...
namespace Microsoft.CodeAnalysis.Tools
{
    internal static class FormatCommandCommon
    {
        ...
        internal static readonly Option<string> SeverityOption = new Option<string>(
            "--severity",
        ...
        internal static readonly Option<bool> IncludeGeneratedOption =
            new(new[] { "--include-generated" }, Resources.Format_files_generated_by_the_SDK);
        internal static readonly Option<string> VerbosityOption = new Option<string>(
            new[] { "--verbosity", "-v" },
        ...
        internal static readonly Option BinarylogOption = new Option<string>(
            new[] { "--binarylog" },
        ...
        internal static readonly Option ReportOption = new Option<string>(
            new[] { "--report" },
        ...
        {
            if (
                parseResult.HasOption(VerbosityOption)
        ...
        )
        {
            ...
            {
                var fileToInclude =
                    parseResult.GetValueForOption(IncludeOption) ?? Array.Empty<string>();
                var fileToExclude =
                    parseResult.GetValueForOption(ExcludeOption) ?? Array.Empty<string>();
            ...
            if (parseResult.HasOption(ReportOption))
            {
                ...
                if (
                    parseResult.GetValueForOption(ReportOption) is string { Length: > 0 } reportPath
                )
                {
            ...
            if (parseResult.HasOption(BinarylogOption))
            {
                ...
                if (
                    parseResult.GetValueForOption(BinarylogOption) is string
                    {
                        Length: > 0
                    } binaryLogPath
                )
        ...
        )
        {
            ...
            if (
                parseResult.GetValueForArgument<string>(SlnOrProjectArgument) is string
                {
                    Length: > 0
                } slnOrProject
            )
        ...
        )
        {
            try
            {
                ...
                var msBuildInstance = Build.Locator.MSBuildLocator
