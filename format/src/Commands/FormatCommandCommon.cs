...
namespace Microsoft.CodeAnalysis.Tools
{
    internal static class FormatCommandCommon
    {
        ...
        internal static readonly Option BinarylogOption = new Option(
            new[] { "--binarylog" },
        ...
        internal static readonly Option ReportOption = new Option(
            new[] { "--report" },
        ...
        )
        {
            ...
            {
                var fileToInclude =
                    parseResult.ValueForOption(IncludeOption) ?? Array.Empty<string>();
                var fileToExclude =
                    parseResult.ValueForOption(ExcludeOption) ?? Array.Empty<string>();
            ...
            if (parseResult.HasOption(BinarylogOption))
            {
                ...
                if (
                    parseResult.ValueForOption(BinarylogOption) is string
                    {
                        Length: > 0
                    } binaryLogPath
                )
        ...
        )
        {
            ...
            if (
                parseResult.ValueForArgument<string>(SlnOrProjectArgument) is string
                {
                    Length: > 0
                } slnOrProject
            )
