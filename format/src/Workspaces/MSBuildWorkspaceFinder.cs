...
// information.
// See
// https://github.com/aspnet/DotNetTools/blob/261b27b70027871143540af10a5cba57ce07ff97/src/dotnet-watch/Internal/MsBuildProjectFinder.cs
...
namespace Microsoft.CodeAnalysis.Tools.Workspaces
{
    internal class MSBuildWorkspaceFinder
    {
        ...
        )
        {
            ...
            var foundProject = FindMatchingFile(
                searchDirectory,
                FindProjectFiles,
        ...
        private static (bool isSolution, string workspacePath) FindFile(string workspacePath)
        {
            ...
            var isSolution =
                workspaceExtension.Equals(".sln", StringComparison.OrdinalIgnoreCase)
        ...
        private static IEnumerable<string> FindSolutionFiles(string basePath) =>
            Directory
                .EnumerateFileSystemEntries(basePath, "*.sln", SearchOption.TopDirectoryOnly)
                .Concat(
