...
namespace Microsoft.CodeAnalysis.Tools
{
    internal static class ILoggerExtensions
    {
        ...
        public static string LogFormattingIssue(
            this ILogger logger,
            Document document,
            ...
            LogIssue(
                logger,
                document,
                s_errorSeverityString,
                formatterName,
                fileChange.LineNumber,
                fileChange.CharNumber,
                fileChange.FormatDescription,
                changesAreErrors
            );

        public static string LogDiagnosticIssue(
            this ILogger logger,
            Document document,
            LinePosition diagnosticPosition,
            ...
            LogIssue(
                ...
                diagnostic.Id,
                diagnosticPosition.Line + 1,
                diagnosticPosition.Character + 1,
                diagnostic.GetMessage(),
                changesAreErrors
            );

        private static string LogIssue(
            ILogger logger,
            Document document,
            string severity,
            string issueId,
