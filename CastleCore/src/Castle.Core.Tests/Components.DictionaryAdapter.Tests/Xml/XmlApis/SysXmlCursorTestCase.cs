...
namespace Castle.Components.DictionaryAdapter.Xml.Tests
{
    ...
    public class SysXmlCursorTestCase
    {
        ...
        public void Create_BeforeFirstItem_Fails()
        {
            ...
            Assert.Throws<InvalidOperationException>(() => cursor.Create(ItemType.ClrType));
        }
        ...
        public void Create_UnknownType()
        {
            ...
            cursor.MoveNext();
            Assert.Throws<SerializationException>(() => cursor.Create(typeof(UnknownType)));
        }
        ...
        public void Coerce_WhenBeforeFirstItem()
        {
            ...
            Assert.Throws<InvalidOperationException>(() => cursor.Coerce(OtherType.ClrType));
        }
        ...
        public void Coerce_UnknownType()
        {
            ...
            cursor.MoveNext();
            Assert.Throws<SerializationException>(() => cursor.Coerce(typeof(UnknownType)));
        }
        ...
        public void Remove_WhenBeforeFirstItem_Fails()
        {
            ...
            Assert.Throws<InvalidOperationException>(() => cursor.Remove());
        }
        ...
        protected static readonly XmlKnownType ItemType = new XmlKnownType(
                "Item",
                null,
                null,
                null,
