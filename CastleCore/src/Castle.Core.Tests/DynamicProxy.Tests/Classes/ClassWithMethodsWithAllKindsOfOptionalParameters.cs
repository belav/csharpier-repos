...
namespace Castle.DynamicProxy.Tests.Classes
{
    ...
    public class ClassWithMethodsWithAllKindsOfOptionalParameters
        : InterfaceWithMethodsWithAllKindsOfOptionalParameters
    {
        ...
        public virtual void MethodWithOptionalNonDefaultNullableSignedByteParameter(
            sbyte? b = 3
        ) { }
        ...
        public virtual void MethodWithOptionalNonDefaultNullableUnsignedIntParameter(
            uint? i = 3
        ) { }
        ...
        public virtual void MethodWithOptionalNonDefaultNullableUnsignedLongParameter(
            ulong? l = 3L
        ) { }
