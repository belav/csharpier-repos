...
namespace Castle.DynamicProxy.Tests
{
    ...
    public class ParameterDefaultValuesTestCase : BasePEVerifyTestCase
    {
        ...
        {
            var originalParameter = GetOriginalParameter(
                typeof(HasNoDefaultValues),
                nameof(HasNoDefaultValues.No_default)
            );
            ...
            var proxiedParameter = GetProxiedParameter(
                typeof(HasNoDefaultValues),
                nameof(HasNoDefaultValues.No_default)
            );
        ...
        public void Fully_supported_Not_optional()
        {
            ...
            var originalParameter = GetOriginalParameter(
                typeof(HasNoDefaultValues),
                nameof(HasNoDefaultValues.Not_optional)
            );
        ...
        {
            AssertParameter(
                typeof(HasDefaultValue<>).MakeGenericType(parameterType),
                nameof(HasDefaultValue<object>.Method)
            );
        }

        [Platform(
            Exclude = "Net,NetCore",
            Reason = "ParameterBuilder.SetConstant does not accept a null default value for value type parameters. See https://github.com/dotnet/corefx/issues/26164."
        )]
        [TestCase(typeof(bool))]
        [TestCase(typeof(decimal))]
        [TestCase(typeof(double))]
        ...
        [Platform(
            Exclude = "Net,NetCore",
            Reason = "ParameterBuilder.SetConstant does not accept non-null default values for nullable enum parameters. See https://github.com/dotnet/coreclr/issues/17893."
        )]
        ...
        [Platform(
            Exclude = "Mono",
            Reason = "ParameterInfo.DefaultValue does not report the correct default value for non-null optional parameters of type `DateTime?` and `decimal?`. See https://github.com/mono/mono/issues/11303."
        )]
        ...
        public class HasDefaultValues
        {
            ...
            public virtual object DateTime_default_from_attribute(
                [Optional, DateTimeConstant(0L)] DateTime arg
            ) => new DateTime(0L);

            public virtual object DateTime_non_default_from_attribute(
                [Optional, DateTimeConstant(1L)] DateTime arg
            ) => new DateTime(1L);
            ...
            public virtual object DateTime_nullable_default_from_attribute(
                [Optional, DateTimeConstant(0L)] DateTime? arg
            ) => new DateTime(0L);

            public virtual object DateTime_nullable_non_default_from_attribute(
                [Optional, DateTimeConstant(1L)] DateTime? arg
            ) => new DateTime(1L);

            public virtual object Decimal_default(decimal arg = default) => default(decimal);

            public virtual object Decimal_default_from_attribute(
                [Optional, DecimalConstant(0, 0, 0, 0, 0)] decimal arg
            ) => new decimal(0, 0, 0, false, 0);

            public virtual object Decimal_non_default(decimal arg = 1.00m) => 1.00m;

            public virtual object Decimal_non_default_from_attribute(
                [Optional, DecimalConstant(0, 0, 0, 0, 1)] decimal arg
            ) => new decimal(1, 0, 0, false, 0);

            public virtual object Decimal_nullable_null(decimal? arg = null) => null;

            public virtual object Decimal_nullable_default(decimal? arg = default(decimal)) =>
                default(decimal);

            public virtual object Decimal_nullable_default_from_attribute(
                [Optional, DecimalConstant(0, 0, 0, 0, 0)] decimal? arg
            ) => new decimal(0, 0, 0, false, 0);

            public virtual object Decimal_nullable_non_default(decimal? arg = 1.00m) => 1.00m;

            public virtual object Decimal_nullable_non_default_from_attribute(
                [Optional, DecimalConstant(0, 0, 0, 0, 1)] decimal? arg
            ) => new decimal(1, 0, 0, false, 0);
            ...
            public virtual object Double_non_default_from_attribute(
                [Optional, DefaultParameterValue(1.0)] double arg
            ) => 1.0;

            public virtual object Double_non_default_from_attribute_wrong_type(
                [Optional, DefaultParameterValue(1.0f)] double arg
            ) => 1.0;

            public virtual object Double_nullable_null(double? arg = null) => null;

            public virtual object Double_nullable_default(double? arg = default(double)) =>
                default(double);

            public virtual object Double_nullable_non_default(double? arg = 1.0) => 1.0;

            public virtual object Double_nullable_non_default_from_attribute(
                [Optional, DefaultParameterValue(1.0)] double? arg
            ) => 1.0;

            public virtual object Double_nullable_non_default_from_attribute_wrong_type(
                [Optional, DefaultParameterValue(1.0f)] double? arg
            ) => 1.0;
            ...
            public virtual object Float_nullable_default(float? arg = default(float)) =>
                default(float);
            ...
            public virtual object Long_non_default_from_attribute(
                [Optional, DefaultParameterValue(1L)] long arg
            ) => 1L;

            public virtual object Long_non_default_from_attribute_wrong_type(
                [Optional, DefaultParameterValue(1)] long arg
            ) => 1L;
            ...
            public virtual object Long_nullable_non_default_from_attribute(
                [Optional, DefaultParameterValue(1L)] long? arg
            ) => 1L;

            public virtual object Long_nullable_non_default_from_attribute_wrong_type(
                [Optional, DefaultParameterValue(1)] long? arg
            ) => 1L;
            ...
            public virtual object Object_non_default_from_attribute(
                [Optional, DefaultParameterValue("1")] object arg
            ) => "1";
            ...
            public virtual object SByte_nullable_default(sbyte? arg = default(sbyte)) =>
                default(sbyte);
            ...
            public virtual object Short_nullable_default(short? arg = default(short)) =>
                default(short);
            ...
            public virtual object ULong_nullable_default(ulong? arg = default(ulong)) =>
                default(ulong);
            ...
            public virtual object UserDefinedClass_default(UserDefinedClass arg = default) =>
                default(UserDefinedClass);

            //public virtual object UserDefinedClass_non_default(UserDefinedClass arg = new UserDefinedClass(...)) => new UserDefinedClass(...);

            public virtual object UserDefinedEnum_default(UserDefinedEnum arg = default) =>
                default(UserDefinedEnum);

            public virtual object UserDefinedEnum_non_default(
                UserDefinedEnum arg = (UserDefinedEnum)1
            ) => (UserDefinedEnum)1;

            public virtual object UserDefinedEnum_non_default_from_attribute(
                [Optional, DefaultParameterValue((UserDefinedEnum)1)] UserDefinedEnum arg
            ) => (UserDefinedEnum)1;
            ...
            public virtual object UserDefinedEnum_nullable_null(UserDefinedEnum? arg = null) =>
                null;
            ...
            public virtual object UserDefinedEnum_nullable_default(
                UserDefinedEnum? arg = default(UserDefinedEnum)
            ) => (int)default(UserDefinedEnum);

            public virtual object UserDefinedEnum_nullable_default_from_attribute(
                [Optional, DefaultParameterValue(default(UserDefinedEnum))] UserDefinedEnum? arg
            ) => (int)default(UserDefinedEnum);
            ...
            public virtual object UserDefinedEnum_nullable_non_default(
                UserDefinedEnum? arg = (UserDefinedEnum)1
            ) => 1;

            public virtual object UserDefinedEnum_nullable_non_default_from_attribute(
                [Optional, DefaultParameterValue((UserDefinedEnum)1)] UserDefinedEnum? arg
            ) => 1;
            ...
            public virtual object UserDefinedStruct_default(UserDefinedStruct arg = default) =>
                null;
            ...
            public virtual object UserDefinedStruct_nullable_null(UserDefinedStruct? arg = null) =>
                null;
            ...
            public virtual object UShort_nullable_default(ushort? arg = default(ushort)) =>
                default(ushort);
