...
namespace Castle.DynamicProxy.Tests.ComInteropTypes.ADODB
{
    ...
    public interface _Recordset // : (inherited interfaces omitted)
    {
        ...
        [DispId(1001)]
        void let_ActiveConnection([In] [MarshalAs(UnmanagedType.Struct)] object pvar);
        ...
        [DispId(1011)]
        void let_Source([In] [MarshalAs(UnmanagedType.BStr)] string pvSource);
        ...
        [DispId(1035)]
        void UpdateBatch([In] AffectEnum AffectRecords = AffectEnum.adAffectAll);
        ...
        void Find(
            ...
            ,
            [In]
                SearchDirectionEnum SearchDirection /* = SearchDirectionEnum.adSearchForward */
            ,
            [Optional] [In] [MarshalAs(UnmanagedType.Struct)] object Start
        );
        ...
        [DispId(1034)]
        [return: MarshalAs(UnmanagedType.Interface)]
        Recordset Clone([In] LockTypeEnum LockType = LockTypeEnum.adLockUnspecified);
