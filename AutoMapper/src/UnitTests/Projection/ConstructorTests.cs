    ...
    protected override MapperConfiguration CreateConfiguration() =>
        new(cfg =>
        {
            ...
            cfg.CreateProjection<SourceItem, DestinationItem>()
                .ForCtorParam("destinationValue", o => o.MapFrom(s => s.Values.FirstOrDefault()));
...
public class ConstructorToString : AutoMapperSpecBase
{
    ...
    protected override MapperConfiguration CreateConfiguration() =>
        new(cfg => cfg.CreateProjection<Source, Destination>());
...
public class ConstructorIncludeMembers : AutoMapperSpecBase
{
    ...
    [Fact]
    public void Should_construct_correctly() =>
        new[] { new SourceWrapper { Source = new Source { Value = 5 } } }
            .AsQueryable()
            .ProjectTo<Destination>(Configuration)
            .First()
            .Value.ShouldBe("5");
