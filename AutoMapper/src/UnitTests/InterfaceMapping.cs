...
namespace AutoMapper.UnitTests.InterfaceMapping
{
    ...
    public class GenericsAndInterfaces : AutoMapperSpecBase
    {
        ...
        protected override MapperConfiguration CreateConfiguration() =>
            new(cfg => cfg.CreateMap(typeof(MyClass<>), typeof(IMyInterface<>)).AsProxy());
    ...
    public class When_mapping_generic_interface : AutoMapperSpecBase
    {
        ...
        public abstract class DestinationBase<T> : DestinationBaseBase, IDestinationBase<T>
        {
            ...
            {
                get { return m_PropertyToIgnore ?? (m_PropertyToIgnore = "Ignore me"); }
                set { m_PropertyToIgnore = value; }
            }
    ...
    public class When_mapping_an_interface_with_getter_only_member : AutoMapperSpecBase
    {
        ...
        protected override MapperConfiguration CreateConfiguration() =>
            new(c => c.CreateMap<ISource, IDestination>().AsProxy());
    ...
    public class When_mapping_an_interface_type_to_a_concrete_type_and_reverse : AutoMapperSpecBase
    {
        ...
        protected override MapperConfiguration CreateConfiguration() =>
            new(cfg => cfg.CreateMap<ISource, Destination>().ReverseMap());
    ...
    public class When_mapping_an_interface_type_to_an_interface_type_and_reverse
        : AutoMapperSpecBase
    {
        public interface ISource
        {
        ...
        protected override MapperConfiguration CreateConfiguration() =>
            new(cfg => cfg.CreateMap<ISource, IDestination>().AsProxy().ReverseMap().AsProxy());
    ...
    public class When_mapping_a_concrete_type_to_an_interface_type_and_reverse : AutoMapperSpecBase
    {
        ...
        protected override MapperConfiguration CreateConfiguration() =>
            new(cfg => cfg.CreateMap<Source, IDestination>().AsProxy().ReverseMap());
        ...
        : AutoMapperSpecBase
    {
        ...
        protected override MapperConfiguration CreateConfiguration() =>
            new(cfg => cfg.CreateMap<Source, IDestination>().AsProxy());
    ...
    public class When_mapping_to_a_type_with_explicitly_implemented_interface_members
        : AutoMapperSpecBase
    {
