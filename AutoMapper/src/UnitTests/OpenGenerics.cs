...
namespace AutoMapper.UnitTests
{
    ...
    public class GenericMapsPriority : AutoMapperSpecBase
    {
        ...
        public void Should_work()
        {
            ...
            Mapper.Map<Destination<string>>(new Source<string> { Value = "42" })
                .Value.ShouldBe("42");
        }
    }
    ...
    public class RecursiveOpenGenerics : AutoMapperSpecBase
    {
        ...
        protected override MapperConfiguration Configuration =>
            new MapperConfiguration(
                cfg => cfg.CreateMap(typeof(SourceTree<>), typeof(DestinationTree<>))
            );
    ...
    public class OpenGenericsValidation : NonValidatingSpecBase
    {
        ...
        protected override MapperConfiguration Configuration =>
            new MapperConfiguration(cfg => cfg.CreateMap(typeof(Source<>), typeof(Dest<>)));
