namespace AutoMapper.UnitTests.Bug
{
    namespace ParentChildResolversBug
    {
        ...
        {
            public ParentDestEnum? field { get; set; }
        }

        public class Dest : ParentDest
        {
            public new DestEnum? field { get; set; }
        }
        ...
        public class ParentResolver : IValueResolver<Source, ParentDest, ParentDestEnum?>
        {
            ...
            )
            {
                ...
                {
                    case "testa":
                        return ParentDestEnum.d;
                    case "testb":
                        return ParentDestEnum.e;
                    case "testc":
                        return ParentDestEnum.f;
                    default:
                        return null;
                }
            }
        ...
        public class ParentChildResolverTests : AutoMapperSpecBase
        {
            ...
            {
                var source = new Source() { fieldCode = "testa" };
