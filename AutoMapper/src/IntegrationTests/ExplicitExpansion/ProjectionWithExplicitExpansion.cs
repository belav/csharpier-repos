...
public static class Ext
{
    public static void SqlShouldSelectColumn(this string sqlSelect, string columnName) =>
        sqlSelect.ShouldContain($".[{columnName}]");
...
public class ProjectionWithExplicitExpansion
    : IntegrationTest<ProjectionWithExplicitExpansion.DatabaseInitializer>
{
...
public class ConstructorExplicitExpansion
    : IntegrationTest<ConstructorExplicitExpansion.DatabaseInitializer>
{
    public class Entity
    {
    ...
    protected override MapperConfiguration CreateConfiguration() =>
        new(c =>
            c.CreateProjection<Entity, Dto>().ForCtorParam("Name", o => o.ExplicitExpansion())
        );
