...
namespace AutoMapper.Internal
{
    ...
    public readonly struct MapRequest : IEquatable<MapRequest>
    {
        ...
        public bool Equals(MapRequest other) =>
            RequestedTypes.Equals(other.RequestedTypes)
            && RuntimeTypes.Equals(other.RuntimeTypes)
            && (
                MemberMap == other.MemberMap
                || (MemberMap?.MapperEquals(other.MemberMap)).GetValueOrDefault()
            );

        public override bool Equals(object obj) => obj is MapRequest other && Equals(other);

        public override int GetHashCode() =>
            HashCode.Combine(RequestedTypes, RuntimeTypes, MemberMap?.MapperGetHashCode());

        public static bool operator ==(in MapRequest left, in MapRequest right) =>
            left.Equals(right);
    ...
    public readonly struct TypePair : IEquatable<TypePair>
    {
        ...
        public override bool Equals(object other) =>
            other is TypePair otherPair && Equals(otherPair);
        ...
        public TypePair GetTypeDefinitionIfGeneric() =>
            new TypePair(
                GetTypeDefinitionIfGeneric(SourceType),
                GetTypeDefinitionIfGeneric(DestinationType)
            );
