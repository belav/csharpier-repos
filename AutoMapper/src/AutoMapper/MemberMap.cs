...
namespace AutoMapper
{
    ...
    public class MemberMap
    {
        ...
        public bool AllowsNullCollections() =>
            (Profile?.AllowsNullCollectionsFor(this)).GetValueOrDefault();
        ...
        public bool MapperEquals(MemberMap other)
        {
            ...
            return other.MustUseDestination == MustUseDestination
                && other.MaxDepth == MaxDepth
                && other.AllowsNullDestinationValues() == AllowsNullDestinationValues()
                && other.AllowsNullCollections() == AllowsNullCollections();
        }

        public int MapperGetHashCode() =>
            HashCode.Combine(
                MustUseDestination,
                MaxDepth,
                AllowsNullDestinationValues(),
                AllowsNullCollections()
            );
    }
