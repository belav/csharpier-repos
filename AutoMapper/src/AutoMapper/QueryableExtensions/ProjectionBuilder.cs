...
namespace AutoMapper.QueryableExtensions.Impl
{
    ...
    public class ProjectionBuilder : IProjectionBuilder
    {
        ...
        private QueryExpressions CreateProjection(ProjectionRequest request) =>
            CreateProjection(
                request,
                new FirstPassLetPropertyMaps(_configurationProvider, MemberPath.Empty, new())
            );
        ...
        )
        {
            ...
            Expression TryProjectMember(MemberMap memberMap, bool? explicitExpansion = null)
            {
                ...
                Expression ProjectMemberCore()
                {
                    ...
                    var memberRequest = request.InnerRequest(
                        resolvedSource.Type,
                        memberMap.DestinationType
                    );
                    if (
                ...
                public Expression GetSourceExpression(Expression parameter)
                {
                    ...
                    for (int index = 0; index < _members.Length - 1; index++)
                    {
                        ...
                        else
                        {
                            ...
                            {
                                sourceExpression = sourceMember.Replace(
                                    first.Target,
                                    sourceExpression
                                );
                            }
    ...
    public class LetPropertyMaps
    {
        ...
        public virtual LetPropertyMaps New() => new(ConfigurationProvider, BuiltProjections);
    ...
    public readonly struct ProjectionRequest : IEquatable<ProjectionRequest>
    {
        ...
        public ProjectionRequest InnerRequest(Type sourceType, Type destinationType) =>
            new(
                ...
                destinationType,
                _membersToExpand,
                new HashSet<ProjectionRequest>(_previousRequests) { this }
            );
