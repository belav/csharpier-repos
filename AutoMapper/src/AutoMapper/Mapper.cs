...
namespace AutoMapper
{
    ...
    public interface IMapper : IMapperBase
    {
        ...
        object Map(
            ...
            Action<IObjectMappingOperationOptions> opts
        );
    ...
    public class Mapper : IMapper, IInternalRuntimeMapper
    {
        ...
        public Mapper(IConfigurationProvider configurationProvider, Func<Type, object> serviceCtor)
        {
            ...
            DefaultContext = new ResolutionContext(
                new MappingOperationOptions<object, object>(
                    serviceCtor ?? throw new NullReferenceException(nameof(serviceCtor))
                ),
                this
            );
        }
        ...
        public TDestination Map<TSource, TDestination>(TSource source) =>
            Map(source, default(TDestination));
        ...
        public object Map(object source, Type sourceType, Type destinationType) =>
            Map(source, null, sourceType, destinationType);
        ...
        )
        {
            ...
            destination = MapCore(
                source,
                destination,
                new ResolutionContext(typedOptions, this),
                sourceType,
                destinationType
            );
        ...
        )
        {
            ...
            return _configurationProvider.GetExecutionPlan<TSource, TDestination>(mapRequest)(
                source,
                destination,
                context
            );
