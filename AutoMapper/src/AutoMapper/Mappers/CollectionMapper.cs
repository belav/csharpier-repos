        ...
        )
        {
            ...
            Expression MapCollectionCore(Expression destExpression)
            {
                ...
                var sourceElementType =
                    sourceExpression.Type.GetICollectionType()?.GenericTypeArguments[0]
                    ?? GetEnumerableElementType(sourceExpression.Type);
                ...
                void GetDestinationType()
                {
                    ...
                    destinationElementType =
                        destinationCollectionType?.GenericTypeArguments[0]
