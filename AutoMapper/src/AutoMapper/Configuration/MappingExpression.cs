...
namespace AutoMapper.Configuration
{
            ...
            IMappingExpression
    {
        ...
        public IMappingExpression ReverseMap()
        {
            ...
            reverseMap.IncludeMembers(
                MapToSourceMembers().Select(m => m.DestinationMember.Name).ToArray()
            );
                ...
                IMemberConfigurationExpression
        {
            ...
            public void ConvertUsing(Type valueConverterType, string sourceMemberName) =>
                PropertyMapActions.Add(
                    pm => ConvertUsing(pm, valueConverterType, sourceMemberName)
                );
            ...
            IProjectionExpression<TSource, TDestination>
    {
        ...
        )
        {
            ...
            var expression = new PathConfigurationExpression<TSource, TDestination, TMember>(
                destinationMember,
                chain
            );
        ...
        {
            foreach (
                var member in memberExpressions
                    .Select(memberExpression => memberExpression.GetMember())
        ...
        public IMappingExpression<TSource, TDestination> IncludeBase<
            TSourceBase,
            TDestinationBase
        ...
        {
            var reverseMap = new MappingExpression<TDestination, TSource>(
                MemberList.None,
                DestinationType,
                SourceType
            )
            ...
            reverseMap.IncludeMembersCore(
                MapToSourceMembers().Select(m => m.GetDestinationExpression()).ToArray()
            );
            return reverseMap;
        }
