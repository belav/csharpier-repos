...
namespace AutoMapper.Configuration.Conventions
{
    ...
    public class MemberConfiguration : IMemberConfiguration
    {
        ...
        public List<IChildMemberConfiguration> MemberMappers { get; } =
            new List<IChildMemberConfiguration>();
        ...
        )
        {
            ...
            {
                if (
                    memberMapper.MapDestinationPropertyToSource(
                        options,
                        sourceType,
                        destType,
                        destMemberType,
    ...
    public class NameSplitMember : IChildMemberConfiguration
    {
        ...
        )
        {
            ...
            var matches =
                destinationMemberNamingConvention.SplittingExpression?.Matches(nameToSearch)
                    .Cast<Match>()
