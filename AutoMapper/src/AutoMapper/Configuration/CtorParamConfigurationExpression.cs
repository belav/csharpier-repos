        ...
        ICtorParameterConfiguration
{
    ...
    public void Configure(TypeMap typeMap)
    {
        ...
        return;
        static string CheckRecord(ConstructorInfo ctor) =>
            ctor.IsFamily && ctor.Has<CompilerGeneratedAttribute>()
                ? " When mapping to records, consider excluding non-public constructors. See https://docs.automapper.org/en/latest/Construction.html."
                : null;
    }
}
