...
namespace AutoMapper
{
    ...
    {
        public static readonly ExactMatchNamingConvention Instance =
            new ExactMatchNamingConvention();
    ...
    public class PascalCaseNamingConvention : INamingConvention
    {
        ...
        public static readonly PascalCaseNamingConvention Instance =
    ...
    public class LowerUnderscoreNamingConvention : INamingConvention
    {
        ...
        public static readonly LowerUnderscoreNamingConvention Instance =
