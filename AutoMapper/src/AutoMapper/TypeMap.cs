...
namespace AutoMapper
{
    ...
    public class TypeMap
    {
        ...
        public bool PassesCtorValidation =>
            ...
            || TypeDetails.GetConstructors(DestinationType, Profile)
        ...
        public string[] GetUnmappedPropertyNames()
        {
            ...
            {
                properties = Profile.CreateTypeDetails(DestinationType)
            ...
            return properties.Where(memberName => !Profile.GlobalIgnores.Any(memberName.StartsWith))
                .ToArray();
        ...
        private void AddSourceMemberConfig(SourceMemberConfig config) =>
