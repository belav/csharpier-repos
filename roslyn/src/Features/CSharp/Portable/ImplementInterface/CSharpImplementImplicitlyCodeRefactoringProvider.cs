...
namespace Microsoft.CodeAnalysis.CSharp.ImplementInterface
{
    [
        ExportCodeRefactoringProvider(
            ...
            Name = PredefinedCodeRefactoringProviderNames.ImplementInterfaceImplicitly
        ),
        Shared
    ]
        ...
        : AbstractChangeImplementationCodeRefactoringProvider
    {
        ...
        protected override bool CheckMemberCanBeConverted(ISymbol member)
        {
            ...
            if (containingTypeInterfaces.Length == 0)
                return false;
            return memberInterfaceImplementations.Any(
                static (impl, containingTypeInterfaces) =>
                    containingTypeInterfaces.Contains(impl.ContainingType),
                containingTypeInterfaces
            );
        }

        // When converting to implicit, we don't need to update any references.
        protected override Task UpdateReferencesAsync(
            Project project,
