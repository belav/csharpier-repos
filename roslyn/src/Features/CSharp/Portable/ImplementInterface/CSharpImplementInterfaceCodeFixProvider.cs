...
namespace Microsoft.CodeAnalysis.CSharp.ImplementInterface
{
    [
        ExportCodeFixProvider(
            ...
            Name = PredefinedCodeFixProviderNames.ImplementInterface
        ),
        Shared
    ]
    ...
    {
        private readonly Func<TypeSyntax, bool> _interfaceName = n =>
            n.Parent is BaseTypeSyntax
            && n.Parent.Parent is BaseListSyntax
            && ((BaseTypeSyntax)n.Parent).Type == n;
