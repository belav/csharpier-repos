...
namespace Microsoft.CodeAnalysis.CSharp.SplitStringLiteral
{
    internal abstract partial class StringSplitter
    {
        ...
        ) : StringSplitter(document, position, indentationOptions, cancellationToken)
        {
            ...
            {
                return _token.IsKind(SyntaxKind.Utf8StringLiteralToken)
                    && CursorPosition >= _token.Span.End - "u8".Length;
            }
