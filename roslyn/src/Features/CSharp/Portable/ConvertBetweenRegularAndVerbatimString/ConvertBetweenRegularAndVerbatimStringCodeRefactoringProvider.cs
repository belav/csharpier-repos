...
namespace Microsoft.CodeAnalysis.CSharp.ConvertBetweenRegularAndVerbatimString
{
    [
        ExportCodeRefactoringProvider(
            ...
            Name = PredefinedCodeRefactoringProviderNames.ConvertBetweenRegularAndVerbatimString
        ),
        Shared
    ]
        ...
        : AbstractConvertBetweenRegularAndVerbatimStringCodeRefactoringProvider<LiteralExpressionSyntax>
    {
        ...
        protected override LiteralExpressionSyntax CreateVerbatimStringExpression(
        ...
        protected override LiteralExpressionSyntax CreateRegularStringExpression(
            IVirtualCharService charService,
            StringBuilder sb,
            LiteralExpressionSyntax stringExpression
        )
