    ...
    internal sealed class ToToListConverter : AbstractToMethodConverter
    {
        ...
        protected override bool CanReplaceInitialization(
            ...
            && ForEachInfo.SemanticModel
                .GetSymbolInfo(objectCreationExpression.Type, cancellationToken).Symbol
                is ITypeSymbol typeSymbol
            && CSharpConvertForEachToLinqQueryProvider.TypeSymbolOptIsList(
                typeSymbol,
                ForEachInfo.SemanticModel
            )
            && (
            ...
            && (
                ...
                || !objectCreationExpression.Initializer.Expressions.Any()
            );
