...
namespace Microsoft.CodeAnalysis.CSharp.SignatureHelp
{
        ...
        : AbstractSignatureHelpProvider
    {
        ...
        private static readonly IList<SymbolDisplayPart> _separatorParts =
            new List<SymbolDisplayPart> { Punctuation(SyntaxKind.CommaToken), Space() };
        ...
        )
        {
            return new SignatureHelpSymbolParameter(
                ...
                parameter.ToMinimalDisplayParts(
                    semanticModel,
                    position,
                    s_allowDefaultLiteralFormat
                )
            );
        }
        ...
        /// </summary>
        [Obsolete(
            "Expected to exist by IntelliCode. This can be removed once their unnecessary use of this is removed."
        )]
#pragma warning disable CA1822 // Mark members as static - see obsolete message above.
        protected IList<TaggedText> GetAwaitableUsage(
