    ...
    internal partial class InvocationExpressionSignatureHelpProviderBase
    {
        ...
        )
        {
            ...
            var expressionSymbol = semanticModel
                .GetSymbolInfo(invocationExpression.Expression, cancellationToken)
                .GetAnySymbol();
            if (
        ...
        private static IList<SymbolDisplayPart> GetDelegateOrFunctionPointerInvokePreambleParts(
            IMethodSymbol invokeMethod,
            SemanticModel semanticModel,
            int position
        )
            ...
            foreach (var parameter in invokeMethod.Parameters)
            {
                ...
                result.Add(
                    new SignatureHelpSymbolParameter(
                        ...
                        parameter.GetDocumentationPartsFactory(
                            semanticModel,
                            position,
                            formattingService
                        ),
