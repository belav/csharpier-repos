...
namespace Microsoft.CodeAnalysis.CSharp.SignatureHelp
{
    ...
    partial internal class AttributeSignatureHelpProvider : AbstractCSharpSignatureHelpProvider
    {
        ...
        )
        {
            ...
            var semanticModel = await document
                .ReuseExistingSpeculativeModelAsync(attribute, cancellationToken)
                .ConfigureAwait(false);
            if (
            ...
            var documentationCommentFormatter =
        ...
        )
        {
            ...
            var isVariadic =
                ...
                && constructor.Parameters.Last().IsParams
                && namedParameters.Count == 0;
        ...
        )
        {
            ...
            {
                result.Add(
                    Convert(parameter, semanticModel, position, documentationCommentFormatter)
                );
            }
            ...
            for (var i = 0; i < namedParameters.Count; i++)
            {
                ...
                var type =
                    namedParameter is IFieldSymbol
                        ? ((IFieldSymbol)namedParameter).Type
                ...
                result.Add(
                    new SignatureHelpSymbolParameter(
                        namedParameter.Name,
                        isOptional: true,
                        documentationFactory: namedParameter.GetDocumentationPartsFactory(
                            semanticModel,
                            position,
                            documentationCommentFormatter
                        ),
            ...
            if (i == 0)
            {
                return new List<SymbolDisplayPart>
                {
                    new SymbolDisplayPart(
                        ...
                        null,
                        CSharpFeaturesResources.Properties
                    ),
