...
namespace Microsoft.CodeAnalysis.CSharp.CodeRefactorings.AddAwait
{
    ...
    [
        ExportCodeRefactoringProvider(
            ...
            Name = PredefinedCodeRefactoringProviderNames.AddAwait
        ),
        Shared
    ]
        ...
        : AbstractAddAwaitCodeRefactoringProvider<ExpressionSyntax>
    {
        ...
        protected override string GetTitle() => CSharpFeaturesResources.Add_await;
            ...
            foreach (var current in node.Ancestors())
            {
                switch (current.Kind())
                {
                    ...
                    case SyntaxKind.MethodDeclaration:
                        return ((MethodDeclarationSyntax)current).Modifiers.Any(
