...
namespace Microsoft.CodeAnalysis.CSharp.CodeRefactorings.UseExplicitType
{
    [
        ExportCodeRefactoringProvider(
            ...
            Name = PredefinedCodeRefactoringProviderNames.UseExplicitType
        ),
        Shared
    ]
    internal class UseExplicitTypeCodeRefactoringProvider : AbstractUseTypeCodeRefactoringProvider
    {
        ...
        protected override string Title => CSharpAnalyzersResources.Use_explicit_type;
        ...
        protected override TypeSyntax FindAnalyzableType(
            ...
            CSharpUseExplicitTypeHelper.Instance
