...
namespace Microsoft.CodeAnalysis.CSharp.CodeRefactorings.UseType
{
    internal abstract class AbstractUseTypeCodeRefactoringProvider : CodeRefactoringProvider
    {
        ...
        public override async Task ComputeRefactoringsAsync(CodeRefactoringContext context)
        {
            ...
            var simplifierOptions = (CSharpSimplifierOptions)
                await document
            ...
            if (
                ...
                && typeStyle.Notification.Severity != ReportDiagnostic.Suppress
            )
            {
        ...
        private static async Task<SyntaxNode> GetDeclarationAsync(CodeRefactoringContext context)
        {
            ...
            var variableNode = await context
                .TryGetRelevantNodeAsync<VariableDeclarationSyntax>()
                .ConfigureAwait(false);
            ...
            var foreachStatement = await context
                .TryGetRelevantNodeAsync<ForEachStatementSyntax>()
                .ConfigureAwait(false);
            ...
            var typeNode = await context
                .TryGetRelevantNodeAsync<TypeSyntax>()
                .ConfigureAwait(false);
