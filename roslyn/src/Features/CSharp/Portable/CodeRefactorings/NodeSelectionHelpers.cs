...
namespace Microsoft.CodeAnalysis.CSharp.CodeRefactorings
{
    internal static class NodeSelectionHelpers
    {
        ...
        > GetSelectedDeclarationsOrVariablesAsync(CodeRefactoringContext context)
        {
            ...
            if (span.IsEmpty)
            {
                ...
                var memberDeclaration = await context
                    .TryGetRelevantNodeAsync<MemberDeclarationSyntax>()
            ...
            else
            {
                ...
                var tree = await document
                    ...
                    .ConfigureAwait(false);
                var members = await CSharpSelectedMembers.Instance
