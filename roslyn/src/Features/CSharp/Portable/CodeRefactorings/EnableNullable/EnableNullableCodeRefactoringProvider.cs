...
namespace Microsoft.CodeAnalysis.CSharp.CodeRefactorings.EnableNullable
{
    ...
    internal class EnableNullableCodeRefactoringProvider : CodeRefactoringProvider
    {
        ...
        public override async Task ComputeRefactoringsAsync(CodeRefactoringContext context)
        {
            ...
            if (
                !token.IsKind(SyntaxKind.EnableKeyword)
                || !token.Parent.IsKind(SyntaxKind.NullableDirectiveTrivia)
            )
                return;
        ...
        )
        {
            ...
            if (
                firstRelevantDirective.IsKind(
                    SyntaxKind.NullableDirectiveTrivia,
                    out NullableDirectiveTriviaSyntax? nullableDirective
