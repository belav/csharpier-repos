...
namespace Microsoft.CodeAnalysis.CSharp.CodeRefactorings.LambdaSimplifier
{
    ...
    internal partial class LambdaSimplifierCodeRefactoringProvider : CodeRefactoringProvider
    {
        public override async Task ComputeRefactoringsAsync(CodeRefactoringContext context)
        {
            ...
            var lambda = await context.TryGetRelevantNodeAsync<LambdaExpressionSyntax>()
                .ConfigureAwait(false);
            if (lambda == null)
            {
                return;
        ...
        )
        {
            ...
            if (!lambdaMethod.ReturnsVoid)
            {
                ...
                var conversion = document.SemanticModel.Compilation
    ...
    static void Main()
    {
        ...
        )
        {
            ...
            var newExpression = newTree.GetRoot(cancellationToken)
