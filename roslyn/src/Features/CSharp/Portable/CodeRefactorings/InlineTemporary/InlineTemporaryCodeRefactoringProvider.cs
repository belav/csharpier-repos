        ...
        : AbstractInlineTemporaryCodeRefactoringProvider<VariableDeclaratorSyntax>
    {
        ...
        public override async Task ComputeRefactoringsAsync(CodeRefactoringContext context)
        {
            ...
            var variableDeclarator = await context
                .TryGetRelevantNodeAsync<VariableDeclaratorSyntax>()
        ...
        )
        {
            ...
            var updatedDocument = await document
                .ReplaceNodeAsync(
                    declarator,
            ...
            var syntaxRoot = await updatedDocument
            ...
            semanticModel = await updatedDocument
                .GetSemanticModelAsync(cancellationToken)
                .ConfigureAwait(false);
            ...
            updatedDocument = await updatedDocument
                .ReplaceNodeAsync(scope, newScope, cancellationToken)
                .ConfigureAwait(false);
            semanticModel = await updatedDocument
                .GetSemanticModelAsync(cancellationToken)
                .ConfigureAwait(false);
        ...
        )
        {
            ...
            {
                updatedDocument = await updatedDocument
                    .ReplaceNodeAsync(newExpression, explicitCastExpression, cancellationToken)
                    .ConfigureAwait(false);
                semanticModel = await updatedDocument
                    .GetSemanticModelAsync(cancellationToken)
                    .ConfigureAwait(false);
            ...
            newExpression = await Simplifier
                .ExpandAsync(
        ...
        )
        {
            ...
            using (var originalNodesEnum = originalIdentifierNodes.GetEnumerator())
            {
                ...
                while (originalNodesEnum.MoveNext())
                {
                    ...
                    var innerInitializerInInlineNodeOrToken = inlinedNode
                        .GetAnnotatedNodesAndTokens(InitializerAnnotation)
                        .First();
