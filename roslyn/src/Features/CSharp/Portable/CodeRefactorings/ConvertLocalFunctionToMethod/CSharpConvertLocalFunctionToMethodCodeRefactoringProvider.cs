...
namespace Microsoft.CodeAnalysis.CSharp.CodeRefactorings.ConvertLocalFunctionToMethod
{
    ...
    {
        private static readonly SyntaxAnnotation s_delegateToReplaceAnnotation =
        ...
        private static async Task<Document> UpdateDocumentAsync(
            ...
            var capturesAsParameters = captures.Where(capture => !capture.IsThisParameter())
                .Select(
                    capture =>
            ...
            var additionalTypeParameters = typeParameters.Except(declaredSymbol.TypeParameters)
                .ToList();
