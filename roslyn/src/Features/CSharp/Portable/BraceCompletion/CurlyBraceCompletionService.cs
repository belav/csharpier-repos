...
namespace Microsoft.CodeAnalysis.CSharp.BraceCompletion
{
    ...
    internal class CurlyBraceCompletionService : AbstractBraceCompletionService
    {
        ...
        )
        {
            ...
            if (
                OpeningBrace == brace
                && await InterpolationBraceCompletionService
                    .IsPositionInInterpolationContextAsync(
                        document,
                        openingPosition,
                        cancellationToken
                    )
        ...
        )
        {
            ...
            static async Task<Document> GetDocumentWithAnnotatedClosingBraceAsync(
                Document document,
                int closingBraceEndPoint,
                CancellationToken cancellationToken
            )
        ...
        private sealed class BraceCompletionFormattingRule : BaseFormattingRule
        {
            ...
            private readonly struct CachedOptions : IEquatable<CachedOptions>
            {
                ...
                {
                    return NewLinesForBracesInObjectCollectionArrayInitializers
