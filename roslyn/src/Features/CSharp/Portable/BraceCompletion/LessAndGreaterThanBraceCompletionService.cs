...
namespace Microsoft.CodeAnalysis.CSharp.BraceCompletion
{
    ...
    internal class LessAndGreaterThanBraceCompletionService : AbstractCSharpBraceCompletionService
    {
        ...
        )
        {
            ...
            if (
                token.Parent is not BinaryExpressionSyntax(SyntaxKind.LessThanExpression) node
            ...
            return IsSemanticTypeArgumentAsync(
                document,
                node.SpanStart,
                identifier,
                cancellationToken
            ...
            static async Task<bool> IsSemanticTypeArgumentAsync(
                Document document,
                int position,
