...
namespace Microsoft.CodeAnalysis.CSharp.BraceCompletion
{
    ...
    internal class LessAndGreaterThanBraceCompletionService : AbstractCSharpBraceCompletionService
    {
        ...
        protected override async ValueTask<bool> IsValidOpenBraceTokenAtPositionAsync(
            Document document,
            SyntaxToken token,
            int position,
            CancellationToken cancellationToken
        ...
        private static async ValueTask<bool> PossibleTypeArgumentAsync(
            Document document,
            SyntaxToken token,
            CancellationToken cancellationToken
        )
        {
            ...
            var semanticModel = await document
                .ReuseExistingSpeculativeModelAsync(leftNode.SpanStart, cancellationToken)
                .ConfigureAwait(false);
