...
namespace Microsoft.CodeAnalysis.CSharp.ConvertProgram
{
    ...
    [
        ExportCodeFixProvider(
            ...
            Name = PredefinedCodeFixProviderNames.ConvertToTopLevelStatements
        ),
        Shared
    ]
    internal class ConvertToTopLevelStatementsCodeFixProvider : SyntaxEditorBasedCodeFixProvider
    {
        ...
        public override async Task RegisterCodeFixesAsync(CodeFixContext context)
        {
            ...
            RegisterCodeFix(
                ...
                nameof(ConvertToTopLevelStatementsCodeFixProvider),
                priority
            );
        }
        ...
        )
        {
            ...
            var newDocument = await ConvertToTopLevelStatementsAsync(
                    document,
                    methodDeclaration,
                    fallbackOptions,
                    cancellationToken
