...
namespace Microsoft.CodeAnalysis.CSharp.ConvertProgram
{
    ...
    [
        ExportCodeRefactoringProvider(
            ...
            Name = PredefinedCodeRefactoringProviderNames.ConvertToTopLevelStatements
        ),
        Shared
    ]
    internal class ConvertToTopLevelStatementsCodeRefactoringProvider : CodeRefactoringProvider
    {
        ...
        public override async Task ComputeRefactoringsAsync(CodeRefactoringContext context)
        {
            ...
            if (
                document.Project.ParseOptions!.LanguageVersion() < LanguageVersion.CSharp9
            ...
            var methodDeclaration = await context
                .TryGetRelevantNodeAsync<MethodDeclarationSyntax>()
            ...
            var options = await document
                ...
                .ConfigureAwait(false);
            if (
                !CanOfferUseTopLevelStatements(options.PreferTopLevelStatements, forAnalyzer: false)
            )
                return;
            ...
            context.RegisterRefactoring(
                CodeAction.Create(
                    ...
                    c =>
                        ConvertToTopLevelStatementsAsync(
                            document,
                            methodDeclaration,
                            context.Options,
                            c
