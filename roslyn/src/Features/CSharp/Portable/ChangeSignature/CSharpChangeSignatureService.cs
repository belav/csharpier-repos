...
namespace Microsoft.CodeAnalysis.CSharp.ChangeSignature
{
    ...
    internal sealed class CSharpChangeSignatureService : AbstractChangeSignatureService
    {
        ...
        {
            var parameters = matchingNode.ChildNodes()
        ...
        private static bool InSymbolHeader(SyntaxNode matchingNode, int position)
        {
            ...
            var lastAttributes = matchingNode.ChildNodes()
            ...
            var parameterList = matchingNode.ChildNodes()
        ...
        private static ImmutableArray<SyntaxNode> VerifyAndPermuteParamNodes(
            ...
            foreach (var paramNode in paramNodes)
            {
                ...
                var identifier = nameAttribute.DescendantNodes(descendIntoTrivia: true)
