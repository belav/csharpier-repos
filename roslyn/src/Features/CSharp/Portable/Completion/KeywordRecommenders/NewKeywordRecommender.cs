...
namespace Microsoft.CodeAnalysis.CSharp.Completion.KeywordRecommenders
{
    internal class NewKeywordRecommender : AbstractSyntacticSingleKeywordRecommender
    {
        ...
        protected static readonly ISet<SyntaxKind> ValidTypeModifiers = new HashSet<SyntaxKind>(
            SyntaxFacts.EqualityComparer
        )
        {
            SyntaxKind.AbstractKeyword,
        ...
        public NewKeywordRecommender() : base(SyntaxKind.NewKeyword) { }
        ...
        )
        {
            ...
            )
            {
                ...
                return token
                    ...
                    .Any(
                        t =>
                            token.SpanStart > t.OpenBraceToken.Span.End
        ...
        private static bool IsNewConstraintContext(CSharpSyntaxContext context)
        {
            ...
            if (
                ...
                && token.Parent.IsKind<TypeParameterConstraintClauseSyntax>(
                    SyntaxKind.TypeParameterConstraintClause,
                    out var constraintClause
                )
            )
            {
                if (
