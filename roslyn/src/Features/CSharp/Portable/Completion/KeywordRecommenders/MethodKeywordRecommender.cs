...
internal sealed class MethodKeywordRecommender()
    : AbstractSyntacticSingleKeywordRecommender(SyntaxKind.MethodKeyword)
{
            ...
            return token.Parent
                is AttributeListSyntax
                {
                    Parent: PropertyDeclarationSyntax
                        ...
                        (kind: SyntaxKind.ClassDeclaration or SyntaxKind.StructDeclaration)
                        {
