...
namespace Microsoft.CodeAnalysis.CSharp.Completion.Providers
{
        ...
        : AbstractPartialTypeCompletionProvider<CSharpSyntaxContext>
    {
        ...
        {
            var candidates = base
                .LookupCandidateSymbols(context, declaredSymbol, cancellationToken);
        ...
        )
        {
            ...
            return await base
                .GetTextChangeAsync(document, selectedItem, ch, cancellationToken)
