...
namespace Microsoft.CodeAnalysis.CSharp.Completion.Providers
{
    ...
    internal class PropertySubpatternCompletionProvider : LSPCompletionProvider
    {
        ...
        public override async Task ProvideCompletionsAsync(CompletionContext context)
        {
            ...
            var propertyPatternType =
                semanticModel.GetTypeInfo(
                    (PatternSyntax)propertyPatternClause.Parent!,
                    cancellationToken
                ).ConvertedType;
        ...
        private static (PropertyPatternClauseSyntax?, ExpressionSyntax?) TryGetPropertyPatternClause(
            SyntaxTree tree,
            int position,
            CancellationToken cancellationToken
        )
        {
            ...
            )
            {
                ...
                if (
                    ...
                    {
                        Parent:
                        { Parent: SubpatternSyntax { Parent: PropertyPatternClauseSyntax found } }
                    }
                )
                {
