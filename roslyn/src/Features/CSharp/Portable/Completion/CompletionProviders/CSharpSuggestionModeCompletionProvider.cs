...
namespace Microsoft.CodeAnalysis.CSharp.Completion.Providers
{
    ...
    internal class CSharpSuggestionModeCompletionProvider : AbstractSuggestionModeCompletionProvider
    {
        ...
        )
        {
            ...
            //    Goo(async(p1, $$
            if (
                token.Kind() is SyntaxKind.OpenParenToken or SyntaxKind.CommaToken
            ...
            return inferredTypeInfo.Any(
                static (type, semanticModel) =>
                    GetDelegateType(type, semanticModel.Compilation).IsDelegateType(),
                semanticModel
            );
        }
