...
namespace Microsoft.CodeAnalysis.CSharp.NameTupleElement
{
    ...
    [
        ExportCodeRefactoringProvider(
            ...
            Name = PredefinedCodeRefactoringProviderNames.NameTupleElement
        ),
        Shared
    ]
    internal class CSharpNameTupleElementCodeRefactoringProvider
        : AbstractNameTupleElementCodeRefactoringProvider<ArgumentSyntax, TupleExpressionSyntax>
    {
