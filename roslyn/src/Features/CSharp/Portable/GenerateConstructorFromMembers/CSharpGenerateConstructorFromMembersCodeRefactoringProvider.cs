...
namespace Microsoft.CodeAnalysis.CSharp.GenerateConstructorFromMembers
{
        ...
        : AbstractGenerateConstructorFromMembersCodeRefactoringProvider
    {
        ...
        protected override IFieldSymbol? TryMapToWritableInstanceField(
        ...
        )
        {
            ...
            var getAccessor = propertyDeclaration.AccessorList?.Accessors.FirstOrDefault(a =>
            ...
            return property.ContainingType.GetMembers(accessedMemberName).FirstOrDefault()
                as IFieldSymbol;
        }
