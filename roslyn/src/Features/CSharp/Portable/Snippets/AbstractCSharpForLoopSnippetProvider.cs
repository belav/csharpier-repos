...
namespace Microsoft.CodeAnalysis.CSharp.Snippets
{
    internal abstract class AbstractCSharpForLoopSnippetProvider : AbstractForLoopSnippetProvider
    {
        ...
        protected abstract ExpressionSyntax GenerateInitializerValue(
            SyntaxGenerator generator,
            SyntaxNode? inlineExpression
        );

        protected abstract ExpressionSyntax GenerateRightSideOfCondition(
            SyntaxGenerator generator,
            SyntaxNode? inlineExpression
        );
        ...
        )
        {
            ...
            {
                iteratorTypeSyntax = compilation
            ...
            else
            {
                ...
                Debug.Assert(
                    inlineExpressionType is not null
                        && (
                            inlineExpressionType.IsIntegralType()
                            || inlineExpressionType.IsNativeIntegerType
                        )
                );
            ...
            return SyntaxFactory.ForStatement(
                ...
                SyntaxFactory.BinaryExpression(
                    ConditionKind,
                    indexVariable,
                    GenerateRightSideOfCondition(generator, inlineExpression)
                ),
        ...
        private static void GetPartsOfForStatement(
            SyntaxNode node,
            out SyntaxNode? declaration,
            out SyntaxNode? condition,
            out SyntaxNode? incrementor,
