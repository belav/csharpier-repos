...
namespace Microsoft.CodeAnalysis.CSharp.UseNamedArguments
{
    ...
    [
        ExportCodeRefactoringProvider(
            ...
            Name = PredefinedCodeRefactoringProviderNames.UseNamedArguments
        ),
        Shared
    ]
        ...
        : AbstractUseNamedArgumentsCodeRefactoringProvider
    {
            ...
            where TSyntaxList : SyntaxNode
        {
            ...
            protected sealed override bool IsLegalToAddNamedArguments(
            ...
            protected override bool IsImplicitIndexOrRangeIndexer(
                ImmutableArray<IParameterSymbol> parameters,
                TSyntax argument,
            ...
            )
            {
                ...
                if (
                    argType?.ContainingNamespace
                        is { Name: nameof(System), ContainingNamespace.IsGlobalNamespace: true }
        ...
        private class ArgumentAnalyzer : BaseAnalyzer<ArgumentSyntax, BaseArgumentListSyntax>
        {
            ...
            protected override BaseArgumentListSyntax WithArguments(
                BaseArgumentListSyntax argumentList,
                IEnumerable<ArgumentSyntax> namedArguments,
            ...
            protected override ExpressionSyntax GetArgumentExpression(
            ...
            : BaseAnalyzer<AttributeArgumentSyntax, AttributeArgumentListSyntax>
        {
            ...
            protected override SeparatedSyntaxList<AttributeArgumentSyntax> GetArguments(
            ...
            protected override AttributeArgumentSyntax WithName(
