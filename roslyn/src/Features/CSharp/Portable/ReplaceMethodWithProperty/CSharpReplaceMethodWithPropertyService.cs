          ...
          IReplaceMethodWithPropertyService
    {
        ...
        )
        {
            ...
            if (nameChanged)
            {
                if (invocation == null)
                {
                    newName = SyntaxFactory.IdentifierName(
                        SyntaxFactory.Identifier(propertyName).WithTriviaFrom(nameToken)
                    );
                }
                else
                {
                    newName = SyntaxFactory.IdentifierName(
                        SyntaxFactory
                            ...
                            .WithTrailingTrivia(
                                invocation.ArgumentList.CloseParenToken.TrailingTrivia
                            )
                    );
                }
            }
