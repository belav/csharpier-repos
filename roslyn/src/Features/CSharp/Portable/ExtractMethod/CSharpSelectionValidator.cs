    ...
    internal partial class CSharpSelectionValidator : SelectionValidator
    {
        ...
        )
        {
            ...
            if (_localFunction)
            {
                ...
                {
                    if (
                        ancestor.IsKind(SyntaxKind.BaseConstructorInitializer)
                        || ancestor.IsKind(SyntaxKind.ThisConstructorInitializer)
                    )
                    {
                        return selectionInfo.WithStatus(
                            s =>
            ...
            )
            {
                selectionInfo = selectionInfo.WithStatus(
                    s =>
                        s.With(
                            OperationStatusFlag.None,
                            CSharpFeaturesResources.Contains_invalid_selection
                        )
                );
            }
