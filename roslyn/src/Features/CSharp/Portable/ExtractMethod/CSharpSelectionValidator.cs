...
namespace Microsoft.CodeAnalysis.CSharp.ExtractMethod
{
    internal partial class CSharpSelectionValidator : SelectionValidator
    {
        ...
        {
            if (
                selectionInfo.Status.FailedWithNoBestEffortSuggestion()
                || !selectionInfo.SelectionInExpression
            ) {
        ...
        private SelectionInfo GetInitialSelectionInfo(SyntaxNode root, SourceText text)
        {
            ...
            if (
                ...
                return new SelectionInfo
                {
                    Status = new OperationStatus(
                        OperationStatusFlag.None,
                        CSharpFeaturesResources.Invalid_selection
                    ),
            ...
            if (
                ...
                return new SelectionInfo
                {
                    Status = new OperationStatus(
                        OperationStatusFlag.None,
                        CSharpFeaturesResources.Selection_does_not_contain_a_valid_token
                    ),
                    OriginalSpan = adjustedSpan,
            ...
            if (
                ...
                return new SelectionInfo
                {
                    Status = new OperationStatus(
                        OperationStatusFlag.None,
                        CSharpFeaturesResources.No_valid_selection_to_perform_extraction
                    ),
                    OriginalSpan = adjustedSpan,
                    FirstTokenInOriginalSpan = firstTokenInSelection,
                    LastTokenInOriginalSpan = lastTokenInSelection
            ...
            if (commonRoot == null)
            {
                return new SelectionInfo
                {
                    Status = new OperationStatus(
                        OperationStatusFlag.None,
                        CSharpFeaturesResources.No_common_root_node_for_extraction
                    ),
                    OriginalSpan = adjustedSpan,
                    FirstTokenInOriginalSpan = firstTokenInSelection,
                    LastTokenInOriginalSpan = lastTokenInSelection
        ...
        public override IEnumerable<SyntaxNode> GetOuterReturnStatements(
            ...
            var container = commonRoot.GetAncestorsOrThis<SyntaxNode>()
        ...
        public override bool IsFinalSpanSemanticallyValidSpan(
            ...
            var container = lastToken.GetAncestors<SyntaxNode>()
