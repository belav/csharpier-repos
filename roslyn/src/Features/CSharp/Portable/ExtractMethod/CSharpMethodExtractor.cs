...
namespace Microsoft.CodeAnalysis.CSharp.ExtractMethod
{
    internal partial class CSharpMethodExtractor : MethodExtractor
    {
        ...
        )
        {
            ...
            return await InsertionPoint.CreateAsync(document, memberNode, cancellationToken)
                .ConfigureAwait(false);
        }
        ...
        protected override async Task<TriviaResult> PreserveTriviaAsync(
            ...
            await CSharpTriviaResult.ProcessAsync(selectionResult, cancellationToken)
                .ConfigureAwait(false);
        ...
        protected override IEnumerable<AbstractFormattingRule> GetFormattingRules(
            ...
            SpecializedCollections.SingletonEnumerable(new FormattingRule())
