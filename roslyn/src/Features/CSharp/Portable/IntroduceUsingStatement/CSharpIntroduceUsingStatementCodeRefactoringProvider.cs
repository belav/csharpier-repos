...
namespace Microsoft.CodeAnalysis.CSharp.IntroduceUsingStatement
{
        ...
        >
    {
        ...
        )
        {
            ...
            // using-declarations are not allowed in switch sections (due to craziness with how switch section
            // scoping works).
            if (
                declarationStatement.Parent is SwitchSectionSyntax
            ...
            usingDeclarationStatement = declarationStatement
                ...
                .WithUsingKeyword(
                    SyntaxFactory.Token(
                        declarationStatement.GetLeadingTrivia(),
