...
{
    [DataContract]
    internal partial struct UnitTestingInvocationReasons(ImmutableHashSet<string> reasons)
        : IEnumerable<string>
    {
        ...
        private readonly ImmutableHashSet<string> _reasons =
            reasons ?? ImmutableHashSet<string>.Empty;
        ...
        public UnitTestingInvocationReasons With(string reason) => new(_reasons.Add(reason));
