...
namespace Microsoft.CodeAnalysis.ExternalAccess.UnitTesting.Api
{
    ...
    {
        public static readonly UnitTestingInvocationReasons DocumentAdded = new(
        ...
        public static readonly UnitTestingInvocationReasons DocumentRemoved = new(
            ImmutableHashSet.Create<string>(
#if false // Not used in unit testing crawling
        ...
        public static readonly UnitTestingInvocationReasons ProjectConfigurationChanged = new(
            ImmutableHashSet.Create<string>(
        ...
        public static readonly UnitTestingInvocationReasons DocumentChanged = new(
            ImmutableHashSet.Create<string>(
#if false // Not used in unit testing crawling
                                    UnitTestingPredefinedInvocationReasons.SyntaxChanged,
#endif
        ...
        public static readonly UnitTestingInvocationReasons AdditionalDocumentChanged = new(
            ImmutableHashSet.Create<string>(
#if false // Not used in unit testing crawling
                                    UnitTestingPredefinedInvocationReasons.SyntaxChanged,
#endif
        ...
        public static readonly UnitTestingInvocationReasons SemanticChanged = new(
            ImmutableHashSet.Create<string>(UnitTestingPredefinedInvocationReasons.SemanticChanged)
        );

        public static readonly UnitTestingInvocationReasons Reanalyze = new(
