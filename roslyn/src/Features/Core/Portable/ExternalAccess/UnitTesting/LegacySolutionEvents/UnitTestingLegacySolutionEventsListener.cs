...
{
    /// <summary>
    /// Retrieves stream of workspace events and forwards them to the dedicated solution crawler
    ...
    internal class UnitTestingLegacySolutionEventsListener : ILegacySolutionEventsListener
    {
        ...
        {
            var service =
                solution.Services.GetService<IUnitTestingSolutionCrawlerRegistrationService>();
            if (service == null)
                return null;
