        ...
        : IUnitTestingSolutionCrawlerRegistrationService
    {
        ...
        [
            ExportWorkspaceService(
                typeof(IUnitTestingSolutionCrawlerService),
        ...
        internal class UnitTestingSolutionCrawlerService : IUnitTestingSolutionCrawlerService
        {
            ...
            )
            {
                ...
                if (
                    ...
                    is UnitTestingSolutionCrawlerRegistrationService registration
                )
                {
            ...
            public IUnitTestingSolutionCrawlerProgressReporter GetProgressReporter(
                Workspace workspace
            )
            {
                // if solution crawler doesn't exist for the given workspace, return null reporter
                if (
                    workspace.Services.GetService<IUnitTestingSolutionCrawlerRegistrationService>()
                    is UnitTestingSolutionCrawlerRegistrationService registration
                )
                {
