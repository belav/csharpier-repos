...
namespace Microsoft.CodeAnalysis.MoveToNamespace
{
    [
        ExportCodeRefactoringProvider(
            ...
            Name = PredefinedCodeRefactoringProviderNames.MoveToNamespace
        ),
        Shared
    ]
    ...
    internal class MoveToNamespaceCodeActionProvider : CodeRefactoringProvider
    {
        ...
        public override async Task ComputeRefactoringsAsync(CodeRefactoringContext context)
        {
            ...
            var actions = await moveToNamespaceService
                .GetCodeActionsAsync(document, textSpan, context.Options, cancellationToken)
