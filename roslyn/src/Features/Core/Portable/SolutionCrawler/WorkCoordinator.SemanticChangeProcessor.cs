    ...
    internal sealed partial class SolutionCrawlerRegistrationService
    {
        ...
        internal sealed partial class WorkCoordinator
        {
            private sealed class SemanticChangeProcessor : IdleProcessor
            {
                ...
                private Data Dequeue() => DequeueWorker(_workGate, _pendingWork, CancellationToken);
                ...
                )
                {
                    ...
                    return graph.GetProjectsThatTransitivelyDependOnThisProject(projectId)
                        .Concat(projectId);
                }
                ...
                private class ProjectProcessor : IdleProcessor
                {
                    ...
                    public async Task EnqueueWorkItemAsync(Document document)
                    {
                        ...
                        var isLowPriority =
                            ...
                            && await priorityService.IsLowPriorityAsync(document, CancellationToken)
                                .ConfigureAwait(false);
