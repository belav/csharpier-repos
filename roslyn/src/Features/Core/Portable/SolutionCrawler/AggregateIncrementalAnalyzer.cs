...
namespace Microsoft.CodeAnalysis.SolutionCrawler
{
    internal class AggregateIncrementalAnalyzer : IIncrementalAnalyzer
    {
        ...
        public async Task NewSolutionSnapshotAsync(
            Solution solution,
        ...
        )
        {
            ...
            {
                await analyzer
                    .ActiveDocumentSwitchedAsync(document, cancellationToken)
                    .ConfigureAwait(false);
            }
        }
        ...
        )
        {
            ...
            {
                await analyzer
                    .AnalyzeDocumentAsync(document, bodyOpt, reasons, cancellationToken)
                    .ConfigureAwait(false);
            }
        }
        ...
        )
        {
            ...
            {
                await analyzer
                    .AnalyzeProjectAsync(project, semanticsChanged, reasons, cancellationToken)
                    .ConfigureAwait(false);
            }
        }

        private bool TryGetAnalyzer(
            Project project,
            [NotNullWhen(true)] out IIncrementalAnalyzer? analyzer
        )
        {
        ...
        public async Task NonSourceDocumentOpenAsync(
        ...
        )
        {
            ...
            {
                await analyzer
                    .NonSourceDocumentOpenAsync(textDocument, cancellationToken)
                    .ConfigureAwait(false);
            }
        }

        public async Task NonSourceDocumentCloseAsync(
            TextDocument textDocument,
            CancellationToken cancellationToken
        )
        {
            ...
            {
                await analyzer
                    .NonSourceDocumentCloseAsync(textDocument, cancellationToken)
                    .ConfigureAwait(false);
            }
        }

        public async Task NonSourceDocumentResetAsync(
            TextDocument textDocument,
            CancellationToken cancellationToken
        )
        {
        ...
        public async Task AnalyzeNonSourceDocumentAsync(
            TextDocument textDocument,
            InvocationReasons reasons,
            CancellationToken cancellationToken
        )
        {
            ...
            {
                await analyzer
                    .AnalyzeNonSourceDocumentAsync(textDocument, reasons, cancellationToken)
                    .ConfigureAwait(false);
            }
        }
