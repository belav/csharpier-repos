        ...
        internal sealed partial class WorkCoordinator
        {
            ...
            )
            {
                ...
                _workspaceConfigurationService =
                    _registration.Workspace.Services.GetService<IWorkspaceConfigurationService>();
            ...
            private void OnActiveDocumentSwitched(object? sender, DocumentId? activeDocumentId)
            {
                ...
                EnqueueFullDocumentEvent(
                    solution,
                    activeDocumentId,
                    InvocationReasons.ActiveDocumentSwitched,
                    eventName: nameof(OnActiveDocumentSwitched)
                );
            }
            ...
            private void ProcessEvent(WorkspaceChangeEventArgs args, string eventName)
            {
                ...
                switch (args.Kind)
                {
                    ...
                    case WorkspaceChangeKind.SolutionCleared:
                        EnqueueFullSolutionEvent(
                            args.OldSolution,
                            InvocationReasons.SolutionRemoved,
                            eventName
                        );
                        break;
            ...
            )
            {
                ...
                if (
                    invocationReasons.Contains(PredefinedInvocationReasons.SemanticChanged)
                    && sourceDocument != null
                )
                {
