...
namespace Microsoft.CodeAnalysis.SpellCheck
{
        ...
        where TSimpleName : SyntaxNode
    {
        ...
        )
        {
            ...
            {
                HideAdvancedMembers = context.Options
            ...
            await CheckItemsAsync(context, nameToken, isGeneric, completionList, similarityChecker)
                .ConfigureAwait(false);
        }
        ...
        )
        {
            ...
            var change = await service
                .GetChangeAsync(document, item, commitCharacter: null, cancellationToken)
                .ConfigureAwait(false);
