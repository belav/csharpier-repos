    ...
    internal partial class DiagnosticIncrementalAnalyzer
    {
        ...
        )
        {
            try
            {
                ...
                if (
                    DiagnosticAnalyzerInfoCache.IsAnalyzerSuppressed(
                        stateSet.Analyzer,
                        document.Project
                    )
                )
        ...
        private static async Task<(
            DiagnosticAnalysisResult loadDiagnostics,
            ImmutableHashSet<Document>? failedDocuments
        )> GetDocumentLoadFailuresAsync(
            Project project,
            VersionStamp version,
            CancellationToken cancellationToken
        )
        ...
        internal static bool FullAnalysisEnabled(Project project, bool forceAnalyzerRun)
        {
            ...
            return SolutionCrawlerOptions.GetBackgroundAnalysisScope(project)
