    ...
    internal partial class DiagnosticIncrementalAnalyzer
    {
        ...
        )
        {
            ...
            )
            {
                ...
                await _stateManager
                    .OnDocumentOpenedAsync(stateSets, document)
                    .ConfigureAwait(false);
            }
        }
        ...
        )
        {
            ...
            )
            {
                ...
                ClearCompilationsWithAnalyzersCache();
                var documentHadDiagnostics = await _stateManager
                    .OnDocumentClosedAsync(stateSets, document)
                    .ConfigureAwait(false);
        ...
        )
        {
            ...
            return stateSets.Where(
                s => IsCandidateForFullSolutionAnalysis(s.Analyzer, project, analyzerConfigOptions)
            );
        }
        ...
        )
        {
            ...
            return descriptors.Any(
                d =>
                    d.GetEffectiveSeverity(project.CompilationOptions!, analyzerConfigOptions)
        ...
        private void RaiseProjectDiagnosticsCreated(
            Project project,
            StateSet stateSet,
