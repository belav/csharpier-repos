...
namespace Microsoft.CodeAnalysis.Diagnostics.EngineV2
{
    internal partial class DiagnosticIncrementalAnalyzer
    {
            ...
            )
            {
                ...
                foreach (var stateSet in stateSets)
                    documentHadDiagnostics |= await stateSet
                        .OnDocumentClosedAsync(document)
                        .ConfigureAwait(false);
        ...
        private static bool AnalysisEnabled(
            TextDocument document,
        ...
        /// </summary>
        private IReadOnlyList<StateSet> GetStateSetsForFullSolutionAnalysis(
            IEnumerable<StateSet> stateSets,
            Project project
        )
        {
            ...
            return stateSets
                .Where(
                    s =>
                        IsCandidateForFullSolutionAnalysis(
                            s.Analyzer,
                            project,
