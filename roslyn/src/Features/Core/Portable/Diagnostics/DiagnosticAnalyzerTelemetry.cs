    ...
    internal sealed class DiagnosticAnalyzerTelemetry
    {
        ...
        )
        {
            ...
            public readonly int CompilationEndActionsCount =
                analyzerTelemetryInfo.CompilationEndActionsCount;
            public readonly int CompilationActionsCount =
                analyzerTelemetryInfo.CompilationActionsCount;
            public readonly int SyntaxTreeActionsCount =
                analyzerTelemetryInfo.SyntaxTreeActionsCount;
            public readonly int AdditionalFileActionsCount =
                analyzerTelemetryInfo.AdditionalFileActionsCount;
            public readonly int SemanticModelActionsCount =
                analyzerTelemetryInfo.SemanticModelActionsCount;
            ...
            public readonly int SyntaxNodeActionsCount =
                analyzerTelemetryInfo.SyntaxNodeActionsCount;
            public readonly int CodeBlockStartActionsCount =
                analyzerTelemetryInfo.CodeBlockStartActionsCount;
            public readonly int CodeBlockEndActionsCount =
                analyzerTelemetryInfo.CodeBlockEndActionsCount;
            ...
            public readonly int OperationBlockActionsCount =
                analyzerTelemetryInfo.OperationBlockActionsCount;
            public readonly int SuppressionActionsCount =
                analyzerTelemetryInfo.SuppressionActionsCount;
                ...
                Logger.Log(
                    ...
                    KeyValueLogMessage.Create(m =>
                    {
                        ...
                        else
                        {
                            ...
                            m["Analyzer.NameHashCode"] = AnalyzerNameForTelemetry.ComputeSha256Hash(
                                analyzerName
                            );
                        }
