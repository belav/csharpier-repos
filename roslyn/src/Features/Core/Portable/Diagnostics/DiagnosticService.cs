    ...
    internal partial class DiagnosticService : IDiagnosticService
    {
        ...
        private void RaiseDiagnosticsCleared(IDiagnosticUpdateSource source)
        {
            ...
            _eventQueue.ScheduleTask(
                ...
                () =>
                {
                    using var pooledObject = SharedPools.Default<List<DiagnosticsUpdatedArgs>>()
                        .GetPooledObject();
        ...
        [Obsolete]
        ImmutableArray<DiagnosticData> IDiagnosticService.GetDiagnostics(
            Workspace workspace,
            ProjectId projectId,
        ...
        private readonly struct Data
        {
            ...
            public Data(UpdatedEventArgs args) : this(args, ImmutableArray<DiagnosticData>.Empty)
            { }
