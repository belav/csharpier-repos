    ...
    internal partial class NavigateToSearcher
    {
        ...
        internal async Task SearchAsync(CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                searchWasComplete = await SearchAllProjectsAsync(cancellationToken)
        ...
        private async Task<bool> SearchAllProjectsAsync(CancellationToken cancellationToken)
        {
            ...
            // that support that.
            var (projectSystemIsFullyLoaded, remoteHostIsFullyLoaded) = await _host
            ...
            var projectsUsingCache = projectResults
                .Where(t => t.location == NavigateToSearchLocation.Cache)
