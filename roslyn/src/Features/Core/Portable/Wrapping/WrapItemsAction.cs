...
namespace Microsoft.CodeAnalysis.Wrapping
{
    ...
    /// invoked.
    /// </summary>
    internal sealed class WrapItemsAction(
        string title,
        string parentTitle,
        Func<
        ...
        : DocumentChangeAction(
            title,
            createChangedDocument,
            GetSortTitle(parentTitle, title),
        ...
        )
    {
        ...
        > ComputePreviewOperationsAsync(CancellationToken cancellationToken)
        {
            ...
            return await base.ComputeOperationsAsync(CodeAnalysisProgress.None, cancellationToken)
        ...
        {
            var operations = await base.ComputeOperationsAsync(progress, cancellationToken)
                .ConfigureAwait(false);
        ...
        private class RecordCodeActionOperation(string sortTitle, string parentTitle)
            : CodeActionOperation
        {
            ...
            public override void Apply(Workspace workspace, CancellationToken cancellationToken)
            {
                ...
                s_mruTitles = s_mruTitles
                    .Remove(_sortTitle)
                    .Remove(_parentTitle)
                    .Insert(0, _sortTitle)
                    .Insert(0, _parentTitle);
            }
        }
    }
}
