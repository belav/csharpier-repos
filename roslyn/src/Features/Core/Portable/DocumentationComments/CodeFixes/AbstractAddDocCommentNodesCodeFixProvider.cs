        ...
        where TMemberDeclarationSyntax : SyntaxNode
    {
        ...
        protected async Task<Document> AddParamTagAsync(
            ...
            for (var index = 0; index < parameterNames.Count; index++)
            {
                ...
                var paramsBeforeCurrentParam = parameterNames.TakeWhile(t => t != parameterName)
                    .ToList();
                var paramsAfterCurrentParam = parameterNames.Except(paramsBeforeCurrentParam)
                    .ToList();
        ...
        {
            var nodes = docComment.ChildNodes()
