...
namespace Microsoft.CodeAnalysis.DocumentationComments
{
        ...
        where TMemberNode : SyntaxNode
    {
        ...
        )
        {
            ...
            indentText = lineOffset.CreateIndentationString(
        ...
        )
        {
            ...
            var indentText = lineOffset.CreateIndentationString(
                options.GetOption(FormattingOptions.UseTabs),
                options.GetOption(FormattingOptions.TabSize)
            );
            IndentLines(lines, indentText);
        ...
        )
        {
            ...
            var firstNonWhitespaceColumn =
                previousLineText.GetColumnOfFirstNonWhitespaceCharacterOrEndOfLine(tabSize);
            ...
            return firstNonWhitespaceColumn.CreateIndentationString(useTabs, tabSize)
                + ExteriorTriviaText
                + extraIndent;
        }
    }
