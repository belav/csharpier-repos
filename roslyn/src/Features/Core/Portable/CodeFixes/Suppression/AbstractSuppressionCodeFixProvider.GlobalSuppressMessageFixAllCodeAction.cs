...
namespace Microsoft.CodeAnalysis.CodeFixes.Suppression
{
    internal abstract partial class AbstractSuppressionCodeFixProvider : IConfigurationFixProvider
    {
            ...
            : AbstractGlobalSuppressMessageCodeAction
        {
            ...
            ) : SolutionChangeAction(title, createChangedSolution, equivalenceKey)
            {
            ...
            )
            {
                ...
                var cleanupOptions = await suppressionsDoc
                    .GetCodeCleanupOptionsAsync(_fallbackOptions, cancellationToken)
                    .ConfigureAwait(false);
                ...
                var final = await CleanupDocumentAsync(result, cleanupOptions, cancellationToken)
                    .ConfigureAwait(false);
                return final;
            }

            private static async Task<
                IEnumerable<KeyValuePair<ISymbol, ImmutableArray<Diagnostic>>>
