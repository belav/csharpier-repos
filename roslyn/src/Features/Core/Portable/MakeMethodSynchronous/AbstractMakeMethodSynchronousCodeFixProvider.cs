...
namespace Microsoft.CodeAnalysis.MakeMethodSynchronous
{
    internal abstract class AbstractMakeMethodSynchronousCodeFixProvider : CodeFixProvider
    {
        ...
        )
        {
            ...
            return await RemoveAwaitFromCallersAsync(newDocument, annotation, cancellationToken)
                .ConfigureAwait(false);
        }
            ...
            if (methodDeclaration != null)
            {
                ...
                )
                {
                    ...
                    var referencedSymbol = references.FirstOrDefault(
                        r => Equals(r.Definition, methodSymbol)
                    );
        ...
        )
        {
            ...
            {
                RemoveAwaitFromCallerIfPresent(
                    editor,
                    syntaxFactsService,
                    root,
                    location,
        ...
        private class MyCodeAction : CodeAction.SolutionChangeAction
        {
            public MyCodeAction(Func<CancellationToken, Task<Solution>> createChangedSolution)
                : base(
                    ...
                    AbstractMakeMethodSynchronousCodeFixProvider.EquivalenceKey
                ) { }
        }
    }
}
