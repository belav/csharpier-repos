...
namespace Microsoft.CodeAnalysis.AddImport
{
    internal abstract partial class AbstractAddImportFeatureService<TSimpleNameSyntax>
    {
        private abstract class Reference : IEquatable<Reference>
        {
            ...
            > s_comparers = ImmutableArray.Create<Func<Reference, Document, IComparable>>(
            ...
            public override int GetHashCode() => Hash.CombineValues(SearchResult.NameParts);
            ...
            )
            {
                ...
                var newIdentifier = generator
                    .IdentifierName(SearchResult.DesiredName)
                    .GetFirstToken()
            ...
            )
            {
                ...
                var cleanedDocument = await CodeAction
                    .CleanupDocumentAsync(newDocument, options, cancellationToken)
                    .ConfigureAwait(false);
