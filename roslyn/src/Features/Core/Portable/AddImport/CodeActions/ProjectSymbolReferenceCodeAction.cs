        ...
        private class ProjectSymbolReferenceCodeAction : SymbolReferenceCodeAction
        {
            ...
            public ProjectSymbolReferenceCodeAction(
                ...
                : base(
                    originalDocument,
                    fixData,
                    additionalTags: ShouldAddProjectReference(originalDocument, fixData)
            ...
            private static bool ShouldAddProjectReference(
                Document originalDocument,
                AddImportFixData fixData
            ) =>
            ...
            private sealed class AddProjectReferenceCodeActionOperation(
            ...
            ) : CodeActionOperation
            {
                ...
                )
                {
                    ...
                    return _applyOperation.TryApplyAsync(
                        workspace,
                        originalSolution,
                        progressTracker,
                        cancellationToken
