...
namespace Microsoft.CodeAnalysis.ConvertToInterpolatedString
{
    ...
    [
        ExportCodeRefactoringProvider(
            ...
            Name = PredefinedCodeRefactoringProviderNames.ConvertToInterpolatedString
        ),
        Shared
    ]
        ...
        : CodeRefactoringProvider
    {
        ...
        public override async Task ComputeRefactoringsAsync(CodeRefactoringContext context)
        {
            ...
            if (!syntaxFacts.SupportsConstantInterpolatedStrings(document.Project.ParseOptions!))
            {
                ...
                var declarator = literalExpression.FirstAncestorOrSelf<SyntaxNode>(
                ...
                var attribute = literalExpression.FirstAncestorOrSelf<SyntaxNode>(
                    syntaxFacts.IsAttribute
                );
                if (attribute != null)
                    return;
            }
                ...
                document.WithSyntaxRoot(
                    root.ReplaceNode(
                        ...
                        CreateInterpolatedString(
                            document,
                            literalExpression,
                            syntaxFacts.IsVerbatimStringLiteral(token)
                        )
                    )
                )
            );
