...
namespace Microsoft.CodeAnalysis.EditAndContinue
{
    internal abstract class AbstractEditAndContinueAnalyzer : IEditAndContinueAnalyzer
    {
        ...
        /// </returns>
        protected abstract IEnumerable<(SyntaxNode statement, int statementPart)> EnumerateNearStatements(
        ...
        protected virtual bool StateMachineSuspensionPointKindEquals(
            SyntaxNode suspensionPoint1,
            SyntaxNode suspensionPoint2
        ...
        )
        {
            ...
            try
            {
                ...
                using var _3 =
                    ArrayBuilder<(SyntaxNode OldNode, SyntaxNode NewNode, TextSpan DiagnosticSpan)>.GetInstance(
                        out var triviaEdits
                    );
        ...
        )
        {
            ...
            var creatingStateMachineAroundActiveStatement =
                oldStateMachineSuspensionPoints.Length == 0
                && newStateMachineSuspensionPoints.Length > 0
            ...
            if (
                oldStateMachineSuspensionPoints.Length > 0
                || creatingStateMachineAroundActiveStatement
            )
            {
                AddMatchingStateMachineSuspensionPoints(
                    ref lazyKnownMatches,
                    ref lazyRudeEdits,
            ...
            {
                Debug.Assert(
                    oldStateMachineSuspensionPoints.Length == newStateMachineSuspensionPoints.Length
                );
                    ...
                    else
                    {
                        diagnostics.Add(
                            new RudeEditDiagnostic(
                                ...
                                new[]
                                {
                                    GetSuspensionPointDisplayName(oldNode, EditKind.Update),
                                    GetSuspensionPointDisplayName(newNode, EditKind.Update)
                                }
                            )
                        );
                    }
        ...
        )
        {
            ...
            else
            {
                ...
                var edits = GetSyntaxSequenceEdits(
                    oldStateMachineSuspensionPoints,
                    newStateMachineSuspensionPoints
                );
        ...
        private void AnalyzeTrivia(
            ...
            IReadOnlyDictionary<SyntaxNode, EditKind> editMap,
            [Out]
                ArrayBuilder<(SyntaxNode OldNode, SyntaxNode NewNode, TextSpan DiagnosticSpan)> triviaEdits,
        ...
        )
        {
            ...
            using var _ =
                ArrayBuilder<(string filePath, int oldStartLine, int oldEndLine, int delta, SyntaxNode oldNode, SyntaxNode newNode)>.GetInstance(
                    out var segments
                );
        ...
        protected static bool ParameterTypesEquivalent(
            ...
            oldParameters.SequenceEqual(
                ...
                (oldParameter, newParameter, exact) =>
                    ParameterTypesEquivalent(oldParameter, newParameter, exact)
            );
        ...
        protected static bool CustomModifiersEquivalent(
            ...
            oldModifiers.SequenceEqual(
                newModifiers,
                exact,
                (x, y, exact) => CustomModifiersEquivalent(x, y, exact)
            );
                            ...
                            case EditKind.Insert:

                                {
                                    ...
                                    else if (newContainingType != null && !IsGlobalMain(newSymbol))
                                    {
                                        ...
                                        if (
                                            oldContainingType != null
                                            && !CanAddNewMember(newSymbol, capabilities)
                                        )
                                        {
                                            diagnostics.Add(
                                                new RudeEditDiagnostic(
        ...
        {
            using var _1 =
                ArrayBuilder<(ISymbol? oldSymbol, ISymbol? newSymbol, EditKind editKind)>.GetInstance(
                    out var builder
                );
        ...
        private static bool CanAddNewMember(
            ISymbol newSymbol,
            EditAndContinueCapabilitiesGrantor capabilities
        )
        {
...
#nullable enable
        ...
        private IEnumerable<(SyntaxNode lambda, SyntaxNode lambdaBody1, SyntaxNode? lambdaBody2)> GetLambdaBodies(
            SyntaxNode body
        )
        {
