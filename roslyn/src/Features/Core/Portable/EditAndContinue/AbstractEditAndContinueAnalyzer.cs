    ...
    internal abstract class AbstractEditAndContinueAnalyzer : IEditAndContinueAnalyzer
    {
        ...
        )
        {
            ...
            try
            {
                ...
                var syntaxError = syntaxDiagnostics.FirstOrDefault(
...
#nullable enable
                                    ...
                                    parameterMap
                                        ...
                                        : bodyMap
                                            ...
                                            && bodyMap
                                                ...
                                                ? GetDiagnosticSpan(
                                                    newContainingLambdaSyntax,
                                                    EditKind.Update
                                                )
                                                : GetSymbolLocationSpan(
                                                    newMember,
                                                    cancellationToken
                                                ),
            ...
            public bool Equals(TypedConstant x, TypedConstant y) =>
                ...
                && x.Kind switch
                {
                    TypedConstantKind.Array
                        => x.Values.IsDefault || x.Values.SequenceEqual(y.Values, Instance),
        ...
        public IMethodSymbol? GetEncompassingPrimaryConstructor(
            ...
            IsPrimaryConstructorDeclaration(declaration)
