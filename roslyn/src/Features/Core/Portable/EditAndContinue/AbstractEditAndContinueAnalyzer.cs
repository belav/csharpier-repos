...
namespace Microsoft.CodeAnalysis.EditAndContinue
{
    internal abstract class AbstractEditAndContinueAnalyzer : IEditAndContinueAnalyzer
    {
        ...
        private static TraceLog Log => EditAndContinueWorkspaceService.AnalysisLog;
        ...
        /// </remarks>
        protected abstract SyntaxNode FindStatementAndPartner(
            SyntaxNode declarationBody,
            TextSpan span,
            SyntaxNode? partnerDeclarationBody,
            out SyntaxNode? partner,
            out int statementPart
        );

        private SyntaxNode FindStatement(
            SyntaxNode declarationBody,
            TextSpan span,
            out int statementPart
        ...
        /// </summary>
        internal abstract SyntaxNode FindDeclarationBodyPartner(
            SyntaxNode leftDeclaration,
            SyntaxNode rightDeclaration,
            SyntaxNode leftNode
        );
        ...
        /// </summary>
        protected abstract SyntaxNode? FindEnclosingLambdaBody(
        ...
        protected abstract SyntaxNode? TryGetPartnerLambdaBody(
            SyntaxNode oldBody,
        ...
        /// </summary>
        protected abstract ImmutableArray<ISymbol> GetCapturedVariables(
            SemanticModel model,
            SyntaxNode memberBody
        );
        ...
        internal abstract bool TryGetLambdaBodies(
            SyntaxNode node,
            [NotNullWhen(true)] out SyntaxNode? body1,
            out SyntaxNode? body2
        );
        ...
        /// </summary>
        internal abstract bool TryGetAssociatedMemberDeclaration(
            SyntaxNode node,
            EditKind editKind,
        ...
        /// </summary>
        internal abstract bool IsPropertyAccessorDeclarationMatchingPrimaryConstructorParameter(
            SyntaxNode declaration,
            INamedTypeSymbol newContainingType,
            out bool isFirstAccessor
        );
        ...
        /// </summary>
        internal virtual void ReportDeclarationInsertDeleteRudeEdits(
            ArrayBuilder<RudeEditDiagnostic> diagnostics,
            SyntaxNode oldNode,
            SyntaxNode newNode,
            ISymbol oldSymbol,
        ...
        )
        {
            ...
            if (
                oldSymbol
                    is INamedTypeSymbol { DelegateInvokeMethod: not null and var oldDelegateInvoke }
                && newSymbol
                    is INamedTypeSymbol { DelegateInvokeMethod: not null and var newDelegateInvoke }
            )
            {
                if (
                    !ParameterTypesEquivalent(
                        oldDelegateInvoke.Parameters,
                        newDelegateInvoke.Parameters,
                        exact: false
                    )
                )
                {
                    ReportUpdateRudeEdit(
                        diagnostics,
                        RudeEditKind.ChangingParameterTypes,
                        newSymbol,
                        newNode,
                        cancellationToken
                    );
        ...
        internal readonly struct ActiveNode
        {
            ...
            public ActiveNode(
                ...
                SyntaxNode oldNode,
                SyntaxNode? enclosingLambdaBody,
                int statementPart,
        ...
        )
        {
            ...
            var activeStatementIndices = GetOverlappingActiveStatements(
                oldDeclaration,
                oldActiveStatements
            );
            ...
            try
            {
                ReportMemberBodyUpdateRudeEdits(
                    diagnostics,
                    newDeclaration,
                ...
                var bodyMatch = ComputeBodyMatch(
                    oldBody,
                    newBody,
                    activeNodes.Where(n => n.EnclosingLambdaBody == null).ToArray(),
                    diagnostics,
                    out var oldHasStateMachineSuspensionPoint,
                    out var newHasStateMachineSuspensionPoint
                );
                var map = ComputeMap(
                    bodyMatch,
                    activeNodes,
                ...
                foreach (var activeNode in activeNodes)
                {
                    ...
                    // This may only happen when two or more member declarations share the same body (VB AsNew clause).
                    Debug.Assert(
                        IsDeclarationWithSharedBody(newDeclaration)
                            || newActiveStatements[activeStatementIndex] == null
                    );
                    Debug.Assert(newSpan != default);
        ...
        private bool TryGetTrackedStatement(
        ...
        )
        {
            ...
            GetStateMachineInfo(
                oldBody,
                out var oldStateMachineSuspensionPoints,
                out var oldStateMachineKinds
            );
            GetStateMachineInfo(
                newBody,
                out var newStateMachineSuspensionPoints,
            ...
            if (
                (oldStateMachineKinds & StateMachineKinds.Async) != 0
                && (newStateMachineKinds & StateMachineKinds.Async) == 0
            )
            {
                diagnostics.Add(
                    new RudeEditDiagnostic(
            ...
            if (
                (oldStateMachineKinds & StateMachineKinds.Iterator) != 0
                && (newStateMachineKinds & StateMachineKinds.Iterator) == 0
            )
            {
                diagnostics.Add(
                    new RudeEditDiagnostic(
        ...
        internal virtual void ReportStateMachineSuspensionPointDeletedRudeEdit(
            ArrayBuilder<RudeEditDiagnostic> diagnostics,
            Match<SyntaxNode> match,
            SyntaxNode deletedSuspensionPoint
        )
        {
            diagnostics.Add(
                new RudeEditDiagnostic(
        ...
        internal virtual void ReportStateMachineSuspensionPointInsertedRudeEdit(
            ArrayBuilder<RudeEditDiagnostic> diagnostics,
            Match<SyntaxNode> match,
            SyntaxNode insertedSuspensionPoint,
            bool aroundActiveStatement
        )
        {
            diagnostics.Add(
                new RudeEditDiagnostic(
        ...
        private static void AddMatchingActiveNodes(
        ...
        private TextSpan GetDeletedNodeDiagnosticSpan(
            SyntaxNode deletedLambdaBody,
            Match<SyntaxNode> match,
            Dictionary<SyntaxNode, LambdaInfo> lambdaInfos
        )
        {
        ...
        private IEnumerable<int> GetOverlappingActiveStatements(
            SyntaxNode declaration,
            ...
            where TSyntaxNode : SyntaxNode
        {
            ...
            var oldNodes = GetAncestors(
                GetEncompassingAncestor(match.OldRoot),
                oldActiveStatement,
                nodeSelector
            );
            ...
            where TSyntaxNode : SyntaxNode
        {
            ...
            for (var newIndex = 0; newIndex < newNodes.Count; newIndex++)
            {
                ...
                if (match == null)
                {
                    ...
                    match.TryGetOldNode(newNode, out var partner)
                    && comparer((TSyntaxNode)partner, (TSyntaxNode)newNode)
                )
                {
        ...
        )
        {
            ...
            foreach (var (oldNode, newNode) in topMatch.Matches)
            {
                ...
                var currentSegment = (
                    ...
                    oldStartLine: 0,
                    delta: 0,
                    firstOldNode: (SyntaxNode?)null,
                    firstNewNode: (SyntaxNode?)null
                );
                ...
                bool IsCurrentSegmentBreakpointSpanMappable()
                {
                    ...
                    if (
                        !TryGetEnclosingBreakpointSpan(
                            oldNode,
                            oldNode.SpanStart,
                            out var oldBreakpointSpan
                        )
                        || !TryGetEnclosingBreakpointSpan(
                            newNode,
                            newNode.SpanStart,
                            out var newBreakpointSpan
                        )
                    )
                    {
                        return true;
                ...
                while (true)
                {
                    ...
                    )
                    {
                        ...
                        currentSegment = (
                            ...
                            oldStartLine,
                            lineDelta,
                            oldTokensEnum.Current.Parent,
                            newTokensEnum.Current.Parent
                        );
                    }
            ...
            foreach (var segment in segments)
            {
                if (segment.filePath != currentDocumentPath)
                {
                    ...
                    segment.oldStartLine <= previousOldEndLine && segment.delta != previousLineDelta
                )
                {
        ...
        protected static bool SignaturesEquivalent(
            ImmutableArray<IParameterSymbol> oldParameters,
            ITypeSymbol oldReturnType,
        ...
        protected static bool TypeParametersEquivalent(
            ...
            oldParameters.SequenceEqual(
                newParameters,
                exact,
                (oldParameter, newParameter, exact) =>
                    oldParameter.Name == newParameter.Name
                    && TypeParameterConstraintsEquivalent(oldParameter, newParameter, exact)
            );
        ...
        )
        {
            ...
            try
            {
                ...
                foreach (var edit in editScript.Edits)
                {
                    ...
                    foreach (var symbolEdit in symbolEdits)
                    {
                        ...
                        if (!inBreakState)
                        {
                            ...
                            {
                                var containingTypeSymbolKey = SymbolKey.Create(
                                    containingType,
                                    cancellationToken
                                );
                            ...
                            case EditKind.Delete:

                                {
                                    ...
                                    )
                                    {
                                        ...
                                        if (
                                            IsPropertyAccessorDeclarationMatchingPrimaryConstructorParameter(
                                                oldDeclaration,
                                                newSymbol.ContainingType,
                                                out var isFirst
                                            )
                                        )
                                        {
                                            ...
                                            if (isFirst)
                                            {
                                                AddEditsForSynthesizedRecordMembers(
                                                    newCompilation,
                                                    newSymbol.ContainingType,
                                                    semanticEdits,
                                                    cancellationToken
                                    ...
                                    else
                                    {
                                        ...
                                        if (
                                            TryGetAssociatedMemberDeclaration(
                                                oldDeclaration,
                                                EditKind.Delete,
                                        ...
                                        )
                                        {
                                            if (
                                                HasEdit(
                                                    editMap,
                                                    oldAssociatedMemberDeclaration,
                                                    EditKind.Delete
                                                )
                                            )
                                            {
                                            ...
                                            {
                                                if (
                                                    TryAddParameterInsertOrDeleteEdits(
                                                        semanticEdits,
                                        ...
                                        else if (oldSymbol.ContainingType != null)
                                        {
                                            ...
                                            var newContainingSymbol = containingSymbolKey
                                                .Resolve(
                                                    newCompilation,
                                                    ignoreAssemblyKey: true,
                                                    cancellationToken
                                            ...
                                            {
                                                AddMemberOrAssociatedMemberSemanticEdits(
                                                    semanticEdits,
                            ...
                            case EditKind.Insert:

                                {
                                    ...
                                    if (oldSymbol != null)
                                    {
                                        ...
                                        if (oldSymbol.IsImplicitlyDeclared)
                                        {
                                            ...
                                            if (oldSymbol.DeclaringSyntaxReferences.Length == 1)
                                            {
                                                ...
                                                )
                                                {
                                                    ...
                                                    if (
                                                        TryGetDeclarationBody(newDeclaration)
                                                        is null
                                                    )
                                                    {
                                                        continue;
                                            ...
                                            oldSymbol.DeclaringSyntaxReferences.Length == 1
                                        ...
                                        )
                                        {
                                            ...
                                            if (oldBody != null)
                                            {
                                                ...
                                                var oldSyntaxModel = await oldSyntaxDocument
                                                    ...
                                                    .ConfigureAwait(false);
                                                var oldSyntaxText = await oldSyntaxDocument
                                                    .GetTextAsync(cancellationToken)
                                                    .ConfigureAwait(false);
                                            ...
                                            var isNewConstructorWithMemberInitializers =
                                                IsConstructorWithMemberInitializers(newDeclaration);
                                            var isDeclarationWithInitializer =
                                                IsDeclarationWithInitializer(oldDeclaration)
                                                || IsDeclarationWithInitializer(newDeclaration);
                                            var isRecordPrimaryConstructorParameter =
                                                IsRecordPrimaryConstructorParameter(oldDeclaration);

                                            if (
                                                isNewConstructorWithMemberInitializers
                                        ...
                                        && HasEdit(
                                            editMap,
                                            newAssociatedMemberDeclaration,
                                            EditKind.Insert
                                        )
                                    )
                                    {
                                    ...
                                    else if (newSymbol is ITypeParameterSymbol)
                                    {
                                        diagnostics.Add(
                                            new RudeEditDiagnostic(
                                                ...
                                                arguments: new[]
                                                {
                                                    GetDisplayName(newDeclaration, EditKind.Insert)
                                                }
                                            )
                                        );
                                    ...
                                    else if (newContainingType != null && !IsGlobalMain(newSymbol))
                                    {
                                        ...
                                        if (
                                            newSymbol is IPropertySymbol or IFieldSymbol
                            ...
                            )
                            {
                                ...
                                for (var i = 0; i < oldMethod.Parameters.Length; i++)
                                {
                                    ...
                                    AnalyzeParameterType(
                                        oldMethod.Parameters[i],
                                        newMethod.Parameters[i],
                                        capabilities,
                                        ref rudeEditKind,
                                        ref unused,
                                        ref hasParameterTypeChange,
                                        cancellationToken
                                    );

                                    createDeleteAndInsertEdits |= hasParameterTypeChange;
                                    renamedParameter ??=
                                        oldMethod.Parameters[i].Name != newMethod.Parameters[i].Name
                                            ? newMethod.Parameters[i]
                                            : null;
                                }

                                if (
                                    !createDeleteAndInsertEdits
                                    && renamedParameter is not null
                                    && !capabilities.Grant(
                ...
                foreach (var (oldEditNode, newEditNode, diagnosticSpan) in triviaEdits)
                {
                    ...
                    foreach (
                        var (oldSymbol, newSymbol, editKind) in GetSymbolEdits(
                            EditKind.Update,
                            oldEditNode,
                            newEditNode,
                            oldModel,
                    ...
                    )
                    {
                        ...
                        var isActiveMember =
                            GetOverlappingActiveStatements(oldDeclaration, oldActiveStatements)
                                .Any()
                            || IsStateMachineMethod(oldDeclaration)
                            || ContainsLambda(oldDeclaration);

                        var syntaxMap = isActiveMember
                            ? CreateSyntaxMapForEquivalentNodes(oldDeclaration, newDeclaration)
                            : null;

                        // only trivia changed:
                        Contract.ThrowIfFalse(
                            IsConstructorWithMemberInitializers(oldDeclaration)
                                == IsConstructorWithMemberInitializers(newDeclaration)
                        );
                        Contract.ThrowIfFalse(
                            IsDeclarationWithInitializer(oldDeclaration)
                        ...
                        if (isConstructorWithMemberInitializers || isDeclarationWithInitializer)
                        {
                            ...
                            syntaxMap ??= CreateSyntaxMapForEquivalentNodes(
                                oldDeclaration,
                                newDeclaration
                            );
                        ...
                        {
                            var rudeEdit = oldIsGenericMethod
                            ...
                            diagnostics.Add(
                                new RudeEditDiagnostic(
                                    ...
                                    diagnosticSpan,
                                    newEditNode,
                                    new[] { GetDisplayName(newEditNode) }
                                )
                            );
                            continue;
                        }
        ...
        )
        {
            ...
            if (otherModel is null || containingSymbol.DeclaringSyntaxReferences.Length != 1)
            {
                return false;
            }
            ...
            var otherContainingSymbol = otherModel.GetDeclaredSymbol(
                otherContainingNode,
                cancellationToken
            );
            ...
            // the match in
            var oldSymbol =
                (otherContainingNode == oldNode) ? otherContainingSymbol : containingSymbol;
            var newSymbol =
                (otherContainingNode == oldNode) ? containingSymbol : otherContainingSymbol;
            ...
            void AddEdit(ISymbol? symbol)
            {
                ...
                semanticEdits.Add(
                    new SemanticEditInfo(
                        ...
                        syntaxMapTree: null,
                        partialType,
                        deletedSymbolContainer: containingSymbolKey
                    )
                );
            }
        }
        ...
        )
        {
            ...
            {
                var oldType = (INamedTypeSymbol?)
                    oldModel.GetDeclaredSymbol(oldTypeDeclaration, cancellationToken);
            ...
            {
                var newType = (INamedTypeSymbol?)
                    newModel.GetDeclaredSymbol(newTypeDeclaration, cancellationToken);
        ...
        )
        {
            ...
            else if (oldSymbol.Name != newSymbol.Name)
            {
                if (oldSymbol is IParameterSymbol && newSymbol is IParameterSymbol)
                {
                    ...
                    oldSymbol is IMethodSymbol oldMethod && newSymbol is IMethodSymbol newMethod
                )
                {
            ...
            else if (oldSymbol is IMethodSymbol oldMethod && newSymbol is IMethodSymbol newMethod)
            {
                ...
                )
                {
                    AnalyzeReturnType(
                        ...
                        capabilities,
                        ref rudeEdit,
                        ref hasGeneratedReturnTypeAttributeChange,
                        ref hasReturnTypeChange,
                        cancellationToken
                    );
                }
            }
            else if (oldSymbol is INamedTypeSymbol oldType && newSymbol is INamedTypeSymbol newType)
            {
                ...
                oldSymbol is IPropertySymbol oldProperty && newSymbol is IPropertySymbol newProperty
            )
            {
                AnalyzeReturnType(
                    oldProperty,
            ...
            {
                if (
                    oldParameter.RefKind != newParameter.RefKind
        ...
        private static void AnalyzeType(
            ...
            RudeEditKind rudeEditKind = RudeEditKind.TypeUpdate
        )
        {
        ...
        private void AnalyzeReturnType(
            IMethodSymbol oldMethod,
            IMethodSymbol newMethod,
            EditAndContinueCapabilitiesGrantor capabilities,
            ref RudeEditKind rudeEdit,
            ref bool hasGeneratedReturnTypeAttributeChange,
            ref bool hasReturnTypeChange,
            CancellationToken cancellationToken
        )
        {
        ...
        )
        {
            ...
            ReportUpdatedSymbolDeclarationRudeEdits(
                ...
                out var hasParameterRename,
                out var hasParameterTypeChange,
                out var hasReturnTypeChange,
                cancellationToken
            );
            ...
            if (hasParameterRename || hasParameterTypeChange)
            {
                ...
                if (
                    newSymbol.ContainingSymbol
                        is IMethodSymbol { AssociatedSymbol: IEventSymbol associatedSymbol }
                ...
                AddParameterUpdateSemanticEdit(
                    semanticEdits,
                    (IParameterSymbol)oldSymbol,
                    (IParameterSymbol)newSymbol,
                    syntaxMap,
                    reportDeleteAndInsertEdits: hasParameterTypeChange,
                    processedSymbols,
                    cancellationToken
                );
            }
            ...
            {
                AddCustomAttributeSemanticEdits(
                    semanticEdits,
                    oldSymbol,
                    newSymbol,
                    topMatch,
            ...
            // updating generic methods and types
            if (
                InGenericContext(oldSymbol, out var oldIsGenericMethod)
                || InGenericContext(newSymbol, out _)
            )
            {
                var rudeEdit = oldIsGenericMethod
        ...
        )
        {
            ...
            )
            {
                if (hasAttributeChange)
                {
                    semanticEdits.Add(
                        new SemanticEditInfo(
                            SemanticEditKind.Update,
                            SymbolKey.Create(newDelegateType, cancellationToken),
                            syntaxMap,
                            syntaxMapTree: null,
                            partialType: null
                        )
                ...
                if (hasReturnTypeAttributeChange)
                {
                    ...
                    semanticEdits.Add(
                        new SemanticEditInfo(
                            SemanticEditKind.Update,
                            SymbolKey.Create(newDelegateInvokeMethod, cancellationToken),
                            syntaxMap,
                            syntaxMapTree: null,
                            partialType: null
                        )
            ...
            else if (newSymbol is IParameterSymbol newParameterSymbol)
            {
                AddParameterUpdateSemanticEdit(
                    ...
                    newParameterSymbol,
                    syntaxMap,
                    reportDeleteAndInsertEdits: false,
        ...
        private static void AddParameterUpdateSemanticEdit(
            ArrayBuilder<SemanticEditInfo> semanticEdits,
        ...
        )
        {
            ...
            if (reportDeleteAndInsertEdits)
            {
                ...
                var containingSymbolKey = SymbolKey.Create(
                    oldContainingSymbol.ContainingSymbol,
                    cancellationToken
                );
                AddMemberOrAssociatedMemberSemanticEdits(
                    semanticEdits,
            ...
            else
            {
                semanticEdits.Add(
                    new SemanticEditInfo(
                        SemanticEditKind.Update,
                        SymbolKey.Create(newContainingSymbol, cancellationToken),
                        syntaxMap,
                        syntaxMapTree: null,
                        partialType: null
                    )
        ...
        private static void AddDelegateBeginInvokeEdit(
            ArrayBuilder<SemanticEditInfo> semanticEdits,
                ...
                if (IsNonCustomAttribute(attributeData))
                {
                    ...
                    diagnostics.Add(
                        new RudeEditDiagnostic(
                            ...
                            node,
                            new[] { attributeData.AttributeClass!.Name, GetDisplayName(newSymbol) }
                        )
                    );
        ...
        )
        {
            ...
            if (
                newSymbol is IFieldSymbol
                || newSymbol is IPropertySymbol { DeclaringSyntaxReferences: [var syntaxRef] }
                    && HasBackingField(syntaxRef.GetSyntax(cancellationToken))
            )
            {
                requiredCapabilities |= newSymbol.IsStatic
        ...
        private static void AddEditsForSynthesizedRecordMembers(
        ...
        private static IEnumerable<ISymbol> GetRecordUpdatedSynthesizedMembers(
            Compilation compilation,
        ...
        )
        {
            ...
            result = record
                ...
                .OfType<IMethodSymbol>()
                .SingleOrDefault(m => m.IsImplicitlyDeclared && m.Parameters.Length == 0);
            if (result is not null)
            {
                yield return result;
            }
        ...
        {
            var newNode = GetDeleteRudeEditDiagnosticNode(
                oldSymbol,
                newCompilation,
                cancellationToken
            );
        ...
        private void ReportUpdateRudeEdit(
            ArrayBuilder<RudeEditDiagnostic> diagnostics,
        ...
        )
        {
            ...
            var span =
                (rudeEdit == RudeEditKind.ChangeImplicitMainReturnType)
                    ? GetGlobalStatementDiagnosticSpan(node)
                    : GetDiagnosticSpan(node, EditKind.Update);
        ...
        private static SyntaxNode GetRudeEditDiagnosticNode(
            ISymbol symbol,
            CancellationToken cancellationToken
        )
        {
        ...
        private static SyntaxNode GetDeleteRudeEditDiagnosticNode(
            ISymbol oldSymbol,
            Compilation newCompilation,
            CancellationToken cancellationToken
        )
        ...
        private void ReportTypeLayoutUpdateRudeEdits(
            ArrayBuilder<RudeEditDiagnostic> diagnostics,
            ISymbol symbol,
            SyntaxNode syntax
        )
...
#nullable enable
        ...
        )
        {
            ...
            foreach (var attribute in attributes)
            {
                ...
                if (
                    attribute.AttributeClass.Equals(lazyLayoutAttribute)
            ...
            foreach (var (newType, updatesInCurrentDocument) in updatedTypes)
            {
                ...
                )
                {
                    ...
                    if (!newCtor.IsImplicitlyDeclared)
                    {
                        ...
                        newDeclaration = GetSymbolDeclarationSyntax(
                            newCtor.DeclaringSyntaxReferences.Single(),
                            cancellationToken
                        );
                        ...
                        if (
                            !isPrimaryRecordConstructor
                            && topMatch.TryGetOldNode(newDeclaration, out var oldDeclaration)
                        )
                        {
                            Contract.ThrowIfNull(oldModel);
                        ...
                        if (
                            ...
                            && HasMemberInitializerContainingLambda(
                                oldType,
                                isStatic,
                                ref lazyOldTypeHasMemberInitializerContainingLambda,
                                cancellationToken
                            )
                        )
                        {
                        ...
                        )
                        {
                            ...
                            var firstSpan = updatesInCurrentDocument.ChangedDeclarations.Keys
                                ...
                                .Aggregate(
                                    ...
                                    (accumulate, node) =>
                                        (node.SpanStart < accumulate.min)
                                            ? (node.SpanStart, node.Span)
                                            : accumulate
                                )
                                .span;
                        ...
                        if (
                            ...
                            && newType.IsRecord
                            && oldCtor.GetParameters().First().Name
                                != newCtor.GetParameters().First().Name
                    ...
                    else
                    {
                        if (newCtor.Parameters.Length == 1)
                        {
                            ...
                            if (
                                oldType.GetMembers().OfType<IPropertySymbol>().Count()
                                    == newType.GetMembers().OfType<IPropertySymbol>().Count()
                                && oldType.GetMembers().OfType<IFieldSymbol>().Count()
        ...
        private bool HasMemberInitializerContainingLambda(
            INamedTypeSymbol type,
            bool isStatic,
            ref bool? lazyHasMemberInitializerContainingLambda,
            CancellationToken cancellationToken
        )
        {
            // checking the old type for existing lambdas (it's ok for the new initializers to contain lambdas)
            lazyHasMemberInitializerContainingLambda ??= HasMemberInitializerContainingLambda(
                type,
                isStatic,
                cancellationToken
            );
        ...
        )
        {
            ...
            foreach (var member in type.GetMembers())
            {
                ...
                {
                    var syntax = GetSymbolDeclarationSyntax(
                        member.DeclaringSyntaxReferences.Single(),
                        cancellationToken
                    );
        ...
        private static bool IsPartialEdit(
            ISymbol? oldSymbol,
            ISymbol? newSymbol,
        ...
        )
        {
            ...
            return oldSymbol?.Kind == SymbolKind.NamedType
                    && oldSymbol.DeclaringSyntaxReferences.Length > 1
                    && oldSymbol.DeclaringSyntaxReferences.Any(IsNotInDocument, oldSyntaxTree)
                || newSymbol?.Kind == SymbolKind.NamedType
                    && newSymbol.DeclaringSyntaxReferences.Length > 1
        ...
        )
        {
            ...
            if (matchedLambdas != null)
            {
                ...
                foreach (var (oldLambdaBody, newLambdaInfo) in matchedLambdas)
                {
                    ...
                    for (
                        ...
                        newCaptureIndex < newCaptures.Length;
                        newCaptureIndex++
                    )
                    {
                        ...
                        if (newAccessed != oldAccessed)
                        {
                            ...
                            {
                                newCapture.Name,
                                GetDisplayName(GetLambda(newLambdaBody))
                            };
                            ...
                            else if (newAccessed)
                            {
                                ...
                                foreach (
                                    var useSite in GetVariableUseSites(
                                        GetLambdaBodyExpressionsAndStatements(newLambdaBody),
                                        newCapture,
                                        newModel,
                                        cancellationToken
                                    )
            ...
            var isInInterfaceDeclaration =
                containingTypeDeclaration != null
                && IsInterfaceDeclaration(containingTypeDeclaration);
        ...
        private IEnumerable<(
            SyntaxNode lambda,
            SyntaxNode lambdaBody1,
            SyntaxNode? lambdaBody2
        )> GetLambdaBodies(SyntaxNode body)
        {
                    ...
                    )
                    {
                        ...
                        diagnostics.Add(
                            new RudeEditDiagnostic(
                                ...
                                new[]
                                {
                                    GetDisplayName(GetLambda(lambdaBody)),
        ...
        private BitVector GetAccessedCaptures(
            SyntaxNode lambdaBody,
            SemanticModel model,
            ImmutableArray<ISymbol> captures,
            PooledDictionary<ISymbol, int> capturesIndex
        ...
        private static void MarkVariables(
            ref BitVector mask,
            ImmutableArray<ISymbol> variables,
            Dictionary<ISymbol, int> index
        )
        {
        ...
        private static TextSpan GetVariableDiagnosticSpan(ISymbol local)
        {
            ...
            return local.Locations.FirstOrDefault()?.SourceSpan
                ?? local.ContainingSymbol.Locations.First().SourceSpan;
        }

        private static (SyntaxNode? Node, int Ordinal) GetParameterKey(
        ...
        private static bool TryMapParameter(
            (SyntaxNode? Node, int Ordinal) parameterKey,
            IReadOnlyDictionary<SyntaxNode, SyntaxNode> map,
            out (SyntaxNode? Node, int Ordinal) mappedParameterKey
        )
        {
        ...
        )
        {
            ...
            for (var i = 0; i < oldCaptures.Length; i++)
            {
                ...
                {
                    oldParameterCapturesByLambdaAndOrdinal.Add(
                        GetParameterKey((IParameterSymbol)oldCapture, cancellationToken),
                        i
                    );
                }
                else
                {
                    oldLocalCapturesBySyntax.Add(
                        oldCapture.DeclaringSyntaxReferences.Single().GetSyntax(cancellationToken),
                        i
                    );
                }
            }
            ...
            for (var newCaptureIndex = 0; newCaptureIndex < newCaptures.Length; newCaptureIndex++)
            {
                ...
                if (newCapture.Kind == SymbolKind.Parameter)
                {
                    ...
                    if (
                        !TryMapParameter(newParameterKey, map.Reverse, out var oldParameterKey)
                        || !oldParameterCapturesByLambdaAndOrdinal.TryGetValue(
                            oldParameterKey,
                            out oldCaptureIndex
                        )
                    )
                ...
                else
                {
                    ...
                    if (
                        !map.Reverse.TryGetValue(newCaptureSyntax, out var mappedOldSyntax)
                        || !oldLocalCapturesBySyntax.TryGetValue(
                            mappedOldSyntax,
                            out oldCaptureIndex
                        )
                    )
                ...
                if (!TypesEquivalent(oldTypeOpt, newTypeOpt, exact: false))
                {
                    diagnostics.Add(
                        new RudeEditDiagnostic(
                            ...
                            {
                                newCapture.Name,
                                oldTypeOpt.ToDisplayString(ErrorDisplayFormat)
                            }
                        )
                    );
                ...
                // scope check:
                var oldScopeOpt = GetCapturedVariableScope(
                    oldCapture,
                    oldMemberBody,
                    cancellationToken
                );
            ...
            if (oldParameterCapturesByLambdaAndOrdinal.Count > 0)
            {
                ...
                foreach (
                    var (
                        (oldContainingLambdaSyntax, ordinal),
                        oldCaptureIndex
                    ) in oldParameterCapturesByLambdaAndOrdinal
                )
                {
                    var oldCapture = oldCaptures[oldCaptureIndex];
        ...
        private SyntaxNode GetCapturedVariableScope(
            ISymbol localOrParameter,
            SyntaxNode memberBody,
            CancellationToken cancellationToken
        )
        {
            ...
            if (localOrParameter.Kind == SymbolKind.Parameter)
            {
                ...
                if (
                    (member as IMethodSymbol)?.MethodKind == MethodKind.AnonymousFunction
        ...
        private static bool AreEquivalentClosureScopes(
            SyntaxNode oldScopeOpt,
            SyntaxNode newScopeOpt,
            IReadOnlyDictionary<SyntaxNode, SyntaxNode> reverseMap
        )
        {
        ...
        internal readonly struct TestAccessor
        {
            ...
            {
                return _abstractEditAndContinueAnalyzer.ComputeMap(
                    bodyMatch,
                    activeNodes,
                    ref lazyActiveOrMatchedLambdas,
                    diagnostics
            ...
            {
                return _abstractEditAndContinueAnalyzer.ComputeBodyMatch(
                    oldBody,
                    newBody,
                    activeNodes,
                    diagnostics,
                    out oldHasStateMachineSuspensionPoint,
                    out newHasStateMachineSuspensionPoint
                );
            }
        }
