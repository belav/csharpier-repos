                ...
                log(
                    ...
                    KeyValueLogMessage.Create(map =>
                    {
                        ...
                        map["ProjectIdsWithAppliedChanges"] = editSessionData.Committed
                            ? editSessionData.ProjectsWithValidDelta.Select(ProjectIdToPii)
                            : "";

                        // Total milliseconds it took to emit the delta in this edit session.
                        map["EmitDifferenceMilliseconds"] = (long)
                            editSessionData.EmitDifferenceTime.TotalMilliseconds;
                        ...
                        map["TotalAnalysisMilliseconds"] = (long)
                            editSessionData.AnalysisTime.TotalMilliseconds;
                    })
                );
