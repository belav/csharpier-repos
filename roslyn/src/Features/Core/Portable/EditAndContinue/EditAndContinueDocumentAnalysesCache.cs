...
namespace Microsoft.CodeAnalysis.EditAndContinue
{
    ...
    internal sealed class EditAndContinueDocumentAnalysesCache
    {
        ...
        private readonly Dictionary<
            DocumentId,
            (AsyncLazy<DocumentAnalysisResults> results, Project baseProject, Document document, ImmutableArray<TextSpan> activeStatementSpans)
        > _analyses = new();
        ...
        public async ValueTask<ImmutableArray<ActiveStatement>> GetActiveStatementsAsync(
        ...
        )
        {
            try
            {
                ...
                var tasks = documentInfos.Select(
                    info =>
                        Task.Run(
                            () =>
