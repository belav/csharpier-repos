    ...
    internal sealed class ActiveStatementsMap
    {
        ...
        )
        {
            using var _1 = PooledDictionary<
                string,
                ArrayBuilder<(
                    ManagedActiveStatementDebugInfo info,
                    SourceFileSpan span,
                    int ordinal
                )>
            ...
            {
                byDocumentPath = byDocumentPath.WithComparers(
