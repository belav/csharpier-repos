    ...
    internal static partial class Extensions
    {
        ...
        public static bool SupportsEditAndContinue(this TextDocumentState textDocumentState)
        {
            ...
            if (textDocumentState is DocumentState documentState)
            {
                ...
                if (
                    IsWpfDesignTimeOnlyDocument(
                        textDocumentState.FilePath,
        ...
        private static bool IsWpfDesignTimeOnlyDocument(string filePath, string language) =>
            language switch
            {
                LanguageNames.CSharp => filePath.EndsWith(
                    ".g.i.cs",
                    StringComparison.OrdinalIgnoreCase
                ),
                LanguageNames.VisualBasic => filePath.EndsWith(
                    ".g.i.vb",
                    StringComparison.OrdinalIgnoreCase
                ),
                _ => false,
        ...
        public static ManagedHotReloadDiagnostic ToHotReloadDiagnostic(
        ...
        public static bool IsSynthesized(this ISymbol symbol) =>
            ...
            || symbol.IsSynthesizedAutoProperty()
            || symbol.IsSynthesizedParameter();

        public static bool IsSynthesizedAutoProperty(this IPropertySymbol property) =>
            property
                is { GetMethod.IsImplicitlyDeclared: true, SetMethod.IsImplicitlyDeclared: true };
        ...
        public static bool IsSynthesizedParameter(this IParameterSymbol parameter) =>
            ...
            || parameter.ContainingSymbol.IsSynthesized()
        ...
        public static bool IsCopyConstructor(this ISymbol symbol) =>
            ...
            && SymbolEqualityComparer.Default.Equals(parameter.Type, symbol.ContainingType);

        public static bool HasDeconstructorSignature(
                ...
                parameter
                    ...
                    .FirstOrDefault(
                        static (member, parameter) =>
                            ...
                            && ParsePrimaryParameterBackingFieldName(field.Name, out var paramName)
                            && paramName == parameter.Name,
                        parameter
                    );

        private static bool ParsePrimaryParameterBackingFieldName(
            string fieldName,
                ...
                constructor
                    ...
                    .FirstOrDefault(
                        static (symbol, constructor) =>
                            ...
                            && HasDeconstructorSignature(method, constructor),
                        constructor
                    )
