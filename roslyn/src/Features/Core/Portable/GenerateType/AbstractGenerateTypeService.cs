...
namespace Microsoft.CodeAnalysis.GenerateType
{
        ...
        where TArgumentSyntax : SyntaxNode
    {
        ...
        public abstract Task<(INamespaceSymbol, INamespaceOrTypeSymbol, Location)> GetOrGenerateEnclosingNamespaceSymbolAsync(
        ...
        )
        {
            ...
            if (generateNewTypeInDialog)
                result.Add(
                    new GenerateTypeCodeActionWithOption((TService)this, document.Document, state)
                );
