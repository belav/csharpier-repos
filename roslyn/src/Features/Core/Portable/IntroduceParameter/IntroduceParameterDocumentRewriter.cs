...
namespace Microsoft.CodeAnalysis.IntroduceParameter
{
    ...
    >
    {
        ...
        {
            private readonly AbstractIntroduceParameterCodeRefactoringProvider<
                TExpressionSyntax,
                TInvocationExpressionSyntax,
                TObjectCreationExpressionSyntax,
                TIdentifierNameSyntax,
            ...
            private readonly SyntaxGenerator _generator = SyntaxGenerator.GetGenerator(
                originalDocument
            );
            ...
            )
            {
                ...
                )
                {
                    ...
                    var currentInvocationArguments =
                        (SeparatedSyntaxList<TArgumentSyntax>)
                            _syntaxFacts.GetArgumentsOfArgumentList(currentArgumentListSyntax);
            ...
            {
                var info = await _originalDocument
                ...
                var newMethodDeclaration = info.Service
            ...
            )
            {
                foreach (var (variable, mappedParameter) in mappingDictionary)
                {
                    ...
                    if (parameterMapped)
                    {
                        ...
                        var parenthesizedArgumentExpression = editor.Generator
            ...
            private SeparatedSyntaxList<TArgumentSyntax> AddArgumentToArgumentList(
                SeparatedSyntaxList<TArgumentSyntax> invocationArguments,
