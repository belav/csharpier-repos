...
namespace Microsoft.CodeAnalysis.Completion
{
    public abstract partial class CompletionService
    {
        private sealed class ProviderManager : IEqualityComparer<ImmutableHashSet<string>>
        {
            ...
            public static ImmutableArray<CompletionProvider> GetProjectCompletionProviders(
                Project? project
            )
            {
...
#pragma warning restore 0618
            ...
            public CompletionProvider? GetProvider(CompletionItem item, Project? project)
            {
                ...
                return GetProjectCompletionProviders(project)
            ...
            )
            {
                ...
                var projectCompletionProviders = FilterProviders(
                    GetProjectCompletionProviders(project),
                    trigger,
                    options
                );
            ...
            internal readonly struct TestAccessor
            {
                ...
                public ImmutableArray<CompletionProvider> GetProviders(
                    ImmutableHashSet<string> roles,
                    Project? project
                )
                {
