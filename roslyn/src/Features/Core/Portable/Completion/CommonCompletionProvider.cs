    ...
    internal abstract class CommonCompletionProvider : CompletionProvider
    {
        ...
        )
        {
            ...
            return ShouldTriggerCompletionImpl(
                ...
                caretPosition,
                trigger,
                CompletionOptions.From(options, Language)
            );
        }
        ...
        private bool ShouldTriggerCompletionImpl(
            SourceText text,
            int caretPosition,
            CompletionTrigger trigger,
        ...
        /// For backwards API compat only, should not be called.
        /// </summary>
        public sealed override Task<CompletionDescription?> GetDescriptionAsync(
            Document document,
            CompletionItem item,
        ...
        )
        {
            ...
            var description = await GetDescriptionWorkerAsync(
                    document,
                    item,
                    options,
                    displayOptions,
