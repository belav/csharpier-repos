...
namespace Microsoft.CodeAnalysis.Completion.Providers
{
        ...
        : LSPCompletionProvider
    {
        ...
        protected AbstractAggregateEmbeddedLanguageCompletionProvider(
        ...
        public override Task<CompletionChange> GetChangeAsync(
            ...
            GetLanguage(item).CompletionProvider!.GetChangeAsync(
                document,
                item,
                commitKey,
                cancellationToken
        ...
        internal override Task<CompletionDescription?> GetDescriptionAsync(
            ...
            GetLanguage(item).CompletionProvider!.GetDescriptionAsync(
                document,
                item,
                cancellationToken
            );
        ...
        private IEmbeddedLanguage GetLanguage(CompletionItem item)
        {
            ...
            return _languageProviders.Single(
                lang => lang.CompletionProvider?.Name == item.Properties[EmbeddedProviderName]
            );
        }
    }
}
