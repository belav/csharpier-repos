...
namespace Microsoft.CodeAnalysis.Completion.Providers
{
        ...
        where TSyntaxContext : SyntaxContext
    {
        ...
        ) GetDisplayAndSuffixAndInsertionText(ISymbol symbol, TSyntaxContext context);
        ...
        )
        {
            ...
            foreach (var symbolGroup in symbolGroups)
            {
                ...
                var supportedPlatformData = ComputeSupportedPlatformData(
                    completionContext,
                    symbolList,
                    invalidProjectMap,
                    totalProjects
        ...
        protected static string GetFilterTextDefault(
            ISymbol symbol,
            string displayText,
            TSyntaxContext context
        )
