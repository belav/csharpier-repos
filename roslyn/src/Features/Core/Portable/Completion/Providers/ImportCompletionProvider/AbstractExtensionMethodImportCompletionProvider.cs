...
namespace Microsoft.CodeAnalysis.Completion.Providers
{
        ...
        : AbstractImportCompletionProvider
    {
        ...
        protected override bool ShouldProvideCompletion(
            ...
            syntaxContext.IsRightOfNameSeparator
            && IsAddingImportsSupported(completionContext.Document);
        ...
        {
            _ = ExtensionMethodImportCompletionHelper.WarmUpCacheAsync(
                document.Project,
        ...
        )
        {
            ...
            )
            {
                ...
                )
                {
                    ...
                    var receiverTypeKey = SymbolKey.CreateString(
                        receiverTypeSymbol,
                        cancellationToken
                    );
                    completionContext.AddItems(
                        result.CompletionItems.Select(i => Convert(i, receiverTypeKey))
                    );
                    ...
                    CompletionProvidersLogger.LogExtensionMethodCompletionTicksDataPoint(
                        totalTicks,
                        result.GetSymbolsTicks,
                        result.CreateItemsTicks,
                        result.IsRemote
                    );
        ...
        private CompletionItem Convert(
            SerializableImportCompletionItem serializableItem,
            ...
            ImportCompletionItem.Create(
                ...
                (
                    ...
                    serializableItem.AdditionalOverloadCount
                ),
