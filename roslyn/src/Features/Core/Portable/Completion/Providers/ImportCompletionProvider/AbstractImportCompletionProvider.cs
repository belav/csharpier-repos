...
namespace Microsoft.CodeAnalysis.Completion.Providers
{
    ...
    {
        protected abstract Task<ImmutableArray<string>> GetImportedNamespacesAsync(
        ...
        public override async Task ProvideCompletionsAsync(CompletionContext completionContext)
        {
            ...
            var namespacesInScope = await GetNamespacesInScopeAsync(
                    syntaxContext,
                    cancellationToken
                )
                .ConfigureAwait(false);
        ...
        private async Task<HashSet<string>> GetNamespacesInScopeAsync(
            SyntaxContext syntaxContext,
            CancellationToken cancellationToken
        )
        {
            ...
            var importedNamespaces = await GetImportedNamespacesAsync(
                    syntaxContext,
                    cancellationToken
                )
                .ConfigureAwait(false);
