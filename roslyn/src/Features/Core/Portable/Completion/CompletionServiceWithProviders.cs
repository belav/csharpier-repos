...
namespace Microsoft.CodeAnalysis.Completion
{
    ...
    public abstract partial class CompletionServiceWithProviders : CompletionService
    {
        ...
        > GetImportedProviders() => _providerManager.GetImportedProviders();
        ...
        protected ImmutableArray<CompletionProvider> GetProviders(
        ...
        )
        {
            ...
            return await GetCompletionsWithAvailabilityOfExpandedItemsAsync(
                    document,
                    caretPosition,
                    completionOptions,
                    passThroughOptions,
        ...
        )
        {
            ...
            var providers = _providerManager.GetFilteredProviders(
                document.Project,
                roles,
                trigger,
                options
            ...
            var additionalAugmentingProviders = await GetAugmentingProviders(
                    document,
                    triggeredProviders,
                    caretPosition,
                    trigger,
            ...
            var allContexts = triggeredContexts
                .Concat(augmentingContexts)
                .Sort(
                    (p1, p2) =>
                        completionProviderToIndex[p1.Provider]
                        - completionProviderToIndex[p2.Provider]
                );
            ...
            ImmutableArray<CompletionProvider> GetTriggeredProviders(
                Document document,
                ConcatImmutableArray<CompletionProvider> providers,
                int caretPosition,
                CompletionOptions options,
                CompletionTrigger trigger,
                ImmutableHashSet<string>? roles,
                ...
                switch (trigger.Kind)
                {
                    ...
                    case CompletionTriggerKind.Deletion:
                        ...
                        )
                        {
                            ...
                            return triggeredProviders.IsEmpty
            ...
            static async Task<ImmutableArray<CompletionProvider>> GetAugmentingProviders(
                Document document,
                ImmutableArray<CompletionProvider> triggeredProviders,
                int caretPosition,
                CompletionTrigger trigger,
                CompletionOptions options,
                CancellationToken cancellationToken
        ...
        private static async Task<
            ImmutableArray<CompletionContext>
        > ComputeNonEmptyCompletionContextsAsync(
            Document document,
            int caretPosition,
            CompletionTrigger trigger,
            CompletionOptions options,
        ...
        internal readonly struct TestAccessor
        {
            ...
            )
            {
                ...
                return await CompletionServiceWithProviders
                    .GetContextAsync(
                        provider,
                        document,
                        position,
