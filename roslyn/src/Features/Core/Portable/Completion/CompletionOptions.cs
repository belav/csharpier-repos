    ...
    )
    {
        ...
        public static CompletionOptions From(OptionSet options, string language) =>
            new(
                ...
                TriggerOnTypingLetters: options.GetOption(
                    Metadata.TriggerOnTypingLetters,
                    language
                ),
                TriggerOnDeletion: options.GetOption(Metadata.TriggerOnDeletion, language),
                TriggerInArgumentLists: options.GetOption(
                    Metadata.TriggerInArgumentLists,
                    language
                ),
                ...
                ShowItemsFromUnimportedNamespaces: options.GetOption(
                    Metadata.ShowItemsFromUnimportedNamespaces,
                    language
                ),
                UnnamedSymbolCompletionDisabled: options.GetOption(
                    Metadata.UnnamedSymbolCompletionDisabledFeatureFlag
                ),
                TargetTypedCompletionFilter: options.GetOption(
                    Metadata.TargetTypedCompletionFilterFeatureFlag
                ),
                TypeImportCompletion: options.GetOption(Metadata.TypeImportCompletionFeatureFlag),
                ProvideDateAndTimeCompletions: options.GetOption(
                    Metadata.ProvideDateAndTimeCompletions,
                    language
                ),
                ProvideRegexCompletions: options.GetOption(
                    Metadata.ProvideRegexCompletions,
                    language
                ),
                TimeoutInMillisecondsForExtensionMethodImportCompletion: options.GetOption(
        ...
        public OptionSet WithChangedOptions(OptionSet set, string language) =>
            set.WithChangedOption(Metadata.TriggerOnTyping, language, TriggerOnTyping)
                .WithChangedOption(
                    Metadata.TriggerOnTypingLetters,
                    language,
                ...
                .WithChangedOption(
                    Metadata.UnnamedSymbolCompletionDisabledFeatureFlag,
                    UnnamedSymbolCompletionDisabled
                )
                .WithChangedOption(
                    Metadata.TargetTypedCompletionFilterFeatureFlag,
        ...
        internal sealed class Metadata : IOptionProvider
        {
            ...
            public static readonly Option2<bool> TypeImportCompletionFeatureFlag =
                new(
                    nameof(CompletionOptions),
                    nameof(TypeImportCompletionFeatureFlag),
                    defaultValue: false,
                    new FeatureFlagStorageLocation("Roslyn.TypeImportCompletion")
                );

            public static readonly Option2<bool> TargetTypedCompletionFilterFeatureFlag =
                new(
                    nameof(CompletionOptions),
                    nameof(TargetTypedCompletionFilterFeatureFlag),
                    defaultValue: false,
            ...
            public static readonly Option2<bool> UnnamedSymbolCompletionDisabledFeatureFlag =
                new(
                    nameof(CompletionOptions),
                    nameof(UnnamedSymbolCompletionDisabledFeatureFlag),
                    defaultValue: false,
            ...
            public static readonly PerLanguageOption2<bool> HideAdvancedMembers =
                new(nameof(CompletionOptions), nameof(HideAdvancedMembers), defaultValue: false);

            // This is serialized by the Visual Studio-specific LanguageSettingsPersister
            public static readonly PerLanguageOption2<bool> TriggerOnTyping =
                new(nameof(CompletionOptions), nameof(TriggerOnTyping), defaultValue: true);
            ...
            public static readonly PerLanguageOption2<bool> TriggerOnTypingLetters =
                new(
                    ...
                    storageLocation: new RoamingProfileStorageLocation(
                        "TextEditor.%LANGUAGE%.Specific.TriggerOnTypingLetters"
                    )
                );
            ...
            public static readonly PerLanguageOption2<bool?> TriggerOnDeletion =
                new(
                    nameof(CompletionOptions),
                    nameof(TriggerOnDeletion),
                    defaultValue: null,
                    storageLocation: new RoamingProfileStorageLocation(
                        "TextEditor.%LANGUAGE%.Specific.TriggerOnDeletion"
                    )
                );
            ...
            public static readonly PerLanguageOption2<EnterKeyRule> EnterKeyBehavior =
                new(
                    nameof(CompletionOptions),
                    nameof(EnterKeyBehavior),
                    defaultValue: EnterKeyRule.Default,
                    storageLocation: new RoamingProfileStorageLocation(
                        "TextEditor.%LANGUAGE%.Specific.EnterKeyBehavior"
                    )
                );
            ...
            public static readonly PerLanguageOption2<SnippetsRule> SnippetsBehavior =
                new(
                    nameof(CompletionOptions),
                    nameof(SnippetsBehavior),
                    defaultValue: SnippetsRule.Default,
                    storageLocation: new RoamingProfileStorageLocation(
                        "TextEditor.%LANGUAGE%.Specific.SnippetsBehavior"
                    )
                );
            ...
            public static readonly PerLanguageOption2<bool?> ShowItemsFromUnimportedNamespaces =
                new(
                    nameof(CompletionOptions),
                    nameof(ShowItemsFromUnimportedNamespaces),
                    defaultValue: null,
                    storageLocation: new RoamingProfileStorageLocation(
                        "TextEditor.%LANGUAGE%.Specific.ShowItemsFromUnimportedNamespaces"
                    )
                );
            ...
            public static readonly PerLanguageOption2<bool> TriggerInArgumentLists =
                new(
                    nameof(CompletionOptions),
                    nameof(TriggerInArgumentLists),
                    defaultValue: true,
                    storageLocation: new RoamingProfileStorageLocation(
                        "TextEditor.%LANGUAGE%.Specific.TriggerInArgumentLists"
                    )
                );
            ...
            public static readonly Option2<int> TimeoutInMillisecondsForExtensionMethodImportCompletion =
                new(
                    ...
                    nameof(TimeoutInMillisecondsForExtensionMethodImportCompletion),
                    defaultValue: 500
                );
