...
namespace Microsoft.CodeAnalysis.SignatureHelp
{
    internal static class CommonSignatureHelpUtilities
    {
        ...
        internal static TextSpan GetSignatureHelpSpan<TArgumentList>(
            ...
            where TArgumentList : SyntaxNode
        {
            return GetSignatureHelpSpan(
                argumentList,
                argumentList.GetRequiredParent().SpanStart,
                getCloseToken
            );
        }
            ...
            where TSyntax : SyntaxNode
        {
            ...
            {
                expression = token
                    .Parent?.GetAncestorsOrThis<TSyntax>()
        ...
        )
        {
            ...
            var parentOperation =
                semanticModel.GetOperation(initializer.Parent, cancellationToken)
