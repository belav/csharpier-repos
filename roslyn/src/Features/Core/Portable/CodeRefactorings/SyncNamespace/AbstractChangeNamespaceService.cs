...
namespace Microsoft.CodeAnalysis.ChangeNamespace
{
        ...
        where TMemberDeclarationSyntax : SyntaxNode
    {
        ...
        protected static bool IsGlobalNamespace(ImmutableArray<string> parts) => parts is [""];
        ...
        )
        {
            ...
            foreach (var memberDecl in memberDecls)
            {
                ...
                if (
                    memberSymbol is INamedTypeSymbol typeSymbol
                ...
                linkedDocumentIds.Any(
                    static (id, arg) =>
                        !PathUtilities.PathsEqual(
                            arg.solution.GetRequiredDocument(id).Project.FilePath!,
                            arg.document.Project.FilePath!
                        ),
                    (solution, document)
                )
            )
