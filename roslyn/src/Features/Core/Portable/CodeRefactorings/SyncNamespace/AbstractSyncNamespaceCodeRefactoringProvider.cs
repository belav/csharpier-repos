...
namespace Microsoft.CodeAnalysis.CodeRefactorings.SyncNamespace
{
        ...
        where TMemberDeclarationSyntax : SyntaxNode
    {
            ...
            if (state.TargetNamespace != null)
            {
                ...
                var solutionChangeAction = new ChangeNamespaceCodeAction(
                    state.TargetNamespace.Length == 0
                      ...
                      : string
                        .Format(FeaturesResources.Change_namespace_to_0, state.TargetNamespace),
                    token =>
                        service.ChangeNamespaceAsync(
                            document,
                            state.Container,
        ...
        /// (3) otherwise, null.
        /// </returns>
        protected abstract Task<SyntaxNode> TryGetApplicableInvocationNodeAsync(
            Document document,
            TextSpan span,
