        ...
        private class MoveTypeEditor : Editor
        {
            ...
            private async Task<Solution> RemoveUnnecessaryImportsAsync(
                ...
                solution = solution.WithDocumentSyntaxRoot(
                    ...
                    await documentWithMovedType.GetRequiredSyntaxRootAsync(CancellationToken)
                        .ConfigureAwait(false)
                );
                ...
                return solution.WithDocumentSyntaxRoot(
                    sourceDocumentId,
                    await sourceDocument.GetRequiredSyntaxRootAsync(CancellationToken)
                        .ConfigureAwait(false)
                );
            }
            ...
            private ISet<SyntaxNode> GetMembersToRemove(SyntaxNode root)
            {
                ...
                var removableCandidates = root.DescendantNodes(n => spine.Contains(n))
