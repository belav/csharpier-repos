...
namespace Microsoft.CodeAnalysis.CodeRefactorings
{
    internal static class PredefinedCodeRefactoringProviderNames
    {
        ...
        public const string AddConstructorParametersFromMembers =
            "Add Parameters From Members Code Action Provider";
        ...
        public const string ConvertAnonymousTypeToClass =
            "Convert Anonymous Type to Class Code Action Provider";
        public const string ConvertAnonymousTypeToTuple =
            "Convert Anonymous Type to Tuple Code Action Provider";
        ...
        public const string ConvertToInterpolatedString =
            "Convert To Interpolated String Code Action Provider";
        ...
        public const string GenerateConstructorFromMembers =
            "Generate Constructor From Members Code Action Provider";
        public const string GenerateDefaultConstructors =
            "Generate Default Constructors Code Action Provider";
        public const string GenerateEqualsAndGetHashCodeFromMembers =
            "Generate Equals and GetHashCode Code Action Provider";
        ...
        public const string InitializeMemberFromPrimaryConstructorParameter = nameof(
            InitializeMemberFromPrimaryConstructorParameter
        );
        ...
        public const string IntroduceUsingStatement =
            "Introduce Using Statement Code Action Provider";
        ...
        public const string MergeConsecutiveIfStatements =
            "Merge Consecutive If Statements Code Action Provider";
        public const string MergeNestedIfStatements =
            "Merge Nested If Statements Code Action Provider";
        public const string MoveDeclarationNearReference =
            "Move Declaration Near Reference Code Action Provider";
        public const string MoveStaticMembers =
            "Move Static Members to Another Type Code Action Provider";
        ...
        public const string ReplaceConditionalWithStatements = nameof(
            ReplaceConditionalWithStatements
        );
        public const string ReplaceDocCommentTextWithTag =
            "Replace Documentation Comment Text With Tag Code Action Provider";
        ...
        public const string SplitIntoConsecutiveIfStatements =
            "Split Into Consecutive If Statements Code Action Provider";
        public const string SplitIntoNestedIfStatements =
            "Split Into Nested If Statements Code Action Provider";
