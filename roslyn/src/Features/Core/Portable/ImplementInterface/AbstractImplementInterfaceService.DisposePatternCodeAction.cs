        ...
        private class ImplementInterfaceWithDisposePatternCodeAction : ImplementInterfaceCodeAction
        {
                    ...
                    g.ExpressionStatement(
                        g.InvocationExpression(
                            g.MemberAccessExpression(
                                g.TypeExpression(
                                    compilation.GetTypeByMetadataName(typeof(GC).FullName!)
                                ),
            ...
            )
            {
                ...
                var options = await document
                    ...
                    .ConfigureAwait(false);
                var requireAccessiblity = options.GetOption(
                ...
                var accessibilityLevel =
                    requireAccessiblity.Value == AccessibilityModifiersRequired.Never
                    || requireAccessiblity.Value == AccessibilityModifiersRequired.OmitIfDefault
