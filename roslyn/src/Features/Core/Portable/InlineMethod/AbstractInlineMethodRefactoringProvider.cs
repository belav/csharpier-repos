...
namespace Microsoft.CodeAnalysis.InlineMethod
{
        ...
        where TInvocationSyntax : TExpressionSyntax
    {
        ...
        public override async Task ComputeRefactoringsAsync(CodeRefactoringContext context)
        {
            ...
            var calleeInvocationNode = await context.TryGetRelevantNodeAsync<TInvocationSyntax>()
            ...
            var calleeMethodNode =
                await calleeMethodDeclarationSyntaxReference.GetSyntaxAsync(cancellationToken)
        ...
        private async Task<Solution> InlineMethodAsync(
            ...
            var statementContainsInvocation =
                calleeInvocationNode.GetAncestors()
                    .TakeWhile(
                        node =>
