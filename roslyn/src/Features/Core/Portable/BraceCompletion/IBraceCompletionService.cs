...
namespace Microsoft.CodeAnalysis.BraceCompletion
{
    internal interface IBraceCompletionService : ILanguageService
    {
        ...
        /// </summary>
        Task<BraceCompletionResult?> GetBraceCompletionAsync(
        ...
        /// </remarks>
        Task<BraceCompletionResult?> GetTextChangesAfterCompletionAsync(
            BraceCompletionContext braceCompletionContext,
            CancellationToken cancellationToken
        );
        ...
        /// </summary>
        Task<BraceCompletionResult?> GetTextChangeAfterReturnAsync(
            BraceCompletionContext braceCompletionContext,
        ...
        /// </summary>
        Task<BraceCompletionContext?> GetCompletedBraceContextAsync(
            Document document,
            int caretLocation,
            CancellationToken cancellationToken
        );
