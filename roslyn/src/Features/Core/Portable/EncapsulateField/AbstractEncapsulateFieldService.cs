...
namespace Microsoft.CodeAnalysis.EncapsulateField
{
    internal abstract partial class AbstractEncapsulateFieldService : ILanguageService
    {
        ...
        )
        {
            ...
            var updatedDocument = await codeGenerationService
                .AddPropertyAsync(
                    destinationSolution,
                    destination,
                    property,
            ...
            updatedDocument = await Formatter
                .FormatAsync(
                    updatedDocument,
                    Formatter.Annotation,
                    cancellationToken: cancellationToken
                ...
                .ConfigureAwait(false);
            updatedDocument = await Simplifier
                .ReduceAsync(updatedDocument, cancellationToken: cancellationToken)
                .ConfigureAwait(false);
