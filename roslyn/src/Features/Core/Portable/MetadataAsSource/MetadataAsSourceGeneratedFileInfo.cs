...
namespace Microsoft.CodeAnalysis.MetadataAsSource
{
    internal sealed class MetadataAsSourceGeneratedFileInfo
    {
        ...
        )
        {
            ...
            var compilationOptions = services
            ...
            var assemblyInfoSourceText = SourceText.From(
                assemblyInfoString,
                Encoding,
                ChecksumAlgorithm
            );

            var assemblyInfoDocument = DocumentInfo
                .Create(
            ...
            var generatedDocument = DocumentInfo
                .Create(
                    generatedDocumentId,
                    Path.GetFileName(TemporaryFilePath),
                    loader: loadFileFromDisk
                        ? new WorkspaceFileTextLoader(services, TemporaryFilePath, Encoding)
                        : null,
