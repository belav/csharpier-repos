...
namespace Microsoft.CodeAnalysis.Shared.Extensions
{
    internal static partial class ISymbolExtensions2
    {
        ...
        public static ImmutableArray<TaggedText> GetRemarksDocumentationParts(
            this ISymbol symbol,
            SemanticModel semanticModel,
            int position,
            IDocumentationCommentFormattingService formatter,
        ...
        public static ImmutableArray<TaggedText> GetReturnsDocumentationParts(
            this ISymbol symbol,
            SemanticModel semanticModel,
            int position,
            IDocumentationCommentFormattingService formatter,
        ...
        public static ImmutableArray<TaggedText> GetValueDocumentationParts(
            this ISymbol symbol,
            SemanticModel semanticModel,
            int position,
            IDocumentationCommentFormattingService formatter,
            ...
            symbol switch
            {
                ...
                ITypeParameterSymbol typeParam
                  => typeParam.ContainingSymbol.GetDocumentationComment(
                      ...
                      .GetTypeParameterText(symbol.Name),
        ...
        private static string? GetRemarksDocumentation(
            ISymbol symbol,
            Compilation compilation,
            CancellationToken cancellationToken
        ) =>
            ...
            {
                IMethodSymbol method
                  => GetMethodDocumentation(method, compilation, cancellationToken).RemarksText,
                _
                  => symbol.GetDocumentationComment(
                      compilation,
                      expandIncludes: true,
        ...
        private static string? GetReturnsDocumentation(
            ISymbol symbol,
            Compilation compilation,
            CancellationToken cancellationToken
        ) =>
            ...
            {
                IMethodSymbol method
                  => GetMethodDocumentation(method, compilation, cancellationToken).ReturnsText,
                _
                  => symbol.GetDocumentationComment(
                      compilation,
                      expandIncludes: true,
        ...
        private static string? GetValueDocumentation(
            ISymbol symbol,
            Compilation compilation,
            CancellationToken cancellationToken
        ) =>
            ...
            {
                IMethodSymbol method
                  => GetMethodDocumentation(method, compilation, cancellationToken).ValueText,
                _
                  => symbol.GetDocumentationComment(
                      compilation,
                      expandIncludes: true,
