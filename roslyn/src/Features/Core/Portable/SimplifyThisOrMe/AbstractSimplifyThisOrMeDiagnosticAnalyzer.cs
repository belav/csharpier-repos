        ...
        where TMemberAccessExpressionSyntax : TExpressionSyntax
    {
        protected AbstractSimplifyThisOrMeDiagnosticAnalyzer()
            : base(
                ...
                new LocalizableResourceString(
                    nameof(AnalyzersResources.Name_can_be_simplified),
        ...
        protected abstract AbstractMemberAccessExpressionSimplifier<
            TExpressionSyntax,
            TMemberAccessExpressionSyntax,
            TThisExpressionSyntax
        > Simplifier { get; }
        ...
        protected sealed override void InitializeWorker(AnalysisContext context) =>
            context.RegisterSyntaxNodeAction(
                AnalyzeNode,
                this.SyntaxKinds.Convert<TLanguageKindEnum>(this.SyntaxKinds.ThisExpression)
            );
