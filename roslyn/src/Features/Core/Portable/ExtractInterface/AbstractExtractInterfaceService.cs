...
namespace Microsoft.CodeAnalysis.ExtractInterface
{
    internal abstract class AbstractExtractInterfaceService : ILanguageService
    {
        ...
        private async Task<ExtractInterfaceResult> ExtractInterfaceToNewFileAsync(
            ...
            var originalDocumentSyntaxRoot =
                await refactoringResult.DocumentToExtractFrom.GetSyntaxRootAsync(cancellationToken)
                    .ConfigureAwait(false);
        ...
        private async Task<Solution> GetSolutionWithOriginalTypeUpdatedAsync(
            ...
            foreach (var documentId in documentIds)
            {
                ...
                var typeDeclaration = currentRoot.GetAnnotatedNodes(typeNodeAnnotation)
                    .SingleOrDefault();
                ...
                var unformattedTypeDeclaration = syntaxGenerator.AddInterfaceType(
                        typeDeclaration,
                        typeReference
                    )
