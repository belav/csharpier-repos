...
namespace Microsoft.CodeAnalysis.GenerateMember.GenerateParameterizedMember
{
    ...
    {
        public abstract ImmutableArray<IParameterSymbol> TryMakeParameters(
        ...
        )
        {
            ...
            )
            {
                ...
                var state = await State
                    .GenerateDeconstructMethodStateAsync(
                        (TService)this,
                        semanticDocument,
                        leftSide,
                        typeToGenerateIn,
                ...
                return state != null
                    ? await GetActionsAsync(document, state, fallbackOptions, cancellationToken)
                        .ConfigureAwait(false)
