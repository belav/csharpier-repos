    ...
    >
    {
            ...
            >.State
        {
            ...
            )
            {
                ...
                return await TryFinishInitializingStateAsync(service, document, cancellationToken)
                    .ConfigureAwait(false);
            }
            ...
            )
            {
                ...
                using var _ = ArrayBuilder<IParameterSymbol>.GetInstance(
