...
namespace Microsoft.CodeAnalysis.GenerateMember.GenerateParameterizedMember
{
    ...
    >
        ...
        where TService : AbstractGenerateMethodService<
                TService,
                TSimpleNameSyntax,
                TExpressionSyntax,
                TInvocationExpressionSyntax
        ...
        where TInvocationExpressionSyntax : TExpressionSyntax
    {
        ...
        protected abstract bool TryInitializeSimpleNameState(
            ...
            CancellationToken cancellationToken,
            out SyntaxToken identifierToken,
            out TExpressionSyntax simpleNameOrMemberAccessExpression,
        ...
        )
        {
            ...
            )
            {
                ...
                var state = await State.GenerateMethodStateAsync(
                    (TService)this,
                    semanticDocument,
                    node,
                    cancellationToken
                ...
                return await GetActionsAsync(document, state, cancellationToken)
                    .ConfigureAwait(false);
            }
        }
    }
