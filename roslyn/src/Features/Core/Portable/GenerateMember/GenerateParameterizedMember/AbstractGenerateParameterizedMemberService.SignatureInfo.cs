...
namespace Microsoft.CodeAnalysis.GenerateMember.GenerateParameterizedMember
{
    ...
    >
    {
        internal abstract class SignatureInfo(SemanticDocument document, State state)
        {
            ...
            )
            {
                ...
                return CodeGenerationSymbolFactory.CreatePropertySymbol(
                    ...
                    parameters: await DetermineParametersAsync(cancellationToken)
            ...
            )
            {
                ...
                {
                    isUnsafe =
                        returnType.RequiresUnsafeModifier()
                        || parameters.Any(static p => p.Type.RequiresUnsafeModifier());
                }
                ...
                var languageServiceProvider =
                    Document.Project.Solution.Services.GetLanguageServices(
            ...
            > GetTypeArgumentToTypeParameterMap(CancellationToken cancellationToken)
            {
                return _typeArgumentToTypeParameterMap ??= CreateTypeArgumentToTypeParameterMap(
                    cancellationToken
                );
            }
            ...
            private IDictionary<
                ITypeSymbol,
                ITypeParameterSymbol
            > CreateTypeArgumentToTypeParameterMap(CancellationToken cancellationToken)
            {
            ...
            )
            {
                ...
                var types = await SpecializedTasks
                    .WhenAll(
