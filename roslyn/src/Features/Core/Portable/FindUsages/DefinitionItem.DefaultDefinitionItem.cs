...
namespace Microsoft.CodeAnalysis.FindUsages
{
    internal partial class DefinitionItem
    {
        ...
        internal sealed class DefaultDefinitionItem : DefinitionItem
        {
            ...
            public sealed override async Task<bool> CanNavigateToAsync(
                Workspace workspace,
                CancellationToken cancellationToken
            )
            {
                ...
                return await this.SourceSpans[0]
                    .CanNavigateToAsync(cancellationToken)
                    .ConfigureAwait(false);
            }

            public sealed override async Task<bool> TryNavigateToAsync(
                Workspace workspace,
                bool showInPreviewTab,
                bool activateTab,
                CancellationToken cancellationToken
            )
            {
                ...
                return await this.SourceSpans[0]
                    .TryNavigateToAsync(showInPreviewTab, activateTab, cancellationToken)
                    .ConfigureAwait(false);
            }
