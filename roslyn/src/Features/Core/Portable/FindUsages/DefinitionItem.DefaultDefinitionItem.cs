    ...
    internal partial class DefinitionItem
    {
        ...
        internal sealed class DefaultDefinitionItem : DefinitionItem
        {
            ...
            )
            {
                ...
                {
                    var (project, symbol) = await TryResolveSymbolInCurrentSolutionAsync(
                            workspace,
                            symbolKey,
                            cancellationToken
                        )
            ...
            private async ValueTask<(Project? project, ISymbol? symbol)> TryResolveSymbolInCurrentSolutionAsync(
                Workspace workspace,
                string symbolKey,
                CancellationToken cancellationToken
            )
