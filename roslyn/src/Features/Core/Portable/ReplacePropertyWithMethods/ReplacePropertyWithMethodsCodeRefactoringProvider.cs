...
namespace Microsoft.CodeAnalysis.ReplacePropertyWithMethods
{
    ...
    internal class ReplacePropertyWithMethodsCodeRefactoringProvider : CodeRefactoringProvider
    {
        ...
        public override async Task ComputeRefactoringsAsync(CodeRefactoringContext context)
        {
            ...
            var propertyDeclaration = await service.GetPropertyDeclarationAsync(context)
...
#pragma warning restore IDE0060 // Remove unused parameter
        ...
        )
        {
            ...
            var root = await updatedDocument.GetRequiredSyntaxRootAsync(cancellationToken)
                .ConfigureAwait(false);
        ...
        {
            using var _ = ArrayBuilder<(IPropertySymbol property, SyntaxNode declaration)>
        ...
        {
            return originalDefinition.GetSymbolKey(cancellationToken)
        ...
        {
            public ReplacePropertyWithMethodsCodeAction(
                string title,
