...
namespace Microsoft.CodeAnalysis.Features.EmbeddedLanguages.Json.LanguageServices
{
    ...
    /// </summary>
    internal abstract class AbstractJsonDetectionAnalyzer
        : AbstractBuiltInCodeStyleDiagnosticAnalyzer
    {
        ...
        protected AbstractJsonDetectionAnalyzer(EmbeddedLanguageInfo info)
            : base(
                ...
                new LocalizableResourceString(
                    nameof(FeaturesResources.Probable_JSON_string_detected),
        ...
        {
            if (
                !context.GetIdeAnalyzerOptions().DetectAndOfferEditorFeaturesForProbableJsonStrings
        ...
        )
        {
            ...
            foreach (var child in node.ChildNodesAndTokens())
            {
                ...
                else
                {
                    ...
                    if (
                        _info.IsAnyStringLiteral(token.RawKind)
                        && detector.TryParseString(
                            token,
                    ...
                    )
                    {
                        ...
                        var properties =
                            strictTree != null && strictTree.Diagnostics.Length == 0
                                ? s_strictProperties
