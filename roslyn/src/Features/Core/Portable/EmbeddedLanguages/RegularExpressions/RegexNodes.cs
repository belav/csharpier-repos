...
namespace Microsoft.CodeAnalysis.EmbeddedLanguages.RegularExpressions
{
    ...
    /// </summary>
    internal sealed class RegexSequenceNode(ImmutableArray<RegexExpressionNode> children)
        : RegexExpressionNode(RegexKind.Sequence)
    {
        ...
        internal override RegexNodeOrToken ChildAt(int index) => Children[index];
    ...
    internal sealed class RegexCharacterClassSubtractionNode : RegexPrimaryExpressionNode
    {
        public RegexCharacterClassSubtractionNode(
            RegexToken minusToken,
            RegexBaseCharacterClassNode characterClass
        )
    ...
    internal sealed class RegexAlternationNode : RegexExpressionNode
    {
        ...
        internal override RegexNodeOrToken ChildAt(int index) => SequenceList.NodesAndTokens[index];
    ...
    internal sealed class RegexCaptureGroupingNode : RegexQuestionGroupingNode
    {
        public RegexCaptureGroupingNode(
            RegexToken openParenToken,
            RegexToken questionToken,
            RegexToken openToken,
            RegexToken captureToken,
    ...
    internal sealed class RegexBalancingGroupingNode : RegexQuestionGroupingNode
    {
        public RegexBalancingGroupingNode(
            ...
            RegexToken questionToken,
            RegexToken openToken,
            RegexToken firstCaptureToken,
            RegexToken minusToken,
            RegexToken secondCaptureToken,
            RegexToken closeToken,
            RegexExpressionNode expression,
            RegexToken closeParenToken
        )
    ...
    internal sealed class RegexConditionalCaptureGroupingNode : RegexConditionalGroupingNode
    {
        public RegexConditionalCaptureGroupingNode(
            RegexToken openParenToken,
            RegexToken questionToken,
            RegexToken innerOpenParenToken,
            RegexToken captureToken,
    ...
    {
        protected RegexEscapeNode(RegexKind kind, RegexToken backslashToken)
            : base(kind)
        {
    ...
    /// One of \b \B \A \G \z \Z
    /// </summary>
    internal sealed class RegexAnchorEscapeNode(RegexToken backslashToken, RegexToken typeToken)
        : RegexTypeEscapeNode(RegexKind.AnchorEscape, backslashToken, typeToken)
    {
        internal override int ChildCount => 2;
    ...
    internal sealed class RegexCharacterClassEscapeNode(
        RegexToken backslashToken,
        RegexToken typeToken
    ) : RegexTypeEscapeNode(RegexKind.CharacterClassEscape, backslashToken, typeToken)
    {
        internal override int ChildCount => 2;
    ...
    internal sealed class RegexControlEscapeNode(
        RegexToken backslashToken,
        RegexToken typeToken,
        RegexToken controlToken
    ) : RegexTypeEscapeNode(RegexKind.ControlEscape, backslashToken, typeToken)
    {
        internal override int ChildCount => 3;
    ...
    internal sealed class RegexHexEscapeNode(
        ...
        RegexToken typeToken,
        RegexToken hexText
    ) : RegexTypeEscapeNode(RegexKind.HexEscape, backslashToken, typeToken)
    {
        internal override int ChildCount => 3;
    ...
    internal sealed class RegexUnicodeEscapeNode(
        ...
        RegexToken typeToken,
        RegexToken hexText
    ) : RegexTypeEscapeNode(RegexKind.UnicodeEscape, backslashToken, typeToken)
    {
        internal override int ChildCount => 3;
    ...
    internal sealed class RegexCaptureEscapeNode(
        ...
        RegexToken captureToken,
        RegexToken closeToken
    ) : RegexEscapeNode(RegexKind.CaptureEscape, backslashToken)
    {
        internal override int ChildCount => 4;
    ...
    internal sealed class RegexKCaptureEscapeNode(
        ...
        RegexToken captureToken,
        RegexToken closeToken
    ) : RegexTypeEscapeNode(RegexKind.KCaptureEscape, backslashToken, typeToken)
    {
        internal override int ChildCount => 5;
    ...
    internal sealed class RegexOctalEscapeNode(RegexToken backslashToken, RegexToken octalText)
        : RegexEscapeNode(RegexKind.OctalEscape, backslashToken)
    {
        internal override int ChildCount => 2;
    ...
    internal sealed class RegexBackreferenceEscapeNode(
        RegexToken backslashToken,
        RegexToken numberToken
    ) : RegexEscapeNode(RegexKind.BackreferenceEscape, backslashToken)
    {
        internal override int ChildCount => 2;
