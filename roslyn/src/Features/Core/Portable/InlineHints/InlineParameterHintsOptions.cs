    ...
    )
    {
        ...
        public static InlineParameterHintsOptions From(OptionSet options, string language) =>
            new(
                ...
                ForObjectCreationParameters: options.GetOption(
                    Metadata.ForObjectCreationParameters,
                    language
                ),
                ForOtherParameters: options.GetOption(Metadata.ForOtherParameters, language),
                SuppressForParametersThatDifferOnlyBySuffix: options.GetOption(
                    Metadata.SuppressForParametersThatDifferOnlyBySuffix,
                    language
                ),
                SuppressForParametersThatMatchMethodIntent: options.GetOption(
                    Metadata.SuppressForParametersThatMatchMethodIntent,
                    language
                ),
                SuppressForParametersThatMatchArgumentName: options.GetOption(
                    Metadata.SuppressForParametersThatMatchArgumentName,
                    language
                )
            );
    ...
    )
    {
        ...
        public static InlineTypeHintsOptions From(OptionSet options, string language) =>
            new(
                ...
                ForImplicitVariableTypes: options.GetOption(
                    Metadata.ForImplicitVariableTypes,
                    language
                ),
                ForLambdaParameterTypes: options.GetOption(
                    Metadata.ForLambdaParameterTypes,
                    language
                ),
                ForImplicitObjectCreation: options.GetOption(
                    Metadata.ForImplicitObjectCreation,
                    language
                )
            );
