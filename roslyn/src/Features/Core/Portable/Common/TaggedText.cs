...
namespace Microsoft.CodeAnalysis
{
    ...
    internal static class TaggedTextExtensions
    {
        ...
        )
        {
            ...
            getNavigationHint ??= static symbol =>
                symbol?.ToDisplayString(SymbolDisplayFormat.MinimallyQualifiedFormat);

            return displayParts.SelectAsArray(d => new TaggedText(
                GetTag(d),
                d.ToString(),
                style,
                includeNavigationHints && d.Kind != SymbolDisplayPartKind.NamespaceName
        ...
        {
            return values.IsDefault ? null : Join(values);
        }
        ...
        )
        {
            ...
            foreach (var part in parts)
            {
                ...
                yield return new ClassifiedSpan(
                    new TextSpan(index, text.Length),
        ...
        )
        {
            ...
            if (includeLeftToRightMarker)
            {
                ...
                if (
                    classificationTypeName
                    is ClassificationTypeNames.Punctuation
