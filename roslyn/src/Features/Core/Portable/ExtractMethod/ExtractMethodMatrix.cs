    ...
    internal class ExtractMethodMatrix
    {
        ...
        )
        {
            ...
            FatalError.ReportAndCatch(
                new Exception($"extract method encountered unknown states: {key.ToString()}"),
        ...
        private static void BuildMatrix()
        {
            ...
            s_matrix.Add(
                new Key(
                    ...
                    writtenInside: true,
                    readOutside: false,
                    writtenOutside: false
                ),
                VariableStyle.InputOnly
            );
            s_matrix.Add(
                new Key(
                    dataFlowIn: false,
            ...
            s_matrix.Add(
                ...
                VariableStyle.OutWithErrorInput
            );
            s_matrix.Add(
                new Key(
                    dataFlowIn: true,
