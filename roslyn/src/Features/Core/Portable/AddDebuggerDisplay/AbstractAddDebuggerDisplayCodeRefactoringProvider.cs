...
namespace Microsoft.CodeAnalysis.AddDebuggerDisplay
{
        ...
        where TMethodDeclarationSyntax : SyntaxNode
    {
        ...
        public override async Task ComputeRefactoringsAsync(CodeRefactoringContext context)
        {
            ...
            var debuggerAttributeTypeSymbol = compilation.GetTypeByMetadataName(
        ...
        )?> GetRelevantTypeFromHeaderAsync(CodeRefactoringContext context)
        {
        ...
        private static async Task<(
            TTypeDeclarationSyntax type,
            CodeActionPriority priority
        )?> GetRelevantTypeFromMethodAsync(CodeRefactoringContext context)
        {
            var (document, _, cancellationToken) = context;
            ...
            var priority = isDebuggerDisplayMethod
        ...
        private static bool HasDebuggerDisplayAttribute(
            ...
            typeSymbol
                ...
                .Contains(
                    compilation.GetTypeByMetadataName("System.Diagnostics.DebuggerDisplayAttribute")
                );

        private async Task<Document> ApplyAsync(
            Document document,
            TTypeDeclarationSyntax type,
                    ...
                    attributeArgument = generator.InterpolatedStringExpression(
                        ...
                        new SyntaxNode[]
                        {
                            ...
                            generator.Interpolation(
                                generator.NameOfExpression(
                                    generator.IdentifierName(DebuggerDisplayMethodName)
                                )
                            ),
                            generator.InterpolatedStringText(
                                generator.InterpolatedStringTextToken("(),nq}}", "(),nq}}")
                            ),
                        },
