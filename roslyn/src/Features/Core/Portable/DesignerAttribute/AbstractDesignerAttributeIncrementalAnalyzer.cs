...
namespace Microsoft.CodeAnalysis.DesignerAttribute
{
        ...
        : IDesignerAttributeDiscoveryService
    {
        ...
        )
        {
            ...
            // in this project.
            var projectVersion = await project
            ...
            if (!changedData.IsEmpty)
                await callback
                    .ReportDesignerAttributeDataAsync(changedData, cancellationToken)
                    .ConfigureAwait(false);
        ...
        )
        {
            ...
            using var _2 = ArrayBuilder<DesignerAttributeData>.GetInstance(
                tasks.Count,
                out var results
            );
        ...
        )
        {
            try
            {
                ...
                var category = await DesignerAttributeHelpers
