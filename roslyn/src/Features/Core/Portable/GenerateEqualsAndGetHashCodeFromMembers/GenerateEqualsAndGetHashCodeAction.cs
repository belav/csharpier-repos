    ...
    internal partial class GenerateEqualsAndGetHashCodeFromMembersCodeRefactoringProvider
    {
        private partial class GenerateEqualsAndGetHashCodeAction : CodeAction
        {
            ...
            )
            {
                ...
                {
                    methods.Add(
                        await CreateEqualsMethodAsync(cancellationToken).ConfigureAwait(false)
                    );
                }
                ...
                {
                    methods.Add(
                        await CreateGetHashCodeMethodAsync(cancellationToken).ConfigureAwait(false)
                    );
                }
                ...
                var codeGenOptions = await _document
                    ...
                    .ConfigureAwait(false);
                var formattingOptions = await _document
                ...
                var newTypeDeclaration = codeGenerator.AddMembers(
                    _typeDeclaration,
                    methods,
                    info,
                    cancellationToken
                ...
                if (constructedTypeToImplement is object)
                {
                    ...
                    newTypeDeclaration = generator.AddInterfaceType(
                        newTypeDeclaration,
                ...
                var formattedDocument = await service
                    .FormatDocumentAsync(newDocument, formattingOptions, cancellationToken)
                    .ConfigureAwait(false);
            ...
            )
            {
                ...
                var useNullableTypeArgument =
                    ...
                    && semanticModel
                        .GetNullableContext(_typeDeclaration.SpanStart)
                        .AnnotationsEnabled();
            ...
            )
            {
                ...
                var addImportOptions = await _document
                    .GetAddImportPlacementOptionsAsync(_fallbackOptions, cancellationToken)
                    .ConfigureAwait(false);
            ...
            )
            {
                ...
                members.Add(
                    CreateEqualityOperator(compilation, generator, generatorInternal, parameters)
                );
            ...
            private static IMethodSymbol CreateInequalityOperator(
                Compilation compilation,
                SyntaxGenerator generator,
                ImmutableArray<IParameterSymbol> parameters
            )
            ...
            public override string Title => GetTitle(_generateEquals, _generateGetHashCode);
