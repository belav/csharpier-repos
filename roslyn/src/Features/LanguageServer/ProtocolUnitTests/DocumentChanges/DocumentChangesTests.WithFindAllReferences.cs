...
class B
{
    void M2()
    {
            ...
            using (testLspServer)
            {
                ...
                var findResults = await FindAllReferencesHandlerTests.RunFindAllReferencesAsync(
                    testLspServer,
                    locationTyped
                );
                ...
                findResults = await FindAllReferencesHandlerTests.RunFindAllReferencesAsync(
                    testLspServer,
                    locationTyped
                );
