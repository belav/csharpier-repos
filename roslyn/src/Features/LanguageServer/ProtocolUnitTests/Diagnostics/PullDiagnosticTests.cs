...
namespace Microsoft.CodeAnalysis.LanguageServer.UnitTests.Diagnostics
{
    ...
    {
        public PullDiagnosticTests(ITestOutputHelper testOutputHelper)
        ...
        )
        {
            ...
            var syntaxResults = await RunGetDocumentPullDiagnosticsAsync(
                ...
                document.GetURI(),
                useVSDiagnostics: true,
                category: PullDiagnosticCategories.DocumentCompilerSyntax
            );
            ...
            var semanticResults = await RunGetDocumentPullDiagnosticsAsync(
                ...
                document.GetURI(),
                useVSDiagnostics: true,
                category: PullDiagnosticCategories.DocumentCompilerSemantic
            );
            ...
            var syntaxResults2 = await RunGetDocumentPullDiagnosticsAsync(
                ...
                document.GetURI(),
                useVSDiagnostics: true,
                previousResultId: syntaxResults.Single().ResultId,
                category: PullDiagnosticCategories.DocumentCompilerSyntax
            );
            var semanticResults2 = await RunGetDocumentPullDiagnosticsAsync(
                ...
                document.GetURI(),
                useVSDiagnostics: true,
                previousResultId: semanticResults.Single().ResultId,
                category: PullDiagnosticCategories.DocumentCompilerSemantic
            );
            ...
            var syntaxAnalyzerResults = await RunGetDocumentPullDiagnosticsAsync(
                ...
                document.GetURI(),
                useVSDiagnostics: true,
                category: PullDiagnosticCategories.DocumentAnalyzerSyntax
            );
            ...
            var semanticAnalyzerResults = await RunGetDocumentPullDiagnosticsAsync(
                ...
                document.GetURI(),
                useVSDiagnostics: true,
                category: PullDiagnosticCategories.DocumentAnalyzerSemantic
            );

            Assert.Equal(
                CSharpSyntaxAnalyzer.RuleId,
                syntaxAnalyzerResults.Single().Diagnostics.Single().Code
            );
            Assert.Equal(
                CSharpSemanticAnalyzer.RuleId,
                semanticAnalyzerResults.Single().Diagnostics.Single().Code
            );
            ...
            var syntaxAnalyzerResults2 = await RunGetDocumentPullDiagnosticsAsync(
                ...
                document.GetURI(),
                useVSDiagnostics: true,
                previousResultId: syntaxAnalyzerResults.Single().ResultId,
                category: PullDiagnosticCategories.DocumentAnalyzerSyntax
            );
            var semanticAnalyzerResults2 = await RunGetDocumentPullDiagnosticsAsync(
                ...
                document.GetURI(),
                useVSDiagnostics: true,
                previousResultId: semanticAnalyzerResults.Single().ResultId,
                category: PullDiagnosticCategories.DocumentAnalyzerSemantic
            );

            Assert.Equal(
                syntaxAnalyzerResults.Single().ResultId,
                syntaxAnalyzerResults2.Single().ResultId
            );
            Assert.Equal(
                semanticAnalyzerResults.Single().ResultId,
                semanticAnalyzerResults2.Single().ResultId
            );
        }
        ...
        private sealed class CSharpSemanticAnalyzer : DiagnosticAnalyzer
        {
            ...
            public override void Initialize(AnalysisContext context)
            {
                context.RegisterSyntaxNodeAction(
                    context =>
                        context.ReportDiagnostic(
                            Diagnostic.Create(_descriptor, context.Node.GetLocation())
                        ),
                ...
                @"internal class Program
{
    static void Main(string[] args)
    {
        ...
        [Theory, CombinatorialData]
        public async Task TestDocumentTodoCommentsDiagnosticsForOpenFile_NoCategory(
            bool useVSDiagnostics,
            bool mutatingLspWorkspace
        )
        {
...
class A {
        ...
        [Theory, CombinatorialData]
        public async Task TestDocumentTodoCommentsDiagnosticsForOpenFile_Category(
            bool useVSDiagnostics,
            bool mutatingLspWorkspace
        )
        {
...
class A {
            ...
            var results = await RunGetDocumentPullDiagnosticsAsync(
                ...
                document.GetURI(),
                useVSDiagnostics,
                category: PullDiagnosticCategories.Task
            );
        ...
        public async Task TestDocumentDiagnosticsWhenGlobalStateChanges(
            bool useVSDiagnostics,
            bool mutatingLspWorkspace
        )
        {
            ...
            var refresher = testLspServer.TestWorkspace
                .ExportProvider
...
class B {";
    ...
    <Project Language=""C#"" CommonReferences=""true"" AssemblyName=""CSProj2"">
        <Document IsLinkFile=""true"" LinkFilePath=""C:\C.cs"" LinkAssemblyName=""CSProj1"">{documentText}</Document>
            ...
            var csproj1Results = await RunGetDocumentPullDiagnosticsAsync(
                testLspServer,
                GetVsTextDocumentIdentifier(csproj1Document),
                useVSDiagnostics: true
            );
            var csproj1Diagnostic = (VSDiagnostic)csproj1Results.Single().Diagnostics.Single();
            var csproj2Results = await RunGetDocumentPullDiagnosticsAsync(
                testLspServer,
                GetVsTextDocumentIdentifier(csproj2Document),
                useVSDiagnostics: true
            );
                ...
                @"namespace M
{
    ...
    <Project Language=""C#"" CommonReferences=""true"" AssemblyName=""CSProj2"">
        ...
        )
        {
            ...
            await using var testLspServer = await CreateTestLspServerAsync(
                ...
                GetInitializationOptions(
                    ...
                    CompilerDiagnosticsScope.OpenFiles,
                    useVSDiagnostics,
                    DiagnosticMode.SolutionCrawlerPush,
        ...
        [Theory, CombinatorialData]
        public async Task TestDocumentDiagnosticsWithFadingOptionOn(
            bool useVSDiagnostics,
            bool mutatingLspWorkspace
        )
        {
...
class A
{
            ...
            if (useVSDiagnostics)
            {
                ...
                Assert.False(
                    results.Single().Diagnostics![1].Tags!.Contains(DiagnosticTag.Unnecessary)
                );
                Assert.Equal(firstLocation, results.Single().Diagnostics![1].Range);
            }
            else
        ...
        [Theory, CombinatorialData]
        public async Task TestDocumentDiagnosticsWithFadingOptionOff(
            bool useVSDiagnostics,
            bool mutatingLspWorkspace
        )
        {
...
class A
{
        ...
        [Theory, CombinatorialData]
        public async Task TestDocumentDiagnosticsWithNotConfigurableFading(
            bool useVSDiagnostics,
            bool mutatingLspWorkspace
        )
        {
    ...
    void M()
    {
        _ = {|line:{|open:(|}1 + 2 +|}
            ...
            if (useVSDiagnostics)
            {
                ...
                Assert.True(
                    results.Single().Diagnostics![2].Tags!.Contains(DiagnosticTag.Unnecessary)
                );
            ...
            else
            {
                ...
                Assert.True(
                    results.Single().Diagnostics.Single().Tags!.Contains(DiagnosticTag.Unnecessary)
                );
                ...
                Assert.Equal(
                    openLocation,
                    results.Single().Diagnostics.Single().RelatedInformation![0].Location.Range
                );

                // There should be an additional location for the close paren.
                Assert.Equal(
                    closeLocation,
                    results.Single().Diagnostics.Single().RelatedInformation![1].Location.Range
                );
            }
        }
        ...
        [
            Theory,
            CombinatorialData,
            WorkItem("https://devdiv.visualstudio.com/DevDiv/_workitems/edit/1806590")
        ]
        public async Task TestDocumentDiagnosticsForUnnecessarySuppressions(
            bool useVSDiagnostics,
            bool mutatingLspWorkspace
        )
        {
            ...
            Assert.Equal(
                ...
                results.Single().Diagnostics.Single().Code
            );
        }
        ...
        [
            Theory,
            CombinatorialData,
            WorkItem("https://devdiv.visualstudio.com/DevDiv/_workitems/edit/1824321")
        ]
        public async Task TestDocumentDiagnosticsForSourceSuppressions(
            bool useVSDiagnostics,
            bool mutatingLspWorkspace
        )
        {
                ...
                @"class A
{
    public A SomeA = new A();
            ...
            Assert.Equal(
                ...
                results.Single().Diagnostics.Single().Severity
            );
        }
                ...
                @"class A
{
    public A SomeA = new A();
        ...
        public async Task TestWorkspaceDiagnosticsForClosedFilesWithRunCodeAnalysisAndFSAOff(
            bool useVSDiagnostics,
            bool mutatingLspWorkspace,
            bool scopeRunCodeAnalysisToProject
        )
        {
            var markup1 = @"class A {";
            var markup2 = "";
            ...
            var projectId = scopeRunCodeAnalysisToProject
            ...
            var results3 = await RunGetWorkspacePullDiagnosticsAsync(
                testLspServer,
                useVSDiagnostics,
                previousResults: CreateDiagnosticParamsFromPreviousReports(results2)
            );
        ...
        [Theory, CombinatorialData, WorkItem("https://github.com/dotnet/roslyn/issues/65967")]
        public async Task TestWorkspaceDiagnosticsForClosedFilesWithWithRunCodeAnalysisFSAOn(
            bool useVSDiagnostics,
            bool mutatingLspWorkspace,
            bool scopeRunCodeAnalysisToProject
        )
        ...
        [Theory, CombinatorialData]
        public async Task TestWorkspaceTodoForClosedFilesWithFSAOffAndTodoOff(
            bool useVSDiagnostics,
            bool mutatingLspWorkspace
        )
        {
...
class A {
        ...
        [Theory, CombinatorialData]
        public async Task TestWorkspaceTodoForClosedFilesWithFSAOffAndTodoOn(
            bool useVSDiagnostics,
            bool mutatingLspWorkspace
        )
        {
...
class A {
            ...
            if (useVSDiagnostics)
            {
                ...
                Assert.Equal(
                    VSDiagnosticRank.Default,
                    ((VSDiagnostic)results[0].Diagnostics.Single()).DiagnosticRank
                );
            }
            else
            {
...
class A {
        ...
        [Theory, CombinatorialData]
        public async Task TestWorkspaceTodoForClosedFilesWithFSAOnAndTodoOff(
            bool useVSDiagnostics,
            bool mutatingLspWorkspace
        )
        {
...
class A {
        ...
        [Theory, CombinatorialData]
        public async Task TestWorkspaceTodoForClosedFilesWithFSAOnAndTodoOn(
            bool useVSDiagnostics,
            bool mutatingLspWorkspace
        )
        {
...
class A {
        ...
        [Theory, CombinatorialData]
        public async Task TestWorkspaceTodoAndDiagnosticForClosedFilesWithFSAOnAndTodoOn(
            bool useVSDiagnostics,
            bool mutatingLspWorkspace
        )
        {
...
";
        ...
        )
        {
            ...
            Assert.Equal(
                DiagnosticProducingGenerator.Descriptor.Id,
        ...
        )
        {
            ...
            await using var testLspServer = await CreateTestLspServerAsync(
                ...
                GetInitializationOptions(
                    ...
                    sourceGeneratedMarkups: [markup1, markup2]
                )
            );
...
class A {";
            ...
            Assert.Equal(3, results.Length);
            Assert.Equal(
                ProtocolConversions.CreateAbsoluteUri(@"C:\test1.cs"),
                results[0].TextDocument!.Uri
            );
            Assert.Equal("CS1513", results[0].Diagnostics.Single().Code);
                ...
                @"namespace M
{
    ...
    <Project Language=""C#"" CommonReferences=""true"" AssemblyName=""CSProj2"" FilePath=""C:\CSProj2.csproj"">
        <Document FilePath=""C:\B.cs"">{markup2}</Document>
            ...
            var projectInfo = testLspServer.TestWorkspace
                .Projects
            ...
            var operations = testLspServer.TestWorkspace
                .ExportProvider
...
<Project Language=""C#"" CommonReferences=""true"" AssemblyName=""CSProj3"" FilePath=""C:\CSProj3.csproj"">
        ...
        [Theory, CombinatorialData]
        public async Task TestWorkspaceDiagnosticsDoesNotThrowIfProjectWithoutFilePathExists(
            bool useVSDiagnostics,
            bool mutatingLspWorkspace
        )
        {
    ...
    <Project Language=""C#"" CommonReferences=""true"" AssemblyName=""CSProj2"" FilePath="""">
        ...
        [Theory, CombinatorialData]
        public async Task TestWorkspaceDiagnosticsWaitsForLspTextChanges(
            bool useVSDiagnostics,
            bool mutatingLspWorkspace
        )
        {
            ...
            var resultTask = RunGetWorkspacePullDiagnosticsAsync(
                testLspServer,
                useVSDiagnostics,
                useProgress: true,
                triggerConnectionClose: false
            );
        ...
        [Theory, CombinatorialData]
        public async Task TestWorkspaceDiagnosticsWaitsForLspSolutionChanges(
            bool useVSDiagnostics,
            bool mutatingLspWorkspace
        )
        {
