...
namespace Microsoft.CodeAnalysis.LanguageServer.UnitTests.Diagnostics
{
    ...
    {
        public NonLocalDiagnosticTests(ITestOutputHelper testOutputHelper)
            : base(testOutputHelper) { }

        [Theory, CombinatorialData]
        [WorkItem("https://github.com/dotnet/vscode-csharp/issues/5634")]
        internal async Task TestNonLocalDocumentDiagnosticsAreReportedWhenFSAEnabled(
        ...
        )
        {
            ...
            if (fsaEnabled)
            {
                ...
                Assert.Equal(
                    ...
                    orderedDiagnostics[0].Code
                );
                Assert.Equal(
                    NonLocalDiagnosticsAnalyzer.CompilationEndDescriptor.Id,
                    orderedDiagnostics[1].Code
                );
                Assert.Equal(document.GetURI(), results[0].Uri);

                // Asking again should give us back unchanged diagnostics.
                var results2 = await RunGetDocumentPullDiagnosticsAsync(
                    testLspServer,
                    document.GetURI(),
                    useVSDiagnostics: false,
        ...
        protected override TestComposition Composition =>
            base.Composition.AddParts(typeof(NonLocalDiagnosticsAnalyzer));
        ...
        {
            public static readonly DiagnosticDescriptor NonLocalDescriptor = new(
                "NonLocal0001",
                "Title1",
                "NonLocal0001",
                "Category",
            ...
            public static readonly DiagnosticDescriptor CompilationEndDescriptor = new(
                "NonLocal0002",
                "Title2",
                "NonLocal0002",
                "Category",
            ...
            public override ImmutableArray<DiagnosticDescriptor> SupportedDiagnostics =>
                ImmutableArray.Create(NonLocalDescriptor, CompilationEndDescriptor);
