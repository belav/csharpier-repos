...
internal abstract class AbstractProjectDiagnosticSource(Project project) : IDiagnosticSource
{
    protected Project Project => project;

    public static AbstractProjectDiagnosticSource CreateForFullSolutionAnalysisDiagnostics(
        Project project,
        Func<DiagnosticAnalyzer, bool>? shouldIncludeAnalyzer
    ) => new FullSolutionAnalysisDiagnosticSource(project, shouldIncludeAnalyzer);

    public static AbstractProjectDiagnosticSource CreateForCodeAnalysisDiagnostics(
        Project project,
    ...
    ) : AbstractProjectDiagnosticSource(project)
    {
        ...
        {
            return codeAnalysisService.GetLastComputedProjectDiagnosticsAsync(
                Project.Id,
                cancellationToken
            );
        }
