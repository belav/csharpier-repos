...
namespace Microsoft.CodeAnalysis.LanguageServer.Handler.Diagnostics
{
        ...
        where TDiagnosticsParams : IPartialResultParams<TReport[]>
    {
        ...
        /// </summary>
        protected abstract ValueTask<ImmutableArray<Document>> GetOrderedDocumentsAsync(
        ...
        )
        {
            ...
            var orderedDocuments = await GetOrderedDocumentsAsync(context, cancellationToken)
        ...
        private static Dictionary<
            Document,
            PreviousPullResult
        > GetDocumentToPreviousDiagnosticParams(
            RequestContext context,
        ...
        )
        {
            ...
            var diagnostics = await GetDiagnosticsAsync(
                ...
                .ConfigureAwait(false);
            context.TraceInformation(
                $"Found {diagnostics.Length} diagnostics for {document.FilePath}"
            );
