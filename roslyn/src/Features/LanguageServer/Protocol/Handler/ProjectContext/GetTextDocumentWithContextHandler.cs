...
namespace Microsoft.CodeAnalysis.LanguageServer.Handler
{
    ...
    internal class GetTextDocumentWithContextHandler
        : AbstractStatelessRequestHandler<GetTextDocumentWithContextParams, ActiveProjectContexts?>
    {
        ...
        )
        {
            ...
            var documents = context.Solution
            ...
            var currentContextDocumentId = openDocument.Project.Solution.Workspace
                .GetDocumentIdInCurrentContext(openDocument.Id);

            return Task.FromResult<ActiveProjectContexts?>(
                new ActiveProjectContexts
                {
