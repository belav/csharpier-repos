...
internal sealed class RequestTelemetryLogger : IDisposable, ILspService
{
    ...
    public RequestTelemetryLogger(string serverTypeName)
    {
        ...
        _queuedDurationLogAggregator = new HistogramLogAggregator<string>(
            bucketSize: 10,
            maxBucketValue: 1000
        );
        ...
        _requestDurationLogAggregator = new HistogramLogAggregator<string>(
            bucketSize: 1,
            maxBucketValue: 40
        );
    }
    ...
    )
    {
        ...
        _requestDurationLogAggregator.IncreaseCount(
            methodName,
            (int)ComputeLogValue(requestDuration.TotalMilliseconds)
        );
