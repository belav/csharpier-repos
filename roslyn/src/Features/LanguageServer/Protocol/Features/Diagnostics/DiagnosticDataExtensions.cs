...
internal static class DiagnosticDataExtensions
{
    internal static bool TryGetUnnecessaryDataLocations(
        ...
        [NotNullWhen(true)] out ImmutableArray<DiagnosticDataLocation>? unnecessaryLocations
    )
    {
        ...
        {
            using var _ = PooledObjects.ArrayBuilder<DiagnosticDataLocation>
    ...
    internal static bool TryGetUnnecessaryLocationIndices(
        this DiagnosticData diagnosticData,
        [NotNullWhen(true)] out string? unnecessaryIndices
    )
    {
