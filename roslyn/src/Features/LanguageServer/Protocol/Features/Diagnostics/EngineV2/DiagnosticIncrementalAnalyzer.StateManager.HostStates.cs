...
namespace Microsoft.CodeAnalysis.Diagnostics.EngineV2
{
    internal partial class DiagnosticIncrementalAnalyzer
    {
        private partial class StateManager
        {
            ...
            {
                var key = new HostAnalyzerStateSetKey(
                    project.Language,
                    project.Solution.State.Analyzers.HostAnalyzerReferences
                );
                ...
                )
                {
                    ...
                    var analyzerMap = CreateStateSetMap(
                        ...
                        includeWorkspacePlaceholderAnalyzers: true
                    );
            ...
            private sealed class HostAnalyzerStateSets
            {
                ...
                private static int GetPriority(StateSet state)
                {
                    ...
                    return state.Analyzer switch
                    {
                        ...
                        GeneratorDiagnosticsPlaceholderAnalyzer _ =>
                            GeneratorDiagnosticsPlaceholderAnalyzerPriority,
