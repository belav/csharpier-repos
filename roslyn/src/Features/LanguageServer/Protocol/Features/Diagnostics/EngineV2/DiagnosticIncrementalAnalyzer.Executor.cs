...
namespace Microsoft.CodeAnalysis.Diagnostics.EngineV2
{
    internal partial class DiagnosticIncrementalAnalyzer
    {
                ...
                if (analyzer.IsCompilerAnalyzer())
                {
                    return compilerDiagnosticsScope switch
                    {
                        ...
                        CompilerDiagnosticsScope.VisibleFilesAndFilesWithPreviouslyReportedDiagnostics
                            => isVisibleDocument || (isOpenDocument && !previousData.Items.IsEmpty),
            ...
            )
            {
                try
                {
                    var diagnostics = await executor
                        .ComputeDiagnosticsAsync(stateSet.Analyzer, cancellationToken)
        ...
        )
        {
            ...
            var generatorDiagnostics = await project
