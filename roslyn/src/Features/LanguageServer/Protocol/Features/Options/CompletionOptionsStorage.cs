...
internal static class CompletionOptionsStorage
{
    public static CompletionOptions GetCompletionOptions(
        ...
        new()
        {
            ...
            UpdateImportCompletionCacheInBackground = options.GetOption(
    ...
    public static readonly Option2<bool> ShowNewSnippetExperienceFeatureFlag =
        new(
            nameof(CompletionOptions),
            nameof(ShowNewSnippetExperienceFeatureFlag),
    ...
    public static readonly PerLanguageOption2<bool> HideAdvancedMembers =
        new(
            ...
            new RoamingProfileStorageLocation(
                "TextEditor.%LANGUAGE%.Hide Advanced Auto List Members"
            )
        );
    ...
    public static readonly Option2<bool> ForceExpandedCompletionIndexCreation =
        new(
            nameof(CompletionOptions),
            nameof(ForceExpandedCompletionIndexCreation),
            defaultValue: false
        );
    ...
    public static readonly Option2<bool> UpdateImportCompletionCacheInBackground =
        new(
            nameof(CompletionOptions),
            nameof(UpdateImportCompletionCacheInBackground),
            defaultValue: false
        );
    ...
    public static readonly PerLanguageOption2<bool?> ShowNewSnippetExperience =
        new(
            nameof(CompletionOptions),
            nameof(ShowNewSnippetExperience),
            CompletionOptions.Default.ShowNewSnippetExperience,
            storageLocation: new RoamingProfileStorageLocation(
                "TextEditor.%LANGUAGE%.Specific.ShowNewSnippetExperience"
            )
        );
}
