...
internal static class CompletionOptionsStorage
{
    ...
    public static readonly Option2<bool> UnnamedSymbolCompletionDisabledFeatureFlag =
        new(
            "CompletionOptions_UnnamedSymbolCompletionDisabledFeatureFlag",
    ...
    public static readonly Option2<bool> ShowNewSnippetExperienceFeatureFlag =
        new(
            "CompletionOptions_ShowNewSnippetExperienceFeatureFlag",
    ...
    public static readonly PerLanguageOption2<bool> HideAdvancedMembers =
        new("CompletionOptions_HideAdvancedMembers", CompletionOptions.Default.HideAdvancedMembers);
    public static readonly PerLanguageOption2<bool> TriggerOnTyping =
        new("CompletionOptions_TriggerOnTyping", CompletionOptions.Default.TriggerOnTyping);
    ...
    public static readonly PerLanguageOption2<bool?> TriggerOnDeletion =
        new("CompletionOptions_TriggerOnDeletion", CompletionOptions.Default.TriggerOnDeletion);
    public static readonly PerLanguageOption2<EnterKeyRule> EnterKeyBehavior =
        new("CompletionOptions_EnterKeyBehavior", CompletionOptions.Default.EnterKeyBehavior);
    public static readonly PerLanguageOption2<SnippetsRule> SnippetsBehavior =
        new("CompletionOptions_SnippetsBehavior", CompletionOptions.Default.SnippetsBehavior);
    public static readonly PerLanguageOption2<bool> ShowNameSuggestions =
        new("CompletionOptions_ShowNameSuggestions", CompletionOptions.Default.ShowNameSuggestions);
    ...
    public static readonly PerLanguageOption2<bool?> ShowNewSnippetExperienceUserOption =
        new(
            "CompletionOptions_ShowNewSnippetExperienceUserOption",
