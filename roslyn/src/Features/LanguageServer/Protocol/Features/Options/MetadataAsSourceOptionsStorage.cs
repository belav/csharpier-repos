...
internal static class MetadataAsSourceOptionsStorage
{
    ...
    private static readonly OptionGroup s_navigationOptionGroup = new(
        name: "navigation",
        description: ""
    );

    public static Option2<bool> NavigateToDecompiledSources = new(
        "dotnet_navigate_to_decompiled_sources",
        defaultValue: true,
        group: s_navigationOptionGroup
    );
    public static Option2<bool> AlwaysUseDefaultSymbolServers = new(
        "dotnet_always_use_default_symbol_servers",
        defaultValue: true,
        group: s_navigationOptionGroup
    );
    public static Option2<bool> NavigateToSourceLinkAndEmbeddedSources = new(
