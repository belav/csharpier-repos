...
internal static class BlockStructureOptionsStorage
{
    public static BlockStructureOptions GetBlockStructureOptions(
        ...
        GetBlockStructureOptions(
            globalOptions,
            project.Language,
            isMetadataAsSource: project.Solution.Workspace.Kind == WorkspaceKind.MetadataAsSource
        );
    ...
    public static BlockStructureOptions GetBlockStructureOptions(
        ...
        new(
            ...
            ShowBlockStructureGuidesForDeclarationLevelConstructs: globalOptions.GetOption(
                ShowBlockStructureGuidesForDeclarationLevelConstructs,
                language
            ),
            ShowBlockStructureGuidesForCodeLevelConstructs: globalOptions.GetOption(
            ...
            ShowOutliningForCodeLevelConstructs: globalOptions.GetOption(
                ShowOutliningForCodeLevelConstructs,
                language
            ),
            CollapseRegionsWhenFirstOpened: globalOptions.GetOption(
                CollapseRegionsWhenFirstOpened,
                language
            ),
            CollapseImportsWhenFirstOpened: globalOptions.GetOption(
                CollapseImportsWhenFirstOpened,
                language
            ),
            CollapseMetadataImplementationsWhenFirstOpened: globalOptions.GetOption(
                CollapseSourceLinkEmbeddedDecompiledFilesWhenFirstOpened,
                language
            ),
            CollapseEmptyMetadataImplementationsWhenFirstOpened: globalOptions.GetOption(
                CollapseMetadataSignatureFilesWhenFirstOpened,
                language
            ),
            CollapseRegionsWhenCollapsingToDefinitions: globalOptions.GetOption(
    ...
    public static readonly PerLanguageOption2<bool> ShowBlockStructureGuidesForDeclarationLevelConstructs =
        new(
            FeatureName,
            "ShowBlockStructureGuidesForDeclarationLevelConstructs",
            BlockStructureOptions.Default.ShowBlockStructureGuidesForDeclarationLevelConstructs,
            storageLocation: new RoamingProfileStorageLocation(
    ...
    public static readonly PerLanguageOption2<bool> ShowOutliningForCommentsAndPreprocessorRegions =
        new(
            FeatureName,
            "ShowOutliningForCommentsAndPreprocessorRegions",
            BlockStructureOptions.Default.ShowOutliningForCommentsAndPreprocessorRegions,
            storageLocation: new RoamingProfileStorageLocation(
    ...
    public static readonly PerLanguageOption2<bool> CollapseSourceLinkEmbeddedDecompiledFilesWhenFirstOpened =
        new(
            FeatureName,
            "CollapseMetadataImplementationsWhenFirstOpened",
            BlockStructureOptions.Default.CollapseMetadataImplementationsWhenFirstOpened,
            storageLocation: new RoamingProfileStorageLocation(
    ...
    public static readonly PerLanguageOption2<bool> CollapseMetadataSignatureFilesWhenFirstOpened =
        new(
            FeatureName,
            "CollapseEmptyMetadataImplementationsWhenFirstOpened",
    ...
    public static readonly PerLanguageOption2<bool> CollapseRegionsWhenCollapsingToDefinitions =
        new(
            FeatureName,
            "CollapseRegionsWhenCollapsingToDefinitions",
            BlockStructureOptions.Default.CollapseRegionsWhenCollapsingToDefinitions,
            storageLocation: new RoamingProfileStorageLocation(
