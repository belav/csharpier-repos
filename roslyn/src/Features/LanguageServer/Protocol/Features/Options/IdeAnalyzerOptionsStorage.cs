...
internal static class IdeAnalyzerOptionsStorage
{
    ...
    )
    {
        ...
        var supportsLanguageSpecificOptions =
            languageServices.GetService<ISyntaxFormattingOptionsStorage>() != null;
        ...
        return new()
        {
            ...
            FadeOutComplexObjectInitialization = globalOptions.GetOption(
                FadeOutComplexObjectInitialization,
                language
            ),
    ...
    public static readonly PerLanguageOption2<bool> FadeOutUnusedImports =
        new(
            ...
            IdeAnalyzerOptions.CommonDefault.FadeOutUnusedImports,
    ...
    public static readonly PerLanguageOption2<bool> FadeOutUnreachableCode =
        new(
            ...
            IdeAnalyzerOptions.CommonDefault.FadeOutUnreachableCode,
            storageLocation: new RoamingProfileStorageLocation(
                $"TextEditor.%LANGUAGE%.Specific.FadeOutUnreachableCode"
            )
        );

    public static readonly PerLanguageOption2<bool> FadeOutComplexObjectInitialization =
        new(
            "CodeStyleOptions",
            "PreferObjectInitializer_FadeOutCode",
            IdeAnalyzerOptions.CommonDefault.FadeOutComplexObjectInitialization,
            storageLocation: new RoamingProfileStorageLocation(
                "TextEditor.%LANGUAGE%.Specific.PreferObjectInitializer_FadeOutCode"
            )
        );

    internal static readonly PerLanguageOption2<bool> FadeOutComplexCollectionInitialization =
        new(
            "CodeStyleOptions",
            "PreferCollectionInitializer_FadeOutCode",
            IdeAnalyzerOptions.CommonDefault.FadeOutComplexCollectionInitialization,
            storageLocation: new RoamingProfileStorageLocation(
                "TextEditor.%LANGUAGE%.Specific.PreferCollectionInitializer_FadeOutCode"
            )
        );
    ...
    public static PerLanguageOption2<bool> ReportInvalidJsonPatterns =
        new(
            ...
            storageLocation: new RoamingProfileStorageLocation(
                "TextEditor.%LANGUAGE%.Specific.ReportInvalidJsonPatterns"
            )
        );
    ...
    public static PerLanguageOption2<bool> DetectAndOfferEditorFeaturesForProbableJsonStrings =
        new(
            "JsonFeatureOptions",
            "DetectAndOfferEditorFeaturesForProbableJsonStrings",
            defaultValue: IdeAnalyzerOptions
                .CommonDefault
                .DetectAndOfferEditorFeaturesForProbableJsonStrings,
            storageLocation: new RoamingProfileStorageLocation(
                "TextEditor.%LANGUAGE%.Specific.DetectAndOfferEditorFeaturesForProbableJsonStrings"
            )
        );
}
