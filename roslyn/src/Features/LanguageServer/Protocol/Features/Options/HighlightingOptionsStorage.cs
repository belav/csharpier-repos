...
internal static class HighlightingOptionsStorage
{
    ...
    private static readonly OptionGroup s_highlightingGroup = new(
        name: "highlighting",
        description: ""
    );

    public static PerLanguageOption2<bool> HighlightRelatedRegexComponentsUnderCursor = new(
        "dotnet_highlight_related_regex_components",
        defaultValue: true,
        s_highlightingGroup
    );

    public static PerLanguageOption2<bool> HighlightRelatedJsonComponentsUnderCursor = new(
