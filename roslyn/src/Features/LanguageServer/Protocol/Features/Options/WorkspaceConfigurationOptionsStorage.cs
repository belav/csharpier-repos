...
internal static class WorkspaceConfigurationOptionsStorage
{
    public static WorkspaceConfigurationOptions GetWorkspaceConfigurationOptions(
        ...
        new(
            ...
            DisableReferenceManagerRecoverableMetadata: globalOptions.GetOption(
    ...
    public static readonly Option2<StorageDatabase> Database =
        new("Storage_Database", WorkspaceConfigurationOptions.Default.CacheStorage);

    public static readonly Option2<bool> CloudCacheFeatureFlag =
        new(
            "Storage_CloudCacheFeatureFlag",
    ...
    public static readonly Option2<bool> DisableReferenceManagerRecoverableMetadata =
        new(
            ...
            WorkspaceConfigurationOptions.Default.DisableReferenceManagerRecoverableMetadata
        );

    public static readonly Option2<bool> DisableBackgroundCompilation =
        new(
            "WorkspaceConfigurationOptions_DisableBackgroundCompilation",
            WorkspaceConfigurationOptions.Default.DisableBackgroundCompilation
        );

    public static readonly Option2<bool> DisableSharedSyntaxTrees =
        new(
            "WorkspaceConfigurationOptions_DisableSharedSyntaxTrees",
    ...
    public static readonly Option2<bool> EnableOpeningSourceGeneratedFilesInWorkspaceFeatureFlag =
        new(
            "WorkspaceConfigurationOptions_EnableOpeningSourceGeneratedFilesInWorkspaceFeatureFlag",
