...
namespace Microsoft.CodeAnalysis.UnifiedSuggestions
{
    ...
    internal class UnifiedSuggestedActionsSource
    {
        ...
        )
        {
            ...
            await GroupFixesAsync(workspace, fixCollections, map, order, cancellationToken)
                .ConfigureAwait(false);
        ...
        )
        {
            ...
            {
                var unifiedSuggestedAction = await GetUnifiedSuggestedActionAsync(fix.Action, fix)
                    .ConfigureAwait(false);
