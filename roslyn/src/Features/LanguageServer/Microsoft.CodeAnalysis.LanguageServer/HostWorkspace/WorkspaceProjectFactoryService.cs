...
[ExportBrokeredService(
    "Microsoft.VisualStudio.LanguageServices.WorkspaceProjectFactoryService",
    null,
    Audience = ServiceAudience.Local
)]
internal class WorkspaceProjectFactoryService
    : IWorkspaceProjectFactoryService,
        IExportedBrokeredService
{
    ...
    {
        await _projectInitializationHandler.SubscribeToInitializationCompleteAsync(
            cancellationToken
        );
    }

    public async Task<IWorkspaceProject> CreateAndAddProjectAsync(
    ...
    )
    {
        _logger.LogInformation(
            string.Format(
                LanguageServerResources.Project_0_loaded_by_CSharp_Dev_Kit,
        ...
        var project =
            await _workspaceFactory.ProjectSystemProjectFactory.CreateAndAddToWorkspaceAsync(
                ...
                new Workspaces.ProjectSystem.ProjectSystemProjectCreationInfo
                {
        ...
        var workspaceProject = new WorkspaceProject(
            project,
        ...
        await workspaceProject.SetBuildSystemPropertiesAsync(
            creationInfo.BuildSystemProperties,
    ...
    public Task<IReadOnlyCollection<string>> GetSupportedBuildSystemPropertiesAsync(
        CancellationToken _
    )
    {
        // TODO: implement
