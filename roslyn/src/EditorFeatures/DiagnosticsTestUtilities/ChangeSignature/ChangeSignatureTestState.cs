    ...
    internal sealed class ChangeSignatureTestState : IDisposable
    {
        ...
        public ChangeSignatureTestState(TestWorkspace workspace)
        {
            ...
            ChangeSignatureService =
                InvocationDocument.GetLanguageService<AbstractChangeSignatureService>();
        }
        ...
        public TestChangeSignatureOptionsService TestChangeSignatureOptionsService
        {
            get
            {
                return (TestChangeSignatureOptionsService)
                    InvocationDocument.Project.Solution.Workspace.Services.GetRequiredService<IChangeSignatureOptionsService>();
            }
        }

        public async Task<ChangeSignatureResult> ChangeSignatureAsync()
        {
            var context = await ChangeSignatureService
