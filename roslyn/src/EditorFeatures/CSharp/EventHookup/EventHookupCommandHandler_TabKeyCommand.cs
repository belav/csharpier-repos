...
namespace Microsoft.CodeAnalysis.Editor.CSharp.EventHookup
{
    internal partial class EventHookupCommandHandler : IChainedCommandHandler<TabKeyCommandArgs>
    {
        ...
        )
        {
            ...
            {
                eventHandlerMethodName = EventHookupSessionManager.CurrentSession.GetEventNameTask
        ...
        )
        {
            ...
            var documentWithNameAndAnnotationsAdded = AddMethodNameAndAnnotationsToSolution(
                document,
                eventHandlerMethodName,
                position,
            ...
            var semanticDocument = SemanticDocument.CreateAsync(
            ...
            var simplifiedDocument = Simplifier.ReduceAsync(
                documentWithNameAndAnnotationsAdded.WithSyntaxRoot(updatedRoot),
            ...
            plusEqualTokenEndPosition =
                newRoot.GetAnnotatedNodesAndTokens(plusEqualsTokenAnnotation).Single().Span.End;
        ...
        )
        {
            ...
            var updatedEventHookupExpression = eventHookupExpression.ReplaceToken(
                plusEqualsToken,
                plusEqualsToken.WithAdditionalAnnotations(plusEqualsTokenAnnotation)
            )
                .WithRight(
            ...
            var rootWithUpdatedEventHookupExpression = root.ReplaceNode(
                eventHookupExpression,
                updatedEventHookupExpression
            );
        ...
        )
        {
            ...
            var generatedMethodSymbol = GetMethodSymbol(
                document,
                eventHandlerMethodName,
                eventHookupExpression,
                cancellationToken
            ...
            var typeDeclWithMethodAdded = CodeGenerator.AddMethodDeclaration(
                typeDecl,
                generatedMethodSymbol,
                document.Project.Solution.Workspace,
                new CodeGenerationOptions(afterThisLocation: eventHookupExpression.GetLocation())
            );
        ...
        )
        {
            ...
            return CodeGenerationSymbolFactory.CreateMethodSymbol(
                ...
                modifiers: new DeclarationModifiers(
                    isStatic: eventHookupExpression.IsInStaticContext()
                ),
                ...
                statements: ImmutableArray.Create(
                    CodeGenerationHelpers.GenerateThrowStatement(
                        syntaxFactory,
                        semanticDocument,
