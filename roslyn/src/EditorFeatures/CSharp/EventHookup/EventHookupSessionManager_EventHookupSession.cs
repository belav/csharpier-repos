...
namespace Microsoft.CodeAnalysis.Editor.CSharp.EventHookup
{
    internal sealed partial class EventHookupSessionManager
    {
        ...
        internal class EventHookupSession : ForegroundThreadAffinitizedObject
        {
            ...
            private async Task<string> DetermineIfEventHookupAndGetHandlerNameAsync(
                Document document,
                int position,
                ...
                using (
                    ...
                    var namingRule = await document.GetApplicableNamingRuleAsync(
                            ...
                            new DeclarationModifiers(
                                isStatic: plusEqualsToken.Value.Parent.IsInStaticContext()
                            ),
            ...
            private IEventSymbol GetEventSymbol(
                ...
                var symbol =
                    semanticModel.GetSymbolInfo(parentToken.Left, cancellationToken).Symbol;
                if (symbol == null)
                {
                    return null;
                }
            ...
            private string GetEventHandlerName(
                ...
                var reservedNames = semanticModel.LookupSymbols(plusEqualsToken.SpanStart)
                    .Select(m => m.Name);
