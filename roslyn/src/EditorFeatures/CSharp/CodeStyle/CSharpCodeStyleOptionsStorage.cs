...
internal static class CSharpCodeStyleOptionsStorage
{
    ...
    public static CSharpIdeCodeStyleOptions GetCSharpCodeStyleOptions(
        ...
        new()
        {
            ...
            ImplicitObjectCreationWhenTypeIsApparent = globalOptions.GetOption(
                CSharpCodeStyleOptions.ImplicitObjectCreationWhenTypeIsApparent
            ),
            PreferNullCheckOverTypeCheck = globalOptions.GetOption(
                CSharpCodeStyleOptions.PreferNullCheckOverTypeCheck
            ),
            AllowBlankLinesBetweenConsecutiveBraces = globalOptions.GetOption(
                CSharpCodeStyleOptions.AllowBlankLinesBetweenConsecutiveBraces
            ),
            AllowBlankLineAfterColonInConstructorInitializer = globalOptions.GetOption(
                CSharpCodeStyleOptions.AllowBlankLineAfterColonInConstructorInitializer
            ),
            PreferConditionalDelegateCall = globalOptions.GetOption(
                CSharpCodeStyleOptions.PreferConditionalDelegateCall
            ),
            PreferSwitchExpression = globalOptions.GetOption(
                CSharpCodeStyleOptions.PreferSwitchExpression
            ),
            PreferPatternMatching = globalOptions.GetOption(
                CSharpCodeStyleOptions.PreferPatternMatching
            ),
            PreferPatternMatchingOverAsWithNullCheck = globalOptions.GetOption(
                CSharpCodeStyleOptions.PreferPatternMatchingOverAsWithNullCheck
            ),
            PreferPatternMatchingOverIsWithCastCheck = globalOptions.GetOption(
            ...
            PreferExtendedPropertyPattern = globalOptions.GetOption(
                CSharpCodeStyleOptions.PreferExtendedPropertyPattern
            ),
            PreferInlinedVariableDeclaration = globalOptions.GetOption(
                CSharpCodeStyleOptions.PreferInlinedVariableDeclaration
            ),
            PreferDeconstructedVariableDeclaration = globalOptions.GetOption(
                CSharpCodeStyleOptions.PreferDeconstructedVariableDeclaration
            ),
            PreferIndexOperator = globalOptions.GetOption(
                CSharpCodeStyleOptions.PreferIndexOperator
            ),
            PreferRangeOperator = globalOptions.GetOption(
                CSharpCodeStyleOptions.PreferRangeOperator
            ),
            PreferUtf8StringLiterals = globalOptions.GetOption(
                CSharpCodeStyleOptions.PreferUtf8StringLiterals
            ),
            PreferredModifierOrder = globalOptions.GetOption(
                CSharpCodeStyleOptions.PreferredModifierOrder
            ),
            PreferSimpleUsingStatement = globalOptions.GetOption(
                CSharpCodeStyleOptions.PreferSimpleUsingStatement
            ),
            PreferLocalOverAnonymousFunction = globalOptions.GetOption(
            ...
            UnusedValueExpressionStatement = globalOptions.GetOption(
                CSharpCodeStyleOptions.UnusedValueExpressionStatement
            ),
            UnusedValueAssignment = globalOptions.GetOption(
                CSharpCodeStyleOptions.UnusedValueAssignment
            ),
            PreferMethodGroupConversion = globalOptions.GetOption(
                CSharpCodeStyleOptions.PreferMethodGroupConversion
            ),
            PreferExpressionBodiedLambdas = globalOptions.GetOption(
                CSharpCodeStyleOptions.PreferExpressionBodiedLambdas
            ),
            PreferReadOnlyStruct = globalOptions.GetOption(
                CSharpCodeStyleOptions.PreferReadOnlyStruct
            ),
            PreferStaticLocalFunction = globalOptions.GetOption(
