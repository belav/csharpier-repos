...
internal static class CSharpSyntaxFormattingOptionsStorage
{
    ...
    public static CSharpSyntaxFormattingOptions GetCSharpSyntaxFormattingOptions(
        ...
        new()
        {
            ...
            Spacing =
                ...
                | (
                    globalOptions.GetOption(CSharpFormattingOptions2.SpaceAfterMethodCallName)
                ...
                | (
                    globalOptions.GetOption(CSharpFormattingOptions2.SpaceWithinCastParentheses)
                ...
                | (
                    globalOptions.GetOption(CSharpFormattingOptions2.SpaceWithinOtherParentheses)
                        ? SpacePlacement.WithinOtherParentheses
                        : 0
                )
                | (
                    globalOptions.GetOption(CSharpFormattingOptions2.SpaceAfterCast)
                        ? SpacePlacement.AfterCast
                        : 0
                )
                | (
                    globalOptions.GetOption(CSharpFormattingOptions2.SpaceBeforeOpenSquareBracket)
                ...
                | (
                    globalOptions.GetOption(CSharpFormattingOptions2.SpaceWithinSquareBrackets)
                ...
                | (
                    globalOptions.GetOption(CSharpFormattingOptions2.SpaceAfterComma)
                        ? SpacePlacement.AfterComma
                        : 0
                )
                | (
                    globalOptions.GetOption(CSharpFormattingOptions2.SpaceBeforeComma)
                        ? SpacePlacement.BeforeComma
                        : 0
                )
                | (
                    globalOptions.GetOption(CSharpFormattingOptions2.SpaceAfterDot)
                        ? SpacePlacement.AfterDot
                        : 0
                )
                | (
                    globalOptions.GetOption(CSharpFormattingOptions2.SpaceBeforeDot)
                        ? SpacePlacement.BeforeDot
                        : 0
                ),
            SpacingAroundBinaryOperator = globalOptions.GetOption(
                CSharpFormattingOptions2.SpacingAroundBinaryOperator
            ),
            NewLines =
                (
                    globalOptions.GetOption(CSharpFormattingOptions2.NewLineForMembersInObjectInit)
                ...
                | (
                    globalOptions.GetOption(CSharpFormattingOptions2.NewLineForElse)
                        ? NewLinePlacement.BeforeElse
                        : 0
                )
                | (
                    globalOptions.GetOption(CSharpFormattingOptions2.NewLineForCatch)
                        ? NewLinePlacement.BeforeCatch
                        : 0
                )
                | (
                    globalOptions.GetOption(CSharpFormattingOptions2.NewLineForFinally)
                        ? NewLinePlacement.BeforeFinally
                        : 0
                )
                | (
                    globalOptions.GetOption(CSharpFormattingOptions2.NewLinesForBracesInTypes)
                ...
                | (
                    globalOptions.GetOption(CSharpFormattingOptions2.NewLinesForBracesInProperties)
                        ? NewLinePlacement.BeforeOpenBraceInProperties
                        : 0
                )
                | (
                    globalOptions.GetOption(CSharpFormattingOptions2.NewLinesForBracesInMethods)
                        ? NewLinePlacement.BeforeOpenBraceInMethods
                        : 0
                )
                | (
                    globalOptions.GetOption(CSharpFormattingOptions2.NewLinesForBracesInAccessors)
                ...
                | (
                    globalOptions.GetOption(CSharpFormattingOptions2.NewLineForClausesInQuery)
            ...
            Indentation =
                (
                    globalOptions.GetOption(CSharpFormattingOptions2.IndentBraces)
                        ? IndentationPlacement.Braces
                        : 0
                )
                | (
                    globalOptions.GetOption(CSharpFormattingOptions2.IndentBlock)
                        ? IndentationPlacement.BlockContents
                        : 0
                )
                | (
                    globalOptions.GetOption(CSharpFormattingOptions2.IndentSwitchCaseSection)
                ...
                | (
                    globalOptions.GetOption(CSharpFormattingOptions2.IndentSwitchSection)
                        ? IndentationPlacement.SwitchSection
                        : 0
                ),
            WrappingKeepStatementsOnSingleLine = globalOptions.GetOption(
                CSharpFormattingOptions2.WrappingKeepStatementsOnSingleLine
            ),
            WrappingPreserveSingleLine = globalOptions.GetOption(
                CSharpFormattingOptions2.WrappingPreserveSingleLine
            ),
            NamespaceDeclarations = globalOptions.GetOption(
                CSharpCodeStyleOptions.NamespaceDeclarations
            ),
            PreferTopLevelStatements = globalOptions.GetOption(
