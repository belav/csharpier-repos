...
namespace Microsoft.CodeAnalysis.CSharp.CodeCleanup
{
    ...
    internal class CSharpCodeCleanupService(
        ICodeFixService codeFixService,
        IDiagnosticAnalyzerService diagnosticAnalyzerService
    ) : AbstractCodeCleanupService(codeFixService, diagnosticAnalyzerService)
    {
        /// <summary>
        ...
        protected override ImmutableArray<DiagnosticSet> GetDiagnosticSets() => s_diagnosticSets;
    }
}
