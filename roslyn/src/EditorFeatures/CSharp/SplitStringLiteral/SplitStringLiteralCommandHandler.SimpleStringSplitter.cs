...
namespace Microsoft.CodeAnalysis.Editor.CSharp.SplitStringLiteral
{
    internal partial class SplitStringLiteralCommandHandler
    {
        private class SimpleStringSplitter : StringSplitter
        {
            ...
            protected override bool CheckToken() => !_token.IsVerbatimStringLiteral();
            ...
            protected override BinaryExpressionSyntax CreateSplitString()
            {
                ...
                var leftExpression = SyntaxFactory.LiteralExpression(
                    SyntaxKind.StringLiteralExpression,
                    firstToken
                );
                var rightExpression = SyntaxFactory.LiteralExpression(
                    SyntaxKind.StringLiteralExpression,
                    secondToken
                );
