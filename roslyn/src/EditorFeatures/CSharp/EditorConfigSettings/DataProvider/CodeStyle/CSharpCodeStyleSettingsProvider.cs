...
{
    internal class CSharpCodeStyleSettingsProvider
        : SettingsProviderBase<CodeStyleSetting, OptionUpdater, IOption2, object>
    {
        ...
        )
        {
            ...
            var usingSettings = GetUsingsCodeStyleOptions(
                editorConfigOptions,
                visualStudioOptions,
                SettingsUpdater
            );
            ...
            var patternMatchingSettings = GetPatternMatchingCodeStyleOptions(
                editorConfigOptions,
                visualStudioOptions,
                SettingsUpdater
            );
            ...
            var variableSettings = GetVariableCodeStyleOptions(
                editorConfigOptions,
                visualStudioOptions,
                SettingsUpdater
            );
            ...
            var expressionBodySettings = GetExpressionBodyCodeStyleOptions(
                editorConfigOptions,
                visualStudioOptions,
                SettingsUpdater
            );
            ...
            var unusedValueSettings = GetUnusedValueCodeStyleOptions(
                editorConfigOptions,
                visualStudioOptions,
                SettingsUpdater
            );
        ...
        private static IEnumerable<CodeStyleSetting> GetVarCodeStyleOptions(
            AnalyzerConfigOptions editorConfigOptions,
            OptionSet visualStudioOptions,
        ...
        )
        {
            ...
            yield return CodeStyleSetting.Create(
                option: CSharpCodeStyleOptions.VarWhenTypeIsApparent,
            ...
            yield return CodeStyleSetting.Create(
                option: CSharpCodeStyleOptions.VarElsewhere,
        ...
        private static IEnumerable<CodeStyleSetting> GetUsingsCodeStyleOptions(
            AnalyzerConfigOptions editorConfigOptions,
            OptionSet visualStudioOptions,
            OptionUpdater updaterService
        )
        {
            yield return CodeStyleSetting.Create(
                ...
                {
                    CSharpEditorResources.Inside_namespace,
        ...
        )
        {
            ...
            yield return CodeStyleSetting.Create(
                ...
                description: CSharpEditorResources.Prefer_simple_default_expression,
                editorConfigOptions,
                visualStudioOptions,
                updaterService
            );
            yield return CodeStyleSetting.Create(
                ...
                description: CSharpEditorResources.Prefer_local_function_over_anonymous_function,
                editorConfigOptions,
                visualStudioOptions,
                updaterService
            );
            yield return CodeStyleSetting.Create(
                ...
                description: CSharpEditorResources.Prefer_index_operator,
                editorConfigOptions,
                visualStudioOptions,
                updaterService
            );
            yield return CodeStyleSetting.Create(
                ...
                description: CSharpEditorResources.Prefer_range_operator,
                editorConfigOptions,
                visualStudioOptions,
                updaterService
            );
        ...
        private static IEnumerable<CodeStyleSetting> GetPatternMatchingCodeStyleOptions(
            AnalyzerConfigOptions editorConfigOptions,
            OptionSet visualStudioOptions,
            OptionUpdater updaterService
        )
        {
            ...
            yield return CodeStyleSetting.Create(
                ...
                description: CSharpEditorResources.Prefer_pattern_matching_over_is_with_cast_check,
                editorConfigOptions,
                visualStudioOptions,
                updaterService
            );
            yield return CodeStyleSetting.Create(
                ...
                description: CSharpEditorResources.Prefer_pattern_matching_over_as_with_null_check,
                editorConfigOptions,
                visualStudioOptions,
                updaterService
            );
            yield return CodeStyleSetting.Create(
                ...
                description: CSharpEditorResources.Prefer_pattern_matching_over_mixed_type_check,
                editorConfigOptions,
                visualStudioOptions,
                updaterService
            );
        ...
        private static IEnumerable<CodeStyleSetting> GetVariableCodeStyleOptions(
            AnalyzerConfigOptions editorConfigOptions,
            OptionSet visualStudioOptions,
            OptionUpdater updaterService
        )
        {
            ...
            yield return CodeStyleSetting.Create(
                ...
                description: CSharpEditorResources.Prefer_deconstructed_variable_declaration,
                editorConfigOptions,
                visualStudioOptions,
                updaterService
            );
        ...
        private static IEnumerable<CodeStyleSetting> GetExpressionBodyCodeStyleOptions(
            AnalyzerConfigOptions editorConfigOptions,
            OptionSet visualStudioOptions,
            OptionUpdater updaterService
        )
        {
            ...
            {
                CSharpEditorResources.Never,
                CSharpEditorResources.When_possible,
                CSharpEditorResources.When_on_single_line
            };
            yield return CodeStyleSetting.Create(
        ...
        private static IEnumerable<CodeStyleSetting> GetUnusedValueCodeStyleOptions(
            AnalyzerConfigOptions editorConfigOptions,
            OptionSet visualStudioOptions,
            OptionUpdater updaterService
        )
