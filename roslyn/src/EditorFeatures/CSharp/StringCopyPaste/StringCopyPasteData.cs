...
namespace Microsoft.CodeAnalysis.Editor.CSharp.StringCopyPaste
{
    ...
    internal class StringCopyPasteData
    {
        ...
        public static StringCopyPasteData? TryCreate(
            ...
            stringExpression switch
            {
                LiteralExpressionSyntax literal
                    => TryCreateForLiteral(virtualCharService, literal, selectionSpan),
        ...
        )
        {
            ...
            var firstOverlappingChar = virtualChars.FirstOrNull(
                vc => vc.Span.OverlapsWith(selectionSpan)
            );
            var lastOverlappingChar = virtualChars.LastOrNull(
                vc => vc.Span.OverlapsWith(selectionSpan)
            );
