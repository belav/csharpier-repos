...
namespace Microsoft.CodeAnalysis.Editor.CSharp.StringCopyPaste
{
            ...
            IChainedCommandHandler<PasteCommandArgs>
    {
        ...
        )
        {
            ...
            if (
                !_globalOptions.GetOption(
                    FeatureOnOffOptions.AutomaticallyFixStringContentsOnPaste,
            ...
            )
            {
                ...
                var copyPasteService =
                    documentBeforePaste.Project.Solution.Workspace.Services.GetRequiredService<IStringCopyPasteService>();
        ...
        )
        {
            ...
            var indentationOptions = documentBeforePaste
