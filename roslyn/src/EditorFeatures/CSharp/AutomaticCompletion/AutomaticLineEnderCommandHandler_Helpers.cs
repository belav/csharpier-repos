...
namespace Microsoft.CodeAnalysis.Editor.CSharp.AutomaticCompletion
{
    internal partial class AutomaticLineEnderCommandHandler
    {
        ...
        )
        {
            ...
            var newNodeAfterInsertion = newRoot.GetAnnotatedNodes(s_replacementNodeAnnotation)
                .Single();
            ...
            var nextCaretPosition =
                formattedNewRoot.GetAnnotatedTokens(s_openBracePositionAnnotation)
                    .Single().Span.End;
        ...
        )
        {
            ...
            if (statement == null || statement.IsMissing)
            {
                var newRoot = ReplaceNodeAndFormat(
                    ...
                    WithBraces(embeddedStatementOwner, editorOptions),
                    cancellationToken
                );
        ...
        )
        {
            ...
            var nextToken = objectCreationExpressionNode.GetLastToken(includeZeroWidth: true)
        ...
        )
        {
            ...
            if (!hasArgumentList)
            {
                ...
                return objectCreationExpressionNode.WithType(newTypeNode)
        ...
        private static bool WithinBraces(SyntaxNode? node, int caretPosition)
        {
            ...
            return TextSpan.FromBounds(openBrace.SpanStart, closeBrace.Span.End)
        ...
        private static AccessorListSyntax GetAccessorListNode(IEditorOptions editorOptions) =>
            SyntaxFactory.AccessorList()
                ...
                .WithCloseBraceToken(GetCloseBrace(editorOptions));
        ...
        private static SyntaxNode WithBraces(SyntaxNode node, IEditorOptions editorOptions) =>
            ...
            {
                BaseTypeDeclarationSyntax baseTypeDeclarationNode
                  => WithBracesForBaseTypeDeclaration(baseTypeDeclarationNode, editorOptions),
                ObjectCreationExpressionSyntax objectCreationExpressionNode
                ...
                BaseMethodDeclarationSyntax baseMethodDeclarationNode
                  => AddBlockToBaseMethodDeclaration(baseMethodDeclarationNode, editorOptions),
                LocalFunctionStatementSyntax localFunctionStatementNode
                  => AddBlockToLocalFunctionDeclaration(localFunctionStatementNode, editorOptions),
                AccessorDeclarationSyntax accessorDeclarationNode
                  => AddBlockToAccessorDeclaration(accessorDeclarationNode, editorOptions),
                _ when node.IsEmbeddedStatementOwner()
                  => AddBlockToEmbeddedStatementOwner(node, editorOptions),
        ...
        private static ObjectCreationExpressionSyntax GetObjectCreationExpressionWithInitializer(
            ...
            objectCreationExpressionNode.WithInitializer(
                GetInitializerExpressionNode(editorOptions)
            );
        ...
        )
        {
            ...
            // Bar(new Foo() // I am some comments
            // );
            var trivia = objectCreationNodeWithoutInitializer.GetTrailingTrivia()
        ...
        private static AccessorDeclarationSyntax RemoveBodyForAccessorDeclarationNode(
            ...
            accessorDeclarationNode.WithBody(null)
