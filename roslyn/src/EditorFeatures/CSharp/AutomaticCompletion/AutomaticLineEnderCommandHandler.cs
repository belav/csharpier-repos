...
namespace Microsoft.CodeAnalysis.Editor.CSharp.AutomaticCompletion
{
        ...
        : AbstractAutomaticLineEnderCommandHandler
    {
        ...
        protected override Document FormatAndApplyBasedOnEndToken(
            Document document,
            int position,
        ...
        protected override string? GetEndingString(
            Document document,
            int position,
            CancellationToken cancellationToken
        )
        ...
        private static int GetBraceInsertionPosition(SyntaxNode node)
        {
            ...
            return node switch
            {
                ...
                CheckedStatementSyntax checkedStatementNode
                    => checkedStatementNode.Keyword.Span.End,
                FieldDeclarationSyntax fieldDeclarationNode
                    => fieldDeclarationNode.Declaration.Variables[0].Identifier.Span.End,
