...
namespace Microsoft.CodeAnalysis.Editor.QuickInfo
{
    ...
    {
        /// <summary>
        /// return <see cref="ViewHostingControl"/> from the given <paramref name="textBuffer"/>'s <paramref
        // name="contentSpan"/>
        /// </summary>
        ViewHostingControl CreateViewHostingControl(ITextBuffer textBuffer, Span contentSpan);

        /// <summary>
        /// get <see cref="DisposableToolTip"/> /> from the given <paramref name="textBuffer"/>'s <paramref
        // name="contentSpan"/>
        /// based on given <paramref name="baseDocument"/>
        ///
        /// tooltip will show embedded textview which shows code from the content span of the text buffer
        ...
        DisposableToolTip CreateDisposableToolTip(
        ...
        ///
        /// tooltip will show embedded textview with whole content from the buffer. if the buffer has
        // associated tags
