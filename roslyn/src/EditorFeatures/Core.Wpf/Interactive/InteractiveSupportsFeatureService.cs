...
namespace Microsoft.CodeAnalysis.Interactive
{
    internal sealed class InteractiveSupportsFeatureService
    {
        ...
        internal class InteractiveTextBufferSupportsFeatureService
        ...
        [
            ExportWorkspaceService(
                typeof(IDocumentSupportsFeatureService),
                WorkspaceKind.Interactive
            ),
            Shared
        ]
        internal class InteractiveDocumentSupportsFeatureService : IDocumentSupportsFeatureService
        {
            ...
            public bool SupportsRefactorings(Document document) => false;

            public bool SupportsRename(Document document) => false;

            public bool SupportsNavigationToAnyPosition(Document document) => true;

            public bool SupportsSemanticSnippets(Document document) => false;
        }
    }
}
