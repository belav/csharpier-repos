...
namespace Microsoft.CodeAnalysis.Editor.UnitTests.CodeGeneration
{
    ...
    public partial class CodeGenerationTests
    {
        ...
        )
        {
            ...
            context.Result = await context.Service
                .AddNamespaceAsync(
                    context.Solution,
        ...
        )
        {
            ...
            var newSyntax = context.Service
                .AddStatements(oldSyntax, parsedStatements, codeGenerationOptions);
            context.Result = context.Document
                .WithSyntaxRoot(
        ...
        )
        {
            ...
            var newMemberSyntax = context.Service
                .AddParameters(oldMemberSyntax, parameterSymbols, codeGenerationOptions);
            context.Result = context.Document
                .WithSyntaxRoot(
                    (await context.Document.GetSyntaxRootAsync())
        ...
        internal class TestContext : IDisposable
        {
            ...
            )
            {
                ...
                this.Service = Document.Project.LanguageServices
