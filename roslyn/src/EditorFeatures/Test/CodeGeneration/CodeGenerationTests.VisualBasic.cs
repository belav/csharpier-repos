 ...
 End Class";
                await TestAddConstructorAsync(
                    ...
                    thisArguments: ImmutableArray.Create<SyntaxNode>(
                        VB.SyntaxFactory.ParseExpression("42")
                    )
                );
            }
            ...
            [
                ...
                WorkItem(544476, "http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/544476")
            ]
...
End Namespace";
            ...
            [
                Fact,
                Trait(Traits.Feature, Traits.Features.CodeGeneration),
                WorkItem(544477, "http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/544477")
            ]
...
End Namespace";
            ...
            [
                Fact,
                Trait(Traits.Feature, Traits.Features.CodeGeneration),
                WorkItem(544528, "http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/544528")
            ]
...
End Namespace";
 ...
 F2 = 2
    F3
End Enum";
                await TestAddFieldAsync(input, expected, name: "F3");
            }
...
End Enum";
            ...
            [
                Fact,
                Trait(Traits.Feature, Traits.Features.CodeGeneration),
                WorkItem(544529, "http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/544529")
            ]
...
End Class";
    ...
    End Event
End Class";
                static ImmutableArray<IEventSymbol> GetExplicitInterfaceEvent(
                    ...
                    return ImmutableArray.Create<IEventSymbol>(
                        new CodeGenerationEventSymbol(
                            ...
                            nameof(System.ComponentModel.INotifyPropertyChanged.PropertyChanged),
                            null,
                            null,
                            null
                        )
...
Class C
    ...
    End Event
End Class";
                var addStatements = ImmutableArray.Create<SyntaxNode>(
                    VB.SyntaxFactory.ParseExecutableStatement("Console.WriteLine(0)")
                );
                var removeStatements = ImmutableArray.Create<SyntaxNode>(
                    VB.SyntaxFactory.ParseExecutableStatement("Console.WriteLine(1)")
                );
                var raiseStatements = ImmutableArray.Create<SyntaxNode>(
                    VB.SyntaxFactory.ParseExecutableStatement("Console.WriteLine(2)")
                );
                await TestAddEventAsync(
                    input,
                    expected,
...
$$ End Set
 ...
 End Operator
 End Class";
                await TestAddParametersAsync(input, expected, Parameters(Parameter("C", "b")));
            }
...
End Class";
                await TestAddPropertyAsync(input, expected, type: typeof(int));
            }
...
End Class";
            ...
            public async Task AddAttributeToCompilationUnit()
            {
                ...
                await TestAddAttributeAsync(
                    ...
                    expected,
                    typeof(SerializableAttribute),
                    VB.SyntaxFactory.Token(VB.SyntaxKind.AssemblyKeyword)
                );
            }
...
Public Shared Class C
    ...
    End Function
End Class";
                await TestUpdateDeclarationAsync<MethodStatementSyntax>(
                    input,
                    expected,
