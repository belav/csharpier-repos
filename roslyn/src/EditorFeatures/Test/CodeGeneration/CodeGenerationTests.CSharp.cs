...
namespace Microsoft.CodeAnalysis.Editor.UnitTests.CodeGeneration
{
    ...
    namespace N2
    {
                ...
                await TestAddNamespaceAsync(input, expected, name: "N2");
            }
                    ...
                    @"class C
{
    public int F;
                ...
                await TestAddFieldAsync(input, expected, type: GetTypeSymbol(typeof(int)));
            }
                    ...
                    @"class C
{
    public int[] F;
                ...
                await TestAddFieldAsync(input, expected, type: CreateArrayType(typeof(int)));
            }
    ...
    public C(DateTime dt, int i)
    {
            ...
            public async Task AddChainedConstructor()
            {
                ...
                await TestAddConstructorAsync(
                    input,
                    expected,
                    thisArguments: ImmutableArray.Create<SyntaxNode>(
                        CS.SyntaxFactory.ParseExpression("42")
                    )
                );
            }
                    ...
                    @"class C
{
    static C()
    {
            ...
            [
                ...
                WorkItem(544082, "http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/544082")
            ]
                    ...
                    @"namespace N
{
    public class @class
    {
                ...
                await TestAddNamedTypeAsync(input, expected, name: "class");
            }
                    ...
                    @"namespace N
{
    public class classæøå
    {
                ...
                await TestAddNamedTypeAsync(input, expected, name: "classæøå");
            }

            [
                Fact,
                Trait(Traits.Feature, Traits.Features.CodeGeneration),
                WorkItem(544405, "http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/544405")
            ]
                    ...
                    @"namespace N
{
    internal struct S
    {
            ...
            [
                Fact,
                Trait(Traits.Feature, Traits.Features.CodeGeneration),
                WorkItem(546224, "http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/546224")
            ]
                    ...
                    @"namespace N
{
    public interface I
    {
            ...
            [
                Fact,
                Trait(Traits.Feature, Traits.Features.CodeGeneration),
                WorkItem(544080, "http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/544080")
            ]
                    ...
                    @"namespace N
{
    public enum E
    {
                ...
                await TestAddNamedTypeAsync(input, expected, "E", typeKind: TypeKind.Enum);
            }

            [
                Fact,
                Trait(Traits.Feature, Traits.Features.CodeGeneration),
                WorkItem(544527, "http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/544527")
            ]
                    ...
                    @"class C
{
    public delegate int D(string s);
                ...
                await TestAddDelegateTypeAsync(
                    input,
                    expected,
                    ...
                    @"class C
{
    public void M()
    {
                ...
                await TestAddMethodAsync(input, expected, returnType: typeof(void));
            }
...
class C : I
{
    unsafe void I.M(int i)
    {
                ...
                await TestAddMethodAsync(
                    ...
                    modifiers: new Editing.DeclarationModifiers(isUnsafe: true),
                    getExplicitInterfaces: s =>
                        s.LookupSymbols(input.IndexOf('M'), null, "M")
...
class C
{
    ...
    public static bool operator >=(C a, C b)
    {
        $$
            ...
            {
                var input = "class [|C|] { }";
                await TestAddUnsupportedOperatorAsync(
                    input,
    ...
    public static implicit operator int(C other)
    {
        $$
            ...
            public async Task AddParametersToMethod()
            {
                var input = "class C { public void [|M|]() { } }";
                var expected =
                    "class C { public void M(int num, string text =\"Hello!\", float floating =0.5F) { } }";
                await TestAddParametersAsync(
                    input,
                    expected,
                    Parameters(
                        Parameter(typeof(int), "num"),
                        Parameter(typeof(string), "text", true, "Hello!"),
                        Parameter(typeof(float), "floating", true, .5f)
                    )
                );
            }
            ...
            [
                Fact,
                Trait(Traits.Feature, Traits.Features.CodeGeneration),
                WorkItem(544015, "http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/544015")
            ]
...
class C { }";
            ...
            public async Task RemoveAttributeFromTypes()
            {
                ...
                await TestRemoveAttributeAsync<SyntaxNode>(
                    input,
                    expected,
            ...
            public async Task RemoveAttributeFromFields()
            {
                ...
                await TestRemoveAttributeAsync<FieldDeclarationSyntax>(
                    input,
                    expected,
                    typeof(SerializableAttribute)
                );
...
enum C { One, Two }";
            ...
            public async Task AddAttributeToIndexer()
            {
                ...
                var expected =
                    "class C {[System.Serializable] public int this[int y] { get; set; } }";
                await TestAddAttributeAsync(input, expected, typeof(SerializableAttribute));
            }
            ...
            {
                var input =
                    "class C { public static C operator [|+|] (C c1, C c2) { return new C(); }}";
                var expected =
                    "class C {[System.Serializable] public static C operator +(C c1, C c2) { return new C(); } }";
                await TestAddAttributeAsync(input, expected, typeof(SerializableAttribute));
            }
    ...
    public static char F() { return 0; }
            ...
            public async Task SortAroundDestructor()
            {
                var generationSource =
                    "public class [|C|] { public C(){} public int this[int index]{get{return 0;}set{value = 0;}} }";
