...
namespace Microsoft.CodeAnalysis.Editor.UnitTests.CodeGeneration
{
    ...
    public class ExpressionGenerationTests : AbstractCodeGenerationTests
    {
        ...
        {
            Test(f => f.ThisExpression(), cs: "this", csSimple: "this", vb: "Me", vbSimple: "Me");
        }
        ...
        {
            Test(f => f.LiteralExpression(0), cs: "0", csSimple: "0", vb: "0", vbSimple: "0");
        }

        [Fact]
        public void TestInt32LiteralExpression1()
        {
            Test(f => f.LiteralExpression(1), cs: "1", csSimple: "1", vb: "1", vbSimple: "1");
        }

        [Fact]
        public void TestInt64LiteralExpression0()
        {
            Test(f => f.LiteralExpression(0L), cs: "0L", csSimple: "0L", vb: "0L", vbSimple: "0L");
        }

        [Fact]
        public void TestInt64LiteralExpression1()
        {
            Test(f => f.LiteralExpression(1L), cs: "1L", csSimple: "1L", vb: "1L", vbSimple: "1L");
        }
        ...
        {
            Test(
                f => f.AddExpression(f.LiteralExpression(1), f.LiteralExpression(2)),
                cs: "(1) + (2)",
                csSimple: "1 + 2",
                vb: "(1) + (2)",
                vbSimple: "1 + 2"
            ...
            Test(
                f =>
                    f.AddExpression(
                        ...
                        f.AddExpression(f.LiteralExpression(2), f.LiteralExpression(3))
                    ),
                cs: "(1) + ((2) + (3))",
                csSimple: "1 + 2 + 3",
                vb: "(1) + ((2) + (3))",
        ...
        public void TestAddExpression3()
        {
            Test(
                f =>
                    f.AddExpression(
                        f.AddExpression(f.LiteralExpression(1), f.LiteralExpression(2)),
        ...
        {
            Test(
                f => f.MultiplyExpression(f.LiteralExpression(1), f.LiteralExpression(2)),
                cs: "(1) * (2)",
                csSimple: "1 * 2",
                vb: "(1) * (2)",
                vbSimple: "1 * 2"
            ...
            Test(
                f =>
                    f.MultiplyExpression(
                        f.LiteralExpression(1),
                        f.MultiplyExpression(f.LiteralExpression(2), f.LiteralExpression(3))
                    ),
                cs: "(1) * ((2) * (3))",
                csSimple: "1 * 2 * 3",
                vb: "(1) * ((2) * (3))",
        ...
        public void TestMultiplyExpression3()
        {
            Test(
                f =>
                    f.MultiplyExpression(
                        f.MultiplyExpression(f.LiteralExpression(1), f.LiteralExpression(2)),
                        f.LiteralExpression(3)
                    ),
                cs: "((1) * (2)) * (3)",
                csSimple: "1 * 2 * 3",
        ...
        {
            Test(
                f => f.BitwiseAndExpression(f.LiteralExpression(1), f.LiteralExpression(2)),
                cs: "(1) & (2)",
                csSimple: "1 & 2",
                vb: "(1) And (2)",
                vbSimple: "1 And 2"
        ...
        {
            Test(
                f => f.BitwiseOrExpression(f.LiteralExpression(1), f.LiteralExpression(2)),
                cs: "(1) | (2)",
                csSimple: "1 | 2",
                vb: "(1) Or (2)",
                vbSimple: "1 Or 2"
        ...
        {
            Test(
                f => f.LogicalAndExpression(f.LiteralExpression(1), f.LiteralExpression(2)),
                cs: "(1) && (2)",
                csSimple: "1 && 2",
                vb: "(1) AndAlso (2)",
        ...
        {
            Test(
                f => f.LogicalOrExpression(f.LiteralExpression(1), f.LiteralExpression(2)),
                cs: "(1) || (2)",
                csSimple: "1 || 2",
                vb: "(1) OrElse (2)",
                vbSimple: "1 OrElse 2"
        ...
        {
            Test(
                f => f.MemberAccessExpression(f.IdentifierName("E"), f.IdentifierName("M")),
                cs: "E.M",
                csSimple: "E.M",
                vb: "E.M",
                vbSimple: "E.M"
        ...
        public void TestConditionalAccessExpression1()
        {
            Test(
                f =>
                    f.ConditionalAccessExpression(
                        f.IdentifierName("E"),
                        f.MemberBindingExpression(f.IdentifierName("T"))
                    ),
                cs: "E?.T",
                csSimple: "E?.T",
                vb: "E?.T",
        ...
        public void TestConditionalAccessExpression2()
        {
            Test(
                f =>
                    f.ConditionalAccessExpression(
                        f.IdentifierName("E"),
                        f.ElementBindingExpression(f.Argument(f.IdentifierName("T")))
                    ),
                cs: "E?[T]",
                csSimple: "E?[T]",
                vb: "E?(T)",
        ...
        {
            Test(
                f => f.InvocationExpression(f.IdentifierName("E")),
                cs: "E()",
                csSimple: "E()",
                vb: "E()",
                vbSimple: "E()"
        ...
        {
            Test(
                f => f.ElementAccessExpression(f.IdentifierName("E")),
                cs: "E[]",
                csSimple: "E[]",
                vb: "E()",
                vbSimple: "E()"
        ...
        {
            Test(
                f => f.IsTypeExpression(f.IdentifierName("a"), CreateClass("SomeType")),
                cs: "(a) is SomeType",
        ...
        {
            Test(
                f => f.TryCastExpression(f.IdentifierName("a"), CreateClass("SomeType")),
                cs: "(a) as SomeType",
        ...
        {
            Test(
                f => f.LogicalNotExpression(f.IdentifierName("a")),
                cs: "!(a)",
                csSimple: "!a",
                vb: "Not (a)",
                vbSimple: "Not a"
        ...
        {
            Test(
                f => f.CastExpression(CreateClass("SomeType"), f.IdentifierName("a")),
                cs: "(SomeType)(a)",
                csSimple: "(SomeType)a",
        ...
        {
            Test(
                f => f.NegateExpression(f.IdentifierName("a")),
                cs: "-(a)",
                csSimple: "-a",
                vb: "-(a)",
                vbSimple: "-a"
