...
namespace Microsoft.CodeAnalysis.Editor.UnitTests.EmbeddedLanguages.StackFrame
{
    public partial class StackFrameParserTests
    {
                ...
                methodDeclaration: MethodDeclaration(
                    ...
                    argumentList: ParameterList(
                        Parameter(
                            ArrayType(
                                Identifier("string"),
                                ArrayRankSpecifier(trailingTrivia: SpaceTrivia())
                            ),
                            IdentifierToken("s")
                        )
                    )
                    ...
                    argumentList: ParameterList(
                        Parameter(
                            ArrayType(
                                Identifier("string"),
                                ArrayRankSpecifier(
                                    OpenBracketToken.With(
                                        trailingTrivia: SpaceTrivia().ToImmutableArray()
                                    ),
                                    CloseBracketToken.With(
                                        trailingTrivia: SpaceTrivia().ToImmutableArray()
                                    ),
                                    CommaToken.With(
                                        trailingTrivia: SpaceTrivia().ToImmutableArray()
                ...
                methodDeclaration: MethodDeclaration(
                    ...
                    argumentList: ParameterList(
                        Parameter(
                            ArrayType(
                                Identifier("string"),
                                ArrayRankSpecifier(1, trailingTrivia: SpaceTrivia())
                            ),
                            IdentifierToken("s")
                        )
                    )
        ...
        public void TestInvalidSpacingBeforeQualifiedName() =>
            Verify(@"at MyNamespace. MyClass.MyMethod()", expectFailure: true);
        ...
        public void TestFilePaths(string path, int line) =>
            Verify(
                ...
                fileInformation: FileInformation(Path(path), ColonToken, Line(line))
            );
        ...
        public void TestInvalidInputs(string input) => Verify(input, expectFailure: true);
        ...
        public void TestKeywordsAsIdentifiers(string keyword) =>
            Verify(
                @$"MyNamespace.MyType.MyMethod[{keyword}]({keyword} {keyword})",
                methodDeclaration: MethodDeclaration(
                    QualifiedName("MyNamespace.MyType.MyMethod"),
                    typeArguments: TypeArgumentList(
                        TypeArgument(IdentifierToken(keyword.Trim(), trailingTrivia: SpaceTrivia()))
                    ),
                    argumentList: ParameterList(
                        Parameter(
        ...
        public void TestGeneratedMain() =>
            Verify(
                ...
                methodDeclaration: MethodDeclaration(
                    QualifiedName(Identifier("Program"), GeneratedName("Main")),
                    argumentList: ParameterList(
                        Parameter(
                            ArrayType(
                                Identifier("String"),
        ...
        public void TestLocalMethod() =>
            Verify(
                ...
                methodDeclaration: MethodDeclaration(
                    QualifiedName(
                        Identifier("C"),
                        LocalMethod(GeneratedName("M", endWithDollar: false), "Local", "0_0")
                    )
                )
            );
        ...
        public void TestLanguages(string at, string @in, string line) =>
            Verify(
                @$"{at} Program.Main() {@in} C:\repos\languages\Program.cs:{line} 16",
                methodDeclaration: MethodDeclaration(
                    QualifiedName(
                        "Program.Main",
                ...
                fileInformation: FileInformation(
                    ...
                    line: CreateToken(
                        ...
                        leadingTrivia: ImmutableArray.Create(
                            CreateTrivia(StackFrameKind.LineTrivia, $"{line} ")
                        )
                    ),
