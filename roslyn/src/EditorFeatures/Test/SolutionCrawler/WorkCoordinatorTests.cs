                ...
                @"class C
{
    public void Test()
    {
        ...
        {
            var documentTrackingService = (TestDocumentTrackingService)document
                .Project
                .Solution
                .Workspace
                .Services
        ...
        private class AnalyzerProviderNoWaitNoBlock : AnalyzerProvider
        {
            ...
            public AnalyzerProviderNoWaitNoBlock() : base(new Analyzer()) { }
        }
        ...
        private class AnalyzerProviderWaitNoBlock : AnalyzerProvider
        {
            [ImportingConstructor]
            [Obsolete(MefConstruction.ImportingConstructorMessage, error: true)]
            public AnalyzerProviderWaitNoBlock() : base(new Analyzer(waitForCancellation: true)) { }
        }
        ...
        private class AnalyzerProviderNoWaitBlock : AnalyzerProvider
        {
            [ImportingConstructor]
            [Obsolete(MefConstruction.ImportingConstructorMessage, error: true)]
            public AnalyzerProviderNoWaitBlock() : base(new Analyzer(blockedRun: true)) { }
        }
        ...
        {
            public static readonly Option<bool> TestOption = new Option<bool>(
                "TestOptions",
                "TestOption",
                defaultValue: true
            );
