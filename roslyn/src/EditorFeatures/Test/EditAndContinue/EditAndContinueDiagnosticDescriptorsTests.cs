        ...
        public void GetDescriptor()
        {
            ...
            Assert.Equal(
                new LocalizableResourceString(
                    nameof(FeaturesResources.RudeEdit),
            ...
            Assert.Equal(
                new LocalizableResourceString(
                    nameof(
                        FeaturesResources.Updating_an_active_statement_will_prevent_the_debug_session_from_continuing
                    ),
                    FeaturesResources.ResourceManager,
                    typeof(FeaturesResources)
                ),
            ...
            d = EditAndContinueDiagnosticDescriptors.GetModuleDiagnosticDescriptor(
                ManagedEditAndContinueAvailabilityStatus.Optimized
            );
            ...
            Assert.Equal(
                new LocalizableResourceString(
                    nameof(FeaturesResources.EditAndContinueDisallowedByProject),
                    FeaturesResources.ResourceManager,
                    typeof(FeaturesResources)
                ),
                d.MessageFormat
