...
namespace Microsoft.CodeAnalysis.EditAndContinue.UnitTests
{
    ...
    public class ActiveStatementsMapTests
    {
        ...
        public void GetSpansStartingInSpan_MultipleSameStart1(
            int sl,
            int sc,
            int el,
            int ec,
        ...
        public void GetSpansStartingInSpan_MultipleSameStart2(
            int sl,
            int sc,
            int el,
            int ec,
...
class C
{
    ...
    static void G(Func<int, int> a)
    {
        a(1);
            ...
            AssertEx.Equal(
                new[] { "(7,16)-(15,9)", "(9,17)-(9,18)", "(20,8)-(20,13)" },
                ...
                @"class C
{
    static void M()
    {
        ...
        <ER:0.0>catch
        {
            ...
            var mapping1 = new NonRemappableRegion(
                oldSpan: exceptionRegions.Spans[0],
                newSpan: exceptionRegions.Spans[0].AddLineDelta(+3),
                isExceptionRegion: true
            );
            var mapping2 = new NonRemappableRegion(
                oldSpan: unmappedActiveStatements[0].Statement.FileSpan,
                newSpan: unmappedActiveStatements[0].Statement.FileSpan,
            ...
            var activeStatement = map.DocumentPathMap[
                ...
                @"class C
{
    static void M()
    {
        <AS:0>var x = y switch { 1 => 0, _ => <AS:1>1</AS:1> };</AS:0>
            ...
            var mapping1 = new NonRemappableRegion(
                oldSpan: unmappedActiveStatements[0].Statement.FileSpan,
                newSpan: unmappedActiveStatements[0].Statement.FileSpan.AddLineDelta(+1),
                isExceptionRegion: false
            );
            var mapping2 = new NonRemappableRegion(
                oldSpan: unmappedActiveStatements[1].Statement.FileSpan,
                newSpan: unmappedActiveStatements[1].Statement.FileSpan.AddLineDelta(+1),
                isExceptionRegion: false
            );
            ...
            var newActiveStatements = map.DocumentPathMap[
                unmappedActiveStatements[0].Statement.FilePath
            ];
            ...
            Assert.Equal(
                unmappedActiveStatements[1].Statement.Span.AddLineDelta(+1),
                newActiveStatements[1].FileSpan.Span
            );
        }
    }
}
