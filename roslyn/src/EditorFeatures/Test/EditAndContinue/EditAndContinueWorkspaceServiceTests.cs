...
namespace Microsoft.CodeAnalysis.EditAndContinue.UnitTests
{
    ...
    public sealed partial class EditAndContinueWorkspaceServiceTests : TestBase
    {
        ...
        {
            var service = (EditAndContinueWorkspaceService)workspace
                .Services
  ...
  void M()
  {
    ...
    System.Console.WriteLine(30);
            ...
            AssertEx.Equal(
                new[]
                {
                    $"{document2.Project.Id} Error ENC2016: {string.Format(FeaturesResources.EditAndContinueDisallowedByProject, document2.Project.Name, "*message*")}"
                },
                InspectDiagnostics(emitDiagnostics)
            );
...
";
        ...
        public async Task SemanticError()
        {
            ...
            AssertEx.Equal(
                new[]
                {
                    $"{document2.Project.Id} Error CS0266: {string.Format(CSharpResources.ERR_NoImplicitConvCast, "long", "int")}"
                },
                InspectDiagnostics(emitDiagnostics)
            );
        ...
        public async Task FileStatus_CompilationError()
        {
            ...
            solution =
                solution
                    ...
                    .Project
                    .AddDocument("B.cs", "class B {}", filePath: "B.cs")
                    .Project
                    .Solution
                    .AddProject("C", "C", "C#")
                    .AddDocument("Common.cs", "class Common {}", filePath: "Common.cs")
                    .Project
                    .AddDocument("C.cs", "class C {}", filePath: "C.cs")
                    .Project
                    .Solution;
...
";
        ...
        public async Task ValidSignificantChange_EmitError()
        {
            ...
            AssertEx.Equal(
                new[]
                {
                    $"{document2.Project.Id} Error CS8055: {string.Format(CSharpResources.ERR_EncodinglessSyntaxTree)}"
                },
                InspectDiagnostics(emitDiagnostics)
            );
        ...
        public async Task ValidSignificantChange_ApplyBeforeFileWatcherEvent(bool saveDocument)
        {
            ...
            var hasChanges = await debuggingSession
                .EditSession
                .HasChangesAsync(
                    solution,
                    s_noActiveSpans,
        ...
        public async Task ValidSignificantChange_EmitSuccessful(bool breakMode, bool commitUpdate)
        {
            ...
            if (commitUpdate)
            {
                ...
                var commitedUpdateSolutionStatus = await debuggingSession
                    .EditSession
                    .HasChangesAsync(
                        solution,
                        s_noActiveSpans,
            ...
            else
            {
                ...
                // solution update status after committing an update:
                var discardedUpdateSolutionStatus = await debuggingSession
                    .EditSession
                    .HasChangesAsync(
                        solution,
                        s_noActiveSpans,
                ...
                @"class Test
{
    ...
    static void F()
    {
        ...
        <AS:1>G();</AS:1>
            ...
            AssertEx.Equal(
                new[] { $"0x06000002 v1 | AS {document.FilePath}: (4,41)-(4,42) δ=0", },
                InspectNonRemappableRegions(debuggingSession.EditSession.NonRemappableRegions)
            );
