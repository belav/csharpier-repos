        ...
        internal sealed class TypeScriptCodeRefactoringProvider : CodeRefactoringProvider
        {
            ...
            public override Task ComputeRefactoringsAsync(CodeRefactoringContext context)
            {
                context.RegisterRefactoring(
                    CodeAction.Create($"Blocking=false", _ => Task.FromResult<Document>(null))
                );
...
<Workspace>
    <Project Language=""TypeScript"">
        ...
        private class StubAnalyzerReference : AnalyzerReference, ICodeRefactoringProviderFactory
        {
            ...
            public ImmutableArray<CodeRefactoringProvider> GetRefactorings() => _refactorings;
        }
        ...
        public async Task TestAdditionalDocumentRefactoringAsync()
        {
            ...
            var txtAdditionalDocument = project
                .AdditionalDocuments
            ...
            var txtRefactoringTitles = txtRefactorings
                .Select(s => s.CodeActions.Single().action.Title)
                .ToImmutableArray();
            ...
            var logAdditionalDocument = project
                .AdditionalDocuments
        ...
        public async Task TestAnalyzerConfigDocumentRefactoringAsync()
        {
            ...
            var editorConfigRefactoringTitles = editorConfigRefactorings
                .Select(s => s.CodeActions.Single().action.Title)
                .ToImmutableArray();
            ...
            Assert.Equal(
                refactoring1.Title,
                changedEditorConfig.GetTextSynchronously(CancellationToken.None).ToString()
            );

            // Verify available refactorings for .globalconfig document
            var globalConfig = project
                .AnalyzerConfigDocuments
        ...
        internal abstract class AbstractNonSourceFileRefactoring : CodeRefactoringProvider
        {
            ...
            protected AbstractNonSourceFileRefactoring(string title) => Title = title;
...
#pragma warning disable RS0034 // Exported parts should be marked with 'ImportingConstructorAttribute'
        ...
        [Shared]
        internal sealed class NonSourceFileRefactoringWithDocumentKindsAndExtensions
            : AbstractNonSourceFileRefactoring
        {
            public NonSourceFileRefactoringWithDocumentKindsAndExtensions()
                : base(nameof(NonSourceFileRefactoringWithDocumentKindsAndExtensions)) { }
        }
        ...
        [Shared]
        internal sealed class NonSourceFileRefactoringWithDocumentKinds
            : AbstractNonSourceFileRefactoring
        {
            public NonSourceFileRefactoringWithDocumentKinds()
                : base(nameof(NonSourceFileRefactoringWithDocumentKinds)) { }
        }
        ...
        [Shared]
        internal sealed class NonSourceFileRefactoringWithDocumentExtensions
            : AbstractNonSourceFileRefactoring
        {
            public NonSourceFileRefactoringWithDocumentExtensions()
                : base(nameof(NonSourceFileRefactoringWithDocumentExtensions)) { }
        }

        [ExportCodeRefactoringProvider(LanguageNames.CSharp)]
        [Shared]
        internal sealed class NonSourceFileRefactoringWithoutDocumentKindsAndExtensions
            : AbstractNonSourceFileRefactoring
        {
            public NonSourceFileRefactoringWithoutDocumentKindsAndExtensions()
                : base(nameof(NonSourceFileRefactoringWithoutDocumentKindsAndExtensions)) { }
        }
