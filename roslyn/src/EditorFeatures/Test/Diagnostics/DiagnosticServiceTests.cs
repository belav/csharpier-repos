...
namespace Microsoft.CodeAnalysis.Editor.UnitTests.Diagnostics
{
    ...
    public class DiagnosticServiceTests
    {
        private static DiagnosticService GetDiagnosticService(TestWorkspace workspace)
        {
            ...
            // for impact.
            Assert.Empty(
                diagnosticService.GetTestAccessor()
                    .EventListenerTracker.GetTestAccessor().EventListeners
            );
        ...
        public async Task TestGetDiagnostics1()
        {
            ...
            var data1 = await diagnosticService.GetPushDiagnosticsAsync(
                workspace,
                null,
                null,
                null,
            ...
            var data2 = await diagnosticService.GetPushDiagnosticsAsync(
                workspace,
                document.Project.Id,
                null,
                null,
            ...
            var data3 = await diagnosticService.GetPushDiagnosticsAsync(
                workspace,
                document.Project.Id,
                document.Id,
                null,
            ...
            var data4 = await diagnosticService.GetPushDiagnosticsAsync(
                workspace,
                document.Project.Id,
                document.Id,
                id,
        ...
        public async Task TestGetDiagnostics2()
        {
            ...
            var data5 = await diagnosticService.GetPushDiagnosticsAsync(
                workspace,
                document.Project.Id,
                document.Id,
                id,
