...
";
        ...
        )
        {
            ...
            var data = new DiagnosticData(
                ...
                location: new DiagnosticDataLocation(
                    new("originalFile1", new(startLine, startColumn), new(endLine, endColumn)),
                    document.Id
                ),
        ...
        public async Task DiagnosticData_ExternalAdditionalLocationIsPreserved()
        {
            ...
            var externalAdditionalLocation = new DiagnosticDataLocation(
                new(additionalDocument.Name, new(0, 0), new(0, 1)),
            ...
            var diagnosticData = new DiagnosticData(
                ...
                properties: ImmutableDictionary<string, string>.Empty,
                location: new DiagnosticDataLocation(
                    new FileLinePositionSpan(document.FilePath, span: default),
                    document.Id
                ),
            ...
            Assert.Equal(
                externalAdditionalLocation.UnmappedFileSpan,
...
";
            ...
            var document = await project.GetSourceGeneratedDocumentAsync(
                documentId,
                CancellationToken.None
            );
            ...
            var location = new DiagnosticDataLocation(
                new(document.FilePath, new(3, 10), new(3, 11)),
                documentId
            );
        ...
        [WorkItem(
            1676229,
            "https://devdiv.visualstudio.com/DefaultCollection/DevDiv/_workitems/edit/1676229"
        )]
        public async Task DiagnosticData_SourceFileAdditionalLocationIsPreserved(
            bool testDifferentProject,
            bool testRemovedDocument
        )
        {
            using var workspace = new TestWorkspace(
                composition: EditorTestCompositions.EditorFeatures
            ...
            {
                secondDocument = firstDocument.Project.Solution
            ...
            var additionalLocation = new DiagnosticDataLocation(
                new(secondDocument.Name, new(0, 0), new(0, 1)),
                secondDocument.Id
            );
            ...
            var diagnosticData = new DiagnosticData(
                ...
                properties: ImmutableDictionary<string, string>.Empty,
                location: new DiagnosticDataLocation(
                    new FileLinePositionSpan(firstDocument.FilePath, span: default),
                    firstDocument.Id
                ),
            ...
            var expectedAdditionalDocumentId = !testRemovedDocument
                ? additionalLocation.DocumentId
                : null;
            Assert.Equal(expectedAdditionalDocumentId, roundTripAdditionalLocation.DocumentId);
            Assert.Equal(
                additionalLocation.UnmappedFileSpan,
                roundTripAdditionalLocation.UnmappedFileSpan
            );
        }
    }
