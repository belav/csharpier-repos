        ...
        )
        {
            ...
            for (var i = 0; i < analyzers.Length; i++)
            {
                ...
                foreach (var additionalDoc in project.AdditionalDocuments)
                {
                    ...
                    if (
                        analysisScope
                        is BackgroundAnalysisScope.ActiveFile
    ...
    void M()
    {
        ...
        internal async Task TestGeneratorProducedDiagnostics(bool fullSolutionAnalysis)
        {
            using var workspace = TestWorkspace.CreateCSharp(
                ...
                composition: s_featuresCompositionWithMockDiagnosticUpdateSourceRegistrationService
            );
            var globalOptions = workspace.GetService<IGlobalOptionService>();
        ...
        internal sealed class CancellationTestAnalyzer : DiagnosticAnalyzer
        {
            ...
            private readonly DiagnosticDescriptor s_canceledDescriptor = new DiagnosticDescriptor(
                CanceledDiagnosticId,
                "test",
                "test",
                "test",
                DiagnosticSeverity.Warning,
            ...
            public override ImmutableArray<DiagnosticDescriptor> SupportedDiagnostics =>
                ImmutableArray.Create(s_canceledDescriptor, s_nonCanceledDescriptor);
