...
namespace Microsoft.CodeAnalysis.Editor.UnitTests.Workspaces
{
    ...
    {
        private readonly byte[] _nonUTF8StringBytes = new byte[]
        {
            0x80,
            0x92,
            0xA4,
        ...
        [
            Fact,
            WorkItem(1038018, "http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/1038018"),
            WorkItem(1041792, "http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/1041792")
        ]
        ...
        private static EditorTextFactoryService CreateMockTextFactoryService()
        {
            ...
            mockContentTypeRegistryService.Setup(r => r.UnknownContentType)
                .Returns(mockUnknownContentType.Object);

            return new EditorTextFactoryService(
                new FakeTextBufferCloneService(),
                mockTextBufferFactoryService.Object,
                mockContentTypeRegistryService.Object
            );
        }
