...
",
            ...
            Assert.NotEmpty(immediateDerived);
            AssertEx.SetEqual(
                immediateDerived.Select(d => d.Name),
                new[] { "IB1", "IB2", "IB3", "IC2" }
            );
...
",
            ...
            AssertEx.SetEqual(
                immediateImpls.Select(d => d.Name),
                new[] { "B1", "B2", "B3", "C2", "S1" }
            );
...
<Workspace>
    ...
    <Project Name=""CSProject"" Language=""C#"">
        ...
        [
            Theory,
            CombinatorialData,
            WorkItem(1555496, "https://devdiv.visualstudio.com/DevDiv/_workitems/edit/1555496")
        ]
...
",
        ...
        [
            Theory,
            CombinatorialData,
            WorkItem(1598801, "https://devdiv.visualstudio.com/DevDiv/_queries/edit/1598801")
        ]
