...
namespace Microsoft.CodeAnalysis.Editor.CSharp.UnitTests.Recommendations
{
    ...
    public abstract class RecommenderTests : TestBase
    {
        ...
        internal Func<
            int,
            CSharpSyntaxContext,
            Task<ImmutableArray<RecommendedKeyword>>
        > RecommendKeywordsAsync;

        internal async Task VerifyWorkerAsync(
            string markup,
            bool absent,
        ...
        )
        {
            ...
            await VerifyAtPosition_KeywordPartiallyWrittenAsync(
                code,
                position,
                absent,
                options: options,
            ...
            await VerifyInFrontOfComment_KeywordPartiallyWrittenAsync(
                code,
                position,
                absent,
                options: options,
            ...
            await VerifyAtEndOfFile_KeywordPartiallyWrittenAsync(
                code,
                position,
                absent,
                options: options,
            ...
            if (absent)
            {
                if (RecommendKeywordsAsync != null)
                {
                    ...
                    Assert.True(
                        ...
                        "Keywords must be null or empty."
                    );
                }
            }
            else
        ...
        private Task VerifyInFrontOfComment_KeywordPartiallyWrittenAsync(
            string text,
            int position,
            bool absent,
            CSharpParseOptions options,
        ...
        private Task VerifyAtPosition_KeywordPartiallyWrittenAsync(
            string text,
            int position,
            bool absent,
            CSharpParseOptions options,
        ...
        private Task VerifyAtEndOfFileAsync(
            string text,
            int position,
            bool absent,
            CSharpParseOptions options,
        ...
        private Task VerifyAtEndOfFile_KeywordPartiallyWrittenAsync(
            string text,
            int position,
            bool absent,
            CSharpParseOptions options,
