...
namespace Microsoft.CodeAnalysis.CSharp.UnitTests.EmbeddedLanguages.RegularExpressions
{
    ...
    public partial class CSharpRegexParserTests
    {
        ...
        {
            using var stream = typeof(CSharpRegexParserTests).Assembly.GetManifestResourceStream(
                "Microsoft.CodeAnalysis.Editor.CSharp.UnitTests.EmbeddedLanguages.RegularExpressions.Regex_RealWorldPatterns.json"
            );
