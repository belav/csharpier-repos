    ...
    public override System.Int32 GetHashCode()
    {
        return 165851236 + EqualityComparer<System.Int32>.Default.GetHashCode(i);
                    ...
                    ExpectedDiagnostics =
                    {
                        ...
                        DiagnosticResult.CompilerError("CS1069")
                            .WithSpan(5, 28, 5, 35)
                            .WithArguments(
                                "Boolean",
                                "System",
                        ...
                        DiagnosticResult.CompilerError("CS0115")
                            .WithSpan(16, 34, 16, 45)
                            .WithArguments("Class1.GetHashCode()"),
            ...
            var test = new VerifyCS.Test
            {
                ...
                FixedState =
                {
                    ...
                    ExpectedDiagnostics =
                    {
                        ...
                        DiagnosticResult.CompilerError("CS0117")
            ...
            var test = new TestWithDialog
            {
                ...
                FixedState =
                {
                    ...
                    ExpectedDiagnostics =
                    {
                        ...
                        DiagnosticResult.CompilerError("CS8604")
                            .WithSpan(20, 55, 20, 59)
