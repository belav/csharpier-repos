...
class MyClass$$
{
    public void Goo(int x, string y)
    {
            ...
            TestReorderParameters(
                ...
                expectedErrorText: FeaturesResources.You_can_only_change_the_signature_of_a_constructor_indexer_method_or_delegate
            );
        }
    ...
    public void Goo(int x, string y)
    {
        ...
        public void ReorderMethodParameters_InsufficientParameters_None()
        {
            ...
            TestReorderParameters(
                ...
                markup,
                expectedSuccess: false,
                expectedErrorText: FeaturesResources.InsufficientParametersToReorder
            );
        }
