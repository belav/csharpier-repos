...
" + markup;
        ...
        )
        {
            ...
            await TestWithProjectReferenceHelperAsync(
                sourceCode,
                referencedCode,
                sourceLanguage,
                referencedLanguage,
            ...
            {
                await TestInSameProjectHelperAsync(
                    sourceCode,
                    referencedCode,
                    sourceLanguage,
                    expectedResults
...
{2}
        ...
        {
            await TestAsync(@"using $$System;", MainDescription("namespace System"));
        }
        ...
        {
            await TestAsync(@"using System.L$$inq;", MainDescription("namespace System.Linq"));
        }

        [Fact]
        public async Task TestNamespaceInUsingDirectiveWithAlias()
        {
            await TestAsync(@"using Goo = Sys$$tem.Console;", MainDescription("namespace System"));
        }
...
class C { void M() { $$C obj; } }";
            ...
            await TestAsync(markup, MainDescription("class C"), Documentation("Hello!"));
        }
...
class C
{
    void M()
    {
        $$C obj;
            ...
            await TestAsync(
                "///<summary>Hello!\r///</summary>\rclass C { void M() { $$C obj; } }",
                MainDescription("class C"),
                Documentation("Hello!")
            );
        }
...
class C
{
    void M()
    {
        $$C obj;
            ...
            await TestAsync(
                "/**\r* <summary>\r* Hello!\r* </summary>\r*/\rclass C { void M() { $$C obj; } }",
                MainDescription("class C"),
                Documentation("Hello!")
            );
        }
...
void M() { M$$() }";
            ...
            await TestInClassAsync(markup, MainDescription("void C.M()"), Documentation("Hello!"));
        }

        [Fact]
        public async Task TestInt32()
        {
            await TestInClassAsync(@"$$Int32 i;", MainDescription("struct System.Int32"));
        }

        [Fact]
        public async Task TestBuiltInInt()
        {
            await TestInClassAsync(@"$$int i;", MainDescription("struct System.Int32"));
        }

        [Fact]
        public async Task TestString()
        {
            await TestInClassAsync(@"$$String s;", MainDescription("class System.String"));
        }
        ...
        {
            await TestInClassAsync(@"$$Boolean b;", MainDescription("struct System.Boolean"));
        }

        [Fact]
        public async Task TestBuiltInBool()
        {
            await TestInClassAsync(@"$$bool b;", MainDescription("struct System.Boolean"));
        }

        [Fact]
        public async Task TestSingle()
        {
            await TestInClassAsync(@"$$Single s;", MainDescription("struct System.Single"));
        }

        [Fact]
        public async Task TestBuiltInFloat()
        {
            await TestInClassAsync(@"$$float f;", MainDescription("struct System.Single"));
        }
                ...
                @"interface I<T> where $$T : class
{
        ...
        {
            await TestAsync(
                @"class C<T> where $$T : System.Collections.Generic.IEnumerable<int>",
                MainDescription(
                    $"T {FeaturesResources.in_} C<T> where T : System.Collections.Generic.IEnumerable<int>"
                )
            );
        }
                ...
                @"class C
{
    ...
    static C operator+(C a, C b) { return a; }
            ...
            await TestAsync(markup, MainDescription("C C.operator +(C a, C b)"));
        }
                ...
                @"class C
{
    ...
    static C operator checked +(C a, C b) { return a; }
            ...
            await TestAsync(markup, MainDescription("C C.operator checked +(C a, C b)"));
        }
                ...
                @"class C
{
    ...
    static C operator-(C a) { return a; }
            ...
            await TestAsync(markup, MainDescription("C C.operator -(C a)"));
        }
                ...
                @"class C
{
    ...
    static C operator checked -(C a) { return a; }
            ...
            await TestAsync(markup, MainDescription("C C.operator checked -(C a)"));
        }
...
static class Test { static void Method() { MyClass.My$$Method(); } }";
        ...
        public async Task TestMetadataFieldMinimal()
        {
            await TestInMethodAsync(
                ...
                MainDescription(
                    $"({FeaturesResources.field}) static readonly DateTime DateTime.MaxValue"
                )
            );
        }
    ...
    void M()
    {
        DateTime dt = System.DateTime.MaxValue$$
            ...
            await TestAsync(
                markup,
                MainDescription(
                    $"({FeaturesResources.field}) static readonly System.DateTime System.DateTime.MaxValue"
                )
            );
        }
                ...
                @"class C<T>
{
    ...
    void M()
    {
        ...
        {
            await TestInMethodAsync(@"int f = 37$$", MainDescription("struct System.Int32"));
        }

        [Fact]
        public async Task TestTrueKeyword()
        {
            await TestInMethodAsync(@"bool f = true$$", MainDescription("struct System.Boolean"));
        }

        [Fact]
        public async Task TestFalseKeyword()
        {
            await TestInMethodAsync(@"bool f = false$$", MainDescription("struct System.Boolean"));
        }

        [Fact, WorkItem("https://github.com/dotnet/roslyn/issues/26027")]
        public async Task TestNullLiteral()
        {
            await TestInMethodAsync(@"string f = null$$", MainDescription("class System.String"));
        }

        [Fact]
        public async Task TestNullLiteralWithVar() => await TestInMethodAsync(@"var f = null$$");
    ...
    public async Task<int> Calc()
    {
        ...
        return 5;
            ...
            await TestAsync(
                markup,
                MainDescription(
                    string.Format(FeaturesResources.Awaited_task_returns_0, "struct System.Int32")
                )
            );
        }
...
class C
{
    public async void Calc()
    {
        ...
        [
            Fact,
            WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/756226"),
            WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/756337")
        ]
    ...
    public void Calc()
    {
        Task$$ v1;
            ...
            await TestAsync(
                markup,
                MainDescription(
                    $"({CSharpFeaturesResources.awaitable}) class System.Threading.Tasks.Task"
                )
            );
        }
...
";
    ...
    """"""U8$$",
        ...
        {
            await TestInMethodAsync(@"string f = 'x'$$", MainDescription("struct System.Char"));
        }
...
f.Att$$ributes.ToString();",
                MainDescription(
                    "System.IO.FileAttributes System.IO.FileSystemInfo.Attributes { get; set; }"
                )
            );
        }
                ...
                @"public DateTime Property
{
    set
    {
        ...
        {
            await TestInClassAsync(@"enum E$$ : byte { A, B }", MainDescription("enum C.E : byte"));
        }
...
{{
    A, B
        ...
        {
            await TestInMethodAsync(
                @"ConsoleColor c = ConsoleColor.Bla$$ck",
        ...
        {
            await TestInMethodAsync(
                @"AttributeTargets a = AttributeTargets.Cl$$ass",
        ...
        {
            await TestInMethodAsync(
                @"AttributeTargets a = AttributeTargets.A$$ll",
                MainDescription(
                ...
                @"void M(int param = 42)
{
    ...
    return param + 1;
                ...
                MainDescription(
                    $"({FeaturesResources.constant}) const int int.MaxValue = 2147483647"
                )
            );
        }
...
void Method(System.IO.FileInfo fileInfo)
{
                ...
                MainDescription(
                    $"void C.Method(System.IO.FileInfo fileInfo) (+ 3 {FeaturesResources.overloads_})"
                )
            );
        }
                ...
                @"void Goo(ref DateTime dt, out System.IO.FileInfo fi, params int[] numbers)
{
    Go$$o(DateTime.Now, null, 32);
                ...
                MainDescription(
                    "void C.Goo(ref DateTime dt, out System.IO.FileInfo fi, params int[] numbers)"
                )
            );
        }
    ...
    new C$$(DateTime.MaxValue).ToString();
        ...
        public async Task Constructor_OverloadFromStringLiteral()
        {
            await TestInMethodAsync(
                ...
                MainDescription(
                    $"InvalidOperationException.InvalidOperationException(string message) (+ 2 {FeaturesResources.overloads_})"
                )
            );
        }
    ...
    new G$$oo();
        ...
        public async Task Constructor_Metadata()
        {
            await TestInMethodAsync(
                ...
                MainDescription(
                    $"ArgumentNullException.ArgumentNullException() (+ 3 {FeaturesResources.overloads_})"
                )
            );
        }
                ...
                @"class Outer<T>
{
    ...
    static void M()
    {
        Outer<int>.I$$nner<string> e;
                ...
                TypeParameterMap(
                    Lines($"\r\nT {FeaturesResources.is_} int", $"U {FeaturesResources.is_} string")
                )
            );
        }
...
class Program<T>
{
    static void Main(string[] args)
    {
        var p = new Dictio$$nary<int, string>();
                ...
                MainDescription(
                    $"Dictionary<int, string>.Dictionary() (+ 5 {FeaturesResources.overloads_})"
                )
            );
        }
...
public class Publisher
{
    ...
    protected virtual void RaiseSampleEvent()
    {
        ...
        {
            await TestInMethodAsync(
                @"System.Console.CancelKeyPres$$s += null;",
        ...
        {
            await TestInMethodAsync(
                @"System.Console.CancelKeyPress +$$= null;",
...
public static class MyExtensions
{
    public static bool In<T>(this T o, IEnumerable<T> items)
    {
        return true;
                ...
                MainDescription(
                    $"({CSharpFeaturesResources.extension}) bool int.In<int>(IEnumerable<int> items)"
                )
            );
        }
...
public static class Ex
{
    ...
    public static void TestExt(this string ex, int arg)
    {
                ...
                MainDescription(
                    $"({CSharpFeaturesResources.extension}) void string.TestExt<string>() (+ 2 {FeaturesResources.overloads_})"
                )
            );
        }
...
public static class Ex
{
    ...
    public static void TestExt(this int ex, int arg)
    {
                ...
                MainDescription(
                    $"({CSharpFeaturesResources.extension}) void string.TestExt<string>() (+ 1 {FeaturesResources.overload})"
                )
            );
        }
...
",
                MainDescription(
                    $"({CSharpFeaturesResources.extension}) IQueryable<int> IQueryable<int>.Select<int, int>(System.Linq.Expressions.Expression<Func<int, int>> selector)"
                )
            );
        }
...
",
                MainDescription(
                    $"({CSharpFeaturesResources.extension}) Lazy<object> Lazy<object>.Select<object, object>(Func<object, object> selector)"
                )
            );
        }
...
",
                MainDescription(
                    $"({CSharpFeaturesResources.extension}) IEnumerable<'a> IEnumerable<int>.Select<int, 'a>(Func<int, 'a> selector)"
                ),
                AnonymousTypes(
                    $@"
...
",
                MainDescription(
                    $"({CSharpFeaturesResources.extension}) IEnumerable<int> IEnumerable<int>.Where<int>(Func<int, bool> predicate)"
                )
            );
        }
...
",
                MainDescription(
                    $"({CSharpFeaturesResources.extension}) IOrderedEnumerable<int> IEnumerable<int>.OrderBy<int, int>(Func<int, int> keySelector)"
                )
            );
        }
...
",
                MainDescription(
                    $"({CSharpFeaturesResources.extension}) IOrderedEnumerable<int> IOrderedEnumerable<int>.ThenBy<int, int>(Func<int, int> keySelector)"
                )
            );
        }
...
",
                MainDescription(
                    $"({CSharpFeaturesResources.extension}) IOrderedEnumerable<int> IEnumerable<int>.OrderBy<int, ?>(Func<int, ?> keySelector)"
                )
            );
        }
...
",
                MainDescription(
                    $"({CSharpFeaturesResources.extension}) IEnumerable<int> IEnumerable<int>.SelectMany<int, int, int>(Func<int, IEnumerable<int>> collectionSelector, Func<int, int, int> resultSelector)"
                )
            );
        }
...
",
                MainDescription(
                    $"({CSharpFeaturesResources.extension}) IEnumerable<IGrouping<int, int>> IEnumerable<int>.GroupBy<int, int>(Func<int, int> keySelector)"
                )
            );
        }
...
",
                MainDescription(
                    $"({CSharpFeaturesResources.extension}) IEnumerable<int> IEnumerable<int>.Join<int, int, int, int>(IEnumerable<int> inner, Func<int, int> outerKeySelector, Func<int, int> innerKeySelector, Func<int, int, int> resultSelector)"
                )
            );
        }
...
",
                MainDescription(
                    $"({CSharpFeaturesResources.extension}) IEnumerable<IEnumerable<int>> IEnumerable<int>.GroupJoin<int, int, int, IEnumerable<int>>(IEnumerable<int> inner, Func<int, int> outerKeySelector, Func<int, int> innerKeySelector, Func<int, IEnumerable<int>, IEnumerable<int>> resultSelector)"
                )
            );
        }
...
",
                MainDescription(
                    $"({CSharpFeaturesResources.extension}) IEnumerable<int> IEnumerable<int>.SelectMany<int, double, int>(Func<int, IEnumerable<double>> collectionSelector, Func<int, double, int> resultSelector)"
                )
            );
        }
...
",
                MainDescription(
                    $"({CSharpFeaturesResources.extension}) IEnumerable<int> System.Collections.IEnumerable.Cast<int>()"
                )
            );
        }
                ...
                @"class B
{
    public const int Z$$ = unchecked(int.MaxValue + 1);
                ...
                MainDescription(
                    $"({FeaturesResources.constant}) int B.Z = unchecked(int.MaxValue + 1)"
                )
            );
        }
                ...
                @"class C
{
    unsafe void $$Goo(int* x = null)
    {
        ...
        {
            await TestInMethodAsync(
                "var q = from e in \"\" let $$y = 1 let a = new { y } select a;",
                MainDescription($"({FeaturesResources.range_variable}) int y")
            );
        }
                ...
                @"class Program
{
    void Main()
    {
        ...
        Blah($$MEGABYTE);
                ...
                MainDescription(
                    $@"({FeaturesResources.local_constant}) int MEGABYTE = 1024 * 1024 + true"
                )
            );
        }
...
End Class";
            ...
            await TestWithReferenceAsync(
                sourceCode: markup,
                referencedCode: referencedCode,
                sourceLanguage: LanguageNames.CSharp,
                referencedLanguage: LanguageNames.VisualBasic,
                expectedResults: MainDescription(
                    "string CCC.IndexProp[int p1, [int p2 = 0]] { get; set; }"
                )
            );
        }
                ...
                @"public class TestClass
{
    ...
    public TestClass$$()
    {
                ...
                Documentation(
                    "This sample shows how to specify the TestClass constructor as a cref attribute."
                )
            );
        }
                ...
                @"public class TestClass
{
    ...
    public TestC$$lass(int value)
    {
                ...
                Documentation(
                    "This sample shows how to specify the TestClass(int) constructor as a cref attribute."
                )
            );
        }
                ...
                @"public class TestClass
{
    ...
    public static void GetGenericValue()
    {
                ...
                Documentation(
                    "This sample shows how to specify the TestClass.GetGenericValue() method as a cref attribute."
                )
            );
        }
                ...
                @"public class TestClass
{
    ...
    public static void GetGenericValue()
    {
                ...
                Documentation(
                    "This sample shows how to call the TestClass.GetGenericValue<T>(T) method"
                )
            );
        }
...
class Generic$$Class<T>
{
                ...
                Documentation(
                    "This example shows how to specify the GenericClass<T> cref.",
    ...
    <Project Language=""C#"" CommonReferences=""true"" AssemblyName=""Proj2"">
        <Document IsLinkFile=""true"" LinkAssemblyName=""Proj1"" LinkFilePath=""SourceDocument""/>
            ...
            await VerifyWithReferenceWorkerAsync(
                markup,
                new[] { MainDescription($"({FeaturesResources.field}) int C.x"), Usage("") }
            );
        }
...
{   
    ...
    <Project Language=""C#"" CommonReferences=""true"" AssemblyName=""Proj2"">
        <Document IsLinkFile=""true"" LinkAssemblyName=""Proj1"" LinkFilePath=""SourceDocument""/>
            ...
            await VerifyWithReferenceWorkerAsync(
                markup,
                new[] { MainDescription($"({FeaturesResources.label}) LABEL"), Usage("") }
            );
        }
...
class C
{
    ...
    <Project Language=""C#"" CommonReferences=""true"" AssemblyName=""Proj2"">
        <Document IsLinkFile=""true"" LinkAssemblyName=""Proj1"" LinkFilePath=""SourceDocument""/>
            ...
            await VerifyWithReferenceWorkerAsync(
                markup,
                new[] { MainDescription($"({FeaturesResources.range_variable}) int y"), Usage("") }
            );
        }
...
";
            ...
            await TestWithOptionsAsync(
                workspace,
                MainDescription($"({FeaturesResources.parameter}) int x = 1")
            );
        }
...
class Program
{
    ...
    private static ref int goo()
    {
        ...
        [
            Fact,
            WorkItem(
                "https://devdiv.visualstudio.com/DefaultCollection/DevDiv/_workitems?id=410932"
            )
        ]
...
void $$M(int x) { }";
            ...
            await TestInClassAsync(markup, MainDescription("void C.M(int x)"), Documentation(""));
        }
...
class Program
{
    static void Main()
    {
        ...
        c$$.M(1, 2);
                ...
                MainDescription(
                    $"void C.M(int a, params int[] b) (+ 1 {FeaturesResources.overload})"
                )
            );
        }
...
interface IGoo {  }";
            ...
            await TestAsync(markup, MainDescription("interface IGoo"), Documentation(""));
        }
...
";
            ...
            await TestAsync(code, MainDescription("void C1_1.M1()"), Documentation("Summary text"));
        }
...
";
            ...
            await TestAsync(code, MainDescription("void I1.M1()"), Documentation("Summary text"));
        }
...
";
            await TestWithOptionsAsync(
                Options.Regular.WithLanguageVersion(LanguageVersion.CSharp11),
                source,
                MainDescription($"({FeaturesResources.parameter}) string s")
            );
        }
    ...
    static void Main()
    {
        ...
        $$F(r, r, ref r, ref r, r, r, out r, out r);
            ...
            await TestAsync(
                source,
                MainDescription(
                    $"void Program.F(R r1, scoped R r2, ref R r3, scoped ref R r4, in R r5, scoped in R r6, out R r7, out R r8)"
                )
            );
        }
    ...
    static void Main()
    {
        ...
        public async Task TestNullableRefTypeVar1()
        {
            var source = """
                ...
                """;
            await TestAsync(source, MainDescription($"class System.String?"));
        }
        ...
        {
            var source = @"using X = $$int;";
            await TestAsync(source, MainDescription($"struct System.Int32"));
        }
        ...
        {
            var source = @"using X = ($$int a, int b);";
            await TestAsync(source, MainDescription($"struct System.Int32"));
        }
        ...
        {
            var source = @"using $$X = (int a, int b);";
            await TestAsync(source, MainDescription($"(int a, int b)"));
        }
        ...
        {
            var source = @"using unsafe X = $$delegate*<int,int>;";
            await TestAsync(source);
        }
        ...
        {
            var source = @"using unsafe $$X = delegate*<int,int>;";
            await TestAsync(source, MainDescription($"delegate*<int, int>"));
        }

        [Fact]
        public async Task TestUsingAliasToType5()
        {
            var source = @"using unsafe X = $$int*;";
            await TestAsync(source, MainDescription($"struct System.Int32"));
        }
        ...
        {
            var source = @"using unsafe $$X = int*;";
            await TestAsync(source, MainDescription($"int*"));
        }
    }
}
