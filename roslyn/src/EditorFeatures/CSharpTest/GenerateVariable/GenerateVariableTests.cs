                ...
                @"class Class
{
    void Method(int i)
    {
        [|goo|] = 1;
                ...
                new[]
                {
                    string.Format(FeaturesResources.Generate_field_1_0, "goo", "Class"),
                ...
                @"class Program
{
    static void Main()
    {
        [|p|]++;
                ...
                new[]
                {
                    string.Format(FeaturesResources.Generate_field_1_0, "p", "Program"),
                    string.Format(FeaturesResources.Generate_property_1_0, "p", "Program"),
