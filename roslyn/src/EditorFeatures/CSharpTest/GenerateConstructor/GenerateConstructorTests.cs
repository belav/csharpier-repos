...
namespace Microsoft.CodeAnalysis.Editor.CSharp.UnitTests.GenerateConstructor
{
    ...
    {
        public GenerateConstructorTests(ITestOutputHelper logger) : base(logger) { }
...
class A
{
    static void Main(string[] args)
    {
        ...
        public partial class GenerateConstructorTestsWithFindMissingIdentifiersAnalyzer
            : AbstractCSharpDiagnosticProviderBasedUserDiagnosticTest
        {
            public GenerateConstructorTestsWithFindMissingIdentifiersAnalyzer(
