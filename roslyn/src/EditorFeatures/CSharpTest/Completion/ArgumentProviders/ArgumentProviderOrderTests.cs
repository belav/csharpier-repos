...
namespace Microsoft.CodeAnalysis.Editor.CSharp.UnitTests.Completion.ArgumentProviders
{
    ...
    public class ArgumentProviderOrderTests
    {
        ...
        {
            var exportProvider = EditorTestCompositions.EditorFeaturesWpf.ExportProviderFactory
            ...
            var actualOrder = orderedCSharpArgumentProviders.Select(x => x.Value.GetType())
                .ToArray();
