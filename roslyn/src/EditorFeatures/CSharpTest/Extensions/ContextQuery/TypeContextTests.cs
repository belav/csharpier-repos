...
namespace Microsoft.CodeAnalysis.Editor.CSharp.UnitTests.IntelliSense.CompletionSetSources
{
    ...
    public class TypeContextTests : AbstractContextTests
    {
        ...
        [Fact]
        public void UsingDirective() => VerifyFalse(@"using $$");
        ...
        [Fact]
        public void UsingAlias() => VerifyTrue(@"using MyType = $$");
        ...
        [Fact]
        public void VariableDeclaration() => VerifyTrue(AddInsideMethod(@"fixed($$"));
        ...
        [Fact]
        public void AliasedName() => VerifyFalse(AddInsideMethod(@"global::$$"));
        ...
        [Fact]
        public void MemberDeclarationInScript() => VerifyOnlyInScript(@"private $$");
    }
}
