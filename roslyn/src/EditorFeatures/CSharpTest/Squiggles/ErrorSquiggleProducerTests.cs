...
class Program
{
    void Test()
    {
        ...
        x += 1;
            ...
            var preferIntrinsicPredefinedTypeOption = new OptionKey2(
                CodeStyleOptions2.PreferIntrinsicPredefinedTypeKeywordInDeclaration,
                language
            );
            var preferIntrinsicPredefinedTypeOptionValue = new CodeStyleOption2<bool>(
                value: true,
                notification: NotificationOption2.Error
            );
            options.Add(
                preferIntrinsicPredefinedTypeOption,
                preferIntrinsicPredefinedTypeOptionValue
            );
            ...
            var expectedToolTip = new ContainerElement(
                ...
                new ClassifiedTextElement(
                    ...
                    new ClassifiedTextRun(
                        ClassificationTypeNames.Text,
                        CSharpAnalyzersResources.Using_directive_is_unnecessary
                    )
                )
            );
            ...
            expectedToolTip = new ContainerElement(
                ...
                new ClassifiedTextElement(
                    ...
                    new ClassifiedTextRun(
                        ClassificationTypeNames.Text,
                        WorkspacesResources.Name_can_be_simplified
                    )
                )
            );
            ...
            class Test
{
        ...
        private static async Task<
            ImmutableArray<ITagSpan<IErrorTag>>
