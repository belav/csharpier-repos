        ...
        static void Main(String[] args)
        {
            ...
            edits.VerifySemanticDiagnostics(
                ...
                Diagnostic(
                    RudeEditKind.Delete,
                    null,
                    DeletedSymbolDisplay(FeaturesResources.class_, "N.C")
                )
            );
        }
    ...
    <AS:0>public Goo(int b)</AS:0>
    {
        this.value = b;
            ...
            edits.VerifySemantics(
                ...
                new[] { SemanticEdit(SemanticEditKind.Update, c => c.GetMember("Goo..ctor")) },
        ...
        public void InstanceConstructor_DeleteParameterless(string typeKind)
        {
            ...
            edits.VerifySemanticDiagnostics(
                ...
                Diagnostic(
                    RudeEditKind.DeleteActiveStatement,
                    "partial " + typeKind + " C",
                    DeletedSymbolDisplay(FeaturesResources.constructor, "C()")
                )
            );
        }
    ...
    public C() {}
            ...
            edits.VerifySemanticDiagnostics(
                ...
                Diagnostic(
                    RudeEditKind.Delete,
                    "class C",
                    DeletedSymbolDisplay(FeaturesResources.field, "a")
                )
            );
        }
    ...
    int a = 1;
            ...
            edits.VerifySemanticDiagnostics(
                ...
                Diagnostic(
                    RudeEditKind.Delete,
                    "class C",
                    DeletedSymbolDisplay(FeaturesResources.auto_property, "a")
                )
            );
        }
...
";
            ...
            edits.VerifySemanticDiagnostics(
                ...
                Diagnostic(
                    RudeEditKind.InsertAroundActiveStatement,
                    "yield return 1;",
                    CSharpFeaturesResources.yield_return_statement
                )
            );
        }
...
";
            ...
            edits.VerifySemanticDiagnostics(
                ...
                Diagnostic(
                    RudeEditKind.InsertAroundActiveStatement,
                    "await",
                    CSharpFeaturesResources.await_expression
                )
            );
        }
...
";
            ...
            edits.VerifySemanticDiagnostics(
                ...
                Diagnostic(
                    RudeEditKind.InsertAroundActiveStatement,
                    "await foreach (var x in AsyncIter())",
                    CSharpFeaturesResources.asynchronous_foreach_statement
                )
            );
        }
...
";
            ...
            edits.VerifySemanticDiagnostics(
                ...
                Diagnostic(
                    RudeEditKind.InsertAroundActiveStatement,
                    "x = new AsyncDisposable()",
                    CSharpFeaturesResources.asynchronous_using_declaration
                ),
                Diagnostic(
                    RudeEditKind.InsertAroundActiveStatement,
        ...
        public void InsertDeleteMethod_Inactive()
        {
            ...
            EditAndContinueValidation.VerifySemantics(
                ...
                new[]
                {
                    ...
                    DocumentResults(activeStatements: GetActiveStatements(srcB1, srcB2, path: "1"))
                }
            );
        }
                    ...
                    DocumentResults(
                        ...
                        diagnostics: new[]
                        {
                            Diagnostic(
                                RudeEditKind.DeleteActiveStatement,
                                "      partial c",
                                DeletedSymbolDisplay(FeaturesResources.method, "F()")
                            )
                        }
                    )
                }
...
#line default
        ...
        [
            ...
            WorkItem(52971, "https://github.com/dotnet/roslyn/issues/52971")
        ]
