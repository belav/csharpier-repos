...
";
        ...
        public void Parameter_Update_Modifiers_RuntimeTypeUnchanged(string newModifiers)
        {
            ...
            var src2 =
                "static class C { static int F("
                + newModifiers
                + " int[] a) => <AS:0>throw null!</AS:0>; }";
        ...
        public void Return_TypeChange_Ref()
        {
            ...
            edits.VerifySemanticDiagnostics(
                active,
                diagnostics: [
                    Diagnostic(RudeEditKind.ChangingNameOrSignatureOfActiveMember, "ref int F(int a)", GetResource("method"))
                ],
                capabilities: EditAndContinueCapabilities.AddMethodToExistingType
            );
        }
    ...
    <AS:0>public Goo(int a = 42)</AS:0>
    {
        this.value = a;
            ...
            edits.VerifySemanticDiagnostics(
                active,
                Diagnostic(
                    RudeEditKind.InitializerUpdate,
                    "int a = 42",
                    FeaturesResources.parameter
                )
            );
        }
...
class C
{
    public C(int a) <AS:0>{</AS:0>}
        ...
        public void Constructor_Instance_ImplicitInitializer_ParameterChange()
        {
            ...
            var src2 = "class C { <AS:0>C(byte P)</AS:0> {} }";
            ...
            edits.VerifySemanticDiagnostics(
                active,
                diagnostics: [
                    Diagnostic(RudeEditKind.ChangingNameOrSignatureOfActiveMember, "C(byte P)", GetResource("constructor"))
                ],
                capabilities: EditAndContinueCapabilities.AddMethodToExistingType
            );
        }
        ...
        {
            var src1 = keyword + " <AS:0>C(int  P)</AS:0>;";
            var src2 = keyword + " <AS:0>C(byte P)</AS:0>;";
            ...
            edits.VerifySemanticDiagnostics(
                active,
                diagnostics: [
                    Diagnostic(RudeEditKind.ChangingNameOrSignatureOfActiveMember, "(byte P)", GetResource("constructor"))
                ],
                capabilities: EditAndContinueCapabilities.AddMethodToExistingType
            );
        }
        ...
        [InlineData("class")]
        [InlineData("record")]
        public void Constructor_Instance_Primary_ExplicitInitializer(string keyword)
        {
            var src1 = keyword + " C(int P) : <AS:0>B(1)</AS:0>;";
            var src2 = keyword + " C(int P) : <AS:0>B(2)</AS:0>;";
        ...
        [Fact]
        public void Constructor_Instance_Primary_Record_Parameter_BaseInitializerChange()
        {
            var src1 = "record C(<AS:0>int P</AS:0>) : B(1);";
            var src2 = "record C(<AS:0>int P</AS:0>) : B(2);";
        ...
        public void Constructor_Instance_Primary_Record_Parameter_TypeAttributeChange(
            string keyword
        )
        {
            var src1 =
                "class A(int x) : System.Attribute; [A( 1)]" + keyword + " C(<AS:0>int P</AS:0>);";
            var src2 =
                "class A(int x) : System.Attribute; [A(10)]" + keyword + " C(<AS:0>int P</AS:0>);";
        ...
        [InlineData("record")]
        [InlineData("record struct")]
        public void Constructor_Instance_Primary_Record_Parameter_TypeParameterAttributeChange(
            string keyword
        )
        {
            var src1 =
                "class A(int x) : System.Attribute; "
                + keyword
                + " C<[A( 1)] T>(<AS:0>int P</AS:0>);";
            var src2 =
                "class A(int x) : System.Attribute; "
                + keyword
                + " C<[A(10)] T>(<AS:0>int P</AS:0>);";
            ...
            edits.VerifySemanticDiagnostics(
                active,
                diagnostics: new[] { Diagnostic(RudeEditKind.GenericTypeUpdate, "T") },
                capabilities: EditAndContinueCapabilities.ChangeCustomAttributes
            );
        }

        [Fact]
        public void Constructor_Instance_Copy_BaseInitializerChange()
        {
            var src1 = "record <AS:0>C</AS:0>(int P) : B(1);";
            var src2 = "record <AS:0>C</AS:0>(int P) : B(2);";
        ...
        [InlineData("record")]
        [InlineData("record struct")]
        public void Constructor_Instance_Copy_TypeAttributeChange(string keyword)
        {
            var src1 =
                "class A(int x) : System.Attribute; [A( 1)]" + keyword + " <AS:0>C</AS:0>(int P);";
            var src2 =
                "class A(int x) : System.Attribute; [A(10)]" + keyword + " <AS:0>C</AS:0>(int P);";
        ...
        [InlineData("record")]
        [InlineData("record struct")]
        public void Constructor_Instance_Copy_TypeParameterAttributeChange(string keyword)
        {
            var src1 =
                "class A(int x) : System.Attribute; "
                + keyword
                + " <AS:0>C<[A( 1)] T></AS:0>(int P);";
            var src2 =
                "class A(int x) : System.Attribute; "
                + keyword
                + " <AS:0>C<[A(10)] T></AS:0>(int P);";
...
public record <AS:0>C</AS:0>(int P);";
        ...
        public void Constructor_Instance_Delete_Parameterless(string typeKind)
        {
            var src1 =
                "partial "
                + typeKind
                + " C { public C() { <AS:0>System.Console.WriteLine(1);</AS:0> } }";
        ...
        [InlineData("record")]
        [InlineData("record struct")]
        public void Constructor_Instance_Delete_Primary(string typeKind)
        {
            var src1 = typeKind + " <AS:0>C()</AS:0> { }";
            var src2 = "<AS:0>" + typeKind + " C</AS:0> { }";
        ...
        [InlineData("class")]
        [InlineData("record")]
        public void Constructor_Instance_Delete_BaseInitializer_Internal(string typeKind)
        {
            var src1 = "<AS:0>var c = new C();</AS:0> " + typeKind + " C() : <AS:1>B()</AS:1> { }";
            var src2 = "<AS:0>var c = new C();</AS:0> " + typeKind + " <AS:1>C()</AS:1> : B { }";
        ...
        [InlineData("class")]
        [InlineData("record")]
        public void Constructor_Instance_Delete_BaseInitializer_Leaf(string typeKind)
        {
            var src1 = typeKind + " C() : <AS:0>B()</AS:0> { }";
            var src2 = typeKind + " <AS:0>C()</AS:0> : B { }";
        ...
        [InlineData("class")]
        [InlineData("record")]
        public void Constructor_Instance_Insert_BaseInitializer_Internal(string typeKind)
        {
            var src1 = "<AS:0>var c = new C();</AS:0> " + typeKind + " <AS:1>C()</AS:1> : B { }";
            var src2 = "<AS:0>var c = new C();</AS:0> " + typeKind + " C() : <AS:1>B()</AS:1> { }";
            ...
            edits.VerifySemanticDiagnostics(
                active,
                Diagnostic(RudeEditKind.ActiveStatementUpdate, "B()")
            );
        }
        ...
        [InlineData("class")]
        [InlineData("record")]
        public void Constructor_Instance_Insert_BaseInitializer_Leaf(string typeKind)
        {
            var src1 = typeKind + " <AS:0>C()</AS:0> : B { }";
            var src2 = typeKind + " C() : <AS:0>B()</AS:0> { }";
        ...
        [InlineData("record")]
        [InlineData("record struct")]
        public void Constructor_Instance_Unchanged(string typeKind)
        {
            var src1 = "<AS:0>var c = new C(1);</AS:0> " + typeKind + " <AS:1>C(int a)</AS:1>;";
            var src2 = "<AS:0>var c = new C(2);</AS:0> " + typeKind + " <AS:1>C(int a)</AS:1>;";
...
public record C
{
    ...
    <AS:2>public C(int P)</AS:2> { }
    protected C(C original) { <AS:3>P = original.P;</AS:3> }
}";
            var src2 =
                @"
...
";
            ...
            edits.VerifySemanticDiagnostics(
                active,
                Diagnostic(RudeEditKind.ActiveStatementUpdate, "C       (        int P         )"),
                Diagnostic(RudeEditKind.ActiveStatementUpdate, "C"),
                Diagnostic(RudeEditKind.ActiveStatementUpdate, "int P")
            );
        }
...
";
            ...
            edits.VerifySemanticDiagnostics(
                active,
                Diagnostic(RudeEditKind.ActiveStatementUpdate, "public C(int P)"),
                Diagnostic(RudeEditKind.ActiveStatementUpdate, "protected C(C original)")
            );
        }
...
";
        ...
        [Fact]
        public void Property_Auto_Record_ReplacingPrimaryWithNonPrimary_Getter()
        {
            // Consider: Just looking at the span we do not know whether the active statement is in the getter of the setter.
...
public record C
{
    ...
    protected C(C original) {P = original.P; }
        ...
        [Fact]
        public void Property_Auto_Record_ReplacingPrimaryWithNonPrimary_Setter()
        {
            // Consider: Just looking at the span we do not know whether the active statement is in the getter of the setter.
            // We could resolve the method token associated with the method to find out and map the statement accordingly.
...
class C
{
    ...
    public C() {}
            ...
            edits.VerifyEdits("Update [int a = 1       ;]@24 -> [const int a = 1;]@24");

            var active = GetActiveStatements(src1, src2);

            edits.VerifySemanticDiagnostics(
                active,
                Diagnostic(RudeEditKind.ModifiersUpdate, "const int a = 1", GetResource("field"))
            );
        }
        ...
        lock (lockThis)
        {
            ...
            edits.VerifySemanticDiagnostics(
                ...
                Diagnostic(
                    ...
                    "lock (lockThis)",
                    CSharpFeaturesResources.lock_statement
                )
            );
        }
        ...
        unsafe
        {
            ...
            edits.VerifySemanticDiagnostics(
                ...
                Diagnostic(
                    RudeEditKind.InsertAroundActiveStatement,
                    "fixed (int* pj = &value)",
                    CSharpFeaturesResources.fixed_statement
                )
            );
        }
    ...
    static void Main(string[] args)
    {
        foreach (<AS:1>object c</AS:1> in F())
        {
            ...
            edits.VerifySemanticDiagnostics(
                ...
                Diagnostic(
                    RudeEditKind.UpdateAroundActiveStatement,
                    "foreach (      object c        in F())",
                    CSharpFeaturesResources.foreach_statement
                )
            );
        }
        ...
        using (a)
        {
            ...
            edits.VerifySemanticDiagnostics(
                ...
                Diagnostic(
                    RudeEditKind.InsertAroundActiveStatement,
                    "using (c)",
                    CSharpFeaturesResources.using_statement
                )
            );
        }
        ...
        return 0;
            ...
            edits.VerifySemanticDiagnostics(
                ...
                Diagnostic(
                    RudeEditKind.UpdateAroundActiveStatement,
                    "switch (F(2))",
                    CSharpFeaturesResources.switch_statement
                )
            );
        }
...
";
            ...
            edits.VerifySemanticDiagnostics(
                ...
                Diagnostic(
                    RudeEditKind.InsertAroundActiveStatement,
                    "try",
                    CSharpFeaturesResources.try_block
                )
            );
        }
        ...
        <AS:0>}</AS:0>
            ...
            edits.VerifySemanticDiagnostics(
                ...
                Diagnostic(
                    RudeEditKind.UpdateAroundActiveStatement,
                    "finally",
                    CSharpFeaturesResources.finally_clause
                )
            );
        }
        ...
        <AS:0>return a * b;</AS:0>
            ...
            edits.VerifySemanticDiagnostics(
                ...
                Diagnostic(
                    RudeEditKind.InsertAroundActiveStatement,
                    "checked",
                    CSharpFeaturesResources.checked_statement
                )
            );
        }
    ...
    private static int M(int a, int b) 
    {
        <AS:0>return a * b;</AS:0>
            ...
            edits.VerifySemanticDiagnostics(
                ...
                Diagnostic(
                    RudeEditKind.DeleteAroundActiveStatement,
                    "System.Console.WriteLine(5 * M(1, 2));",
                    CSharpFeaturesResources.checked_statement
                )
            );
        }
...
";
            ...
            edits.VerifySemanticDiagnostics(
                active,
                Diagnostic(
                    RudeEditKind.ActiveStatementLambdaRemoved,
                    "return b;",
...
";
            ...
            edits.VerifySemanticDiagnostics(
                ...
                Diagnostic(
                    RudeEditKind.ActiveStatementLambdaRemoved,
                    "from",
                    CSharpFeaturesResources.where_clause
                )
            );
        }
...
";
            ...
            edits.VerifySemanticDiagnostics(
                ...
                Diagnostic(
                    RudeEditKind.ActiveStatementLambdaRemoved,
                    "from",
                    CSharpFeaturesResources.let_clause
                )
            );
        }
...
";
            ...
            edits.VerifySemanticDiagnostics(
                ...
                Diagnostic(
                    RudeEditKind.ActiveStatementLambdaRemoved,
                    "from",
                    CSharpFeaturesResources.join_clause
                )
            );
        }
...
";
            ...
            edits.VerifySemanticDiagnostics(
                ...
                Diagnostic(
                    RudeEditKind.ActiveStatementLambdaRemoved,
                    "from",
                    CSharpFeaturesResources.orderby_clause
                )
            );
        }
        ...
        var q = from x in xs
            ...
            edits.VerifySemanticDiagnostics(
                ...
                Diagnostic(
                    RudeEditKind.ActiveStatementLambdaRemoved,
                    "join",
                    CSharpFeaturesResources.select_clause
                )
            );
        }
        ...
        var q = from a in array
            ...
            edits.VerifySemanticDiagnostics(
                ...
                Diagnostic(
                    RudeEditKind.ActiveStatementLambdaRemoved,
                    "group",
                    CSharpFeaturesResources.groupby_clause
                )
            );
        }
...
";
        ...
        public void InsertDeleteMethod_Inactive()
        {
            ...
            var srcA1 =
                "partial class C { void F1() { <AS:0>System.Console.WriteLine(1);</AS:0> } }";
            var srcB1 = "partial class C { void F2() { } }";
            var srcA2 =
                "partial class C { void F1() { <AS:0>System.Console.WriteLine(1);</AS:0> } void F2() { } }";
        ...
        public void InsertDeleteMethod_Active()
        {
            ...
            var srcB1 =
                "partial class C { void F() { <AS:0>System.Console.WriteLine(1);</AS:0> } }";
            ...
            EditAndContinueValidation.VerifySemantics(
                new[]
                {
                    GetTopEdits(srcA1, srcA2, documentIndex: 0),
                    GetTopEdits(srcB1, srcB2, documentIndex: 1)
                },
                new[]
                {
                    DocumentResults(
        ...
        [Fact]
        public void InsertDeleteMethod_Active_EntirePartialTypeDeclaration()
        {
            var srcA1 = "partial class C { }";
            var srcB1 =
                "partial class C { void F() { <AS:0>System.Console.WriteLine(1);</AS:0> } }";
        ...
        <AS:1>B();</AS:1>
            ...
            edits.VerifySemanticDiagnostics(
                ...
                Diagnostic(
                    RudeEditKind.UpdateAroundActiveStatement,
                    "B();",
                    string.Format(FeaturesResources._0_directive, "line")
                )
            );
        }
...
#line default
        ...
        [
            Fact(Skip = "https://github.com/dotnet/roslyn/issues/52971"),
            WorkItem("https://github.com/dotnet/roslyn/issues/52971")
        ]
        ...
        <AS:0>Console.WriteLine(a);</AS:0>
            ...
            edits.VerifySemanticDiagnostics(
                Diagnostic(
                    RudeEditKind.Delete,
                    null,
                    DeletedSymbolDisplay(FeaturesResources.class_, "C")
                )
            );
        }
...
class C
{
    public static void F()
    {
        ...
        <AS:4>Console.WriteLine(50);</AS:4> 
            ...
            var edits = GetTopEdits(src1, src2);
            var active = GetActiveStatements(
                src1,
                src2,
                flags: new[]
                {
...
class C
{
    ...
    <AS:0>}</AS:0>
            ...
            var active = GetActiveStatements(
                src1,
                src2,
                flags: new[] { ActiveStatementFlags.NonLeafFrame | ActiveStatementFlags.LeafFrame }
            );
...
";
            ...
            var expectedDiagnostic = outOfMemory
                ...
                : Diagnostic(
                    ...
                    "public static void G()",
                    "G",
                    SimpleToStringException.ToStringOutput
                );
