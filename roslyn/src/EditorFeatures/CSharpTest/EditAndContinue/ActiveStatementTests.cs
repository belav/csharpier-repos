...
class C
{
    public C(int a) <AS:0>{</AS:0>}
        ...
        )
        {
            ...
            edits.VerifySemanticDiagnostics(
                active,
                diagnostics: [Diagnostic(RudeEditKind.GenericTypeUpdate, "T")],
                capabilities: EditAndContinueCapabilities.ChangeCustomAttributes
            );
        }
            ...
            edits.VerifySemanticDiagnostics(
                ...
                [
                    Diagnostic(
                        RudeEditKind.ChangingNameOrSignatureOfActiveMember,
                        "get",
                        GetResource("property getter")
                    ),
                    Diagnostic(
                        RudeEditKind.ChangingNameOrSignatureOfActiveMember,
                        "set",
                        GetResource("property setter")
                    ),
                ],
                capabilities: EditAndContinueCapabilities.AddMethodToExistingType
            );
...
class C
{
    ...
    <AS:0>}</AS:0>
            ...
            var active = GetActiveStatements(
                src1,
                src2,
                flags: [ActiveStatementFlags.PartiallyExecuted | ActiveStatementFlags.LeafFrame]
            );
...
class C
{
    ...
    <AS:0>}</AS:0>
            ...
            var active = GetActiveStatements(
                src1,
                src2,
                flags: [ActiveStatementFlags.NonLeafFrame | ActiveStatementFlags.LeafFrame]
            );
