...
namespace N
{
    class C
    {
        ...
        public void UpdateAttributes1()
        {
            ...
            edits.VerifyEdits("Update [A1]@1 -> [A2]@1");
        ...
        public void UpdateAttributes2()
        {
            ...
            edits.VerifyEdits("Update [A(1)]@1 -> [A(2)]@1");
        ...
        public void DeleteAttributes()
        {
            ...
            edits.VerifyEdits("Update [[A, B]]@0 -> [[A]]@0", "Delete [B]@4");
        ...
        public void InsertAttributes1()
        {
            ...
            edits.VerifyEdits("Update [[A]]@0 -> [[A, B]]@0", "Insert [B]@4");
        ...
        public void InsertAttributes2()
        {
            ...
            edits.VerifyEdits("Insert [[A]]@0", "Insert [A]@1");
        ...
        public void ReorderAndUpdateAttributes()
        {
            ...
            edits.VerifyEdits("Reorder [A(1)]@1 -> @7", "Update [A(1)]@1 -> [A(2)]@7");
        ...
        public void TypeKindUpdate()
        {
            ...
            edits.VerifyEdits("Update [class C { }]@0 -> [struct C { }]@0");
        ...
        public void TypeKindUpdate2()
        {
            ...
            edits.VerifyEdits("Update [class C { }]@0 -> [record C { }]@0");
...
";
        ...
        public void Interface_Modifiers_Update()
        {
            ...
            edits.VerifyEdits("Update [public interface C { }]@0 -> [interface C { }]@0");

            edits.VerifyRudeDiagnostics(
                Diagnostic(
                    RudeEditKind.ModifiersUpdate,
                    "interface C",
                    FeaturesResources.interface_
                )
            );
        }
        ...
        public void Struct_Modifiers_Update()
        {
            ...
            edits.VerifyEdits("Update [struct C { }]@0 -> [public struct C { }]@0");
        ...
        public void Struct_UnsafeModifier_Update()
        {
            ...
            edits.VerifyEdits("Update [unsafe struct C { }]@0 -> [struct C { }]@0");
        ...
        public void Class_Name_Update1()
        {
            ...
            edits.VerifyEdits("Update [class C { }]@0 -> [class D { }]@0");
        ...
        public void Class_Name_Update2()
        {
            ...
            edits.VerifyEdits("Update [class LongerName { }]@0 -> [class LongerMame { }]@0");
        ...
        public void Interface_Name_Update()
        {
            ...
            edits.VerifyEdits("Update [interface C { }]@0 -> [interface D { }]@0");
        ...
        public void BaseTypeUpdate2()
        {
            ...
            edits.VerifyEdits("Update [class C : D1 { }]@0 -> [class C : D2 { }]@0");
        ...
        public void BaseInterfaceUpdate2()
        {
            ...
            edits.VerifyEdits("Update [class C : IGoo, IBar { }]@0 -> [class C : IGoo { }]@0");
...
record C(int X)
{
    public int Y { get; init; }
        ...
        public void EnumMemberAttributeUpdate()
        {
            ...
            edits.VerifyEdits("Update [A1]@10 -> [A2]@10");
        ...
        public void Delegates_ParameterOptionalParameter_Update()
        {
            ...
            edits.VerifyEdits("Update [int a = 1]@22 -> [int a = 2]@22");
        ...
        public void Delegates_Parameter_UpdateModifier()
        {
            ...
            edits.VerifyEdits("Update [int[] a]@22 -> [params int[] a]@22");
        ...
        public void Delegates_Parameter_AddAttribute()
        {
            ...
            edits.VerifyEdits("Insert [[A]]@22", "Insert [A]@23");
        ...
        public void Delegates_AddAttribute()
        {
            ...
            edits.VerifyEdits("Insert [[return:A]]@0", "Insert [A]@8");
                    ...
                    DocumentResults(
                        diagnostics: new[]
                        {
                            Diagnostic(
                                RudeEditKind.Delete,
                                "partial struct S",
                                DeletedSymbolDisplay(FeaturesResources.method, "F2(byte)")
                            )
                        }
                    ),
                    DocumentResults(
    ...
    public static extern int puts(string c);]@74",
            ...
            edits.VerifySemanticDiagnostics(
                Diagnostic(
                    RudeEditKind.Delete,
                    "class C",
                    DeletedSymbolDisplay(FeaturesResources.method, "puts(string)")
                )
            );
        }
...
class C
{
    static void M(string? s)
    {
            ...
            edits.VerifyEdits("Update [string s]@32 -> [string? s]@32");
...
class C
{
    static void Main(char c, int a)
    {
            ...
            edits.VerifyEdits("Reorder [char c]@42 -> @35");
...
public static class Extensions
{
    public static int ToInt32(string s)
    {
        return Int32.Parse(s);
            ...
            edits.VerifyEdits("Update [this string s]@179 -> [string s]@179");
...
class Test
{
    ...
    static void Main(string[] args)
    {
        System.Console.Write(5);
            ...
            edits.VerifyEdits(
                "Update [[Obsolete]]@21 -> [[Obsolete, Serializable]]@21",
...
class Test
{
    ...
    static void Main(string[] args)
    {
        System.Console.Write(5);
            ...
            edits.VerifyEdits("Insert [[Serializable]]@37", "Insert [Serializable]@38");
...
class Test
{
    static void Main(string[] args)
    {
        System.Console.Write(5);
            ...
            edits.VerifyEdits("Delete [[Obsolete]]@21", "Delete [Obsolete]@22");
...
class Test
{
    ...
    static void Main(string[] args)
    {
        System.Console.Write(5);
            ...
            edits.VerifyEdits(
                "Update [[Obsolete, Serializable]]@21 -> [[Obsolete]]@21",
...
class Test
{
    ...
    static void Main(string[] args)
    {
        System.Console.Write(5);
            ...
            edits.VerifyEdits("Delete [[Serializable]]@37", "Delete [Serializable]@38");
            ...
            edits.VerifySemanticDiagnostics(
                Diagnostic(
                    ...
                    DeletedSymbolDisplay(
                        CSharpFeaturesResources.conversion_operator,
                        "implicit operator bool(C)"
                    )
                ),
                Diagnostic(
                    RudeEditKind.Delete,
                    "class C",
                    DeletedSymbolDisplay(FeaturesResources.operator_, "operator +(C, C)")
                )
            );
        }
...
";
        ...
        public void FieldInitializer_Update1()
        {
            ...
            edits.VerifyEdits("Update [a = 0]@14 -> [a = 1]@14");
        ...
        public void PropertyInitializer_Update1()
        {
            ...
            edits.VerifyEdits("Update [int a { get; } = 0;]@10 -> [int a { get; } = 1;]@10");
        ...
        public void FieldInitializerUpdate_SwitchExpressionInConstructor()
        {
            ...
            edits.VerifySemanticDiagnostics(
                Diagnostic(
                    RudeEditKind.SwitchExpressionUpdate,
                    "switch",
                    FeaturesResources.constructor
                )
            );
...
";
        ...
        public void IndexerWithExpressionBody_Update()
        {
            ...
            edits.VerifyEdits("Update [int this[int a] => 1;]@10 -> [int this[int a] => 2;]@10");
        ...
        public void Indexer_GetterAndSetterBlockBodiesToExpressionBody()
        {
            ...
            edits.VerifyRudeDiagnostics(
                Diagnostic(
                    RudeEditKind.Delete,
                    "int this[int a]",
                    DeletedSymbolDisplay(CSharpFeaturesResources.indexer_setter, "this[int].set")
                )
            );
        }
        ...
        set { arr[i] = value; }
            ...
            edits.VerifyRudeDiagnostics(
                Diagnostic(
                    RudeEditKind.Delete,
                    "public T this[int i]",
                    DeletedSymbolDisplay(CSharpFeaturesResources.indexer_getter, "this[int].get")
                )
            );
        }
...
";
        ...
        public void ParameterModifierUpdate1()
        {
            ...
            var edits = GetTopEdits(src1, src2);
            edits.VerifyEdits("Update [ref int b]@33 -> [int b]@33");
        }
        ...
        public void ParameterAttributeInsert1()
        {
            ...
            var edits = GetTopEdits(src1, src2);
            edits.VerifyEdits("Insert [[A]]@24", "Insert [A]@25");
        }
        ...
        public void ParameterAttributeInsert2()
        {
            ...
            var edits = GetTopEdits(src1, src2);
            edits.VerifyEdits("Update [[A]]@24 -> [[A, B]]@24", "Insert [B]@28");
        }
        ...
        public void ParameterAttributeDelete()
        {
            ...
            var edits = GetTopEdits(src1, src2);
            edits.VerifyEdits("Delete [[A]]@24", "Delete [A]@25");
        }
        ...
        public void ParameterAttributeUpdate()
        {
            ...
            var edits = GetTopEdits(src1, src2);
            edits.VerifyEdits("Update [A(1)]@25 -> [A(2)]@25", "Update [C]@31 -> [B]@31");
        }
        ...
        public void TypeTypeParameterAttributeInsert1()
        {
            ...
            edits.VerifyEdits("Insert [[A]]@8", "Insert [A]@9");
        ...
        public void TypeTypeParameterAttributeInsert2()
        {
            ...
            edits.VerifyEdits("Update [[A]]@8 -> [[A, B]]@8", "Insert [B]@12");
        ...
        public void TypeTypeParameterAttributeDelete()
        {
            ...
            edits.VerifyEdits("Delete [[A]]@8", "Delete [A]@9");
        ...
        public void TypeTypeParameterAttributeUpdate()
        {
            ...
            edits.VerifyEdits("Update [A(1)]@9 -> [A(2)]@9", "Update [C]@15 -> [B]@15");
        ...
        public void TypeConstraintInsert_Class()
        {
            ...
            edits.VerifyEdits("Insert [where T : class]@11");

            edits.VerifyRudeDiagnostics(
                Diagnostic(
                    RudeEditKind.Insert,
                    "where T : class",
                    FeaturesResources.type_constraint
                )
            );
        }
        ...
        public void TypeConstraintInsert_Unmanaged()
        {
            ...
            edits.VerifyEdits("Insert [where T : unmanaged]@11");
        ...
        public void TypeConstraintInsert_DoubleStatement_New()
        {
            ...
            edits.VerifyEdits("Insert [where S : new()]@13");
        ...
        public void TypeConstraintDelete_Class()
        {
            ...
            edits.VerifyEdits("Delete [where T : class]@13");
        ...
        public void TypeConstraintDelete_Unmanaged()
        {
            ...
            edits.VerifyEdits("Delete [where T : unmanaged]@13");
        ...
        public void TypeConstraintDelete_DoubleStatement_Unmanaged()
        {
            ...
            edits.VerifyEdits("Delete [where S : unmanaged]@13");
        ...
        public void TypeConstraintReorder_Unmanaged()
        {
            ...
            edits.VerifyEdits("Reorder [where T : unmanaged]@30 -> @13");
