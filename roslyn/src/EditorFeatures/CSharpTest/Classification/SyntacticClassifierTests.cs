...
partial interface T3
{
        ...
        private static readonly string[] s_contextualKeywordsOnlyValidInMethods = new string[]
        {
            "where",
            "from",
            "group",
        ...
        {
            await TestInMethodAsync(@"@""goo""u8", testHost, Verbatim(@"@""goo""u8"));
        }
...
on a new line ""U8"
        ...
        {
            await TestAsync(@"""goo""u8", testHost, String(@"""goo""u8"));
        }
        ...
        {
            await TestAsync(@"""""u8", testHost, String(@"""""u8"));
        }
