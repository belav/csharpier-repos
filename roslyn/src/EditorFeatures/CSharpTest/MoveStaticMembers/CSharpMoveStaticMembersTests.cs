    ...
    public class Class1
    {
        public static int TestField = 1;[||]
            ...
            await TestNoRefactoringAsync(
                    initialMarkup,
                    hostServices: FeaturesTestCompositions.Features.GetHostServices()
                )
                .ConfigureAwait(false);
        }
        ...
        private class Test : VerifyCS.Test
        {
            ...
            protected override Workspace CreateWorkspaceImpl()
            {
                ...
                var testOptionsService =
                    workspace.Services.GetService<IMoveStaticMembersOptionsService>()
                    as TestMoveStaticMembersService;
