...
namespace Microsoft.CodeAnalysis.Editor.CSharp.UnitTests.Intents
{
    public class IntentTestsBase
    {
        ...
        )
        {
            ...
            var results = await GetIntentsAsync(
                    workspace,
                    intentName,
                    currentDocumentText,
                    options,
        ...
        )
        {
            ...
            var currentDocument = currentTextBuffer.CurrentSnapshot
            ...
            var currentSnapshot = new SnapshotSpan(
                currentTextBuffer.CurrentSnapshot,
                new Span(0, currentTextBuffer.CurrentSnapshot.Length)
            );
