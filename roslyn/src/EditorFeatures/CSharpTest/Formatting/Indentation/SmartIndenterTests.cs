...
";
            ...
            AssertSmartIndent(code, indentationLine: 1, expectedIndentation: 4);
            AssertSmartIndent(code, indentationLine: 0, expectedIndentation: 0);
        }
...
#line hidden
        ...
        [
            WpfFact,
            WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/529876"),
            Trait(Traits.Feature, Traits.Features.SmartIndent),
...
#line hidden
        ...
        [
            WpfFact,
            WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/530948"),
            Trait(Traits.Feature, Traits.Features.SmartIndent)
        ]
                ...
                @"enum MyEnum
{
    e1,
        ...
        [
            WpfFact,
            WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/530796"),
            Trait(Traits.Feature, Traits.Features.SmartIndent)
        ]
...
";
        ...
        [
            WpfFact,
            WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/584599"),
            Trait(Traits.Feature, Traits.Features.SmartIndent)
        ]
...
class Program
{
    static void Main(string[] args)
    {
        ...
        [
            WpfFact,
            WorkItem("http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/912735"),
            Trait(Traits.Feature, Traits.Features.SmartIndent)
        ]
        ...
        )
        {
            ...
            foreach (var option in optionsSet)
            {
                ...
                editorOptions.SetOptionValue(
                    ...
                    indentStyle.ToEditorIndentStyle()
                );
        ...
        )
        {
            ...
            foreach (var option in optionsSet)
            {
                ...
                var line = wpfTextView
                    .TextBuffer.CurrentSnapshot.GetLineFromPosition(
