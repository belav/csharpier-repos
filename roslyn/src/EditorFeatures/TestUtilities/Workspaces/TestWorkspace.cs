...
namespace Microsoft.CodeAnalysis.Editor.UnitTests.Workspaces
{
    public partial class TestWorkspace : Workspace
    {
        ...
        private readonly Dictionary<string, ITextBuffer> _createdTextBuffers = new Dictionary<
            string,
            ITextBuffer
        >();
        ...
        ) : base(GetHostServices(exportProvider, composition), workspaceKind ?? WorkspaceKind.Host)
        {
            ...
            _metadataAsSourceFileService =
                ExportProvider.GetExportedValues<IMetadataAsSourceFileService>().FirstOrDefault();
        ...
        )
        {
            ...
            foreach (var spanNameToListMap in sortedAndNamedSpans)
            {
                ...
                var trackingSpan = documentWithSpan.GetTextBuffer()
        ...
        public void ChangeDocument(DocumentId documentId, SourceText text)
        {
            ...
            var newSolution = this.SetCurrentSolution(
                oldSolution.WithDocumentText(documentId, text)
            );
        ...
        )
        {
            ...
            return _createdTextBuffers.GetOrAdd(
                ...
                _ =>
                {
                    ...
                    var editorOptions =
                        ExportProvider.GetExportedValue<IEditorOptionsFactoryService>()
