...
#pragma warning restore IDE0060 // Remove unused parameter
        {
            ...
            workspace.SetOptions(
                workspace.Options.WithChangedOption(FormattingOptions2.UseTabs, Language, useTabs)
            );
            ...
            commandHandler.ExecuteCommand(
                new AutomaticLineEnderCommandArgs(view, buffer),
                nextHandler,
        ...
        private static void Test(
            ITextView view,
            ITextBuffer buffer,
            string expectedWithAnnotations,
            bool useTabs
        )
        {
