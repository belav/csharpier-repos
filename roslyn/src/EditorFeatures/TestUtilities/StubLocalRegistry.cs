...
{
    int ILocalRegistry.CreateInstance(
        Guid clsid,
        object punkOuter,
        ref Guid riid,
        uint dwFlags,
    ...
    int ILocalRegistry.GetClassObjectOfClsid(
        ref Guid clsid,
        uint dwFlags,
        IntPtr lpReserved,
        ref Guid riid,
    ...
    int ILocalRegistry2.CreateInstance(
        Guid clsid,
        object punkOuter,
        ref Guid riid,
        uint dwFlags,
    ...
    int ILocalRegistry2.GetClassObjectOfClsid(
        ref Guid clsid,
        uint dwFlags,
        IntPtr lpReserved,
        ref Guid riid,
    ...
    int ILocalRegistry3.CreateInstance(
        Guid clsid,
        object punkOuter,
        ref Guid riid,
        uint dwFlags,
    ...
    int ILocalRegistry3.GetClassObjectOfClsid(
        ref Guid clsid,
        uint dwFlags,
        IntPtr lpReserved,
        ref Guid riid,
    ...
    int ILocalRegistry3.CreateManagedInstance(
        string codeBase,
        string assemblyName,
        string typeName,
        ref Guid riid,
    ...
    int ILocalRegistry3.GetClassObjectOfManagedClass(
        string codeBase,
        string assemblyName,
        string typeName,
        ref Guid riid,
    ...
    int ILocalRegistry4.GetLocalRegistryRootEx(
        uint dwRegType,
    ...
    int ILocalRegistry5.CreateAggregatedManagedInstance(
        string codeBase,
        string AssemblyName,
        string TypeName,
        IntPtr pUnkOuter,
