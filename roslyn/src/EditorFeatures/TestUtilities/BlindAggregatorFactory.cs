...
namespace Microsoft.CodeAnalysis.Test.Utilities
{
    ...
    {
        public static unsafe IntPtr CreateWrapper() => (IntPtr)BlindAggregator.CreateInstance();

        public static unsafe void SetInnerObject(
        ...
        private struct BlindAggregator
        {
            ...
            private unsafe delegate int QueryInterfaceDelegateType(
            ...
            private unsafe delegate int GetGCHandlePtrDelegateType(
                BlindAggregator* pThis,
                out IntPtr pResult
            );
            ...
            private struct VTable
            {
                ...
                private static readonly unsafe QueryInterfaceDelegateType s_queryInterface =
                    BlindAggregator.QueryInterface;
                private static readonly unsafe AddRefDelegateType s_addRef = BlindAggregator.AddRef;
                private static readonly unsafe ReleaseDelegateType s_release =
                    BlindAggregator.Release;
                private static readonly unsafe GetGCHandlePtrDelegateType s_get_GCHandlePtr =
                    BlindAggregator.GetGCHandlePtr;
                ...
                private class CoTaskMemPtr
                {
                    ...
                    ~CoTaskMemPtr() => Marshal.FreeCoTaskMem(this.VTablePtr);
                }
                ...
                public static IntPtr AddressOfVTable
                {
                    get { return s_instance.VTablePtr; }
                }
            }
            ...
            private static readonly Guid s_IUnknownInterfaceGuid = new Guid(
                0x00000000,
                0x0000,
                0x0000,
                0xC0,
            ...
            private static readonly Guid s_IMarshalInterfaceGuid = new Guid(
                0x00000003,
                0x0000,
                0x0000,
                0xC0,
            ...
            private static readonly Guid s_IComWrapperGuid = new Guid(
                "CBD71F2C-6BC5-4932-B851-B93EB3151386"
            );
