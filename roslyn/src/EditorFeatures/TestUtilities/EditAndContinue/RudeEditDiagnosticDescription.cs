...
{
    internal readonly struct RudeEditDiagnosticDescription
        : IEquatable<RudeEditDiagnosticDescription>
    {
        ...
        public override string ToString() => ToString(tryGetResource: null);
