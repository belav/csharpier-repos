    ...
    public abstract partial class AbstractLanguageServerProtocolTests
    {
        ...
        private protected Task<TestLspServer> CreateTestLspServerAsync(
            ...
            CreateTestLspServerAsync(
                ...
                new InitializationOptions { ClientCapabilities = clientCapabilities }
            );
            ...
            var workspace = languageName switch
            {
                LanguageNames.CSharp
                    => TestWorkspace.CreateCSharp(
                        markups,
                        lspOptions.SourceGeneratedMarkups,
        ...
        )
        {
            ...
            workspace.TryApplyChanges(
                workspace.CurrentSolution.WithAnalyzerReferences(new[] { TestAnalyzerReferences })
            );
            ...
            public async ValueTask DisposeAsync()
            {
                ...
                if (!LanguageServer.HasShutdownStarted)
                {
                    await LanguageServer
                        .GetTestAccessor()
                        .ShutdownServerAsync("Disposing of test lsp server");
                }
