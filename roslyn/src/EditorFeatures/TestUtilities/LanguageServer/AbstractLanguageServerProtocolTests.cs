...
namespace Roslyn.Test.Utilities
{
    ...
    public abstract partial class AbstractLanguageServerProtocolTests
    {
        ...
        /// </summary>
        protected Task<TestLspServer> CreateTestLspServerAsync(
            string markup,
        ...
        protected Task<TestLspServer> CreateMultiProjectLspServerAsync(
            string xmlMarkup,
            LSP.ClientCapabilities? clientCapabilities = null
        ) =>
            CreateTestLspServerAsync(
                TestWorkspace.Create(xmlMarkup, composition: Composition),
                clientCapabilities,
        ...
        )
        {
            ...
            var workspaceConfigurationService =
                exportProvider.GetExportedValue<TestWorkspaceConfigurationService>();
            workspaceConfigurationService.Options = new WorkspaceConfigurationOptions(
        ...
        private static async Task<TestLspServer> CreateTestLspServerAsync(
        ...
        )
        {
            ...
            foreach (var document in workspace.Documents)
            {
                ...
                solution = solution.WithDocumentText(
                    document.Id,
                    SourceText.From(documentText.ToString(), System.Text.Encoding.UTF8)
                );
            }
        ...
        private static LSP.DidOpenTextDocumentParams CreateDidOpenTextDocumentParams(
            ...
            {
                TextDocument = new LSP.TextDocumentItem { Text = source, Uri = uri }
            };
        ...
        public sealed class TestLspServer : IDisposable
        {
            ...
            )
            {
                ...
                _languageServer = CreateLanguageServer(
                    serverStream,
                    serverStream,
                    TestWorkspace,
                    serverKind
            ...
            private static LanguageServerTarget CreateLanguageServer(
                Stream inputStream,
                Stream outputStream,
                TestWorkspace workspace,
                WellKnownLspServerKinds serverKind
            ...
            internal void InitializeDiagnostics(
                ...
                TestAnalyzerReferenceByLanguage references
            )
            {
                TestWorkspace.GlobalOptions.SetGlobalOption(
                    new OptionKey(
                ...
                TestWorkspace.TryApplyChanges(
                    TestWorkspace.CurrentSolution.WithAnalyzerReferences(new[] { references })
                );
                ...
                var diagnosticService = (DiagnosticService)
                    TestWorkspace.ExportProvider.GetExportedValue<IDiagnosticService>();
            ...
            internal async Task WaitForDiagnosticsAsync()
            {
                ...
                await listenerProvider
                    .GetWaiter(FeatureAttribute.SolutionCrawler)
                    .ExpeditedWaitAsync();
                await listenerProvider
            ...
            internal RequestExecutionQueue.TestAccessor GetQueueAccessor() =>
                _languageServer.GetTestAccessor().GetQueueAccessor();
            ...
            internal LanguageServerTarget.TestAccessor GetServerAccessor() =>
                _languageServer.GetTestAccessor();

            internal T GetRequiredLspService<T>() where T : class, ILspService =>
                _languageServer.GetTestAccessor().GetRequiredLspService<T>();

            internal ImmutableArray<SourceText> GetTrackedTexts() =>
                GetManager().GetTrackedLspText().Values.ToImmutableArray();
