...
namespace Roslyn.Test.Utilities
{
    ...
    public abstract partial class AbstractLanguageServerProtocolTests
    {
        ...
        protected async Task<TestLspServer> CreateXmlTestLspServerAsync(
            string xmlContent,
        ...
        public sealed class TestLspServer : IDisposable
        {
            ...
            internal RequestExecutionQueue.TestAccessor GetQueueAccessor() =>
                _executionQueue.GetTestAccessor();

            internal RequestDispatcher.TestAccessor GetDispatcherAccessor() =>
                _requestDispatcher.GetTestAccessor();

            internal LspWorkspaceManager.TestAccessor GetManagerAccessor() =>
                _executionQueue.GetTestAccessor().GetLspWorkspaceManager().GetTestAccessor();

            internal LspWorkspaceManager GetManager() =>
                _executionQueue.GetTestAccessor().GetLspWorkspaceManager();
