...
namespace Microsoft.CodeAnalysis.Editor.UnitTests
{
    ...
    internal class StubVsEditorAdaptersFactoryService : IVsEditorAdaptersFactoryService
    {
        ...
        public IVsTextBuffer CreateVsTextBufferAdapter(
            IServiceProvider serviceProvider,
            IContentType contentType
        ) => throw new NotImplementedException();

        public IVsTextBuffer CreateVsTextBufferAdapterForSecondaryBuffer(
            IServiceProvider serviceProvider,
        ...
        public IVsTextView CreateVsTextViewAdapter(
            IServiceProvider serviceProvider,
