...
namespace Microsoft.CodeAnalysis.Editor.UnitTests.Diagnostics
{
    ...
    internal class MockDiagnosticAnalyzerService : IDiagnosticAnalyzerService
    {
        private readonly ArrayBuilder<(
            ...
            DiagnosticKind KindFilter
        )> _diagnosticsWithKindFilter;
        ...
        public MockDiagnosticAnalyzerService(IGlobalOptionService globalOptions)
        {
            ...
            _diagnosticsWithKindFilter = ArrayBuilder<(
                DiagnosticData Diagnostic,
                DiagnosticKind KindFilter
            )>.GetInstance();
        }
        ...
        public Task<ImmutableArray<DiagnosticData>> GetDiagnosticsForSpanAsync(
            ...
            bool includeSuppressedDiagnostics = true,
            ...
            Task.FromResult(
                _diagnosticsWithKindFilter
                    .Where(d => diagnosticKind == d.KindFilter)
