...
{1}
        ...
        )
        {
            ...
            )
            {
                ...
                var item = completionList.ItemsList.FirstOrDefault(i =>
                    i.DisplayText == expectedItem
                );
                Assert.Equal(
                    expectedDescription,
                    (
        ...
        )
        {
            ...
            using (var workspace = CreateWorkspace(initialMarkup))
            {
                ...
                var item = completionList.ItemsList.First(i =>
                    i.DisplayText.StartsWith(textTypedSoFar)
                );
