...
namespace Microsoft.CodeAnalysis.Editor.UnitTests.Completion
{
        ...
        where TWorkspaceFixture : TestWorkspaceFixture, new()
    {
        ...
        protected virtual OptionSet WithChangedNonCompletionOptions(OptionSet options) => options;
        ...
        private CompletionOptions GetCompletionOptions()
        {
            ...
            if (TargetTypedCompletionFilterFeatureFlag.HasValue)
                ...
                {
                    TargetTypedCompletionFilter = TargetTypedCompletionFilterFeatureFlag.Value
                };
