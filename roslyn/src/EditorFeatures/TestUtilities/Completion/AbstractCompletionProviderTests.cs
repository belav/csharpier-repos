        ...
        where TWorkspaceFixture : TestWorkspaceFixture, new()
    {
        ...
        internal virtual CompletionServiceWithProviders GetCompletionService(Project project)
        {
            ...
            var completionProviders = (
                (IMefHostExportProvider)project.Solution.Workspace.Services.HostServices
            )
                .GetExports<CompletionProvider>();
                        ...
                        c =>
                            ...
                            && (
                                expectedDescriptionOrNull != null
                                    ? completionService.GetDescriptionAsync(document, c).Result.Text
        ...
        protected void SetExperimentOption(string experimentName, bool enabled)
        {
            var mockExperimentService =
                ExportProvider.GetExportedValue<TestExperimentationService>();
        ...
        )
        {
            if (sourceCodeKind.HasValue)
            {
                await VerifyAsync(
                    ...
                    expectedDescriptionOrNull: null,
                    sourceCodeKind: sourceCodeKind.Value,
        ...
        private static Document WithChangedOption(
            Document document,
            OptionKey optionKey,
            object value
        )
        ...
        )
        {
            ...
            var disallowAddingImports = options.GetOption(
        ...
        )
        {
            ...
            var firstItem = items.First(
                i => CompareItems(i.DisplayText + i.DisplayTextSuffix, itemToCommit)
            );
        ...
        protected Task VerifyItemWithMetadataReferenceAsync(
            string markup,
...
<Workspace>
    <Project Language=""{0}"" CommonReferences=""true"" AssemblyName=""Project1"">
        ...
        protected Task VerifyItemWithAliasedMetadataReferencesAsync(
            string markup,
...
<Workspace>
    <Project Language=""{0}"" CommonReferences=""true"" AssemblyName=""Project1"">
        ...
        protected Task VerifyItemWithProjectReferenceAsync(
            string markup,
            string referencedCode,
            string expectedItem,
            int expectedSymbols,
...
<Workspace>
    <Project Language=""{0}"" CommonReferences=""true"">
        ...
        protected Task VerifyItemWithMscorlib45Async(
            string markup,
            string expectedItem,
...
{1}
            ...
            return VerifyItemWithMscorlib45WorkerAsync(
                xmlString,
                expectedItem,
                expectedDescription
            );
        ...
        )
        {
            ...
            )
            {
                ...
                Assert.Equal(
                    expectedDescription,
                    (await completionService.GetDescriptionAsync(document, item)).Text
                );
            }
        }
        ...
        )
        {
            ...
            using (var workspace = CreateWorkspace(initialMarkup))
            {
                ...
                {
                    Assert.True(
                        CommitManager.IsCommitCharacter(service.GetRules(), item, ch),
        ...
        protected async Task<
            ImmutableArray<RoslynCompletion.CompletionItem>
