...
namespace Microsoft.CodeAnalysis.Test.Utilities.Completion
{
        ...
        where TWorkspaceFixture : TestWorkspaceFixture, new()
    {
        ...
        protected abstract (SyntaxNode argumentList, ImmutableArray<SyntaxNode> arguments) GetArgumentList(
            SyntaxToken token
        );
        ...
        )
        {
            ...
            var parameter = GetParameterSymbolInfo(
                workspace,
                semanticModel,
                root,
                position,
        ...
        private IParameterSymbol GetParameterSymbolInfo(
            Workspace workspace,
        ...
        )
        {
            ...
            var symbols = semanticModel
                .GetSymbolInfo(argumentList.GetRequiredParent(), cancellationToken)
                .GetAllSymbols();
            ...
            Contract.ThrowIfTrue(
                ...
                "Named arguments are not currently supported by this test."
            );
            Contract.ThrowIfTrue(
                parameters.Any(parameter => parameter.IsParams),
                "'params' parameters are not currently supported by this test."
            );
