...
namespace Microsoft.CodeAnalysis.Editor.UnitTests.DocumentationComments
{
    ...
    public abstract class AbstractDocumentationCommentTests
    {
        ...
        internal void VerifyTypingCharacter(
        ...
        internal void VerifyPressingEnter(
            string initialMarkup,
            string expectedMarkup,
            bool useTabs = false,
            string newLine = "\r\n",
        ...
        internal void VerifyInsertCommentCommand(
            string initialMarkup,
            string expectedMarkup,
            bool useTabs = false,
            string newLine = "\r\n",
        ...
        internal void VerifyOpenLineAbove(
            string initialMarkup,
            string expectedMarkup,
            bool useTabs = false,
            string newLine = "\r\n",
        ...
        internal void VerifyOpenLineBelow(
            string initialMarkup,
            string expectedMarkup,
            bool useTabs = false,
            string newLine = "\r\n",
