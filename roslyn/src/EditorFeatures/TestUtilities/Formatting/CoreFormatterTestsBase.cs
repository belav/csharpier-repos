...
namespace Microsoft.CodeAnalysis.Editor.UnitTests.Formatting
{
    public abstract class CoreFormatterTestsBase
    {
        ...
        protected CoreFormatterTestsBase(ITestOutputHelper output) => this._output = output;
        ...
        internal static void AssertFormat(
            Workspace workspace,
            string expected,
            OptionSet optionSet,
            IEnumerable<AbstractFormattingRule> rules,
        ...
        )
        {
            ...
            var rules = formattingRuleProvider
                .CreateRule(workspace.CurrentSolution.GetDocument(syntaxTree), 0)
