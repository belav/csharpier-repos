...
namespace Microsoft.CodeAnalysis.Editor.UnitTests
{
    ...
    {
        public static readonly TestComposition Editor = TestComposition.Empty.AddAssemblies(
        ...
        ).AddParts(typeof(TestSerializerService.Factory), typeof(TestExportJoinableTaskContext), typeof(StubStreamingFindUsagesPresenter), // actual implementation is in VS layer
        ...
        public static readonly TestComposition EditorFeatures = FeaturesTestCompositions.Features
            ...
            .AddParts(typeof(TestWaitIndicator));

        public static readonly TestComposition EditorFeaturesWpf = EditorFeatures.AddAssemblies(
            typeof(EditorFeaturesWpfResources).Assembly
        );

        public static readonly TestComposition InteractiveWindow = EditorFeaturesWpf.AddAssemblies(
        ...
        public static readonly TestComposition LanguageServerProtocolWpf =
            EditorFeaturesWpf.AddAssemblies(LanguageServerProtocol.Assemblies);
    }
}
