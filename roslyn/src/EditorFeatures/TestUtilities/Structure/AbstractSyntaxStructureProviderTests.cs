...
namespace Microsoft.CodeAnalysis.Editor.UnitTests.Structure
{
    ...
    public abstract class AbstractSyntaxStructureProviderTests
    {
        ...
        protected static RegionData Region(
            string textSpanName,
            string hintSpanName,
            string primaryTextSpanName,
            string primaryHintSpanName,
            string bannerText,
            bool autoCollapse,
        ...
        protected static RegionData Region(
            ...
            new RegionData(
                textSpanName,
                hintSpanName,
                primaryTextSpanName: null,
                primaryHintSpanName: null,
                bannerText,
                autoCollapse,
                isDefaultCollapsed
            );
        ...
        )
        {
            ...
            TextSpan? primaryTextSpan = null,
                primaryHintSpan = null;
            if (primaryTextSpanName != null || primaryHintSpanName != null)
            {
                ...
                Assert.True(
                    spans.ContainsKey(primaryTextSpanName)
                        && spans[primaryTextSpanName].Length == 1,
                    $"Test did not specify '{primaryTextSpanName}' span."
                );
                Assert.True(
                    spans.ContainsKey(primaryHintSpanName)
                        && spans[primaryHintSpanName].Length == 1,
                    $"Test did not specify '{primaryHintSpanName}' span."
                );
