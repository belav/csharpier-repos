...
namespace Microsoft.CodeAnalysis.Editor.UnitTests.Structure
{
        ...
        where TSyntaxNode : SyntaxNode
    {
        ...
        )
        {
            ...
            var previousToken = root.DescendantNodesAndTokens(descendIntoTrivia: true)
                .TakeWhile(nodeOrToken => nodeOrToken != node)
                .LastOrDefault(nodeOrToken => nodeOrToken.IsToken)
                .AsToken();
