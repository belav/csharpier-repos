...
namespace Microsoft.CodeAnalysis.Editor.UnitTests.QuickInfo
{
    ...
    public abstract class AbstractSemanticQuickInfoSourceTests
    {
        ...
        protected static Tuple<string, string>[] NoClassifications() => null;
...
#pragma warning restore IDE0060 // Remove unused parameter
        ...
        )
        {
            return item =>
                AssertSection(
                    expectedText,
                    item.Sections,
                    QuickInfoSectionKinds.ValueDocumentationComments,
                    expectedClassifications
                );
        }
        ...
        )
        {
            return item =>
                AssertSection(
                    expectedText,
                    item.Sections,
                    QuickInfoSectionKinds.AnonymousTypes,
                    expectedClassifications
                );
        }
        ...
        protected static Action<QuickInfoItem> NoTypeParameterMap =>
            item =>
                AssertSection(string.Empty, item.Sections, QuickInfoSectionKinds.TypeParameters);
