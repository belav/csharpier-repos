...
namespace Microsoft.CodeAnalysis.Editor.UnitTests.Classification
{
    public class FormattedClassification
    {
        private static readonly ImmutableDictionary<
            string,
            string
        > s_classificationPrefixToTestHelperMap = ImmutableDictionary<string, string>.Empty
            .Add("regex - ", "Regex.")
            .Add("json - ", "Json.")
        ...
        public override string ToString()
        {
            ...
            switch (ClassificationName)
            {
                ...
                default:
                    ...
                    {
                        trimmedClassification = trimmedClassification.Substring(
                            0,
                            trimmedClassification.Length - " name".Length
                        );
                    }
