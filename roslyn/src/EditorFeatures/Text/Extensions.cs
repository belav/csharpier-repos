...
namespace Microsoft.CodeAnalysis.Text
{
    public static partial class Extensions
    {
        ...
        public static ITextBuffer GetTextBuffer(this SourceTextContainer textContainer) =>
            TryGetTextBuffer(textContainer)
            ?? throw new ArgumentException(
                TextEditorResources.textContainer_is_not_a_SourceTextContainer_that_was_created_from_an_ITextBuffer,
        ...
        internal static TextDocument? GetOpenTextDocumentInCurrentContextWithChanges(
            this ITextSnapshot text
