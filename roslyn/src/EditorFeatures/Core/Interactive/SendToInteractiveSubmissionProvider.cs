...
namespace Microsoft.CodeAnalysis.Interactive
{
    ...
    /// to a syntax node.
    /// </summary>
    internal abstract class AbstractSendToInteractiveSubmissionProvider
        : ISendToInteractiveSubmissionProvider
    {
        ...
        protected abstract IEnumerable<TextSpan> GetExecutableSyntaxTreeNodeSelection(
        ...
        string ISendToInteractiveSubmissionProvider.GetSelectedText(
        ...
        private Task<IEnumerable<SnapshotSpan>> GetExpandedLineAsync(
            IEditorOptions editorOptions,
            EditorCommandArgs args,
            CancellationToken cancellationToken
        )
        ...
        private async Task<IEnumerable<SnapshotSpan>> ExpandSelectionAsync(
