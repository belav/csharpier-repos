...
namespace Microsoft.CodeAnalysis.Remote
{
    internal sealed class RemoteHostOptions
    {
        ...
        public static readonly Option2<bool> OOP64Bit =
            new("InternalFeatureOnOffOptions_OOP64Bit", defaultValue: true);

        public static readonly Option2<bool> OOPServerGCFeatureFlag =
            new("InternalFeatureOnOffOptions_OOPServerGCFeatureFlag", defaultValue: false);

        // use coreclr host for OOP
        public static readonly Option2<bool> OOPCoreClrFeatureFlag =
            new("InternalFeatureOnOffOptions_OOPCoreClrFeatureFlag", defaultValue: false);
    }
}
