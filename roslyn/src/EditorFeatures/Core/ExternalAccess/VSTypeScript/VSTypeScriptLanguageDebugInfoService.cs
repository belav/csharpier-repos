...
namespace Microsoft.CodeAnalysis.ExternalAccess.VSTypeScript
{
    ...
    internal sealed class VSTypeScriptLanguageDebugInfoService : ILanguageDebugInfoService
    {
        ...
        public VSTypeScriptLanguageDebugInfoService(
        ...
        public async Task<DebugDataTipInfo> GetDataTipInfoAsync(
            ...
            (
                await _implementation.GetDataTipInfoAsync(document, position, cancellationToken)
        ...
        public async Task<DebugLocationInfo> GetLocationInfoAsync(
            ...
            (
                await _implementation.GetLocationInfoAsync(document, position, cancellationToken)
                    .ConfigureAwait(false)
            ).UnderlyingObject;
    }
}
