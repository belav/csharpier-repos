...
namespace Microsoft.CodeAnalysis.ExternalAccess.VSTypeScript
{
    ...
    internal sealed class VSTypeScriptFindUsagesService(
        IVSTypeScriptFindUsagesService underlyingService
    ) : IFindUsagesService
    {
        ...
        private sealed class ProgressTracker(IStreamingProgressTracker progressTracker)
