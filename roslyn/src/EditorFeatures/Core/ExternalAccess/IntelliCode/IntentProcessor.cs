...
namespace Microsoft.CodeAnalysis.ExternalAccess.IntelliCode
{
    ...
    ) : IIntentSourceProvider
    {
        ...
        {
            var currentDocument = intentRequestContext.CurrentSnapshotSpan
                .Snapshot
        ...
        )
        {
            ...
            using var _ = PooledDictionary<DocumentId, ImmutableArray<TextChange>>.GetInstance(
                out var results
            );
        ...
        )
        {
            ...
            var textDiffService = changedSolution.Services
