...
namespace Microsoft.CodeAnalysis.Diagnostics
{
    ...
    internal sealed partial class DiagnosticsClassificationTaggerProvider
        : AbstractPushOrPullDiagnosticsTaggerProvider<ClassificationTag>
    {
        ...
        protected sealed override ImmutableArray<IOption2> Options { get; } =
            ImmutableArray.Create<IOption2>(InternalFeatureOnOffOptions.Classification);
        ...
        protected sealed override bool IsEnabled =>
            !_editorOptionsService.Factory.GlobalOptions.GetOptionValue(
        ...
        protected sealed override bool IncludeDiagnostic(DiagnosticData data)
        {
            ...
            if (
                IDEDiagnosticIdToOptionMappingHelper.TryGetMappedFadingOption(
                    data.Id,
                    out var fadingOption
                )
            )
            {
        ...
        protected sealed override ITagSpan<ClassificationTag> CreateTagSpan(
            Workspace workspace,
            bool isLiveUpdate,
            SnapshotSpan span,
            DiagnosticData data
        ...
        protected sealed override ImmutableArray<DiagnosticDataLocation> GetLocationsToTag(
