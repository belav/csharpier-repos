...
namespace Microsoft.CodeAnalysis.Classification
{
    internal static class ClassificationUtilities
    {
        ...
        )
        {
            ...
            // Don't block getting classifications on building the full compilation.  This may take a
            // significant amount
            // of time and can cause a very latency sensitive operation (copying) to block the user while we
            // wait on this
            // work to happen.
            //
            // It's also a better experience to get classifications to the user faster versus waiting a
            // potentially
            // large amount of time waiting for all the compilation information to be built.  For example, we
            // can
            // classify types that we've parsed in other files, or partially loaded from metadata, even if we're
            // still
            // parsing/loading.  For cross language projects, this also produces semantic classifications more
            // quickly
