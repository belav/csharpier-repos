...
#pragma warning restore CA2007 // Consider calling ConfigureAwait on the awaited task
                ...
                var suppressDiagnosticsSpans = suppressDiagnosticsNodes.Select(n => n.Span.ToSpan())
                    .ToList();
...
#pragma warning restore CA2007 // Consider calling ConfigureAwait on the awaited task
        ...
        )
        {
            ...
            var oldText = oldDocument.GetTextAsync(cancellationToken)
                .WaitAndGetResult(cancellationToken);
            var newText = newDocument.GetTextAsync(cancellationToken)
                .WaitAndGetResult(cancellationToken);
