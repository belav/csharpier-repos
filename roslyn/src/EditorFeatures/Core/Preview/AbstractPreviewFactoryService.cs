...
namespace Microsoft.CodeAnalysis.Editor.Implementation.Preview
{
        ...
        where TDifferenceViewer : IDifferenceViewer
    {
        ...
        public SolutionPreviewResult? GetSolutionPreviews(
        ...
        )
        {
            ...
            if (newSolution != null)
            {
                ...
                foreach (var projectChanges in solutionChanges.GetProjectChanges())
                {
                    ...
                    foreach (
                        var documentId in projectChanges.GetChangedDocuments(
                ...
                foreach (
                    var projectChanges in solutionChanges
                        .GetProjectChanges()
                ...
                changeSummary = new SolutionChangeSummary(
                    oldSolution,
                    newSolution,
                    solutionChanges
                );
        ...
        {
            var oldProjectReferences = projectChanges.OldProject.ProjectReferences.ToDictionary(r =>
                r.ProjectId
            );
            var newProjectReferences = projectChanges.NewProject.ProjectReferences.ToDictionary(r =>
                r.ProjectId
            );
        ...
        public Task<
            IDifferenceViewerPreview<TDifferenceViewer>
        > CreateAddedDocumentPreviewViewAsync(
            Document document,
            CancellationToken cancellationToken
        ...
        private async ValueTask<
            IDifferenceViewerPreview<TDifferenceViewer>
        > CreateAddedDocumentPreviewViewCoreAsync(
...
#pragma warning restore CA2007 // Consider calling ConfigureAwait on the awaited task
        ...
        private async Task<
            IDifferenceViewerPreview<TDifferenceViewer>
        > CreateAddedTextDocumentPreviewViewAsync<TDocument>(
            TDocument document,
            double zoomLevel,
...
#pragma warning restore CA2007 // Consider calling ConfigureAwait on the awaited task
        ...
        )
        {
            return CreateAddedTextDocumentPreviewViewAsync(
                document,
                zoomLevel,
                createBufferAsync: (textDocument, cancellationToken) =>
                    CreateNewBufferAsync(textDocument, cancellationToken),
                cancellationToken
            );
        }
        ...
        public Task<
            IDifferenceViewerPreview<TDifferenceViewer>
        > CreateAddedAdditionalDocumentPreviewViewAsync(
            TextDocument document,
            double zoomLevel,
            CancellationToken cancellationToken
        )
        ...
        public Task<
            IDifferenceViewerPreview<TDifferenceViewer>
        > CreateAddedAnalyzerConfigDocumentPreviewViewAsync(
            TextDocument document,
            double zoomLevel,
            CancellationToken cancellationToken
        )
        ...
        private async ValueTask<
            IDifferenceViewerPreview<TDifferenceViewer>
        > CreateRemovedDocumentPreviewViewCoreAsync(
...
#pragma warning restore CA2007 // Consider calling ConfigureAwait on the awaited task
        ...
        private async Task<
            IDifferenceViewerPreview<TDifferenceViewer>
        > CreateRemovedTextDocumentPreviewViewAsync<TDocument>(
            TDocument document,
            double zoomLevel,
            Func<TDocument, CancellationToken, ValueTask<ITextBuffer>> createBufferAsync,
            CancellationToken cancellationToken
...
#pragma warning restore CA2007 // Consider calling ConfigureAwait on the awaited task
        ...
        public Task<
            IDifferenceViewerPreview<TDifferenceViewer>
        > CreateRemovedAdditionalDocumentPreviewViewAsync(
            TextDocument document,
            double zoomLevel,
            CancellationToken cancellationToken
        )
        ...
        public Task<
            IDifferenceViewerPreview<TDifferenceViewer>
        > CreateRemovedAnalyzerConfigDocumentPreviewViewAsync(
            TextDocument document,
            double zoomLevel,
            CancellationToken cancellationToken
        )
        ...
        public Task<IDifferenceViewerPreview<TDifferenceViewer>?> CreateChangedDocumentPreviewViewAsync(
        ...
        public async Task<IDifferenceViewerPreview<TDifferenceViewer>?> CreateChangedDocumentPreviewViewAsync(
            Document oldDocument,
            Document newDocument,
            double zoomLevel,
            CancellationToken cancellationToken
...
#pragma warning restore CA2007 // Consider calling ConfigureAwait on the awaited task
                ...
                var conflictDescriptions = conflictNodes
                    .SelectMany(n => n.GetAnnotations(ConflictAnnotation.Kind))
                ...
                var warningDescriptions = warningNodes
                    .SelectMany(n => n.GetAnnotations(WarningAnnotation.Kind))
                    .Select(a => $"⚠ {WarningAnnotation.GetDescription(a)}")
                    .Distinct();

                var suppressDiagnosticsNodes = newRoot.GetAnnotatedNodesAndTokens(
                    SuppressDiagnosticsAnnotation.Kind
                );
                var suppressDiagnosticsSpans = suppressDiagnosticsNodes
                    .Select(n => n.Span.ToSpan())
                    .ToList();
                AttachAnnotationsToBuffer(
                    newBuffer,
                    conflictSpans,
                    warningSpans,
            ...
            var originalLineSpans = CreateLineSpans(
                oldBuffer.CurrentSnapshot,
                originalSpans,
                cancellationToken
            );
            var changedLineSpans = CreateLineSpans(
                newBuffer.CurrentSnapshot,
                allSpans,
                cancellationToken
            );
...
#pragma warning restore CA2007 // Consider calling ConfigureAwait on the awaited task
        ...
        )
        {
            Debug.Assert(
                oldDocument.Kind
                    is TextDocumentKind.AdditionalDocument
                        or TextDocumentKind.AnalyzerConfigDocument
            );
...
#pragma warning restore CA2007 // Consider calling ConfigureAwait on the awaited task
        ...
        public Task<IDifferenceViewerPreview<TDifferenceViewer>?> CreateChangedAdditionalDocumentPreviewViewAsync(
            TextDocument oldDocument,
            TextDocument newDocument,
            double zoomLevel,
            CancellationToken cancellationToken
        ...
        public Task<IDifferenceViewerPreview<TDifferenceViewer>?> CreateChangedAnalyzerConfigDocumentPreviewViewAsync(
            TextDocument oldDocument,
            TextDocument newDocument,
            double zoomLevel,
            CancellationToken cancellationToken
        ...
        private async ValueTask<IDifferenceViewerPreview<TDifferenceViewer>?> CreateChangedDocumentViewAsync(
            ITextBuffer oldBuffer,
            ITextBuffer newBuffer,
            string? description,
            List<LineSpan> originalSpans,
            List<LineSpan> changedSpans,
            PreviewWorkspace leftWorkspace,
        ...
        )
        {
            ...
            var originalBuffer =
                _projectionBufferFactoryService.CreateProjectionBufferWithoutIndentation(
...
#pragma warning restore CA2007 // Consider calling ConfigureAwait on the awaited task
        ...
        private async ValueTask<ITextBuffer> CreateTextBufferCoreAsync(
            TextDocument document,
...
#pragma warning restore CA2007 // Consider calling ConfigureAwait on the awaited task
        ...
        protected abstract IDifferenceViewerPreview<TDifferenceViewer> CreateDifferenceViewerPreview(
            TDifferenceViewer viewer
        );
        protected abstract Task<TDifferenceViewer> CreateDifferenceViewAsync(
        ...
        private async ValueTask<
            IDifferenceViewerPreview<TDifferenceViewer>
        > CreateNewDifferenceViewerAsync(
            PreviewWorkspace? leftWorkspace,
            PreviewWorkspace? rightWorkspace,
        ...
        )
        {
            ...
            var mode =
                leftWorkspace == null ? DifferenceViewMode.RightViewOnly
        ...
        private static List<LineSpan> CreateLineSpans(
        ...
        // user.
        private static LineSpan GetLineSpan(ITextSnapshot snapshot, Span span)
        {
        ...
        private IHierarchicalDifferenceCollection ComputeEditDifferences(
            TextDocument oldDocument,
            TextDocument newDocument,
            CancellationToken cancellationToken
        )
        {
            ...
            var diffService = _differenceSelectorService.GetTextDifferencingService(
                oldDocument
                    .Project.Services.GetRequiredService<IContentTypeLanguageService>()
