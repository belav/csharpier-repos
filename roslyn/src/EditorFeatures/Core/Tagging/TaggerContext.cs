...
namespace Microsoft.CodeAnalysis.Editor.Tagging
{
        ...
        where TTag : ITag
    {
        ...
        /// produce tags.  In order to be passed this value, <see
        ...
        /// to <see cref="AbstractAsynchronousTaggerProvider{TTag}.ProduceTagsAsync(TaggerContext{TTag},
        // CancellationToken)"/>.  Note: state will
        ...
        /// <summary>
        /// Used to allow taggers to indicate what spans were actually tagged.  This is useful when the
        // tagger decides
        /// to tag a different span than the entire file.  If a sub-span of a document is tagged then the
        // tagger
        /// infrastructure will keep previously computed tags from before and after the sub-span and merge
        // them with the
        /// newly produced tags.
        /// </summary>
