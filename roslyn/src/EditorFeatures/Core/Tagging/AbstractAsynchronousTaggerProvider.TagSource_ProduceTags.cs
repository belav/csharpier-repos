...
namespace Microsoft.CodeAnalysis.Editor.Tagging
{
    internal partial class AbstractAsynchronousTaggerProvider<TTag>
    {
        private partial class TagSource
        {
            ...
            private void EnqueueWork(bool highPriority) => _eventChangeQueue.AddWork(highPriority);
            ...
            {
                await _dataSource.ThreadingContext.JoinableTaskFactory.SwitchToMainThreadAsync(
                    cancellationToken
                );
            ...
            private bool ShouldSkipTagProduction()
            {
                ...
                return _dataSource.PerLanguageOptions.Any(
                    option =>
                        languageName == null
