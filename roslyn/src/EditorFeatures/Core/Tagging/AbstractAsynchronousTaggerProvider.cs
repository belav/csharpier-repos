...
namespace Microsoft.CodeAnalysis.Editor.Tagging
{
        ...
        where TTag : ITag
    {
        ...
        protected EfficientTagger<TTag>? CreateEfficientTagger(
            ITextView? textView,
        ...
        public bool SpanEquals(
            ITextSnapshot snapshot1,
            TextSpan? span1,
            ITextSnapshot snapshot2,
            TextSpan? span2
        ...
        public bool SpanEquals(
            ...
            SpanEquals(
                span1 is null ? null : new SnapshotSpan(snapshot1, span1.Value),
                span2 is null ? null : new SnapshotSpan(snapshot2, span2.Value)
            );
        ...
        )
        {
            ...
            public readonly NormalizedSnapshotSpanCollection Removed =
                removed ?? NormalizedSnapshotSpanCollection.Empty;
