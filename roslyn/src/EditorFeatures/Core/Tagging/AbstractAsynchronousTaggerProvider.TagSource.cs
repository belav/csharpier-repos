        ...
        private sealed partial class TagSource
        {
            ...
            )
            {
                ...
                void Connect()
                {
                    ...
                    _visibilityTracker?.RegisterForVisibilityChanges(
                        subjectBuffer,
            ...
            private void Dispose()
            {
                ...
                void Disconnect()
                {
                    ...
                    _visibilityTracker?.UnregisterForVisibilityChanges(
                        _subjectBuffer,
                        _onVisibilityChanged
                    );
                }
            ...
            private ITaggerEventSource CreateEventSource()
            {
                Contract.ThrowIfTrue(
                    _dataSource.Options.Any(
                        o => o is not Option2<bool> and not PerLanguageOption2<bool>
                    ),
