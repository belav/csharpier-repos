    ...
    internal partial class BraceCompletionSessionProvider
    {
        ...
        private class BraceCompletionSession : IBraceCompletionSession
        {
            ...
            private bool TryStart(CancellationToken cancellationToken)
            {
                ...
                if (
                    !_service
                        .HasBraceCompletionAsync(context, document, cancellationToken)
                ...
                if (TryGetBraceCompletionContext(out var contextAfterStart, cancellationToken))
                {
                    var indentationOptions = SubjectBuffer.GetIndentationOptions(
                        ...
                        contextAfterStart.Document.LanguageServices,
                        explicitFormat: false
                    );
                    var changesAfterStart = _service.GetTextChangesAfterCompletion(
                        contextAfterStart,
                        indentationOptions,
                        cancellationToken
                    );
            ...
            public void PostReturn()
            {
                ...
                if (this.GetCaretPosition().HasValue)
                {
                    ...
                    )
                    {
                        ...
                        var changesAfterReturn = _service.GetTextChangeAfterReturn(
                            context,
                            indentationOptions,
            ...
            private bool TryGetBraceCompletionContext(
                out BraceCompletionContext context,
            ...
            )
            {
                ...
                context = GetBraceCompletionContext(
                    ParsedDocument.CreateSynchronously(document, cancellationToken)
                );
                return true;
            }
