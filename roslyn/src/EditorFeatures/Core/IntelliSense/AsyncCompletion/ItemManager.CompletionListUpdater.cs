    ...
    internal partial class ItemManager
    {
        ...
        private sealed class CompletionListUpdater
        {
            ...
            )
            {
                ...
                if (
                    selectedItem.Rules.MatchPriority >= MatchPriority.Preselect
                ...
                AsyncCompletionLogger.LogGetDefaultsMatchTicksDataPoint(
            ...
            private sealed class FilterStateHelper
            {
                ...
                public FilterStateHelper(ImmutableArray<CompletionFilterWithState> filtersWithState)
                {
                    ...
                    _nonExpanderFilterStates = filtersWithState.WhereAsArray(
                        f => f.Filter is not CompletionExpander
                    );
