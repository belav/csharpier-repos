    ...
    internal sealed class CompletionSource : IAsyncExpandingCompletionSource
    {
        ...
        )
        {
            ...
            try
            {
                ...
                var document = triggerLocation.Snapshot
        ...
        )
        {
            ...
            )
            {
                ...
                if (sessionData.CombinedSortedList is null)
                {
                    ...
                    var document = initialTriggerLocation.Snapshot
                        .GetOpenDocumentInCurrentContextWithChanges();
                    if (document != null)
                    {
        ...
        )
        {
            ...
            var suggestionItemOptions = new AsyncCompletionData.SuggestionItemOptions(
                ...
                completionList.SuggestionModeItem
                    .TryGetProperty(CommonCompletionItem.DescriptionProperty, out var description)
                    ? description
                    : string.Empty
            );
        ...
        )
        {
            ...
            session.Properties[ExcludedCommitCharacters] = excludedCommitCharactersMap.Keys
                .ToImmutableArray();
        ...
        )
        {
            ...
            var completionOptions = _editorOptionsService.GlobalOptions
                .GetCompletionOptions(document.Project.Language);
            var displayOptions = _editorOptionsService.GlobalOptions
        ...
        /// </summary>
        private static MultiDictionary<char, RoslynCompletionItem> GetExcludedCommitCharacters(
