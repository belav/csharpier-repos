...
namespace Microsoft.CodeAnalysis.Editor.EditorConfigSettings.DataProvider.CodeStyle
{
        ...
        : SettingsProviderBase<CodeStyleSetting, OptionUpdater, IOption2, object>
    {
        ...
        )
        {
            ...
            {
                EditorFeaturesResources.Always_for_clarity,
                EditorFeaturesResources.Never_if_unnecessary
            };
            yield return CodeStyleSetting.Create(
        ...
        )
        {
            yield return CodeStyleSetting.Create(
                ...
                new[]
                {
                    EditorFeaturesResources.Non_public_methods,
                    EditorFeaturesResources.All_methods
                },
                editorConfigOptions: options,
                visualStudioOptions: visualStudioOptions,
                updater: updater
