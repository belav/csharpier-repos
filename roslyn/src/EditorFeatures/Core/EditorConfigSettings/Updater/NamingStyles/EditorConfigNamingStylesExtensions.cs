...
namespace Microsoft.CodeAnalysis.Editor.EditorConfigSettings.Updater
{
    internal static class EditorConfigNamingStylesExtensions
    {
        ...
        public static ImmutableArray<(NamingStyleOption namingStyleOption, NamingStyleSetting namingStyleSetting)> AsNamingStyleSettings(
            this ImmutableArray<NamingStyleOption> namingStyleOptions
        ) =>
            namingStyleOptions.SelectAsArray(
                rule => (rule, NamingStyleSetting.FromParseResult(rule))
            );
