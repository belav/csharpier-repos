...
namespace Microsoft.CodeAnalysis.Editor.Shared.Extensions
{
    ...
    {
        public static SnapshotSpan? MapUpOrDownToFirstMatch(
        ...
        public static SnapshotSpan? MapUpOrDownToBuffer(
            this IBufferGraph bufferGraph,
            SnapshotSpan span,
        ...
        )
        {
            ...
            switch (direction)
            {
                ...
                {
                    var spans = bufferGraph.MapDownToBuffer(
                        span,
                        SpanTrackingMode.EdgeExclusive,
                        targetBuffer
                    );
                ...
                {
                    var spans = bufferGraph.MapUpToBuffer(
                        span,
                        SpanTrackingMode.EdgeExclusive,
                        targetBuffer
                    );
        ...
        public static SnapshotPoint? MapUpOrDownToBuffer(
            this IBufferGraph bufferGraph,
            SnapshotPoint point,
            ITextBuffer targetBuffer
        )
        {
            ...
            switch (direction)
            {
                ...
                case BufferMapDirection.Down:
                {
                    ...
                    try
                    {
                        return bufferGraph.MapDownToInsertionPoint(
                            ...
                            s => s == targetBuffer.CurrentSnapshot
                        );
                    }
                ...
                case BufferMapDirection.Up:
                {
                    return bufferGraph.MapUpToBuffer(
                        point,
                        PointTrackingMode.Positive,
        ...
        private static bool IsSourceBuffer(IProjectionBufferBase top, ITextBuffer bottom)
        {
            return top.SourceBuffers.Contains(bottom)
                || top
                    .SourceBuffers.OfType<IProjectionBufferBase>()
