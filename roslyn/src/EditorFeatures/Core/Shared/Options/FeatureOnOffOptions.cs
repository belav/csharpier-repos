    ...
    internal sealed class FeatureOnOffOptions
    {
        ...
        public static readonly PerLanguageOption2<bool> StringIdentation =
            new(
                ...
                defaultValue: true,
                storageLocation: new RoamingProfileStorageLocation(
                    "TextEditor.%LANGUAGE%.Specific.StringIdentation"
                )
            );
        ...
        public static readonly PerLanguageOption2<bool> RenameTracking =
            new(FeatureName, "RenameTracking", defaultValue: true);
        ...
        public static readonly PerLanguageOption2<bool> RefactoringVerification =
            new(FeatureName, "RefactoringVerification", defaultValue: false);

        public static readonly Option2<bool> NavigateAsynchronously =
            new(
                FeatureName,
                "NavigateAsynchronously",
                defaultValue: true,
                storageLocation: new RoamingProfileStorageLocation(
                    "TextEditor.NavigateAsynchronously"
                )
            );
        ...
        public static readonly PerLanguageOption2<bool> AddImportsOnPaste =
            new(
                ...
                defaultValue: true,
                storageLocation: new RoamingProfileStorageLocation(
                    "TextEditor.%LANGUAGE%.Specific.AddImportsOnPaste2"
                )
            );
        ...
        public static readonly PerLanguageOption2<bool?> ShowInheritanceMargin =
            new(
                ...
                new RoamingProfileStorageLocation(
                    "TextEditor.%LANGUAGE%.Specific.ShowInheritanceMargin"
                )
            );
        ...
        public static readonly Option2<bool> InheritanceMarginCombinedWithIndicatorMargin =
            new(
                ...
                defaultValue: false,
                new RoamingProfileStorageLocation(
                    "TextEditor.InheritanceMarginCombinedWithIndicatorMargin"
                )
            );
        ...
        public static readonly PerLanguageOption2<bool> InheritanceMarginIncludeGlobalImports =
            new(
                FeatureName,
                "InheritanceMarginIncludeGlobalImports",
                defaultValue: true,
                new RoamingProfileStorageLocation(
                    "TextEditor.%LANGUAGE%.Specific.InheritanceMarginIncludeGlobalImports"
                )
            );
        ...
        public static readonly PerLanguageOption2<bool> AutomaticallyFixStringContentsOnPaste =
            new(
                FeatureName,
                "AutomaticallyFixStringContentsOnPaste",
                defaultValue: true,
                storageLocation: new RoamingProfileStorageLocation(
                    "TextEditor.%LANGUAGE%.AutomaticallyFixStringContentsOnPaste"
                )
            );
