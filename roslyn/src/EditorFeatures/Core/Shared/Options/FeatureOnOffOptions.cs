...
namespace Microsoft.CodeAnalysis.Editor.Shared.Options
{
    internal sealed class FeatureOnOffOptions
    {
        public static readonly PerLanguageOption2<bool> EndConstruct =
            new("FeatureOnOffOptions_EndConstruct", defaultValue: true);
        ...
        public static readonly PerLanguageOption2<bool> AutomaticInsertionOfAbstractOrInterfaceMembers =
            new(
                "FeatureOnOffOptions_AutomaticInsertionOfAbstractOrInterfaceMembers",
                defaultValue: true
            );

        public static readonly PerLanguageOption2<bool> LineSeparator =
            new("FeatureOnOffOptions_LineSeparator", defaultValue: false);

        public static readonly PerLanguageOption2<bool> Outlining =
            new("FeatureOnOffOptions_Outlining", defaultValue: true);

        public static readonly PerLanguageOption2<bool> KeywordHighlighting =
            new("FeatureOnOffOptions_KeywordHighlighting", defaultValue: true);

        public static readonly PerLanguageOption2<bool> ReferenceHighlighting =
            new("FeatureOnOffOptions_ReferenceHighlighting", defaultValue: true);

        public static readonly PerLanguageOption2<bool> AutoInsertBlockCommentStartString =
            new("FeatureOnOffOptions_AutoInsertBlockCommentStartString", defaultValue: true);

        public static readonly PerLanguageOption2<bool> PrettyListing =
            new("FeatureOnOffOptions_PrettyListing", defaultValue: true);

        public static readonly PerLanguageOption2<bool> StringIdentation =
            new("FeatureOnOffOptions_StringIdentation", defaultValue: true);

        public static readonly PerLanguageOption2<bool> RenameTrackingPreview =
            new("FeatureOnOffOptions_RenameTrackingPreview", defaultValue: true);
        ...
        public static readonly Option2<bool> NavigateAsynchronously =
            new("FeatureOnOffOptions_NavigateAsynchronously", defaultValue: true);
        ...
        public static readonly PerLanguageOption2<bool> AddImportsOnPaste =
            new("FeatureOnOffOptions_AddImportsOnPaste", defaultValue: true);

        public static readonly Option2<bool?> OfferRemoveUnusedReferences =
            new("FeatureOnOffOptions_OfferRemoveUnusedReferences", defaultValue: true);

        public static readonly Option2<bool> OfferRemoveUnusedReferencesFeatureFlag =
            new("FeatureOnOffOptions_OfferRemoveUnusedReferencesFeatureFlag", defaultValue: false);

        public static readonly PerLanguageOption2<bool?> ShowInheritanceMargin =
            new("FeatureOnOffOptions_ShowInheritanceMargin", defaultValue: true);

        public static readonly Option2<bool> InheritanceMarginCombinedWithIndicatorMargin =
            new(
                "FeatureOnOffOptions_InheritanceMarginCombinedWithIndicatorMargin",
                defaultValue: false
            );

        public static readonly PerLanguageOption2<bool> InheritanceMarginIncludeGlobalImports =
            new("FeatureOnOffOptions_InheritanceMarginIncludeGlobalImports", defaultValue: true);

        public static readonly Option2<bool> AutomaticallyCompleteStatementOnSemicolon =
            new(
                "FeatureOnOffOptions_AutomaticallyCompleteStatementOnSemicolon",
                defaultValue: true
            );

        public static readonly PerLanguageOption2<bool> AutomaticallyFixStringContentsOnPaste =
            new("FeatureOnOffOptions_AutomaticallyFixStringContentsOnPaste", defaultValue: true);
        ...
        public static readonly Option2<bool> SkipAnalyzersForImplicitlyTriggeredBuilds =
            new(
                "FeatureOnOffOptions_SkipAnalyzersForImplicitlyTriggeredBuilds",
                defaultValue: true
            );
    }
}
