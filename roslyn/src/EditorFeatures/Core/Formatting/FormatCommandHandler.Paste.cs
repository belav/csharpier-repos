...
namespace Microsoft.CodeAnalysis.Formatting
{
    internal partial class FormatCommandHandler
    {
        ...
        )
        {
            ...
            if (
                !subjectBuffer.TryGetWorkspace(out var workspace)
            ...
            var formattingRuleService =
                services.GetService<IHostDependentFormattingRuleFactoryService>();
            if (
                formattingRuleService != null
                && formattingRuleService.ShouldNotFormatOrCommitOnPaste(document.Id)
            )
                return;
            ...
            var changes = formattingService
                .GetFormattingChangesOnPasteAsync(document, subjectBuffer, span, cancellationToken)
