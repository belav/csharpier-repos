...
namespace Microsoft.CodeAnalysis.Interactive
{
    internal static class InteractiveHostEntryPoint
    {
        ...
        internal enum ErrorMode : int
        {
            ...
            // parameter of SEM_FAILCRITICALERRORS at startup.
            /// This is to prevent error mode dialogs from blocking the application.
            /// </summary>
            SEM_NOGPFAULTERRORBOX = 0x0002,

            /// <summary>
            /// The system automatically fixes memory alignment faults and makes them invisible to the
            // application.
            /// It does this for the calling process and any descendant processes. This feature is only
            // supported by
