...
namespace Microsoft.CodeAnalysis.Interop
{
    ...
    internal interface IClrStrongName
    {
        ...
        void StrongNameFreeBuffer([In] IntPtr pbMemory);
        ...
        [return: MarshalAs(UnmanagedType.U4)]
        int StrongNameHashSize([In, MarshalAs(UnmanagedType.U4)] int ulHashAlg);

        void StrongNameKeyDelete([In, MarshalAs(UnmanagedType.LPWStr)] string pwzKeyContainer);
