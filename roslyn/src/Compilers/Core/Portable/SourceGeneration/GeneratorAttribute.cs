...
namespace Microsoft.CodeAnalysis
{
    ...
    public sealed class GeneratorAttribute : Attribute
    {
        ...
        /// <summary>
        /// Attribute constructor used to specify the attached class is a source generator that provides
        // CSharp sources.
        /// </summary>
        ...
        /// <summary>
        /// Attribute constructor used to specify the attached class is a source generator and indicate
        // which language(s) it supports.
        /// </summary>
        /// <param name="firstLanguage">One language to which the generator applies.</param>
        /// <param name="additionalLanguages">Additional languages to which the generator applies. See <see
        // cref="LanguageNames"/>.</param>
