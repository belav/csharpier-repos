...
{
    /// <summary>
    /// Represents the results of running a generation pass over a set of <see
    // cref="ISourceGenerator"/>s.
    /// </summary>
    public class GeneratorDriverRunResult
    {
        ...
        /// <summary>
        /// The individual result of each <see cref="ISourceGenerator"/> that was run in this generator
        // pass, one per generator.
        /// </summary>
        ...
        /// </summary>
        /// <remarks>
        /// This is equivalent to the union of all <see cref="GeneratorRunResult.Diagnostics"/> in <see
        // cref="Results"/>.
        /// </remarks>
        ...
        /// <summary>
        /// The <see cref="SyntaxTree"/>s produced during this generation pass by parsing each <see
        // cref="SourceText"/> added by each generator.
        /// </summary>
        /// <remarks>
        /// This is equivalent to the union of all <see cref="GeneratedSourceResult.SyntaxTree"/>s in each
        // <see cref="GeneratorRunResult.GeneratedSources"/> in each <see cref="Results"/>
        /// </remarks>
    ...
    public readonly struct GeneratorRunResult
    {
        ...
        /// <summary>
        /// The sources that were added by <see cref="Generator"/> during the generation pass this result
        // represents.
        /// </summary>
        ...
        /// </summary>
        /// <remarks>
        /// When generation fails due to an <see cref="Exception"/> being thrown, a single diagnostic is
        // added
        /// to represent the failure. Any generator reported diagnostics up to the failure point are not
        // included.
        /// </remarks>
        ...
        /// <summary>
        /// An <see cref="System.Exception"/> instance that was thrown by the generator, or <c>null</c> if
        // the generator completed without error.
        /// </summary>
        /// <remarks>
        /// When this property has a value, <see cref="GeneratedSources"/> property is guaranteed to be
        // empty, and the <see cref="Diagnostics"/>
        ...
        /// <summary>
        /// A collection of the named output steps executed during the generator pass this result
        // represents.
        /// </summary>
        /// <remarks>
        /// Steps can be named by extension method WithTrackingName.
    ...
    /// <summary>
    /// Represents the results of an <see cref="ISourceGenerator"/> calling <see
    // cref="GeneratorExecutionContext.AddSource(string, SourceText)"/>.
    /// </summary>
    /// <remarks>
    /// This contains the original <see cref="SourceText"/> added by the generator, along with the
    // parsed representation of that text in <see cref="SyntaxTree"/>.
    /// </remarks>
    public readonly struct GeneratedSourceResult
    {
        ...
        /// <summary>
        /// The <see cref="SyntaxTree"/> that was produced from parsing the <see
        // cref="GeneratedSourceResult.SourceText"/>.
        /// </summary>
    ...
    public readonly struct GeneratorDriverTimingInfo
    {
        ...
        /// </summary>
        /// <remarks>
        /// This can be more than the sum of times in <see cref="GeneratorTimes"/> as it includes other
        // costs such as setup.
        /// </remarks>
