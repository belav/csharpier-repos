...
namespace Microsoft.CodeAnalysis
{
    ...
    {
        public static void LogTables<TSelf, TInput>(
            this IIncrementalGeneratorNode<TSelf> self,
            string? name,
            NodeStateTable<TSelf>? previousTable,
            NodeStateTable<TSelf> newTable,
            NodeStateTable<TInput> inputTable
        ) =>
            LogTables<TSelf, TInput, TInput>(
                self,
                name,
                previousTable,
                newTable,
        ...
        public static void LogTables<TSelf, TInput1, TInput2>(
            this IIncrementalGeneratorNode<TSelf> self,
            string? name,
            NodeStateTable<TSelf>? previousTable,
            NodeStateTable<TSelf> newTable,
            NodeStateTable<TInput1> inputNode1,
            NodeStateTable<TInput2>? inputNode2
        )
        {
