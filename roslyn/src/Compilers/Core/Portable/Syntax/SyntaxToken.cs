...
namespace Microsoft.CodeAnalysis
{
    ...
    public readonly struct SyntaxToken : IEquatable<SyntaxToken>
    {
        ...
        /// <summary>
        /// Determines whether this token represents a language construct that was actually parsed from
        // source code.
        /// Missing tokens are typically generated by the parser in error scenarios to represent constructs
        // that should
        /// have been present in the source code for the source code to compile successfully but were
        // actually missing.
        /// </summary>
        public bool IsMissing => Node?.IsMissing ?? false;

        /// <summary>
        /// Returns the value of the token. For example, if the token represents an integer literal, then
        // this property
        ...
        /// <summary>
        /// Returns the text representation of the value of the token. For example, if the token represents
        // an integer
        ...
        /// </summary>
        /// <returns>The full string representation of this token including its leading and trailing
        // trivia.</returns>
        ...
        /// <summary>
        /// Adds this annotation to a given syntax token, creating a new syntax token of the same type with
        // the
        /// annotation on it.
        /// </summary>
        ...
        /// <summary>
        /// Copies all SyntaxAnnotations, if any, from this SyntaxToken instance and attaches them to a new
        // instance based on <paramref name="token" />.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// The list of trivia that appear after this token in the source code and are attached to this
        // token or any of
        /// its descendants.
        /// </summary>
        ...
        /// <summary>
        /// Creates a new token from this token with the leading and trailing trivia from the specified
        // token.
        /// </summary>
        ...
        /// </summary>
        /// <param name="predicate">Delegate applied to each token.  The token is returned if the predicate
        // returns
        /// true.</param>
        /// <param name="stepInto">Delegate applied to trivia.  If this delegate is present then trailing
        // trivia is
        ...
        /// <summary>
        /// Returns true if these two tokens are considered "incrementally identical".  An incrementally
        // identical token
        /// occurs when a <see cref="SyntaxTree"/> is incrementally parsed using <see
        // cref="SyntaxTree.WithChangedText"/>
        /// and the incremental parser is able to take the token from the original tree and use it in its
        // entirety in the
        /// new tree.  In this case, the <see cref="SyntaxToken.ToFullString()"/> of each token will be the
        // same, though
        /// they could have different parents, and may occur at different positions in the respective trees.
        // If two tokens are
        /// incrementally identical, all trivial of each node will be incrementally identical as well.
        /// </summary>
        /// <remarks>
        /// Incrementally identical tokens can also appear within the same syntax tree, or syntax trees that
        // did not arise
        /// from <see cref="SyntaxTree.WithChangedText"/>.  This can happen as the parser is allowed to
        // construct parse
        /// trees using shared tokens for efficiency.  In all these cases though, it will still remain true
        // that the incrementally
        /// identical tokens could have different parents and may occur at different positions in their
        // respective trees.
        /// </remarks>
