...
namespace Microsoft.CodeAnalysis
{
    ...
    ///    The lifespan of a temporary variable shall not cross a statement boundary (a PDB sequence
    // point).
    ///    These variables are not tracked by EnC and don't have names. Only values less than 0 are
    // considered
    ...
    ///    must be named in a build configuration that supports EnC. Some of them might need to be named
    // in release, to support EE.
    ///    The kind of such local must be encoded in the name, so that we can retrieve it from debug
    // metadata during EnC.
    ///
    ...
    internal enum SynthesizedLocalKind
    {
        ...
        /// <summary>
        /// Local variable that stores value of an expression consumed by a subsequent conditional branch
        // instruction that might jump across PDB sequence points.
        /// The value needs to be preserved when remapping the IL offset from old method body to new method
        // body during EnC.
        /// A hidden sequence point also needs to be inserted at the offset where this variable is loaded to
        // be consumed by the branch instruction.
        /// (VB, C#).
        /// </summary>
        ...
        /// <summary>
        /// Variable holding on the object being locked while the execution is within the block of the lock
        // statement (C#) or SyncLock statement (VB).
        /// </summary>
        Lock = 3,
        ...
        /// <summary>
        /// Local variable that holds a pinned handle of a managed reference passed to a fixed statement
        // (C#).
        /// </summary>
        FixedReference = 9,
        ...
        /// <summary>
        /// VB: Stores the return value of a function that is not accessible from user code (e.g. operator,
        // lambda, async, iterator).
        /// C#: Stores the return value of a method/lambda with a block body, so that we can put a sequence
        // point on the closing brace of the body.
        /// </summary>
        ...
        /// <summary>
        /// Local variable that stores the current state of the state machine while MoveNext method is
        // executing.
        ...
        /// The variable is assigned the result of a call to await-expression.GetAwaiter() and subsequently
        // used
        /// to check whether the task completed. Eventually the value is stored in an awaiter field.
        ///
        /// The value assigned to the variable needs to be preserved when remapping the IL offset from old
        // method body
        /// to new method body during EnC. If the awaiter expression is contained in an active statement and
        // the
        /// containing MoveNext method changes the debugger finds the next sequence point that follows the
        // await expression
        /// and transfers the execution to the new method version. This sequence point is placed by the
        // compiler at
        ...
        /// <summary>
        /// Variable that stores the context object used to track local variable and parameter stores in
        // method bodies instrumented with <see cref="InstrumentationKindExtensions.LocalStateTracing"/>.
        /// Associated with the method body syntax.
        /// </summary>
        LocalStoreTracker = 36,

        /// <summary>
        /// All values have to be less than or equal to <see
        // cref="MaxValidValueForLocalVariableSerializedToDebugInformation"/>
        ...
        /// TODO: Avoid using lambdas and display classes for implementation of relaxation stubs and remove
        // this kind.
        /// </summary>
    ...
    internal static class SynthesizedLocalKindExtensions
    {
        ...
        public static LocalVariableAttributes PdbAttributes(this SynthesizedLocalKind kind)
        {
            ...
            // We mark all synthesized locals, other than lambda display class as hidden so that they don't show
            // up in Dev12 EE.
