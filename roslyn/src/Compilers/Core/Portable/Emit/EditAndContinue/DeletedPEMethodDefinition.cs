...
{
    internal sealed class DeletedPEMethodDefinition
            ...
            IDeletedMethodDefinition
    {
        ...
        public Cci.TypeMemberVisibility Visibility => _oldMethod.MetadataVisibility;
        ...
        public ISymbolInternal? GetInternalSymbol() => _oldMethod;
        ...
        public bool IsConstructor => throw ExceptionUtilities.Unreachable();
        ...
        public bool ReturnValueIsMarshalledExplicitly => throw ExceptionUtilities.Unreachable();
        ...
        public bool AcceptsExtraArguments => throw ExceptionUtilities.Unreachable();

        public ushort GenericParameterCount => throw ExceptionUtilities.Unreachable();
        ...
        public Cci.CallingConvention CallingConvention => throw ExceptionUtilities.Unreachable();

        public ushort ParameterCount => throw ExceptionUtilities.Unreachable();
        ...
        public bool ReturnValueIsByRef => throw ExceptionUtilities.Unreachable();
