...
)
{
    ...
    public bool IsEmpty =>
        ...
        && AnonymousDelegates.IsEmpty
        && AnonymousDelegatesWithIndexedNames.IsEmpty;
    ...
    > AnonymousTypes { get; } =
        anonymousTypeMap
        ?? ImmutableSegmentedDictionary<AnonymousTypeKey, AnonymousTypeValue>.Empty;
    ...
    public bool IsSubsetOf(SynthesizedTypeMaps other) =>
        ...
        && AnonymousDelegates.Keys.All(
            static (key, other) => other.AnonymousDelegates.ContainsKey(key),
            other
        )
        && AnonymousDelegatesWithIndexedNames.Keys.All(
