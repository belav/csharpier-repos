...
#nullable disable
        ...
        where TModuleCompilationState : ModuleCompilationState<TNamedTypeSymbol, TMethodSymbol>
    {
        ...
        )
        {
            ...
            {
                Cci.IMethodDefinition cctor = CreatePrivateImplementationDetailsStaticConstructor(
                    syntaxOpt,
                    diagnostics
                );
                Debug.Assert(
                    (
                        (ISynthesizedGlobalMethodSymbol)cctor.GetInternalSymbol()
...
#nullable enable
        ...
        )
        {
            ...
            if (result == null)
            {
                ...
                if (
                    Interlocked.CompareExchange(ref _lazyPrivateImplementationDetails, result, null)
                    != null
                )
                {
