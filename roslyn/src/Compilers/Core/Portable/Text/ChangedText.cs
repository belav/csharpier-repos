...
namespace Microsoft.CodeAnalysis.Text
{
    internal sealed class ChangedText : SourceText
    {
        ...
        private class ChangeInfo
        {
            ...
            // store old text weakly so we don't form unwanted chains of old texts (especially chains of
            // ChangedTexts)
        ...
        {
            // compute changes against newText to avoid capturing strong references to this ChangedText
            // instance.
            // _newText will only ever be one of CompositeText, SubText, StringText or LargeText, so calling
            // WithChanges on it
        ...
        public override IReadOnlyList<TextChangeRange> GetChangeRanges(SourceText oldText)
        {
            ...
            // otherwise look to see if there are a series of changes from the old text to this text and merge
            // them.
            ...
            // the SourceText subtype for editor snapshots knows when two snapshots from the same buffer have
            // the same contents
        ...
        protected override TextLineCollection GetLinesCore()
        {
            ...
            // true if last segment ends with CR and we need to check for CR+LF code below assumes that both CR
            // and LF are also line breaks alone
