    ...
    internal partial struct SwitchIntegralJumpTableEmitter
    {
        ...
        internal void EmitJumpTable()
        {
            ...
            if (startLabelIndex <= endLabelIndex)
            {
                ...
                ImmutableArray<SwitchBucket> switchBuckets = this.GenerateSwitchBuckets(
                    startLabelIndex,
                    endLabelIndex
                );
                ...
                switch (degenerateSplit)
                {
                    ...
                    case 0:
                        ...
                        crumbled.Add(
                            new SwitchBucket(
                                _sortedCaseLabels,
                                uncrumbled.StartLabelIndex,
                                uncrumbled.EndLabelIndex,
                                isDegenerate: true
                            )
                        );
                        break;
        ...
        private void EmitSwitchBucketsLinearLeaf(
        ...
        private void EmitSwitchBucket(SwitchBucket switchBucket, object bucketFallThroughLabel)
        {
            ...
            else
            {
                ...
                {
                    EmitRangeCheckedBranch(
                        switchBucket.StartConstant,
                        switchBucket.EndConstant,
