...
namespace Roslyn.Utilities
{
    ...
    internal class StringTable
    {
        ...
        )
        {
            ...
            // Don't add non-ascii strings to table. The hashCode we have here is not correct and we won't find
            // them again.
            // Non-ascii in UTF-8 encoded parts of metadata (the only use of this at the moment) is assumed to
            // be rare in
