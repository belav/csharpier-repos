...
namespace Roslyn.Utilities
{
    internal static class GeneratedCodeUtilities
    {
        ...
        {
            return IsGeneratedCodeFile(filePath) || BeginsWithAutoGeneratedComment(root, isComment);
        }
        ...
        private static bool IsGeneratedCodeFile([NotNullWhen(returnValue: true)] string? filePath)
        {
            if (!RoslynString.IsNullOrEmpty(filePath))
            {
                ...
                {
                    var fileNameWithoutExtension = PathUtilities.GetFileName(
                        filePath,
        ...
        internal static GeneratedKind GetIsGeneratedCodeFromOptions(
        ...
        )
        {
            ...
            if (
                options.TryGetValue("generated_code", out string? optionValue)
