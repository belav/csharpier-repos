...
namespace Roslyn.Utilities
{
    internal static partial class EnumerableExtensions
    {
        ...
        public static ImmutableArray<TResult> SelectManyAsArray<TItem, TArg, TResult>(
            this IEnumerable<TItem>? source,
            Func<TItem, TArg, IEnumerable<TResult>> selector,
            TArg arg
        )
        {
            if (source == null)
        ...
        public static int IndexOf<T>(this IEnumerable<T> sequence, T value)
        {
            return sequence switch
            {
                ...
                IReadOnlyList<T> readOnlyList => IndexOf(
                    readOnlyList,
                    value,
