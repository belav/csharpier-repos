...
namespace Microsoft.CodeAnalysis
{
    public abstract class AttributeData
    {
        ...
        {
            get { return CommonAttributeClass; }
        }
        ...
        {
            get { return CommonConstructorArguments; }
        }
        ...
        {
            get { return CommonNamedArguments; }
        }
        protected internal abstract ImmutableArray<
        ...
        [MemberNotNullWhen(
            false,
            nameof(AttributeClass) /*, nameof(AttributeConstructor)*/
        )]
        ...
        /// </remarks>
        internal T? DecodeNamedArgument<T>(
            string name,
            ...
            where TAttributeData : AttributeData
        {
            ...
            arguments
                .GetOrCreateData<T>()
                .SetMethodImplementation(arguments.Index, (MethodImplAttributes)options | codeType);
        }

        internal static void DecodeStructLayoutAttribute<
            TTypeWellKnownAttributeData,
            TAttributeSyntaxNode,
            TAttributeData,
            TAttributeLocation
        >(
            ...
            where TAttributeData : AttributeData
        {
            ...
            CharSet charSet =
                (defaultCharSet != Cci.Constants.CharSet_None) ? defaultCharSet : CharSet.Ansi;
            int? size = null;
            int? alignment = null;
            ...
            if (!hasErrors)
            {
                ...
                arguments
                    .GetOrCreateData<TTypeWellKnownAttributeData>()
                    .SetStructLayout(
                        new TypeLayout(kind, size ?? 0, (byte)(alignment ?? 0)),
                        charSet
                    );
            }
        }
        ...
        {
            return DecodeAttributeUsageAttribute(
                this.CommonConstructorArguments[0],
        ...
        )
        {
            ...
            bool allowMultiple = DecodeNamedArgument(
                namedArgs,
                "AllowMultiple",
                SpecialType.System_Boolean,
                false
            );
            bool inherited = DecodeNamedArgument(
                namedArgs,
                "Inherited",
                SpecialType.System_Boolean,
                true
