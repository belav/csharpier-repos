...
namespace Microsoft.CodeAnalysis
{
    internal partial class CommonReferenceManager<TCompilation, TAssemblySymbol>
    {
        ...
        )
        {
            ...
            try
            {
                var explicitAssembliesMap = new MultiDictionary<
                    string,
                    (AssemblyData DefinitionData, int DefinitionIndex)
                >(explicitAssemblies.Length, AssemblyIdentityComparer.SimpleNameComparer);
        ...
        )
        {
            ...
            try
            {
                ...
                var implicitAssembliesMap = new MultiDictionary<
                    string,
                    (AssemblyData DefinitionData, int DefinitionIndex)
                >(implicitAssemblies.Count, AssemblyIdentityComparer.SimpleNameComparer);
