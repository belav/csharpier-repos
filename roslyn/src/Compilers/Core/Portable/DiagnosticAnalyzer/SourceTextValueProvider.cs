...
{
    /// <summary>
    /// Provides custom values associated with <see cref="SourceText"/> instances using the given
    // computeValue delegate.
    /// </summary>
    public sealed class SourceTextValueProvider<TValue>
    {
        ...
        /// <summary>
        /// Provides custom values associated with <see cref="SourceText"/> instances using the given
        // <paramref name="computeValue"/>.
        /// </summary>
        /// <param name="computeValue">Delegate to compute the value associated with a given <see
        // cref="SourceText"/> instance.</param>
        /// <param name="sourceTextComparer">Optional equality comparer to determine equivalent <see
        // cref="SourceText"/> instances that have the same value.
