...
namespace Microsoft.CodeAnalysis.Diagnostics
{
    ...
    internal sealed class AnalyzerAnalysisContext : AnalysisContext
    {
        ...
        public override void RegisterAdditionalFileAction(
    ...
    internal sealed class AnalyzerCompilationStartAnalysisContext : CompilationStartAnalysisContext
    {
        ...
        internal override bool TryGetValueCore<TKey, TValue>(
            TKey key,
        ...
        )
        {
            var compilationAnalysisValueProvider =
                _compilationAnalysisValueProviderFactory.GetValueProvider(valueProvider);
        ...
        : CodeBlockStartAnalysisContext<TLanguageKindEnum> where TLanguageKindEnum : struct
    {
        ...
        public override void RegisterSyntaxNodeAction(
            Action<SyntaxNodeAnalysisContext> action,
            ImmutableArray<TLanguageKindEnum> syntaxKinds
        )
        {
    ...
    internal sealed class HostSessionStartAnalysisScope : HostAnalysisScope
    {
        ...
        {
            CompilationStartAnalyzerAction analyzerAction = new CompilationStartAnalyzerAction(
                action,
                analyzer
            );
        ...
        {
            _generatedCodeConfigurationMap.AddOrUpdate(
                analyzer,
                addValue: mode,
                updateValueFactory: (a, c) => mode
            );
        }
    }
    ...
    /// </summary>
    internal sealed class HostCodeBlockStartAnalysisScope<TLanguageKindEnum>
        where TLanguageKindEnum : struct
    {
        private ImmutableArray<CodeBlockAnalyzerAction> _codeBlockEndActions =
            ImmutableArray<CodeBlockAnalyzerAction>.Empty;
        private ImmutableArray<SyntaxNodeAnalyzerAction<TLanguageKindEnum>> _syntaxNodeActions =
            ImmutableArray<SyntaxNodeAnalyzerAction<TLanguageKindEnum>>.Empty;
        ...
        {
            _codeBlockEndActions = _codeBlockEndActions.Add(
                new CodeBlockAnalyzerAction(action, analyzer)
            );
        }
        ...
        {
            _syntaxNodeActions = _syntaxNodeActions.Add(
    ...
    internal sealed class HostOperationBlockStartAnalysisScope
    {
        ...
        private ImmutableArray<OperationAnalyzerAction> _operationActions =
            ImmutableArray<OperationAnalyzerAction>.Empty;
        ...
        {
            _operationBlockEndActions = _operationBlockEndActions.Add(
                new OperationBlockAnalyzerAction(action, analyzer)
            );
        }
        ...
        {
            _operationActions = _operationActions.Add(
                new OperationAnalyzerAction(action, operationKinds, analyzer)
            );
        }
    }
    ...
    internal abstract class HostAnalysisScope
    {
        ...
        public void RegisterCompilationAction(
            DiagnosticAnalyzer analyzer,
            Action<CompilationAnalysisContext> action
        )
        {
            CompilationAnalyzerAction analyzerAction = new CompilationAnalyzerAction(
                action,
                analyzer
            );
        ...
        public void RegisterCompilationEndAction(
            DiagnosticAnalyzer analyzer,
            Action<CompilationAnalysisContext> action
        )
        {
        ...
        {
            SemanticModelAnalyzerAction analyzerAction = new SemanticModelAnalyzerAction(
                action,
                analyzer
            );
        ...
        {
            SyntaxTreeAnalyzerAction analyzerAction = new SyntaxTreeAnalyzerAction(
                action,
                analyzer
            );
        ...
        public void RegisterAdditionalFileAction(
            DiagnosticAnalyzer analyzer,
            Action<AdditionalFileAnalysisContext> action
        )
        {
        ...
        {
            SymbolAnalyzerAction analyzerAction = new SymbolAnalyzerAction(
                action,
                symbolKinds,
                analyzer
            );
                        ...
                        switch (context.Symbol.Kind)
                        {
                            ...
                            default:
                                throw new ArgumentException(
                                    $"{context.Symbol.Kind} is not supported.",
                                    nameof(context)
                                );
                        }
        ...
        public void RegisterSymbolEndAction(
            DiagnosticAnalyzer analyzer,
            Action<SymbolAnalysisContext> action
        )
        {
        ...
        {
            OperationBlockAnalyzerAction analyzerAction = new OperationBlockAnalyzerAction(
                action,
                analyzer
            );
            this.GetOrCreateAnalyzerActions(analyzer)
        ...
        {
            OperationAnalyzerAction analyzerAction = new OperationAnalyzerAction(
                action,
                operationKinds,
                analyzer
            );
    ...
    internal struct AnalyzerActions
    {
        ...
        {
            return _codeBlockStartActions.OfType<CodeBlockStartAnalyzerAction<TLanguageKindEnum>>()
                .ToImmutableArray();
        }
        ...
        {
            return _syntaxNodeActions.OfType<SyntaxNodeAnalyzerAction<TLanguageKindEnum>>()
                .ToImmutableArray();
        }

        internal readonly ImmutableArray<
            SyntaxNodeAnalyzerAction<TLanguageKindEnum>
        > GetSyntaxNodeActions<TLanguageKindEnum>(DiagnosticAnalyzer analyzer)
            where TLanguageKindEnum : struct
        {
        ...
        public readonly AnalyzerActions Append(
            in AnalyzerActions otherActions,
            bool appendSymbolStartAndSymbolEndActions = true
        )
        {
            ...
            actions._compilationStartActions = _compilationStartActions.AddRange(
                otherActions._compilationStartActions
            );
            actions._compilationEndActions = _compilationEndActions.AddRange(
                otherActions._compilationEndActions
            );
            actions._compilationActions = _compilationActions.AddRange(
                otherActions._compilationActions
            );
            actions._syntaxTreeActions = _syntaxTreeActions.AddRange(
                otherActions._syntaxTreeActions
            );
            actions._additionalFileActions = _additionalFileActions.AddRange(
                otherActions._additionalFileActions
            );
            actions._semanticModelActions = _semanticModelActions.AddRange(
                otherActions._semanticModelActions
            );
            actions._symbolActions = _symbolActions.AddRange(otherActions._symbolActions);
            actions._symbolStartActions = appendSymbolStartAndSymbolEndActions
                ? _symbolStartActions.AddRange(otherActions._symbolStartActions)
                : _symbolStartActions;
            actions._symbolEndActions = appendSymbolStartAndSymbolEndActions
                ? _symbolEndActions.AddRange(otherActions._symbolEndActions)
                : _symbolEndActions;
            actions._codeBlockStartActions = _codeBlockStartActions.AddRange(
                otherActions._codeBlockStartActions
            );
            actions._codeBlockEndActions = _codeBlockEndActions.AddRange(
                otherActions._codeBlockEndActions
            );
            actions._codeBlockActions = _codeBlockActions.AddRange(otherActions._codeBlockActions);
            actions._syntaxNodeActions = _syntaxNodeActions.AddRange(
                otherActions._syntaxNodeActions
            );
            actions._operationActions = _operationActions.AddRange(otherActions._operationActions);
            actions._operationBlockStartActions = _operationBlockStartActions.AddRange(
                otherActions._operationBlockStartActions
            );
            actions._operationBlockEndActions = _operationBlockEndActions.AddRange(
                otherActions._operationBlockEndActions
            );
            actions._operationBlockActions = _operationBlockActions.AddRange(
                otherActions._operationBlockActions
            );
