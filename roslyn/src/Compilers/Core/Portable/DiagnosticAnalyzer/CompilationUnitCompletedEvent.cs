...
namespace Microsoft.CodeAnalysis.Diagnostics
{
    internal sealed class CompilationUnitCompletedEvent : CompilationEvent
    {
        ...
        /// <summary>
        /// Optional filter span for a synthesized CompilationUnitCompletedEvent generated for span-based
        // semantic diagnostic computation.
        /// Such synthesized events are used primarily for performance improvements when running compiler
        // analyzer in span-based mode in the IDE,
        /// such as computing diagnostics for the lightbulb for the current line.
        /// Note that such a synthesized CompilationUnitCompletedEvent with non-null FilterSpan is not a
        // true
        /// compilation unit completed event, but just a stub event to drive span-based semantic model
        // action callbacks
        /// for analyzer execution. This event will eventually be followed by a true
