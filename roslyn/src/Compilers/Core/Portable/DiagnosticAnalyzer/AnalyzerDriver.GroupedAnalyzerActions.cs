        ...
        where TLanguageKindEnum : struct
    {
        ...
        private sealed class GroupedAnalyzerActions : IGroupedAnalyzerActions
        {
            ...
            private GroupedAnalyzerActions(
                ImmutableArray<(
                    DiagnosticAnalyzer,
                    GroupedAnalyzerActionsForAnalyzer
                )> groupedActionsAndAnalyzers,
            ...
            public ImmutableArray<(
                ...
                GroupedAnalyzerActionsForAnalyzer groupedActions
            )> GroupedActionsByAnalyzer { get; }
            ...
            )
            {
                ...
                var groupedActionsAndAnalyzers = ImmutableArray<(
                    DiagnosticAnalyzer,
                    GroupedAnalyzerActionsForAnalyzer
                )>.Empty.Add((analyzer, groupedActions));
...
#if DEBUG
                var inputAnalyzers = groupedAnalyzerActions.GroupedActionsByAnalyzer.Select(a =>
                    a.analyzer
                );
