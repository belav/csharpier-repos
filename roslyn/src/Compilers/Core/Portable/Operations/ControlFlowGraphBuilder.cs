...
namespace Microsoft.CodeAnalysis.FlowAnalysis
{
    ...
    internal sealed partial class ControlFlowGraphBuilder : OperationVisitor<int?, IOperation>
    {
        ...
        )
        {
            ...
            if (
                arguments.SelectAsArray(
                    predicate: arg => arg.Value is IInterpolatedStringHandlerCreationOperation,
                    selector: arg => (IInterpolatedStringHandlerCreationOperation)arg.Value
                ) is
                { IsDefaultOrEmpty: false } interpolatedStrings
            )
            {
                _currentInterpolatedStringHandlerArgumentContext =
        ...
        private static readonly Func<IArgumentOperation, IOperation> UnwrapArgument =
            UnwrapArgumentDoNotCaptureDirectly;
