...
namespace Microsoft.CodeAnalysis.FlowAnalysis
{
    ...
    internal sealed partial class ControlFlowGraphBuilder : OperationVisitor<int?, IOperation>
    {
        ...
        private readonly ArrayBuilder<(
            EvalStackFrame? frameOpt,
            IOperation? operationOpt
        )> _evalStack;
        ...
        private void VisitAndPushArguments(
            ImmutableArray<IArgumentOperation> arguments,
            bool instancePushed
        )
        {
            ...
            ArrayBuilder<IInterpolatedStringHandlerCreationOperation>? interpolatedStringBuilder =
                null;
            ...
            for (int i = 0; i < arguments.Length; i++)
            {
                if (arguments[i].Value is IInterpolatedStringHandlerCreationOperation creation)
                {
                    ...
                    interpolatedStringBuilder ??=
                        ArrayBuilder<IInterpolatedStringHandlerCreationOperation>.GetInstance();
        ...
        public override IOperation VisitImplicitIndexerReference(
        ...
        public override IOperation? VisitInlineArrayAccess(
            ...
            else if (ITypeSymbolHelpers.IsDynamicType(left.Type) || unaryOperatorMethod != null)
            {
                ...
                )
                {
                    condition = new UnaryOperation(
                        ...
                        constrainedToType: unaryOperatorMethod is not null
                        && (unaryOperatorMethod.IsAbstract || unaryOperatorMethod.IsVirtual)
            ...
            AddStatement(
                new FlowCaptureOperation(
                    ...
                    new BinaryOperation(
                        ...
                        binOp.OperatorMethod is not null
                        && (binOp.OperatorMethod.IsAbstract || binOp.OperatorMethod.IsVirtual)
                            ? binOp.ConstrainedToType
                            : null,
                        unaryOperatorMethod: null,
                        semanticModel: null,
        ...
        )
        {
            ...
            )
            {
                condition = new UnaryOperation(
                    ...
                    isChecked: false,
                    operatorMethod: unaryOperatorMethod,
                    constrainedToType: unaryOperatorMethod.IsAbstract
                    || unaryOperatorMethod.IsVirtual
                        ? binOp.ConstrainedToType
                        : null,
                    semanticModel: null,
                    condition.Syntax,
        ...
        )
        {
            ...
            void visitConditionalBranchCore(
                IOperation condition,
                [NotNull] ref BasicBlockBuilder? dest,
                bool jumpIfTrue
            )
                        ...
                        if (IsBooleanConditionalOperator((IBinaryOperation)condition))
                        {
                            ...
                            do
                            {
                                ...
                                if (top.condition is null)
                                {
                                    ...
                                    top.condition is IBinaryOperation binOp
                                    && IsBooleanConditionalOperator(binOp)
                                )
                                {
                                    if (CalculateAndOrSense(binOp, top.jumpIfTrue))
                                    {
                                        ...
                                        stack.Push(
                                            (
                                                skipParenthesized(binOp.RightOperand),
                                                top.dest,
                                                top.jumpIfTrue
                                            )
                                        );
                                        stack.Push(
                                            (
                                                skipParenthesized(binOp.LeftOperand),
                                                fallThrough,
                                                !top.jumpIfTrue
                                            )
                                        );
                        ...
                        if (ITypeSymbolHelpers.IsBooleanType(condition.Type))
                        {
                            ...
                            if (ITypeSymbolHelpers.IsBooleanType(coalesce.WhenNull.Type))
                            {
                                ...
                                IOperation convertedTestExpression =
                                    NullCheckAndConvertCoalesceValue(coalesce, whenNull);
        ...
        )
        {
            ...
            {
                var resourceQueue = ArrayBuilder<(
        ...
        )
        {
            ...
            IOperation getEnumerator()
            {
                ...
                {
                    IOperation? collection = info.GetEnumeratorMethod.IsStatic
                        ? null
                        : Visit(operation.Collection);

                    if (
                        collection is not null
                        && info.InlineArrayConversion is { } inlineArrayConversion
                    )
                    {
                        if (info.CollectionIsInlineArrayValue)
                        {
                            ...
                            collection = new FlowCaptureReferenceOperation(
                                localCopyCaptureId,
                                operation.Collection.Syntax,
                                collection.Type,
                                constantValue: null
                        ...
                        collection = applyConversion(
                            inlineArrayConversion,
                            collection,
                            info.GetEnumeratorMethod.ContainingType
                        );
                    }
        ...
        public override IOperation? VisitFunctionPointerInvocation(
        ...
        )
        {
            ...
            var (visitedPointer, visitedArguments) = handlePointerAndArguments(
                target,
                operation.Arguments
            );
            PopStackFrame(frame);
            ...
            ) handlePointerAndArguments(
                IOperation targetPointer,
                ImmutableArray<IArgumentOperation> arguments
            )
            {
        ...
        )
        {
            ...
            ImmutableArray<IArgumentOperation> visitedArgs = VisitArguments(
                operation.Arguments,
                instancePushed: false
            );
                ...
                switch (originalTarget.Kind)
                {
                    ...
                    case OperationKind.EventReference:
                        ...
                        return new EventReferenceOperation(
                            ...
                            eventReference.ConstrainedToType,
                            instance,
                            semanticModel: null,
                    ...
                    case OperationKind.PropertyReference:
                        ...
                        return new PropertyReferenceOperation(
                            ...
                            propertyReference.ConstrainedToType,
                            propertyArguments,
                            instance,
                            semanticModel: null,
        ...
        )
        {
            ...
            var elements = VisitArray(
                ...
                {
                    return element is ISpreadOperation spread ? spread.Operand : element;
                },
        ...
        )
        {
            switch (operation.ReferenceKind)
            {
                ...
                case InstanceReferenceKind.InterpolatedStringHandler:
                    AssertContainingContextIsForThisCreation(
                        operation,
                        assertArgumentContext: false
                    );
                    return new FlowCaptureReferenceOperation(
                        _currentInterpolatedStringHandlerCreationContext.HandlerPlaceholder,
                        operation.Syntax,
                        operation.Type,
                        operation.GetConstantValue()
                    );
        ...
        )
        {
            ...
            {
                for (
                    int i = _currentInterpolatedStringHandlerArgumentContext.StartingStackDepth;
                    i < maxStackDepth;
                    i++
                )
                {
            ...
            if (
                operation.HandlerCreationHasSuccessParameter
            ...
            if (operation.HandlerCreationHasSuccessParameter)
            {
                ...
                for (int i = arguments.Length - 1; i > 1; i--)
                {
                    if (
                        arguments[i] is
                        {
                            Value: IInterpolatedStringHandlerArgumentPlaceholderOperation
                            {
                                PlaceholderKind: InterpolatedStringArgumentPlaceholderKind.TrailingValidityArgument
                            }
                        } arg
                    )
                    {
            ...
            _currentInterpolatedStringHandlerCreationContext =
                new InterpolatedStringHandlerCreationContext(
                    operation,
                    maxStackDepth,
                    handlerCaptureId,
                    outParameterFlowCapture
                );
            ...
            if (operation.HandlerCreationHasSuccessParameter)
            {
                ...
                ConditionalBranch(
                    new FlowCaptureReferenceOperation(
                        outParameterFlowCapture,
                        outParameterPlaceholder.Syntax,
                        outParameterPlaceholder.Type,
                        constantValue: null
                    ),
                    jumpIfTrue: false,
                    resultBlock
            ...
            static void collectAppendCalls(
                IInterpolatedStringHandlerCreationOperation creation,
                ArrayBuilder<IInterpolatedStringAppendOperation> appendCalls
            )
            {
                ...
                static void appendStringCalls(
                    IInterpolatedStringOperation interpolatedString,
                    ArrayBuilder<IInterpolatedStringAppendOperation> appendCalls
                )
                {
                ...
                static void pushLeftNodes(
                    IInterpolatedStringAdditionOperation addition,
                    ArrayBuilder<IInterpolatedStringAdditionOperation> stack
                )
                {
        ...
        public override IOperation? VisitInterpolatedStringAppend(
        ...
        )
        {
            switch (operation.PlaceholderKind)
            {
                case InterpolatedStringArgumentPlaceholderKind.TrailingValidityArgument:
                    ...
                    return new FlowCaptureReferenceOperation(
                        _currentInterpolatedStringHandlerCreationContext.OutPlaceholder,
                        operation.Syntax,
                        operation.Type,
                        operation.GetConstantValue(),
                ...
                case InterpolatedStringArgumentPlaceholderKind.CallsiteArgument:
                    ...
                    Debug.Assert(_currentInterpolatedStringHandlerArgumentContext != null);
                    if (
                        tryGetArgumentOrReceiver(operation.ArgumentIndex)
                        is IOperation argumentCapture
                    )
                    {
                        Debug.Assert(
                            argumentCapture is IFlowCaptureReferenceOperation or IDiscardOperation
                        );
            ...
            IOperation? tryGetArgumentOrReceiver(int argumentIndex)
            {
                ...
                int targetStackDepth =
                    _currentInterpolatedStringHandlerArgumentContext.StartingStackDepth
                    + argumentIndex;

                Debug.Assert(
                    _evalStack.Count
                        > _currentInterpolatedStringHandlerCreationContext.MaximumStackDepth
                );
            ...
            for (int i = operation.Parts.Length - 1; i >= 0; i--)
            {
                ...
                switch (element)
                {
                    case IInterpolationOperation interpolation:
                            ...
                            Debug.Assert(
                                interpolation.FormatString
                                    is ILiteralOperation
                                        or IConversionOperation { Operand: ILiteralOperation }
                            );
                            rewrittenFormatString = VisitRequired(
                                interpolation.FormatString,
                                argument: null
                            );
                        }
                        ...
                        var rewrittenAlignment =
                            interpolation.Alignment != null ? PopOperand() : null;
                    ...
                    case IInterpolatedStringTextOperation interpolatedStringText:
                        Debug.Assert(
                            interpolatedStringText.Text
                                is ILiteralOperation
                                    or IConversionOperation { Operand: ILiteralOperation }
                        );
                        var rewrittenInterpolationText = VisitRequired(
                            interpolatedStringText.Text,
                            argument: null
                        );
        ...
        public override IOperation? VisitUtf8String(
        ...
        )
        {
            ...
            var visitedEventReference = new EventReferenceOperation(
                ...
                operation.EventReference.ConstrainedToType,
                visitedInstance,
                semanticModel: null,
                operation.EventReference.Syntax,
                operation.EventReference.Type,
        ...
        public override IOperation VisitSlicePattern(
        ...
        public override IOperation VisitWith(IWithOperation operation, int? captureIdForResult)
        {
            ...
            {
                return handleAnonymousTypeWithExpression(
            ...
            )
            {
                ...
                var explicitProperties = new Dictionary<IPropertySymbol, IOperation>(
                ...
                foreach (IOperation initializer in initializers)
                {
                    ...
                    Debug.Assert(propertyReference.Instance != null);
                    Debug.Assert(
                        propertyReference.Instance.Kind == OperationKind.InstanceReference
                    );
                    Debug.Assert(
                        ((IInstanceReferenceOperation)propertyReference.Instance).ReferenceKind
                            == InstanceReferenceKind.ImplicitReceiver
                    ...
                    LeaveRegionsUpTo(innerCaptureRegion);
                    var valueCaptureRef = new FlowCaptureReferenceOperation(
                        valueCaptureId,
                        operation.Operand.Syntax,
                ...
                foreach (IPropertySymbol property in properties)
                {
                    ...
                    else
                    {
                        ...
                        // `oldInstance`
                        var oldInstance = new FlowCaptureReferenceOperation(
                            oldValueCaptureId,
                            operation.Operand.Syntax,
                            operation.Operand.Type,
                            constantValue: operation.Operand.GetConstantValue()
                        ...
                        var visitedValue = new PropertyReferenceOperation(
                            property,
                            constrainedToType: null,
                            ImmutableArray<IArgumentOperation>.Empty,
                            oldInstance,
                        ...
                        var extraValueCaptureRef = new FlowCaptureReferenceOperation(
                            extraValueCaptureId,
                            operation.Operand.Syntax,
                            operation.Operand.Type,
                            constantValue: operation.Operand.GetConstantValue()
            ...
            SimpleAssignmentOperation makeAssignment(
            ...
            {
                // <implicitReceiver>
                var implicitReceiver = new InstanceReferenceOperation(
                    InstanceReferenceKind.ImplicitReceiver,
                    semanticModel: null,
                    operation.Syntax,
                    operation.Type,
                ...
                var target = new PropertyReferenceOperation(
                    property,
                    constrainedToType: null,
                    ImmutableArray<IArgumentOperation>.Empty,
                    implicitReceiver,
        ...
        public override IOperation VisitAttribute(
            IAttributeOperation operation,
            int? captureIdForResult
        )
        {
            return new AttributeOperation(
                Visit(operation.Operation, captureIdForResult)!,
                semanticModel: null,
                operation.Syntax,
                IsImplicit(operation)
            );
