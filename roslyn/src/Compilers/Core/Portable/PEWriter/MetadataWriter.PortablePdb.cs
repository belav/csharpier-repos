            ...
            public bool Equals(IImportScope x, IImportScope y)
            {
                return (object)x == y
                    || x != null
                        ...
                        && x.GetUsedNamespaces(_context)
                            .SequenceEqual(y.GetUsedNamespaces(_context));
            }

            public int GetHashCode(IImportScope obj)
            {
                return Hash.Combine(
                    Hash.CombineValues(obj.GetUsedNamespaces(_context)),
                ...
                if (bodyOpt.IsPrimaryConstructor)
                {
                    _debugMetadataOpt.AddCustomDebugInformation(
                        ...
                        kind: _debugMetadataOpt.GetOrAddGuid(
                            PortableCustomDebugInfoKinds.PrimaryConstructorInformationBlob
                        ),
