...
namespace Microsoft.CodeAnalysis.UnitTests
{
    public sealed class StringTextDecodingTests : TestBase
    {
        ...
        public void ShiftJisGetEncoding()
        {
            ...
            var data = CreateMemoryStreamBasedEncodedText(
                TestResources.General.ShiftJisSource,
                () => sjis
            );
        ...
        public void CheckSum002()
        {
            ...
            Assert.Equal(
                ...
                StringTextTest.ChecksumToHexQuads(checksum)
            );
        }
        ...
        public void CheckSum003()
        {
            ...
            var checksum = data.GetChecksum();
            Assert.Equal(
                "9d0047c0 8c84a7ef a55a955e aa3b4aae f62c9c39",
                StringTextTest.ChecksumToHexQuads(checksum)
            );
        }
        ...
        public void CheckSum004()
        {
            ...
            var checksum = data.GetChecksum();
            Assert.Equal(
                "72b2beae c76188ac 5b38c16c 4f9d518a 2be0a34c",
                StringTextTest.ChecksumToHexQuads(checksum)
            );
        }
        ...
        public void CheckSum007()
        {
            ...
            var checksum = data.GetChecksum();
            Assert.Equal(
                "d62636d8 caec13f0 4e28442a 0a6fa1af eb024bbb",
                StringTextTest.ChecksumToHexQuads(checksum)
            );
        }
        ...
        public void CheckSum008()
        {
            ...
            var checksum = data.GetChecksum();
            Assert.Equal(
                "26237800 2c95ae7e 29535cb9 f438db21 9adf98f5",
                StringTextTest.ChecksumToHexQuads(checksum)
            );
        }
        ...
        public void MemoryStreamBasedEncodedText1()
        {
            ...
            foreach (var writeEncoding in encodings)
            {
                ...
                {
                    var text = CreateMemoryStreamBasedEncodedText(
                        "goo",
                        writeEncoding,
                        readEncoding
                    );
