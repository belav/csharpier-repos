    ...
    public class MetadataReferencePropertiesTests
    {
        ...
        public void Constructor()
        {
            ...
            m = new MetadataReferenceProperties(
                ...
                aliases: ImmutableArray.Create("\\/[.'\":_)??\t\n*#$@^%*&)", "goo"),
        ...
        public void WithXxx()
        {
            ...
            Assert.Equal(
                a.WithAliases(default(ImmutableArray<string>)),
                new MetadataReferenceProperties(
                    MetadataImageKind.Assembly,
                    ImmutableArray<string>.Empty,
                    embedInteropTypes: true
            ...
            Assert.Equal(
                a.WithAliases(ImmutableArray<string>.Empty),
                new MetadataReferenceProperties(
                    MetadataImageKind.Assembly,
            ...
            Assert.Equal(
                a.WithAliases(new[] { "goo", "aaa" }),
                new MetadataReferenceProperties(
                    MetadataImageKind.Assembly,
                    ImmutableArray.Create("goo", "aaa"),
                    embedInteropTypes: true
                )
            );
            Assert.Equal(
                a.WithEmbedInteropTypes(false),
                new MetadataReferenceProperties(
                    MetadataImageKind.Assembly,
                    ImmutableArray.Create("a"),
            ...
            Assert.Equal(
                m.WithAliases(default(ImmutableArray<string>)),
                new MetadataReferenceProperties(
                    MetadataImageKind.Module,
                    default(ImmutableArray<string>),
                    embedInteropTypes: false
