...
namespace Microsoft.CodeAnalysis.UnitTests
{
    ...
    public class AnalyzerFileReferenceTests : TestBase
    {
        ...
        {
            AnalyzerFileReference reference = CreateAnalyzerFileReference(
                _testFixture.FaultyAnalyzer.Path
            );
        ...
        {
            AnalyzerFileReference reference = CreateAnalyzerFileReference(
                _testFixture.AnalyzerWithFakeCompilerDependency.Path
            );
        ...
        {
            AnalyzerFileReference reference = CreateAnalyzerFileReference(
                _testFixture.AnalyzerWithLaterFakeCompilerDependency.Path
            );
            ...
            var error = errors[0];
            Assert.Equal(
                AnalyzerLoadFailureEventArgs.FailureErrorCode.ReferencesNewerCompiler,
                error.ErrorCode
            );
        ...
        {
            public AnalyzerLoaderMockCSharpCompiler(
        ...
        public void AssemblyLoading_ReferencesLaterFakeCompiler_EndToEnd_CSharp()
        {
            ...
            var compiler = new AnalyzerLoaderMockCSharpCompiler(
                ...
                {
                    "/nologo",
                    $@"/analyzer:""{_testFixture.AnalyzerWithLaterFakeCompilerDependency.Path}""",
                    "/nostdlib",
                    $@"/r:""{corlib.Path}""",
                    "/out:something.dll",
                    source.Path
        ...
        [ConditionalFact(
            ...
            AlwaysSkip = "https://github.com/dotnet/roslyn/issues/63856"
        )]
        public void DuplicateAnalyzerReference()
        {
            ...
            var compiler = new AnalyzerLoaderMockCSharpCompiler(
                ...
                {
                    "/nologo",
                    $@"/analyzer:""{_testFixture.AnalyzerWithFakeCompilerDependency.Path}""",
                    $@"/analyzer:""{_testFixture.AnalyzerWithFakeCompilerDependency.Path}""",
                    "/nostdlib",
                    $@"/r:""{corlib.Path}""",
                    "/out:something.dll",
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        [ConditionalFact(
            typeof(CoreClrOnly),
            AlwaysSkip = "https://github.com/dotnet/roslyn/issues/60762"
        )]
...
{{
        ...
        public void TestLoadedGeneratorOrderIsDeterministic()
        {
            ...
            var csharpGenerators = reference
                ...
                .Select(g => g.GetGeneratorType().FullName)
                .ToArray();
