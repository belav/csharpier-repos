...
namespace Microsoft.CodeAnalysis.UnitTests.Collections
{
    public class RopeTests
    {
        ...
        private static readonly Rope[] longRopes = longStrings.Select(s => Rope.ForString(s))
            .ToArray();
        ...
        private static readonly Rope[] shortRopes = shortStrings.Select(s => Rope.ForString(s))
            .ToArray();
