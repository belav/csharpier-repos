    ...
    public class AnalysisContextInfoTests
    {
        ...
        private class Analyzer : DiagnosticAnalyzer
        {
            ...
            public override void Initialize(AnalysisContext c)
            {
                ...
                c.RegisterCodeBlockStartAction<SyntaxKind>(b =>
                    ThrowIfMatch(
                ...
                c.RegisterSemanticModelAction(b =>
                    ThrowIfMatch(
                ...
                c.RegisterSyntaxTreeAction(b =>
                    ThrowIfMatch(
                        nameof(c.RegisterSyntaxTreeAction),
                        new AnalysisContextInfo(b.Compilation, new SourceOrAdditionalFile(b.Tree))
                    )
                );
                c.RegisterAdditionalFileAction(b =>
                    ThrowIfMatch(
