...
namespace Roslyn.Test.Utilities.Desktop
{
    ...
    {
        private static readonly Guid s_clsIdClrRuntimeHost = new Guid(
            "90F1A06E-7712-4762-86B5-7A5EBA6BDB02"
        );
        private static readonly Guid s_clsIdCorMetaDataDispenser = new Guid(
        ...
        static CLRHelpers()
        {
            ...
            AppDomain.CurrentDomain.ReflectionOnlyAssemblyResolve +=
                ReflectionOnlyAssemblyResolveHandler;
        }
        ...
        private static string[] PeVerify(byte[] peImage, int domainId, string assemblyPath)
        {
            ...
            lock (s_guard)
            {
                ...
                try
                {
                    ...
                    metaDataValidate.ValidatorInit(
                        CorValidatorModuleType.ValidatorModuleTypePE,
                        errorHandler
                    );
                    ...
                    validator.Validate(
                        errorHandler,
                        (uint)domainId,
                        ValidatorFlags.VALIDATOR_EXTRA_VERBOSE,
                        ulMaxError: 10,
                        token: 0,
                        fileName: assemblyPath,
                        pe: buffer,
                        ulSize: (uint)peImage.Length
                    );
        ...
        private class ValidationErrorHandler : IVEHandler
        {
            ...
            private static readonly string s_resourceFilePath = Path.Combine(
                RuntimeEnvironment.GetRuntimeDirectory(),
                "mscorrc.dll"
            );
            private const uint LOAD_LIBRARY_AS_DATAFILE = 0x00000002;
            private static readonly IntPtr s_hMod = LoadLibraryEx(
                s_resourceFilePath,
                IntPtr.Zero,
    ...
    namespace ComTypes
    {
        ...
        {
            void VEHandler(
                [In, MarshalAs(UnmanagedType.Error)] int VECode,
                [In] tag_VerError Context,
                [In, MarshalAs(UnmanagedType.SafeArray, SafeArraySubType = VarEnum.VT_VARIANT)]
                    Array psa
            );
        ...
        {
            void ValidatorInit(
                [In] CorValidatorModuleType dwModuleType,
        ...
        [
            ...
            TypeIdentifier("5477469e-83b1-11d2-8b49-00a0c9b7c9c4", "mscoree.tag_VerError")
        ]
