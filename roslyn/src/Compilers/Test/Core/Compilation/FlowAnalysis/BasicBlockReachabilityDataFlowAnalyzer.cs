...
namespace Microsoft.CodeAnalysis.FlowAnalysis
{
    internal sealed class BasicBlockReachabilityDataFlowAnalyzer : DataFlowAnalyzer<bool>
    {
        ...
        public static BitVector Run(ControlFlowGraph controlFlowGraph)
        {
            ...
            _ = CustomDataFlowAnalysis<bool>.Run(
                controlFlowGraph,
                analyzer,
        ...
        public override (
            bool fallThroughSuccessorData,
            bool conditionalSuccessorData
        ...
        public override bool Merge(
            bool predecessor1IsReachable,
            bool predecessor2IsReachable,
            CancellationToken cancellationToken
