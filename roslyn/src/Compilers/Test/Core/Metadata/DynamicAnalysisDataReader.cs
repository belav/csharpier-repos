...
namespace Microsoft.CodeAnalysis
{
    ...
    internal sealed unsafe class DynamicAnalysisDataReader
    {
        ...
        public DynamicAnalysisDataReader(byte* buffer, int size)
        {
            ...
            var documentsBuilder =
                ArrayBuilder<DynamicAnalysisDocument>.GetInstance(documentRowCount);
            ...
            var methodsBuilder =
                ArrayBuilder<DynamicAnalysisMethod>.GetInstance(methodSpanRowCount);
