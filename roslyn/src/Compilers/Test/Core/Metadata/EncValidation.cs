...
namespace Roslyn.Test.Utilities
{
    ...
    {
        internal static void VerifyModuleMvid(
            int generation,
        ...
        )
        {
            ...
            Assert.Equal(
                previousReader.GetGuid(previousModule.Mvid),
                currentReader.GetGuid(currentModule.Mvid)
            );
            ...
            else
            {
                ...
                Assert.Equal(
                    previousReader.GetGuid(previousModule.GenerationId),
                    currentReader.GetGuid(currentModule.BaseGenerationId)
                );
            }
