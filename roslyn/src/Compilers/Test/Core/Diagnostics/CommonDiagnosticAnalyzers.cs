...
namespace Microsoft.CodeAnalysis
{
    public static class CommonDiagnosticAnalyzers
    {
        ...
        public class AnalyzerForErrorLogTest : DiagnosticAnalyzer
        {
            ...
            {
                get { return ImmutableArray.Create(Descriptor1, Descriptor2); }
            }
            ...
            public static string GetExpectedV1ErrorLogResultsAndRulesText(
            ...
            )
            {
                ...
                var effectiveSeverity1 =
                    warnAsError || Descriptor1.DefaultSeverity == DiagnosticSeverity.Error
                        ? "error"
                        : "warning";
                var effectiveSeverity2 =
                    warnAsError || Descriptor2.DefaultSeverity == DiagnosticSeverity.Error
                        ? "error"
                        : "warning";
                var warningLevelText = warnAsError
                    ? string.Empty
                    : @"
            ""warningLevel"": 1,";
          ...
          ""locations"": [
            {
              ""resultFile"": {
                ...
                ""region"": {
                  ""startLine"": "
                    + (expectedLineSpan.StartLinePosition.Line + 1)
                    + @",
                  ""startColumn"": "
                    + (expectedLineSpan.StartLinePosition.Character + 1)
                    + @",
                  ""endLine"": "
                    + (expectedLineSpan.EndLinePosition.Line + 1)
                    + @",
                  ""endColumn"": "
                    + (expectedLineSpan.EndLinePosition.Character + 1)
                    + @"
                }
              }
            }
      ...
      ""rules"": {
        """
          ...
          ""defaultLevel"": """
                    + (
                        Descriptor1.DefaultSeverity == DiagnosticSeverity.Error
                            ? "error"
                            : "warning"
                    )
                    + @""",
          ""helpUri"": """
                    + Descriptor1.HelpLinkUri
                    + @""",
          ""properties"": {
            ""category"": """
                    + Descriptor1.Category
                    + @""",
            ""isEnabledByDefault"": "
                    + (Descriptor2.IsEnabledByDefault ? "true" : "false")
                    + @",
            ""tags"": [
              "
                    + String.Join(
                        "," + Environment.NewLine + "              ",
                        Descriptor1.CustomTags.Select(s => $"\"{s}\"")
                    )
                    + @"
            ]
          }
        ...
        """
          ...
          ""defaultLevel"": """
                    + (
                        Descriptor2.DefaultSeverity == DiagnosticSeverity.Error
                            ? "error"
                            : "warning"
                    )
                    + @""",
          ""helpUri"": """
                    + Descriptor2.HelpLinkUri
                    + @""",
          ""properties"": {
            ""category"": """
                    + Descriptor2.Category
                    + @""",
            ""isEnabledByDefault"": "
                    + (Descriptor2.IsEnabledByDefault ? "true" : "false")
                    + @",
            ""tags"": [
              "
                    + String.Join(
                        "," + Environment.NewLine + "              ",
                        Descriptor2.CustomTags.Select(s => $"\"{s}\"")
                    )
                    + @"
            ]
          }
      ...
      ""rules"": {
        ...
        """
          ...
          ""properties"": {
            ...
            public static string GetExpectedV2ErrorLogResultsText(
                Compilation compilation,
                bool warnAsError = false
            )
            {
          ...
          ""suppressions"": [
            {
              ...
              ""justification"": """
                    ...
                    + (suppressionType == null ? "" : expectedSuppressionPropertyMap)
                    + @"
            }
          ],
          ""locations"": [
        ...
        },
        {
          ...
          ""properties"": {"
            ...
            public static string GetExpectedV2SuppressionTextForRulesSection(
                string[] suppressionKinds
            )
            {
            ...
            public static string GetExpectedV2ErrorLogInvocationsText(
                ...
                )[] overriddenEffectiveSeveritiesWithIndex
            )
            {
                ...
                foreach (
                    var (id, index, effectiveSeverities) in overriddenEffectiveSeveritiesWithIndex
                )
                {
                    foreach (
                        var effectiveSeverity in effectiveSeverities.OrderBy(
                            Comparer<ReportDiagnostic>.Default
                        )
                    )
                    {
                        if (first)
        ...
        {{
          ...
          ""ruleConfigurationOverrides"": [{overridesContent}
            ...
            {
                var descriptor1Info = descriptorsWithInfo
                    .Single(d => d.Descriptor.Id == Descriptor1.Id)
                    .Info;
                var descriptor1ExecutionTime = ReportAnalyzerUtil
                    .GetFormattedAnalyzerExecutionTime(descriptor1Info.ExecutionTime, culture)
                    .Trim();
                var descriptor1ExecutionPercentage = ReportAnalyzerUtil
                    .GetFormattedAnalyzerExecutionPercentage(
                        descriptor1Info.ExecutionPercentage,
                        culture
                    )
                    .Trim();

                var descriptor2Info = descriptorsWithInfo
                    .Single(d => d.Descriptor.Id == Descriptor2.Id)
                    .Info;
                var descriptor2ExecutionTime = ReportAnalyzerUtil
                    .GetFormattedAnalyzerExecutionTime(descriptor2Info.ExecutionTime, culture)
                    .Trim();
                var descriptor2ExecutionPercentage = ReportAnalyzerUtil
                    .GetFormattedAnalyzerExecutionPercentage(
                        descriptor2Info.ExecutionPercentage,
                        culture
                    )
                    .Trim();
                ...
                return @"          ""rules"": [
            {
              ...
              ""properties"": {
                ...
                ""executionTimeInSeconds"": """
                    + descriptor1ExecutionTime
                    + @""",
                ""executionTimeInPercentage"": """
                    + descriptor1ExecutionPercentage
                    + @""",
                ""tags"": [
                  "
                    + string.Join(
            ...
            },
            {
              ...
              ""properties"": {
                ""category"": """
                    ...
                    + @",
                ""executionTimeInSeconds"": """
                    + descriptor2ExecutionTime
                    + @""",
                ""executionTimeInPercentage"": """
                    + descriptor2ExecutionPercentage
                    + @""",
                ""tags"": [
                  "
                    + String.Join(
            ...
            public static string GetUriForPath(string path)
            {
                ...
                return uri.IsAbsoluteUri ? uri.AbsoluteUri : WebUtility.UrlEncode(uri.ToString());
            }
        }
        ...
        public class SuppressorForErrorLogTest : DiagnosticSuppressor
        {
            ...
            public override void ReportSuppressions(SuppressionAnalysisContext context)
            {
                ...
                {
                    var descriptor =
                        diagnostic.Id == Descriptor1.SuppressedDiagnosticId
                            ? Descriptor1
                            : Descriptor2;
        ...
        public class NotConfigurableDiagnosticAnalyzer : DiagnosticAnalyzer
        {
            ...
            public override ImmutableArray<DiagnosticDescriptor> SupportedDiagnostics
            {
                get { return ImmutableArray.Create(EnabledRule, DisabledRule); }
            }
        ...
        public class CSharpCodeBlockObjectCreationAnalyzer
            : CodeBlockObjectCreationAnalyzer<SyntaxKind>
        {
            ...
            : CodeBlockObjectCreationAnalyzer<VisualBasic.SyntaxKind>
        {
            protected override VisualBasic.SyntaxKind ObjectCreationExpressionKind =>
                VisualBasic.SyntaxKind.ObjectCreationExpression;
        }
        ...
        [DiagnosticAnalyzer(LanguageNames.CSharp)]
        public class CSharpNamespaceDeclarationAnalyzer
            : AbstractNamespaceDeclarationAnalyzer<SyntaxKind>
        {
        ...
        [DiagnosticAnalyzer(LanguageNames.VisualBasic)]
        public class VisualBasicNamespaceDeclarationAnalyzer
            : AbstractNamespaceDeclarationAnalyzer<VisualBasic.SyntaxKind>
        {
            protected override VisualBasic.SyntaxKind NamespaceDeclarationSyntaxKind =>
                VisualBasic.SyntaxKind.NamespaceStatement;
        }
            ...
            public override void Initialize(AnalysisContext context)
            {
                context.RegisterSymbolAction(
                    context =>
                    {
                        ...
                        context.ReportDiagnostic(
                            Diagnostic.Create(Rule, context.Symbol.Locations[0])
                        );
                    },
...
#pragma warning restore RS1029 // Do not use reserved diagnostic IDs.
        ...
        public sealed class AnalyzerWithInvalidDiagnosticLocation : DiagnosticAnalyzer
        {
                ...
                if (_actionKind == actionKindBeingRun)
                {
                    var diagnostic = _testInvalidAdditionalLocation
                        ? Diagnostic.Create(
                            Descriptor,
                            Location.None,
                            additionalLocations: new[] { _invalidLocation }
                        )
            ...
            public override void Initialize(AnalysisContext context)
            {
                context.RegisterCompilationStartAction(cc =>
                {
                    ...
                    cc.RegisterCodeBlockAction(c =>
                        ReportDiagnostic(c.ReportDiagnostic, ActionKind.CodeBlock)
                    );
                    cc.RegisterCompilationEndAction(c =>
                        ReportDiagnostic(c.ReportDiagnostic, ActionKind.CompilationEnd)
                    );
                    ...
                    cc.RegisterOperationBlockStartAction(oc =>
                    {
                        ...
                        oc.RegisterOperationBlockEndAction(c =>
                            ReportDiagnostic(c.ReportDiagnostic, ActionKind.OperationBlockEnd)
                        );
                    });
                });

                context.RegisterSyntaxTreeAction(c =>
                    ReportDiagnostic(c.ReportDiagnostic, ActionKind.SyntaxTree)
                );
                context.RegisterCompilationAction(cc =>
                    ReportDiagnostic(cc.ReportDiagnostic, ActionKind.Compilation)
                );
            }
        }
                ...
                context.RegisterSymbolAction(
                    symbolContext =>
                    {
                        symbolContext.ReportDiagnostic(
                            Diagnostic.Create(Rule, symbolContext.Symbol.Locations[0])
                        );
                    },
                    SymbolKind.NamedType
                );
                ...
                context.RegisterSymbolAction(
                    symbolContext =>
                    {
                        ...
                        symbolContext.ReportDiagnostic(
                            Diagnostic.Create(
                                Rule,
                                symbolContext.Symbol.Locations[0],
        ...
        public class CompilationAnalyzerWithSeverity : DiagnosticAnalyzer
        {
            ...
            private void OnCompilation(CompilationAnalysisContext context)
            {
                ...
                {
                    context.ReportDiagnostic(
                        Diagnostic.Create(Descriptor, tree.GetRoot().GetLocation())
                    );
                }
            }
        }
            ...
            public override void Initialize(AnalysisContext context) =>
                context.RegisterSemanticModelAction(context =>
                    context.ReportDiagnostic(
                        Diagnostic.Create(
                            Descriptor,
                            context.SemanticModel.SyntaxTree.GetRoot().GetLocation()
                        )
                    )
                );
        }
        ...
        public class ConcurrentAnalyzer : DiagnosticAnalyzer
        {
            ...
            public ConcurrentAnalyzer(IEnumerable<string> symbolNames)
            {
                Assert.True(
                    ...
                    "This analyzer is intended to be used only in a concurrent environment."
                );
            ...
            private void OnCompilationStart(CompilationStartAnalysisContext context)
            {
                Assert.True(
                    ...
                    "This analyzer is intended to be used only when concurrent build is enabled."
                );
        ...
        public sealed class OperationAnalyzer : DiagnosticAnalyzer
        {
            ...
            public OperationAnalyzer(ActionKind actionKind, bool verifyGetControlFlowGraph = false)
            {
                ...
                _controlFlowGraphMapOpt = verifyGetControlFlowGraph
                    ? new ConcurrentDictionary<IOperation, (ControlFlowGraph, ISymbol)>()
                    : null;
            }
            ...
            private void CacheAndVerifyControlFlowGraph(
            ...
            )
            {
                if (_verifyGetControlFlowGraph)
                {
                    foreach (var operationBlock in operationBlocks)
                    {
                        ...
                        Assert.Same(
                            operationBlock.GetRootOperation(),
                            controlFlowGraphAndSymbol.Graph.OriginalOperation
                        );

                        _controlFlowGraphMapOpt.Add(
                            controlFlowGraphAndSymbol.Graph.OriginalOperation,
                        ...
                        Assert.Same(
                            controlFlowGraphAndSymbol.Graph,
                            getControlFlowGraph(operationBlock).Graph
                        );
                        ...
                        {
                            Assert.Equal(
                                new ArgumentNullException("operationBlock").Message,
                                ex.Message
                            );
                        }
            ...
            )
            {
                if (_verifyGetControlFlowGraph)
                {
                    ...
                    {
                        _controlFlowGraphMapOpt[rootOperation] = (
                            controlFlowGraph,
            ...
            where TSyntaxKind : struct
        {
            ...
            public override ImmutableArray<DiagnosticDescriptor> SupportedDiagnostics =>
                ImmutableArray.Create(Warning, Error, Summary, Summary2);
            ...
            private void OnCompilationStart(CompilationStartAnalysisContext context)
            {
                ...
                context.RegisterSymbolAction(
                    symbolContext =>
                    {
                        sortedCallbackSymbolNames.Add(
                            $"{symbolContext.Symbol.Name}(IsGeneratedCode:{symbolContext.IsGeneratedCode})"
                        );
                        ReportSymbolDiagnostics(
                ...
                {
                    sortedCallbackTreePaths.Add(
                        $"{treeContext.Tree.FilePath}(IsGeneratedCode:{treeContext.IsGeneratedCode})"
                    );
                ...
                if (_testIsGeneratedCodeInCallbacks)
                {
                    ...
                    context.RegisterSyntaxNodeAction(
                        context =>
                            sortedCallbackSyntaxNodeNames.Add(
                                $"{context.ContainingSymbol.Name}(IsGeneratedCode:{context.IsGeneratedCode})"
                            ),
                        ImmutableArray.Create(ClassDeclarationSyntaxKind)
                    );

                    context.RegisterSemanticModelAction(context =>
                        sortedCallbackSemanticModelPaths.Add(
                            $"{context.SemanticModel.SyntaxTree.FilePath}(IsGeneratedCode:{context.IsGeneratedCode})"
                        )
                    );
                    ...
                    context.RegisterSymbolStartAction(
                        context =>
                        {
                            sortedCallbackSymbolStartNames.Add(
                                $"{context.Symbol.Name}(IsGeneratedCode:{context.IsGeneratedCode})"
                            );

                            context.RegisterOperationBlockStartAction(context =>
                            {
                                if (
                                    context.OwningSymbol.Kind != SymbolKind.Method
                                ...
                                sortedCallbackOperationBlockStartNames.Add(
                                    $"{context.OwningSymbol.ContainingType.Name}(IsGeneratedCode:{context.IsGeneratedCode})"
                                );

                                context.RegisterOperationAction(
                                    context =>
                                        sortedCallbackOperationNames.Add(
                                            $"{context.ContainingSymbol.ContainingType.Name}(IsGeneratedCode:{context.IsGeneratedCode})"
                                        ),
                                    OperationKind.Invocation
                                );

                                context.RegisterOperationBlockEndAction(context =>
                                    sortedCallbackOperationBlockEndNames.Add(
                                        $"{context.OwningSymbol.ContainingType.Name}(IsGeneratedCode:{context.IsGeneratedCode})"
                                    )
                                );
                            });
                            ...
                            context.RegisterOperationBlockAction(context =>
                            {
                                ...
                                sortedCallbackOperationBlockNames.Add(
                                    $"{context.OwningSymbol.ContainingType.Name}(IsGeneratedCode:{context.IsGeneratedCode})"
                                );
                            });

                            context.RegisterSymbolEndAction(context =>
                                sortedCallbackSymbolEndNames.Add(
                                    $"{context.Symbol.Name}(IsGeneratedCode:{context.IsGeneratedCode})"
                                )
                            );
                        },
                    ...
                    context.RegisterCodeBlockStartAction<TSyntaxKind>(context =>
                    {
                        ...
                        sortedCallbackCodeBlockStartNames.Add(
                            $"{context.OwningSymbol.ContainingType.Name}(IsGeneratedCode:{context.IsGeneratedCode})"
                        );

                        context.RegisterCodeBlockEndAction(context =>
                            sortedCallbackCodeBlockEndNames.Add(
                                $"{context.OwningSymbol.ContainingType.Name}(IsGeneratedCode:{context.IsGeneratedCode})"
                            )
                        );
                    });
                    ...
                    context.RegisterCodeBlockAction(context =>
                    {
                        ...
                        sortedCallbackCodeBlockNames.Add(
                            $"{context.OwningSymbol.ContainingType.Name}(IsGeneratedCode:{context.IsGeneratedCode})"
                        );
                    });
                }
            ...
            private void ReportTreeDiagnostics(SyntaxTree tree, Action<Diagnostic> addDiagnostic)
            {
                ReportDiagnosticsCore(
                    addDiagnostic,
                    tree.GetRoot().GetLastToken().GetLocation(),
                    tree.FilePath
                );
            }
        ...
        public class AnalyzerForParameters : DiagnosticAnalyzer
        {
            ...
            public override ImmutableArray<DiagnosticDescriptor> SupportedDiagnostics =>
                ImmutableArray.Create(ParameterDescriptor);
                ...
                void onSymbolStart(SymbolStartAnalysisContext symbolStartContext)
                {
                    ...
                    if (_operationKind.HasValue)
                    {
                        symbolStartContext.RegisterOperationAction(
                            operationContext =>
                            {
                                performOperationActionVerification(
                                    operationContext,
                                    symbolStartContext
                                );
                            },
                    ...
                    if (!SymbolsStarted.Add(symbolStartContext.Symbol))
                    {
                        diagnostics.Add(
                            Diagnostic.Create(
                                DuplicateStartActionRule,
                                Location.None,
                                symbolStartContext.Symbol.Name,
                                _analyzerId
                            )
                        );
                    }
                ...
                )
                {
                    ...
                    operationContext.ReportDiagnostic(
                        Diagnostic.Create(
                            ...
                            symbolStartContext.Symbol.Name,
                            operationContext.ContainingSymbol.Name,
                            operationContext.Operation.Syntax.ToString(),
                            _analyzerId
                        )
                    );
                }
        ...
        [DiagnosticAnalyzer(LanguageNames.CSharp, LanguageNames.VisualBasic)]
        public sealed class DiagnosticSuppressorForId_ThrowsOperationCancelledException
        ...
        [DiagnosticAnalyzer(LanguageNames.CSharp, LanguageNames.VisualBasic)]
        public sealed class DiagnosticSuppressorThrowsExceptionFromReportedSuppressions
            : DiagnosticSuppressor
        {
            ...
            : DiagnosticSuppressor
        {
            ...
            public DiagnosticSuppressor_UnsupportedSuppressionReported(
                string suppressedDiagnosticId,
        ...
        public sealed class DiagnosticSuppressor_NonReportedDiagnosticCannotBeSuppressed
            : DiagnosticSuppressor
        {
            private readonly SuppressionDescriptor _descriptor1,
                _descriptor2;
        ...
        public sealed class NamedTypeAnalyzerWithConfigurableEnabledByDefault : DiagnosticAnalyzer
        {
            ...
            public NamedTypeAnalyzerWithConfigurableEnabledByDefault(
                ...
                : this(
                    isEnabledByDefault,
                    defaultSeverity,
                    customConfigurable: false,
                    throwOnAllNamedTypes
                ) { }
            ...
            private void OnOperationBlockStart(OperationBlockStartAnalysisContext context)
            {
                context.RegisterOperationBlockEndAction(endContext =>
                    endContext.ReportDiagnostic(
                        Diagnostic.Create(s_descriptor, context.OwningSymbol.Locations[0])
                    )
                );
            }
        }
            ...
            public override void Initialize(AnalysisContext context)
            {
                ...
                else
                {
                    context.RegisterSymbolAction(
                        context =>
                            context.ReportDiagnostic(
                                Diagnostic.Create(Descriptor, context.Symbol.Locations[0])
                            ),
                        SymbolKind.Field
                    );
                }
        ...
        public class AdditionalFileAnalyzer : DiagnosticAnalyzer
        {
            ...
            private void AnalyzeAdditionalFile(AdditionalFileAnalysisContext context)
            {
                ...
                var location = Location.Create(
                    ...
                    _diagnosticSpan,
                    text.Lines.GetLinePositionSpan(_diagnosticSpan)
                );
        ...
        public sealed class LocalNonLocalDiagnosticsAnalyzer : DiagnosticAnalyzer
        {
            ...
            private void AnalyzeCompilation(CompilationStartAnalysisContext context)
            {
                switch (_actionKind)
                {
                    case ActionKind.SyntaxTreeAction:
                        context.RegisterSyntaxTreeAction(treeContext =>
                            ReportDiagnosticsInAllTrees(
                                "RegisterSyntaxTreeAction",
                                treeContext.Tree,
                                treeContext.Compilation,
                                treeContext.ReportDiagnostic
                            )
                        );
                        break;
                    ...
                    case ActionKind.SemanticModelAction:
                        context.RegisterSemanticModelAction(semanticModelContext =>
                            ReportDiagnosticsInAllTrees(
                                ...
                                semanticModelContext.SemanticModel.Compilation,
                        ...
                        context.RegisterSymbolStartAction(
                            symbolStartContext =>
                            {
                                symbolStartContext.RegisterOperationAction(
                                    operationContext =>
                                        ReportDiagnostics(
                                            $"RegisterOperationAction({operationContext.Operation.Syntax}) in RegisterSymbolStartAction",
                                            operationContext.Operation.Syntax.SyntaxTree,
                                            operationContext.ContainingSymbol,
                                            operationContext.ReportDiagnostic
                                        ),
                                    OperationKind.VariableDeclarationGroup
                                ...
                                symbolStartContext.RegisterSyntaxNodeAction(
                                    syntaxNodeContext =>
                                        ReportDiagnostics(
                                            $"RegisterSyntaxNodeAction({syntaxNodeContext.Node}) in RegisterSymbolStartAction",
                                            syntaxNodeContext.Node.SyntaxTree,
                                            syntaxNodeContext.ContainingSymbol,
                                            syntaxNodeContext.ReportDiagnostic
                                        ),
                    ...
                    case ActionKind.OperationAction:
                        context.RegisterOperationAction(
                            operationContext =>
                                ReportDiagnostics(
                                    $"RegisterOperationAction({operationContext.Operation.Syntax})",
                                    operationContext.Operation.Syntax.SyntaxTree,
                                    operationContext.ContainingSymbol,
                                    operationContext.ReportDiagnostic
                                ),
                    ...
                    case ActionKind.OperationBlockStartEndAction:
                        context.RegisterOperationBlockStartAction(operationBlockStartContext =>
                        {
                            operationBlockStartContext.RegisterOperationAction(
                                operationContext =>
                                    ReportDiagnostics(
                                        $"RegisterOperationAction({operationContext.Operation.Syntax}) in RegisterOperationBlockStartAction",
                                        operationContext.Operation.Syntax.SyntaxTree,
                                        operationContext.ContainingSymbol,
                                        operationContext.ReportDiagnostic
                                    ),
                    ...
                    case ActionKind.SyntaxNodeAction:
                        context.RegisterSyntaxNodeAction(
                            syntaxNodeContext =>
                                ReportDiagnostics(
                                    $"RegisterSyntaxNodeAction({syntaxNodeContext.Node})",
                                    syntaxNodeContext.Node.SyntaxTree,
                                    syntaxNodeContext.ContainingSymbol,
                                    syntaxNodeContext.ReportDiagnostic
                                ),
                    ...
                    case ActionKind.CodeBlockAction:
                        context.RegisterCodeBlockAction(codeBlockContext =>
                            ReportDiagnostics(
                                ...
                                codeBlockContext.CodeBlock.SyntaxTree,
                                codeBlockContext.OwningSymbol,
                                codeBlockContext.ReportDiagnostic
                            )
                        );
                        break;
                    ...
                    case ActionKind.CodeBlockStartEndAction:
                        context.RegisterCodeBlockStartAction<SyntaxKind>(codeBlockStartContext =>
                        {
                            codeBlockStartContext.RegisterSyntaxNodeAction(
                                syntaxNodeContext =>
                                    ReportDiagnostics(
                                        $"RegisterSyntaxNodeAction({syntaxNodeContext.Node}) in RegisterCodeBlockStartAction",
                                        syntaxNodeContext.Node.SyntaxTree,
                                        syntaxNodeContext.ContainingSymbol,
                                        syntaxNodeContext.ReportDiagnostic
                                    ),
                            ...
                            codeBlockStartContext.RegisterCodeBlockEndAction(codeBlockEndContext =>
                                ReportDiagnostics(
                                    ...
                                    codeBlockEndContext.CodeBlock.SyntaxTree,
                                    codeBlockEndContext.OwningSymbol,
                                    codeBlockEndContext.ReportDiagnostic
                                )
                            );
                        });
                        break;
            ...
            private static void ReportSymbolDiagnostics(
                string actionName,
                ISymbol symbol,
                Compilation compilation,
                Action<Diagnostic> reportDiagnostic
            ...
            private static void ReportDiagnosticsInAllTrees(
                string actionName,
            ...
            )
            {
                ...
                {
                    ReportDiagnosticsInTreeCore(
                        $"{actionName}(File{index})",
                        tree,
                        reportDiagnostic
                    );
                }
            ...
            private static void ReportDiagnosticsInTreeCore(
                string arg,
                SyntaxTree tree,
                Action<Diagnostic> reportDiagnostic
            )
            {
                var root = tree.GetRoot();
                foreach (
                    var localDecl in root.DescendantNodes()
        ...
        internal sealed class CancellationTestAnalyzer : DiagnosticAnalyzer
        {
            ...
            private readonly DiagnosticDescriptor s_descriptor = new DiagnosticDescriptor(
                DiagnosticId,
                "test",
                "test",
                "test",
            ...
            private void OnCompilationStart(CompilationStartAnalysisContext context)
            {
                switch (_actionKind)
                {
                    case AnalyzerRegisterActionKind.SyntaxTree:
                        context.RegisterSyntaxTreeAction(syntaxContext =>
                            HandleCallback(
                                syntaxContext.Tree.GetRoot().GetLocation(),
                                context.Compilation,
                    ...
                    case AnalyzerRegisterActionKind.SyntaxNode:
                        context.RegisterSyntaxNodeAction(
                            ...
                            CodeAnalysis.CSharp.SyntaxKind.ClassDeclaration
                        );
                        break;
        ...
        public sealed class AllActionsAnalyzer : DiagnosticAnalyzer
        {
            ...
            private void AnalyzeCompilation(CompilationStartAnalysisContext context)
            {
                ...
                context.RegisterSymbolAction(
                    symbolContext => AnalyzedSymbols.Add(symbolContext.Symbol),
                    SymbolKind.NamedType,
                    SymbolKind.Method
                );
                context.RegisterOperationAction(
                    operationContext => AnalyzedOperations.Add(operationContext.Operation),
                    OperationKind.VariableDeclaration
                );
                context.RegisterSyntaxNodeAction(
                    syntaxNodeContext => AnalyzedSyntaxNodes.Add(syntaxNodeContext.Node),
                    SyntaxKind.LocalDeclarationStatement
                );
                ...
                {
                    context.RegisterSyntaxTreeAction(treeContext =>
                        AnalyzedTrees.Add(treeContext.Tree)
                    );
                }
                ...
                {
                    context.RegisterSemanticModelAction(semanticModelContext =>
                        AnalyzedSemanticModels.Add(semanticModelContext.SemanticModel)
                    );
                }
                ...
                if (_testSymbolStartAction)
                {
                    context.RegisterSymbolStartAction(
                        symbolStartContext =>
                        {
                            ...
                            symbolStartContext.RegisterSymbolEndAction(symbolEndContext =>
                                AnalyzedSymbolEndSymbols.Add(symbolEndContext.Symbol)
                            );
                        },
                        SymbolKind.NamedType
                    );
                ...
                {
                    context.RegisterOperationBlockAction(operationBlockContext =>
                        AnalyzedOperationBlockSymbols.Add(operationBlockContext.OwningSymbol)
                    );
                    context.RegisterOperationBlockStartAction(operationBlockStartContext =>
                    {
                        AnalyzedOperationBlockStartSymbols.Add(
                            operationBlockStartContext.OwningSymbol
                        );
                        operationBlockStartContext.RegisterOperationAction(
                            operationContext =>
                                AnalyzedOperationsInsideOperationBlock.Add(
                        ...
                        operationBlockStartContext.RegisterOperationBlockEndAction(
                            operationBlockEndContext =>
                                AnalyzedOperationBlockEndSymbols.Add(
                                    operationBlockEndContext.OwningSymbol
                                )
                        );
                    });
                    context.RegisterCodeBlockAction(codeBlockContext =>
                        AnalyzedCodeBlockSymbols.Add(codeBlockContext.OwningSymbol)
                    );
                    context.RegisterCodeBlockStartAction<SyntaxKind>(codeBlockStartContext =>
                    {
                        ...
                        codeBlockStartContext.RegisterSyntaxNodeAction(
                            syntaxNodeContext =>
                                AnalyzedSyntaxNodesInsideCodeBlock.Add(syntaxNodeContext.Node),
                            SyntaxKind.LocalDeclarationStatement
                        );
                        codeBlockStartContext.RegisterCodeBlockEndAction(codeBlockEndContext =>
                            AnalyzedCodeBlockEndSymbols.Add(codeBlockEndContext.OwningSymbol)
                        );
                    });
                }
            }
