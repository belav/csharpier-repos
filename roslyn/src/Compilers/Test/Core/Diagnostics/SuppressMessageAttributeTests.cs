...
namespace Microsoft.CodeAnalysis.UnitTests.Diagnostics
{
    public abstract partial class SuppressMessageAttributeTests
    {
        ...
        public static IEnumerable<string[]> QualifiedAttributeNames { get; } =
            new[]
            {
        ...
        public static IEnumerable<string[]> SimpleAttributeNames { get; } =
            new[] { new[] { "SuppressMessage" }, new[] { "UnconditionalSuppressMessage" } };
...
[assembly: "
                    + attrName
                    + @"(""Test"", ""Declaration"", Scope=""Namespace"", Target=""N"")]
[module: "
                    + attrName
                    + @"(""Test"", ""Declaration"", Scope=""Namespace"", Target=""N.N1"")]
[module: "
                    + attrName
                    + @"(""Test"", ""Declaration"", Scope=""Namespace"", Target=""N4"")]
...
[assembly: "
                    + attrName
                    + @"(""Test"", ""Declaration"", Scope=""NamespaceAndDescendants"", Target=""N.N1"")]
[module: "
                    + attrName
                    + @"(""Test"", ""Declaration"", Scope=""namespaceanddescendants"", Target=""N4"")]
...
[assembly: "
                + attrName
                + @"(""Test"", ""Declaration"", Scope=""NamespaceAndDescendants"", Target=""N.N1.N2"")]
[module: "
                + attrName
                + @"(""Test"", ""Declaration"", Scope=""NamespaceAndDescendants"", Target=""N4"")]
[module: "
                + attrName
                + @"(""Test"", ""Declaration"", Scope=""Type"", Target=""C2"")]
...
[assembly: "
                    + attrName
                    + @"(""Test"", ""Declaration"", Scope=""Type"", Target=""E"")]
[module: "
                    + attrName
                    + @"(""Test"", ""Declaration"", Scope=""Type"", Target=""Ef"")]
[assembly: "
                    + attrName
                    + @"(""Test"", ""Declaration"", Scope=""Type"", Target=""Egg"")]
[assembly: "
                    + attrName
                    + @"(""Test"", ""Declaration"", Scope=""Type"", Target=""Ele`2"")]
...
[assembly: "
                    + attrName
                    + @"(""Test"", ""Declaration"", Scope=""type"", Target=""C.A1"")]
[module: "
                    + attrName
                    + @"(""Test"", ""Declaration"", Scope=""type"", Target=""C+A2"")]
[assembly: "
                    + attrName
                    + @"(""Test"", ""Declaration"", Scope=""member"", Target=""C+A3"")]
[assembly: "
                    + attrName
                    + @"(""Test"", ""Declaration"", Scope=""member"", Target=""C.A4"")]
...
<assembly: "
                    + attrName
                    + @"(""Test"", ""Declaration"", Scope=""type"", Target=""M"")>
...
[assembly: "
                    + attrName
                    + @"(""Test"", ""Declaration"", Scope=""Member"", Target=""C.#M1"")]
[module: "
                    + attrName
                    + @"(""Test"", ""Declaration"", Scope=""Member"", Target=""C.#M3`1()"")]
...
[assembly: "
                    + attrName
                    + @"(""Test"", ""Declaration"", Scope=""Member"", Target=""~M:C.M~System.Threading.Tasks.Task{System.ValueTuple{System.Boolean,ErrorCode}}"")]
...
[assembly: "
                    + attrName
                    + @"(""Test"", ""TypeDeclaration"", Scope=""Type"", Target=""E"")]
...
[module: "
                    + attrName
                    + @"(""Test"", ""Comment"", Scope=""Member"" Target=""C.Goo():System.Void"")]
// before class
public class C
{
    // before method
...
[assembly: "
                    + attrName
                    + @"(""Test"", ""Token"", Scope=""namespace"", Target=""A.B"")]
namespace A
[|{
    namespace B
    {
...
[assembly: "
                    + attrName
                    + @"(""Test"", ""Token"", Scope=""NamespaceAndDescendants"", Target=""A.B"")]
namespace A
[|{
    namespace B
    {
...
[module: "
                    + attrName
                    + @"(""Test"", ""Comment"", Scope=""Member"" Target=""E.Field1"")]
// before enum
public enum E
{
...
["
                    + attrName
                    + @"(""Test"", ""Declaration"", Scope=""Type"", Target=""C"")]
public class C3
{
}
",
...
[module: "
                    + attrName
                    + @"(""Test"", ""Declaration"", Scope=""Class"", Target=""C"")]
[module: "
                    + attrName
                    + @"(""Test"", ""Declaration"", Scope=""Type"", Target=""E"")]
[module: "
                    + attrName
                    + @"(""Test"", ""Declaration"", Scope=""Class"", Target=""E"")]
...
<module: "
                    + attrName
                    + @"UndeclaredIdentifier, ""Comment"")>
<module: "
                    + attrName
                    + @"(""Test"", UndeclaredIdentifier)>
<module: "
                    + attrName
                    + @"(""Test"", ""Comment"", Scope:=UndeclaredIdentifier, Target:=""C"")>
<module: "
                    + attrName
                    + @"(""Test"", ""Comment"", Scope:=""Type"", Target:=UndeclaredIdentifier)>
...
",
        ...
        protected async Task VerifyBasicAsync(
            string source,
        ...
        protected abstract Task VerifyAsync(
            string source,
            string language,
            DiagnosticAnalyzer[] analyzers,
        ...
        )
        {
            ...
            Assert.True(
                spans.Length > 0,
                "Must specify a span within which to generate diagnostics on each token"
            );

            return VerifyAsync(
                source,
                language,
                new DiagnosticAnalyzer[] { new WarningOnTokenAnalyzer(spans) },
                diagnostics
            );
        }
        ...
        {
            var arguments =
                this.ConsiderArgumentsForComparingDiagnostics && squiggledText != null
                    ? new[] { squiggledText }
                    : null;
