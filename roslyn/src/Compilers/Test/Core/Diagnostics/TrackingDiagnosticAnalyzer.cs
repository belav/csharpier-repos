...
namespace Microsoft.CodeAnalysis.Test.Utilities
{
        ...
        where TLanguageKindEnum : struct
    {
        ...
        )
        {
            ...
            {
                expectedArguments = expectedArguments.Where(a =>
                    !symbolKindsWithNoCodeBlocks.Contains(a.SymbolKind)
                );
            }

            expectedArguments = expectedArguments.Where(a =>
                IsOnCodeBlockSupported(a.SymbolKind, a.MethodKind, a.ReturnsVoid)
            );
