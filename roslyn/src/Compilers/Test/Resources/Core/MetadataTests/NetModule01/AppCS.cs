...
namespace AppCS
{
    public class App
    {
        ...
        internal NS.Module.CS01.CS02.ModIGen2<Expression, object> AppProp
        {
            get { return new NS.Module.CS01.CS02.ModStructImplExp(); }
        }
    ...
    public class UseModule
    {
        ...
        ModVBClass.ModVBInnerEnum this[ModVBClass.ModVBInnerEnum p]
        {
            get { return p; }
        }
        ...
        {
            // x-modules
            NS.Module.CS01.CS02.ModClassImplImp<ModVBStruct.ModVBInnerStruct.ModVBInnerIGoo> v =
                null;
            if (null != AppField02)
            {
                v =
                    default(NS.Module.CS01.CS02.ModClassImplImp<ModVBStruct.ModVBInnerStruct.ModVBInnerIGoo>);
