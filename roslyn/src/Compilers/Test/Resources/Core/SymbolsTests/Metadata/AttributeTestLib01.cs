...
namespace AttributeUse
{
    ...
    public interface IGoo<
        [typevar: AllInheritMultiple(3.1415926)] T,
        [AllInheritMultiple('q', 2)] V
    >
    {
        // default: method
        [AllInheritMultiple(p3: 1.234f, p2: 1056, p1: "555")]
        // attribute on return, param
        [return: AllInheritMultiple(
            "obj",
            System.Reflection.BindingFlags.Instance | System.Reflection.BindingFlags.Static
        )]
        V Method(
            [param: DerivedAttribute(new sbyte[] { -1, 0, 1 }, ObjectField = typeof(IList<>))] T t
        );
    }

    // multiple attributes
    [AllInheritMultiple(new char[] { '1', '2' }, UIntField = 112233)]
    [type: AllInheritMultiple(
        new char[] { 'a', '\0', '\t' },
        AryField = new ulong[] { 0, 1, ulong.MaxValue }
    )]
    [AllInheritMultiple(
        null,
        "",
        null,
        "1234",
        AryProp = new object[2] { new ushort[] { 1 }, new ushort[] { 2, 3, 4 } }
    )]
    public class Goo<[typevar: AllInheritMultiple(null), AllInheritMultiple()] T> : IGoo<T, ushort>
    {
        // named parameters
        [field: AllInheritMultiple(
            p2: System.Reflection.BindingFlags.DeclaredOnly | System.Reflection.BindingFlags.Public,
            p1: -123
        )]
