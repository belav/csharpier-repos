...
namespace Interop
{
    ...
    [TypeIdentifier(
        ...
        "SGoo, INteropAttribute, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null"
    )]
    [
        Guid("C3957C2A-07DD-4A56-AF01-FFD56664600F"),
    ...
    public interface IBar
    {
        ...
        int MixedAttrMethod1(
            [In] [MarshalAs(UnmanagedType.U4)] uint v1,
        ...
        void IDispatchParameters(
            [MarshalAs(UnmanagedType.IDispatch)] object v1,
            [Out] [MarshalAs(UnmanagedType.IUnknown)] out object v2
        );
        ...
        string VariantParameters(
            [MarshalAs(
                UnmanagedType.CustomMarshaler,
                MarshalCookie = "YumYum",
                MarshalType = "IUnknown"
            )]
                object v1,
            [In] [Out] ref object v2
        );

        [LCIDConversion(1)]
        void DecimalStringParameter(
            [In] decimal v1,
            [MarshalAs(UnmanagedType.LPStr)] string v2,
