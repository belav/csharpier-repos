    ...
    void M()
    {
        void L()
        {
            ...
            comp.VerifyDiagnostics(
                ...
                //         void L()
                Diagnostic(ErrorCode.WRN_UnreferencedLocalFunction, "L")
                    .WithArguments("L")
                    .WithLocation(7, 14)
            );
        }
    ...
    void M()
    {
        void L1()
        {
            ...
            comp.VerifyDiagnostics(
                ...
                //         void L1()
                Diagnostic(ErrorCode.WRN_UnreferencedLocalFunction, "L1")
                    .WithArguments("L1")
                    .WithLocation(7, 14)
            );
        }
    ...
    void M()
    {
        void L1()
        {
            ...
            comp.VerifyDiagnostics(
                ...
                //             void L2() => x++;
                Diagnostic(ErrorCode.WRN_UnreferencedLocalFunction, "L2")
                    .WithArguments("L2")
                    .WithLocation(9, 18),
    ...
    public void M()
    {
        ...
        x++;
            ...
            comp.VerifyDiagnostics(
                ...
                //         Local();
                Diagnostic(ErrorCode.ERR_UseDefViolation, "Local()")
                    .WithArguments("x")
                    .WithLocation(12, 9)
            );
        }
    ...
    public static void M2()
    {
        ...
        IEnumerable<bool> L1()
        {
            ...
            comp.VerifyDiagnostics(
                ...
                //         w++;
                Diagnostic(ErrorCode.ERR_UseDefViolation, "w")
                    .WithArguments("w")
                    .WithLocation(13, 9),
    ...
    public static void Main()
    {
        ...
        Local2();
            ...
            comp.VerifyDiagnostics(
                ...
                //         Local2();
                Diagnostic(ErrorCode.ERR_UseDefViolation, "Local2()")
                    .WithArguments("x")
                    .WithLocation(9, 9)
            );
        }
    ...
    public static void Main()
    {
        ...
        f();
            ...
            comp.VerifyDiagnostics(
                ...
                //         System.Func<bool> f = L1;
                Diagnostic(ErrorCode.ERR_UseDefViolation, "L1")
                    .WithArguments("x")
                    .WithLocation(8, 31)
            );
        }
    ...
    public S(int x)
    {
        ...
        Local();
            ...
            comp.VerifyDiagnostics(
                ...
                //         Local();
                Diagnostic(ErrorCode.ERR_UseDefViolationField, "Local()")
                    .WithArguments("_x")
                    .WithLocation(12, 9),
    ...
    void M4()
    {
        ...
        void Local()
        {
            ...
            comp.VerifyDiagnostics(
                ...
                //         S s2 = s1; // unassigned
                Diagnostic(ErrorCode.ERR_UseDefViolation, "s1")
                    .WithArguments("s1")
                    .WithLocation(14, 16),
    ...
    void SkipField()
    {
        ...
        void Local()
        {
            ...
            comp.VerifyDiagnostics(
                ...
                //         Local1(); // unassigned
                Diagnostic(ErrorCode.ERR_UseDefViolationProperty, "Local1()")
                    .WithArguments("y")
                    .WithLocation(19, 9),
                // (28,9): error CS8079: Use of possibly unassigned auto-implemented property 'y'
                //         Local2();
                Diagnostic(ErrorCode.ERR_UseDefViolationProperty, "Local2()")
                    .WithArguments("y")
                    .WithLocation(28, 9),
                // (41,16): error CS0165: Use of unassigned local variable 'b1'
                //         B b2 = b1; // unassigned
                Diagnostic(ErrorCode.ERR_UseDefViolation, "b1")
                    .WithArguments("b1")
                    .WithLocation(41, 16),
                ...
                //         Local();
                Diagnostic(ErrorCode.ERR_UseDefViolationProperty, "Local()")
                    .WithArguments("y")
                    .WithLocation(61, 9),
    ...
    void FullAssign()
    {
        ...
        Local2();
            ...
            comp.VerifyDiagnostics(
                ...
                //         S s4 = s3;
                Diagnostic(ErrorCode.ERR_UseDefViolation, "s3")
                    .WithArguments("s3")
                    .WithLocation(54, 16),
                // (55,9): error CS0170: Use of possibly unassigned field 'Event'
                //         Local2();
                Diagnostic(ErrorCode.ERR_UseDefViolationField, "Local2()")
                    .WithArguments("Event")
                    .WithLocation(55, 9)
            );
        }
    ...
    void M()
    {
        ...
        foreach (var i in items)
        {
            ...
            comp.VerifyDiagnostics(
                ...
                //                 i = 4;
                Diagnostic(ErrorCode.ERR_AssgReadonlyLocalCause, "i")
                    .WithArguments("i", "foreach iteration variable")
                    .WithLocation(11, 17)
            );
        }
    ...
    void M()
    {
        ...
        }
        {
            ...
            comp.VerifyDiagnostics(
                ...
                //             Goo();
                Diagnostic(ErrorCode.ERR_UseDefViolation, "Goo()")
                    .WithArguments("x")
                    .WithLocation(7, 13),
    ...
    public void M3()
    {
        ...
        S2 s6 = s5;
            ...
            comp.VerifyDiagnostics(
                ...
                //         S2 s6 = s5;
                Diagnostic(ErrorCode.ERR_UseDefViolation, "s5")
                    .WithArguments("s5")
                    .WithLocation(41, 17)
            );
        }
    ...
    static void Main(string[] args)
    {
        ...
        getGoo(1, out bool myBool);
            ...
            comp.VerifyDiagnostics(
                ...
                //         System.Collections.Generic.IEnumerable<string> getGoo(int count, out bool goobar)
                Diagnostic(ErrorCode.ERR_ParamUnassigned, "getGoo")
