...
struct Program
{
    ...
    static void Main(string[] args)
    {
            ...
            comp.VerifyDiagnostics(
                ...
                //         x.i = 1;
                Diagnostic(ErrorCode.ERR_UseDefViolationField, "x.i")
                    .WithArguments("i")
                    .WithLocation(16, 9),
                // (17,34): error CS8079: Use of possibly unassigned auto-implemented property 'x2'
                //         System.Console.WriteLine(x2.ii);
                Diagnostic(ErrorCode.ERR_UseDefViolationProperty, "x2")
                    .WithArguments("x2")
                    .WithLocation(17, 34),
...
struct Program
{
    ...
    static void Main(string[] args)
    {
            ...
            comp.VerifyDiagnostics(
                ...
                //         Goo(out x1);
                Diagnostic(ErrorCode.ERR_UseDefViolationProperty, "x1")
                    .WithArguments("x1")
                    .WithLocation(15, 17),
                // (16,9): error CS0188: The 'this' object cannot be used before all of its fields are assigned to
                //         Goo(ref x1);
                Diagnostic(ErrorCode.ERR_UseDefViolationThis, "Goo")
                    .WithArguments("this")
                    .WithLocation(16, 9),
                ...
                @"struct Derived
{
    ...
    private int x;
            ...
            comp.VerifyDiagnostics(
                ...
                //     Derived(int x) { }
                Diagnostic(ErrorCode.ERR_UnassignedThis, "Derived")
