...
";
            ...
            builder.Add(tree);
            analyzerConfigOptions = new CompilerAnalyzerConfigOptions(
                ImmutableDictionary<string, string>.Empty.Add("generated_code", "TRUE")
            );
            analyzerConfigOptionsPerTreeBuilder.Add(tree, analyzerConfigOptions);
    ...
    private int _field3 = 3;
            ...
            var field1 =
                tree1.GetRoot()
                    ...
                    .Single()
                    .Declaration.Variables.Single().Identifier;
            var semanticModel1 = compilation.GetSemanticModel(tree1);
        ...
        public async Task TestAdditionalFileAnalyzer(bool registerFromInitialize)
        {
            ...
            var analysisResult = await compilation.WithAnalyzers(analyzers, options)
            ...
            analysisResult = await compilation.WithAnalyzers(analyzers, options)
