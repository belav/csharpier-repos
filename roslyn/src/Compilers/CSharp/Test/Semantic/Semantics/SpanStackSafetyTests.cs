    ...
    void M()
    {
        ...
        s2 = (s1 = s2);
            ...
            comp.VerifyDiagnostics(
                ...
                //         s2 = (s1 = s2);
                Diagnostic(ErrorCode.ERR_EscapeLocal, "s1 = s2")
                    .WithArguments("s1")
                    .WithLocation(11, 15)
            );
        }
    ...
    void M<T>(T t)
    {
        ...
        { }
            ...
            comp.VerifyDiagnostics(
                // (7,13): warning CS0184: The given expression is never of the provided ('Span<int>') type
                //         if (t is Span<int>)
                Diagnostic(ErrorCode.WRN_IsAlwaysFalse, "t is Span<int>")
                    .WithArguments("System.Span<int>")
                    .WithLocation(7, 13),
                // (9,18): error CS8121: An expression of type 'T' cannot be handled by a pattern of type 'Span<int>'.
                //         if (t is Span<int> s)
    ...
    void M<T>(Span<int> s)
    {
        ...
        if (s is T t) { }
            ...
            comp.VerifyDiagnostics(
                ...
                //         if (s is T) { }
                Diagnostic(ErrorCode.WRN_IsAlwaysFalse, "s is T")
                    .WithArguments("T")
                    .WithLocation(7, 13),
        ...
        y = default;
                ...
                .VerifyDiagnostics(
                    ...
                    Diagnostic(ErrorCode.ERR_CallArgMixing, "M2(ref s1, out s2)")
                        .WithArguments("C.M2(ref System.Span<int>, out System.Span<int>)", "y")
                        .WithLocation(16, 9),
                    ...
                    Diagnostic(ErrorCode.ERR_CallArgMixing, "M2(ref s2, out s1)")
                        .WithArguments("C.M2(ref System.Span<int>, out System.Span<int>)", "x")
                        .WithLocation(17, 9),
