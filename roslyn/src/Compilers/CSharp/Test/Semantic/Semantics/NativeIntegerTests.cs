                ...
                @"interface I
{
    ...
    void F2(System.UIntPtr x, nuint y);
            ...
            VerifyTypes(
                ...
                (NamedTypeSymbol)method.Parameters[1].Type,
                signed: true
            );
                ...
                @"interface I
{
    ...
    void F2(System.UIntPtr x, nuint y);
        ...
        {
            Assert.Equal(
                signed ? SpecialType.System_IntPtr : SpecialType.System_UIntPtr,
                type.SpecialType
            );
        ...
        )
        {
            ...
            VerifyInterfaces(
                underlyingType,
                underlyingType.Interfaces,
                nativeIntegerType,
                nativeIntegerType.Interfaces
            );
            ...
            Assert.False(
                underlyingType.Equals(nativeIntegerType, SymbolEqualityComparer.IncludeNullability)
            );
            Assert.False(
                underlyingType.Equals(nativeIntegerType, SymbolEqualityComparer.ConsiderEverything)
            );
            Assert.True(
                underlyingType.Equals(nativeIntegerType, TypeCompareKind.IgnoreNativeIntegers)
            );
            ...
            )
            {
                ...
                for (int i = 0; i < underlyingInterface.TypeArguments.Length; i++)
                {
                    ...
                    Assert.Equal(
                        ...
                        nativeIntegerTypeArgument.Equals(
                            nativeIntegerType,
                            TypeCompareKind.AllIgnoreOptions
                        )
                    );
        ...
        private static void VerifyMembers(
            INamedTypeSymbol underlyingType,
            INamedTypeSymbol nativeIntegerType,
            bool signed
        )
        {
            ...
            AssertEx.Equal(
                nativeIntegerMembers.SelectAsArray(m => m.Name),
                nativeIntegerMemberNames
            );

            var expectedMembers = underlyingMembers
                .WhereAsArray(m => includeUnderlyingMember(m))
                .Sort(SymbolComparison)
                .SelectAsArray(m => m.ToTestDisplayString());
            var actualMembers = nativeIntegerMembers
                .WhereAsArray(m => includeNativeIntegerMember(m))
                .Sort(SymbolComparison)
                .SelectAsArray(
                    m =>
                        m.ToTestDisplayString()
                            .Replace(
                                signed ? "nint" : "nuint",
                                signed ? "System.IntPtr" : "System.UIntPtr"
                            )
                );
                ...
                switch (underlyingMember.Kind)
                {
                    ...
                    case SymbolKind.Property:
                        ...
                        return property.Parameters.Length == 0
                            && !IsSkippedPropertyName(property.Name);
                    default:
                        return false;
                }
            }
            ...
            {
                return !(
                    nativeIntegerMember is IMethodSymbol { MethodKind: MethodKind.Constructor }
                );
            }
        }
        ...
        )
        {
            ...
            VerifyInterfaces(
                underlyingType,
                underlyingType.InterfacesNoUseSiteDiagnostics(),
                nativeIntegerType,
                nativeIntegerType.InterfacesNoUseSiteDiagnostics()
            );
            VerifyInterfaces(
                underlyingType,
                underlyingType.GetDeclaredInterfaces(null),
                nativeIntegerType,
                nativeIntegerType.GetDeclaredInterfaces(null)
            );
        ...
        )
        {
            ...
            Assert.NotEqual(nativeIntegerType, underlyingType);
            Assert.False(
                underlyingType.Equals(nativeIntegerType, TypeCompareKind.ConsiderEverything)
            );
            Assert.False(
                nativeIntegerType.Equals(underlyingType, TypeCompareKind.ConsiderEverything)
            );
            Assert.True(
                underlyingType.Equals(nativeIntegerType, TypeCompareKind.IgnoreNativeIntegers)
            );
            Assert.True(
                nativeIntegerType.Equals(underlyingType, TypeCompareKind.IgnoreNativeIntegers)
            );
            Assert.Equal(underlyingType.GetHashCode(), nativeIntegerType.GetHashCode());
        }
        ...
        )
        {
            ...
            static bool includeUnderlyingMember(Symbol underlyingMember)
            {
                ...
                switch (underlyingMember.Kind)
                {
                    ...
                    case SymbolKind.Property:
                        ...
                        return property.ParameterCount == 0
                            && !IsSkippedPropertyName(property.Name);
                    default:
                        return false;
                }
            ...
            {
                return !(
                    nativeIntegerMember is MethodSymbol { MethodKind: MethodKind.Constructor }
                );
            }
        }
        ...
        private static void VerifyMember(Symbol member, Symbol underlyingMember, bool signed)
        {
                ...
                case SymbolKind.Property:

                    {
                        ...
                        verifyTypes(
                            ...
                            underlyingProperty.TypeWithAnnotations
                        );
                    }
                    break;
                case SymbolKind.Parameter:

                    {
                        ...
                        verifyTypes(
                            ...
                            underlyingParameter.TypeWithAnnotations
                        );
                    }
                    break;
                default:
            ...
            )
            {
                ...
                Assert.Equal(
                    containsType(fromMember, useNativeInteger: true),
                    containsType(fromUnderlyingMember, useNativeInteger: false)
                );
                Assert.NotEqual(
                    containsType(fromMember, useNativeInteger: true),
                    fromMember.Equals(fromUnderlyingMember, TypeCompareKind.ConsiderEverything)
                );
            }
        ...
        private static int SymbolComparison(Symbol x, Symbol y) =>
            SymbolComparison(x.ToTestDisplayString(), y.ToTestDisplayString());

        private static int SymbolComparison(ISymbol x, ISymbol y) =>
            SymbolComparison(x.ToTestDisplayString(), y.ToTestDisplayString());
        ...
        private static int SymbolComparison(string x, string y)
        {
            ...
            static string normalizeDisplayString(string s) =>
                s.Replace("System.IntPtr", "nint").Replace("System.UIntPtr", "nuint");
        }
                ...
                @"interface I
{
    ...
    void F2(System.UIntPtr x, nuint y);
            ...
            var diagnostics = new[]
            {
                ...
                //     void F1(System.IntPtr x, nint y);
                Diagnostic(ErrorCode.ERR_DottedTypeNameNotFoundInNS, "IntPtr")
                    .WithArguments("IntPtr", "System")
                    .WithLocation(3, 20),
                // (3,30): error CS0518: Predefined underlyingType 'System.IntPtr' is not defined or imported
                //     void F1(System.IntPtr x, nint y);
                Diagnostic(ErrorCode.ERR_PredefinedTypeNotFound, "nint")
                ...
                //     void F2(System.UIntPtr x, nuint y);
                Diagnostic(ErrorCode.ERR_DottedTypeNameNotFoundInNS, "UIntPtr")
                    .WithArguments("UIntPtr", "System")
                    .WithLocation(4, 20),
        ...
        private static void VerifyErrorType(
            NamedTypeSymbol type,
        ...
        private static void VerifyErrorTypes(
            NamedTypeSymbol underlyingType,
            NamedTypeSymbol nativeIntegerType,
            bool signed
        )
                ...
                @"namespace System
{
    ...
    public struct UIntPtr { }
            ...
            var comp = CreateCompilation(
                new AssemblyIdentity(assemblyName, new Version(1, 0, 0, 0)),
                new[] { source1 },
                references: null
            );
                ...
                @"namespace System
{
    ...
    public struct Int32 { }
            ...
            comp = CreateCompilation(
                new AssemblyIdentity(assemblyName, new Version(2, 0, 0, 0)),
                new[] { source2 },
                references: null
            );
            var ref2 = comp.EmitToImageReference();
    ...
    public struct UIntPtr { }
            ...
            var comp = CreateCompilation(
                new AssemblyIdentity(
                    "9ef8b1e0-1ae0-4af6-b9a1-00f2078f299e",
                    new Version(1, 0, 0, 0)
                ),
                new[] { source1 },
                references: null
                ...
                @"class C : B
{
            ...
            comp.VerifyDiagnostics(
                ...
                Diagnostic(ErrorCode.ERR_NoTypeDef, "B")
                    .WithArguments(
                        "System.Object",
                        "9ef8b1e0-1ae0-4af6-b9a1-00f2078f299e, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null"
                    )
                    .WithLocation(1, 11)
            );
                ...
                @"namespace System
{
    ...
    public sealed class AttributeUsageAttribute : Attribute
    {
        ...
        public AttributeUsageAttribute(AttributeTargets validOn)
        {
            ...
            var comp = CreateCompilation(
                new AssemblyIdentity(
                    "c804cc09-8f73-44a1-9cfe-9567bed1def6",
                    new Version(1, 0, 0, 0)
                ),
                new[] { source1 },
                references: null
                ...
                @"class B : A
{
            ...
            comp.VerifyDiagnostics(
                ...
                Diagnostic(ErrorCode.ERR_NoTypeDef, "A")
                    .WithArguments(
                        "System.IntPtr",
                        "c804cc09-8f73-44a1-9cfe-9567bed1def6, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null"
                    )
                    .WithLocation(1, 11)
            );
                    ...
                    @"interface I
{
    ...
    nuint F2();
            ...
            static void verifyCompilation(CSharpCompilation comp, bool includesIEquatable)
            {
                verifyInterfaces(
                    comp,
                    (NamedTypeSymbol)comp.GetMember<MethodSymbol>("I.F1").ReturnType,
                    SpecialType.System_IntPtr,
                    includesIEquatable
                );
                verifyInterfaces(
                    comp,
                    (NamedTypeSymbol)comp.GetMember<MethodSymbol>("I.F2").ReturnType,
            ...
            )
            {
                ...
                VerifyInterfaces(
                    underlyingType,
                    underlyingType.InterfacesNoUseSiteDiagnostics(null),
                    type,
                    interfaces
                );
                ...
                if (includesIEquatable)
                {
                    ...
                    Assert.Equal(
                        type,
                        @interface.TypeArgumentsWithAnnotationsNoUseSiteDiagnostics[0].Type
                    );
                }
            }
        }
                ...
                @"namespace System
{
    ...
    public struct Void { }
            ...
            static void verifyCreateNativeIntegerTypeSymbol(CSharpCompilation comp)
            {
                ...
                VerifyErrorType(
                    comp.CreateNativeIntegerTypeSymbol(signed: false),
                    SpecialType.System_UIntPtr,
                    isNativeInt: true
                );
                VerifyErrorType(
                ...
                VerifyErrorType(
                    ((Compilation)comp).CreateNativeIntegerTypeSymbol(signed: false),
                    SpecialType.System_UIntPtr,
                    isNativeInt: true
                );
            }
    ...
    static nuint F2()
    {
        ...
        return 0;
            ...
            comp.VerifyDiagnostics(
                ...
                //         _ = nint.Zero;
                Diagnostic(ErrorCode.ERR_NoSuchMember, "Zero")
                    .WithArguments("nint", "Zero")
                    .WithLocation(5, 18),
                // (6,18): error CS0117: 'nint' does not contain a definition for 'Size'
                //         _ = nint.Size;
                Diagnostic(ErrorCode.ERR_NoSuchMember, "Size")
                    .WithArguments("nint", "Size")
                    .WithLocation(6, 18),
                // (9,18): error CS0117: 'nint' does not contain a definition for 'Add'
                //         _ = nint.Add(x1, x2);
                Diagnostic(ErrorCode.ERR_NoSuchMember, "Add")
                    .WithArguments("nint", "Add")
                    .WithLocation(9, 18),
                // (10,18): error CS0117: 'nint' does not contain a definition for 'Subtract'
                //         _ = nint.Subtract(x1, x2);
                Diagnostic(ErrorCode.ERR_NoSuchMember, "Subtract")
                    .WithArguments("nint", "Subtract")
                    .WithLocation(10, 18),
                // (17,19): error CS0117: 'nuint' does not contain a definition for 'Zero'
                //         _ = nuint.Zero;
                Diagnostic(ErrorCode.ERR_NoSuchMember, "Zero")
                    .WithArguments("nuint", "Zero")
                    .WithLocation(17, 19),
                // (18,19): error CS0117: 'nuint' does not contain a definition for 'Size'
                //         _ = nuint.Size;
                Diagnostic(ErrorCode.ERR_NoSuchMember, "Size")
                    .WithArguments("nuint", "Size")
                    .WithLocation(18, 19),
                // (21,19): error CS0117: 'nuint' does not contain a definition for 'Add'
                //         _ = nuint.Add(y1, y2);
                Diagnostic(ErrorCode.ERR_NoSuchMember, "Add")
                    .WithArguments("nuint", "Add")
                    .WithLocation(21, 19),
                // (22,19): error CS0117: 'nuint' does not contain a definition for 'Subtract'
                //         _ = nuint.Subtract(y1, y2);
                Diagnostic(ErrorCode.ERR_NoSuchMember, "Subtract")
                    .WithArguments("nuint", "Subtract")
                    .WithLocation(22, 19)
            );

            verifyType(
                (NamedTypeSymbol)comp.GetMember<MethodSymbol>("Program.F1").ReturnType,
                signed: true
            );
            verifyType(
                (NamedTypeSymbol)comp.GetMember<MethodSymbol>("Program.F2").ReturnType,
                signed: false
            );
            ...
            var actualLocals = tree.GetRoot()
                ...
                .Select(d => model.GetDeclaredSymbol(d).ToTestDisplayString());
    ...
    unsafe static void F2(nuint u)
    {
        ...
        _ = u.ToString((string)null, (IFormatProvider)null);
            ...
            comp.VerifyDiagnostics(
                ...
                //         _ = i.ToInt32();
                Diagnostic(ErrorCode.ERR_NoSuchMemberOrExtension, "ToInt32")
                    .WithArguments("nint", "ToInt32")
                    .WithLocation(6, 15),
                ...
                //         _ = i.ToInt64();
                Diagnostic(ErrorCode.ERR_NoSuchMemberOrExtension, "ToInt64")
                    .WithArguments("nint", "ToInt64")
                    .WithLocation(7, 15),
                ...
                //         _ = i.ToUInt32();
                Diagnostic(ErrorCode.ERR_NoSuchMemberOrExtension, "ToUInt32")
                    .WithArguments("nint", "ToUInt32")
                    .WithLocation(8, 15),
                ...
                //         _ = i.ToUInt64();
                Diagnostic(ErrorCode.ERR_NoSuchMemberOrExtension, "ToUInt64")
                    .WithArguments("nint", "ToUInt64")
                    .WithLocation(9, 15),
                ...
                //         _ = i.ToPointer();
                Diagnostic(ErrorCode.ERR_NoSuchMemberOrExtension, "ToPointer")
                    .WithArguments("nint", "ToPointer")
                    .WithLocation(10, 15),
                ...
                //         _ = u.ToPointer();
                Diagnostic(ErrorCode.ERR_NoSuchMemberOrExtension, "ToPointer")
                    .WithArguments("nuint", "ToPointer")
                    .WithLocation(24, 15)
            );

            verifyType(
                (NamedTypeSymbol)comp.GetMember<MethodSymbol>("Program.F1").Parameters[0].Type,
                signed: true
            );
            verifyType(
                (NamedTypeSymbol)comp.GetMember<MethodSymbol>("Program.F2").Parameters[0].Type,
                signed: false
            );
    ...
    unsafe static void F2(nuint x, nuint y)
    {
        ...
        _ = x != y;
            ...
            comp.VerifyDiagnostics(
                ...
                //         _ = new nint(1);
                Diagnostic(ErrorCode.ERR_BadCtorArgCount, "nint")
                    .WithArguments("nint", "1")
                    .WithLocation(7, 17),
                ...
                //         _ = new nuint(1);
                Diagnostic(ErrorCode.ERR_BadCtorArgCount, "nuint")
                    .WithArguments("nuint", "1")
                    .WithLocation(25, 17),
            ...
            static void verifyType(NamedTypeSymbol type, bool signed)
            {
                ...
                var members = type.GetMembers().Sort(SymbolComparison);
                var actualMembers = members.SelectAsArray(m => m.ToTestDisplayString());
                var expectedMembers = new[] { $"{type}..ctor()", };
                AssertEx.Equal(expectedMembers, actualMembers);
...
class Program
{
    ...
    static void M2(nuint y)
    {
        ...
        _ = y.F();
            ...
            var actualLocals = tree.GetRoot()
                ...
                .OfType<VariableDeclaratorSyntax>()
                .Select(d => model.GetDeclaredSymbol(d).ToTestDisplayString());
            var expectedLocals = new[] { "nint x1", "nint x2", "nuint y1", "nuint y2", };
            AssertEx.Equal(expectedLocals, actualLocals);

            verifyType(
                (NamedTypeSymbol)comp.GetMember<MethodSymbol>("Program.M1").Parameters[0].Type,
                signed: true
            );
            verifyType(
                (NamedTypeSymbol)comp.GetMember<MethodSymbol>("Program.M2").Parameters[0].Type,
                signed: false
            );
    ...
    End Structure
End Namespace";
            var compA = CreateVisualBasicCompilation(
                sourceA,
                referencedAssemblies: Array.Empty<MetadataReference>()
            );
...
class Program
{
    ...
    static void M2(nuint y)
    {
        ...
        _ = y.F();
            ...
            var compB = CreateEmptyCompilation(
                sourceB,
                references: new[] { refA },
                parseOptions: TestOptions.Regular9
            );
            ...
            verifyType(
                (NamedTypeSymbol)compB.GetMember<MethodSymbol>("Program.M1").Parameters[0].Type,
                signed: true
            );
            verifyType(
                (NamedTypeSymbol)compB.GetMember<MethodSymbol>("Program.M2").Parameters[0].Type,
                signed: false
            );
    ...
    public struct UIntPtr
    {
        ...
        public static UIntPtr F3()
        {
            ...
            comp.VerifyDiagnostics(
                ...
                //             _ = nint.F1();
                Diagnostic(ErrorCode.ERR_NoSuchMember, "F1")
                    .WithArguments("nint", "F1")
                    .WithLocation(16, 22),
                ...
                //             _ = i.F2();
                Diagnostic(ErrorCode.ERR_NoSuchMemberOrExtension, "F2")
                    .WithArguments("nint", "F2")
                    .WithLocation(17, 19),
                // (28,23): error CS0117: 'nuint' does not contain a definition for 'F1'
                //             _ = nuint.F1();
                Diagnostic(ErrorCode.ERR_NoSuchMember, "F1")
                    .WithArguments("nuint", "F1")
                    .WithLocation(28, 23),
    ...
    static void F2(nuint y)
    {
        ...
        _ = nuint.F3();
            ...
            static void verifyType(NamedTypeSymbol type, bool signed)
            {
                ...
                var members = type.GetMembers().Sort(SymbolComparison);
                var actualMembers = members.SelectAsArray(m => m.ToTestDisplayString());
                var expectedMembers = new[] { $"{type} {type}.F3()", $"{type}..ctor()", };
                AssertEx.Equal(expectedMembers, actualMembers);
    ...
    static void F2(nuint y)
    {
        ...
        _ = y[0];
            ...
            comp.VerifyDiagnostics(
                ...
                //         _ = x.M<nint>();
                Diagnostic(ErrorCode.ERR_NoSuchMemberOrExtension, "M<nint>")
                    .WithArguments("nint", "M")
                    .WithLocation(5, 15),
                // (6,13): error CS0021: Cannot apply indexing with [] to an expression of type 'nint'
                //         _ = x[0];
                Diagnostic(ErrorCode.ERR_BadIndexLHS, "x[0]")
                    .WithArguments("nint")
                    .WithLocation(6, 13),
                ...
                //         _ = y.M<nuint>();
                Diagnostic(ErrorCode.ERR_NoSuchMemberOrExtension, "M<nuint>")
                    .WithArguments("nuint", "M")
                    .WithLocation(10, 15),
                // (11,13): error CS0021: Cannot apply indexing with [] to an expression of type 'nuint'
                //         _ = y[0];
                Diagnostic(ErrorCode.ERR_BadIndexLHS, "y[0]")
                    .WithArguments("nuint")
                    .WithLocation(11, 13)
            );
                ...
                @"class Program
{
    ...
    static void Report<T>(T[] items)
    {
        foreach (var item in items)
            ...
            var verifier = CompileAndVerify(
                comp,
                expectedOutput: @"System.IntPtr: -2147483648
System.IntPtr: -1
System.IntPtr: 0
System.IntPtr: 1
...
class B4 : A
{
    ...
    public void F2(System.UIntPtr y) { base.F2(y); }
            ...
            var diagnostics = new[]
            {
                ...
                //     public void F1(System.IntPtr x) { base.F1(x); }
                Diagnostic(ErrorCode.WRN_NewRequired, "F1")
                    .WithArguments("B2.F1(System.IntPtr)", "A.F1(nint)")
                    .WithLocation(8, 17),
                // (9,17): warning CS0108: 'B2.F2(UIntPtr)' hides inherited member 'A.F2(nuint)'. Use the new keyword if hiding was intended.
                //     public void F2(System.UIntPtr y) { base.F2(y); }
                Diagnostic(ErrorCode.WRN_NewRequired, "F2")
...
class C
{
    ...
    static void F(nuint y) { }
            ...
            comp.VerifyDiagnostics(
                ...
                //     void F(nint y);
                Diagnostic(ErrorCode.ERR_MemberAlreadyExists, "F")
                    .WithArguments("F", "I")
                    .WithLocation(5, 10),
...
interface I
{
    nint Add(nint x, nuint y);
            ...
            static void verify(CSharpCompilation comp)
            {
                ...
                var model = comp.GetSemanticModel(tree);
                var underlyingType = model.GetDeclaredSymbol(
                ...
                var method = model.GetDeclaredSymbol(
                    nodes.OfType<MethodDeclarationSyntax>().Single()
                );
    ...
    static void Main()
    {
        F(new nint(), new nuint());
            ...
            void verify(CSharpCompilation comp)
            {
                var verifier = CompileAndVerify(
                    comp,
                    expectedOutput: @"System.Int16
System.Object"
                );
                var method = comp.GetMember<MethodSymbol>("Program.F");
                Assert.Equal(
                    "System.Int16 Program.F(System.Int16 x, System.Object y)",
...
class Program
{
    static @nint F(nint x, nuint y) => x;
            ...
            static void verify(CSharpCompilation comp)
            {
                var method = comp.GetMember<MethodSymbol>("Program.F");
                Assert.Equal(
                    "System.Int16 Program.F(System.Int16 x, nuint y)",
                    method.ToTestDisplayString()
                );
                var underlyingType0 = (NamedTypeSymbol)method.Parameters[0].Type;
                var underlyingType1 = (NamedTypeSymbol)method.Parameters[1].Type;
...
class Program
{
    ...
    A2 F2() => default;
            ...
            var expectedDiagnostics = new[]
            {
                ...
                // using A1 = nint;
                Diagnostic(ErrorCode.ERR_SingleTypeNameNotFound, "nint")
                    .WithArguments("nint")
                    .WithLocation(1, 12),
                ...
                // using A2 = nuint;
                Diagnostic(ErrorCode.ERR_SingleTypeNameNotFound, "nuint")
                    .WithArguments("nuint")
                    .WithLocation(2, 12)
            };
    ...
    static void Main()
    {
        ...
        Console.WriteLine(nameof(nuint));
            ...
            comp.VerifyDiagnostics(
                ...
                //         Console.WriteLine(nameof(nint));
                Diagnostic(ErrorCode.ERR_NameNotInContext, "nint")
                    .WithArguments("nint")
                    .WithLocation(6, 34),
                // (7,34): error CS0103: The name 'nuint' does not exist in the current context
                //         Console.WriteLine(nameof(nuint));
                Diagnostic(ErrorCode.ERR_NameNotInContext, "nuint")
                    .WithArguments("nuint")
                    .WithLocation(7, 34)
            );
                ...
                @"unsafe class Program
{
    ...
    const int D = sizeof(nuint);
            ...
            comp.VerifyDiagnostics(
                ...
                //     const int A = sizeof(System.IntPtr);
                Diagnostic(ErrorCode.ERR_NotConstantExpression, "sizeof(System.IntPtr)")
                    .WithArguments("Program.A")
                    .WithLocation(3, 19),
                // (4,19): error CS0133: The expression being assigned to 'Program.B' must be constant
                //     const int B = sizeof(System.UIntPtr);
                Diagnostic(ErrorCode.ERR_NotConstantExpression, "sizeof(System.UIntPtr)")
                    .WithArguments("Program.B")
                    .WithLocation(4, 19),
                // (5,19): error CS0133: The expression being assigned to 'Program.C' must be constant
                //     const int C = sizeof(nint);
                Diagnostic(ErrorCode.ERR_NotConstantExpression, "sizeof(nint)")
                    .WithArguments("Program.C")
                    .WithLocation(5, 19),
                // (6,19): error CS0133: The expression being assigned to 'Program.D' must be constant
                //     const int D = sizeof(nuint);
                Diagnostic(ErrorCode.ERR_NotConstantExpression, "sizeof(nuint)")
  ...
  IL_0032:  ret
        ...
        public void BuiltInOperators()
        {
            ...
            static void verifyOperators(CSharpCompilation comp)
            {
                ...
                static void verifyUnaryOperators(
                    CSharpCompilation comp,
                ...
                )
                {
                    ...
                    verifyOperators(
                        operators,
                        (op, signed) => isNullableNativeInt(op.OperandType, signed),
                        expectedSigned,
                        expectedUnsigned
                    );
                }

                static void verifyBinaryOperators(
                    CSharpCompilation comp,
                ...
                )
                {
                    ...
                    verifyOperators(
                        operators,
                        (op, signed) => isNativeInt(op.LeftType, signed),
                        expected,
                        expected
                    );
                    verifyOperators(
                        operators,
                        (op, signed) => isNullableNativeInt(op.LeftType, signed),
                        expected,
                        expected
                    );
                }

                static void verifyOperators<T>(
                    ImmutableArray<T> operators,
        ...
        F4 = w;
            ...
            var diagnostics = new[]
            {
                ...
                Diagnostic(ErrorCode.ERR_NoImplicitConvCast, "F1")
                    .WithArguments("System.IntPtr", "long")
                    .WithLocation(9, 18),
                ...
                //         ulong y = F2;
                Diagnostic(ErrorCode.ERR_NoImplicitConvCast, "F2")
                    .WithArguments("System.UIntPtr", "ulong")
                    .WithLocation(10, 19),
                ...
                //         long? z = F3;
                Diagnostic(ErrorCode.ERR_NoImplicitConvCast, "F3")
                    .WithArguments("System.IntPtr?", "long?")
                    .WithLocation(11, 19),
                ...
                //         ulong? w = F4;
                Diagnostic(ErrorCode.ERR_NoImplicitConvCast, "F4")
                    .WithArguments("System.UIntPtr?", "ulong?")
                    .WithLocation(12, 20),
                ...
                Diagnostic(ErrorCode.ERR_NoImplicitConvCast, "x")
                    .WithArguments("int", "System.IntPtr")
                    .WithLocation(16, 14),
                ...
                Diagnostic(ErrorCode.ERR_NoImplicitConvCast, "y")
                    .WithArguments("uint", "System.UIntPtr")
                    .WithLocation(17, 14),
                ...
                //         F3 = z;
                Diagnostic(ErrorCode.ERR_NoImplicitConvCast, "z")
                    .WithArguments("int?", "System.IntPtr?")
                    .WithLocation(18, 14),
                ...
                //         F4 = w;
                Diagnostic(ErrorCode.ERR_NoImplicitConvCast, "w")
                    .WithArguments("uint?", "System.UIntPtr?")
                    .WithLocation(19, 14)
            };
                ...
                @"class B : A
{
    ...
    static void M2(int x, uint y, int? z, uint? w)
    {
        ...
        F4 = w;
            ...
            comp = CreateCompilation(
                sourceB,
                references: new[] { AsReference(comp, useCompilationReference) },
                parseOptions: useLatest ? TestOptions.Regular9 : TestOptions.Regular8
            );
            comp.VerifyDiagnostics();
            var verifier = CompileAndVerify(comp);
            verifier.VerifyIL(
    ...
    static void Main()
    {
        ...
        F--;
            ...
            comp.VerifyEmitDiagnostics(
                ...
                //         ++F;
                Diagnostic(ErrorCode.ERR_FeatureNotAvailableInVersion8, "++F")
                    .WithArguments("native-sized integers", "9.0")
                    .WithLocation(5, 9),
    ...
    static void Main()
    {
        ...
        _ = F1 >> 1;
            ...
            comp.VerifyEmitDiagnostics(
                // (5,13): error CS8400: Feature 'native-sized integers' is not available in C# 8.0. Please use language version 9.0 or greater.
                //         _ = F1 + F2;
                Diagnostic(ErrorCode.ERR_FeatureNotAvailableInVersion8, "F1 + F2")
                    .WithArguments("native-sized integers", "9.0")
                    .WithLocation(5, 13),
                // (6,13): error CS8400: Feature 'native-sized integers' is not available in C# 8.0. Please use language version 9.0 or greater.
                //         _ = F1 - F2;
                ...
                //         _ = F1 << 1;
                Diagnostic(ErrorCode.ERR_FeatureNotAvailableInVersion8, "F1 << 1")
                    .WithArguments("native-sized integers", "9.0")
                    .WithLocation(19, 13),
    ...
    static void Main()
    {
        ...
        _ = (F1, F1) != (F2, F2);
            ...
            comp.VerifyEmitDiagnostics(
                // (5,13): error CS8400: Feature 'native-sized integers' is not available in C# 8.0. Please use language version 9.0 or greater.
                //         _ = (F1, F1) == (F2, F2);
                Diagnostic(ErrorCode.ERR_FeatureNotAvailableInVersion8, "(F1, F1) == (F2, F2)")
                    .WithArguments("native-sized integers", "9.0")
                    .WithLocation(5, 13),
                // (5,13): error CS8400: Feature 'native-sized integers' is not available in C# 8.0. Please use language version 9.0 or greater.
                //         _ = (F1, F1) == (F2, F2);
    ...
    static void Main()
    {
        ...
        F >>= 1;
            ...
            comp.VerifyEmitDiagnostics(
                // (5,9): error CS8400: Feature 'native-sized integers' is not available in C# 8.0. Please use language version 9.0 or greater.
                //         F += 1;
                Diagnostic(ErrorCode.ERR_FeatureNotAvailableInVersion8, "F += 1")
                    .WithArguments("native-sized integers", "9.0")
                    .WithLocation(5, 9),
                // (6,9): error CS8400: Feature 'native-sized integers' is not available in C# 8.0. Please use language version 9.0 or greater.
                //         F -= 1;
...
{{
    ...
    {{
        ...
        _ = ~y;
            ...
            var actualOperators = nodes
                .Select(n => model.GetSymbolInfo(n).Symbol.ToTestDisplayString())
                .ToArray();
    ...
    static void Main()
    {
        ...
        Console.WriteLine(y);
            ...
            comp.VerifyDiagnostics(
                ...
                //         const nint y = checked((nint)x);
                Diagnostic(ErrorCode.ERR_NotConstantExpression, "checked((nint)x)")
                    .WithArguments("y")
                    .WithLocation(7, 24),
                // (7,32): warning CS8778: Constant value '1152921504606846975' may overflow 'nint' at runtime (use 'unchecked' syntax to override)
                //         const nint y = checked((nint)x);
                Diagnostic(ErrorCode.WRN_ConstOutOfRangeChecked, "(nint)x")
                    .WithArguments("1152921504606846975", "nint")
                    .WithLocation(7, 32)
            );
    ...
    static void Main()
    {
        ...
        Console.WriteLine(y);
            ...
            comp.VerifyDiagnostics(
                // (7,24): error CS0133: The expression being assigned to 'y' must be constant
                //         const nint y = unchecked((nint)x);
                Diagnostic(ErrorCode.ERR_NotConstantExpression, "unchecked((nint)x)")
                    .WithArguments("y")
                    .WithLocation(7, 24)
            );
    ...
    static void Main()
    {
        ...
        public void ConstantConversions_03()
        {
            ...
            constantConversions(
                ...
                "nint",
                "(int.MaxValue + 1U)",
                warningOutOfRangeChecked("nint", "2147483648"),
                "System.OverflowException",
                "2147483648",
                null,
                "-2147483648",
            ...
            constantConversions(
                ...
                "nint",
                "uint.MaxValue",
                warningOutOfRangeChecked("nint", "4294967295"),
                "System.OverflowException",
                "4294967295",
                null,
                "-1",
            ...
            constantConversions(
                ...
                "nint",
                "(int.MinValue - 1L)",
                warningOutOfRangeChecked("nint", "-2147483649"),
                "System.OverflowException",
                "-2147483649",
                null,
                "2147483647",
            ...
            constantConversions(
                ...
                "nint",
                "long.MinValue",
                warningOutOfRangeChecked("nint", "-9223372036854775808"),
                "System.OverflowException",
                "-9223372036854775808",
                null,
                "0",
            ...
            constantConversions(
                ...
                "nint",
                "long.MaxValue",
                warningOutOfRangeChecked("nint", "9223372036854775807"),
                "System.OverflowException",
                "9223372036854775807",
                null,
                "-1",
            ...
            constantConversions(
                ...
                "nint",
                "ulong.MaxValue",
                errorOutOfRangeChecked("nint", "18446744073709551615"),
                "System.OverflowException",
                "System.OverflowException",
                null,
                "-1",
            ...
            constantConversions(
                ...
                "nint",
                "(int.MinValue - 1M)",
                errorOutOfRange("nint", "-2147483649M"),
                "System.OverflowException",
                "-2147483649",
                errorOutOfRange("nint", "-2147483649M"),
                "2147483647",
            ...
            constantConversions(
                ...
                "nint",
                "(int.MaxValue + 1M)",
                errorOutOfRange("nint", "2147483648M"),
                "System.OverflowException",
                "2147483648",
                errorOutOfRange("nint", "2147483648M"),
                "-2147483648",
            ...
            constantConversions(
                ...
                "nint",
                "decimal.MinValue",
                errorOutOfRange("nint", "-79228162514264337593543950335M"),
                "System.OverflowException",
                "System.OverflowException",
                errorOutOfRange("nint", "-79228162514264337593543950335M"),
                "-1",
            ...
            constantConversions(
                ...
                "nuint",
                "-1",
                errorOutOfRangeChecked("nuint", "-1"),
                "System.OverflowException",
                "System.OverflowException",
                null,
                "4294967295",
            ...
            constantConversions(
                ...
                "nuint",
                "sbyte.MinValue",
                errorOutOfRangeChecked("nuint", "-128"),
                "System.OverflowException",
                "System.OverflowException",
                null,
                "4294967168",
            ...
            constantConversions(
                ...
                "nuint",
                "short.MinValue",
                errorOutOfRangeChecked("nuint", "-32768"),
                "System.OverflowException",
                "System.OverflowException",
                null,
                "4294934528",
            ...
            constantConversions(
                ...
                "nuint",
                "int.MinValue",
                errorOutOfRangeChecked("nuint", "-2147483648"),
                "System.OverflowException",
                "System.OverflowException",
                null,
                "2147483648",
            ...
            constantConversions(
                ...
                "nuint",
                "uint.MaxValue + 1L",
                warningOutOfRangeChecked("nuint", "4294967296"),
                "System.OverflowException",
                "4294967296",
                null,
                "0",
            ...
            constantConversions(
                ...
                "nuint",
                "long.MinValue",
                errorOutOfRangeChecked("nuint", "-9223372036854775808"),
                "System.OverflowException",
                "System.OverflowException",
                null,
                "0",
            ...
            constantConversions(
                ...
                "nuint",
                "long.MaxValue",
                warningOutOfRangeChecked("nuint", "9223372036854775807"),
                "System.OverflowException",
                "9223372036854775807",
                null,
                "4294967295",
            ...
            constantConversions(
                ...
                "nuint",
                "ulong.MaxValue",
                warningOutOfRangeChecked("nuint", "18446744073709551615"),
                "System.OverflowException",
                "18446744073709551615",
                null,
                "4294967295",
            ...
            constantConversions(
                ...
                "nuint",
                "(uint.MaxValue + 1M)",
                errorOutOfRange("nuint", "4294967296M"),
                "System.OverflowException",
                "4294967296",
                errorOutOfRange("nuint", "4294967296M"),
                "-1",
            ...
            constantConversions(
                ...
                "nuint",
                "decimal.MinValue",
                errorOutOfRange("nuint", "-79228162514264337593543950335M"),
                "System.OverflowException",
                "System.OverflowException",
                errorOutOfRange("nuint", "-79228162514264337593543950335M"),
                "-1",
            ...
            constantConversions(
                ...
                "nint",
                "(int.MinValue - 10000F)",
                warningOutOfRangeChecked("nint", "-2.147494E+09"),
                "System.OverflowException",
                "-2147493632",
                null,
                "-2147483648",
            ...
            constantConversions(
                ...
                "nint",
                "float.MinValue",
                errorOutOfRangeChecked("nint", "-3.402823E+38"),
                "System.OverflowException",
                "System.OverflowException",
                null,
                "-2147483648",
            ...
            constantConversions(
                ...
                "nint",
                "double.MinValue",
                errorOutOfRangeChecked("nint", "-1.79769313486232E+308"),
                "System.OverflowException",
                "System.OverflowException",
                null,
                "-2147483648",
            ...
            constantConversions(
                ...
                "nuint",
                "(uint.MaxValue + 1F)",
                warningOutOfRangeChecked("nuint", "4.294967E+09"),
                "System.OverflowException",
                "4294967296",
                null,
                "0",
            ...
            constantConversions(
                ...
                "nuint",
                "float.MinValue",
                errorOutOfRangeChecked("nuint", "-3.402823E+38"),
                "System.OverflowException",
                "System.OverflowException",
                null,
                "0",
            ...
            constantConversions(
                ...
                "nuint",
                "double.MinValue",
                errorOutOfRangeChecked("nuint", "-1.79769313486232E+308"),
                "System.OverflowException",
                "System.OverflowException",
                null,
                "0",
            ...
            static DiagnosticDescription errorOutOfRangeChecked(
                string destinationType,
                string value
            ) =>
                Diagnostic(ErrorCode.ERR_ConstOutOfRangeChecked, $"({destinationType})x")
                    .WithArguments(value, destinationType);
            static DiagnosticDescription errorOutOfRange(string destinationType, string value) =>
                Diagnostic(ErrorCode.ERR_ConstOutOfRange, $"({destinationType})x")
                    .WithArguments(value, destinationType);
            static DiagnosticDescription warningOutOfRangeChecked(
                string destinationType,
                string value
            ) =>
                Diagnostic(ErrorCode.WRN_ConstOutOfRangeChecked, $"({destinationType})x")
                    .WithArguments(value, destinationType);
            ...
            void constantConversions(
                ...
                string destinationType,
                string sourceValue,
                DiagnosticDescription checkedError,
                string checked32,
                string checked64,
            ...
            )
            {
                constantConversion(
                    ...
                    useChecked: true,
                    checkedError,
                    IntPtr.Size == 4 ? checked32 : checked64
                );
                constantConversion(
                    sourceType,
                    destinationType,
                    ...
                    useChecked: false,
                    uncheckedError,
                    IntPtr.Size == 4 ? unchecked32 : unchecked64
                );
            }

            void constantConversion(
                string sourceType,
                string destinationType,
                string sourceValue,
                bool useChecked,
    ...
    static void Main()
    {
        ...
        const nuint d = default;
            ...
            comp.VerifyDiagnostics(
                ...
                //         const System.IntPtr a = default;
                Diagnostic(ErrorCode.ERR_BadConstType, "System.IntPtr")
                    .WithArguments("System.IntPtr")
                    .WithLocation(6, 15),
                // (8,15): error CS0283: The type 'UIntPtr' cannot be declared const
                //         const System.UIntPtr c = default;
                Diagnostic(ErrorCode.ERR_BadConstType, "System.UIntPtr")
                    .WithArguments("System.UIntPtr")
                    .WithLocation(8, 15)
            );
        }
                ...
                @"class Program
{
    ...
    const nuint D = default(nuint);
            ...
            comp.VerifyDiagnostics(
                ...
                //     const System.IntPtr A = default(System.IntPtr);
                Diagnostic(ErrorCode.ERR_BadConstType, "const")
                    .WithArguments("System.IntPtr")
                    .WithLocation(3, 5),
                // (3,29): error CS0133: The expression being assigned to 'Program.A' must be constant
                //     const System.IntPtr A = default(System.IntPtr);
                Diagnostic(ErrorCode.ERR_NotConstantExpression, "default(System.IntPtr)")
                    .WithArguments("Program.A")
                    .WithLocation(3, 29),
                ...
                //     const System.UIntPtr C = default(System.UIntPtr);
                Diagnostic(ErrorCode.ERR_NotConstantExpression, "default(System.UIntPtr)")
                    .WithArguments("Program.C")
                    .WithLocation(5, 30)
            );
        }
                ...
                @"class Program
{
    ...
    const nuint E = uint.MaxValue;
            ...
            comp.VerifyDiagnostics();
            verify(
                (FieldSymbol)comp.GetMember("Program.A"),
                int.MinValue,
                signed: true,
                negative: true
            );
            ...
            verify(
                (FieldSymbol)comp.GetMember("Program.C"),
                int.MaxValue,
                signed: true,
                negative: false
            );
            ...
            verify(
                (FieldSymbol)comp.GetMember("Program.E"),
                uint.MaxValue,
                signed: false,
                negative: false
            );
...
class A
{
    ...
    static void F3(IntPtr? x = (IntPtr)(-3), UIntPtr? y = (UIntPtr)4)
    {
            ...
            comp.VerifyDiagnostics(
                ...
                //     static void F1(IntPtr x = (IntPtr)(-1), UIntPtr y = (UIntPtr)2)
                Diagnostic(ErrorCode.ERR_DefaultValueMustBeConstant, "(IntPtr)(-1)")
                    .WithArguments("x")
                    .WithLocation(7, 31),
                // (7,57): error CS1736: Default parameter value for 'y' must be a compile-time constant
                //     static void F1(IntPtr x = (IntPtr)(-1), UIntPtr y = (UIntPtr)2)
                Diagnostic(ErrorCode.ERR_DefaultValueMustBeConstant, "(UIntPtr)2")
                    .WithArguments("y")
                    .WithLocation(7, 57),
                // (13,32): error CS1736: Default parameter value for 'x' must be a compile-time constant
                //     static void F3(IntPtr? x = (IntPtr)(-3), UIntPtr? y = (UIntPtr)4)
                Diagnostic(ErrorCode.ERR_DefaultValueMustBeConstant, "(IntPtr)(-3)")
                    .WithArguments("x")
                    .WithLocation(13, 32),
                // (13,59): error CS1736: Default parameter value for 'y' must be a compile-time constant
                //     static void F3(IntPtr? x = (IntPtr)(-3), UIntPtr? y = (UIntPtr)4)
                Diagnostic(ErrorCode.ERR_DefaultValueMustBeConstant, "(UIntPtr)4")
                    .WithArguments("y")
                    .WithLocation(13, 59)
            );
        }
...
"
  ...
  IL_0007:  ret
            ...
            static string convFromToNullableT(
                string conversion,
                string sourceType,
                string destType
            ) =>
  ...
  IL_0022:  ret
            ...
            static string convAndExplicit(string method, string conv = null) =>
                conv is null
                    ? $@"{{
  // Code size        7 (0x7)
  .maxstack  1
  ...
  IL_0007:  ret
            ...
            static string convAndExplicitFromNullableT(
                string sourceType,
                string method,
                string conv = null
            ) =>
  ...
  IL_000d:  ret
            ...
            static string convAndExplicitToNullableT(
                string destType,
                string method,
                string conv = null
            ) =>
  ...
  IL_000c:  ret
            ...
            static string convAndExplicitFromToNullableT(
                string sourceType,
                string destType,
                string method,
                string conv = null
  ...
  IL_0026:  ret
            ...
            static string explicitAndConv(string method, string conv = null) =>
                conv is null
                    ? $@"{{
  // Code size        7 (0x7)
  .maxstack  1
  ...
  IL_0007:  ret
            ...
            static string explicitAndConvFromNullableT(
                string sourceType,
                string method,
                string conv = null
            ) =>
  ...
  IL_000d:  ret
            ...
            static string explicitAndConvToNullableT(
                string destType,
                string method,
                string conv = null
            ) =>
  ...
  IL_000c:  ret
            ...
            // https://github.com/dotnet/roslyn/issues/42834: Invalid code generated for nullable conversions
            // involving System.[U]IntPtr: the conversion is dropped.
            static string explicitAndConvFromToNullableT(
                string sourceType,
                string destType,
                string method,
                string conv = null
  ...
  IL_0026:  ret
            ...
            )
            {
                ...
                convert(
                    ...
                    skipTypeChecks: usesIntPtrOrUIntPtr(sourceType)
                        || usesIntPtrOrUIntPtr(destType),
                ...
                static bool usesIntPtrOrUIntPtr(string underlyingType) =>
                    underlyingType.Contains("IntPtr");
            }

            conversions(
                sourceType: "object",
                destType: "nint",
                expectedImplicitIL: null,
                @"{
  // Code size        7 (0x7)
  .maxstack  1
  IL_0000:  ldarg.0
  ...
  IL_0006:  ret
            ...
            conversions(
                ...
                destType: "nint",
                expectedImplicitIL: null,
                expectedExplicitIL: null
            );
            conversions(
                sourceType: "void*",
                destType: "nint",
                expectedImplicitIL: null,
                expectedExplicitIL: convNone,
                expectedCheckedIL: conv("conv.ovf.i.un")
            );
            conversions(
                sourceType: "delegate*<void>",
                destType: "nint",
                expectedImplicitIL: null,
                expectedExplicitIL: convNone,
                expectedCheckedIL: conv("conv.ovf.i.un")
            ...
            conversions(
                ...
                destType: "nint",
                expectedImplicitIL: null,
                expectedExplicitIL: conv("conv.i")
            );
            conversions(
                sourceType: "bool",
                destType: "nint",
            ...
            conversions(
                sourceType: "char",
                destType: "nint",
                expectedImplicitIL: conv("conv.u"),
                expectedExplicitIL: conv("conv.u")
            );
            conversions(
                sourceType: "sbyte",
                destType: "nint",
                expectedImplicitIL: conv("conv.i"),
                expectedExplicitIL: conv("conv.i")
            );
            conversions(
                sourceType: "byte",
            ...
            conversions(
                ...
                expectedImplicitIL: null,
                expectedExplicitIL: conv("conv.i"),
                expectedCheckedIL: conv("conv.ovf.i")
            );
            conversions(
                sourceType: "ulong",
                destType: "nint",
  ...
  IL_0007:  ret
            ...
            conversions(
                sourceType: "System.IntPtr",
                destType: "nint",
                expectedImplicitIL: convNone,
                expectedExplicitIL: convNone
            );
            conversions(
                sourceType: "System.UIntPtr",
                destType: "nint",
                expectedImplicitIL: null,
                expectedExplicitIL: null
            );
            conversions(
                ...
                destType: "nint",
                expectedImplicitIL: null,
                expectedExplicitIL: convFromNullableT("conv.i", "E")
            );
            conversions(
                sourceType: "bool?",
                destType: "nint",
            ...
            conversions(
                ...
                destType: "nint",
                expectedImplicitIL: null,
                expectedExplicitIL: convFromNullableT("conv.u", "char")
            );
            conversions(
                sourceType: "sbyte?",
                destType: "nint",
                expectedImplicitIL: null,
                expectedExplicitIL: convFromNullableT("conv.i", "sbyte")
            );
            conversions(
                sourceType: "byte?",
                destType: "nint",
                expectedImplicitIL: null,
                expectedExplicitIL: convFromNullableT("conv.u", "byte")
            );
            conversions(
                sourceType: "short?",
                destType: "nint",
                expectedImplicitIL: null,
                expectedExplicitIL: convFromNullableT("conv.i", "short")
            );
            conversions(
                sourceType: "ushort?",
                destType: "nint",
                expectedImplicitIL: null,
                expectedExplicitIL: convFromNullableT("conv.u", "ushort")
            );
            conversions(
                sourceType: "int?",
                destType: "nint",
                expectedImplicitIL: null,
                expectedExplicitIL: convFromNullableT("conv.i", "int")
            );
            conversions(
                sourceType: "uint?",
                destType: "nint",
                expectedImplicitIL: null,
                expectedExplicitIL: convFromNullableT("conv.u", "uint"),
                expectedCheckedIL: convFromNullableT("conv.ovf.i.un", "uint")
            );
            conversions(
                sourceType: "long?",
                destType: "nint",
                expectedImplicitIL: null,
                expectedExplicitIL: convFromNullableT("conv.i", "long"),
                expectedCheckedIL: convFromNullableT("conv.ovf.i", "long")
            );
            conversions(
                sourceType: "ulong?",
                destType: "nint",
                expectedImplicitIL: null,
                expectedExplicitIL: convFromNullableT("conv.i", "ulong"),
                expectedCheckedIL: convFromNullableT("conv.ovf.i.un", "ulong")
            );
            conversions(
                sourceType: "nint?",
                destType: "nint",
  ...
  IL_0007:  ret
            ...
            conversions(
                ...
                destType: "nint",
                expectedImplicitIL: null,
                expectedExplicitIL: convFromNullableT("conv.i", "nuint"),
            ...
            conversions(
                ...
                destType: "nint",
                expectedImplicitIL: null,
                expectedExplicitIL: convFromNullableT("conv.i", "float"),
                expectedCheckedIL: convFromNullableT("conv.ovf.i", "float")
            );
            conversions(
                sourceType: "double?",
                destType: "nint",
                expectedImplicitIL: null,
                expectedExplicitIL: convFromNullableT("conv.i", "double"),
                expectedCheckedIL: convFromNullableT("conv.ovf.i", "double")
            );
            conversions(
                sourceType: "decimal?",
                destType: "nint",
  ...
  IL_0007:  ret
            ...
            conversions(
                ...
                destType: "nint?",
                expectedImplicitIL: null,
                expectedExplicitIL: convToNullableT("conv.i", "nint")
            );
            conversions(
                sourceType: "bool",
                destType: "nint?",
            ...
            conversions(
                sourceType: "char",
                destType: "nint?",
                expectedImplicitIL: convToNullableT("conv.u", "nint"),
                expectedExplicitIL: convToNullableT("conv.u", "nint")
            );
            conversions(
                sourceType: "sbyte",
                destType: "nint?",
                expectedImplicitIL: convToNullableT("conv.i", "nint"),
                expectedExplicitIL: convToNullableT("conv.i", "nint")
            );
            conversions(
                sourceType: "byte",
            ...
            conversions(
                ...
                expectedImplicitIL: null,
                expectedExplicitIL: convToNullableT("conv.i", "nint"),
                expectedCheckedIL: convToNullableT("conv.ovf.i", "nint")
            );
            conversions(
                sourceType: "ulong",
                destType: "nint?",
  ...
  IL_0006:  ret
            ...
            conversions(
                ...
                destType: "nint?",
                expectedImplicitIL: null,
                expectedExplicitIL: convFromToNullableT("conv.i", "E", "nint")
            );
            conversions(
                sourceType: "bool?",
                destType: "nint?",
            ...
            conversions(
                sourceType: "char?",
                destType: "nint?",
                expectedImplicitIL: convFromToNullableT("conv.u", "char", "nint"),
                expectedExplicitIL: convFromToNullableT("conv.u", "char", "nint")
            );
            conversions(
                sourceType: "sbyte?",
                destType: "nint?",
                expectedImplicitIL: convFromToNullableT("conv.i", "sbyte", "nint"),
                expectedExplicitIL: convFromToNullableT("conv.i", "sbyte", "nint")
            );
            conversions(
                sourceType: "byte?",
                destType: "nint?",
                expectedImplicitIL: convFromToNullableT("conv.u", "byte", "nint"),
                expectedExplicitIL: convFromToNullableT("conv.u", "byte", "nint")
            );
            conversions(
                sourceType: "short?",
                destType: "nint?",
                expectedImplicitIL: convFromToNullableT("conv.i", "short", "nint"),
                expectedExplicitIL: convFromToNullableT("conv.i", "short", "nint")
            );
            conversions(
                sourceType: "ushort?",
                destType: "nint?",
                expectedImplicitIL: convFromToNullableT("conv.u", "ushort", "nint"),
                expectedExplicitIL: convFromToNullableT("conv.u", "ushort", "nint")
            );
            conversions(
                sourceType: "int?",
                destType: "nint?",
                expectedImplicitIL: convFromToNullableT("conv.i", "int", "nint"),
                expectedExplicitIL: convFromToNullableT("conv.i", "int", "nint")
            );
            conversions(
                sourceType: "uint?",
                destType: "nint?",
                expectedImplicitIL: null,
                expectedExplicitIL: convFromToNullableT("conv.u", "uint", "nint"),
                expectedCheckedIL: convFromToNullableT("conv.ovf.i.un", "uint", "nint")
            );
            conversions(
                sourceType: "long?",
                destType: "nint?",
                expectedImplicitIL: null,
                expectedExplicitIL: convFromToNullableT("conv.i", "long", "nint"),
                expectedCheckedIL: convFromToNullableT("conv.ovf.i", "long", "nint")
            );
            conversions(
                sourceType: "ulong?",
                destType: "nint?",
                expectedImplicitIL: null,
                expectedExplicitIL: convFromToNullableT("conv.i", "ulong", "nint"),
                expectedCheckedIL: convFromToNullableT("conv.ovf.i.un", "ulong", "nint")
            );
            conversions(
                sourceType: "nint?",
                destType: "nint?",
            ...
            conversions(
                ...
                destType: "nint?",
                expectedImplicitIL: null,
                expectedExplicitIL: convFromToNullableT("conv.i", "nuint", "nint"),
            ...
            conversions(
                ...
                destType: "nint?",
                expectedImplicitIL: null,
                expectedExplicitIL: convFromToNullableT("conv.i", "float", "nint"),
                expectedCheckedIL: convFromToNullableT("conv.ovf.i", "float", "nint")
            );
            conversions(
                sourceType: "double?",
                destType: "nint?",
                expectedImplicitIL: null,
                expectedExplicitIL: convFromToNullableT("conv.i", "double", "nint"),
                expectedCheckedIL: convFromToNullableT("conv.ovf.i", "double", "nint")
            );
            conversions(
                sourceType: "decimal?",
                destType: "nint?",
  ...
  IL_0006:  ret
            ...
            conversions(
                ...
                expectedImplicitIL: null,
                expectedExplicitIL: convNone,
                expectedCheckedIL: conv("conv.ovf.u")
            );
            conversions(
                sourceType: "nint",
                destType: "delegate*<void>",
                expectedImplicitIL: null,
                expectedExplicitIL: convNone,
                expectedCheckedIL: conv("conv.ovf.u")
            );
            conversions(
                ...
                destType: "E",
                expectedImplicitIL: null,
                expectedExplicitIL: conv("conv.i4"),
                expectedCheckedIL: conv("conv.ovf.i4")
            );
            conversions(
                sourceType: "nint",
                destType: "bool",
            ...
            conversions(
                ...
                destType: "char",
                expectedImplicitIL: null,
                expectedExplicitIL: conv("conv.u2"),
                expectedCheckedIL: conv("conv.ovf.u2")
            );
            conversions(
                sourceType: "nint",
                destType: "sbyte",
                expectedImplicitIL: null,
                expectedExplicitIL: conv("conv.i1"),
                expectedCheckedIL: conv("conv.ovf.i1")
            );
            conversions(
                sourceType: "nint",
                destType: "byte",
                expectedImplicitIL: null,
                expectedExplicitIL: conv("conv.u1"),
                expectedCheckedIL: conv("conv.ovf.u1")
            );
            conversions(
                sourceType: "nint",
                destType: "short",
                expectedImplicitIL: null,
                expectedExplicitIL: conv("conv.i2"),
                expectedCheckedIL: conv("conv.ovf.i2")
            );
            conversions(
                sourceType: "nint",
                destType: "ushort",
            ...
            conversions(
                ...
                destType: "uint",
                expectedImplicitIL: null,
                expectedExplicitIL: conv("conv.u4"),
                expectedCheckedIL: conv("conv.ovf.u4")
            );
            conversions(
                sourceType: "nint",
                destType: "long",
                expectedImplicitIL: conv("conv.i8"),
                expectedExplicitIL: conv("conv.i8")
            );
            conversions(
                sourceType: "nint",
                destType: "ulong",
                expectedImplicitIL: null,
                expectedExplicitIL: conv("conv.i8"),
                expectedCheckedIL: conv("conv.ovf.u8")
            );
            conversions(
                sourceType: "nint",
                destType: "float",
                expectedImplicitIL: conv("conv.r4"),
                expectedExplicitIL: conv("conv.r4")
            );
            conversions(
                sourceType: "nint",
                destType: "double",
                expectedImplicitIL: conv("conv.r8"),
                expectedExplicitIL: conv("conv.r8")
            );
            conversions(
                sourceType: "nint",
                destType: "decimal",
  ...
  IL_0007:  ret
            ...
            conversions(
                sourceType: "nint",
                destType: "System.IntPtr",
                expectedImplicitIL: convNone,
                expectedExplicitIL: convNone
            );
            conversions(
                sourceType: "nint",
                destType: "System.UIntPtr",
                expectedImplicitIL: null,
                expectedExplicitIL: null
            ); // https://github.com/dotnet/roslyn/issues/42560: Allow explicitly casting nint to UIntPtr.
            conversions(
                sourceType: "nint",
                destType: "E?",
                expectedImplicitIL: null,
                expectedExplicitIL: convToNullableT("conv.i4", "E"),
                expectedCheckedIL: convToNullableT("conv.ovf.i4", "E")
            );
            conversions(
                sourceType: "nint",
                destType: "bool?",
            ...
            conversions(
                ...
                destType: "char?",
                expectedImplicitIL: null,
                expectedExplicitIL: convToNullableT("conv.u2", "char"),
                expectedCheckedIL: convToNullableT("conv.ovf.u2", "char")
            );
            conversions(
                sourceType: "nint",
                destType: "sbyte?",
                expectedImplicitIL: null,
                expectedExplicitIL: convToNullableT("conv.i1", "sbyte"),
                expectedCheckedIL: convToNullableT("conv.ovf.i1", "sbyte")
            );
            conversions(
                sourceType: "nint",
                destType: "byte?",
                expectedImplicitIL: null,
                expectedExplicitIL: convToNullableT("conv.u1", "byte"),
                expectedCheckedIL: convToNullableT("conv.ovf.u1", "byte")
            );
            conversions(
                sourceType: "nint",
                destType: "short?",
                expectedImplicitIL: null,
                expectedExplicitIL: convToNullableT("conv.i2", "short"),
                expectedCheckedIL: convToNullableT("conv.ovf.i2", "short")
            );
            conversions(
                sourceType: "nint",
                destType: "ushort?",
                expectedImplicitIL: null,
                expectedExplicitIL: convToNullableT("conv.u2", "ushort"),
                expectedCheckedIL: convToNullableT("conv.ovf.u2", "ushort")
            );
            conversions(
                sourceType: "nint",
                destType: "int?",
                expectedImplicitIL: null,
                expectedExplicitIL: convToNullableT("conv.i4", "int"),
                expectedCheckedIL: convToNullableT("conv.ovf.i4", "int")
            );
            conversions(
                sourceType: "nint",
                destType: "uint?",
                expectedImplicitIL: null,
                expectedExplicitIL: convToNullableT("conv.u4", "uint"),
                expectedCheckedIL: convToNullableT("conv.ovf.u4", "uint")
            );
            conversions(
                sourceType: "nint",
                destType: "long?",
                expectedImplicitIL: convToNullableT("conv.i8", "long"),
                expectedExplicitIL: convToNullableT("conv.i8", "long")
            );
            conversions(
                sourceType: "nint",
                destType: "ulong?",
                expectedImplicitIL: null,
                expectedExplicitIL: convToNullableT("conv.i8", "ulong"),
                expectedCheckedIL: convToNullableT("conv.ovf.u8", "ulong")
            );
            conversions(
                sourceType: "nint",
                destType: "float?",
                expectedImplicitIL: convToNullableT("conv.r4", "float"),
                expectedExplicitIL: convToNullableT("conv.r4", "float"),
                null
            );
            conversions(
                sourceType: "nint",
                destType: "double?",
                expectedImplicitIL: convToNullableT("conv.r8", "double"),
                expectedExplicitIL: convToNullableT("conv.r8", "double"),
                null
            );
            conversions(
                sourceType: "nint",
  ...
  IL_0006:  ret
            ...
            conversions(
                ...
                destType: "E",
                expectedImplicitIL: null,
                expectedExplicitIL: convFromNullableT("conv.i4", "nint"),
                expectedCheckedIL: convFromNullableT("conv.ovf.i4", "nint")
            );
            conversions(
                sourceType: "nint?",
                destType: "bool",
            ...
            conversions(
                ...
                destType: "char",
                expectedImplicitIL: null,
                expectedExplicitIL: convFromNullableT("conv.u2", "nint"),
                expectedCheckedIL: convFromNullableT("conv.ovf.u2", "nint")
            );
            conversions(
                sourceType: "nint?",
                destType: "sbyte",
                expectedImplicitIL: null,
                expectedExplicitIL: convFromNullableT("conv.i1", "nint"),
                expectedCheckedIL: convFromNullableT("conv.ovf.i1", "nint")
            );
            conversions(
                sourceType: "nint?",
                destType: "byte",
                expectedImplicitIL: null,
                expectedExplicitIL: convFromNullableT("conv.u1", "nint"),
                expectedCheckedIL: convFromNullableT("conv.ovf.u1", "nint")
            );
            conversions(
                sourceType: "nint?",
                destType: "short",
                expectedImplicitIL: null,
                expectedExplicitIL: convFromNullableT("conv.i2", "nint"),
                expectedCheckedIL: convFromNullableT("conv.ovf.i2", "nint")
            );
            conversions(
                sourceType: "nint?",
                destType: "ushort",
            ...
            conversions(
                ...
                destType: "uint",
                expectedImplicitIL: null,
                expectedExplicitIL: convFromNullableT("conv.u4", "nint"),
                expectedCheckedIL: convFromNullableT("conv.ovf.u4", "nint")
            );
            conversions(
                sourceType: "nint?",
                destType: "long",
                expectedImplicitIL: null,
                expectedExplicitIL: convFromNullableT("conv.i8", "nint")
            );
            conversions(
                sourceType: "nint?",
                destType: "ulong",
                expectedImplicitIL: null,
                expectedExplicitIL: convFromNullableT("conv.i8", "nint"),
                expectedCheckedIL: convFromNullableT("conv.ovf.u8", "nint")
            );
            conversions(
                sourceType: "nint?",
                destType: "float",
                expectedImplicitIL: null,
                expectedExplicitIL: convFromNullableT("conv.r4", "nint")
            );
            conversions(
                sourceType: "nint?",
                destType: "double",
                expectedImplicitIL: null,
                expectedExplicitIL: convFromNullableT("conv.r8", "nint")
            );
            conversions(
                sourceType: "nint?",
                destType: "decimal",
  ...
  IL_0007:  ret
            ...
            conversions(
                ...
                destType: "E?",
                expectedImplicitIL: null,
                expectedExplicitIL: convFromToNullableT("conv.i4", "nint", "E"),
                expectedCheckedIL: convFromToNullableT("conv.ovf.i4", "nint", "E")
            );
            conversions(
                sourceType: "nint?",
                destType: "bool?",
            ...
            conversions(
                ...
                destType: "char?",
                expectedImplicitIL: null,
                expectedExplicitIL: convFromToNullableT("conv.u2", "nint", "char"),
                expectedCheckedIL: convFromToNullableT("conv.ovf.u2", "nint", "char")
            );
            conversions(
                sourceType: "nint?",
                destType: "sbyte?",
                expectedImplicitIL: null,
                expectedExplicitIL: convFromToNullableT("conv.i1", "nint", "sbyte"),
                expectedCheckedIL: convFromToNullableT("conv.ovf.i1", "nint", "sbyte")
            );
            conversions(
                sourceType: "nint?",
                destType: "byte?",
                expectedImplicitIL: null,
                expectedExplicitIL: convFromToNullableT("conv.u1", "nint", "byte"),
            ...
            conversions(
                ...
                destType: "short?",
                expectedImplicitIL: null,
                expectedExplicitIL: convFromToNullableT("conv.i2", "nint", "short"),
                expectedCheckedIL: convFromToNullableT("conv.ovf.i2", "nint", "short")
            );
            conversions(
                sourceType: "nint?",
                destType: "ushort?",
                expectedImplicitIL: null,
                expectedExplicitIL: convFromToNullableT("conv.u2", "nint", "ushort"),
                expectedCheckedIL: convFromToNullableT("conv.ovf.u2", "nint", "ushort")
            );
            conversions(
                sourceType: "nint?",
                destType: "int?",
                expectedImplicitIL: null,
                expectedExplicitIL: convFromToNullableT("conv.i4", "nint", "int"),
                expectedCheckedIL: convFromToNullableT("conv.ovf.i4", "nint", "int")
            );
            conversions(
                sourceType: "nint?",
                destType: "uint?",
                expectedImplicitIL: null,
                expectedExplicitIL: convFromToNullableT("conv.u4", "nint", "uint"),
                expectedCheckedIL: convFromToNullableT("conv.ovf.u4", "nint", "uint")
            );
            conversions(
                sourceType: "nint?",
                destType: "long?",
                expectedImplicitIL: convFromToNullableT("conv.i8", "nint", "long"),
                expectedExplicitIL: convFromToNullableT("conv.i8", "nint", "long")
            );
            conversions(
                sourceType: "nint?",
                destType: "ulong?",
                expectedImplicitIL: null,
                expectedExplicitIL: convFromToNullableT("conv.i8", "nint", "ulong"),
                expectedCheckedIL: convFromToNullableT("conv.ovf.u8", "nint", "ulong")
            );
            conversions(
                sourceType: "nint?",
                destType: "float?",
                expectedImplicitIL: convFromToNullableT("conv.r4", "nint", "float"),
                expectedExplicitIL: convFromToNullableT("conv.r4", "nint", "float"),
                null
            );
            conversions(
                sourceType: "nint?",
                destType: "double?",
                expectedImplicitIL: convFromToNullableT("conv.r8", "nint", "double"),
                expectedExplicitIL: convFromToNullableT("conv.r8", "nint", "double"),
                null
            );
            conversions(
                sourceType: "nint?",
  ...
  IL_0006:  ret
            ...
            conversions(
                ...
                expectedImplicitIL: null,
                expectedExplicitIL: conv("conv.u"),
                expectedCheckedIL: conv("conv.ovf.u.un")
            );
            conversions(
                sourceType: "nint",
                destType: "nuint",
  ...
  IL_0007:  ret
            ...
            conversions(
                ...
                expectedImplicitIL: null,
                expectedExplicitIL: convFromNullableT("conv.i", "E"),
                expectedCheckedIL: convFromNullableT("conv.ovf.u", "E")
            );
            conversions(
                sourceType: "bool?",
                destType: "nuint",
            ...
            conversions(
                ...
                expectedImplicitIL: null,
                expectedExplicitIL: convFromNullableT("conv.i", "sbyte"),
                expectedCheckedIL: convFromNullableT("conv.ovf.u", "sbyte")
            );
            conversions(
                sourceType: "byte?",
                destType: "nuint",
            ...
            conversions(
                ...
                expectedImplicitIL: null,
                expectedExplicitIL: convFromNullableT("conv.i", "short"),
                expectedCheckedIL: convFromNullableT("conv.ovf.u", "short")
            );
            conversions(
                sourceType: "ushort?",
                destType: "nuint",
            ...
            conversions(
                ...
                expectedImplicitIL: null,
                expectedExplicitIL: convFromNullableT("conv.i", "int"),
                expectedCheckedIL: convFromNullableT("conv.ovf.u", "int")
            );
            conversions(
                sourceType: "uint?",
                destType: "nuint",
            ...
            conversions(
                ...
                destType: "nuint",
                expectedImplicitIL: null,
                expectedExplicitIL: convFromNullableT("conv.u", "long"),
                expectedCheckedIL: convFromNullableT("conv.ovf.u", "long")
            );
            conversions(
                sourceType: "ulong?",
                destType: "nuint",
                expectedImplicitIL: null,
                expectedExplicitIL: convFromNullableT("conv.u", "ulong"),
                expectedCheckedIL: convFromNullableT("conv.ovf.u.un", "ulong")
            );
            conversions(
                sourceType: "nint?",
                destType: "nuint",
                expectedImplicitIL: null,
                expectedExplicitIL: convFromNullableT("conv.u", "nint"),
  ...
  IL_0007:  ret
            ...
            conversions(
                ...
                destType: "nuint",
                expectedImplicitIL: null,
                expectedExplicitIL: convFromNullableT("conv.u", "float"),
                expectedCheckedIL: convFromNullableT("conv.ovf.u", "float")
            );
            conversions(
                sourceType: "double?",
                destType: "nuint",
                expectedImplicitIL: null,
                expectedExplicitIL: convFromNullableT("conv.u", "double"),
                expectedCheckedIL: convFromNullableT("conv.ovf.u", "double")
            );
            conversions(
                sourceType: "decimal?",
                destType: "nuint",
  ...
  IL_0006:  ret
            ...
            conversions(
                ...
                destType: "nuint?",
                expectedImplicitIL: null,
                expectedExplicitIL: convToNullableT("conv.i", "nuint"),
            ...
            conversions(
                sourceType: "char",
                destType: "nuint?",
                expectedImplicitIL: convToNullableT("conv.u", "nuint"),
                expectedExplicitIL: convToNullableT("conv.u", "nuint")
            );
            conversions(
                sourceType: "sbyte",
                destType: "nuint?",
            ...
            conversions(
                ...
                expectedImplicitIL: null,
                expectedExplicitIL: convToNullableT("conv.u", "nuint"),
                expectedCheckedIL: convToNullableT("conv.ovf.u.un", "nuint")
            );
            conversions(
                sourceType: "nint",
                destType: "nuint?",
  ...
  IL_0006:  ret
            ...
            conversions(
                ...
                destType: "nuint?",
                expectedImplicitIL: null,
                expectedExplicitIL: convFromToNullableT("conv.i", "E", "nuint"),
                expectedCheckedIL: convFromToNullableT("conv.ovf.u", "E", "nuint")
            );
            conversions(
                sourceType: "bool?",
                destType: "nuint?",
            ...
            conversions(
                sourceType: "char?",
                destType: "nuint?",
                expectedImplicitIL: convFromToNullableT("conv.u", "char", "nuint"),
                expectedExplicitIL: convFromToNullableT("conv.u", "char", "nuint")
            );
            conversions(
                sourceType: "sbyte?",
                destType: "nuint?",
                expectedImplicitIL: null,
                expectedExplicitIL: convFromToNullableT("conv.i", "sbyte", "nuint"),
                expectedCheckedIL: convFromToNullableT("conv.ovf.u", "sbyte", "nuint")
            );
            conversions(
                sourceType: "byte?",
                destType: "nuint?",
                expectedImplicitIL: convFromToNullableT("conv.u", "byte", "nuint"),
                expectedExplicitIL: convFromToNullableT("conv.u", "byte", "nuint")
            );
            conversions(
                sourceType: "short?",
                destType: "nuint?",
                expectedImplicitIL: null,
                expectedExplicitIL: convFromToNullableT("conv.i", "short", "nuint"),
                expectedCheckedIL: convFromToNullableT("conv.ovf.u", "short", "nuint")
            );
            conversions(
                sourceType: "ushort?",
                destType: "nuint?",
                expectedImplicitIL: convFromToNullableT("conv.u", "ushort", "nuint"),
                expectedExplicitIL: convFromToNullableT("conv.u", "ushort", "nuint")
            );
            conversions(
                sourceType: "int?",
                destType: "nuint?",
                expectedImplicitIL: null,
                expectedExplicitIL: convFromToNullableT("conv.i", "int", "nuint"),
                expectedCheckedIL: convFromToNullableT("conv.ovf.u", "int", "nuint")
            );
            conversions(
                sourceType: "uint?",
                destType: "nuint?",
                expectedImplicitIL: convFromToNullableT("conv.u", "uint", "nuint"),
                expectedExplicitIL: convFromToNullableT("conv.u", "uint", "nuint")
            );
            conversions(
                sourceType: "long?",
                destType: "nuint?",
                expectedImplicitIL: null,
                expectedExplicitIL: convFromToNullableT("conv.u", "long", "nuint"),
                expectedCheckedIL: convFromToNullableT("conv.ovf.u", "long", "nuint")
            );
            conversions(
                sourceType: "ulong?",
                destType: "nuint?",
                expectedImplicitIL: null,
                expectedExplicitIL: convFromToNullableT("conv.u", "ulong", "nuint"),
                expectedCheckedIL: convFromToNullableT("conv.ovf.u.un", "ulong", "nuint")
            );
            conversions(
                sourceType: "nint?",
                destType: "nuint?",
                expectedImplicitIL: null,
                expectedExplicitIL: convFromToNullableT("conv.u", "nint", "nuint"),
            ...
            conversions(
                ...
                destType: "nuint?",
                expectedImplicitIL: null,
                expectedExplicitIL: convFromToNullableT("conv.u", "float", "nuint"),
                expectedCheckedIL: convFromToNullableT("conv.ovf.u", "float", "nuint")
            );
            conversions(
                sourceType: "double?",
                destType: "nuint?",
                expectedImplicitIL: null,
                expectedExplicitIL: convFromToNullableT("conv.u", "double", "nuint"),
                expectedCheckedIL: convFromToNullableT("conv.ovf.u", "double", "nuint")
            );
            conversions(
                sourceType: "decimal?",
                destType: "nuint?",
  ...
  IL_0006:  ret
            ...
            conversions(
                ...
                expectedImplicitIL: null,
                expectedExplicitIL: conv("conv.i4"),
                expectedCheckedIL: conv("conv.ovf.i4.un")
            );
            conversions(
                sourceType: "nuint",
                destType: "bool",
            ...
            conversions(
                ...
                expectedImplicitIL: null,
                expectedExplicitIL: conv("conv.u2"),
                expectedCheckedIL: conv("conv.ovf.u2.un")
            );
            conversions(
                sourceType: "nuint",
                destType: "sbyte",
                expectedImplicitIL: null,
                expectedExplicitIL: conv("conv.i1"),
                expectedCheckedIL: conv("conv.ovf.i1.un")
            );
            conversions(
                sourceType: "nuint",
                destType: "byte",
                expectedImplicitIL: null,
                expectedExplicitIL: conv("conv.u1"),
                expectedCheckedIL: conv("conv.ovf.u1.un")
            );
            conversions(
                sourceType: "nuint",
                destType: "short",
                expectedImplicitIL: null,
                expectedExplicitIL: conv("conv.i2"),
                expectedCheckedIL: conv("conv.ovf.i2.un")
            );
            conversions(
                sourceType: "nuint",
                destType: "ushort",
            ...
            conversions(
                ...
                expectedImplicitIL: null,
                expectedExplicitIL: conv("conv.u4"),
                expectedCheckedIL: conv("conv.ovf.u4.un")
            );
            conversions(
                sourceType: "nuint",
                destType: "long",
                expectedImplicitIL: null,
                expectedExplicitIL: conv("conv.u8"),
                expectedCheckedIL: conv("conv.ovf.i8.un")
            );
            conversions(
                sourceType: "nuint",
                destType: "ulong",
                expectedImplicitIL: conv("conv.u8"),
                expectedExplicitIL: conv("conv.u8")
            );
            conversions(
                sourceType: "nuint",
  ...
  IL_0007:  ret
            ...
            conversions(
                ...
                expectedImplicitIL: null,
                expectedExplicitIL: null
            ); // https://github.com/dotnet/roslyn/issues/42560: Allow explicitly casting nuint to IntPtr.
            conversions(
                sourceType: "nuint",
                destType: "System.UIntPtr",
                expectedImplicitIL: convNone,
            ...
            conversions(
                ...
                expectedImplicitIL: null,
                expectedExplicitIL: convToNullableT("conv.i4", "E"),
                expectedCheckedIL: convToNullableT("conv.ovf.i4.un", "E")
            );
            conversions(
                sourceType: "nuint",
                destType: "bool?",
            ...
            conversions(
                ...
                expectedImplicitIL: null,
                expectedExplicitIL: convToNullableT("conv.u2", "char"),
                expectedCheckedIL: convToNullableT("conv.ovf.u2.un", "char")
            );
            conversions(
                sourceType: "nuint",
                destType: "sbyte?",
                expectedImplicitIL: null,
                expectedExplicitIL: convToNullableT("conv.i1", "sbyte"),
                expectedCheckedIL: convToNullableT("conv.ovf.i1.un", "sbyte")
            );
            conversions(
                sourceType: "nuint",
                destType: "byte?",
                expectedImplicitIL: null,
                expectedExplicitIL: convToNullableT("conv.u1", "byte"),
                expectedCheckedIL: convToNullableT("conv.ovf.u1.un", "byte")
            );
            conversions(
                sourceType: "nuint",
                destType: "short?",
                expectedImplicitIL: null,
                expectedExplicitIL: convToNullableT("conv.i2", "short"),
                expectedCheckedIL: convToNullableT("conv.ovf.i2.un", "short")
            );
            conversions(
                sourceType: "nuint",
                destType: "ushort?",
                expectedImplicitIL: null,
                expectedExplicitIL: convToNullableT("conv.u2", "ushort"),
                expectedCheckedIL: convToNullableT("conv.ovf.u2.un", "ushort")
            );
            conversions(
                sourceType: "nuint",
                destType: "int?",
                expectedImplicitIL: null,
                expectedExplicitIL: convToNullableT("conv.i4", "int"),
                expectedCheckedIL: convToNullableT("conv.ovf.i4.un", "int")
            );
            conversions(
                sourceType: "nuint",
                destType: "uint?",
                expectedImplicitIL: null,
                expectedExplicitIL: convToNullableT("conv.u4", "uint"),
                expectedCheckedIL: convToNullableT("conv.ovf.u4.un", "uint")
            );
            conversions(
                sourceType: "nuint",
                destType: "long?",
                expectedImplicitIL: null,
                expectedExplicitIL: convToNullableT("conv.u8", "long"),
                expectedCheckedIL: convToNullableT("conv.ovf.i8.un", "long")
            );
            conversions(
                sourceType: "nuint",
                destType: "ulong?",
                expectedImplicitIL: convToNullableT("conv.u8", "ulong"),
                expectedExplicitIL: convToNullableT("conv.u8", "ulong")
            );
            conversions(
                sourceType: "nuint",
                destType: "float?",
  ...
  IL_0006:  ret
            ...
            conversions(
                ...
                destType: "E",
                expectedImplicitIL: null,
                expectedExplicitIL: convFromNullableT("conv.i4", "nuint"),
                expectedCheckedIL: convFromNullableT("conv.ovf.i4.un", "nuint")
            );
            conversions(
                sourceType: "nuint?",
                destType: "bool",
            ...
            conversions(
                ...
                destType: "char",
                expectedImplicitIL: null,
                expectedExplicitIL: convFromNullableT("conv.u2", "nuint"),
                expectedCheckedIL: convFromNullableT("conv.ovf.u2.un", "nuint")
            );
            conversions(
                sourceType: "nuint?",
                destType: "sbyte",
                expectedImplicitIL: null,
                expectedExplicitIL: convFromNullableT("conv.i1", "nuint"),
                expectedCheckedIL: convFromNullableT("conv.ovf.i1.un", "nuint")
            );
            conversions(
                sourceType: "nuint?",
                destType: "byte",
                expectedImplicitIL: null,
                expectedExplicitIL: convFromNullableT("conv.u1", "nuint"),
                expectedCheckedIL: convFromNullableT("conv.ovf.u1.un", "nuint")
            );
            conversions(
                sourceType: "nuint?",
                destType: "short",
                expectedImplicitIL: null,
                expectedExplicitIL: convFromNullableT("conv.i2", "nuint"),
                expectedCheckedIL: convFromNullableT("conv.ovf.i2.un", "nuint")
            );
            conversions(
                sourceType: "nuint?",
                destType: "ushort",
            ...
            conversions(
                ...
                destType: "uint",
                expectedImplicitIL: null,
                expectedExplicitIL: convFromNullableT("conv.u4", "nuint"),
                expectedCheckedIL: convFromNullableT("conv.ovf.u4.un", "nuint")
            );
            conversions(
                sourceType: "nuint?",
                destType: "long",
                expectedImplicitIL: null,
                expectedExplicitIL: convFromNullableT("conv.u8", "nuint"),
                expectedCheckedIL: convFromNullableT("conv.ovf.i8.un", "nuint")
            );
            conversions(
                sourceType: "nuint?",
                destType: "ulong",
            ...
            conversions(
                ...
                destType: "float",
                expectedImplicitIL: null,
                expectedExplicitIL: convFromNullableT("conv.r4", "nuint")
            );
            conversions(
                sourceType: "nuint?",
                destType: "double",
                expectedImplicitIL: null,
                expectedExplicitIL: convFromNullableT("conv.r8", "nuint")
            );
            conversions(
                sourceType: "nuint?",
                destType: "decimal",
  ...
  IL_0007:  ret
            ...
            conversions(
                ...
                destType: "E?",
                expectedImplicitIL: null,
                expectedExplicitIL: convFromToNullableT("conv.i4", "nuint", "E"),
                expectedCheckedIL: convFromToNullableT("conv.ovf.i4.un", "nuint", "E")
            );
            conversions(
                sourceType: "nuint?",
                destType: "bool?",
            ...
            conversions(
                ...
                destType: "char?",
                expectedImplicitIL: null,
                expectedExplicitIL: convFromToNullableT("conv.u2", "nuint", "char"),
                expectedCheckedIL: convFromToNullableT("conv.ovf.u2.un", "nuint", "char")
            );
            conversions(
                sourceType: "nuint?",
                destType: "sbyte?",
                expectedImplicitIL: null,
                expectedExplicitIL: convFromToNullableT("conv.i1", "nuint", "sbyte"),
                expectedCheckedIL: convFromToNullableT("conv.ovf.i1.un", "nuint", "sbyte")
            );
            conversions(
                sourceType: "nuint?",
                destType: "byte?",
                expectedImplicitIL: null,
                expectedExplicitIL: convFromToNullableT("conv.u1", "nuint", "byte"),
                expectedCheckedIL: convFromToNullableT("conv.ovf.u1.un", "nuint", "byte")
            );
            conversions(
                sourceType: "nuint?",
                destType: "short?",
                expectedImplicitIL: null,
                expectedExplicitIL: convFromToNullableT("conv.i2", "nuint", "short"),
                expectedCheckedIL: convFromToNullableT("conv.ovf.i2.un", "nuint", "short")
            );
            conversions(
                sourceType: "nuint?",
                destType: "ushort?",
                expectedImplicitIL: null,
                expectedExplicitIL: convFromToNullableT("conv.u2", "nuint", "ushort"),
                expectedCheckedIL: convFromToNullableT("conv.ovf.u2.un", "nuint", "ushort")
            );
            conversions(
                sourceType: "nuint?",
                destType: "int?",
                expectedImplicitIL: null,
                expectedExplicitIL: convFromToNullableT("conv.i4", "nuint", "int"),
                expectedCheckedIL: convFromToNullableT("conv.ovf.i4.un", "nuint", "int")
            );
            conversions(
                sourceType: "nuint?",
                destType: "uint?",
                expectedImplicitIL: null,
                expectedExplicitIL: convFromToNullableT("conv.u4", "nuint", "uint"),
                expectedCheckedIL: convFromToNullableT("conv.ovf.u4.un", "nuint", "uint")
            );
            conversions(
                sourceType: "nuint?",
                destType: "long?",
                expectedImplicitIL: null,
                expectedExplicitIL: convFromToNullableT("conv.u8", "nuint", "long"),
                expectedCheckedIL: convFromToNullableT("conv.ovf.i8.un", "nuint", "long")
            );
            conversions(
                sourceType: "nuint?",
                destType: "ulong?",
                expectedImplicitIL: convFromToNullableT("conv.u8", "nuint", "ulong"),
                expectedExplicitIL: convFromToNullableT("conv.u8", "nuint", "ulong")
            );
            conversions(
                sourceType: "nuint?",
                destType: "float?",
                expectedImplicitIL: convFromToNullableT("conv.r4", "nuint", "float"),
                expectedExplicitIL: convFromToNullableT("conv.r4", "nuint", "float"),
                null
            );
            conversions(
                sourceType: "nuint?",
                destType: "double?",
                expectedImplicitIL: convFromToNullableT("conv.r8", "nuint", "double"),
                expectedExplicitIL: convFromToNullableT("conv.r8", "nuint", "double"),
                null
            );
            conversions(
                sourceType: "nuint?",
  ...
  IL_0006:  ret
            ...
            conversions(
                ...
                destType: "void*",
                expectedImplicitIL: null,
                expectedExplicitIL: convAndExplicit(
                    "void* System.IntPtr.op_Explicit(System.IntPtr)"
                )
            );
            conversions(
                sourceType: "System.IntPtr",
            ...
            conversions(
                ...
                destType: "E",
                expectedImplicitIL: null,
                expectedExplicitIL: convAndExplicit("int System.IntPtr.op_Explicit(System.IntPtr)")
            );
            conversions(
                sourceType: "System.IntPtr",
                destType: "bool",
            ...
            conversions(
                ...
                expectedImplicitIL: null,
                expectedExplicitIL: convAndExplicit(
                    "int System.IntPtr.op_Explicit(System.IntPtr)",
                    "conv.u2"
                ),
                expectedCheckedIL: convAndExplicit(
                    "int System.IntPtr.op_Explicit(System.IntPtr)",
                    "conv.ovf.u2"
                )
            );
            ...
            conversions(
                ...
                destType: "long",
                expectedImplicitIL: null,
                expectedExplicitIL: convAndExplicit("long System.IntPtr.op_Explicit(System.IntPtr)")
            );
            conversions(
                sourceType: "System.IntPtr",
                destType: "ulong",
  ...
  IL_000b:  ret
            ...
            conversions(
                ...
                destType: "E?",
                expectedImplicitIL: null,
                expectedExplicitIL: convAndExplicitToNullableT(
                    "E",
                    "int System.IntPtr.op_Explicit(System.IntPtr)"
                )
            );
            ...
            conversions(
                ...
                expectedCheckedIL: convAndExplicitToNullableT(
                    "char",
                    "int System.IntPtr.op_Explicit(System.IntPtr)",
                    "conv.ovf.u2"
                )
  ...
  IL_0006:  ret
            ...
            conversions(
                ...
                destType: "E",
                expectedImplicitIL: null,
                expectedExplicitIL: convAndExplicitFromNullableT(
                    "System.IntPtr",
                    "int System.IntPtr.op_Explicit(System.IntPtr)"
                )
            );
            ...
            conversions(
                ...
                expectedCheckedIL: convAndExplicitFromNullableT(
                    "System.IntPtr",
                    "int System.IntPtr.op_Explicit(System.IntPtr)",
                    "conv.ovf.u2"
                )
  ...
  IL_0007:  ret
            ...
            conversions(
                ...
                destType: "E?",
                expectedImplicitIL: null,
                expectedExplicitIL: convAndExplicitFromToNullableT(
                    "System.IntPtr",
                    "E",
                    "int System.IntPtr.op_Explicit(System.IntPtr)"
                )
            ...
            conversions(
                ...
                expectedCheckedIL: convAndExplicitFromToNullableT(
                    "System.IntPtr",
                    "char",
                    "int System.IntPtr.op_Explicit(System.IntPtr)",
                    "conv.ovf.u2"
  ...
  IL_0006:  ret
            ...
            conversions(
                ...
                destType: "System.IntPtr",
                expectedImplicitIL: null,
                expectedExplicitIL: explicitAndConv(
            ...
            conversions(
                ...
                destType: "System.IntPtr",
                expectedImplicitIL: null,
                expectedExplicitIL: explicitAndConv("System.IntPtr System.IntPtr.op_Explicit(int)")
            );
            conversions(
                sourceType: "bool",
                destType: "System.IntPtr",
            ...
            conversions(
                ...
                expectedImplicitIL: null,
                expectedExplicitIL: explicitAndConv(
                    "System.IntPtr System.IntPtr.op_Explicit(long)",
                    "conv.u8"
                )
            );
            conversions(
                ...
                destType: "System.IntPtr",
                expectedImplicitIL: null,
                expectedExplicitIL: explicitAndConv("System.IntPtr System.IntPtr.op_Explicit(long)")
            );
            conversions(
                sourceType: "ulong",
                destType: "System.IntPtr",
                ...
                expectedCheckedIL: explicitAndConv(
                    "System.IntPtr System.IntPtr.op_Explicit(long)",
                    "conv.ovf.i8.un"
                )
            );
  ...
  IL_000b:  ret
            ...
            conversions(
                ...
                destType: "System.IntPtr?",
                expectedImplicitIL: null,
                expectedExplicitIL: explicitAndConvToNullableT(
                    "System.IntPtr",
            ...
            conversions(
                ...
                expectedCheckedIL: explicitAndConvToNullableT(
                    "System.IntPtr",
                    "System.IntPtr System.IntPtr.op_Explicit(long)",
                    "conv.ovf.i8.un"
                )
  ...
  IL_0010:  ret
            ...
            conversions(
                ...
                destType: "System.IntPtr",
                expectedImplicitIL: null,
                expectedExplicitIL: explicitAndConvFromNullableT(
                    "E",
                    "System.IntPtr System.IntPtr.op_Explicit(int)"
                )
            );
            ...
            conversions(
                ...
                expectedCheckedIL: explicitAndConvFromNullableT(
                    "ulong",
                    "System.IntPtr System.IntPtr.op_Explicit(long)",
                    "conv.ovf.i8.un"
                )
  ...
  IL_0011:  ret
            ...
            conversions(
                ...
                destType: "System.IntPtr?",
                expectedImplicitIL: null,
                expectedExplicitIL: explicitAndConvFromToNullableT(
                    "E",
                    "System.IntPtr",
                    "System.IntPtr System.IntPtr.op_Explicit(int)"
                )
            ...
            conversions(
                ...
                expectedCheckedIL: explicitAndConvFromToNullableT(
                    "ulong",
                    "System.IntPtr",
                    "System.IntPtr System.IntPtr.op_Explicit(long)",
                    "conv.ovf.i8.un"
  ...
  IL_0006:  ret
            ...
            conversions(
                ...
                expectedImplicitIL: null,
                expectedExplicitIL: convAndExplicit(
                    "void* System.UIntPtr.op_Explicit(System.UIntPtr)"
                )
            );
            conversions(
                sourceType: "System.UIntPtr",
            ...
            conversions(
                ...
                expectedImplicitIL: null,
                expectedExplicitIL: convAndExplicit(
                    "uint System.UIntPtr.op_Explicit(System.UIntPtr)"
                ),
                expectedCheckedIL: convAndExplicit(
                    "uint System.UIntPtr.op_Explicit(System.UIntPtr)",
                    "conv.ovf.i4.un"
            ...
            conversions(
                ...
                expectedImplicitIL: null,
                expectedExplicitIL: convAndExplicit(
                    "ulong System.UIntPtr.op_Explicit(System.UIntPtr)"
                ),
                expectedCheckedIL: convAndExplicit(
                    "ulong System.UIntPtr.op_Explicit(System.UIntPtr)",
                    "conv.ovf.i8.un"
  ...
  IL_0006:  ret
            ...
            conversions(
                ...
                expectedImplicitIL: null,
                expectedExplicitIL: explicitAndConv(
                    "System.UIntPtr System.UIntPtr.op_Explicit(void*)"
                )
            );
            conversions(
                sourceType: "delegate*<void>",
            ...
            conversions(
                ...
                expectedImplicitIL: null,
                expectedExplicitIL: explicitAndConv(
                    "System.UIntPtr System.UIntPtr.op_Explicit(ulong)",
                    "conv.i8"
                ),
                expectedCheckedIL: explicitAndConv(
                    "System.UIntPtr System.UIntPtr.op_Explicit(ulong)",
            ...
            conversions(
                ...
                expectedImplicitIL: null,
                expectedExplicitIL: explicitAndConv(
                    "System.UIntPtr System.UIntPtr.op_Explicit(uint)"
                )
            );
            conversions(
                sourceType: "sbyte",
...
";
                var comp = CreateCompilation(
                    source,
                    options: TestOptions.ReleaseDll.WithAllowUnsafe(useUnsafeContext),
                    parseOptions: TestOptions.Regular9
                );
                comp.VerifyDiagnostics(expectedDiagnostics);
        ...
        public void UnaryOperators()
        {
            ...
            {
                object result = (IntPtr.Size == 4) ? (object)~value : (object)~(ulong)value;
            ...
            )
            {
                ...
                unaryOperator(
                    ...
                    expectedResult,
                    expectedIL,
                    diagnostic != null ? new[] { diagnostic } : Array.Empty<DiagnosticDescription>()
                );
            }
  ...
  IL_0022:  ret
            ...
            unaryOp(
                ...
                null,
                null,
                Diagnostic(ErrorCode.ERR_AmbigUnaryOp, "-operand").WithArguments("-", "nuint?")
            );
            unaryOp("-", "System.IntPtr?");
            unaryOp("-", "System.UIntPtr?");
            unaryOp("!", "nint?");
...
{{
        ...
        public void IncrementOperators()
        {
            ...
            )
            {
                incrementOperator(
                    ...
                    expectedResult,
                    expectedIL,
                    getDiagnostics(opType, isPrefix: true, diagnostic)
                );
                incrementOperator(
                    op,
                    opType,
                    ...
                    expectedResult,
                    expectedIL,
                    getDiagnostics(opType, isPrefix: false, diagnostic)
                );
                opType += "?";
                incrementOperator(
                    op,
            ...
            incrementOps(
                "++",
                "nint",
                "nint nint.op_Increment(nint value)",
                useChecked: false,
  ...
  IL_0027:  ret
            ...
            incrementOps(
                "++",
                "nuint",
                "nuint nuint.op_Increment(nuint value)",
                useChecked: false,
  ...
  IL_0027:  ret
            ...
            incrementOps(
                "--",
                "nint",
                "nint nint.op_Decrement(nint value)",
                useChecked: false,
  ...
  IL_0027:  ret
            ...
            incrementOps(
                "--",
                "nuint",
                "nuint nuint.op_Decrement(nuint value)",
                useChecked: false,
                ...
                @"class Program
{
    ...
    static nint F2(nint i) => -i;
            ...
            var verifier = CompileAndVerify(
                comp,
                emitOptions: EmitOptions.Default.WithRuntimeMetadataVersion("0.0.0.0"),
    ...
    static void F(MyInt x, MyInt y)
    {
        ...
        _ = x << 1;
            ...
            comp.VerifyDiagnostics(
                ...
                //         _ = x << 1;
                Diagnostic(ErrorCode.ERR_BadBinaryOps, "x << 1")
                    .WithArguments("<<", "MyInt", "int")
                    .WithLocation(16, 13)
            );
        }
        ...
        public void BinaryOperators()
        {
            ...
            )
            {
                ...
                binaryOp(
                    ...
                    rightType,
                    leftType,
                    expectedSymbol2 == "" ? expectedSymbol1 : expectedSymbol2,
                    diagnostics2 ?? diagnostics1
                );
            }
            ...
            )
            {
                ...
                binaryOperator(
                    ...
                    rightType,
                    expectedSymbol,
                    diagnostics ?? Array.Empty<DiagnosticDescription>()
                );
            }

            static DiagnosticDescription[] getBadBinaryOpsDiagnostics(
                string op,
                string leftType,
                string rightType,
            ...
            )
            {
                ...
                if (includeBadBinaryOps)
                    builder.Add(
                        Diagnostic(ErrorCode.ERR_BadBinaryOps, $"x {op} y")
                            .WithArguments(op, leftType, rightType)
                    );
                if (includeVoidError)
            ...
            static DiagnosticDescription[] getAmbiguousBinaryOpsDiagnostics(
                string op,
                string leftType,
                string rightType
            )
            ...
            var additionOperators = new[] { ("+", "op_Addition"), };
            ...
            var shiftOperators = new[] { ("<<", "op_LeftShift"), (">>", "op_RightShift"), };
            var equalityOperators = new[] { ("==", "op_Equality"), ("!=", "op_Inequality"), };
            ...
            foreach ((string symbol, string name) in arithmeticOperators)
            {
                ...
                binaryOps(
                    ...
                    "void*",
                    null,
                    (symbol == "-") ? $"void* void*.{name}(void* left, long right)" : null,
                    getBadBinaryOpsDiagnostics(symbol, "nint", "void*", includeVoidError: true),
                    getBadBinaryOpsDiagnostics(
                        symbol,
                        "void*",
                        "nint",
                        includeBadBinaryOps: includeBadBinaryOps,
                        includeVoidError: true
                    )
                );
                ...
                binaryOps(
                    ...
                    null,
                    null,
                    getAmbiguousBinaryOpsDiagnostics(symbol, "nint", "nuint"),
                    getAmbiguousBinaryOpsDiagnostics(symbol, "nuint", "nint")
                );
                ...
                binaryOps(
                    ...
                    null,
                    null,
                    getAmbiguousBinaryOpsDiagnostics(symbol, "nint", "ulong"),
                    getAmbiguousBinaryOpsDiagnostics(symbol, "ulong", "nint")
                );
                ...
                binaryOps(
                    ...
                    "nint",
                    "double",
                    $"double double.{name}(double left, double right)"
                );
                binaryOps(
                    symbol,
                    "nint",
                    "decimal",
                    $"decimal decimal.{name}(decimal left, decimal right)"
                );
                binaryOps(
                    symbol,
                    "nint",
                    "System.IntPtr",
                    $"nint nint.{name}(nint left, nint right)"
                );
                ...
                binaryOps(
                    ...
                    null,
                    getBadBinaryOpsDiagnostics(symbol, "nint?", "void*", includeVoidError: true),
                    getBadBinaryOpsDiagnostics(symbol, "void*", "nint?", includeVoidError: true)
                );
                binaryOps(symbol, "nint?", "bool");
                binaryOps(symbol, "nint?", "char", $"nint nint.{name}(nint left, nint right)");
                binaryOps(symbol, "nint?", "sbyte", $"nint nint.{name}(nint left, nint right)");
                ...
                binaryOps(
                    ...
                    "nint?",
                    "float?",
                    $"float float.{name}(float left, float right)"
                );
                binaryOps(
                    symbol,
                    "nint?",
                ...
                binaryOps(
                    ...
                    "void*",
                    null,
                    (symbol == "-") ? $"void* void*.{name}(void* left, ulong right)" : null,
                    getBadBinaryOpsDiagnostics(symbol, "nuint", "void*", includeVoidError: true),
                    getBadBinaryOpsDiagnostics(
                        symbol,
                        "void*",
                        "nuint",
                ...
                binaryOps(
                    ...
                    null,
                    null,
                    getAmbiguousBinaryOpsDiagnostics(symbol, "nuint", "sbyte"),
                    getAmbiguousBinaryOpsDiagnostics(symbol, "sbyte", "nuint")
                );
                ...
                binaryOps(
                    ...
                    null,
                    null,
                    getAmbiguousBinaryOpsDiagnostics(symbol, "nuint", "short"),
                    getAmbiguousBinaryOpsDiagnostics(symbol, "short", "nuint")
                );
                binaryOps(
                    symbol,
                    "nuint",
                    "ushort",
                    $"nuint nuint.{name}(nuint left, nuint right)"
                );
                binaryOps(
                    symbol,
                    "nuint",
                    ...
                    null,
                    null,
                    getAmbiguousBinaryOpsDiagnostics(symbol, "nuint", "int"),
                    getAmbiguousBinaryOpsDiagnostics(symbol, "int", "nuint")
                );
                ...
                binaryOps(
                    ...
                    null,
                    null,
                    getAmbiguousBinaryOpsDiagnostics(symbol, "nuint", "long"),
                    getAmbiguousBinaryOpsDiagnostics(symbol, "long", "nuint")
                );
                ...
                binaryOps(
                    ...
                    "nuint",
                    "ulong?",
                    $"ulong ulong.{name}(ulong left, ulong right)"
                );
                binaryOps(
                    symbol,
                    "nuint",
                ...
                binaryOps(
                    ...
                    null,
                    getBadBinaryOpsDiagnostics(symbol, "nuint?", "void*", includeVoidError: true),
                    getBadBinaryOpsDiagnostics(symbol, "void*", "nuint?", includeVoidError: true)
                );
                binaryOps(symbol, "nuint?", "bool");
                binaryOps(symbol, "nuint?", "char", $"nuint nuint.{name}(nuint left, nuint right)");
                binaryOps(
            ...
            foreach ((string symbol, string name) in comparisonOperators)
            {
                ...
                binaryOps(
                    ...
                    null,
                    null,
                    getBadBinaryOpsDiagnostics(symbol, "nint", "void*"),
                    getBadBinaryOpsDiagnostics(symbol, "void*", "nint")
                );
                binaryOps(symbol, "nint", "bool");
                ...
                binaryOps(
                    ...
                    "nint",
                    "double",
                    $"bool double.{name}(double left, double right)"
                );
                binaryOps(
                    symbol,
                    "nint",
                    "decimal",
                    $"bool decimal.{name}(decimal left, decimal right)"
                );
                binaryOps(
                    symbol,
                    "nint",
                    "System.IntPtr",
                    $"bool nint.{name}(nint left, nint right)"
                );
                binaryOps(symbol, "nint", "System.UIntPtr");
                binaryOps(symbol, "nint", "bool?");
                binaryOps(symbol, "nint", "char?", $"bool nint.{name}(nint left, nint right)");
                ...
                binaryOps(
                    ...
                    null,
                    null,
                    getBadBinaryOpsDiagnostics(symbol, "nuint", "void*"),
                    getBadBinaryOpsDiagnostics(symbol, "void*", "nuint")
                );
                binaryOps(symbol, "nuint", "bool");
                ...
                binaryOps(
                    ...
                    "nuint",
                    "System.UIntPtr",
                    $"bool nuint.{name}(nuint left, nuint right)"
                );
                binaryOps(symbol, "nuint", "bool?");
                binaryOps(symbol, "nuint", "char?", $"bool nuint.{name}(nuint left, nuint right)");
                binaryOps(
                ...
                binaryOps(
                    ...
                    "nuint?",
                    "ulong?",
                    $"bool ulong.{name}(ulong left, ulong right)"
                );
                binaryOps(
                    symbol,
                    "nuint?",
                    "float?",
                    $"bool float.{name}(float left, float right)"
                );
                binaryOps(
                    symbol,
                    "nuint?",
            ...
            foreach ((string symbol, string name) in additionOperators)
            {
                ...
                binaryOps(
                    ...
                    "nint",
                    "string",
                    $"string string.{name}(object left, string right)",
                    $"string string.{name}(string left, object right)"
                );
                binaryOps(
                    symbol,
                    "nint",
                    "void*",
                    $"void* void*.{name}(long left, void* right)",
                    $"void* void*.{name}(void* left, long right)",
                    new[] { Diagnostic(ErrorCode.ERR_VoidError, "x + y") }
                );
                binaryOps(symbol, "nint", "bool");
                binaryOps(symbol, "nint", "char", $"nint nint.{name}(nint left, nint right)");
                binaryOps(symbol, "nint", "sbyte", $"nint nint.{name}(nint left, nint right)");
                ...
                binaryOps(
                    ...
                    "nuint",
                    "void*",
                    $"void* void*.{name}(ulong left, void* right)",
                    $"void* void*.{name}(void* left, ulong right)",
                    new[] { Diagnostic(ErrorCode.ERR_VoidError, "x + y") }
                );
                binaryOps(symbol, "nuint", "bool");
                binaryOps(symbol, "nuint", "char", $"nuint nuint.{name}(nuint left, nuint right)");
            ...
            foreach ((string symbol, string name) in shiftOperators)
            {
                ...
                binaryOps(
                    ...
                    "nint",
                    "ushort",
                    $"nint nint.{name}(nint left, int right)",
                    null
                );
                ...
                binaryOps(
                    ...
                    "nuint",
                    "char",
                    $"nuint nuint.{name}(nuint left, int right)",
                    null
                );
                binaryOps(
                    symbol,
            ...
            foreach ((string symbol, string name) in equalityOperators)
            {
                ...
                binaryOps(
                    ...
                    "nint",
                    "System.IntPtr",
                    $"bool System.IntPtr.{name}(System.IntPtr value1, System.IntPtr value2)"
                );
                binaryOps(symbol, "nint", "System.UIntPtr");
                binaryOps(symbol, "nint", "bool?");
                binaryOps(symbol, "nint", "char?", $"bool nint.{name}(nint left, nint right)");
                ...
                binaryOps(
                    ...
                    "nuint",
                    "System.UIntPtr",
                    $"bool System.UIntPtr.{name}(System.UIntPtr value1, System.UIntPtr value2)"
                );
                binaryOps(symbol, "nuint", "bool?");
                binaryOps(symbol, "nuint", "char?", $"bool nuint.{name}(nuint left, nuint right)");
                binaryOps(
...
1"
  ...
  IL_0003:  ret
        ...
        public void ConstantFolding_01()
        {
            ...
            unaryOperatorNotConstant(
                "nuint",
                "~",
                "0",
                IntPtr.Size == 4 ? uintMaxValue : ulongMaxValue
            );
            unaryOperatorNotConstant(
                "nuint",
                "~",
            ...
            binaryOperatorCheckedOverflow(
                ...
                IntPtr.Size == 4 ? "System.OverflowException" : "-2147483649"
            );
            ...
            binaryOperatorCheckedOverflow(
                ...
                "nuint",
                uintMaxValue,
                IntPtr.Size == 4 ? "0" : "4294967296",
                IntPtr.Size == 4 ? "System.OverflowException" : "4294967296"
            );
            ...
            binaryOperatorCheckedOverflow(
                ...
                "nint",
                intMaxValue,
                IntPtr.Size == 4 ? "-2" : "4294967294",
                IntPtr.Size == 4 ? "System.OverflowException" : "4294967294"
            );
            binaryOperatorCheckedOverflow(
                "nuint",
                "*",
                ...
                "nuint",
                "2",
                IntPtr.Size == 4 ? "4294967294" : "8589934590",
                IntPtr.Size == 4 ? "System.OverflowException" : "8589934590"
            );
            ...
            static DiagnosticDescription[] getNoDiagnostics(
                string opType,
                string op,
                string operand
            ) => Array.Empty<DiagnosticDescription>();
            static DiagnosticDescription[] getBadUnaryOpDiagnostics(
                string opType,
                string op,
                string operand
            ) => new[] { Diagnostic(ErrorCode.ERR_BadUnaryOp, operand).WithArguments(op, opType) };

            static DiagnosticDescription[] getIntDivByZeroDiagnostics(
                string opType,
                string op,
                string operand
            ) => new[] { Diagnostic(ErrorCode.ERR_IntDivByZero, operand) };
            ...
            void unaryOperatorCheckedOverflow(
                string opType,
                string op,
                string operand,
                string expectedResultUnchecked,
                string expectedResultChecked
            )
            {
                var declarations = $"const {opType} A = {operand};";
                var expr = $"{op}A";
                constantDeclaration(
                    ...
                    new[]
                    {
                        Diagnostic(ErrorCode.WRN_CompileTimeCheckedOverflow, expr)
                            .WithArguments(opType),
                        Diagnostic(ErrorCode.ERR_NotConstantExpression, expr)
                            .WithArguments("Library.F")
                    }
                );
                constantDeclaration(
                    opType,
                    ...
                    new[]
                    {
                        Diagnostic(ErrorCode.WRN_CompileTimeCheckedOverflow, expr)
                            .WithArguments(opType),
                        Diagnostic(ErrorCode.ERR_NotConstantExpression, $"checked({expr})")
                            .WithArguments("Library.F")
                    }
                );
                constantDeclaration(
                    ...
                    new[]
                    {
                        Diagnostic(ErrorCode.ERR_NotConstantExpression, $"unchecked({expr})")
                            .WithArguments("Library.F")
                    }
                );
            ...
            void binaryOperatorCheckedOverflow(
                string opType,
                string op,
                string leftType,
                string leftOperand,
            ...
            void binaryOperatorNotConstant(
                string opType,
                string op,
                string leftType,
                string leftOperand,
        ...
        const nuint y = checked(uint.MaxValue + (nuint)42);
            ...
            comp.VerifyDiagnostics(
                ...
                Diagnostic(
                        ...
                        "unchecked(uint.MaxValue + (nuint)42)"
                    )
                    .WithArguments("x")
                    .WithLocation(6, 25),
                ...
                Diagnostic(
                        ErrorCode.ERR_NotConstantExpression,
                        "checked(uint.MaxValue + (nuint)42)"
                    )
                    .WithArguments("y")
                    .WithLocation(7, 25),
                // (7,33): warning CS8973: The operation may overflow 'nuint' at runtime (use 'unchecked' syntax to override)
                //         const nuint y = checked(uint.MaxValue + (nuint)42);
                Diagnostic(ErrorCode.WRN_CompileTimeCheckedOverflow, "uint.MaxValue + (nuint)42")
                    .WithArguments("nuint")
                    .WithLocation(7, 33)
            );
...
class Program
{
    static void Main()
    {
        ...
        catch (System.Exception e)
        {
            ...
            CompileAndVerify(
                    comp,
                    expectedOutput: IntPtr.Size == 4 ? "System.OverflowException" : "4294967337"
                )
                .VerifyDiagnostics(
                    // (8,29): warning CS8973: The operation may overflow 'nuint' at runtime (use 'unchecked' syntax to override)
                    //             var y = checked(uint.MaxValue + (nuint)42);
                    Diagnostic(
                            ErrorCode.WRN_CompileTimeCheckedOverflow,
                            "uint.MaxValue + (nuint)42"
                        )
                        .WithArguments("nuint")
                        .WithLocation(8, 29)
                );
...
class Program
{
    static void Main()
    {
        ...
        System.Console.WriteLine(y);
            ...
            comp = CreateCompilation(source, options: TestOptions.ReleaseExe);
            CompileAndVerify(comp, expectedOutput: IntPtr.Size == 4 ? "41" : "4294967337")
                .VerifyDiagnostics();
        }
    ...
    static void Main()
    {
        ...
        const nint y = checked(-(nint)int.MinValue);
            ...
            comp.VerifyDiagnostics(
                ...
                //         const nint x = unchecked(-(nint)int.MinValue);
                Diagnostic(ErrorCode.ERR_NotConstantExpression, "unchecked(-(nint)int.MinValue)")
                    .WithArguments("x")
                    .WithLocation(6, 24),
                // (7,24): error CS0133: The expression being assigned to 'y' must be constant
                //         const nint y = checked(-(nint)int.MinValue);
                Diagnostic(ErrorCode.ERR_NotConstantExpression, "checked(-(nint)int.MinValue)")
                    .WithArguments("y")
                    .WithLocation(7, 24),
                // (7,32): warning CS8973: The operation may overflow 'nint' at runtime (use 'unchecked' syntax to override)
                //         const nint y = checked(-(nint)int.MinValue);
                Diagnostic(ErrorCode.WRN_CompileTimeCheckedOverflow, "-(nint)int.MinValue")
                    .WithArguments("nint")
                    .WithLocation(7, 32)
            );
...
class Program
{
    static void Main()
    {
        ...
        catch (System.Exception e)
        {
            ...
            CompileAndVerify(
                    comp,
                    expectedOutput: IntPtr.Size == 4 ? "System.OverflowException" : "2147483648"
                )
                .VerifyDiagnostics(
...
class Program
{
    static void Main()
    {
        ...
        System.Console.WriteLine(y);
            ...
            comp = CreateCompilation(source, options: TestOptions.ReleaseExe);
            CompileAndVerify(comp, expectedOutput: IntPtr.Size == 4 ? "-2147483648" : "2147483648")
                .VerifyDiagnostics();
        }
                ...
                @"class B : A
{
    ...
    public override void F4(System.IntPtr i) { }
            ...
            var type = comp.GetTypeByMetadataName("A");
            Assert.Equal(
                "void A.F1(nint modopt(System.Int32) i)",
                type.GetMember("F1").ToTestDisplayString()
            );
            Assert.Equal(
                "void A.F2(System.IntPtr modopt(System.Int32) i)",
                type.GetMember("F2").ToTestDisplayString()
            );
            Assert.Equal(
                "void A.F3(nint modopt(System.Int32) i)",
                type.GetMember("F3").ToTestDisplayString()
            );
            Assert.Equal(
                "void A.F4(System.IntPtr modopt(System.Int32) i)",
                type.GetMember("F4").ToTestDisplayString()
            );

            type = comp.GetTypeByMetadataName("B");
            Assert.Equal(
                "void B.F1(System.IntPtr modopt(System.Int32) i)",
                type.GetMember("F1").ToTestDisplayString()
            );
            Assert.Equal(
                "void B.F2(nint modopt(System.Int32) i)",
                type.GetMember("F2").ToTestDisplayString()
            );
            Assert.Equal(
                "void B.F3(nint modopt(System.Int32) i)",
                type.GetMember("F3").ToTestDisplayString()
            );
            Assert.Equal(
                "void B.F4(System.IntPtr modopt(System.Int32) i)",
                type.GetMember("F4").ToTestDisplayString()
            );
        }
                ...
                @"class B : A
{
    ...
    public override System.IntPtr[] F4() => default;
            ...
            var type = comp.GetTypeByMetadataName("A");
            Assert.Equal(
                "nint[] modopt(System.Int32) A.F1()",
                type.GetMember("F1").ToTestDisplayString()
            );
            Assert.Equal(
                "System.IntPtr[] modopt(System.Int32) A.F2()",
                type.GetMember("F2").ToTestDisplayString()
            );
            Assert.Equal(
                "nint[] modopt(System.Int32) A.F3()",
                type.GetMember("F3").ToTestDisplayString()
            );
            Assert.Equal(
                "System.IntPtr[] modopt(System.Int32) A.F4()",
                type.GetMember("F4").ToTestDisplayString()
            );

            type = comp.GetTypeByMetadataName("B");
            Assert.Equal(
                "System.IntPtr[] modopt(System.Int32) B.F1()",
                type.GetMember("F1").ToTestDisplayString()
            );
            Assert.Equal(
                "nint[] modopt(System.Int32) B.F2()",
                type.GetMember("F2").ToTestDisplayString()
            );
            Assert.Equal(
                "nint[] modopt(System.Int32) B.F3()",
                type.GetMember("F3").ToTestDisplayString()
            );
            Assert.Equal(
                "System.IntPtr[] modopt(System.Int32) B.F4()",
                type.GetMember("F4").ToTestDisplayString()
            );
        }
        ...
        public void Int64Conversions()
        {
            ...
            convert(
                ...
                toType: "ulong",
                nintMinValue,
                IntPtr.Size == 4 ? "18446744071562067968" : "9223372036854775808",
                "conv.i8",
                "System.OverflowException",
                "conv.ovf.u8"
            );
            convert(
                ...
                toType: "ulong",
                nintMaxValue,
                IntPtr.Size == 4 ? "2147483647" : "9223372036854775807",
                "conv.i8",
                IntPtr.Size == 4 ? "2147483647" : "9223372036854775807",
                "conv.ovf.u8"
            );
            convert(
                ...
                toType: "nuint",
                nintMinValue,
                IntPtr.Size == 4 ? "2147483648" : "9223372036854775808",
                "conv.u",
                "System.OverflowException",
                "conv.ovf.u"
            );
            ...
            convert(
                ...
                toType: "long",
                nuintMaxValue,
                IntPtr.Size == 4 ? "4294967295" : "-1",
                "conv.u8",
                IntPtr.Size == 4 ? "4294967295" : "System.OverflowException",
                "conv.ovf.i8.un"
            );
            convert(
                fromType: "nuint",
    ...
    {{
        ...
        Console.WriteLine(Execute(() => ConvertChecked(value)));
                ...
                var verifier = CompileAndVerify(
                    source,
                    parseOptions: TestOptions.Regular9,
                    expectedOutput: $@"{toValueUnchecked}
{toValueChecked}"
                );
                verifier.VerifyIL(
                    "Program.Convert",
...
4294967295";
  ...
  IL_0001:  ret
        ...
        public void EnumConversions_01(string baseType)
        {
            if (baseType != null)
                baseType = " : " + baseType;
            string sourceA = $@"enum E{baseType} {{ A = 0, B = 1 }}";
            string sourceB =
                @"#pragma warning disable 219
class Program
{
    ...
    static void F4()
    {
        ...
        public void EnumConversions_02(string baseType)
        {
            if (baseType != null)
                baseType = " : " + baseType;
            string sourceA = $@"enum E{baseType} {{ A = -1, B = 1 }}";
            string sourceB =
                @"using static System.Console;
class Program
{
...
1"
        ...
        public void EnumConversions_03()
        {
            ...
            convert(
                ...
                toType: "nuint",
                "sbyte.MinValue",
                IntPtr.Size == 4 ? "4294967168" : "18446744073709551488",
                "conv.i",
                "System.OverflowException",
                "conv.ovf.u"
            );
            ...
            convert(
                ...
                toType: "nuint",
                "short.MinValue",
                IntPtr.Size == 4 ? "4294934528" : "18446744073709518848",
                "conv.i",
                "System.OverflowException",
                "conv.ovf.u"
            );
            ...
            convert(
                ...
                toType: "nint",
                "long.MinValue",
                IntPtr.Size == 4 ? "0" : "-9223372036854775808",
                "conv.i",
                IntPtr.Size == 4 ? "System.OverflowException" : "-9223372036854775808",
                "conv.ovf.i"
            );
            convert(
                baseType: "long",
                ...
                toType: "nint",
                "long.MaxValue",
                IntPtr.Size == 4 ? "-1" : "9223372036854775807",
                "conv.i",
                IntPtr.Size == 4 ? "System.OverflowException" : "9223372036854775807",
                "conv.ovf.i"
            );
            convert(
                baseType: "long",
            ...
            convert(
                ...
                toType: "nuint",
                "long.MaxValue",
                IntPtr.Size == 4 ? "4294967295" : "9223372036854775807",
                "conv.u",
                IntPtr.Size == 4 ? "System.OverflowException" : "9223372036854775807",
                "conv.ovf.u"
            );
            ...
            convert(
                ...
                "conv.u",
                IntPtr.Size == 4 ? "System.OverflowException" : "18446744073709551615",
                "conv.ovf.u.un"
            );
            convert(
                baseType: "ulong",
    ...
    {{
        ...
        F0(() => {{ if (b) return y; return x; }}).ToPointer();
            ...
            comp.VerifyDiagnostics(
                ...
                //         (new[] { x, z })[0].ToPointer();
                Diagnostic(ErrorCode.ERR_NoSuchMemberOrExtension, "ToPointer")
                    .WithArguments($"{nativeIntegerType}", "ToPointer")
                    .WithLocation(8, 29),
                ...
                //         (b ? x : y).ToPointer();
                Diagnostic(ErrorCode.ERR_AmbigQM, "b ? x : y")
                    .WithArguments($"{nativeIntegerType}", $"{underlyingType}")
                    .WithLocation(12, 10),
                ...
                //         (b ? y : x).ToPointer();
                Diagnostic(ErrorCode.ERR_AmbigQM, "b ? y : x")
                    .WithArguments($"{underlyingType}", $"{nativeIntegerType}")
                    .WithLocation(13, 10),
                ...
                Diagnostic(ErrorCode.ERR_CantInferMethTypeArgs, "F0")
                    .WithArguments("Program.F0<T>(System.Func<T>)")
                    .WithLocation(15, 9),
    ...
    {{
        ...
        F0(() => {{ if (b) return x; return y; }});
            ...
            comp.VerifyDiagnostics(
                ...
                //         _ = b ? x : y;
                Diagnostic(ErrorCode.ERR_AmbigQM, "b ? x : y")
                    .WithArguments($"I<{nativeIntegerType}>", $"I<{underlyingType}>")
                    .WithLocation(15, 13),
                // (16,9): error CS0411: The type arguments for method 'Program.F0<T>(Func<T>)' cannot be inferred from the usage. Try specifying the type arguments explicitly.
                //         F0(() => { if (b) return x; return y; });
                Diagnostic(ErrorCode.ERR_CantInferMethTypeArgs, "F0")
    ...
    {{
        ...
        F0<I<{underlyingType}>>(x, y).P.
            ...
            comp.VerifyDiagnostics(
                ...
                //         F0(x, y).ToPointer();
                Diagnostic(ErrorCode.ERR_CantInferMethTypeArgs, "F0")
                    .WithArguments("Program.F0<T>(T, T)")
                    .WithLocation(12, 9),
...
";
            ...
            comp.VerifyDiagnostics(
                ...
                // class C1<T, U> where U : I<nint>, I<nint> { }
                Diagnostic(ErrorCode.ERR_DuplicateBound, "I<nint>")
                    .WithArguments("I<nint>", "U")
                    .WithLocation(2, 35),
                // (3,35): error CS0405: Duplicate constraint 'I<IntPtr>' for type parameter 'U'
                // class C2<T, U> where U : I<nint>, I<System.IntPtr> { }
                Diagnostic(ErrorCode.ERR_DuplicateBound, "I<System.IntPtr>")
                    .WithArguments("I<System.IntPtr>", "U")
                    .WithLocation(3, 35),
                // (4,63): error CS0405: Duplicate constraint 'I<nuint>' for type parameter 'U'
                // class C3<T, U> where U : I<System.UIntPtr>, I<System.IntPtr>, I<nuint> { }
                Diagnostic(ErrorCode.ERR_DuplicateBound, "I<nuint>")
                    .WithArguments("I<nuint>", "U")
                    .WithLocation(4, 63)
            );
        }
...
";
            ...
            comp.VerifyDiagnostics(
                ...
                // class C1 : I<nint>, I<nint> { }
                Diagnostic(ErrorCode.ERR_DuplicateInterfaceInBaseList, "I<nint>")
                    .WithArguments("I<nint>")
                    .WithLocation(2, 21),
                // (3,7): error CS8779: 'I<IntPtr>' is already listed in the interface list on type 'C2' as 'I<nint>'.
                // class C2 : I<nint>, I<System.IntPtr> { }
                Diagnostic(ErrorCode.ERR_DuplicateInterfaceWithDifferencesInBaseList, "C2")
                    .WithArguments("I<System.IntPtr>", "I<nint>", "C2")
                    .WithLocation(3, 7),
                // (4,7): error CS8779: 'I<nuint>' is already listed in the interface list on type 'C3' as 'I<UIntPtr>'.
                // class C3 : I<System.UIntPtr>, I<System.IntPtr>, I<nuint> { }
                Diagnostic(ErrorCode.ERR_DuplicateInterfaceWithDifferencesInBaseList, "C3")
                    .WithArguments("I<nuint>", "I<System.UIntPtr>", "C3")
                    .WithLocation(4, 7)
            );
        }
...
{ }";
            ...
            comp.VerifyDiagnostics(
                ...
                // class C1 :
                Diagnostic(ErrorCode.ERR_DuplicateInterfaceWithDifferencesInBaseList, "C1")
                    .WithArguments("I<System.IntPtr[]?>", "I<nint[]>", "C1")
                    .WithLocation(3, 7),
                // (7,7): error CS8779: 'I<nint[]>' is already listed in the interface list on type 'C2' as 'I<IntPtr[]>'.
                // class C2 :
                Diagnostic(ErrorCode.ERR_DuplicateInterfaceWithDifferencesInBaseList, "C2")
                    .WithArguments("I<nint[]>", "I<System.IntPtr[]>", "C2")
                    .WithLocation(7, 7),
...
";
            ...
            comp.VerifyDiagnostics(
                ...
                // class C0 : I<(System.IntPtr, object)>, I<(System.IntPtr, object)> { } // differences: none
                Diagnostic(ErrorCode.ERR_DuplicateInterfaceInBaseList, "I<(System.IntPtr, object)>")
                    .WithArguments("I<(System.IntPtr, object)>")
                    .WithLocation(3, 40),
                ...
                Diagnostic(ErrorCode.ERR_DuplicateInterfaceWithTupleNamesInBaseList, "C1")
                    .WithArguments(
                        "I<(System.IntPtr, object)>",
                        "I<(System.IntPtr X, object Y)>",
                        "C1"
                    )
                    .WithLocation(4, 7),
                ...
                // class C2 : I<(System.IntPtr, object)>, I<(nint, object)> { } // differences: nint
                Diagnostic(ErrorCode.ERR_DuplicateInterfaceWithDifferencesInBaseList, "C2")
                    .WithArguments("I<(nint, object)>", "I<(System.IntPtr, object)>", "C2")
                    .WithLocation(5, 7),
                ...
                // class C4 : I<(System.IntPtr, object?)>, I<(System.IntPtr, object)> { } // differences: nullable
                Diagnostic(ErrorCode.WRN_DuplicateInterfaceWithNullabilityMismatchInBaseList, "C4")
                    .WithArguments("I<(System.IntPtr, object)>", "C4")
                    .WithLocation(7, 7),
                // (8,7): error CS8779: 'I<(nint, object)>' is already listed in the interface list on type 'C5' as 'I<(IntPtr X, object Y)>'.
                // class C5 : I<(System.IntPtr X, object Y)>, I<(nint, object)> { } // differences: names, nint
                Diagnostic(ErrorCode.ERR_DuplicateInterfaceWithDifferencesInBaseList, "C5")
                    .WithArguments("I<(nint, object)>", "I<(System.IntPtr X, object Y)>", "C5")
                    .WithLocation(8, 7),
                // (9,7): error CS8779: 'I<(IntPtr, dynamic)>' is already listed in the interface list on type 'C6' as 'I<(IntPtr X, object Y)>'.
                // class C6 : I<(System.IntPtr X, object Y)>, I<(System.IntPtr, dynamic)> { } // differences: names, dynamic
                Diagnostic(ErrorCode.ERR_DuplicateInterfaceWithDifferencesInBaseList, "C6")
                    .WithArguments(
                        "I<(System.IntPtr, dynamic)>",
                        "I<(System.IntPtr X, object Y)>",
                        "C6"
                ...
                // class C7 : I<(System.IntPtr X, object? Y)>, I<(System.IntPtr, object)> { } // differences: names, nullable
                Diagnostic(ErrorCode.ERR_DuplicateInterfaceWithTupleNamesInBaseList, "C7")
                    .WithArguments(
                        "I<(System.IntPtr, object)>",
                        "I<(System.IntPtr X, object? Y)>",
                        "C7"
                ...
                // class C8 : I<(System.IntPtr, object)>, I<(nint, dynamic)> { } // differences: nint, dynamic
                Diagnostic(ErrorCode.ERR_DuplicateInterfaceWithDifferencesInBaseList, "C8")
                    .WithArguments("I<(nint, dynamic)>", "I<(System.IntPtr, object)>", "C8")
                    .WithLocation(11, 7),
                // (11,40): error CS1966: 'C8': cannot implement a dynamic interface 'I<(nint, dynamic)>'
                // class C8 : I<(System.IntPtr, object)>, I<(nint, dynamic)> { } // differences: nint, dynamic
                Diagnostic(ErrorCode.ERR_DeriveFromConstructedDynamic, "I<(nint, dynamic)>")
                    .WithArguments("C8", "I<(nint, dynamic)>")
                    .WithLocation(11, 40),
                // (12,7): error CS8779: 'I<(nint, object)>' is already listed in the interface list on type 'C9' as 'I<(IntPtr, object?)>'.
                // class C9 : I<(System.IntPtr, object?)>, I<(nint, object)> { } // differences: nint, nullable
                Diagnostic(ErrorCode.ERR_DuplicateInterfaceWithDifferencesInBaseList, "C9")
                    .WithArguments("I<(nint, object)>", "I<(System.IntPtr, object?)>", "C9")
                    .WithLocation(12, 7),
                // (13,7): error CS8779: 'I<(nint, dynamic)>' is already listed in the interface list on type 'CA' as 'I<(IntPtr, object?)>'.
                // class CA : I<(System.IntPtr, object?)>, I<(nint, dynamic)> { } // differences: dynamic, nullable
                Diagnostic(ErrorCode.ERR_DuplicateInterfaceWithDifferencesInBaseList, "CA")
                    .WithArguments("I<(nint, dynamic)>", "I<(System.IntPtr, object?)>", "CA")
                    .WithLocation(13, 7),
                // (13,41): error CS1966: 'CA': cannot implement a dynamic interface 'I<(nint, dynamic)>'
                // class CA : I<(System.IntPtr, object?)>, I<(nint, dynamic)> { } // differences: dynamic, nullable
                Diagnostic(ErrorCode.ERR_DeriveFromConstructedDynamic, "I<(nint, dynamic)>")
                    .WithArguments("CA", "I<(nint, dynamic)>")
                    .WithLocation(13, 41),
                // (14,7): error CS8779: 'I<(nint, dynamic)>' is already listed in the interface list on type 'CB' as 'I<(IntPtr X, object Y)>'.
                // class CB : I<(System.IntPtr X, object Y)>, I<(nint, dynamic)> { } // differences: names, nint, dynamic
                Diagnostic(ErrorCode.ERR_DuplicateInterfaceWithDifferencesInBaseList, "CB")
                    .WithArguments("I<(nint, dynamic)>", "I<(System.IntPtr X, object Y)>", "CB")
                    .WithLocation(14, 7),
                // (14,44): error CS1966: 'CB': cannot implement a dynamic interface 'I<(nint, dynamic)>'
                // class CB : I<(System.IntPtr X, object Y)>, I<(nint, dynamic)> { } // differences: names, nint, dynamic
                Diagnostic(ErrorCode.ERR_DeriveFromConstructedDynamic, "I<(nint, dynamic)>")
                    .WithArguments("CB", "I<(nint, dynamic)>")
                    .WithLocation(14, 44),
                // (15,7): error CS8779: 'I<(nint, object)>' is already listed in the interface list on type 'CC' as 'I<(IntPtr X, object? Y)>'.
                // class CC : I<(System.IntPtr X, object? Y)>, I<(nint, object)> { } // differences: names, nint, nullable
                Diagnostic(ErrorCode.ERR_DuplicateInterfaceWithDifferencesInBaseList, "CC")
                    .WithArguments("I<(nint, object)>", "I<(System.IntPtr X, object? Y)>", "CC")
                    .WithLocation(15, 7),
                // (16,7): error CS8779: 'I<(nint, dynamic)>' is already listed in the interface list on type 'CD' as 'I<(IntPtr, object?)>'.
                // class CD : I<(System.IntPtr, object?)>, I<(nint, dynamic)> { } // differences: nint, dynamic, nullable
                Diagnostic(ErrorCode.ERR_DuplicateInterfaceWithDifferencesInBaseList, "CD")
                    .WithArguments("I<(nint, dynamic)>", "I<(System.IntPtr, object?)>", "CD")
                    .WithLocation(16, 7),
                // (16,41): error CS1966: 'CD': cannot implement a dynamic interface 'I<(nint, dynamic)>'
                // class CD : I<(System.IntPtr, object?)>, I<(nint, dynamic)> { } // differences: nint, dynamic, nullable
                Diagnostic(ErrorCode.ERR_DeriveFromConstructedDynamic, "I<(nint, dynamic)>")
                    .WithArguments("CD", "I<(nint, dynamic)>")
                    .WithLocation(16, 41),
                // (17,7): error CS8779: 'I<(nint, dynamic)>' is already listed in the interface list on type 'CE' as 'I<(IntPtr X, object? Y)>'.
                // class CE : I<(System.IntPtr X, object? Y)>, I<(nint, dynamic)> { } // differences: names, dynamic, nullable
                Diagnostic(ErrorCode.ERR_DuplicateInterfaceWithDifferencesInBaseList, "CE")
                    .WithArguments("I<(nint, dynamic)>", "I<(System.IntPtr X, object? Y)>", "CE")
                    .WithLocation(17, 7),
                // (17,45): error CS1966: 'CE': cannot implement a dynamic interface 'I<(nint, dynamic)>'
                // class CE : I<(System.IntPtr X, object? Y)>, I<(nint, dynamic)> { } // differences: names, dynamic, nullable
                Diagnostic(ErrorCode.ERR_DeriveFromConstructedDynamic, "I<(nint, dynamic)>")
                    .WithArguments("CE", "I<(nint, dynamic)>")
                    .WithLocation(17, 45),
                // (18,7): error CS8779: 'I<(nint, dynamic)>' is already listed in the interface list on type 'CF' as 'I<(IntPtr X, object? Y)>'.
                // class CF : I<(System.IntPtr X, object? Y)>, I<(nint, dynamic)> { } // differences: names, nint, dynamic, nullable
                Diagnostic(ErrorCode.ERR_DuplicateInterfaceWithDifferencesInBaseList, "CF")
                    .WithArguments("I<(nint, dynamic)>", "I<(System.IntPtr X, object? Y)>", "CF")
                    .WithLocation(18, 7),
                // (18,45): error CS1966: 'CF': cannot implement a dynamic interface 'I<(nint, dynamic)>'
                // class CF : I<(System.IntPtr X, object? Y)>, I<(nint, dynamic)> { } // differences: names, nint, dynamic, nullable
                Diagnostic(ErrorCode.ERR_DeriveFromConstructedDynamic, "I<(nint, dynamic)>")
                    .WithArguments("CF", "I<(nint, dynamic)>")
                    .WithLocation(18, 45)
            );
        }
...
";
            ...
            comp.VerifyDiagnostics(
                ...
                // class C1<T> : I<nint>, I<T> { }
                Diagnostic(ErrorCode.ERR_UnifyingInterfaceInstantiations, "C1")
                    .WithArguments("C1<T>", "I<nint>", "I<T>")
                    .WithLocation(2, 7),
                ...
                // class C2<T> : I<(nint, T)>, I<(T, System.IntPtr)> { }
                Diagnostic(ErrorCode.ERR_UnifyingInterfaceInstantiations, "C2")
                    .WithArguments("C2<T>", "I<(nint, T)>", "I<(T, System.IntPtr)>")
                    .WithLocation(3, 7),
                ...
                // class C3<T> : I<(T, T)>, I<(System.UIntPtr, nuint)> { }
                Diagnostic(ErrorCode.ERR_UnifyingInterfaceInstantiations, "C3")
                    .WithArguments("C3<T>", "I<(T, T)>", "I<(System.UIntPtr, nuint)>")
                    .WithLocation(4, 7)
            );
        }
...
";
            ...
            comp.VerifyDiagnostics(
                ...
                // class C1<T> : IB1<T>, IB2<nint> { }
                Diagnostic(ErrorCode.ERR_UnifyingInterfaceInstantiations, "C1")
                    .WithArguments("C1<T>", "IA<T>", "IA<nint>")
                    .WithLocation(4, 7),
                ...
                // class C2<T> : IB1<(nint, T)>, IB2<(T, System.IntPtr)> { }
                Diagnostic(ErrorCode.ERR_UnifyingInterfaceInstantiations, "C2")
                    .WithArguments("C2<T>", "IA<(nint, T)>", "IA<(T, System.IntPtr)>")
                    .WithLocation(5, 7),
                ...
                // class C3<T> : IB1<(T, T)>, IB2<(System.UIntPtr, nuint)> { }
                Diagnostic(ErrorCode.ERR_UnifyingInterfaceInstantiations, "C3")
                    .WithArguments("C3<T>", "IA<(T, T)>", "IA<(System.UIntPtr, nuint)>")
                    .WithLocation(6, 7)
            );
        }
