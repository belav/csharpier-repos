    ...
    public static RGBColor FromSpan(int r, int g, int b)
    {
        ...
        return 1 switch
        {
            ...
            compilation.VerifyDiagnostics(
                ...
                //             1 => new RGBColor(span),
                Diagnostic(ErrorCode.ERR_EscapeLocal, "span")
                    .WithArguments("span")
                    .WithLocation(17, 31)
            );
        }
            ...
            for (int i = 0; i < 31; i++)
            {
                ...
                switch (i)
                {
                    ...
                    case 3:
                        ...
                        Assert.Equal(
                            "System.Int32 N",
                            model.GetSymbolInfo(((ConstantPatternSyntax)pattern).Expression)
                        ...
                        Assert.Equal(
                            "System.Int32",
                            model.GetTypeInfo(((ConstantPatternSyntax)pattern).Expression)
                    ...
                    case 9:
                        ...
                        Assert.Equal(
                            "System.Int64",
                            model.GetSymbolInfo(((TypePatternSyntax)pattern).Type)
                                .Symbol.ToTestDisplayString()
                        );
                        Assert.Equal(
                            "System.Object",
                    ...
                    case 20:
                        ...
                        Assert.Equal(
                            "System.Char A",
                            model.GetSymbolInfo(((RelationalPatternSyntax)pattern).Expression)
                                .Symbol.ToTestDisplayString()
                        );
                        Assert.Equal(
                            "System.Object",
...
";
            ...
            void runTest()
            {
                ...
                var source = sourceTemplate.Replace("TESTS", tests.ToString())
