                ...
                @"class C
{
    ...
    static object G;
            ...
            comp.VerifyDiagnostics(
                ...
                //     static object G;
                Diagnostic(ErrorCode.WRN_UnreferencedField, "G")
                    .WithArguments("C.G")
                    .WithLocation(4, 19)
            );
        }
...
#nullable enable
    ...
    static object G;
            ...
            comp.VerifyDiagnostics(
                ...
                // #nullable enable
                Diagnostic(ErrorCode.ERR_FeatureNotAvailableInVersion7, "nullable")
                ...
                @"class C
{
    ...
    static object G;
            ...
            comp.VerifyDiagnostics(
                ...
                //     internal object F;
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "F")
                    .WithArguments("field", "F")
                    .WithLocation(3, 21),
                // (3,21): warning CS0649: Field 'C.F' is never assigned to, and will always have its default value null
                //     internal object F;
                Diagnostic(ErrorCode.WRN_UnassignedInternalField, "F")
                ...
                //     static object G;
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "G")
                    .WithArguments("field", "G")
                    .WithLocation(4, 19),
                // (4,19): warning CS0169: The field 'C.G' is never used
                //     static object G;
                Diagnostic(ErrorCode.WRN_UnreferencedField, "G")
                ...
                @"internal class C<T> where T : new()
{
    ...
    internal T F4 = default(T);
            ...
            comp.VerifyDiagnostics(
                ...
                //     internal T F1;
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "F1")
...
#pragma warning disable 0649
    ...
    private object[]? F4;
            ...
            comp.VerifyDiagnostics(
                ...
                //     internal object?[] F3;
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "F3")
                ...
                @"class C
{
    private static object P { get; set; }
            ...
            comp.VerifyDiagnostics(
                ...
                //     private static object P { get; set; }
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "P")
...
#pragma warning disable 0169
    ...
    private static object P4 { get; set; } = new object();
            ...
            comp.VerifyDiagnostics(
                ...
                //     private static object P1 { get; }
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "P1")
                ...
                //     private static object P3 { get; set; }
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "P3")
                    .WithArguments("property", "P3")
                    .WithLocation(10, 27)
            );
        }
    ...
    where V : struct
{
    ...
    private static V? P12 { get; } = default;
            ...
            comp.VerifyDiagnostics(
                ...
                //     private static U P5 { get; set; }
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "P5")
                    .WithArguments("property", "P5")
                    .WithLocation(11, 22)
            );
        }
    ...
    class C
    {
        ...
        event D E2;
            ...
            comp.VerifyDiagnostics(
                ...
                //         static event D E1;
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "E1")
                    .WithArguments("event", "E1")
                    .WithLocation(11, 24),
                ...
                //         event D E2;
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "E2")
                    .WithArguments("event", "E2")
                    .WithLocation(14, 17)
            );
        }
...
";
            ...
            comp.VerifyDiagnostics(
                ...
                //     public S1(string s) // 1
                Diagnostic(ErrorCode.ERR_UnassignedThisAutoPropertyUnsupportedVersion, "S1")
                    .WithArguments("S1.Prop", "11.0")
                    .WithLocation(5, 12),
                ...
                //         Prop.ToString(); // 2
                Diagnostic(ErrorCode.ERR_UseDefViolationPropertyUnsupportedVersion, "Prop")
                    .WithArguments("Prop", "11.0")
                    .WithLocation(7, 9),
...
";
            ...
            comp.VerifyDiagnostics(
                ...
                //     public S1(string s) // 1, 2
                Diagnostic(ErrorCode.ERR_UnassignedThisUnsupportedVersion, "S1")
                    .WithArguments("S1.field", "11.0")
                    .WithLocation(13, 12),
                ...
                //         System.Console.Write(field); // 3
                Diagnostic(ErrorCode.ERR_UseDefViolationFieldUnsupportedVersion, "field")
...
class C<T> where T : struct
{
    ...
    C() { }
            ...
            comp.VerifyDiagnostics(
                ...
                //     B() { }
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "B")
                    .WithArguments("field", "F2")
                    .WithLocation(11, 5),
                // (5,5): warning CS8618: Non-nullable field 'F1' is uninitialized. Consider declaring the field as nullable.
                //     A() { }
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "A")
                    .WithArguments("field", "F1")
                    .WithLocation(5, 5)
            );
            ...
            comp.VerifyDiagnostics(
                ...
                //     T? F3;
                Diagnostic(ErrorCode.ERR_NullableUnconstrainedTypeParameter, "T?")
                    .WithArguments("9.0")
                    .WithLocation(10, 5)
            );
...
class C5<T, U> where T : A where U : T
{
    ...
    U G5;
            ...
            comp.VerifyDiagnostics(
                ...
                //     U G1;
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "G1")
                    .WithArguments("field", "G1")
                    .WithLocation(7, 7),
    ...
    internal S(string s)
    {
        if (s.Length > 0)
            ...
            comp.VerifyDiagnostics(
                ...
                //     internal S(string s)
                Diagnostic(ErrorCode.ERR_UnassignedThisAutoPropertyUnsupportedVersion, "S")
                    .WithArguments("S.P", "11.0")
                    .WithLocation(6, 14),
    ...
    static I() // 2, 3, 4
    {
        ...
        E3 = () => {};
            ...
            comp.VerifyDiagnostics(
                ...
                //     static I() // 2, 3, 4
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "I")
                    .WithArguments("property", "F2")
                    .WithLocation(16, 12),
    ...
    public C3()
    {
        ...
        if (Prop is null)
        {
            ...
            comp.VerifyDiagnostics(
                ...
                //     public C1() // 1
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "C1")
                    .WithArguments("property", "Prop")
                    .WithLocation(9, 12)
            );
        }
...
class Field
{
  ...
  [MemberNotNull(nameof(F))] void Init() => F = """";
            ...
            var comp = CreateCompilation(
                new[] { source, MemberNotNullAttributeDefinition },
                options: WithNullableEnable(),
...
";
            ...
            comp.VerifyDiagnostics(
                ...
                //     public string BaseProp { get; set; } // 1
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "BaseProp")
                    .WithArguments("property", "BaseProp")
                    .WithLocation(4, 19),
...
";
            ...
            comp.GetDiagnosticsForSyntaxTree(
                ...
                .Verify(
                    ...
                    //     public static readonly string Value1; // 1
                    Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "Value1")
                        .WithArguments("field", "Value1")
                        .WithLocation(4, 35)
                );
            ...
            comp.GetDiagnosticsForSyntaxTree(
                ...
                .Verify(
                    ...
                    //     public static readonly string Value2; // 2
                    Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "Value2")
                        .WithArguments("field", "Value2")
                        .WithLocation(4, 35)
                );
...
";
        ...
        [WorkItem(
            1090263,
            "https://devdiv.visualstudio.com/DefaultCollection/DevDiv/_workitems/edit/1090263"
        )]
    ...
    static void Main()
    {
        new C() { f = { f2 = null }};
            ...
            diagnostics.Verify(
                ...
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "f")
                    .WithArguments("field", "f")
                    .WithLocation(8, 14)
                    .WithWarningAsError(warnAsError)
            );
        ...
        public void CopyConstructor_01()
        {
            ...
            comp.VerifyEmitDiagnostics(
                ...
                //     public string Prop { get; init; } // 1
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "Prop")
                    .WithArguments("property", "Prop")
                    .WithLocation(6, 19),
                ...
                //     public Rec(Rec other) // 2
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "Rec")
                    .WithArguments("property", "Prop")
                    .WithLocation(7, 12)
            );
        }
        ...
        public void CopyConstructor_04()
        {
            ...
            comp.VerifyEmitDiagnostics(
                ...
                //         var rec = new Rec(this);
                Diagnostic(ErrorCode.ERR_RequiredMemberMustBeSet, "Rec")
                    .WithArguments("Rec.Prop")
                    .WithLocation(9, 23)
            );
        }
