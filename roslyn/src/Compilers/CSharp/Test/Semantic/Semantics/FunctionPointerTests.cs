...
namespace Microsoft.CodeAnalysis.CSharp.UnitTests
{
    ...
    {
        private CSharpCompilation CreateCompilationWithFunctionPointers(
            string source,
...
using s = delegate*<void>;"
            ...
            comp.VerifyDiagnostics(
                ...
                // using s = delegate*<void>;
                Diagnostic(ErrorCode.ERR_SimpleProgramNotAnExecutable, "delegate*<void>;")
                    .WithLocation(2, 11),
...
",
            ...
            comp.VerifyDiagnostics(
                ...
                //     Test1<string, int>(string.Empty, v => 0);
                Diagnostic(ErrorCode.ERR_AnonMethToNonDel, "v => 0")
