...
class Program
{
    ...
    Expression<Func<string>> M(dynamic d) {
        ...
        string expectedOutput =
            @"<>
<System.String[]>";
        var verifier = CompileAndVerify(source, new[] { CSharpRef }, expectedOutput: expectedOutput)
            .VerifyDiagnostics();
    }
    ...
    string M()
    {
        ...
        CreateCompilation(
            ...
            .VerifyDiagnostics(
                ...
                //         string other = """world""";
                Diagnostic(ErrorCode.ERR_FeatureInPreview, @"""""""world""""""")
                    .WithArguments("raw string literals")
                    .WithLocation(6, 24),
