    ...
    public Program(int dummy)
    {
            ...
            CreateCompilation(
                ...
                .VerifyDiagnostics(
                    ...
                    //     public Program(int dummy)
                    Diagnostic(ErrorCode.WRN_UnassignedThisAutoProperty, "Program")
    ...
    public Program(int dummy)
    {
            ...
            CreateCompilation(
                ...
                .VerifyDiagnostics(
                    ...
                    //     public Program(int dummy)
                    Diagnostic(ErrorCode.WRN_UnassignedThis, "Program")
        ...
        Property = default;
            ...
            CreateCompilation(
                ...
                .VerifyDiagnostics(
                    ...
                    //         Struct v2 = Property;
                    Diagnostic(ErrorCode.WRN_UseDefViolationProperty, "Property")
        ...
        Field = default;
            ...
            CreateCompilation(
                ...
                .VerifyDiagnostics(
                    ...
                    //         Struct v2 = Field;
                    Diagnostic(ErrorCode.WRN_UseDefViolationField, "Field")
                        .WithArguments("Field")
                        .WithLocation(6, 21)
                );
        }
        ...
        this.Field = default;
            ...
            CreateCompilation(
                ...
                .VerifyDiagnostics(
                    ...
                    //         Program p2 = this;
                    Diagnostic(ErrorCode.WRN_UseDefViolationThis, "this")
                        .WithArguments("this")
                        .WithLocation(6, 22)
                );
        }
