...
";
            ...
            comp.VerifyDiagnostics(
                ...
                //         [A(out var s)]
                Diagnostic(ErrorCode.ERR_SyntaxError, "s")
                    .WithArguments(",", "")
                    .WithLocation(18, 20)
            );
        }
    ...
    public void M()
    {
        ...
        Local<int>();
            ...
            comp.VerifyDiagnostics(
                ...
                //         void Local<[A, B, CLSCompliant, D]T>() { }
                Diagnostic(ErrorCode.ERR_AttributesInLocalFuncDecl, "[A, B, CLSCompliant, D]")
                    .WithLocation(7, 20),
            ...
            var x = tree.GetRoot()
                ...
                .Single();
            var localSymbol = model.GetDeclaredSymbol(x)
...
";
            ...
            {
                var name = $"z{i}";
                var designation = descendents.OfType<SingleVariableDesignationSyntax>()
                    .Where(d => d.Identifier.ValueText == name)
                    .Single();
                var symbol = (ILocalSymbol)model.GetDeclaredSymbol(designation);
                Assert.NotNull(symbol);
                Assert.Equal("System.Int32", symbol.Type.ToTestDisplayString());
                var refs = descendents.OfType<IdentifierNameSyntax>()
...
";
            CompileAndVerify(
                ...
                sourceSymbolValidator: m =>
                {
                    ...
                    var name = "N";
                    var declarator = descendents.OfType<VariableDeclaratorSyntax>()
                        .Where(d => d.Identifier.ValueText == name)
                        .Single();
...
class C2
{
    ...
    static void F3()
    {
        ...
        static void B3(object y) => _ = y;
            ...
            var actualSymbols = nodes.Select(n => model.GetSymbolInfo(n.Left).Symbol)
