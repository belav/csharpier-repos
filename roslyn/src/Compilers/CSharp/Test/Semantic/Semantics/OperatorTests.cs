...
o1 OPERATOR o2  //-ObjectKIND"
        ...
        private const string PostfixIncrementTemplate =
            Prefix
            + @"
e   OPERATOR, //-EnumKIND
                ...
                @"class Program
{
    ...
    static void Main()
    {
        ...
        F<decimal?>();
            ...
            var methodBody =
                tree.GetRoot().DescendantNodes().OfType<MethodDeclarationSyntax>().Last().Body;
...
class Module1
{
    void Test(int x)
    {
        ...
        )
        {
            ...
            BinaryOperatorKind result = OverloadResolution
                .BinopEasyOut
