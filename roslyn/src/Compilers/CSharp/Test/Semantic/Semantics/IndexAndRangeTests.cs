...
";
            ...
            comp.VerifyDiagnostics(
                ...
                //         return new Index(s1)..;
                Diagnostic(ErrorCode.ERR_EscapeLocal, "s1")
                    .WithArguments("s1")
                    .WithLocation(28, 26),
                ...
                //         return ..new Index(s3);
                Diagnostic(ErrorCode.ERR_EscapeLocal, "s3")
                    .WithArguments("s3")
                    .WithLocation(40, 28),
                ...
                //         return Range.EndAt(new Index(s4));
                Diagnostic(ErrorCode.ERR_EscapeLocal, "s4")
                    .WithArguments("s4")
                    .WithLocation(46, 38),
                ...
                //         return new Index(s51) .. new Index(s52);
                Diagnostic(ErrorCode.ERR_EscapeLocal, "s52")
                    .WithArguments("s52")
                    .WithLocation(52, 44),
                ...
                //         return new Range(new Index(s61), new Index(s62));
                Diagnostic(ErrorCode.ERR_EscapeLocal, "s62")
                    .WithArguments("s62")
                    .WithLocation(58, 52),
                ...
                //         return new Index(s71) .. new Index(s72);
                Diagnostic(ErrorCode.ERR_EscapeLocal, "s71")
                    .WithArguments("s71")
                    .WithLocation(64, 26),
                ...
                //         return new Range(new Index(s81), new Index(s82));
                Diagnostic(ErrorCode.ERR_EscapeLocal, "s81")
                    .WithArguments("s81")
                    .WithLocation(70, 36),
                ...
                //         return new Index(s91) .. new Index(s92);
                Diagnostic(ErrorCode.ERR_EscapeLocal, "s91")
                    .WithArguments("s91")
                    .WithLocation(77, 26),
                ...
                //         return new Range(new Index(s101), new Index(s102));
                Diagnostic(ErrorCode.ERR_EscapeLocal, "s101")
                    .WithArguments("s101")
                    .WithLocation(84, 36)
            );
        }
...
";
            ...
            comp.VerifyDiagnostics(
                ...
                //         return r1;
                Diagnostic(ErrorCode.ERR_EscapeLocal, "r1")
                    .WithArguments("r1")
                    .WithLocation(29, 16),
                ...
                //         return r2;
                Diagnostic(ErrorCode.ERR_EscapeLocal, "r2")
                    .WithArguments("r2")
                    .WithLocation(36, 16),
                ...
                //         return r3;
                Diagnostic(ErrorCode.ERR_EscapeLocal, "r3")
                    .WithArguments("r3")
                    .WithLocation(43, 16),
                ...
                //         return r4;
                Diagnostic(ErrorCode.ERR_EscapeLocal, "r4")
                    .WithArguments("r4")
                    .WithLocation(50, 16),
                ...
                //         return r5;
                Diagnostic(ErrorCode.ERR_EscapeLocal, "r5")
                    .WithArguments("r5")
                    .WithLocation(57, 16),
                ...
                //         return r6;
                Diagnostic(ErrorCode.ERR_EscapeLocal, "r6")
                    .WithArguments("r6")
                    .WithLocation(64, 16),
                ...
                //         return r7;
                Diagnostic(ErrorCode.ERR_EscapeLocal, "r7")
                    .WithArguments("r7")
                    .WithLocation(71, 16),
                ...
                //         return r8;
                Diagnostic(ErrorCode.ERR_EscapeLocal, "r8")
                    .WithArguments("r8")
                    .WithLocation(78, 16),
                ...
                //         return r9;
                Diagnostic(ErrorCode.ERR_EscapeLocal, "r9")
                    .WithArguments("r9")
                    .WithLocation(86, 16),
                ...
                //         return r10;
                Diagnostic(ErrorCode.ERR_EscapeLocal, "r10")
                    .WithArguments("r10")
                    .WithLocation(94, 16)
            );
        }
