    ...
    public static void Main() {
        ...
        Console.WriteLine(zzz[0]);
            ...
            comp.VerifyDiagnostics(
                ...
                //         var b = a["str2"];
                Diagnostic(ErrorCode.ERR_BadArgType, @"""str2""")
                ...
                //         Console.WriteLine(zzz[0]);
                Diagnostic(ErrorCode.ERR_NameNotInContext, "zzz")
                    .WithArguments("zzz")
                    .WithLocation(11, 27)
            );
        }
    ...
    readonly void M(Index i, Range r)
    {
        ...
        _ = this[r]; // 2
            ...
            comp.VerifyDiagnostics(
                ...
                //         _ = this[i]; // 1
                Diagnostic(ErrorCode.WRN_ImplicitCopyInReadOnlyMember, "this")
                    .WithArguments("S.Count.get", "this")
                    .WithLocation(11, 13),
    ...
    public static void Main()
    {
        ...
        Throws(() => new Span<char>(s.ToCharArray())[0..1]);
            ...
            comp.VerifyDiagnostics(
                ...
                //         Throws(() => new Span<char>(s.ToCharArray())[0..1]);
                Diagnostic(ErrorCode.ERR_BadTypeArgument, "Throws")
    ...
    void M(B b)
    {
        ...
        _ = b[0..];
            ...
            comp.VerifyDiagnostics(
                ...
                //         _ = b[^0];
                Diagnostic(ErrorCode.ERR_InaccessibleGetter, "b[^0]")
    ...
    void M()
    {
        ...
        _ = this[0..];
            ...
            comp.VerifyDiagnostics(
                ...
                //         _ = this[^0];
                Diagnostic(ErrorCode.ERR_MissingPredefinedMember, "this[^0]")
        ...
        _ = this[0..];
            ...
            comp.VerifyDiagnostics(
                ...
                Diagnostic(ErrorCode.ERR_MissingPredefinedMember, "this[0..]")
                    .WithArguments(
                        "System.Range",
                        "get_" + (propertyName == "Start" ? "End" : "Start")
                    )
                    .WithLocation(24, 13)
            );
        }
    ...
    public void M(int[] arr) {
        ref int[] x = ref arr[0..2];
            ...
            comp.VerifyDiagnostics(
                ...
                //         ref int[] x = ref arr[0..2];
                Diagnostic(ErrorCode.ERR_PredefinedTypeNotFound, "0..2")
    ...
    public void M(int[] arr) {
        var x = arr[0..2];
            ...
            comp.VerifyDiagnostics(
                ...
                //         var x = arr[0..2];
                Diagnostic(ErrorCode.ERR_MissingPredefinedMember, "0..2")
    ...
    public readonly struct Index
    {
        public Index(int value, bool fromEnd) { }
            ...
            comp.VerifyDiagnostics(
                ...
                //         var x = arr[^2];
                Diagnostic(ErrorCode.ERR_MissingPredefinedMember, "^2")
                    .WithArguments("System.Index", "GetOffset")
                    .WithLocation(6, 21)
            );
...
class Test
{
    void M(int arg)
    {
        var x = ^arg;
            ...
            Assert.Equal("System.Index", model.GetTypeInfo(expression).Type.ToTestDisplayString());
            Assert.Equal(
                "System.Index..ctor(System.Int32 value, [System.Boolean fromEnd = false])",
    ...
    public static Test operator ^(Test value) => default;  
        ...
        public void IndexExpression_OlderLanguageVersion()
        {
            var expected = new[]
            {
                ...
                //         var x = ^1;
                Diagnostic(ErrorCode.ERR_FeatureNotAvailableInVersion7_3, "^1")
                    .WithArguments("index operator", "8.0")
                    .WithLocation(6, 17),
            };
            const string source =
...
class Test
{
    void M(int arg)
    {
        ...
        var d = ..;
            ...
            Assert.Equal(
                "System.Range",
                model.GetTypeInfo(expressions[0]).Type.ToTestDisplayString()
            );
            Assert.Null(model.GetSymbolInfo(expressions[0]).Symbol);
            Assert.Equal(
                "System.Int32",
                model.GetTypeInfo(expressions[0].RightOperand).Type.ToTestDisplayString()
            );
            Assert.Equal(
                "System.Int32",
                model.GetTypeInfo(expressions[0].LeftOperand).Type.ToTestDisplayString()
            );

            Assert.Equal(
                "System.Range",
                model.GetTypeInfo(expressions[1]).Type.ToTestDisplayString()
            );
            Assert.Equal(
                RangeStartAtSignature,
                model.GetSymbolInfo(expressions[1]).Symbol.ToTestDisplayString()
            );
            Assert.Null(expressions[1].RightOperand);
            Assert.Equal(
                "System.Int32",
                model.GetTypeInfo(expressions[1].LeftOperand).Type.ToTestDisplayString()
            );

            Assert.Equal(
                "System.Range",
                model.GetTypeInfo(expressions[2]).Type.ToTestDisplayString()
            );
            Assert.Equal(
                RangeEndAtSignature,
                model.GetSymbolInfo(expressions[2]).Symbol.ToTestDisplayString()
            );
            Assert.Equal(
                "System.Int32",
                model.GetTypeInfo(expressions[2].RightOperand).Type.ToTestDisplayString()
            );
            Assert.Null(expressions[2].LeftOperand);

            Assert.Equal(
                "System.Range",
                model.GetTypeInfo(expressions[3]).Type.ToTestDisplayString()
            );
            Assert.Equal(
                RangeAllSignature,
                model.GetSymbolInfo(expressions[3]).Symbol.ToTestDisplayString()
            );
...
class Test
{
    void M(Index start, Index end)
    {
        ...
        var d = ..;
            ...
            Assert.Equal(
                RangeCtorSignature,
                model.GetSymbolInfo(expressions[0]).Symbol.ToTestDisplayString()
            );
            Assert.Equal(
                "System.Index",
                model.GetTypeInfo(expressions[0].RightOperand).Type.ToTestDisplayString()
    ...
    void M()
    {
        ...
        var d = ..;
            ...
            var expected = new[]
            {
                ...
                //         var a = 1..2;
                Diagnostic(ErrorCode.ERR_FeatureNotAvailableInVersion7_3, "1..2")
                    .WithArguments("range operator", "8.0")
                    .WithLocation(6, 17),
                ...
                //         var c = ..2;
                Diagnostic(ErrorCode.ERR_FeatureNotAvailableInVersion7_3, "..2")
                    .WithArguments("range operator", "8.0")
                    .WithLocation(8, 17),
            ...
            CreateCompilationWithIndexAndRange(source, parseOptions: TestOptions.Regular7_3)
                .VerifyDiagnostics(expected);
            CreateCompilationWithIndexAndRange(source, parseOptions: TestOptions.Regular8)
                .VerifyDiagnostics();
        }
...
";
            ...
            comp.VerifyDiagnostics(
                ...
                //         return new Index(s1)..;
                Diagnostic(ErrorCode.ERR_EscapeCall, "new Index(s1)")
                    .WithArguments("System.Index.Index(System.Span<int>)", "x")
                    .WithLocation(28, 16),
                ...
                //         return new Index(s1)..;
                Diagnostic(ErrorCode.ERR_EscapeVariable, "s1")
                    .WithArguments("s1")
                    .WithLocation(28, 26),
                ...
                //         return Range.StartAt(new Index(s2));
                Diagnostic(ErrorCode.ERR_EscapeCall, "Range.StartAt(new Index(s2))")
                    .WithArguments("System.Range.StartAt(System.Index)", "start")
                    .WithLocation(34, 16),
                ...
                //         return Range.StartAt(new Index(s2));
                Diagnostic(ErrorCode.ERR_EscapeCall, "new Index(s2)")
                    .WithArguments("System.Index.Index(System.Span<int>)", "x")
                    .WithLocation(34, 30),
                ...
                //         return ..new Index(s3);
                Diagnostic(ErrorCode.ERR_EscapeCall, "new Index(s3)")
                    .WithArguments("System.Index.Index(System.Span<int>)", "x")
                    .WithLocation(40, 18),
                ...
                //         return ..new Index(s3);
                Diagnostic(ErrorCode.ERR_EscapeVariable, "s3")
                    .WithArguments("s3")
                    .WithLocation(40, 28),
                ...
                //         return Range.EndAt(new Index(s4));
                Diagnostic(ErrorCode.ERR_EscapeCall, "Range.EndAt(new Index(s4))")
                    .WithArguments("System.Range.EndAt(System.Index)", "end")
                    .WithLocation(46, 16),
                ...
                //         return Range.EndAt(new Index(s4));
                Diagnostic(ErrorCode.ERR_EscapeCall, "new Index(s4)")
                    .WithArguments("System.Index.Index(System.Span<int>)", "x")
                    .WithLocation(46, 28),
                ...
                //         return Range.EndAt(new Index(s4));
                Diagnostic(ErrorCode.ERR_EscapeVariable, "s4")
                    .WithArguments("s4")
                    .WithLocation(46, 38),
                ...
                //         return new Index(s51) .. new Index(s52);
                Diagnostic(ErrorCode.ERR_EscapeCall, "new Index(s52)")
                    .WithArguments("System.Index.Index(System.Span<int>)", "x")
                    .WithLocation(52, 34),
                ...
                //         return new Index(s51) .. new Index(s52);
                Diagnostic(ErrorCode.ERR_EscapeVariable, "s52")
                    .WithArguments("s52")
                    .WithLocation(52, 44),
                ...
                //         return new Range(new Index(s61), new Index(s62));
                Diagnostic(ErrorCode.ERR_EscapeCall, "new Range(new Index(s61), new Index(s62))")
                    .WithArguments("System.Range.Range(System.Index, System.Index)", "end")
                    .WithLocation(58, 16),
                ...
                //         return new Range(new Index(s61), new Index(s62));
                Diagnostic(ErrorCode.ERR_EscapeCall, "new Index(s62)")
                    .WithArguments("System.Index.Index(System.Span<int>)", "x")
                    .WithLocation(58, 42),
                ...
                //         return new Range(new Index(s61), new Index(s62));
                Diagnostic(ErrorCode.ERR_EscapeVariable, "s62")
                    .WithArguments("s62")
                    .WithLocation(58, 52),
                ...
                //         return new Index(s71) .. new Index(s72);
                Diagnostic(ErrorCode.ERR_EscapeCall, "new Index(s71)")
                    .WithArguments("System.Index.Index(System.Span<int>)", "x")
                    .WithLocation(64, 16),
                ...
                //         return new Index(s71) .. new Index(s72);
                Diagnostic(ErrorCode.ERR_EscapeVariable, "s71")
                    .WithArguments("s71")
                    .WithLocation(64, 26),
                ...
                //         return new Range(new Index(s81), new Index(s82));
                Diagnostic(ErrorCode.ERR_EscapeCall, "new Range(new Index(s81), new Index(s82))")
                    .WithArguments("System.Range.Range(System.Index, System.Index)", "start")
                    .WithLocation(70, 16),
                ...
                //         return new Range(new Index(s81), new Index(s82));
                Diagnostic(ErrorCode.ERR_EscapeCall, "new Index(s81)")
                    .WithArguments("System.Index.Index(System.Span<int>)", "x")
                    .WithLocation(70, 26),
                ...
                //         return new Range(new Index(s81), new Index(s82));
                Diagnostic(ErrorCode.ERR_EscapeVariable, "s81")
                    .WithArguments("s81")
                    .WithLocation(70, 36),
                ...
                //         return new Index(s91) .. new Index(s92);
                Diagnostic(ErrorCode.ERR_EscapeCall, "new Index(s91)")
                    .WithArguments("System.Index.Index(System.Span<int>)", "x")
                    .WithLocation(77, 16),
                ...
                //         return new Index(s91) .. new Index(s92);
                Diagnostic(ErrorCode.ERR_EscapeVariable, "s91")
                    .WithArguments("s91")
                    .WithLocation(77, 26),
                ...
                //         return new Range(new Index(s101), new Index(s102));
                Diagnostic(ErrorCode.ERR_EscapeCall, "new Range(new Index(s101), new Index(s102))")
                    .WithArguments("System.Range.Range(System.Index, System.Index)", "start")
                    .WithLocation(84, 16),
                ...
                //         return new Range(new Index(s101), new Index(s102));
                Diagnostic(ErrorCode.ERR_EscapeCall, "new Index(s101)")
                    .WithArguments("System.Index.Index(System.Span<int>)", "x")
                    .WithLocation(84, 26),
                ...
                //         return new Range(new Index(s101), new Index(s102));
                Diagnostic(ErrorCode.ERR_EscapeVariable, "s101")
                    .WithArguments("s101")
                    .WithLocation(84, 36)
            );
        }
...
";
            ...
            comp.VerifyDiagnostics(
                ...
                //         return r1;
                Diagnostic(ErrorCode.ERR_EscapeVariable, "r1")
                    .WithArguments("r1")
                    .WithLocation(29, 16),
                ...
                //         return r2;
                Diagnostic(ErrorCode.ERR_EscapeVariable, "r2")
                    .WithArguments("r2")
                    .WithLocation(36, 16),
                ...
                //         return r3;
                Diagnostic(ErrorCode.ERR_EscapeVariable, "r3")
                    .WithArguments("r3")
                    .WithLocation(43, 16),
                ...
                //         return r4;
                Diagnostic(ErrorCode.ERR_EscapeVariable, "r4")
                    .WithArguments("r4")
                    .WithLocation(50, 16),
                ...
                //         return r5;
                Diagnostic(ErrorCode.ERR_EscapeVariable, "r5")
                    .WithArguments("r5")
                    .WithLocation(57, 16),
                ...
                //         return r6;
                Diagnostic(ErrorCode.ERR_EscapeVariable, "r6")
                    .WithArguments("r6")
                    .WithLocation(64, 16),
                ...
                //         return r7;
                Diagnostic(ErrorCode.ERR_EscapeVariable, "r7")
                    .WithArguments("r7")
                    .WithLocation(71, 16),
                ...
                //         return r8;
                Diagnostic(ErrorCode.ERR_EscapeVariable, "r8")
                    .WithArguments("r8")
                    .WithLocation(78, 16),
                ...
                //         return r9;
                Diagnostic(ErrorCode.ERR_EscapeVariable, "r9")
                    .WithArguments("r9")
                    .WithLocation(86, 16),
                ...
                //         return r10;
                Diagnostic(ErrorCode.ERR_EscapeVariable, "r10")
                    .WithArguments("r10")
                    .WithLocation(94, 16)
            );
        }
