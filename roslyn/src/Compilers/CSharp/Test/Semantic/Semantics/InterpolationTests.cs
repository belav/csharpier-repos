...
";
        ...
        public void RefEscape_14()
        {
            ...
            comp.VerifyDiagnostics(
                ...
                //         return r;
                Diagnostic(ErrorCode.ERR_EscapeVariable, "r")
                    .WithArguments("r")
                    .WithLocation(13, 16)
            );
        }
        ...
        public void RefEscape_15()
        {
            ...
            comp.VerifyDiagnostics(
                ...
                //         _ = r[$"{1}"];
                Diagnostic(ErrorCode.ERR_BadArgRef, "r")
                    .WithArguments("3", "ref")
                    .WithLocation(18, 13)
            );
        }
        ...
        public void RefEscape_16()
        {
            ...
            comp.VerifyDiagnostics(
                ...
                //         _ = r[ref r, $"{1}"];
                Diagnostic(ErrorCode.ERR_EscapeCall, @"$""{1}""")
                    .WithArguments("CustomHandler.CustomHandler(int, int, ref R)", "r")
                    .WithLocation(18, 22),
                // (18,22): error CS8347: Cannot use a result of 'CustomHandler.CustomHandler(int, int, ref R)' in this context because it may expose variables referenced by parameter 'r' outside of their declaration scope
                //         _ = r[ref r, $"{1}"];
                Diagnostic(ErrorCode.ERR_EscapeCall, @"$""{1}""")
        ...
        public void RefEscape_18()
        {
            ...
            comp.VerifyDiagnostics(
                ...
                //         return $"{1}";
                Diagnostic(ErrorCode.ERR_EscapeCall, @"$""{1}""")
                    .WithArguments("CustomHandler.CustomHandler(int, int, in int)", "i")
                    .WithLocation(13, 16),
                ...
                //         return h2;
                Diagnostic(ErrorCode.ERR_EscapeVariable, "h2")
                    .WithArguments("h2")
                    .WithLocation(18, 16)
            );
        }
        ...
        public void RefEscape_NestedCalls_06()
        {
            ...
            comp.VerifyDiagnostics(
                ...
                //         return r
                Diagnostic(
                        ErrorCode.ERR_EscapeCall,
                        @"r
            .F($""{span}"")"
                    )
                    .WithArguments("R.F(CustomHandler)", "handler")
                    .WithLocation(9, 16),
...
"
        ...
        [
            ConditionalFact(typeof(CoreClrOnly)),
            WorkItem("https://github.com/dotnet/roslyn/issues/68834")
        ]
...
class C
{
    string M()
    {
        ...
        public void ConvertStringLiteralToInterpolatedStringHandlerError_ByVal(string stringLiteral)
        {
            ...
            CreateCompilation(code, targetFramework: TargetFramework.Net60)
                .VerifyDiagnostics(
                    // (5,15): error CS9205: Expected interpolated string
                    //         ByVal("");
                    Diagnostic(ErrorCode.ERR_ExpectedInterpolatedString, stringLiteral)
                        .WithLocation(5, 15),
                    // (6,19): error CS1510: A ref or out value must be an assignable variable
                    //         ByVal(ref "");
                    Diagnostic(ErrorCode.ERR_RefLvalueExpected, stringLiteral)
                        .WithLocation(6, 19),
                    // (7,18): error CS8156: An expression cannot be used in this context because it may not be passed or returned by reference
                    //         ByVal(in "");
                    Diagnostic(ErrorCode.ERR_RefReturnLvalueExpected, stringLiteral)
                        .WithLocation(7, 18),
        ...
        public void ConvertStringLiteralToInterpolatedStringHandlerError_ByOut(string stringLiteral)
        {
            ...
            CreateCompilation(code, targetFramework: TargetFramework.Net60)
                .VerifyDiagnostics(
                    ...
                    //         ByOut("");
                    Diagnostic(ErrorCode.ERR_BadArgRef, stringLiteral)
                        .WithArguments("1", "out")
                        .WithLocation(5, 15),
                    // (6,19): error CS1510: A ref or out value must be an assignable variable
                    //         ByOut(ref "");
                ...
                .VerifyDiagnostics(
                    ...
                    Diagnostic(ErrorCode.ERR_BadArgType, "s")
                        .WithArguments(
                            "1",
                            "string",
                            "in System.Runtime.CompilerServices.DefaultInterpolatedStringHandler"
                        )
                        .WithLocation(7, 14)
                );
        }
        ...
        public void DefaultSyntaxValueReentrancy_01()
        {
            ...
            compilation.VerifyDiagnostics(
                ...
                //     public A(int x, A a = $"{1}") { }
                Diagnostic(ErrorCode.ERR_DefaultValueMustBeConstant, @"$""{1}""")
                    .WithArguments("a")
                    .WithLocation(8, 27)
            );
        }
