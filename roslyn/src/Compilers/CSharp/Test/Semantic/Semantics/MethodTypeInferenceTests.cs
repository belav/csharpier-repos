...
";
            CreateCompilationWithMscorlib40AndSystemCore(source, new[] { CSharpRef })
...
""";
        ...
        private static void CheckDiscard(
            SemanticModel model,
            DiscardDesignationSyntax discard,
            string type
        )
        {
            ...
            Assert.Equal(
                type,
                model.GetTypeInfo(declaration).Type.ToTestDisplayString(includeNonNullable: true)
            );
        ...
        )
        {
            ...
            Assert.Equal(
                type,
                model.GetTypeInfo(discard).Type.ToTestDisplayString(includeNonNullable: true)
            );
        }
...
";
            ...
            Assert.Equal(
                "void C<System.Char>.M<System.Char>(System.Func<System.Char, System.Char> f1, System.Func<System.Int64, System.Char> f2)",
...
";
            ...
            Assert.Equal(SpecialType.System_Char, method.TypeArguments.Single().SpecialType);
            Assert.Equal(
                "void C<System.Char>.M<System.Char>(System.Func<System.Char, System.Char> f1, System.Func<System.Int64, System.Char> f2, params System.Int32[] a)",
                method.ToTestDisplayString()
            );
        }
