...
";
            ...
            comp.VerifyEmitDiagnostics(
                ...
                //     public string Property { get; init; }
                Diagnostic(ErrorCode.ERR_FeatureNotAvailableInVersion8, "init")
                    .WithArguments("init-only setters", "9.0")
                    .WithLocation(4, 35)
            );
        ...
        [
            Theory,
            CombinatorialData,
            WorkItem(50245, "https://github.com/dotnet/roslyn/issues/50245")
        ]
...
";
            var lib = CreateCompilation(
                new[] { lib_cs, IsExternalInitTypeDefinition },
...
";
            ...
            var comp = CreateCompilation(
                ...
                references: new[]
                {
                    useMetadataImage ? lib.EmitToImageReference() : lib.ToMetadataReference(),
                }
            );
            comp.VerifyEmitDiagnostics(
                // (6,23): error CS8400: Feature 'init-only setters' is not available in C# 8.0. Please use language version 9.0 or greater.
                //         _ = new C() { Property = string.Empty, Property2 = string.Empty };
                Diagnostic(ErrorCode.ERR_FeatureNotAvailableInVersion8, "Property")
                    .WithArguments("init-only setters", "9.0")
                    .WithLocation(6, 23),
                // (6,48): error CS0200: Property or indexer 'C.Property2' cannot be assigned to -- it is read only
                //         _ = new C() { Property = string.Empty, Property2 = string.Empty };
                Diagnostic(ErrorCode.ERR_AssgReadonlyProp, "Property2")
                    .WithArguments("C.Property2")
                    .WithLocation(6, 48)
            );
        }
...
";
            ...
            comp.VerifyEmitDiagnostics(
                ...
                //         _ = new Container() { contained = { Property = string.Empty, Property2 = string.Empty } };
                Diagnostic(ErrorCode.ERR_AssignmentInitOnly, "Property")
...
";
            ...
            comp.VerifyEmitDiagnostics(
                ...
                //         c.Property = string.Empty;
                Diagnostic(ErrorCode.ERR_AssignmentInitOnly, "c.Property")
                    .WithArguments("C.Property")
                    .WithLocation(6, 9),
                // (7,9): error CS0200: Property or indexer 'C.Property2' cannot be assigned to -- it is read only
                //         c.Property2 = string.Empty;
                Diagnostic(ErrorCode.ERR_AssgReadonlyProp, "c.Property2")
                    .WithArguments("C.Property2")
                    .WithLocation(7, 9)
            );
        }
...
";
            ...
            comp.VerifyEmitDiagnostics(
                ...
                // [Test(Property = 42, Property2 = 43)]
                Diagnostic(ErrorCode.ERR_FeatureNotAvailableInVersion8, "Property = 42")
                    .WithArguments("init-only setters", "9.0")
                    .WithLocation(2, 7),
                ...
                // [Test(Property = 42, Property2 = 43)]
                Diagnostic(ErrorCode.ERR_BadNamedAttributeArgument, "Property2")
                    .WithArguments("Property2")
                    .WithLocation(2, 22)
            );
...
";
            ...
            comp.VerifyEmitDiagnostics(
                ...
                //     public C() : this(Property = null) // 1
                Diagnostic(ErrorCode.ERR_ObjectRequired, "Property")
                    .WithArguments("C.Property")
                    .WithLocation(5, 23),
...
";
            ...
            comp.VerifyEmitDiagnostics(
                ...
                //         _ = new C() { Property = null }; // 2, 3
                Diagnostic(ErrorCode.ERR_InaccessibleSetter, "Property")
                    .WithArguments("C.Property")
                    .WithLocation(20, 23),
...
";
            ...
            comp.VerifyEmitDiagnostics(
                ...
                //         _ = new C() { Property = null }; // 2
                Diagnostic(ErrorCode.ERR_BadProtectedAccess, "Property")
                    .WithArguments("C.Property", "C", "Derived")
                    .WithLocation(20, 23),
                // (21,9): error CS8802: Init-only property or indexer 'C.Property' can only be assigned in an object initializer, or on 'this' or 'base' in an instance constructor or an 'init' accessor.
                //         c.Property = null; // 3, 4
                Diagnostic(ErrorCode.ERR_AssignmentInitOnly, "c.Property")
...
";
            ...
            comp.VerifyEmitDiagnostics(
                ...
                //     public string Property { protected init { throw null; } }
                Diagnostic(ErrorCode.ERR_AccessModMissingAccessor, "Property")
                    .WithArguments("C.Property")
                    .WithLocation(4, 19)
            );
        }
...
";
            ...
            comp.VerifyEmitDiagnostics(
                ...
                //         Property = null; // 1
                Diagnostic(ErrorCode.ERR_AssignmentInitOnly, "Property")
                    .WithArguments("C<string>.Property")
                    .WithLocation(10, 9)
            );

            var property = (PropertySymbol)
                comp
                    .GlobalNamespace.GetTypeMember("Derived")
...
";
            ...
            comp.VerifyEmitDiagnostics(
                ...
                //     public string Property { get => throw null; init { } }
                Diagnostic(ErrorCode.ERR_PredefinedTypeNotFound, "init")
...
";
            ...
            comp.VerifyEmitDiagnostics(
                ...
                //     public string otherField = (Property = null); // 5
                Diagnostic(ErrorCode.ERR_FieldInitRefNonstatic, "Property")
                    .WithArguments("C.Property")
                    .WithLocation(43, 33),
...
";
            var libComp = CreateCompilation(
                new[] { parent, IsExternalInitTypeDefinition },
                parseOptions: TestOptions.Regular9
            );
            var comp = CreateCompilation(
                new[] { source, main },
                references: new[]
                {
                    emitImage ? libComp.EmitToImageReference() : libComp.ToMetadataReference(),
                },
                parseOptions: TestOptions.Regular9,
                options: TestOptions.DebugExe
            );
            ...
            libComp = CreateCompilation(
                new[] { parent, source, IsExternalInitTypeDefinition },
                parseOptions: TestOptions.Regular9
            );
            comp = CreateCompilation(
                new[] { main },
...
";
            ...
            void symbolValidator(ModuleSymbol m)
            {
                ...
                Assert.Equal(
                    "System.String C.Property { get; init; }",
                    property.ToTestDisplayString()
                );
...
";
            ...
            comp.VerifyEmitDiagnostics(
                ...
                //         base.Property = null; // 8
                Diagnostic(ErrorCode.ERR_AssignmentInitOnly, "base.Property")
                    .WithArguments("C.Property")
                    .WithLocation(52, 9),
...
";
            ...
            comp.VerifyEmitDiagnostics(
                ...
                //         init => ((ISomething)this).Property = value;
                Diagnostic(ErrorCode.ERR_AssignmentInitOnly, "((ISomething)this).Property")
                    .WithArguments("ISomething.Property")
                    .WithLocation(13, 17)
            );
        }
...
";
            ...
            comp.VerifyEmitDiagnostics(
                ...
                //     public override string Property { get; set; } // 1
                Diagnostic(ErrorCode.ERR_CantChangeInitOnlyOnOverride, "Property")
                    .WithArguments("DerivedWithoutInit.Property", "Base.Property")
                    .WithLocation(13, 28),
                // (22,28): error CS8803: 'DerivedWithoutInitSetterOnly.Property' must match by init-only of overridden member 'Base.Property'
                //     public override string Property { set { } } // 2
                Diagnostic(ErrorCode.ERR_CantChangeInitOnlyOnOverride, "Property")
                    .WithArguments("DerivedWithoutInitSetterOnly.Property", "Base.Property")
                    .WithLocation(22, 28),
                ...
                Diagnostic(ErrorCode.ERR_CantChangeInitOnlyOnOverride, "Property")
                    .WithArguments(
                        "DerivedDerivedWithoutInit.Property",
                        "DerivedGetterOnly.Property"
                    )
                    .WithLocation(35, 28)
            );
        }
...
";
            var comp = CreateCompilation(
                ...
                references: new[]
                {
                    emitAsImage ? libComp.EmitToImageReference() : libComp.ToMetadataReference(),
                }
            );
            comp.VerifyEmitDiagnostics(
...
";
            ...
            comp.VerifyEmitDiagnostics(
                ...
                //     public override string Property { get; init; } // 1
                Diagnostic(ErrorCode.ERR_CantChangeInitOnlyOnOverride, "Property")
                    .WithArguments("DerivedWithInit.Property", "Base.Property")
                    .WithLocation(9, 28),
                // (18,28): error CS8803: 'DerivedWithInitSetterOnly.Property' must match by init-only of overridden member 'Base.Property'
                //     public override string Property { init { } } // 2
                Diagnostic(ErrorCode.ERR_CantChangeInitOnlyOnOverride, "Property")
                    .WithArguments("DerivedWithInitSetterOnly.Property", "Base.Property")
                    .WithLocation(18, 28),
                ...
                //     public override string Property { init { } } // 3
                Diagnostic(ErrorCode.ERR_CantChangeInitOnlyOnOverride, "Property")
                    .WithArguments("DerivedDerivedWithInit.Property", "DerivedGetterOnly.Property")
                    .WithLocation(31, 28)
            );
        }
...
";
            ...
            comp.VerifyEmitDiagnostics(
                ...
                //     public override string Property { get; init; } // 1
                Diagnostic(ErrorCode.ERR_NoSetToOverride, "init")
                    .WithArguments("DerivedWithInit.Property.init", "Base.Property")
                    .WithLocation(8, 44),
                ...
                Diagnostic(ErrorCode.ERR_NoSetToOverride, "set")
                    .WithArguments("DerivedWithoutInit.Property.set", "Base.Property")
                    .WithLocation(12, 44),
                ...
                //     public override string Property { init { } } // 3
                Diagnostic(ErrorCode.ERR_NoSetToOverride, "init")
                    .WithArguments("DerivedWithInitSetterOnly.Property.init", "Base.Property")
                    .WithLocation(16, 39),
                ...
                //     public override string Property { set { } } // 4
                Diagnostic(ErrorCode.ERR_NoSetToOverride, "set")
                    .WithArguments("DerivedWithoutInitSetterOnly.Property.set", "Base.Property")
                    .WithLocation(20, 39)
            );
        }
...
";
            ...
            comp.VerifyEmitDiagnostics(
                ...
                Diagnostic(ErrorCode.ERR_NoGetToOverride, "get")
                    .WithArguments("DerivedWithInit.Property.get", "Base.Property")
                    .WithLocation(8, 39),
                ...
                //     public override string Property { get; set; } // 3
                Diagnostic(ErrorCode.ERR_NoGetToOverride, "get")
                    .WithArguments("DerivedWithoutInit.Property.get", "Base.Property")
                    .WithLocation(12, 39),
                ...
                //     public override string Property { get => null; } // 5
                Diagnostic(ErrorCode.ERR_NoGetToOverride, "get")
                    .WithArguments("DerivedWithoutInitGetterOnly.Property.get", "Base.Property")
                    .WithLocation(20, 39)
            );
        }
            ...
            comp.VerifyEmitDiagnostics(
                ...
                Diagnostic(ErrorCode.ERR_CloseUnimplementedInterfaceMemberWrongInitOnly, "I")
                    .WithArguments(
                        "DerivedWithoutInit",
                        "I.Property.init",
                        "DerivedWithoutInit.Property.set"
                    )
                    .WithLocation(10, 35),
                ...
                Diagnostic(ErrorCode.ERR_UnimplementedInterfaceMember, "I")
                    .WithArguments("DerivedWithInitSetterOnly", "I.Property.get")
                    .WithLocation(14, 42),
                // (18,45): error CS0535: 'DerivedWithoutInitGetterOnly' does not implement interface member 'I.Property.init'
                // public class DerivedWithoutInitGetterOnly : I // 3
                Diagnostic(ErrorCode.ERR_UnimplementedInterfaceMember, "I")
                    .WithArguments("DerivedWithoutInitGetterOnly", "I.Property.init")
                    .WithLocation(18, 45)
            );
        }
...
";
            ...
            comp.VerifyEmitDiagnostics(
                ...
                Diagnostic(ErrorCode.ERR_CloseUnimplementedInterfaceMemberWrongInitOnly, "I")
                    .WithArguments(
                        "DerivedWithInitSetterOnly",
                        "I.Property.set",
                        "DerivedWithInitSetterOnly.Property.init"
                    )
                    .WithLocation(14, 42),
                // (18,45): error CS0535: 'DerivedWithoutInitGetterOnly' does not implement interface member 'I.Property.set'
                // public class DerivedWithoutInitGetterOnly : I // 3
                Diagnostic(ErrorCode.ERR_UnimplementedInterfaceMember, "I")
                    .WithArguments("DerivedWithoutInitGetterOnly", "I.Property.set")
                    .WithLocation(18, 45)
            );
        }
...
";
            ...
            comp.VerifyEmitDiagnostics(
                ...
                //     string I.Property { init { } } // 1
                Diagnostic(ErrorCode.ERR_ExplicitPropertyMismatchInitOnly, "init")
                    .WithArguments("DerivedWithInit.I.Property.init", "I.Property.set")
                    .WithLocation(8, 25),
                ...
                Diagnostic(ErrorCode.ERR_ExplicitPropertyAddingAccessor, "get")
                    .WithArguments("DerivedWithInitAndGetter.I.Property.get", "I.Property")
                    .WithLocation(12, 25),
                ...
                //     string I.Property { get; init; } // 2, 3
                Diagnostic(ErrorCode.ERR_ExplicitPropertyMismatchInitOnly, "init")
                    .WithArguments("DerivedWithInitAndGetter.I.Property.init", "I.Property.set")
                    .WithLocation(12, 30)
            );
        }
...
";
            ...
            comp.VerifyEmitDiagnostics(
                ...
                //     string I.Property { set { } } // 1
                Diagnostic(ErrorCode.ERR_ExplicitPropertyMismatchInitOnly, "set")
                    .WithArguments("DerivedWithoutInit.I.Property.set", "I.Property.init")
                    .WithLocation(8, 25),
...
";
            ...
            comp.VerifyEmitDiagnostics(
                ...
                // public class DerivedGetterOnly : I // 2
                Diagnostic(ErrorCode.ERR_UnimplementedInterfaceMember, "I")
                    .WithArguments("DerivedGetterOnly", "I.Property.init")
                    .WithLocation(10, 34),
                // (12,14): error CS0551: Explicit interface implementation 'DerivedGetterOnly.I.Property' is missing accessor 'I.Property.init'
                //     string I.Property { get => null; } // 3, 4
                Diagnostic(ErrorCode.ERR_ExplicitPropertyMissingAccessor, "Property")
                    .WithArguments("DerivedGetterOnly.I.Property", "I.Property.init")
                    .WithLocation(12, 14),
                // (12,25): error CS0550: 'DerivedGetterOnly.I.Property.get' adds an accessor not found in interface member 'I.Property'
                //     string I.Property { get => null; } // 3, 4
                Diagnostic(ErrorCode.ERR_ExplicitPropertyAddingAccessor, "get")
                    .WithArguments("DerivedGetterOnly.I.Property.get", "I.Property")
                    .WithLocation(12, 25)
            );
        }
...
";
            ...
            Assert.True(
                comp.SupportsRuntimeCapability(RuntimeCapability.DefaultImplementationsOfInterfaces)
            );
            ...
            comp.VerifyEmitDiagnostics(
                ...
                //     string Property { init { } } // 3
                Diagnostic(ErrorCode.WRN_NewRequired, "Property")
                    .WithArguments("IWithInitWithDefaultImplementation.Property", "I1.Property")
                    .WithLocation(24, 12)
            );
        }
...
";
            ...
            comp.VerifyEmitDiagnostics(
                ...
                //     string Property { init { } } // 3
                Diagnostic(ErrorCode.WRN_NewRequired, "Property")
                    .WithArguments("IWithInitWithImplementation.Property", "I1.Property")
                    .WithLocation(31, 12),
                ...
                Diagnostic(ErrorCode.ERR_ExplicitPropertyMismatchInitOnly, "init")
                    .WithArguments(
                        "IWithInitWithExplicitImplementationOfI2.I2.Property.init",
                        "I2.Property.set"
                    )
                    .WithLocation(40, 26),
                ...
                Diagnostic(ErrorCode.ERR_ExplicitPropertyMismatchInitOnly, "set")
                    .WithArguments(
                        "IWithoutInitWithExplicitImplementationOfI1.I1.Property.set",
                        "I1.Property.init"
                    )
                    .WithLocation(45, 26),
                ...
                // public class CWithImplementationWithInitOnly : I1, I2 // 6
                Diagnostic(ErrorCode.ERR_CloseUnimplementedInterfaceMemberWrongInitOnly, "I2")
                    .WithArguments(
                        "CWithImplementationWithInitOnly",
                        "I2.Property.set",
                        "CWithImplementationWithInitOnly.Property.init"
                    )
                    .WithLocation(62, 52),
                ...
                // public class CWithImplementationWithoutInitOnly : I1, I2 // 7
                Diagnostic(ErrorCode.ERR_CloseUnimplementedInterfaceMemberWrongInitOnly, "I1")
                    .WithArguments(
                        "CWithImplementationWithoutInitOnly",
                        "I1.Property.init",
                        "CWithImplementationWithoutInitOnly.Property.set"
                    )
                    .WithLocation(66, 51)
            );
        }
...
";
            ...
            comp.VerifyEmitDiagnostics(
                ...
                //     public event System.Action Event
                Diagnostic(ErrorCode.ERR_EventNeedsBothAccessors, "Event")
            ...
            AssertEx.SetEqual(
                members.ToTestDisplayStrings(),
                new[] { "event System.Action C.Event", "C..ctor()" }
            );
        }
...
";
            ...
            comp.VerifyEmitDiagnostics(
                ...
                //         this[43] = null; // 1
                Diagnostic(ErrorCode.ERR_AssignmentInitOnly, "this[43]")
                ...
                //         this[45] = null; // 2
                Diagnostic(ErrorCode.ERR_AssignmentInitOnly, "this[45]")
                    .WithArguments("C.this[int]")
                    .WithLocation(25, 9),
...
";
            ...
            comp.VerifyEmitDiagnostics(
                ...
                //         field.content = null; // 1
                Diagnostic(ErrorCode.ERR_AssgReadonly2, "field.content")
...
";
            ...
            comp.VerifyEmitDiagnostics(
                ...
                //             field.content = value;
                Diagnostic(ErrorCode.ERR_AssgReadonlyStatic2, "field.content")
                    .WithArguments("C.field")
                    .WithLocation(15, 13)
            );
        }
...
"
            ...
            AccessorDeclarationSyntax accessorDecl = root.DescendantNodes()
            ...
            var success = model.TryGetSpeculativeSemanticModelForMethodBody(
                accessorDecl.Body.Statements[0].SpanStart,
                speculatedMethod,
            ...
            var symbolSpeculation = speculativeModel.GetSpeculativeSymbolInfo(
                p.FullSpan.Start,
                p,
            ...
            var typeSpeculation = speculativeModel.GetSpeculativeTypeInfo(
                p.FullSpan.Start,
                p,
                SpeculativeBindingOption.BindAsExpression
            );
...
";
            ...
            comp.VerifyEmitDiagnostics(
                ...
                //     public override int Property { set { throw null; } }
                Diagnostic(ErrorCode.ERR_CantOverrideBogusMethod, "Property")
                    .WithArguments("Derived.Property", "C.Property")
                    .WithLocation(4, 25),
                ...
                //         c.Property = 42;
                Diagnostic(ErrorCode.ERR_BindToBogusProp1, "Property")
                    .WithArguments("C.Property", "C.set_Property(int)")
                    .WithLocation(14, 11),
                // (15,11): error CS0570: 'C.set_Property(int)' is not supported by the language
                //         c.set_Property(42);
                Diagnostic(ErrorCode.ERR_BindToBogus, "set_Property")
                    .WithArguments("C.set_Property(int)")
                    .WithLocation(15, 11)
            );
...
";
            ...
            comp.VerifyEmitDiagnostics(
                ...
                //     public override int this[int i] { set { throw null; } }
                Diagnostic(ErrorCode.ERR_CantOverrideBogusMethod, "this")
                    .WithArguments("Derived.this[int]", "C.this[int]")
                    .WithLocation(4, 25),
                // (8,25): error CS0569: 'Derived2.this[int]': cannot override 'C.this[int]' because it is not supported by the language
                //     public override int this[int i] { init { throw null; } }
                Diagnostic(ErrorCode.ERR_CantOverrideBogusMethod, "this")
                    .WithArguments("Derived2.this[int]", "C.this[int]")
                    .WithLocation(8, 25),
                ...
                //         c[42] = 43;
                Diagnostic(ErrorCode.ERR_BindToBogusProp1, "c[42]")
                    .WithArguments("C.this[int]", "C.set_Item(int, int)")
                    .WithLocation(14, 9),
                // (15,11): error CS0570: 'C.set_Item(int, int)' is not supported by the language
                //         c.set_Item(42, 43);
                Diagnostic(ErrorCode.ERR_BindToBogus, "set_Item")
                    .WithArguments("C.set_Item(int, int)")
                    .WithLocation(15, 11)
            );
...
";
            ...
            comp.VerifyEmitDiagnostics(
                ...
                //     public override int this[int i] { init { throw null; } }
                Diagnostic(ErrorCode.ERR_CantChangeInitOnlyOnOverride, "this")
                    .WithArguments("Derived2.this[int]", "C.this[int]")
                    .WithLocation(8, 25),
...
";
            ...
            comp.VerifyEmitDiagnostics(
                ...
                //         c.set_Property(i); // 1
                Diagnostic(ErrorCode.ERR_BindToBogus, "set_Property")
                    .WithArguments("C.set_Property(ref int)")
                    .WithLocation(7, 11),
                ...
                //         _ = c.Property; // 2
                Diagnostic(ErrorCode.ERR_BindToBogusProp2, "Property")
                    .WithArguments("C.Property", "C.get_Property()", "C.set_Property(ref int)")
                    .WithLocation(9, 15),
...
";
            ...
            comp.VerifyEmitDiagnostics(
                ...
                //         _ = c.get_Property(); // 1
                Diagnostic(ErrorCode.ERR_BindToBogus, "get_Property")
                    .WithArguments("C.get_Property()")
                    .WithLocation(6, 15),
                // (7,11): error CS0570: 'C.set_Property(ref int)' is not supported by the language
                //         c.set_Property(i); // 2
                Diagnostic(ErrorCode.ERR_BindToBogus, "set_Property")
            ...
            Assert.Equal(
                "System.Runtime.CompilerServices.IsExternalInit",
                property0.RefCustomModifiers.Single().Modifier.ToTestDisplayString()
            );
...
",
            ...
            var delegateSyntax = tree.GetRoot()
                ...
                .Single();
            var delegateMemberSymbols = model
                .GetDeclaredSymbol(delegateSyntax)
                .GetSymbol<SourceNamedTypeSymbol>()
                .GetMembers();
...
";
            ...
            CompileAndVerify(comp1, expectedOutput: "42", verify: Verification.FailsPEVerify);
...
",
            ...
            comp.VerifyDiagnostics(
                ...
                //     public int I { get; readonly init; }
                Diagnostic(ErrorCode.ERR_InitCannotBeReadonly, "init", isSuppressed: false)
                    .WithArguments("S.I")
                    .WithLocation(4, 34)
            );
...
";
            ...
            comp.VerifyEmitDiagnostics(
                ...
                //     Person = { FirstName = "c" }
                Diagnostic(ErrorCode.ERR_AssignmentInitOnly, "FirstName")
                    .WithArguments("Person.FirstName")
                    .WithLocation(7, 16)
            );
        }
...
";
            ...
            var piaCompilation = CreateCompilationWithMscorlib45(
                new[] { IsExternalInitTypeDefinition, pia },
    ...
    public static void Main()
    {
        ...
        var x2 = new UsePia() { Property2 = { Property = 43 } };
            ...
            compilation.VerifyDiagnostics(
                ...
                //         var x2 = new UsePia() { Property2 = { Property = 43 } };
                Diagnostic(ErrorCode.ERR_AssignmentInitOnly, "Property")
                    .WithArguments("ITest28.Property")
                    .WithLocation(9, 47)
            );
        }
...
";
...

            {
                ...
                var comp = CreateEmptyCompilation(
                    new[] { source },
                    references: new[] { corlibWithoutIsExternalInitRef, libWithIsExternalInitRef },
                    assemblyName: "source"
                );
                comp.VerifyEmitDiagnostics();
...

            {
                ...
                var comp = CreateEmptyCompilation(
                    source,
                    references: new[] { libWithIsExternalInitRef, corlibWithIsExternalInitRef }
                );
                comp.VerifyEmitDiagnostics();
                verify(comp, "corlibWithIsExternalInit");
            }
        ...
        public void DoNotPickTypeFromSourceWithFileModifier(bool useCompilationReference)
        {
            ...
            var corlibWithoutIsExternalInitRef = AsReference(
                CreateEmptyCompilation(corlib_cs),
                useCompilationReference
            );
            var corlibWithIsExternalInitRef = AsReference(
                CreateEmptyCompilation(corlib_cs + IsExternalInitTypeDefinition),
                useCompilationReference
            );
