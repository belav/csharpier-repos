...
"
            ...
            Assert.Equal(
                ...
                concat1.Usings.Select(u => u.NamespaceOrType.ToTestDisplayString())
            );
            ...
            Assert.Equal(
                new[] { "System.IO", "System" },
                concat2.Usings.Select(u => u.NamespaceOrType.ToTestDisplayString())
            );
...
"
            ...
            Assert.Equal(
                new[] { "System", "System.Collections", "System.IO" },
                concat1.Usings.Select(u => u.NamespaceOrType.ToTestDisplayString())
            );
            var usingAliases1 = concat1.UsingAliases;
        ...
        private static Imports[] GetImports(params string[] sources)
        {
            ...
            var externAliases = compilationUnits.SelectMany(cu => cu.Externs)
