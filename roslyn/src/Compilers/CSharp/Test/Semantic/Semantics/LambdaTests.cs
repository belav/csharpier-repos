...
class Program
{
    static void Main()
    {
        ...
        Func<object, object> d = [D] x => x;
            ...
            var actualAttributes = attributeSyntaxes
                .Select(a => model.GetSymbolInfo(a).Symbol.GetSymbol<MethodSymbol>())
                .ToImmutableArray();
            var expectedAttributes = new[]
            {
                "AAttribute",
                ...
                .Select(a => comp.GetTypeByMetadataName(a).InstanceConstructors.Single())
                .ToImmutableArray();
            AssertEx.Equal(expectedAttributes, actualAttributes);
        }
    ...
    static void Main()
    {
        ...
        d = ArgIterator () => throw null;
            ...
            comp.VerifyDiagnostics(
                ...
                //         d = TypedReference () => throw null;
                Diagnostic(ErrorCode.ERR_CannotInferDelegateType, "TypedReference () => throw null")
                    .WithLocation(7, 13),
                ...
                Diagnostic(
                        ...
                        "RuntimeArgumentHandle () => throw null"
                    )
                    .WithLocation(8, 13),
                ...
                //         d = ArgIterator () => throw null;
                Diagnostic(ErrorCode.ERR_CannotInferDelegateType, "ArgIterator () => throw null")
                    .WithLocation(9, 13)
            );
        }
