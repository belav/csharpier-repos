...
";
            ...
            comp.VerifyDiagnostics(
                ...
                // struct Point(int x, int y);
                Diagnostic(ErrorCode.ERR_FeatureNotAvailableInVersion9, "(int x, int y)")
            ...
            comp.VerifyDiagnostics(
                ...
                // struct Point(int x, int y);
                Diagnostic(ErrorCode.ERR_FeatureNotAvailableInVersion10, "(int x, int y)")
                    .WithArguments("primary constructors", "12.0")
                    .WithLocation(2, 13),
                // 0.cs(2,18): warning CS9113: Parameter 'x' is unread.
                // struct Point(int x, int y);
...
";
            ...
            comp.VerifyEmitDiagnostics(
                ...
                //     C2 P6, // 4, 5
                Diagnostic(ErrorCode.ERR_ParameterIsStaticClass, "C2")
                    .WithArguments("C2")
                    .WithLocation(12, 5),
                // 0.cs(12,5): error CS0722: 'C2': static types cannot be used as return types
                //     C2 P6, // 4, 5
                Diagnostic(ErrorCode.ERR_ReturnTypeIsStaticClass, "C2")
                    .WithArguments("C2")
                    .WithLocation(12, 5),
                ...
                //     delegate*<void> P10); // 9
                Diagnostic(ErrorCode.ERR_BadFieldTypeInRecord, "P10")
...
";
            ...
            comp.VerifyEmitDiagnostics(
                ...
                //     public delegate*<void> f10; // 8
                Diagnostic(ErrorCode.ERR_BadFieldTypeInRecord, "f10")
                    .WithArguments("delegate*<void>")
                    .WithLocation(17, 28)
            );
        }
    ...
    public static void Main()
    {
        ...
        Console.WriteLine(c.Y);
            ...
            comp.VerifyEmitDiagnostics(
                ...
                // record struct C(int X, int Y)
                Diagnostic(ErrorCode.ERR_UnassignedThisAutoPropertyUnsupportedVersion, "C")
                    .WithArguments("C.X", "11.0")
                    .WithLocation(3, 15),
...
";
            ...
            comp.VerifyDiagnostics(
                ...
                // record struct C1(object O1, object O2, object O3) // 1, 2
                Diagnostic(ErrorCode.ERR_UnassignedThisAutoPropertyUnsupportedVersion, "C1")
                    .WithArguments("C1.O1", "11.0")
                    .WithLocation(2, 15),
...
record struct C(int X)
{
    static int Z = X + 1;
            ...
            comp.VerifyDiagnostics(
                ...
                //     static int Z = X + 1;
                Diagnostic(ErrorCode.ERR_InvalidPrimaryConstructorParameterReference, "X")
                    .WithArguments("int X")
                    .WithLocation(4, 20)
            );
...
record struct C(int X)
{
    const int Z = X + 1;
            ...
            comp.VerifyDiagnostics(
                ...
                //     const int Z = X + 1;
                Diagnostic(ErrorCode.ERR_NotConstantExpression, "X + 1")
                    .WithArguments("C.Z")
                    .WithLocation(4, 19)
            );
...
";
            ...
            comp.VerifyDiagnostics(
                ...
                // record struct R(int P = 42)
                Diagnostic(ErrorCode.ERR_UnassignedThisAutoPropertyUnsupportedVersion, "R")
                    .WithArguments("R.P", "11.0")
                    .WithLocation(2, 15),
...
";
            ...
            comp.VerifyDiagnostics(
                ...
                // public record struct C(int I1, int I2)
                Diagnostic(ErrorCode.WRN_MissingParamTag, "I2")
                    .WithArguments("I2", "C.C(int, int)")
                    .WithLocation(4, 36),
                // (7,52): warning CS1574: XML comment has cref attribute 'x' that could not be resolved
                //     /// <param name="x">Description for <see cref="x"/></param>
                Diagnostic(ErrorCode.WRN_BadXMLRef, "x").WithArguments("x").WithLocation(7, 52)
...
";
            ...
            comp.VerifyDiagnostics(
                ...
                // /// <param name="I1">Description for <seealso cref="I2"/>something like I2</seealso></param>
                Diagnostic(ErrorCode.WRN_XMLParseError, "seealso")
                    .WithArguments("seealso", "param")
                    .WithLocation(3, 77),
...
";
            ...
            comp.VerifyEmitDiagnostics(
                ...
                // record struct Pos(int X)
                Diagnostic(ErrorCode.ERR_UnassignedThisUnsupportedVersion, "Pos")
                    .WithArguments("Pos.x", "11.0")
                    .WithLocation(2, 15),
...
";
            ...
            comp.VerifyDiagnostics(
                ...
                //         _ = this with { X = 42 }; // 1
                Diagnostic(ErrorCode.ERR_UseDefViolationThisUnsupportedVersion, "this")
                    .WithArguments("11.0")
                    .WithLocation(8, 13)
            );
    ...
    /*<bind>*/{
        ...
        var b = a with { [0] = 20 };
            ...
            var expectedDiagnostics = new[]
            {
                ...
                // (7,26): error CS0747: Invalid initializer member declarator
                //         var b = a with { [0] = 20 };
                Diagnostic(ErrorCode.ERR_InvalidInitializerElementInitializer, "[0] = 20")
                    .WithLocation(7, 26),
            };
            var comp = CreateCompilation(src, parseOptions: TestOptions.RegularPreview);
            comp.VerifyEmitDiagnostics(expectedDiagnostics);
...
record struct S3(char A)
{
    public S3(object o) : base() { }
            ...
            comp.VerifyDiagnostics(
                ...
                //     public S1(object o) : base() { }
                Diagnostic(ErrorCode.ERR_StructWithBaseConstructorCall, "S1")
                    .WithArguments("S1")
                    .WithLocation(3, 12),
                // (7,12): error CS0522: 'S2': structs cannot call base class constructors
                //     public S2(object o) : base() { }
                Diagnostic(ErrorCode.ERR_StructWithBaseConstructorCall, "S2")
                    .WithArguments("S2")
                    .WithLocation(7, 12),
                ...
                //     public S3(object o) : base() { }
                Diagnostic(ErrorCode.ERR_StructWithBaseConstructorCall, "S3")
                    .WithArguments("S3")
                    .WithLocation(11, 12),
                ...
                @"record struct S(object F)
{
    ...
    public S(int i) : this() { F = i; }
            ...
            comp.VerifyDiagnostics(
                ...
                // record struct S(object F)
                Diagnostic(ErrorCode.WRN_UnreadRecordParameter, "F")
                    .WithArguments("F")
                    .WithLocation(1, 24),
    ...
    static S() : this() { }
        ...
        public void StructNamedRecord()
        {
            ...
            comp.VerifyDiagnostics(
                ...
                // struct record { }
                Diagnostic(ErrorCode.WRN_LowerCaseTypeName, "record")
...
";
            ...
            compilation1.VerifyDiagnostics(
                ...
                Diagnostic(
                    ...
                    .WithArguments("System.Runtime.InteropServices.ComImport", "class, interface")
                    .WithLocation(2, 2)
            );
        }
    }
