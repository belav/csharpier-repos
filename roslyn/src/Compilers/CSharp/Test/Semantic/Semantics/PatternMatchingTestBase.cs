    ...
    public class PatternMatchingTestBase : CSharpTestBase
    {
        ...
        protected static void VerifyModelForDeclarationOrVarSimplePattern(
            ...
            foreach (var reference in references)
            {
                ...
                Assert.Same(
                    symbol,
                    model.LookupSymbols(reference.SpanStart, name: designation.Identifier.ValueText)
                        .Single()
                );
                Assert.True(
        ...
        protected static void VerifyModelForDeclarationOrVarPatternDuplicateInSameScope(
            ...
            Assert.NotEqual(
                symbol,
                model.LookupSymbols(designation.SpanStart, name: designation.Identifier.ValueText)
                    .Single()
            );
            Assert.True(
                model.LookupNames(designation.SpanStart).Contains(designation.Identifier.ValueText)
        ...
        protected static void VerifyModelForDuplicateVariableDeclarationInSameScope(
            ...
            Assert.NotEqual(
                symbol,
                model.LookupSymbols(declarator.SpanStart, name: declarator.Identifier.ValueText)
                    .Single()
            );
            Assert.True(
        ...
        protected static void VerifyNotAPatternField(
            ...
            Assert.Same(
                symbol,
                model.LookupSymbols(reference.SpanStart, name: reference.Identifier.ValueText)
                    .Single()
            );
            Assert.True(
        ...
        protected static void VerifyModelForDeclarationField(
            ...
            var declarator = designation.Ancestors()
