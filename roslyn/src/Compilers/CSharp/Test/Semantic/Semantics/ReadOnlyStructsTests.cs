...
";
            ...
            comp.VerifyDiagnostics(
                ...
                //         M1(ref f2); // error
                Diagnostic(ErrorCode.ERR_RefReadonlyLocal, "f2")
                    .WithArguments("f2")
                    .WithLocation(21, 16)
            );
        }
...
";
            ...
            static IMethodSymbol getMethod(INamedTypeSymbol symbol, string name) =>
                (IMethodSymbol)symbol.GetMembers(name).Single();
            static IPropertySymbol getProperty(INamedTypeSymbol symbol, string name) =>
                (IPropertySymbol)symbol.GetMembers(name).Single();
            static IEventSymbol getEvent(INamedTypeSymbol symbol, string name) =>
                (IEventSymbol)symbol.GetMembers(name).Single();
        }
...
";
            ...
            comp.VerifyDiagnostics(
                ...
                //     public readonly int P { get; set; }
                Diagnostic(ErrorCode.ERR_BadMemberFlag, "P")
                    .WithArguments("readonly")
                    .WithLocation(7, 25),
...
";
            ...
            comp.VerifyDiagnostics(
                ...
                // {
                Diagnostic(ErrorCode.ERR_IdentifierExpectedKW, "")
                    .WithArguments("", "readonly")
                    .WithLocation(3, 2),
...
";
            ...
            comp.VerifyDiagnostics(
                ...
                //     public static readonly int M()
                Diagnostic(ErrorCode.ERR_StaticMemberCantBeReadOnly, "M")
                    .WithArguments("S.M()")
                    .WithLocation(5, 32)
            );
...
";
            ...
            comp.VerifyDiagnostics(
                ...
                //         readonly get
                Diagnostic(ErrorCode.ERR_StaticMemberCantBeReadOnly, "get")
                    .WithArguments("S.P.get")
                    .WithLocation(7, 18)
            );
        }
...
";
            ...
            comp.VerifyDiagnostics(
                ...
                //     public static readonly int P => i;
                Diagnostic(ErrorCode.ERR_StaticMemberCantBeReadOnly, "P")
                    .WithArguments("S.P")
                    .WithLocation(5, 32)
            );
        }
...
";
            ...
            comp.VerifyDiagnostics(
                ...
                // public readonly delegate int Del();
                Diagnostic(ErrorCode.ERR_BadMemberFlag, "Del")
                    .WithArguments("readonly")
                    .WithLocation(2, 30)
            );
        }
...
";
            ...
            comp.VerifyDiagnostics(
                ...
                //     public readonly event Action<EventArgs> E;
                Diagnostic(ErrorCode.ERR_FieldLikeEventCantBeReadOnly, "E")
                    .WithArguments("S1.E")
                    .WithLocation(6, 45)
            );
        }
...
";
            ...
            comp.VerifyDiagnostics(
                ...
                //     public static readonly event Action<EventArgs> E
                Diagnostic(ErrorCode.ERR_StaticMemberCantBeReadOnly, "E")
                    .WithArguments("S1.E")
                    .WithLocation(6, 52)
            );
        }
    ...
    readonly void M2()
    {
        ...
        P4 += 1; // ok
            ...
            comp.VerifyDiagnostics(
                ...
                //         P1 += 1; // error
                Diagnostic(ErrorCode.ERR_AssgReadonlyLocal, "P1")
                    .WithArguments("P1")
                    .WithLocation(20, 9),
