...
";
            ...
            GeneratorDriverTests.VerifyGeneratorExceptionDiagnostic<Exception>(
...
";
            ...
            var classDeclarations = testReceiver
                .VisitedNodes.OfType<ClassDeclarationSyntax>()
...
";
            ...
            compilation = compilation.RemoveSyntaxTrees(compilation.SyntaxTrees.Last());
            driver = driver.AddGenerators(
                ImmutableArray.Create(testGenerator2.AsSourceGenerator())
            );
            driver = driver.RunGenerators(compilation);
        }
...
";
            ...
            Assert.Equal(
                "Simulated cancellation from external source",
                results.Results[0].Exception!.Message
            );
        }
