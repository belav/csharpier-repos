    ...
    public class StateTableTests
    {
        ...
        public void Node_Table_Entries_Can_Be_Enumerated()
        {
            ...
            var expected = ImmutableArray.Create(
                (1, EntryState.Added, 0),
                (2, EntryState.Added, 0),
                (3, EntryState.Added, 0)
            );
        ...
        public void Node_Table_Entries_Are_Flattened_When_Enumerated()
        {
            ...
            var expected = ImmutableArray.Create(
                (1, EntryState.Added, 0),
                (2, EntryState.Added, 1),
                (3, EntryState.Added, 2),
                (4, EntryState.Added, 0),
                (5, EntryState.Added, 1),
                (6, EntryState.Added, 2),
                (7, EntryState.Added, 0),
                (8, EntryState.Added, 1),
                (9, EntryState.Added, 2)
            );
            AssertTableEntries(table, expected);
        }
        ...
        public void Node_Table_Entries_Can_Be_The_Same_Object()
        {
            ...
            var expected = ImmutableArray.Create(
                (o, EntryState.Added, 0),
                (o, EntryState.Added, 1),
                (o, EntryState.Added, 2)
            );
            AssertTableEntries(table, expected);
        }
        ...
        public void Node_Builder_Can_Add_Entries_From_Previous_Table()
        {
            ...
            builder.TryModifyEntries(
                ImmutableArray.Create(10, 11),
            ...
            builder.TryModifyEntries(
                ImmutableArray.Create(20, 21, 22),
                EqualityComparer<int>.Default,
                TimeSpan.Zero,
                default,
                EntryState.Modified
            );
            bool didRemoveEntries = builder.TryRemoveEntries(
                TimeSpan.Zero,
                default,
            ...
            var expected = ImmutableArray.Create(
                (10, EntryState.Modified, 0),
                (11, EntryState.Added, 1),
                (2, EntryState.Cached, 0),
                (3, EntryState.Cached, 1),
                (20, EntryState.Modified, 0),
                (21, EntryState.Modified, 1),
                (22, EntryState.Added, 2),
                (6, EntryState.Removed, 0)
            );
        ...
        public void Node_Table_Entries_Are_Cached_Or_Dropped_When_Cached()
        {
            ...
            var expected = ImmutableArray.Create(
                ...
                (2, EntryState.Added, 1),
                (3, EntryState.Added, 2),
                (4, EntryState.Removed, 0),
                (5, EntryState.Removed, 1),
                (6, EntryState.Removed, 2),
                (7, EntryState.Added, 0),
                (8, EntryState.Added, 1),
                (9, EntryState.Added, 2)
            );
            ...
            expected = ImmutableArray.Create(
                ...
                (7, EntryState.Cached, 0),
                (8, EntryState.Cached, 1),
                (9, EntryState.Cached, 2)
            );
        ...
        public void Node_Table_Single_Returns_Second_Item_When_First_Is_Removed()
        {
            ...
            AssertTableEntries(
                table,
                new[] { (1, EntryState.Removed, 0), (2, EntryState.Added, 0) }
            );
        ...
        public void Node_Builder_Handles_Modification_When_Both_Tables_Have_Empty_Entries()
        {
            ...
            expected = ImmutableArray.Create(
                (3, EntryState.Modified, 0),
                (2, EntryState.Cached, 1),
                (3, EntryState.Cached, 0),
                (5, EntryState.Modified, 1)
            );
            AssertTableEntries(newTable, expected);
        }
        ...
        public void Node_Table_Doesnt_Modify_Single_Item_Multiple_Times_When_Same()
        {
            ...
            expected = ImmutableArray.Create(
                (1, EntryState.Cached, 0),
                (2, EntryState.Cached, 0),
                (5, EntryState.Modified, 0),
                (4, EntryState.Cached, 0)
            );
            AssertTableEntries(newTable, expected);
        }
        ...
        public void Node_Table_Caches_Previous_Object_When_Modification_Considered_Cached()
        {
            ...
            Assert.True(
                builder.TryModifyEntry(
                    5,
                    new LambdaComparer<int>((i, j) => true),
                    TimeSpan.Zero,
                    default,
                    EntryState.Modified
                )
        ...
        public void Driver_Table_Compacts_State_Tables_And_Drops_Steps_When_Made_Immutable()
        {
            ...
            // empty first time
            DriverStateTable.Builder builder = GetBuilder(
                DriverStateTable.Empty,
            ...
            DriverStateTable.Builder builder2 = GetBuilder(
                driverStateTable,
                trackIncrementalGeneratorSteps: true
            );
            builder2.GetLatestStateTableForNode(callbackNode);
        ...
        public void Batch_Node_Is_Cached_If_All_Inputs_Are_Cached()
        {
            ...
            AssertTableEntries(
                table,
                new[] { (ImmutableArray.Create(1, 2, 3), EntryState.Cached, 0) }
            );
        }
        ...
        public void Batch_Node_Is_Not_Cached_When_Inputs_Are_Changed()
        {
            ...
            AssertTableEntries(
                table,
                new[] { (ImmutableArray.Create(1, 2, 4), EntryState.Modified, 0) }
            );
        }
        ...
        public void Batch_Node_Remove_From_Beginning()
        {
            ...
            var inputNode = new CallbackNode<string>(
                (_, _) =>
                {
            ...
            AssertTableEntries(
                table1,
                new[] { ("A", EntryState.Added, 0), ("B", EntryState.Added, 0) }
            );
            AssertTableEntries(
                table1.AsCached(),
            ...
            AssertTableEntries(
                table2,
                new[] { (ImmutableArray.Create("A", "B"), EntryState.Added, 0) }
            );
            AssertTableEntries(
                table2.AsCached(),
            ...
            AssertTableEntries(
                table2,
                new[] { (ImmutableArray.Create("B"), EntryState.Modified, 0) }
            );
            AssertTableEntries(
                table2.AsCached(),
        ...
        public void Transform_Node_Records_NewInput_OnFirst_Run()
        {
            ...
            TransformNode<int, int> transformNode = new TransformNode<int, int>(
                inputNode,
                (i, ct) => i,
                name: "Transform"
            );
        ...
        public void InputNode_With_Different_Element_Count_Records_Add_Remove_For_Replaced_Items()
        {
            ...
            Assert.Collection(
                ...
                step =>
                {
                    Assert.Empty(step.Inputs);
                    Assert.Equal(
                        (2, IncrementalStepRunReason.Removed),
                ...
                step =>
                {
                    Assert.Empty(step.Inputs);
                    Assert.Equal(
                        (3, IncrementalStepRunReason.Removed),
                        Assert.Single(step.Outputs)
                    );
                },
                step =>
        ...
        public void CombineNode_Records_Removed_Outputs_Of_Removed_First_Input()
        {
            ...
            var combineNode = new CombineNode<int, int>(inputNode, input2Node).WithTrackingName(
                "TestStep"
            );
        ...
        {
            int thirdValue = 3;
            var inputNode = new InputNode<int>(
                (_) => ImmutableArray.Create(1, 2, thirdValue)
            ...
            var filterNode = new TransformNode<int, int>(
                transformNode,
                (i, ct) => i <= 2 ? ImmutableArray.Create(i) : ImmutableArray<int>.Empty,
                name: "Filter"
            );
            var doubleNode = new TransformNode<int, int>(
                filterNode,
                (i, ct) => i * 2,
                name: "Double"
            );
            var addOneNode = new TransformNode<int, int>(
                doubleNode,
                (i, ct) => i + 1,
                name: "AddOne"
            );

            DriverStateTable.Builder dstBuilder = GetBuilder(
                DriverStateTable.Empty,
                trackIncrementalGeneratorSteps: true
            );
        ...
        public void Modified_Entry_Removing_Outputs_Records_Removed_Step_State()
        {
            ...
            var inputNode = new InputNode<ImmutableArray<int>>(_ =>
        ...
        {
            ImmutableArray<ImmutableArray<string>> values = ImmutableArray.Create(
                ImmutableArray.Create("class1"),
                ImmutableArray.Create("class2")
            );
            var inputNode = new InputNode<ImmutableArray<string>>(_ => values).WithTrackingName(
                "Input"
            );
            var transformNode = new TransformNode<ImmutableArray<string>, string>(
                inputNode,
                (arr, ct) => arr[0] == "class3" ? ImmutableArray<string>.Empty : arr,
                name: "SelectMany"
            );
            ...
            AssertTableEntries(
                ...
                ImmutableArray.Create(
                    ("class1", EntryState.Added, 0),
                    ("class2", EntryState.Added, 0)
                )
            );
        ...
        {
            ImmutableArray<ImmutableArray<string>> values = ImmutableArray.Create(
                ImmutableArray.Create("class1", "class1.1"),
                ImmutableArray.Create("class2", "class2.1")
            );
            var inputNode = new InputNode<ImmutableArray<string>>(_ => values).WithTrackingName(
                "Input"
            );
            ...
            AssertTableEntries(
                ...
                ImmutableArray.Create(
                    ("class1", EntryState.Added, 0),
                    ("class1.1", EntryState.Added, 1),
                    ("class2", EntryState.Added, 0),
                    ("class2.1", EntryState.Added, 1)
                )
            );
            ...
            AssertTableEntries(
                ...
                ImmutableArray.Create(
                    ("class1", EntryState.Cached, 0),
                    ("class1.1", EntryState.Cached, 1),
                    ("class2", EntryState.Cached, 0),
                    ("class2.1", EntryState.Cached, 1)
                )
            );

            // update values, so that we'll no longer produce the first item in the select
            values = ImmutableArray.Create(
                ImmutableArray.Create("class3", "class3.1"),
                ImmutableArray.Create("class2", "class2.1")
            );
            dstBuilder = GetBuilder(
                dstBuilder.ToImmutable(),
            ...
            values = ImmutableArray.Create(
                ImmutableArray.Create("class3", "class3.1"),
                ImmutableArray.Create("class4", "class4.1")
            );
            dstBuilder = GetBuilder(
                dstBuilder.ToImmutable(),
                trackIncrementalGeneratorSteps: false
            ...
            AssertTableEntries(
                table,
                ImmutableArray.Create(
                    ("class4", EntryState.Modified, 0),
                    ("class4.1", EntryState.Modified, 1)
                )
            );
            ...
            AssertTableEntries(
                table.AsCached(),
                ImmutableArray.Create(
                    ("class4", EntryState.Cached, 0),
                    ("class4.1", EntryState.Cached, 1)
                )
            );
        ...
        public void Node_Table_When_Previous_Was_Smaller()
        {
            ...
            var transformNode = new TransformNode<string, string>(
                inputNode,
                (a, ct) =>
                {
                    return a switch
            ...
            var select2 = new TransformNode<string, string>(
                transformNode,
                (a, ct) => a,
                name: "Select2"
            );
            ...
            AssertTableEntries(
                table,
                ImmutableArray.Create(
                    ("1.1", EntryState.Added, 0),
                    ("1.2", EntryState.Added, 0),
                    ("2.1", EntryState.Added, 0),
                    ("2.2", EntryState.Added, 0)
                )
            );
            ...
            AssertTableEntries(
                table.AsCached(),
                ImmutableArray.Create(
                    ("1.1", EntryState.Cached, 0),
                    ("1.2", EntryState.Cached, 0),
                    ("2.1", EntryState.Cached, 0),
                    ("2.2", EntryState.Cached, 0)
                )
            );
            ...
            AssertTableEntries(
                ...
                ImmutableArray.Create(
                    ("1.1", EntryState.Cached, 0),
                    ("inserted", EntryState.Modified, 0),
                    ("1.2", EntryState.Added, 0),
                    ("2.1", EntryState.Cached, 0),
                    ("2.2", EntryState.Cached, 0)
                )
        ...
        public void Node_Table_When_Previous_Was_Smaller_InsertedIntoMiddleValue()
        {
            ...
            AssertTableEntries(
                ...
                ImmutableArray.Create(
                    ...
                    ("2.1", EntryState.Added, 0),
                    ("2.2", EntryState.Added, 0),
                    ("3.1", EntryState.Added, 0),
                    ("3.2", EntryState.Added, 0)
                )
            );
            ...
            AssertTableEntries(
                ...
                ImmutableArray.Create(
                    ...
                    ("2.1", EntryState.Cached, 0),
                    ("2.2", EntryState.Cached, 0),
                    ("3.1", EntryState.Cached, 0),
                    ("3.2", EntryState.Cached, 0)
                )
            );
        ...
        private void AssertTableEntries<T>(
            ...
            IList<(T Item, EntryState State, int OutputIndex)> expected
        )
        {
            int index = 0;
        ...
        private void AssertTableEntries<T>(
            ...
            IList<(ImmutableArray<T> Item, EntryState State, int OutputIndex)> expected
        )
        {
            int index = 0;
            foreach (var entry in table)
        ...
        private DriverStateTable.Builder GetBuilder(
            DriverStateTable previous,
