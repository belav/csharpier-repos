...
";
            var expectedDiagnostics = new[]
            {
                ...
                //             case other:
                Diagnostic(ErrorCode.ERR_ConstantValueOfTypeExpected, "other")
...
";
            var expectedDiagnostics = new[]
            {
                // (8,18): error CS9135: A constant value of type 'int' is expected
                //             case input1 ?? input2:
                Diagnostic(ErrorCode.ERR_ConstantValueOfTypeExpected, "input1 ?? input2")
                    .WithArguments("int")
                    .WithLocation(8, 18),
            };
...
";
            var expectedDiagnostics = new DiagnosticDescription[]
            {
                ...
                Diagnostic(
                        ...
                        "1+TakeOutParam(3, out MyClass x1)"
                    )
                    .WithArguments("int")
                    .WithLocation(8, 18),
            };
