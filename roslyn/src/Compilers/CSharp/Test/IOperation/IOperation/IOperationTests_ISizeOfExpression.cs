...
{
    public class IOperationTests_ISizeOfExpression : SemanticModelTestBase
    {
...
";
            ...
            VerifyOperationTreeAndDiagnosticsForTest<SizeOfExpressionSyntax>(
                source,
...
";
            var expectedDiagnostics = new DiagnosticDescription[]
            {
                ...
                //         i = /*<bind>*/sizeof(C)/*</bind>*/;
                Diagnostic(ErrorCode.ERR_ManagedAddr, "sizeof(C)")
                    .WithArguments("C")
                    .WithLocation(8, 23),
                ...
                //         i = /*<bind>*/sizeof(C)/*</bind>*/;
                Diagnostic(ErrorCode.ERR_SizeofUnsafe, "sizeof(C)")
                    .WithArguments("C")
                    .WithLocation(8, 23)
            };
...
";
            var expectedDiagnostics = new DiagnosticDescription[]
            {
                ...
                //         i = /*<bind>*/sizeof(UndefinedType)/*</bind>*/;
                Diagnostic(ErrorCode.ERR_SizeofUnsafe, "sizeof(UndefinedType)")
                    .WithArguments("UndefinedType")
                    .WithLocation(8, 23)
            };
...
";
            var expectedDiagnostics = new DiagnosticDescription[]
            {
                ...
                //         i = /*<bind>*/sizeof(i)/*</bind>*/;
                Diagnostic(ErrorCode.ERR_SizeofUnsafe, "sizeof(i)")
                    .WithArguments("i")
                    .WithLocation(8, 23)
            };
...
";
            var expectedDiagnostics = new DiagnosticDescription[]
            {
                ...
                //         i = /*<bind>*/sizeof(M2()/*</bind>*/);
                Diagnostic(ErrorCode.ERR_SingleTypeNameNotFound, "M2")
                    .WithArguments("M2")
                    .WithLocation(8, 30),
                ...
                //         i = /*<bind>*/sizeof(M2()/*</bind>*/);
                Diagnostic(ErrorCode.ERR_SizeofUnsafe, "sizeof(M2")
                    .WithArguments("M2")
                    .WithLocation(8, 23)
            };
