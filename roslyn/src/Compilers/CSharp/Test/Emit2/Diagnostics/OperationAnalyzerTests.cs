        ...
        int[,][] arr12 = new int[0,0][];               // no
            ...
            CreateCompilationWithMscorlib45(source)
                ...
                .VerifyAnalyzerDiagnostics(
                    new DiagnosticAnalyzer[] { new EmptyArrayAnalyzer() },
                    null,
                    null,
...
class D
{
    ...
    object SField = ""Zap"";
            ...
            CreateCompilationWithMscorlib45(source)
                .VerifyDiagnostics()
                .VerifyAnalyzerDiagnostics(
                    new DiagnosticAnalyzer[] { new BoxingOperationAnalyzer() },
                    null,
                    null,
...
";
            CreateCompilationWithMscorlib45(source)
                .VerifyAnalyzerDiagnostics(
                    new DiagnosticAnalyzer[] { new BadStuffTestAnalyzer() },
                    null,
                    null,
...
";
            CreateCompilationWithMscorlib45(source)
                .VerifyDiagnostics()
                .VerifyAnalyzerDiagnostics(
                    new DiagnosticAnalyzer[] { new BigForTestAnalyzer() },
                    null,
                    null,
                    Diagnostic(
            ...
            CreateCompilationWithMscorlib45(source)
                ...
                .VerifyAnalyzerDiagnostics(
                    ...
                    Diagnostic(InvocationTestAnalyzer.UseDefaultArgumentDescriptor.Id, "M3(x: 0)")
                        .WithArguments("y")
                        .WithLocation(35, 9),
                    Diagnostic(InvocationTestAnalyzer.UseDefaultArgumentDescriptor.Id, "M3()")
                        .WithArguments("x")
                        .WithLocation(36, 9),
                    Diagnostic(InvocationTestAnalyzer.UseDefaultArgumentDescriptor.Id, "M3()")
                        .WithArguments("y")
...
";
            CreateCompilationWithMscorlib45(source)
                .VerifyDiagnostics()
                .VerifyAnalyzerDiagnostics(
                    new DiagnosticAnalyzer[] { new FieldCouldBeReadOnlyAnalyzer() },
                    null,
                    null,
...
";
            CreateCompilationWithMscorlib45(source)
                .VerifyDiagnostics()
                .VerifyAnalyzerDiagnostics(
                    new DiagnosticAnalyzer[] { new LocalCouldBeConstAnalyzer() },
                    null,
                    null,
...
";
            CreateCompilationWithMscorlib45(source)
                .VerifyDiagnostics()
                .VerifyAnalyzerDiagnostics(
                    new DiagnosticAnalyzer[] { new SymbolCouldHaveMoreSpecificTypeAnalyzer() },
                    null,
                    null,
                    Diagnostic(
                            SymbolCouldHaveMoreSpecificTypeAnalyzer.LocalCouldHaveMoreSpecificTypeDescriptor
                                .Id,
                            "a"
                        )
...
";
            CreateCompilationWithMscorlib45(source)
                .VerifyDiagnostics()
                .VerifyAnalyzerDiagnostics(
                    new DiagnosticAnalyzer[] { new SeventeenTestAnalyzer() },
                    null,
                    null,
...
";
            CreateCompilationWithMscorlib45(source)
                .VerifyDiagnostics()
                .VerifyAnalyzerDiagnostics(
                    new DiagnosticAnalyzer[] { new NullArgumentTestAnalyzer() },
                    null,
                    null,
...
";
            CreateCompilationWithMscorlib45(source)
                .VerifyDiagnostics()
                .VerifyAnalyzerDiagnostics(
                    new DiagnosticAnalyzer[] { new AssignmentTestAnalyzer() },
                    null,
                    null,
    ...
    void M1()
    {
        ...
        int[][] arr14 = new int[][] { new int[] { 1,2,3 }, new[] { 1, 2, 3, 4, 5, 6 } };  // LargeList
            ...
            CreateCompilationWithMscorlib45(source)
                .VerifyDiagnostics()
                .VerifyAnalyzerDiagnostics(
                    new DiagnosticAnalyzer[] { new ArrayInitializerTestAnalyzer() },
                    null,
                    null,
                    Diagnostic(
                            ArrayInitializerTestAnalyzer.DoNotUseLargeListOfArrayInitializersDescriptor
                                .Id,
                            "{ 1, 2, 3, 4, 5, 6 }"
                        )
                        .WithLocation(14, 32),
...
";
            CreateCompilationWithMscorlib45(source)
                ...
                .VerifyAnalyzerDiagnostics(
                    new DiagnosticAnalyzer[] { new VariableDeclarationTestAnalyzer() },
                    null,
                    null,
                    Diagnostic(
                            VariableDeclarationTestAnalyzer.TooManyLocalVarDeclarationsDescriptor
                                .Id,
                            "int c1, c2, c3, c4;"
                        )
                        .WithLocation(9, 9),
                    Diagnostic(
                        ...
                        .WithLocation(10, 9),
                    Diagnostic(
                            VariableDeclarationTestAnalyzer.LocalVarInitializedDeclarationDescriptor
                                .Id,
                            "d4 = { null, null }"
                        )
                        .WithLocation(10, 25),
...
";
            CreateCompilationWithMscorlib45(source)
                .VerifyDiagnostics(
                    Diagnostic(ErrorCode.WRN_EmptySwitch, "{").WithLocation(37, 20),
                    Diagnostic(ErrorCode.ERR_ConstantExpected, ":").WithLocation(41, 18)
                )
                .VerifyAnalyzerDiagnostics(
                    new DiagnosticAnalyzer[] { new CaseTestAnalyzer() },
                    null,
                    null,
                    Diagnostic(
    ...
    public override void M1()
    {
        ...
        M2();
            ...
            CreateCompilationWithMscorlib45(source)
                .VerifyDiagnostics()
                .VerifyAnalyzerDiagnostics(
                    new DiagnosticAnalyzer[] { new ExplicitVsImplicitInstanceAnalyzer() },
                    null,
                    null,
                    Diagnostic(
...
";
            CreateCompilationWithMscorlib45(source)
                .VerifyDiagnostics()
                .VerifyAnalyzerDiagnostics(
                    new DiagnosticAnalyzer[] { new ParamsArrayTestAnalyzer() },
                    null,
                    null,
...
";
            CreateCompilationWithMscorlib45(source)
                .VerifyDiagnostics()
                .VerifyAnalyzerDiagnostics(
                    new DiagnosticAnalyzer[] { new EqualsValueTestAnalyzer() },
                    null,
                    null,
...
";
        ...
        {
            Func<int, string> buildSequenceOfBinaryExpressions = (count) =>
            {
...
"
        ...
        return x;
            ...
            CreateCompilationWithMscorlib45(source)
                .VerifyDiagnostics()
                .VerifyAnalyzerDiagnostics(
                    new DiagnosticAnalyzer[] { new AssignmentOperationSyntaxTestAnalyzer() },
                    null,
                    null,
                    Diagnostic(
...
class A
{
    ...
    private int _i = 0;
            ...
            CreateCompilationWithMscorlib45(source, options: TestOptions.UnsafeReleaseDll)
                .VerifyDiagnostics(
                    Diagnostic(ErrorCode.ERR_InvalidAddrOp, "a + b").WithLocation(7, 18)
                )
                .VerifyAnalyzerDiagnostics(
                    new DiagnosticAnalyzer[] { new AddressOfTestAnalyzer() },
                    null,
                    null,
...
";
            CreateCompilationWithMscorlib45(source)
                .VerifyDiagnostics()
                .VerifyAnalyzerDiagnostics(
                    new DiagnosticAnalyzer[] { new LambdaTestAnalyzer() },
                    null,
                    null,
...
";
            CreateCompilationWithMscorlib45(source)
                ...
                .VerifyAnalyzerDiagnostics(
                    new DiagnosticAnalyzer[] { new StaticMemberTestAnalyzer() },
                    null,
                    null,
...
";
            CreateCompilationWithMscorlib45(source)
                .VerifyDiagnostics()
                .VerifyAnalyzerDiagnostics(
                    new DiagnosticAnalyzer[] { new LabelOperationsTestAnalyzer() },
                    null,
                    null,
...
";
            CreateCompilationWithMscorlib45(source)
                .VerifyDiagnostics()
                .VerifyAnalyzerDiagnostics(
                    new DiagnosticAnalyzer[] { new UnaryAndBinaryOperationsTestAnalyzer() },
                    null,
                    null,
...
";
            CreateCompilationWithMscorlib45(source)
                ...
                .VerifyAnalyzerDiagnostics(
                    new DiagnosticAnalyzer[] { new OperatorPropertyPullerTestAnalyzer() },
                    null,
                    null
                );
        }
        ...
        int i = global::MyType();
            ...
            CreateCompilationWithMscorlib45(source)
                ...
                .VerifyAnalyzerDiagnostics(
                    ...
                    null,
                    Diagnostic(
                            ConversionExpressionCSharpTestAnalyzer.InvalidConversionExpressionDescriptor
                                .Id,
                            "null.Length"
                        )
                        .WithLocation(8, 17),
...
";
            CreateCompilationWithMscorlib45(source)
                .VerifyDiagnostics(
                    Diagnostic(ErrorCode.ERR_NoSuchMember, "Nan")
                        .WithArguments("float", "Nan")
                        .WithLocation(6, 27),
                    Diagnostic(ErrorCode.ERR_BadUnaryOp, "-f")
                ...
                .VerifyAnalyzerDiagnostics(
                    new DiagnosticAnalyzer[] { new InvalidOperatorExpressionTestAnalyzer() },
                    null,
                    null,
                    Diagnostic(
...
";
            CreateCompilationWithMscorlib45(source)
                ...
                .VerifyAnalyzerDiagnostics(
                    ...
                    null,
                    Diagnostic(
                            ConditionalAccessOperationTestAnalyzer.ConditionalAccessOperationDescriptor
                                .Id,
                            "p?.Prop"
                        )
                        .WithLocation(24, 17),
                    Diagnostic(
                            ConditionalAccessOperationTestAnalyzer.ConditionalAccessInstanceOperationDescriptor
                                .Id,
                            "p"
                        )
                        .WithLocation(24, 17),
...
";
            CreateCompilationWithMscorlib45(source)
                .VerifyDiagnostics()
                .VerifyAnalyzerDiagnostics(
                    new DiagnosticAnalyzer[] { new TrueFalseUnaryOperationTestAnalyzer() },
                    null,
                    null,
