    ...
    public object M(in object x) { return x; } // should trigger synthesizing IsReadOnly
            ...
            CreateEmptyCompilation(code)
                .VerifyEmitDiagnostics(
                    ...
                    //     public class ValueType { }
                    Diagnostic(ErrorCode.ERR_PredefinedTypeNotFound, "ValueType")
                        .WithArguments("System.Object")
                        .WithLocation(11, 18),
                    ...
                    //         public AttributeUsageAttribute(AttributeTargets t) { }
                    Diagnostic(ErrorCode.ERR_PredefinedTypeNotFound, "AttributeTargets")
                        .WithArguments("System.Object")
                        .WithLocation(7, 40),
                    ...
                    //     public class ValueType { }
                    Diagnostic(ErrorCode.ERR_BadCtorArgCount, "ValueType")
                        .WithArguments("object", "0")
                        .WithLocation(11, 18),
    ...
    public object M(in object x) { return x; } // should trigger synthesizing IsReadOnly
            ...
            CreateEmptyCompilation(code)
                .VerifyEmitDiagnostics(
                    ...
                    //         public AttributeUsageAttribute(AttributeTargets t) { }
                    Diagnostic(ErrorCode.ERR_PredefinedTypeNotFound, "AttributeUsageAttribute")
                        .WithArguments("System.Void")
                        .WithLocation(7, 16),
