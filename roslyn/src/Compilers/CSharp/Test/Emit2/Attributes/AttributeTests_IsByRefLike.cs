...
";
        ...
        public void IsByRefLikeIsWrittenToMetadata_NeedsToBeGenerated(
            bool includeCompilerFeatureRequired
        )
        {
            var text =
                @"
...
namespace System.Runtime.CompilerServices
{
    public class IsByRefLikeAttribute : System.Attribute { }
            ...
            var referenceA = CreateCompilation(
                    new[]
                    {
                        codeA,
                        GetCompilerFeatureRequiredAttributeText(includeCompilerFeatureRequired),
...
";
            ...
            CompileAndVerify(
                ...
                symbolValidator: module =>
                {
                    ...
                    AssertNoIsByRefLikeAttributeOrCompilerFeatureRequiredAttributeExists(
...
";
            ...
            void validate(ModuleSymbol module)
            {
                ...
                if (module is PEModuleSymbol peModule)
                {
                    ...
                    AssertHasCompilerFeatureRequired(
                        includeCompilerFeatureRequired,
                        peType,
                        peModule,
...
namespace System
{
    ...
    public ref struct NotTypedReference { }
            ...
            var compilation1 = CreateEmptyCompilation(
                new[] { source1, compilerFeatureRequiredAttribute },
...
";
        ...
        private static void AssertReferencedIsByRefLike(
            TypeSymbol type,
            bool hasObsolete = true,
            bool hasCompilerFeatureRequired = false
        )
        {
            var peType = (PENamedTypeSymbol)type;
        ...
        private static void AssertHasCompilerFeatureRequired(
            bool hasCompilerFeatureRequired,
        ...
        )
        {
            ...
            var shouldHaveMarker =
                hasCompilerFeatureRequired && !peType.IsRestrictedType(ignoreSpanLikeTypes: true);
            Assert.Equal(
                shouldHaveMarker ? nameof(CompilerFeatureRequiredFeatures.RefStructs) : null,
                compilerFeatureRequiredToken
            );
        }
        ...
        private static void AssertNoIsByRefLikeAttributeOrCompilerFeatureRequiredAttributeExists(
        ...
        )
        {
            ...
            var compilerFeatureRequiredAttributeTypeName = WellKnownTypes.GetMetadataName(
        ...
        private static string GetCompilerFeatureRequiredAttributeText(bool hasAttribute) =>
            hasAttribute ? CompilerFeatureRequiredAttribute : "";
    }
}
