                ...
                @"class Program
{
    static void Main()
    {
        ...
        A.F4(ref r);
            ...
            Assert.Equal(
                "void A.F3(System.Object x, scoped ref System.Int32 y)",
...
";
        ...
        {
            return module.GlobalNamespace.GetMember<NamedTypeSymbol>(
                "System.Runtime.CompilerServices.ScopedRefAttribute"
            );
        }
    }
