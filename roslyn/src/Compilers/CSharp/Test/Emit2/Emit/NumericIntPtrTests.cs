...
namespace Microsoft.CodeAnalysis.CSharp.UnitTests.Semantics
{
    public class NumericIntPtrTests : CSharpTestBase
    {
        ...
        internal static readonly ConversionKind[] NoConversion = new[]
        {
        ...
        internal static readonly ConversionKind[] IntPtrConversion = new[]
        {
            ConversionKind.IntPtr
        };
        internal static readonly ConversionKind[] ImplicitNumeric = new[]
        {
            ConversionKind.ImplicitNumeric
        };
        internal static readonly ConversionKind[] ExplicitIntegerToPointer = new[]
        {
        ...
        internal static readonly ConversionKind[] ExplicitEnumeration = new[]
        {
            ConversionKind.ExplicitEnumeration
        };
        internal static readonly ConversionKind[] ExplicitNumeric = new[]
        {
            ConversionKind.ExplicitNumeric
        };
        internal static readonly ConversionKind[] ExplicitUserDefined = new[]
        {
            ConversionKind.ExplicitUserDefined
        };

        internal static readonly ConversionKind[] ImplicitNullableNumeric = new[]
        {
            ConversionKind.ImplicitNullable,
            ConversionKind.ImplicitNumeric
        };
        internal static readonly ConversionKind[] ImplicitNullableIdentity = new[]
        {
            ConversionKind.ImplicitNullable,
            ConversionKind.Identity
        };

        internal static readonly ConversionKind[] ExplicitNullableEnumeration = new[]
        {
            ConversionKind.ExplicitNullable,
            ConversionKind.ExplicitEnumeration
        };
        internal static readonly ConversionKind[] ExplicitNullableImplicitNumeric = new[]
        {
            ConversionKind.ExplicitNullable,
            ConversionKind.ImplicitNumeric
        };
        internal static readonly ConversionKind[] ExplicitNullableNumeric = new[]
        {
            ConversionKind.ExplicitNullable,
            ConversionKind.ExplicitNumeric
        };
        internal static readonly ConversionKind[] ExplicitNullablePointerToInteger = new[]
        {
            ConversionKind.ExplicitNullable,
            ConversionKind.ExplicitPointerToInteger
        };
        internal static readonly ConversionKind[] ExplicitNullableIdentity = new[]
        {
            ConversionKind.ExplicitNullable,
            ConversionKind.Identity
        };
        ...
        internal static void AssertMatches(ConversionKind[] expected, Conversion conversion)
        {
            ...
            {
                actualConversionKinds = actualConversionKinds.Concat(
                    conversion.UnderlyingConversions.Select(c => c.Kind)
                );
            }
...
class A4 : IA
{
    void IA.F1(System.IntPtr x, nuint y) { }
            ...
            var comp = CreateNumericIntPtrCompilation(
                new[] { sourceA, sourceB },
                references: new[] { MscorlibRefWithoutSharingCachedSymbols },
                parseOptions: TestOptions.Regular9
            );
            comp.VerifyDiagnostics();

            comp = CreateNumericIntPtrCompilation(
                sourceA,
                references: new[] { MscorlibRefWithoutSharingCachedSymbols },
                parseOptions: TestOptions.Regular9
            );
            ...
            comp = CreateNumericIntPtrCompilation(
                sourceB,
                references: new[] { ref1, MscorlibRefWithoutSharingCachedSymbols },
                parseOptions: TestOptions.Regular9
            );
            comp.VerifyDiagnostics();
            ...
            comp = CreateNumericIntPtrCompilation(
                sourceB,
                references: new[] { ref2, MscorlibRefWithoutSharingCachedSymbols },
                parseOptions: TestOptions.Regular9
            );
            comp.VerifyDiagnostics();
        }
    ...
    public new void F2(System.UIntPtr y) { base.F2(y); }
            ...
            var diagnostics = new[]
            {
                ...
                Diagnostic(ErrorCode.WRN_NewRequired, "F1")
                    .WithArguments("B2.F1(nint)", "A.F1(nint)")
                    .WithLocation(8, 17),
                ...
                Diagnostic(ErrorCode.WRN_NewRequired, "F2")
                    .WithArguments("B2.F2(nuint)", "A.F2(nuint)")
                    .WithLocation(9, 17),
...
42"
  ...
  IL_0006:  ret
        ...
        public void BuiltInOperators()
        {
            var comp = CreateNumericIntPtrCompilation(
                "",
                new[] { MscorlibRefWithoutSharingCachedSymbols },
                parseOptions: TestOptions.Regular9
            );
        ...
        public void BuiltInConversions_NativeIntegers(
                ...
                @"class B : A
{
        ...
        F4 = w;
            ...
            comp = CreateNumericIntPtrCompilation(
                ...
                references: new[]
                {
                    ...
                    MscorlibRefWithoutSharingCachedSymbols
                },
  ...
  IL_005e:  ret
        ...
        [Theory, CombinatorialData]
        public void BuiltInOperators_NativeIntegers(
            bool useCompilationReference,
            bool useSystemTypes
        )
        {
                ...
                @"class B : A
{
    static void Main()
    {
        ...
        F4 = F4 / F2;
            ...
            comp = CreateNumericIntPtrCompilation(
                sourceB,
                references: new[] { refA, MscorlibRefWithoutSharingCachedSymbols },
                parseOptions: TestOptions.Regular9
            );
            comp.VerifyDiagnostics();
            var verifier = CompileAndVerify(comp);
    ...
    static void Main()
    {
        ...
        Console.WriteLine(y);
            ...
            comp.VerifyDiagnostics(
                ...
                //         const IntPtr y = checked((IntPtr)x);
                Diagnostic(ErrorCode.ERR_NotConstantExpression, "checked((IntPtr)x)")
                    .WithArguments("y")
                    .WithLocation(7, 26),
                // (7,34): warning CS8778: Constant value '1152921504606846975' may overflow 'nint' at runtime (use 'unchecked' syntax to override)
                //         const IntPtr y = checked((IntPtr)x);
                Diagnostic(ErrorCode.WRN_ConstOutOfRangeChecked, "(IntPtr)x")
    ...
    static void Main()
    {
        ...
        Console.WriteLine(y);
            ...
            comp.VerifyDiagnostics(
                // (7,26): error CS0133: The expression being assigned to 'y' must be constant
                //         const IntPtr y = unchecked((IntPtr)x);
                Diagnostic(ErrorCode.ERR_NotConstantExpression, "unchecked((IntPtr)x)")
                    .WithArguments("y")
                    .WithLocation(7, 26)
            );
    ...
    static void Main()
    {
        ...
        public void ConstantConversions_03()
        {
            ...
            constantConversions(
                ...
                "IntPtr",
                "(int.MaxValue + 1U)",
                warningOutOfRangeChecked("IntPtr", "2147483648"),
                "System.OverflowException",
                "2147483648",
                null,
                "-2147483648",
            ...
            constantConversions(
                ...
                "IntPtr",
                "uint.MaxValue",
                warningOutOfRangeChecked("IntPtr", "4294967295"),
                "System.OverflowException",
                "4294967295",
                null,
                "-1",
            ...
            constantConversions(
                ...
                "IntPtr",
                "(int.MinValue - 1L)",
                warningOutOfRangeChecked("IntPtr", "-2147483649"),
                "System.OverflowException",
                "-2147483649",
                null,
                "2147483647",
            ...
            constantConversions(
                ...
                "IntPtr",
                "long.MinValue",
                warningOutOfRangeChecked("IntPtr", "-9223372036854775808"),
                "System.OverflowException",
                "-9223372036854775808",
                null,
                "0",
            ...
            constantConversions(
                ...
                "IntPtr",
                "long.MaxValue",
                warningOutOfRangeChecked("IntPtr", "9223372036854775807"),
                "System.OverflowException",
                "9223372036854775807",
                null,
                "-1",
            ...
            constantConversions(
                ...
                "IntPtr",
                "ulong.MaxValue",
                errorOutOfRangeChecked("IntPtr", "18446744073709551615"),
                "System.OverflowException",
                "System.OverflowException",
                null,
                "-1",
            ...
            constantConversions(
                ...
                "IntPtr",
                "(int.MinValue - 1M)",
                errorOutOfRange("IntPtr", "-2147483649M"),
                "System.OverflowException",
                "-2147483649",
                errorOutOfRange("IntPtr", "-2147483649M"),
                "2147483647",
            ...
            constantConversions(
                ...
                "IntPtr",
                "(int.MaxValue + 1M)",
                errorOutOfRange("IntPtr", "2147483648M"),
                "System.OverflowException",
                "2147483648",
                errorOutOfRange("IntPtr", "2147483648M"),
                "-2147483648",
            ...
            constantConversions(
                ...
                "IntPtr",
                "decimal.MinValue",
                errorOutOfRange("IntPtr", "-79228162514264337593543950335M"),
                "System.OverflowException",
                "System.OverflowException",
                errorOutOfRange("IntPtr", "-79228162514264337593543950335M"),
                "-1",
            ...
            constantConversions(
                ...
                "UIntPtr",
                "-1",
                errorOutOfRangeChecked("UIntPtr", "-1"),
                "System.OverflowException",
                "System.OverflowException",
                null,
                "4294967295",
            ...
            constantConversions(
                ...
                "UIntPtr",
                "sbyte.MinValue",
                errorOutOfRangeChecked("UIntPtr", "-128"),
                "System.OverflowException",
                "System.OverflowException",
                null,
                "4294967168",
            ...
            constantConversions(
                ...
                "UIntPtr",
                "short.MinValue",
                errorOutOfRangeChecked("UIntPtr", "-32768"),
                "System.OverflowException",
                "System.OverflowException",
                null,
                "4294934528",
            ...
            constantConversions(
                ...
                "UIntPtr",
                "int.MinValue",
                errorOutOfRangeChecked("UIntPtr", "-2147483648"),
                "System.OverflowException",
                "System.OverflowException",
                null,
                "2147483648",
            ...
            constantConversions(
                ...
                "UIntPtr",
                "uint.MaxValue + 1L",
                warningOutOfRangeChecked("UIntPtr", "4294967296"),
                "System.OverflowException",
                "4294967296",
                null,
                "0",
            ...
            constantConversions(
                ...
                "UIntPtr",
                "long.MinValue",
                errorOutOfRangeChecked("UIntPtr", "-9223372036854775808"),
                "System.OverflowException",
                "System.OverflowException",
                null,
                "0",
            ...
            constantConversions(
                ...
                "UIntPtr",
                "long.MaxValue",
                warningOutOfRangeChecked("UIntPtr", "9223372036854775807"),
                "System.OverflowException",
                "9223372036854775807",
                null,
                "4294967295",
            ...
            constantConversions(
                ...
                "UIntPtr",
                "ulong.MaxValue",
                warningOutOfRangeChecked("UIntPtr", "18446744073709551615"),
                "System.OverflowException",
                "18446744073709551615",
                null,
                "4294967295",
            ...
            constantConversions(
                ...
                "UIntPtr",
                "(uint.MaxValue + 1M)",
                errorOutOfRange("UIntPtr", "4294967296M"),
                "System.OverflowException",
                "4294967296",
                errorOutOfRange("UIntPtr", "4294967296M"),
                "-1",
            ...
            constantConversions(
                ...
                "IntPtr",
                "(int.MinValue - 10000F)",
                warningOutOfRangeChecked("IntPtr", "-2.147494E+09"),
                "System.OverflowException",
                "-2147493632",
                null,
                "-2147483648",
            ...
            constantConversions(
                ...
                "IntPtr",
                "float.MinValue",
                errorOutOfRangeChecked("IntPtr", "-3.402823E+38"),
                "System.OverflowException",
                "System.OverflowException",
                null,
                "-2147483648",
            ...
            constantConversions(
                ...
                "IntPtr",
                "double.MinValue",
                errorOutOfRangeChecked("IntPtr", "-1.79769313486232E+308"),
                "System.OverflowException",
                "System.OverflowException",
                null,
                "-2147483648",
            ...
            constantConversions(
                ...
                "UIntPtr",
                "(uint.MaxValue + 1F)",
                warningOutOfRangeChecked("UIntPtr", "4.294967E+09"),
                "System.OverflowException",
                "4294967296",
                null,
                "0",
            ...
            constantConversions(
                ...
                "UIntPtr",
                "float.MinValue",
                errorOutOfRangeChecked("UIntPtr", "-3.402823E+38"),
                "System.OverflowException",
                "System.OverflowException",
                null,
                "0",
            ...
            constantConversions(
                ...
                "UIntPtr",
                "double.MinValue",
                errorOutOfRangeChecked("UIntPtr", "-1.79769313486232E+308"),
                "System.OverflowException",
                "System.OverflowException",
                null,
                "0",
            ...
            static DiagnosticDescription errorOutOfRangeChecked(
                ...
                Diagnostic(ErrorCode.ERR_ConstOutOfRangeChecked, $"({destinationType})x")
                    .WithArguments(value, AsNative(destinationType));
...
class B
{
    static void Main()
    {
        ...
        Console.WriteLine(A.C2);
            ...
            comp = CreateNumericIntPtrCompilation(
                source1,
                references: new[] { ref0, MscorlibRefWithoutSharingCachedSymbols },
                parseOptions: TestOptions.Regular9,
                options: TestOptions.ReleaseExe
            );
            CompileAndVerify(
...
"
  ...
  IL_0022:  ret
            ...
            static string convRUnFromToNullableT(
                string conversion,
                string sourceType,
                string destType
            ) =>
  ...
  IL_0007:  ret
            ...
            conversions(
                sourceType: "char?",
                destType: "nint",
                ExplicitNullableImplicitNumeric,
                expectedImplicitIL: null,
  ...
  IL_0006:  ret
            ...
            conversions(
                sourceType: "void*",
                destType: "nint?",
                ExplicitNullablePointerToInteger,
                expectedImplicitIL: null,
                @"{
  // Code size        7 (0x7)
  .maxstack  1
  ...
  IL_0006:  ret
            ...
            conversions(
                ...
                ExplicitUserDefined,
                expectedImplicitIL: null,
                expectedExplicitIL: convExplicitFromNullableT(
                    "nint",
                    "void* nint.op_Explicit(nint)"
                )
            );
            conversions(
                sourceType: "nint?",
  ...
  IL_0006:  ret
            ...
            conversions(
                ...
                destType: "float",
                ImplicitNumeric,
                expectedImplicitIL: convRUn("conv.r4"),
                expectedExplicitIL: convRUn("conv.r4")
            );
            conversions(
                sourceType: "nuint",
                destType: "double",
                ImplicitNumeric,
                expectedImplicitIL: convRUn("conv.r8"),
                expectedExplicitIL: convRUn("conv.r8")
            );
            conversions(
                sourceType: "nuint",
                destType: "decimal",
  ...
  IL_0007:  ret
            ...
            conversions(
                ...
                destType: "float?",
                ImplicitNullableNumeric,
                expectedImplicitIL: convRUnToNullableT("conv.r4", "float"),
                expectedExplicitIL: convRUnToNullableT("conv.r4", "float"),
                null
            );
            conversions(
                sourceType: "nuint",
                destType: "double?",
                ImplicitNullableNumeric,
                expectedImplicitIL: convRUnToNullableT("conv.r8", "double"),
                expectedExplicitIL: convRUnToNullableT("conv.r8", "double"),
                null
            );
            conversions(
                sourceType: "nuint",
  ...
  IL_0006:  ret
            ...
            conversions(
                ...
                ExplicitNullableImplicitNumeric,
                expectedImplicitIL: null,
                expectedExplicitIL: convRUnFromNullableT("conv.r4", "nuint")
            );
            conversions(
                sourceType: "nuint?",
                destType: "double",
                ExplicitNullableImplicitNumeric,
                expectedImplicitIL: null,
                expectedExplicitIL: convRUnFromNullableT("conv.r8", "nuint")
            );
            conversions(
                sourceType: "nuint?",
                destType: "decimal",
  ...
  IL_0007:  ret
            ...
            conversions(
                ...
                destType: "float?",
                ImplicitNullableNumeric,
                expectedImplicitIL: convRUnFromToNullableT("conv.r4", "nuint", "float"),
                expectedExplicitIL: convRUnFromToNullableT("conv.r4", "nuint", "float"),
                null
            );
            conversions(
                sourceType: "nuint?",
                destType: "double?",
                ImplicitNullableNumeric,
                expectedImplicitIL: convRUnFromToNullableT("conv.r8", "nuint", "double"),
                expectedExplicitIL: convRUnFromToNullableT("conv.r8", "nuint", "double"),
                null
            );
            conversions(
                sourceType: "nuint?",
                    ...
                    expectedErrorCode == 0
                        ...
                        : new[]
                        {
                            Diagnostic(expectedErrorCode, value)
                                .WithArguments(AsNative(sourceType), AsNative(destType))
                        };
                if (useChecked)
                {
                    value = $"checked({value})";
...
";
                ...
                if (expectedIL != null)
                {
                    var verifier = CompileAndVerify(
                        comp,
                        verify: useUnsafeContext ? Verification.Skipped : Verification.Passes
                    );
            ...
            )
            {
                ...
                if (expectedSymbol == null && diagnostic == null)
                {
                    diagnostic = Diagnostic(ErrorCode.ERR_BadUnaryOp, $"{op}operand")
                        .WithArguments(op, AsNative(opType));
                }
...
{{
  ...
  IL_0027:  ret
            ...
            unifiedIncrementOps(
                "++",
                "System.IntPtr",
                "nint nint.op_CheckedIncrement(nint value)",
                useChecked: true,
                values: $"{int.MinValue}, -1, 0, {int.MaxValue - 1}, {int.MaxValue}",
  ...
  IL_0027:  ret
            ...
            unifiedIncrementOps(
                "++",
                "System.UIntPtr",
                "nuint nuint.op_CheckedIncrement(nuint value)",
                useChecked: true,
                values: $"0, {int.MaxValue}, {uint.MaxValue - 1}, {uint.MaxValue}",
  ...
  IL_0027:  ret
            ...
            unifiedIncrementOps(
                "--",
                "System.IntPtr",
                "nint nint.op_CheckedDecrement(nint value)",
                useChecked: true,
                values: $"{int.MinValue}, {int.MinValue + 1}, 0, 1, {int.MaxValue}",
  ...
  IL_0027:  ret
            ...
            unifiedIncrementOps(
                "--",
                "System.UIntPtr",
                "nuint nuint.op_CheckedDecrement(nuint value)",
                useChecked: true,
                values: $"0, 1, {uint.MaxValue}",
        ...
        public void BinaryOperators()
        {
                ...
                if (includeBadBinaryOps)
                    builder.Add(
                        Diagnostic(ErrorCode.ERR_BadBinaryOps, $"x {op} y")
                            .WithArguments(op, AsNative(leftType), AsNative(rightType))
                    );
                if (includeVoidError)
            ...
            foreach ((string symbol, string name) in arithmeticOperators)
            {
                ...
                unifiedBinaryOps(
                    ...
                    "nint",
                    "uint",
                    $"long long.{name}(long left, long right)"
                );
                unifiedBinaryOps(
                    symbol,
                    "nint",
            ...
            foreach ((string symbol, string name) in comparisonOperators)
            {
                ...
                unifiedBinaryOps(
                    ...
                    "nint",
                    "uint",
                    $"bool long.{name}(long left, long right)"
                );
                unifiedBinaryOps(
                    symbol,
                    "nint",
  ...
  IL_0003:  ret
        ...
        public void ConstantFolding_01()
        {
            ...
            static DiagnosticDescription[] getBadUnaryOpDiagnostics(
                ...
                new[]
                {
                    Diagnostic(ErrorCode.ERR_BadUnaryOp, operand)
                        .WithArguments(op, AsNative(opType))
                };
        ...
        const UIntPtr y = checked(uint.MaxValue + (UIntPtr)42);
            ...
            comp.VerifyDiagnostics(
                ...
                Diagnostic(
                        ...
                        "unchecked(uint.MaxValue + (UIntPtr)42)"
                    )
                    .WithArguments("x")
                    .WithLocation(8, 27),
                ...
                Diagnostic(
                        ErrorCode.ERR_NotConstantExpression,
                        "checked(uint.MaxValue + (UIntPtr)42)"
                    )
                    .WithArguments("y")
                    .WithLocation(9, 27),
                // (9,35): warning CS8973: The operation may overflow 'nuint' at runtime (use 'unchecked' syntax to override)
                //         const UIntPtr y = checked(uint.MaxValue + (UIntPtr)42);
                Diagnostic(ErrorCode.WRN_CompileTimeCheckedOverflow, "uint.MaxValue + (UIntPtr)42")
                    .WithArguments("nuint")
                    .WithLocation(9, 35)
            );
    ...
    static void Main()
    {
        ...
        const IntPtr y = checked(-(IntPtr)int.MinValue);
            ...
            comp.VerifyDiagnostics(
                ...
                //         const IntPtr x = unchecked(-(IntPtr)int.MinValue);
                Diagnostic(ErrorCode.ERR_NotConstantExpression, "unchecked(-(IntPtr)int.MinValue)")
                    .WithArguments("x")
                    .WithLocation(8, 26),
                // (9,26): error CS0133: The expression being assigned to 'y' must be constant
                //         const IntPtr y = checked(-(IntPtr)int.MinValue);
                Diagnostic(ErrorCode.ERR_NotConstantExpression, "checked(-(IntPtr)int.MinValue)")
                    .WithArguments("y")
                    .WithLocation(9, 26),
                // (9,34): warning CS8973: The operation may overflow 'nint' at runtime (use 'unchecked' syntax to override)
                //         const IntPtr y = checked(-(IntPtr)int.MinValue);
                Diagnostic(ErrorCode.WRN_CompileTimeCheckedOverflow, "-(IntPtr)int.MinValue")
                    .WithArguments("nint")
                    .WithLocation(9, 34)
            );
...
";
            ...
            comp.VerifyDiagnostics(
                ...
                // class C2 : I<nint>, I<System.IntPtr> { }
                Diagnostic(ErrorCode.ERR_DuplicateInterfaceInBaseList, "I<System.IntPtr>")
                    .WithArguments("I<nint>")
                    .WithLocation(3, 21),
                // (4,49): error CS0528: 'I<nuint>' is already listed in interface list
                // class C3 : I<System.UIntPtr>, I<System.IntPtr>, I<nuint> { }
                Diagnostic(ErrorCode.ERR_DuplicateInterfaceInBaseList, "I<nuint>")
                    .WithArguments("I<nuint>")
                    .WithLocation(4, 49)
            );
        }
                ...
                if (noConversion)
                {
                    comp.VerifyDiagnostics(
                        ...
                        Diagnostic(ErrorCode.ERR_NoImplicitConv, "x")
                            .WithArguments(AsNative(sourceType), "FinalType"),
                        // (4,31): error CS0030: Cannot convert type 'sourceType' to 'FinalType'
                        //     FinalType M2(sourceType x) => (FinalType)x;
                        Diagnostic(ErrorCode.ERR_NoExplicitConv, "(FinalType)x")
                            .WithArguments(AsNative(sourceType), "FinalType")
                    );
                }
                else if (isExplicit)
...
";
            ...
            comp = CreateEmptyCompilation(
                source,
                references: new[] { corlib.ToMetadataReference() },
                parseOptions: parseOptions
            );
            verify(comp);
            ...
            comp = CreateEmptyCompilation(
                source,
                references: new[] { corlib.EmitToImageReference() },
                parseOptions: parseOptions
            );
            verify(comp);
...
";
            ...
            var returnStatements = tree.GetRoot()
                ...
                .ToArray();
            Assert.Equal(
                "nint nint.op_Implicit(System.String s)",
                model.GetConversion(returnStatements[0].Expression).Method.ToTestDisplayString()
            );
            Assert.Equal(
                "nuint nuint.op_Implicit(System.String s)",
                model.GetConversion(returnStatements[1].Expression).Method.ToTestDisplayString()
            );
        }
                ...
                @"class Program
{
    ...
    static System.UIntPtr F4() => throw null;
            ...
            foreach (var method in methods)
            {
                ...
                Assert.Equal(
                    useCompilationReference || returnType.IsReferenceType,
                    returnType.IsRecord
                );
            }
        }
...
public class C
{
    public nint M() { throw null; }
            ...
            var comp2 = CreateNumericIntPtrCompilation(
                source,
                references: new[] { image, MscorlibRefWithoutSharingCachedSymbols }
            );
...
""";
            var libComp = CreateNumericIntPtrCompilation(
                lib_cs,
                references: new[] { MscorlibRefWithoutSharingCachedSymbols },
                assemblyName: "lib"
            );
...
""";
        ...
        private void VerifyNoNativeIntegerAttributeEmitted(CSharpCompilation comp)
        {
            ...
            CompileAndVerify(
                ...
                symbolValidator: module =>
                    Assert.Equal(
                        "",
                        NativeIntegerAttributesVisitor.GetString((PEModuleSymbol)module)
                    ),
                verify: Verification.Skipped
            );
        }
        ...
        private static MetadataReference MscorlibRefWithoutSharingCachedSymbols
        {
            get
            {
                ...
                return ((AssemblyMetadata)((MetadataImageReference)MscorlibRef).GetMetadata())
...
";
        ...
        static string AsNative(string type) =>
            type switch
            {
