    ...
    unsafe static void Main()
    {
        ...
        Console.Write(sizeof(nuint));
            ...
            var verifier = CompileAndVerify(
                comp,
                expectedOutput: IncludeExpectedOutput($"{size}{size}{size}{size}"),
            ...
            static void verifyOperators(CSharpCompilation comp)
            {
                ...
                )
                {
                    ...
                    int expectedUnsigned =
                        skipNativeIntegerOperators ? 0
                        : (operatorKind == UnaryOperatorKind.UnaryMinus) ? 0
                        : 1;
                    verifyOperators(
                        operators,
    ...
    static void Main()
    {
        ...
        catch (Exception e)
        {
            ...
            CompileAndVerify(
                comp,
                expectedOutput: IncludeExpectedOutput(
                    IntPtr.Size == 4 ? "System.OverflowException" : "1152921504606846975"
                ),
                verify: Verification.FailsPEVerify
            );
        }
    ...
    static void Main()
    {
        ...
        Console.WriteLine(y);
            ...
            CompileAndVerify(
                ...
                verify: Verification.FailsPEVerify,
                expectedOutput: IncludeExpectedOutput(
                    IntPtr.Size == 4 ? "-1" : "1152921504606846975"
                )
            );
        }
...
";
                ...
                if (expectedIL != null)
                {
                    var verifier = CompileAndVerify(
                        comp,
                        verify: useUnsafeContext ? Verification.Skipped : Verification.FailsPEVerify
                    );
    ...
    static void Main()
    {
        System.Console.WriteLine(Library.F);
                ...
                CompileAndVerify(
                    ...
                    {
                        Status =
                            VerificationStatus.PassesOrFailFast | VerificationStatus.FailsPEVerify,
                    },
                    expectedOutput: IncludeExpectedOutput(expectedResult)
                );
    ...
    {{
        ...
        Console.WriteLine(result);
                ...
                CompileAndVerify(
                        ...
                        {
                            Status =
                                VerificationStatus.FailsPEVerify
                                | VerificationStatus.PassesOrFailFast,
                        },
                        expectedOutput: IncludeExpectedOutput(expectedResult)
                    )
    ...
    static void Main()
    {
        ...
        catch (System.Exception e)
        {
            ...
            CompileAndVerify(
                    ...
                    verify: Verification.FailsPEVerify,
                    expectedOutput: IncludeExpectedOutput(
                        IntPtr.Size == 4 ? "System.OverflowException" : "4294967337"
                    )
                )
                .VerifyDiagnostics(
    ...
    static void Main()
    {
        ...
        System.Console.WriteLine(y);
            ...
            CompileAndVerify(
                    comp,
                    verify: Verification.FailsPEVerify,
                    expectedOutput: IncludeExpectedOutput(IntPtr.Size == 4 ? "41" : "4294967337")
                )
                .VerifyDiagnostics();
        }
...
""";
            ...
            CompileAndVerify(
                comp,
                expectedOutput: IncludeExpectedOutput(expected),
                verify: Verification.FailsPEVerify
            );
        }
...
""";
            ...
            comp.VerifyDiagnostics(
                ...
                // public class Derived : Base
                Diagnostic(ErrorCode.ERR_NoTypeDef, "Base")
                    .WithArguments(
                        "System.Object",
...
""";
            ...
            CompileAndVerify(
                comp,
                expectedOutput: IncludeExpectedOutput("OVERFLOW RAN"),
                verify: Verification.Skipped
            );
...
""";
            ...
            var verifier = CompileAndVerify(
                comp,
                expectedOutput: IncludeExpectedOutput("63"),
                verify: Verification.FailsPEVerify
            );
            verifier.VerifyIL(
                "C.ShiftRight",
        ...
        Console.Write(F(11));
            ...
            void verify(CSharpCompilation comp)
            {
                ...
                var verifier = CompileAndVerify(
                    comp,
                    verify: Verification.Skipped,
                    expectedOutput: IncludeExpectedOutput("00")
                );
                verifier.VerifyIL(
                    "Program.F",
                    """
