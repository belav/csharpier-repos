...
class A4 : IA
{
    void IA.F1(System.IntPtr x, nuint y) { }
            ...
            var comp = CreateNumericIntPtrCompilation(
                new[] { sourceA, sourceB },
                references: new[] { mscorlibRefWithoutSharing },
                parseOptions: TestOptions.Regular9
            );
            comp.VerifyDiagnostics();
            ...
            comp = CreateEmptyCompilation(
                sourceB,
                references: new[] { ref1, mscorlibRefWithoutSharing },
                parseOptions: TestOptions.Regular9
            );
            comp.VerifyDiagnostics();
            ...
            comp = CreateEmptyCompilation(
                sourceB,
                references: new[] { ref2, mscorlibRefWithoutSharing },
                parseOptions: TestOptions.Regular9
            );
            comp.VerifyDiagnostics();
        }
...
";
            ...
            comp.VerifyDiagnostics(
                ...
                //     UIntPtr M(UIntPtr i, int j) => i + j;
                Diagnostic(ErrorCode.ERR_AmbigBinaryOps, "i + j")
                ...
                @"class B : A
{
    static void Main()
    {
        ...
        F4 = F4 / F2;
            ...
            comp = CreateEmptyCompilation(
                sourceB,
                references: new[] { refA, mscorlibRefWithoutSharing },
                parseOptions: useCSharp9 ? TestOptions.Regular9 : TestOptions.Regular8
            );
            comp.VerifyDiagnostics();
            var verifier = CompileAndVerify(comp);
            verifier.VerifyIL(
...
class B
{
    static void Main()
    {
        ...
        Console.WriteLine(A.C2);
            ...
            comp = CreateEmptyCompilation(
                source1,
                references: new[] { ref0, mscorlibRefWithoutSharing },
                parseOptions: TestOptions.Regular9,
                options: TestOptions.ReleaseExe
            );
            CompileAndVerify(
...
";
            var parseOptions = (
                useCSharp11 ? TestOptions.Regular11 : TestOptions.Regular10
...
";
            ...
            {
                validateWithCheckedOrUnchecked(
                    type,
                    value,
                    binaryOp,
                    expectedIL,
            ...
            void validateWithCheckedOrUnchecked(
                string type,
                string value,
                string binaryOp,
                string expectedIL,
