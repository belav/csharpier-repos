    ...
    public static string M5()
    {
        ...
        // error
            ...
            comp.VerifyDiagnostics(
                ...
                //     public static string M5()
                Diagnostic(ErrorCode.ERR_ReturnExpected, "M5")
                    .WithArguments("C.M5()")
                    .WithLocation(46, 26),
...
"
            ...
            CreateCompilation(source)
                .VerifyDiagnostics(
                    ...
                    //         { int a; if (GetNLS() && GetNLS(out a)) F(a); } // error
                    Diagnostic(ErrorCode.ERR_UseDefViolation, "a")
                        .WithArguments("a")
                        .WithLocation(106, 51),
            ...
            CreateCompilation(source)
                .VerifyDiagnostics(
                    ...
                    Diagnostic(ErrorCode.ERR_AnonymousReturnExpected, "delegate")
                        .WithArguments("anonymous method", "DI")
                        .WithLocation(78, 15),
...
";
            CreateCompilation(source)
                .VerifyDiagnostics(
                    ...
                    //             : x.ToString() + z.ToString(); // 1
                    Diagnostic(ErrorCode.ERR_UseDefViolation, "z")
                        .WithArguments("z")
                        .WithLocation(21, 30)
                );
        }
...
";
            CreateCompilation(source)
                .VerifyDiagnostics(
                    ...
                    //     Console.WriteLine(di.ToString()); // 1
                    Diagnostic(ErrorCode.ERR_UseDefViolation, "di")
                        .WithArguments("di")
                        .WithLocation(6, 23)
                );
        }
...
";
            CreateCompilation(source)
                .VerifyDiagnostics(
                    ...
                    //     : d1.ToString(); // 2
                    Diagnostic(ErrorCode.ERR_UseDefViolation, "d1")
                        .WithArguments("d1")
                        .WithLocation(7, 7),
                    ...
                    //     : d2.ToString(); // 4
                    Diagnostic(ErrorCode.ERR_UseDefViolation, "d2")
                        .WithArguments("d2")
                        .WithLocation(11, 7)
                );
        }
...
class C
{
    public "
                + returnType
                + @" M0(out int x, out int y) { x = 42; y = 42; return null; }
...
struct T
{
    public static implicit operator S("
                + conversionParams
                + @") => new S(); // 1
    public T M0(out int x, out int y) { x = 42; y = 42; return this; }
}
...
";
            CreateCompilation(source)
                .VerifyDiagnostics(
                    ...
                    //         _ = t?.M0(out x, out y) != new S() // 2
                    Diagnostic(ErrorCode.ERR_BadBinaryOps, "t?.M0(out x, out y) != new S()")
                        .WithArguments("!=", "T?", "S")
                        .WithLocation(20, 13),
                    // (21,15): error CS0165: Use of unassigned local variable 'x'
                    //             ? x.ToString() // 3
                    ...
                    //         _ = new S() != t?.M0(out x, out y) // 8
                    Diagnostic(ErrorCode.ERR_BadBinaryOps, "new S() != t?.M0(out x, out y)")
                        .WithArguments("!=", "S", "T?")
                        .WithLocation(36, 13),
                    // (37,15): error CS0165: Use of unassigned local variable 'x'
                    //             ? x.ToString() // 9
...
";
            CreateCompilation(source)
                .VerifyDiagnostics(
                    ...
                    //         _ = (b && M0(x = y = 0)) is bool // 1
                    Diagnostic(ErrorCode.WRN_IsAlwaysTrue, "(b && M0(x = y = 0)) is bool")
                        .WithArguments("bool")
                        .WithLocation(11, 13),
                    // (12,15): error CS0165: Use of unassigned local variable 'x'
                    //             ? x.ToString() // 2
...
";
            CreateCompilationWithMscorlib45(source)
                .VerifyDiagnostics(
                    ...
                    //                 obj.ToString();
                    Diagnostic(ErrorCode.ERR_UseDefViolation, "obj")
                        .WithArguments("obj")
                        .WithLocation(28, 17)
                );
        }
        ...
        public void LocalMethod_ParameterAttribute()
        {
            ...
            CreateCompilation(source)
                .VerifyDiagnostics(
                    ...
                    //         const int Unused = 20;
                    Diagnostic(ErrorCode.WRN_UnreferencedVarAssg, "Unused")
        ...
        public void LocalMethod_AttributeArguments()
        {
            ...
            CreateCompilation(source)
                .VerifyDiagnostics(
                    ...
                    //         const int N6 = 60;
                    Diagnostic(ErrorCode.WRN_UnreferencedVarAssg, "N6")
                        .WithArguments("N6")
                        .WithLocation(16, 19)
                );
        }
        ...
        public void NameOf_Nested()
        {
            ...
            var expectedDiagnostic =
                ...
                Diagnostic(ErrorCode.WRN_UnassignedInternalField, "c")
                    .WithArguments("C.c", "null")
                    .WithLocation(4, 15);

            CompileAndVerify(source, parseOptions: TestOptions.Regular12, expectedOutput: "c")
                .VerifyDiagnostics(expectedDiagnostic);
            CompileAndVerify(source, parseOptions: TestOptions.RegularPreview, expectedOutput: "c")
                .VerifyDiagnostics(expectedDiagnostic);
            CreateCompilation(source, parseOptions: TestOptions.Regular11)
                .VerifyDiagnostics(
                    ...
                    //     public static string M() => nameof(c.c.c);
                    Diagnostic(ErrorCode.ERR_FeatureNotAvailableInVersion11, "c")
        ...
        public void OutParameterIsNotAssigned_01()
        {
            ...
            CreateCompilation(source)
                .VerifyDiagnostics(
                    ...
                    // static void bug(out int a)
                    Diagnostic(ErrorCode.ERR_ParamUnassigned, "bug")
                        .WithArguments("a")
                        .WithLocation(3, 13)
                );
        }
        ...
        public void OutParameterIsNotAssigned_07()
        {
            ...
            CreateCompilation(source)
                .VerifyDiagnostics(
                    ...
                    // class C(out int a) : Base(Test(() =>
                    Diagnostic(ErrorCode.ERR_ParamUnassigned, "C")
                        .WithArguments("a")
                        .WithLocation(1, 7)
                );
        }
