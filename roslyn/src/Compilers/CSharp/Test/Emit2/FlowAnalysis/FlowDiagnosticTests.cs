...
class Program
{
    ...
    static void F(ref int i) { }
            ...
            var comp = CreateCompilation(program);
            Assert.NotEmpty(
                this.FlowDiagnostics(comp).Where(e => e.Severity >= DiagnosticSeverity.Error)
            );
        }
...
";
            CreateCompilation(program, parseOptions: TestOptions.Regular9)
                .VerifyDiagnostics(
            ...
            CreateCompilation(program, parseOptions: TestOptions.Regular10)
                .VerifyDiagnostics(
                    ...
                    Diagnostic(ErrorCode.ERR_UnassignedThisUnsupportedVersion, "S")
                        .WithArguments("S.y", "preview")
                        .WithLocation(5, 5),
                    // (4,12): warning CS0169: The field 'S.y' is never used
                    //     int x, y;
                    Diagnostic(ErrorCode.WRN_UnreferencedField, "y")
                        .WithArguments("S.y")
                        .WithLocation(4, 12)
                );
    ...
    public static void Main(string[] args)
    {
            ...
            CreateCompilation(program, parseOptions: TestOptions.Regular10)
                .VerifyDiagnostics(
                    ...
                    //     public Program(int x)
                    Diagnostic(
                            ErrorCode.ERR_UnassignedThisAutoPropertyUnsupportedVersion,
                            "Program"
                        )
                        .WithArguments("Program.X", "preview")
                        .WithLocation(5, 12)
                );
...
struct Program
{
    ...
    static void Main(string[] args)
    {
            ...
            comp.VerifyDiagnostics(
                ...
                //         x.i = 1;
                Diagnostic(ErrorCode.ERR_ReturnNotLValue, "x")
                ...
                //         x.i = 1;
                Diagnostic(ErrorCode.ERR_UseDefViolationFieldUnsupportedVersion, "x.i")
                    .WithArguments("i", "preview")
                    .WithLocation(16, 9),
                ...
                //         System.Console.WriteLine(x2.ii);
                Diagnostic(ErrorCode.ERR_UseDefViolationPropertyUnsupportedVersion, "x2")
                    .WithArguments("x2", "preview")
                    .WithLocation(17, 34),
                ...
                //     public Program(int dummy)
                Diagnostic(ErrorCode.ERR_UnassignedThisAutoPropertyUnsupportedVersion, "Program")
                    .WithArguments("Program.x", "preview")
                    .WithLocation(14, 12),
                ...
                //     public Program(int dummy)
                Diagnostic(ErrorCode.ERR_UnassignedThisAutoPropertyUnsupportedVersion, "Program")
                    .WithArguments("Program.x2", "preview")
                    .WithLocation(14, 12)
            );
...
struct Program
{
    ...
    static void Main(string[] args)
    {
            ...
            comp.VerifyDiagnostics(
                ...
                //         x.i = 1;
                Diagnostic(ErrorCode.WRN_UseDefViolationFieldSupportedVersion, "x.i")
                    .WithArguments("i")
                    .WithLocation(16, 9),
                ...
                //         System.Console.WriteLine(x2.ii);
                Diagnostic(ErrorCode.WRN_UseDefViolationPropertySupportedVersion, "x2")
                    .WithArguments("x2")
                    .WithLocation(17, 34)
            );
...
struct Program
{
    ...
    static void Main(string[] args)
    {
            ...
            comp.VerifyDiagnostics(
                ...
                //         x2.i += 1;
                Diagnostic(ErrorCode.ERR_ReturnNotLValue, "x2")
                    .WithArguments("Program.x2")
                    .WithLocation(20, 9)
            );
        }
...
class Program
{
    ...
    static void Main(string[] args)
    {
            ...
            comp.VerifyDiagnostics(
                ...
                //             this.x2 = new S1();
                Diagnostic(ErrorCode.ERR_AssgReadonlyProp, "this.x2")
                    .WithArguments("Program.x2")
                    .WithLocation(23, 13),
                // (6,20): warning CS0649: Field 'Program.S1.i' is never assigned to, and will always have its default value 0
                //         public int i;
...
struct Program
{
    ...
    static void Main(string[] args)
    {
            ...
            comp.VerifyDiagnostics(
                ...
                //         Goo(ref x3);
                Diagnostic(ErrorCode.ERR_BadArgRef, "x3")
                    .WithArguments("1", "out")
                    .WithLocation(20, 17),
                ...
                //         Goo(out x1);
                Diagnostic(ErrorCode.ERR_UseDefViolationPropertyUnsupportedVersion, "x1")
                    .WithArguments("x1", "preview")
                    .WithLocation(15, 17),
                ...
                //         Goo(ref x1);
                Diagnostic(ErrorCode.ERR_UseDefViolationThisUnsupportedVersion, "Goo")
                    .WithArguments("preview")
                    .WithLocation(16, 9),
                ...
                @"class C
{
    ...
    static void Goo(int y)
    {
            ...
            comp.VerifyDiagnostics(
                ...
                //             Goo(y, null);
                Diagnostic(ErrorCode.ERR_BadArgCount, "Goo")
                    .WithArguments("Goo", "2")
                    .WithLocation(8, 13),
            ...
            comp = CreateCompilationWithMscorlib40AndSystemCore(
                source,
                parseOptions: TestOptions.RegularNext
            );
            comp.VerifyDiagnostics(
                ...
                @"struct Derived
{
    ...
    private int x;
            ...
            comp.VerifyDiagnostics(
                ...
                //     Derived(int x) { }
                Diagnostic(ErrorCode.ERR_UnassignedThisUnsupportedVersion, "Derived")
                    .WithArguments("Derived.x", "preview")
                    .WithLocation(3, 5),
    ...
    public static void Main()
    {
        ...
        string s = k;
            ...
            comp.VerifyDiagnostics(
                ...
                //         string s = k;
                Diagnostic(ErrorCode.ERR_UseDefViolation, "k")
                    .WithArguments("k")
                    .WithLocation(10, 20)
            );
        }
