...
";
            ...
            compilation.VerifyDiagnostics(
                ...
                //         if (p is 1) { }
                Diagnostic(ErrorCode.ERR_ConstantValueOfTypeExpected, "1")
                    .WithArguments("int*")
                    .WithLocation(6, 18),
...
";
        ...
        public void Pointer_Pattern_Comparison(
        ...
        )
        {
            ...
            CreateCompilation(source, options: TestOptions.UnsafeDebugDll)
                .VerifyDiagnostics(
                    ...
                    //         if (p is     < null) { }
                    Diagnostic(ErrorCode.ERR_UnsupportedTypeForRelationalPattern, $"{op} null")
                        .WithArguments("void*")
                        .WithLocation(5, 22)
                );
        }
        ...
        public void Pointer_Pattern_Equality([CombinatorialValues("==", "!=")] string op, bool not)
        {
            ...
            CreateCompilation(source, options: TestOptions.UnsafeDebugDll)
                .VerifyDiagnostics(
                    ...
                    //         if (p is     == null) { }
                    Diagnostic(ErrorCode.ERR_InvalidExprTerm, op)
                        .WithArguments(op)
                        .WithLocation(5, 22)
                );
        }
