...
";
            ...
            compilation.VerifyEmitDiagnostics(
                ...
                //         if (0 is s->X) {}
                Diagnostic(ErrorCode.ERR_ConstantValueOfTypeExpected, "s->X")
                    .WithArguments("int")
                    .WithLocation(6, 18)
            );
        }
...
";
            ...
            var yName = ((MemberAccessExpressionSyntax)subpatterns[0].ExpressionColon.Expression)
                .Name;
            ...
            var xName = ((MemberAccessExpressionSyntax)subpatterns[1].ExpressionColon.Expression)
                .Name;
...
""";
            ...
            comp.VerifyDiagnostics(
                ...
                Diagnostic(
                    ...
                    .WithArguments("(Enum.One, (Enum)-1, _)")
                    .WithLocation(12, 28)
            );
        }
...
""";
        ...
        [
            Theory,
            CombinatorialData,
            WorkItem(64399, "https://github.com/dotnet/roslyn/issues/64399")
        ]
        public void ShortestPathToDefaultNodeYieldsNoRemainingValues_Nullability_Deconstruction(
            bool nullableEnable
        )
        {
            var source = """
...
""";
            ...
            if (nullableEnable)
            {
                comp.VerifyDiagnostics(
                    ...
                    Diagnostic(
                        ...
                        .WithArguments("(Enum.Zero, (Enum)-1, false)")
                        .WithLocation(121, 21)
                );
            }
            else
        ...
        public void ShortestPathToDefaultNodeYieldsNoRemainingValues_Nullability_NullableBool(
            bool nullableEnable
        )
        {
            var source = """
