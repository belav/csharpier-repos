...
namespace Microsoft.CodeAnalysis.CSharp.UnitTests
{
    public class SyntaxFactoryTests : CSharpTestBase
    {
        ...
        {
            var text = SyntaxFactory
                .SyntaxTree(SyntaxFactory.CompilationUnit(), encoding: null)
                .GetText();
        ...
        {
            var n = SyntaxFactory.NamespaceDeclaration(
                name: SyntaxFactory.IdentifierName(SyntaxFactory.Identifier("goo"))
            );
            Assert.NotNull(n);
        ...
        public void TestConstructPragmaChecksumDirective()
        {
            Func<string, SyntaxToken> makeStringLiteral = value =>
                SyntaxFactory
                    .ParseToken(string.Format("\"{0}\"", value))
                    .WithLeadingTrivia(SyntaxFactory.ElasticMarker)
                    .WithTrailingTrivia(SyntaxFactory.ElasticMarker);
            var t = SyntaxFactory.PragmaChecksumDirectiveTrivia(
                makeStringLiteral("file"),
                makeStringLiteral("guid"),
                makeStringLiteral("bytes"),
                true
            );
        ...
        public void TestFreeFormTokenFactory_CustomText()
        {
            ...
            )
            {
                ...
                {
                    Assert.IsType<InternalSyntax.SyntaxToken.SyntaxTokenWithValueAndTrivia<string>>(
                        token.Node
                    );
                }
            }
        ...
        public void TestSeparatedListFactory_DefaultSeparators()
        {
            ...
            var null2 = SyntaxFactory.SeparatedList(
            ...
            var empty2 = SyntaxFactory.SeparatedList(
            ...
            var singleton1 = SyntaxFactory.SeparatedList(
            ...
            var list1 = SyntaxFactory.SeparatedList(
                new[]
                {
        ...
        public void GetTokenDiagnosticsWithSyntaxTree_WithDiagnostics()
        {
            ...
            var expectedLocation = Location.Create(
                expression.Token.SyntaxTree,
        ...
        public void TestSpacingOnTernary()
        {
            ...
            var syntaxNode2 = SyntaxFactory
                .ParseExpression("x is DateTime? y: z")
                .NormalizeWhitespace();
        ...
        public void TestSpacingOnCoalescing()
        {
            ...
            var syntaxNode2 = SyntaxFactory
                .ParseExpression("x is DateTime??y")
                .NormalizeWhitespace();
        ...
        public void TestParenthesizedLambdaNoParameterList_ExpressionBody()
        {
            var lambda = SyntaxFactory.ParenthesizedLambdaExpression(
                body: SyntaxFactory.LiteralExpression(
        ...
        public void TestParseNameWithOptions()
        {
            ...
            CreateCompilation(type, parseOptions: TestOptions.Regular8)
                .VerifyDiagnostics(
            ...
            CreateCompilation(type, parseOptions: TestOptions.Regular9)
                .VerifyDiagnostics(
                    // (1,1): error CS0214: Pointers and fixed size buffers may only be used in an unsafe context
                    // delegate*<void>
                    Diagnostic(ErrorCode.ERR_UnsafeNeeded, "delegate*").WithLocation(1, 1),
