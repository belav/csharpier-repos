...
namespace Microsoft.CodeAnalysis.CSharp.UnitTests
{
    public class SyntaxFactoryTests : CSharpTestBase
    {
        ...
        {
            var text = SyntaxFactory.SyntaxTree(SyntaxFactory.CompilationUnit(), encoding: null)
                .GetText();
        ...
        public void TestConstructPragmaChecksumDirective()
        {
            Func<string, SyntaxToken> makeStringLiteral = value =>
                SyntaxFactory.ParseToken(string.Format("\"{0}\"", value))
        ...
        public void TestSpacingOnTernary()
        {
            ...
            var syntaxNode2 = SyntaxFactory.ParseExpression("x is DateTime? y: z")
                .NormalizeWhitespace();
        ...
        public void TestSpacingOnCoalescing()
        {
            ...
            var syntaxNode2 = SyntaxFactory.ParseExpression("x is DateTime??y")
                .NormalizeWhitespace();
