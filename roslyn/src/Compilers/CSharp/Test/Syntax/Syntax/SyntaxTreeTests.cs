    ...
    public class SyntaxTreeTests : ParsingTests
    {
        ...
        public void SyntaxTreeCreationAndDirectiveParsing(SyntaxTreeFactoryKind factoryKind)
        {
            ...
            var tree = factoryKind switch
            {
                ...
                SyntaxTreeFactoryKind.ParseText
                    => CSharpSyntaxTree.ParseText(
                        SourceText.From(source, Encoding.UTF8, SourceHashAlgorithm.Sha256),
                        parseOptions
                    ),
                SyntaxTreeFactoryKind.Subclass
                    => new MockCSharpSyntaxTree(
                        root,
                        SourceText.From(source, Encoding.UTF8, SourceHashAlgorithm.Sha256),
                        parseOptions
                    ),
                SyntaxTreeFactoryKind.SynthesizedSyntaxTree
                    => SyntaxNode.CloneNodeAsRoot(root, syntaxTree: null).SyntaxTree,
...
#pragma warning restore CS0618
        ...
        public void GlobalUsingDirective_06()
        {
            ...
            UsingTree(
                ...
                Diagnostic(ErrorCode.ERR_FeatureNotAvailableInVersion9, "global using static ns1;")
                    .WithArguments("global using directive", "10.0")
                    .WithLocation(1, 1)
            );
        ...
        public void GlobalUsingDirective_10()
        {
            ...
            UsingTree(
                ...
                Diagnostic(ErrorCode.ERR_FeatureNotAvailableInVersion9, "global using alias = ns1;")
                    .WithArguments("global using directive", "10.0")
                    .WithLocation(1, 1)
            );
