    ...
    public class SyntaxAnnotationTests
    {
        ...
        private void TestMultipleAnnotationsInTree(
            ...
            foreach (var annotation in annotations)
            {
                ...
                var annotatedNodesOrTokens = newRoot.GetAnnotatedNodesAndTokens(annotation)
                ...
                var annotatedTrivia = newRoot.GetAnnotatedTrivia(annotation)
                    .OrderBy(t => t.SpanStart);
        ...
        private SyntaxNode CopyAnnotationsTo(SyntaxNode sourceTreeRoot, SyntaxNode destTreeRoot)
        {
            ...
            while (
                ...
                else if (sourceTreeNodeOrTokenEnumerator.Current.IsToken)
                {
                    ...
                    var newToken = sourceTreeNodeOrTokenEnumerator.Current.AsToken()
