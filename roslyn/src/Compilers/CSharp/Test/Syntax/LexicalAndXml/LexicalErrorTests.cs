...
";
        ...
        public void EscapeCharInStringCSharp12_A()
        {
            ...
            ParserErrorMessageTests.ParseAndValidate(
                ...
                //         string a = "\e";
                Diagnostic(ErrorCode.ERR_FeatureInPreview, @"\e")
                    .WithArguments("string escape character")
                    .WithLocation(5, 21)
            );
        }
...
";
            ...
            ParserErrorMessageTests.ParseAndValidate(test);
            CreateCompilation(test, parseOptions: TestOptions.Regular10)
                .VerifyDiagnostics(
...
";
            ...
            CreateCompilation(test, parseOptions: TestOptions.Regular11)
                .VerifyDiagnostics(
                    // (6,38): error CS1733: Expected expression
                    //       string s = $"x { /* comment */ } y";
                    Diagnostic(ErrorCode.ERR_ExpressionExpected, "").WithLocation(6, 38)
