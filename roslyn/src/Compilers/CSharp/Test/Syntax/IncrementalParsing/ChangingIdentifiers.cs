...
namespace Microsoft.CodeAnalysis.CSharp.UnitTests.IncrementalParsing
{
    ...
    public class ChangingIdentifiers
    {
        ...
        {
            MakeIncrementalNameChange(
                NameTypes.SingleName,
                NameTypes.DottedName,
        ...
        private static void MakeIncrementalNameChanges(
            NameTypes oldStyle,
            NameTypes newStyle,
            Action<ExpressionSyntax> expressionValidator,
            bool topLevel = false,
        ...
        )
        {
            ...
            var nameTree = topLevel
                ? GetGlobalMethodDeclarationSyntaxChange(newTree)
