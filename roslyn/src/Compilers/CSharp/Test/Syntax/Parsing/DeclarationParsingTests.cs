...
namespace Microsoft.CodeAnalysis.CSharp.UnitTests
{
    ...
    {
        public DeclarationParsingTests(ITestOutputHelper output)
            : base(output) { }
...
b { }";
        ...
        public void DefaultConstraint_01(bool useCSharp8)
        {
            ...
            UsingNode(test, useCSharp8 ? TestOptions.Regular8 : TestOptions.Regular9);
...
"
        ...
        [InlineDataAttribute(SyntaxKind.ClassDeclaration, SyntaxKind.ClassKeyword)]
        [InlineDataAttribute(SyntaxKind.InterfaceDeclaration, SyntaxKind.InterfaceKeyword)]
        public void Class_SemicolonBodyAfterConstraint_01(
            SyntaxKind declKind,
...
"
        ...
        [InlineDataAttribute(SyntaxKind.ClassDeclaration, SyntaxKind.ClassKeyword)]
        [InlineDataAttribute(SyntaxKind.InterfaceDeclaration, SyntaxKind.InterfaceKeyword)]
        public void Class_SemicolonBodyAfterConstraint_02(
            SyntaxKind declKind,
            SyntaxKind keywordKind
        )
        {
...
"
        ...
        [InlineDataAttribute(SyntaxKind.ClassDeclaration, SyntaxKind.ClassKeyword)]
        [InlineDataAttribute(SyntaxKind.InterfaceDeclaration, SyntaxKind.InterfaceKeyword)]
        public void Class_SemicolonBodyAfterConstraint_03(
            SyntaxKind declKind,
            SyntaxKind keywordKind
        )
        {
...
: Base(x, where T : class;";
            UsingTree(
                ...
                // : Base(x, where T : class;
                Diagnostic(ErrorCode.ERR_InvalidExprTerm, "where")
                    .WithArguments("where")
                    .WithLocation(3, 11),
