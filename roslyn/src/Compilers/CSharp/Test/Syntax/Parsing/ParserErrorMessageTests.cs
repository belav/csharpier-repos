...
";
            ...
            firstDiag.Verify(
                Diagnostic(ErrorCode.ERR_SyntaxError, "for").WithArguments("foreach", "for")
            );
        }
...
";
            ...
            ParseAndValidate(
                ...
                Diagnostic(ErrorCode.ERR_SyntaxError, "operator")
                    .WithArguments("explicit", "operator")
            );
        }
        ...
        return null;
            ...
            ParseAndValidate(
                ...
                Diagnostic(ErrorCode.ERR_SyntaxError, "explicit")
                    .WithArguments("operator", "explicit")
                    .WithLocation(4, 23),
...
";
            ...
            Assert.Equal(
                SyntaxKind.InKeyword,
                anonymousMethodExpression.ParameterList.Parameters.Single()
                    .Modifiers.Single()
                    .Kind()
            );
...
";
            ...
            ParseAndValidate(
                ...
                Diagnostic(ErrorCode.ERR_SyntaxError, "implicit")
                    .WithArguments("operator", "implicit")
                    .WithLocation(3, 23),
...
";
            ...
            tree.GetCompilationUnitRoot()
                ...
                .Verify(
                    ...
                    //         var q = from a in b
                    Diagnostic(ErrorCode.ERR_FeatureNotAvailableInVersion2, "from a in b")
...
";
 ...
 public static class Test
 {
     public static void DoSomething(this int x) { }
            ...
            ParseAndValidate(
                code,
                new CSharpParseOptions(LanguageVersion.CSharp2),
...
class TestClass { }";
            ...
            tree.GetDiagnostics()
                .Verify(
                    ...
                    // [One Two] // error: missing comma
                    Diagnostic(ErrorCode.ERR_SyntaxError, "Two")
                        .WithArguments(",", "")
                        .WithLocation(1, 6)
                );
...
";
            ...
            tree.GetCompilationUnitRoot()
                ...
                .Verify(
                    ...
                    //     async void M() { }
                    Diagnostic(ErrorCode.ERR_FeatureNotAvailableInVersion3, "async")
...
";
            ...
            SyntaxFactory.ParseSyntaxTree(
                ...
                .Verify(
                    ...
                    //     void M(int x = 1) { }
                    Diagnostic(ErrorCode.ERR_FeatureNotAvailableInVersion3, "= 1")
            ...
            SyntaxFactory.ParseSyntaxTree(
                ...
                .Verify(
                    ...
                    Diagnostic(ErrorCode.WRN_NonECMAFeature, "module:")
                        .WithArguments("module as an attribute target specifier")
                );
        }
        ...
        var x = $""hello world"";
            ...
            SyntaxFactory.ParseSyntaxTree(
                ...
                .Verify(
                    ...
                    //     int L { get; } = 12; // auto property initializer
                    Diagnostic(ErrorCode.ERR_FeatureNotAvailableInVersion5, "= 12")
                    ...
                    //     int this[int a] => a + 1; // expression-bodied indexer
                    Diagnostic(ErrorCode.ERR_FeatureNotAvailableInVersion5, "=> a + 1")
                    ...
                    //     public static explicit operator bool(Goo a) => false; // expression-bodied conversion operator
                    Diagnostic(ErrorCode.ERR_FeatureNotAvailableInVersion5, "=> false")
                        .WithArguments("expression-bodied method", "6")
                        .WithLocation(13, 49),
                    ...
                    //         var s = o?.ToString(); // null propagating operator
                    Diagnostic(ErrorCode.ERR_FeatureNotAvailableInVersion5, "o?.ToString()")
