...
namespace Microsoft.CodeAnalysis.CSharp.UnitTests
{
    ...
    {
        public ParserErrorMessageTests(ITestOutputHelper output)
            : base(output) { }
...
";
            ...
            ParseAndValidate(
                ...
                // using namespace System;
                Diagnostic(ErrorCode.ERR_IdentifierExpectedKW, "namespace")
...
";
            CreateCompilation(test)
                .VerifyDiagnostics(
                    ...
                    //         int[2] myarray;
                    Diagnostic(ErrorCode.WRN_UnreferencedVar, "myarray")
                        .WithArguments("myarray")
                        .WithLocation(7, 16),
                    // (8,9): error CS0119: 'MyClass' is a type, which is not valid in the given context
                    //         MyClass[0] m;
                    Diagnostic(ErrorCode.ERR_BadSKunknown, "MyClass")
                        .WithArguments("MyClass", "type")
                        .WithLocation(8, 9),
                    ...
                    //     static int[2] myarray;
                    Diagnostic(ErrorCode.WRN_UnreferencedField, "myarray")
                        .WithArguments("MyClass.myarray")
                        .WithLocation(14, 19),
                    ...
                    //     static MyClass[0] m;
                    Diagnostic(ErrorCode.WRN_UnassignedInternalField, "m")
                        .WithArguments("MyClass.m", "null")
                        .WithLocation(15, 23),
                    ...
                    //     static double[14,5,6] d;
                    Diagnostic(ErrorCode.WRN_UnreferencedField, "d")
                        .WithArguments("MyClass.d")
                        .WithLocation(17, 27),
    ...
    internal override abstract void M4<T>() where T : struct;
            ...
            CreateCompilation(source)
                .VerifyDiagnostics(
                    ...
                    //     internal override abstract void M4<T>() where T : struct;
                    Diagnostic(ErrorCode.ERR_OverrideNotExpected, "M4")
                        .WithArguments("B.M4<T>()")
                        .WithLocation(19, 37)
                );
        }
...
";
            ...
            CreateCompilation(test)
                .VerifyDiagnostics(
                    ...
                    //         static cly() : base(0){} // sc0514
                    Diagnostic(ErrorCode.ERR_StaticConstructorWithExplicitConstructorCall, "base")
                        .WithArguments("cly")
                        .WithLocation(12, 24),
                    // (8,18): error CS7036: There is no argument given that corresponds to the required parameter 'i' of 'clx.clx(int)'
                    //     public class @cly : clx
                    Diagnostic(ErrorCode.ERR_NoCorrespondingArgument, "@cly")
                        .WithArguments("i", "x.clx.clx(int)")
                        .WithLocation(8, 18)
                );
        }
...
";
            ...
            CreateCompilation(test)
                .VerifyDiagnostics(
                    ...
                    //     static C() : this() { } //CS0514
                    Diagnostic(ErrorCode.ERR_StaticConstructorWithExplicitConstructorCall, "this")
                        .WithArguments("C")
                        .WithLocation(5, 18)
                );
        }
...
";
            CreateCompilation(test)
                .VerifyDiagnostics(
                    ...
                    //         MyClass m[0];
                    Diagnostic(ErrorCode.WRN_UnreferencedVar, "m")
                        .WithArguments("m")
                        .WithLocation(7, 17),
...
";
            CreateCompilation(test)
                .VerifyDiagnostics(
                    ...
                    //         var t = new { s.Length = 1 };
                    Diagnostic(ErrorCode.ERR_AssgReadonlyProp, "s.Length")
...
";
            ...
            CreateCompilation(test)
                .VerifyDiagnostics(
                    ...
                    //         int i;
                    Diagnostic(ErrorCode.WRN_UnreferencedField, "i")
                        .WithArguments("x.clx.i")
                        .WithLocation(5, 13)
                );
        }
    ...
    public int P { get; private private set; }
            ...
            CreateCompilation(test)
                .VerifyDiagnostics(
                    ...
                    //     public int P { get; private private set; }
                    Diagnostic(ErrorCode.ERR_DuplicateModifier, "private")
...
";
            ...
            CreateCompilation(test)
                .VerifyDiagnostics(
                    ...
                    //     public int this[int i] {
                    Diagnostic(ErrorCode.ERR_DuplicatePropertyAccessMods, "this")
                        .WithArguments("Container.this[int]")
                        .WithLocation(15, 16),
        ...
        public static int Main()
        {
            ...
            CreateCompilation(test)
                .VerifyDiagnostics(
                    ...
                    //     [Goo(a=5, b)]
                    Diagnostic(ErrorCode.ERR_BadCtorArgCount, "Goo(a=5, b)")
                        .WithArguments("x.GooAttribute", "1")
                        .WithLocation(9, 6)
                );
        }
        ...
        public void CS1022ERR_EOFExpected02()
        {
            ...
            CreateCompilation(
                ...
                .VerifyDiagnostics(
                    ...
                    //  > Roslyn.Utilities.dll!  Basic
                    Diagnostic(ErrorCode.ERR_NameNotInContext, "Roslyn")
                        .WithArguments("Roslyn")
                        .WithLocation(1, 4),
                    ...
                    //  > Roslyn.Utilities.dll!  Basic
                    Diagnostic(ErrorCode.ERR_SingleTypeNameNotFound, "Basic")
                        .WithArguments("Basic")
                        .WithLocation(1, 27),
...
";
            CreateCompilation(test)
                .VerifyDiagnostics(
                    ...
                    //         for (int i=0; i < 3; i++) void j() { }
                    Diagnostic(ErrorCode.WRN_UnreferencedLocalFunction, "j")
                        .WithArguments("j")
                        .WithLocation(6, 40)
                );
        }
...
";
            ...
            ParseAndValidate(
                test,
                Diagnostic(ErrorCode.ERR_ErrorDirective, "(12345)").WithArguments("(12345)")
            );
        }
...
";
            ...
            CreateCompilationWithMscorlib46(text, parseOptions: TestOptions.Regular8)
                .VerifyDiagnostics(
...
";
            CreateCompilationWithMscorlib46(
                ...
                .VerifyDiagnostics(
                    ...
                    //             var e = new ();
                    Diagnostic(ErrorCode.ERR_FeatureNotAvailableInVersion6, "new")
                        .WithArguments("target-typed object creation", "9.0")
                        .WithLocation(7, 21),
                    // (7,21): error CS8754: There is no target type for 'new()'
                    //             var e = new ();
    ...
    static void M()
    {
        D d = (this object o) => null;
            ...
            ParseAndValidate(
                ...
                //         D d = (this object o) => null;
                Diagnostic(ErrorCode.ERR_SyntaxError, "this")
                    .WithArguments("=>")
                    .WithLocation(6, 16),
...
";
            ...
            CreateCompilation(test)
                .VerifyDiagnostics(
                    ...
                    //         const string message = "the parameter is obsolete";
                    Diagnostic(ErrorCode.WRN_UnreferencedVarAssg, "message")
...
";
            ...
            CreateCompilationWithMscorlib40AndSystemCore(test)
                ...
                .Verify(
                    ...
                    //     public static void M4(in this in int i) {}
                    Diagnostic(ErrorCode.ERR_DupParamMod, "in")
                        .WithArguments("in")
                        .WithLocation(7, 35),
                    // (5,36): error CS8328:  The parameter modifier 'in' cannot be used with 'ref'
                    //     public static void M2(ref this in int i) {}
                    Diagnostic(ErrorCode.ERR_BadParameterModifiers, "in")
                        .WithArguments("in", "ref")
                        .WithLocation(5, 36),
                    // (6,35): error CS8328:  The parameter modifier 'ref' cannot be used with 'in'
                    //     public static void M3(in this ref int i) {}
                    Diagnostic(ErrorCode.ERR_BadParameterModifiers, "ref")
                        .WithArguments("ref", "in")
                        .WithLocation(6, 35),
                    // (4,36): error CS1107: A parameter can only have one 'ref' modifier
                    //     public static void M1(ref this ref int i) {}
                    Diagnostic(ErrorCode.ERR_DupParamMod, "ref")
                        .WithArguments("ref")
                        .WithLocation(4, 36)
                );
        }
...
";
            CreateCompilationWithMscorlib40AndSystemCore(test)
                ...
                .Verify(
                    ...
                    //     public static void Goo(int this) {}
                    Diagnostic(ErrorCode.ERR_BadThisParam, "this")
                        .WithArguments("Goo")
                        .WithLocation(10, 32),
                    ...
                    //     public static void Goo(this this t) {}
                    Diagnostic(ErrorCode.ERR_DupParamMod, "this")
                        .WithArguments("this")
                        .WithLocation(6, 33),
                    ...
                    //     public static void Goo(this t) {}
                    Diagnostic(ErrorCode.ERR_MemberAlreadyExists, "Goo")
                        .WithArguments("Goo", "Extensions")
                        .WithLocation(9, 24),
...
";
            ...
            CreateCompilationWithMscorlib40AndSystemCore(test)
                ...
                .Verify(
                    ...
                    //     public static void Test2(out out int i) {}
                    Diagnostic(ErrorCode.ERR_DupParamMod, "out")
                        .WithArguments("out")
                        .WithLocation(5, 34),
                    ...
                    //     public static void Test4(params params int[] i) {}
                    Diagnostic(ErrorCode.ERR_DupParamMod, "params")
...
";
            ...
            CreateCompilationWithMscorlib40AndSystemCore(test)
                ...
                .Verify(
                    ...
                    // public static void Method2(params in int[] i) { }
                    Diagnostic(ErrorCode.ERR_ParamsCantBeWithModifier, "in")
                        .WithArguments("in")
                        .WithLocation(6, 35),
                    // (9,34): error CS8328:  The parameter modifier 'params' cannot be used with 'in'
                    // public static void Method3<T>(in params int[] i) { }
                    Diagnostic(ErrorCode.ERR_BadParameterModifiers, "params")
                        .WithArguments("params", "in")
                        .WithLocation(9, 34),
...
";
            ...
            CreateCompilation(test)
                ...
                .Verify(
                    ...
                    // class Test3 : Test1*    // CS1521
                    Diagnostic(ErrorCode.ERR_NonInterfaceInInterfaceList, "Test1*")
                        .WithArguments("Test1*")
                        .WithLocation(6, 15),
...
";
            ParseAndValidate(
                test,
                Diagnostic(ErrorCode.ERR_InvalidExprTerm, "from").WithArguments("]")
            );
        }
...
";
            ParseAndValidate(
                ...
                //         int s = 1>2 ? return 0: return 1; 	// Invalid
                Diagnostic(ErrorCode.ERR_InvalidExprTerm, "return")
...
";
            ParseAndValidate(
                ...
                //         int s = true ? goto lab1: goto lab2; // Invalid
                Diagnostic(ErrorCode.ERR_InvalidExprTerm, "goto")
                    .WithArguments("goto")
                    .WithLocation(5, 24),
                // (5,24): error CS1003: Syntax error, ':' expected
                //         int s = true ? goto lab1: goto lab2; // Invalid
                Diagnostic(ErrorCode.ERR_SyntaxError, "goto")
                    .WithArguments(":")
                    .WithLocation(5, 24),
                // (5,24): error CS1525: Invalid expression term 'goto'
                //         int s = true ? goto lab1: goto lab2; // Invalid
...
";
            CreateCompilation(test, parseOptions: TestOptions.Regular6)
                .VerifyDiagnostics(
                    ...
                    // class goo {
                    Diagnostic(ErrorCode.WRN_LowerCaseTypeName, "goo")
                        .WithArguments("goo")
                        .WithLocation(2, 7),
                    // (3,19): error CS1553: Declaration is not valid; use '+ operator <dest-type> (...' instead
                    //     public static int implicit operator (goo f) { return 6; }    // Error
                    ...
                    //     public static int implicit operator (goo f) { return 6; }    // Error
                    Diagnostic(ErrorCode.ERR_ConcreteMissingBody, "")
                        .WithArguments("goo.operator +((goo f, ?))")
                        .WithLocation(3, 23),
                    ...
                    //     public static int implicit operator (goo f) { return 6; }    // Error
                    Diagnostic(ErrorCode.ERR_FeatureNotAvailableInVersion6, "(goo f)")
                        .WithArguments("tuples", "7.0")
                        .WithLocation(3, 41),
                    // (3,47): error CS8124: Tuple must contain at least two elements.
                    //     public static int implicit operator (goo f) { return 6; }    // Error
...
";
            // Extra errors
            CreateCompilation(test, options: TestOptions.UnsafeDebugDll)
                .VerifyDiagnostics(
...
";
            CreateCompilation(test, options: TestOptions.UnsafeDebugDll)
                .VerifyDiagnostics(
                    ...
                    //     int* p = stackalloc int[1];
                    Diagnostic(ErrorCode.ERR_PredefinedTypeNotFound, "stackalloc int[1]")
...
";
            CreateCompilation(test, options: TestOptions.UnsafeDebugDll)
                .VerifyDiagnostics(
                    ...
                    //         const int* p = stackalloc int[1];
                    Diagnostic(ErrorCode.ERR_BadConstType, "int*")
                        .WithArguments("int*")
                        .WithLocation(6, 15)
                );
        }
...
";
            CreateCompilationWithMscorlibAndSpan(
                    test,
                    options: TestOptions.ReleaseDll.WithAllowUnsafe(true)
                )
                .VerifyDiagnostics(
                    // (6,16): error CS1674: 'Span<int>': type used in a using statement must be implicitly convertible to 'System.IDisposable'
                    //         using (var v = stackalloc int[1])
                    Diagnostic(ErrorCode.ERR_NoConvToIDisp, "var v = stackalloc int[1]")
...
";
            CreateCompilation(test, options: TestOptions.ReleaseDll.WithAllowUnsafe(true))
                .VerifyDiagnostics(
...
";
            ...
            CreateCompilationWithMscorlib40AndSystemCore(test)
                ...
                .Verify(
                    ...
                    //     public static void ParamsWithRef(params ref int[] a)
                    Diagnostic(ErrorCode.ERR_ParamsCantBeWithModifier, "ref")
                        .WithArguments("ref")
                        .WithLocation(4, 45),
                    // (7,45): error CS1611: The params parameter cannot be declared as out
                    //     public static void ParamsWithOut(params out int[] a)
                    Diagnostic(ErrorCode.ERR_ParamsCantBeWithModifier, "out")
                        .WithArguments("out")
                        .WithLocation(7, 45)
                );
        }
...
";
            ...
            ParseAndValidate(
                test,
                Diagnostic(ErrorCode.ERR_FixedDimsRequired, "ia"),
                Diagnostic(ErrorCode.ERR_ValueExpected, "]")
            );
        }
...
";
            ...
            CreateCompilation(test)
                .VerifyDiagnostics(
                    ...
                    //             N1.global::Test.M1();
                    Diagnostic(ErrorCode.ERR_DottedTypeNameNotFoundInNS, "N1.global")
                        .WithArguments("global", "N1")
                        .WithLocation(12, 13),
                    // (2,1): hidden CS8019: Unnecessary using directive.
                    // using N1Alias = N1;
...
";
            ...
            tree = SyntaxFactory.ParseSyntaxTree(
                text,
                options: CSharpParseOptions.Default.WithLanguageVersion(LanguageVersion.CSharp1)
            );
            tree.GetCompilationUnitRoot().GetDiagnostics().Verify();

            CreateCompilation(text, parseOptions: TestOptions.Regular5).VerifyDiagnostics();
            CreateCompilation(text, parseOptions: TestOptions.Regular1)
                .VerifyDiagnostics(
                    // (2,1): error CS8022: Feature 'partial types' is not available in C# 1. Please use language version 2 or greater.
                    // partial class C
                    Diagnostic(ErrorCode.ERR_FeatureNotAvailableInVersion1, "partial")
                        .WithArguments("partial types", "2")
                        .WithLocation(2, 1)
                );
        }
...
";
            ...
            tree = SyntaxFactory.ParseSyntaxTree(
                text,
                options: CSharpParseOptions.Default.WithLanguageVersion(LanguageVersion.CSharp2)
            );
            tree.GetCompilationUnitRoot().GetDiagnostics().Verify();
            ...
            CreateCompilation(text, parseOptions: TestOptions.Regular2)
                .VerifyDiagnostics(
                    // (4,5): error CS8023: Feature 'partial method' is not available in C# 2. Please use language version 3 or greater.
                    //     partial int Goo() { }
                    Diagnostic(ErrorCode.ERR_FeatureNotAvailableInVersion2, "partial")
                        .WithArguments("partial method", "3")
                        .WithLocation(4, 5),
                    // (4,17): error CS0759: No defining declaration found for implementing declaration of partial method 'C.Goo()'
                    //     partial int Goo() { }
                    Diagnostic(ErrorCode.ERR_PartialMethodMustHaveLatent, "Goo")
...
";
            ...
            CreateCompilation(text, parseOptions: TestOptions.Regular2)
                .VerifyDiagnostics(
                    ...
                    //         var q = from a in b
                    Diagnostic(ErrorCode.ERR_FeatureNotAvailableInVersion2, "from")
                        .WithArguments("query expression", "3")
                        .WithLocation(6, 17),
                    // (6,27): error CS0103: The name 'b' does not exist in the current context
                    //         var q = from a in b
                    Diagnostic(ErrorCode.ERR_NameNotInContext, "b")
...
";
            ...
            CreateCompilation(text, parseOptions: TestOptions.Regular2)
                .VerifyDiagnostics(
                    ...
                    //         var q = new { };
                    Diagnostic(ErrorCode.ERR_FeatureNotAvailableInVersion2, "new")
                        .WithArguments("anonymous types", "3")
                        .WithLocation(6, 17)
                );
        }
...
";
            ...
            CreateCompilation(text, parseOptions: TestOptions.Regular2)
                .VerifyDiagnostics(
                    ...
                    //         var q = new [] { };
                    Diagnostic(ErrorCode.ERR_FeatureNotAvailableInVersion2, "new")
                        .WithArguments("implicitly typed array", "3")
                        .WithLocation(6, 17),
                    // (6,17): error CS0826: No best type found for implicitly-typed array
                    //         var q = new [] { };
                    Diagnostic(ErrorCode.ERR_ImplicitlyTypedArrayNoBestType, "new [] { }")
...
";
            ...
            CreateCompilation(text, parseOptions: TestOptions.Regular2)
                .VerifyEmitDiagnostics(
                    ...
                    //         var q = new Goo { };
                    Diagnostic(ErrorCode.ERR_FeatureNotAvailableInVersion2, "{")
                        .WithArguments("object initializer", "3")
                        .WithLocation(6, 25)
                );
...
";
            CreateCompilation(text, parseOptions: TestOptions.Regular5)
                .VerifyDiagnostics(
                    ...
                    //         var q = a => b;
                    Diagnostic(ErrorCode.ERR_FeatureNotAvailableInVersion5, "a => b")
                        .WithArguments("inferred delegate type", "10.0")
                        .WithLocation(6, 17)
                );
            CreateCompilation(text, parseOptions: TestOptions.Regular2)
                .VerifyDiagnostics(
...
";
            ...
            CreateCompilation(text, parseOptions: TestOptions.Regular5)
                .VerifyDiagnostics(
                    ...
                    //         try { } catch when (true) {}
                    Diagnostic(ErrorCode.ERR_FeatureNotAvailableInVersion5, "when")
                        .WithArguments("exception filter", "6")
                        .WithLocation(6, 23),
                    // (6,29): warning CS7095: Filter expression is a constant 'true', consider removing the filter
                    //         try { } catch when (true) {}
                    Diagnostic(ErrorCode.WRN_FilterIsConstantTrue, "true").WithLocation(6, 29)
...
";
            ...
            CreateCompilation(test)
                .VerifyDiagnostics(
                    ...
                    // using global = MyClass;   // CS0440
                    Diagnostic(ErrorCode.WRN_LowerCaseTypeName, "global")
...
";
            ...
            CreateCompilation(test)
                .VerifyDiagnostics(
                    ...
                    //     public static int Main(bool b)
                    Diagnostic(ErrorCode.ERR_ReturnExpected, "Main")
                        .WithArguments("MyClass.Main(bool)")
                        .WithLocation(4, 23)
                );
        }
...
";
            ...
            ParseAndValidate(
                test,
                Diagnostic(ErrorCode.WRN_WarningDirective, "//This is a WARNING!")
                    .WithArguments("//This is a WARNING!")
            );
        }
...
";
            ...
            tree = SyntaxFactory.ParseSyntaxTree(
                text,
                options: CSharpParseOptions.Default.WithLanguageVersion(LanguageVersion.CSharp3)
            );
            tree.GetCompilationUnitRoot().GetDiagnostics().Verify();

            CreateCompilation(text, parseOptions: TestOptions.Regular3)
                .VerifyDiagnostics(
                    // (4,16): error CS8024: Feature 'async function' is not available in C# 3. Please use language version 5 or greater.
                    //     async void M() { }
                    Diagnostic(ErrorCode.ERR_FeatureNotAvailableInVersion3, "M")
                        .WithArguments("async function", "5")
                        .WithLocation(4, 16),
                    // (4,16): warning CS1998: This async method lacks 'await' operators and will run synchronously. Consider using the 'await' operator to await non-blocking API calls, or 'await Task.Run(...)' to do CPU-bound work on a background thread.
                    //     async void M() { }
                    Diagnostic(ErrorCode.WRN_AsyncLacksAwaits, "M").WithLocation(4, 16)
...
";
            ...
            CreateCompilation(text, parseOptions: TestOptions.Regular5)
                .VerifyDiagnostics(
                    ...
                    //         Func<int, Task<int>> f = async x => x;
                    Diagnostic(ErrorCode.ERR_SingleTypeNameNotFound, "Func<int, Task<int>>")
                        .WithArguments("Func<,>")
                        .WithLocation(6, 9),
                    ...
                    //         Func<int, Task<int>> f = async x => x;
                    Diagnostic(ErrorCode.ERR_SingleTypeNameNotFound, "Task<int>")
                        .WithArguments("Task<>")
                        .WithLocation(6, 19),
            ...
            tree = SyntaxFactory.ParseSyntaxTree(
                text,
                options: CSharpParseOptions.Default.WithLanguageVersion(LanguageVersion.CSharp4)
            );
            tree.GetCompilationUnitRoot().GetDiagnostics().Verify();
            CreateCompilation(text, parseOptions: TestOptions.Regular4)
                .VerifyDiagnostics(
                    // (6,9): error CS0246: The type or namespace name 'Func<,>' could not be found (are you missing a using directive or an assembly reference?)
                    //         Func<int, Task<int>> f = async x => x;
                    Diagnostic(ErrorCode.ERR_SingleTypeNameNotFound, "Func<int, Task<int>>")
                    ...
                    //         Func<int, Task<int>> f = async x => x;
                    Diagnostic(ErrorCode.ERR_FeatureNotAvailableInVersion4, "async")
                        .WithArguments("async function", "5")
                        .WithLocation(6, 34),
                    // (6,42): warning CS1998: This async method lacks 'await' operators and will run synchronously. Consider using the 'await' operator to await non-blocking API calls, or 'await Task.Run(...)' to do CPU-bound work on a background thread.
                    //         Func<int, Task<int>> f = async x => x;
...
";
            CreateCompilation(text, parseOptions: TestOptions.Regular4)
                .VerifyDiagnostics(
                    ...
                    // [Attr(x:1)]
                    Diagnostic(ErrorCode.ERR_SingleTypeNameNotFound, "Attr")
                        .WithArguments("AttrAttribute")
                        .WithLocation(2, 2),
            ...
            CreateCompilation(text, parseOptions: TestOptions.Regular3)
                .VerifyDiagnostics(
                    ...
                    // [Attr(x:1)]
                    Diagnostic(ErrorCode.ERR_FeatureNotAvailableInVersion3, "x:")
                        .WithArguments("named argument", "4")
                        .WithLocation(2, 7),
                    // (7,9): error CS0103: The name 'M' does not exist in the current context
                    //         M(y:2);
                    Diagnostic(ErrorCode.ERR_NameNotInContext, "M")
                    ...
                    //         M(y:2);
                    Diagnostic(ErrorCode.ERR_FeatureNotAvailableInVersion3, "y:")
                        .WithArguments("named argument", "4")
                        .WithLocation(7, 11)
                );
...
";
            ...
            CreateCompilation(text, parseOptions: TestOptions.Regular2)
                .VerifyDiagnostics(
                    ...
                    // class C : global::B
                    Diagnostic(ErrorCode.ERR_GlobalSingleTypeNameNotFound, "B")
                        .WithArguments("B")
                        .WithLocation(2, 19)
                );
            CreateCompilation(text, parseOptions: TestOptions.Regular1)
                .VerifyDiagnostics(
                    ...
                    // class C : global::B
                    Diagnostic(ErrorCode.ERR_FeatureNotAvailableInVersion1, "global")
                        .WithArguments("namespace alias qualifier", "2")
                        .WithLocation(2, 11),
                    // (2,19): error CS0400: The type or namespace name 'B' could not be found in the global namespace (are you missing an assembly reference?)
                    // class C : global::B
                    Diagnostic(ErrorCode.ERR_GlobalSingleTypeNameNotFound, "B")
...
";
            ...
            CreateCompilation(text, parseOptions: TestOptions.Regular2)
                .VerifyDiagnostics(
                    ...
                    // class C : A::B
                    Diagnostic(ErrorCode.ERR_AliasNotFound, "A")
                        .WithArguments("A")
                        .WithLocation(2, 11)
                );
            CreateCompilation(text, parseOptions: TestOptions.Regular1)
                .VerifyDiagnostics(
                    // (2,11): error CS8022: Feature 'namespace alias qualifier' is not available in C# 1. Please use language version 2 or greater.
                    // class C : A::B
                    Diagnostic(ErrorCode.ERR_FeatureNotAvailableInVersion1, "A")
                        .WithArguments("namespace alias qualifier", "2")
                        .WithLocation(2, 11),
                    // (2,11): error CS0432: Alias 'A' not found
                    // class C : A::B
...
";
            ...
            CreateCompilation(text, parseOptions: TestOptions.Regular3)
                .VerifyDiagnostics(
                    ...
                    //     void M(int x = 1) { }
                    Diagnostic(ErrorCode.ERR_FeatureNotAvailableInVersion3, "=")
                        .WithArguments("optional parameter", "4")
                        .WithLocation(4, 18)
                );
...
";
            CreateCompilation(text, parseOptions: TestOptions.Regular3)
                .VerifyEmitDiagnostics(
                    ...
                    //         return new C { Goo = 1 };
                    Diagnostic(ErrorCode.ERR_NoSuchMember, "Goo")
                        .WithArguments("C", "Goo")
                        .WithLocation(6, 24)
                );
            CreateCompilation(text, parseOptions: TestOptions.Regular2)
...
";
            CreateCompilation(text, parseOptions: TestOptions.Regular3)
                .VerifyEmitDiagnostics(
                    ...
                    //         return new C { 1, 2, 3 };
                    Diagnostic(ErrorCode.ERR_CollectionInitRequiresIEnumerable, "{ 1, 2, 3 }")
                        .WithArguments("C")
                        .WithLocation(6, 22)
                );
            CreateCompilation(text, parseOptions: TestOptions.Regular2)
                .VerifyEmitDiagnostics(
                    ...
                    //         return new C { 1, 2, 3 };
                    Diagnostic(ErrorCode.ERR_FeatureNotAvailableInVersion2, "{")
                        .WithArguments("collection initializer", "3")
                        .WithLocation(6, 22),
                    // (6,22): error CS1922: Cannot initialize type 'C' with a collection initializer because it does not implement 'System.Collections.IEnumerable'
                    //         return new C { 1, 2, 3 };
                    Diagnostic(ErrorCode.ERR_CollectionInitRequiresIEnumerable, "{ 1, 2, 3 }")
            ...
            SyntaxFactory
                ...
                .Verify(
                    ...
                    Diagnostic(ErrorCode.WRN_ErrorOverride, "{")
                        .WithArguments(
                            "Feature 'generics' is not available in C# 1. Please use language version 2 or greater.",
                            "8022"
                        )
                );
        }
...
";
            ...
            SyntaxFactory
                ...
                .Verify(
                    ...
                    // /// <see cref='Alias::Goo'/>
                    Diagnostic(ErrorCode.WRN_BadXMLRefSyntax, "Alias::Goo")
                        .WithArguments("Alias::Goo"),
                    ...
                    // /// <see cref='Alias::Goo'/>
                    Diagnostic(ErrorCode.WRN_ErrorOverride, "Alias")
                        .WithArguments(
                            "Feature 'namespace alias qualifier' is not available in C# 1. Please use language version 2 or greater.",
                            "8022"
                        ),
                    // (3,16): warning CS1584: XML comment has syntactically incorrect cref attribute 'global::Goo'
                    // /// <see cref='global::Goo'/>
                    Diagnostic(ErrorCode.WRN_BadXMLRefSyntax, "global::Goo")
                        .WithArguments("global::Goo"),
                    ...
                    // /// <see cref='global::Goo'/>
                    Diagnostic(ErrorCode.WRN_ErrorOverride, "global")
                        .WithArguments(
                            "Feature 'namespace alias qualifier' is not available in C# 1. Please use language version 2 or greater.",
                            "8022"
                        )
...
";
            ...
            SyntaxFactory
                ...
                .Verify(
                    ...
                    // #pragma warning disable 1584
                    Diagnostic(ErrorCode.ERR_FeatureNotAvailableInVersion1, "pragma")
                        .WithArguments("#pragma", "2"),
...
";
        ...
        public void WRN_NonECMAFeature()
        {
            ...
            CreateCompilation(source, parseOptions: TestOptions.Regular2)
                .VerifyDiagnostics(
                    ...
                    // [module:Obsolete()]
                    Diagnostic(ErrorCode.ERR_SingleTypeNameNotFound, "Obsolete")
                        .WithArguments("ObsoleteAttribute")
                        .WithLocation(1, 9),
            ...
            CreateCompilation(source, parseOptions: TestOptions.Regular1)
                .VerifyDiagnostics(
                    ...
                    // [module:Obsolete()]
                    Diagnostic(ErrorCode.WRN_NonECMAFeature, "module:")
                        .WithArguments("IDS_FeatureModuleAttrLoc")
                        .WithLocation(1, 2),
                    // (1,9): error CS0246: The type or namespace name 'ObsoleteAttribute' could not be found (are you missing a using directive or an assembly reference?)
                    // [module:Obsolete()]
                    Diagnostic(ErrorCode.ERR_SingleTypeNameNotFound, "Obsolete")
        ...
        var x = $""hello world"";
            ...
            CreateCompilation(source, parseOptions: TestOptions.Regular6)
                .VerifyDiagnostics(
                    ...
                    //         } catch (Exception ex) when (ex.ToString() == null) { // exception filter
                    Diagnostic(ErrorCode.ERR_SingleTypeNameNotFound, "Exception")
                        .WithArguments("Exception")
                        .WithLocation(18, 18)
                );
            CreateCompilation(source, parseOptions: TestOptions.Regular5)
                .VerifyDiagnostics(
                    ...
                    //     int L { get; } = 12; // auto property initializer
                    Diagnostic(ErrorCode.ERR_FeatureNotAvailableInVersion5, "L")
                    ...
                    //         var x = $"hello world";
                    Diagnostic(ErrorCode.ERR_FeatureNotAvailableInVersion5, @"$""hello world""")
