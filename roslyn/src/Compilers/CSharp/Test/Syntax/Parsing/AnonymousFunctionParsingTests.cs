    ...
    void M1()
    {
        ...
        public void StaticLambdaRankSpecifier()
        {
            ...
            CreateCompilation(testInMethod)
                .VerifyDiagnostics(
                    ...
                    Diagnostic(ErrorCode.ERR_AnonMethToNonDel, "static x => x")
        ...
        public void StaticAnonymousFunctionRankSpecifier()
        {
            ...
            CreateCompilation(testInMethod)
                .VerifyDiagnostics(
                    ...
                    Diagnostic(ErrorCode.ERR_AnonMethToNonDel, "static delegate(int x) { }")
        ...
        public void StaticLambdaFunctionPointer()
        {
            ...
            UsingStatement(
                ...
                Diagnostic(ErrorCode.ERR_UnexpectedToken, "delegate*<void> ptr = &static (")
                    .WithArguments(")")
                    .WithLocation(1, 1),
