...
{{                                                                    \
    public A Get\(\) =\> default\;                                    \
            ...
            Assert.Equal(
                name.Replace(".dll", ", Version=0.0.0.0, Culture=neutral, PublicKeyToken=null"),
...
"
        ...
        [ConditionalFact(
            typeof(WindowsDesktopOnly),
            Reason = "https://github.com/dotnet/roslyn/issues/55730"
        )]
        public void ReservedDeviceNameAsFileName()
        {
            ...
            parsedArgs = DefaultParse(
                new[] { "a.cs", "/t:library ", "/appconfig:.\\aux.config" },
                WorkingDirectory
            );
            Assert.Equal(1, parsedArgs.Errors.Length);
