...
";
        ...
        public void ReportAnalyzerOutput()
        {
            ...
            Assert.Contains(
                "WarningDiagnosticAnalyzer (Warning01)",
                output,
                StringComparison.Ordinal
            );
            CleanupAllGeneratedFiles(srcFile.Path);
...
"
        ...
        public void AnalyzerDiagnosticThrowsInGetMessage()
        {
            ...
            var csc = CreateCSharpCompiler(
                ...
                analyzers: ImmutableArray.Create<DiagnosticAnalyzer>(
                    new AnalyzerThatThrowsInGetMessage()
                )
            );
        ...
        public void AnalyzerReportsMisformattedDiagnostic()
        {
            ...
            var csc = CreateCSharpCompiler(
                ...
                new[] { "/t:library", srcFile.Path },
                analyzers: ImmutableArray.Create<DiagnosticAnalyzer>(
                    new AnalyzerReportingMisformattedDiagnostic()
                )
            );
...
class C
{
        ...
        )
        {
            ...
            var csc = CreateCSharpCompiler(
                ...
                generators: generators.ToImmutableArrayOrEmpty(),
    ...
    public struct ValueTuple<T1>
    {
        ...
        public ValueTuple(T1 item1)
        {
            ...
            var csc = CreateCSharpCompiler(
                ...
                analyzers: ImmutableArray.Create<DiagnosticAnalyzer>(new FieldAnalyzer())
