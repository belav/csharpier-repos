...
";
            ...
            DiagnosticDescription[] errors =
            {
                ...
                //     class C5 : CL3_I1, I1<CL3_I1>
                Diagnostic(ErrorCode.ERR_NoTypeDef, "C5")
                    .WithArguments(
                        "CL2_I1",
                        "CL2, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null"
                    )
                    .WithLocation(140, 11),
                ...
                //     class C2 : CL3_C1
                Diagnostic(ErrorCode.ERR_NoTypeDef, "CL3_C1")
                    .WithArguments(
                        "CL2_C1",
                        "CL2, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null"
                    )
                ...
                //     class C4 : CL3_S1
                Diagnostic(ErrorCode.ERR_CantDeriveFromSealedType, "CL3_S1")
                    .WithArguments("Module1.C4", "CL3_S1")
                    .WithLocation(133, 16),
                ...
                //     interface I2 : CL3_I1, I1<CL3_I1>
                Diagnostic(ErrorCode.ERR_NoTypeDef, "I2")
                    .WithArguments(
                        "CL2_I1",
                        "CL2, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null"
                    )
                ...
                //         CL3_C1.Test1();
                Diagnostic(ErrorCode.ERR_NoTypeDef, "Test1")
                    .WithArguments(
                        "CL2_C1",
                        "CL2, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null"
                    )
                ...
                //         object z = y.x;
                Diagnostic(ErrorCode.ERR_NoTypeDef, "x")
                    .WithArguments(
                        "CL2_C1",
                        "CL2, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null"
                    )
                ...
                //         CL3_C2.Test1();
                Diagnostic(ErrorCode.ERR_NoTypeDef, "CL3_C2.Test1")
                    .WithArguments(
                        "CL2_C1",
                        "CL2, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null"
                    )
                ...
                //         CL3_C2.Test1(1);
                Diagnostic(ErrorCode.ERR_ObjectRequired, "CL3_C2.Test1")
                    .WithArguments("CL3_C2.Test1(int)")
                    .WithLocation(156, 9),
                ...
                //         CL3_C2.Test3();
                Diagnostic(ErrorCode.ERR_NoTypeDef, "CL3_C2.Test3")
                    .WithArguments(
                        "CL2_C1",
                        "CL2, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null"
                    )
                ...
                //         CL3_C2.Test4();
                Diagnostic(ErrorCode.ERR_BadArgCount, "Test4")
                    .WithArguments("Test4", "0")
                    .WithLocation(166, 16),
                ...
                //         CL3_C2.Test4(null);
                Diagnostic(ErrorCode.ERR_NoTypeDef, "CL3_C2.Test4")
                    .WithArguments(
                        "CL2_C1",
                        "CL2, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null"
                    )
                ...
                //         CL3_C2.Test4(null);
                Diagnostic(ErrorCode.ERR_AmbigCall, "Test4")
                    .WithArguments("CL3_C2.Test4(CL3_C1)", "CL3_C2.Test4(CL3_C3)")
                    .WithLocation(171, 16),
                ...
                //         y.Test1();
                Diagnostic(ErrorCode.ERR_NoTypeDef, "y.Test1")
                    .WithArguments(
                        "CL2_C1",
                        "CL2, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null"
                    )
                ...
                //         CL3_D1 d1 = y.Test2;
                Diagnostic(ErrorCode.ERR_NoTypeDef, "Test2")
                    .WithArguments(
                        "CL2_C1",
                        "CL2, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null"
                    )
                ...
                //         y.w(null);
                Diagnostic(ErrorCode.ERR_NoTypeDef, "y.w(null)")
                    .WithArguments(
                        "CL2_C1",
                        "CL2, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null"
                    )
                ...
                //         CL3_D1 u = (uuu) => System.Console.WriteLine();
                Diagnostic(ErrorCode.ERR_NoTypeDef, "(uuu) => System.Console.WriteLine()")
                    .WithArguments(
                        "CL2_C1",
                        "CL2, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null"
                    )
                ...
                //     private CL3_C1 f1;
                Diagnostic(ErrorCode.WRN_UnassignedInternalField, "f1")
                    .WithArguments("Module1.f1", "null")
                    .WithLocation(5, 20)
            };
...
";
            ...
            var compilation3 = CreateCompilation(
                a_cs,
                new MetadataReference[] { new CSharpCompilationReference(cl3Compilation) }
            );
            ...
            var compilation4 = CreateCompilation(
                a_cs,
                new MetadataReference[] { new CSharpCompilationReference(cl3BadCompilation1) }
            );
            ...
            DiagnosticDescription[] errors2 =
            {
                ...
                //     class C5 : CL3_I1, I1<CL3_I1>
                Diagnostic(ErrorCode.ERR_SingleTypeNameNotFound, "C5")
                ...
                //     class C2 : CL3_C1
                Diagnostic(ErrorCode.ERR_SingleTypeNameNotFound, "CL3_C1")
                ...
                //     interface I2 : CL3_I1, I1<CL3_I1>
                Diagnostic(ErrorCode.ERR_SingleTypeNameNotFound, "I2")
                    .WithArguments("CL2_I1")
                    .WithLocation(137, 15),
                // (9,16): warning CS0219: The variable 'x1' is assigned but its value is never used
                //         CL3_C1 x1;
                ...
                //         CL3_C1.Test1();
                Diagnostic(ErrorCode.ERR_SingleTypeNameNotFound, "Test1")
                    .WithArguments("CL2_C1")
                    .WithLocation(27, 16),
                ...
                //         CL3_C2.Test1();
                Diagnostic(ErrorCode.ERR_SingleTypeNameNotFound, "CL3_C2.Test1")
                    .WithArguments("CL2_C1")
                    .WithLocation(151, 9),
                ...
                //         CL3_C2.Test3();
                Diagnostic(ErrorCode.ERR_SingleTypeNameNotFound, "CL3_C2.Test3")
                    .WithArguments("CL2_C1")
                    .WithLocation(161, 9),
                // (166,16): error CS1501: No overload for method 'Test4' takes 0 arguments
                //         CL3_C2.Test4();
                ...
                //         CL3_C2.Test4(null);
                Diagnostic(ErrorCode.ERR_SingleTypeNameNotFound, "CL3_C2.Test4")
                    .WithArguments("CL2_C1")
                    .WithLocation(171, 9),
                ...
                //         y.Test1();
                Diagnostic(ErrorCode.ERR_SingleTypeNameNotFound, "y.Test1")
                    .WithArguments("CL2_C1")
                    .WithLocation(177, 9),
                ...
                //         CL3_D1 d1 = y.Test2;
                Diagnostic(ErrorCode.ERR_SingleTypeNameNotFound, "Test2")
                    .WithArguments("CL2_C1")
                    .WithLocation(195, 23),
                ...
                //         y.w(null);
                Diagnostic(ErrorCode.ERR_SingleTypeNameNotFound, "y.w(null)")
                    .WithArguments("CL2_C1")
                    .WithLocation(207, 9),
            ...
            var compilation5 = CreateCompilation(
                a_cs,
                new MetadataReference[] { new CSharpCompilationReference(cl3BadCompilation2) }
            );
            ...
            DiagnosticDescription[] errors5 =
            {
                ...
                //         y.Test1();
                Diagnostic(ErrorCode.ERR_ObjectProhibited, "y.Test1")
                    .WithArguments("CL3_C2.Test1()")
                    .WithLocation(177, 9),
                // (195,23): error CS0123: No overload for 'Test2' matches delegate 'CL3_D1'
                //         CL3_D1 d1 = y.Test2;
                Diagnostic(ErrorCode.ERR_MethDelegateMismatch, "Test2")
                    .WithArguments("Test2", "CL3_D1")
                    .WithLocation(195, 23),
                // (5,20): warning CS0649: Field 'Module1.f1' is never assigned to, and will always have its default value null
                //     private CL3_C1 f1;
                Diagnostic(ErrorCode.WRN_UnassignedInternalField, "f1")
...
";
            ...
            // Scenario 1: Projects 1, 2, and 3 are in source; project 3 does not reference lib.
            {
                var comp3 = CreateEmptyCompilation(
                    project3Source,
                    new[] { MscorlibRef, comp1.ToMetadataReference(), comp2.ToMetadataReference() },
                ...
                comp3.VerifyDiagnostics(
                    ...
                    Diagnostic(ErrorCode.ERR_NoTypeDef, "D")
                        .WithArguments(
                            ...
                            "System.Drawing, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null"
                        )
                );
            }
    ...
    class Test6
    {
        ...
        {}
            ...
            DiagnosticDescription[] expectedErrors =
            {
                ...
                //     public class C12
                Diagnostic(ErrorCode.ERR_GenericConstraintNotSatisfiedRefType, "C12")
                    .WithArguments(
                        "ErrorTest.C10<T>",
                        "ErrorTest.I1<ErrorTest.I2>",
                        "T",
                        "ErrorTest.I5"
                    ),
                ...
                //     public class C12
                Diagnostic(ErrorCode.ERR_NoTypeDef, "C12")
                    .WithArguments(
                        "ErrorTest.I3",
                        "MissingTypeInTypeArgumentsOfImplementedInterface2, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null"
                    ),
                ...
                //     public class C9
                Diagnostic(ErrorCode.ERR_GenericConstraintNotSatisfiedRefType, "C9")
                    .WithArguments(
                        "ErrorTest.C8<T>",
                        "ErrorTest.I6<ErrorTest.I3>",
                        "T",
                        "ErrorTest.I6<ErrorTest.I2>"
                    ),
                ...
                //     public class C9
                Diagnostic(ErrorCode.ERR_NoTypeDef, "C9")
                    .WithArguments(
                        "ErrorTest.I3",
                        "MissingTypeInTypeArgumentsOfImplementedInterface2, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null"
                    ),
                ...
                //     public class C11
                Diagnostic(ErrorCode.ERR_GenericConstraintNotSatisfiedRefType, "C11")
                    .WithArguments(
                        "ErrorTest.C10<T>",
                        "ErrorTest.I1<ErrorTest.I2>",
                        "T",
                ...
                //     public class C11
                Diagnostic(ErrorCode.ERR_NoTypeDef, "C11")
                    .WithArguments(
                        "ErrorTest.I3",
                        "MissingTypeInTypeArgumentsOfImplementedInterface2, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null"
                    ),
                ...
                //     public class C6
                Diagnostic(ErrorCode.ERR_NoTypeDef, "C6")
                    .WithArguments(
                        "ErrorTest.I3",
                        "MissingTypeInTypeArgumentsOfImplementedInterface2, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null"
                    ),
                ...
                //         void Test(C10<C4> x)
                Diagnostic(ErrorCode.ERR_GenericConstraintNotSatisfiedRefType, "x")
                    .WithArguments(
                        "ErrorTest.C10<T>",
                        "ErrorTest.I1<ErrorTest.I2>",
                        "T",
                ...
                //             I1<I2> x = y4;
                Diagnostic(ErrorCode.ERR_NoTypeDef, "y4")
                    .WithArguments(
                        "ErrorTest.I3",
                        "MissingTypeInTypeArgumentsOfImplementedInterface2, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null"
                    ),
                ...
                //             I1<I2> x = y4;
                Diagnostic(ErrorCode.ERR_NoImplicitConvCast, "y4")
                    .WithArguments("T", "ErrorTest.I1<ErrorTest.I2>"),
                ...
                //             I1<I2> x = y5;
                Diagnostic(ErrorCode.ERR_NoTypeDef, "y5")
                    .WithArguments(
                        "ErrorTest.I3",
                        "MissingTypeInTypeArgumentsOfImplementedInterface2, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null"
                    ),
                ...
                //             I1<I2> x = y5;
                Diagnostic(ErrorCode.ERR_NoImplicitConvCast, "y5")
                    .WithArguments("ErrorTest.I5", "ErrorTest.I1<ErrorTest.I2>"),
                ...
                //             I1<I2> x = y3;
                Diagnostic(ErrorCode.ERR_NoTypeDef, "y3")
                    .WithArguments(
                        "ErrorTest.I3",
                        "MissingTypeInTypeArgumentsOfImplementedInterface2, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null"
                    ),
                ...
                //             I1<I2> x = y3;
                Diagnostic(ErrorCode.ERR_NoImplicitConvCast, "y3")
                    .WithArguments("T", "ErrorTest.I1<ErrorTest.I2>"),
                ...
                //             I1<I2> x = y;
                Diagnostic(ErrorCode.ERR_NoTypeDef, "y")
                    .WithArguments(
                        "ErrorTest.I3",
                        "MissingTypeInTypeArgumentsOfImplementedInterface2, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null"
                    ),
                ...
                //             I1<I2> x = y;
                Diagnostic(ErrorCode.ERR_NoImplicitConvCast, "y")
                    .WithArguments("ErrorTest.C4", "ErrorTest.I1<ErrorTest.I2>")
            };

            lib4.VerifyDiagnostics(expectedErrors);

            lib4 = CreateCompilation(
                lib4Def,
                new[] { lib1Ref, lib2Ref, lib3Ref },
                TestOptions.ReleaseDll
            );
            ...
            lib4 = CreateCompilation(
                lib4Def,
                new[] { lib1.EmitToImageReference(), lib3.EmitToImageReference() },
                TestOptions.ReleaseDll
            );
...
";
            ...
            lib4.VerifyDiagnostics(
                ...
                //     public class C8 : I5
                Diagnostic(ErrorCode.ERR_NoTypeDef, "C8")
                    .WithArguments(
                        "ErrorTest.I2",
                        "MissingImplementedInterface2, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null"
                    ),
                ...
                Diagnostic(ErrorCode.ERR_ClassDoesntImplementInterface, "I1")
                    .WithArguments("ErrorTest.C8.ErrorTest.I1.M1()", "ErrorTest.I1"),
                // (14,14): error CS0540: 'ErrorTest.C6.ErrorTest.I1.M1()': containing type does not implement interface 'ErrorTest.I1'
                //         void I1.M1()
                Diagnostic(ErrorCode.ERR_ClassDoesntImplementInterface, "I1")
                    .WithArguments("ErrorTest.C6.ErrorTest.I1.M1()", "ErrorTest.I1"),
                ...
                //     public class C10 : C9<C4>
                Diagnostic(ErrorCode.ERR_GenericConstraintNotSatisfiedRefType, "C10")
                    .WithArguments("ErrorTest.C9<T>", "ErrorTest.I1", "T", "ErrorTest.C4"),
                ...
                //     public class C10 : C9<C4>
                Diagnostic(ErrorCode.ERR_NoTypeDef, "C10")
                    .WithArguments(
                        "ErrorTest.I2",
                        "MissingImplementedInterface2, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null"
                    ),
                ...
                //     public class C11 : C9<I5>
                Diagnostic(ErrorCode.ERR_GenericConstraintNotSatisfiedRefType, "C11")
                    .WithArguments("ErrorTest.C9<T>", "ErrorTest.I1", "T", "ErrorTest.I5"),
                ...
                //             I1 x = c13;
                Diagnostic(ErrorCode.ERR_NoTypeDef, "c13")
                    .WithArguments(
                        "ErrorTest.C12",
                        "MissingImplementedInterface2, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null"
                    ),
                ...
                //             I1 x = c13;
                Diagnostic(ErrorCode.ERR_NoImplicitConvCast, "c13")
                    .WithArguments("ErrorTest.C13", "ErrorTest.I1"),
                ...
                //             I1 x = y;
                Diagnostic(ErrorCode.ERR_NoImplicitConvCast, "y")
                    .WithArguments("ErrorTest.C4", "ErrorTest.I1"),
                ...
                //             x.M1();
                Diagnostic(ErrorCode.ERR_NoTypeDef, "M1")
                    .WithArguments(
                        "ErrorTest.I2",
                        "MissingImplementedInterface2, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null"
                    ),
    ...
    class Test4
    {
        ...
        { }
            ...
            DiagnosticDescription[] expectedErrors =
            {
                ...
                //     public class C5 : C4
                Diagnostic(ErrorCode.ERR_NoTypeDef, "C4")
                    .WithArguments(
                        "ErrorTest.C2",
                        "MissingBaseClass2, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null"
                    ),
                ...
                //     public class C7 : C6<C4>
                Diagnostic(ErrorCode.ERR_GenericConstraintNotSatisfiedRefType, "C7")
                    .WithArguments("ErrorTest.C6<T>", "ErrorTest.C1", "T", "ErrorTest.C4"),
                ...
                //     public class C7 : C6<C4>
                Diagnostic(ErrorCode.ERR_NoTypeDef, "C7")
                    .WithArguments(
                        "ErrorTest.C2",
                        "MissingBaseClass2, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null"
                    ),
                ...
                //             C1 x = y;
                Diagnostic(ErrorCode.ERR_NoImplicitConv, "y")
                    .WithArguments("ErrorTest.C4", "ErrorTest.C1"),
