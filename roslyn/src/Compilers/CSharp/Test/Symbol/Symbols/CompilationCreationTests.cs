    ...
    public class CompilationCreationTests : CSharpTestBase
    {
        ...
        public void CorLibTypes()
        {
            ...
            for (int i = 1; i <= (int)SpecialType.Count; i++)
            {
                ...
                if (
                    i
                    is (int)SpecialType.System_Runtime_CompilerServices_RuntimeFeature
                        or (int)
        ...
        public void MultiTargeting1()
        {
            ...
            Assert.Equal(
                ...
                asm1[1]
                    .GlobalNamespace.GetTypeMembers("Class4")
                    .Single()
                    .GetMembers("Foo")
                    .OfType<MethodSymbol>()
                    .Single()
...
",
            ...
            var localC3Foo2 = asm3
                .GlobalNamespace.GetTypeMembers("C3")
                .Single()
                .GetMembers("Foo2")
                .OfType<MethodSymbol>()
                .Single();
...
";
            ...
            NamedTypeSymbol classModule1 = c1AsmRef
                .Modules[0]
                .GlobalNamespace.GetTypeMembers("Module1")
                .Single();
...
",
        ...
        public void RuntimeCapabilitiesSupported()
        {
            ...
            Assert.False(
                compilation.SupportsRuntimeCapability(RuntimeCapability.VirtualStaticsInInterfaces)
            );
            Assert.False(
                compilation.SupportsRuntimeCapability(
