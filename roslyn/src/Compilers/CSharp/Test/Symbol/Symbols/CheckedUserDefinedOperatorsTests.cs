...
";
            ...
            var expectedSymbol = compilation.SourceModule
                .GlobalNamespace
                .GetTypeMember("C")
                .GetMembers()
                .OfType<MethodSymbol>()
            ...
            compilation.VerifyDiagnostics(
                ...
                Diagnostic(ErrorCode.WRN_ErrorOverride, "checked")
                    .WithArguments(
                        "Feature 'checked user-defined operators' is not available in C# 10.0. Please use language version 11.0 or greater.",
                        "8936"
                    )
                    .WithLocation(3, 29),
            ...
            expectedSymbol = compilation.SourceModule
                .GlobalNamespace
                .GetTypeMember("C")
                .GetMembers()
                .OfType<MethodSymbol>()
...
";
            ...
            else
            {
                compilation.VerifyDiagnostics(
                    ...
                    Diagnostic(ErrorCode.WRN_ErrorOverride, "}}}")
                        .WithArguments(
                            "Feature 'unsigned right shift' is not available in C# 10.0. Please use language version 11.0 or greater.",
                            "8936"
                        )
                        .WithLocation(3, 37),
