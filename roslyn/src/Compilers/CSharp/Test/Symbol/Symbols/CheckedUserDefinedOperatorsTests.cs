...
class C 
{
    public static C operator checked "
                + op
                + @"(C x) => x;
...
";
            ...
            compilation1 = CreateCompilation(
                source1,
                options: TestOptions.DebugDll,
            ...
            compilation1.VerifyDiagnostics(
                ...
                Diagnostic(ErrorCode.ERR_FeatureInPreview, "checked")
                    .WithArguments("checked user-defined operators")
                    .WithLocation(4, 30)
            );
...
class C1 
{
    public static C1 operator checked "
                + op
                + @"(C1 x) => x;
...
class C2 
{
    ...
    public static C2 operator checked "
                + op
                + @"(C2 x) => x;
}
...
class C3 
{
    public static C3 operator checked "
                + op
                + @"(C3 x) => x;
...
class C4 
{
    ...
    public static C4 operator checked "
                + op
                + @"(C4 x) => x;
}
...
class C5 
{
    public static C5 operator checked "
                + op
                + @"(C5 x) => x;
...
";
            ...
            compilation1
                ...
                .Verify(
                    ...
                    Diagnostic(ErrorCode.ERR_DuplicateNameInClass, name)
                        .WithArguments("C3", name)
                        .WithLocation(30, 9),
...
";
            ...
            compilation1
                ...
                .Verify(
                    ...
                    Diagnostic(ErrorCode.ERR_BadUnOpArgs, op)
                        .WithArguments(op)
                        .WithLocation(4, 38)
                );
...
";
            ...
            compilation1
                ...
                .Verify(
                    ...
                    //     public static C operator checked ++(C x) => x;
                    Diagnostic(ErrorCode.ERR_ParameterIsStaticClass, op)
                        .WithArguments("C")
                        .WithLocation(4, 38)
                );
        }
...
";
            ...
            compilation.VerifyDiagnostics(
                ...
                Diagnostic(ErrorCode.WRN_ErrorOverride, "checked")
                    .WithArguments(
                        "The feature 'checked user-defined operators' is currently in Preview and *unsupported*. To use Preview features, use the 'preview' language version.",
                        "8652"
                    )
                    .WithLocation(3, 29),
            ...
            compilation = CreateCompilationWithMscorlib40AndDocumentationComments(
                source,
                parseOptions: TestOptions.RegularNext.WithDocumentationMode(
                    DocumentationMode.Diagnose
                )
            );
            compilation.VerifyDiagnostics();
...
";
            var expected = new[]
            {
                ...
                // /// See <see cref="operator (C)"/>.
                Diagnostic(ErrorCode.WRN_BadXMLRefSyntax, "operator (C)")
                    .WithArguments("operator (C)")
                    .WithLocation(3, 20),
...
class C 
{
    ...
    public static bool operator checked "
                + op
                + @"(C x) => false;
}
";
...
";
            ...
            void validator(ModuleSymbol m)
            {
                ...
                Assert.Equal(
                    "C C." + checkedName + "(C x, C y)",
                    opSymbols[1].ToTestDisplayString()
                );
            }
        }
...
";
            ...
            compilation1
                ...
                .Verify(
                    ...
                    //     public static C operator checked *() => default;
                    Diagnostic(ErrorCode.ERR_BadBinOpArgs, op)
                        .WithArguments(op)
                        .WithLocation(4, 38)
                );
...
";
            var expected = new[]
            {
                ...
                // /// See <see cref="operator "/>.
                Diagnostic(ErrorCode.WRN_BadXMLRefSyntax, "operator")
...
";
            var expected = new[]
            {
                ...
                // /// See <see cref="operator (C, C)"/>.
                Diagnostic(ErrorCode.WRN_BadXMLRefSyntax, "operator (C, C)")
                    .WithArguments("operator (C, C)")
                    .WithLocation(3, 20),
                // (3,29): warning CS1658: Overloadable operator expected. See also error CS1037.
                // /// See <see cref="operator (C, C)"/>.
                Diagnostic(ErrorCode.WRN_ErrorOverride, "(")
...
";
            ...
            )
            {
                ...
                if (op == ">>>" && options == TestOptions.Regular10)
                {
                    compilation1.VerifyDiagnostics(
                        ...
                        Diagnostic(ErrorCode.ERR_FeatureInPreview, ">>>")
                            .WithArguments("unsigned right shift")
                            .WithLocation(4, 38)
                    );
                }
                else
                ...
                Assert.Equal(name, opSymbol.Name);
                Assert.Equal(
                    "C C." + name + "(C x, System.Int32 y)",
                    opSymbol.ToTestDisplayString()
                );
...
";
            ...
            Assert.Equal(
                "C C." + name + "(C x, System.Int32 y)",
                opSymbols[0].ToTestDisplayString()
            );
            Assert.Equal(
                "C C." + name + "(C x, System.Int32 y)",
                opSymbols[1].ToTestDisplayString()
...
";
            ...
            else
            {
                compilation.VerifyDiagnostics(
                    ...
                    Diagnostic(ErrorCode.WRN_ErrorOverride, "}}}")
                        .WithArguments(
                            "The feature 'unsigned right shift' is currently in Preview and *unsupported*. To use Preview features, use the 'preview' language version.",
                            "8652"
                        )
                        .WithLocation(3, 37),
                ...
                compilation
                    ...
                    .Verify(
                        ...
                        Diagnostic(
                                ...
                                "operator checked " + opForXml + "(C, int)"
                            )
                            .WithArguments("operator checked " + opForXml + "(C, int)")
                            .WithLocation(3, 20),
                        // (3,29): warning CS1658: The feature 'checked user-defined operators' is currently in Preview and *unsupported*. To use Preview features, use the 'preview' language version.. See also error CS8652.
...
";
            ...
            void validator(ModuleSymbol m)
            {
                ...
                Assert.Equal(
                    "System.Int32 C.op_CheckedExplicit(C x)",
                    opSymbol.ToTestDisplayString()
                );
...
";
            ...
            void validator(ModuleSymbol m)
            {
                ...
                Assert.Equal(
                    "System.Int64 C.op_CheckedExplicit(C x)",
                    opSymbols[1].ToTestDisplayString()
                );
            }
        }
...
";
            ...
            compilation1
                ...
                .Verify(
                    ...
                    //     int op_CheckedExplicit { get; }
                    Diagnostic(ErrorCode.ERR_DuplicateNameInClass, "op_CheckedExplicit")
                        .WithArguments("C3", "op_CheckedExplicit")
                        .WithLocation(30, 9),
                    // (37,45): error CS0102: The type 'C4' already contains a definition for 'op_CheckedExplicit'
                    //     public static explicit operator checked int(C4 x) => 0;
                    Diagnostic(ErrorCode.ERR_DuplicateNameInClass, "int")
                        .WithArguments("C4", "op_CheckedExplicit")
                        .WithLocation(37, 45),
...
";
            ...
            compilation1
                ...
                .Verify(
                    ...
                    //     public static explicit operator checked int(C x) => 0;
                    Diagnostic(ErrorCode.ERR_ParameterIsStaticClass, "int")
                        .WithArguments("C")
                        .WithLocation(4, 45)
                );
        }
...
public class C0 
{
    public static C0 operator checked "
                + op
                + @"(C0 x)
    {
...
"
            ...
            compilation3.VerifyDiagnostics(
                ...
                //         return checked(-x); // C0
                Diagnostic(ErrorCode.ERR_FeatureInPreview, op + "x")
                    .WithArguments("checked user-defined operators")
                    .WithLocation(16, 24),
...
class Program
{
    ...
    public static C0 TestUncheckedC1(C1 x)
    {
        return unchecked(-x);
            ...
            var compilation1 = CreateCompilationWithIL(
                source1,
                ilSource,
                options: TestOptions.DebugExe,
                parseOptions: TestOptions.RegularPreview
    ...
    public static C0 TestUncheckedC0(C0 x)
    {
        return unchecked("
            ...
            compilation1.VerifyDiagnostics(
                ...
                //         return unchecked(-x);
                Diagnostic(ErrorCode.ERR_BadUnaryOp, op + "x")
                    .WithArguments(op, "C0")
                    .WithLocation(11, 26)
            );
        }
...
"
            ...
            compilation3.VerifyDiagnostics(
                ...
                Diagnostic(ErrorCode.ERR_FeatureInPreview, "x " + op + " x")
                    .WithArguments("checked user-defined operators")
                    .WithLocation(16, 24),
                // (26,24): error CS8652: The feature 'checked user-defined operators' is currently in Preview and *unsupported*. To use Preview features, use the 'preview' language version.
        ...
        [InlineData("*", "op_Multiply", "op_CheckedMultiply")]
        [InlineData("/", "op_Division", "op_CheckedDivision")]
        public void OverloadResolution_BinaryOperators_02(
            string op,
            string name,
            string checkedName
        )
    ...
    public static C0 TestUncheckedC0(C0 x)
    {
        return unchecked(x "
            ...
            compilation1.VerifyDiagnostics(
                ...
                Diagnostic(ErrorCode.ERR_BadBinaryOps, "x " + op + " x")
                    .WithArguments(op, "C0", "C0")
                    .WithLocation(11, 26)
            );
        }
...
"
            ...
            compilation3.VerifyDiagnostics(
                ...
                //         return checked(x - y);
                Diagnostic(ErrorCode.ERR_FeatureInPreview, "x " + op + " y")
                    .WithArguments("checked user-defined operators")
                    .WithLocation(14, 24)
            );
        }
...
";
            ...
            compilation1.VerifyDiagnostics(
                ...
                //         return x => checked(x / x);
                Diagnostic(ErrorCode.ERR_FeatureNotValidInExpressionTree, "x / x")
                    .WithArguments("C0.operator checked /(C0, C0)")
                    .WithLocation(22, 29)
            );
        }
        ...
        public void ExpressionTree_BinaryOperators_02(
            string op,
            string name,
            string checkedName,
            string factory,
            string checkedFactory
        )
        {
            var source1 =
                @"
                ...
                @"
{
  ...
  IL_0027:  call       ""System.Linq.Expressions.BinaryExpression System.Linq.Expressions.Expression."
                    + checkedFactory
                    + @"(System.Linq.Expressions.Expression, System.Linq.Expressions.Expression, System.Reflection.MethodInfo)""
  IL_002c:  ldc.i4.1
...
"
            ...
            compilation3.VerifyDiagnostics(
                ...
                //         checked { return (long)x; }
                Diagnostic(ErrorCode.ERR_FeatureInPreview, "(long)x")
                    .WithArguments("checked user-defined operators")
                    .WithLocation(23, 26)
            );
        }
...
";
            ...
            var verifier = CompileAndVerify(
                    compilation1,
                    expectedOutput: ExecutionConditionUtil.IsDesktop
                        ? @"
x => ConvertChecked(x)
x => Convert(x)
...
";
            var compilation1 = CreateCompilationWithCSharp(
                source1 + source2,
                options: TestOptions.DebugExe,
                parseOptions: TestOptions.RegularPreview
            );
...
"
            ...
            compilation1 = CreateCompilationWithCSharp(
                source1 + source2,
                options: TestOptions.DebugExe,
                parseOptions: TestOptions.RegularNext
            );
...
"
            ...
            var compilation3 = CreateCompilationWithCSharp(
                source2,
                options: TestOptions.DebugExe,
                parseOptions: TestOptions.Regular10,
                references: new[] { compilation2.ToMetadataReference() }
...
";
            ...
            var compilation3 = CreateCompilation(
                ...
                options: TestOptions.DebugExe,
                parseOptions: TestOptions.RegularPreview,
                references: new[] { compilation2.EmitToImageReference() }
            );
...
public class C0 
{
    public static (C0 a, object b, nint c)  operator checked "
                + op
                + @"(C0 x, C0 y)
    {
        System.Console.WriteLine(""checked C0"");
    ...
    public static (C0? d, dynamic e, System.IntPtr f) operator "
                + op
                + @"(C0 x, C0 y)
    {
        System.Console.WriteLine(""regular C0"");
...
public class C0 
{
    ...
    public static C0 operator "
                + op
                + @"((C0? d, dynamic e, System.IntPtr f) x, C0 y)
    {
        System.Console.WriteLine(""regular C0"");
        return y;
    }
...
public class C0 
{
    ...
    public static C0 operator "
                + op
                + @"(C0 x, (C0? d, dynamic e, System.IntPtr f) y)
    {
        System.Console.WriteLine(""regular C0"");
        return x;
    }
...
"
            ...
            var yNode = tree.GetRoot()
                .DescendantNodes()
                .OfType<IdentifierNameSyntax>()
                .Where(id => id.Identifier.ValueText == "y")
                .Single();

            Assert.Equal(
                "System.Int64 C0.op_CheckedExplicit(C0 x)",
                model.GetSymbolInfo(xNode.Parent).Symbol.ToTestDisplayString()
            );
            Assert.Equal(
                "System.Int64 C0.op_CheckedExplicit(C0 x)",
                model.GetSymbolInfo(yNode.Parent).Symbol.ToTestDisplayString()
            );
