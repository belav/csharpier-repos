...
";
            var compilation2 = CreateCompilation(
                ...
                references: new[]
                {
                    ...
                    ref1,
                    CreateEmptyCompilation("").ToMetadataReference()
                }
            );
            ...
            Assert.NotSame(
                compilation2.GetTypeByMetadataName("C1`1"),
                compilation3.GetTypeByMetadataName("C1`1")
            );
            ...
            Assert.Equal(
                c2.Interfaces().Single().GetMethod("M"),
                m.ExplicitInterfaceImplementations.Single()
            );
        }
    }
}
