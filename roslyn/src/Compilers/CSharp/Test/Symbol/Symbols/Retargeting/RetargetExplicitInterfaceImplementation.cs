...
"
                ...
                new[] { Net451.mscorlib, TestReferences.SymbolsTests.V1.MTTestLib1.dll, }
            );
                ...
                switch (member.Kind)
                {
                    case SymbolKind.Method:
                        ...
                        if (method.MethodKind == MethodKind.ExplicitInterfaceImplementation)
                        {
                            Assert.Equal(
                                interfaceV1,
                                method.ExplicitInterfaceImplementations.Single().ContainingType
                            );
                        }
                        break;
                    case SymbolKind.Property:
                        Assert.Equal(
                            ...
                            ).ExplicitInterfaceImplementations.Single().ContainingType
                        );
                        break;
...
"
            ...
            var retargetedClassCMethod1 = (MethodSymbol)retargetedClassC.GetMembers(
                    "Interface1.Method1"
                )
                .Single();
            {
                ...
                var retargetedClassCMethod1Impl =
                    retargetedClassCMethod1.ExplicitInterfaceImplementations.Single();
                Assert.Same(interfaceV2Method1, retargetedClassCMethod1Impl);
                Assert.NotSame(interfaceV1Method1, retargetedClassCMethod1Impl);
                Assert.Equal(
                    retargetedClassCMethod1Impl.ToTestDisplayString(),
                    interfaceV1Method1.ToTestDisplayString()
                );
            }

            var retargetedClassCMethod2 = (MethodSymbol)retargetedClassC.GetMembers(
                    "Interface1.Method2"
                )
                .Single();
            {
            ...
            var retargetedClassCMethod3 = (MethodSymbol)retargetedClassC.GetMembers(
                    "Interface1.Method3"
                )
                .Single();
            {
            ...
            var retargetedClassCMethod4 = (MethodSymbol)retargetedClassC.GetMembers(
                    "Interface1.Method4"
                )
                .Single();
            {
                ...
                var retargetedClassCMethod4Impl =
                    retargetedClassCMethod4.ExplicitInterfaceImplementations.Single();
                Assert.Same(interfaceV2Method4, retargetedClassCMethod4Impl);
                Assert.NotSame(interfaceV1Method4, retargetedClassCMethod4Impl);
                Assert.Equal(
                    retargetedClassCMethod4Impl.ToTestDisplayString(),
                    interfaceV1Method4.ToTestDisplayString()
                );
            }

            var retargetedClassCProperty1 = (PropertySymbol)retargetedClassC.GetMembers(
                ...
                .Single();
            {
                ...
                var retargetedClassCProperty1Impl =
                    retargetedClassCProperty1.ExplicitInterfaceImplementations.Single();
                ...
                Assert.Equal(
                    retargetedClassCProperty1Impl.Type.ToTestDisplayString(),
                    interfaceV1Property1.Type.ToTestDisplayString()
                );
            }

            var retargetedClassCProperty2 = (PropertySymbol)retargetedClassC.GetMembers(
                    "Interface1.Property2"
                )
                .Single();
            {
            ...
            var retargetedClassCProperty3 = (PropertySymbol)retargetedClassC.GetMembers(
                    "Interface1.Property3"
                )
                .Single();
            {
            ...
            var retargetedClassCProperty4 = (PropertySymbol)retargetedClassC.GetMembers(
                    "Interface1.Property4"
                )
                .Single();
            {
                Assert.IsType<RetargetingPropertySymbol>(retargetedClassCProperty4);

                var retargetedClassCProperty4Impl =
                    retargetedClassCProperty4.ExplicitInterfaceImplementations.Single();
                ...
                Assert.Equal(
                    retargetedClassCProperty4Impl.Type.ToTestDisplayString(),
                    interfaceV1Property4.Type.ToTestDisplayString()
                );
            }
            ...
            var retargetedClassCIndexer1 = FindIndexerWithParameterCount(retargetedClassC, 1);
            {
                ...
                var retargetedClassCIndexer1Impl =
                    retargetedClassCIndexer1.ExplicitInterfaceImplementations.Single();
                ...
                Assert.Equal(
                    retargetedClassCIndexer1Impl.Type.ToTestDisplayString(),
                    interfaceV1Indexer1.Type.ToTestDisplayString()
                );
            }
            ...
            var retargetedClassCIndexer4 = FindIndexerWithParameterCount(retargetedClassC, 4);
            {
                ...
                var retargetedClassCIndexer4Impl =
                    retargetedClassCIndexer4.ExplicitInterfaceImplementations.Single();
                ...
                Assert.Equal(
                    retargetedClassCIndexer4Impl.Type.ToTestDisplayString(),
                    interfaceV1Indexer4.Type.ToTestDisplayString()
                );
            }

            var retargetedClassCEvent1 = (EventSymbol)retargetedClassC.GetMembers(
                    "Interface1.Event1"
                )
                .Single();
            {
                ...
                var retargetedClassCEvent1Impl =
                    retargetedClassCEvent1.ExplicitInterfaceImplementations.Single();
                ...
                Assert.Equal(
                    retargetedClassCEvent1Impl.Type.ToTestDisplayString(),
                    interfaceV1Event1.Type.ToTestDisplayString()
                );
            }

            var retargetedClassCEvent2 = (EventSymbol)retargetedClassC.GetMembers(
                    "Interface1.Event2"
                )
                .Single();
            {
            ...
            var retargetedClassCEvent3 = (EventSymbol)retargetedClassC.GetMembers(
                    "Interface1.Event3"
                )
                .Single();
            {
            ...
            var retargetedClassCEvent4 = (EventSymbol)retargetedClassC.GetMembers(
                    "Interface1.Event4"
                )
                .Single();
            {
                ...
                var retargetedClassCEvent4Impl =
                    retargetedClassCEvent4.ExplicitInterfaceImplementations.Single();
                ...
                Assert.Equal(
                    retargetedClassCEvent4Impl.Type.ToTestDisplayString(),
                    interfaceV1Event4.Type.ToTestDisplayString()
                );
            }
        }
        ...
        )
        {
            return type.GetMembers()
                ...
                .Cast<PropertySymbol>()
                .Single(p => p.Parameters.Length == parameterCount);
        }
...
"
            ...
            var retargetedClassC1Method1 = (MethodSymbol)retargetedClassC1.GetMembers(
                    "Interface2<S>.Method1"
                )
                .Single();
            ...
            var retargetedClassC2Method1 = (MethodSymbol)retargetedClassC2.GetMembers(
                    "Interface2<System.Int32>.Method1"
                )
                .Single();
            ...
            var retargetedClassC3Method1 = (MethodSymbol)retargetedClassC3.GetMembers(
                    "Interface2<Class1>.Method1"
                )
                .Single();
            ...
            var retargetedClassC1Property1 = (PropertySymbol)retargetedClassC1.GetMembers(
                    "Interface2<S>.Property1"
                )
                .Single();
            ...
            var retargetedClassC2Property1 = (PropertySymbol)retargetedClassC2.GetMembers(
                    "Interface2<System.Int32>.Property1"
                )
                .Single();
            ...
            var retargetedClassC3Property1 = (PropertySymbol)retargetedClassC3.GetMembers(
                    "Interface2<Class1>.Property1"
                )
                .Single();
            ...
            var retargetedClassC1Event1 = (EventSymbol)retargetedClassC1.GetMembers(
                    "Interface2<S>.Event1"
                )
                .Single();
            ...
            var retargetedClassC2Event1 = (EventSymbol)retargetedClassC2.GetMembers(
                    "Interface2<System.Int32>.Event1"
                )
                .Single();
            ...
            var retargetedClassC3Event1 = (EventSymbol)retargetedClassC3.GetMembers(
                    "Interface2<Class1>.Event1"
                )
                .Single();
