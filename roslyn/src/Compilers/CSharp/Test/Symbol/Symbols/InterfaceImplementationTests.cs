...
";
            ...
            var classExplicitImplementation = (MethodSymbol)@class.GetMembers("Interface.Method")
                .Single();
            Assert.Equal(
                MethodKind.ExplicitInterfaceImplementation,
...
";
            ...
            var classImplicitImplementationBase = (MethodSymbol)@class.GetMembers("BaseMethod")
                .Single();
...
";
            ...
            var baseClassImplicitImplementation = (MethodSymbol)baseClass.GetMembers("Method")
                .Single();
...
";
            ...
            var baseClassMethodNonVirtual = (MethodSymbol)baseClass.GetMembers("NonVirtual")
                .Single();
...
";
            ...
            Assert.False(
                derivedClass.GetSynthesizedExplicitImplementations(CancellationToken.None).Any()
            );
        }
...
";
            ...
            Assert.Equal(
                0,
                classC.GetSynthesizedExplicitImplementations(CancellationToken.None).Length
            );
        }
...
"
            ...
            var baseAdder = baseType.GetMembers()
                .OfType<MethodSymbol>()
...
";
            ...
            var derivedGetter = derivedType.GetMembers()
                .OfType<MethodSymbol>()
