...
";
            ...
            comp.VerifyDiagnostics(
                ...
                //     public int op_Implicit { get; set; }
                Diagnostic(ErrorCode.ERR_DuplicateNameInClass, "op_Implicit")
                    .WithArguments("G", "op_Implicit"),
...
";
            ...
            comp.VerifyDiagnostics(
                ...
                //     public static explicit operator int (C c) { }
                Diagnostic(ErrorCode.ERR_ReturnExpected, "int")
                    .WithArguments("C.explicit operator int(C)")
            );
        }
