...
";
            Action<CSharpCompilation> validatePresent = comp =>
            {
                ...
                Assert.NotNull(
                    comp.GetSpecialTypeMember(SpecialMember.System_String__ConcatStringString)
                );
                comp.GetDiagnostics();
            };
...
";
            Action<CSharpCompilation> validate = comp =>
            {
                var wellKnownType = comp.GetWellKnownType(
                ...
                var lookupType = comp.GetTypeByMetadataName(
            ...
            ValidateSourceAndMetadata(
                string.Format(sourceTemplate, "public", "protected"),
                validate
            );
...
";
            Action<CSharpCompilation> validatePresent = comp =>
            {
                ...
                Assert.NotNull(
                    comp.GetWellKnownTypeMember(WellKnownMember.System_Math__RoundDouble)
                );
                comp.GetDiagnostics();
            };
...
";
            ...
            var comp = CreateEmptyCompilation(
                "",
                new[] { corlibRef, publicLibRef, internalLibRef },
                assemblyName: "Test"
            );
        ...
        public void AllSpecialTypes()
        {
            ...
            for (var special = SpecialType.None + 1; special <= SpecialType.Count; special++)
            {
                ...
                if (
                    special
                    is SpecialType.System_Runtime_CompilerServices_RuntimeFeature
                        or SpecialType.System_Runtime_CompilerServices_PreserveBaseOverridesAttribute
        ...
        public void AllSpecialTypeMembers()
        {
            ...
            foreach (SpecialMember special in Enum.GetValues(typeof(SpecialMember)))
            {
                ...
                if (
                    ...
                    || special
                        == SpecialMember.System_Runtime_CompilerServices_InlineArrayAttribute__ctor
                )
                {
...
";
            ...
            comp.VerifyEmitDiagnostics(
                ...
                //         ((IntPtr)0).GetHashCode();
                Diagnostic(ErrorCode.ERR_MissingPredefinedMember, "(IntPtr)0")
                    .WithArguments("System.IntPtr", "op_Explicit")
                    .WithLocation(8, 10)
            );
        }
...
";
            ...
            compilation.VerifyEmitDiagnostics(
                ...
                //             C c = (C)i;
                Diagnostic(ErrorCode.ERR_MissingPredefinedMember, "(C)i")
                    .WithArguments("System.Nullable`1", "GetValueOrDefault")
                    .WithLocation(10, 19)
            );
        }
...
";
            ...
            compilation.VerifyEmitDiagnostics(
                ...
                //         MyClass b = (int?)1;
                Diagnostic(ErrorCode.ERR_MissingPredefinedMember, "(int?)1")
                    .WithArguments("System.Nullable`1", ".ctor")
                    .WithLocation(9, 21)
            );
        }
...
";
            ...
            compilation.VerifyEmitDiagnostics(
                ...
                //         Test.Generic<decimal?>();
                Diagnostic(ErrorCode.ERR_MissingPredefinedMember, "Test.Generic<decimal?>()")
                    .WithArguments("System.Nullable`1", ".ctor")
                    .WithLocation(55, 9),
                // (58,9): error CS0656: Missing compiler required member 'System.Nullable`1..ctor'
                //         Test.NullableDecimal();
                Diagnostic(ErrorCode.ERR_MissingPredefinedMember, "Test.NullableDecimal()")
                    .WithArguments("System.Nullable`1", ".ctor")
                    .WithLocation(58, 9)
            );
        }
...
";
            ...
            compilation.VerifyEmitDiagnostics(
                ...
                //         Expression<Func<object, string>> e = x => "X = " + x;
                Diagnostic(ErrorCode.ERR_MissingPredefinedMember, @"""X = "" + x")
...
class C
{
    static void Main()
    {
            ...
            compilation.VerifyEmitDiagnostics(
                ...
                //     public static S operator + (S x, S y) { return new S(x.str + '+' + y.str); }
                Diagnostic(ErrorCode.ERR_MissingPredefinedMember, "x.str + '+' + y.str")
                    .WithArguments("System.String", "Concat")
                    .WithLocation(8, 58)
            );
        }
...
";
            ...
            compilation.VerifyEmitDiagnostics(
                ...
                //         var j = +sq;
                Diagnostic(ErrorCode.ERR_MissingPredefinedMember, "+sq")
                    .WithArguments("System.Nullable`1", "GetValueOrDefault")
                    .WithLocation(9, 17)
            );
        }
    ...
    static void Main()
    {
        Func<decimal?, decimal?> lambda = a => { return checked(a * a); };
            ...
            compilation.VerifyEmitDiagnostics(
                ...
                //         Func<decimal?, decimal?> lambda = a => { return checked(a * a); };
                Diagnostic(ErrorCode.ERR_MissingPredefinedMember, "a * a")
                    .WithArguments("System.Decimal", "op_Multiply")
                    .WithLocation(7, 65)
            );
        }
...
class C
{
  ...
  static void T(int line, bool b)
  {
            ...
            compilation.VerifyEmitDiagnostics(
                ...
                //     T(2, (x++).Value == (q++));
                Diagnostic(ErrorCode.ERR_MissingPredefinedMember, "x++")
                    .WithArguments("System.Nullable`1", "GetValueOrDefault")
                    .WithLocation(10, 11)
            );
        }
...
class C
{
  ...
  static void T(int line, bool b)
  {
            ...
            compilation.VerifyEmitDiagnostics(
                ...
                //     decimal? x = 10;
                Diagnostic(ErrorCode.ERR_MissingPredefinedMember, "10")
                    .WithArguments("System.Nullable`1", ".ctor")
                    .WithLocation(8, 18),
...
";
            ...
            compilation.VerifyEmitDiagnostics(
                ...
                //     T(2, (n++).Value.x == (s++).x);
                Diagnostic(ErrorCode.ERR_MissingPredefinedMember, "n++")
                    .WithArguments("System.Nullable`1", "GetValueOrDefault")
                    .WithLocation(18, 11)
            );
        }
...
";
            ...
            compilation.VerifyEmitDiagnostics(
                ...
                //     S? n = new S(1);
                Diagnostic(ErrorCode.ERR_MissingPredefinedMember, "new S(1)")
                    .WithArguments("System.Nullable`1", ".ctor")
                    .WithLocation(15, 12),
    ...
    static void Main()
    {
        ...
        T(1, true & bnt);
            ...
            compilation.VerifyEmitDiagnostics(
                ...
                //         bool? bnt = bt;
                Diagnostic(ErrorCode.ERR_MissingPredefinedMember, "bt")
                    .WithArguments("System.Nullable`1", ".ctor")
                    .WithLocation(11, 21),
                // (13,14): error CS0656: Missing compiler required member 'System.Nullable`1..ctor'
                //         T(1, true & bnt);
                Diagnostic(ErrorCode.ERR_MissingPredefinedMember, "true")
                    .WithArguments("System.Nullable`1", ".ctor")
                    .WithLocation(13, 14)
            );
        }
    ...
    static void Main()
    {
        ...
        T(13, bnt & bnt);
            ...
            compilation.VerifyEmitDiagnostics(
                ...
                //         T(13, bnt & bnt);
                Diagnostic(ErrorCode.ERR_MissingPredefinedMember, "bnt & bnt")
                    .WithArguments("System.Nullable`1", "GetValueOrDefault")
                    .WithLocation(13, 15),
                // (13,15): error CS0656: Missing compiler required member 'System.Nullable`1.GetValueOrDefault'
                //         T(13, bnt & bnt);
...
";
            ...
            compilation.VerifyEmitDiagnostics(
                ...
                //     public static bool operator ==(SZ sz1, SZ sz2) { return sz1.str == sz2.str; }
                Diagnostic(ErrorCode.ERR_MissingPredefinedMember, "sz1.str == sz2.str")
    ...
    static void Where<TSource>()
    {
        Action subscribe = () =>
        {
            ...
            compilation.VerifyEmitDiagnostics(
                ...
                //             var previousKey = previous?.Key;
                Diagnostic(ErrorCode.ERR_MissingPredefinedMember, "previous?.Key")
                    .WithArguments("System.Nullable`1", "get_HasValue")
                    .WithLocation(17, 31)
            );
        }
...
";
            ...
            compilation.VerifyEmitDiagnostics(
                ...
                //             case "hmm":
                Diagnostic(ErrorCode.ERR_MissingPredefinedMember, @"""hmm""")
                    .WithArguments("System.String", "op_Equality")
                    .WithLocation(13, 18),
                // (33,18): error CS0656: Missing compiler required member 'System.String.op_Equality'
                //             case "baz":
                Diagnostic(ErrorCode.ERR_MissingPredefinedMember, @"""baz""")
                    .WithArguments("System.String", "op_Equality")
                    .WithLocation(33, 18)
            );
        }
...
";
            ...
            compilation.VerifyEmitDiagnostics(
                ...
                //         Console.WriteLine(c + "3");
                Diagnostic(ErrorCode.ERR_MissingPredefinedMember, @"c + ""3""")
...
";
            ...
            compilation.VerifyEmitDiagnostics(
                ...
                //         Expression<Func<string, string, string>> testExpr = (x, y) => x + y;
                Diagnostic(ErrorCode.ERR_MissingPredefinedMember, "x + y")
                    .WithArguments("System.String", "Concat")
                    .WithLocation(10, 71)
            );
        }
    ...
    static void Main()
    {
        Expression<Func<SampStruct?, decimal, decimal>> testExpr = (x, y) => x ?? y;
            ...
            compilation.VerifyEmitDiagnostics(
                ...
                //         Expression<Func<SampStruct?, decimal, decimal>> testExpr = (x, y) => x ?? y;
                Diagnostic(ErrorCode.ERR_MissingPredefinedMember, "x ?? y")
                    .WithArguments("System.Decimal", "op_Implicit")
                    .WithLocation(16, 78)
            );
        }
    ...
    public static void Main() {
        LogCallerLineNumber5();
            ...
            compilation.VerifyEmitDiagnostics(
                ...
                //         LogCallerLineNumber5();
                Diagnostic(ErrorCode.ERR_MissingPredefinedMember, "LogCallerLineNumber5()")
                    .WithArguments("System.Nullable`1", ".ctor")
                    .WithLocation(10, 9)
            );
        }
