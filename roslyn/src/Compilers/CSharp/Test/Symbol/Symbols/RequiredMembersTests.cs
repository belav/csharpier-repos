...
";
        ...
        comp.VerifyDiagnostics(
            ...
            Diagnostic(ErrorCode.ERR_FeatureInPreview, "Field")
                .WithArguments("required members")
                .WithLocation(5, 27),
            ...
            //     internal required int Prop { get; set; }
            Diagnostic(ErrorCode.ERR_FeatureInPreview, "Prop")
                .WithArguments("required members")
                .WithLocation(6, 27)
        );
...
";
        var comp = CreateCompilationWithRequiredMembers(
            code,
            parseOptions: use10 ? TestOptions.Regular10 : TestOptions.RegularNext
        );
...
"
        ...
        comp.VerifyDiagnostics(
            ...
            Diagnostic(
                ...
                .WithArguments(
                    "Outer.ProtectedInternalClass.InternalProperty",
            ...
            Diagnostic(
                ...
                .WithArguments(
                    "Outer.ProtectedInternalClass.InternalField",
                    "Outer.ProtectedInternalClass"
                )
                .WithLocation(46, 31),
...
"
        ...
        comp.VerifyDiagnostics(
            ...
            Diagnostic(
                ...
                .WithArguments(
                    "Outer.InternalProtectedClass.Internal",
