...
namespace Microsoft.CodeAnalysis.CSharp.UnitTests.Symbols.Metadata.PE
{
    public class NoPiaLocalHideAndTypeSubstitutionTests : CSharpTestBase
    {
        ...
        public void NoPiaTypeEquivalenceBetweenPIATypeInExternalAndLocalAssembly()
        {
            ...
            var localConsumer = CreateCompilation(
                assemblyName: "Dummy",
                source: (string[])null,
            ...
            Assert.Equal(
                1,
                localConsumerRefsAsm.First(arg => arg.Name == "LocalTypes1")
                    .Modules.FirstOrDefault()
                    .GetReferencedAssemblies().Length
            );
            Assert.Equal(
                1,
                localConsumerRefsAsm.First(arg => arg.Name == "LocalTypes1")
                    .Modules.FirstOrDefault()
                    .GetReferencedAssemblySymbols().Length
            );
            Assert.Equal(
            ...
            var canonicalType1 = localConsumerRefsAsm.First(arg => arg.Name == "Pia1")
                .GlobalNamespace.GetTypeMembers("I1")
                .Single();
            var canonicalType2 = localConsumerRefsAsm.First(arg => arg.Name == "Pia1")
            ...
            NamedTypeSymbol classLocalType = localConsumerRefsAsm.First(
                    arg => arg.Name == "LocalTypes1"
                )
                .GlobalNamespace.GetTypeMembers("LocalTypes1")
                .Single();
            MethodSymbol methodSymbol = classLocalType.GetMembers("Test1")
                .OfType<MethodSymbol>()
                .Single();
            ...
            Assert.Same(
                canonicalType1,
                param.Where(arg => arg.Type.Name == "I1").Select(arg => arg).Single().Type
            );
            Assert.Same(
                canonicalType2,
                param.Where(arg => arg.Type.Name == "I2").Select(arg => arg).Single().Type
            );
        }
                ...
                @"public class External1
{
    ...
    public FooEnum Property1;
            ...
            var localTypeSource2 =
                @"public static class LocalType1
{
    public void Test1(External1.MyFunc arg)
    {
            ...
            var localType1 = CreateEmptyCompilation(
                assemblyName: "Dummy1",
            ...
            var localType2 = CreateEmptyCompilation(
                assemblyName: "Dummy2",
                source: new string[] { localTypeSource2 },
                references: new MetadataReference[]
                {
            ...
            Assert.Equal(
                2,
                localConsumerRefsAsm.First(arg => arg.Name == "Dummy2")
                    .Modules.FirstOrDefault()
                    .GetReferencedAssemblies().Length
            );
            Assert.Equal(
            ...
            NamedTypeSymbol classLocalType = localConsumer.GlobalNamespace.GetTypeMembers(
                    "LocalType1"
                )
                .Single();
            ...
            Assert.Equal(
                ...
                methodSymbol.Parameters.Single(arg => arg.Name == "arg").Type.Kind
            );
        }
...
";
            ...
            var localConsumer = CreateEmptyCompilation(
                assemblyName: "Dummy",
                source: new string[] { localTypeSource },
                references: new MetadataReference[]
                {
                    TestReferences.SymbolsTests.NoPia.GeneralPia,
            ...
            Assert.Equal(
                3,
                localConsumerRefsAsm.First(arg => arg.Name == "GeneralPia")
                    .Modules.FirstOrDefault()
                    .GetReferencedAssemblies().Length
            );
            Assert.Equal(
            ...
            var canonicalType = localConsumerRefsAsm.First(arg => arg.Name == "GeneralPia")
            ...
            NamedTypeSymbol classLocalType = localConsumer.GlobalNamespace.GetTypeMembers(
                ...
                .Single();
            FieldSymbol localFieldSymbol = classLocalType.GetMembers("myOwnVar")
                .OfType<FieldSymbol>()
                .Single();

            NamedTypeSymbol classRefLocalType = localConsumerRefsAsm.First(
                    arg => arg.Name == "ExternalAsm1"
                )
                .GlobalNamespace.GetTypeMembers("ExternalAsm1")
                .Single();
            MethodSymbol refMethodSymbol = classRefLocalType.GetMembers("Scen1")
                .OfType<MethodSymbol>()
                .Single();
            ImmutableArray<ParameterSymbol> param = refMethodSymbol.Parameters;
            NoPiaMissingCanonicalTypeSymbol missing =
                (NoPiaMissingCanonicalTypeSymbol)param.First().Type;

            Assert.Same(
                localConsumerRefsAsm.First(arg => arg.Name == "ExternalAsm1"),
                missing.EmbeddingAssembly
            );
        ...
        public void NoPIALocalTypesEquivalentToEachOtherInterfaceAsMethodParameterType()
        {
            ...
            var localTypeSource =
                @"class ICBase : InheritanceConflict.IBase
{
    public int Bar()
    {
        return -2;
    ...
    public static void Main()
    {
        ...
        ExternalAsm1.Scen2(myOwnRef);
            ...
            NamedTypeSymbol classLocalType = localConsumer.GlobalNamespace.GetTypeMembers(
                ...
                .Single();
            FieldSymbol localFieldSymbol = classLocalType.GetMembers("myOwnRef")
                .OfType<FieldSymbol>()
                .Single();
            ...
            NamedTypeSymbol classRefLocalType = localConsumerRefsAsm.First(
                ...
                .GlobalNamespace.GetTypeMembers("ExternalAsm1")
                .Single();
            MethodSymbol refMethodSymbol = classRefLocalType.GetMembers("Scen2")
                .OfType<MethodSymbol>()
                .Single();
            ImmutableArray<ParameterSymbol> param = refMethodSymbol.Parameters;
    ...
    public static void Main()
    {
       ...
       myLocalType = ExternalAsm1.Scen3(5);
            ...
            NamedTypeSymbol classLocalType = localConsumer.GlobalNamespace.GetTypeMembers(
                ...
                .Single();
            FieldSymbol localFieldSymbol = classLocalType.GetMembers("myLocalType")
                .OfType<FieldSymbol>()
                .Single();
            ...
            NamedTypeSymbol classRefLocalType = localConsumerRefsAsm.First(
                ...
                .GlobalNamespace.GetTypeMembers("ExternalAsm1")
                .Single();
            MethodSymbol methodSymbol = classRefLocalType.GetMembers("Scen3")
                .OfType<MethodSymbol>()
                .Single();
            NoPiaMissingCanonicalTypeSymbol missing =
                ...
                @"static class TypeSubstitution
{
    ISubFuncProp myLocalType = ExternalAsm1.Scen4;
            ...
            NamedTypeSymbol classRefLocalType = localConsumerRefsAsm.First(
                ...
                .GlobalNamespace.GetTypeMembers("ExternalAsm1")
                .Single();
            var methodSymbol = classRefLocalType.GetMembers("Scen4")
                ...
                @"static class TypeSubstitution
{
    GeneralEventScenario.EventHandler myLocalType = ExternalAsm1.Scen5;
            ...
            NamedTypeSymbol classRefLocalType = localConsumerRefsAsm.First(
                ...
                .GlobalNamespace.GetTypeMembers("ExternalAsm1")
                .Single();
            var methodSymbol = classRefLocalType.GetMembers("Scen5")
                .OfType<PropertySymbol>()
                .Single();
        ...
        public void NoPIATypeSubstitutionForClassThatImplementNoPiaInterface()
        {
            ...
            NamedTypeSymbol classRefLocalType = localConsumerRefsAsm.First(
                ...
                .Single();
            MethodSymbol methodSymbol = classRefLocalType.GetMembers("Foo")
                .OfType<MethodSymbol>()
                .Single();
        ...
        public void NoPiaAmbiguousCanonicalTypeSymbolForStruct()
        {
            ...
            Assert.Same(
                localConsumerRefsAsm.First(arg => arg.Name == "GeneralPiaCopy")
                    .GlobalNamespace.ChildNamespace("InheritanceConflict")
                    .GetTypeMembers("IBase")
                    .Single(),
                ...
                @"public class IdentifyingAttributes
{
    ...
    public IInterface Foo()
    {
        return new IInterface();
            ...
            var localType1 = CreateCompilation(
                assemblyName: "Dummy1",
                source: localTypeSource1,
                references: null
            );

            var localType2 = CreateCompilation(
                assemblyName: "Dummy2",
            ...
            Assert.True(
                localType2.Assembly.GetNoPiaResolutionAssemblies()
                    .First(arg => arg.Name == "Dummy1").IsLinked
            );
            ...
            var importedType = localConsumerRefsAsm.First(arg => arg.Name == "Dummy2")
...
public interface I1
{
            ...
            var localType = CreateCompilation(
                assemblyName: "Dummy1",
                source: localTypeSource,
                references: null
            );
            ...
            var localConsumerRefsAsm = localConsumer.Assembly.GetNoPiaResolutionAssemblies();
            var importedTypeComp2 = localConsumerRefsAsm.First(arg => arg.Name == "Dummy1")
                .GlobalNamespace.GetTypeMembers("LocalTypes1")
                .Single();
            var embeddedType = importedTypeComp2.GetMembers("Test1")
                .OfType<MethodSymbol>()
                .Single();
            var importedTypeAsm = localConsumerRefsAsm.First(arg => arg.Name == "Pia1")
                .GlobalNamespace.GetTypeMembers("I1")
                .Single();
