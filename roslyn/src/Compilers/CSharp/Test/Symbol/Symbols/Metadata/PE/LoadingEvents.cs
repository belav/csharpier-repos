...
namespace Microsoft.CodeAnalysis.CSharp.UnitTests.Symbols.Metadata.PE
{
    public class LoadingEvents : CSharpTestBase
    {
        ...
        public void TestExplicitImplementationGeneric()
        {
            ...
            var substitutedInterfaceEvent = (EventSymbol)substitutedInterface.GetMembers("Event")
                .Single();
        ...
        public void TestExplicitImplementationConstructed()
        {
            ...
            var classEvent = (EventSymbol)@class.GetMembers("IGeneric<System.Int32>.Event")
                .Single();
        ...
        public void TestTypeParameterPositions()
        {
            ...
            var outerInterfaceEvent = outerInterface.GetMembers()
            ...
            var innerInterfaceEvent = innerInterface.GetMembers()
                .Single(m => m.Kind == SymbolKind.Event);
