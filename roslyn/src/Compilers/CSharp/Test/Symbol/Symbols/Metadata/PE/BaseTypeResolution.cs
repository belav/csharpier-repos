...
namespace Microsoft.CodeAnalysis.CSharp.UnitTests.Symbols.Metadata.PE
{
    public class BaseTypeResolution : CSharpTestBase
    {
        ...
        private void TestBaseTypeResolutionHelper2(AssemblySymbol[] assemblies)
        {
            ...
            var varCorTypes = module2.GlobalNamespace.GetMembers("CorTypes")
        ...
        public void Test3()
        {
            ...
            Assert.Equal(
                "System.Object",
                ((SourceModuleSymbol)c1.Assembly.Modules[0]).GetCorLibType(
            ...
            Assert.Equal(
                ...
                ((SourceModuleSymbol)c2.Assembly.Modules[0]).GetCorLibType(
                        SpecialType.System_Object
                    )
                    .ToTestDisplayString()
            );
