...
namespace Microsoft.CodeAnalysis.CSharp.UnitTests.Symbols.Metadata.PE
{
    public class LoadingAttributes : CSharpTestBase
    {
        ...
        public void TestInteropAttributesInterface()
        {
            ...
            attrObj = (NamedTypeSymbol)interopNS.GetTypeMembers("TypeLibImportClassAttribute")
                .Single();
        ...
        public void TestInteropAttributesDelegate()
        {
            ...
            attrObj = (NamedTypeSymbol)interopNS.GetTypeMembers("UnmanagedFunctionPointerAttribute")
                .Single();
        ...
        public void TestAttributesOnTypeParameters()
        {
            ...
            var attrObj1 = (NamedTypeSymbol)caNS.GetTypeMembers("AllInheritMultipleAttribute")
                .Single();
        ...
        public void TestAttributesAssemblyVersionValue()
        {
            ...
            var asmFileAttr = (NamedTypeSymbol)refNS.GetTypeMembers("AssemblyFileVersionAttribute")
                .Single();
        ...
        public void TestAttributesWithTypeOfInternalClass()
        {
            ...
            var dbgProxyAttr = (NamedTypeSymbol)diagNS.GetTypeMembers("DebuggerTypeProxyAttribute")
                .Single();

            // [DebuggerTypeProxy(typeof(Expression.BinaryExpressionProxy))] - internal class as argument to typeof()
            // public class BinaryExpression : Expression {... }
            var attr1 = exprNS.GetTypeMembers("BinaryExpression")
                .First()
            ...
            attr1 = exprNS.GetTypeMembers("TypeBinaryExpression")
                .First()
                .GetAttribute(dbgProxyAttr);
            Assert.Equal(
        ...
        public void TestAttributesOverloadedCtors()
        {
            ...
            var resCatAttr = (NamedTypeSymbol)secondNS.GetTypeMembers("ResCategoryAttribute")
                .Single();
            var resDesAttr = (NamedTypeSymbol)secondNS.GetTypeMembers("ResDescriptionAttribute")
                .Single();
            ...
            var defValAttr = (NamedTypeSymbol)level02NS.GetTypeMembers("DefaultValueAttribute")
                .Single();
