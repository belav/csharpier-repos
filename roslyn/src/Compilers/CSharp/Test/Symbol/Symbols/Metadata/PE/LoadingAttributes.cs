...
namespace Microsoft.CodeAnalysis.CSharp.UnitTests.Symbols.Metadata.PE
{
    public class LoadingAttributes : CSharpTestBase
    {
        ...
        public void TestAssemblyAttributes()
        {
            ...
            var aBoolClass =
                assembly1.Modules[0].GlobalNamespace.GetMember<NamedTypeSymbol>("ABooleanAttribute")
                as NamedTypeSymbol;
            var aByteClass =
                assembly1.Modules[0].GlobalNamespace.GetMember<NamedTypeSymbol>("AByteAttribute")
                as NamedTypeSymbol;
            var aCharClass =
                assembly1.Modules[0].GlobalNamespace.GetMember<NamedTypeSymbol>("ACharAttribute")
                as NamedTypeSymbol;
            var aSingleClass =
                assembly1.Modules[0].GlobalNamespace.GetMember<NamedTypeSymbol>("ASingleAttribute")
                as NamedTypeSymbol;
            var aDoubleClass =
                assembly1.Modules[0].GlobalNamespace.GetMember<NamedTypeSymbol>("ADoubleAttribute")
                as NamedTypeSymbol;
            var aInt16Class =
                assembly1.Modules[0].GlobalNamespace.GetMember<NamedTypeSymbol>("AInt16Attribute")
                as NamedTypeSymbol;
            var aInt32Class =
                assembly1.Modules[0].GlobalNamespace.GetMember<NamedTypeSymbol>("AInt32Attribute")
                as NamedTypeSymbol;
            var aInt64Class =
                assembly1.Modules[0].GlobalNamespace.GetMember<NamedTypeSymbol>("AInt64Attribute")
                as NamedTypeSymbol;
            var aObjectClass =
                assembly1.Modules[0].GlobalNamespace.GetMember<NamedTypeSymbol>("AObjectAttribute")
                as NamedTypeSymbol;
            var aStringClass =
                assembly1.Modules[0].GlobalNamespace.GetMember<NamedTypeSymbol>("AStringAttribute")
                as NamedTypeSymbol;
            var aTypeClass =
                assembly1.Modules[0].GlobalNamespace.GetMember<NamedTypeSymbol>("ATypeAttribute")
                as NamedTypeSymbol;
        ...
        public void TestModuleAttributes()
        {
            ...
            var aBoolClass =
                assembly1.Modules[0].GlobalNamespace.GetMember("ABooleanAttribute")
                as NamedTypeSymbol;
            var aByteClass =
                assembly1.Modules[0].GlobalNamespace.GetMember("AByteAttribute") as NamedTypeSymbol;
            var aCharClass =
                assembly1.Modules[0].GlobalNamespace.GetMember("ACharAttribute") as NamedTypeSymbol;
            var aSingleClass =
                assembly1.Modules[0].GlobalNamespace.GetMember("ASingleAttribute")
                as NamedTypeSymbol;
            var aDoubleClass =
                assembly1.Modules[0].GlobalNamespace.GetMember("ADoubleAttribute")
                as NamedTypeSymbol;
            var aInt16Class =
                assembly1.Modules[0].GlobalNamespace.GetMember("AInt16Attribute")
                as NamedTypeSymbol;
            var aInt32Class =
                assembly1.Modules[0].GlobalNamespace.GetMember("AInt32Attribute")
                as NamedTypeSymbol;
            var aInt64Class =
                assembly1.Modules[0].GlobalNamespace.GetMember("AInt64Attribute")
                as NamedTypeSymbol;
            var aObjectClass =
                assembly1.Modules[0].GlobalNamespace.GetMember("AObjectAttribute")
                as NamedTypeSymbol;
            var aStringClass =
                assembly1.Modules[0].GlobalNamespace.GetMember("AStringAttribute")
                as NamedTypeSymbol;
            var aTypeClass =
                assembly1.Modules[0].GlobalNamespace.GetMember("ATypeAttribute") as NamedTypeSymbol;
        ...
        public void TestAttributesOnClassAndMembers()
        {
            ...
            property1
                .GetAttributes()
                .First()
                .VerifyValue(0, TypedConstantKind.Primitive, "Property1");
            ...
            function1
                .GetAttributes()
                .First()
                .VerifyValue(0, TypedConstantKind.Primitive, "Function1");
        }
        ...
        public void TestNamedAttributes()
        {
            ...
            var aBoolClass =
                assemblies[1].Modules[0].GlobalNamespace.GetMember("ABooleanAttribute")
                as NamedTypeSymbol;
            var aByteClass =
                assemblies[1].Modules[0].GlobalNamespace.GetMember("AByteAttribute")
                as NamedTypeSymbol;
            var aCharClass =
                assemblies[1].Modules[0].GlobalNamespace.GetMember("ACharAttribute")
                as NamedTypeSymbol;
            var aEnumClass =
                assemblies[1].Modules[0].GlobalNamespace.GetMember("AEnumAttribute")
                as NamedTypeSymbol;
            var aSingleClass =
                assemblies[1].Modules[0].GlobalNamespace.GetMember("ASingleAttribute")
                as NamedTypeSymbol;
            var aDoubleClass =
                assemblies[1].Modules[0].GlobalNamespace.GetMember("ADoubleAttribute")
                as NamedTypeSymbol;
            var aInt16Class =
                assemblies[1].Modules[0].GlobalNamespace.GetMember("AInt16Attribute")
                as NamedTypeSymbol;
            var aInt32Class =
                assemblies[1].Modules[0].GlobalNamespace.GetMember("AInt32Attribute")
                as NamedTypeSymbol;
            var aInt64Class =
                assemblies[1].Modules[0].GlobalNamespace.GetMember("AInt64Attribute")
                as NamedTypeSymbol;
            var aObjectClass =
                assemblies[1].Modules[0].GlobalNamespace.GetMember("AObjectAttribute")
                as NamedTypeSymbol;
            var aStringClass =
                assemblies[1].Modules[0].GlobalNamespace.GetMember("AStringAttribute")
                as NamedTypeSymbol;
            var aTypeClass =
                assemblies[1].Modules[0].GlobalNamespace.GetMember("ATypeAttribute")
                as NamedTypeSymbol;
        ...
        public void TestAttributesOnReturnTypes()
        {
            ...
            var c1 = (NamedTypeSymbol)
                assemblies[0].Modules[0].GlobalNamespace.GetMembers("C1").Single();
            c1.GetAttributes().First().VerifyValue(0, TypedConstantKind.Primitive, "C1");
        ...
        public void TestAttributesWithTypesAndArrays()
        {
            ...
            l.GetAttributes()
                .First()
                .VerifyValue(0, TypedConstantKind.Type, "System.Collections.Generic.List<>");

            l = (FieldSymbol)c2.GetMember("L2");
            l.GetAttributes()
                .First()
                .VerifyValue(0, TypedConstantKind.Type, "System.Collections.Generic.List<C1>");
            ...
            l.GetAttributes()
                ...
                .VerifyValue(
                    0,
                    TypedConstantKind.Type,
                    "System.Collections.Generic.List<System.Collections.Generic.KeyValuePair<C1, System.String>>"
                );
            ...
            l.GetAttributes()
                ...
                .VerifyValue(
                    0,
                    TypedConstantKind.Type,
                    "System.Collections.Generic.List<System.Collections.Generic.KeyValuePair<System.String, C1.InnerC1<System.Int32>.InnerC2<System.String, System.String>>>"
                );
            ...
            arg.VerifyValue(
                0,
                TypedConstantKind.Array,
                new object[] { new object[] { stringType } }
            );
            ...
            arg.VerifyValue(
                0,
                TypedConstantKind.Array,
                new object[] { 1, "two", stringType, 3.1415926 }
            );
            ...
            arg.VerifyValue(
                0,
                TypedConstantKind.Array,
                new object[] { 1, new object[] { 2, 3, 4 }, 5 }
            );
        ...
        {
            var assemblies = MetadataTestHelpers.GetSymbolsForReferences(
                new[] { TestReferences.SymbolsTests.Metadata.MDTestAttributeDefLib, Net40.mscorlib }
            );
        ...
        {
            var assemblies = MetadataTestHelpers.GetSymbolsForReferences(
                new[] { TestReferences.SymbolsTests.Metadata.AttributeInterop01, Net40.mscorlib }
            );
                ...
                switch (a.AttributeClass.Name)
                {
                    ...
                    case "ClassInterfaceAttribute":
                        ...
                        Assert.Equal(
                            ...
                            a.CommonConstructorArguments[0].Type.ToDisplayString()
                        );
        ...
        public void TestInteropAttributesInterface()
        {
            ...
            var appNS = (NamespaceSymbol)
                assemblies[0].Modules[0].GlobalNamespace.GetMember("Interop");
            ...
            attrObj = (NamedTypeSymbol)
                interopNS.GetTypeMembers("TypeLibImportClassAttribute").Single();
            var msym = attrObj.InstanceConstructors.First();
            attrSym = igoo.GetAttribute(msym);
            Assert.Equal(
                "object",
                ((Symbol)attrSym.CommonConstructorArguments[0].ValueInternal).ToString()
            );
        ...
        public void TestInteropAttributesDelegate()
        {
            ...
            attrObj = (NamedTypeSymbol)
                interopNS.GetTypeMembers("UnmanagedFunctionPointerAttribute").Single();
        ...
        {
            var assemblies = MetadataTestHelpers.GetSymbolsForReferences(
                new[] { TestReferences.SymbolsTests.Metadata.AttributeInterop02, Net40.mscorlib }
            );
            ...
            var appNS = (NamespaceSymbol)
                assemblies[0].Modules[0].GlobalNamespace.GetMember("EventNS");
        ...
        public void TestAttributesNames()
        {
            ...
            Assert.Equal(
                2,
                (attrSym.CommonNamedArguments[0].Value.ValueInternal as NamedTypeSymbol).Arity
            );
        }
        ...
        public void TestAttributesOnTypeParameters()
        {
            ...
            var attrObj1 = (NamedTypeSymbol)
                caNS.GetTypeMembers("AllInheritMultipleAttribute").Single();
            var attrObj2 = (NamedTypeSymbol)caNS.GetTypeMembers("DerivedAttribute").Single();

            var appNS = (NamespaceSymbol)
                assemblies[0].Modules[0].GlobalNamespace.GetMember("AttributeUse");
            ...
            Assert.Equal(
                ...
                (attrSym.CommonNamedArguments[0].Value.Value as INamedTypeSymbol).ToString()
            );
        }
        ...
        public void TestAttributesMultiples()
        {
            ...
            foreach (var a in attrs)
            {
                ...
                if (pos0.IsDefaultOrEmpty)
                {
                    ...
                    Assert.Equal(
                        "string[]",
                        a.CommonConstructorArguments[1].Type.ToDisplayString()
                    );
        ...
        {
            var assemblies = MetadataTestHelpers.GetSymbolsForReferences(
                mrefs: new[] { Net451.SystemCore, Net451.System, Net40.mscorlib }
            );
            ...
            var asmFileAttr = (NamedTypeSymbol)
                refNS.GetTypeMembers("AssemblyFileVersionAttribute").Single();
            var attr1 = assemblies[0].GetAttribute(asmFileAttr);
            attr1.VerifyValue(0, TypedConstantKind.Primitive, "4.0.30319.18408");

            var asmInfoAttr = (NamedTypeSymbol)
                refNS.GetTypeMembers("AssemblyInformationalVersionAttribute").Single();
        ...
        public void TestAttributesWithTypeOfInternalClass()
        {
            ...
            var corsysNS =
                assemblies[2].GlobalNamespace.GetMembers("System").Single() as NamespaceSymbol;
            ...
            attr1 = exprNS
                .GetTypeMembers("TypeBinaryExpression")
                .First()
                .GetAttribute(dbgProxyAttr);
            Assert.Equal(
        ...
        {
            var assemblies = MetadataTestHelpers.GetSymbolsForReferences(
                new[] { Net451.SystemConfiguration, Net451.System, Net40.mscorlib }
            );
        ...
        {
            var assemblies = MetadataTestHelpers.GetSymbolsForReferences(
                mrefs: new[] { Net451.SystemData, Net451.SystemCore, Net451.System, Net40.mscorlib }
            );
            ...
            var resCatAttr = (NamedTypeSymbol)
                secondNS.GetTypeMembers("ResCategoryAttribute").Single();
            var resDesAttr = (NamedTypeSymbol)
                secondNS.GetTypeMembers("ResDescriptionAttribute").Single();
            ...
            var defValAttr = (NamedTypeSymbol)
                level02NS.GetTypeMembers("DefaultValueAttribute").Single();
...
class Class2 : Class1
{
            ...
            CompileAndVerify(
                CreateCompilationWithILAndMscorlib40(csSource, ilSource),
                symbolValidator: module =>
                {
