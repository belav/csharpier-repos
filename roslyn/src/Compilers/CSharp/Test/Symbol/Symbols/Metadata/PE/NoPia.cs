...
";
            ...
            var pia1CopyLink = TestReferences.SymbolsTests.NoPia.Pia1Copy
                .WithEmbedInteropTypes(true);
            var pia1CopyRef = TestReferences.SymbolsTests.NoPia.Pia1Copy
        ...
        public void GenericsClosedOverLocalTypes2()
        {
            ...
            var library2Ref = TestReferences.SymbolsTests.NoPia.Library2
                .WithEmbedInteropTypes(false);
            var library2Link = TestReferences.SymbolsTests.NoPia.Library2
                .WithEmbedInteropTypes(true);
