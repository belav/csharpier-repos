                ...
                @"public class NoPIAGenerics 
{
   Class1 field =  null;   
            ...
            NamedTypeSymbol classLocalType1 =
                localConsumer1.SourceModule.GlobalNamespace.GetTypeMembers("NoPIAGenerics")
                    .Single();
                ...
                @" public class NoPIAGenerics 
{
   Interface1 i1 = null;
            ...
            NamedTypeSymbol classLocalType1 = localConsumer.GlobalNamespace.GetTypeMembers(
                    "NoPIAGenerics"
                )
                .Single();
                ...
                @"public class NoPIAGenerics 
{
     InheritsMethods inheritsMethods = null;
            ...
            NamedTypeSymbol classLocalType = localConsumer.GlobalNamespace.GetTypeMembers(
                ...
                .Single();
            var localField = classLocalType.GetMembers("inheritsMethods")
                .OfType<FieldSymbol>()
                .Single();
            ...
            foreach (MethodSymbol m in localField.Type.GetMembers("Method1").OfType<MethodSymbol>())
            {
                if (m.Parameters.Length > 0)
                {
                    Assert.Equal(
                        ...
                        m.Parameters.Where(arg => arg.Name == "c1")
                            .Select(arg => arg)
                            .Single()
                            .Type.BaseType().Kind
                    );
                ...
                @"public class NoPIAGenerics 
{
   TypeRefs1 typeRef = null;
            ...
            var importedProperty = local.Type.GetMembers("Property1")
            ...
            Assert.IsType<NoPiaIllegalGenericInstantiationSymbol>(
                importedProperty.Parameters.Single(arg => arg.Name == "x").Type
            );
        }
                ...
                @"public class NoPIAGenerics 
{
   TypeRefs1 typeRef = null;
            ...
            NamedTypeSymbol classLocalType1 = localConsumer.GlobalNamespace.GetTypeMembers(
                ...
                .Single();
            var local = classLocalType1.GetMembers("typeRef").OfType<FieldSymbol>().Single();
            var importedProperty = local.Type.GetMembers("Property2")
                .OfType<PropertySymbol>()
                .Single();
                ...
                @"public class NoPIAGenerics 
{
   TypeRefs1 typeRef = null;
            ...
            Assert.Equal(
                SymbolKind.ErrorType,
                importedMethod.Parameters.Where(arg => arg.Name == "x")
                    .Select(arg => arg)
                    .Single().Type.Kind
            );
            Assert.IsType<NoPiaIllegalGenericInstantiationSymbol>(
                ...
                @" public class NoPIAGenerics 
{
     TypeRefs2 tr2a = new TypeRefs2(null);
            ...
            NamedTypeSymbol classLocalType = localConsumer.GlobalNamespace.GetTypeMembers(
                ...
                .Single();
            var local = classLocalType.GetMembers("tr2a").OfType<FieldSymbol>().Single();
            var importedMethod = local.Type.GetMembers("op_Implicit")
                .OfType<MethodSymbol>()
                .Single();
            ...
            Assert.IsType<NoPiaIllegalGenericInstantiationSymbol>(
                importedMethod.Parameters.Single(arg => arg.Name == "x").Type
            );
        }
...
public class NoPIAGenerics  
{
    MyGenericClass2 mygeneric = null;
        ...
        public void NoPIAClassThatInheritsGenericOfNoPIAType()
        {
            ...
            var localTypeSource1 =
                @"public class BaseClass : System.Collections.Generic.List<FooStruct>
{
}
...
public class DrivedClass
{
    ...
    public static BaseClass Method1()
    {
            ...
            foreach (MethodSymbol m in classLocalType.GetMembers("Method1").OfType<MethodSymbol>())
            {
                if (m.Parameters.Length > 0)
                {
                    Assert.Equal(
                        ...
                        m.Parameters.Where(arg => arg.Name == "c1").Select(arg => arg).Single().Kind
                    );
                    Assert.True(
                        m.Parameters.Where(arg => arg.Name == "c1")
                            .Select(arg => arg)
        ...
        public void NoPIATypeImplementingAnInterfaceThatInheritsIGenericOfNoPiaType()
        {
            ...
            var localTypeSource =
                @"public struct Interface1Impl2 : Interface4
{
}";
            var localConsumer = CreateCompilation(localTypeSource);
        ...
        public void NoPiaIllegalGenericInstantiationSymbolForAssemblyRefsWithClassThatInheritsGenericOfNoPiaType()
        {
            ...
            var localConsumer = CreateCompilationWithMscorlib40(
                assemblyName: "Dummy",
                source: (string[])null,
                references: new[] { TestReferences.SymbolsTests.NoPia.NoPIAGenericsAsm1, }
            );

            var localConsumerRefsAsm = localConsumer.Assembly.GetNoPiaResolutionAssemblies();

            var nestedType = localConsumerRefsAsm.Where(a => a.Name == "NoPIAGenerics1-Asm1")
                .Single()
        ...
        public void NoPIAGenericsAssemblyRefsWithClassThatInheritsGenericOfNoPiaType()
        {
            ...
            var nestedType = localConsumerRefsAsm[1].GlobalNamespace.GetTypeMembers(
                    "NestedConstructs"
                )
                .Single();
            var localField = nestedType.GetMembers("field1").OfType<FieldSymbol>().Single();
        ...
        public void NoPIAGenericsAssemblyRefs3()
        {
            ...
            var nestedType = localConsumerRefsAsm[1].GlobalNamespace.GetTypeMembers("TypeRefs1")
                .Single();
...
public class TypeRefs1
{
    ...
    public List<FooStruct> Method4()
    {
        return null;
            ...
            var nestedType = localConsumerRefsAsm.First(arg => arg.Name == "Dummy")
