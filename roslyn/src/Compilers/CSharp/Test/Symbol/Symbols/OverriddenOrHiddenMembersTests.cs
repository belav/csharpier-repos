...
";
            ...
            var derivedInterface1 = (NamedTypeSymbol)global.GetMembers("DerivedInterface1")
                .Single();
            var derivedInterface2 = (NamedTypeSymbol)global.GetMembers("DerivedInterface2")
                .Single();

            var baseInterface1Method = (MethodSymbol)baseInterface1.GetMembers("Method").Single();
            var baseInterface1Property = (PropertySymbol)baseInterface1.GetMembers("Property")
                .Single();

            var baseInterface2Method = (MethodSymbol)baseInterface2.GetMembers("Method").Single();
            var baseInterface2Property = (PropertySymbol)baseInterface2.GetMembers("Property")
                .Single();

            var derivedInterface1Method = (MethodSymbol)derivedInterface1.GetMembers("Method")
                .First();
            var derivedInterface1MethodInt = (MethodSymbol)derivedInterface1.GetMembers("Method")
                .Last();
            var derivedInterface1Property = (PropertySymbol)derivedInterface1.GetMembers("Property")
                .Single();

            var derivedInterface2Method = (MethodSymbol)derivedInterface2.GetMembers("Method")
                .First();
            var derivedInterface2MethodInt = (MethodSymbol)derivedInterface2.GetMembers("Method")
                .Last();
            var derivedInterface2Property = (PropertySymbol)derivedInterface2.GetMembers("Property")
                .Single();
...
";
            ...
            var derivedClassRefProperty = (PropertySymbol)derivedClass.GetMembers("Property1")
                .Single();
...
abstract class DerivedClass : BaseClass<int, long>
{
    ...
    public override bool Equals(object obj) { return true; }
            ...
            var derivedClassGetHashCode = (MethodSymbol)derivedClass.GetMembers("GetHashCode")
                .Single();
...
";
            ...
            var definingClassProperty1 = (PropertySymbol)definingClass.GetMembers("Property1")
                .Single();
            var definingClassProperty2 = (PropertySymbol)definingClass.GetMembers("Property2")
                .Single();
            ...
            var overridingClassMethod1 = (MethodSymbol)overridingClass.GetMembers("Method1")
                .Single();
            var overridingClassMethod2 = (MethodSymbol)overridingClass.GetMembers("Method2")
                .Single();
            var overridingClassProperty1 = (PropertySymbol)overridingClass.GetMembers("Property1")
                .Single();
            var overridingClassProperty2 = (PropertySymbol)overridingClass.GetMembers("Property2")
                .Single();
...
";
            ...
            //IL
            var classA = (NamedTypeSymbol)global.GetTypeMembers("CustomModifierOverridingA")
                .Single();
            var classB = (NamedTypeSymbol)global.GetTypeMembers("CustomModifierOverridingB")
                .Single();
            var classC = (NamedTypeSymbol)global.GetTypeMembers("CustomModifierOverridingC")
                .Single();
            var classD = (NamedTypeSymbol)global.GetTypeMembers("CustomModifierOverridingD")
                .Single();
            ...
            //Source
            var classE = (NamedTypeSymbol)global.GetTypeMembers("CustomModifierOverridingE")
                .Single();
...
";
            ...
            var baseMethod1 = baseType.GetMembers("Method")
                .OfType<MethodSymbol>()
                .Single(m => m.CustomModifierCount() == 1);
            var baseMethod2 = baseType.GetMembers("Method")
                .OfType<MethodSymbol>()
                .Single(m => m.CustomModifierCount() == 1);
...
";
            ...
            var indexerA = global.GetMember<NamedTypeSymbol>("A")
                .GetMember<PropertySymbol>(WellKnownMemberNames.Indexer);
            var indexerB = global.GetMember<NamedTypeSymbol>("B")
                .GetMember<PropertySymbol>(WellKnownMemberNames.Indexer);
            var indexerC = global.GetMember<NamedTypeSymbol>("C")
                .GetMember<PropertySymbol>(WellKnownMemberNames.Indexer);
            var indexerD = global.GetMember<NamedTypeSymbol>("D")
                .GetMember<PropertySymbol>(WellKnownMemberNames.Indexer);
