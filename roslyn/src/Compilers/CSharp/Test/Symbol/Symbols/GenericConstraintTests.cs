            ...
            CreateCompilation(source)
                .VerifyDiagnostics(
                    ...
                    Diagnostic(ErrorCode.ERR_InterfaceMemberNotFound, "M2")
                        .WithArguments("C.M2<U>()"),
                    // (5,11): error CS0535: 'C' does not implement interface member 'I<string>.M1<U>()'
                    Diagnostic(ErrorCode.ERR_UnimplementedInterfaceMember, "I<string>")
                        .WithArguments("C", "I<string>.M1<U>()")
                );
        }
    ...
    void M<U>() where U : U;
            ...
            CreateCompilation(source)
                .VerifyDiagnostics(
                    ...
                    Diagnostic(ErrorCode.ERR_CircularConstraint, "T")
                        .WithArguments("T", "T")
                        .WithLocation(5, 14),
                    // (8, 12): error CS0454: Circular constraint dependency involving 'U' and 'U'
                    Diagnostic(ErrorCode.ERR_CircularConstraint, "U")
                        .WithArguments("U", "U")
                        .WithLocation(8, 12)
                );
        }
       ...
       o = new U(G());
            ...
            CreateCompilation(source)
                .VerifyDiagnostics(
                    ...
                    Diagnostic(ErrorCode.ERR_NewTyvarWithArgs, "new T(F())")
                        .WithArguments("T")
                        .WithLocation(5, 19),
                    ...
                    Diagnostic(ErrorCode.ERR_NameNotInContext, "G")
                        .WithArguments("G")
                        .WithLocation(6, 18)
                );
        }
    ...
    partial class B<U, V> where U : T where V : U, U, IB<T>, IB<T> { }
            ...
            CreateCompilation(source)
                .VerifyDiagnostics(
                    ...
                    Diagnostic(ErrorCode.ERR_DuplicateBound, "T")
                        .WithArguments("T", "U")
                        .WithLocation(13, 40),
                    // (14,52): error CS0405: Duplicate constraint 'U' for type parameter 'V'
                    Diagnostic(ErrorCode.ERR_DuplicateBound, "U")
                        .WithArguments("U", "V")
                        .WithLocation(14, 52),
                    // (14,62): error CS0405: Duplicate constraint 'C<T>.IB<T>' for type parameter 'V'
                    Diagnostic(ErrorCode.ERR_DuplicateBound, "IB<T>")
                        .WithArguments("C<T>.IB<T>", "V")
                        .WithLocation(14, 62)
                );
        }
    ...
    partial void F<U>() where U : T, I<T>, I<T> { }
            ...
            CreateCompilation(source)
                .VerifyDiagnostics(
                    ...
                    //     partial void F<U>() where U : T, I<T>, I<T> { }
                    Diagnostic(ErrorCode.ERR_DuplicateBound, "I<T>")
                        .WithArguments("I<T>", "U")
                        .WithLocation(5, 44)
                );
        }
        ...
        B.M<string, string>();
            ...
            CreateCompilationWithILAndMscorlib40(csharpSource, ilSource)
                .VerifyDiagnostics(
                    ...
                    //         B.M<string, string>();
                    Diagnostic(ErrorCode.ERR_CircularConstraint, "M<string, string>")
                        .WithArguments("T", "U")
                        .WithLocation(6, 11)
                );
        }
...
public class A { }";
            var compilation1 = CreateCompilation(
                source1,
                assemblyName: "d521fe98-c881-45cf-0788-249e00d004ea"
            );
...
public interface I { }";
            var compilation1 = CreateCompilation(
                source1,
                assemblyName: "d521fe98-c881-45cf-8870-249e00ae400d"
            );
            compilation1.VerifyDiagnostics();
            var source2 =
...
public class A3
{
    public static void M<T>() where T : B3, T { }
            ...
            var compilation2 = CreateCompilation(
                source2,
                assemblyName: "d03a3229-eb22-4682-88df-77efaa348e3b",
                references: new MetadataReference[] { new CSharpCompilationReference(compilation1) }
            );
            compilation2.VerifyDiagnostics(
...
class B: A
{
    public override I<U> F<U>() { return null; }
            ...
            Assert.Equal(
                "I<U> B.F<U>() where U : class",
                method.ToDisplayString(SymbolDisplayFormat.TestFormatWithConstraints)
            );
        }
        ...
        where T2 : I<T1>;
            ...
            CreateCompilation(source)
                .VerifyDiagnostics(
                    ...
                    //         t.ToString();
                    Diagnostic(ErrorCode.ERR_NameNotInContext, "t")
                        .WithArguments("t")
                        .WithLocation(13, 9),
                    // (14,9): error CS0103: The name 'u' does not exist in the current context
                    //         u.ToString();
                    Diagnostic(ErrorCode.ERR_NameNotInContext, "u")
                        .WithArguments("u")
                        .WithLocation(14, 9),
    ...
    static void M()
    {
        ...
        o = typeof(IIn<object>.IOut); // CS0648 (not reported by Dev11)
            ...
            compilation1.VerifyDiagnostics(
                ...
                //         o = typeof(IT<object>.ITU2<object>); // CS0648
                Diagnostic(ErrorCode.ERR_BogusType, "ITU2<object>")
                    .WithArguments("IT<T>.ITU2<U>"),
...
";
            Action<CSharpCompilation> compilationVerifier = delegate(CSharpCompilation compilation)
            {
                ...
                Assert.Equal(
                    "I2",
                    i2.ToDisplayString(SymbolDisplayFormat.QualifiedNameArityFormat)
                );
            };
...
";
            Action<CSharpCompilation> compilationVerifier = delegate(CSharpCompilation compilation)
            {
                ...
                NamedTypeSymbol iEquatable = compilation.GetWellKnownType(
                ...
                NamedTypeSymbol iQueryable_T = compilation.GetWellKnownType(
                    WellKnownType.System_Linq_IQueryable_T
                );
                Assert.True(iQueryable_T.IsErrorType());
                Assert.Equal(1, iQueryable_T.Arity);

                NamedTypeSymbol iQueryable = compilation.GetWellKnownType(
                ...
                t = asm.LookupDeclaredOrForwardedTopLevelMetadataType(
                    ref mdName,
...
abstract class E : D, IB
{
    ...
    void IB.M2<X, Y>() { }
            ...
            Action<ModuleSymbol> validator = module =>
            {
                ...
                Assert.Equal(
                    "IA<A<T1>.B<object>>",
                    typeParameter.ConstraintTypes()[0].ToDisplayString()
                );
                CheckTypeParameterContainingSymbols(
                    method,
                    typeParameter.EffectiveBaseClassNoUseSiteDiagnostics,
                    0
                );
                CheckTypeParameterContainingSymbols(
                    method,
                    typeParameter.EffectiveInterfacesNoUseSiteDiagnostics[0],
                    1
                );
...
class C : I<object>, I<C>
{
    static void M()
    {
        ...
        /// </summary>
        private void CheckTypeParameterContainingSymbols(
        ...
        return (T[])x;
            ...
            CreateCompilation(source)
                .VerifyDiagnostics(
                    ...
                    Diagnostic(ErrorCode.ERR_NoExplicitConv, "(int[])x")
                        .WithArguments("object[]", "int[]")
                        .WithLocation(5, 16),
                    // (13,16): error CS0030: Cannot convert type 'T[]' to 'U[]'
                    Diagnostic(ErrorCode.ERR_NoExplicitConv, "(U[])x")
                        .WithArguments("T[]", "U[]")
                        .WithLocation(13, 16),
                    ...
                    Diagnostic(ErrorCode.ERR_NoExplicitConv, "(object[])x")
                        .WithArguments("int[]", "object[]")
                        .WithLocation(24, 16),
                    // (32,16): error CS0030: Cannot convert type 'U[]' to 'T[]'
                    Diagnostic(ErrorCode.ERR_NoExplicitConv, "(T[])x")
                        .WithArguments("U[]", "T[]")
                        .WithLocation(32, 16),
            ...
            CreateCompilation(source)
                .VerifyDiagnostics(
                    ...
                    Diagnostic(
                        ...
                        .WithArguments("C.M<T1, T2>()", "I<object>", "T2", "object")
                        .WithLocation(13, 9)
                );
        }
...
.class public R2<class (A) T> { }";
            ...
            CheckConstraints(
                @namespace.GetMember<NamedTypeSymbol>("O1").TypeParameters[0],
                TypeParameterConstraintKind.None,
                false,
                false,
                "object",
            ...
            CheckConstraints(
                @namespace.GetMember<NamedTypeSymbol>("O2").TypeParameters[0],
                TypeParameterConstraintKind.None,
                false,
                false,
                "object",
            ...
            CheckConstraints(
                @namespace.GetMember<NamedTypeSymbol>("V1").TypeParameters[0],
                TypeParameterConstraintKind.ValueType,
                true,
                false,
                "ValueType",
            ...
            CheckConstraints(
                @namespace.GetMember<NamedTypeSymbol>("V2").TypeParameters[0],
                TypeParameterConstraintKind.ValueType,
                true,
                false,
                "ValueType",
            ...
            CheckConstraints(
                @namespace.GetMember<NamedTypeSymbol>("V3").TypeParameters[0],
                TypeParameterConstraintKind.ValueType,
                true,
                false,
                "ValueType",
            ...
            CheckConstraints(
                @namespace.GetMember<NamedTypeSymbol>("V4").TypeParameters[0],
                TypeParameterConstraintKind.ValueType,
                true,
                false,
                "ValueType",
            ...
            CheckConstraints(
                @namespace.GetMember<NamedTypeSymbol>("V5").TypeParameters[0],
                TypeParameterConstraintKind.None,
                false,
                false,
                "ValueType",
            ...
            CheckConstraints(
                @namespace.GetMember<NamedTypeSymbol>("R1").TypeParameters[0],
                TypeParameterConstraintKind.None,
                false,
                true,
                "A",
            ...
            CheckConstraints(
                @namespace.GetMember<NamedTypeSymbol>("R2").TypeParameters[0],
                TypeParameterConstraintKind.ReferenceType,
                false,
                true,
                "A",
...
.class public B2 extends class A<class [mscorlib]System.ValueType>
{
  ...
  .method public virtual instance void M2<valuetype (class [mscorlib]System.ValueType)U>() { ret }
            ...
            CheckConstraints(
                type.GetMember<MethodSymbol>("M1").TypeParameters[0],
                TypeParameterConstraintKind.None,
                false,
                false,
                "object",
            ...
            CheckConstraints(
                type.GetMember<MethodSymbol>("M2").TypeParameters[0],
                TypeParameterConstraintKind.ValueType,
                true,
                false,
                "ValueType",
...
class D0 : D<object>
{
            ...
            CheckConstraints(
                type.Interfaces()[0].GetMember<MethodSymbol>("M").TypeParameters[0],
                TypeParameterConstraintKind.None,
                false,
                false,
                "object",
            ...
            CheckConstraints(
                type.GetMember<MethodSymbol>("M").TypeParameters[0],
                TypeParameterConstraintKind.None,
                false,
                false,
                "object",
            ...
            CheckConstraints(
                type.GetMethod("I<System.Object>.M").TypeParameters[0],
                TypeParameterConstraintKind.None,
                false,
                false,
                "object",
            ...
            CheckConstraints(
                type.BaseType().GetMember<MethodSymbol>("M").TypeParameters[0],
                TypeParameterConstraintKind.None,
                false,
                false,
                "object",
...
class D2 : D<A>
{
    ...
    public override void M4<U>() { }
            ...
            CheckConstraints(
                type.GetMember<MethodSymbol>("M3").TypeParameters[0],
                TypeParameterConstraintKind.None,
                false,
                true,
                "A",
            ...
            CheckConstraints(
                type.GetMember<MethodSymbol>("M4").TypeParameters[0],
                TypeParameterConstraintKind.None,
                false,
                true,
                "B",
...
";
        ...
        {
            var csCompilation = CreateCSharpCompilation(
                "InheritedObjectConstraint2CS",
                @"using System;
...
End Module",
        ...
        )
        {
            ...
            Utils.CheckSymbol(
                typeParameter.EffectiveBaseClassNoUseSiteDiagnostics,
                effectiveBaseClassDescription
            );
            Utils.CheckSymbol(
                typeParameter.DeducedBaseTypeNoUseSiteDiagnostics,
                ...
                .VerifyDiagnostics(
                    ...
                    Diagnostic(ErrorCode.ERR_BadInstanceArgType, "o")
                        .WithArguments(
                            "U",
                            "E2",
                            "M.E2(System.Collections.Generic.IEnumerable<object>)",
...
public class Test5
{
    public static void RunTest()
    {
        ...
        GStruct<int, int> obj15 = new GStruct<int, int>();
            ...
            CreateCompilationWithILAndMscorlib40(source, ilSource, appendDefaultHeader: false)
                .VerifyDiagnostics();
        }
...
public interface IA { }";
            var compilation1 = CreateCompilation(
                source1,
                assemblyName: "e521fe98-c881-45cf-8870-249e00ae400d"
            );
            compilation1.VerifyDiagnostics();
            var source2 =
                @"public class B : A { }
    ...
    public override void F<T>() { }
        ...
        public void Bug654522()
        {
            var compilation = CreateCompilationWithMscorlib40AndSystemCore(
                    "public interface I<W> where W : struct {}"
                )
                .VerifyDiagnostics();

            Action<ModuleSymbol> metadataValidator = delegate(ModuleSymbol module)
            {
...
";
            CompileAndVerify(source, options: TestOptions.DebugDll)
                .VerifyDiagnostics(
                    ...
                    // class Class3<T> where T : Class2
                    Diagnostic(ErrorCode.WRN_DeprecatedSymbol, "Class2")
                        .WithArguments("Class2")
                        .WithLocation(12, 27),
        ...
        [
            Fact,
            WorkItem(
                "https://devdiv.visualstudio.com/DefaultCollection/DevDiv/_workitems?id=278264"
            )
        ]
    ...
    static void Main(string[] args)
    {
        ...
        r.f<int>();
            ...
            compilation.VerifyDiagnostics(
                ...
                // class R2 : R1<int *>
                Diagnostic(ErrorCode.ERR_BadTypeArgument, "R2")
                    .WithArguments("int*")
                    .WithLocation(6, 7)
            );
        ...
        provider.GetService<>();
            ...
            CreateCompilation(source)
                .VerifyDiagnostics(
                    ...
                    //         provider.GetService<>();
                    Diagnostic(ErrorCode.ERR_HasNoTypeVars, "GetService<>")
                        .WithArguments("I.GetService()", "method")
                        .WithLocation(12, 18),
                    // (13,9): error CS8389: Omitting the type argument is not allowed in the current context
                    //         provider.GetService<>().ToString();
                    Diagnostic(ErrorCode.ERR_OmittedTypeArgument, "provider.GetService<>")
        ...
        provider.GetService<>().ToString();
            ...
            CreateCompilation(source)
                .VerifyDiagnostics(
                    ...
                    //         provider.GetService<>();
                    Diagnostic(ErrorCode.ERR_BadArity, "provider.GetService<>")
                        .WithArguments("GetService", "method group", "1")
                        .WithLocation(26, 9),
...
";
            var metadataComp = CreateEmptyCompilation(
                code,
                new[] { MscorlibRef_v20 },
            ...
            CompileAndVerify(
                comp.WithOptions(
                    comp.Options.WithSpecificDiagnosticOptions("CS1701", ReportDiagnostic.Suppress)
                ),
                expectedOutput: "C+D"
            );
        ...
        public void RecursiveConstraintsFromUnifiedAssemblies_2()
        {
            ...
            var remappedComp11 = CreateCompilation(
                new AssemblyIdentity(
                    "remapped",
                    new Version("1.0.0.0"),
                    publicKeyOrToken: SigningTestHelpers.PublicKey,
                    hasPublicKey: true
                ),
                new[] { remappedCode },
...
";
            ...
            var metadataComp = CreateCompilation(
                code,
                new[] { remappedComp11.EmitToImageReference() },
                assemblyName: "intermediate",
            ...
            comp.VerifyDiagnostics(
                ...
                Diagnostic(ErrorCode.WRN_UnifyReferenceMajMin)
                    .WithArguments(
                        ...
                        "intermediate",
                        "remapped, Version=2.0.0.0, Culture=neutral, PublicKeyToken=ce65828c82a341f2",
                        "remapped"
                    )
                    .WithLocation(1, 1)
            );
...
""";
            ...
            var nest = tree.GetRoot()
                ...
                .Where(i => i.Identifier.ValueText == "Nest")
                .Single();
