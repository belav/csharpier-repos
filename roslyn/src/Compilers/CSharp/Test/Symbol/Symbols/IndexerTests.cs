...
class C : IB, IC
{
    ...
    public object this[string index]
    {
        ...
        set { }
            ...
            Assert.True(
                bridgeMethods.Select(GetPairForSynthesizedExplicitImplementation)
                    .SetEquals(
                        new[]
                        {
...
";
            ...
            CompileWithCustomILSource(
                ...
                compilation =>
                {
                    ...
                    var synthesizedExplicitImplementation =
                        @class.GetSynthesizedExplicitImplementations(default(CancellationToken))
                            .Single();
...
";
            ...
            Action<ModuleSymbol> sourceValidator = module =>
            {
                ...
                var classCIndexer = classC.GetMembers()
...
";
            ...
            Assert.True(
                model.GetIndexerGroup(receiverSyntaxes[1])
                    .SetEquals(
            ...
            Assert.True(
                model.GetIndexerGroup(receiverSyntaxes[2])
                    .SetEquals(
