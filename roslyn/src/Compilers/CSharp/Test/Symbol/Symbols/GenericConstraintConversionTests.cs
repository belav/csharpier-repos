        ...
        b = u;
            ...
            CreateCompilation(source)
                .VerifyDiagnostics(
                    ...
                    Diagnostic(ErrorCode.ERR_NoImplicitConvCast, "u")
                        .WithArguments("U", "IB")
                        .WithLocation(25, 14),
        ...
        x = w;
            ...
            CreateCompilation(source)
                .VerifyDiagnostics(
                    ...
                    Diagnostic(ErrorCode.ERR_NoImplicitConv, "w")
                        .WithArguments("W", "V")
                        .WithLocation(19, 13),
            ...
            CreateCompilation(source)
                .VerifyDiagnostics(
                    ...
                    Diagnostic(ErrorCode.WRN_UnreferencedFieldAssg, "F2")
                        .WithArguments("B<T1, T2, T3, T4, T5, T6>.F2"),
                    // (15,15): warning CS0414: The field 'B<T1, T2, T3, T4, T5, T6>.F6' is assigned but its value is never used
                    //     static T6 F6 = null;
                    Diagnostic(ErrorCode.WRN_UnreferencedFieldAssg, "F6")
                        .WithArguments("B<T1, T2, T3, T4, T5, T6>.F6")
                );
        }
        ...
        u = (U)b2;
            ...
            CreateCompilation(source)
                .VerifyDiagnostics(
                    ...
                    Diagnostic(ErrorCode.ERR_NoExplicitConv, "(T)b1t")
                        .WithArguments("B1<T>", "T")
                        .WithLocation(14, 13),
                    // (16,13): error CS0030: Cannot convert type 'B2' to 'T'
                    Diagnostic(ErrorCode.ERR_NoExplicitConv, "(T)b2")
                        .WithArguments("B2", "T")
                        .WithLocation(16, 13),
                    // (21,13): error CS0030: Cannot convert type 'B1<object>' to 'U'
                    Diagnostic(ErrorCode.ERR_NoExplicitConv, "(U)b1o")
                        .WithArguments("B1<object>", "U")
                        .WithLocation(21, 13),
                    // (22,13): error CS0030: Cannot convert type 'B2' to 'U'
                    Diagnostic(ErrorCode.ERR_NoExplicitConv, "(U)b2")
                        .WithArguments("B2", "U")
                        .WithLocation(22, 13)
                );
        }
        ...
        v = (V)w;
            ...
            CreateCompilation(source)
                .VerifyDiagnostics(
                    ...
                    //     static W w;
                    Diagnostic(ErrorCode.WRN_UnassignedInternalField, "w")
                        .WithArguments("C<T, U, V, W>.w", "")
                );
        }
        ...
        t = (int)u;
            ...
            CreateCompilation(source)
                .VerifyDiagnostics(
                    ...
                    Diagnostic(ErrorCode.ERR_NoExplicitConv, "(U)t")
                        .WithArguments("int", "U")
                        .WithLocation(10, 13),
                    ...
                    Diagnostic(ErrorCode.ERR_NoExplicitConv, "(int)u")
                        .WithArguments("U", "int")
                        .WithLocation(12, 13)
                );
        }
    ...
    static T F4<T>(C4<T> c) { return (T)c; }
            ...
            CreateCompilation(source)
                .VerifyDiagnostics(
                    ...
                    Diagnostic(ErrorCode.ERR_NoExplicitConv, "(C0)t")
                        .WithArguments("T", "C0")
                        .WithLocation(17, 48),
                    // (21,38): error CS0030: Cannot convert type 'C4<T>' to 'T'
                    Diagnostic(ErrorCode.ERR_NoExplicitConv, "(T)c")
                        .WithArguments("C4<T>", "T")
                        .WithLocation(21, 38)
                );
        }
