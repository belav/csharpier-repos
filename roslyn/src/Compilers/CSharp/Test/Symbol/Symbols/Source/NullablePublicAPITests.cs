...
";
            ...
            comp.VerifyDiagnostics(
                ...
                //         C[] arr2 = (C[])arr1;
                Diagnostic(ErrorCode.WRN_NullabilityMismatchInAssignment, "(C[])arr1")
                    .WithArguments("C?[]", "C[]")
                    .WithLocation(6, 20),
            ...
            var arrayAccesses = root.DescendantNodes()
...
";
            ...
            void verifyCompilation(CSharpCompilation compilation)
            {
                ...
                members = e.GetMembers()
                    .OfType<IMethodSymbol>()
                    .Where(m => m.Name.StartsWith("M"))
                    .Select(m => m.ReduceExtensionMethod(m.Parameters[0].Type))
                    .ToArray();
                assertNullability(
                    members,
                    PublicNullableAnnotation.NotAnnotated,
            ...
            VerifyAcrossCompilations(
                ...
                comp =>
                {
                    ...
                    return syntaxTree.GetRoot()
                        .DescendantNodes()
                        .OfType<CSharp.Syntax.LocalFunctionStatementSyntax>()
                        .Select(func => semanticModel.GetDeclaredSymbol(func))
                        .Cast<IMethodSymbol>()
                        .ToArray();
                },
                method =>
                {
                    Assert.Equal(
                        ...
                        method.Parameters[0].NullableAnnotation
                    );
                    Assert.Equal(
                        method.ReturnNullableAnnotation,
    ...
    public event D? D4;
            ...
            VerifyAcrossCompilations(
                ...
                new[]
                {
                    ...
                    //     public event D D1;
                    Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "D1")
                        .WithArguments("event", "D1")
                        .WithLocation(8, 20),
    ...
    A<int?> F8();
            ...
            VerifyAcrossCompilations(
                ...
                method =>
                {
                    ...
                    Assert.Equal(
                        result,
                        typeParameterSymbol.ConstraintNullableAnnotations.Single()
                    );
                    return result;
                },
                testMetadata: true,
...
#nullable disable
        ...
        private static void VerifyAcrossCompilations<T>(
            string source,
...
enum E2
{
    A2 = E1.A1
            ...
            _ = model.GetTypeInfoAndVerifyIOperation(
...
class C
{
    void M()
    {
        ...
        var o2 = o;
            ...
            comp.VerifyDiagnostics();
            comp.VerifyAnalyzerDiagnostics(
                new[] { new NullabilityPrinter() },
                null,
                null,
                Diagnostic("CA9998_NullabilityPrinter", "o = null")
                    .WithArguments("o", "Annotated")
                    .WithLocation(6, 17),
                Diagnostic("CA9998_NullabilityPrinter", "o1 = o")
                    .WithArguments("o1", "Annotated")
                    .WithLocation(7, 13),
                Diagnostic("CA9999_NullabilityPrinter", "o")
                    .WithArguments("o", "MaybeNull", "Annotated", "MaybeNull")
                    .WithLocation(7, 18),
                Diagnostic("CA9999_NullabilityPrinter", "o")
                    .WithArguments("o", "MaybeNull", "Annotated", "MaybeNull")
                    .WithLocation(8, 13),
                Diagnostic("CA9998_NullabilityPrinter", "o2 = o")
                    .WithArguments("o2", "Annotated")
                    .WithLocation(9, 13),
                Diagnostic("CA9999_NullabilityPrinter", "o")
                    .WithArguments("o", "NotNull", "NotAnnotated", "NotNull")
                    .WithLocation(9, 18)
            );
        }
        ...
        private class NullabilityPrinter : DiagnosticAnalyzer
        {
            public override ImmutableArray<DiagnosticDescriptor> SupportedDiagnostics =>
                ImmutableArray.Create(s_descriptor1, s_descriptor2);

            private static readonly DiagnosticDescriptor s_descriptor1 = new DiagnosticDescriptor(
                id: "CA9999_NullabilityPrinter",
                title: "CA9999_NullabilityPrinter",
                messageFormat: "Nullability of '{0}' is '{1}':'{2}'. Speculative flow state is '{3}'",
                category: "Test",
                defaultSeverity: DiagnosticSeverity.Warning,
                isEnabledByDefault: true
            );
            private static readonly DiagnosticDescriptor s_descriptor2 = new DiagnosticDescriptor(
                id: "CA9998_NullabilityPrinter",
                title: "CA9998_NullabilityPrinter",
                messageFormat: "Declared nullability of '{0}' is '{1}'",
                category: "Test",
                defaultSeverity: DiagnosticSeverity.Warning,
                isEnabledByDefault: true
            );
    ...
    void M()
    {
        var x = new Undefined() ? new object() : null;
            ...
            comp.VerifyDiagnostics(
                ...
                //         var x = new Undefined() ? new object() : null;
                Diagnostic(ErrorCode.ERR_SingleTypeNameNotFound, "Undefined")
            ...
            var notNull = new NullabilityInfo(
                PublicNullableAnnotation.NotAnnotated,
                PublicNullableFlowState.NotNull
            );
            var @null = new NullabilityInfo(
                PublicNullableAnnotation.Annotated,
                PublicNullableFlowState.MaybeNull
            );
...
class C
{
    void M(string? s1)
    {
        ...
        var s2 = s1 == null ? """" : s1;
            ...
            var conditionalAccessExpression = root.DescendantNodes()
            ...
            verifySpeculativeModel(
                ifStatement.Statement.SpanStart,
                PublicNullableFlowState.NotNull
            );

            // Before the conditional access
            verifySpeculativeModel(
                conditionalAccessExpression.SpanStart,
                PublicNullableFlowState.MaybeNull
            );

            // After the conditional access
            verifySpeculativeModel(
                conditionalAccessExpression.WhenNotNull.SpanStart,
                PublicNullableFlowState.NotNull
            );
            ...
            void verifySpeculativeModel(int spanStart, PublicNullableFlowState conditionFlowState)
            {
                ...
                var referenceTypeInfo = speculativeModel.GetSpeculativeTypeInfo(
                    whenTrue.SpanStart,
                    newReference,
                ...
                var coalesceTypeInfo = speculativeModel.GetSpeculativeTypeInfo(
                    whenTrue.SpanStart,
                    newCoalesce,
                    SpeculativeBindingOption.BindAsExpression
                );
                ...
                Assert.Equal(conditionFlowState, speculativeTypeInfo.Nullability.FlowState);
                referenceTypeInfo = speculativeModel.GetSpeculativeTypeInfo(
                    whenFalse.SpanStart,
                    newReference,
                    SpeculativeBindingOption.BindAsExpression
                );
                ...
                coalesceTypeInfo = speculativeModel.GetSpeculativeTypeInfo(
                    whenFalse.SpanStart,
                    newCoalesce,
                    SpeculativeBindingOption.BindAsExpression
                );
...
class C
{
    object? Foo
    {
        get
        {
            ...
            var yReference =
                (
                    (MemberAccessExpressionSyntax)newSource.DescendantNodes()
                        .OfType<InvocationExpressionSyntax>()
                        .Single().Expression
                ).Expression;
            Assert.True(
    ...
    void M(C? x, C x2)
    {
        ...
        (object a, int b) t4 = (default(object), default(int)) /*T:(object?, int)*/ /*CT:(object! a, int b)*/; // 3
            ...
            comp.VerifyDiagnostics(
                ...
                //         (object a, int b) t2 = (x, (short)0)/*T:(C? x, short)*/ /*CT:(object! a, int b)*/; // 1
                Diagnostic(ErrorCode.WRN_NullabilityMismatchInAssignment, "(x, (short)0)")
                    .WithArguments("(object? x, int)", "(object a, int b)")
                    .WithLocation(9, 32),
                // (10,32): warning CS8619: Nullability of reference types in value of type '(object?, int)' doesn't match target type '(object a, int b)'.
                //         (object a, int b) t3 = (default, default) /*T:<null>!*/ /*CT:(object! a, int b)*/; //2
                Diagnostic(ErrorCode.WRN_NullabilityMismatchInAssignment, "(default, default)")
...
class C
{
    ...
    string M(string? s1)
    {
        ...
        return null!;
            ...
            {
                var specTypeInfo = model.GetSpeculativeTypeInfo(
                    position,
                    newReference,
                    SpeculativeBindingOption.BindAsExpression
                );
                Assert.Equal(expectedFlowState, specTypeInfo.Nullability.FlowState);
                specTypeInfo = model.GetSpeculativeTypeInfo(
                    position,
                    newCoalesce,
                    SpeculativeBindingOption.BindAsExpression
                );
...
class C
{
    ...
    static string? GetNullableString() => null;
            ...
            comp.VerifyDiagnostics(
                ...
                //     private static string s_data;
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "s_data")
                    .WithArguments("field", "s_data")
                    .WithLocation(6, 27),
                // (6,27): warning CS0649: Field 'C.s_data' is never assigned to, and will always have its default value null
                //     private static string s_data;
                Diagnostic(ErrorCode.WRN_UnassignedInternalField, "s_data")
                    .WithArguments("C.s_data", "null")
                    .WithLocation(6, 27)
            );
...
class C
{
    ...
    static string? GetNullableString() => null;
            ...
            comp.VerifyDiagnostics(
                ...
                //         NonexistentDelegateType a = () => {
                Diagnostic(ErrorCode.ERR_SingleTypeNameNotFound, "NonexistentDelegateType")
                    .WithArguments("NonexistentDelegateType")
                    .WithLocation(9, 9)
            );
...
";
            ...
            comp.VerifyDiagnostics(
                ...
                Diagnostic(ErrorCode.ERR_NullableOptionNotAvailable)
                    .WithArguments("NullableContextOptions", "Enable", "7.3", "8.0")
                    .WithLocation(1, 1)
            );
    ...
    void M(string? s)
    {
        ...
        _ = Identity(s);
            ...
            static void verifySymbolInfo(
                ...
                Assert.Equal(
                    expectedAnnotation,
                    methodSymbol.TypeArguments.Single().NullableAnnotation
                );
                Assert.Equal(
                    expectedAnnotation,
                    methodSymbol.Parameters.Single().NullableAnnotation
                );
                Assert.Equal(
                    expectedAnnotation,
                    methodSymbol.Parameters.Single().Type.NullableAnnotation
                );
...
class C
{
    void M(string? s1, string s2)
    {
        ...
        string o4 = s2;        
            ...
            var lastDeclaration = root.DescendantNodes()
                .OfType<VariableDeclaratorSyntax>()
                .ElementAt(3);
            var newDeclaration = SyntaxFactory.ParseStatement("var o5 = s2;");
            var newDeclarator = newDeclaration.DescendantNodes()
                .OfType<VariableDeclaratorSyntax>()
                .Single();

            Assert.True(
                model.TryGetSpeculativeSemanticModel(
                    s2Assignment.SpanStart,
                    newDeclaration,
                    out var specModel
                )
            );
...
";
            ...
            var comp = CreateCompilation(
                source,
                options: WithNullableEnable().WithAllowUnsafe(true)
            );
            comp.VerifyDiagnostics(
...
";
            ...
            var comp = CreateCompilation(
                source,
                parseOptions: TestOptions.Regular8.WithFeature("run-nullable-analysis", flagState)
            );
            ...
            var sRef = root.DescendantNodes()
                .OfType<IdentifierNameSyntax>()
                .Where(n => n.Identifier.ValueText == "s")
                .Single();
...
class C
{
    ...
    private class F<T>
    {
        ...
        public T Item { get; }
            ...
            var select = root.DescendantNodes()
                .OfType<IdentifierNameSyntax>()
                .Where(i => i.Identifier.ValueText == "Select")
                .Single();
    ...
    static void M(object? o)
    {
        ...
        _ = c2.GetT;
            ...
            comp.VerifyDiagnostics(
                ...
                //     public T GetT { get; }
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "GetT")
                    .WithArguments("property", "GetT")
                    .WithLocation(4, 14)
            );
    ...
    static void M(object? o)
    {
        ...
        _ = c2.GetT;
            ...
            comp.VerifyDiagnostics(
                ...
                //     public T GetT;
                Diagnostic(ErrorCode.WRN_UninitializedNonNullableField, "GetT")
                    .WithArguments("field", "GetT")
                    .WithLocation(4, 14),
                // (4,14): warning CS0649: Field 'C<T>.GetT' is never assigned to, and will always have its default value
                //     public T GetT;
                Diagnostic(ErrorCode.WRN_UnassignedInternalField, "GetT")
                    .WithArguments("C<T>.GetT", "")
                    .WithLocation(4, 14)
            );
...
";
            ...
            verifyAnnotation(
                collectionInitializer.Expressions[1],
                PublicNullableAnnotation.NotAnnotated
            );
            verifyAnnotation(
                collectionInitializer.Expressions[2],
                PublicNullableAnnotation.NotAnnotated
            );
            verifyAnnotation(
                collectionInitializer.Expressions[3],
                PublicNullableAnnotation.NotAnnotated
            );
...
";
            ...
            void verifyAnnotation(
                ...
                Assert.Equal(
                    expectedAnnotation,
                    ((IMethodSymbol)symbolInfo.Symbol).TypeArgumentNullableAnnotations[1]
                );
                Assert.Equal(
                    expectedAnnotation,
                    ((IMethodSymbol)symbolInfo.Symbol).TypeArguments[1].NullableAnnotation
                );
            }
        }
...
";
            ...
            comp.VerifyDiagnostics(
                ...
                //         _ = new C() { o1, Identity(o1 ??= new object()), o1, o2 };
                Diagnostic(ErrorCode.ERR_AmbigCall, "o1")
                    .WithArguments("CExt1.Add<T>(C, T)", "CExt2.Add<T>(C, T)")
                    .WithLocation(10, 23),
                // (10,27): error CS0121: The call is ambiguous between the following methods or properties: 'CExt1.Add<T>(C, T)' and 'CExt2.Add<T>(C, T)'
                //         _ = new C() { o1, Identity(o1 ??= new object()), o1, o2 };
                Diagnostic(ErrorCode.ERR_AmbigCall, "Identity(o1 ??= new object())")
                    .WithArguments("CExt1.Add<T>(C, T)", "CExt2.Add<T>(C, T)")
                    .WithLocation(10, 27),
                ...
                //         _ = new C() { o1, Identity(o1 ??= new object()), o1, o2 };
                Diagnostic(ErrorCode.ERR_AmbigCall, "o2")
                    .WithArguments("CExt1.Add<T>(C, T)", "CExt2.Add<T>(C, T)")
                    .WithLocation(10, 62)
            );
...
static class CExt
{
    public static C<T, U> Create<T, U>(T t, U u) => throw null!;
            ...
            comp.VerifyDiagnostics(
                ...
                //         if (b) c1[o1] = o2;
                Diagnostic(ErrorCode.WRN_NullReferenceArgument, "o1")
                    .WithArguments("u", "object? C<object?, object>.this[object u]")
                    .WithLocation(9, 19),
            ...
            void verifyAnnotation(
                ...
                void verifyIndexer(IPropertySymbol propertySymbol)
                {
                    ...
                    Assert.Equal(
                        secondAnnotation,
                        propertySymbol.Parameters[0].Type.NullableAnnotation
                    );
                }
            }
        }
    ...
    static void F<T>() where T : class, new()
    {
        ...
        _ = ~sy;
            ...
            void verifyAnnotations(
                ...
                Assert.Equal(
                    annotation,
                    method.ContainingType.TypeArgumentNullableAnnotations().First()
                );
            }
        }
...
class C
{
    ...
    public static void M(object? o)
    {
        var a = Create(o, o1 => { _ = o1.ToString(); });
            ...
            var mDeclaration = root.DescendantNodes()
...
class C
{
    ...
    public static void M(object? o)
    {
        var a = Create(o, o1 => {
            ...
            Assert.Equal(
                lambdaSymbol,
                innerLambdaSymbol.ContainingSymbol,
                SymbolEqualityComparer.IncludeNullability
            );
...
class C
{
    ...
    public static void M(object? o)
    {
        var a = Create(o, o1 => {
            ...
            var localFunction = lambda.DescendantNodes()
                .OfType<LocalFunctionStatementSyntax>()
                .Single();
            var localFunctionSymbol = (IMethodSymbol)model.GetDeclaredSymbol(localFunction);

            var o2Reference = localFunction.DescendantNodes()
                .OfType<IdentifierNameSyntax>()
                .Single(id => id.Identifier.ValueText == "o2");
            var o2Symbol = model.GetSymbolInfo(o2Reference).Symbol;

            Assert.Equal(
                lambdaSymbol,
                localFunctionSymbol.ContainingSymbol,
                SymbolEqualityComparer.IncludeNullability
            );
            Assert.Equal(
                localFunctionSymbol,
...
class C
{
    ...
    C M()
    {
        ...
        string local()
        {
            ...
            Assert.Equal(
                "System.String!",
                typeInfo.ConvertedType.ToTestDisplayString(includeNonNullable: true)
            );
            var @return = (ReturnStatementSyntax)SyntaxFactory.ParseStatement("return s;");
            Assert.True(
                model.TryGetSpeculativeSemanticModel(
                    localFunctionBody.Body!.OpenBraceToken.SpanStart + 1,
                    @return,
                    out var specModel
                )
            );
...
class C
{
    ...
    C M()
    {
        ...
        return null!;
            ...
            Assert.True(
                model.TryGetSpeculativeSemanticModel(
                    localFunctionBody.Block!.OpenBraceToken.SpanStart + 1,
                    @return,
                    out var specModel
                )
            );
    ...
    public static void M(object? o)
    {
        var a = Create(o, o1 => 
        {
            ...
            comp.VerifyDiagnostics(
                ...
                //             void localFunc(out object? o)
                Diagnostic(ErrorCode.WRN_UnreferencedLocalFunction, "localFunc")
            ...
            var innerLambda = root.DescendantNodes().OfType<LambdaExpressionSyntax>().ElementAt(1);
            var innerO2Reference = innerLambda.DescendantNodes()
                .OfType<IdentifierNameSyntax>()
                .Single(id => id.Identifier.ValueText == "o2");
            ...
            var o8Declaration = localFunction.DescendantNodes()
                .OfType<VariableDeclaratorSyntax>()
                .Single();
            Assert.Equal(
                localFunctionSymbol,
                model.GetDeclaredSymbol(o8Declaration).ContainingSymbol,
                SymbolEqualityComparer.IncludeNullability
            );
            ...
            void assertParent(SyntaxNode node)
            {
                Assert.Equal(
                    lambdaSymbol,
                    model.GetDeclaredSymbol(node).ContainingSymbol,
                    SymbolEqualityComparer.IncludeNullability
                );
            }
        }
...
";
            ...
            var o1Reference = fieldLambda.DescendantNodes()
                .OfType<IdentifierNameSyntax>()
                .Single(id => id.Identifier.ValueText == "o1");
            ...
            var propertyLambda = root.DescendantNodes()
                .OfType<LambdaExpressionSyntax>()
                .ElementAt(1);
            var propertyLambdaSymbol = model.GetSymbolInfo(propertyLambda).Symbol;
            var o3Reference = propertyLambda.DescendantNodes()
                .OfType<IdentifierNameSyntax>()
                .Single(id => id.Identifier.ValueText == "o3");
            var o3Symbol = (IParameterSymbol)model.GetSymbolInfo(o3Reference).Symbol;
            var o4Decl = propertyLambda.DescendantNodes()
                .OfType<VariableDeclaratorSyntax>()
                .Single();
            ...
            Assert.Equal(
                propertyLambdaSymbol,
                o3Symbol.ContainingSymbol,
                SymbolEqualityComparer.IncludeNullability
            );
            Assert.Equal(
                propertyLambdaSymbol,
                o4Symbol.ContainingSymbol,
                SymbolEqualityComparer.IncludeNullability
            );
        }
...
class C
{
    ...
    public static void M(object? o)
    {
        var a = Create(o, o1 => {
            ...
            Assert.Equal(
                lambdaSymbol,
                innerLambdaSymbol1.ContainingSymbol,
                SymbolEqualityComparer.IncludeNullability
            );
            Assert.Equal(
                PublicNullableAnnotation.NotAnnotated,
    ...
    public static void M(object? o)
    {
        var a = Create(o, o1 => 
        {
            ...
            comp.VerifyDiagnostics(
                ...
                //             void localFunc([A(o1)] object o3 = o2)
                Diagnostic(ErrorCode.ERR_DefaultValueMustBeConstant, "o2")
                    .WithArguments("o3")
                    .WithLocation(18, 48)
            );
            ...
            Assert.Equal(
                o2Symbol,
                speculativeModel.GetSymbolInfo(speculativeO2Ref).Symbol,
                SymbolEqualityComparer.IncludeNullability
            );

            var speculativeInitializer = SyntaxFactory.EqualsValueClause(
                SyntaxFactory.ParseExpression("o1")
            );
            var speculativeO1Ref = speculativeInitializer.Value;
            Assert.True(
                model.TryGetSpeculativeSemanticModel(
                    localFunction.ParameterList.Parameters[0].Default.SpanStart,
            ...
            Assert.Equal(
                o1Symbol,
                speculativeModel.GetSymbolInfo(speculativeO1Ref).Symbol,
                SymbolEqualityComparer.IncludeNullability
            );
        }
...
class C
{
    ...
    public static void M(object? o)
    {
        var a = Create(o, o1 => 
        {
            ...
            Assert.Equal(
                lambdaSymbol,
                o2Result.ContainingSymbol,
                SymbolEqualityComparer.IncludeNullability
            );
            Assert.Equal(
                localFunctionSymbol,
                o8Result.ContainingSymbol,
                SymbolEqualityComparer.IncludeNullability
            );
            ...
            Assert.Equal(
                lambdaSymbol,
                o1Result.ContainingSymbol,
                SymbolEqualityComparer.IncludeNullability
            );
            Assert.Equal(
                localFunctionSymbol,
                oResult.ContainingSymbol,
                SymbolEqualityComparer.IncludeNullability
            );

            var localFunctionResult = lookupResults.OfType<IMethodSymbol>()
                .First(m => m.MethodKind == MethodKind.LocalFunction);
            Assert.Equal(
                localFunctionSymbol,
                localFunctionResult,
                SymbolEqualityComparer.IncludeNullability
...
";
            ...
            var newAttributeUsage = SyntaxFactory.Attribute(
                SyntaxFactory.ParseName("Attr"),
                SyntaxFactory.ParseAttributeArgumentList("(Constant)")
            );

            Assert.True(
                model.TryGetSpeculativeSemanticModel(
                    attributeUsage.SpanStart,
                    newAttributeUsage,
                    out var specModel
                )
            );
            ...
            var symbolInfo = specModel.GetSymbolInfo(
                newAttributeUsage.ArgumentList.Arguments[0].Expression
            );
            Assert.Equal(
                SpecialType.System_String,
                ((IFieldSymbol)symbolInfo.Symbol).Type.SpecialType
            );
        }
    ...
    string M(out C c2)
    {
        ...
        return """";
            ...
            var newInitializer = SyntaxFactory.ConstructorInitializer(
                ...
                SyntaxFactory.ParseArgumentList(@"(M(out C c))")
            );
            Assert.True(
                model.TryGetSpeculativeSemanticModel(
            ...
            var type2 =
                newInitializer.DescendantNodes()
                    .OfType<DeclarationExpressionSyntax>()
                    .Single().Type;
            var symbol2 = speculativeModel.GetSymbolInfo(type2);
            Assert.Equal(
...
class C
{
    void M(out C c2)
    {
        ...
        c2 = c;
            ...
            var symbol2 = (IMethodSymbol)model.GetSpeculativeSymbolInfo(
...
class C
{
    ...
    string? M2() => null;
            ...
            var suppressions = tree.GetRoot()
                ...
                .Where(p => p.IsKind(SyntaxKind.SuppressNullableWarningExpression))
                .ToList();
...
";
            ...
            var ctorDecl = tree.GetRoot()
                ...
                .Single();
            var spanStart = ctorDecl.Body.OpenBraceToken.SpanStart;
            ...
            var newAccess = newBody.DescendantNodes()
                .OfType<MemberAccessExpressionSyntax>()
                .Single();
...
M();"
        ...
        public void GetDeclaredSymbolTopLevelStatementsWithLocalFunctionFirst(string code)
        {
            ...
            AssertEx.Equal(
                "void M()",
                model.GetDeclaredSymbol(localFunction).ToTestDisplayString()
            );
        }
...
";
            ...
            comp.VerifyDiagnostics(
                ...
                //         System.Console.WriteLine($"{x.a}");
                Diagnostic(ErrorCode.ERR_PredefinedTypeMemberNotFoundInAssembly, "a")
                    .WithArguments(
                        "Item1",
                        "(T1, T2)",
            ...
            var tupleLiteral = tree.GetRoot()
                ...
                .Single();
            AssertEx.Equal(
                "(System.String a, System.String b)",
                model.GetTypeInfo(tupleLiteral).Type.ToTestDisplayString(includeNonNullable: false)
            );
        }
...
",
        ...
        { 
            ...
            AssertEx.Equal(
                ...
                model.GetSymbolInfo(constructor).CandidateSymbols[0].ToTestDisplayString()
            );

            var assignmentsInLambda = constructor.DescendantNodes()
                .OfType<AssignmentExpressionSyntax>()
                .ToArray();
            ...
            AssertEx.Equal(
                "System.String?",
                model.GetTypeInfo(assignmentsInLambda[0].Right)
                    .Type.ToTestDisplayString(includeNonNullable: true)
            );
            AssertEx.Equal(
                "System.String!",
                model.GetTypeInfo(assignmentsInLambda[2].Right)
                    .Type.ToTestDisplayString(includeNonNullable: true)
            );
        }
        ...
        {
            var comp = CreateCompilation(
                @"string s = """" switch { _ => string.Empty };",
            ...
            var switchExpressionInput =
                tree.GetRoot()
                    ...
                    .Single().GoverningExpression;

            var model = comp.GetSemanticModel(tree);
            AssertEx.Equal(
                "System.String!",
                model.GetTypeInfo(switchExpressionInput)
                    .Type.ToTestDisplayString(includeNonNullable: true)
            );
