...
";
            ...
            var arrayAccesses = root.DescendantNodes()
                ...
                .ToList();
            var arrayTypes = arrayAccesses
                .Select(arr => model.GetTypeInfoAndVerifyIOperation(arr.Expression).Type)
...
class C
{
    ...
    void M1(C? c)
    {
        ...
        M(c);
            ...
            var expressionTypes = invocations
                .Select(inv => model.GetTypeInfoAndVerifyIOperation(inv).Type)
    ...
    void M(string?[] nullableStrings, string[] strings)
    {
        ...
        foreach (var o in strings) {}
            ...
            void assertAnnotation(
                ...
                PublicNullableAnnotation expectedElementTypeAnnotation
            )
            {
                var foreachInfo = model.GetForEachStatementInfo(foreachStatement);
                Assert.Equal(
                    expectedElementTypeAnnotation,
...
class C
{
    ...
    public static void M(object? o)
    {
        var a = Create(o, o1 => 
        {
            ...
            foreach (
                var singleVarDesignation in lambda
                    .DescendantNodes()
                    .OfType<SingleVariableDesignationSyntax>()
            )
            {
...
class C
{
    ...
    public static void M(object? o)
    {
        var a = Create(o, o1 => 
        {
            ...
            var localFunctionResult = lookupResults
                .OfType<IMethodSymbol>()
