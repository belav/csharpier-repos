...
public class C : B<int, long>
{
            ...
            var classBMethodM = (MethodSymbol)classB.GetMembers()
            ...
            var classCBaseMethodM = (MethodSymbol)classCBase.GetMembers()
                .Single(sym => sym.Name.EndsWith("M", StringComparison.Ordinal));
...
";
            ...
            var @interface = (NamedTypeSymbol)systemNamespace.GetTypeMembers("IFormattable")
                .Single();
            Assert.Equal(TypeKind.Interface, @interface.TypeKind);
            ...
            var classMethod = (MethodSymbol)@class.GetMembers("System.IFormattable.ToString")
                .Single();
            Assert.Equal(MethodKind.ExplicitInterfaceImplementation, classMethod.MethodKind);
...
";
            ...
            var substitutedInterfaceMethod = (MethodSymbol)substitutedInterface.GetMembers("Method")
                .Single();

            var classMethod = (MethodSymbol)@class.GetMembers("Namespace.I<System.Int32>.Method")
                .Single();
            Assert.Equal(MethodKind.ExplicitInterfaceImplementation, classMethod.MethodKind);
