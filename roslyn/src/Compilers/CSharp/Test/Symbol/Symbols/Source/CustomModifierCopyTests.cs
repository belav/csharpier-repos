...
";
            ...
            Assert.Equal(
                int32Type,
                baseIndexer.SetMethod.Parameters[0]
                    .TypeWithAnnotations
                    .CustomModifiers
                    .Single()
                    .Modifier()
            ...
            Assert.Equal(
                int32Type,
                derivedIndexer.SetMethod.Parameters[0]
                    .TypeWithAnnotations
                    .CustomModifiers
                    .Single()
                    .Modifier()
            ...
            Assert.Equal(
                int64Type,
                baseIndexer.SetMethod.Parameters[1]
                    .TypeWithAnnotations
                    .CustomModifiers
                    .Single()
                    .Modifier()
            ...
            Assert.Equal(
                int64Type,
                derivedIndexer.SetMethod.Parameters[1]
                    .TypeWithAnnotations
                    .CustomModifiers
                    .Single()
                    .Modifier()
...
";
            ...
            Assert.Equal(
                int32Type,
                interfaceIndexer.SetMethod.Parameters[0]
                    .TypeWithAnnotations
                    .CustomModifiers
                    .Single()
                    .Modifier()
            ...
            Assert.Equal(
                int32Type,
                implementationIndexer.SetMethod.Parameters[0]
                    .TypeWithAnnotations
                    .CustomModifiers
                    .Single()
                    .Modifier()
            ...
            Assert.Equal(
                int64Type,
                interfaceIndexer.SetMethod.Parameters[1]
                    .TypeWithAnnotations
                    .CustomModifiers
                    .Single()
                    .Modifier()
            ...
            Assert.Equal(
                int64Type,
                implementationIndexer.SetMethod.Parameters[1]
                    .TypeWithAnnotations
                    .CustomModifiers
                    .Single()
                    .Modifier()
