...
interface C
{
    int P => 1;
            ...
            comp.VerifyDiagnostics(
                ...
                //     int P => 1;
                Diagnostic(ErrorCode.ERR_FeatureNotAvailableInVersion7, "1")
...
abstract class C
{
  public abstract int P => 1;
            ...
            comp.VerifyDiagnostics(
                ...
                //   public abstract int P => 1;
                Diagnostic(ErrorCode.ERR_AbstractHasBody, "1")
...
class C
{
   public abstract int P => 1;
            ...
            comp.VerifyDiagnostics(
                ...
                //    public abstract int P => 1;
                Diagnostic(ErrorCode.ERR_AbstractInConcreteClass, "1")
                    .WithArguments("C.P.get", "C")
                    .WithLocation(4, 29)
            );
        }
...
abstract class C
{
   abstract int P => 1;
            ...
            comp.VerifyDiagnostics(
                ...
                //    abstract int P => 1;
                Diagnostic(ErrorCode.ERR_VirtualPrivate, "P")
                    .WithArguments("C.P")
                    .WithLocation(4, 17),
