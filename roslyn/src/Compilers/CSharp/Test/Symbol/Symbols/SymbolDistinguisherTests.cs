...
";
            ...
            Assert.Equal(
                "C.M() [Metadata, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null]",
                distinguisher.Second.ToString()
            );
            ...
            Assert.Equal(
                "C.P [Metadata, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null]",
                distinguisher.Second.ToString()
            );
            ...
            Assert.Equal(
                "C.F [Metadata, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null]",
                distinguisher.Second.ToString()
            );
            ...
            Assert.Equal(
                "C.E [Metadata, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null]",
                distinguisher.Second.ToString()
            );
        }
...
";
            ...
            Assert.Equal(
                "ref C [Metadata, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null]",
                distinguisher.Second.ToString()
            );
        }
...
";
            ...
            Assert.Equal(
                "S* [Metadata, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null]",
                distinguisher.Second.ToString()
            );
        }
...
";
            ...
            Assert.Equal(
                "params C[] [Metadata, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null]",
                distinguisher.Second.ToString()
            );
        }
        ...
        public void TestDynamicLocation()
        {
            ...
            Assert.Equal(
                "dynamic [Metadata, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null]",
                distinguisher.Second.ToString()
            );
        }
        ...
        public void TestMissingTypeLocation()
        {
            ...
            var validType = CreateEmptyCompilation("", new[] { MscorlibRef })
            ...
            Assert.Equal(
                "int [Error, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null]",
                distinguisher.First.ToString()
            );
            Assert.Equal(
                "int [mscorlib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089]",
                distinguisher.Second.ToString()
            );
        }
...
";
            ...
            var libRef = CreateCompilation(libSource, assemblyName: "Metadata")
                .EmitToImageReference();
            CreateCompilation(Parse(source, "file.cs"), new[] { libRef }, assemblyName: "Source")
                .VerifyDiagnostics(
                    ...
                    //         I i = Lib.M();
                    Diagnostic(ErrorCode.WRN_SameFullNameThisAggAgg, "I")
                        .WithArguments(
                            "file.cs",
                            "I",
                            "Metadata, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null",
                            "I"
                        )
                        .WithLocation(8, 9),
                    ...
                    //         I i = Lib.M();
                    Diagnostic(ErrorCode.ERR_NoImplicitConvCast, "Lib.M()")
                        .WithArguments(
                            "I [Metadata, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null]",
                            "I [file.cs(2)]"
                        )
                        .WithLocation(8, 15)
                );
...
";
            ...
            CreateCompilation(Parse(source, "file.cs"), new[] { libRef }, assemblyName: "Source")
                .VerifyDiagnostics(
                    ...
                    //         S s = Lib.M();
                    Diagnostic(ErrorCode.WRN_SameFullNameThisAggAgg, "S")
                        .WithArguments(
                            "file.cs",
                            "S",
                            "Metadata, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null",
                    ...
                    //         S s = Lib.M();
                    Diagnostic(ErrorCode.ERR_NoImplicitConv, "Lib.M()")
                        .WithArguments(
                            "S [Metadata, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null]",
                            "S [file.cs(2)]"
                        )
...
";
            ...
            CreateCompilation(Parse(source, "file.cs"), new[] { libRef }, assemblyName: "Source")
                .VerifyDiagnostics(
                    ...
                    //         var s = (S)Lib.M();
                    Diagnostic(ErrorCode.ERR_NoExplicitConv, "(S)Lib.M()")
                        .WithArguments(
                            "S [Metadata, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null]",
                            "S [file.cs(2)]"
                        )
...
";
            ...
            CreateCompilation(Parse(source, "file.cs"), new[] { libRef }, assemblyName: "Source")
                .VerifyDiagnostics(
                    ...
                    //         var c = Lib.M() as C;
                    Diagnostic(ErrorCode.WRN_SameFullNameThisAggAgg, "C")
                        .WithArguments(
                            "file.cs",
                            "C",
                            "Metadata, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null",
                    ...
                    //         var c = Lib.M() as C;
                    Diagnostic(ErrorCode.ERR_NoExplicitBuiltinConv, "Lib.M() as C")
                        .WithArguments(
                            "C [Metadata, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null]",
                            "C [file.cs(2)]"
                        )
...
";
            ...
            CreateCompilation(Parse(source, "file.cs"), new[] { libRef }, assemblyName: "Source")
                .VerifyDiagnostics(
                    ...
                    //         var c = args == null ? new C() : Lib.M();
                    Diagnostic(ErrorCode.ERR_InvalidQM, "args == null ? new C() : Lib.M()")
                        .WithArguments(
                            "C [file.cs(2)]",
                            "C [Metadata, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null]"
                        )
...
";
            ...
            CreateCompilation(Parse(source, "file.cs"), new[] { libRef }, assemblyName: "Source")
                .VerifyDiagnostics(
                    ...
                    //         D d = (C c) => { };
                    Diagnostic(ErrorCode.ERR_CantConvAnonMethParams, "(C c) => { }")
                    ...
                    //         D d = (C c) => { };
                    Diagnostic(ErrorCode.ERR_BadParamType, "c")
                        .WithArguments(
                            "1",
                            "",
                            "C [file.cs(3)]",
...
";
            ...
            CreateCompilation(Parse(source, "file.cs"), new[] { libRef }, assemblyName: "Source")
                .VerifyDiagnostics(
                    ...
                    //         Lib.M(new C());
                    Diagnostic(ErrorCode.ERR_BadArgType, "new C()")
                        .WithArguments(
                            "1",
                            "C [file.cs(2)]",
                            "C [Metadata, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null]"
            ...
            CreateCompilation(Parse(source, "file.cs"), new[] { libRef }, assemblyName: "Source")
                .VerifyDiagnostics(
                    ...
                    Diagnostic(ErrorCode.ERR_BadArgType, "c")
                        .WithArguments(
                            "1",
                            "ref C [Source, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null]",
                            "ref C [Metadata, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null]"
                        )
                        .WithLocation(7, 19)
                );
...
";
            ...
            CreateCompilation(Parse(source, "file.cs"), new[] { libRef }, assemblyName: "Source")
                .VerifyDiagnostics(
                    ...
                    //         Lib.M<C>();
                    Diagnostic(ErrorCode.ERR_GenericConstraintNotSatisfiedRefType, "M<C>")
                        .WithArguments(
                            "Lib.M<T>()",
                            "C [Metadata, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null]",
                            "T",
...
";
            ...
            CreateCompilation(Parse(source, "file.cs"), new[] { libRef }, assemblyName: "Source")
                .VerifyDiagnostics(
                    ...
                    //         Lib.M<C>();
                    Diagnostic(ErrorCode.ERR_GenericConstraintNotSatisfiedTyVar, "M<C>")
                        .WithArguments(
                            "Lib.M<T>()",
                            "C [Metadata, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null]",
                            "T",
...
";
            ...
            CreateCompilation(Parse(source, "file.cs"), new[] { libRef }, assemblyName: "Source")
                .VerifyDiagnostics(
                    ...
                    //         Lib.M<C>();
                    Diagnostic(ErrorCode.ERR_GenericConstraintNotSatisfiedValType, "M<C>")
                        .WithArguments(
                            "Lib.M<T>()",
                            "C [Metadata, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null]",
                            "T",
...
class C { }";
            ...
            Assert.True(
                AreEqual(
                    new SymbolDistinguisher(compilation, sA, sB),
                    new SymbolDistinguisher(compilation, sA, sB)
                )
            );
            Assert.False(
                AreEqual(
                    new SymbolDistinguisher(compilation, sA, sB),
                    new SymbolDistinguisher(compilation, sA, sC)
                )
            );
            Assert.False(
                AreEqual(
                    new SymbolDistinguisher(compilation, sA, sB),
                    new SymbolDistinguisher(compilation, sC, sB)
                )
            );
        }
    ...
    static void M(System.Collections.Generic.IEnumerable<E> e)
    {
        A.M(e);
            ...
            comp1.VerifyDiagnostics(
                ...
                //         A.M(e);
                Diagnostic(ErrorCode.ERR_BadArgType, "e")
                    .WithArguments(
                        "1",
