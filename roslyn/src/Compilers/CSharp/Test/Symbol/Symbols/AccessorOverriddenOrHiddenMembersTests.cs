...
";
            ...
            Assert.Equal(
                0,
                @class.GetSynthesizedExplicitImplementations(CancellationToken.None).Length
            ); //not needed
        }
...
",
            ...
            var tsym = comp2.GetReferencedAssemblySymbol(mtref)
...
" + sourceFromReproSteps;
            ...
            foreach (var testCase in testCases)
            {
                ...
                var explicitInterfaceImplementation = nodes.OfType<MethodDeclarationSyntax>()
