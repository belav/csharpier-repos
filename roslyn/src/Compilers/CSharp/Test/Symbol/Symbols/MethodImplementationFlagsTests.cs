...
";
            ...
            Action<ModuleSymbol> validator = module =>
            {
                ...
                Assert.Equal(
                    ...
                    aggressiveInliningMethod.MethodImplementationFlags
                );

                var noInliningMethod = c.GetMember<MethodSymbol>("M_NoInlining").GetPublicSymbol();
                Assert.Equal(
                    MethodImplAttributes.NoInlining,
                    noInliningMethod.MethodImplementationFlags
                );
            };
...
";
            Action<ModuleSymbol> validator = module =>
            {
                ...
                Assert.Equal(
                    ...
                    aggressiveOptimizationMethod.MethodImplementationFlags
                );
#else
                Assert.Equal(
                ...
                Assert.Equal(
                    ...
                    noOptimizationMethod.MethodImplementationFlags
                );
            };
...
";
            ...
            Action<ModuleSymbol> validator = module =>
            {
...
#if !NET472 // MethodImplAttributes.AggressiveOptimization was introduced in .NET Core 3
                Assert.Equal(
                    MethodImplAttributes.AggressiveOptimization | MethodImplAttributes.NoInlining,
                    aggressiveOptNoInliningMethod.MethodImplementationFlags
                );
#else
                Assert.Equal(
                    (MethodImplAttributes)512 | MethodImplAttributes.NoInlining,
                    aggressiveOptNoInliningMethod.MethodImplementationFlags
                );
#endif
                ...
                var noOptNoInliningMethod = c.GetMember<MethodSymbol>("M_NoOpt_NoInlining")
                    .GetPublicSymbol();
                Assert.Equal(
                    MethodImplAttributes.NoOptimization | MethodImplAttributes.NoInlining,
                    noOptNoInliningMethod.MethodImplementationFlags
                );
                ...
                Assert.Equal(
                    MethodImplAttributes.AggressiveOptimization
                        | MethodImplAttributes.AggressiveInlining,
                    aggressiveOptAggressiveInliningMethod.MethodImplementationFlags
                );
#else
                Assert.Equal(
                    (MethodImplAttributes)512 | MethodImplAttributes.AggressiveInlining,
                    aggressiveOptAggressiveInliningMethod.MethodImplementationFlags
                );
#endif
                ...
                Assert.Equal(
                    ...
                    noOptAggressiveInliningMethod.MethodImplementationFlags
                );
            };
...
";
            Action<ModuleSymbol> validator = module =>
            {
                ...
                Assert.Equal(
                    MethodImplAttributes.PreserveSig | MethodImplAttributes.Runtime,
