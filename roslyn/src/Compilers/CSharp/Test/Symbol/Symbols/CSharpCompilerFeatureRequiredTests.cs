    ...
    : BaseCompilerFeatureRequiredTests<CSharpCompilation, CSharpTestSource>
{
    ...
    protected override CSharpCompilation CreateCompilationWithIL(
    ...
    protected override void AssertModuleErrors(CSharpCompilation comp, MetadataReference ilRef)
    {
        ...
        Assert.True(
            comp.GetReferencedAssemblySymbol(ilRef).Modules.Single().HasUnsupportedMetadata
        );
    }
    ...
    protected override void AssertAssemblyErrors(CSharpCompilation comp, MetadataReference ilRef)
    {
        comp.VerifyDiagnostics(
            ...
            Diagnostic(ErrorCode.ERR_UnsupportedCompilerFeature, "OnType")
                .WithArguments(
                    "AssemblyTest, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null",
                    "test"
                )
                .WithLocation(2, 1),
    ...
    public void Application()
    {
        ...
        comp.VerifyDiagnostics(
            ...
            Diagnostic(
                    ...
                    @"CompilerFeatureRequired(""OnMethodReturn"")"
                )
                .WithArguments("System.Runtime.CompilerServices.CompilerFeatureRequiredAttribute")
                .WithLocation(17, 14),
            ...
            Diagnostic(
                    ErrorCode.ERR_ExplicitReservedAttr,
                    @"CompilerFeatureRequired(""OnParameter"")"
                )
                .WithArguments("System.Runtime.CompilerServices.CompilerFeatureRequiredAttribute")
                .WithLocation(23, 27),
            ...
            Diagnostic(
                    ErrorCode.ERR_ExplicitReservedAttr,
                    @"CompilerFeatureRequired(""OnEnumMember"")"
                )
                .WithArguments("System.Runtime.CompilerServices.CompilerFeatureRequiredAttribute")
                .WithLocation(72, 6),
            ...
            Diagnostic(
                    ErrorCode.ERR_ExplicitReservedAttr,
                    @"CompilerFeatureRequired(""OnClassTypeParameter"")"
                )
                .WithArguments("System.Runtime.CompilerServices.CompilerFeatureRequiredAttribute")
                .WithLocation(75, 36),
            ...
            Diagnostic(
                    ErrorCode.ERR_ExplicitReservedAttr,
                    @"CompilerFeatureRequired(""OnMethodTypeParameter"")"
                )
                .WithArguments("System.Runtime.CompilerServices.CompilerFeatureRequiredAttribute")
                .WithLocation(81, 27),
