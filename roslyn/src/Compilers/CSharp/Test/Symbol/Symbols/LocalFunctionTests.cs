    ...
    void M()
    {
        ...
        staticLocal();
            ...
            var staticLocal = semanticModel
                .GetDeclaredSymbol(localsSyntax[0])
        ...
        public void StaticLocalFunction_CapturingMethodGroup()
        {
            CreateCompilation(
                ...
                .VerifyDiagnostics(
                    ...
                    //     var x1 = c.MyExtension;
                    Diagnostic(ErrorCode.ERR_StaticLocalFunctionCannotCaptureVariable, "c")
                        .WithArguments("c")
                        .WithLocation(9, 14),
                    ...
                    //         var x2 = c.MyExtension;
                    Diagnostic(ErrorCode.ERR_StaticAnonymousFunctionCannotCaptureVariable, "c")
                        .WithArguments("c")
                        .WithLocation(17, 18),
        ...
        public void StaticLocalFunction_CapturingMethodGroup3()
        {
            CreateCompilation(
                ...
                .VerifyDiagnostics(
                    ...
                    //             var y1 = base.MyExtension;
                    Diagnostic(ErrorCode.ERR_NoSuchMember, "MyExtension")
                        .WithArguments("Base", "MyExtension")
                        .WithLocation(14, 27),
