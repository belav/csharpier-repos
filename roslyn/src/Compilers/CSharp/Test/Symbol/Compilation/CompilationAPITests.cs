...
#pragma warning restore CS0078
        ...
        public void CompilationName()
        {
            ...
            CSharpCompilation.Create(@"C:Test.exe", options: compilationOptions)
                .VerifyEmitDiagnostics(
                    // error CS8203: Invalid assembly name: Name contains invalid characters.
                    Diagnostic(ErrorCode.ERR_BadAssemblyName)
                        .WithArguments("Name contains invalid characters.")
            ...
            CSharpCompilation.Create(@"Te\0st.exe", options: compilationOptions)
                .VerifyEmitDiagnostics(
                    // error CS8203: Invalid assembly name: Name contains invalid characters.
                    Diagnostic(ErrorCode.ERR_BadAssemblyName)
                        .WithArguments("Name contains invalid characters.")
    ...
    <assemblyBinding xmlns=""urn:schemas-microsoft-com:asm.v1"">
       <supportPortability PKT=""7cec85d7bea7798e"" enable=""false""/>
        ...
        public void GetMetadataReference_VisualBasicSymbols()
        {
            ...
            var assembly = (IAssemblySymbol)vbComp.GetBoundReferenceManager()
