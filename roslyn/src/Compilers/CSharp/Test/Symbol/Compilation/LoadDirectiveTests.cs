    ...
    public class LoadDirectiveTests : CSharpTestBase
    {
        ...
        public void EmptyFile()
        {
            ...
            compilation.VerifyDiagnostics(
                ...
                Diagnostic(ErrorCode.ERR_NoSourceFile, "\"\"")
                    .WithArguments("", CSharpResources.CouldNotFindFile)
                    .WithLocation(1, 7)
            );
        }
        ...
        public void MissingFile()
        {
            ...
            compilation.VerifyDiagnostics(
                ...
                Diagnostic(ErrorCode.ERR_NoSourceFile, "\"missing\"")
                    .WithArguments("missing", CSharpResources.CouldNotFindFile)
                    .WithLocation(1, 7)
            );
        }
