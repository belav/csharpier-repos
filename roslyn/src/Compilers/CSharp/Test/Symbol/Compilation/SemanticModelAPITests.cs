...
";
            ...
            var args = descendants.OfType<ArgumentSyntax>()
...
"
            ...
            var lambdaExpression = speculatedStatement.DescendantNodes()
...
"
            ...
            var root = tree.GetCompilationUnitRoot();
            var typeDecl = (TypeDeclarationSyntax)root.Members[0];
            var cref = typeDecl.DescendantNodes(descendIntoTrivia: true)
...
";
            ...
            var omittedArraySize = typeSyntax.DescendantNodes()
...
";
            ...
            var method2 =
                statementSyntax.DescendantNodes()
                    .OfType<InvocationExpressionSyntax>()
                    .Single().Expression;
...
";
        ...
        private static void CheckLambdaArgumentInBadCall(string source)
        {
            ...
            var firstParamType =
                ((ISymbol)exprInfo.CandidateSymbols.Single()).GetParameters().First().Type;
