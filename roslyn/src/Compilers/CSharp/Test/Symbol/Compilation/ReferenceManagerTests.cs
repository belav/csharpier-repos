...
public interface ITest
{
            ...
            var wimpl = AssemblyMetadata.CreateFromImage(TestResources.WinRt.WImpl)
                .GetReference(display: "WImpl");
...
public class C
{
    public static void Main()
    {
        ...
        public void VersionUnification_SymbolUsed()
        {
            ...
            var v1 = AssemblyMetadata.CreateFromImage(TestResources.General.C1)
                .GetReference(display: "C, V1");

            // Identity: C, Version=2.0.0.0, Culture=neutral, PublicKeyToken=374d0c2befcd8cc9
            var v2 = AssemblyMetadata.CreateFromImage(TestResources.General.C2)
                .GetReference(display: "C, V2");

            var refV1 = CreateCompilation(
                "public class D : C { }",
                new[] { v1 },
                assemblyName: "refV1"
            );
            var refV2 = CreateCompilation(
                "public class D : C { }",
                new[] { v2 },
                assemblyName: "refV2"
            );
            ...
            var testRefV1 = CreateCompilation(
                "public class E : D { }",
                new MetadataReference[] { new CSharpCompilationReference(refV1), v2 },
                assemblyName: "testRefV1"
            );

            // reference asks for a higher version than available:
            var testRefV2 = CreateCompilation(
                "public class E : D { }",
                new MetadataReference[] { new CSharpCompilationReference(refV2), v1 },
                assemblyName: "testRefV2"
            );
...
";
            ...
            var libV1 = CreateCompilation(sourceLibV1, assemblyName: "Lib", options: s_signedDll);
...
";
            ...
            var libV2 = CreateCompilation(sourceLibV2, assemblyName: "Lib", options: s_signedDll);
...
";
            ...
            var libV3 = CreateCompilation(sourceLibV3, assemblyName: "Lib", options: s_signedDll);
...
";
        ...
        [Fact]
        [
            WorkItem(529808, "http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/529808"),
            WorkItem(530246, "http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/530246")
        ]
...
";
            ...
            var a1 = CreateCompilation(sourceA1, assemblyName: "A", options: s_signedDll);
...
";
            ...
            var a2 = CreateCompilation(sourceA2, assemblyName: "A", options: s_signedDll);
...
";
            ...
            var b1 = CreateCompilation(sourceB1, assemblyName: "B", options: s_signedDll);
...
";
            ...
            var b2 = CreateCompilation(sourceB2, assemblyName: "B", options: s_signedDll);
...
namespace Microsoft.TeamFoundation.WebAccess.Common
{
    public class CachedRegistry
    {
        public static void Main(string[] args)
        {
            ...
            var r1 = AssemblyMetadata.CreateFromImage(ResourcesNet451.SystemCore)
                .GetReference(filePath: @"c:\temp\aa.dll", display: "System.Core.v4_0_30319.dll");
            var r2 = AssemblyMetadata.CreateFromImage(ResourcesNet451.SystemCore)
                .GetReference(filePath: @"c:\temp\aa.dll", display: "System.Core.v4_0_30319.dll");
            var r2_SysCore = r2.WithAliases(new[] { "SysCore" });

            var compilation = CreateEmptyCompilation(
                tree,
                new[] { MscorlibRef, r1, r2_SysCore },
        ...
        public void DuplicateReferences()
        {
            ...
            var r1 = AssemblyMetadata.CreateFromImage(TestResources.General.C1)
                .GetReference(filePath: @"c:\temp\a.dll", display: "R1");
            var r2 = AssemblyMetadata.CreateFromImage(TestResources.General.C1)
                .GetReference(filePath: @"c:\temp\a.dll", display: "R2");
...
";
        ...
        public void DuplicateModuleReferences_EquivalentPath()
        {
            ...
            var m2 = MetadataReference.CreateFromFile(
                p2,
                new MetadataReferenceProperties(MetadataImageKind.Module)
            );
        ...
        {
            var ref1 = AssemblyMetadata.CreateFromImage(TestResources.General.C2)
                .GetReference(embedInteropTypes: true, filePath: @"R:\A\MTTestLib1.dll");
            var ref2 = AssemblyMetadata.CreateFromImage(TestResources.General.C2)
                .GetReference(embedInteropTypes: false, filePath: @"R:\B\MTTestLib1.dll");
...
public interface I {}";
        ...
        public void DuplicateAssemblyReferences_EquivalentName()
        {
            ...
            var refs = compilation.Assembly.Modules.Select(
        ...
        [Fact]
        [
            WorkItem(546026, "http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/546026"),
            WorkItem(546169, "http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/546169")
        ]
...
public class A { }";
            ...
            var ref1 = AssemblyMetadata.CreateFromFile(exe1.Path)
                .GetReference(aliases: ImmutableArray.Create("A1"));
            var ref2 = AssemblyMetadata.CreateFromFile(exe2.Path)
...
";
            ...
            using (
                AssemblyMetadata metadataLib1 = AssemblyMetadata.CreateFromImage(
...
";
            ...
            using (
                ...
                var main = CreateCompilation(sourceMain, new[] { mdRefLib1, mdRefLib2 });
...
";
            ...
            var compilation = CreateEmptyCompilation(
                source,
                TargetFrameworkUtil.StandardReferences.AddRange(new[] { arSA, enUS })
            );
...
";
            var b = CreateCompilation(
                sourceB,
                new[] { new CSharpCompilationReference(a) },
                assemblyName: "B"
            );
...
";
            ...
            Assert.True(
                symbolB is Microsoft.CodeAnalysis.CSharp.Symbols.Metadata.PE.PEAssemblySymbol,
                "PE symbol expected"
            );
            ...
            Assert.True(
                symbolA2 is Microsoft.CodeAnalysis.CSharp.Symbols.Metadata.PE.PEAssemblySymbol,
                "PE symbol expected"
            );
...
",
        ...
        public void BoundReferenceCaching_CyclesInReferences()
        {
            ...
            var withCircularReference1 = CreateCompilation(
                @"public class B : A { }",
                new[] { refA2 },
                assemblyName: "B"
            );
...
";
            ...
            {
                var il = string.Format(
                    ilTemplate,
                    "  .publickeytoken = (31 BF 38 56 AD 36 4E 35 )                         // 1.8V.6N5"
                );
                var ilRef = CompileIL(il, prependDefaultHeader: false);
                CreateCompilation(csharp, new[] { ilRef }, assemblyName: "ReachFramework")
                    .VerifyDiagnostics();
            }
            ...
            // culture specified by ref, but not def
            {
                var il = string.Format(
                    ilTemplate,
                    "  .locale = (65 00 6E 00 2D 00 63 00 61 00 00 00 )             // e.n.-.c.a..."
                );
                var ilRef = CompileIL(il, prependDefaultHeader: false);
                CreateCompilation(csharp, new[] { ilRef }, assemblyName: "ReachFramework")
                    .VerifyDiagnostics();
...
";
            ...
            var oldMetadata = AssemblyMetadata.CreateFromImage(
                CreateCompilation(oldVersion + csharp, assemblyName: "ReachFramework").EmitToArray()
            );
...
public class B
{
	public A A;
            ...
            var b = CreateCompilation(
                srcB,
                references: new[] { aRef },
                options: TestOptions.ReleaseModule.WithModuleName("mod.netmodule"),
                assemblyName: "B"
            );
            b.VerifyDiagnostics();
        }
...
";
            ...
            var assemblyMetadata = AssemblyMetadata.CreateFromImage(
                CreateCompilation("public class TypeDependedOnByModule { }", assemblyName: "lib1")
                    .EmitToArray()
            );
            var assemblyRef = assemblyMetadata.GetReference();
            var moduleRef = CreateCompilation(
                    "public class TypeFromModule : TypeDependedOnByModule { }",
                    new[] { assemblyRef },
...
";
            ...
            var implicitTypeCount1 =
                comp1.GlobalNamespace.GetMember<NamespaceSymbol>("A")
            ...
            var implicitTypeCount2 =
                comp2.GlobalNamespace.GetMember<NamespaceSymbol>("A")
                    .GetMembers(TypeSymbol.ImplicitTypeName).Length;
...
";
        ...
        [Fact]
        [
            WorkItem(531342, "http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/531342"),
            WorkItem(727122, "DevDiv")
        ]
        public void PortableLibrary()
        {
            var plSource = @"public class C {}";
            var pl = CreateEmptyCompilation(
                plSource,
                new[] { MscorlibPP7Ref, SystemRuntimePP7Ref }
            );
            ...
            var main = CreateEmptyCompilation(
                mainSource,
                new MetadataReference[] { r1, MscorlibFacadeRef },
                options: TestOptions.ReleaseDll
            );
            main.VerifyDiagnostics(
            ...
            // facade specified:
            main = CreateEmptyCompilation(
                mainSource,
                new MetadataReference[] { r1, MscorlibFacadeRef, SystemRuntimeFacadeRef }
            );
            main.VerifyDiagnostics();
        }
...
";
            ...
            var libBv1 = CreateCompilationWithMscorlib40AndSystemCore(
                string.Format(libBTemplate, "1"),
                assemblyName: "B",
                options: s_signedDll
            );
            var libBv2 = CreateCompilationWithMscorlib40AndSystemCore(
                string.Format(libBTemplate, "2"),
                assemblyName: "B",
                options: s_signedDll
            );
            ...
            Assert.Equal(
                "B, Version=1.0.0.0, Culture=neutral, PublicKeyToken=ce65828c82a341f2",
                libBv1.Assembly.Identity.GetDisplayName()
            );
            Assert.Equal(
                "B, Version=2.0.0.0, Culture=neutral, PublicKeyToken=ce65828c82a341f2",
                libBv2.Assembly.Identity.GetDisplayName()
            );
...
";
        ...
        public void MetadataDisposed()
        {
            ...
            var compilation = CSharpCompilation.Create(
                "test",
                references: new[] { md.GetReference() }
            );
        ...
        public void AsymmetricUnification()
        {
            ...
            Assert.Equal(
                ...
                vectors40.Assembly.Identity.GetDisplayName()
            );
            ...
            Assert.Equal(
                ...
                vectors41.Assembly.Identity.GetDisplayName()
            );
            ...
            Assert.Equal(
                "System.Numerics.Vectors, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a",
                ((AssemblySymbol)a0).Identity.GetDisplayName()
            );
            Assert.Equal(
                "System.Numerics.Vectors, Version=4.1.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a",
                ((AssemblySymbol)a1).Identity.GetDisplayName()
            );
        ...
        public void ReferenceSupersession_AliasesErased()
        {
            var c = CreateSubmissionWithExactReferences(
                ...
                new[]
                {
                    MscorlibRef_v4_0_30316_17626,
                    CreateEmptyCompilation(
                            @"[assembly: System.Reflection.AssemblyVersion(""0.0.0.0"")] public class C {}",
                            new[] { MscorlibRef },
                            assemblyName: "C"
                        )
                        .ToMetadataReference(),
                    CreateEmptyCompilation(
                            @"[assembly: System.Reflection.AssemblyVersion(""2.0.0.1"")] public class C {}",
                            new[] { MscorlibRef },
                            assemblyName: "C"
                        )
                        .ToMetadataReference(),
                    ...
                    CreateEmptyCompilation(
                        ...
                        .ToMetadataReference(),
                    CreateEmptyCompilation(
                            @"[assembly: System.Reflection.AssemblyVersion(""1.1.0.0"")] public class C {}",
                            new[] { MscorlibRef },
                            assemblyName: "C"
                        )
                        .ToMetadataReference()
            ...
            var c = CreateSubmissionWithExactReferences(
                ...
                new[]
                {
                    ...
                    CreateCompilation(
                        ...
                        .ToMetadataReference(aliases: ImmutableArray.Create("X", "Y")),
                    CreateCompilation(
                            @"[assembly: System.Reflection.AssemblyVersion(""1.0.0.0"")] public class C {}",
                            assemblyName: "C"
                        )
        ...
        public void ReferenceDirective_RecursiveReferenceWithNoAliases()
        {
            ...
            var bRef = CreateCompilationWithMscorlib45("public class B { }", assemblyName: "B")
                .EmitToImageReference();
            var aRef = CreateCompilationWithMscorlib45(
                    "public class A : B { }",
                    new[] { bRef },
                    assemblyName: "A"
                )
...
";
            ...
            c.VerifyAssemblyAliases("mscorlib", "B: X,global", "A");
        }
...
";
            ...
            c.VerifyAssemblyAliases("mscorlib", "B: X", "A");
        }
...
";
            ...
            var c = CreateEmptyCompilation(
                ...
                new[]
                {
                    ...
                    aRef,
                    aRef.WithProperties(
                        MetadataReferenceProperties.Assembly.WithAliases(ImmutableArray.Create("Y"))
                            .WithRecursiveAliases(true)
                    ),
                    MscorlibRef,
                },
            ...
            c.VerifyAssemblyAliases("B: X,Y", "A: global,Y", "mscorlib: global,Y");
        }
...
";
        ...
        public void ReferenceDirective_RecursiveReferenceWithAlias4()
        {
            ...
            var aRef = CreateCompilationWithMscorlib45(
                ...
                .EmitToImageReference();
            var dRef = CreateCompilationWithMscorlib45(
                    "public class D : A { }",
                    new[] { aRef, bRef },
                    assemblyName: "D"
                )
...
";
            ...
            var c = CreateEmptyCompilation(
                ...
                new[]
                {
                    ...
                    aRef.WithProperties(
                        MetadataReferenceProperties.Assembly.WithAliases(
                                ImmutableArray.Create("Y", "Y")
                            )
                            .WithRecursiveAliases(true)
                    ),
                    dRef.WithProperties(
                        MetadataReferenceProperties.Assembly.WithAliases(ImmutableArray.Create("Z"))
                            .WithRecursiveAliases(true)
                    ),
                    MscorlibRef,
                },
            ...
            c.VerifyAssemblyAliases("B: X,Y,Y,Z", "A: Y,Y,Z", "D: Z", "mscorlib: global,Y,Y,Z");
        }

        [ConditionalFact(
            typeof(NoIOperationValidation),
            typeof(NoUsedAssembliesValidation),
            Reason = "IOperation adds extra assemblies"
        )]
        public void MissingAssemblyResolution1()
        {
            ...
            var bRef = CreateCompilationWithMscorlib46("public class B { }", assemblyName: "B")
                .EmitToImageReference();
            var aRef = CreateCompilationWithMscorlib46(
                    "public class A : B { }",
                    new[] { bRef },
                    assemblyName: "A"
                )
            ...
            var resolver = new TestMissingMetadataReferenceResolver(
                new Dictionary<string, MetadataReference> { { "B", bRef } }
            );
...
",
        ...
        public void MissingAssemblyResolution_AliasesMerge()
        {
            ...
            var b1Ref = CreateEmptyCompilation(
                    @"[assembly: System.Reflection.AssemblyVersion(""1.0.0.0"")] public class B { }",
                    new[] { MscorlibRef },
                    options: s_signedDll,
                    assemblyName: "B"
                )
                .EmitToImageReference();
            var b2Ref = CreateEmptyCompilation(
                    @"[assembly: System.Reflection.AssemblyVersion(""2.0.0.0"")] public class B { }",
                    new[] { MscorlibRef },
                    options: s_signedDll,
                    assemblyName: "B"
                )
                .EmitToImageReference();
            var b3Ref = CreateEmptyCompilation(
                    @"[assembly: System.Reflection.AssemblyVersion(""3.0.0.0"")] public class B { }",
                    new[] { MscorlibRef },
                    options: s_signedDll,
                    assemblyName: "B"
                )
            ...
            var aRef = CreateEmptyCompilation(
                    "public class A : B { }",
                    new[] { MscorlibRef, b1Ref },
                    assemblyName: "A"
                )
                .EmitToImageReference();
            var dRef = CreateEmptyCompilation(
                    "public class D : B { }",
                    new[] { MscorlibRef, b2Ref },
                    assemblyName: "D"
                )
                .EmitToImageReference();
...
",
        ...
        public void MissingAssemblyResolution_WeakIdentities1()
        {
            ...
            //   - d -> "b,v2,PKT=null"
            var b1Ref = CreateEmptyCompilation(
                    @"[assembly: System.Reflection.AssemblyVersion(""1.0.0.0"")] public interface B { }",
                    new[] { MscorlibRef },
                    assemblyName: "B"
                )
                .EmitToImageReference();
            var b2Ref = CreateEmptyCompilation(
                    @"[assembly: System.Reflection.AssemblyVersion(""2.0.0.0"")] public interface B { }",
                    new[] { MscorlibRef },
                    assemblyName: "B"
                )
                .EmitToImageReference();
            var b3Ref = CreateEmptyCompilation(
                    @"[assembly: System.Reflection.AssemblyVersion(""3.0.0.0"")] public interface B { }",
                    new[] { MscorlibRef },
                    assemblyName: "B"
                )
                .EmitToImageReference();
            var b4Ref = CreateEmptyCompilation(
                    @"[assembly: System.Reflection.AssemblyVersion(""4.0.0.0"")] public interface B { }",
                    new[] { MscorlibRef },
                    assemblyName: "B"
                )
                .EmitToImageReference();
            ...
            var c = CreateSubmissionWithExactReferences(
                @"public interface C : A, D {  }",
                new[] { MscorlibRef_v4_0_30316_17626, aRef, dRef },
                TestOptions.ReleaseDll.WithMetadataReferenceResolver(resolver)
            );
        ...
        public void MissingAssemblyResolution_Multiple()
        {
            ...
            var aRef = CreateCompilationWithMscorlib46(
                ...
                .ToMetadataReference();
            var bRef = CreateCompilationWithMscorlib46(
        ...
        public void MissingAssemblyResolution_Modules()
        {
            ...
            var mRef = CreateCompilationWithMscorlib46(
                    "public interface M : B { }",
                    new[] { bRef },
                    options: TestOptions.ReleaseModule.WithModuleName("M.netmodule")
                )
                .EmitToImageReference();
            var nRef = CreateCompilationWithMscorlib46(
                    "public interface N : D { }",
                    new[] { dRef },
                    options: TestOptions.ReleaseModule.WithModuleName("N.netmodule")
                )
                .EmitToImageReference();
        ...
        public void MissingAssemblyResolution_BindingToForExplicitReference1()
        {
            ...
            //   - "b,v3"
            //
            var b1Ref = CreateCompilationWithMscorlib46(
                    @"[assembly: System.Reflection.AssemblyVersion(""1.0.0.0"")] public class B { }",
                    options: s_signedDll,
                    assemblyName: "B"
                )
                .EmitToImageReference();
            var b2Ref = CreateCompilationWithMscorlib46(
                    @"[assembly: System.Reflection.AssemblyVersion(""2.0.0.0"")] public class B { }",
                    options: s_signedDll,
                    assemblyName: "B"
                )
                .EmitToImageReference();
            var b3Ref = CreateCompilationWithMscorlib46(
                    @"[assembly: System.Reflection.AssemblyVersion(""3.0.0.0"")] public class B { }",
                    options: s_signedDll,
                    assemblyName: "B"
                )
            ...
            var aRef = CreateCompilationWithMscorlib46(
                    @"[assembly: System.Reflection.AssemblyVersion(""1.0.0.0"")] public class A : B { }",
                    new[] { b1Ref },
                    options: s_signedDll,
                    assemblyName: "A"
                )
        ...
        public void MissingAssemblyResolution_BindingToExplicitReference_WorseVersion()
        {
            ...
            var dRef = CreateEmptyCompilation(
                    @"[assembly: System.Reflection.AssemblyVersion(""1.0.0.0"")] public interface D : B { }",
                    new[] { MscorlibRef, b2Ref },
                    options: s_signedDll,
                    assemblyName: "D"
                )
                .EmitToImageReference();
            var eRef = CreateEmptyCompilation(
                    @"[assembly: System.Reflection.AssemblyVersion(""1.0.0.0"")] public interface E : B { }",
                    new[] { MscorlibRef, b1Ref },
                    options: s_signedDll,
                    assemblyName: "E"
                )
            ...
            var resolverA = new TestMissingMetadataReferenceResolver(
                new Dictionary<string, MetadataReference>
                {
                    { "B, 2.0.0.0", b2Ref },
                    { "B, 1.0.0.0", b1Ref },
            ...
            var aRef = CreateEmptyCompilation(
                    @"[assembly: System.Reflection.AssemblyVersion(""1.0.0.0"")] public interface A : D, E { }",
                    new[] { MscorlibRef, dRef, eRef },
            ...
            var resolverC = new TestMissingMetadataReferenceResolver(
                new Dictionary<string, MetadataReference>
                {
                    { "D, 1.0.0.0", dRef },
                    { "E, 1.0.0.0", eRef },
        ...
        public void MissingAssemblyResolution_BindingToImplicitReference1()
        {
            ...
            var aRef = CreateEmptyCompilation(
                    @"[assembly: System.Reflection.AssemblyVersion(""1.0.0.0"")] public interface A : D, E { }",
                    new[] { MscorlibRef, dRef, eRef, b1Ref, b2Ref },
                    s_signedDll,
                    assemblyName: "A"
                )
                .EmitToImageReference();
            ...
            var c = CreateSubmissionWithExactReferences(
                "public class C : A { }",
                new[] { MscorlibRef_v4_0_30316_17626, aRef },
        ...
        public void MissingAssemblyResolution_Supersession_FxUnification()
        {
            ...
            //          "System, v4"
            var aRef = CreateEmptyCompilation(
                    @"public interface A { System.Diagnostics.Process PA { get; } }",
                    new[] { Net20.mscorlib, Net20.System },
                    options: options,
                    assemblyName: "A"
                )
                .EmitToImageReference();

            var bRef = CreateEmptyCompilation(
                    @"public interface B { System.Diagnostics.Process PB { get; } }",
                    new[] { MscorlibRef_v4_0_30316_17626, Net451.System },
                    options: options,
                    assemblyName: "B"
                )
                .EmitToImageReference();
            ...
            var c = CreateSubmissionWithExactReferences(
                "public interface C : A, B { System.Diagnostics.Process PC { get; } }",
                new[] { MscorlibRef_v4_0_30316_17626, aRef, bRef },
        ...
        public void MissingAssemblyResolution_Supersession_StrongNames()
        {
            ...
            //     b -> "C, v1"
            var aRef = CreateEmptyCompilation(
                    @"public interface A { C CA { get; } }",
                    new[] { MscorlibRef, TestReferences.SymbolsTests.Versioning.C2 },
                    options: options,
                    assemblyName: "A"
                )
                .EmitToImageReference();
            ...
            var bRef = CreateEmptyCompilation(
                    @"public interface B { C CB { get; } }",
                    new[] { MscorlibRef, TestReferences.SymbolsTests.Versioning.C1 },
                    options: options,
                    assemblyName: "B"
                )
                .EmitToImageReference();
            ...
            var c = CreateSubmissionWithExactReferences(
                "public interface D : A, B { C CC { get; } }",
                new[] { MscorlibRef_v4_0_30316_17626, aRef, bRef },
                options.WithMetadataReferenceResolver(resolverC)
            );
