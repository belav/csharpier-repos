...
public interface ITest
{
            ...
            var wimpl = AssemblyMetadata
                .CreateFromImage(TestResources.WinRt.WImpl)
...
namespace Microsoft.TeamFoundation.WebAccess.Common
{
    public class CachedRegistry
    {
        public static void Main(string[] args)
        {
            ...
            var r1 = AssemblyMetadata
                .CreateFromImage(ResourcesNet451.SystemCore)
                .GetReference(filePath: @"c:\temp\aa.dll", display: "System.Core.v4_0_30319.dll");
            var r2 = AssemblyMetadata
                .CreateFromImage(ResourcesNet451.SystemCore)
                .GetReference(filePath: @"c:\temp\aa.dll", display: "System.Core.v4_0_30319.dll");
...
";
        ...
        public void DuplicateModuleReferences_EquivalentPath()
        {
            ...
            string p1 = dir.CreateFile("netModule1.netmodule")
...
public interface I {}";
        ...
        public void DuplicateAssemblyReferences_EquivalentName()
        {
            ...
            var refs = compilation
                .Assembly.Modules.Select(module => module.GetReferencedAssemblies())
                .ToArray();
...
public class A { }";
            ...
            var ref1 = AssemblyMetadata
                .CreateFromFile(exe1.Path)
                .GetReference(aliases: ImmutableArray.Create("A1"));
            var ref2 = AssemblyMetadata
                .CreateFromFile(exe2.Path)
...
";
            ...
            var implicitTypeCount1 = comp1
                .GlobalNamespace.GetMember<NamespaceSymbol>("A")
                    ...
                    CreateEmptyCompilation(
                        ...
                        .WithProperties(
                            MetadataReferenceProperties
                                .Assembly.WithAliases(ImmutableArray.Create("Z"))
...
";
            ...
            var c = CreateEmptyCompilation(
                ...
                new[]
                {
                    ...
                    aRef.WithProperties(
                        MetadataReferenceProperties
                            .Assembly.WithAliases(ImmutableArray.Create("Y"))
                            .WithRecursiveAliases(true)
                    ),
                    MscorlibRef,
                },
...
";
            ...
            var c = CreateEmptyCompilation(
                ...
                new[]
                {
                    ...
                    aRef.WithProperties(
                        MetadataReferenceProperties
                            .Assembly.WithAliases(ImmutableArray.Create("Y", "Y"))
                            .WithRecursiveAliases(true)
                    ),
                    dRef.WithProperties(
                        MetadataReferenceProperties
