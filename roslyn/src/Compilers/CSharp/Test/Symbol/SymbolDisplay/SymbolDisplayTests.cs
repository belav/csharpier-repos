...
class C
{
    void M()
    {
        var q = from x in new[] { 1, 2, 3 } where x < 3 select x;
            ...
            var fromClauseRangeVariableSymbol =
                (IRangeVariableSymbol)semanticModel.GetDeclaredSymbol(queryExpression.FromClause);
...
";
            ...
            var declaration = (BaseTypeDeclarationSyntax)semanticModel
                .SyntaxTree
                .GetRoot()
                .DescendantNodes()
...
";
            ...
            var declaration = (LocalDeclarationStatementSyntax)semanticModel
                .SyntaxTree
                .GetRoot()
                .DescendantNodes()
