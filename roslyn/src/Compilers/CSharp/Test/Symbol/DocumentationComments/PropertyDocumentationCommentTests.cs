...
"
        ...
        public void TestProperty()
        {
            Assert.Equal(
                "P:Acme.Widget.Width",
                _acmeNamespace.GetTypeMembers("Widget")
                    .Single()
                    .GetMembers("Width")
                    .Single()
        ...
        public void TestIndexer1()
        {
            Assert.Equal(
                ...
                _acmeNamespace.GetTypeMembers("Widget").Single().GetMembers("this[]")[0]
                    .GetDocumentationCommentId()
            );
        }
        ...
        public void TestIndexer2()
        {
            Assert.Equal(
                ...
                _acmeNamespace.GetTypeMembers("Widget").Single().GetMembers("this[]")[1]
                    .GetDocumentationCommentId()
            );
        }
    }
