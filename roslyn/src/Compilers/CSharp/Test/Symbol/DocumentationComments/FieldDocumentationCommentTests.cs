...
",
        ...
        public void TestFieldInNestedClass()
        {
            Assert.Equal(
                ...
                _widgetClass.GetTypeMembers("NestedClass")
                    .Single()
                    .GetMembers("value")
                    .Single()
        ...
        public void TestUnsafePointer()
        {
            Assert.Equal(
                ...
                _widgetClass.GetMembers("pCount").Single().GetDocumentationCommentId()
            );
        }
        ...
        public void TestUnsafePointerToPointer()
        {
            Assert.Equal(
                ...
                _widgetClass.GetMembers("ppValues").Single().GetDocumentationCommentId()
            );
        }
