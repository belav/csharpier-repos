...
"
        ...
        public void TestMethodInStruct()
        {
            Assert.Equal(
                ...
                _acmeNamespace.GetTypeMembers("ValueType")
                    .Single()
                    .GetMembers("M")
                    .Single()
...
",
        ...
        public void TestParams()
        {
            Assert.Equal(
                ...
                _widgetClass.GetMembers("M6").Single().GetDocumentationCommentId()
            );
        }
        ...
        {
            Assert.Equal(
                "M:Acme.Widget.M7(System.ValueTuple{System.Int32,System.Int32,System.Int32,System.Int32,System.Int32,System.Int32,System.Int16})",
        ...
        {
            Assert.Equal(
                "M:Acme.Widget.M8(System.ValueTuple{System.Int32,System.Int32,System.Int32,System.Int32,System.Int32,System.Int32,System.Int16,System.ValueTuple{System.Int32}})",
        ...
        {
            Assert.Equal(
                "M:Acme.Widget.M9(System.ValueTuple{System.Int32,System.Int32,System.Int32,System.Int32,System.Int32,System.Int32,System.Int16,System.ValueTuple{System.ValueTuple{System.String,System.String}}})",
        ...
        {
            Assert.Equal(
                "M:Acme.Widget.M10(System.ValueTuple{System.Int32,System.Int16},System.Tuple{System.Int32,System.Int16})",
        ...
        {
            Assert.Equal(
                "M:Acme.MyList`1.Zip(Acme.MyList{`0})",
                _acmeNamespace.GetTypeMembers("MyList", 1)
                    .Single()
                    .GetMembers("Zip")
                    .Single()
        ...
        {
            Assert.Equal(
                "M:Acme.MyList`1.ReallyZip(Acme.MyList{Acme.MyList{`0}})",
                _acmeNamespace.GetTypeMembers("MyList", 1)
                    .Single()
                    .GetMembers("ReallyZip")
                    .Single()
                    .GetDocumentationCommentId()
            );
        }
        ...
        public void TestMethodWithClosedGenericParameter()
        {
            Assert.Equal(
                ...
                _acmeNamespace.GetTypeMembers("UseList")
                    .Single()
                    .GetMembers("Process")
                    .Single()
                    .GetDocumentationCommentId()
        ...
        public void TestMethodWithMissingType()
        {
            ...
            var compilation = CreateCompilation(
                references: new[] { csharpAssemblyReference, ilAssemblyReference },
                source: @"class C
{
    internal static CSharpErrors.ClassMethods F = null;
        ...
        {
            Assert.Equal(
                "M:Acme.ValueType.op_Explicit(System.Byte)~Acme.ValueType",
                _acmeNamespace.GetTypeMembers("ValueType")
                    .Single()
...
";
            ...
            Assert.Equal(
                @"<!-- Badly formed XML comment ignored for member ""M:Test.Main"" -->",
                main.GetDocumentationCommentXml(EnsureEnglishUICulture.PreferredOrNull).Trim()
            );
