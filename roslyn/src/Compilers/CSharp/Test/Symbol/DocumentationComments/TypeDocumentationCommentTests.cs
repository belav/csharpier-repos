...
namespace Acme
{
	...
	class MyList<T>
	{
        ...
        public void TestEnum()
        {
            Assert.Equal(
                "T:Color",
                _compilation.GlobalNamespace.GetTypeMembers("Color")
                    .Single()
...
",
        ...
        public void TestNestedInterface()
        {
            Assert.Equal(
                ...
                _widgetClass.GetMembers("IMenuItem").Single().GetDocumentationCommentId()
            );
        }
        ...
        public void TestNestedGenericType()
        {
            Assert.Equal(
                ...
                _acmeNamespace.GetTypeMembers("MyList", 1)
                    .Single()
                    .GetTypeMembers("Helper", 2)
                    .Single()
                    .GetDocumentationCommentId()
            );
        }
