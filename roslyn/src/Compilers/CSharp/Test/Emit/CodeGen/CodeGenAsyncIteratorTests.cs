        ...
        await using (var enumerator = M(0))
        {
            ...
            void verifyMembersAndInterfaces(ModuleSymbol module)
            {
                ...
                AssertEx.SetEqual(
                    ...
                    type.InterfacesAndTheirBaseInterfacesNoUseSiteDiagnostics.Keys
        ...
        throw new System.NotImplementedException();
            ...
            comp.VerifyEmitDiagnostics(
                ...
                Diagnostic(ErrorCode.ERR_PossibleAsyncIteratorWithoutYieldOrAwait, "M")
                    .WithArguments("System.Collections.Generic.IAsyncEnumerable<int>")
                    .WithLocation(4, 74)
            );
                ...
                @"
{
  ...
  IL_0141:  ret
        ...
        )
        {
            ...
            var fields = metadataReader.GetTypeDefinition(type)
                .GetFields()
