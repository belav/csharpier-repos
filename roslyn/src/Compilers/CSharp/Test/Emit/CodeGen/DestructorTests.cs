...
";
            Action<ModuleSymbol> validator = module =>
            {
                ...
                Assert.True(
                    systemNamespace.GetMember<NamedTypeSymbol>("Object")
                ...
                Assert.False(
                    globalNamespace.GetMember<NamedTypeSymbol>("F")
                        .GetMember<MethodSymbol>("Finalize")
                        .IsRuntimeFinalizer()
                );
                Assert.False(
                ...
                Assert.True(
                    globalNamespace.GetMember<NamedTypeSymbol>("H")
                        .GetMember<MethodSymbol>("Finalize")
                        .IsRuntimeFinalizer()
                );
                Assert.False(
...
";
            CompileAndVerify(
                ...
                assemblyValidator: (assembly) =>
                {
                    ...
                    MethodDefinitionHandle handleDestructorA = typeA.GetMethods()
                        .AsEnumerable()
                        .Single(
                            handle =>
                    ...
                    MethodImplementation methodImpl = typeA.GetMethodImplementations()
                        .AsEnumerable()
