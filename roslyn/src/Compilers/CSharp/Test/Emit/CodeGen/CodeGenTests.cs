...
class Program
{
    static void Main()
    {
        Util.M(""test"");
            ...
            var testReference = AssemblyMetadata
                .CreateFromImage(ProprietaryTestResources.Repros.BadDefaultParameterValue)
                .GetReference();
...
";
            ...
            comp.VerifyDiagnostics();
            var verifier = CompileAndVerify(comp, expectedOutput: "System.Int32")
                .VerifyDiagnostics();
