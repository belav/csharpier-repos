...
";
            CreateCompilation(
                ...
                .VerifyDiagnostics(
                    ...
                    //         Field1 = Constant;
                    Diagnostic(ErrorCode.ERR_BadAccess, "Constant")
                        .WithArguments("Base.Constant")
                        .WithLocation(5, 18),
                    ...
                    //         Property2 = Constant;
                    Diagnostic(ErrorCode.ERR_InaccessibleSetter, "Property2")
                        .WithArguments("Base.Property2")
                        .WithLocation(10, 9),
                    ...
                    //         this[string.Empty] = 4;
                    Diagnostic(ErrorCode.ERR_InaccessibleSetter, "this[string.Empty]")
                        .WithArguments("Base.this[string]")
                        .WithLocation(12, 9),
                    // (14,22): error CS0122: 'Base.Base()' is inaccessible due to its protection level
                    //     Derived(int x) : base() {}
                    Diagnostic(ErrorCode.ERR_BadAccess, "base")
                        .WithArguments("Base.Base()")
                        .WithLocation(14, 22),
                    // (15,5): error CS0122: 'Base.Base()' is inaccessible due to its protection level
                    //     Derived(long x) {} // implicit base()
                    Diagnostic(ErrorCode.ERR_BadAccess, "Derived")
                        .WithArguments("Base.Base()")
                        .WithLocation(15, 5)
                );
            CreateCompilation(
            ...
            var verifier = CompileAndVerify(
                ...
                expectedSignatures: new[]
                {
                    Signature(
                        "Program",
                        "M",
                        ".method famandassem hidebysig instance System.Void M() cil managed"
                    ),
...
";
            CreateCompilation(
                ...
                .VerifyDiagnostics(
                    ...
                    //     override private protected void F() {}
                    Diagnostic(ErrorCode.ERR_OverrideNotExpected, "F")
                        .WithArguments("B.F()")
                        .WithLocation(3, 37),
                    // (1,7): error CS0534: 'B' does not implement inherited abstract member 'A.F()'
                    // class B : A // CS0534
...
";
            CreateCompilationWithMscorlib45(source, parseOptions: TestOptions.Regular7_2)
                .VerifyDiagnostics(
                    ...
                    //     static private protected void SomeExtension(this string s) { } // error: no pp in static class
                    Diagnostic(ErrorCode.ERR_ProtectedInStatic, "SomeExtension")
                        .WithArguments("Extensions.SomeExtension(string)")
                        .WithLocation(4, 35),
                    ...
                    //         s.SomeExtension(); // error: no accessible SomeExtension
                    Diagnostic(ErrorCode.ERR_NoSuchMemberOrExtension, "SomeExtension")
                        .WithArguments("string", "SomeExtension")
                        .WithLocation(11, 11)
                );
        }
    }
