...
",
            ...
            {
                stream.Position = 0;
                int entryPoint = new PEHeaders(stream).CorHeader
...
public class Test
{
    public static void Main()
    {
        ...
        public void EmitAssemblyWithGivenName()
        {
            ...
            Assert.True(
                compilation
                    .Emit(stream, options: new EmitOptions(outputNameOverride: nameWithExtension))
                    .Success
            );
        ...
        public void EmitAssemblyWithDifferentName2()
        {
            ...
            Assert.True(
                compilation
                    .Emit(stream, options: new EmitOptions(outputNameOverride: nameOverride))
                    .Success
            );
