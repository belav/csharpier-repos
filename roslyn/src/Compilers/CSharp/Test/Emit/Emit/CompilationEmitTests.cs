...
"
        ...
        )
        {
            ...
            AssertEx.Equal(
                expectedMethods,
                compWithMetadata
                    .GetMember<NamedTypeSymbol>(containingType)
                    .GetMembers()
...
";
        ...
        public void RefAssembly_InvariantToResourceChanges()
        {
            ...
            )
            {
                ...
                var refoutOptions = EmitOptions.Default
            ...
            )
            {
                ...
                var refonlyOptions = EmitOptions.Default
                    .WithEmitMetadataOnly(true)
                    .WithIncludePrivateMembers(false);
                ...
                @"class C
{
    string M()
    {
        ...
        {
            var id1 = ModuleMetadata
                .CreateFromImage(firstImage)
                .GetMetadataReader()
                .ReadAssemblyIdentityOrThrow();
            var id2 = ModuleMetadata
                .CreateFromImage(secondImage)
                .GetMetadataReader()
                .ReadAssemblyIdentityOrThrow();
...
";
            ...
            var emitRefOnly = EmitOptions.Default
                .WithEmitMetadataOnly(true)
                .WithIncludePrivateMembers(false);
...
";
            ...
            AssertEx.Equal(
                ...
                globalNamespace
                    .GetMember<NamespaceSymbol>("Microsoft.CodeAnalysis")
                    .GetMembers()
                    .Select(m => m.ToDisplayString())
            );
            ...
            AssertEx.Equal(
                ...
                globalNamespace
                    .GetMember<NamespaceSymbol>("System.Runtime")
                    .GetMembers()
                    .Select(m => m.ToDisplayString())
            );
            AssertEx.Equal(
                ...
                globalNamespace
                    .GetMember<NamespaceSymbol>("System.Runtime.CompilerServices")
                    .GetMembers()
                    .Select(m => m.ToDisplayString())
            );
