        ...
        public void DelegateRoundTrip()
        {
            ...
            CompileAndVerify(
                ...
                symbolValidator: module =>
                {
                    ...
                    Assert.Equal(
                        "System.Object",
                        beginInvoke.Parameters[invoke.Parameters.Length + 1].Type
                            .ToTestDisplayString()
                    );
...
class T
{
    public void M(in int a, [In]in int b, [In]int c, int d) {}
            ...
            {
                var parameters = module.GlobalNamespace
                    .GetTypeMember("T")
                    .GetMethod("M")
                    .GetParameters();
...
public class Parent
{
    public void M(out int a, [Out] int b) => throw null;
            ...
            CompileAndVerify(
                ...
                symbolValidator: module =>
                {
                    var sourceParentParameters = module.GlobalNamespace
...
public class Child : Parent, IParent
{
            ...
            CompileAndVerify(
                ...
                symbolValidator: module =>
                {
                    var interfaceParameters = module.GlobalNamespace
                    ...
                    var proxyChildParameters = module.GlobalNamespace
                        .GetTypeMember("Child")
                        .GetMethod("IParent.M")
                        .GetParameters();
