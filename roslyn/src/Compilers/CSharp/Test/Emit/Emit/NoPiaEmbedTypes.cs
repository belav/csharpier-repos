...
";
            ...
            System.Action<ModuleSymbol> metadataValidator = delegate(ModuleSymbol module)
            {
                ...
                var interface1_Event = (PENamedTypeSymbol)
                ...
                var interfaceEvents = (PENamedTypeSymbol)
...
";
            var dispIdDefinition = CreateCompilation(
                    dispId,
                    options: TestOptions.ReleaseDll,
                    assemblyName: "DispId"
                )
                .EmitToImageReference(aliases: ImmutableArray.Create("dispId"));
...
";
            ...
            var piaCompilation = CreateCompilation(
                pia,
                references: new[] { dispIdDefinition },
                options: TestOptions.ReleaseDll,
                assemblyName: "Pia"
            );
...
";
            ...
            CompileAndVerify(
                    compilation1.AddReferences(dispIdDefinition),
                    symbolValidator: metadataValidator
                )
                .VerifyDiagnostics();
            ...
            compilation1.VerifyEmitDiagnostics(
                ...
                Diagnostic(ErrorCode.ERR_NoTypeDef)
                    .WithArguments(
                        ...
                        "DispId, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null"
                    )
                    .WithLocation(1, 1)
            );

            CompileAndVerify(
                    compilation2.AddReferences(dispIdDefinition),
                    symbolValidator: metadataValidator
                )
                .VerifyDiagnostics();
...
";
            ...
            piaCompilation.VerifyDiagnostics(
                ...
                //     [System.Runtime.InteropServices.DispIdAttribute("124")]
                Diagnostic(ErrorCode.ERR_BadArgType, @"""124""")
...
";
            ...
            System.Action<ModuleSymbol> metadataValidator = delegate(ModuleSymbol module)
            {
                ...
                var myDelegate = (PENamedTypeSymbol)
...
";
            ...
            System.Action<ModuleSymbol> metadataValidator = delegate(ModuleSymbol module)
            {
                ...
                var IEventsBase = (PENamedTypeSymbol)
