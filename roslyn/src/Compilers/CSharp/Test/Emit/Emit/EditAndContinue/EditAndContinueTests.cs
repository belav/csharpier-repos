            ...
            using var _ = new EditAndContinueTest(
                ...
                .AddGeneration(
                    ...
                    validator: g =>
                    {
                        ...
                        g.VerifyMemberRefNames( /*CompilationRelaxationsAttribute.*/
                ...
                .AddGeneration(
                    ...
                    validator: g =>
                    {
                        ...
                        g.VerifyEncMapDefinitions(
                            new[] { Handle(2, TableIndex.MethodDef), Handle(1, TableIndex.Param) }
                        );
...
class C
{
    ...
    static string F() { return string.Empty; }
                    ...
                    validator: g =>
                    {
                        ...
                        g.VerifyMemberRefNames( /*DescriptionAttribute*/
                            ".ctor", /*String.*/
                            "Empty"
                        );
...
class C
{
    ...
    static string F() { return string.Empty; }
                    ...
                    validator: g =>
                    {
                        ...
                        g.VerifyMethodDefNames("F");
                        g.VerifyMemberRefNames( /*DescriptionAttribute*/
                            ".ctor", /*BrowsableAttribute*/
                            ".ctor", /*CategoryAttribute*/
                            ".ctor", /*String.*/
                            "Empty"
                        );
                        ...
                        g.VerifyEncLog(
                            new[]
                            {
                                ...
                                ), // Row 4, updating the existing custom attribute
                                Row(
                                    5,
                                    TableIndex.CustomAttribute,
                                    EditAndContinueOperation.Default
                                ), // Row 5, adding a new CustomAttribute
...
class C
{
    ...
    static string F() { return string.Empty; }
                    ...
                    validator: g =>
                    {
                        g.VerifyTypeDefNames();
                        g.VerifyMethodDefNames("F");
                        g.VerifyMemberRefNames( /*BrowsableAttribute*/
                            ".ctor", /*DescriptionAttribute*/
                            ".ctor", /*CategoryAttribute*/
                            ".ctor", /*String.*/
                            "Empty"
                        ...
                        g.VerifyEncLog(
                            new[]
                            {
                                ...
                                Row(
                                    ...
                                    TableIndex.CustomAttribute,
                                    EditAndContinueOperation.Default
                                ), // Row 5, updating a row that was new in Generation 2
...
";
            ...
            CheckNames(
                readers,
                reader1.GetMemberRefNames(), /*BrowsableAttribute*/
                ".ctor", /*CategoryAttribute*/
                ".ctor", /*DescriptionAttribute*/
                ".ctor"
            );
                ...
                @"class C
{
    ...
    static string F() { return string.Empty; }
            ...
            CheckNames(
                readers,
                reader2.GetMemberRefNames(), /*DescriptionAttribute*/
                ".ctor", /*String.*/
                "Empty"
            );
            ...
            CheckEncLog(
                ...
                Row(2, TableIndex.MethodDef, EditAndContinueOperation.Default),
                Row(4, TableIndex.CustomAttribute, EditAndContinueOperation.Default)
            ); // Row 4, updating the original row back to a real one
                ...
                @"class C
{
    ...
    static string F() { return string.Empty; }
            ...
            CheckNames(
                readers,
                reader1.GetMemberRefNames(), /*DescriptionAttribute*/
                ".ctor", /*String.*/
                "Empty"
            );
            ...
            CheckEncLog(
                ...
                Row(2, TableIndex.MethodDef, EditAndContinueOperation.Default),
                Row(4, TableIndex.CustomAttribute, EditAndContinueOperation.Default)
            ); // Row 4, so adding a new CustomAttribute
            ...
            CheckNames(
                readers,
                reader3.GetMemberRefNames(), /*DescriptionAttribute*/
                ".ctor", /*String.*/
                "Empty"
            );
            ...
            CheckEncLog(
                ...
                Row(2, TableIndex.MethodDef, EditAndContinueOperation.Default),
                Row(4, TableIndex.CustomAttribute, EditAndContinueOperation.Default)
            ); // Row 4, update the previously deleted row
...
class C
{
    void F()
    {
        var x = <N:0>[System.Obsolete](int a) => a</N:0>;
            ...
            diff1.VerifySynthesizedMembers("C: {<>c}", "C.<>c: {<>9__0_0, <F>b__0_0}");
    ...
    void F()
    {
        ...
        var z = <N:2>(int _1, int _2, int _3, int _4, int _5, int _6, ref int _7, int _8, int _9, int _10, int _11, int _12, int _13, int _14, int _15, int _16, int _17, int _18, int _19, int _20, int _21, int _22, int _23, int _24, int _25, int _26, int _27, int _28, int _29, int _30, int _31, int _32, ref int _33) => { _1.ToString(); }</N:2>;
            ...
            CheckNames(
                ...
                "C",
                "<>c"
            ); // <>F{00000001}`3 is the synthesized delegate for the lambda
            CheckNames(
                reader0,
                reader0.GetMethodDefNames(),
                ".ctor",
            ...
            CheckNames(
                ...
                "<>A{00001000,00000001}`33",
                "<>F{00000004}`3"
            ); // new synthesized delegate for the new lambda
            CheckNames(
                readers,
...
class C
{
    static unsafe void F()
    {
        var x = <N:0>(B<A>* a, int b) => b</N:0>;
            ...
            diff1.VerifySynthesizedMembers("C.<>c: {<>9__0#1, <F>b__0#1}", "C: {<>c}");
                ...
                @"class C
{
    void F()
    {
        ...
        System.Console.WriteLine(1);
            ...
            diff1.VerifySynthesizedMembers("C.<>c: {<>9__0_0, <F>b__0_0}", "C: {<>c}");
        }
                        ...
                        g.VerifyEncLogDefinitions(
                            new[]
                            {
                                ...
                                Row(
                                    ...
                                    TableIndex.CustomAttribute,
                                    EditAndContinueOperation.Default
                                ), // Same row numbers as previous gen
                                Row(
                                    8,
                                    TableIndex.CustomAttribute,
                                    EditAndContinueOperation.Default
...
";
            ...
            var diff2 = compilation2.EmitDifference(
                diff1.NextGeneration,
                ImmutableArray.Create(SemanticEdit.Create(SemanticEditKind.Insert, null, q2))
            );
            ...
            using var _ = new EditAndContinueTest(
                ...
                .AddGeneration(
                    ...
                    edits: new[]
                    {
                        Edit(
                            SemanticEditKind.Delete,
                            symbolProvider: c => c.GetMember("C.get_P"),
                            newSymbolProvider: c => c.GetMember("C")
                        ),
                        Edit(
                            SemanticEditKind.Delete,
                            symbolProvider: c => c.GetMember("C.set_P"),
                            newSymbolProvider: c => c.GetMember("C")
                        ),
                    },
                    validator: g =>
            ...
            using var _ = new EditAndContinueTest(
                ...
                .AddGeneration(
                    ...
                    edits: new[]
                    {
                        Edit(
                            SemanticEditKind.Delete,
                            symbolProvider: c => c.GetMember("C.get_Q"),
                            newSymbolProvider: c => c.GetMember("C")
                        ),
                        Edit(
                            SemanticEditKind.Delete,
                            symbolProvider: c => c.GetMember("C.set_Q"),
                            newSymbolProvider: c => c.GetMember("C")
                        ),
                        Edit(SemanticEditKind.Insert, symbolProvider: c => c.GetMember("C.P")),
                    },
            ...
            using var _ = new EditAndContinueTest(
                ...
                .AddGeneration(
                    ...
                    edits: new[]
                    {
                        Edit(
                            SemanticEditKind.Delete,
                            symbolProvider: c => c.GetMember("C.get_Item"),
                            newSymbolProvider: c => c.GetMember("C")
                        ),
                        Edit(
                            SemanticEditKind.Delete,
                            symbolProvider: c => c.GetMember("C.set_Item"),
                            newSymbolProvider: c => c.GetMember("C")
                        ),
                    },
                    validator: g =>
...
class C
{
    ...
    event System.Action G;
            ...
            var diff1 = compilation1.EmitDifference(
                generation0,
                ImmutableArray.Create(SemanticEdit.Create(SemanticEditKind.Insert, null, e1))
            );
            ...
            var diff2 = compilation2.EmitDifference(
                diff1.NextGeneration,
                ImmutableArray.Create(SemanticEdit.Create(SemanticEditKind.Insert, null, g2))
            );
            ...
            using var _ = new EditAndContinueTest(
                ...
                .AddGeneration(
                    ...
                    edits: new[]
                    {
                        Edit(
                            SemanticEditKind.Delete,
                            symbolProvider: c => c.GetMember("C.add_E"),
                            newSymbolProvider: c => c.GetMember("C")
                        ),
                        Edit(
                            SemanticEditKind.Delete,
                            symbolProvider: c => c.GetMember("C.remove_E"),
                            newSymbolProvider: c => c.GetMember("C")
                        ),
                    },
                    validator: g =>
            ...
            using var _ = new EditAndContinueTest(
                ...
                .AddGeneration(
                    ...
                    edits: new[]
                    {
                        Edit(
                            SemanticEditKind.Delete,
                            symbolProvider: c => c.GetMember("C.add_F"),
                            newSymbolProvider: c => c.GetMember("C")
                        ),
                        Edit(
                            SemanticEditKind.Delete,
                            symbolProvider: c => c.GetMember("C.remove_F"),
                            newSymbolProvider: c => c.GetMember("C")
                        ),
    ...
    void F(int x, int y) { System.Console.WriteLine(2); }
            ...
            void ValidateReplacedType(CompilationDifference diff, MetadataReader[] readers)
            {
                ...
                CheckEncLogDefinitions(
                    ...
                    Row(
                        baseMethodCount + generation * 2 - 1,
                    ...
                    Row(
                        baseMethodCount + generation * 2 - 1,
                        TableIndex.MethodDef,
                        EditAndContinueOperation.AddParameter
                    ),
                    Row(
                        baseParameterCount + generation * 2 - 1,
                        TableIndex.Param,
                        EditAndContinueOperation.Default
                    ),
                    Row(
                    ...
                    Row(
                        baseParameterCount + generation * 2,
                        TableIndex.Param,
                        EditAndContinueOperation.Default
                    ),
                    hasAttribute
                        ? Row(
                            baseAttributeCount + generation,
                            TableIndex.CustomAttribute,
                            EditAndContinueOperation.Default
                        )
                        : default
                ); // adding a new attribute row for attribute on C#* definition
                ...
                CheckEncMapDefinitions(
                    ...
                    hasAttribute
                        ? Handle(baseAttributeCount + generation, TableIndex.CustomAttribute)
                        : default
                );
                ...
                if (hasAttribute)
                {
                    ...
                    var parentHandle = aggregator.GetGenerationHandle(
                        attribute.Parent,
                    ...
                    var ctorHandle = aggregator.GetGenerationHandle(
                        attribute.Constructor,
                        out var ctorGeneration
                    );
                    ...
                    CheckBlobValue(
                        readers,
                        attribute.Value,
                        new byte[] { 0x01, 0x00, 0x01, (byte)'C', 0x00, 0x00 }
                    );
                }
            }
            ...
            CheckBlobValue(
                readers,
                reader3.GetCustomAttribute(reader3.CustomAttributes.First()).Value,
...
class C
{
    ...
    static event EventHandler E;
            ...
            var diff1 = compilation1.EmitDifference(
                generation0,
                ImmutableArray.Create(SemanticEdit.Create(SemanticEditKind.Update, event0, event1))
            );
...
class C
{
    static void M()
    {
        int[] a = new[] { 1, 2, 3, 4 };
            ...
            var compilation0 = CreateCompilation(
                Parse(source0, "a.cs", parseOptions),
                options: TestOptions.DebugDll
            );
...
";
            ...
            var diff1 = compilation1.EmitDifference(
                generation0,
                ImmutableArray.Create(SemanticEdit.Create(SemanticEditKind.Insert, null, ctor1))
            );
    ...
    static void N()
    {
        ...
        M(b);
            ...
            var generation0 = EmitBaseline.CreateInitialBaseline(
                ...
                m =>
                    testData0
                        .GetMethodData(methodNames0[MetadataTokens.GetRowNumber(m) - 1])
                        .GetEncDebugInfo()
            );
            ...
            using var _ = new EditAndContinueTest(
                ...
                .AddGeneration(
                    ...
                    edits: new[]
                    {
                        Edit(
                            SemanticEditKind.Delete,
                            symbolProvider: c => c.GetMember("C.op_LogicalNot"),
                            newSymbolProvider: c => c.GetMember("C")
                        ),
                    },
                    validator: g =>
                    {
                        g.VerifyTypeDefNames();
                        g.VerifyMethodDefNames("op_LogicalNot");
                        g.VerifyMemberRefNames( /* MissingMethodException */
                            ".ctor"
                        );
                        g.VerifyEncLogDefinitions(
                        ...
                        g.VerifyEncMapDefinitions(
                            new[] { Handle(1, TableIndex.MethodDef), Handle(1, TableIndex.Param), }
                        );
...
";
            ...
            CheckNames(
                readers,
                reader1.GetMemberRefNames(), /*CompilerGenerated*/
                ".ctor", /*Console.*/
                "WriteLine"
            );
...
class C
{
    void M()
    {
        ...
        Console.WriteLine(x(1, 2));
            ...
            diff.VerifySynthesizedMembers("C: {<>c}", "C.<>c: {<>9__0_0, <M>b__0_0}");
            ...
            using var _ = new EditAndContinueTest(
                ...
                .AddGeneration(
                    ...
                    validator: g =>
                    {
                        ...
                        g.VerifyEncMapDefinitions(
                            new[] { Handle(1, TableIndex.MethodDef), }.Concat(
                                Enumerable
                                    .Range(1, parameterCount)
                                    .Select(i => Handle(i, TableIndex.Param))
                            )
                        );
            ...
            using var _ = new EditAndContinueTest(
                ...
                .AddGeneration(
                    ...
                    validator: g =>
                    {
                        ...
                        g.VerifyEncMapDefinitions(
                            new[] { Handle(3, TableIndex.MethodDef), Handle(1, TableIndex.Param), }
                        );
...
file class C
{
    void M()
    {
        Console.Write(<N:0>3</N:0>);
            ...
            var compilation0 = CreateCompilation(
                new[] { source1_gen0.Tree, source2_gen0.Tree },
                options: ComSafeDebugDll
            );
