        ...
        public void Lambda_Delete()
        {
            using var _ = new EditAndContinueTest()
                ...
                .AddGeneration(
                    ...
                    validator: g =>
                    {
                        g.VerifySynthesizedMembers("C: {<>c}", "C.<>c: {<>9__0_1, <F>b__0_1}");
                        g.VerifyTypeDefNames();
                        g.VerifyMethodDefNames("F", "<F>b__0_0", "<F>b__0_1");
                        g.VerifyTypeRefNames(
                            "Object",
...
";
            ...
            var diff1 = compilation1.EmitDifference(
                ...
                explicitAccessorEdits
                    ? ImmutableArray.Create(
                        SemanticEdit.Create(SemanticEditKind.Insert, null, r1),
                        SemanticEdit.Create(SemanticEditKind.Insert, null, r1.GetMethod)
                    )
...
class C
{
    ...
    void F(int x, int y) { System.Console.WriteLine(2); }
            ...
            var attributeTypeDefHandle = reader0.TypeDefinitions
                .Single(d =>
            ...
            var attributeCtorDefHandle = reader0.MethodDefinitions
                .Single(d =>
                {
...
class B
{
    ...
    object x = ((dynamic)F) + 1;
            ...
            generation0 = CreateInitialBaseline(
                compilation0,
                md0,
                methodData0.EncDebugInfoProvider()
            );
        ...
        public void TypeDefinitionDocumentInformation()
        {
            ...
            var diff1 = compilation1.EmitDifference(
                ...
                ImmutableArray.Create(
                    SemanticEdit.Create(
                        SemanticEditKind.Update,
                        compilation0.GetMember("C.Main"),
                        compilation1.GetMember("C.Main")
                    )
                )
            );
...
public class B
{
    public static void F() { var a = new A(); }
            ...
            var mdB0 = ModuleMetadata.CreateFromImage(bytesB0);
            var generationB0 = CreateInitialBaseline(
                compilationB0,
                mdB0,
        ...
        public void Records_AddPrimaryConstructorParameter()
        {
            using var _ = new EditAndContinueTest(
                ...
                .AddGeneration(
                    ...
                    validator: g =>
                    {
                        g.VerifyMethodDefNames(".ctor", "get_Q", "set_Q", "Deconstruct");
        ...
        public void Records_AddProperty_NonPrimary()
        {
            using var _ = new EditAndContinueTest(
                ...
                .AddGeneration(
                    ...
                    validator: g =>
                    {
                        g.VerifyMethodDefNames("get_Q", "set_Q");
            ...
            using var _ = new EditAndContinueTest(
                ...
                .AddBaseline(
                    ...
                    validator: g =>
                    {
                        ...
                        g.VerifyFieldDefNames(
                            "BEB0DBD1C6FAC1140DD817514F2FBDF501E246BF16C8E877E71187E9EB008189"
                        );
                        g.VerifyMethodDefNames("F", ".ctor");
                    }
                )
