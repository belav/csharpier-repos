            ...
            var diff1 = compilation1.EmitDifference(
                ...
                ImmutableArray.Create(
                    SemanticEdit.Create(
                        ...
                        compilation0.GetMember<MethodSymbol>("C.F"),
...
class C
{
    void F()
    {
        <N:0>int x() => 2;</N:0>
            ...
            diff1.VerifySynthesizedMembers("C: {<F>g__x|0_0}");
...
class C
{
    void F<T>()
    {
        Func<T> x = <N:0>() => default(T)</N:0>;
            ...
            // no new synthesized members generated (with #1 in names):
            diff1.VerifySynthesizedMembers("C: {<>c__0}", "C.<>c__0<T>: {<>9__0_0, <F>b__0_0}");
...
class C
{
    int F(int a)
    {
        ...
        return 2;
            ...
            // no new synthesized members generated (with #1 in names):
            diff1.VerifySynthesizedMembers("C: {<F>b__0_0}");
...
class C
{
    ...
    static object F()
    {
        return G(<N:0>a => a + 2</N:0>);
            ...
            diff1.VerifySynthesizedMembers("C: {<>c}", "C.<>c: {<>9__0#1, <F>b__0#1}");
...
"
            ...
            diff2.VerifySynthesizedMembers("C: {<>c}", "C.<>c: {<>9__0#1, <F>b__0#1}");
...
class C
{
    ...
    static object F()
    {
        ...
        return G(f);
            ...
            // new lambda "<F>b__0#1" has been added:
            diff1.VerifySynthesizedMembers("C: {<F>g__f|0#1}");
...
"
            ...
            diff2.VerifySynthesizedMembers("C: {<F>g__f|0#1}");
...
class C
{
    ...
    static object F()
    {
        ...
        return G(f1) + G(f2) + G(f3);
            ...
            diff1.VerifySynthesizedMembers("C: {<F>g__f1|1_0, <F>g__f2|1_1#1}");
...
"
            ...
            diff2.VerifySynthesizedMembers("C: {<F>g__f1|1_0, <F>g__f2|1_1#1, <F>g__f3|1_2#2}");
...
"
            ...
            diff3.VerifySynthesizedMembers("C: {<F>g__f1|1_0, <F>g__f2|1_1#1, <F>g__f3|1_2#2}");
    ...
    { 
        ...
        return 2;
            ...
            var f_byte2 = compilation2.GetMembers("C.F")
                .Single(m => m.ToString() == "C.F<T>(byte)");
...
class C
{
    ...
    public C(int x)
    {
        G(<N:3>a => a - 4</N:3>);
            ...
            var ctor00 = compilation0.GetMembers("C..ctor")
                .Single(m => m.ToTestDisplayString() == "C..ctor()");
            var ctor10 = compilation0.GetMembers("C..ctor")
                .Single(m => m.ToTestDisplayString() == "C..ctor(System.Int32 x)");
            var ctor01 = compilation1.GetMembers("C..ctor")
                .Single(m => m.ToTestDisplayString() == "C..ctor()");
            var ctor11 = compilation1.GetMembers("C..ctor")
                .Single(m => m.ToTestDisplayString() == "C..ctor(System.Int32 x)");
                ...
                @"
{
  ...
  IL_002c:  ret
        ...
        [WorkItem(
            179990,
            "https://devdiv.visualstudio.com:443/defaultcollection/DevDiv/_workitems/edit/179990"
        )]
        [Fact]
...
public class C 
{
    ...
    <N:1>{</N:1>
        ...
        L();
            ...
            diff1.VerifySynthesizedMembers("C: {<F>g__L|1_0}");
