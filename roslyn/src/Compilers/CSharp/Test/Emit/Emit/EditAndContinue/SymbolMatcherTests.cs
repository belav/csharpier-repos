...
namespace Microsoft.CodeAnalysis.CSharp.EditAndContinue.UnitTests
{
    public class SymbolMatcherTests : EditAndContinueTestBase
    {
        ...
        private static CSharpSymbolMatcher CreateMatcher(
            CSharpCompilation fromCompilation,
            CSharpCompilation toCompilation
        ) =>
...
class C
{
    static void F()
    {
        ...
        var y = new Func<int>(() => x1.A + x2.b);
            ...
            var synthesizedTypes0 = PEDeltaAssemblyBuilder.GetSynthesizedTypesFromMetadata(
                reader0,
                decoder0
            );
...
class C
{
    static void F()
    {
        ...
        var _3 = (int _1, int _2, int _3, int _4, int _5, int _6, int _7, int _8, int _9, int _10, int _11, int _12, int _13, int _14, int _15, int _16, int _17, int _18, int _19, int _20, int _21, int _22, int _23, int _24, int _25, int _26, int _27, int _28, int _29, int _30, int _31, int _32, ref int _33) => { _1.ToString(); };
            ...
            Assert.Contains(
                new SynthesizedDelegateKey("<>F{00000008}`3"),
                synthesizedDelegates0.Keys
            );
            Assert.Contains(
                new SynthesizedDelegateKey("<>A{00000003}`2"),
                synthesizedDelegates0.Keys
            );
            Assert.Contains(
                new SynthesizedDelegateKey("<>A{00000000,100000000}`33"),
                synthesizedDelegates0.Keys
            );
    ...
    static void Main()
    {
        var d1 = (int* p) => 1;
            ...
            Assert.Equal(
                ...
                anonymousDelegates0.Single().Value.Single().Name
            );
