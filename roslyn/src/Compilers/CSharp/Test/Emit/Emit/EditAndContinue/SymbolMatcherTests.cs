                ...
                @"unsafe class Program
{
    static void Main()
    {
        ...
        public void SynthesizedDelegates_03()
        {
            ...
            Assert.Equal(
                "<>f__AnonymousDelegate0<T1, T2, TResult>",
                anonymousDelegates0["<>f__AnonymousDelegate0"].Type.ToString()
            );
            Assert.Equal(
                "<>f__AnonymousDelegate1",
                anonymousDelegates0["<>f__AnonymousDelegate1"].Type.ToString()
            );
            Assert.Equal(
                "<>f__AnonymousDelegate2",
                anonymousDelegates0["<>f__AnonymousDelegate2"].Type.ToString()
            );
