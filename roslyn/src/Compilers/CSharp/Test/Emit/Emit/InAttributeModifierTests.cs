    ...
    public static void Main()
    {
        ...
        System.Console.WriteLine(obj.M());
            ...
            CompileAndVerify(
                source: userCode,
                expectedOutput: "5",
                references: new[] { testRef.ToMetadataReference() },
            ...
            CompileAndVerify(
                source: userCode,
                expectedOutput: "5",
                references: new[] { testRef.EmitToImageReference() },
                options: TestOptions.ReleaseExe,
                symbolValidator: validator
            );
        }
    ...
    public static void Main()
    {
        ...
        System.Console.WriteLine(obj.M());
            ...
            Action<ModuleSymbol> validator = module =>
            {
                ...
                var explicitModifier =
                    type.GetMethod("Parent.M").RefCustomModifiers.Single().Modifier;
...
public class Test
{
    public ref readonly int M() => throw null;
            ...
            var comp = CreateCompilation(user, references: new[] { ref1, ref2 })
                .VerifyDiagnostics();
            ...
            var assembly =
                (
                    (Symbols.PublicModel.NonSourceAssemblySymbol)attribute.ContainingAssembly
