...
";
        ...
        internal struct DynamicAttributeValidator
        {
            ...
            private readonly NamedTypeSymbol _base0Class,
                ...
                _base2Class,
                _derivedClass;
            private readonly NamedTypeSymbol _outerClass,
                _innerClass,
                _innerInnerClass;
            private readonly NamedTypeSymbol _outer2Class,
                _inner2Class,
                _innerInner2Class;
            private readonly NamedTypeSymbol _outer3Class,
                _inner3Class;
            ...
            private DynamicAttributeValidator(ModuleSymbol module)
            {
                ...
                _synthesizedMyDelegateType = globalNamespace.GetMember<NamedTypeSymbol>(
                    "MyDelegate"
                );
            ...
            private void ValidateAttributesOnNamedTypes()
            {
                ...
                _expectedTransformFlags = new bool[]
                {
                    false,
                    true,
                    false,
                ...
                ValidateDynamicAttribute(
                    ...
                    expectedTransformFlags: _expectedTransformFlags
                );
                ...
                _expectedTransformFlags = new bool[] { false, true };
                ValidateDynamicAttribute(
                    _innerInnerClass.GetAttributes(),
                    expectedDynamicAttribute: true,
                    expectedTransformFlags: _expectedTransformFlags
                );
                ...
                ValidateDynamicAttribute(
                    _innerInner2Class.GetAttributes(),
                    expectedDynamicAttribute: false
                );

                // public class Inner3<U>
                ValidateDynamicAttribute(
                    _inner3Class.GetAttributes(),
                    expectedDynamicAttribute: false
                );
            }
            ...
            private void ValidateAttributesOnFields()
            {
                ...
                ValidateDynamicAttribute(
                    ...
                    expectedDynamicAttribute: true,
                    expectedTransformFlags: expectedTransformFlags
                );
                ...
                expectedTransformFlags = new bool[]
                {
                    false,
                    false,
                    true,
            ...
            private void ValidateAttributesOnMethodReturnValueAndParameters()
            {
                ...
                //.custom instance void [System.Core]System.Runtime.CompilerServices.DynamicAttribute::.ctor() = ( 01 00 00 00 )
                ValidateDynamicAttribute(
                    f1.GetReturnTypeAttributes(),
                    expectedDynamicAttribute: true
                );
                ValidateDynamicAttribute(
                    f1.Parameters[0].GetAttributes(),
                    expectedDynamicAttribute: true
                );
                ...
                //.custom instance void [System.Core]System.Runtime.CompilerServices.DynamicAttribute::.ctor(bool[]) = ( 01 00 02 00 00 00 * 00 01 * 00 00 )
                ValidateDynamicAttribute(
                    f2.GetReturnTypeAttributes(),
                    expectedDynamicAttribute: true
                );
                _expectedTransformFlags = new bool[] { false, true };
                ValidateDynamicAttribute(
                    f2.Parameters[0].GetAttributes(),
                    expectedDynamicAttribute: true,
                    expectedTransformFlags: _expectedTransformFlags
                );
                ...
                //.custom instance void [System.Core]System.Runtime.CompilerServices.DynamicAttribute::.ctor(bool[]) = ( 01 00 02 00 00 00 * 00 01 * 00 00 )
                ValidateDynamicAttribute(
                    f3.GetReturnTypeAttributes(),
                    expectedDynamicAttribute: true,
                    expectedTransformFlags: _expectedTransformFlags
                );
                ValidateDynamicAttribute(
                    f3.Parameters[0].GetAttributes(),
                    expectedDynamicAttribute: true,
                    expectedTransformFlags: _expectedTransformFlags
                );
                ...
                ValidateDynamicAttribute(
                    f4.GetReturnTypeAttributes(),
                    expectedDynamicAttribute: true,
                    expectedTransformFlags: _expectedTransformFlags
                );
                ValidateDynamicAttribute(
                    f4.Parameters[0].GetAttributes(),
                    expectedDynamicAttribute: true,
                    expectedTransformFlags: _expectedTransformFlags
                );
            ...
            private void ValidateAttributesOnProperty()
            {
                ...
                //.custom instance void [System.Core]System.Runtime.CompilerServices.DynamicAttribute::.ctor() = ( 01 00 00 00 )
                ValidateDynamicAttribute(
                    prop1.GetMethod.GetReturnTypeAttributes(),
                    expectedDynamicAttribute: true
                );
                ...
                //.custom instance void [System.Core]System.Runtime.CompilerServices.DynamicAttribute::.ctor(bool[]) = ( 01 00 0D 00 00 00 * 00 00 00 01 00 00 01 00 00 01 00 01 01 * 00 00 )
                ValidateDynamicAttribute(
                    prop2.GetMethod.GetReturnTypeAttributes(),
                    expectedDynamicAttribute: true,
                    expectedTransformFlags: _expectedTransformFlags
                );
                ...
                //.custom instance void [System.Core]System.Runtime.CompilerServices.DynamicAttribute::.ctor(bool[]) = ( 01 00 0D 00 00 00 * 00 00 00 01 00 00 01 00 00 01 00 01 01 * 00 00 )
                ValidateDynamicAttribute(
                    prop2.SetMethod.Parameters[0].GetAttributes(),
                    expectedDynamicAttribute: true,
                    expectedTransformFlags: _expectedTransformFlags
                );
            }
            ...
            private void ValidateAttributesOnIndexer()
            {
                ...
                //.custom instance void [System.Core]System.Runtime.CompilerServices.DynamicAttribute::.ctor() = ( 01 00 00 00 )
                ValidateDynamicAttribute(
                    indexer.GetMethod.GetReturnTypeAttributes(),
                    expectedDynamicAttribute: true
                );
                ValidateDynamicAttribute(
                    indexer.GetMethod.Parameters[0].GetAttributes(),
                    expectedDynamicAttribute: true
                );
                ...
                //.custom instance void [System.Core]System.Runtime.CompilerServices.DynamicAttribute::.ctor() = ( 01 00 00 00 )
                ValidateDynamicAttribute(
                    indexer.SetMethod.GetReturnTypeAttributes(),
                    expectedDynamicAttribute: false
                );
                ValidateDynamicAttribute(
                    indexer.SetMethod.Parameters[0].GetAttributes(),
                    expectedDynamicAttribute: true
                );
                ValidateDynamicAttribute(
                    indexer.SetMethod.Parameters[1].GetAttributes(),
                    expectedDynamicAttribute: true
                );
            }
            ...
            private void ValidateAttributesForSynthesizedDelegateMembers()
            {
                ...
                ValidateDynamicAttribute(
                    _synthesizedMyDelegateType.GetAttributes(),
                    expectedDynamicAttribute: false
                );
                ...
                //.custom instance void [System.Core]System.Runtime.CompilerServices.DynamicAttribute::.ctor(bool[]) = ( 01 00 02 00 00 00 * 00 01 * 00 00 )
                ValidateDynamicAttribute(
                    invokeMethod.GetReturnTypeAttributes(),
                    expectedDynamicAttribute: true,
                    expectedTransformFlags: expectedTransformFlags
                );
                ValidateDynamicAttribute(
                    invokeMethod.Parameters[0].GetAttributes(),
                    expectedDynamicAttribute: true,
                    expectedTransformFlags: expectedTransformFlags
                );
                ...
                var beginInvokeMethod = _synthesizedMyDelegateType.GetMember<MethodSymbol>(
                    "BeginInvoke"
                );
                ValidateDynamicAttribute(
                    beginInvokeMethod.GetAttributes(),
                    expectedDynamicAttribute: false
                );
                ValidateDynamicAttribute(
                ...
                ValidateDynamicAttribute(
                    parameters[0].GetAttributes(),
                    expectedDynamicAttribute: true,
                    expectedTransformFlags: expectedTransformFlags
                );
                ValidateDynamicAttribute(
                    parameters[1].GetAttributes(),
                    expectedDynamicAttribute: false
                );
                ValidateDynamicAttribute(
                    parameters[2].GetAttributes(),
                    expectedDynamicAttribute: false
                );
                ...
                var endInvokeMethod = _synthesizedMyDelegateType.GetMember<MethodSymbol>(
                    "EndInvoke"
                );
                ValidateDynamicAttribute(
                    endInvokeMethod.GetAttributes(),
                    expectedDynamicAttribute: false
                );
                //.param [0]
                //.custom instance void [System.Core]System.Runtime.CompilerServices.DynamicAttribute::.ctor(bool[]) = ( 01 00 02 00 00 00 * 00 01 * 00 00 )
                ValidateDynamicAttribute(
                    endInvokeMethod.GetReturnTypeAttributes(),
                    expectedDynamicAttribute: true,
                    expectedTransformFlags: expectedTransformFlags
                );
                ValidateDynamicAttribute(
                    endInvokeMethod.Parameters[0].GetAttributes(),
                    expectedDynamicAttribute: false
                );
            }

            public static void ValidateDynamicAttribute(
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        for (int i = 0; i < actualTransformFlags.Length; i++)
                        {
                            ...
                            Assert.Equal(
                                "System.Boolean",
                                actualTransformFlag.Type.ToTestDisplayString()
                            );
                            Assert.Equal(
                                expectedTransformFlags[i],
                                (bool)actualTransformFlag.Value
                            );
                        }
                    }
                }
...
";
            ...
            CreateCompilationWithMscorlib45(source, parseOptions: TestOptions.Script)
                .VerifyDiagnostics(
...
Gen<dynamic> x = null;";
        ...
        public void TestDynamicAttributeForScript_DynamicTypeInAliasTarget_NoCore()
        {
            ...
            var comp = CreateCompilationWithMscorlib45(source, parseOptions: TestOptions.Script)
                .VerifyDiagnostics(
                    ...
                    // X x = null;
                    Diagnostic(ErrorCode.ERR_DynamicAttributeMissing, "X")
                        .WithArguments("System.Runtime.CompilerServices.DynamicAttribute")
                        .WithLocation(20, 1)
                );
        }
...
";
            CompileAndVerify(
                ...
                symbolValidator: module =>
                {
                    ...
                    var getEnumerator = iterator.GetMethod(
...
class C
{
    ...
    static void Main()
    {
        ...
        public void TestDynamicAttributeForSubmissionGlobalStatement()
        {
            ...
            CreateCompilationWithMscorlib45(source: source, parseOptions: TestOptions.Script)
                .VerifyDiagnostics(
        ...
        {
            string source =
                "using X = Gen<dynamic>;     // No CS1980" + GetNoCS1980String(typeName: "X");
