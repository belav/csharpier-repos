    ...
    static void Main()
    {
        ...
        d((0, 0));
            ...
            comp.VerifyDiagnostics(
                ...
                //         D<(int x, int y)> d = o => { };
                Diagnostic(ErrorCode.ERR_PredefinedTypeNotFound, "(int x, int y)")
                ...
                //         D<(int x, int y)> d = o => { };
                Diagnostic(ErrorCode.ERR_NoTypeDef, "(int x, int y)")
                    .WithArguments(
                        "System.ValueType",
                ...
                //         d((0, 0));
                Diagnostic(ErrorCode.ERR_NoTypeDef, "(0, 0)")
                    .WithArguments(
                        "System.ValueType",
                        "mscorlib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089"
                    )
...
class C
{
    static (int x, int y) M() => (0, 0);
            ...
            comp.VerifyDiagnostics();
            var ref0 = comp.EmitToImageReference();
            comp = CreateEmptyCompilation(source1, references: new[] { ref0, ValueTupleRef });
            comp.VerifyDiagnostics(
        ...
        public void RoundTrip()
        {
            ...
            for (int i = 0; i < srcTypes.Length; i++)
            {
                ...
                var srcMembers = srcType.GetMembers()
                    ...
                    .Select(ToTestString)
                    .ToList();
                var peMembers = peType.GetMembers().Select(ToTestString).ToList();
        ...
        {
            private readonly NamedTypeSymbol _base0Class,
                _base1Class,
                _base2Class,
                _outerClass,
                _derivedClass;
            ...
            private void ValidateAttributesOnNamedTypes()
            {
                // public class Base0 { }
                ValidateTupleNameAttribute(
                    _base0Class.GetAttributes(),
                    expectedTupleNamesAttribute: false
                );

                // public class Base1<T> { }
                ValidateTupleNameAttribute(
                    _base1Class.GetAttributes(),
                    expectedTupleNamesAttribute: false
                );

                // public class Base2<T, U> { }
                ValidateTupleNameAttribute(
                    _base2Class.GetAttributes(),
                    expectedTupleNamesAttribute: false
                );
            ...
            private void ValidateAttributesOnMethods()
            {
                ...
                var expectedElementNames = new[] { "e1", "e2" };
                ValidateTupleNameAttribute(
                    method1.GetReturnTypeAttributes(),
                    expectedTupleNamesAttribute: true,
                    expectedElementNames: expectedElementNames
                );
                ...
                expectedElementNames = new[] { "e1", "e2" };
                ValidateTupleNameAttribute(
                    method2.Parameters.Single().GetAttributes(),
                    expectedTupleNamesAttribute: true,
                    expectedElementNames: expectedElementNames
                );
                ...
                expectedElementNames = new[] { "e1", "e2" };
                ValidateTupleNameAttribute(
                    method3.GetReturnTypeAttributes(),
                    expectedTupleNamesAttribute: true,
                    expectedElementNames: expectedElementNames
                );
                expectedElementNames = new[] { "e3", "e4" };
                ValidateTupleNameAttribute(
                    method3.Parameters.Single().GetAttributes(),
                    expectedTupleNamesAttribute: true,
                    expectedElementNames: expectedElementNames
                );
                ...
                expectedElementNames = new[] { "e1", "e2" };
                ValidateTupleNameAttribute(
                    method4.GetReturnTypeAttributes(),
                    expectedTupleNamesAttribute: true,
                    expectedElementNames: expectedElementNames
                );
                expectedElementNames = new[] { "e3", "e4" };
                ValidateTupleNameAttribute(
                    method4.Parameters.Single().GetAttributes(),
                    expectedTupleNamesAttribute: true,
                    expectedElementNames: expectedElementNames
                );
                ...
                ValidateTupleNameAttribute(
                    method5.Parameters.Single().GetAttributes(),
                    expectedTupleNamesAttribute: false
                );
                ...
                ValidateTupleNameAttribute(
                    method6.GetReturnTypeAttributes(),
                    expectedTupleNamesAttribute: true,
                    expectedElementNames: expectedElementNames
                );
            }
            ...
            private void ValidateAttributesOnProperties()
            {
                ...
                expectedTupleNames = new[] { "e1", "e2" };
                ValidateTupleNameAttribute(
                    indexer.GetAttributes(),
                    expectedTupleNamesAttribute: true,
                    expectedElementNames: expectedTupleNames
                );
                expectedTupleNames = new[] { "e3", "e4" };
                ValidateTupleNameAttribute(
                    indexer.Parameters.Single().GetAttributes(),
                    expectedTupleNamesAttribute: true,
                    expectedElementNames: expectedTupleNames
                );
            }
            ...
            )
            {
                ...
                else
                {
                    ...
                    Assert.Equal(
                        ...
                        tupleAttr.AttributeClass.ToTestDisplayString()
                    );
                    Assert.Equal(
                        "System.String[]",
        ...
        public void TupleAttributeMissing()
        {
            ...
            comp.VerifyDiagnostics(
                ...
                // public class Outer<T> : Base1<(int key, int val)>
                Diagnostic(ErrorCode.ERR_TupleElementNamesAttributeMissing, "(int key, int val)")
                ...
                // public class Derived<T> : Outer<(int e1, (int e2, int e3) e4)>.Inner<
                Diagnostic(ErrorCode.ERR_TupleElementNamesAttributeMissing, "(int e2, int e3)")
                    .WithArguments("System.Runtime.CompilerServices.TupleElementNamesAttribute")
                    .WithLocation(16, 42),
                ...
                //     Outer<(int e5, int e6)>.Inner<(int e7, int e8)[], (int e9, int e10)>.InnerInner<int>[],
                Diagnostic(ErrorCode.ERR_TupleElementNamesAttributeMissing, "(int e5, int e6)")
                    .WithArguments("System.Runtime.CompilerServices.TupleElementNamesAttribute")
                    .WithLocation(17, 11),
                ...
                //     Outer<(int e5, int e6)>.Inner<(int e7, int e8)[], (int e9, int e10)>.InnerInner<int>[],
                Diagnostic(ErrorCode.ERR_TupleElementNamesAttributeMissing, "(int e7, int e8)")
                    .WithArguments("System.Runtime.CompilerServices.TupleElementNamesAttribute")
                    .WithLocation(17, 35),
                ...
                //     Outer<(int e5, int e6)>.Inner<(int e7, int e8)[], (int e9, int e10)>.InnerInner<int>[],
                Diagnostic(ErrorCode.ERR_TupleElementNamesAttributeMissing, "(int e9, int e10)")
                    .WithArguments("System.Runtime.CompilerServices.TupleElementNamesAttribute")
                    .WithLocation(17, 55),
                ...
                //     ((int e11, int e12) e13, int e14)>
                Diagnostic(ErrorCode.ERR_TupleElementNamesAttributeMissing, "(int e11, int e12)")
                    .WithArguments("System.Runtime.CompilerServices.TupleElementNamesAttribute")
                    .WithLocation(18, 6),
                ...
                //     .InnerInner<((int e15, int e16) e17, (int e18, Base1<(int e19, int e20)> e21) e22)>
                Diagnostic(ErrorCode.ERR_TupleElementNamesAttributeMissing, "(int e15, int e16)")
                    .WithArguments("System.Runtime.CompilerServices.TupleElementNamesAttribute")
                    .WithLocation(19, 18),
                ...
                //     .InnerInner<((int e15, int e16) e17, (int e18, Base1<(int e19, int e20)> e21) e22)>
                Diagnostic(ErrorCode.ERR_TupleElementNamesAttributeMissing, "(int e19, int e20)")
                    .WithArguments("System.Runtime.CompilerServices.TupleElementNamesAttribute")
                    .WithLocation(19, 58),
                ...
                Diagnostic(
                    ErrorCode.ERR_TupleElementNamesAttributeMissing,
                    "(int e18, Base1<(int e19, int e20)> e21)"
                )
                    .WithArguments("System.Runtime.CompilerServices.TupleElementNamesAttribute")
                    .WithLocation(19, 42),
                ...
                Diagnostic(
                    ErrorCode.ERR_TupleElementNamesAttributeMissing,
                    "((int e15, int e16) e17, (int e18, Base1<(int e19, int e20)> e21) e22)"
                )
                    .WithArguments("System.Runtime.CompilerServices.TupleElementNamesAttribute")
                    .WithLocation(19, 17),
                ...
                //     public class Inner<U, V> : Base2<(int key2, int val2), V>
                Diagnostic(ErrorCode.ERR_TupleElementNamesAttributeMissing, "(int key2, int val2)")
                    .WithArguments("System.Runtime.CompilerServices.TupleElementNamesAttribute")
                    .WithLocation(10, 38),
                ...
                //         public class InnerInner<W> : Base1<(int key3, int val3)> { }
                Diagnostic(ErrorCode.ERR_TupleElementNamesAttributeMissing, "(int key3, int val3)")
                    .WithArguments("System.Runtime.CompilerServices.TupleElementNamesAttribute")
                    .WithLocation(12, 44),
                ...
                Diagnostic(
                    ErrorCode.ERR_TupleElementNamesAttributeMissing,
                    @"(dynamic e1,
                                   ValueTuple<(dynamic e2, dynamic e3)> e4)"
                ).WithArguments("System.Runtime.CompilerServices.TupleElementNamesAttribute").WithLocation(71, 35),
                ...
                //     public static (int e1, int e2) Method1() => (0, 0);
                Diagnostic(ErrorCode.ERR_TupleElementNamesAttributeMissing, "(int e1, int e2)")
                    .WithArguments("System.Runtime.CompilerServices.TupleElementNamesAttribute")
                    .WithLocation(41, 19),
                ...
                //     public static (int e1, int e2) Method3((int e3, int e4) x) => (0, 0);
                Diagnostic(ErrorCode.ERR_TupleElementNamesAttributeMissing, "(int e3, int e4)")
                    .WithArguments("System.Runtime.CompilerServices.TupleElementNamesAttribute")
                    .WithLocation(43, 44),
                ...
                Diagnostic(
                   ...
                   int e6, int e7, int e8, int e9)"
                ).WithArguments("System.Runtime.CompilerServices.TupleElementNamesAttribute").WithLocation(53, 19),
                ...
                Diagnostic(
                    ErrorCode.ERR_TupleElementNamesAttributeMissing,
                    "(dynamic e1, dynamic e2, object e3)"
                )
                    .WithArguments("System.Runtime.CompilerServices.TupleElementNamesAttribute")
                    .WithLocation(68, 14),
                ...
                Diagnostic(
                    ...
                    @"(int e1, int e2, int e3, int e4, int e5,
                   int e6, int e7, int e8, int e9)"
                ).WithArguments("System.Runtime.CompilerServices.TupleElementNamesAttribute").WithLocation(36, 19),
                ...
                Diagnostic(
                    ...
                    @"(int e1, int e2, int e3, int e4, int e5,
                         int e6, int e7, int e8, int e9)"
                ).WithArguments("System.Runtime.CompilerServices.TupleElementNamesAttribute").WithLocation(38, 25),
...
public struct S
{
            ...
            comp.VerifyDiagnostics(
                ...
                Diagnostic(
                    ErrorCode.ERR_ExplicitTupleElementNamesAttribute,
                    "TupleElementNames(new string[] { null})"
                )
                    .WithLocation(15, 36),
                ...
                //     [TupleElementNames(new[] { "y" })]
                Diagnostic(ErrorCode.ERR_AttributeOnBadSymbolType, "TupleElementNames")
                    .WithArguments(
                        "TupleElementNames",
                        "class, struct, property, indexer, field, parameter, return"
                    )
                    .WithLocation(20, 6),
