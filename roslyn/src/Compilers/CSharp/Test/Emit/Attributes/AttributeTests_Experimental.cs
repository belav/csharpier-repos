...
namespace N
{
    ...
    [Experimental] public enum E { A }
            ...
            comp1.VerifyDiagnostics(
                ...
                //             new B();
                Diagnostic(ErrorCode.WRN_Experimental, "B")
                ...
                //             D<int> d = null;
                Diagnostic(ErrorCode.WRN_Experimental, "D<int>")
...
class B
{
    A F() => null;
            ...
            comp.VerifyDiagnostics(
                ...
                // [MyAttribute]
                Diagnostic(ErrorCode.WRN_Experimental, "MyAttribute")
                    .WithArguments("MyAttribute")
                    .WithLocation(8, 2),
