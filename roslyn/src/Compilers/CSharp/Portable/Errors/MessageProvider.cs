...
namespace Microsoft.CodeAnalysis.CSharp
{
    internal sealed class MessageProvider : CommonMessageProvider
    {
        ...
        public override int ERR_MultipleAnalyzerConfigsInSameDir =>
            (int)ErrorCode.ERR_MultipleAnalyzerConfigsInSameDir;
        ...
        public override int WRN_AnalyzerCannotBeCreated =>
            (int)ErrorCode.WRN_AnalyzerCannotBeCreated;
        ...
        public override int WRN_AnalyzerReferencesFramework =>
            (int)ErrorCode.WRN_AnalyzerReferencesFramework;
        public override int WRN_AnalyzerReferencesNewerCompiler =>
            (int)ErrorCode.WRN_AnalyzerReferencesNewerCompiler;
        public override int WRN_DuplicateAnalyzerReference =>
            (int)ErrorCode.WRN_DuplicateAnalyzerReference;
        public override int INF_UnableToLoadSomeTypesInAnalyzer =>
            (int)ErrorCode.INF_UnableToLoadSomeTypesInAnalyzer;
        ...
        public override int ERR_MutuallyExclusiveOptions =>
            (int)ErrorCode.ERR_MutuallyExclusiveOptions;
        ...
        public override int ERR_InvalidSubsystemVersion =>
            (int)ErrorCode.ERR_InvalidSubsystemVersion;
        public override int ERR_InvalidInstrumentationKind =>
            (int)ErrorCode.ERR_InvalidInstrumentationKind;
        ...
        public override int ERR_MetadataReferencesNotSupported =>
            (int)ErrorCode.ERR_MetadataReferencesNotSupported;
        ...
        public override int ERR_PublicKeyContainerFailure =>
            (int)ErrorCode.ERR_PublicKeyContainerFailure;
        public override int ERR_OptionMustBeAbsolutePath =>
            (int)ErrorCode.ERR_OptionMustBeAbsolutePath;
        ...
        public override int ERR_EncReferenceToAddedMember =>
            (int)ErrorCode.ERR_EncReferenceToAddedMember;
        ...
        public override int ERR_EncUpdateFailedMissingAttribute =>
            (int)ErrorCode.ERR_EncUpdateFailedMissingAttribute;
        ...
        )
        {
            ...
            diagnostics.Add(
                ...
                ((CSharpAttributeData)attribute).GetAttributeArgumentLocation(parameterIndex),
        ...
        )
        {
            ...
            diagnostics.Add(
                ...
                node.ArgumentList.Arguments[namedArgumentIndex].Location,
                parameterName
            );
        }
        ...
        public override int? WRN_ByValArraySizeConstRequired =>
            (int)ErrorCode.WRN_ByValArraySizeConstRequired;
    }
}
