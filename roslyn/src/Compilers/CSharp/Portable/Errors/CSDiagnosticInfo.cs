...
namespace Microsoft.CodeAnalysis.CSharp
{
    internal sealed class CSDiagnosticInfo : DiagnosticInfoWithSymbols
    {
        ...
        public static readonly DiagnosticInfo VoidDiagnosticInfo = new CSDiagnosticInfo(
            ErrorCode.Void
        );
            ...
            : base(code, args, symbols)
        {
            ...
            _additionalLocations = additionalLocations.IsDefaultOrEmpty
                ? SpecializedCollections.EmptyReadOnlyList<Location>()
                : additionalLocations;
        }
