...
namespace Microsoft.CodeAnalysis.CSharp
{
    internal sealed class SpillSequenceSpiller : BoundTreeRewriterWithStackGuard
    {
        ...
        public override BoundNode VisitAsOperator(BoundAsOperator node)
        {
            ...
            return UpdateExpression(
                builder,
                node.Update(operand, node.TargetType, node.Conversion, node.Type)
            );
        }
        ...
        public override BoundNode VisitNullCoalescingOperator(BoundNullCoalescingOperator node)
        {
            ...
            return UpdateExpression(
                builder,
                node.Update(left, right, node.LeftConversion, node.OperatorResultKind, node.Type)
            );
        }
        ...
        public override BoundNode VisitPointerElementAccess(BoundPointerElementAccess node)
        {
            ...
            return UpdateExpression(
                builder,
                node.Update(expression, index, node.Checked, node.Type)
            );
        }
