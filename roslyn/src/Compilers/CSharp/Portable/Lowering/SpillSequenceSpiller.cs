...
namespace Microsoft.CodeAnalysis.CSharp
{
    internal sealed class SpillSequenceSpiller : BoundTreeRewriterWithStackGuard
    {
        ...
        private sealed class BoundSpillSequenceBuilder : BoundExpression
        {
            ...
            {
                get { return _statements != null; }
            }

            public bool HasLocals
            {
                get { return _locals != null; }
            }
                ...
                var node = new TreeDumperNode(
                    ...
                    new TreeDumperNode[]
                    {
                        ...
                        new TreeDumperNode(
                            "statements",
                            null,
                            from x in this.GetStatements()
                            select BoundTreeDumperNodeProducer.MakeTree(x)
                        ),
                        new TreeDumperNode(
                            "value",
                            null,
        ...
        private sealed class LocalSubstituter
        ...
        )
        {
            ...
            var receiverSubstitution = PooledDictionary<
                LocalSymbol,
                BoundComplexConditionalReceiver
            >.GetInstance();
        ...
        )
        {
            ...
            while (true)
            {
                switch (expression.Kind)
                {
                    case BoundKind.ArrayInitialization:
                        ...
                        var newInitializers = VisitExpressionList(
                            ref builder,
                            arrayInitialization.Initializers,
                            forceSpill: true
                        );
                    ...
                    case BoundKind.ArgListOperator:
                        ...
                        var newArgs = VisitExpressionList(
                            ref builder,
                            argumentList.Arguments,
                            argumentList.ArgumentRefKindsOpt,
                            forceSpill: true
                        );
                        return argumentList.Update(
                            newArgs,
                            argumentList.ArgumentRefKindsOpt,
                            argumentList.Type
                        );
                    ...
                    case BoundKind.AssignmentOperator:
                        ...
                        ) // Optimize for some known to be safe scenarios.
                        {
                            ...
                            )
                            {
                                ...
                                _receiverSubstitution.Add(
                                    receiverRefLocal,
                                    complexReceiver.Update(
                                        valueTypeReceiver,
                    ...
                    case BoundKind.FieldAccess:
                        ...
                        var receiver = Spill(
                            builder,
                            field.ReceiverOpt,
                            fieldSymbol.ContainingType.IsValueType ? refKind : RefKind.None
                        );
                        return field.Update(
                            receiver,
                            fieldSymbol,
                    ...
                    case BoundKind.Call:
                        ...
                        if (refKind != RefKind.None)
                        {
                            if (
                                ...
                                is SynthesizedInlineArrayFirstElementRefMethod
                                    or SynthesizedInlineArrayFirstElementRefReadOnlyMethod
                            )
                            {
                                ...
                                call.Method.OriginalDefinition
                                is SynthesizedInlineArrayElementRefMethod
                            ...
                            )
                            {
                                ...
                                return call.Update(
                                    Spill(
                                        builder,
                                        call.ReceiverOpt,
                                        ReceiverSpillRefKind(call.ReceiverOpt)
                                    ),
                            ...
                            call.Method.OriginalDefinition
                            is SynthesizedInlineArrayAsSpanMethod
                                or SynthesizedInlineArrayAsReadOnlySpanMethod
                        )
                        {
                            return spillInlineArrayHelperWithTwoArguments(builder, call);
                        }
                        ...
                        )
                        {
                            ...
                            return call.Update(
                                ...
                                call.Method,
                                ImmutableArray.Create(
                                    Spill(builder, call.Arguments[0]),
                                    Spill(builder, call.Arguments[1])
                                )
                            );
                        }
            ...
            BoundExpression spillInlineArrayHelperWithTwoArguments(
                BoundSpillSequenceBuilder builder,
                BoundCall call
            )
            {
                ...
                return call.Update(
                    ImmutableArray.Create(
                        ...
                        call.Arguments[1].ConstantValueOpt is { }
                            ? call.Arguments[1]
                            : Spill(builder, call.Arguments[1])
                    )
                );
                ...
                assignment
                    is {
                        ...
                        Left: BoundLocal
                        {
                            LocalSymbol:
                            {
                                SynthesizedKind: SynthesizedLocalKind.LoweringTemp,
                                RefKind: RefKind.Ref
                            } receiverRefLocal
                        },
                        Right: BoundComplexConditionalReceiver
                        {
                            ValueTypeReceiver: BoundLocal
                            {
                                LocalSymbol:
                                {
                                    SynthesizedKind: SynthesizedLocalKind.LoweringTemp,
        ...
        public override BoundNode VisitReturnStatement(BoundReturnStatement node)
        {
            ...
            return UpdateStatement(
                builder,
                node.Update(node.RefKind, expression, @checked: node.Checked)
            );
        }
        ...
        public override BoundNode VisitCatchBlock(BoundCatchBlock node)
        {
            ...
            if (builder is { })
            {
                ...
                exceptionFilterPrologueOpt = new BoundStatementList(
                    node.Syntax,
                    builder.GetStatements()
                );
            }
        ...
        public override BoundNode VisitAwaitExpression(BoundAwaitExpression node)
        {
            ...
            return UpdateExpression(
                builder,
                node.Update(expr, node.AwaitableInfo, node.DebugInfo, node.Type)
            );
        }
        ...
        public override BoundNode VisitArgListOperator(BoundArgListOperator node)
        {
            ...
            return UpdateExpression(
                builder,
                node.Update(newArgs, node.ArgumentRefKindsOpt, node.Type)
            );
        }
        ...
        public override BoundNode VisitAssignmentOperator(BoundAssignmentOperator node)
        {
            ...
            else
            {
                ...
                switch (left.Kind)
                {
                    ...
                    default:
                        ...
                        left = Spill(
                            leftBuilder,
                            VisitExpression(ref leftBuilder, left),
                            RefKind.Ref
                        );
                        break;
                }
            ...
            BoundExpression fieldWithSpilledReceiver(
            ...
            )
            {
                ...
                if (!field.FieldSymbol.IsStatic)
                {
                    ...
                    if (field.FieldSymbol.ContainingType.IsReferenceType)
                    {
                        ...
                        receiver = Spill(
                            leftBuilder,
                            VisitExpression(ref leftBuilder, field.ReceiverOpt)
                        );
                    ...
                    {
                        receiver = fieldWithSpilledReceiver(
                            receiverField,
                            ref leftBuilder,
        ...
        {
            BoundSpillSequenceBuilder builder = null;
            var arguments = this.VisitExpressionList(
                ref builder,
                node.Arguments,
            ...
            else if (node.Method.RequiresInstanceReceiver)
            {
                ...
                receiver = Spill(
                    receiverBuilder,
                    VisitExpression(ref receiverBuilder, receiver),
                    refKind: refKind
                );
                    ...
                    receiverBuilder.AddStatement(
                        _F.ExpressionStatement(
                            new BoundComplexConditionalReceiver(
                                ...
                                cache,
                                _F.Sequence(
                                    new[] { _F.AssignmentExpression(cache, receiver) },
                                    cache
                                ),
                                receiverType
                            )
        ...
        )
        {
            ...
            else
            {
                ...
                invokedExpression = Spill(
                    invokedExpressionBuilder,
                    VisitExpression(ref invokedExpressionBuilder, node.InvokedExpression)
                );
            ...
            else
            {
                ...
                conditionBuilder.AddStatement(
                    _F.If(
                        ...
                        UpdateStatement(
                            consequenceBuilder,
                            _F.Assignment(_F.Local(tmp), consequence)
                        ),
                        UpdateStatement(
                            alternativeBuilder,
                            _F.Assignment(_F.Local(tmp), alternative)
                        )
                    )
                );
        ...
        public override BoundNode VisitPassByCopy(BoundPassByCopy node)
        {
            BoundSpillSequenceBuilder builder = null;
            var expression = VisitExpression(ref builder, node.Expression);
            return UpdateExpression(builder, node.Update(expression, type: node.Type));
        }
        ...
        public override BoundNode VisitIsOperator(BoundIsOperator node)
        {
            ...
            return UpdateExpression(
                builder,
                node.Update(operand, node.TargetType, node.ConversionKind, node.Type)
            );
        }
        ...
        public override BoundNode VisitLoweredConditionalAccess(BoundLoweredConditionalAccess node)
        {
            ...
            if (node.Type.IsVoidType())
            {
                var whenNotNullStatement = UpdateStatement(
                    whenNotNullBuilder,
                    _F.ExpressionStatement(whenNotNull)
                );
                whenNotNullStatement = ConditionalReceiverReplacer.Replace(
                ...
                Debug.Assert(
                    whenNullOpt == null || !LocalRewriter.ReadIsSideeffecting(whenNullOpt)
                );
            ...
            else
            {
                ...
                var whenNotNullStatement = UpdateStatement(
                    whenNotNullBuilder,
                    _F.Assignment(_F.Local(tmp), whenNotNull)
                );
                whenNotNullStatement = ConditionalReceiverReplacer.Replace(
                    whenNotNullStatement,
                    receiver,
        ...
        private sealed class ConditionalReceiverReplacer
            : BoundTreeRewriterWithStackGuardWithoutRecursionOnTheLeftOfBinaryOperator
        {
            ...
            public static BoundStatement Replace(
                BoundNode node,
                BoundExpression receiver,
                int receiverID,
                int recursionDepth
        ...
        public override BoundNode VisitPointerElementAccess(BoundPointerElementAccess node)
        {
            ...
            return UpdateExpression(
                builder,
                node.Update(expression, index, node.Checked, node.RefersToLocation, node.Type)
            );
        }
        ...
        )
        {
            ...
            return UpdateExpression(
                builder,
                node.Update(operand, node.RefersToLocation, node.Type)
            );
        }
        ...
        public override BoundNode VisitSequence(BoundSequence node)
        {
            ...
            var sideEffects = VisitExpressionList(
                ref builder,
                node.SideEffects,
                forceSpill: valueBuilder != null,
        ...
        )
        {
            foreach (var local in locals)
            {
                ...
                {
                    LocalSymbol longLived = local.WithSynthesizedLocalKindAndSyntax(
        ...
        public override BoundNode VisitReadOnlySpanFromArray(BoundReadOnlySpanFromArray node)
        {
            ...
            return UpdateExpression(
                builder,
                node.Update(operand, node.ConversionMethod, node.Type)
            );
        }
