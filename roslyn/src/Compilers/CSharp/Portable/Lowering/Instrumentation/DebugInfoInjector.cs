    ...
    internal partial class DebugInfoInjector : CompoundInstrumenter
    {
                ...
                switch (original.Syntax)
                {
                    ...
                    case ConstructorInitializerSyntax ctorInit:
                        ...
                        return new BoundSequencePointWithSpan(
                            ...
                            rewritten,
                            TextSpan.FromBounds(
                                ctorInit.ThisOrBaseKeyword.SpanStart,
                                ctorInit.ArgumentList.CloseParenToken.Span.End
                            )
                        );
                    ...
                    case TypeDeclarationSyntax typeDecl:
                        ...
                        return new BoundSequencePointWithSpan(
                            ...
                            rewritten,
                            TextSpan.FromBounds(
                                typeDecl.Identifier.SpanStart,
                                typeDecl.ParameterList.Span.End
                            )
                        );
        ...
        )
        {
            ...
            if (rewritten.Kind == BoundKind.Block)
            {
                ...
                return block.Update(
                    block.Locals,
                    block.LocalFunctions,
                    block.HasUnsafeModifier,
                    block.Instrumentation,
                    ImmutableArray.Create(
                        InstrumentFieldOrPropertyInitializer(block.Statements.Single(), syntax)
                    )
                );
            }
        ...
        )
        {
            ...
            if (original.WasCompilerGenerated && original.Syntax.Kind() == SyntaxKind.Block)
            {
                ...
                return new BoundSequencePointWithSpan(
                    original.Syntax,
                    rewritten,
                    ((BlockSyntax)original.Syntax).CloseBraceToken.Span
                );
            }
        ...
        )
        {
            ...
            {
                prologue = new BoundSequencePointWithSpan(
                    original.Syntax,
                    previousPrologue,
                    blockSyntax.OpenBraceToken.Span
                );
                ...
                {
                    epilogue = new BoundSequencePointWithSpan(
                        original.Syntax,
                        previousEpilogue,
            ...
            else if (original == rewriter.CurrentMethodBody)
            {
                ...
                if (
                    previousPrologue != null
                    || rewriter.Factory.TopLevelMethod is SynthesizedSimpleProgramEntryPointSymbol
                    || original.Syntax
                        is RecordDeclarationSyntax { ParameterList.Parameters.Count: > 0 }
                )
                {
        ...
        public override BoundExpression InstrumentDoStatementCondition(
        ...
        )
        {
            ...
            return AddConditionSequencePoint(
                base.InstrumentDoStatementCondition(original, rewrittenCondition, factory),
                original.Syntax,
                factory
            );
        }
        ...
        )
        {
            ...
            // the containing method is edited while methods invoked in the condition are being executed.
            return AddConditionSequencePoint(
                base.InstrumentWhileStatementCondition(original, rewrittenCondition, factory),
                original.Syntax,
                factory
            );
        }
        ...
        )
        {
            ...
            return new BoundSequencePointWithSpan(
                doSyntax,
                base.InstrumentDoStatementConditionalGotoStart(original, ifConditionGotoStart),
                span
            );
        }
        ...
        )
        {
            ...
            switch (original.Syntax.Kind())
            {
                case SyntaxKind.ForEachStatement:
                {
                    ...
                    iterationVarDeclSpan = TextSpan.FromBounds(
                        forEachSyntax.Type.SpanStart,
                        forEachSyntax.Identifier.Span.End
                    );
                    break;
                }
        ...
        )
        {
            ...
            // the containing method is edited while methods invoked in the condition are being executed.
            return AddConditionSequencePoint(
                base.InstrumentForStatementCondition(original, rewrittenCondition, factory),
                original.Syntax,
                factory
            );
        }
        ...
        )
        {
            ...
            return new BoundSequencePointWithSpan(
                ...
                TextSpan.FromBounds(syntax.IfKeyword.SpanStart, syntax.CloseParenToken.Span.End),
                original.HasErrors
            );
        }
        ...
        )
        {
            ...
            // the containing method is edited while methods invoked in the condition are being executed.
            return AddConditionSequencePoint(
                base.InstrumentIfStatementCondition(original, rewrittenCondition, factory),
                original.Syntax,
                factory
            );
        }
        ...
        )
        {
            ...
            var span = TextSpan.FromBounds(
                ...
                labeledSyntax.ColonToken.Span.End
            );
            return new BoundSequencePointWithSpan(
                labeledSyntax,
        ...
        public override BoundStatement InstrumentUserDefinedLocalInitialization(
        ...
        )
        {
            ...
            return new BoundSequencePointWithSpan(
                ...
                TextSpan.FromBounds(
                    lockSyntax.LockKeyword.SpanStart,
                    lockSyntax.CloseParenToken.Span.End
                )
            );
        }
        ...
        )
        {
            ...
            rewrittenFilter = AddConditionSequencePoint(
        ...
        )
        {
            ...
            return AddConditionSequencePoint(
                base.InstrumentSwitchStatementExpression(original, rewrittenExpression, factory),
                original.Syntax,
                factory
            );
        }

        public override BoundExpression InstrumentSwitchExpressionArmExpression(
            BoundExpression original,
            BoundExpression rewrittenExpression,
            SyntheticBoundNodeFactory factory
        )
        ...
        )
        {
            ...
            return BoundSequencePoint.CreateHidden(
                base.InstrumentSwitchBindCasePatternVariables(bindings)
            );
        }
    }
}
