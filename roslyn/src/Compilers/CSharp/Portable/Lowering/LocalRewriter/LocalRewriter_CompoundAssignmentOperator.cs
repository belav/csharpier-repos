...
namespace Microsoft.CodeAnalysis.CSharp
{
    internal sealed partial class LocalRewriter
    {
        ...
        private BoundExpression VisitCompoundAssignmentOperator(
            ...
            if (
                ...
                var isEvent = _factory.StoreToTemp(
                    _dynamicFactory.MakeDynamicIsEventTest(memberAccess.Name, memberAccess.Receiver)
                        .ToExpression(),
            ...
            BoundExpression rewriteAssignment(BoundExpression leftRead)
            {
                ...
                BoundExpression opLHS = isDynamic
                    ? leftRead
                    : MakeConversionNode(
                          syntax: syntax,
        ...
        private BoundExpression TransformPatternIndexerAccess(
            ...
            return TransformCompoundAssignmentLHS(
                sequence.Value,
                stores,
                temps,
                isDynamicAssignment
            ...
            switch (originalLHS.Kind)
            {
                ...
                case BoundKind.IndexOrRangePatternIndexerAccess:

                    {
                        ...
                        {
                            return TransformPatternIndexerAccess(
