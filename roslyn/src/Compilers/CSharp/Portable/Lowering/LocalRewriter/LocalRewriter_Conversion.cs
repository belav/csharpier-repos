...
namespace Microsoft.CodeAnalysis.CSharp
{
    internal partial class LocalRewriter
    {
        public override BoundNode VisitConversion(BoundConversion node)
        {
            ...
            if (
                node.ConversionKind
                is ConversionKind.SwitchExpression
            ...
            switch (conversion.Kind)
            {
                ...
                case ConversionKind.MethodGroup
                      when oldNodeOpt
                          is
                          {
                              Type: { TypeKind: TypeKind.FunctionPointer } funcPtrType
                          }:
                {
                ...
                case ConversionKind.MethodGroup:
                {
                    ...
                    var receiver =
                        (!method.RequiresInstanceReceiver && !oldNodeOpt.IsExtensionMethod)
        ...
        /// The error will be suppressed only for conversions from <see cref="decimal"/> or <see cref="DateTime"/>.
        /// </remarks>
        private BoundExpression MakeImplicitConversion(
            BoundExpression rewrittenOperand,
            TypeSymbol rewrittenType
        ) {
