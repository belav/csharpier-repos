        ...
        )
        {
            ...
            for (int i = 0; i <= n; i++)
            {
                ...
                else
                {
                    ...
                    stringBuilder.Append(
                        escapeInterpolatedStringLiteral(part.ConstantValue.StringValue)
                    );
                }
            }
            ...
            else if (CanLowerToStringConcatenation(node))
            {
                ...
                for (int i = 0; i < length; i++)
                {
                    ...
                    else
                    {
                        ...
                        Debug.Assert(
                            part is BoundLiteral && part.ConstantValue?.StringValue is not null
                        );
                ...
                if (
                    ...
                    && result
                        is not (
                            ...
                            or { ConstantValue.IsString: true }
                        )
                )
                {
