...
namespace Microsoft.CodeAnalysis.CSharp
{
    internal partial class LocalRewriter
    {
        ...
        private BoundExpression MakeLiteral(
            SyntaxNode syntax,
        ...
        private BoundExpression MakeDecimalLiteral(SyntaxNode syntax, ConstantValue constantValue)
        {
            ...
            if (scale == 0 && int.MinValue <= value && value <= int.MaxValue)
            {
                ...
                arguments.Add(
                    new BoundLiteral(
                        syntax,
                        ConstantValue.Create((int)value),
            ...
            else if (scale == 0 && uint.MinValue <= value && value <= uint.MaxValue)
            {
                ...
                arguments.Add(
                    new BoundLiteral(
                        syntax,
                        ConstantValue.Create((uint)value),
            ...
            else if (scale == 0 && long.MinValue <= value && value <= long.MaxValue)
            {
                ...
                arguments.Add(
                    new BoundLiteral(
                        syntax,
                        ConstantValue.Create((long)value),
            ...
            else if (scale == 0 && ulong.MinValue <= value && value <= ulong.MaxValue)
            {
                ...
                arguments.Add(
                    new BoundLiteral(
                        syntax,
                        ConstantValue.Create((ulong)value),
            ...
            else
            {
                ...
                arguments.Add(
                    new BoundLiteral(
                        syntax,
                        ConstantValue.Create(isNegative),
                ...
                arguments.Add(
                    new BoundLiteral(
                        syntax,
                        ConstantValue.Create(scale),
                        _compilation.GetSpecialType(SpecialType.System_Byte)
                    )
                );
            }
        ...
        private BoundExpression MakeDateTimeLiteral(SyntaxNode syntax, ConstantValue constantValue)
        {
            ...
            arguments.Add(
                new BoundLiteral(
                    syntax,
                    ConstantValue.Create(constantValue.DateTimeValue.Ticks),
                    _compilation.GetSpecialType(SpecialType.System_Int64)
                )
            );

            var ctor = (MethodSymbol)_compilation.Assembly
                .GetSpecialTypeMember(SpecialMember.System_DateTime__CtorInt64);
            Debug.Assert((object)ctor != null);
