...
namespace Microsoft.CodeAnalysis.CSharp
{
    internal sealed partial class LocalRewriter
    {
        ...
        )
        {
            ...
            // T.&(temp, y)
            var andOperatorCall = LowerUserDefinedBinaryOperator(
                syntax,
        ...
        public BoundExpression VisitBinaryOperator(
        ...
        )
        {
            ...
            {
                Debug.Assert(
                    node.Type.SpecialType == SpecialType.System_String,
                    "Non-string binary addition should have been handled by VisitConversion or VisitArguments"
                );
                ImmutableArray<BoundExpression> parts =
                    CollectBinaryOperatorInterpolatedStringParts(node);
            ...
            for (
                ...
                current != null && current.ConstantValueOpt == null;
                current = current.Left as BoundBinaryOperator
            )
            {
                // The regular visit mechanism will handle this.
                if (
                    current.InterpolatedStringHandlerData is not null
                    || current.OperatorKind is BinaryOperatorKind.Utf8Addition
                )
                {
            ...
            while (stack.Count > 0)
            {
                ...
                loweredLeft = MakeBinaryOperator(
                    original,
                    original.Syntax,
                    original.OperatorKind,
                    loweredLeft,
                    loweredRight,
                    original.Type,
                    original.Method,
        ...
        private static ImmutableArray<BoundExpression> CollectBinaryOperatorInterpolatedStringParts(
            BoundBinaryOperator node
        )
        {
            ...
            node.VisitBinaryOperatorInterpolatedString(
                ...
                static (
                    ...
                    ArrayBuilder<BoundExpression> partsBuilder
                ) =>
                {
        ...
        )
        {
            ...
            if (_inExpressionLambda)
            {
                switch (operatorKind.Operator() | operatorKind.OperandTypes())
                {
                    ...
                    case BinaryOperatorKind.StringConcatenation:
                        return RewriteStringConcatenation(
                            syntax,
                            operatorKind,
                            loweredLeft,
                            loweredRight,
                    ...
                    case BinaryOperatorKind.DelegateCombination:
                        return RewriteDelegateOperation(
                            syntax,
                            operatorKind,
                            loweredLeft,
                            loweredRight,
                    ...
                    case BinaryOperatorKind.DelegateEqual:
                        return RewriteDelegateOperation(
                            ...
                            loweredRight,
                            type,
                            SpecialMember.System_Delegate__op_Equality
                        );
                    case BinaryOperatorKind.DelegateNotEqual:
                        return RewriteDelegateOperation(
                            ...
                            loweredRight,
                            type,
                            SpecialMember.System_Delegate__op_Inequality
                        );
                }
            }
            else
            // try to lower the expression.
            {
                if (operatorKind.IsDynamic())
                {
                    ...
                    {
                        return MakeDynamicLogicalBinaryOperator(
                            syntax,
                            operatorKind,
                            loweredLeft,
                            loweredRight,
                ...
                {
                    return RewriteLiftedBinaryOperator(
                        syntax,
                        operatorKind,
                        loweredLeft,
                        loweredRight,
                ...
                {
                    return LowerUserDefinedBinaryOperator(
                        syntax,
                        operatorKind,
                        loweredLeft,
                        loweredRight,
                ...
                switch (operatorKind.OperatorWithLogical() | operatorKind.OperandTypes())
                {
                    ...
                    case BinaryOperatorKind.StringNotEqual:
                        return RewriteStringEquality(
                            ...
                            loweredRight,
                            type,
                            SpecialMember.System_String__op_Inequality
                        );
                    ...
                    case BinaryOperatorKind.LogicalBoolAnd:
                        ...
                        if (
                            loweredRight.Kind == BoundKind.Local
                    ...
                    case BinaryOperatorKind.UIntUnsignedRightShift:
                        return RewriteBuiltInShiftOperation(
                            oldNode,
                            syntax,
                            operatorKind,
                            loweredLeft,
                    ...
                    case BinaryOperatorKind.NUIntLeftShift:
                        return RewriteBuiltInNativeShiftOperation(
                            oldNode,
                            syntax,
                            operatorKind,
                            loweredLeft,
                    ...
                    case BinaryOperatorKind.DecimalGreaterThanOrEqual:
                        return RewriteDecimalBinaryOperation(
                            syntax,
                            loweredLeft,
                            loweredRight,
                            operatorKind
                    ...
                    case BinaryOperatorKind.PointerSubtraction:
                        return RewritePointerSubtraction(
                            operatorKind,
                            loweredLeft,
                            loweredRight,
                            type
                    ...
                    case BinaryOperatorKind.IntLessThanOrEqual:
                        if (
                            loweredLeft.Kind == BoundKind.ArrayLength
                    ...
                    case BinaryOperatorKind.IntGreaterThanOrEqual:
                        if (
                            loweredRight.Kind == BoundKind.ArrayLength
            ...
            if (optimize)
            {
                ...
                )
                {
                    ...
                    whenNullOpt = RewriteLiftedBinaryOperator(
                        syntax,
                        operatorKind,
                        _factory.Default(loweredLeft.Type),
                        loweredRight,
                        type,
                        method,
                        constrainedToTypeOpt
        ...
        )
        {
            Debug.Assert(
                operatorKind.Operator() == BinaryOperatorKind.And
                    || operatorKind.Operator() == BinaryOperatorKind.Or
            );
            ...
            ConstantValue? constantLeft =
                loweredLeft.ConstantValueOpt ?? UnboxConstant(loweredLeft);
            if (
                testOperator == UnaryOperatorKind.DynamicFalse
                    && constantLeft == ConstantValue.False
                || testOperator == UnaryOperatorKind.DynamicTrue
                    && constantLeft == ConstantValue.True
            )
            {
            ...
            if (
                constantLeft == null
                && loweredLeft.Kind != BoundKind.Local
            ...
            bool leftTestIsConstantFalse =
                testOperator == UnaryOperatorKind.DynamicFalse && constantLeft == ConstantValue.True
                || testOperator == UnaryOperatorKind.DynamicTrue
                    && constantLeft == ConstantValue.False;
            ...
            if (applyParentUnaryOperator != null)
            {
                ...
                result = _dynamicFactory
                    .MakeDynamicUnaryOperator(testOperator, op, boolean)
                    .ToExpression();
                if (!leftTestIsConstantFalse)
                {
                    BoundExpression leftTest = MakeTruthTestForDynamicLogicalOperator(
                        syntax,
                        loweredLeft,
                        boolean,
                        leftTruthOperator,
        ...
        private BoundExpression MakeTruthTestForDynamicLogicalOperator(
            SyntaxNode syntax,
            BoundExpression loweredLeft,
            TypeSymbol boolean,
            MethodSymbol? leftTruthOperator,
        ...
        )
        {
            ...
            if (conversion.IsImplicit)
            {
                ...
                var converted = MakeConversionNode(
                    loweredLeft,
                    boolean,
                    @checked: false,
                    markAsChecked: true
                ); // The conversion was checked in binding
                if (negative)
                {
        ...
        )
        {
            ...
            if (leftAlwaysNull && rightAlwaysNull)
            {
                return MakeLiteral(
                    syntax,
                    ConstantValue.Create(kind.Operator() == BinaryOperatorKind.Equal),
                    boolType
                );
            }
            ...
            {
                BoundExpression result = MakeLiteral(
                    syntax,
                    ConstantValue.Create(operatorKind == BinaryOperatorKind.NotEqual),
                    boolType
                );
            ...
            if (leftAlwaysNull || rightAlwaysNull)
            {
                ...
                {
                    BoundExpression falseExpr = MakeBooleanConstant(
                        syntax,
                        operatorKind == BinaryOperatorKind.NotEqual
                    );
        ...
        private BoundExpression MakeOptimizedGetValueOrDefault(
            SyntaxNode syntax,
        ...
        )
        {
            ...
            BoundExpression? optimized = TrivialLiftedComparisonOperatorOptimizations(
                syntax,
                kind,
                loweredLeft,
                loweredRight,
            ...
            BoundLocal boundTempX = _factory.StoreToTemp(
                xNonNull ?? loweredLeft,
                out BoundAssignmentOperator tempAssignmentX
            );
            BoundLocal boundTempY = _factory.StoreToTemp(
                yNonNull ?? loweredRight,
                out BoundAssignmentOperator tempAssignmentY
            );

            BoundExpression callX_GetValueOrDefault = MakeOptimizedGetValueOrDefault(
                syntax,
                boundTempX
            );
            BoundExpression callY_GetValueOrDefault = MakeOptimizedGetValueOrDefault(
                syntax,
                boundTempY
            );
            ...
            return new BoundSequence(
                ...
                locals: ImmutableArray.Create<LocalSymbol>(
                    boundTempX.LocalSymbol,
                    boundTempY.LocalSymbol
                ),
                sideEffects: ImmutableArray.Create<BoundExpression>(
                    tempAssignmentX,
                    tempAssignmentY
                ),
        ...
        )
        {
            ...
            )
            {
                ...
                consequence = RewriteConditionalOperator(
                    ...
                    rewrittenAlternative: MakeLiteral(
                        syntax,
            ...
            // false
            BoundExpression alternative = MakeBooleanConstant(
                syntax,
                operatorKind == BinaryOperatorKind.NotEqual
            );
        ...
        )
        {
            ...
            if (leftNonNull != null && rightNonNull != null)
            {
                return MakeLiftedBinaryOperatorConsequence(
                    syntax,
                    kind,
                    leftNonNull,
                    rightNonNull,
        ...
        )
        {
            ...
            BoundExpression? optimized = OptimizeLiftedBinaryArithmetic(
                syntax,
                kind,
                loweredLeft,
                loweredRight,
            ...
            // new R?(tempX.GetValueOrDefault() OP tempY.GetValueOrDefault)
            BoundExpression consequence = MakeLiftedBinaryOperatorConsequence(
                syntax,
                kind,
        ...
        {
            BoundExpression? optimized = TrivialLiftedBinaryArithmeticOptimizations(
                syntax,
                kind,
                left,
                right,
            ...
            if (
                nonNullRight != null
                && nonNullRight.ConstantValueOpt != null
                && left.Kind == BoundKind.Sequence
            )
            {
        ...
        {
            NamedTypeSymbol nullableType = _compilation.GetSpecialType(
        ...
        )
        {
            ...
            if (neverNull != null)
            {
                BoundExpression newNullBool = MakeNewNullableBoolean(
                    syntax,
            ...
            BoundExpression consequence =
                kind == BinaryOperatorKind.LiftedBoolAnd ? nullBool : boundTemp;
            BoundExpression alternative =
                kind == BinaryOperatorKind.LiftedBoolAnd ? boundTemp : nullBool;
            BoundExpression conditionalExpression = RewriteConditionalOperator(
                syntax: syntax,
                rewrittenCondition: condition,
                rewrittenConsequence: consequence,
        ...
        )
        {
            ...
            BoundExpression consequence =
                kind == BinaryOperatorKind.LiftedBoolOr ? newNullBool : maybeNullTemp;
            BoundExpression alternative =
                kind == BinaryOperatorKind.LiftedBoolOr ? maybeNullTemp : newNullBool;
            BoundExpression conditionalExpression = RewriteConditionalOperator(
                syntax: syntax,
                rewrittenCondition: condition,
                rewrittenConsequence: consequence,
        ...
        )
        {
            ...
            BoundExpression? optimized = OptimizeLiftedBooleanOperatorOneNull(
                syntax,
                kind,
                loweredLeft,
                loweredRight
            ...
            optimized = OptimizeLiftedBooleanOperatorOneNonNull(
                syntax,
                kind,
                loweredLeft,
                loweredRight
            ...
            MethodSymbol getValueOrDefaultX = UnsafeGetNullableMethod(
                syntax,
                boundTempX.Type,
                SpecialMember.System_Nullable_T_GetValueOrDefault
            );
            MethodSymbol getValueOrDefaultY = UnsafeGetNullableMethod(
                syntax,
                boundTempY.Type,
                SpecialMember.System_Nullable_T_GetValueOrDefault
            );
            ...
            BoundExpression callX_GetValueOrDefault = BoundCall.Synthesized(
                syntax,
                boundTempX,
                getValueOrDefaultX
            );
            // tempy.GetValueOrDefault()
            BoundExpression callY_GetValueOrDefault = BoundCall.Synthesized(
                syntax,
                boundTempY,
                getValueOrDefaultY
            );
            ...
            BoundExpression consequence =
                kind == BinaryOperatorKind.LiftedBoolAnd ? boundTempY : boundTempX;
            BoundExpression alternative =
                kind == BinaryOperatorKind.LiftedBoolAnd ? boundTempX : boundTempY;
        ...
        {
            return UnsafeGetNullableMethod(
                syntax,
                nullableType,
                member,
                _compilation,
        ...
        /// If used, a unit-test with a missing member is absolutely a must have.
        /// </summary>
        internal static MethodSymbol UnsafeGetNullableMethod(
            SyntaxNode syntax,
            TypeSymbol nullableType,
            SpecialMember member,
        ...
        private bool TryGetNullableMethod(
            SyntaxNode syntax,
            TypeSymbol nullableType,
            SpecialMember member,
        ...
        )
        {
            ...
            if (NullableNeverHasValue(nullable))
            {
                return MakeLiteral(
                    syntax,
                    ConstantValue.Create(kind == BinaryOperatorKind.NullableNullEqual),
                    returnType
                );
            }
            ...
            )
            {
                ...
                var whenNull =
                    kind == BinaryOperatorKind.NullableNullEqual
                        ? MakeBooleanConstant(syntax, true)
                        : null;
        ...
        private BoundExpression RewriteStringEquality(
            BoundBinaryOperator? oldNode,
            SyntaxNode syntax,
            BinaryOperatorKind operatorKind,
            BoundExpression loweredLeft,
        ...
        )
        {
            if (
                oldNode != null
                && (
                    loweredLeft.ConstantValueOpt == ConstantValue.Null
                    || loweredRight.ConstantValueOpt == ConstantValue.Null
                )
            )
            {
        ...
        private BoundExpression RewriteDelegateOperation(
            SyntaxNode syntax,
            BinaryOperatorKind operatorKind,
            BoundExpression loweredLeft,
            BoundExpression loweredRight,
        ...
        )
        {
            ...
            )
            {
                ...
                )
                {
                    ...
                    operatorKind =
                        (operatorKind & (~BinaryOperatorKind.Delegate)) | BinaryOperatorKind.Object;
        ...
        private BoundExpression RewriteDecimalBinaryOperation(
            SyntaxNode syntax,
            BoundExpression loweredLeft,
            BoundExpression loweredRight,
            BinaryOperatorKind operatorKind
        ...
        )
        {
            ...
            if (exprType is { })
            {
                ...
                {
                    // Box type parameters.
                    rewrittenExpr = MakeConversionNode(
                        syntax,
                        rewrittenExpr,
                        Conversion.Boxing,
                        objectType,
        ...
        )
        {
            ...
            if (rightConstantValue != null && rightConstantValue.IsIntegral)
            {
                ...
                loweredRight = MakeLiteral(
                    rightSyntax,
                    ConstantValue.Create(shiftAmount),
                    rightType
                );
            }
            else
            {
                BinaryOperatorKind andOperatorKind =
                    (operatorKind & ~BinaryOperatorKind.OpMask) | BinaryOperatorKind.And;
        ...
        )
        {
            ...
            Debug.Assert(
                leftType.SpecialType is SpecialType.System_IntPtr or SpecialType.System_UIntPtr
            );
            ...
            else
            {
                ...
                loweredRight = _factory.Binary(
                    andOperatorKind,
                    rightType,
                    loweredRight,
                    _factory.IntSubtract(
                        _factory.IntMultiply(_factory.Sizeof(leftType), _factory.Literal(8)),
                        _factory.Literal(1)
                    )
                );
            }
        ...
        private BoundExpression MakeSizeOfMultiplication(
            BoundExpression numericOperand,
        ...
        )
        {
            ...
            var multiplication = _factory.Binary(
                multiplicationKind,
