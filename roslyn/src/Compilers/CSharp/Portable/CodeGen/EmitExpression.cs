...
namespace Microsoft.CodeAnalysis.CSharp.CodeGen
{
    internal partial class CodeGenerator
    {
        ...
        )
        {
            ...
            Debug.Assert(
                argRefKindsOpt.IsDefault || argRefKindsOpt.Length == arguments.Length,
                    ...
                    Debug.Assert(
                        argRefKind == parameters[i].RefKind
                            || argRefKind == RefKindExtensions.StrictIn
                                && parameters[i].RefKind == RefKind.In,
        ...
        private void EmitInstanceCallExpression(BoundCall call, UseKind useKind)
        {
            ...
            LocalDefinition emitGenericReceiver(BoundCall call, out CallKind callKind)
            {
                ...
                callKind =
                    receiverType.IsReferenceType && !IsRef(receiver)
                        ? CallKind.CallVirt
                        : CallKind.ConstrainedCallVirt;

                LocalDefinition tempOpt = EmitReceiverRef(
                    receiver,
                    callKind == CallKind.ConstrainedCallVirt
