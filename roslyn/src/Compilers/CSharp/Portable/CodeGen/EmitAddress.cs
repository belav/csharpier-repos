...
namespace Microsoft.CodeAnalysis.CSharp.CodeGen
{
    internal partial class CodeGenerator
    {
        ...
        private LocalDefinition EmitReceiverRef(BoundExpression receiver, AddressKind addressKind)
        {
            ...
            Debug.Assert(
                receiverType.TypeKind == TypeKind.TypeParameter || receiverType.IsValueType
            );
            return EmitAddress(receiver, addressKind);
        }

        private static bool BoxNonVerifierReferenceReceiver(
            TypeSymbol receiverType,
            AddressKind addressKind
        )
        {
            Debug.Assert(!receiverType.IsVerifierReference());
            return receiverType.TypeKind == TypeKind.TypeParameter
