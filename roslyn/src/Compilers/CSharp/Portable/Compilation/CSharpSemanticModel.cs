...
namespace Microsoft.CodeAnalysis.CSharp
{
    ...
    internal abstract class CSharpSemanticModel : SemanticModel
    {
        ...
        private BoundAttribute GetSpeculativelyBoundAttribute(
            ...
            NamedTypeSymbol attributeType = (NamedTypeSymbol)binder.BindType(
                attribute.Name,
                BindingDiagnosticBag.Discarded,
                out aliasOpt
            ).Type;
            var boundNode = new ExecutableCodeBinder(
                ...
                binder.ContainingMemberOrLambda,
                binder
            ).BindAttribute(attribute, attributeType, BindingDiagnosticBag.Discarded);
        ...
        public SymbolInfo GetSymbolInfo(
            ...
            return
                CanGetSemanticInfo(constructorInitializer)
              ? GetSymbolInfoWorker(
        ...
        public SymbolInfo GetSymbolInfo(
            ...
            return
                CanGetSemanticInfo(attributeSyntax)
              ? GetSymbolInfoWorker(
                    attributeSyntax,
                    SymbolInfoOptions.DefaultOptions,
                    cancellationToken
        ...
        internal CSharpTypeInfo GetSpeculativeTypeInfoWorker(
            ...
            {
                return
                    !crefSymbols.IsDefault && crefSymbols.Length == 1
        ...
        public ImmutableArray<ISymbol> GetMemberGroup(
            ...
            return
                CanGetSemanticInfo(initializer)
              ? this.GetMemberGroupWorker(
                        initializer,
                        SymbolInfoOptions.DefaultOptions,
                        cancellationToken
        ...
        internal SymbolInfo GetSymbolInfoForNode(
            ...
            if (highestBoundNode is BoundExpression highestBoundExpr)
            {
                ...
                if (
                    ...
                    highestResultKind != LookupResultKind.Empty && highestResultKind < resultKind
                ) {
                    resultKind = highestResultKind;
                    isDynamic = highestIsDynamic;
                }
            ...
            ) // Do not return any type information for a ObjectCreationExpressionSyntax.Type node.
            {
                ...
                else if (highestBoundExprKind == BoundKind.FixedLocalCollectionInitializer)
                {
                    ...
                    if (
                        ...
                        conversion = convertedSwitch.Conversion.IsValid
                            ? convertedSwitch.Conversion
        ...
        internal static SymbolInfo GetSymbolInfoForSymbol(Symbol symbol, SymbolInfoOptions options)
        {
            ...
            else
            {
                ...
                return new SymbolInfo(
                    symbolToReturn.GetPublicSymbol(),
                    ImmutableArray<ISymbol>.Empty,
        ...
        internal virtual BoundNode Bind(
            ...
            switch (node)
            {
                case ExpressionSyntax expression:
                    ...
                    return
                        parent.IsKind(SyntaxKind.GotoStatement)
        ...
        public bool TryGetSpeculativeSemanticModelForMethodBody(
            ...
            return TryGetSpeculativeSemanticModelForMethodBodyCore(
        ...
        public bool TryGetSpeculativeSemanticModel(
            ...
            return TryGetSpeculativeSemanticModelCore(
                (SyntaxTreeSemanticModel)this,
                position,
                type,
                bindingOption,
        ...
        public bool TryGetSpeculativeSemanticModel(
            ...
            var attributeType = (NamedTypeSymbol)binder.BindType(
                attribute.Name,
                BindingDiagnosticBag.Discarded,
                out aliasOpt
            ).Type;
        ...
        public ILocalSymbol GetDeclaredSymbol(
            ...
            LocalSymbol local = foreachBinder.GetDeclaredLocalsForScope(forEachStatement)
                .FirstOrDefault();
            return (
                local
            ...
            switch (boundNode.Kind)
            {
                ...
                case BoundKind.TypeOrValueExpression:
                {
                    ...
                    BoundExpression valueExpression =
                        ((BoundTypeOrValueExpression)boundNode).Data.ValueExpression;
                ...
                case BoundKind.IndexerAccess:

                    {
                        ...
                        symbols = originalIndexersOpt.IsDefault
                            ? ImmutableArray.Create<Symbol>(indexerAccess.Indexer)
                            : StaticCast<Symbol>.From(originalIndexersOpt);
                    }
                    break;
        ...
        private static void GetSymbolsAndResultKind(
            ...
            {
                Debug.Assert(
                    (object)binaryOperator.MethodOpt == null
            ...
            if (node.SearchExtensionMethods)
            {
                ...
                foreach (var scope in new ExtensionMethodScopes(binder))
                {
                    ...
                    otherBinder.GetCandidateExtensionMethods(
                        scope.SearchUsingsNotNamespace,
                        extensionMethods,
                        name,
                        arity,
                        options,
        ...
        /// </summary>
        private static ImmutableArray<MethodSymbol> CreateReducedExtensionMethodsFromOriginalsIfNecessary(
            BoundCall call,
            CSharpCompilation compilation
        ) {
        ...
        private ImmutableArray<Symbol> CreateReducedExtensionMethodIfPossible(
        ...
        protected sealed override IAliasSymbol GetSpeculativeAliasInfoCore(
            ...
            return
                nameSyntax is IdentifierNameSyntax identifier
        ...
        protected sealed override IAliasSymbol GetAliasInfoCore(
            ...
            return
                node is IdentifierNameSyntax nameSyntax
        ...
        protected sealed override DataFlowAnalysis AnalyzeDataFlowCore(
            ...
            switch (statementOrExpression)
            {
                ...
                default:
                    throw new ArgumentException(
                        "statementOrExpression is not a StatementSyntax or an ExpressionSyntax."
                    );
            }
        }
        ...
        public sealed override NullableContext GetNullableContext(int position)
        {
            ...
            var defaultState = syntaxTree.IsGeneratedCode(
            ...
            NullableContext context = getFlag(
                ...
                defaultState.AnnotationsEnabled(),
                NullableContext.AnnotationsContextInherited,
                NullableContext.AnnotationsEnabled
            );
            context |= getFlag(
                contextState.WarningsState,
                defaultState.WarningsEnabled(),
                NullableContext.WarningsContextInherited,
                NullableContext.WarningsEnabled
            );

            return context;

            static NullableContext getFlag(
                NullableContextState.State contextState,
                bool defaultEnableState,
                NullableContext inheritedFlag,
                NullableContext enableFlag
            ) =>
                contextState switch
                {
