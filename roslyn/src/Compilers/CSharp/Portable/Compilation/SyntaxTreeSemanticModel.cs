...
#nullable disable
                ...
                switch (memberDecl.Kind())
                {
                    ...
                    case SyntaxKind.RecordDeclaration:

                        {
                            ...
                            {
                                var argumentList =
                                    recordDecl.PrimaryConstructorBaseType?.ArgumentList;
                                outsideMemberDecl =
            ...
            if (memberDecl != null)
            {
                ...
                switch (memberDecl.Kind())
                {
                    ...
                    case SyntaxKind.CompilationUnit:
                        if (
                            SimpleProgramNamedTypeSymbol.GetSimpleProgramEntryPoint(
                                Compilation,
        ...
        )
        {
            ...
            return SimpleProgramNamedTypeSymbol
        ...
        )
        {
            ...
            if (
                memberDeclaration.Kind() == SyntaxKind.NamespaceDeclaration
        ...
        )
        {
            switch (declaredNode)
            {
                case CompilationUnitSyntax unit
                      when SimpleProgramNamedTypeSymbol.GetSimpleProgramEntryPoint(
                          Compilation,
                          unit,
                          fallbackToMainEntryPoint: false
                      )
                ...
                case RecordDeclarationSyntax recordDeclaration
                    ...
                    switch (declaredSymbol.Kind)
                    {
                        case SymbolKind.Method:
                            ...
                            return (node) =>
                            {
                                ...
                                else if (node.Parent is BaseListSyntax baseList)
                                {
                                    ...
                                    && baseType == recordDeclaration.PrimaryConstructorBaseType
                                )
                                {
                        ...
                        case SymbolKind.NamedType:
                            Debug.Assert(
                                (object)declaredSymbol.GetSymbol() == (object)ctor.ContainingSymbol
                            );
                            ...
                            return (node) =>
                                ...
                                && !(
                                    ...
                                    && node
                                        == recordDeclaration.PrimaryConstructorBaseType?.ArgumentList
                                );
