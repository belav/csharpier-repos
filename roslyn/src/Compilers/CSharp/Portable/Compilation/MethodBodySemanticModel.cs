...
#nullable disable
            ...
            )
        {
            ...
            Debug.Assert(
                (syntax.Kind() == SyntaxKind.CompilationUnit)
                    == (
        ...
        )
        {
            ...
            {
                result.UnguardedAddBoundTreeForStandaloneSyntax(
                    initialState.Syntax,
                    initialState.Body,
                    initialState.SnapshotManager,
                    initialState.RemappedSymbols
                );
            }
        ...
        {
            return CreateSpeculativeForNode(
                parentSemanticModel,
                owner,
                syntax,
                rootBinder,
        ...
        )
        {
            ...
            Binder executablebinder = new WithNullableContextBinder(
                SyntaxTree,
                position,
        ...
        {
            if (
                MemberSymbol is SynthesizedPrimaryConstructor primaryCtor
            ...
            )
            {
                ...
                if (
                    Root.FindToken(position)
                        ...
                        .FirstOrDefault() == typeDecl.PrimaryConstructorBaseTypeIfClass
                )
                {
                    var binder = this.GetEnclosingBinder(position);
                    if (binder != null)
