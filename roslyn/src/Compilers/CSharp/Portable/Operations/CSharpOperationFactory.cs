    ...
    internal sealed partial class CSharpOperationFactory
    {
        ...
        )
        {
            ...
            return new MethodReferenceOperation(
                ...
                bindingSyntax,
                bindingType,
                boundMethodGroup.WasCompilerGenerated
            );
        }
        ...
        )
        {
            ...
            bool isImplicit =
                ...
                || boundBadExpression.ChildBoundNodes.Any(
                    e => e?.Syntax == boundBadExpression.Syntax
                );
        ...
        )
        {
            ...
            bool isImplicit =
                ...
                || boundBadStatement.ChildBoundNodes.Any(
                    e => e?.Syntax == boundBadStatement.Syntax
                );
            var children = CreateFromArray<BoundNode, IOperation>(
        ...
        )
        {
            ...
            )
            {
                ...
                static (BoundExpression Value, BoundExpression? Alignment, BoundExpression? Format) getCallInfo(
