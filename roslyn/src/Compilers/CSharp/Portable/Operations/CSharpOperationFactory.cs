    ...
    internal sealed partial class CSharpOperationFactory
    {
            ...
            switch (declaration.Kind)
            {
                case BoundKind.LocalDeclaration:
                {
                    BoundTypeExpression? declaredTypeOpt =
                        ((BoundLocalDeclaration)declaration).DeclaredTypeOpt;
                ...
                {
                    var declarations =
                        ((BoundMultipleLocalDeclarationsBase)declaration).LocalDeclarations;
        ...
        )
        {
            ...
            if (boundConversion.ConversionKind == ConversionKind.InterpolatedStringHandler)
            {
                ...
                Debug.Assert(
                    boundOperand
                        is BoundInterpolatedString { InterpolationData: not null }
                            or BoundBinaryOperator { InterpolatedStringHandlerData: not null }
                );
        ...
        )
        {
            ...
            IMethodSymbol operatorMethod =
                boundCompoundAssignmentOperator.Operator.Method.GetPublicSymbol();
