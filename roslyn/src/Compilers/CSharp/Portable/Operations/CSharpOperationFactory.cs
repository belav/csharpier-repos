...
namespace Microsoft.CodeAnalysis.Operations
{
    internal sealed partial class CSharpOperationFactory
    {
        ...
        private ICollectionExpressionOperation CreateBoundCollectionExpression(
            BoundCollectionExpression expr
        )
        {
            ...
            IMethodSymbol? constructMethod = getConstructMethod(
        ...
        private static BoundExpression GetUnderlyingCollectionExpressionElement(
        ...
        )
        {
            ...
            var iteratorItem = iteratorBody is null
                ? null
                : GetUnderlyingCollectionExpressionElement(iteratorBody);
