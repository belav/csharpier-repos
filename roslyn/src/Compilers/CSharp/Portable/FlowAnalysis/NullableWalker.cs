...
namespace Microsoft.CodeAnalysis.CSharp
{
        ...
        : LocalDataFlowPass<NullableWalker.LocalState, NullableWalker.LocalFunctionState>
    {
                        ...
                        if (needsDefaultInitialStateForMembers())
                        {
                            foreach (var member in method.ContainingType.GetMembersUnordered())
                            {
                                ...
                                if (memberSlot > 0)
                                {
                                    ...
                                    {
                                        this.State[memberSlot] = type.Type
                    ...
                    .Any(
                        tree =>
                            ((CSharpSyntaxTree)tree)
                                .IsNullableAnalysisEnabled(new Text.TextSpan(0, tree.Length))
                            == true
                    );
            }
#endif
        ...
        )
        {
            ...
            return base
                .GetOrCreateSlot(symbol, containingSlot, forceSlotEvenIfEmpty, createIfMissing);
        }
        ...
        public override BoundNode? VisitArrayCreation(BoundArrayCreation node)
        {
            ...
            var expressions = ArrayBuilder<BoundExpression>
                .GetInstance(initialization.Initializers.Length);
        ...
        )
        {
            ...
            if (bestType is { })
            {
                ...
                ConversionsBase conversionsWithoutNullability = walker._conversions
        ...
        )
        {
            ...
            if (deconstructMethod is object)
            {
                ...
                if (!invocation.InvokedAsExtensionMethod)
                {
                    ...
                    {
                        deconstructMethod = deconstructMethod.OriginalDefinition
