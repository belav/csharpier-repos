        ...
        : LocalDataFlowPass<NullableWalker.LocalState, NullableWalker.LocalFunctionState>
    {
        ...
        protected override ImmutableArray<PendingBranch> Scan(ref bool badRegion)
        {
            ...
            )
            {
                ...
                var badState =
                    fieldType.Type.IsPossiblyNullableReferenceTypeTypeParameter()
            ...
            void makeNotNullMembersMaybeNull()
            {
                ...
                ImmutableArray<Symbol> getMembersNeedingDefaultInitialState()
                {
                    ...
                    )
                    {
                        ...
                        var baseOrThisInitializer = (
                            _baseOrThisInitializer
                            ?? GetConstructorThisOrBaseSymbol(this.methodMainNode)
                        );
                    ...
                    )
                    {
                        ...
                        ) switch
                        {
                            ...
                            (
                                ...
                                => containingType
                                    ...
                                    .SelectAsArray(
                                        ...
                                        selector: getFieldSymbolToBeInitialized
                                    ),
                            ...
                            (
                                ...
                                => containingType.AllRequiredMembers.SelectAsArray(
                                    static kvp => getFieldSymbolToBeInitialized(kvp.Value)
                                ),
                ...
                if (pendingReturn.IsConditionalState)
                {
                    ...
                    foreach (var parameter in parameters)
                    {
                        ...
                        if (
                            ...
                            && pendingReturn.StateWhenTrue[slot]
                                != pendingReturn.StateWhenFalse[slot]
                        )
                        {
        ...
        private static (SnapshotManager?, ImmutableDictionary<
            BoundExpression,
            (NullabilityInfo, TypeSymbol?)
        ...
        )
        {
            ...
            if (this.State.Reachable)
            {
                ...
                if (!this.State.HasValue(targetSlot))
        ...
        private void VisitObjectCreationExpressionBase(BoundObjectCreationExpressionBase node)
        {
            ...
            (int slot, NullableFlowState resultState, Func<
                TypeSymbol,
                MethodSymbol?,
                int
            >? completion) inferInitialObjectState(
        ...
        protected override void VisitBinaryOperatorChildren(ArrayBuilder<BoundBinaryOperator> stack)
        {
            ...
            {
                return resultType.State.IsNotNull() || expr.ConstantValue is object;
            }
            ...
            bool learnFromConditionalAccessOrBoolConstant()
            {
                ...
                if (
                    IsConditionalState
                    && binary.Right.ConstantValue is { IsBoolean: true } rightConstant
                )
                {
        ...
        private static void MarkSlotsAsNotNull(
            ArrayBuilder<int> slots,
        ...
        )
        {
            ...
            TypeWithState rightResult = VisitOptionalImplicitConversion(
                rightOperand,
                targetType,
                useLegacyWarnings: UseLegacyWarnings(leftOperand, targetType),
                trackMembers: false,
                AssignmentKind.Assignment
            );
            TrackNullableStateForAssignment(
        ...
        private (MethodSymbol? method, ImmutableArray<VisitArgumentResult> results, bool returnNotNull, ArgumentsCompletionDelegate? completion) VisitArguments(
            BoundNode node,
            ImmutableArray<BoundExpression> arguments,
            ImmutableArray<RefKind> refKindsOpt,
            ImmutableArray<ParameterSymbol> parametersOpt,
        ...
        )
        {
            ...
            (MethodSymbol? method, ImmutableArray<VisitArgumentResult> results, bool returnNotNull, ArgumentsCompletionDelegate? completion) visitArguments(
                BoundNode node,
                ImmutableArray<BoundExpression> arguments,
                ImmutableArray<BoundExpression> argumentsNoConversions,
                ImmutableArray<Conversion> conversions,
            ...
            )
            {
                ...
                bool parameterHasNotNullIfNotNull =
                    ...
                    && parametersOpt.Any(p => !p.NotNullIfParameterNotNull.IsEmpty);
            ...
            private static NullableAnnotation GetNullableAnnotation(BoundExpression expr)
            {
                switch (expr.Kind)
                {
                    ...
                    case BoundKind.Literal:
                        return
                            expr.ConstantValue == ConstantValue.NotAvailable
                            || !expr.ConstantValue.IsNull
                            || expr.IsSuppressed
                            ? NullableAnnotation.NotAnnotated
        ...
        private (TypeWithState resultType, Func<
            TypeWithAnnotations,
            TypeWithState
...
#nullable disable
            ...
            switch (conversion.Kind)
            {
                case ConversionKind.MethodGroup:
                    ...
                    static (MethodSymbol invokeSignature, ImmutableArray<ParameterSymbol>) getDelegateOrFunctionPointerInfo(
                        TypeSymbol targetType
                    ) =>
                        targetType switch
                        {
            ...
            else
            {
                ...
                if (!node.IsRef)
                {
                    ...
                    rightState = VisitOptionalImplicitConversion(
                        ...
                        UseLegacyWarnings(left, leftLValueType),
                        trackMembers: true,
                        AssignmentKind.Assignment
                    );
                    Unsplit();
...
#pragma warning restore IDE0055 // Fix formatting
        ...
        public override BoundNode? VisitEventAssignmentOperator(BoundEventAssignmentOperator node)
        {
            ...
            if (
                node.Argument.ConstantValue?.IsNull != true
        ...
        internal struct LocalState : ILocalDataFlowState
        {
            ...
            )
            {
                ...
                return new LocalState(
                    variables.Id,
                    container,
                    CreateBitVector(capacity, reachable)
                );
            }
            ...
            public LocalState CreateNestedMethodState(Variables variables)
            {
                ...
                return new LocalState(
                    ...
                    CreateBitVector(capacity: variables.NextAvailableIndex, reachable: true)
                );
            }
