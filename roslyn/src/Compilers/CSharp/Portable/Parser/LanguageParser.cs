                        ...
                        case SyntaxKind.UsingKeyword:
                            ...
                            else
                            {
                                ...
                                if (seen > NamespaceParts.Usings)
                                {
                                    @using = this.AddError(
                                        @using,
                                        ErrorCode.ERR_UsingAfterElements
                                    );
                                    this.AddSkippedNamespaceText(
                                        ref openBrace,
                                        ref body,
...
#nullable enable
        ...
        )
        {
            ...
            SyntaxListBuilder<MemberDeclarationSyntax> members =
                default(SyntaxListBuilder<MemberDeclarationSyntax>);
...
#nullable disable
        ...
        private BaseListSyntax ParseBaseList(SyntaxToken typeKeyword, bool haveParameters)
        {
            ...
            try
            {
                ...
                if (this.CurrentToken.Kind == SyntaxKind.OpenParenToken)
                {
                    ...
                    {
                        argumentList = this.AddErrorToFirstToken(
                            argumentList,
            ...
            try
            {
                ...
                try
                {
                    if (
                        ...
                        && !haveModifiers
                        && (type.Kind == SyntaxKind.RefType || !IsOperatorKeyword())
                    )
                    {
        ...
        private ConversionOperatorDeclarationSyntax ParseConversionOperatorDeclaration(
            SyntaxList<AttributeListSyntax> attributes,
            SyntaxListBuilder modifiers
        )
        {
        ...
        )
        {
            ...
            if (!isExpressionContext)
            {
                ...
                try
                {
                    ...
                    {
                        var isAfterNewLine = parentType.GetLastToken()
        ...
        )
        {
            ...
            switch (separator.Kind)
            {
                ...
                case SyntaxKind.DotDotToken:
                    ...
                    var rightDot = SyntaxFactory.Token(
                        null,
                        SyntaxKind.DotToken,
...
#nullable disable
                ...
                else if (isAssignmentOperator)
                {
                    ExpressionSyntax rhs =
                        ...
                        && CurrentToken.Kind == SyntaxKind.RefKeyword
                            ? rhs = CheckFeatureAvailability(
                                  ParsePossibleRefExpression(),
                                  MessageID.IDS_FeatureRefReassignment
                              )
        ...
        private bool IsPossibleLambdaExpression(Precedence precedence)
        {
            ...
            bool isAsync =
                ScanParenthesizedImplicitlyTypedLambda(precedence)
