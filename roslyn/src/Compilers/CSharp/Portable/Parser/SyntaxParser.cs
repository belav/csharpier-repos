...
namespace Microsoft.CodeAnalysis.CSharp.Syntax.InternalSyntax
{
    ...
    internal abstract partial class SyntaxParser : IDisposable
    {
        ...
        private static readonly ObjectPool<ArrayElement<SyntaxToken>[]> s_lexedTokensPool =
            new ObjectPool<ArrayElement<SyntaxToken>[]>(
                () => new ArrayElement<SyntaxToken>[CachedTokenArraySize],
                2
            );
        ...
        protected TNode AddErrorAsWarning<TNode>(TNode node, ErrorCode code, params object[] args)
            where TNode : GreenNode
        {
        ...
        protected static SyntaxToken ConvertToIdentifier(SyntaxToken token)
        {
            ...
            var identifier = SyntaxToken.Identifier(
                token.Kind,
                token.LeadingTrivia.Node,
                token.Text,
                token.ValueText,
