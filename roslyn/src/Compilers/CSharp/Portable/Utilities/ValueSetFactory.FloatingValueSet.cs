...
namespace Microsoft.CodeAnalysis.CSharp
{
    ...
    internal static partial class ValueSetFactory
    {
        ...
        private sealed class FloatingValueSet<TFloating, TFloatingTC> : IValueSet<TFloating>
            where TFloatingTC : struct, FloatingTC<TFloating>
        {
            ...
            internal static readonly IValueSet<TFloating> AllValues = new FloatingValueSet<
                TFloating,
                TFloatingTC
            >(numbers: NumericValueSet<TFloating, TFloatingTC>.AllValues, hasNaN: true);

            internal static readonly IValueSet<TFloating> NoValues = new FloatingValueSet<
                TFloating,
                TFloatingTC
            ...
            internal static IValueSet<TFloating> Random(int expectedSize, Random random)
            {
                ...
                return new FloatingValueSet<TFloating, TFloatingTC>(
                    numbers: (IValueSet<TFloating>)
                        NumericValueSetFactory<TFloating, TFloatingTC>.Instance
            ...
            IValueSet IValueSet.Intersect(IValueSet other) =>
                this.Intersect((IValueSet<TFloating>)other);
            ...
            {
                TFloatingTC tc = default;
                return _hasNaN && tc.Related(relation, tc.NaN, value)
                    || _numbers.Any(relation, value);
            }

            bool IValueSet.All(BinaryOperatorKind relation, ConstantValue value) =>
                !value.IsBad && All(relation, default(TFloatingTC).FromConstantValue(value));
