...
#pragma warning restore CS0618
        ...
        )
        {
            ...
            return _lazyLineDirectiveMap.TranslateSpan(
                this.GetText(cancellationToken),
                this.FilePath,
                span
            );
        }
        ...
        )
        {
            ...
            return _lazyLineDirectiveMap.GetLineVisibility(
                this.GetText(cancellationToken),
                position
            );
        }
        ...
        )
        {
            ...
            return _lazyLineDirectiveMap.TranslateSpanAndVisibility(
                this.GetText(),
                this.FilePath,
                span,
                out isHiddenPosition
            );
        }
