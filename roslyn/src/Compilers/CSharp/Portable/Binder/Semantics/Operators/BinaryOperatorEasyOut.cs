...
namespace Microsoft.CodeAnalysis.CSharp
{
    internal sealed partial class OverloadResolution
    {
        internal static class BinopEasyOut
        {
            ...
            private const BinaryOperatorKind LIN =
                BinaryOperatorKind.Lifted | BinaryOperatorKind.Int;
            private const BinaryOperatorKind LUN =
                BinaryOperatorKind.Lifted | BinaryOperatorKind.UInt;
            private const BinaryOperatorKind LLG =
                BinaryOperatorKind.Lifted | BinaryOperatorKind.Long;
            private const BinaryOperatorKind LUL =
                BinaryOperatorKind.Lifted | BinaryOperatorKind.ULong;
            private const BinaryOperatorKind LNI =
                BinaryOperatorKind.Lifted | BinaryOperatorKind.NInt;
            private const BinaryOperatorKind LNU =
                BinaryOperatorKind.Lifted | BinaryOperatorKind.NUInt;
            private const BinaryOperatorKind LFL =
                BinaryOperatorKind.Lifted | BinaryOperatorKind.Float;
            private const BinaryOperatorKind LDB =
                BinaryOperatorKind.Lifted | BinaryOperatorKind.Double;
            private const BinaryOperatorKind LDC =
                BinaryOperatorKind.Lifted | BinaryOperatorKind.Decimal;
            private const BinaryOperatorKind LBL =
                BinaryOperatorKind.Lifted | BinaryOperatorKind.Bool;
            ...
            private static readonly BinaryOperatorKind[,] s_arithmetic =
            {
                ...
                // bool? chr? i08? i16? i32? i64? u08? u16? u32? u64?nint?nuint?r32? r64? dec?
/*  obj */{
                    ERR,
                    ERR,
                    ERR,
...
/* dec? */{
            ...
            // Overload resolution for Y == != X
            // Note that these are the overload resolution rules; overload resolution might pick an invalid
            // operator.
            // For example, overload resolution on object == decimal chooses the object/object overload, which
            // then
            // is not legal because decimal must be a reference type. But we don't know to give that error
            // *until*
...
/* >>> */s_shift,
            ...
            public static BinaryOperatorKind OpKind(
        ...
        )
        {
            ...
            Conversion rightConversion = Conversions.FastClassifyConversion(
                rightType,
                signature.RightType
            );
