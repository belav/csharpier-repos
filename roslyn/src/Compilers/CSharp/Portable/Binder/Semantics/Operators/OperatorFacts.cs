    ...
    internal static class OperatorFacts
    {
        ...
        public static string BinaryOperatorNameFromSyntaxKind(SyntaxKind kind, bool isChecked)
        {
            return BinaryOperatorNameFromSyntaxKindIfAny(kind, isChecked)
                ...
                ); // This can occur in the presence of syntax errors.
        }

        internal static string BinaryOperatorNameFromSyntaxKindIfAny(
            SyntaxKind kind,
            bool isChecked
        )
        {
        ...
        {
            return OperatorNameFromDeclaration(
        ...
        )
        {
            ...
            if (SyntaxFacts.IsBinaryExpressionOperatorToken(opTokenKind))
            {
                ...
                if (
                    opTokenKind != SyntaxKind.AsteriskToken
        ...
        public static string OperatorNameFromDeclaration(
            Syntax.InternalSyntax.ConversionOperatorDeclarationSyntax declaration
        )
        {
        ...
        public static string BinaryOperatorNameFromOperatorKind(
