...
#nullable enable
        ...
        )
        {
            ...
            if (destination is ArrayTypeSymbol arrayType)
            {
                ...
                isSpanType(compilation, destination, WellKnownType.System_Span_T, out elementType)
            )
            {
            ...
            static bool implementsIEnumerable(CSharpCompilation compilation, TypeSymbol targetType)
            {
                ...
                switch (targetType.TypeKind)
                {
                    ...
                    case TypeKind.TypeParameter:
                        allInterfaces = (
                            (TypeParameterSymbol)targetType
