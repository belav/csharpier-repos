...
#nullable enable
        protected override CSharpCompilation Compilation
        {
        ...
        public override Conversion GetMethodGroupDelegateConversion(
        ...
        )
        {
            ...
            var (methodSymbol, isFunctionPointer, callingConventionInfo) =
                GetDelegateInvokeOrFunctionPointerMethodIfAvailable(destination);
...
#nullable enable
        ...
        )
        {
            ...
            var collectionTypeKind = GetCollectionExpressionTypeKind(
                Compilation,
                targetType,
                ...
                case CollectionExpressionTypeKind.CollectionBuilder:
                    {
                        _binder.TryGetCollectionIterationType(
                            (Syntax.ExpressionSyntax)syntax,
                            targetType,
            ...
            {
                Conversion elementConversion = convertElement(
                    element,
                    elementType,
                    ref useSiteInfo
                );
            ...
            bool isCompatibleIEnumerableT(
                NamedTypeSymbol targetInterface,
                NamedTypeSymbol ienumerableType,
                ImmutableArray<BoundNode> elements,
                ref CompoundUseSiteInfo<AssemblySymbol> useSiteInfo
            )
            {
                Debug.Assert(
                    ienumerableType.SpecialType
                        == SpecialType.System_Collections_Generic_IEnumerable_T
                );
                ...
                var targetElementType =
                    targetInterface.TypeArgumentsWithAnnotationsNoUseSiteDiagnostics[0];
                return elementsCanAllConvert(elements, targetElementType.Type, ref useSiteInfo);
            }

            bool elementsCanAllConvert(
                ImmutableArray<BoundNode> elements,
...
#nullable disable
        ...
        /// </summary>
        private static MethodGroupResolution ResolveDelegateOrFunctionPointerMethodGroup(
            Binder binder,
            BoundMethodGroup source,
        ...
        )
        {
            if ((object)delegateInvokeMethodOpt != null)
            {
                ...
                GetDelegateOrFunctionPointerArguments(
                    source.Syntax,
                    analyzedArguments,
                    delegateInvokeMethodOpt.Parameters,
                    binder.Compilation
                );
                var resolution = binder.ResolveMethodGroup(
                    ...
                    returnRefKind: delegateInvokeMethodOpt.RefKind,
                    returnType: delegateInvokeMethodOpt.ReturnType,
                    isFunctionPointerResolution: isFunctionPointer,
            ...
            {
                return binder.ResolveMethodGroup(
                    source,
        ...
        private static (
            ...
            bool isFunctionPointer,
            CallingConventionInfo callingConventionInfo
        ) GetDelegateInvokeOrFunctionPointerMethodIfAvailable(TypeSymbol type)
        {
        ...
        public static bool ReportDelegateOrFunctionPointerMethodGroupDiagnostics(
            Binder binder,
                ...
                if (result != null)
                {
                    ...
                    )
                    {
                        ...
                        result.ReportDiagnostics(
                            ...
                            isMethodGroupConversion: true,
                            returnRefKind: invokeMethodOpt?.RefKind,
        ...
        public Conversion MethodGroupConversion(
            SyntaxNode syntax,
        ...
        )
        {
            ...
            Debug.Assert(
                (object)delegateInvokeMethod != null && !delegateInvokeMethod.HasUseSiteError,
            ...
            var conversion = ToConversion(
                result,
                methodGroup,
                delegateType.DelegateInvokeMethod.ParameterCount
            );
        ...
        public static void GetDelegateOrFunctionPointerArguments(
            SyntaxNode syntax,
                ...
                if (parameter.Type.IsDynamic())
                {
                    ...
                    parameter = new SignatureOnlyParameterSymbol(
                        TypeWithAnnotations.Create(
                            ...
                            customModifiers: parameter.TypeWithAnnotations.CustomModifiers
                        ),
        ...
        )
        {
            if (sourceExpression.NeedsToBeConverted())
            {
                ...
                var sourceAsPointer = new PointerTypeSymbol(
                    TypeWithAnnotations.Create(sourceExpression.ElementType)
                );
                var pointerConversion = ClassifyImplicitConversionFromType(
                    sourceAsPointer,
                    destination,
                    ref useSiteInfo
                );
                ...
                {
                    var spanType = _binder.GetWellKnownType(
                    ...
                    if (spanType.TypeKind == TypeKind.Struct && spanType.IsRefLikeType)
                    {
                        ...
                        var spanConversion = ClassifyImplicitConversionFromType(
                            spanType_T,
                            destination,
                            ref useSiteInfo
                        );
