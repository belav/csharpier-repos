...
namespace Microsoft.CodeAnalysis.CSharp
{
    internal abstract partial class ConversionsBase
    {
        ...
        )
        {
            ...
            TypeSymbol sx = MostSpecificSourceTypeForImplicitUserDefinedConversion(
                u,
                source,
                ref useSiteInfo
            );
            ...
            TypeSymbol tx = MostSpecificTargetTypeForImplicitUserDefinedConversion(
                u,
                target,
                ref useSiteInfo
            );
        ...
        )
        {
            ...
            )
            {
                ...
                )
                {
                    ...
                    Conversion fromConversion = EncompassingImplicitConversion(
                        sourceExpression,
                        source,
                        convertsFrom,
                        ref useSiteInfo
                    );
                    Conversion toConversion = allowAnyTarget
                        ? Conversion.Identity
        ...
        )
        {
            return MostSpecificConversionOperator(
                conv =>
                    ...
                    && TypeSymbol.Equals(conv.ToType, tx, TypeCompareKind.ConsiderEverything2),
                u
            );
        }
        ...
        private bool IsEncompassedBy(
            BoundExpression aExpr,
            TypeSymbol a,
            TypeSymbol b,
            ref CompoundUseSiteInfo<AssemblySymbol> useSiteInfo
        )
        ...
        private Conversion EncompassingImplicitConversion(
            BoundExpression aExpr,
            TypeSymbol a,
            TypeSymbol b,
            ref CompoundUseSiteInfo<AssemblySymbol> useSiteInfo
        ...
        )
        {
            ...
            int? best = UniqueBestValidIndex(
                ...
                (left, right) =>
                {
                    ...
                    bool leftWins = IsEncompassedBy(
                        null,
                        leftType,
                        rightType,
                        ref inLambdaUseSiteInfo
                    );
                    bool rightWins = IsEncompassedBy(
                        null,
                        rightType,
                        leftType,
                        ref inLambdaUseSiteInfo
        ...
        )
        {
            ...
            var d = ArrayBuilder<TypeSymbol>.GetInstance();
            ComputeUserDefinedImplicitConversionTypeSet(
                source,
                t: null,
                d: d,
                useSiteInfo: ref useSiteInfo
            ...
            int? best = MostSpecificConversionOperator(
                conv => conv.ToType.IsValidV6SwitchGoverningType(isTargetTypeOfUserDefinedOp: true),
                u
            );
            if (best != null)
            {
