...
namespace Microsoft.CodeAnalysis.CSharp
{
    internal partial class Binder
    {
        ...
        private static void MergeHidingLookupResults(
        ...
        {
            Debug.Assert(
                (options & LookupOptions.MustBeAbstract) == 0
            ...
            )
            {
                ...
                (options & (LookupOptions.MustNotBeInstance | LookupOptions.MustBeAbstract))
                    == (LookupOptions.MustNotBeInstance | LookupOptions.MustBeAbstract)
                && (
                    unwrappedSymbol is not TypeSymbol && IsInstance(unwrappedSymbol)
                    || !unwrappedSymbol.IsAbstract
                )
            )
            {
                return LookupResult.Empty();
        ...
        protected virtual void AddLookupSymbolsInfoInSingleBinder(
            LookupSymbolsInfo info,
            LookupOptions options,
            Binder originalBinder
        )
