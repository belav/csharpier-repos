...
namespace Microsoft.CodeAnalysis.CSharp
{
    internal partial class Binder
    {
        ...
        /// </remarks>
        private void LookupMembersInSubmissions(
            LookupResult result,
        ...
        )
        {
            ...
            )
            {
                ...
                var considerUsings = !(
                    isCurrentSubmission && this.Flags.Includes(BinderFlags.InScriptUsing)
                );
                ...
                )
                {
                    ...
                    if (
                        ...
                        && considerUsings
                        && submissionImports.IsUsingAlias(
                            name,
                ...
                if (!submissionSymbols.IsMultiViable && considerUsings)
                {
                    ...
                    submissionImports.LookupSymbolInAliases(
                        originalBinder,
                        submissionSymbols,
                        name,
                        arity,
        ...
        )
        {
            ...
            binder.GetCandidateExtensionMethods(
        ...
        )
        {
            ...
            if (symbol.Kind == SymbolKind.NamedType)
            {
                ...
                if (namedType.IsGenericType)
                {
                    ...
                    diagInfo = diagnose
                        ? new CSDiagnosticInfo(ErrorCode.ERR_AttributeCantBeGeneric, symbol)
                        : null;
                    return false;
                }
                ...
                case SymbolKind.NamedType:
                    if (arity != 0 || (options & LookupOptions.AllNamedTypesOnArityZero) == 0)
                    {
                        ...
                        if (
                            ...
                            || options.IsAttributeTypeLookup() && arity != 0
                        )
                        {
        ...
        private void AddMemberLookupSymbolsInfoInSubmissions(
            LookupSymbolsInfo result,
        ...
        )
        {
            ...
            )
            {
                ...
                )
                {
                    ...
                    // NB: We diverge from InContainerBinder here and only look in aliases.
                    // In submissions, regular usings are bubbled up to the outermost scope.
                    submissionImports.AddLookupSymbolsInfoInAliases(
                        result,
                        options,
                        originalBinder
                    );
