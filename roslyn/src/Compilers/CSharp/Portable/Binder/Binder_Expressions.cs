    ...
    internal partial class Binder
    {
        ...
        )
        {
            if (
                ...
                && !EarlyWellKnownAttributeBinder.CanBeValidAttributeArgument(node, this)
            )
            {
...
#nullable disable
        ...
        )
        {
            ...
            try
            {
                ...
                if (
                    underlyingExpr.ConstantValue != null
        ...
        )
        {
            ...
            {
                diagnostics.Add(
                    ErrorCode.ERR_OutVariableCannotBeByRef,
                    declarationExpression.Type.Location
                );
            }
        ...
        /// </summary>
        internal static bool CheckRestrictedTypeInAsyncMethod(
...
#nullable disable
        ...
        )
        {
            if (
                ...
                && boundLeft.ConstantValue == ConstantValue.Null
...
#nullable enable
        internal NamedTypeSymbol? GetMethodGroupDelegateType(BoundMethodGroup node)
        {
            ...
            var parameterScopes = parameters.Any(p => p.EffectiveScope != DeclarationScope.Unscoped)
                ...
                : default;
            return GetMethodGroupOrLambdaDelegateType(
                node.Syntax,
                method.RefKind,
        ...
        )
        {
            ...
            if (
                ...
                && (
                    ...
                    || parameterScopes.All(scope => scope == DeclarationScope.Unscoped)
                )
            )
            {
