...
#nullable disable
        ...
        )
        {
            MessageID
                ...
                .CheckFeatureAvailability(diagnostics, node, node.ThrowKeyword.GetLocation());
...
#nullable disable
        ...
        )
        {
            MessageID
                .IDS_FeatureDefault
                .CheckFeatureAvailability(diagnostics, node, node.Keyword.GetLocation());
            ...
            if (argumentSyntax.RefKindKeyword.IsKind(SyntaxKind.InKeyword))
                MessageID
                    ...
                    .CheckFeatureAvailability(
                        diagnostics,
                        argumentSyntax,
                        argumentSyntax.RefKindKeyword.GetLocation()
                    );
...
#nullable disable
        ...
        )
        {
            ...
            MessageID
                ...
                .CheckFeatureAvailability(diagnostics, node, stackAllocKeyword.GetLocation());
...
#nullable disable
            ...
            if (initializerSyntax.Kind() == SyntaxKind.ObjectInitializerExpression)
                MessageID
                    ...
                    .CheckFeatureAvailability(
                        diagnostics,
                        initializerSyntax,
                        initializerSyntax.OpenBraceToken.GetLocation()
                    );
        ...
        )
        {
            ...
            else if (leftSyntax.Kind() == SyntaxKind.ImplicitElementAccess)
            {
                ...
                MessageID
                    ...
                    .CheckFeatureAvailability(
                        diagnostics,
                        implicitIndexing,
                        implicitIndexing.ArgumentList.OpenBracketToken.GetLocation()
                    );
            ...
            switch (boundMemberKind)
            {
                ...
                case BoundKind.IndexerAccess:
                {
                    var indexer = BindIndexerDefaultArguments(
...
#nullable disable
        ...
        ) // Last to make named arguments more convenient.
        {
            ...
            {
                this.CoerceArguments<MethodSymbol>(
                    result.ValidResult,
                    analyzedArguments.Arguments,
                    diagnostics,
                    receiver: null
        ...
        )
        {
            ...
            {
                MessageID
                    .IDS_FeatureRawStringLiterals
                    .CheckFeatureAvailability(diagnostics, node, node.Location);
            }
        ...
        )
        {
            ...
            if (!hasError && fieldSymbol.IsFixedSizeBuffer && !IsInsideNameof)
            {
                ...
                if (!hasError)
                {
                    ...
                    if (
                        IsMoveableVariable(receiver, out Symbol accessedLocalOrParameterOpt)
...
#nullable disable
        ...
        )
        {
            ...
            else
            {
                ...
                this.CoerceArguments<PropertySymbol>(
                    resolutionResult,
                    analyzedArguments.Arguments,
                    diagnostics,
                    receiver
