...
#nullable enable
        ...
        )
        {
            typeArgument.VisitType(
                ...
                typePredicate: null,
                arg: (typeArgument, errorLocation, diagnostics)
            );
        }
...
#nullable disable
        ...
        )
        {
            ...
            if (memberInitializer.Kind() == SyntaxKind.SimpleAssignmentExpression)
            {
                ...
                {
                    {
                        ...
                        boundLeft = new BoundDynamicObjectInitializerMember(
                            leftSyntax,
                            memberName,
                ...
                else
                {
                    ...
                    boundLeft = objectInitializerMemberBinder.BindObjectInitializerMember(
                        initializer,
                        implicitReceiver,
                        diagnostics
                    );
        ...
        )
        {
            ...
            bool isRhsNestedInitializer =
                rhsKind == SyntaxKind.ObjectInitializerExpression
                || rhsKind == SyntaxKind.CollectionInitializerExpression;
...
#nullable disable
                ...
                if (leftType.TypeKind == TypeKind.TypeParameter)
                {
                    ...
                    else if (lookupResult.IsClear)
                    {
                        Error(
                            ...
                            boundLeft.Syntax,
                            leftType,
                            MessageID.IDS_SK_TYVAR.Localize()
                        );
        ...
        private bool ImplementsWinRTAsyncInterface(TypeSymbol type)
        {
            return IsWinRTAsyncInterface(type)
                || type.AllInterfacesNoUseSiteDiagnostics.Any(i => IsWinRTAsyncInterface(i));
        }
...
#nullable enable
        ...
        )
        {
            ...
            bool hasByRefParameters =
                ...
                && parameterRefKinds.Any(refKind => refKind != RefKind.None);
            ...
            fieldsBuilder.Add(
                new AnonymousTypeField(name: "", location, returnType, returnRefKind)
            );
