    ...
    internal partial class Binder
    {
        ...
        )
        {
            ...
            Conversion elementConversionClassification =
                this.Conversions.ClassifyConversionFromType(pointerType, declType, ref useSiteInfo);
        ...
        private static PropertySymbol GetPropertySymbol(
            BoundExpression expr,
...
#nullable disable
        ...
        public virtual BoundNode BindMethodBody(
            ...
            BindingDiagnosticBag diagnostics,
            bool includesFieldInitializers = false
        )
        {
            switch (syntax)
            {
