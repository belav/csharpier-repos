    ...
    partial class Binder
    {
        ...
        )
        {
            return node switch
            {
                ...
                VarPatternSyntax p
                    => BindVarPattern(p, inputType, permitDesignations, hasErrors, diagnostics),
                ...
                BinaryPatternSyntax p
                    => BindBinaryPattern(p, inputType, permitDesignations, hasErrors, diagnostics),
                UnaryPatternSyntax p
                    => BindUnaryPattern(p, inputType, hasErrors, diagnostics, underIsPattern),
                ...
                ListPatternSyntax p
                    => BindListPattern(p, inputType, permitDesignations, hasErrors, diagnostics),
                SlicePatternSyntax p
                    => BindSlicePattern(
                        p,
                        inputType,
                        permitDesignations,
        ...
        )
        {
            ...
            BinaryOperatorKind opType = RelationalOperatorType(
                value.Type.EnumUnderlyingTypeOrSelf()
            );
            switch (opType)
            {
