    ...
    partial class Binder
    {
        ...
        private void BindITupleSubpatterns(
            ...
            foreach (var variable in node.Variables)
            {
                ...
                var boundSubpattern = new BoundSubpattern(variable, null, pattern);
                patterns.Add(boundSubpattern);
            }
        }
        ...
        private ImmutableArray<BoundSubpattern> BindPropertyPatternClause(
            ...
            foreach (SubpatternSyntax p in node.Subpatterns)
            {
                ...
                {
                    member = LookupMemberForPropertyPattern(
                        inputType,
                        name,
                        diagnostics,
                        ref hasErrors,
                ...
                BoundPattern boundPattern = BindPattern(
                    pattern,
                    memberType,
                    GetValEscape(memberType, inputValEscape),
                    permitDesignations,
                    hasErrors,
                    diagnostics
                );
