...
namespace Microsoft.CodeAnalysis.CSharp
{
    ...
    internal partial class Binder
    {
        ...
        )
        {
            ...
            for (int i = 0; i < fieldCount; i++)
            {
                ...
                if (nameToken.Kind() == SyntaxKind.IdentifierToken)
                {
                    ...
                    if (!uniqueFieldNames.Add(fieldName!))
                    {
                        ...
                        Error(
                            diagnostics,
                            ErrorCode.ERR_AnonymousTypeDuplicatePropertyName,
                            fieldInitializer
                        );
                        hasError = true;
                        fieldName = null;
                ...
                TypeSymbol fieldType = GetAnonymousTypeFieldType(
                    boundExpressions[i],
                    fieldInitializer,
                    diagnostics,
                    ref hasError
                ...
                fieldSyntaxNodes[i] =
                    (nameToken.Kind() == SyntaxKind.IdentifierToken)
                        ? (CSharpSyntaxNode)nameToken.Parent!
                        : fieldInitializer;
            ...
            AnonymousTypeDescriptor descriptor = new AnonymousTypeDescriptor(
                ...
                if (explicitName != null)
                {
                    ...
                    if (field.Name != null)
                    {
                        ...
                        foreach (var symbol in anonymousType.GetMembers(field.Name))
                        {
                            ...
                            {
                                declarators.Add(
                                    new BoundAnonymousPropertyDeclaration(
                                        fieldSyntaxNodes[i],
        ...
        /// </summary>
        private TypeSymbol GetAnonymousTypeFieldType(
