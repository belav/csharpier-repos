...
#nullable disable
        ...
        internal static void CheckNullableReferenceTypeAndScopedMismatchOnImplementingMember(
            TypeSymbol implementingType,
        ...
        )
        {
            ...
            return snt?.GetImplementsLocation(@interface)
                ?? implementingType.Locations.FirstOrNone();
        }
