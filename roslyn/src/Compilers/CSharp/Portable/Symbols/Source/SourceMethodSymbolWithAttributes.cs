...
#nullable disable
        ...
        )
        {
            ...
            else if (attribute.IsTargetAttribute(this, AttributeDescription.UnscopedRefAttribute))
            {
                ...
                attribute.IsTargetAttribute(this, AttributeDescription.InterceptsLocationAttribute)
            )
            {
        ...
        )
        {
            ...
            if (attributeFilePath is null)
            {
                diagnostics.Add(
                    ...
                    attributeData.GetAttributeArgumentSyntaxLocation(
            ...
            {
                var location = attributeData.GetAttributeArgumentSyntaxLocation(
