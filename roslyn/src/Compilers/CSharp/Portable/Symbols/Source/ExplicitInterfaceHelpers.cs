    ...
    internal static class ExplicitInterfaceHelpers
    {
        ...
        )
        {
            ...
            string methodName = GetMemberNameAndInterfaceSymbol(
                ...
                out discardedExplicitInterfaceType,
...
#nullable enable
        ...
        ) where T : Symbol
        {
            ...
            {
                builder.Add(
                    SubstituteExplicitInterfaceImplementation(unsubstitutedPropertyImplemented, map)
                );
            }
...
#nullable disable
        ...
        )
        {
            ...
            if (!implementingMember.IsStatic || !containingType.IsInterface)
            {
                ...
                foreach (
                    Symbol interfaceMember in explicitInterfaceNamedType.GetMembers(
                        interfaceMemberName
                    )
                )
                {
