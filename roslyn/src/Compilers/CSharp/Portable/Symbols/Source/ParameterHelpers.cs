    ...
    internal static class ParameterHelpers
    {
            ...
            where TOwningSymbol : Symbol
        {
            ...
            foreach (var parameterSyntax in parametersList)
            {
                ...
                var parameterType = binder.BindType(
...
#nullable disable
        ...
        )
        {
            ...
            )
            {
                ...
                conversion.IsReference
                    && (
                        parameterType.SpecialType == SpecialType.System_Object
                        || parameterType.Kind == SymbolKind.DynamicType
                    )
        ...
        {
            return expression.Constructor.IsDefaultValueTypeConstructor(requireZeroInit: true)
