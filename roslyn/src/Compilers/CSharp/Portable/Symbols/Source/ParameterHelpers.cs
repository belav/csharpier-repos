...
#nullable enable
            ...
            foreach (var modifier in parameter.Modifiers)
            {
                switch (modifier.Kind())
                {
                    ...
                    case SyntaxKind.ReadOnlyKeyword:
                        diagnostics.Add(
                            ErrorCode.ERR_ReadOnlyNotSuppAsParamModDidYouMeanIn,
        ...
        )
        {
            ...
            )
            {
                ...
                Location loc = ((ParameterSyntax)parameterSyntax).Identifier
            ...
            if (
                parameter is SourceParameterSymbol { DeclaredScope: DeclarationScope.ValueScoped }
                && !parameter.TypeWithAnnotations.IsRefLikeType()
            )
            {
