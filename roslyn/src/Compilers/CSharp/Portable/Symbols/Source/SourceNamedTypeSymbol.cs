...
#nullable enable
        ...
        )
        {
            ...
            else if (attribute.IsTargetAttribute(AttributeDescription.InterfaceTypeAttribute))
            {
                ...
                attribute.IsTargetAttribute(AttributeDescription.WindowsRuntimeImportAttribute)
            )
            {
                arguments
                    .GetOrCreateData<TypeWellKnownAttributeData>()
            ...
            else if (attribute.IsTargetAttribute(AttributeDescription.CollectionBuilderAttribute))
            {
                ...
                && attribute.IsTargetAttribute(AttributeDescription.TypeIdentifierAttribute)
            )
            {
