...
namespace Microsoft.CodeAnalysis.CSharp.Symbols
{
          ...
          IAttributeTargetSymbol
    {
        ...
        )
        {
            ...
            )
            {
                ...
                if (!boundAttribute.HasErrors)
                {
                    ...
                    arguments
                        .GetOrCreateData<CommonTypeEarlyWellKnownAttributeData>()
            ...
            )
            {
                ...
                if (!boundAttribute.HasErrors)
                {
                    ...
                    {
                        var typeData =
                            arguments.GetOrCreateData<CommonTypeEarlyWellKnownAttributeData>();
        ...
        internal override AttributeUsageInfo GetAttributeUsageInfo()
        {
            ...
            CommonTypeEarlyWellKnownAttributeData data =
                this.GetEarlyDecodedWellKnownAttributeData();
