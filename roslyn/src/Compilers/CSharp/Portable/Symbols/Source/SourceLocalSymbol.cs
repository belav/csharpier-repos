...
namespace Microsoft.CodeAnalysis.CSharp.Symbols
{
    ...
    internal class SourceLocalSymbol : LocalSymbol
    {
        ...
        )
        {
            ...
            return
                typeSyntax?.SkipScoped(out _).SkipRef().IsVar != false
        ...
        private TypeWithAnnotations GetTypeSymbol()
        {
            ...
            else
            {
                declType = typeBinder.BindTypeOrVarKeyword(
                    _typeSyntax.SkipScoped(out _).SkipRef(),
                    diagnostics,
                    out isVar
                );
            }
        ...
        public override Location TryGetFirstLocation() => _identifierToken.GetLocation();
