...
namespace Microsoft.CodeAnalysis.CSharp.Symbols
{
    ...
    internal abstract class SynthesizedAttributeData : CSharpAttributeData
    {
        ...
        {
            return new FromMethodAndArguments(
                compilation,
                wellKnownMember,
                arguments,
                namedArguments
        ...
        private sealed class FromMethodAndArguments : SynthesizedAttributeData
        {
            ...
            internal FromMethodAndArguments(
                CSharpCompilation compilation,
                MethodSymbol wellKnownMember,
                ImmutableArray<TypedConstant> arguments,
                ImmutableArray<KeyValuePair<string, TypedConstant>> namedArguments
            ...
            {
                return SourceAttributeData.IsTargetAttribute(
                    AttributeClass,
                    namespaceName,
                    typeName
                );
        ...
        private sealed class FromSourceAttributeData : SynthesizedAttributeData
        {
            ...
            public override SyntaxReference? ApplicationSyntaxReference =>
                _original.ApplicationSyntaxReference;
            ...
            protected internal override ImmutableArray<
                KeyValuePair<string, TypedConstant>
            > CommonNamedArguments => _original.CommonNamedArguments;
            ...
            ) => _original.GetTargetAttributeSignatureIndex(description);

            internal override bool IsTargetAttribute(string namespaceName, string typeName) =>
                _original.IsTargetAttribute(namespaceName, typeName);
        }
    }
}
