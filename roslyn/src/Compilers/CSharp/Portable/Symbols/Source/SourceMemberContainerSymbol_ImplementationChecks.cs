...
namespace Microsoft.CodeAnalysis.CSharp.Symbols
{
    ...
    internal partial class SourceMemberContainerTypeSymbol
    {
        ...
        )
        {
            ...
            var methodImpls =
                ArrayBuilder<(MethodSymbol Body, MethodSymbol Implemented)>.GetInstance();
...

                                        {
                                            ...
                                            )
                                            {
                                                DiagnosticInfo useSiteDiagnostic =
                                                    interfaceMember.GetUseSiteInfo().DiagnosticInfo;
...
#nullable disable
                ...
                else
                {
                    ...
                    if (overridingMemberIsMethod)
                    {
                        associatedPropertyOrEvent =
                            ((MethodSymbol)overridingMember).AssociatedSymbol;
                    }
                    ...
                    else
                    {
                        ...
                        )
                        {
                            ...
                            if (!IsOrContainsErrorType(overridingMethod.ReturnType))
                            {
                                ...
                                {
                                    if (
                                        !overridingMethod.ContainingAssembly.RuntimeSupportsCovariantReturnsOfClasses
                                    )
                                    {
                                        diagnostics.Add(
                ...
                )
                {
                    ...
                    )
                    {
                        ...
                        if (!IsOrContainsErrorType(overridingMemberType.Type))
                        {
                            ...
                            {
                                if (
                                    !overridingProperty.ContainingAssembly.RuntimeSupportsCovariantReturnsOfClasses
                                )
                                {
                                    diagnostics.Add(
        ...
        )
        {
                ...
                if (!notNullIfParameterNotNull.IsEmpty)
                {
                    for (var i = 0; i < baseParameters.Length; i++)
                    {
                        ...
                        if (
                            ...
                            && NullableWalker.GetParameterState(
            ...
            )
            {
                ...
                var discardedUseSiteInfo = CompoundUseSiteInfo<AssemblySymbol>.Discarded;
                return conversions.ClassifyImplicitConversionFromType(
                        sourceType,
                        targetType,
                        ref discardedUseSiteInfo
            ...
            switch (hidingMember.DeclaredAccessibility)
            {
                ...
                case Accessibility.Protected:
                {
                    ...
                    switch (hidingMember.Kind)
                    {
                        case SymbolKind.Method:
                            var associatedPropertyOrEvent =
                                ((MethodSymbol)hidingMember).AssociatedSymbol;
                            if ((object)associatedPropertyOrEvent != null)
                            {
        ...
        )
        {
            ...
            )
            {
                if (
                    ...
                    && diagnostic.Code
                        is not (int)ErrorCode.ERR_ImplicitImplementationOfNonPublicInterfaceMember
                )
                {
                    return default;
                }
