...
namespace Microsoft.CodeAnalysis.CSharp.Symbols
{
    ...
    internal readonly struct TypeWithState
    {
        ...
        public static TypeWithState Create(TypeSymbol? type, NullableFlowState defaultState)
        {
            ...
            var state =
                defaultState != NullableFlowState.NotNull && type?.CanContainNull() != false
        ...
        public string GetDebuggerDisplay() =>
            $"{{Type:{Type?.GetDebuggerDisplay()}, State:{State}{"}"}";

        public override string ToString() => GetDebuggerDisplay();

        public TypeWithState WithNotNullState() =>
            new TypeWithState(Type, NullableFlowState.NotNull);

        public TypeWithState WithSuppression(bool suppress) =>
            suppress ? new TypeWithState(Type, NullableFlowState.NotNull) : this;
