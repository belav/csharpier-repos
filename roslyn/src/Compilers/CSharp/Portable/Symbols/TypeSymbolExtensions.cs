    ...
    internal static partial class TypeSymbolExtensions
    {
        ...
        public static bool CanBeConst(this TypeSymbol typeSymbol)
        {
            ...
            return typeSymbol.IsReferenceType
                ...
                || typeSymbol.SpecialType.CanBeConst()
        ...
        public static bool IsNullableType(
            ...
            [NotNullWhen(true)] out TypeSymbol? underlyingType
        )
        {
            if (
                type is NamedTypeSymbol nt
        ...
        public static TypeWithAnnotations GetNullableUnderlyingTypeWithAnnotations(
            this TypeSymbol type
        )
        {
        ...
        /// <returns></returns>
        public static bool IsValidAttributeParameterType(
            this TypeSymbol type,
        ...
        public static TypedConstantKind GetAttributeParameterTypedConstantKind(
            this TypeSymbol type,
            CSharpCompilation compilation
        )
        {
        ...
        internal static bool IsArrayInterface(
            this TypeSymbol type,
            out TypeWithAnnotations typeArgument
        )
        {
            if (
        ...
        internal static ImmutableArray<NamedTypeSymbol> GetAllInterfacesOrEffectiveInterfaces(
            this TypeSymbol type
        )
        {
            switch (type.TypeKind)
        ...
        {
            return type.IsGenericOrNonGenericExpressionType(out bool isGenericType)
                && isGenericType;
        }
        ...
        /// or "System.Linq.Expressions.LambdaExpression".
        /// </summary>
        public static bool IsGenericOrNonGenericExpressionType(
            this TypeSymbol _type,
            out bool isGenericType
        )
        {
                ...
                switch (type.Name)
                {
                    case "Expression":
                        if (IsNamespaceName(type.ContainingSymbol, s_expressionsNamespaceName))
                        {
                            ...
                            if (type.Arity == 1 && type.MangleName)
                            {
                                isGenericType = true;
                                return true;
                            }
                    ...
                    case "LambdaExpression":
                        if (
                            IsNamespaceName(type.ContainingSymbol, s_expressionsNamespaceName)
                            && type.Arity == 0
                        )
                        {
                            isGenericType = false;
        ...
        public static ImmutableArray<ParameterSymbol> DelegateOrFunctionPointerParameters(
            this TypeSymbol type
        )
        {
        ...
        public static bool TryGetElementTypesWithAnnotationsIfTupleType(
            this TypeSymbol type,
            out ImmutableArray<TypeWithAnnotations> elementTypes
        )
        {
            if (type.IsTupleType)
            {
        ...
        public static bool IsAtLeastAsVisibleAs(
            this TypeSymbol type,
            Symbol sym,
            ref CompoundUseSiteInfo<AssemblySymbol> useSiteInfo
        )
        {
            ...
            var result = type.VisitType(
                (type1, symbol, unused) =>
                    IsTypeLessVisibleThan(type1, symbol, ref localUseSiteInfo),
                sym,
                canDigThroughNullable: true
            ); // System.Nullable is public
            useSiteInfo = localUseSiteInfo;
            return result is null;
        }

        private static bool IsTypeLessVisibleThan(
            TypeSymbol type,
            Symbol sym,
            ref CompoundUseSiteInfo<AssemblySymbol> useSiteInfo
        )
        ...
        )
        {
            ...
            RoslynDebug.Assert(
                canDigThroughNullable == false || useDefaultType == false,
            ...
            while (true)
            {
                ...
                {
                    if (
                        typeWithAnnotationsPredicate(typeWithAnnotationsOpt, arg, isNestedNamedType)
                    )
                    {
                        return current;
                    }
                ...
                if (visitCustomModifiers && typeWithAnnotationsOpt.HasType)
                {
                    foreach (var customModifier in typeWithAnnotationsOpt.CustomModifiers)
                    {
                        var result = VisitType(
                            typeWithAnnotationsOpt: default,
                            type: ((CSharpCustomModifier)customModifier).ModifierSymbol,
                            typeWithAnnotationsPredicate,
                            typePredicate,
                            arg,
                            canDigThroughNullable,
                ...
                switch (current.TypeKind)
                {
                    ...
                    case TypeKindInternal.FunctionType:
                        if (
                            ((FunctionTypeSymbol)current).GetInternalDelegateType()
                            is not { } delegateType
                        )
                        {
                            return null;
                    ...
                    case TypeKind.Delegate:
                        ...
                        {
                            var anonymous =
                                (AnonymousTypeManager.AnonymousTypeOrDelegatePublicSymbol)current;
                            ...
                            for (i = 0; i < fields.Length - 1; i++)
                            {
                                ...
                                (
                                    TypeWithAnnotations nextTypeWithAnnotations,
                                    TypeSymbol? nextType
                                ) = getNextIterationElements(
                                    fields[i].TypeWithAnnotations,
                                    canDigThroughNullable
                                );
                                var result = VisitType(
        ...
        internal static bool IsAsRestrictive(
            this Symbol s1,
            Symbol sym2,
            ref CompoundUseSiteInfo<AssemblySymbol> useSiteInfo
        )
            ...
            for (Symbol s2 = sym2; s2.Kind != SymbolKind.Namespace; s2 = s2.ContainingSymbol)
            {
                ...
                switch (acc1)
                {
                    case Accessibility.Internal:
                    {
                        ...
                        if (
                            (
                                acc2 == Accessibility.Private
                                || acc2 == Accessibility.Internal
                                || acc2 == Accessibility.ProtectedAndInternal
                            ) && s2.ContainingAssembly.HasInternalAccessTo(s1.ContainingAssembly)
                        )
                        {
                            return true;
                        }
                    ...
                    case Accessibility.Protected:
                    {
                        ...
                        else if (acc2 == Accessibility.Private)
                        {
                            ...
                            for (
                                ...
                                (object)parent2 != null;
                                parent2 = parent2.ContainingType
                            )
                            {
                        ...
                        )
                        {
                            ...
                            if (
                                (object)parent2 != null
                                && parent1.IsAccessibleViaInheritance(parent2, ref useSiteInfo)
                            )
                            {
                                return true;
                            }
                    ...
                    case Accessibility.ProtectedOrInternal:
                    {
                        ...
                        switch (acc2)
                        {
                            ...
                            case Accessibility.Protected:
                                ...
                                // then this is at least as restrictive as s1's internal protected
                                if (
                                    parent1.IsAccessibleViaInheritance(
                                        s2.ContainingType,
                                        ref useSiteInfo
                                    )
                                )
                    ...
                    case Accessibility.Private:
                        if (acc2 == Accessibility.Private)
                        {
                            ...
                            )
                            {
                                if (
                                    ReferenceEquals(
                                        parent2.OriginalDefinition,
                                        parent1OriginalDefinition
                                    )
                                    || parent1OriginalDefinition.TypeKind == TypeKind.Submission
                                        && parent2.TypeKind == TypeKind.Submission
                                )
                                {
                                    return true;
                                }
        ...
        public static bool ContainsTypeParameter(
            this TypeSymbol type,
            TypeParameterSymbol? parameter = null
        )
        {
        ...
        private static readonly Func<
            ...
            bool,
            bool
        > s_containsTypeParameterPredicate = (type, parameter, unused) =>
            type.TypeKind == TypeKind.TypeParameter
            && (
                parameter is null
                || TypeSymbol.Equals(type, parameter, TypeCompareKind.ConsiderEverything2)
            );

        public static bool ContainsTypeParameter(
            this TypeSymbol type,
            MethodSymbol parameterContainer
        )
        {
            RoslynDebug.Assert((object)parameterContainer != null);

            var result = type.VisitType(
                s_isTypeParameterWithSpecificContainerPredicate,
                parameterContainer
            );
            return result is object;
        }
        ...
        private static readonly Func<
            ...
            bool,
            bool
        > s_isTypeParameterWithSpecificContainerPredicate = (type, parameterContainer, unused) =>
            type.TypeKind == TypeKind.TypeParameter
            && (object)type.ContainingSymbol == (object)parameterContainer;

        public static bool ContainsTypeParameters(
            this TypeSymbol type,
            HashSet<TypeParameterSymbol> parameters
        )
        {
        ...
        private static readonly Func<
            ...
            bool,
            bool
        > s_containsTypeParametersPredicate = (type, parameters, unused) =>
            type.TypeKind == TypeKind.TypeParameter
            && parameters.Contains((TypeParameterSymbol)type);
        ...
        private static readonly Func<
            ...
            bool,
            bool
        > s_containsMethodTypeParameterPredicate = (type, _, _) =>
            type.TypeKind == TypeKind.TypeParameter && type.ContainingSymbol is MethodSymbol;
        ...
        internal static bool ContainsTupleNames(this TypeSymbol type) =>
            type.VisitType(
                (TypeSymbol t, object? _1, bool _2) => !t.TupleElementNames.IsDefault,
                null
            ) is object;
        ...
        internal static bool ContainsFunctionPointer(this TypeSymbol type) =>
            type.VisitType((TypeSymbol t, object? _, bool _) => t.IsFunctionPointer(), null)
            is object;

        internal static bool ContainsPointer(this TypeSymbol type) =>
            type.VisitType(
                (TypeSymbol t, object? _, bool _) =>
                    t.TypeKind is TypeKind.Pointer or TypeKind.FunctionPointer,
                null
            ) is object;
        ...
        /// </summary>
        internal static bool IsValidV6SwitchGoverningType(
            this TypeSymbol type,
            bool isTargetTypeOfUserDefinedOp = false
        )
        {
...
#pragma warning restore CA1200 // Avoid using cref tags with a prefix
        internal static bool IsRestrictedType(
            this TypeSymbol type,
        ...
        )
        {
            ...
            return ignoreSpanLikeTypes ? false : type.IsRefLikeType;
        }
        ...
        {
            var foundType = type.VisitType(
                predicate: (type, _, _) => type is NamedTypeSymbol { IsFileLocal: true },
                arg: (object?)null
            );
        ...
        internal static string? GetFileLocalTypeMetadataNamePrefix(this NamedTypeSymbol type)
        {
            ...
            return GeneratedNames.MakeFileTypeMetadataNamePrefix(
                identifier.DisplayFilePath,
        ...
        /// </summary>
        public static bool MarkCheckedIfNecessary(
            this TypeSymbol type,
        ...
        {
            RoslynDebug.Assert(
                !type.Equals(type.OriginalDefinition, TypeCompareKind.AllIgnoreOptions)
                    || wasConstructedForAnnotations(type)
            );
        ...
        /// <returns></returns>
        public static TypeSymbol AsDynamicIfNoPia(
            this TypeSymbol type,
        ...
        public static bool TryAsDynamicIfNoPia(
            this TypeSymbol type,
            NamedTypeSymbol containingType,
            [NotNullWhen(true)] out TypeSymbol? result
        )
        {
            if (type.SpecialType == SpecialType.System_Object)
            {
                AssemblySymbol assembly = containingType.ContainingAssembly;
                if ((object)assembly != null && assembly.IsLinked && containingType.IsComImport)
                {
        ...
        /// from outer-most to inner-most type.
        /// </summary>
        internal static void GetAllTypeParameters(
            this NamedTypeSymbol type,
            ArrayBuilder<TypeParameterSymbol> result
        )
        {
        ...
        /// </summary>
        internal static TypeParameterSymbol? FindEnclosingTypeParameter(
            this NamedTypeSymbol type,
            string name
        )
        {
        ...
        )
        {
            ...
            return (name.Length == length)
                && (string.Compare(name, 0, namespaceName, offset, length, comparison) == 0);
        }

        internal static bool IsNonGenericTaskType(
            this TypeSymbol type,
            CSharpCompilation compilation
        )
        {
        ...
        internal static bool IsGenericTaskType(this TypeSymbol type, CSharpCompilation compilation)
        {
            ...
            if (
                (object)namedType.ConstructedFrom
        ...
        internal static bool IsIAsyncEnumerableType(
            this TypeSymbol type,
            CSharpCompilation compilation
        )
        {
        ...
        /// </remarks>
        internal static bool IsCustomTaskType(
            this NamedTypeSymbol type,
        ...
        /// </summary>
        internal static TypeSymbol NormalizeTaskTypes(
            this TypeSymbol type,
            CSharpCompilation compilation
        )
        {
        ...
        /// </summary>
        private static bool NormalizeTaskTypesInType(
            CSharpCompilation compilation,
            ref TypeSymbol type
        )
        {
        ...
        private static bool NormalizeTaskTypesInType(
            CSharpCompilation compilation,
            ref TypeWithAnnotations typeWithAnnotations
        )
        {
            var type = typeWithAnnotations.Type;
            if (NormalizeTaskTypesInType(compilation, ref type))
            {
                typeWithAnnotations = TypeWithAnnotations.Create(
                    type,
                    customModifiers: typeWithAnnotations.CustomModifiers
                );
                return true;
            }
            return false;
            ...
            if (!type.IsDefinition)
            {
                ...
                for (int i = 0; i < typeArgumentsBuilder.Count; i++)
                {
                    ...
                    if (NormalizeTaskTypesInType(compilation, ref typeArgNormalized))
                    {
                        ...
                        typeArgumentsBuilder[i] = TypeWithAnnotations.Create(
                            typeArgNormalized,
                            customModifiers: typeWithModifier.CustomModifiers
                        );
                    }
                }
                if (hasChanged)
                {
                    ...
                    type = typeMap
                        .SubstituteNamedType(originalDefinition)
                        .WithTupleDataFrom(originalType);
                }
        ...
        private static bool NormalizeTaskTypesInArray(
            CSharpCompilation compilation,
            ref ArrayTypeSymbol arrayType
        )
        {
        ...
        private static bool NormalizeTaskTypesInPointer(
            CSharpCompilation compilation,
            ref PointerTypeSymbol pointerType
        )
        {
        ...
        private static bool NormalizeTaskTypesInFunctionPointer(
            CSharpCompilation compilation,
            ref FunctionPointerTypeSymbol funcPtrType
        )
        {
            ...
            if (madeChanges)
            {
                funcPtrType = funcPtrType.SubstituteTypeSymbol(
                    returnType,
                    paramTypes,
        ...
        )
        {
            ...
            if (compilation != null)
            {
                ...
                if (compilation.ShouldEmitNativeIntegerAttributes(type.Type))
                {
                    addIfNotNull(
                        builder,
                        moduleBuilder.SynthesizeNativeIntegerAttribute(declaringSymbol, type.Type)
                    );
                }
                if (compilation.ShouldEmitNullableAttributes(declaringSymbol))
                {
                    addIfNotNull(
                        ...
                        moduleBuilder.SynthesizeNullableAttributeIfNecessary(
                            declaringSymbol,
                            declaringSymbol.GetNullableContextValue(),
                            type
                        )
                    );
                }
                ...
                static void addIfNotNull(
                    ArrayBuilder<Cci.ICustomAttribute> builder,
                    SynthesizedAttributeData? attr
                )
                {
                    if (attr != null)
                    {
        ...
        internal static bool IsWellKnownTypeOutAttribute(this TypeSymbol typeSymbol) =>
            typeSymbol.IsWellKnownInteropServicesTopLevelType("OutAttribute");

        private static bool IsWellKnownInteropServicesTopLevelType(
        ...
        private static bool IsWellKnownCompilerServicesTopLevelType(
            this TypeSymbol typeSymbol,
            string name
        )
        {
        ...
        internal static bool IsCompilerServicesTopLevelType(this TypeSymbol typeSymbol) =>
            ...
            && IsContainedInNamespace(typeSymbol, "System", "Runtime", "CompilerServices");

        internal static bool IsWellKnownSetsRequiredMembersAttribute(this TypeSymbol type) =>
            type.Name == "SetsRequiredMembersAttribute"
            && type.IsWellKnownDiagnosticsCodeAnalysisTopLevelType();
        ...
        internal static bool IsWellKnownDiagnosticsCodeAnalysisTopLevelType(
            this TypeSymbol typeSymbol
        ) =>
            typeSymbol.ContainingType is null
            && IsContainedInNamespace(typeSymbol, "System", "Diagnostics", "CodeAnalysis");

        private static bool IsContainedInNamespace(
            this TypeSymbol typeSymbol,
            string outerNS,
            string midNS,
            string? innerNS = null
                ...
                case SpecialType.None:
                    if ((object)type != null && type.IsNullableType())
                    {
                        ...
                        switch (underlyingType.GetSpecialTypeSafe())
                        {
                            ...
                            case SpecialType.System_UInt64:
                                return 26;
                            case SpecialType.System_IntPtr when underlyingType.IsNativeIntegerType:
                                return 27;
                            case SpecialType.System_UIntPtr when underlyingType.IsNativeIntegerType:
                                return 28;
                            case SpecialType.System_Single:
                                return 29;
                            case SpecialType.System_Double:
