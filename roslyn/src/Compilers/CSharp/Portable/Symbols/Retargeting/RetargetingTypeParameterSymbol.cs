...
namespace Microsoft.CodeAnalysis.CSharp.Symbols.Retargeting
{
    ...
    /// another TypeParameterSymbol that is responsible for retargeting symbols from one assembly to
    // another.
    ...
    internal sealed class RetargetingTypeParameterSymbol : WrappedTypeParameterSymbol
    {
        ...
        public RetargetingTypeParameterSymbol(
            RetargetingModuleSymbol retargetingModule,
            TypeParameterSymbol underlyingTypeParameter
        )
        ...
        {
            get { return _underlyingTypeParameter.IsNotNullable; }
        }
