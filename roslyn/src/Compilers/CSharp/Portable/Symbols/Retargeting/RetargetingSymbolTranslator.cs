...
namespace Microsoft.CodeAnalysis.CSharp.Symbols.Retargeting
{
    ...
    internal partial class RetargetingModuleSymbol
    {
        ...
        /// </summary>
        private readonly ConcurrentDictionary<Symbol, Symbol> _symbolMap = new ConcurrentDictionary<
            Symbol,
            Symbol
        >(concurrencyLevel: 2, capacity: 4);
        ...
        > _createRetargetingTypeParameter;
            ...
            if (symbol is TupleErrorFieldSymbol tupleErrorField)
            {
                ...
                return new TupleErrorFieldSymbol(
                    RetargetingTranslator.Retarget(
                        tupleErrorField.ContainingType,
        ...
        internal class RetargetingSymbolTranslator : CSharpSymbolVisitor<RetargetOptions, Symbol>
        {
            ...
            {
                get { return _retargetingModule._symbolMap; }
            }
            ...
            {
                get { return _retargetingModule._retargetingAssembly; }
            }
            ...
            {
                get { return _retargetingModule._underlyingModule; }
            }
            ...
            {
                get { return _retargetingModule._retargetingAssemblyMap; }
            }
            ...
            public Symbol Retarget(Symbol symbol)
            {
                Debug.Assert(
                    symbol.Kind != SymbolKind.NamedType
                        || ((NamedTypeSymbol)symbol).PrimitiveTypeCode
            ...
            public TypeWithAnnotations Retarget(
            ...
            )
            {
                ...
                var newModifiers = RetargetModifiers(
                    underlyingType.CustomModifiers,
                    out modifiersHaveChanged
                );
            ...
            public NamespaceSymbol Retarget(NamespaceSymbol ns)
            {
                return (NamespaceSymbol)
                    this.SymbolMap.GetOrAdd(ns, _retargetingModule._createRetargetingNamespace);
            }
            ...
            )
            {
                ...
                {
                    var result = RetargetNamedTypeDefinition(
            ...
            )
            {
                    ...
                    while ((object)container != null)
                    {
                        if (container.IsExplicitDefinitionOfNoPiaLocalType)
                        {
                            ...
                            return (NamedTypeSymbol)
                                this.SymbolMap.GetOrAdd(type, new UnsupportedMetadataTypeSymbol());
                        }
                ...
                else
                {
                    ...
                    Debug.Assert(module.Ordinal > 0);
                    PEModuleSymbol addedModule = (PEModuleSymbol)
                        this.RetargetingAssembly.Modules[module.Ordinal];
                    Debug.Assert(
                        ReferenceEquals(((PEModuleSymbol)module).Module, addedModule.Module)
                    );
            ...
            private NamedTypeSymbol RetargetNoPiaLocalType(NamedTypeSymbol type)
            {
                ...
                if (type.ContainingSymbol.Kind != SymbolKind.NamedType && type.Arity == 0)
                {
                    ...
                    MetadataTypeName name = MetadataTypeName.FromFullName(
                        type.ToDisplayString(SymbolDisplayFormat.QualifiedNameOnlyFormat),
                            ...
                            if (signatureIndex != -1)
                            {
                                ...
                                )
                                {
                                    scope =
                                        ...
                                        as string;
                                    identifier =
                                        attrData.CommonConstructorArguments[1].ValueInternal
                                        as string;
                                }
                    ...
                    {
                        Debug.Assert(
                            (object)type.ContainingAssembly
                                != (object)RetargetingAssembly.UnderlyingAssembly
                        );
            ...
            )
            {
                Debug.Assert(
                    !type.ContainingModule.Equals(addedModule)
                        && ReferenceEquals(
                            ((PEModuleSymbol)type.ContainingModule).Module,
                            addedModule.Module
                        )
                );
                ...
                if ((object)containingType != null)
                {
                    ...
                    mdName = MetadataTypeName.FromTypeName(
                        type.MetadataName,
                        forcedArity: type.Arity
                    );
                ...
                Debug.Assert(
                    result is PENamedTypeSymbol peResult && peResult.Handle == type.Handle
                );
            ...
            )
            {
                ...
                if (!destination.SymbolMap.TryGetValue(type, out result))
                {
                    ...
                    if ((object)containingType != null)
                    {
                        ...
                        NamedTypeSymbol scope = PerformTypeRetargeting(
                            ref destination,
                            containingType
                        );
                        mdName = MetadataTypeName.FromTypeName(
...
#nullable disable
            ...
            public NamedTypeSymbol Retarget(NamedTypeSymbol type, RetargetOptions options)
            {
                ...
                NamedTypeSymbol newDefinition = RetargetNamedTypeDefinition(
                    originalDefinition,
                    options
                );
                ...
                Debug.Assert(
                    originalDefinition.Arity == 0 || !ReferenceEquals(type.ConstructedFrom, type)
                );
                ...
                Debug.Assert(
                    (object)type.ContainingType == null
                        || !type.ContainingType.IsUnboundGenericType()
                );
                ...
                {
                    if (startOfNonInterfaceArguments == int.MaxValue && !genericType.IsInterface)
                    {
                        startOfNonInterfaceArguments = oldArguments.Count;
                    }

                    oldArguments.AddRange(
                ...
                bool noPiaIllegalGenericInstantiation = IsNoPiaIllegalGenericInstantiation(
                    oldArguments,
                    newArguments,
                ...
                else
                {
                    ...
                    ArrayBuilder<TypeParameterSymbol> newParameters =
                        ArrayBuilder<TypeParameterSymbol>.GetInstance(newArguments.Count);
                    ...
                    TypeMap substitution = new TypeMap(
                        newParameters.ToImmutableAndFree(),
                        newArguments.ToImmutable()
                    );

                    constructedType = substitution
                        .SubstituteNamedType(newDefinition)
                ...
                {
                    return new NoPiaIllegalGenericInstantiationSymbol(
                        _retargetingModule,
                        constructedType
                    );
                }
            ...
            private bool IsNoPiaIllegalGenericInstantiation(
            ...
            public ArrayTypeSymbol Retarget(ArrayTypeSymbol type)
            {
                ...
                TypeWithAnnotations newElement = Retarget(
                    oldElement,
                    RetargetOptions.RetargetPrimitiveTypesByTypeCode
                );
            ...
            public PointerTypeSymbol Retarget(PointerTypeSymbol type)
            {
                ...
                TypeWithAnnotations newPointed = Retarget(
                    oldPointed,
                    RetargetOptions.RetargetPrimitiveTypesByTypeCode
                );
            ...
            public FunctionPointerTypeSymbol Retarget(FunctionPointerTypeSymbol type)
            {
                ...
                var newReturn = Retarget(
                    signature.ReturnTypeWithAnnotations,
                    RetargetOptions.RetargetPrimitiveTypesByTypeCode
                );
                var newRefModifiers = RetargetModifiers(
                    signature.RefCustomModifiers,
                    out bool symbolModified
                );
                symbolModified =
                    symbolModified || !signature.ReturnTypeWithAnnotations.IsSameAs(newReturn);
                ...
                if (paramCount > 0)
                {
                    ...
                    foreach (var parameter in signature.Parameters)
                    {
                        ...
                        parametersModified =
                            parametersModified
                            || !parameter.TypeWithAnnotations.IsSameAs(newParameterType)
                            || customModifiersChanged;
                    }
            ...
            public static ErrorTypeSymbol Retarget(ErrorTypeSymbol type)
            {
                ...
                return (type as ExtendedErrorTypeSymbol)?.AsUnreported()
                    ?? // preserve diagnostic information if possible
            ...
            {
                return arr.SelectAsArray(static (s, self) => self.Retarget(s), this);
            }
            ...
            )
            {
                return sequence.SelectAsArray(
                    static (nts, self) =>
                    {
                        ...
                        Debug.Assert(
                            nts.TypeKind == TypeKind.Error
                                || nts.PrimitiveTypeCode == Cci.PrimitiveTypeCode.NotPrimitive
                        );
            ...
            public ImmutableArray<TypeSymbol> Retarget(ImmutableArray<TypeSymbol> sequence)
            {
                return sequence.SelectAsArray(
                    static (ts, self) =>
                    {
                        ...
                        Debug.Assert(
                            ts.TypeKind == TypeKind.Error
                                || ts.PrimitiveTypeCode == Cci.PrimitiveTypeCode.NotPrimitive
                        );
            ...
            )
            {
                return sequence.SelectAsArray(
                    static (ts, self) =>
                        self.Retarget(ts, RetargetOptions.RetargetPrimitiveTypesByName),
                    this
                );
            }
            ...
            {
                return list.SelectAsArray(static (tps, self) => self.Retarget(tps), this);
            }
            ...
            public MethodSymbol Retarget(MethodSymbol method)
            {
                ...
                return (MethodSymbol)
                    this.SymbolMap.GetOrAdd(method, _retargetingModule._createRetargetingMethod);
            }
            ...
            )
            {
                ...
                if (!containingType.IsDefinition)
                {
                    ...
                    var retargetedDefinition = Retarget(
            ...
            {
                return (FieldSymbol)
                    this.SymbolMap.GetOrAdd(field, _retargetingModule._createRetargetingField);
            }
            ...
            public EventSymbol Retarget(EventSymbol @event)
            {
                ...
                {
                    return (EventSymbol)
                        this.SymbolMap.GetOrAdd(@event, _retargetingModule._createRetargetingEvent);
                }
            ...
            private class RetargetedTypeMethodFinder : RetargetingSymbolTranslator
            {
                ...
                )
                {
                    ...
                    var finder = new RetargetedTypeMethodFinder(
                        translator._retargetingModule,
                        retargetedType,
                        method
                    );
            ...
            private PropertySymbol FindPropertyInRetargetedType(
                PropertySymbol property,
                NamedTypeSymbol retargetedType,
                IEqualityComparer<PropertySymbol> retargetedPropertyComparer
            )
            ...
            private CSharpAttributeData RetargetAttributeData(CSharpAttributeData oldAttributeData)
            {
                ...
                ImmutableArray<TypedConstant> oldAttributeCtorArguments =
                    oldAttributeData.CommonConstructorArguments;
                ImmutableArray<TypedConstant> newAttributeCtorArguments =
                    RetargetAttributeConstructorArguments(oldAttributeCtorArguments);

                ImmutableArray<KeyValuePair<string, TypedConstant>> oldAttributeNamedArguments =
                    oldAttributeData.CommonNamedArguments;
                ImmutableArray<KeyValuePair<string, TypedConstant>> newAttributeNamedArguments =
                    RetargetAttributeNamedArguments(oldAttributeNamedArguments);
            ...
            )
            {
                ...
                if (!constructorArguments.IsDefault && constructorArguments.Any())
                {
                    ...
                    {
                        TypedConstant retargetedArgument = RetargetTypedConstant(
                            oldArgument,
            ...
            )
            {
                ...
                {
                    newConstantValue = Retarget(
                        (TypeSymbol)oldConstantValue,
                        RetargetOptions.RetargetPrimitiveTypesByTypeCode
                    );
                }
                else
            ...
            )
            {
                ...
                if (namedArguments.Any())
                {
                    ...
                    foreach (KeyValuePair<string, TypedConstant> oldArgument in namedArguments)
                    {
                        ...
                        TypedConstant newConstant = RetargetTypedConstant(
                            oldConstant,
                            ref typedConstantChanged
                        );
            ...
            )
            {
                if (lazyCustomAttributes.IsDefault)
                {
                    ...
                    ImmutableArray<CSharpAttributeData> retargetedAttributes =
                        this.RetargetAttributes(underlyingAttributes);

                    ImmutableInterlocked.InterlockedCompareExchange(
                        ref lazyCustomAttributes,
                        retargetedAttributes,
