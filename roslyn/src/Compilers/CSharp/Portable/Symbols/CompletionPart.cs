...
namespace Microsoft.CodeAnalysis.CSharp.Symbols
{
    ...
    /// </summary>
    /// <remarks>
    /// PEParameterSymbol reserves all completion part bits and uses them to track the completion state
    // and
    ...
    internal enum CompletionPart
    {
        ...
        NamedTypeSymbolAll =
            NamedTypeSymbolWithLocationAll | MembersCompletedChecksStarted | MembersCompleted,
