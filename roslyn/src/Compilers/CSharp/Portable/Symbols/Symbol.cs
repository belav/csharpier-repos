...
#nullable enable
        ...
        protected static bool IsLocationContainedWithin(
            Location loc,
            SyntaxTree tree,
            TextSpan declarationSpan,
            out bool wasZeroWidthMatch
        )
        {
            if (
                loc.IsInSource
                && loc.SourceTree == tree
                && declarationSpan.Contains(loc.SourceSpan)
            )
            {
                wasZeroWidthMatch =
...
#nullable disable
        ...
        public virtual bool IsDefinedInSourceTree(
            SyntaxTree tree,
        ...
        protected static bool IsDefinedInSourceTree(
...
#nullable disable
        ...
        internal bool MergeUseSiteDiagnostics(ref DiagnosticInfo result, DiagnosticInfo info)
        {
            ...
            if (
                ...
                && IsHighestPriorityUseSiteErrorCode(info.Code)
            )
            {
...
#nullable disable
        ...
        )
        {
            ...
            )
            {
                ...
                (reserved & ReservedAttributes.RequiresLocationAttribute) != 0
                && reportExplicitUseOfReservedAttribute(
                    attribute,
                    arguments,
            ...
            )
            {
                ...
                (reserved & ReservedAttributes.RequiredMemberAttribute) != 0
            ...
            )
            {
                ...
                (reserved & ReservedAttributes.ScopedRefAttribute) != 0
            ...
            )
            {
                ...
                (reserved & ReservedAttributes.RefSafetyRulesAttribute) != 0
                && reportExplicitUseOfReservedAttribute(
                    attribute,
                    arguments,
