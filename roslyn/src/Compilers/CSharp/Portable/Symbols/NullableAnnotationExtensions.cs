...
namespace Microsoft.CodeAnalysis.CSharp
{
    internal static class NullableAnnotationExtensions
    {
        ...
        /// This uses the covariant merging rules. (Annotated wins over Oblivious which wins over
        // NotAnnotated)
        /// </summary>
        ...
        /// <summary>
        /// Meet two nullable annotations for computing the nullable annotation of a type parameter from
        // upper bounds.
        /// This uses the contravariant merging rules. (NotAnnotated wins over Oblivious which wins over
        // Annotated)
        /// </summary>
        ...
        /// <summary>
        /// Return the nullable annotation to use when two annotations are expected to be "compatible",
        // which means
        /// they could be the same. These are the "invariant" merging rules. (NotAnnotated wins over
        // Annotated which wins over Oblivious)
        /// </summary>
        ...
        /// Merges nullability.
        /// </summary>
        public static NullableAnnotation MergeNullableAnnotation(
            this NullableAnnotation a,
            NullableAnnotation b,
        ...
        internal static ImmutableArray<CodeAnalysis.NullableAnnotation> ToPublicAnnotations(
            this ImmutableArray<TypeWithAnnotations> types
...
#nullable disable
        ...
        internal static CSharp.NullableAnnotation ToInternalAnnotation(
            this CodeAnalysis.NullableAnnotation annotation
        ) =>
            annotation switch
            {
