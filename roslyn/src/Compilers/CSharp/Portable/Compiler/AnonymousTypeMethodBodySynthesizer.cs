    ...
    internal sealed partial class AnonymousTypeManager
    {
        private sealed partial class AnonymousTypeConstructorSymbol : SynthesizedMethodBase
        {
            ...
            )
            {
                ...
                BoundExpression call = Binder.GenerateBaseParameterlessConstructorInitializer(
                    this,
                    diagnostics
                );
                if (call == null)
                ...
                if (fieldCount > 0)
                {
                    ...
                    for (int i = 0; i < fieldCount; i++)
                    {
                        ...
                        arguments[i] = F.Convert(
                            ...
                            new BoundLoweredConditionalAccess(
                                F.Syntax,
                                ...
                                F.Call(
                                    ...
                                    manager.System_Object__ToString
                                ),
                                null,
                                id: i,
                    ...
                    retExpression = F.StaticCall(
                        manager.System_String,
                        formatMethod,
                        F.Null(formatMethod.Parameters[0].Type),
                        format,
                        F.ArrayOrEmpty(manager.System_Object, arguments)
                    );
                }
                else
                {
