    ...
    internal sealed class MethodCompiler : CSharpSymbolVisitor<TypeCompilationState, object>
    {
                ...
                try
                {
                    ...
                    if (!hasErrors && (hasBody || includeNonEmptyInitializersInBody))
                    {
                        ...
                        else
                        {
                            ...
                            if (hasBody)
                            {
                                boundStatements = boundStatements.Concat(
        ...
        )
        {
            ...
            try
            {
                ...
                var importScopeOpt = importChainOpt
                    ?
                    .Translate(moduleBuilder, diagnosticsForThisMethod.DiagnosticBag);
        ...
        )
        {
            ...
            else if (method is SourceMemberMethodSymbol sourceMethod)
            {
                ...
                if (bodyBinder != null)
                {
                    ...
                    BoundNode methodBody = bodyBinder.BindMethodBody(
                        syntaxNode,
                        diagnostics,
                        includesFieldInitializers
                    );
