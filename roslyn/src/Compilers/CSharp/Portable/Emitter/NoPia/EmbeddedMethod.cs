...
namespace Microsoft.CodeAnalysis.CSharp.Emit.NoPia
{
    internal sealed class EmbeddedMethod : EmbeddedTypesManager.CommonEmbeddedMethod
    {
        ...
        {
            return UnderlyingMethod.AdaptedMethodSymbol.TypeParameters.SelectAsArray(
                (t, m) => new EmbeddedTypeParameter(m, t.GetCciAdapter()),
                this
            );
        }
        ...
        {
            get { return UnderlyingMethod.AdaptedMethodSymbol.IsAbstract; }
        }

        protected override bool IsAccessCheckedOnOverride
        {
            get { return UnderlyingMethod.AdaptedMethodSymbol.IsAccessCheckedOnOverride; }
        }
        ...
        {
            get { return UnderlyingMethod.AdaptedMethodSymbol.IsExternal; }
        }

        protected override bool IsHiddenBySignature
        {
            get { return !UnderlyingMethod.AdaptedMethodSymbol.HidesBaseMethodsByName; }
        }

        protected override bool IsNewSlot
        {
            get { return UnderlyingMethod.AdaptedMethodSymbol.IsMetadataNewSlot(); }
        }

        protected override Cci.IPlatformInvokeInformation PlatformInvokeData
        {
            get { return UnderlyingMethod.AdaptedMethodSymbol.GetDllImportData(); }
        }

        protected override bool IsRuntimeSpecial
        {
            get { return UnderlyingMethod.AdaptedMethodSymbol.HasRuntimeSpecialName; }
        }

        protected override bool IsSpecialName
        {
            get { return UnderlyingMethod.AdaptedMethodSymbol.HasSpecialName; }
        }

        protected override bool IsSealed
        {
            get { return UnderlyingMethod.AdaptedMethodSymbol.IsMetadataFinal; }
        }

        protected override bool IsStatic
        {
            get { return UnderlyingMethod.AdaptedMethodSymbol.IsStatic; }
        }

        protected override bool IsVirtual
        {
            get { return UnderlyingMethod.AdaptedMethodSymbol.IsMetadataVirtual(); }
        }
        ...
        {
            get { return UnderlyingMethod.AdaptedMethodSymbol.ReturnValueIsMarshalledExplicitly; }
        }

        protected override Cci.IMarshallingInformation ReturnValueMarshallingInformation
        {
            get { return UnderlyingMethod.AdaptedMethodSymbol.ReturnValueMarshallingInformation; }
        }

        protected override ImmutableArray<byte> ReturnValueMarshallingDescriptor
        {
            get { return UnderlyingMethod.AdaptedMethodSymbol.ReturnValueMarshallingDescriptor; }
        }

        protected override Cci.TypeMemberVisibility Visibility
        {
            get { return PEModuleBuilder.MemberVisibility(UnderlyingMethod.AdaptedMethodSymbol); }
        }
        ...
        {
            get { return UnderlyingMethod.AdaptedMethodSymbol.IsVararg; }
        }

        protected override Cci.ISignature UnderlyingMethodSignature
        {
            get { return (Cci.ISignature)UnderlyingMethod; }
        }

        protected override Cci.INamespace ContainingNamespace
        {
            get { return UnderlyingMethod.AdaptedMethodSymbol.ContainingNamespace.GetCciAdapter(); }
        }
    }
}
