    ...
    internal class Program
    {
        ...
        static int Main(string[] args)
        {
            ...
            var rootCommand = new RootCommand
            {
                new Option<string>(
                    "--assembliesPath",
                    BuildValidatorResources.Path_to_assemblies_to_rebuild_can_be_specified_one_or_more_times
                )
                {
                    IsRequired = true,
                ...
                new Option<string>(
                    "--sourcePath",
                    BuildValidatorResources.Path_to_sources_to_use_in_rebuild
                )
                {
                    IsRequired = true
                },
                new Option<string>(
                    "--referencesPath",
                    BuildValidatorResources.Path_to_referenced_assemblies_can_be_specified_zero_or_more_times
                )
                {
                    Argument = { Arity = ArgumentArity.ZeroOrMore }
                },
                new Option<bool>(
                    "--verbose",
                    BuildValidatorResources.Output_verbose_log_information
                ),
                new Option<bool>(
                    "--quiet",
                    BuildValidatorResources.Do_not_output_log_information_to_console
                ),
                new Option<bool>(
                    "--debug",
                    BuildValidatorResources.Output_debug_info_when_rebuild_is_not_equal_to_the_original
                ),
                new Option<string?>(
                    "--debugPath",
                    BuildValidatorResources.Path_to_output_debug_info
                )
            };
