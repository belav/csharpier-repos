...
namespace IdeCoreBenchmarks
{
    ...
    public class NavigateToBenchmarks
    {
            ...
            foreach (var project in _workspace.CurrentSolution.Projects)
            {
                foreach (var document in project.Documents)
                {
                    ...
                    await SyntaxTreeIndex
                        .PrecalculateAsync(document, default)
        ...
        public async Task RunFullParallelIndexing()
        {
            ...
            var start = DateTime.Now;
            var tasks = _workspace.CurrentSolution.Projects
                .SelectMany(p => p.Documents)
                .Select(d => Task.Run(() => SyntaxTreeIndex.PrecalculateAsync(d, default)))
                .ToList();
            await Task.WhenAll(tasks);
        ...
        public async Task RunNavigateTo()
        {
            ...
            var searchTasks = _workspace.CurrentSolution.Projects
                .Select(
                    p =>
                        Task.Run(
