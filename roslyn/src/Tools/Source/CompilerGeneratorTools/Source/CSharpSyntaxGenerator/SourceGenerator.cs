...
using System;using System.Collections.Immutable;using System.IO;using System.Linq;using System.Text;using System.Threading;using System.Xml;using System.Xml.Serialization;using Microsoft.CodeAnalysis;using Microsoft.CodeAnalysis.Text;
...
namespace CSharpSyntaxGenerator
{
    ...
    public sealed class SourceGenerator : IIncrementalGenerator
    {
        ...
        )
        {
            ...
            var sourcesBuilder = ImmutableArray.CreateBuilder<(
                string hintName,
