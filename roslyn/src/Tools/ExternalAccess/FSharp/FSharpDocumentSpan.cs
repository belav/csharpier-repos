...
namespace Microsoft.CodeAnalysis.ExternalAccess.FSharp
{
    ...
    internal readonly struct FSharpDocumentSpan : IEquatable<FSharpDocumentSpan>
    {
        ...
        public override bool Equals(object obj) => Equals((FSharpDocumentSpan)obj);
        ...
        public static bool operator !=(FSharpDocumentSpan d1, FSharpDocumentSpan d2) => !(d1 == d2);

        public override int GetHashCode() =>
            Hash.Combine(this.Document, this.SourceSpan.GetHashCode());

        internal Microsoft.CodeAnalysis.DocumentSpan ToRoslynDocumentSpan()
        {
            return new Microsoft.CodeAnalysis.DocumentSpan(
                this.Document,
                this.SourceSpan,
                this.Properties
            );
