...
namespace Microsoft.CodeAnalysis.ExternalAccess.Razor
{
    ...
    internal class RazorLanguageServerFactoryWrapper : IRazorLanguageServerFactoryWrapper
    {
        ...
        public IRazorLanguageServerTarget CreateLanguageServer(
            JsonRpc jsonRpc,
            IRazorTestCapabilitiesProvider razorCapabilitiesProvider,
...
#pragma warning restore CS0618 // Type or member is obsolete
            ...
            public RazorCapabilitiesProvider(
                IRazorTestCapabilitiesProvider razorTestCapabilitiesProvider
            )
            {
                ...
                if (_razorTestCapabilitiesProvider is not null)
                {
                    ...
                    if (serverCapabilities is null)
                    {
                        throw new InvalidOperationException(
                            "Could not deserialize server capabilities as VSInternalServerCapabilities"
                        );
                    }
