...
namespace Microsoft.CodeAnalysis.ExternalAccess.Razor
{
    internal static class RazorPredefinedCodeFixProviderNames
    {
        public static string AddDocCommentNodes =>
            PredefinedCodeFixProviderNames.AddDocCommentNodes;
        ...
        public static string AddParenthesesAroundConditionalExpressionInInterpolatedString =>
            PredefinedCodeFixProviderNames.AddParenthesesAroundConditionalExpressionInInterpolatedString;
        public static string AliasAmbiguousType =>
            PredefinedCodeFixProviderNames.AliasAmbiguousType;
        ...
        public static string CorrectNextControlVariable =>
            PredefinedCodeFixProviderNames.CorrectNextControlVariable;
        public static string ConvertTypeOfToNameOf =>
            PredefinedCodeFixProviderNames.ConvertTypeOfToNameOf;
        public static string RemoveDocCommentNode =>
            PredefinedCodeFixProviderNames.RemoveDocCommentNode;
        ...
        public static string FixIncorrectFunctionReturnType =>
            PredefinedCodeFixProviderNames.FixIncorrectFunctionReturnType;
        public static string FixIncorrectExitContinue =>
            PredefinedCodeFixProviderNames.FixIncorrectExitContinue;
        ...
        public static string GenerateEndConstruct =>
            PredefinedCodeFixProviderNames.GenerateEndConstruct;
        ...
        public static string MakeStatementAsynchronous =>
            PredefinedCodeFixProviderNames.MakeStatementAsynchronous;
        ...
        public static string MoveMisplacedUsingDirectives =>
            PredefinedCodeFixProviderNames.MoveMisplacedUsingDirectives;
        ...
        public static string QualifyMemberAccess =>
            PredefinedCodeFixProviderNames.QualifyMemberAccess;
        public static string ReplaceDefaultLiteral =>
            PredefinedCodeFixProviderNames.ReplaceDefaultLiteral;
        ...
        public static string RemoveAsyncModifier =>
            PredefinedCodeFixProviderNames.RemoveAsyncModifier;
        ...
        public static string RemoveUnnecessaryAttributeSuppressions =>
            PredefinedCodeFixProviderNames.RemoveUnnecessaryAttributeSuppressions;
        public static string RemoveUnnecessaryPragmaSuppressions =>
            PredefinedCodeFixProviderNames.RemoveUnnecessaryPragmaSuppressions;
        public static string RemoveUnreachableCode =>
            PredefinedCodeFixProviderNames.RemoveUnreachableCode;
        public static string RemoveUnusedValues =>
            PredefinedCodeFixProviderNames.RemoveUnusedValues;
        public static string RemoveUnusedLocalFunction =>
            PredefinedCodeFixProviderNames.RemoveUnusedLocalFunction;
        public static string RemoveUnusedMembers =>
            PredefinedCodeFixProviderNames.RemoveUnusedMembers;
        ...
        public static string UpdateLegacySuppressions =>
            PredefinedCodeFixProviderNames.UpdateLegacySuppressions;
        ...
        public static string UseExplicitTypeForConst =>
            PredefinedCodeFixProviderNames.UseExplicitTypeForConst;
        ...
        public static string UseObjectInitializer =>
            PredefinedCodeFixProviderNames.UseObjectInitializer;
        ...
        public static string PreferFrameworkType =>
            PredefinedCodeFixProviderNames.PreferFrameworkType;
        ...
        public static string SimplifyLinqExpression =>
            PredefinedCodeFixProviderNames.SimplifyLinqExpression;
        ...
        public static string ConvertAnonymousTypeToTuple =>
            PredefinedCodeFixProviderNames.ConvertAnonymousTypeToTuple;
        public static string AddRequiredParentheses =>
            PredefinedCodeFixProviderNames.AddRequiredParentheses;
        public static string AddAccessibilityModifiers =>
            PredefinedCodeFixProviderNames.AddAccessibilityModifiers;
        ...
        public static string RemoveRedundantEquality =>
            PredefinedCodeFixProviderNames.RemoveRedundantEquality;
        public static string RemoveUnnecessaryParentheses =>
            PredefinedCodeFixProviderNames.RemoveUnnecessaryParentheses;
        public static string SimplifyConditionalExpression =>
            PredefinedCodeFixProviderNames.SimplifyConditionalExpression;
        public static string SimplifyInterpolation =>
            PredefinedCodeFixProviderNames.SimplifyInterpolation;
        public static string UseCoalesceExpression =>
            PredefinedCodeFixProviderNames.UseCoalesceExpression;
        public static string UseCompoundAssignment =>
            PredefinedCodeFixProviderNames.UseCompoundAssignment;
        public static string UseConditionalExpressionForAssignment =>
            PredefinedCodeFixProviderNames.UseConditionalExpressionForAssignment;
        public static string UseConditionalExpressionForReturn =>
            PredefinedCodeFixProviderNames.UseConditionalExpressionForReturn;
        public static string UseExplicitTupleName =>
            PredefinedCodeFixProviderNames.UseExplicitTupleName;
        public static string UseInferredMemberName =>
            PredefinedCodeFixProviderNames.UseInferredMemberName;
        public static string UseIsNullCheck => PredefinedCodeFixProviderNames.UseIsNullCheck;
        public static string UseNullPropagation =>
            PredefinedCodeFixProviderNames.UseNullPropagation;
        ...
        public static string ConsecutiveStatementPlacement =>
            PredefinedCodeFixProviderNames.ConsecutiveStatementPlacement;
        public static string UsePatternCombinators =>
            PredefinedCodeFixProviderNames.UsePatternCombinators;
        public static string ConvertSwitchStatementToExpression =>
            PredefinedCodeFixProviderNames.ConvertSwitchStatementToExpression;
        public static string InvokeDelegateWithConditionalAccess =>
            PredefinedCodeFixProviderNames.InvokeDelegateWithConditionalAccess;
        public static string RemoveUnnecessaryByVal =>
            PredefinedCodeFixProviderNames.RemoveUnnecessaryByVal;
        public static string UseIsNotExpression =>
            PredefinedCodeFixProviderNames.UseIsNotExpression;
        ...
        public static string ConstructorInitializerPlacement =>
            PredefinedCodeFixProviderNames.ConstructorInitializerPlacement;
        public static string EmbeddedStatementPlacement =>
            PredefinedCodeFixProviderNames.EmbeddedStatementPlacement;
        ...
        public static string UseCompoundCoalesceAssignment =>
            PredefinedCodeFixProviderNames.UseCompoundCoalesceAssignment;
        ...
        public static string UseSimpleUsingStatement =>
            PredefinedCodeFixProviderNames.UseSimpleUsingStatement;
        public static string MakeLocalFunctionStatic =>
            PredefinedCodeFixProviderNames.MakeLocalFunctionStatic;
        public static string PassInCapturedVariables =>
            PredefinedCodeFixProviderNames.PassInCapturedVariables;
        ...
        public static string ConsecutiveBracePlacement =>
            PredefinedCodeFixProviderNames.ConsecutiveBracePlacement;
        ...
        public static string AddAnonymousTypeMemberName =>
            PredefinedCodeFixProviderNames.AddAnonymousTypeMemberName;
        public static string RemoveSharedFromModuleMembers =>
            PredefinedCodeFixProviderNames.RemoveSharedFromModuleMembers;
        public static string DisambiguateSameVariable =>
            PredefinedCodeFixProviderNames.DisambiguateSameVariable;
        public static string UseInterpolatedVerbatimString =>
            PredefinedCodeFixProviderNames.UseInterpolatedVerbatimString;
        public static string MakeRefStruct => PredefinedCodeFixProviderNames.MakeRefStruct;
        public static string AddObsoleteAttribute =>
            PredefinedCodeFixProviderNames.AddObsoleteAttribute;
        public static string ConflictMarkerResolution =>
            PredefinedCodeFixProviderNames.ConflictMarkerResolution;
        ...
        public static string AssignOutParametersAtStart =>
            PredefinedCodeFixProviderNames.AssignOutParametersAtStart;
        public static string AssignOutParametersAboveReturn =>
            PredefinedCodeFixProviderNames.AssignOutParametersAboveReturn;
        public static string UseCoalesceExpressionForNullable =>
            PredefinedCodeFixProviderNames.UseCoalesceExpressionForNullable;
        public static string UpdateProjectToAllowUnsafe =>
            PredefinedCodeFixProviderNames.UpdateProjectToAllowUnsafe;
        public static string UseExpressionBodyForLambda =>
            PredefinedCodeFixProviderNames.UseExpressionBodyForLambda;
        public static string PopulateSwitchExpression =>
            PredefinedCodeFixProviderNames.PopulateSwitchExpression;
        public static string UseIsNullCheckForCastAndEqualityOperator =>
            PredefinedCodeFixProviderNames.UseIsNullCheckForCastAndEqualityOperator;
        public static string UseIsNullCheckForReferenceEquals =>
            PredefinedCodeFixProviderNames.UseIsNullCheckForReferenceEquals;
        public static string UsePatternMatchingIsAndCastCheckWithoutName =>
            PredefinedCodeFixProviderNames.UsePatternMatchingIsAndCastCheckWithoutName;
        public static string UsePatternMatchingIsAndCastCheck =>
            PredefinedCodeFixProviderNames.UsePatternMatchingIsAndCastCheck;
        public static string UsePatternMatchingAsAndNullCheck =>
            PredefinedCodeFixProviderNames.UsePatternMatchingAsAndNullCheck;
