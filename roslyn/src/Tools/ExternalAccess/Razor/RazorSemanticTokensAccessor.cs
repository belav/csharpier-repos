...
namespace Microsoft.CodeAnalysis.ExternalAccess.Razor
{
    internal class RazorSemanticTokensAccessor
    {
        ...
        public static ImmutableArray<string> RoslynTokenTypes =>
            SemanticTokensSchema.LegacyTokenSchemaForRazor.AllTokenTypes;

        [Obsolete("Use GetTokenTypes(bool)")]
        public static ImmutableArray<string> GetTokenTypes(ClientCapabilities capabilities) =>
        ...
        public static ImmutableArray<string> GetTokenTypes(
            bool clientSupportsVisualStudioExtensions
        ) => SemanticTokensSchema.GetSchema(clientSupportsVisualStudioExtensions).AllTokenTypes;
