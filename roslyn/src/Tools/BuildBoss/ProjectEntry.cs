...
namespace BuildBoss
{
    ...
    internal readonly struct ProjectEntry
    {
        ...
        internal ProjectFileType ProjectType =>
            ProjectEntryUtil.GetProjectFileType(RelativeFilePath);

        internal ProjectEntry(string relativeFilePath, string name, Guid projectGuid, Guid typeGuid)
        {
    ...
    internal static class ProjectEntryUtil
    {
        ...
        internal static readonly Guid VsixProjectType = new Guid(
        ...
        internal static readonly Guid ManagedProjectSystemCSharp = new Guid(
            "9A19103F-16F7-4668-BE54-9A1E7A4F7556"
        );
        internal static readonly Guid ManagedProjectSystemVisualBasic = new Guid(
        ...
        internal static ProjectFileType GetProjectFileType(string path)
        {
            switch (Path.GetExtension(path))
            {
                ...
                case ".vbproj":
                    return ProjectFileType.Basic;
                case ".shproj":
                    return ProjectFileType.Shared;
                case ".proj":
                    return ProjectFileType.Tool;
                default:
