...
",
        ...
        {
            var runner = CreateRunner(args: new[] { "-i" }, input: "1+1");
...
> ",
        ...
        public void Args_Script1()
        {
            ...
            var runner = CreateRunner(args: new[] { script.Path, "arg1", "arg2", "arg3" });
...
"
            ...
            var runner = CreateRunner(
                new[] { $"/loadpath:{dir1.Path}", $"/loadpaths:{dir2.Path};{dir3.Path}", main.Path }
            );
