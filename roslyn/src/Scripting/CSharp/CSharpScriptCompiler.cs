...
namespace Microsoft.CodeAnalysis.CSharp.Scripting
{
    internal sealed class CSharpScriptCompiler : ScriptCompiler
    {
        ...
        internal static readonly CSharpParseOptions DefaultParseOptions = new CSharpParseOptions(
        ...
        internal static CSharpCompilationOptions WithTopLevelBinderFlags(
