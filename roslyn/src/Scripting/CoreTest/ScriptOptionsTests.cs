    ...
    public class ScriptOptionsTests : TestBase
    {
        ...
        public void AddReferences()
        {
            var options = ScriptOptions
                .Default.AddReferences(typeof(int).GetTypeInfo().Assembly)
        ...
        public void AddReferences_Errors()
        {
            ...
            Assert.Throws<ArgumentNullException>("references", () =>
                options.AddReferences((MetadataReference[])null)
            );
            Assert.Throws<ArgumentNullException>("references[0]", () =>
        ...
        public void WithReferences()
        {
            ...
            var assemblyRef = ModuleMetadata
                .CreateFromImage(TestResources.SymbolsTests.Methods.CSMethods)
                .GetReference();
        ...
        public void AddImports_Errors()
        {
            ...
            Assert.Throws<ArgumentNullException>("imports", () =>
            ...
            Assert.Throws<ArgumentNullException>("imports[0]", () =>
