...
namespace Roslyn.Test.Utilities
{
    ...
    {
        public static readonly TestRuntimeMetadataReferenceResolver Instance =
            new TestRuntimeMetadataReferenceResolver();
