...
namespace Microsoft.CodeAnalysis.CSharp.ExpressionEvaluator.UnitTests
{
    public class ObjectIdTests : CSharpResultProviderTestBase
    {
        ...
        public void SpecialTypes()
        {
            ...
            // enum
            value = CreateDkmClrValue(
                value: DkmEvaluationResultFlags.HasObjectId,
                type: typeof(DkmEvaluationResultFlags),
                alias: "$Four",
                evalFlags: DkmEvaluationResultFlags.HasObjectId
            );
            Verify(
                ...
                EvalResult(
                    "e",
                    "HasObjectId {$Four}",
                    "object {Microsoft.VisualStudio.Debugger.Evaluation.DkmEvaluationResultFlags}",
                    "e",
                    DkmEvaluationResultFlags.HasObjectId,
            ...
            Verify(
                ...
                EvalResult(
                    ...
                    "string",
                    "s",
                    DkmEvaluationResultFlags.RawString | DkmEvaluationResultFlags.HasObjectId,
                    editableValue: "\"str\""
                )
            );
            // decimal
        ...
        public void OtherIds()
        {
            ...
            Verify(
                FormatResult("o", value),
                EvalResult("o", "{object}", "object", "o", DkmEvaluationResultFlags.HasObjectId)
            );
            // "$"
            value = CreateDkmClrValue(
                value: new object(),
    ...
    public P(C c) { }
            ...
            Verify(
                ...
                EvalResult(
                    ...
                    "",
                    "o, raw",
                    DkmEvaluationResultFlags.ReadOnly | DkmEvaluationResultFlags.HasObjectId,
