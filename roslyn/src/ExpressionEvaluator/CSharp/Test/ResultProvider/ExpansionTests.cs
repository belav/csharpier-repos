...
namespace Microsoft.CodeAnalysis.CSharp.ExpressionEvaluator.UnitTests
{
    public class ExpansionTests : CSharpResultProviderTestBase
    {
        ...
        public void Primitives()
        {
            ...
            Verify(
                FormatResult("new object()", CreateDkmClrValue(new object())),
                EvalResult("new object()", "{object}", "object", "new object()")
            );
            // System.DBNull
            Verify(
                FormatResult("DBNull.Value", CreateDkmClrValue(DBNull.Value)),
                EvalResult(
                    "DBNull.Value",
                    "{}",
                    "System.DBNull",
            ...
            // System.Boolean
            Verify(
                FormatResult("new Boolean()", CreateDkmClrValue(new Boolean())),
                EvalResult(
                    "new Boolean()",
                    "false",
                    "bool",
                    "new Boolean()",
                    DkmEvaluationResultFlags.Boolean
                )
            );
            Verify(
                FormatResult(
                    ...
                    CreateDkmClrValue(
                        false,
                        typeof(bool),
                        evalFlags: DkmEvaluationResultFlags.Boolean
                    )
                ),
                EvalResult("false", "false", "bool", "false", DkmEvaluationResultFlags.Boolean)
            );
            Verify(
                FormatResult(
                    "true",
                    CreateDkmClrValue(
                        ...
                        typeof(bool),
                        evalFlags: DkmEvaluationResultFlags.Boolean
                            | DkmEvaluationResultFlags.BooleanTrue
                    )
                ),
                EvalResult(
                    "true",
            ...
            // System.Char
            Verify(
                FormatResult("new Char()", CreateDkmClrValue(new Char())),
                EvalResult("new Char()", "0 '\\0'", "char", "new Char()", editableValue: "'\\0'")
            );
            // System.SByte
            Verify(
                FormatResult("new SByte()", CreateDkmClrValue(new SByte())),
                EvalResult("new SByte()", "0", "sbyte", "new SByte()")
            );
            // System.Byte
            Verify(
                FormatResult("new Byte()", CreateDkmClrValue(new Byte())),
                EvalResult("new Byte()", "0", "byte", "new Byte()")
            );
            // System.Int16
            Verify(
                FormatResult("new Int16()", CreateDkmClrValue(new Int16())),
                EvalResult("new Int16()", "0", "short", "new Int16()")
            );
            // System.UInt16
            Verify(
                FormatResult("new UInt16()", CreateDkmClrValue(new UInt16())),
                EvalResult("new UInt16()", "0", "ushort", "new UInt16()")
            );
            // System.Int32
            Verify(
                FormatResult("new Int32()", CreateDkmClrValue(new Int32())),
                EvalResult("new Int32()", "0", "int", "new Int32()")
            );
            // System.UInt32
            Verify(
                FormatResult("new UInt32()", CreateDkmClrValue(new UInt32())),
                EvalResult("new UInt32()", "0", "uint", "new UInt32()")
            );
            // System.Int64
            Verify(
                FormatResult("new Int64()", CreateDkmClrValue(new Int64())),
                EvalResult("new Int64()", "0", "long", "new Int64()")
            );
            // System.UInt64
            Verify(
                FormatResult("new UInt64()", CreateDkmClrValue(new UInt64())),
                EvalResult("new UInt64()", "0", "ulong", "new UInt64()")
            );
            // System.Single
            Verify(
                FormatResult("new Single()", CreateDkmClrValue(new Single())),
                EvalResult("new Single()", "0", "float", "new Single()")
            );
            // System.Double
            Verify(
                FormatResult("new Double()", CreateDkmClrValue(new Double())),
                EvalResult("new Double()", "0", "double", "new Double()")
            );
            // System.Decimal
            Verify(
                FormatResult("new Decimal()", CreateDkmClrValue(new Decimal())),
                EvalResult("new Decimal()", "0", "decimal", "new Decimal()", editableValue: "0M")
            );
            // System.DateTime
            ...
            Verify(
                FormatResult("\"\"", CreateDkmClrValue("")),
                EvalResult(
                    "\"\"",
                    "\"\"",
                    "string",
                ...
                @"class C
{
    ...
    static object Q { set { } }
            ...
            var value = CreateDkmClrValue(Activator.CreateInstance(type));
            var evalResult = FormatResult(rootExpr, value);
            Verify(evalResult, EvalResult(rootExpr, "{C}", "C", rootExpr));
            var children = GetChildren(evalResult);
            Verify(children);
        }
            ...
            unsafe
            {
                ...
                Verify(
                    ...
                    EvalResult(
                        ...
                        "int*",
                        string.Format("({0}).q", rootExpr)
                    )
                );
                string fullName = string.Format("*({0}).p", rootExpr);
                Verify(GetChildren(children[0]), EvalResult(fullName, "4", "int", fullName));
            }
        }
    ...
    IntPtr* q;
            ...
            unsafe
            {
                ...
                Verify(
                    ...
                    EvalResult(
                        fullName,
                        IntPtr.Size == 8 ? "0x0000000000000004" : "0x00000004",
                        "System.IntPtr",
                        fullName,
    ...
    UIntPtr* q;
            ...
            unsafe
            {
                ...
                Verify(
                    ...
                    EvalResult(
                        fullName,
                        UIntPtr.Size == 8 ? "0x0000000000000004" : "0x00000004",
                        "System.UIntPtr",
                        fullName,
                        DkmEvaluationResultFlags.None
                    )
    ...
    void** vv;
        ...
        public void NullPointer()
        {
            ...
            */
            ...
            var evalResult = FormatResult(rootExpr, value);
            Verify(evalResult, EvalResult(rootExpr, "0x00000000", "byte*", rootExpr)); // should not be expandable
            Assert.Empty(GetChildren(evalResult));
            value = CreateDkmClrValue(0L, type);
            evalResult = FormatResult(rootExpr, value);
            Verify(evalResult, EvalResult(rootExpr, "0x0000000000000000", "byte*", rootExpr)); // should not be expandable
            Assert.Empty(GetChildren(evalResult));
        }
        ...
        public void InvalidPointer()
        {
            ...
            */
            ...
            Verify(
                ...
                EvalResult(
                    "*ptr",
                    "Cannot dereference '*ptr'. The pointer is not valid.",
                    "byte",
                    "*ptr",
...
class D
{
    C F = new C();
            ...
            // Non-null value.
            var value = CreateDkmClrValue(Activator.CreateInstance(type), type: type);
            var evalResult = FormatResult(
                "o",
                value,
                inspectionContext: CreateDkmInspectionContext(DkmEvaluationFlags.NoExpansion)
            );
            Verify(evalResult, EvalResult("o", "{C}", "C", "o", DkmEvaluationResultFlags.None));

            // Null value.
            value = CreateDkmClrValue(null, type: type);
            evalResult = FormatResult(
                "o",
                value,
                inspectionContext: CreateDkmInspectionContext(DkmEvaluationFlags.NoExpansion)
            );
            Verify(evalResult, EvalResult("o", "null", "C", "o", DkmEvaluationResultFlags.None));
  ...
  .property object 'CS$<M>7'() { .get object B::'<M>7__get'() }
            ...
            Verify(
                ...
                EvalResult(
                    ...
                    "object",
                    fullName: null,
                    flags: DkmEvaluationResultFlags.ReadOnly | DkmEvaluationResultFlags.CanFavorite
                ),
                EvalResult(
                    "@",
                    "null",
        ...
        public void ImmutableArray()
        {
            var runtime = new DkmClrRuntimeInstance(
                ReflectionUtilities.GetMscorlib(typeof(ImmutableArray<>).Assembly)
            );
            var rawValue = System.Collections.Immutable.ImmutableArray.Create(1, 2, 3);
            var type = runtime
                .GetType(typeof(ImmutableArray<>))
                .MakeGenericType(runtime.GetType(typeof(int)));
            var value = CreateDkmClrValue(
                value: rawValue,
                type: type,
                evalFlags: DkmEvaluationResultFlags.None
...
";
            ...
            Verify(
                GetChildren(children[2]), // as object
                EvalResult(
                    "F",
                    "3",
                    "object {int}",
...
";
            ...
            Verify(
                GetChildren(GetChildren(children[0]).Single()), // as A[]
                EvalResult(
                    "F",
                    "1",
                    "object {int}",
            ...
            Verify(
                GetChildren(GetChildren(children[1]).Single()), // as B[]
                EvalResult(
                    "F",
                    "2",
                    "object {int}",
            ...
            Verify(
                GetChildren(GetChildren(children[2]).Single()), // as I[]
                EvalResult(
                    "F",
                    "3",
                    "object {int}",
            ...
            Verify(
                GetChildren(GetChildren(children[3]).Single()), // as object[]
                EvalResult(
                    "F",
                    "4",
                    "object {int}",
...
";
            ...
            Verify(
                ...
                EvalResult(
                    "This",
                    "'s.This' threw an exception of type 'System.Exception'",
                    "S {System.Exception}",
                    "s.This",
                    DkmEvaluationResultFlags.Expandable
                        | DkmEvaluationResultFlags.ReadOnly
...
";
            ...
            Verify(
                ...
                EvalResult(
                    "This",
                    "'s.This' threw an exception of type 'E'",
                    "S {E}",
                    "s.This",
                    DkmEvaluationResultFlags.Expandable
                        | DkmEvaluationResultFlags.ReadOnly
    ...
    int? P
    {
        ...
        public void UnicodeChar()
        {
            ...
            evalResult = FormatResult(
                "c",
                value,
                inspectionContext: CreateDkmInspectionContext(radix: 16)
            );
            Verify(
                evalResult,
...
";
            ...
            Verify(evalResult, EvalResult("a", "{B}", "A {B}", "a", DkmEvaluationResultFlags.None));
            var children = GetChildren(evalResult);
            Verify(children);
        }
        ...
        public void DeclaredTypeAndRuntimeTypeDifferByCase()
        {
            ...
            using (runtime.Load())
            {
                ...
                var evalResult = FormatResult(
                    "o",
                    value,
                    declaredType: runtime.GetType("System.Object")
                );
                Verify(
                    evalResult,
                    EvalResult(
            ...
            using (new EnsureEnglishUICulture())
            {
                ...
                using (runtime.Load())
                {
                    ...
                    Verify(
                        ...
                        EvalResult(
                            "Q",
                            "{E: Exception of type 'E' was thrown.}",
                            "object {E}",
                            "o.Q",
                            DkmEvaluationResultFlags.Expandable
                                | DkmEvaluationResultFlags.ReadOnly
                    ...
                    Verify(moreChildren[1], EvalResult("F", "1", "object {int}", null));
                    Verify(
                        moreChildren[7],
                        EvalResult(
                            "Message",
...
class C
{
    ...
    internal object RW2 { get { throw new RW(); } set { } }
            ...
            Verify(
                ...
                EvalResult(
                    "RO1",
                    "'o.RO1' threw an exception of type 'RO'",
                    "object {RO}",
                    "o.RO1",
                    DkmEvaluationResultFlags.Expandable
                        | DkmEvaluationResultFlags.ReadOnly
                ...
                EvalResult(
                    "RO2",
                    "'o.RO2' threw an exception of type 'RW'",
                    "object {RW}",
                    "o.RO2",
                    DkmEvaluationResultFlags.Expandable
                        | DkmEvaluationResultFlags.ReadOnly
                ...
                EvalResult(
                    "RW1",
                    "'o.RW1' threw an exception of type 'RO'",
                    "object {RO}",
                    "o.RW1",
                    DkmEvaluationResultFlags.Expandable
                        | DkmEvaluationResultFlags.ExceptionThrown
                ...
                EvalResult(
                    "RW2",
                    "'o.RW2' threw an exception of type 'RW'",
                    "object {RW}",
                    "o.RW2",
                    DkmEvaluationResultFlags.Expandable
                        | DkmEvaluationResultFlags.ExceptionThrown
...
class C : B
{
    new double P { get { return 4.4; } }
            ...
            Verify(GetChildren(children[2]), EvalResult("S", "42", "int", "A.S"));
        }
                ...
                @"class B
{
    ...
    public A _4 = new A();
            ...
            DkmClrModuleInstance getModule(DkmClrRuntimeInstance r, System.Reflection.Assembly a) =>
                (a == assemblyB)
                    ? new DkmClrModuleInstance(r, a, new DkmModule(a.GetName().Name + ".dll"))
                    : null;
    ...
    object F;
            ...
            using (runtime.Load())
            {
                ...
                var value = CreateDkmClrValue(
                    Enumerable
                        .Range(0, n)
                        .Select(i => (i % 2) == 0 ? type.UnderlyingType.Instantiate() : null)
                        .ToArray()
                );
                var evalResult = FormatResult("a", value);
    ...
    object P
    {
        get
        {
            ...
            using (runtime.Load())
            {
                ...
                var type = runtime.GetType("C");
                var value = CreateDkmClrValue(
                    Enumerable.Range(0, n).Select(i => type.UnderlyingType.Instantiate(i)).ToArray()
                );
                var evalResult = FormatResult("a", value);
        ...
        public void NullFormatSpecifiers()
        {
            ...
            Verify(evalResult, EvalResult("o", "3", "int", "o"));
            ...
            Verify(evalResult, EvalResult("o", "3", "int", "o, nq"));
        }
        ...
        public void ErrorValueWithNoType()
        {
            ...
            Verify(FormatResult(rootExpr, value), EvalResult(rootExpr, message, "", rootExpr));
        }
