    ...
    public class DynamicTests : CSharpResultProviderTestBase
    {
        ...
        public void Simple()
        {
            ...
            var evalResult = FormatResult(
                ...
                rootExpr,
                value,
                declaredType: new DkmClrType((TypeImpl)typeof(object)),
                declaredTypeInfo: MakeCustomTypeInfo(true)
            );
            Verify(evalResult, EvalResult(rootExpr, "{object}", "dynamic {object}", rootExpr));
        }
...
class C<T, U>
{
    ...
    C<C<C<object, T>, dynamic[]>, U[]>[] Complex;
            ...
            var evalResult = FormatResult(
                ...
                rootExpr,
                value,
                new DkmClrType((TypeImpl)typeC_Constructed2),
            ...
            Verify(
                ...
                EvalResult(
                    rootExpr,
                    "{C<object, C<object, object>>}",
                    "C<dynamic, C<object, dynamic>> {C<object, C<object, object>>}",
                    rootExpr,
            ...
            Verify(
                ...
                EvalResult(
                    "Array",
                    "null",
                    "C<object, dynamic>[] {C<object, object>[]}",
                    "c.Array",
                    DkmEvaluationResultFlags.CanFavorite
                ),
                EvalResult(
                    "Complex",
                    "null",
                    "C<C<C<object, dynamic>, dynamic[]>, C<object, dynamic>[]>[] {C<C<C<object, object>, object[]>, C<object, object>[]>[]}",
                    "c.Complex",
                    DkmEvaluationResultFlags.CanFavorite
                ),
                EvalResult(
                    "Constructed",
                    "null",
                    "C<C<object, dynamic>, dynamic> {C<C<object, object>, object>}",
                    "c.Constructed",
                    DkmEvaluationResultFlags.CanFavorite
                ),
                EvalResult(
    ...
    class Inner<U>
    {
        ...
        Outer<U>.Inner<T> Constructed;
            ...
            var evalResult = FormatResult(
                ...
                rootExpr,
                value,
                new DkmClrType((TypeImpl)typeInner_Constructed),
                MakeCustomTypeInfo(false, true, false)
            );
            Verify(
                evalResult,
                EvalResult(
                    ...
                    "Outer<dynamic>.Inner<object> {Outer<object>.Inner<object>}",
                    rootExpr,
                    DkmEvaluationResultFlags.Expandable
                )
            );
            ...
            Verify(
                ...
                EvalResult(
                    "Constructed",
                    "null",
                    "Outer<object>.Inner<dynamic> {Outer<object>.Inner<object>}",
                    "i.Constructed",
                    DkmEvaluationResultFlags.CanFavorite
                ),
                EvalResult(
...
class D<T, U, V>
{
    ...
    V VV;
            ...
            var typeD_Constructed = typeD.MakeGenericType(
                typeof(object),
                typeof(object),
                typeof(int)
            ); // D<object, dynamic, int>
            ...
            var evalResult = FormatResult(
                ...
                rootExpr,
                value,
                new DkmClrType((TypeImpl)typeC_Constructed),
                MakeCustomTypeInfo(false, false, false, true, false)
            );
            Verify(
                evalResult,
                EvalResult(
                    rootExpr,
                    "{C<D<object, object, int>>}",
                    "C<D<object, dynamic, int>> {C<D<object, object, int>>}",
                    rootExpr,
                    DkmEvaluationResultFlags.Expandable
                )
            );
            ...
            Verify(
                ...
                EvalResult(
                    "Array",
                    "{D<object, object, int>[1]}",
                    "D<object, dynamic, int>[] {D<object, object, int>[]}",
                    "c.Array",
                    DkmEvaluationResultFlags.Expandable | DkmEvaluationResultFlags.CanFavorite
                ),
                EvalResult(
                    "Constructed",
                    "{D<D<object, object, int>, object, object>}",
                    "D<D<object, dynamic, int>, object, dynamic> {D<D<object, object, int>, object, object>}",
                    "c.Constructed",
                    DkmEvaluationResultFlags.Expandable | DkmEvaluationResultFlags.CanFavorite
                ),
                EvalResult(
    ...
    U I<bool, U>.Q { get; set; }
            ...
            Verify(
                ...
                EvalResult(
                    rootExpr,
                    "{C<object, object>}",
                    "C<dynamic, object> {C<object, object>}",
                    rootExpr,
                    DkmEvaluationResultFlags.Expandable
                )
            );
...
class Derived<T, U> : Base<T, U, object, dynamic>
{
    ...
    new public object[] S;
            ...
            var typeDerived_Constructed = typeDerived.MakeGenericType(
                typeof(object),
                typeof(object)
            ); // Derived<dynamic, object>
            ...
            var evalResult = FormatResult(
                ...
                rootExpr,
                value,
                new DkmClrType((TypeImpl)typeDerived_Constructed),
                MakeCustomTypeInfo(false, true, false)
            );
            Verify(
                evalResult,
                EvalResult(
                    ...
                    "Derived<dynamic, object> {Derived<object, object>}",
                    rootExpr,
                    DkmEvaluationResultFlags.Expandable
                )
            );
            ...
            Verify(
                children,
                EvalResult(
                    "P (Base<object, object, object, object>)",
                    "null",
                    "object",
                    "((Base<object, object, object, object>)d).P"
                ),
                EvalResult(
                    "P",
                    "null",
                ...
                EvalResult(
                    "Q (Base<object, object, object, object>)",
                    "null",
                    "object",
                    "((Base<object, object, object, object>)d).Q"
                ),
                EvalResult("Q", "null", "object[]", "d.Q", DkmEvaluationResultFlags.CanFavorite),
                EvalResult(
                    "R (Base<object, object, object, object>)",
                    "null",
                    "object",
                    "((Base<object, object, object, object>)d).R"
                ),
                EvalResult(
                    "R",
                    "null",
                ...
                EvalResult(
                    "S (Base<object, object, object, object>)",
                    "null",
                    "object",
                    "((Base<object, object, object, object>)d).S"
                ),
        ...
        public void ArrayElement()
        {
            ...
            var children = GetChildren(evalResult);
            Verify(children, EvalResult("[0]", "null", "dynamic {object}", "d[0]"));
        }
                ...
                @".class private abstract sealed beforefieldinit specialname '<>c__TypeVariables'<T,U,V>
{
  .method public hidebysig specialname rtspecialname instance void .ctor() { ret }
            ...
            var reflectionType = assembly
                ...
                .MakeGenericType([typeof(object), typeof(object), typeof(object[])]);
...
class B : A<dynamic>
{
    B() { F = 1; }
            ...
            using (runtime.Load())
            {
                ...
                var children = GetChildren(evalResult);
                Verify(children, EvalResult("F", "1", "dynamic {int}", "o.F"));
            }
        }
    }
}
