            ...
            Verify(
                ...
                EvalResult(
                    ...
                    DkmEvaluationResultFlags.Expandable
                        ...
                        | DkmEvaluationResultFlags.IsFavorite
...
class C
{
    ...
    B b = new B();
            ...
            var evalResult = FormatResult(
                ...
                value,
                null,
                CreateDkmInspectionContext(DkmEvaluationFlags.FilterToFavorites)
            );
            Verify(
                evalResult,
                EvalResult(
                ...
                @"class A
{
    ...
    string s4 = ""S4"";
            ...
            var evalResult = FormatResult(
                ...
                value,
                null,
                CreateDkmInspectionContext(DkmEvaluationFlags.UseSimpleDisplayString)
            );
            Verify(
                evalResult,
                EvalResult(
    ...
    public string S3 { get; }
            ...
            Verify(
                ...
                EvalResult(
                    ...
                    "((A)(new B())).S1",
                    DkmEvaluationResultFlags.ReadOnly
                ), /* Inherited and hidden does not currently support favorites */
                EvalResult(
                    "S2",
                    @"null",
                    "string",
