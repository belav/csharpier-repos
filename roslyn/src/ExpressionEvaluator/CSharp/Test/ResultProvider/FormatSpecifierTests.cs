        ...
        public void NoQuotes_String()
        {
            ...
            Verify(
                ...
                EvalResult(
                    ...
                    "s",
                    editableValue: "\" \"",
                    flags: DkmEvaluationResultFlags.RawString | DkmEvaluationResultFlags.HasObjectId
                )
            );
    ...
    static void Main()
    {
        ...
        System.Diagnostics.Debugger.Break();
            ...
            using (runtime.Load())
            {
                ...
                // Null value.
                value = CreateDkmClrValue(value: null, type: type);
                ...
                Verify(evalResult, EvalResult("o", "null", "C", "o, raw"));
            }
        }
        ...
        public void ResultsView_FrameworkTypes()
        {
            ...
            // ArrayList
            value = CreateDkmClrValue(
                new System.Collections.ArrayList(new[] { 2 }),
                type: runtime.GetType(typeof(System.Collections.ArrayList))
            );
            evalResult = FormatResult("a", value, inspectionContext: inspectionContext);
            Verify(
                evalResult,
            ...
            Verify(
                ...
                EvalResult(
                    ...
                    "2",
                    "object {int}",
                    "new System.Linq.SystemCore_EnumerableDebugView(a).Items[0]"
                )
            );

            // List<object>
            value = CreateDkmClrValue(
                new System.Collections.Generic.List<object>(new object[] { 3 }),
                type: runtime.GetType(typeof(System.Collections.Generic.List<object>))
            );
            ...
            Verify(
                ...
                EvalResult(
                    ...
                    "3",
                    "object {int}",
                    "new System.Linq.SystemCore_EnumerableDebugView<object>(l).Items[0]"
                )
            );
            ...
            value = CreateDkmClrValue(
                1,
                type: runtime.GetType(typeof(System.Nullable<>))
            ...
            using (runtime.Load())
            {
                ...
                Verify(
                    ...
                    EvalResult(
                        "F",
                        "{C.<get_F>d__1}",
                        "System.Collections.Generic.IEnumerable<int> {C.<get_F>d__1}",
                        "o.F",
                    ...
                    EvalResult(
                        "G",
                        "{C.<get_G>d__3}",
                        "System.Collections.IEnumerable {C.<get_G>d__3}",
                        "o.G",
                        DkmEvaluationResultFlags.Expandable
                            | DkmEvaluationResultFlags.ReadOnly
                            | DkmEvaluationResultFlags.CanFavorite
    ...
    internal ArrayList Q
    {
        get { throw new E(); }
            ...
            using (runtime.Load())
            {
                ...
                memberValue = value.GetMemberValue(
                    "Q",
                    (int)System.Reflection.MemberTypes.Property,
                    "C",
                    DefaultInspectionContext
                ...
                Verify(evalResult, EvalFailedResult("o.Q", "'o.Q' threw an exception of type 'E'"));
            }
        }
    ...
    internal int Q
    {
        get { while (!this.f) { } return 3; }
            ...
            using (runtime.Load())
            {
                ...
                Verify(evalResult, EvalFailedResult("o.P", "Property 'P' evaluation timed out"));
                memberValue = value.GetMemberValue(
                    "Q",
                    (int)System.Reflection.MemberTypes.Property,
                    "C",
                ...
                Verify(evalResult, EvalFailedResult("o.Q", "Property 'Q' evaluation timed out"));
            }
        }
