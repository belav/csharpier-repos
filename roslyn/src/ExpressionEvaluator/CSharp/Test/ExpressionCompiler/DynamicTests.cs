        ...
        return null;
            ...
            WithRuntimeInstance(
                ...
                runtime =>
                {
                    ...
                    var method = (MethodSymbol)testData.GetExplicitlyDeclaredMethods()
                        .Single().Value.Method;
                    CheckAttribute(
                        assembly,
                        method,
        ...
        return null;
            ...
            WithRuntimeInstance(
                ...
                runtime =>
                {
                    ...
                    Assert.Equal(
                        TypeKind.Dynamic,
                        ((ArrayTypeSymbol)method.ReturnType).ElementType.TypeKind
                    );
        ...
        return null;
            ...
            WithRuntimeInstance(
                ...
                runtime =>
                {
                    ...
                    Assert.Equal(
                        TypeKind.Dynamic,
                        ((NamedTypeSymbol)method.ReturnType).TypeArguments().Single().TypeKind
                    );
                    VerifyCustomTypeInfo(locals[0], "d", 0x02);
                    VerifyLocal(
                        testData,
                ...
                runtime =>
                {
                    ...
                    var aliases = ImmutableArray.Create(
                        ...
                        Alias(
                            ...
                            "d2",
                            typeof(Dictionary<
                                Dictionary<dynamic, Dictionary<object[], dynamic[]>>,
                                object
...
";
            ...
            WithRuntimeInstance(
                ...
                runtime =>
                {
                    ...
                    Assert.Equal(
                        TypeKind.Dynamic,
                        ((MethodSymbol)methodData.Method).ReturnType.TypeKind
                    );
                    methodData.VerifyIL(
                        @"
{
...
";
            ...
            WithRuntimeInstance(
                ...
                runtime =>
                {
                    ...
                    Assert.Null(error);
                    VerifyCustomTypeInfo(result, null);
                    var methodData = testData.GetMethodData(
