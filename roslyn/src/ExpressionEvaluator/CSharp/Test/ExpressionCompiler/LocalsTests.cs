...
";
  ...
  IL_000b:  ret
        ...
        [
            Fact,
            WorkItem(1022165, "http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/1022165"),
            WorkItem(1028883, "http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/1028883"),
            WorkItem(1034204, "http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/1034204")
        ]
...
#line 500
    ...
    static void DummySequencePoint()
    {
            ...
            var references = TargetFrameworkUtil.Mscorlib461ExtendedReferences.Concat(
                new[]
                {
                    TestMetadata.Net461.SystemThreadingTasks,
