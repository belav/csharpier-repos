...
";
            ...
            WithRuntimeInstance(
                comp,
                references: new[] { ValueTupleRef, SystemRuntimeFacadeRef, MscorlibRef },
                validator: runtime =>
                {
    ...
    static void M()
    {
            ...
            WithRuntimeInstance(
                ...
                runtime =>
                {
                    ...
                    Assert.Equal(
                        "error CS8092: Expression or declaration statement expected.",
                        error
                    );
                    testData = new CompilationTestData();
                    context.CompileExpression(
