                ...
                @"class C
{
    static void M()
    {
            ...
            Assert.Equal(
                "error CS0400: The type or namespace name '$exception' could not be found in the global namespace (are you missing an assembly reference?)",
                error
            );
        }
    ...
    void M()
    {
            ...
            WithRuntimeInstance(
                ...
                runtime =>
                {
                    ...
                    Assert.Equal(
                        "error CS1061: 'C' does not contain a definition for '$exception' and no accessible extension method '$exception' accepting a first argument of type 'C' could be found (are you missing a using directive or an assembly reference?)",
                        error
                    );
                }
            );
    ...
    static void M()
    {
            ...
            WithRuntimeInstance(
                ...
                runtime =>
                {
                    var context = CreateMethodContext(runtime, "C.M");
                    string error;
                    context.CompileExpression("23#", out error);
                    Assert.Equal(
            ...
            WithRuntimeInstance(
                ...
                runtime =>
                {
                    ...
                    var aliases = ImmutableArray.Create(
                        VariableAlias(
                            "s",
                            "C+S`1[[System.Int32, mscorlib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089]]"
                        )
                    );
                    ResultProperties resultProperties;
                    string error;
            ...
            WithRuntimeInstance(
                ...
                runtime =>
                {
                    ...
                    var aliases = ImmutableArray.Create(
                        VariableAlias(
                            "o",
                            "T, 9BAC6622-86EB-4EC5-94A1-9A1E6D0C24AB, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null"
                        )
                    );
                    context.CompileExpression(
                        "o.P",
                    ...
                    aliases = ImmutableArray.Create(
                        VariableAlias(
                            "s",
                            "S`1[[T, 9BAC6622-86EB-4EC5-94A1-9A1E6D0C24AB, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null]]"
                        )
                    );
                    context.CompileExpression(
                        "s.F",
    ...
    static void M()
    {
            ...
            WithRuntimeInstance(
                ...
                runtime =>
                {
                    ...
                    Assert.Equal(
                        "error CS0307: The variable '$ReturnValue1' cannot be used with type arguments",
                        error
                    );
                ...
                @"class C
{
    static void M(System.Exception e)
    {
            ...
            WithRuntimeInstance(
                ...
                {
                    var context = CreateMethodContext(runtime, "C.M");
                    var aliases = ImmutableArray.Create(ExceptionAlias());
                    ResultProperties resultProperties;
                    string error;
                    ImmutableArray<AssemblyIdentity> missingAssemblyIdentities;
                    var testData = new CompilationTestData();
...
class C
{
    static void M()
    {
            ...
            WithRuntimeInstance(
                ...
                {
                    var context = CreateMethodContext(runtime, "C.M");
                    var aliases = ImmutableArray.Create(VariableAlias("s", "S"));
                    string error;
                    var testData = new CompilationTestData();
                    context.CompileExpression(
                        "s.F = 1",
...
class C
{
    static void M()
    {
        var o = new A<object>();
            ...
            WithRuntimeInstance(
                compilationB1,
                new[] { MscorlibRef, compilationA2.EmitToImageReference() },
                runtime =>
                {
                    ...
                    var aliases = ImmutableArray.Create(
                        ...
                        ObjectIdAlias(
                            1,
                            "A`1[[B`1[[System.Object, mscorlib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089]], 397300B0-B, Version=1.2.2.2, Culture=neutral, PublicKeyToken=null]], 397300B0-A, Version=2.1.2.1, Culture=neutral, PublicKeyToken=1f8a32457d187bf3"
                        ),
                        ObjectIdAlias(
                            2,
                            "B`1[[A`1[[System.Object, mscorlib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089]][], 397300B0-A, Version=2.1.2.1, Culture=neutral, PublicKeyToken=1f8a32457d187bf3]], 397300B0-B, Version=1.2.2.2, Culture=neutral, PublicKeyToken=null"
                        )
                    );
                    string error;
                    var testData = new CompilationTestData();
    ...
    static void Main()
    {
        A<int>.M(() => { throw new E(); });
            ...
            var aliases = ImmutableArray.Create(
                ...
                ObjectIdAlias(
                    1,
                    "A`1[[B, 9BAC6622-86EB-4EC5-94A1-9A1E6D0C24B9, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null]], 0A93FF0B-31A2-47C8-B24D-16A2D77AB5C5, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null"
                )
            );
