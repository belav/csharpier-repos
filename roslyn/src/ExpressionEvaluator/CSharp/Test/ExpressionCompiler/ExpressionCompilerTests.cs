                ...
                @"class C
{
    ...
    static void G()
    {
            ...
            var scopes = symReader.GetScopes(
                methodToken,
                methodVersion,
                EvaluationContext.IsLocalScopeEndInclusive
            )
            ...
            Assert.NotEqual(context, GetMetadataContext(previous).EvaluationContext);
            Assert.True(
                GetMetadataContext(previous).EvaluationContext.MethodContextReuseConstraints.Value
                ...
                @"class C
{
    ...
    static void M()
    {
            ...
            var referenceD0 = AssemblyMetadata.CreateFromImage(compilationD0.EmitToArray())
            ...
            var referenceD1 = AssemblyMetadata.CreateFromImage(compilationD1.EmitToArray())
