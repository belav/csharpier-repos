        ...
        public void UnreferencedAssemblies()
        {
            ...
            using (
                ...
                var context = CreateMethodContext(
                    new AppDomain(),
                    ImmutableArray.Create(moduleMscorlib, moduleA2, moduleB1, moduleB2, moduleC)
...
IL_0005:  ret
        ...
        public void DifferentAssemblyVersions()
        {
            ...
            using (
                ...
                var context = CreateMethodContext(
                    new AppDomain(),
                    ImmutableArray.Create(moduleMscorlib, moduleA2, moduleB1)
                        .SelectAsArray(m => m.MetadataBlock),
                    stateB
                );
                string error;
...
IL_0005:  ret
                ...
                context = CreateMethodContext(
                    new AppDomain(),
                    ImmutableArray.Create(moduleMscorlib, moduleA3, moduleB1)
                        .SelectAsArray(m => m.MetadataBlock),
                    stateB
                );
                testData = new CompilationTestData();
...
IL_0005:  ret
                ...
                context = CreateMethodContext(
                    new AppDomain(),
                    ImmutableArray.Create(moduleMscorlib, moduleA1, moduleB1)
                        .SelectAsArray(m => m.MetadataBlock),
                    stateB
                );
                testData = new CompilationTestData();
                ...
                context = CreateMethodContext(
                    new AppDomain(),
                    ImmutableArray.Create(moduleMscorlib, moduleA1, moduleA3, moduleA2, moduleB1)
                        .SelectAsArray(m => m.MetadataBlock),
                    stateB
                );
                testData = new CompilationTestData();
...
IL_0005:  ret
        ...
        public void DuplicateNamedCorLib()
        {
            ...
            using (var runtime = CreateRuntimeInstance(new[] { moduleMscorlib, moduleA, moduleB }))
            {
                ...
                var context = CreateMethodContext(
                    new AppDomain(),
                    ImmutableArray.Create(moduleMscorlib, moduleOther, moduleA, moduleB)
                        .SelectAsArray(m => m.MetadataBlock),
                    stateB
                );
                string error;
...
IL_0005:  ret
                ...
                context = CreateMethodContext(
                    new AppDomain(),
                    ImmutableArray.Create(moduleB, moduleA, moduleOther, moduleMscorlib)
                        .SelectAsArray(m => m.MetadataBlock),
                    stateB
                );
                testData = new CompilationTestData();
