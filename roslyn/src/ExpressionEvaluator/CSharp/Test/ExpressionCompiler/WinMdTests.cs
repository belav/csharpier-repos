...
class C
{
    static void M(X::Windows.Storage.StorageFolder f)
    {
            ...
            var compilation0 = CreateEmptyCompilation(
                ...
                options: TestOptions.DebugDll,
                assemblyName: ExpressionCompilerUtilities.GenerateUniqueName(),
                references: WinRtRefs.Select(r =>
                    r.Display == "Windows" ? r.WithAliases(new[] { "X" }) : r
                )
            );
        ...
        public void Win8OnWin8()
        {
            CompileTimeAndRuntimeAssemblies(
                ImmutableArray.Create(
                    MscorlibRef,
                    AssemblyMetadata
                        .CreateFromImage(ToVersion1_3(TestResources.ExpressionCompiler.Windows))
                        .GetReference(),
                    AssemblyMetadata
                        .CreateFromImage(ToVersion1_3(TestResources.ExpressionCompiler.LibraryA))
                        .GetReference(),
                    AssemblyMetadata
                ...
                ImmutableArray.Create(
                    MscorlibRef,
                    AssemblyMetadata
                        .CreateFromImage(ToVersion1_3(TestResources.ExpressionCompiler.WindowsData))
                        .GetReference(),
                    AssemblyMetadata
                        .CreateFromImage(
            ...
            WithRuntimeInstance(
                ...
                runtime =>
                {
                    ...
                    var aliases = ImmutableArray.Create(
                        VariableAlias(
                            "s",
                            "Windows.Storage.StorageFolder, Windows.Storage, Version=255.255.255.255, Culture=neutral, PublicKeyToken=null, ContentType=WindowsRuntime"
                        ),
                        VariableAlias(
                            "d",
                            "Windows.Foundation.DateTime, Windows.Foundation, Version=255.255.255.255, Culture=neutral, PublicKeyToken=null, ContentType=WindowsRuntime"
                        )
                    );
    ...
    static void M(Windows.UI.Xaml.FrameworkElement f)
    {
            ...
            WithRuntimeInstance(
                ...
                runtime =>
                {
                    ...
                    var expectedAssemblyIdentity = WinRtRefs
                        .Single(r => r.Display == "System.Runtime.WindowsRuntime.dll")
                        .GetAssemblyIdentity();
