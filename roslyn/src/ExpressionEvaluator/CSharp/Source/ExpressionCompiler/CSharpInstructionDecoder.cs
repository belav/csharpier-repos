...
namespace Microsoft.CodeAnalysis.CSharp.ExpressionEvaluator
{
          ...
          >
    {
        ...
        private static readonly SymbolDisplayFormat s_propertyDisplayFormat =
            DisplayFormat.AddMemberOptions(SymbolDisplayMemberOptions.IncludeParameters)
                ...
                switch (part.Kind)
                {
                    case SymbolDisplayPartKind.ClassName:
                        ...
                        else
                        {
                            ...
                            do
                            {
                                ...
                                i < numParts && parts[i].Kind != SymbolDisplayPartKind.MethodName
                            );
                            i--;
                        }
                        break;
                    ...
                    case SymbolDisplayPartKind.MethodName:
                        ...
                        int openBracketOffset,
                            closeBracketOffset;
                        if (
                            GeneratedNames.TryParseGeneratedName(
                                displayString,
                                out kind,
        ...
        internal override MethodSymbol ConstructMethod(
            MethodSymbol method,
        ...
        internal override CSharpCompilation GetCompilation(DkmClrModuleInstance moduleInstance)
        {
            ...
            var metadataBlocks = moduleInstance.RuntimeInstance
