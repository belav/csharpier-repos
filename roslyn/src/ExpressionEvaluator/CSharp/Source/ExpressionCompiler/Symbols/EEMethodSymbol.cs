...
namespace Microsoft.CodeAnalysis.CSharp.ExpressionEvaluator
{
    ...
    internal sealed class EEMethodSymbol : MethodSymbol
    {
        ...
        )
        {
            ...
            var allSourceTypeParameters =
                container.SourceTypeParameters.Concat(sourceMethodTypeParameters);
            ...
            try
            {
                ...
                if (body.Kind != BoundKind.ReturnStatement)
                {
                    statementsBuilder.Add(
                        new BoundReturnStatement(syntax, RefKind.None, expressionOpt: null)
                    );
                }
