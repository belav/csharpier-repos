...
#pragma warning restore RS0042 // Do not copy value
                ...
                qualifiedNameLength =
                    (
                        typeDef.Namespace.IsNil
                            ? 0
                            : _metadataReaderOpt.GetString(typeDef.Namespace).Length + 1
                ...
                qualifiedNameLength =
                    (
                        typeRef.Namespace.IsNil
                            ? 0
                            : _metadataReaderOpt.GetString(typeRef.Namespace).Length + 1
        ...
        public uint EnumCustomAttributes(
        ...
        public uint EnumFieldsWithName(
            ref uint handlePointerEnum,
            uint cl,
            string stringName,
        ...
        public uint EnumMembersWithName(
            ref uint handlePointerEnum,
            uint cl,
            string stringName,
        ...
        public unsafe uint EnumMethods(
            ref uint handlePointerEnum,
            uint cl,
            uint* arrayMethods,
            uint countMax
        ...
        public uint EnumMethodSemantics(
            ref uint handlePointerEnum,
            uint mb,
        ...
        public uint EnumMethodsWithName(
            ref uint handlePointerEnum,
            uint cl,
            string stringName,
        ...
        public uint EnumPermissionSets(
            ref uint handlePointerEnum,
            uint tk,
            uint dwordActions,
        ...
        public unsafe uint EnumProperties(
            ref uint handlePointerEnum,
            uint td,
        ...
        public unsafe uint GetCustomAttributeByName(
            uint tokenObj,
            string stringName,
            out void* ppData
        )
        ...
        public uint GetEventProps(
            uint ev,
            out uint pointerClass,
            StringBuilder stringEvent,
            uint cchEvent,
            out uint pchEvent,
        ...
        public unsafe uint GetFieldProps(
            uint mb,
            out uint pointerClass,
        ...
        public unsafe uint GetMemberProps(
            uint mb,
            out uint pointerClass,
            StringBuilder stringMember,
            uint cchMember,
            out uint pchMember,
            out uint pdwAttr,
            out byte* ppvSigBlob,
        ...
        public unsafe uint GetMemberRefProps(
            uint mr,
            ref uint ptk,
            StringBuilder stringMember,
            uint cchMember,
        ...
        public unsafe uint GetParamProps(
            uint tk,
            out uint pmd,
        ...
        public unsafe uint GetPermissionSetProps(
            uint pm,
            out uint pdwAction,
        ...
        public unsafe uint GetPropertyProps(
            uint prop,
            out uint pointerClass,
            StringBuilder stringProperty,
            uint cchProperty,
            out uint pchProperty,
            out uint pdwPropFlags,
            out byte* ppvSig,
            out uint bytePointerSig,
            out uint pdwCPlusTypeFlag,
            out void* ppDefaultValue,
