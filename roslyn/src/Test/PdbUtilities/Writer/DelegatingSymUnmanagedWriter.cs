...
namespace Roslyn.Test.PdbUtilities
{
    internal class DelegatingSymUnmanagedWriter : SymUnmanagedWriter
    {
        ...
        public override void OpenMethod(int methodToken) => _target.OpenMethod(methodToken);

        public override void OpenScope(int startOffset) => _target.OpenScope(startOffset);

        public override void OpenTokensToSourceSpansMap() => _target.OpenTokensToSourceSpansMap();
        ...
        public override void SetSourceLinkData(byte[] data) => _target.SetSourceLinkData(data);

        public override void SetSourceServerData(byte[] data) => _target.SetSourceServerData(data);
        ...
        public override void WriteTo(Stream stream) => _target.WriteTo(stream);
    }
}
