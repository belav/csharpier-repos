    ...
    internal partial class EditAndContinueTest<TSelf> : IDisposable
    {
        internal sealed class GenerationVerifier
        {
            ...
            public GenerationVerifier(
                ...
                ImmutableArray<MetadataReader> readers
            )
            {
                _ordinal = ordinal;
            ...
            internal void VerifyEncLogDefinitions(
                IEnumerable<EditAndContinueLogEntry>? expected = null
            )
            {
                AssertEx.Equal(
                    expected ?? Array.Empty<EditAndContinueLogEntry>(),
            ...
            public void VerifyUpdatedMethodNames(params string[] expectedMethodNames)
            {
                ...
                CheckNames(
                    _readers,
                    _generationInfo.CompilationDifference.EmitResult.UpdatedMethods,
                    expectedMethodNames
                );
            }
            ...
            public void VerifyChangedTypeNames(params string[] expectedTypeNames)
            {
                ...
                CheckNames(
                    _readers,
                    _generationInfo.CompilationDifference.EmitResult.ChangedTypes,
                    expectedTypeNames
                );
            }

            internal void VerifyMethodBody(
