    ...
    public class CSharpIntelliSense : AbstractEditorTest
    {
        ...
        public void AtNamespaceLevel(bool showCompletionInArgumentLists)
        {
            ...
            VisualStudio.Workspace
                .SetTriggerCompletionInArgumentLists(showCompletionInArgumentLists);
...
public static class NavigateTo
{
    ...
    public static void Navigate(int i){ }
            ...
            VisualStudio.Editor.Verify
                .CurrentLineText("NavigateTo.Search$$", assertCaretPosition: true);
        }
        ...
        public void CtrlAltSpace(bool showCompletionInArgumentLists)
        {
            ...
            VisualStudio.Editor.Verify
                .CurrentLineText("System.Console.WriteLine();$$", assertCaretPosition: true);
        ...
        public void CtrlAltSpaceOption(bool showCompletionInArgumentLists)
        {
            ...
            VisualStudio.Editor.Verify
                .CurrentLineText("namespace Goo$$", assertCaretPosition: true);
...
class Class1
{
    ...
    void Main(string[] args)
    {
            ...
            var currentIndex = Array.IndexOf(
                completionItems,
                VisualStudio.Editor.GetCurrentCompletionItem()
            );
            if (currentIndex != targetIndex)
            {
                var key = currentIndex < targetIndex ? VirtualKey.Down : VirtualKey.Up;
                var keys = Enumerable.Repeat(key, Math.Abs(currentIndex - targetIndex))
                    .Cast<object>()
                    .ToArray();
            ...
            VisualStudio.Editor.Verify
                .CurrentLineText("///<see cref=\"$$\"/>", assertCaretPosition: true);
        }
...
"
            ...
            VisualStudio.Editor.Verify
                .CurrentLineText("/// <summary>$$</summary>", assertCaretPosition: true);
...
class Class1
{
    void Main(string[] args)
    {
        $$
            ...
            VisualStudio.Editor.SendKeys('M', Shift(VirtualKey.Enter));
...
{{
    ...
    {{
        ...
        {variableName} = $$
            ...
            VisualStudio.Editor.SendKeys(VirtualKey.Delete, "aaa", VirtualKey.Tab);
            var actualText = VisualStudio.Editor.GetText();
            Assert.Contains($"{variableName} = {variableName}", actualText);
            Assert.True(VisualStudio.Editor.IsCaretOnScreen());
            Assert.True(
                VisualStudio.Editor.GetCaretColumn() > visibleColumns,
