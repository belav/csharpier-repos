...
";
        ...
        public void VerifyAvailableCodeActions()
        {
            ...
            VisualStudio.Editor.InvokeCodeActionList();
            VisualStudio.Editor.Verify
                .CodeAction("Add project reference to 'ClassLibrary3'.", applyFix: false);
        }
        ...
        public void InvokeSomeFixesInCSharpThenVerifyReferences()
        {
            ...
            VisualStudio.SolutionExplorer.Verify
                .AssemblyReferencePresent(
            ...
            VisualStudio.Editor.InvokeCodeActionList();
            VisualStudio.Editor.Verify
                .CodeAction("Add project reference to 'ClassLibrary3'.", applyFix: true);
            VisualStudio.SolutionExplorer.Verify
