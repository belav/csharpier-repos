...
namespace Microsoft.VisualStudio.IntegrationTest.Utilities.OutOfProcess
{
    public partial class SolutionExplorer_OutOfProc : OutOfProcComponent
    {
        ...
        public void AddPackageReference(
            ...
            ProjectUtils.PackageReference package
        ...
        /// instead.
        /// </summary>
        public string[] GetChildrenOfItem(string itemName) => _inProc.GetChildrenOfItem(itemName);
        ...
        public void ClearBuildOutputWindowPane() => _inProc.ClearBuildOutputWindowPane();

        public void WaitForBuildToFinish() => _inProc.WaitForBuildToFinish();
