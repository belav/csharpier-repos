...
namespace Roslyn.VisualStudio.NewIntegrationTests.CSharp
{
    public class CSharpInteractiveCommands : AbstractInteractiveWindowTest
    {
        ...
        public async Task VerifyPreviousAndNextHistory()
        {
            ...
            await TestServices.InteractiveWindow.WaitForLastReplInputAsync(
                "",
                HangMitigatingCancellationToken
            );
        ...
        public async Task CutDeletePasteSelectAll()
        {
            ...
            await TestServices.Shell.ExecuteCommandAsync(
                WellKnownCommands.Edit.Copy,
                HangMitigatingCancellationToken
            );
            await TestServices.Shell.ExecuteCommandAsync(
                WellKnownCommands.Edit.Cut,
                HangMitigatingCancellationToken
            );
            await TestServices.Shell.ExecuteCommandAsync(
                WellKnownCommands.Edit.Paste,
                HangMitigatingCancellationToken
            );
        ...
        public async Task VerifyReturnIndentCurrentLine()
        {
            ...
            Assert.Equal(
                12,
                (
                    await TestServices.InteractiveWindow.GetCaretPositionAsync(
                        HangMitigatingCancellationToken
                    )
                )
                    .BufferPosition
