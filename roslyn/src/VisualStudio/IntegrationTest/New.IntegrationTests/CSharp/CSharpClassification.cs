    ...
    public class Program
        {
            ...
            await TestServices
                .Editor
                .PlaceCaretAsync("{", charsOffset: 0, HangMitigatingCancellationToken);
            await TestServices
                .EditorVerifier
            ...
            await TestServices
                .Editor
                .PlaceCaretAsync("Main", charsOffset: 0, HangMitigatingCancellationToken);
            await TestServices
                .EditorVerifier
                .CurrentTokenTypeAsync(tokenType: "method name", HangMitigatingCancellationToken);
            await TestServices
                .Editor
                .PlaceCaretAsync("Hello", charsOffset: 0, HangMitigatingCancellationToken);
            await TestServices
                .EditorVerifier
            ...
            await TestServices
                .Editor
                .PlaceCaretAsync("summary", charsOffset: 0, HangMitigatingCancellationToken);
            await TestServices
                .EditorVerifier
                .CurrentTokenTypeAsync(
            ...
            await TestServices
                .Editor
                .PlaceCaretAsync("innertext", charsOffset: 0, HangMitigatingCancellationToken);
            await TestServices
                .EditorVerifier
                .CurrentTokenTypeAsync(
            ...
            await TestServices
                .Editor
                .PlaceCaretAsync("comment", charsOffset: 0, HangMitigatingCancellationToken);
            await TestServices
                .EditorVerifier
                .CurrentTokenTypeAsync(
            ...
            await TestServices
                .Editor
                .PlaceCaretAsync("CDATA", charsOffset: 0, HangMitigatingCancellationToken);
            await TestServices
                .EditorVerifier
                .CurrentTokenTypeAsync(
                    tokenType: "xml doc comment - delimiter",
            ...
            await TestServices
                .Editor
                .PlaceCaretAsync("attribute", charsOffset: 0, HangMitigatingCancellationToken);
            await TestServices
                .EditorVerifier
...
class Program : Attribute
{
    static void Main(string[] args)
    {
        ...
        Program.Main(null);
            ...
            await TestServices
                .Editor
                .PlaceCaretAsync("list", charsOffset: 8, HangMitigatingCancellationToken);
            await TestServices
                .EditorVerifier
                .CurrentTokenTypeAsync(tokenType: "class name", HangMitigatingCancellationToken);
            await TestServices
            ...
            await TestServices
                .Editor
                .PlaceCaretAsync("null", charsOffset: -8, HangMitigatingCancellationToken);
            await TestServices
                .EditorVerifier
                .CurrentTokenTypeAsync(tokenType: "class name", HangMitigatingCancellationToken);
            ...
            await TestServices
                .Editor
                .DeleteTextAsync(@"using System;", HangMitigatingCancellationToken);
            await TestServices
                .Editor
                .DeleteTextAsync(
                    @"using System.Collections.Generic;",
...
",
            ...
            await TestServices
                .Editor
                .PlaceCaretAsync("Goo", charsOffset: 0, HangMitigatingCancellationToken);
            await TestServices
                .EditorVerifier
                .CurrentTokenTypeAsync(tokenType: "method name", HangMitigatingCancellationToken);
            await TestServices
                .Editor
                .PlaceCaretAsync("Bar", charsOffset: 0, HangMitigatingCancellationToken);
            await TestServices
                .EditorVerifier
                .CurrentTokenTypeAsync(tokenType: "excluded code", HangMitigatingCancellationToken);
            await TestServices.Editor.MoveCaretAsync(0, HangMitigatingCancellationToken);
            await TestServices
                .Shell
                .ExecuteCommandAsync(
