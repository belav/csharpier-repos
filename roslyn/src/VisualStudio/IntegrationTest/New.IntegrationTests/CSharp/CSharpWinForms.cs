...
namespace Roslyn.VisualStudio.NewIntegrationTests.CSharp
{
    ...
    public class CSharpWinForms : AbstractEditorTest
    {
        ...
        public async Task AddControl()
        {
            ...
            await TestServices.SolutionExplorer.OpenFileWithDesignerAsync(
                project,
                "Form1.cs",
                HangMitigatingCancellationToken
            );
            await TestServices.Editor.AddWinFormButtonAsync(
                "SomeButton",
                HangMitigatingCancellationToken
            );
            await TestServices.SolutionExplorer.SaveFileAsync(
                project,
                "Form1.cs",
                HangMitigatingCancellationToken
            );
        ...
        public async Task ChangeControlProperty()
        {
            ...
            await TestServices.SolutionExplorer.CloseDesignerFileAsync(
                project,
                "Form1.cs",
                saveFile: true,
                HangMitigatingCancellationToken
        ...
        public async Task ChangeControlPropertyInCode()
        {
            ...
            await TestServices.Editor.EditWinFormButtonPropertyAsync(
                buttonName: "SomeButton",
                propertyName: "Text",
                propertyValue: "ButtonTextGoesHere",
                HangMitigatingCancellationToken
            );
            var expectedPropertyValue = "ButtonTextGoesHere";
            var actualPropertyValue = await TestServices.Editor.GetWinFormButtonPropertyValueAsync(
                buttonName: "SomeButton",
                propertyName: "Text",
                HangMitigatingCancellationToken
            );
            ...
            actualPropertyValue = await TestServices.Editor.GetWinFormButtonPropertyValueAsync(
                buttonName: "SomeButton",
                propertyName: "Text",
                HangMitigatingCancellationToken
            );
        ...
        public async Task AddClickHandler()
        {
            ...
            await TestServices.Editor.EditWinFormButtonEventAsync(
                buttonName: "SomeButton",
                eventName: "Click",
            ...
            var designerActualText = await TestServices.Editor.GetTextAsync(
                HangMitigatingCancellationToken
            );
            Assert.Contains(
            ...
            var codeFileActualText = await TestServices.Editor.GetTextAsync(
                HangMitigatingCancellationToken
            );
            Assert.Contains(
                @"    public partial class Form1 : Form
    {
        ...
        public async Task RenameControl()
        {
            ...
            await TestServices.Editor.EditWinFormButtonEventAsync(
                buttonName: "SomeButton",
                eventName: "Click",
                eventHandlerName: "SomeButtonHandler",
                HangMitigatingCancellationToken
            );
            // Rename the control
            await TestServices.Editor.EditWinFormButtonPropertyAsync(
            ...
            Assert.Contains(
                @"this.SomeNewButton.Click += new System.EventHandler(this.SomeButtonHandler);",
                actualText
            );
        ...
        public async Task DeleteControl()
        {
            ...
            await TestServices.Editor.DeleteWinFormButtonAsync(
                "SomeButton",
                HangMitigatingCancellationToken
            );
