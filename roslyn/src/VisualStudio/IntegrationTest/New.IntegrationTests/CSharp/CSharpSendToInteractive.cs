...
",
        ...
        public async Task ExecuteSingleLineSubmissionInInteractiveWhilePreservingReplSubmissionBuffer()
        {
            ...
            await TestServices.InteractiveWindow.WaitForLastReplInputContainsAsync(
                "// scenario 5",
                HangMitigatingCancellationToken
            );
        ...
        public async Task ResetInteractiveFromProjectAndVerify()
        {
            ...
            var project = ProjectName;
            await TestServices.SolutionExplorer.AddMetadataReferenceAsync(
                assembly,
                project,
                HangMitigatingCancellationToken
            );

            await TestServices.SolutionExplorer.SelectItemAsync(
                ProjectName,
                HangMitigatingCancellationToken
            );
            await TestServices.Shell.ExecuteCommandAsync(
            ...
            await TestServices.InteractiveWindow.WaitForReplOutputAsync(
                "using TestProj;",
                HangMitigatingCancellationToken
            );
