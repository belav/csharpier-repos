...
namespace Roslyn.VisualStudio.NewIntegrationTests.CSharp
{
    public class CSharpReplIdeFeatures : AbstractInteractiveWindowTest
    {
        ...
        public async Task VerifyCodeActionsNotAvailableInPreviousSubmission()
        {
            ...
            await TestServices.InteractiveWindowVerifier.CodeActionsNotShowingAsync(
                HangMitigatingCancellationToken
            );
        }
        ...
        public async Task VerifyQuickInfoOnStringDocCommentsFromMetadata()
        {
            ...
            await TestServices.InteractiveWindow.PlaceCaretAsync(
                "[]",
                charsOffset: -2,
                HangMitigatingCancellationToken
            );
            await TestServices.InteractiveWindow.InvokeQuickInfoAsync(
                HangMitigatingCancellationToken
            );
            var s = await TestServices.InteractiveWindow.GetQuickInfoAsync(
                HangMitigatingCancellationToken
            );
...
العربية func = () => System.Console.WriteLine(2);",
        ...
        public async Task HighlightRefsSingleSubmissionVerifyRenameTagsShowUpWhenInvokedOnUnsubmittedText()
        {
            ...
            await TestServices.InteractiveWindow.VerifyTagsAsync<WrittenReferenceHighlightTag>(
                2,
                HangMitigatingCancellationToken
            );
            await TestServices.InteractiveWindow.VerifyTagsAsync<DefinitionHighlightTag>(
                1,
                HangMitigatingCancellationToken
            );
        }
        ...
        public async Task HighlightRefsSingleSubmissionVerifyRenameTagsGoAway()
        {
            ...
            await TestServices.InteractiveWindow.VerifyTagsAsync<ReferenceHighlightTag>(
                0,
                HangMitigatingCancellationToken
            );
            await TestServices.InteractiveWindow.VerifyTagsAsync<WrittenReferenceHighlightTag>(
                ...
                @"public class Class
{
    ...
    public void Method(int x)
    {
         int abc = 1 + 1;
            ...
            Assert.False(
                await TestServices.Shell.IsCommandAvailableAsync(
        ...
        public async Task AddUsing()
        {
            ...
            await TestServices.InteractiveWindow.InvokeCodeActionListAsync(
                HangMitigatingCancellationToken
            );
