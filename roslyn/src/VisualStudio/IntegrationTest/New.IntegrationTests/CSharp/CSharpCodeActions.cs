...
public class P2 { }",
            ...
            await TestServices
                .Input
                .SendAsync(
                    new InputKey[] { VirtualKeyCode.BACK, VirtualKeyCode.BACK, "Stream" },
                    HangMitigatingCancellationToken
                );
            await TestServices
                .Workspace
        ...
        [
            IdeFact(Skip = "https://github.com/dotnet/roslyn/issues/57423"),
    ...
    public class P2
    {
        static void Main(string[] args)
        {
            ...
            await TestServices
                .Input
                .SendAsync(
                    new InputKey[] { VirtualKeyCode.BACK, VirtualKeyCode.BACK, "Foober" },
                    HangMitigatingCancellationToken
                );
            await TestServices
                .Workspace
