...
class C {
    $$
            ...
            await TestServices.Input.SendWithoutActivateAsync(
                new InputKey[] { VirtualKeyCode.RETURN, '{', VirtualKeyCode.RETURN, '}' },
                HangMitigatingCancellationToken
            );
...
class C {
    void Goo() {
        $$
            ...
            await TestServices.Input.SendWithoutActivateAsync(
                new InputKey[] { "if (true) {", VirtualKeyCode.RETURN, "var a = 1;", },
                HangMitigatingCancellationToken
            );
...
class C {
    void Goo() {
        ...
        )
        {
            ...
            await TestServices.Input.SendWithoutActivateAsync(
                new InputKey[] { "class A { int i;", VirtualKeyCode.RETURN, },
                HangMitigatingCancellationToken
            );
...
class C {
    $$
            ...
            await TestServices.Input.SendWithoutActivateAsync(
                new InputKey[] { "int x", VirtualKeyCode.TAB },
                HangMitigatingCancellationToken
            );
            await TestServices.EditorVerifier.CurrentLineTextAsync(
                "    void Goo(int x)$$",
...
class C {
    $$
            ...
            await TestServices.Input.SendWithoutActivateAsync(
                new InputKey[] { "void Goo(", VirtualKeyCode.ESCAPE, ")", },
                HangMitigatingCancellationToken
            );
...
class C {
    $$
            ...
            await TestServices.Input.SendWithoutActivateAsync(
                new InputKey[] { "string str = \"", VirtualKeyCode.TAB },
                HangMitigatingCancellationToken
            );
            await TestServices.EditorVerifier.CurrentLineTextAsync(
                "    string str = \"\"$$",
...
class C {
    $$
            ...
            await TestServices.Input.SendWithoutActivateAsync(
                new InputKey[] { "string str = \"Hi Roslyn!", '"' },
                HangMitigatingCancellationToken
            );
            await TestServices.EditorVerifier.CurrentLineTextAsync(
        ...
        [IdeTheory, CombinatorialData]
        public async Task DoubleQuote_FixedInterpolatedVerbatimString(
            bool showCompletionInArgumentLists
        )
        {
            await SetUpEditorAsync(
...
class C {
    ...
    $$
            ...
            await TestServices.Input.SendWithoutActivateAsync(
                new InputKey[] { "System.Action<", VirtualKeyCode.TAB },
                HangMitigatingCancellationToken
            );
            await TestServices.EditorVerifier.CurrentLineTextAsync(
                "    System.Action<>$$",
...
class C {
    ...
    $$
            ...
            await TestServices.Input.SendWithoutActivateAsync(
                new InputKey[] { "void GenericMethod<", VirtualKeyCode.TAB },
                HangMitigatingCancellationToken
            );
            await TestServices.EditorVerifier.CurrentLineTextAsync(
                "    void GenericMethod<>$$",
...
",
            ...
            await TestServices.Input.SendWithoutActivateAsync(
                new InputKey[] { "class GenericClass<", '>' },
                HangMitigatingCancellationToken
            );
            await TestServices.EditorVerifier.CurrentLineTextAsync(
                "class GenericClass<>$$",
...
class C {
    $$
            ...
            await TestServices.Input.SendWithoutActivateAsync(
                new InputKey[] { VirtualKeyCode.DELETE, VirtualKeyCode.BACK },
                HangMitigatingCancellationToken
            );
            await TestServices.Input.SendWithoutActivateAsync(
                new InputKey[] { "'\u6666", "'" },
...
class Bar<U>
{
    ...
    void M()
    {
        $$
            ...
            {
                Assert.False(
                    await TestServices.Editor.IsCompletionActiveAsync(
                        HangMitigatingCancellationToken
                    )
                );
            }
...
class C {
    $$
            ...
            await TestServices.Input.SendWithoutActivateAsync(
                new InputKey[] { VirtualKeyCode.END, ';', VirtualKeyCode.RETURN },
                HangMitigatingCancellationToken
            );
...
",
            ...
            {
                await TestServices.Input.SendWithoutActivateAsync(
                    new InputKey[] { "(", VirtualKeyCode.TAB },
                    HangMitigatingCancellationToken
                );
            }
...
",
            ...
            await TestServices.Input.SendWithoutActivateAsync(
                new InputKey[] { VirtualKeyCode.RETURN, "int Prop {", },
                HangMitigatingCancellationToken
            );
            await TestServices.EditorVerifier.TextContainsAsync(
                @"
...
class C {
    void Goo() {
        $$
            ...
            await TestServices.Input.SendWithoutActivateAsync(
                new InputKey[] { "if (true)", VirtualKeyCode.RETURN, "{", },
                HangMitigatingCancellationToken
            );
            await TestServices.EditorVerifier.CurrentLineTextAsync(
                "        { $$}",
