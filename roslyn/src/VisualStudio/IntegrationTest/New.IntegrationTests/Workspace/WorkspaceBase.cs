...
End Class",
        ...
        public virtual async Task MetadataReference()
        {
            ...
            await TestServices.SolutionExplorer.RemoveDllReferenceAsync(
                "TestProj",
        ...
        public async Task ProjectReference()
        {
            ...
            await TestServices.SolutionExplorer.RemoveProjectReferenceAsync(
                csProj2,
...
End Module",
            ...
            await TestServices.Editor.InvokeQuickInfoAsync(HangMitigatingCancellationToken);
            quickInfo = await TestServices.Editor.GetQuickInfoAsync(
                HangMitigatingCancellationToken
            );
        ...
        public async Task RenamingOpenFiles()
        {
            ...
            var navBarItems = await TestServices.Editor.GetNavigationBarItemsAsync(
                Microsoft.CodeAnalysis.Editor.NavigationBarDropdownKind.Project,
                HangMitigatingCancellationToken
            );
            ...
            // ...and after.
            navBarItems = await TestServices.Editor.GetNavigationBarItemsAsync(
                Microsoft.CodeAnalysis.Editor.NavigationBarDropdownKind.Project,
                HangMitigatingCancellationToken
            );
            Assert.Contains(ProjectName, navBarItems);
        ...
        public virtual async Task RenamingOpenFilesViaDTE()
        {
            ...
            await TestServices.SolutionExplorer.RenameFileViaDTEAsync(
                ProjectName,
                "BeforeRename.cs",
                "AfterRename.cs",
                HangMitigatingCancellationToken
