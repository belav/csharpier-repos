...
",
            ...
            await TestServices.GenerateTypeDialog.SetAccessibilityAsync(
                "Public",
                HangMitigatingCancellationToken
            );
            await TestServices.GenerateTypeDialog.SetKindAsync(
                "Structure",
                HangMitigatingCancellationToken
            );
            await TestServices.GenerateTypeDialog.SetTargetProjectAsync(
                csProj,
                HangMitigatingCancellationToken
            );
            await TestServices.GenerateTypeDialog.SetTargetFileToNewNameAsync(
                "GenerateTypeTest.cs",
                HangMitigatingCancellationToken
            );
            await TestServices.GenerateTypeDialog.ClickOKAsync(HangMitigatingCancellationToken);
            await TestServices.GenerateTypeDialog.VerifyClosedAsync(
                HangMitigatingCancellationToken
            );
...
",
            ...
            var folders = await TestServices.GenerateTypeDialog.GetNewFileComboBoxItemsAsync(
                HangMitigatingCancellationToken
            );
