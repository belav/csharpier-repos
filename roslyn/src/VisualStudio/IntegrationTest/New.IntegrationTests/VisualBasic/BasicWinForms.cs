    ...
    public class BasicWinForms : AbstractEditorTest
    {
        ...
        public async Task TestMyIntelliSense()
        {
            ...
            await TestServices.SolutionExplorer
                .OpenFileAsync(project, "Form1.vb", HangMitigatingCancellationToken);
...
End Class",
        ...
        public async Task AddControl()
        {
            var project = ProjectName;
            await TestServices.SolutionExplorer
                .OpenFileWithDesignerAsync(project, "Form1.vb", HangMitigatingCancellationToken);
            await TestServices.Editor
                .AddWinFormButtonAsync("SomeButton", HangMitigatingCancellationToken);
            await TestServices.SolutionExplorer
                .SaveFileAsync(project, "Form1.vb", HangMitigatingCancellationToken);
            await TestServices.SolutionExplorer
            ...
            await TestServices.SolutionExplorer
                .OpenFileAsync(project, "Form1.Designer.vb", HangMitigatingCancellationToken);
        ...
        public async Task RenameControl()
        {
            ...
            await TestServices.SolutionExplorer
                .OpenFileAsync(project, "Form1.Designer.vb", HangMitigatingCancellationToken);
            var formDesignerActualText = await TestServices.Editor
                .GetTextAsync(HangMitigatingCancellationToken);
            ...
            await TestServices.SolutionExplorer
                .OpenFileAsync(project, "Form1.vb", HangMitigatingCancellationToken);
            var formActualText = await TestServices.Editor
                .GetTextAsync(HangMitigatingCancellationToken);
            Assert.Contains(
            ...
            await TestServices.Input
                .SendAsync(
                    ["AnotherNewButton", VirtualKeyCode.RETURN],
                    HangMitigatingCancellationToken
                );
            formActualText = await TestServices.Editor
                .GetTextAsync(HangMitigatingCancellationToken);
            Assert.Contains(
