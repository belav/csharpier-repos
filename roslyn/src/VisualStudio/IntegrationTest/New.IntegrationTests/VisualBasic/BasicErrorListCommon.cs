...
",
            ...
            await TestServices.ErrorList.NavigateToErrorListItemAsync(
                0,
                isPreview: false,
                shouldActivate: true,
                HangMitigatingCancellationToken
        ...
        [IdeFact(
            Skip = "https://github.com/dotnet/roslyn/issues/63981 and https://github.com/dotnet/roslyn/issues/63982"
        )]
...
",
            ...
            var actualErrors = await TestServices.ErrorList.GetBuildErrorsAsync(
                HangMitigatingCancellationToken
            );
