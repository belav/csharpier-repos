...
namespace Roslyn.VisualStudio.IntegrationTests.InProcess
{
    public static class DialogHelpers
    {
        ...
        /// found.
        /// </summary>
        public static async Task<IUIAutomationElement> GetOpenDialogByIdAsync(
        ...
        {
            var dialogAutomationElement = await FindDialogByAutomationIdAsync(
                joinableTaskFactory,
                visualStudioHWnd,
                dialogAutomationId,
                isOpen: true,
        ...
        public static async Task<IUIAutomationElement> FindDialogByAutomationIdAsync(
            JoinableTaskFactory joinableTaskFactory,
            IntPtr visualStudioHWnd,
            string dialogAutomationId,
            bool isOpen,
        ...
        /// </summary>
        public static async Task<IUIAutomationElement> FindDialogByNameAsync(
            JoinableTaskFactory joinableTaskFactory,
            IntPtr visualStudioHWnd,
            string dialogName,
            bool isOpen,
        ...
        {
            var dialogAutomationElement = await GetOpenDialogByIdAsync(
                joinableTaskFactory,
                visualStudioHWnd,
                dialogAutomationId,
                cancellationToken
        ...
        {
            var dialogAutomationElement = await FindDialogByNameAsync(
                joinableTaskFactory,
                visualStudioHWnd,
                dialogName,
                isOpen: true,
