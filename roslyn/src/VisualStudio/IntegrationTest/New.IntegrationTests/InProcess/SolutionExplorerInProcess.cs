...
namespace Microsoft.VisualStudio.Extensibility.Testing
{
    internal partial class SolutionExplorerInProcess
    {
        ...
        public async Task SetProjectInferAsync(
            string projectName,
            bool value,
            CancellationToken cancellationToken
        )
        ...
        public async Task AddAnalyzerReferenceAsync(
            string projectName,
            string filePath,
            CancellationToken cancellationToken
        )
        ...
        public async Task AddDllReferenceAsync(
            string projectName,
            string filePath,
            CancellationToken cancellationToken
        )
        ...
        public Task RemoveDllReferenceAsync(
            string projectName,
            string assemblyName,
            CancellationToken cancellationToken
        )
        ...
        public async Task AddMetadataReferenceAsync(
            string assemblyName,
            string projectName,
            CancellationToken cancellationToken
        )
        ...
        )
        {
            ...
            throw new InvalidOperationException(
                $"Could not find reference {referenceName} to remove"
            );
        }
        ...
        )
        {
            ...
            _ = await GetRequiredGlobalServiceAsync<SVsShellDebugger, IVsDebugger>(
                cancellationToken
            );
        ...
        public async Task AddCustomProjectAsync(
            string projectName,
        ...
        )
        {
            ...
            ErrorHandler.ThrowOnFailure(
                solution.AddExistingProject(projectFilePath, pParent: null, out _)
            );
        }
        ...
        )
        {
            ...
            SaveFileWithExtraValidation(
                await GetOpenDocumentAsync(JoinableTaskFactory, dte, filePath, cancellationToken)
            );

            static async Task<EnvDTE.Document> GetOpenDocumentAsync(
        ...
        )
        {
            ...
            await Helper.RetryAsync(
                async cancellationToken =>
                {
                    try
                    {
                        return await solutionRestoreStatusProvider.IsRestoreCompleteAsync(
                            cancellationToken
                        );
                    }
        ...
        public async Task CloseDesignerFileAsync(
            string projectName,
            string relativeFilePath,
            bool saveFile,
            CancellationToken cancellationToken
        ...
        /// </summary>
        /// <param name="fileName">The name of the file to add.</param>
        public async Task AddStandaloneFileAsync(
            string fileName,
            CancellationToken cancellationToken
        )
        {
        ...
        {
            await JoinableTaskFactory.SwitchToMainThreadAsync(cancellationToken);
            var projectItem = await GetProjectItemAsync(
                projectName,
                oldFileName,
                cancellationToken
            );
        ...
        private async Task<EnvDTE.ProjectItem> GetProjectItemAsync(
            string projectName,
            string relativeFilePath,
            CancellationToken cancellationToken
        )
        ...
        public async Task SetFileContentsAsync(
            string projectName,
            string relativeFilePath,
            string content,
            CancellationToken cancellationToken
        ...
        )> GetSolutionInfoAsync(CancellationToken cancellationToken)
        {
            await JoinableTaskFactory.SwitchToMainThreadAsync(cancellationToken);
            ...
            ErrorHandler.ThrowOnFailure(
                solution.GetSolutionInfo(
                    ...
                    out var solutionFileFullPath,
                    out var userOptionsFile
                )
            );
        ...
        public async Task<string> BuildSolutionAndWaitAsync(CancellationToken cancellationToken)
        {
            ...
            var wpfTextViewHost = await textView.GetTextViewHostAsync(
                JoinableTaskFactory,
                cancellationToken
            );
        ...
        )
        {
            ...
            var outputWindow = await GetRequiredGlobalServiceAsync<
                SVsOutputWindow,
                IVsOutputWindow
            >(cancellationToken);
            ErrorHandler.ThrowOnFailure(
        ...
        {
            var (solutionDirectory, solutionFileFullPath, _) = await GetSolutionInfoAsync(
                cancellationToken
            );
    ...
    internal sealed class UpdateSolutionEvents : IVsUpdateSolutionEvents, IDisposable
    {
        ...
        internal UpdateSolutionEvents(IVsSolutionBuildManager2 solutionBuildManager)
        {
            ...
            ErrorHandler.ThrowOnFailure(
                solutionBuildManager.AdviseUpdateSolutionEvents(this, out _cookie)
            );
        }
        ...
        void IDisposable.Dispose()
        {
            ...
            if (_cookie != 0)
            {
                ...
                _cookie = 0;
                ErrorHandler.ThrowOnFailure(
                    _solutionBuildManager.UnadviseUpdateSolutionEvents(tempCookie)
                );
            }
        }
    }
