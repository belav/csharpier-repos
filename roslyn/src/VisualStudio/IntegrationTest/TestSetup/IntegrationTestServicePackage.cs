...
namespace Microsoft.VisualStudio.IntegrationTest.Setup
{
    ...
    {
        private static readonly Guid s_compilerPackage = new Guid(
            "31C0675E-87A4-4061-A0DD-A4E510FCCF97"
        );
        ...
        )
        {
            ...
            ErrorHandler.ThrowOnFailure(
                shell.IsPackageInstalled(s_compilerPackage, out var installed)
            );
            if (installed != 0)
            {
