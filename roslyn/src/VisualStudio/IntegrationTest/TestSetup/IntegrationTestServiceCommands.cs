...
#pragma warning restore IDE0052 // Remove unread private members
        ...
        private IntegrationTestServiceCommands(Package package)
        {
            ...
            _runningDocumentTable = (IVsRunningDocumentTable)
        ...
        private void StartServiceCallback(object sender, EventArgs e)
        {
            if (_startMenuCmd.Enabled)
            {
                ...
                _ = Task.Run(async () =>
                {
                    ...
                    var asyncCompletionTracker =
                        componentModel.GetService<AsyncCompletionTracker>();
...
#pragma warning restore RS0030 // Do not used banned APIs
                    ...
                    ErrorHandler.ThrowOnFailure(
                        _runningDocumentTable.AdviseRunningDocTableEvents(
            ...
            if (_stopMenuCmd.Enabled)
            {
                ...
                ErrorHandler.ThrowOnFailure(
                    _runningDocumentTable.UnadviseRunningDocTableEvents(
                        s_runningDocTableEventListenerCookie
                    )
                );
        ...
        private static void SwapAvailableCommands(
