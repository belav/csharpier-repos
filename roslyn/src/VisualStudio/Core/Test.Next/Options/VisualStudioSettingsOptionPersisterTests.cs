...
public class VisualStudioSettingsOptionPersisterTests
{
                                            ...
                                            : optionType == typeof(NamingStylePreferences)
                                                ...
                                                : optionType == typeof(CodeStyleOption2<bool>)
                                                    ...
                                                    : optionType == typeof(ImmutableArray<bool>)
                                                        ...
                                                        : optionType == typeof(ImmutableArray<int>)
                                                            ? (
    ...
    private static Type GetStorageType(Type optionType) =>
        optionType.IsEnum
            ? typeof(int)
            : (Nullable.GetUnderlyingType(optionType)?.IsEnum == true)
                ? typeof(int?)
                : optionType == typeof(NamingStylePreferences)
                    ? typeof(string)
                    : typeof(ICodeStyleOption2).IsAssignableFrom(optionType)
                        ? typeof(string)
    ...
    )
    {
        ...
        {
            GetValueImpl = (_, type) =>
                (type == storageType ? specializedTypeResult : GetValueResult.Success, storageValue)
        };
