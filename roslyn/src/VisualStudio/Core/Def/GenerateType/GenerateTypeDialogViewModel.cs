...
namespace Microsoft.VisualStudio.LanguageServices.Implementation.GenerateType
{
    internal class GenerateTypeDialogViewModel : AbstractNotifyPropertyChanged
    {
        ...
        {
            get { return _accessSelectIndex; }
            set { SetProperty(ref _accessSelectIndex, value); }
        }

        private string _selectedAccessibilityString;
        public string SelectedAccessibilityString
        {
            get { return _selectedAccessibilityString; }
            set { SetProperty(ref _selectedAccessibilityString, value); }
        }
        ...
        public Accessibility SelectedAccessibility
        {
            ...
            {
                Debug.Assert(
                    _accessListMap.ContainsKey(SelectedAccessibilityString),
                    "The Accessibility Key String not present"
                );
        ...
        {
            get { return _kindList; }
            set { SetProperty(ref _kindList, value); }
        }

        private int _kindSelectIndex;
        public int KindSelectIndex
        {
            get { return _kindSelectIndex; }
            set { SetProperty(ref _kindSelectIndex, value); }
        }

        private string _selectedTypeKindString;
        public string SelectedTypeKindString
        {
            get { return _selectedTypeKindString; }
            set { SetProperty(ref _selectedTypeKindString, value); }
        }
        ...
        public TypeKind SelectedTypeKind
        {
            ...
            {
                Debug.Assert(
                    _typeKindMap.ContainsKey(SelectedTypeKindString),
            ...
            if (this.IsNewFile)
            {
                ...
                if (isRootOfTheProject || this.SelectedProject != _document.Project)
                {
                    if (
                        !TryGetImplicitFilePath(
                            this.SelectedProject.FilePath ?? string.Empty,
                ...
                if (lastIndexOfSeparatorInFullPath != -1)
                {
                    ...
                    this.FullFilePath = string.Join(
                        "\\",
                        fileNameInFullPathInContainers.Select(str => str.Trim())
                    );
                }
                ...
                if (this.FullFilePath.StartsWith(projectRootPath, StringComparison.Ordinal))
                {
                    ...
                    var containers = folderPath.Split(
                        new[] { '\\' },
                        StringSplitOptions.RemoveEmptyEntries
                    );
                    ...
                    if (containers.Length > 1)
                    {
                        ...
                        if (
                            Folders.Any(
                                folder =>
                                    !(
                                        _syntaxFactsService.IsValidIdentifier(folder)
        ...
        private bool TryGetImplicitFilePath(
        ...
        public Project SelectedProject
        {
            ...
            set
            {
                ...
                if (SetProperty(ref _selectedProject, value))
                {
                    ...
                    this.ProjectSelectIndex = this.ProjectList.FindIndex(
                    ...
                    if (_selectedProject != _document.Project)
                    {
                        ...
                        this.AccessSelectIndex =
                            this.AccessList.IndexOf("public") == -1
                                ? this.AccessList.IndexOf("Public")
                                : this.AccessList.IndexOf("public");
                    ...
                    {
                        this.ProjectFolders = _projectManagementService.GetFolders(
                            this.SelectedProject.Id,
                            this.SelectedProject.Solution.Workspace
                        );
                    }
        ...
        {
            get { return _projectSelectIndex; }
            set { SetProperty(ref _projectSelectIndex, value); }
        }
        ...
        public IEnumerable<DocumentSelectItem> DocumentList
        {
            get
            {
                ...
                if (_selectedProject == _document.Project)
                {
                    ...
                    _previouslyPopulatedDocumentList.Add(
                        new DocumentSelectItem(_document, "<Current File>")
                    );
                ...
                this.IsExistingFileEnabled =
                    _previouslyPopulatedDocumentList.Count == 0 ? false : true;
        ...
        {
            get { return _isExistingFileEnabled; }
            set { SetProperty(ref _isExistingFileEnabled, value); }
        }

        private int _documentSelectIndex;
        public int DocumentSelectIndex
        {
            get { return _documentSelectIndex; }
            set { SetProperty(ref _documentSelectIndex, value); }
        }
        ...
        public bool IsNewFile
        {
            ...
            set { SetProperty(ref _isNewFile, value); }
        }
        ...
        {
            get { return _isAccessListEnabled; }
            set { SetProperty(ref _isAccessListEnabled, value); }
        }
        ...
        internal void UpdateFileNameExtension()
        {
            ...
            )
            {
                ...
                {
                    // For CSharp
                    currentFileName = UpdateExtension(
                        currentFileName,
                        _csharpExtension,
                        _visualBasicExtension
                    );
                }
                else
                {
        ...
        public class ProjectSelectItem
        {
            ...
            public ProjectSelectItem(Project project) => _project = project;
        }
