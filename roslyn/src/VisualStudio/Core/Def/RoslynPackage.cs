...
namespace Microsoft.VisualStudio.LanguageServices.Setup
{
    ...
    internal sealed class RoslynPackage : AbstractPackage
    {
        ...
        protected override async Task LoadComponentsAsync(CancellationToken cancellationToken)
        {
            ...
            this.ComponentModel.GetService<AnalyzerConfigDocumentAsSolutionItemHandler>()
                .Initialize(this);
        ...
        private async Task LoadInteractiveMenusAsync(CancellationToken cancellationToken)
        {
            ...
            await new CSharpResetInteractiveMenuCommand(
                ...
                ComponentModel
            ).InitializeResetInteractiveFromProjectCommandAsync().ConfigureAwait(true);
        ...
        private void DisposeVisualStudioServices()
        {
            if (_workspace != null)
            {
                _workspace.Services.GetRequiredService<VisualStudioMetadataReferenceManager>()
