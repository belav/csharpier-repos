...
namespace Microsoft.VisualStudio.LanguageServices.Setup
{
    ...
    internal sealed class RoslynPackage : AbstractPackage
    {
        ...
        )
        {
            ...
            var telemetryService = (VisualStudioWorkspaceTelemetryService)_workspace.Services
        ...
        private async Task LoadComponentsBackgroundAsync(CancellationToken cancellationToken)
        {
            ...
            var experiments = this.ComponentModel.DefaultExportProvider
                .GetExportedValues<IExperiment>();
        ...
        private void TrackBulkFileOperations()
        {
            ...
            var globalNotificationService = _workspace.Services
