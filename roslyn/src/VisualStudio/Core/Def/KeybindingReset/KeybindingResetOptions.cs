...
namespace Microsoft.VisualStudio.LanguageServices.KeybindingReset
{
    internal sealed class KeybindingResetOptions
    {
        ...
        public static readonly Option2<bool> NeedsReset =
            new("KeybindingResetOptions_NeedsReset", defaultValue: false);
        public static readonly Option2<bool> NeverShowAgain =
            new("KeybindingResetOptions_NeverShowAgain", defaultValue: false);
        public static readonly Option2<bool> EnabledFeatureFlag =
            new("KeybindingResetOptions_EnabledFeatureFlag", defaultValue: false);
    }
}
