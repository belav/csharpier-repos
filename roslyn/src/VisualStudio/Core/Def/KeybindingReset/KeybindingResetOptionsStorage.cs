...
namespace Microsoft.VisualStudio.LanguageServices.KeybindingReset
{
    internal sealed class KeybindingResetOptionsStorage
    {
        ...
        public static readonly Option2<bool> NeedsReset =
            new("visual_studio_key_binding_needs_reset", defaultValue: false);
        public static readonly Option2<bool> NeverShowAgain =
            new("visual_studio_key_binding_reset_never_show_again", defaultValue: false);
        public static readonly Option2<bool> EnabledFeatureFlag =
            new("visual_studio_enable_key_binding_reset", defaultValue: false);
    }
}
