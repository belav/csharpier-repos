...
namespace Microsoft.VisualStudio.LanguageServices
{
    internal static partial class ID
    {
        ...
        public static class CSharpCommands
        {
            ...
            public const int SmartTagPartialMatchForUnboundItemMin =
                SmartTagPartialMatchForUnboundItem0;
            public const int SmartTagPartialMatchForUnboundItemMax =
                SmartTagPartialMatchForUnboundItem7;
