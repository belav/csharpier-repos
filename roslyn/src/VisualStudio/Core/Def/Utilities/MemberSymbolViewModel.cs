...
namespace Microsoft.VisualStudio.LanguageServices.Utilities
{
    internal class MemberSymbolViewModel : SymbolViewModel<ISymbol>
    {
        ...
        public string MakeAbstractCheckBoxAutomationText =>
            string.Format(ServicesVSResources.Make_0_abstract, Symbol.Name);
        ...
        public Visibility MakeAbstractVisibility =>
            Symbol.Kind == SymbolKind.Field || Symbol.IsAbstract
                ? Visibility.Hidden
                : Visibility.Visible;
        ...
        {
            get => _makeAbstract;
            set => SetProperty(ref _makeAbstract, value, nameof(MakeAbstract));
        }
        ...
        {
            get => _isMakeAbstractCheckable;
            set =>
                SetProperty(ref _isMakeAbstractCheckable, value, nameof(IsMakeAbstractCheckable));
        }
