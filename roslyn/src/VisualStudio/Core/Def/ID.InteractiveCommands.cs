...
namespace Microsoft.VisualStudio.LanguageServices
{
    internal static partial class ID
    {
        internal static class InteractiveCommands
        {
            ...
            public static readonly Guid CSharpInteractiveCommandSetId = new(
            ...
            public static readonly Guid VisualBasicInteractiveCommandSetId = new(
                VisualBasicInteractiveCommandSetIdString
            );
        }
    }
}
