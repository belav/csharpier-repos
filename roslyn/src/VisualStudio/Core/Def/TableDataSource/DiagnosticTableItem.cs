...
namespace Microsoft.VisualStudio.LanguageServices.Implementation.TableDataSource
{
    internal sealed class DiagnosticTableItem : TableItem
    {
        ...
        public override string GetOriginalFilePath() => Data.DataLocation.UnmappedFileSpan.Path;
                ...
                IEqualityComparer<DiagnosticTableItem>
        {
            ...
            public bool Equals(DiagnosticData left, DiagnosticData right)
            {
                ...
                return leftLocation.UnmappedFileSpan == rightLocation.UnmappedFileSpan
            ...
            public int GetHashCode(DiagnosticData data)
            {
                ...
                return Hash.Combine(
                    location.UnmappedFileSpan.GetHashCode(),
                    Hash.Combine(
                        data.IsSuppressed,
