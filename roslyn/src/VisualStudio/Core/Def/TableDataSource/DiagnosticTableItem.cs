...
namespace Microsoft.VisualStudio.LanguageServices.Implementation.TableDataSource
{
    internal sealed class DiagnosticTableItem : TableItem
    {
        ...
        internal static DiagnosticTableItem Create(Workspace workspace, DiagnosticData data)
        {
            ...
            return new DiagnosticTableItem(
                workspace,
                data,
                projectName,
                projectGuid,
        ...
        public override ProjectId? ProjectId => Data.ProjectId;

        public override LinePosition GetOriginalPosition() =>
            new(
                Data.DataLocation?.OriginalStartLine ?? 0,
                Data.DataLocation?.OriginalStartColumn ?? 0
            );

        public override string? GetOriginalFilePath() => Data.DataLocation?.OriginalFilePath;
                ...
                IEqualityComparer<DiagnosticTableItem>
        {
            ...
            public bool Equals(DiagnosticData left, DiagnosticData right)
            {
                ...
                return leftLocation.OriginalStartLine == rightLocation.OriginalStartLine
            ...
            public int GetHashCode(DiagnosticData data)
            {
                ...
                return Hash.Combine(
                    location.OriginalStartColumn,
                    Hash.Combine(
                        location.OriginalStartLine,
                        Hash.Combine(
                            location.OriginalEndColumn,
                            Hash.Combine(
                                location.OriginalEndLine,
                                Hash.Combine(
