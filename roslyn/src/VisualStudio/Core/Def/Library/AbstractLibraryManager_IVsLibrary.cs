...
{
    partial internal class AbstractLibraryManager : IVsLibrary
    {
        int IVsLibrary.AddBrowseContainer(
        ...
        int IVsLibrary.GetBrowseContainersForHierarchy(
        ...
        int IVsLibrary.GetSeparatorString(string[] pszSeparator) => VSConstants.E_NOTIMPL;
        ...
        int IVsLibrary.LoadState(
            Microsoft.VisualStudio.OLE.Interop.IStream pIStream,
