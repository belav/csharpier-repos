...
namespace Microsoft.VisualStudio.LanguageServices.Implementation.F1Help
{
    internal abstract class AbstractHelpContextService : IHelpContextService
    {
        ...
        protected static readonly SymbolDisplayFormat TypeFormat = new(
        ...
        protected static readonly SymbolDisplayFormat SpecialTypeFormat = new(
            globalNamespaceStyle: SymbolDisplayGlobalNamespaceStyle.Omitted,
        ...
        protected static readonly SymbolDisplayFormat NameFormat = new(
            globalNamespaceStyle: SymbolDisplayGlobalNamespaceStyle.Omitted,
            typeQualificationStyle: SymbolDisplayTypeQualificationStyle.NameOnly,
        ...
        public abstract Task<string> GetHelpTermAsync(
            Document document,
            TextSpan textSpan,
