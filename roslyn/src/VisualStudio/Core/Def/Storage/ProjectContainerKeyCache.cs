...
namespace Microsoft.VisualStudio.LanguageServices.Storage
{
    ...
    {
        private static readonly ImmutableSortedDictionary<string, string?> EmptyDimensions =
        ...
        /// </remarks>
        private readonly Dictionary<TextDocumentState, CacheContainerKey?> _documentToContainerKey =
            new();
        private readonly Func<
            TextDocumentState,
            CacheContainerKey?
        > _documentToContainerKeyCallback;
        ...
        public ProjectContainerKeyCache(string relativePathBase, ProjectKey projectKey)
        {
            ...
            _documentToContainerKeyCallback = ds =>
                CreateDocumentContainerKey(
                    relativePathBase,
                    DocumentKey.ToDocumentKey(projectKey, ds)
                );
        }
        ...
        )
        {
            ...
            var dimensions = EmptyDimensions
                ...
                .Add(
                    $"{nameof(ProjectKey)}.{nameof(ProjectKey.ParseOptionsChecksum)}",
                    projectKey.ParseOptionsChecksum.ToString()
                );
        ...
        )
        {
            ...
            var projectContainerKey = CreateProjectContainerKey(
                relativePathBase,
                documentKey.Project
            );
            ...
            var dimensions = projectContainerKey.Value
                .Dimensions
