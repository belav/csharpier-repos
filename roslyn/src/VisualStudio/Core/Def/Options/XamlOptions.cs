...
namespace Microsoft.CodeAnalysis.Editor.Xaml
{
    ...
    ///
    /// Currently GlobalOptionService.CreateLazySerializableOptionsByLanguage loads all IOptionProvider
    // types eagerly to determine whether or not they contribute to solution options.
    ...
    internal sealed class XamlOptions
    {
        public static readonly Option2<bool> EnableLspIntelliSenseFeatureFlag =
            new("xaml_enable_lsp_intellisense", defaultValue: false);
    }
}
