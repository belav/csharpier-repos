...
namespace Microsoft.VisualStudio.Shell.Interop
{
    ...
    {
        void GetSessionStartTime([Out] out System.Runtime.InteropServices.ComTypes.FILETIME time);
        void GetFlags([Out, MarshalAs(UnmanagedType.U4)] out System.UInt32 flags);
        void SetFlags([In, MarshalAs(UnmanagedType.U4)] System.UInt32 flags);
        void ClearFlags([In, MarshalAs(UnmanagedType.U4)] System.UInt32 flags);
        ...
        void StartDatapointTimer([In, MarshalAs(UnmanagedType.U4)] System.UInt32 dataPointID);
        void RecordDatapointTimer([In, MarshalAs(UnmanagedType.U4)] System.UInt32 dataPointID);
        void AccumulateDatapointTimer([In, MarshalAs(UnmanagedType.U4)] System.UInt32 dataPointID);
...
#pragma warning disable CS0618 // Type or member is obsolete
            [In, MarshalAs(UnmanagedType.VariantBool)]
                System.Boolean alwaysSend,
#pragma warning restore CS0618 // Type or member is obsolete
            [Out, MarshalAs(UnmanagedType.U4)]
                out System.UInt32 sessionHandle
        );

        void EndSession([In, MarshalAs(UnmanagedType.U4)] System.UInt32 sessionHandle);
    ...
    internal interface IVsSqmOptinManager
    {
        ...
        void SetOptinStatus([In, MarshalAs(UnmanagedType.U4)] System.UInt32 optinStatus);
    }
