...
{
    internal class CommonWhitespaceSettingsProvider
        : SettingsProviderBase<WhitespaceSetting, OptionUpdater, IOption2, object>
    {
        ...
        private IEnumerable<WhitespaceSetting> GetDefaultOptions(
            AnalyzerConfigOptions editorConfigOptions,
            OptionSet visualStudioOptions,
            OptionUpdater updater
        )
        {
            yield return WhitespaceSetting.Create(
            ...
            yield return WhitespaceSetting.Create(
                ...
                ServicesVSResources.Operator_placement_when_wrapping,
                editorConfigOptions,
                visualStudioOptions,
                updater,
                FileName
