...
{
    internal sealed class CommonCodeStyleSettingsProvider
        : SettingsProviderBase<CodeStyleSetting, OptionUpdater, IOption2, object>
    {
        ...
        private static IEnumerable<CodeStyleSetting> GetQualifyCodeStyleOptions(
            TieredAnalyzerConfigOptions options,
        ...
        )
        {
            ...
            yield return CodeStyleSetting.Create(
                ...
                EditorFeaturesResources.Qualify_field_access_with_this_or_Me,
                options,
                updater,
            ...
            yield return CodeStyleSetting.Create(
                ...
                EditorFeaturesResources.Qualify_property_access_with_this_or_Me,
                options,
                updater,
                trueValueDescription,
                falseValueDescription
            ...
            yield return CodeStyleSetting.Create(
                ...
                EditorFeaturesResources.Qualify_method_access_with_this_or_Me,
                options,
                updater,
                trueValueDescription,
                falseValueDescription
            ...
            yield return CodeStyleSetting.Create(
                ...
                EditorFeaturesResources.Qualify_event_access_with_this_or_Me,
                options,
                updater,
                trueValueDescription,
                falseValueDescription
        ...
        private static IEnumerable<CodeStyleSetting> GetPredefinedTypesCodeStyleOptions(
            TieredAnalyzerConfigOptions options,
            OptionUpdater updater
        )
        {
            ...
            yield return CodeStyleSetting.Create(
                ...
                ServicesVSResources.For_member_access_expressions,
                options,
                updater,
                trueValueDescription,
                falseValueDescription
        ...
        private static IEnumerable<CodeStyleSetting> GetNullCheckingCodeStyleOptions(
            TieredAnalyzerConfigOptions options,
            OptionUpdater updater
        )
        {
            yield return CodeStyleSetting.Create(
                ...
                ServicesVSResources.Prefer_coalesce_expression,
                options,
                updater
            );
            yield return CodeStyleSetting.Create(
                CodeStyleOptions2.PreferNullPropagation,
                ServicesVSResources.Prefer_null_propagation,
                options,
                updater
            );
            yield return CodeStyleSetting.Create(
                CodeStyleOptions2.PreferIsNullCheckOverReferenceEqualityMethod,
                EditorFeaturesResources.Prefer_is_null_for_reference_equality_checks,
                options,
                updater
            );
        }

        private static IEnumerable<CodeStyleSetting> GetModifierCodeStyleOptions(
            TieredAnalyzerConfigOptions options,
            OptionUpdater updater
        )
        {
            ...
            yield return CodeStyleSetting.Create(
                ...
                ServicesVSResources.Prefer_readonly_fields,
                options,
                updater
            );
        }

        private static IEnumerable<CodeStyleSetting> GetCodeBlockCodeStyleOptions(
            TieredAnalyzerConfigOptions options,
            OptionUpdater updater
        )
        {
            yield return CodeStyleSetting.Create(
                ...
                ServicesVSResources.analyzer_Prefer_auto_properties,
                options,
                updater
            );
        }
        ...
        )
        {
            yield return CodeStyleSetting.Create(
                ...
                description: ServicesVSResources.Prefer_object_initializer,
                options,
                updater
            );
            yield return CodeStyleSetting.Create(
                CodeStyleOptions2.PreferCollectionExpression,
                description: ServicesVSResources.Prefer_collection_expression,
                options,
                updater
            );
            yield return CodeStyleSetting.Create(
                CodeStyleOptions2.PreferCollectionInitializer,
                description: ServicesVSResources.Prefer_collection_initializer,
                options,
                updater
            );
            yield return CodeStyleSetting.Create(
                CodeStyleOptions2.PreferSimplifiedBooleanExpressions,
                description: ServicesVSResources.Prefer_simplified_boolean_expressions,
                options,
                updater
            );
            yield return CodeStyleSetting.Create(
                CodeStyleOptions2.PreferConditionalExpressionOverAssignment,
                description: ServicesVSResources.Prefer_conditional_expression_over_if_with_assignments,
                options,
                updater
            );
            yield return CodeStyleSetting.Create(
                CodeStyleOptions2.PreferConditionalExpressionOverReturn,
                description: ServicesVSResources.Prefer_conditional_expression_over_if_with_returns,
                options,
                updater
            );
            yield return CodeStyleSetting.Create(
                CodeStyleOptions2.PreferExplicitTupleNames,
                description: ServicesVSResources.Prefer_explicit_tuple_name,
                options,
                updater
            );
            yield return CodeStyleSetting.Create(
                CodeStyleOptions2.PreferInferredTupleNames,
                description: ServicesVSResources.Prefer_inferred_tuple_names,
                options,
                updater
            );
            yield return CodeStyleSetting.Create(
                CodeStyleOptions2.PreferInferredAnonymousTypeMemberNames,
                description: ServicesVSResources.Prefer_inferred_anonymous_type_member_names,
                options,
                updater
            );
            yield return CodeStyleSetting.Create(
                CodeStyleOptions2.PreferCompoundAssignment,
                description: ServicesVSResources.Prefer_compound_assignments,
                options,
                updater
            );
            yield return CodeStyleSetting.Create(
                CodeStyleOptions2.PreferSimplifiedInterpolation,
                description: ServicesVSResources.Prefer_simplified_interpolation,
                options,
                updater
            );
        }

        private static IEnumerable<CodeStyleSetting> GetParenthesesCodeStyleOptions(
            TieredAnalyzerConfigOptions options,
            OptionUpdater updater
        )
        {
            ...
            yield return CodeStyleSetting.Create(
                ...
                EditorFeaturesResources.In_arithmetic_binary_operators,
                options,
                updater,
                enumValues,
                valueDescriptions
            ...
            yield return CodeStyleSetting.Create(
                ...
                EditorFeaturesResources.In_other_binary_operators,
                options,
                updater,
                enumValues,
                valueDescriptions
            ...
            yield return CodeStyleSetting.Create(
                ...
                EditorFeaturesResources.In_relational_binary_operators,
                options,
                updater,
                enumValues,
                valueDescriptions
        ...
        private static IEnumerable<CodeStyleSetting> GetParameterCodeStyleOptions(
            TieredAnalyzerConfigOptions options,
            OptionUpdater updater
        )
        {
            ...
            yield return CodeStyleSetting.Create(
                ...
                ServicesVSResources.Avoid_unused_parameters,
                options,
                updater,
                enumValues,
                valueDescriptions
        ...
        private static IEnumerable<CodeStyleSetting> GetExperimentalCodeStyleOptions(
            TieredAnalyzerConfigOptions options,
            OptionUpdater updater
        )
        {
            yield return CodeStyleSetting.Create(
                ...
                ServicesVSResources.Prefer_namespace_and_folder_match_structure,
                options,
                updater
            );
            yield return CodeStyleSetting.Create(
                CodeStyleOptions2.AllowMultipleBlankLines,
                ServicesVSResources.Allow_multiple_blank_lines,
                options,
                updater
            );
            yield return CodeStyleSetting.Create(
                CodeStyleOptions2.AllowStatementImmediatelyAfterBlock,
                ServicesVSResources.Allow_statement_immediately_after_block,
                options,
                updater
            );
        }
