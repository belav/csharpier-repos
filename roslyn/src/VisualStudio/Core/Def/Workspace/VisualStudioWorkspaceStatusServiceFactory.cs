...
namespace Microsoft.VisualStudio.LanguageServices.Implementation
{
    ...
    internal class VisualStudioWorkspaceStatusServiceFactory : IWorkspaceServiceFactory
    {
        ...
        internal sealed class Options : IOptionProvider
        {
            ...
            public static readonly Option2<bool> PartialLoadModeFeatureFlag =
                new(
                    FeatureName,
                    nameof(PartialLoadModeFeatureFlag),
                    defaultValue: false,
                    new FeatureFlagStorageLocation("Roslyn.PartialLoadMode")
                );

            ImmutableArray<IOption> IOptionProvider.Options =>
                ImmutableArray.Create<IOption>(PartialLoadModeFeatureFlag);
