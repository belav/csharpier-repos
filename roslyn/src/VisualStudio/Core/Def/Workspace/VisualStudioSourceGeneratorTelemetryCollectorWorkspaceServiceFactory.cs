...
namespace Microsoft.VisualStudio.LanguageServices
{
    ...
    internal class VisualStudioSourceGeneratorTelemetryCollectorWorkspaceServiceFactory
            ...
            IVsSolutionEvents
    {
        ...
        /// </summary>
        private readonly SourceGeneratorTelemetryCollectorWorkspaceService _visualStudioWorkspaceInstance =
            new SourceGeneratorTelemetryCollectorWorkspaceService();
        ...
        /// </summary>
        private readonly SourceGeneratorTelemetryCollectorWorkspaceService _otherWorkspacesInstance =
            new SourceGeneratorTelemetryCollectorWorkspaceService();
        ...
        public VisualStudioSourceGeneratorTelemetryCollectorWorkspaceServiceFactory(
        ...
        private void EnsureSubscribedToSolutionEvents()
        {
            if (Interlocked.CompareExchange(ref _subscribedToSolutionEvents, 1, 0) == 0)
            {
                Task.Run(
                    async () =>
                    {
                        var shellService = await _serviceProvider
        ...
        {
            _otherWorkspacesInstance.ReportStatisticsAndClear(
                FunctionId.SourceGenerator_OtherWorkspaceSessionStatistics
            );
        }
        ...
        int IVsSolutionEvents.OnBeforeCloseSolution(object pUnkReserved)
        {
            ...
            _visualStudioWorkspaceInstance.ReportStatisticsAndClear(
                FunctionId.SourceGenerator_SolutionStatistics
            );
