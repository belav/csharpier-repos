...
namespace Microsoft.VisualStudio.LanguageServices.Implementation
{
            ...
            IDocumentNavigationService
    {
        ...
        public async Task<bool> CanNavigateToLineAndOffsetAsync(
            Workspace workspace,
            DocumentId documentId,
            int lineNumber,
            int offset,
        ...
        {
            if (
                !await this.CanNavigateToSpanAsync(
                        workspace,
                        documentId,
                        textSpan,
                        allowInvalidSpan,
        ...
        {
            if (
                !await this.CanNavigateToLineAndOffsetAsync(
                        workspace,
                        documentId,
                        lineNumber,
                        offset,
            ...
            return await GetNavigableLocationAsync(
                    ...
                    documentId,
                    document =>
                        GetTextSpanFromLineAndOffsetAsync(
                            document,
                            lineNumber,
                            offset,
                            cancellationToken
            ...
            static async Task<TextSpan> GetTextSpanFromLineAndOffsetAsync(
                Document document,
                int lineNumber,
                int offset,
                CancellationToken cancellationToken
        ...
        {
            if (
                !await this.CanNavigateToPositionAsync(
                        workspace,
                        documentId,
                        position,
                        virtualSpace,
            ...
            static async Task<TextSpan> GetTextSpanFromPositionAsync(
                Document document,
                int position,
                int virtualSpace,
                CancellationToken cancellationToken
        ...
        private async Task<Func<
            CancellationToken,
            Task<bool>
        >?> GetNavigableLocationForMappedFileAsync(
            Workspace workspace,
        ...
        )
        {
            ...
            return cancellationToken =>
                NavigateToTextBufferAsync(textBuffer, vsTextSpan, cancellationToken);
        }
        ...
        {
            var results = await spanMappingService
                .MapSpansAsync(
                    generatedDocument,
        ...
        private static VsTextSpan GetVsTextSpan(
            SourceText text,
            TextSpan textSpan,
            bool allowInvalidSpan
        )
