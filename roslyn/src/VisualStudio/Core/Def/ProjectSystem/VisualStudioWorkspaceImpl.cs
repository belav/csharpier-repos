...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        internal void AddProjectToInternalMaps_NoLock(
        ...
        protected override void Dispose(bool finalize)
        {
            if (!finalize)
            {
                ...
                _projectionBufferFactoryService.ProjectionBufferCreated -=
                    AddTextBufferCloneServiceToBuffer;
                FileWatchedReferenceFactory.ReferenceChanged -=
                    StartRefreshingMetadataReferencesForFile;
        ...
        internal void RemoveProjectFromTrackingMaps_NoLock(ProjectId projectId)
        {
            ...
            _threadingContext.RunWithShutdownBlockAsync(async cancellationToken =>
            {
                ...
                await RefreshProjectExistsUIContextForLanguageAsync(languageName, cancellationToken)
                    .ConfigureAwait(false);
            });
        }
