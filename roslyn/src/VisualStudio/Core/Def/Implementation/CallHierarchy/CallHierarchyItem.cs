...
namespace Microsoft.CodeAnalysis.Editor.Implementation.CallHierarchy
{
    internal class CallHierarchyItem : ICallHierarchyMemberItem
    {
        ...
        )
        {
            ...
            _containingNamespaceName =
                symbol.ContainingNamespace.ToDisplayString(ContainingNamespaceFormat);
        ...
        {
            get { return _workspace.CurrentSolution.GetProject(_projectId); }
        }
        ...
        public IEnumerable<CallHierarchySearchCategory> SupportedSearchCategories
        {
            get
            {
                return _finders.Select(
                    s => new CallHierarchySearchCategory(s.SearchCategory, s.DisplayName)
                );
            }
        }
        ...
        public void NavigateTo()
        {
            ...
            _provider.NavigateTo(
                _symbolId,
                _workspace.CurrentSolution.GetProject(_projectId),
