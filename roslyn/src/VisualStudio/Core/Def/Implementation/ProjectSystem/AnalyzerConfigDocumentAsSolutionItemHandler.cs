...
namespace Microsoft.VisualStudio.LanguageServices.Implementation.ProjectSystem
{
    ...
    internal partial class AnalyzerConfigDocumentAsSolutionItemHandler : IDisposable
    {
        ...
        private void OnWorkspaceChanged(object sender, WorkspaceChangeEventArgs e)
        {
            ...
            var analyzerConfigDocumentFilePath = e.NewSolution
                .GetAnalyzerConfigDocument(e.DocumentId)?.FilePath;
            ...
            Task.Run(
                async () =>
                {
                    ...
                    if (!_infoBarShownForCurrentSolution)
                    {
                        ...
                        var infoBarService = _workspace.Services
            ...
            {
                var addSolutionItemService = _workspace.Services
