    ...
    internal partial class VisualStudioWorkspaceImpl
    {
        ...
        public sealed class OpenFileTracker : IRunningDocumentTableEventListener
        {
            ...
            )
            {
                ...
                _asyncOperationListener = componentModel
            ...
            private void TryOpeningDocumentsForMoniker(
                string moniker,
                ITextBuffer textBuffer,
                IVsHierarchy? hierarchy
            )
            {
                ...
                _workspace.ApplyChangeToWorkspace(
                    w =>
                    {
                        ...
                        {
                            activeContextProjectId = GetActiveContextProjectIdAndWatchHierarchies(
                                moniker,
            ...
            private ProjectId GetActiveContextProjectIdAndWatchHierarchies(
                string moniker,
            ...
            )
            {
                ...
                )
                {
                    ...
                    {
                        var project = _workspace.GetProjectWithHierarchyAndName(
                            hierarchy,
                            contextProjectName
                        );
                ...
                // out better.
                var matchingProjectId = projectIds.FirstOrDefault(
                    id => projectToHierarchyMap.GetValueOrDefault(id, null) == hierarchy
                );
            ...
            private void RefreshContextForMoniker(string moniker, IVsHierarchy hierarchy)
            {
                ...
                _workspace.ApplyChangeToWorkspace(
                    w =>
                    {
                        ...
                        var activeProjectId = GetActiveContextProjectIdAndWatchHierarchies(
                            moniker,
                            documentIds.Select(d => d.ProjectId),
                            hierarchy
                        );
            ...
            public void QueueCheckForFilesBeingOpen(ImmutableArray<string> newFileNames)
            {
                ...
                if (shouldStartTask)
                {
                    var asyncToken = _asyncOperationListener.BeginAsyncOperation(
            ...
            public void ProcessQueuedWorkOnUIThread()
            {
                ...
                lock (_gate)
                {
                    ...
                    justEnumerateTheEntireRunningDocumentTable =
                        _justEnumerateTheEntireRunningDocumentTable;
                ...
                else if (fileNamesToCheckForOpenDocuments != null)
                {
                    ...
                    {
                        if (
                            _runningDocumentTableEventTracker.IsFileOpen(fileName)
