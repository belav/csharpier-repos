...
namespace Microsoft.VisualStudio.LanguageServices.Implementation.ProjectSystem
{
    internal sealed class VisualStudioProject
    {
        ...
        private readonly List<Func<Solution, Solution>> _projectPropertyModificationsInBatch =
            new();
        ...
        > _documentFileWatchingTokens = new();
        ...
        )
        {
            ...
            _sourceFiles = new BatchingDocumentCollection(
                ...
                documentTextLoaderChangedAction: (w, d, loader) =>
                    w.OnDocumentTextLoaderChanged(d, loader)
            );
            ...
            _additionalFiles = new BatchingDocumentCollection(
                ...
                documentTextLoaderChangedAction: (w, d, loader) =>
                    w.OnAdditionalDocumentTextLoaderChanged(d, loader)
            );
            ...
            _analyzerConfigFiles = new BatchingDocumentCollection(
                ...
                documentTextLoaderChangedAction: (w, d, loader) =>
                    w.OnAnalyzerConfigDocumentTextLoaderChanged(d, loader)
            );
            ...
            if (filePath != null && fileExtensionToWatch != null)
            {
                ...
                var projectDirectoryToWatch = new FileChangeWatcher.WatchedDirectory(
                    Path.GetDirectoryName(filePath),
                    fileExtensionToWatch
                );
                _documentFileChangeContext = _workspace.FileChangeWatcher
                ...
                Logger.Log(
                    ...
                    KeyValueLogMessage.Create(
                        m =>
                        {
                            ...
                            m["ProjectGuid"] = projectState.ProjectInfo.Attributes.TelemetryId
                                .ToString("B");
                    ...
                    solution =>
                    {
                        ...
                        foreach (var (path, properties) in _metadataReferencesRemovedInBatch)
                        {
                            ...
                            else
                            {
                                ...
                                _workspace.FileWatchedReferenceFactory
                        ...
                        if (_metadataReferencesAddedInBatch.Count > 0)
                        {
                            ...
                            foreach (var (path, properties) in _metadataReferencesAddedInBatch)
                            {
                                ...
                                {
                                    var metadataReference = _workspace.FileWatchedReferenceFactory
        ...
        public IReadOnlyList<ProjectReference> GetProjectReferences()
        {
            lock (_gate)
            {
                ...
                var projectReferencesInWorkspace =
                    _workspace.CurrentSolution.GetRequiredProject(Id).AllProjectReferences;
            ...
            _workspace.ApplyChangeToWorkspace(
                w =>
                {
                    ...
                    remainingMetadataReferences =
                        w.CurrentSolution.GetRequiredProject(Id).MetadataReferences;
        ...
        public void AddOutputPath(string outputPath)
        {
            ...
            {
                throw new ArgumentException(
                    $"{nameof(outputPath)} isn't a valid path.",
                    nameof(outputPath)
                );
            }
        ...
        private sealed class BatchingDocumentCollection
        {
            ...
            > _sourceTextContainersToDocumentIds =
                BidirectionalMap<SourceTextContainer, DocumentId>.Empty;
            ...
            )
            {
                ...
                lock (_project._gate)
                {
                    ...
                    _project._documentFileWatchingTokens
                        .Add(
                            documentId,
                ...
                lock (_project._gate)
                {
                    ...
                    else
                    {
                        _project._workspace.ApplyChangeToWorkspace(
                            ...
                            {
                                _project._workspace
                                    .AddDocumentToDocumentsNotFromFiles(documentInfo.Id);
            ...
            public void RemoveFile(string fullPath)
            {
                ...
                lock (_project._gate)
                {
                    ...
                    _project._documentFileChangeContext
            ...
            public void RemoveTextContainer(SourceTextContainer textContainer)
            {
                ...
                lock (_project._gate)
                {
                    ...
                    var entry = _documentPathsToDocumentIds.Where(kv => kv.Value == documentId)
                        .FirstOrDefault();
                    if (entry.Key != null)
                    {
                        ...
                        else
                        {
                            _project._workspace.ApplyChangeToWorkspace(
                                w =>
                                {
                                    ...
                                    _project._workspace
                                        .RemoveDocumentToDocumentsNotFromFiles(documentId);
                                }
                            );
                        }
                    }
            ...
            public void ProcessFileChange(string filePath) => ProcessFileChange(filePath, filePath);
                        ...
                        _project._workspace.ApplyChangeToWorkspace(
                            w =>
                            {
                                ...
                                else
                                {
                                    ...
                                    var document = w.CurrentSolution
            ...
            public void ReorderFiles(ImmutableArray<string> filePaths)
            {
                ...
                lock (_project._gate)
                {
                    ...
                    {
                        _project._workspace.ApplyBatchChangeToWorkspace(
                            solution =>
                            {
