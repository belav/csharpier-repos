        ...
        private class DocumentSpanEntry : AbstractDocumentSpanEntry, ISupportsNavigation
        {
            ...
            )
            {
                if (base.TryCreateColumnContent(columnName, out content))
                {
                    ...
                    var controlService = _excerptResult.Document.Project.Solution.Workspace.Services
            ...
            )
            {
                ...
                var controlService = document.Project.Solution.Workspace.Services
                    .GetRequiredService<IContentControlService>();
                ...
                {
                    var excerpt = Presenter.ThreadingContext.JoinableTaskFactory
                        .Run(
                            () =>
                    ...
                    if (excerpt != null)
                    {
                        ...
                        var clonedBuffer = excerpt.Value.Content
            ...
            )
            {
                ...
                var lineNumber =
                    sourceText.Lines.GetLineFromPosition(referenceSpan.Start).LineNumber;
