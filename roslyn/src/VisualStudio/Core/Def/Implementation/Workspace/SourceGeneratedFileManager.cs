...
#pragma warning restore IDE0052 // Remove unread private members
        ...
        private class OpenSourceGeneratedFile : ForegroundThreadAffinitizedObject, IDisposable
        {
            ...
            private void EnsureWindowFrameInfoBarUpdated()
            {
                ...
                var infoBarFactory = (IVsInfoBarUIFactory)_fileManager
                    ._serviceProvider
        ...
        internal sealed class Options : IOptionProvider
        {
            ...
            internal static readonly Option2<bool?> EnableOpeningInWorkspace =
                new(
                    FeatureName,
                    nameof(EnableOpeningInWorkspace),
                    defaultValue: null,
            ...
            internal static readonly Option2<bool> EnableOpeningInWorkspaceFeatureFlag =
                new(
                    FeatureName,
                    nameof(EnableOpeningInWorkspaceFeatureFlag),
                    defaultValue: false,
