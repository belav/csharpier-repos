        ...
        public class DocumentServiceProvider : IDocumentServiceProvider
        {
                ...
                )
                {
                    ...
                    foreach (var span in spans)
                    {
                        ...
                        )
                        {
                            ...
                            var primarySnapshotSpan = new SnapshotSpan(
                                primarySnapshot,
                                primarySpan
                            );
                            result = new MappedSpanResult(
                                document.FilePath,
                                primarySnapshotSpan.ToLinePositionSpan(),
                                primarySpan.ToTextSpan()
                            );
                            break;
                        }
            ...
            private class DocumentExcerpter : IDocumentExcerptService
            {
                ...
                )
                {
                    ...
                    var spanOnPrimarySnapshot = MapRoslynSpanToPrimarySpan(
                        primarySnapshot,
                        roslynSnapshot,
                        span
                    );
                    ...
                    var contentSpanOnPrimarySnapshot = GetContentSpanFromPrimarySpan(
                        mode,
                        spanOnPrimarySnapshot.Value
                    );
                    ...
                    var (content, spanOnContent) = GetContentAndMappedSpan(
                        mode,
                        spanOnPrimarySnapshot.Value,
                ...
                )
                {
                    ...
                    using var pooledObject = SharedPools.Default<List<ClassifiedSpan>>()
                        .GetPooledObject();
                    ...
                    )
                    {
                        ...
                        var fixedUpSpan = roslynSpan.TranslateTo(
                            roslynSnapshot,
                        ...
                        {
                            var mappedSpan = MapRoslynSpanToPrimarySpan(
                                primarySnapshot,
                                roslynSnapshot,
                            ...
                            var spanOnContentSpan = GetSpanOnContent(
                                mappedSpan.Value.Span.ToTextSpan(),
                                contentSpan
                            );
                    ...
                    if (builder.Count == 0)
                    {
                        ...
                        builder.Add(
                            new ClassifiedSpan(
                                new TextSpan(0, contentSpan.Length),
                    ...
                    else
                    {
                        ...
                        if (lastSpan.End < contentSpan.Length)
                        {
                            builder.Add(
                                new ClassifiedSpan(
                                    new TextSpan(lastSpan.End, contentSpan.Length - lastSpan.End),
                                    ClassificationTypeNames.Text
                                )
                            );
                        }
                ...
                private static SnapshotSpan? MapRoslynSpanToPrimarySpan(
                ...
                )
                {
                    ...
                    {
                        return (
                            line.Snapshot.AsText().GetSubText(contentSpan.Span.ToTextSpan()),
                            GetSpanOnContent(
                                primarySpan.Span.ToTextSpan(),
                                contentSpan.Span.ToTextSpan()
                            )
                        );
                    }
                ...
                )
                {
                    ...
                    if (mode == ExcerptMode.Tooltip)
                    {
                        ...
                        return new SnapshotSpan(
                            line.Snapshot,
                            Span.FromBounds(
                                startLine.Extent.Start.Position,
                                endLine.Extent.End.Position
                            )
                        );
                    }
                ...
                private static TextSpan GetSpanOnContent(
                    TextSpan targetSpan,
