...
namespace Microsoft.VisualStudio.LanguageServices.Implementation.Library.ObjectBrowser
{
          ...
          IDisposable
    {
        ...
        ) : base(libraryGuid, serviceProvider)
        {
            ...
            _streamingPresenter = componentModel.DefaultExportProvider
        ...
        internal Compilation GetCompilation(ProjectId projectId)
        {
            ...
            return project.GetCompilationAsync(CancellationToken.None)
        ...
        )
        {
            ...
            ppNavInfo = this.LibraryService.NavInfoFactory
                .Create(
                    libraryName,
                    referenceOwnerName,
        ...
        internal IVsNavInfo GetNavInfo(SymbolListItem symbolListItem, bool useExpandedHierarchy)
        {
            ...
            {
                return this.LibraryService.NavInfoFactory
            ...
            if (commandGroup == VsMenus.guidStandardCommandSet97)
            {
                switch (commandId)
                {
                    case (uint)VSConstants.VSStd97CmdID.FindReferences:
                        ...
                        {
                            var project = this.Workspace.CurrentSolution
