...
namespace Microsoft.VisualStudio.LanguageServices.Implementation.Library.ObjectBrowser
{
    internal abstract partial class AbstractDescriptionBuilder
    {
        ...
        private static readonly SymbolDisplayFormat s_typeDisplay =
        ...
        {
            return _project.GetCompilationAsync(CancellationToken.None)
        ...
        protected void AddAssemblyLink(IAssemblySymbol assemblySymbol)
        {
            ...
            var navInfo = _libraryManager.LibraryService.NavInfoFactory
        ...
        private void BuildXmlDocumentation(ISymbol symbol, Compilation compilation)
        {
            ...
            var formattingService = _project.LanguageServices
