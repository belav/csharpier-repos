...
namespace Microsoft.VisualStudio.LanguageServices.Implementation.ProjectSystem.CPS
{
            ...
            EncInterop.IVsENCRebuildableProjectCfg4
    {
        ...
        public int StartDebuggingPE() => throw ExceptionUtilities.Unreachable;

        public int StopDebuggingPE() => throw ExceptionUtilities.Unreachable;

        public int GetPEidentity(Guid[] pMVID, string[] pbstrPEName) =>
            throw ExceptionUtilities.Unreachable;

        public int EnterBreakStateOnPE(
            EncInterop.ENC_BREAKSTATE_REASON encBreakReason,
            ShellInterop.ENC_ACTIVE_STATEMENT[] pActiveStatements,
        ...
        public int GetExceptionSpans(
            uint celt,
            ShellInterop.ENC_EXCEPTION_SPAN[] rgelt,
        ...
        public int ExitBreakStateOnPE() => throw ExceptionUtilities.Unreachable;

        public int GetCurrentActiveStatementPosition(uint id, VsTextSpan[] ptsNewPosition) =>
            throw ExceptionUtilities.Unreachable;

        public int EncApplySucceeded(int hrApplyResult) => throw ExceptionUtilities.Unreachable;

        public int GetPEBuildTimeStamp(Microsoft.VisualStudio.OLE.Interop.FILETIME[] pTimeStamp) =>
            throw ExceptionUtilities.Unreachable;

        public int BuildForEnc(object pUpdatePE) => throw ExceptionUtilities.Unreachable;
    }
}
