...
namespace Microsoft.VisualStudio.LanguageServices.Implementation.ProjectSystem.CPS
{
    internal sealed partial class CPSProject : IWorkspaceProjectContext
    {
        ...
        )
        {
            ...
            if (
                visualStudioWorkspace
                    .Services.GetLanguageServices(projectSystemProject.Language)
        ...
        public string? BinOutputPath
        {
            ...
            set
            {
                ...
                {
                    var rootDirectory =
                        _projectSystemProject.FilePath != null
        ...
        public void SetProperty(string name, string? value)
        {
            ...
            else if (name == BuildPropertyNames.RunAnalyzersDuringLiveAnalysis)
            {
                ...
                name == BuildPropertyNames.TemporaryDependencyNodeTargetIdentifier
            ...
            else if (name == BuildPropertyNames.TargetRefPath)
            {
                ...
                else
                {
                    ...
                    if (!PathUtilities.IsAbsolute(value))
                    {
                        ...
                        _projectSystemProject.OutputRefFilePath = Path.Combine(
                            rootDirectory,
                            value
                        );
                    }
        ...
        public void RemoveMetadataReference(string referencePath)
        {
            ...
            _projectSystemProject.RemoveMetadataReference(
                referencePath,
                _projectSystemProject.GetPropertiesForMetadataReference(referencePath).Single()
            );
        }
        ...
        )
        {
            ...
            _projectSystemProject.AddProjectReference(
        ...
        {
            var otherProjectId = ((CPSProject)project)._projectSystemProject.Id;
            var otherProjectReference = _projectSystemProject
        ...
        public void AddSourceFile(
            ...
            _projectSystemProject.AddSourceFile(
                filePath,
                sourceCodeKind,
        ...
        public void StartBatch() => _batchScopes.Enqueue(_projectSystemProject.CreateBatchScope());
        ...
        internal ProjectSystemProject GetProject_TestOnly() => _projectSystemProject;
