...
namespace Microsoft.VisualStudio.LanguageServices.Implementation.ProjectSystem.CPS
{
            ...
            IVsLanguageServiceBuildErrorReporter2
    {
        private ProjectExternalErrorReporter GetExternalErrorReporter()
        {
            ...
            if (errorReporter == null)
            {
                throw new InvalidOperationException(
                    "The language of the project doesn't support external errors."
                );
            }
        ...
        public int ClearAllErrors() => GetExternalErrorReporter().ClearAllErrors();
        ...
        public int ClearErrors() => GetExternalErrorReporter().ClearErrors();
