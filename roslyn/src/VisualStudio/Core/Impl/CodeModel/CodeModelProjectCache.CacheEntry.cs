...
namespace Microsoft.VisualStudio.LanguageServices.Implementation.CodeModel
{
    internal sealed partial class CodeModelProjectCache
    {
        private readonly struct CacheEntry
        {
            ...
            private readonly WeakComHandle<
                EnvDTE80.FileCodeModel2,
                FileCodeModel
            > _fileCodeModelWeakComHandle;

            public CacheEntry(ComHandle<EnvDTE80.FileCodeModel2, FileCodeModel> handle) =>
                _fileCodeModelWeakComHandle = new WeakComHandle<
                    EnvDTE80.FileCodeModel2,
                    FileCodeModel
                >(handle);
            ...
            {
                get { return _fileCodeModelWeakComHandle.ComAggregateObject; }
            }
            ...
            {
                get { return _fileCodeModelWeakComHandle.ComHandle; }
            }
        }
    }
}
