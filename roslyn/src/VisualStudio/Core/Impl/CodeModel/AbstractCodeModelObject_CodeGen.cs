...
namespace Microsoft.VisualStudio.LanguageServices.Implementation.CodeModel
{
    ...
    public partial class AbstractCodeModelObject
    {
        ...
        private protected SyntaxNode CreateConstructorDeclaration(
            SyntaxNode containerNode,
            string typeName,
        ...
        )
        {
            ...
            var newMethodSymbol = CodeGenerationSymbolFactory.CreateConstructorSymbol(
                attributes: default,
                accessibility: CodeModelService.GetAccessibility(
                    access,
                    SymbolKind.Method,
                    destination
                ),
            ...
            var method = CodeGenerationService.CreateMethodDeclaration(
                newMethodSymbol,
                destination,
                info,
        ...
        private protected SyntaxNode CreateDestructorDeclaration(
            SyntaxNode containerNode,
            string typeName,
            CodeGenerationOptions options
        )
        ...
        private protected SyntaxNode CreateDelegateTypeDeclaration(
            SyntaxNode containerNode,
            string name,
            EnvDTE.vsCMAccess access,
        ...
        private protected SyntaxNode CreateEventDeclaration(
            SyntaxNode containerNode,
            string name,
            EnvDTE.vsCMAccess access,
            ITypeSymbol type,
        ...
        private protected SyntaxNode CreateFieldDeclaration(
            SyntaxNode containerNode,
            string name,
            EnvDTE.vsCMAccess access,
            ITypeSymbol type,
        ...
        )
        {
            ...
            var newFieldSymbol = CodeGenerationSymbolFactory.CreateFieldSymbol(
                ...
                modifiers: new DeclarationModifiers(
                    isWithEvents: CodeModelService.GetWithEvents(access)
                ),
                type: type,
                name: name
            );
        ...
        private protected SyntaxNode CreateMethodDeclaration(
            SyntaxNode containerNode,
            string name,
            EnvDTE.vsCMAccess access,
            ...
            if (generateGetter)
            {
                getMethod = CodeGenerationSymbolFactory.CreateMethodSymbol(
                    ...
                    statements: ImmutableArray.Create(
                        CodeModelService.CreateReturnDefaultValueStatement(type)
                    )
                );
            }
        ...
        private protected SyntaxNode CreateNamespaceDeclaration(
            SyntaxNode containerNode,
            string name,
            CodeGenerationOptions options
        )
        {
            ...
            var info = GetCodeGenerationContextInfo(containerNode, options);
            return CodeGenerationService.CreateNamespaceDeclaration(
                newNamespaceSymbol,
                destination,
                info,
                CancellationToken.None
        ...
        )
        {
            ...
            var codeGenOptions = GetCodeGenerationContextInfo(
                containerNode,
                options,
                access: access
            );
