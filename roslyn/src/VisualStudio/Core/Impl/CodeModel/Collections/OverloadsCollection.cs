...
namespace Microsoft.VisualStudio.LanguageServices.Implementation.CodeModel.Collections
{
    ...
    public sealed class OverloadsCollection : AbstractCodeElementCollection
    {
        ...
        {
            // Retrieving the overloads is potentially very expensive because it can force multiple
            // FileCodeModels to be instantiated.
            // Here, we cache the result to avoid having to perform these calculations each time GetOverloads()
            // is called.
            // This *could* be an issue because it means that an OverloadsCollection will not necessarily
            // reflect the
            // current state of the user's code. However, because a new OverloadsCollection is created every
            // time the Overloads
