...
namespace Microsoft.VisualStudio.LanguageServices.Implementation.CodeModel.ExternalElements
{
            ...
            EnvDTE80.CodeElement2
    {
        ...
        internal AbstractExternalCodeElement(
        ...
        {
            var symbol = CodeModelService.ResolveSymbol(
        ...
        {
            get { return GetIsShared(); }
            set { throw Exceptions.ThrowEFail(); }
        }

        public EnvDTE.TextPoint GetEndPoint(EnvDTE.vsCMPart part) => throw Exceptions.ThrowEFail();
...
#pragma warning disable IDE0060 // Remove unused parameter - Implements interface methods for sub-types.
        ...
        public void RenameSymbol(string newName) => throw Exceptions.ThrowEFail();

        public void RemoveParameter(object element) => throw Exceptions.ThrowEFail();
