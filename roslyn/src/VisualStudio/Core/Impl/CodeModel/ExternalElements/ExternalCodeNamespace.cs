...
namespace Microsoft.VisualStudio.LanguageServices.Implementation.CodeModel.ExternalElements
{
            ...
            EnvDTE.CodeElement
    {
        ...
        public EnvDTE.CodeElements Members
        {
            get
            {
                return ExternalNamespaceCollection.Create(State, this, ProjectId, NamespaceSymbol);
            }
        }
        ...
        public void Remove(object element) => throw Exceptions.ThrowEFail();
    }
}
