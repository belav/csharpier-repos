...
namespace Microsoft.VisualStudio.LanguageServices.CSharp.UnitTests.CodeModel
{
    internal static class FileCodeModelTestHelpers
    {
        ...
        public static (
            ...
            EnvDTE.FileCodeModel fileCodeModel
        ) CreateWorkspaceAndFileCodeModel(string file)
        {
            var workspace = TestWorkspace.CreateCSharp(
                file,
                composition: CodeModelTestHelpers.Composition
            );
            ...
            try
            {
                ...
                var serviceProvider = workspace.ExportProvider
                ...
                var visualStudioWorkspaceMock = workspace.ExportProvider
