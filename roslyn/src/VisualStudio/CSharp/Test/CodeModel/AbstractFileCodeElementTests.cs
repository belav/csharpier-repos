...
namespace Microsoft.VisualStudio.LanguageServices.CSharp.UnitTests.CodeModel
{
    ...
    public abstract class AbstractFileCodeElementTests : IDisposable
    {
        ...
        protected static (TestWorkspace workspace, VisualStudioWorkspace extraWorkspaceToDisposeButNotUse, FileCodeModel fileCodeModel) CreateWorkspaceAndFileCodeModelAsync(
            string file
