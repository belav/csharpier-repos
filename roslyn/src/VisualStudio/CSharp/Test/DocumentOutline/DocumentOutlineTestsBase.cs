...
namespace Roslyn.VisualStudio.CSharp.UnitTests.DocumentOutline
{
    ...
    public abstract class DocumentOutlineTestsBase
    {
        ...
        protected class DocumentOutlineTestMocks : IAsyncDisposable
        {
            ...
            internal string FilePath => PathRoot + _workspace.Documents.Single().FilePath!;
            ...
            languageServiceBrokerMock
                .Setup(l =>
                    l.RequestAsync(
                        ...
                        It.IsAny<string>(),
                        It.IsAny<string>(),
                        It.IsAny<Func<ITextSnapshot, JToken>>(),
                ...
                .Returns<
                    ...
                    string,
                    string,
                    Func<ITextSnapshot, JToken>,
                    CancellationToken
                >(RequestAsync);
#pragma warning restore CS0618 // Type or member is obsolete

            var mocks = new DocumentOutlineTestMocks(
                languageServiceBrokerMock.Object,
                threadingContext,
                workspace,
                testLspServer
            );
            ...
            async Task<ManualInvocationResponse?> RequestAsync(
            ...
            {
                var request = parameterFactory(textBuffer.CurrentSnapshot)
                    .ToObject<RoslynDocumentSymbolParams>();
