...
namespace Microsoft.VisualStudio.LanguageServices.CSharp.ProjectSystemShim
{
          ...
          ICodeModelInstanceFactory
    {
            ...
            )
        {
            ...
            this.ProjectCodeModel = componentModel.GetService<IProjectCodeModelFactory>()
                .CreateProjectCodeModel(VisualStudioProject.Id, this);
            this.VisualStudioProjectOptionsProcessor = new OptionsProcessor(
