...
namespace Microsoft.VisualStudio.LanguageServices.CSharp.ProjectSystemShim
{
    internal partial class CSharpProjectShim : ICSharpVenusProjectSite
    {
        ...
        )
        {
            ...
            var projectReferencesToRemove = VisualStudioProject
                .GetProjectReferences()
                .Where(p => p.ProjectId == projectSite.VisualStudioProject.Id)
                .ToList();
            ...
            foreach (var projectReferenceToRemove in projectReferencesToRemove)
            {
                VisualStudioProject.RemoveProjectReference(
                    new ProjectReference(projectSite.VisualStudioProject.Id)
                );
            }
        }
        ...
        )
        {
            ...
            {
                var existingProjectReference = VisualStudioProject
                    .GetProjectReferences()
                    .Single(p => p.ProjectId == projectSite.VisualStudioProject.Id);
        ...
        )
        {
            ...
            VisualStudioProject.AddProjectReference(
                new ProjectReference(
                    projectSite.VisualStudioProject.Id,
