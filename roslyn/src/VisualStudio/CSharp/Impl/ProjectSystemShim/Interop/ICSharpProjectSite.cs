...
namespace Microsoft.VisualStudio.LanguageServices.CSharp.ProjectSystemShim.Interop
{
    ...
    internal interface ICSharpProjectSite
    {
        ...
        [PreserveSig]
        int CreateCodeModel(
            [MarshalAs(UnmanagedType.IUnknown)] object parent,
            out EnvDTE.CodeModel codeModel
        );
        ...
        int CreateFileCodeModel(
            [MarshalAs(UnmanagedType.LPWStr)] string fileName,
            [MarshalAs(UnmanagedType.IUnknown)] object parent,
            out EnvDTE.FileCodeModel fileCodeModel
        );
