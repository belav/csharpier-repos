...
namespace Microsoft.VisualStudio.LanguageServices.CSharp.ProjectSystemShim
{
    internal partial class CSharpProjectShim : ICSCompiler
    {
        ...
        public ICSCompilerConfig GetConfiguration() => this;

        public ICSInputSet AddInputSet() => throw new NotImplementedException();

        public void RemoveInputSet(ICSInputSet inputSet) => throw new NotImplementedException();

        public void Compile(ICSCompileProgress progress) => throw new NotImplementedException();
        ...
        public object CreateLanguageAnalysisEngine() => throw new NotImplementedException();
