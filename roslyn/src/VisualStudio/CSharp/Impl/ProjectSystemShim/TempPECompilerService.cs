...
namespace Microsoft.VisualStudio.LanguageServices.CSharp.ProjectSystemShim
{
    ...
    internal sealed class TempPECompilerService : ICSharpTempPECompilerService
    {
        ...
        public int CompileTempPE(
            string pszOutputFileName,
            int sourceCount,
            string[] fileNames,
            string[] fileContents,
            int optionCount,
        ...
        )
        {
            ...
            for (var i = 0; i < fileNames.Length; i++)
            {
                var sourceText = SourceText.From(
                    ...
                    parsedArguments.ChecksumAlgorithm
                );
                trees.Add(
            ...
            var compilation = CSharpCompilation.Create(
                ...
                parsedArguments
                    .CompilationOptions.WithAssemblyIdentityComparer(
        ...
        private static CSharpCommandLineArguments ParseCommandLineArguments(
