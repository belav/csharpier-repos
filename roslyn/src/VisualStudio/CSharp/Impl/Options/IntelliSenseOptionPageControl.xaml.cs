...
{
    partial internal class IntelliSenseOptionPageControl : AbstractOptionPageControl
    {
            ...
            : base(optionStore)
        {
            ...
            BindToOption(
                ...
                CompletionViewOptions.ShowCompletionItemFilters,
            ...
            BindToOption(
                ...
                CompletionOptionsStorage.SnippetsBehavior,
                SnippetsRule.IncludeAfterTypingIdentifierQuestionTab,
                LanguageNames.CSharp
            );
            ...
            Show_new_snippet_experience.IsChecked = this.OptionStore.GetOption(
        ...
        private void Show_completion_list_after_a_character_is_deleted_Checked(
            object sender,
            RoutedEventArgs e
        ) =>
        ...
        private void Show_new_snippet_experience_CheckedChanged(object sender, RoutedEventArgs e)
        {
            ...
            this.OptionStore.SetOption(
                CompletionOptionsStorage.ShowNewSnippetExperienceUserOption,
                LanguageNames.CSharp,
                value: Show_new_snippet_experience.IsChecked
            );
        }
    }
}
