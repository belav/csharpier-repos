    ...
    internal partial class AdvancedOptionPageControl : AbstractOptionPageControl
    {
            ...
            : base(optionStore)
        {
            ...
            BindToOption(
                ...
                IdeAnalyzerOptionsStorage.FadeOutUnusedImports,
                LanguageNames.CSharp
            );
            BindToOption(
                Fade_out_unreachable_code,
                IdeAnalyzerOptionsStorage.FadeOutUnreachableCode,
                LanguageNames.CSharp
            );
            ...
            BindToOption(
                ...
                ExtractMethodOptionsStorage.DontPutOutOrRefOnStruct,
                LanguageNames.CSharp
            );
            ...
            BindToOption(
                ...
                StackTraceExplorerOptionsMetadata.OpenOnFocus
            );
        }
