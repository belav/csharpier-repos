    ...
    internal partial class AdvancedOptionPageControl : AbstractOptionPageControl
    {
            ...
            : base(optionStore)
        {
            ...
            BindToOption(
                ...
                BlockStructureOptions.Metadata.ShowOutliningForDeclarationLevelConstructs,
                LanguageNames.CSharp
            );
            BindToOption(
                Show_outlining_for_code_level_constructs,
                BlockStructureOptions.Metadata.ShowOutliningForCodeLevelConstructs,
                LanguageNames.CSharp
            );
            BindToOption(
            ...
            BindToOption(
                ...
                QuickInfoOptions.Metadata.ShowRemarksInQuickInfo,
                LanguageNames.CSharp
            );
            BindToOption(
            ...
            BindToOption(
                ...
                SourceGeneratedFileManager.Options.EnableOpeningInWorkspace,
                () =>
                {
                    // If the option has not been set by the user, check if the option is enabled from experimentation.
                    // If so, default to that.
                    return optionStore.GetOption(
                        SourceGeneratedFileManager.Options.EnableOpeningInWorkspaceFeatureFlag
                    );
                }
            );
            ...
            BindToOption(
                ...
                ClassificationOptions.Metadata.ColorizeRegexPatterns,
                LanguageNames.CSharp
            );
            BindToOption(
            ...
            BindToOption(
                ...
                CompletionOptions.Metadata.ProvideRegexCompletions,
                LanguageNames.CSharp
            );
