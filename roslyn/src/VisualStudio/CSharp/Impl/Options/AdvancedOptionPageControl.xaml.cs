...
namespace Microsoft.VisualStudio.LanguageServices.CSharp.Options
{
    internal partial class AdvancedOptionPageControl : AbstractOptionPageControl
    {
        ...
        public AdvancedOptionPageControl(OptionStore optionStore, IComponentModel componentModel)
            : base(optionStore)
        {
            ...
            BindToOption(
                ...
                LanguageNames.CSharp,
                label: Show_compiler_errors_and_warnings_for_label
            );
            BindToOption(
            ...
            BindToOption(
                ...
                InlineDiagnosticsLocations.PlacedAtEndOfCode,
                LanguageNames.CSharp
            );
            BindToOption(
                on_the_right_edge_of_the_editor_window,
                InlineDiagnosticsOptionsStorage.Location,
                InlineDiagnosticsLocations.PlacedAtEndOfEditor,
                LanguageNames.CSharp
            );
            ...
            BindToOption(
                AddUsingsOnPaste,
                AddImportOnPasteOptionsStorage.AddImportsOnPaste,
                LanguageNames.CSharp
            );
            ...
            BindToOption(
                EnterOutliningMode,
                OutliningOptionsStorage.Outlining,
                LanguageNames.CSharp
            );
            BindToOption(
            ...
            BindToOption(
                ...
                SplitCommentOptionsStorage.Enabled,
                LanguageNames.CSharp
            );
            BindToOption(
            ...
            BindToOption(
                ...
                () =>
                {
                    ...
                    return optionStore.GetOption(
                        WorkspaceConfigurationOptionsStorage.EnableOpeningSourceGeneratedFilesInWorkspaceFeatureFlag
                    );
                }
            );
            ...
            BindToOption(
                ...
                ClassificationOptionsStorage.ColorizeRegexPatterns,
                LanguageNames.CSharp
            );
            BindToOption(
                Report_invalid_regular_expressions,
                IdeAnalyzerOptionsStorage.ReportInvalidRegexPatterns,
                LanguageNames.CSharp
            );
            BindToOption(
            ...
            BindToOption(
                ...
                ClassificationOptionsStorage.ColorizeJsonPatterns,
                LanguageNames.CSharp
            );
            BindToOption(
            ...
            BindToOption(
                ...
                StackTraceExplorerOptionsStorage.OpenOnFocus
            );

            // Document Outline
            BindToOption(
                EnableDocumentOutline,
                DocumentOutlineOptionsStorage.EnableDocumentOutline,
                () =>
                {
                    ...
                    return !optionStore.GetOption(
                        DocumentOutlineOptionsStorage.DisableDocumentOutlineFeatureFlag
                    );
                }
            );
        }
        ...
        internal override void OnLoad()
        {
            ...
            var (isSupportedTheme, isThemeCustomized) = _threadingContext.JoinableTaskFactory
                .Run(async () =>
                    (
        ...
        private void Enable_pull_diagnostics_experimental_requires_restart_CheckedChanged(
            object sender,
            RoutedEventArgs e
        )
        {
        ...
        private void Enable_pull_diagnostics_experimental_requires_restart_Indeterminate(
            object sender,
            RoutedEventArgs e
        )
        {
        ...
        private void UpdateInlineHintsOptions()
        {
            var enabledForParameters = this.OptionStore
                .GetOption(InlineHintsOptionsStorage.EnabledForParameters, LanguageNames.CSharp);
            ...
            var enabledForTypes = this.OptionStore
                .GetOption(InlineHintsOptionsStorage.EnabledForTypes, LanguageNames.CSharp);
        ...
        {
            this.OptionStore
                .SetOption(InlineHintsOptionsStorage.EnabledForTypes, LanguageNames.CSharp, true);
            UpdateInlineHintsOptions();
        }
        ...
        {
            this.OptionStore
                .SetOption(InlineHintsOptionsStorage.EnabledForTypes, LanguageNames.CSharp, false);
            UpdateInlineHintsOptions();
        }
        ...
        private void Run_code_analysis_in_separate_process_Unchecked(
            object sender,
            RoutedEventArgs e
        )
        {
