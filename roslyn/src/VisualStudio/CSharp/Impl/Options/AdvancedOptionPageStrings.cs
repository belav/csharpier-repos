...
namespace Microsoft.VisualStudio.LanguageServices.CSharp.Options
{
    ...
    {
        public static string Option_Analysis => ServicesVSResources.Analysis;

        public static string Option_Run_background_code_analysis_for =>
            ServicesVSResources.Run_background_code_analysis_for_colon;

        public static string Option_Background_Analysis_Scope_None => ServicesVSResources.None;
        ...
        public static string Option_Compiler_Diagnostics_Scope_None => ServicesVSResources.None;
        ...
        public static string Option_Inline_Hints => ServicesVSResources.Inline_Hints;
        ...
        public static string Option_Color_hints => ServicesVSResources.Color_hints;
        ...
        public static string Option_EditorHelp => CSharpVSResources.Editor_Help;
        ...
        public static string Option_ExtractMethod => CSharpVSResources.Extract_Method;
        ...
        public static string Option_at_the_end => ServicesVSResources.at_the_end;
        ...
        public static string Option_Comments => ServicesVSResources.Comments;
        ...
        public static string Option_Highlighting => CSharpVSResources.Highlighting;

        public static string Option_OptimizeForSolutionSize =>
            CSharpVSResources.Optimize_for_solution_size;

        public static string Option_OptimizeForSolutionSize_Large => CSharpVSResources.Large;

        public static string Option_OptimizeForSolutionSize_Regular => CSharpVSResources.Regular;

        public static string Option_OptimizeForSolutionSize_Small => CSharpVSResources.Small;

        public static string Option_Quick_Actions => ServicesVSResources.Quick_Actions;

        public static string Option_Outlining => ServicesVSResources.Outlining;
        ...
        public static string Option_Fading => ServicesVSResources.Fading;
        ...
        public static string Option_Performance => CSharpVSResources.Performance;
        ...
        public static string Option_Using_Directives => CSharpVSResources.Using_Directives;
        ...
        public static string Option_Regular_Expressions => ServicesVSResources.Regular_Expressions;
        ...
        public static string Option_Editor_Color_Scheme => ServicesVSResources.Editor_Color_Scheme;
        ...
        public static string Show_inheritance_margin => ServicesVSResources.Show_inheritance_margin;
        ...
        public static string Include_global_imports => ServicesVSResources.Include_global_imports;

        public static string Option_JSON_strings => ServicesVSResources.JSON_strings;
        ...
        public static string Stack_Trace_Explorer => ServicesVSResources.Stack_Trace_Explorer;
        ...
        public static string Option_Go_To_Definition => ServicesVSResources.Go_To_Definition;

        public static string Option_Navigate_asynchronously_exerimental =>
            ServicesVSResources.Navigate_asynchronously_exerimental;

        public static string Option_Rename => ServicesVSResources.Rename;
        ...
        public static string Option_Show_UI_inline => ServicesVSResources.Show_UI_inline;
