...
namespace Microsoft.VisualStudio.LanguageServices.CSharp.Options
{
    ...
    public partial class AutomationObject : AbstractAutomationObject
    {
        ...
        private int GetBooleanOption(PerLanguageOption2<bool> key) => GetOption(key) ? 1 : 0;

        private void SetBooleanOption(Option2<bool> key, int value) => SetOption(key, value != 0);
