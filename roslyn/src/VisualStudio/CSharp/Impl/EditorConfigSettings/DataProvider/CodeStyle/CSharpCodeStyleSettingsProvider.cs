        ...
        : SettingsProviderBase<CodeStyleSetting, OptionUpdater, IOption2, object>
    {
        ...
        )
        {
            ...
            yield return CodeStyleSetting.Create(
                ...
                ServicesVSResources.Prefer_read_only_struct_member,
                options,
                updater
            );
        }
        ...
        )
        {
            ...
            yield return CodeStyleSetting.Create(
                ...
                ServicesVSResources.Prefer_primary_constructors,
                options,
                updater
            );
        }
        ...
        )
        {
            ...
            yield return CodeStyleSetting.Create(
                ...
                CSharpVSResources.Prefer_extended_property_pattern,
                options,
                updater
            );
        }
        ...
        )
        {
            ...
            var valueDescriptions = new[]
            {
                CSharpVSResources.Unused_local,
                CSharpVSResources.Discard
            };
