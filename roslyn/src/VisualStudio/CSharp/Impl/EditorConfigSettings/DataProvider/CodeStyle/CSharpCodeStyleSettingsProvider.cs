...
namespace Microsoft.VisualStudio.LanguageServices.CSharp.EditorConfigSettings.DataProvider.CodeStyle
{
        ...
        : SettingsProviderBase<CodeStyleSetting, OptionUpdater, IOption2, object>
    {
        ...
        private IEnumerable<CodeStyleSetting> GetVarCodeStyleOptions(
            AnalyzerConfigOptions editorConfigOptions,
            OptionSet visualStudioOptions,
        ...
        private IEnumerable<CodeStyleSetting> GetUsingsCodeStyleOptions(
            AnalyzerConfigOptions editorConfigOptions,
            OptionSet visualStudioOptions,
            OptionUpdater updaterService
        )
        ...
        )
        {
            ...
            yield return CodeStyleSetting.Create(
                option: CSharpCodeStyleOptions.PreferNullCheckOverTypeCheck,
        ...
        )
        {
            ...
            yield return CodeStyleSetting.Create(
                option: CSharpCodeStyleOptions.PreferReadOnlyStruct,
        ...
        )
        {
            ...
            yield return CodeStyleSetting.Create(
                option: CSharpCodeStyleOptions.NamespaceDeclarations,
                ...
                valueDescriptions: new[]
                {
                    CSharpVSResources.Block_scoped,
                    CSharpVSResources.File_scoped
                },
                editorConfigOptions: editorConfigOptions,
                visualStudioOptions: visualStudioOptions,
                updater: updaterService,
            ...
            yield return CodeStyleSetting.Create(
                option: CSharpCodeStyleOptions.PreferMethodGroupConversion,
            ...
            yield return CodeStyleSetting.Create(
                option: CSharpCodeStyleOptions.PreferTopLevelStatements,
        ...
        )
        {
            yield return CodeStyleSetting.Create(
                ...
                description: CSharpVSResources.Prefer_switch_expression,
                editorConfigOptions,
                visualStudioOptions,
                updaterService,
                FileName
            ...
            yield return CodeStyleSetting.Create(
                ...
                description: ServicesVSResources.Prefer_simple_default_expression,
                editorConfigOptions,
                visualStudioOptions,
                updaterService,
                FileName
            ...
            yield return CodeStyleSetting.Create(
                ...
                description: ServicesVSResources.Prefer_local_function_over_anonymous_function,
                editorConfigOptions,
                visualStudioOptions,
                updaterService,
                FileName
            ...
            yield return CodeStyleSetting.Create(
                ...
                description: ServicesVSResources.Prefer_index_operator,
                editorConfigOptions,
                visualStudioOptions,
                updaterService,
                FileName
            ...
            yield return CodeStyleSetting.Create(
                ...
                description: ServicesVSResources.Prefer_range_operator,
                editorConfigOptions,
                visualStudioOptions,
                updaterService,
                FileName
            ...
            yield return CodeStyleSetting.Create(
                ...
                description: CSharpVSResources.Prefer_implicit_object_creation_when_type_is_apparent,
                editorConfigOptions,
                visualStudioOptions,
                updaterService,
                FileName
            ...
            yield return CodeStyleSetting.Create(
                ...
                description: ServicesVSResources.Prefer_tuple_swap,
                editorConfigOptions,
                visualStudioOptions,
                updaterService,
                FileName
            ...
            yield return CodeStyleSetting.Create(
                ...
                description: ServicesVSResources.Prefer_Utf8_string_literals,
                editorConfigOptions,
                visualStudioOptions,
                updaterService,
                FileName
        ...
        private IEnumerable<CodeStyleSetting> GetPatternMatchingCodeStyleOptions(
            AnalyzerConfigOptions editorConfigOptions,
            OptionSet visualStudioOptions,
            OptionUpdater updaterService
        )
        {
            yield return CodeStyleSetting.Create(
                ...
                description: CSharpVSResources.Prefer_pattern_matching,
                editorConfigOptions,
                visualStudioOptions,
                updaterService,
                FileName
            ...
            yield return CodeStyleSetting.Create(
                ...
                description: CSharpVSResources.Prefer_pattern_matching_over_is_with_cast_check,
                editorConfigOptions,
                visualStudioOptions,
                updaterService,
                FileName
            ...
            yield return CodeStyleSetting.Create(
                ...
                description: CSharpVSResources.Prefer_pattern_matching_over_mixed_type_check,
                editorConfigOptions,
                visualStudioOptions,
                updaterService,
                FileName
            ...
            yield return CodeStyleSetting.Create(
                ...
                description: CSharpVSResources.Prefer_extended_property_pattern,
                editorConfigOptions,
                visualStudioOptions,
                updaterService,
                FileName
        ...
        private IEnumerable<CodeStyleSetting> GetVariableCodeStyleOptions(
            AnalyzerConfigOptions editorConfigOptions,
            OptionSet visualStudioOptions,
            OptionUpdater updaterService
        )
        {
            yield return CodeStyleSetting.Create(
                ...
                description: ServicesVSResources.Prefer_inlined_variable_declaration,
                editorConfigOptions,
                visualStudioOptions,
                updaterService,
                FileName
            ...
            yield return CodeStyleSetting.Create(
                ...
                description: ServicesVSResources.Prefer_deconstructed_variable_declaration,
                editorConfigOptions,
                visualStudioOptions,
                updaterService,
                FileName
        ...
        private IEnumerable<CodeStyleSetting> GetExpressionBodyCodeStyleOptions(
            AnalyzerConfigOptions editorConfigOptions,
            OptionSet visualStudioOptions,
            OptionUpdater updaterService
        )
        {
            ...
            {
                CSharpVSResources.Never,
                CSharpVSResources.When_possible,
                CSharpVSResources.When_on_single_line
            };
            yield return CodeStyleSetting.Create(
        ...
        private IEnumerable<CodeStyleSetting> GetUnusedValueCodeStyleOptions(
            AnalyzerConfigOptions editorConfigOptions,
            OptionSet visualStudioOptions,
            OptionUpdater updaterService
        )
