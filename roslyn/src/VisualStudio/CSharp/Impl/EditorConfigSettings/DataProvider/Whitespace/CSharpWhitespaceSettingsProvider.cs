...
{
    internal sealed class CSharpWhitespaceSettingsProvider
        : SettingsProviderBase<Setting, OptionUpdater, IOption2, object>
    {
        ...
        public CSharpWhitespaceSettingsProvider(
            string filePath,
        ...
        private static IEnumerable<Setting> GetSpacingOptions(
            TieredAnalyzerConfigOptions options,
            OptionUpdater updaterService
        )
        {
            ...
            yield return Setting.Create(
                ...
                CSharpVSResources.Set_spacing_for_operators,
                options,
                updaterService
            );
        }

        private static IEnumerable<Setting> GetNewLineOptions(
            TieredAnalyzerConfigOptions options,
            OptionUpdater updaterService
        )
        {
        ...
        private static IEnumerable<Setting> GetIndentationOptions(
            TieredAnalyzerConfigOptions options,
            OptionUpdater updaterService
        )
        {
            ...
            yield return Setting.Create(
                ...
                CSharpVSResources.Label_Indentation,
                options,
                updaterService
            );
        }

        private static IEnumerable<Setting> GetWrappingOptions(
            TieredAnalyzerConfigOptions options,
            OptionUpdater updaterService
        )
        {
