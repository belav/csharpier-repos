...
namespace Microsoft.VisualStudio.LanguageServices.CSharp.ChangeSignature
{
    [
        ExportLanguageService(
            typeof(IChangeSignatureViewModelFactoryService),
        ...
        : ChangeSignatureViewModelFactoryService
    {
        ...
        )
        {
            ...
            var isPredefinedType =
                SyntaxFactory.ParseExpression(addedParameterViewModel.Type).Kind()
                == SyntaxKind.PredefinedType;
            var typePartKind = isPredefinedType
            ...
            parts.Add(
                new SymbolDisplayPart(
                    ...
                    null,
                    addedParameterViewModel.ParameterName
                )
            );
            ...
            if (!string.IsNullOrWhiteSpace(addedParameterViewModel.Default))
            {
                ...
                parts.Add(
                    new SymbolDisplayPart(
                        ...
                        null,
                        addedParameterViewModel.Default
                    )
                );
            }
