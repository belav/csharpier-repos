...
namespace Microsoft.CodeAnalysis.CSharp.UsePatternCombinators
{
        ...
        : AbstractBuiltInCodeStyleDiagnosticAnalyzer
    {
        ...
        private static readonly LocalizableResourceString s_safePatternTitle =
            new(
                nameof(CSharpAnalyzersResources.Use_pattern_matching),
                CSharpAnalyzersResources.ResourceManager,
                typeof(CSharpAnalyzersResources)
            );
        private static readonly LocalizableResourceString s_unsafePatternTitle =
            new(
        ...
        private void AnalyzeNode(SyntaxNodeAnalysisContext context)
        {
            ...
            var isSafe =
                UnwrapImplicitConversion(pattern.Target) is not Operations.IInvocationOperation;
