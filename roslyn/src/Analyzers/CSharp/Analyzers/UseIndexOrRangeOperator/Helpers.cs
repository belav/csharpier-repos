    ...
    internal static class Helpers
    {
        ...
        public static IPropertySymbol TryGetNoArgInt32Property(ITypeSymbol type, string name) =>
            type.GetMembers(name)
                ...
                .Where(p => IsPublicInstance(p) && p.Type.SpecialType == SpecialType.System_Int32)
                .FirstOrDefault();
        ...
        /// </summary>
        public static bool IsSubtraction(
            IOperation operation,
            [NotNullWhen(true)] out IBinaryOperation? subtraction
        )
        {
            if (
        ...
        /// name="returnType"/>.
        /// </summary>
        public static IPropertySymbol GetIndexer(
            ITypeSymbol type,
