        ...
        : AbstractBuiltInCodeStyleDiagnosticAnalyzer
    {
        ...
        protected override void InitializeWorker(AnalysisContext context)
        {
            context.RegisterCompilationStartAction(context =>
            {
                ...
                context.RegisterSyntaxNodeAction(
                    n => SyntaxNodeAction(n, expressionOfTType),
        ...
        )
        {
            ...
            var isKeywordLocation = parenthesizedExpression.Expression switch
            {
                ...
                } isPattern => isPattern.IsKeyword.GetLocation(),

                // Look for the form: !(x is Y)
                BinaryExpressionSyntax(SyntaxKind.IsExpression)
                {
                    Right: TypeSyntax
                } isExpression => isExpression.OperatorToken.GetLocation(),
            ...
            if (
                node.IsInExpressionTree(context.SemanticModel, expressionOfTType, cancellationToken)
            )
                return;
