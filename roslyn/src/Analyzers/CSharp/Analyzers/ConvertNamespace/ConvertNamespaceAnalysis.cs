...
namespace Microsoft.CodeAnalysis.CSharp.ConvertNamespace
{
    ...
    {
        public static (string title, string equivalenceKey) GetInfo(
            NamespaceDeclarationPreference preference
        ) =>
            preference switch
            {
        ...
        public static bool CanOfferUseBlockScoped(
            CodeStyleOption2<NamespaceDeclarationPreference> option,
            [NotNullWhen(true)] BaseNamespaceDeclarationSyntax? declaration,
            bool forAnalyzer
        )
        {
            ...
            var userPrefersRegularNamespaces =
            ...
            var canOffer =
                userPrefersRegularNamespaces == forAnalyzer || (forRefactoring && analyzerDisabled);
            return canOffer;
        }
        ...
        )
        {
            ...
            var userPrefersFileScopedNamespaces =
                option.Value == NamespaceDeclarationPreference.FileScoped;
            var analyzerDisabled = option.Notification.Severity == ReportDiagnostic.Suppress;
            var forRefactoring = !forAnalyzer;
            ...
            // If the analyzer is disabled completely, the refactoring is enabled in both directions.
            var canOffer =
                userPrefersFileScopedNamespaces == forAnalyzer
