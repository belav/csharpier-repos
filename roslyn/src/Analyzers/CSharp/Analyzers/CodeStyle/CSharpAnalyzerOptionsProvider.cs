...
)
{
    ...
    public CodeStyleOption2<bool> VarWhenTypeIsApparent =>
        GetOption(
            ...
            FallbackSimplifierOptions.VarWhenTypeIsApparent
        );
    ...
    public CodeStyleOption2<bool> PreferSimpleDefaultExpression =>
        GetOption(
            ...
            FallbackSimplifierOptions.PreferSimpleDefaultExpression
        );
    ...
    public CodeStyleOption2<PreferBracesPreference> PreferBraces =>
        GetOption(CSharpCodeStyleOptions.PreferBraces, FallbackSimplifierOptions.PreferBraces);
    ...
    public CodeStyleOption2<bool> ImplicitObjectCreationWhenTypeIsApparent =>
        GetOption(
            ...
            FallbackCodeStyleOptions.ImplicitObjectCreationWhenTypeIsApparent
        );
    ...
    public CodeStyleOption2<bool> AllowBlankLinesBetweenConsecutiveBraces =>
        GetOption(
            ...
            FallbackCodeStyleOptions.AllowBlankLinesBetweenConsecutiveBraces
        );
    public CodeStyleOption2<bool> AllowBlankLineAfterColonInConstructorInitializer =>
        GetOption(
            ...
            FallbackCodeStyleOptions.AllowBlankLineAfterColonInConstructorInitializer
        );
    public CodeStyleOption2<bool> AllowBlankLineAfterTokenInArrowExpressionClause =>
        GetOption(
            ...
            FallbackCodeStyleOptions.AllowBlankLineAfterTokenInArrowExpressionClause
        );
    ...
    public CodeStyleOption2<bool> PreferPatternMatchingOverIsWithCastCheck =>
        GetOption(
            ...
            FallbackCodeStyleOptions.PreferPatternMatchingOverIsWithCastCheck
        );
    ...
    public CodeStyleOption2<bool> PreferDeconstructedVariableDeclaration =>
        GetOption(
            ...
            FallbackCodeStyleOptions.PreferDeconstructedVariableDeclaration
        );
    ...
    public CodeStyleOption2<bool> PreferSimpleUsingStatement =>
        GetOption(
            ...
            FallbackCodeStyleOptions.PreferSimpleUsingStatement
        );
    public CodeStyleOption2<bool> PreferLocalOverAnonymousFunction =>
        GetOption(
            CSharpCodeStyleOptions.PreferLocalOverAnonymousFunction,
            FallbackCodeStyleOptions.PreferLocalOverAnonymousFunction
        );
    public CodeStyleOption2<bool> PreferTupleSwap =>
        GetOption(CSharpCodeStyleOptions.PreferTupleSwap, FallbackCodeStyleOptions.PreferTupleSwap);
    ...
    public CodeStyleOption2<ExpressionBodyPreference> PreferExpressionBodiedLambdas =>
        GetOption(
            ...
            FallbackCodeStyleOptions.PreferExpressionBodiedLambdas
        );
    ...
    private CSharpIdeCodeStyleOptions FallbackCodeStyleOptions =>
        (CSharpIdeCodeStyleOptions?)_fallbackOptions.CodeStyleOptions
        ?? CSharpIdeCodeStyleOptions.Default;

    private CSharpSimplifierOptions FallbackSimplifierOptions =>
        (CSharpSimplifierOptions?)_fallbackOptions.CleanupOptions?.SimplifierOptions
        ?? CSharpSimplifierOptions.Default;

    private CSharpSyntaxFormattingOptions FallbackSyntaxFormattingOptions =>
        (CSharpSyntaxFormattingOptions?)_fallbackOptions.CleanupOptions?.FormattingOptions
...
{
    public static CSharpAnalyzerOptionsProvider GetCSharpAnalyzerOptions(
    ...
    public static CSharpAnalyzerOptionsProvider GetCSharpAnalyzerOptions(
        this SymbolStartAnalysisContext context,
        SyntaxTree syntaxTree
