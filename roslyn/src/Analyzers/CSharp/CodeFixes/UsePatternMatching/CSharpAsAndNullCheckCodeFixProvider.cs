...
namespace Microsoft.CodeAnalysis.CSharp.UsePatternMatching
{
    ...
    partial internal class CSharpAsAndNullCheckCodeFixProvider : SyntaxEditorBasedCodeFixProvider
    {
        ...
        )
        {
            ...
            TypeSyntax GetPatternType()
            {
                ...
                {
                    var asExpressionTypeInfo = semanticModel.GetTypeInfo(
                        asExpression,
                        cancellationToken
                    );
                    if (asExpressionTypeInfo.Type != null)
                    {
                        ...
                        if (
                            SymbolEqualityComparer.Default.Equals(localType, asType)
