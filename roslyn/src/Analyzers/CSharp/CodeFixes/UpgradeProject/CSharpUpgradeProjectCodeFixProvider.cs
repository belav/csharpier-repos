...
namespace Microsoft.CodeAnalysis.CSharp.UpgradeProject
{
    [
        ExportCodeFixProvider(
            ...
            Name = PredefinedCodeFixProviderNames.UpgradeProject
        ),
        Shared
    ]
    internal class CSharpUpgradeProjectCodeFixProvider : AbstractUpgradeProjectCodeFixProvider
    {
        ...
        public override string UpgradeThisProjectResource =>
            CSharpCodeFixesResources.Upgrade_this_project_to_csharp_language_version_0;
        public override string UpgradeAllProjectsResource =>
            CSharpCodeFixesResources.Upgrade_all_csharp_projects_to_language_version_0;
        ...
        public override bool IsUpgrade(Project project, string newVersion)
        {
            ...
            return mappedVersion >= parseOptions.LanguageVersion
                ...
                && project.CanApplyParseOptionChange(
                    parseOptions,
                    parseOptions.WithLanguageVersion(parsedNewVersion)
                );
        }
