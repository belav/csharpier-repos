...
namespace Microsoft.CodeAnalysis.CSharp.UseInterpolatedVerbatimString
{
    ...
    [
        ExportCodeFixProvider(
            ...
            Name = PredefinedCodeFixProviderNames.UseInterpolatedVerbatimString
        ),
        Shared
    ]
        ...
        : SyntaxEditorBasedCodeFixProvider
    {
        ...
        public override Task RegisterCodeFixesAsync(CodeFixContext context)
        {
            RegisterCodeFix(
                context,
                CSharpCodeFixesResources.Use_interpolated_verbatim_string,
                nameof(CSharpCodeFixesResources.Use_interpolated_verbatim_string)
            );
        ...
        )
        {
            ...
            var newStartToken = SyntaxFactory.Token(
                oldStartToken.LeadingTrivia,
                SyntaxKind.InterpolatedVerbatimStringStartToken,
                InterpolatedVerbatimText,
                InterpolatedVerbatimText,
                oldStartToken.TrailingTrivia
            );
