...
namespace Microsoft.CodeAnalysis.CSharp.UseUtf8StringLiteral
{
    ...
    internal sealed class UseUtf8StringLiteralCodeFixProvider : SyntaxEditorBasedCodeFixProvider
    {
        ...
        )
        {
            ...
            var readOnlySpanType = semanticModel.Compilation.GetBestTypeByMetadataName(
            ...
            foreach (var diagnostic in diagnostics)
            {
                ...
                var isConvertedToReadOnlySpan =
                    arrayOp.Parent is IConversionOperation conversion
                ...
                else
                {
                    editor.ReplaceNode(
                        node,
                        CreateUtf8String(node, stringValue, isConvertedToReadOnlySpan)
                    );
                }
            }
        }

        private static IArrayCreationOperation GetArrayCreationOperation(
        ...
        private static string GetUtf8StringValueFromArrayInitializer(
