...
namespace Microsoft.CodeAnalysis.CSharp.RemoveAsyncModifier
{
    [
        ExportCodeFixProvider(
            ...
            Name = PredefinedCodeFixProviderNames.RemoveAsyncModifier
        ),
        Shared
    ]
    ...
    internal partial class CSharpRemoveAsyncModifierCodeFixProvider
        : AbstractRemoveAsyncModifierCodeFixProvider<ReturnStatementSyntax, ExpressionSyntax>
    {
        ...
        protected override SyntaxNode RemoveAsyncModifier(
            SyntaxGenerator generator,
            SyntaxNode methodLikeNode
        ) =>
            methodLikeNode switch
            {
                MethodDeclarationSyntax method => RemoveAsyncModifierHelpers.WithoutAsyncModifier(
                    method,
                    method.ReturnType
                ),
                ...
                AnonymousMethodExpressionSyntax method => AnnotateBlock(
                    generator,
                    RemoveAsyncModifierHelpers.WithoutAsyncModifier(method)
                ),
                ParenthesizedLambdaExpressionSyntax lambda => AnnotateBlock(
                    generator,
                    RemoveAsyncModifierHelpers.WithoutAsyncModifier(lambda)
                ),
                SimpleLambdaExpressionSyntax lambda => AnnotateBlock(
                    generator,
                    RemoveAsyncModifierHelpers.WithoutAsyncModifier(lambda)
                ),
                _ => methodLikeNode,
