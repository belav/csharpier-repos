                ...
                @"class C
{
    ...
    int M2() => 0;
            ...
            {
                (UnusedValuePreference.DiscardVariable, CodeFixTestBehaviors.None) => @"class C
{
    int M(int {|IDE0060:x|}, int {|IDE0060:y|})
    {
        _ = _ = M2();
                ...
                ) => @"class C
{
    ...
    int M2() => 0;
                ...
                (UnusedValuePreference.UnusedLocalVariable, CodeFixTestBehaviors.None) => @"class C
{
    int M(int {|IDE0060:x|}, int {|IDE0060:y|})
    {
        int unused1;
    ...
    {{
        var {{|#0:y|}} = {prefix}x{postfix};
            ...
            var fixedSource = (UnusedValuePreference)option switch
            {
                ...
                UnusedValuePreference.DiscardVariable => $@"class C
{{
    void M(int x)
    {{
        _ = {prefix}x{postfix};
    ...
    bool M(object p1, object p2)
    {
        ...
        return isZero;
            ...
            var fixedSource = testBehaviors switch
            {
                ...
                CodeFixTestBehaviors.FixOne => @"class C
{
    bool M(object p1, object p2)
    {
                ...
                ) => @"class C
{
    ...
    bool M2(int {|IDE0060:x|})
    {
        return false;
                ...
                (UnusedValuePreference.UnusedLocalVariable, _) => @"class C
{
    bool M(object p1, object p2)
    {
        int x1;
