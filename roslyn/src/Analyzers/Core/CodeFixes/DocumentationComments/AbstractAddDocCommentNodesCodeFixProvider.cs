...
namespace Microsoft.CodeAnalysis.DocumentationComments
{
        ...
        where TMemberDeclarationSyntax : SyntaxNode
    {
        ...
        protected abstract ImmutableArray<string> GetParameterNames(
            TMemberDeclarationSyntax method
        );
        ...
        protected async Task<Document> AddParamTagAsync(
            Document document,
            TMemberDeclarationSyntax parentMethod,
            SyntaxNode docCommentNode,
        ...
        )
        {
            ...
            for (var index = 0; index < parameterNames.Length; index++)
            {
                ...
                if (
                    indexOfNode > 0
                    && paramNodeSiblings[indexOfNode - 1] is TXmlTextSyntax previousSibling
                )
