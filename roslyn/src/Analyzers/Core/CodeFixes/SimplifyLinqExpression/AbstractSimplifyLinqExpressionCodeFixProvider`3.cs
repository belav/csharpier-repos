...
{
    internal abstract class AbstractSimplifyLinqExpressionCodeFixProvider<
        ...
        where TSimpleNameSyntax : TExpressionSyntax
    {
        ...
        )
        {
            ...
            var expressionsToReWrite = diagnostics
                .Select(d => GetInvocation(root, d))
            ...
            (
                ...
                TSimpleNameSyntax Name,
                SeparatedSyntaxList<SyntaxNode> Arguments
            ) FindNodes(TInvocationExpressionSyntax current)
            {
