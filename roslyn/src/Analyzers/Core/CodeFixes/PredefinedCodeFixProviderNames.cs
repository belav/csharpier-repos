...
namespace Microsoft.CodeAnalysis.CodeFixes
{
    internal static class PredefinedCodeFixProviderNames
    {
        ...
        public const string AddParenthesesAroundConditionalExpressionInInterpolatedString =
            nameof(AddParenthesesAroundConditionalExpressionInInterpolatedString);
        ...
        public const string RemoveUnnecessaryAttributeSuppressions =
            nameof(RemoveUnnecessaryAttributeSuppressions);
        public const string RemoveUnnecessaryPragmaSuppressions =
            nameof(RemoveUnnecessaryPragmaSuppressions);
        ...
        public const string UseConditionalExpressionForAssignment =
            nameof(UseConditionalExpressionForAssignment);
        public const string UseConditionalExpressionForReturn =
            nameof(UseConditionalExpressionForReturn);
        ...
        public const string ConvertSwitchStatementToExpression =
            nameof(ConvertSwitchStatementToExpression);
        public const string InvokeDelegateWithConditionalAccess =
            nameof(InvokeDelegateWithConditionalAccess);
        ...
        public const string ConstructorInitializerPlacement =
            nameof(ConstructorInitializerPlacement);
        ...
        public const string RemoveUnnecessaryDiscardDesignation =
            nameof(RemoveUnnecessaryDiscardDesignation);
        ...
        public const string UseCoalesceExpressionForNullable =
            nameof(UseCoalesceExpressionForNullable);
        ...
        public const string UseIsNullCheckForCastAndEqualityOperator =
            nameof(UseIsNullCheckForCastAndEqualityOperator);
        public const string UseIsNullCheckForReferenceEquals =
            nameof(UseIsNullCheckForReferenceEquals);
        public const string UsePatternMatchingIsAndCastCheckWithoutName =
            nameof(UsePatternMatchingIsAndCastCheckWithoutName);
        public const string UsePatternMatchingIsAndCastCheck =
            nameof(UsePatternMatchingIsAndCastCheck);
        public const string UsePatternMatchingAsAndNullCheck =
            nameof(UsePatternMatchingAsAndNullCheck);
