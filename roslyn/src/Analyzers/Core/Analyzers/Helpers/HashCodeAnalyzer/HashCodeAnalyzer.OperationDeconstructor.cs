...
{
    partial internal struct HashCodeAnalyzer
    {
        /// <summary>
        ...
        private struct OperationDeconstructor : IDisposable
        {
            ...
            public void Dispose() => _hashedSymbols.Free();
            ...
            public bool TryAddHashedSymbol(IOperation value, bool seenHash)
            {
                ...
                switch (value)
                {
                    ...
                    case IInvocationOperation invocation:
                        ...
                        if (
                            targetMethod.Name == nameof(GetHashCode)
                            && Equals(
                                _analyzer._equalityComparerType,
                ...
                {
                    if (
                        value is IInstanceReferenceOperation instanceReference
                    ...
                    // way
                    if (
                        TryGetFieldOrProperty(value, out var fieldOrProp)
                        && Equals(
