...
namespace Microsoft.CodeAnalysis.PopulateSwitch
{
    internal static class PopulateSwitchExpressionHelpers
    {
        ...
        public static bool IsDefault(ISwitchExpressionArmOperation arm) => IsDefault(arm.Pattern);
        ...
        private static bool IsDefault(IPatternOperation pattern) =>
            pattern switch
            {
                ...
                {
                    // x or _ => ...
                    BinaryOperatorKind.Or => IsDefault(binaryPattern.LeftPattern)
                        || IsDefault(binaryPattern.RightPattern),
                    // _ and var x => ...
                    BinaryOperatorKind.And => IsDefault(binaryPattern.LeftPattern)
                        && IsDefault(binaryPattern.RightPattern),
                    _ => false,
                },
                _ => false,
