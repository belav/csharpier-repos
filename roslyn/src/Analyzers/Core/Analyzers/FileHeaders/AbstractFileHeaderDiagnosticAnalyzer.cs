...
namespace Microsoft.CodeAnalysis.FileHeaders
{
        ...
        : AbstractBuiltInCodeStyleDiagnosticAnalyzer
    {
            ...
            )
        {
            ...
            var invalidHeaderMessage = new LocalizableResourceString(
                nameof(
            ...
            InvalidHeaderDescriptor = CreateDescriptorWithId(
                DescriptorId,
                EnforceOnBuildValues.FileHeaderMismatch,
                invalidHeaderTitle,
        ...
        private void HandleSyntaxTree(SyntaxTreeAnalysisContext context)
        {
            ...
            if (fileHeader.IsMissing)
            {
                context.ReportDiagnostic(
                    Diagnostic.Create(MissingHeaderDescriptor, fileHeader.GetLocation(tree))
                );
                return;
            }
            ...
            {
                context.ReportDiagnostic(
                    Diagnostic.Create(InvalidHeaderDescriptor, fileHeader.GetLocation(tree))
                );
                return;
            }
        }
