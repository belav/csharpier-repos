...
namespace Microsoft.CodeAnalysis.SimplifyInterpolation
{
    ...
    {
        private static SyntaxNode GetPreservedInterpolationExpressionSyntax<
          ...
          where TParenthesizedExpressionSyntax : TExpressionSyntax
        {
            ...
            unwrapped =
                GetPreservedInterpolationExpressionSyntax<
                    TConditionalExpressionSyntax,
                    TParenthesizedExpressionSyntax
                >(expression) as TExpressionSyntax;

            unnecessaryLocations = unnecessarySpans.OrderBy(t => t.Start)
          ...
          where TParenthesizedExpressionSyntax : SyntaxNode
        {
            if (
                ...
                if (
                    ...
                    var unwrappedSyntax = GetPreservedInterpolationExpressionSyntax<
                        TConditionalExpressionSyntax,
                        TParenthesizedExpressionSyntax
                    >(unwrapped);
