...
namespace Microsoft.CodeAnalysis.Collections
{
    internal partial struct ImmutableSegmentedList<T>
    {
        public sealed class Builder : IList<T>, IReadOnlyList<T>, IList
        {
            ...
            internal Builder(ImmutableSegmentedList<T> list) => _builder = new ValueBuilder(list);
            ...
            /// <inheritdoc
            // cref="System.Collections.Immutable.ImmutableList{T}.Builder.AddRange(IEnumerable{T})"/>
            ...
            public int BinarySearch(T item) => _builder.BinarySearch(item);
            ...
            /// <inheritdoc cref="System.Collections.Immutable.ImmutableList{T}.Builder.BinarySearch(int, int,
            // T, IComparer{T}?)"/>
            ...
            /// <inheritdoc
            // cref="System.Collections.Immutable.ImmutableList{T}.Builder.ConvertAll{TOutput}(Func{T, TOutput})"/>
            ...
            public void CopyTo(T[] array) => _builder.CopyTo(array);

            public void CopyTo(T[] array, int arrayIndex) => _builder.CopyTo(array, arrayIndex);

            /// <inheritdoc cref="System.Collections.Immutable.ImmutableList{T}.Builder.CopyTo(int, T[], int,
            // int)"/>
            ...
            public bool Exists(Predicate<T> match) => _builder.Exists(match);

            /// <inheritdoc cref="System.Collections.Immutable.ImmutableList{T}.Builder.Find(Predicate{T})"/>
            public T? Find(Predicate<T> match) => _builder.Find(match);

            /// <inheritdoc cref="System.Collections.Immutable.ImmutableList{T}.Builder.FindAll(Predicate{T})"/>
            public ImmutableSegmentedList<T> FindAll(Predicate<T> match) => _builder.FindAll(match);

            /// <inheritdoc
            // cref="System.Collections.Immutable.ImmutableList{T}.Builder.FindIndex(Predicate{T})"/>
            public int FindIndex(Predicate<T> match) => _builder.FindIndex(match);

            /// <inheritdoc cref="System.Collections.Immutable.ImmutableList{T}.Builder.FindIndex(int,
            // Predicate{T})"/>
            public int FindIndex(int startIndex, Predicate<T> match) =>
                _builder.FindIndex(startIndex, match);

            /// <inheritdoc cref="System.Collections.Immutable.ImmutableList{T}.Builder.FindIndex(int, int,
            // Predicate{T})"/>
            public int FindIndex(int startIndex, int count, Predicate<T> match) =>
                _builder.FindIndex(startIndex, count, match);

            /// <inheritdoc
            // cref="System.Collections.Immutable.ImmutableList{T}.Builder.FindLast(Predicate{T})"/>
            public T? FindLast(Predicate<T> match) => _builder.FindLast(match);

            /// <inheritdoc
            // cref="System.Collections.Immutable.ImmutableList{T}.Builder.FindLastIndex(Predicate{T})"/>
            public int FindLastIndex(Predicate<T> match) => _builder.FindLastIndex(match);

            /// <inheritdoc cref="System.Collections.Immutable.ImmutableList{T}.Builder.FindLastIndex(int,
            // Predicate{T})"/>
            public int FindLastIndex(int startIndex, Predicate<T> match) =>
                _builder.FindLastIndex(startIndex, match);

            /// <inheritdoc cref="System.Collections.Immutable.ImmutableList{T}.Builder.FindLastIndex(int, int,
            // Predicate{T})"/>
            ...
            public void ForEach(Action<T> action) => _builder.ForEach(action);

            /// <inheritdoc cref="System.Collections.Immutable.ImmutableList{T}.Builder.GetEnumerator()"/>
            public Enumerator GetEnumerator() => _builder.GetEnumerator();
            ...
            public int IndexOf(T item, int index) => _builder.IndexOf(item, index);
            ...
            /// <inheritdoc cref="System.Collections.Immutable.ImmutableList{T}.Builder.InsertRange(int,
            // IEnumerable{T})"/>
            ...
            /// <inheritdoc
            // cref="System.Collections.Immutable.ImmutableList{T}.Builder.RemoveAll(Predicate{T})"/>
            public int RemoveAll(Predicate<T> match) => _builder.RemoveAll(match);
            ...
            public void Reverse(int index, int count) => _builder.Reverse(index, count);
            ...
            /// <inheritdoc cref="System.Collections.Immutable.ImmutableList{T}.Builder.Sort(int, int,
            // IComparer{T}?)"/>
            ...
            public ImmutableSegmentedList<T> ToImmutable() => _builder.ToImmutable();

            /// <inheritdoc
            // cref="System.Collections.Immutable.ImmutableList{T}.Builder.TrueForAll(Predicate{T})"/>
            public bool TrueForAll(Predicate<T> match) => _builder.TrueForAll(match);

            IEnumerator<T> IEnumerable<T>.GetEnumerator() =>
                IEnumerableCalls<T>.GetEnumerator(ref _builder);

            IEnumerator IEnumerable.GetEnumerator() => IEnumerableCalls.GetEnumerator(ref _builder);

            int IList.Add(object? value) => IListCalls.Add(ref _builder, value);

            bool IList.Contains(object? value) => IListCalls.Contains(ref _builder, value);

            int IList.IndexOf(object? value) => IListCalls.IndexOf(ref _builder, value);

            void IList.Insert(int index, object? value) =>
                IListCalls.Insert(ref _builder, index, value);

            void IList.Remove(object? value) => IListCalls.Remove(ref _builder, value);
