...
namespace Microsoft.CodeAnalysis.CSharp.UnitTests.Formatting
{
    public class EditorConfigOptionParserTests
    {
        [
            ...
            InlineData(
                "expressions ,  ,  , control_flow_statements",
                (int)SpacingWithinParenthesesOption.Expressions
            ),
            InlineData(
                ",  ,  , control_flow_statements",
                (int)SpacingWithinParenthesesOption.ControlFlowStatements
        ...
        {
            Assert.True(
                ParseEditorConfigSpacingAroundBinaryOperator(value)
        ...
        {
            Assert.True(
                ParseEditorConfigLabelPositioning(value) == LabelPositionOptions.NoIndent,
        ...
        [
            ...
            InlineData(
                ...
                (int)NewLineOption.ObjectCollectionsArrayInitializers
            ),
            InlineData(
        ...
        {
            Assert.True(
                DetermineIfNewLineOptionIsSet(value, (NewLineOption)option),
