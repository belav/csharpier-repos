...
class B
{
                ...
                attributeLists: SyntaxFactory.SingletonList<AttributeListSyntax>(
                    SyntaxFactory.AttributeList(
                        ...
                        SyntaxFactory.SingletonSeparatedList<AttributeSyntax>(
                            SyntaxFactory.Attribute(SyntaxFactory.ParseName("My"))
                        ),
            ...
            var newCompilation = Formatter.Format(
                compilation,
                workspace.Services,
...
";
            ...
            var decl = generator.GetDeclaration(
                root.DescendantNodes()
                    .OfType<VariableDeclaratorSyntax>()
                    .First(vd => vd.Identifier.Text == "f2")
            );
            var newDecl = generator
                .AddAttributes(decl, generator.Attribute("Some"))
...
";
            ...
            var formatted = Formatter
                .Format(newRoot, workspace.Services, options, CancellationToken.None)
                .ToFullString();
            ...
            var annotationFormatted = Formatter
                .Format(
                    newRoot,
