...
namespace Microsoft.CodeAnalysis.CSharp.UnitTests.EmbeddedLanguages.VirtualChars
{
    public class CSharpVirtualCharServiceTests
    {
        ...
        )
        {
            ...
            else if (expression is InterpolatedStringExpressionSyntax interpolation)
            {
                return interpolation
                    .Contents.OfType<InterpolatedStringTextSyntax>()
        ...
        private static void Test(string stringText, string expected, ParseOptions? options = null)
        {
            ...
            var virtualCharsArray = tokens.Select(
                CSharpVirtualCharService.Instance.TryConvertToVirtualChars
            );
        ...
        public void TestRawStringInSkippedToken()
        {
            ...
            var skippedTrivia = namespaceDeclaration.OpenBraceToken.TrailingTrivia.Single(t =>
                t.Kind() is SyntaxKind.SkippedTokensTrivia
            );
            var virtualChars = CSharpVirtualCharService.Instance.TryConvertToVirtualChars(
                skippedTrivia.Token
            );
        ...
        [Fact]
        public void TestEscapeInInterpolatedSimpleString_E() => TestFailure("$\"\\e\"");
        ...
        [Fact]
        public void TestSurrogate1() => Test(@"""😊""", @"['\U0001F60A',[1,3]]");

        [Fact]
        public void TestSurrogate2() => Test(@"""\U0001F60A""", @"['\U0001F60A',[1,11]]");

        [Fact]
        public void TestSurrogate3() => Test(@"""\ud83d\ude0a""", @"['\U0001F60A',[1,13]]");

        [Fact]
        public void TestHighSurrogate() => Test(@"""\ud83d""", @"['\uD83D',[1,7]]");

        [Fact]
        public void TestLowSurrogate() => Test(@"""\ude0a""", @"['\uDE0A',[1,7]]");

        [Fact]
        public void TestMixedSurrogate1() => Test("\"\ud83d\\ude0a\"", @"['\U0001F60A',[1,8]]");

        [Fact]
        public void TestMixedSurrogate2() => Test("\"\\ud83d\ude0a\"", @"['\U0001F60A',[1,8]]");
