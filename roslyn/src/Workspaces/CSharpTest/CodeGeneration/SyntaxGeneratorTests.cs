...
namespace Microsoft.CodeAnalysis.CSharp.UnitTests.Editing
{
    ...
    {
        private readonly CSharpCompilation _emptyCompilation = CSharpCompilation.Create(
            "empty",
        ...
        private Workspace Workspace => _workspace ??= new AdhocWorkspace();
        ...
        public static Compilation Compile(string code)
        {
            return CSharpCompilation
                ...
                .AddReferences(
                    ...
                    TestMetadata.Net451.SystemRuntime,
                    TestReferences.NetFx.ValueTuple.tuplelib
                )
                .AddSyntaxTrees(SyntaxFactory.ParseSyntaxTree(code));
        }

        private static void VerifySyntax<TSyntax>(SyntaxNode node, string expectedText)
        ...
        private static void VerifySyntaxRaw<TSyntax>(SyntaxNode node, string expectedText)
            where TSyntax : SyntaxNode
        {
            Assert.IsAssignableFrom<TSyntax>(node);
        ...
        public void TestLiteralExpressions()
        {
            ...
            VerifySyntax<MemberAccessExpressionSyntax>(
                Generator.LiteralExpression(int.MinValue),
                "global::System.Int32.MinValue"
            );
            VerifySyntax<MemberAccessExpressionSyntax>(
                Generator.LiteralExpression(int.MaxValue),
            ...
            VerifySyntax<MemberAccessExpressionSyntax>(
                Generator.LiteralExpression(long.MinValue),
                "global::System.Int64.MinValue"
            );
            VerifySyntax<MemberAccessExpressionSyntax>(
                Generator.LiteralExpression(long.MaxValue),
            ...
            VerifySyntax<LiteralExpressionSyntax>(
                Generator.LiteralExpression(ulong.MinValue),
                "0UL"
            );
            VerifySyntax<MemberAccessExpressionSyntax>(
                Generator.LiteralExpression(ulong.MaxValue),
            ...
            VerifySyntax<MemberAccessExpressionSyntax>(
                Generator.LiteralExpression(float.MinValue),
                "global::System.Single.MinValue"
            );
            VerifySyntax<MemberAccessExpressionSyntax>(
                Generator.LiteralExpression(float.MaxValue),
                "global::System.Single.MaxValue"
            );
            VerifySyntax<MemberAccessExpressionSyntax>(
                Generator.LiteralExpression(float.Epsilon),
                "global::System.Single.Epsilon"
            );
            VerifySyntax<MemberAccessExpressionSyntax>(
                Generator.LiteralExpression(float.NaN),
                "global::System.Single.NaN"
            );
            VerifySyntax<MemberAccessExpressionSyntax>(
                Generator.LiteralExpression(float.NegativeInfinity),
                "global::System.Single.NegativeInfinity"
            );
            VerifySyntax<MemberAccessExpressionSyntax>(
                Generator.LiteralExpression(float.PositiveInfinity),
            ...
            VerifySyntax<MemberAccessExpressionSyntax>(
                Generator.LiteralExpression(double.MinValue),
                "global::System.Double.MinValue"
            );
            VerifySyntax<MemberAccessExpressionSyntax>(
                Generator.LiteralExpression(double.MaxValue),
                "global::System.Double.MaxValue"
            );
            VerifySyntax<MemberAccessExpressionSyntax>(
                Generator.LiteralExpression(double.Epsilon),
                "global::System.Double.Epsilon"
            );
            VerifySyntax<MemberAccessExpressionSyntax>(
                Generator.LiteralExpression(double.NaN),
                "global::System.Double.NaN"
            );
            VerifySyntax<MemberAccessExpressionSyntax>(
                Generator.LiteralExpression(double.NegativeInfinity),
                "global::System.Double.NegativeInfinity"
            );
            VerifySyntax<MemberAccessExpressionSyntax>(
                Generator.LiteralExpression(double.PositiveInfinity),
            ...
            VerifySyntax<PrefixUnaryExpressionSyntax>(
                Generator.LiteralExpression(-1.00m),
                "-1.00M"
            );
            VerifySyntax<LiteralExpressionSyntax>(
                Generator.LiteralExpression(1.0000000000m),
                "1.0000000000M"
            );
            VerifySyntax<LiteralExpressionSyntax>(
                Generator.LiteralExpression(0.000000m),
                "0.000000M"
            );
            VerifySyntax<LiteralExpressionSyntax>(
                Generator.LiteralExpression(0.0000000m),
                "0.0000000M"
            );
            VerifySyntax<LiteralExpressionSyntax>(
                Generator.LiteralExpression(1000000000m),
                "1000000000M"
            );
            VerifySyntax<LiteralExpressionSyntax>(
                Generator.LiteralExpression(123456789.123456789m),
                "123456789.123456789M"
            );
            VerifySyntax<LiteralExpressionSyntax>(
                Generator.LiteralExpression(1E-28m),
                "0.0000000000000000000000000001M"
            );
            VerifySyntax<LiteralExpressionSyntax>(
                Generator.LiteralExpression(0E-28m),
                "0.0000000000000000000000000000M"
            );
            VerifySyntax<LiteralExpressionSyntax>(
                Generator.LiteralExpression(1E-29m),
                "0.0000000000000000000000000000M"
            );
            VerifySyntax<LiteralExpressionSyntax>(
                Generator.LiteralExpression(-1E-29m),
            ...
            VerifySyntax<MemberAccessExpressionSyntax>(
                Generator.LiteralExpression(decimal.MaxValue),
            ...
            VerifySyntax<LiteralExpressionSyntax>(
                Generator.LiteralExpression("s\"t\"r"),
                "\"s\\\"t\\\"r\""
            );
        ...
        public void TestShortLiteralExpressions()
        {
            ...
            VerifySyntax<MemberAccessExpressionSyntax>(
                Generator.LiteralExpression(short.MinValue),
                "global::System.Int16.MinValue"
            );
            VerifySyntax<MemberAccessExpressionSyntax>(
                Generator.LiteralExpression(short.MaxValue),
        ...
        public void TestUshortLiteralExpressions()
        {
            ...
            VerifySyntax<LiteralExpressionSyntax>(
                Generator.LiteralExpression(ushort.MinValue),
                "0"
            );
            VerifySyntax<MemberAccessExpressionSyntax>(
                Generator.LiteralExpression(ushort.MaxValue),
        ...
        public void TestSbyteLiteralExpressions()
        {
            ...
            VerifySyntax<MemberAccessExpressionSyntax>(
                Generator.LiteralExpression(sbyte.MinValue),
                "global::System.SByte.MinValue"
            );
            VerifySyntax<MemberAccessExpressionSyntax>(
                Generator.LiteralExpression(sbyte.MaxValue),
        ...
        public void TestByteLiteralExpressions()
        {
            ...
            VerifySyntax<LiteralExpressionSyntax>(
                Generator.LiteralExpression(byte.MaxValue),
                "255"
            );
        }
...
public class MyAttribute : Attribute { public int Value {get; set;} }",
            ...
            var attributes = Generator.GetAttributes(
        ...
        public void TestNameExpressions()
        {
            ...
            VerifySyntax<QualifiedNameSyntax>(
            ...
            VerifySyntax<GenericNameSyntax>(
                Generator.GenericName("x", Generator.IdentifierName("y")),
                "x<y>"
            );
            VerifySyntax<GenericNameSyntax>(
            ...
            var gname = Generator.WithTypeArguments(
                Generator.IdentifierName("x"),
                Generator.IdentifierName("y")
            );
            VerifySyntax<GenericNameSyntax>(gname, "x<y>");
            VerifySyntax<GenericNameSyntax>(
                Generator.WithTypeArguments(gname, Generator.IdentifierName("z")),
                "x<z>"
            );
        }
        ...
        public void TestTypeExpressions()
        {
            ...
            VerifySyntax<TypeSyntax>(
                Generator.ArrayTypeExpression(Generator.IdentifierName("x")),
                "x[]"
            );
            VerifySyntax<TypeSyntax>(
            ...
            VerifySyntax<TypeSyntax>(
                Generator.NullableTypeExpression(Generator.IdentifierName("x")),
                "x?"
            );
            VerifySyntax<TypeSyntax>(
                Generator.NullableTypeExpression(
                    Generator.NullableTypeExpression(Generator.IdentifierName("x"))
                ),
                "x?"
            );
            ...
            VerifySyntax<TupleElementSyntax>(
                Generator.TupleElementExpression(Generator.IdentifierName("x")),
                "x"
            );
            VerifySyntax<TupleElementSyntax>(
                Generator.TupleElementExpression(Generator.IdentifierName("x"), "y"),
                "x y"
            );
            VerifySyntax<TupleElementSyntax>(
                Generator.TupleElementExpression(intType),
                "global::System.Int32"
            );
            VerifySyntax<TupleElementSyntax>(
                Generator.TupleElementExpression(intType, "y"),
                "global::System.Int32 y"
            );
            VerifySyntax<TypeSyntax>(
                Generator.TupleTypeExpression(
                    Generator.TupleElementExpression(Generator.IdentifierName("x")),
                    Generator.TupleElementExpression(Generator.IdentifierName("y"))
                ),
                "(x, y)"
            );
            VerifySyntax<TypeSyntax>(
                Generator.TupleTypeExpression(new[] { intType, intType }),
                "(global::System.Int32, global::System.Int32)"
            );
            VerifySyntax<TypeSyntax>(
                Generator.TupleTypeExpression(new[] { intType, intType }, new[] { "x", "y" }),
        ...
        public void TestSpecialTypeExpression()
        {
            ...
            VerifySyntax<TypeSyntax>(
                Generator.TypeExpression(SpecialType.System_Decimal),
                "decimal"
            );
        }
        ...
        {
            var genericType = _emptyCompilation.GetSpecialType(
                SpecialType.System_Collections_Generic_IEnumerable_T
            );
            VerifySyntax<QualifiedNameSyntax>(
                Generator.TypeExpression(genericType),
                "global::System.Collections.Generic.IEnumerable<T>"
            );

            var arrayType = _emptyCompilation.CreateArrayTypeSymbol(
                _emptyCompilation.GetSpecialType(SpecialType.System_Int32)
            );
            VerifySyntax<ArrayTypeSyntax>(
        ...
        {
            VerifySyntax<PrefixUnaryExpressionSyntax>(
                Generator.NegateExpression(Generator.IdentifierName("x")),
                "-(x)"
            );
            VerifySyntax<BinaryExpressionSyntax>(
            ...
            VerifySyntax<PrefixUnaryExpressionSyntax>(
                Generator.BitwiseNotExpression(Generator.IdentifierName("x")),
                "~(x)"
            );
            VerifySyntax<BinaryExpressionSyntax>(
                Generator.BitwiseAndExpression(
                    Generator.IdentifierName("x"),
                    Generator.IdentifierName("y")
                ),
                "(x) & (y)"
            ...
            VerifySyntax<PrefixUnaryExpressionSyntax>(
                Generator.LogicalNotExpression(Generator.IdentifierName("x")),
                "!(x)"
            );
            VerifySyntax<BinaryExpressionSyntax>(
        ...
        public void TestConditionalExpressions()
        {
            ...
            VerifySyntax<ConditionalExpressionSyntax>(
        ...
        public void TestMemberAccessExpressions()
        {
            ...
            VerifySyntax<MemberAccessExpressionSyntax>(
                Generator.MemberAccessExpression(Generator.IdentifierName("x"), "y"),
                "x.y"
            );
            VerifySyntax<MemberAccessExpressionSyntax>(
                Generator.MemberAccessExpression(
        ...
        public void TestArrayCreationExpressions()
        {
            VerifySyntax<ArrayCreationExpressionSyntax>(
                Generator.ArrayCreationExpression(
                    Generator.IdentifierName("x"),
                    Generator.LiteralExpression(10)
                ),
                "new x[10]"
            );
        ...
        public void TestObjectCreationExpressions()
        {
            ...
            var intType = _emptyCompilation.GetSpecialType(SpecialType.System_Int32);
            var listType = _emptyCompilation.GetTypeByMetadataName(
            ...
            ); // should this be 'int' or if not shouldn't it have global::?
        }
        ...
        {
            VerifySyntax<CastExpressionSyntax>(
        ...
        public void TestIsAndAsExpressions()
        {
            ...
            VerifySyntax<TypeOfExpressionSyntax>(
                Generator.TypeOfExpression(Generator.IdentifierName("x")),
                "typeof(x)"
            );
        }
        ...
        public void TestInvocationExpressions()
        {
            ...
            VerifySyntax<InvocationExpressionSyntax>(
                Generator.InvocationExpression(Generator.IdentifierName("x")),
                "x()"
            );
            VerifySyntax<InvocationExpressionSyntax>(
                Generator.InvocationExpression(
            ...
            VerifySyntax<InvocationExpressionSyntax>(
                Generator.InvocationExpression(
                    Generator.IdentifierName("x"),
                    Generator.Argument(Generator.IdentifierName("y"))
                ),
                "x(y)"
            );
            VerifySyntax<InvocationExpressionSyntax>(
                Generator.InvocationExpression(
                    Generator.IdentifierName("x"),
                    Generator.Argument(RefKind.Ref, Generator.IdentifierName("y"))
                ),
                "x(ref y)"
            );
            VerifySyntax<InvocationExpressionSyntax>(
                Generator.InvocationExpression(
                    Generator.IdentifierName("x"),
                    Generator.Argument(RefKind.Out, Generator.IdentifierName("y"))
                ),
                "x(out y)"
            );
        ...
        {
            VerifySyntax<ExpressionStatementSyntax>(
                Generator.ExpressionStatement(Generator.IdentifierName("x")),
                "x;"
            );
            VerifySyntax<ExpressionStatementSyntax>(
        ...
        {
            VerifySyntax<LocalDeclarationStatementSyntax>(
                Generator.LocalDeclarationStatement(Generator.IdentifierName("x"), "y"),
                "x y;"
            );
            VerifySyntax<LocalDeclarationStatementSyntax>(
            ...
            VerifySyntax<LocalDeclarationStatementSyntax>(
                Generator.LocalDeclarationStatement("y", Generator.IdentifierName("z")),
                "var y = z;"
            );
        }
        ...
        public void TestAddHandlerExpressions()
        {
            VerifySyntax<AssignmentExpressionSyntax>(
                Generator.AddEventHandler(
                    Generator.IdentifierName("@event"),
                    Generator.IdentifierName("handler")
                ),
                "@event += (handler)"
            );
        }
        ...
        public void TestAwaitExpressions() =>
            VerifySyntax<AwaitExpressionSyntax>(
                Generator.AwaitExpression(Generator.IdentifierName("x")),
                "await x"
            );
        ...
        public void TestNameOfExpressions() =>
            VerifySyntax<InvocationExpressionSyntax>(
                Generator.NameOfExpression(Generator.IdentifierName("x")),
                "nameof(x)"
            );
        ...
        {
            VerifySyntax<TupleExpressionSyntax>(
                Generator.TupleExpression(
                    new[] { Generator.IdentifierName("x"), Generator.IdentifierName("y") }
                ),
                "(x, y)"
            );
            ...
            VerifySyntax<TupleExpressionSyntax>(
                Generator.TupleExpression(
                    new[]
                    {
                        ...
                        Generator.Argument("bar", RefKind.None, Generator.IdentifierName("y")),
                    }
                ),
                "(goo: x, bar: y)"
            );
        ...
        public void TestReturnStatements()
        {
            ...
            VerifySyntax<ReturnStatementSyntax>(
                Generator.ReturnStatement(Generator.IdentifierName("x")),
                "return x;"
            );
        }
        ...
        {
            VerifySyntax<YieldStatementSyntax>(
                Generator.YieldReturnStatement(Generator.LiteralExpression(1)),
                "yield return 1;"
            );
            VerifySyntax<YieldStatementSyntax>(
                Generator.YieldReturnStatement(Generator.IdentifierName("x")),
                "yield return x;"
            );
        }
        ...
        public void TestThrowStatements()
        {
            ...
            VerifySyntax<ThrowStatementSyntax>(
                Generator.ThrowStatement(Generator.IdentifierName("x")),
                "throw x;"
            );
        }
        ...
        public void TestIfStatements()
        {
            ...
            VerifySyntax<IfStatementSyntax>(
                Generator.IfStatement(
                    ...
                    new SyntaxNode[] { Generator.IdentifierName("y") },
                    Generator.IfStatement(
                        Generator.IdentifierName("p"),
                        new SyntaxNode[] { Generator.IdentifierName("q") }
                    )
                ),
                "if (x)\r\n{\r\n    y;\r\n}\r\nelse if (p)\r\n{\r\n    q;\r\n}"
            );
        ...
        public void TestSwitchStatements()
        {
            ...
            VerifySyntax<SwitchStatementSyntax>(
                Generator.SwitchStatement(
                    ...
                    Generator.DefaultSwitchSection(new[] { Generator.IdentifierName("b") })
                ),
                "switch (x)\r\n{\r\n    case y:\r\n        z;\r\n    default:\r\n        b;\r\n}"
            );
            ...
            VerifySyntax<SwitchStatementSyntax>(
                Generator.SwitchStatement(
                    Generator.TupleExpression(
                        new[] { Generator.IdentifierName("x1"), Generator.IdentifierName("x2") }
                    ),
                    Generator.SwitchSection(
                        Generator.IdentifierName("y"),
                        new[] { Generator.IdentifierName("z") }
        ...
        public void TestUsingStatements()
        {
            ...
            VerifySyntax<UsingStatementSyntax>(
                Generator.UsingStatement(
                    ...
                    "y",
                    Generator.IdentifierName("z"),
                    new[] { Generator.IdentifierName("q") }
                ),
                "using (x y = z)\r\n{\r\n    q;\r\n}"
            );
        }
        ...
        public void TestLambdaExpressions()
        {
            ...
            VerifySyntax<ParenthesizedLambdaExpressionSyntax>(
                Generator.ValueReturningLambdaExpression(
                    new[] { Generator.LambdaParameter("x"), Generator.LambdaParameter("y") },
                    Generator.IdentifierName("z")
                ),
                "(x, y) => z"
            );
            ...
            VerifySyntax<ParenthesizedLambdaExpressionSyntax>(
                Generator.ValueReturningLambdaExpression(
                    new[] { Generator.LambdaParameter("x"), Generator.LambdaParameter("y") },
                    new[] { Generator.ReturnStatement(Generator.IdentifierName("z")) }
                ),
                "(x, y) =>\r\n{\r\n    return z;\r\n}"
            );
            ...
            VerifySyntax<ParenthesizedLambdaExpressionSyntax>(
                Generator.ValueReturningLambdaExpression(
                    new[] { Generator.LambdaParameter("x", Generator.IdentifierName("y")) },
                    Generator.IdentifierName("z")
                ),
                "(y x) => z"
            );
            ...
            VerifySyntax<ParenthesizedLambdaExpressionSyntax>(
                Generator.ValueReturningLambdaExpression(
                    new[]
                    {
                        Generator.LambdaParameter("x", Generator.IdentifierName("y")),
                        Generator.LambdaParameter("a", Generator.IdentifierName("b")),
                    },
                    Generator.IdentifierName("z")
                ),
                "(y x, b a) => z"
        ...
        public void TestFieldDeclarations()
        {
            ...
            VerifySyntax<FieldDeclarationSyntax>(
                Generator.FieldDeclaration(
                    "fld",
                    Generator.TypeExpression(SpecialType.System_Int32),
                    initializer: Generator.LiteralExpression(0)
                ),
                "int fld = 0;"
            );
            ...
            VerifySyntax<FieldDeclarationSyntax>(
                Generator.FieldDeclaration(
                    ...
                    Generator.TypeExpression(SpecialType.System_Int32),
                    accessibility: Accessibility.NotApplicable,
                    modifiers: DeclarationModifiers.Required
                ),
                "required int fld;"
            );
        }
        ...
        public void TestMethodDeclarations()
        {
            ...
            VerifySyntax<MethodDeclarationSyntax>(
                Generator.MethodDeclaration(
                    ...
                    statements: new[] { Generator.IdentifierName("y") }
                ),
                "x m()\r\n{\r\n    y;\r\n}"
            );
            ...
            VerifySyntax<MethodDeclarationSyntax>(
                Generator.MethodDeclaration(
                    ...
                    parameters: new[]
                    {
                        Generator.ParameterDeclaration("z", Generator.IdentifierName("y")),
                    },
                    returnType: Generator.IdentifierName("x")
                ),
                "x m(y z)\r\n{\r\n}"
            ...
            VerifySyntax<MethodDeclarationSyntax>(
                Generator.MethodDeclaration(
                    "m",
                    modifiers: DeclarationModifiers.Partial | DeclarationModifiers.Async,
                    statements: null
                ),
                "partial void m();"
            );
        ...
        public void TestConversionOperatorDeclaration()
        {
            ...
            var conversion = gcHandleType
                .GetMembers()
                .OfType<IMethodSymbol>()
                .Single(m =>
                    m.Name == WellKnownMemberNames.ExplicitConversionName
        ...
        public void TestPropertyDeclarations()
        {
            VerifySyntax<PropertyDeclarationSyntax>(
                Generator.PropertyDeclaration(
                    "p",
                    Generator.IdentifierName("x"),
                    modifiers: DeclarationModifiers.Abstract | DeclarationModifiers.ReadOnly
                ),
                "abstract x p { get; }"
            );
            ...
            VerifySyntax<PropertyDeclarationSyntax>(
                Generator.PropertyDeclaration(
                    "p",
                    Generator.IdentifierName("x"),
                    modifiers: DeclarationModifiers.Abstract | DeclarationModifiers.WriteOnly
                ),
                "abstract x p { set; }"
            );
            ...
            VerifySyntax<PropertyDeclarationSyntax>(
                Generator.PropertyDeclaration(
                    ...
                    Generator.IdentifierName("x"),
                    modifiers: DeclarationModifiers.WriteOnly,
                    setAccessorStatements: Array.Empty<SyntaxNode>()
                ),
                "x p\r\n{\r\n    set\r\n    {\r\n    }\r\n}"
            );
            ...
            VerifySyntax<PropertyDeclarationSyntax>(
                Generator.PropertyDeclaration(
                    ...
                    Generator.IdentifierName("x"),
                    modifiers: DeclarationModifiers.WriteOnly,
                    setAccessorStatements: new[] { Generator.IdentifierName("y") }
                ),
                "x p\r\n{\r\n    set\r\n    {\r\n        y;\r\n    }\r\n}"
            );
        ...
        public void TestIndexerDeclarations()
        {
            VerifySyntax<IndexerDeclarationSyntax>(
                Generator.IndexerDeclaration(
                    new[] { Generator.ParameterDeclaration("z", Generator.IdentifierName("y")) },
                    Generator.IdentifierName("x"),
                    modifiers: DeclarationModifiers.Abstract | DeclarationModifiers.ReadOnly
                ),
            ...
            VerifySyntax<IndexerDeclarationSyntax>(
                Generator.IndexerDeclaration(
                    ...
                    Generator.IdentifierName("x"),
                    getAccessorStatements: new[] { Generator.IdentifierName("a") },
                    setAccessorStatements: new[] { Generator.IdentifierName("b") }
                ),
                "x this[y z]\r\n{\r\n    get\r\n    {\r\n        a;\r\n    }\r\n\r\n    set\r\n    {\r\n        b;\r\n    }\r\n}"
            );
        }
        ...
        public void TestEventPropertyDeclarations()
        {
            ...
            VerifySyntax<EventDeclarationSyntax>(
                Generator.CustomEventDeclaration(
                    "ep",
                    Generator.IdentifierName("t"),
                    addAccessorStatements: new[] { Generator.IdentifierName("s") },
                    removeAccessorStatements: new[] { Generator.IdentifierName("s2") }
                ),
                "event t ep\r\n{\r\n    add\r\n    {\r\n        s;\r\n    }\r\n\r\n    remove\r\n    {\r\n        s2;\r\n    }\r\n}"
            );
        }
            ...
            VerifySyntax<IndexerDeclarationSyntax>(
                Generator.AsPublicInterfaceImplementation(
                    Generator.IndexerDeclaration(
                        parameters: new[]
                        {
                            Generator.ParameterDeclaration("p", Generator.IdentifierName("a")),
                        },
                        type: Generator.IdentifierName("t"),
                ...
                Generator.AsPublicInterfaceImplementation(
                    SyntaxFactory
                        ...
                        .WithExplicitInterfaceSpecifier(
                            SyntaxFactory.ExplicitInterfaceSpecifier(
                                SyntaxFactory
                                    .GenericName(SyntaxFactory.Identifier("IGeneral"))
                        ...
                        .WithParameterList(
                            SyntaxFactory.ParameterList(
                                SyntaxFactory.SeparatedList<ParameterSyntax>(
                                    ...
                                    {
                                        SyntaxFactory
                                            .Parameter(SyntaxFactory.Identifier("x"))
                                            .WithType(SyntaxFactory.IdentifierName("C")),
                                        SyntaxFactory.Token(SyntaxKind.CommaToken),
                                        SyntaxFactory
                                            .Parameter(SyntaxFactory.Identifier("y"))
                                            .WithType(SyntaxFactory.IdentifierName("C")),
                                    }
                                )
                            )
...
public interface IFace
{
    void Method<T>() where T : class;
            ...
            var privateMethod = Generator.AsPrivateInterfaceImplementation(
                method,
                Generator.IdentifierName("IFace")
            );
        ...
        public void TestClassDeclarations()
        {
            ...
            VerifySyntax<ClassDeclarationSyntax>(
                Generator.ClassDeclaration(
                    "c",
                    interfaceTypes: new[] { Generator.IdentifierName("x") }
                ),
                "class c : x\r\n{\r\n}"
            );
            ...
            VerifySyntax<ClassDeclarationSyntax>(
                Generator.ClassDeclaration(
                    "c",
                    baseType: Generator.IdentifierName("x"),
                    interfaceTypes: new[] { Generator.IdentifierName("y") }
                ),
                "class c : x, y\r\n{\r\n}"
            );
            ...
            VerifySyntax<ClassDeclarationSyntax>(
                Generator.ClassDeclaration(
                    ...
                    members: new[]
                    {
                        Generator.FieldDeclaration("y", type: Generator.IdentifierName("x")),
                    }
                ),
                "class c\r\n{\r\n    x y;\r\n}"
            );
            ...
            VerifySyntax<ClassDeclarationSyntax>(
                Generator.ClassDeclaration(
                    "c",
                    members: new[] { Generator.ConstructorDeclaration() }
                ),
                "class c\r\n{\r\n    c()\r\n    {\r\n    }\r\n}"
            );
        }
        ...
        public void TestStructDeclarations()
        {
            ...
            VerifySyntax<StructDeclarationSyntax>(
                Generator.StructDeclaration(
                    "s",
                    members: new[] { Generator.ConstructorDeclaration("xxx") }
                ),
                "struct s\r\n{\r\n    s()\r\n    {\r\n    }\r\n}"
            );
        }
        ...
        public void TestInterfaceDeclarations()
        {
            ...
            VerifySyntax<InterfaceDeclarationSyntax>(
                Generator.InterfaceDeclaration(
                    "i",
                    interfaceTypes: new[] { Generator.IdentifierName("a") }
                ),
                "interface i : a\r\n{\r\n}"
            );
                ...
                Generator.InterfaceDeclaration(
                    ...
                    members: new[]
                    {
                        Generator.IndexerDeclaration(
                            new[]
                            {
                                Generator.ParameterDeclaration("y", Generator.IdentifierName("x")),
                            },
                            Generator.IdentifierName("t"),
        ...
        {
            VerifySyntax<EnumDeclarationSyntax>(Generator.EnumDeclaration("e"), "enum e\r\n{\r\n}");

            VerifySyntax<EnumDeclarationSyntax>(
                Generator.EnumDeclaration(
                    "e",
                    members: new[]
                    {
                        Generator.EnumMember("a"),
                        Generator.EnumMember("b"),
                        Generator.EnumMember("c"),
                    }
                ),
                "enum e\r\n{\r\n    a,\r\n    b,\r\n    c\r\n}"
            );
            ...
            VerifySyntax<EnumDeclarationSyntax>(
                Generator.EnumDeclaration(
                    ...
                    members: new[]
                    {
                        Generator.EnumMember("a", Generator.LiteralExpression(0)),
                        Generator.EnumMember("b"),
                        Generator.EnumMember("c", Generator.LiteralExpression(5)),
                    }
                ),
                "enum e\r\n{\r\n    a = 0,\r\n    b,\r\n    c = 5\r\n}"
            );
                ...
                Generator.EnumDeclaration(
                    ...
                    members: new[]
                    {
                        Generator.FieldDeclaration(
                            ...
                            initializer: Generator.LiteralExpression(1)
                        ),
                    }
                ),
                "enum e\r\n{\r\n    a = 1\r\n}"
        ...
        public void TestNamespaceDeclarations()
        {
            ...
            VerifySyntax<NamespaceDeclarationSyntax>(
                Generator.NamespaceDeclaration("n", Generator.NamespaceImportDeclaration("m")),
                "namespace n\r\n{\r\n    using m;\r\n}"
            );
        ...
        {
            VerifySyntax<CompilationUnitSyntax>(Generator.CompilationUnit(), "");
            ...
            VerifySyntax<CompilationUnitSyntax>(
                Generator.CompilationUnit(Generator.NamespaceImportDeclaration("n")),
                "using n;"
            );
        ...
        public void TestAttributeDeclarations()
        {
            ...
            VerifySyntax<AttributeListSyntax>(Generator.Attribute("a"), "[a]");
            ...
            VerifySyntax<AttributeListSyntax>(
                Generator.Attribute(
                    "a",
                    new[] { Generator.AttributeArgument(Generator.IdentifierName("x")) }
                ),
                "[a(x)]"
            );
            ...
            VerifySyntax<AttributeListSyntax>(
                Generator.Attribute(
                    "a",
                    new[] { Generator.AttributeArgument("x", Generator.IdentifierName("y")) }
                ),
                "[a(x = y)]"
            );
        ...
        public void TestAddAttributes()
        {
            ...
            VerifySyntax<ClassDeclarationSyntax>(
                Generator.AddAttributes(Generator.ClassDeclaration("c"), Generator.Attribute("a")),
                "[a]\r\nclass c\r\n{\r\n}"
            );

            VerifySyntax<StructDeclarationSyntax>(
                Generator.AddAttributes(Generator.StructDeclaration("s"), Generator.Attribute("a")),
                "[a]\r\nstruct s\r\n{\r\n}"
            );
            ...
            VerifySyntax<StatementSyntax>(
                Generator.AddAttributes(SyntaxFactory.BreakStatement(), Generator.Attribute("a")),
                "[a]\r\nbreak;"
            );

            VerifySyntax<TypeParameterSyntax>(
                Generator.AddAttributes(SyntaxFactory.TypeParameter("T"), Generator.Attribute("a")),
                "[a]\r\nT"
            );
...
public class C { } // end"
        ...
        public void TestWithTypeParameters()
        {
            ...
            VerifySyntax<ClassDeclarationSyntax>(
                Generator.WithTypeParameters(Generator.ClassDeclaration("c"), "a", "b"),
                "class c<a, b>\r\n{\r\n}"
            );

            VerifySyntax<StructDeclarationSyntax>(
                Generator.WithTypeParameters(Generator.StructDeclaration("s"), "a", "b"),
                "struct s<a, b>\r\n{\r\n}"
            );

            VerifySyntax<InterfaceDeclarationSyntax>(
                Generator.WithTypeParameters(Generator.InterfaceDeclaration("i"), "a", "b"),
                "interface i<a, b>\r\n{\r\n}"
            );

            VerifySyntax<DelegateDeclarationSyntax>(
                Generator.WithTypeParameters(Generator.DelegateDeclaration("d"), "a", "b"),
                "delegate void d<a, b>();"
            );
        }
        ...
        public void TestWithTypeConstraint()
        {
            ...
            VerifySyntax<MethodDeclarationSyntax>(
                Generator.WithTypeConstraint(
                    ...
                    "a",
                    SpecialTypeConstraintKind.ReferenceType | SpecialTypeConstraintKind.Constructor
                ),
                "abstract void m<a>()\r\n    where a : class, new();"
            );
            ...
            VerifySyntax<MethodDeclarationSyntax>(
                Generator.WithTypeConstraint(
                    ...
                    "a",
                    SpecialTypeConstraintKind.ReferenceType | SpecialTypeConstraintKind.ValueType
                ),
                "abstract void m<a>()\r\n    where a : class;"
            );
    ...
    event global::System.ComponentModel.PropertyChangedEventHandler PropertyChanged;
        ...
        public void TestUnsafeFieldDeclarationFromSymbol()
        {
            VerifySyntax<MethodDeclarationSyntax>(
                Generator.Declaration(
                    _emptyCompilation
                        .GetTypeByMetadataName("System.IntPtr")
                        .GetMembers("ToPointer")
                        .Single()
                ),
    ...
    Level2 = 2
        ...
        public void TestExplicitInterface1()
        {
            ...
            var method = type.GetMembers()
                .Single(m =>
                    m is IMethodSymbol { MethodKind: MethodKind.ExplicitInterfaceImplementation }
                );
        ...
        {
            var field = _emptyCompilation
                .GetSpecialType(SpecialType.System_UInt32)
                .GetMembers(nameof(UInt32.MaxValue))
                .Single();
        ...
        public void TestAddNamespaceImports()
        {
            ...
            AssertNamesEqual(
                ...
                Generator.GetNamespaceImports(
                    Generator.AddNamespaceImports(
                        Generator.CompilationUnit(Generator.IdentifierName("x")),
                        Generator.DottedName("y.z")
                    )
                )
            );
        }
...
public class C
{
            ...
            var summary = cls.DescendantNodes(descendIntoTrivia: true)
...
public class C
{
        ...
        public void TestAddMembers()
        {
            AssertMemberNamesEqual(
                ...
                Generator.AddMembers(
                    Generator.ClassDeclaration("d"),
                    new[] { Generator.MethodDeclaration("m") }
                )
            );
            AssertMemberNamesEqual(
                "m",
            ...
            AssertMemberNamesEqual(
                ...
                Generator.AddMembers(
                    Generator.NamespaceDeclaration("n"),
                    new[] { Generator.NamespaceDeclaration("n2") }
                )
            );
            AssertMemberNamesEqual(
                "n",
            ...
            AssertMemberNamesEqual(
                ...
                Generator.AddMembers(
                    Generator.ClassDeclaration(
                        "d",
                        members: new[] { Generator.MethodDeclaration("m") }
                    ),
                    new[] { Generator.MethodDeclaration("m2") }
                )
            );
            AssertMemberNamesEqual(
                new[] { "m", "m2" },
            ...
            AssertMemberNamesEqual(
                new[] { "v", "v2" },
                Generator.AddMembers(
                    Generator.EnumDeclaration("i", members: new[] { Generator.EnumMember("v") }),
                    new[] { Generator.EnumMember("v2") }
                )
            );
            AssertMemberNamesEqual(
                new[] { "n1", "n2" },
                Generator.AddMembers(
                    Generator.NamespaceDeclaration(
                        "n",
                        new[] { Generator.NamespaceDeclaration("n1") }
                    ),
                    new[] { Generator.NamespaceDeclaration("n2") }
                )
            );
            AssertMemberNamesEqual(
                ...
                Generator.AddMembers(
                    Generator.CompilationUnit(
                        declarations: new[] { Generator.NamespaceDeclaration("n1") }
                    ),
                    new[] { Generator.NamespaceDeclaration("n2") }
                )
            );
        ...
        {
            // remove all members
            TestRemoveAllMembers(
                Generator.ClassDeclaration("c", members: new[] { Generator.MethodDeclaration("m") })
            );
            TestRemoveAllMembers(
                Generator.StructDeclaration(
                    "s",
            ...
            TestRemoveAllMembers(
                Generator.NamespaceDeclaration("n", new[] { Generator.NamespaceDeclaration("n") })
            );
            TestRemoveAllMembers(
                Generator.CompilationUnit(
            ...
            TestRemoveMember(
                Generator.ClassDeclaration(
                    ...
                    members: new[]
                    {
                        Generator.MethodDeclaration("m1"),
                        Generator.MethodDeclaration("m2"),
                    }
                ),
                "m1",
                ["m2"]
        ...
        private void TestRemoveMember(SyntaxNode declaration, string name, string[] remainingNames)
        {
            var newDecl = Generator.RemoveNode(
                declaration,
                Generator.GetMembers(declaration).First(m => Generator.GetName(m) == name)
            );
        ...
        public void TestGetMembers()
        {
            ...
            AssertMemberNamesEqual(
                "v",
                Generator.EnumDeclaration("e", members: new[] { Generator.EnumMember("v") })
            );
            AssertMemberNamesEqual(
                "c",
                Generator.NamespaceDeclaration(
            ...
            AssertMemberNamesEqual(
                "c",
                Generator.CompilationUnit(declarations: new[] { Generator.ClassDeclaration("c") })
            );
        }
        ...
        public void TestGetDeclarationKind()
        {
            Assert.Equal(
                ...
                Generator.GetDeclarationKind(Generator.CompilationUnit())
            );
            Assert.Equal(
                DeclarationKind.Class,
                Generator.GetDeclarationKind(Generator.ClassDeclaration("c"))
            );
            Assert.Equal(
                DeclarationKind.Struct,
                Generator.GetDeclarationKind(Generator.StructDeclaration("s"))
            );
            Assert.Equal(
                DeclarationKind.Interface,
                Generator.GetDeclarationKind(Generator.InterfaceDeclaration("i"))
            );
            Assert.Equal(
                DeclarationKind.Enum,
                Generator.GetDeclarationKind(Generator.EnumDeclaration("e"))
            );
            Assert.Equal(
                DeclarationKind.Delegate,
                Generator.GetDeclarationKind(Generator.DelegateDeclaration("d"))
            );
            Assert.Equal(
                DeclarationKind.Method,
                Generator.GetDeclarationKind(Generator.MethodDeclaration("m"))
            );
            Assert.Equal(
                DeclarationKind.Constructor,
                Generator.GetDeclarationKind(Generator.ConstructorDeclaration())
            );
            Assert.Equal(
                DeclarationKind.Parameter,
                Generator.GetDeclarationKind(Generator.ParameterDeclaration("p"))
            );
            Assert.Equal(
                DeclarationKind.Property,
                Generator.GetDeclarationKind(
            ...
            Assert.Equal(
                ...
                Generator.GetDeclarationKind(
                    Generator.IndexerDeclaration(
                        new[] { Generator.ParameterDeclaration("i") },
                        Generator.IdentifierName("t")
                    )
                )
            );
            ...
            Assert.Equal(
                ...
                Generator.GetDeclarationKind(Generator.EnumMember("v"))
            );
            Assert.Equal(
            ...
            Assert.Equal(
                ...
                Generator.GetDeclarationKind(Generator.NamespaceDeclaration("n"))
            );
            Assert.Equal(
                DeclarationKind.NamespaceImport,
                Generator.GetDeclarationKind(Generator.NamespaceImportDeclaration("u"))
            );
            Assert.Equal(
            ...
            Assert.Equal(
                ...
                Generator.GetDeclarationKind(Generator.Attribute("a"))
            );
        }
        ...
        public void TestGetName()
        {
            ...
            Assert.Equal(
                "p",
                Generator.GetName(Generator.PropertyDeclaration("p", Generator.IdentifierName("t")))
            );
            Assert.Equal(
                "",
                Generator.GetName(
            ...
            Assert.Equal(
                "f",
                Generator.GetName(Generator.FieldDeclaration("f", Generator.IdentifierName("t")))
            );
            Assert.Equal("v", Generator.GetName(Generator.EnumMember("v")));
            Assert.Equal(
                "ef",
                Generator.GetName(Generator.EventDeclaration("ef", Generator.IdentifierName("t")))
            );
            Assert.Equal(
                "ep",
                Generator.GetName(
        ...
        public void TestWithName()
        {
            Assert.Equal(
                "c",
                Generator.GetName(Generator.WithName(Generator.ClassDeclaration("x"), "c"))
            );
            Assert.Equal(
                "s",
                Generator.GetName(Generator.WithName(Generator.StructDeclaration("x"), "s"))
            );
            Assert.Equal(
                "i",
                Generator.GetName(Generator.WithName(Generator.EnumDeclaration("x"), "i"))
            );
            Assert.Equal(
                "e",
                Generator.GetName(Generator.WithName(Generator.EnumDeclaration("x"), "e"))
            );
            Assert.Equal(
                "d",
                Generator.GetName(Generator.WithName(Generator.DelegateDeclaration("x"), "d"))
            );
            Assert.Equal(
                "m",
                Generator.GetName(Generator.WithName(Generator.MethodDeclaration("x"), "m"))
            );
            Assert.Equal(
                "",
                Generator.GetName(Generator.WithName(Generator.ConstructorDeclaration(), ".ctor"))
            );
            Assert.Equal(
                "p",
                Generator.GetName(Generator.WithName(Generator.ParameterDeclaration("x"), "p"))
            );
            Assert.Equal(
                "p",
                Generator.GetName(
                    Generator.WithName(
                        Generator.PropertyDeclaration("x", Generator.IdentifierName("t")),
                        "p"
                    )
                )
            );
            ...
            Assert.Equal(
                ...
                Generator.GetName(
                    Generator.WithName(
                        Generator.FieldDeclaration("x", Generator.IdentifierName("t")),
                        "f"
                    )
                )
            );
            Assert.Equal(
                "v",
                Generator.GetName(Generator.WithName(Generator.EnumMember("x"), "v"))
            );
            Assert.Equal(
                "ef",
                Generator.GetName(
                    Generator.WithName(
                        Generator.EventDeclaration("x", Generator.IdentifierName("t")),
                        "ef"
                    )
                )
            );
            Assert.Equal(
                ...
                Generator.GetName(
                    Generator.WithName(
                        Generator.CustomEventDeclaration("x", Generator.IdentifierName("t")),
                        "ep"
                    )
                )
            );
            Assert.Equal(
                "n",
                Generator.GetName(Generator.WithName(Generator.NamespaceDeclaration("x"), "n"))
            );
            Assert.Equal(
                "u",
                Generator.GetName(
                    Generator.WithName(Generator.NamespaceImportDeclaration("x"), "u")
                )
            );
            Assert.Equal(
                "loc",
                Generator.GetName(
                    Generator.WithName(
                        Generator.LocalDeclarationStatement(Generator.IdentifierName("t"), "x"),
                        "loc"
                    )
                )
            );
        ...
        public void TestGetAccessibility()
        {
            ...
            Assert.Equal(
                ...
                Generator.GetAccessibility(Generator.ParameterDeclaration("p"))
            );
            Assert.Equal(
                Accessibility.Internal,
                Generator.GetAccessibility(
            ...
            Assert.Equal(
                Accessibility.NotApplicable,
                Generator.GetAccessibility(Generator.EnumMember("v"))
            );
            Assert.Equal(
                Accessibility.Internal,
                Generator.GetAccessibility(
            ...
            Assert.Equal(
                Accessibility.NotApplicable,
                Generator.GetAccessibility(Generator.NamespaceDeclaration("n"))
            );
            Assert.Equal(
                Accessibility.NotApplicable,
                Generator.GetAccessibility(Generator.NamespaceImportDeclaration("u"))
            );
            Assert.Equal(
                Accessibility.NotApplicable,
                Generator.GetAccessibility(
            ...
            Assert.Equal(
                Accessibility.NotApplicable,
                Generator.GetAccessibility(Generator.Attribute("a"))
            );
            Assert.Equal(
                Accessibility.NotApplicable,
                Generator.GetAccessibility(SyntaxFactory.TypeParameter("tp"))
            );
        }
        ...
        public void TestGetModifiers()
        {
            ...
            Assert.Equal(
                ...
                Generator.GetModifiers(Generator.ParameterDeclaration("p"))
            );
            Assert.Equal(
                DeclarationModifiers.Abstract,
                Generator.GetModifiers(
            ...
            Assert.Equal(
                DeclarationModifiers.None,
                Generator.GetModifiers(Generator.EnumMember("v"))
            );
            Assert.Equal(
                DeclarationModifiers.None,
                Generator.GetModifiers(Generator.NamespaceDeclaration("n"))
            );
            Assert.Equal(
                DeclarationModifiers.None,
                Generator.GetModifiers(Generator.NamespaceImportDeclaration("u"))
            );
            Assert.Equal(
                DeclarationModifiers.None,
                Generator.GetModifiers(
            ...
            Assert.Equal(
                DeclarationModifiers.None,
                Generator.GetModifiers(Generator.Attribute("a"))
            );
            Assert.Equal(
                DeclarationModifiers.None,
                Generator.GetModifiers(SyntaxFactory.TypeParameter("tp"))
            );
        }
        ...
        {
            var allModifiers = new DeclarationModifiers(
                true,
                true,
                true,
                true,
            ...
            Assert.Equal(
                DeclarationModifiers.Unsafe,
                Generator.GetModifiers(
                    Generator.WithModifiers(SyntaxFactory.DestructorDeclaration("c"), allModifiers)
                )
            );
                ...
                @"static C()
{
        ...
        {
            var fileClass = (ClassDeclarationSyntax)
                SyntaxFactory.ParseMemberDeclaration("file class C { }");
            var fileAbstractClass = Generator.WithModifiers(
                fileClass,
                Generator.GetModifiers(fileClass).WithIsAbstract(true)
            );
            VerifySyntax<ClassDeclarationSyntax>(
                fileAbstractClass,
                ...
                @"public class C
{
        ...
        {
            var abstractClass = (ClassDeclarationSyntax)
                SyntaxFactory.ParseMemberDeclaration("abstract class C { }");
            var fileAbstractClass = Generator.WithModifiers(
                abstractClass,
                Generator.GetModifiers(abstractClass).WithIsFile(true)
            );
            VerifySyntax<ClassDeclarationSyntax>(
                fileAbstractClass,
                @"file abstract class C
{
        ...
        {
            var publicClass = (ClassDeclarationSyntax)
                SyntaxFactory.ParseMemberDeclaration("public class C { }");
            var filePublicClass = Generator.WithModifiers(
                publicClass,
                Generator.GetModifiers(publicClass).WithIsFile(true)
            );
            VerifySyntax<ClassDeclarationSyntax>(
                filePublicClass,
                @"file class C
{
        ...
        public void TestAddRequiredModifierToVirtualProperty()
        {
            ...
            var updatedProperty = Generator.WithModifiers(
                property,
                Generator.GetModifiers(property).WithIsRequired(true)
            );
            VerifySyntax<PropertyDeclarationSyntax>(
                updatedProperty,
                "public virtual required int P { get; }"
            );
        }
        ...
        public void TestAddVirtualModifierToRequiredProperty()
        {
            ...
            var updatedProperty = Generator.WithModifiers(
                property,
                Generator.GetModifiers(property).WithIsVirtual(true)
            );
            VerifySyntax<PropertyDeclarationSyntax>(
                updatedProperty,
                "public virtual required int P { get; }"
        ...
        public void TestGetType()
        {
            ...
            Assert.Equal(
                "t",
                Generator
                    .GetType(Generator.FieldDeclaration("f", Generator.IdentifierName("t")))
                    .ToString()
            );
            Assert.Equal(
                "t",
                Generator
                    .GetType(Generator.PropertyDeclaration("p", Generator.IdentifierName("t")))
                    .ToString()
            );
            Assert.Equal(
                "t",
            ...
            Assert.Equal(
                "t",
                Generator
                    .GetType(Generator.ParameterDeclaration("p", Generator.IdentifierName("t")))
                    .ToString()
            );
            ...
            Assert.Equal(
                "t",
                Generator
                    .GetType(Generator.EventDeclaration("ef", Generator.IdentifierName("t")))
                    .ToString()
            );
            Assert.Equal(
                "t",
                Generator
                    .GetType(Generator.CustomEventDeclaration("ep", Generator.IdentifierName("t")))
                    .ToString()
            );
        ...
        public void TestAddParameters()
        {
            ...
            Assert.Equal(
                ...
                Generator
                    .GetParameters(
                        Generator.AddParameters(
                            Generator.InterfaceDeclaration("c"),
                            new[]
                            {
                                Generator.ParameterDeclaration("p", Generator.IdentifierName("t")),
                            }
        ...
        public void TestGetExpression()
        {
            ...
            method = method.WithExpressionBody(
                SyntaxFactory.ArrowExpressionClause((ExpressionSyntax)Generator.IdentifierName("x"))
            );

            Assert.Equal("x", Generator.GetExpression(method).ToString());

            // expression bodied local functions
            var local = SyntaxFactory.LocalFunctionStatement(
            ...
            local = local
                .WithBody(null)
                .WithSemicolonToken(SyntaxFactory.Token(SyntaxKind.SemicolonToken));
            local = local.WithExpressionBody(
                SyntaxFactory.ArrowExpressionClause((ExpressionSyntax)Generator.IdentifierName("x"))
            );
        ...
        public void TestWithExpression()
        {
            ...
            Assert.Equal(
                "y",
                Generator
                    .GetExpression(Generator.WithExpression(method, Generator.IdentifierName("y")))
                    .ToString()
            );
            ...
            Assert.Equal(
                "y",
                Generator
                    .GetExpression(Generator.WithExpression(local, Generator.IdentifierName("y")))
                    .ToString()
            );
        }
        ...
        public void TestAccessorDeclarations()
        {
            ...
            VerifySyntax<AccessorDeclarationSyntax>(getAccessor, @"get;");
            ...
            // remove accessors
            Assert.Null(
                Generator.GetAccessor(
                    Generator.RemoveNode(prop, getAccessor),
                    DeclarationKind.GetAccessor
                )
            );
            Assert.Null(
                Generator.GetAccessor(
                    Generator.RemoveNode(prop, setAccessor),
                ...
                @"get
{
            ...
            // change accessors
            var newProp = Generator.ReplaceNode(
                prop,
                getAccessor,
                Generator.WithAccessibility(getAccessor, Accessibility.Public)
            );
            ...
            newProp = Generator.ReplaceNode(
                prop,
                setAccessor,
                Generator.WithAccessibility(setAccessor, Accessibility.Public)
            );
            Assert.Equal(
                Accessibility.Public,
                Generator.GetAccessibility(
                ...
                @"class C
{
   ...
   public int Y => 300;
            ...
            var y2 = Generator.AddAccessors(
                y,
                new[] { Generator.GetAccessor(x, DeclarationKind.GetAccessor) }
            );
            Assert.NotNull(y2);
                ...
                @"class C
{
   ...
   public int Z { get; set; }
            ...
            Assert.Equal(
                "500",
                Generator
                    .GetExpression(Generator.WithExpression(x, Generator.LiteralExpression(500)))
                    .ToString()
            );
            Assert.Equal(
                "500",
                Generator
                    .GetExpression(Generator.WithExpression(y, Generator.LiteralExpression(500)))
                    .ToString()
            );
            Assert.Equal(
                "500",
                Generator
                    .GetExpression(Generator.WithExpression(z, Generator.LiteralExpression(500)))
                    .ToString()
            );
        }
   ...
   public int this[int p] => p * 10;
        ...
        public void TestGetStatements()
        {
            var stmts = new[]
            {
                ...
                Generator.ExpressionStatement(
                    Generator.InvocationExpression(
                        Generator.IdentifierName("fn"),
                        Generator.IdentifierName("arg")
                    )
                ),
            };
            ...
            Assert.Equal(
                2,
                Generator.GetStatements(Generator.MethodDeclaration("m", statements: stmts)).Count
            );

            Assert.Equal(0, Generator.GetStatements(Generator.ConstructorDeclaration()).Count);
            Assert.Equal(
                2,
                Generator.GetStatements(Generator.ConstructorDeclaration(statements: stmts)).Count
            );
            ...
            Assert.Equal(
                2,
                Generator.GetStatements(Generator.VoidReturningLambdaExpression(stmts)).Count
            );
            ...
            Assert.Equal(
                2,
                Generator.GetStatements(Generator.ValueReturningLambdaExpression(stmts)).Count
            );
        ...
        public void TestGetAccessorStatements()
        {
            ...
            Assert.Equal(
                0,
                Generator.GetGetAccessorStatements(Generator.IdentifierName("x")).Count
            );
            ...
            Assert.Equal(
                0,
                Generator.GetSetAccessorStatements(Generator.IdentifierName("x")).Count
            );
        }
                ...
                @"public class C
{
   public static int X, Y, Z;
            ...
            var declC = Generator.GetDeclaration(
                symbolC.DeclaringSyntaxReferences.Select(x => x.GetSyntax()).First()
            );
            var declX = Generator.GetDeclaration(
                symbolX.DeclaringSyntaxReferences.Select(x => x.GetSyntax()).First()
            );
            var declY = Generator.GetDeclaration(
                symbolY.DeclaringSyntaxReferences.Select(x => x.GetSyntax()).First()
            );
            var declZ = Generator.GetDeclaration(
                symbolZ.DeclaringSyntaxReferences.Select(x => x.GetSyntax()).First()
            );
            ...
            VerifySyntax<ClassDeclarationSyntax>(
                Generator.InsertMembers(
                    declC,
                    0,
                    Generator.FieldDeclaration("A", Generator.IdentifierName("T"))
                ),
                @"public class C
{
    T A;
    ...
    public static int Y, Z;
            ...
            VerifySyntax<ClassDeclarationSyntax>(
                Generator.ReplaceNode(
                    declC,
                    declY,
                    Generator.WithType(declY, Generator.IdentifierName("T"))
                ),
                @"public class C
{
    public static int X;
    ...
    public static int Z;
            ...
            VerifySyntax<ClassDeclarationSyntax>(
                Generator.ReplaceNode(
                    declC,
                    declZ,
                    Generator.WithType(declZ, Generator.IdentifierName("T"))
                ),
                @"public class C
{
    public static int X, Y;
    public static T Z;
            ...
            VerifySyntax<ClassDeclarationSyntax>(
                Generator.ReplaceNode(
                    declC,
                    declX,
                    Generator.WithAccessibility(declX, Accessibility.Private)
                ),
                @"public class C
{
    ...
    public static int Y, Z;
            ...
            VerifySyntax<ClassDeclarationSyntax>(
                Generator.ReplaceNode(
                    declC,
                    declX,
                    Generator.WithModifiers(declX, DeclarationModifiers.None)
                ),
                @"public class C
{
    public int X;
                ...
                @"public class C
{
    public static int Q, Y, Z;
            ...
            VerifySyntax<ClassDeclarationSyntax>(
                Generator.ReplaceNode(
                    declC,
                    declX.GetAncestorOrThis<VariableDeclaratorSyntax>(),
                    SyntaxFactory.VariableDeclarator("Q")
                ),
                @"public class C
{
    public static int Q, Y, Z;
            ...
            VerifySyntax<ClassDeclarationSyntax>(
                Generator.ReplaceNode(
                    declC,
                    declX,
                    Generator.WithExpression(declX, Generator.IdentifierName("e"))
                ),
                @"public class C
{
...
"
            ...
            VerifySyntax<InterfaceDeclarationSyntax>(
                Generator.InsertMembers(
                    declC,
                    0,
                    Generator.PropertyDeclaration("A", Generator.IdentifierName("T"))
                ),
                $@"public interface C
{{
    T A {{ get; set; }}
...
public class C
{
            ...
            var xWithArg = Generator.AddAttributeArguments(
                attrX,
                new[] { Generator.AttributeArgument(Generator.IdentifierName("e")) }
            );
...
public class C
{
            ...
            VerifySyntax<ClassDeclarationSyntax>(
                Generator.ReplaceNode(
                    declC,
                    attrX,
                    Generator.AddAttributeArguments(
                        attrX,
                        new[] { Generator.AttributeArgument(Generator.IdentifierName("e")) }
                    )
                ),
...
";
            ...
            var elasticOnlyFormatted = Formatter
                .Format(
                    newRoot,
        ...
        {
            var comp = Compile(@"public record class R;");
        ...
        {
            var comp = Compile(@"public record class R(int i) { public int I => i; }");
        ...
        {
            var comp = Compile(@"public record struct R;");
        ...
        {
            var comp = Compile(@"public readonly record struct R(int i) { public int I => i; }");
        ...
        {
            var comp = Compile("""public class C<T> where T : unmanaged { }""");
        ...
        {
            var comp = Compile("""public class C { void M<T>() where T : unmanaged { } }""");
        ...
        {
            var comp = Compile("""public class C { public int X { get; init; } }""");
...
[|static class C
{
        ...
        {
            TestModifiersAsync(
                DeclarationModifiers.Sealed | DeclarationModifiers.Override,
                @"
class C
{
...
"
        ...
        {
            TestModifiersAsync(
                DeclarationModifiers.Virtual | DeclarationModifiers.ReadOnly,
                @"
class C
{
    [|public virtual int X => 0;|]
        ...
        {
            TestModifiersAsync(
                DeclarationModifiers.ReadOnly | DeclarationModifiers.Required,
                @"
class C
{
...
class C
{
    public virtual event System.Action [|X|];
        ...
        {
            TestModifiersAsync(
                DeclarationModifiers.ReadOnly | DeclarationModifiers.Sealed,
                @"
