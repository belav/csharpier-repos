        ...
        : IIncrementalGenerator
    {
        ...
        public void Initialize(IncrementalGeneratorInitializationContext context)
        {
            context.RegisterSourceOutput(
                context.AdditionalTextsProvider.Select((t, ct) => t).WithTrackingName(StepName),
        ...
        private static SourceText GenerateSourceForAdditionalFile(
            AdditionalText file,
        ...
        )
        {
            ...
            var changes = sourceText.Lines.SelectAsArray(l => new TextChange(
                new TextSpan(l.Start, length: 0),
                "// "
            ));
