...
#nullable enable
        ...
        private static readonly DocumentId s_unrelatedDocumentId = DocumentId.CreateNewId(
                ...
                workspace.TryApplyChanges(
                    workspace
                        ...
                        .AddAdditionalDocument(
                            DocumentId.CreateNewId(projectId),
                            "add.txt",
                            SourceText.From("text", Encoding.UTF8, SourceHashAlgorithms.Default)
                        )
                        .AddAnalyzerConfigDocument(
                            DocumentId.CreateNewId(projectId),
                            "editorcfg",
                            SourceText.From("config", Encoding.UTF8, SourceHashAlgorithms.Default),
                            filePath: "/a/b"
                        )
                )
            );
        ...
        private static Workspace CreateWorkspaceWithProjectAndLinkedDocuments(
            string docContents,
            ParseOptions? parseOptions1 = null,
            ParseOptions? parseOptions2 = null
        )
        {
        ...
        public void RemoveAnalyzerConfigDocuments_Errors()
        {
            ...
            Assert.Throws<InvalidOperationException>(() =>
                solution.RemoveAnalyzerConfigDocuments(ImmutableArray.Create(s_unrelatedDocumentId))
            );
            Assert.Throws<ArgumentNullException>(() =>
        ...
        public void WithDocumentFolders()
        {
            ...
            var newSolution4 = solution.WithDocumentFolders(
                documentId,
        ...
        public void WithSourceCodeKind()
        {
            ...
            Assert.Same(
                solution,
                solution.WithDocumentSourceCodeKind(documentId, SourceCodeKind.Regular)
            );

            var newSolution1 = solution.WithDocumentSourceCodeKind(
                documentId,
        ...
        public void WithSourceCodeKind_Obsolete()
        {
            ...
            var newSolution = solution.WithDocumentSourceCodeKind(
                documentId,
                SourceCodeKind.Interactive
            );
            Assert.Equal(
                SourceCodeKind.Script,
                newSolution.GetDocument(documentId)!.SourceCodeKind
            );
        }
        ...
        public void WithDocumentSyntaxRoot()
        {
            ...
            var newSolution1 = solution.WithDocumentSyntaxRoot(
                documentId,
                root,
        ...
        public void WithDocumentText_SourceText()
        {
            ...
            var newSolution2 = newSolution1.WithDocumentText(
                documentId,
                text,
                PreservationMode.PreserveIdentity
            );
        ...
        public void WithDocumentText_TextAndVersion()
        {
            ...
            Assert.True(
                newSolution1.GetDocument(documentId)!.TryGetTextVersion(out var actualVersion)
            );
        ...
        )
        {
            solution = updateType switch
            {
                ...
                TextUpdateType.TextAndVersion => solution.WithDocumentText(
                    documentId1,
                    textAndVersion,
                    mode
                ),
                TextUpdateType.TextLoader => solution.WithDocumentTextLoader(
                    documentId1,
        ...
        )
        {
            ...
            var text = SourceText.From(
                "new text without pp directives",
                encoding: null,
        ...
        public void WithAdditionalDocumentText_SourceText()
        {
            ...
            var newSolution1 = solution.WithAdditionalDocumentText(
                documentId,
                text,
                PreservationMode.PreserveIdentity
            );
            Assert.True(
                newSolution1.GetAdditionalDocument(documentId)!.TryGetText(out var actualText)
            );
            Assert.Same(text, actualText);

            var newSolution2 = newSolution1.WithAdditionalDocumentText(
                documentId,
                text,
                PreservationMode.PreserveIdentity
            );
        ...
        public void WithAnalyzerConfigDocumentText_SourceText()
        {
            ...
            Assert.True(
                newSolution1.GetAnalyzerConfigDocument(documentId)!.TryGetText(out var actualText)
            );
            Assert.Same(text, actualText);

            var newSolution2 = newSolution1.WithAnalyzerConfigDocumentText(
                documentId,
                text,
                PreservationMode.PreserveIdentity
            );
        ...
        public void WithDocumentTextLoader()
        {
            ...
            var newSolution1 = solution.WithDocumentTextLoader(
                documentId,
                loader,
                PreservationMode.PreserveIdentity
            );
            ...
            var newSolution2 = solution.WithDocumentTextLoader(
                documentId,
                loader,
                PreservationMode.PreserveIdentity
            );
        ...
        public void WithAdditionalDocumentTextLoader()
        {
            ...
            var newSolution1 = solution.WithAdditionalDocumentTextLoader(
                documentId,
                loader,
                PreservationMode.PreserveIdentity
            );
            ...
            // Reusal is not currently implemented: https://github.com/dotnet/roslyn/issues/42028
            var newSolution2 = solution.WithAdditionalDocumentTextLoader(
                documentId,
                loader,
                PreservationMode.PreserveIdentity
            );
        ...
        public void WithAnalyzerConfigDocumentTextLoader()
        {
            ...
            var newSolution1 = solution.WithAnalyzerConfigDocumentTextLoader(
                documentId,
                loader,
                PreservationMode.PreserveIdentity
            );
            ...
            // Reusal is not currently implemented: https://github.com/dotnet/roslyn/issues/42028
            var newSolution2 = solution.WithAnalyzerConfigDocumentTextLoader(
                documentId,
                loader,
                PreservationMode.PreserveIdentity
            );
        ...
        public async Task WithProjectChecksumAlgorithm_DocumentUpdates()
        {
            ...
            solution = solution.AddDocument(
                DocumentInfo.Create(documentAId, "a.cs", loader: textLoaderA, filePath: "a.cs")
            );
            ...
            solution = solution.AddDocument(
                DocumentInfo.Create(
                    fileDocumentId,
                    "d.cs",
                    loader: new FileTextLoader(fileD.Path, defaultEncoding: null),
                    filePath: fileD.Path
                )
            );
            ...
            await Verify(
                solution.GetRequiredDocument(fileDocumentId),
                SourceHashAlgorithm.Sha1,
                checksumSHA1
            );
            ...
            static async Task Verify(
                Document document,
                SourceHashAlgorithm expectedAlgorithm,
            ...
            )
            {
                ...
                Assert.Equal(
                    expectedAlgorithm,
                    (await document.GetTextAsync(default)).ChecksumAlgorithm
                );
                Assert.Equal(
                    expectedAlgorithm,
                ...
                Assert.Equal(
                    expectedAlgorithm,
                    (await document.GetRequiredSyntaxTreeAsync(default)).GetText().ChecksumAlgorithm
                );
                Assert.Equal(
                    expectedAlgorithm,
                    document.GetRequiredSyntaxTreeSynchronously(default).GetText().ChecksumAlgorithm
                );
                ...
                if (expectedChecksum != null)
                {
                    Assert.Equal(
                        expectedChecksum,
                        document.GetTextSynchronously(default).GetChecksum()
                    );
                }
                ...
                Assert.Equal(
                    expectedAlgorithm,
                    (await tree.GetTextAsync(default)).ChecksumAlgorithm
                );
            ...
            ParseOptions newOptions =
                languageName == LanguageNames.CSharp
                    ...
                    : new VisualBasicParseOptions(
                        preprocessorSymbols: new KeyValuePair<string, object?>[]
                        {
                            new("DEBUG", null),
                        }
                    );
        ...
        public void WithProjectReferences()
        {
            ...
            Assert.Throws<InvalidOperationException>(() =>
                solution.WithProjectReferences(projectId, new[] { new ProjectReference(projectId) })
            );
        }
        ...
        public void WithProjectReferences_ProjectNotInSolution()
        {
            ...
            var projectRefs =
                (IEnumerable<ProjectReference>)ImmutableArray.Create(externalProjectRef);
        ...
        public void AddProjectReferences()
        {
            ...
            var solution2 = solution.AddProjectReferences(
                projectId,
            ...
            AssertEx.Equal(
                new[] { projectRef2 },
                solution3.GetProject(projectId)!.ProjectReferences
            );
            AssertEx.Equal(
                new[] { projectRef2, externalProjectRef },
            ...
            Assert.Throws<InvalidOperationException>(() =>
                solution3.AddProjectReferences(projectId, new[] { new ProjectReference(projectId) })
            );
        }
        ...
        public void RemoveProjectReference()
        {
            ...
            AssertEx.Equal(
                new[] { projectRef2 },
                solution2.GetProject(projectId)!.AllProjectReferences
            );
        ...
        public void ProjectReferences_Submissions()
        {
            ...
            _ = solution.AddProjectReferences(
                submissionId3,
                new[] { new ProjectReference(submissionId1) }
            );
            _ = solution.WithProjectReferences(
                submissionId3,
                new[] { new ProjectReference(submissionId1) }
            );
            ...
            _ = solution.AddProjectReferences(
                submissionId3,
                new[] { new ProjectReference(projectId0) }
            );
            _ = solution.WithProjectReferences(
                submissionId3,
                new[] { new ProjectReference(projectId0) }
        ...
        public void AddMetadataReferences()
        {
            ...
            var solution2 = solution.AddMetadataReferences(
                projectId,
            ...
            var solution3 = solution.AddMetadataReferences(
                projectId,
                OnceEnumerable(metadataRef1, metadataRef2)
            );
            AssertEx.Equal(
                new[] { metadataRef1, metadataRef2 },
        ...
        public void RemoveMetadataReference()
        {
            ...
            AssertEx.Equal(
                new[] { metadataRef2 },
                solution2.GetProject(projectId)!.MetadataReferences
            );
        ...
        public void AddAnalyzerReferences_Project()
        {
            ...
            var solution3 = solution.AddAnalyzerReferences(
                projectId,
                OnceEnumerable(analyzerRef1, analyzerRef2)
            );
            AssertEx.Equal(
                new[] { analyzerRef1, analyzerRef2 },
                solution3.GetProject(projectId)!.AnalyzerReferences
            );
        ...
        public void AddDocument_SourceText()
        {
            ...
            var solution2 = solution.AddDocument(
                documentId,
                "name",
                sourceText,
                folders,
...
#nullable disable
        ...
        public async Task TestAddFirstDocumentAsync()
        {
            ...
            Assert.True(
                solution.ContainsProject(pid),
                "Solution was expected to have project " + pid
            );
            ...
            Assert.True(
                project.ContainsDocument(did),
                "Project was expected to have document " + did
            );
            ...
            Assert.True(
                project2.ContainsDocument(did2),
                "Project was expected to have document " + did2
            );
        ...
        private static async Task ValidateSolutionAndCompilationsAsync(Solution solution)
        {
            ...
            {
                Assert.True(
                    solution.ContainsProject(project.Id),
                    "Solution was expected to have project " + project.Id
                );
                ...
                {
                    Assert.True(
                        compilation.References.Contains(meta),
                        "Compilation references were expected to contain " + meta
                    );
                }
                ...
                {
                    Assert.True(
                        trees.Contains(await doc.GetSyntaxTreeAsync()),
            ...
            for (var i = 0; i < projectIds.Length; i++)
            {
                ...
                if (i >= 1)
                {
                    solution = solution.AddProjectReference(
                        projectIds[i],
                        new ProjectReference(projectIds[i - 1])
                    );
                }
            }
        ...
        public async Task TestAddMetadataReferencesAsync()
        {
            ...
            var namespacesAndTypes = assemblyReference
                .GlobalNamespace
        ...
        public void TestProjectDiagnosticAnalyzers()
        {
            ...
            var secondAnalyzerReference = new AnalyzerImageReference(
                ImmutableArray.Create(secondAnalyzer)
            );
        ...
        public async Task TestRemoveProjectWithReferencesAsync()
        {
            ...
            Assert.True(
                sol2.GetProject(pid2).AllProjectReferences.Any(r => r.ProjectId == pid),
                "sol2 project pid2 was expected to contain project reference " + pid
            );
        ...
        public async Task TestRemoveProjectWithReferencesAndAddItBackAsync()
        {
            ...
            Assert.True(
                sol2.GetProject(pid2).AllProjectReferences.Any(r => r.ProjectId == pid),
                "sol2 pid2 was expected to contain " + pid
            );
        ...
        public async Task ParsedTreeRootOwnership(string language)
        {
            ...
            if (language == LanguageNames.CSharp)
            {
                var classNode = syntaxRoot
                    .DescendantNodes()
                    .OfType<CS.Syntax.ClassDeclarationSyntax>()
                    .Single();
                newSyntaxRoot = syntaxRoot.ReplaceNode(
                    classNode,
                    classNode.WithModifiers(
                        CS.SyntaxFactory.TokenList(CS.SyntaxFactory.ParseToken("public"))
                    )
                );
            }
            else
            {
                var classNode = syntaxRoot
                    .DescendantNodes()
                    .OfType<VB.Syntax.ClassStatementSyntax>()
                    .Single();
                newSyntaxRoot = syntaxRoot.ReplaceNode(
                    classNode,
                    classNode.WithModifiers(
                        VB.SyntaxFactory.TokenList(VB.SyntaxFactory.ParseToken("Public"))
                    )
                );
            }
            ...
            var root = await documentWithAttribute.GetRequiredSyntaxRootAsync(
                CancellationToken.None
            );
        ...
        public void TestDocumentChangedOnDiskIsNotObserved()
        {
            ...
            {
                Assert.IsType<TemporaryStorageService>(
                    workspace.Services.GetService<ITemporaryStorageServiceInternal>()
                );
            ...
            else
            {
                ...
                Assert.IsType<TrivialTemporaryStorageService>(
                    workspace.Services.GetService<ITemporaryStorageServiceInternal>()
                );
            }
        ...
        [MethodImpl(MethodImplOptions.NoInlining)]
        private static ObjectReference<SourceText> GetObservedText(
            Solution solution,
        ...
        [MethodImpl(MethodImplOptions.NoInlining)]
        private static ObjectReference<SourceText> GetObservedTextAsync(
            Solution solution,
            DocumentId documentId,
            string expectedText = null
        )
        ...
        public void RecoverableTree_With(string language)
        {
            ...
            var sol = workspace
                ...
                .AddDocument(
                    ...
                    "test",
                    SourceText.From(
                        language == LanguageNames.CSharp ? "class C {}" : "Class C : End Class",
                        Encoding.UTF8,
                        SourceHashAlgorithm.Sha256
                    ),
                    filePath: "old path"
...
";
        ...
        public void TestEncodingRetainedAfterTreeChanged()
        {
            ...
            var doc = ws.AddDocument(
                proj.Id,
                "a.cs",
                SourceText.From("public class c { }", Encoding.UTF32)
            );
            ...
            var newRoot = root.WithLeadingTrivia(
                root.GetLeadingTrivia().Add(CS.SyntaxFactory.Whitespace("    "))
            );
        ...
        public async Task TestFrozenPartialProjectHasDifferentSemanticVersions_AddedDoc()
        {
            ...
            var frozenDocument = documentToFreeze.WithFrozenPartialSemantics(
                CancellationToken.None
            );
        ...
        public async Task TestFrozenPartialProjectHasDifferentSemanticVersions_ChangedDoc1()
        {
            ...
            var documentToFreezeOriginal = project.AddDocument(
                "DocumentToFreeze.cs",
                SourceText.From("class DocumentToFreeze { void M() { } }")
            );
            ...
            var frozenDocument = documentToFreezeChanged.WithFrozenPartialSemantics(
                CancellationToken.None
            );
        ...
        public async Task TestFrozenPartialSemanticsHandlesDocumentWithSamePathBeingRemovedAndAdded()
        {
            ...
            var originalCompilation = await project.GetCompilationAsync();
            project = project
                .RemoveDocument(project.DocumentIds.Single())
                .AddDocument("RegularDocument.cs", "// Source File", filePath: "RegularDocument.cs")
                .Project;
        ...
        public async Task TestFrozenPartialSemanticsHandlesRemoveAndAddWithNullPathAndDifferentNames()
        {
            ...
            project = project
                .RemoveDocument(project.DocumentIds.Single())
                .AddDocument("RegularDocument2.cs", "// Source File", filePath: null)
                .Project;
            ...
            var treesInCompilation = (
                await frozenDocument.Project.GetCompilationAsync()
            ).SyntaxTrees;
            Assert.Equal(2, treesInCompilation.Count());

            foreach (var document in frozenDocument.Project.Documents)
                Assert.Contains(
                    await document.GetRequiredSyntaxTreeAsync(CancellationToken.None),
                    treesInCompilation
                );
        }
        ...
        [Theory]
        [CombinatorialData]
        public async Task TestFrozenPartialSemanticsWithMulitipleUnrelatedEdits(
            [CombinatorialValues(1, 2, 3)] int documentToFreeze
        )
        {
            using var workspace = CreateWorkspaceWithPartialSemantics();
            var solution = workspace
            ...
            var documentIdToFreeze =
                documentToFreeze == 1 ? documentId1
                : documentToFreeze == 2 ? documentId2
                : documentId3;
        ...
        public void TestProjectCompletenessWithMultipleProjects()
        {
            GetMultipleProjects(
                ...
                out var vbNormalProject,
                out var dependsOnBrokenProject,
                out var dependsOnVbNormalProject,
                out var transitivelyDependsOnBrokenProjects,
                out var transitivelyDependsOnNormalProjects
            );
        ...
        public async Task TestMassiveFileSize()
        {
            ...
            var file = root.CreateFile(prefix: "massiveFile", extension: ".cs")
                .WriteAllText("hello");
            ...
            {
                // test async one
                var unused = await loader.LoadTextAndVersionAsync(
            ...
            {
                // test sync one
                var unused = loader.LoadTextAndVersionSynchronously(
                    new LoadTextOptions(SourceHashAlgorithms.Default),
                    CancellationToken.None
                );
            }
        ...
        public void TestWithSyntaxTree()
        {
            ...
            var strongTree = factory.ParseSyntaxTree(
                "dummy",
                dummyProject.ParseOptions,
                text,
                CancellationToken.None
            );
        ...
        public void TestUpdateDocumentsOrder()
        {
            ...
            ImmutableArray<DocumentId> GetDocumentIds() =>
                solution.GetProject(pid).DocumentIds.ToImmutableArray();
            ...
            solution = solution.WithProjectDocumentsOrder(
                pid,
                ImmutableList.CreateRange(new[] { did5, did4, did3, did2, did1 })
            );
        ...
        )
        {
            ...
            solution = solution.AddDocument(
                ...
                "Test" + extension,
                "",
                filePath: @"Z:\Test" + extension
            );

            var originalSyntaxTree = await solution
            ...
            solution = solution.AddAnalyzerConfigDocuments(
                ImmutableArray.Create(
                    DocumentInfo.Create(
        ...
        )
        {
            ...
            var syntaxTreeAfterAddingEditorConfig = await solution
                .GetDocument(sourceDocumentId)
                .GetSyntaxTreeAsync();
            ...
            var syntaxTreeAfterRemovingEditorConfig = await solution
                .GetDocument(sourceDocumentId)
                .GetSyntaxTreeAsync();
        ...
        )
        {
            ...
            var syntaxTreeBeforeEditorConfigChange = await solution
                .GetDocument(sourceDocumentId)
                .GetSyntaxTreeAsync();
            ...
            Assert.Equal(
                provider,
                (await project.GetCompilationAsync()).Options.SyntaxTreeOptionsProvider
            );
            Assert.True(
                provider.TryGetDiagnosticValue(
            ...
            var syntaxTreeAfterEditorConfigChange = await solution
                .GetDocument(sourceDocumentId)
                .GetSyntaxTreeAsync();
    ...
    void M(C? c)
    {
        ...
        public void AddingAndRemovingProjectsUpdatesFilePathMap()
        {
            ...
            var projectInfo = ProjectInfo
                .Create(projectId, VersionStamp.Default, "Test", "Test", LanguageNames.CSharp)
            ...
            Assert.Equal(
                editorConfigDocumentId,
                Assert.Single(solution.GetDocumentIdsWithFilePath(editorConfigFilePath))
            );
        ...
        )
        {
            ...
            dependsOnBrokenProject = workspace.AddProject(
                ProjectInfo.Create(
                    ...
                    {
                        new ProjectReference(csBrokenProject.Id),
                        new ProjectReference(vbNormalProject.Id),
                    }
                )
            );
        ...
        public async Task ReplacingTextMultipleTimesDoesNotRootIntermediateCopiesIfCompilationNotAskedFor()
        {
            ...
            // prior change.
            var finalSolution = solutionWithSourceTextToRelease
                .GetObjectReference(
                    static (s, documentId) =>
                        s.WithDocumentTextLoader(
                            documentId,
        ...
        public async Task EditorConfigOptions(
            string projectPath,
            string configPath,
            string sourcePath,
            string pattern,
            bool appliedToEntireProject,
            bool appliedToDocument
        )
        {
            projectPath = string.IsNullOrEmpty(projectPath)
                ? projectPath
                : Path.Combine(TempRoot.Root, projectPath);
            configPath = Path.Combine(TempRoot.Root, configPath);
            sourcePath = string.IsNullOrEmpty(sourcePath)
                ? sourcePath
                : Path.Combine(TempRoot.Root, sourcePath);
            ...
            var solution = workspace
                ...
                .AddDocument(
                    documentId,
                    "test.cs",
                    SourceText.From("public class C { }"),
                    filePath: sourcePath
                )
                .AddAnalyzerConfigDocument(
                    DocumentId.CreateNewId(projectId),
                    ".editorconfig",
                    SourceText.From($"[{pattern}]\nindent_style = tab"),
                    filePath: configPath
                );
...
#pragma warning restore
            ...
            var documentOptionsViaSyntaxTree = document
                .Project
                .State
                .AnalyzerOptions
            ...
            Assert.Equal(
                ...
                projectOptions?.AnalyzerOptions.TryGetValue("indent_style", out value) == true
                    && value == "tab"
            );
        }
