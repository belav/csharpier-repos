...
#nullable enable
        ...
        public void WithAdditionalDocumentText_TextAndVersion()
        {
            ...
            Assert.True(
                newSolution1.GetAdditionalDocument(documentId)!.TryGetTextVersion(
        ...
        public void WithAnalyzerConfigDocumentText_TextAndVersion()
        {
            ...
            Assert.True(
                newSolution1.GetAnalyzerConfigDocument(documentId)!.TryGetTextVersion(
                    out var actualVersion
                )
            );
            Assert.Same(textAndVersion.Text, actualText);
        ...
        public void WithDocumentTextLoader()
        {
            ...
            Assert.Equal(
                "new text",
                newSolution1.GetDocument(documentId)!.GetTextSynchronously(CancellationToken.None)
                    .ToString()
            );
        ...
        public void WithAdditionalDocumentTextLoader()
        {
            ...
            Assert.Equal(
                "new text",
                newSolution1.GetAdditionalDocument(documentId)!.GetTextSynchronously(
        ...
        public void WithAnalyzerConfigDocumentTextLoader()
        {
            ...
            Assert.Equal(
                "new text",
                newSolution1.GetAnalyzerConfigDocument(documentId)!.GetTextSynchronously(
                        CancellationToken.None
                    )
                    .ToString()
            );
        ...
        public void WithProjectCompilationOptionsReplacesSyntaxTreeOptionProvider(
            ...
            var originalSyntaxTreeOptionsProvider =
                solution.Projects.Single().CompilationOptions!.SyntaxTreeOptionsProvider;
            Assert.NotNull(originalSyntaxTreeOptionsProvider);

            var defaultOptions = solution.Projects.Single()
            ...
            var newSyntaxTreeOptionsProvider =
                solution.Projects.Single().CompilationOptions!.SyntaxTreeOptionsProvider;
...
#nullable disable
        ...
        public void RemoveDocumentFromUnrelatedProject()
        {
            ...
            Assert.Throws<ArgumentException>(
                () =>
                    solution.GetProject(projectId2)
        ...
        public async Task TestOneCSharpProjectAsync()
        {
            ...
            var solution =
                workspace.CurrentSolution.AddProject("goo", "goo.dll", LanguageNames.CSharp)
                    .AddMetadataReference(s_mscorlib)
                    .AddDocument("goo.cs", "public class Goo { }").Project.Solution;
        ...
        public async Task TestAddMetadataReferencesAsync()
        {
            ...
            var assemblyReference = (IAssemblySymbol)solution.GetProject(project1)
                .GetCompilationAsync()
            ...
            assemblyReference = (IAssemblySymbol)solution.GetProject(project1)
                .GetCompilationAsync()
                .Result.GetAssemblyOrModuleSymbol(mefReference);
        ...
        public async Task TestGetSyntaxRootAsync()
        {
            ...
            using var workspace = CreateWorkspace();
            var sol = workspace.CurrentSolution.AddProject(
                    pid,
                    "goo",
                    "goo.dll",
                    LanguageNames.CSharp
        ...
        public async Task TestUpdateDocumentAsync()
        {
            ...
            using var workspace = CreateWorkspace();
            var solution1 = workspace.CurrentSolution.AddProject(
                    projectId,
                    "ProjectName",
                    "AssemblyName",
                    LanguageNames.CSharp
...
End Class";
        ...
        private static void TestRecoverableSyntaxTree(Solution sol, DocumentId did)
        {
            ...
            var doc2 = doc.Project.Solution.WithDocumentSyntaxRoot(
                    doc.Id,
                    newRoot,
        ...
        public void TestWorkspaceLanguageServiceOverride()
        {
            ...
            var service = ws.Services.GetLanguageServices(LanguageNames.CSharp)
            ...
            var service2 = ws2.Services.GetLanguageServices(LanguageNames.CSharp)
                .GetService<ITestLanguageService>();
        ...
        public async Task TestDocumentFileAccessFailureMissingFile()
        {
            ...
            var compilation = await solution.State.GetCompilationAsync(
                    doc.Project.State,
                    CancellationToken.None
                )
                .ConfigureAwait(false);
...
";
        ...
        public void TestFrozenPartialProjectAlwaysIsIncomplete()
        {
            ...
            // Nothing should have incomplete references, and everything should build
            var frozenSolution =
                document.WithFrozenPartialSemantics(CancellationToken.None).Project.Solution;
        ...
        public void TestWithSyntaxTree()
        {
            ...
            var recoverableTree = factory.CreateRecoverableTree(
                ...
                strongTree.FilePath,
                strongTree.Options,
                new ConstantValueSource<TextAndVersion>(
        ...
        public void TestUpdateDocumentsOrder()
        {
            ...
            {
                return solution.GetProject(pid)
                    .GetCompilationAsync()
...
class C
{
    void M(C? c)
    {
        ...
        {
            using var workspace = CreateWorkspace(
                new[] { typeof(NoCompilationLanguageServiceFactory) }
            );
            var solution = workspace.CurrentSolution;
            var projectId = ProjectId.CreateNewId();
            var documentId = DocumentId.CreateNewId(projectId);
        ...
        public void TestOptionChangesForLanguagesNotInSolution()
        {
            ...
            var roundTripOptionSet = SerializeAndDeserialize(
                (SerializableOptionSet)s3.Options,
                optionService
            );
            ...
            static SerializableOptionSet SerializeAndDeserialize(
                ...
                return SerializableOptionSet.Deserialize(
                    reader,
                    optionService,
                    CancellationToken.None
                );
        ...
        {
            using var workspace = recoverable
                ? CreateWorkspaceWithRecoverableSyntaxTreesAndWeakCompilations()
                : CreateWorkspace();
            var pid = ProjectId.CreateNewId();
            ...
            var newDoc = doc.Project.Solution.WithDocumentSyntaxRoot(doc.Id, newRoot)
                .GetDocument(doc.Id);
