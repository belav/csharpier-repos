    ...
    public class ProjectInfoTests
    {
        ...
        public void Create_Documents()
        {
            ...
            var info4 = ProjectInfo.Create(
                ...
                "assembly",
                "C#",
                documents: ImmutableArray<DocumentInfo>.Empty
            );
        ...
        public void Create_AdditionalDocuments()
        {
            ...
            Assert.Same(
                documentInfo,
                ((ImmutableArray<DocumentInfo>)info1.AdditionalDocuments).Single()
            );
            ...
            var info3 = ProjectInfo.Create(
                ...
                "assembly",
                "C#",
                additionalDocuments: new DocumentInfo[0]
            );
            ...
            var info4 = ProjectInfo.Create(
                ...
                "assembly",
                "C#",
                additionalDocuments: ImmutableArray<DocumentInfo>.Empty
            );
        ...
        public void Create_ProjectReferences()
        {
            ...
            Assert.Same(
                projectReference,
                ((ImmutableArray<ProjectReference>)info1.ProjectReferences).Single()
            );
            ...
            var info3 = ProjectInfo.Create(
                ...
                "assembly",
                "C#",
                projectReferences: new ProjectReference[0]
            );
            ...
            var info4 = ProjectInfo.Create(
                ...
                "assembly",
                "C#",
                projectReferences: ImmutableArray<ProjectReference>.Empty
            );
        ...
        public void TestProperties()
        {
            ...
            SolutionTestHelpers.TestProperty(
                instance,
                (old, value) => old.WithChecksumAlgorithm(value),
                opt => opt.ChecksumAlgorithm,
