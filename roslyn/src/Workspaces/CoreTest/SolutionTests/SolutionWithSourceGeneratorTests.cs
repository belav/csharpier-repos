...
namespace Microsoft.CodeAnalysis.UnitTests
{
    ...
    public class SolutionWithSourceGeneratorTests : TestBase
    {
        ...
        public async Task RequestingGeneratedDocumentsTwiceGivesSameInstance()
        {
            ...
            var generatedDocumentFirstTime = Assert.Single(
            ...
            var generatedDocumentSecondTime = Assert.Single(
                await project.GetSourceGeneratedDocumentsAsync()
            );
        ...
        public async Task ChangesToAdditionalFilesCorrectlyAppliedEvenIfCompilationFallsAway()
        {
            ...
            var projectWithoutAdditionalFiles = project.RemoveAdditionalDocument(
                project.AdditionalDocumentIds.Single()
            );
            Assert.Empty(
                (
                    await projectWithoutAdditionalFiles.GetRequiredCompilationAsync(
                        CancellationToken.None
                    )
                ).SyntaxTrees
            );
