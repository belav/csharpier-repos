...
namespace Microsoft.CodeAnalysis.UnitTests
{
    ...
    public class SolutionWithSourceGeneratorTests : TestBase
    {
        ...
        public async Task IncrementalSourceGeneratorInvokedCorrectNumberOfTimes()
        {
            ...
            var project =
                WithPreviewLanguageVersion(AddEmptyProject(workspace.CurrentSolution))
                    .AddAnalyzerReference(analyzerReference)
                    .AddAdditionalDocument("Test.txt", "Hello, world!")
                    .Project.AddAdditionalDocument("Test2.txt", "Hello, world!").Project;
            ...
            project =
                project.AdditionalDocuments
                    .First()
                    .WithAdditionalDocumentText(SourceText.From("Changed text!")).Project;
        ...
        public async Task OpenSourceGeneratedUpdatedToBufferContentsWhenCallingGetOpenDocumentInCurrentContextWithChanges()
        {
            ...
            var generatedDocumentIdentity =
                Assert.Single(await project.GetSourceGeneratedDocumentsAsync()).Identity;
        ...
        public async Task OpenSourceGeneratedFileDoesNotCreateNewSnapshotIfContentsKnownToMatch()
        {
            ...
            var generatedDocumentIdentity =
                Assert.Single(
                    await workspace.CurrentSolution.Projects
                        .Single()
                        .GetSourceGeneratedDocumentsAsync()
                ).Identity;
            var differentOpenTextContainer =
                SourceText.From("// StaticContent", Encoding.UTF8).Container;
        ...
        public async Task OpenSourceGeneratedFileMatchesBufferContentsEvenIfGeneratedFileIsMissingIsRemoved()
        {
            ...
            var originalAdditionalFile = WithPreviewLanguageVersion(
                    AddEmptyProject(workspace.CurrentSolution)
                )
                .AddAnalyzerReference(analyzerReference)
        ...
        public async Task OpenSourceGeneratedDocumentUpdatedAndVisibleInProjectReference()
        {
            ...
            solution =
                AddEmptyProject(solution)
                    .AddProjectReference(new ProjectReference(projectIdWithGenerator)).Solution;
