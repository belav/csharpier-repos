...
public class SimplifierTests
{
    ...
    public async Task Expand_BadArguments()
    {
        ...
        Assert.Throws<ArgumentNullException>(
            "node",
            () => Simplifier.Expand<SyntaxNode>(node: null!, semanticModel: null!, workspace: null!)
        );
        Assert.Throws<ArgumentNullException>(
            "semanticModel",
            () => Simplifier.Expand(node, semanticModel: null!, workspace: null!)
        );
        Assert.Throws<ArgumentNullException>(
            "workspace",
    ...
    public async Task ReduceAsync_Options()
    {
        ...
        static void ValidateCSharpOptions(CSharpSimplifierOptions simplifierOptions)
        {
            ...
            Assert.Equal(
                ...
                simplifierOptions.PreferBraces.Value
            );
        }
