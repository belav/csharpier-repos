    ...
    public partial class FindAllDeclarationsTests : TestBase
    {
        ...
        [
            ...
            InlineData(
                ...
                new[] { "TestCases.TestCase.Test(string[])" }
            ),
            ...
            InlineData(
                ...
                new[] { "TestCases.TestCase.TestField" }
            ),
            ...
            InlineData(
                ...
                new[] { "TestCases.TestCase.InnerTestCase" }
            ),
            ...
            InlineData(
                ...
                new[] { "TestCase1.TestCase", "TestCase2.TestCase" }
            ),
            InlineData(
                "testcase",
                false,
        ...
        public async Task FindDeclarationsAsync_Test(
            string searchTerm,
            bool ignoreCase,
        ...
        )
        {
            ...
            var declarations = await SymbolFinder
                .FindDeclarationsAsync(project, searchTerm, ignoreCase)
        ...
        public async Task FindDeclarationsAsync_Metadata(TestHost testHost)
        {
            ...
            var csharpResult = await SymbolFinder.FindDeclarationsAsync(
                solution.GetProject(csharpId),
                "Console",
                ignoreCase: false
            );
            Assert.True(csharpResult.Count() > 0);

            var vbResult = await SymbolFinder.FindDeclarationsAsync(
                solution.GetProject(vbId),
                "Console",
                ignoreCase: true
            );
...
"
            ...
            var actualSymbol = (
                await SymbolFinder.FindDeclarationsAsync(
                    solution.GetProject(submission1Id),
                    "Inner",
                    ignoreCase: false
                )
            ).SingleOrDefault();
        ...
        public async Task FindSourceDeclarationsAsync_Project_Test(
            string searchTerm,
            bool ignoreCase,
            SolutionKind workspaceKind,
            string[] expectedResults
        )
        {
            using var workspace = CreateWorkspaceWithProject(workspaceKind, out var project);
            var declarations = await SymbolFinder
                .FindSourceDeclarationsAsync(project, searchTerm, ignoreCase)
                .ConfigureAwait(false);
            Verify(searchTerm, ignoreCase, workspaceKind, declarations, expectedResults);
        }
        ...
        [
            ...
            InlineData(
                ...
                true,
                SolutionKind.TwoProjectsEachWithASingleClassWithSingleMethod,
                new[] { "TestCases.TestCase", "TestCases.TestCase" }
            ),
            InlineData(
                "testcase",
                false,
            ...
            InlineData(
                ...
                true,
                SolutionKind.TwoProjectsEachWithASingleClassWithSingleMethod,
                new[] { "TestCases.TestCase.Test(string[])", "TestCases.TestCase.Test(string[])" }
            ),
            InlineData(
                "test",
                false,
            ...
            InlineData(
                ...
                true,
                SolutionKind.TwoProjectsEachWithASingleClassWithSingleField,
                new[] { "TestCases.TestCase.TestField", "TestCases.TestCase.TestField" }
            ),
            InlineData(
                "testfield",
                false,
        ...
        public async Task FindSourceDeclarationsAsync_Solution_Test(
            string searchTerm,
            bool ignoreCase,
            SolutionKind workspaceKind,
            string[] expectedResults
        )
        {
            ...
            var declarations = await SymbolFinder
                .FindSourceDeclarationsAsync(solution, searchTerm, ignoreCase)
                .ConfigureAwait(false);
            Verify(searchTerm, ignoreCase, workspaceKind, declarations, expectedResults);
        }
        ...
        public async Task FindSourceDeclarationsAsync_Solution_Test_NullString()
        {
            await Assert.ThrowsAnyAsync<ArgumentNullException>(async () =>
            {
                using var workspace = CreateWorkspaceWithSolution(
                    SolutionKind.SingleClass,
                    out var solution
                );
                var declarations = await SymbolFinder.FindSourceDeclarationsAsync(
        ...
        [
            ...
            InlineData(
                SolutionKind.SingleClassWithSingleMethod,
                new[] { "TestCases", "TestCases.TestCase", "TestCases.TestCase.Test(string[])" }
            ),
            InlineData(
                SolutionKind.SingleClassWithSingleProperty,
            ...
            InlineData(
                SolutionKind.SingleClassWithSingleField,
                new[] { "TestCases", "TestCases.TestCase", "TestCases.TestCase.TestField" }
            ),
            InlineData(
                SolutionKind.TwoProjectsEachWithASingleClassWithSingleMethod,
                new[] { "TestCases", "TestCases.TestCase", "TestCases.TestCase.Test(string[])" }
            ...
            InlineData(
                SolutionKind.NestedClass,
                new[] { "TestCases", "TestCases.TestCase", "TestCases.TestCase.InnerTestCase" }
            ),
            InlineData(
                SolutionKind.TwoNamespacesWithIdenticalClasses,
                new[] { "TestCase1", "TestCase1.TestCase", "TestCase2.TestCase", "TestCase2" }
            ),
        ]
        ...
        )
        {
            using var workspace = CreateWorkspaceWithProject(workspaceKind, out var project);
            var declarations = await SymbolFinder
                .FindSourceDeclarationsAsync(project, str => str.Contains("Test"))
                .ConfigureAwait(false);
        ...
        public async Task FindSourceDeclarationsAsync_Project_Func_Test_AlwaysTruePredicate()
        {
            ...
            var declarations = await SymbolFinder
                .FindSourceDeclarationsAsync(project, str => true)
                .ConfigureAwait(false);
        ...
        public async Task FindSourceDeclarationsAsync_Project_Func_Test_AlwaysFalsePredicate()
        {
            ...
            var declarations = await SymbolFinder
                .FindSourceDeclarationsAsync(project, str => false)
                .ConfigureAwait(false);
        ...
        [
            ...
            InlineData(
                ...
                new[]
                {
                    "TestCases",
                    "TestCases.TestCase",
                    "TestCases.TestCase.Test(string[])",
                    "TestCases",
                    "TestCases.TestCase",
                    "TestCases.TestCase.Test(string[])"
                }
            ...
            InlineData(
                ...
                new[]
                {
                    "TestCases",
                    "TestCases.TestCase",
                    "TestCases.TestCase.TestProperty",
                    "TestCases",
                    "TestCases.TestCase",
                    "TestCases.TestCase.TestProperty"
                }
        ...
        )
        {
            using var workspace = CreateWorkspaceWithSolution(workspaceKind, out var solution);
            var declarations = await SymbolFinder
                .FindSourceDeclarationsAsync(solution, str => str.Contains("Test"))
                .ConfigureAwait(false);
        ...
        public async Task FindSourceDeclarationsAsync_Solution_Func_Test_AlwaysTruePredicate()
        {
            ...
            var declarations = await SymbolFinder
                .FindSourceDeclarationsAsync(solution, str => true)
                .ConfigureAwait(false);
            Verify(SolutionKind.SingleClass, declarations, "TestCases", "TestCases.TestCase");
        }
        ...
        public async Task FindSourceDeclarationsAsync_Solution_Func_Test_AlwaysFalsePredicate()
        {
            ...
            var declarations = await SymbolFinder
                .FindSourceDeclarationsAsync(solution, str => false)
                .ConfigureAwait(false);
            Verify(SolutionKind.SingleClass, declarations);
        }
        ...
        )
        {
            using var workspace = CreateWorkspaceWithProject(workspaceKind, out var project);
            var declarations = await SymbolFinder
                .FindSourceDeclarationsWithPatternAsync(project, "test")
                .ConfigureAwait(false);
            Verify(workspaceKind, declarations, expectedResults);
        }
        ...
        )
        {
            using var workspace = CreateWorkspaceWithSolution(workspaceKind, out var solution);
            var declarations = await SymbolFinder
                .FindSourceDeclarationsWithPatternAsync(solution, "test")
                .ConfigureAwait(false);
            Verify(workspaceKind, declarations, expectedResult);
        }
        ...
        public async Task FindSourceDeclarationsWithPatternAsync_CamelCase_Solution_Test(
            SolutionKind workspaceKind,
            string pattern,
            string[] expectedResults
        )
...
";
            ...
            // perform the search
            var foundDeclarations = await SymbolFinder.FindDeclarationsAsync(
                project,
                name: "MyEvent",
                ignoreCase: true
            );
