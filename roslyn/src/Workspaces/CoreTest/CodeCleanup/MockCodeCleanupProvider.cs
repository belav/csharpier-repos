...
namespace Microsoft.CodeAnalysis.UnitTests.CodeCleanup
{
    internal sealed class MockCodeCleanupProvider : ICodeCleanupProvider
    {
        public Func<
            ...
            CancellationToken,
            Task<Document>
        >? CleanupDocumentAsyncImpl { get; set; }
        public Func<
            SyntaxNode,
            ImmutableArray<TextSpan>,
            SyntaxFormattingOptions,
        ...
        public Task<Document> CleanupAsync(
            ...
            (CleanupDocumentAsyncImpl ?? throw new NotImplementedException()).Invoke(
                document,
                spans,
        ...
        public Task<SyntaxNode> CleanupAsync(
            ...
            Task.FromResult(
                (CleanupNodeImpl ?? throw new NotImplementedException()).Invoke(
                    root,
                    spans,
                    options,
                    services
