...
namespace Microsoft.CodeAnalysis.Differencing.UnitTests
{
    public class TestTreeComparer : TreeComparer<TestNode>
    {
        ...
        {
            get { return TestNode.MaxLabel + 1; }
        }
        ...
        protected internal override int GetLabel(TestNode node) => node.Label;

        protected internal override TextSpan GetSpan(TestNode node) => new TextSpan(0, 10);

        protected internal override int TiedToAncestor(int label) => 0;
