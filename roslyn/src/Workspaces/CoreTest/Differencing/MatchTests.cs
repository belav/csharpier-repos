...
namespace Microsoft.CodeAnalysis.Differencing.UnitTests
{
    public class MatchTests
    {
        ...
        public void KnownMatches()
        {
            ...
            var oldRoot = new TestNode(0, 1, x1 = new TestNode(1, 1));
        ...
        public void KnownMatchesDups()
        {
            ...
            var oldRoot = new TestNode(0, 1, x1 = new TestNode(1, 1), y1 = new TestNode(1, 4));
        ...
        public void KnownMatchesRootMatch()
        {
            ...
            var oldRoot = new TestNode(0, 1, x1 = new TestNode(0, 1));
