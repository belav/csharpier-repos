...
namespace Microsoft.CodeAnalysis.UnitTests.SemanticModelReuse
{
    ...
    public class SemanticModelReuseTests
    {
        private static Document CreateDocument(string code, string language)
        {
            ...
            return project
                .AddMetadataReference(TestMetadata.Net40.mscorlib)
        ...
        public async Task NullBodyReturnsNormalSemanticModel1_CSharp()
        {
            ...
            var model = await document.ReuseExistingSpeculativeModelAsync(
                null,
        ...
        public async Task NullBodyReturnsNormalSemanticModel2_CSharp()
        {
            ...
            var model1 = await document.ReuseExistingSpeculativeModelAsync(
                source.IndexOf("return"),
                CancellationToken.None
            );
            var model2 = await document.ReuseExistingSpeculativeModelAsync(
                null,
                CancellationToken.None
            );
        ...
        public async Task InBodyEditShouldProduceCachedModel_CSharp()
        {
            ...
            var model1 = await document1.ReuseExistingSpeculativeModelAsync(
                source.IndexOf("return"),
                CancellationToken.None
            );
            Assert.False(model1.IsSpeculativeSemanticModel);

            var document2 = document1.WithText(
                SourceText.From("class C { void M() { return null; } }")
            );

            // This should be able to get a speculative model using the original model we primed the cache with.
            var model2 = await document2.ReuseExistingSpeculativeModelAsync(
                source.IndexOf("return"),
                CancellationToken.None
            );
        ...
        public async Task OutOfBodyEditShouldProduceFreshModel_CSharp()
        {
            ...
            var document3 = document2.WithText(
                SourceText.From("class C { long M() { return 0; } }")
            );

            // We are now again only editing a method body so we should be able to get a speculative model.
            var model3 = await document3.ReuseExistingSpeculativeModelAsync(
                source.IndexOf("return"),
                CancellationToken.None
            );
        ...
        public async Task MultipleBodyEditsShouldProduceFreshModel_CSharp()
        {
            ...
            var document2 = document1.WithText(
                SourceText.From("class C { void M() { return 0; } }")
            );
            ...
            var document3 = document1.WithText(
                SourceText.From("class C { void M() { return 1; } }")
            );
        ...
        public async Task MultipleBodyEditsShouldProduceFreshModel_Accessor_Property_CSharp()
        {
            ...
            var document2 = document1.WithText(
                SourceText.From("class C { int M { get { return 1; } } }")
            );
            ...
            var document3 = document1.WithText(
                SourceText.From("class C { int M { get { return 2; } } }")
            );
        ...
        public async Task MultipleBodyEditsShouldProduceFreshModel_Accessor_Event_CSharp()
        {
            ...
            var document2 = document1.WithText(
                SourceText.From("class C { event System.Action E { add { return 1; } } }")
            );
            ...
            var document3 = document1.WithText(
                SourceText.From("class C { event System.Action E { add { return 2; } } }")
            );
        ...
        public async Task MultipleBodyEditsShouldProduceFreshModel_Accessor_Indexer_CSharp()
        {
            ...
            var document2 = document1.WithText(
                SourceText.From("class C { int this[int i] { get { return 1; } } }")
            );
            ...
            var document3 = document1.WithText(
                SourceText.From("class C { int this[int i] { get { return 2; } } }")
            );
...
class C
    sub M()
        return nothing
            ...
            // Ensure this doesn't crash.
            VisualBasicSyntaxContext.CreateContext(
                document2,
                model2,
                source.IndexOf("sub"),
                CancellationToken.None
