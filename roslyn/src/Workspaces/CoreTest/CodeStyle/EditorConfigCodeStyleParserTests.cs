...
namespace Microsoft.CodeAnalysis.UnitTests.CodeStyle
{
    public class EditorConfigCodeStyleParserTests
    {
        ...
        internal void TestParseEditorConfigAccessibilityModifiers(
        ...
        {
            Assert.True(
                CodeStyleOptions2.AccessibilityModifiersRequired.Definition.Serializer.TryParseValue(
                    configurationString,
        ...
        {
            Assert.True(
                FormattingOptions2.NewLine.Definition.Serializer.TryParseValue(
                    configurationString,
