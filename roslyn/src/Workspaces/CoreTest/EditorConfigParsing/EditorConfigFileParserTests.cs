...
namespace Microsoft.CodeAnalysis.UnitTests.EditorConfigParsing
{
    ...
    {
        internal static EditorConfigFile<EditorConfigOption> CreateParseResults(
            string editorconfigFilePath,
            params (string headerText, TextSpan span, bool isGlobal)[] sections
        )
        {
            ...
            return new EditorConfigFile<EditorConfigOption>(
                editorconfigFilePath,
        ...
        {
            var parseResults = CreateParseResults(
                @"C:\dev\.editorconfig",
            ...
            Assert.True(
                parseResults.TryGetSectionForLanguage(
        ...
        internal void TestGetBestSectionWithDifferMatchCriteria()
        {
            ...
            Assert.True(
                parseResults.TryGetSectionForLanguage(
                    Language.CSharp,
                    SectionMatch.ExactLanguageMatchWithOthers,
                    out var section
                )
            );
        ...
        internal void TestGetBestSectionForFile()
        {
            ...
            Assert.True(
                parseResults.TryGetSectionForFilePath(
        ...
        internal void TestGetBestSectionForFilePatternWithDefaults()
        {
            ...
            Assert.False(
                parseResults.TryGetSectionForFilePath(@"C:\dev\sources\CSharp\Program.cs", out _)
            );
            Assert.False(
                parseResults.TryGetSectionForFilePath(
                    @"C:\dev\sources\VisualBasic\Program.vb",
