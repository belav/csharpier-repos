...
namespace Microsoft.CodeAnalysis.CSharp.CodeGeneration
{
    ...
    internal class CSharpSyntaxGenerator : SyntaxGenerator
    {
                ...
                member =>
                {
                    ...
                    switch (member.Kind())
                    {
                        ...
                        case SyntaxKind.FieldDeclaration:
                            ...
                            SyntaxFacts.GetAccessibilityAndModifiers(
                                f.Modifiers,
                                out acc,
                                out modifiers,
                                out _
        ...
        {
            if (
                !SyntaxFacts.CanHaveAccessibility(declaration)
        ...
        private static readonly DeclarationModifiers s_lambdaModifiers = DeclarationModifiers.Async;
        ...
        private static SyntaxNode GetFullDeclaration(SyntaxNode declaration)
        {
            switch (declaration.Kind())
            {
                case SyntaxKind.VariableDeclaration:
                    var vd = (VariableDeclarationSyntax)declaration;
                    if (
                        CSharpSyntaxFacts.ParentIsFieldDeclaration(vd)
