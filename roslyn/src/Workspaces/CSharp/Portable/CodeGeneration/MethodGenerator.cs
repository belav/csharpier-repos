...
namespace Microsoft.CodeAnalysis.CSharp.CodeGeneration
{
    internal static class MethodGenerator
    {
        ...
        )
        {
            ...
            var declaration = GenerateMethodDeclarationWorker(method, destination, info);
        ...
        )
        {
            ...
            var declaration = GenerateLocalFunctionDeclarationWorker(method, destination, info);
        ...
        )
        {
            ...
            using var _2 = ArrayBuilder<TypeParameterConstraintClauseSyntax>.GetInstance(
