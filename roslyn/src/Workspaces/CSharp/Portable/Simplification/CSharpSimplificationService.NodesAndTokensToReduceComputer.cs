...
namespace Microsoft.CodeAnalysis.CSharp.Simplification
{
        ...
        : AbstractSimplificationService<ExpressionSyntax, StatementSyntax, CrefSyntax>
    {
        private class NodesAndTokensToReduceComputer : CSharpSyntaxRewriter
        {
            ...
            private static readonly Func<SyntaxNode, bool> s_containsAnnotations = n =>
                n.ContainsAnnotations;
            private static readonly Func<SyntaxNodeOrToken, bool> s_hasSimplifierAnnotation = n =>
                ...
                if (
                    ...
                    _nodesAndTokensToReduce.Add(
                        new NodeOrTokenToReduce(
                            token,
                            simplifyAllDescendants: true,
                            originalNodeOrToken: token
                        )
                    );
                }
