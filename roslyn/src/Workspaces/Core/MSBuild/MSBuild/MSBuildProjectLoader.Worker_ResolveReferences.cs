    ...
    public partial class MSBuildProjectLoader
    {
        private partial class Worker
        {
            ...
            private class ResolvedReferencesBuilder
            {
                ...
                {
                    if (
                        filePath != null && _pathToIndicesMap.TryGetValue(filePath, out var indices)
                    )
                    {
            ...
            {
                var outputFilePath = await _buildManager
                    .TryGetOutputFilePathAsync(projectPath, cancellationToken)
                    .ConfigureAwait(false);
