...
namespace Microsoft.CodeAnalysis.Host
{
    ...
    internal partial class TemporaryStorageServiceFactory : IWorkspaceServiceFactory
    {
        ...
        internal class TemporaryStorageService : ITemporaryStorageService2
        {
            ...
            public ITemporaryTextStorage AttachTemporaryTextStorage(
                string storageName,
                long offset,
                long size,
            ...
            public ITemporaryStreamStorage AttachTemporaryStreamStorage(
                string storageName,
                long offset,
                long size,
                CancellationToken cancellationToken
