...
namespace Microsoft.CodeAnalysis.Options
{
    public abstract partial class OptionSet
    {
        ...
        > s_emptyAnalyzerConfigOptions = ImmutableDictionary.Create<string, AnalyzerConfigOptions>(
        ...
        /// </summary>
        private ImmutableDictionary<string, AnalyzerConfigOptions> _lazyAnalyzerConfigOptions =
            s_emptyAnalyzerConfigOptions;
        ...
        /// Gets the value of the option, or the default value if not otherwise set.
        /// </summary>
        public T GetOption<T>(Option<T> option) => OptionsHelpers.GetOption(option, _getOptionCore);
        ...
        /// Creates a new <see cref="OptionSet" /> that contains the changed value.
        /// </summary>
        internal OptionSet WithChangedOption<T>(
        ...
        )
        {
            return ImmutableInterlocked.GetOrAdd(
                ...
                (
                    string language,
                    (OptionSet self, IEditorConfigOptionMappingService mapping) arg
                ) =>
        ...
        private protected virtual AnalyzerConfigOptions CreateAnalyzerConfigOptions(
            IEditorConfigOptionMappingService optionMappingService,
            string? language
