...
partial internal abstract class AbstractRecommendationService<TSyntaxContext>
{
    protected abstract class AbstractRecommendationServiceRunner
    {
        ...
        )
        {
            ...
            if (
                !(
                    syntaxFactsService.IsAnonymousFunctionExpression(lambdaSyntax)
            ...
            else
            {
                ...
                parameterTypeSymbols = GetTypeSymbols(
                    ...
                    argumentName,
                    ordinalInInvocation,
                    ordinalInLambda: parameter.Ordinal
                );
