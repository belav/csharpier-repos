...
namespace Microsoft.CodeAnalysis.SQLite.v2
{
    internal partial class SQLitePersistentStorage
    {
        ...
        // tasks.
        private Task<TResult> PerformReadAsync<TArg, TResult>(
            Func<TArg, TResult> func,
            TArg arg,
            CancellationToken cancellationToken
        )
            where TArg : struct
        {
            ...
            return PerformTaskAsync(
                func,
                arg,
                _connectionPoolService.Scheduler.ConcurrentScheduler,
                cancellationToken
            );
        }
        ...
        // tasks we need to do.
        public Task<TResult> PerformWriteAsync<TArg, TResult>(
            Func<TArg, TResult> func,
            TArg arg,
            CancellationToken cancellationToken
        )
            where TArg : struct
        {
            ...
            return PerformTaskAsync(
                func,
                arg,
                _connectionPoolService.Scheduler.ExclusiveScheduler,
                cancellationToken
            );
        }
