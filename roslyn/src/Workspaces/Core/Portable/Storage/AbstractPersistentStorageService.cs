...
namespace Microsoft.CodeAnalysis.Storage
{
        ...
        : IChecksummedPersistentStorageService
    {
        ...
        async ValueTask<IPersistentStorage> IPersistentStorageService.GetStorageAsync(
            Solution solution,
        ...
        )
        {
            using (await _lock.DisposableWaitAsync(cancellationToken).ConfigureAwait(false))
            {
                ...
                var storage = await CreatePersistentStorageAsync(solutionKey, workingFolder)
                    .ConfigureAwait(false);
                ...
                _currentPersistentStorage =
                    new ReferenceCountedDisposable<IChecksummedPersistentStorage>(storage);
        ...
        )
        {
            ...
            var result =
                await TryCreatePersistentStorageAsync(solutionKey, workingFolderPath)
                    .ConfigureAwait(false)
                ?? await TryCreatePersistentStorageAsync(solutionKey, workingFolderPath)
                    .ConfigureAwait(false);
            if (result != null)
        ...
        )
        {
            ...
            try
            {
                return await TryOpenDatabaseAsync(solutionKey, workingFolderPath, databaseFilePath)
                    .ConfigureAwait(false);
            }
            catch (Exception ex)
            {
        ...
        internal readonly struct TestAccessor
        {
            ...
            public TestAccessor(AbstractPersistentStorageService service) => _service = service;
            ...
            : IChecksummedPersistentStorage
        {
            ...
            private PersistentStorageReferenceCountedDisposableWrapper(
