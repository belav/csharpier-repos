...
namespace Microsoft.CodeAnalysis.CodeRefactorings
{
    ...
    /// Remember to use <see cref="ExportCodeRefactoringProviderAttribute"/> so the host environment can
    // offer your refactorings in a UI.
    /// </summary>
    public abstract class CodeRefactoringProvider
    {
        ...
        /// <summary>
        /// Gets an optional <see cref="FixAllProvider"/> that can apply multiple occurrences of code
        // refactoring(s)
        /// registered by this code refactoring provider across the supported <see
        // cref="CodeFixes.FixAllScope"/>s.
