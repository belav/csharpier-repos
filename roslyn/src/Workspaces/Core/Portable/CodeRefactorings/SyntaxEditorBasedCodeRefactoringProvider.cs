...
namespace Microsoft.CodeAnalysis.CodeRefactorings
{
        ...
        : CodeRefactoringProvider
    {
        ...
        protected static readonly ImmutableArray<FixAllScope> AllFixAllScopes =
            ...
            return FixAllProvider.Create(
                async (fixAllContext, document, fixAllSpans) =>
                {
                    return await this.FixAllAsync(
                            document,
                            fixAllSpans,
                            fixAllContext.GetOptionsProvider(),
        ...
        )
        {
            ...
            Task FixAllAsync(SyntaxEditor editor)
            {
                ...
                var spans = fixAllSpans.HasValue
                    ? fixAllSpans.Value
                    : ImmutableArray.Create(editor.OriginalRoot.FullSpan);
                return this.FixAllAsync(
                    document,
                    spans,
                    editor,
                    optionsProvider,
