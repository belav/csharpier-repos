...
namespace Microsoft.CodeAnalysis.Remote
{
    ...
    internal abstract class RemoteHostClient : IDisposable
    {
        ...
        public virtual void Dispose() => OnStatusChanged(started: false);

        private void OnStatusChanged(bool started) => StatusChanged?.Invoke(this, started);
        ...
        public abstract Task<RemoteServiceConnection> CreateConnectionAsync(
        ...
        ) where TService : class
        {
            ...
            return await connection.TryInvokeAsync(invocation, cancellationToken)
        ...
        {
            using var connection = CreateConnection<TService>(callbackTarget: null);
            return await connection.TryInvokeAsync(solution, invocation, cancellationToken)
                .ConfigureAwait(false);
        }
        ...
        {
            using var connection = CreateConnection<TService>(callbackTarget: null);
            return await connection.TryInvokeAsync(solution, invocation, reader, cancellationToken)
                .ConfigureAwait(false);
        }
