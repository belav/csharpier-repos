    ...
    public static partial class SymbolFinder
    {
        ...
        )
        {
            ...
            var directReference = references
                .Where(r => SymbolEquivalenceComparer.Instance.Equals(symbol, r.Definition))
                .FirstOrDefault();
            ...
            {
                await AddReferencingSymbols(indirectReference, isDirect: false)
                    .ConfigureAwait(false);
            }
        ...
        {
            if (symbol.Kind is SymbolKind.Event or SymbolKind.Method or SymbolKind.Property)
            {
