...
namespace Microsoft.CodeAnalysis.FindSymbols
{
    ...
    internal static class DeclarationFinder
    {
        ...
        )
        {
            ...
            var lazyCompilation = new AsyncLazy<Compilation>(
            ...
            async Task SearchProjectReferencesAsync()
            {
                ...
                foreach (var projectReference in project.ProjectReferences)
                {
                    ...
                    await AddAllAsync(
                            buffer,
                            mapSymbol: referencedProject.Language != project.Language
                        )
                        .ConfigureAwait(false);
                }
            }
            ...
            async Task SearchMetadataReferencesAsync()
            {
                ...
                )
                {
                    ...
                    var lazyAssembly = new AsyncLazy<IAssemblySymbol?>(
                        async cancellationToken =>
                        {
                            var compilation = await lazyCompilation
                                ...
                                .ConfigureAwait(false);
                            var assemblySymbol =
                                compilation.GetAssemblyOrModuleSymbol(peReference)
                                as IAssemblySymbol;
