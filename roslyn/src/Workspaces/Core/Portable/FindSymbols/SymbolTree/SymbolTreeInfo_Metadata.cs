    ...
    internal partial class SymbolTreeInfo
    {
        ...
        )
        {
            return LoadOrCreateAsync(
                ...
                solutionKey,
                getChecksumAsync: () =>
                    new ValueTask<Checksum>(
                        GetMetadataChecksum(services, reference, cancellationToken)
                    ),
                createAsync: checksum =>
                    new ValueTask<SymbolTreeInfo>(
                        new MetadataInfoCreator(checksum, reference).Create()
                    ),
        ...
        private struct MetadataInfoCreator : IDisposable
        {
            ...
            public MetadataInfoCreator(Checksum checksum, PortableExecutableReference reference)
            {
                _checksum = checksum;
