    ...
    internal static partial class DependentTypeFinder
    {
        ...
        )
        {
            ...
            using (Logger.LogBlock(functionId, cancellationToken))
            {
                ...
                {
                    DependentTypesKind.DerivedClasses => FindDerivedClassesInCurrentProcessAsync(
                        type,
                        solution,
                        projects,
                        transitive,
        ...
        private static async Task<ImmutableArray<INamedTypeSymbol>> RehydrateAsync(
            Solution solution,
        ...
        )
        {
            ...
            {
                var rehydrated = await item.TryRehydrateAsync(solution, cancellationToken)
                    .ConfigureAwait(false);
