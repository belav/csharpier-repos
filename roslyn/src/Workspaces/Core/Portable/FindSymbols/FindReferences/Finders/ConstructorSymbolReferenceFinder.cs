...
namespace Microsoft.CodeAnalysis.FindSymbols.Finders
{
    internal class ConstructorSymbolReferenceFinder : AbstractReferenceFinder<IMethodSymbol>
    {
        ...
        )
        {
            ...
            await AddDocumentsAsync(project, documents, typeName, result, cancellationToken)
            ...
            result.AddRange(
                await FindDocumentsAsync(
                        project,
                        documents,
                        containingType.SpecialType.ToPredefinedType(),
                        cancellationToken
                    )
                    .ConfigureAwait(false)
            );
        ...
        > FindDocumentsWithImplicitObjectCreationExpressionAsync(
            ...
            FindDocumentsWithPredicateAsync(
                project,
                documents,
                static index => index.ContainsImplicitObjectCreation,
                cancellationToken
            );
        ...
        )
        {
            ...
            await NamedTypeSymbolReferenceFinder
                .AddReferencesToTypeOrGlobalAliasToItAsync(
            ...
            result.AddRange(
                await FindPredefinedTypeReferencesAsync(methodSymbol, state, cancellationToken)
                    .ConfigureAwait(false)
            );
