...
namespace Microsoft.CodeAnalysis.FindSymbols.Finders
{
        ...
        : AbstractReferenceFinder<TSymbol> where TSymbol : ISymbol
    {
        ...
        protected static ValueTask<
            ImmutableArray<FinderLocation>
        > FindReferencesInTokensWithSymbolNameAsync(
            TSymbol symbol,
            Document document,
            SemanticModel semanticModel,
        ...
        )
        {
            ...
            var tokens = declarations.SelectMany(
                r => r.GetSyntax(cancellationToken).DescendantTokens()
            );
        ...
        protected abstract Func<SyntaxToken, bool> GetTokensMatchFunction(
