        ...
        : AbstractMethodOrPropertyOrEventSymbolReferenceFinder<IPropertySymbol>
    {
        ...
        )
        {
            return FindDocumentsWithPredicateAsync(
                project,
                documents,
                info => info.ContainsElementAccessExpression,
                cancellationToken
            );
        }
        ...
        )
        {
            return FindDocumentsWithPredicateAsync(
                project,
                documents,
                info => info.ContainsIndexerMemberCref,
                cancellationToken
            );
        }
        ...
        )
        {
            ...
            var indexerReferenceExpresssions = syntaxRoot
        ...
        )
        {
            ...
            var (matched, reason) = await symbolsMatchAsync(indexerReference, semanticModel)
                .ConfigureAwait(false);
