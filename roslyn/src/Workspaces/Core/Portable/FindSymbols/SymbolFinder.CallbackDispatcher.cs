    ...
    public static partial class SymbolFinder
    {
                ...
                IRemoteSymbolFinderService.ICallback
        {
            ...
            public ValueTask OnFindInDocumentCompletedAsync(
                ...
                GetFindReferencesCallback(callbackId)
                    .OnFindInDocumentCompletedAsync(documentId, cancellationToken);
            ...
            public ValueTask OnFindInDocumentStartedAsync(
                ...
                GetFindReferencesCallback(callbackId)
                    .OnFindInDocumentStartedAsync(documentId, cancellationToken);
            ...
            public ValueTask OnReferenceFoundAsync(
                ...
                GetFindReferencesCallback(callbackId)
                    .OnReferenceFoundAsync(symbolGroup, definition, reference, cancellationToken);
            ...
            public ValueTask OnLiteralReferenceFoundAsync(
                ...
                GetFindLiteralsCallback(callbackId)
                    .OnLiteralReferenceFoundAsync(documentId, span, cancellationToken);
        }
    }
}
