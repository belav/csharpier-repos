...
namespace Microsoft.CodeAnalysis.Classification
{
    ...
    {
        internal static PooledObject<SegmentedList<ClassifiedSpan>> GetPooledList(
            out SegmentedList<ClassifiedSpan> classifiedSpans
        ...
        /// <see cref="ClassifiedSpan"/>s may have the same <see cref="ClassifiedSpan.TextSpan"/>. This
        // occurs when there are multiple
        /// <see cref="ClassifiedSpan.ClassificationType"/>s for the same region of code. For example, a
        // reference to a static method
        /// will have two spans, one that designates it as a method, and one that designates it as static.
        /// <see cref="ClassifiedSpan"/>s may also have overlapping <see cref="ClassifiedSpan.TextSpan"/>s.
        ...
        )
        {
            return GetClassifiedSpans(
                ...
                textSpan,
                options,
                includedEmbeddedClassifications: true,
                cancellationToken
            );
        }
