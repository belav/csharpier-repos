...
namespace Microsoft.CodeAnalysis.Rename
{
    public static class RenameOptions
    {
        ...
        /// </summary>
        internal static Option<bool> RenameFile { get; } =
            new Option<bool>(nameof(RenameOptions), nameof(RenameFile), defaultValue: false);
    ...
    internal struct RenameOptionSet
    {
        ...
        internal static RenameOptionSet From(Solution solution) => From(solution, options: null);
