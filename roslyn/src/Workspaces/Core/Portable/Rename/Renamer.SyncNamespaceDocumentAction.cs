...
namespace Microsoft.CodeAnalysis.Rename
{
    public static partial class Renamer
    {
        ...
        ///
        /// For example, if a document is moved from "Bat/Bar/Baz" folder structure to "Bat/Bar/Baz/Bat" and
        // contains
        /// a namespace definition of Bat.Bar.Baz in the document, then it would update that definition to
        /// Bat.Bar.Baz.Bat and update the solution to reflect these changes. Uses <see
