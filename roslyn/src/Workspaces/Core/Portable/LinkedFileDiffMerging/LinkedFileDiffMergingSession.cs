...
namespace Microsoft.CodeAnalysis
{
    internal sealed class LinkedFileDiffMergingSession
    {
        ...
        public LinkedFileDiffMergingSession(
        ...
        )
        {
            ...
            foreach (var linkedDocumentsWithChanges in linkedDocumentGroupsWithChanges)
            {
                ...
                var allLinkedDocuments = documentInNewSolution.GetLinkedDocumentIds()
                ...
                {
                    mergedText = await _newSolution.GetDocument(linkedDocumentsWithChanges.Single())
        ...
        )
        {
            ...
            {
                mergeConflictHandler ??= _oldSolution.GetDocument(linkedDocumentGroup.First())
