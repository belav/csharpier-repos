...
{
    internal class UnitTestingIncrementalAnalyzer(
    ...
    ) : IIncrementalAnalyzer
    {
        public Task AnalyzeDocumentAsync(
            ...
            implementation.AnalyzeDocumentAsync(
                document,
                bodyOpt,
        ...
        public Task AnalyzeProjectAsync(
            ...
            implementation.AnalyzeProjectAsync(
                project,
                semanticsChanged,
                new UnitTestingInvocationReasonsWrapper(reasons),
                cancellationToken
        ...
        public Task AnalyzeSyntaxAsync(
            ...
            implementation.AnalyzeSyntaxAsync(
                document,
                new UnitTestingInvocationReasonsWrapper(reasons),
                cancellationToken
            );
        ...
        // In future, we should add a separate option to allow users to configure background analysis scope
        // for unit testing.
