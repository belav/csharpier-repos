...
namespace Microsoft.CodeAnalysis.CodeFixes
{
    ...
    public partial class FixAllContext
    {
        ...
        public abstract class DiagnosticProvider
        {
            ...
            /// </summary>
            public abstract Task<IEnumerable<Diagnostic>> GetDocumentDiagnosticsAsync(
                Document document,
            ...
            /// </summary>
            public abstract Task<IEnumerable<Diagnostic>> GetProjectDiagnosticsAsync(
                Project project,
                CancellationToken cancellationToken
            );
            ...
            {
                var result = await GetDocumentDiagnosticsToFixWorkerAsync(fixAllContext)
