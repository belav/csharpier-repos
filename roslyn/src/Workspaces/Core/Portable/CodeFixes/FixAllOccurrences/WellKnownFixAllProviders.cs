...
namespace Microsoft.CodeAnalysis.CodeFixes
{
    ...
    public static class WellKnownFixAllProviders
    {
        ...
        /// computes fixes in parallel and then merges all the non-conflicting fixes into a single fix all
        // code action.
        /// This fixer supports fixes for the following fix all scopes:
        /// <see cref="FixAllScope.Document"/>, <see cref="FixAllScope.Project"/>, <see
        // cref="FixAllScope.Solution"/>
        /// <see cref="FixAllScope.ContainingMember"/> and <see cref="FixAllScope.ContainingType"/>.
        /// </summary>
        /// <remarks>
        /// The batch fix all provider only batches operations (i.e. <see cref="CodeActionOperation"/>) of
        // type
        /// <see cref="ApplyChangesOperation"/> present within the individual diagnostic fixes. Other types
        // of
