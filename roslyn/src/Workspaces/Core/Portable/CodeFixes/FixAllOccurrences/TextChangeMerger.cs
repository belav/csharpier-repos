...
namespace Microsoft.CodeAnalysis.CodeFixes
{
    ...
    internal class TextChangeMerger
    {
        ...
        private readonly SimpleIntervalTree<
            TextChange,
            IntervalIntrospector
        > _totalChangesIntervalTree = SimpleIntervalTree.Create(
        ...
        public TextChangeMerger(Document document)
        {
            ...
            _differenceService = document.Project
                .Solution
                .Services
        ...
        )
        {
            ...
            var currentChanges = await _differenceService
                .GetTextChangesAsync(_oldDocument, newDocument, cancellationToken)
        ...
        )
        {
            ...
            if (intersectingSpans.Count == 1)
            {
                ...
                return !IsPureInsertion(otherChange) && otherChange.Span.End == change.Span.Start;
            }
