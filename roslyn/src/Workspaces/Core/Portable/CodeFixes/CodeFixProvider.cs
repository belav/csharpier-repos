...
namespace Microsoft.CodeAnalysis.CodeFixes
{
    ...
    /// Remember to use <see cref="ExportCodeFixProviderAttribute"/> so the host environment can offer
    // your fixes in a UI.
    /// </summary>
    public abstract class CodeFixProvider
    {
        ...
        /// The context must only contain diagnostics with a <see cref="Diagnostic.Id"/> included in the
        // <see cref="FixableDiagnosticIds"/> for the current provider.
        /// </param>
        public abstract Task RegisterCodeFixesAsync(CodeFixContext context);

        /// <summary>
        /// Gets an optional <see cref="FixAllProvider"/> that can fix all/multiple occurrences of
        // diagnostics fixed by this code fix provider.
        /// Return null if the provider doesn't support fix all/multiple occurrences.
        /// Otherwise, you can return any of the well known fix all providers from <see
        // cref="WellKnownFixAllProviders"/> or implement your own fix all provider.
        /// </summary>
        public virtual FixAllProvider? GetFixAllProvider() => null;

        /// <summary>
        /// Computes the <see cref="CodeActionRequestPriority"/> group this provider should be considered to
        // run at. Legal values
        /// this can be must be between <see cref="CodeActionRequestPriority.Low"/> and <see
        // cref="CodeActionPriority.High"/>.
        /// </summary>
        /// <remarks>
        /// Values outside of this range will be clamped to be within that range.  Requests for <see
        /// cref="CodeActionRequestPriority.High"/> may be downgraded to <see
        // cref="CodeActionRequestPriority.Default"/> as they
        ...
        /// cref="CodeActionRequestPriority.Default"/> if not overridden.  Slower, or less relevant,
        // providers should
        /// override this and return a lower value to not interfere with computation of normal priority
        // providers.
        /// </summary>
