...
namespace Microsoft.CodeAnalysis.CodeStyle
{
    ...
    public class CodeStyleOption<T> : ICodeStyleOption, IEquatable<CodeStyleOption<T>>
    {
        ...
        bool IObjectWritable.ShouldReuseInSerialization =>
            _codeStyleOptionImpl.ShouldReuseInSerialization;
        ...
        ICodeStyleOption ICodeStyleOption.WithValue(object value) =>
            new CodeStyleOption<T>((T)value, Notification);
        ICodeStyleOption ICodeStyleOption.WithNotification(NotificationOption2 notification) =>
            new CodeStyleOption<T>(Value, (NotificationOption)notification);
        ...
        public NotificationOption Notification
        {
            ...
            set =>
                _codeStyleOptionImpl.Notification = (NotificationOption2)(
        ...
        void IObjectWritable.WriteTo(ObjectWriter writer) => _codeStyleOptionImpl.WriteTo(writer);
        ...
        public override bool Equals(object obj) =>
            obj is CodeStyleOption<T> option && Equals(option);

        public override int GetHashCode() => _codeStyleOptionImpl.GetHashCode();
    }
}
