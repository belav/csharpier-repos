...
namespace Microsoft.CodeAnalysis
{
    ...
    internal class WorkspaceConfigurationOptions : IOptionProvider
    {
        ...
        /// </summary>
        public static readonly Option<bool> DisableRecoverableTrees =
            new(
                nameof(WorkspaceConfigurationOptions),
                nameof(DisableRecoverableTrees),
                defaultValue: false,
                new FeatureFlagStorageLocation("Roslyn.DisableRecoverableTrees")
            );

        public static readonly Option<bool> DisableProjectCacheService =
            new(
                nameof(WorkspaceConfigurationOptions),
        ...
        /// </summary>
        public static readonly Option<bool> DisableReferenceManagerWeakRuntimeReferences =
            new(
                nameof(WorkspaceConfigurationOptions),
                nameof(DisableReferenceManagerWeakRuntimeReferences),
                defaultValue: false,
                new FeatureFlagStorageLocation(
                    "Roslyn.DisableReferenceManagerWeakRuntimeReferences"
                )
            );
        ...
        /// Disables holding onto the assembly references for runtime (not user/nuget/etc.) dlls weakly.
        /// </summary>
        public static readonly Option<bool> DisableCompilationTrackerWeakCompilationReferences =
            new(
                nameof(WorkspaceConfigurationOptions),
                nameof(DisableCompilationTrackerWeakCompilationReferences),
                defaultValue: false,
                new FeatureFlagStorageLocation(
                    "Roslyn.DisableCompilationTrackerWeakCompilationReferences"
                )
            );
