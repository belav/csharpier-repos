...
namespace Microsoft.CodeAnalysis.Host
{
    ...
    internal class MetadataReferenceCache(
        Func<string, MetadataReferenceProperties, MetadataReference> createReference
    )
    {
        ...
        private readonly Func<
            ...
            MetadataReference
        > _createReference =
            createReference ?? throw new ArgumentNullException(nameof(createReference));
        ...
        public MetadataReference GetReference(string path, MetadataReferenceProperties properties)
        {
            ...
            {
                referenceSet = ImmutableInterlocked.GetOrAdd(
                    ref _referenceSets,
                    path,
                    new ReferenceSet(this)
                );
            }
