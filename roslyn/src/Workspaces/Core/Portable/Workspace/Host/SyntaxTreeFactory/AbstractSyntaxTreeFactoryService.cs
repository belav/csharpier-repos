...
namespace Microsoft.CodeAnalysis.Host
{
    internal abstract partial class AbstractSyntaxTreeFactoryService : ISyntaxTreeFactoryService
    {
        ...
        public AbstractSyntaxTreeFactoryService(HostLanguageServices languageServices)
        {
            ...
            var cacheService =
                languageServices.WorkspaceServices.GetService<IProjectCacheHostService>();
            _minimumLengthForRecoverableTree =
                (cacheService != null)
                    ? cacheService.MinimumLengthForRecoverableTree
                    : int.MaxValue;
        }
        ...
        public abstract bool OptionsDifferOnlyByPreprocessorDirectives(
