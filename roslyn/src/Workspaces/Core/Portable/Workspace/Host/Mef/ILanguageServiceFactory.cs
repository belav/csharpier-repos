...
namespace Microsoft.CodeAnalysis.Host.Mef
{
    ...
    ///
    /// Implement a <see cref="ILanguageServiceFactory"/> when you want to provide <see
    // cref="ILanguageService"/> instances that use other services.
    /// </summary>
    public interface ILanguageServiceFactory
    {
        ...
        /// </summary>
        /// <param name="languageServices">The <see cref="HostLanguageServices"/> that can be used to access
        // other services.</param>
