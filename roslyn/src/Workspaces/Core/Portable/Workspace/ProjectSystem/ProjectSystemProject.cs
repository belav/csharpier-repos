...
namespace Microsoft.CodeAnalysis.Workspaces.ProjectSystem
{
    internal sealed partial class ProjectSystemProject
    {
        ...
        private static readonly ImmutableArray<MetadataReferenceProperties> s_defaultMetadataReferenceProperties =
            ImmutableArray.Create(default(MetadataReferenceProperties));
        ...
        )> _metadataReferencesAddedInBatch = new();
        private readonly List<(
            string path,
            MetadataReferenceProperties properties
        )> _metadataReferencesRemovedInBatch = new();
        ...
        private readonly List<
            Action<SolutionChangeAccumulator>
        ...
        private readonly Dictionary<
            string,
            ImmutableArray<MetadataReferenceProperties>
        > _allMetadataReferences = new();
        ...
        private readonly CancellationTokenSource _asynchronousFileChangeProcessingCancellationTokenSource =
            new();
        ...
        )
        {
            ...
            _sourceFiles = new BatchingDocumentCollection(
                ...
                documentTextLoaderChangedAction: (s, d, loader) =>
                    s.WithDocumentTextLoader(d, loader, PreservationMode.PreserveValue),
            ...
            _additionalFiles = new BatchingDocumentCollection(
                ...
                documentTextLoaderChangedAction: (s, d, loader) =>
                    s.WithAdditionalDocumentTextLoader(d, loader, PreservationMode.PreserveValue),
            ...
            _analyzerConfigFiles = new BatchingDocumentCollection(
                ...
                documentTextLoaderChangedAction: (s, d, loader) =>
                    s.WithAnalyzerConfigDocumentTextLoader(
                        d,
                        loader,
            ...
            if (filePath != null && fileExtensionToWatch != null)
            {
                ...
                var projectDirectoryToWatch = new WatchedDirectory(
        ...
        private void ChangeProjectProperty<T>(
            ref T field,
            T newValue,
            Func<Solution, Solution> updateSolution,
        ...
        private void ChangeProjectProperty<T>(
            ref T field,
            T newValue,
            Action<SolutionChangeAccumulator, T> updateSolution,
            bool logThrowAwayTelemetry = false
        )
        {
            using (_gate.DisposableWait())
            {
                ...
                if (logThrowAwayTelemetry)
                {
                    ...
                    if (telemetryService?.HasActiveSession == true)
                    {
                        ...
                        // fully loaded.
                        var isFullyLoadedTask = workspaceStatusService.IsFullyLoadedAsync(
                        ...
                        if (!isFullyLoaded)
                        {
                            TryReportCompilationThrownAway(
                                _projectSystemProjectFactory.Workspace.CurrentSolution.State,
                                Id
                            );
                        }
                    }
                ...
                {
                    _projectPropertyModificationsInBatch.Add(solutionChanges =>
        ...
        private void ChangeProjectOutputPath(
            ref string? field,
            string? newValue,
        ...
        )
        {
            ChangeProjectProperty(ref field, newValue, (solutionChanges, oldValue) =>
            {
                ...
                if (oldValue != null)
                {
                    _projectSystemProjectFactory.RemoveProjectOutputPath_NoLock(
                        solutionChanges,
                        Id,
                        oldValue
                    );
                ...
                if (newValue != null)
                {
                    _projectSystemProjectFactory.AddProjectOutputPath_NoLock(
                        solutionChanges,
                        Id,
                        newValue
                    );
        ...
        internal string? CompilationOutputAssemblyFilePath
        {
            ...
            set =>
                ChangeProjectOutputPath(ref _compilationOutputAssemblyFilePath, value, s =>
                    s.WithProjectCompilationOutputInfo(
                        Id,
                        s.GetRequiredProject(Id).CompilationOutputInfo.WithAssemblyPath(value)
                    )
                );
        }
        ...
        public string? OutputFilePath
        {
            get => _outputFilePath;
            set =>
                ChangeProjectOutputPath(ref _outputFilePath, value, s =>
                    s.WithProjectOutputFilePath(Id, value)
                );
        }
        ...
        public string? OutputRefFilePath
        {
            ...
            set =>
                ChangeProjectOutputPath(ref _outputRefFilePath, value, s =>
                    s.WithProjectOutputRefFilePath(Id, value)
                );
        }
        ...
        public string? FilePath
        {
            get => _filePath;
            set =>
                ChangeProjectProperty(ref _filePath, value, s => s.WithProjectFilePath(Id, value));
        }
        ...
        public string DisplayName
        {
            get => _displayName;
            set =>
                ChangeProjectProperty(ref _displayName, value, s => s.WithProjectName(Id, value));
        }
        ...
        public SourceHashAlgorithm ChecksumAlgorithm
        {
            ...
            set =>
                ChangeProjectProperty(ref _checksumAlgorithm, value, s =>
                    s.WithProjectChecksumAlgorithm(Id, value)
                );
        }
        ...
        internal bool HasAllInformation
        {
            ...
            set =>
                ChangeProjectProperty(ref _hasAllInformation, value, s =>
                    s.WithHasAllInformation(Id, value)
                );
        }
        ...
        private void UpdateRunAnalyzers()
        {
            ...
            var runAnalyzers =
                _runAnalyzersPropertyValue ?? _runAnalyzersDuringLiveAnalysisPropertyValue ?? true;
            ChangeProjectProperty(ref _runAnalyzers, runAnalyzers, s =>
                s.WithRunAnalyzers(Id, runAnalyzers)
            );
        }
        ...
        internal string? DefaultNamespace
        {
            ...
            set =>
                ChangeProjectProperty(ref _defaultNamespace, value, s =>
                    s.WithProjectDefaultNamespace(Id, value)
                );
        }
        ...
        private bool HasBeenRemoved =>
            !_projectSystemProjectFactory.Workspace.CurrentSolution.ContainsProject(Id);
        ...
        public sealed class BatchScope : IDisposable, IAsyncDisposable
        {
            ...
            public async ValueTask DisposeAsync()
            {
                ...
                {
                    await _project
                        .OnBatchScopeDisposedMaybeAsync(useAsync: true)
        ...
        private async Task OnBatchScopeDisposedMaybeAsync(bool useAsync)
        {
            ...
            )
            {
                ...
                var documentsToOpen =
                    new List<(DocumentId documentId, SourceTextContainer textContainer)>();
                var additionalDocumentsToOpen =
                    new List<(DocumentId documentId, SourceTextContainer textContainer)>();
                var analyzerConfigDocumentsToOpen =
                    new List<(DocumentId documentId, SourceTextContainer textContainer)>();
                    ...
                    .ApplyBatchChangeToWorkspaceMaybeAsync(useAsync, solutionChanges =>
                    {
                        ...
                        foreach (var (path, properties) in _metadataReferencesRemovedInBatch)
                        {
                            var projectReference =
                                _projectSystemProjectFactory.TryRemoveConvertedProjectReference_NoLock(
                                    Id,
                                    path,
                                    properties
                                );
                        ...
                        if (_metadataReferencesAddedInBatch.Count > 0)
                        {
                            ...
                            {
                                var projectReference =
                                    _projectSystemProjectFactory.TryCreateConvertedProjectReference_NoLock(
                                        Id,
                                        path,
                                        properties
                                    );
                ...
                foreach (var (documentId, textContainer) in analyzerConfigDocumentsToOpen)
                {
                    await _projectSystemProjectFactory
                        .ApplyChangeToWorkspaceMaybeAsync(useAsync, w =>
                            w.OnAnalyzerConfigDocumentOpened(documentId, textContainer)
                        )
                        .ConfigureAwait(false);
                }
                ...
                if (documentFileNamesAdded.Count > 0)
                {
                    await _projectSystemProjectFactory
                        .RaiseOnDocumentsAddedMaybeAsync(
                            useAsync,
                            documentFileNamesAdded.ToImmutable()
                        )
                        .ConfigureAwait(false);
                }
            }
        ...
        public bool ContainsSourceFile(string fullPath) => _sourceFiles.ContainsFile(fullPath);

        public void RemoveSourceFile(string fullPath) => _sourceFiles.RemoveFile(fullPath);
            ...
            using (_gate.DisposableWait())
            {
                if (_dynamicFilePathMaps.ContainsKey(dynamicFilePath))
                {
                    ...
                    throw new ArgumentException(
                        $"{dynamicFilePath} has already been added to this project."
                    );
                }
        ...
        )
        {
            ...
            if (string.IsNullOrEmpty(fileInfo.FilePath))
            {
                return new DynamicFileInfo(
                    filePath,
                    fileInfo.SourceCodeKind,
                    fileInfo.TextLoader,
                    fileInfo.DesignTimeOnly,
        ...
        public void RemoveDynamicSourceFile(string dynamicFilePath)
        {
            ...
            using (_gate.DisposableWait())
            {
                ...
                {
                    throw new ArgumentException(
                        $"{dynamicFilePath} wasn't added by a previous call to {nameof(AddDynamicSourceFile)}"
                    );
                }
        ...
        public void AddAnalyzerReference(string fullPath)
        {
            ...
            using (_gate.DisposableWait())
            {
                ...
                foreach (var mappedFullPath in mappedPaths)
                {
                    ...
                    var analyzerPendingRemoval = _analyzersRemovedInBatch.FirstOrDefault(a =>
                        a.FullPath == mappedFullPath
                    );
                    ...
                    else
                    {
                        ...
                        else
                        {
                            _projectSystemProjectFactory.ApplyChangeToWorkspace(w =>
                                w.OnAnalyzerReferenceAdded(Id, visualStudioAnalyzer.GetReference())
                            );
                        }
                    }
                }
        ...
        public void RemoveAnalyzerReference(string fullPath)
        {
            ...
            using (_gate.DisposableWait())
            {
                ...
                foreach (var mappedFullPath in mappedPaths)
                {
                    ...
                    {
                        throw new ArgumentException(
                            $"'{fullPath}' is not an analyzer of this project.",
                            nameof(fullPath)
                        );
                    }
                }
                ...
                foreach (var mappedFullPath in mappedPaths)
                {
                    ...
                    {
                        _projectSystemProjectFactory.ApplyChangeToWorkspace(w =>
                            w.OnAnalyzerReferenceRemoved(Id, visualStudioAnalyzer.GetReference())
                        );
        ...
        private static readonly string s_razorSourceGeneratorSdkDirectory =
            Path.Combine("Sdks", "Microsoft.NET.Sdk.Razor", "source-generators")
        ...
        private static readonly ImmutableArray<string> s_razorSourceGeneratorAssemblyRootedFileNames =
            s_razorSourceGeneratorAssemblyNames.SelectAsArray(assemblyName =>
                PathUtilities.DirectorySeparatorStr + assemblyName + ".dll"
            );
        ...
        private OneOrMany<string> GetMappedAnalyzerPaths(string fullPath)
        {
            ...
            if (
                fullPath.LastIndexOf(
                    ...
                    + s_razorSourceGeneratorSdkDirectory.Length
                    - 1
            ...
            )
            {
                ...
                {
                    if (
                        s_razorSourceGeneratorAssemblyRootedFileNames.Any(
                            static (fileName, fullPath) =>
                                fullPath.EndsWith(fileName, StringComparison.OrdinalIgnoreCase),
                            fullPath
                        )
                    )
                    {
        ...
        )
        {
            ...
            await _analyzerConfigFiles
                .ProcessRegularFileChangesAsync(filePaths)
                .ConfigureAwait(false);
        }
            ...
            using (_gate.DisposableWait())
            {
                if (ContainsMetadataReference_NoLock(fullPath, properties))
                {
                    throw new InvalidOperationException(
                        "The metadata reference has already been added to the project."
                    );
                }

                _allMetadataReferences.MultiAdd(
                    fullPath,
                    properties,
                    s_defaultMetadataReferenceProperties
                );
        ...
        private bool ContainsMetadataReference_NoLock(
            string fullPath,
            MetadataReferenceProperties properties
        )
        {
            ...
            return _allMetadataReferences.TryGetValue(fullPath, out var propertiesList)
                && propertiesList.Contains(properties);
        }
        ...
        public void RemoveMetadataReference(string fullPath, MetadataReferenceProperties properties)
        {
            ...
            using (_gate.DisposableWait())
            {
                ...
                {
                    throw new InvalidOperationException(
                        "The metadata reference does not exist in this project."
                    );
                }
        ...
        public void AddProjectReference(ProjectReference projectReference)
        {
            ...
            using (_gate.DisposableWait())
            {
                ...
                {
                    throw new ArgumentException(
                        "The project reference has already been added to the project."
                    );
                }
        ...
        public void RemoveProjectReference(ProjectReference projectReference)
        {
            ...
            using (_gate.DisposableWait())
            {
                ...
                {
                    throw new ArgumentException(
                        "The project does not contain that project reference."
                    );
                }
