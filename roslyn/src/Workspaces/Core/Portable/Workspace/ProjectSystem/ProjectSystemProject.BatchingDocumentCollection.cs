    ...
    internal sealed partial class ProjectSystemProject
    {
        ...
        private sealed class BatchingDocumentCollection
        {
            ...
            )
            {
                ...
                var textLoader = new WorkspaceFileTextLoader(
                    _project._projectSystemProjectFactory.Workspace.Services.SolutionServices,
                    fullPath,
                ...
                using (_project._gate.DisposableWait())
                {
                    ...
                    else
                    {
                        ...
                        _project._projectSystemProjectFactory.RaiseOnDocumentsAdded(
