...
namespace Microsoft.CodeAnalysis
{
    ...
    {
        public static readonly MetadataOnlyImage Empty =
            new(storage: null, assemblyName: string.Empty);
        ...
        public static MetadataOnlyImage Create(
            Workspace workspace,
        ...
        )
        {
            ...
            try
            {
                ...
                )
                {
                    ...
                    var emitResult = compilation.Clone()
                        .Emit(stream, options: s_emitOptions, cancellationToken: cancellationToken);
                        ...
                        Logger.Log(
                            ...
                            KeyValueLogMessage.Create(
                                m =>
                                {
                                    ...
                                    // CS0001:1;CS002:10;...
                                    var groups = emitResult.Diagnostics.GroupBy(d => d.Id)
