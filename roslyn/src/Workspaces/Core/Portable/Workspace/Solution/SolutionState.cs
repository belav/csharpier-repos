...
namespace Microsoft.CodeAnalysis
{
    ...
    internal partial class SolutionState
    {
        ...
        private readonly Dictionary<
            ProjectId,
            AsyncLazy<SolutionStateChecksums>
        ...
        )
        {
            ...
            _lazyChecksums = AsyncLazy.Create(c =>
                ComputeChecksumsAsync(projectsToInclude: null, c)
            );
        ...
        /// </summary>
        public SolutionState WithProjectChecksumAlgorithm(
            ProjectId projectId,
        ...
        public SolutionState WithDocumentContentsFrom(
            DocumentId documentId,
        ...
        )
        {
            ...
            if (
                oldDocument.TextAndVersionSource == documentState.TextAndVersionSource
            ...
            return UpdateDocumentState(
                oldDocument.UpdateTextAndTreeContents(
                    documentState.TextAndVersionSource,
            ...
            if (newTrackerMap.TryGetValue(projectId, out var tracker))
            {
                ...
                if (forkTracker)
                {
                    newTrackerMap = newTrackerMap.Add(
                        projectId,
                        tracker.Fork(newProjectState, translate)
                    );
                }
            }
        ...
        )
        {
            ...
            using var _ = ArrayBuilder<KeyValuePair<ProjectId, ICompilationTracker>>.GetInstance(
                _projectIdToTrackerMap.Count,
                out var newTrackerInfo
            );
            var allReused = true;
            foreach (var (id, tracker) in _projectIdToTrackerMap)
            {
                ...
                newTrackerInfo.Add(
                    new KeyValuePair<ProjectId, ICompilationTracker>(id, localTracker)
                );
            }
        ...
        public SolutionState WithOptions(SolutionOptionSet options) => Branch(options: options);
        ...
        )
        {
            try
            {
                ...
                using var _ = ArrayBuilder<(DocumentState, SyntaxTree)>.GetInstance(
                ...
                using (this.StateLock.DisposableWait(cancellationToken))
                {
                    ...
                    if (
                        Services
                            .GetService<IWorkspacePartialSolutionsTestHook>()
                            ?.IsPartialSolutionDisabled == true
                    )
                    {
                        return this;
                    }
                    ...
                    foreach (var (doc, tree) in builder)
                    {
                        ...
                        newIdToProjectStateMap = newIdToProjectStateMap.SetItem(
                            doc.Id.ProjectId,
                ...
                static (documentId, args) =>
                {
                    ...
                    if (projectState == null)
                    {
                        ...
                        FatalError.ReportAndCatch(
                            new Exception(
                                "GetDocumentIdsWithFilePath returned a document in a project that does not exist."
                            )
                        );
                        return false;
                    }
        ...
        )
        {
            ...
            return project.SupportsCompilation
                ...
                : project.HasAllInformation ? SpecializedTasks.True
        ...
        public SolutionState WithCachedSourceGeneratorState(
            ProjectId projectToUpdate,
            Project projectWithCachedGeneratorState
        )
        {
        ...
        internal readonly struct TestAccessor(SolutionState solutionState)
        {
            ...
            {
                return project.SupportsCompilation
                    ? solutionState.GetCompilationTracker(project.Id).GeneratorDriver
                    : null;
            }
        }
    }
