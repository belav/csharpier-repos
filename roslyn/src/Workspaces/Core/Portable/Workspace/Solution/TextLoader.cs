...
namespace Microsoft.CodeAnalysis
{
    ...
    public abstract class TextLoader
    {
        ...
        /// </summary>
        internal virtual bool CanReloadText => false;
...
#pragma warning disable CS0618 // Type or member is obsolete
            ...
            {
                return LoadTextAndVersionAsync(
                    workspace: null,
                    documentId: null,
                    cancellationToken
                );
...
#pragma warning restore
        ...
        )
        {
            ...
            while (true)
            {
                try
                {
                    return await LoadTextAndVersionAsync(options, cancellationToken)
        ...
        private sealed class TextContainerLoader : TextLoader
        {
            ...
            internal override string? FilePath => _filePath;
