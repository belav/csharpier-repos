    ...
    internal partial class SolutionState
    {
        ...
        private class GeneratedFileReplacingCompilationTracker : ICompilationTracker
        {
            ...
            )
            {
                ...
                var underlyingCompilation = await _underlyingTracker
                    .GetCompilationAsync(solution, cancellationToken)
                    .ConfigureAwait(false);
                var underlyingSourceGeneratedDocuments = await _underlyingTracker
            ...
            {
                var underlyingGeneratedDocumentStates = await _underlyingTracker
                    .GetSourceGeneratedDocumentStatesAsync(solution, cancellationToken)
                    .ConfigureAwait(false);
            ...
            )
            {
                ...
                {
                    return _underlyingTracker.TryGetSourceGeneratedDocumentStateForAlreadyGeneratedId(
                        documentId
                    );
                }
            }
