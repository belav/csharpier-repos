...
namespace Microsoft.CodeAnalysis
{
    public partial class ProjectDependencyGraph
    {
        ...
        )
        {
            ...
            var newTransitiveReferencesMap =
            ...
            var newReverseTransitiveReferencesMap =
                ComputeNewReverseTransitiveReferencesMapForAdditionalProjectReferences(
        ...
        )
        {
            if (existingReferencesMap.TryGetValue(projectId, out var existingReferences))
            {
                return existingReferencesMap.SetItem(
                    projectId,
                    existingReferences.Union(referencedProjectIds)
                );
            }
            else
            {
                return existingReferencesMap.SetItem(
                    projectId,
                    referencedProjectIds.ToImmutableHashSet()
                );
            }
        }
        ...
        )
        {
            ...
            {
                if (
                    existingTransitiveReferencesMap.TryGetValue(
                        referencedProjectId,
        ...
        )
        {
            ...
            existingReverseTransitiveReferencesMap.TryGetValue(
                projectId,
                out var newReverseTranstiveReferences
            );
