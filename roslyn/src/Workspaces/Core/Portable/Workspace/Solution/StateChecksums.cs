...
{
    internal sealed class SolutionStateChecksums(ImmutableArray<object> children)
        : ChecksumWithChildren(children)
    {
    ...
    internal class ProjectStateChecksums(ImmutableArray<object> children)
        : ChecksumWithChildren(children)
    {
    ...
    internal class DocumentStateChecksums(ImmutableArray<object> children)
        : ChecksumWithChildren(children)
    {
