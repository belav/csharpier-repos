...
namespace Microsoft.CodeAnalysis.Serialization
{
    ...
    internal class ProjectChecksumCollection : ChecksumCollection
    {
        ...
        public ProjectChecksumCollection(object[] checksums)
            : base(WellKnownSynchronizationKind.ProjectChecksumCollection, checksums) { }
    }
    ...
    internal class DocumentChecksumCollection : ChecksumCollection
    {
        ...
        public DocumentChecksumCollection(object[] checksums)
            : base(WellKnownSynchronizationKind.DocumentChecksumCollection, checksums) { }
    }
    ...
    internal class TextDocumentChecksumCollection : ChecksumCollection
    {
        ...
        public TextDocumentChecksumCollection(object[] checksums)
            : base(WellKnownSynchronizationKind.TextDocumentChecksumCollection, checksums) { }
    }

    internal class AnalyzerConfigDocumentChecksumCollection : ChecksumCollection
    {
        public AnalyzerConfigDocumentChecksumCollection(Checksum[] checksums)
            : this((object[])checksums) { }
        public AnalyzerConfigDocumentChecksumCollection(object[] checksums)
            : base(WellKnownSynchronizationKind.AnalyzerConfigDocumentChecksumCollection, checksums)
        { }
    }
    ...
    internal class ProjectReferenceChecksumCollection : ChecksumCollection
    {
        ...
        public ProjectReferenceChecksumCollection(object[] checksums)
            : base(WellKnownSynchronizationKind.ProjectReferenceChecksumCollection, checksums) { }
    }
    ...
    internal class MetadataReferenceChecksumCollection : ChecksumCollection
    {
        ...
        public MetadataReferenceChecksumCollection(object[] checksums)
            : base(WellKnownSynchronizationKind.MetadataReferenceChecksumCollection, checksums) { }
    }
    ...
    internal class AnalyzerReferenceChecksumCollection : ChecksumCollection
    {
        ...
        public AnalyzerReferenceChecksumCollection(object[] checksums)
            : base(WellKnownSynchronizationKind.AnalyzerReferenceChecksumCollection, checksums) { }
    }
}
