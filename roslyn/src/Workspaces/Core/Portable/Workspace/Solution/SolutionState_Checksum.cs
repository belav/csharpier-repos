...
namespace Microsoft.CodeAnalysis
{
    internal partial class SolutionState
    {
        private static readonly ConditionalWeakTable<
            ...
            IReadOnlyList<ProjectId>
        > s_projectIdToSortedProjectsMap = new();
                ...
                )
                {
                    ...
                    var projectChecksumTasks = orderedProjectIds
                        ...
                        .Select(async t =>
                        {
                            ...
                            if (t.mustCompute)
                                return await t.state.GetStateChecksumsAsync(cancellationToken)
                                    .ConfigureAwait(false);
                    ...
                    using var _2 = ArrayBuilder<Checksum>.GetInstance(
                        allResults.Length,
                        out var projectChecksums
                    );
