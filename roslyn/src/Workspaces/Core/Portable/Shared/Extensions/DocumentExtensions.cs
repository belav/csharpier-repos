...
namespace Microsoft.CodeAnalysis.Shared.Extensions
{
    internal static partial class DocumentExtensions
    {
        ...
        public static async ValueTask<SyntaxTreeIndex> GetSyntaxTreeIndexAsync(
        ...
        public static ValueTask<SyntaxTreeIndex?> GetSyntaxTreeIndexAsync(
            this Document document,
            bool loadOnly,
            CancellationToken cancellationToken
        ...
        /// </summary>
        public static async Task<(Document document, SemanticModel? semanticModel)> GetPartialSemanticModelAsync(
            this Document document,
            CancellationToken cancellationToken
        )
        {
