...
namespace Microsoft.CodeAnalysis.Shared.Utilities
{
    internal class SignatureComparer
    {
        ...
        private IEqualityComparer<ITypeSymbol> SignatureTypeEquivalenceComparer =>
            _symbolEquivalenceComparer.SignatureTypeEquivalenceComparer;
        ...
        )
        {
            ...
            if (method1.MethodKind != method2.MethodKind || method1.Arity != method2.Arity)
            {
                return false;
            }
        ...
        public bool HaveSameSignatureAndConstraintsAndReturnTypeAndAccessors(
            ISymbol symbol1,
            ISymbol symbol2,
            bool caseSensitive
        )
        {
            ...
            switch (symbol1.Kind)
            {
                ...
                case SymbolKind.Property:
                    ...
                    return HaveSameReturnType(property1, property2)
