...
namespace Microsoft.CodeAnalysis.Editing
{
    ...
    public class SyntaxEditor
    {
        ...
        private sealed class RemoveChange(SyntaxNode node, SyntaxRemoveOptions options)
            : Change(node)
        {
            protected override SyntaxNode Apply(
                SyntaxNode root,
        ...
        private sealed class ReplaceChange : Change
        {
            ...
            protected override SyntaxNode Apply(
                ...
                ValidateNewRoot(
                    generator.ReplaceNode(root, currentNode, _modifier(currentNode, generator))
                );
        }
            ...
            protected override SyntaxNode Apply(
                ...
                ValidateNewRoot(
                    generator.ReplaceNode(
                        root,
                        currentNode,
                        modifier(currentNode, generator, argument)
                    )
                );
        }

        private sealed class InsertChange(
            SyntaxNode node,
