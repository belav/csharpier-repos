...
namespace Microsoft.CodeAnalysis.Editing
{
    public static class SyntaxEditorExtensions
    {
        ...
        internal static void RemoveAllAttributes(
            this SyntaxEditor editor,
            SyntaxNode declaration
        ...
        internal static void RemoveAllTypeInheritance(
            this SyntaxEditor editor,
            SyntaxNode declaration
        ...
        public static void SetTypeParameters(
            this SyntaxEditor editor,
            SyntaxNode declaration,
        ...
        public static void SetGetAccessorStatements(
            this SyntaxEditor editor,
            SyntaxNode declaration,
            IEnumerable<SyntaxNode> statements
        ) => editor.ReplaceNode(declaration, (d, g) => g.WithGetAccessorStatements(d, statements));

        public static void SetSetAccessorStatements(
            this SyntaxEditor editor,
            SyntaxNode declaration,
            IEnumerable<SyntaxNode> statements
        ...
        public static void AddReturnAttribute(
            this SyntaxEditor editor,
            SyntaxNode declaration,
            SyntaxNode attribute
        ) =>
        ...
        public static void AddInterfaceType(
            this SyntaxEditor editor,
            SyntaxNode declaration,
            SyntaxNode interfaceType
