...
namespace Microsoft.CodeAnalysis.Editing
{
    ...
    {
        private static async ValueTask<IEnumerable<TextSpan>> GetSpansAsync(
            Document document,
        ...
        public static async Task<Document> AddImportsAsync(
            ...
            await AddImportsFromSyntaxesAsync(
                    document,
                    await GetSpansAsync(document, cancellationToken).ConfigureAwait(false),
                    options,
                    cancellationToken
                )
                .ConfigureAwait(false);
        ...
        public static async Task<Document> AddImportsAsync(
            ...
            await AddImportsFromSyntaxesAsync(
                    document,
                    await GetSpansAsync(document, annotation, cancellationToken)
                        .ConfigureAwait(false),
                    options,
                    cancellationToken
                )
        ...
        private static async Task<Document> AddImportsFromSyntaxesAsync(
            Document document,
            IEnumerable<TextSpan> spans,
            OptionSet? _,
            CancellationToken cancellationToken
        )
        {
            ...
            return await service
                .AddImportsAsync(
                    document,
                    spans,
                    ImportAdderService.Strategy.AddImportsFromSyntaxes,
                    addImportOptions,
                    cancellationToken
                )
                .ConfigureAwait(false);
        ...
        internal static Task<Document> AddImportsFromSyntaxesAsync(
            ...
            document
                .GetRequiredLanguageService<ImportAdderService>()
                .AddImportsAsync(
                    document,
                    spans,
                    ImportAdderService.Strategy.AddImportsFromSyntaxes,
        ...
        internal static async Task<Document> AddImportsFromSymbolAnnotationAsync(
            ...
            await AddImportsFromSymbolAnnotationAsync(
                    document,
                    await GetSpansAsync(document, cancellationToken).ConfigureAwait(false),
                    options,
                    cancellationToken
        ...
        internal static Task<Document> AddImportsFromSymbolAnnotationAsync(
            Document document,
            IEnumerable<TextSpan> spans,
            AddImportPlacementOptions options,
            CancellationToken cancellationToken
