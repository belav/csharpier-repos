...
namespace Microsoft.CodeAnalysis.CodeGeneration
{
    ...
    internal static class CodeGenerator
    {
        ...
        private static ICodeGenerationService GetCodeGenerationService(
            Workspace workspace,
            string language
        ) =>
            workspace.Services.GetLanguageServices(language)
                .GetRequiredService<ICodeGenerationService>();

        /// <summary>
        /// Returns a newly created event declaration node from the provided event.
        /// </summary>
        public static SyntaxNode CreateEventDeclaration(
            IEventSymbol @event,
            Workspace workspace,
            CodeGenerationDestination destination = CodeGenerationDestination.Unspecified,
            CodeGenerationOptions? options = null
        ) =>
            GetCodeGenerationService(workspace, @event.Language)
                .CreateEventDeclaration(@event, destination, options);

        /// <summary>
        /// Returns a newly created field declaration node from the provided field.
        /// </summary>
        public static SyntaxNode CreateFieldDeclaration(
            IFieldSymbol field,
            Workspace workspace,
            CodeGenerationDestination destination = CodeGenerationDestination.Unspecified,
            CodeGenerationOptions? options = null
        ) =>
            GetCodeGenerationService(workspace, field.Language)
                .CreateFieldDeclaration(field, destination, options);

        /// <summary>
        /// Returns a newly created method declaration node from the provided method.
        /// </summary>
        public static SyntaxNode CreateMethodDeclaration(
            IMethodSymbol method,
            Workspace workspace,
            CodeGenerationDestination destination = CodeGenerationDestination.Unspecified,
            CodeGenerationOptions? options = null
        ) =>
            GetCodeGenerationService(workspace, method.Language)
                .CreateMethodDeclaration(method, destination, options);

        /// <summary>
        /// Returns a newly created property declaration node from the provided property.
        /// </summary>
        public static SyntaxNode CreatePropertyDeclaration(
            IPropertySymbol property,
            Workspace workspace,
            CodeGenerationDestination destination = CodeGenerationDestination.Unspecified,
            CodeGenerationOptions? options = null
        ) =>
            GetCodeGenerationService(workspace, property.Language)
                .CreatePropertyDeclaration(property, destination, options);

        /// <summary>
        /// Returns a newly created named type declaration node from the provided named type.
        /// </summary>
        public static SyntaxNode CreateNamedTypeDeclaration(
            INamedTypeSymbol namedType,
            Workspace workspace,
            CodeGenerationDestination destination = CodeGenerationDestination.Unspecified,
            CodeGenerationOptions? options = null
        ) =>
            GetCodeGenerationService(workspace, namedType.Language)
                .CreateNamedTypeDeclaration(namedType, destination, options);

        /// <summary>
        /// Returns a newly created namespace declaration node from the provided namespace.
        /// </summary>
        public static SyntaxNode CreateNamespaceDeclaration(
            INamespaceSymbol @namespace,
            Workspace workspace,
            CodeGenerationDestination destination = CodeGenerationDestination.Unspecified,
            CodeGenerationOptions? options = null
        ) =>
            GetCodeGenerationService(workspace, @namespace.Language)
                .CreateNamespaceDeclaration(@namespace, destination, options);

        /// <summary>
        /// Create a new declaration node with an event declaration of the same signature as the specified symbol added to it.
        /// </summary>
        public static TDeclarationNode AddEventDeclaration<TDeclarationNode>(
            TDeclarationNode destination,
            IEventSymbol @event,
            Workspace workspace,
            CodeGenerationOptions? options = null
        ) where TDeclarationNode : SyntaxNode =>
            GetCodeGenerationService(workspace, destination.Language)
                .AddEvent(destination, @event, options);

        /// <summary>
        /// Create a new declaration node with a field declaration of the same signature as the specified symbol added to it.
        /// </summary>
        public static TDeclarationNode AddFieldDeclaration<TDeclarationNode>(
            TDeclarationNode destination,
            IFieldSymbol field,
            Workspace workspace,
            CodeGenerationOptions? options = null
        ...
        public static TDeclarationNode AddNamedTypeDeclaration<TDeclarationNode>(
            ...
            GetCodeGenerationService(workspace, destination.Language)
                .AddNamedType(destination, namedType, options);
        ...
        /// </summary>
        public static TDeclarationNode AddMemberDeclarations<TDeclarationNode>(
            TDeclarationNode destination,
            ...
            GetCodeGenerationService(workspace, destination.Language)
                .AddMembers(destination, members, options);
        ...
        /// </summary>
        public static TDeclarationNode AddParameterDeclarations<TDeclarationNode>(
            TDeclarationNode destinationMember,
            IEnumerable<IParameterSymbol> parameters,
            Workspace workspace,
            CodeGenerationOptions? options = null
        ) where TDeclarationNode : SyntaxNode =>
            GetCodeGenerationService(workspace, destinationMember.Language)
                .AddParameters(destinationMember, parameters, options);

        /// <summary>
        /// Create a new declaration node with the specified attributes added to it.
        /// </summary>
        public static TDeclarationNode AddAttributes<TDeclarationNode>(
            TDeclarationNode destination,
            Workspace workspace,
        ...
        /// </summary>
        public static TDeclarationNode RemoveAttribute<TDeclarationNode>(
            TDeclarationNode destination,
            Workspace workspace,
        ...
        public static TDeclarationNode UpdateDeclarationModifiers<TDeclarationNode>(
            TDeclarationNode destination,
            Workspace workspace,
            ...
            GetCodeGenerationService(workspace, destination.Language)
                .UpdateDeclarationModifiers(
                    destination,
                    newModifiers,
                    options ?? new CodeGenerationOptions(reuseSyntax: true),
                    cancellationToken
                );

        public static TDeclarationNode UpdateDeclarationAccessibility<TDeclarationNode>(
            TDeclarationNode destination,
            Workspace workspace,
        ...
        public static TDeclarationNode UpdateDeclarationType<TDeclarationNode>(
            TDeclarationNode destination,
            Workspace workspace,
            ITypeSymbol newType,
            CodeGenerationOptions? options = null,
        ...
        public static TDeclarationNode UpdateDeclarationMembers<TDeclarationNode>(
            TDeclarationNode destination,
            Workspace workspace,
        ...
        /// </summary>
        public static TDeclarationNode AddStatements<TDeclarationNode>(
            TDeclarationNode destinationMember,
            ...
            GetCodeGenerationService(workspace, destinationMember.Language)
                .AddStatements(destinationMember, statements, options);
        ...
        public static Task<Document> AddEventDeclarationAsync(
            ...
            GetCodeGenerationService(solution.Workspace, destination.Language)
        ...
        public static Task<Document> AddFieldDeclarationAsync(
            ...
            GetCodeGenerationService(solution.Workspace, destination.Language)
                .AddFieldAsync(solution, destination, field, options, cancellationToken);
        ...
        public static Task<Document> AddMethodDeclarationAsync(
            ...
            GetCodeGenerationService(solution.Workspace, destination.Language)
                .AddMethodAsync(solution, destination, method, options, cancellationToken);
        ...
        public static Task<Document> AddPropertyDeclarationAsync(
            ...
            GetCodeGenerationService(solution.Workspace, destination.Language)
                .AddPropertyAsync(solution, destination, property, options, cancellationToken);
        ...
        public static Task<Document> AddNamedTypeDeclarationAsync(
            ...
            GetCodeGenerationService(solution.Workspace, destination.Language)
                .AddNamedTypeAsync(solution, destination, namedType, options, cancellationToken);
        ...
        public static Task<Document> AddNamespaceDeclarationAsync(
            ...
            GetCodeGenerationService(solution.Workspace, destination.Language)
                .AddNamespaceAsync(solution, destination, @namespace, options, cancellationToken);
        ...
        public static Task<Document> AddMemberDeclarationsAsync(
            ...
            GetCodeGenerationService(solution.Workspace, destination.Language)
                .AddMembersAsync(solution, destination, members, options, cancellationToken);
        ...
        public static bool CanAdd(
            ...
            GetCodeGenerationService(solution.Workspace, destination.Language)
                .CanAddTo(destination, solution, cancellationToken);
    }
}
