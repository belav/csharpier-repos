...
namespace Microsoft.CodeAnalysis.Diagnostics
{
    ...
    ) : IEquatable<DiagnosticData?>
    {
        ...
        public readonly ImmutableArray<DiagnosticDataLocation> AdditionalLocations =
            additionalLocations.NullToEmpty();
        ...
        public bool Equals(DiagnosticData? other)
        {
            ...
            return DataLocation.UnmappedFileSpan.StartLinePosition
                    == other.DataLocation.UnmappedFileSpan.StartLinePosition
                && Id == other.Id
        ...
        public override int GetHashCode() =>
            Hash.Combine(
                DataLocation.UnmappedFileSpan.StartLinePosition.GetHashCode(),
                Hash.Combine(
                    Id,
                    Hash.Combine(
                        Category,
                        Hash.Combine(
                            ...
                            Hash.Combine(
                                ...
                                Hash.Combine(
                                    ...
                                    Hash.Combine(
                                        ProjectId,
                                        Hash.Combine(DocumentId, Hash.Combine(Message, 0))
                                    )
                                )
                            )
                        )
        ...
        )
        {
            ...
            {
                var diagnosticSpanMappingService = document?.Project
                    .Solution
                    .Services
            ...
            Create(
                ...
                location: new DiagnosticDataLocation(
                    new FileLinePositionSpan(
                        project?.FilePath ?? solution.FilePath ?? "",
                        span: default
                    )
                ),
        ...
        )
        {
            return new DiagnosticData(
                ...
                description: diagnostic.Descriptor
                    .Description
            ...
            foreach (var location in diagnostic.AdditionalLocations)
            {
                if (location.IsInSource)
                {
                    builder.AddIfNotNull(
                        CreateLocation(
                            document.Project.Solution.GetDocument(location.SourceTree),
                            location
                        )
                    );
                }
