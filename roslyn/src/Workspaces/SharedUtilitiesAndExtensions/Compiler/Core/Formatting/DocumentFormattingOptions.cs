...
internal static class DocumentFormattingOptionsProviders
{
    public static DocumentFormattingOptions GetDocumentFormattingOptions(
        ...
        DocumentFormattingOptions? fallbackOptions
    )
    {
        ...
        return new()
        {
            FileHeaderTemplate = options.GetEditorConfigOption(
                CodeStyleOptions2.FileHeaderTemplate,
                fallbackOptions.FileHeaderTemplate
            ),
            InsertFinalNewLine = options.GetEditorConfigOption(
...
#if !CODE_STYLE
    public static async ValueTask<DocumentFormattingOptions> GetDocumentFormattingOptionsAsync(
    ...
    public static async ValueTask<DocumentFormattingOptions> GetDocumentFormattingOptionsAsync(
        this Document document,
        DocumentFormattingOptionsProvider fallbackOptionsProvider,
        CancellationToken cancellationToken
    ) =>
        await document
