...
#pragma warning disable CS0809 // Obsolete member overrides non-obsolete member
        ...
        [Obsolete("Do not call this method directly (it will Stack Overflow).", error: true)]
        [EditorBrowsable(EditorBrowsableState.Never)]
        public sealed override void AddAnchorIndentationOperations(
        ...
        [Obsolete("Do not call this method directly (it will Stack Overflow).", error: true)]
        [EditorBrowsable(EditorBrowsableState.Never)]
        public sealed override void AddIndentBlockOperations(
        ...
        [Obsolete("Do not call this method directly (it will Stack Overflow).", error: true)]
        [EditorBrowsable(EditorBrowsableState.Never)]
        public sealed override void AddAlignTokensOperations(
        ...
        [Obsolete("Do not call this method directly (it will Stack Overflow).", error: true)]
        [EditorBrowsable(EditorBrowsableState.Never)]
        public sealed override AdjustNewLinesOperation? GetAdjustNewLinesOperation(
        ...
        )
        {
            ...
            var nextOperationCopy = nextOperation;
            return GetAdjustNewLinesOperationSlow(
                ref previousTokenCopy,
                ref currentTokenCopy,
        ...
        [Obsolete("Do not call this method directly (it will Stack Overflow).", error: true)]
        [EditorBrowsable(EditorBrowsableState.Never)]
        public sealed override AdjustSpacesOperation? GetAdjustSpacesOperation(
            in SyntaxToken previousToken,
            in SyntaxToken currentToken,
        ...
        )
        {
            ...
            var currentTokenCopy = currentToken;
            var nextOperationCopy = nextOperation;
            return GetAdjustSpacesOperationSlow(
                ref previousTokenCopy,
                ref currentTokenCopy,
                ref nextOperationCopy
            );
...
#pragma warning restore CS0809 // Obsolete member overrides non-obsolete member
        ...
        public virtual void AddAnchorIndentationOperationsSlow(
            List<AnchorIndentationOperation> list,
            SyntaxNode node,
            ref NextAnchorIndentationOperationAction nextOperation
        ...
        public virtual void AddIndentBlockOperationsSlow(
            List<IndentBlockOperation> list,
            SyntaxNode node,
            ref NextIndentBlockOperationAction nextOperation
        ...
        public virtual void AddAlignTokensOperationsSlow(
            List<AlignTokensOperation> list,
            SyntaxNode node,
            ref NextAlignTokensOperationAction nextOperation
        ...
        public virtual AdjustSpacesOperation? GetAdjustSpacesOperationSlow(
            ref SyntaxToken previousToken,
            ref SyntaxToken currentToken,
            ref NextGetAdjustSpacesOperation nextOperation
