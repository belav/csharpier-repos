...
namespace Microsoft.CodeAnalysis.Formatting.Rules
{
    internal static class FormattingOperations
    {
        ...
        /// </summary>
        public static AnchorIndentationOperation CreateAnchorIndentationOperation(
            ...
            CreateAnchorIndentationOperation(
                anchorToken,
                endToken,
                TextSpan.FromBounds(anchorToken.Span.End, endToken.Span.End)
            );
        ...
        /// </summary>
        public static SuppressOperation CreateSuppressOperation(
            SyntaxToken startToken,
            SyntaxToken endToken,
            SuppressOption option
        ) =>
            CreateSuppressOperation(
                startToken,
                endToken,
        ...
        /// </summary>
        private static SuppressOperation CreateSuppressOperation(
            SyntaxToken startToken,
            SyntaxToken endToken,
            TextSpan textSpan,
            SuppressOption option
        ...
        /// </summary>
        public static IndentBlockOperation CreateIndentBlockOperation(
            SyntaxToken startToken,
            SyntaxToken endToken,
        ...
        /// </summary>
        public static IndentBlockOperation CreateRelativeIndentBlockOperation(
        ...
        )
        {
            ...
            return CreateRelativeIndentBlockOperation(
                baseToken,
                startToken,
                endToken,
                span,
        ...
        /// </summary>
        public static AlignTokensOperation CreateAlignTokensOperation(
            SyntaxToken baseToken,
        ...
        /// </summary>
        internal static IEnumerable<SuppressOperation> GetSuppressOperations(
        ...
        /// </summary>
        internal static IEnumerable<IndentBlockOperation> GetIndentBlockOperations(
            IEnumerable<AbstractFormattingRule> formattingRules,
            SyntaxNode node,
            SyntaxFormattingOptions options
        )
        ...
        /// </summary>
        internal static IEnumerable<AlignTokensOperation> GetAlignTokensOperations(
            IEnumerable<AbstractFormattingRule> formattingRules,
            SyntaxNode node,
            SyntaxFormattingOptions options
        )
        ...
        /// </summary>
        internal static AdjustNewLinesOperation? GetAdjustNewLinesOperation(
            IEnumerable<AbstractFormattingRule> formattingRules,
        ...
        /// </summary>
        internal static AdjustSpacesOperation? GetAdjustSpacesOperation(
            IEnumerable<AbstractFormattingRule> formattingRules,
            SyntaxToken previousToken,
            SyntaxToken currentToken,
            SyntaxFormattingOptions options
