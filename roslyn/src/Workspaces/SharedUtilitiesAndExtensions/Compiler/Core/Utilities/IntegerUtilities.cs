...
namespace Microsoft.CodeAnalysis.Shared.Utilities
{
    internal static class IntegerUtilities
    {
        ...
        public static bool HasOneBitSet(IComparable value)
        {
            ...
            {
                case long v:
                    return HasOneBitSet((long)v);
                case ulong v:
                    return HasOneBitSet(unchecked((long)v));
                case int v:
                    return HasOneBitSet((long)v);
                case uint v:
                    return HasOneBitSet((long)v);
        ...
        public static bool HasOneBitSet(long v) => CountOfBitsSet(v) == 1;
        ...
        public static ulong ToUnsigned(long v) => unchecked((ulong)v);
