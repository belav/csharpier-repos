...
namespace Roslyn.Utilities
{
    ...
    internal class AnnotationTable<TAnnotation> where TAnnotation : class
    {
        ...
        public AnnotationTable(string annotationKind) => _annotationKind = annotationKind;
        ...
        public bool HasAnnotations(SyntaxToken token) => token.HasAnnotations(_annotationKind);

        public bool HasAnnotations(SyntaxTrivia trivia) => trivia.HasAnnotations(_annotationKind);
        ...
        public IEnumerable<SyntaxNodeOrToken> GetAnnotatedNodesAndTokens<TSpecificAnnotation>(
            ...
            node.GetAnnotatedNodesAndTokens(_annotationKind)
                .Where(nt => this.HasAnnotations<TSpecificAnnotation>(nt));
        ...
        public IEnumerable<SyntaxTrivia> GetAnnotatedTrivia<TSpecificAnnotation>(SyntaxNode node)
            where TSpecificAnnotation : TAnnotation =>
            node.GetAnnotatedTrivia(_annotationKind)
                .Where(tr => this.HasAnnotations<TSpecificAnnotation>(tr));
    }
}
