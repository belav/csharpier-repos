...
namespace Microsoft.CodeAnalysis.Simplification
{
    internal class SpecialTypeAnnotation
    {
        ...
        private static readonly ConcurrentDictionary<SpecialType, string> s_fromSpecialTypes =
            new();
        ...
        private static string CreateFromSpecialTypes(SpecialType arg) => arg.ToString();
