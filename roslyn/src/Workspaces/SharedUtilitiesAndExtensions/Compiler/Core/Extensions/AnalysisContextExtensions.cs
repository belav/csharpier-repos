...
namespace Microsoft.CodeAnalysis
{
    internal static class AnalysisContextExtensions
    {
        ...
        /// </summary>
        public static bool ShouldAnalyzeSpan(
        ...
        public static bool ShouldAnalyzeSpan(
            ...
            context.FilterTree == null
            || (context.FilterTree == tree && ShouldAnalyze(context.FilterSpan, span));
        ...
        /// </summary>
        public static bool ShouldAnalyzeLocation(
            this SymbolStartAnalysisContext context,
            Location location
        ) =>
            location.SourceTree != null
            && context.ShouldAnalyzeSpan(location.SourceSpan, location.SourceTree);
        ...
        /// </summary>
        public static bool ShouldAnalyzeSpan(
            this AdditionalFileAnalysisContext context,
            TextSpan span
        ) => ShouldAnalyze(context.FilterSpan, span);
        ...
        /// </summary>
        public static bool ShouldAnalyzeSpan(
            this OperationBlockStartAnalysisContext context,
            TextSpan span
        ) => ShouldAnalyze(context.FilterSpan, span);
        ...
        /// </summary>
        public static bool ShouldAnalyzeSpan<TSytnaxKind>(
            this CodeBlockStartAnalysisContext<TSytnaxKind> context,
            TextSpan span
        )
            where TSytnaxKind : struct => ShouldAnalyze(context.FilterSpan, span);
        ...
        /// </summary>
        public static SyntaxNode GetAnalysisRoot(
            this SyntaxTreeAnalysisContext context,
            bool findInTrivia,
        ...
        /// Gets the root node in the analysis span for the given <paramref name="context"/>.
        /// </summary>
        public static SyntaxNode GetAnalysisRoot<TSyntaxKind>(
            this CodeBlockStartAnalysisContext<TSyntaxKind> context,
            bool findInTrivia,
            bool getInnermostNodeForTie = false
        )
