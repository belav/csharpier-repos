    ...
    internal static class LocationExtensions
    {
        ...
        public static SyntaxNode FindNode(
            ...
            location
                .GetSourceTreeOrThrow()
                .GetRoot(cancellationToken)
                .FindNode(location.SourceSpan, getInnermostNodeForTie: getInnermostNodeForTie);
        ...
        public static bool IntersectsWith(this Location loc1, Location loc2)
        {
            ...
            return loc1.SourceTree == loc2.SourceTree
                && loc1.SourceSpan.IntersectsWith(loc2.SourceSpan);
        }
    }
}
