...
namespace Microsoft.CodeAnalysis.Shared.Extensions
{
    ...
    {
        /// <summary>
        /// Update a list in place, where a function has the ability to either transform or remove each
        // item.
        /// </summary>
        /// <typeparam name="T">The type of items in the list.</typeparam>
        /// <typeparam name="TArg">The type of state argument passed to the transformation
        // callback.</typeparam>
        /// <param name="list">The list to update.</param>
        /// <param name="transform">A function which transforms each element. The function returns the
        // transformed list
