...
internal sealed record class AddImportPlacementOptions
{
    ...
    public bool PlaceImportsInsideNamespaces =>
        UsingDirectivePlacement.Value == AddImportPlacement.InsideNamespace;
...
internal static partial class AddImportPlacementOptionsProviders
{
    ...
    public static AddImportPlacementOptions GetAddImportPlacementOptions(
        ...
        languageServices
            .GetRequiredService<IAddImportsService>()
            .GetAddImportOptions(options, allowInHiddenRegions, fallbackOptions);

    public static async ValueTask<AddImportPlacementOptions> GetAddImportPlacementOptionsAsync(
    ...
    public static bool AllowImportsInHiddenRegions(this Document document) =>
        document.Services.GetService<ISpanMappingService>()?.SupportsMappingImportDirectives
        == true;
    ...
    public static async ValueTask<AddImportPlacementOptions> GetAddImportPlacementOptionsAsync(
        ...
        await GetAddImportPlacementOptionsAsync(
                document,
