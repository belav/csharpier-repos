    ...
    internal partial struct SymbolKey
    {
        private sealed class BuiltinOperatorSymbolKey : AbstractSymbolKey<IMethodSymbol>
        {
            ...
            protected sealed override SymbolKeyResolution Resolve(
                ...
                IMethodSymbol? contextualSymbol,
            ...
            )
            {
                ...
                {
                    failureReason =
                        $"({nameof(BuiltinOperatorSymbolKey)} {nameof(returnType)} failed -> {returnTypeFailureReason})";
                    return default;
                }
                ...
                {
                    failureReason =
                        $"({nameof(BuiltinOperatorSymbolKey)} {nameof(parameterTypes)} failed -> {parameterTypesFailureReason})";
                    return default;
                }
                ...
                try
                {
                    switch (parameterTypes.Count)
                    {
                        case 1:
                            failureReason = null;
                            var unaryOperator = reader.Compilation
                        ...
                        default:
                            failureReason =
                                $"({nameof(BuiltinOperatorSymbolKey)} {nameof(parameterTypes)} failed -> count was {parameterTypes.Count})";
                            return default;
                    }
                }
