...
namespace Microsoft.CodeAnalysis.CodeStyle
{
    internal static class CodeStyleOptions2
    {
        ...
        internal static readonly PerLanguageOption2<bool> PreferObjectInitializer_FadeOutCode =
            new(
                "CodeStyleOptions",
        ...
        internal static readonly PerLanguageOption2<bool> PreferCollectionInitializer_FadeOutCode =
            new(
                "CodeStyleOptions",
        ...
        internal static readonly PerLanguageOption2<OperatorPlacementWhenWrappingPreference> OperatorPlacementWhenWrapping =
            CreateOption(
                ...
                storageLocations: new EditorConfigStorageLocation<OperatorPlacementWhenWrappingPreference>(
        ...
        > UnusedParameters = CreateOption(
            ...
            storageLocations: new OptionStorageLocation2[]
            {
                new EditorConfigStorageLocation<CodeStyleOption2<UnusedParametersPreference>>(
                    ...
                    s =>
                        ParseUnusedParametersPreference(
                            s,
                            s_preferAllMethodsUnusedParametersPreference
                        ),
                    o =>
                ...
                new RoamingProfileStorageLocation(
                    $"TextEditor.%LANGUAGE%.Specific.{nameof(UnusedParameters)}Preference"
                )
            }
        );
        ...
        > RequireAccessibilityModifiers = CreateOption(
            CodeStyleOptionGroups.Modifier,
            nameof(RequireAccessibilityModifiers),
        ...
        private static string GetAccessibilityModifiersRequiredEditorConfigString(
            ...
            {
                Debug.Assert(
                    s_accessibilityModifiersRequiredMap.ContainsValue(
