...
namespace Microsoft.CodeAnalysis.CodeStyle
{
    internal static class CodeStyleOptions2
    {
        ...
        private static PerLanguageOption2<CodeStyleOption2<T>> CreatePerLanguageOption<T>(
            ...
            s_allOptionsBuilder.CreatePerLanguageEditorConfigOption(
                name,
                defaultValue,
                group,
                serializerFactory
        ...
        public static readonly PerLanguageOption2<CodeStyleOption2<bool>> QualifyFieldAccess =
            CreateQualifyAccessOption("dotnet_style_qualification_for_field")
        ...
        public static readonly PerLanguageOption2<CodeStyleOption2<bool>> QualifyPropertyAccess =
            CreateQualifyAccessOption("dotnet_style_qualification_for_property")
        ...
        public static readonly PerLanguageOption2<CodeStyleOption2<bool>> QualifyMethodAccess =
            CreateQualifyAccessOption("dotnet_style_qualification_for_method")
        ...
        public static readonly PerLanguageOption2<CodeStyleOption2<bool>> QualifyEventAccess =
            CreateQualifyAccessOption("dotnet_style_qualification_for_event")
        ...
        internal static readonly PerLanguageOption2<
            CodeStyleOption2<bool>
        > PreferObjectInitializer = CreatePerLanguageOption(
        ...
        internal static readonly PerLanguageOption2<
            CodeStyleOption2<bool>
        > PreferCollectionInitializer = CreatePerLanguageOption(
            CodeStyleOptionGroups.ExpressionLevelPreferences,
        ...
        internal static readonly PerLanguageOption2<
            CodeStyleOption2<bool>
        > PreferSimplifiedBooleanExpressions = CreatePerLanguageOption(
            CodeStyleOptionGroups.ExpressionLevelPreferences,
        ...
        internal static readonly PerLanguageOption2<
            CodeStyleOption2<bool>
        > PreferCoalesceExpression = CreatePerLanguageOption(
            CodeStyleOptionGroups.ExpressionLevelPreferences,
        ...
        internal static readonly PerLanguageOption2<
            CodeStyleOption2<bool>
        > PreferExplicitTupleNames = CreatePerLanguageOption(
            CodeStyleOptionGroups.ExpressionLevelPreferences,
        ...
        internal static readonly PerLanguageOption2<
            CodeStyleOption2<bool>
        > PreferInferredTupleNames = CreatePerLanguageOption(
            CodeStyleOptionGroups.ExpressionLevelPreferences,
        ...
        internal static readonly PerLanguageOption2<
            CodeStyleOption2<bool>
        > PreferInferredAnonymousTypeMemberNames = CreatePerLanguageOption(
            CodeStyleOptionGroups.ExpressionLevelPreferences,
        ...
        internal static readonly PerLanguageOption2<
            CodeStyleOption2<bool>
        > PreferIsNullCheckOverReferenceEqualityMethod = CreatePerLanguageOption(
            CodeStyleOptionGroups.ExpressionLevelPreferences,
        ...
        internal static readonly PerLanguageOption2<
            CodeStyleOption2<bool>
        > PreferConditionalExpressionOverAssignment = CreatePerLanguageOption(
            CodeStyleOptionGroups.ExpressionLevelPreferences,
        ...
        internal static readonly PerLanguageOption2<
            CodeStyleOption2<bool>
        > PreferConditionalExpressionOverReturn = CreatePerLanguageOption(
            CodeStyleOptionGroups.ExpressionLevelPreferences,
        ...
        internal static readonly PerLanguageOption2<
            CodeStyleOption2<bool>
        > PreferCompoundAssignment = CreatePerLanguageOption(
            CodeStyleOptionGroups.ExpressionLevelPreferences,
        ...
        internal static readonly PerLanguageOption2<
            CodeStyleOption2<bool>
        > PreferSimplifiedInterpolation = CreatePerLanguageOption(
            CodeStyleOptionGroups.ExpressionLevelPreferences,
        ...
        > UnusedParameters = CreatePerLanguageOption(
        ...
        > AccessibilityModifiersRequired = CreatePerLanguageOption(
            ...
            defaultValue =>
                new(
                    ...
                    {
                        Debug.Assert(
                            s_accessibilityModifiersRequiredMap.ContainsValue(option.Value)
                        );
            ...
            defaultValue =>
                new(
                    parseValue: str =>
                    {
                        ...
                        {
                            Debug.Assert(
                                s_forEachExplicitCastInSourcePreferencePreferenceMap.ContainsKey(
                                    value
                                )
                            );
                            return new CodeStyleOption2<ForEachExplicitCastInSourcePreference>(
                                s_forEachExplicitCastInSourcePreferencePreferenceMap.GetValueOrDefault(
                                    value
                                ),
                                notification
                            );
                    ...
                    {
                        Debug.Assert(
                            s_forEachExplicitCastInSourcePreferencePreferenceMap.ContainsValue(
                                option.Value
                            )
                        );
                        var value =
        ...
        public static readonly PerLanguageOption2<
            CodeStyleOption2<bool>
        > PreferNamespaceAndFolderMatchStructure = CreatePerLanguageOption(
            CodeStyleOptionGroups.ExpressionLevelPreferences,
        ...
        internal static readonly PerLanguageOption2<
            CodeStyleOption2<bool>
        > AllowMultipleBlankLines = CreatePerLanguageOption(
        ...
        internal static readonly PerLanguageOption2<
            CodeStyleOption2<bool>
        > AllowStatementImmediatelyAfterBlock = CreatePerLanguageOption(
            CodeStyleOptionGroups.NewLinePreferences,
    ...
    internal static class CodeStyleOptionGroups
    {
        ...
        public static readonly OptionGroup Usings =
            new(CompilerExtensionsResources.Organize_usings, priority: 1, parent: CodeStyle);
        public static readonly OptionGroup ThisOrMe =
            new(
                CompilerExtensionsResources.this_dot_and_Me_dot_preferences,
                priority: 2,
                parent: CodeStyle
            );
        ...
        public static readonly OptionGroup Parentheses =
            new(
                CompilerExtensionsResources.Parentheses_preferences,
                priority: 4,
                parent: CodeStyle
            );
        public static readonly OptionGroup Modifier =
            new(CompilerExtensionsResources.Modifier_preferences, priority: 5, parent: CodeStyle);
        ...
        public static readonly OptionGroup Field =
            new(CompilerExtensionsResources.Field_preferences, priority: 7, parent: CodeStyle);
        public static readonly OptionGroup Parameter =
            new(CompilerExtensionsResources.Parameter_preferences, priority: 8, parent: CodeStyle);
        public static readonly OptionGroup Suppressions =
            new(
                CompilerExtensionsResources.Suppression_preferences,
                priority: 9,
                parent: CodeStyle
            );
        public static readonly OptionGroup NewLinePreferences =
            new(CompilerExtensionsResources.New_line_preferences, priority: 10, parent: CodeStyle);
    }
}
