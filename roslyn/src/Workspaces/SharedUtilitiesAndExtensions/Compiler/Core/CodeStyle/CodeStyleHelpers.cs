...
namespace Microsoft.CodeAnalysis.CodeStyle
{
    ...
    {
        public static bool TryParseStringEditorConfigCodeStyleOption(
            string arg,
        ...
        public static bool TryGetCodeStyleValue(
            ...
            TryGetCodeStyleValueAndOptionalNotification(
                arg,
                defaultNotification: NotificationOption2.None,
                out value,
                out _
            );
        ...
        )
        {
            ...
            if (secondColonIndex == -1)
            {
                ...
                if (
                    TryParseNotification(arg.AsSpan(firstColonIndex + 1), out var localNotification)
                )
                {
        ...
        private static bool TryParseNotification(
            ...
            out NotificationOption2 notification
        )
        {
            switch (value.Trim())
            {
                ...
                case EditorConfigSeverityStrings.Warning:
                    notification = NotificationOption2.Warning;
                    return true;
                case EditorConfigSeverityStrings.Error:
                    notification = NotificationOption2.Error;
                    return true;
            }
        ...
        {
            var option = new Option2<CodeStyleOption2<T>>(
                name,
                defaultValue,
                group,
                languageName,
        ...
        public static PerLanguageOption2<
            CodeStyleOption2<T>
        > CreatePerLanguageEditorConfigOption<T>(
            this ImmutableArray<IOption2>.Builder optionsBuilder,
            string name,
            CodeStyleOption2<T> defaultValue,
            OptionGroup group,
        ...
        {
            var option = new PerLanguageOption2<CodeStyleOption2<T>>(
                name,
                defaultValue,
                group,
                isEditorConfigOption: true,
        ...
        > GetUnusedValuePreferenceSerializer(
            ...
            new(
                ...
                serializeValue: value =>
                    GetUnusedExpressionAssignmentPreferenceEditorConfigString(value, defaultValue)
            );
        ...
        )
        {
            if (
                TryGetCodeStyleValueAndOptionalNotification(
                    optionString,
                    defaultCodeStyleOption.Notification,
                    out var value,
                    out var notification
                )
            )
        ...
        )
        {
            ...
            var value =
                ...
                ?? s_unusedExpressionAssignmentPreferenceMap.GetKeyOrDefault(defaultValue.Value);
