...
[DataContract]
internal sealed record class VisualBasicIdeCodeStyleOptions
    : IdeCodeStyleOptions,
        IEquatable<VisualBasicIdeCodeStyleOptions>
{
    ...
    [DataMember]
    public CodeStyleOption2<bool> PreferIsNotExpression { get; init; } =
        CodeStyleOption2.TrueWithSuggestionEnforcement;

    [DataMember]
    public CodeStyleOption2<bool> PreferSimplifiedObjectCreation { get; init; } =
        CodeStyleOption2.TrueWithSuggestionEnforcement;
    ...
    internal VisualBasicIdeCodeStyleOptions(
        IOptionsReader options,
        VisualBasicIdeCodeStyleOptions? fallbackOptions
    )
        : base(options, fallbackOptions ??= Default, LanguageNames.VisualBasic)
    {
        ...
        PreferIsNotExpression = options.GetOption(
            VisualBasicCodeStyleOptions.PreferIsNotExpression,
            fallbackOptions.PreferIsNotExpression
        );
        PreferSimplifiedObjectCreation = options.GetOption(
            VisualBasicCodeStyleOptions.PreferSimplifiedObjectCreation,
            fallbackOptions.PreferSimplifiedObjectCreation
        );
