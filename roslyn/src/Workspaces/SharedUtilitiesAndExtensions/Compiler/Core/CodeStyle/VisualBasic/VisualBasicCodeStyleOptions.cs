...
internal sealed class VisualBasicCodeStyleOptions
{
    ...
    private static Option2<CodeStyleOption2<T>> CreateOption<T>(
        ...
        Func<
            CodeStyleOption2<T>,
            EditorConfigValueSerializer<CodeStyleOption2<T>>
        >? serializerFactory = null
    )
    {
        return s_allOptionsBuilder.CreateEditorConfigOption(
            name,
            defaultValue,
            group,
    ...
    public static readonly Option2<CodeStyleOption2<bool>> PreferSimplifiedObjectCreation =
        CreateOption(
            CodeStyleOptionGroups.ExpressionLevelPreferences,
    ...
    public static readonly Option2<CodeStyleOption2<UnusedValuePreference>> UnusedValueAssignment =
        CreateOption(
            CodeStyleOptionGroups.ExpressionLevelPreferences,
