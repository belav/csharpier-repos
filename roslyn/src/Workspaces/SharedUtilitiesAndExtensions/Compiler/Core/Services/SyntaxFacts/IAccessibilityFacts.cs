...
namespace Microsoft.CodeAnalysis.LanguageService
{
    internal interface IAccessibilityFacts
    {
        ...
        /// <param name="ignoreDeclarationModifiers">A flag that indicates whether to consider modifiers on
        // the given declaration that blocks adding accessibility.</param>
