...
namespace Microsoft.CodeAnalysis.Diagnostics.Analyzers.NamingStyles
{
    internal static partial class EditorConfigNamingStyleParser
    {
        ...
        )
        {
            ...
            var applicableKinds = GetSymbolsApplicableKinds(
                symbolSpecName.name,
                conventionsDictionary,
                tupleSelector,
                defaultValue
            ...
            symbolSpec = constructor(
                symbolSpecName,
                applicableKinds,
                applicableAccessibilities,
                requiredModifiers
            );
        ...
        private static (ImmutableArray<SymbolKindOrTypeKind> kinds, TData data) GetSymbolsApplicableKinds<
            T,
            TData
        >(
        ...
        )
        {
            ...
            foreach (
                var symbolSpecApplicableKind in symbolSpecApplicableKinds
                    .Split(',')
                    .Select(x => x.Trim())
            )
            {
        ...
        private static (ImmutableArray<Accessibility> accessibilities, TData data) GetSymbolsApplicableAccessibilities<
            T,
            TData
        >(
            string symbolSpecName,
        ...
        )
        {
            ...
            )
            {
                ...
                return (
                    ParseAccessibilityKindList(symbolSpecApplicableAccessibilities ?? string.Empty),
                    data
                );
            }
        ...
        )
        {
            ...
            foreach (
                var symbolSpecApplicableAccessibility in symbolSpecApplicableAccessibilities
                    .Split(',')
                    .Select(x => x.Trim())
            )
            {
        ...
        private static (ImmutableArray<ModifierKind> modifiers, TData data) GetSymbolsRequiredModifiers<
            T,
            TData
        >(
            string symbolSpecName,
        ...
        )
        {
            ...
            foreach (
                var symbolSpecRequiredModifier in symbolSpecRequiredModifiers
                    .Split(',')
                    .Select(x => x.Trim())
            )
            {
        ...
        )
        {
            ...
            if (
                s_allAccessibility.All(accessibilities.Contains)
                && accessibilities.All(s_allAccessibility.Contains)
            )
            {
                return "*";
            }
