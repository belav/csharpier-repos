...
internal static class CodeCleanupOptionsProviders
{
    ...
    {
        var formattingOptions = options.GetSyntaxFormattingOptions(
        ...
        var addImportOptions = options.GetAddImportPlacementOptions(
            allowImportsInHiddenRegions,
            fallbackOptions?.AddImportOptions,
            languageServices
        );
        var documentFormattingOptions = options.GetDocumentFormattingOptions(
