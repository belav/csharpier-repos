...
namespace Microsoft.CodeAnalysis.Options
{
    internal static class EditorConfigStorageLocation
    {
        ...
        public static EditorConfigStorageLocation<string> ForStringOption(
            string keyName,
        ...
        public static EditorConfigStorageLocation<CodeStyleOption2<bool>> ForBoolCodeStyleOption(
            ...
            new(
                keyName,
                str => ParseBoolCodeStyleOption(str, defaultValue),
                value => GetBoolCodeStyleOptionEditorConfigStringForValue(value, defaultValue)
            );

        public static EditorConfigStorageLocation<
            CodeStyleOption2<string>
        > ForStringCodeStyleOption(string keyName, CodeStyleOption2<string> defaultValue) =>
            new(
                keyName,
                str => ParseStringCodeStyleOption(str, defaultValue),
                value => GetStringCodeStyleOptionEditorConfigStringForValue(value, defaultValue)
            );
        ...
        private static Optional<CodeStyleOption2<string>> ParseStringCodeStyleOption(
            string str,
