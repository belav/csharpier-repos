...
internal static partial class Extensions
{
    ...
    public static T GetOption<T>(this IOptionsReader options, Option2<T> option) =>
        options.TryGetOption<T>(new OptionKey2(option), out var value)
            ? value!
            : option.DefaultValue;
    ...
    public static T GetOption<T>(
        ...
        options.TryGetOption<T>(new OptionKey2(option, language), out var value)
            ? value!
            : option.DefaultValue;
    ...
    public static T GetOptionValue<T>(
        ...
        options.TryGetOption<CodeStyleOption2<T>>(new OptionKey2(option), out var style)
            ? style!.Value
            : defaultValue;
    ...
    public static T GetOptionValue<T>(
        ...
        options.TryGetOption<CodeStyleOption2<T>>(new OptionKey2(option, language), out var style)
            ? style!.Value
            : defaultValue;
}
