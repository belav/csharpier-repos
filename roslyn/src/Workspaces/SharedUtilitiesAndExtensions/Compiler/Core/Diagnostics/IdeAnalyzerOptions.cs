...
{
    public static readonly CodeStyleOption2<bool> DefaultPreferSystemHashCode =
    ...
    [DataMember(Order = 0)]
    public bool CrashOnAnalyzerException { get; init; } = false;

    [DataMember(Order = 1)]
    public bool FadeOutUnusedImports { get; init; } = true;

    [DataMember(Order = 2)]
    public bool FadeOutUnreachableCode { get; init; } = true;

    [DataMember(Order = 3)]
    public bool FadeOutComplexObjectInitialization { get; init; } = false;

    [DataMember(Order = 4)]
    public bool FadeOutComplexCollectionInitialization { get; init; } = false;

    [DataMember(Order = 5)]
    public bool ReportInvalidPlaceholdersInStringDotFormatCalls { get; init; } = true;

    [DataMember(Order = 6)]
    public bool ReportInvalidRegexPatterns { get; init; } = true;

    [DataMember(Order = 7)]
    public bool ReportInvalidJsonPatterns { get; init; } = true;

    [DataMember(Order = 8)]
    public bool DetectAndOfferEditorFeaturesForProbableJsonStrings { get; init; } = true;

    [DataMember(Order = 9)]
    public CodeStyleOption2<bool> PreferSystemHashCode { get; init; } = DefaultPreferSystemHashCode;
    ...
    /// </summary>
    [DataMember(Order = 10)]
    public CleanCodeGenerationOptions? CleanCodeGenerationOptions { get; init; } = null;
    ...
    /// </summary>
    [DataMember(Order = 11)]
    public IdeCodeStyleOptions? CodeStyleOptions { get; init; } = null;
