...
internal readonly struct AnalyzerOptionsProvider
{
    ...
    private SimplifierOptions.CommonOptions FallbackSimplifierOptions =>
        _fallbackOptions.CleanupOptions?.SimplifierOptions.Common
        ?? SimplifierOptions.CommonOptions.Default;

    internal AnalyzerConfigOptions GetAnalyzerConfigOptions() => _options;
...
internal static partial class AnalyzerOptionsProviders
{
    ...
    public static AnalyzerOptionsProvider GetAnalyzerOptions(
        ...
        new(
            context.Options.AnalyzerConfigOptionsProvider.GetOptions(context.Tree),
            context.Options
        );
    ...
    public static AnalyzerOptionsProvider GetAnalyzerOptions(
        ...
        new(
            context.Options.AnalyzerConfigOptionsProvider.GetOptions(context.CodeBlock.SyntaxTree),
            context.Options
        );
