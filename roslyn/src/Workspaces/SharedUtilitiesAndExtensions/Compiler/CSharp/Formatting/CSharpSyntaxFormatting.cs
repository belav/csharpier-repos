...
namespace Microsoft.CodeAnalysis.CSharp.Formatting
{
    internal class CSharpSyntaxFormatting : AbstractSyntaxFormatting
    {
        ...
        protected override AbstractFormattingResult Format(
            ...
            new CSharpFormatEngine(node, options, formattingRules, startToken, endToken).Format(
                cancellationToken
            );
    }
}
