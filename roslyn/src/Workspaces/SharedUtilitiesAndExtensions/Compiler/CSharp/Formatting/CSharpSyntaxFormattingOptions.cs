            ...
            Spacing =
                ...
                | (
                    options.GetOption(
                        ...
                        fallbackOptions.Spacing.HasFlag(SpacePlacement.AfterMethodDeclarationName)
                    )
                ...
                | (
                    options.GetOption(
                        ...
                        fallbackOptions.Spacing.HasFlag(SpacePlacement.WithinMethodCallParentheses)
                    )
                ...
                | options
                    .GetOption(
                        ...
                        fallbackOptions.Spacing.ToSpacingWithinParentheses()
                    )
                    .ToSpacePlacement()
                | (
                    options.GetOption(
                ...
                | (
                    options.GetOption(
                        ...
                        fallbackOptions.Spacing.HasFlag(SpacePlacement.BetweenEmptySquareBrackets)
                    )
            ...
            NewLines =
                ...
                | options
                    .GetOption(
                        ...
                        fallbackOptions.NewLines.ToNewLineBeforeOpenBracePlacement()
                    )
                    .ToNewLinePlacement()
                | (
                    options.GetOption(
            ...
            Indentation =
                ...
                | (
                    options.GetOption(
                        ...
                        fallbackOptions.Indentation.HasFlag(IndentationPlacement.SwitchCaseContents)
                    )
                        ? IndentationPlacement.SwitchCaseContents
                        : 0
                )
