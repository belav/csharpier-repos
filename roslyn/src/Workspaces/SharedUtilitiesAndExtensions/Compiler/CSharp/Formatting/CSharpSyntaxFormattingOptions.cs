...
namespace Microsoft.CodeAnalysis.CSharp.Formatting
{
    ...
    [DataContract]
    internal sealed class CSharpSyntaxFormattingOptions
            ...
            IEquatable<CSharpSyntaxFormattingOptions>
    {
        ...
        [DataMember]
        public BinaryOperatorSpacingOptions SpacingAroundBinaryOperator { get; init; } =
        ...
        [DataMember]
        public CodeStyleOption2<NamespaceDeclarationPreference> NamespaceDeclarations { get; init; } =
            s_defaultNamespaceDeclarations;

        [DataMember]
        public CodeStyleOption2<bool> PreferTopLevelStatements { get; init; } =
        ...
        public override bool Equals(object? obj) => Equals(obj as CSharpSyntaxFormattingOptions);
    ...
    internal static class CSharpSyntaxFormattingOptionsProviders
    {
        ...
        )
        {
            ...
            return new()
            {
                ...
                Spacing =
                    ...
                    | (
                        options.GetEditorConfigOption(
                            ...
                            fallbackOptions.Spacing.HasFlag(SpacePlacement.AfterMethodCallName)
                        )
                    ...
                    | (
                        options.GetEditorConfigOption(
                            ...
                            fallbackOptions.Spacing.HasFlag(SpacePlacement.WithinCastParentheses)
                        )
                    ...
                    | (
                        options.GetEditorConfigOption(
                            ...
                            fallbackOptions.Spacing.HasFlag(SpacePlacement.WithinOtherParentheses)
                        )
                    ...
                    | (
                        options.GetEditorConfigOption(
                            ...
                            fallbackOptions.Spacing.HasFlag(SpacePlacement.AfterCast)
                        )
                    ...
                    | (
                        options.GetEditorConfigOption(
                            ...
                            fallbackOptions.Spacing.HasFlag(SpacePlacement.BeforeOpenSquareBracket)
                        )
                    ...
                    | (
                        options.GetEditorConfigOption(
                            ...
                            fallbackOptions.Spacing.HasFlag(SpacePlacement.WithinSquareBrackets)
                        )
                    ...
                    | (
                        options.GetEditorConfigOption(
                            ...
                            fallbackOptions.Spacing.HasFlag(SpacePlacement.AfterComma)
                        )
                            ? SpacePlacement.AfterComma
                            : 0
                    )
                    | (
                        options.GetEditorConfigOption(
                            ...
                            fallbackOptions.Spacing.HasFlag(SpacePlacement.BeforeComma)
                        )
                    ...
                    | (
                        options.GetEditorConfigOption(
                            ...
                            fallbackOptions.Spacing.HasFlag(SpacePlacement.AfterDot)
                        )
                    ...
                    | (
                        options.GetEditorConfigOption(
                            ...
                            fallbackOptions.Spacing.HasFlag(SpacePlacement.BeforeDot)
                        )
                            ? SpacePlacement.BeforeDot
                            : 0
                    ),
                SpacingAroundBinaryOperator = options.GetEditorConfigOption(
                    CSharpFormattingOptions2.SpacingAroundBinaryOperator,
                    fallbackOptions.SpacingAroundBinaryOperator
                ),
                NewLines =
                    (
                        options.GetEditorConfigOption(
                    ...
                    | (
                        options.GetEditorConfigOption(
                            ...
                            fallbackOptions.NewLines.HasFlag(NewLinePlacement.BeforeElse)
                        )
                            ? NewLinePlacement.BeforeElse
                            : 0
                    )
                    | (
                        options.GetEditorConfigOption(
                            ...
                            fallbackOptions.NewLines.HasFlag(NewLinePlacement.BeforeCatch)
                        )
                            ? NewLinePlacement.BeforeCatch
                            : 0
                    )
                    | (
                        options.GetEditorConfigOption(
                            ...
                            fallbackOptions.NewLines.HasFlag(NewLinePlacement.BeforeFinally)
                        )
                            ? NewLinePlacement.BeforeFinally
                            : 0
                    )
                ...
                LabelPositioning = options.GetEditorConfigOption(
                    CSharpFormattingOptions2.LabelPositioning,
                    fallbackOptions.LabelPositioning
                ),
                Indentation =
                    (
                        options.GetEditorConfigOption(
                            CSharpFormattingOptions2.IndentBraces,
                            fallbackOptions.Indentation.HasFlag(IndentationPlacement.Braces)
                        )
                    ...
                    | (
                        options.GetEditorConfigOption(
                            ...
                            fallbackOptions.Indentation.HasFlag(IndentationPlacement.BlockContents)
                        )
                            ? IndentationPlacement.BlockContents
                            : 0
                    )
                    ...
                    | (
                        options.GetEditorConfigOption(
                            ...
                            fallbackOptions.Indentation.HasFlag(IndentationPlacement.SwitchSection)
                        )
                            ? IndentationPlacement.SwitchSection
                            : 0
                    ),
                WrappingKeepStatementsOnSingleLine = options.GetEditorConfigOption(
                    CSharpFormattingOptions2.WrappingKeepStatementsOnSingleLine,
                    fallbackOptions.WrappingKeepStatementsOnSingleLine
                ),
                WrappingPreserveSingleLine = options.GetEditorConfigOption(
                    CSharpFormattingOptions2.WrappingPreserveSingleLine,
                    fallbackOptions.WrappingPreserveSingleLine
                ),
                NamespaceDeclarations = options.GetEditorConfigOption(
                    CSharpCodeStyleOptions.NamespaceDeclarations,
                    fallbackOptions.NamespaceDeclarations
                ),
                PreferTopLevelStatements = options.GetEditorConfigOption(
