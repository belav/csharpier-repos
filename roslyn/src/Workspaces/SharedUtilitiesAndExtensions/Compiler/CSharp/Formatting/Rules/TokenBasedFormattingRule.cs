...
namespace Microsoft.CodeAnalysis.CSharp.Formatting
{
    internal sealed class TokenBasedFormattingRule : BaseFormattingRule
    {
        ...
        public TokenBasedFormattingRule() : this(new CachedOptions(null)) { }
        ...
        )
        {
            ...
            if (previousToken.Kind() == SyntaxKind.NewKeyword)
            {
                ...
                var spaces = previousToken.Parent?.Kind()
                    is SyntaxKind.ConstructorConstraint
        ...
        private readonly struct CachedOptions : IEquatable<CachedOptions>
        {
            ...
            {
                SeparateImportDirectiveGroups = GetOptionOrDefault(
                    options,
