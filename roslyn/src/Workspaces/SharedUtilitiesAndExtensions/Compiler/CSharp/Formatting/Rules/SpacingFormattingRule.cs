    ...
    internal sealed class SpacingFormattingRule : BaseFormattingRule
    {
        ...
        )
        {
            ...
            )
            {
                ...
                if (
                    currentToken.IsOpenParenInParameterListOfParenthesizedLambdaExpression()
                    && previousParentKind == SyntaxKind.TypeArgumentList
                )
                {
                    return CreateAdjustSpacesOperation(
                        1,
                ...
                if (previousParentKind == SyntaxKind.TypeParameterList)
                {
                    return AdjustSpacesOperationZeroOrOne(
                        _options.SpacingAfterMethodDeclarationName
                    );
                }
            }
        ...
        private static bool IsFunctionLikeKeywordExpressionKind(SyntaxKind syntaxKind) =>
            (
                syntaxKind
                is SyntaxKind.TypeOfExpression
        ...
        private static bool IsControlFlowLikeKeywordStatementKind(SyntaxKind syntaxKind)
        {
            return (
                ...
                is SyntaxKind.IfStatement
                    ...
                    or SyntaxKind.CatchDeclaration
