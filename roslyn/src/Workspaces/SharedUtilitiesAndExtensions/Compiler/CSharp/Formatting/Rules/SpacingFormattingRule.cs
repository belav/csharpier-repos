...
namespace Microsoft.CodeAnalysis.CSharp.Formatting
{
    internal sealed class SpacingFormattingRule : BaseFormattingRule
    {
        ...
        public override AbstractFormattingRule WithOptions(SyntaxFormattingOptions options)
        {
            ...
            if (
                _options.Spacing == newOptions.Spacing
        ...
        )
        {
            ...
            )
            {
                ...
                return AdjustSpacesOperationZeroOrOne(
                    _options.Spacing.HasFlag(SpacePlacement.AfterMethodDeclarationName)
                );
            }
            ...
            {
                return AdjustSpacesOperationZeroOrOne(
                    _options.Spacing.HasFlag(SpacePlacement.WithinMethodDeclarationParenthesis)
                );
            }
            ...
            {
                return AdjustSpacesOperationZeroOrOne(
                    _options.Spacing.HasFlag(SpacePlacement.AfterMethodCallName)
                );
            }
            ...
            {
                return AdjustSpacesOperationZeroOrOne(
                    _options.Spacing.HasFlag(SpacePlacement.BetweenEmptyMethodCallParentheses)
                );
            }
            ...
            {
                return AdjustSpacesOperationZeroOrOne(
                    _options.Spacing.HasFlag(SpacePlacement.WithinMethodCallParentheses)
                );
            }
            ...
            {
                return AdjustSpacesOperationZeroOrOne(
                    _options.Spacing.HasFlag(SpacePlacement.AfterControlFlowStatementKeyword)
                );
            }
                ...
                (
                    previousToken.Parent.Kind()
                        is SyntaxKind.ParenthesizedExpression
                            or SyntaxKind.ParenthesizedPattern
                    && previousKind == SyntaxKind.OpenParenToken
                )
                || (
            ...
            {
                return AdjustSpacesOperationZeroOrOne(
                    _options.Spacing.HasFlag(SpacePlacement.WithinExpressionParentheses)
                );
            }
            ...
            {
                return AdjustSpacesOperationZeroOrOne(
                    _options.Spacing.HasFlag(SpacePlacement.WithinCastParentheses)
                );
            }
            ...
            )
            {
                ...
                return AdjustSpacesOperationZeroOrOne(
                    _options.Spacing.HasFlag(SpacePlacement.AfterSemicolonsInForStatement)
                );
            }
            ...
            {
                return AdjustSpacesOperationZeroOrOne(
                    _options.Spacing.HasFlag(SpacePlacement.WithinOtherParentheses)
                );
            }
            ...
            {
                return AdjustSpacesOperationZeroOrOne(
                    _options.Spacing.HasFlag(SpacePlacement.AfterCast)
                );
            }
            ...
            )
            {
                ...
                {
                    return AdjustSpacesOperationZeroOrOne(
                        _options.Spacing.HasFlag(SpacePlacement.AfterComma)
                    );
                }
            ...
            {
                return AdjustSpacesOperationZeroOrOne(
                    _options.Spacing.HasFlag(SpacePlacement.BeforeOpenSquareBracket)
                );
            }
            ...
            {
                return AdjustSpacesOperationZeroOrOne(
                    _options.Spacing.HasFlag(SpacePlacement.BetweenEmptySquareBrackets)
                );
            }
            ...
            {
                return AdjustSpacesOperationZeroOrOne(
                    _options.Spacing.HasFlag(SpacePlacement.WithinSquareBrackets)
                );
            }
            ...
            {
                return AdjustSpacesOperationZeroOrOne(
                    _options.Spacing.HasFlag(SpacePlacement.AfterColonInBaseTypeDeclaration)
                );
            }
            ...
            {
                return AdjustSpacesOperationZeroOrOne(
                    _options.Spacing.HasFlag(SpacePlacement.BeforeColonInBaseTypeDeclaration)
                );
            }
            ...
            {
                return AdjustSpacesOperationZeroOrOne(
                    _options.Spacing.HasFlag(SpacePlacement.BeforeComma)
                );
            }
            ...
            {
                return AdjustSpacesOperationZeroOrOne(
                    _options.Spacing.HasFlag(SpacePlacement.AfterDot)
                );
            }
            ...
            {
                return AdjustSpacesOperationZeroOrOne(
                    _options.Spacing.HasFlag(SpacePlacement.BeforeDot)
                );
            }
            ...
            if (
                currentKind
                is SyntaxKind.InterpolatedStringEndToken
