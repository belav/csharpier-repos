        ...
        IEquatable<CSharpIdeCodeStyleOptions>
{
    ...
    [DataMember]
    public CodeStyleOption2<bool> PreferNotPattern { get; init; } = s_trueWithSuggestionEnforcement;
    ...
    [DataMember]
    public CodeStyleOption2<bool> PreferTupleSwap { get; init; } = s_trueWithSuggestionEnforcement;
    ...
    public override bool Equals(object? obj) => Equals(obj as CSharpIdeCodeStyleOptions);

    public bool Equals([AllowNull] CSharpIdeCodeStyleOptions other) =>
        other is not null
        && Common.Equals(other.Common)
        && ImplicitObjectCreationWhenTypeIsApparent.Equals(
            other.ImplicitObjectCreationWhenTypeIsApparent
        )
        && PreferNullCheckOverTypeCheck.Equals(other.PreferNullCheckOverTypeCheck)
        && AllowBlankLinesBetweenConsecutiveBraces.Equals(
            other.AllowBlankLinesBetweenConsecutiveBraces
        )
        && AllowBlankLineAfterColonInConstructorInitializer.Equals(
            other.AllowBlankLineAfterColonInConstructorInitializer
        )
        && AllowBlankLineAfterTokenInConditionalExpression.Equals(
            other.AllowBlankLineAfterTokenInConditionalExpression
        )
        ...
        && PreferPatternMatchingOverAsWithNullCheck.Equals(
            other.PreferPatternMatchingOverAsWithNullCheck
        )
        && PreferPatternMatchingOverIsWithCastCheck.Equals(
            other.PreferPatternMatchingOverIsWithCastCheck
        )
        ...
        && PreferDeconstructedVariableDeclaration.Equals(
            other.PreferDeconstructedVariableDeclaration
        )
