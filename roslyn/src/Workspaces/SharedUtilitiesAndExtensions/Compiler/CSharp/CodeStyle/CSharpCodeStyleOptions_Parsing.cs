    ...
    internal static partial class CSharpCodeStyleOptions
    {
        ...
        )
        {
            ...
            )
            {
                ...
                {
                    return new CodeStyleOption2<ExpressionBodyPreference>(
        ...
        )
        {
            ...
            )
            {
                return value switch
                {
                    "inside_namespace" => new CodeStyleOption2<AddImportPlacement>(
                        AddImportPlacement.InsideNamespace,
                        notification
                    ),
                    "outside_namespace" => new CodeStyleOption2<AddImportPlacement>(
        ...
        public static CodeStyleOption2<NamespaceDeclarationPreference> ParseNamespaceDeclaration(
            string optionString,
            CodeStyleOption2<NamespaceDeclarationPreference> @default
        )
        {
            if (
                CodeStyleHelpers.TryGetCodeStyleValueAndOptionalNotification(
        ...
        public static string GetNamespaceDeclarationEditorConfigString(
            CodeStyleOption2<NamespaceDeclarationPreference> value,
        ...
        )
        {
            ...
            )
            {
                ...
                {
                    return new CodeStyleOption2<PreferBracesPreference>(
