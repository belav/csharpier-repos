...
namespace Microsoft.CodeAnalysis.CSharp.CodeStyle
{
    internal static partial class CSharpCodeStyleOptions
    {
        ...
        private static Option2<CodeStyleOption2<T>> CreateOption<T>(
            ...
            s_allOptionsBuilder.CreateEditorConfigOption(
                name,
                defaultValue,
                group,
                ...
                defaultValue =>
                    new(
                        ...
                        serializeValue: value =>
                            GetExpressionBodyPreferenceEditorConfigString(value, defaultValue)
                    )
            );
            ...
            CreateOption(
                ...
                defaultValue =>
                    new(
                        ...
                        serializeValue: value =>
                            GetPreferBracesPreferenceEditorConfigString(value, defaultValue)
                    )
            );
        ...
        public static readonly Option2<CodeStyleOption2<bool>> PreferReadOnlyStructMember =
            CreateOption(
                CodeStyleOptionGroups.Modifier,
        ...
        > PreferredUsingDirectivePlacement = CreateOption(
            ...
            defaultValue =>
                new(
                    ...
                    serializeValue: value =>
                        GetUsingDirectivesPlacementEditorConfigString(value, defaultValue)
                )
        );
        ...
        public static Option2<
            CodeStyleOption2<bool>
        > AllowBlankLineAfterTokenInConditionalExpression { get; } =
            CreateOption(
                CodeStyleOptionGroups.NewLinePreferences,
        ...
        public static Option2<
            CodeStyleOption2<bool>
        > AllowBlankLineAfterTokenInArrowExpressionClause { get; } =
            CreateOption(
                CodeStyleOptionGroups.NewLinePreferences,
            ...
            CreateOption(
                ...
                defaultValue =>
                    new(
                        ...
                        serializeValue: value =>
                            GetNamespaceDeclarationEditorConfigString(value, defaultValue)
                    )
            );
        ...
        public static readonly Option2<CodeStyleOption2<bool>> PreferPrimaryConstructors =
            CreateOption(
                CSharpCodeStyleOptionGroups.CodeBlockPreferences,
        ...
        internal static readonly ImmutableArray<IOption2> AllOptions =
            s_allOptionsBuilder.ToImmutable();
    }

    internal static class CSharpCodeStyleOptionGroups
    {
        public static readonly OptionGroup VarPreferences = new(
            "csharp_var_keyword_usage",
            CSharpCompilerExtensionsResources.var_preferences,
            priority: 1,
            parent: CodeStyleOptionGroups.CodeStyle
        );
        public static readonly OptionGroup ExpressionBodiedMembers = new(
            "csharp_expression_bodied_members",
            CSharpCompilerExtensionsResources.Expression_bodied_members,
            priority: 2,
            parent: CodeStyleOptionGroups.CodeStyle
        );
        public static readonly OptionGroup PatternMatching = new(
            "csharp_pattern_matching",
            CSharpCompilerExtensionsResources.Pattern_matching_preferences,
            priority: 3,
            parent: CodeStyleOptionGroups.CodeStyle
        );
        public static readonly OptionGroup NullCheckingPreferences = new(
            "csharp_null_checks",
            CSharpCompilerExtensionsResources.Null_checking_preferences,
            priority: 4,
            parent: CodeStyleOptionGroups.CodeStyle
        );
        public static readonly OptionGroup CodeBlockPreferences = new(
            "csharp_code_blocks",
            CSharpCompilerExtensionsResources.Code_block_preferences,
            priority: 6,
            parent: CodeStyleOptionGroups.CodeStyle
        );
        public static readonly OptionGroup UsingDirectivePreferences = new(
            "csharp_using_directives",
            CSharpCompilerExtensionsResources.using_directive_preferences,
            priority: 8,
            parent: CodeStyleOptionGroups.CodeStyle
        );
    }
