    ...
    internal class CSharpSyntaxFacts : ISyntaxFacts
    {
            ...
            )
            {
                ...
                else if (identifier.Parent.IsParentKind(SyntaxKind.ObjectInitializerExpression))
                {
                    ...
                    if (objectInitializer.Parent is BaseObjectCreationExpressionSyntax)
                    {
                        ...
                        objectInitializer.IsParentKind(
        ...
        public bool IsInferredAnonymousObjectMemberDeclarator(
            ...
            node.IsKind(
                ...
                out AnonymousObjectMemberDeclaratorSyntax? anonObject
            )
        ...
        public bool IsSimpleAssignmentStatement([NotNullWhen(true)] SyntaxNode? statement) =>
            statement.IsKind(
                ...
                out ExpressionStatementSyntax? exprStatement
        ...
        public bool IsIsNotTypeExpression([NotNullWhen(true)] SyntaxNode? node) => false;
