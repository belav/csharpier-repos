...
namespace Microsoft.CodeAnalysis.CSharp.Shared.Lightup
{
    internal static class NullableSyntaxAnnotationEx
    {
        ...
        static NullableSyntaxAnnotationEx()
        {
            ...
            {
                Oblivious = (SyntaxAnnotation?)nullableSyntaxAnnotation.GetField(
                    nameof(Oblivious),
                    BindingFlags.Static | BindingFlags.Public
                )?.GetValue(null);
                AnnotatedOrNotAnnotated = (SyntaxAnnotation?)nullableSyntaxAnnotation.GetField(
                    nameof(AnnotatedOrNotAnnotated),
                    BindingFlags.Static | BindingFlags.Public
                )?.GetValue(null);
            }
            ...
            Contract.ThrowIfFalse(
                ReferenceEquals(
                    ...
                    NullableSyntaxAnnotation.AnnotatedOrNotAnnotated
                )
            );
#endif
        }
