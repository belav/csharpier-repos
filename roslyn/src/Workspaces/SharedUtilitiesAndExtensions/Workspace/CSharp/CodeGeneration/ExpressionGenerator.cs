    ...
    internal static class ExpressionGenerator
    {
                        ...
                        : SyntaxFactory.ImplicitArrayCreationExpression(
                            SyntaxFactory.InitializerExpression(
                                ...
                                SyntaxFactory.SeparatedList(
                                    typedConstant.Values.Select(v =>
                                        GenerateExpression(generator, v)
                                    )
                                )
                            )
                        );
            ...
            if (type != null && value != null)
            {
                if (type is INamedTypeSymbol { TypeKind: TypeKind.Enum } enumType)
                    return (ExpressionSyntax)
                        CSharpFlagsEnumGenerator.Instance.CreateEnumConstantValue(
                            generator,
                            enumType,
                            value
                        );
                ...
                if (type.IsNullable(out var underlyingType))
                {
                    ...
                    // (e.g. int? x = 5) or it can be T? (e.g. SomeStruct? x = null). The below statement handles the
                    // case
        ...
        internal static ExpressionSyntax GenerateNonEnumValueExpression(
            ...
            value switch
            {
                ...
                sbyte val => GenerateLiteralExpression(
                    type,
                    val,
                ...
                short val => GenerateLiteralExpression(
                    type,
                    val,
                ...
                int val => GenerateLiteralExpression(
                    type,
                    val,
                ...
                long val => GenerateLiteralExpression(
                    type,
                    val,
                ...
                byte val => GenerateNonNegativeLiteralExpression(
                    type,
                    val,
                ...
                ushort val => GenerateNonNegativeLiteralExpression(
                    type,
                    val,
                ...
                uint val => GenerateNonNegativeLiteralExpression(
                    type,
                    val,
                ...
                ulong val => GenerateNonNegativeLiteralExpression(
                    type,
                    val,
                ...
                decimal val => GenerateLiteralExpression(
                    type,
                    val,
