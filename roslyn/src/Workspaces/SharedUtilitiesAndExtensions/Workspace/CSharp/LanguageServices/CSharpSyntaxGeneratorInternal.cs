...
namespace Microsoft.CodeAnalysis.CSharp.CodeGeneration
{
    ...
    internal sealed class CSharpSyntaxGeneratorInternal : SyntaxGeneratorInternal
    {
        ...
        internal override SyntaxTrivia EndOfLine(string text) => SyntaxFactory.EndOfLine(text);

        internal override SyntaxNode LocalDeclarationStatement(
            SyntaxNode type,
            SyntaxToken name,
        ...
        internal override SyntaxNode WithInitializer(
        ...
        internal override SyntaxNode ConditionalAccessExpression(
            SyntaxNode expression,
        ...
        internal override SyntaxNode AddParentheses(
        ...
        internal override SyntaxNode InterpolatedStringExpression(
        ...
        internal override SyntaxNode IsPatternExpression(
            SyntaxNode expression,
