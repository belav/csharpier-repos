...
namespace Microsoft.CodeAnalysis.CSharp.CodeGeneration
{
    ...
    internal sealed class CSharpSyntaxGeneratorInternal : SyntaxGeneratorInternal
    {
        ...
        public override SyntaxTrivia EndOfLine(string text) => SyntaxFactory.EndOfLine(text);

        public override SyntaxNode LocalDeclarationStatement(
            SyntaxNode? type,
            SyntaxToken name,
        ...
        public override SyntaxNode WithInitializer(
        ...
        public override SyntaxNode ConditionalAccessExpression(
            SyntaxNode expression,
        ...
        public override SyntaxNode AddParentheses(
        ...
        internal static SyntaxNode Parenthesize(
            SyntaxNode expressionOrPattern,
            bool includeElasticTrivia = true,
            bool addSimplifierAnnotation = true
        ) =>
            ...
            {
                ExpressionSyntax expression => expression.Parenthesize(
                    includeElasticTrivia,
                    addSimplifierAnnotation
                ),
                PatternSyntax pattern => pattern.Parenthesize(
                    includeElasticTrivia,
                    addSimplifierAnnotation
                ),
                var other => other,
        ...
        public override SyntaxNode InterpolatedStringExpression(
            ...
            SyntaxFactory.InterpolatedStringExpression(
                startToken,
                SyntaxFactory.List(content.Cast<InterpolatedStringContentSyntax>()),
                endToken
            );
        ...
        internal static SyntaxTokenList GetParameterModifiers(
            RefKind refKind,
            bool forFunctionPointerReturnParameter = false
        ) =>
            refKind switch
            {
                ...
                RefKind.In when !forFunctionPointerReturnParameter => SyntaxFactory.TokenList(
        ...
        public override SyntaxNode NegateEquality(
        ...
        public override SyntaxNode IsPatternExpression(
            SyntaxNode expression,
        ...
        public override SyntaxNode AndPattern(SyntaxNode left, SyntaxNode right) =>
            SyntaxFactory.BinaryPattern(
                ...
                (PatternSyntax)Parenthesize(left),
                (PatternSyntax)Parenthesize(right)
            );
