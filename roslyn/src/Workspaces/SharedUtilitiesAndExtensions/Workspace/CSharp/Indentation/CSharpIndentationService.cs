...
namespace Microsoft.CodeAnalysis.CSharp.Indentation
{
        ...
        : AbstractIndentationService<CompilationUnitSyntax>
    {
        ...
        )
        {
            ...
            var lineOperation = FormattingOperations.GetAdjustNewLinesOperation(
                formattingRules,
                previousToken,
                token,
        ...
        private class CSharpIndentationFormattingRule : AbstractFormattingRule
        {
            public static readonly AbstractFormattingRule Instance =
                new CSharpIndentationFormattingRule();
            ...
            )
            {
                ...
                if (
                    node is BaseParameterListSyntax
                ...
                if (
                    node is BaseArgumentListSyntax argument
                ...
                )
                {
                    ...
                    var colonIsFirstTokenOnLine =
                        !constructorInitializer.ColonToken.IsMissing
                        && constructorInitializer.ColonToken.IsFirstTokenOnLine(text);
                    var thisOrBaseIsFirstTokenOnLine =
                        !constructorInitializer.ThisOrBaseKeyword.IsMissing
            ...
            )
            {
                ...
                for (var i = 0; i < list.Count; i++)
                {
                    ...
                    {
                        // replace operation
                        list[i] = FormattingOperations.CreateIndentBlockOperation(
                            startToken,
                            endToken,
                            indentationDelta: 1,
                            option: IndentBlockOption.RelativePosition
