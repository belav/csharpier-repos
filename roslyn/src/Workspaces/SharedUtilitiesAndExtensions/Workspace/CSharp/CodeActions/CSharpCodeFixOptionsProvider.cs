...
internal readonly struct CSharpCodeFixOptionsProvider
{
    ...
    public CodeStyleOption2<AccessibilityModifiersRequired> AccessibilityModifiersRequired =>
        GetOption(
            ...
            FallbackCodeStyleOptions.Common.AccessibilityModifiersRequired
        );
    ...
    private CSharpSimplifierOptions FallbackSimplifierOptions
        ...
        (CSharpSimplifierOptions)
            _fallbackOptions.GetOptions(_languageServices).CleanupOptions.SimplifierOptions;
#endif
