...
namespace Microsoft.CodeAnalysis.CSharp.Extensions
{
    internal static partial class CastExpressionSyntaxExtensions
    {
        ...
        {
            var leadingTrivia = node.OpenParenToken.LeadingTrivia.Concat(
                    node.OpenParenToken.TrailingTrivia
                )
            ...
            var resultNode = node.Expression.WithLeadingTrivia(leadingTrivia)
