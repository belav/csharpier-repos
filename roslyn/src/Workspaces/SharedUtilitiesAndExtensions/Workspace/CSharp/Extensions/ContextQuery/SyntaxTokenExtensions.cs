...
namespace Microsoft.CodeAnalysis.CSharp.Extensions.ContextQuery
{
    internal static partial class SyntaxTokenExtensions
    {
        ...
        {
            return token.Kind() == SyntaxKind.UsingKeyword
        ...
        public static bool IsPreProcessorExpressionContext(this SyntaxToken targetToken)
        {
            ...
            // #elif
            if (
                targetToken.Kind() == SyntaxKind.IfKeyword
        ...
        public static bool IsUnaryOperatorContext(this SyntaxToken targetToken)
        {
            if (
                ...
                && targetToken.GetPreviousToken(includeSkipped: true)
        ...
        {
            return targetToken.GetAncestors<StatementSyntax>()
                    .Any(s => s.IsKind(SyntaxKind.UnsafeStatement))
                || targetToken.GetAncestors<MemberDeclarationSyntax>()
        ...
        ) where TMemberNode : SyntaxNode
        {
            ...
            var existingAccessor = list.Accessors.Select(a => a.Keyword)
        ...
        private static bool IsAccessorDeclarationContextWorker(ref SyntaxToken targetToken)
        {
            ...
            while (
                targetToken.Kind() == SyntaxKind.InternalKeyword
