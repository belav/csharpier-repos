...
internal static class CodeAnalysisProgressExtensions
{
    ...
    public static ItemCompletedDisposer ItemCompletedScope(
        this IProgress<CodeAnalysisProgress> progress,
    ...
    public readonly struct ItemCompletedDisposer(IProgress<CodeAnalysisProgress> progress)
        : IDisposable
    {
        public void Dispose() => progress.ItemCompleted();
    }
}
