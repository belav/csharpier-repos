...
namespace Microsoft.CodeAnalysis.CodeActions
{
    ...
    internal sealed record class CodeActionOptions
    {
        ...
        [DataMember]
        public required IdeCodeStyleOptions CodeStyleOptions { get; init; }
        ...
        public int CollectionExpressionWrappingLength { get; init; } =
            DefaultCollectionExpressionWrappingLength;
    ...
    internal sealed class DelegatingCodeActionOptionsProvider(
        Func<LanguageServices, CodeActionOptions> @delegate
    ) : AbstractCodeActionOptionsProvider
    {
