...
namespace Microsoft.CodeAnalysis.CodeActions
{
    ...
    internal sealed record class CodeActionOptions
    {
        ...
        public static readonly CodeActionOptionsProvider DefaultProvider =
            new DelegatingCodeActionOptionsProvider(GetDefault);
#else
        public static readonly CodeActionOptionsProvider DefaultProvider =
            new DelegatingCodeActionOptionsProvider(static ls => GetDefault(ls));
#endif
...
#if !CODE_STYLE
        [DataMember(Order = 0)]
        public CodeCleanupOptions CleanupOptions { get; init; }

        [DataMember(Order = 1)]
        public CodeGenerationOptions CodeGenerationOptions { get; init; }

        [DataMember(Order = 2)]
        public IdeCodeStyleOptions CodeStyleOptions { get; init; }

        [DataMember(Order = 3)]
        public SymbolSearchOptions SearchOptions { get; init; } = SymbolSearchOptions.Default;

        [DataMember(Order = 4)]
        public ImplementTypeOptions ImplementTypeOptions { get; init; } =
            ImplementTypeOptions.Default;

        [DataMember(Order = 5)]
        public ExtractMethodOptions ExtractMethodOptions { get; init; } =
        ...
        [DataMember(Order = 7)]
        public int WrappingColumn { get; init; } = DefaultWrappingColumn;

        [DataMember(Order = 8)]
        public int ConditionalExpressionWrappingLength { get; init; } =
...
#else
        public static CodeActionOptions GetDefault(LanguageServices languageServices) => new();
#endif
    ...
    internal abstract class AbstractCodeActionOptionsProvider : CodeActionOptionsProvider
    {
        ...
        ValueTask<LineFormattingOptions> OptionsProvider<LineFormattingOptions>.GetOptionsAsync(
            ...
            ValueTaskFactory.FromResult(
                GetOptions(languageServices).CleanupOptions.FormattingOptions.LineFormatting
            );
        ...
        ValueTask<DocumentFormattingOptions> OptionsProvider<DocumentFormattingOptions>.GetOptionsAsync(
            ...
            ValueTaskFactory.FromResult(
                GetOptions(languageServices).CleanupOptions.DocumentFormattingOptions
            );
        ...
        ValueTask<SyntaxFormattingOptions> OptionsProvider<SyntaxFormattingOptions>.GetOptionsAsync(
            ...
            ValueTaskFactory.FromResult(
                GetOptions(languageServices).CleanupOptions.FormattingOptions
            );
        ...
        ValueTask<SimplifierOptions> OptionsProvider<SimplifierOptions>.GetOptionsAsync(
            ...
            ValueTaskFactory.FromResult(
                GetOptions(languageServices).CleanupOptions.SimplifierOptions
            );
        ...
        ValueTask<AddImportPlacementOptions> OptionsProvider<AddImportPlacementOptions>.GetOptionsAsync(
            ...
            ValueTaskFactory.FromResult(
                GetOptions(languageServices).CleanupOptions.AddImportOptions
            );

        ValueTask<OrganizeImportsOptions> OptionsProvider<OrganizeImportsOptions>.GetOptionsAsync(
            LanguageServices languageServices,
            CancellationToken cancellationToken
        ) =>
            ValueTaskFactory.FromResult(
                GetOptions(languageServices).CleanupOptions.GetOrganizeImportsOptions()
            );
        ...
        ValueTask<NamingStylePreferences> OptionsProvider<NamingStylePreferences>.GetOptionsAsync(
            ...
            ValueTaskFactory.FromResult(
                GetOptions(languageServices).CodeGenerationOptions.NamingStyle
            );
        ...
        )
        {
            ...
            return ValueTaskFactory.FromResult(
                new CleanCodeGenerationOptions(
                    codeActionOptions.CodeGenerationOptions,
                    codeActionOptions.CleanupOptions
                )
            );
        }
    ...
    internal sealed class DelegatingCodeActionOptionsProvider : AbstractCodeActionOptionsProvider
    {
        ...
        public DelegatingCodeActionOptionsProvider(
            Func<LanguageServices, CodeActionOptions> @delegate
        ) => _delegate = @delegate;
    ...
    internal static class CodeActionOptionsProviders
    {
        ...
        public static ImplementTypeGenerationOptions GetImplementTypeGenerationOptions(
            this CodeActionOptionsProvider provider,
            LanguageServices languageServices
        ...
        )
        {
            ...
            return new(codeActionOptions.CodeGenerationOptions)
            {
                ...
                LineFormattingOptions = codeActionOptions
                    .CleanupOptions
                    .FormattingOptions
                    .LineFormatting
            };
