...
namespace Microsoft.CodeAnalysis.Host.Mef
{
    internal sealed class MefWorkspaceServices : HostWorkspaceServices
    {
        ...
        public override Workspace Workspace
        {
            ...
            {
                //#if !CODE_STYLE
                //                Contract.ThrowIfTrue(_workspace.Kind ==
                // CodeAnalysis.WorkspaceKind.RemoteWorkspace, "Access .Workspace off of a RemoteWorkspace
                // MefWorkspaceServices is not supported.");
                //#endif
                return _workspace;
            }
        }
