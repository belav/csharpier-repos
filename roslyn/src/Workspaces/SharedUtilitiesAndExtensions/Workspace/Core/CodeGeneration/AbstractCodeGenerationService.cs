...
namespace Microsoft.CodeAnalysis.CodeGeneration
{
        ...
        where TCodeGenerationContextInfo : CodeGenerationContextInfo
    {
        ...
        protected AbstractCodeGenerationService(LanguageServices languageServices)
        {
            LanguageServices = languageServices;
            _symbolDeclarationService =
                languageServices.GetRequiredService<ISymbolDeclarationService>();
        }
            ...
            where TDeclarationNode : SyntaxNode
        {
            ...
            if (destination is not TDeclarationNode)
            {
                throw new ArgumentException(
                    string.Format(
                        WorkspaceExtensionsResources.Destination_type_must_be_a_0_but_given_one_is_1,
            ...
            where TDeclarationNode2 : SyntaxNode
        {
            ...
            if (destination is not TDeclarationNode1 and not TDeclarationNode2)
            {
                throw new ArgumentException(
                    string.Format(
                        WorkspaceExtensionsResources.Destination_type_must_be_a_0_or_a_1_but_given_one_is_2,
            ...
            where TDeclarationNode3 : SyntaxNode
        {
            ...
            )
            {
                throw new ArgumentException(
                    string.Format(
                        WorkspaceExtensionsResources.Destination_type_must_be_a_0_1_or_2_but_given_one_is_3,
                        typeof(TDeclarationNode1).Name,
                        typeof(TDeclarationNode2).Name,
            ...
            where TDeclarationNode4 : SyntaxNode
        {
            ...
            )
            {
                throw new ArgumentException(
                    string.Format(
                        WorkspaceExtensionsResources.Destination_type_must_be_a_0_1_2_or_3_but_given_one_is_4,
                        typeof(TDeclarationNode1).Name,
                        typeof(TDeclarationNode2).Name,
                        typeof(TDeclarationNode3).Name,
        ...
        )
        {
            ...
            {
                throw new ArgumentException(
                    WorkspaceExtensionsResources.Could_not_find_location_to_generation_symbol_into
                );
            }
            ...
            var info = GetInfo(
                context.Context,
                codeGenOptions,
                destinationDeclaration.SyntaxTree.Options
            );
            ...
            where TDeclarationNode : SyntaxNode
        {
            ...
            var filteredMembers = membersList.Where(m =>
                !m.IsImplicitlyDeclared || m.IsTupleField()
            );
        ...
        private SyntaxNode? GetNewMember(
            ...
            member switch
            {
                IEventSymbol @event => CreateEventDeclaration(
                    @event,
                    codeGenerationDestination,
                    info,
                    cancellationToken
                ),
                IFieldSymbol field => CreateFieldDeclaration(
                    field,
                    codeGenerationDestination,
                    info,
                    cancellationToken
                ),
                IPropertySymbol property => CreatePropertyDeclaration(
                    property,
                    codeGenerationDestination,
                    info,
                    cancellationToken
                ),
                IMethodSymbol method => CreateMethodDeclaration(
                    method,
                    codeGenerationDestination,
                    info,
                    cancellationToken
                ),
                INamedTypeSymbol namedType => CreateNamedTypeDeclaration(
                    namedType,
                    codeGenerationDestination,
                    info,
                    cancellationToken
                ),
                INamespaceSymbol @namespace => CreateNamespaceDeclaration(
                    @namespace,
                    codeGenerationDestination,
                    info,
                    cancellationToken
            ...
            where TDeclarationNode : SyntaxNode
        {
            return member switch
            {
                ...
                IPropertySymbol property => AddProperty(
                    currentDestination,
                    property,
                    info,
                    availableIndices,
                ...
                IMethodSymbol method => AddMethod(
                    currentDestination,
                    method,
                    info,
                    availableIndices,
                ...
                INamedTypeSymbol namedType => AddNamedType(
                    currentDestination,
                    namedType,
                    info,
                    availableIndices,
                ...
                INamespaceSymbol @namespace => AddNamespace(
                    currentDestination,
                    @namespace,
                    info,
                    availableIndices,
        ...
        )
        {
            ...
            {
                throw new ArgumentException(
                    WorkspaceExtensionsResources.No_location_provided_to_add_statements_to
                );
            }
            ...
            {
                throw new ArgumentException(
                    WorkspaceExtensionsResources.Destination_location_was_not_in_source
                );
            }
            ...
            {
                throw new ArgumentException(
                    WorkspaceExtensionsResources.Destination_location_was_from_a_different_tree
                );
            }
        }
