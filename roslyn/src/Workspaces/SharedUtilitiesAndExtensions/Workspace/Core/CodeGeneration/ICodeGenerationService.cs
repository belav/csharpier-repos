...
namespace Microsoft.CodeAnalysis.CodeGeneration
{
    internal interface ICodeGenerationService : ILanguageService
    {
        ...
        /// </summary>
        SyntaxNode CreatePropertyDeclaration(
        ...
        /// </summary>
        SyntaxNode CreateNamedTypeDeclaration(
        ...
        /// </summary>
        SyntaxNode CreateNamespaceDeclaration(
        ...
        /// </summary>
        TDeclarationNode AddEvent<TDeclarationNode>(
        ...
        /// </summary>
        TDeclarationNode AddField<TDeclarationNode>(
            TDeclarationNode destination,
            IFieldSymbol field,
            CodeGenerationContextInfo info,
            CancellationToken cancellationToken
        ...
        /// </summary>
        TDeclarationNode AddMethod<TDeclarationNode>(
            TDeclarationNode destination,
            IMethodSymbol method,
            CodeGenerationContextInfo info,
            CancellationToken cancellationToken
        ...
        /// </summary>
        TDeclarationNode AddMembers<TDeclarationNode>(
            TDeclarationNode destination,
        ...
        /// </summary>
        TDeclarationNode AddParameters<TDeclarationNode>(
            TDeclarationNode destination,
        ...
        /// </summary>
        TDeclarationNode AddAttributes<TDeclarationNode>(
            TDeclarationNode destination,
        ...
        /// </summary>
        TDeclarationNode RemoveAttribute<TDeclarationNode>(
            TDeclarationNode destination,
        ...
        /// </summary>
        TDeclarationNode UpdateDeclarationModifiers<TDeclarationNode>(
        ...
        /// </summary>
        TDeclarationNode UpdateDeclarationAccessibility<TDeclarationNode>(
            TDeclarationNode declaration,
        ...
        /// </summary>
        TDeclarationNode UpdateDeclarationType<TDeclarationNode>(
            TDeclarationNode declaration,
            ITypeSymbol newType,
            CodeGenerationContextInfo info,
            CancellationToken cancellationToken
        ...
        /// </summary>
        TDeclarationNode UpdateDeclarationMembers<TDeclarationNode>(
            TDeclarationNode declaration,
        ...
        /// </summary>
        TDeclarationNode AddStatements<TDeclarationNode>(
            TDeclarationNode destination,
        ...
        /// </summary>
        Task<SyntaxNode?> FindMostRelevantNameSpaceOrTypeDeclarationAsync(
            Solution solution,
            INamespaceOrTypeSymbol namespaceOrType,
            Location? location,
            CancellationToken cancellationToken
