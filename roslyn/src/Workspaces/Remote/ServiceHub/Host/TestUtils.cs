...
#if DEBUG
using System.Diagnostics;using System.Text;using Microsoft.CodeAnalysis.Internal.Log;
#endif
    ...
    internal static class TestUtils
    {
        ...
        )
        {
            ...
            var assetMapFromNewSolution = await solutionFromScratch
                .GetAssetMapAsync(CancellationToken.None)
                .ConfigureAwait(false);
        ...
        public static Task AppendAssetMapAsync(
            this Solution solution,
        ...
        )
        {
            ...
            else
            {
                ...
                foreach (
                    ...
                    await solution
                        .GetRequiredProject(dep)
                        .AppendAssetMapAsync(map, cancellationToken)
                        .ConfigureAwait(false);
            }
        }
