...
namespace Microsoft.CodeAnalysis.Remote
{
    internal static class TestUtils
    {
        ...
        )
        {
            ...
            async Task<HashSet<Checksum>> GetAllChildrenChecksumsAsync(Checksum solutionChecksum)
            {
                ...
                foreach (var (projectChecksum, projectId) in solutionChecksums.Projects)
                {
                    ...
                    await AddDocumentsAsync(projectId, projectChecksums.Documents, set)
                        .ConfigureAwait(false);
                    await AddDocumentsAsync(projectId, projectChecksums.AdditionalDocuments, set)
                        .ConfigureAwait(false);
            ...
            async Task AddDocumentsAsync(
                ProjectId projectId,
                ChecksumsAndIds<DocumentId> documents,
        ...
        private static void AddAllTo(
            DocumentStateChecksums documentStateChecksums,
            HashSet<Checksum> checksums
        )
        {
