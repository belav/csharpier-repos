          ...
          IRemoteSymbolFinderService
    {
              ...
              IStreamingProgressTracker
        {
            ...
            public ValueTask OnReferenceFoundAsync(Document document, TextSpan span) =>
                _callback.InvokeAsync(
                    (callback, cancellationToken) =>
                        callback.OnLiteralReferenceFoundAsync(_callbackId, document.Id, span),
                    _cancellationToken
                );
            ...
            public ValueTask AddItemsAsync(int count) =>
                _callback.InvokeAsync(
                    (callback, cancellationToken) =>
                        callback.AddLiteralItemsAsync(_callbackId, count),
                    _cancellationToken
                );
            ...
            public ValueTask ItemCompletedAsync() =>
                _callback.InvokeAsync(
                    (callback, cancellationToken) =>
                        callback.LiteralItemCompletedAsync(_callbackId),
                    _cancellationToken
                );
        }
              ...
              IStreamingProgressTracker
        {
            ...
            public ValueTask OnStartedAsync() =>
                _callback.InvokeAsync(
                    (callback, cancellationToken) => callback.OnStartedAsync(_callbackId),
                    _cancellationToken
                );

            public ValueTask OnCompletedAsync() =>
                _callback.InvokeAsync(
                    (callback, cancellationToken) => callback.OnCompletedAsync(_callbackId),
                    _cancellationToken
                );
            ...
            public ValueTask OnFindInDocumentStartedAsync(Document document) =>
                _callback.InvokeAsync(
                    (callback, cancellationToken) =>
                        callback.OnFindInDocumentStartedAsync(_callbackId, document.Id),
                    _cancellationToken
                );
            ...
            public ValueTask OnFindInDocumentCompletedAsync(Document document) =>
                _callback.InvokeAsync(
                    (callback, cancellationToken) =>
                        callback.OnFindInDocumentCompletedAsync(_callbackId, document.Id),
                    _cancellationToken
                );
            ...
            public ValueTask OnDefinitionFoundAsync(SymbolGroup group)
            {
                ...
                return _callback.InvokeAsync(
                    (callback, cancellationToken) =>
                        callback.OnDefinitionFoundAsync(_callbackId, dehydratedGroup),
                    _cancellationToken
                );
            }
            ...
            public ValueTask AddItemsAsync(int count) =>
                _callback.InvokeAsync(
                    (callback, cancellationToken) =>
                        callback.AddReferenceItemsAsync(_callbackId, count),
                    _cancellationToken
                );
            ...
            public ValueTask ItemCompletedAsync() =>
                _callback.InvokeAsync(
                    (callback, cancellationToken) =>
                        callback.ReferenceItemCompletedAsync(_callbackId),
                    _cancellationToken
                );
        }
    }
