...
namespace Microsoft.CodeAnalysis.Remote
{
            ...
            IRemoteSymbolFinderService
    {
        ...
        {
            protected override IRemoteSymbolFinderService CreateService(
        ...
        )
        {
            return RunServiceAsync(
                ...
                async solution =>
                {
                    var symbol = await symbolAndProjectIdArg
        ...
        public ValueTask FindLiteralReferencesAsync(
            Checksum solutionChecksum,
            RemoteServiceCallbackId callbackId,
            object value,
            TypeCode typeCode,
        ...
        )
        {
            return RunServiceAsync(
                ...
                async solution =>
                {
                    ...
                    var progressCallback = new FindLiteralReferencesProgressCallback(
                        _callback,
                        callbackId
                    );
                    await SymbolFinder
        ...
        private static ImmutableArray<SerializableSymbolAndProjectId> Convert(
        ...
        )
        {
            ...
            foreach (var item in items)
                result.Add(
                    SerializableSymbolAndProjectId.Dehydrate(solution, item, cancellationToken)
                );
        ...
        )
        {
            return RunServiceAsync(
                ...
                async solution =>
                {
                    ...
                    var result = await DeclarationFinder
        ...
        )
        {
            return RunServiceAsync(
                ...
                {
                    var cacheService =
                        solution.Services.GetRequiredService<SymbolTreeInfoCacheService>();
        ...
        public ValueTask RemoveProjectAsync(
            ProjectId projectId,
            CancellationToken cancellationToken
        )
        {
            return RunServiceAsync(
                cancellationToken =>
                {
                    var cacheService = GetWorkspaceServices()
                        .GetRequiredService<SymbolTreeInfoCacheService>();
                ...
                IStreamingProgressTracker
        {
            ...
            public ValueTask OnReferenceFoundAsync(
                ...
                _callback.InvokeAsync(
                    (callback, cancellationToken) =>
                        callback.OnLiteralReferenceFoundAsync(
                            _callbackId,
                            document.Id,
                            span,
                            cancellationToken
            ...
            public ValueTask AddItemsAsync(int count, CancellationToken cancellationToken) =>
                _callback.InvokeAsync(
                    (callback, cancellationToken) =>
                        callback.AddLiteralItemsAsync(_callbackId, count, cancellationToken),
                    cancellationToken
                );
            ...
            public ValueTask ItemsCompletedAsync(int count, CancellationToken cancellationToken) =>
                _callback.InvokeAsync(
                    (callback, cancellationToken) =>
                        callback.LiteralItemsCompletedAsync(_callbackId, count, cancellationToken),
                    cancellationToken
                );
        }
                ...
                IStreamingProgressTracker
        {
            ...
            public ValueTask OnStartedAsync(CancellationToken cancellationToken) =>
                _callback.InvokeAsync(
                    (callback, cancellationToken) =>
                        callback.OnStartedAsync(_callbackId, cancellationToken),
                    cancellationToken
                );
            ...
            public ValueTask OnCompletedAsync(CancellationToken cancellationToken) =>
                _callback.InvokeAsync(
                    (callback, cancellationToken) =>
                        callback.OnCompletedAsync(_callbackId, cancellationToken),
                    cancellationToken
                );
            ...
            public ValueTask OnFindInDocumentStartedAsync(
                ...
                _callback.InvokeAsync(
                    (callback, cancellationToken) =>
                        callback.OnFindInDocumentStartedAsync(
                            _callbackId,
                            document.Id,
                            cancellationToken
                        ),
            ...
            public ValueTask OnFindInDocumentCompletedAsync(
                ...
                _callback.InvokeAsync(
                    (callback, cancellationToken) =>
                        callback.OnFindInDocumentCompletedAsync(
                            _callbackId,
                            document.Id,
                            cancellationToken
                        ),
            ...
            )
            {
                ...
                return _callback.InvokeAsync(
                    (callback, cancellationToken) =>
                        callback.OnDefinitionFoundAsync(
                            _callbackId,
                            dehydratedGroup,
                            cancellationToken
                        ),
            ...
            )
            {
                ...
                var dehydratedDefinition = SerializableSymbolAndProjectId.Dehydrate(
                    _solution,
                    definition,
                    cancellationToken
                );
                var dehydratedReference = SerializableReferenceLocation.Dehydrate(
                    reference,
                    cancellationToken
                );
                ...
                return _callback.InvokeAsync(
                    (callback, cancellationToken) =>
                        callback.OnReferenceFoundAsync(
                            _callbackId,
                            dehydratedGroup,
            ...
            public ValueTask AddItemsAsync(int count, CancellationToken cancellationToken) =>
                _callback.InvokeAsync(
                    (callback, cancellationToken) =>
                        callback.AddReferenceItemsAsync(_callbackId, count, cancellationToken),
                    cancellationToken
                );
            ...
            public ValueTask ItemsCompletedAsync(int count, CancellationToken cancellationToken) =>
                _callback.InvokeAsync(
                    (callback, cancellationToken) =>
                        callback.ReferenceItemsCompletedAsync(
                            _callbackId,
                            count,
                            cancellationToken
                        ),
