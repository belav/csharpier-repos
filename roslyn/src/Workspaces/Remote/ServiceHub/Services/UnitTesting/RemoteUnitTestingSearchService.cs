...
namespace Microsoft.CodeAnalysis.Remote
{
            ...
            IRemoteUnitTestingSearchService
    {
        ...
        {
            return RunServiceAsync<UnitTestingSourceLocation?>(
                solutionChecksum,
                async solution =>
                {
                    ...
                    var resultOpt = await UnitTestingSearchHelpers
                        .GetSourceLocationAsync(project, query, cancellationToken)
                    ...
                    return new UnitTestingSourceLocation(
                        new DocumentIdSpan(
                            result.DocumentSpan.Document.Id,
                            result.DocumentSpan.SourceSpan
                        ),
                        result.Span
                    );
                },
