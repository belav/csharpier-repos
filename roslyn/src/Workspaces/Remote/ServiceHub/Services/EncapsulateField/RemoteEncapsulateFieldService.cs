...
namespace Microsoft.CodeAnalysis.Remote
{
            ...
            IRemoteEncapsulateFieldService
    {
        internal sealed class Factory
            : FactoryBase<IRemoteEncapsulateFieldService, IRemoteEncapsulateFieldService.ICallback>
        {
        ...
        )
        {
            return RunServiceAsync(
                ...
                async solution =>
                {
                    ...
                    var service =
                        document.GetRequiredLanguageService<AbstractEncapsulateFieldService>();
                    ...
                    return await RemoteUtilities
                        .GetDocumentTextChangesAsync(solution, newSolution, cancellationToken)
                        .ConfigureAwait(false);
                },
                cancellationToken
            );
