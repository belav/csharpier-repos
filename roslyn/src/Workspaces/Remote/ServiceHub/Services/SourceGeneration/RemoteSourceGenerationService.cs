...
internal sealed partial class RemoteSourceGenerationService(
...
) : BrokeredServiceBase(arguments), IRemoteSourceGenerationService
{
    ...
    {
        protected override IRemoteSourceGenerationService CreateService(
    ...
    )
    {
        return RunServiceAsync(
            ...
            async solution =>
            {
                ...
                var documentStates = await solution.State
                ...
                using var _ = ArrayBuilder<(
                    SourceGeneratedDocumentIdentity documentIdentity,
                    SourceGeneratedDocumentContentIdentity contentIdentity
                )>.GetInstance(documentStates.Ids.Count, out var result);
