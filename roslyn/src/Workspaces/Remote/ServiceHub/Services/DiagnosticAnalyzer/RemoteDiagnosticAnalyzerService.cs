...
namespace Microsoft.CodeAnalysis.Remote
{
            ...
            IRemoteDiagnosticAnalyzerService
    {
        ...
        {
            protected override IRemoteDiagnosticAnalyzerService CreateService(
        ...
        )
        {
            ...
            using (
                TelemetryLogging.LogBlockTimeAggregated(
                    FunctionId.PerformAnalysis_Summary,
                    $"Total"
                )
            )
            using (
                RoslynLogger.LogBlock(
                    FunctionId.CodeAnalysisService_CalculateDiagnosticsAsync,
            ...
            )
            {
                return await RunWithSolutionAsync(
                        ...
                        async solution =>
                        {
                            ...
                            var result = await DiagnosticComputer
                                .GetDiagnosticsAsync(
                                    document,
                                    project,
                                    solutionChecksum,
                                    arguments.IdeOptions,
                                    documentSpan,
        ...
        public async ValueTask<ImmutableArray<DiagnosticData>> GetSourceGeneratorDiagnosticsAsync(
            Checksum solutionChecksum,
            ProjectId projectId,
            CancellationToken cancellationToken
        )
        ...
        public ValueTask ReportAnalyzerPerformanceAsync(
