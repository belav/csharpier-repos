...
namespace Microsoft.CodeAnalysis.Remote.Diagnostics
{
    internal class DiagnosticComputer
    {
        ...
        /// </summary>
        private static readonly WeakReference<CompilationWithAnalyzersCacheEntry?> s_compilationWithAnalyzersCache =
            new(null);
        ...
        )
        {
            ...
            catch
            {
                ...
                {
                    if (
                        s_compilationWithAnalyzersCache.TryGetTarget(out var target)
