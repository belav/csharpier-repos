...
namespace Microsoft.CodeAnalysis.Remote.Diagnostics
{
    internal class DiagnosticComputer
    {
        ...
        > s_compilationWithAnalyzersCache = new();
        ...
        )
        {
            ...
            _performanceTracker = project.IsFromPrimaryBranch()
        ...
        private async Task<(CompilationWithAnalyzers compilationWithAnalyzers, BidirectionalMap<
                string,
                DiagnosticAnalyzer
            > analyzerToIdMap)> GetOrCreateCompilationWithAnalyzersAsync(
            CancellationToken cancellationToken
        )
        {
            ...
            async Task<CompilationWithAnalyzersCacheEntry> GetOrCreateCacheEntryAsync()
            {
                ...
                data = await CreateCompilationWithAnalyzersCacheEntryAsync(cancellationToken)
                    .ConfigureAwait(false);
