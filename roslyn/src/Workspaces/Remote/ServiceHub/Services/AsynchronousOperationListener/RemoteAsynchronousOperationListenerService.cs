...
namespace Microsoft.CodeAnalysis.Remote
{
          ...
          IRemoteAsynchronousOperationListenerService
    {
        ...
        {
            protected override IRemoteAsynchronousOperationListenerService CreateService(
            ...
            return RunServiceAsync(
                cancellationToken =>
                {
                    ...
                    var listenerProvider =
                        exportProvider.GetExports<AsynchronousOperationListenerProvider>()
                            .Single().Value;
        ...
        public ValueTask ExpeditedWaitAsync(
            ...
            return RunServiceAsync(
                async cancellationToken =>
                {
                    ...
                    await listenerProvider.WaitAllAsync(workspace, featureNames.ToArray())
