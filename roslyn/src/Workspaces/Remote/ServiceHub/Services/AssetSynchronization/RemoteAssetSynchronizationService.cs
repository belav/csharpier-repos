...
namespace Microsoft.CodeAnalysis.Remote
{
            ...
            IRemoteAssetSynchronizationService
    {
        ...
        {
            protected override IRemoteAssetSynchronizationService CreateService(
                ...
                async cancellationToken =>
                {
                    using (
                        RoslynLogger.LogBlock(
                            FunctionId.RemoteHostService_SynchronizePrimaryWorkspaceAsync,
                    ...
                    )
                    {
                        ...
                        await workspace
                            .UpdatePrimaryBranchSolutionAsync(
                                assetProvider,
                                solutionChecksum,
                                workspaceVersion,
                                cancellationToken
        ...
        public ValueTask SynchronizeTextAsync(
        ...
        )
        {
            return RunServiceAsync(
                async cancellationToken =>
                {
                    ...
                    using (
                        RoslynLogger.LogBlock(
                            FunctionId.RemoteHostService_SynchronizeTextAsync,
                            Checksum.GetChecksumLogInfo,
                            baseTextChecksum,
                            cancellationToken
                        )
                    )
                    {
                        ...
                        var text = await TryGetSourceTextAsync(
                                WorkspaceManager,
                                workspace,
                                documentId,
                                baseTextChecksum,
