        ...
        )
        {
            return RunServiceAsync(
                ...
                solution =>
                {
                    ...
                    var service = (AbstractInheritanceMarginService)
                        document.GetRequiredLanguageService<IInheritanceMarginService>();

                    return service.GetGlobalImportItemsAsync(
                        document,
                        spanToSearch,
        ...
        )
        {
            return RunServiceAsync(
                ...
                solution =>
                {
                    ...
                    return AbstractInheritanceMarginService.GetSymbolItemsAsync(
                        project,
                        document,
