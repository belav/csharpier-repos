...
namespace Microsoft.CodeAnalysis.ExternalAccess.UnitTesting.Api
{
        ...
        where TService : class
    {
        ...
        internal UnitTestingRemoteServiceConnectionWrapper(
            RemoteServiceConnection<TService> underlyingObject
        ...
        public ValueTask<bool> TryInvokeAsync(
            Func<
                TService,
                UnitTestingRemoteServiceCallbackIdWrapper,
                CancellationToken,
                ValueTask
            > invocation,
            CancellationToken cancellationToken
            ...
            UnderlyingObject.TryInvokeAsync(
                (service, callbackId, cancellationToken) =>
                    invocation(service, callbackId, cancellationToken),
                cancellationToken
            );
        ...
        public ValueTask<bool> TryInvokeAsync(
            ...
            Func<
                TService,
                UnitTestingPinnedSolutionInfoWrapper,
                CancellationToken,
                ValueTask
            > invocation,
            CancellationToken cancellationToken
        ...
        public ValueTask<bool> TryInvokeAsync(
            ...
            UnderlyingObject.TryInvokeAsync(
                ...
                (service, solutionInfo, callbackId, cancellationToken) =>
                    invocation(service, solutionInfo, callbackId, cancellationToken),
                cancellationToken
            );
