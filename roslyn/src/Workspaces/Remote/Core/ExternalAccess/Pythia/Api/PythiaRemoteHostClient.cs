...
namespace Microsoft.CodeAnalysis.ExternalAccess.Pythia.Api
{
    internal readonly struct PythiaRemoteHostClient
    {
        ...
        internal PythiaRemoteHostClient(
            ...
            PythiaServiceDescriptorsWrapper serviceDescriptors,
            PythiaRemoteServiceCallbackDispatcherRegistry callbackDispatchers
        )
        {
            _client = client;
        ...
        public static async Task<PythiaRemoteHostClient?> TryGetClientAsync(
        ...
        )
        {
            var client = await RemoteHostClient
                .TryGetClientAsync(services.SolutionServices, cancellationToken)
        ...
        private PythiaRemoteServiceConnectionWrapper<TService> CreateConnection<TService>(
        ...
        public async ValueTask<bool> TryInvokeAsync<TService>(
            Func<
                TService,
                PythiaRemoteServiceCallbackIdWrapper,
                CancellationToken,
                ValueTask
            > invocation,
            object callbackTarget,
