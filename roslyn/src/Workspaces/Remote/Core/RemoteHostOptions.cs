...
namespace Microsoft.CodeAnalysis.Remote
{
    ...
    internal sealed class RemoteHostOptions : IOptionProvider
    {
        ...
        public static readonly Option2<bool> OOPServerGC =
            new(
                FeatureName,
                nameof(OOPServerGC),
                defaultValue: false,
        ...
        public static readonly Option<bool> OOPServerGCFeatureFlag =
            new(
                FeatureName,
        ...
        public static readonly Option<bool> OOPCoreClrFeatureFlag =
            new(
                FeatureName,
