...
public class HierarchyId : IComparable<HierarchyId>
{
    ...
    public static HierarchyId? Parse(string? input) => (HierarchyId?)SqlHierarchyId.Parse(input);

    /// <inheritdoc />
    public virtual int CompareTo(HierarchyId? other) => _value.CompareTo((SqlHierarchyId)other);
