...
namespace Microsoft.EntityFrameworkCore.Sqlite.Storage.Internal
{
    ...
    {
        private const string DateTimeOffsetFormatConst =
        ...
        ///     doing so can result in application failures when updating to a new Entity Framework Core release.
        /// </summary>
        public SqliteDateTimeOffsetTypeMapping(string storeType, DbType? dbType = null)
        ...
        ///     doing so can result in application failures when updating to a new Entity Framework Core release.
        /// </summary>
        protected SqliteDateTimeOffsetTypeMapping(
