...
public static class SqliteTableBuilderExtensions
{
    ...
    /// </summary>
    /// <remarks>
    ///     See <see href="https://aka.ms/efcore-docs-sqlite-returning-clause">Using the SQL RETURNING
    // clause with Sqlite</see> for more
    ///     information and examples.
    /// </remarks>
    /// <param name="tableBuilder">The builder for the table being configured.</param>
    /// <param name="useSqlReturningClause">A value indicating whether to use the RETURNING clause when
    // saving changes to the table.</param>
    ...
    /// <summary>
    ///     Configures whether to use the SQL RETURNING clause when saving changes to the table.
    ///     The RETURNING clause is incompatible with  certain Sqlite features, such as virtual tables
    // or tables with AFTER triggers.
    /// </summary>
    /// <remarks>
    ///     See <see href="https://aka.ms/efcore-docs-sqlite-returning-clause">Using the SQL RETURNING
    // clause with Sqlite</see> for more
    ...
    /// <summary>
    ///     Configures whether to use the SQL RETURNING clause when saving changes to the table. The
    // RETURNING clause is incompatible with
