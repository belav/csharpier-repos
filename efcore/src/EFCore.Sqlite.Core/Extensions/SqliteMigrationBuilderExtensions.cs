...
/// </summary>
/// <remarks>
///     See <see href="https://aka.ms/efcore-docs-sqlite">Accessing SQLite databases with EF
// Core</see> for more information and examples.
/// </remarks>
public static class SqliteMigrationBuilderExtensions
{
    /// <summary>
    ///     Returns <see langword="true" /> if the database provider currently in use is the SQLite
    // provider.
    /// </summary>
    /// <remarks>
    ///     See <see href="https://aka.ms/efcore-docs-sqlite">Accessing SQLite databases with EF
    ...
    /// </param>
    /// <returns><see langword="true" /> if SQLite is being used; <see langword="false" />
    // otherwise.</returns>
