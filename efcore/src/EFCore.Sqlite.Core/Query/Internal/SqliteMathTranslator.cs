    ...
    public class SqliteMathTranslator : IMethodCallTranslator
    {
        private static readonly Dictionary<MethodInfo, string> _supportedMethods =
            new()
            {
                ...
                {
                    typeof(Math).GetRequiredMethod(nameof(Math.Max), typeof(byte), typeof(byte)),
                    "max"
                },
                {
                ...
                {
                    typeof(Math).GetRequiredMethod(nameof(Math.Max), typeof(float), typeof(float)),
                    "max"
                },
                {
                    typeof(Math).GetRequiredMethod(nameof(Math.Max), typeof(int), typeof(int)),
                    "max"
                },
                {
                    typeof(Math).GetRequiredMethod(nameof(Math.Max), typeof(long), typeof(long)),
                    "max"
                },
                {
                    typeof(Math).GetRequiredMethod(nameof(Math.Max), typeof(sbyte), typeof(sbyte)),
                    "max"
                },
                {
                    typeof(Math).GetRequiredMethod(nameof(Math.Max), typeof(short), typeof(short)),
                    "max"
                },
                {
                    typeof(Math).GetRequiredMethod(nameof(Math.Max), typeof(uint), typeof(uint)),
                    "max"
                },
                {
                    typeof(Math).GetRequiredMethod(
                ...
                {
                    typeof(Math).GetRequiredMethod(nameof(Math.Min), typeof(byte), typeof(byte)),
                    "min"
                },
                {
                    typeof(Math).GetRequiredMethod(
                ...
                {
                    typeof(Math).GetRequiredMethod(nameof(Math.Min), typeof(float), typeof(float)),
                    "min"
                },
                {
                    typeof(Math).GetRequiredMethod(nameof(Math.Min), typeof(int), typeof(int)),
                    "min"
                },
                {
                    typeof(Math).GetRequiredMethod(nameof(Math.Min), typeof(long), typeof(long)),
                    "min"
                },
                {
                    typeof(Math).GetRequiredMethod(nameof(Math.Min), typeof(sbyte), typeof(sbyte)),
                    "min"
                },
                {
                    typeof(Math).GetRequiredMethod(nameof(Math.Min), typeof(short), typeof(short)),
                    "min"
                },
                {
                    typeof(Math).GetRequiredMethod(nameof(Math.Min), typeof(uint), typeof(uint)),
                    "min"
                },
                {
                    typeof(Math).GetRequiredMethod(
                ...
                {
                    typeof(Math).GetRequiredMethod(nameof(Math.Round), typeof(double), typeof(int)),
                    "round"
                },
                { typeof(MathF).GetRequiredMethod(nameof(MathF.Abs), typeof(float)), "abs" },
                {
                    typeof(MathF).GetRequiredMethod(
                        nameof(MathF.Max),
                        typeof(float),
                        typeof(float)
                    ),
