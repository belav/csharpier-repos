...
public class SqliteMathTranslator : IMethodCallTranslator
{
    private static readonly Dictionary<MethodInfo, string> SupportedMethods =
        new()
        {
            ...
            {
                typeof(Math).GetMethod(nameof(Math.Max), new[] { typeof(byte), typeof(byte) })!,
                "max"
            },
            {
            ...
            {
                typeof(Math).GetMethod(nameof(Math.Max), new[] { typeof(long), typeof(long) })!,
                "max"
            },
            {
                typeof(Math).GetMethod(nameof(Math.Max), new[] { typeof(sbyte), typeof(sbyte) })!,
                "max"
            },
            {
                typeof(Math).GetMethod(nameof(Math.Max), new[] { typeof(short), typeof(short) })!,
                "max"
            },
            {
                typeof(Math).GetMethod(nameof(Math.Max), new[] { typeof(uint), typeof(uint) })!,
                "max"
            },
            {
                typeof(Math).GetMethod(nameof(Math.Max), new[] { typeof(ushort), typeof(ushort) })!,
                "max"
            },
            {
                typeof(Math).GetMethod(nameof(Math.Min), new[] { typeof(byte), typeof(byte) })!,
                "min"
            },
            {
            ...
            {
                typeof(Math).GetMethod(nameof(Math.Min), new[] { typeof(long), typeof(long) })!,
                "min"
            },
            {
                typeof(Math).GetMethod(nameof(Math.Min), new[] { typeof(sbyte), typeof(sbyte) })!,
                "min"
            },
            {
                typeof(Math).GetMethod(nameof(Math.Min), new[] { typeof(short), typeof(short) })!,
                "min"
            },
            {
                typeof(Math).GetMethod(nameof(Math.Min), new[] { typeof(uint), typeof(uint) })!,
                "min"
            },
            {
                typeof(Math).GetMethod(nameof(Math.Min), new[] { typeof(ushort), typeof(ushort) })!,
                "min"
            },
            ...
            {
                typeof(MathF).GetMethod(nameof(MathF.Max), new[] { typeof(float), typeof(float) })!,
                "max"
            },
            {
