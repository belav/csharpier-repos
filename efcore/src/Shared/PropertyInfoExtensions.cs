...
namespace System.Reflection
{
    ...
    internal static class PropertyInfoExtensions
    {
        ...
        public static bool IsIndexerProperty(this PropertyInfo propertyInfo)
        {
            ...
            return indexParams.Length == 1 && indexParams[0].ParameterType == typeof(string);
        }

        public static PropertyInfo? FindGetterProperty(this PropertyInfo propertyInfo) =>
            propertyInfo.DeclaringType!.GetPropertiesInHierarchy(propertyInfo.GetSimpleMemberName())
