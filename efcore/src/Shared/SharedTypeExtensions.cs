...
internal static class SharedTypeExtensions
{
    ...
    public static bool IsValidEntityType(this Type type) =>
        type is { IsClass: true, IsArray: false } && type != typeof(string);

    public static bool IsValidComplexType(this Type type) =>
        !type.IsArray && !type.IsInterface && !IsScalarType(type);

    public static bool IsScalarType(this Type type) =>
        type == typeof(string) || CommonTypeDictionary.ContainsKey(type);

    public static bool IsPropertyBagType(
    ...
    public static Type GetSequenceType(
        [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.Interfaces)] this Type type
    )
    {
    ...
    public static Type? TryGetSequenceType(
        [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.Interfaces)] this Type type
    ) =>
        type.TryGetElementType(typeof(IEnumerable<>)) ?? type.TryGetElementType(
    ...
    )
    {
        ...
        [UnconditionalSuppressMessage(
            "ReflectionAnalysis",
            "IL2070",
            Justification = "https://github.com/dotnet/linker/issues/2473"
        )]
        static IEnumerable<Type> GetInterfacesSuppressed(Type type) => type.GetInterfaces();
    }
    ...
    public static IEnumerable<MemberInfo> GetMembersInHierarchy(this Type type)
    {
        ...
        do
        {
            ...
            foreach (
                var propertyInfo in currentType
...
#pragma warning restore IDE0034 // Simplify 'default' expression
    ...
    public static ConstantExpression GetDefaultValueConstant(this Type type) =>
        (ConstantExpression)
            GenerateDefaultValueConstantMethod
