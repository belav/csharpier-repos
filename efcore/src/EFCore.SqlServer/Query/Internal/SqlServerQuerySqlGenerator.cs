            ...
            if (extensionExpression is TemporalTableExpression temporalTableExpression)
            {
                ...
                switch (temporalTableExpression)
                {
                    case TemporalAsOfTableExpression asOf:
                        Sql.Append("AS OF ")
                            .Append(
                                Sql.TypeMappingSource
                                    .GetMapping(typeof(DateTime))
                                    .GenerateSqlLiteral(asOf.PointInTime)
                            );
                        break;
                    ...
                    case TemporalFromToTableExpression fromTo:
                        Sql.Append("FROM ")
                            .Append(
                                Sql.TypeMappingSource
                                    .GetMapping(typeof(DateTime))
                                    .GenerateSqlLiteral(fromTo.From)
                            )
                            .Append(" TO ")
                            .Append(
                                Sql.TypeMappingSource
                                    .GetMapping(typeof(DateTime))
                                    .GenerateSqlLiteral(fromTo.To)
                            );
                        break;
                    ...
                    case TemporalBetweenTableExpression between:
                        Sql.Append("BETWEEN ")
                            .Append(
                                Sql.TypeMappingSource
                                    .GetMapping(typeof(DateTime))
                                    .GenerateSqlLiteral(between.From)
                            )
                            .Append(" AND ")
                            .Append(
                                Sql.TypeMappingSource
                                    .GetMapping(typeof(DateTime))
                                    .GenerateSqlLiteral(between.To)
                            );
                        break;
                    ...
                    case TemporalContainedInTableExpression containedIn:
                        Sql.Append("CONTAINED IN (")
                            .Append(
                                Sql.TypeMappingSource
                                    .GetMapping(typeof(DateTime))
                                    .GenerateSqlLiteral(containedIn.From)
                            )
                            .Append(", ")
                            .Append(
                                Sql.TypeMappingSource
                                    .GetMapping(typeof(DateTime))
                                    .GenerateSqlLiteral(containedIn.To)
                            )
                            .Append(")");
                        break;
