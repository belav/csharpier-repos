...
namespace Microsoft.EntityFrameworkCore.SqlServer.Query.Internal
{
    ...
    {
        private static readonly MethodInfo _dateFromPartsMethodInfo =
        ...
        private static readonly MethodInfo _dateTimeFromPartsMethodInfo =
            typeof(SqlServerDbFunctionsExtensions).GetRequiredRuntimeMethod(
        ...
        private static readonly MethodInfo _dateTime2FromPartsMethodInfo =
            typeof(SqlServerDbFunctionsExtensions).GetRequiredRuntimeMethod(
        ...
        private static readonly MethodInfo _dateTimeOffsetFromPartsMethodInfo =
            typeof(SqlServerDbFunctionsExtensions).GetRequiredRuntimeMethod(
        ...
        private static readonly MethodInfo _smallDateTimeFromPartsMethodInfo =
            typeof(SqlServerDbFunctionsExtensions).GetRequiredRuntimeMethod(
        ...
        private static readonly MethodInfo _timeFromPartsMethodInfo =
            typeof(SqlServerDbFunctionsExtensions).GetRequiredRuntimeMethod(
        ...
        > _methodFunctionMapping = new Dictionary<MethodInfo, (string, string)>
        {
