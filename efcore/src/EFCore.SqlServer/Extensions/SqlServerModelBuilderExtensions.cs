...
public static class SqlServerModelBuilderExtensions
{
    ...
    /// <summary>
    ///     Configures the database sequence used for the hi-lo pattern to generate values for key
    // properties
    ///     marked as <see cref="ValueGenerated.OnAdd" />, when targeting SQL Server.
    /// </summary>
    /// <remarks>
    ...
    /// <summary>
    ///     Returns a value indicating whether the given name and schema can be set for the hi-lo
    // sequence.
    /// </summary>
    /// <remarks>
    ///     See <see href="https://aka.ms/efcore-docs-modeling">Modeling entity types and
    ...
    /// <param name="fromDataAnnotation">Indicates whether the configuration was specified using a data
    // annotation.</param>
    /// <returns><see langword="true" /> if the given name and schema can be set for the hi-lo
    // sequence.</returns>
    ...
    /// </remarks>
    /// <param name="modelBuilder">The model builder.</param>
    /// <param name="nameSuffix">The name that will suffix the table name for each sequence created
    // automatically.</param>
    /// <param name="schema">The schema of the sequence.</param>
    /// <returns>The same builder instance so that multiple calls can be chained.</returns>
    ...
    /// <summary>
    ///     Configures the model to use the SQL Server IDENTITY feature to generate values for key
    // properties
    ///     marked as <see cref="ValueGenerated.OnAdd" />, when targeting SQL Server. This is the
    // default
    ...
    /// <param name="increment">The incremental value that is added to the identity value of the
    // previous row that was loaded.</param>
    /// <returns>The same builder instance so that multiple calls can be chained.</returns>
    ...
    /// <summary>
    ///     Returns a value indicating whether the given value can be set as the default seed for SQL
    // Server IDENTITY.
    /// </summary>
    /// <remarks>
    ///     See <see href="https://aka.ms/efcore-docs-modeling">Modeling entity types and
    ...
    /// <param name="fromDataAnnotation">Indicates whether the configuration was specified using a data
    // annotation.</param>
    /// <returns><see langword="true" /> if the given value can be set as the seed for SQL Server
    // IDENTITY.</returns>
    ...
    /// <summary>
    ///     Returns a value indicating whether the given value can be set as the default increment for
    // SQL Server IDENTITY.
    /// </summary>
    /// <remarks>
    ///     See <see href="https://aka.ms/efcore-docs-modeling">Modeling entity types and
    ...
    /// <param name="fromDataAnnotation">Indicates whether the configuration was specified using a data
    // annotation.</param>
    /// <returns><see langword="true" /> if the given value can be set as the default increment for SQL
    // Server IDENTITY.</returns>
    ...
    /// <summary>
    ///     Configures the default value generation strategy for key properties marked as <see
    // cref="ValueGenerated.OnAdd" />,
    ...
    )
    {
        ...
        {
            if (
                modelBuilder.CanSetAnnotation(SqlServerAnnotationNames.SequenceNameSuffix, null)
    ...
    /// <summary>
    ///     Returns a value indicating whether the given value can be set as the default value
    // generation strategy.
    /// </summary>
    /// <remarks>
    ///     See <see href="https://aka.ms/efcore-docs-modeling">Modeling entity types and
    ...
    /// <param name="fromDataAnnotation">Indicates whether the configuration was specified using a data
    // annotation.</param>
    /// <returns><see langword="true" /> if the given value can be set as the default value generation
    // strategy.</returns>
    ...
    /// <remarks>
    ///     <para>
    ///         Units must be included, e.g. "100 MB". See Azure SQL Database documentation for all
    // supported values.
    ///     </para>
    ///     <para>
    ///         See <see href="https://aka.ms/efcore-docs-modeling">Modeling entity types and
    ...
    /// <summary>
    ///     Returns a value indicating whether the given value can be set as the maximum size of the
    // database.
    /// </summary>
    /// <remarks>
    ///     See <see href="https://aka.ms/efcore-docs-modeling">Modeling entity types and
    ...
    /// <param name="fromDataAnnotation">Indicates whether the configuration was specified using a data
    // annotation.</param>
    /// <returns><see langword="true" /> if the given value can be set as the maximum size of the
    // database.</returns>
    ...
    /// <summary>
    ///     Returns a value indicating whether the given value can be set as the service tier of the
    // database.
    /// </summary>
    /// <remarks>
    ///     See <see href="https://aka.ms/efcore-docs-modeling">Modeling entity types and
    ...
    /// <param name="fromDataAnnotation">Indicates whether the configuration was specified using a data
    // annotation.</param>
    /// <returns><see langword="true" /> if the given value can be set as the service tier of the
    // database.</returns>
    ...
    /// <summary>
    ///     Configures the performance level (SERVICE_OBJECTIVE) for Azure SQL Database as a string
    // literal.
    /// </summary>
    /// <remarks>
    ///     <para>
    ...
    /// </remarks>
    /// <param name="modelBuilder">The model builder.</param>
    /// <param name="performanceLevel">The performance level of the database as a string
    // literal.</param>
    /// <returns>The same builder instance so that multiple calls can be chained.</returns>
    ...
    /// <summary>
    ///     Configures the performance level (SERVICE_OBJECTIVE) for Azure SQL Database as a SQL
    // expression.
    /// </summary>
    /// <remarks>
    ///     <para>
    ...
    /// <summary>
    ///     Returns a value indicating whether the given value can be set as the performance level of
    // the database.
    /// </summary>
    /// <remarks>
    ///     See <see href="https://aka.ms/efcore-docs-modeling">Modeling entity types and
    ...
    /// <param name="fromDataAnnotation">Indicates whether the configuration was specified using a data
    // annotation.</param>
    /// <returns><see langword="true" /> if the given value can be set as the performance level of the
    // database.</returns>
