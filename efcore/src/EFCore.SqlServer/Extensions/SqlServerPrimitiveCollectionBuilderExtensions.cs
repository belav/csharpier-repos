...
public static class SqlServerPrimitiveCollectionBuilderExtensions
{
    ...
    ///     <see
    // href="https://docs.microsoft.com/sql/relational-databases/tables/use-sparse-columns">Sparse
    // columns</see> for
    ...
    /// <param name="sparse">A value indicating whether the property's column is created as
    // sparse.</param>
