...
public static class SqlServerEntityTypeBuilderExtensions
{
    ...
    ///     for more information and examples.
    /// </remarks>
    /// <param name="collectionOwnershipBuilder">The builder for the entity type being
    // configured.</param>
    /// <param name="memoryOptimized">A value indicating whether the table is memory-optimized.</param>
    /// <returns>The same builder instance so that multiple calls can be chained.</returns>
    [Obsolete("Configure this using ToTable(t => t.IsMemoryOptimized()) instead.")]
    ...
    /// <param name="fromDataAnnotation">Indicates whether the configuration was specified using a data
    // annotation.</param>
    /// <returns><see langword="true" /> if the mapped table can be configured as
    // memory-optimized.</returns>
