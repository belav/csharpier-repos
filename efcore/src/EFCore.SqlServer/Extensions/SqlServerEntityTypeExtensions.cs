...
public static class SqlServerEntityTypeExtensions
{
    ...
    public static void SetPeriodStartPropertyName(
        this IMutableEntityType entityType,
    ...
    public static void SetPeriodEndPropertyName(
        this IMutableEntityType entityType,
    ...
    public static void SetHistoryTableName(
        this IMutableEntityType entityType,
    ...
    public static void SetHistoryTableSchema(
        this IMutableEntityType entityType,
    ...
    {
        if (
            entityType.FindAnnotation(SqlServerAnnotationNames.UseSqlOutputClause) is
            { Value: bool useSqlOutputClause }
        )
        {
    ...
    public static bool IsSqlOutputClauseUsed(
    ...
    )
    {
        if (
            ...
            && overrides.FindAnnotation(SqlServerAnnotationNames.UseSqlOutputClause)
                is { Value: bool useSqlOutputClause }
        )
        {
            return useSqlOutputClause;
        }
