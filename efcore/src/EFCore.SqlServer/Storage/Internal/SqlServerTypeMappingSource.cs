...
{
    private readonly RelationalTypeMapping _sqlVariant = new SqlServerSqlVariantTypeMapping(
        "sql_variant"
    );

    private readonly FloatTypeMapping _real = new SqlServerFloatTypeMapping("real");

    private readonly FloatTypeMapping _realAlias = new SqlServerFloatTypeMapping(
        "placeholder",
        storeTypePostfix: StoreTypePostfix.None
    );

    private readonly ByteTypeMapping _byte = new SqlServerByteTypeMapping("tinyint");

    private readonly ShortTypeMapping _short = new SqlServerShortTypeMapping("smallint");

    private readonly LongTypeMapping _long = new SqlServerLongTypeMapping("bigint");
    ...
    private readonly IntTypeMapping _int = new("int");

    private readonly BoolTypeMapping _bool = new SqlServerBoolTypeMapping("bit");
    ...
    private readonly SqlServerDateTimeTypeMapping _date = new("date", DbType.Date);

    private readonly SqlServerDateTimeTypeMapping _smallDatetime =
        new("smalldatetime", DbType.DateTime, SqlDbType.SmallDateTime);

    private readonly SqlServerDateTimeTypeMapping _datetime = new("datetime", DbType.DateTime);

    private readonly SqlServerDateTimeTypeMapping _datetime2 = new("datetime2", DbType.DateTime2);

    private readonly SqlServerDateTimeTypeMapping _datetime2Alias =
        new("placeholder", DbType.DateTime2, null, StoreTypePostfix.None);

    private readonly DoubleTypeMapping _double = new SqlServerDoubleTypeMapping("float");

    private readonly DoubleTypeMapping _doubleAlias = new SqlServerDoubleTypeMapping(
        "placeholder",
        storeTypePostfix: StoreTypePostfix.None
    );

    private readonly SqlServerDateTimeOffsetTypeMapping _datetimeoffset = new("datetimeoffset");
    ...
    private readonly GuidTypeMapping _uniqueidentifier = new("uniqueidentifier");

    private readonly DecimalTypeMapping _decimal = new SqlServerDecimalTypeMapping(
        "decimal",
        precision: 18,
        scale: 0
    );

    private readonly DecimalTypeMapping _decimalAlias = new SqlServerDecimalTypeMapping(
        "placeholder",
        precision: 18,
        scale: 2,
        storeTypePostfix: StoreTypePostfix.None
    ...
    private readonly DecimalTypeMapping _decimal182 = new SqlServerDecimalTypeMapping(
        "decimal(18, 2)",
        precision: 18,
        scale: 2
    );

    private readonly DecimalTypeMapping _money = new SqlServerDecimalTypeMapping(
        "money",
        DbType.Currency,
    ...
    private readonly DecimalTypeMapping _smallMoney = new SqlServerDecimalTypeMapping(
        "smallmoney",
        DbType.Currency,
    ...
    private readonly SqlServerJsonTypeMapping _json = new("nvarchar(max)");
    ...
    private RelationalTypeMapping? FindRawMapping(RelationalTypeMappingInfo mappingInfo)
    {
        ...
        if (storeTypeName != null)
        {
            ...
            if (clrType != null && _clrNoFacetTypeMappings.TryGetValue(clrType, out mapping))
            {
                return mapping;
            }
        }
