...
public class SqlServerOptionsExtension : RelationalOptionsExtension, IDbContextOptionsExtension
{
    ...
    // SQL Server 2022 (16.x): compatibility level 160, start date 2022-11-16, mainstream end date
    // 2028-01-11, extended end date 2033-01-11
    // SQL Server 2019 (15.x): compatibility level 150, start date 2019-11-04, mainstream end date
    // 2025-02-28, extended end date 2030-01-08
    // SQL Server 2017 (14.x): compatibility level 140, start date 2017-09-29, mainstream end date
    // 2022-10-11, extended end date 2027-10-12
    // SQL Server 2016 (13.x): compatibility level 130, start date 2016-06-01, mainstream end date
    // 2021-07-13, extended end date 2026-07-14
    // SQL Server 2014 (12.x): compatibility level 120, start date 2014-06-05, mainstream end date
    // 2019-07-09, extended end date 2024-07-09
