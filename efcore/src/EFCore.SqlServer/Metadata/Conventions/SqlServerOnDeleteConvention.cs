        ...
        IEntityTypeAnnotationChangedConvention
{
    ...
    {
        var skipNavigation = skipNavigations.FirstOrDefault(
            s => s.Inverse != null && IsMappedToSameTable(s.DeclaringEntityType, s.TargetEntityType)
        );
    ...
    {
        if (name == RelationalAnnotationNames.TableName || name == RelationalAnnotationNames.Schema)
        {
