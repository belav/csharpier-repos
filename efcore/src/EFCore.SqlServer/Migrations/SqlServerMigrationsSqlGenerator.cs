...
public class SqlServerMigrationsSqlGenerator : MigrationsSqlGenerator
{
    ...
    )
    {
        ...
        {
            var schema =
                operation.Schema ?? model?[RelationalAnnotationNames.DefaultSchema] as string;
            var historyTableSchema =
    ...
    )
    {
        ...
        if (operation[SqlServerAnnotationNames.IsTemporal] as bool? == true)
        {
            ...
            if (operation.Name != periodStartColumnName && operation.Name != periodEndColumnName)
            {
                Generate(
    ...
    )
    {
        ...
        if (name == periodStartColumnName || name == periodEndColumnName)
        {
    ...
    )
    {
        ...
        foreach (var operation in migrationOperations)
        {
            ...
            if (isTemporal)
            {
                ...
                var suppressTransaction =
                    table is not null && IsMemoryOptimized(operation, model, schema, table);
                ...
                switch (operation)
                {
                    ...
                    case AlterTableOperation alterTableOperation:
                        var oldIsTemporal =
                            alterTableOperation.OldTable[SqlServerAnnotationNames.IsTemporal]
                                as bool?
                            == true;
                        if (!oldIsTemporal)
                        {
                        ...
                        else
                        {
                            ...
                            )
                            {
                                ...
                                if (
                                    versioningMap.ContainsKey(
                                        (alterTableOperation.Name, alterTableOperation.Schema)
                                    )
                                )
                                {
                                    versioningMap[
                    ...
                    case AlterColumnOperation alterColumnOperation:
                        ...
                        )
                        {
                            ...
                            if (
                                alterColumnOperation.OldColumn[SqlServerAnnotationNames.IsTemporal]
                                    as bool?
                                == true
                            )
                            {
                                alterColumnOperation
                                    .OldColumn
                                    .RemoveAnnotation(SqlServerAnnotationNames.IsTemporal);
                                alterColumnOperation
                                    .OldColumn
                                    .RemoveAnnotation(
                                        SqlServerAnnotationNames.TemporalPeriodStartColumnName
                                ...
                                {
                                    var alterHistoryTableColumn =
                                        CopyColumnOperation<AlterColumnOperation>(
                                            alterColumnOperation
                                        );
                    ...
                    case DropColumnOperation dropColumnOperation:
                        ...
                        if (
                            dropColumnOperation.Name == periodStartColumnName
                    ...
                    case AddColumnOperation addColumnOperation:
                        ...
                        if (
                            addColumnOperation[SqlServerAnnotationNames.IsTemporal] as bool?
                            == true
                        )
                        {
                            ...
                            if (
                                addColumnOperation.Name != periodStartColumnName
            ...
            {
                if (
                    operation is AlterTableOperation alterTableOperation
                ...
                )
                {
                    ...
                    var suppressTransaction = IsMemoryOptimized(
                        operation,
                        model,
                        alterTableOperation.Schema,
                        alterTableOperation.Name
                    );
                ...
                operations.Add(
                    new SqlOperation
                    {
                        Sql = new StringBuilder()
                            .Append("ALTER TABLE ")
                            .Append(
                                Dependencies.SqlGenerationHelper.DelimitIdentifier(table, schema)
                            )
        ...
        static bool ColumnOperationsOnlyDifferByTemporalTableAnnotation(
            ColumnOperation first,
            ColumnOperation second
        )
        {
            ...
            return unmatched.All(
                a =>
                    a.Name
                        is SqlServerAnnotationNames.IsTemporal
