                    ...
                    @"
{
    ...
    )
    {
        ...
        using (mainBuilder.Indent())
        {
            ...
            {
                mainBuilder.AppendLine().AppendLines(methods);
            }
        }
...
#pragma warning restore CS0618 // Type or member is obsolete
    ...
    )
    {
        ...
        if (valueComparerType == null && property[CoreAnnotationNames.ValueComparer] != null)
        {
            throw new InvalidOperationException(
        ...
        if (
            providerValueComparerType == null
        ...
        if (valueConverterType == null && property.GetValueConverter() != null)
        {
            throw new InvalidOperationException(
        ...
        if (
            property is IConventionProperty conventionProperty
    ...
    )
    {
        ...
        mainBuilder
            ...
            .AppendLine(",")
            .Append(
                "typeof(" + property.ClrType.DisplayName(fullName: true, compilable: true) + ")"
            );
