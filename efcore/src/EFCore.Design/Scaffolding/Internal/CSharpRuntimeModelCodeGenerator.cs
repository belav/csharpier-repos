...
public class CSharpRuntimeModelCodeGenerator : ICompiledModelCodeGenerator
{
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public virtual string Language => "C#";
    ...
    )
    {
        ...
        var modelBuilderFileName =
            options.ContextType.ShortDisplayName() + ModelBuilderSuffix + FileExtension;
        scaffoldedFiles.Add(
            new ScaffoldedFile { Path = modelBuilderFileName, Code = modelBuilderCode }
        );
    ...
    )
    {
        ...
        builder.AppendLine().AppendLine("#pragma warning disable 219, 612, 618");
    ...
    private string CreateModel(string @namespace, Type contextType, bool nullable)
    {
        ...
        mainBuilder
            ...
            .Append(_code.Reference(contextType))
            .AppendLine("))]")
                    ...
                    @"
{
    ...
    )
    {
        ...
        var className = _code.Identifier(contextType.ShortDisplayName()) + ModelSuffix;
        mainBuilder.Append("public partial class ").AppendLine(className).AppendLine("{");
        ...
        using (mainBuilder.Indent())
        {
            ...
            mainBuilder.AppendLine("partial void Initialize()").AppendLine("{");
            using (mainBuilder.Indent())
            {
                ...
                {
                    anyEntityTypes = true;
                    var variableName = _code.Identifier(
    ...
    )
    {
        ...
        mainBuilder
            ...
            .AppendLine(".AddTypeMappingConfiguration(")
            .IncrementIndent()
    ...
    )
    {
        ...
        mainBuilder.Append("internal partial class ").AppendLine(className).AppendLine("{");
        using (mainBuilder.Indent())
        {
            CreateEntityType(
                entityType,
    ...
    )
    {
        ...
        mainBuilder.AppendLine(" baseEntityType = null)").AppendLine("{");
        ...
        using (mainBuilder.Indent())
        {
            ...
            mainBuilder.Append("return ").Append(entityTypeVariable).AppendLine(";");
        }
    ...
    )
    {
        ...
        if (
            (
                ...
                && (
                    (
                        runtimeEntityType?.GetConstructorBindingConfigurationSource()
        ...
        {
            throw new InvalidOperationException(
                DesignStrings.CompiledModelQueryFilter(entityType.ShortName())
            );
        }
...
#pragma warning disable CS0618 // Type or member is obsolete
        if (entityType.GetDefiningQuery() != null)
        {
            ...
            throw new InvalidOperationException(
                DesignStrings.CompiledModelDefiningQuery(entityType.ShortName())
            );
        }
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        {
            mainBuilder.AppendLine(",").Append("propertyBag: ").Append(_code.Literal(true));
        }
        ...
        if (keyCount != 0)
        {
            mainBuilder.AppendLine(",").Append("keyCount: ").Append(_code.Literal(keyCount));
        }

        mainBuilder.AppendLine(");").AppendLine().DecrementIndent();
    }
    ...
    )
    {
        ...
        {
            mainBuilder.AppendLine(",").Append("nullable: ").Append(_code.Literal(true));
        }

        if (property.IsConcurrencyToken)
        {
            mainBuilder.AppendLine(",").Append("concurrencyToken: ").Append(_code.Literal(true));
        }
        ...
        var providerValueComparerType = (Type?)
            property[CoreAnnotationNames.ProviderValueComparerType];
        ...
        if (sentinel != null && converter == null)
        {
            mainBuilder.AppendLine(",").Append("sentinel: ").Append(_code.UnknownLiteral(sentinel));
        }

        var jsonValueReaderWriterType = (Type?)
            property[CoreAnnotationNames.JsonValueReaderWriterType];
        if (jsonValueReaderWriterType != null)
        {
            mainBuilder.AppendLine(",").Append("jsonValueReaderWriter: ");

            CSharpRuntimeAnnotationCodeGenerator.CreateJsonValueReaderWriter(
        ...
        if (sentinel != null && converter != null)
        {
            mainBuilder
                .Append(variableName)
                .Append(".SetSentinelFromProviderValue(")
        ...
        for (; i < ForeignKey.LongestFkChainAllowedLength; i++)
        {
            ...
            foreach (var foreignKey in principalProperty.GetContainingForeignKeys())
            {
                ...
                )
                {
                    ...
                    {
                        var newPrincipalProperty = foreignKey.PrincipalKey.Properties[
                            propertyIndex
                        ];
                        if (
                            newPrincipalProperty == property
                        ...
                        annotation = newPrincipalProperty.FindAnnotation(
    ...
    )
    {
        ...
        if (!skipType)
        {
            ...
            mainBuilder.AppendLine(",").Append(_code.Literal(property.ClrType));
        }
        ...
        if (propertyInfo != null)
        {
            ...
            mainBuilder.AppendLine(",").Append("propertyInfo: ");

            if (property.IsIndexerProperty())
            {
                mainBuilder.Append(parameters.TargetName).Append(".FindIndexerPropertyInfo()");
            }
            else
            {
                mainBuilder
    ...
    )
    {
        ...
        if (index.Name != null)
        {
            mainBuilder.AppendLine(",").Append("name: ").Append(_code.Literal(index.Name));
        }

        if (index.IsUnique)
        {
            mainBuilder.AppendLine(",").Append("unique: ").Append(_code.Literal(true));
        }
    ...
    )
    {
        ...
        using (mainBuilder.Indent())
        {
            ...
            mainBuilder
                ...
                .Append(
                    complexProperty.DeclaringType is IEntityType
                        ? "RuntimeEntityType "
                        : "RuntimeComplexType "
                )
            ...
            using (mainBuilder.Indent())
            {
                ...
                {
                    mainBuilder.AppendLine(",").Append("collection: ").Append(_code.Literal(true));
                }
                ...
                CreateAnnotations(
                    ...
                    parameters with
                    {
                        TargetName = complexPropertyVariable,
                    }
                );

                mainBuilder.Append("return ").Append(complexPropertyVariable).AppendLine(";");
            }
    ...
    )
    {
        ...
        mainBuilder
            .AppendLine()
            .Append("public static RuntimeForeignKey CreateForeignKey")
            .Append(foreignKeyNumber.ToString())
            .Append("(RuntimeEntityType ")
        ...
        using (mainBuilder.Indent())
        {
            ...
            mainBuilder.AppendLine(",").Append(principalEntityType).Append(".FindKey(");
            FindProperties(
                principalEntityType,
            ...
            mainBuilder.AppendLine(",").Append(principalEntityType);
            ...
            {
                mainBuilder.AppendLine(",").Append("required: ").Append(_code.Literal(true));
            }
            ...
            {
                mainBuilder.AppendLine(",").Append("ownership: ").Append(_code.Literal(true));
            }
            ...
            CreateAnnotations(foreignKey, _annotationCodeGenerator.Generate, parameters);

            mainBuilder.Append("return ").Append(foreignKeyVariable).AppendLine(";");
        }
    ...
    {
        var mainBuilder = parameters.MainBuilder;
        var navigationVariable = _code.Identifier(
            navigation.Name,
            parameters.ScopeVariables,
            capitalize: false
        );
        ...
        {
            mainBuilder.AppendLine(",").Append("eagerLoaded: ").Append(_code.Literal(true));
        }

        if (!navigation.LazyLoadingEnabled)
        {
            mainBuilder.AppendLine(",").Append("lazyLoadingEnabled: ").Append(_code.Literal(false));
        }
    ...
    )
    {
        ...
        using (mainBuilder.Indent())
        {
            ...
            using (mainBuilder.Indent())
            {
                ...
                mainBuilder.AppendLine(",").Append(declaringEntityType).Append(".FindKey(");
                FindProperties(
                    declaringEntityType,
                ...
                mainBuilder.AppendLine(",").Append(declaringEntityType).Append(")");
                if (nullable)
                {
                    mainBuilder.Append("!");
                }
            ...
            mainBuilder
                .AppendLine(",")
                .Append(_code.Literal(navigation.IsCollection))
                .AppendLine(",")
                .Append(_code.Literal(navigation.IsOnDependent));

            PropertyBaseParameters(
                navigation,
                parameters with
                {
                    TargetName = declaringEntityType,
            ...
            mainBuilder
                .Append("var inverse = ")
                .Append(targetEntityType)
                .Append(".FindSkipNavigation(")
                .Append(_code.Literal(navigation.Inverse.Name))
                .AppendLine(");")
            ...
            mainBuilder.AppendLine("}").AppendLine();

            CreateAnnotations(navigation, _annotationCodeGenerator.Generate, parameters);

            mainBuilder.Append("return ").Append(navigationVariable).AppendLine(";");
        }
    ...
    {
        var triggerVariable = _code.Identifier(
            trigger.ModelName,
            parameters.ScopeVariables,
            capitalize: false
        );
    ...
    )
    {
        ...
        using (mainBuilder.Indent())
        {
            ...
            mainBuilder.AppendLine().AppendLine("Customize(runtimeEntityType);");
        }
