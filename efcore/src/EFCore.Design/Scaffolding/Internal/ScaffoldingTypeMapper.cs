    ...
    public class ScaffoldingTypeMapper : IScaffoldingTypeMapper
    {
        ...
        )
        {
            ...
            )
            {
                ...
                // Check for Unicode
                var unicodeMapping = _typeMappingSource
                    .FindMapping(
                        unwrappedClrType,
                        null,
                        keyOrIndex,
                ...
                var fixedLengthMapping = _typeMappingSource
                    .FindMapping(
                        unwrappedClrType,
                        null,
                        keyOrIndex,
                ...
                var sizedMapping = _typeMappingSource
                    .FindMapping(
                        unwrappedClrType,
                        null,
                        keyOrIndex,
                ...
                // Check for precision
                var precisionMapping = _typeMappingSource
                    .FindMapping(
                        unwrappedClrType,
                        null,
                        keyOrIndex,
                ...
                // Check for scale
                var scaleMapping = _typeMappingSource
                    .FindMapping(
                        unwrappedClrType,
                        null,
                        keyOrIndex,
