...
///     <see cref="DbContext.OnConfiguring(DbContextOptionsBuilder)" /> or use a <see
// cref="DbContextOptionsBuilder{TContext}" />
///     to create instances of this class and it is not designed to be directly constructed in your
// application code.
/// </summary>
...
{
    /// <summary>
    ///     Initializes a new instance of the <see cref="DbContextOptions{TContext}" /> class. You
    // normally override
    ///     <see cref="DbContext.OnConfiguring(DbContextOptionsBuilder)" /> or use a <see
    // cref="DbContextOptionsBuilder{TContext}" />
    ///     to create instances of this class and it is not designed to be directly constructed in your
