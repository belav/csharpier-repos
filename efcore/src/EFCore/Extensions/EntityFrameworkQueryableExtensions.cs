...
[UnconditionalSuppressMessage(
    "ReflectionAnalysis",
    "IL2060",
    Justification = "MakeGenericMethod is used in this class to create MethodCallExpression nodes, but only if the method in question is called "
...
public static class EntityFrameworkQueryableExtensions
{
    ...
    // direct execution and is intended only
    ...
    ///     </para>
    ///     <para>
    ///         See <see href="https://aka.ms/efcore-docs-query-string">Viewing SQL generated by EF
    ...
    // context.
    ///         See <see href="https://aka.ms/efcore-docs-threading">Avoiding DbContext threading
    // issues</see> for more information and examples.
    ///     </para>
    ///     <para>
    ///         See <see href="https://aka.ms/efcore-docs-async-linq">Querying data with EF Core</see>
    ...
    ///     The task result contains <see langword="true" /> if the source sequence contains any
    ...
    /// </remarks>
    /// <typeparam name="TSource">The type of the elements of <paramref name="source" />.</typeparam>
    /// <param name="source">An <see cref="IQueryable{T}" /> whose elements to test for a
    // condition.</param>
    ...
    /// <returns>
    ///     A task that represents the asynchronous operation.
    ///     The task result contains <see langword="true" /> if any elements in the source sequence pass
    // the test in the specified
    ...
    /// <returns>
    ///     A task that represents the asynchronous operation.
    ///     The task result contains <see langword="true" /> if every element of the source sequence
    // passes the test in the specified
    ///     predicate; otherwise, <see langword="false" />.
    /// </returns>
    /// <exception cref="ArgumentNullException">
    ///     <paramref name="source" /> or <paramref name="predicate" /> is <see langword="null" />.
    ...
    /// </remarks>
    /// <typeparam name="TSource">The type of the elements of <paramref name="source" />.</typeparam>
    /// <param name="source">An <see cref="IQueryable{T}" /> that contains the elements to be
    // counted.</param>
    /// <param name="cancellationToken">A <see cref="CancellationToken" /> to observe while waiting for
    // the task to complete.</param>
    /// <returns>
    ...
    /// <returns>
    ///     A task that represents the asynchronous operation.
    ///     The task result contains the number of elements in the sequence that satisfy the condition
    // in the predicate
    ///     function.
    /// </returns>
    /// <exception cref="ArgumentNullException">
    ...
    /// <summary>
    ///     Asynchronously returns a <see cref="long" /> that represents the total number of elements in
    // a sequence.
    /// </summary>
    /// <remarks>
    ///     <para>
    ...
    /// <returns>
    ///     A task that represents the asynchronous operation.
    ///     The task result contains the element at a specified index in a <paramref name="source" />
    // sequence.
    /// </returns>
    /// <exception cref="ArgumentNullException">
    ...
    /// <summary>
    ///     Asynchronously returns the element at a specified index in a sequence, or a default value if
    ...
    /// <exception cref="ArgumentNullException"><paramref name="source" /> is <see langword="null"
    // />.</exception>
    /// <exception cref="InvalidOperationException"><paramref name="source" /> contains no
    // elements.</exception>
    /// <exception cref="OperationCanceledException">If the <see cref="CancellationToken" /> is
    // canceled.</exception>
    ...
    /// <returns>
    ///     A task that represents the asynchronous operation.
    ///     The task result contains the first element in <paramref name="source" /> that passes the
    // test in
    ...
    ///     is empty or if no element passes the test specified by <paramref name="predicate" />,
    // otherwise, the first
    ///     element in <paramref name="source" /> that passes the test specified by <paramref
    // name="predicate" />.
    /// </returns>
    /// <exception cref="ArgumentNullException">
    ///     <paramref name="source" /> or <paramref name="predicate" /> is <see langword="null" />.
    ...
    /// <returns>
    ///     A task that represents the asynchronous operation.
    ///     The task result contains the last element in <paramref name="source" /> that passes the test
    // in
    ///     <paramref name="predicate" />.
    /// </returns>
    /// <exception cref="ArgumentNullException">
    ...
    /// <summary>
    ///     Asynchronously returns the last element of a sequence, or a default value if the sequence
    // contains no elements.
    /// </summary>
    /// <remarks>
    ///     <para>
    ...
    /// <returns>
    ///     A task that represents the asynchronous operation.
    ///     The task result contains the single element of the input sequence that satisfies the
    // condition in
    ///     <paramref name="predicate" />.
    /// </returns>
    /// <exception cref="ArgumentNullException">
    ...
    /// <returns>
    ///     A task that represents the asynchronous operation.
    ///     The task result contains the single element of the input sequence, or <see
    // langword="default" /> (
    ...
    /// <exception cref="ArgumentNullException"><paramref name="source" /> is <see langword="null"
    // />.</exception>
    /// <exception cref="InvalidOperationException"><paramref name="source" /> contains more than one
    // element.</exception>
    /// <exception cref="OperationCanceledException">If the <see cref="CancellationToken" /> is
    // canceled.</exception>
    ...
    ///     Asynchronously returns the only element of a sequence that satisfies a specified condition
    // or
    ///     a default value if no such element exists; this method throws an exception if more than one
    // element
    ...
    ///     The task result contains the single element of the input sequence that satisfies the
    // condition in
    ///     <paramref name="predicate" />, or <see langword="default" /> ( <typeparamref name="TSource"
    ...
    /// </remarks>
    /// <typeparam name="TSource">The type of the elements of <paramref name="source" />.</typeparam>
    /// <param name="source">An <see cref="IQueryable{T}" /> that contains the elements to determine the
    // minimum of.</param>
    /// <param name="cancellationToken">A <see cref="CancellationToken" /> to observe while waiting for
    // the task to complete.</param>
    /// <returns>
    ...
    /// <summary>
    ///     Asynchronously invokes a projection function on each element of a sequence and returns the
    ...
    public static Task<decimal> SumAsync(
        ...
        ExecuteAsync<decimal, Task<decimal>>(
            QueryableMethods.GetSumWithoutSelector(typeof(decimal)),
            source,
            cancellationToken
        );
    ...
    /// <summary>
    ///     Asynchronously computes the sum of the sequence of values that is obtained by invoking a
    // projection function on
    ...
    )
    {
        ...
        return ExecuteAsync<TSource, Task<decimal>>(
            QueryableMethods.GetSumWithSelector(typeof(decimal)),
            source,
            selector,
            cancellationToken
        );
    ...
    public static Task<int> SumAsync(
        ...
        ExecuteAsync<int, Task<int>>(
            QueryableMethods.GetSumWithoutSelector(typeof(int)),
            source,
            cancellationToken
        );
    ...
    )
    {
        ...
        return ExecuteAsync<TSource, Task<int>>(
            QueryableMethods.GetSumWithSelector(typeof(int)),
            source,
            selector,
            cancellationToken
        );
    ...
    public static Task<long> SumAsync(
        ...
        ExecuteAsync<long, Task<long>>(
            QueryableMethods.GetSumWithoutSelector(typeof(long)),
            source,
            cancellationToken
        );
    ...
    )
    {
        ...
        return ExecuteAsync<TSource, Task<long>>(
            QueryableMethods.GetSumWithSelector(typeof(long)),
            source,
            selector,
            cancellationToken
        );
    ...
    public static Task<double> SumAsync(
        ...
        ExecuteAsync<double, Task<double>>(
            QueryableMethods.GetSumWithoutSelector(typeof(double)),
            source,
            cancellationToken
        );
    ...
    )
    {
        ...
        return ExecuteAsync<TSource, Task<double>>(
            QueryableMethods.GetSumWithSelector(typeof(double)),
            source,
            selector,
            cancellationToken
        );
    ...
    public static Task<float> SumAsync(
        ...
        ExecuteAsync<float, Task<float>>(
            QueryableMethods.GetSumWithoutSelector(typeof(float)),
            source,
            cancellationToken
        );
    ...
    )
    {
        ...
        return ExecuteAsync<TSource, Task<float>>(
            QueryableMethods.GetSumWithSelector(typeof(float)),
            source,
            selector,
            cancellationToken
        );
    ...
    public static Task<decimal> AverageAsync(
        ...
        ExecuteAsync<decimal, Task<decimal>>(
            QueryableMethods.GetAverageWithoutSelector(typeof(decimal)),
            source,
            cancellationToken
        );
    ...
    )
    {
        ...
        return ExecuteAsync<TSource, Task<decimal>>(
            QueryableMethods.GetAverageWithSelector(typeof(decimal)),
            source,
            selector,
            cancellationToken
        );
    ...
    public static Task<double> AverageAsync(
        ...
        ExecuteAsync<int, Task<double>>(
            QueryableMethods.GetAverageWithoutSelector(typeof(int)),
            source,
            cancellationToken
        );
    ...
    )
    {
        ...
        return ExecuteAsync<TSource, Task<double>>(
            QueryableMethods.GetAverageWithSelector(typeof(int)),
            source,
            selector,
            cancellationToken
        );
    ...
    public static Task<double> AverageAsync(
        ...
        ExecuteAsync<long, Task<double>>(
            QueryableMethods.GetAverageWithoutSelector(typeof(long)),
            source,
            cancellationToken
        );
    ...
    )
    {
        ...
        return ExecuteAsync<TSource, Task<double>>(
            QueryableMethods.GetAverageWithSelector(typeof(long)),
            source,
            selector,
            cancellationToken
        );
    ...
    public static Task<double> AverageAsync(
        ...
        ExecuteAsync<double, Task<double>>(
            QueryableMethods.GetAverageWithoutSelector(typeof(double)),
            source,
            cancellationToken
        );
    ...
    )
    {
        ...
        return ExecuteAsync<TSource, Task<double>>(
            QueryableMethods.GetAverageWithSelector(typeof(double)),
            source,
            selector,
            cancellationToken
        );
    ...
    public static Task<float> AverageAsync(
        ...
        ExecuteAsync<float, Task<float>>(
            QueryableMethods.GetAverageWithoutSelector(typeof(float)),
            source,
            cancellationToken
        );
    ...
    )
    {
        ...
        return ExecuteAsync<TSource, Task<float>>(
            QueryableMethods.GetAverageWithSelector(typeof(float)),
            source,
            selector,
            cancellationToken
        );
    ...
    /// <summary>
    ///     Asynchronously determines whether a sequence contains a specified element by using the
    ...
    /// <returns>
    ///     A task that represents the asynchronous operation.
    ///     The task result contains <see langword="true" /> if the input sequence contains the
    ...
    /// <summary>
    ///     Asynchronously creates a <see cref="List{T}" /> from an <see cref="IQueryable{T}" /> by
    // enumerating it
    ///     asynchronously.
    /// </summary>
    /// <remarks>
    ...
    /// <returns>
    ///     A task that represents the asynchronous operation.
    ///     The task result contains a <see cref="List{T}" /> that contains elements from the input
    // sequence.
    /// </returns>
    /// <exception cref="ArgumentNullException"><paramref name="source" /> is <see langword="null"
    // />.</exception>
    ...
    /// <summary>
    ///     Specifies related entities to include in the query results. The navigation property to be
    // included is specified starting with the
    ///     type of entity being queried (<typeparamref name="TEntity" />). If you wish to include
    // additional types based on the navigation
    ///     properties of the type being included, then chain a call to
    ///     <see
    ///         cref="ThenInclude{TEntity, TPreviousProperty, TProperty}(IIncludableQueryable{TEntity,
    // IEnumerable{TPreviousProperty}}, Expression{Func{TPreviousProperty, TProperty}})" />
    ///     after this call.
    /// </summary>
    /// <remarks>
    ///     See <see href="https://aka.ms/efcore-docs-load-related-data">Loading related entities</see>
    ...
    ///     A lambda expression representing the navigation property to be included (<c>t =>
    // t.Property1</c>).
    /// </param>
    /// <returns>A new query with the related data included.</returns>
    /// <exception cref="ArgumentNullException">
    ///     <paramref name="source" /> or <paramref name="navigationPropertyPath" /> is <see
    // langword="null" />.
    /// </exception>
    ...
    /// <summary>
    ///     Specifies additional related data to be further included based on a related type that was
    // just included.
    /// </summary>
    /// <remarks>
    ///     See <see href="https://aka.ms/efcore-docs-load-related-data">Loading related entities</see>
    ...
    /// </param>
    /// <returns>A new query with the related data included.</returns>
    public static IIncludableQueryable<TEntity, TProperty> ThenInclude<
        TEntity,
        TPreviousProperty,
        TProperty
    >(
    ...
    /// <typeparam name="TEntity">The type of entity being queried.</typeparam>
    /// <param name="source">The source query.</param>
    /// <param name="navigationPropertyPath">A string of '.' separated navigation property names to be
    // included.</param>
    /// <returns>A new query with the related data included.</returns>
    /// <exception cref="ArgumentNullException">
    ///     <paramref name="source" /> or <paramref name="navigationPropertyPath" /> is <see
    // langword="null" />.
    /// </exception>
    /// <exception cref="ArgumentException"><paramref name="navigationPropertyPath" /> is empty or
    ...
    internal static readonly MethodInfo IgnoreAutoIncludesMethodInfo =
        typeof(EntityFrameworkQueryableExtensions)
            .GetTypeInfo()
            .GetDeclaredMethod(nameof(IgnoreAutoIncludes))!;

    /// <summary>
    ///     Specifies that the current Entity Framework LINQ query should not have any model-level eager
    // loaded navigations applied.
    /// </summary>
    /// <remarks>
    ///     See <see href="https://aka.ms/efcore-docs-load-related-data">Loading related entities</see>
    // for more information and examples.
    ...
    internal static readonly MethodInfo IgnoreQueryFiltersMethodInfo =
        typeof(EntityFrameworkQueryableExtensions)
            .GetTypeInfo()
            .GetDeclaredMethod(nameof(IgnoreQueryFilters))!;
    ...
    /// </summary>
    /// <remarks>
    ///     See <see href="https://aka.ms/efcore-docs-query-filters">EF Core query filters</see> for
    ...
    internal static readonly MethodInfo AsNoTrackingMethodInfo =
        typeof(EntityFrameworkQueryableExtensions)
            .GetTypeInfo()
            .GetDeclaredMethod(nameof(AsNoTracking))!;
    ...
    /// <remarks>
    ///     <para>
    ///         Disabling change tracking is useful for read-only scenarios because it avoids the
    // overhead of setting
    ///         up change tracking for each entity instance. You should not disable change tracking if
    // you want to
    ///         manipulate entity instances and persist those changes to the database using
    ///         <see cref="DbContext.SaveChanges()" />.
    ///     </para>
    ///     <para>
    ///         Identity resolution will not be performed. If an entity with a given key is in different
    // result in the result set
    ///         then they will be different instances.
    ///     </para>
    ///     <para>
    ///         The default tracking behavior for queries can be controlled by <see
    // cref="ChangeTracker.QueryTrackingBehavior" />.
    ///     </para>
    ///     <para>
    ///         See <see href="https://aka.ms/efcore-docs-query-tracking">No-tracking queries in EF
    // Core</see> for more information and examples.
    ///     </para>
    /// </remarks>
    /// <typeparam name="TEntity">The type of entity being queried.</typeparam>
    ...
    internal static readonly MethodInfo AsNoTrackingWithIdentityResolutionMethodInfo =
        typeof(EntityFrameworkQueryableExtensions)
            .GetTypeInfo()
            .GetDeclaredMethod(nameof(AsNoTrackingWithIdentityResolution))!;
    ...
    ///     </para>
    ///     <para>
    ///         Identity resolution will be performed to ensure that all occurrences of an entity with a
    // given key
    ...
    /// <summary>
    ///     Returns a new query where the change tracker will keep track of changes for all entities
    // that are returned.
    ///     Any modification to the entity instances will be detected and persisted to the database
    // during
    ///     <see cref="DbContext.SaveChanges()" />.
    /// </summary>
    /// <remarks>
    ...
    ///     </para>
    ///     <para>
    ///         See <see href="https://aka.ms/efcore-docs-query-tracking">Tracking queries in EF
    // Core</see> for more information and examples.
    ///     </para>
    /// </remarks>
    /// <typeparam name="TEntity">The type of entity being queried.</typeparam>
    ...
    /// <summary>
    ///     Returns a new query where the change tracker will either keep track of changes or not for
    // all entities
    ///     that are returned, depending on the value of the 'track' parameter. When tracking, Any
    // modification
    ///     to the entity instances will be detected and persisted to the database during
    ///     <see cref="DbContext.SaveChanges()" />. When not tracking, if the entity instances are
    // modified, this will
    ///     not be detected by the change tracker and <see cref="DbContext.SaveChanges()" /> will not
    // persist those
    ...
    /// <summary>
    ///     Adds a tag to the collection of tags associated with an EF LINQ query. Tags are query
    // annotations
    ///     that can provide contextual tracing information at different points in the query pipeline.
    /// </summary>
    /// <remarks>
    ///     See <see href="https://aka.ms/efcore-docs-query-tags">Tagging queries in EF Core</see> for
    // more information and examples.
    /// </remarks>
    ...
    /// <summary>
    ///     Adds a tag to the collection of tags associated with an EF LINQ query with source file name
    // and line
    ///     where method was called that can provide contextual tracing information at different points
    ...
    /// </summary>
    /// <remarks>
    ///     See <see href="https://aka.ms/efcore-docs-query">LINQ queries in EF Core</see> for more
    ...
    /// <summary>
    ///     Asynchronously enumerates the query. When using Entity Framework, this causes the results of
    // the query to
    ///     be loaded into the associated context. This is equivalent to calling ToList
    ///     and then throwing away the list (without the overhead of actually creating the list).
    /// </summary>
    ...
    /// <summary>
    ///     Creates a <see cref="Dictionary{TKey, TValue}" /> from an <see cref="IQueryable{T}" /> by
    // enumerating it
    ///     asynchronously
    ...
    /// </remarks>
    /// <typeparam name="TSource">The type of the elements of <paramref name="source" />.</typeparam>
    /// <typeparam name="TKey">The type of the key returned by <paramref name="keySelector"
    // />.</typeparam>
    /// <param name="source">An <see cref="IQueryable{T}" /> to create a <see cref="Dictionary{TKey,
    // TValue}" /> from.</param>
    ...
    /// <returns>
    ///     A task that represents the asynchronous operation.
    ///     The task result contains a <see cref="Dictionary{TKey, TSource}" /> that contains selected
    // keys and values.
    /// </returns>
    /// <exception cref="ArgumentNullException">
    ...
    /// <typeparam name="TKey">The type of the key returned by <paramref name="keySelector"
    // />.</typeparam>
    /// <typeparam name="TElement">The type of the value returned by <paramref name="elementSelector"
    // />.</typeparam>
    /// <param name="source">An <see cref="IQueryable{T}" /> to create a <see cref="Dictionary{TKey,
    // TValue}" /> from.</param>
    /// <param name="keySelector">A function to extract a key from each element.</param>
    ...
    /// <returns>
    ///     A task that represents the asynchronous operation.
    ///     The task result contains a <see cref="Dictionary{TKey, TElement}" /> that contains values of
    // type
    ///     <typeparamref name="TElement" /> selected from the input sequence.
    /// </returns>
    /// <exception cref="ArgumentNullException">
    ///     <paramref name="source" /> or <paramref name="keySelector" /> or <paramref
    ...
    /// <summary>
    ///     Asynchronously enumerates the query results and performs the specified action on each
    // element.
    /// </summary>
    /// <remarks>
    ///     <para>
    ...
    /// <exception cref="InvalidOperationException"><paramref name="source" /> is <see langword="null"
    // />.</exception>
    /// <exception cref="ArgumentNullException"><paramref name="source" /> is not a <see
