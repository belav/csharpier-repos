...
/// <summary>
///     Provides a simple API surface for configuring a <see cref="IMutableModel" /> that defines
// the shape of your
...
///         <see cref="DbContext.OnModelCreating(ModelBuilder)" /> on your derived context.
// Alternatively you can create the
///         model externally and set it on a <see cref="DbContextOptions" /> instance that is passed
// to the context constructor.
///     </para>
///     <para>
///         See <see href="https://aka.ms/efcore-docs-modeling">Modeling entity types and
// relationships in EF Core</see> for more information
///         and examples.
///     </para>
/// </remarks>
public class ModelBuilder : IInfrastructure<IConventionModelBuilder>
{
    ...
    ///     <see href="https://aka.ms/efcore-docs-conventions">EF Core model-building conventions</see>
    ...
    /// </summary>
    /// <remarks>
    ///     See <see href="https://aka.ms/efcore-docs-modeling">Modeling entity types and relationships
    ...
    /// <returns>The same <see cref="ModelBuilder" /> instance so that multiple configuration calls can
    // be chained.</returns>
    ...
    /// </summary>
    /// <remarks>
    ///     This property is intended for use by extension methods to configure the model. It is not
    ...
    /// </summary>
    /// <remarks>
    ///     See <see href="https://aka.ms/efcore-docs-modeling">Modeling entity types</see> for more
    ...
    /// <summary>
    ///     Returns an object that can be used to configure a given shared type entity type in the
    // model.
    /// </summary>
    /// <remarks>
    ///     <para>
    ///         If an entity type with the provided name is not already part of the model, a new entity
    // type with provided CLR
    ///         type will be added to the model as shared type entity type.
    ///     </para>
    ///     <para>
    ///         Shared type entity type is an entity type which can share CLR type with other types in
    // the model but has
    ...
    ///         <see href="https://aka.ms/efcore-docs-shared-types">Shared entity types</see> for more
    // information and examples.
    ///     </para>
    /// </remarks>
        ...
        where TEntity : class
    {
        ...
        return new EntityTypeBuilder<TEntity>(
            Builder.SharedTypeEntity(name, typeof(TEntity), ConfigurationSource.Explicit)!.Metadata
        );
    }
    ...
    )
    {
        ...
        return new EntityTypeBuilder(
            Builder
                .SharedTypeEntity(name, type, ConfigurationSource.Explicit, shouldBeOwned: false)!
                .Metadata
        );
    }

    /// <summary>
    ///     Performs configuration of a given entity type in the model. If the entity type is not
    // already part
    ///     of the model, it will be added to the model.
    /// </summary>
    /// <remarks>
    ///     <para>
    ///         This overload allows configuration of the entity type to be done in line in the method
    // call rather
    ///         than being chained after a call to <see cref="Entity{TEntity}()" />. This allows
    // additional
    ...
    /// <returns>
    ///     The same <see cref="ModelBuilder" /> instance so that additional configuration calls can be
    // chained.
    /// </returns>
    ...
    ///     </para>
    ///     <para>
    ///         This overload allows configuration of the entity type to be done inline in the method
    // call rather
    ///         than being chained after a call to <see cref="Entity{TEntity}()" />. This allows
    // additional
    ///         configuration at the model level to be chained after configuration for the entity type.
    ...
    /// <summary>
    ///     Excludes the given entity type from the model. This method is typically used to remove types
    // from
    ...
    /// <summary>
    ///     Excludes an entity type with given CLR type from the model. This method is typically used to
    // remove types from
    ///     the model that were added by convention.
    /// </summary>
    /// <remarks>
    ...
    /// <summary>
    ///     Excludes an entity type with the given name from the model. This method is typically used to
    // remove types from
    ///     the model that were added by convention.
    /// </summary>
    /// <remarks>
    ...
    /// <summary>
    ///     Applies configuration that is defined in an <see cref="IEntityTypeConfiguration{TEntity}" />
    // instance.
    /// </summary>
    /// <remarks>
    ///     See <see href="https://aka.ms/efcore-docs-modeling">Modeling entity types and
    ...
    )
    {
        ...
        {
            // Only accept types that contain a parameterless constructor, are not abstract and satisfy a
            // predicate if it was used.
    ...
    /// </summary>
    /// <remarks>
    ///     See <see href="https://aka.ms/efcore-docs-owned">Owned types in EF Core</see> for more
    // information and examples.
    /// </remarks>
    ...
    /// </remarks>
    /// <param name="type">The entity type to be configured.</param>
    public virtual OwnedEntityTypeBuilder Owned(
        [DynamicallyAccessedMembers(IEntityType.DynamicallyAccessedMemberTypes)] Type type
    )
    {
        Check.NotNull(type, nameof(type));
    ...
    ///     This strategy indicates how the context detects changes to properties for an instance of an
    // entity type.
    /// </summary>
    /// <remarks>
    ///     See <see href="https://aka.ms/efcore-docs-change-detection">Change detection and
    // notifications</see> for more information and examples.
    /// </remarks>
    ...
    // behavior
    ///         for all properties in the model as described in the <see cref="PropertyAccessMode" />
    // enum.
    ///     </para>
    ///     <para>
    ///         See <see href="https://aka.ms/efcore-docs-property-access">Property versus field access
    // in EF Core</see> for more information and
    ///         examples.
    ///     </para>
    /// </remarks>
