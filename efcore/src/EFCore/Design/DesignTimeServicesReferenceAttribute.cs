...
///     </para>
///     <para>
///         This attribute is typically used by design-time extensions. It is generally not used in
// application code.
///     </para>
/// </summary>
/// <remarks>
...
public sealed class DesignTimeServicesReferenceAttribute : Attribute
{
    ...
    /// </summary>
    /// <param name="typeName">
    ///     The assembly-qualified name of the type that can be used to add additional design time
    // services to a <see cref="ServiceCollection" />.
    ...
    ///     The name of the provider for which these services should be added. If null, the services
    // will be added
    ///     for all providers.
    /// </param>
    ...
    /// <summary>
    ///     Gets the assembly-qualified name of the type that can be used to add additional design time
    // services to a
    ...
    /// <summary>
    ///     Gets the name of the provider for which these services should be added. If null, the
    // services will be
