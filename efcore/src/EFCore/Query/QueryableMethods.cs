...
public static class QueryableMethods
{
    ...
    static QueryableMethods()
    {
        ...
        All = GetMethod(nameof(Queryable.All), 1, types =>
            new[]
            {
        ...
        AnyWithoutPredicate = GetMethod(nameof(Queryable.Any), 1, types =>
            new[] { typeof(IQueryable<>).MakeGenericType(types[0]) }
        );

        AnyWithPredicate = GetMethod(nameof(Queryable.Any), 1, types =>
            new[]
            {
                typeof(IQueryable<>).MakeGenericType(types[0]),
                typeof(Expression<>).MakeGenericType(
        ...
        AsQueryable = GetMethod(nameof(Queryable.AsQueryable), 1, types =>
            new[] { typeof(IEnumerable<>).MakeGenericType(types[0]) }
        );

        Cast = GetMethod(nameof(Queryable.Cast), 1, types => new[] { typeof(IQueryable) });

        Concat = GetMethod(nameof(Queryable.Concat), 1, types =>
            new[]
            {
                typeof(IQueryable<>).MakeGenericType(types[0]),
        ...
        Contains = GetMethod(nameof(Queryable.Contains), 1, types =>
            new[] { typeof(IQueryable<>).MakeGenericType(types[0]), types[0] }
        );

        CountWithoutPredicate = GetMethod(nameof(Queryable.Count), 1, types =>
            new[] { typeof(IQueryable<>).MakeGenericType(types[0]) }
        );

        CountWithPredicate = GetMethod(nameof(Queryable.Count), 1, types =>
            new[]
            {
                typeof(IQueryable<>).MakeGenericType(types[0]),
                typeof(Expression<>).MakeGenericType(
        ...
        DefaultIfEmptyWithoutArgument = GetMethod(nameof(Queryable.DefaultIfEmpty), 1, types =>
            new[] { typeof(IQueryable<>).MakeGenericType(types[0]) }
        );

        DefaultIfEmptyWithArgument = GetMethod(nameof(Queryable.DefaultIfEmpty), 1, types =>
            new[] { typeof(IQueryable<>).MakeGenericType(types[0]), types[0] }
        );

        Distinct = GetMethod(nameof(Queryable.Distinct), 1, types =>
            new[] { typeof(IQueryable<>).MakeGenericType(types[0]) }
        );

        ElementAt = GetMethod(nameof(Queryable.ElementAt), 1, types =>
            new[] { typeof(IQueryable<>).MakeGenericType(types[0]), typeof(int) }
        );

        ElementAtOrDefault = GetMethod(nameof(Queryable.ElementAtOrDefault), 1, types =>
            new[] { typeof(IQueryable<>).MakeGenericType(types[0]), typeof(int) }
        );

        Except = GetMethod(nameof(Queryable.Except), 1, types =>
            new[]
            {
                typeof(IQueryable<>).MakeGenericType(types[0]),
                typeof(IEnumerable<>).MakeGenericType(types[0]),
        ...
        FirstWithoutPredicate = GetMethod(nameof(Queryable.First), 1, types =>
            new[] { typeof(IQueryable<>).MakeGenericType(types[0]) }
        );

        FirstWithPredicate = GetMethod(nameof(Queryable.First), 1, types =>
            new[]
            {
                typeof(IQueryable<>).MakeGenericType(types[0]),
                typeof(Expression<>).MakeGenericType(
        ...
        FirstOrDefaultWithoutPredicate = GetMethod(nameof(Queryable.FirstOrDefault), 1, types =>
            new[] { typeof(IQueryable<>).MakeGenericType(types[0]) }
        );

        FirstOrDefaultWithPredicate = GetMethod(nameof(Queryable.FirstOrDefault), 1, types =>
            new[]
            {
                typeof(IQueryable<>).MakeGenericType(types[0]),
                typeof(Expression<>).MakeGenericType(
        ...
        GroupByWithKeySelector = GetMethod(nameof(Queryable.GroupBy), 2, types =>
            new[]
            {
                typeof(IQueryable<>).MakeGenericType(types[0]),
                typeof(Expression<>).MakeGenericType(
        ...
        GroupByWithKeyElementSelector = GetMethod(nameof(Queryable.GroupBy), 3, types =>
            new[]
            {
                typeof(IQueryable<>).MakeGenericType(types[0]),
                typeof(Expression<>).MakeGenericType(
        ...
        GroupByWithKeyElementResultSelector = GetMethod(nameof(Queryable.GroupBy), 4, types =>
            new[]
            {
                typeof(IQueryable<>).MakeGenericType(types[0]),
                typeof(Expression<>).MakeGenericType(
        ...
        GroupByWithKeyResultSelector = GetMethod(nameof(Queryable.GroupBy), 3, types =>
            new[]
            {
                typeof(IQueryable<>).MakeGenericType(types[0]),
                typeof(Expression<>).MakeGenericType(
        ...
        GroupJoin = GetMethod(nameof(Queryable.GroupJoin), 4, types =>
            new[]
            {
                typeof(IQueryable<>).MakeGenericType(types[0]),
        ...
        Intersect = GetMethod(nameof(Queryable.Intersect), 1, types =>
            new[]
            {
                typeof(IQueryable<>).MakeGenericType(types[0]),
                typeof(IEnumerable<>).MakeGenericType(types[0]),
        ...
        Join = GetMethod(nameof(Queryable.Join), 4, types =>
            new[]
            {
                typeof(IQueryable<>).MakeGenericType(types[0]),
                typeof(IEnumerable<>).MakeGenericType(types[1]),
        ...
        LastWithoutPredicate = GetMethod(nameof(Queryable.Last), 1, types =>
            new[] { typeof(IQueryable<>).MakeGenericType(types[0]) }
        );

        LastWithPredicate = GetMethod(nameof(Queryable.Last), 1, types =>
            new[]
            {
                typeof(IQueryable<>).MakeGenericType(types[0]),
                typeof(Expression<>).MakeGenericType(
        ...
        LastOrDefaultWithoutPredicate = GetMethod(nameof(Queryable.LastOrDefault), 1, types =>
            new[] { typeof(IQueryable<>).MakeGenericType(types[0]) }
        );

        LastOrDefaultWithPredicate = GetMethod(nameof(Queryable.LastOrDefault), 1, types =>
            new[]
            {
                typeof(IQueryable<>).MakeGenericType(types[0]),
                typeof(Expression<>).MakeGenericType(
        ...
        LongCountWithoutPredicate = GetMethod(nameof(Queryable.LongCount), 1, types =>
            new[] { typeof(IQueryable<>).MakeGenericType(types[0]) }
        );

        LongCountWithPredicate = GetMethod(nameof(Queryable.LongCount), 1, types =>
            new[]
            {
                typeof(IQueryable<>).MakeGenericType(types[0]),
                typeof(Expression<>).MakeGenericType(
        ...
        MaxWithoutSelector = GetMethod(nameof(Queryable.Max), 1, types =>
            new[] { typeof(IQueryable<>).MakeGenericType(types[0]) }
        );

        MaxWithSelector = GetMethod(nameof(Queryable.Max), 2, types =>
            new[]
            {
                typeof(IQueryable<>).MakeGenericType(types[0]),
                typeof(Expression<>).MakeGenericType(
        ...
        MinWithoutSelector = GetMethod(nameof(Queryable.Min), 1, types =>
            new[] { typeof(IQueryable<>).MakeGenericType(types[0]) }
        );

        MinWithSelector = GetMethod(nameof(Queryable.Min), 2, types =>
            new[]
            {
                typeof(IQueryable<>).MakeGenericType(types[0]),
                typeof(Expression<>).MakeGenericType(
        ...
        OrderBy = GetMethod(nameof(Queryable.OrderBy), 2, types =>
            new[]
            {
                typeof(IQueryable<>).MakeGenericType(types[0]),
                typeof(Expression<>).MakeGenericType(
        ...
        OrderByDescending = GetMethod(nameof(Queryable.OrderByDescending), 2, types =>
            new[]
            {
                typeof(IQueryable<>).MakeGenericType(types[0]),
                typeof(Expression<>).MakeGenericType(
        ...
        Reverse = GetMethod(nameof(Queryable.Reverse), 1, types =>
            new[] { typeof(IQueryable<>).MakeGenericType(types[0]) }
        );

        Select = GetMethod(nameof(Queryable.Select), 2, types =>
            new[]
            {
                typeof(IQueryable<>).MakeGenericType(types[0]),
                typeof(Expression<>).MakeGenericType(
        ...
        SelectManyWithoutCollectionSelector = GetMethod(nameof(Queryable.SelectMany), 2, types =>
            new[]
            {
                typeof(IQueryable<>).MakeGenericType(types[0]),
                typeof(Expression<>).MakeGenericType(
        ...
        SelectManyWithCollectionSelector = GetMethod(nameof(Queryable.SelectMany), 3, types =>
            new[]
            {
                typeof(IQueryable<>).MakeGenericType(types[0]),
                typeof(Expression<>).MakeGenericType(
        ...
        SingleWithoutPredicate = GetMethod(nameof(Queryable.Single), 1, types =>
            new[] { typeof(IQueryable<>).MakeGenericType(types[0]) }
        );

        SingleWithPredicate = GetMethod(nameof(Queryable.Single), 1, types =>
            new[]
            {
                typeof(IQueryable<>).MakeGenericType(types[0]),
                typeof(Expression<>).MakeGenericType(
        ...
        SingleOrDefaultWithoutPredicate = GetMethod(nameof(Queryable.SingleOrDefault), 1, types =>
            new[] { typeof(IQueryable<>).MakeGenericType(types[0]) }
        );

        SingleOrDefaultWithPredicate = GetMethod(nameof(Queryable.SingleOrDefault), 1, types =>
            new[]
            {
                typeof(IQueryable<>).MakeGenericType(types[0]),
                typeof(Expression<>).MakeGenericType(
        ...
        Skip = GetMethod(nameof(Queryable.Skip), 1, types =>
            new[] { typeof(IQueryable<>).MakeGenericType(types[0]), typeof(int) }
        );

        SkipWhile = GetMethod(nameof(Queryable.SkipWhile), 1, types =>
            new[]
            {
                typeof(IQueryable<>).MakeGenericType(types[0]),
                typeof(Expression<>).MakeGenericType(
        ...
        Take = GetMethod(nameof(Queryable.Take), 1, types =>
            new[] { typeof(IQueryable<>).MakeGenericType(types[0]), typeof(int) }
        );

        TakeWhile = GetMethod(nameof(Queryable.TakeWhile), 1, types =>
            new[]
            {
                typeof(IQueryable<>).MakeGenericType(types[0]),
                typeof(Expression<>).MakeGenericType(
        ...
        ThenBy = GetMethod(nameof(Queryable.ThenBy), 2, types =>
            new[]
            {
        ...
        ThenByDescending = GetMethod(nameof(Queryable.ThenByDescending), 2, types =>
            new[]
            {
                typeof(IOrderedQueryable<>).MakeGenericType(types[0]),
                typeof(Expression<>).MakeGenericType(
        ...
        Union = GetMethod(nameof(Queryable.Union), 1, types =>
            new[]
            {
                typeof(IQueryable<>).MakeGenericType(types[0]),
                typeof(IEnumerable<>).MakeGenericType(types[0]),
        ...
        Where = GetMethod(nameof(Queryable.Where), 1, types =>
            new[]
            {
                typeof(IQueryable<>).MakeGenericType(types[0]),
                typeof(Expression<>).MakeGenericType(
        ...
        {
            AverageWithoutSelectorMethods[type] = GetMethod(nameof(Queryable.Average), 0, types =>
                new[] { typeof(IQueryable<>).MakeGenericType(type) }
            );
            AverageWithSelectorMethods[type] = GetMethod(nameof(Queryable.Average), 1, types =>
                new[]
                {
                    typeof(IQueryable<>).MakeGenericType(types[0]),
                    typeof(Expression<>).MakeGenericType(
            ...
            SumWithoutSelectorMethods[type] = GetMethod(nameof(Queryable.Sum), 0, types =>
                new[] { typeof(IQueryable<>).MakeGenericType(type) }
            );
            SumWithSelectorMethods[type] = GetMethod(nameof(Queryable.Sum), 1, types =>
                new[]
                {
                    typeof(IQueryable<>).MakeGenericType(types[0]),
                    typeof(Expression<>).MakeGenericType(
