...
/// </remarks>
[DebuggerDisplay(
    "{Microsoft.EntityFrameworkCore.Query.ExpressionPrinter.Print(QueryExpression), nq}"
)]
public class ShapedQueryExpression : Expression, IPrintableExpression
{
    /// <summary>
    ///     Creates a new instance of the <see cref="ShapedQueryExpression" /> class with associated
    // query and shaper expressions.
    /// </summary>
    /// <param name="queryExpression">The query expression to get results from server.</param>
    /// <param name="shaperExpression">The shaper expression to create result objects from server
    // results.</param>
    ...
    /// <param name="shaperExpression">The <see cref="ShaperExpression" /> property of the
    // result.</param>
    ...
    /// <summary>
    ///     Creates a new expression that is like this one, but using the supplied query expression. If
    // query expression is the same, it will
    ///     return this expression.
    /// </summary>
    /// <param name="queryExpression">The <see cref="QueryExpression" /> property of the result.</param>
    /// <returns>This expression if shaper expression did not change, or an expression with the updated
    // shaper expression.</returns>
    ...
    /// <summary>
    ///     Creates a new expression that is like this one, but using the supplied shaper expression. If
    // shaper expression is the same, it will
    ///     return this expression.
    /// </summary>
    /// <param name="shaperExpression">The <see cref="ShaperExpression" /> property of the
    // result.</param>
    ...
    /// </summary>
    /// <param name="resultCardinality">The <see cref="ResultCardinality" /> property of the
    // result.</param>
