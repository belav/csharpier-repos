...
namespace Microsoft.EntityFrameworkCore.Query.Internal
{
    ...
    {
        private static readonly List<MethodInfo> _singleResultMethodInfos =
            new()
            {
        ...
        protected override Expression VisitBinary(BinaryExpression binaryExpression)
        {
            ...
            )
            {
                ...
                if (leftNullConstant || rightNullConstant)
                {
                    ...
                    if (
                        nonNullExpression is MethodCallExpression methodCallExpression
                        && methodCallExpression.Method.DeclaringType == typeof(Queryable)
                        && methodCallExpression.Method.IsGenericMethod
                        && methodCallExpression.Method.GetGenericMethodDefinition()
                            is MethodInfo genericMethod
        ...
        protected override Expression VisitMethodCall(MethodCallExpression methodCallExpression)
        {
            ...
            if (
                ...
                && visited.Method.DeclaringType?.Namespace
        ...
        private Expression? TryOptimizeMemberAccessOverConditional(Expression expression)
        {
            ...
            )
            {
                ...
                )
                {
                    ...
                    nonNullExpression =
                        TryOptimizeMemberAccessOverConditional(nonNullExpression)
                        ?? nonNullExpression;
