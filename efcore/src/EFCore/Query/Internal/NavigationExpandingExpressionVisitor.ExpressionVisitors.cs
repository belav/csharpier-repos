    ...
    public partial class NavigationExpandingExpressionVisitor
    {
        ...
        private class ExpandingExpressionVisitor : ExpressionVisitor
        {
            ...
            )
            {
                ...
                var transparentIdentifierOuterMemberInfo = resultType.GetTypeInfo()
                    .GetRequiredDeclaredField("Outer");
                var transparentIdentifierInnerMemberInfo = resultType.GetTypeInfo()
                        ...
                        )
                        {
                            ...
                            if (filterExpression == null)
                            {
                                ...
                                subquery = joinMethodCallExpression.Update(
                                    // TODO-Nullable bug
                                    null!,
                                    joinMethodCallExpression.Arguments.Take(4)
