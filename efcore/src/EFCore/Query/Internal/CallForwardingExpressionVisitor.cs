...
{
    private static readonly IReadOnlyDictionary<MethodInfo, MethodInfo> _forwardedMethods =
        new Dictionary<MethodInfo, MethodInfo>
        {
            {
                typeof(byte).GetRuntimeMethod(
                    nameof(byte.Clamp),
            ...
            {
                typeof(decimal).GetRuntimeMethod(
            ...
            },
            {
                typeof(decimal).GetRuntimeMethod(
                    nameof(decimal.Round),
                    new[] { typeof(decimal), typeof(int), typeof(MidpointRounding) }
                )!,
                typeof(Math).GetRuntimeMethod(
                    nameof(Math.Round),
                    new[] { typeof(decimal), typeof(int), typeof(MidpointRounding) }
            ...
            {
                typeof(double).GetRuntimeMethod(
                    nameof(double.FusedMultiplyAdd),
                    new[] { typeof(double), typeof(double), typeof(double) }
                )!,
                typeof(Math).GetRuntimeMethod(
                    nameof(Math.FusedMultiplyAdd),
                    new[] { typeof(double), typeof(double), typeof(double) }
                )!
            },
            {
                typeof(double).GetRuntimeMethod(
                    nameof(double.Ieee754Remainder),
                    new[] { typeof(double), typeof(double) }
                )!,
                typeof(Math).GetRuntimeMethod(
            ...
            {
                typeof(double).GetRuntimeMethod(
                    nameof(double.ReciprocalEstimate),
                    new[] { typeof(double) }
                )!,
                typeof(Math).GetRuntimeMethod(
                    nameof(Math.ReciprocalEstimate),
                    new[] { typeof(double) }
                )!
            },
            {
                typeof(double).GetRuntimeMethod(
                    nameof(double.ReciprocalSqrtEstimate),
                    new[] { typeof(double) }
                )!,
                typeof(Math).GetRuntimeMethod(
                    nameof(Math.ReciprocalSqrtEstimate),
                    new[] { typeof(double) }
                )!
            },
            {
            ...
            {
                typeof(float).GetRuntimeMethod(
                    nameof(float.FusedMultiplyAdd),
                    new[] { typeof(float), typeof(float), typeof(float) }
                )!,
                typeof(MathF).GetRuntimeMethod(
                    nameof(MathF.FusedMultiplyAdd),
                    new[] { typeof(float), typeof(float), typeof(float) }
                )!
            },
            {
                typeof(float).GetRuntimeMethod(
                    nameof(float.Ieee754Remainder),
                    new[] { typeof(float), typeof(float) }
                )!,
                typeof(MathF).GetRuntimeMethod(
                    nameof(MathF.IEEERemainder),
                    new[] { typeof(float), typeof(float) }
                )!
            },
            {
            ...
            {
                typeof(float).GetRuntimeMethod(
                    nameof(float.MaxMagnitude),
                    new[] { typeof(float), typeof(float) }
                )!,
                typeof(MathF).GetRuntimeMethod(
                    nameof(MathF.MaxMagnitude),
                    new[] { typeof(float), typeof(float) }
                )!
            },
            {
            ...
            {
                typeof(float).GetRuntimeMethod(
                    nameof(float.MinMagnitude),
                    new[] { typeof(float), typeof(float) }
                )!,
                typeof(MathF).GetRuntimeMethod(
                    nameof(MathF.MinMagnitude),
                    new[] { typeof(float), typeof(float) }
                )!
            },
            {
            ...
            {
                typeof(float).GetRuntimeMethod(
                    nameof(float.ReciprocalEstimate),
                    new[] { typeof(float) }
                )!,
                typeof(MathF).GetRuntimeMethod(
                    nameof(MathF.ReciprocalEstimate),
                    new[] { typeof(float) }
                )!
            },
            {
                typeof(float).GetRuntimeMethod(
                    nameof(float.ReciprocalSqrtEstimate),
                    new[] { typeof(float) }
                )!,
                typeof(MathF).GetRuntimeMethod(
                    nameof(MathF.ReciprocalSqrtEstimate),
                    new[] { typeof(float) }
                )!
            },
            {
            ...
            },
            {
                typeof(float).GetRuntimeMethod(
                    nameof(float.Round),
                    new[] { typeof(float), typeof(int), typeof(MidpointRounding) }
                )!,
                typeof(MathF).GetRuntimeMethod(
                    nameof(MathF.Round),
                    new[] { typeof(float), typeof(int), typeof(MidpointRounding) }
            ...
            },
            {
                typeof(float).GetRuntimeMethod(
                    nameof(float.Round),
                    new[] { typeof(float), typeof(MidpointRounding) }
                )!,
                typeof(MathF).GetRuntimeMethod(
                    nameof(MathF.Round),
                    new[] { typeof(float), typeof(MidpointRounding) }
            ...
            {
                typeof(sbyte).GetRuntimeMethod(
                    nameof(sbyte.Clamp),
                    new[] { typeof(sbyte), typeof(sbyte), typeof(sbyte) }
                )!,
                typeof(Math).GetRuntimeMethod(
                    nameof(Math.Clamp),
                    new[] { typeof(sbyte), typeof(sbyte), typeof(sbyte) }
            ...
            {
                typeof(short).GetRuntimeMethod(
                    nameof(short.Clamp),
                    new[] { typeof(short), typeof(short), typeof(short) }
                )!,
                typeof(Math).GetRuntimeMethod(
                    nameof(Math.Clamp),
                    new[] { typeof(short), typeof(short), typeof(short) }
            ...
            {
                typeof(ulong).GetRuntimeMethod(
                    nameof(ulong.Clamp),
                    new[] { typeof(ulong), typeof(ulong), typeof(ulong) }
                )!,
                typeof(Math).GetRuntimeMethod(
                    nameof(Math.Clamp),
                    new[] { typeof(ulong), typeof(ulong), typeof(ulong) }
            ...
            {
                typeof(ushort).GetRuntimeMethod(
                    nameof(ushort.Clamp),
