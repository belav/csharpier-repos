...
// EF Core</see>,
///         <see href="https://aka.ms/efcore-docs-changing-relationships">Changing foreign keys and
// navigations</see>,
    ...
    where TRelatedEntity : class
{
    ...
    /// <summary>
    ///     Returns the query that would be used by <see cref="CollectionEntry.Load()" /> to load
