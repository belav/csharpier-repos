    ...
    where TEntity : class
{
    ...
    /// <summary>
    ///     Gets or sets the value that was assigned to this property when it was retrieved from the
    // database.
    ///     This property is populated when an entity is retrieved from the database, but setting it may
    // be
