...
/// </summary>
/// <remarks>
///     See <see href="https://aka.ms/efcore-docs-state-changes">State changes of entities in EF
...
public class EntityTrackedEventArgs : EntityEntryEventArgs
{
    ...
    /// <summary>
    ///     <see langword="true" /> if the entity is being tracked as part of a database query; <see
