...
namespace Microsoft.EntityFrameworkCore.ChangeTracking.Internal
{
    ...
    public abstract partial class InternalEntityEntry : IUpdateEntry
    {
        ...
        ///     doing so can result in application failures when updating to a new Entity Framework Core release.
        /// </summary>
        public virtual bool HasConceptualNull => _stateData.AnyPropertiesFlagged(PropertyFlag.Null);
        ...
        ///     doing so can result in application failures when updating to a new Entity Framework Core release.
        /// </summary>
        public virtual void SetTemporaryValue(
            IProperty property,
            object? value,
        ...
        ///     doing so can result in application failures when updating to a new Entity Framework Core release.
        /// </summary>
        public virtual TProperty GetRelationshipSnapshotValue<TProperty>(
            IPropertyBase propertyBase
        ) =>
            (
                (Func<
        ...
        ///     doing so can result in application failures when updating to a new Entity Framework Core release.
        /// </summary>
        public virtual object GetOrCreateCollection(
        ...
        ///     doing so can result in application failures when updating to a new Entity Framework Core release.
        /// </summary>
        public virtual bool CollectionContains(
            INavigationBase navigationBase,
        ...
        )
        {
            ...
            return navigationBase.GetCollectionAccessor()!
        ...
        ///     doing so can result in application failures when updating to a new Entity Framework Core release.
        /// </summary>
        public virtual bool RemoveFromCollection(
            INavigationBase navigationBase,
            InternalEntityEntry value
        )
        {
        ...
        )
        {
            ...
            )
            {
                ...
                var propertyIndex = property.GetIndex();
                if (
                    !ValuesEqualFunc(property)(currentValue, value)
                    && !_stateData.IsPropertyFlagged(propertyIndex, PropertyFlag.Unknown)
                )
                {
        ...
        public virtual void EnsureStoreGeneratedValues()
        {
            if (_storeGeneratedValues.IsEmpty)
            {
                _storeGeneratedValues = new SidecarValues(
                    ((IRuntimeEntityType)EntityType).StoreGeneratedValuesFactory(this)
                );
            }
        }
            ...
            )
            {
                ...
                if (
                    ...
                    && (
                        ...
                        || asProperty.GetContainingForeignKeys()
                            .Any(
                                fk =>
                                    (
        ...
        ///     doing so can result in application failures when updating to a new Entity Framework Core release.
        /// </summary>
        public virtual EntityEntry ToEntityEntry() => new(this);
        ...
        public virtual void SetIsLoaded(INavigationBase navigation, bool loaded = true)
        {
            ...
            foreach (
                var lazyLoaderProperty in EntityType.GetServiceProperties()
