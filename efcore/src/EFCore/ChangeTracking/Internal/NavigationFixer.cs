...
{
    private IList<(InternalEntityEntry Entry, InternalEntityEntry OtherEntry, ISkipNavigation SkipNavigation, bool FromQuery, bool SetModified)>? _danglingJoinEntities;
    ...
    )
    {
        ...
        try
        {
            if (oldState == EntityState.Detached)
            {
                ...
                (oldState == EntityState.Deleted || oldState == EntityState.Added)
    ...
    )
    {
        ...
        else
        {
            _danglingJoinEntities ??=
                new List<(InternalEntityEntry Entry, InternalEntityEntry OtherEntry, ISkipNavigation SkipNavigation, bool FromQuery, bool SetModified)>();
