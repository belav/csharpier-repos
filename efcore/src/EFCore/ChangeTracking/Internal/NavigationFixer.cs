...
namespace Microsoft.EntityFrameworkCore.ChangeTracking.Internal
{
    ...
    public class NavigationFixer : INavigationFixer
    {
            ...
            foreach (var foreignKey in entityType.GetForeignKeys())
            {
                ...
                foreach (var skipNavigation in foreignKey.GetReferencingSkipNavigations())
                {
                    ...
                    if (
                        StringComparer
                            .Ordinal
                            .Compare(skipNavigation.Name, skipNavigation.Inverse.Name) < 0
                    )
                    {
        ...
        private static bool IsAmbiguous(InternalEntityEntry dependentEntry) =>
            ...
            && (
                ...
                || dependentEntry.EntityType.HasSharedClrType
                    && dependentEntry
                        .StateManager
                        .TryGetEntry(dependentEntry.Entity, throwOnNonUniqueness: false)
                        != dependentEntry
            );
        ...
        {
            var currentPrincipal = dependentEntry
                .StateManager
        ...
        )
        {
            ...
            return existingValue == null || existingValue == value.Entity;
        }
