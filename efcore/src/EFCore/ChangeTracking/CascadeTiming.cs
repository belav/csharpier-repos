...
///     See <see cref="ChangeTracker.CascadeDeleteTiming" /> and <see
// cref="ChangeTracker.DeleteOrphansTiming" />.
/// </summary>
/// <remarks>
///     See <see href="https://aka.ms/efcore-docs-cascading">EF Core cascade deletes and deleting
// orphans</see> for more information and
///     examples.
/// </remarks>
public enum CascadeTiming
{
    ...
    /// <summary>
    ///     Cascading actions are made to dependent/child entities as part of <see
