...
{
    private static readonly MethodInfo GenericCreate = typeof(EntityFinderSource)
        .GetTypeInfo()
        .GetDeclaredMethod(nameof(CreateConstructor))!;
    ...
    public virtual IEntityFinder Create(
        ...
        _cache.GetOrAdd(
            ...
            t =>
                (Func<IStateManager, IDbSetSource, IDbSetCache, IEntityType, IEntityFinder>)
                    GenericCreate.MakeGenericMethod(t).Invoke(null, null)!
