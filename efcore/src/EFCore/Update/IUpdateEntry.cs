...
/// <summary>
///     <para>
///         The information passed to a database provider to save changes to an entity to the
// database.
///     </para>
///     <para>
...
public interface IUpdateEntry
{
    ...
    /// <summary>
    ///     Gets a value indicating if the specified property is modified. If true, the current value
    // assigned
    ///     to the property should be saved to the database.
    /// </summary>
    /// <param name="property">The property to be checked.</param>
    /// <returns><see langword="true" /> if the property is modified, otherwise <see langword="false"
    // />.</returns>
    ...
    /// </summary>
    /// <param name="property">The property to be checked.</param>
    /// <returns><see langword="true" /> if the property has a temporary value, otherwise <see
    // langword="false" />.</returns>
    bool HasTemporaryValue(IProperty property);

    /// <summary>
    ///     Gets a value indicating if the specified property has a store-generated value that has not
    // yet been saved to the entity.
    /// </summary>
    /// <param name="property">The property to be checked.</param>
    /// <returns><see langword="true" /> if the property has a store-gen value, otherwise <see
    // langword="false" />.</returns>
    bool HasStoreGeneratedValue(IProperty property);

    /// <summary>
    ///     Gets a value indicating if the specified property should have a value generated by the
    // database.
    /// </summary>
    /// <param name="property">The property to be checked.</param>
    /// <returns><see langword="true" /> if the property should have a value generated by the database,
    ...
    /// <param name="value">The value to set.</param>
    /// <param name="setModified">Whether to set the store-generated property's state to
    // Modified.</param>
    void SetStoreGeneratedValue(IProperty property, object? value, bool setModified = true);

    /// <summary>
    ///     Gets an <see cref="EntityEntry" /> for the entity being saved. <see cref="EntityEntry" /> is
    // an API optimized for
    ///     application developers and <see cref="IUpdateEntry" /> is optimized for database providers,
    ...
    /// <summary>
    ///     Checks whether the property is conceptually set to null even if the property type is not
    // nullable.
    /// </summary>
    /// <param name="property">The property to check.</param>
    /// <returns><see langword="true" /> if the property is conceptually null; <see langword="false" />
    // otherwise.</returns>
