        ...
        IForeignKeyRemovedConvention
{
    ...
    )
    {
        ...
        foreach (
            var candidateTuple in Dependencies.MemberClassifier.GetNavigationCandidates(entityType)
        )
        {
            ...
            if (!entityType.IsKeyless)
            {
                var inverseCandidates = Dependencies
                    .MemberClassifier
                    .GetNavigationCandidates(candidateTargetEntityType);
    ...
    )
    {
        DiscoverRelationships(
            ...
            Dependencies
                .MemberClassifier
                .GetInverseCandidateTypes(entityTypeBuilder.Metadata)
                .ToHashSet()
        );
