        ...
        IForeignKeyRemovedConvention
{
    ...
    )
    {
        ...
        foreach (var relationshipCandidate in relationshipCandidates)
        {
            ...
            {
                if (
                    relationshipCandidate.InverseProperties.Count == 0 || targetEntityType.IsOwned()
                )
                {
                    unusedEntityTypes.Add(targetEntityType);
                }
    ...
    )
    {
        ...
        if (
            entityType.FindNavigation(navigationName) != null || IsAmbiguous(entityType, memberInfo)
        )
        {
            return;
        }
