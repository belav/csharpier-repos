...
/// <summary>
///     Represents an operation that should be performed when a property is removed from the entity
// type.
/// </summary>
/// <remarks>
...
public interface IPropertyRemovedConvention : IConvention
{
    ...
    /// </summary>
    /// <param name="typeBaseBuilder">The builder for the entity type that contained the
    // property.</param>
