...
/// <summary>
///     Represents an operation that should be performed when a navigation is removed from the
// entity type.
/// </summary>
/// <remarks>
...
public interface INavigationRemovedConvention : IConvention
{
    ...
    /// </summary>
    /// <param name="sourceEntityTypeBuilder">The builder for the entity type that contained the
    // navigation.</param>
    /// <param name="targetEntityTypeBuilder">The builder for the target entity type of the
    // navigation.</param>
