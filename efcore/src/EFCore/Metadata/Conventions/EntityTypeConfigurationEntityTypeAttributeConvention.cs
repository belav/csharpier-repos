...
namespace Microsoft.EntityFrameworkCore.Metadata.Conventions
{
    ...
    /// </summary>
    public class EntityTypeConfigurationEntityTypeAttributeConvention
        : EntityTypeAttributeConventionBase<EntityTypeConfigurationAttribute>
    {
        private static readonly MethodInfo _configureMethod =
            typeof(EntityTypeConfigurationEntityTypeAttributeConvention).GetRequiredDeclaredMethod(
                nameof(Configure)
            );
        ...
        )
        {
            ...
            if (
                !entityTypeConfigurationType.GetInterfaces()
                    .Any(
                        x =>
                            x.IsGenericType
            ...
            _configureMethod.MakeGenericMethod(entityTypeBuilder.Metadata.ClrType)
                .Invoke(
                    null,
                    new object[] { entityTypeBuilder.Metadata, entityTypeConfigurationType }
                );
        }
        ...
        ) where TEntity : class
        {
            ...
            var entityTypeConfiguration =
                (IEntityTypeConfiguration<TEntity>)Activator.CreateInstance(
