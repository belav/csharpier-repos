          ...
          IModelFinalizingConvention
    {
        ...
        private IConventionForeignKeyBuilder? UpdateRelationshipBuilder(
            ...
            else
            {
                ...
                {
                    var conflictingFk = foreignKey.DeclaringEntityType.FindForeignKeys(
                            existingProperties
                        )
                        .FirstOrDefault(
                            fk =>
        ...
        private static IReadOnlyList<string>? FindCandidateDependentPropertiesThroughNavigation(
            ...
            {
                var properties = navigationFkAttribute.Name.Split(',')
                    .Select(p => p.Trim())
                    .ToList();
                ...
                var otherNavigations = navigation.DeclaringEntityType.GetRuntimeProperties()
                    .Values.Where(
                        p =>
