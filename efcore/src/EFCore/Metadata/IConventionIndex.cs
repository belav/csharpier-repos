...
///         Once the model is built, <see cref="IIndex" /> represents a read-only view of the same
// metadata.
///     </para>
///     <para>
...
public interface IConventionIndex : IReadOnlyIndex, IConventionAnnotatable
{
    ...
    /// </summary>
    /// <exception cref="InvalidOperationException">If the index has been removed from the
    // model.</exception>
    ...
    /// </summary>
    /// <param name="unique">A value indicating whether the values assigned to the index properties are
    // unique.</param>
