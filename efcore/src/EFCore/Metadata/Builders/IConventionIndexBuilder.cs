...
/// <summary>
///     <para>
///         Provides a simple API surface for configuring an <see cref="IConventionIndex" /> from
// conventions.
///     </para>
///     <para>
...
public interface IConventionIndexBuilder : IConventionAnnotatableBuilder
{
    ...
    // annotation.</param>
    /// <returns>
    ///     An <see cref="IConventionIndexBuilder" /> to continue configuration if the annotation was
    ...
    /// <param name="fromDataAnnotation">Indicates whether the configuration was specified using a data
    // annotation.</param>
    /// <returns>The same builder instance if the uniqueness was configured, <see langword="null" />
    // otherwise.</returns>
    IConventionIndexBuilder? IsUnique(bool? unique, bool fromDataAnnotation = false);

    /// <summary>
    ///     Returns a value indicating whether this index uniqueness can be configured from the current
    ...
    /// </summary>
    /// <param name="descending">A set of values indicating whether each corresponding index column has
    // descending sort order.</param>
    /// <param name="fromDataAnnotation">Indicates whether the configuration was specified using a data
    // annotation.</param>
    /// <returns>The same builder instance if the uniqueness was configured, <see langword="null" />
    // otherwise.</returns>
    ...
    /// <summary>
    ///     Returns a value indicating whether this index sort order can be configured from the current
    // configuration source.
    /// </summary>
    /// <param name="descending">A set of values indicating whether each corresponding index column has
    // descending sort order.</param>
