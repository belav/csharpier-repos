...
/// <summary>
///     <para>
///         Provides a simple API surface for configuring an <see cref="IConventionSkipNavigation"
// /> from conventions.
///     </para>
///     <para>
    ...
    : IConventionPropertyBaseBuilder<IConventionSkipNavigationBuilder>
{
    ...
    /// <summary>
    ///     Returns a value indicating whether the <see cref="IConventionSkipNavigation.ForeignKey" />
    // can be set for this navigation
    ...
    /// <param name="fromDataAnnotation">Indicates whether the configuration was specified using a data
    // annotation.</param>
    /// <returns><see langword="true" /> if the <see cref="IConventionSkipNavigation.ForeignKey" /> can
    // be set for this property.</returns>
    ...
    /// <summary>
    ///     Returns a value indicating whether the <see cref="IConventionSkipNavigation.Inverse" /> can
    // be set for this navigation
    ///     from the given configuration source.
    /// </summary>
    /// <param name="inverse">
    ///     The inverse skip navigation. Passing <see langword="null" /> will result in there being no
    ...
    /// <param name="fromDataAnnotation">Indicates whether the configuration was specified using a data
    // annotation.</param>
    /// <returns><see langword="true" /> if the <see cref="IConventionSkipNavigation.Inverse" /> can be
    // set for this property.</returns>
    bool CanSetInverse(IConventionSkipNavigation? inverse, bool fromDataAnnotation = false);

    /// <summary>
    ///     Returns a value indicating whether this navigation can be configured to be automatically
    // included in a query
    ///     from the current configuration source.
    /// </summary>
    /// <param name="autoInclude">A value indicating whether the navigation should be automatically
    // included.</param>
    /// <param name="fromDataAnnotation">Indicates whether the configuration was specified using a data
    // annotation.</param>
    /// <returns><see langword="true" /> if automatically included can be set for this
    // navigation.</returns>
    ...
    ///     from the current configuration source.
    /// </summary>
    /// <param name="lazyLoadingEnabled">A value indicating whether the navigation should be enabled for
    // lazy-loading.</param>
    /// <param name="fromDataAnnotation">Indicates whether the configuration was specified using a data
    // annotation.</param>
    /// <returns><see langword="true" /> if automatically included can be set for this
