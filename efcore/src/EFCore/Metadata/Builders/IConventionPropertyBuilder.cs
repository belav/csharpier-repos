...
/// <summary>
///     <para>
///         Provides a simple API surface for configuring an <see cref="IConventionProperty" /> from
// conventions.
///     </para>
///     <para>
    ...
    : IConventionPropertyBaseBuilder<IConventionPropertyBuilder>
{
    ...
    /// <summary>
    ///     Sets a value indicating when a value for this property will be generated by the database.
    // Even when the
    ...
    // cref="IReadOnlyProperty.GetBeforeSaveBehavior" /> and
    ...
    /// <param name="fromDataAnnotation">Indicates whether the configuration was specified using a data
    // annotation.</param>
    /// <returns><see langword="true" /> if the property can be configured as a concurrency
    // token.</returns>
    ...
    /// <summary>
    ///     Returns a value indicating whether the sentinel can be set for this property from the
    ...
    /// <summary>
    ///     Returns a value indicating whether the maximum length of data allowed can be set for this
    // property
    ///     from the current configuration source.
    /// </summary>
    ...
    /// <param name="fromDataAnnotation">Indicates whether the configuration was specified using a data
    // annotation.</param>
    /// <returns><see langword="true" /> if the maximum length of data allowed can be set for this
    // property.</returns>
    ...
    /// <summary>
    ///     Returns a value indicating whether the property can be configured as capable of persisting
    // unicode characters
    ///     from the current configuration source.
    /// </summary>
    /// <param name="unicode">A value indicating whether the property can contain unicode
    ...
    /// <param name="fromDataAnnotation">Indicates whether the configuration was specified using a data
    // annotation.</param>
    /// <returns><see langword="true" /> if the capability of persisting unicode characters can be
    // configured for this property.</returns>
    ...
    /// <summary>
    ///     Returns a value indicating whether the precision of data allowed can be set for this
    // property
    ///     from the current configuration source.
    /// </summary>
    /// <param name="precision">The precision of the property.</param>
    /// <param name="fromDataAnnotation">Indicates whether the configuration was specified using a data
    // annotation.</param>
    /// <returns><see langword="true" /> if the precision of data allowed can be set for this
    // property.</returns>
    ...
    /// <param name="fromDataAnnotation">Indicates whether the configuration was specified using a data
    // annotation.</param>
    /// <returns><see langword="true" /> if the scale of data allowed can be set for this
    // property.</returns>
    ...
    /// <summary>
    ///     Returns a value indicating whether the ability to be modified before the entity is saved to
    // the database
    ...
    // annotation.</param>
    /// <returns>
    ///     <see langword="true" /> if the ability to be modified before the entity is saved to the
    // database can be configured for this property.
    /// </returns>
    ...
    /// <summary>
    ///     Returns a value indicating whether the ability to be modified after the entity is saved to
    // the database
    ///     can be configured for this property from the current configuration source.
    /// </summary>
    /// <param name="behavior">
    ...
    // annotation.</param>
    /// <returns>
    ///     <see langword="true" /> if the ability to be modified after the entity is saved to the
    // database can be configured for this property.
    /// </returns>
    ...
    /// <summary>
    ///     Returns a value indicating whether the <see cref="ValueGenerator" /> can be configured for
    // this property
    ///     from the current configuration source.
    /// </summary>
    /// <param name="factory">A delegate that will be used to create value generator instances.</param>
    ...
    /// </returns>
    /// <returns>
    ///     <see langword="true" /> if the <see cref="ValueGenerator" /> can be configured for this
    // property.
    /// </returns>
    ...
    /// <summary>
    ///     Returns a value indicating whether the <see cref="ValueGeneratorFactory" /> can be
    ...
    /// <summary>
    ///     Returns a value indicating whether the <see cref="ValueConverter" /> can be configured for
    // this property
    ///     from the current configuration source.
    /// </summary>
    /// <param name="converter">The converter to use.</param>
    ...
    // annotation.</param>
    /// <returns>
    ///     <see langword="true" /> if the <see cref="ValueConverter" /> can be configured for this
    // property.
    /// </returns>
    ...
    /// </summary>
    /// <param name="typeMapping">The type mapping, or <see langword="null" /> to remove any previously
    // set type mapping.</param>
    /// <param name="fromDataAnnotation">Indicates whether the configuration was specified using a data
    // annotation.</param>
    /// <returns>
    ///     The same builder instance if the configuration was applied,
    ...
    // annotation.</param>
    /// <returns>
    ///     <see langword="true" /> if the given <see cref="ValueComparer" /> can be configured for this
    // property.
    /// </returns>
    ...
    /// <summary>
    ///     Configures the <see cref="ValueComparer" /> to use for the provider values for this
    // property.
    /// </summary>
    /// <param name="comparer">The comparer, or <see langword="null" /> to remove any previously set
    // comparer.</param>
