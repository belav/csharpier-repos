...
namespace Microsoft.EntityFrameworkCore.Metadata.Builders
{
        ...
        where TDependentEntity : class
    {
        ...
        public new virtual OwnedNavigationBuilder<TOwnerEntity, TDependentEntity> Ignore(
            string propertyName
        ...
        public virtual OwnedNavigationBuilder<
            TDependentEntity,
            TNewDependentEntity
        > OwnsOne<TNewDependentEntity>(string navigationName) where TNewDependentEntity : class =>
            OwnsOneBuilder<TNewDependentEntity>(
                new TypeIdentity(
                    typeof(TNewDependentEntity),
                    (Model)Metadata.DeclaringEntityType.Model
                ),
        ...
        public virtual OwnedNavigationBuilder<
            TDependentEntity,
            TNewDependentEntity
        > OwnsMany<TNewDependentEntity>(string navigationName) where TNewDependentEntity : class =>
        ...
        /// </param>
        /// <returns>An object that can be used to configure the relationship.</returns>
        public virtual ReferenceNavigationBuilder<
            TDependentEntity,
            TNewRelatedEntity
        > HasOne<TNewRelatedEntity>(string? navigationName) where TNewRelatedEntity : class
        {
        ...
        ) where TNewRelatedEntity : class
        {
            ...
            var relatedEntityType = FindRelatedEntityType(
                typeof(TNewRelatedEntity),
                navigation?.GetSimpleMemberName()
            );
        ...
        /// <returns>The same builder instance so that multiple configuration calls can be chained.</returns>
        public new virtual OwnedNavigationBuilder<
            TOwnerEntity,
            TDependentEntity
