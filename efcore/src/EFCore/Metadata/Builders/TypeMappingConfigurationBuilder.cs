...
public class TypeMappingConfigurationBuilder
{
    ...
    /// </summary>
    /// <typeparam name="TConversion">The type to convert to and from or a type that derives from <see
    ...
    ///     writing to the database and converted back when reading from the database.
    /// </summary>
    /// <param name="conversionType">The type to convert to and from or a type that derives from <see
