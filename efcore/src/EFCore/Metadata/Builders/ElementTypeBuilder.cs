...
/// <summary>
///     Provides a simple API for configuring the <see cref="IMutableElementType" /> of a primitive
// collection.
/// </summary>
/// <remarks>
///     <para>
...
public class ElementTypeBuilder : IInfrastructure<IConventionElementTypeBuilder>
{
    ...
    /// <summary>
    ///     Adds or updates an annotation on the element type. If an annotation with the key specified
    // in
    ...
    /// <summary>
    ///     Configures whether elements of the collection must have a value or can be <see
    // langword="null" />.
    ///     An element can only be configured as non-required if it is based on a CLR type that can be
    ///     assigned <see langword="null" />.
    /// </summary>
    /// <param name="required">A value indicating whether elements of the collection must not be <see
    // langword="null" />.</param>
    /// <returns>The same builder instance so that multiple configuration calls can be
    // chained.</returns>
    ...
    ///     The maximum length of data allowed in elements of the collection. A value of <c>-1</c>
    // indicates that elements of the
    ...
    /// </summary>
    /// <param name="unicode">A value indicating whether elements of the collection can contain unicode
    // characters.</param>
    /// <returns>The same builder instance so that multiple configuration calls can be
    // chained.</returns>
    ...
    /// <summary>
    ///     Configures elements of the collection so their values are converted before writing to the
    // database and converted back
    ...
    /// <summary>
    ///     Configures elements of the collection so that their values are converted before writing to
    ...
    /// <summary>
    ///     Configures elements of the collection so that their values are converted to and from the
    // database
