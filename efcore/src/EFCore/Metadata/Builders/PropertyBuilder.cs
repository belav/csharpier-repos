...
public class PropertyBuilder : IInfrastructure<IConventionPropertyBuilder>
{
    ...
    ///     </para>
    ///     <para>
    ///         This factory will be invoked once to create a single instance of the value generator,
    // and
    ///         this will be used to generate values for this property in all instances of the entity
    // type.
    ///     </para>
    ///     <para>
    ///         This method is intended for use with custom value generation. Value generation for
