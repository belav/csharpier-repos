...
/// <summary>
///     <para>
///         Provides a simple API surface for configuring an <see cref="IConventionEntityType" />
// from conventions.
///     </para>
///     <para>
...
public interface IConventionEntityTypeBuilder : IConventionTypeBaseBuilder
{
    ...
    // annotation.</param>
    /// <returns>
    ///     An <see cref="IConventionEntityTypeBuilder" /> to continue configuration if the annotation
    // was set, <see langword="null" /> otherwise.
    /// </returns>
    ...
    /// </summary>
    /// <param name="baseEntityType">The base entity type or <see langword="null" /> to indicate no base
    // type.</param>
    /// <param name="fromDataAnnotation">Indicates whether the configuration was specified using a data
    // annotation.</param>
    /// <returns>
    ...
    /// <summary>
    ///     Returns a value indicating whether the given type can be set as the base type of this entity
    // type.
    /// </summary>
    /// <param name="baseEntityType">The base entity type or <see langword="null" /> to indicate no base
    // type.</param>
    /// <param name="fromDataAnnotation">Indicates whether the configuration was specified using a data
    // annotation.</param>
    /// <returns><see langword="true" /> if the given type can be set as the base type of this entity
    // type.</returns>
    ...
    /// <summary>
    ///     Returns an object that can be used to configure the service property with the given member
    // info.
    ...
    /// <summary>
    ///     Returns a value indicating whether the given service property can be added to this entity
    // type.
    /// </summary>
    /// <param name="memberInfo">The <see cref="PropertyInfo" /> or <see cref="FieldInfo" /> of the
    // property.</param>
    ...
    /// <summary>
    ///     Returns a value indicating whether the service property can be removed from this entity
    // type.
    /// </summary>
    /// <param name="serviceProperty">The service property to be removed.</param>
    /// <param name="fromDataAnnotation">Indicates whether the configuration was specified using a data
    // annotation.</param>
    /// <returns><see langword="true" /> if the service property can be removed from this entity
    // type.</returns>
    ...
    /// <summary>
    ///     Excludes the given property from the entity type and prevents conventions from adding a
    // matching property
    ...
    /// <summary>
    ///     Returns a value indicating whether the given properties can be set as the primary key for
    // this entity type.
    /// </summary>
    /// <param name="propertyNames">The names of the properties that make up the index.</param>
    /// <param name="fromDataAnnotation">Indicates whether the configuration was specified using a data
    // annotation.</param>
    /// <returns><see langword="true" /> if the given properties can be set as the primary
    // key.</returns>
    ...
    /// <summary>
    ///     Returns a value indicating whether and index on the given properties can be added to this
    // entity type.
    /// </summary>
    /// <param name="propertyNames">The names of the properties that make up the index.</param>
    /// <param name="fromDataAnnotation">Indicates whether the configuration was specified using a data
    ...
    /// <summary>
    ///     Configures a relationship between this and the target entity type with the target as the
    // principal end.
    /// </summary>
    /// <param name="principalEntityType">The entity type that this relationship targets.</param>
    /// <param name="dependentProperties">The properties on this type that make up the foreign
    // key.</param>
    /// <param name="fromDataAnnotation">Indicates whether the configuration was specified using a data
    // annotation.</param>
    /// <returns>
    ...
    /// </param>
    /// <param name="setTargetAsPrincipal">A value indicating whether the target entity type should be
    // configured as the principal end.</param>
    /// <param name="fromDataAnnotation">Indicates whether the configuration was specified using a data
    // annotation.</param>
    /// <returns>
    ///     An object that can be used to configure the relationship if it exists on the entity type,
    ...
    /// </summary>
    /// <param name="targetEntityType">The entity type that this relationship targets.</param>
    /// <param name="navigation">The navigation property on this entity type that is part of the
    // relationship.</param>
    /// <param name="setTargetAsPrincipal">A value indicating whether the target entity type should be
    // configured as the principal end.</param>
    /// <param name="fromDataAnnotation">Indicates whether the configuration was specified using a data
    ...
    /// </summary>
    /// <param name="targetEntityType">The entity type that this relationship targets.</param>
    /// <param name="navigationName">The name of the navigation property on this entity type that is
    // part of the relationship.</param>
    /// <param name="inverseNavigationName">
    ///     The name of the navigation property on the target entity type that is part of the
    // relationship. If <see langword="null" />
    ///     is specified, the relationship will be configured without a navigation property on the
    // target end.
    /// </param>
    /// <param name="setTargetAsPrincipal">A value indicating whether the target entity type should be
    // configured as the principal end.</param>
    ...
    ///     The navigation property on the target entity type that is part of the relationship. If <see
    // langword="null" />
    ///     is specified, the relationship will be configured without a navigation property on the
    // target end.
    /// </param>
    ...
    /// <param name="fromDataAnnotation">Indicates whether the configuration was specified using a data
    // annotation.</param>
    /// <returns><see langword="true" /> if the foreign key can be removed from this entity
    // type.</returns>
    ...
    /// <param name="fromDataAnnotation">Indicates whether the configuration was specified using a data
    // annotation.</param>
    /// <returns><see langword="true" /> if the navigation can be removed from this entity
    // type.</returns>
    bool CanRemoveNavigation(IConventionNavigation navigation, bool fromDataAnnotation = false);

    /// <summary>
    ///     Returns a value indicating whether the given skip navigation can be added to this entity
    // type.
    /// </summary>
    ...
    // target end.
    /// </param>
    /// <param name="collections">Whether both of the navigation properties are collections or aren't
    // collections.</param>
    /// <param name="onDependent">
    ///     Whether both of the navigation property are defined on the dependent side of the underlying
    // foreign keys.
    /// </param>
    /// <param name="fromDataAnnotation">Indicates whether the configuration was specified using a data
    // annotation.</param>
    ...
    /// <param name="onDependent">
    ///     Whether the navigation property is defined on the dependent side of the underlying foreign
    // key.
    /// </param>
    /// <param name="fromDataAnnotation">Indicates whether the configuration was specified using a data
    // annotation.</param>
    ...
    /// <param name="fromDataAnnotation">Indicates whether the configuration was specified using a data
    // annotation.</param>
    /// <returns><see langword="true" /> if the skip navigation can be removed from this entity
    // type.</returns>
    ...
    /// <param name="fromDataAnnotation">Indicates whether the configuration was specified using a data
    // annotation.</param>
    /// <returns>The same builder instance if the check constraint was configured, <see langword="null"
    // /> otherwise.</returns>
    ...
    /// <summary>
    ///     Returns a value indicating whether the given query filter can be set from the current
    ...
    /// <summary>
    ///     Returns a value indicating whether the given defining query can be set from the current
    // configuration source.
    /// </summary>
    /// <param name="query">The query that will provide the underlying data for the keyless entity
    // type.</param>
    ...
    /// <summary>
    ///     Configures the discriminator property used to identify which entity type each row in a table
    // represents
    ...
    ///     This method is usually called when the entity type is no longer mapped to the same table as
    // any other type in
    ...
    /// <param name="createIfMissing">Whether the entity type should be created if currently not in the
    // model.</param>
    /// <param name="targetShouldBeOwned">Whether the target should be owned. <see langword="null" /> if
    // it can be either.</param>
    /// <param name="fromDataAnnotation">Indicates whether the configuration was specified using a data
    // annotation.</param>
    /// <returns>The entity type builder or <see langword="null" /> if not found and can't be
    // created.</returns>
