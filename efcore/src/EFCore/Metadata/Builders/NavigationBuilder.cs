...
/// <summary>
///     Provides a simple API for configuring a <see cref="IMutableNavigation" /> or <see
// cref="IMutableSkipNavigation" />.
/// </summary>
/// <remarks>
///     <para>
        ...
        IInfrastructure<IConventionNavigationBuilder?>
{
    ...
    /// </summary>
    /// <param name="autoInclude">A value indicating if the navigation should be automatically
    // included.</param>
    /// <returns>The same builder instance so that multiple configuration calls can be
    // chained.</returns>
    ...
    /// <summary>
    ///     Configures whether this navigation should be enabled for lazy-loading. Note that a property
    // can only be lazy-loaded
    ///     if a lazy-loading mechanism such as lazy-loading proxies or <see cref="ILazyLoader" />
    ...
    ///     </para>
    /// </remarks>
    /// <param name="lazyLoadingEnabled">A value indicating if the navigation should be enabled for
    // lazy-loading.</param>
    /// <returns>The same builder instance so that multiple configuration calls can be
    // chained.</returns>
