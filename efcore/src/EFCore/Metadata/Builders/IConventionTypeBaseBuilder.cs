...
/// <summary>
///     <para>
///         Provides a simple API surface for configuring an <see cref="IConventionTypeBase" /> from
// conventions.
///     </para>
///     <para>
...
public interface IConventionTypeBaseBuilder : IConventionAnnotatableBuilder
{
    ...
    // annotation.</param>
    /// <returns>
    ///     An <see cref="IConventionTypeBaseBuilder" /> to continue configuration if the annotation was
    ...
    /// <param name="setTypeConfigurationSource">Indicates whether the type configuration source should
    // be set.</param>
    /// <param name="fromDataAnnotation">Indicates whether the configuration was specified using a data
    // annotation.</param>
    /// <returns>
    ...
    ///     If no matching property exists, then a new property will be added.
    /// </summary>
    /// <param name="memberInfo">The <see cref="PropertyInfo" /> or <see cref="FieldInfo" /> of the
    // property.</param>
    /// <param name="fromDataAnnotation">Indicates whether the configuration was specified using a data
    // annotation.</param>
    /// <returns>
    ...
    /// <summary>
    ///     Returns the existing properties with the given names or creates them if matching CLR members
    // are found.
    /// </summary>
    /// <param name="propertyNames">The names of the properties.</param>
    /// <param name="fromDataAnnotation">Indicates whether the configuration was specified using a data
    // annotation.</param>
    /// <returns>A list of properties if they exist on the type, <see langword="null" />
    // otherwise.</returns>
    ...
    /// <summary>
    ///     Returns an object that can be used to configure the complex property with the given member
    // info.
    ///     If no matching property exists, then a new property will be added.
    /// </summary>
    /// <param name="memberInfo">The <see cref="PropertyInfo" /> or <see cref="FieldInfo" /> of the
    ...
    /// <summary>
    ///     Returns an object that can be used to configure the complex indexer property with the given
    // name.
    ///     If no matching property exists, then a new property will be added.
    /// </summary>
    /// <param name="propertyType">The type of value the property will hold.</param>
    ...
    /// <summary>
    ///     Returns a value indicating whether the given complex indexer property can be added to this
    // type.
    /// </summary>
    /// <param name="propertyType">The type of value the property will hold.</param>
    /// <param name="propertyName">The name of the property to be configured.</param>
    ...
    /// <param name="fromDataAnnotation">Indicates whether the configuration was specified using a data
    // annotation.</param>
    /// <returns><see langword="true" /> if the complex property can be removed from this
    // type.</returns>
    ...
    ///     the given member name hasn't been ignored or it was ignored using a lower configuration
    // source;
    ...
    /// <summary>
    ///     Excludes the given property from the complex type and prevents conventions from adding a
    // matching property
    ...
    /// <summary>
    ///     Returns a value indicating whether the given member name can be ignored from the given
    ...
    /// <summary>
    ///     Returns a value indicating whether the given change tracking strategy can be set from the
    ...
    /// <summary>
    ///     Returns a value indicating whether the given <see cref="PropertyAccessMode" /> can be set
    ...
    /// <param name="fromDataAnnotation">Indicates whether the configuration was specified using a data
    // annotation.</param>
    /// <returns><see langword="true" /> if the given <see cref="PropertyAccessMode" /> can be
    // set.</returns>
