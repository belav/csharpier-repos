...
///         Once the model is built, <see cref="IReadOnlyTypeBase" /> represents a read-only view of
// the same metadata.
///     </para>
///     <para>
...
public interface IConventionTypeBase : IReadOnlyTypeBase, IConventionAnnotatable
{
    ...
    /// </summary>
    /// <exception cref="InvalidOperationException">If the type has been removed from the
    // model.</exception>
    ...
    ///     </para>
    ///     <para>
    ///         An indexer with a <see cref="string" /> parameter and <see cref="object" /> return type
    // can be used.
    ///     </para>
    /// </param>
    /// <param name="setTypeConfigurationSource">Indicates whether the type configuration source should
    ...
    /// <summary>
    ///     Gets a property on the given entity type. Returns <see langword="null" /> if no property is
    // found.
    /// </summary>
    /// <remarks>
    ///     This API only finds scalar properties and does not find navigation, complex or service
    ...
    /// <returns>The removed property, or <see langword="null" /> if the property was not
    // found.</returns>
    ...
    /// </summary>
    /// <remarks>
    ///     Note that individual properties and navigations can override this access mode. The value set
    // here will
