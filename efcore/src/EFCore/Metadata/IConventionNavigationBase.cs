...
///         Once the model is built, <see cref="IReadOnlyNavigationBase" /> represents a read-only
...
public interface IConventionNavigationBase : IReadOnlyNavigationBase, IConventionPropertyBase
{
    ...
    /// </summary>
    /// <param name="eagerLoaded">A value indicating whether this navigation should be eager loaded by
    // default.</param>
    ...
    /// <summary>
    ///     Sets a value indicating whether this navigation should be lazy-loaded, if lazy-loading is
    // enabled and in place.
    /// </summary>
    /// <param name="lazyLoadingEnabled">A value indicating whether this navigation should
    // lazy-loaded.</param>
    /// <param name="fromDataAnnotation">Indicates whether the configuration was specified using a data
    // annotation.</param>
    /// <returns>The configured value.</returns>
