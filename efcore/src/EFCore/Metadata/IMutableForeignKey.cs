...
///         Once the model is built, <see cref="IForeignKey" /> represents a read-only view of the
// same metadata.
///     </para>
///     <para>
...
public interface IMutableForeignKey : IReadOnlyForeignKey, IMutableAnnotatable
{
    ...
    /// <summary>
    ///     Gets or sets a value indicating whether the values assigned to the foreign key properties
    // are unique.
    /// </summary>
    ...
    ///     If <see langword="true" />, the dependent entity must always be assigned to a valid
    // principal entity.
    /// </summary>
    ...
    ///     If <see langword="true" />, the principal entity must always have a valid dependent entity
    // assigned.
    /// </summary>
    new bool IsRequiredDependent { get; set; }

    /// <summary>
    ///     Gets or sets a value indicating whether this relationship defines ownership. If true, the
    // dependent entity must always be
    ///     accessed via the navigation from the principal entity.
    /// </summary>
    new bool IsOwnership { get; set; }

    /// <summary>
    ///     Gets or sets a value indicating how a delete operation is applied to dependent entities in
    // the relationship when the
    ...
    /// <summary>
    ///     Sets the navigation property on the dependent entity type that points to the principal
    // entity.
    /// </summary>
    /// <param name="name">
    ///     The name of the navigation property on the dependent type. Passing <see langword="null" />
    ...
    /// </summary>
    /// <param name="property">
    ///     The navigation property on the dependent type. Passing <see langword="null" /> will result
    // in there being
    ///     no navigation property defined.
    /// </param>
    /// <returns>The newly set navigation property.</returns>
    ...
    /// <summary>
    ///     Sets the navigation property on the principal entity type that points to the dependent
    // entity.
    /// </summary>
    /// <param name="name">
    ///     The name of the navigation property on the principal type. Passing <see langword="null" />
    // will result in there being
    ///     no navigation property defined.
    /// </param>
    /// <returns>The newly set navigation property.</returns>
