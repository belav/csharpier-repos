...
///         Once the model is built, <see cref="IElementType" /> represents a read-only view of the
// same metadata.
///     </para>
///     <para>
...
public interface IMutableElementType : IReadOnlyElementType, IMutableAnnotatable
{
    ...
    /// <summary>
    ///     Gets or sets a value indicating whether elements of the collection can be <see
    // langword="null" />.
    /// </summary>
    new bool IsNullable { get; set; }

    /// <summary>
    ///     Sets the maximum length of data that is allowed in elements of the collection. For example,
    // if the element type is
    ///     a <see cref="string" /> then this is the maximum number of characters.
    /// </summary>
    /// <param name="maxLength">The maximum length of data that is allowed in this elements of the
    // collection.</param>
    ...
    /// </summary>
    /// <param name="scale">The maximum number of decimal places that is allowed in each
    // element.</param>
    ...
    /// </summary>
    /// <param name="unicode">
    ///     <see langword="true" /> if the elements of the collection accept Unicode characters, <see
    // langword="false" /> if they do not,
    ...
    /// </summary>
    /// <param name="converter">The converter, or <see langword="null" /> to remove any previously set
    // converter.</param>
    ...
    ///     A type that inherits from <see cref="ValueConverter" />, or <see langword="null" /> to
    // remove any previously set converter.
    /// </param>
    ...
    /// <summary>
    ///     Sets the type that the elements of the collection will be converted to before being sent to
    // the database provider.
    /// </summary>
    /// <param name="providerClrType">The type to use, or <see langword="null" /> to remove any
    // previously set type.</param>
    ...
    /// </summary>
    /// <param name="comparer">The comparer, or <see langword="null" /> to remove any previously set
    // comparer.</param>
    ...
    ///     A type that inherits from <see cref="ValueComparer" />, or <see langword="null" /> to remove
    // any previously set comparer.
    /// </param>
    ...
    /// <summary>
    ///     Sets the type of <see cref="JsonValueReaderWriter{TValue}" /> to use for elements of the
    // collection.
    /// </summary>
    /// <param name="readerWriterType">
    ///     A type that inherits from <see cref="JsonValueReaderWriter{TValue}" />, or <see
    // langword="null" /> to use the reader/writer
