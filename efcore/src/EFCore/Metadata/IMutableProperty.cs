...
///         Once the model is built, <see cref="IProperty" /> represents a read-only view of the
// same metadata.
///     </para>
///     <para>
...
public interface IMutableProperty : IReadOnlyProperty, IMutablePropertyBase
{
    ...
    /// <summary>
    ///     Gets or sets a value indicating when a value for this property will be generated by the
    // database. Even when the
    ///     property is set to be generated by the database, EF may still attempt to save a specific
    // value (rather than
    ///     having one generated by the database) when the entity is added and a value is assigned, or
    // the property is
    ///     marked as modified for an existing entity. See <see
    // cref="IReadOnlyProperty.GetBeforeSaveBehavior" />
    ...
    /// <summary>
    ///     Gets or sets a value indicating whether this property is used as a concurrency token. When a
    ...
    /// <summary>
    ///     Sets the maximum length of data that is allowed in this property. For example, if the
    // property is a <see cref="string" />
    ...
    /// </summary>
    /// <param name="scale">The maximum number of decimal places that is allowed in this
    // property.</param>
    ...
    /// </summary>
    /// <param name="unicode">
    ///     <see langword="true" /> if the property accepts Unicode characters, <see langword="false" />
    // if it does not,
    ...
    ///     A value indicating whether this property can be modified before the entity is saved to the
    // database.
    /// </param>
    ...
    ///     <para>
    ///         If <see cref="PropertySaveBehavior.Throw" />, then an exception
    ///         will be thrown if a new value is assigned to this property after the entity exists in
    // the database.
    ///     </para>
    ///     <para>
    ...
    ///     A value indicating whether this property can be modified after the entity is saved to the
    // database.
    /// </param>
    void SetAfterSaveBehavior(PropertySaveBehavior? afterSaveBehavior);

    /// <summary>
    ///     Sets the factory to use for generating values for this property, or <see langword="null" />
    // to clear any previously set factory.
    /// </summary>
    /// <remarks>
    ///     Setting <see langword="null" /> does not disable value generation for this property, it just
    // clears any generator explicitly
    ///     configured for this property. The database provider may still have a value generator for the
    // property type.
    /// </remarks>
    ...
    ///     A type that derives from <see cref="ValueConverter" />, or <see langword="null" /> to remove
    // any previously set converter.
    /// </param>
    ...
    /// <summary>
    ///     Sets the type that the property value will be converted to before being sent to the database
    // provider.
    /// </summary>
    ...
    ///     A type that derives from <see cref="ValueComparer" />, or <see langword="null" /> to remove
    ...
    /// <summary>
    ///     Sets the custom <see cref="ValueComparer" /> to use for the provider values for this
    // property.
    /// </summary>
    /// <param name="comparer">The comparer, or <see langword="null" /> to remove any previously set
    // comparer.</param>
    ...
    /// <summary>
    ///     Sets the type of <see cref="JsonValueReaderWriter{TValue}" /> to use for this property for
    // this property.
    /// </summary>
    /// <param name="readerWriterType">
    ///     A type that derives from <see cref="JsonValueReaderWriter{TValue}" />, or <see
    ...
    /// <summary>
    ///     Sets the configuration for elements of the primitive collection represented by this
    // property.
    /// </summary>
    /// <param name="elementType">If <see langword="true" />, then this is a collection of primitive
    // elements.</param>
