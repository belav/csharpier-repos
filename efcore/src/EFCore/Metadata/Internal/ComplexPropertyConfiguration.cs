...
// release.
/// </summary>
public class ComplexPropertyConfiguration : AnnotatableBase
{
    /// <summary>
    ///     This is an internal API that supports the Entity Framework Core infrastructure and not
    // subject to
    ...
    // release.
    /// </summary>
    public ComplexPropertyConfiguration(Type clrType)
    {
        ClrType = clrType;
    }
    ...
    // release.
    /// </summary>
    public virtual void Apply(IMutableComplexProperty property)
    {
