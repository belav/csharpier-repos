          ...
          IConventionEntityTypeBuilder
    {
        ...
        )
        {
            ...
            else
            {
                ...
                foreach (
                    var conflictingServiceProperty in Metadata.FindServicePropertiesInHierarchy(propertyName)
                )
                {
                    if (
                        !configurationSource.Overrides(
        ...
        )
        {
            ...
            using (Metadata.Model.DelayConventions())
            {
                ...
                foreach (var derivedType in Metadata.GetDerivedTypes())
                {
                    var derivedIgnoredSource =
                        derivedType.FindDeclaredIgnoredConfigurationSource(name);
        ...
        )
        {
            ...
            using (Metadata.Model.DelayConventions())
            {
                ...
                var configurationSourceForRemoval =
                    ConfigurationSource.DataAnnotation.Max(configurationSource);
                if (baseEntityType != null)
                {
        ...
        public static EntityType.Snapshot? DetachAllMembers(EntityType entityType)
        {
            ...
            List<InternalServicePropertyBuilder>? detachedServiceProperties = null;
            foreach (
                var servicePropertiesToBeDetached in entityType
        ...
        )
        {
            ...
            else
            {
                ...
                if (foreignKey != null)
                {
                    ...
                    propertyBaseName ??=
                        ForeignKeyPropertyDiscoveryConvention.GetPropertyBaseName(foreignKey);
                }
        ...
        )
        {
            ...
            foreach (
                var conflictingMember in Metadata
                    .FindPropertiesInHierarchy(navigationName)
                    .Cast<PropertyBase>()
            ...
            using (ModelBuilder.Metadata.DelayConventions())
            {
                ...
                foreach (
                    var conflictingServiceProperty in Metadata.FindServicePropertiesInHierarchy(navigationName)
                )
                {
                    if (
                        conflictingServiceProperty.GetConfigurationSource()
