        ...
        IConventionForeignKeyBuilder
{
    ...
    )
    {
        ...
        )
        {
            dependentEntityType.Builder
                .RemoveMembersInHierarchy(navigationToPrincipalName, configurationSource);
        }
        ...
        )
        {
            principalEntityType.Builder
                .RemoveMembersInHierarchy(navigationToDependentName, configurationSource);
        }
    ...
    )
    {
        ...
        if (declaringType.HasSharedClrType)
        {
            ...
            {
                otherOwnership.DeclaringEntityType
                    .Builder
        ...
        using (var batch = ModelBuilder.Metadata.DelayConventions())
        {
            var declaringEntityTypeBuilder = newRelationshipBuilder.Metadata
                .DeclaringEntityType
                .Builder
        ...
        if (detachedKeys != null)
        {
            foreach (var (internalKeyBuilder, configurationSource) in detachedKeys)
            {
                internalKeyBuilder.Attach(
                    Metadata.DeclaringEntityType.GetRootType().Builder,
                    configurationSource
                );
            }
        }
    ...
    )
    {
        ...
        properties = Metadata.PrincipalEntityType
            .Builder
            .GetActualProperties(properties, configurationSource)!;
    ...
    )
    {
        ...
        if (dependentProperties != null || principalProperties != null)
        {
            ...
            if (shouldSetProperties)
            {
                ...
                newRelationshipBuilder = foreignKey.DeclaringEntityType
                    .Builder
                    .UpdateForeignKey(
                        foreignKey,
        ...
        {
            newRelationshipBuilder =
                newRelationshipBuilder.IsUnique(Metadata.IsUnique, isUniqueConfigurationSource)
                ?? newRelationshipBuilder;
        }
        ...
        else
        {
            ...
            {
                if (
                    Metadata.GetIsRequiredConfigurationSource() is { } isRequiredConfigurationSource
            ...
            else
            {
                if (
                    Metadata.GetIsRequiredDependentConfigurationSource()
                        is { } isRequiredDependentConfigurationSource
                    && isRequiredDependentConfigurationSource.Overrides(
                        ConfigurationSource.Explicit
                    )
                    && !newRelationshipBuilder.Metadata.GetIsRequiredConfigurationSource().HasValue
                )
        ...
        if (deleteBehavior.HasValue)
        {
            ...
            !oldRelationshipInverted
            && Metadata.GetDeleteBehaviorConfigurationSource()
                is { } deleteBehaviorConfigurationSource
    ...
    )
    {
        ...
        foreach (var relationshipWithResolution in resolvableRelationships)
        {
            ...
            if (
                ...
                && navigationlessForeignKey.DeclaringEntityType
                    .Builder
        ...
        if (newRelationshipBuilder == null)
        {
            ...
            if (principalKey != null)
            {
                ...
                )
                {
                    ...
                    {
                        var detachedProperties = InternalTypeBaseBuilder.DetachProperties(
                            dependentProperties
                        )!;
    ...
    )
    {
        ...
        foreach (var candidateRelationship in candidates)
        {
            ...
            if (
                ...
                && candidateRelationship.Metadata
                    is { DependentToPrincipal: not null, PrincipalToDependent: not null }
                && (
                    (
    ...
    )
    {
        ...
        {
            bool? invertedShouldBeUnique = null;
            var navigationToPrincipalProperty = Metadata.DependentToPrincipal
        ...
        else
        {
            ...
            var navigationToDependentProperty = Metadata.PrincipalToDependent
                ?.GetIdentifyingMemberInfo();
            if (
                navigationToDependentProperty != null
                && !IsCompatible(
    ...
    /// <inheritdoc />
    [DebuggerStepThrough]
    IConventionForeignKeyBuilder? IConventionForeignKeyBuilder.HasAnnotation(
        string name,
        object? value,
    ...
    /// <inheritdoc />
    [DebuggerStepThrough]
    IConventionForeignKeyBuilder? IConventionForeignKeyBuilder.HasNonNullAnnotation(
        string name,
        object? value,
        bool fromDataAnnotation
    ) =>
    ...
    /// <inheritdoc />
    [DebuggerStepThrough]
    IConventionForeignKeyBuilder? IConventionForeignKeyBuilder.HasNoAnnotation(
        string name,
        bool fromDataAnnotation
    ) =>
        (IConventionForeignKeyBuilder?)
