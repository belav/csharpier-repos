...
public class CollectionTypeFactory
{
    ...
    )
    {
        ...
        // If the collection is defined as a concrete type with a public parameterless constructor, then
        // create an instance of that type
        // Else, if entity type is notifying and ObservableHashSet{T} can be assigned to the type, then use
        // ObservableHashSet{T}
