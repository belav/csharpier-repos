...
/// <remarks>
///     <para>
///         Even when a property is set to be generated by the database, EF may still attempt to
// save
///         a specific value (rather than having one generated by the database) when an entity is
// added
...
///         See <see href="https://aka.ms/efcore-docs-value-generation">Value generation in EF
...
public enum ValueGenerated
{
    ...
    /// <summary>
    ///     A value is generated by the database when an entity is first added to the database. The most
    // common
    ...
    /// <summary>
    ///     No value is generated when the entity is first added to the database, but a value will be
    // read
