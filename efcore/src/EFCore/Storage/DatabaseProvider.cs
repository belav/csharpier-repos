...
/// <summary>
///     <para>
///         The primary point where a database provider can tell EF that it has been selected for
// the current context.
///     </para>
///     <para>
...
///     The type of options that the database provider will add to <see
// cref="DbContextOptions.Extensions" />
    ...
    where TOptionsExtension : class, IDbContextOptionsExtension
{
    ...
    /// <summary>
    ///     The unique name used to identify the database provider. This should be the same as the NuGet
    // package name
    ...
    /// <summary>
    ///     Gets a value indicating whether this database provider has been selected for a given
    // context.
    /// </summary>
    /// <param name="options">The options for the context.</param>
    /// <returns><see langword="true" /> if the database provider has been selected, otherwise <see
