...
/// <summary>
///     A strategy that is used to execute a command or query against the database, possibly with
// logic to retry when a
///     failure occurs.
/// </summary>
/// <remarks>
///     <para>
...
{
    /// <summary>
    ///     Indicates whether this <see cref="IExecutionStrategy" /> might retry the execution after a
    // failure.
    /// </summary>
    /// <remarks>
