...
public interface IDatabaseProvider
{
    ...
    /// <summary>
    ///     Gets a value indicating whether this database provider has been configured for a given
    // context.
    /// </summary>
    /// <param name="options">The options for the context.</param>
    /// <returns><see langword="true" /> if the database provider has been configured, otherwise <see
