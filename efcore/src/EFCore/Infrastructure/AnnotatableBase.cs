...
namespace Microsoft.EntityFrameworkCore.Infrastructure
{
    ...
    public class AnnotatableBase : IAnnotatable
    {
        ...
        )
        {
            ...
            {
                throw new InvalidOperationException(
                    CoreStrings.AnnotationNotFound(annotationName, annotatable.ToString())
                );
            }
        ...
        /// </summary>
        /// <param name="annotations">The annotations to be added.</param>
        public virtual void AddRuntimeAnnotations(
        ...
        /// <inheritdoc />
        [DebuggerStepThrough]
        IEnumerable<IAnnotation> IReadOnlyAnnotatable.GetAnnotations() => GetAnnotations();
