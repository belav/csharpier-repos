...
namespace Microsoft.EntityFrameworkCore.Infrastructure
{
          ...
          IMutableAnnotatable
    {
        ...
        public virtual ConventionAnnotation AddAnnotation(
            ...
            (ConventionAnnotation)base
                .AddAnnotation(name, CreateAnnotation(name, value, configurationSource));
        ...
        )
        {
            ...
            if (oldAnnotation != null)
            {
                ...
                configurationSource = configurationSource.Max(
                    oldAnnotation.GetConfigurationSource()
                );
            }

            return (ConventionAnnotation?)base
                .SetAnnotation(
                    name,
