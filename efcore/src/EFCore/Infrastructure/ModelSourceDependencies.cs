...
public sealed record ModelSourceDependencies
{
    ...
    /// <summary>
    ///     Gets the <see cref="IModelCustomizer" /> that will perform additional configuration of the
    // model
    ...
    /// <summary>
    ///     Gets the <see cref="IModelCacheKeyFactory" /> that will create keys used to store and lookup
    // models
    ///     the model cache.
    /// </summary>
