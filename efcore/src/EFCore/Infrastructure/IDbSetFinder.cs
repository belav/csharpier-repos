...
/// <summary>
///     A service for finding <see cref="DbSet{TEntity}" /> properties on a type that inherits from
// <see cref="DbContext" />.
/// </summary>
/// <remarks>
...
{
    /// <summary>
    ///     Finds <see cref="DbSet{TEntity}" /> properties on a type that inherits from <see
    // cref="DbContext" />.
    /// </summary>
