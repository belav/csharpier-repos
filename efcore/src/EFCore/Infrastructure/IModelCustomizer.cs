...
/// <remarks>
///     <para>
///         When replacing this service consider deriving the implementation from <see
// cref="ModelCustomizer" /> or
///         <see cref="T:Microsoft.EntityFrameworkCore.Infrastructure.RelationalModelCustomizer" />
...
public interface IModelCustomizer
{
    ...
    ///     used when building the model, then the implementation of <see
    // cref="IModelCacheKeyFactory.Create(DbContext, bool)" />
