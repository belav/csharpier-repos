...
/// <summary>
///     <para>
///         Explicitly implemented by <see cref="DbContextOptionsBuilder" /> to hide methods that
// are used by database provider
...
public interface IDbContextOptionsBuilderInfrastructure
{
    /// <summary>
    ///     <para>
    ///         Adds the given extension to the options. If an existing extension of the same type
    // already exists, it will be replaced.
    ///     </para>
    ///     <para>
    ///         This property is intended for use by extension methods to configure the context. It is
