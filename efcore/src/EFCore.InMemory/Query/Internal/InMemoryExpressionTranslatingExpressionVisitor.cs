...
namespace Microsoft.EntityFrameworkCore.InMemory.Query.Internal
{
    ...
    public class InMemoryExpressionTranslatingExpressionVisitor : ExpressionVisitor
    {
        ...
        public InMemoryExpressionTranslatingExpressionVisitor(
            ...
            _entityReferenceFindingExpressionVisitor =
                new EntityReferenceFindingExpressionVisitor();
        ...
        protected override Expression VisitMember(MemberExpression memberExpression)
        {
            ...
            static bool ShouldApplyNullProtectionForMemberAccess(
                Type callerType,
                string memberName
            ) =>
                !(
        ...
        protected override Expression VisitMethodCall(MethodCallExpression methodCallExpression)
        {
                ...
                if (
                    ...
                    switch (methodCallExpression.Method.Name)
                    {
                        case nameof(Enumerable.Average):
                        {
                            ...
                            result =
                                expression == null
                                    ? null
                                    : Expression.Call(
                                          EnumerableMethods.GetAverageWithoutSelector(
                        ...
                        case nameof(Enumerable.Distinct):
                            result =
                                groupingElementExpression.Selector is EntityShaperExpression
                                    ? groupingElementExpression
                        ...
                        case nameof(Enumerable.Sum):
                        {
                            ...
                            result =
                                expression == null
                                    ? null
                                    : Expression.Call(
                                          EnumerableMethods.GetSumWithoutSelector(
                                              expression.Type.GetSequenceType()
                                          ),
                                          expression
                                      );
            ...
            if (
                methodCallExpression.Method == _likeMethodInfo
        ...
        private static Expression ProcessSingleResultScalar(
            ...
            if (
                readValueExpression is UnaryExpression unaryExpression
                && unaryExpression.NodeType == ExpressionType.Convert
            ...
            replacedReadExpression =
                replacedReadExpression.Type == type
                    ? replacedReadExpression
...
#pragma warning restore IDE0066 // Convert switch statement to expression
        ...
        private static bool InMemoryLike(
        ...
        {
            public GroupingElementExpression(
                Expression source,
                Expression selector,
