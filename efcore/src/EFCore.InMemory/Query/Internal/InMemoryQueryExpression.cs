            ...
            ServerQueryExpression = Call(
                ...
                Lambda(
                    New(
                        ...
                        NewArrayInit(
                            typeof(object),
                            source1SelectorExpressions.Select(e =>
                                e.Type.IsValueType ? Convert(e, typeof(object)) : e
                            )
                        )
                    ),
            ...
            source2.ServerQueryExpression = Call(
                ...
                Lambda(
                    New(
                        ...
                        NewArrayInit(
                            typeof(object),
                            source2SelectorExpressions.Select(e =>
                                e.Type.IsValueType ? Convert(e, typeof(object)) : e
                            )
                        )
                    ),
    ...
    )
    {
        ...
        if (defaultElementSelector)
        {
            selector = Lambda(
                New(
                    ...
                    NewArrayInit(
                        typeof(object),
                        _projectionMappingExpressions.Select(e =>
                            e.Type.IsValueType ? Convert(e, typeof(object)) : e
                        )
                    )
                ),
        ...
        var keySelector = Lambda(
            New(
                ...
                NewArrayInit(
                    typeof(object),
                    groupingKeyExpressions.Select(e =>
                        e.Type.IsValueType ? Convert(e, typeof(object)) : e
                    )
                )
            ),
