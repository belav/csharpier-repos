...
public class InMemoryTableFactory : IInMemoryTableFactory
{
    ...
    private readonly ConcurrentDictionary<
        Type,
        Func<IEntityType, IInMemoryTable?, bool, bool, IInMemoryTable>
    > _factories = new();
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public InMemoryTableFactory(ILoggingOptions loggingOptions, IInMemorySingletonOptions options)
    {
    ...
    private Func<IEntityType, IInMemoryTable?, bool, bool, IInMemoryTable> CreateTable(
        Type keyType
    ) =>
        (Func<IEntityType, IInMemoryTable?, bool, bool, IInMemoryTable>)
