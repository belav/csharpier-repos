...
/// <remarks>
///     <para>
///         Represents an update, insert, or delete operation for a single column. <see
// cref="IReadOnlyModificationCommand" />
...
public class ColumnModification : IColumnModification
{
    ...
    private void SetOriginalValue(object? value) => Entry!.SetOriginalValue(Property!, value);
    ...
    // release.
    /// </summary>
    public static void SetStoreGeneratedValue(
        IUpdateEntry entry,
        IProperty property,
        object? value
                ...
                Property
                    ...
                    .Equals(
                        ...
                        modification.Entry.SharedIdentityEntry == null
                            ...
                            : GetOriginalProviderValue(
                                modification.Entry.SharedIdentityEntry,
