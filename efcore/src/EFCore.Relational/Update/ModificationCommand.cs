    ...
    private List<IColumnModification> GenerateColumnModifications()
    {
        ...
        if (jsonEntry)
        {
            ...
            foreach (var (jsonColumnName, updateInfo) in jsonColumnsUpdateMap)
            {
                ...
                var jsonColumnTypeMapping = navigation
                    .TargetEntityType
                    .GetContainerColumnTypeMapping()!;
                ...
                if (updateInfo.Property != null)
                {
                    ...
                    jsonPathString =
                        jsonPathString + "." + updateInfo.Property.GetJsonPropertyName();
                }
                else
                {
    ...
    )
    {
        ...
        if (isCollection)
        {
            ...
            foreach (var collectionElement in (IEnumerable)navigationValue)
            {
                ...
                var collectionElementJson = CreateJson(
                    collectionElement,
                    parentEntry,
                    entityType,
                    i++,
                ...
                && (
                    ...
                    || (
                        ...
                        && mapping
                            .Column
                            .ProviderValueComparer
                            .Equals(_originalValue, entry.GetCurrentProviderValue(property))
                    )
                )
            )
            {
