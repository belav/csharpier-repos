        ...
        try
        {
            ...
            if (hasOutputParameters)
            {
                ...
                )
                {
                    ...
                    if (
                        !ResultSetMappings[commandIndex].HasFlag(
                            ResultSetMapping.HasOutputParameters
                        )
                    )
                    {
                        continue;
                    ...
                    var rowsAffectedDbParameter = command.RowsAffectedColumn
        ...
        try
        {
            ...
            do
            {
                if (!reader.Read())
                {
                    ...
                    while (
                        ++commandIndex < ResultSetMappings.Count
                        && ResultSetMappings[commandIndex - 1].HasFlag(
