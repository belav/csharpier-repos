...
/// <summary>
///     <para>
///         A service for preparing a list of <see cref="ModificationCommandBatch" />s for the
// entities
...
{
    /// <summary>
    ///     Creates the command batches needed to insert/update/delete the entities represented by the
    // given
    ...
    /// <summary>
    ///     Given a set of modification commands, returns one more ready-to-execute batches for those
    // commands, taking into account e.g.
    ...
    /// <param name="moreCommandSets">Whether more command sets are expected after this one within the
    // same save operation.</param>
    /// <returns>The list of batches to execute.</returns>
