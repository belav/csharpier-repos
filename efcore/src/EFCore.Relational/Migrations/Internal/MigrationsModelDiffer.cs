...
public class MigrationsModelDiffer : IMigrationsModelDiffer
{
    ...
    private static IEnumerable<IColumn> GetSortedColumns(ITable table)
    {
        ...
        // issue #28539
        // ideally we should inject JSON column in the place corresponding to the navigation that maps to it
        // in the clr type
    ...
    {
        var sensitiveLoggingEnabled = CommandBatchPreparerDependencies
            .LoggingOptions
