...
// cref="RelationalEventId.CommandExecuted" />.
/// </summary>
/// <remarks>
...
public class CommandExecutedEventData : CommandEndEventData
{
    ...
    // known.</param>
    /// <param name="executeMethod">The <see cref="DbCommand" /> method that was used to execute the
    // command.</param>
    /// <param name="commandId">A correlation ID that identifies the <see cref="DbCommand" /> instance
    // being used.</param>
    ...
    /// <param name="logParameterValues">Indicates whether or not the application allows logging of
