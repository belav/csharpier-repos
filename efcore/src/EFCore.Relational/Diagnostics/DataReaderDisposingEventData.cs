...
/// <summary>
///     <see cref="DiagnosticSource" /> event payload for <see
// cref="RelationalEventId.DataReaderDisposing" />.
/// </summary>
/// <remarks>
...
{
    /// <summary>
    ///     Constructs a <see cref="DiagnosticSource" /> event payload for <see
    // cref="RelationalEventId.DataReaderDisposing" />.
    /// </summary>
    ...
    /// <param name="recordsAffected">Gets the number of rows changed, inserted, or deleted by execution
    ...
    /// <param name="duration">
    ///     The duration from the time the data reader is created until it is disposed. This corresponds
    // to the time reading
