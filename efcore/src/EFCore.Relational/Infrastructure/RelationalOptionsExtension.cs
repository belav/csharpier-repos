...
public abstract class RelationalOptionsExtension : IDbContextOptionsExtension
{
    ...
    /// <summary>
    ///     The connection string, or <see langword="null" /> if a <see cref="DbConnection" /> was used
    // instead of
    ///     a connection string.
    /// </summary>
    ...
    /// <summary>
    ///     The <see cref="DbConnection" />, or <see langword="null" /> if a connection string was used
    // instead of
    ...
    /// <summary>
    ///     <see langword="true" /> if the <see cref="Connection" /> is owned by the context and should
    ...
    /// <param name="connection">The option to change.</param>
    /// <param name="owned">
    ///     If <see langword="true" />, then the connection will become owned by the context, and will
    // be disposed in the same way
    ...
    ///     during <see cref="DbContext.SaveChanges()" /> or <see langword="null" /> if none has been
    // set.
    /// </summary>
    ...
    /// <summary>
    ///     The minimum number of statements that are needed for a multi-statement command sent to the
    // database
    ///     during <see cref="DbContext.SaveChanges()" /> or <see langword="null" /> if none has been
    // set.
    /// </summary>
    ...
    /// <summary>
    ///     Indicates whether or not to use relational database semantics when comparing null values. By
    // default,
    ...
    /// <summary>
    ///     The <see cref="QuerySplittingBehavior" /> to use when loading related collections in a
    // query.
    /// </summary>
    ...
    /// <summary>
    ///     The name of the assembly that contains migrations, or <see langword="null" /> if none has
    // been set.
    /// </summary>
    ...
    /// <summary>
    ///     The table name to use for the migrations history table, or <see langword="null" /> if none
    // has been set.
    /// </summary>
    ...
    /// <summary>
    ///     The schema to use for the migrations history table, or <see langword="null" /> if none has
    // been set.
    /// </summary>
    ...
    /// <summary>
    ///     A factory for creating the default <see cref="IExecutionStrategy" />, or <see
    // langword="null" /> if none has been
    ///     configured.
    /// </summary>
    public virtual Func<
    ...
    protected abstract class RelationalExtensionInfo : DbContextOptionsExtensionInfo
    {
        ...
        ///     to be needed. For example, if the options affect a singleton service. However most
        // extensions do not
