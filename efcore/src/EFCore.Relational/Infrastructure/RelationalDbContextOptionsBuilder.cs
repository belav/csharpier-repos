...
/// <summary>
///     Allows relational database specific configuration to be performed on <see
// cref="DbContextOptions" />.
/// </summary>
/// <remarks>
///     <para>
///         Instances of this class are typically returned from methods that configure the context
// to use a
...
{
    /// <summary>
    ///     Initializes a new instance of the <see cref="RelationalDbContextOptionsBuilder{TBuilder,
    // TExtension}" /> class.
    /// </summary>
    ...
    /// <summary>
    ///     Configures the maximum number of statements that will be included in commands sent to the
    // database
    ...
    /// <summary>
    ///     Configures the minimum number of statements that are needed for a multi-statement command
    ...
    /// <summary>
    ///     Configures the wait time (in seconds) before terminating the attempt to execute a command
    // and generating an error.
    /// </summary>
    /// <remarks>
    ///     <para>
    ///         This sets the <see cref="DbCommand.CommandTimeout" /> property on the ADO.NET provider
    // being used.
    ///     </para>
    ///     <para>
    ///         An <see cref="ArgumentException" /> is generated if <paramref name="commandTimeout" />
    // value is less than 0.
    ///     </para>
    ///     <para>
    ///         Zero (0) typically means no timeout will be applied, consult your ADO.NET provider
    // documentation.
    ///     </para>
    ///     <para>
    ...
    /// <summary>
    ///     Configures the name of the table used to record which migrations have been applied to the
    // database.
    /// </summary>
    /// <remarks>
    ///     See <see href="https://aka.ms/efcore-docs-migrations">Database migrations</see> for more
    ...
    /// <summary>
    ///     Configures the context to use relational database semantics when comparing null values. By
    // default,
    ///     Entity Framework will use C# semantics for null values, and generate SQL to compensate for
    // differences
    ///     in how the database handles nulls.
    /// </summary>
    /// <remarks>
    ///     See <see href="https://aka.ms/efcore-docs-relational-nulls">Relational database null
    // semantics</see> for more information and examples.
    /// </remarks>
    /// <returns>The same builder instance so that multiple calls can be chained.</returns>
    ...
    /// <summary>
    ///     Configures the <see cref="QuerySplittingBehavior" /> to use when loading related collections
    // in a query.
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    /// <param name="getExecutionStrategy">A function that returns a new instance of an execution
    // strategy.</param>
