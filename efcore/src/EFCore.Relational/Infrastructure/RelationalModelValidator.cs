...
public class RelationalModelValidator : ModelValidator
{
    ...
    )
    {
        ...
        var previousProviderType =
            duplicateTypeMapping.Converter?.ProviderClrType ?? duplicateTypeMapping.ClrType;
    ...
    )
    {
        foreach (var entityType in model.GetEntityTypes())
        {
            ...
            foreach (var fragment in fragments)
            {
                ...
                var unmatchedLeafRowInternalFk = entityType
                    .FindRowInternalForeignKeys(fragment.StoreObject)
                    .FirstOrDefault(
                        fk =>
                            entityType
                                .FindRowInternalForeignKeys(mainStoreObject.Value)
