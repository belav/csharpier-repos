...
/// <summary>
///     Provides a simple API for configuring a <see cref="IMutableDbFunction" /> that an entity
// type is mapped to.
/// </summary>
/// <typeparam name="TEntity">The entity type being configured.</typeparam>
public class TableValuedFunctionBuilder<TEntity>
    ...
    where TEntity : class
{
    ...
    /// <returns>The same builder instance so that multiple configuration calls can be
    // chained.</returns>
    public new virtual TableValuedFunctionBuilder<TEntity> HasParameter(
        string name,
        Action<DbFunctionParameterBuilder> buildAction
    ) => (TableValuedFunctionBuilder<TEntity>)base.HasParameter(name, buildAction);

    /// <summary>
    ///     Adds or updates an annotation on the database function. If an annotation with the key
    // specified in
    ...
    /// <returns>The same builder instance so that multiple configuration calls can be
    // chained.</returns>
    public new virtual TableValuedFunctionBuilder<TEntity> HasAnnotation(
        string annotation,
        object? value
