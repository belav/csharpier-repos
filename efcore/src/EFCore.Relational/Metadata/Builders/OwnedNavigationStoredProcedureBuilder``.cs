    ...
    where TDependentEntity : class
{
    ...
    public new virtual OwnedNavigationStoredProcedureBuilder<
        TOwnerEntity,
        TDependentEntity
    > HasParameter(string propertyName, Action<StoredProcedureParameterBuilder> buildAction) =>
        (OwnedNavigationStoredProcedureBuilder<TOwnerEntity, TDependentEntity>)
            base.HasParameter(propertyName, buildAction);
    ...
    public virtual OwnedNavigationStoredProcedureBuilder<
        TOwnerEntity,
        TDependentEntity
    > HasParameter<TProperty>(Expression<Func<TDependentEntity, TProperty>> propertyExpression)
    {
    ...
    public new virtual OwnedNavigationStoredProcedureBuilder<
        TOwnerEntity,
        TDependentEntity
    > HasOriginalValueParameter(string propertyName) =>
        (OwnedNavigationStoredProcedureBuilder<TOwnerEntity, TDependentEntity>)
    ...
    public virtual OwnedNavigationStoredProcedureBuilder<
        TOwnerEntity,
        TDependentEntity
    > HasOriginalValueParameter<TProperty>(
        Expression<Func<TDependentEntity, TProperty>> propertyExpression
    )
    {
    ...
    public new virtual OwnedNavigationStoredProcedureBuilder<
        TOwnerEntity,
        TDependentEntity
    > HasRowsAffectedParameter(Action<StoredProcedureParameterBuilder> buildAction) =>
        (OwnedNavigationStoredProcedureBuilder<TOwnerEntity, TDependentEntity>)
    ...
    public new virtual OwnedNavigationStoredProcedureBuilder<
        TOwnerEntity,
        TDependentEntity
    > HasResultColumn(string propertyName) =>
        (OwnedNavigationStoredProcedureBuilder<TOwnerEntity, TDependentEntity>)
    ...
    public virtual OwnedNavigationStoredProcedureBuilder<
        TOwnerEntity,
        TDependentEntity
    > HasResultColumn<TProperty>(Expression<Func<TDependentEntity, TProperty>> propertyExpression)
    {
    ...
    public new virtual OwnedNavigationStoredProcedureBuilder<
        TOwnerEntity,
        TDependentEntity
    > HasRowsAffectedResultColumn(Action<StoredProcedureResultColumnBuilder> buildAction) =>
        (OwnedNavigationStoredProcedureBuilder<TOwnerEntity, TDependentEntity>)
            base.HasRowsAffectedResultColumn(buildAction);
