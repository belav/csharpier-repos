...
/// <summary>
///     A convention that removes discriminators from non-TPH entity types and unmaps the inherited
// properties for TPT entity types.
/// </summary>
/// <remarks>
        ...
        foreach (var entityType in modelBuilder.Metadata.GetEntityTypes())
        {
            ...
            if (mappingStrategy == null)
            {
                ...
                if (
                    ...
                    && root.GetDiscriminatorPropertyConfigurationSource()
            ...
            if (tableName != null)
            {
                ...
                if (mappingStrategy == RelationalAnnotationNames.TptMappingStrategy)
                {
                    ...
                    )
                    {
                        ...
                        {
                            entityType
                                .Builder.HasRelationship(closestMappedType, pk.Properties, pk)
                                ?.IsUnique(true);
                        }
                    }
