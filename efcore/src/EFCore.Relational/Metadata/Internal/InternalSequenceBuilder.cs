        ...
        IConventionSequenceBuilder
{
    ...
    /// <inheritdoc />
    [DebuggerStepThrough]
    IConventionSequenceBuilder? IConventionSequenceBuilder.HasAnnotation(
        string name,
        object? value,
    ...
    /// <inheritdoc />
    [DebuggerStepThrough]
    IConventionSequenceBuilder? IConventionSequenceBuilder.HasNonNullAnnotation(
        string name,
        object? value,
        bool fromDataAnnotation
    ) =>
    ...
    /// <inheritdoc />
    [DebuggerStepThrough]
    IConventionSequenceBuilder? IConventionSequenceBuilder.HasNoAnnotation(
        string name,
        bool fromDataAnnotation
    ) =>
        (IConventionSequenceBuilder?)
