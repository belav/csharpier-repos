        ...
        IConventionStoredProcedureParameterBuilder
{
    ...
    public virtual bool CanSetDirection(
        ...
        || (
            configurationSource.Overrides(Metadata.GetDirectionConfigurationSource())
            && Metadata.IsValid(direction)
        );
    ...
    /// <inheritdoc />
    [DebuggerStepThrough]
    IConventionStoredProcedureParameterBuilder? IConventionStoredProcedureParameterBuilder.HasName(
        string name,
        bool fromDataAnnotation
    ) =>
        HasName(
    ...
    /// <inheritdoc />
    [DebuggerStepThrough]
    bool IConventionStoredProcedureParameterBuilder.CanSetName(
        string? name,
        bool fromDataAnnotation
    ) =>
        CanSetName(
