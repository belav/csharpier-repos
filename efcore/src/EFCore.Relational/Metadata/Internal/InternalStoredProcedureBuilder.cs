        ...
        IConventionStoredProcedureBuilder
{
    ...
    {
        var sproc = (StoredProcedure?)
            StoredProcedure.FindDeclaredStoredProcedure(entityType, sprocType);
        if (sproc == null)
        {
            sproc =
                name == null
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public virtual InternalStoredProcedureBuilder? HasName(
        string? name,
    ...
    {
        if (CanSetName(name, configurationSource) && CanSetSchema(schema, configurationSource))
        {
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public virtual InternalStoredProcedureBuilder? HasSchema(
        string? schema,
        ConfigurationSource configurationSource
    )
    {
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public virtual bool CanHaveParameter(
        string propertyName,
        ConfigurationSource configurationSource
    ) =>
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public virtual bool CanHaveOriginalValueParameter(
        string propertyName,
        ConfigurationSource configurationSource
    ) =>
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public virtual bool CanHaveResultColumn(
        string propertyName,
        ConfigurationSource configurationSource
    ) =>
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public virtual InternalStoredProcedureBuilder? HasRowsAffectedReturn(
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public virtual bool CanHaveRowsAffectedReturn(
        bool rowsAffectedReturned,
        ConfigurationSource configurationSource
    ) =>
    ...
    /// <inheritdoc />
    [DebuggerStepThrough]
    IConventionStoredProcedureBuilder? IConventionStoredProcedureBuilder.HasAnnotation(
        string name,
        object? value,
        bool fromDataAnnotation
    ) =>
    ...
    /// <inheritdoc />
    [DebuggerStepThrough]
    IConventionStoredProcedureBuilder? IConventionStoredProcedureBuilder.HasNoAnnotation(
        string name,
        bool fromDataAnnotation
    ) =>
        (IConventionStoredProcedureBuilder?)
    ...
    /// <inheritdoc />
    [DebuggerStepThrough]
    IConventionStoredProcedureBuilder? IConventionStoredProcedureBuilder.HasName(
        string? name,
        bool fromDataAnnotation
    ) =>
        HasName(
    ...
    /// <inheritdoc />
    [DebuggerStepThrough]
    IConventionStoredProcedureParameterBuilder? IConventionStoredProcedureBuilder.HasParameter(
        string propertyName,
        bool fromDataAnnotation
    ) =>
        HasParameter(
    ...
    /// <inheritdoc />
    [DebuggerStepThrough]
    bool IConventionStoredProcedureBuilder.CanHaveParameter(
        string propertyName,
        bool fromDataAnnotation
    ) =>
        CanHaveParameter(
    ...
    /// <inheritdoc />
    [DebuggerStepThrough]
    bool IConventionStoredProcedureBuilder.CanHaveOriginalValueParameter(
        string propertyName,
        bool fromDataAnnotation
    ) =>
    ...
    /// <inheritdoc />
    [DebuggerStepThrough]
    IConventionStoredProcedureParameterBuilder? IConventionStoredProcedureBuilder.HasRowsAffectedParameter(
        bool fromDataAnnotation
    ) =>
    ...
    /// <inheritdoc />
    [DebuggerStepThrough]
    bool IConventionStoredProcedureBuilder.CanHaveResultColumn(
        string propertyName,
        bool fromDataAnnotation
    ) =>
        CanHaveResultColumn(
    ...
    /// <inheritdoc />
    [DebuggerStepThrough]
    bool IConventionStoredProcedureBuilder.CanHaveRowsAffectedResultColumn(
        bool fromDataAnnotation
    ) =>
        CanHaveRowsAffectedResultColumn(
            fromDataAnnotation ? ConfigurationSource.DataAnnotation : ConfigurationSource.Convention
        );
}
