        ...
        IConventionDbFunctionParameterBuilder
{
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public virtual bool CanSetPropagatesNullability(
        bool propagatesNullability,
        ConfigurationSource configurationSource
    ) =>
    ...
    /// <inheritdoc />
    [DebuggerStepThrough]
    IConventionDbFunctionParameterBuilder? IConventionDbFunctionParameterBuilder.HasNoAnnotation(
        string name,
        bool fromDataAnnotation
    ) =>
        (IConventionDbFunctionParameterBuilder?)
    ...
    /// <inheritdoc />
    [DebuggerStepThrough]
    bool IConventionDbFunctionParameterBuilder.CanSetStoreType(
        string? storeType,
        bool fromDataAnnotation
    ) =>
        CanSetStoreType(
    ...
    /// <inheritdoc />
    [DebuggerStepThrough]
    bool IConventionDbFunctionParameterBuilder.CanSetTypeMapping(
        RelationalTypeMapping? typeMapping,
        bool fromDataAnnotation
    ) =>
        CanSetTypeMapping(
