    ...
    public class AnnotationCodeGenerator : IAnnotationCodeGenerator
    {
        ...
        )
        {
            ...
            GenerateSimpleFluentApiCall(
                ...
                _entityTypeHasCommentMethodInfo,
                methodCallCodeFragments
            );
        ...
        )
        {
            ...
            GenerateSimpleFluentApiCall(
                ...
                _propertyHasColumnNameMethodInfo,
                methodCallCodeFragments
            );
            ...
            GenerateSimpleFluentApiCall(
                ...
                _propertyHasColumnOrderMethodInfo,
                methodCallCodeFragments
            );
            ...
            GenerateSimpleFluentApiCall(
                annotations,
                RelationalAnnotationNames.Collation,
                _propertyUseCollationMethodInfo,
                methodCallCodeFragments
            );
        ...
        private IEnumerable<TCodeFragment> GenerateFluentApiCallsHelper<
            TAnnotatable,
            TCodeFragment
        >(
