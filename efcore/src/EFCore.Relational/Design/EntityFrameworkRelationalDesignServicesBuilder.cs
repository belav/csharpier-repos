...
/// <summary>
///     A builder API designed for database providers to use when implementing <see
// cref="IDesignTimeServices" />.
/// </summary>
/// <remarks>
///     <para>
...
public class EntityFrameworkRelationalDesignServicesBuilder : EntityFrameworkDesignServicesBuilder
{
    ...
    /// <summary>
    ///     Registers default implementations of all services, including relational services, not
    // already
