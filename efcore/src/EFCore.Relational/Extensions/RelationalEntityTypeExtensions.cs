    ...
    public static class RelationalEntityTypeExtensions
    {
        ...
        public static string? GetTableName(this IReadOnlyEntityType entityType)
        {
            ...
            return
                ...
                && (
                    (entityType as IConventionEntityType)?.GetFunctionNameConfigurationSource()
                    == null
                )
#pragma warning disable CS0618 // Type or member is obsolete
                && (
                    (entityType as IConventionEntityType)?.GetDefiningQueryConfigurationSource()
                    == null
                )
...
#pragma warning restore EF1001 // Internal EF Core API usage.
        ...
        public static IEnumerable<ITableMappingBase> GetDefaultMappings(
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        public static IEnumerable<ISqlQueryMapping> GetSqlQueryMappings(
            this IEntityType entityType
        ) =>
        ...
        /// <param name="entityType">The entity type to get the function mappings for.</param>
        /// <returns>The functions to which the entity type is mapped.</returns>
        public static IEnumerable<IFunctionMapping> GetFunctionMappings(
            this IEntityType entityType
        ) =>
        ...
        public static IConventionCheckConstraint? FindCheckConstraint(
            ...
            (IConventionCheckConstraint?)
                ((IReadOnlyEntityType)entityType).FindCheckConstraint(name);
        ...
        public static IEnumerable<IConventionCheckConstraint> GetDeclaredCheckConstraints(
            ...
            CheckConstraint
                ...
                .Cast<IConventionCheckConstraint>();
...
#pragma warning restore EF1001 // Internal EF Core API usage.
        ...
        public static bool IsTableExcludedFromMigrations(this IReadOnlyEntityType entityType)
        {
            ...
            var excluded = (bool?)
                entityType[RelationalAnnotationNames.IsTableExcludedFromMigrations];
            if (excluded != null)
            {
