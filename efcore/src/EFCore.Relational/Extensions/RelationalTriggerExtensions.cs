...
public static class RelationalTriggerExtensions
{
    ...
    )
    {
        ...
        return annotation != null
            ...
            : trigger.GetDefaultDatabaseName(storeObject);
    }
    ...
    public static string? GetDefaultDatabaseName(
        ...
        storeObject.StoreObjectType == StoreObjectType.Table
            ? Uniquifier.Truncate(
                trigger.ModelName,
                trigger.EntityType.Model.GetMaxIdentifierLength()
            )
            : null;
    ...
    {
        if (
            trigger.FindAnnotation(RelationalAnnotationNames.TableName) is
        ...
        Check.DebugAssert(
            mainTableName is not null,
            "Trigger defined on entity not mapped to a table"
        );
    ...
    /// <param name="trigger">The trigger.</param>
    /// <returns>The configuration source for the database name.</returns>
    public static ConfigurationSource? GetTableSchemaConfigurationSource(
        this IConventionTrigger trigger
