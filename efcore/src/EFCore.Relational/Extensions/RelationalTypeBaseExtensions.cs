...
public static class RelationalTypeBaseExtensions
{
    ...
    public static IEnumerable<ITableMappingBase> GetDefaultMappings(this ITypeBase typeBase) =>
        (IEnumerable<ITableMappingBase>?)
            typeBase.FindRuntimeAnnotationValue(RelationalAnnotationNames.DefaultMappings)
    ...
    public static IEnumerable<ISqlQueryMapping> GetSqlQueryMappings(this ITypeBase typeBase) =>
        (IEnumerable<ISqlQueryMapping>?)
            typeBase.FindRuntimeAnnotationValue(RelationalAnnotationNames.SqlQueryMappings)
    ...
    public static IEnumerable<IFunctionMapping> GetFunctionMappings(this ITypeBase typeBase) =>
        (IEnumerable<IFunctionMapping>?)
            typeBase.FindRuntimeAnnotationValue(RelationalAnnotationNames.FunctionMappings)
    ...
    public static IReadOnlyStoredProcedure? GetDeleteStoredProcedure(
    ...
    /// <param name="typeBase">The type.</param>
    /// <returns>The stored procedure to which the type is mapped.</returns>
    public static IReadOnlyStoredProcedure? GetInsertStoredProcedure(
        this IReadOnlyTypeBase typeBase
    ...
    /// <param name="typeBase">The type.</param>
    /// <returns>The stored procedure to which the type is mapped.</returns>
    public static IReadOnlyStoredProcedure? GetUpdateStoredProcedure(
        this IReadOnlyTypeBase typeBase
    ...
    public static IEnumerable<IStoredProcedureMapping> GetInsertStoredProcedureMappings(
    ...
    public static IEnumerable<IStoredProcedureMapping> GetDeleteStoredProcedureMappings(
        this ITypeBase typeBase
    ) =>
        (IEnumerable<IStoredProcedureMapping>?)
            typeBase.FindRuntimeAnnotationValue(
    ...
    public static IEnumerable<IStoredProcedureMapping> GetUpdateStoredProcedureMappings(
        this ITypeBase typeBase
    ) =>
        (IEnumerable<IStoredProcedureMapping>?)
            typeBase.FindRuntimeAnnotationValue(
