...
namespace Microsoft.EntityFrameworkCore
{
    ...
    public static class RelationalModelExtensions
    {
        ...
        public static ConfigurationSource? GetDefaultSchemaConfigurationSource(
            this IConventionModel model
        ) =>
        ...
        public static IRelationalModel GetRelationalModel(this IModel model)
        {
            ...
            if (databaseModel == null)
            {
                throw new InvalidOperationException(
                    CoreStrings.ModelNotFinalized(nameof(GetRelationalModel))
                );
            }
        ...
        public static int GetMaxIdentifierLength(this IReadOnlyModel model) =>
            (int?)Check.NotNull(model, nameof(model))[RelationalAnnotationNames.MaxIdentifierLength]
            ?? short.MaxValue;
        ...
        public static ConfigurationSource? GetMaxIdentifierLengthConfigurationSource(
            this IConventionModel model
        ) =>
        ...
        public static IConventionSequence? RemoveSequence(
            ...
            Sequence.RemoveSequence(
                (IMutableModel)Check.NotNull(model, nameof(model)),
                name,
                schema
            );
        ...
        /// <param name="method"> The <see cref="MethodInfo" /> for the method that is mapped to the function. </param>
        /// <returns> The function or <see langword="null" /> if the method is not mapped. </returns>
        public static IMutableDbFunction? FindDbFunction(
            this IMutableModel model,
            MethodInfo method
        ...
        public static IEnumerable<IMutableDbFunction> GetDbFunctions(this IMutableModel model) =>
            DbFunction
                .GetDbFunctions((Model)Check.NotNull(model, nameof(model)))
                .Cast<IMutableDbFunction>();

        /// <summary>
        ///     Returns all functions contained in the model.
        /// </summary>
        /// <param name="model"> The model to get the functions in. </param>
        public static IEnumerable<IConventionDbFunction> GetDbFunctions(
            this IConventionModel model
        ) =>
            DbFunction
                .GetDbFunctions((Model)Check.NotNull(model, nameof(model)))
                .Cast<IConventionDbFunction>();
