...
/// <summary>
///     <para>
///         The relational type mapping source. Type mappings describe how a provider maps CLR
// types/values to database types/values.
///     </para>
///     <para>
...
///     </para>
///     <para>
///         Warning: do not implement this interface directly. Instead, derive from <see
// cref="RelationalTypeMappingSource" />.
///     </para>
/// </summary>
/// <remarks>
///     <para>
...
public interface IRelationalTypeMappingSource : ITypeMappingSource
{
    ...
    /// <param name="unicode">
    ///     Specify <see langword="true" /> for Unicode mapping, <see langword="false" /> for Ansi
    // mapping or <see langword="null" /> for the
    ///     default.
    /// </param>
