...
{
    /// <summary>
    ///     Gets the underlying <see cref="DbTransaction" /> for the given transaction. Throws if the
    // database being targeted
    ...
    // more information and examples.
    /// </remarks>
    /// <param name="dbContextTransaction">The transaction to get the <see cref="DbTransaction" />
    // from.</param>
