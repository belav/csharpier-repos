...
/// <summary>
///     <para>
///         Supports specifying property and value to be set in ExecuteUpdate method with chaining
// multiple calls for updating
///         multiple columns.
///     </para>
///     <para>
///         This type does not have any constructor or implementation since it is used inside LINQ
// query solely for the purpose of
...
/// </remarks>
/// <typeparam name="TSource">The type of source element on which ExecuteUpdate operation is being
// applied.</typeparam>
public sealed class SetPropertyCalls<TSource>
{
    ...
    ///     <see cref="SetPropertyCalls{TSource}.SetProperty{TProperty}(Func{TSource, TProperty},
