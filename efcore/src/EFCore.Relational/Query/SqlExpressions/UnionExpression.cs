...
public class UnionExpression : SetOperationBase
{
    ...
    /// <param name="distinct">A bool value indicating whether result will remove duplicate
    // rows.</param>
    ...
    /// </summary>
    /// <param name="source1">The <see cref="SetOperationBase.Source1" /> property of the
    // result.</param>
    /// <param name="source2">The <see cref="SetOperationBase.Source2" /> property of the
    // result.</param>
