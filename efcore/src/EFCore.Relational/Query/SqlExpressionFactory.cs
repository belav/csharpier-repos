...
#pragma warning restore IDE0046 // Convert to conditional expression
        ...
        /// <inheritdoc />
        public virtual SqlBinaryExpression LessThanOrEqual(
            SqlExpression left,
            SqlExpression right
        ...
        )
        {
            var operandTypeMapping =
                ...
                ?? new[] { operand.Type }
                    ...
                    .Select(t => Dependencies.TypeMappingSource.FindMapping(t, Dependencies.Model))
                    .FirstOrDefault();
        ...
        public virtual InExpression In(SqlExpression item, SqlExpression values, bool negated)
        {
            var typeMapping =
                item.TypeMapping
                ?? Dependencies.TypeMappingSource.FindMapping(item.Type, Dependencies.Model);
        ...
        private void AddSelfConditions(
        ...
        )
        {
            ...
            if (table != null && table.IsOptional(entityType) && !discriminatorAdded)
            {
        ...
        private bool AddDiscriminatorCondition(
            SelectExpression selectExpression,
            IEntityType entityType
        )
        {
            ...
            {
                return entityType.BaseType?.GetDirectlyDerivedTypes().Any(i => i != entityType)
                    == true;
            }
        }
        ...
        private EntityProjectionExpression GetMappedEntityProjectionExpression(
            SelectExpression selectExpression
        ) =>
