...
/// <summary>
///     Contains extension methods on <see cref="DbFunctions" /> for the
// Microsoft.EntityFrameworkCore.SqlServer.NetTopologySuite library.
/// </summary>
public static class SqlServerNetTopologySuiteDbFunctionsExtensions
{
    /// <summary>
    ///     Maps to the SQL Server <c>STCurveToLine</c> function which returns a polygonal approximation
    // of an instance that contains circular arc
    ///     segments.
    /// </summary>
