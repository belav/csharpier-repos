...
namespace Microsoft.EntityFrameworkCore.SqlServer.Query.Internal
{
    ...
    {
        private static readonly IDictionary<MemberInfo, string> _memberToPropertyName =
        ...
        private static readonly IDictionary<MemberInfo, string> _geographyMemberToPropertyName =
            new Dictionary<MemberInfo, string>
            {
        ...
        private static readonly IDictionary<MemberInfo, string> _geometryMemberToPropertyName =
            new Dictionary<MemberInfo, string>
            {
