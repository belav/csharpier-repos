...
public class CosmosClientWrapper : ICosmosClientWrapper
{
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public virtual Task<bool> DeleteDatabaseAsync(CancellationToken cancellationToken = default) =>
    ...
    )
    {
        using var response = await wrapper
            .Client.GetDatabase(wrapper._databaseId)
            ...
            .CreateContainerStreamAsync(
                new Azure.Cosmos.ContainerProperties(parameters.Id, "/" + parameters.PartitionKey)
                {
                    ...
                    AnalyticalStoreTimeToLiveInSeconds =
                        parameters.AnalyticalStoreTimeToLiveInSeconds,
                },
    ...
    public virtual Task<bool> CreateItemAsync(
        ...
        _executionStrategy.ExecuteAsync(
            (containerId, document, updateEntry, this),
            CreateItemOnceAsync,
            null,
            cancellationToken
        );
    ...
    )
    {
        ...
        var itemRequestOptions = CreateItemRequestOptions(
            entry,
            wrapper._enableContentResponseOnWrite
        );
    ...
    public virtual bool ReplaceItem(
        ...
        _executionStrategy.Execute(
            (collectionId, documentId, document, entry, this),
            ReplaceItemOnce,
            null
        );
    ...
    public virtual Task<bool> ReplaceItemAsync(
        ...
        _executionStrategy.ExecuteAsync(
            (collectionId, documentId, document, updateEntry, this),
    ...
    public virtual Task<bool> DeleteItemAsync(
        ...
        _executionStrategy.ExecuteAsync(
            (containerId, documentId, entry, this),
            DeleteItemOnceAsync,
            null,
            cancellationToken
        );
    ...
    private static ItemRequestOptions? CreateItemRequestOptions(
        IUpdateEntry entry,
    ...
    private static void ProcessResponse(ResponseMessage response, IUpdateEntry entry)
    {
        ...
        if (
            jObjectProperty is { ValueGenerated: ValueGenerated.OnAddOrUpdate }
    ...
    )
    {
        ...
        var response = _executionStrategy.Execute(
    ...
    )
    {
        ...
        var response = await _executionStrategy
            .ExecuteAsync(
                (containerId, partitionKey, resourceId, this),
