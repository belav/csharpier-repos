...
public static class CosmosQueryableExtensions
{
    ...
    /// <remarks>
    ///     <para>
    ///         The returned <see cref="IQueryable{T}" /> can be composed over using LINQ to build more
    // complex queries.
    ///     </para>
    ///     <para>
    ...
    ///         arguments. Any parameter values you supply will automatically be converted to a Cosmos
    // parameter.
    ///     </para>
    ///     <para>
    ///         See <see href="https://aka.ms/efcore-docs-query">Querying data with EF Core</see>, and
    ///         <see href="https://aka.ms/efcore-docs-cosmos">Accessing Azure Cosmos DB with EF
    // Core</see> for more information
    ///         and examples.
    ///     </para>
    /// </remarks>
