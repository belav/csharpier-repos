...
"""
    ...
    protected virtual Task Test(
        ...
        MigrationsSqlGenerationOptions migrationsSqlGenerationOptions =
    ...
    )
    {
        ...
        var migrationsCodeGenerator = Fixture.TestHelpers
        ...
        var sourceModelSnapshot = migrationsCodeGenerator.GenerateSnapshot(
            ...
            typeof(DbContext),
            "MigrationsTestSnapshot",
            preSnapshotSourceModel
        );
    ...
    private ModelBuilder CreateModelBuilder(bool withConventions) =>
        withConventions
            ? Fixture.TestHelpers.CreateConventionBuilder()
    ...
    protected IModel BuildModelFromSnapshotSource(string code)
    {
        ...
        var databaseProvider = Fixture.TestHelpers
