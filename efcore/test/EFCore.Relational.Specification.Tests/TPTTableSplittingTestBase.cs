...
public abstract class TPTTableSplittingTestBase : TableSplittingTestBase
{
    ...
    public override Task ExecuteDelete_throws_for_table_sharing(bool async) => Task.CompletedTask;
    ...
    public override async Task ExecuteUpdate_works_for_table_sharing(bool async) =>
        Assert.Contains(
            RelationalStrings.NonQueryTranslationFailedWithDetails(
                "",
                RelationalStrings.ExecuteOperationOnTPT("ExecuteUpdate", "Vehicle")
            )[21..],
            (
    ...
    protected override string StoreName => "TPTTableSplittingTest";
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder
            .Entity<Engine>()
            .ToTable("PoweredVehicles")
            .HasOne(e => e.Vehicle)
            .WithOne(e => e.Engine)
            .OnDelete(DeleteBehavior.ClientCascade);
        modelBuilder.Entity<CombustionEngine>().ToTable("CombustionEngines");
        modelBuilder
            .Entity<IntermittentCombustionEngine>()
            .ToTable("IntermittentCombustionEngines");
