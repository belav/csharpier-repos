...
public class PrimitiveCollectionsQueryRelationalTestBase<TFixture>
    : PrimitiveCollectionsQueryTestBase<TFixture>
    where TFixture : PrimitiveCollectionsQueryTestBase<TFixture>.PrimitiveCollectionsQueryFixtureBase,
        new()
{
