    ...
    where TFixture : NullSemanticsQueryFixtureBase, new()
{
    ...
    public virtual async Task Where_conditional_search_condition_in_result(bool async)
    {
        ...
        await AssertQueryScalar(
            ...
            ss =>
                ss.Set<NullSemanticsEntity1>()
                    .Where(e => !prm ? true : e.StringA.StartsWith("A"))
                    .Select(e => e.Id)
        );
    }
        ...
        AssertQueryScalar(
            ...
            ss =>
                ss.Set<NullSemanticsEntity1>()
                    .Where(
                        e =>
                            e.NullableStringA.Maybe(x => x.Substring(0, e.IntA))
                            != e.NullableStringB
                    )
                    .Select(e => e.Id)
        );
    ...
    public virtual async Task Null_semantics_contains_non_nullable_argument(bool async)
    {
        ...
        await AssertQueryScalar(
            async,
            ss => ss.Set<NullSemanticsEntity1>().Where(e => ids3.Contains(e.IntA)).Select(e => e.Id)
        );
        await AssertQueryScalar(
            async,
            ss =>
        ...
        await AssertQueryScalar(
            async,
            ss => ss.Set<NullSemanticsEntity1>().Where(e => ids4.Contains(e.IntA)).Select(e => e.Id)
        );
        await AssertQueryScalar(
            async,
            ss =>
    ...
    public virtual Task Nullable_column_info_propagates_inside_conditional(bool async) =>
        AssertQueryScalar(
            ...
            ss =>
                ss.Set<NullSemanticsEntity1>()
                    .Select(
                        e => e.NullableStringA != null ? e.NullableStringA != e.StringA : e.BoolA
                    )
        );
    ...
    public virtual Task Nullable_string_FirstOrDefault_compared_to_nullable_string_LastOrDefault(
        ...
        AssertQuery(
            ...
            ss =>
                ss.Set<NullSemanticsEntity1>()
                    .Where(
                        e => e.NullableStringA.FirstOrDefault() == e.NullableStringB.LastOrDefault()
                    ),
            ss =>
                ss.Set<NullSemanticsEntity1>()
                    .Where(
    ...
    public virtual Task Multiple_non_equality_comparisons_with_null_in_the_middle(bool async) =>
        AssertQuery(
            ...
            ss =>
                ss.Set<NullSemanticsEntity1>()
                    .Where(
                        e => e.NullableIntA != 1 && e.NullableIntA != null && e.NullableIntA != 2
                    )
        );
