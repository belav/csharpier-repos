    ...
    where TFixture : JsonQueryFixtureBase, new()
{
    ...
    public virtual Task Basic_json_projection_owner_entity(bool async) =>
        AssertQuery(async, ss => ss.Set<JsonEntityBasic>(), entryCount: 40);
    ...
    public virtual Task Custom_naming_projection_owner_entity(bool async) =>
        AssertQuery(async, ss => ss.Set<JsonEntityCustomNaming>().Select(x => x), entryCount: 13);
    ...
    public virtual Task Project_entity_with_single_owned(bool async) =>
        AssertQuery(async, ss => ss.Set<JsonEntitySingleOwned>(), entryCount: 8);
    ...
    public virtual Task Json_entity_with_inheritance_basic_projection(bool async) =>
        AssertQuery(async, ss => ss.Set<JsonEntityInheritanceBase>(), entryCount: 38);
                ...
                ss.Set<JsonEntityBasic>()
                    .Select(
                        x =>
                            ...
                            {
                                x.Id,
                                x.OwnedCollectionRoot[0].OwnedCollectionBranch[
                                    prm
                                ].OwnedCollectionLeaf
                            }
                    )
        ...
        return AssertQuery(
            ...
            ss =>
                ss.Set<JsonEntityBasic>()
                    .Where(
                        x =>
                            x.OwnedCollectionRoot[1].OwnedCollectionBranch[prm].OwnedCollectionLeaf[
                                x.Id - 1
                ...
                ss.Set<JsonEntityBasic>()
                    .Select(
                        x =>
                            ...
                            {
                                x.Id,
                                CollectionElement = x.OwnedCollectionRoot
                                    .Select(xx => xx.Number)
                                    .ElementAt(0)
                            }
                    )
                    ...
                    .Where(
                        j =>
                            j.OwnedReferenceRoot.OwnedCollectionBranch.Any(
                                b => b.OwnedReferenceLeaf.SomethingSomething == "e1_c2_c1_c1"
                            )
                    )
        );
                ...
                ss.Set<JsonEntityBasic>()
                    .Select(
                        x =>
                            ...
                            {
                                x.Id,
                                CollectionElement = x.OwnedCollectionRoot[prm].OwnedCollectionBranch
                                    .Select(xx => "Foo")
                                    .ElementAt(0)
                            }
                    )
            ...
            ss =>
                ss.Set<JsonEntityBasic>()
                    ...
                    .Select(
                        x =>
                            x.OwnedCollectionRoot
                                .Select(xx => xx.OwnedCollectionBranch)
                                .ElementAt(0)
                    ),
            elementAsserter: (e, a) =>
            {
            ...
            ss =>
                ss.Set<JsonEntityBasic>()
                    ...
                    .Select(
                        x =>
                            x.OwnedCollectionRoot
                                .Select(xx => new { xx.OwnedReferenceBranch })
                                .ElementAt(0)
                    ),
            assertOrder: true,
            elementAsserter: (e, a) =>
            ...
            ss =>
                ss.Set<JsonEntityBasic>()
                    .Select(
                        x =>
                            x.OwnedCollectionRoot
                                .Select(xx => new JsonEntityBasic { Id = x.Id })
                                .ElementAt(0)
                    )
        );
                    ...
                    .Select(
                        x =>
                            new
                            {
                                ...
                                CollectionElement2 = x.OwnedCollectionRoot[1].OwnedCollectionBranch[
                                    1
                                ].OwnedReferenceLeaf,
                                ...
                                CollectionElement6 = x.OwnedCollectionRoot[
                                    x.Id
                                ].OwnedCollectionBranch[1].OwnedReferenceLeaf,
                        ...
                        x =>
                            new
                            {
                                ...
                                Reference3 = x.OwnedCollectionRoot[1]
                                    .OwnedReferenceBranch
                                    .OwnedReferenceLeaf,
                                Reference4 = x.OwnedCollectionRoot[0].OwnedCollectionBranch[
                                    0
                                ].OwnedReferenceLeaf,
                            }
                    )
    ...
    public virtual Task Json_all_types_entity_projection(bool async) =>
        AssertQuery(async, ss => ss.Set<JsonEntityAllTypes>(), entryCount: 6);
