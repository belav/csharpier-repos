        ...
        IQueryFixtureBase
{
                ...
                (e, a) =>
                {
                    ...
                    if (a != null)
                    {
                        ...
                        if (ee.OwnedReferenceRoot is not null || aa.OwnedReferenceRoot is not null)
                        {
                            ...
                            Assert.Equal(
                                ee.OwnedCollectionRoot.Count,
                                aa.OwnedCollectionRoot.Count
                            );
    ...
    public static void AssertAllTypes(JsonOwnedAllTypes expected, JsonOwnedAllTypes actual)
    {
        ...
        Assert.Equal(
            expected.TestNullableEnumWithIntConverter,
            actual.TestNullableEnumWithIntConverter
        );
        Assert.Equal(
            expected.TestNullableEnumWithConverterThatHandlesNulls,
            actual.TestNullableEnumWithConverterThatHandlesNulls
        );

        AssertPrimitiveCollection(
            expected.TestDefaultStringCollection,
            actual.TestDefaultStringCollection
        );
        AssertPrimitiveCollection(
            expected.TestMaxLengthStringCollection,
            actual.TestMaxLengthStringCollection
        );
        ...
        AssertPrimitiveCollection(
            expected.TestDateTimeOffsetCollection,
            actual.TestDateTimeOffsetCollection
        );
        ...
        AssertPrimitiveCollection(
            expected.TestSignedByteCollection,
            actual.TestSignedByteCollection
        );
        ...
        AssertPrimitiveCollection(
            expected.TestUnsignedInt16Collection,
            actual.TestUnsignedInt16Collection
        );
        AssertPrimitiveCollection(
            expected.TestUnsignedInt32Collection,
            actual.TestUnsignedInt32Collection
        );
        AssertPrimitiveCollection(
            expected.TestUnsignedInt64Collection,
            actual.TestUnsignedInt64Collection
        );
        AssertPrimitiveCollection(
            expected.TestNullableInt32Collection,
            actual.TestNullableInt32Collection
        );
        AssertPrimitiveCollection(expected.TestEnumCollection, actual.TestEnumCollection);
        AssertPrimitiveCollection(
            expected.TestEnumWithIntConverterCollection,
            actual.TestEnumWithIntConverterCollection
        );
        AssertPrimitiveCollection(
            expected.TestNullableEnumCollection,
            actual.TestNullableEnumCollection
        );
        AssertPrimitiveCollection(
            expected.TestNullableEnumWithIntConverterCollection,
            actual.TestNullableEnumWithIntConverterCollection
        );
        AssertPrimitiveCollection(
    ...
    public static void AssertConverters(JsonOwnedConverters expected, JsonOwnedConverters actual)
    {
        ...
        Assert.Equal(
            expected.BoolConvertedToStringTrueFalse,
            actual.BoolConvertedToStringTrueFalse
        );
        ...
        Assert.Equal(
            expected.StringTrueFalseConvertedToBool,
            actual.StringTrueFalseConvertedToBool
        );
