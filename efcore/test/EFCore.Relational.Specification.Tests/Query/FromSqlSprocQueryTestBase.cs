...
namespace Microsoft.EntityFrameworkCore.Query
{
        ...
        where TFixture : NorthwindQueryRelationalFixture<NoopModelCustomizer>, new()
    {
        ...
        [InlineData(false)]
        [InlineData(true)]
        public virtual async Task From_sql_queryable_stored_procedure_with_caller_info_tag(
            bool async
        )
        {
            using var context = CreateContext();
            ...
            var queryResult = async ? await query.ToArrayAsync() : query.ToArray();
        ...
        [InlineData(false)]
        [InlineData(true)]
        public virtual async Task From_sql_queryable_stored_procedure_with_caller_info_tag_and_other_tags(
            bool async
        )
        {
            using var context = CreateContext();
