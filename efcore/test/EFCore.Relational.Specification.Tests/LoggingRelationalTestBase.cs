    ...
    where TExtension : RelationalOptionsExtension, new()
{
    ...
    {
        using var context = new IndexPropertiesBothMappedAndNotMappedToTableContext(
        ...
        Assert.Equal(
            CoreStrings.WarningAsErrorTemplate(
                ...
                RelationalResources
                    .LogUnnamedIndexPropertiesBothMappedAndNotMappedToTable(CreateTestLogger())
    ...
    {
        public IndexPropertiesBothMappedAndNotMappedToTableContext(
    ...
    public virtual void UnnamedIndexPropertiesMappedToNonOverlappingTables_throws_by_default()
    {
        ...
        Assert.Equal(
            CoreStrings.WarningAsErrorTemplate(
                ...
                RelationalResources
                    .LogUnnamedIndexPropertiesMappedToNonOverlappingTables(CreateTestLogger())
                    .GenerateMessage(
                        nameof(Cat),
                        "{'Name', 'Identity'}",
                        nameof(Animal.Name),
    ...
    {
        public UnnamedIndexPropertiesMappedToNonOverlappingTablesContext(
            DbContextOptionsBuilder optionsBuilder
        )
            : base(optionsBuilder.Options) { }
    ...
    {
        using var context = new ForeignKeyPropertiesMappedToUnrelatedTablesContext(
            CreateOptionsBuilder(new ServiceCollection())
        );
    ...
    {
        public ForeignKeyPropertiesMappedToUnrelatedTablesContext(
            DbContextOptionsBuilder optionsBuilder
        )
            : base(optionsBuilder.Options) { }
