...
public class JsonTypesRelationalTestBase : JsonTypesTestBase
{
    [ConditionalTheory]
    [InlineData(null)]
    public virtual void Can_read_write_collection_of_fixed_length_string_JSON_values(
        object? storeType
    ) =>
        Can_read_and_write_JSON_collection_value<StringCollectionType, List<string>>(
            ...
            new List<string> { "MinValue", "Value", "MaxValue" },
    ...
    protected override void AssertElementFacets(
    ...
    )
    {
        ...
        var expectedStoreType =
            FacetValue(RelationalAnnotationNames.StoreType)
