...
public abstract class StoredProcedureUpdateTestBase : NonSharedModelTestBase
{
    ...
    protected async Task Insert_with_two_result_columns(bool async, string createSprocSql)
    {
        ...
        using (TestSqlLoggerFactory.SuspendRecordingEvents())
        {
            Assert.Equal(
                "Foo",
                context.Set<EntityWithAdditionalProperty>().Single(b => b.Id == entity.Id).Name
            );
        }
    }
    ...
    protected async Task Insert_with_output_parameter_and_result_column(
        bool async,
    ...
    protected async Task Update_partial(bool async, string createSprocSql)
    {
        var contextFactory = await InitializeAsync<DbContext>(
            modelBuilder =>
                modelBuilder
                    .Entity<EntityWithAdditionalProperty>()
                    .UpdateUsingStoredProcedure(
        ...
        using (TestSqlLoggerFactory.SuspendRecordingEvents())
        {
            var actual = await context
                .Set<EntityWithAdditionalProperty>()
    ...
    protected async Task Update_with_output_parameter_and_rows_affected_result_column(
        bool async,
        string createSprocSql
    )
    {
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public abstract Task Update_with_output_parameter_and_rows_affected_result_column_concurrency_failure(
        bool async
    );

    protected async Task Update_with_output_parameter_and_rows_affected_result_column_concurrency_failure(
        bool async,
        string createSprocSql
    )
    {
    ...
    protected async Task Rows_affected_parameter_and_concurrency_failure(
        bool async,
        string createSprocSql
    )
    {
    ...
    protected async Task Rows_affected_result_column_and_concurrency_failure(
        bool async,
        string createSprocSql
    )
    {
    ...
    protected async Task Rows_affected_return_value_and_concurrency_failure(
        bool async,
        string createSprocSql
    )
    {
    ...
    protected async Task Store_generated_concurrency_token_as_in_out_parameter(
        bool async,
        string createSprocSql
    )
    {
    ...
    protected async Task Store_generated_concurrency_token_as_two_parameters(
        bool async,
        string createSprocSql
    )
    {
    ...
    protected async Task Original_and_current_value_on_non_concurrency_token(
        bool async,
        string createSprocSql
    )
    {
    ...
    protected async Task Input_or_output_parameter_with_input(bool async, string createSprocSql)
    {
        ...
        using (TestSqlLoggerFactory.SuspendRecordingEvents())
        {
            Assert.Same(
                ...
                await context
                    .Set<Entity>()
                    .SingleAsync(w => w.Id == entity.Id && w.Name == "Initial")
            );
        }
    }
    ...
    protected async Task Input_or_output_parameter_with_output(bool async, string createSprocSql)
    {
        ...
        using (TestSqlLoggerFactory.SuspendRecordingEvents())
        {
            Assert.Same(
                ...
                await context
                    .Set<Entity>()
                    .SingleAsync(w => w.Id == entity.Id && w.Name == "Some default value")
            );
        }
    }
    ...
    protected async Task Non_sproc_followed_by_sproc_commands_in_the_same_batch(
        bool async,
        string createSprocSql
    )
    {
        ...
        using (TestSqlLoggerFactory.SuspendRecordingEvents())
        {
            Assert.Equal(
                "Entity2",
                context.Set<EntityWithAdditionalProperty>().Single(b => b.Id == entity2.Id).Name
            );
        }
    }
    ...
    protected virtual void ClearLog() => TestSqlLoggerFactory.Clear();
