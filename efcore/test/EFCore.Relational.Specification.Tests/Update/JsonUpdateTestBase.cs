    ...
    where TFixture : JsonUpdateFixtureBase, new()
{
        ...
        TestHelpers.ExecuteWithStrategyInTransactionAsync(
                ...
                var newEntity = new JsonEntityBasic
                {
                    ...
                    OwnedReferenceRoot = new JsonOwnedRoot
                    {
                        ...
                        OwnedReferenceBranch = new JsonOwnedBranch
                        {
                            ...
                            {
                                new() { SomethingSomething = "ss1" },
                                new() { SomethingSomething = "ss2" },
                            },
            ...
            async context =>
            {
                ...
                Assert.Equal(
                    ...
                    newEntity.OwnedReferenceRoot.OwnedReferenceBranch.Date
                );
                Assert.Equal(
                    JsonEnum.Three,
                    newEntity.OwnedReferenceRoot.OwnedReferenceBranch.Enum
                );
    ...
    public virtual Task Add_json_reference_root() =>
        TestHelpers.ExecuteWithStrategyInTransactionAsync(
            ...
            async context =>
            {
                ...
                Assert.Equal(
                    new DateTime(2010, 10, 10),
                    updatedReference.OwnedReferenceBranch.Date
                );
                ...
                Assert.Equal(
                    "ss3",
                    updatedReference.OwnedReferenceBranch.OwnedReferenceLeaf.SomethingSomething
                );
    ...
    public virtual Task Add_element_to_json_collection_root() =>
        TestHelpers.ExecuteWithStrategyInTransactionAsync(
            ...
            async context =>
            {
                ...
                Assert.Equal(
                    new DateTime(2010, 10, 10),
                    updatedCollection[2].OwnedReferenceBranch.Date
                );
                ...
                Assert.Equal(
                    "ss3",
                    updatedCollection[2].OwnedReferenceBranch.OwnedReferenceLeaf.SomethingSomething
                );
    ...
    public virtual Task Delete_json_reference_leaf() =>
        TestHelpers.ExecuteWithStrategyInTransactionAsync(
            ...
            async context =>
            {
                var updatedEntity = await context.JsonEntitiesBasic.SingleAsync();
                Assert.Null(
                    updatedEntity.OwnedReferenceRoot.OwnedReferenceBranch.OwnedReferenceLeaf
                );
            }
        );
    ...
    public virtual Task Edit_element_in_json_collection_branch() =>
        TestHelpers.ExecuteWithStrategyInTransactionAsync(
            ...
            async context =>
            {
                var query = await context.JsonEntitiesBasic.ToListAsync();
                var entity = query.Single();
                entity.OwnedCollectionRoot[0].OwnedCollectionBranch[0].Date = new DateTime(
                    2111,
                    11,
                    11
                );
            ...
            async context =>
            {
                var result = await context.Set<JsonEntityBasic>().SingleAsync();
                Assert.Equal(
                    new DateTime(2111, 11, 11),
                    result.OwnedCollectionRoot[0].OwnedCollectionBranch[0].Date
                );
            }
        );
        ...
        TestHelpers.ExecuteWithStrategyInTransactionAsync(
            ...
            async context =>
            {
                ...
                entity
                    ...
                    .SomethingSomething = "yet another change";
                entity
                    .OwnedCollectionRoot[0]
                    .OwnedCollectionBranch[1]
                    .OwnedCollectionLeaf[1]
                    .SomethingSomething = "and another";
                entity
                    .OwnedCollectionRoot[0]
                    .OwnedCollectionBranch[0]
                    .OwnedCollectionLeaf[0]
            ...
            async context =>
            {
                ...
                Assert.Equal(
                    new DateTime(2111, 11, 11),
                    result.OwnedReferenceRoot.OwnedReferenceBranch.Date
                );
    ...
    public virtual Task Edit_element_in_json_branch_collection_and_add_element_to_the_same_collection() =>
        TestHelpers.ExecuteWithStrategyInTransactionAsync(
            ...
            async context =>
            {
                ...
                Assert.Equal(
                    new DateTime(2222, 11, 11),
                    result.OwnedReferenceRoot.OwnedCollectionBranch[2].Date
                );
                Assert.Equal(
                    JsonEnum.Three,
                    result.OwnedReferenceRoot.OwnedCollectionBranch[2].Enum
                );
    ...
    public virtual Task Edit_single_enum_property() =>
        TestHelpers.ExecuteWithStrategyInTransactionAsync(
            ...
            async context =>
            {
                ...
                Assert.Equal(
                    JsonEnum.Two,
                    result.OwnedCollectionRoot[1].OwnedCollectionBranch[1].Enum
                );
            }
        );
        ...
        TestHelpers.ExecuteWithStrategyInTransactionAsync(
            ...
            async context =>
            {
                ...
                Assert.Equal(
                    ...
                    result.Collection[0].TestDateTime
                );
            }
        );
    ...
    public virtual Task Edit_single_property_datetimeoffset() =>
        TestHelpers.ExecuteWithStrategyInTransactionAsync(
            ...
            async context =>
            {
                var query = await context.JsonEntitiesAllTypes.ToListAsync();
                var entity = query.Single(x => x.Id == 1);
                entity.Reference.TestDateTimeOffset = new DateTimeOffset(
                    DateTime.Parse("01/01/3000 12:34:56"),
    ...
    public virtual Task Edit_single_property_guid() =>
        TestHelpers.ExecuteWithStrategyInTransactionAsync(
            ...
            async context =>
            {
                var result = await context.Set<JsonEntityAllTypes>().SingleAsync(x => x.Id == 1);
                Assert.Equal(
                    new Guid("12345678-1234-4321-5555-987654321000"),
                    result.Reference.TestGuid
                );
                Assert.Equal(
                    new Guid("12345678-1234-4321-5555-987654321000"),
                    result.Collection[0].TestGuid
                );
            }
        );
    ...
    public virtual Task Edit_single_property_nullable_enum_with_converter_that_handles_nulls() =>
        TestHelpers.ExecuteWithStrategyInTransactionAsync(
            ...
            async context =>
            {
                ...
                Assert.Equal(
                    JsonEnum.One,
                    result.Reference.TestNullableEnumWithConverterThatHandlesNulls
                );
                Assert.Equal(
                    JsonEnum.Three,
                    result.Collection[0].TestNullableEnumWithConverterThatHandlesNulls
                );
            }
        );
    ...
    public virtual Task Edit_a_scalar_property_and_reference_navigation_on_the_same_entity() =>
        TestHelpers.ExecuteWithStrategyInTransactionAsync(
            ...
            async context =>
            {
                ...
                entity.OwnedReferenceRoot.OwnedReferenceBranch.OwnedReferenceLeaf =
    ...
    public virtual Task Edit_a_scalar_property_and_collection_navigation_on_the_same_entity() =>
        TestHelpers.ExecuteWithStrategyInTransactionAsync(
            ...
            async context =>
            {
                ...
                var entity = query.Single();
                entity.OwnedReferenceRoot.OwnedReferenceBranch.Fraction = 523.532M;
                entity.OwnedReferenceRoot.OwnedReferenceBranch.OwnedCollectionLeaf =
                    new List<JsonOwnedLeaf> { new() { SomethingSomething = "edit" } };
        ...
        TestHelpers.ExecuteWithStrategyInTransactionAsync(
            ...
            async context =>
            {
                ...
                Assert.Equal(
                    ...
                    result.Collection[0].TestBooleanCollection
                );
    ...
    public virtual Task Edit_single_property_collection_of_char() =>
        TestHelpers.ExecuteWithStrategyInTransactionAsync(
            ...
            async context =>
            {
                ...
                Assert.Equal(
                    new[] { 'E', 'F', 'C', 'ö', 'r', 'E', '\"', '\\' },
                    result.Reference.TestCharacterCollection
                );
                Assert.Equal(
                    new[] { 'A', 'B', '\"', (char)0 },
                    result.Collection[0].TestCharacterCollection
                );
    ...
    public virtual Task Edit_single_property_collection_of_double() =>
        TestHelpers.ExecuteWithStrategyInTransactionAsync(
            ...
            async context =>
            {
                var result = await context.Set<JsonEntityAllTypes>().SingleAsync(x => x.Id == 1);
                Assert.Equal(
                    new[] { -1.23456789, 1.23456789, 0.0, -1.23579 },
                    result.Reference.TestDoubleCollection
                );
                Assert.Equal(
                    new[] { -1.23456789, 1.23456789, 0.0, -1.23579 },
                    result.Collection[0].TestDoubleCollection
                );
    ...
    public virtual Task Edit_single_property_collection_of_guid() =>
        TestHelpers.ExecuteWithStrategyInTransactionAsync(
            ...
            async context =>
            {
                var query = await context.JsonEntitiesAllTypes.ToListAsync();
                var entity = query.Single(x => x.Id == 1);
                entity.Reference.TestGuidCollection = new List<Guid>
                {
                    new("12345678-1234-4321-5555-987654321000"),
                };
                entity.Collection[0].TestGuidCollection = new List<Guid>
                {
                    new("12345678-1234-4321-5555-987654321000"),
                };
            ...
            async context =>
            {
                var result = await context.Set<JsonEntityAllTypes>().SingleAsync(x => x.Id == 1);
                Assert.Equal(
                    new List<Guid> { new("12345678-1234-4321-5555-987654321000") },
                    result.Reference.TestGuidCollection
                );
                Assert.Equal(
                    new List<Guid> { new("12345678-1234-4321-5555-987654321000") },
                    result.Collection[0].TestGuidCollection
                );
    ...
    public virtual Task Edit_single_property_collection_of_timespan() =>
        TestHelpers.ExecuteWithStrategyInTransactionAsync(
            ...
            async context =>
            {
                var result = await context.Set<JsonEntityAllTypes>().SingleAsync(x => x.Id == 1);
                Assert.Equal(
                    new[] { new TimeSpan(0, 10, 1, 1, 7), new TimeSpan(0, -10, 9, 8, 7) },
                    result.Reference.TestTimeSpanCollection
                );
                Assert.Equal(
                    new[] { new TimeSpan(0, 10, 9, 8, 7), new TimeSpan(0, 10, 1, 1, 7) },
                    result.Collection[0].TestTimeSpanCollection
                );
    ...
    public virtual Task Edit_single_property_collection_of_dateonly() =>
        TestHelpers.ExecuteWithStrategyInTransactionAsync(
            ...
            async context =>
            {
                var result = await context.Set<JsonEntityAllTypes>().SingleAsync(x => x.Id == 1);
                Assert.Equal(
                    new[] { new DateOnly(1, 1, 7), new DateOnly(4321, 1, 21) },
                    result.Reference.TestDateOnlyCollection
                );
                Assert.Equal(
                    new[] { new DateOnly(3234, 1, 23), new DateOnly(1, 1, 7) },
                    result.Collection[0].TestDateOnlyCollection
                );
    ...
    public virtual Task Edit_single_property_collection_of_timeonly() =>
        TestHelpers.ExecuteWithStrategyInTransactionAsync(
            ...
            async context =>
            {
                var result = await context.Set<JsonEntityAllTypes>().SingleAsync(x => x.Id == 1);
                Assert.Equal(
                    new[] { new TimeOnly(1, 1, 7), new TimeOnly(7, 17, 27) },
                    result.Reference.TestTimeOnlyCollection
                );
                Assert.Equal(
                    new[] { new TimeOnly(13, 42, 23), new TimeOnly(1, 1, 7) },
                    result.Collection[0].TestTimeOnlyCollection
                );
    ...
    public virtual Task Edit_single_property_collection_of_uint16() =>
        TestHelpers.ExecuteWithStrategyInTransactionAsync(
            ...
            async context =>
            {
                var result = await context.Set<JsonEntityAllTypes>().SingleAsync(x => x.Id == 1);
                Assert.Equal(
                    new List<ushort> { 1534 },
                    result.Reference.TestUnsignedInt16Collection
                );
                Assert.Equal(
                    new List<ushort> { 1534 },
                    result.Collection[0].TestUnsignedInt16Collection
                );
    ...
    public virtual Task Edit_single_property_collection_of_uint32() =>
        TestHelpers.ExecuteWithStrategyInTransactionAsync(
            ...
            async context =>
            {
                ...
                Assert.Equal(
                    new[] { 1237775789U },
                    result.Collection[0].TestUnsignedInt32Collection
                );
    ...
    public virtual Task Edit_single_property_collection_of_uint64() =>
        TestHelpers.ExecuteWithStrategyInTransactionAsync(
            ...
            async context =>
            {
                var query = await context.JsonEntitiesAllTypes.ToListAsync();
                var entity = query.Single(x => x.Id == 1);
                entity.Reference.TestUnsignedInt64Collection = new ObservableCollection<ulong>
                {
                    1234555555123456789UL,
                };
                entity.Collection[0].TestUnsignedInt64Collection = new ObservableCollection<ulong>
                {
                    1234555555123456789UL,
                };
            ...
            async context =>
            {
                var result = await context.Set<JsonEntityAllTypes>().SingleAsync(x => x.Id == 1);
                Assert.Equal(
                    new[] { 1234555555123456789UL },
                    result.Reference.TestUnsignedInt64Collection
                );
                Assert.Equal(
                    new[] { 1234555555123456789UL },
                    result.Collection[0].TestUnsignedInt64Collection
                );
    ...
    public virtual Task Edit_single_property_collection_of_nullable_int32() =>
        TestHelpers.ExecuteWithStrategyInTransactionAsync(
            ...
            async context =>
            {
                ...
                entity.Collection[0].TestNullableInt32Collection = new ObservableCollection<int?>
                {
                    null,
                    77,
                };
            ...
            async context =>
            {
                var result = await context.Set<JsonEntityAllTypes>().SingleAsync(x => x.Id == 1);
                Assert.Equal(
                    new int?[] { null, int.MinValue, 0, null, int.MaxValue, null, 77, null },
                    result.Reference.TestNullableInt32Collection
                );
                Assert.Equal(
                    new int?[] { null, 77 },
                    result.Collection[0].TestNullableInt32Collection
                );
    ...
    public virtual Task Edit_single_property_collection_of_enum_with_int_converter() =>
        TestHelpers.ExecuteWithStrategyInTransactionAsync(
            ...
            async context =>
            {
                ...
                Assert.Equal(
                    new[] { JsonEnum.Three },
                    result.Reference.TestEnumWithIntConverterCollection
                );
                Assert.Equal(
                    new[] { JsonEnum.Three },
                    result.Collection[0].TestEnumWithIntConverterCollection
                );
    ...
    public virtual Task Edit_single_property_collection_of_nullable_enum_with_converter_that_handles_nulls() =>
        TestHelpers.ExecuteWithStrategyInTransactionAsync(
            ...
            async context =>
            {
                var query = await context.JsonEntitiesAllTypes.ToListAsync();
                var entity = query.Single(x => x.Id == 1);
                entity.Reference.TestNullableEnumWithConverterThatHandlesNullsCollection =
                    new JsonEnum?[] { JsonEnum.One };
                entity.Collection[0].TestNullableEnumWithConverterThatHandlesNullsCollection =
                    new JsonEnum?[] { JsonEnum.Three };
            ...
            async context =>
            {
                ...
                Assert.Equal(
                    new JsonEnum?[] { JsonEnum.One },
                    result.Reference.TestNullableEnumWithConverterThatHandlesNullsCollection
                );
                Assert.Equal(
                    new JsonEnum?[] { JsonEnum.Three },
                    result.Collection[0].TestNullableEnumWithConverterThatHandlesNullsCollection
                );
    ...
    public virtual Task Edit_single_property_relational_collection_of_char() =>
        TestHelpers.ExecuteWithStrategyInTransactionAsync(
            ...
            async context =>
            {
                ...
                Assert.Equal(
                    new[] { 'E', 'F', 'C', 'ö', 'r', 'E', '\"', '\\' },
                    result.TestCharacterCollection
                );
    ...
    public virtual Task Edit_single_property_relational_collection_of_guid() =>
        TestHelpers.ExecuteWithStrategyInTransactionAsync(
            ...
            async context =>
            {
                var query = await context.JsonEntitiesAllTypes.ToListAsync();
                var entity = query.Single(x => x.Id == 1);
                entity.TestGuidCollection = new List<Guid>
                {
                    new("12345678-1234-4321-5555-987654321000"),
                };
    ...
    public virtual Task Edit_single_property_relational_collection_of_timespan() =>
        TestHelpers.ExecuteWithStrategyInTransactionAsync(
            ...
            async context =>
            {
                var result = await context.Set<JsonEntityAllTypes>().SingleAsync(x => x.Id == 1);
                Assert.Equal(
                    new[] { new TimeSpan(0, 10, 1, 1, 7), new TimeSpan(0, 7, 9, 8, 7) },
                    result.TestTimeSpanCollection
                );
    ...
    public virtual Task Edit_single_property_relational_collection_of_uint64() =>
        TestHelpers.ExecuteWithStrategyInTransactionAsync(
            ...
            async context =>
            {
                var query = await context.JsonEntitiesAllTypes.ToListAsync();
                var entity = query.Single(x => x.Id == 1);
                entity.TestUnsignedInt64Collection = new ObservableCollection<ulong>
                {
                    1234555555123456789UL,
                };
    ...
    public virtual Task Edit_single_property_relational_collection_of_nullable_int32() =>
        TestHelpers.ExecuteWithStrategyInTransactionAsync(
            ...
            async context =>
            {
                ...
                Assert.Equal(
                    new int?[] { null, int.MinValue, 0, null, int.MaxValue, null, 77, null },
                    result.TestNullableInt32Collection
                );
    ...
    public virtual Task Edit_single_property_relational_collection_of_nullable_enum_with_converter_that_handles_nulls() =>
        TestHelpers.ExecuteWithStrategyInTransactionAsync(
            ...
            async context =>
            {
                var query = await context.JsonEntitiesAllTypes.ToListAsync();
                var entity = query.Single(x => x.Id == 1);
                entity.TestNullableEnumWithConverterThatHandlesNullsCollection = new JsonEnum?[]
                {
                    JsonEnum.One,
                };
            ...
            async context =>
            {
                ...
                Assert.Equal(
                    new JsonEnum?[] { JsonEnum.One },
                    result.TestNullableEnumWithConverterThatHandlesNullsCollection
                );
        ...
        TestHelpers.ExecuteWithStrategyInTransactionAsync(
            ...
            async context =>
            {
                var newEntity = new JsonEntityBasic
                {
                    Id = 2,
                    Name = "NewEntity",
                    OwnedCollectionRoot = value.HasValue
                        ? value.Value
        ...
        TestHelpers.ExecuteWithStrategyInTransactionAsync(
            ...
            async context =>
            {
                var newEntity = new JsonEntityBasic
                {
                    ...
                    OwnedReferenceRoot = new JsonOwnedRoot()
                    {
                        OwnedCollectionBranch = value.HasValue
                            ? value.Value
    ...
    public virtual Task Add_and_update_nested_optional_primitive_collection(bool? value) =>
        TestHelpers.ExecuteWithStrategyInTransactionAsync(
                    ...
                    Collection = new List<JsonOwnedAllTypes>
                    {
                        new()
                        {
                            ...
                            TestNullableEnumWithIntConverterCollection =
                                new Collection<JsonEnum?>(),
                            TestNullableEnumWithConverterThatHandlesNullsCollection =
                                Array.Empty<JsonEnum?>(),
                            TestCharacterCollection = value.HasValue
                                ? value.Value
            ...
            async context =>
            {
                var newEntity = await context
                    .Set<JsonEntityAllTypes>()
                    .SingleAsync(e => e.Id == 7624);
