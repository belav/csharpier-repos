...
public abstract class JsonUpdateFixtureBase : SharedStoreFixtureBase<JsonQueryContext>
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder, DbContext context)
    {
        ...
        modelBuilder
            .Entity<JsonEntityBasic>()
            .Navigation(x => x.OwnedReferenceRoot)
            .IsRequired(false);
        ...
        modelBuilder
            ...
            .OwnsOne(
                ...
                b =>
                {
                    ...
                    b.Property(x => x.TestNullableEnumWithConverterThatHandlesNulls)
                        .HasConversion(
        ...
        modelBuilder
            .Entity<JsonEntityConverters>()
            .OwnsOne(
                x => x.Reference,
                b =>
                {
                    b.ToJson();
                    b.Property(x => x.BoolConvertedToIntZeroOne)
                        .HasConversion<BoolToZeroOneConverter<int>>();
                    b.Property(x => x.BoolConvertedToStringTrueFalse)
                        .HasConversion(new BoolToStringConverter("False", "True"));
                    b.Property(x => x.BoolConvertedToStringYN)
                        .HasConversion(new BoolToStringConverter("N", "Y"));
                    b.Property(x => x.IntZeroOneConvertedToBool)
                        .HasConversion(
                    ...
                    b.Property(x => x.StringTrueFalseConvertedToBool)
                        .HasConversion(
                    ...
                    b.Property(x => x.StringYNConvertedToBool)
                        .HasConversion(
                            new ValueConverter<string, bool>(
                                x => x == "Y" ? true : false,
                                x => x == true ? "Y" : "N"
