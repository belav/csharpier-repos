...
public abstract class StoredProcedureUpdateFixtureBase
    : SharedStoreFixtureBase<StoredProcedureUpdateContext>
{
    protected override string StoreName => "StoredProcedureUpdateTest";

    protected override void OnModelCreating(ModelBuilder modelBuilder, DbContext context)
    {
        modelBuilder
            .SharedTypeEntity<Entity>(nameof(StoredProcedureUpdateContext.WithOutputParameter))
            .InsertUsingStoredProcedure(
                nameof(StoredProcedureUpdateContext.WithOutputParameter) + "_Insert",
                spb => spb.HasParameter(w => w.Name).HasParameter(w => w.Id, pb => pb.IsOutput())
            )
        ...
        modelBuilder
            .SharedTypeEntity<Entity>(nameof(StoredProcedureUpdateContext.WithResultColumn))
            .InsertUsingStoredProcedure(
                nameof(StoredProcedureUpdateContext.WithResultColumn) + "_Insert",
        ...
        modelBuilder.SharedTypeEntity<EntityWithAdditionalProperty>(
            ...
            b =>
            {
                ...
                b.InsertUsingStoredProcedure(
                    "WithOutputParameterAndResultColumn_Insert",
                    spb =>
        ...
        modelBuilder.SharedTypeEntity<EntityWithAdditionalProperty>(
            ...
            b =>
            {
                ...
                b.UpdateUsingStoredProcedure(
                    nameof(
                        StoredProcedureUpdateContext.WithOutputParameterAndRowsAffectedResultColumn
                    ) + "_Update",
                    spb =>
        ...
        modelBuilder
            .SharedTypeEntity<EntityWithAdditionalProperty>(
                nameof(StoredProcedureUpdateContext.WithTwoInputParameters)
            )
            .UpdateUsingStoredProcedure(
                nameof(StoredProcedureUpdateContext.WithTwoInputParameters) + "_Update",
                spb =>
                    spb.HasOriginalValueParameter(w => w.Id)
                        .HasParameter(w => w.Name)
        ...
        modelBuilder
            .SharedTypeEntity<Entity>(
                nameof(StoredProcedureUpdateContext.WithRowsAffectedParameter)
            )
            .UpdateUsingStoredProcedure(
        ...
        modelBuilder
            .SharedTypeEntity<Entity>(
                nameof(StoredProcedureUpdateContext.WithRowsAffectedResultColumn)
            )
            .UpdateUsingStoredProcedure(
        ...
        modelBuilder
            .SharedTypeEntity<Entity>(
                nameof(StoredProcedureUpdateContext.WithRowsAffectedReturnValue)
            )
            .UpdateUsingStoredProcedure(
        ...
        modelBuilder.SharedTypeEntity<Entity>(
            ...
            b =>
            {
                ...
                b.UpdateUsingStoredProcedure(
                    nameof(
                        StoredProcedureUpdateContext.WithStoreGeneratedConcurrencyTokenAsInOutParameter
                    ) + "_Update",
                    spb =>
                        spb.HasOriginalValueParameter(w => w.Id)
        ...
        modelBuilder.SharedTypeEntity<Entity>(
            ...
            b =>
            {
                ...
                b.UpdateUsingStoredProcedure(
                    nameof(
                        StoredProcedureUpdateContext.WithStoreGeneratedConcurrencyTokenAsTwoParameters
                    ) + "_Update",
                    spb =>
                        spb.HasOriginalValueParameter(w => w.Id)
            ...
            b =>
            {
                ...
                b.UpdateUsingStoredProcedure(
                    ...
                    spb =>
                        spb.HasOriginalValueParameter(w => w.Id)
                            .HasOriginalValueParameter(
                                w => w.AdditionalProperty,
                                pb => pb.HasName("ConcurrencyTokenOriginal")
                            )
                            .HasParameter(w => w.Name)
                            .HasParameter(
                                w => w.AdditionalProperty,
                                pb => pb.HasName("ConcurrencyTokenCurrent")
                            )
                            .HasRowsAffectedParameter()
                );
            }
        ...
        modelBuilder
            .SharedTypeEntity<Entity>(
                nameof(
                    StoredProcedureUpdateContext.WithOriginalAndCurrentValueOnNonConcurrencyToken
                )
            )
            .UpdateUsingStoredProcedure(
                nameof(
        ...
        modelBuilder.Entity<TphChild2>(b =>
        {
        ...
        modelBuilder.Entity<TphParent>(b =>
        {
            b.ToTable("Tph");
            ...
            b.InsertUsingStoredProcedure(
                ...
                spb =>
                    spb.HasParameter(w => w.Id, pb => pb.IsOutput())
                        ...
                        .HasParameter(
                            nameof(TphChild2.Child2OutputParameterProperty),
                            o => o.IsOutput()
                        )
        ...
        modelBuilder.Entity<TptParent>(b =>
        {
            b.UseTptMappingStrategy();

            b.InsertUsingStoredProcedure(
                "TptParent_Insert",
                spb => spb.HasParameter(w => w.Id, pb => pb.IsOutput()).HasParameter(w => w.Name)
            );
        });
        ...
        modelBuilder
            ...
            .InsertUsingStoredProcedure(
                "TptChild_Insert",
                spb => spb.HasParameter(w => w.Id).HasParameter(w => w.ChildProperty)
            );

        modelBuilder.Entity<TptMixedParent>(b =>
        {
            b.UseTptMappingStrategy();
    ...
    /// </summary>
    protected abstract void ConfigureStoreGeneratedConcurrencyToken(
