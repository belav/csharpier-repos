...
public class EntitySplittingData : ISetSource
{
    ...
    private static EntityOne[] CreateEntityOnes()
        => new EntityOne[]
        {
            new EntityOne { Id = 1, IntValue1 = 11, IntValue2 = 12, IntValue3 = 13, IntValue4 = 14,
                StringValue1 = "V11", StringValue2 = "V12", StringValue3 = "V13", StringValue4 = "V14"},
            new EntityOne { Id = 2, IntValue1 = 21, IntValue2 = 22, IntValue3 = 23, IntValue4 = 24,
                StringValue1 = "V21", StringValue2 = "V22", StringValue3 = "V23", StringValue4 = "V24"},
            new EntityOne { Id = 3, IntValue1 = 31, IntValue2 = 32, IntValue3 = 33, IntValue4 = 34,
                StringValue1 = "V31", StringValue2 = "V32", StringValue3 = "V33", StringValue4 = "V34"},
            new EntityOne { Id = 4, IntValue1 = 41, IntValue2 = 42, IntValue3 = 43, IntValue4 = 44,
                StringValue1 = "V41", StringValue2 = "V42", StringValue3 = "V43", StringValue4 = "V44"},
            new EntityOne { Id = 5, IntValue1 = 51, IntValue2 = 52, IntValue3 = 53, IntValue4 = 54,
                StringValue1 = "V51", StringValue2 = "V52", StringValue3 = "V53", StringValue4 = "V54"},
        };
    ...
    private static BaseEntity[] CreateHierarchyEntities()
        => new BaseEntity[]
        {
            ...
            new MiddleEntity { Id = 2, BaseValue = 2, MiddleValue = 21 },
            new SiblingEntity { Id = 3, BaseValue = 3, SiblingValue = 21 },
            new LeafEntity { Id = 4, BaseValue = 4, MiddleValue = 22, LeafValue = 301 }
        };
    ...
    private void WireUp()
    {
        ...
        for (var i = 0; i < _entityOnes.Length; i++)
        {
            ...
            for (var j = 0; j < i; j++)
            {
                _entityOnes[i].OwnedCollection.Add(new OwnedCollection
                {
                    Id = i * 100 + j,
                    OwnedIntValue1 = i * 10 + 1,
                    OwnedIntValue2 = i * 10 + 2,
        ...
        for (var i = 0; i < _baseEntities.Length; i++)
        {
            ...
            for (var j = 0; j < i; j++)
            {
                _baseEntities[i].OwnedCollection.Add(new OwnedCollection
                {
                    Id = i * 100 + j,
                    OwnedIntValue1 = i * 10 + 1,
                    OwnedIntValue2 = i * 10 + 2,
