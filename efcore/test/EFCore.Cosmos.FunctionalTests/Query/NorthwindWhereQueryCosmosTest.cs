    ...
    : NorthwindWhereQueryTestBase<NorthwindQueryCosmosFixture<NoopModelCustomizer>>
{
    ...
    {
        await AssertQuery(async, ss => ss.Set<Order>().Where(o => o.OrderID + 10 == 10258));
...
"""
    ...
    {
        await AssertQuery(async, ss => ss.Set<Order>().Where(o => o.OrderID - 10 == 10238));
...
"""
    ...
    {
        await AssertQuery(async, ss => ss.Set<Order>().Where(o => o.OrderID * 1 == 10248));
...
"""
    ...
    {
        await AssertQuery(async, ss => ss.Set<Order>().Where(o => o.OrderID % 10248 == 0));
...
"""
    ...
    {
        await AssertQuery(async, ss => ss.Set<Order>().Where(o => (o.OrderID << 1) == 20496));
...
"""
    ...
    {
        await AssertQuery(async, ss => ss.Set<Order>().Where(o => (o.OrderID >> 1) == 5124));
...
"""
    ...
    {
        await AssertQuery(async, ss => ss.Set<Customer>().Where(c => !(c.City != "Seattle")));
...
"""
    ...
    {
        await AssertQuery(async, ss => ss.Set<Employee>().Where(e => e.ReportsTo < 3));
...
"""
    ...
    {
        await AssertQuery(async, ss => ss.Set<Order>().Where(o => -o.OrderID == -10248));
...
"""
    ...
    {
        await AssertQuery(async, ss => ss.Set<Order>().Where(o => ~o.OrderID == -10249));
...
"""
    ...
    {
        await AssertQuery(async, ss => ss.Set<Customer>().Where(c => (c.Region ?? "SP") == "BC"));
...
"""
    ...
    public override async Task FirstOrDefault_over_scalar_projection_compared_to_not_null(
        bool async
    )
    {
        // Cosmos client evaluation. Issue #17246.
    ...
    public override async Task SingleOrDefault_over_custom_projection_compared_to_not_null(
        bool async
    )
    {
        // Cosmos client evaluation. Issue #17246.
    ...
    public override async Task ElementAtOrDefault_over_custom_projection_compared_to_null(
        bool async
    )
    {
        // Cosmos client evaluation. Issue #17246.
...
"""
    ...
    public override async Task Filter_with_property_compared_to_null_wrapped_in_explicit_convert_to_object(
        bool async
    )
    {
        await base.Filter_with_property_compared_to_null_wrapped_in_explicit_convert_to_object(
            async
        );
...
"""
    ...
    public override async Task Where_nested_field_access_closure_via_query_cache_error_method_null(
        bool async
    )
    {
...
"""
    ...
    public override async Task EF_Constant_does_not_parameterized_as_part_of_bigger_subtree(
        bool async
    )
    {
...
"""
    ...
    public override async Task EF_Parameter_does_not_parameterized_as_part_of_bigger_subtree(
        bool async
    )
    {
