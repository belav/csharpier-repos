...
WHERE ((c[""Discriminator""] = ""Order"") AND (c[""OrderID""] = 10243))"
        ...
        [ConditionalTheory(Skip = "Issue #17246")]
        public override Task Collection_FirstOrDefault_with_nullable_unsigned_int_column(
            bool async
...
ORDER BY c[""CustomerID""]"
        ...
        public override Task Projecting_Length_of_a_string_property_after_FirstOrDefault_on_correlated_collection(
            ...
            base.Projecting_Length_of_a_string_property_after_FirstOrDefault_on_correlated_collection(
                async
            );
...
OFFSET 0 LIMIT @__p_0"
        ...
        [ConditionalTheory(Skip = "Cross collection join Issue#17246")]
        public override Task Projecting_count_of_navigation_which_is_generic_collection(
            bool async
