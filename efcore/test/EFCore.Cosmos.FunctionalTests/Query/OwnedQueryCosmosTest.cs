...
"""
    ...
    public override Task Query_when_subquery(bool async) => base.Query_when_subquery(async);
...
"""
    ...
    public override Task NoTracking_Include_with_cycles_does_not_throw_when_performing_identity_resolution(
        ...
        base.NoTracking_Include_with_cycles_does_not_throw_when_performing_identity_resolution(
            async,
            useAsTracking
        );
    ...
    public override async Task GroupBy_aggregate_on_owned_navigation_in_aggregate_selector(
        bool async
    )
    {
