...
public class SqlServerTypeMappingTest : RelationalTypeMappingTest
{
    ...
    )
    {
        ...
        var entity = context
            .Attach(new WithRowVersion { Id = 789, Version = token.ToArray() })
            .Entity;
        ...
        Assert.Equal(
            changeValue ? EntityState.Modified : EntityState.Unchanged,
    ...
    protected override DbCommand CreateTestCommand() => new SqlCommand();
    ...
    public void Create_and_clone_SQL_Server_DateTime_mappings_with_converter()
    {
        var mapping = (RelationalTypeMapping)
            Activator.CreateInstance(
                ...
                new[]
                {
                    FakeTypeMapping.CreateParameters(typeof(SqlServerDateTimeTypeMapping)),
    ...
    public virtual void Create_and_clone_SQL_Server_sized_mappings_with_converter() =>
        ConversionCloneTest(typeof(SqlServerByteArrayTypeMapping), typeof(byte[]), SqlDbType.Image);
    ...
    public override void DateTimeOffset_literal_generated_correctly()
    {
        ...
        Test_GenerateSqlLiteral_helper(
            ...
            "'2015-03-12T13:36:37.1230000-07:00'"
    ...
    public virtual void String_Utf8()
    {
        ...
        var utf8StringMapping = typeMappingSource.FindMapping(
            typeof(string),
            "varchar(max)",
            unicode: true
        )!;
    ...
    public virtual void TimeOnly_code_literal_generated_correctly()
    {
        ...
        Test_GenerateCodeLiteral_helper(
            typeMapping,
            new TimeOnly(12, 30, 10),
            "new TimeOnly(12, 30, 10)"
        );
        Test_GenerateCodeLiteral_helper(
            typeMapping,
            new TimeOnly(12, 30, 10, 500),
            "new TimeOnly(12, 30, 10, 500)"
        );
