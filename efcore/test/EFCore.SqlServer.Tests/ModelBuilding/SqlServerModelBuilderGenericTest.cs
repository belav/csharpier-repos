...
{
    public class SqlServerGenericNonRelationship
    ...
    public class SqlServerGenericComplexType
    ...
    public class SqlServerGenericInheritance
    ...
    public class SqlServerGenericOneToMany
        : SqlServerOneToMany,
            IClassFixture<SqlServerModelBuilderFixture>
    {
    ...
    public class SqlServerGenericManyToOne
        : SqlServerManyToOne,
            IClassFixture<SqlServerModelBuilderFixture>
    {
    ...
    public class SqlServerGenericOneToOne
        : SqlServerOneToOne,
            IClassFixture<SqlServerModelBuilderFixture>
    {
    ...
    public class SqlServerGenericManyToMany
        : SqlServerManyToMany,
            IClassFixture<SqlServerModelBuilderFixture>
    {
    ...
    public class SqlServerGenericOwnedTypes
        : SqlServerOwnedTypes,
            IClassFixture<SqlServerModelBuilderFixture>
    {
