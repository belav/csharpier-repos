...
{
    public abstract class SqlServerNonRelationship
        : RelationalNonRelationshipTestBase,
            IClassFixture<SqlServerModelBuilderFixture>
    {
        ...
        public virtual void Index_has_a_filter_if_nonclustered_unique_with_nullable_properties()
        {
            ...
            var indexBuilder = entityTypeBuilder.HasIndex(ix => ix.Name).IsUnique();
        ...
        {
            var modelBuilder = CreateModelBuilder();
            modelBuilder.Entity<Customer>().HasIndex(e => e.Id, "Ix_Id").IsUnique();
            modelBuilder.Entity<CustomerDetails>().HasIndex(e => e.CustomerId, "Ix_Id").IsUnique();
            ...
            Assert.Equal(
                "Ix_Id",
                customerIndex.GetDatabaseName(StoreObjectIdentifier.Table("Customer"))
            );
            ...
            Assert.Equal(
                "Ix_Id",
                detailsIndex.GetDatabaseName(StoreObjectIdentifier.Table("CustomerDetails"))
            );
        }
        ...
        public virtual void Can_set_store_type_for_property_type()
        {
            ...
            Assert.Equal(
                "smallint",
                entityType.FindProperty(Customer.IdProperty.Name)!.GetColumnType()
            );
        ...
        public virtual void Can_set_collation_for_property_type()
        {
            ...
            Assert.Equal(
                ...
                entityType.FindProperty(Customer.IdProperty.Name)!.GetCollation()
            );
            Assert.Equal(
                "Latin1_General_CS_AS_KS_WS",
                entityType.FindProperty("Up")!.GetCollation()
            );
            Assert.Equal("Latin1_General_BIN", entityType.FindProperty("Down")!.GetCollation());
            Assert.Equal(
                "Latin1_General_CS_AS_KS_WS",
                entityType.FindProperty("Charm")!.GetCollation()
            );
            Assert.Equal("Latin1_General_BIN", entityType.FindProperty("Strange")!.GetCollation());
            Assert.Equal(
                "Latin1_General_CS_AS_KS_WS",
                entityType.FindProperty("Top")!.GetCollation()
            );
        ...
        public virtual void Can_set_store_type_for_primitive_collection()
        {
            ...
            modelBuilder.Entity<CollectionQuarks>(b =>
            {
                ...
                ;
                b.PrimitiveCollection<ObservableCollection<string>?>("Bottom")
            ...
            Assert.Equal(
                "int",
                entityType.FindProperty(nameof(CollectionQuarks.Id))!.GetColumnType()
            );
            Assert.Equal(
                "national character varying(255)",
                entityType.FindProperty("Up")!.GetColumnType()
            );
            ...
            else
            {
                Assert.Equal(
                    CoreStrings.PropertyNotAdded(
                        nameof(SqlVariantEntity),
                        nameof(SqlVariantEntity.Value),
                        "object"
                    ),
    ...
    public abstract class SqlServerComplexType
        : RelationalComplexTypeTestBase,
            IClassFixture<SqlServerModelBuilderFixture>
    {
    ...
    public abstract class SqlServerInheritance
        : RelationalInheritanceTestBase,
            IClassFixture<SqlServerModelBuilderFixture>
    {
        ...
        public void Can_use_shadow_FK_that_collides_with_convention_shadow_FK_on_other_derived_type()
        {
            ...
            var property1 = model
                .FindEntityType(typeof(DisjointChildSubclass1))!
                .FindProperty("ParentId")!;
            Assert.True(property1.IsForeignKey());
            Assert.Equal("ParentId", property1.GetColumnName());
            var property2 = model
                .FindEntityType(typeof(DisjointChildSubclass2))!
                .FindProperty("ParentId")!;
            Assert.True(property2.IsForeignKey());
            Assert.Equal("ParentId", property2.GetColumnName());
            Assert.Equal(
                "DisjointChildSubclass2_ParentId",
                property2.GetColumnName(StoreObjectIdentifier.Table(nameof(Child)))
            );
        }
        ...
        public void Inherited_clr_properties_are_mapped_to_the_same_column()
        {
            ...
            var property1 = model
                .FindEntityType(typeof(DisjointChildSubclass1))!
                .FindProperty(nameof(Child.Name))!;
        ...
        public void Index_convention_run_for_fk_when_derived_type_discovered_before_base_type()
        {
            ...
            var index = modelBuilder
                .Model.FindEntityType(typeof(CustomerDetails))!
                .GetIndexes()
                .Single();
        ...
        public void Index_convention_sets_filter_for_unique_index_when_base_type_changed()
        {
            ...
            modelBuilder.Entity<CustomerDetails>().HasIndex(e => e.CustomerId).IsUnique();
        ...
        public virtual void Can_override_TPC_with_TPH()
        {
            ...
            modelBuilder.Entity<PBase>().UseTpcMappingStrategy().UseTphMappingStrategy();

            var model = modelBuilder.FinalizeModel();

            Assert.Equal(
                "Discriminator",
                model.FindEntityType(typeof(PBase))!.GetDiscriminatorPropertyName()
            );
            Assert.Equal(
                nameof(PBase),
                model.FindEntityType(typeof(PBase))!.GetDiscriminatorValue()
            );
        ...
        public virtual void TPT_identifying_FK_is_created_only_on_declaring_table()
        {
            ...
            Assert.Equal(
                "FK_Buns_Ingredients_Id",
                bunLinkingFk.GetConstraintName(
                    StoreObjectIdentifier.Create(bunType, StoreObjectType.Table)!.Value,
            ...
            Assert.Equal(
                "FK_SesameBuns_Buns_Id",
                sesameBunFk.GetConstraintName(
        ...
        public virtual void TPC_identifying_FKs_are_created_on_all_tables()
        {
            ...
            Assert.Equal(
                ...
                ingredientIndex.GetDatabaseName(
                    StoreObjectIdentifier.Create(sesameBunType, StoreObjectType.Table)!.Value
                )
            );
            Assert.Equal(
    ...
    public abstract class SqlServerOneToMany
        : RelationalOneToManyTestBase,
            IClassFixture<SqlServerModelBuilderFixture>
    {
        ...
        public virtual void Shadow_foreign_keys_to_generic_types_have_terrible_names_that_should_not_change()
        {
            ...
            var eventTable = StoreObjectIdentifier
                .Create(companyActivityEventType, StoreObjectType.Table)!
                .Value;
            ...
            Assert.Equal(
                "Activity<Company>Id",
                companyActivityEventFkProperty.GetColumnName(eventTable)
            );
            Assert.Equal(
                "FK_Events_CompanyActivities_Activity<Company>Id",
                companyActivityEventFk.GetConstraintName()
            );
            Assert.Equal(
                "FK_Events_CompanyActivities_Activity<Company>Id",
                companyActivityEventFk.GetConstraintName(
                    ...
                    StoreObjectIdentifier
                        .Create(companyActivityEventFk.PrincipalEntityType, StoreObjectType.Table)!
                        .Value
                )
            );
            ...
            Assert.Equal(
                ...
                userActivityEventFk.GetConstraintName()
            );
            Assert.Equal(
                "FK_Events_UserActivities_Activity<User>Id",
                userActivityEventFk.GetConstraintName(
                    eventTable,
                    StoreObjectIdentifier
                        .Create(userActivityEventFk.PrincipalEntityType, StoreObjectType.Table)!
                        .Value
                )
            );
        }
    ...
    public abstract class SqlServerOneToOne
        : RelationalOneToOneTestBase,
            IClassFixture<SqlServerModelBuilderFixture>
    {
    ...
    public abstract class SqlServerManyToMany
        : RelationalManyToManyTestBase,
            IClassFixture<SqlServerModelBuilderFixture>
    {
        ...
        public virtual void Join_entity_type_uses_same_schema()
        {
            ...
            modelBuilder
                .Entity<Category>()
                .ToTable("Category", "mySchema")
                .Ignore(c => c.ProductCategories);
    ...
    public abstract class SqlServerOwnedTypes
        : RelationalOwnedTypesTestBase,
            IClassFixture<SqlServerModelBuilderFixture>
    {
        ...
        public virtual void Owned_types_use_table_splitting_by_default()
        {
            ...
            var bookLabel1Ownership1 = bookOwnership1
                .DeclaringEntityType.FindNavigation(nameof(BookLabel.AnotherBookLabel))!
                .ForeignKey;
            var bookLabel1Ownership2 = bookOwnership1
                .DeclaringEntityType.FindNavigation(nameof(BookLabel.SpecialBookLabel))!
                .ForeignKey;
            ...
            Assert.Equal(
                book.GetTableName(),
                bookLabel1Ownership1.DeclaringEntityType.GetTableName()
            );
            Assert.Equal(
                book.GetTableName(),
                bookLabel1Ownership2.DeclaringEntityType.GetTableName()
            );
            Assert.Equal(
                book.GetTableName(),
                bookLabel2Ownership1.DeclaringEntityType.GetTableName()
            );
            Assert.Equal(
                book.GetTableName(),
                bookLabel2Ownership2.DeclaringEntityType.GetTableName()
            );
            ...
            Assert.Equal(
                4,
                model.GetEntityTypes().Count(e => e.ClrType == typeof(AnotherBookLabel))
            );
            Assert.Equal(
                4,
                model.GetEntityTypes().Count(e => e.ClrType == typeof(SpecialBookLabel))
            );

            Assert.Null(
                bookOwnership1
                    .DeclaringEntityType.FindProperty(nameof(BookLabel.Id))!
        ...
        public virtual void Owned_types_can_be_mapped_to_different_tables()
        {
            ...
            var bookLabel2Ownership2 = bookOwnership2
                .DeclaringEntityType.FindNavigation(nameof(BookLabel.SpecialBookLabel))!
                .ForeignKey;
            var bookLabel1Ownership11 = bookLabel1Ownership1
                .DeclaringEntityType.FindNavigation(nameof(BookLabel.SpecialBookLabel))!
                .ForeignKey;
            var bookLabel1Ownership21 = bookLabel1Ownership2
                .DeclaringEntityType.FindNavigation(nameof(BookLabel.AnotherBookLabel))!
                .ForeignKey;
            var bookLabel2Ownership11 = bookLabel2Ownership1
                .DeclaringEntityType.FindNavigation(nameof(BookLabel.SpecialBookLabel))!
                .ForeignKey;
            var bookLabel2Ownership21 = bookLabel2Ownership2
                .DeclaringEntityType.FindNavigation(nameof(BookLabel.AnotherBookLabel))!
                .ForeignKey;
        ...
        public virtual void Owned_type_collections_can_be_mapped_to_different_tables()
        {
            ...
            modelBuilder.Entity<Customer>().OwnsMany(c => c.Orders, r => r.ToTable("blah"));
        ...
        public override void Can_configure_owned_type()
        {
            ...
            ownedBuilder
                .WithOwner(d => (OtherCustomer?)d.Customer)
            ...
            Assert.Equal(
                2,
                model.GetEntityTypes().Count(e => e.ClrType == typeof(CustomerDetails))
            );
            ...
            static void AssertOwnership(IEntityType owner)
            {
                ...
                Assert.Equal(
                    ...
                    ownership1.PrincipalKey.Properties.Single().Name
                );
        ...
        public virtual void Temporal_table_with_period_column_names_changed_configuration()
        {
            ...
            Assert.Equal("MyPeriodStart", periodStart.Name);
            Assert.Equal(
                "ChangedPeriodStartColumn",
                periodStart[RelationalAnnotationNames.ColumnName]
            );
            Assert.True(periodStart.IsShadowProperty());
            Assert.Equal(typeof(DateTime), periodStart.ClrType);
            Assert.Equal(ValueGenerated.OnAddOrUpdate, periodStart.ValueGenerated);
        ...
        public virtual void Temporal_table_with_explicit_properties_with_same_name_as_default_periods_but_different_periods_defined_explicity_as_well()
        {
            ...
            Assert.Equal(
                "PeriodStartColumn",
                propertyMappedToStart[RelationalAnnotationNames.ColumnName]
            );
            ...
            Assert.Equal(
                "PeriodEndColumn",
                propertyMappedToEnd[RelationalAnnotationNames.ColumnName]
            );
        ...
        public virtual void Json_entity_and_normal_owned_can_exist_side_by_side_on_same_entity()
        {
            ...
            var reference = ownedEntities
                .Where(e => e.GetContainerColumnName() == "reference")
                .Single();
            ...
            var collection = ownedEntities
                .Where(e => e.GetContainerColumnName() == "collection")
                .Single();
        ...
        public virtual void Json_entity_with_tph_inheritance()
        {
            ...
            modelBuilder.Entity<JsonEntityInheritanceDerived>(b =>
            {
                ...
                b.OwnsMany(
                    x => x.OwnedCollectionOnDerived,
                    bb => bb.ToJson("collection_on_derived")
                );
            });
            ...
            var jsonColumnNames = ownedEntities
                .Select(x => x.GetContainerColumnName())
                .OrderBy(x => x)
                .ToList();
        ...
        public virtual void Json_entity_with_nested_structure_same_property_names()
        {
            ...
            foreach (var outerOwnedEntity in outerOwnedEntities)
            {
                ...
                Assert.Equal(
                    "Fraction",
                    outerOwnedEntity.GetProperty("Fraction").GetJsonPropertyName()
                );
...
#pragma warning restore CS0618
        ...
        public virtual void Json_entity_with_custom_property_names()
        {
            ...
            foreach (var outerOwnedEntity in outerOwnedEntities)
            {
                Assert.Equal(
                    "OuterDate",
                    outerOwnedEntity.GetProperty("Date").GetJsonPropertyName()
                );
                Assert.Equal(
                    "OuterFraction",
                    outerOwnedEntity.GetProperty("Fraction").GetJsonPropertyName()
                ...
                Assert.Equal(
                    "OuterEnum",
                    outerOwnedEntity.GetProperty("Enum").GetJsonPropertyName()
                );
                Assert.Equal(
                    "RenamedReference1",
                    outerOwnedEntity
            ...
            foreach (var ownedEntity in ownedEntities)
            {
                ...
                Assert.Equal(
                    "InnerFraction",
                    ownedEntity.GetProperty("Fraction").GetJsonPropertyName()
                );
        ...
        where TEntity : class
    {
        ...
        protected virtual TestTemporalTableBuilder<TEntity> Wrap(
            TemporalTableBuilder<TEntity> tableBuilder
        ) => new GenericTestTemporalTableBuilder<TEntity>(tableBuilder);

        public override TestTemporalTableBuilder<TEntity> UseHistoryTable(
            string name,
            string? schema
        ...
        where TEntity : class
    {
        ...
        TemporalTableBuilder IInfrastructure<TemporalTableBuilder>.Instance => TemporalTableBuilder;
    ...
    {
        public abstract TestOwnedNavigationTemporalTableBuilder<
            TOwnerEntity,
            TDependentEntity
    ...
    public class GenericTestOwnedNavigationTemporalTableBuilder<TOwnerEntity, TDependentEntity>
        ...
        where TDependentEntity : class
    {
        public GenericTestOwnedNavigationTemporalTableBuilder(
        ...
        private OwnedNavigationTemporalTableBuilder<
            TOwnerEntity,
            TDependentEntity
        > TemporalTableBuilder { get; }

        OwnedNavigationTemporalTableBuilder<TOwnerEntity, TDependentEntity> IInfrastructure<
            OwnedNavigationTemporalTableBuilder<TOwnerEntity, TDependentEntity>
        >.Instance => TemporalTableBuilder;

        protected virtual TestOwnedNavigationTemporalTableBuilder<
            TOwnerEntity,
            TDependentEntity
        > Wrap(OwnedNavigationTemporalTableBuilder<TOwnerEntity, TDependentEntity> tableBuilder) =>
            new GenericTestOwnedNavigationTemporalTableBuilder<TOwnerEntity, TDependentEntity>(
                tableBuilder
            );

        public override TestOwnedNavigationTemporalTableBuilder<
            TOwnerEntity,
            TDependentEntity
        > UseHistoryTable(string name, string? schema) =>
            Wrap(TemporalTableBuilder.UseHistoryTable(name, schema));
    ...
    public class NonGenericTestOwnedNavigationTemporalTableBuilder<TOwnerEntity, TDependentEntity>
        ...
        where TDependentEntity : class
    {
        public NonGenericTestOwnedNavigationTemporalTableBuilder(
        ...
        protected virtual TestOwnedNavigationTemporalTableBuilder<
            TOwnerEntity,
            TDependentEntity
        > Wrap(OwnedNavigationTemporalTableBuilder temporalTableBuilder) =>
            new NonGenericTestOwnedNavigationTemporalTableBuilder<TOwnerEntity, TDependentEntity>(
                temporalTableBuilder
            );
    ...
    {
        public TestTemporalPeriodPropertyBuilder(
    ...
    {
        public TestOwnedNavigationTemporalPeriodPropertyBuilder(
