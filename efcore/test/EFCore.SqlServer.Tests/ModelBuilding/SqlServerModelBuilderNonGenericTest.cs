...
{
    public class SqlServerNonGenericNonRelationship
        : SqlServerNonRelationship,
    ...
    public class SqlServerNonGenericComplexType
        : SqlServerComplexType,
            IClassFixture<SqlServerModelBuilderFixture>
    {
    ...
    public class SqlServerNonGenericInheritance
        : SqlServerInheritance,
            IClassFixture<SqlServerModelBuilderFixture>
    {
    ...
    public class SqlServerNonGenericOneToMany
        : SqlServerOneToMany,
            IClassFixture<SqlServerModelBuilderFixture>
    {
    ...
    public class SqlServerNonGenericManyToOne
        : SqlServerManyToOne,
            IClassFixture<SqlServerModelBuilderFixture>
    {
    ...
    public class SqlServerNonGenericOneToOne
        : SqlServerOneToOne,
            IClassFixture<SqlServerModelBuilderFixture>
    {
    ...
    public class SqlServerNonGenericManyToMany
        : SqlServerManyToMany,
            IClassFixture<SqlServerModelBuilderFixture>
    {
    ...
    public class SqlServerNonGenericOwnedTypes
        : SqlServerOwnedTypes,
            IClassFixture<SqlServerModelBuilderFixture>
    {
