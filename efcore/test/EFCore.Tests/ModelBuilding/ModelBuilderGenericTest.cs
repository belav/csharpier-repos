...
public class ModelBuilderGenericTest : ModelBuilderTest
{
    ...
    public class GenericComplexType : ComplexTypeTestBase
    {
        ...
        public virtual void Changing_propertyInfo_updates_Property()
        {
            ...
            modelBuilder
                ...
                .ComplexProperty(e => e.DoubleProperty)
                .Property(e => ((IReplaceable?)e)!.Property);
        ...
        where TEntity : class
    {
        ...
        protected virtual TestEntityTypeBuilder<TEntity> Wrap(
        ...
        protected virtual TestPrimitiveCollectionBuilder<TProperty> Wrap<TProperty>(
            PrimitiveCollectionBuilder<TProperty> propertyBuilder
        ...
        public override TestKeyBuilder<TEntity> HasKey(
            ...
            new GenericTestKeyBuilder<TEntity>(
                (KeyBuilder<TEntity>)EntityTypeBuilder.HasKey(keyExpression)
            );
        ...
        public override TestComplexPropertyBuilder<TProperty> ComplexProperty<TProperty>(
            ...
            where TProperty : default =>
            new GenericTestComplexPropertyBuilder<TProperty>(
                EntityTypeBuilder.ComplexProperty(propertyExpression)
            );
        ...
        public override TestDiscriminatorBuilder<TDiscriminator> HasDiscriminator<TDiscriminator>(
            ...
            new GenericTestDiscriminatorBuilder<TDiscriminator>(
                EntityTypeBuilder.HasDiscriminator<TDiscriminator>(propertyName)
            );
    ...
    {
        public GenericTestComplexPropertyBuilder(
            ComplexPropertyBuilder<TComplex> complexPropertyBuilder
        )
        {
        ...
        protected virtual TestComplexPropertyBuilder<T> Wrap<T>(
            ComplexPropertyBuilder<T> complexPropertyBuilder
        ...
        public override TestComplexTypePropertyBuilder<TProperty> Property<TProperty>(
            ...
            where TProperty : default => Wrap(PropertyBuilder.Property(propertyExpression));
        ...
        public override TestComplexPropertyBuilder<TProperty> ComplexProperty<TProperty>(
            ...
            where TProperty : default => Wrap(PropertyBuilder.ComplexProperty(propertyExpression));
        ...
        public ComplexPropertyBuilder<TComplex> Instance => PropertyBuilder;
    }

    protected class GenericTestDiscriminatorBuilder<TDiscriminator>
            ...
            IInfrastructure<PropertyBuilder<TProperty>>
    {
        ...
        protected virtual TestPropertyBuilder<TProperty> Wrap(
            PropertyBuilder<TProperty> propertyBuilder
        ) => new GenericTestPropertyBuilder<TProperty>(propertyBuilder);
    ...
    protected class GenericTestPrimitiveCollectionBuilder<TProperty>
        : TestPrimitiveCollectionBuilder<TProperty>,
            IInfrastructure<PrimitiveCollectionBuilder<TProperty>>
    {
        public GenericTestPrimitiveCollectionBuilder(
            PrimitiveCollectionBuilder<TProperty> primitiveCollectionBuilder
        )
        {
        ...
        PrimitiveCollectionBuilder<TProperty> IInfrastructure<
            PrimitiveCollectionBuilder<TProperty>
        >.Instance => PrimitiveCollectionBuilder;
    }
    ...
    {
        public GenericTestComplexTypePropertyBuilder(
            ComplexTypePropertyBuilder<TProperty> propertyBuilder
        )
        {
            PropertyBuilder = propertyBuilder;
        ...
        ComplexTypePropertyBuilder<TProperty> IInfrastructure<
            ComplexTypePropertyBuilder<TProperty>
        >.Instance => PropertyBuilder;
    }
    ...
    {
        public GenericTestComplexTypePrimitiveCollectionBuilder(
        ...
        protected virtual TestComplexTypePrimitiveCollectionBuilder<TProperty> Wrap(
            ...
            new GenericTestComplexTypePrimitiveCollectionBuilder<TProperty>(
        ...
        ComplexTypePrimitiveCollectionBuilder<TProperty> IInfrastructure<
    ...
    protected class GenericTestIndexBuilder<TEntity>
        ...
        where TTarget : class
    {
        ...
        public override TestNavigationBuilder HasAnnotation(string annotation, object? value) =>
            new GenericTestNavigationBuilder<TSource, TTarget>(
        ...
        public override TestNavigationBuilder HasField(string fieldName) =>
            new GenericTestNavigationBuilder<TSource, TTarget>(
                NavigationBuilder.HasField(fieldName)
            );

        public override TestNavigationBuilder AutoInclude(bool autoInclude = true) =>
            new GenericTestNavigationBuilder<TSource, TTarget>(
                NavigationBuilder.AutoInclude(autoInclude)
            );
        ...
        public override TestNavigationBuilder IsRequired(bool required = true) =>
            new GenericTestNavigationBuilder<TSource, TTarget>(
                NavigationBuilder.IsRequired(required)
            );
    }

    protected class GenericTestReferenceNavigationBuilder<TEntity, TRelatedEntity>
        ...
        where TRelatedEntity : class
    {
        ...
        protected ReferenceNavigationBuilder<
            TEntity,
            TRelatedEntity
        > ReferenceNavigationBuilder { get; }
        ...
        where TRelatedEntity : class
    {
        ...
        protected CollectionNavigationBuilder<
            TEntity,
            TRelatedEntity
        > CollectionNavigationBuilder { get; }
        ...
        where TRelatedEntity : class
    {
        ...
        public ReferenceCollectionBuilder<
            TEntity,
            TRelatedEntity
        > ReferenceCollectionBuilder { get; }
        ...
        where TRightEntity : class
    {
        ...
        protected CollectionCollectionBuilder<
            TLeftEntity,
            TRightEntity
        > CollectionCollectionBuilder { get; }
        ...
        public override TestEntityTypeBuilder<Dictionary<string, object>> UsingEntity(
            ...
            new GenericTestEntityTypeBuilder<Dictionary<string, object>>(
                new EntityTypeBuilder<Dictionary<string, object>>(
                    CollectionCollectionBuilder.UsingEntity(joinEntityName).Metadata
                )
            );
        ...
        public override TestEntityTypeBuilder<TJoinEntity> UsingEntity<TJoinEntity>(
            ...
            new GenericTestEntityTypeBuilder<TJoinEntity>(
                CollectionCollectionBuilder.UsingEntity<TJoinEntity>(
                    l =>
                        (
                            (GenericTestReferenceCollectionBuilder<TLeftEntity, TJoinEntity>)
                                configureRight(new GenericTestEntityTypeBuilder<TJoinEntity>(l))
                        ).ReferenceCollectionBuilder,
                    r =>
                        (
                            (GenericTestReferenceCollectionBuilder<TRightEntity, TJoinEntity>)
                                configureLeft(new GenericTestEntityTypeBuilder<TJoinEntity>(r))
                        ).ReferenceCollectionBuilder
                )
            );
        ...
        where TDependentEntity : class
    {
        ...
        OwnershipBuilder<TEntity, TDependentEntity> IInfrastructure<
            OwnershipBuilder<TEntity, TDependentEntity>
        >.Instance => OwnershipBuilder;
    }
        ...
        where TDependentEntity : class
    {
        ...
        protected virtual GenericTestOwnedNavigationBuilder<TNewEntity, TNewDependentEntity> Wrap<
            TNewEntity,
            TNewDependentEntity
        ...
        public override TestKeyBuilder<TDependentEntity> HasKey(
            ...
            new GenericTestKeyBuilder<TDependentEntity>(
                OwnedNavigationBuilder.HasKey(keyExpression)
            );
        ...
        public override TestIndexBuilder<TDependentEntity> HasIndex(
            ...
            new GenericTestIndexBuilder<TDependentEntity>(
        ...
        public override TestIndexBuilder<TDependentEntity> HasIndex(
            ...
            new GenericTestIndexBuilder<TDependentEntity>(
                OwnedNavigationBuilder.HasIndex(indexExpression)
            );
        ...
        OwnedNavigationBuilder<TEntity, TDependentEntity> IInfrastructure<
