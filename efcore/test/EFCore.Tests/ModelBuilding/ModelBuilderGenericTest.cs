    ...
    public class ModelBuilderGenericTest : ModelBuilderTest
    {
        ...
        protected class GenericTestModelBuilder : TestModelBuilder
        {
            ...
            public override TestEntityTypeBuilder<TEntity> SharedTypeEntity<TEntity>(string name) =>
                new GenericTestEntityTypeBuilder<TEntity>(
                ...
                IInfrastructure<EntityTypeBuilder<TEntity>> where TEntity : class
        {
            ...
            public override TestKeyBuilder<TEntity> HasAlternateKey(
                ...
                new GenericTestKeyBuilder<TEntity>(
                    EntityTypeBuilder.HasAlternateKey(keyExpression)
                );
            ...
            public override TestIndexBuilder<TEntity> HasIndex(
                ...
                new GenericTestIndexBuilder<TEntity>(
            ...
            where TRightEntity : class
        {
            ...
            public override TestEntityTypeBuilder<Dictionary<string, object>> UsingEntity(
                ...
                new GenericTestEntityTypeBuilder<Dictionary<string, object>>(
                    new(CollectionCollectionBuilder.UsingEntity(joinEntityName).Metadata)
                );
            ...
            public override TestEntityTypeBuilder<TRightEntity> UsingEntity<TJoinEntity>(
                ...
                new GenericTestEntityTypeBuilder<TRightEntity>(
                    CollectionCollectionBuilder.UsingEntity<TJoinEntity>(
                        e =>
                            configureJoinEntityType(
                                new GenericTestEntityTypeBuilder<TJoinEntity>(e)
                            )
                    )
                );
            ...
            where TDependentEntity : class
        {
            ...
            protected OwnedNavigationBuilder<
                TEntity,
                TDependentEntity
            > OwnedNavigationBuilder { get; }
            ...
            protected virtual GenericTestOwnedNavigationBuilder<
                TNewEntity,
                TNewDependentEntity
            ...
            public override TestPropertyBuilder<TProperty> Property<TProperty>(
                ...
                new GenericTestPropertyBuilder<TProperty>(
                    OwnedNavigationBuilder.Property(propertyExpression)
                );
            ...
            > OwnsOne<TNewDependentEntity>(
                ...
                Wrap(
                    OwnedNavigationBuilder.OwnsOne(navigationExpression, r => buildAction(Wrap(r)))
                );
            ...
            > OwnsMany<TNewDependentEntity>(
                ...
                Wrap(
                    OwnedNavigationBuilder.OwnsMany(navigationExpression, r => buildAction(Wrap(r)))
                );
