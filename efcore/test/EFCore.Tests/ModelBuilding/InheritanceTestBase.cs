...
public abstract partial class ModelBuilderTest
{
    public abstract class InheritanceTestBase : ModelBuilderTestBase
    {
        ...
        public virtual void Can_map_derived_types_first()
        {
            ...
            modelBuilder.Entity<ExtraSpecialBookLabel>().HasBaseType(null).Property(b => b.BookId);
        ...
        public virtual void Can_specify_discriminator_without_derived_types()
        {
            ...
            modelBuilder.Entity<Q>().HasDiscriminator<string>("Discriminator");
        ...
        public virtual void Setting_base_type_to_null_fixes_relationships()
        {
            ...
            var anotherDerivedFk = derivedDependentEntityBuilder
                .Metadata.GetDeclaredNavigations()
                .Single()
                .ForeignKey;
        ...
        public virtual void Index_removed_when_covered_by_an_inherited_foreign_key()
        {
            ...
            var backOrderClone = Clone(modelBuilder.Model)
            ...
            var (Level, _, Message, _, _) = modelBuilder.ModelLoggerFactory.Log.Single(e =>
                e.Id == CoreEventId.RedundantIndexRemoved
            );
        ...
        public virtual void Removing_derived_removes_it_from_directly_derived_type()
        {
            ...
            Assert.Empty(
                modelBuilder
                    .Model.FindEntityType(typeof(BookLabel).FullName)
        ...
        public virtual void Can_reconfigure_inherited_intraHierarchical_relationship()
        {
            ...
            var fk = bookLabelEntityBuilder
                .Metadata.FindNavigation(nameof(BookLabel.SpecialBookLabel))
                .ForeignKey;
            Assert.Equal(
                new[] { fk },
