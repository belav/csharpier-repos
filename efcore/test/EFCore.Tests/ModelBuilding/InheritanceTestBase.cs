    ...
    public abstract partial class ModelBuilderTest
    {
        public abstract class InheritanceTestBase : ModelBuilderTestBase
        {
            ...
            public virtual void Can_map_derived_types_first()
            {
                ...
                modelBuilder
                    .Entity<ExtraSpecialBookLabel>()
                    .HasBaseType(null)
                    .Property(b => b.BookId);

                modelBuilder
                    .Entity<SpecialBookLabel>()
                    .HasBaseType(null)
            ...
            public virtual void Can_map_derived_self_ref_many_to_one()
            {
                ...
                modelBuilder
                    .Entity<SelfRefManyToOneDerived>()
                    .HasData(new SelfRefManyToOneDerived { Id = 1, SelfRef1Id = 1 });
                ...
                var fk =
                    model
                        .FindEntityType(typeof(SelfRefManyToOne))
                        .FindNavigation(nameof(SelfRefManyToOne.SelfRef1)).ForeignKey;
            ...
            public virtual void Can_set_and_remove_base_type()
            {
                ...
                var initialProperties = pickleClone
                    .GetProperties()
                    .Where(p => p.Name != "__jObject")
                    .ToList();
                ...
                var initialReferencingForeignKeys = pickleClone
            ...
            public virtual void Index_removed_when_covered_by_an_inherited_foreign_key()
            {
                ...
                var derivedFk = derivedDependentEntityType
                    .GetForeignKeys()
                    .Single(
                        foreignKey =>
                ...
                Assert.Equal(
                    CoreResources
                        .LogRedundantIndexRemoved(new TestLogger<TestLoggingDefinitions>())
                        .GenerateMessage(
                            "{'CustomerId'}",
                            nameof(Order),
            ...
            public virtual void Index_removed_when_covered_by_an_inherited_index()
            {
                ...
                dependentEntityBuilder
                    .HasIndex(o => new { o.CustomerId, o.AnotherCustomerId })
                    .IsUnique();
                ...
                var indexRemoveMessage = CoreResources
                    .LogRedundantIndexRemoved(new TestLogger<TestLoggingDefinitions>())
                    .GenerateMessage(
                        "{'CustomerId'}",
                        nameof(Order),
            ...
            {
                var modelBuilder = CreateModelBuilder();
                var relationshipBuilder = modelBuilder
                    .Entity<BookLabel>()
            ...
            public virtual void Relationships_are_discovered_on_the_base_entity_type()
            {
                ...
                var specialNavigation = bookLabel
                    .GetDeclaredNavigations()
                ...
                var anotherNavigation = bookLabel
                    .GetDeclaredNavigations()
