    ...
    public abstract partial class ModelBuilderTest
    {
        public abstract class InheritanceTestBase : ModelBuilderTestBase
        {
            ...
            public virtual void Can_map_derived_types_first()
            {
                ...
                Assert.Empty(
                    model.FindEntityType(typeof(ExtraSpecialBookLabel)).GetDeclaredProperties()
                );
                Assert.Empty(
                    model.FindEntityType(typeof(SpecialBookLabel)).GetDeclaredProperties()
                );
                Assert.NotNull(
                    model.FindEntityType(typeof(SpecialBookLabel))
                        .FindProperty(nameof(BookLabel.BookId))
                );
            }
            ...
            public virtual void Can_map_derived_self_ref_many_to_one()
            {
                ...
                Assert.Empty(
                    model.FindEntityType(typeof(SelfRefManyToOneDerived)).GetDeclaredProperties()
                );
                Assert.NotNull(
                    model.FindEntityType(typeof(SelfRefManyToOne))
                        .FindNavigation(nameof(SelfRefManyToOne.SelfRef1))
                );
                Assert.NotNull(
                    model.FindEntityType(typeof(SelfRefManyToOne))
                        .FindNavigation(nameof(SelfRefManyToOne.SelfRef2))
                );
            }
            ...
            public virtual void Can_set_and_remove_base_type()
            {
                ...
                AssertEqual(
                    initialProperties,
                    pickle.GetProperties().Where(p => p.Name != "Discriminator"),
                ...
                AssertEqual(
                    initialProperties,
                    ingredient.GetProperties().Where(p => p.Name != "Discriminator"),
                    new PropertyComparer(compareAnnotations: false)
                );
                ...
                Assert.Equal(
                    initialReferencingForeignKeys.Count(),
                    ingredient.GetReferencingForeignKeys().Count()
                );
            }
            ...
            public virtual void Setting_base_type_to_null_fixes_relationships()
            {
                ...
                Assert.Same(
                    ...
                    derivedPrincipalEntityBuilder.Metadata.BaseType
                );
                Assert.Same(
                ...
                var derivedFk =
                    derivedPrincipalEntityBuilder.Metadata.GetNavigations().Single().ForeignKey;
                Assert.Null(derivedFk.DependentToPrincipal);
                Assert.Equal(
                    nameof(SpecialCustomer.SpecialOrders),
                    derivedFk.PrincipalToDependent.Name
                );
                ...
                derivedFk =
                    derivedPrincipalEntityBuilder.Metadata.GetNavigations().Single().ForeignKey;
                var anotherDerivedFk =
                    derivedDependentEntityBuilder.Metadata.GetDeclaredNavigations()
                        .Single().ForeignKey;
            ...
            public virtual void Pulling_relationship_to_a_derived_type_creates_relationships_on_other_derived_types()
            {
                ...
                Assert.Same(
                    dependentEntityBuilder.Metadata,
                    otherDerivedDependentEntityBuilder.Metadata.BaseType
                );
                ...
                derivedPrincipalEntityBuilder.HasMany(e => e.SpecialOrders)
                    .WithOne(e => (SpecialCustomer)e.Customer);

                var model = modelBuilder.FinalizeModel();

                var dependentEntityType = model.FindEntityType(
                    dependentEntityBuilder.Metadata.Name
                );
                var derivedDependentEntityType = model.FindEntityType(
                    derivedDependentEntityBuilder.Metadata.Name
                );
                var otherDerivedDependentEntityType = model.FindEntityType(
                    otherDerivedDependentEntityBuilder.Metadata.Name
                );
                var derivedPrincipalEntityType = model.FindEntityType(
                    derivedPrincipalEntityBuilder.Metadata.Name
                );
                ...
                var otherDerivedFk =
                    otherDerivedDependentEntityType.GetDeclaredNavigations().Single().ForeignKey;
            ...
            public virtual void Pulling_relationship_to_a_derived_type_reverted_creates_relationships_on_other_derived_types()
            {
                ...
                derivedDependentEntityBuilder.HasOne(e => (SpecialCustomer)e.Customer)
                ...
                var otherDerivedFk =
                    otherDerivedDependentEntityBuilder.Metadata.GetDeclaredNavigations()
                        .Single().ForeignKey;
                Assert.Equal(nameof(Order.Customer), otherDerivedFk.DependentToPrincipal.Name);
                Assert.Null(otherDerivedFk.PrincipalToDependent);
                Assert.Equal(nameof(Order.CustomerId), otherDerivedFk.Properties.Single().Name);
            ...
            public virtual void Can_match_navigation_to_derived_type_with_inverse_on_base()
            {
                ...
                derivedDependentEntityBuilder.HasOne(e => e.Customer).WithMany(e => e.SomeOrders);
            ...
            public virtual void Pulling_relationship_to_a_derived_type_many_to_one_creates_relationships_on_other_derived_types()
            {
                ...
                derivedPrincipalEntityBuilder.HasMany(e => (IEnumerable<SpecialOrder>)e.Orders)
                ...
                Assert.Same(derivedPrincipalEntityBuilder.Metadata, newFk.PrincipalEntityType);
                var otherDerivedFk =
                    otherDerivedPrincipalEntityBuilder.Metadata.GetDeclaredNavigations()
                        .Single().ForeignKey;
                Assert.Null(otherDerivedFk.DependentToPrincipal);
                Assert.Equal(
                    nameof(OtherCustomer.Orders),
                    otherDerivedFk.PrincipalToDependent.Name
                );
            }
            ...
            public virtual void Pulling_relationship_to_a_derived_type_one_to_one_creates_relationship_on_base()
            {
                ...
                principalEntityBuilder.HasOne(e => (SpecialOrder)e.Order)
                ...
                var newFk =
                    derivedDependentEntityBuilder.Metadata.GetDeclaredNavigations()
                        .Single().ForeignKey;
                Assert.Equal(
                    nameof(SpecialOrder.SpecialOrderCombination),
                    newFk.DependentToPrincipal.Name
                );
            ...
            public virtual void Pulling_relationship_to_a_derived_type_one_to_one_with_fk_creates_relationship_on_base()
            {
                ...
                Assert.Null(dependentEntityBuilder.Metadata.GetNavigations().Single().Inverse);
                var newFk =
                    principalEntityBuilder.Metadata.GetDeclaredNavigations().Single().ForeignKey;
            ...
            public virtual void Can_promote_shadow_fk_to_the_base_type()
            {
                ...
                dependentEntityBuilder.HasOne<SpecialCustomer>()
                    .WithMany()
                ...
                Assert.NotEqual(
                    newFk,
                    derivedDependentEntityBuilder.Metadata.GetDeclaredForeignKeys().Single()
                );
                Assert.Null(newFk.DependentToPrincipal);
                Assert.Null(newFk.PrincipalToDependent);
                Assert.Equal(
                    nameof(SpecialOrder.SpecialCustomerId),
            ...
            public virtual void Index_removed_when_covered_by_an_inherited_foreign_key()
            {
                ...
                principalEntityBuilder.HasMany(c => c.Orders)
                ...
                derivedPrincipalEntityBuilder.HasMany<BackOrder>()
                    .WithOne()
                ...
                var backOrderClone = modelBuilder.Model.Clone()
                ...
                var derivedFk = derivedDependentEntityType.GetForeignKeys()
                    .Single(
                        foreignKey =>
                            foreignKey.PrincipalEntityType == derivedPrincipalEntityBuilder.Metadata
                    );
                ...
                AssertEqual(
                    initialProperties,
                    derivedDependentEntityType.GetProperties(),
                    new PropertyComparer(compareAnnotations: false)
                );
                ...
                principalEntityBuilder.HasOne<Order>()
                    .WithOne()
                ...
                Assert.Equal(
                    CoreResources.LogRedundantIndexRemoved(new TestLogger<TestLoggingDefinitions>())
                        .GenerateMessage(
                            "{'CustomerId'}",
                            nameof(Order),
                ...
                fk = dependentEntityType.GetForeignKeys()
            ...
            public virtual void Index_removed_when_covered_by_an_inherited_index()
            {
                ...
                var dependentEntityType = dependentEntityBuilder.Metadata;
                var derivedDependentEntityType = derivedDependentEntityBuilder.Metadata;
                var index = dependentEntityType.FindIndex(
                    dependentEntityType.GetForeignKeys().Single().Properties
                );
                ...
                var indexRemoveMessage = CoreResources.LogRedundantIndexRemoved(
                ...
                Assert.Equal(
                    1,
                    modelBuilder.ModelLoggerFactory.Log.Count(l => l.Message == indexRemoveMessage)
                );
            ...
            public virtual void Setting_base_type_handles_require_value_generator_properly()
            {
                ...
                var fkProperty = modelBuilder.Model.FindEntityType(typeof(OrderDetails))
            ...
            public virtual void Can_create_relationship_between_base_type_and_derived_type()
            {
                ...
                Assert.Equal(
                    nameof(SpecialBookLabel.Id),
                    relationshipBuilder.Metadata.PrincipalKey.Properties.Single().Name
                );
            }
            ...
            public virtual void Removing_derived_type_make_sure_that_entity_type_is_removed_from_directly_derived_type()
            {
                ...
                Assert.Empty(
                    modelBuilder.Model.FindEntityType(typeof(BookLabel).FullName)
                ...
                foreach (var entityType in model.GetEntityTypes())
                {
                    ...
                    Assert.Empty(
                        entityType.GetForeignKeys()
                            .Where(
                                fk =>
                                    fk.PrincipalKey.DeclaringEntityType.ClrType == typeof(BookLabel)
                            )
                    );
                }
            }
            ...
            public virtual void Relationships_are_discovered_on_the_base_entity_type()
            {
                ...
                var specialNavigation = bookLabel.GetDeclaredNavigations()
                    .Single(n => n.Name == nameof(BookLabel.SpecialBookLabel));
                ...
                var anotherNavigation = bookLabel.GetDeclaredNavigations()
                    .Single(n => n.Name == nameof(BookLabel.AnotherBookLabel));
            ...
            public virtual void Can_reconfigure_inherited_intraHierarchical_relationship()
            {
                ...
                var extraSpecialBookLabelEntityBuilder =
                    modelBuilder.Entity<ExtraSpecialBookLabel>();
                modelBuilder.Entity<SpecialBookLabel>()
                ...
                var fk =
                    bookLabelEntityBuilder.Metadata.FindNavigation(
                        nameof(BookLabel.SpecialBookLabel)
                    ).ForeignKey;
                Assert.Equal(nameof(SpecialBookLabel.BookLabel), fk.DependentToPrincipal.Name);
                Assert.Equal(
                    new[] { fk },
                    extraSpecialBookLabelEntityBuilder.Metadata.GetForeignKeys()
                );
            }
            ...
            public virtual void Relationships_on_derived_types_are_discovered_first_if_base_is_one_sided()
            {
                ...
                Assert.Empty(
                    modelBuilder.Model.FindEntityType(typeof(PersonBaseViewModel)).GetForeignKeys()
                );

                var citizen = modelBuilder.Model.FindEntityType(typeof(CitizenViewModel));
                var citizenNavigation = citizen.GetDeclaredNavigations()
                    .Single(n => n.Name == nameof(CitizenViewModel.CityVM));
                ...
                var doctorNavigation = doctor.GetDeclaredNavigations()
                    .Single(n => n.Name == nameof(CitizenViewModel.CityVM));
                ...
                var policeNavigation = police.GetDeclaredNavigations()
                    .Single(n => n.Name == nameof(CitizenViewModel.CityVM));
                Assert.Equal(nameof(CityViewModel.Police), policeNavigation.Inverse.Name);

                Assert.Empty(
                    modelBuilder.Model.FindEntityType(typeof(CityViewModel)).GetForeignKeys()
                );
            ...
            public virtual void Can_remove_objects_in_derived_type_which_was_set_using_data_annotation_while_setting_base_type_by_convention()
            {
                ...
                var baseEntityType =
                    (EntityType)modelBuilder.Entity<BaseTypeWithKeyAnnotation>().Metadata;

                Assert.Equal(baseEntityType, derivedEntityType.BaseType);
                Assert.Equal(
                    ConfigurationSource.DataAnnotation,
                    baseEntityType.GetPrimaryKeyConfigurationSource()
                );
                Assert.Equal(
                    ConfigurationSource.DataAnnotation,
                    baseEntityType.FindNavigation(nameof(BaseTypeWithKeyAnnotation.Navigation))
                        .ForeignKey.GetConfigurationSource()
                );
                Assert.Equal(
                    ConfigurationSource.Convention,
                    derivedEntityType.GetBaseTypeConfigurationSource()
                );
            }
            ...
            public virtual void Cannot_remove_objects_in_derived_type_which_was_set_using_explicit_while_setting_base_type_by_convention()
            {
                ...
                derivedEntityTypeBuilder.HasOne(e => e.Navigation)
                    .WithOne()
                ...
                Assert.Equal(
                    ...
                    derivedEntityType.FindNavigation(
                            nameof(DerivedTypeWithKeyAnnotation.Navigation)
                        )
                        .ForeignKey.GetConfigurationSource()
                );
                Assert.Equal(
                    ConfigurationSource.Explicit,
                    derivedEntityType.GetPrimaryKeyConfigurationSource()
                );
            }
            ...
            public void Base_type_can_be_discovered_after_creating_foreign_keys_on_derived()
            {
                ...
                Assert.Equal(
                    ...
                    mb.Model.FindEntityType(typeof(Q)).FindProperty(nameof(Q.ID)).ValueGenerated
                );
            }
