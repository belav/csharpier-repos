...
public class ModelBuilderGenericRelationshipTypeTest : ModelBuilderGenericTest
{
    ...
    public class GenericTypeTestModelBuilder : TestModelBuilder
    {
        ...
        public override TestEntityTypeBuilder<TEntity> SharedTypeEntity<TEntity>(string name) =>
            new GenericTypeTestEntityTypeBuilder<TEntity>(
    ...
    protected class GenericTypeTestEntityTypeBuilder<TEntity>
        ...
        where TEntity : class
    {
        ...
        protected override TestPropertyBuilder<TProperty> Wrap<TProperty>(
    ...
    protected class GenericTypeTestPropertyBuilder<TProperty>
        : GenericTestPropertyBuilder<TProperty>
    {
        ...
        >() =>
            Wrap(
                PropertyBuilder.HasConversion(
                    typeof(TConverter),
                    typeof(TComparer),
                    typeof(TProviderComparer)
                )
            );
    }

    protected class GenericTypeTestReferenceNavigationBuilder<TEntity, TRelatedEntity>
        ...
        public override TestEntityTypeBuilder<TJoinEntity> UsingEntity<TJoinEntity>() =>
            new GenericTypeTestEntityTypeBuilder<TJoinEntity>(
                new EntityTypeBuilder<TJoinEntity>(
                    CollectionCollectionBuilder.UsingEntity(typeof(TJoinEntity)).Metadata
                )
            );
