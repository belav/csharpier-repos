    ...
    public abstract partial class ModelBuilderTest
    {
        public abstract class OneToManyTestBase : ModelBuilderTestBase
        {
            ...
            public virtual void Creates_shadow_FK_with_no_navigation()
            {
                ...
                var fk = dependentType.GetForeignKeys()
                    .Single(foreignKey => foreignKey != existingFk);
                var fkProperty = (IReadOnlyProperty)fk.Properties.Single();
                ...
                Assert.Empty(
                    dependentType.GetNavigations().Where(nav => nav.ForeignKey != existingFk)
                );
                Assert.Empty(
                    principalType.GetNavigations().Where(nav => nav.ForeignKey != existingFk)
                );
                Assert.Empty(principalType.GetForeignKeys());
                Assert.Same(principalKey, principalType.FindPrimaryKey());
                Assert.Equal(
            ...
            public virtual void Creates_both_navigations_and_uses_existing_composite_FK()
            {
                ...
                Assert.Equal(
                    nameof(Whoopper.Tomatoes),
                    principalType.GetNavigations().Single().Name
                );
                Assert.Same(fk, dependentType.GetNavigations().Single().ForeignKey);
                Assert.Same(fk, principalType.GetNavigations().Single().ForeignKey);
                Assert.Empty(principalType.GetForeignKeys());
            ...
            public virtual void Creates_relationship_on_existing_FK_is_using_different_principal_key()
            {
                ...
                Assert.True(
                    existingFk.DeclaringEntityType.FindIndex(existingFk.Properties).IsUnique
                );
                Assert.False(fk.DeclaringEntityType.FindIndex(fk.Properties).IsUnique);
            ...
            public virtual void Creates_overlapping_foreign_keys_with_different_nullability()
            {
                ...
                var requiredFk = dependentType.GetForeignKeys()
                ...
                var dependentKey = dependentType.FindPrimaryKey();
                Assert.True(
                    dependentKey.Properties.All(p => p.ValueGenerated == ValueGenerated.Never)
                );
            ...
            public virtual void Can_set_foreign_key_property_when_matching_property_added()
            {
                ...
                var foreignKey = model.FindEntityType(typeof(DependentEntity))
                    .GetForeignKeys()
                    .Single();
                ...
                var newForeignKey = model.FindEntityType(typeof(DependentEntity))
                    .GetForeignKeys()
                    .Single();
            ...
            public virtual void Creates_shadow_FK_property_with_non_shadow_PK()
            {
                ...
                Assert.Equal(
                    "ShadowId",
                    modelBuilder.Model.FindEntityType(typeof(Beta))
            ...
            public virtual void Handles_identity_correctly_while_removing_navigation()
            {
                ...
                var property = modelBuilder.Model.FindEntityType(typeof(Epsilon))
                    .FindProperty("Id");
            ...
            public virtual void Can_exclude_navigation_pointed_by_foreign_key_attribute_from_explicit_configuration()
            {
                ...
                var alphaFk =
                    model.FindEntityType(typeof(Epsilon))
                        .FindNavigation(nameof(Epsilon.Alpha)).ForeignKey;
                ...
                var epsilonFk =
                    model.FindEntityType(typeof(Alpha))
                        .FindNavigation(nameof(Alpha.Epsilons)).ForeignKey;
                ...
                var etaFk =
                    model.FindEntityType(typeof(Alpha))
                        .FindNavigation(nameof(Alpha.Etas)).ForeignKey;
                ...
                var kappaFk =
                    model.FindEntityType(typeof(Alpha))
                        .FindNavigation(nameof(Alpha.Kappas)).ForeignKey;
            ...
            public virtual void Can_exclude_navigation_with_foreign_key_attribute_on_principal_type_from_explicit_configuration()
            {
                ...
                var thetasFk =
                    model.FindEntityType(typeof(Alpha))
                        .FindNavigation(nameof(Alpha.Thetas)).ForeignKey;
                ...
                var alphaFk =
                    model.FindEntityType(typeof(Theta))
                        .FindNavigation(nameof(Theta.Alpha)).ForeignKey;
                Assert.Null(alphaFk.PrincipalToDependent);
                Assert.False(alphaFk.IsUnique);
            ...
            public virtual void Creates_one_to_many_relationship_with_single_ref_as_dependent_to_principal_if_no_matching_properties_either_side()
            {
                ...
                var fk =
                    modelBuilder.Model.FindEntityType(typeof(OneToOneDependentEntity))
            ...
            public virtual void Shadow_property_created_for_foreign_key_is_nullable()
            {
                ...
                Assert.True(
                    modelBuilder.Model.FindEntityType(typeof(Order))
                        .FindProperty("MyShadowFk").IsNullable
                );
                Assert.Equal(
                    typeof(int?),
                    modelBuilder.Model.FindEntityType(typeof(Order))
                        .FindProperty("MyShadowFk").ClrType
                );
            }
            ...
            public virtual void One_to_many_relationship_has_no_ambiguity_convention()
            {
                ...
                Assert.Equal(
                    "KappaId",
                    modelBuilder.Model.FindEntityType(typeof(Kappa))
            ...
            public virtual void One_to_many_relationship_has_no_ambiguity_explicit()
            {
                ...
                Assert.Equal(
                    "KappaId",
                    modelBuilder.Model.FindEntityType(typeof(Omega))
            ...
            {
                var modelBuilder = CreateModelBuilder();
                modelBuilder.Entity<PrincipalShadowFk>()
                ...
                Assert.Equal(
                    "PrincipalShadowFkId",
                    modelBuilder.Model.FindEntityType(typeof(DependentShadowFk))
                        .GetForeignKeys()
                        .Single().Properties[0].Name
                );
            }
            ...
            public virtual void Do_not_match_non_unique_FK_when_overlap_with_PK()
            {
                ...
                var fk = modelBuilder.Model.FindEntityType(typeof(CompositeChild))
                    .GetForeignKeys()
                    .Single();
