...
public abstract partial class ModelBuilderTest
{
    public abstract class OwnedTypesTestBase : ModelBuilderTestBase
    {
        ...
        public virtual void Can_configure_owned_type()
        {
            ...
            modelBuilder
                ...
                .OwnsOne(
                    ...
                    db =>
                    {
                        db.WithOwner(d => d.Customer).HasPrincipalKey(c => c.AlternateKey);
            ...
            Assert.Equal(
                ...
                ownership.PrincipalKey.Properties.Single().Name
            );
            var owned = ownership.DeclaringEntityType;
            Assert.Single(owned.GetForeignKeys());
            Assert.Equal(
                nameof(CustomerDetails.CustomerId),
                owned.GetIndexes().Single().Properties.Single().Name
            );
        ...
        public virtual void Can_configure_one_to_one_owned_type_with_fields()
        {
            ...
            modelBuilder.Entity<OneToOneOwnerWithField>().Navigation(owner => owner.OwnedDependent);
            ...
            Assert.Equal(
                nameof(OneToOneOwnedWithField.OneToOneOwner),
                ownership.DependentToPrincipal.Name
            );
            Assert.Equal(
                nameof(OneToOneOwnedWithField.OneToOneOwnerId),
                ownership.Properties.Single().Name
            );
            Assert.Equal(
                nameof(OneToOneOwnerWithField.Id),
                ownership.PrincipalKey.Properties.Single().Name
            );
            var owned = ownership.DeclaringEntityType;
            Assert.Single(owned.GetForeignKeys());
            ...
            Assert.Equal(
                1,
                model.GetEntityTypes().Count(e => e.ClrType == typeof(OneToOneOwnedWithField))
            );
        }
        ...
        public virtual void Can_configure_one_to_many_owned_type_with_fields()
        {
            ...
            var ownership = owner
                .FindNavigation(nameof(OneToManyOwnerWithField.OwnedDependents))
                .ForeignKey;
            Assert.True(ownership.IsOwnership);
            Assert.Equal(
            ...
            Assert.Equal(
                nameof(OneToManyOwnedWithField.OneToManyOwner),
                ownership.DependentToPrincipal.Name
            );
            Assert.Equal(
                nameof(OneToManyOwnedWithField.OneToManyOwnerId),
                ownership.Properties.Single().Name
            );
            Assert.Equal(
                nameof(OneToManyOwnerWithField.Id),
                ownership.PrincipalKey.Properties.Single().Name
            );
            var owned = ownership.DeclaringEntityType;
            Assert.Single(owned.GetForeignKeys());
            ...
            Assert.Equal(
                1,
                model.GetEntityTypes().Count(e => e.ClrType == typeof(OneToManyOwnedWithField))
            );
        }
        ...
        public virtual void Can_configure_owned_type_inverse()
        {
            ...
            modelBuilder.Entity<Customer>().OwnsOne(c => c.Details).HasOne(d => d.Customer);
        ...
        public virtual void Can_configure_owned_type_properties()
        {
            ...
            Assert.Equal(
                ...
                owned.GetChangeTrackingStrategy()
            );
        }
        ...
        public virtual void Can_configure_owned_type_key()
        {
            ...
            modelBuilder.Ignore<Product>();
            modelBuilder.Entity<Customer>().OwnsOne(c => c.Details).HasKey(c => c.Id);
        ...
        public virtual void Can_configure_ownership_foreign_key()
        {
            ...
            Assert.Equal(
                nameof(CustomerDetails.Id),
                ownership.DeclaringEntityType.FindPrimaryKey().Properties.Single().Name
            );
            Assert.Single(ownership.DeclaringEntityType.GetForeignKeys());
        }
        ...
        public virtual void Can_configure_multiple_ownerships()
        {
            ...
            var ownership1 = model
                .FindEntityType(typeof(OtherCustomer))
                .FindNavigation(nameof(Customer.Details))
                .ForeignKey;
            var ownership2 = model
                .FindEntityType(typeof(SpecialCustomer))
                .FindNavigation(nameof(Customer.Details))
                .ForeignKey;
        ...
        public virtual void Can_configure_one_to_one_relationship_from_an_owned_type()
        {
            ...
            var foreignKey = model
                ...
                .Single(fk =>
                    fk.DeclaringEntityType.ClrType == typeof(CustomerDetails)
        ...
        public virtual void Can_configure_owned_type_collection_from_an_owned_type()
        {
            ...
            var ownership = model
                ...
                .FindNavigation(nameof(CustomerDetails.Customer))
                .ForeignKey;
            var owned = ownership.DeclaringEntityType;
            ...
            Assert.Equal(
                ...
                chainedOwned.FindPrimaryKey().Properties.Single().Name
            );
        ...
        public virtual void Can_configure_owned_type_collection()
        {
            ...
            entityBuilder.WithOwner(o => o.Customer).HasPrincipalKey(c => c.AlternateKey);
            ...
            Assert.Equal(
                ...
                owned.GetIndexes().First().Properties.Single().Name
            );
            ...
            modelBuilder
                ...
                .OwnsMany(
                    ...
                    ob =>
                    {
                        ...
                        ob.HasOne<SpecialCustomer>().WithOne().HasPrincipalKey<SpecialCustomer>();
                    }
                );

            modelBuilder.Entity<SpecialCustomer>().OwnsMany(c => c.Orders).HasKey(o => o.OrderId);
                    ...
                    ob =>
                    {
                        ...
                        switch (hasDataOverload)
                        {
                            ...
                            case HasDataOverload.Array | HasDataOverload.Params:
                                ownedNavigationBuilder.HasData(
                                    (object)new OrderDetails { OrderId = -1 }
                                );
                                break;
                            case HasDataOverload.Array | HasDataOverload.Generic:
                                ...
                                break;
                            case HasDataOverload.Array
                                | HasDataOverload.Params
                                | HasDataOverload.Generic:
                            ...
                            default:
                                Assert.Fail(
                                    $"Unexpected HasData overload specification {hasDataOverload}"
                                );
                                break;
                        }
                    }
        ...
        public virtual void Can_chain_owned_type_collection_configurations()
        {
            ...
            Assert.Equal("OrderId", chainedOwned.GetIndexes().Single().Properties.Single().Name);
        ...
        public virtual void Can_configure_owned_type_collection_without_explicit_key()
        {
            ...
            Assert.Equal(nameof(Product.Order), chainedOwnership.DependentToPrincipal.Name);
            Assert.Equal(
                new[] { "OrderCustomerId", "OrderId" },
                chainedOwnership.Properties.Select(p => p.Name)
            );
            var chainedPk = chainedOwned.FindPrimaryKey();
            Assert.Equal(
                new[] { "OrderCustomerId", "OrderId", nameof(Product.Id) },
                chainedPk.Properties.Select(p => p.Name)
            );
            Assert.Empty(chainedOwned.GetIndexes());
        ...
        public virtual void Can_configure_owned_type_collection_without_explicit_key_or_candidate()
        {
            ...
            var pk = owned.FindPrimaryKey();
            Assert.Equal(
                new[] { nameof(Order.CustomerId), "Id" },
                pk.Properties.Select(p => p.Name)
            );
            Assert.Empty(owned.GetIndexes());
            ...
            var chainedPk = chainedOwned.FindPrimaryKey();
            Assert.Equal(
                new[] { "OrderCustomerId", "OrderId", "Id1" },
                chainedPk.Properties.Select(p => p.Name)
            );
            Assert.Empty(chainedOwned.GetIndexes());
        ...
        public virtual void Can_configure_owned_type_collection_with_one_call()
        {
            ...
            modelBuilder.Entity<Customer>().OwnsMany(c => c.Orders).HasKey(o => o.OrderId);
            ...
            var specialOwnership = specialCustomer
                .FindNavigation(nameof(SpecialCustomer.SpecialOrders))
                .ForeignKey;
            Assert.True(specialOwnership.IsOwnership);
            Assert.False(specialOwnership.IsUnique);
            Assert.Equal(
                nameof(SpecialOrder.SpecialOrderId),
                specialOwnership.DeclaringEntityType.FindPrimaryKey().Properties.Single().Name
            );
            Assert.Same(
        ...
        public virtual void Can_configure_owned_type_collection_with_one_call_afterwards()
        {
            ...
            modelBuilder.Entity<SpecialCustomer>();
            var specialCustomer = modelBuilder
                .Entity<SpecialCustomer>()
                .OwnsMany(
                    c => c.SpecialOrders,
                    so =>
        ...
        public virtual void Can_configure_single_owned_type_using_attribute()
        {
            ...
            Assert.NotNull(
                ownership.DeclaringEntityType.FindProperty(nameof(StreetAddress.Street))
            );
        }
        ...
        public virtual void Can_configure_fk_on_multiple_ownerships()
        {
            ...
            modelBuilder
                ...
                .OwnsOne(
                    ...
                    lb =>
                    {
                        lb.WithOwner().HasForeignKey("BookLabelId").HasAnnotation("Foo", "Bar");
                        lb.Ignore(l => l.Book);
                    }
                );
            modelBuilder
                ...
                .OwnsOne(
                    ...
                    lb =>
                    {
                        lb.WithOwner().HasForeignKey("BookLabelId");
            ...
            var bookOwnership1 = model
                .FindEntityType(typeof(Book))
                .FindNavigation(nameof(Book.Label))
                .ForeignKey;
            var bookOwnership2 = model
                .FindEntityType(typeof(Book))
                .FindNavigation(nameof(Book.AlternateLabel))
                .ForeignKey;
            Assert.NotSame(bookOwnership1.DeclaringEntityType, bookOwnership2.DeclaringEntityType);
            Assert.Equal(
                typeof(int),
                bookOwnership1
                    .DeclaringEntityType.GetForeignKeys()
                    .Single()
                    .Properties.Single()
                    .ClrType
            );
        ...
        public virtual void Can_configure_relationship_with_PK_ValueConverter()
        {
            ...
            var barNavigation = owned
                .GetDeclaredNavigations()
                .Single(n => !n.ForeignKey.IsOwnership);
        ...
        protected virtual void VerifyOwnedBookLabelModel(IReadOnlyModel model)
        {
            ...
            Assert.Equal(
                nameof(SpecialBookLabel.BookLabel),
                bookLabel1Ownership2.DependentToPrincipal.Name
            );
            ...
            Assert.Equal(
                nameof(SpecialBookLabel.AnotherBookLabel),
                bookLabel1Ownership1Subownership.DependentToPrincipal.Name
            );
            Assert.Equal(
                nameof(AnotherBookLabel.SpecialBookLabel),
                bookLabel1Ownership2Subownership.DependentToPrincipal.Name
            );
            Assert.Equal(
                nameof(SpecialBookLabel.AnotherBookLabel),
                bookLabel2Ownership1Subownership.DependentToPrincipal.Name
            );
            Assert.Equal(
                nameof(AnotherBookLabel.SpecialBookLabel),
                bookLabel2Ownership2Subownership.DependentToPrincipal.Name
            );
        ...
        public virtual void Removing_ambiguous_inverse_allows_navigations_to_be_discovered()
        {
            ...
            modelBuilder
                ...
                .OwnsOne(
                    ...
                    al =>
                    {
                        ...
                        al.OwnsOne(b => b.SpecialBookLabel).OwnsOne(b => b.AnotherBookLabel);
                    }
                );
            ...
            Assert.NotNull(
                bookLabelOwnership1.DeclaringEntityType.FindNavigation(nameof(BookLabel.Book))
            );
            Assert.NotNull(
                bookLabelOwnership2.DeclaringEntityType.FindNavigation(nameof(BookLabel.Book))
            );
            Assert.NotNull(
                bookLabel2Ownership1Subownership.DeclaringEntityType.FindNavigation(
                    nameof(BookLabel.Book)
                )
            );
            Assert.NotNull(
                bookLabel2Ownership2Subownership.DeclaringEntityType.FindNavigation(
                    nameof(BookLabel.Book)
                )
            );
            Assert.Equal(
        ...
        public virtual void Can_configure_self_ownership()
        {
            ...
            modelBuilder
                .Entity<BookLabel>()
                .OwnsOne(l => l.AnotherBookLabel, ab => ab.OwnsOne(l => l.AnotherBookLabel));

            var model = modelBuilder.FinalizeModel();

            var bookLabelOwnership = model
            ...
            Assert.Equal(
                selfOwnership.PrincipalEntityType.ClrType,
                selfOwnership.DeclaringEntityType.ClrType
            );
        ...
        )
        {
            var modelBuilder = CreateModelBuilder(c =>
            {
                if (defaultPrecision.HasValue)
                {
                    ...
                    {
                        c.Properties<decimal>()
                            .HavePrecision(defaultPrecision.Value, defaultScale.Value);
                    }
                    else
                    {
            ...
            var oneType = model.FindEntityType(
                typeof(OwnedOtter),
                nameof(MainOtter.OwnedEntity),
                mainType
            )!;
            var manyType = model.FindEntityType(
                typeof(OwnedOtter),
                nameof(OtherOtter.OwnedEntities),
                otherType
            )!;

            Assert.Equal(
                mainPrecision ?? defaultPrecision,
                mainType.FindProperty(nameof(MainOtter.Number))!.GetPrecision()
            );
            Assert.Equal(
                mainScale ?? defaultScale,
                mainType.FindProperty(nameof(MainOtter.Number))!.GetScale()
            );

            Assert.Equal(
                otherPrecision ?? defaultPrecision,
                otherType.FindProperty(nameof(OtherOtter.Number))!.GetPrecision()
            );
            Assert.Equal(
                otherScale ?? defaultScale,
                otherType.FindProperty(nameof(OtherOtter.Number))!.GetScale()
            );

            Assert.Equal(
                onePrecision ?? defaultPrecision,
                oneType.FindProperty(nameof(OwnedOtter.Number))!.GetPrecision()
            );
            Assert.Equal(
                oneScale ?? defaultScale,
                oneType.FindProperty(nameof(OwnedOtter.Number))!.GetScale()
            );

            Assert.Equal(
                manyPrecision ?? defaultPrecision,
                manyType.FindProperty(nameof(OwnedOtter.Number))!.GetPrecision()
            );
            Assert.Equal(
                manyScale ?? defaultScale,
                manyType.FindProperty(nameof(OwnedOtter.Number))!.GetScale()
            );

            void HasPrecision(
                TestPropertyBuilder<decimal> testPropertyBuilder,
                int? precision,
                int? scale
            )
            {
        ...
        public virtual void Can_configure_property_and_owned_entity_of_same_type()
        {
            ...
            modelBuilder.Entity<Office>().OwnsMany(o => o.DepartmentIds);

            var model = modelBuilder.FinalizeModel();

            var departmentType = model.FindEntityType(typeof(Department))!;
            var departmentNestedType = model.FindEntityType(
                typeof(DepartmentId),
                nameof(Department.DepartmentIds),
                departmentType
            )!;
            var officeType = model.FindEntityType(typeof(Office))!;
            var officeNestedType = model.FindEntityType(
                typeof(DepartmentId),
                nameof(Office.DepartmentIds),
                officeType
            )!;
            ...
            var departmentIdFkProperty = departmentNestedType.GetForeignKeys().Single().Properties[
                0
            ];
            Assert.Same(
                departmentIdProperty.GetValueConverter(),
                departmentIdFkProperty.GetValueConverter()
            );
        }
        ...
        public virtual void Configuring_base_type_as_owned_throws()
        {
            ...
            modelBuilder.Entity<Book>().Ignore(b => b.AlternateLabel).Ignore(b => b.Details);
        ...
        public virtual void Navigations_on_owned_type_can_set_access_mode_using_expressions()
        {
            ...
            Assert.Equal(
                ...
                principal.FindNavigation("OwnedDependent").GetPropertyAccessMode()
            );
            Assert.Equal(
                PropertyAccessMode.Property,
                dependent.FindNavigation("OneToOneOwner").GetPropertyAccessMode()
            );
        }
        ...
        public virtual void Navigations_on_owned_type_collection_can_set_access_mode()
        {
            ...
            Assert.Equal(
                PropertyAccessMode.Field,
                principal.FindNavigation("OwnedDependents").GetPropertyAccessMode()
            );
            Assert.Equal(
                PropertyAccessMode.Property,
                dependent.FindNavigation("OneToManyOwner").GetPropertyAccessMode()
            );
        }
        ...
        public virtual void Shared_type_can_be_used_as_owned_type()
        {
            ...
            Assert.Collection(
                ...
                t =>
                {
                    Assert.Equal(typeof(NestedOwnerOfSharedType), t.ClrType);
                },
                t =>
                {
                    Assert.Equal(typeof(OwnerOfSharedType), t.ClrType);
                },
                t =>
                {
