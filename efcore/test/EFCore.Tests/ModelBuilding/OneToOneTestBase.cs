...
public abstract partial class ModelBuilderTest
{
    public abstract class OneToOneTestBase : ModelBuilderTestBase
    {
        ...
        public virtual void Creates_both_navigations_and_overrides_existing_FK_when_uniqueness_does_not_match()
        {
            ...
            var model = modelBuilder.Model;
            modelBuilder.Entity<BigMak>();
            modelBuilder.Entity<Bun>().HasOne<BigMak>().WithMany().HasForeignKey(e => e.BurgerId);
            modelBuilder.Ignore<Pickle>();
        ...
        public virtual void Can_specify_shadow_fk_before_configuring_principal_PK()
        {
            ...
            Assert.Equal(
                typeof(int?),
                modelBuilder
                    .Model.FindEntityType(typeof(Nob))
                    .GetForeignKeys()
                    .Single()
                    .Properties.Single()
                    .ClrType
            ...
            Assert.Equal(
                typeof(string),
                modelBuilder
                    .Model.FindEntityType(typeof(Hob))
                    .GetForeignKeys()
                    .Single()
                    .Properties.Single()
                    .ClrType
        ...
        public virtual void Throws_if_ambiguous_FK_made_required()
        {
            ...
            Assert.Equal(
                ...
                Assert
                    .Throws<InvalidOperationException>(() => foreignKeyBuilder.HasForeignKey<Nob>())
                    .Message
            );
        }
        ...
        public virtual void Creates_field_backed_FK_property()
        {
            ...
            var fkProperty = modelBuilder
                .Model.FindEntityType(typeof(Quarks))
                .GetForeignKeys()
                .Single()
                .Properties.Single();
        ...
        public virtual void Can_create_self_referencing_relationship_without_navigations()
        {
            ...
            var relationship = modelBuilder.Entity<SelfRef>().HasOne<SelfRef>().WithOne().Metadata;
        ...
        public virtual void Can_create_relationship_if_dependent_has_matching_property_with_navigation_name()
        {
            ...
            var fk = modelBuilder
                .Model.FindEntityType(typeof(OneToOnePrincipalEntity))
        ...
        public virtual void Can_create_relationship_if_foreign_key_attribute_is_used()
        {
            ...
            var fk = modelBuilder
                .Model.FindEntityType(typeof(OneToOnePrincipalEntityWithAnnotation))
