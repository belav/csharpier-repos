    ...
    public abstract partial class ModelBuilderTest
    {
        public abstract class OneToOneTestBase : ModelBuilderTestBase
        {
            ...
            public virtual void Finds_existing_navigations_and_uses_associated_FK()
            {
                ...
                Assert.Same(
                    fk.PrincipalKey,
                    principalType.GetNavigations().Single().ForeignKey.PrincipalKey
                );
            ...
            public virtual void Can_create_two_FKs_using_the_same_property()
            {
                ...
                var foreignKeys = model.FindEntityType(typeof(CustomerDetails))
                    .GetForeignKeys()
                    .Where(fk => fk.Properties.Single().Name == nameof(CustomerDetails.Id))
                    .ToList();
                ...
                var orderFk = foreignKeys.Single(
                    fk => fk.PrincipalEntityType.ClrType == typeof(Order)
                );
                var dependentType = customerFk.DeclaringEntityType;
                var principalType = customerFk.PrincipalEntityType;
                Assert.Equal(
                    nameof(CustomerDetails.Customer),
                    customerFk.DependentToPrincipal.Name
                );
            ...
            public virtual void Creates_both_navigations_and_shadow_FK_if_existing_FK()
            {
                ...
                var existingFk = dependentType.GetForeignKeys()
            ...
            public virtual void Creates_both_navigations_and_new_FK()
            {
                ...
                Assert.Equal(
                    nameof(CustomerDetails.Customer),
                    dependentType.GetNavigations().Single().Name
                );
                Assert.Equal(
            ...
            public virtual void Creates_relationship_with_no_navigations()
            {
                ...
                var fk = dependentType.GetForeignKeys()
                    .Single(foreignKey => foreignKey.PrincipalToDependent == null);
            ...
            public virtual void Creates_both_navigations_and_uses_existing_FK_not_found_by_convention()
            {
                ...
                var fk = dependentType.GetForeignKeys()
                    .Single(foreignKey => foreignKey.Properties.All(p => p.Name == "BurgerId"));
                Assert.True(fk.IsUnique);
            ...
            public virtual void Removes_existing_FK_when_specified()
            {
                ...
                var principalType = model.FindEntityType(typeof(Order));
                var existingFk = dependentType.GetForeignKeys()
                    .Single(foreignKey => foreignKey.Properties.All(p => p.Name == "Id"));
            ...
            public virtual void Creates_FK_when_specified_on_dependent_with_navigation_to_principal()
            {
                ...
                Assert.Same(dependentKey, dependentType.FindPrimaryKey());
                Assert.Equal(
                    dependentType.GetForeignKeys().Count() - 1,
                    dependentType.GetIndexes().Count()
                );
                Assert.True(
                    principalType.GetForeignKeys()
            ...
            public virtual void Creates_FK_when_specified_on_dependent_with_no_navigations()
            {
                ...
                var fk = dependentType.GetForeignKeys()
                    .Single(foreignKey => foreignKey != existingFk);
                Assert.Same(
                    dependentType.FindProperty(nameof(Customer.Id)),
            ...
            public virtual void Principal_and_dependent_can_be_flipped_twice_separately()
            {
                ...
                var fk = dependentType.GetForeignKeys().Single();
                Assert.Same(
                    principalType.FindProperty(nameof(OrderDetails.OrderId)),
                    fk.PrincipalKey.Properties.Single()
                );
                Assert.Same(fk.DependentToPrincipal, dependentType.GetNavigations().Single());
                Assert.Same(fk.PrincipalToDependent, principalType.GetNavigations().Single());
                Assert.Same(fk, dependentType.GetNavigations().Single().ForeignKey);
                ...
                Assert.Same(
                    fk.PrincipalKey,
                    principalType.GetDeclaredKeys().First(k => !k.IsPrimaryKey())
                );
                Assert.Empty(dependentType.GetIndexes());
                Assert.Empty(principalType.GetIndexes());
                Assert.True(fk.IsUnique);
            ...
            public virtual void Principal_and_dependent_can_be_flipped_twice_in_reverse_order_separately()
            {
                ...
                Assert.Same(
                    dependentType.FindProperty(nameof(Order.OrderId)),
                    fk.Properties.Single()
                );
                Assert.Same(fk.DependentToPrincipal, dependentType.GetNavigations().Single());
                Assert.Same(fk.PrincipalToDependent, principalType.GetNavigations().Single());
            ...
            public virtual void Throws_if_not_principal_or_dependent_specified()
            {
                ...
                var relationship = modelBuilder.Entity<OrderDetails>()
                    .HasOne(e => e.Order)
                    .WithOne(e => e.Details);
            ...
            public virtual void Uses_composite_PK_for_FK_by_convention()
            {
                ...
                var model = modelBuilder.Model;
                modelBuilder.Entity<Whoopper>().HasKey(c => new { c.Id1, c.Id2 });
                modelBuilder.Entity<Mustard>().HasKey(c => new { c.Id1, c.Id2 });
                modelBuilder.Ignore<Tomato>();
            ...
            public virtual void Creates_composite_FK_when_specified_on_principal_with_no_navigations()
            {
                ...
                modelBuilder.Entity<ToastedBun>()
                    .HasOne(b => b.Whoopper)
                    .WithOne(w => w.ToastedBun)
                    .HasPrincipalKey<ToastedBun>();
                modelBuilder.Entity<Whoopper>().HasKey(c => new { c.Id1, c.Id2 });
                modelBuilder.Ignore<Tomato>();
                modelBuilder.Ignore<Mustard>();
            ...
            public virtual void Principal_and_dependent_can_be_flipped_when_self_referencing()
            {
                ...
                Assert.Equal(
                    fk.DeclaringEntityType.GetForeignKeys().Count(),
                    fk.DeclaringEntityType.GetIndexes().Count()
                );
                Assert.True(fk.DeclaringEntityType.FindIndex(fk.Properties).IsUnique);
            ...
            {
                var modelBuilder = CreateModelBuilder();
                modelBuilder.Entity<SelfRef>(eb => eb.HasKey(e => e.Id));

                var entityType = modelBuilder.Model.FindEntityType(typeof(SelfRef));

                modelBuilder.Entity<SelfRef>()
                    .HasOne(e => e.SelfRef1)
                    .WithOne(e => e.SelfRef2)
                    .HasForeignKey<SelfRef>(e => e.Id);
            ...
            public virtual void Can_create_relationship_if_navigations_have_same_name()
            {
                ...
                var principalEntityTypeBuilder =
                    modelBuilder.Entity<PrincipalTypeWithKeyAnnotation>();

                var foreignKey1 =
                    dependentEntityTypeBuilder.HasOne(p => p.Navigation)
                        .WithOne(d => d.Navigation).Metadata;

                var foreignKey2 =
                    principalEntityTypeBuilder.HasOne(p => p.Navigation)
                        .WithOne(d => d.Navigation).Metadata;
                ...
                Assert.Equal(
                    nameof(PrincipalTypeWithKeyAnnotation.Navigation),
                    foreignKey1.DependentToPrincipal?.Name
                );
                Assert.Equal(
                    nameof(BaseTypeWithKeyAnnotation.Navigation),
                    foreignKey1.PrincipalToDependent?.Name
                );
            }
            ...
            public virtual void Can_specify_shadow_fk_before_configuring_principal_PK()
            {
                ...
                modelBuilder.Entity<Hob>().HasKey(e => new { e.NobId1 });
                modelBuilder.Entity<Nob>().HasKey(e => new { e.HobId1 });
            ...
            {
                var modelBuilder = CreateModelBuilder();
                modelBuilder.Entity<Hob>().HasKey(e => new { e.Id1 });
                modelBuilder.Entity<Nob>().HasKey(e => new { e.Id1 });
            ...
            public virtual void Can_specify_shadow_identifying_fk()
            {
                ...
                modelBuilder.Entity<Hob>(
                    eb =>
                    {
                        ...
                        eb.HasOne(c => c.Nob).WithOne().HasForeignKey<Hob>("NobId");

                        eb.HasKey("NobId");

                        eb.HasOne(c => c.Nob).WithOne().HasForeignKey<Hob>("NobId").IsRequired();
                    }
                );
            ...
            public virtual void Overrides_PK_if_specified_FK_types_do_not_match_separately()
            {
                ...
                modelBuilder.Entity<Customer>();
                var guidProperty =
                    modelBuilder.Entity<CustomerDetails>().Property<Guid>("GuidProperty").Metadata;
                modelBuilder.Ignore<Order>();
            ...
            public virtual void Overrides_FK_if_specified_PK_types_do_not_match_separately()
            {
                ...
                var fk = dependentType.GetForeignKeys().Single();
                Assert.Same(
                    principalType.FindProperty(nameof(Customer.Id)),
                    fk.PrincipalKey.Properties.Single()
                );
                Assert.False(fk.IsRequired);
            ...
            public virtual void Overrides_PK_if_specified_FK_count_does_not_match_separately()
            {
                ...
                var fk = dependentType.GetForeignKeys().Single();
                AssertEqual(
                    new[] { dependentType.FindProperty(nameof(CustomerDetails.Id)), guidProperty },
                    fk.Properties
                );
            ...
            public virtual void Creates_index_even_if_covered_by_an_alternate_key()
            {
                ...
                modelBuilder.Entity<Whoopper>().HasKey(c => new { c.Id1, c.Id2 });
                modelBuilder.Entity<Tomato>()
                    .HasAlternateKey(c => new { c.BurgerId1, c.BurgerId2 });
                modelBuilder.Ignore<ToastedBun>();
                modelBuilder.Ignore<Mustard>();
            ...
            public virtual void Removes_existing_unidirectional_many_to_one_relationship()
            {
                ...
                var fk =
                    dependentType.GetNavigations()
                        .Single(n => n.Name == nameof(Nob.Hob)).ForeignKey;
                Assert.Same(
                    fk,
                    principalType.GetNavigations().Single(n => n.Name == nameof(Hob.Nob)).ForeignKey
                );
                Assert.True(fk.IsUnique);

                Assert.Equal(
                    0,
                    dependentType.GetForeignKeys().Count(foreignKey => foreignKey != fk)
                );
                Assert.Equal(
                    0,
                    principalType.GetForeignKeys().Count(foreignKey => foreignKey != fk)
                );
                Assert.Same(principalKey, principalType.FindPrimaryKey());
                Assert.Same(dependentKey, dependentType.FindPrimaryKey());
            }
            ...
            public virtual void Can_add_annotations()
            {
                ...
                var builder = modelBuilder.Entity<CustomerDetails>()
                    .HasOne(e => e.Customer)
                    .WithOne(e => e.Details);
            ...
            public virtual void Nullable_FK_can_be_made_required()
            {
                ...
                modelBuilder.Entity<Nob>().Property(e => e.HobId2).IsRequired(false);
                ...
                var principalType = (IReadOnlyEntityType)modelBuilder.Model.FindEntityType(
                    typeof(Hob)
                );
            ...
            public virtual void Non_nullable_FK_can_be_made_optional_separately()
            {
                ...
                modelBuilder.Entity<Nob>().HasOne(e => e.Hob).WithOne(e => e.Nob).IsRequired(false);
            ...
            public virtual void Throws_if_ambiguous_FK_made_required()
            {
                ...
                var foreignKeyBuilder = modelBuilder.Entity<Hob>()
                    .HasOne(e => e.Nob)
                    .WithOne(e => e.Hob)
                    .IsRequired();
                ...
                Assert.Contains(
                    ...
                    l =>
                        ...
                        && l.Message
                            == CoreResources.LogAmbiguousEndRequired(
            ...
            public virtual void Can_be_defined_before_the_PK_from_principal()
            {
                ...
                AssertEqual(
                    new[]
                    {
                        dependentEntityType.FindProperty("HobId1"),
                        dependentEntityType.FindProperty("HobId2")
                    },
                    fk.Properties
                );
                Assert.False(fk.IsRequired);
                ...
                AssertEqual(
                    ...
                    principalEntityType.FindPrimaryKey().Properties
                );
            }
            ...
            public virtual void Can_be_defined_before_the_PK_from_dependent()
            {
                ...
                AssertEqual(
                    new[]
                    {
                        dependentEntityType.FindProperty("NobId1"),
                        dependentEntityType.FindProperty("NobId2")
                    },
                    fk.Properties
                );
                Assert.True(fk.IsRequired);
            ...
            public virtual void Can_change_delete_behavior()
            {
                ...
                Assert.Equal(
                    ...
                    dependentType.GetNavigations().Single().ForeignKey.DeleteBehavior
                );
            ...
            public virtual void Configuring_FK_properties_as_PK_sets_DeleteBehavior_Cascade()
            {
                ...
                modelBuilder.Entity<Nob>().HasKey(e => e.HobId1);
            ...
            public virtual void Creates_shadow_FK_property_with_non_shadow_PK()
            {
                ...
                modelBuilder.Entity<Beta>(
                    b =>
                    {
                        b.HasOne(e => e.FirstNav).WithOne().HasForeignKey<Beta>("ShadowId");
                    }
                );
            ...
            public virtual void Creates_field_backed_FK_property()
            {
                ...
                var fkProperty = modelBuilder.Model.FindEntityType(typeof(Quarks))
                    .GetForeignKeys()
                    .Single()
                    .Properties.Single();
            ...
            public virtual void Can_create_self_referencing_relationship_without_navigations()
            {
                ...
                var relationship =
                    modelBuilder.Entity<SelfRef>().HasOne<SelfRef>().WithOne().Metadata;
            ...
            public virtual void Can_create_relationship_if_dependent_has_matching_property_with_navigation_name()
            {
                ...
                modelBuilder.Entity<OneToOnePrincipalEntity>()
                    .HasOne(e => e.NavOneToOneDependentEntity)
                    .WithOne(e => e.NavOneToOnePrincipalEntity);

                modelBuilder.FinalizeModel();

                var fk =
                    modelBuilder.Model.FindEntityType(typeof(OneToOnePrincipalEntity))
                        .FindNavigation("NavOneToOneDependentEntity").ForeignKey;
            ...
            public virtual void Can_create_relationship_if_user_specify_foreign_key_property()
            {
                ...
                modelBuilder.Entity<OneToOnePrincipalEntity>()
                    .HasOne(e => e.NavOneToOneDependentEntity)
                    .WithOne(e => e.NavOneToOnePrincipalEntity)
                    .HasForeignKey<OneToOneDependentEntity>(e => e.NavOneToOnePrincipalEntityId);
            ...
            public virtual void Can_create_relationship_if_user_specifies_principal_key_property()
            {
                ...
                var fk =
                    modelBuilder.Model.FindEntityType(typeof(OneToOnePrincipalEntity))
                        .FindNavigation(
                            nameof(OneToOnePrincipalEntity.NavOneToOneDependentEntity)
                        ).ForeignKey;

                Assert.Equal(typeof(OneToOnePrincipalEntity), fk.DeclaringEntityType.ClrType);
                Assert.Equal(typeof(OneToOneDependentEntity), fk.PrincipalEntityType.ClrType);
                Assert.Equal(
                    nameof(OneToOneDependentEntity.NavOneToOnePrincipalEntityId),
                    fk.PrincipalKey.Properties.First().Name
                );
                Assert.Equal(
                    nameof(OneToOnePrincipalEntity.NavOneToOneDependentEntityId),
            ...
            public virtual void Can_create_relationship_if_foreign_key_attribute_is_used()
            {
                ...
                modelBuilder.Entity<OneToOnePrincipalEntityWithAnnotation>()
                    .HasOne(e => e.NavOneToOneDependentEntityWithAnnotation)
                    .WithOne(e => e.NavOneToOnePrincipalEntityWithAnnotation);

                modelBuilder.FinalizeModel();

                var fk =
                    modelBuilder.Model.FindEntityType(typeof(OneToOnePrincipalEntityWithAnnotation))
                        .FindNavigation("NavOneToOneDependentEntityWithAnnotation").ForeignKey;

                Assert.Equal(
                    typeof(OneToOnePrincipalEntityWithAnnotation),
                    fk.DeclaringEntityType.ClrType
                );
                Assert.Equal(
                    typeof(OneToOneDependentEntityWithAnnotation),
            ...
            public virtual void Can_use_pk_as_fk_if_principal_end_is_specified()
            {
                ...
                modelBuilder.Entity<Book>()
                    .HasOne(e => e.Details)
                    .WithOne(e => e.AnotherBook)
                    .HasPrincipalKey<Book>(e => e.Id);

                Assert.Equal(
                    "Id",
                    modelBuilder.Model.FindEntityType(typeof(Book))
            ...
            public virtual void Does_not_use_pk_as_fk_if_principal_end_is_not_specified()
            {
                ...
                var fk =
                    modelBuilder.Entity<Book>()
                        .HasOne(e => e.Details)
                        .WithOne(e => e.AnotherBook).Metadata;
            ...
            public virtual void Creates_one_to_one_relationship_with_single_ref_as_principal_to_dependent_if_matching_properties_are_on_the_other_side()
            {
                ...
                Assert.Equal(
                    OneToOnePrincipalEntity.EntityMatchingProperty.Name,
            ...
            public virtual void Navigation_properties_can_set_access_mode()
            {
                ...
                var principal = (IReadOnlyEntityType)model.FindEntityType(
                    typeof(OneToOneNavPrincipal)
                );
                var dependent = (IReadOnlyEntityType)model.FindEntityType(typeof(NavDependent));

                Assert.Equal(
                    PropertyAccessMode.Field,
                    principal.FindNavigation("Dependent").GetPropertyAccessMode()
                );
                Assert.Equal(
                    PropertyAccessMode.Property,
                    dependent.FindNavigation("OneToOnePrincipal").GetPropertyAccessMode()
                );
            }
            ...
            public virtual void Navigation_to_shared_type_is_not_discovered_by_convention()
            {
                ...
                Assert.Equal(
                    CoreStrings.NonConfiguredNavigationToSharedType(
                        "Navigation",
                        nameof(ReferenceNavigationToSharedType)
                    ),
                    Assert.Throws<InvalidOperationException>(
                        () => modelBuilder.FinalizeModel()
                    ).Message
