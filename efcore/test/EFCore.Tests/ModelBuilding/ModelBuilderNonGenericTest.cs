...
public class ModelBuilderNonGenericTest : ModelBuilderTest
{
    ...
    public class NonGenericTestModelBuilder : TestModelBuilder
    {
        ...
        public override TestEntityTypeBuilder<TEntity> SharedTypeEntity<TEntity>(string name) =>
            new NonGenericTestEntityTypeBuilder<TEntity>(
        ...
        where TEntity : class
    {
        ...
        protected virtual NonGenericTestEntityTypeBuilder<TEntity> Wrap(
            EntityTypeBuilder entityTypeBuilder
        ) => new(entityTypeBuilder);

        protected virtual TestPropertyBuilder<TProperty> Wrap<TProperty>(
            PropertyBuilder propertyBuilder
        ) => new NonGenericTestPropertyBuilder<TProperty>(propertyBuilder);

        protected virtual TestPrimitiveCollectionBuilder<TProperty> Wrap<TProperty>(
            PrimitiveCollectionBuilder propertyBuilder
        ) => new NonGenericTestPrimitiveCollectionBuilder<TProperty>(propertyBuilder);

        public override TestEntityTypeBuilder<TEntity> HasAnnotation(
            string annotation,
            object? value
        ...
        public override TestKeyBuilder<TEntity> HasKey(
            Expression<Func<TEntity, object?>> keyExpression
        ) =>
            new NonGenericTestKeyBuilder<TEntity>(
                EntityTypeBuilder.HasKey(
                    keyExpression
                        .GetMemberAccessList()
        ...
        public override TestKeyBuilder<TEntity> HasAlternateKey(
            Expression<Func<TEntity, object?>> keyExpression
        ) =>
            new NonGenericTestKeyBuilder<TEntity>(
        ...
        )
        {
            var memberInfo = propertyExpression.GetMemberAccess();
            return Wrap<TProperty>(
                EntityTypeBuilder.PrimitiveCollection(
                    memberInfo.GetMemberType(),
                    memberInfo.GetSimpleMemberName()
                )
            );
        ...
        public override TestPropertyBuilder<TProperty> IndexerProperty<TProperty>(
            string propertyName
        ...
        public override TestComplexPropertyBuilder<TProperty> ComplexProperty<TProperty>(
            ...
            new NonGenericTestComplexPropertyBuilder<TProperty>(
                EntityTypeBuilder.ComplexProperty<TProperty>(propertyName)
            );
            ...
            where TProperty : default
        {
            ...
            return new NonGenericTestComplexPropertyBuilder<TProperty>(
                EntityTypeBuilder.ComplexProperty(
                    memberInfo.GetMemberType(),
                    memberInfo.GetSimpleMemberName()
                )
            );
        ...
        public override TestEntityTypeBuilder<TEntity> Ignore(
            Expression<Func<TEntity, object?>> propertyExpression
        ) =>
            Wrap(
                EntityTypeBuilder.Ignore(propertyExpression.GetMemberAccess().GetSimpleMemberName())
            );

        public override TestEntityTypeBuilder<TEntity> Ignore(string propertyName) =>
            Wrap(EntityTypeBuilder.Ignore(propertyName));

        public override TestIndexBuilder<TEntity> HasIndex(
        ...
        public override TestEntityTypeBuilder<TEntity> HasQueryFilter(
            Expression<Func<TEntity, bool>> filter
        ) => Wrap(EntityTypeBuilder.HasQueryFilter(filter));

        public override TestEntityTypeBuilder<TEntity> HasChangeTrackingStrategy(
            ChangeTrackingStrategy changeTrackingStrategy
        ) => Wrap(EntityTypeBuilder.HasChangeTrackingStrategy(changeTrackingStrategy));

        public override TestEntityTypeBuilder<TEntity> UsePropertyAccessMode(
            ...
            IInfrastructure<ComplexPropertyBuilder>
    {
        ...
        public override IMutableComplexProperty Metadata => PropertyBuilder.Metadata;

        protected virtual NonGenericTestComplexPropertyBuilder<T> Wrap<T>(
            ComplexPropertyBuilder entityTypeBuilder
        ) => new(entityTypeBuilder);

        protected virtual TestComplexTypePropertyBuilder<TProperty> Wrap<TProperty>(
            ComplexTypePropertyBuilder propertyBuilder
        ...
        public override TestComplexPropertyBuilder<TComplex> HasPropertyAnnotation(
            string annotation,
            object? value
        ) => Wrap<TComplex>(PropertyBuilder.HasPropertyAnnotation(annotation, value));

        public override TestComplexPropertyBuilder<TComplex> HasTypeAnnotation(
            string annotation,
            object? value
        ...
        public override TestComplexTypePropertyBuilder<TProperty> IndexerProperty<TProperty>(
            string propertyName
        ...
        public override TestComplexPropertyBuilder<TComplex> Ignore(
            Expression<Func<TComplex, object?>> propertyExpression
        ) =>
            Wrap<TComplex>(
                PropertyBuilder.Ignore(propertyExpression.GetMemberAccess().GetSimpleMemberName())
            );
        ...
        public override TestComplexPropertyBuilder<TComplex> HasChangeTrackingStrategy(
            ChangeTrackingStrategy changeTrackingStrategy
        ) => Wrap<TComplex>(PropertyBuilder.HasChangeTrackingStrategy(changeTrackingStrategy));

        public override TestComplexPropertyBuilder<TComplex> UsePropertyAccessMode(
            PropertyAccessMode propertyAccessMode
        ) => Wrap<TComplex>(PropertyBuilder.UsePropertyAccessMode(propertyAccessMode));

        public override TestComplexPropertyBuilder<TComplex> UseDefaultPropertyAccessMode(
            PropertyAccessMode propertyAccessMode
        ) => Wrap<TComplex>(PropertyBuilder.UseDefaultPropertyAccessMode(propertyAccessMode));

        public ComplexPropertyBuilder Instance => PropertyBuilder;
    }

    protected class NonGenericTestDiscriminatorBuilder<TDiscriminator>
        : TestDiscriminatorBuilder<TDiscriminator>
    {
        ...
        protected virtual TestDiscriminatorBuilder<TDiscriminator> Wrap(
            DiscriminatorBuilder discriminatorBuilder
        ...
        public override TestDiscriminatorBuilder<TDiscriminator> HasValue<TEntity>(
            TDiscriminator? value
        ) => Wrap(DiscriminatorBuilder.HasValue<TEntity>(value));

        public override TestDiscriminatorBuilder<TDiscriminator> HasValue(
            Type entityType,
            TDiscriminator? value
            ...
            IInfrastructure<PropertyBuilder>
    {
        ...
        public override TestPropertyBuilder<TProperty> HasAnnotation(
            string annotation,
            object? value
        ...
        public override TestPropertyBuilder<TProperty> IsConcurrencyToken(
        ...
        public override TestPropertyBuilder<TProperty> HasValueGeneratorFactory(
        ...
        public override TestPropertyBuilder<TProperty> UsePropertyAccessMode(
            PropertyAccessMode propertyAccessMode
    ...
    protected class NonGenericTestPrimitiveCollectionBuilder<TProperty>
        : TestPrimitiveCollectionBuilder<TProperty>,
            IInfrastructure<PrimitiveCollectionBuilder>
    {
        public NonGenericTestPrimitiveCollectionBuilder(
        ...
        public override IMutableProperty Metadata => PrimitiveCollectionBuilder.Metadata;

        public override TestElementTypeBuilder ElementType() =>
            new(PrimitiveCollectionBuilder.ElementType());

        public override TestPrimitiveCollectionBuilder<TProperty> ElementType(
            Action<TestElementTypeBuilder> builderAction
        ) =>
            Wrap(
                PrimitiveCollectionBuilder.ElementType(b =>
                    builderAction(new TestElementTypeBuilder(b))
                )
            );

        protected virtual TestPrimitiveCollectionBuilder<TProperty> Wrap(
            PrimitiveCollectionBuilder primitiveCollectionBuilder
        ) => new NonGenericTestPrimitiveCollectionBuilder<TProperty>(primitiveCollectionBuilder);

        public override TestPrimitiveCollectionBuilder<TProperty> HasAnnotation(
            string annotation,
            object? value
        ) => Wrap(PrimitiveCollectionBuilder.HasAnnotation(annotation, value));

        public override TestPrimitiveCollectionBuilder<TProperty> IsRequired(
        ...
        public override TestPrimitiveCollectionBuilder<TProperty> HasSentinel(
            TProperty? sentinel
        ...
        public override TestPrimitiveCollectionBuilder<TProperty> IsConcurrencyToken(
            bool isConcurrencyToken = true
        ...
        public override TestPrimitiveCollectionBuilder<TProperty> HasValueGenerator(
        ...
        public override TestPrimitiveCollectionBuilder<TProperty> HasValueGeneratorFactory(
            Type valueGeneratorFactoryType
        ...
        public override TestPrimitiveCollectionBuilder<TProperty> UsePropertyAccessMode(
            PropertyAccessMode propertyAccessMode
            ...
            IInfrastructure<ComplexTypePropertyBuilder>
    {
        ...
        protected virtual TestComplexTypePropertyBuilder<TProperty> Wrap(
            ComplexTypePropertyBuilder propertyBuilder
        ) => new NonGenericTestComplexTypePropertyBuilder<TProperty>(propertyBuilder);

        public override TestComplexTypePropertyBuilder<TProperty> HasAnnotation(
            string annotation,
            object? value
        ) => Wrap(PropertyBuilder.HasAnnotation(annotation, value));

        public override TestComplexTypePropertyBuilder<TProperty> IsRequired(
            bool isRequired = true
        ) => Wrap(PropertyBuilder.IsRequired(isRequired));
        ...
        public override TestComplexTypePropertyBuilder<TProperty> HasSentinel(
            TProperty? sentinel
        ) => Wrap(PropertyBuilder.HasSentinel(sentinel));
        ...
        public override TestComplexTypePropertyBuilder<TProperty> HasPrecision(
            int precision,
            int scale
        ) => Wrap(PropertyBuilder.HasPrecision(precision, scale));
        ...
        public override TestComplexTypePropertyBuilder<TProperty> IsConcurrencyToken(
            bool isConcurrencyToken = true
        ) => Wrap(PropertyBuilder.IsConcurrencyToken(isConcurrencyToken));
        ...
        public override TestComplexTypePropertyBuilder<TProperty> HasValueGeneratorFactory(
            Type valueGeneratorFactoryType
        ) => Wrap(PropertyBuilder.HasValueGeneratorFactory(valueGeneratorFactoryType));
        ...
        public override TestComplexTypePropertyBuilder<TProperty> UsePropertyAccessMode(
            PropertyAccessMode propertyAccessMode
        ) => Wrap(PropertyBuilder.UsePropertyAccessMode(propertyAccessMode));
    ...
    {
        public NonGenericTestComplexTypePrimitiveCollectionBuilder(
        ...
        protected virtual TestComplexTypePrimitiveCollectionBuilder<TProperty> Wrap(
            ...
            new NonGenericTestComplexTypePrimitiveCollectionBuilder<TProperty>(
                primitiveCollectionBuilder
            );

        public override TestComplexTypePrimitiveCollectionBuilder<TProperty> HasAnnotation(
            string annotation,
            object? value
        ) => Wrap(PrimitiveCollectionBuilder.HasAnnotation(annotation, value));

        public override TestComplexTypePrimitiveCollectionBuilder<TProperty> IsRequired(
            bool isRequired = true
        ) => Wrap(PrimitiveCollectionBuilder.IsRequired(isRequired));

        public override TestComplexTypePrimitiveCollectionBuilder<TProperty> HasMaxLength(
            int maxLength
        ) => Wrap(PrimitiveCollectionBuilder.HasMaxLength(maxLength));

        public override TestComplexTypePrimitiveCollectionBuilder<TProperty> HasSentinel(
            TProperty? sentinel
        ) => Wrap(PrimitiveCollectionBuilder.HasSentinel(sentinel));

        public override TestComplexTypePrimitiveCollectionBuilder<TProperty> IsUnicode(
            bool unicode = true
        ) => Wrap(PrimitiveCollectionBuilder.IsUnicode(unicode));

        public override TestComplexTypePrimitiveCollectionBuilder<TProperty> IsConcurrencyToken(
            bool isConcurrencyToken = true
        ) => Wrap(PrimitiveCollectionBuilder.IsConcurrencyToken(isConcurrencyToken));
        ...
        public override TestComplexTypePrimitiveCollectionBuilder<TProperty> HasValueGenerator(
            Type valueGeneratorType
        ) => Wrap(PrimitiveCollectionBuilder.HasValueGenerator(valueGeneratorType));
        ...
        public override TestComplexTypePrimitiveCollectionBuilder<TProperty> HasValueGeneratorFactory(
            Type valueGeneratorFactoryType
        ) => Wrap(PrimitiveCollectionBuilder.HasValueGeneratorFactory(valueGeneratorFactoryType));

        public override TestComplexTypePrimitiveCollectionBuilder<TProperty> HasField(
            string fieldName
        ) => Wrap(PrimitiveCollectionBuilder.HasField(fieldName));

        public override TestComplexTypePrimitiveCollectionBuilder<TProperty> UsePropertyAccessMode(
            PropertyAccessMode propertyAccessMode
        ) => Wrap(PrimitiveCollectionBuilder.UsePropertyAccessMode(propertyAccessMode));
    ...
    protected class NonGenericTestNavigationBuilder : TestNavigationBuilder
    {
        ...
        public override TestNavigationBuilder UsePropertyAccessMode(
            PropertyAccessMode propertyAccessMode
        ) =>
            new NonGenericTestNavigationBuilder(
                NavigationBuilder.UsePropertyAccessMode(propertyAccessMode)
            );
        ...
        public override TestNavigationBuilder EnableLazyLoading(bool lazyLoadingEnabled = true) =>
            new NonGenericTestNavigationBuilder(
                NavigationBuilder.EnableLazyLoading(lazyLoadingEnabled)
            );
    ...
    protected class NonGenericTestIndexBuilder<TEntity>
    ...
    protected class NonGenericTestReferenceNavigationBuilder<TEntity, TRelatedEntity>
        ...
        where TRelatedEntity : class
    {
        ...
        public override TestReferenceCollectionBuilder<TEntity, TRelatedEntity> HasAnnotation(
            string annotation,
            object? value
        ) =>
            new NonGenericTestReferenceCollectionBuilder<TEntity, TRelatedEntity>(
        ...
        public override TestReferenceCollectionBuilder<TEntity, TRelatedEntity> IsRequired(
            bool isRequired = true
        ) =>
            new NonGenericTestReferenceCollectionBuilder<TEntity, TRelatedEntity>(
                ReferenceCollectionBuilder.IsRequired(isRequired)
            );

        public override TestReferenceCollectionBuilder<TEntity, TRelatedEntity> OnDelete(
    ...
    protected class NonGenericTestReferenceReferenceBuilder<TEntity, TRelatedEntity>
        ...
        where TRelatedEntity : class
    {
        ...
        public override TestReferenceReferenceBuilder<TEntity, TRelatedEntity> HasAnnotation(
            string annotation,
            object? value
        ...
        public override TestReferenceReferenceBuilder<TEntity, TRelatedEntity> IsRequired(
            bool isRequired = true
        ) => Wrap(ReferenceReferenceBuilder.IsRequired(isRequired));

        public override TestReferenceReferenceBuilder<TEntity, TRelatedEntity> OnDelete(
            DeleteBehavior deleteBehavior
        ...
        where TRightEntity : class
    {
        ...
        public override TestEntityTypeBuilder<TJoinEntity> UsingEntity<TJoinEntity>(
            ...
            new NonGenericTestEntityTypeBuilder<TJoinEntity>(
                CollectionCollectionBuilder.UsingEntity(joinEntityName, typeof(TJoinEntity))
            );
        ...
        public override TestEntityTypeBuilder<Dictionary<string, object>> UsingEntity(
            Func<
                TestEntityTypeBuilder<Dictionary<string, object>>,
                TestReferenceCollectionBuilder<TLeftEntity, Dictionary<string, object>>
            > configureRight,
            Func<
                TestEntityTypeBuilder<Dictionary<string, object>>,
                TestReferenceCollectionBuilder<TRightEntity, Dictionary<string, object>>
            > configureLeft
        ) =>
            new NonGenericTestEntityTypeBuilder<Dictionary<string, object>>(
                CollectionCollectionBuilder.UsingEntity(
        ...
        public override TestEntityTypeBuilder<TJoinEntity> UsingEntity<TJoinEntity>(
            Func<
                ...
                TestReferenceCollectionBuilder<TLeftEntity, TJoinEntity>
            > configureRight,
            Func<
                TestEntityTypeBuilder<TJoinEntity>,
                    ...
                    l =>
                        (
                            (NonGenericTestReferenceCollectionBuilder<TLeftEntity, TJoinEntity>)
                                configureRight(new NonGenericTestEntityTypeBuilder<TJoinEntity>(l))
                        ).ReferenceCollectionBuilder,
                    r =>
                        (
                            (NonGenericTestReferenceCollectionBuilder<TRightEntity, TJoinEntity>)
        ...
        where TRelatedEntity : class
    {
        ...
        protected virtual NonGenericTestOwnershipBuilder<TNewEntity, TNewRelatedEntity> Wrap<
            TNewEntity,
            TNewRelatedEntity
        >(OwnershipBuilder ownershipBuilder)
            where TNewEntity : class
            where TNewRelatedEntity : class => new(ownershipBuilder);

        public override TestOwnershipBuilder<TEntity, TRelatedEntity> HasAnnotation(
            string annotation,
            object? value
        ...
        where TDependentEntity : class
    {
        ...
        public override TestOwnedNavigationBuilder<TEntity, TDependentEntity> HasAnnotation(
            ...
            Wrap<TEntity, TDependentEntity>(
                OwnedNavigationBuilder.HasAnnotation(annotation, value)
            );

        public override TestKeyBuilder<TDependentEntity> HasKey(
        ...
        public override TestKeyBuilder<TDependentEntity> HasKey(params string[] propertyNames) =>
            new NonGenericTestKeyBuilder<TDependentEntity>(
                OwnedNavigationBuilder.HasKey(propertyNames)
            );

        public override TestPropertyBuilder<TProperty> Property<TProperty>(string propertyName) =>
            new NonGenericTestPropertyBuilder<TProperty>(
                OwnedNavigationBuilder.Property<TProperty>(propertyName)
            );
        ...
        public override TestPropertyBuilder<TProperty> IndexerProperty<TProperty>(
            ...
            new NonGenericTestPropertyBuilder<TProperty>(
                OwnedNavigationBuilder.IndexerProperty<TProperty>(propertyName)
            );
        ...
        public override TestNavigationBuilder Navigation<TNavigation>(
            ...
            where TNavigation : class =>
            new NonGenericTestNavigationBuilder(
                OwnedNavigationBuilder.Navigation(
                    navigationExpression.GetMemberAccess().GetSimpleMemberName()
                )
            );
        ...
        public override TestIndexBuilder<TDependentEntity> HasIndex(
            ...
            new NonGenericTestIndexBuilder<TDependentEntity>(
                OwnedNavigationBuilder.HasIndex(propertyNames)
            );
        ...
        public override TestOwnershipBuilder<TEntity, TDependentEntity> WithOwner(
            ...
            new NonGenericTestOwnershipBuilder<TEntity, TDependentEntity>(
                OwnedNavigationBuilder.WithOwner(
                    referenceExpression?.GetMemberAccess().GetSimpleMemberName()
                )
            );
        ...
        > HasChangeTrackingStrategy(ChangeTrackingStrategy changeTrackingStrategy) =>
            Wrap<TEntity, TDependentEntity>(
                OwnedNavigationBuilder.HasChangeTrackingStrategy(changeTrackingStrategy)
            );
        ...
        public override TestOwnedNavigationBuilder<TEntity, TDependentEntity> UsePropertyAccessMode(
            ...
            Wrap<TEntity, TDependentEntity>(
                OwnedNavigationBuilder.UsePropertyAccessMode(propertyAccessMode)
            );
