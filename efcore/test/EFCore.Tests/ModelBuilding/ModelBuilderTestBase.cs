    ...
    public abstract partial class ModelBuilderTest
    {
        ...
        public abstract class TestEntityTypeBuilder<TEntity> where TEntity : class
        {
            ...
            public abstract TestOwnedNavigationBuilder<
                TEntity,
                TRelatedEntity
            > OwnsOne<TRelatedEntity>(string navigationName) where TRelatedEntity : class;
        ...
        public abstract class TestIndexBuilder<TEntity>
        {
            ...
            public abstract TestIndexBuilder<TEntity> HasAnnotation(
                string annotation,
                object? value
            );
            ...
            where TDependentEntity : class
        {
            ...
            public abstract DataBuilder<TDependentEntity> HasData(
