...
namespace Microsoft.EntityFrameworkCore
{
    public class ServiceProviderCacheTest
    {
        ...
        public void Returns_same_provider_for_same_type_of_configured_extensions()
        {
            ...
            Assert.Equal(
                CoreResources.LogServiceProviderCreated(new TestLogger<TestLoggingDefinitions>())
                    .GenerateMessage(),
        ...
        public void Returns_different_provider_for_different_type_of_configured_extensions()
        {
            ...
            Assert.Equal(
                CoreResources.LogServiceProviderDebugInfo(new TestLogger<TestLoggingDefinitions>())
                    .GenerateMessage(
                        string
                            .Join(
                                ", ",
        ...
        public void Reports_debug_info_for_most_similar_existing_service_provider()
        {
            ...
            for (var i = 0; i < 1000; i++)
            {
                ...
                Assert.Equal(
                    CoreResources.LogServiceProviderCreated(
                ...
                Assert.Equal(
                    CoreResources.LogServiceProviderDebugInfo(
                        new TestLogger<TestLoggingDefinitions>()
                    )
                        .GenerateMessage(
            ...
            where TExtension : class, IDbContextOptionsExtension, new()
        {
            ...
            ((IDbContextOptionsBuilderInfrastructure)optionsBuilder)
                .AddOrUpdateExtension(new TExtension());
