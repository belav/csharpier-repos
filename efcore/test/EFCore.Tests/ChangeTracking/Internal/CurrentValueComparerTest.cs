...
public class CurrentValueComparerTest
{
    ...
    public void Factory_creates_expected_comparer(Type expectedComparer, string property)
    {
        ...
        Assert.IsType(
            expectedComparer,
            factory.Create(context.Model.FindEntityType(typeof(Godzilla)).FindProperty(property))
        );
    }
    ...
    public void Can_sort_GenericComparableBytesStruct() =>
        CanSort(
            ...
            i => new Godzilla
            {
                GenericComparableBytesStruct = new GenericComparableBytesStruct { Value = i },
            },
    ...
    public void Can_sort_StructuralComparableBytesStruct() =>
        CanSort(
            ...
            i => new Godzilla
            {
                StructuralComparableBytesStruct = new StructuralComparableBytesStruct { Value = i },
            },
    ...
    public void Can_sort_NullableIntStructs() =>
        CanSortNullable(
            ...
            i => new Godzilla
            {
                NullableIntStruct = i.HasValue ? new IntStruct { Value = i.Value } : null,
            },
    ...
    public void Can_sort_ComparableIntClasses() =>
        CanSortNullable(
            ...
            i => new Godzilla
            {
                ComparableIntClass = i.HasValue ? new ComparableIntClass { Value = i.Value } : null,
            },
    ...
    public void Can_sort_NullableBytesStructs() =>
        CanSortNullable(
            ...
            i => new Godzilla
            {
                NullableBytesStruct = i == null ? null : new BytesStruct { Value = i },
            },
        ...
        CanSortNullable(
            ...
            i => new Godzilla
            {
                NullableComparableBytesStruct =
                    i == null ? null : new ComparableBytesStruct { Value = i },
            },
        ...
        CanSortNullable(
            ...
            i => new Godzilla
            {
                NullableStructuralComparableBytesStruct =
                    i == null ? null : new StructuralComparableBytesStruct { Value = i },
            },
    ...
    private class GenericComparableIntClass : IComparable<GenericComparableIntClass>
    {
        ...
        public override bool Equals(object obj) =>
            obj == this || obj?.GetType() == GetType() && Equals((GenericComparableIntClass)obj);
