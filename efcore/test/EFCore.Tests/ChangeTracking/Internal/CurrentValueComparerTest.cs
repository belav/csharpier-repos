...
namespace Microsoft.EntityFrameworkCore.ChangeTracking.Internal
{
    public class CurrentValueComparerTest
    {
        ...
        [InlineData(
            typeof(CurrentProviderValueComparer<IntStruct, int>),
        ...
        [InlineData(
            typeof(EntryCurrentValueComparer<GenericComparableIntStruct>),
            nameof(Godzilla.GenericComparableIntStruct)
        )]
        [InlineData(
            typeof(EntryCurrentValueComparer<GenericComparableBytesStruct>),
            nameof(Godzilla.GenericComparableBytesStruct)
        )]
        [InlineData(
            typeof(StructuralEntryCurrentValueComparer),
            nameof(Godzilla.StructuralComparableBytesStruct)
        )]
        [InlineData(
            typeof(NullableStructCurrentProviderValueComparer<IntStruct, int>),
        ...
        [InlineData(
            typeof(EntryCurrentValueComparer),
        ...
        [InlineData(
            typeof(NullableClassCurrentProviderValueComparer<IntClass, int>),
            nameof(Godzilla.IntClass)
        )]
        [InlineData(typeof(EntryCurrentValueComparer), nameof(Godzilla.ComparableIntClass))]
        [InlineData(
            typeof(EntryCurrentValueComparer<GenericComparableIntClass>),
        ...
        public void Factory_creates_expected_comparer(Type expectedComparer, string property)
        {
            ...
            Assert.IsType(
                expectedComparer,
                factory.Create(
                    context.Model.FindEntityType(typeof(Godzilla)).FindProperty(property)
                )
            );
        }
        ...
        public void Factory_throws_if_model_and_provider_type_are_not_comparable()
        {
            ...
            Assert.Equal(
                CoreStrings.NonComparableKeyTypes(
                    nameof(Godzilla),
                    nameof(Godzilla.NotComparableConverted),
                    nameof(NotComparable),
                    nameof(NotComparable)
                ),
                Assert
        ...
        public void Can_sort_ulongs() =>
            CanSort(
                nameof(Godzilla.ULong),
                i => new Godzilla { ULong = (ulong)i },
                g => (int)g.ULong
            );
        ...
        public void Can_sort_GenericComparableIntStructs() =>
            CanSort(
                ...
                i =>
                    new Godzilla
                    {
                        GenericComparableIntStruct = new GenericComparableIntStruct { Value = i }
                    },
        ...
        public void Can_sort_ComparableBytesStructs() =>
            CanSort(
                ...
                i =>
                    new Godzilla
                    {
                        ComparableBytesStruct = new ComparableBytesStruct { Value = i }
                    },
        ...
        public void Can_sort_GenericComparableBytesStruct() =>
            CanSort(
                ...
                i =>
                    new Godzilla
                    {
                        GenericComparableBytesStruct = new GenericComparableBytesStruct
                        {
                            Value = i
                        }
                    },
        ...
        public void Can_sort_StructuralComparableBytesStruct() =>
            CanSort(
                ...
                i =>
                    new Godzilla
                    {
                        StructuralComparableBytesStruct = new StructuralComparableBytesStruct
                        {
                            Value = i
                        }
                    },
        ...
        )
        {
            ...
            context.AttachRange(
                generator(new byte[0]),
                generator(new byte[] { 9 }),
                generator(new byte[0]),
                generator(new byte[] { 3, 3, 3 }),
                generator(new byte[] { 1, 1 }),
                generator(new byte[] { 9 }),
                generator(new byte[] { 7 }),
        ...
        public void Can_sort_NullableIntStructs() =>
            CanSortNullable(
                ...
                i =>
                    new Godzilla
                    {
                        NullableIntStruct = i.HasValue
                            ? new IntStruct { Value = i.Value }
                            : (IntStruct?)null
                    },
        ...
        public void Can_sort_NullableComparableIntStructs() =>
            CanSortNullable(
                ...
                i =>
                    new Godzilla
                    {
                        NullableComparableIntStruct = i.HasValue
                            ? new ComparableIntStruct { Value = i.Value }
                            : (ComparableIntStruct?)null
                    },
        ...
        public void Can_sort_NullableGenericComparableIntStructs() =>
            CanSortNullable(
                ...
                i =>
                    new Godzilla
                    {
                        NullableGenericComparableIntStruct = i.HasValue
                            ? new GenericComparableIntStruct { Value = i.Value }
                            : (GenericComparableIntStruct?)null
                    },
        ...
        public void Can_sort_IntClasses() =>
            CanSortNullable(
                ...
                i =>
                    new Godzilla
                    {
                        IntClass = i.HasValue ? new IntClass { Value = i.Value } : null
                    },
                g => g.IntClass?.Value
            );
        ...
        public void Can_sort_ComparableIntClasses() =>
            CanSortNullable(
                ...
                i =>
                    new Godzilla
                    {
                        ComparableIntClass = i.HasValue
                            ? new ComparableIntClass { Value = i.Value }
                            : null
                    },
        ...
        public void Can_sort_GenericComparableIntClass() =>
            CanSortNullable(
                ...
                i =>
                    new Godzilla
                    {
                        GenericComparableIntClass = i.HasValue
                            ? new GenericComparableIntClass { Value = i.Value }
                            : null
                    },
        ...
        public void Can_sort_NullableBytesStructs() =>
            CanSortNullable(
                ...
                i =>
                    ...
                    {
                        NullableBytesStruct =
                            i == null ? (BytesStruct?)null : new BytesStruct { Value = i }
                    },
        ...
        public void Can_sort_NullableComparableBytesStructs() =>
            CanSortNullable(
                ...
                i =>
                    new Godzilla
                    {
                        NullableComparableBytesStruct =
                            i == null
                                ? (ComparableBytesStruct?)null
                                : new ComparableBytesStruct { Value = i }
                    },
                ...
                i =>
                    new Godzilla
                    {
                        NullableGenericComparableBytesStruct =
                            i == null
                                ? (GenericComparableBytesStruct?)null
                                : new GenericComparableBytesStruct { Value = i }
                    },
        ...
        public void Can_sort_NullableStructuralComparableBytesStructs() =>
            CanSortNullable(
                ...
                i =>
                    new Godzilla
                    {
                        NullableStructuralComparableBytesStruct =
                            i == null
        ...
        public void Can_sort_Bytes() =>
            CanSortNullable(nameof(Godzilla.Bytes), i => new Godzilla { Bytes = i }, g => g.Bytes);
        ...
        private struct ComparableIntStruct : IComparable
        {
            ...
            public int CompareTo(object other) => Value - ((ComparableIntStruct)other).Value;
        }
        ...
        private struct GenericComparableIntStruct : IComparable<GenericComparableIntStruct>
        {
            ...
            public int CompareTo(GenericComparableIntStruct other) => Value - other.Value;
        }
        ...
        private class ComparableIntClass : IComparable
        {
            ...
            private bool Equals(ComparableIntClass other) => other != null && Value == other.Value;

            public override bool Equals(object obj) =>
                obj == this || obj?.GetType() == GetType() && Equals((ComparableIntClass)obj);

            public override int GetHashCode() => Value;

            public int CompareTo(object other) => Value - ((ComparableIntClass)other).Value;
        }
        ...
        private class GenericComparableIntClass : IComparable<GenericComparableIntClass>
        {
            ...
            public override bool Equals(object obj) =>
                obj == this
                || obj?.GetType() == GetType() && Equals((GenericComparableIntClass)obj);

            public override int GetHashCode() => Value;

            public int CompareTo(GenericComparableIntClass other) => Value - other.Value;
        }
    }
}
