...
#pragma warning restore IDE0039 // Use local function
        ...
        public void Can_add_instance_services()
        {
            ...
            AddServiceInstanceTest(
                m => m.TryAddSingleton(typeof(IFakeService), instance),
                instance
            );
        }
        ...
        public void Existing_services_are_not_replaced()
        {
            ...
            ExistingServiceTest(
                m => m.TryAddScoped<IFakeService, FakeService>(p => new FakeService())
            );
            ExistingServiceTest(
            ...
            ExistingServiceTest(
                m => m.TryAddTransient(typeof(IFakeService), p => new FakeService())
            );
            ExistingServiceTest(m => m.TryAddScoped(typeof(IFakeService), p => new FakeService()));
            ExistingServiceTest(
                m => m.TryAddSingleton(typeof(IFakeService), p => new FakeService())
            );
