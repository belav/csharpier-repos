    ...
    public class ModelValidatorTest : ModelValidatorTestBase
    {
        ...
        public virtual void Detects_key_property_which_cannot_be_compared()
        {
            ...
            entityType.SetPrimaryKey(
                entityType.AddProperty(nameof(WithNonComparableKey.Id), typeof(NotComparable))
            );
        ...
        public virtual void Detects_unique_index_property_which_cannot_be_compared()
        {
            ...
            entityType.SetPrimaryKey(
                entityType.AddProperty(nameof(WithNonComparableUniqueIndex.Id), typeof(int))
            );
            entityType.AddIndex(
                entityType.AddProperty(
                    nameof(WithNonComparableUniqueIndex.Index),
                    typeof(NotComparable)
                )
            ).IsUnique = true;
        ...
        public virtual void Ignores_normal__property_which_cannot_be_compared()
        {
            ...
            entityType.SetPrimaryKey(
                entityType.AddProperty(nameof(WithNonComparableNormalProperty.Id), typeof(int))
            );
            entityType.AddProperty(
        ...
        public virtual void Detects_custom_converter_for_collection_type_without_comparer()
        {
            ...
            VerifyWarning(
                CoreResources.LogCollectionWithoutComparer(new TestLogger<TestLoggingDefinitions>())
        ...
        public virtual void Passes_on_redundant_foreign_key()
        {
            ...
            VerifyWarning(
                CoreResources.LogRedundantForeignKey(new TestLogger<TestLoggingDefinitions>())
        ...
        public virtual void Passes_on_valid_many_to_many_navigations()
        {
            ...
            var orderProductForeignKey = orderProductEntity.GetForeignKeys()
                .Single(fk => fk.PrincipalEntityType == orderEntity);
            var productOrderForeignKey = orderProductEntity.GetForeignKeys()
        ...
        public virtual void Detects_entity_type_with_multiple_ownerships()
        {
            ...
            VerifyError(
                CoreStrings.MultipleOwnerships(
                    ...
                    "'SampleEntity.ReferencedEntity', 'SampleEntity.'"
                ),
                modelBuilder.Metadata
            );
        }
        ...
        public virtual void Detects_ForeignKey_on_inherited_generated_key_property()
        {
            ...
            modelBuilder.Entity<Generic<int>>()
                .HasOne<Abstract>()
                .WithOne()
