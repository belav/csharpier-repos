...
public class EntityFrameworkServicesBuilderTest
{
    ...
    public void Can_register_singleton_service_with_full_factory() =>
        TestSingleton(
            b => b.TryAdd<IDbSetInitializer, FakeDbSetInitializer>(p => new FakeDbSetInitializer())
        );
    ...
    public void Can_register_multiple_scoped_service_with_full_factory() =>
        TestMultipleScoped(
            b => b.TryAdd<IResettableService, FakeResetableService>(p => new FakeResetableService())
        );
