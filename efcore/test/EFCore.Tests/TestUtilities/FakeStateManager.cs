...
public class FakeStateManager : IStateManager
{
    ...
    public IEnumerable<IUpdateEntry> GetDependents(
    ...
    public IEnumerable<IUpdateEntry> GetDependentsFromNavigation(
        IUpdateEntry principalEntry,
        IForeignKey foreignKey
    ) => throw new NotImplementedException();
    ...
    public InternalEntityEntry CreateEntry(
    ...
    public InternalEntityEntry TryGetEntry(
        IKey key,
    ...
    public IEnumerable<Tuple<INavigationBase, InternalEntityEntry>> GetRecordedReferrers(
        object referencedEntity,
        bool clear
    ) => throw new NotImplementedException();
    ...
    public InternalEntityEntry FindPrincipalUsingRelationshipSnapshot(
        InternalEntityEntry entityEntry,
        IForeignKey foreignKey
    ) => throw new NotImplementedException();
