...
public class DbContextOptionsTest
{
    ...
    {
        var optionsBuilder = new DbContextOptionsBuilder().ConfigureWarnings(c =>
    ...
    public void Extensions_can_be_added_to_options()
    {
        ...
        Assert.Same(
            extension1,
            optionsBuilder.Options.FindExtension<FakeDbContextOptionsExtension1>()
        );
        Assert.Same(
            extension2,
            optionsBuilder.Options.FindExtension<FakeDbContextOptionsExtension2>()
        );
    }
    ...
    public void UseModel_on_generic_builder_returns_generic_builder()
    {
        ...
        var optionsBuilder = GenericCheck(
            new DbContextOptionsBuilder<UnkoolContext>().UseModel(model)
        );
    ...
    public void UseLoggerFactory_on_generic_builder_returns_generic_builder()
    {
        ...
        var optionsBuilder = GenericCheck(
            new DbContextOptionsBuilder<UnkoolContext>().UseLoggerFactory(loggerFactory)
        );

        Assert.Same(
            loggerFactory,
            optionsBuilder.Options.FindExtension<CoreOptionsExtension>().LoggerFactory
        );
    }
    ...
    public void UseMemoryCache_on_generic_builder_returns_generic_builder()
    {
        ...
        var optionsBuilder = GenericCheck(
            new DbContextOptionsBuilder<UnkoolContext>().UseMemoryCache(memoryCache)
        );

        Assert.Same(
            memoryCache,
            optionsBuilder.Options.FindExtension<CoreOptionsExtension>().MemoryCache
        );
    }
    ...
    public void UseQueryTrackingBehavior_on_generic_builder_returns_generic_builder()
    {
        ...
        Assert.Equal(
            QueryTrackingBehavior.NoTracking,
            optionsBuilder.Options.FindExtension<CoreOptionsExtension>().QueryTrackingBehavior
        );
    }
    ...
    {
        var optionsBuilder = GenericCheck(
            new DbContextOptionsBuilder<UnkoolContext>().ConfigureWarnings(c =>
                c.Default(WarningBehavior.Throw)
            )
        );
    ...
    private DbContextOptionsBuilder<UnkoolContext> GenericCheck(
        DbContextOptionsBuilder<UnkoolContext> optionsBuilder
    ) => optionsBuilder;
