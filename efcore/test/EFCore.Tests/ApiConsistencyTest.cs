            ...
            {
                {
                    typeof(IConventionNavigationBuilder).GetMethod(
                        nameof(IConventionNavigationBuilder.EnableLazyLoading),
                ...
                },
                {
                    typeof(IConventionSkipNavigationBuilder).GetMethod(
                        nameof(IConventionSkipNavigationBuilder.EnableLazyLoading),
                        new[] { typeof(bool?), typeof(bool) }
                    )!,
                    "LazyLoadingEnabled"
                },
        ...
        public override HashSet<MethodInfo> UnmatchedMetadataMethods { get; } =
            new()
            {
                ...
                typeof(ComplexPropertyBuilder).GetMethod(
                    nameof(ComplexPropertyBuilder.ComplexProperty),
                    0,
                    new[] { typeof(string) }
                ),
                typeof(ComplexPropertyBuilder).GetMethod(
                ...
                typeof(ComplexPropertyBuilder).GetMethod(
                    nameof(ComplexPropertyBuilder.ComplexProperty),
                    0,
                    new[] { typeof(Type), typeof(string), typeof(string) }
                ),
                ...
                typeof(OwnedNavigationBuilder).GetMethod(
                    nameof(OwnedNavigationBuilder.OwnsOne),
                    0,
                    new[] { typeof(Type), typeof(string), typeof(Action<OwnedNavigationBuilder>) }
                ),
                typeof(OwnedNavigationBuilder).GetMethod(
                    nameof(OwnedNavigationBuilder.OwnsMany),
                    0,
                ...
                typeof(IConventionModelBuilder).GetMethod(
                    nameof(IConventionModelBuilder.ComplexType)
                ),
                ...
                typeof(IConventionTypeBaseBuilder).GetMethod(
                    nameof(IConventionTypeBaseBuilder.RemoveUnusedImplicitProperties)
                ),
                typeof(IConventionEntityTypeBuilder).GetMethod(
                    nameof(IConventionEntityTypeBuilder.GetTargetEntityTypeBuilder)
                ),
