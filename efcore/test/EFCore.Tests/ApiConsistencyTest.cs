...
namespace Microsoft.EntityFrameworkCore
{
    public class ApiConsistencyTest
        : ApiConsistencyTestBase<ApiConsistencyTest.ApiConsistencyFixture>
    {
        ...
        public class ApiConsistencyFixture : ApiConsistencyFixtureBase
        {
            ...
            public override HashSet<MethodInfo> NonVirtualMethods { get; } =
                new()
                {
                    typeof(CompiledQueryCacheKeyGenerator).GetMethod(
                        "GenerateCacheKeyCore",
                        AnyInstance
                    ),
                    ...
                    typeof(InternalEntityEntry).GetMethod(
                        nameof(InternalEntityEntry.HasDefaultValue)
                    ),
            ...
            public override HashSet<MethodInfo> UnmatchedMetadataMethods { get; } =
                new()
                {
                    ...
                    typeof(IConventionPropertyBase).GetMethod(
                        nameof(IConventionPropertyBase.SetField),
                        new[] { typeof(string), typeof(bool) }
                    ),
                    typeof(IReadOnlyAnnotatable).GetMethod(
                        nameof(IReadOnlyAnnotatable.FindAnnotation)
                    ),
                    typeof(IReadOnlyAnnotatable).GetMethod(
                        nameof(IReadOnlyAnnotatable.GetAnnotations)
                    ),
                    typeof(IReadOnlyAnnotatable).GetMethod(
                        nameof(IReadOnlyAnnotatable.GetAnnotation)
                    ),
                    typeof(IMutableAnnotatable).GetMethod("set_Item"),
                    typeof(IConventionAnnotatable).GetMethod(
                        nameof(IConventionAnnotatable.SetAnnotation)
                    ),
                    typeof(IConventionAnnotatable).GetMethod(
                        nameof(IConventionAnnotatable.SetOrRemoveAnnotation)
                    ),
                    typeof(IConventionModelBuilder).GetMethod(
                        nameof(IConventionModelBuilder.HasNoEntityType)
                    ),
                    typeof(IReadOnlyEntityType).GetMethod(
                        nameof(IReadOnlyEntityType.GetConcreteDerivedTypesInclusive)
                    ),
                    typeof(IReadOnlyEntityType).GetMethod(
                        nameof(IReadOnlyEntityType.FindClosestCommonParent)
                    ),
                    typeof(IReadOnlyEntityType).GetMethod(
                        nameof(IReadOnlyEntityType.LeastDerivedType)
                    ),
                    ...
                    typeof(IConventionAnnotatableBuilder).GetMethod(
                        nameof(IConventionAnnotatableBuilder.HasNonNullAnnotation)
                    ),
                    typeof(IConventionEntityTypeBuilder).GetMethod(
                        nameof(IConventionEntityTypeBuilder.RemoveUnusedImplicitProperties)
                    ),
                    typeof(IConventionEntityTypeBuilder).GetMethod(
                        nameof(IConventionEntityTypeBuilder.Ignore)
                    ),
                    typeof(IConventionModelBuilder).GetMethod(
                        nameof(IConventionModelBuilder.Ignore),
                    ...
                    typeof(IConventionPropertyBuilder).GetMethod(
                        nameof(IConventionPropertyBuilder.HasField),
                        new[] { typeof(string), typeof(bool) }
                    ),
                    typeof(IConventionPropertyBuilder).GetMethod(
                        nameof(IConventionPropertyBuilder.HasField),
                        new[] { typeof(FieldInfo), typeof(bool) }
                    ),
                    typeof(IConventionPropertyBuilder).GetMethod(
                        nameof(IConventionPropertyBuilder.UsePropertyAccessMode),
                        new[] { typeof(PropertyAccessMode), typeof(bool) }
                    ),
                    typeof(IConventionServicePropertyBuilder).GetMethod(
                        nameof(IConventionServicePropertyBuilder.HasField),
                        new[] { typeof(string), typeof(bool) }
                    ),
                    typeof(IConventionServicePropertyBuilder).GetMethod(
                        nameof(IConventionServicePropertyBuilder.HasField),
                    ...
                    typeof(IConventionServicePropertyBuilder).GetMethod(
                        nameof(IConventionServicePropertyBuilder.UsePropertyAccessMode),
                        new[] { typeof(PropertyAccessMode), typeof(bool) }
                    ),
                    typeof(IConventionNavigationBuilder).GetMethod(
                        nameof(IConventionNavigationBuilder.HasField),
                        new[] { typeof(string), typeof(bool) }
                    ),
                    typeof(IConventionNavigationBuilder).GetMethod(
                        nameof(IConventionNavigationBuilder.HasField),
                    ...
                    typeof(IConventionNavigationBuilder).GetMethod(
                        nameof(IConventionNavigationBuilder.UsePropertyAccessMode),
                        new[] { typeof(PropertyAccessMode), typeof(bool) }
                    ),
                    typeof(IConventionSkipNavigationBuilder).GetMethod(
                        nameof(IConventionSkipNavigationBuilder.HasField),
                        new[] { typeof(string), typeof(bool) }
                    ),
                    typeof(IConventionSkipNavigationBuilder).GetMethod(
                        nameof(IConventionSkipNavigationBuilder.HasField),
                    ...
                    typeof(IConventionSkipNavigationBuilder).GetMethod(
                        nameof(IConventionSkipNavigationBuilder.UsePropertyAccessMode),
                        new[] { typeof(PropertyAccessMode), typeof(bool) }
                    ),
                };
            ...
            public override HashSet<MethodInfo> MetadataMethodExceptions { get; } =
                new()
                {
                    ...
                    typeof(IConventionAnnotatable).GetMethod(
                        nameof(IConventionAnnotatable.AddAnnotations)
                    ),
                    typeof(IMutableAnnotatable).GetMethod(
                        nameof(IMutableAnnotatable.AddAnnotations)
                    ),
