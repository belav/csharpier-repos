        ...
        : ApiConsistencyTestBase<ApiConsistencyTest.ApiConsistencyFixture>
    {
        ...
        public class ApiConsistencyFixture : ApiConsistencyFixtureBase
        {
            ...
            public override HashSet<MethodInfo> NonVirtualMethods { get; } =
                new()
                {
                    typeof(CompiledQueryCacheKeyGenerator)
                        .GetMethod("GenerateCacheKeyCore", AnyInstance),
                    typeof(InternalEntityEntry).GetMethod("get_Item"),
                    typeof(InternalEntityEntry).GetMethod("set_Item"),
                    typeof(InternalEntityEntry)
                        .GetMethod(nameof(InternalEntityEntry.HasDefaultValue)),
            ...
            public override HashSet<MethodInfo> NotAnnotatedMethods { get; } =
                new()
                {
                    ...
                    typeof(IEntityTypeConfiguration<>)
                        .GetMethod(nameof(IEntityTypeConfiguration<Type>.Configure))
                };
            ...
            public override HashSet<MethodInfo> UnmatchedMetadataMethods { get; } =
                new()
                {
                    ...
                    typeof(IReadOnlyAnnotatable)
                        .GetMethod(nameof(IReadOnlyAnnotatable.FindAnnotation)),
                    typeof(IReadOnlyAnnotatable)
                        .GetMethod(nameof(IReadOnlyAnnotatable.GetAnnotations)),
                    typeof(IReadOnlyAnnotatable)
                        .GetMethod(nameof(IReadOnlyAnnotatable.GetAnnotation)),
                    typeof(IMutableAnnotatable).GetMethod("set_Item"),
                    typeof(IConventionAnnotatable)
                        .GetMethod(nameof(IConventionAnnotatable.SetAnnotation)),
                    typeof(IConventionAnnotatable)
                        .GetMethod(nameof(IConventionAnnotatable.SetOrRemoveAnnotation)),
                    typeof(IConventionModelBuilder)
                        .GetMethod(nameof(IConventionModelBuilder.HasNoEntityType)),
                    typeof(IReadOnlyEntityType)
                        .GetMethod(nameof(IReadOnlyEntityType.GetConcreteDerivedTypesInclusive)),
                    typeof(IReadOnlyEntityType)
                        .GetMethod(nameof(IReadOnlyEntityType.FindClosestCommonParent)),
                    typeof(IReadOnlyEntityType)
                        .GetMethod(nameof(IReadOnlyEntityType.LeastDerivedType)),
                    ...
                    typeof(IConventionAnnotatableBuilder)
                        .GetMethod(nameof(IConventionAnnotatableBuilder.HasNonNullAnnotation)),
                    typeof(IConventionEntityTypeBuilder)
                        .GetMethod(
                            nameof(IConventionEntityTypeBuilder.RemoveUnusedImplicitProperties)
                        ),
                    typeof(IConventionEntityTypeBuilder)
                        .GetMethod(nameof(IConventionEntityTypeBuilder.Ignore)),
                    typeof(IConventionModelBuilder)
                        .GetMethod(
            ...
            public override HashSet<MethodInfo> MetadataMethodExceptions { get; } =
                new()
                {
                    ...
                    typeof(IConventionAnnotatable)
                        .GetMethod(nameof(IConventionAnnotatable.SetOrRemoveAnnotation)),
                    typeof(IConventionAnnotatable)
                        .GetMethod(nameof(IConventionAnnotatable.AddAnnotations)),
                    typeof(IMutableAnnotatable)
                        .GetMethod(nameof(IMutableAnnotatable.AddAnnotations)),
                    ...
                    typeof(IConventionEntityType)
                        .GetMethod(nameof(IConventionEntityType.LeastDerivedType))
                };
        }
    }
}
