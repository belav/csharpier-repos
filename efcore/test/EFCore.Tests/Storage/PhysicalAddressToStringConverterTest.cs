...
namespace Microsoft.EntityFrameworkCore.Storage
{
    public class PhysicalAddressToStringConverterTest
    {
        ...
        [ConditionalTheory]
        [InlineData(
            new byte[] { 74, 74, 45, 72, 72, 45, 89, 89, 45, 68, 54, 45, 57, 50, 45, 55, 51 }
        )]
        [InlineData(
            new byte[] { 72, 72, 45, 77, 77, 45, 53, 53, 45, 68, 54, 45, 57, 50, 45, 55, 51 }
        )]
        [InlineData(
            new byte[] { 86, 86, 45, 56, 48, 45, 66, 55, 45, 51, 56, 45, 52, 65, 45, 54, 56 }
        )]
        [InlineData(
