...
namespace Microsoft.EntityFrameworkCore.Metadata.Conventions
{
    public class ConventionDispatcherTest
    {
        ...
        public void OnEntityTypeAdded_calls_conventions_in_order(bool useBuilder, bool useScope)
        {
            ...
            else
            {
                var result = builder.Metadata
                    .AddEntityType(typeof(Order), ConfigurationSource.Convention);
                ...
                builder.Metadata
                    .SetBaseType(
                        builder.Metadata.Model
                            .AddEntityType(typeof(Order), ConfigurationSource.Explicit),
                        ConfigurationSource.Convention
                    );
            }
        ...
        )
        {
            ...
            entityBuilder.Metadata[CoreAnnotationNames.PropertyAccessMode] =
        ...
        private class ForeignKeyPrincipalEndChangedConvention
        ...
        )
        {
            ...
            var builder = new InternalModelBuilder(new Model(conventions));
            var principalEntityBuilder = builder.Entity(
                typeof(Order),
                ConfigurationSource.Convention
            );
            var dependentEntityBuilder = builder.Entity(
        ...
        private class ForeignKeyRequirednessChangedConvention
        ...
        )
        {
            ...
            var convention3 = new ForeignKeyDependentRequirednessChangedConvention(
                terminate: false
            );
        ...
        public void OnSkipNavigationAdded_calls_conventions_in_order(bool useBuilder, bool useScope)
        {
            ...
            var secondEntityBuilder = builder.Entity(
                typeof(Product),
                ConfigurationSource.Convention
            );
        ...
        private class SkipNavigationAddedConvention : ISkipNavigationAddedConvention
        {
            ...
            )
            {
                ...
                if (_terminate)
                {
                    skipNavigationBuilder.Metadata.DeclaringEntityType
        ...
        )
        {
            ...
            var foreignKey =
                joinEntityBuilder.HasRelationship(
                    typeof(Order),
        ...
        private class SkipNavigationInverseChangedConvention
        ...
        private class KeyAddedConvention : IKeyAddedConvention
        {
            ...
            )
            {
                ...
                if (_terminate)
                {
                    keyBuilder.Metadata.DeclaringEntityType
        ...
        )
        {
            ...
            {
                Assert.NotNull(
                    key.Builder.HasAnnotation("foo", "bar", ConfigurationSource.Convention)
                );
            }
            else
            {
            ...
            {
                Assert.NotNull(
                    key.Builder.HasAnnotation("foo", null, ConfigurationSource.Convention)
                );
            }
            else
            {
        ...
        )
        {
            ...
            {
                Assert.NotNull(
                    indexBuilder.HasAnnotation("foo", null, ConfigurationSource.Convention)
                );
            }
            else
            {
        ...
        )
        {
            ...
            {
                Assert.NotNull(
                    propertyBuilder.HasField((string)null, ConfigurationSource.Convention)
                );
            }
            else
            {
        ...
        )
        {
            ...
            var builder = new InternalModelBuilder(new Model(conventions));
            var propertyBuilder = builder.Entity(
                typeof(SpecialOrder),
                ConfigurationSource.Convention
            )
        ...
        private class Order
        {
            public static readonly PropertyInfo OrderIdProperty = typeof(Order)
                .GetProperty(nameof(OrderId));
            public static readonly PropertyInfo OrderDetailsProperty = typeof(Order)
                .GetProperty(nameof(OrderDetails));
        ...
        {
            public static readonly PropertyInfo OrderProperty = typeof(OrderDetails)
                .GetProperty(nameof(Order));
