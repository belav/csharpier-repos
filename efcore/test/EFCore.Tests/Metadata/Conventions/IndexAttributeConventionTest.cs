...
public class IndexAttributeConventionTest
{
    ...
    public void IndexAttribute_overrides_configuration_from_convention()
    {
        ...
        Assert.Equal(
            ...
            index.GetIsDescendingConfigurationSource()
        );
        Assert.Collection(
            index.Properties,
    ...
    public void IndexAttribute_with_no_property_names_throws()
    {
        ...
        Assert.Equal(
            ...
            Assert
                .Throws<ArgumentException>(() => modelBuilder.Entity<EntityWithInvalidEmptyIndex>())
                .Message
        );
    }
    ...
    public void IndexAttribute_properties_cannot_include_whitespace(Type entityTypeWithInvalidIndex)
    {
        ...
        Assert.Equal(
            ...
            Assert
                .Throws<ArgumentException>(() => modelBuilder.Entity(entityTypeWithInvalidIndex))
                .Message
        );
    }
