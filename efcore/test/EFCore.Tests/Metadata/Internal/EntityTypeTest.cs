    ...
    public partial class EntityTypeTest
    {
        ...
        public void Throws_when_model_is_readonly()
        {
            ...
            Assert.Equal(
                ...
                Assert
                    .Throws<InvalidOperationException>(() => model.AddEntityType(typeof(B)))
                    .Message
            );
            ...
            Assert.Equal(
                CoreStrings.ModelReadOnly,
                Assert
                    .Throws<InvalidOperationException>(() => entityTypeA.RemoveIgnored(""))
                    .Message
            );
        ...
        public void Adding_a_key_throws_if_properties_from_different_type()
        {
            ...
            Assert.Equal(
                ...
                Assert
                    .Throws<InvalidOperationException>(() => entityType1.AddKey(idProperty))
                    .Message
            );
        }
        ...
        public void Removing_a_key_from_wrong_type_throws()
        {
            ...
            Assert.Equal(
                ...
                Assert
                    .Throws<InvalidOperationException>(() => orderType.RemoveKey(customerKey))
                    .Message
            );
        ...
        public void AddProperty_throws_if_no_clr_property_or_field()
        {
            ...
            Assert.Equal(
                ...
                Assert
                    .Throws<InvalidOperationException>(() => entityType.AddProperty("_foo"))
                    .Message
            );
        }
        ...
        public void Setting_base_type_for_owned_throws()
        {
            ...
            Assert.Equal(
                ...
                Assert
                    .Throws<InvalidOperationException>(() => entityType.BaseType = baseType)
                    .Message
            );
        }
