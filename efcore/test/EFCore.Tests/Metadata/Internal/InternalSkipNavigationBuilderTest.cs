...
namespace Microsoft.EntityFrameworkCore.Metadata.Internal
{
    public class InternalSkipNavigationBuilderTest
    {
        ...
        public void Can_only_override_lower_or_equal_source_HasField()
        {
            ...
            Assert.True(
                builder.CanSetField(Order.ProductsField, ConfigurationSource.DataAnnotation)
            );
            Assert.NotNull(
                builder.HasField(Order.ProductsField, ConfigurationSource.DataAnnotation)
            );
            ...
            Assert.False(
                builder.CanSetField(Order.OtherProductsField, ConfigurationSource.Convention)
            );
        ...
        public void Can_only_override_lower_or_equal_source_Inverse()
        {
            ...
            Assert.Equal(
                ConfigurationSource.DataAnnotation,
                metadata.GetInverseConfigurationSource()
            );
            Assert.Equal(metadata, inverse.Inverse);
            Assert.Equal(
                ConfigurationSource.DataAnnotation,
                inverse.GetInverseConfigurationSource()
            );
        ...
        public void Can_only_override_lower_or_equal_source_IsEagerLoaded()
        {
            ...
            Assert.NotNull(
                builder.AutoInclude(autoInclude: true, ConfigurationSource.DataAnnotation)
            );
            ...
            Assert.True(
                builder.CanSetAutoInclude(autoInclude: true, ConfigurationSource.Convention)
            );
            Assert.False(
                builder.CanSetAutoInclude(autoInclude: false, ConfigurationSource.Convention)
            );
            ...
            Assert.NotNull(
                builder.AutoInclude(autoInclude: false, ConfigurationSource.DataAnnotation)
            );
