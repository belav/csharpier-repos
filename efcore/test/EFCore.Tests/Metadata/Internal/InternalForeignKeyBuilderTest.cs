    ...
    public class InternalForeignKeyBuilderTest
    {
        ...
        public void Facets_are_configured_with_the_specified_source()
        {
            ...
            var key = principalEntityBuilder.PrimaryKey(
                new[] { Customer.IdProperty, Customer.UniqueProperty },
            ...
            relationshipBuilder = relationshipBuilder
                .PrincipalEntityType(principalEntityBuilder.Metadata, ConfigurationSource.Explicit)
                ...
                .HasForeignKey(
                    new[]
                    {
                        dependentEntityBuilder
                            .Property(Order.CustomerIdProperty, ConfigurationSource.Convention)
                            .Metadata,
                        dependentEntityBuilder
            ...
            Assert.Null(
                relationshipBuilder.HasForeignKey(
                    new[] { Order.IdProperty, Order.CustomerUniqueProperty },
                    ConfigurationSource.DataAnnotation
                )
            );
            var shadowId = principalEntityBuilder
                .Property(typeof(int), "ShadowId", ConfigurationSource.Convention)
                .Metadata;
            Assert.Null(
                relationshipBuilder.HasPrincipalKey(
                    new[] { shadowId.Name, Customer.UniqueProperty.Name },
                    ConfigurationSource.DataAnnotation
                )
            );
            ...
            Assert.Null(
                relationshipBuilder.IsRequiredDependent(true, ConfigurationSource.DataAnnotation)
            );
        ...
        public void Existing_facets_are_configured_explicitly()
        {
            ...
            var foreignKey = dependentEntityBuilder
                .HasRelationship(principalEntityBuilder.Metadata, ConfigurationSource.Explicit)
                .Metadata;
            ...
            foreignKey.SetDependentToPrincipal(
                Order.CustomerProperty,
                ConfigurationSource.Explicit
            );
            foreignKey.SetPrincipalToDependent(
            ...
            Assert.Equal(
                ConfigurationSource.Explicit,
                foreignKey.GetPropertiesConfigurationSource()
            );
            Assert.Equal(
                ConfigurationSource.Explicit,
                foreignKey.GetPrincipalKeyConfigurationSource()
            );
            Assert.Equal(
                ConfigurationSource.Explicit,
                foreignKey.GetPrincipalEndConfigurationSource()
            );
            Assert.Equal(
                ConfigurationSource.Explicit,
            ...
            Assert.Equal(
                ConfigurationSource.Explicit,
                foreignKey.GetIsRequiredConfigurationSource()
            );
            Assert.Equal(
                ConfigurationSource.Explicit,
                foreignKey.GetIsRequiredDependentConfigurationSource()
            );
            Assert.Equal(
                ConfigurationSource.Explicit,
                foreignKey.GetIsOwnershipConfigurationSource()
            );
            Assert.Equal(
                ConfigurationSource.Explicit,
        ...
        {
            var modelBuilder = CreateInternalModelBuilder();
            var customerEntityBuilder = modelBuilder.Entity(
                typeof(Customer),
                ConfigurationSource.Explicit
            );
        ...
        public void ForeignKey_returns_same_instance_for_same_properties()
        {
            ...
            Assert.Same(
                ...
                orderEntityBuilder
                    .HasRelationship(customerEntityBuilder.Metadata, ConfigurationSource.Convention)
                    .HasForeignKey(
                        new[] { Order.CustomerIdProperty, Order.CustomerUniqueProperty },
                        ConfigurationSource.DataAnnotation
                    )
                    .HasPrincipalKey(
        ...
        public void ForeignKey_can_be_set_independently_from_requiredness()
        {
            ...
            var nullableId = orderEntityBuilder.Property(
                typeof(int?),
                "NullableId",
                ConfigurationSource.Explicit
            );
        ...
        public void ForeignKey_overrides_incompatible_lower_or_equal_source_principal_key()
        {
            ...
            Assert.Null(
                relationshipBuilder.HasForeignKey(
                    new[] { Order.CustomerUniqueProperty },
                    ConfigurationSource.Convention
                )
            );
            Assert.Equal(
        ...
        public void PrincipalKey_does_not_return_same_instance_for_same_properties()
        {
            ...
            var relationshipBuilder = customerEntityBuilder
                .HasRelationship(orderEntityBuilder.Metadata, ConfigurationSource.DataAnnotation)
                .HasPrincipalKey(
                    new[] { Order.CustomerIdProperty.Name, Order.CustomerUniqueProperty.Name },
                    ConfigurationSource.DataAnnotation
                );
        ...
        public void Can_only_override_existing_Unique_value_explicitly()
        {
            ...
            relationshipBuilder = relationshipBuilder.HasPrincipalKey(
                customerKeyBuilder.Metadata.Properties,
                ConfigurationSource.Convention
            );
            Assert.Same(foreignKey, relationshipBuilder.Metadata);
        ...
        public void Can_set_Required_independently_from_nullability()
        {
            ...
            var customerIdProperty = orderEntityBuilder
                .Property(Order.CustomerIdProperty, ConfigurationSource.Convention)
                .Metadata;
        ...
        public void Can_only_override_lower_or_equal_source_RequiredDependent()
        {
            ...
            relationshipBuilder = relationshipBuilder.IsRequiredDependent(
                true,
                ConfigurationSource.Convention
            );
            ...
            Assert.Null(
                relationshipBuilder.IsRequiredDependent(true, ConfigurationSource.Convention)
            );
            Assert.False(relationshipBuilder.Metadata.IsRequiredDependent);
        }
        ...
        public void Can_only_override_lower_or_equal_source_Ownership()
        {
            ...
            relationshipBuilder = relationshipBuilder.IsOwnership(
                true,
                ConfigurationSource.Convention
            );
        ...
        public void Inverting_to_keyless_throws()
        {
            ...
            var orderEntityBuilder = modelBuilder
                .Entity(typeof(Order), ConfigurationSource.Explicit)
        ...
        {
            var modelBuilder = CreateInternalModelBuilder();
            var specialOrderEntityBuilder = modelBuilder.Entity(
                typeof(SpecialOrder),
                ConfigurationSource.Explicit
            );
            var orderEntityBuilder = modelBuilder.Entity(
            ...
            specialOrderEntityBuilder.HasBaseType(
                orderEntityBuilder.Metadata,
                ConfigurationSource.Explicit
            );
            ...
            Assert.Same(
                specialOrderEntityBuilder.Metadata,
                relationshipBuilder.Metadata.DeclaringEntityType
            );
            Assert.Same(
                orderEntityBuilder.Metadata,
            ...
            Assert.Equal(
                nameof(SpecialOrder.SpecialOrder),
                relationshipBuilder.Metadata.PrincipalToDependent.Name
            );
        }
        ...
        public void Can_add_navigations_to_higher_source_foreign_key()
        {
            ...
            Assert.Same(
                ...
                dependentEntityBuilder.Metadata
                    .FindNavigation(Order.CustomerProperty.Name)
                    .ForeignKey
            );
            Assert.Same(
                relationship.Metadata,
                principalEntityBuilder.Metadata
                    .FindNavigation(Customer.OrdersProperty.Name)
                    .ForeignKey
            );
        }
        ...
        public void Can_only_override_existing_conflicting_navigations_explicitly()
        {
            ...
            var existingForeignKey = dependentEntityBuilder.Metadata.AddForeignKey(
                ...
                {
                    dependentEntityBuilder
                        .Property(Order.CustomerIdProperty, ConfigurationSource.Explicit)
                        .Metadata,
                    dependentEntityBuilder
            ...
            existingForeignKey.SetPrincipalToDependent(
                Customer.OrdersProperty,
                ConfigurationSource.Explicit
            );
            existingForeignKey.SetDependentToPrincipal(
                Order.CustomerProperty,
                ConfigurationSource.Explicit
            );
            Assert.Equal(
                ConfigurationSource.Explicit,
                existingForeignKey.GetDependentToPrincipalConfigurationSource()
            );
            Assert.Equal(
                ConfigurationSource.Explicit,
                existingForeignKey.GetPrincipalToDependentConfigurationSource()
            );

            var newForeignKeyBuilder = dependentEntityBuilder.HasRelationship(
                typeof(Customer).FullName,
                new[] { Order.IdProperty.Name, Order.CustomerUniqueProperty.Name },
                ConfigurationSource.Convention
            );
            ...
            Assert.Equal(
                Customer.OrdersProperty.Name,
                newForeignKeyBuilder.Metadata.PrincipalToDependent.Name
            );
            Assert.Equal(
                Order.CustomerProperty.Name,
                newForeignKeyBuilder.Metadata.DependentToPrincipal.Name
            );
        }
        ...
        public void Can_override_lower_or_equal_source_conflicting_navigation()
        {
            ...
            Assert.Equal(
                ...
                newForeignKeyBuilder.Metadata.Properties.Single().Name
            );
            Assert.Same(
                newForeignKeyBuilder.Metadata,
                dependentEntityBuilder.Metadata
                    .FindNavigation(Order.CustomerProperty.Name)
                    .ForeignKey
            );
            ...
            Assert.Same(
                newForeignKeyBuilder.Metadata,
                dependentEntityBuilder.Metadata.GetForeignKeys().Single()
            );
        }
        ...
        public void Navigation_to_principal_uses_same_relationship_if_conflicting_navigation_configured_with_lower_source()
        {
            ...
            var relationshipBuilder = customerEntityBuilder
                .HasRelationship(orderEntityBuilder.Metadata, ConfigurationSource.Explicit)
                .HasNavigation(
                    nameof(Order.Customer),
                    pointsToPrincipal: false,
                    ConfigurationSource.Convention
        ...
        public void Navigation_to_dependent_changes_uniqueness_for_relationship_of_lower_or_equal_source()
        {
            ...
            Assert.Equal(
                nameof(Customer.NotCollectionOrders),
                foreignKeyBuilder.Metadata.PrincipalToDependent.Name
            );
        ...
        public void Navigation_to_dependent_does_not_change_uniqueness_for_relationship_of_higher_source()
        {
            ...
            foreignKeyBuilder = foreignKeyBuilder.IsUnique(
                false,
                ConfigurationSource.DataAnnotation
            );
            Assert.False(foreignKeyBuilder.Metadata.IsUnique);
        ...
        private class Customer
        {
            ...
            public static readonly PropertyInfo UniqueProperty = typeof(Customer).GetProperty(
                "Unique"
            );
