...
namespace Microsoft.EntityFrameworkCore.Metadata.Internal
{
    public class InternalNavigationBuilderTest
    {
        ...
        public void Can_only_override_lower_or_equal_source_HasField()
        {
            ...
            Assert.True(
                builder.CanSetField(Order.DetailsField, ConfigurationSource.DataAnnotation)
            );
            Assert.NotNull(
                builder.HasField(Order.DetailsField, ConfigurationSource.DataAnnotation)
            );
            ...
            Assert.False(
                builder.CanSetField(Order.OtherDetailsField, ConfigurationSource.Convention)
            );
            ...
            Assert.True(
                builder.CanSetField(Order.OtherDetailsField, ConfigurationSource.DataAnnotation)
            );
            Assert.NotNull(
                builder.HasField(Order.OtherDetailsField, ConfigurationSource.DataAnnotation)
            );
        ...
        private InternalNavigationBuilder CreateInternalNavigationBuilder()
        {
            ...
            var detailsEntityBuilder = modelBuilder.Entity(
                typeof(OrderDetails),
                ConfigurationSource.Convention
            );
            orderEntityBuilder
