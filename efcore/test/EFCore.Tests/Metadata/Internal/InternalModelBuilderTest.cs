...
namespace Microsoft.EntityFrameworkCore.Metadata.Internal
{
    public class InternalModelBuilderTest
    {
        ...
        public void Can_mark_type_as_owned_type()
        {
            ...
            var ownedEntityTypeBuilder = modelBuilder.Entity(
                typeof(Details),
                ConfigurationSource.Convention
            );
            ...
            Assert.NotNull(
                modelBuilder.Ignore(typeof(Details), ConfigurationSource.DataAnnotation)
            );
        ...
        private class Order
        {
            ...
            public static readonly PropertyInfo ProductIdProperty = typeof(Order).GetProperty(
                "ProductId"
            );
