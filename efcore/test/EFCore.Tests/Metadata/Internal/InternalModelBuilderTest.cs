...
public class InternalModelBuilderTest
{
    ...
    public void Entity_returns_same_instance_for_entity_clr_type()
    {
        ...
        Assert.Same(
            entityBuilder,
            modelBuilder.Entity(typeof(Customer).DisplayName(), ConfigurationSource.DataAnnotation)
        );
    ...
    public void Can_ignore_existing_entity_type_using_entity_type_name()
    {
        ...
        Assert.Same(
            entityType,
            modelBuilder.Entity(typeof(Customer).FullName, ConfigurationSource.Convention).Metadata
        );
        Assert.Null(
            modelBuilder.Ignore(typeof(Customer).FullName, ConfigurationSource.DataAnnotation)
        );
    ...
    public void Ignoring_an_entity_type_does_not_remove_referenced_lower_source_entity_types()
    {
        ...
        Assert.Equal(
            typeof(Product),
            orderEntityTypeBuilder.Metadata.GetForeignKeys().Single().PrincipalEntityType.ClrType
        );
    }
