...
namespace Microsoft.EntityFrameworkCore.Metadata.Internal
{
    public class InternalModelBuilderTest
    {
        ...
        public void Can_ignore_lower_or_equal_source_entity_type_using_entity_type_name()
        {
            ...
            Assert.NotNull(
                modelBuilder.Ignore(typeof(Customer).FullName, ConfigurationSource.Explicit)
            );
            Assert.Null(
                modelBuilder.Entity(typeof(Customer).FullName, ConfigurationSource.DataAnnotation)
            );
            ...
            Assert.NotNull(
                modelBuilder.Entity(typeof(Customer).FullName, ConfigurationSource.Explicit)
            );
        ...
        public void Cannot_ignore_higher_source_entity_type_using_entity_type_name()
        {
            ...
            Assert.NotNull(
                modelBuilder.Ignore(typeof(Customer).FullName, ConfigurationSource.Convention)
            );
            Assert.Null(
                modelBuilder.Entity(typeof(Customer).FullName, ConfigurationSource.Convention)
            );
            Assert.NotNull(
                modelBuilder.Entity(typeof(Customer).FullName, ConfigurationSource.DataAnnotation)
            );
        ...
        public void Can_ignore_entity_type_referenced_from_lower_or_equal_source_foreign_key()
        {
            ...
            var orderEntityTypeBuilder = modelBuilder.Entity(
                typeof(Order),
                ConfigurationSource.Explicit
            );
        ...
        {
            var modelBuilder = CreateModelBuilder();
            var customerEntityTypeBuilder = modelBuilder.Entity(
                typeof(Customer),
                ConfigurationSource.Explicit
            )
                .PrimaryKey(new[] { Customer.IdProperty }, ConfigurationSource.Convention);
        ...
        {
            var modelBuilder = CreateModelBuilder();
            var baseEntityTypeBuilder = modelBuilder.Entity(
                typeof(Base),
                ConfigurationSource.Explicit
            );
            var customerEntityTypeBuilder = modelBuilder.Entity(
            ...
            var specialCustomerEntityTypeBuilder = modelBuilder.Entity(
                typeof(SpecialCustomer),
                ConfigurationSource.Explicit
            );

            Assert.NotNull(
                customerEntityTypeBuilder.HasBaseType(
                    baseEntityTypeBuilder.Metadata,
                    ConfigurationSource.Convention
                )
            );
            Assert.NotNull(
                specialCustomerEntityTypeBuilder.HasBaseType(
                    customerEntityTypeBuilder.Metadata,
                    ConfigurationSource.Convention
                )
            );
            ...
            Assert.Same(
                baseEntityTypeBuilder.Metadata,
                specialCustomerEntityTypeBuilder.Metadata.BaseType
            );
        }
        ...
        public void Ignoring_an_entity_type_removes_lower_source_orphaned_entity_types()
        {
            ...
            modelBuilder.Entity(typeof(Customer), ConfigurationSource.Convention)
                .PrimaryKey(new[] { Customer.IdProperty }, ConfigurationSource.Convention);
            modelBuilder.Entity(typeof(Product), ConfigurationSource.Convention)
        ...
        public void Ignoring_an_entity_type_does_not_remove_referenced_lower_source_entity_types()
        {
            ...
            orderEntityTypeBuilder.HasRelationship(
                ...
                .HasNavigation("Product", pointsToPrincipal: true, ConfigurationSource.Convention);
            ...
            Cleanup(modelBuilder);
            Assert.Equal(
                new[] { typeof(Order), typeof(Product) },
                modelBuilder.Metadata.GetEntityTypes().Select(et => et.ClrType)
            );
            Assert.Equal(
                typeof(Product),
        ...
        public void Ignoring_an_entity_type_does_not_remove_referencing_lower_source_entity_types()
        {
            ...
            orderEntityTypeBuilder.HasRelationship(
                ...
                .HasNavigation("Order", pointsToPrincipal: false, ConfigurationSource.Convention);
        ...
        public void Can_remove_implicitly_created_join_entity_type()
        {
            ...
            var manyToManyLeft = modelBuilder.Entity(
                typeof(ManyToManyLeft),
                ConfigurationSource.Convention
            );
            var manyToManyRight = modelBuilder.Entity(
                typeof(ManyToManyRight),
                ConfigurationSource.Convention
            );
            var manyToManyLeftPK = manyToManyLeft.PrimaryKey(
                new[] { nameof(ManyToManyLeft.Id) },
                ConfigurationSource.Convention
            );
            var manyToManyRightPK = manyToManyRight.PrimaryKey(
                new[] { nameof(ManyToManyRight.Id) },
                ConfigurationSource.Convention
            );

            var skipNavOnLeft = manyToManyLeft.HasSkipNavigation(
                new MemberIdentity(
                    typeof(ManyToManyLeft).GetProperty(nameof(ManyToManyLeft.Rights))
                ),
            ...
            var skipNavOnRight = manyToManyRight.HasSkipNavigation(
                new MemberIdentity(
                    typeof(ManyToManyRight).GetProperty(nameof(ManyToManyRight.Lefts))
                ),
            ...
            var leftSkipNav = manyToManyLeft.Metadata
                .FindDeclaredSkipNavigation(nameof(ManyToManyLeft.Rights));
            var rightSkipNav = manyToManyRight.Metadata
        ...
        public void Cannot_remove_manually_created_join_entity_type()
        {
            ...
            manyToManyJoin.PrimaryKey(
                new[] { nameof(ManyToManyJoin.LeftId), nameof(ManyToManyJoin.RightId) },
                ConfigurationSource.Convention
            );
        ...
        public void Can_add_shared_type()
        {
            ...
            Assert.NotNull(
                modelBuilder.Entity(typeof(Product), ConfigurationSource.DataAnnotation)
            );

            Assert.Null(
                modelBuilder.SharedTypeEntity(
                    typeof(Product).DisplayName(),
                    typeof(Product),
                    ConfigurationSource.DataAnnotation
                )
            );
        ...
        private class Order
        {
            ...
            public static readonly PropertyInfo ProductIdProperty = typeof(Order)
