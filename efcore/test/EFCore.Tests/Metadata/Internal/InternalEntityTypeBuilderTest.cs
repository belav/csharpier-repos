...
namespace Microsoft.EntityFrameworkCore.Metadata.Internal
{
    public class InternalEntityTypeBuilderTest
    {
        ...
        )
        {
            ...
            Assert.Empty(
                dependentEntityBuilder.Metadata
                    ...
                    .Where(
                        foreignKey =>
                            foreignKey.Properties.SequenceEqual(
                                relationshipBuilder.Metadata.Properties
                            )
                    )
            );
        ...
        public void Can_only_remove_lower_or_equal_source_key()
        {
            ...
            Assert.NotNull(
                entityBuilder.HasNoKey(key.Metadata, ConfigurationSource.DataAnnotation)
            );
        ...
        )
        {
            ...
            Assert.Empty(
                entityBuilder.Metadata
                    .GetKeys()
                    .Where(
                        foreignKey => foreignKey.Properties.SequenceEqual(key.Metadata.Properties)
                    )
            );
        }
        ...
        public void Can_promote_property_to_base()
        {
            ...
            derivedEntityBuilder2.HasBaseType(
                entityBuilder.Metadata,
                ConfigurationSource.Convention
            );
        ...
        )
        {
            ...
            productTypeBuilder.PrimaryKey(
                new[] { Product.IdProperty },
                ConfigurationSource.Convention
            );
        ...
        public void Can_ignore_service_property()
        {
            ...
            Assert.NotNull(
                entityBuilder.Ignore(nameof(Order.Context), ConfigurationSource.Explicit)
            );
        ...
        )
        {
            ...
            var firstEntityTypeBuilder = modelBuilder.Entity(
                firstType,
                ConfigurationSource.Convention
            );
        ...
        public void Conflicting_navigations_are_not_removed_if_conflicting_fk_cannot_be_removed()
        {
            ...
            Assert.Same(
                ...
                orderEntityBuilder.Metadata
                    .GetForeignKeys()
                    .Single(
                        fk => fk.DependentToPrincipal == null && fk.PrincipalToDependent == null
                    )
            );
            ...
            Assert.Same(
                navigationFk,
                orderEntityBuilder.Metadata.GetNavigations().Single().ForeignKey
            );
        ...
        public void Can_only_override_lower_or_equal_source_base_type()
        {
            ...
            Assert.Null(
                derivedEntityBuilder.HasBaseType((string)null, ConfigurationSource.Convention)
            );
        ...
        public void Setting_base_type_removes_duplicate_derived_service_properties()
        {
            ...
            derivedEntityBuilder.ServiceProperty(
                Order.ContextProperty,
                ConfigurationSource.Convention
            );
        ...
        public void Changing_discriminator_type_removes_values()
        {
            ...
            Assert.Null(typeBuilder.Metadata.GetDiscriminatorValue());
            Assert.Null(typeBuilder.ModelBuilder.Entity("Splow").Metadata.GetDiscriminatorValue());
            Assert.Null(typeBuilder.ModelBuilder.Entity("Splod").Metadata.GetDiscriminatorValue());
        ...
        {
            public static readonly PropertyInfo SpecialtyProperty =
                typeof(SpecialOrder).GetProperty("Specialty");
        ...
        private class Customer
        {
            ...
            public static readonly PropertyInfo SpecialOrdersProperty =
                typeof(Customer).GetProperty(nameof(SpecialOrders));
