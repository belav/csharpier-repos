...
public class InternalEntityTypeBuilderTest
{
    ...
    public void Can_add_relationship_on_property_bag()
    {
        ...
        var relationshipBuilder = dependentEntityBuilder
            .HasRelationship(principalEntityBuilder.Metadata, ConfigurationSource.Explicit)
            .HasNavigation("Count", pointsToPrincipal: true, ConfigurationSource.Explicit)
            .HasNavigation("Values", pointsToPrincipal: false, ConfigurationSource.Explicit);

        var fk = relationshipBuilder.Metadata;
        Assert.Same(
            dependentEntityBuilder.Metadata.FindIndexerPropertyInfo(),
            fk.DependentToPrincipal.PropertyInfo
        );
        Assert.Same(
            principalEntityBuilder.Metadata.FindIndexerPropertyInfo(),
            fk.PrincipalToDependent.PropertyInfo
        );
        ...
        Assert.Same(
            dependentEntityBuilder.Metadata.FindIndexerPropertyInfo(),
            skipNavigationBuilder.Metadata.PropertyInfo
        );
    }
    ...
    public void ForeignKey_does_not_create_shadow_properties_if_corresponding_principal_key_properties_has_different_count()
    {
        ...
        customerEntityBuilder.Property(
            typeof(int),
            "ShadowPrimaryKey",
            ConfigurationSource.Explicit
        );
        customerEntityBuilder.PrimaryKey(
            new List<string> { "ShadowPrimaryKey" },
            ConfigurationSource.Explicit
        );
        var orderEntityBuilder = modelBuilder.Entity(typeof(Order), ConfigurationSource.Explicit);
    ...
    public void ForeignKey_promotes_derived_foreign_key_of_lower_or_equal_source()
    {
        ...
        var primaryKey = principalEntityBuilder
            .PrimaryKey(new[] { nameof(Customer.Id) }, ConfigurationSource.Convention)
            .Metadata;
        ...
        Assert.Equal(
            ConfigurationSource.DataAnnotation,
            foreignKeyBuilder.Metadata.GetConfigurationSource()
        );
    ...
    public void ForeignKey_returns_inherited_foreign_key_of_lower_or_equal_source()
    {
        ...
        var principalKey = principalEntityBuilder
            .HasKey(new[] { Customer.IdProperty }, ConfigurationSource.Explicit)
            .Metadata;
        var dependentEntityBuilder = modelBuilder.Entity(
            typeof(Order),
            ConfigurationSource.Explicit
        ...
        var derivedDependentEntityBuilder = modelBuilder.Entity(
            typeof(SpecialOrder),
            ConfigurationSource.Convention
        );
        ...
        Assert.Same(
            derivedDependentEntityBuilder.Metadata.GetForeignKeys().Single(),
    ...
    public void ForeignKey_matches_existing_foreign_key_if_same_or_no_principal_key_specified_or_lower_source()
    {
        ...
        var primaryKey = principalEntityBuilder
            ...
            .Metadata;
        var shadowKeyProperty = principalEntityBuilder.Property(
            typeof(int),
            "ShadowId",
            ConfigurationSource.Convention
        );
        var alternateKey = principalEntityBuilder
            .HasKey(new[] { shadowKeyProperty.Metadata.Name }, ConfigurationSource.Convention)
            .Metadata;
        var dependentEntityBuilder = modelBuilder.Entity(
            typeof(Order),
            ConfigurationSource.Explicit
        ...
        var fk1 = dependentEntityBuilder
            .HasRelationship(
                principalEntityBuilder.Metadata.Name,
                new[] { Order.IdProperty.Name },
                ConfigurationSource.DataAnnotation
            ...
            .Metadata;
        var newFk1 = dependentEntityBuilder
            .HasRelationship(
                principalEntityBuilder.Metadata.Name,
                new[] { Order.IdProperty.Name },
                alternateKey,
        ...
        var fk2 = dependentEntityBuilder
            .HasRelationship(
                principalEntityBuilder.Metadata.Name,
                new[] { Order.IdProperty.Name },
                ConfigurationSource.DataAnnotation
            ...
            .Metadata;
        var newFk2 = dependentEntityBuilder
            .HasRelationship(
                principalEntityBuilder.Metadata.Name,
                new[] { Order.IdProperty.Name },
                primaryKey,
    ...
    public void Promotes_derived_relationship()
    {
        ...
        var basePrincipalEntityBuilder = modelBuilder.Entity(
            typeof(Customer),
            ConfigurationSource.Explicit
        );
        var baseDependentEntityBuilder = modelBuilder.Entity(
            typeof(Order),
            ConfigurationSource.Explicit
        );
        ...
        dependentEntityBuilder.HasBaseType(
            baseDependentEntityBuilder.Metadata,
            ConfigurationSource.Explicit
        );
        ...
        Assert.Same(
            relationship.Metadata,
            principalEntityBuilder.Metadata.GetNavigations().Single().ForeignKey
        );
        Assert.Same(
            relationship.Metadata,
            dependentEntityBuilder.Metadata.GetNavigations().Single().ForeignKey
        );
        Assert.Empty(dependentEntityBuilder.Metadata.GetDeclaredForeignKeys());
        Assert.Empty(dependentEntityBuilder.Metadata.GetKeys());
        Assert.Same(
            relationship.Metadata.PrincipalKey,
            principalEntityBuilder.Metadata.GetKeys().Single()
        );
    }
    ...
    public void Returns_inherited_relationship_of_lower_or_equal_source()
    {
        ...
        Assert.Equal(
            Order.CustomerProperty.Name,
            relationshipBuilder.Metadata.DependentToPrincipal.Name
        );
    ...
    public void Can_create_foreign_key_on_mix_of_inherited_properties()
    {
        ...
        customerEntityTypeBuilder.PrimaryKey(
            new List<PropertyInfo> { Customer.IdProperty },
            ConfigurationSource.Explicit
        );
        ...
        derivedEntityBuilder.Property(
            SpecialOrder.SpecialtyProperty,
            ConfigurationSource.Convention
        );
        derivedEntityBuilder.HasBaseType(entityBuilder.Metadata, ConfigurationSource.Convention);

        var relationshipBuilder = derivedEntityBuilder.HasRelationship(
        ...
        Assert.Same(
            derivedEntityBuilder.Metadata.GetDeclaredForeignKeys().Single(),
            relationshipBuilder.Metadata
        );
        Assert.Collection(
    ...
    public void Can_only_remove_lower_or_equal_source_relationship()
    {
        ...
        Assert.Null(
            dependentEntityBuilder.HasNoRelationship(
                relationshipBuilder.Metadata,
                ConfigurationSource.Convention
            )
        );
    ...
    public void Removing_relationship_removes_unused_contained_shadow_properties()
    {
        ...
        var shadowProperty = dependentEntityBuilder.Property(
            typeof(Guid),
            "Shadow",
            ConfigurationSource.Convention
        );
        ...
        Assert.Same(
            Order.CustomerIdProperty.Name,
            dependentEntityBuilder.Metadata.GetProperties().Single().Name
        );
        Assert.Empty(dependentEntityBuilder.Metadata.GetForeignKeys());
    }
    ...
    public void Removing_relationship_removes_unused_conventional_index()
    {
        ...
        var derivedPrincipalEntityBuilder = modelBuilder.Entity(
            typeof(SpecialCustomer),
            ConfigurationSource.Explicit
        );
        var dependentEntityBuilder = modelBuilder.Entity(
    ...
    public void Removing_relationship_does_not_remove_conventional_index_if_in_use()
    {
        ...
        Assert.Equal(
            Order.CustomerIdProperty.Name,
            dependentEntityBuilder.Metadata.GetIndexes().First().Properties.First().Name
        );
        Assert.Empty(dependentEntityBuilder.Metadata.GetForeignKeys());
    }
    ...
    public void Removing_relationship_does_not_remove_contained_shadow_properties_if_referenced_elsewhere()
    {
        Test_removing_relationship_does_not_remove_contained_shadow_properties_if_referenced_elsewhere(
            (entityBuilder, property) =>
                entityBuilder.PrimaryKey(new[] { property.Name }, ConfigurationSource.Convention)
        );

        Test_removing_relationship_does_not_remove_contained_shadow_properties_if_referenced_elsewhere(
            (entityBuilder, property) =>
                entityBuilder.HasIndex(new[] { property.Name }, ConfigurationSource.Convention)
        );
    ...
    )
    {
        ...
        Assert.Equal(
            ...
            dependentEntityBuilder
                ...
                .Count(p => p.Name == shadowProperty.Metadata.Name)
        );
        Assert.Empty(
            dependentEntityBuilder
    ...
    public void Index_returns_same_instance_for_clr_properties()
    {
        ...
        var indexBuilder = entityBuilder.HasIndex(
            new[] { Order.IdProperty, Order.CustomerIdProperty },
            ConfigurationSource.Explicit
        );
    ...
    public void Can_promote_index_to_base()
    {
        ...
        Assert.Same(
            indexBuilder.Metadata.Properties.Single(),
            entityBuilder.Metadata.FindProperty(Order.IdProperty.Name)
        );
        Assert.Same(
            indexBuilder.Metadata,
            entityBuilder.Metadata.FindIndex(indexBuilder.Metadata.Properties.Single())
        );
    ...
    public void Can_promote_named_index_to_base()
    {
        ...
        Assert.Same(
            indexBuilder.Metadata,
            entityBuilder.Metadata.FindIndex(indexBuilder.Metadata.Name)
        );
        Assert.Empty(derivedEntityBuilder.Metadata.GetDeclaredIndexes());
    }
    ...
    public void Can_promote_index_to_base_with_facets()
    {
        ...
        derivedEntityBuilder.Property(Order.IdProperty, ConfigurationSource.Convention);
        derivedEntityBuilder
            .HasIndex(new[] { Order.IdProperty.Name }, ConfigurationSource.DataAnnotation)
    ...
    public void Can_create_index_on_inherited_property()
    {
        ...
        Assert.Same(
            derivedEntityBuilder.Metadata.GetDeclaredIndexes().Single(),
            indexBuilder.Metadata
        );
    ...
    public void Can_create_index_on_mix_of_inherited_properties()
    {
        ...
        derivedEntityBuilder.Property(
            typeof(string),
            SpecialOrder.SpecialtyProperty.Name,
            ConfigurationSource.Convention
        );
        derivedEntityBuilder.HasBaseType(entityBuilder.Metadata, ConfigurationSource.Convention);
    ...
    public void Can_only_remove_lower_or_equal_source_index()
    {
        ...
        Assert.NotNull(
            entityBuilder.HasNoIndex(index.Metadata, ConfigurationSource.DataAnnotation)
        );

        Assert.Equal(
            Order.CustomerIdProperty.Name,
            entityBuilder.Metadata.GetProperties().Single().Name
        );
        Assert.Empty(entityBuilder.Metadata.GetIndexes());
    }
    ...
    public void Removing_index_removes_unused_contained_shadow_properties()
    {
        var modelBuilder = CreateModelBuilder();
        var entityBuilder = modelBuilder.Entity(typeof(Order), ConfigurationSource.Explicit);
        var shadowProperty = entityBuilder.Property(
            typeof(Guid),
            "Shadow",
            ConfigurationSource.Convention
        );
        ...
        var index = entityBuilder.HasIndex(
            new[] { Order.CustomerIdProperty.Name, shadowProperty.Metadata.Name },
            ConfigurationSource.Convention
        );
        Assert.NotNull(index);
    ...
    public void Removing_index_does_not_remove_contained_shadow_properties_if_referenced_elsewhere()
    {
        ...
        Test_removing_index_does_not_remove_contained_shadow_properties_if_referenced_elsewhere(
            (entityBuilder, property) =>
                entityBuilder.Property(
                    property.ClrType,
                    ((IReadOnlyProperty)property).Name,
                    ConfigurationSource.Explicit
                )
        );
    }
    ...
    )
    {
        ...
        Assert.Empty(
            entityBuilder
                .Metadata.GetIndexes()
                .Where(i => i.Properties.SequenceEqual(index.Metadata.Properties))
        );
    }
    ...
    public void Key_sets_properties_to_required()
    {
        ...
        Assert.False(
            ((IReadOnlyEntityType)entityBuilder.Metadata)
                .FindProperty(Order.CustomerUniqueProperty)
                .IsNullable
        );
    ...
    public void Key_throws_for_derived_type_before_HasBase()
    {
        ...
        derivedEntityBuilder.HasKey(
            new[] { nameof(SpecialOrder.Specialty) },
            ConfigurationSource.Explicit
        );
    ...
    public void Key_works_for_property_names_for_shadow_entity_type()
    {
        ...
        var entityBuilder = modelBuilder.Entity(typeof(Order), ConfigurationSource.Explicit);
        entityBuilder.Property(
            Order.CustomerIdProperty.PropertyType,
            Order.CustomerIdProperty.Name,
            ConfigurationSource.Convention
        );
        ...
        Assert.Equal(
            Order.CustomerIdProperty.Name,
            entityBuilder.Metadata.GetKeys().Single().Properties.Single().Name
        );
    }
    ...
    )
    {
        ...
        Assert.Empty(
            entityBuilder
                .Metadata.GetKeys()
                .Where(foreignKey => foreignKey.Properties.SequenceEqual(key.Metadata.Properties))
        );
    }
    ...
    public void HasKey_can_override_lower_or_equal_source_HasNoKey()
    {
        ...
        Assert.NotNull(
            entityBuilder.HasKey(
                new[] { shadowProperty.Metadata.Name },
                ConfigurationSource.Convention
            )
        );
    ...
    public void PrimaryKey_returns_same_instance_for_clr_properties()
    {
        ...
        Assert.Same(
            ...
            entityBuilder.Metadata.GetKeys().Single()
        );
    }
    ...
    public void PrimaryKey_works_for_property_names_for_shadow_entity_type()
    {
        ...
        Assert.Equal(
            Order.CustomerIdProperty.Name,
            entityBuilder.Metadata.FindPrimaryKey().Properties.Single().Name
        );
    }
    ...
    public void Can_only_override_lower_or_equal_source_primary_key()
    {
        ...
        var simpleKeyBuilder = entityBuilder.PrimaryKey(
            new[] { Order.IdProperty },
            ConfigurationSource.Convention
        );
        ...
        var simpleKeyBuilder2 = entityBuilder.HasKey(
            new[] { Order.IdProperty },
            ConfigurationSource.Explicit
        );
        ...
        Assert.Null(
            entityBuilder.PrimaryKey(new[] { Order.IdProperty }, ConfigurationSource.DataAnnotation)
        );
        Assert.Same(compositeKeyBuilder2.Metadata, entityBuilder.Metadata.FindPrimaryKey());
        Assert.Equal(2, entityType.GetKeys().Count());
    }
    ...
    public void Changing_primary_key_removes_previously_referenced_primary_key_of_lower_or_equal_source()
    {
        ...
        var fkProperty1 = dependentEntityBuilder
            .Property(Order.CustomerIdProperty, ConfigurationSource.Convention)
            .Metadata;
        var fkProperty2 = dependentEntityBuilder
            .Property(Order.CustomerUniqueProperty, ConfigurationSource.Convention)
            .Metadata;

        dependentEntityBuilder
            .HasRelationship(principalEntityBuilder.Metadata, ConfigurationSource.DataAnnotation)
        ...
        keyBuilder = principalEntityBuilder.PrimaryKey(
            new[] { Customer.IdProperty },
            ConfigurationSource.DataAnnotation
        );
    ...
    public void Changing_primary_key_removes_previously_referenced_key_of_lower_or_equal_source()
    {
        ...
        Assert.Same(
            keyBuilder.Metadata,
            dependentEntityBuilder.Metadata.GetForeignKeys().Single().PrincipalKey
        );
    ...
    public void Property_returns_same_instance_for_clr_properties()
    {
        ...
        Assert.Same(
            propertyBuilder,
            entityBuilder.Property(typeof(int), Order.IdProperty.Name, ConfigurationSource.Explicit)
        );
    }
    ...
    public void Property_returns_same_instance_for_property_names()
    {
        ...
        Assert.Same(
            propertyBuilder,
            entityBuilder.Property(Order.IdProperty, ConfigurationSource.DataAnnotation)
        );
    }
    ...
    public void Property_returns_same_instance_if_type_matches()
    {
        ...
        Assert.Same(
            propertyBuilder,
            entityBuilder.Property(Order.IdProperty.Name, ConfigurationSource.Convention)
        );
        ...
        Assert.Equal(
            new[] { propertyBuilder.Metadata },
            entityBuilder.GetActualProperties(new[] { propertyBuilder.Metadata }, null)
        );
    }
    ...
    public void Can_promote_property_to_base()
    {
        ...
        derivedEntityBuilder.HasBaseType(entityBuilder.Metadata, ConfigurationSource.Convention);
        var derivedProperty = derivedEntityBuilder.Property(
            typeof(int),
            "byte",
            ConfigurationSource.DataAnnotation
        );
        ...
        var derivedEntityBuilder2 = modelBuilder.Entity(
            typeof(BackOrder),
            ConfigurationSource.Convention
        );
        derivedEntityBuilder2.HasBaseType(entityBuilder.Metadata, ConfigurationSource.Convention);
        var derivedProperty2 = derivedEntityBuilder2.Property(
            typeof(byte),
            "byte",
            ConfigurationSource.Convention
        );
    ...
    public void Can_configure_inherited_property()
    {
        ...
        var entityBuilder = modelBuilder.Entity(typeof(Order), ConfigurationSource.Explicit);
        entityBuilder
            .Property(typeof(int), nameof(SpecialOrder.Specialty), ConfigurationSource.Explicit)
        ...
        var propertyBuilder = derivedEntityBuilder.Property(
            typeof(int),
            nameof(SpecialOrder.Specialty),
            ConfigurationSource.DataAnnotation
        );

        Assert.Same(
            entityBuilder.Metadata.FindProperty(nameof(SpecialOrder.Specialty)),
        ...
        Assert.NotNull(
            entityBuilder.PrimaryKey(
                new[] { propertyBuilder.Metadata.Name },
                ConfigurationSource.Explicit
            )
        );
        propertyBuilder = derivedEntityBuilder.Property(
            typeof(string),
            nameof(SpecialOrder.Specialty),
            ConfigurationSource.Explicit
        );
    ...
    public void Can_reuniquify_temporary_properties_with_same_names()
    {
            ...
            .HasKey(
                new[]
                {
                    principalEntityBuilder
                        .Property(typeof(int), "Id", ConfigurationSource.Explicit)
                        .Metadata,
                    principalEntityBuilder
                        .Property(typeof(int), "AlternateId", ConfigurationSource.Explicit)
                        .Metadata,
                },
                ConfigurationSource.Explicit
            )
        ...
        var foreignKey = dependentEntityBuilder
            .HasRelationship(
                ...
                {
                    dependentEntityBuilder
                        .Property(typeof(int), "AlternateId", ConfigurationSource.Convention)
                        .Metadata,
                    dependentEntityBuilder
                        .Property(typeof(int), "AlternateId1", ConfigurationSource.Convention)
                        .Metadata,
                },
                principalKey,
                ConfigurationSource.Convention
        ...
        var newFkProperties = foreignKey
            .Builder.HasForeignKey((IReadOnlyList<Property>)null, ConfigurationSource.Convention)
            .Metadata.Properties;
            ...
            .HasKey(
                new[]
                {
                    principalEntityBuilder
                        ...
                        .Metadata,
                    principalEntityBuilder
                        .Property(typeof(Guid), "AlternateId", ConfigurationSource.Explicit)
                        .Metadata,
                },
                ConfigurationSource.Explicit
            )
            ...
            .HasRelationship(
                ...
                new[]
                {
                    dependentEntityBuilder
                        ...
                        .Metadata,
                    dependentEntityBuilder
                        .Property(typeof(Guid), "Id", ConfigurationSource.Convention)
                        .Metadata,
                },
                principalKey,
                ConfigurationSource.Convention
    ...
    public void Can_reuniquify_temporary_properties_avoiding_unmapped_clr_properties()
    {
            ...
            .HasKey(
                new[]
                {
                    principalEntityBuilder
                        ...
                        .Metadata,
                    principalEntityBuilder
                        .Property(typeof(int), "Unique", ConfigurationSource.Explicit)
                        .Metadata,
                },
                ConfigurationSource.Explicit
            )
        ...
        var foreignKey = dependentEntityBuilder
            .HasRelationship(
                ...
                {
                    dependentEntityBuilder
                        .Property(typeof(int), "Id1", ConfigurationSource.Convention)
                        .Metadata,
                    dependentEntityBuilder
                        .Property(typeof(int), "Id2", ConfigurationSource.Convention)
                        .Metadata,
                },
                principalKey,
                ConfigurationSource.Convention
    ...
    )
    {
        ...
        customerTypeBuilder.PrimaryKey(
            new[] { Customer.IdProperty },
            ConfigurationSource.Convention
        );
        ...
        var ignoredEntityTypeBuilder = modelBuilder.Entity(
            ignoredOnType,
            ConfigurationSource.Convention
        );
        var addedEntityTypeBuilder = modelBuilder.Entity(
            typeof(SpecialOrder),
            ConfigurationSource.Convention
        );

        var exceptionExpected =
            ignoredOnType == typeof(ExtraSpecialOrder)
            && (
        ...
        var expectedIgnored =
            (ignoredOnType != typeof(SpecialOrder) || !expectedAdded) && !exceptionExpected;
        ...
        if (ignoredFirst)
        {
            ...
            Assert.Equal(
                expectedAdded || (!setBaseFirst && ignoredOnType != typeof(SpecialOrder)),
                addMember(addedEntityTypeBuilder)
            );
        }
        else
        {
            Assert.True(addMember(addedEntityTypeBuilder));
            if (exceptionExpected && setBaseFirst)
            {
                Assert.Equal(
        ...
        var modelValidator = InMemoryTestHelpers
            .Instance.CreateContextServices()
            .GetRequiredService<IModelValidator>();
    ...
    public void Can_ignore_service_property()
    {
        ...
        Assert.Null(
            entityBuilder.Ignore(nameof(Order.Context), ConfigurationSource.DataAnnotation)
        );
    ...
    public void Can_ignore_property_that_is_part_of_lower_source_foreign_key_preserving_the_relationship()
    {
        ...
        Assert.Empty(
            dependentEntityBuilder
                .Metadata.GetProperties()
                .Where(p => p.Name == Order.CustomerIdProperty.Name)
        );
        ...
        Assert.NotNull(
            dependentEntityBuilder
                .Metadata.GetForeignKeys()
                .Where(foreignKey => foreignKey != newFk)
        );
    }
    ...
    public void Can_ignore_property_that_is_part_of_lower_source_index()
    {
        ...
        Assert.NotNull(
            entityBuilder.Ignore(nameof(Order.CustomerId), ConfigurationSource.Explicit)
        );

        Assert.Empty(
            entityBuilder.Metadata.GetProperties().Where(p => p.Name == nameof(Order.CustomerId))
        );
        Assert.Empty(entityBuilder.Metadata.GetIndexes());
    ...
    public void Can_ignore_property_that_was_explicitly_mapped()
    {
        ...
        Assert.NotNull(
            entityBuilder.Property(nameof(Order.CustomerId), ConfigurationSource.Explicit)
        );
        Assert.NotNull(
            entityBuilder.Ignore(nameof(Order.CustomerId), ConfigurationSource.Explicit)
        );
        ...
        Assert.Equal(
            CoreResources
                .LogMappedPropertyIgnored(logger)
                .GenerateMessage(nameof(Order), nameof(Order.CustomerId)),
            logger.Message
        );
    }
    ...
    public void Can_ignore_navigation_that_is_part_of_lower_source_index()
    {
        ...
        Assert.Empty(
            entityBuilder.Metadata.GetNavigations().Where(p => p.Name == nameof(Order.Customer))
        );
    ...
    public void Can_ignore_navigation_that_was_explicitly_mapped()
    {
        ...
        Assert.Equal(
            CoreResources
                .LogMappedNavigationIgnored(logger)
                .GenerateMessage(nameof(Order), nameof(Order.Customer)),
            logger.Message
        );
    }
    ...
    public void Can_ignore_skip_navigation_that_is_part_of_lower_source_index()
    {
        ...
        Assert.Empty(
            entityBuilder.Metadata.GetSkipNavigations().Where(p => p.Name == nameof(Order.Products))
        );
    ...
    public void Can_ignore_skip_navigation_that_was_explicitly_mapped()
    {
        ...
        Assert.Equal(
            CoreResources
                .LogMappedNavigationIgnored(logger)
                .GenerateMessage(nameof(Order), nameof(Order.Products)),
            logger.Message
        );
    }
    ...
    public void Can_ignore_property_that_is_part_of_lower_source_principal_key_preserving_the_relationship()
    {
        ...
        Assert.Empty(
            principalEntityBuilder
                .Metadata.GetProperties()
                .Where(p => p.Name == Customer.UniqueProperty.Name)
        );
        var newFk = dependentEntityBuilder.Metadata.GetForeignKeys().Single();
        Assert.Same(fk.DeclaringEntityType, newFk.DeclaringEntityType);
        Assert.Same(fk.PrincipalEntityType, newFk.PrincipalEntityType);
    ...
    public void Navigation_returns_same_value()
    {
        ...
        Assert.True(
            dependentEntityBuilder.CanHaveNavigation(
                Order.CustomerProperty.Name,
                Order.CustomerProperty.GetMemberType(),
                ConfigurationSource.Convention
            )
        );
        ...
        Assert.True(
            principalEntityBuilder.CanHaveNavigation(
                Customer.OrdersProperty.Name,
                Customer.OrdersProperty.GetMemberType(),
                ConfigurationSource.Convention
            )
        );
        ...
        newForeignKeyBuilder = principalEntityBuilder
            .HasRelationship(dependentEntityBuilder.Metadata, ConfigurationSource.Convention)
            .HasNavigation(
                Order.CustomerProperty.Name,
                pointsToPrincipal: false,
                ConfigurationSource.Convention
        ...
        Assert.Empty(dependentEntityBuilder.Metadata.GetKeys());
        Assert.Same(
            foreignKeyBuilder.Metadata.PrincipalKey,
            principalEntityBuilder.Metadata.GetKeys().Single()
        );
    }
    ...
    public void Can_merge_with_intrahierarchical_relationship_of_higher_source()
    {
        ...
        baseEntityBuilder
            .HasRelationship(derivedEntityBuilder.Metadata, ConfigurationSource.Explicit)
            .HasNavigation(
    ...
    )
    {
        ...
        var secondEntityTypeBuilder = modelBuilder.Entity(
            typeof(SpecialOrder),
            ConfigurationSource.Convention
        );
        ...
        {
            if (
                firstEntityTypeBuilder == secondEntityTypeBuilder
                || firstSource != ConfigurationSource.Explicit
                || secondSource != ConfigurationSource.Explicit
                || firstMemberType == secondMemberType
            )
        ...
        var leastDerivedType = firstEntityTypeBuilder.Metadata.LeastDerivedType(
        ...
        var expectedDeclaringType =
            firstMemberType == secondMemberType ? leastDerivedType
            : shouldSecondWin ? secondEntityTypeBuilder.Metadata
            : firstEntityTypeBuilder.Metadata;

        var expectedMemberType = shouldSecondWin ? secondMemberType : firstMemberType;
    ...
    )
    {
        switch (memberType)
        {
            case MemberType.Property:
                return entityTypeBuilder.Property(Order.ProductsProperty, configurationSource)
                    != null;
            ...
            case MemberType.ServiceProperty:
                return entityTypeBuilder.ServiceProperty(
                        Order.ProductsProperty,
                        configurationSource
                    ) != null;
    ...
    )
    {
        switch (memberType)
        {
            case MemberType.Property:
                return (EntityType)
                    entityTypeBuilder.Metadata.FindProperty(nameof(Order.Products))?.DeclaringType;
            case MemberType.ComplexProperty:
                return (EntityType)
                    entityTypeBuilder
                        .Metadata.FindComplexProperty(nameof(Order.Products))
                        ?.DeclaringType;
            case MemberType.ServiceProperty:
                return entityTypeBuilder
                    .Metadata.FindServiceProperty(nameof(Order.Products))
                    ?.DeclaringEntityType;
            case MemberType.Navigation:
                return entityTypeBuilder
                    .Metadata.FindNavigation(nameof(Order.Products))
                    ?.DeclaringEntityType;
            case MemberType.SkipNavigation:
                return entityTypeBuilder
                    .Metadata.FindSkipNavigation(nameof(Order.Products))
                    ?.DeclaringEntityType;
        }
    ...
    public void Can_ignore_lower_source_weak_entity_type()
    {
        ...
        Assert.Equal(
            typeof(Customer).FullName,
            modelBuilder.Metadata.GetEntityTypes().Single().Name
        );
    }
    ...
    public void Can_ignore_lower_source_navigation_to_principal()
    {
        ...
        Assert.NotNull(
            dependentEntityBuilder.Ignore(Order.CustomerProperty.Name, ConfigurationSource.Explicit)
        );
    ...
    public void Dependent_conflicting_relationship_is_not_removed_if_principal_conflicting_relationship_cannot_be_removed()
    {
        ...
        var customerRelationship = dependentEntityBuilder
            .HasRelationship(
                principalEntityBuilder.Metadata,
                null,
        ...
        Assert.Equal(
            Customer.NotCollectionOrdersProperty.Name,
            customerFk.PrincipalToDependent.Name
        );
    ...
    public void Principal_conflicting_relationship_is_not_removed_if_dependent_conflicting_relationship_cannot_be_removed()
    {
        ...
        Assert.Equal(
            Order.CustomerProperty.Name,
            orderRelationship.Metadata.DependentToPrincipal.Name
        );
        Assert.Equal(
            Customer.NotCollectionOrdersProperty.Name,
            customerRelationship.Metadata.PrincipalToDependent.Name
        );
    ...
    public void Conflicting_navigations_are_not_removed_if_conflicting_fk_cannot_be_removed()
    {
        ...
        var orderEntityBuilder = modelBuilder.Entity(typeof(Order), ConfigurationSource.Explicit);
        var fkProperty = orderEntityBuilder
            .Property(Order.IdProperty, ConfigurationSource.Explicit)
            .Metadata;
        var key = customerEntityBuilder
        ...
        Assert.NotNull(customerRelationship);
        var fkRelationship = orderEntityBuilder
            .HasRelationship(
                customerEntityBuilder.Metadata,
                new[] { fkProperty },
                key,
        ...
        Assert.Same(
            fkRelationship.Metadata,
            orderEntityBuilder
                .Metadata.GetForeignKeys()
                .Single(fk => fk.DependentToPrincipal == null && fk.PrincipalToDependent == null)
        );
        var fk1 = orderEntityBuilder
            .Metadata.FindNavigation(Order.CustomerProperty.Name)
            .ForeignKey;
        Assert.NotSame(fkRelationship.Metadata, fk1);
        var fk2 = customerEntityBuilder
            .Metadata.FindNavigation(Customer.NotCollectionOrdersProperty.Name)
            .ForeignKey;
    ...
    public void Can_only_override_lower_or_equal_source_base_type()
    {
        ...
        Assert.Null(
            modelBuilder.Ignore(entityBuilder.Metadata.Name, ConfigurationSource.Convention)
        );
        Assert.Same(
            derivedEntityBuilder,
    ...
    public void Can_only_override_existing_base_type_explicitly()
    {
        ...
        derivedEntityBuilder.Metadata.SetBaseType(
            entityBuilder.Metadata,
            ConfigurationSource.Explicit
        );
        ...
        Assert.Null(
            derivedEntityBuilder.HasBaseType((EntityType)null, ConfigurationSource.Convention)
        );
        Assert.Same(
            derivedEntityBuilder,
            derivedEntityBuilder.HasBaseType((EntityType)null, ConfigurationSource.Explicit)
        );
    ...
    public void Cannot_set_base_type_for_relationship_with_explicit_conflicting_incompatible_navigations()
    {
        ...
        var derivedPrincipalEntityBuilder = modelBuilder
            .Entity(typeof(SpecialCustomer), ConfigurationSource.Explicit)
    ...
    public void Can_set_base_type_for_relationship_with_explicit_conflicting_foreign_key()
    {
        ...
        Assert.Same(
            dependentEntityBuilder.Metadata,
            derivedDependentEntityBuilder.Metadata.BaseType
        );
    ...
    public void Setting_base_type_preserves_non_conflicting_referencing_relationship()
    {
        ...
        var derivedIdProperty = derivedPrincipalEntityBuilder
            .Property(Customer.IdProperty, ConfigurationSource.Convention)
            .Metadata;
        ...
        Assert.Same(
            ...
            derivedPrincipalEntityBuilder.HasBaseType(
                principalEntityBuilder.Metadata,
                ConfigurationSource.Convention
            )
        );
    ...
    public void Setting_base_type_preserves_non_conflicting_relationship_on_duplicate_foreign_key_properties()
    {
        ...
        var derivedIdProperty = derivedDependentEntityBuilder
            .Property(Order.IdProperty, ConfigurationSource.Convention)
            .Metadata;
    ...
    public void Setting_base_type_fixes_relationship_conflicting_with_PK()
    {
        ...
        derivedDependentEntityBuilder.PrimaryKey(
            new[] { Order.IdProperty },
            ConfigurationSource.Convention
        );
        var derivedIdProperty = derivedDependentEntityBuilder
    ...
    {
        IConventionEntityTypeBuilder typeBuilder = CreateModelBuilder()
        ...
        Assert.NotNull(
            typeBuilder.HasDiscriminator(Order.CustomerUniqueProperty, fromDataAnnotation: true)
        );
        Assert.Equal(
            Order.CustomerUniqueProperty.Name,
            typeBuilder.Metadata.FindDiscriminatorProperty().Name
        );
        Assert.Equal(typeof(Guid?), typeBuilder.Metadata.FindDiscriminatorProperty().ClrType);
        Assert.Equal(
            Order.CustomerUniqueProperty.Name,
            typeBuilder.Metadata.GetProperties().Single().Name
        );
    ...
    {
        IConventionEntityTypeBuilder typeBuilder = CreateModelBuilder()
            .Entity("Splot", ConfigurationSource.Convention);
        ...
        Assert.Equal(2, typeBuilder.ModelBuilder.Entity("Splow").Metadata.GetDiscriminatorValue());
        Assert.Equal(3, typeBuilder.ModelBuilder.Entity("Splod").Metadata.GetDiscriminatorValue());
        Assert.Same(
            typeBuilder.Metadata,
            typeBuilder.ModelBuilder.Metadata.FindEntityType("Splow").BaseType
        );

        discriminatorBuilder = typeBuilder.HasDiscriminator(fromDataAnnotation: true);
        Assert.NotNull(
            discriminatorBuilder.HasValue(typeBuilder.Metadata, 4, fromDataAnnotation: true)
        );
        Assert.NotNull(
            discriminatorBuilder.HasValue(
                otherDerivedTypeBuilder.Metadata,
                5,
                fromDataAnnotation: true
            )
        );
        Assert.NotNull(
            discriminatorBuilder.HasValue(derivedTypeBuilder.Metadata, 6, fromDataAnnotation: true)
        );
        Assert.Equal(4, typeBuilder.Metadata.GetDiscriminatorValue());
        Assert.Equal(5, typeBuilder.ModelBuilder.Entity("Splow").Metadata.GetDiscriminatorValue());
        Assert.Equal(6, typeBuilder.ModelBuilder.Entity("Splod").Metadata.GetDiscriminatorValue());
    ...
    public void Changing_discriminator_type_removes_values()
    {
        ...
        Assert.Null(typeBuilder.Metadata[CoreAnnotationNames.DiscriminatorValue]);
        Assert.Null(
            typeBuilder.ModelBuilder.Entity("Splow").Metadata[
                CoreAnnotationNames.DiscriminatorValue
            ]
        );
        Assert.Null(
            typeBuilder.ModelBuilder.Entity("Splod").Metadata[
                CoreAnnotationNames.DiscriminatorValue
            ]
        );
        ...
        Assert.Equal(
            "5",
            typeBuilder.ModelBuilder.Entity("Splow").Metadata.GetDiscriminatorValue()
        );
        Assert.Equal(
            "6",
            typeBuilder.ModelBuilder.Entity("Splod").Metadata.GetDiscriminatorValue()
        );
    ...
    public void Can_access_discriminator_value_generic()
    {
        ...
        Assert.Equal(
            3,
            typeBuilder.ModelBuilder.Entity(typeof(Splod)).Metadata.GetDiscriminatorValue()
        );
    ...
    public void DiscriminatorValue_throws_if_base_cannot_be_set()
    {
        ...
        Assert.Equal(
            CoreStrings.DiscriminatorEntityTypeNotDerived(
                "Splow (Dictionary<string, object>)",
    ...
    private class Order
    {
        ...
        public static readonly PropertyInfo ContextProperty = typeof(Order).GetProperty(
            nameof(Context)
        );
    ...
    {
        public static readonly PropertyInfo SpecialtyProperty = typeof(SpecialOrder).GetProperty(
            "Specialty"
        );
    ...
    private class Customer
    {
        ...
        public static readonly PropertyInfo SpecialOrdersProperty = typeof(Customer).GetProperty(
            nameof(SpecialOrders)
        );
