...
public class StoreGeneratedSentinelSqlServerTest
    : StoreGeneratedSqlServerTestBase<StoreGeneratedSentinelSqlServerTest.StoreGeneratedSentinelSqlServerFixture>
{
    ...
    public class StoreGeneratedSentinelSqlServerFixture : StoreGeneratedSqlServerFixtureBase
    {
        ...
        public override short ShortSentinel => -1;

        public override long LongSentinel => -1;

        public override int? NullableIntSentinel => -1;

        public override bool BoolSentinel => true;

        public override bool? NullableBoolSentinel => true;

        public override string? StringSentinel => "Sentinel";

        public override Uri? UriSentinel { get; } = new(@"http://localhost/");

        public override KeyEnum KeyEnumSentinel => (KeyEnum)(-1);

        public override string? StringAsGuidSentinel => "91B22A0D-99F4-4AD4-930F-6590AFD30FDD";

        public override Guid GuidAsStringSentinel { get; } =
            new("91B22A0D-99F4-4AD4-930F-6590AFD30FDD");
        public override WrappedIntKeyClass? WrappedIntKeyClassSentinel { get; } =
            new() { Value = -1 };
        public override WrappedIntClass? WrappedIntClassSentinel { get; } = new() { Value = -1 };
        public override WrappedIntKeyStruct WrappedIntKeyStructSentinel { get; } =
            new() { Value = -1 };
        public override WrappedIntStruct WrappedIntStructSentinel { get; } = new() { Value = -1 };
        public override WrappedIntKeyRecord? WrappedIntKeyRecordSentinel { get; } =
            new() { Value = -1 };
        public override WrappedIntRecord? WrappedIntRecordSentinel { get; } = new() { Value = -1 };
        public override WrappedStringKeyClass? WrappedStringKeyClassSentinel { get; } =
            new() { Value = "Sentinel" };
        public override WrappedStringClass? WrappedStringClassSentinel { get; } =
            new() { Value = "Sentinel" };
        public override WrappedStringKeyStruct WrappedStringKeyStructSentinel { get; } =
            new() { Value = "Sentinel" };
        public override WrappedStringStruct WrappedStringStructSentinel { get; } =
            new() { Value = "Sentinel" };
        public override WrappedStringKeyRecord? WrappedStringKeyRecordSentinel { get; } =
            new() { Value = "Sentinel" };
        public override WrappedStringRecord? WrappedStringRecordSentinel { get; } =
            new() { Value = "Sentinel" };
        ...
        public override WrappedUriKeyClass? WrappedUriKeyClassSentinel { get; } =
            new() { Value = new Uri(@"http://localhost/") };
        public override WrappedUriClass? WrappedUriClassSentinel { get; } =
            new() { Value = new Uri(@"http://localhost/") };
        public override WrappedUriKeyStruct WrappedUriKeyStructSentinel { get; } =
            new() { Value = new Uri(@"http://localhost/") };
        public override WrappedUriStruct WrappedUriStructSentinel { get; } =
            new() { Value = new Uri(@"http://localhost/") };
        public override WrappedUriKeyRecord? WrappedUriKeyRecordSentinel { get; } =
            new() { Value = new Uri(@"http://localhost/") };
        public override WrappedUriRecord? WrappedUriRecordSentinel { get; } =
            new() { Value = new Uri(@"http://localhost/") };

        public override long LongToDecimalPrincipalSentinel => -1;

        public override WrappedIntHiLoKeyClass? WrappedIntHiLoKeyClassSentinel { get; } =
            new() { Value = -1 };
        public override WrappedIntHiLoKeyStruct WrappedIntHiLoKeyStructSentinel { get; } =
            new() { Value = -1 };
        public override WrappedIntHiLoKeyRecord? WrappedIntHiLoKeyRecordSentinel { get; } =
            new() { Value = -1 };

        protected override string StoreName => "StoreGeneratedTestSentinel";
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder, DbContext context)
        {
            ...
            modelBuilder
                .Entity<CompositeDependent>()
                .Property(e => e.PrincipalId)
                .HasSentinel(IntSentinel);

            modelBuilder
                .Entity<WrappedIntHiLoClassPrincipal>()
                .Property(e => e.Id)
                .HasSentinel(WrappedIntHiLoKeyClassSentinel);
            modelBuilder
                .Entity<WrappedIntHiLoStructPrincipal>()
                .Property(e => e.Id)
                .HasSentinel(WrappedIntHiLoKeyStructSentinel);
            modelBuilder
                .Entity<WrappedIntHiLoRecordPrincipal>()
                .Property(e => e.Id)
                .HasSentinel(WrappedIntHiLoKeyRecordSentinel);
            ...
            modelBuilder
                .Entity<LongToDecimalPrincipal>()
                .Property(e => e.Id)
                .HasSentinel(LongToDecimalPrincipalSentinel);
            ...
            ;
            modelBuilder
                .Entity<GuidAsStringPrincipal>()
                .Property(e => e.Id)
                .HasSentinel(GuidAsStringSentinel);
            modelBuilder
                .Entity<StringAsGuidPrincipal>()
                .Property(e => e.Id)
                .HasSentinel(StringAsGuidSentinel);
        }
    }
}
