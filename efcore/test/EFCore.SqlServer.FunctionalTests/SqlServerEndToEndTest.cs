    ...
    public class SqlServerEndToEndTest : IClassFixture<SqlServerFixture>
    {
        ...
        public void Can_use_decimal_and_byte_as_identity_columns()
        {
            ...
            using (var context = new NumNumContext(options))
            {
                ...
                Assert.Equal(
                    byteNownNum2.Id,
                    context.ByteNownNums.Single(e => e.Lucy == "Trees").Id
                );
                ...
                Assert.Equal(
                    byteAnNum1.Id,
                    context.ByteAnNums.Single(e => e.Lucy == "Cellophane").Id
                );
        ...
        private class NumNumContext : DbContext
        {
            ...
            {
                modelBuilder.Entity<NumNum>()
                    .Property(e => e.Id)
                    .HasColumnType("numeric(18, 0)")
                    .UseIdentityColumn();

                modelBuilder.Entity<AdNum>()
                    .Property(e => e.Id)
                ...
                modelBuilder.Entity<Category>(
                    builder =>
                    {
                        builder.OwnsOne(
                            ...
                            fileSource =>
                            {
                                fileSource.HasOne<FileMetadata>()
                                    .WithOne()
