...
public class SqlServerDatabaseCreatorExistsTest : SqlServerDatabaseCreatorTest
{
    ...
    public Task Returns_false_when_database_does_not_exist(
        ...
        Returns_false_when_database_does_not_exist_test(
            async,
            ambientTransaction,
            useCanConnect,
            file: false
    ...
    public Task Returns_true_when_database_exists(
        ...
        Returns_true_when_database_exists_test(
            async,
            ambientTransaction,
            useCanConnect,
            file: false
...
public class SqlServerDatabaseCreatorEnsureDeletedTest : SqlServerDatabaseCreatorTest
{
    ...
    private static async Task Delete_database_test(
        bool async,
        bool open,
        bool ambientTransaction,
        bool file
...
public class SqlServerDatabaseCreatorEnsureCreatedTest : SqlServerDatabaseCreatorTest
{
    ...
    private static Task Creates_schema_in_existing_database_test(
        bool async,
        bool ambientTransaction,
        bool file
    ) =>
    ...
    private static Task Creates_new_physical_database_and_schema_test(
        bool async,
        bool ambientTransaction,
        bool file
    ) =>
...
public class SqlServerDatabaseCreatorHasTablesTest : SqlServerDatabaseCreatorTest
{
    ...
    {
        using var testDatabase = SqlServerTestStore
            .GetOrCreate("ExistingTables")
