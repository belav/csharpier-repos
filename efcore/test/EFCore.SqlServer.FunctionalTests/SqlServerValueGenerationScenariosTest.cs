    ...
    public class SqlServerValueGenerationScenariosTest
    {
        ...
        public class BlogContextStringDefaultValue : ContextBase
        {
            ...
            protected override void OnModelCreating(ModelBuilder modelBuilder)
            {
                ...
                modelBuilder.Entity<BlogWithStringKey>()
                    .Property(e => e.Id)
                    .HasDefaultValueSql(
                        "'i' + CAST((NEXT VALUE FOR MyStringSequence) AS VARCHAR(20))"
                    );
            }
        }
...
END"
        ...
        public void Resolve_concurrency()
        {
            ...
            catch (DbUpdateConcurrencyException)
            {
                ...
                context.Entry(blog).Property(e => e.Timestamp).OriginalValue =
                    updatedBlog.Timestamp;
        ...
        {
            public NeedsConverter(int value) => Value = value;
