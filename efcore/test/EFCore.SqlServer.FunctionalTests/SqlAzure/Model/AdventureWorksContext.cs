...
public class AdventureWorksContext : PoolableDbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<SalesOrder>(entity =>
        {
            ...
            entity
                .HasIndex(e => e.SalesOrderNumber, "AK_SalesOrderHeader_SalesOrderNumber")
                .IsUnique();
            ...
            entity.Property(e => e.Freight).HasColumnType("money").HasDefaultValueSql("0.00");
            ...
            entity.Property(e => e.SubTotal).HasColumnType("money").HasDefaultValueSql("0.00");

            entity.Property(e => e.TaxAmt).HasColumnType("money").HasDefaultValueSql("0.00");

            entity.Property(e => e.TotalDue).HasColumnType("money").ValueGeneratedOnAddOrUpdate();
