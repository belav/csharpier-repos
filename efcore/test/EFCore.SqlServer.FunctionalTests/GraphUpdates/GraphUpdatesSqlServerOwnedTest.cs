    ...
    : GraphUpdatesSqlServerTestBase<GraphUpdatesSqlServerOwnedTest.SqlServerFixture>
{
    ...
    // No owned types
    public override Task Update_root_by_collection_replacement_of_inserted_first_level(
        bool async
    ) => Task.CompletedTask;
    ...
    // No owned types
    public override Task Update_root_by_collection_replacement_of_inserted_second_level(
        bool async
    ) => Task.CompletedTask;

    // No owned types
    public override Task Update_root_by_collection_replacement_of_deleted_second_level(
        bool async
    ) => Task.CompletedTask;

    // No owned types
    public override Task Update_root_by_collection_replacement_of_inserted_first_level_level(
        bool async
    ) => Task.CompletedTask;
    ...
    {
        protected override string StoreName => "GraphOwnedUpdatesTest";
            ...
            modelBuilder.Entity<Root>(b =>
            {
                ...
                b.OwnsOne(
                    ...
                    r =>
                    {
                        ...
                        r.OwnsOne(e => e.Single).WithOwner(e => e.Back).HasForeignKey(e => e.Id);
                    }
                );
