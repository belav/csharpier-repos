...
[dbo].[Ten Most Expensive Products]"
        ...
        public override async Task From_sql_queryable_stored_procedure_with_caller_info_tag(
            bool async
        )
        {
...
[dbo].[Ten Most Expensive Products]"
        ...
        {
            await base.From_sql_queryable_stored_procedure_with_caller_info_tag_and_other_tags(
                async
            );
