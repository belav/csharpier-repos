...
public class TemporalManyToManyQuerySqlServerFixture : ManyToManyQueryFixtureBase
{
    ...
    protected override void Seed(ManyToManyContext context)
    {
        ...
        context.RemoveRange(
            context.ChangeTracker.Entries().Where(e => e.Entity is EntityTwo).Select(e => e.Entity)
        );
        context.RemoveRange(
            context.ChangeTracker.Entries().Where(e => e.Entity is EntityOne).Select(e => e.Entity)
        );
        context.RemoveRange(
            context
                .ChangeTracker.Entries()
        ...
        context.RemoveRange(
            context.ChangeTracker.Entries().Where(e => e.Entity is EntityRoot).Select(e => e.Entity)
        );
        context.RemoveRange(
            context
                .ChangeTracker.Entries()
