...
{
    protected override string StoreName => "TemporalGearsOfWarQueryTest";
    ...
    protected override void Seed(GearsOfWarContext context)
    {
        ...
        context.RemoveRange(
            context.ChangeTracker.Entries().Where(e => e.Entity is CogTag).Select(e => e.Entity)
        );
        context.RemoveRange(
        ...
        context.RemoveRange(
            context.ChangeTracker.Entries().Where(e => e.Entity is Mission).Select(e => e.Entity)
        );
        context.RemoveRange(
        ...
        context.RemoveRange(
            context.ChangeTracker.Entries().Where(e => e.Entity is Weapon).Select(e => e.Entity)
        );
        context.SaveChanges();

        context.RemoveRange(
            context.ChangeTracker.Entries().Where(e => e.Entity is Faction).Select(e => e.Entity)
        );
        context.RemoveRange(
            context
                .ChangeTracker.Entries()
