...
public class TPCManyToManyQuerySqlServerTest
    : TPCManyToManyQueryRelationalTestBase<TPCManyToManyQuerySqlServerFixture>
{
    public TPCManyToManyQuerySqlServerTest(
