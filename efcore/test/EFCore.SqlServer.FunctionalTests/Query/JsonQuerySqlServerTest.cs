...
"""
    ...
    public override async Task Json_collection_element_access_in_projection_using_ElementAt(
        bool async
    )
    {
...
"""
    ...
    public override async Task Json_collection_element_access_in_projection_using_ElementAtOrDefault(
        bool async
    )
    {
...
"""
    ...
    public override async Task Json_collection_element_access_in_projection_project_collection(
        bool async
    )
    {
...
"""
    ...
    public override async Task Json_collection_element_access_in_projection_using_ElementAt_project_collection(
        bool async
    )
    {
        await base.Json_collection_element_access_in_projection_using_ElementAt_project_collection(
            async
        );
...
"""
    ...
    public override async Task Json_collection_element_access_in_projection_using_ElementAtOrDefault_project_collection(
        bool async
    )
    {
        await base.Json_collection_element_access_in_projection_using_ElementAtOrDefault_project_collection(
            async
        );
...
"""
    ...
    public override async Task Json_collection_element_access_in_projection_using_parameter(
        bool async
    )
    {
...
"""
    ...
    public override async Task Json_collection_element_access_in_projection_using_untranslatable_client_method(
        bool async
    )
    {
        await base.Json_collection_element_access_in_projection_using_untranslatable_client_method(
            async
        );
    ...
    public override async Task Json_collection_element_access_in_projection_using_untranslatable_client_method2(
        bool async
    )
    {
        await base.Json_collection_element_access_in_projection_using_untranslatable_client_method2(
            async
        );
...
"""
    ...
    public override async Task Json_collection_element_access_outside_bounds_with_property_access(
        bool async
    )
    {
...
"""
    ...
    [SqlServerCondition(SqlServerCondition.SupportsJsonPathExpressions)]
    public override async Task Json_collection_element_access_in_projection_nested_project_scalar(
        bool async
    )
    {
...
"""
    ...
    [SqlServerCondition(SqlServerCondition.SupportsJsonPathExpressions)]
    public override async Task Json_collection_element_access_in_projection_nested_project_reference(
        bool async
    )
    {
...
"""
    ...
    [SqlServerCondition(SqlServerCondition.SupportsJsonPathExpressions)]
    public override async Task Json_collection_element_access_in_projection_nested_project_collection(
        bool async
    )
    {
...
"""
    ...
    [SqlServerCondition(SqlServerCondition.SupportsJsonPathExpressions)]
    public override async Task Json_collection_element_access_in_projection_nested_project_collection_anonymous_projection(
        bool async
    )
    {
        await base.Json_collection_element_access_in_projection_nested_project_collection_anonymous_projection(
            async
        );
...
"""
    ...
    public override async Task Json_collection_element_access_in_predicate_using_constant(
        bool async
    )
    {
...
"""
    ...
    [SqlServerCondition(SqlServerCondition.SupportsJsonPathExpressions)]
    public override async Task Json_collection_element_access_in_predicate_using_variable(
        bool async
    )
    {
...
"""
    ...
    [SqlServerCondition(SqlServerCondition.SupportsJsonPathExpressions)]
    public override async Task Json_collection_element_access_in_predicate_using_complex_expression1(
        bool async
    )
    {
...
"""
    ...
    [SqlServerCondition(SqlServerCondition.SupportsJsonPathExpressions)]
    public override async Task Json_collection_element_access_in_predicate_using_complex_expression2(
        bool async
    )
    {
...
"""
    ...
    public override async Task Json_collection_element_access_in_predicate_using_ElementAt(
        bool async
    )
    {
...
"""
    ...
    public override async Task Json_collection_element_access_manual_Element_at_and_pushdown(
        bool async
    )
    {
...
"""
    ...
    public override async Task Json_collection_element_access_manual_Element_at_and_pushdown_negative(
        bool async
    )
    {
    ...
    public override async Task Json_collection_element_access_manual_Element_at_and_pushdown_negative2(
        bool async
    )
    {
    ...
    public override async Task Json_collection_element_access_manual_Element_at_and_pushdown_negative3(
        bool async
    )
    {
    ...
    public override async Task Json_collection_element_access_manual_Element_at_and_pushdown_negative4(
        bool async
    )
    {
    ...
    public override async Task Json_collection_element_access_manual_Element_at_and_pushdown_negative5(
        bool async
    )
    {
    ...
    public override async Task Json_collection_element_access_manual_Element_at_and_pushdown_negative6(
        bool async
    )
    {
...
"""
    ...
    public override async Task Json_collection_element_access_in_projection_using_constant_when_owner_is_present(
        bool async
    )
    {
...
"""
    ...
    public override async Task Json_collection_element_access_in_projection_using_parameter_when_owner_is_present(
        bool async
    )
    {
        await base.Json_collection_element_access_in_projection_using_parameter_when_owner_is_present(
            async
        );
...
"""
    ...
    public override async Task Json_collection_after_collection_element_access_in_projection_using_constant_when_owner_is_present(
        bool async
    )
    {
        await base.Json_collection_after_collection_element_access_in_projection_using_constant_when_owner_is_present(
            async
        );
...
"""
    ...
    public override async Task Json_collection_after_collection_element_access_in_projection_using_parameter_when_owner_is_present(
        bool async
    )
    {
        await base.Json_collection_after_collection_element_access_in_projection_using_parameter_when_owner_is_present(
            async
        );
...
"""
    ...
    public override async Task Json_collection_element_access_in_projection_when_owner_is_present_misc1(
        bool async
    )
    {
...
"""
    ...
    public override async Task Json_collection_element_access_in_projection_when_owner_is_present_misc2(
        bool async
    )
    {
...
"""
    ...
    public override async Task Json_collection_element_access_in_projection_when_owner_is_present_multiple(
        bool async
    )
    {
        await base.Json_collection_element_access_in_projection_when_owner_is_present_multiple(
            async
        );
