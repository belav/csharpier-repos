...
public class NorthwindAsTrackingQuerySqlServerTest
    : NorthwindAsTrackingQueryTestBase<NorthwindQuerySqlServerFixture<NoopModelCustomizer>>
{
    public NorthwindAsTrackingQuerySqlServerTest(
