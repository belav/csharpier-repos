...
namespace Microsoft.EntityFrameworkCore.Query
{
    public class TemporalPointInTimeQueryRewriter : ExpressionVisitor
    {
        private static readonly MethodInfo _setMethodInfo = typeof(ISetSource).GetMethod(
            nameof(ISetSource.Set)
        );

        private static readonly MethodInfo _asOfMethodInfo =
            typeof(SqlServerDbSetExtensions).GetMethod(
        ...
        public TemporalPointInTimeQueryRewriter(
            DateTime pointInTime,
            List<Type> temporalEntityTypes
        )
        {
        ...
        protected override Expression VisitMethodCall(MethodCallExpression methodCallExpression)
        {
            ...
            )
            {
                ...
                {
                    var method = _asOfMethodInfo.MakeGenericMethod(
                    ...
                    return Expression.Call(
                        method,
                        Expression.Convert(methodCallExpression, dbSetType),
