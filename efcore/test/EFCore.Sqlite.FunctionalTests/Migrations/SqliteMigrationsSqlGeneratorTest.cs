...
"
        ...
        public virtual void RenameIndexOperations_throws_when_no_model()
        {
            ...
            Assert.Equal(
                SqliteStrings.InvalidMigrationOperation("RenameIndexOperation"),
                ex.Message
            );
        }
...
"
        ...
        protected override string GetGeometryCollectionStoreType() => "GEOMETRYCOLLECTION";
...
"
        ...
        public virtual void AddPrimaryKey_throws_when_no_model()
        {
            ...
            Assert.Equal(
                SqliteStrings.InvalidMigrationOperation("AddPrimaryKeyOperation"),
                ex.Message
            );
        }
        ...
        public virtual void DropColumn_throws_when_no_model()
        {
            ...
            Assert.Equal(
                SqliteStrings.InvalidMigrationOperation("DropColumnOperation"),
                ex.Message
            );
        }
        ...
        public virtual void DropColumn_defers_subsequent_RenameColumn()
        {
            Generate(
                ...
                migrationBuilder =>
                {
                    ...
                    migrationBuilder.RenameColumn(name: "Title", table: "Blog", newName: "Name");
                }
            );
...
"
        ...
        public virtual void Deferred_AddColumn_defers_subsequent_CreateIndex()
        {
            Generate(
                ...
                {
                    migrationBuilder.DropColumn(name: "Name", table: "Blog");
                    migrationBuilder.AddColumn<string>(name: "Name", table: "Blog");
                    migrationBuilder.CreateIndex(
                        name: "IX_Blog_Name",
                        table: "Blog",
                        column: "Name"
...
"
        ...
        public virtual void RenameTable_preserves_pending_rebuilds()
        {
            Generate(
                ...
                migrationBuilder =>
                {
                    migrationBuilder.DropColumn(name: "Name", table: "Blogs");
                    migrationBuilder.RenameTable(name: "Blogs", newName: "Blog");
                }
            );
