        ...
        : IClassFixture<SqliteDatabaseModelFactoryTest.SqliteDatabaseModelFixture>
    {
        ...
        )
        {
            ...
            try
            {
                ...
                var databaseModelFactory = services.BuildServiceProvider()
...
SELECT
 ...
 CAST('' AS text) AS Name;",
                ...
                dbModel =>
                {
                    ...
                    Assert.All(
                        table.Columns,
                        c => Assert.Equal("MountainsColumnsView", c.Table.Name)
                    );
...
CREATE TABLE DefaultValue (
    ...
    Created datetime DEFAULT('October 20, 2015 11am')
                ...
                dbModel =>
                {
                    ...
                    Assert.Equal(
                        "3.14",
                        columns.Single(c => c.Name == "RealColumn").DefaultValueSql
                    );
                    Assert.Equal(
...
CREATE TABLE ComputedColumnSql (
    ...
    GeneratedColumnStored AS (1 + 2) STORED
                ...
                dbModel =>
                {
                    ...
                    var generatedColumnStored = columns.Single(
                        c => c.Name == "GeneratedColumnStored"
                    );
        ...
        public void Warn_missing_table()
        {
            Test(
                ...
                dbModel =>
                {
                    ...
                    Assert.Equal(
                        SqliteResources.LogMissingTable(new TestLogger<SqliteLoggingDefinitions>())
