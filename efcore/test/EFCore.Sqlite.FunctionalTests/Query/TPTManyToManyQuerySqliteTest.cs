...
{
    public class TPTManyToManyQuerySqliteTest
        : TPTManyToManyQueryRelationalTestBase<TPTManyToManyQuerySqliteFixture>
    {
        public TPTManyToManyQuerySqliteTest(TPTManyToManyQuerySqliteFixture fixture) : base(fixture)
        { }
