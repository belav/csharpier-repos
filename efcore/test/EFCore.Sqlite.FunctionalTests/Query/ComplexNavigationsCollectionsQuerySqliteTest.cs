...
namespace Microsoft.EntityFrameworkCore.Query
{
    ...
    {
        public ComplexNavigationsCollectionsQuerySqliteTest(
        ...
        public override async Task Filtered_include_outer_parameter_used_inside_filter(
            bool async
        ) =>
            Assert.Equal(
                SqliteStrings.ApplyNotSupported,
        ...
        public override async Task Skip_Take_on_grouping_element_with_collection_include(
            bool async
        ) =>
            Assert.Equal(
                SqliteStrings.ApplyNotSupported,
