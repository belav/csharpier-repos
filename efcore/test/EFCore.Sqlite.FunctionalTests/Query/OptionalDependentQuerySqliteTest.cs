...
public class OptionalDependentQuerySqliteTest
    : OptionalDependentQueryTestBase<OptionalDependentQuerySqliteFixture>
{
    public OptionalDependentQuerySqliteTest(
        OptionalDependentQuerySqliteFixture fixture,
