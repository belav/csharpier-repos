...
public class TPCGearsOfWarQuerySqliteTest
    : TPCGearsOfWarQueryRelationalTestBase<TPCGearsOfWarQuerySqliteFixture>
{
    public TPCGearsOfWarQuerySqliteTest(
        TPCGearsOfWarQuerySqliteFixture fixture,
