...
public class JsonTypesSqliteTest : JsonTypesRelationalTestBase
{
    ...
    public override void Can_read_write_collection_of_decimal_JSON_values() =>
        Can_read_and_write_JSON_value<DecimalCollectionType, List<decimal>>(
            ...
            new List<decimal> { decimal.MinValue, 0, decimal.MaxValue },
    ...
    [InlineData(
        "9999-12-31T23:59:59.9999999+02:00",
        """{"Prop":"9999-12-31 23:59:59.9999999+02:00"}"""
    )]
    [InlineData("0001-01-01T00:00:00.0000000-03:00", """{"Prop":"0001-01-01 00:00:00-03:00"}""")]
    [InlineData(
        "2023-05-29T11:11:15.5672854+04:00",
        """{"Prop":"2023-05-29 11:11:15.5672854+04:00"}"""
    )]
    public virtual void Can_read_write_DateTimeOffset_JSON_values_sqlite(
        string value,
        string json
    ) =>
    ...
    [InlineData(
        ...
        """{"Prop":"-79228162514264337593543950335.0"}"""
    )]
    ...
    public virtual void Can_read_write_decimal_JSON_values_sqlite(decimal value, string json) =>
        Can_read_and_write_JSON_value<DecimalType, decimal>(
            nameof(DecimalType.Decimal),
            value,
            json
        );
    ...
    [InlineData(
        ...
        """{"Prop":"FFFFFFFF-FFFF-FFFF-FFFF-FFFFFFFFFFFF"}"""
    )]
    [InlineData(
        "8C44242F-8E3F-4A20-8BE8-98C7C1AADEBD",
        """{"Prop":"8C44242F-8E3F-4A20-8BE8-98C7C1AADEBD"}"""
    )]
    ...
    public virtual void Can_read_write_nullable_binary_JSON_values_sqlite(
        string? value,
        string json
    ) =>
    ...
    [InlineData("2023-05-29T10:52:47.2064353", """{"Prop":"2023-05-29 10:52:47.2064353"}""")]
    [InlineData(null, """{"Prop":null}""")]
    public virtual void Can_read_write_nullable_DateTime_JSON_values_sqlite(
        string? value,
        string json
    ) =>
    ...
    public override void Can_read_write_nullable_DateTimeOffset_JSON_values(
        string? value,
        string json
    )
    {
    ...
    [InlineData(null, """{"Prop":null}""")]
    public virtual void Can_read_write_nullable_DateTimeOffset_JSON_values_sqlite(
        string? value,
        string json
    ) =>
    ...
    [InlineData("1.1", """{"Prop":"1.1"}""")]
    [InlineData(null, """{"Prop":null}""")]
    public virtual void Can_read_write_nullable_decimal_JSON_values_sqlite(
        string? value,
        string json
    ) =>
        Can_read_and_write_JSON_value<NullableDecimalType, decimal?>(
            nameof(NullableDecimalType.Decimal),
            value == null ? default(decimal?) : decimal.Parse(value, CultureInfo.InvariantCulture),
            json
        );
    ...
    [InlineData(null, """{"Prop":null}""")]
    public virtual void Can_read_write_nullable_GUID_JSON_values_sqlite(
        string? value,
        string json
    ) =>
        Can_read_and_write_JSON_value<NullableGuidType, Guid?>(
            nameof(NullableGuidType.Guid),
            value == null ? null : Guid.Parse(value, CultureInfo.InvariantCulture),
            json
        );
    ...
    public override void Can_read_write_collection_of_nullable_decimal_JSON_values() =>
        Can_read_and_write_JSON_value<NullableDecimalCollectionType, List<decimal?>>(
            ...
            new List<decimal?> { decimal.MinValue, 0, null, decimal.MaxValue },
