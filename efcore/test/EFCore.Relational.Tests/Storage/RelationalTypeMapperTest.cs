    ...
    public class RelationalTypeMapperTest : RelationalTypeMapperTestBase
    {
        ...
        public void Key_with_store_type_is_picked_up_by_FK()
        {
            ...
            Assert.Equal(
                ...
                GetMapping(
                    mapper,
                    model.FindEntityType(typeof(MyType)).FindProperty("Id")
                ).StoreType
            );
        ...
        public void Does_default_type_mapping_from_decimal()
        {
            ...
            Assert.Equal(
                ...
                GetMapping(
                    mapper,
                    model.FindEntityType(typeof(MyPrecisionType)).FindProperty("Id")
                ).StoreType
            );
        }
        ...
        public void Does_type_mapping_from_decimal_with_precision_only()
        {
            ...
            Assert.Equal(
                ...
                GetMapping(
                    mapper,
                    model.FindEntityType(typeof(MyPrecisionType)).FindProperty("PrecisionOnly")
                ).StoreType
            );
        }
        ...
        public void Does_type_mapping_from_decimal_with_precision_and_scale()
        {
            ...
            Assert.Equal(
                ...
                GetMapping(
                    mapper,
                    model.FindEntityType(typeof(MyPrecisionType)).FindProperty("PrecisionAndScale")
                ).StoreType
            );
        }
        ...
        public static RelationalTypeMapping GetMapping(IProperty property) =>
