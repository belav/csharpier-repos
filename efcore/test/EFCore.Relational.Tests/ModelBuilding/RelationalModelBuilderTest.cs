...
public class RelationalModelBuilderTest : ModelBuilderTest
{
    public abstract class RelationalNonRelationshipTestBase : NonRelationshipTestBase
    {
        ...
        public virtual void Can_use_table_splitting()
        {
            ...
            Assert.False(
                entity.IsTableExcludedFromMigrations(StoreObjectIdentifier.Table("Order", "dbo"))
            );
            Assert.True(
                entity.IsTableExcludedFromMigrations(
                    StoreObjectIdentifier.Table("OrderDetails", "dbo")
                )
            );
            Assert.Same(
                entity.GetMappingFragments().Single(),
                entity.FindMappingFragment(StoreObjectIdentifier.Table("OrderDetails", "dbo"))
            );
            ...
            Assert.Equal(
                "id",
                customerId.GetColumnName(StoreObjectIdentifier.Table("OrderDetails", "dbo"))
            );
            Assert.Same(
                customerId.GetOverrides().Single(),
                customerId.FindOverrides(StoreObjectIdentifier.Table("OrderDetails", "dbo"))
            );
        }
        ...
        public virtual void Can_use_table_splitting_with_schema()
        {
            ...
            Assert.True(
                entity.IsTableExcludedFromMigrations(
                    StoreObjectIdentifier.Table("OrderDetails", "sch")
                )
            );
            Assert.Same(
                entity.GetMappingFragments().Single(),
                entity.FindMappingFragment(StoreObjectIdentifier.Table("OrderDetails", "sch"))
            );
            Assert.Equal(
            ...
            Assert.Equal(
                "id",
                customerId.GetColumnName(StoreObjectIdentifier.Table("OrderDetails", "sch"))
            );
            Assert.Same(
                customerId.GetOverrides().Single(),
                customerId.FindOverrides(StoreObjectIdentifier.Table("OrderDetails", "sch"))
            );
        ...
        public virtual void Can_use_view_splitting()
        {
            ...
            Assert.Same(
                entity.GetMappingFragments().Single(),
                entity.FindMappingFragment(StoreObjectIdentifier.View("OrderDetails"))
            );
            ...
            Assert.Equal(
                "id",
                customerId.GetColumnName(StoreObjectIdentifier.View("OrderDetails"))
            );
            Assert.Same(
                customerId.GetOverrides().Single(),
                customerId.FindOverrides(StoreObjectIdentifier.View("OrderDetails"))
            );
        }
        ...
        public virtual void Can_use_view_splitting_with_schema()
        {
            ...
            Assert.Same(
                entity.GetMappingFragments().Single(),
                entity.FindMappingFragment(StoreObjectIdentifier.View("OrderDetails", "sch"))
            );
            Assert.Equal(
                RelationalStrings.TableNotMappedEntityType(nameof(Order), "Order"),
                Assert
            ...
            Assert.Equal(
                "id",
                customerId.GetColumnName(StoreObjectIdentifier.View("OrderDetails", "sch"))
            );
            Assert.Same(
                customerId.GetOverrides().Single(),
                customerId.FindOverrides(StoreObjectIdentifier.View("OrderDetails", "sch"))
            );
            Assert.Null(customerId.GetColumnName(StoreObjectIdentifier.View("Order")));
        }
        ...
        public virtual void Duplicate_sproc_rows_affected_result_column_throws()
        {
            ...
            Assert.Equal(
                ...
                Assert
                    .Throws<InvalidOperationException>(() => sproc.AddRowsAffectedResultColumn())
                    .Message
            );
        }
        ...
        public virtual void Duplicate_sproc_rows_affected_parameter_throws()
        {
            ...
            Assert.Equal(
                RelationalStrings.StoredProcedureDuplicateRowsAffectedParameter("BookLabel_Update"),
                Assert
                    .Throws<InvalidOperationException>(() => sproc.AddRowsAffectedParameter())
                    .Message
            );
        }
        ...
        public virtual void Duplicate_sproc_parameter_throws()
        {
            ...
            Assert.Equal(
                ...
                Assert.Throws<InvalidOperationException>(() => sproc.AddParameter("Id")).Message
            );
        }
        ...
        public virtual void Duplicate_sproc_original_value_parameter_throws()
        {
            ...
            Assert.Equal(
                ...
                Assert
                    .Throws<InvalidOperationException>(() => sproc.AddOriginalValueParameter("Id"))
                    .Message
            );
        }
        ...
        public virtual void Duplicate_sproc_result_column_throws()
        {
            ...
            Assert.Equal(
                ...
                Assert.Throws<InvalidOperationException>(() => sproc.AddResultColumn("Id")).Message
            );
        }
    ...
    public abstract class RelationalInheritanceTestBase : InheritanceTestBase
    {
        ...
        public virtual void Can_use_table_splitting()
        {
            ...
            Assert.True(
                entity.IsTableExcludedFromMigrations(StoreObjectIdentifier.Table("OrderDetails"))
            );
            Assert.Same(
                entity.GetMappingFragments().Single(),
                entity.FindMappingFragment(StoreObjectIdentifier.Table("OrderDetails"))
            );
            ...
            Assert.Equal(
                "id",
                customerId.GetColumnName(StoreObjectIdentifier.Table("OrderDetails"))
            );
            Assert.Same(
                customerId.GetOverrides().Single(),
                customerId.FindOverrides(StoreObjectIdentifier.Table("OrderDetails"))
            );
        }
        ...
        public virtual void Sproc_overrides_update_when_renamed_in_TPH()
        {
                ...
                .UpdateUsingStoredProcedure(
                    s =>
                        s.HasAnnotation("foo", "bar2")
                            ...
                            .HasOriginalValueParameter(
                                "RowVersion",
                                p => p.HasName("OriginalRowVersion")
                            )
            ...
            modelBuilder.Entity<SpecialBookLabel>().Ignore(s => s.BookLabel);
            ...
            Assert.Equal(
                new[] { "Id", "BookId", null, "RowVersion", "RowVersion" },
                updateSproc.Parameters.Select(p => p.PropertyName)
            );
            Assert.Equal(
                new[] { "UpdateId", "BookId", "RowsAffected", "OriginalRowVersion", "RowVersion" },
                updateSproc.Parameters.Select(p => p.Name)
            );
            ...
            Assert.Equal(
                new[] { "DeleteId", "RowVersion_Original" },
            ...
            Assert.Equal(
                ...
                id.GetColumnName(
                    StoreObjectIdentifier
                        .Create(bookLabel, StoreObjectType.InsertStoredProcedure)!
                        .Value
                )
            );
            Assert.Equal(
                ...
                id.GetColumnName(
                    StoreObjectIdentifier
                        .Create(bookLabel, StoreObjectType.UpdateStoredProcedure)!
                        .Value
                )
            );
            Assert.Equal(
                ...
                id.GetColumnName(
                    StoreObjectIdentifier
                        .Create(bookLabel, StoreObjectType.DeleteStoredProcedure)!
                        .Value
                )
            );
        ...
        public virtual void Sproc_overrides_are_removed_with_sproc()
        {
            ...
            modelBuilder
                ...
                .InsertUsingStoredProcedure(
                    s =>
                        s.HasParameter(b => b.BookId)
                            .HasResultColumn(b => b.Id, p => p.HasName("InsertId"))
                )
                .UpdateUsingStoredProcedure(
                    s =>
                        s.HasParameter(b => b.Id, p => p.HasName("UpdateId"))
                            .HasParameter(b => b.BookId)
                )
                .DeleteUsingStoredProcedure(
    ...
    public abstract class RelationalOwnedTypesTestBase : OwnedTypesTestBase
    {
        ...
        public virtual void Can_use_table_splitting_with_owned_reference()
        {
            ...
            Assert.Same(
                fragment,
                bookOwnership1.DeclaringEntityType.FindMappingFragment(splitTable)
            );
            Assert.Same(
                fragment,
            ...
            Assert.Equal(
                2,
                readOnlyModel.GetEntityTypes().Count(e => e.ClrType == typeof(BookLabel))
            );
...
#nullable enable
    ...
    public abstract class TestTableBuilder<TEntity> where TEntity : class
    {
        ...
        public abstract TestCheckConstraintBuilder HasCheckConstraint(string name, string? sql);
        ...
        public abstract TestColumnBuilder<TProperty> Property<TProperty>(
            ...
            IInfrastructure<TableBuilder<TEntity>> where TEntity : class
    {
        ...
        public override string? Name => TableBuilder.Name;

        public override string? Schema => TableBuilder.Schema;

        TableBuilder<TEntity> IInfrastructure<TableBuilder<TEntity>>.Instance => TableBuilder;
        ...
        public override TestColumnBuilder<TProperty> Property<TProperty>(
            Expression<Func<TEntity, TProperty>> propertyExpression
            ...
            IInfrastructure<TableBuilder> where TEntity : class
    {
        ...
        TableBuilder IInfrastructure<TableBuilder>.Instance => TableBuilder;
        ...
        public override TestColumnBuilder<TProperty> Property<TProperty>(
            ...
            new GenericTestColumnBuilder<TProperty>(
                TableBuilder.Property<TProperty>(propertyExpression.GetPropertyAccess().Name)
            );
    }
        ...
        where TDependentEntity : class
    {
        ...
        public abstract TestOwnedNavigationTableBuilder<
            TOwnerEntity,
            TDependentEntity
    ...
    public class GenericTestOwnedNavigationTableBuilder<TOwnerEntity, TDependentEntity>
        ...
        where TDependentEntity : class
    {
        public GenericTestOwnedNavigationTableBuilder(
        ...
        OwnedNavigationTableBuilder<TOwnerEntity, TDependentEntity> IInfrastructure<
        ...
        protected virtual TestOwnedNavigationTableBuilder<TOwnerEntity, TDependentEntity> Wrap(
            ...
            new GenericTestOwnedNavigationTableBuilder<TOwnerEntity, TDependentEntity>(
                tableBuilder
            );

        public override TestOwnedNavigationTableBuilder<
            TOwnerEntity,
            TDependentEntity
        > ExcludeFromMigrations(bool excluded = true) =>
            Wrap(TableBuilder.ExcludeFromMigrations(excluded));
        ...
        where TDependentEntity : class
    {
        ...
        protected virtual TestOwnedNavigationTableBuilder<TOwnerEntity, TDependentEntity> Wrap(
            ...
            new NonGenericTestOwnedNavigationTableBuilder<TOwnerEntity, TDependentEntity>(
                tableBuilder
            );
            ...
            IInfrastructure<SplitTableBuilder<TEntity>> where TEntity : class
    {
        ...
        protected virtual TestSplitTableBuilder<TEntity> Wrap(
            SplitTableBuilder<TEntity> tableBuilder
        ) => new GenericTestSplitTableBuilder<TEntity>(tableBuilder);

        public override TestSplitTableBuilder<TEntity> ExcludeFromMigrations(
            bool excluded = true
        ) => Wrap(TableBuilder.ExcludeFromMigrations(excluded));
        ...
        public override TestSplitTableBuilder<TEntity> HasAnnotation(
            string annotation,
            object? value
            ...
            IInfrastructure<SplitTableBuilder> where TEntity : class
    {
        ...
        SplitTableBuilder IInfrastructure<SplitTableBuilder>.Instance => TableBuilder;
        ...
        public override TestColumnBuilder<TProperty> Property<TProperty>(
            ...
            new NonGenericTestColumnBuilder<TProperty>(
                TableBuilder.Property<TProperty>(propertyExpression.GetPropertyAccess().Name)
            );
        ...
        where TDependentEntity : class
    {
        ...
        public abstract TestOwnedNavigationSplitTableBuilder<
            TOwnerEntity,
            TDependentEntity
        > ExcludeFromMigrations(bool excluded = true);
    ...
    public class GenericTestOwnedNavigationSplitTableBuilder<TOwnerEntity, TDependentEntity>
        ...
        where TDependentEntity : class
    {
        public GenericTestOwnedNavigationSplitTableBuilder(
        ...
        private OwnedNavigationSplitTableBuilder<
            TOwnerEntity,
            TDependentEntity
        > TableBuilder { get; }
        ...
        OwnedNavigationSplitTableBuilder<TOwnerEntity, TDependentEntity> IInfrastructure<
        ...
        protected virtual TestOwnedNavigationSplitTableBuilder<TOwnerEntity, TDependentEntity> Wrap(
            ...
            new GenericTestOwnedNavigationSplitTableBuilder<TOwnerEntity, TDependentEntity>(
                tableBuilder
            );

        public override TestOwnedNavigationSplitTableBuilder<
            TOwnerEntity,
            TDependentEntity
        > ExcludeFromMigrations(bool excluded = true) =>
            Wrap(TableBuilder.ExcludeFromMigrations(excluded));
    ...
    public class NonGenericTestOwnedNavigationSplitTableBuilder<TOwnerEntity, TDependentEntity>
        ...
        where TDependentEntity : class
    {
        public NonGenericTestOwnedNavigationSplitTableBuilder(
        ...
        protected virtual TestOwnedNavigationSplitTableBuilder<TOwnerEntity, TDependentEntity> Wrap(
            ...
            new NonGenericTestOwnedNavigationSplitTableBuilder<TOwnerEntity, TDependentEntity>(
                tableBuilder
            );
    ...
    public class GenericTestColumnBuilder<TProperty>
        : TestColumnBuilder<TProperty>,
            IInfrastructure<ColumnBuilder<TProperty>>
    {
        ...
        protected virtual TestColumnBuilder<TProperty> Wrap(
            ColumnBuilder<TProperty> columnBuilder
    ...
    public class NonGenericTestColumnBuilder<TProperty>
        : TestColumnBuilder<TProperty>,
            IInfrastructure<ColumnBuilder>
    {
        ...
        ColumnBuilder IInfrastructure<ColumnBuilder>.Instance => ColumnBuilder;
            ...
            IInfrastructure<ViewBuilder<TEntity>> where TEntity : class
    {
        ...
        public override string? Name => ViewBuilder.Name;

        public override string? Schema => ViewBuilder.Schema;

        ViewBuilder<TEntity> IInfrastructure<ViewBuilder<TEntity>>.Instance => ViewBuilder;
            ...
            IInfrastructure<ViewBuilder> where TEntity : class
    {
        ...
        ViewBuilder IInfrastructure<ViewBuilder>.Instance => ViewBuilder;
        ...
        public override TestViewColumnBuilder<TProperty> Property<TProperty>(
            ...
            new GenericTestViewColumnBuilder<TProperty>(
                ViewBuilder.Property<TProperty>(propertyExpression.GetPropertyAccess().Name)
            );
    }
    ...
    public class GenericTestOwnedNavigationViewBuilder<TOwnerEntity, TDependentEntity>
        ...
        where TDependentEntity : class
    {
        public GenericTestOwnedNavigationViewBuilder(
        ...
        OwnedNavigationViewBuilder<TOwnerEntity, TDependentEntity> IInfrastructure<
        ...
        where TDependentEntity : class
    {
        ...
        protected virtual TestOwnedNavigationViewBuilder<TOwnerEntity, TDependentEntity> Wrap(
            OwnedNavigationViewBuilder tableBuilder
        ) =>
            new NonGenericTestOwnedNavigationViewBuilder<TOwnerEntity, TDependentEntity>(
                tableBuilder
            );
            ...
            IInfrastructure<SplitViewBuilder<TEntity>> where TEntity : class
    {
        ...
        protected virtual TestSplitViewBuilder<TEntity> Wrap(
            SplitViewBuilder<TEntity> tableBuilder
        ...
        public override TestSplitViewBuilder<TEntity> HasAnnotation(
            string annotation,
            object? value
            ...
            IInfrastructure<SplitViewBuilder> where TEntity : class
    {
        ...
        SplitViewBuilder IInfrastructure<SplitViewBuilder>.Instance => ViewBuilder;
        ...
        public override TestViewColumnBuilder<TProperty> Property<TProperty>(
            ...
            new NonGenericTestViewColumnBuilder<TProperty>(
                ViewBuilder.Property<TProperty>(propertyExpression.GetPropertyAccess().Name)
            );
        ...
        where TDependentEntity : class
    {
        ...
        public abstract TestOwnedNavigationSplitViewBuilder<
            TOwnerEntity,
            TDependentEntity
        > HasAnnotation(string annotation, object? value);
    }
    ...
    public class GenericTestOwnedNavigationSplitViewBuilder<TOwnerEntity, TDependentEntity>
        ...
        where TDependentEntity : class
    {
        public GenericTestOwnedNavigationSplitViewBuilder(
        ...
        OwnedNavigationSplitViewBuilder<TOwnerEntity, TDependentEntity> IInfrastructure<
        ...
        protected virtual TestOwnedNavigationSplitViewBuilder<TOwnerEntity, TDependentEntity> Wrap(
            ...
            new GenericTestOwnedNavigationSplitViewBuilder<TOwnerEntity, TDependentEntity>(
                tableBuilder
            );
    ...
    public class NonGenericTestOwnedNavigationSplitViewBuilder<TOwnerEntity, TDependentEntity>
        ...
        where TDependentEntity : class
    {
        public NonGenericTestOwnedNavigationSplitViewBuilder(
        ...
        protected virtual TestOwnedNavigationSplitViewBuilder<TOwnerEntity, TDependentEntity> Wrap(
            ...
            new NonGenericTestOwnedNavigationSplitViewBuilder<TOwnerEntity, TDependentEntity>(
                tableBuilder
            );
    ...
    public class GenericTestViewColumnBuilder<TProperty>
        : TestViewColumnBuilder<TProperty>,
            IInfrastructure<ViewColumnBuilder<TProperty>>
    {
        ...
        protected virtual TestViewColumnBuilder<TProperty> Wrap(
            ViewColumnBuilder<TProperty> columnBuilder
    ...
    public class NonGenericTestViewColumnBuilder<TProperty>
        : TestViewColumnBuilder<TProperty>,
            IInfrastructure<ViewColumnBuilder>
    {
        ...
        ViewColumnBuilder IInfrastructure<ViewColumnBuilder>.Instance => ViewColumnBuilder;

        protected virtual TestViewColumnBuilder<TProperty> Wrap(
            ViewColumnBuilder viewColumnBuilder
    ...
    public abstract class TestStoredProcedureBuilder<TEntity> where TEntity : class
    {
        ...
        public abstract TestStoredProcedureBuilder<TEntity> HasResultColumn(string propertyName);
        ...
        public abstract TestStoredProcedureBuilder<TEntity> HasRowsAffectedReturnValue(
            bool rowsAffectedReturned = true
        );

        public abstract TestStoredProcedureBuilder<TEntity> HasAnnotation(
            string annotation,
            object? value
        );
    }
            ...
            IInfrastructure<StoredProcedureBuilder<TEntity>> where TEntity : class
    {
        ...
        protected virtual TestStoredProcedureBuilder<TEntity> Wrap(
            StoredProcedureBuilder<TEntity> storedProcedureBuilder
        ) => new GenericTestStoredProcedureBuilder<TEntity>(storedProcedureBuilder);

        public override TestStoredProcedureBuilder<TEntity> HasParameter(string propertyName) =>
        ...
        public override TestStoredProcedureBuilder<TEntity> HasResultColumn(string propertyName) =>
        ...
        public override TestStoredProcedureBuilder<TEntity> HasRowsAffectedReturnValue(
            bool rowsAffectedReturned
        ) => Wrap(StoredProcedureBuilder.HasRowsAffectedReturnValue(rowsAffectedReturned));

        public override TestStoredProcedureBuilder<TEntity> HasAnnotation(
            string annotation,
            object? value
        ...
        where TDependentEntity : class
    {
        ...
        private OwnedNavigationStoredProcedureBuilder<
            TOwnerEntity,
            TDependentEntity
        > StoredProcedureBuilder { get; }

        OwnedNavigationStoredProcedureBuilder<TOwnerEntity, TDependentEntity> IInfrastructure<
            OwnedNavigationStoredProcedureBuilder<TOwnerEntity, TDependentEntity>
        >.Instance => StoredProcedureBuilder;

        protected virtual TestOwnedNavigationStoredProcedureBuilder<
            TOwnerEntity,
            TDependentEntity
        > Wrap(
            OwnedNavigationStoredProcedureBuilder<
            ...
            new GenericTestOwnedNavigationStoredProcedureBuilder<TOwnerEntity, TDependentEntity>(
                storedProcedureBuilder
            );

        public override TestOwnedNavigationStoredProcedureBuilder<
            TOwnerEntity,
            TDependentEntity
        > HasParameter(string propertyName) =>
            Wrap(StoredProcedureBuilder.HasParameter(propertyName));
        ...
        public override TestOwnedNavigationStoredProcedureBuilder<
            TOwnerEntity,
            TDependentEntity
        > HasRowsAffectedParameter() => Wrap(StoredProcedureBuilder.HasRowsAffectedParameter());
        ...
        public override TestOwnedNavigationStoredProcedureBuilder<
            TOwnerEntity,
            TDependentEntity
        > HasRowsAffectedReturnValue(bool rowsAffectedReturned) =>
            Wrap(StoredProcedureBuilder.HasRowsAffectedReturnValue(rowsAffectedReturned));
    ...
    public class NonGenericTestOwnedNavigationStoredProcedureBuilder<TOwnerEntity, TDependentEntity>
        ...
        where TDependentEntity : class
    {
        public NonGenericTestOwnedNavigationStoredProcedureBuilder(
        ...
        > Wrap(OwnedNavigationStoredProcedureBuilder storedProcedureBuilder) =>
            new NonGenericTestOwnedNavigationStoredProcedureBuilder<TOwnerEntity, TDependentEntity>(
                storedProcedureBuilder
            );
    ...
    public class TestStoredProcedureParameterBuilder
        : IInfrastructure<StoredProcedureParameterBuilder>
    {
        public TestStoredProcedureParameterBuilder(
        ...
        protected virtual TestStoredProcedureParameterBuilder Wrap(
            StoredProcedureParameterBuilder storedProcedureParameterBuilder
    ...
    public class TestStoredProcedureResultColumnBuilder
        : IInfrastructure<StoredProcedureResultColumnBuilder>
    {
        public TestStoredProcedureResultColumnBuilder(
        ...
        protected virtual TestStoredProcedureResultColumnBuilder Wrap(
            StoredProcedureResultColumnBuilder storedProcedureResultColumnBuilder
    ...
    public class NonGenericTestTriggerBuilder
        : TestTriggerBuilder,
            IInfrastructure<TableTriggerBuilder>
    {
        ...
        TableTriggerBuilder IInfrastructure<TableTriggerBuilder>.Instance => TriggerBuilder;
