...
public static class RelationalTestModelBuilderExtensions
{
        ...
        where TEntity : class
    {
        ...
        {
            case IInfrastructure<EntityTypeBuilder<TEntity>> genericBuilder:
                genericBuilder.Instance.ToTable(b =>
                    buildAction(new RelationalModelBuilderTest.GenericTestTableBuilder<TEntity>(b))
                );
                break;
            case IInfrastructure<EntityTypeBuilder> nonGenericBuilder:
                nonGenericBuilder.Instance.ToTable(b =>
                    buildAction(
        ...
        where TEntity : class
    {
        ...
        {
            case IInfrastructure<EntityTypeBuilder<TEntity>> genericBuilder:
                genericBuilder.Instance.ToTable(name, b =>
                    buildAction(new RelationalModelBuilderTest.GenericTestTableBuilder<TEntity>(b))
                );
                break;
            case IInfrastructure<EntityTypeBuilder> nonGenericBuilder:
                nonGenericBuilder.Instance.ToTable(name, b =>
                    buildAction(
                        new RelationalModelBuilderTest.NonGenericTestTableBuilder<TEntity>(b)
                    )
                );
        ...
        where TEntity : class
    {
        ...
        {
            case IInfrastructure<EntityTypeBuilder<TEntity>> genericBuilder:
                genericBuilder.Instance.ToTable(name, schema, b =>
                    buildAction(new RelationalModelBuilderTest.GenericTestTableBuilder<TEntity>(b))
                );
                break;
            case IInfrastructure<EntityTypeBuilder> nonGenericBuilder:
                nonGenericBuilder.Instance.ToTable(name, schema, b =>
                    buildAction(
                        new RelationalModelBuilderTest.NonGenericTestTableBuilder<TEntity>(b)
                    )
                );
    ...
    public static ModelBuilderTest.TestOwnedNavigationBuilder<
        TOwnerEntity,
        TDependentEntity
    > ToTable<TOwnerEntity, TDependentEntity>(
    ...
    > ToTable<TOwnerEntity, TDependentEntity>(
        this ModelBuilderTest.TestOwnedNavigationBuilder<TOwnerEntity, TDependentEntity> builder,
        Action<RelationalModelBuilderTest.TestOwnedNavigationTableBuilder<
            TOwnerEntity,
            TDependentEntity
        >> buildAction
    )
        ...
        where TDependentEntity : class
    {
        switch (builder)
        {
            ...
            > genericBuilder:
                genericBuilder.Instance.ToTable(b =>
                    buildAction(
                        new RelationalModelBuilderTest.GenericTestOwnedNavigationTableBuilder<
                            TOwnerEntity,
                            TDependentEntity
                        >(b)
                    )
            ...
            case IInfrastructure<OwnedNavigationBuilder> nonGenericBuilder:
                nonGenericBuilder.Instance.ToTable(b =>
                    buildAction(
                        new RelationalModelBuilderTest.NonGenericTestOwnedNavigationTableBuilder<
                            TOwnerEntity,
                            TDependentEntity
                        >(b)
                    )
        ...
        where TEntity : class
    {
        ...
        {
            case IInfrastructure<EntityTypeBuilder<TEntity>> genericBuilder:
                genericBuilder.Instance.SplitToTable(name, b =>
                    buildAction(
                        new RelationalModelBuilderTest.GenericTestSplitTableBuilder<TEntity>(b)
                    )
                );
                break;
            case IInfrastructure<EntityTypeBuilder> nonGenericBuilder:
                nonGenericBuilder.Instance.SplitToTable(name, b =>
                    buildAction(
                        new RelationalModelBuilderTest.NonGenericTestSplitTableBuilder<TEntity>(b)
                    )
                );
                break;
        }
        ...
        where TEntity : class
    {
        ...
        {
            case IInfrastructure<EntityTypeBuilder<TEntity>> genericBuilder:
                genericBuilder.Instance.SplitToTable(name, schema, b =>
                    buildAction(
                        new RelationalModelBuilderTest.GenericTestSplitTableBuilder<TEntity>(b)
                    )
                );
                break;
            case IInfrastructure<EntityTypeBuilder> nonGenericBuilder:
                nonGenericBuilder.Instance.SplitToTable(name, schema, b =>
                    buildAction(
                        new RelationalModelBuilderTest.NonGenericTestSplitTableBuilder<TEntity>(b)
                    )
                );
    ...
    public static ModelBuilderTest.TestOwnedNavigationBuilder<
        TOwnerEntity,
        TDependentEntity
    > SplitToTable<TOwnerEntity, TDependentEntity>(
        this ModelBuilderTest.TestOwnedNavigationBuilder<TOwnerEntity, TDependentEntity> builder,
        string name,
        Action<RelationalModelBuilderTest.TestOwnedNavigationSplitTableBuilder<
            TOwnerEntity,
            TDependentEntity
        >> buildAction
    )
        ...
        where TDependentEntity : class
    {
        switch (builder)
        {
            ...
            > genericBuilder:
                genericBuilder.Instance.SplitToTable(name, b =>
                    buildAction(
                        new RelationalModelBuilderTest.GenericTestOwnedNavigationSplitTableBuilder<
                            TOwnerEntity,
                            TDependentEntity
                        >(b)
                    )
            ...
            case IInfrastructure<OwnedNavigationBuilder> nonGenericBuilder:
                nonGenericBuilder.Instance.SplitToTable(name, b =>
                    buildAction(
                        new RelationalModelBuilderTest.NonGenericTestOwnedNavigationSplitTableBuilder<
                            TOwnerEntity,
                            TDependentEntity
                        >(b)
                    )
        ...
        where TEntity : class
    {
        ...
        {
            case IInfrastructure<EntityTypeBuilder<TEntity>> genericBuilder:
                genericBuilder.Instance.ToView(name, b =>
                    buildAction(new RelationalModelBuilderTest.GenericTestViewBuilder<TEntity>(b))
                );
                break;
            case IInfrastructure<EntityTypeBuilder> nonGenericBuilder:
                nonGenericBuilder.Instance.ToView(name, b =>
                    buildAction(
        ...
        where TEntity : class
    {
        ...
        {
            case IInfrastructure<EntityTypeBuilder<TEntity>> genericBuilder:
                genericBuilder.Instance.ToView(name, schema, b =>
                    buildAction(new RelationalModelBuilderTest.GenericTestViewBuilder<TEntity>(b))
                );
                break;
            case IInfrastructure<EntityTypeBuilder> nonGenericBuilder:
                nonGenericBuilder.Instance.ToView(name, schema, b =>
                    buildAction(
                        new RelationalModelBuilderTest.NonGenericTestViewBuilder<TEntity>(b)
                    )
                );
    ...
    public static ModelBuilderTest.TestOwnedNavigationBuilder<
        TOwnerEntity,
        TDependentEntity
    > ToView<TOwnerEntity, TDependentEntity>(
        this ModelBuilderTest.TestOwnedNavigationBuilder<TOwnerEntity, TDependentEntity> builder,
        string? name
    )
        where TOwnerEntity : class
    ...
    > ToView<TOwnerEntity, TDependentEntity>(
        this ModelBuilderTest.TestOwnedNavigationBuilder<TOwnerEntity, TDependentEntity> builder,
        string name,
        Action<RelationalModelBuilderTest.TestOwnedNavigationViewBuilder<
            TOwnerEntity,
            TDependentEntity
        >> buildAction
    )
        ...
        where TDependentEntity : class
    {
        switch (builder)
        {
            ...
            > genericBuilder:
                genericBuilder.Instance.ToView(name, b =>
                    buildAction(
                        new RelationalModelBuilderTest.GenericTestOwnedNavigationViewBuilder<
                            TOwnerEntity,
                            TDependentEntity
                        >(b)
                    )
            ...
            case IInfrastructure<OwnedNavigationBuilder> nonGenericBuilder:
                nonGenericBuilder.Instance.ToView(name, b =>
                    buildAction(
                        new RelationalModelBuilderTest.NonGenericTestOwnedNavigationViewBuilder<
                            TOwnerEntity,
                            TDependentEntity
                        >(b)
                    )
        ...
        where TEntity : class
    {
        ...
        {
            case IInfrastructure<EntityTypeBuilder<TEntity>> genericBuilder:
                genericBuilder.Instance.SplitToView(name, b =>
                    buildAction(
                ...
                break;
            case IInfrastructure<EntityTypeBuilder> nonGenericBuilder:
                nonGenericBuilder.Instance.SplitToView(name, b =>
                    buildAction(
        ...
        where TEntity : class
    {
        ...
        {
            case IInfrastructure<EntityTypeBuilder<TEntity>> genericBuilder:
                genericBuilder.Instance.SplitToView(name, schema, b =>
                    buildAction(
                        new RelationalModelBuilderTest.GenericTestSplitViewBuilder<TEntity>(b)
                    )
                );
                break;
            case IInfrastructure<EntityTypeBuilder> nonGenericBuilder:
                nonGenericBuilder.Instance.SplitToView(name, schema, b =>
                    buildAction(
                        new RelationalModelBuilderTest.NonGenericTestSplitViewBuilder<TEntity>(b)
                    )
                );
    ...
    public static ModelBuilderTest.TestOwnedNavigationBuilder<
        TOwnerEntity,
        TDependentEntity
    > SplitToView<TOwnerEntity, TDependentEntity>(
        this ModelBuilderTest.TestOwnedNavigationBuilder<TOwnerEntity, TDependentEntity> builder,
        string name,
        Action<RelationalModelBuilderTest.TestOwnedNavigationSplitViewBuilder<
            TOwnerEntity,
            TDependentEntity
        >> buildAction
    )
        ...
        where TDependentEntity : class
    {
        switch (builder)
        {
            ...
            > genericBuilder:
                genericBuilder.Instance.SplitToView(name, b =>
                    buildAction(
                        new RelationalModelBuilderTest.GenericTestOwnedNavigationSplitViewBuilder<
                            TOwnerEntity,
                            TDependentEntity
                        >(b)
                    )
            ...
            case IInfrastructure<OwnedNavigationBuilder> nonGenericBuilder:
                nonGenericBuilder.Instance.SplitToView(name, b =>
                    buildAction(
                        new RelationalModelBuilderTest.NonGenericTestOwnedNavigationSplitViewBuilder<
                            TOwnerEntity,
                            TDependentEntity
                        >(b)
                    )
        ...
        switch (builder)
        {
            case IInfrastructure<EntityTypeBuilder<TEntity>> genericBuilder:
                genericBuilder.Instance.UpdateUsingStoredProcedure(b =>
                    buildAction(
                        new RelationalModelBuilderTest.GenericTestStoredProcedureBuilder<TEntity>(b)
                    )
                );
                break;
            case IInfrastructure<EntityTypeBuilder> nonGenericBuilder:
                nonGenericBuilder.Instance.UpdateUsingStoredProcedure(b =>
                    buildAction(
                        new RelationalModelBuilderTest.NonGenericTestStoredProcedureBuilder<TEntity>(
                            b
                        )
                    )
                );
        ...
        where TEntity : class
    {
        ...
        {
            case IInfrastructure<EntityTypeBuilder<TEntity>> genericBuilder:
                genericBuilder.Instance.UpdateUsingStoredProcedure(name, b =>
                    buildAction(
                        new RelationalModelBuilderTest.GenericTestStoredProcedureBuilder<TEntity>(b)
                    )
                );
                break;
            case IInfrastructure<EntityTypeBuilder> nonGenericBuilder:
                nonGenericBuilder.Instance.UpdateUsingStoredProcedure(name, b =>
                    buildAction(
                        new RelationalModelBuilderTest.NonGenericTestStoredProcedureBuilder<TEntity>(
                            b
                        )
        ...
        where TEntity : class
    {
        ...
        {
            case IInfrastructure<EntityTypeBuilder<TEntity>> genericBuilder:
                genericBuilder.Instance.UpdateUsingStoredProcedure(name, schema, b =>
                    buildAction(
                        new RelationalModelBuilderTest.GenericTestStoredProcedureBuilder<TEntity>(b)
                    )
                );
                break;
            case IInfrastructure<EntityTypeBuilder> nonGenericBuilder:
                nonGenericBuilder.Instance.UpdateUsingStoredProcedure(name, schema, b =>
                    buildAction(
                        new RelationalModelBuilderTest.NonGenericTestStoredProcedureBuilder<TEntity>(
                            b
                        )
    ...
    public static ModelBuilderTest.TestOwnedNavigationBuilder<
        TOwnerEntity,
        TDependentEntity
    > UpdateUsingStoredProcedure<TOwnerEntity, TDependentEntity>(
        this ModelBuilderTest.TestOwnedNavigationBuilder<TOwnerEntity, TDependentEntity> builder,
        Action<RelationalModelBuilderTest.TestOwnedNavigationStoredProcedureBuilder<
            TOwnerEntity,
            TDependentEntity
        >> buildAction
    )
        ...
        where TDependentEntity : class
    {
        switch (builder)
        {
            ...
            > genericBuilder:
                genericBuilder.Instance.UpdateUsingStoredProcedure(b =>
                    buildAction(
                        new RelationalModelBuilderTest.GenericTestOwnedNavigationStoredProcedureBuilder<
                            TOwnerEntity,
                            TDependentEntity
                        >(b)
                    )
            ...
            case IInfrastructure<OwnedNavigationBuilder> nonGenericBuilder:
                nonGenericBuilder.Instance.UpdateUsingStoredProcedure(b =>
                    buildAction(
                        new RelationalModelBuilderTest.NonGenericTestOwnedNavigationStoredProcedureBuilder<
                            TOwnerEntity,
                            TDependentEntity
                        >(b)
                    )
        ...
        where TEntity : class
    {
        ...
        {
            case IInfrastructure<EntityTypeBuilder<TEntity>> genericBuilder:
                genericBuilder.Instance.InsertUsingStoredProcedure(name, b =>
                    buildAction(
                        new RelationalModelBuilderTest.GenericTestStoredProcedureBuilder<TEntity>(b)
                    )
                );
                break;
            case IInfrastructure<EntityTypeBuilder> nonGenericBuilder:
                nonGenericBuilder.Instance.InsertUsingStoredProcedure(name, b =>
                    buildAction(
                        new RelationalModelBuilderTest.NonGenericTestStoredProcedureBuilder<TEntity>(
                            b
                        )
        ...
        where TEntity : class
    {
        ...
        {
            case IInfrastructure<EntityTypeBuilder<TEntity>> genericBuilder:
                genericBuilder.Instance.InsertUsingStoredProcedure(name, schema, b =>
                    buildAction(
                        new RelationalModelBuilderTest.GenericTestStoredProcedureBuilder<TEntity>(b)
                    )
                );
                break;
            case IInfrastructure<EntityTypeBuilder> nonGenericBuilder:
                nonGenericBuilder.Instance.InsertUsingStoredProcedure(name, schema, b =>
                    buildAction(
                        new RelationalModelBuilderTest.NonGenericTestStoredProcedureBuilder<TEntity>(
                            b
                        )
    ...
    public static ModelBuilderTest.TestOwnedNavigationBuilder<
        TOwnerEntity,
        TDependentEntity
    > InsertUsingStoredProcedure<TOwnerEntity, TDependentEntity>(
        this ModelBuilderTest.TestOwnedNavigationBuilder<TOwnerEntity, TDependentEntity> builder,
        Action<RelationalModelBuilderTest.TestOwnedNavigationStoredProcedureBuilder<
            TOwnerEntity,
            TDependentEntity
        ...
        where TEntity : class
    {
        ...
        {
            case IInfrastructure<EntityTypeBuilder<TEntity>> genericBuilder:
                genericBuilder.Instance.DeleteUsingStoredProcedure(name, b =>
                    buildAction(
                        new RelationalModelBuilderTest.GenericTestStoredProcedureBuilder<TEntity>(b)
                    )
                );
                break;
            case IInfrastructure<EntityTypeBuilder> nonGenericBuilder:
                nonGenericBuilder.Instance.DeleteUsingStoredProcedure(name, b =>
                    buildAction(
                        new RelationalModelBuilderTest.NonGenericTestStoredProcedureBuilder<TEntity>(
                            b
                        )
        ...
        where TEntity : class
    {
        ...
        {
            case IInfrastructure<EntityTypeBuilder<TEntity>> genericBuilder:
                genericBuilder.Instance.DeleteUsingStoredProcedure(name, schema, b =>
                    buildAction(
                        new RelationalModelBuilderTest.GenericTestStoredProcedureBuilder<TEntity>(b)
                    )
                );
                break;
            case IInfrastructure<EntityTypeBuilder> nonGenericBuilder:
                nonGenericBuilder.Instance.DeleteUsingStoredProcedure(name, schema, b =>
                    buildAction(
                        new RelationalModelBuilderTest.NonGenericTestStoredProcedureBuilder<TEntity>(
                            b
                        )
    ...
    public static ModelBuilderTest.TestOwnedNavigationBuilder<
        TOwnerEntity,
        TDependentEntity
    > DeleteUsingStoredProcedure<TOwnerEntity, TDependentEntity>(
        this ModelBuilderTest.TestOwnedNavigationBuilder<TOwnerEntity, TDependentEntity> builder,
        Action<RelationalModelBuilderTest.TestOwnedNavigationStoredProcedureBuilder<
            TOwnerEntity,
            TDependentEntity
    ...
    public static ModelBuilderTest.TestOwnedNavigationBuilder<
        TOwnerEntity,
        TDependentEntity
    > ToJson<TOwnerEntity, TDependentEntity>(
        this ModelBuilderTest.TestOwnedNavigationBuilder<TOwnerEntity, TDependentEntity> builder
    )
        where TOwnerEntity : class
        where TDependentEntity : class
    ...
    public static ModelBuilderTest.TestOwnedNavigationBuilder<
        TOwnerEntity,
        TDependentEntity
    > HasJsonPropertyName<TOwnerEntity, TDependentEntity>(
        this ModelBuilderTest.TestOwnedNavigationBuilder<TOwnerEntity, TDependentEntity> builder,
        string? name
    )
        where TOwnerEntity : class
    ...
    public static ModelBuilderTest.TestOwnershipBuilder<
        TOwnerEntity,
        TDependentEntity
    > HasConstraintName<TOwnerEntity, TDependentEntity>(
        ...
        where TDependentEntity : class
    {
        ...
        {
            case IInfrastructure<
                ReferenceReferenceBuilder<TOwnerEntity, TDependentEntity>
            > genericBuilder:
                genericBuilder.Instance.HasConstraintName(name);
                break;
    ...
    public static ModelBuilderTest.TestReferenceCollectionBuilder<
        ...
        TDependentEntity
    > HasConstraintName<TOwnerEntity, TDependentEntity>(
        this ModelBuilderTest.TestReferenceCollectionBuilder<
            TOwnerEntity,
            TDependentEntity
        > builder,
        string name
        ...
        where TDependentEntity : class
    {
        ...
        {
            case IInfrastructure<
                ReferenceCollectionBuilder<TOwnerEntity, TDependentEntity>
            > genericBuilder:
                genericBuilder.Instance.HasConstraintName(name);
                break;
