        ...
        get
        {
            ...
            methods.Add(
                typeof(DbConnectionInterceptor).GetMethod(
                    nameof(DbConnectionInterceptor.ConnectionDisposedAsync)
                )
            );
            return methods;
        }
    ...
    public class RelationalApiConsistencyFixture : ApiConsistencyFixtureBase
    {
        ...
        > _metadataTypes =>
            new()
            {
                ...
                {
                    typeof(IReadOnlyStoredProcedureParameter),
                    (
                        typeof(IMutableStoredProcedureParameter),
                ...
                {
                    typeof(IReadOnlyStoredProcedureResultColumn),
                    (
                        typeof(IMutableStoredProcedureResultColumn),
        ...
        > MetadataExtensionTypes { get; } =
            new()
            {
                ...
                { typeof(IReadOnlyTypeBase), (null, null, null, null, null) },
                {
                    typeof(IReadOnlyKey),
                    (
                ...
                { typeof(IReadOnlyComplexProperty), (null, null, null, null, null) },
                {
        ...
        public override HashSet<MethodInfo> UnmatchedMetadataMethods { get; } =
            new()
            {
                ...
                typeof(RelationalPropertyExtensions).GetMethod(
                    ...
                    {
                        typeof(IReadOnlyProperty),
                        typeof(StoreObjectIdentifier).MakeByRefType(),
                    }
                ),
                typeof(RelationalPropertyExtensions).GetMethod(
                    ...
                    (typeTypes, methodTypes) =>
                        new[]
                        {
                            typeof(Expression<>).MakeGenericType(
                                typeof(Func<,>).MakeGenericType(methodTypes[0], methodTypes[1])
                            ),
                        }
                ),
                GetMethod(
        ...
        public override Dictionary<Type, HashSet<MethodInfo>> UnmatchedMirrorMethods { get; } =
            new()
            {
                {
                    ...
                    new HashSet<MethodInfo>
                    {
                        ...
                        typeof(PropertyBuilder).GetMethod(
                            ...
                            new[] { typeof(Func<IProperty, ITypeBase, ValueGenerator>) }
                        ),
                        typeof(PropertyBuilder).GetMethod(
                        ...
                        typeof(PropertyBuilder).GetMethod(
                            nameof(PropertyBuilder.HasConversion),
                            new[] { typeof(ValueComparer) }
                        ),
                        typeof(PropertyBuilder).GetMethod(
                            nameof(PropertyBuilder.HasConversion),
                            new[] { typeof(ValueConverter) }
                        ),
                        typeof(PropertyBuilder).GetMethod(
                            nameof(PropertyBuilder.HasConversion),
                            new[] { typeof(ValueComparer), typeof(ValueComparer) }
                        ),
                        typeof(PropertyBuilder).GetMethod(
                            nameof(PropertyBuilder.HasConversion),
                            new[] { typeof(Type), typeof(ValueComparer) }
                        ),
                        typeof(PropertyBuilder).GetMethod(
                            nameof(PropertyBuilder.HasConversion),
                        ...
                        typeof(PropertyBuilder).GetMethod(
                            nameof(PropertyBuilder.HasConversion),
                            new[] { typeof(ValueConverter), typeof(ValueComparer) }
                        ),
                        typeof(PropertyBuilder).GetMethod(
                            nameof(PropertyBuilder.HasConversion),
                            new[]
                ...
                },
                {
                    ...
                    {
                        typeof(PropertyBuilder<>).GetMethod(
                            nameof(PropertyBuilder<object>.HasPrecision),
                            new[] { typeof(int) }
                        ),
                        typeof(PropertyBuilder<>).GetMethod(
                            nameof(PropertyBuilder<object>.HasPrecision),
                        ...
                        typeof(PropertyBuilder<>).GetMethod(
                            nameof(PropertyBuilder<object>.HasValueGenerator),
                            new[] { typeof(Func<IProperty, ITypeBase, ValueGenerator>) }
                        ),
                        typeof(PropertyBuilder<>).GetMethod(
                            nameof(PropertyBuilder<object>.IsRowVersion),
                            Type.EmptyTypes
                        ),
                        GetMethod(
                            typeof(PropertyBuilder<>),
                        ...
                        GetMethod(
                            ...
                            (typeGenerics, methodGenerics) =>
                                (typeGenerics.Length < 1 || methodGenerics.Length < 1)
                                    ? new[] { typeof(Random) }
                                    : new[]
                                    {
                                        typeof(Expression<>).MakeGenericType(
        ...
        public override HashSet<MethodInfo> AsyncMethodExceptions { get; } =
            new()
            {
                ...
                typeof(IDbConnectionInterceptor).GetMethod(
                    nameof(IDbConnectionInterceptor.ConnectionDisposingAsync)
                ),
                typeof(IDbConnectionInterceptor).GetMethod(
                    nameof(IDbConnectionInterceptor.ConnectionDisposedAsync)
                ),
        ...
        public override HashSet<MethodInfo> MetadataMethodExceptions { get; } =
            new()
            {
                typeof(IMutableStoredProcedure).GetMethod(
                    nameof(IMutableStoredProcedure.AddParameter)
                ),
                typeof(IMutableStoredProcedure).GetMethod(
                    nameof(IMutableStoredProcedure.AddResultColumn)
                ),
            };
