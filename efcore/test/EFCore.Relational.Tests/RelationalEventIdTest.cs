        ...
        public void Every_eventId_has_a_logger_method_and_logs_when_level_enabled()
        {
            ...
            var fakeFactories = new Dictionary<Type, Func<object>>
            {
                ...
                { typeof(IMigrationsAssembly), () => new FakeMigrationsAssembly() },
                {
                    ...
                    () => Expression.Call(constantExpression, typeof(object).GetMethod("ToString"))
                },
                ...
                {
                    {
                        ...
                        new List<string>
                        {
                            ...
                            nameof(
                                IRelationalCommandDiagnosticsLogger.CommandNonQueryExecutingAsync
                            )
                        }
                    },
                    {
                        ...
                        new List<string>
                        {
                            ...
                            nameof(
                                IRelationalCommandDiagnosticsLogger.CommandNonQueryExecutedAsync
                            ),
