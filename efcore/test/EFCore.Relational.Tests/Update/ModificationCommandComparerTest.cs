...
namespace Microsoft.EntityFrameworkCore.Update
{
    public class ModificationCommandComparerTest
    {
        ...
        public void Compare_returns_0_only_for_commands_that_are_equal()
        {
            ...
            var modificationCommandAdded = new ModificationCommand(
                "A",
                null,
            ...
            var modificationCommandModified = new ModificationCommand(
                "A",
                null,
                new ParameterNameGenerator().GenerateNext,
                false,
            ...
            var modificationCommandDeleted = new ModificationCommand(
                "A",
                null,
                new ParameterNameGenerator().GenerateNext,
                false,
        ...
        )
        {
            ...
            var modificationCommand1 = new ModificationCommand(
                "A",
                null,
                new ParameterNameGenerator().GenerateNext,
                false,
            ...
            entry2.SetEntityState(EntityState.Modified);
            var modificationCommand2 = new ModificationCommand(
                "A",
                null,
                new ParameterNameGenerator().GenerateNext,
                false,
            ...
            var modificationCommand3 = new ModificationCommand(
                "A",
                null,
                new ParameterNameGenerator().GenerateNext,
                false,
