...
partial public class RelationalModelValidatorTest : ModelValidatorTest
{
    ...
    public virtual void Detects_tableless_entity_type_mapped_to_some_stored_procedures()
    {
        ...
        modelBuilder
            ...
            .UpdateUsingStoredProcedure(
                s => s.HasOriginalValueParameter(c => c.Id).HasParameter(c => c.Name)
            )
            .Property(a => a.Id)
            .ValueGeneratedNever();
    ...
    public virtual void Detects_non_key_delete_stored_procedure_params_in_TPH()
    {
        ...
        modelBuilder
            .Entity<Animal>()
            .DeleteUsingStoredProcedure(
                s => s.HasOriginalValueParameter(a => a.Id).HasOriginalValueParameter(a => a.Name)
            )
            .Property(a => a.Name)
            .ValueGeneratedOnUpdate();
    ...
    public virtual void Detects_non_generated_update_stored_procedure_result_columns_in_TPT()
    {
        ...
        modelBuilder
            ...
            .Ignore(a => a.FavoritePerson)
            .UpdateUsingStoredProcedure(
                s => s.HasOriginalValueParameter(a => a.Id).HasParameter(a => a.Name)
            )
    ...
    public virtual void Detects_original_value_parameter_on_insert_stored_procedure()
    {
        ...
        modelBuilder
            .Entity<Animal>()
            .InsertUsingStoredProcedure(
                s => s.HasParameter(a => a.Id).HasOriginalValueParameter(a => a.Name)
            );
