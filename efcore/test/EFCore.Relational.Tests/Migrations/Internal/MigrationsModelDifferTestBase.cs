...
namespace Microsoft.EntityFrameworkCore.Migrations.Internal
{
    public abstract class MigrationsModelDifferTestBase
    {
        ...
        protected void Execute(
            ...
            var sourceOptionsBuilder = TestHelpers.AddProviderOptions(new DbContextOptionsBuilder())
            ...
            var targetOptionsBuilder = TestHelpers.AddProviderOptions(new DbContextOptionsBuilder())
