...
#pragma warning disable CS0618 // Type or member is obsolete
                modelBuilder =>
                    modelBuilder.Entity<TestKeylessType>()
                        .HasNoKey()
                        .ToQuery(
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        public void Model_differ_breaks_foreign_key_cycles_in_drop_table_operations()
        {
            Execute(
                modelBuilder =>
                {
                    ...
                    modelBuilder.Entity("Third")
                        .HasOne("Fourth")
                        .WithMany()
                        .HasForeignKey("FourthId");
                    modelBuilder.Entity("Fourth")
                        .HasOne("Third")
                        .WithMany()
        ...
        public void Model_differ_breaks_double_foreign_key_cycles_in_create_table_operations()
        {
            Execute(
                ...
                modelBuilder =>
                {
                    ...
                    modelBuilder.Entity("BankRegistrations")
                        .HasOne("Banks")
                        .WithMany()
                        .HasForeignKey("BankId");

                    modelBuilder.Entity("BankProfiles")
                        .HasOne("Banks")
                        .WithMany()
                        .HasForeignKey("BankId");
        ...
        public void Create_table_columns_uses_principal_to_dependent_order_when_splitting()
        {
            Execute(
                _ => { },
                modelBuilder =>
                    modelBuilder.Entity<CreateTableEntity2B>()
        ...
        public void Create_sequence()
        {
            Execute(
                _ => { },
                modelBuilder =>
                    modelBuilder.HasSequence<int>("Tango", "dbo")
                        .StartsAt(2)
                        .IncrementsBy(3)
                        .HasMin(1)
                        .HasMax(4)
        ...
        public void Alter_sequence_increment_by()
        {
            Execute(
                source =>
                    source.HasSequence<int>("Alpha", "dbo")
                        .StartsAt(2)
                        .IncrementsBy(3)
                        .HasMin(1)
                        .HasMax(4)
        ...
        public void Alter_sequence_max_value()
        {
            Execute(
                source =>
                    source.HasSequence<int>("Echo", "dbo")
                        .StartsAt(2)
                        .IncrementsBy(3)
                        .HasMin(1)
                        .HasMax(4)
        ...
        public void Alter_sequence_min_value()
        {
            Execute(
                source =>
                    source.HasSequence<int>("Delta", "dbo")
                        .StartsAt(2)
                        .IncrementsBy(3)
                        .HasMin(1)
                        .HasMax(4)
        ...
        public void Alter_sequence_cycle()
        {
            Execute(
                source =>
                    source.HasSequence<int>("Foxtrot", "dbo")
                        .StartsAt(2)
                        .IncrementsBy(3)
                        .HasMin(1)
                        .HasMax(4)
        ...
        public void Alter_sequence_type()
        {
            Execute(
                source =>
                    source.HasSequence<int>("Hotel", "dbo")
                        .StartsAt(2)
                        .IncrementsBy(3)
                        .HasMin(1)
                        .HasMax(4)
                        .IsCyclic(),
                source =>
                    source.HasSequence<long>("Hotel", "dbo")
                        .StartsAt(2)
                        .IncrementsBy(3)
                        .HasMin(1)
                        .HasMax(4)
        ...
        public void Alter_sequence_start()
        {
            Execute(
                source =>
                    source.HasSequence<int>("Golf", "dbo")
                        .StartsAt(2)
                        .IncrementsBy(3)
                        .HasMin(1)
                        .HasMax(4)
        ...
        public void Add_shared_foreign_key_on_subtypes()
        {
            Execute(
                common =>
                {
                    ...
                    common.Entity("GameAnimal")
                        .HasBaseType("Animal")
                        .Property<int>("HunterId")
                        .HasColumnName("HunterId");
                    common.Entity("EndangeredAnimal")
                        .HasBaseType("Animal")
                        .Property<int>("HunterId")
                        .HasColumnName("HunterId");
                },
        ...
        public void Add_shared_property_with_foreign_key_on_subtypes()
        {
            Execute(
                ...
                target =>
                {
                    target.Entity("EndangeredAnimal")
                        .HasBaseType("Animal")
                        .Property<int>("HunterId")
                        .HasColumnName("HunterId");
                    target.Entity(
        ...
        public void Rename_primary_key_on_renamed_table()
        {
            Execute(
                ...
                operations =>
                {
                    ...
                    var dropPrimaryKeyOperation = Assert.IsType<DropPrimaryKeyOperation>(
                        operations[0]
                    );
                    ...
                    var addPrimaryKeyOperation = Assert.IsType<AddPrimaryKeyOperation>(
                        operations[3]
                    );
        ...
        public void Add_alternate_key_to_renamed_column()
        {
            Execute(
                ...
                operations =>
                {
                    ...
                    Assert.Equal(
                        new[] { "RenamedAlternateId" },
                        addUniqueConstraintOperation.Columns
                    );
        ...
        public void Alter_renamed_sequence()
        {
            Execute(
                ...
                operations =>
                {
                    ...
                    var alterSequenceOperation = Assert.IsType<AlterSequenceOperation>(
                        operations[2]
                    );
        ...
        public void Drop_foreign_key_on_renamed_table()
        {
            Execute(
                ...
                operations =>
                {
                    ...
                    Assert.Equal(
                        "FK_Table_ReferencedTable_ForeignId",
                        dropForeignKeyOperation.Name
                    );
        ...
        public void Drop_alternate_key_on_renamed_table()
        {
            Execute(
                ...
                operations =>
                {
                    ...
                    var dropUniqueConstraintOperation =
                        Assert.IsType<DropUniqueConstraintOperation>(operations[0]);
        ...
        public void Restart_renamed_sequence()
        {
            Execute(
                ...
                operations =>
                {
                    ...
                    var alterSequenceOperation = Assert.IsType<RestartSequenceOperation>(
                        operations[2]
                    );
                    Assert.Equal("new", alterSequenceOperation.Schema);
                    Assert.Equal("Sequence", alterSequenceOperation.Name);
        ...
        protected class SomeEntity
        {
            ...
            public virtual SomeOwnedEntity OwnedEntity { get; private set; } =
                new SomeOwnedEntity();
        ...
        public void Add_property_on_owned_type()
        {
            Execute(
                ...
                downOperations =>
                {
                    var operation = Assert.IsType<DropColumnOperation>(
            ...
            Execute(
                common =>
                    common.Entity<OldOrder>(
                        ...
                        .ToTable("OldOrder"),
                source =>
                    source.Entity<OldOrder>(x => { }).Entity<Address>().Property<int>("OldZip"),
                target =>
                    target.Entity<OldOrder>(x => x.Property<int>("NotZip"))
                        .Entity<Address>()
                        .Property<int>("NewZip"),
                operations =>
                {
        ...
        public void Rename_property_on_subtype_and_add_similar_to_base()
        {
            Execute(
                source =>
                    source.Entity("AddressBase", x => x.Property<int>("Id"))
                        .Entity("Address")
