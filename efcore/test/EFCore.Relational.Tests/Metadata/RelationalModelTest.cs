...
namespace Microsoft.EntityFrameworkCore.Metadata
{
    public class RelationalModelTest
    {
        ...
        private static void AssertDefaultMappings(IRelationalModel model)
        {
            ...
            var specialityColumn = specialCustomerTable.Columns
                .Single(c => c.Name == nameof(SpecialCustomer.Speciality));
            Assert.Equal(
            ...
            if (mapping == Mapping.TPT)
            {
                ...
                Assert.True(
                    specialCustomerView.EntityTypeMappings
                        .Single(m => m.EntityType == specialCustomerType).IsSharedTablePrincipal
                );

                var specialityColumn = specialCustomerView.Columns
                    .Single(c => c.Name == nameof(SpecialCustomer.Speciality));
...
#pragma warning restore CS0618 // Type or member is obsolete
            ...
            if (mapping == Mapping.TPT)
            {
                ...
                var specialCustomerUniqueConstraint = customerTable.UniqueConstraints
            ...
            else
            {
                ...
                var anotherSpecialCustomerFkConstraint = specialCustomerTable.ForeignKeyConstraints
                    .First();
                Assert.Equal(
