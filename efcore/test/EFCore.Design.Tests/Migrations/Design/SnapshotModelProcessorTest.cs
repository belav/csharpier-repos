...
namespace Microsoft.EntityFrameworkCore.Migrations.Internal
{
    public class SnapshotModelProcessorTest
    {
        ...
        public void Can_resolve_ISnapshotModelProcessor_from_DI()
        {
            ...
            var snapshotModelProcessor = new DesignTimeServicesBuilder(
                assembly,
                assembly,
        ...
        public void Sets_owned_type_keys()
        {
            ...
            Assert.Equal(
                ...
                model.FindEntityType(typeof(Blog))
        ...
        public void Can_diff_against_older_ownership_model(Type snapshotType)
        {
            ...
            var reporter = new TestOperationReporter();
            var modelRuntimeInitializer = SqlServerTestHelpers.Instance.CreateContextServices()
        ...
        public void Can_diff_against_older_sequence_model(Type snapshotType)
        {
            ...
            var snapshot = (ModelSnapshot)Activator.CreateInstance(snapshotType);
            var reporter = new TestOperationReporter();
            var setBuilder = SqlServerTestHelpers.Instance.CreateContextServices()
                .GetRequiredService<IModelRuntimeInitializer>();
        ...
        {
            foreach (
                var annotationName in GetAnnotationNames()
                    .Where(
                        a =>
                            a != RelationalAnnotationNames.MaxIdentifierLength
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        private static IEnumerable<string> GetAnnotationNames() =>
            typeof(RelationalAnnotationNames).GetTypeInfo()
                .GetRuntimeFields()
...
#pragma warning disable 612, 618
                modelBuilder.HasAnnotation("ProductVersion", "2.0.3-rtm-10026")
                    .HasAnnotation(
...
#pragma warning restore 612, 618
        ...
        private class OwnershipModelSnapshot2_1 : ModelSnapshot
        {
            ...
            {
#pragma warning disable 612, 618
                modelBuilder.HasAnnotation("ProductVersion", "2.1.11-servicing-32099")
                    ...
                    b =>
                    {
                        b.OwnsOne(
                            ...
                            b1 =>
                            {
                                ...
                                b1.WithOwner().HasForeignKey("OwningType1Id");
                                ...
                                b1.OwnsOne(
                                    ...
                                    b2 =>
                                    {
                                        ...
                                        b2.Property<int>("Value").HasColumnType("int");

                                        b2.HasKey("OwnedTypeOwningType1Id");

                                        b2.ToTable("OwningType1");

                                        b2.WithOwner().HasForeignKey("OwnedTypeOwningType1Id");
                                    }
                                );
                    ...
                    b =>
                    {
                        b.OwnsOne(
                            ...
                            b1 =>
                            {
                                ...
                                b1.WithOwner().HasForeignKey("OwningType2Id");
                                ...
                                b1.OwnsOne(
                                    ...
                                    b2 =>
                                    {
                                        ...
                                        b2.WithOwner().HasForeignKey("OwnedTypeOwningType2Id");
                                    }
                                );
...
#pragma warning restore 612, 618
        ...
        private class SequenceModelSnapshot1_1 : ModelSnapshot
        {
            protected override void BuildModel(ModelBuilder modelBuilder)
            {
                modelBuilder.HasAnnotation("ChangeDetector.SkipDetectChanges", "true")
                    .HasAnnotation("ProductVersion", "1.1.6")
                    .HasAnnotation(
                        "Relational:Sequence:Bar.Foo",
                        "'Foo', 'Bar', '2', '2', '1', '3', 'Int32', 'True'"
                    )
                    .HasAnnotation(
                        "SqlServer:ValueGenerationStrategy",
                        SqlServerValueGenerationStrategy.IdentityColumn
        ...
        private class SequenceContext : DbContext
        {
            protected override void OnConfiguring(DbContextOptionsBuilder options) =>
                options.UseSqlServer(
                    @"Data Source=(localdb)\MSSQLLocalDB;Initial Catalog=Ownership"
                );
