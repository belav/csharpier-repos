...
namespace Microsoft.EntityFrameworkCore
{
    public class ScaffoldingTypeMapperSqliteTest
    {
        ...
        {
            var mapping = CreateMapper()
                .FindMapping("binary(8)", keyOrIndex: false, rowVersion: true);
        ...
        {
            var mapping = CreateMapper()
                .FindMapping("char(200)", keyOrIndex: false, rowVersion: false);
        ...
        {
            var mapping = CreateMapper()
                .FindMapping("nchar(max)", keyOrIndex: true, rowVersion: false);
        ...
        {
            var mapping = CreateMapper()
                .FindMapping("nchar(200)", keyOrIndex: true, rowVersion: false);
        ...
        {
            var mapping = CreateMapper()
                .FindMapping("char(max)", keyOrIndex: true, rowVersion: false);
        ...
        {
            var mapping = CreateMapper()
                .FindMapping("char(200)", keyOrIndex: true, rowVersion: false);
        ...
        {
            var mapping = CreateMapper()
                .FindMapping("nchar(450)", keyOrIndex: true, rowVersion: false);
        ...
        {
            var mapping = CreateMapper()
                .FindMapping("char(900)", keyOrIndex: true, rowVersion: false);
        ...
        {
            var mapping = CreateMapper()
                .FindMapping("rowversion", keyOrIndex: false, rowVersion: true);
        ...
        {
            var mapping = CreateMapper()
                .FindMapping("decimal(18, 2)", isKeyOrIndex, rowVersion: false);
