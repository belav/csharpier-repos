            ...
            TestAsync(
                ...
                code =>
                {
                    ...
                    Assert.DoesNotContain(
                        "DbSet<Entity> Entity { get; set; } = null!;",
...
""",
        ...
        public Task IsRequired_is_generated_for_ref_property_without_nrt() =>
            TestAsync(
                ...
                {
                    Assert.Contains(
                        "Property(e => e.RequiredString).IsRequired()",
                        code.ContextFile.Code
                    );
        ...
        public Task ModelInDifferentNamespaceDbContext_works()
        {
            ...
            return TestAsync(
                ...
                code =>
                    Assert.Contains(
                        string.Concat("using ", modelGenerationOptions.ModelNamespace, ";"),
                        code.ContextFile.Code
                    ),
                model =>
                    Assert.NotNull(
        ...
        public Task ValueGenerated_works() =>
            TestAsync(
                ...
                {
                    Assert.Contains(
                        "Property(e => e.ValueGeneratedOnAdd).ValueGeneratedOnAdd()",
                        code.ContextFile.Code
                    );
                    Assert.Contains(
                        "Property(e => e.ValueGeneratedOnAddOrUpdate).ValueGeneratedOnAddOrUpdate()",
                        code.ContextFile.Code
                    );
                    Assert.Contains(
                        "Property(e => e.ConcurrencyToken).IsConcurrencyToken()",
                        code.ContextFile.Code
                    );
                    Assert.Contains(
                        "Property(e => e.ValueGeneratedOnUpdate).ValueGeneratedOnUpdate()",
                        code.ContextFile.Code
                    );
                    Assert.Contains(
                        "Property(e => e.ValueGeneratedNever).ValueGeneratedNever()",
                        code.ContextFile.Code
                    );
                },
                model =>
                {
                    ...
                    Assert.Equal(
                        ...
                        entity.GetProperty("ValueGeneratedOnAdd").ValueGenerated
                    );
                    Assert.Equal(
                        ValueGenerated.OnAddOrUpdate,
                        entity.GetProperty("ValueGeneratedOnAddOrUpdate").ValueGenerated
                    );
                    Assert.True(entity.GetProperty("ConcurrencyToken").IsConcurrencyToken);
                    Assert.Equal(
                        ValueGenerated.OnUpdate,
                        entity.GetProperty("ValueGeneratedOnUpdate").ValueGenerated
                    );
                    Assert.Equal(
                        ValueGenerated.Never,
                        entity.GetProperty("ValueGeneratedNever").ValueGenerated
                    );
                }
            );
        ...
        public Task HasPrecision_works() =>
            TestAsync(
                ...
                {
                    Assert.Contains(
                        "Property(e => e.HasPrecision).HasPrecision(12)",
                        code.ContextFile.Code
                    );
                    Assert.Contains(
                        "Property(e => e.HasPrecisionAndScale).HasPrecision(14, 7)",
                        code.ContextFile.Code
                    );
                },
                model =>
        ...
        public Task Collation_works() =>
            TestAsync(
                modelBuilder =>
                    modelBuilder
                        .Entity("Entity")
                        .Property<string>("UseCollation")
                        .UseCollation("Some Collation"),
                new ModelCodeGenerationOptions(),
                code =>
                    Assert.Contains(
                        "Property(e => e.UseCollation).UseCollation(\"Some Collation\")",
                        code.ContextFile.Code
                    ),
                model =>
                {
                    ...
                    Assert.Equal(
                        "Some Collation",
                        entity.GetProperty("UseCollation").GetCollation()
                    );
                }
            );
        ...
        public Task ComputedColumnSql_works() =>
            TestAsync(
                modelBuilder =>
                    modelBuilder
                        .Entity("Entity")
                        .Property<string>("ComputedColumn")
                        .HasComputedColumnSql("1 + 2"),
                new ModelCodeGenerationOptions(),
                ...
                model =>
                {
                    ...
                    Assert.Equal(
                        "1 + 2",
                        entity.GetProperty("ComputedColumn").GetComputedColumnSql()
                    );
                }
            );
            ...
            TestAsync(
                serviceProvider =>
                    serviceProvider
                        ...
                        .Create(
                            BuildModelWithColumn("nvarchar(max)", null, "Hot"),
                ...
                {
                    var property = model
                        .FindEntityType("TestNamespace.Table")!
                        .GetProperty("Column");
            ...
            TestAsync(
                serviceProvider =>
                    serviceProvider
                        .GetService<IScaffoldingModelFactory>()
                        .Create(
                            BuildModelWithColumn("nvarchar(max)", "('Hot')", null),
                            new ModelReverseEngineerOptions()
                        ),
                new ModelCodeGenerationOptions(),
            ...
            TestAsync(
                serviceProvider =>
                    serviceProvider
                        .GetService<IScaffoldingModelFactory>()
                        .Create(
                            BuildModelWithColumn("nvarchar(max)", "('Hot')", "Hot"),
                            new ModelReverseEngineerOptions()
                        ),
                new ModelCodeGenerationOptions(),
                code => Assert.Contains(".HasDefaultValue(\"Hot\")", code.ContextFile.Code),
        ...
        public Task IsUnicode_works() =>
            TestAsync(
                modelBuilder =>
                {
                    ...
                    modelBuilder
                        .Entity("Entity")
                        .Property<string>("NonUnicodeColumn")
                        .IsUnicode(false);
                },
                new ModelCodeGenerationOptions(),
                code =>
                {
                    Assert.Contains(
                        "Property(e => e.UnicodeColumn).IsUnicode()",
                        code.ContextFile.Code
                    );
                    Assert.Contains(
                        "Property(e => e.NonUnicodeColumn).IsUnicode(false)",
                        code.ContextFile.Code
                    );
                },
                model =>
        ...
        public Task DefaultValue_works_unspecified() =>
            TestAsync(
                modelBuilder =>
                    modelBuilder
                        .Entity("Entity")
                        .Property<string>("DefaultedColumn")
                        .HasDefaultValue(),
                new ModelCodeGenerationOptions(),
                ...
                model =>
                {
                    ...
                    Assert.Equal(
                        DBNull.Value,
                        entity.GetProperty("DefaultedColumn").GetDefaultValue()
                    );
                }
            );
...
""",
                ...
                model =>
                    Assert.Equal(
                        2,
                        model.FindEntityType("TestNamespace.EntityWithIndexes").GetIndexes().Count()
                    )
            );
        ...
        public Task Global_namespace_works_just_context() =>
            TestAsync(
                ...
                code =>
                {
                    ...
                    Assert.Contains(
                        "namespace TestNamespace",
                        Assert.Single(code.AdditionalFiles).Code
                    );
                },
                model =>
                {
...
""",
        ...
        public Task ColumnOrder_is_ignored(bool useDataAnnotations) =>
            TestAsync(
                modelBuilder =>
                    modelBuilder.Entity("Entity").Property<string>("Property").HasColumnOrder(1),
        ...
        protected override void AddScaffoldingServices(IServiceCollection services) =>
            services.Replace(
                ServiceDescriptor.Singleton<
                    ...
                    TestModelAnnotationCodeGenerator
                >()
            );
        ...
        private class TestModelAnnotationCodeGenerator : SqlServerAnnotationCodeGenerator
        {
            private static readonly MethodInfo _testFluentApiCallMethodInfo =
                typeof(TestModelBuilderExtensions).GetRuntimeMethod(
                    nameof(TestModelBuilderExtensions.TestFluentApiCall),
        ...
        private class TestCodeGeneratorPlugin : ProviderCodeGeneratorPlugin
        {
            ...
            public static SqlServerDbContextOptionsBuilder SetContextOption(
