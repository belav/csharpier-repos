...
",
        ...
        private class FullyQualifiedCSharpHelper : CSharpHelper
        {
            ...
            public override bool ShouldUseFullName(Type type) => base.ShouldUseFullName(type);
...
",
                ...
                model =>
                {
                    ...
                    Assert.IsType<CastingConverter<Point, Point>>(
                        principalAlternateId.GetValueConverter()
                    );
                    Assert.IsType<CustomValueComparer<Point>>(
                        principalAlternateId.GetValueComparer()
                    );
                    Assert.IsType<CustomValueComparer<Point>>(
                        principalAlternateId.GetKeyValueComparer()
                    );
                    Assert.IsType<CustomValueComparer<Point>>(
                        principalAlternateId.GetProviderValueComparer()
                    );
                    Assert.Equal(
                        SqlServerValueGenerationStrategy.None,
                        principalAlternateId.GetValueGenerationStrategy()
                    );
                    Assert.Equal(
                    ...
                    Assert.Equal(
                        new[] { compositeIndex, alternateIndex },
...
namespace Microsoft.EntityFrameworkCore.Scaffolding.TestModel.Internal
{
    ...
    public class SelfReferentialDbContext : ContextBase
    {
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Scaffolding.Internal.SelfReferentialEntity>(eb =>
            {
    ...
    public class SelfReferentialPropertyValueConverter
        : ValueConverter<Scaffolding.Internal.SelfReferentialProperty, string>
    {
