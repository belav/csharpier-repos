...
public class GlobalNamespaceContext
    : Microsoft.EntityFrameworkCore.Scaffolding.Internal.CSharpRuntimeModelCodeGeneratorTest.ContextBase
{
...
",
                ...
                model =>
                {
                    ...
                    Assert.Equal(
                        typeof(EntityFrameworkCore.DbContext),
                        ownedServiceProperty.ClrType
                    );
                    Assert.Equal(
                        typeof(EntityFrameworkCore.DbContext),
                        ownedServiceProperty.PropertyInfo.PropertyType
                    );
                    ...
                    Assert.Equal(
                        typeof(EntityFrameworkCore.DbContext),
                        ownedServicePropertyBinding.ServiceType
                    );
                    Assert.Equal(
...
",
                ...
                model =>
                {
                    ...
                    var getData = model.FindDbFunction(
                        typeof(DbFunctionContext).GetMethod("GetData", new Type[] { typeof(int) })
                    );
