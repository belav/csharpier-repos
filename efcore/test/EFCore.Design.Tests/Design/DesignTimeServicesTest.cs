...
",
            ...
            Assert.Equal(
                ...
                serviceProvider
                    .GetRequiredService<CSharpMigrationsGeneratorDependencies>()
                    .GetType()
            );
            Assert.Equal(
            ...
            Assert.Equal(
                typeof(CSharpModelGenerator),
                serviceProvider.GetRequiredService<IModelCodeGenerator>().GetType()
            );
            Assert.Equal(
        ...
        public class ExtensionProviderConfigurationCodeGenerator
            : IProviderConfigurationCodeGenerator
        {
