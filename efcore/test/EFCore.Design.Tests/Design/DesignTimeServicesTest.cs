...
",
            ...
            Assert.Equal(
                "HumanizerPluralizer",
                serviceProvider.GetRequiredService<IPluralizer>().GetType().Name
            );
            ...
            Assert.Equal(
                ...
                serviceProvider.GetRequiredService<IEnumerable<IProviderCodeGeneratorPlugin>>()
                    .Single()
                    .GetType()
            );
            ...
            Assert.Equal(
                ...
                serviceProvider.GetRequiredService<IProviderConfigurationCodeGenerator>()
                    .GetType().Name
            );
        }
