    ...
    : ApiConsistencyTestBase<DesignApiConsistencyTest.DesignApiConsistencyFixture>
{
    ...
    public class DesignApiConsistencyFixture : ApiConsistencyFixtureBase
    {
        public override HashSet<Type> FluentApiTypes { get; } =
            new() { typeof(DesignTimeServiceCollectionExtensions) };
        ...
        public override HashSet<MethodInfo> NonVirtualMethods { get; } =
            new()
            {
                typeof(CSharpEntityTypeGeneratorBase.ToStringInstanceHelper)
                    .GetProperty(
                        nameof(CSharpEntityTypeGeneratorBase.ToStringInstanceHelper.FormatProvider)
                    )
                    .GetMethod,
                typeof(CSharpEntityTypeGeneratorBase.ToStringInstanceHelper)
                    .GetProperty(
                ...
                typeof(CSharpDbContextGeneratorBase.ToStringInstanceHelper)
                    .GetProperty(
                        nameof(CSharpDbContextGeneratorBase.ToStringInstanceHelper.FormatProvider)
                    )
                    .GetMethod,
                typeof(CSharpDbContextGeneratorBase.ToStringInstanceHelper)
                    .GetProperty(
