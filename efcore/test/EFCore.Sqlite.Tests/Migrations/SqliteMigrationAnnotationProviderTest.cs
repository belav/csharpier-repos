...
{
    private readonly TestHelpers.TestModelBuilder _modelBuilder = SqliteTestHelpers.Instance
    ...
    public void Does_not_add_Autoincrement_for_OnAdd_integer_property_non_key()
    {
        var property = (IProperty)
            _modelBuilder.Entity<Entity>().Property(e => e.IntProp).ValueGeneratedOnAdd().Metadata;
        FinalizeModel();
    ...
    {
        var property = (IProperty)
            _modelBuilder.Entity<Entity>().Property(e => e.IntProp).ValueGeneratedNever().Metadata;
        FinalizeModel();
    ...
    private IModel FinalizeModel() => _modelBuilder.FinalizeModel();
