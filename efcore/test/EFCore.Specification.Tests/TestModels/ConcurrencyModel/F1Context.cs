...
public class F1Context : PoolableDbContext
{
    ...
    {
        foreach (
            var engineSupplier in new List<EngineSupplier>
            {
                new() { Name = "Mercedes" },
                new() { Name = "Renault" },
                new() { Name = "Ferrari" },
        ...
        context.AddRange(
            new SuperFan
            {
                Id = 1,
                Name = "Alice",
                Swag = new() { Stuff = "SuperStuff" }
            },
            new MegaFan
            {
                Id = 2,
                Name = "Toast",
                Swag = new() { Stuff = "MegaStuff" }
            },
            new SuperFanTpt
            {
                Id = 1,
