    ...
    where TFixture : class, IQueryFixtureBase, new()
{
    ...
    protected Task AssertFirst<TResult>(
        ...
        Func<ISetSource, IQueryable<TResult>> expectedQuery,
        Action<TResult, TResult> asserter = null
    ) => QueryAsserter.AssertFirst(actualQuery, expectedQuery, asserter, async);
    ...
    protected Task AssertFirstOrDefault<TResult>(
        ...
        Action<TResult, TResult> asserter = null,
        int entryCount = 0
    ) => QueryAsserter.AssertFirstOrDefault(actualQuery, expectedQuery, asserter, async);
    ...
    protected Task AssertSingle<TResult>(
        ...
        Func<ISetSource, IQueryable<TResult>> expectedQuery,
        Action<TResult, TResult> asserter = null
    ) => QueryAsserter.AssertSingle(actualQuery, expectedQuery, asserter, async);
    ...
    protected Task AssertSingleOrDefault<TResult>(
        ...
        Func<ISetSource, IQueryable<TResult>> expectedQuery,
        Action<TResult, TResult> asserter = null
    ) => QueryAsserter.AssertSingleOrDefault(actualQuery, expectedQuery, asserter, async);
    ...
    protected Task AssertLast<TResult>(
        ...
        Func<ISetSource, IQueryable<TResult>> expectedQuery,
        Action<TResult, TResult> asserter = null
    ) => QueryAsserter.AssertLast(actualQuery, expectedQuery, asserter, async);
    ...
    protected Task AssertLastOrDefault<TResult>(
        ...
        Func<ISetSource, IQueryable<TResult>> expectedQuery,
        Action<TResult, TResult> asserter = null
    ) => QueryAsserter.AssertLastOrDefault(actualQuery, expectedQuery, asserter, async);
    ...
    protected Task AssertMin<TResult>(
        ...
        Func<ISetSource, IQueryable<TResult>> expectedQuery,
        Action<TResult, TResult> asserter = null
    ) => QueryAsserter.AssertMin(actualQuery, expectedQuery, asserter, async);
    ...
    protected Task AssertMax<TResult>(
        ...
        Func<ISetSource, IQueryable<TResult>> expectedQuery,
        Action<TResult, TResult> asserter = null
    ) => QueryAsserter.AssertMax(actualQuery, expectedQuery, asserter, async);
