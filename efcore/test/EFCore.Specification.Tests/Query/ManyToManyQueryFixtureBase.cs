...
public abstract class ManyToManyQueryFixtureBase
    : SharedStoreFixtureBase<ManyToManyContext>,
        IQueryFixtureBase
{
    protected override string StoreName => "ManyToManyQueryTest";
    ...
    public IReadOnlyDictionary<Type, object> EntitySorters { get; } =
        new Dictionary<Type, Func<object, object>>
        {
            ...
            { typeof(UnidirectionalEntityThree), e => ((UnidirectionalEntityThree)e)?.Id },
            {
                ...
                e =>
                    (
                        ((UnidirectionalEntityCompositeKey)e)?.Key1,
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder, DbContext context)
    {
        ...
        modelBuilder.Entity<UnidirectionalEntityOne>().HasMany(e => e.TwoSkipShared).WithMany();

        modelBuilder
            .Entity<UnidirectionalEntityBranch>()
        ...
        modelBuilder
            ...
            .UsingEntity<Dictionary<string, object>>(
                ...
                r =>
                    r.HasOne<UnidirectionalEntityThree>()
                        .WithMany(e => e.JoinOnePayloadFullShared)
                        .HasForeignKey("ThreeId"),
                l =>
                    l.HasOne<UnidirectionalEntityOne>()
                        .WithMany(e => e.JoinThreePayloadFullShared)
                        .HasForeignKey("OneId")
            )
            .IndexerProperty<string>("Payload");
