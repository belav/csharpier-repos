...
{
    protected SpatialQueryTestBase(TFixture fixture) : base(fixture) { }

    protected virtual bool AssertDistances => true;

    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual async Task SimpleSelect(bool async)
    {
        await AssertQuery(async, ss => ss.Set<PointEntity>());

        await AssertQuery(async, ss => ss.Set<LineStringEntity>());

        await AssertQuery(async, ss => ss.Set<PolygonEntity>());

        await AssertQuery(async, ss => ss.Set<MultiLineStringEntity>());
    }

    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task WithConversion(bool async) =>
        AssertQuery(async, ss => ss.Set<GeoPointEntity>());
        ...
        AssertQuery(
            ...
            ss =>
                ss.Set<PolygonEntity>()
                    .Select(
                        e => new { e.Id, Area = e.Polygon == null ? (double?)null : e.Polygon.Area }
                    ),
    ...
    public virtual Task AsBinary(bool async) =>
        AssertQuery(
            ...
            ss =>
                ss.Set<PointEntity>()
                    .Select(
                        e => new { e.Id, Binary = e.Point == null ? null : e.Point.AsBinary() }
                    ),
            elementSorter: x => x.Id,
            elementAsserter: (e, a) =>
            {
    ...
    public virtual Task AsText(bool async) =>
        AssertQuery(
            ...
            ss =>
                ss.Set<PointEntity>()
                    .Select(e => new { e.Id, Text = e.Point == null ? null : e.Point.AsText() }),
            elementSorter: x => x.Id,
            elementAsserter: (e, a) =>
            {
                Assert.Equal(e.Id, a.Id);
    ...
    public virtual Task Boundary(bool async) =>
        AssertQuery(
            ...
            ss =>
                ss.Set<PolygonEntity>()
                    .Select(
                        e => new { e.Id, Boundary = e.Polygon == null ? null : e.Polygon.Boundary }
                    ),
            elementSorter: x => x.Id,
            elementAsserter: (e, a) =>
            {
    ...
    public virtual Task Buffer(bool async) =>
        AssertQuery(
            ...
            ss =>
                ss.Set<PolygonEntity>()
                    .Select(
                        e => new { e.Id, Buffer = e.Polygon == null ? null : e.Polygon.Buffer(1.0) }
                    ),
            elementSorter: x => x.Id,
            elementAsserter: (e, a) =>
            {
    ...
    public virtual Task Buffer_quadrantSegments(bool async) =>
        AssertQuery(
            ...
            ss =>
                ss.Set<PolygonEntity>()
                    .Select(e => new { e.Id, Buffer = e.Polygon.Buffer(1.0, 8) }),
            ss =>
                ss.Set<PolygonEntity>()
                    .Select(
                        e =>
    ...
    public virtual Task Centroid(bool async) =>
        AssertQuery(
            ...
            ss =>
                ss.Set<PolygonEntity>()
                    .Select(
                        e => new { e.Id, Centroid = e.Polygon == null ? null : e.Polygon.Centroid }
                    ),
            elementSorter: x => x.Id,
            elementAsserter: (e, a) =>
            {
                ...
                ss.Set<PointEntity>()
                    ...
                    .Select(
                        g =>
                            ...
                            {
                                Id = g.Key,
                                Combined = EnvelopeCombiner.CombineAsGeometry(
                                    g.Select(e => e.Point)
                                )
                            }
                    ),
    ...
    public virtual Task Contains(bool async)
    {
        ...
        return AssertQuery(
            ...
            ss =>
                ss.Set<PolygonEntity>()
                    .Select(e => new { e.Id, Contains = (bool?)e.Polygon.Contains(point) }),
            ss =>
                ss.Set<PolygonEntity>()
                    .Select(
                        e =>
                            ...
                            {
                                e.Id,
                                Contains = e.Polygon == null
                                    ? (bool?)null
                                    : e.Polygon.Contains(point)
                            }
                    ),
            elementSorter: x => x.Id
        );
    ...
    public virtual Task ConvexHull(bool async) =>
        AssertQuery(
            ...
            ss =>
                ss.Set<PolygonEntity>()
                    .Select(e => new { e.Id, ConvexHull = e.Polygon.ConvexHull() }),
            ss =>
                ss.Set<PolygonEntity>()
                    .Select(
                        e =>
                ...
                ss.Set<MultiLineStringEntity>()
                    .Select(
                        e =>
                            ...
                            {
                                e.Id,
                                Count = e.MultiLineString == null
                                    ? (int?)null
                                    : e.MultiLineString.Count
                            }
                    ),
            elementSorter: x => x.Id
        );
    ...
    public virtual Task CoveredBy(bool async)
    {
        ...
        return AssertQuery(
            ...
            ss =>
                ss.Set<PointEntity>()
                    .Select(e => new { e.Id, CoveredBy = (bool?)e.Point.CoveredBy(polygon) }),
            ss =>
                ss.Set<PointEntity>()
                    .Select(
                        e =>
                            ...
                            {
                                e.Id,
                                CoveredBy = e.Point == null
                                    ? (bool?)null
                                    : e.Point.CoveredBy(polygon)
                            }
                    ),
            elementSorter: x => x.Id
        );
    ...
    public virtual Task Covers(bool async)
    {
        ...
        return AssertQuery(
            ...
            ss =>
                ss.Set<PolygonEntity>()
                    .Select(e => new { e.Id, Covers = (bool?)e.Polygon.Covers(point) }),
            ss =>
                ss.Set<PolygonEntity>()
                    .Select(
                        e =>
    ...
    public virtual Task Crosses(bool async)
    {
        ...
        return AssertQuery(
            ...
            ss =>
                ss.Set<LineStringEntity>()
                    .Select(e => new { e.Id, Crosses = (bool?)e.LineString.Crosses(lineString) }),
            ss =>
                ss.Set<LineStringEntity>()
                    .Select(
                        e =>
    ...
    public virtual Task Difference(bool async)
    {
        ...
        return AssertQuery(
            ...
            ss =>
                ss.Set<PolygonEntity>()
                    .Select(e => new { e.Id, Difference = e.Polygon.Difference(polygon) }),
            ss =>
                ss.Set<PolygonEntity>()
                    .Select(
                        e =>
                            ...
                            {
                                e.Id,
                                Difference = e.Polygon == null
                                    ? null
                                    : e.Polygon.Difference(polygon)
                            }
                    ),
            elementSorter: x => x.Id,
            elementAsserter: (e, a) =>
    ...
    public virtual Task Disjoint_with_cast_to_nullable(bool async)
    {
        ...
        return AssertQuery(
            ...
            ss =>
                ss.Set<PolygonEntity>()
                    .Select(e => new { e.Id, Disjoint = (bool?)e.Polygon.Disjoint(point) }),
            ss =>
                ss.Set<PolygonEntity>()
                    .Select(
                        e =>
                            ...
                            {
                                e.Id,
                                Disjoint = e.Polygon == null
                                    ? (bool?)null
                                    : e.Polygon.Disjoint(point)
                            }
                    ),
            elementSorter: x => x.Id
        );
    ...
    public virtual Task Distance_with_null_check(bool async)
    {
        ...
        return AssertQuery(
            ...
            ss =>
                ss.Set<PointEntity>()
                    .Select(e => new { e.Id, Distance = (double?)e.Point.Distance(point) }),
            ss =>
                ss.Set<PointEntity>()
                    .Select(
                        e =>
                            new
                            {
                                e.Id,
                                Distance = (
                                    e.Point == null ? (double?)null : e.Point.Distance(point)
                                )
                            }
                    ),
    ...
    public virtual Task Distance_geometry(bool async)
    {
        ...
        return AssertQuery(
            ...
            ss =>
                ss.Set<PointEntity>()
                    .Select(e => new { e.Id, Distance = (double?)e.Geometry.Distance(point) }),
            ss =>
                ss.Set<PointEntity>()
                    .Select(
                        e =>
                            ...
                            {
                                e.Id,
                                Distance = e.Geometry == null
                                    ? (double?)null
                                    : e.Geometry.Distance(point)
                            }
                    ),
            elementSorter: e => e.Id,
            elementAsserter: (e, a) =>
    ...
    public virtual Task Distance_constant(bool async) =>
        AssertQuery(
            ...
            ss =>
                ss.Set<PointEntity>()
                    .Select(
                        e => new { e.Id, Distance = (double?)e.Point.Distance(new Point(0, 1)) }
                    ),
            ss =>
                ss.Set<PointEntity>()
                    .Select(
    ...
    public virtual Task Distance_constant_lhs(bool async) =>
        AssertQuery(
            ...
            ss =>
                ss.Set<PointEntity>()
                    .Select(
                        e => new { e.Id, Distance = (double?)new Point(0, 1).Distance(e.Point) }
                    ),
            ss =>
                ss.Set<PointEntity>()
                    .Select(
    ...
    public virtual Task Distance_on_converted_geometry_type(bool async)
    {
        ...
        return AssertQuery(
            async,
            ss =>
                ss.Set<GeoPointEntity>()
                    .Select(e => new { e.Id, Distance = e.Location.Distance(point) }),
            elementSorter: e => e.Id,
            elementAsserter: (e, a) =>
            {
                Assert.Equal(e.Id, a.Id);
    ...
    public virtual Task Distance_on_converted_geometry_type_lhs(bool async)
    {
        ...
        return AssertQuery(
            ...
            ss =>
                ss.Set<GeoPointEntity>()
                    .Select(e => new { e.Id, Distance = point.Distance(e.Location) }),
            elementSorter: e => e.Id,
            elementAsserter: (e, a) =>
            {
                Assert.Equal(e.Id, a.Id);
    ...
    public virtual Task Distance_on_converted_geometry_type_constant(bool async) =>
        AssertQuery(
            ...
            ss =>
                ss.Set<GeoPointEntity>()
                    .Select(e => new { e.Id, Distance = e.Location.Distance(new GeoPoint(1, 0)) }),
            elementSorter: e => e.Id,
            elementAsserter: (e, a) =>
            {
                Assert.Equal(e.Id, a.Id);
    ...
    public virtual Task Distance_on_converted_geometry_type_constant_lhs(bool async) =>
        AssertQuery(
            ...
            ss =>
                ss.Set<GeoPointEntity>()
                    .Select(e => new { e.Id, Distance = new GeoPoint(1, 0).Distance(e.Location) }),
            elementSorter: e => e.Id,
            elementAsserter: (e, a) =>
            {
                Assert.Equal(e.Id, a.Id);
    ...
    public virtual Task Envelope(bool async) =>
        AssertQuery(
            ...
            ss =>
                ss.Set<PolygonEntity>()
                    .Select(
                        e => new { e.Id, Envelope = e.Polygon == null ? null : e.Polygon.Envelope }
                    ),
            elementSorter: x => x.Id,
            elementAsserter: (e, a) =>
            {
    ...
    public virtual Task GetGeometryN(bool async) =>
        AssertQuery(
            ...
            ss =>
                ss.Set<MultiLineStringEntity>()
                    .Select(e => new { e.Id, Geometry0 = e.MultiLineString.GetGeometryN(0) }),
            ss =>
                ss.Set<MultiLineStringEntity>()
                    .Select(
                        e =>
    ...
    public virtual Task GetGeometryN_with_null_argument(bool async) =>
        AssertQuery(
            ...
            ss =>
                ss.Set<MultiLineStringEntity>()
                    .Select(e => new { e.Id, Geometry0 = default(Geometry) }),
            elementSorter: x => x.Id
        );
    ...
    public virtual Task GetPointN(bool async) =>
        AssertQuery(
            ...
            ss =>
                ss.Set<LineStringEntity>()
                    .Select(e => new { e.Id, Point0 = e.LineString.GetPointN(0) }),
            ss =>
                ss.Set<LineStringEntity>()
                    .Select(
                        e =>
    ...
    public virtual Task Intersection(bool async)
    {
        ...
        return AssertQuery(
            ...
            ss =>
                ss.Set<PolygonEntity>()
                    .Select(e => new { e.Id, Intersection = e.Polygon.Intersection(polygon) }),
            ss =>
                ss.Set<PolygonEntity>()
                    .Select(
                        e =>
                            ...
                            {
                                e.Id,
                                Intersection = e.Polygon == null
                                    ? null
                                    : e.Polygon.Intersection(polygon)
                            }
                    ),
            elementSorter: x => x.Id,
            elementAsserter: (e, a) =>
    ...
    public virtual Task Intersects(bool async)
    {
        ...
        return AssertQuery(
            ...
            ss =>
                ss.Set<LineStringEntity>()
                    .Select(
                        e => new { e.Id, Intersects = (bool?)e.LineString.Intersects(lineString) }
                    ),
            ss =>
                ss.Set<LineStringEntity>()
                    .Select(
                ...
                ss.Set<LineStringEntity>()
                    .Select(
                        e =>
                            ...
                            {
                                e.Id,
                                IsClosed = e.LineString == null
                                    ? (bool?)null
                                    : e.LineString.IsClosed
                            }
                    ),
            elementSorter: x => x.Id
        );
                ...
                ss.Set<LineStringEntity>()
                    .Select(
                        e =>
                            ...
                            {
                                e.Id,
                                IsSimple = e.LineString == null
                                    ? (bool?)null
                                    : e.LineString.IsSimple
                            }
                    ),
            elementSorter: x => x.Id
        );
    ...
    public virtual Task IsValid(bool async) =>
        AssertQuery(
            ...
            ss =>
                ss.Set<PointEntity>()
                    .Select(
                        e => new { e.Id, IsValid = e.Point == null ? (bool?)null : e.Point.IsValid }
                    ),
            elementSorter: x => x.Id
        );
    ...
    public virtual Task Item(bool async) =>
        AssertQuery(
            ...
            ss =>
                ss.Set<MultiLineStringEntity>()
                    .Select(e => new { e.Id, Item0 = e.MultiLineString[0] }),
            ss =>
                ss.Set<MultiLineStringEntity>()
                    .Select(
                        e =>
    ...
    public virtual Task M(bool async) =>
        AssertQuery(
            ...
            ss =>
                ss.Set<PointEntity>()
                    .Select(e => new { e.Id, M = e.Point == null ? (double?)null : e.Point.M }),
            elementSorter: e => e.Id,
            elementAsserter: (e, a) =>
            {
                Assert.Equal(e.Id, a.Id);
    ...
    public virtual Task Normalized(bool async) =>
        AssertQuery(
            ...
            ss =>
                ss.Set<PolygonEntity>()
                    .Select(e => new { e.Id, Normalized = e.Polygon.Normalized() }),
            ss =>
                ss.Set<PolygonEntity>()
                    .Select(
                        e =>
                ...
                ss.Set<LineStringEntity>()
                    .Select(
                        e =>
                            ...
                            {
                                e.Id,
                                NumPoints = e.LineString == null
                                    ? (int?)null
                                    : e.LineString.NumPoints
                            }
                    ),
            elementSorter: x => x.Id
        );
    ...
    public virtual Task Overlaps(bool async)
    {
        ...
        return AssertQuery(
            ...
            ss =>
                ss.Set<PolygonEntity>()
                    .Select(e => new { e.Id, Overlaps = (bool?)e.Polygon.Overlaps(polygon) }),
            ss =>
                ss.Set<PolygonEntity>()
                    .Select(
                        e =>
                            ...
                            {
                                e.Id,
                                Overlaps = e.Polygon == null
                                    ? (bool?)null
                                    : e.Polygon.Overlaps(polygon)
                            }
                    ),
            elementSorter: x => x.Id
        );
                ...
                ss.Set<PolygonEntity>()
                    .Select(
                        e =>
                            ...
                            {
                                e.Id,
                                PointOnSurface = e.Polygon == null
                                    ? null
                                    : e.Polygon.PointOnSurface,
                                e.Polygon
                            }
                    ),
            elementSorter: x => x.Id,
    ...
    public virtual Task Relate(bool async)
    {
        ...
        return AssertQuery(
            ...
            ss =>
                ss.Set<PolygonEntity>()
                    .Select(
                        e => new { e.Id, Relate = (bool?)e.Polygon.Relate(polygon, "212111212") }
                    ),
            ss =>
                ss.Set<PolygonEntity>()
                    .Select(
    ...
    public virtual Task Reverse(bool async) =>
        AssertQuery(
            ...
            ss =>
                ss.Set<LineStringEntity>()
                    .Select(e => new { e.Id, Reverse = e.LineString.Reverse() }),
            ss =>
                ss.Set<LineStringEntity>()
                    .Select(
                        e =>
    ...
    public virtual Task SRID(bool async) =>
        AssertQuery(
            ...
            ss =>
                ss.Set<PointEntity>()
                    .Select(e => new { e.Id, SRID = e.Point == null ? (int?)null : e.Point.SRID }),
            elementSorter: x => x.Id
        );
    ...
    public virtual Task ToBinary(bool async) =>
        AssertQuery(
            ...
            ss =>
                ss.Set<PointEntity>()
                    .Select(
                        e => new { e.Id, Binary = e.Point == null ? null : e.Point.ToBinary() }
                    ),
            elementSorter: e => e.Id,
            elementAsserter: (e, a) =>
            {
    ...
    public virtual Task ToText(bool async) =>
        AssertQuery(
            ...
            ss =>
                ss.Set<PointEntity>()
                    .Select(e => new { e.Id, Text = e.Point == null ? null : e.Point.ToText() }),
            elementSorter: e => e.Id,
            elementAsserter: (e, a) =>
            {
                Assert.Equal(e.Id, a.Id);
    ...
    public virtual Task Touches(bool async)
    {
        ...
        return AssertQuery(
            ...
            ss =>
                ss.Set<PolygonEntity>()
                    .Select(e => new { e.Id, Touches = (bool?)e.Polygon.Touches(polygon) }),
            ss =>
                ss.Set<PolygonEntity>()
                    .Select(
                        e =>
                            ...
                            {
                                e.Id,
                                Touches = e.Polygon == null
                                    ? (bool?)null
                                    : e.Polygon.Touches(polygon)
                            }
                    ),
            elementSorter: x => x.Id
        );
    ...
    public virtual Task Union(bool async)
    {
        ...
        return AssertQuery(
            async,
            ss =>
                ss.Set<PolygonEntity>().Select(e => new { e.Id, Union = e.Polygon.Union(polygon) }),
            ss =>
                ss.Set<PolygonEntity>()
                    .Select(
                        e =>
        ...
        AssertQuery(
            ...
            ss =>
                ss.Set<PointEntity>()
                    ...
                    .GroupBy(e => e.Group)
                    .Select(
                        g => new { Id = g.Key, Union = UnaryUnionOp.Union(g.Select(e => e.Point)) }
                    ),
            elementSorter: x => x.Id,
            elementAsserter: (e, a) =>
            {
    ...
    public virtual Task Union_void(bool async) =>
        AssertQuery(
            ...
            ss =>
                ss.Set<MultiLineStringEntity>()
                    .Select(e => new { e.Id, Union = e.MultiLineString.Union() }),
            ss =>
                ss.Set<MultiLineStringEntity>()
                    .Select(
                        e =>
    ...
    public virtual Task Within(bool async)
    {
        ...
        return AssertQuery(
            ...
            ss =>
                ss.Set<PointEntity>()
                    .Select(e => new { e.Id, Within = (bool?)e.Point.Within(polygon) }),
            ss =>
                ss.Set<PointEntity>()
                    .Select(
                        e =>
    ...
    public virtual Task X(bool async) =>
        AssertQuery(
            ...
            ss =>
                ss.Set<PointEntity>()
                    .Select(e => new { e.Id, X = e.Point == null ? (double?)null : e.Point.X }),
            elementSorter: x => x.Id
        );
    ...
    public virtual Task Y(bool async) =>
        AssertQuery(
            ...
            ss =>
                ss.Set<PointEntity>()
                    .Select(e => new { e.Id, Y = e.Point == null ? (double?)null : e.Point.Y }),
            elementSorter: x => x.Id
        );
    ...
    public virtual Task Z(bool async) =>
        AssertQuery(
            ...
            ss =>
                ss.Set<PointEntity>()
                    .Select(e => new { e.Id, Z = e.Point == null ? (double?)null : e.Point.Z }),
            elementSorter: e => e.Id,
            elementAsserter: (e, a) =>
            {
                Assert.Equal(e.Id, a.Id);
...
#pragma warning disable CS0472 // The result of the expression is always the same since a value of this type is never equal to 'null'
            ss =>
                ss.Set<LineStringEntity>()
                    .Where(e => e.LineString.Intersects(lineString) == null)
                    .Select(e => e.Id),
#pragma warning restore CS0472 // The result of the expression is always the same since a value of this type is never equal to 'null'
...
#pragma warning disable CS0472 // The result of the expression is always the same since a value of this type is never equal to 'null'
            ss =>
                ss.Set<LineStringEntity>()
                    .Where(e => lineString.Intersects(e.LineString) == null)
                    .Select(e => e.Id),
#pragma warning restore CS0472 // The result of the expression is always the same since a value of this type is never equal to 'null'
            ss => ss.Set<LineStringEntity>().Where(e => e.LineString == null).Select(e => e.Id)
        );
