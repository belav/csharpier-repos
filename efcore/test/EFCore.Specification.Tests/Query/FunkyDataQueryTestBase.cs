    ...
    where TFixture : FunkyDataQueryTestBase<TFixture>.FunkyDataQueryFixtureBase, new()
{
    ...
    public virtual async Task String_contains_on_argument_with_wildcard_constant(bool async)
    {
        await AssertQuery(
            ...
            ss =>
                ss.Set<FunkyCustomer>()
                    .Where(c => c.FirstName.Contains("%B"))
                    .Select(c => c.FirstName),
            ss =>
                ss.Set<FunkyCustomer>()
                    .Where(c => c.FirstName.MaybeScalar(x => x.Contains("%B")) == true)
                    .Select(c => c.FirstName)
        );
        ...
        await AssertQuery(
            ...
            ss =>
                ss.Set<FunkyCustomer>()
                    .Where(c => c.FirstName.Contains("a_"))
                    .Select(c => c.FirstName),
            ss =>
                ss.Set<FunkyCustomer>()
                    .Where(c => c.FirstName.MaybeScalar(x => x.Contains("a_")) == true)
                    .Select(c => c.FirstName)
        );
        ...
        await AssertQuery(
            ...
            ss =>
                ss.Set<FunkyCustomer>()
                    .Where(c => c.FirstName.Contains(null))
                    .Select(c => c.FirstName),
        ...
        await AssertQuery(
            ...
            ss =>
                ss.Set<FunkyCustomer>()
                    .Where(c => c.FirstName.Contains("_Ba_"))
                    .Select(c => c.FirstName),
            ss =>
                ss.Set<FunkyCustomer>()
                    .Where(c => c.FirstName.MaybeScalar(x => x.Contains("_Ba_")) == true)
                    .Select(c => c.FirstName)
        );
        ...
        await AssertQuery(
            ...
            ss =>
                ss.Set<FunkyCustomer>()
                    .Where(c => !c.FirstName.Contains("%B%a%r"))
                    .Select(c => c.FirstName),
            ss =>
                ss.Set<FunkyCustomer>()
                    .Where(c => c.FirstName.MaybeScalar(x => x.Contains("%B%a%r")) != true)
                    .Select(c => c.FirstName)
        );
    ...
    public virtual async Task String_contains_on_argument_with_wildcard_parameter(bool async)
    {
        ...
        await AssertQuery(
            ...
            ss =>
                ss.Set<FunkyCustomer>()
                    .Where(c => c.FirstName.Contains(prm1))
                    .Select(c => c.FirstName),
            ss =>
                ss.Set<FunkyCustomer>()
                    .Where(c => c.FirstName.MaybeScalar(x => x.Contains(prm1)) == true)
                    .Select(c => c.FirstName)
        );
        ...
        await AssertQuery(
            ...
            ss =>
                ss.Set<FunkyCustomer>()
                    .Where(c => c.FirstName.Contains(prm2))
                    .Select(c => c.FirstName),
            ss =>
                ss.Set<FunkyCustomer>()
                    .Where(c => c.FirstName.MaybeScalar(x => x.Contains(prm2)) == true)
                    .Select(c => c.FirstName)
        );
        ...
        await AssertQuery(
            ...
            ss =>
                ss.Set<FunkyCustomer>()
                    .Where(c => c.FirstName.Contains(prm3))
                    .Select(c => c.FirstName),
            ss => ss.Set<FunkyCustomer>().Where(c => false).Select(c => c.FirstName),
            assertEmpty: true
        );
        ...
        await AssertQuery(
            ...
            ss =>
                ss.Set<FunkyCustomer>()
                    .Where(c => c.FirstName.Contains(prm4))
                    .Select(c => c.FirstName),
            ss => ss.Set<FunkyCustomer>().Where(c => c.FirstName != null).Select(c => c.FirstName)
        );
        ...
        await AssertQuery(
            ...
            ss =>
                ss.Set<FunkyCustomer>()
                    .Where(c => c.FirstName.Contains(prm5))
                    .Select(c => c.FirstName),
            ss =>
                ss.Set<FunkyCustomer>()
                    .Where(c => c.FirstName.MaybeScalar(x => x.Contains(prm5)) == true)
                    .Select(c => c.FirstName)
        );
        ...
        await AssertQuery(
            ...
            ss =>
                ss.Set<FunkyCustomer>()
                    .Where(c => !c.FirstName.Contains(prm6))
                    .Select(c => c.FirstName),
            ss =>
                ss.Set<FunkyCustomer>()
                    .Where(c => c.FirstName.MaybeScalar(x => x.Contains(prm6)) != true)
                    .Select(c => c.FirstName)
        );
        ...
        await AssertQuery(
            ...
            ss =>
                ss.Set<FunkyCustomer>()
                    .Where(c => !c.FirstName.Contains(prm7))
                    .Select(c => c.FirstName),
            ss => ss.Set<FunkyCustomer>().Where(c => c.FirstName == null).Select(c => c.FirstName)
        );
        ...
        await AssertQuery(
            ...
            ss =>
                ss.Set<FunkyCustomer>()
                    .Where(c => !c.FirstName.Contains(prm8))
                    .Select(c => c.FirstName),
            ss => ss.Set<FunkyCustomer>().Where(c => true).Select(c => c.FirstName)
        );
    }
    ...
    public virtual async Task String_starts_with_on_argument_with_wildcard_constant(bool async)
    {
        ...
        await AssertQuery(
            ...
            ss =>
                ss.Set<FunkyCustomer>()
                    .Where(c => c.FirstName.StartsWith(null))
                    .Select(c => c.FirstName),
            ss => ss.Set<FunkyCustomer>().Where(c => false).Select(c => c.FirstName),
            assertEmpty: true
        );
    ...
    public virtual async Task String_starts_with_on_argument_with_wildcard_parameter(bool async)
    {
        ...
        await AssertQuery(
            ...
            ss =>
                ss.Set<FunkyCustomer>()
                    .Where(c => c.FirstName.StartsWith(prm3))
                    .Select(c => c.FirstName),
            ss => ss.Set<FunkyCustomer>().Where(c => false).Select(c => c.FirstName),
            assertEmpty: true
        );
    ...
    public virtual async Task String_ends_with_on_argument_with_wildcard_constant(bool async)
    {
        await AssertQuery(
            ...
            ss =>
                ss.Set<FunkyCustomer>()
                    .Where(c => c.FirstName.EndsWith("%r"))
                    .Select(c => c.FirstName),
            ss =>
                ss.Set<FunkyCustomer>()
                    .Where(c => c.FirstName.MaybeScalar(x => x.EndsWith("%r")) == true)
                    .Select(c => c.FirstName)
        );
        ...
        await AssertQuery(
            ...
            ss =>
                ss.Set<FunkyCustomer>()
                    .Where(c => c.FirstName.EndsWith("r_"))
                    .Select(c => c.FirstName),
            ss =>
                ss.Set<FunkyCustomer>()
                    .Where(c => c.FirstName.MaybeScalar(x => x.EndsWith("r_")) == true)
                    .Select(c => c.FirstName)
        );
        ...
        await AssertQuery(
            ...
            ss =>
                ss.Set<FunkyCustomer>()
                    .Where(c => c.FirstName.EndsWith(null))
                    .Select(c => c.FirstName),
            ss => ss.Set<FunkyCustomer>().Where(c => false).Select(c => c.FirstName),
            assertEmpty: true
        );
        ...
        await AssertQuery(
            ...
            ss =>
                ss.Set<FunkyCustomer>()
                    .Where(c => c.FirstName.EndsWith("_r_"))
                    .Select(c => c.FirstName),
            ss =>
                ss.Set<FunkyCustomer>()
                    .Where(c => c.FirstName.MaybeScalar(x => x.EndsWith("_r_")) == true)
                    .Select(c => c.FirstName)
        );
        ...
        await AssertQuery(
            ...
            ss =>
                ss.Set<FunkyCustomer>()
                    .Where(c => !c.FirstName.EndsWith("a%r%"))
                    .Select(c => c.FirstName),
            ss =>
                ss.Set<FunkyCustomer>()
                    .Where(c => c.FirstName.MaybeScalar(x => x.EndsWith("a%r%")) != true)
                    .Select(c => c.FirstName)
        );
        ...
        await AssertQuery(
            ...
            ss =>
                ss.Set<FunkyCustomer>()
                    .Where(c => c.FirstName.MaybeScalar(x => x.EndsWith("")) != true)
                    .Select(c => c.FirstName)
        );
    ...
    public virtual async Task String_ends_with_on_argument_with_wildcard_parameter(bool async)
    {
        ...
        await AssertQuery(
            ...
            ss =>
                ss.Set<FunkyCustomer>()
                    .Where(c => c.FirstName.EndsWith(prm1))
                    .Select(c => c.FirstName),
            ss =>
                ss.Set<FunkyCustomer>()
                    .Where(c => c.FirstName.MaybeScalar(x => x.EndsWith(prm1)) == true)
                    .Select(c => c.FirstName)
        );
        ...
        await AssertQuery(
            ...
            ss =>
                ss.Set<FunkyCustomer>()
                    .Where(c => c.FirstName.EndsWith(prm2))
                    .Select(c => c.FirstName),
            ss =>
                ss.Set<FunkyCustomer>()
                    .Where(c => c.FirstName.MaybeScalar(x => x.EndsWith(prm2)) == true)
                    .Select(c => c.FirstName)
        );
        ...
        await AssertQuery(
            ...
            ss =>
                ss.Set<FunkyCustomer>()
                    .Where(c => c.FirstName.EndsWith(prm3))
                    .Select(c => c.FirstName),
            ss => ss.Set<FunkyCustomer>().Where(c => false).Select(c => c.FirstName),
            assertEmpty: true
        );
        ...
        await AssertQuery(
            ...
            ss =>
                ss.Set<FunkyCustomer>()
                    .Where(c => c.FirstName.EndsWith(prm4))
                    .Select(c => c.FirstName),
            ss =>
                ss.Set<FunkyCustomer>()
                    .Where(c => c.FirstName.MaybeScalar(x => x.EndsWith(prm4)) == true)
                    .Select(c => c.FirstName)
        );
        ...
        await AssertQuery(
            ...
            ss =>
                ss.Set<FunkyCustomer>()
                    .Where(c => c.FirstName.EndsWith(prm5))
                    .Select(c => c.FirstName),
            ss =>
                ss.Set<FunkyCustomer>()
                    .Where(c => c.FirstName.MaybeScalar(x => x.EndsWith(prm5)) == true)
                    .Select(c => c.FirstName)
        );
        ...
        await AssertQuery(
            ...
            ss =>
                ss.Set<FunkyCustomer>()
                    .Where(c => !c.FirstName.EndsWith(prm6))
                    .Select(c => c.FirstName),
            ss =>
                ss.Set<FunkyCustomer>()
                    .Where(c => c.FirstName.MaybeScalar(x => x.EndsWith(prm6)) != true)
                    .Select(c => c.FirstName)
        );
        ...
        await AssertQuery(
            ...
            ss =>
                ss.Set<FunkyCustomer>()
                    .Where(c => !c.FirstName.EndsWith(prm7))
                    .Select(c => c.FirstName),
            ss => ss.Set<FunkyCustomer>().Where(c => c.FirstName == null).Select(c => c.FirstName)
        );
        ...
        await AssertQuery(
            ...
            ss =>
                ss.Set<FunkyCustomer>()
                    .Where(c => !c.FirstName.EndsWith(prm8))
                    .Select(c => c.FirstName),
            ss => ss.Set<FunkyCustomer>().Where(c => true).Select(c => c.FirstName)
        );
    }
            ...
            IQueryFixtureBase
    {
        ...
        public virtual ISetSource GetExpectedData() => FunkyDataData.Instance;
        ...
        protected override string StoreName => "FunkyDataQueryTest";
