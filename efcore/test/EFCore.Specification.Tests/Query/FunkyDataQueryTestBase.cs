        ...
        where TFixture : FunkyDataQueryTestBase<TFixture>.FunkyDataQueryFixtureBase, new()
    {
        ...
        public virtual async Task String_contains_on_argument_with_wildcard_constant(bool async)
        {
            ...
            await AssertQuery(
                ...
                ss =>
                    ss.Set<FunkyCustomer>()
                        .Where(c => !c.FirstName.MaybeScalar(x => x.Contains("")) == true)
                        .Select(c => c.FirstName)
            );
                ...
                ss =>
                    ss.Set<FunkyCustomer>()
                        ...
                        .Where(
                            r =>
                                r.ln != ""
                                && !r.fn.MaybeScalar(x => r.ln.MaybeScalar(xx => x.Contains(xx)))
                                    == true
                        )
            );
        }
        ...
        public virtual async Task String_starts_with_on_argument_with_wildcard_constant(bool async)
        {
            ...
            await AssertQuery(
                ...
                ss =>
                    ss.Set<FunkyCustomer>()
                        .Where(c => c.FirstName.StartsWith("a_"))
                        .Select(c => c.FirstName)
            );
        ...
        public virtual async Task String_ends_with_on_argument_with_wildcard_constant(bool async)
        {
            await AssertQuery(
                ...
                ss =>
                    ss.Set<FunkyCustomer>()
                        .Where(c => c.FirstName.EndsWith("%B"))
                        .Select(c => c.FirstName)
            );
            ...
            await AssertQuery(
                ...
                ss =>
                    ss.Set<FunkyCustomer>()
                        .Where(c => c.FirstName.EndsWith("a_"))
                        .Select(c => c.FirstName)
            );
            ...
            await AssertQuery(
                ...
                ss =>
                    ss.Set<FunkyCustomer>()
                        .Where(c => c.FirstName.EndsWith("_Ba_"))
                        .Select(c => c.FirstName)
            );
            ...
            await AssertQuery(
                ...
                ss =>
                    ss.Set<FunkyCustomer>()
                        .Where(c => !c.FirstName.EndsWith("%B%a%r"))
                        .Select(c => c.FirstName),
                ss =>
                    ss.Set<FunkyCustomer>()
                        .Where(c => !c.FirstName.MaybeScalar(x => x.EndsWith("%B%a%r")) == true)
                        .Select(c => c.FirstName)
            );
                ...
                ss =>
                    ss.Set<FunkyCustomer>()
                        ...
                        .Where(
                            r =>
                                r.ln != ""
                                && !r.fn.MaybeScalar(x => r.ln.MaybeScalar(xx => x.EndsWith(xx)))
                                    == true
                        )
            );
        }
            ...
            return AssertQuery(
                ...
                ss =>
                    ss.Set<FunkyCustomer>()
                        ...
                        .Where(
                            r => r.c1.FirstName.EndsWith(r.c2.LastName) == r.c1.NullableBool.Value
                        ),
                ...
                IQueryFixtureBase
        {
            ...
            public virtual ISetSource GetExpectedData() => new FunkyDataData();
