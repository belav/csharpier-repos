    ...
    where TFixture : NorthwindQueryFixtureBase<NoopModelCustomizer>, new()
{
    ...
    public virtual Task Select_Where_Navigation_Null(bool async) =>
        AssertQuery(async, ss => from e in ss.Set<Employee>() where e.Manager == null select e);

    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task Select_Where_Navigation_Null_Reverse(bool async) =>
        AssertQuery(async, ss => from e in ss.Set<Employee>() where null == e.Manager select e);
    ...
    public virtual Task Select_Navigation(bool async) =>
        AssertQuery(async, ss => from o in ss.Set<Order>() select o.Customer);
