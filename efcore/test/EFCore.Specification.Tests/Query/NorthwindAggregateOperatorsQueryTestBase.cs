...
{
    public abstract class NorthwindAggregateOperatorsQueryTestBase<TFixture>
        : QueryTestBase<TFixture>
        where TFixture : NorthwindQueryFixtureBase<NoopModelCustomizer>, new()
    {
        ...
        {
            return AssertSum(async, ss => ss.Set<Order>().Select(o => o.OrderID));
        }
        ...
        {
            return AssertSum(async, ss => ss.Set<Product>(), selector: o => o.SupplierID);
        }
        ...
        {
            return AssertSum(async, ss => ss.Set<Order>().Select(o => o.OrderID * 2));
        }
        ...
        {
            return AssertSum(async, ss => ss.Set<Order>(), selector: o => o.OrderID);
        }
        ...
        {
            return AssertSum(async, ss => ss.Set<Order>(), selector: o => o.OrderID + o.OrderID);
        }
        ...
        {
            return AssertAverage(async, ss => ss.Set<Order>().Select(o => o.OrderID));
        }
        ...
        {
            return AssertAverage(async, ss => ss.Set<Order>().Select(o => o.OrderID * 2));
        }
        ...
        {
            return AssertAverage(async, ss => ss.Set<Order>(), selector: o => o.OrderID);
        }
        ...
        {
            return AssertMin(async, ss => ss.Set<Order>().Select(o => o.OrderID));
        }
        ...
        {
            return AssertMin(async, ss => ss.Set<Order>(), selector: o => o.OrderID);
        }
        ...
        public virtual void Min_no_data()
        {
            ...
            Assert.Throws<InvalidOperationException>(
                () => context.Orders.Where(o => o.OrderID == -1).Min(o => o.OrderID)
            );
        }
        ...
        public virtual void Max_no_data()
        {
            using var context = CreateContext();
            Assert.Throws<InvalidOperationException>(
                () => context.Orders.Where(o => o.OrderID == -1).Max(o => o.OrderID)
            );
        }
        ...
        public virtual void Average_no_data()
        {
            using var context = CreateContext();
            Assert.Throws<InvalidOperationException>(
                () => context.Orders.Where(o => o.OrderID == -1).Average(o => o.OrderID)
            );
        }
        ...
        {
            return AssertMax(async, ss => ss.Set<Order>().Select(o => o.OrderID));
        }
        ...
        {
            return AssertMax(async, ss => ss.Set<Order>(), selector: o => o.OrderID);
        }
        ...
        {
            return AssertCount(async, ss => ss.Set<Order>());
        }
        ...
        {
            return AssertCount(async, ss => ss.Set<Order>().OrderBy(o => o.CustomerID));
        }
        ...
        {
            return AssertQuery(async, ss => ss.Set<Customer>().Distinct(), entryCount: 91);
        }
        ...
        {
            return AssertQuery(async, ss => ss.Set<Customer>().Select(c => c.City).Distinct());
        }
        ...
        {
            return AssertCount(async, ss => ss.Set<Customer>().Distinct());
        }
        ...
        public virtual Task Contains_with_subquery(bool async)
        {
            return AssertQuery(
                ...
                ss =>
                    ss.Set<Customer>()
                        .Where(
                            c => ss.Set<Order>().Select(o => o.CustomerID).Contains(c.CustomerID)
                        ),
                entryCount: 89
            );
        }
        ...
        public virtual Task Contains_with_local_array_inline(bool async)
        {
            return AssertQuery(
                ...
                ss =>
                    ss.Set<Customer>()
                        .Where(c => new[] { "ABCDE", "ALFKI" }.Contains(c.CustomerID)),
                entryCount: 1
            );
        }
        ...
        public virtual Task Contains_with_local_object_list_closure(bool async)
        {
            ...
            return AssertQuery(
                ...
                ss =>
                    ss.Set<Customer>()
                        .Where(
                            c => ids.Contains(EF.Property<object>(c, nameof(Customer.CustomerID)))
                        ),
                entryCount: 1
            );
        }
        ...
        public virtual Task Contains_with_local_non_primitive_list_closure_mix(bool async)
        {
            ...
            return AssertQuery(
                ...
                ss =>
                    ss.Set<Customer>()
                        .Where(c => ids.Select(i => i.CustomerID).Contains(c.CustomerID)),
                entryCount: 1
            );
        }
                ...
                () =>
                    AssertQuery(
                        ...
                        ss =>
                            ss.Set<OrderDetail>()
                                .Where(
                                    o => ids.Contains(new { Id1 = o.OrderID, Id2 = o.ProductID })
                                ),
                        entryCount: 1
                    )
            );
        ...
        public virtual void Contains_over_keyless_entity_throws()
        {
            using var context = CreateContext();
            Assert.Throws<InvalidOperationException>(
                () => context.CustomerQueries.Contains(new CustomerQuery())
            );
        }
        ...
        public virtual Task Contains_over_entityType_with_null_should_rewrite_to_false(bool async)
        {
            return AssertSingleResult(
                ...
                ss =>
                    ss.Set<Order>().Where(o => o.CustomerID == "VINET").ContainsAsync(null, default)
            );
        }
        ...
        )
        {
            return AssertQuery(
                ...
                ss =>
                    ss.Set<Order>()
                        .Where(
                            o => ss.Set<Order>().Where(o => o.CustomerID == "VINET").Contains(null)
                        )
            );
        }
        ...
        {
            return AssertSum(async, ss => ss.Set<Employee>(), selector: e => 1);
        }
        ...
        {
            return AssertCount(async, ss => ss.Set<Customer>().Cast<Customer>());
        }
        ...
        public virtual Task Cast_before_aggregate_is_preserved(bool async)
        {
            return AssertQueryScalar(
                ...
                ss =>
                    ss.Set<Customer>()
                        .Select(c => c.Orders.Select(o => (double?)o.OrderID).Average())
            );
        }
        ...
        {
            return AssertSum(async, ss => ss.Set<Order>(), o => (long?)o.OrderID);
        }
        ...
        {
            return AssertAll(async, ss => ss.Set<Customer>(), predicate: x => true);
        }
