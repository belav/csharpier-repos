    ...
    where TFixture : ComplexNavigationsQueryFixtureBase, new()
{
    ...
    protected ComplexNavigationsCollectionsQueryTestBase(TFixture fixture) : base(fixture) { }
    ...
    public virtual Task Select_nav_prop_collection_one_to_many_required(bool async) =>
        AssertQuery(
            ...
            ss =>
                ss.Set<Level1>()
                    .OrderBy(e => e.Id)
                    .Select(e => e.OneToMany_Required1.Select(i => i.Id)),
            assertOrder: true,
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task Complex_SelectMany_with_nested_navigations_and_explicit_DefaultIfEmpty_with_other_query_operators_composed_on_top(
        bool async
    ) =>
        AssertQuery(
            async,
    ...
    public virtual Task Project_collection_navigation(bool async) =>
        AssertQuery(
            async,
            ss => from l1 in ss.Set<Level1>() select l1.OneToMany_Optional1,
    ...
    public virtual Task Project_collection_navigation_nested(bool async) =>
        AssertQuery(
            async,
            ss => from l1 in ss.Set<Level1>() select l1.OneToOne_Optional_FK1.OneToMany_Optional2,
            ss =>
        ...
        AssertQuery(
            ...
            ss =>
                ...
                select EF.Property<ICollection<Level3>>(
                    EF.Property<Level2>(l1, "OneToOne_Optional_FK1"),
                    "OneToMany_Optional2"
                ),
            elementSorter: e => e?.Count ?? 0,
    ...
    public virtual Task Project_collection_navigation_nested_anonymous(bool async) =>
        AssertQuery(
            ...
            elementAsserter: (e, a) =>
            {
                ...
                AssertCollection(
                    e.OneToMany_Optional2 ?? new List<Level3>(),
                    a.OneToMany_Optional2
                );
            }
        );
    ...
    public virtual Task Project_collection_and_root_entity(bool async) =>
        AssertQuery(
            async,
            ss => from l1 in ss.Set<Level1>() select new { l1, l1.OneToMany_Optional1 },
    ...
    public virtual Task Null_check_in_anonymous_type_projection_should_not_be_removed(bool async) =>
        AssertQuery(
            ...
            assertOrder: true,
            elementAsserter: (e, a) =>
                AssertCollection(e.Level2s, a.Level2s, elementSorter: ee => ee?.Level3.Name)
        );
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task SelectMany_navigation_property_followed_by_select_collection_navigation(
        bool async
    ) =>
        AssertQuery(
            async,
            ss =>
                ss.Set<Level1>()
                    ...
                    .Select(l2 => new { l2.Id, l2.OneToMany_Optional2 }),
            elementSorter: e => e.Id,
            elementAsserter: (e, a) =>
            {
                Assert.Equal(e.Id, a.Id);
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task Multiple_SelectMany_navigation_property_followed_by_select_collection_navigation(
        bool async
    ) =>
        AssertQuery(
            async,
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task SelectMany_navigation_property_with_include_and_followed_by_select_collection_navigation(
        bool async
    ) =>
        AssertQuery(
            async,
        ...
        AssertQuery(
            ...
            elementAsserter: (e, a) =>
            {
                ...
                AssertCollection(
                    e.c2,
                    a.c2,
                    elementSorter: i => i.Id,
                    elementAsserter: (ie, ia) => Assert.Equal(ie.Id, ia.Id)
                );
            }
        );
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task Complex_query_with_let_collection_projection_FirstOrDefault_with_ToList_on_inner_and_outer(
        bool async
    ) =>
        AssertQuery(
            async,
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task SelectMany_DefaultIfEmpty_multiple_times_with_joins_projecting_a_collection(
        bool async
    ) =>
        AssertQuery(
            async,
            ...
            elementAsserter: (e, a) =>
                AssertInclude(
                    ...
                    new ExpectedInclude<Level2>(
                        l2 => l2.OneToMany_Optional2,
                        "OneToMany_Optional1"
                    ),
                    new ExpectedInclude<Level3>(
                        l3 => l3.OneToMany_Required_Inverse3,
                        "OneToMany_Optional1.OneToMany_Optional2"
                    ),
                    new ExpectedInclude<Level2>(
                        l2 => l2.OneToMany_Optional2,
                        "OneToMany_Optional1.OneToMany_Optional2.OneToMany_Required_Inverse3"
                    )
                )
        );
        ...
        AssertQuery(
            ...
            ss =>
                ss.Set<Level1>()
                    ...
                    .ThenInclude(
                        e => EF.Property<ICollection<Level1>>(e, "OneToMany_Optional_Self1")
                    )
    ...
    public virtual Task Include_collection_with_conditional_order_by(bool async) =>
        AssertQuery(
            ...
            elementSorter: e => e.Id,
            elementAsserter: (e, a) =>
                AssertInclude(e, a, new ExpectedInclude<Level1>(ee => ee.OneToMany_Optional1))
        );
        ...
        AssertQuery(
            ...
            elementAsserter: (e, a) =>
                AssertInclude(
                    ...
                    new ExpectedInclude<Level1>(l1 => l1.OneToOne_Optional_FK1),
                    new ExpectedInclude<Level2>(
                        l1 => l1.OneToMany_Required2,
                        "OneToOne_Optional_FK1"
                    ),
                    new ExpectedInclude<Level3>(
                        l1 => l1.OneToOne_Required_FK3,
                        "OneToOne_Optional_FK1.OneToMany_Required2"
                    )
                )
        );
        ...
        AssertQuery(
            ...
            elementAsserter: (e, a) =>
                AssertInclude(
                    ...
                    new ExpectedInclude<Level2>(
                        l1 => l1.OneToMany_Optional2,
                        "OneToOne_Required_FK1"
                    ),
                    new ExpectedInclude<Level2>(
                        l1 => l1.OneToMany_Required2,
                        "OneToOne_Required_FK1"
        ...
        AssertQuery(
            ...
            elementAsserter: (e, a) =>
                AssertInclude(
                    ...
                    new ExpectedInclude<Level1>(l1 => l1.OneToOne_Optional_FK1),
                    new ExpectedInclude<Level2>(
                        l2 => l2.OneToOne_Required_FK2,
                        "OneToOne_Optional_FK1"
                    ),
                    new ExpectedInclude<Level3>(
                        l3 => l3.OneToMany_Optional3,
                        "OneToOne_Optional_FK1.OneToOne_Required_FK2"
                    )
                )
        );
    ...
    public virtual Task SelectMany_with_Include1(bool async) =>
        AssertQuery(
            ...
            elementAsserter: (e, a) =>
                AssertInclude(e, a, new ExpectedInclude<Level2>(l2 => l2.OneToMany_Optional2))
        );
    ...
    public virtual Task SelectMany_with_Include2(bool async) =>
        AssertQuery(
            ...
            elementAsserter: (e, a) =>
                AssertInclude(e, a, new ExpectedInclude<Level2>(l2 => l2.OneToOne_Required_FK2))
        );
        ...
        AssertQuery(
            ...
            elementAsserter: (e, a) =>
                AssertInclude(
                    ...
                    new ExpectedInclude<Level2>(
                        l2 => l2.OneToMany_Optional_Inverse2,
    ...
    public virtual Task Multiple_optional_navigation_with_Include(bool async) =>
        AssertQuery(
            ...
            ss =>
                ss.Set<Level1>()
                    .Include(
                        l1 => l1.OneToOne_Optional_FK1.OneToOne_Optional_PK2.OneToMany_Optional3
                    )
                    .Select(l1 => l1.OneToOne_Optional_FK1.OneToOne_Optional_PK2),
            elementAsserter: (e, a) =>
                AssertInclude(e, a, new ExpectedInclude<Level3>(l3 => l3.OneToMany_Optional3))
        );
    ...
    public virtual Task SelectMany_with_navigation_and_Distinct(bool async) =>
        AssertQuery(
            ...
            ss =>
                ...
                select l1,
            elementAsserter: (e, a) =>
                AssertInclude(e, a, new ExpectedInclude<Level1>(l1 => l1.OneToMany_Optional1))
        );

    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task SelectMany_with_navigation_and_Distinct_projecting_columns_including_join_key(
        bool async
    ) =>
        AssertQuery(
            async,
    ...
    public virtual Task Include_collection_with_multiple_orderbys_member(bool async) =>
        AssertQuery(
            ...
            elementAsserter: (e, a) =>
                AssertInclude(e, a, new ExpectedInclude<Level2>(e => e.OneToMany_Optional2)),
            assertOrder: true
        );
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task Include_collection_with_multiple_orderbys_complex_repeated_checked(
        bool async
    )
    {
        checked
    ...
    public virtual Task Include_collection_with_groupby_in_subquery(bool async) =>
        AssertQuery(
            ...
            elementAsserter: (e, a) =>
                AssertInclude(e, a, new ExpectedInclude<Level1>(e => e.OneToMany_Optional1))
        );
        ...
        AssertQuery(
            ...
            ss =>
                ss.Set<Level1>()
                    ...
                    .Include(l2 => l2.OneToMany_Optional2),
            elementAsserter: (e, a) =>
                AssertInclude(e, a, new ExpectedInclude<Level2>(x => x.OneToMany_Optional2))
        );
    ...
    public virtual Task Include_after_multiple_SelectMany_and_reference_navigation(bool async) =>
        AssertQuery(
            ...
            elementAsserter: (e, a) =>
                AssertInclude(e, a, new ExpectedInclude<Level4>(l4 => l4.OneToMany_Required_Self4))
        );
        ...
        AssertQuery(
            ...
            ss =>
                ss.Set<Level1>()
                    ...
                    .Select(l3 => l3.OneToOne_Required_FK3),
            elementAsserter: (e, a) =>
                AssertInclude(e, a, new ExpectedInclude<Level4>(l4 => l4.OneToMany_Optional_Self4))
        );
    ...
    public virtual Task Include_collection(bool async) =>
        AssertQuery(
            ...
            elementAsserter: (e, a) =>
                AssertInclude(e, a, new ExpectedInclude<Level1>(l3 => l3.OneToMany_Optional1))
        );
        ...
        AssertQuery(
            ...
            elementAsserter: (e, a) =>
                AssertInclude(
                    e,
                    a,
                    new ExpectedInclude<Level1>(e1 => e1.OneToMany_Optional1),
                    new ExpectedInclude<Level2>(
                        e2 => e2.OneToOne_Optional_PK2,
                        "OneToMany_Optional1"
                    )
                )
        );
        ...
        AssertQuery(
            ...
            elementAsserter: (e, a) =>
                AssertInclude(
                    e,
                    a,
                    new ExpectedInclude<Level1>(e1 => e1.OneToOne_Optional_FK1),
                    new ExpectedInclude<Level2>(
                        e2 => e2.OneToMany_Optional2,
                        "OneToOne_Optional_FK1"
                    )
                )
        );
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task Include_collection_followed_by_projecting_the_included_collection(
        bool async
    ) =>
        AssertQuery(
            async,
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task Include_and_ThenInclude_collections_followed_by_projecting_the_first_collection(
        bool async
    ) =>
        AssertQuery(
            async,
                ...
                AssertCollection(
                    ...
                    elementAsserter: (ee, aa) =>
                        AssertInclude(
                            ee,
                            aa,
                            new ExpectedInclude<Level2>(x => x.OneToOne_Optional_PK2)
                        )
                )
        );
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task Include_collection_and_another_navigation_chain_followed_by_projecting_the_first_collection(
        bool async
    ) =>
        AssertQuery(
            async,
                ...
                AssertCollection(
                    ...
                    elementAsserter: (ee, aa) =>
                        AssertInclude(
                            ee,
                            aa,
                            new ExpectedInclude<Level2>(e1 => e1.OneToOne_Optional_PK2),
                            new ExpectedInclude<Level3>(
                                e2 => e2.OneToOne_Optional_FK3,
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task Include_collection_followed_by_complex_includes_and_projecting_the_included_collection(
        bool async
    ) =>
        AssertQuery(
            async,
        ...
        AssertQuery(
            ...
            elementAsserter: (e, a) =>
                AssertInclude(
                    ...
                    new ExpectedInclude<Level2>(
                        e4 => e4.OneToOne_Optional_FK2,
                        "OneToMany_Optional1"
                    ),
                    new ExpectedInclude<Level3>(
                        e5 => e5.OneToMany_Optional3,
                        "OneToMany_Optional1.OneToOne_Optional_FK2"
                    )
                )
        );
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task Include_ThenInclude_ThenInclude_followed_by_two_nested_selects(
        bool async
    ) =>
        AssertQuery(
            async,
                ...
                AssertCollection(
                    ...
                    elementAsserter: (ee, aa) =>
                        AssertInclude(
                            ee,
                            aa,
                            new ExpectedInclude<Level3>(x => x.OneToOne_Optional_FK3)
                        )
                )
        );
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task Include_collection_ThenInclude_reference_followed_by_projection_into_anonmous_type(
        bool async
    ) =>
        AssertQuery(
            async,
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task Including_reference_navigation_and_projecting_collection_navigation(
        bool async
    ) =>
        AssertQuery(
            async,
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task LeftJoin_with_Any_on_outer_source_and_projecting_collection_from_inner(
        bool async
    )
    {
        ...
        return AssertQuery(
            async,
            ss =>
                from l1 in ss.Set<Level1>().Where(l1 => validIds.Any(e => e == l1.Name))
                join l2 in ss.Set<Level2>() on l1.Id equals l2.Level1_Required_Id into l2s
    ...
    public virtual Task Filtered_include_basic_OrderBy_Take(bool async) =>
        AssertQuery(
            async,
            ss =>
                ss.Set<Level1>().Include(l1 => l1.OneToMany_Optional1.OrderBy(x => x.Name).Take(3)),
            elementAsserter: (e, a) =>
                AssertInclude(
                    e,
                    a,
    ...
    public virtual Task Filtered_include_basic_OrderBy_Skip(bool async) =>
        AssertQuery(
            async,
            ss =>
                ss.Set<Level1>().Include(l1 => l1.OneToMany_Optional1.OrderBy(x => x.Name).Skip(1)),
            elementAsserter: (e, a) =>
                AssertInclude(
                    e,
                    a,
    ...
    public virtual Task Filtered_include_basic_OrderBy_Skip_Take(bool async) =>
        AssertQuery(
            ...
            ss =>
                ss.Set<Level1>()
                    .Include(l1 => l1.OneToMany_Optional1.OrderBy(x => x.Name).Skip(1).Take(3)),
            elementAsserter: (e, a) =>
                AssertInclude(
                    e,
                    a,
    ...
    public virtual Task Filtered_include_Skip_without_OrderBy(bool async) =>
        AssertQuery(
            ...
            elementAsserter: (e, a) =>
            {
                AssertEqual(e, a);
                Assert.Equal(
                    Math.Max(e.OneToMany_Optional1.Count - 1, 0),
                    a.OneToMany_Optional1?.Count
                );
            }
        );
            ...
            elementAsserter: (e, a) =>
                AssertInclude(
                    ...
                    new ExpectedFilteredInclude<Level1, Level2>(
                        e => e.OneToMany_Optional1,
                        includeFilter: x =>
                            x.Where(x => x.Name != "Foo").OrderBy(x => x.Name).Take(3),
                        assertOrder: true
                    ),
                    new ExpectedFilteredInclude<Level1, Level2>(
                        e => e.OneToMany_Required1,
                        includeFilter: x =>
                            x.Where(x => x.Name != "Bar").OrderByDescending(x => x.Name).Skip(1),
                        assertOrder: true
                    )
                )
        );
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task Filtered_include_after_different_filtered_include_different_level(
        bool async
    ) =>
        AssertQuery(
            async,
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual async Task Filtered_include_different_filter_set_on_same_navigation_twice(
        bool async
    ) =>
        Assert.Equal(
            CoreStrings
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual async Task Filtered_include_different_filter_set_on_same_navigation_twice_multi_level(
        bool async
    ) =>
        Assert.Equal(
            CoreStrings
            ...
            elementAsserter: (e, a) =>
                AssertInclude(
                    ...
                    new ExpectedFilteredInclude<Level1, Level2>(
                        e => e.OneToMany_Optional1,
                        includeFilter: x =>
                            x.Where(x => x.Name != "Foo").OrderByDescending(x => x.Id).Take(2),
                        assertOrder: true
                    )
                )
        );
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task Filtered_include_same_filter_set_on_same_navigation_twice_followed_by_ThenIncludes(
        bool async
    ) =>
        AssertQuery(
            async,
            ...
            elementAsserter: (e, a) =>
                AssertInclude(
                    ...
                    new ExpectedFilteredInclude<Level1, Level2>(
                        e => e.OneToMany_Optional1,
                        includeFilter: x =>
                            x.Where(x => x.Name != "Foo").OrderBy(x => x.Id).Take(2),
                        assertOrder: true
                    ),
            ...
            elementAsserter: (e, a) =>
                AssertInclude(
                    ...
                    new ExpectedFilteredInclude<Level1, Level2>(
                        e => e.OneToMany_Optional1,
                        includeFilter: x =>
                            x.Where(x => x.Name != "Foo").OrderBy(x => x.Id).Take(3),
                        assertOrder: true
                    )
                )
        );
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task Filtered_include_and_non_filtered_include_followed_by_then_include_on_same_navigation(
        bool async
    ) =>
        AssertQuery(
            async,
            ss =>
                ss.Set<Level1>()
                    ...
                    .Include(l1 => l1.OneToMany_Optional1)
                    .ThenInclude(
                        l2 => l2.OneToOne_Optional_PK2.OneToMany_Optional3.Where(x => x.Id > 1)
                    ),
            elementAsserter: (e, a) =>
                AssertInclude(
                    e,
                    ...
                    new ExpectedFilteredInclude<Level1, Level2>(
                        e => e.OneToMany_Optional1,
                        includeFilter: x =>
                            x.Where(x => x.Name != "Foo").OrderBy(x => x.Id).Take(1),
                        assertOrder: true
                    ),
                    new ExpectedInclude<Level2>(
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task Filtered_include_complex_three_level_with_middle_having_filter1(
        bool async
    ) =>
        AssertQuery(
            async,
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task Filtered_include_complex_three_level_with_middle_having_filter2(
        bool async
    ) =>
        AssertQuery(
            async,
            ...
            elementAsserter: (e, a) =>
                AssertInclude(
                    ...
                    new ExpectedFilteredInclude<Level1, Level2>(
                        ...
                        includeFilter: x =>
                            x.Where(xx => xx.Name != "Foo").OrderBy(x => x.Id).Take(3)
                    )
                )
        );
    }
        ...
        AssertQuery(
            ...
            elementAsserter: (e, a) =>
            {
                ...
                AssertInclude(
                    e.FullInclude,
                    a.FullInclude,
                    new ExpectedInclude<Level2>(x => x.OneToMany_Optional2)
                );
                AssertInclude(
                    e.FilteredInclude,
                    a.FilteredInclude,
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual async Task Filtered_include_calling_methods_directly_on_parameter_throws(
        bool async
    ) =>
        Assert.Equal(
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task Filtered_include_Skip_Take_with_another_Skip_Take_on_top_level(
        bool async
    ) =>
        AssertQuery(
            async,
            ss =>
                ss.Set<Level1>()
                    .Include(
                        l1 => l1.OneToMany_Optional1.OrderByDescending(x => x.Name).Skip(2).Take(4)
                    )
                    .ThenInclude(l2 => l2.OneToOne_Optional_FK2)
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task Filtered_include_with_Take_without_order_by_followed_by_ThenInclude_and_FirstOrDefault_on_top_level(
        bool async
    ) =>
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task Filtered_include_with_Take_without_order_by_followed_by_ThenInclude_and_unordered_Take_on_top_level(
        bool async
    ) =>
        AssertQuery(
            async,
        ...
        AssertQuery(
            ...
            ss =>
                ss.Set<Level1>()
                    .GroupBy(l => l.Date)
                    .Select(
                        g => new { g.Key, Level1s = g.OrderByDescending(e => e.Name).Take(10) }
                    ),
            elementSorter: e => e.Key,
            elementAsserter: (e, a) =>
            {
        ...
        AssertQuery(
            ...
            ss =>
                ss.Set<Level1>()
                    ...
                    .Select(
                        g =>
                            new { g.Key, Level1s = g.OrderBy(e => e.Name).Skip(1).Take(5).ToList() }
                    ),
            elementSorter: e => e.Key,
            elementAsserter: (e, a) =>
            {
                ...
                AssertCollection(
                    ...
                    elementAsserter: (ee, aa) =>
                        AssertInclude(
                            ee,
                            aa,
                            new ExpectedInclude<Level1>(l => l.OneToMany_Optional1)
                        )
                );
            }
        );
                ...
                AssertCollection(
                    ...
                    elementAsserter: (ee, aa) =>
                        AssertInclude(
                            ee,
                            aa,
                            new ExpectedInclude<Level1>(l => l.OneToOne_Optional_FK1)
                        )
                );
            }
        );
        ...
        AssertQuery(
            ...
            elementAsserter: (e, a) =>
                AssertInclude(
                    ...
                    new ExpectedInclude<Level3>(
                        l3 => l3.OneToOne_Optional_FK3,
                        "OneToOne_Optional_FK1.OneToMany_Optional2"
                    )
                )
        );
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task Include_partially_added_before_Where_and_then_build_upon_with_filtered_include(
        bool async
    ) =>
        AssertQuery(
            async,
            ss =>
                ss.Set<Level1>()
                    .Include(
                        l1 =>
                            l1.OneToOne_Optional_FK1.OneToMany_Optional2.OrderBy(x => x.Id).Take(3)
                    )
                    .Where(l1 => l1.OneToOne_Optional_PK1.Id < 3 || l1.OneToOne_Optional_FK1.Id > 8)
    ...
    public virtual Task Take_on_correlated_collection_in_projection(bool async) =>
        AssertQuery(
            ...
            ss =>
                ss.Set<Level1>()
                    .Select(l1 => new { l1.Id, Collection = l1.OneToMany_Optional1.Take(50) }),
            elementSorter: e => e.Id,
            elementAsserter: (e, a) =>
            {
                AssertEqual(e.Id, a.Id);
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task FirstOrDefault_with_predicate_on_correlated_collection_in_projection(
        bool async
    ) =>
        AssertQuery(
            async,
                ...
                ss.Set<Level1>()
                    .Select(
                        l1 =>
                            ...
                            {
                                l1.Id,
                                Element = l1.OneToMany_Optional1.FirstOrDefault(
                                    l2 => l2.Id == l1.Id
                                )
                            }
                    ),
                                    ...
                                    .Select(
                                        lc1 =>
                                            new
                                            {
                                                ...
                                                IsLevel2There = lc1.OneToMany_Optional1.Any(
                                                    l2 => l2.Id == 2
                                                )
                                            }
                                    )
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task Projecting_collection_after_optional_reference_correlated_with_parent(
        bool async
    ) =>
        AssertQuery(
            async,
                    ...
                    .Select(
                        l1 =>
                            new
                            {
                                ...
                                Collection = l1.Maybe(
                                    x =>
                                        x.OneToOne_Optional_FK1.Maybe(
                                            xx =>
                                                xx.OneToMany_Optional2.Select(
                                                    l3 =>
                                                        new
                                                        {
                                                            ChildId = (int)
                                                                l3.MaybeScalar(xxx => xxx.Id),
                                                            ParentName = l1.OneToOne_Optional_FK1.Maybe(
                                                                xxx => xxx.Name
                                                            )
                                                        }
                                                )
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task Projecting_collection_with_group_by_after_optional_reference_correlated_with_parent(
        bool async
    ) =>
        AssertQuery(
            async,
                    ...
                    .Select(
                        l1 =>
                            new
                            {
                                ...
                                Collection = l1.OneToOne_Optional_FK1.OneToMany_Optional2
                                    .GroupBy(x => x.Name)
    ...
    public virtual Task Final_GroupBy_property_entity_Include_collection_multiple(bool async) =>
        AssertQuery(
            ...
            ss =>
                ss.Set<Level1>()
                    .Include(l1 => l1.OneToMany_Optional1)
                    .Include(l1 => l1.OneToMany_Required1)
                    .GroupBy(l1 => l1.Name),
            elementSorter: e => e.Key,
            elementAsserter: (e, a) =>
                AssertGrouping(
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task Final_GroupBy_property_entity_Include_collection_reference_same_level(
        bool async
    ) =>
        AssertQuery(
            async,
    ...
    public virtual Task Final_GroupBy_property_entity_Include_reference_multiple(bool async) =>
        AssertQuery(
            ...
            ss =>
                ss.Set<Level1>()
                    .Include(l1 => l1.OneToOne_Optional_FK1)
                    .Include(l1 => l1.OneToOne_Required_FK1)
                    .GroupBy(l1 => l1.Name),
            elementSorter: e => e.Key,
            elementAsserter: (e, a) =>
                AssertGrouping(
