        ...
        IFilteredQueryFixtureBase
{
    ...
    protected override string StoreName => "InheritanceTest";

    public virtual bool EnableFilters => false;

    public virtual bool IsDiscriminatorMappingComplete => true;

    public virtual bool HasDiscriminator => true;

    public virtual bool UseGeneratedKeys => true;

    public virtual bool EnableComplexTypes => true;
    ...
    public virtual ISetSource GetExpectedData() =>
        UseGeneratedKeys ? InheritanceData.GeneratedKeysInstance : InheritanceData.Instance;
                ...
                (e, a) =>
                {
                    ...
                    if (a != null)
                    {
                        ...
                        if (ee.AdditionalInfo is not null)
                        {
                            ...
                            Assert.Equal(
                                ee.AdditionalInfo.LeafStructure is null,
                                aa.AdditionalInfo.LeafStructure is null
                            );
                            if (ee.AdditionalInfo.LeafStructure is not null)
                            {
                                Assert.Equal(
                                    ee.AdditionalInfo.LeafStructure.NumLeaves,
                                    aa.AdditionalInfo.LeafStructure!.NumLeaves
                                );
                                Assert.Equal(
                                    ee.AdditionalInfo.LeafStructure.AreLeavesBig,
                                    aa.AdditionalInfo.LeafStructure.AreLeavesBig
                                );
                            }
                        }
                    }
