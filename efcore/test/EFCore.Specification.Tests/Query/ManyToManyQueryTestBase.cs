        ...
        where TFixture : ManyToManyQueryFixtureBase, new()
    {
        ...
        public virtual Task Skip_navigation_any_with_predicate(bool async)
        {
            return AssertQuery(
                async,
                ss =>
                    ss.Set<EntityOne>().Where(e => e.TwoSkipShared.Any(e => e.Name.Contains("B"))),
                entryCount: 0
            );
        }
        ...
        public virtual Task Skip_navigation_contains(bool async)
        {
            return AssertQuery(
                ...
                ss =>
                    ss.Set<EntityOne>()
                        .Where(
                            e => e.ThreeSkipPayloadFullShared.Contains(new EntityThree { Id = 1 })
                        ),
                ss =>
                    ss.Set<EntityOne>()
        ...
        public virtual Task Skip_navigation_select_many_average(bool async)
        {
            return AssertAverage(
                ...
                ss =>
                    ss.Set<EntityTwo>()
                        .SelectMany(e => e.CompositeKeySkipShared.Select(e => e.Key1))
            );
        }
        ...
        public virtual Task Skip_navigation_select_many_max(bool async)
        {
            return AssertMax(
                ...
                ss =>
                    ss.Set<EntityThree>()
                        .SelectMany(e => e.CompositeKeySkipFull.Select(e => e.Key1)),
                entryCount: 0
            );
        }
        ...
        public virtual Task Skip_navigation_order_by_first_or_default(bool async)
        {
            return AssertQuery(
                ...
                ss =>
                    ss.Set<EntityThree>()
                        .Select(
                            e => e.OneSkipPayloadFullShared.OrderBy(i => i.Id).FirstOrDefault()
                        ),
                entryCount: 12
            );
        }
        ...
        public virtual Task Skip_navigation_order_by_last_or_default(bool async)
        {
            return AssertQuery(
                ...
                ss =>
                    ss.Set<EntityBranch>()
                        .Select(e => e.OneSkip.OrderBy(i => i.Id).LastOrDefault()),
                entryCount: 6
            );
        }
