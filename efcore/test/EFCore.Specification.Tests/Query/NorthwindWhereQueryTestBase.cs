    ...
    where TFixture : NorthwindQueryFixtureBase<NoopModelCustomizer>, new()
{
    ...
    public virtual Task Where_simple(bool async) =>
        AssertQuery(async, ss => ss.Set<Customer>().Where(c => c.City == "London"));
    ...
    public virtual Task Where_as_queryable_expression(bool async) =>
        AssertQuery(async, ss =>
            ss.Set<Customer>().Where(c => c.Orders.AsQueryable().Any(_filter))
        );
    ...
    public virtual async Task<string> Where_simple_closure(bool async)
    {
        ...
        await AssertQuery(async, ss => ss.Set<Customer>().Where(c => c.City == city));
    ...
    public virtual Task Where_indexer_closure(bool async)
    {
        ...
        return AssertQuery(async, ss => ss.Set<Customer>().Where(c => c.City == cities[0]));
    }
    ...
    public virtual Task Where_dictionary_key_access_closure(bool async)
    {
        ...
        return AssertQuery(async, ss =>
            ss.Set<Customer>().Where(c => c.City == predicateMap["City"])
        );
    }
    ...
    public virtual Task Where_tuple_item_closure(bool async)
    {
        ...
        return AssertQuery(async, ss =>
            ss.Set<Customer>().Where(c => c.City == predicateTuple.Item2)
        );
    }
    ...
    public virtual Task Where_named_tuple_item_closure(bool async)
    {
        ...
        return AssertQuery(async, ss =>
            ss.Set<Customer>().Where(c => c.City == predicateTuple.City)
        );
    }
    ...
    public virtual Task Where_simple_closure_constant(bool async)
    {
        ...
        return AssertQuery(async, ss => ss.Set<Customer>().Where(c => predicate));
    }
    ...
    public virtual async Task Where_method_call_nullable_type_closure_via_query_cache(bool async)
    {
        ...
        await AssertQuery(async, ss => ss.Set<Employee>().Where(e => e.ReportsTo == city.Int));
    ...
    )
    {
        ...
        await AssertQuery(async, ss =>
            ss.Set<Employee>().Where(e => e.EmployeeID > city.NullableInt)
        );
    ...
    public virtual async Task Where_method_call_closure_via_query_cache(bool async)
    {
        ...
        await AssertQuery(async, ss => ss.Set<Customer>().Where(c => c.City == city.GetCity()));
    ...
    public virtual async Task Where_field_access_closure_via_query_cache(bool async)
    {
        ...
        await AssertQuery(async, ss =>
            ss.Set<Customer>().Where(c => c.City == city.InstanceFieldValue)
        );
    ...
    public virtual async Task Where_property_access_closure_via_query_cache(bool async)
    {
        ...
        await AssertQuery(async, ss =>
            ss.Set<Customer>().Where(c => c.City == city.InstancePropertyValue)
        );
    ...
    public virtual async Task Where_static_field_access_closure_via_query_cache(bool async)
    {
        ...
        await AssertQuery(async, ss =>
            ss.Set<Customer>().Where(c => c.City == City.StaticFieldValue)
        );
    ...
    public virtual async Task Where_static_property_access_closure_via_query_cache(bool async)
    {
        ...
        await AssertQuery(async, ss =>
            ss.Set<Customer>().Where(c => c.City == City.StaticPropertyValue)
        );
    ...
    public virtual async Task Where_nested_field_access_closure_via_query_cache(bool async)
    {
        ...
        await AssertQuery(async, ss =>
            ss.Set<Customer>().Where(c => c.City == city.Nested.InstanceFieldValue)
        );
    ...
    public virtual async Task Where_nested_property_access_closure_via_query_cache(bool async)
    {
        ...
        await AssertQuery(async, ss =>
            ss.Set<Customer>().Where(c => c.City == city.Nested.InstancePropertyValue)
        );
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task Where_nested_field_access_closure_via_query_cache_error_method_null(
        bool async
    )
    {
        var city = new City();
        ...
        return Assert.ThrowsAsync<InvalidOperationException>(() =>
            AssertQuery(async, ss =>
                ss.Set<Customer>().Where(c => c.City == city.Throw().InstanceFieldValue)
            )
        );
    }
    ...
    public virtual async Task Where_new_instance_field_access_query_cache(bool async)
    {
        await AssertQuery(async, ss =>
            ss.Set<Customer>()
                .Where(c => c.City == new City { InstanceFieldValue = "London" }.InstanceFieldValue)
        );
    ...
    public virtual async Task Where_new_instance_field_access_closure_via_query_cache(bool async)
    {
        ...
        await AssertQuery(async, ss =>
            ss.Set<Customer>()
                .Where(c => c.City == new City { InstanceFieldValue = city }.InstanceFieldValue)
        );
    ...
    private class City
    {
        ...
        public City Throw() => throw new NotImplementedException();

        public string GetCity() => InstanceFieldValue;
    }
    ...
    public virtual async Task Where_simple_closure_via_query_cache_nullable_type(bool async)
    {
        ...
        await AssertQuery(async, ss => ss.Set<Employee>().Where(e => e.ReportsTo == reportsTo));
    ...
    public virtual Task Where_bitwise_xor(bool async) =>
        AssertQuery(async, ss => ss.Set<Customer>().Where(c => (c.CustomerID == "ALFKI") ^ true));

    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task Where_simple_shadow(bool async) =>
        AssertQuery(async, ss =>
            ss.Set<Employee>().Where(e => EF.Property<string>(e, "Title") == "Sales Representative")
        );
    ...
    public virtual Task Where_client(bool async) =>
        AssertTranslationFailedWithDetails(
            () => AssertQuery(async, ss => ss.Set<Customer>().Where(c => c.IsLondon)),
        ...
        AssertTranslationFailed(() =>
            AssertQuery(async, ss =>
                ss.Set<Customer>()
                    ...
                    .Take(5)
                    .Where(c1 =>
                        ss.Set<Customer>().Any(c2 => c1.CustomerID == c2.CustomerID && c2.IsLondon)
                    )
            )
        );
    ...
    public virtual Task Where_client_and_server_top_level(bool async) =>
        AssertTranslationFailedWithDetails(
            () =>
                AssertQuery(async, ss =>
                    ss.Set<Customer>().Where(c => c.IsLondon && c.CustomerID != "AROUT")
                ),
            CoreStrings.QueryUnableToTranslateMember(nameof(Customer.IsLondon), nameof(Customer))
        );
    ...
    public virtual Task Where_client_or_server_top_level(bool async) =>
        AssertTranslationFailedWithDetails(
            () =>
                AssertQuery(async, ss =>
                    ss.Set<Customer>().Where(c => c.IsLondon || c.CustomerID == "ALFKI")
                ),
            CoreStrings.QueryUnableToTranslateMember(nameof(Customer.IsLondon), nameof(Customer))
        );
            ...
            () =>
                AssertQuery(async, ss =>
                    ss.Set<Customer>()
                        .Where(c =>
                            c.CustomerID != "ALFKI"
                            && (c.CustomerID == "MAUMAR" || (c.CustomerID != "AROUT" && c.IsLondon))
                        )
                ),
            CoreStrings.QueryUnableToTranslateMember(nameof(Customer.IsLondon), nameof(Customer))
        );
    ...
    public virtual Task Where_equals_method_string(bool async) =>
        AssertQuery(async, ss => ss.Set<Customer>().Where(c => c.City.Equals("London")));
    ...
    public virtual Task Where_equals_method_int(bool async) =>
        AssertQuery(async, ss => ss.Set<Employee>().Where(e => e.EmployeeID.Equals(1)));
    ...
    public virtual Task Where_equals_using_int_overload_on_mismatched_types(bool async)
    {
        ...
        return AssertQuery(async, ss =>
            ss.Set<Employee>().Where(e => e.EmployeeID.Equals(shortPrm))
        );
    }
    ...
    public virtual async Task Where_equals_on_mismatched_types_int_nullable_int(bool async)
    {
        ...
        await AssertQuery(async, ss => ss.Set<Employee>().Where(e => e.ReportsTo.Equals(intPrm)));

        await AssertQuery(async, ss => ss.Set<Employee>().Where(e => intPrm.Equals(e.ReportsTo)));
    }
    ...
    public virtual async Task Where_equals_on_matched_nullable_int_types(bool async)
    {
        ...
        await AssertQuery(async, ss =>
            ss.Set<Employee>().Where(e => nullableIntPrm.Equals(e.ReportsTo))
        );

        await AssertQuery(async, ss =>
            ss.Set<Employee>().Where(e => e.ReportsTo.Equals(nullableIntPrm))
        );
    }
    ...
    public virtual Task Where_comparison_nullable_type_not_null(bool async) =>
        AssertQuery(async, ss => ss.Set<Employee>().Where(e => e.ReportsTo == 2));

    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task Where_comparison_nullable_type_null(bool async) =>
        AssertQuery(async, ss => ss.Set<Employee>().Where(e => e.ReportsTo == null));

    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task Where_string_length(bool async) =>
        AssertQuery(async, ss => ss.Set<Customer>().Where(c => c.City.Length == 6));

    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task Where_string_indexof(bool async) =>
        AssertQuery(async, ss => ss.Set<Customer>().Where(c => c.City.IndexOf("Sea") != -1));

    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task Where_string_replace(bool async) =>
        AssertQuery(async, ss =>
            ss.Set<Customer>().Where(c => c.City.Replace("Sea", "Rea") == "Reattle")
        );

    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task Where_string_substring(bool async) =>
        AssertQuery(async, ss => ss.Set<Customer>().Where(c => c.City.Substring(1, 2) == "ea"));
    ...
    public virtual Task Where_datetime_now(bool async)
    {
        ...
        return AssertQuery(async, ss => ss.Set<Customer>().Where(c => DateTime.Now != myDatetime));
    }
    ...
    public virtual Task Where_datetime_utcnow(bool async)
    {
        ...
        return AssertQuery(async, ss =>
            ss.Set<Customer>().Where(c => DateTime.UtcNow != myDatetime)
        );
    }
    ...
    public virtual Task Where_datetimeoffset_utcnow(bool async)
    {
        ...
        return AssertQuery(async, ss =>
            ss.Set<Customer>().Where(c => DateTimeOffset.UtcNow != myDatetimeOffset)
        );
    }
    ...
    public virtual Task Where_datetime_today(bool async) =>
        AssertQuery(async, ss =>
            ss.Set<Employee>().Where(e => DateTime.Now.Date == DateTime.Today)
        );
    ...
    public virtual Task Where_datetime_date_component(bool async)
    {
        ...
        return AssertQuery(async, ss =>
            ss.Set<Order>().Where(o => o.OrderDate.Value.Date == myDatetime)
        );
    }
    ...
    public virtual Task Where_date_add_year_constant_component(bool async) =>
        AssertQuery(async, ss =>
            ss.Set<Order>().Where(o => o.OrderDate.Value.AddYears(-1).Year == 1997)
        );

    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task Where_datetime_year_component(bool async) =>
        AssertQuery(async, ss => ss.Set<Order>().Where(o => o.OrderDate.Value.Year == 1998));

    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task Where_datetime_month_component(bool async) =>
        AssertQuery(async, ss => ss.Set<Order>().Where(o => o.OrderDate.Value.Month == 4));

    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task Where_datetime_dayOfYear_component(bool async) =>
        AssertQuery(async, ss => ss.Set<Order>().Where(o => o.OrderDate.Value.DayOfYear == 68));

    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task Where_datetime_day_component(bool async) =>
        AssertQuery(async, ss => ss.Set<Order>().Where(o => o.OrderDate.Value.Day == 4));

    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task Where_datetime_hour_component(bool async) =>
        AssertQuery(async, ss => ss.Set<Order>().Where(o => o.OrderDate.Value.Hour == 0));

    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task Where_datetime_minute_component(bool async) =>
        AssertQuery(async, ss => ss.Set<Order>().Where(o => o.OrderDate.Value.Minute == 0));

    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task Where_datetime_second_component(bool async) =>
        AssertQuery(async, ss => ss.Set<Order>().Where(o => o.OrderDate.Value.Second == 0));

    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task Where_datetime_millisecond_component(bool async) =>
        AssertQuery(async, ss => ss.Set<Order>().Where(o => o.OrderDate.Value.Millisecond == 0));

    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task Where_datetimeoffset_now_component(bool async) =>
        AssertQuery(async, ss => ss.Set<Order>().Where(o => o.OrderDate < DateTimeOffset.Now));

    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task Where_datetimeoffset_utcnow_component(bool async) =>
        AssertQuery(async, ss => ss.Set<Order>().Where(o => o.OrderDate != DateTimeOffset.UtcNow));

    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task Where_simple_reversed(bool async) =>
        AssertQuery(async, ss => ss.Set<Customer>().Where(c => "London" == c.City));

    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task Where_is_null(bool async) =>
        AssertQuery(async, ss => ss.Set<Customer>().Where(c => c.Region == null));

    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task Where_null_is_null(bool async) =>
        AssertQuery(async, ss => ss.Set<Customer>().Where(c => null == null));

    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task Where_constant_is_null(bool async) =>
        AssertQuery(async, ss => ss.Set<Customer>().Where(c => "foo" == null), assertEmpty: true);

    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task Where_is_not_null(bool async) =>
        AssertQuery(async, ss => ss.Set<Customer>().Where(c => c.City != null));

    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task Where_null_is_not_null(bool async) =>
        AssertQuery(async, ss => ss.Set<Customer>().Where(c => null != null), assertEmpty: true);

    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task Where_constant_is_not_null(bool async) =>
        AssertQuery(async, ss => ss.Set<Customer>().Where(c => "foo" != null));

    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task Where_identity_comparison(bool async) =>
        AssertQuery(async, ss => ss.Set<Customer>().Where(c => c.City == c.City));
...
#pragma warning restore RCS1032 // Remove redundant parentheses.
    ...
    public virtual Task Where_primitive(bool async) =>
        AssertQueryScalar(async, ss =>
            ss.Set<Employee>().Select(e => e.EmployeeID).Take(9).Where(i => i == 5)
        );

    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task Where_primitive_tracked(bool async) =>
        AssertQuery(async, ss => ss.Set<Employee>().Take(9).Where(e => e.EmployeeID == 5));
    ...
    public virtual Task Where_bool_member(bool async) =>
        AssertQuery(async, ss => ss.Set<Product>().Where(p => p.Discontinued));
    ...
    public virtual Task Where_bool_client_side_negated(bool async) =>
        AssertQuery(async, ss =>
            ss.Set<Product>().Where(p => !ClientFunc(p.ProductID) && p.Discontinued)
        );
...
#pragma warning restore RCS1068 // Simplify logical negation.
    ...
    public virtual Task Where_bool_member_shadow(bool async) =>
        AssertQuery(async, ss =>
            ss.Set<Product>().Where(p => EF.Property<bool>(p, "Discontinued"))
        );
    ...
    public virtual Task Where_bool_member_equals_constant(bool async) =>
        AssertQuery(async, ss => ss.Set<Product>().Where(p => p.Discontinued.Equals(true)));
    ...
    public virtual Task Where_bool_member_in_complex_predicate(bool async) =>
        AssertQuery(async, ss =>
            ss.Set<Product>()
                .Where(p => p.ProductID > 100 && p.Discontinued || (p.Discontinued == true))
        );
    ...
    public virtual Task Where_bool_member_compared_to_binary_expression(bool async) =>
        AssertQuery(async, ss =>
            ss.Set<Product>().Where(p => p.Discontinued == (p.ProductID > 50))
        );

    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task Where_not_bool_member_compared_to_not_bool_member(bool async) =>
        AssertQuery(async, ss => ss.Set<Product>().Where(p => !p.Discontinued == !p.Discontinued));
    ...
    public virtual Task Where_negated_boolean_expression_compared_to_another_negated_boolean_expression(
        ...
        AssertQuery(async, ss =>
            ss.Set<Product>().Where(p => !(p.ProductID > 50) == !(p.ProductID > 20))
        );
    ...
    public virtual Task Where_bool_parameter(bool async)
    {
        ...
        return AssertQuery(async, ss => ss.Set<Product>().Where(p => prm));
    }
    ...
    public virtual Task Where_bool_parameter_compared_to_binary_expression(bool async)
    {
        ...
        return AssertQuery(async, ss => ss.Set<Product>().Where(p => (p.ProductID > 50) != prm));
    }
    ...
    )
    {
        ...
        return AssertQuery(async, ss =>
            ss.Set<Product>().Where(p => p.Discontinued == ((p.ProductID > 50) != prm))
        );
    }
    ...
    public virtual Task Where_de_morgan_or_optimized(bool async) =>
        AssertQuery(async, ss =>
            ss.Set<Product>().Where(p => !(p.Discontinued || (p.ProductID < 20)))
        );
    ...
    public virtual Task Where_complex_negated_expression_optimized(bool async) =>
        AssertQuery(async, ss =>
            ss.Set<Product>()
                .Where(p => !(!(!p.Discontinued && (p.ProductID < 60)) || !(p.ProductID > 30)))
        );

    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task Where_short_member_comparison(bool async) =>
        AssertQuery(async, ss => ss.Set<Product>().Where(p => p.UnitsInStock > 10));

    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task Where_comparison_to_nullable_bool(bool async) =>
        AssertQuery(async, ss =>
            ss.Set<Customer>().Where(c => c.CustomerID.EndsWith("KI") == ((bool?)true))
        );

    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task Where_true(bool async) =>
        AssertQuery(async, ss => ss.Set<Customer>().Where(c => true));

    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task Where_false(bool async) =>
        AssertQuery(async, ss => ss.Set<Customer>().Where(c => false), assertEmpty: true);
    ...
    public virtual async Task Where_bool_closure(bool async)
    {
        ...
        await AssertQuery(async, ss =>
            ss.Set<Customer>().Where(c => c.CustomerID == "ALFKI" && boolean)
        );
    }
    ...
    public virtual async Task Where_poco_closure(bool async)
    {
        ...
        await AssertQuery(async, ss =>
            ss.Set<Customer>().Where(c => c.Equals(customer)).Select(c => c.CustomerID)
        );
    ...
    public virtual Task Where_default(bool async)
    {
        ...
        return AssertQuery(async, ss => ss.Set<Customer>().Where(defaultExpression));
    }
    ...
    public virtual Task Where_expression_invoke_2(bool async)
    {
        ...
        return AssertQuery(async, ss => ss.Set<Order>().Where(exp));
    }
    ...
    public virtual Task Where_expression_invoke_3(bool async)
    {
        ...
        return AssertQuery(async, ss => ss.Set<Customer>().Where(lambda));
    }
    ...
    public virtual Task Where_concat_string_string_comparison(bool async)
    {
        ...
        return AssertQuery(async, ss =>
            ss.Set<Customer>().Where(c => i + c.CustomerID == "AALFKI").Select(c => c.CustomerID)
        );
    }
    ...
    public virtual Task Where_string_concat_method_comparison(bool async)
    {
        ...
        return AssertQuery(async, ss =>
            ss.Set<Customer>()
                .Where(c => string.Concat(i, c.CustomerID) == "AAROUT")
                .Select(c => c.CustomerID)
        );
    }
    ...
    public virtual Task Where_string_concat_method_comparison_2(bool async)
    {
        ...
        return AssertQuery(async, ss =>
            ss.Set<Customer>()
                .Where(c => string.Concat(i, j, c.CustomerID) == "ABANATR")
                .Select(c => c.CustomerID)
        );
    }
    ...
    public virtual Task Where_string_concat_method_comparison_3(bool async)
    {
        ...
        return AssertQuery(async, ss =>
            ss.Set<Customer>()
                .Where(c => string.Concat(i, j, k, c.CustomerID) == "ABCANTON")
                .Select(c => c.CustomerID)
        );
    }
    ...
    public virtual Task Where_ternary_boolean_condition_with_another_condition(bool async)
    {
        ...
        return AssertQuery(async, ss =>
            ss.Set<Product>()
                .Where(p =>
                    p.ProductID < productId && (flag ? p.UnitsInStock >= 20 : p.UnitsInStock < 20)
                )
        );
    }
    ...
    public virtual Task Where_ternary_boolean_condition_with_false_as_result_true(bool async)
    {
        ...
        return AssertQuery(async, ss =>
            ss.Set<Product>().Where(p => flag ? p.UnitsInStock >= 20 : false)
        );
    }
    ...
    public virtual Task Where_compare_null(bool async) =>
        AssertQuery(async, ss =>
            ss.Set<Customer>().Where(c => c.Region == null && c.Country == "UK")
        );

    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task Where_compare_null_with_cast_to_object(bool async) =>
        AssertQuery(async, ss => ss.Set<Customer>().Where(c => (object)c.Region == null));
    ...
    public virtual Task Where_projection(bool async) =>
        AssertQuery(async, ss =>
            ss.Set<Customer>().Where(c => c.City == "London").Select(c => c.CompanyName)
        );
    ...
    public virtual Task Where_array_index(bool async)
    {
        ...
        return AssertQuery(async, ss =>
            ss.Set<Customer>().Where(c => c.CustomerID == customers[0])
        );
    }
    ...
    public virtual Task Where_contains_on_navigation(bool async) =>
        AssertQuery(async, ss =>
            ss.Set<Order>().Where(o => ss.Set<Customer>().Any(c => c.Orders.Contains(o)))
        );
    ...
    public virtual Task Where_subquery_FirstOrDefault_is_null(bool async) =>
        AssertQuery(async, ss =>
            ss.Set<Customer>().Where(c => c.Orders.OrderBy(o => o.OrderID).FirstOrDefault() == null)
        );
    ...
    public virtual Task Where_subquery_FirstOrDefault_compared_to_entity(bool async) =>
        AssertQuery(
            ...
            ss =>
                ss.Set<Customer>()
                    .Where(c => c.Orders.OrderBy(o => o.OrderID).FirstOrDefault().OrderID == 10276)
        );
...
#pragma warning restore CS0184 // 'is' expression's given expression is never of the provided type
    ...
    public virtual Task Decimal_cast_to_double_works(bool async)
    {
        ...
        return AssertQuery(async, ss => ss.Set<Product>().Where(p => (double?)p.UnitPrice > 100));
    }
    ...
    public virtual async Task Enclosing_class_settable_member_generates_parameter(bool async)
    {
        ...
        await AssertQuery(async, ss => ss.Set<Order>().Where(o => o.OrderID == SettableProperty));
    ...
    public virtual Task Enclosing_class_readonly_member_generates_parameter(bool async) =>
        AssertQuery(async, ss => ss.Set<Order>().Where(o => o.OrderID == ReadOnlyProperty));

    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task Enclosing_class_const_member_does_not_generate_parameter(bool async) =>
        AssertQuery(async, ss => ss.Set<Order>().Where(o => o.OrderID == ConstantProperty));
    ...
    public virtual Task Generic_Ilist_contains_translates_to_server(bool async)
    {
        ...
        return AssertQuery(async, ss => ss.Set<Customer>().Where(c => cities.Contains(c.City)));
    }

    private int SettableProperty { get; set; }

    private int ReadOnlyProperty => 10275;
    ...
    public virtual Task Using_same_parameter_twice_in_query_generates_one_sql_parameter(bool async)
    {
        ...
        return AssertQuery(async, ss =>
            ss.Set<Customer>()
                .Where(c => i + c.CustomerID + i == "10ALFKI10")
                .Select(c => c.CustomerID)
        );
    }
    ...
    public virtual Task Where_list_object_contains_over_value_type(bool async)
    {
        ...
        return AssertQuery(async, ss => ss.Set<Order>().Where(o => orderIds.Contains(o.OrderID)));
    }
    ...
    )
    {
        ...
        return AssertQuery(async, ss =>
            ss.Set<Customer>()
                .Where(c => new[] { prm1, prm2 }.Contains(c.CustomerID) || c.CustomerID == "ANTON")
        );
    }
    ...
    public virtual Task Parameter_array_Contains_OrElse_comparison_with_constant(bool async)
    {
        ...
        return AssertQuery(async, ss =>
            ss.Set<Customer>().Where(c => array.Contains(c.CustomerID) || c.CustomerID == "ANTON")
        );
    }
    ...
    public virtual Task Filter_with_EF_Property_using_closure_for_property_name(bool async)
    {
        ...
        return AssertQuery(async, ss =>
            ss.Set<Customer>().Where(c => EF.Property<string>(c, id) == "ALFKI")
        );
    }
    ...
    public virtual Task Filter_with_EF_Property_using_function_for_property_name(bool async) =>
        AssertQuery(async, ss =>
            ss.Set<Customer>()
                .Where(c => EF.Property<string>(c, StringMethod("CustomerID")) == "ALFKI")
        );
    ...
    public virtual Task FirstOrDefault_over_scalar_projection_compared_to_null(bool async) =>
        AssertQuery(async, ss =>
            ss.Set<Customer>()
                .Where(c => c.Orders.Select(o => (int?)o.OrderID).FirstOrDefault() == null)
        );
    ...
    public virtual Task FirstOrDefault_over_custom_projection_compared_to_null(bool async) =>
        AssertQuery(async, ss =>
            ss.Set<Customer>()
                .Where(c => c.Orders.Select(o => new { o.OrderID }).FirstOrDefault() == null)
        );
    ...
    public virtual Task SingleOrDefault_over_custom_projection_compared_to_null(bool async) =>
        AssertQuery(
            ...
            ss =>
                ss.Set<Customer>()
                    .Where(c => c.Orders.Select(o => new { o.OrderID }).SingleOrDefault() == null),
            ss =>
                ss.Set<Customer>()
                    .Where(c => c.Orders.Select(o => new { o.OrderID }).FirstOrDefault() == null)
        );
    ...
    public virtual Task LastOrDefault_over_custom_projection_compared_to_null(bool async) =>
        AssertQuery(async, ss =>
            ss.Set<Customer>()
                .Where(c => c.Orders.Select(o => new { o.OrderID }).LastOrDefault() == null)
        );
    ...
    public virtual Task First_over_custom_projection_compared_to_null(bool async) =>
        AssertQuery(
            ...
            ss =>
                ss.Set<Customer>()
                    .Where(c => c.Orders.Select(o => new { o.OrderID }).First() == null),
            ss =>
                ss.Set<Customer>()
                    .Where(c => c.Orders.Select(o => new { o.OrderID }).FirstOrDefault() == null)
        );
    ...
    public virtual Task Single_over_custom_projection_compared_to_null(bool async) =>
        AssertQuery(
            ...
            ss =>
                ss.Set<Customer>()
                    .Where(c => c.Orders.Select(o => new { o.OrderID }).Single() == null),
            ss =>
                ss.Set<Customer>()
                    .Where(c => c.Orders.Select(o => new { o.OrderID }).FirstOrDefault() == null)
        );
    ...
    public virtual Task Last_over_custom_projection_compared_to_null(bool async) =>
        AssertQuery(
            ...
            ss =>
                ss.Set<Customer>()
                    .Where(c => c.Orders.Select(o => new { o.OrderID }).Last() == null),
            ss =>
                ss.Set<Customer>()
                    .Where(c => c.Orders.Select(o => new { o.OrderID }).LastOrDefault() == null)
        );
    ...
    private string StringMethod(string arg) => arg;
    ...
    public virtual Task Where_Contains_and_comparison(bool async)
    {
        ...
        return AssertQuery(async, ss =>
            ss.Set<Customer>().Where(c => customerIds.Contains(c.CustomerID) && c.City == "Seattle")
        );
    }
    ...
    public virtual Task Where_Like_and_comparison(bool async) =>
        AssertQuery(
            ...
            ss =>
                ss.Set<Customer>()
                    .Where(c => EF.Functions.Like(c.CustomerID, "F%") && c.City == "Seattle"),
            ss =>
                ss.Set<Customer>().Where(c => c.CustomerID.StartsWith("F") && c.City == "Seattle"),
            assertEmpty: true
        );
    ...
    public virtual Task GetType_on_non_hierarchy1(bool async) =>
        AssertQuery(async, ss => ss.Set<Customer>().Where(c => c.GetType() == typeof(Customer)));
    ...
    public virtual Task GetType_on_non_hierarchy4(bool async) =>
        AssertQuery(async, ss => ss.Set<Customer>().Where(c => c.GetType() != typeof(Order)));
...
#pragma warning disable IDE0029 // Use coalesce expression
        =>
        AssertQuery(async, ss =>
            ss.Set<Customer>().Where(c => (c.Region == null ? "OR" : c.Region) == "OR")
        );
#pragma warning restore IDE0029 // Use coalesce expression
    ...
    public virtual async Task EF_Constant_with_non_evaluatable_argument_throws(bool async)
    {
        var exception = await Assert.ThrowsAsync<InvalidOperationException>(() =>
            AssertQuery(async, ss =>
                ss.Set<Customer>().Where(c => c.CustomerID == EF.Constant(c.CustomerID))
            )
        );
    ...
    public virtual async Task EF_Parameter_with_non_evaluatable_argument_throws(bool async)
    {
        var exception = await Assert.ThrowsAsync<InvalidOperationException>(() =>
            AssertQuery(async, ss =>
                ss.Set<Customer>().Where(c => c.CustomerID == EF.Parameter(c.CustomerID))
            )
        );
