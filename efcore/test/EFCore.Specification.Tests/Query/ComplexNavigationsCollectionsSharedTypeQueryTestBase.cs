...
{
    public abstract class ComplexNavigationsCollectionsSharedTypeQueryTestBase<TFixture>
        ...
        where TFixture : ComplexNavigationsSharedTypeQueryFixtureBase, new()
    {
        ...
        public override Task Multiple_complex_includes_self_ref(bool async) => Task.CompletedTask;
        ...
        public override Task Include_inside_subquery(bool async) => Task.CompletedTask;
        ...
        public override Task Required_navigation_with_Include(bool async) => Task.CompletedTask;
