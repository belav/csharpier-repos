        ...
        new()
{
    ...
    public virtual Task Inline_collection_of_ints_Contains(bool async) =>
        AssertQuery(async, ss =>
            ss.Set<PrimitiveCollectionsEntity>().Where(c => new[] { 10, 999 }.Contains(c.Int))
        );
    ...
    public virtual Task Inline_collection_of_nullable_ints_Contains(bool async) =>
        AssertQuery(async, ss =>
            ss.Set<PrimitiveCollectionsEntity>()
                .Where(c => new int?[] { 10, 999 }.Contains(c.NullableInt))
        );
    ...
    public virtual Task Inline_collection_of_nullable_ints_Contains_null(bool async) =>
        AssertQuery(async, ss =>
            ss.Set<PrimitiveCollectionsEntity>()
                .Where(c => new int?[] { null, 999 }.Contains(c.NullableInt))
        );
    ...
    public virtual Task Inline_collection_Count_with_zero_values(bool async) =>
        AssertQuery(
            ...
            ss =>
                ss.Set<PrimitiveCollectionsEntity>()
                    .Where(c => new int[0].Count(i => i > c.Id) == 1)
        );
    ...
    public virtual Task Inline_collection_Count_with_one_value(bool async) =>
        AssertQuery(async, ss =>
            ss.Set<PrimitiveCollectionsEntity>().Where(c => new[] { 2 }.Count(i => i > c.Id) == 1)
        );
    ...
    public virtual Task Inline_collection_Count_with_two_values(bool async) =>
        AssertQuery(async, ss =>
            ss.Set<PrimitiveCollectionsEntity>()
                .Where(c => new[] { 2, 999 }.Count(i => i > c.Id) == 1)
        );
    ...
    public virtual Task Inline_collection_Count_with_three_values(bool async) =>
        AssertQuery(async, ss =>
            ss.Set<PrimitiveCollectionsEntity>()
                .Where(c => new[] { 2, 999, 1000 }.Count(i => i > c.Id) == 2)
        );
    ...
    public virtual Task Inline_collection_Contains_with_one_value(bool async) =>
        AssertQuery(async, ss =>
            ss.Set<PrimitiveCollectionsEntity>().Where(c => new[] { 2 }.Contains(c.Id))
        );
    ...
    public virtual Task Inline_collection_Contains_with_two_values(bool async) =>
        AssertQuery(async, ss =>
            ss.Set<PrimitiveCollectionsEntity>().Where(c => new[] { 2, 999 }.Contains(c.Id))
        );
    ...
    public virtual Task Inline_collection_Contains_with_three_values(bool async) =>
        AssertQuery(async, ss =>
            ss.Set<PrimitiveCollectionsEntity>().Where(c => new[] { 2, 999, 1000 }.Contains(c.Id))
        );
    ...
    public virtual Task Inline_collection_Contains_with_EF_Constant(bool async)
    {
        ...
        return AssertQuery(
            ...
            ss =>
                ss.Set<PrimitiveCollectionsEntity>()
                    .Where(c => new[] { 2, 99, 1000 }.Contains(c.Id))
        );
    }
    ...
    public virtual Task Inline_collection_Contains_with_all_parameters(bool async)
    {
        ...
        return AssertQuery(async, ss =>
            ss.Set<PrimitiveCollectionsEntity>().Where(c => new[] { i, j }.Contains(c.Id))
        );
    }
    ...
    public virtual Task Inline_collection_Contains_with_constant_and_parameter(bool async)
    {
        ...
        return AssertQuery(async, ss =>
            ss.Set<PrimitiveCollectionsEntity>().Where(c => new[] { 2, j }.Contains(c.Id))
        );
    }
    ...
    public virtual async Task Inline_collection_Contains_with_mixed_value_types(bool async)
    {
        ...
        await AssertQuery(async, ss =>
            ss.Set<PrimitiveCollectionsEntity>()
                .Where(c => new[] { 999, i, c.Id, c.Id + c.Int }.Contains(c.Int))
        );
    }
    ...
    public virtual Task Inline_collection_Contains_as_Any_with_predicate(bool async) =>
        AssertQuery(async, ss =>
            ss.Set<PrimitiveCollectionsEntity>().Where(c => new[] { 2, 999 }.Any(i => i == c.Id))
        );
    ...
    public virtual Task Inline_collection_negated_Contains_as_All(bool async) =>
        AssertQuery(async, ss =>
            ss.Set<PrimitiveCollectionsEntity>().Where(c => new[] { 2, 999 }.All(i => i != c.Id))
        );
    ...
    public virtual async Task Inline_collection_Min_with_two_values(bool async) =>
        await AssertQuery(async, ss =>
            ss.Set<PrimitiveCollectionsEntity>().Where(c => new[] { 30, c.Int }.Min() == 30)
        );
    ...
    public virtual async Task Inline_collection_Max_with_two_values(bool async) =>
        await AssertQuery(async, ss =>
            ss.Set<PrimitiveCollectionsEntity>().Where(c => new[] { 30, c.Int }.Max() == 30)
        );
    ...
    public virtual async Task Inline_collection_Min_with_three_values(bool async)
    {
        ...
        await AssertQuery(async, ss =>
            ss.Set<PrimitiveCollectionsEntity>().Where(c => new[] { 30, c.Int, i }.Min() == 25)
        );
    }
    ...
    public virtual async Task Inline_collection_Max_with_three_values(bool async)
    {
        ...
        await AssertQuery(async, ss =>
            ss.Set<PrimitiveCollectionsEntity>().Where(c => new[] { 30, c.Int, i }.Max() == 35)
        );
    }
    ...
    public virtual Task Parameter_collection_Count(bool async)
    {
        ...
        return AssertQuery(async, ss =>
            ss.Set<PrimitiveCollectionsEntity>().Where(c => ids.Count(i => i > c.Id) == 1)
        );
    }
    ...
    public virtual Task Parameter_collection_of_ints_Contains(bool async)
    {
        ...
        return AssertQuery(async, ss =>
            ss.Set<PrimitiveCollectionsEntity>().Where(c => ints.Contains(c.Int))
        );
    }
    ...
    public virtual Task Parameter_collection_of_nullable_ints_Contains_int(bool async)
    {
        ...
        return AssertQuery(async, ss =>
            ss.Set<PrimitiveCollectionsEntity>().Where(c => nullableInts.Contains(c.Int))
        );
    }
    ...
    public virtual Task Parameter_collection_of_nullable_ints_Contains_nullable_int(bool async)
    {
        ...
        return AssertQuery(async, ss =>
            ss.Set<PrimitiveCollectionsEntity>().Where(c => nullableInts.Contains(c.NullableInt))
        );
    }
    ...
    public virtual Task Parameter_collection_of_strings_Contains_non_nullable_string(bool async)
    {
        ...
        return AssertQuery(async, ss =>
            ss.Set<PrimitiveCollectionsEntity>().Where(c => strings.Contains(c.String))
        );
    }
    ...
    public virtual Task Parameter_collection_of_strings_Contains_nullable_string(bool async)
    {
        ...
        return AssertQuery(async, ss =>
            ss.Set<PrimitiveCollectionsEntity>().Where(c => strings.Contains(c.NullableString))
        );
    }
    ...
    public virtual Task Parameter_collection_of_DateTimes_Contains(bool async)
    {
        ...
        return AssertQuery(async, ss =>
            ss.Set<PrimitiveCollectionsEntity>().Where(c => dateTimes.Contains(c.DateTime))
        );
    }
    ...
    public virtual Task Parameter_collection_of_bools_Contains(bool async)
    {
        ...
        return AssertQuery(async, ss =>
            ss.Set<PrimitiveCollectionsEntity>().Where(c => bools.Contains(c.Bool))
        );
    }
    ...
    public virtual Task Parameter_collection_of_enums_Contains(bool async)
    {
        ...
        return AssertQuery(async, ss =>
            ss.Set<PrimitiveCollectionsEntity>().Where(c => enums.Contains(c.Enum))
        );
    }
    ...
    public virtual Task Column_collection_of_ints_Contains(bool async) =>
        AssertQuery(async, ss =>
            ss.Set<PrimitiveCollectionsEntity>().Where(c => c.Ints.Contains(10))
        );
    ...
    public virtual Task Column_collection_of_nullable_ints_Contains(bool async) =>
        AssertQuery(async, ss =>
            ss.Set<PrimitiveCollectionsEntity>().Where(c => c.NullableInts.Contains(10))
        );
    ...
    public virtual Task Column_collection_of_nullable_ints_Contains_null(bool async) =>
        AssertQuery(async, ss =>
            ss.Set<PrimitiveCollectionsEntity>().Where(c => c.NullableInts.Contains(null))
        );
    ...
    public virtual Task Column_collection_of_nullable_strings_contains_null(bool async) =>
        AssertQuery(async, ss =>
            ss.Set<PrimitiveCollectionsEntity>().Where(c => c.NullableStrings.Contains(null))
        );
    ...
    public virtual Task Column_collection_of_bools_Contains(bool async) =>
        AssertQuery(async, ss =>
            ss.Set<PrimitiveCollectionsEntity>().Where(c => c.Bools.Contains(true))
        );
    ...
    public virtual Task Column_collection_Length(bool async) =>
        AssertQuery(async, ss =>
            ss.Set<PrimitiveCollectionsEntity>().Where(c => c.Ints.Length == 2)
        );
    ...
    public virtual Task Column_collection_index_int(bool async) =>
        AssertQuery(
            ...
            ss =>
                ss.Set<PrimitiveCollectionsEntity>()
                    .Where(c => (c.Ints.Length >= 2 ? c.Ints[1] : -1) == 10)
        );
    ...
    public virtual Task Column_collection_index_string(bool async) =>
        AssertQuery(
            ...
            ss =>
                ss.Set<PrimitiveCollectionsEntity>()
                    .Where(c => (c.Strings.Length >= 2 ? c.Strings[1] : "-1") == "10")
        );
    ...
    public virtual Task Inline_collection_index_Column(bool async) =>
        AssertQuery(
            ...
            ss =>
                ss.Set<PrimitiveCollectionsEntity>()
                    .Where(c => (c.Int <= 2 ? new[] { 1, 2, 3 }[c.Int] : -1) == 1)
        );
    ...
    public virtual Task Parameter_collection_index_Column_equal_Column(bool async)
    {
        ...
        return AssertQuery(
            ...
            ss =>
                ss.Set<PrimitiveCollectionsEntity>()
                    .Where(c => (c.Int <= 2 ? ints[c.Int] : -1) == c.Int)
        );
    }
    ...
    public virtual Task Parameter_collection_index_Column_equal_constant(bool async)
    {
        ...
        return AssertQuery(
            ...
            ss =>
                ss.Set<PrimitiveCollectionsEntity>()
                    .Where(c => (c.Int <= 2 ? ints[c.Int] : -1) == 1)
        );
    }
    ...
    public virtual Task Column_collection_ElementAt(bool async) =>
        AssertQuery(
            ...
            ss =>
                ss.Set<PrimitiveCollectionsEntity>()
                    .Where(c => (c.Ints.Length >= 2 ? c.Ints.ElementAt(1) : -1) == 10)
        );
    ...
    public virtual Task Column_collection_Skip(bool async) =>
        AssertQuery(async, ss =>
            ss.Set<PrimitiveCollectionsEntity>().Where(c => c.Ints.Skip(1).Count() == 2)
        );
    ...
    public virtual Task Column_collection_Take(bool async) =>
        AssertQuery(async, ss =>
            ss.Set<PrimitiveCollectionsEntity>().Where(c => c.Ints.Take(2).Contains(11))
        );
    ...
    public virtual Task Column_collection_Skip_Take(bool async) =>
        AssertQuery(async, ss =>
            ss.Set<PrimitiveCollectionsEntity>().Where(c => c.Ints.Skip(1).Take(2).Contains(11))
        );
    ...
    public virtual Task Column_collection_Any(bool async) =>
        AssertQuery(async, ss => ss.Set<PrimitiveCollectionsEntity>().Where(c => c.Ints.Any()));
    ...
    public virtual Task Column_collection_Distinct(bool async) =>
        AssertQuery(async, ss =>
            ss.Set<PrimitiveCollectionsEntity>().Where(c => c.Ints.Distinct().Count() == 3)
        );
    ...
    public virtual Task Column_collection_Join_parameter_collection(bool async)
    {
        ...
        return AssertQuery(async, ss =>
            ss.Set<PrimitiveCollectionsEntity>()
                .Where(c =>
                    c.Ints.Join(ints, i => i, j => j, (i, j) => new { I = i, J = j }).Count() == 2
                )
        );
    }
    ...
    public virtual Task Column_collection_Union_parameter_collection(bool async)
    {
        ...
        return AssertQuery(async, ss =>
            ss.Set<PrimitiveCollectionsEntity>().Where(c => c.Ints.Union(ints).Count() == 2)
        );
    }
    ...
    public virtual Task Column_collection_Intersect_inline_collection(bool async) =>
        AssertQuery(async, ss =>
            ss.Set<PrimitiveCollectionsEntity>()
                .Where(c => c.Ints.Intersect(new[] { 11, 111 }).Count() == 2)
        );
    ...
    public virtual Task Inline_collection_Except_column_collection(bool async)
        ...
        AssertQuery(async, ss =>
            ss.Set<PrimitiveCollectionsEntity>()
                .Where(c => new[] { 11, 111 }.Except(c.Ints).Count(i => i % 2 == 1) == 2)
        );
    ...
    )
    {
        ...
        await AssertQuery(
            ...
            ss =>
                ss.Set<PrimitiveCollectionsEntity>()
                    .Where(c => c.Ints.Concat(ints) == new[] { 1, 11, 111, 1, 10 }),
            ss =>
                ss.Set<PrimitiveCollectionsEntity>()
                    .Where(c => c.Ints.Concat(ints).SequenceEqual(new[] { 1, 11, 111, 1, 10 }))
        );
    }
    ...
    public virtual Task Column_collection_equality_inline_collection(bool async) =>
        AssertQuery(
            ...
            ss =>
                ss.Set<PrimitiveCollectionsEntity>()
                    .Where(c => c.Ints.SequenceEqual(new[] { 1, 10 }))
        );
    ...
    )
    {
        ...
        await AssertQuery(
            ...
            ss =>
                ss.Set<PrimitiveCollectionsEntity>()
                    .Where(c => c.Ints.SequenceEqual(new[] { i, j }))
        );
    }
    ...
    public virtual async Task Parameter_collection_in_subquery_Count_as_compiled_query(bool async)
    {
        ...
        var compiledQuery = EF.CompileQuery(
            (PrimitiveCollectionsContext context, int[] ints) =>
                context
                    .Set<PrimitiveCollectionsEntity>()
                    .Where(p => ints.Skip(1).Count(i => i > p.Id) == 1)
                    .Count()
        );
    ...
    )
    {
        ...
        var compiledQuery = EF.CompileQuery(
            (PrimitiveCollectionsContext context, int[] ints) =>
                context
                    .Set<PrimitiveCollectionsEntity>()
                    .Where(p => ints.Skip(1).Union(p.Ints).Count() == 3)
        );
    ...
    public virtual Task Parameter_collection_in_subquery_Union_column_collection(bool async)
    {
        ...
        return AssertQuery(async, ss =>
            ss.Set<PrimitiveCollectionsEntity>().Where(p => ints.Skip(1).Union(p.Ints).Count() == 3)
        );
    }
    ...
    public virtual void Parameter_collection_in_subquery_and_Convert_as_compiled_query()
    {
        var query = EF.CompileQuery(
            (PrimitiveCollectionsContext context, object[] parameters) =>
                context
                    .Set<PrimitiveCollectionsEntity>()
                    .Where(p => p.String == (string)parameters[0])
        );
    ...
    )
    {
        var compiledQuery = EF.CompileQuery(
            (PrimitiveCollectionsContext context, int[] ints1, int[] ints2) =>
                context
                    .Set<PrimitiveCollectionsEntity>()
                    .Where(p => ints1.Skip(1).Union(ints2).Count() == 3)
        );
    ...
    public virtual Task Column_collection_in_subquery_Union_parameter_collection(bool async)
    {
        ...
        return AssertQuery(async, ss =>
            ss.Set<PrimitiveCollectionsEntity>().Where(c => c.Ints.Skip(1).Union(ints).Count() == 3)
        );
    }
    ...
    public virtual Task Project_collection_of_ints_ordered(bool async) =>
        AssertQuery(
            ...
            ss =>
                ss.Set<PrimitiveCollectionsEntity>()
                    .OrderBy(x => x.Id)
                    .Select(x => x.Ints.OrderByDescending(xx => xx).ToList()),
            assertOrder: true,
            elementAsserter: (e, a) => AssertCollection(e, a, ordered: true)
        );
    ...
    public virtual Task Project_collection_of_datetimes_filtered(bool async) =>
        AssertQuery(
            ...
            ss =>
                ss.Set<PrimitiveCollectionsEntity>()
                    .OrderBy(x => x.Id)
                    .Select(x => x.DateTimes.Where(xx => xx.Day != 1).ToList()),
            assertOrder: true,
    ...
    public virtual Task Project_collection_of_nullable_ints_with_paging(bool async) =>
        AssertQuery(
            ...
            ss =>
                ss.Set<PrimitiveCollectionsEntity>()
                    .OrderBy(x => x.Id)
                    .Select(x => x.NullableInts.Take(20).ToList()),
            assertOrder: true,
            elementAsserter: (e, a) => AssertCollection(e, a, elementSorter: ee => ee)
        );
    ...
    public virtual Task Project_collection_of_nullable_ints_with_paging2(bool async) =>
        AssertQuery(
            ...
            ss =>
                ss.Set<PrimitiveCollectionsEntity>()
                    .OrderBy(x => x.Id)
                    .Select(x => x.NullableInts.OrderBy(x => x).Skip(1).ToList()),
            assertOrder: true,
            elementAsserter: (e, a) => AssertCollection(e, a, elementSorter: ee => ee)
        );
    ...
    public virtual Task Project_collection_of_nullable_ints_with_paging3(bool async) =>
        AssertQuery(
            ...
            ss =>
                ss.Set<PrimitiveCollectionsEntity>()
                    .OrderBy(x => x.Id)
                    .Select(x => x.NullableInts.Skip(2).ToList()),
            assertOrder: true,
            elementAsserter: (e, a) => AssertCollection(e, a, elementSorter: ee => ee)
        );
    ...
    public virtual Task Project_collection_of_ints_with_distinct(bool async) =>
        AssertQuery(
            ...
            ss =>
                ss.Set<PrimitiveCollectionsEntity>()
                    .OrderBy(x => x.Id)
                    .Select(x => x.Ints.Distinct().ToList()),
            assertOrder: true,
            elementAsserter: (e, a) => AssertCollection(e, a, elementSorter: ee => ee)
        );
    ...
    public virtual Task Project_collection_of_nullable_ints_with_distinct(bool async) =>
        AssertQuery(
            ...
            ss =>
                ss.Set<PrimitiveCollectionsEntity>()
                    .OrderBy(x => x.Id)
                    .Select(x => x.NullableInts.Distinct().ToList()),
            assertOrder: true,
            elementAsserter: (e, a) => AssertCollection(e, a, elementSorter: ee => ee)
        );
    ...
    public virtual Task Project_multiple_collections(bool async) =>
        AssertQuery(
            ...
            elementAsserter: (e, a) =>
            {
                ...
                AssertCollection(e.FilteredDateTimes2, a.FilteredDateTimes2, elementSorter: ee =>
                    ee
                );
            },
            assertOrder: true
    ...
    public abstract class PrimitiveCollectionsQueryFixtureBase
        : SharedStoreFixtureBase<PrimitiveCollectionsContext>,
            IQueryFixtureBase
    {
        private PrimitiveArrayData? _expectedData;

        protected override string StoreName => "PrimitiveCollectionsTest";
        ...
        public IReadOnlyDictionary<Type, object> EntityAsserters { get; } =
            ...
            {
                {
                    typeof(PrimitiveCollectionsEntity),
                    (e, a) =>
                    {
