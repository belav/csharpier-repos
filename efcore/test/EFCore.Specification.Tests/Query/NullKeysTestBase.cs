    ...
    where TFixture : NullKeysTestBase<TFixture>.NullKeysFixtureBase, new()
{
    ...
    public virtual void Include_with_null_FKs_and_nullable_PK()
    {
        ...
        Assert.Equal(new WithStringKey[] { null, null }, results.Take(2).Select(e => e.Principal));
    ...
    {
        using var context = CreateContext();
        var results = context.Set<WithStringFk>().OrderBy(e => e.Id).Include(e => e.Self).ToList();
    ...
    {
        protected override string StoreName => "NullKeysTest";

        protected override void OnModelCreating(ModelBuilder modelBuilder, DbContext context)
        {
            modelBuilder
                .Entity<WithStringKey>()
            ...
            modelBuilder.Entity<WithIntKey>(b =>
            {
                ...
                b.HasMany(e => e.Dependents).WithOne(e => e.Principal).HasForeignKey(e => e.Fk);
            });
            ...
            modelBuilder.Entity<WithAllNullableIntFk>().Property(e => e.Id).ValueGeneratedNever();
        }
