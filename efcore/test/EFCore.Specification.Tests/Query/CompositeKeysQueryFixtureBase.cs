...
public abstract class CompositeKeysQueryFixtureBase
    : SharedStoreFixtureBase<CompositeKeysContext>,
        IQueryFixtureBase
{
    protected override string StoreName => "CompositeKeys";

    public Func<DbContext> GetContextCreator() => () => CreateContext();

    public virtual ISetSource GetExpectedData() => CompositeKeysDefaultData.Instance;
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder, DbContext context)
    {
        ...
        modelBuilder
            ...
            .HasPrincipalKey<CompositeOne>(e => new { e.Id1, e.Id2 })
            .HasForeignKey<CompositeTwo>(e => new { e.Id1, e.Id2 })
            .IsRequired()
        ...
        modelBuilder
            ...
            .HasForeignKey<CompositeTwo>(e => new { e.Level1_Required_Id1, e.Level1_Required_Id2 })
            .IsRequired()
            .OnDelete(DeleteBehavior.Restrict);
        modelBuilder
            .Entity<CompositeOne>()
            ...
            .HasForeignKey<CompositeTwo>(e => new { e.Level1_Optional_Id1, e.Level1_Optional_Id2 })
            .IsRequired(false);
        modelBuilder
            .Entity<CompositeOne>()
        ...
        modelBuilder
            ...
            .HasPrincipalKey<CompositeTwo>(e => new { e.Id1, e.Id2 })
            .HasForeignKey<CompositeThree>(e => new { e.Id1, e.Id2 })
            .IsRequired()
            .OnDelete(DeleteBehavior.Restrict);
        modelBuilder
            .Entity<CompositeTwo>()
        ...
        modelBuilder
            ...
            .HasForeignKey<CompositeThree>(
                e => new { e.Level2_Required_Id1, e.Level2_Required_Id2 }
            )
            .IsRequired()
            .OnDelete(DeleteBehavior.Restrict);
        modelBuilder
            ...
            .HasForeignKey<CompositeThree>(
                e => new { e.Level2_Optional_Id1, e.Level2_Optional_Id2 }
            )
            .IsRequired(false);
        modelBuilder
            .Entity<CompositeTwo>()
        ...
        modelBuilder
            .Entity<CompositeThree>()
            .HasOne(e => e.OneToOne_Required_PK3)
            .WithOne(e => e.OneToOne_Required_PK_Inverse4)
            .HasPrincipalKey<CompositeThree>(e => new { e.Id1, e.Id2 })
            .HasForeignKey<CompositeFour>(e => new { e.Id1, e.Id2 })
            .IsRequired()
            .OnDelete(DeleteBehavior.Restrict);
        modelBuilder
            .Entity<CompositeThree>()
        ...
        modelBuilder
            ...
            .HasForeignKey<CompositeFour>(e => new { e.Level3_Required_Id1, e.Level3_Required_Id2 })
            .IsRequired()
            .OnDelete(DeleteBehavior.Restrict);
        modelBuilder
            .Entity<CompositeThree>()
            ...
            .HasForeignKey<CompositeFour>(e => new { e.Level3_Optional_Id1, e.Level3_Optional_Id2 })
            .IsRequired(false);
        modelBuilder
            .Entity<CompositeThree>()
    ...
    protected override void Seed(CompositeKeysContext context) => CompositeKeysData.Seed(context);

    public override DbContextOptionsBuilder AddOptions(DbContextOptionsBuilder builder) =>
        base.AddOptions(builder)
            .ConfigureWarnings(
                c =>
                    c.Log(CoreEventId.PossibleUnintendedCollectionNavigationNullComparisonWarning)
