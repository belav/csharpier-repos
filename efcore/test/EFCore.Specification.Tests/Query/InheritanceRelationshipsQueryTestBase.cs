    ...
    where TFixture : InheritanceRelationshipsQueryFixtureBase, new()
{
    ...
    public virtual Task Include_collection_with_inheritance_reverse(bool async) =>
        AssertQuery(
            ...
            elementAsserter: (e, a) =>
                AssertInclude(e, a, new ExpectedInclude<BaseCollectionOnBase>(x => x.BaseParent))
        );
    ...
    public virtual Task Include_reference_with_inheritance_on_derived1(bool async) =>
        AssertQuery(
            async,
            ss =>
                ss.Set<DerivedInheritanceRelationshipEntity>().Include(e => e.BaseReferenceOnBase),
            elementAsserter: (e, a) =>
                AssertInclude(
                    e,
                    a,
    ...
    public virtual Task Include_reference_with_inheritance_on_derived_reverse(bool async) =>
        AssertQuery(
            ...
            elementAsserter: (e, a) =>
                AssertInclude(e, a, new ExpectedInclude<BaseReferenceOnDerived>(x => x.BaseParent))
        );
    ...
    public virtual Task Include_collection_with_inheritance_on_derived1(bool async) =>
        AssertQuery(
            async,
            ss =>
                ss.Set<DerivedInheritanceRelationshipEntity>().Include(e => e.BaseCollectionOnBase),
            elementAsserter: (e, a) =>
                AssertInclude(
                    e,
                    a,
    ...
    public virtual Task Include_collection_with_inheritance_on_derived_reverse(bool async) =>
        AssertQuery(
            ...
            elementAsserter: (e, a) =>
                AssertInclude(e, a, new ExpectedInclude<BaseCollectionOnDerived>(x => x.BaseParent))
        );
    ...
    public virtual Task Nested_include_collection_reference_on_non_entity_base(bool async) =>
        AssertQuery(
            async,
            ss =>
                ss.Set<ReferencedEntity>().Include(e => e.Principals).ThenInclude(e => e.Reference),
            elementAsserter: (e, a) =>
                AssertInclude(
                    e,
                    a,
