        ...
        where TFixture : NorthwindQueryFixtureBase<NoopModelCustomizer>, new()
    {
        ...
        public virtual void Multiple_context_instances_2()
        {
            ...
            Assert.Equal(
                ...
                Assert.Throws<InvalidOperationException>(
                    () =>
                        (from c in context1.Customers from o in context2.Set<Order>() select c)
                            .First()
                ).Message
            );
        }
        ...
        public virtual void Query_when_evaluatable_queryable_method_call_with_repository()
        {
            ...
            var results = customerRepository.Find()
        ...
        public virtual void Lifting_when_subquery_nested_order_by_simple()
        {
            ...
            var results = (
                ...
                join _c1 in (
                    from c1 in (from c in context.Customers orderby c.CustomerID  select c).Take(2)
...
#pragma warning restore CS1718 // Comparison made to same variable
        ...
        public virtual Task Ternary_should_not_evaluate_both_sides_with_parameter(bool async)
        {
            ...
            return AssertQuery(async, ss => ss.Set<Order>().Select(
                        o =>
                            new
                            {
        ...
        {
            return AssertCount(async, ss => ss.Set<Order>().Distinct().Take(5));
        }
        ...
        {
            return AssertCount(async, ss => ss.Set<Order>().Take(5).Distinct());
        }
        ...
        {
            return AssertAny(async, ss => ss.Set<Customer>());
        }
        ...
        {
            return AssertCount(async, ss => ss.Set<Order>().OrderBy(o => o.OrderID).Take(5));
        }
        ...
        {
            return AssertCount(async, ss => ss.Set<Order>().Take(5).OrderBy(o => o.OrderID));
        }
                            ...
                            c1 =>
                                ss.Set<Customer>()
                                    .Any(
                                        c2 =>
                                            ss.Set<Customer>()
                                                .Any(c3 => c1.CustomerID == c3.CustomerID)
                                    )
                        ),
                asyncQuery: ss =>
                    ss.Set<Customer>()
            ...
            var expected = Fixture.GetExpectedData()
                ...
                .Select(
                    e =>
                        ...
                        {
                            e.A,
                            Orders = Fixture.GetExpectedData()
                                .Set<Order>()
                                .Where(o => o.CustomerID == e.CustomerID)
                                .ToList()
                        }
        ...
        public virtual void Select_DTO_with_member_init_distinct_in_subquery_used_in_projection_translated_to_server()
        {
            ...
            var actual = (
                ...
                .ToList()
                .OrderBy(e => e.c.CustomerID + " " + e.o.Count)
                .ToList();

            var expected = (
                from c in Fixture.GetExpectedData()
                    .Set<Customer>()
                    .Where(c => c.CustomerID.StartsWith("A"))
    ...
    .Select(e2 => DbSet<Employee>()
            ...
            return AssertQuery(
                ...
                ss =>
                    ...
                    select new
                    {
                        ...
                        OrderIds = ss.Set<Order>()
                            .Where(
                                o => o.CustomerID == c.CustomerID && o.OrderDate.Value.Year == 1997
                            )
                            .Select(o => o.OrderID)
                            .OrderBy(o => o)
                            .ToArray(),
        ...
        public virtual Task Where_query_composition_entity_equality_one_element_Single(bool async)
        {
            return AssertQuery(
                ...
                ss =>
                    from e1 in ss.Set<Employee>()
                    where
                        ss.Set<Employee>().Single(e2 => e2.EmployeeID == e1.ReportsTo)
                        == new Employee()
                    select e1,
                ss =>
                    from e1 in ss.Set<Employee>()
        ...
        public virtual Task Where_query_composition_entity_equality_one_element_First(bool async)
        {
            return AssertQuery(
                ...
                ss =>
                    from e1 in ss.Set<Employee>()
                    where
                        ss.Set<Employee>().First(e2 => e2.EmployeeID == e1.ReportsTo)
                        == new Employee()
                    select e1,
                ss =>
                    from e1 in ss.Set<Employee>()
        ...
        )
        {
            return AssertQuery(
                ...
                ss =>
                    from e1 in ss.Set<Employee>()
                    where
                        ss.Set<Employee>().SingleOrDefault(e2 => e2.EmployeeID == 42)
                        == new Employee()
                    select e1,
                ss =>
                    from e1 in ss.Set<Employee>()
                    where
                        ss.Set<Employee>().FirstOrDefault(e2 => e2.EmployeeID == 42)
                        == new Employee()
                    select e1
            );
        }
                ...
                ss =>
                    ...
                    where
                        (
                            from e2 in ss.Set<Employee>()
                            where
                                (from e3 in ss.Set<Employee>() orderby e3.EmployeeID  select e3)
                                    .Any()
                            select e2
                        )
                            .Any()
            ...
            return AssertQuery(
                ...
                ss =>
                    ...
                    from e1 in (
                        ...
                        .Take(9)
                    from e2 in (from e3 in ss.Set<Employee>() where e1.City == e3.City select c1)
                        .Take(9)
                    select new { c1, e1 },
        ...
        public virtual Task OrderBy_anon(bool async)
        {
            return AssertQuery(
                async,
                ss =>
                    ss.Set<Customer>().Select(c => new { c.CustomerID }).OrderBy(a => a.CustomerID),
                ss =>
                    ss.Set<Customer>()
            ...
            return AssertTranslationFailedWithDetails(
                () =>
                    AssertQuery(
                        async,
                        ss =>
                            ss.Set<Customer>().OrderBy(c => c.IsLondon).ThenBy(c => c.CompanyName),
                        assertOrder: true,
                        entryCount: 91
                    ),
                CoreStrings.QueryUnableToTranslateMember(
                    ...
                    AssertQuery(
                        ...
                        ss =>
                            ...
                            join o in ss.Set<Order>()
                                on new Foo { Bar = c.CustomerID } equals new Foo
                                {
                                    Bar = o.CustomerID
                                }
        ...
        public virtual Task OrderBy_correlated_subquery1(bool async)
        {
            return AssertQuery(
                ...
                ss =>
                    from c in ss.Set<Customer>()
                    where c.CustomerID.StartsWith("A")
                    orderby ss.Set<Customer>()
                        .Any(c2 => c2.CustomerID == c.CustomerID) ,c.CustomerID
                    select c,
                assertOrder: true,
                entryCount: 4
            );
...
#pragma warning restore IDE0029 // Use coalesce expression
        ...
        {
            using var context = CreateContext();
            var customers = (from c in context.Set<Customer>() orderby c.Region ?? "ZZ"  select c)
                .ToList();
        ...
        public virtual void Select_Where_Subquery_Equality()
        {
            ...
            var orders = (
                ...
                where
                    (
                        from od in context.OrderDetails.OrderBy(od => od.OrderID).Take(2)
                        where
                            (
                                from c in context.Set<Customer>()
                                where c.CustomerID == o.CustomerID
                            ...
                            == (
                                ...
                                join c in context.Set<Customer>()
                                    on o2.CustomerID equals c.CustomerID
        ...
        public virtual Task DateTime_parse_is_inlined(bool async)
        {
            return AssertQuery(
                ...
                ss =>
                    ss.Set<Order>()
                        .Where(o => o.OrderDate > DateTime.Parse("1/1/1998 12:00:00 PM")),
                entryCount: 267
            );
        }
        ...
        {
            return AssertQuery(isAsync, ss => ss.Set<Order>().Select(o => "-" + o.OrderID));
        }
                        ...
                        .Select(
                            o =>
                                new
                                {
                                    OrderId = o.OrderID,
                                    ss.Set<Customer>()
                                        .SingleOrDefault(c => c.CustomerID == o.CustomerID).City
                                }
                        )
                        .OrderBy(o => o.City),
                assertOrder: true
        ...
        public virtual Task Query_expression_with_to_string_and_contains(bool async)
        {
            return AssertQuery(
                ...
                ss =>
                    ss.Set<Order>()
                        .Where(
                            o => o.OrderDate != null && o.EmployeeID.Value.ToString().Contains("10")
                        )
                            ...
                            o =>
                                new Order
                                {
                                    OrderDate = o.OrderDate.Value
                                        .AddTicks(TimeSpan.TicksPerMillisecond)
                                }
                        ),
                e => e.OrderDate
            );
...
#pragma warning restore IDE0031 // Use null propagation
        ...
        {
            return AssertCount(async, ss => ss.Set<Customer>().Take(7));
        }
        ...
        {
            return AssertCount(async, ss => ss.Set<Customer>().OrderBy(c => c.Country).Take(7));
        }
        ...
        {
            return AssertLongCount(async, ss => ss.Set<Customer>().Take(7));
        }
        ...
        {
            return AssertLongCount(async, ss => ss.Set<Customer>().OrderBy(c => c.Country).Take(7));
        }
        ...
        {
            return AssertCount(async, ss => ss.Set<Customer>().Skip(7));
        }
        ...
        {
            return AssertCount(async, ss => ss.Set<Customer>().OrderBy(c => c.Country).Skip(7));
        }
        ...
        {
            return AssertLongCount(async, ss => ss.Set<Customer>().Skip(7));
        }
        ...
        {
            return AssertLongCount(async, ss => ss.Set<Customer>().OrderBy(c => c.Country).Skip(7));
        }
        ...
        {
            return AssertAverage(async, ss => ss.Set<Order>().Select(o => o.OrderID).Distinct());
        }
        ...
        {
            return AssertLongCount(async, ss => ss.Set<Customer>().Distinct());
        }
        ...
        {
            return AssertMax(async, ss => ss.Set<Order>().Select(o => o.OrderID).Distinct());
        }
        ...
        {
            return AssertMin(async, ss => ss.Set<Order>().Select(o => o.OrderID).Distinct());
        }
        ...
        {
            return AssertSum(async, ss => ss.Set<Order>().Select(o => o.OrderID).Distinct());
        }
        ...
        {
            return AssertQuery(async, ss => FindLike(ss.Set<Customer>(), "A"));
        }

        private static IQueryable<string> FindLike(IQueryable<Customer> cs, string prefix)
        {
            return from c in cs where c.CustomerID.StartsWith(prefix) select c.CustomerID;
        }
        ...
        public virtual void Manual_expression_tree_typed_null_equality()
        {
            ...
            var query = context.Orders.Where(o => o.OrderID < 10300).Select(selector).ToList();
...
#pragma warning restore IDE0031 // Use null propagation
        ...
        public virtual Task Dependent_to_principal_navigation_equal_to_null_for_subquery(bool async)
        {
            return AssertQuery(
                ...
                ss =>
                    ss.Set<Customer>()
                        .Where(
                            c => c.Orders.OrderBy(o => o.OrderID).FirstOrDefault().Customer == null
                        ),
                ss =>
                    ss.Set<Customer>()
                        .Where(
        ...
        public virtual void Client_code_using_instance_in_anonymous_type()
        {
            using var context = CreateContext();
            Assert.Equal(
                CoreStrings.ClientProjectionCapturingConstantInTree(GetType().DisplayName()),
                Assert.Throws<InvalidOperationException>(
                    ...
                    ss.Set<Order>()
                        ...
                        .Select(
                            e =>
                                ...
                                {
                                    e.Item.OrderID,
                                    ProductIds = e.Item.OrderDetails
        ...
        public virtual async Task Null_parameter_name_works(bool async)
        {
            ...
            var query = ((IAsyncQueryProvider)customerDbSet.Provider)
        ...
        )
        {
            ...
            var arouts = result.Where(t => t.c.CustomerID == "AROUT")
                .Select(t => t.c)
        ...
        )
        {
            return AssertQuery(
                ...
                ss =>
                    ss.Set<Customer>()
                        .Where(
                            c => c.CustomerID.Equals("ALFKI", StringComparison.InvariantCulture)
                        ),
                entryCount: 1
            );
        }
                        ...
                        .Select(
                            c =>
                                new
                                {
                                    ...
                                    Subquery = c.Orders
                                        .Select(
                                            o => new { First = o.OrderID, Second = o.OrderDate }
                                        )
                                        .Distinct()
                                        .ToList()
                                }
