        ...
        AssertQuery(
            ...
            ss =>
                ss.Set<Level2>()
                    .Where(l =>
                        EF.Property<int>(
                            EF.Property<Level1>(l, "OneToOne_Required_FK_Inverse2"),
                            "Id"
                        ) == 7
                    )
        );
    ...
    public virtual Task Simple_level1_level2_level3_include(bool async) =>
        AssertQuery(
            ...
            ss =>
                ss.Set<Level1>()
                    .Include(l1 =>
                        l1.OneToOne_Required_PK1.OneToOne_Required_PK2.OneToOne_Required_PK3
                    )
        );
            ...
            ss =>
                ss.Set<Level3>()
                    .Where(l3 =>
                        ...
                        || l3.OneToMany_Required_Inverse3.OneToOne_Required_FK_Inverse2.Name
                            == "L1 01"
                    )
    ...
    public virtual Task Navigations_compared_to_each_other3(bool async) =>
        AssertQuery(
            ...
            ss =>
                from l2 in ss.Set<Level2>()
                where
                    l2.OneToMany_Optional2.Select(i => i.OneToOne_Optional_PK_Inverse3 == l2).Any()
                select l2.Name
        );
                ...
                AssertQuery(
                    ...
                    ss =>
                        ss.Set<Level1>()
                            .Select(x => new
                            {
                                Subquery = ss.Set<Level2>().Where(l2 => l2.Id < 10),
                            })
                            .Join(ss.Set<Level3>(), o => 7, i => i.Id, (o, i) => i)
                ),
            "IQueryable<Level1>"
