    ...
    where TFixture : ComplexNavigationsQueryFixtureBase, new()
{
            ...
            ss =>
                ...
                where
                    e1.OneToOne_Optional_FK1
                        .Name
                        .MaybeScalar(x => x.StartsWith(e1.OneToOne_Optional_FK1.Name)) == true
                select e1
        );
    ...
    public virtual Task SelectMany_with_nested_navigation_filter_and_explicit_DefaultIfEmpty(
        ...
        AssertQuery(
            ...
            ss =>
                from l1 in ss.Set<Level1>()
                from l3 in l1.OneToOne_Optional_FK1
                    .OneToMany_Optional2
                    .Where(l => l.Id > 5)
                    .DefaultIfEmpty()
                where l3 != null
    ...
    public virtual Task SelectMany_with_nested_required_navigation_filter_and_explicit_DefaultIfEmpty(
        ...
        AssertQuery(
            ...
            ss =>
                from l1 in ss.Set<Level1>()
                from l3 in l1.OneToOne_Required_FK1
                    .OneToMany_Required2
                    .Where(l => l.Id > 5)
                    .DefaultIfEmpty()
                where l3 != null
            ...
            ss =>
                ss.Set<Level1>()
                    .Where(l1 =>
                        l1.OneToOne_Optional_FK1
                            .OneToMany_Optional2
                            .MaybeScalar(x => x.Distinct().Select(l3 => l3.Id).Contains(6)) == true
                    )
        );
            ...
            ss =>
                ss.Set<Level1>()
                    .Where(l1 =>
                        l1.OneToOne_Optional_FK1
                            .OneToMany_Optional2
                            .MaybeScalar(x => x.Select(l3 => l3.Name.Length).Distinct().Contains(5))
                        == true
                    )
        );
            ...
            ss =>
                ...
                where
                    l2.OneToOne_Required_FK2
                        .OneToMany_Optional3
                        .Select(i => i.OneToOne_Optional_PK_Inverse4 == l2.OneToOne_Required_FK2)
                        .Any()
                select l2.Name,
            ss =>
                from l2 in ss.Set<Level2>()
        ...
        AssertQuery(
            ...
            ss =>
                ...
                where
                    l2.OneToOne_Required_FK2
                        .OneToMany_Optional3
                        .Select(i => i.OneToOne_Optional_PK_Inverse4 == l2.OneToOne_Optional_PK2)
                        .Any()
                select l2.Name,
            ss =>
                from l2 in ss.Set<Level2>()
