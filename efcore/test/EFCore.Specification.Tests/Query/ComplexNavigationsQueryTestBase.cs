    ...
    where TFixture : ComplexNavigationsQueryFixtureBase, new()
{
    ...
    public virtual Task Key_equality_using_property_method_required(bool async) =>
        AssertQuery(async, ss =>
            ss.Set<Level1>().Where(l => EF.Property<int>(l.OneToOne_Required_FK1, "Id") > 7)
        );
    ...
    public virtual Task Key_equality_using_property_method_required2(bool async) =>
        AssertQuery(async, ss =>
            ss.Set<Level2>().Where(l => EF.Property<int>(l.OneToOne_Required_FK_Inverse2, "Id") > 7)
        );
    ...
    public virtual Task Key_equality_using_property_method_nested(bool async) =>
        AssertQuery(async, ss =>
            ss.Set<Level1>()
                .Where(l =>
                    EF.Property<int>(EF.Property<Level2>(l, "OneToOne_Required_FK1"), "Id") == 7
                )
        );
    ...
    public virtual Task Key_equality_using_property_method_nested2(bool async) =>
        AssertQuery(async, ss =>
            ss.Set<Level2>()
                .Where(l =>
                    EF.Property<int>(EF.Property<Level1>(l, "OneToOne_Required_FK_Inverse2"), "Id")
                    == 7
                )
        );
    ...
    public virtual Task Key_equality_using_property_method_and_member_expression1(bool async) =>
        AssertQuery(async, ss =>
            ss.Set<Level1>().Where(l => EF.Property<Level2>(l, "OneToOne_Required_FK1").Id == 7)
        );
    ...
    public virtual Task Key_equality_using_property_method_and_member_expression3(bool async) =>
        AssertQuery(async, ss =>
            ss.Set<Level2>()
                .Where(l => EF.Property<int>(l.OneToOne_Required_FK_Inverse2, "Id") == 7)
        );
    ...
    public virtual Task Key_equality_navigation_converted_to_FK(bool async) =>
        AssertQuery(
            ...
            ss =>
                ss.Set<Level2>()
                    .Where(l => l.OneToOne_Required_FK_Inverse2 == new Level1 { Id = 1 }),
    ...
    public virtual Task Key_equality_two_conditions_on_same_navigation(bool async) =>
        AssertQuery(
            ...
            ss =>
                ss.Set<Level1>()
                    .Where(l =>
                        l.OneToOne_Required_FK1 == new Level2 { Id = 1 }
                        || l.OneToOne_Required_FK1 == new Level2 { Id = 2 }
                    ),
            ss =>
                ss.Set<Level1>()
                    .Where(l => l.OneToOne_Required_FK1.Id == 1 || l.OneToOne_Required_FK1.Id == 2)
        );
    ...
    public virtual Task Key_equality_two_conditions_on_same_navigation2(bool async) =>
        AssertQuery(
            ...
            ss =>
                ss.Set<Level2>()
                    .Where(l =>
                        l.OneToOne_Required_FK_Inverse2 == new Level1 { Id = 1 }
                        || l.OneToOne_Required_FK_Inverse2 == new Level1 { Id = 2 }
                    ),
            ss =>
                ss.Set<Level2>()
                    .Where(l =>
                        l.OneToOne_Required_FK_Inverse2.Id == 1
    ...
    public virtual async Task Multi_level_include_with_short_circuiting(bool async)
    {
        ...
        var globalizations_1_placeholder = result[1]
            .Placeholder.Globalizations.OrderBy(g => g.Text)
            .ToList();
    ...
    public virtual Task Simple_level1_include(bool async) =>
        AssertQuery(async, ss => ss.Set<Level1>().Include(l1 => l1.OneToOne_Required_PK1));

    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task Simple_level1(bool async) => AssertQuery(async, ss => ss.Set<Level1>());

    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task Simple_level1_level2_include(bool async) =>
        AssertQuery(async, ss =>
            ss.Set<Level1>().Include(l1 => l1.OneToOne_Required_PK1.OneToOne_Required_PK2)
        );
    ...
    public virtual Task Simple_level1_level2_GroupBy_Count(bool async) =>
        AssertQueryScalar(async, ss =>
            ss.Set<Level1>()
                .GroupBy(l1 => l1.OneToOne_Required_PK1.OneToOne_Required_PK2.Name)
                .Select(g => g.Count())
        );
    ...
    public virtual Task Simple_level1_level2_level3_include(bool async) =>
        AssertQuery(async, ss =>
            ss.Set<Level1>()
                .Include(l1 => l1.OneToOne_Required_PK1.OneToOne_Required_PK2.OneToOne_Required_PK3)
        );
    ...
    public virtual Task Optional_navigation_inside_property_method_translated_to_join(bool async) =>
        AssertQuery(async, ss =>
            from e1 in ss.Set<Level1>()
            where
                EF.Property<string>(EF.Property<Level2>(e1, "OneToOne_Optional_FK1"), "Name")
                == "L2 01"
            select e1
        );
    ...
    public virtual Task Optional_navigation_inside_nested_method_call_translated_to_join(
        ...
        AssertQuery(
            ...
            ss =>
                from e1 in ss.Set<Level1>()
                where
                    e1.OneToOne_Optional_FK1.Name.MaybeScalar(x => x.ToUpper().StartsWith("L"))
                    == true
                select e1
        );
    ...
    public virtual Task Method_call_on_optional_navigation_translates_to_null_conditional_properly_for_arguments(
        ...
        AssertQuery(
            ...
            ss =>
                from e1 in ss.Set<Level1>()
                where
                    e1.OneToOne_Optional_FK1.Name.MaybeScalar(x =>
                        x.StartsWith(e1.OneToOne_Optional_FK1.Name)
                    ) == true
                select e1
        );
    ...
    public virtual Task Optional_navigation_inside_method_call_translated_to_join_keeps_original_nullability(
        ...
        AssertQuery(
            ...
            ss =>
                from e1 in ss.Set<Level1>()
                where
                    e1.OneToOne_Optional_FK1.MaybeScalar(x => x.Date.AddDays(10))
    ...
    public virtual Task Optional_navigation_inside_nested_method_call_translated_to_join_keeps_original_nullability(
        ...
        AssertQuery(
            ...
            ss =>
                from e1 in ss.Set<Level1>()
                where
                    e1.OneToOne_Optional_FK1.Date.AddDays(10).AddDays(15).AddMonths(2)
    ...
    public virtual Task Optional_navigation_inside_nested_method_call_translated_to_join_keeps_original_nullability_also_for_arguments(
        ...
        AssertQuery(
            ...
            ss =>
                from e1 in ss.Set<Level1>()
                where
                    e1.OneToOne_Optional_FK1.MaybeScalar(x => x.Date.AddDays(15).AddDays(x.Id))
                    > new DateTime(2000, 2, 1)
                select e1
        );
        ...
        AssertQuery(
            ...
            ss =>
                ...
                join e3 in ss.Set<Level3>()
                    on e1.OneToOne_Required_FK1.OneToOne_Optional_FK2.Id equals e3.Id
        ...
        AssertQuery(
            ...
            ss =>
                ...
                join e1 in ss.Set<Level1>()
                    on e3.OneToOne_Required_FK_Inverse3
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task Join_navigations_in_inner_selector_translated_without_collision(
        bool async
    ) =>
        AssertQuery(
            async,
    ...
    public virtual Task Join_navigation_nested(bool async) =>
        AssertQuery(
            ...
            ss =>
                from e3 in ss.Set<Level3>()
                join e1 in ss.Set<Level1>()
                    on e3.Id equals e1.OneToOne_Required_FK1.OneToOne_Optional_FK2.Id
                select new { Id3 = e3.Id, Id1 = e1.Id },
            e => (e.Id3, e.Id1)
        );
    ...
    public virtual Task Join_navigation_nested2(bool async) =>
        AssertQuery(
            ...
            ss =>
                from e3 in ss.Set<Level3>()
                join e1 in ss.Set<Level1>().OrderBy(ll => ll.Id)
                    on e3.Id equals e1.OneToOne_Required_FK1.OneToOne_Optional_FK2.Id
                select new { Id3 = e3.Id, Id1 = e1.Id },
            e => (e.Id3, e.Id1)
        );
    ...
    public virtual Task Join_navigation_deeply_nested_non_key_join(bool async) =>
        AssertQuery(
            ...
            ss =>
                ...
                join e1 in ss.Set<Level1>()
                    on e4.Name equals e1.OneToOne_Required_FK1
    ...
    public virtual Task Join_navigation_deeply_nested_required(bool async) =>
        AssertQuery(
            ...
            ss =>
                from e1 in ss.Set<Level1>()
                join e4 in ss.Set<Level4>()
                    on e1.Name equals e4.OneToOne_Required_FK_Inverse4
        ...
        AssertQuery(
            ...
            elementAsserter: (e, a) =>
            {
                AssertInclude(
                    e.entity,
                    a.entity,
                    new ExpectedInclude<Level1>(ee => ee.OneToOne_Optional_FK1)
                );
    ...
    public virtual Task Select_nav_prop_reference_optional1(bool async) =>
        AssertQuery(async, ss => ss.Set<Level1>().Select(e => e.OneToOne_Optional_FK1.Name));
    ...
    public virtual Task Select_nav_prop_reference_optional2(bool async) =>
        AssertQueryScalar(async, ss =>
            ss.Set<Level1>().Select(e => (int?)e.OneToOne_Optional_FK1.Id)
        );
    ...
    public virtual Task Select_nav_prop_reference_optional3(bool async) =>
        AssertQuery(async, ss =>
            ss.Set<Level2>().Select(e => e.OneToOne_Optional_FK_Inverse2.Name)
        );
    ...
    public virtual Task Where_nav_prop_reference_optional1(bool async) =>
        AssertQueryScalar(async, ss =>
            ss.Set<Level1>()
                .Where(e =>
                    e.OneToOne_Optional_FK1.Name == "L2 05"
                    || e.OneToOne_Optional_FK1.Name == "L2 07"
                )
                .Select(e => e.Id)
        );
    ...
    public virtual Task Where_nav_prop_reference_optional1_via_DefaultIfEmpty(bool async) =>
        AssertQueryScalar(async, ss =>
            from l1 in ss.Set<Level1>()
            join l2Left in ss.Set<Level2>()
                on l1.Id equals l2Left.Level1_Optional_Id
                into groupJoinLeft
            from l2Left in groupJoinLeft.DefaultIfEmpty()
            join l2Right in ss.Set<Level2>()
                on l1.Id equals l2Right.Level1_Optional_Id
                into groupJoinRight
            from l2Right in groupJoinRight.DefaultIfEmpty()
            where
                (l2Left == null ? null : l2Left.Name) == "L2 05"
                || (l2Right == null ? null : l2Right.Name) == "L2 07"
            select l1.Id
        );
    ...
    public virtual Task Where_nav_prop_reference_optional2(bool async) =>
        AssertQueryScalar(async, ss =>
            ss.Set<Level1>()
                .Where(e =>
                    e.OneToOne_Optional_FK1.Name == "L2 05"
                    || e.OneToOne_Optional_FK1.Name != "L2 42"
                )
                .Select(e => e.Id)
        );
    ...
    public virtual Task Where_nav_prop_reference_optional2_via_DefaultIfEmpty(bool async) =>
        AssertQueryScalar(async, ss =>
            ...
            where
                (l2Left == null ? null : l2Left.Name) == "L2 05"
                || (l2Right == null ? null : l2Right.Name) != "L2 42"
            select l1.Id
        );
    ...
    public virtual Task Select_multiple_nav_prop_reference_optional(bool async) =>
        AssertQueryScalar(async, ss =>
            ss.Set<Level1>().Select(e => (int?)e.OneToOne_Optional_FK1.OneToOne_Optional_FK2.Id)
        );
    ...
    public virtual Task Select_multiple_nav_prop_reference_required(bool async) =>
        AssertQueryScalar(async, ss =>
            ss.Set<Level1>().Select(e => (int?)e.OneToOne_Required_FK1.OneToOne_Required_FK2.Id)
        );
    ...
    public virtual Task Select_multiple_nav_prop_reference_required2(bool async) =>
        AssertQueryScalar(async, ss =>
            ss.Set<Level3>()
                .Select(e => e.OneToOne_Required_FK_Inverse3.OneToOne_Required_FK_Inverse2.Id)
        );
    ...
    public virtual Task Where_complex_predicate_with_with_nav_prop_and_OrElse1(bool async) =>
        AssertQuery(
            ...
            ss =>
                ...
                from l2 in ss.Set<Level2>()
                where
                    l1.OneToOne_Optional_FK1.Name == "L2 01"
                ...
                ss.Set<Level1>()
                    .Where(e =>
                        e.OneToOne_Required_FK1.OneToOne_Required_FK2
                            == e.OneToOne_Required_FK1.OneToOne_Optional_FK2
    ...
    public virtual Task OrderBy_nav_prop_reference_optional(bool async) =>
        AssertQueryScalar(
            ...
            ss =>
                ss.Set<Level1>()
                    .OrderBy(e => e.OneToOne_Optional_FK1.Name)
                    .ThenBy(e => e.Id)
                    .Select(e => e.Id),
            assertOrder: true
        );
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task Result_operator_nav_prop_reference_optional_Average_with_identity_selector(
        bool async
    ) =>
        AssertAverage(
            async,
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task Result_operator_nav_prop_reference_optional_Average_without_selector(
        bool async
    ) =>
        AssertAverage(async, ss =>
            ss.Set<Level1>().Select(e => (int?)e.OneToOne_Optional_FK1.Level1_Required_Id)
        );

    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task Result_operator_nav_prop_reference_optional_via_DefaultIfEmpty(
        bool async
    ) =>
        AssertSum(
            async,
    ...
    public virtual Task Include_with_optional_navigation(bool async) =>
        AssertQuery(
            async,
            ss =>
                from l1 in ss.Set<Level1>().Include(e => e.OneToOne_Optional_FK1)
                where l1.OneToOne_Optional_FK1.Name != "L2 05"
                select l1,
            elementAsserter: (e, a) =>
                AssertInclude(e, a, new ExpectedInclude<Level1>(l1 => l1.OneToOne_Optional_FK1))
        );
    ...
    public virtual Task Join_flattening_bug_4539(bool async) =>
        AssertQuery(
            ...
            ss =>
                from l1 in ss.Set<Level1>()
                join l1_Optional in ss.Set<Level2>()
                    on l1.Id equals l1_Optional.Level1_Optional_Id
                    into grouping
                from l1_Optional in grouping.DefaultIfEmpty()
                from l2 in ss.Set<Level2>()
                join l2_Required_Reverse in ss.Set<Level1>()
                    on l2.Level1_Required_Id equals l2_Required_Reverse.Id
    ...
    public virtual Task Query_source_materialization_bug_4547(bool async) =>
        AssertQueryScalar(async, ss => from e3 in ss.Set<Level3>() join e1 in ss.Set<Level1>()
                on e3.Id equals (
                    from subQuery2 in ss.Set<Level2>()
                    join subQuery3 in ss.Set<Level3>()
                        on subQuery2 != null
                            ? subQuery2.Id
                            : null equals subQuery3.Level2_Optional_Id
                        into grouping
                    ...
                    .Where(x => x != null)
                    .FirstOrDefault() select e1.Id);

    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task SelectMany_navigation_property(bool async) =>
        AssertQuery(async, ss => ss.Set<Level1>().SelectMany(l1 => l1.OneToMany_Optional1));

    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task SelectMany_navigation_property_and_projection(bool async) =>
        AssertQuery(async, ss =>
            ss.Set<Level1>().SelectMany(l1 => l1.OneToMany_Optional1).Select(e => e.Name)
        );
    ...
    public virtual Task SelectMany_navigation_property_and_filter_before(bool async) =>
        AssertQuery(async, ss =>
            ss.Set<Level1>().Where(e => e.Id == 1).SelectMany(l1 => l1.OneToMany_Optional1)
        );
    ...
    public virtual Task SelectMany_navigation_property_and_filter_after(bool async) =>
        AssertQuery(async, ss =>
            ss.Set<Level1>().SelectMany(l1 => l1.OneToMany_Optional1).Where(e => e.Id != 6)
        );
    ...
    public virtual Task SelectMany_nested_navigation_property_optional_and_projection(bool async) =>
        AssertQuery(
            ...
            ss =>
                ss.Set<Level1>()
                    .SelectMany(l1 => l1.OneToOne_Optional_FK1.OneToMany_Optional2)
                    .Select(e => e.Name),
            ss =>
                ss.Set<Level1>()
                    .SelectMany(l1 =>
    ...
    public virtual Task Multiple_SelectMany_calls(bool async) =>
        AssertQuery(async, ss =>
            ss.Set<Level1>()
                ...
                .SelectMany(e => e.OneToMany_Optional2)
        );
    ...
    public virtual Task SelectMany_navigation_property_with_another_navigation_in_subquery(
        ...
        AssertQuery(async, ss =>
            ss.Set<Level1>()
                .SelectMany(l1 => l1.OneToMany_Optional1.Select(l2 => l2.OneToOne_Optional_FK2))
        );
    ...
    public virtual Task Where_navigation_property_to_collection(bool async) =>
        AssertQuery(
            ...
            ss =>
                ss.Set<Level1>()
                    .Where(l1 => l1.OneToOne_Required_FK1.OneToMany_Optional2.Count > 0),
            ss =>
                ss.Set<Level1>()
                    .Where(l1 =>
                        l1.OneToOne_Required_FK1.OneToMany_Optional2.MaybeScalar(x => x.Count) > 0
                    )
        );
    ...
    public virtual Task Where_navigation_property_to_collection2(bool async) =>
        AssertQuery(
            ...
            ss =>
                ss.Set<Level3>()
                    .Where(l3 => l3.OneToOne_Required_FK_Inverse3.OneToMany_Optional2.Count > 0),
            ss =>
                ss.Set<Level3>()
                    .Where(l3 =>
                        l3.OneToOne_Required_FK_Inverse3.OneToMany_Optional2.MaybeScalar(x =>
                            x.Count
                        ) > 0
                    )
        );
    ...
    public virtual Task Where_navigation_property_to_collection_of_original_entity_type(
        ...
        AssertQuery(
            ...
            ss =>
                ss.Set<Level2>()
                    .Where(l2 => l2.OneToMany_Required_Inverse2.OneToMany_Optional1.Count() > 0),
            ss =>
                ss.Set<Level2>()
                    .Where(l2 =>
                        l2.OneToMany_Required_Inverse2.OneToMany_Optional1.MaybeScalar(x =>
                            x.Count()
                        ) > 0
                    )
        );
    ...
    public virtual Task SelectMany_where_with_subquery(bool async) =>
        AssertQuery(async, ss =>
            ss.Set<Level1>()
                ...
                .Where(l2 => l2.OneToMany_Required2.Any())
        );
    ...
    public virtual Task Order_by_key_of_projected_navigation_doesnt_get_optimized_into_FK_access3(
        ...
        AssertQuery(
            ...
            ss =>
                ss.Set<Level3>()
                    .OrderBy(l3 => EF.Property<Level2>(l3, "OneToOne_Required_FK_Inverse3").Id)
                    .Select(l3 => l3.OneToOne_Required_FK_Inverse3),
            elementAsserter: (e, a) => AssertEqual(e, a),
            assertOrder: true
        );
    ...
    public virtual Task Multiple_SelectMany_with_string_based_Include(bool async) =>
        AssertQuery(
            ...
            elementAsserter: (e, a) =>
                AssertInclude(e, a, new ExpectedInclude<Level3>(l3 => l3.OneToOne_Required_FK3))
        );
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task Multiple_required_navigation_using_multiple_selects_with_EF_Property_Include(
        bool async
    )
        // Include after select. Issue #16752.
        =>
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task SelectMany_with_nested_required_navigation_filter_and_explicit_DefaultIfEmpty(
        bool async
    ) =>
        AssertQuery(
            async,
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task SelectMany_with_nested_navigations_and_additional_joins_outside_of_SelectMany(
        bool async
    ) =>
        AssertQuery(
            async,
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task Multiple_SelectMany_with_nested_navigations_and_explicit_DefaultIfEmpty_joined_together(
        bool async
    ) =>
        AssertQuery(
            async,
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task SelectMany_with_nested_navigations_and_explicit_DefaultIfEmpty_followed_by_Select_required_navigation_using_same_navs(
        bool async
    ) =>
        AssertQuery(async, ss =>
    ...
    public virtual Task SelectMany_with_nested_navigations_and_explicit_DefaultIfEmpty_followed_by_Select_required_navigation_using_different_navs(
        ...
        AssertQuery(async, ss =>
            from l3 in ss.Set<Level1>()
                .SelectMany(l1 => l1.OneToOne_Optional_FK1.OneToMany_Optional2.DefaultIfEmpty())
            select l3.OneToOne_Required_FK_Inverse3.OneToOne_Required_PK_Inverse2
        );
    ...
    public virtual Task Select_join_subquery_containing_filter_and_distinct(bool async) =>
        AssertQuery(
            ...
            ss =>
                from l1 in ss.Set<Level1>()
                join l2 in ss.Set<Level2>().Where(l => l.Id > 2).Distinct()
                    on l1.Id equals l2.Level1_Optional_Id
                select new { l1, l2 },
            elementSorter: e => (e.l1.Id, e.l2.Id),
            elementAsserter: (e, a) =>
    ...
    public virtual Task Contains_with_subquery_optional_navigation_and_constant_item(bool async) =>
        AssertQuery(
            ...
            ss =>
                ss.Set<Level1>()
                    .Where(l1 =>
                        l1.OneToOne_Optional_FK1.OneToMany_Optional2.MaybeScalar(x =>
                            x.Distinct().Select(l3 => l3.Id).Contains(6)
                        ) == true
                    )
        );
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task Contains_with_subquery_optional_navigation_scalar_distinct_and_constant_item(
        bool async
    ) =>
        AssertQuery(
            async,
            ...
            ss =>
                ss.Set<Level1>()
                    .Where(l1 =>
                        l1.OneToOne_Optional_FK1.OneToMany_Optional2.MaybeScalar(x =>
                            x.Select(l3 => l3.Name.Length).Distinct().Contains(5)
                        ) == true
                    )
        );
    ...
    public virtual Task Manually_created_left_join_propagates_nullability_to_navigations(
        ...
        AssertQuery(async, ss =>
            ...
            join l2_manual in ss.Set<Level2>()
                on l1_manual.Id equals l2_manual.Level1_Optional_Id
                into grouping
    ...
    public virtual Task Optional_navigation_propagates_nullability_to_manually_created_left_join2(
        ...
        AssertQuery(
            ...
            ss =>
                from l3 in ss.Set<Level3>()
                join l2_nav in ss.Set<Level1>().Select(ll => ll.OneToOne_Optional_FK1)
                    on l3.Level2_Required_Id equals l2_nav.Id
                    into grouping
    ...
    public virtual Task Null_reference_protection_complex(bool async) =>
        AssertQuery(async, ss =>
            from l3 in ss.Set<Level3>()
            join l2_outer in from l1_inner in ss.Set<Level1>()
            join l2_inner in ss.Set<Level2>()
                on l1_inner.Id equals l2_inner.Level1_Optional_Id
                into grouping_inner
            from l2_inner in grouping_inner.DefaultIfEmpty()
            select l2_inner
                on l3.Level2_Required_Id equals l2_outer.Id
                into grouping_outer
    ...
    private static TResult ClientMethodReturnSelf<TResult>(TResult element) => element;
    ...
    public virtual Task GroupJoin_with_complex_subquery_with_joins_does_not_get_flattened(
        ...
        AssertQueryScalar(async, ss =>
            ...
            join subquery in from l2_inner in ss.Set<Level2>()
            join l1_inner in ss.Set<Level1>() on l2_inner.Level1_Required_Id equals l1_inner.Id
            select l2_inner
                on l1_outer.Id equals subquery.Level1_Optional_Id
                into grouping
    ...
    public virtual Task GroupJoin_with_complex_subquery_with_joins_does_not_get_flattened3(
        ...
        AssertQueryScalar(async, ss =>
            from l1_outer in ss.Set<Level1>()
            join subquery in from l2_inner in ss.Set<Level2>()
            join l1_inner in ss.Set<Level1>()
                on l2_inner.Level1_Required_Id equals l1_inner.Id
                into grouping_inner
            from l1_inner in grouping_inner.DefaultIfEmpty()
            select l2_inner
                on l1_outer.Id equals subquery.Level1_Required_Id
                into grouping
            from subquery in grouping.DefaultIfEmpty()
            select (int?)subquery.Id
        );
    ...
    public virtual Task GroupJoin_on_a_subquery_containing_another_GroupJoin_with_orderby_on_inner_sequence_projecting_inner(
        ...
        AssertQuery(async, ss =>
            from x in (
                from l1 in ss.Set<Level1>()
                join l2 in ss.Set<Level2>().OrderBy(ee => ee.Date)
                    on l1.Id equals l2.Level1_Optional_Id
                    into grouping
                from l2 in grouping.DefaultIfEmpty()
                orderby l1.Id
    ...
    public virtual Task GroupJoin_on_left_side_being_a_subquery(bool async) =>
        AssertQuery(
            ...
            ss =>
                ss.Set<Level1>()
                    .OrderBy(l1 => l1.OneToOne_Optional_FK1.Name)
                    .ThenBy(l1 => l1.Id)
                    .Take(2)
    ...
    public virtual Task GroupJoin_on_right_side_being_a_subquery(bool async) =>
        AssertQuery(
            ...
            ss =>
                from l2 in ss.Set<Level2>()
                join l1 in ss.Set<Level1>().OrderBy(x => x.OneToOne_Optional_FK1.Name).Take(2)
                    on l2.Level1_Optional_Id equals l1.Id
                    into grouping
    ...
    private static bool ClientMethod(int? id) => true;

    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task GroupJoin_in_subquery_with_client_result_operator(bool async) =>
        AssertQuery(async, ss => from l1 in ss.Set<Level1>() where
                (
                    ...
                    .Distinct()
                    .Count() > 7 where l1.Id < 3 select l1.Name);
    ...
    public virtual Task GroupJoin_in_subquery_with_client_projection_nested1(bool async) =>
        AssertQuery(async, ss => from l1_outer in ss.Set<Level1>() where
                (
                    from l1_middle in ss.Set<Level1>()
                    join l2_middle in ss.Set<Level2>()
                        on l1_middle.Id equals l2_middle.Level1_Optional_Id
                        into grouping_middle
                    ...
                    .OrderBy(l1 => l1.Id)
                    .Take(10)
                    .Count() > 4 where l1_outer.Id < 2 select l1_outer.Name);
    ...
    private static string ClientStringMethod(string argument) => argument;
    ...
    private static int ClientMethodNullableInt(int? id) => id ?? 0;
...
#pragma warning restore IDE0031 // Use null propagation
        ...
        AssertQuery(async, ss =>
            ...
            where
                (
                    from l1_inner in ss.Set<Level1>()
                    join l2 in ss.Set<Level2>()
                        on l1_inner.Id equals l2.Level1_Optional_Id
                        into grouping
                    from l2 in grouping.DefaultIfEmpty()
                    select l1_inner
                ).Count() > 4
    ...
    public virtual Task Where_on_multilevel_reference_in_subquery_with_outer_projection(
        ...
        AssertQuery(async, ss =>
            ss.Set<Level3>()
                .Where(l3 =>
                    l3.OneToMany_Required_Inverse3.OneToOne_Required_FK_Inverse2.Name == "L1 10"
    ...
    public virtual Task Navigation_with_same_navigation_compared_to_null(bool async) =>
        AssertQueryScalar(async, ss =>
            from l2 in ss.Set<Level2>()
            where
                l2.OneToMany_Required_Inverse2.Name != "L1 07"
                && l2.OneToMany_Required_Inverse2 != null
            select l2.Id
        );
    ...
    public virtual Task Navigations_compared_to_each_other4(bool async) =>
        AssertQuery(
            ...
            ss =>
                from l2 in ss.Set<Level2>()
                where
                    l2.OneToOne_Required_FK2.OneToMany_Optional3.MaybeScalar(x =>
                        x.Select(i => i.OneToOne_Optional_PK_Inverse4 == l2.OneToOne_Required_FK2)
                            .Any()
                    ) == true
                select l2.Name
        );
    ...
    public virtual Task Navigations_compared_to_each_other5(bool async) =>
        AssertQuery(
            ...
            ss =>
                ...
                where
                    l2.OneToOne_Required_FK2.OneToMany_Optional3.MaybeScalar(x =>
                        x.Select(i => i.OneToOne_Optional_PK_Inverse4 == l2.OneToOne_Optional_PK2)
                            .Any()
                    ) == true
                select l2.Name
        );
    ...
    public virtual Task Level4_Include(bool async)
        ...
        AssertIncludeOnNonEntity(() =>
            AssertQuery(
                ...
                ss =>
                    ss.Set<Level1>()
                        .Select(l1 => l1.OneToOne_Required_PK1)
                        .Where(t => t != null)
    ...
    public virtual Task Comparing_collection_navigation_on_optional_reference_to_null(bool async) =>
        AssertQueryScalar(async, ss =>
            ss.Set<Level1>()
                .Where(l1 => l1.OneToOne_Optional_FK1.OneToMany_Optional2 == null)
                .Select(l1 => l1.Id)
        );
    ...
    public virtual Task Select_subquery_with_client_eval_and_navigation1(bool async) =>
        AssertQuery(async, ss =>
            ss.Set<Level2>()
                .Select(l2 =>
                    ss.Set<Level2>().OrderBy(l => l.Id).First().OneToOne_Required_FK_Inverse2.Name
                )
        );
    ...
    public virtual Task Include_reference_with_groupby_in_subquery(bool async) =>
        AssertQuery(
            ...
            elementAsserter: (e, a) =>
                AssertInclude(e, a, new ExpectedInclude<Level1>(e => e.OneToOne_Optional_FK1))
        );
        ...
        AssertQuery(
            ...
            elementAsserter: (e, a) =>
                AssertInclude(
                    e,
                    a,
                    new ExpectedInclude<InheritanceDerived1>(e1 => e1.ReferenceSameType),
        ...
        AssertQuery(
            ...
            elementAsserter: (e, a) =>
                AssertInclude(
                    e,
                    a,
                    new ExpectedInclude<InheritanceDerived1>(e1 => e1.ReferenceDifferentType),
        ...
        AssertQuery(
            ...
            elementAsserter: (e, a) =>
                AssertInclude(
                    ...
                    new ExpectedInclude<InheritanceDerived1>(e1 => e1.ReferenceDifferentType),
                    new ExpectedInclude<InheritanceDerived2>(e2 => e2.ReferenceDifferentType),
                    new ExpectedInclude<InheritanceLeaf2>(
                        e3 => e3.BaseCollection,
                        "ReferenceDifferentType"
                    )
                )
        );
        ...
        AssertQuery(
            ...
            elementAsserter: (e, a) =>
                AssertInclude(
                    e,
                    a,
                    new ExpectedInclude<InheritanceDerived1>(e1 => e1.CollectionSameType),
        ...
        AssertQuery(
            ...
            elementAsserter: (e, a) =>
                AssertInclude(
                    e,
                    a,
                    new ExpectedInclude<InheritanceDerived1>(e1 => e1.CollectionDifferentType),
    ...
    public virtual Task String_include_multiple_derived_navigations_complex(bool async) =>
        AssertQuery(
            async,
            ss =>
                ss.Set<InheritanceBase2>()
                    .Include("Reference.CollectionDifferentType")
                    .Include("Collection.ReferenceSameType"),
            elementAsserter: (e, a) =>
                AssertInclude(
                    e,
                    a,
                    new ExpectedInclude<InheritanceBase2>(e1 => e1.Reference),
                    new ExpectedInclude<InheritanceDerived1>(
                        e2 => e2.CollectionDifferentType,
                        "Reference"
                    ),
                    new ExpectedInclude<InheritanceDerived2>(
                        e3 => e3.CollectionDifferentType,
                        "Reference"
                    ),
                    new ExpectedInclude<InheritanceBase2>(e4 => e4.Collection),
                    new ExpectedInclude<InheritanceDerived1>(
                        e5 => e5.ReferenceSameType,
                        "Collection"
                    ),
                    new ExpectedInclude<InheritanceDerived2>(
                        e6 => e6.ReferenceSameType,
                        "Collection"
                    )
                )
        );
    ...
    public virtual Task Nav_rewrite_doesnt_apply_null_protection_for_function_arguments(
        ...
        AssertQueryScalar(async, ss =>
            ss.Set<Level1>()
                .Where(l1 => l1.OneToOne_Optional_PK1 != null)
    ...
    public virtual Task Accessing_optional_property_inside_result_operator_subquery(bool async)
    {
        ...
        return AssertQuery(async, ss =>
            ss.Set<Level1>().Where(l1 => names.All(n => l1.OneToOne_Optional_FK1.Name != n))
        );
    }
    ...
    public virtual Task SelectMany_subquery_with_custom_projection(bool async) =>
        AssertQuery(async, ss =>
            ss.Set<Level1>()
                .OrderBy(l1 => l1.Id)
                .SelectMany(l1 => l1.OneToMany_Optional1.Select(l2 => new { l2.Name }))
                .Take(1)
        );
    ...
    public virtual Task Include3(bool async) =>
        AssertQuery(
            ...
            ss =>
                ss.Set<Level1>()
                    .Include(l1 => l1.OneToOne_Optional_FK1)
                    .Include(l1 => l1.OneToOne_Optional_PK1),
            elementAsserter: (e, a) =>
                AssertInclude(
                    e,
                    a,
        ...
        AssertQuery(
            ...
            ss =>
                ss.Set<Level1>()
                    ...
                    .Select(l1 => l1.OneToOne_Optional_FK1),
            elementAsserter: (e, a) =>
                AssertInclude(e, a, new ExpectedInclude<Level2>(l2 => l2.OneToOne_Optional_PK2))
        );
        ...
        AssertQuery(
            ...
            ss =>
                ss.Set<Level1>()
                    .Include(l1 => l1.OneToOne_Optional_FK1.OneToOne_Optional_PK2)
                    .Include(l1 =>
                        l1.OneToOne_Optional_PK1.OneToOne_Optional_FK2.OneToOne_Optional_PK3
                    ),
            elementAsserter: (e, a) =>
                AssertInclude(
                    e,
                    ...
                    new ExpectedInclude<Level2>(
                        ...
                        "OneToOne_Optional_PK1"
                    ),
                    new ExpectedInclude<Level3>(
                        l3 => l3.OneToOne_Optional_PK3,
                        "OneToOne_Optional_FK1.OneToOne_Optional_FK2"
                    )
                )
        );
        ...
        AssertQuery(
            ...
            ss =>
                ss.Set<Level1>()
                    ...
                    .Include(l1 => l1.OneToOne_Optional_FK1.OneToOne_Optional_PK2)
                    .Include(l1 =>
                        l1.OneToOne_Optional_PK1.OneToOne_Optional_FK2.OneToOne_Optional_FK3
                    )
                    .Include(l1 =>
                        l1.OneToOne_Optional_PK1.OneToOne_Optional_FK2.OneToOne_Optional_PK3
                    )
            ...
            elementAsserter: (e, a) =>
                AssertInclude(
                    ...
                    new ExpectedInclude<Level3>(
                        ...
                        "OneToOne_Optional_PK1.OneToOne_Optional_FK2"
                    ),
                    new ExpectedInclude<Level1>(l1 => l1.OneToOne_Optional_PK1),
                    new ExpectedInclude<Level2>(
                        l2 => l2.OneToOne_Optional_FK2,
    ...
    public virtual Task Include18_2(bool async) =>
        AssertQuery(
            ...
            ss =>
                ss.Set<Level1>()
                    .Where(x => x.OneToOne_Required_FK1.Name != "Foo")
                    .Include(x => x.OneToOne_Optional_FK1)
                    .Distinct(),
            elementAsserter: (e, a) =>
                AssertInclude(e, a, new ExpectedInclude<Level1>(l1 => l1.OneToOne_Optional_FK1))
    ...
    public virtual async Task Include18_3_2(bool async)
    {
        ...
        var query = ctx
            ...
            .Select(l1 => new
            {
                outer_foo = new { inner_foo = l1, inner_bar = l1.Name },
                outer_bar = l1,
            })
            .Take(10);
        ...
        AssertQuery(
            ...
            ss =>
                ss.Set<Level1>()
                    ...
                    .Distinct(),
            elementAsserter: (e, a) =>
                AssertInclude(e, a, new ExpectedInclude<Level2>(l1 => l1.OneToOne_Optional_FK2))
        );
    ...
    public virtual Task Null_check_different_structure_does_not_remove_null_checks(bool async) =>
        AssertQuery(async, ss => ss.Set<Level1>()
                .Where(l1 =>
                    (
                        l1.OneToOne_Optional_FK1 == null ? null
                        : l1.OneToOne_Optional_FK1.OneToOne_Optional_FK2 == null ? null
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task Including_reference_navigation_and_projecting_collection_navigation_2(
        bool async
    ) =>
        AssertQuery(async, ss =>
            ss.Set<Level1>()
    ...
    public virtual Task OrderBy_collection_count_ThenBy_reference_navigation(bool async) =>
        AssertQuery(
            ...
            ss =>
                ss.Set<Level1>()
                    .OrderBy(l1 =>
                        l1.OneToOne_Required_FK1.OneToMany_Required2.MaybeScalar(x => x.Count())
                        ?? 0
                    )
                    .ThenBy(l1 => l1.OneToOne_Required_FK1.OneToOne_Required_FK2.Name),
            assertOrder: true
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task Null_conditional_is_not_applied_explicitly_for_optional_navigation(
        bool async
    ) =>
        AssertQuery(async, ss =>
            ss.Set<Level1>()
                .Where(l1 =>
                    l1.OneToOne_Optional_FK1 != null && l1.OneToOne_Optional_FK1.Name == "L2 01"
                )
        );
    ...
    public virtual Task Sum_with_selector_cast_using_as(bool async) =>
        AssertSum(async, ss => ss.Set<Level1>().Select(s => s.Id as int?));
    ...
    public virtual Task Sum_with_filter_with_include_selector_cast_using_as(bool async) =>
        AssertQuery(async, ss =>
            ss.Set<Level1>()
                .Where(l1 => l1.Id > l1.OneToMany_Optional1.Select(l2 => l2.Id as int?).Sum())
        );
    ...
    public virtual Task Select_with_joined_where_clause_cast_using_as(bool async) =>
        AssertQuery(async, ss =>
            ss.Set<Level1>().Where(w => (w.Id + 7) == w.OneToOne_Optional_FK1.Id as int?)
        );

    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task SelectMany_with_outside_reference_to_joined_table_correctly_translated_to_apply(
        bool async
    ) =>
        AssertQuery(async, ss =>
            from l1 in ss.Set<Level1>()
            ...
            from other in ss.Set<Level1>()
                .Where(x => x.Id <= l2.Id && x.Name == l4.Name)
                .DefaultIfEmpty()
            select l1
        );
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task Nested_SelectMany_correlated_with_join_table_correctly_translated_to_apply(
        bool async
    ) => AssertQuery(async, ss => ss.Set<Level1>()
                .SelectMany(l1 =>
    ...
    public virtual Task Contains_over_optional_navigation_with_null_parameter(bool async) =>
        AssertSingleResult(
            ...
            ss =>
                ss.Set<Level1>().Select(l1 => l1.OneToOne_Optional_FK1).ContainsAsync(null, default)
        );
            ...
            ss =>
                ss.Set<Level1>()
                    .Select(l1 => new
                    {
                        ...
                        Contains = ss.Set<Level1>()
                            .Select(x => x.OneToOne_Optional_FK1.Name)
                            .Contains(l1.OneToOne_Optional_FK1.Name),
                    }),
            ...
            ss =>
                ss.Set<Level1>()
                    .Select(l1 => new
                    {
                        ...
                        OptionalName = l1.OneToOne_Optional_FK1.Name,
                        Contains = ss.Set<Level1>()
                            .Select(x => x.OneToOne_Optional_FK1)
                            .Contains(l1.OneToOne_Optional_PK1),
                    }),
            elementSorter: e => (e.Name, e.OptionalName, e.Contains)
        );
    ...
    public virtual Task Let_let_contains_from_outer_let(bool async) =>
        AssertQuery(
            async,
            ss =>
                from l1 in ss.Set<Level1>().Include(l => l.OneToMany_Required1)
                let level2Ids = from level2 in l1.OneToMany_Required1
                select level2.Id
                let level3s = (
            ...
            ss =>
                ss.Set<Level2>()
                    .Select(l2 => new Level1Dto
                    {
                        Id = l2.Id,
                        Name =
                            l2.OneToOne_Optional_FK2 == null ? null : l2.OneToOne_Optional_FK2.Name,
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task Composite_key_join_on_groupby_aggregate_projecting_only_grouping_key(
        bool async
    ) =>
        AssertQueryScalar(async, ss =>
            ss.Set<Level1>()
                .Join(
                    ss.Set<Level2>()
                        .GroupBy(g => g.Id % 3)
                        .Select(g => new { g.Key, Sum = g.Sum(x => x.Id) }),
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task Collection_FirstOrDefault_entity_reference_accesses_in_projection(
        bool async
    ) =>
        AssertQuery(async, ss =>
            ss.Set<Level1>()
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task Collection_FirstOrDefault_entity_collection_accesses_in_projection(
        bool async
    ) =>
        AssertQuery(
            async,
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task Multiple_collection_FirstOrDefault_followed_by_member_access_in_projection(
        bool async
    ) =>
        AssertQuery(async, ss =>
            ss.Set<Level1>()
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task Projecting_columns_with_same_name_from_different_entities_making_sure_aliasing_works_after_Distinct(
        bool async
    ) =>
        AssertQuery(
            async,
    ...
    public virtual Task SelectMany_without_collection_selector_returning_queryable(bool async) =>
        AssertQuery(async, ss =>
            ss.Set<Level1>().SelectMany(x => ss.Set<Level2>().Where(l2 => l2.Id < 10))
        );
    ...
    public virtual Task Select_projecting_queryable_followed_by_SelectMany(bool async) =>
        AssertInvalidMaterializationType(
            () =>
                AssertQuery(async, ss =>
                    ss.Set<Level1>()
                        .Select(x => ss.Set<Level2>().Where(l2 => l2.Id < 10))
                        .SelectMany(x => x)
                ),
            "IQueryable<Level2>"
        );
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task Join_with_result_selector_returning_queryable_throws_validation_error(
        bool async
    ) =>
        AssertQuery(async, ss =>
            from l1 in ss.Set<Level1>()
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task Select_projecting_queryable_in_anonymous_projection_followed_by_Join(
        bool async
    )
        // Materialization type. Issue #23302.
        =>
        AssertInvalidMaterializationType(
            () =>
                AssertQuery(async, ss =>
                    ss.Set<Level1>()
                        .Select(x => new { Subquery = ss.Set<Level2>().Where(l2 => l2.Id < 10) })
                        .Join(ss.Set<Level3>(), o => 7, i => i.Id, (o, i) => i)
                ),
            "IQueryable<Level1>"
        );
    ...
    public virtual Task Project_shadow_properties1(bool async) =>
        AssertQuery(
            async,
            ss =>
                from x in ss.Set<Level1>()
                select new
                {
                    x.Id,
                    OneToOne_Optional_Self1Id = EF.Property<int?>(x, "OneToOne_Optional_Self1Id"),
                    OneToMany_Required_Self_Inverse1Id = EF.Property<int?>(
                        x,
                        "OneToMany_Required_Self_Inverse1Id"
                    ),
                    OneToMany_Optional_Self_Inverse1Id = EF.Property<int?>(
                        x,
    ...
    public virtual Task Project_shadow_properties2(bool async) =>
        AssertQuery(
            async,
            ss =>
                from x in ss.Set<Level2>()
                select new
                {
                    x.Id,
                    OneToOne_Optional_PK_Inverse2Id = EF.Property<int?>(
                        x,
                        "OneToOne_Optional_PK_Inverse2Id"
                    ),
                    OneToMany_Required_Inverse2Id = EF.Property<int?>(
                        x,
                        "OneToMany_Required_Inverse2Id"
                    ),
                    OneToMany_Optional_Inverse2Id = EF.Property<int?>(
                        x,
                        "OneToMany_Optional_Inverse2Id"
                    ),
                    OneToOne_Optional_Self2Id = EF.Property<int?>(x, "OneToOne_Optional_Self2Id"),
                    OneToMany_Required_Self_Inverse2Id = EF.Property<int?>(
                        x,
                        "OneToMany_Required_Self_Inverse2Id"
                    ),
                    OneToMany_Optional_Self_Inverse2Id = EF.Property<int?>(
                        x,
    ...
    public virtual Task Project_shadow_properties3(bool async) =>
        AssertQuery(
            async,
            ss =>
                from x in ss.Set<Level3>()
                select new
                {
                    x.Id,
                    OneToOne_Optional_PK_Inverse3Id = EF.Property<int?>(
                        x,
                        "OneToOne_Optional_PK_Inverse3Id"
                    ),
                    OneToMany_Required_Inverse3Id = EF.Property<int?>(
                        x,
                        "OneToMany_Required_Inverse3Id"
                    ),
                    OneToMany_Optional_Inverse3Id = EF.Property<int?>(
                        x,
                        "OneToMany_Optional_Inverse3Id"
                    ),
                    OneToOne_Optional_Self3Id = EF.Property<int?>(x, "OneToOne_Optional_Self3Id"),
                    OneToMany_Required_Self_Inverse3Id = EF.Property<int?>(
                        x,
                        "OneToMany_Required_Self_Inverse3Id"
                    ),
                    OneToMany_Optional_Self_Inverse3Id = EF.Property<int?>(
                        x,
    ...
    public virtual Task Project_shadow_properties4(bool async) =>
        AssertQuery(
            async,
            ss =>
                from x in ss.Set<Level4>()
                select new
                {
                    x.Id,
                    OneToOne_Optional_PK_Inverse4Id = EF.Property<int?>(
                        x,
                        "OneToOne_Optional_PK_Inverse4Id"
                    ),
                    OneToMany_Required_Inverse4Id = EF.Property<int?>(
                        x,
                        "OneToMany_Required_Inverse4Id"
                    ),
                    OneToMany_Optional_Inverse4Id = EF.Property<int?>(
                        x,
                        "OneToMany_Optional_Inverse4Id"
                    ),
                    OneToOne_Optional_Self4Id = EF.Property<int?>(x, "OneToOne_Optional_Self4Id"),
                    OneToMany_Required_Self_Inverse4Id = EF.Property<int?>(
                        x,
                        "OneToMany_Required_Self_Inverse4Id"
                    ),
                    OneToMany_Optional_Self_Inverse4Id = EF.Property<int?>(
                        x,
                        "OneToMany_Optional_Self_Inverse4Id"
                    ),
                },
            elementSorter: e => e.Id
        );
    ...
    public virtual Task Project_shadow_properties5(bool async) =>
        AssertQuery(
            async,
            ss =>
                from x in ss.Set<InheritanceBase1>()
                select new
                {
                    x.Id,
    ...
    public virtual Task Project_shadow_properties6(bool async) =>
        AssertQuery(
            async,
            ss =>
                from x in ss.Set<InheritanceBase1>().OfType<InheritanceDerived1>()
                select new
                {
                    x.Id,
                    InheritanceBase2Id = EF.Property<int?>(x, "InheritanceBase2Id"),
    ...
    public virtual Task Project_shadow_properties7(bool async) =>
        AssertQuery(
            async,
            ss =>
                from x in ss.Set<InheritanceBase1>().OfType<InheritanceDerived2>()
                select new
                {
                    x.Id,
                    InheritanceBase2Id = EF.Property<int?>(x, "InheritanceBase2Id"),
    ...
    public virtual Task Project_shadow_properties8(bool async) =>
        AssertQuery(
            async,
            ss =>
                from x in ss.Set<InheritanceBase2>()
                select new
                {
                    x.Id,
    ...
    public virtual Task Project_shadow_properties9(bool async) =>
        AssertQuery(
            async,
            ss =>
                from x in ss.Set<InheritanceLeaf1>()
                select new
                {
                    x.Id,
                    DifferentTypeReference_InheritanceDerived1Id = EF.Property<int?>(
                        x,
                    ...
                    SameTypeReference_InheritanceDerived1Id = EF.Property<int?>(
                        x,
                        "SameTypeReference_InheritanceDerived1Id"
                    ),
                    SameTypeReference_InheritanceDerived2Id = EF.Property<int?>(
                        x,
                        "SameTypeReference_InheritanceDerived2Id"
                    ),
                },
            elementSorter: e => e.Id
        );
    ...
    public virtual Task Project_shadow_properties10(bool async) =>
        AssertQuery(
            async,
            ss =>
                from x in ss.Set<InheritanceLeaf2>()
                select new
                {
                    x.Id,
                    DifferentTypeReference_InheritanceDerived2Id = EF.Property<int?>(
                        x,
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task GroupJoin_SelectMany_DefaultIfEmpty_with_predicate_using_closure_nested(
        bool async
    )
    {
        var prm1 = 10;
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task GroupJoin_SelectMany_DefaultIfEmpty_with_predicate_using_closure_nested_same_param(
        bool async
    )
    {
        var prm = 10;
    ...
    [ConditionalTheory]
    [MemberData(nameof(IsAsyncData))]
    public virtual Task GroupJoin_SelectMany_with_predicate_using_closure_nested_same_param(
        bool async
    )
    {
        var prm = 10;
