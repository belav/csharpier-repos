        ...
        AssertQuery(
            ...
            ss =>
                ss.Set<Level1>()
                    .Where(
                        l =>
                            EF.Property<int>(EF.Property<Level2>(l, "OneToOne_Required_FK1"), "Id")
                            == 7
                    )
        );
    ...
    public virtual Task Simple_level1_level2_level3_include(bool async) =>
        AssertQuery(
            ...
            ss =>
                ss.Set<Level1>()
                    .Include(
                        l1 => l1.OneToOne_Required_PK1.OneToOne_Required_PK2.OneToOne_Required_PK3
                    )
        );
    ...
    public virtual Task SelectMany_nested_navigation_property_required(bool async) =>
        AssertQuery(
            ...
            ss =>
                ss.Set<Level1>()
                    .SelectMany(
                        l1 => l1.OneToOne_Required_FK1.OneToMany_Optional2 ?? new List<Level3>()
                    )
        );
    ...
    public virtual Task SelectMany_nested_navigation_property_optional_and_projection(bool async) =>
        AssertQuery(
            ...
            ss =>
                ss.Set<Level1>()
                    .SelectMany(
                        l1 => l1.OneToOne_Optional_FK1.OneToMany_Optional2 ?? new List<Level3>()
                    )
                    .Select(e => e.Name)
        );
        ...
        AssertQuery(
            ...
            ss =>
                ss.Set<Level1>()
                    .Where(
                        l1 =>
                            l1.OneToOne_Required_FK1.OneToMany_Optional2.MaybeScalar(x => x.Count)
                            > 0
                    )
        );
            ...
            () =>
                AssertQuery(
                    ...
                    ss =>
                        ss.Set<Level4>()
                            .Select(
                                l4 => l4.OneToOne_Required_FK_Inverse4.OneToOne_Required_FK_Inverse3
                            )
                ...
                ss.Set<Level1>()
                    .Where(
                        l1 =>
                            l1.OneToOne_Optional_FK1
                                .OneToMany_Optional2
                                .MaybeScalar(x => x.Distinct().Select(l3 => l3.Id).Contains(6))
                            == true
                    )
        );
...
#pragma warning restore IDE0031 // Use null propagation
        ...
        AssertQuery(
            ...
            ss =>
                ss.Set<Level1>()
                    .Include(l1 => l1.OneToOne_Optional_FK1.OneToOne_Optional_PK2)
                    .Include(
                        l1 => l1.OneToOne_Optional_PK1.OneToOne_Optional_FK2.OneToOne_Optional_PK3
                    ),
            elementAsserter: (e, a) =>
                AssertInclude(
                    e,
        ...
        AssertQuery(
            ...
            ss =>
                ss.Set<Level1>()
                    ...
                    .Include(l1 => l1.OneToOne_Optional_FK1.OneToOne_Optional_PK2)
                    .Include(
                        l1 => l1.OneToOne_Optional_PK1.OneToOne_Optional_FK2.OneToOne_Optional_FK3
                    )
                    .Include(
                        l1 => l1.OneToOne_Optional_PK1.OneToOne_Optional_FK2.OneToOne_Optional_PK3
                    )
    ...
    public virtual async Task Include18_3_2(bool async)
    {
        ...
        var query = ctx.LevelOne
            ...
            .Select(
                l1 =>
                    new { outer_foo = new { inner_foo = l1, inner_bar = l1.Name }, outer_bar = l1 }
            )
            .Take(10);
                    ...
                    .Select(
                        l2 =>
                            new Level1Dto
                            {
                                Id = l2.Id,
                                Name =
                                    l2.OneToOne_Optional_FK2 == null
                                        ? null
                                        : l2.OneToOne_Optional_FK2.Name,
                                Level2 =
                                    l2.OneToOne_Optional_FK_Inverse2 == null
                                        ? null
                                        : new Level2Dto()
                            }
                    ),
            ...
            () =>
                AssertQuery(
                    ...
                    ss =>
                        ss.Set<Level1>()
                            .Select(
                                x => new { Subquery = ss.Set<Level2>().Where(l2 => l2.Id < 10) }
                            )
                            .Join(ss.Set<Level3>(), o => 7, i => i.Id, (o, i) => i)
                ),
            "IQueryable<Level1>"
