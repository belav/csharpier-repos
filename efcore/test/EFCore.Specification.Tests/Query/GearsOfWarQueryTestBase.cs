    ...
    public virtual Task Select_null_propagation_optimization7(bool async) =>
        AssertQuery(
            ...
            ss =>
                ss.Set<Gear>()
                    .Select(g =>
                        null != g.LeaderNickname ? g.LeaderNickname + g.LeaderNickname : null
                    )
        );
            ...
            ss =>
                ss.Set<Gear>()
                    ...
                    .Where(g =>
                        g.HasSoulPatch
                        && g
                            .Weapons.Where(w => w.Name.Contains("Lancer"))
                            .Distinct()
                            .Select(w => w.IsAutomatic)
                            .SingleOrDefault()
                    ),
            ...
            ss =>
                ss.Set<Gear>()
                    .Where(g =>
                        g.HasSoulPatch
                        && g
                            .Weapons.Join(g.Weapons, e => e.Id, e => e.Id, (e1, e2) => e1)
                            .OrderBy(w => w.Id)
                            .FirstOrDefault()
                            .IsAutomatic
                    )
...
#pragma warning restore IDE0031 // Use null propagation
    ...
    public virtual Task Distinct_on_subquery_doesnt_get_lifted(bool async) =>
        AssertQueryScalar(
            async,
            ss => from g in (from ig in ss.Set<Gear>() select ig).Distinct() select g.HasSoulPatch
        );
        ...
        AssertQuery(
            ...
            ss =>
                ss.Set<City>()
                    ...
                    .Select(c =>
                        c
                            .StationedGears.Select(g => new Officer
                            {
        ...
        AssertQuery(
            ...
            ss =>
                ss.Set<City>()
                    ...
                    .Select(c =>
                        c
                            .StationedGears.OrderByDescending(g => g.Nickname)
    ...
    public virtual Task Enum_array_contains(bool async)
    {
        ...
        return AssertQuery(
            ...
            ss =>
                ss.Set<Weapon>()
                    .Where(w =>
                        w.SynergyWith != null && types.Contains(w.SynergyWith.AmmunitionType)
                    )
        );
    }
        ...
        AssertQuery(
            ...
            ss =>
                ss.Set<Gear>()
                    ...
                    .Select(g =>
                        g
                            .Weapons.SelectMany(x => x.Owner.AssignedCity.BornGears)
    ...
    public virtual Task Enum_matching_take_value_gets_different_type_mapping(bool async)
    {
        ...
        return AssertQueryScalar(
            async,
            ss => ss.Set<Gear>().OrderBy(g => g.Nickname).Take(1).Select(g => g.Rank & value)
        );
    }
        ...
        AssertQuery(
            ...
            ss =>
                ss.Set<Squad>()
                    .Where(s =>
                        s
                            .Members.Where(m => m.FullName == "Anthony Carmine")
        ...
        AssertQuery(
            ...
            ss =>
                ss.Set<Gear>()
                    .Where(s =>
                        s
                            .Weapons.Where(w => w.Name == "Hammer of Dawn")
                            .OrderBy(e => e.Name)
                            .FirstOrDefault() == null
                    )
        );
        ...
        return AssertQuery(
            ...
            ss =>
                ss.Set<Gear>()
                    .OrderBy(x => x.Nickname)
                    .Select(x =>
                        x.Weapons.OrderBy(g => g.Id).ElementAt(x.AssignedCity != null ? 1 : 0)
                    )
        );
    }
