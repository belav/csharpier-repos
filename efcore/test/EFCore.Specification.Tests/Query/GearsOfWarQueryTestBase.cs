        ...
        AssertQuery(
            ...
            ss =>
                ss.Set<Gear>()
                    .Select(
                        g =>
                            new { g.Nickname, Weapons = g.Weapons.Take(10).ToList(), g.CityOfBirth }
                    ),
            elementSorter: e => e.Nickname,
            elementAsserter: (e, a) =>
            {
                    ...
                    .Select(
                        g =>
                            new
                            {
                                ...
                                Subquery = g.Weapons
                                    .Select(
                                        w => new { w.Name, w.IsAutomatic, w.OwnerFullName.Length }
                                    )
                                    .Distinct()
                                    .ToList()
                            }
                                        ...
                                        xx =>
                                            new
                                            {
                                                ...
                                                Subquery2 = (
                                                    ...
                                                    select new { w.Id, x.Length, xx.HasSoulPatch }
                                                ).ToList()
                                            }
                                    )
                                    .ToList()
