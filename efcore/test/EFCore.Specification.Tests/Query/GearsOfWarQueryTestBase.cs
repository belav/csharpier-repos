    ...
    public virtual Task Correlated_collections_basic_projection(bool async) =>
        AssertQuery(
            ...
            ss =>
                ...
                where g.Nickname != "Marcus"
                orderby g.Nickname
                select (from w in g.Weapons where w.IsAutomatic || w.Name != "foo" select w).ToList(
                ...
                ss.Set<Gear>()
                    ...
                    .Select(o => new
                    {
                        ...
                        OuterCollection = o.Reports.Where(r => r.FullName != "Foo")
                            ...
                            {
                                g.FullName,
                                InnerCollection = g.Weapons.Where(w => w.Name != "Bar")
                    ...
                    OuterCollection = (
                        ...
                        select new
                        {
                            ...
                            InnerCollection = (
                                ...
                                {
                                    w.Id,
                                    InnerFirst = w.Owner.Weapons.Select(ww => new
                                    {
                                        ww.Name,
                                        ww.IsAutomatic
                                    })
        ...
        AssertQuery(
            ...
            ss =>
                ss.Set<Gear>()
                    ...
                    {
                        Key = g.Nickname,
                        Subquery = g.Weapons.Select(w => new
                        {
                            w.Id,
                            w.Name,
                            w.OwnerFullName
        ...
        AssertQuery(
            ...
            ss =>
                ss.Set<Squad>()
                    ...
                    {
                        Key = s.Id,
                        Subquery = s.Members.Select(m => new
                        {
                            m.Nickname,
                            m.SquadId,
                            m.HasSoulPatch
