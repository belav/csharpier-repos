    ...
    where TFixture : NorthwindQueryFixtureBase<NoopModelCustomizer>, new()
{
        ...
        AssertQuery(
            ...
            ss =>
                ss.Set<Order>()
                    .GroupBy(
                        o =>
                            new NominalType { CustomerID = o.CustomerID, EmployeeID = o.EmployeeID }
                    )
        ...
        AssertQuery(
            ...
            ss =>
                ss.Set<Order>()
                    ...
                    .Select(
                        e =>
                            new NoGroupByAggregationWrapper
                            {
    ...
    public virtual Task GroupBy_empty_key_Aggregate(bool async) =>
        AssertQueryScalar(
            async,
            ss => ss.Set<Order>().GroupBy(o => new { }).Select(g => g.Sum(o => o.OrderID))
        );
        ...
        AssertQuery(
            ...
            ss =>
                ss.Set<Customer>()
                    ...
                    .Union(ss.Set<Customer>().Where(c => c.City == "M�xico D.F."))
                    .GroupBy(c => c.City)
        ...
        AssertQuery(
            ...
            ss =>
                ss.Set<Customer>()
                    ...
                    .Select(
                        c => ss.Set<Order>().GroupBy(o => o.OrderID).Select(g => g.Key).ToArray()
                    ),
            assertOrder: true,
    ...
    public virtual Task GroupBy_Property_Select_Count_with_predicate(bool async) =>
        AssertQueryScalar(
            ...
            ss =>
                ss.Set<Order>()
                    .GroupBy(o => o.CustomerID)
                    .Select(g => g.Count(o => o.OrderID < 10300))
        );
                ...
                AssertQuery(
                    ...
                    ss =>
                        ss.Set<Customer>()
                            ...
                            .ThenBy(x => x.g.Key)
                            .Select(
                                x => new { Locality = x.g.Key ?? "Unknown", Count = x.citiesCount }
                            )
                ),
        ...
        AssertQuery(
            ...
            ss =>
                ss.Set<Employee>()
                    .Where(
                        e =>
                            EF.Property<string>(e, "Title") == "Sales Representative"
                            && e.EmployeeID == 1
                    )
    ...
    public virtual Task GroupBy_with_group_key_being_navigation_with_entity_key_projection(
        ...
        AssertQuery(
            async,
            ss => ss.Set<OrderDetail>().GroupBy(od => od.Order).Select(g => g.Key),
            entryCount: 830
        );
        ...
        AssertQuery(
            ...
            ss =>
                ss.Set<Order>()
                    ...
                    .Select(
                        o => new { o, OrderDetails = o.OrderDetails.Where(od => od.ProductID < 25) }
                    )
                    .Select(
                        info =>
                            new
    ...
    public virtual Task GroupBy_nominal_type_count(bool async) =>
        AssertCount(
            async,
            ss => ss.Set<Order>().GroupBy(o => o.CustomerID).Select(e => new Result(e.Key))
        );
                        ...
                        c =>
                            new
                            {
                                ...
                                Orders = ss.Set<Order>()
                                    ...
                                    .GroupBy(o => o.CustomerID)
                                    .Select(
                                        g => g.OrderByDescending(e => e.OrderDate).FirstOrDefault()
                                    )
                                    .ToList()
                            }
                    ),
