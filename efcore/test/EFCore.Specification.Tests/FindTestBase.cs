        ...
        where TFixture : FindTestBase<TFixture>.FindFixtureBase
    {
        ...
        public virtual void Throws_for_wrong_number_of_values_for_composite_key()
        {
            ...
            Assert.Equal(
                ...
                Assert
                    .Throws<ArgumentException>(() => Finder.Find<CompositeKey>(context, 77))
                    .Message
            );
        }
        ...
        public virtual void Throws_for_bad_type_for_composite_key()
        {
            ...
            Assert.Equal(
                ...
                Assert
                    .Throws<ArgumentException>(() => Finder.Find<CompositeKey>(context, 77, 88))
                    .Message
            );
        }
        ...
        public virtual void Throws_for_bad_entity_type()
        {
            ...
            Assert.Equal(
                ...
                Assert
                    .Throws<InvalidOperationException>(() => Finder.Find<Random>(context, 77))
                    .Message
            );
        }
        ...
        public virtual void Throws_for_bad_entity_type_with_different_namespace()
        {
            ...
            Assert.Equal(
                CoreStrings.InvalidSetSameTypeWithDifferentNamespace(
                    typeof(DifferentNamespace.ShadowKey).DisplayName(),
        ...
        public virtual async Task Find_int_key_tracked_async(CancellationType cancellationType)
        {
            ...
            var valueTask = Finder.FindAsync<IntKey>(
                cancellationType,
                context,
                new object[] { 88 }
            );
        ...
        public virtual async Task Find_int_key_from_store_async(CancellationType cancellationType)
        {
            ...
            Assert.Equal(
                "Smokey",
                (await Finder.FindAsync<IntKey>(cancellationType, context, new object[] { 77 })).Foo
            );
        }
        ...
        )
        {
            using var context = CreateContext();
            Assert.Null(
                await Finder.FindAsync<IntKey>(cancellationType, context, new object[] { 99 })
            );
        }
        ...
        )
        {
            ...
            Assert.Same(
                entity,
                await Finder.FindAsync<NullableIntKey>(
                    cancellationType,
                    context,
                    new object[] { 88 }
                )
        ...
        public virtual async Task Find_string_key_tracked_async(CancellationType cancellationType)
        {
            ...
            Assert.Same(
                entity,
                await Finder.FindAsync<StringKey>(
                    cancellationType,
                    context,
                    new object[] { "Rabbit" }
                )
        ...
        )
        {
            using var context = CreateContext();
            Assert.Null(
                await Finder.FindAsync<StringKey>(cancellationType, context, new object[] { "Fox" })
            );
        }
        ...
        )
        {
            ...
            Assert.Same(
                entity,
                await Finder.FindAsync<CompositeKey>(
                    cancellationType,
                    context,
                    new object[] { 88, "Rabbit" }
                )
            );
        }
        ...
        public virtual async Task Find_base_type_tracked_async(CancellationType cancellationType)
        {
            ...
            Assert.Same(
                entity,
                await Finder.FindAsync<BaseType>(cancellationType, context, new object[] { 88 })
            );
        }
        ...
        )
        {
            using var context = CreateContext();
            Assert.Null(
                await Finder.FindAsync<BaseType>(cancellationType, context, new object[] { 99 })
            );
        }
        ...
        public virtual async Task Find_derived_type_tracked_async(CancellationType cancellationType)
        {
            ...
            Assert.Same(
                entity,
                await Finder.FindAsync<DerivedType>(cancellationType, context, new object[] { 88 })
            );
        }
        ...
        {
            using var context = CreateContext();
            var derivedType = await Finder.FindAsync<DerivedType>(
                cancellationType,
                context,
                new object[] { 78 }
            );
        ...
        )
        {
            using var context = CreateContext();
            Assert.Null(
                await Finder.FindAsync<DerivedType>(cancellationType, context, new object[] { 99 })
            );
        }
        ...
        )
        {
            using var context = CreateContext();
            Assert.Null(
                await Finder.FindAsync<DerivedType>(cancellationType, context, new object[] { 77 })
            );
        }
        ...
        {
            using var context = CreateContext();
            var derivedType = await Finder.FindAsync<BaseType>(
                cancellationType,
                context,
                new object[] { 78 }
            );
        ...
        public virtual async Task Find_shadow_key_tracked_async(CancellationType cancellationType)
        {
            ...
            Assert.Same(
                entry.Entity,
                await Finder.FindAsync<ShadowKey>(cancellationType, context, new object[] { 88 })
            );
        }
        ...
        )
        {
            using var context = CreateContext();
            Assert.Null(
                await Finder.FindAsync<ShadowKey>(cancellationType, context, new object[] { 99 })
            );
        }
        ...
        public virtual async Task Returns_null_for_null_key_async(CancellationType cancellationType)
        {
            using var context = CreateContext();
            Assert.Null(
                await Finder.FindAsync<IntKey>(cancellationType, context, new object[] { null })
            );
        }
        ...
        public class FindViaSetFinder : TestFinder
        {
            ...
            public override ValueTask<TEntity> FindAsync<TEntity>(
                ...
                {
                    CancellationType.Right => context
                        .Set<TEntity>()
                        .FindAsync(keyValues, cancellationToken: cancellationToken),
                    CancellationType.Wrong => context
                        .Set<TEntity>()
        ...
        public class FindViaContextFinder : TestFinder
        {
            ...
            public override async ValueTask<TEntity> FindAsync<TEntity>(
                ...
                cancellationType switch
                {
                    CancellationType.Right => (TEntity)
                        await context.FindAsync(
                            typeof(TEntity),
                            keyValues,
                            cancellationToken: cancellationToken
                        ),
                    CancellationType.Wrong => (TEntity)
                        await context.FindAsync(
                            typeof(TEntity),
                            keyValues?.Concat(new object[] { cancellationToken }).ToArray()
                        ),
                    CancellationType.None => (TEntity)
                        await context.FindAsync(typeof(TEntity), keyValues),
                    _ => throw new ArgumentOutOfRangeException(
                        nameof(cancellationType),
                        cancellationType,
                        null
        ...
        public class FindViaNonGenericContextFinder : TestFinder
        {
            ...
            public override ValueTask<TEntity> FindAsync<TEntity>(
                ...
                cancellationType switch
                {
                    CancellationType.Right => context.FindAsync<TEntity>(
                        keyValues,
                        cancellationToken: cancellationToken
                    ),
