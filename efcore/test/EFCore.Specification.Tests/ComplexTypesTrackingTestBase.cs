...
public abstract class ComplexTypesTrackingTestBase<TFixture>(TFixture fixture)
    ...
    where TFixture : ComplexTypesTrackingTestBase<TFixture>.FixtureBase
{
    ...
    [InlineData(false)]
    [InlineData(true)]
    public virtual void Can_read_original_values_for_properties_of_complex_types(
        bool trackFromQuery
    ...
    [InlineData(false)]
    [InlineData(true)]
    public virtual void Can_write_original_values_for_properties_of_complex_types(
        bool trackFromQuery
    ...
    [InlineData(EntityState.Deleted, false)]
    [InlineData(EntityState.Deleted, true)]
    public virtual Task Can_track_entity_with_complex_readonly_structs(
        EntityState state,
        bool async
    ...
    [InlineData(false)]
    [InlineData(true)]
    public virtual void Can_mark_complex_readonly_readonly_struct_properties_modified(
        bool trackFromQuery
    ...
    [InlineData(false)]
    [InlineData(true)]
    public virtual void Can_read_original_values_for_properties_of_readonly_structs(
        bool trackFromQuery
    ...
    [InlineData(false)]
    [InlineData(true)]
    public virtual void Can_write_original_values_for_properties_of_readonly_structs(
        bool trackFromQuery
    ...
    [InlineData(EntityState.Deleted, false)]
    [InlineData(EntityState.Deleted, true)]
    public virtual Task Can_track_entity_with_complex_record_objects(
        EntityState state,
        bool async
    ...
    [InlineData(false)]
    [InlineData(true)]
    public virtual void Can_read_original_values_for_properties_of_record_complex_types(
        bool trackFromQuery
    ...
    [InlineData(false)]
    [InlineData(true)]
    public virtual void Can_write_original_values_for_properties_of_record_complex_types(
        bool trackFromQuery
    ...
    [InlineData(EntityState.Deleted, false)]
    [InlineData(EntityState.Deleted, true)]
    public virtual Task Can_track_entity_with_complex_objects_with_fields(
        EntityState state,
        bool async
    ...
    [InlineData(false)]
    [InlineData(true)]
    public virtual void Can_mark_complex_type_properties_modified_with_fields(
        bool trackFromQuery
    ...
    [InlineData(false)]
    [InlineData(true)]
    public virtual void Can_read_original_values_for_properties_of_complex_types_with_fields(
        bool trackFromQuery
    ...
    [InlineData(false)]
    [InlineData(true)]
    public virtual void Can_write_original_values_for_properties_of_complex_types_with_fields(
        bool trackFromQuery
    ...
    [InlineData(EntityState.Deleted, false)]
    [InlineData(EntityState.Deleted, true)]
    public virtual Task Can_track_entity_with_complex_structs_with_fields(
        EntityState state,
        bool async
    ...
    [InlineData(false)]
    [InlineData(true)]
    public virtual void Can_mark_complex_readonly_struct_properties_modified_with_fields(
        bool trackFromQuery
    ...
    [InlineData(false)]
    [InlineData(true)]
    public virtual void Can_read_original_values_for_properties_of_structs_with_fields(
        bool trackFromQuery
    ...
    [InlineData(false)]
    [InlineData(true)]
    public virtual void Can_write_original_values_for_properties_of_structs_with_fields(
        bool trackFromQuery
    ...
    [InlineData(EntityState.Deleted, false)]
    [InlineData(EntityState.Deleted, true)]
    public virtual Task Can_track_entity_with_complex_readonly_structs_with_fields(
        EntityState state,
        bool async
    ...
    [InlineData(false)]
    [InlineData(true)]
    public virtual void Can_mark_complex_readonly_readonly_struct_properties_modified_with_fields(
        bool trackFromQuery
    ...
    [InlineData(false)]
    [InlineData(true)]
    public virtual void Can_read_original_values_for_properties_of_readonly_structs_with_fields(
        bool trackFromQuery
    ...
    [InlineData(false)]
    [InlineData(true)]
    public virtual void Can_write_original_values_for_properties_of_readonly_structs_with_fields(
        bool trackFromQuery
    ...
    [InlineData(EntityState.Deleted, false)]
    [InlineData(EntityState.Deleted, true)]
    public virtual Task Can_track_entity_with_complex_record_objects_with_fields(
        EntityState state,
        bool async
    ...
    [InlineData(false)]
    [InlineData(true)]
    public virtual void Can_mark_complex_record_type_properties_modified_with_fields(
        bool trackFromQuery
    ...
    [InlineData(false)]
    [InlineData(true)]
    public virtual void Can_read_original_values_for_properties_of_record_complex_types_with_fields(
        bool trackFromQuery
    ...
    [InlineData(false)]
    [InlineData(true)]
    public virtual void Can_write_original_values_for_properties_of_record_complex_types_with_fields(
        bool trackFromQuery
    ) => WriteOriginalValuesTest(trackFromQuery, c => CreateFieldPubWithRecords(c));

    private async Task TrackAndSaveTest<TEntity>(
        EntityState state,
        bool async,
        ...
        where TEntity : class
    {
        ...
        var membersEntry = entry
            .ComplexProperty("LunchtimeActivity")
            .ComplexProperty("RunnersUp")
            .Property("Members");
    ...
    private void ReadOriginalValuesTest<TEntity>(
        bool trackFromQuery,
        Func<DbContext, TEntity> createPub
    )
        where TEntity : class
    ...
    private void WriteOriginalValuesTest<TEntity>(
        bool trackFromQuery,
        Func<DbContext, TEntity> createPub
    )
        where TEntity : class
    {
        ...
        var membersEntry = entry
            .ComplexProperty("EveningActivity")
            .ComplexProperty("Champions")
            .Property("Members");
    ...
    public virtual void Detect_changes_in_complex_type_properties(bool trackFromQuery)
    {
        ...
        pub.EveningActivity.Champions.Members = new List<string> { "1", "2", "3" };
        context.ChangeTracker.DetectChanges();

        var membersEntry = entry
            .ComplexProperty(e => e.EveningActivity)
            .ComplexProperty(e => e.Champions)
        ...
        var coverChargeEntry = entry
            .ComplexProperty(e => e.EveningActivity)
            .Property(e => e.CoverCharge);
    ...
    [InlineData(false)]
    [InlineData(true)]
    public virtual async Task Throws_only_when_saving_with_null_top_level_complex_property(
        bool async
    )
    {
        using var context = CreateContext();
    ...
    [InlineData(false)]
    [InlineData(true)]
    public virtual async Task Throws_only_when_saving_with_null_second_level_complex_property(
        bool async
    )
    {
        using var context = CreateContext();
    ...
    [InlineData(false)]
    [InlineData(true)]
    public virtual async Task Throws_only_when_saving_with_null_third_level_complex_property(
        bool async
    )
    {
        using var context = CreateContext();
    ...
    public virtual void Detect_changes_in_complex_struct_type_properties(bool trackFromQuery)
    {
        ...
        champions.Members = new List<string> { "1", "2", "3" };
    ...
    [InlineData(false)]
    [InlineData(true)]
    public virtual void Detects_changes_in_complex_readonly_struct_type_properties(
        bool trackFromQuery
    )
    {
        using var context = CreateContext();
    ...
    protected void AssertPropertyValues(EntityEntry entry)
    {
        ...
        Assert.Equal(
            "A general knowledge pub quiz.",
            lunchtimeEntry.Property("Description").CurrentValue
        );
        Assert.Equal(
            new[] { "One", "Two", "Three" },
            lunchtimeEntry.Property("Notes").CurrentValue
        );
        ...
        Assert.Equal(
            new[] { "Boris", "David", "Theresa" },
            lunchtimeChampionsEntry.Property("Members").CurrentValue
        );
        ...
        Assert.Equal(
            ...
            lunchtimeRunnersUpEntry.Property("Members").CurrentValue
        );
        ...
        Assert.Equal(
            new[] { "Robert", "Jimmy", "John", "Jason" },
            eveningChampionsEntry.Property("Members").CurrentValue
        );
    ...
    {
        protected override string StoreName => "ComplexTypesTrackingTest";

        public virtual bool UseProxies => false;
    ...
    protected Pub CreatePub(
        DbContext context,
        bool nullActivity = false,
        bool nullChampions = false,
        bool nullRunnersUp = false
    )
    {
        var pub = Fixture.UseProxies ? context.CreateProxy<Pub>() : new Pub();
        ...
        pub.LunchtimeActivity = nullActivity
            ...
            : new Activity
            {
                ...
                Champions = nullChampions
                    ? null!
                    : new Team { Name = "Clueless", Members = { "Boris", "David", "Theresa" } },
                RunnersUp = nullRunnersUp
                    ? null!
                    : new Team
                    {
                        Name = "ZZ",
                        Members = { "Has Beard", "Has Beard", "Is Called Beard" },
                    },
            };
        ...
        pub.EveningActivity = new Activity
        {
            ...
            {
                Name = "Dazed and Confused",
                Members = { "Robert", "Jimmy", "John", "Jason" },
            },
    ...
    {
        var pub = Fixture.UseProxies ? context.CreateProxy<PubWithStructs>() : new PubWithStructs();
        ...
        pub.FeaturedTeam = new TeamStruct
        {
    ...
    protected PubWithReadonlyStructs CreatePubWithReadonlyStructs(DbContext context)
    {
        ...
        pub.FeaturedTeam = new TeamReadonlyStruct
        {
            Name = "Not In This Lifetime",
            Members = new List<string> { "Slash", "Axl" },
        };
    ...
    {
        var pub = Fixture.UseProxies ? context.CreateProxy<PubWithRecords>() : new PubWithRecords();
        ...
        pub.FeaturedTeam = new TeamRecord
        {
            Name = "Not In This Lifetime",
            Members = new List<string> { "Slash", "Axl" },
        };
    ...
    protected static FieldPubWithStructs CreateFieldPubWithStructs(DbContext context) =>
        new()
        {
            ...
            FeaturedTeam = new FieldTeamStruct
            {
                Name = "Not In This Lifetime",
                Members = new List<string> { "Slash", "Axl" },
            },
    ...
    protected static FieldPubWithReadonlyStructs CreateFieldPubWithReadonlyStructs(
        ...
        new()
        {
            Id = Guid.NewGuid(),
            Name = "The FBI",
            LunchtimeActivity = new FieldActivityReadonlyStruct(
                "Pub Quiz",
                2.0m,
                true,
                "A general knowledge pub quiz.",
                ...
                new FieldTeamReadonlyStruct(
                    "Clueless",
                    new List<string> { "Boris", "David", "Theresa" }
                ),
                new FieldTeamReadonlyStruct(
                    "ZZ",
                    new List<string> { "Has Beard", "Has Beard", "Is Called Beard" }
                )
            ),
            EveningActivity = new FieldActivityReadonlyStruct(
                "Music Quiz",
                5.0m,
                true,
                "A music pub quiz.",
                ...
                new FieldTeamReadonlyStruct(
                    "Dazed and Confused",
                    new List<string> { "Robert", "Jimmy", "John", "Jason" }
                ),
                new FieldTeamReadonlyStruct("Banksy", new List<string>())
            ),
            FeaturedTeam = new FieldTeamReadonlyStruct(
                "Not In This Lifetime",
                new List<string> { "Slash", "Axl" }
            ),
        };
    ...
    protected static FieldPubWithRecords CreateFieldPubWithRecords(DbContext context) =>
        new()
        {
            ...
            FeaturedTeam = new FieldTeamRecord
            {
                Name = "Not In This Lifetime",
                Members = new List<string> { "Slash", "Axl" },
            },
    ...
    {
        var yogurt = Fixture.UseProxies ? context.CreateProxy<Yogurt>() : new Yogurt();
