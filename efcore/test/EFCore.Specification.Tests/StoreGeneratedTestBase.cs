    ...
    where TFixture : StoreGeneratedTestBase<TFixture>.StoreGeneratedFixtureBase, new()
{
    ...
    )
    {
        ...
        ExecuteWithStrategyInTransaction(
            ...
            {
                var entity = context
                    .Add(Anais.Create(Fixture.IntSentinel, Fixture.StringSentinel))
                    .Entity;
    ...
    public virtual void Before_save_use_always_uses_value_if_set(string propertyName)
    {
        ...
        ExecuteWithStrategyInTransaction(
            ...
            {
                var entity = context
                    .Add(WithValue(propertyName, Fixture.IntSentinel, Fixture.StringSentinel))
                    .Entity;
    ...
    public virtual void After_save_throw_always_throws_if_value_modified(string propertyName) =>
        ...
        {
            context
                .Attach(WithValue(propertyName, 1, Fixture.StringSentinel))
    ...
    public virtual void Identity_property_on_Added_entity_with_default_value_gets_value_from_store()
    {
        ...
        ExecuteWithStrategyInTransaction(
            ...
            {
                var entity = context
                    .Add(Gumball.Create(Fixture.IntSentinel, Fixture.StringSentinel))
                    .Entity;
    ...
    public virtual void Fields_used_correctly_for_store_generated_values()
    {
        ...
        ExecuteWithStrategyInTransaction(
            ...
            {
                var entity = context
                    .Add(WithBackingFields.Create(Fixture.IntSentinel, Fixture.NullableIntSentinel))
                    .Entity;
    ...
    public virtual void Nullable_fields_get_defaults_when_not_set() =>
        ExecuteWithStrategyInTransaction(
            context =>
            {
                var entity = context
                    .Add(
                        WithNullableBackingFields.Create(
                            Fixture.NullableIntSentinel,
                            Fixture.NullableBoolSentinel
                        )
                    )
                    .Entity;
    ...
    public virtual void Nullable_fields_store_non_defaults_when_set() =>
        ExecuteWithStrategyInTransaction(
            context =>
            {
                var entity = WithNullableBackingFields.Create(
                    Fixture.NullableIntSentinel,
                    Fixture.NullableBoolSentinel
                );
    ...
    public virtual void Object_fields_get_defaults_when_not_set() =>
        ExecuteWithStrategyInTransaction(
            context =>
            {
                var entity = WithObjectBackingFields.Create(
                    Fixture.NullableIntSentinel,
                    Fixture.NullableBoolSentinel
                );
                context.Add(entity);
...
#pragma warning restore RCS1085 // Use auto-implemented property.
    ...
    public virtual void Insert_update_and_delete_with_long_to_int_conversion()
    {
        ...
        ExecuteWithStrategyInTransaction(
            ...
            context =>
            {
                ...
                var optionalDependents1 = context
                    .Set<LongToIntDependentOptional>()
                    .Include(e => e.Principal)
                    .ToList();
                Assert.Equal(2, optionalDependents1.Count);
                Assert.Null(optionalDependents1.Single(e => e.Principal == null).PrincipalId);
                ...
                var requiredDependents1 = context
                    .Set<LongToIntDependentRequired>()
                    .Include(e => e.Principal)
                    .ToList();
                Assert.Single(requiredDependents1);
    ...
    {
        public virtual Guid GuidSentinel => default;

        public virtual int IntSentinel => default;

        public virtual short ShortSentinel => default;

        public virtual long LongSentinel => default;

        public virtual int? NullableIntSentinel => default;

        public virtual bool BoolSentinel => default;

        public virtual bool? NullableBoolSentinel => default;

        public virtual string? StringSentinel => default;

        public virtual Uri? UriSentinel => default;

        public virtual KeyEnum KeyEnumSentinel => default;

        public virtual string? StringAsGuidSentinel => default;

        public virtual Guid GuidAsStringSentinel => default;

        public virtual WrappedIntKeyClass? WrappedIntKeyClassSentinel => default;

        public virtual WrappedIntClass? WrappedIntClassSentinel => default;

        public virtual WrappedIntKeyStruct WrappedIntKeyStructSentinel => default;

        public virtual WrappedIntStruct WrappedIntStructSentinel => default;

        public virtual WrappedIntKeyRecord? WrappedIntKeyRecordSentinel => default;

        public virtual WrappedIntRecord? WrappedIntRecordSentinel => default;

        public virtual WrappedStringKeyClass? WrappedStringKeyClassSentinel => default;

        public virtual WrappedStringClass? WrappedStringClassSentinel => default;

        public virtual WrappedStringKeyStruct WrappedStringKeyStructSentinel => default;

        public virtual WrappedStringStruct WrappedStringStructSentinel => default;

        public virtual WrappedStringKeyRecord? WrappedStringKeyRecordSentinel => default;

        public virtual WrappedStringRecord? WrappedStringRecordSentinel => default;

        public virtual WrappedGuidKeyClass? WrappedGuidKeyClassSentinel => default;

        public virtual WrappedGuidClass? WrappedGuidClassSentinel => default;

        public virtual WrappedGuidKeyStruct WrappedGuidKeyStructSentinel => default;

        public virtual WrappedGuidStruct WrappedGuidStructSentinel => default;

        public virtual WrappedGuidKeyRecord? WrappedGuidKeyRecordSentinel => default;

        public virtual WrappedGuidRecord? WrappedGuidRecordSentinel => default;

        public virtual WrappedUriKeyClass? WrappedUriKeyClassSentinel => default;

        public virtual WrappedUriClass? WrappedUriClassSentinel => default;

        public virtual WrappedUriKeyStruct WrappedUriKeyStructSentinel => default;

        public virtual WrappedUriStruct WrappedUriStructSentinel => default;

        public virtual WrappedUriKeyRecord? WrappedUriKeyRecordSentinel => default;

        public virtual WrappedUriRecord? WrappedUriRecordSentinel => default;
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder, DbContext context)
        {
            ...
            {
                var keyConverter = new ValueConverter<long, int>(v => (int)v, v => v);
