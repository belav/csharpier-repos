    ...
    where TFixture : ManyToManyTrackingTestBase<TFixture>.ManyToManyTrackingFixtureBase
{
    ...
    public virtual async Task Can_insert_many_to_many_composite_with_navs(bool async)
    {
        ...
        await ExecuteWithStrategyInTransactionAsync(
            ...
            async context =>
            {
                ...
                var leftEntities = context
                    .ChangeTracker.Entries<EntityCompositeKey>()
                    .Select(e => e.Entity)
                    .OrderBy(e => e.Key2)
                    .ToList();

                var rightEntities = context
                    .ChangeTracker.Entries<EntityLeaf>()
                    .Select(e => e.Entity)
                    .OrderBy(e => e.Name)
                    .ToList();
        ...
        )
        {
            ...
            var joinEntities = context
                .ChangeTracker.Entries<JoinCompositeKeyToLeaf>()
                .Select(e => e.Entity)
                .ToList();
    ...
    public virtual async Task Can_insert_many_to_many_composite_shared_with_navs(bool async)
    {
        ...
        await ExecuteWithStrategyInTransactionAsync(
            ...
            async context =>
            {
                ...
                var rightEntities = context
                    .ChangeTracker.Entries<EntityRoot>()
                    .Select(e => e.Entity)
                    .OrderBy(e => e.Name)
                    .ToList();
    ...
    public virtual void Can_delete_with_many_to_many_composite_shared_with_navs()
    {
        ...
        ExecuteWithStrategyInTransaction(
            context =>
            {
                ...
                key3 = toRemoveOne.Key3;
                var refCountOnes = threes
                    .SelectMany(e => e.CompositeKeySkipShared)
                    .Count(e => e == toRemoveOne);
                ...
                Assert.Equal(
                    refCountOnes,
                    threes.SelectMany(e => e.CompositeKeySkipShared).Count(e => e == toRemoveOne)
                );
                Assert.Equal(
                    refCountThrees,
                    ones.SelectMany(e => e.RootSkipShared).Count(e => e == toRemoveThree)
    ...
    public virtual async Task Can_insert_many_to_many_composite_additional_pk_with_navs(bool async)
    {
        ...
        await ExecuteWithStrategyInTransactionAsync(
            ...
            async context =>
            {
                ...
                var rightEntities = context
                    .ChangeTracker.Entries<EntityThree>()
                    .Select(e => e.Entity)
                    .OrderBy(e => e.Name)
                    .ToList();
        ...
        )
        {
            ...
            var joinEntities = context
                .ChangeTracker.Entries<JoinThreeToCompositeKeyFull>()
                .Select(e => e.Entity)
                .ToList();
            foreach (var joinEntity in joinEntities)
            {
    ...
    public virtual async Task Can_insert_many_to_many_self_shared(bool async)
    {
        ...
        await ExecuteWithStrategyInTransactionAsync(
            ...
            async context =>
            {
                ...
                var leftEntities = context
                    .ChangeTracker.Entries<EntityTwo>()
                    .Select(e => e.Entity)
    ...
    public virtual async Task Can_insert_many_to_many_with_navs(bool async)
    {
        ...
        )
        {
            ...
            var joinEntities = context
                .ChangeTracker.Entries<JoinTwoToThree>()
                .Select(e => e.Entity)
                .ToList();
            foreach (var joinEntity in joinEntities)
            {
    ...
    public virtual async Task Can_insert_many_to_many_with_inheritance(bool async)
    {
        ...
        await ExecuteWithStrategyInTransactionAsync(
            ...
            async context =>
            {
                ...
                var leftEntities = context
                    .ChangeTracker.Entries<EntityOne>()
                    .Select(e => e.Entity)
                    .OrderBy(e => e.Name)
                    .ToList();
                var rightEntities = context
                    .ChangeTracker.Entries<EntityBranch>()
                    .Select(e => e.Entity)
                    .OrderBy(e => e.Name)
                    .ToList();
    ...
    public virtual void Can_update_many_to_many_with_inheritance()
    {
        ExecuteWithStrategyInTransaction(
            context =>
            {
                ...
                rightEntities[1]
                    .OneSkip.Remove(rightEntities[1].OneSkip.Single(e => e.Name == "EntityOne 9"));
                ...
                rightEntities[2]
                    .OneSkip.Remove(rightEntities[2].OneSkip.Single(e => e.Name == "EntityOne 8"));
                rightEntities[2]
                    .OneSkip.Add(
                        context.EntityOnes.CreateInstance(
                            (e, p) =>
        ...
        )
        {
            ...
            var deleted = context
                .ChangeTracker.Entries<JoinOneToBranch>()
                .Count(e => e.State == EntityState.Deleted);
            Assert.Equal(joinCount, (count / 2) + deleted);
        }
    }
    ...
    public virtual async Task Can_insert_many_to_many_self_with_payload(bool async)
    {
        ...
        )
        {
            ...
            var joinEntities = context
                .ChangeTracker.Entries<JoinOneSelfPayload>()
                .Select(e => e.Entity)
                .ToList();
            foreach (var joinEntity in joinEntities)
            {
    ...
    public virtual void Can_update_many_to_many_self_with_payload()
    {
        ...
        ExecuteWithStrategyInTransaction(
            context =>
            {
                ...
                context
                    .Find<JoinOneSelfPayload>(
                        keys[5],
                        context
                            .Entry(context.EntityOnes.Local.Single(e => e.Name == "EntityOne 1"))
                            .Property(e => e.Id)
                            .CurrentValue
                    )
                ...
                context
                    .Find<JoinOneSelfPayload>(
                        context
                            .Entry(context.EntityOnes.Local.Single(e => e.Name == "EntityOne 20"))
                            .Property(e => e.Id)
                            .CurrentValue,
                        context
                            .Entry(context.EntityOnes.Local.Single(e => e.Name == "EntityOne 16"))
                            .Property(e => e.Id)
                            .CurrentValue
                    )
    ...
    public virtual void Can_update_many_to_many_shared_with_payload()
    {
        ExecuteWithStrategyInTransaction(
            context =>
            {
                ...
                rightEntities[4]
                    .OneSkipPayloadFullShared.Remove(
                        rightEntities[4]
                            .OneSkipPayloadFullShared.Single(e => e.Name == "EntityOne 6")
                    );
                ...
                rightEntities[2]
                    .OneSkipPayloadFullShared.Remove(
                        rightEntities[2]
                            .OneSkipPayloadFullShared.Single(e => e.Name == "EntityOne 12")
                    );
                rightEntities[2]
                    .OneSkipPayloadFullShared.Add(
                        context.EntityOnes.CreateInstance(
        ...
        static int GetEntityOneId(ManyToManyContext context, string name) =>
            context
                .Entry(context.EntityOnes.Local.Single(e => e.Name == name))
                .Property(e => e.Id)
                .CurrentValue;

        static int GetEntityThreeId(ManyToManyContext context, string name) =>
            context
                .Entry(context.EntityThrees.Local.Single(e => e.Name == name))
                .Property(e => e.Id)
                .CurrentValue;
    ...
    public virtual async Task Can_insert_many_to_many_with_payload(bool async)
    {
        ...
        )
        {
            ...
            var joinEntities = context
                .ChangeTracker.Entries<JoinOneToThreePayloadFull>()
                .Select(e => e.Entity)
                .ToList();
            foreach (var joinEntity in joinEntities)
            {
    ...
    public virtual void Can_update_many_to_many_with_payload()
    {
        ExecuteWithStrategyInTransaction(
            context =>
            {
                ...
                context
                    .Find<JoinOneToThreePayloadFull>(
                        GetEntityOneId(context, "Z7712"),
                        GetEntityThreeId(context, "EntityThree 1")
                    )
                    .Payload = "Set!";
    ...
    public virtual void Can_delete_with_many_to_many_with_navs()
    {
        ExecuteWithStrategyInTransaction(
            context =>
            {
                ...
                var refCountOnes = threes
                    .SelectMany(e => e.OneSkipPayloadFull)
                    .Count(e => e == toRemoveOne);
    ...
    )
    {
        ...
        )
        {
            ...
            var extra = context
                .ChangeTracker.Entries<JoinOneToTwoExtra>()
                .Select(e => e.Entity)
                .Single();
    ...
    )
    {
        ...
        )
        {
            ...
            var joinEntities = context
                .ChangeTracker.Entries<JoinOneToTwo>()
                .Select(e => e.Entity)
                .ToList();
    ...
    public virtual void Can_update_many_to_many()
    {
        ...
        ExecuteWithStrategyInTransaction(
            context =>
            {
                ...
                leftEntities[1]
                    .TwoSkip.Remove(leftEntities[1].TwoSkip.Single(e => e.Name == "EntityTwo 1"));
                rightEntities[1]
                    .OneSkip.Remove(rightEntities[1].OneSkip.Single(e => e.Name == "EntityOne 1"));

                leftEntities[2]
                    .TwoSkip.Remove(leftEntities[2].TwoSkip.Single(e => e.Name == "EntityTwo 1"));
                leftEntities[2].TwoSkip.Add(twos[3]);

                rightEntities[2]
                    .OneSkip.Remove(rightEntities[2].OneSkip.Single(e => e.Name == "EntityOne 1"));
    ...
    public virtual async Task Can_insert_many_to_many_fully_by_convention(bool async)
    {
        ...
        await ExecuteWithStrategyInTransactionAsync(
            ...
            async context =>
            {
                ...
                var leftEntities = context
                    .ChangeTracker.Entries<ImplicitManyToManyA>()
                    .Select(e => e.Entity)
                    .OrderBy(e => e.Name)
                    .ToList();
                var rightEntities = context
                    .ChangeTracker.Entries<ImplicitManyToManyB>()
                    .Select(e => e.Entity)
                    .OrderBy(e => e.Name)
                    .ToList();
    ...
    public virtual async Task Can_insert_many_to_many_fully_by_convention_generated_keys(bool async)
    {
        await ExecuteWithStrategyInTransactionAsync(
            ...
            async context =>
            {
                ...
                var leftEntities = context
                    .ChangeTracker.Entries<GeneratedKeysLeft>()
                    .Select(e => e.Entity)
                    .OrderBy(e => e.Name)
                    .ToList();
                var rightEntities = context
                    .ChangeTracker.Entries<GeneratedKeysRight>()
                    .Select(e => e.Entity)
                    .OrderBy(e => e.Name)
                    .ToList();
    ...
    public virtual void Can_add_and_remove_a_new_relationship(
        bool modifyLeft,
        bool modifyRight,
        bool useJoin,
        bool useNavs
                ...
                if (useJoin)
                {
                    context.Add(
                        RequiresDetectChanges
                            ...
                            : useNavs
                                ? context.CreateProxy<JoinOneToTwo>(e =>
                                {
                                    e.One = left;
                                    e.Two = right;
                                })
    ...
    [InlineData(true, false, true)]
    [InlineData(true, true, true)]
    public virtual void Can_add_and_remove_a_new_relationship_self(
        bool modifyLeft,
        bool modifyRight,
        bool useJoin
    )
    {
        ...
        ExecuteWithStrategyInTransaction(
            context =>
            {
                var left = context
                    .Set<EntityTwo>()
                    .Where(e => !e.SelfSkipSharedRight.Any())
                    .OrderBy(e => e.Id)
                    .First();
                var right = context
                    .Set<EntityTwo>()
                    .Where(e => !e.SelfSkipSharedLeft.Any())
                    .OrderBy(e => e.Id)
                    .First();
                ...
                {
                    context
                        .Set<Dictionary<string, object>>("EntityTwoEntityTwo")
                        .Add(
    ...
    [InlineData(true, false, true)]
    [InlineData(true, true, true)]
    public virtual void Can_add_and_remove_a_new_relationship_with_inheritance(
        bool modifyLeft,
        bool modifyRight,
        bool useJoin
    )
                ...
                if (useJoin)
                {
                    context.Add(
                        RequiresDetectChanges
                            ...
                            : context.CreateProxy<JoinOneToBranch>(e =>
                            {
    ...
    [InlineData(true, false, true)]
    [InlineData(true, true, true)]
    public virtual void Can_add_and_remove_a_new_relationship_shared_with_payload(
        bool modifyLeft,
        bool modifyRight,
        bool useJoin
    )
    {
        ...
        ExecuteWithStrategyInTransaction(
            context =>
            {
                var left = context
                    .Set<EntityOne>()
                    .Where(e => !e.ThreeSkipPayloadFullShared.Any())
                    .OrderBy(e => e.Id)
                    .First();
                var right = context.Set<EntityThree>().OrderBy(e => e.Id).First();
    ...
    [InlineData(true, false, true)]
    [InlineData(true, true, true)]
    public virtual void Can_add_and_remove_a_new_relationship_shared(
        bool modifyLeft,
        bool modifyRight,
        bool useJoin
    )
    ...
    )
    {
        ...
        ExecuteWithStrategyInTransaction(
            context =>
            {
                var left = context
                    .Set<EntityOne>()
                    .Where(e => !e.ThreeSkipPayloadFull.Any())
                    .OrderBy(e => e.Id)
                    .First();
                var right = context.Set<EntityThree>().OrderBy(e => e.Id).First();
    ...
    [InlineData(true, false)]
    [InlineData(true, true)]
    public virtual async Task Can_replace_dependent_with_many_to_many(
    ...
    )
    {
        ...
        await ExecuteWithStrategyInTransactionAsync(
            async context =>
            {
                ...
                _ = async ? await context.AddAsync(principal) : context.Add(principal);
        ...
        static void ValidateFixup(
            DbContext context,
            EntityOne principal,
            EntityTwo leftEntity,
            EntityThree rightEntity
        )
        {
    ...
    protected static void VerifyRelationshipSnapshots(
        DbContext context,
    ...
    )
    {
        ...
        try
        {
            ...
            foreach (var entity in entities)
            {
                ...
                {
                    foreach (
                        var property in entityType.GetForeignKeys().SelectMany(e => e.Properties)
                    )
                    {
