        ...
        where TFixture : ManyToManyTrackingTestBase<TFixture>.ManyToManyTrackingFixtureBase
    {
        ...
        public virtual async Task Can_insert_many_to_many_composite_with_navs(bool async)
        {
            ...
            await ExecuteWithStrategyInTransactionAsync(
                async context =>
                {
                    var leftEntities = new[] { context.EntityCompositeKeys.CreateInstance(
                            (e, p) =>
                            {
                ...
                async context =>
                {
                    var queryable = context.Set<EntityCompositeKey>()
                        .Where(e => keys.Contains(e.Key1))
        ...
        public virtual void Can_update_many_to_many_composite_with_navs()
        {
            ExecuteWithStrategyInTransaction(
                context =>
                {
                    var leftEntities = context.Set<EntityCompositeKey>()
                        .Include(e => e.LeafSkipFull)
                        .OrderBy(e => e.Key2)
                        .ToList();
                    var rightEntities = context.Set<EntityLeaf>()
                        .Include(e => e.CompositeKeySkipFull)
                        .OrderBy(e => e.Name)
                        .ToList();

                    leftEntities[0].LeafSkipFull.Add(context.Set<EntityLeaf>().CreateInstance(
                            (e, p) =>
                            {
                    ...
                    rightEntities[0].CompositeKeySkipFull
                        .Add(context.EntityCompositeKeys.CreateInstance(
                                (e, p) =>
                                {
                                    e.Key1 = Fixture.UseGeneratedKeys ? 0 : 7711;
                                    e.Key2 = "7711";
                    ...
                    leftEntities[2].LeafSkipFull
                        .Remove(leftEntities[2].LeafSkipFull.Single(e => e.Name == "Leaf 3"));
                    leftEntities[2].LeafSkipFull.Add(context.Set<EntityLeaf>().CreateInstance(
                            (e, p) =>
                            {
            ...
            )
            {
                ...
                Assert.Equal(
                    joinCount,
                    context.ChangeTracker.Entries<JoinCompositeKeyToLeaf>().Count()
                );
                Assert.Equal(
        ...
        public virtual void Can_delete_with_many_to_many_composite_with_navs()
        {
            ...
            ExecuteWithStrategyInTransaction(
                context =>
                {
                    var ones = context.Set<EntityCompositeKey>()
                        .Include(e => e.RootSkipShared)
                        .OrderBy(e => e.Key2)
                        .ToList();
                    var threes = context.Set<EntityLeaf>()
                        .Include(e => e.CompositeKeySkipFull)
                        .OrderBy(e => e.Name)
                        .ToList();
                    ...
                    var toRemoveOne = context.EntityCompositeKeys
                        .Single(e => e.Name == "Composite 6");
                    key1 = toRemoveOne.Key1;
                    key2 = toRemoveOne.Key2;
                    key3 = toRemoveOne.Key3;
                    var refCountOnes = threes.SelectMany(e => e.CompositeKeySkipFull)
                        .Count(e => e == toRemoveOne);

                    var toRemoveThree = (EntityLeaf)context.EntityRoots
                        .Single(e => e.Name == "Leaf 3");
                    id = toRemoveThree.Id;
        ...
        public virtual async Task Can_insert_many_to_many_composite_shared_with_navs(bool async)
        {
            ...
            await ExecuteWithStrategyInTransactionAsync(
                async context =>
                {
                    ...
                    rightEntities[0].CompositeKeySkipShared =
                        CreateCollection<EntityCompositeKey>();
            ...
            ExecuteWithStrategyInTransaction(
                context =>
                {
                    var leftEntities = context.Set<EntityCompositeKey>()
                        ...
                        .OrderBy(e => e.Key2)
                        .ToList();
                    var rightEntities = context.Set<EntityRoot>()
                        .Include(e => e.CompositeKeySkipShared)
                        .OrderBy(e => e.Name)
                        .ToList();

                    var roots = new[] { context.Set<EntityRoot>().CreateInstance(
                            (e, p) =>
                            {
                                e.Id = Fixture.UseGeneratedKeys ? 0 : 7721;
                                e.Name = "Z7721";
                    ...
                    rightEntities[1].CompositeKeySkipShared
                        .Remove(
                    ...
                    rightEntities[3].CompositeKeySkipShared
                        .Remove(
                    ...
                    rootKeys = roots.Select(e => context.Entry(e).Property(e => e.Id).CurrentValue)
                        .ToList();
            ...
            ExecuteWithStrategyInTransaction(
                context =>
                {
                    var ones = context.Set<EntityCompositeKey>()
                        ...
                        .OrderBy(e => e.Key2)
                        .ToList();
                    var threes = context.Set<EntityRoot>()
                        .Include(e => e.CompositeKeySkipShared)
                        .OrderBy(e => e.Name)
                        .ToList();
                    ...
                    key2 = toRemoveOne.Key2;
                    key3 = toRemoveOne.Key3;
                    var refCountOnes = threes.SelectMany(e => e.CompositeKeySkipShared)
                        .Count(e => e == toRemoveOne);
                    ...
                    Assert.Equal(
                        refCountOnes,
                        threes.SelectMany(e => e.CompositeKeySkipShared)
                            .Count(e => e == toRemoveOne)
                    );
                    Assert.Equal(
                        refCountThrees,
        ...
        )
        {
            ...
            await ExecuteWithStrategyInTransactionAsync(
                async context =>
                {
                    ...
                    var rightEntities = new[] { context.Set<EntityThree>().CreateInstance(
                            (e, p) =>
                            {
                                e.Id = Fixture.UseGeneratedKeys ? 0 : 7721;
                                e.Name = "Z7721";
            ...
            )
            {
                ...
                Assert.Equal(
                    5,
                    context.ChangeTracker.Entries<JoinThreeToCompositeKeyFull>().Count()
                );
        ...
        public virtual void Can_update_many_to_many_composite_additional_pk_with_navs()
        {
            ...
            ExecuteWithStrategyInTransaction(
                context =>
                {
                    var leftEntities = context.Set<EntityCompositeKey>()
                        ...
                        .OrderBy(e => e.Key2)
                        .ToList();
                    var rightEntities = context.Set<EntityThree>()
                        .Include(e => e.CompositeKeySkipFull)
                        .OrderBy(e => e.Name)
                        .ToList();

                    var threes = new[] { context.Set<EntityThree>().CreateInstance(
                            (e, p) =>
                            {
                                e.Id = Fixture.UseGeneratedKeys ? 0 : 7721;
                                e.Name = "Z7721";
                    ...
                    var composites = new[] { context.EntityCompositeKeys.CreateInstance(
                            (e, p) =>
                            {
                                e.Key1 = Fixture.UseGeneratedKeys ? 0 : 7711;
                                e.Key2 = "Z7711";
                    ...
                    threeIds = threes.Select(e => context.Entry(e).Property(e => e.Id).CurrentValue)
                        .ToList();
            ...
            )
            {
                ...
                var joinEntries = context.ChangeTracker
                    .Entries<JoinThreeToCompositeKeyFull>()
                    .ToList();
                foreach (var joinEntry in joinEntries)
                {
            ...
            ExecuteWithStrategyInTransaction(
                context =>
                {
                    var ones = context.Set<EntityCompositeKey>()
                        ...
                        .OrderBy(e => e.Key2)
                        .ToList();
                    var threes = context.Set<EntityThree>()
                        .Include(e => e.CompositeKeySkipFull)
                        .OrderBy(e => e.Name)
                        .ToList();
                    ...
                    var toRemoveThree = context.EntityThrees
        ...
        public virtual void Can_update_many_to_many_self()
        {
            ...
            ExecuteWithStrategyInTransaction(
                context =>
                {
                    var leftEntities = context.Set<EntityTwo>()
                        .Include(e => e.SelfSkipSharedRight)
                        .OrderBy(e => e.Name)
                        .ToList();
                    var rightEntities = context.Set<EntityTwo>()
                        .Include(e => e.SelfSkipSharedLeft)
                        .OrderBy(e => e.Name)
                        .ToList();

                    var twos = new[] { context.EntityTwos.CreateInstance(
                            (e, p) =>
                            {
                                e.Id = Fixture.UseGeneratedKeys ? 0 : 7721;
                                e.Name = "Z7721";
                    ...
                    ids = twos.Select(e => context.Entry(e).Property(e => e.Id).CurrentValue)
                        .ToList();
            ...
            ExecuteWithStrategyInTransaction(
                context =>
                {
                    var leftEntities = context.Set<EntityTwo>()
                        ...
                        .ToList();
                    var rightEntities = context.Set<EntityThree>()
                        .Include(e => e.TwoSkipFull)
                        .OrderBy(e => e.Name)
                        .ToList();

                    leftEntities[0].ThreeSkipFull.Add(context.EntityThrees.CreateInstance(
                            (e, p) =>
                            {
                                e.Id = Fixture.UseGeneratedKeys ? 0 : 7721;
                                e.Name = "Z7721";
                    ...
                    rightEntities[0].TwoSkipFull.Add(context.EntityTwos.CreateInstance(
                            (e, p) =>
                            {
                                e.Id = Fixture.UseGeneratedKeys ? 0 : 7711;
                                e.Name = "Z7711";
                    ...
                    rightEntities[2].TwoSkipFull
                        .Remove(rightEntities[2].TwoSkipFull.Single(e => e.Name == "EntityTwo 3"));
                    rightEntities[2].TwoSkipFull.Add(context.EntityTwos.CreateInstance(
                            (e, p) =>
                            {
                                e.Id = Fixture.UseGeneratedKeys ? 0 : 7714;
                                e.Name = "Z7714";
        ...
        public virtual void Can_update_many_to_many_with_inheritance()
        {
            ExecuteWithStrategyInTransaction(
                context =>
                {
                    var leftEntities = context.Set<EntityOne>()
                        .Include(e => e.BranchSkip)
                        .OrderBy(e => e.Name)
                        .ToList();
                    var rightEntities = context.Set<EntityBranch>()
                        .Include(e => e.OneSkip)
                        .OrderBy(e => e.Name)
                        .ToList();

                    leftEntities[0].BranchSkip.Add(context.Set<EntityBranch>().CreateInstance(
                            (e, p) =>
                            {
                                e.Id = Fixture.UseGeneratedKeys ? 0 : 7721;
                                e.Name = "Z7721";
                    ...
                    rightEntities[0].OneSkip.Add(context.EntityOnes.CreateInstance(
                            (e, p) =>
                            {
                                e.Id = Fixture.UseGeneratedKeys ? 0 : 7711;
                                e.Name = "Z7711";
                    ...
                    rightEntities[2].OneSkip.Add(context.EntityOnes.CreateInstance(
                            (e, p) =>
                            {
                                e.Id = Fixture.UseGeneratedKeys ? 0 : 7714;
                                e.Name = "Z7714";
        ...
        public virtual void Can_update_many_to_many_self_with_payload()
        {
            ...
            ExecuteWithStrategyInTransaction(
                ...
                {
                    var leftEntities = context.Set<EntityOne>()
                        .Include(e => e.SelfSkipPayloadRight)
                        .OrderBy(e => e.Name)
                        .ToList();
                    var rightEntities = context.Set<EntityOne>()
                        .Include(e => e.SelfSkipPayloadLeft)
                        .OrderBy(e => e.Name)
                        .ToList();

                    var ones = new[] { context.EntityOnes.CreateInstance(
                            (e, p) =>
                            {
                                e.Id = Fixture.UseGeneratedKeys ? 0 : 7721;
                                e.Name = "Z7721";
                    ...
                    rightEntities[11].SelfSkipPayloadLeft
                        .Remove(
                            rightEntities[11].SelfSkipPayloadLeft
                                .Single(e => e.Name == "EntityOne 13")
                        );

                    leftEntities[4].SelfSkipPayloadRight
                        .Remove(
                            leftEntities[4].SelfSkipPayloadRight
                                .Single(e => e.Name == "EntityOne 18")
                        );
                    ...
                    keys = ones.Select(e => context.Entry(e).Property(e => e.Id).CurrentValue)
                        .ToList();

                    context.Find<JoinOneSelfPayload>(
                        keys[5],
                        context.Entry(context.EntityOnes.Local.Single(e => e.Name == "EntityOne 1"))
                            .Property(e => e.Id).CurrentValue
                    ).Payload = new DateTime(1973, 9, 3);

                    context.Find<JoinOneSelfPayload>(
                        context.Entry(
                            context.EntityOnes.Local.Single(e => e.Name == "EntityOne 20")
                        )
                            .Property(e => e.Id).CurrentValue,
                        context.Entry(
                            context.EntityOnes.Local.Single(e => e.Name == "EntityOne 16")
                        )
                            .Property(e => e.Id).CurrentValue
            ...
            )
            {
                ...
                Assert.Equal(
                    joinCount,
                    context.ChangeTracker.Entries<JoinOneSelfPayload>().Count()
                );
                Assert.Equal(count + joinCount, context.ChangeTracker.Entries().Count());
        ...
        public virtual void Can_update_many_to_many_shared_with_payload()
        {
            ExecuteWithStrategyInTransaction(
                context =>
                {
                    ...
                    leftEntities[0].ThreeSkipPayloadFullShared
                        .Add(context.EntityThrees.CreateInstance(
                                (e, p) =>
                                {
                                    e.Id = Fixture.UseGeneratedKeys ? 0 : 7721;
                                    e.Name = "Z7721";
                    ...
                    rightEntities[0].OneSkipPayloadFullShared.Add(context.EntityOnes.CreateInstance(
                            (e, p) =>
                            {
                                e.Id = Fixture.UseGeneratedKeys ? 0 : 7711;
                                e.Name = "Z7711";
                    ...
                    rightEntities[2].OneSkipPayloadFullShared.Add(context.EntityOnes.CreateInstance(
                            (e, p) =>
                            {
                                e.Id = Fixture.UseGeneratedKeys ? 0 : 7714;
                                e.Name = "Z7714";
            ...
            static int GetEntityOneId(ManyToManyContext context, string name) =>
                context.Entry(context.EntityOnes.Local.Single(e => e.Name == name))
                    .Property(e => e.Id).CurrentValue;

            static int GetEntityThreeId(ManyToManyContext context, string name) =>
                context.Entry(context.EntityThrees.Local.Single(e => e.Name == name))
                    .Property(e => e.Id).CurrentValue;
        ...
        public virtual void Can_update_many_to_many_with_payload()
        {
            ExecuteWithStrategyInTransaction(
                context =>
                {
                    ...
                    leftEntities[0].ThreeSkipPayloadFull.Add(context.EntityThrees.CreateInstance(
                            (e, p) =>
                            {
                                e.Id = Fixture.UseGeneratedKeys ? 0 : 7721;
                                e.Name = "Z7721";
                    ...
                    rightEntities[0].OneSkipPayloadFull.Add(context.EntityOnes.CreateInstance(
                            (e, p) =>
                            {
                                e.Id = Fixture.UseGeneratedKeys ? 0 : 7711;
                                e.Name = "Z7711";
                    ...
                    leftEntities[2].ThreeSkipPayloadFull
                        .Remove(
                            leftEntities[2].ThreeSkipPayloadFull
                                .Single(e => e.Name == "EntityThree 13")
                        );
                    leftEntities[2].ThreeSkipPayloadFull.Add(context.EntityThrees.CreateInstance(
                            (e, p) =>
                            {
                                e.Id = Fixture.UseGeneratedKeys ? 0 : 7724;
                                e.Name = "Z7724";
                    ...
                    rightEntities[2].OneSkipPayloadFull
                        .Remove(
                            rightEntities[2].OneSkipPayloadFull
                                .Single(e => e.Name == "EntityOne 15")
                        );
                    rightEntities[2].OneSkipPayloadFull.Add(context.EntityOnes.CreateInstance(
                            (e, p) =>
                            {
                                e.Id = Fixture.UseGeneratedKeys ? 0 : 7714;
                                e.Name = "Z7714";
                    ...
                    context.Find<JoinOneToThreePayloadFull>(
                        GetEntityOneId(context, "EntityOne 20"),
                        GetEntityThreeId(context, "EntityThree 20")
                    ).Payload = "Changed!";
            ...
            )
            {
                ...
                Assert.Equal(
                    joinCount,
                    context.ChangeTracker.Entries<JoinOneToThreePayloadFull>().Count()
                );
                Assert.Equal(
                    leftCount + rightCount + joinCount,
                    context.ChangeTracker.Entries().Count()
        ...
        public virtual void Can_delete_with_many_to_many_with_navs()
        {
            ExecuteWithStrategyInTransaction(
                context =>
                {
                    var ones = context.Set<EntityOne>()
                        .Include(e => e.ThreeSkipPayloadFull)
                        .OrderBy(e => e.Name)
                        .ToList();
                    var threes = context.Set<EntityThree>()
                    ...
                    var refCountOnes = threes.SelectMany(e => e.OneSkipPayloadFull)
                        .Count(e => e == toRemoveOne);

                    var toRemoveThree = context.EntityThrees.Single(e => e.Name == "EntityThree 1");
                    var refCountThrees = ones.SelectMany(e => e.ThreeSkipPayloadFull)
                        .Count(e => e == toRemoveThree);
                    ...
                    Assert.Equal(
                        refCountOnes,
                        threes.SelectMany(e => e.OneSkipPayloadFull).Count(e => e == toRemoveOne)
                    );
                    Assert.Equal(
                        refCountThrees,
                        ones.SelectMany(e => e.ThreeSkipPayloadFull).Count(e => e == toRemoveThree)
                    );
        ...
        )
        {
            ...
            await ExecuteWithStrategyInTransactionAsync(
                async context =>
                {
                    ...
                    var joinEntities = new[] { context.Set<JoinOneToTwo>().CreateInstance(
                            (e, p) =>
                            {
        ...
        [InlineData(false, true, true)]
        [InlineData(true, true, true)]
        public virtual async Task Can_insert_many_to_many_with_dangling_join(
            bool async,
            bool useTrackGraph,
            bool useDetectChanges
        )
        ...
        public virtual void Can_update_many_to_many()
        {
            ...
            ExecuteWithStrategyInTransaction(
                context =>
                {
                    ...
                    oneIds = ones.Select(e => context.Entry(e).Property(e => e.Id).CurrentValue)
                        .ToList();
                    twoIds = twos.Select(e => context.Entry(e).Property(e => e.Id).CurrentValue)
                        .ToList();
            ...
            ExecuteWithStrategyInTransaction(
                context =>
                {
                    var ones = context.Set<EntityOne>()
                        ...
                        .OrderBy(e => e.Name)
                        .ToList();
                    var twos = context.Set<EntityTwo>()
                        .Include(e => e.OneSkip)
                        .OrderBy(e => e.Name)
                        .ToList();
                    ...
                    Assert.Equal(
                        refCountOnes,
                        twos.SelectMany(e => e.OneSkip).Count(e => e == toRemoveOne)
                    );
                    Assert.Equal(
                        refCountTwos,
        ...
        public virtual async Task Can_insert_many_to_many_fully_by_convention(bool async)
        {
            ...
            await ExecuteWithStrategyInTransactionAsync(
                async context =>
                {
                    var leftEntities = new[]
                    {
                        context.Set<ImplicitManyToManyA>()
                            .CreateInstance((e, p) => e.Id = Fixture.UseGeneratedKeys ? 0 : 7711),
                        context.Set<ImplicitManyToManyA>()
                            .CreateInstance((e, p) => e.Id = Fixture.UseGeneratedKeys ? 0 : 7712),
                        context.Set<ImplicitManyToManyA>()
                    ...
                    var rightEntities = new[]
                    {
                        context.Set<ImplicitManyToManyB>()
                            .CreateInstance((e, p) => e.Id = Fixture.UseGeneratedKeys ? 0 : 7721),
                        context.Set<ImplicitManyToManyB>()
                            .CreateInstance((e, p) => e.Id = Fixture.UseGeneratedKeys ? 0 : 7722),
                        context.Set<ImplicitManyToManyB>()
                ...
                async context =>
                {
                    var queryable = context.Set<ImplicitManyToManyA>()
                        .Where(e => keys.Contains(e.Id))
                        .Include(e => e.Bs);
                    var results = async ? await queryable.ToListAsync() : queryable.ToList();
                    Assert.Equal(3, results.Count);
        ...
        )
        {
            ...
            await ExecuteWithStrategyInTransactionAsync(
                ...
                async context =>
                {
                    ...
                    var rightEntities = new[]
                    {
                        context.Set<GeneratedKeysRight>()
        ...
        public virtual void Can_insert_update_delete_shared_type_entity_type()
        {
            ExecuteWithStrategyInTransaction(
                context =>
                {
                    var entity = context.Set<Dictionary<string, object>>(
                        "JoinOneToThreePayloadFullShared"
                    )
                        .CreateInstance(
                            (e, p) =>
        ...
        public virtual void Can_insert_update_delete_proxyable_shared_type_entity_type()
        {
            ...
            ExecuteWithStrategyInTransaction(
                ...
                context =>
                {
                    var entity = context.Set<ProxyableSharedType>("PST")
                ...
                context =>
                {
                    ...
                    Assert.False(
                        context.Set<ProxyableSharedType>("PST").Any(e => (int)e["Id"] == id)
                    );
                }
            );
        }
        ...
        public virtual async Task Can_insert_many_to_many_with_navs_by_join_entity(bool async)
        {
            await ExecuteWithStrategyInTransactionAsync(
                async context =>
                {
                    var leftEntities = new[] { context.EntityTwos.CreateInstance(
                            (e, p) =>
                            {
                                e.Id = Fixture.UseGeneratedKeys ? 0 : 7711;
                                e.Name = "Z7711";
                    ...
                    var rightEntities = new[] { context.EntityThrees.CreateInstance(
                            (e, p) =>
                            {
                                e.Id = Fixture.UseGeneratedKeys ? 0 : 7721;
                                e.Name = "Z7721";
                    ...
                    var joinEntities = new[] { context.Set<JoinTwoToThree>().CreateInstance(
                            (e, p) =>
                            {
                ...
                foreach (var entity in entities)
                {
                    ...
                    if (entityEntry.HasRelationshipSnapshot)
                    {
                        ...
                        )
                        {
                            ...
                            {
                                Assert.Equal(
                                    entityEntry.GetRelationshipSnapshotValue(property),
        ...
        private ICollection<TEntity> CreateCollection<TEntity>() =>
            RequiresDetectChanges
                ? (ICollection<TEntity>)new List<TEntity>()
