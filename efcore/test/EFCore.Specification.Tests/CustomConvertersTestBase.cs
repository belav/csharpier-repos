    ...
    where TFixture : BuiltInDataTypesTestBase<TFixture>.BuiltInDataTypesFixtureBase, new()
{
    ...
    protected class Email
    {
        ...
        public override bool Equals(object obj) => _value == ((Email)obj)?._value;
    ...
    public virtual void Can_insert_and_read_back_with_case_insensitive_string_key()
    {
        using (var context = CreateContext())
        {
            ...
            var dependent = context
                ...
                .Add(new StringForeignKeyDataType { Id = 7767, StringKeyDataTypeId = "gumball!!" })
                .Entity;
    ...
    public struct OrderId
    {
        ...
        public static OrderId Parse(string stringValue) => new(stringValue);
    ...
    {
        protected override string StoreName => "CustomConverters";
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder, DbContext context)
        {
            ...
            modelBuilder.Entity<BuiltInDataTypes>(b =>
            {
                ...
                b.Property(e => e.TestDateOnly)
                    .HasConversion(v => v.ToShortDateString(), v => DateOnly.Parse(v));
                b.Property(e => e.TestTimeSpan)
                    .HasConversion(v => v.TotalMilliseconds, v => TimeSpan.FromMilliseconds(v));
            ...
            modelBuilder.Entity<BuiltInNullableDataTypes>(b =>
            {
                ...
                b.Property(e => e.TestNullableDateTime)
                    .HasConversion(v => v.Value.ToBinary(), v => DateTime.FromBinary(v));

                b.Property(e => e.TestNullableDateOnly)
                    .HasConversion(v => v.Value.ToShortDateString(), v => DateOnly.Parse(v));
                ...
                b.Property(e => e.TestNullableTimeOnly)
                    .HasConversion(v => v.Value.Ticks, v => new TimeOnly(v));
            ...
            modelBuilder.Entity<BuiltInDataTypesShadow>(b =>
            {
                ...
                b.Property(nameof(BuiltInDataTypes.TestDecimal))
                    .HasConversion(NumberToBytesConverter<decimal>.DefaultInfo.Create());
                b.Property(nameof(BuiltInDataTypes.TestDateOnly))
                    .HasConversion(
                ...
                b.Property(nameof(BuiltInDataTypes.TestTimeOnly))
                    .HasConversion(
            ...
            modelBuilder.Entity<BuiltInNullableDataTypes>(b =>
            {
                ...
                b.Property(nameof(BuiltInNullableDataTypes.TestNullableDateOnly))
                    .HasConversion(
                        new ValueConverter<DateOnly?, string>(
                ...
                b.Property(nameof(BuiltInNullableDataTypes.TestNullableTimeOnly))
                    .HasConversion(
            ...
            modelBuilder.Entity<MaxLengthDataTypes>(b =>
            {
                ...
                b.Property(e => e.StringUnbounded)
                    .HasConversion(StringToBytesConverter.DefaultInfo.Create());
                ...
                b.Property(e => e.ByteArray9000)
                    .HasConversion(BytesToStringConverter.DefaultInfo.Create(), bytesComparer)
