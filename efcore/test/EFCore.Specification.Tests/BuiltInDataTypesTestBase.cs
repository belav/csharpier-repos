...
namespace Microsoft.EntityFrameworkCore
{
        ...
        where TFixture : BuiltInDataTypesTestBase<TFixture>.BuiltInDataTypesFixtureBase, new()
    {
        ...
        public virtual void Can_perform_query_with_max_length()
        {
            ...
            using (var context = CreateContext())
            {
                context.Set<MaxLengthDataTypes>()
                    .Add(
        ...
        public virtual void Can_perform_query_with_ansi_strings_test()
        {
            ...
            using (var context = CreateContext())
            {
                ...
                var entity = context.Set<UnicodeDataTypes>()
                    .Where(e => e.Id == 799)
                    .ToList()
                    .Single();
        ...
        {
            using var context = CreateContext();
            var source = AddTestBuiltInNullableDataTypes(
                context.Set<BuiltInNullableDataTypesShadow>()
            );
        ...
        public virtual void Can_query_using_any_nullable_data_type_as_literal()
        {
            ...
            using (var context = CreateContext())
            {
                var entity = context.Set<BuiltInNullableDataTypes>()
                    .Where(e => e.Id == 12)
                    .ToList()
                    .Single();
                    ...
                    Assert.Same(
                        ...
                        context.Set<BuiltInNullableDataTypes>()
                            .Where(
                                e =>
                                    e.Id == 12
                                    && e.TestNullableTimeSpan == new TimeSpan(0, 10, 9, 8, 7)
                            )
                            .ToList()
                            .Single()
                    );
                    ...
                    Assert.Same(
                        ...
                        context.Set<BuiltInNullableDataTypes>()
                            .Where(
                                e =>
                                    e.Id == 12
                                    && e.TestNullableUnsignedInt64 == 1234567890123456789UL
                            )
                            .ToList()
                            .Single()
                    );
        ...
        public virtual void Can_query_with_null_parameters_using_any_nullable_data_type()
        {
            ...
            {
                context.Set<BuiltInNullableDataTypes>()
                    .Add(new BuiltInNullableDataTypes { Id = 711 });
            ...
            using (var context = CreateContext())
            {
                ...
                Assert.Same(
                    entity,
                    context.Set<BuiltInNullableDataTypes>()
                        .Where(e => e.Id == 711 && (long?)(int?)e.TestNullableInt16 == param1)
                        .ToList()
                        .Single()
                );
        ...
        public virtual void Can_insert_and_read_back_with_binary_key()
        {
            ...
            {
                return context.Set<BinaryKeyDataType>()
        ...
        public virtual void Can_insert_and_read_back_with_null_binary_foreign_key()
        {
            ...
            {
                context.Set<BinaryForeignKeyDataType>()
                    .Add(new BinaryForeignKeyDataType { Id = 78 });
        ...
        public virtual void Can_insert_and_read_back_with_string_key()
        {
            ...
            {
                var principal =
                    context.Set<StringKeyDataType>()
                        .Add(new StringKeyDataType { Id = "Gumball!" }).Entity;

                var dependent =
                    context.Set<StringForeignKeyDataType>()
                        .Add(
            ...
            using (var context = CreateContext())
            {
                var entity = context.Set<StringKeyDataType>()
                    .Include(e => e.Dependents)
        ...
        public virtual void Can_insert_and_read_back_with_null_string_foreign_key()
        {
            ...
            {
                context.Set<StringForeignKeyDataType>()
                    .Add(new StringForeignKeyDataType { Id = 78 });
            ...
            using (var context = CreateContext())
            {
                var entity = context.Set<StringForeignKeyDataType>()
                    .Where(e => e.Id == 78)
                    .ToList()
                    .Single();
        ...
        public virtual void Can_insert_and_read_back_all_nullable_data_types_with_values_set_to_null()
        {
            ...
            using (var context = CreateContext())
            {
                var dt = context.Set<BuiltInNullableDataTypes>()
        ...
        public virtual void Can_insert_and_read_back_object_backed_data_types()
        {
            ...
            using (var context = CreateContext())
            {
                var dt = context.Set<ObjectBackedDataTypes>()
                    .Where(ndt => ndt.Id == 101)
                    .ToList()
                    .Single();
        ...
        public virtual void Can_insert_and_read_back_nullable_backed_data_types()
        {
            using (var context = CreateContext())
            {
                context.Set<NullableBackedDataTypes>()
                    .Add(
            ...
            using (var context = CreateContext())
            {
                var dt = context.Set<NullableBackedDataTypes>()
                    .Where(ndt => ndt.Id == 101)
                    .ToList()
                    .Single();
        ...
        public virtual void Can_insert_and_read_back_non_nullable_backed_data_types()
        {
            using (var context = CreateContext())
            {
                context.Set<NonNullableBackedDataTypes>()
                    .Add(
            ...
            using (var context = CreateContext())
            {
                var dt = context.Set<NonNullableBackedDataTypes>()
                    .Where(ndt => ndt.Id == 101)
                    .ToList()
                    .Single();
        ...
        {
            using var context = CreateContext();
            var expected = context.Set<DateTimeEnclosure>()
                .ToList()
                .Select(
                    e =>
                        new
