...
{
    public abstract class ConvertToProviderTypesTestBase<TFixture>
        : BuiltInDataTypesTestBase<TFixture>
        where TFixture : BuiltInDataTypesTestBase<TFixture>.BuiltInDataTypesFixtureBase, new()
    {
        ...
        public virtual void Equals_method_over_enum_works()
        {
            ...
            var query = context
                ...
                .Where(t => t.Id == -1 && t.Enum8.Equals(Enum8.SomeValue))
                .ToList();
        ...
        public virtual void Object_equals_method_over_enum_works()
        {
            ...
            var query = context
                .Set<BuiltInDataTypes>()
                .Where(t => t.Id == -1 && Equals(t.Enum8, Enum8.SomeValue))
                .ToList();
