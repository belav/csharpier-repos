...
namespace Microsoft.EntityFrameworkCore.TestUtilities.QueryTestGeneration
{
    ...
    public class ProcedurallyGeneratedQueryExecutor
    {
        ...
        static ProcedurallyGeneratedQueryExecutor()
        {
            ...
            AddExpectedFailure(
                "Null_reference_protection_complex_client_eval",
                "Object reference not set to an instance of an object."
            );
            AddExpectedFailure(
            ...
            AddExpectedFailure(
                "Include_with_orderby_skip_preserves_ordering",
                "Object reference not set to an instance of an object."
            );
            AddExpectedFailure(
                "SelectMany_with_Include_and_order_by",
                "Object reference not set to an instance of an object."
            );
            AddExpectedFailure(
            ...
            AddExpectedFailure(
                "SelectMany_with_Include1",
                "Object reference not set to an instance of an object."
            );
            AddExpectedFailure(
                "Include_collection_with_Cast_to_base",
                "Object reference not set to an instance of an object."
            );
            ...
            AddExpectedFailure(
                "Correlated_collections_left_join_with_self_reference",
                "The EF.Property<T> method may only be used within LINQ queries."
            );
            AddExpectedFailure(
                "Correlated_collections_on_left_join_with_null_value",
                "The EF.Property<T> method may only be used within LINQ queries."
            );
            AddExpectedFailure(
                "GroupBy_Shadow",
            ...
            AddExpectedFailure(
                ...
                "The property '' on entity type 'Level2' could not be found. Ensure that the property exists and has been included in the model."
            ); // 12575
            AddExpectedFailure(
            ...
            AddExpectedFailure(
                ...
                "The property '' on entity type 'Level3' could not be found. Ensure that the property exists and has been included in the model."
            ); // 12575
            AddExpectedFailure(
            ...
            AddExpectedFailure(
                "GroupBy_Key_as_part_of_element_selector",
            ...
            AddExpectedFailure(
                "GroupBy_anonymous_with_alias_Select_Key_Sum",
                "Incorrect syntax near '+'."
            ); // 12656
            AddExpectedFailure(
                "GroupBy_Property_Select_Key_LongCount",
                "Incorrect syntax near '+'."
            ); // 12656
            AddExpectedFailure(
                "GroupBy_filter_count_OrderBy_count_Select_sum",
                "Incorrect syntax near '+'."
            ); // 12656
            ...
            AddExpectedFailure(
                "GroupBy_Property_Select_Key_Sum_Min_Max_Avg",
                "Incorrect syntax near '+'."
            ); // 12656
            AddExpectedFailure(
                "GroupBy_optional_navigation_member_Aggregate",
                "Incorrect syntax near '+'."
            ); // 12656
            ...
            AddExpectedFailure(
                ...
                "could not be found. Ensure that the property exists and has been included in the model."
            ); // 12802
            AddExpectedFailure(
                "Include_on_GroupJoin_SelectMany_DefaultIfEmpty_with_coalesce_result3",
                "could not be found. Ensure that the property exists and has been included in the model."
