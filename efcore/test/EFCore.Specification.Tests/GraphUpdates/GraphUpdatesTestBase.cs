...
partial public abstract class GraphUpdatesTestBase<TFixture> : IClassFixture<TFixture>
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder, DbContext context)
        {
            ...
            modelBuilder.Entity<SomethingOfCategoryB>(builder =>
            {
                ...
                builder
                    ...
                    .HasPrincipalKey<Something>(p => new { p.Id, p.CategoryId })
                    .HasForeignKey<SomethingOfCategoryB>(
                        socb => new { socb.SomethingId, socb.CategoryId }
                    )
                    .OnDelete(DeleteBehavior.ClientSetNull);
