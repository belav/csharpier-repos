            ...
            protected virtual object CreateFullGraph(DbContext context) =>
                context.CreateProxy<Root>(e =>
                {
                    ...
                    e.RequiredNonPkSingleDerived =
                        context.CreateProxy<RequiredNonPkSingle1Derived>(e =>
                        {
                    ...
                    e.OptionalSingleAkMoreDerived =
                        context.CreateProxy<OptionalSingleAk1MoreDerived>(e =>
                        {
                            e.AlternateId = Guid.NewGuid();
                    ...
                    e.RequiredNonPkSingleAkDerived =
                        context.CreateProxy<RequiredNonPkSingleAk1Derived>(e =>
                        {
                            e.AlternateId = Guid.NewGuid();
                    ...
                    e.RequiredNonPkSingleAkMoreDerived =
                        ...
                        {
                            e.AlternateId = Guid.NewGuid();
                            e.Single = context.CreateProxy<RequiredNonPkSingleAk2MoreDerived>(
                                e => e.AlternateId = Guid.NewGuid()
                            );
                            e.Root = context.CreateProxy<Root>();
