    ...
    where TFixture : ProxyGraphUpdatesTestBase<TFixture>.ProxyGraphUpdatesFixtureBase, new()
{
    ...
    public abstract class ProxyGraphUpdatesFixtureBase : SharedStoreFixtureBase<DbContext>
    {
        ...
        protected virtual object CreateFullGraph(DbContext context) =>
            context.CreateProxy<Root>(e =>
            {
                ...
                e.RequiredSingle = context.CreateProxy<RequiredSingle1>(e =>
                    e.Single = context.Set<RequiredSingle2>().CreateProxy()
                );

                e.OptionalSingle = context.CreateProxy<OptionalSingle1>(e =>
                    e.Single = context.Set<OptionalSingle2>().CreateProxy()
                );

                e.OptionalSingleDerived = context.CreateProxy<OptionalSingle1Derived>(e =>
                    e.Single = context.Set<OptionalSingle2Derived>().CreateProxy()
                );

                e.OptionalSingleMoreDerived = context.CreateProxy<OptionalSingle1MoreDerived>(e =>
                    e.Single = context.Set<OptionalSingle2MoreDerived>().CreateProxy()
                );

                e.RequiredNonPkSingle = context.CreateProxy<RequiredNonPkSingle1>(e =>
                    e.Single = context.Set<RequiredNonPkSingle2>().CreateProxy()
                );
                ...
                e.RequiredNonPkSingleMoreDerived =
                    context.CreateProxy<RequiredNonPkSingle1MoreDerived>(e =>
                    {
                ...
                {
                    e.AlternateId = Guid.NewGuid();
                    e.Single = context.CreateProxy<RequiredSingleAk2>(e =>
                        e.AlternateId = Guid.NewGuid()
                    );
                ...
                {
                    e.AlternateId = Guid.NewGuid();
                    e.Single = context.CreateProxy<OptionalSingleAk2>(e =>
                        e.AlternateId = Guid.NewGuid()
                    );
                ...
                {
                    e.AlternateId = Guid.NewGuid();
                    e.Single = context.CreateProxy<OptionalSingleAk2Derived>(e =>
                        e.AlternateId = Guid.NewGuid()
                    );
                });
                ...
                e.OptionalSingleAkMoreDerived = context.CreateProxy<OptionalSingleAk1MoreDerived>(
                    ...
                    {
                        e.AlternateId = Guid.NewGuid();
                        e.Single = context.CreateProxy<OptionalSingleAk2MoreDerived>(e =>
                            e.AlternateId = Guid.NewGuid()
                        );
                    }
                );
                ...
                {
                    e.AlternateId = Guid.NewGuid();
                    e.Single = context.CreateProxy<RequiredNonPkSingleAk2>(e =>
                        e.AlternateId = Guid.NewGuid()
                    );
                });
                ...
                e.RequiredNonPkSingleAkDerived = context.CreateProxy<RequiredNonPkSingleAk1Derived>(
                    ...
                    {
                        e.AlternateId = Guid.NewGuid();
                        e.Single = context.CreateProxy<RequiredNonPkSingleAk2Derived>(e =>
                            e.AlternateId = Guid.NewGuid()
                        );
                ...
                e.RequiredNonPkSingleAkMoreDerived =
                    context.CreateProxy<RequiredNonPkSingleAk1MoreDerived>(e =>
                    {
                        e.AlternateId = Guid.NewGuid();
                        e.Single = context.CreateProxy<RequiredNonPkSingleAk2MoreDerived>(e =>
                            e.AlternateId = Guid.NewGuid()
                        );
                        e.Root = context.CreateProxy<Root>();
        ...
        protected override void Seed(DbContext context)
        {
            ...
            context.ChangeTracker.TrackGraph(CreateFullGraph(context), e =>
                tracker.TrackEntity(e.Entry)
            );

            context.Add(
                context.CreateProxy<BadOrder>(e =>
                    e.BadCustomer = context.CreateProxy<BadCustomer>()
                )
            );
    ...
    protected Root LoadRoot(DbContext context) => context.Set<Root>().Single(IsTheRoot);
