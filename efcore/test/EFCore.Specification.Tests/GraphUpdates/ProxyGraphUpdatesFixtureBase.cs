                ...
                context.CreateProxy<Root>(
                    e =>
                    {
                        ...
                        e.OptionalSingleMoreDerived =
                            context.CreateProxy<OptionalSingle1MoreDerived>(
                                e =>
                                    e.Single = context.Set<OptionalSingle2MoreDerived>()
                                        .CreateProxy()
                            );
                        ...
                        e.RequiredNonPkSingleDerived =
                            context.CreateProxy<RequiredNonPkSingle1Derived>(
                                e =>
                                {
                                    e.Single = context.Set<RequiredNonPkSingle2Derived>()
                                        .CreateProxy();
                        ...
                        e.RequiredNonPkSingleMoreDerived =
                            context.CreateProxy<RequiredNonPkSingle1MoreDerived>(
                                e =>
                                {
                                    e.Single = context.Set<RequiredNonPkSingle2MoreDerived>()
                                        .CreateProxy();
                                    e.Root = context.Set<Root>().CreateProxy();
                        ...
                        e.RequiredSingleAk = context.CreateProxy<RequiredSingleAk1>(
                            ...
                            {
                                e.AlternateId = Guid.NewGuid();
                                e.Single = context.CreateProxy<RequiredSingleAk2>(
                        ...
                        e.OptionalSingleAk = context.CreateProxy<OptionalSingleAk1>(
                            ...
                            {
                                e.AlternateId = Guid.NewGuid();
                                e.Single = context.CreateProxy<OptionalSingleAk2>(
                                    e => e.AlternateId = Guid.NewGuid()
                                );
                        ...
                        e.OptionalSingleAkDerived = context.CreateProxy<OptionalSingleAk1Derived>(
                            ...
                            {
                                e.AlternateId = Guid.NewGuid();
                                e.Single = context.CreateProxy<OptionalSingleAk2Derived>(
                                    e => e.AlternateId = Guid.NewGuid()
                                );
                            }
                        );

                        e.OptionalSingleAkMoreDerived =
                            context.CreateProxy<OptionalSingleAk1MoreDerived>(
                                e =>
                                {
                                    e.AlternateId = Guid.NewGuid();
                                    e.Single = context.CreateProxy<OptionalSingleAk2MoreDerived>(
                                        e => e.AlternateId = Guid.NewGuid()
                                    );
                                }
                            );
                        ...
                        e.RequiredNonPkSingleAk = context.CreateProxy<RequiredNonPkSingleAk1>(
                            ...
                            {
                                e.AlternateId = Guid.NewGuid();
                                e.Single = context.CreateProxy<RequiredNonPkSingleAk2>(
                                    e => e.AlternateId = Guid.NewGuid()
                                );
                            }
                        );

                        e.RequiredNonPkSingleAkDerived =
                            context.CreateProxy<RequiredNonPkSingleAk1Derived>(
                                e =>
                                {
                                    e.AlternateId = Guid.NewGuid();
                                    e.Single = context.CreateProxy<RequiredNonPkSingleAk2Derived>(
                                        e => e.AlternateId = Guid.NewGuid()
                                    );
                        ...
                        e.RequiredNonPkSingleAkMoreDerived =
                            context.CreateProxy<RequiredNonPkSingleAk1MoreDerived>(
                                e =>
                                {
                                    e.AlternateId = Guid.NewGuid();
                                    e.Single =
                                        context.CreateProxy<RequiredNonPkSingleAk2MoreDerived>(
                                            e => e.AlternateId = Guid.NewGuid()
                                        );
                                    e.Root = context.CreateProxy<Root>();
            ...
            protected override void Seed(DbContext context)
            {
                ...
                context.Add(
                    context.CreateProxy<BadOrder>(
                        e => e.BadCustomer = context.CreateProxy<BadCustomer>()
                    )
                );
