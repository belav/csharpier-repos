...
public abstract partial class ManyToManyTrackingTestBase<TFixture>
{
    ...
    public virtual async Task Can_insert_many_to_many_composite_with_navs_unidirectional(bool async)
    {
        ...
        await ExecuteWithStrategyInTransactionAsync(
            async context =>
            {
                ...
                {
                    context.UnidirectionalEntityCompositeKeys
                        .CreateInstance(
                            (e, p) =>
                            {
            ...
            async context =>
            {
                ...
                var leftEntities = context.ChangeTracker
                    .Entries<UnidirectionalEntityCompositeKey>()
                    .Select(e => e.Entity)
                    .OrderBy(e => e.Key2)
                    .ToList();

                var rightEntities = context.ChangeTracker
                    .Entries<UnidirectionalEntityLeaf>()
                    .Select(e => e.Entity)
                    .OrderBy(e => e.Name)
                    .ToList();
        ...
        )
        {
            ...
            var joinEntities = context.ChangeTracker
                .Entries<UnidirectionalJoinCompositeKeyToLeaf>()
                .Select(e => e.Entity)
                .ToList();
    ...
    public virtual void Can_delete_with_many_to_many_composite_with_navs_unidirectional()
    {
        ...
        ExecuteWithStrategyInTransaction(
            context =>
            {
                ...
                var toRemoveOne = context.UnidirectionalEntityCompositeKeys
    ...
    )
    {
        ...
        await ExecuteWithStrategyInTransactionAsync(
            ...
            async context =>
            {
                ...
                var rightEntities = context.ChangeTracker
                    .Entries<UnidirectionalEntityThree>()
                    .Select(e => e.Entity)
                    .OrderBy(e => e.Name)
                    .ToList();
        ...
        )
        {
            ...
            var joinEntities = context.ChangeTracker
                .Entries<UnidirectionalJoinThreeToCompositeKeyFull>()
                .Select(e => e.Entity)
                .ToList();
            foreach (var joinEntity in joinEntities)
            {
    ...
    public virtual void Can_delete_with_many_to_many_composite_additional_pk_with_navs_unidirectional()
    {
        ...
        ExecuteWithStrategyInTransaction(
            context =>
            {
                ...
                var toRemoveThree = context.UnidirectionalEntityThrees
    ...
    public virtual async Task Can_insert_many_to_many_self_shared_unidirectional(bool async)
    {
        ...
        await ExecuteWithStrategyInTransactionAsync(
            ...
            async context =>
            {
                ...
                var leftEntities = context.ChangeTracker
                    .Entries<UnidirectionalEntityTwo>()
                    .Select(e => e.Entity)
    ...
    public virtual async Task Can_insert_many_to_many_with_inheritance_unidirectional(bool async)
    {
        ...
        await ExecuteWithStrategyInTransactionAsync(
            ...
            async context =>
            {
                ...
                var leftEntities = context.ChangeTracker
                    .Entries<UnidirectionalEntityOne>()
                    .Select(e => e.Entity)
                    .OrderBy(e => e.Name)
                    .ToList();
                var rightEntities = context.ChangeTracker
                    .Entries<UnidirectionalEntityBranch>()
                    .Select(e => e.Entity)
                    .OrderBy(e => e.Name)
                    .ToList();
    ...
    public virtual void Can_update_many_to_many_with_inheritance_unidirectional()
    {
        ...
        )
        {
            ...
            var deleted = context.ChangeTracker
                .Entries<UnidirectionalJoinOneToBranch>()
                .Count(e => e.State == EntityState.Deleted);
            Assert.Equal(joinCount, (count / 2) + deleted);
        }
    }
    ...
    public virtual async Task Can_insert_many_to_many_self_with_payload_unidirectional(bool async)
    {
        ...
        )
        {
            ...
            var joinEntities = context.ChangeTracker
                .Entries<UnidirectionalJoinOneSelfPayload>()
                .Select(e => e.Entity)
                .ToList();
            foreach (var joinEntity in joinEntities)
            {
    ...
    public virtual async Task Can_insert_many_to_many_shared_with_payload_unidirectional(bool async)
    {
        ...
        await ExecuteWithStrategyInTransactionAsync(
            async context =>
            {
                ...
                var rightEntities = new[]
                {
                    context.UnidirectionalEntityThrees
                        .CreateInstance((e, p) => e.Id = Fixture.UseGeneratedKeys ? 0 : 7721),
                    context.UnidirectionalEntityThrees
                        .CreateInstance((e, p) => e.Id = Fixture.UseGeneratedKeys ? 0 : 7722),
                    context.UnidirectionalEntityThrees
    ...
    )
    {
        ...
        )
        {
            ...
            var extra = context.ChangeTracker
                .Entries<UnidirectionalJoinOneToTwoExtra>()
                .Select(e => e.Entity)
                .Single();
    ...
    )
    {
        ...
        )
        {
            ...
            var joinEntities = context.ChangeTracker
                .Entries<UnidirectionalJoinOneToTwo>()
                .Select(e => e.Entity)
                .ToList();
    ...
    )
    {
        ...
        )
        {
            ...
            foreach (
                var joinEntity in context.ChangeTracker
                    .Entries<UnidirectionalJoinTwoToThree>()
                    .Select(e => e.Entity)
                    .ToList()
            )
            {
