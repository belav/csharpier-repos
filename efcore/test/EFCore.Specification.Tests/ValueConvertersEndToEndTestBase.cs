...
namespace Microsoft.EntityFrameworkCore
{
    public abstract class ValueConvertersEndToEndTestBase<TFixture> : IClassFixture<TFixture>
        where TFixture : ValueConvertersEndToEndTestBase<TFixture>.ValueConvertersEndToEndFixtureBase,
            new()
    {
        protected ValueConvertersEndToEndTestBase(TFixture fixture) => Fixture = fixture;

        protected TFixture Fixture { get; }

        private static readonly DateTimeOffset _dateTimeOffset1 =
            new(1973, 9, 3, 12, 10, 0, new TimeSpan(7, 0, 0));
        private static readonly DateTimeOffset _dateTimeOffset2 =
            new(1973, 9, 3, 12, 10, 0, new TimeSpan(8, 0, 0));
        ...
        private static readonly PhysicalAddress _physicalAddress1 = PhysicalAddress.Parse(
            "1D4E55D69273"
        );
        private static readonly PhysicalAddress _physicalAddress2 = PhysicalAddress.Parse(
            "1D4E55D69274"
        );
        ...
        private static readonly string _dateTimeOffsetFormat =
            @"yyyy\-MM\-dd HH\:mm\:ss.FFFFFFFzzz";

        protected static Dictionary<Type, object?[]> TestValues =
            new()
            {
                ...
                {
                    typeof(DateTime),
                    new object?[] { _dateTime1, _dateTime2, _dateTime1, _dateTime2 }
                },
                {
                ...
                {
                    typeof(Guid),
                    new object?[] { Guid.NewGuid(), Guid.NewGuid(), Guid.NewGuid(), Guid.NewGuid() }
                },
                {
                    typeof(IPAddress),
                    new object?[] { _ipAddress1, _ipAddress2, _ipAddress1, _ipAddress2 }
                },
                ...
                {
                    typeof(TimeSpan),
                    new object?[] { _timeSpan1, _timeSpan2, _timeSpan1, _timeSpan2 }
                },
        ...
        protected static Dictionary<Type, object?[]> StringTestValues =
            new()
            {
                { typeof(bool), new object?[] { "True", "False", "True", "False" } },
                { typeof(char), new object?[] { "A", "B", "C", "D" } },
        ...
        public virtual void Can_insert_and_read_back_with_conversions(int[] valueOrder)
        {
            ...
            using (var context = CreateContext())
            {
                SetPropertyValues(
                    context,
                    context.Set<ConvertingEntity>().Single(e => e.Id == id),
                    valueOrder[1],
                    valueOrder[0]
                );
                context.SaveChanges();
        ...
        )
        {
            ...
            foreach (
                var property in context.Model.FindEntityType(entity.GetType())!
                    .GetProperties()
        ...
        public abstract class ValueConvertersEndToEndFixtureBase
            : SharedStoreFixtureBase<PoolableDbContext>
        {
            protected override string StoreName => "ValueConvertersEndToEnd";
            ...
            protected override void OnModelCreating(ModelBuilder modelBuilder, DbContext context)
            {
                modelBuilder.Entity<ConvertingEntity>(
                    b =>
                    {
                        b.Property(e => e.BoolAsChar)
                            .HasConversion(new BoolToTwoValuesConverter<char>('O', 'N'));
                        b.Property(e => e.BoolAsNullableChar)
                            .HasConversion(new BoolToTwoValuesConverter<char?>('O', 'N'));
                        b.Property(e => e.NullableBoolAsChar)
                            .HasConversion(new BoolToTwoValuesConverter<char>('O', 'N'));
                        b.Property(e => e.NullableBoolAsNullableChar)
                            .HasConversion(new BoolToTwoValuesConverter<char?>('O', 'N'));

                        b.Property(e => e.BoolAsString)
                            .HasConversion(new BoolToStringConverter("Non", "Oui"));
                        b.Property(e => e.BoolAsNullableString)
                            .HasConversion(
                                new BoolToTwoValuesConverter<string?>(
                                    "Non",
                                    "Oui",
                                    mappingHints: new ConverterMappingHints(size: 3)
                                )
                            );
                        b.Property(e => e.NullableBoolAsString)
                            .HasConversion(new BoolToStringConverter("Non", "Oui"));
                        b.Property(e => e.NullableBoolAsNullableString)
                            .HasConversion(
                                new BoolToTwoValuesConverter<string?>(
                                    "Non",
                                    "Oui",
                        ...
                        b.Property(e => e.BoolAsInt)
                            .HasConversion(new BoolToZeroOneConverter<int>());
                        b.Property(e => e.BoolAsNullableInt)
                            .HasConversion(new BoolToZeroOneConverter<int?>());
                        b.Property(e => e.NullableBoolAsInt)
                            .HasConversion(new BoolToZeroOneConverter<int>());
                        b.Property(e => e.NullableBoolAsNullableInt)
                            .HasConversion(new BoolToZeroOneConverter<int?>());

                        b.Property(e => e.IntAsLong)
                            .HasConversion(new CastingConverter<int, long>());
                        b.Property(e => e.IntAsNullableLong)
                            .HasConversion(new CastingConverter<int, long?>());
                        b.Property(e => e.NullableIntAsLong)
                            .HasConversion(new CastingConverter<int?, long>());
                        b.Property(e => e.NullableIntAsNullableLong)
                            .HasConversion(new CastingConverter<int?, long?>());

                        b.Property(e => e.BytesAsString)
                            .HasConversion(
                                (ValueConverter)new BytesToStringConverter(),
                                new ArrayStructuralComparer<byte>()
                            );
                        b.Property(e => e.BytesAsNullableString)
                            .HasConversion(
                                (ValueConverter)new BytesToStringConverter(),
                                new ArrayStructuralComparer<byte>()
                            );
                        b.Property(e => e.NullableBytesAsString)
                            .HasConversion(
                                new BytesToStringConverter(),
                                new ArrayStructuralComparer<byte>()
                            );
                        b.Property(e => e.NullableBytesAsNullableString)
                            .HasConversion(
                                new BytesToStringConverter(),
                                new ArrayStructuralComparer<byte>()
                            );
                        ...
                        b.Property(e => e.NullableCharAsString)
                            .HasConversion(new CharToStringConverter());
                        b.Property(e => e.CharAsNullableString)
                            .HasConversion(new CharToStringConverter());
                        b.Property(e => e.NullableCharAsNullableString)
                            .HasConversion(new CharToStringConverter());

                        b.Property(e => e.DateTimeOffsetToBinary)
                            .HasConversion(new DateTimeOffsetToBinaryConverter());
                        b.Property(e => e.DateTimeOffsetToNullableBinary)
                            .HasConversion(new DateTimeOffsetToBinaryConverter());
                        b.Property(e => e.NullableDateTimeOffsetToBinary)
                            .HasConversion(new DateTimeOffsetToBinaryConverter());
                        b.Property(e => e.NullableDateTimeOffsetToNullableBinary)
                            .HasConversion(new DateTimeOffsetToBinaryConverter());

                        b.Property(e => e.DateTimeOffsetToString)
                            .HasConversion(new DateTimeOffsetToStringConverter());
                        b.Property(e => e.DateTimeOffsetToNullableString)
                            .HasConversion(new DateTimeOffsetToStringConverter());
                        b.Property(e => e.NullableDateTimeOffsetToString)
                            .HasConversion(new DateTimeOffsetToStringConverter());
                        b.Property(e => e.NullableDateTimeOffsetToNullableString)
                            .HasConversion(new DateTimeOffsetToStringConverter());

                        b.Property(e => e.DateTimeToBinary)
                            .HasConversion(new DateTimeToBinaryConverter());
                        b.Property(e => e.DateTimeToNullableBinary)
                            .HasConversion(new DateTimeToBinaryConverter());
                        b.Property(e => e.NullableDateTimeToBinary)
                            .HasConversion(new DateTimeToBinaryConverter());
                        b.Property(e => e.NullableDateTimeToNullableBinary)
                            .HasConversion(new DateTimeToBinaryConverter());

                        b.Property(e => e.DateTimeToString)
                            .HasConversion(new DateTimeToStringConverter());
                        b.Property(e => e.DateTimeToNullableString)
                            .HasConversion(new DateTimeToStringConverter());
                        b.Property(e => e.NullableDateTimeToString)
                            .HasConversion(new DateTimeToStringConverter());
                        b.Property(e => e.NullableDateTimeToNullableString)
                            .HasConversion(new DateTimeToStringConverter());

                        b.Property(e => e.EnumToString)
                            .HasConversion(new EnumToStringConverter<TheExperience>());
                        b.Property(e => e.EnumToNullableString)
                            .HasConversion(new EnumToStringConverter<TheExperience>());
                        b.Property(e => e.NullableEnumToString)
                            .HasConversion(new EnumToStringConverter<TheExperience>());
                        b.Property(e => e.NullableEnumToNullableString)
                            .HasConversion(new EnumToStringConverter<TheExperience>());

                        b.Property(e => e.EnumToNumber)
                            .HasConversion(new EnumToNumberConverter<TheExperience, long>());
                        b.Property(e => e.EnumToNullableNumber)
                            .HasConversion(new EnumToNumberConverter<TheExperience, long>());
                        b.Property(e => e.NullableEnumToNumber)
                            .HasConversion(new EnumToNumberConverter<TheExperience, long>());
                        b.Property(e => e.NullableEnumToNullableNumber)
                            .HasConversion(new EnumToNumberConverter<TheExperience, long>());

                        b.Property(e => e.GuidToString).HasConversion(new GuidToStringConverter());
                        b.Property(e => e.GuidToNullableString)
                            .HasConversion(new GuidToStringConverter());
                        b.Property(e => e.NullableGuidToString)
                            .HasConversion(new GuidToStringConverter());
                        b.Property(e => e.NullableGuidToNullableString)
                            .HasConversion(new GuidToStringConverter());

                        b.Property(e => e.GuidToBytes).HasConversion(new GuidToBytesConverter());
                        b.Property(e => e.GuidToNullableBytes)
                            .HasConversion(new GuidToBytesConverter());
                        b.Property(e => e.NullableGuidToBytes)
                            .HasConversion(new GuidToBytesConverter());
                        b.Property(e => e.NullableGuidToNullableBytes)
                            .HasConversion(new GuidToBytesConverter());

                        b.Property(e => e.IPAddressToString)
                            .HasConversion((ValueConverter)new IPAddressToStringConverter());
                        b.Property(e => e.IPAddressToNullableString)
                            .HasConversion((ValueConverter)new IPAddressToStringConverter());
                        b.Property(e => e.NullableIPAddressToString)
                            .HasConversion(new IPAddressToStringConverter());
                        b.Property(e => e.NullableIPAddressToNullableString)
                            .HasConversion(new IPAddressToStringConverter());

                        b.Property(e => e.IPAddressToBytes)
                            .HasConversion((ValueConverter)new IPAddressToBytesConverter());
                        b.Property(e => e.IPAddressToNullableBytes)
                            .HasConversion((ValueConverter)new IPAddressToBytesConverter());
                        b.Property(e => e.NullableIPAddressToBytes)
                            .HasConversion(new IPAddressToBytesConverter());
                        b.Property(e => e.NullableIPAddressToNullableBytes)
                            .HasConversion(new IPAddressToBytesConverter());

                        b.Property(e => e.PhysicalAddressToString)
                            .HasConversion((ValueConverter)new PhysicalAddressToStringConverter());
                        b.Property(e => e.PhysicalAddressToNullableString)
                            .HasConversion((ValueConverter)new PhysicalAddressToStringConverter());
                        b.Property(e => e.NullablePhysicalAddressToString)
                            .HasConversion(new PhysicalAddressToStringConverter());
                        b.Property(e => e.NullablePhysicalAddressToNullableString)
                            .HasConversion(new PhysicalAddressToStringConverter());

                        b.Property(e => e.PhysicalAddressToBytes)
                            .HasConversion((ValueConverter)new PhysicalAddressToBytesConverter());
                        b.Property(e => e.PhysicalAddressToNullableBytes)
                            .HasConversion((ValueConverter)new PhysicalAddressToBytesConverter());
                        b.Property(e => e.NullablePhysicalAddressToBytes)
                            .HasConversion(new PhysicalAddressToBytesConverter());
                        b.Property(e => e.NullablePhysicalAddressToNullableBytes)
                            .HasConversion(new PhysicalAddressToBytesConverter());

                        b.Property(e => e.NumberToString)
                            .HasConversion(new NumberToStringConverter<ulong>());
                        b.Property(e => e.NumberToNullableString)
                            .HasConversion(new NumberToStringConverter<ulong>());
                        b.Property(e => e.NullableNumberToString)
                            .HasConversion(new NumberToStringConverter<ulong>());
                        b.Property(e => e.NullableNumberToNullableString)
                            .HasConversion(new NumberToStringConverter<ulong>());

                        b.Property(e => e.NumberToBytes)
                            .HasConversion(new NumberToBytesConverter<sbyte>());
                        b.Property(e => e.NumberToNullableBytes)
                            .HasConversion(new NumberToBytesConverter<sbyte>());
                        b.Property(e => e.NullableNumberToBytes)
                            .HasConversion(new NumberToBytesConverter<sbyte>());
                        b.Property(e => e.NullableNumberToNullableBytes)
                            .HasConversion(new NumberToBytesConverter<sbyte>());

                        b.Property(e => e.StringToBool).HasConversion(new StringToBoolConverter());
                        b.Property(e => e.StringToNullableBool)
                            .HasConversion(new StringToBoolConverter());
                        b.Property(e => e.NullableStringToBool)
                            .HasConversion((ValueConverter)new StringToBoolConverter());
                        b.Property(e => e.NullableStringToNullableBool)
                            .HasConversion((ValueConverter)new StringToBoolConverter());

                        b.Property(e => e.StringToBytes)
                            .HasConversion(
                                (ValueConverter)new StringToBytesConverter(Encoding.UTF32)
                            );
                        b.Property(e => e.StringToNullableBytes)
                            .HasConversion(
                                (ValueConverter)new StringToBytesConverter(Encoding.UTF32)
                            );
                        b.Property(e => e.NullableStringToBytes)
                            .HasConversion(new StringToBytesConverter(Encoding.UTF32));
                        b.Property(e => e.NullableStringToNullableBytes)
                            .HasConversion(new StringToBytesConverter(Encoding.UTF32));
                        ...
                        b.Property(e => e.NullableStringToChar)
                            .HasConversion((ValueConverter)new StringToCharConverter());
                        b.Property(e => e.NullableStringToNullableChar)
                            .HasConversion((ValueConverter)new StringToCharConverter());

                        b.Property(e => e.StringToDateTime)
                            .HasConversion(new StringToDateTimeConverter());
                        b.Property(e => e.StringToNullableDateTime)
                            .HasConversion(new StringToDateTimeConverter());
                        b.Property(e => e.NullableStringToDateTime)
                            .HasConversion((ValueConverter)new StringToDateTimeConverter());
                        b.Property(e => e.NullableStringToNullableDateTime)
                            .HasConversion((ValueConverter)new StringToDateTimeConverter());

                        b.Property(e => e.StringToDateTimeOffset)
                            .HasConversion(new StringToDateTimeOffsetConverter());
                        b.Property(e => e.StringToNullableDateTimeOffset)
                            .HasConversion(new StringToDateTimeOffsetConverter());
                        ...
                        b.Property(e => e.StringToEnum)
                            .HasConversion(new StringToEnumConverter<TheExperience>());
                        b.Property(e => e.StringToNullableEnum)
                            .HasConversion(new StringToEnumConverter<TheExperience>());
                        b.Property(e => e.NullableStringToEnum)
                            .HasConversion(
                                (ValueConverter)new StringToEnumConverter<TheExperience>()
                            );
                        ...
                        b.Property(e => e.StringToNullableGuid)
                            .HasConversion(new StringToGuidConverter());
                        b.Property(e => e.NullableStringToGuid)
                            .HasConversion((ValueConverter)new StringToGuidConverter());
                        b.Property(e => e.NullableStringToNullableGuid)
                            .HasConversion((ValueConverter)new StringToGuidConverter());

                        b.Property(e => e.StringToNumber)
                            .HasConversion(new StringToNumberConverter<byte>());
                        b.Property(e => e.StringToNullableNumber)
                            .HasConversion(new StringToNumberConverter<byte>());
                        b.Property(e => e.NullableStringToNumber)
                            .HasConversion((ValueConverter)new StringToNumberConverter<byte>());
                        b.Property(e => e.NullableStringToNullableNumber)
                            .HasConversion((ValueConverter)new StringToNumberConverter<byte>());

                        b.Property(e => e.StringToTimeSpan)
                            .HasConversion(new StringToTimeSpanConverter());
                        b.Property(e => e.StringToNullableTimeSpan)
                            .HasConversion(new StringToTimeSpanConverter());
                        b.Property(e => e.NullableStringToTimeSpan)
                            .HasConversion((ValueConverter)new StringToTimeSpanConverter());
                        b.Property(e => e.NullableStringToNullableTimeSpan)
                            .HasConversion((ValueConverter)new StringToTimeSpanConverter());

                        b.Property(e => e.TimeSpanToTicks)
                            .HasConversion(new TimeSpanToTicksConverter());
                        b.Property(e => e.TimeSpanToNullableTicks)
                            .HasConversion(new TimeSpanToTicksConverter());
                        b.Property(e => e.NullableTimeSpanToTicks)
                            .HasConversion(new TimeSpanToTicksConverter());
                        b.Property(e => e.NullableTimeSpanToNullableTicks)
                            .HasConversion(new TimeSpanToTicksConverter());

                        b.Property(e => e.TimeSpanToString)
                            .HasConversion(new TimeSpanToStringConverter());
                        b.Property(e => e.TimeSpanToNullableString)
                            .HasConversion(new TimeSpanToStringConverter());
                        b.Property(e => e.NullableTimeSpanToString)
                            .HasConversion(new TimeSpanToStringConverter());
                        b.Property(e => e.NullableTimeSpanToNullableString)
                            .HasConversion(new TimeSpanToStringConverter());

                        b.Property(e => e.UriToString)
                            .HasConversion((ValueConverter)new UriToStringConverter());
                        b.Property(e => e.UriToNullableString)
                            .HasConversion((ValueConverter)new UriToStringConverter());
                        b.Property(e => e.NullableUriToString)
                            .HasConversion(new UriToStringConverter());
                        b.Property(e => e.NullableUriToNullableString)
                            .HasConversion(new UriToStringConverter());

                        b.Property(e => e.NonNullIntToNullString)
                            .HasConversion(new NonNullIntToNullStringConverter());
                        b.Property(e => e.NonNullIntToNonNullString)
                            .HasConversion(new NonNullIntToNonNullStringConverter());
                        b.Property(e => e.NullIntToNullString)
                            .HasConversion(new NullIntToNullStringConverter())
                            .IsRequired(false);
                        b.Property(e => e.NullIntToNonNullString)
                            .HasConversion(new NullIntToNonNullStringConverter())
                            .IsRequired(false);

                        b.Property(e => e.NullStringToNonNullString)
                            .HasConversion(new NullStringToNonNullStringConverter())
                            .IsRequired();
                        b.Property(e => e.NonNullStringToNullString)
                            .HasConversion(new NonNullStringToNullStringConverter())
                            .IsRequired(false);

                        b.Property(e => e.NullableListOfInt)
                            .HasConversion(
                                (ValueConverter?)new ListOfIntToJsonConverter(),
                                new ListOfIntComparer()
                            );

                        b.Property(e => e.ListOfInt)
                            .HasConversion(new ListOfIntToJsonConverter(), new ListOfIntComparer());

                        b.Property(e => e.NullableEnumerableOfInt)
                            .HasConversion(
                                (ValueConverter?)new EnumerableOfIntToJsonConverter(),
                                new EnumerableOfIntComparer()
                            );

                        b.Property(e => e.EnumerableOfInt)
                            .HasConversion(
                                new EnumerableOfIntToJsonConverter(),
                                new EnumerableOfIntComparer()
                            );
                    }
                );
