        ...
        new()
{
    ...
    private static readonly DateTimeOffset _dateTimeOffset1 = new(
        1973,
        9,
        3,
        12,
    ...
    private static readonly DateTimeOffset _dateTimeOffset2 = new(
        1973,
        9,
        3,
        12,
    ...
    protected static Dictionary<Type, object?[]> TestValues = new()
    {
        ...
        {
            typeof(byte[]),
            new object?[] { new byte[] { 1 }, new byte[] { 2 }, new byte[] { 3 }, new byte[] { 4 } }
        },
        {
            typeof(DateTimeOffset),
            new object?[] { _dateTimeOffset1, _dateTimeOffset2, _dateTimeOffset1, _dateTimeOffset2 }
        },
    ...
    {
        var converter = new NullStringToNonNullStringConverter().ConvertToProviderExpression
            .Compile();
    ...
    {
        var converter = new NonNullStringToNullStringConverter().ConvertFromProviderExpression
            .Compile();
    ...
    {
        var converter = new NonNullStringToNullStringConverter().ConvertToProviderExpression
            .Compile();
    ...
    {
        var converter = new NonNullIntToNonNullStringConverter().ConvertToProviderExpression
            .Compile();
    ...
    {
        var converter = new NonNullIntToNullStringConverter().ConvertFromProviderExpression
            .Compile();
    ...
    {
        var converter = new NonNullIntToNonNullStringConverter().ConvertFromProviderExpression
            .Compile();
    ...
    {
        var converter = new NullIntToNonNullStringConverter().ConvertFromProviderExpression
            .Compile();
        ...
        : SharedStoreFixtureBase<PoolableDbContext>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder, DbContext context) =>
            modelBuilder.Entity<ConvertingEntity>(b =>
            {
                ...
                b.Property(e => e.DateOnlyToNullableString)
                    .HasConversion(new DateOnlyToStringConverter());
                b.Property(e => e.NullableDateOnlyToString)
                    .HasConversion(new DateOnlyToStringConverter());
                b.Property(e => e.NullableDateOnlyToNullableString)
                    .HasConversion(new DateOnlyToStringConverter());
