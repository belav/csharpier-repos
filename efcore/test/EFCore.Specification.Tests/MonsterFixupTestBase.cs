        ...
        where TFixture : MonsterFixupTestBase<TFixture>.MonsterFixupFixtureBase, new()
    {
        ...
        public virtual void Can_build_monster_model_and_seed_data_using_all_navigations()
        {
            CreateAndSeedDatabase(
                context => context.SeedUsingNavigations(dependentNavs: true, principalNavs: true)
            );
        ...
        {
            CreateAndSeedDatabase(
                context => context.SeedUsingNavigations(dependentNavs: true, principalNavs: false)
            );
        ...
        {
            CreateAndSeedDatabase(
                context => context.SeedUsingNavigations(dependentNavs: false, principalNavs: true)
            );
        ...
        public virtual void Composite_fixup_happens_when_FKs_change_test()
        {
            ...
            using (var context = CreateContext())
            {
                ...
                var productReview1 = context.ProductReviews
                    .Single(e => e.Review.StartsWith("Better"));
                var productReview2 = context.ProductReviews
                    .Single(e => e.Review.StartsWith("Good"));
                var productReview3 = context.ProductReviews
                ...
                var productWebFeature1 = context.ProductWebFeatures
                    .Single(e => e.Heading.StartsWith("Waffle"));
                var productWebFeature2 = context.ProductWebFeatures
        ...
        public virtual void Fixup_with_binary_keys_happens_when_FKs_or_navigations_change_test()
        {
            ...
            using (var context = CreateContext())
            {
                ...
                var incorrectScan1 = context.IncorrectScans
                    .Single(e => e.Details.StartsWith("Treats"));
                var incorrectScan2 = context.IncorrectScans
                    .Single(e => e.Details.StartsWith("Wot"));

                var barcodeDetails1 = context.BarcodeDetails
        ...
        protected void FkVerification()
        {
            ...
            var suspiciousActivity1 = context.SuspiciousActivities
                .Single(e => e.Activity.StartsWith("Pig"));
            var suspiciousActivity2 = context.SuspiciousActivities
                .Single(e => e.Activity.StartsWith("Crumbs"));
            var suspiciousActivity3 = context.SuspiciousActivities
            ...
            var supplierInfo1 = context.SupplierInformation
                .Single(e => e.Information.StartsWith("Seems"));
            var supplierInfo2 = context.SupplierInformation
                .Single(e => e.Information.StartsWith("Orange"));
            var supplierInfo3 = context.SupplierInformation
            ...
            var customerInfo1 = context.CustomerInformation
                .Single(e => e.Information.StartsWith("Really"));
            var customerInfo2 = context.CustomerInformation
            ...
            var computerDetail1 = context.ComputerDetails
                .Single(e => e.Specifications == "It's a Dell!");
            var computerDetail2 = context.ComputerDetails
