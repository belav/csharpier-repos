            ...
            new()
            {
                new EntityTypeMapping()
                {
                    ...
                    Properties =
                    {
                        ...
                        "Property: ApiResource.LastAccessed (Nullable<DateTime>)",
                        ...
                        "Property: ApiResource.Updated (Nullable<DateTime>)",
                    },
                    Indexes = { "{'Name'} Unique", },
                    Navigations =
                    {
                ...
                new EntityTypeMapping()
                {
                    ...
                    Properties =
                    {
                        ...
                        "Property: ApiResourceSecret.Expiration (Nullable<DateTime>)",
                ...
                new EntityTypeMapping()
                {
                    ...
                    Properties =
                    {
                        ...
                        "Property: Client.ConsentLifetime (Nullable<int>)",
                        ...
                        "Property: Client.LastAccessed (Nullable<DateTime>)",
                        ...
                        "Property: Client.Updated (Nullable<DateTime>)",
                        "Property: Client.UserCodeType (string) MaxLength(100)",
                        "Property: Client.UserSsoLifetime (Nullable<int>)",
                    },
                ...
                new EntityTypeMapping()
                {
                    ...
                    Properties =
                    {
                        ...
                        "Property: ClientSecret.Expiration (Nullable<DateTime>)",
                ...
                new EntityTypeMapping()
                {
                    ...
                    Properties =
                    {
                        ...
                        "Property: IdentityResource.Updated (Nullable<DateTime>)",
                    },
                    Indexes = { "{'Name'} Unique", },
                    Navigations =
                    {
