    ...
    protected override List<EntityTypeMapping> ExpectedMappings =>
        new()
        {
            ...
            new EntityTypeMapping
            {
                ...
                FKs =
                {
                    "ForeignKey: IdentityRoleClaim<string> {'RoleId'} -> IdentityRole {'Id'} Required Cascade",
                },
            },
            new EntityTypeMapping
            {
            ...
            new EntityTypeMapping
            {
                ...
                FKs =
                {
                    "ForeignKey: IdentityUserClaim<string> {'UserId'} -> IdentityUser {'Id'} Required Cascade",
                },
            },
            new EntityTypeMapping
            {
                ...
                FKs =
                {
                    "ForeignKey: IdentityUserLogin<string> {'UserId'} -> IdentityUser {'Id'} Required Cascade",
                },
            },
            new EntityTypeMapping
            {
            ...
            new EntityTypeMapping
            {
                ...
                FKs =
                {
                    "ForeignKey: IdentityUserToken<string> {'UserId'} -> IdentityUser {'Id'} Required Cascade",
                },
            },
        };
}
