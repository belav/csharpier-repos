...
public class CosmosModelValidatorTest : ModelValidatorTestBase
{
    ...
    public virtual void Detects_non_string_id_property()
    {
        ...
        VerifyError(
            CosmosStrings.IdNonStringStoreType("id", typeof(Order).Name, "int"),
            modelBuilder
        );
    }
    ...
    public virtual void Passes_on_valid_partition_keys()
    {
        ...
        modelBuilder
            .Entity<Order>()
            .ToContainer("Orders")
            .HasPartitionKey(o => o.PartitionId)
            .Property(o => o.PartitionId)
    ...
    public virtual void Detects_non_key_partition_key_property()
    {
        ...
        VerifyError(
            CosmosStrings.NoPartitionKeyKey(typeof(Order).Name, nameof(Order.PartitionId), "id"),
            modelBuilder
        );
    }
    ...
    public virtual void Detects_missing_partition_key_property()
    {
        ...
        VerifyError(
            CosmosStrings.PartitionKeyMissingProperty(typeof(Order).Name, "PartitionKey"),
            modelBuilder
        );
    }
    ...
    public virtual void Detects_partition_keys_mapped_to_different_properties()
    {
        ...
        modelBuilder
            ...
            .ToContainer("Orders")
            .HasPartitionKey(c => c.PartitionId)
            .Property(c => c.PartitionId)
            .ToJsonProperty("pk");
        modelBuilder.Entity<Order>().ToContainer("Orders").HasPartitionKey(c => c.PartitionId);

        VerifyError(
            CosmosStrings.PartitionKeyStoreNameMismatch(
                nameof(Customer.PartitionId),
                typeof(Customer).Name,
                "pk",
                nameof(Order.PartitionId),
                typeof(Order).Name,
                nameof(Order.PartitionId)
            ),
            modelBuilder
    ...
    {
        var modelBuilder = CreateConventionalModelBuilder();
        modelBuilder.Entity<Customer>().ToContainer("Orders").HasAnalyticalStoreTimeToLive(-1);
        modelBuilder.Entity<Order>().ToContainer("Orders").HasAnalyticalStoreTimeToLive(60);
    ...
    {
        var modelBuilder = CreateConventionalModelBuilder();
        modelBuilder.Entity<Customer>().ToContainer("Orders").HasDefaultTimeToLive(100);
        modelBuilder.Entity<Order>().ToContainer("Orders").HasDefaultTimeToLive(60);
    ...
    {
        var modelBuilder = CreateConventionalModelBuilder();
        modelBuilder.Entity<Customer>().ToContainer("Orders").HasAutoscaleThroughput(200);
        modelBuilder.Entity<Order>().ToContainer("Orders").HasAutoscaleThroughput(60);
    ...
    {
        var modelBuilder = CreateConventionalModelBuilder();
        modelBuilder.Entity<Customer>().ToContainer("Orders").HasManualThroughput(200);
        modelBuilder.Entity<Order>().ToContainer("Orders").HasAutoscaleThroughput(200);
    ...
    public virtual void Detects_missing_discriminator()
    {
        ...
        VerifyError(
            CosmosStrings.NoDiscriminatorProperty(typeof(Customer).Name, "Orders"),
            modelBuilder
        );
    }
    ...
    public virtual void Detects_missing_discriminator_value()
    {
        ...
        VerifyError(
            CosmosStrings.NoDiscriminatorValue(typeof(Customer).Name, "Orders"),
            modelBuilder
        );
    }
    ...
    public virtual void Detects_invalid_concurrency_token()
    {
        ...
        VerifyError(
            CosmosStrings.NonETagConcurrencyToken(typeof(Customer).Name, "_not_etag"),
            modelBuilder
        );
    }
    ...
    public virtual void Detects_nonString_concurrency_token()
    {
        ...
        VerifyError(
            CosmosStrings.ETagNonStringStoreType("_etag", typeof(Customer).Name, "int"),
            modelBuilder
        );
    }
