...
{
    protected FindInMemoryTest(FindInMemoryFixture fixture) : base(fixture)
    {
    }

    public class FindInMemoryTestSet : FindInMemoryTest
    {
        public FindInMemoryTestSet(FindInMemoryFixture fixture) : base(fixture)
        {
        }
    ...
    {
        public FindInMemoryTestContext(FindInMemoryFixture fixture) : base(fixture)
        {
        }
    ...
    {
        public FindInMemoryTestNonGeneric(FindInMemoryFixture fixture) : base(fixture)
        {
        }
