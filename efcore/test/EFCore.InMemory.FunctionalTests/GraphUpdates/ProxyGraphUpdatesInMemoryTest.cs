...
namespace Microsoft.EntityFrameworkCore
{
    public class ProxyGraphUpdatesInMemoryTest
    {
                ...
                new()
        {
            ...
            {
                base.Optional_many_to_one_dependents_are_orphaned_in_store(
                    cascadeDeleteTiming,
                    deleteOrphansTiming
                );
            }
            ...
            {
                base.Required_one_to_one_are_cascade_detached_when_Added(
                    cascadeDeleteTiming,
                    deleteOrphansTiming
                );
            }
            ...
            {
                base.Required_non_PK_one_to_one_are_cascade_detached_when_Added(
                    cascadeDeleteTiming,
                    deleteOrphansTiming
                );
            }
            ...
            public abstract class ProxyGraphUpdatesInMemoryFixtureBase
            ...
            : ProxyGraphUpdatesInMemoryTestBase<LazyLoading.ProxyGraphUpdatesWithLazyLoadingInMemoryFixture>
        {
            ...
            public class ProxyGraphUpdatesWithLazyLoadingInMemoryFixture
                : ProxyGraphUpdatesInMemoryFixtureBase
            {
            ...
            : ProxyGraphUpdatesInMemoryTestBase<ChangeTracking.ProxyGraphUpdatesWithChangeTrackingInMemoryFixture>
        {
            ...
            public class ProxyGraphUpdatesWithChangeTrackingInMemoryFixture
                : ProxyGraphUpdatesInMemoryFixtureBase
            {
        ...
        public class LazyLoadingAndChangeTracking
            : ProxyGraphUpdatesInMemoryTestBase<LazyLoadingAndChangeTracking.ProxyGraphUpdatesWithChangeTrackingInMemoryFixture>
        {
