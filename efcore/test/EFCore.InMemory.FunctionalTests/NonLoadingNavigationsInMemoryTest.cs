    ...
    : LoadTestBase<NonLoadingNavigationsInMemoryTest.NonLoadingNavigationsInMemoryFixture>
{
    ...
    protected override bool LazyLoadingEnabled => false;

    public class NonLoadingNavigationsInMemoryFixture : LoadFixtureBase
    {
        protected override string StoreName => "NonLoadingNavigations";
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder, DbContext context)
        {
            ...
            modelBuilder
                .Entity<ChildFullLoaderByConstructor>()
                .Navigation(e => e.Parent)
                .EnableLazyLoading(false);
            modelBuilder
                .Entity<SingleFullLoaderByConstructor>()
                .Navigation(e => e.Parent)
                .EnableLazyLoading(false);
            ...
            modelBuilder
                .Entity<ChildDelegateLoaderByConstructor>()
                .Navigation(e => e.Parent)
                .EnableLazyLoading(false);
            modelBuilder
                .Entity<SingleDelegateLoaderByConstructor>()
                .Navigation(e => e.Parent)
                .EnableLazyLoading(false);
            ...
            modelBuilder
                .Entity<ChildDelegateLoaderByProperty>()
                .Navigation(e => e.Parent)
                .EnableLazyLoading(false);
            modelBuilder
                .Entity<SingleDelegateLoaderByProperty>()
                .Navigation(e => e.Parent)
                .EnableLazyLoading(false);
            ...
            modelBuilder
                .Entity<ChildDelegateLoaderWithStateByProperty>()
                .Navigation(e => e.Parent)
                .EnableLazyLoading(false);
            modelBuilder
                .Entity<SingleDelegateLoaderWithStateByProperty>()
                .Navigation(e => e.Parent)
                .EnableLazyLoading(false);
