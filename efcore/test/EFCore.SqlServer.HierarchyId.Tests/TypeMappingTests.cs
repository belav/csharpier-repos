...
public class TypeMappingTests
{
    ...
    private static void AssertMapping<T>(RelationalTypeMapping mapping) =>
        AssertMapping(typeof(T), mapping);

    private static void AssertMapping(Type type, RelationalTypeMapping mapping) =>
