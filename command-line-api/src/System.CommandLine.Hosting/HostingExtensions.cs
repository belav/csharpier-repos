...
namespace System.CommandLine.Hosting
{
    public static class HostingExtensions
    {
        ...
        public static IHostBuilder UseInvocationLifetime(
        ...
        public static ParseResult GetParseResult(this IHostBuilder hostBuilder)
        {
            ...
            if (
                hostBuilder.Properties.TryGetValue(typeof(ParseResult), out var ctxObj)
                && ctxObj is ParseResult invocationContext
            )
                return invocationContext;

            throw new InvalidOperationException(
                "Host builder has no Invocation Context registered to it."
            );
        }
        ...
        public static ParseResult GetParseResult(this HostBuilderContext context)
        {
            ...
            if (
                context.Properties.TryGetValue(typeof(ParseResult), out var ctxObj)
                && ctxObj is ParseResult invocationContext
            )
                return invocationContext;
