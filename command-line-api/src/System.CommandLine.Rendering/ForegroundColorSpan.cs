...
namespace System.CommandLine.Rendering
{
    public class ForegroundColorSpan : ColorSpan
    {
        ...
        public static ForegroundColorSpan Magenta() =>
            new(nameof(Magenta), Ansi.Color.Foreground.Magenta);

        public static ForegroundColorSpan Cyan() => new(nameof(Cyan), Ansi.Color.Foreground.Cyan);

        public static ForegroundColorSpan White() =>
            new(nameof(White), Ansi.Color.Foreground.White);

        public static ForegroundColorSpan DarkGray() =>
            new(nameof(DarkGray), Ansi.Color.Foreground.DarkGray);

        public static ForegroundColorSpan LightRed() =>
            new(nameof(LightRed), Ansi.Color.Foreground.LightRed);

        public static ForegroundColorSpan LightGreen() =>
            new(nameof(LightGreen), Ansi.Color.Foreground.LightGreen);

        public static ForegroundColorSpan LightYellow() =>
            new(nameof(LightYellow), Ansi.Color.Foreground.LightYellow);

        public static ForegroundColorSpan LightBlue() =>
            new(nameof(LightBlue), Ansi.Color.Foreground.LightBlue);

        public static ForegroundColorSpan LightMagenta() =>
            new(nameof(LightMagenta), Ansi.Color.Foreground.LightMagenta);

        public static ForegroundColorSpan LightCyan() =>
            new(nameof(LightCyan), Ansi.Color.Foreground.LightCyan);

        public static ForegroundColorSpan LightGray() =>
            new(nameof(LightGray), Ansi.Color.Foreground.LightGray);
