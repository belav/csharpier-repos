...
namespace System.CommandLine.Rendering
{
    public class BackgroundColorSpan : ColorSpan
    {
        ...
        public static BackgroundColorSpan Magenta() =>
            new(nameof(Magenta), Ansi.Color.Background.Magenta);

        public static BackgroundColorSpan Cyan() => new(nameof(Cyan), Ansi.Color.Background.Cyan);

        public static BackgroundColorSpan White() =>
            new(nameof(White), Ansi.Color.Background.White);

        public static BackgroundColorSpan DarkGray() =>
            new(nameof(DarkGray), Ansi.Color.Background.DarkGray);

        public static BackgroundColorSpan LightRed() =>
            new(nameof(LightRed), Ansi.Color.Background.LightRed);

        public static BackgroundColorSpan LightGreen() =>
            new(nameof(LightGreen), Ansi.Color.Background.LightGreen);

        public static BackgroundColorSpan LightYellow() =>
            new(nameof(LightYellow), Ansi.Color.Background.LightYellow);

        public static BackgroundColorSpan LightBlue() =>
            new(nameof(LightBlue), Ansi.Color.Background.LightBlue);

        public static BackgroundColorSpan LightMagenta() =>
            new(nameof(LightMagenta), Ansi.Color.Background.LightMagenta);

        public static BackgroundColorSpan LightCyan() =>
            new(nameof(LightCyan), Ansi.Color.Background.LightCyan);

        public static BackgroundColorSpan LightGray() =>
            new(nameof(LightGray), Ansi.Color.Background.LightGray);
