...
namespace System.CommandLine.Rendering
{
    public class StyleSpan : ControlSpan
    {
        ...
        public static StyleSpan ReverseOff() =>
            new StyleSpan(nameof(ReverseOff), Ansi.Text.ReverseOff);
        public static StyleSpan StandoutOff() =>
            new StyleSpan(nameof(StandoutOff), Ansi.Text.StandoutOff);
        public static StyleSpan StandoutOn() =>
            new StyleSpan(nameof(StandoutOn), Ansi.Text.StandoutOn);
        public static StyleSpan UnderlinedOff() =>
            new StyleSpan(nameof(UnderlinedOff), Ansi.Text.UnderlinedOff);
        public static StyleSpan UnderlinedOn() =>
            new StyleSpan(nameof(UnderlinedOn), Ansi.Text.UnderlinedOn);
    }
}
