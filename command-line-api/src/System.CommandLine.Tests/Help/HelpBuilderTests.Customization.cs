    ...
    public partial class HelpBuilderTests
    {
        public class Customization
        {
            ...
            private HelpBuilder GetHelpBuilder(int maxWidth) =>
                new(LocalizationResources.Instance, maxWidth);
            ...
            public void Option_can_customize_first_column_text_based_on_parse_result()
            {
                ...
                var commandA = new Command("a", "a command help") { option };
                var commandB = new Command("b", "b command help") { option };
                var command = new Command("root", "root command help") { commandA, commandB };
            ...
            {
                Action action = () =>
                    new HelpBuilder(LocalizationResources.Instance).CustomizeSymbol(null!, "");
            ...
            )
            {
                ...
                helpBuilder.CustomizeSymbol(
                    ...
                    firstColumnText: ctx =>
                        conditionA
                            ? "custom 1st"
                            : HelpBuilder.Default.GetIdentifierSymbolUsageLabel(option, ctx),
                    secondColumnText: ctx =>
                        conditionB
                            ? "custom 2nd"
                            : HelpBuilder.Default.GetIdentifierSymbolDescription(option)
                );
            ...
            [InlineData(
                ...
                false,
                false,
                "\\<arg\\>\\s*description\\s*\\[default\\: default\\]"
            )]
            [InlineData(
                true,
                false,
                false,
                "custom 1st\\s*description\\s*\\[default\\: default\\]"
            )]
            ...
            [InlineData(
                ...
                false,
                true,
                "\\<arg\\>\\s*description\\s*\\[default\\: custom def\\]"
            )]
            [InlineData(
                true,
                false,
                true,
                "custom 1st\\s*description\\s*\\[default\\: custom def\\]"
            )]
            [InlineData(
                false,
                true,
                true,
                "\\<arg\\>\\s*custom 2nd\\s*\\[default\\: custom def\\]"
            )]
            [InlineData(
                true,
                true,
                true,
                "custom 1st\\s*custom 2nd\\s*\\[default\\: custom def\\]"
            )]
            ...
            )
            {
                ...
                helpBuilder.CustomizeSymbol(
                    ...
                    firstColumnText: ctx =>
                        conditionA
                            ? "custom 1st"
                            : HelpBuilder.Default.GetArgumentUsageLabel(argument),
                    secondColumnText: ctx =>
                        conditionB
                            ? "custom 2nd"
