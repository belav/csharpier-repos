...
namespace System.CommandLine.Tests.Help
{
    public partial class HelpBuilderTests
    {
        ...
        public void Usage_section_does_not_show_additional_arguments_when_TreatUnmatchedTokensAsErrors_is_not_specified()
        {
            ...
            command.AddOption(new Option<string>("-x", "Indicates whether x"));
        ...
        {
            var command = new Command("the-command");
            command.AddOption(new Option<string>("-x", "Is Hidden") { IsHidden = true });
            command.AddOption(new Option<string>("-n", "Not Hidden") { IsHidden = false });
