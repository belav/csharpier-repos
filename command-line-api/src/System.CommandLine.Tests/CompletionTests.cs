...
namespace System.CommandLine.Tests
{
    public class CompletionTests
    {
        ...
        public void Command_GetCompletions_returns_available_option_aliases_for_global_options()
        {
            ...
            var subcommand1 = new CliCommand("command1") { subcommand2 };
        ...
        {
            var command = new CliCommand("command") { new CliArgument<string>("the-argument") };
        ...
        public void When_a_subcommand_has_been_specified_then_its_sibling_commands_will_not_be_suggested()
        {
            ...
            {
                new CliCommand("apple") { new CliOption<string>("--cortland") },
                new CliCommand("banana") { new CliOption<string>("--cavendish") },
                new CliCommand("cherry") { new CliOption<string>("--rainier") },
            };
            CliConfiguration simpleConfig = new(rootCommand);
        ...
        {
            var apple = new CliCommand("apple") { new CliOption<string>("--cortland") };
            apple.Aliases.Add("apl");

            var banana = new CliCommand("banana") { new CliOption<string>("--cavendish") };
            banana.Aliases.Add("bnn");

            var rootCommand = new CliRootCommand { apple, banana };
            CliConfiguration simpleConfig = new(rootCommand);
        ...
        public void When_a_subcommand_has_been_specified_then_its_child_options_will_be_suggested()
        {
            ...
            {
                new CliArgument<string>("arg"),
                new CliCommand("child") { new CliOption<string>("--child-option") },
            };
        ...
        public void When_a_subcommand_with_subcommands_has_been_specified_then_its_sibling_commands_will_not_be_suggested()
        {
            var rootCommand = new CliRootCommand
            {
                new CliCommand("apple") { new CliCommand("cortland") },
                new CliCommand("banana") { new CliCommand("cavendish") },
                new CliCommand("cherry") { new CliCommand("rainier") },
            };
        ...
        public void An_option_can_be_hidden_from_completions_by_setting_IsHidden_to_true()
        {
            var command = new CliCommand("the-command")
            {
                new CliOption<string>("--hide-me") { Hidden = true },
        ...
        public void Parser_options_can_supply_context_sensitive_matches()
        {
            var command = new CliRootCommand
            {
                ...
                CreateOptionWithAcceptOnlyFromAmong(
                    name: "--cheese",
                    "provolone",
                    "cheddar",
                    "cream cheese"
        ...
        public void Subcommand_names_are_available_as_suggestions()
        {
            ...
            CliConfiguration simpleConfig = new(command);
            command
                .Parse(commandLine, simpleConfig)
                .GetCompletions(commandLine.Length + 1)
                .Select(item => item.Label)
                .Should()
        ...
        public void Completions_can_be_provided_in_the_absence_of_validation()
        {
            ...
            CliConfiguration simpleConfig = new(command);
            command
                .Parse("the-command -t m", simpleConfig)
                .GetCompletions()
                .Select(item => item.Label)
                .Should()
                .BeEquivalentTo("animal", "mineral");

            command.Parse("the-command -t something-else", simpleConfig).Errors.Should().BeEmpty();
        }
        ...
        public void When_parsing_from_text_if_the_proximate_option_is_completed_then_completions_consider_other_option_tokens()
        {
            ...
            var configuration = new CliConfiguration(command);
            var completions = command
                .Parse("--framework net7.0 --l", configuration)
                .GetCompletions();
        ...
        public void When_parsing_from_array_if_the_proximate_option_is_completed_then_completions_consider_other_option_tokens()
        {
            ...
            var configuration = new CliConfiguration(command);
            var completions = command
                .Parse(new[] { "--framework", "net7.0", "--l" }, configuration)
                .GetCompletions();
        ...
        {
            var command = new CliCommand("the-command") { new CliArgument<FileMode>("arg") };
        ...
        public void It_can_provide_completions_within_quotes(string commandLine, int position)
        {
            ...
            var r = new CliCommand("#r") { argument };
        ...
        public void Completions_for_options_provide_a_description()
        {
            ...
            var completions = new CliCommand("test") { option }.GetCompletions(
        ...
        public void Completions_for_subcommands_provide_a_description()
        {
            ...
            var completions = new CliCommand("test") { subcommand }.GetCompletions(
                CompletionContext.Empty
            );
        ...
        private static CliArgument<string> CreateArgumentWithAcceptOnlyFromAmong(
        ...
        private static CliOption<string> CreateOptionWithAcceptOnlyFromAmong(
            string name,
            params string[] values
        )
        {
