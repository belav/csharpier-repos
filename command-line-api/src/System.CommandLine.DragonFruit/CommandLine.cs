...
namespace System.CommandLine.DragonFruit
{
    public static class CommandLine
    {
        ...
        )
        {
            ...
            {
                var argument = ArgumentBuilder.CreateArgument(
                    argsParam.ParameterType,
                    argsParam.Name
                );
            ...
            )
            {
                ...
                )
                {
                    ...
                    foreach (var parameterDescription in metadata.ParameterDescriptions)
                    {
                        ...
                        var option = builder.Command.Options.FirstOrDefault(
                            o => o.HasAliasIgnoringPrefix(kebabCasedParameterName)
                        );
