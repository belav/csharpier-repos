...
{
    /// <summary>
    /// Determines whether <paramref name="type"/> is a constructed type of <paramref
    // name="genericTypeDefinition"/>.
    /// </summary>
    /// <param name="type">The type.</param>
    /// <param name="genericTypeDefinition">The generic type definition.</param>
    /// <returns><see langword="true" /> if <paramref name="type"/> is a constructed type of <paramref
    // name="genericTypeDefinition"/>; otherwise, <see langword="false" />.</returns>
    ...
    /// <returns><see langword="true" /> if <paramref name="type"/> is a nullable value type; otherwise,
