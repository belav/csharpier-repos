...
namespace R2RDump
{
    public class R2RDumpRootCommand : RootCommand
    {
        ...
        public Option<bool> Header { get; } = new(new[] { "--header" }, "Dump R2R header");
        ...
        public Option<bool> Unwind { get; } = new(new[] { "--unwind" }, "Dump unwindInfo");
        public Option<bool> GC { get; } = new(new[] { "--gc" }, "Dump gcInfo and slot table");
        ...
        public Option<bool> Diff { get; } = new(new[] { "--diff" }, "Compare two R2R images");
        ...
        public Option<bool> CreatePDB { get; } = new(new[] { "--create-pdb" }, "Create PDB");
