    ...
    internal static class CommandLineOptions
    {
        public static RootCommand RootCommand()
        {
            ...
            command.AddOption(
                new Option<FileInfo[]>(
                    new[] { "--in", "-i" },
                    "Input file(s) to dump. Expects them to by ReadyToRun images"
                )
            );
            command.AddOption(
                new Option<FileInfo>(
            ...
            command.AddOption(
                new Option<bool>(
                    new[] { "--hide-offsets", "--ho" },
                    "Hide offsets in naked disassembly"
                )
            );
            command.AddOption(
                new Option<string[]>(
            ...
            command.AddOption(
                new Option<string[]>(new[] { "--keyword", "-k" }, "Search method by keyword")
            );
            command.AddOption(
                new Option<string[]>(
            ...
            command.AddOption(
                new Option<string[]>(new[] { "--section", "-s" }, "Get section by keyword")
            );
            ...
            command.AddOption(
                new Option<bool>(new[] { "--pgo" }, "Dump embedded pgo instrumentation data")
            );
            command.AddOption(
                new Option<bool>(new[] { "--sectionContents", "--sc" }, "Dump section contents")
            );
            command.AddOption(
                new Option<bool>(
                    new[] { "--entrypoints", "-e" },
                    "Dump list of method / instance entrypoints in the R2R file"
                )
            );
            command.AddOption(
                new Option<bool>(
            ...
            command.AddOption(
                new Option<bool>(
                    ...
                    "Don't include GC transitions in disassembly output"
                )
            );
            command.AddOption(
                new Option<bool>(
                    new[] { "--verbose", "-v" },
                    "Dump disassembly, unwindInfo, gcInfo and sectionContents"
                )
            );
            ...
            command.AddOption(
                new Option<FileInfo[]>(
                    new[] { "--reference", "-r" },
                    "Explicit reference assembly files"
                )
            );
            command.AddOption(
                new Option<DirectoryInfo[]>(
                    new[] { "--referencePath", "--rp" },
                    "Search paths for reference assemblies"
                )
            );
            command.AddOption(
                new Option<bool>(
            ...
            command.AddOption(
                new Option<bool>(
                    ...
                    "Append signature binary to its textual representation"
                )
            );
            command.AddOption(new Option<bool>(new[] { "--create-pdb" }, "Create PDB"));
            command.AddOption(
                new Option<string>(new[] { "--pdb-path" }, "PDB output path for --create-pdb")
            );
            command.AddOption(new Option<bool>(new[] { "--create-perfmap" }, "Create PerfMap"));
            command.AddOption(
                new Option<string>(
                    new[] { "--perfmap-path" },
                    "PerfMap output path for --create-perfmap"
                )
            );
            command.AddOption(
                new Option<int>(
                    new[] { "--perfmap-format-version" },
                    "PerfMap format version for --create-perfmap"
                )
            );
            return command;
        }
