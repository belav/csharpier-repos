...
********/
    ...
    public class MinimumCostCirculation
    {
        ...
        public static Tuple<List<Edge>, long> FindNegativeCycle(CirculationGraph graph)
        {
            ...
            // Decide which edges should even be considered for increasing flow by those with positive Free
            // space.
            ...
            // Return a null cycle if no negative cycles are found; signals that there are no more negative
            // cycles.

            return Tuple.Create<List<Edge>, long>(null, 0);
        }

        // After Bellman-Ford is run and a negative cycle is signalled, find that negative cost cycle by
        // traversing the
        ...
        public static Tuple<List<Edge>, long> FindBellmanFordCycle(Node currentNode)
        {
            ...
            // Now keep traversing up this cycle until a repeat node is found, deriving the edges and min
            // capacity.
