...
namespace TypeSystemTests
{
    public class GenericMethodTests
    {
        ...
        public void TestInstantiation()
        {
            ...
            MethodDesc fooInstantiatedMethod = instantiatedType.GetMethods()
                .First(m => m.Name == "Foo");
        ...
        public void TestMethodAttributes()
        {
            ...
            MethodDesc fooDerivedInstantiatedMethod = derivedGenOfInt.GetMethods()
                .First(m => m.Name == "Foo");
        ...
        public void TestFinalize()
        {
            ...
            MethodDesc finalizeInstantiatedMethod = genOfInt.GetMethods()
