...
namespace TypeSystemTests
{
    public class TypeNameParsingTests
    {
        ...
        {
            {
                TypeDesc result = _testModule.GetTypeByCustomAttributeTypeName(
                    "TypeNameParsing.Simple"
                );
            ...
            {
                TypeDesc result = _testModule.GetTypeByCustomAttributeTypeName(
                    "TypeNameParsing.Simple+Nested+NestedTwice"
                );
            ...
            {
                TypeDesc result = _testModule.GetTypeByCustomAttributeTypeName(
                    "System.Int32, " + _coreAssemblyQualifier
                );
        ...
        public void TestPointerTypes()
        {
            ...
            {
                TypeDesc expected = _context.GetWellKnownType(WellKnownType.Int32)
                    .MakePointerType();
                TypeDesc result = _testModule.GetTypeByCustomAttributeTypeName(
                    "System.Int32*, " + _coreAssemblyQualifier
                );
        ...
        public void TestInstantiatedTypes()
        {
...

            {
                ...
                TypeDesc result = _testModule.GetTypeByCustomAttributeTypeName(
                    "TypeNameParsing.Generic`1[TypeNameParsing.Simple]"
                );
                Assert.Equal(expected, result);
            }

            {
                ...
                TypeDesc result = _testModule.GetTypeByCustomAttributeTypeName(
                    "TypeNameParsing.VeryGeneric`3[TypeNameParsing.Simple,TypeNameParsing.Generic`1[TypeNameParsing.Simple],TypeNameParsing.Struct]"
                );
                Assert.Equal(expected, result);
            }

            {
                TypeDesc expected = _genericType.MakeInstantiatedType(
                    _context.GetWellKnownType(WellKnownType.Object)
                );
                TypeDesc result = _testModule.GetTypeByCustomAttributeTypeName(
                    "TypeNameParsing.Generic`1[[System.Object, " + _coreAssemblyQualifier + "]]"
                );
                Assert.Equal(expected, result);
            }

            {
                ...
                TypeDesc result = _testModule.GetTypeByCustomAttributeTypeName(
                    String.Format(
                        "TypeNameParsing.VeryGeneric`3[[System.Object, {0}],TypeNameParsing.Simple,[System.Int32, {0}]]",
                        _coreAssemblyQualifier
                    )
                );
                Assert.Equal(expected, result);
            }

            {
                ...
                TypeDesc result = _testModule.GetTypeByCustomAttributeTypeName(
                    String.Format(
                        "System.Nullable`1[TypeNameParsing.Struct], {0}",
                        _coreAssemblyQualifier
                    )
                );
                Assert.Equal(expected, result);
            ...
            {
                TypeDesc expected = nullableType.MakeInstantiatedType(
                    _context.GetWellKnownType(WellKnownType.Int32)
                );
                TypeDesc result = _testModule.GetTypeByCustomAttributeTypeName(
                    String.Format(
                        "System.Nullable`1[[System.Int32, {0}]], {0}",
                        _coreAssemblyQualifier
                    )
                );
                Assert.Equal(expected, result);
        ...
        public void TestMixed()
        {
...

            {
                ...
                TypeDesc result = _testModule.GetTypeByCustomAttributeTypeName(
                    "TypeNameParsing.Generic`1[TypeNameParsing.Struct*[]]"
                );
                Assert.Equal(expected, result);
            }
            ...
            {
                TypeDesc expected = _genericType.MakeInstantiatedType(
                    _structType.MakePointerType().MakePointerType().MakeArrayType().MakeArrayType(2)
                );
                TypeDesc result = _testModule.GetTypeByCustomAttributeTypeName(
                    "TypeNameParsing.Generic`1[TypeNameParsing.Struct**[][,]]"
                );
...

            {
                ...
                TypeDesc result = _testModule.GetTypeByCustomAttributeTypeName(
                    String.Format(
                        "TypeNameParsing.Generic`1+NestedNongeneric[[System.Nullable`1[TypeNameParsing.Struct], {0}]]",
                        _coreAssemblyQualifier
                    )
                );
                Assert.Equal(expected, result);
...

            {
                TypeDesc expected = _nestedGenericType.MakeInstantiatedType(
                    nullableType.MakeInstantiatedType(
                        _context.GetWellKnownType(WellKnownType.Int32)
                    ),
                ...
                TypeDesc result = _testModule.GetTypeByCustomAttributeTypeName(
                    String.Format(
                        "TypeNameParsing.Generic`1+NestedGeneric`1[[System.Nullable`1[[System.Int32, {0}]], {0}],TypeNameParsing.Simple+Nested[]]",
                        _coreAssemblyQualifier
                    )
                );
                Assert.Equal(expected, result);
        ...
        public void TestFailureWhenTypeIsMissing()
        {
            ...
            Assert.Null(
                _testModule.GetTypeByCustomAttributeTypeName(
                    "TypeNameParsing.Simple+NestedNotThere+NonNamespaceQualifiedType",
                    throwIfNotFound: false
                )
            );
            Assert.Null(
            ...
            Assert.Null(
                _testModule.GetTypeByCustomAttributeTypeName(
                    "TypeNameParsing.Simple+Nested+NonNamespaceQualifiedType",
                    throwIfNotFound: false
                )
            );
            Assert.Null(
