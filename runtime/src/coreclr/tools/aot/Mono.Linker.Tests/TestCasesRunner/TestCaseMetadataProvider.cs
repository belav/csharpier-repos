    ...
    public class TestCaseMetadataProvider : BaseMetadataProvider
    {
        ...
        public virtual TestCaseLinkerOptions GetLinkerOptions(NPath inputPath)
        {
            var tclo = new TestCaseLinkerOptions
            {
                ...
                KeepTypeForwarderOnlyAssemblies = GetOptionAttributeValue(
                    nameof(KeepTypeForwarderOnlyAssembliesAttribute),
                    string.Empty
                ),
                ...
                IlcFrameworkCompilation = _testCaseTypeDefinition.HasAttribute(
                    nameof(SetupIlcWholeProgramAnalysisAttribute)
                ),
            };
