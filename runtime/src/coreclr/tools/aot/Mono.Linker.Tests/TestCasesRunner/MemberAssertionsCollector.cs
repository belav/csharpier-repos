    ...
    public class MemberAssertionsCollector : IEnumerable<object[]>
    {
        ...
        private CompilerTypeSystemContext CreateTypeSystemContext()
        {
            ...
            typeSystemContext.SetSystemModule(
                typeSystemContext.GetModuleForSimpleName(ILCompilerDriver.DefaultSystemModule)
            );
        ...
        private static void CollectMemberAssertions(
            ...
            List<(TypeSystemEntity, CustomAttribute)> results
        )
        {
        ...
        private static IEnumerable<CustomAttribute> GetCustomAttributes(EcmaType type)
        {
            ...
            return GetCustomAttributes(
                metadataReader.GetTypeDefinition(type.Handle).GetCustomAttributes(),
                metadataReader,
                type.EcmaModule
            );
        }
        ...
        private static IEnumerable<CustomAttribute> GetCustomAttributes(EcmaMethod method)
        {
            ...
            return GetCustomAttributes(
                metadataReader.GetMethodDefinition(method.Handle).GetCustomAttributes(),
                metadataReader,
                method.Module
            );
        }
        ...
        private static IEnumerable<CustomAttribute> GetCustomAttributes(EcmaField field)
        {
            ...
            return GetCustomAttributes(
                metadataReader.GetFieldDefinition(field.Handle).GetCustomAttributes(),
                metadataReader,
                field.Module
            );
        }
        ...
        )
        {
            ...
            {
                if (
                    !metadataReader.GetAttributeTypeAndConstructor(
                        attributeHandle,
