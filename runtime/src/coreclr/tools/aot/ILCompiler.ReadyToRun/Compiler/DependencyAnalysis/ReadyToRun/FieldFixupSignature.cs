...
namespace ILCompiler.DependencyAnalysis.ReadyToRun
{
    public class FieldFixupSignature : Signature
    {
        ...
        )
        {
            ...
            ((CompilerTypeSystemContext)fieldWithToken.Field.Context)
                .EnsureLoadableType(fieldWithToken.Field.OwningType);
        }
        ...
        public override ObjectData GetData(NodeFactory factory, bool relocsOnly = false)
        {
            ...
            if (!relocsOnly)
            {
                ...
                if (_fixupKind == ReadyToRunFixupKind.Verify_FieldOffset)
                {
                    ...
                    if (
                        (_fieldWithToken.Field.OwningType.BaseType != null)
