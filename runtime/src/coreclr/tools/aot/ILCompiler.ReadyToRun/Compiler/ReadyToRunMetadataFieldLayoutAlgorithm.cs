    ...
    internal class ReadyToRunMetadataFieldLayoutAlgorithm : MetadataFieldLayoutAlgorithm
    {
        ...
        )
        {
            if (type.IsExplicitLayout)
            {
                ...
                type.IsEnum || MarshalUtils.IsBlittableType(type) || IsManagedSequentialType(type)
            )
            {
        ...
        protected override bool AlignUpInstanceByteSizeForExplicitFieldLayoutCompatQuirk(
            TypeDesc type
        )
        {
