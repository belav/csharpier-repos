    ...
    static class PEHeaderProvider
    {
        ...
        )
        {
            ...
            imageCharacteristics &= ~(
                Characteristics.Bit32Machine | Characteristics.LargeAddressAware
            );
            imageCharacteristics |= (
            ...
            if (target.IsWindows && is64BitTarget && (imageBase <= uint.MaxValue))
            {
                ...
                imageBase =
                    (imageCharacteristics & Characteristics.Dll) != 0
                        ? PE64HeaderConstants.DllImageBase
                        : PE64HeaderConstants.ExeImageBase;
            }
