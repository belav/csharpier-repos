...
namespace Internal.JitInterface
{
    ...
    unsafe partial class CorInfoImpl
    {
            ...
            switch (id)
            {
                ...
                case CorInfoHelpFunc.CORINFO_HELP_READYTORUN_STATIC_BASE:

                    {
                        ...
                        pLookup = CreateConstLookupToSymbol(
                            _compilation.SymbolNodeFactory.CreateReadyToRunHelper(
                                ReadyToRunHelperId.CctorTrigger,
                                type
                            )
                        );
                    }
        ...
        private void getReadyToRunDelegateCtorHelper(
            ...
            // properly.
            fixed (CORINFO_LOOKUP* tmp = &pLookup)MemoryHelper.FillMemory(
                (byte*)tmp,
                0xcc,
                sizeof(CORINFO_LOOKUP)
            );
#endif
        ...
        private void ceeInfoEmbedGenericHandle(
            ...
            // In debug, write some bogus data to the struct to ensure we have filled everything
            // properly.
            fixed (CORINFO_GENERICHANDLE_RESULT* tmp = &pResult)MemoryHelper.FillMemory(
                (byte*)tmp,
                0xcc,
