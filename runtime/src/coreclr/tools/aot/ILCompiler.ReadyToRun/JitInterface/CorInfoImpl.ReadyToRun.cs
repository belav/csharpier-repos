...
namespace Internal.JitInterface
{
    ...
    public class MethodWithToken
    {
        ...
        )
        {
            ...
            {
                var methodSpecification = moduleToken
                    .MetadataReader
            ...
            {
                var methodDefinition = moduleToken
                    .MetadataReader
    ...
    unsafe partial class CorInfoImpl
    {
            ...
            try
            {
                ...
                )
                {
                    ...
                    if (methodIL != null)
                    {
                        ...
                        {
                            if (
                                MethodBeingCompiled.GetTypicalMethodDefinition()
        ...
        private void updateEntryPointForTailCall(ref CORINFO_CONST_LOOKUP entryPoint)
        {
            ...
            IMethodNode newEntryPoint = _compilation
                .NodeFactory
                .MethodEntrypoint(
                    imp.MethodWithToken,
