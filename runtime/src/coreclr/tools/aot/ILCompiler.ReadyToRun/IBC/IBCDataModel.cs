...
namespace ILCompiler.IBC
{
    ...
    public static class IBCData
    {
        ...
        private static SectionTypeInfo[] ComputeSectionTypeInfos()
        {
            ...
            SectionTypeInfo[] sectionTypeInfo = new SectionTypeInfo[
                (int)SectionFormat.SectionFormatCount
            ];

            tokenType = TokenType.TokenTypeOther;
            sectionTypeInfo[(int)SectionFormat.BasicBlockInfo] = new SectionTypeInfo(
                tokenType,
                SectionFormat.BasicBlockInfo
            );
            sectionTypeInfo[(int)SectionFormat.BlobStream] = new SectionTypeInfo(
                tokenType,
    ...
    public enum SectionFormat : int
    {
        ...
        TypeRefProfilingData =
            CONSTANT.FirstTokenFlagSection + ((int)CorTokenType.mdtTypeRef >> 24),
        TypeProfilingData = CONSTANT.FirstTokenFlagSection + ((int)CorTokenType.mdtTypeDef >> 24),
        FieldDefProfilingData =
            CONSTANT.FirstTokenFlagSection + ((int)CorTokenType.mdtFieldDef >> 24),
        MethodProfilingData =
            CONSTANT.FirstTokenFlagSection + ((int)CorTokenType.mdtMethodDef >> 24),
        ParamDefProfilingData =
            CONSTANT.FirstTokenFlagSection + ((int)CorTokenType.mdtParamDef >> 24),
        InterfaceImplProfilingData =
            CONSTANT.FirstTokenFlagSection + ((int)CorTokenType.mdtInterfaceImpl >> 24),
        MemberRefProfilingData =
            CONSTANT.FirstTokenFlagSection + ((int)CorTokenType.mdtMemberRef >> 24),
        ConstantProfilingData =
            CONSTANT.FirstTokenFlagSection + ((int)CorTokenType.mdtConstant >> 24),
        CustomAttributeProfilingData =
            CONSTANT.FirstTokenFlagSection + ((int)CorTokenType.mdtCustomAttribute >> 24),
        FieldMarshalProfilingData =
            CONSTANT.FirstTokenFlagSection + ((int)CorTokenType.mdtFieldMarshal >> 24),
        PermissionProfilingData =
            CONSTANT.FirstTokenFlagSection + ((int)CorTokenType.mdtPermission >> 24),
        ClassLayoutProfilingData =
            CONSTANT.FirstTokenFlagSection + ((int)CorTokenType.mdtClassLayout >> 24),
        FieldLayoutProfilingData =
            CONSTANT.FirstTokenFlagSection + ((int)CorTokenType.mdtFieldLayout >> 24),
        SignatureProfilingData =
            CONSTANT.FirstTokenFlagSection + ((int)CorTokenType.mdtSignature >> 24),
        EventMapProfilingData =
            CONSTANT.FirstTokenFlagSection + ((int)CorTokenType.mdtEventMap >> 24),
        EventProfilingData = CONSTANT.FirstTokenFlagSection + ((int)CorTokenType.mdtEvent >> 24),
        PropertyMapProfilingData =
            CONSTANT.FirstTokenFlagSection + ((int)CorTokenType.mdtPropertyMap >> 24),
        PropertyProfilingData =
            CONSTANT.FirstTokenFlagSection + ((int)CorTokenType.mdtProperty >> 24),
        MethodSemanticsProfilingData =
            CONSTANT.FirstTokenFlagSection + ((int)CorTokenType.mdtMethodSemantics >> 24),
        MethodImplProfilingData =
            CONSTANT.FirstTokenFlagSection + ((int)CorTokenType.mdtMethodImpl >> 24),
        ModuleRefProfilingData =
            CONSTANT.FirstTokenFlagSection + ((int)CorTokenType.mdtModuleRef >> 24),
        TypeSpecProfilingData =
            CONSTANT.FirstTokenFlagSection + ((int)CorTokenType.mdtTypeSpec >> 24),
        ImplMapProfilingData =
            CONSTANT.FirstTokenFlagSection + ((int)CorTokenType.mdtImplMap >> 24),
        FieldRVAProfilingData =
            CONSTANT.FirstTokenFlagSection + ((int)CorTokenType.mdtFieldRVA >> 24),
        AssemblyProfilingData =
            CONSTANT.FirstTokenFlagSection + ((int)CorTokenType.mdtAssembly >> 24),
        AssemblyRefProfilingData =
            CONSTANT.FirstTokenFlagSection + ((int)CorTokenType.mdtAssemblyRef >> 24),
        FileProfilingData = CONSTANT.FirstTokenFlagSection + ((int)CorTokenType.mdtFile >> 24),
        ExportedTypeProfilingData =
            CONSTANT.FirstTokenFlagSection + ((int)CorTokenType.mdtExportedType >> 24),
        ManifestResourceProfilingData =
            CONSTANT.FirstTokenFlagSection + ((int)CorTokenType.mdtManifestResource >> 24),
        NestedClassProfilingData =
            CONSTANT.FirstTokenFlagSection + ((int)CorTokenType.mdtNestedClass >> 24),
        GenericParamProfilingData =
            CONSTANT.FirstTokenFlagSection + ((int)CorTokenType.mdtGenericParam >> 24),
        MethodSpecProfilingData =
            CONSTANT.FirstTokenFlagSection + ((int)CorTokenType.mdtMethodSpec >> 24),
        GenericParamConstraintProfilingData =
            CONSTANT.FirstTokenFlagSection + ((int)CorTokenType.mdtGenericParamConstraint >> 24),
