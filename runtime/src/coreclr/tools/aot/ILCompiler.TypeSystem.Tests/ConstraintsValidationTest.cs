...
namespace TypeSystemTests
{
    public class ConstraintsValidationTest
    {
        ...
        public ConstraintsValidationTest()
        {
            ...
            _structArgWithDefaultCtorType = _testModule.GetType(
                "GenericConstraints",
                "StructArgWithDefaultCtor"
            );
            _structArgWithoutDefaultCtorType = _testModule.GetType(
                "GenericConstraints",
                "StructArgWithoutDefaultCtor"
            );
            _classArgWithDefaultCtorType = _testModule.GetType(
                "GenericConstraints",
                "ClassArgWithDefaultCtor"
            );
            _classArgWithPrivateDefaultCtorType = _testModule.GetType(
                "GenericConstraints",
                "ClassArgWithPrivateDefaultCtor"
            );
            _abstractClassArgWithDefaultCtorType = _testModule.GetType(
                "GenericConstraints",
                "AbstractClassArgWithDefaultCtor"
            );
            _classArgWithoutDefaultCtorType = _testModule.GetType(
                "GenericConstraints",
                "ClassArgWithoutDefaultCtor"
            );

            _referenceTypeConstraintType = _testModule.GetType(
                "GenericConstraints",
                "ReferenceTypeConstraint`1"
            );
            _defaultConstructorConstraintType = _testModule.GetType(
                "GenericConstraints",
                "DefaultConstructorConstraint`1"
            );
            _notNullableValueTypeConstraintType = _testModule.GetType(
                "GenericConstraints",
                "NotNullableValueTypeConstraint`1"
            );
            _simpleTypeConstraintType = _testModule.GetType(
                "GenericConstraints",
                "SimpleTypeConstraint`1"
            );
            _doubleSimpleTypeConstraintType = _testModule.GetType(
                "GenericConstraints",
                "DoubleSimpleTypeConstraint`1"
            );
            _simpleGenericConstraintType = _testModule.GetType(
                "GenericConstraints",
                "SimpleGenericConstraint`2"
            );
            _complexGenericConstraint1Type = _testModule.GetType(
                "GenericConstraints",
                "ComplexGenericConstraint1`2"
            );
            _complexGenericConstraint2Type = _testModule.GetType(
                "GenericConstraints",
                "ComplexGenericConstraint2`2"
            );
            _complexGenericConstraint3Type = _testModule.GetType(
                "GenericConstraints",
                "ComplexGenericConstraint3`2"
            );
            _complexGenericConstraint4Type = _testModule.GetType(
                "GenericConstraints",
                "ComplexGenericConstraint4`2"
            );
            _multipleConstraintsType = _testModule.GetType(
                "GenericConstraints",
                "MultipleConstraints`2"
            );

            _genericMethodsType = _testModule.GetType("GenericConstraints", "GenericMethods");
            _simpleGenericConstraintMethod = _genericMethodsType.GetMethod(
                "SimpleGenericConstraintMethod",
                null
            );
            _complexGenericConstraintMethod = _genericMethodsType.GetMethod(
                "ComplexGenericConstraintMethod",
                null
            );
        }
        ...
        public void TestTypeConstraints()
        {
            ...
            MetadataType arg2OfInt = _arg2Type.MakeInstantiatedType(
                _context.GetWellKnownType(WellKnownType.Int32)
            );
            MetadataType arg2OfBool = _arg2Type.MakeInstantiatedType(
                _context.GetWellKnownType(WellKnownType.Boolean)
            );
            MetadataType arg2OfObject = _arg2Type.MakeInstantiatedType(
            ...
            {
                instantiatedType = _referenceTypeConstraintType.MakeInstantiatedType(
                    _referenceTypeConstraintType.Instantiation[0]
                );
                Assert.True(instantiatedType.CheckConstraints());

                instantiatedType = _defaultConstructorConstraintType.MakeInstantiatedType(
                    _defaultConstructorConstraintType.Instantiation[0]
                );
                Assert.True(instantiatedType.CheckConstraints());

                instantiatedType = _notNullableValueTypeConstraintType.MakeInstantiatedType(
                    _notNullableValueTypeConstraintType.Instantiation[0]
                );
                Assert.True(instantiatedType.CheckConstraints());
                ...
                instantiatedType = _referenceTypeConstraintType.MakeInstantiatedType(
                    _simpleTypeConstraintType.Instantiation[0]
                );
                Assert.True(instantiatedType.CheckConstraints());
            ...
            foreach (
                var genType in new MetadataType[]
                {
            ...
            {
                instantiatedType = _simpleGenericConstraintType.MakeInstantiatedType(
                    _arg1Type,
                    _arg1Type
                );
                Assert.True(instantiatedType.CheckConstraints());
                ...
                instantiatedType = _simpleGenericConstraintType.MakeInstantiatedType(
                    _structArgWithDefaultCtorType,
                    _context.GetWellKnownType(WellKnownType.ValueType)
                );
                Assert.True(instantiatedType.CheckConstraints());
                ...
                instantiatedType = _simpleGenericConstraintType.MakeInstantiatedType(
                    _context.GetWellKnownType(WellKnownType.UInt16),
                    _context.GetWellKnownType(WellKnownType.UInt32)
                );
                Assert.False(instantiatedType.CheckConstraints());
            ...
            {
                instantiatedType = _complexGenericConstraint1Type.MakeInstantiatedType(
                    _arg1Type,
                    _arg1Type /* uninteresting */
                );
                Assert.False(instantiatedType.CheckConstraints());
            ...
            // ComplexGenericConstraint2
            {
                ...
                instantiatedType = _complexGenericConstraint2Type.MakeInstantiatedType(
                    _arg1Type,
                    _context.GetWellKnownType(WellKnownType.Int32)
                );
                Assert.False(instantiatedType.CheckConstraints());
            ...
            {
                MetadataType igenOfObject = _iGenType.MakeInstantiatedType(
                    _context.GetWellKnownType(WellKnownType.Object)
                );

                instantiatedType = _complexGenericConstraint3Type.MakeInstantiatedType(
                    igenOfObject,
                    _context.GetWellKnownType(WellKnownType.Object)
                );
                Assert.True(instantiatedType.CheckConstraints());
                ...
                instantiatedType = _complexGenericConstraint3Type.MakeInstantiatedType(
                    igenOfObject,
                    _context.GetWellKnownType(WellKnownType.String)
                );
                Assert.True(instantiatedType.CheckConstraints());

                // Type that implements the interface
                var arg3OfObject = _arg3Type.MakeInstantiatedType(
                    _context.GetWellKnownType(WellKnownType.Object)
                );
                instantiatedType = _complexGenericConstraint3Type.MakeInstantiatedType(
                    arg3OfObject,
            ...
            // Constraints requiring InstantiationContext
            {
                ...
                instantiatedType = _complexGenericConstraint3Type.MakeInstantiatedType(
                    _complexGenericConstraint3Type.Instantiation[0],
                    _complexGenericConstraint3Type.Instantiation[1]
                );
                Assert.True(
                    instantiatedType.CheckConstraints(
                ...
                instantiatedType = _complexGenericConstraint4Type.MakeInstantiatedType(
                    _complexGenericConstraint4Type.Instantiation[0],
                    _complexGenericConstraint4Type.Instantiation[1]
                );
                Assert.True(
                    instantiatedType.CheckConstraints(
                        new InstantiationContext(
                ...
                instantiatedMethod = _simpleGenericConstraintMethod.MakeInstantiatedMethod(
                    _simpleGenericConstraintMethod.Instantiation
                );
                Assert.True(
                    instantiatedMethod.CheckConstraints(
                        new InstantiationContext(
                            default(Instantiation),
                            instantiatedMethod.Instantiation
                        )
                    )
                );

                instantiatedMethod = _complexGenericConstraintMethod.MakeInstantiatedMethod(
                    _complexGenericConstraintMethod.Instantiation
                );
                Assert.True(
                    instantiatedMethod.CheckConstraints(
                        new InstantiationContext(
                ...
                instantiatedMethod = _simpleGenericConstraintMethod.MakeInstantiatedMethod(
                    _simpleGenericConstraintType.Instantiation
                );
                Assert.True(
                    instantiatedMethod.CheckConstraints(
                        new InstantiationContext(
                ...
                instantiatedMethod = _complexGenericConstraintMethod.MakeInstantiatedMethod(
                    _complexGenericConstraint4Type.Instantiation
                );
                Assert.True(
                    instantiatedMethod.CheckConstraints(
                        new InstantiationContext(
            ...
            // MultipleConstraints
            {
                ...
                instantiatedType = _multipleConstraintsType.MakeInstantiatedType(
                    _structArgWithDefaultCtorType,
                    _context.GetWellKnownType(WellKnownType.Object)
                );
                Assert.False(instantiatedType.CheckConstraints());
            ...
            // InvalidInstantiationArgs
            {
                ...
                instantiatedType = _iGenType.MakeInstantiatedType(
                    _context.GetWellKnownType(WellKnownType.Void)
                );
