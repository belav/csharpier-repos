...
namespace VirtualFunctionOverride
{
    ...
    unsafe class FunctionPointerOverloadBase
    {
        ...
        public virtual Type Method(delegate* unmanaged[Cdecl]<void> p) =>
            typeof(delegate* unmanaged[Cdecl]<void>);

        public virtual Type Method(delegate* unmanaged[Stdcall]<void> p) =>
            typeof(delegate* unmanaged[Stdcall]<void>);

        public virtual Type Method(delegate* unmanaged[Stdcall, SuppressGCTransition]<void> p) =>
            typeof(delegate* unmanaged[Stdcall, SuppressGCTransition]<void>);
    ...
    unsafe class FunctionPointerOverloadDerived : FunctionPointerOverloadBase
    {
        ...
        public override Type Method(delegate* unmanaged[Stdcall, SuppressGCTransition]<void> p) =>
            null;
