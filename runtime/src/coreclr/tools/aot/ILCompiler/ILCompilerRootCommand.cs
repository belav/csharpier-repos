    ...
    internal sealed class ILCompilerRootCommand : CliRootCommand
    {
        ...
        public CliOption<Dictionary<string, string>> ReferenceFiles { get; } =
            new("--reference", "-r")
            {
                ...
                Description = "Reference file(s) for compilation",
            };
        ...
        public CliOption<bool> OptimizeSpace { get; } =
            new("--optimize-space", "--Os")
            {
                Description = "Enable optimizations, favor code space",
            };
        public CliOption<bool> OptimizeTime { get; } =
            new("--optimize-time", "--Ot")
            {
                Description = "Enable optimizations, favor code speed",
            };
        public CliOption<string[]> MibcFilePaths { get; } =
            new("--mibc", "-m")
            {
                DefaultValueFactory = _ => Array.Empty<string>(),
                Description = "Mibc file(s) for profile guided optimization",
            };
        public CliOption<string[]> SatelliteFilePaths { get; } =
            new("--satellite")
            {
                DefaultValueFactory = _ => Array.Empty<string>(),
                Description = "Satellite assemblies associated with inputs/references",
            };
        ...
        public CliOption<bool> SplitExeInitialization { get; } =
            ...
            {
                Description =
                    "Split initialization of an executable between the library entrypoint and a main entrypoint",
            };
        ...
        public CliOption<string> ScanDgmlLogFileName { get; } =
            new("--scandgmllog")
            {
                Description = "Save result of scanner dependency analysis as DGML",
            };
        public CliOption<bool> GenerateFullScanDgmlLog { get; } =
            new("--scanfulllog")
            {
                Description = "Save detailed log of scanner dependency analysis",
            };
        ...
        public CliOption<string> SystemModuleName { get; } =
            new("--systemmodule")
            {
                ...
                Description = "System module name (default: System.Private.CoreLib)",
            };
        public CliOption<string> Win32ResourceModuleName { get; } =
            new("--win32resourcemodule")
            {
                Description =
                    "Name of the module from which to copy Win32 resources (Windows target only)",
            };
        public CliOption<bool> MultiFile { get; } =
            new("--multifile")
            {
                Description = "Compile only input files (do not compile referenced assemblies)",
            };
        public CliOption<bool> WaitForDebugger { get; } =
            new("--waitfordebugger")
            {
                Description = "Pause to give opportunity to attach debugger",
            };
        public CliOption<bool> Resilient { get; } =
            new("--resilient")
            {
                Description = "Ignore unresolved types, methods, and assemblies. Defaults to false",
            };
        public CliOption<string[]> CodegenOptions { get; } =
            new("--codegenopt")
            {
                DefaultValueFactory = _ => Array.Empty<string>(),
                Description = "Define a codegen option",
            };
        public CliOption<string[]> RdXmlFilePaths { get; } =
            new("--rdxml")
            {
                DefaultValueFactory = _ => Array.Empty<string>(),
                Description = "RD.XML file(s) for compilation",
            };
        public CliOption<string[]> LinkTrimFilePaths { get; } =
            new("--descriptor")
            {
                DefaultValueFactory = _ => Array.Empty<string>(),
                Description = "ILLink.Descriptor file(s) for compilation",
            };
        public CliOption<string[]> SubstitutionFilePaths { get; } =
            new("--substitution")
            {
                DefaultValueFactory = _ => Array.Empty<string>(),
                Description = "ILLink.Substitution file(s) for compilation",
            };
        ...
        public CliOption<string> ReflectionData { get; } =
            new("--reflectiondata")
            {
                Description = "Reflection data to generate (one of: all, none)",
            };
        ...
        public CliOption<bool> UseScanner { get; } =
            new("--scan")
            {
                Description = "Use IL scanner to generate optimized code (implied by -O)",
            };
        ...
        public CliOption<bool> EmitStackTraceData { get; } =
            new("--stacktracedata")
            {
                Description = "Emit data to support generating stack trace strings at runtime",
            };
        ...
        public CliOption<string[]> InitAssemblies { get; } =
            ...
            {
                DefaultValueFactory = _ => Array.Empty<string>(),
                Description = "Assembly(ies) with a library initializer",
            };
        public CliOption<string[]> FeatureSwitches { get; } =
            new("--feature")
            {
                DefaultValueFactory = _ => Array.Empty<string>(),
                Description = "Feature switches to apply (format: 'Namespace.Name=[true|false]'",
            };
        public CliOption<string[]> RuntimeOptions { get; } =
            new("--runtimeopt")
            {
                DefaultValueFactory = _ => Array.Empty<string>(),
                Description = "Runtime options to set",
            };
        public CliOption<string[]> RuntimeKnobs { get; } =
            new("--runtimeknob")
            {
                DefaultValueFactory = _ => Array.Empty<string>(),
                Description = "Runtime knobs to set",
            };
        public CliOption<int> Parallelism { get; } =
            new("--parallelism")
            {
                ...
                Description = "Maximum number of threads to use during compilation",
            };
        ...
        public CliOption<int> MaxVectorTBitWidth { get; } =
            new("--max-vectort-bitwidth")
            {
                Description = "Maximum width, in bits, that Vector<T> is allowed to be",
            };
        ...
        public CliOption<bool> NoPreinitStatics { get; } =
            ...
            {
                Description = "Do not interpret static constructors at compile time",
            };
        ...
        public CliOption<bool> SingleWarn { get; } =
            new("--singlewarn")
            {
                Description = "Generate single AOT/trimming warning per assembly",
            };
        ...
        public CliOption<string[]> SingleWarnEnabledAssemblies { get; } =
            ...
            {
                DefaultValueFactory = _ => Array.Empty<string>(),
                Description = "Generate single AOT/trimming warning for given assembly",
            };
        public CliOption<string[]> SingleWarnDisabledAssemblies { get; } =
            new("--nosinglewarnassembly")
            {
                DefaultValueFactory = _ => Array.Empty<string>(),
                Description = "Expand AOT/trimming warnings for given assembly",
            };
        public CliOption<string[]> DirectPInvokes { get; } =
            new("--directpinvoke")
            {
                DefaultValueFactory = _ => Array.Empty<string>(),
                Description = "PInvoke to call directly",
            };
        public CliOption<string[]> DirectPInvokeLists { get; } =
            new("--directpinvokelist")
            {
                DefaultValueFactory = _ => Array.Empty<string>(),
                Description = "File with list of PInvokes to call directly",
            };
        public CliOption<string[]> RootedAssemblies { get; } =
            new("--root")
            {
                DefaultValueFactory = _ => Array.Empty<string>(),
                Description = "Fully generate given assembly",
            };
        public CliOption<string[]> ConditionallyRootedAssemblies { get; } =
            new("--conditionalroot")
            {
                DefaultValueFactory = _ => Array.Empty<string>(),
                Description = "Fully generate given assembly if it's used",
            };
        public CliOption<string[]> TrimmedAssemblies { get; } =
            new("--trim")
            {
                DefaultValueFactory = _ => Array.Empty<string>(),
                Description = "Trim the specified assembly",
            };
        public CliOption<bool> RootDefaultAssemblies { get; } =
            new("--defaultrooting")
            {
                Description = "Root assemblies that are not marked [IsTrimmable]",
            };
        ...
        public CliOption<string> SingleMethodName { get; } =
            new("--singlemethodname")
            {
                Description = "Single method compilation: name of the method",
            };
        public CliOption<int> MaxGenericCycleDepth { get; } =
            new("--maxgenericcycle")
            {
                DefaultValueFactory = _ => CompilerTypeSystemContext.DefaultGenericCycleDepthCutoff,
        ...
        public CliOption<int> MaxGenericCycleBreadth { get; } =
            new("--maxgenericcyclebreadth")
            {
                DefaultValueFactory = _ =>
                    CompilerTypeSystemContext.DefaultGenericCycleBreadthCutoff,
        ...
        public CliOption<string[]> SingleMethodGenericArgs { get; } =
            ...
            {
                Description = "Single method compilation: generic arguments to the method",
            };
        ...
        public CliOption<string[]> UnmanagedEntryPointsAssemblies { get; } =
            ...
            {
                DefaultValueFactory = _ => Array.Empty<string>(),
                Description = "Generate unmanaged entrypoints for a given assembly",
            };
