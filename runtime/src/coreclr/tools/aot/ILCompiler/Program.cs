    ...
    internal class Program
    {
        ...
        private ArgumentSyntax ParseCommandLine(string[] args)
        {
            ...
            ArgumentSyntax argSyntax = ArgumentSyntax.Parse(
                ...
                syntax =>
                {
                    ...
                    syntax.DefineOption(
                        "Os",
                        ref optimizeSpace,
                        "Enable optimizations, favor code space"
                    );
                    syntax.DefineOption(
                        "Ot",
                        ref optimizeTime,
                        "Enable optimizations, favor code speed"
                    );
                    syntax.DefineOptionList(
                        "m|mibc",
                        ref _mibcFilePaths,
                    ...
                    syntax.DefineOption(
                        "dgmllog",
                        ref _dgmlLogFileName,
                        "Save result of dependency analysis as DGML"
                    );
                    syntax.DefineOption(
                        "fulllog",
                        ref _generateFullDgmlLog,
                        "Save detailed log of dependency analysis"
                    );
                    syntax.DefineOption(
                        "scandgmllog",
                        ref _scanDgmlLogFileName,
                        "Save result of scanner dependency analysis as DGML"
                    );
                    syntax.DefineOption(
                        "scanfulllog",
                        ref _generateFullScanDgmlLog,
                        "Save detailed log of scanner dependency analysis"
                    );
                    syntax.DefineOption("verbose", ref _isVerbose, "Enable verbose logging");
                    syntax.DefineOption(
                        "systemmodule",
                        ref _systemModuleName,
                    ...
                    syntax.DefineOption(
                        "waitfordebugger",
                        ref waitForDebugger,
                        "Pause to give opportunity to attach debugger"
                    );
                    syntax.DefineOption(
                        "resilient",
                        ref _resilient,
                    ...
                    syntax.DefineOptionList(
                        "codegenopt",
                        ref _codegenOptions,
                        "Define a codegen option"
                    );
                    syntax.DefineOptionList(
                        "rdxml",
                        ref _rdXmlFilePaths,
                        "RD.XML file(s) for compilation"
                    );
                    syntax.DefineOption("map", ref _mapFileName, "Generate a map file");
                    syntax.DefineOption(
                        "metadatalog",
                        ref _metadataLogFileName,
                        "Generate a metadata log file"
                    );
                    syntax.DefineOption(
                        "nometadatablocking",
                    ...
                    syntax.DefineOption(
                        "disablereflection",
                        ref _disableReflection,
                        "Disable generation of reflection metadata"
                    );
                    syntax.DefineOption(
                        "completetypemetadata",
                        ref _completeTypesMetadata,
                        "Generate complete metadata for types"
                    );
                    syntax.DefineOption(
                        "reflectedonly",
                        ref _reflectedOnly,
                        "Generate metadata only for reflected members"
                    );
                    syntax.DefineOption(
                        "scanreflection",
                        ref _scanReflection,
                    ...
                    syntax.DefineOption(
                        "scan",
                        ref _useScanner,
                        "Use IL scanner to generate optimized code (implied by -O)"
                    );
                    syntax.DefineOption(
                        "noscan",
                        ref _noScanner,
                        "Do not use IL scanner to generate optimized code"
                    );
                    syntax.DefineOption(
                        "ildump",
                        ref _ilDump,
                        "Dump IL assembly listing for compiler-generated IL"
                    );
                    syntax.DefineOption(
                        "stacktracedata",
                        ref _emitStackTraceData,
                        "Emit data to support generating stack trace strings at runtime"
                    );
                    syntax.DefineOption(
                        "methodbodyfolding",
                        ref _methodBodyFolding,
                        "Fold identical method bodies"
                    );
                    syntax.DefineOptionList(
                        "initassembly",
                        ref _initAssemblies,
                    ...
                    syntax.DefineOption(
                        "instructionset",
                        ref _instructionSet,
                        "Instruction set to allow or disallow"
                    );
                    syntax.DefineOption(
                        "guard",
                        ref _guard,
                    ...
                    syntax.DefineOption(
                        "nopreinitstatics",
                        ref _noPreinitStatics,
                        "Do not interpret static constructors at compile time"
                    );
                    syntax.DefineOptionList(
                        "nowarn",
                        ref _suppressedWarnings,
                        "Disable specific warning messages"
                    );
                    syntax.DefineOption(
                        "singlewarn",
                        ref _singleWarn,
                        "Generate single AOT/trimming warning per assembly"
                    );
                    syntax.DefineOptionList(
                        "singlewarnassembly",
                        ref _singleWarnEnabledAssemblies,
                        "Generate single AOT/trimming warning for given assembly"
                    );
                    syntax.DefineOptionList(
                        "nosinglewarnassembly",
                        ref _singleWarnDisabledAssemblies,
                        "Expand AOT/trimming warnings for given assembly"
                    );
                    syntax.DefineOptionList(
                        "directpinvoke",
                        ref _directPInvokes,
                        "PInvoke to call directly"
                    );
                    syntax.DefineOptionList(
                        "directpinvokelist",
                    ...
                    syntax.DefineOption(
                        "maxgenericcycle",
                        ref _maxGenericCycle,
                        "Max depth of generic cycle"
                    );
                    syntax.DefineOptionList(
                        "root",
                        ref _rootedAssemblies,
                        "Fully generate given assembly"
                    );
                    syntax.DefineOptionList(
                        "conditionalroot",
                        ref _conditionallyRootedAssemblies,
                        "Fully generate given assembly if it's used"
                    );
                    syntax.DefineOptionList(
                        "trim",
                        ref _trimmedAssemblies,
                        "Trim the specified assembly"
                    );
                    syntax.DefineOption(
                        "defaultrooting",
                        ref _rootDefaultAssemblies,
                        "Root assemblies that are not marked [IsTrimmable]"
                    );

                    syntax.DefineOption(
                        "targetarch",
                        ref _targetArchitectureStr,
                    ...
                    syntax.DefineOption(
                        ...
                        ref _singleMethodTypeName,
                        "Single method compilation: assembly-qualified name of the owning type"
                    );
                    syntax.DefineOption(
                        "singlemethodname",
                        ref _singleMethodName,
                        "Single method compilation: name of the method"
                    );
                    syntax.DefineOptionList(
                        "singlemethodgenericarg",
                        ref _singleMethodGenericArgs,
                    ...
                    syntax.DefineOption(
                        "make-repro-path",
                        ref _makeReproPath,
                        "Path where to place a repro package"
                    );
            ...
            if (_help)
            {
                ...
                Program.ComputeDefaultOptions(
                    out TargetOS defaultOs,
                    out TargetArchitecture defaultArch
                );
            ...
            if (_makeReproPath != null)
            {
                ...
                Helpers.MakeReproPackage(
                    ...
                    args,
                    argSyntax,
                    new[] { "-r", "-m", "--rdxml", "--directpinvokelist" }
                );
            }
        ...
        private int Run(string[] args)
        {
                    ...
                    if (enabled)
                    {
                        if (
                            ...
                            throw new CommandLineException(
                                $"Unrecognized instruction set '{instructionSet}'"
                            );
                    }
                    else
                    {
            ...
            var instructionSetSupport = new InstructionSetSupport(
            ...
            bool supportsReflection =
                !_disableReflection && _systemModuleName == DefaultSystemModule;
            ...
            if (
                !typeSystemContext.InputFilePaths.ContainsKey(_systemModuleName)
                && !typeSystemContext.ReferenceFilePaths.ContainsKey(_systemModuleName)
            )
                throw new CommandLineException(
                    $"System module {_systemModuleName} does not exists. Make sure that you specify --systemmodule"
                );

            typeSystemContext.SetSystemModule(
                typeSystemContext.GetModuleForSimpleName(_systemModuleName)
            );
            ...
            _conditionallyRootedAssemblies = new List<string>(
                _conditionallyRootedAssemblies.Select(a => ILLinkify(a))
            );
            ...
            string compilationUnitPrefix = _multiFile
                ? System.IO.Path.GetFileNameWithoutExtension(_outputFilePath)
                : "";
            ...
            var logger = new Logger(
                Console.Out,
                _isVerbose,
                ProcessWarningCodes(_suppressedWarnings),
                _singleWarn,
                _singleWarnEnabledAssemblies,
                _singleWarnDisabledAssemblies
            );
            ...
            if (supportsReflection)
            {
                ...
                if (_reflectedOnly)
                    metadataGenerationOptions |=
                        UsageBasedMetadataGenerationOptions.ReflectedMembersOnly;
            ...
            bool useScanner =
                _useScanner || (_optimizationMode != OptimizationMode.None && !_multiFile);

            useScanner &= !_noScanner;

            // Enable static data preinitialization in optimized builds.
            bool preinitStatics =
                _preinitStatics || (_optimizationMode != OptimizationMode.None && !_multiFile);
            ...
            DependencyTrackingLevel trackingLevel =
                _dgmlLogFileName == null
                    ? DependencyTrackingLevel.None
                    : (
                        _generateFullDgmlLog
                            ? DependencyTrackingLevel.All
                            : DependencyTrackingLevel.First
                    );
            ...
            if (scanResults != null)
            {
                ...
                DiffCompilationResults(
                    ...
                    scanResults.CompiledMethodBodies,
                    "Methods",
                    "compiled",
                    "scanned",
                    method =>
                ...
                DiffCompilationResults(
                    ...
                    scanResults.ConstructedEETypes,
                    "EETypes",
                    "compiled",
                    "scanned",
        ...
        private void DiffCompilationResults<T>(
            ref bool result,
            IEnumerable<T> set1,
            IEnumerable<T> set2,
            string prefix,
        ...
        {
            if (
                _singleMethodName == null
                && _singleMethodTypeName == null
                && _singleMethodGenericArgs == null
            )
                return null;
            ...
            if (method == null)
                throw new CommandLineException(
                    $"Method '{_singleMethodName}' not found in '{_singleMethodTypeName}'"
                );

            if (
                method.HasInstantiation != (_singleMethodGenericArgs != null)
                || (
                    method.HasInstantiation
                    && (method.Instantiation.Length != _singleMethodGenericArgs.Count)
                )
            )
            {
                throw new CommandLineException(
            ...
            foreach (string value in warningCodes)
            {
                ...
                foreach (string id in values)
                {
                    if (
                        ...
                        || !ushort.TryParse(id.Substring(2), out ushort code)
                    )
                        continue;
