...
namespace ILLink.Shared
{
    ...
    internal static class Annotations
    {
        ...
        private static readonly DynamicallyAccessedMemberTypes[] AllDynamicallyAccessedMemberTypes =
        ...
        public static (DiagnosticId Id, string[] Arguments) GetDiagnosticForAnnotationMismatch(
            ValueWithDynamicallyAccessedMembers source,
            ValueWithDynamicallyAccessedMembers target,
            string missingAnnotations
        )
        {
            DiagnosticId diagnosticId = (source, target) switch
            {
                ...
                (MethodParameterValue, MethodThisParameterValue)
                ...
                (MethodReturnValue, MethodThisParameterValue)
                ...
                (FieldValue, MethodThisParameterValue)
                ...
                (GenericParameterValue, MethodThisParameterValue)
                ...
                (NullableValueWithDynamicallyAccessedMembers, FieldValue)
                    => DiagnosticId.DynamicallyAccessedMembersMismatchTypeArgumentTargetsField,
                (NullableValueWithDynamicallyAccessedMembers, MethodThisParameterValue)
                    => DiagnosticId.DynamicallyAccessedMembersMismatchTypeArgumentTargetsThisParameter,
                ...
                _
                    => throw new NotImplementedException(
                        $"Unsupported source context {source} or target context {target}."
                    )
            };
