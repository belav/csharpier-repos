    ...
    internal static class Intrinsics
    {
        public static IntrinsicId GetIntrinsicIdForMethod(MethodProxy calledMethod)
        {
            return calledMethod.Name switch
            {
                ...
                "GetTypeInfo"
                    when calledMethod.IsDeclaredOnType("System.Reflection.IntrospectionExtensions")
                ...
                "get_MethodHandle"
                    when calledMethod.IsDeclaredOnType("System.Reflection.MethodBase")
                    => IntrinsicId.MethodBase_get_MethodHandle,
                ...
                "Property"
                    when calledMethod.IsDeclaredOnType("System.Linq.Expressions.Expression")
                        && (
                            ...
                            || (
                                calledMethod.HasParameterOfType(1, "System.Reflection.MethodInfo")
                ...
                "GetValues"
                    when calledMethod.IsDeclaredOnType("System.Enum")
                        && calledMethod.HasParameterOfType(0, "System.Type")
                        && calledMethod.HasParametersCount(1)
                ...
                "SizeOf"
                    when calledMethod.IsDeclaredOnType("System.Runtime.InteropServices.Marshal")
                        && calledMethod.HasParameterOfType(0, "System.Type")
                        && calledMethod.HasParametersCount(1)
                ...
                "GetConstructor"
                    when calledMethod.IsDeclaredOnType("System.Type") && !calledMethod.IsStatic()
                ...
                "GetUnderlyingType"
                    when calledMethod.IsDeclaredOnType("System.Nullable")
                        && calledMethod.HasParameterOfType(0, "System.Type")
                        && calledMethod.IsStatic()
