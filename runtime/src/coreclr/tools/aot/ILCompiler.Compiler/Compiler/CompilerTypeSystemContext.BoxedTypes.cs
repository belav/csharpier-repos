...
namespace ILCompiler
{
    ...
    partial class CompilerTypeSystemContext
    {
        ...
        )
        {
            ...
            var methodKey = new UnboxingThunkHashtableKey(
                targetMethodDefinition,
                boxedTypeDefinition
            );
            GenericUnboxingThunk thunkDefinition = _unboxingThunkHashtable.GetOrCreateValue(
                methodKey
            );

            // Find the thunk on the instantiated version of the reference type.
            Debug.Assert(owningType != owningTypeDefinition);
            InstantiatedType boxedType = boxedTypeDefinition.MakeInstantiatedType(
        ...
        public MethodDesc GetUnboxingThunk(MethodDesc targetMethod, ModuleDesc ownerModuleOfThunk)
        {
            ...
            UnboxingThunk thunkDefinition = _nonGenericUnboxingThunkHashtable.GetOrCreateValue(
                methodKey
            );
        ...
        public bool IsSpecialUnboxingThunkTargetMethod(MethodDesc method)
        {
            return method.GetTypicalMethodDefinition().GetType()
                == typeof(ValueTypeInstanceMethodWithHiddenParameter);
        }
        ...
        private class BoxedValuetypeHashtable
            : LockFreeReaderHashtable<BoxedValuetypeHashtableKey, BoxedValueType>
        {
            ...
            protected override bool CompareValueToValue(
                BoxedValueType value1,
                BoxedValueType value2
            )
            {
                return Object.ReferenceEquals(
                        value1.ValueTypeRepresented,
                        value2.ValueTypeRepresented
        ...
        private class UnboxingThunkHashtable
            : LockFreeReaderHashtable<UnboxingThunkHashtableKey, GenericUnboxingThunk>
        {
            ...
            protected override bool CompareValueToValue(
                GenericUnboxingThunk value1,
                GenericUnboxingThunk value2
            )
            {
        ...
        private class NonGenericUnboxingThunkHashtable
        ...
        private partial class BoxedValueType : MetadataType, INonEmittableType
        {
            ...
            public override int GetHashCode()
            {
                string ns = Namespace;
                var hashCodeBuilder =
                    new Internal.NativeFormat.TypeHashingAlgorithms.HashCodeBuilder(ns);
                if (ns.Length > 0)
        ...
        public MethodDesc GetTargetOfSpecialUnboxingThunk(MethodDesc method)
        {
            ...
            {
                InstantiatedType instantiatedType = GetInstantiatedType(
                    (MetadataType)typicalMethodTarget.OwningType,
                    method.OwningType.Instantiation
                );
                methodOnInstantiatedType = GetMethodForInstantiatedType(
                    typicalMethodTarget,
                    instantiatedType
                );
            }
            ...
            {
                instantiatedMethod = GetInstantiatedMethod(
        ...
        private partial class GenericUnboxingThunk : ILStubMethod
        {
            ...
            {
                get { return _targetMethod.Name + "_Unbox"; }
            }

            public override string DiagnosticName
            {
                get { return _targetMethod.DiagnosticName + "_Unbox"; }
            }
            ...
            public override MethodIL EmitIL()
            {
                ...
                codeStream.Emit(
                    ILOpcode.call,
                    emit.NewToken(_nakedTargetMethod.InstantiateAsOpen())
                );
        ...
        private partial class UnboxingThunk : ILStubMethod
        {
            ...
            public override MethodIL EmitIL()
            {
                ...
                if (methodToInstantiate.HasInstantiation)
                {
                    ...
                    methodToInstantiate = context.GetInstantiatedMethod(
                        methodToInstantiate,
