...
namespace ILCompiler
{
    public class Logger
    {
        ...
        )
        {
            ...
            _suppressedCategories = new HashSet<string>(
                suppressedCategories,
                StringComparer.Ordinal
            );
            _compilerGeneratedState =
                ilProvider == null ? null : new CompilerGeneratedState(ilProvider, this);
            _unconditionalSuppressMessageAttributeState =
                new UnconditionalSuppressMessageAttributeState(_compilerGeneratedState, this);
        }
        ...
        internal bool IsWarningSubcategorySuppressed(string category) =>
            _suppressedCategories.Contains(category);
        ...
        internal static bool IsWarningAsError(
            int _ /*code*/
        )
        {
            // TODO: warnaserror
        ...
        internal bool ShouldSuppressAnalysisWarningsForRequires(
            TypeSystemEntity originMember,
        ...
        )
        {
            ...
            if (
                originMember is MethodDesc method
