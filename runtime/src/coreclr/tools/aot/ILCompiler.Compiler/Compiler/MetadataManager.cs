...
namespace ILCompiler
{
    ...
    public abstract class MetadataManager : ICompilationRootProvider
    {
        ...
        private readonly SortedSet<FrozenObjectNode> _frozenObjects =
            new SortedSet<FrozenObjectNode>(CompilerComparer.Instance);
        ...
        private readonly SortedSet<MetadataType> _typesWithGenericStaticBaseInfo =
            new SortedSet<MetadataType>(TypeSystemComparer.Instance);
        private readonly SortedSet<MethodDesc> _genericMethodHashtableEntries =
            new SortedSet<MethodDesc>(TypeSystemComparer.Instance);
        ...
        )
        {
            ...
            header.Add(
                BlobIdToReadyToRunSection(ReflectionMapBlob.FunctionPointerTypeMap),
        ...
        public void GetDependenciesDueToGenericDictionary(
            ref DependencyList dependencies,
            NodeFactory factory,
            MethodDesc method
        )
        {
            MetadataCategory category = GetMetadataCategory(
            ...
            if (method.Signature.IsStatic && method.IsSynchronized)
            {
                ...
                dependencies.Add(
                    factory.GenericMethodsHashtableEntry(method),
                    "Will need to look up owning type from dictionary"
                );
            }
        }

        public IEnumerable<CombinedDependencyListEntry> GetConditionalDependenciesDueToGenericDictionary(
            NodeFactory factory,
            MethodDesc method
        )
        {
            ...
            yield return new CombinedDependencyListEntry(
                factory.GenericMethodsHashtableEntry(method),
                factory.NativeLayout.TemplateMethodEntry(
                    method.GetCanonMethodTarget(CanonicalFormKind.Specific)
                ),
        ...
        /// </summary>
        public virtual void GetDependenciesDueToEETypePresence(
            ref DependencyList dependencies,
            NodeFactory factory,
            TypeDesc type
        )
        ...
        )
        {
            ...
            InlineableStringsResourceNode.AddDependenciesDueToResourceStringUse(
                ref dependencies,
                factory,
                method
            );
        ...
        protected StackTraceRecordData CreateStackTraceRecord(
        ...
        )
        {
            ...
            MetadataRecord signature = transform.HandleMethodSignature(
                methodToGenerateMetadataFor.Signature
            );
            MetadataRecord owningType = transform.HandleType(
                methodToGenerateMetadataFor.OwningType
            );
            ...
            if (owningTypeToGenerateMetadataFor.HasInstantiation && owningType is TypeReference)
            {
            ...
            return new StackTraceRecordData(
                method,
                owningType,
                signature,
                name,
        ...
        public bool IsManifestResourceBlocked(
            NodeFactory factory,
            Internal.TypeSystem.Ecma.EcmaModule module,
            string resourceName
        )
        {
            ...
            if (
                InlineableStringsResourceNode.IsInlineableStringsResource(module, resourceName)
    ...
    public readonly struct StackTraceMapping
    {
        ...
        public StackTraceMapping(
            MethodDesc method,
            int owningTypeHandle,
            int methodSignatureHandle,
            int methodNameHandle,
    ...
    public readonly struct StackTraceRecordData
    {
        ...
        public StackTraceRecordData(
            MethodDesc method,
            MetadataRecord owningType,
            MetadataRecord methodSignature,
            MetadataRecord methodName,
            MetadataRecord methodInstantiationArgumentCollection,
            bool isHidden
        ) =>
            (
                Method,
