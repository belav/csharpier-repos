    ...
    internal static class DynamicallyAccessedMembersBinder
    {
        ...
        )
        {
            ...
            if (memberTypes.HasFlag(DynamicallyAccessedMemberTypes.PublicParameterlessConstructor))
            {
                foreach (
                    var c in typeDefinition.GetConstructorsOnType(
                        filter: m => m.IsPublic && m.Parameters.Count == 0
                    )
                )
                    yield return c;
            }
            ...
            {
                foreach (
                    var nested in typeDefinition.GetNestedTypesOnType(
                        filter: null,
                        bindingFlags: BindingFlags.NonPublic
                    )
                )
            ...
            {
                foreach (
                    var i in typeDefinition.GetAllInterfaceImplementations(context, declaredOnly)
                )
                    yield return i;
            }
        }

        public static IEnumerable<MethodDefinition> GetConstructorsOnType(
        ...
        public static IEnumerable<MethodDefinition> GetMethodsOnTypeHierarchy(
        ...
        public static IEnumerable<FieldDefinition> GetFieldsOnTypeHierarchy(
            this TypeDefinition thisType,
            LinkContext context,
        ...
        public static IEnumerable<TypeDefinition> GetNestedTypesOnType(
            this TypeDefinition type,
        ...
        public static IEnumerable<PropertyDefinition> GetPropertiesOnTypeHierarchy(
            this TypeDefinition thisType,
            LinkContext context,
        ...
        public static IEnumerable<EventDefinition> GetEventsOnTypeHierarchy(
            this TypeDefinition thisType,
            LinkContext context,
            ...
            while (type != null)
            {
                foreach (var i in type.Interfaces)
                {
                    ...
                    if (interfaceType != null)
                    {
                        ...
                        foreach (
                            var innerInterface in interfaceType.GetAllInterfaceImplementations(
                                context,
                                declaredOnly: true
                            )
                        )
        ...
        public static void GetAllOnType(
            ...
            LinkContext context,
            bool declaredOnly,
            List<IMetadataTokenProvider> members
        ) => GetAllOnType(type, context, declaredOnly, members, new HashSet<TypeDefinition>());

        static void GetAllOnType(
            TypeDefinition type,
            LinkContext context,
            bool declaredOnly,
            List<IMetadataTokenProvider> members,
        ...
        )
        {
            ...
            if (type.HasInterfaces)
            {
                ...
                {
                    foreach (
                        var iface in type.GetAllInterfaceImplementations(
                            context,
                            declaredOnly: true
                        )
                    )
