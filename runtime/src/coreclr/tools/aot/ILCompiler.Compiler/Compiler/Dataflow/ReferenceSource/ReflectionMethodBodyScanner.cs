...
namespace Mono.Linker.Dataflow
{
    class ReflectionMethodBodyScanner : MethodBodyScanner
    {
        ...
        static readonly DynamicallyAccessedMemberTypes[] AllDynamicallyAccessedMemberTypes =
            GetAllDynamicallyAccessedMemberTypes();

        static DynamicallyAccessedMemberTypes[] GetAllDynamicallyAccessedMemberTypes()
        {
            HashSet<DynamicallyAccessedMemberTypes> values = Enum.GetValues(
                    typeof(DynamicallyAccessedMemberTypes)
                )
        ...
        )
        {
            ...
            return GetIntrinsicIdForMethod(methodDefinition)
        ...
        public ReflectionMethodBodyScanner(
            LinkContext context,
            MarkStep parent,
        ...
        public void ScanAndProcessReturnValue(MethodBody methodBody)
        {
            ...
            if (
                GetReturnTypeWithoutModifiers(methodBody.Method.ReturnType).MetadataType
                != MetadataType.Void
            )
            {
        ...
        public void ProcessAttributeDataflow(
        ...
        )
        {
            ...
            {
                var annotation = _context.Annotations.FlowAnnotations.GetParameterAnnotation(
                    method,
                    i + paramOffset
                );
        ...
        ValueNode GetValueNodeForCustomAttributeArgument(CustomAttributeArgument argument)
        {
            ...
            {
                TypeDefinition? referencedType = ResolveToTypeDefinition(
        ...
        public void ProcessGenericArgumentDataFlow(
            GenericParameter genericParameter,
            TypeReference genericArgument
        )
        {
            var annotation = _context.Annotations.FlowAnnotations.GetGenericParameterAnnotation(
                genericParameter
            );
            Debug.Assert(annotation != DynamicallyAccessedMemberTypes.None);
        ...
        protected override ValueNode GetMethodParameterValue(
            MethodDefinition method,
            int parameterIndex
        )
        {
            DynamicallyAccessedMemberTypes memberTypes =
                _context.Annotations.FlowAnnotations.GetParameterAnnotation(method, parameterIndex);

            var staticType = !method.HasImplicitThis()
        ...
        protected override ValueNode GetFieldValue(MethodDefinition method, FieldDefinition field)
        {
            switch (field.Name)
            {
                ...
                default:
                {
                    ...
                    return new LoadFieldValue(
                        ResolveToTypeDefinition(field.FieldType),
                        field,
                        memberTypes
                    );
                }
        ...
        {
            var requiredMemberTypes = _context.Annotations.FlowAnnotations.GetFieldAnnotation(
                field
            );
            if (requiredMemberTypes != 0)
            {
        ...
        {
            var requiredMemberTypes = _context.Annotations.FlowAnnotations.GetParameterAnnotation(
                method,
                index
            );
            if (requiredMemberTypes != 0)
            {
                ParameterDefinition parameter = method.Parameters[
                    index - (method.HasImplicitThis() ? 1 : 0)
                ];
                _scopeStack.UpdateCurrentScopeInstructionOffset(operation.Offset);
                var reflectionContext = new ReflectionPatternContext(
                    _context,
        ...
        static IntrinsicId GetIntrinsicIdForMethod(MethodDefinition calledMethod)
        {
            return calledMethod.Name switch
            {
                ...
                "GetMethodFromHandle"
                    when calledMethod.IsDeclaredOnType("System.Reflection", "MethodBase")
                ...
                "MakeGenericType" when calledMethod.IsDeclaredOnType("System", "Type")
                    => IntrinsicId.Type_MakeGenericType,
                ...
                "Call"
                    when calledMethod.IsDeclaredOnType("System.Linq.Expressions", "Expression")
                        && calledMethod.HasParameterOfType(0, "System", "Type")
                ...
                "GetType"
                    when calledMethod.IsDeclaredOnType("System", "Type")
                ...
                "GetConstructor"
                    when calledMethod.IsDeclaredOnType("System", "Type") && calledMethod.HasThis
                ...
                "GetInterface"
                    when calledMethod.IsDeclaredOnType("System", "Type")
                        ...
                        && (
                            ...
                            || (
                                calledMethod.Parameters.Count == 2
                                && calledMethod.HasParameterOfType(1, "System", "Boolean")
                            )
                        )
                ...
                ".ctor"
                    when calledMethod.IsDeclaredOnType("System.Reflection", "TypeDelegator")
                        && calledMethod.HasParameterOfType(0, "System", "Type")
                ...
                "CreateInstance"
                    when calledMethod.IsDeclaredOnType("System", "Activator")
                ...
                "CreateInstance"
                    when calledMethod.IsDeclaredOnType("System", "AppDomain")
                        && calledMethod.HasParameterOfType(0, "System", "String")
                        && calledMethod.HasParameterOfType(1, "System", "String")
                ...
                "CreateInstance"
                    when calledMethod.IsDeclaredOnType("System.Reflection", "Assembly")
                        && calledMethod.HasParameterOfType(0, "System", "String")
                ...
                "MakeGenericMethod"
                    when calledMethod.IsDeclaredOnType("System.Reflection", "MethodInfo")
                        && calledMethod.HasThis
                        && calledMethod.Parameters.Count == 1
        ...
        )
        {
            ...
            try
            {
                bool requiresDataFlowAnalysis =
                    _context.Annotations.FlowAnnotations.RequiresDataFlowAnalysis(
                        calledMethodDefinition
                    );
                returnValueDynamicallyAccessedMemberTypes = requiresDataFlowAnalysis
                    ? _context.Annotations.FlowAnnotations.GetReturnParameterAnnotation(
                        calledMethodDefinition
                    )
                    : 0;
                ...
                switch (GetIntrinsicIdForMethod(calledMethodDefinition))
                {
                    ...
                    case IntrinsicId.Array_Empty:
                        ...
                        {
                            methodReturnValue = new ArrayValue(
                                new ConstIntValue(0),
                                ((GenericInstanceMethod)calledMethod).GenericArguments[0]
                            );
                        }
                        break;
                    ...
                    case IntrinsicId.Type_GetTypeFromHandle:

                        {
                            ...
                            if (methodParams[0] is RuntimeTypeHandleValue typeHandle)
                                ...
                                methodParams[0]
                                is RuntimeTypeHandleForGenericParameterValue typeHandleForGenericParameter
                            )
                            {
...

                        {
                            foreach (var value in methodParams[0].UniqueValues())
                            {
                                if (value is SystemTypeValue typeValue)
                                    methodReturnValue = MergePointValue.MergeValues(
                                        methodReturnValue,
                                        new RuntimeTypeHandleValue(typeValue.TypeRepresented)
                                    );
                    ...
                    case IntrinsicId.MethodBase_GetMethodFromHandle:

                        {
                            ...
                            if (methodParams[0] is RuntimeMethodHandleValue methodHandle)
                                methodReturnValue = new SystemReflectionMethodBaseValue(
                                    methodHandle.MethodRepresented
                                );
                        }
                        break;
                    ...
                    case IntrinsicId.Type_MakeGenericType:

                        {
                            ...
                            foreach (var value in methodParams[0].UniqueValues())
                            {
                                ...
                                {
                                    if (
                                        AnalyzeGenericInstantiationTypeArray(
                                            methodParams[1],
                                            ref reflectionContext,
                                            calledMethodDefinition,
                                            typeValue.TypeRepresented.GenericParameters
                                        )
                                    )
                                    {
                                    ...
                                    else
                                    {
                                        ...
                                        foreach (
                                            var genericParameter in typeValue
                                                .TypeRepresented
                                                .GenericParameters
                                        )
                                        {
                                            if (
                                                ...
                                                || (
                                                    ...
                                                    && !typeValue.TypeRepresented.IsTypeOf(
                                                        "System",
                                                        "Nullable`1"
                                                    )
                                                )
                                ...
                                else
                                {
                                    ...
                                    reflectionContext.RecordUnrecognizedPattern(
                                        ...
                                        new DiagnosticString(
                                            DiagnosticId.MakeGenericType
                                        ).GetMessage(calledMethodDefinition.GetDisplayName())
                                    );
                                }
                            }
                    ...
                    //
                    case var getRuntimeMember
                        when getRuntimeMember
                            == IntrinsicId.RuntimeReflectionExtensions_GetRuntimeEvent
                            || getRuntimeMember
                                == IntrinsicId.RuntimeReflectionExtensions_GetRuntimeField
                            || getRuntimeMember
                                ...
                                getRuntimeMember switch
                                {
                                    ...
                                    _
                                        => throw new InternalErrorException(
                                            $"Reflection call '{calledMethod.GetDisplayName()}' inside '{callingMethodDefinition.GetDisplayName()}' is of unexpected member type."
                                        ),
                                };
                                        ...
                                        if (stringParam is KnownStringValue stringValue)
                                        {
                                            switch (getRuntimeMember)
                                            {
                                                case IntrinsicId.RuntimeReflectionExtensions_GetRuntimeEvent:
                                                    MarkEventsOnTypeHierarchy(
                                                        ref reflectionContext,
                                                        systemTypeValue.TypeRepresented,
                                                        e => e.Name == stringValue.Contents,
                                                        bindingFlags
                                                    );
                                                    reflectionContext.RecordHandledPattern();
                                                    break;
                                                case IntrinsicId.RuntimeReflectionExtensions_GetRuntimeField:
                                                    MarkFieldsOnTypeHierarchy(
                                                        ref reflectionContext,
                                                        systemTypeValue.TypeRepresented,
                                                        f => f.Name == stringValue.Contents,
                                                        bindingFlags
                                                    );
                                                    reflectionContext.RecordHandledPattern();
                                                    break;
                                                case IntrinsicId.RuntimeReflectionExtensions_GetRuntimeMethod:
                                                    ProcessGetMethodByName(
                                                        ...
                                                        bindingFlags,
                                                        ref methodReturnValue
                                                    );
                                                    reflectionContext.RecordHandledPattern();
                                                    break;
                                                case IntrinsicId.RuntimeReflectionExtensions_GetRuntimeProperty:
                                                    MarkPropertiesOnTypeHierarchy(
                                                        ref reflectionContext,
                                                        systemTypeValue.TypeRepresented,
                                                        p => p.Name == stringValue.Contents,
                                                        bindingFlags
                                                    );
                                                    reflectionContext.RecordHandledPattern();
                                                    break;
                                                default:
                                                    throw new InternalErrorException(
                                                        $"Error processing reflection call '{calledMethod.GetDisplayName()}' inside {callingMethodDefinition.GetDisplayName()}. Unexpected member kind."
                                                    );
                                            }
                                        }
                                        else
                    ...
                    case IntrinsicId.Expression_Call:

                        {
                            ...
                            bool hasTypeArguments =
                                (methodParams[2] as ArrayValue)?.Size.AsConstInt() != 0;
                            foreach (var value in methodParams[0].UniqueValues())
                            {
                                if (value is SystemTypeValue systemTypeValue)
                                {
                                    foreach (var stringParam in methodParams[1].UniqueValues())
                                    {
                                        ...
                                        {
                                            foreach (
                                                var method in systemTypeValue.TypeRepresented.GetMethodsOnTypeHierarchy(
                                                    _context,
                                                    m => m.Name == stringValue.Contents,
                                                    bindingFlags
                                                )
                                            )
                                            {
                                            ...
                                            if (hasTypeArguments)
                                            {
                                                ...
                                                reflectionContext.RecordUnrecognizedPattern(
                                                    ...
                                                    new DiagnosticString(
                                                        ...
                                                        DiagnosticUtilities.GetMethodSignatureDisplayName(
                                                            calledMethod
                                                        )
                                                    )
                                                );
                    ...
                    case IntrinsicId.Expression_Property
                        when calledMethod.HasParameterOfType(1, "System.Reflection", "MethodInfo"):

                        {
                            ...
                            foreach (var value in methodParams[1].UniqueValues())
                            {
                                if (value is SystemReflectionMethodBaseValue methodBaseValue)
                                {
                                    ...
                                    if (
                                        methodBaseValue.MethodRepresented.TryGetProperty(
                                ...
                                reflectionContext.RecordUnrecognizedPattern(
                                    2103,
                                    string.Format(
                                        Resources.Strings.IL2103,
                                        DiagnosticUtilities.GetParameterNameForErrorMessage(
                                            calledMethod.Parameters[1]
                                        ),
                                        DiagnosticUtilities.GetMethodSignatureDisplayName(
                                            calledMethod
                                        )
                    ...
                    //
                    case var fieldOrPropertyInstrinsic
                        when fieldOrPropertyInstrinsic == IntrinsicId.Expression_Field
                            || fieldOrPropertyInstrinsic == IntrinsicId.Expression_Property:
                            ...
                            foreach (var value in methodParams[1].UniqueValues())
                            {
                                if (value is SystemTypeValue systemTypeValue)
                                {
                                    foreach (var stringParam in methodParams[2].UniqueValues())
                                    {
                                        ...
                                        {
                                            BindingFlags bindingFlags =
                                                methodParams[0]?.Kind == ValueNodeKind.Null
                                                    ? BindingFlags.Static
                                            ...
                                            )
                                            {
                                                MarkPropertiesOnTypeHierarchy(
                                                    ref reflectionContext,
                                                    systemTypeValue.TypeRepresented,
                                                    filter: p => p.Name == stringValue.Contents,
                                                    bindingFlags
                                                );
                                            }
                                            else
                                            {
                                                MarkFieldsOnTypeHierarchy(
                                                    ref reflectionContext,
                                                    systemTypeValue.TypeRepresented,
                                                    filter: f => f.Name == stringValue.Contents,
                                                    bindingFlags
                                                );
                                            }
...

                        {
                            foreach (var valueNode in methodParams[0].UniqueValues())
                            {
                                ...
                                if (staticType is null)
                                {
                                    ...
                                    methodReturnValue = MergePointValue.MergeValues(
                                        methodReturnValue,
                                        CreateMethodReturnValue(calledMethod)
                                    );
                                }
                                else if (
                                ...
                                )
                                {
                                    ...
                                    methodReturnValue = MergePointValue.MergeValues(
                                        methodReturnValue,
                                        new SystemTypeValue(staticType)
                                    );
                                }
                                else
                                {
                                    ...
                                    var annotation =
                                        _markStep.DynamicallyAccessedMembersTypeHierarchy.ApplyDynamicallyAccessedMembersToTypeHierarchy(
                                            this,
                                            staticType
                                        );
                                    ...
                                    methodReturnValue = MergePointValue.MergeValues(
                                        methodReturnValue,
                                        CreateMethodReturnValue(calledMethod, annotation)
                                    );
                                }
                            }
                        }
                    ...
                    case IntrinsicId.Type_GetType:

                        {
                            ...
                            if (
                                (
                                    parameters.Count == 3
                                    && parameters[2].ParameterType.MetadataType
                                        == MetadataType.Boolean
                                    && methodParams[2].AsConstInt() != 0
                                ) || (parameters.Count == 5 && methodParams[4].AsConstInt() != 0)
                            )
                            {
                                reflectionContext.RecordUnrecognizedPattern(
                                    2096,
                                    $"Call to '{calledMethod.GetDisplayName()}' can perform case insensitive lookup of the type, currently ILLink can not guarantee presence of all the matching types"
                                );
                                break;
                            }
                            foreach (var typeNameValue in methodParams[0].UniqueValues())
                            {
                                if (typeNameValue is KnownStringValue knownStringValue)
                                {
                                    if (
                                        !_context.TypeNameResolver.TryResolveTypeName(
                                            knownStringValue.Contents,
                                            callingMethodDefinition,
                                            out TypeReference? foundTypeRef,
                                            out AssemblyDefinition? typeAssembly,
                                            false
                                        )
                                        || ResolveToTypeDefinition(foundTypeRef)
                                            is not TypeDefinition foundType
                                    )
                                    {
                                    ...
                                    else
                                    {
                                        reflectionContext.RecordRecognizedPattern(
                                            foundType,
                                            () =>
                                                _markStep.MarkTypeVisibleToReflection(
                                                    foundTypeRef,
                                                    foundType,
                                                    new DependencyInfo(
                                ...
                                else if (typeNameValue == NullValue.Instance)
                                {
                                    ...
                                    typeNameValue
                                        is LeafValueWithDynamicallyAccessedMemberNode valueWithDynamicallyAccessedMember
                                    && valueWithDynamicallyAccessedMember.DynamicallyAccessedMemberTypes
                                        != 0
                                )
                                {
                                ...
                                else
                                {
                                    reflectionContext.RecordUnrecognizedPattern(
                                        2057,
                                        $"Unrecognized value passed to the parameter 'typeName' of method '{calledMethod.GetDisplayName()}'. It's not possible to guarantee the availability of the target type."
                                    );
                                }
                            }
                        }
                    ...
                    case IntrinsicId.Type_GetConstructor:

                        {
                            ...
                            if (
                                parameters.Count > 1
                                && calledMethod.Parameters[0].ParameterType.Name == "BindingFlags"
                            )
                            ...
                            foreach (var value in methodParams[0].UniqueValues())
                            {
                                    ...
                                    else
                                    {
                                        ...
                                        )
                                        {
                                            MarkConstructorsOnType(
                                                ref reflectionContext,
                                                systemTypeValue.TypeRepresented,
                                                m => m.IsPublic && m.Parameters.Count == 0,
                                                bindingFlags
                                            );
                                        }
                                        else
                                ...
                                else
                                {
                                    ...
                                    var requiredMemberTypes =
                                        GetDynamicallyAccessedMemberTypesFromBindingFlagsForConstructors(
                                            bindingFlags
                                        );
                    ...
                    case IntrinsicId.Type_GetMethod:

                        {
                            ...
                            if (
                                calledMethod.Parameters.Count > 1
                                && calledMethod.Parameters[1].ParameterType.Name == "BindingFlags"
                            )
                                bindingFlags = GetBindingFlagsFromValue(methodParams[2]);
                            else if (
                                calledMethod.Parameters.Count > 2
                                && calledMethod.Parameters[2].ParameterType.Name == "BindingFlags"
                            )
                    ...
                    case IntrinsicId.Type_GetNestedType:

                        {
                            ...
                            foreach (var value in methodParams[0].UniqueValues())
                            {
                                if (value is SystemTypeValue systemTypeValue)
                                {
                                    foreach (var stringParam in methodParams[1].UniqueValues())
                                    {
                                        if (stringParam is KnownStringValue stringValue)
                                        {
                                            ...
                                            {
                                                TypeDefinition[]? matchingNestedTypes =
                                                    MarkNestedTypesOnType(
                                                        ref reflectionContext,
                                                        systemTypeValue.TypeRepresented,
                                                        m => m.Name == stringValue.Contents,
                                                        bindingFlags
                                                ...
                                                if (matchingNestedTypes != null)
                                                {
                                                    for (
                                                        int i = 0;
                                                        i < matchingNestedTypes.Length;
                                                        i++
                                                    )
                                                        methodReturnValue =
                                                            MergePointValue.MergeValues(
                                                                methodReturnValue,
                                                                new SystemTypeValue(
                                                                    matchingNestedTypes[i]
                                                                )
                                                            );
                                                }
                                            }
                                ...
                                if (
                                    value
                                    is LeafValueWithDynamicallyAccessedMemberNode leafValueWithDynamicallyAccessedMember
                                )
                                {
                                    if (
                                        leafValueWithDynamicallyAccessedMember.DynamicallyAccessedMemberTypes
                    ...
                    case IntrinsicId.Type_get_AssemblyQualifiedName:

                        {
                            ...
                            foreach (var value in methodParams[0].UniqueValues())
                            {
                                if (
                                    value
                                    is LeafValueWithDynamicallyAccessedMemberNode dynamicallyAccessedThing
                                )
                                {
                                    var annotatedString = new AnnotatedStringValue(
                                        dynamicallyAccessedThing.SourceContext,
                                        dynamicallyAccessedThing.DynamicallyAccessedMemberTypes
                                    );
                                    transformedResult = MergePointValue.MergeValues(
                                        transformedResult,
                                        annotatedString
                                    );
                                }
                    ...
                    case IntrinsicId.Type_get_BaseType:

                        {
                            foreach (var value in methodParams[0].UniqueValues())
                            {
                                if (
                                    value
                                    is LeafValueWithDynamicallyAccessedMemberNode dynamicallyAccessedMemberNode
                                )
                                {
                                    DynamicallyAccessedMemberTypes propagatedMemberTypes =
                                        DynamicallyAccessedMemberTypes.None;
                                    if (
                                        dynamicallyAccessedMemberNode.DynamicallyAccessedMemberTypes
                                        == DynamicallyAccessedMemberTypes.All
                                    )
                                    ...
                                    else
                                    {
                                        ...
                                        if (
                                            dynamicallyAccessedMemberNode.DynamicallyAccessedMemberTypes.HasFlag(
                                                DynamicallyAccessedMemberTypes.PublicEvents
                                            )
                                        )
                                    ...
                                    methodReturnValue = MergePointValue.MergeValues(
                                        methodReturnValue,
                                        CreateMethodReturnValue(calledMethod, propagatedMemberTypes)
                                    );
                                }
                                else if (value is SystemTypeValue systemTypeValue)
                                {
                                    if (
                                        systemTypeValue.TypeRepresented.BaseType
                                            is TypeReference baseTypeRef
                                        && _context.TryResolve(baseTypeRef)
                                            is TypeDefinition baseTypeDefinition
                                    )
                                        methodReturnValue = MergePointValue.MergeValues(
                                            methodReturnValue,
                                            new SystemTypeValue(baseTypeDefinition)
                                        );
                                    else
                                        methodReturnValue = MergePointValue.MergeValues(
                                            methodReturnValue,
                    ...
                    //
                    case var fieldPropertyOrEvent
                        when (
                            fieldPropertyOrEvent == IntrinsicId.Type_GetField
                            || fieldPropertyOrEvent == IntrinsicId.Type_GetProperty
                            || fieldPropertyOrEvent == IntrinsicId.Type_GetEvent
                        )
...

                        {
                            ...
                            DynamicallyAccessedMemberTypes memberTypes = fieldPropertyOrEvent switch
                            {
                                ...
                                IntrinsicId.Type_GetField
                                    => GetDynamicallyAccessedMemberTypesFromBindingFlagsForFields(
                                        bindingFlags
                                    ),
                                IntrinsicId.Type_GetProperty
                    ...
                    case var callType
                        when (
                            callType == IntrinsicId.Type_GetConstructors
                            || callType == IntrinsicId.Type_GetMethods
                            || callType == IntrinsicId.Type_GetFields
                            || callType == IntrinsicId.Type_GetProperties
                            || callType == IntrinsicId.Type_GetEvents
                            || callType == IntrinsicId.Type_GetNestedTypes
                            || callType == IntrinsicId.Type_GetMembers
                        )
                            && calledMethod.DeclaringType.Namespace == "System"
                            && calledMethod.DeclaringType.Name == "Type"
                            && calledMethod.Parameters[0].ParameterType.FullName
...

                        {
                            ...
                            else
                            {
                                memberTypes = callType switch
                                {
                                    ...
                                    IntrinsicId.Type_GetMembers
                                        => GetDynamicallyAccessedMemberTypesFromBindingFlagsForMembers(
                                            bindingFlags
                                        ),
                                    _
                                        => throw new ArgumentException(
                    ...
                    case IntrinsicId.Type_GetMember:

                        {
                            ...
                            )
                            {
                                ...
                                throw new ArgumentException(
                                    $"Reflection call '{calledMethod.GetDisplayName()}' inside '{callingMethodDefinition.GetDisplayName()}' is an unexpected intrinsic."
                                );
                    ...
                    case IntrinsicId.Type_GetInterface:

                        {
                            ...
                            foreach (var value in methodParams[0].UniqueValues())
                            {
                                ...
                                DynamicallyAccessedMemberTypes returnMemberTypes =
                                    DynamicallyAccessedMemberTypesOverlay.Interfaces;

                                // Propagate All annotation across the call - All is a superset of Interfaces
                                if (
                                    value
                                        is LeafValueWithDynamicallyAccessedMemberNode annotatedNode
                                    && annotatedNode.DynamicallyAccessedMemberTypes
                                        == DynamicallyAccessedMemberTypes.All
                                )
                                ...
                                methodReturnValue = MergePointValue.MergeValues(
                                    methodReturnValue,
                                    CreateMethodReturnValue(calledMethod, returnMemberTypes)
                                );
                            }
                        }
                        break;
                    ...
                    case IntrinsicId.Activator_CreateInstance_Type:

                        {
                            ...
                            {
                                if (
                                    parameters[1].ParameterType.MetadataType == MetadataType.Boolean
                                )
                                {
                                ...
                                else
                                {
                                    ...
                                    int argsParam =
                                        parameters.Count == 2 || parameters.Count == 3 ? 1 : 3;
                            ...
                            foreach (var value in methodParams[0].UniqueValues())
                            {
                                if (value is SystemTypeValue systemTypeValue)
                                {
                                    ...
                                    MarkConstructorsOnType(
                                        ref reflectionContext,
                                        systemTypeValue.TypeRepresented,
                                        ctorParameterCount == null
                                            ? null
                                            : m => m.Parameters.Count == ctorParameterCount,
                                        bindingFlags
                                    );
                                    reflectionContext.RecordHandledPattern();
                                }
                    ...
                    case IntrinsicId.Activator_CreateInstanceOfT
                        when calledMethod is GenericInstanceMethod genericCalledMethod
                            && genericCalledMethod.GenericArguments.Count == 1:

                        {
                            reflectionContext.AnalyzingPattern();

                            if (
                                genericCalledMethod.GenericArguments[0]
                                    is GenericParameter genericParameter
                                && genericParameter.HasDefaultConstructorConstraint
                            )
                            {
                            ...
                            RequireDynamicallyAccessedMembers(
                                ref reflectionContext,
                                DynamicallyAccessedMemberTypes.PublicParameterlessConstructor,
                                GetTypeValueNodeFromGenericArgument(
                                    genericCalledMethod.GenericArguments[0]
                                ),
                    ...
                    //
                    case var appDomainCreateInstance
                        when appDomainCreateInstance == IntrinsicId.AppDomain_CreateInstance
                    ...
                    case IntrinsicId.Assembly_CreateInstance:
                        ...
                        reflectionContext.RecordUnrecognizedPattern(
                            2058,
                            $"Parameters passed to method '{calledMethodDefinition.GetDisplayName()}' cannot be analyzed. Consider using methods 'System.Type.GetType' and `System.Activator.CreateInstance` instead."
                        );
                        break;
                    ...
                    case IntrinsicId.RuntimeHelpers_RunClassConstructor:

                        {
                            ...
                            {
                                if (
                                    typeHandleValue is RuntimeTypeHandleValue runtimeTypeHandleValue
                                )
                                {
                                    _markStep.MarkStaticConstructorVisibleToReflection(
                                        runtimeTypeHandleValue.TypeRepresented,
                                        new DependencyInfo(
                                            DependencyKind.AccessedViaReflection,
                                            reflectionContext.Source
                                        )
                                    );
                                    reflectionContext.RecordHandledPattern();
                                }
                                ...
                                else
                                {
                                    reflectionContext.RecordUnrecognizedPattern(
                                        2059,
                                        $"Unrecognized value passed to the parameter 'type' of method '{calledMethodDefinition.GetDisplayName()}'. It's not possible to guarantee the availability of the target static constructor."
                                    );
                                }
                            }
                        }
...

                        {
                            ...
                            foreach (var methodValue in methodParams[0].UniqueValues())
                            {
                                if (methodValue is SystemReflectionMethodBaseValue methodBaseValue)
                                {
                                    ValidateGenericMethodInstantiation(
                                        ref reflectionContext,
                                        methodBaseValue.MethodRepresented,
                                        methodParams[1],
                                        calledMethod
                                    );
                                }
                    ...
                    default:
                        ...
                        if (calledMethodDefinition.IsPInvokeImpl)
                        {
                            ...
                            bool comDangerousMethod = IsComInterop(
                                calledMethodDefinition.MethodReturnType,
                                calledMethodDefinition.ReturnType
                            );
                            ...
                            if (comDangerousMethod)
                            {
                                ...
                                reflectionContext.RecordUnrecognizedPattern(
                                    2050,
                                    $"P/invoke method '{calledMethodDefinition.GetDisplayName()}' declares a parameter with COM marshalling. Correctness of COM interop cannot be guaranteed after trimming. Interfaces and interface members might be removed."
                                );
                            }
                        }
                        ...
                        if (requiresDataFlowAnalysis)
                        {
                            ...
                            for (
                                ...
                                parameterIndex < methodParams.Count;
                                parameterIndex++
                            )
                            {
                                var requiredMemberTypes =
                                    _context.Annotations.FlowAnnotations.GetParameterAnnotation(
                                        calledMethodDefinition,
                                        parameterIndex
                                    );
                                if (requiredMemberTypes != 0)
                                {
                                    ...
                                    if (calledMethodDefinition.HasImplicitThis())
                                    {
                                        if (parameterIndex == 0)
                                            ...
                                            targetContext = calledMethodDefinition.Parameters[
                                                parameterIndex - 1
                                            ];
                                    }
                                    else
                        ...
                        )
                        {
                            methodReturnValue = CreateMethodReturnValue(
                                calledMethodDefinition,
                                returnValueDynamicallyAccessedMemberTypes
                            );
            ...
            {
                if (
                    GetReturnTypeWithoutModifiers(calledMethod.ReturnType).MetadataType
                    != MetadataType.Void
                )
                {
                    methodReturnValue = CreateMethodReturnValue(
            ...
            if (returnValueDynamicallyAccessedMemberTypes != 0)
            {
                foreach (var uniqueValue in methodReturnValue.UniqueValues())
                {
                    if (
                        uniqueValue
                        is LeafValueWithDynamicallyAccessedMemberNode methodReturnValueWithMemberTypes
                    )
                    {
                        if (
        ...
        bool IsComInterop(IMarshalInfoProvider marshalInfoProvider, TypeReference parameterType)
        {
            ...
            if (
                nativeType == NativeType.IUnknown
            ...
            if (nativeType == NativeType.None)
            {
                ...
                if (parameterTypeDef != null)
                {
                    if (parameterTypeDef.IsTypeOf("System", "Array"))
                    {
                        ...
                        parameterTypeDef.IsTypeOf("System", "String")
                    ...
                    )
                    {
                        ...
                        !parameterTypeDef.IsSequentialLayout && !parameterTypeDef.IsExplicitLayout
                    )
                    {
        ...
        bool AnalyzeGenericInstantiationTypeArray(
            ValueNode? arrayParam,
        ...
        )
        {
            ...
            foreach (var typesValue in arrayParam.UniqueValues())
            {
                ...
                {
                    if (
                        !array.IndexValues.TryGetValue(i, out ValueBasicBlockPair value)
                        || value.Value is null or { Kind: ValueNodeKind.Unknown }
                    )
                    {
        ...
        void ProcessCreateInstanceByName(
            ref ReflectionPatternContext reflectionContext,
        ...
        )
        {
            ...
            if (
                calledMethod.Parameters.Count == 8
                && calledMethod.Parameters[2].ParameterType.MetadataType == MetadataType.Boolean
            )
            {
            ...
            foreach (var assemblyNameValue in methodParams[methodParamsOffset].UniqueValues())
            {
                ...
                {
                    foreach (
                        var typeNameValue in methodParams[methodParamsOffset + 1].UniqueValues()
                    )
                    {
                        if (typeNameValue is KnownStringValue typeNameStringValue)
                        {
                            var resolvedAssembly = _context.TryResolve(
                            ...
                            if (resolvedAssembly == null)
                            {
                                reflectionContext.RecordUnrecognizedPattern(
                                    2061,
                                    $"The assembly name '{assemblyNameStringValue.Contents}' passed to method '{calledMethod.GetDisplayName()}' references assembly which is not available."
                                );
                                continue;
                            }
                            ...
                            MarkConstructorsOnType(
                                ref reflectionContext,
                                resolvedType,
                                parameterlessConstructor ? m => m.Parameters.Count == 0 : null,
                                bindingFlags
                            );
                        }
                        else
                        {
                            reflectionContext.RecordUnrecognizedPattern(
                                2032,
                                $"Unrecognized value passed to the parameter '{calledMethod.Parameters[1].Name}' of method '{calledMethod.GetDisplayName()}'. It's not possible to guarantee the availability of the target type."
                            );
                        }
                    }
                }
                else
                {
                    reflectionContext.RecordUnrecognizedPattern(
                        2032,
                        $"Unrecognized value passed to the parameter '{calledMethod.Parameters[0].Name}' of method '{calledMethod.GetDisplayName()}'. It's not possible to guarantee the availability of the target type."
                    );
                }
            }
        }
        ...
        )
        {
            bool foundAny = false;
            foreach (
                var method in typeDefinition.GetMethodsOnTypeHierarchy(
                    _context,
                    m => m.Name == methodName,
                    bindingFlags
                )
            )
            {
                ...
                methodReturnValue = MergePointValue.MergeValues(
                    methodReturnValue,
                    new SystemReflectionMethodBaseValue(method)
                );
                foundAny = true;
            }
        ...
        public static DynamicallyAccessedMemberTypes GetMissingMemberTypes(
            DynamicallyAccessedMemberTypes requiredMemberTypes,
            DynamicallyAccessedMemberTypes availableMemberTypes
        )
        {
        ...
        string GetMemberTypesString(DynamicallyAccessedMemberTypes memberTypes)
        {
            ...
            var memberTypesList = AllDynamicallyAccessedMemberTypes
                .Where(
                    damt =>
                        (memberTypes & damt) == damt && damt != DynamicallyAccessedMemberTypes.None
                )
                .ToList();
            ...
            return string.Join(
                ", ",
                memberTypesList.Select(mt =>
                {
                    string mtName =
                        mt == DynamicallyAccessedMemberTypesOverlay.Interfaces
            ...
            foreach (var uniqueValue in value.UniqueValues())
            {
                ...
                )
                {
                    var availableMemberTypes =
                        valueWithDynamicallyAccessedMember.DynamicallyAccessedMemberTypes;
                    var missingMemberTypesValue = GetMissingMemberTypes(
                        requiredMemberTypes,
                        ...
                        switch ((valueWithDynamicallyAccessedMember.SourceContext, targetContext))
                        {
                            case (
                                ...
                                reflectionContext.RecordUnrecognizedPattern(
                                    2067,
                                    string.Format(
                                        Resources.Strings.IL2067,
                                        DiagnosticUtilities.GetParameterNameForErrorMessage(
                                            targetParameter
                                        ),
                                        DiagnosticUtilities.GetMethodSignatureDisplayName(
                                            targetParameter.Method
                                        ),
                                        DiagnosticUtilities.GetParameterNameForErrorMessage(
                                            sourceParameter
                                        ),
                                        DiagnosticUtilities.GetMethodSignatureDisplayName(
                                            sourceParameter.Method
                                        ),
                                        missingMemberTypes
                                    )
                                );
                            ...
                            case (
                                ParameterDefinition sourceParameter,
                                MethodReturnType targetMethodReturnType
                            ):
                                reflectionContext.RecordUnrecognizedPattern(
                                    2068,
                                    string.Format(
                                        Resources.Strings.IL2068,
                                        DiagnosticUtilities.GetMethodSignatureDisplayName(
                                            targetMethodReturnType.Method
                                        ),
                                        DiagnosticUtilities.GetParameterNameForErrorMessage(
                                            sourceParameter
                                        ),
                            ...
                            case (
                                MethodReturnType sourceMethodReturnType,
                                ParameterDefinition targetParameter
                            ):
                                reflectionContext.RecordUnrecognizedPattern(
                                    2072,
                                    string.Format(
                                        Resources.Strings.IL2072,
                                        DiagnosticUtilities.GetParameterNameForErrorMessage(
                                            targetParameter
                                        ),
                                        DiagnosticUtilities.GetMethodSignatureDisplayName(
                            ...
                            default:
                                throw new NotImplementedException(
                                    $"unsupported source context {valueWithDynamicallyAccessedMember.SourceContext} or target context {targetContext}"
                                );
                        }
                        ;
                    }
                ...
                {
                    MarkTypeForDynamicallyAccessedMembers(
                        ref reflectionContext,
                        systemTypeValue.TypeRepresented,
                        requiredMemberTypes,
                ...
                else if (uniqueValue is KnownStringValue knownStringValue)
                {
                    ...
                    else
                    {
                        ...
                        _context.MarkingHelpers.MarkMatchingExportedType(
                            foundType,
                            typeAssembly,
                            new DependencyInfo(DependencyKind.DynamicallyAccessedMember, foundType),
                            reflectionContext.Origin
                        );
                    }
                }
                ...
                else
                {
                    switch (targetContext)
                    {
                        ...
                        default:
                            throw new NotImplementedException(
                                $"unsupported target context {targetContext.GetType()}"
                            );
                    }
                    ;
                }
        ...
        static BindingFlags? GetBindingFlagsFromValue(ValueNode? parameter) =>
            (BindingFlags?)parameter.AsConstInt();
        ...
        static bool HasBindingFlag(BindingFlags? bindingFlags, BindingFlags? search) =>
            bindingFlags != null && (bindingFlags & search) == search;

        public void MarkTypeForDynamicallyAccessedMembers(
            ref ReflectionPatternContext reflectionContext,
            TypeDefinition typeDefinition,
            DynamicallyAccessedMemberTypes requiredMemberTypes,
        ...
        void MarkType(
            ...
            DependencyKind dependencyKind = DependencyKind.AccessedViaReflection
        )
        {
            ...
            if (_context.TryResolve(typeReference) is TypeDefinition type)
                reflectionContext.RecordRecognizedPattern(
                    type,
                    () => _markStep.MarkTypeVisibleToReflection(typeReference, type, dependencyInfo)
                );
        }
        ...
        )
        {
            ...
            reflectionContext.RecordRecognizedPattern(
                method,
                () => _markStep.MarkMethodVisibleToReflection(method, dependencyInfo)
            );
        }
        ...
        )
        {
            ...
            reflectionContext.RecordRecognizedPattern(
                field,
                () => _markStep.MarkFieldVisibleToReflection(field, dependencyInfo)
            );
        }
        ...
        )
        {
            ...
            reflectionContext.RecordRecognizedPattern(
                ...
                () =>
                {
                    _markStep.MarkPropertyVisibleToReflection(property, dependencyInfo);
                }
            );
        }
        ...
        )
        {
            ...
            reflectionContext.RecordRecognizedPattern(
                ...
                () =>
                {
                    _markStep.MarkEventVisibleToReflection(@event, dependencyInfo);
                }
            );
        }
        ...
        )
        {
            ...
            reflectionContext.RecordRecognizedPattern(
                interfaceImplementation,
                () =>
                    _markStep.MarkInterfaceImplementation(
                        interfaceImplementation,
                        null,
                        dependencyInfo
                    )
        ...
        void MarkConstructorsOnType(
            ref ReflectionPatternContext reflectionContext,
            TypeDefinition type,
            Func<MethodDefinition, bool>? filter,
        ...
        void MarkFieldsOnTypeHierarchy(
            ref ReflectionPatternContext reflectionContext,
            TypeDefinition type,
            Func<FieldDefinition, bool> filter,
        ...
        TypeDefinition[]? MarkNestedTypesOnType(
            ref ReflectionPatternContext reflectionContext,
            TypeDefinition type,
        ...
        void MarkPropertiesOnTypeHierarchy(
            ref ReflectionPatternContext reflectionContext,
            TypeDefinition type,
            Func<PropertyDefinition, bool> filter,
            BindingFlags? bindingFlags = BindingFlags.Default
        )
        {
            foreach (
                var property in type.GetPropertiesOnTypeHierarchy(_context, filter, bindingFlags)
            )
        ...
        void MarkEventsOnTypeHierarchy(
            ref ReflectionPatternContext reflectionContext,
            TypeDefinition type,
            Func<EventDefinition, bool> filter,
            BindingFlags? bindingFlags = BindingFlags.Default
        )
        {
        ...
        )
        {
            ...
            if (
                !AnalyzeGenericInstantiationTypeArray(
                    ...
                    ref reflectionContext,
                    reflectionMethod,
                    genericMethod.GenericParameters
                )
            )
            {
                reflectionContext.RecordUnrecognizedPattern(
        ...
        static DynamicallyAccessedMemberTypes GetDynamicallyAccessedMemberTypesFromBindingFlagsForNestedTypes(
            BindingFlags? bindingFlags
        ) =>
            (
                HasBindingFlag(bindingFlags, BindingFlags.Public)
        ...
        static DynamicallyAccessedMemberTypes GetDynamicallyAccessedMemberTypesFromBindingFlagsForConstructors(
            BindingFlags? bindingFlags
        ) =>
            (
                HasBindingFlag(bindingFlags, BindingFlags.Public)
        ...
        static DynamicallyAccessedMemberTypes GetDynamicallyAccessedMemberTypesFromBindingFlagsForMethods(
            BindingFlags? bindingFlags
        ) =>
            (
                HasBindingFlag(bindingFlags, BindingFlags.Public)
        ...
        static DynamicallyAccessedMemberTypes GetDynamicallyAccessedMemberTypesFromBindingFlagsForFields(
            BindingFlags? bindingFlags
        ) =>
            (
                HasBindingFlag(bindingFlags, BindingFlags.Public)
        ...
        static DynamicallyAccessedMemberTypes GetDynamicallyAccessedMemberTypesFromBindingFlagsForProperties(
            BindingFlags? bindingFlags
        ) =>
            (
                HasBindingFlag(bindingFlags, BindingFlags.Public)
        ...
        static DynamicallyAccessedMemberTypes GetDynamicallyAccessedMemberTypesFromBindingFlagsForEvents(
            BindingFlags? bindingFlags
        ) =>
            (
                HasBindingFlag(bindingFlags, BindingFlags.Public)
        ...
        static DynamicallyAccessedMemberTypes GetDynamicallyAccessedMemberTypesFromBindingFlagsForMembers(
            BindingFlags? bindingFlags
        ) =>
