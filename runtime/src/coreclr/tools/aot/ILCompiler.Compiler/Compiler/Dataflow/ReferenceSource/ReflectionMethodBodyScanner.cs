    ...
    sealed class ReflectionMethodBodyScanner : MethodBodyScanner
    {
        ...
        protected override ValueWithDynamicallyAccessedMembers GetMethodParameterValue(
            ...
            GetMethodParameterValue(
                parameter,
                _context.Annotations.FlowAnnotations.GetParameterAnnotation(parameter)
            );
        ...
        )
        {
            ...
            switch (intrinsicId)
            {
                ...
                {
                    if (
                        calledMethodDefinition.IsPInvokeImpl
                        && ComDangerousMethod(calledMethodDefinition, context)
                    )
        ...
        private static bool ComDangerousMethod(
            MethodDefinition methodDefinition,
            LinkContext context
        )
        {
            bool comDangerousMethod = IsComInterop(
                methodDefinition.MethodReturnType,
