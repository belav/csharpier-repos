...
namespace Mono.Linker.Dataflow
{
    sealed class ReflectionMethodBodyScanner : MethodBodyScanner
    {
        ...
        ValueWithDynamicallyAccessedMembers GetMethodParameterValue(
            MethodDefinition method,
            int parameterIndex,
        ...
        )
        {
            ...
            {
                if (parameterIndex == 0)
                    return _annotations.GetMethodThisParameterValue(
                        method,
            ...
            return _annotations.GetMethodParameterValue(
                method,
                parameterIndex,
                dynamicallyAccessedMemberTypes
            );
        ...
        protected override void HandleStoreMethodThisParameter(
            MethodDefinition method,
            ...
            switch (Intrinsics.GetIntrinsicIdForMethod(calledMethodDefinition))
            {
                ...
                case var fieldPropertyOrEvent
                    when (
                        ...
                        && calledMethod.DeclaringType.IsTypeOf(WellKnownType.System_Type)
                        && calledMethod.Parameters[0].ParameterType.IsTypeOf(
                            WellKnownType.System_String
                        )
                        && calledMethod.HasThis:
                case var getRuntimeMember
                    when getRuntimeMember == IntrinsicId.RuntimeReflectionExtensions_GetRuntimeEvent
                        || getRuntimeMember
                ...
                case var fieldOrPropertyIntrinsic
                    when fieldOrPropertyIntrinsic == IntrinsicId.Expression_Field
                        || fieldOrPropertyIntrinsic == IntrinsicId.Expression_Property:
        ...
        static bool IsComInterop(
            IMarshalInfoProvider marshalInfoProvider,
            ...
            if (nativeType == NativeType.None)
            {
                ...
                if (parameterTypeDef != null)
                {
                    if (parameterTypeDef.IsTypeOf(WellKnownType.System_Array))
                    {
                        ...
                        parameterTypeDef.IsTypeOf(WellKnownType.System_String)
