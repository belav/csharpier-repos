            ...
            foreach (var value in target)
            {
                switch (value)
                {
                    ...
                    case ParameterReferenceValue parameterReference
                        ...
                        HandleStoreMethodThisParameter(
                            method,
                            thisParameterValue,
                            operation,
                            source
        ...
        )
        {
            ...
            )
            {
                ...
                SingleValue newByRefValue = methodIsResolved
                    ? _context.Annotations.FlowAnnotations.GetMethodParameterValue(
