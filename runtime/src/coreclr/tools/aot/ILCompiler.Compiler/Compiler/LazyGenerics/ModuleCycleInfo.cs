...
namespace ILCompiler
{
    internal static partial class LazyGenericsSupport
    {
        ...
        internal sealed class GenericCycleDetector
        {
            ...
            {
                return IsDeepPossiblyCyclicInstantiation(method.Instantiation)
                    || IsDeepPossiblyCyclicInstantiation(method.OwningType);
            }
            ...
            public void DetectCycle(TypeSystemEntity owner, TypeSystemEntity referent)
            {
                ...
                EcmaModule ownerModule =
                    (ownerDefinition as EcmaType)?.EcmaModule
                    ?? ((EcmaMethod)ownerDefinition).Module;
