...
namespace ILCompiler.DependencyAnalysis
{
    ...
    public sealed class TypeGenericDictionaryNode : GenericDictionaryNode
    {
        ...
        public override bool ShouldSkipEmittingObjectNode(NodeFactory factory) =>
            GetDictionaryLayout(factory).IsEmpty;
        ...
        protected override DependencyList ComputeNonRelocationBasedDependencies(NodeFactory factory)
        {
            ...
            // Lazy generic use of the Activator.CreateInstance<T> heuristic requires tracking type parameters
            // that are used in lazy generics.
    ...
    public sealed class MethodGenericDictionaryNode : GenericDictionaryNode
    {
        ...
        )
        {
            ...
            // Lazy method dictionaries are generated by the compiler, but they have no entries within them.
            // (They are used solely to identify the exact method)
            // The dictionary layout may be filled in by various needs for generic lookups, but those are
            // handled in a lazy fashion.
