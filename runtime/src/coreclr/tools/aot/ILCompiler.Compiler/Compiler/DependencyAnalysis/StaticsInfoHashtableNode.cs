...
namespace ILCompiler.DependencyAnalysis
{
            ...
            INodeWithSize
    {
        ...
        public StaticsInfoHashtableNode(
            ...
            ExternalReferencesTableNode nativeStaticsReferences
        )
        {
        ...
        )
        {
            ...
            if (metadataType.GCStaticFieldSize.AsInt > 0)
            {
                dependencies.Add(
                    ...
                    "GC statics indirection for StaticsInfoHashtable"
                );
            }

            if (
                metadataType.NonGCStaticFieldSize.AsInt > 0
                || NonGCStaticsNode.TypeHasCctorContext(
            ...
            )
            {
                ...
                dependencies.Add(
                    ...
                    "Non-GC statics indirection for StaticsInfoHashtable"
                );
            }
        ...
        public override ObjectData GetData(NodeFactory factory, bool relocsOnly = false)
        {
            ...
            foreach (
                var metadataType in factory.MetadataManager.GetTypesWithGenericStaticBaseInfos()
            )
            {
                ...
                {
                    bag.AppendUnsigned(
                        BagElementKind.GcStaticData,
                        _nativeStaticsReferences.GetIndex(factory.TypeGCStaticsSymbol(metadataType))
                    );
                }
                if (
                    metadataType.NonGCStaticFieldSize.AsInt > 0
                ...
                {
                    bag.AppendUnsigned(
                        BagElementKind.NonGcStaticData,
                        _nativeStaticsReferences.GetIndex(
                            factory.TypeNonGCStaticsSymbol(metadataType)
                        )
                    );
                }
                ...
                {
                    bag.AppendUnsigned(
                        BagElementKind.ThreadStaticIndex,
                        _nativeStaticsReferences.GetIndex(
                            factory.TypeThreadStaticIndex(metadataType)
                        )
                    );
