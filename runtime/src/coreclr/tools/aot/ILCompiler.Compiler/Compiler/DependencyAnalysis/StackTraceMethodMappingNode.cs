...
namespace ILCompiler.DependencyAnalysis
{
    ...
    /// </summary>
    public sealed class StackTraceMethodMappingNode
        : ObjectNode,
            ...
            INodeWithSize
    {
        ...
        public override ObjectData GetData(NodeFactory factory, bool relocsOnly = false)
        {
            ...
            var mapping = new List<StackTraceMapping>(
                factory.MetadataManager.GetStackTraceMapping(factory)
            );
            ...
            mapping.Sort(
                (x, y) =>
                {
                    ...
                    Debug.Assert(
                        x.MethodInstantiationArgumentCollectionHandle
                            == y.MethodInstantiationArgumentCollectionHandle
                    );
            ...
            foreach (var entry in mapping)
            {
                ...
                if (currentName != entry.MethodNameHandle)
                {
                    ...
                    objData.EmitCompressedUInt(
                        (uint)(currentName & MetadataManager.MetadataOffsetMask)
                    );
                }
                ...
                if (currentSignature != entry.MethodSignatureHandle)
                {
                    ...
                    objData.EmitCompressedUInt(
                        (uint)(currentSignature & MetadataManager.MetadataOffsetMask)
                    );
                    ...
                    if (entry.MethodInstantiationArgumentCollectionHandle != 0)
                    {
                        ...
                        objData.EmitCompressedUInt(
                            (uint)(
                                entry.MethodInstantiationArgumentCollectionHandle
                ...
                objData.EmitReloc(
                    factory.MethodEntrypoint(entry.Method),
