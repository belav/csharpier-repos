    ...
    public sealed class GenericMethodsHashtableNode : ObjectNode, ISymbolDefinitionNode
    {
        ...
        public GenericMethodsHashtableNode(ExternalReferencesTableNode externalReferences)
        {
            _endSymbol = new ObjectAndOffsetSymbolNode(
                this,
                0,
                "__generic_methods_hashtable_End",
                true
            );
        ...
        public override ObjectData GetData(NodeFactory factory, bool relocsOnly = false)
        {
            ...
            {
                MethodGenericDictionaryNode methodDictionary =
                    dictionaryNode as MethodGenericDictionaryNode;
        ...
        )
        {
            ...
            dependencies.Add(
                new DependencyListEntry(dictionaryNode, "GenericMethodsHashtable entry dictionary")
            );
        }
