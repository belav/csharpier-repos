...
namespace ILCompiler.DependencyAnalysis
{
    ...
    /// </summary>
    public sealed class GenericMethodsHashtableNode
        : ObjectNode,
            ...
            INodeWithSize
    {
        ...
        public override ObjectData GetData(NodeFactory factory, bool relocsOnly = false)
        {
            ...
            foreach (
                MethodDesc method in factory.MetadataManager.GetGenericMethodHashtableEntries()
            )
            {
                Debug.Assert(
                    method.HasInstantiation && !method.IsCanonicalMethod(CanonicalFormKind.Any)
                );
                ...
                Vertex fullMethodSignature;
                {
                    ...
                    Vertex containingType = nativeWriter.GetUnsignedConstant(
                        _externalReferences.GetIndex(containingTypeNode)
                    );
                    ...
                    NativeLayoutVertexNode nameAndSig = factory.NativeLayout
                        .MethodNameAndSignatureVertex(method.GetTypicalMethodDefinition());
                    NativeLayoutSavedVertexNode placedNameAndSig = factory.NativeLayout
                    ...
                    fullMethodSignature = nativeWriter.GetTuple(
                        containingType,
                        placedNameAndSigVertexOffset,
                        arguments
                    );
                }
                ...
                Vertex dictionaryVertex = nativeWriter.GetUnsignedConstant(
                    _externalReferences.GetIndex(dictionaryNode)
                );
        ...
        public static void GetGenericMethodsHashtableDependenciesForMethod(
        ...
        )
        {
            ...
            dependencies.Add(
                new DependencyListEntry(
                    containingTypeNode,
                    "GenericMethodsHashtable entry containing type"
                )
            );
            ...
            for (int i = 0; i < method.Instantiation.Length; i++)
            {
                ...
                dependencies.Add(
                    new DependencyListEntry(
                        argNode,
                        "GenericMethodsHashtable entry instantiation argument"
                    )
                );
            }
