    ...
    public partial class NodeFactory
    {
        ...
        public class NativeLayoutHelper
        {
            ...
            private void CreateNodeCaches()
            {
                ...
                _callingConventionSlots = new NodeCache<
                    CallingConventionConverterKey,
                    NativeLayoutCallingConventionConverterGenericDictionarySlotNode
                >(key =>
                {
                    return new NativeLayoutCallingConventionConverterGenericDictionarySlotNode(
                        key.Signature,
                        key.ConverterKind
                    );
                });
                ...
                _typeSize_GenericDictionarySlots = new NodeCache<
                    TypeDesc,
                    NativeLayoutTypeSizeGenericDictionarySlotNode
                >(type =>
                {
                ...
                _castClass_GenericDictionarySlots = new NodeCache<
                    TypeDesc,
                    NativeLayoutCastClassGenericDictionarySlotNode
                >(type =>
                {
                    return new NativeLayoutCastClassGenericDictionarySlotNode(_factory, type);
                });

                _isInst_GenericDictionarySlots = new NodeCache<
                    TypeDesc,
                    NativeLayoutIsInstGenericDictionarySlotNode
                >(type =>
                {
                ...
                _allocateArray_GenericDictionarySlots = new NodeCache<
                    TypeDesc,
                    NativeLayoutAllocateArrayGenericDictionarySlotNode
                >(type =>
                {
                ...
                _fieldOffset_GenericDictionaryslots = new NodeCache<
                    FieldDesc,
                ...
                _vtableOffset_GenericDictionaryslots = new NodeCache<
                    MethodDesc,
                    NativeLayoutVTableOffsetGenericDictionarySlotNode
                >(method =>
                {
                ...
                _otherSlotPointerSlots = new NodeCache<
                    int,
                    NativeLayoutPointerToOtherSlotDictionarySlotNode
                >(otherSlotIndex =>
                {
            ...
            private NodeCache<
                CallingConventionConverterKey,
                NativeLayoutCallingConventionConverterGenericDictionarySlotNode
            > _callingConventionSlots;

            internal NativeLayoutCallingConventionConverterGenericDictionarySlotNode CallingConventionConverter(
                CallingConventionConverterKey key
            )
            {
            ...
            private NodeCache<
                TypeDesc,
                NativeLayoutTypeSizeGenericDictionarySlotNode
            > _typeSize_GenericDictionarySlots;

            public NativeLayoutTypeSizeGenericDictionarySlotNode TypeSizeDictionarySlot(
                TypeDesc type
            )
            {
            ...
            private NodeCache<
                TypeDesc,
                NativeLayoutCastClassGenericDictionarySlotNode
            > _castClass_GenericDictionarySlots;

            public NativeLayoutCastClassGenericDictionarySlotNode CastClassDictionarySlot(
                TypeDesc type
            )
            {
            ...
            private NodeCache<
                TypeDesc,
                NativeLayoutIsInstGenericDictionarySlotNode
            > _isInst_GenericDictionarySlots;
            ...
            private NodeCache<
                TypeDesc,
                NativeLayoutAllocateArrayGenericDictionarySlotNode
            > _allocateArray_GenericDictionarySlots;

            public NativeLayoutAllocateArrayGenericDictionarySlotNode AllocateArrayDictionarySlot(
                TypeDesc type
            )
            {
            ...
            private NodeCache<
                FieldDesc,
                NativeLayoutFieldOffsetGenericDictionarySlotNode
            > _fieldOffset_GenericDictionaryslots;

            public NativeLayoutFieldOffsetGenericDictionarySlotNode FieldOffsetDictionarySlot(
                FieldDesc field
            )
            {
            ...
            private NodeCache<
                MethodDesc,
                NativeLayoutVTableOffsetGenericDictionarySlotNode
            > _vtableOffset_GenericDictionaryslots;

            public NativeLayoutVTableOffsetGenericDictionarySlotNode VTableOffsetDictionarySlot(
                MethodDesc method
            )
            {
            ...
            private NodeCache<
                int,
                NativeLayoutPointerToOtherSlotDictionarySlotNode
            > _otherSlotPointerSlots;

            public NativeLayoutPointerToOtherSlotDictionarySlotNode PointerToOtherSlot(
                int otherSlotIndex
            )
            {
