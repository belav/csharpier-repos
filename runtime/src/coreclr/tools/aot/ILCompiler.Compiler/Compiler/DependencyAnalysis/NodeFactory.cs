...
namespace ILCompiler.DependencyAnalysis
{
    public abstract partial class NodeFactory
    {
        ...
        private void CreateNodeCaches()
        {
            ...
            _constructedTypeSymbols = new NodeCache<TypeDesc, IEETypeNode>(
                CreateConstructedTypeNode
            );
            ...
            _GCStaticsPreInitDataNodes = new NodeCache<MetadataType, GCStaticsPreInitDataNode>(
                (MetadataType type) =>
                {
            ...
            _uninitializedWritableDataBlobs = new NodeCache<
                UninitializedWritableDataBlobKey,
                BlobNode
            >(key =>
            {
                return new BlobNode(
            ...
            {
                MethodDesc canonMethod = methodKey.Method.GetCanonMethodTarget(
                ...
                {
                    return new ShadowConcreteMethodNode(
                        methodKey.Method,
            ...
            _virtMethods = new NodeCache<MethodDesc, VirtualMethodUseNode>(
                (MethodDesc method) =>
                {
            ...
            _vTableNodes = new NodeCache<TypeDesc, VTableSliceNode>(
                (TypeDesc type) =>
                {
        ...
        private NodeCache<
            UninitializedWritableDataBlobKey,
            BlobNode
        > _uninitializedWritableDataBlobs;

        public BlobNode UninitializedWritableDataBlob(Utf8String name, int size, int alignment)
        {
            return _uninitializedWritableDataBlobs.GetOrAdd(
                new UninitializedWritableDataBlobKey(name, size, alignment)
            );
        }
        ...
        public ArrayOfEmbeddedDataNode<EmbeddedObjectNode> FrozenSegmentRegion =
            new ArrayOfFrozenObjectsNode<EmbeddedObjectNode>(
        ...
        public virtual void AttachToDependencyGraph(DependencyAnalyzerBase<NodeFactory> graph)
        {
            ...
            ReadyToRunHeader.Add(
                ...
                FrozenSegmentRegion,
                FrozenSegmentRegion.StartSymbol,
        ...
        protected struct UninitializedWritableDataBlobKey
            : IEquatable<UninitializedWritableDataBlobKey>
        {
            public readonly Utf8String Name;
            ...
            public override bool Equals(object obj) =>
                obj is UninitializedWritableDataBlobKey
                && Equals((UninitializedWritableDataBlobKey)obj);
