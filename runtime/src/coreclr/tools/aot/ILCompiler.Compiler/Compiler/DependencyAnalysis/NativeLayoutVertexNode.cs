...
namespace ILCompiler.DependencyAnalysis
{
    ...
    internal abstract class NativeLayoutMethodEntryVertexNode : NativeLayoutSavedVertexNode
    {
        ...
        )
        {
            _method = method;
            _flags = flags;
            _methodSig = factory.NativeLayout
    ...
    internal abstract class NativeLayoutTypeSignatureVertexNode : NativeLayoutVertexNode
    {
            ...
            : NativeLayoutTypeSignatureVertexNode
        {
            ...
            public NativeLayoutFunctionPointerTypeSignatureVertexNode(
                NodeFactory factory,
                TypeDesc type
            )
                : base(type)
            {
                _sig = factory.NativeLayout
            ...
            public override Vertex WriteVertex(NodeFactory factory)
            {
                ...
                return GetNativeWriter(factory)
                    .GetFunctionPointerTypeSignature(_sig.WriteVertex(factory));
            }
        }
        ...
        : NativeLayoutMethodEntryVertexNode
    {
        ...
        public NativeLayoutTemplateMethodSignatureVertexNode(NodeFactory factory, MethodDesc method)
            : base(
                ...
                MethodEntryFlags.CreateInstantiatedSignature
                    | (NeedsEntrypoint(method) ? MethodEntryFlags.SaveEntryPoint : 0)
            ) { }
        ...
        public override IEnumerable<DependencyListEntry> GetStaticDependencies(NodeFactory context)
        {
            ...
            foreach (
                var dependency in context.NativeLayout
    ...
    public sealed class NativeLayoutTemplateMethodLayoutVertexNode : NativeLayoutSavedVertexNode
    {
        ...
        public override Vertex WriteVertex(NodeFactory factory)
        {
            ...
            )
            {
                ...
                NativeLayoutPlacedVertexSequenceVertexNode dictionaryLayout = factory.NativeLayout
    ...
    public sealed class NativeLayoutTemplateTypeLayoutVertexNode : NativeLayoutSavedVertexNode
    {
        ...
        public override IEnumerable<DependencyListEntry> GetStaticDependencies(NodeFactory context)
        {
            ...
            if (
                context.PreinitializationManager
        ...
        public override Vertex WriteVertex(NodeFactory factory)
        {
            ...
            if (_type.RuntimeInterfaces.Length > 0)
            {
                ...
                NativeLayoutPlacedVertexSequenceVertexNode implementedInterfaces =
            ...
            if (_isUniversalCanon)
            {
                ...
                foreach (FieldDesc field in _type.GetFields())
                {
                    ...
                    if (field.FieldType.IsGCPointer)
                    {
                        fieldTypeSignature = factory.NativeLayout
                            .PlacedSignatureVertex(
                                factory.NativeLayout
                                    .TypeSignatureVertex(
                                        field.Context.GetWellKnownType(WellKnownType.Object)
                ...
                {
                    Vertex placedFieldsLayout = factory.MetadataManager
                        .NativeLayoutInfo
                        .SignaturesSection
        ...
        : NativeLayoutGenericDictionarySlotNode
    {
        ...
        )
        {
            ...
            foreach (
                var dependency in factory.NativeLayout
                    .TemplateConstructableTypes(_method.OwningType)
            )
            {
                dependencies.Add(
        ...
        : NativeLayoutGenericDictionarySlotNode
    {
        ...
        )
        {
            ...
            var canonOwningType = (InstantiatedType)
                _field.OwningType.ConvertToCanonForm(CanonicalFormKind.Specific);
            FieldDesc canonField = factory.TypeSystemContext
                .GetFieldForInstantiatedType(_field.GetTypicalFieldDefinition(), canonOwningType);
