    ...
    internal partial class ILImporter
    {
        ...
        private void ImportCall(ILOpcode opcode, int token)
        {
            ...
            if (method.IsIntrinsic)
            {
                ...
                {
                    if (
                        _previousInstructionOffset >= 0
                        && _ilBytes[_previousInstructionOffset] == (byte)ILOpcode.ldtoken
                    )
                        return;
                }
            ...
            else if (directCall)
            {
                ...
                else
                {
                    ...
                    if (
                        ...
                        && targetMethod.OwningType.NormalizeInstantiation()
                    ...
                    )
                    {
                        ...
                        _dependencies.Add(
                            _compilation
                                .NodeFactory
                                .MaximallyConstructableType(concreteMethod.OwningType),
                            reason + " - inlining protection"
                        );
                    }
        ...
        private static bool IsRuntimeHelpersInitializeArrayOrCreateSpan(MethodDesc method)
        {
            if (method.IsIntrinsic)
            {
                ...
                if (name == "InitializeArray" || name == "CreateSpan")
                {
                    ...
                    if (owningType != null)
                    {
                        return owningType.Name == "RuntimeHelpers"
