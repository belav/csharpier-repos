...
namespace Mono.Linker.Tests.Cases.DataFlow
{
    ...
    public class ExceptionalDataFlow
    {
        ...
        [ExpectedWarning(
            "IL2072",
            nameof(RequireAll) + "(Type)",
            nameof(GetWithPublicProperties) + "()"
        )]
        ...
        [ExpectedWarning(
            "IL2072",
            nameof(RequireAll) + "(Type)",
            nameof(GetWithPublicConstructors) + "()"
        )]
        [ExpectedWarning(
            "IL2072",
            nameof(RequireAll) + "(Type)",
        ...
        [ExpectedWarning(
            "IL2072",
            nameof(RequireAll1) + "(Type)",
            nameof(GetWithPublicEvents) + "()",
            ProducedBy = ProducedBy.Analyzer
        )]
        [ExpectedWarning(
            "IL2072",
            nameof(RequireAll2) + "(Type)",
            nameof(GetWithPublicMethods) + "()"
        )]
        [ExpectedWarning(
            "IL2072",
        ...
        [ExpectedWarning(
            "IL2072",
            nameof(RequireAll5) + "(Type)",
            nameof(GetWithPublicEvents) + "()"
        )]
        [ExpectedWarning(
            "IL2072",
            nameof(RequireAll6) + "(Type)",
            nameof(GetWithPublicMethods) + "()",
            ProducedBy = ProducedBy.Analyzer
        )]
        [ExpectedWarning(
