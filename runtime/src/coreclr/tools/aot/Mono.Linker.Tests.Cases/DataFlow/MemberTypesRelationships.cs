    ...
    public class MemberTypesRelationships
    {
        ...
        [ExpectedWarning(
            ...
            nameof(DynamicallyAccessedMemberTypes)
                + "."
                + nameof(DynamicallyAccessedMemberTypes.PublicConstructors)
        )]
        [ExpectedWarning(
            "IL2067",
            ...
            nameof(DynamicallyAccessedMemberTypes)
                + "."
                + nameof(DynamicallyAccessedMemberTypes.NonPublicConstructors)
        )]
        [ExpectedWarning(
            "IL2067",
            ...
            nameof(DynamicallyAccessedMemberTypes)
                + "."
                + nameof(DynamicallyAccessedMemberTypes.PublicMethods)
        )]
        [ExpectedWarning(
            "IL2067",
            nameof(DataFlowTypeExtensions.RequiresAll),
            nameof(DynamicallyAccessedMemberTypes)
                + "."
        ...
        [ExpectedWarning(
            ...
            nameof(DynamicallyAccessedMemberTypes)
                + "."
                + nameof(DynamicallyAccessedMemberTypes.PublicParameterlessConstructor)
        )]
        [ExpectedWarning(
            "IL2067",
            nameof(DataFlowTypeExtensions.RequiresPublicConstructors),
        ...
        [ExpectedWarning(
            ...
            nameof(DynamicallyAccessedMemberTypes)
                + "."
                + nameof(DynamicallyAccessedMemberTypes.NonPublicMethods)
        )]
        [ExpectedWarning(
            "IL2067",
            nameof(DataFlowTypeExtensions.RequiresPublicConstructors),
        ...
        [ExpectedWarning(
            ...
            nameof(DynamicallyAccessedMemberTypes)
                + "."
                + nameof(DynamicallyAccessedMemberTypes.NonPublicFields)
        )]
        [ExpectedWarning(
            "IL2067",
            nameof(DataFlowTypeExtensions.RequiresPublicConstructors),
        ...
        [ExpectedWarning(
            "IL2067",
            nameof(DataFlowTypeExtensions.RequiresPublicFields),
            nameof(DynamicallyAccessedMemberTypes)
                + "."
                + nameof(DynamicallyAccessedMemberTypes.PublicFields)
        )]
        [ExpectedWarning(
            "IL2067",
            nameof(DataFlowTypeExtensions.RequiresNonPublicConstructors),
        ...
        [ExpectedWarning(
            ...
            nameof(DynamicallyAccessedMemberTypes)
                + "."
                + nameof(DynamicallyAccessedMemberTypes.NonPublicNestedTypes)
        )]
        [ExpectedWarning(
            "IL2067",
            nameof(DataFlowTypeExtensions.RequiresInterfaces),
            nameof(DynamicallyAccessedMemberTypes)
                + "."
        ...
        [ExpectedWarning(
            ...
            nameof(DynamicallyAccessedMemberTypes)
                + "."
                + nameof(DynamicallyAccessedMemberTypes.PublicNestedTypes)
        )]
        [ExpectedWarning(
            "IL2067",
            nameof(DataFlowTypeExtensions.RequiresInterfaces),
        ...
        [ExpectedWarning(
            ...
            nameof(DynamicallyAccessedMemberTypes)
                + "."
                + nameof(DynamicallyAccessedMemberTypes.NonPublicProperties)
        )]
        [ExpectedWarning(
            "IL2067",
            nameof(DataFlowTypeExtensions.RequiresPublicFields),
        ...
        [ExpectedWarning(
            "IL2067",
            nameof(DataFlowTypeExtensions.RequiresPublicProperties),
            nameof(DynamicallyAccessedMemberTypes)
                + "."
                + nameof(DynamicallyAccessedMemberTypes.PublicProperties)
        )]
        [ExpectedWarning(
            "IL2067",
            nameof(DataFlowTypeExtensions.RequiresNonPublicFields),
        ...
        [ExpectedWarning(
            ...
            nameof(DynamicallyAccessedMemberTypes)
                + "."
                + nameof(DynamicallyAccessedMemberTypes.NonPublicEvents)
        )]
        [ExpectedWarning(
            "IL2067",
            nameof(DataFlowTypeExtensions.RequiresPublicFields),
        ...
        [ExpectedWarning(
            "IL2067",
            nameof(DataFlowTypeExtensions.RequiresPublicEvents),
            nameof(DynamicallyAccessedMemberTypes)
                + "."
                + nameof(DynamicallyAccessedMemberTypes.PublicEvents)
        )]
        [ExpectedWarning(
            "IL2067",
            nameof(DataFlowTypeExtensions.RequiresNonPublicFields),
