...
namespace Mono.Linker.Tests.Cases.DataFlow
{
    ...
    public class MethodThisDataFlow
    {
        ...
        [ExpectedWarning(
            "IL2075",
            nameof(MethodThisDataFlowTypeTest.PropertyRequireThisNonPublicMethods) + ".get"
        )]
        ...
        [ExpectedWarning(
            "IL2075",
            nameof(MethodThisDataFlowTypeTest.PropertyRequireThisNonPublicMethods) + ".set"
        )]
        ...
        [ExpectedWarning(
            ...
            nameof(MethodThisDataFlowTypeTest)
                + "."
                + nameof(MethodThisDataFlowTypeTest.RequireThisNonPublicMethods),
            "'this'"
        )]
        ...
        [ExpectedWarning(
            "IL2070",
            "sourceType",
            nameof(TestFromParameterToThis),
...
namespace System
{
    class MethodThisDataFlowTypeTest : TestSystemTypeBase
    {
        ...
        [ExpectedWarning(
            "IL2082",
            nameof(MethodThisDataFlowTypeTest) + "." + nameof(RequireNonPublicMethods) + "(Type)",
            "'type' argument ",
            "in call to 'System.MethodThisDataFlowTypeTest.RequireNonPublicMethods(Type)'",
        ...
        [ExpectedWarning(
            "IL2082",
            nameof(MethodThisDataFlowTypeTest) + "." + nameof(RequirePublicMethods) + "(Type)"
        )]
        ...
        [ExpectedWarning("IL2083", nameof(PropagateToReturn), nameof(PropagateToReturn))]
        [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicMethods)]
        ...
        [ExpectedWarning(
            "IL2084",
            nameof(MethodThisDataFlowTypeTest) + "." + nameof(_requiresPublicConstructors),
        ...
        [ExpectedWarning("IL2085", nameof(PropagateToThis), nameof(RequireThisNonPublicMethods))]
        [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicMethods)]
