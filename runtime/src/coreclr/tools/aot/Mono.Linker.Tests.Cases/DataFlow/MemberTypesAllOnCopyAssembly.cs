...
namespace Mono.Linker.Tests.Cases.DataFlow
{
    ...
    [KeptTypeInAssembly(
        "base.dll",
        "Mono.Linker.Tests.Cases.DataFlow.Dependencies.MemberTypesAllBaseType"
    )]
    ...
    [KeptTypeInAssembly(
        "base.dll",
        "Mono.Linker.Tests.Cases.DataFlow.Dependencies.MemberTypesAllBaseType/PublicNestedType"
    )]
    [KeptMemberInAssembly(
        "base.dll",
        "Mono.Linker.Tests.Cases.DataFlow.Dependencies.MemberTypesAllBaseType/PublicNestedType",
        new string[] { "PrivateMethod()" }
    )]
    [KeptTypeInAssembly(
        "base.dll",
        "Mono.Linker.Tests.Cases.DataFlow.Dependencies.MemberTypesAllBaseType/PrivateNestedType"
    )]
    [KeptMemberInAssembly(
        "base.dll",
        "Mono.Linker.Tests.Cases.DataFlow.Dependencies.MemberTypesAllBaseType/PrivateNestedType",
