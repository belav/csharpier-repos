    ...
    public class GetInterfaceDataFlow
    {
        ...
        class GetInterface_Name
        {
            ...
            static void TestMultipleValues(
                int p,
                [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.All)] Type typeWithAll
            )
            {
                Type type;
                if (p == 0)
