...
namespace Mono.Linker.Tests.Cases.Expectations.Helpers
{
    public static class DataFlowStringExtensions
    {
        public static void RequiresAll(
            [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.All)] this string str
        )
        {
        }
        ...
        public static void RequiresInterfaces(
            [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.Interfaces)] this string str
        )
        {
        }
