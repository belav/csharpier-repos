...
namespace Internal.TypeSystem
{
    ...
    public abstract partial class DefType : TypeDesc
    {
        ...
        public virtual bool IsAutoLayoutOrHasAutoLayoutFields
        {
            get
            {
                ...
                return _fieldLayoutFlags.HasFlags(
                    FieldLayoutFlags.IsAutoLayoutOrHasAutoLayoutFields
                );
            }
        }
        ...
        {
            _valueTypeShapeCharacteristics = this
                .Context.GetLayoutAlgorithmForType(this)
