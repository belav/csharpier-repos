...
namespace Internal.TypeSystem.Ecma
{
    public partial class EcmaModule : ModuleDesc
    {
        ...
        internal class EcmaObjectLookupHashtable
        ...
        public sealed override MetadataType GetType(
            string nameSpace,
            string name,
        ...
        public TypeDesc GetType(EntityHandle handle)
        {
            ...
            if (type == null)
                ThrowHelper.ThrowBadImageFormatException(
                    $"type expected for handle {handle.ToString()}"
                );
            return type;
        }
        ...
        public MethodDesc GetMethod(EntityHandle handle)
        {
            ...
            if (method == null)
                ThrowHelper.ThrowBadImageFormatException(
                    $"method expected for handle {handle.ToString()}"
                );
            return method;
        }
        ...
        public FieldDesc GetField(EntityHandle handle)
        {
            ...
            if (field == null)
                ThrowHelper.ThrowBadImageFormatException(
                    $"field expected for handle {handle.ToString()}"
                );
            return field;
        }
        ...
        private Object ResolveExportedType(ExportedTypeHandle handle)
        {
            ...
            if (implementation is ModuleDesc)
            {
                ...
                MetadataType resolvedType = module.GetType(
                    nameSpace,
                    name,
                    NotFoundBehavior.ReturnResolutionFailure
                );
            ...
            else if (implementation is MetadataType)
            {
