...
namespace Internal.TypeSystem
{
    partial class TypeSystemContext
    {
        private struct RuntimeDeterminedTypeKey
        {
            ...
            public class RuntimeDeterminedTypeKeyHashtable
                : LockFreeReaderHashtable<RuntimeDeterminedTypeKey, RuntimeDeterminedType>
            {
                ...
                {
                    return value.RuntimeDeterminedDetailsType.GetHashCode()
                        ^ value.CanonicalType.GetHashCode();
                }
        ...
        private RuntimeDeterminedTypeKey.RuntimeDeterminedTypeKeyHashtable _runtimeDeterminedTypes =
            new RuntimeDeterminedTypeKey.RuntimeDeterminedTypeKeyHashtable();
        ...
        private struct MethodForRuntimeDeterminedTypeKey
        {
            ...
            )
            {
                ...
                _hashcode = TypeHashingAlgorithms.ComputeMethodHashCode(
                    rdType.CanonicalType.GetHashCode(),
        ...
        private MethodForRuntimeDeterminedTypeKey.MethodForRuntimeDeterminedTypeKeyHashtable _methodForRDTypes =
            new MethodForRuntimeDeterminedTypeKey.MethodForRuntimeDeterminedTypeKeyHashtable();
        ...
        )
        {
            ...
            return _methodForRDTypes.GetOrCreateValue(
