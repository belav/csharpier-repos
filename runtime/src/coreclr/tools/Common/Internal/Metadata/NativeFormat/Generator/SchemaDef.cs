...
public class MemberDef
{
    ...
    public string GetMemberType(MemberTypeKind kind = MemberTypeKind.Accessor)
    {
        ...
        if ((Flags & MemberDefFlags.RecordRef) != 0)
        {
            ...
            {
                typeName =
                    (kind == MemberTypeKind.WriterField)
                        ? (TypeName != null ? (string)TypeName : "MetadataRecord")
                        : $"{TypeName}Handle";
            }
        }
        else
    ...
    {
        return "_"
            + Char.ToLower(Name[0], System.Globalization.CultureInfo.InvariantCulture)
            + Name.Substring(1);
    }
...
public class RecordDef
{
    public RecordDef(
        ...
        RecordDefFlags flags = 0,
        string comment = null,
        MemberDef[] members = null
    )
    {
        Name = name;
...
class SchemaDef
{
        ...
        new RecordDef(
            ...
            members: new MemberDef[]
            {
                new MemberDef(
                    name: "PublicKey",
                    value: "0x1",
                    comment: "The assembly reference holds the full (unhashed) public key."
                ),
                new MemberDef(
                    name: "Retargetable",
                    value: "0x100",
                    comment: "The implementation of this assembly used at runtime is not expected to match the version seen at compile time."
                ),
                new MemberDef(
                    name: "DisableJITcompileOptimizer",
                    value: "0x4000",
                    comment: "Reserved."
                ),
                new MemberDef(
                    name: "EnableJITcompileTracking",
                    value: "0x8000",
                    comment: "Reserved."
                ),
            }
        ...
        new RecordDef(
            ...
            members: new MemberDef[]
            {
                new MemberDef(
                    name: "Property",
                    value: "0x0",
                    comment: "Specifies the name of a property"
                ),
                new MemberDef(
                    name: "Field",
                    value: "0x1",
                    comment: "Specifies the name of a field"
                ),
            }
        ),
        ...
        new RecordDef(
            ...
            members: new MemberDef[]
            {
                new MemberDef(
                    ...
                    value: "0x0",
                    comment: "Represents a type parameter for a generic type."
                ),
                new MemberDef(
                    name: "GenericMethodParameter",
                    value: "0x1",
                    comment: "Represents a type parameter from a generic method."
                ),
            }
        ),
        new RecordDef(
                ...
                new RecordDef(
                    ...
                    members: new MemberDef[]
                    {
                        new MemberDef(
                            name: "Value",
                            typeName: "Object",
                            flags: MemberDefFlags.NotPersisted
                        ),
                    }
                ),
                new RecordDef(
                    name: "ConstantStringValue",
                    members: new MemberDef[] { new MemberDef(name: "Value", typeName: "string") }
                ),
            }
        )
        .ToArray();
        ...
        select new RecordDef(
            ...
            members: new MemberDef[]
            {
                new MemberDef(
                    ...
                    flags: MemberDefFlags.Array
                        | (primitiveType.CustomCompare ? MemberDefFlags.CustomCompare : 0)
                ),
            }
        )
    )
            ...
            new RecordDef[]
            {
                new RecordDef(
                    ...
                    members: new MemberDef[]
                    {
                        new MemberDef(
                            name: "Value",
                            flags: MemberDefFlags.RecordRef | MemberDefFlags.List
                        ),
                    }
                ),
                new RecordDef(
    ...
    private static readonly RecordDef[] ConstantRecordSchema = ConstantValueRecordSchema
        .Concat(ConstantArrayRecordSchema)
        .OrderBy(record => record.Name, StringComparer.Ordinal)
        .ToArray();
    ...
    private static readonly string[] TypeDefOrRefOrSpecOrConstant = TypeDefOrRefOrSpec
        .Concat(from constantRecord in ConstantRecordSchema select constantRecord.Name)
        .ToArray();
    ...
    public static readonly RecordDef[] RecordSchema = new RecordDef[]
    {
        new RecordDef(
            ...
            members: new MemberDef[]
            {
                ...
                new MemberDef(
                    "NamespaceDefinition",
                    "NamespaceDefinition",
                    MemberDefFlags.RecordRef | MemberDefFlags.Compare
                ),
                new MemberDef(
                    "Name",
                    "ConstantStringValue",
                    MemberDefFlags.RecordRef | MemberDefFlags.Child | MemberDefFlags.Compare
                ),
                ...
                new MemberDef(
                    "NestedTypes",
                    "TypeDefinition",
                    MemberDefFlags.List | MemberDefFlags.RecordRef | MemberDefFlags.Child
                ),
                new MemberDef(
                    "Methods",
                    "Method",
                ...
                new MemberDef(
                    "Fields",
                    "Field",
                    MemberDefFlags.Map | MemberDefFlags.RecordRef | MemberDefFlags.Child
                ),
                new MemberDef(
                    "Properties",
                    "Property",
        ...
        new RecordDef(
            ...
            members: new MemberDef[]
            {
                new MemberDef(
                    ...
                    new string[] { "NamespaceReference", "TypeReference" },
                    MemberDefFlags.RecordRef
                ),
                new MemberDef(
                    "TypeName",
                    "ConstantStringValue",
                    MemberDefFlags.RecordRef | MemberDefFlags.Child | MemberDefFlags.Name
                ),
        ...
        new RecordDef(
            ...
            members: new MemberDef[]
            {
                new MemberDef(
                    "Signature",
                    TypeDefOrRef.Concat(TypeSig).ToArray(),
                    MemberDefFlags.RecordRef | MemberDefFlags.Child
                ),
                // COMPLETENESS: new MemberDef("CustomAttributes", "CustomAttribute", MemberDefFlags.List | MemberDefFlags.RecordRef | MemberDefFlags.Child),
            }
        ),
        ...
        new RecordDef(
            ...
            members: new MemberDef[]
            {
                new MemberDef(
                    ...
                    new string[] { "NamespaceDefinition", "ScopeDefinition" },
                    MemberDefFlags.RecordRef | MemberDefFlags.Compare
                ),
                new MemberDef(
                    "Name",
        ...
        new RecordDef(
            ...
            members: new MemberDef[]
            {
                new MemberDef(
                    "ParentScopeOrNamespace",
                    new string[] { "NamespaceReference", "ScopeReference" },
                    MemberDefFlags.RecordRef
                ),
                new MemberDef(
                    "Name",
        ...
        new RecordDef(
            ...
            members: new MemberDef[]
            {
                ...
                new MemberDef(
                    ...
                    MemberDefFlags.List
                        | MemberDefFlags.RecordRef
                        | MemberDefFlags.Child
                        | MemberDefFlags.EnumerateForHashCode
                ),
                new MemberDef(
                    "GenericParameters",
                    "GenericParameter",
        ...
        new RecordDef(
            ...
            members: new MemberDef[]
            {
                ...
                new MemberDef(
                    "Signature",
                    new string[] { "MethodSignature", "FieldSignature" },
                    MemberDefFlags.RecordRef | MemberDefFlags.Child
                ),
                // COMPLETENESS: new MemberDef("CustomAttributes", "CustomAttribute", MemberDefFlags.List | MemberDefFlags.RecordRef | MemberDefFlags.Child),
            }
        ...
        new RecordDef(
            ...
            members: new MemberDef[] { new MemberDef("Number", "int") }
        ),
        new RecordDef(
    ...
    /// </summary>
    public static readonly string[] HandleSchema = (
        from record in RecordSchema
        select record.Name
    ).ToArray();

    public static readonly string[] TypeNamesWithCollectionTypes = RecordSchema
        .SelectMany(r =>
