...
"
        ...
        static void WriteManagedThunkInterface(
            TextWriter tw,
...
"
            ...
            foreach (FunctionDecl decl in functionData)
            {
                ...
                tw.Write(
                    $"        static {decl.ReturnType.UnmanagedTypeName} _{decl.FunctionName}(IntPtr thisHandle, IntPtr* ppException"
                );
...
"
        ...
        static void API_Wrapper_Generic_Core(
            TextWriter tw,
            IEnumerable<FunctionDecl> functionData,
        ...
        static void API_Wrapper_Generic(
            TextWriter tw,
            IEnumerable<FunctionDecl> functionData,
            string header,
            string footer,
...
"
        ...
        static void SPMI_ShimCounter_ICorJitInfo(
            TextWriter tw,
            IEnumerable<FunctionDecl> functionData
        )
        {
...
",
        ...
        static void SPMI_ShimSimple_ICorJitInfo(
            TextWriter tw,
            IEnumerable<FunctionDecl> functionData
        )
        {
