...
namespace Internal.JitInterface
{
    partial internal unsafe class CorInfoImpl
    {
        ...
        [UnmanagedCallersOnly]
        private static byte* _getClassName(
            IntPtr thisHandle,
            IntPtr* ppException,
            CORINFO_CLASS_STRUCT_* cls
        )
        ...
        [UnmanagedCallersOnly]
        private static int _appendClassName(
            IntPtr thisHandle,
            IntPtr* ppException,
            char** ppBuf,
            int* pnBufLen,
        ...
        [UnmanagedCallersOnly]
        private static byte* _getHelperName(
            IntPtr thisHandle,
            IntPtr* ppException,
        ...
        [UnmanagedCallersOnly]
        private static byte* _getFieldName(
            IntPtr thisHandle,
            IntPtr* ppException,
        ...
        [UnmanagedCallersOnly]
        private static byte* _getMethodName(
            IntPtr thisHandle,
            IntPtr* ppException,
            CORINFO_METHOD_STRUCT_* ftn,
            byte** moduleName
        ...
        [UnmanagedCallersOnly]
        private static void* _getFieldAddress(
            IntPtr thisHandle,
            IntPtr* ppException,
            CORINFO_FIELD_STRUCT_* field,
            void** ppIndirection
        ...
        [UnmanagedCallersOnly]
        private static void _addActiveDependency(
            IntPtr thisHandle,
            IntPtr* ppException,
        ...
        private static IntPtr GetUnmanagedCallbacks()
        {
            ...
            callbacks[68] = (delegate* unmanaged<IntPtr, IntPtr*, CorInfoHelpFunc, byte*>)
                &_getHelperName;
            callbacks[69] = (delegate* unmanaged<
                ...
                &_initClass;
            callbacks[70] = (delegate* unmanaged<IntPtr, IntPtr*, CORINFO_CLASS_STRUCT_*, void>)
            ...
            callbacks[92] = (delegate* unmanaged<
                ...
                void>)
                &_getFieldInfo;
            callbacks[93] = (delegate* unmanaged<IntPtr, IntPtr*, CORINFO_FIELD_STRUCT_*, byte>)
                &_isFieldStatic;
            ...
            callbacks[105] = (delegate* unmanaged<
                ...
                CorInfoHFAElemType>)
                &_getHFAType;
            callbacks[106] = (delegate* unmanaged<IntPtr, IntPtr*, _EXCEPTION_POINTERS*, HRESULT>)
                &_GetErrorHRESULT;
            callbacks[107] = (delegate* unmanaged<IntPtr, IntPtr*, char*, uint, uint>)
                &_GetErrorMessage;
            callbacks[108] = (delegate* unmanaged<IntPtr, IntPtr*, _EXCEPTION_POINTERS*, int>)
                &_FilterException;
            callbacks[109] = (delegate* unmanaged<IntPtr, IntPtr*, HRESULT, void>)
                &_ThrowExceptionForJitResult;
            callbacks[110] = (delegate* unmanaged<IntPtr, IntPtr*, CORINFO_HELPER_DESC*, void>)
                &_ThrowExceptionForHelper;
            callbacks[111] = (delegate* unmanaged<IntPtr, IntPtr*, void*, void*, byte>)
                &_runWithErrorTrap;
            callbacks[112] = (delegate* unmanaged<IntPtr, IntPtr*, void*, void*, byte>)
                &_runWithSPMIErrorTrap;
            callbacks[113] = (delegate* unmanaged<IntPtr, IntPtr*, CORINFO_EE_INFO*, void>)
                &_getEEInfo;
            ...
            callbacks[118] = (delegate* unmanaged<IntPtr, IntPtr*, CORINFO_METHOD_STRUCT_*, uint>)
                &_getMethodHash;
            ...
            callbacks[121] = (delegate* unmanaged<IntPtr, IntPtr*, CORINFO_CLASS_STRUCT_*, uint>)
                &_getLoongArch64PassStructInRegisterFlags;
            callbacks[122] = (delegate* unmanaged<IntPtr, IntPtr*, void**, uint>)
                &_getThreadTLSIndex;
            callbacks[123] = (delegate* unmanaged<IntPtr, IntPtr*, void**, void*>)
                &_getInlinedCallFrameVptr;
            callbacks[124] = (delegate* unmanaged<IntPtr, IntPtr*, void**, int*>)
                &_getAddrOfCaptureThreadGlobal;
            callbacks[125] = (delegate* unmanaged<IntPtr, IntPtr*, CorInfoHelpFunc, void**, void*>)
                &_getHelperFtn;
            ...
            callbacks[138] = (delegate* unmanaged<IntPtr, IntPtr*, CORINFO_SIG_INFO*, byte>)
            ...
            callbacks[140] = (delegate* unmanaged<IntPtr, IntPtr*, bool*, void**, bool*, void>)
                &_GetProfilingHandle;
            ...
            callbacks[142] = (delegate* unmanaged<
                ...
                byte>)
                &_canAccessFamily;
            callbacks[143] = (delegate* unmanaged<IntPtr, IntPtr*, CORINFO_CLASS_STRUCT_*, byte>)
                &_isRIDClassDomainID;
            ...
            callbacks[147] = (delegate* unmanaged<
                ...
                IntPtr>)
                &_getVarArgsHandle;
            callbacks[148] = (delegate* unmanaged<IntPtr, IntPtr*, CORINFO_SIG_INFO*, byte>)
            ...
            callbacks[150] = (delegate* unmanaged<IntPtr, IntPtr*, void**, InfoAccessType>)
                &_emptyStringLiteral;
            ...
            callbacks[153] = (delegate* unmanaged<
                ...
                CORINFO_METHOD_STRUCT_*>)
                &_GetDelegateCtor;
            callbacks[154] = (delegate* unmanaged<IntPtr, IntPtr*, CORINFO_METHOD_STRUCT_*, void>)
            ...
            callbacks[157] = (delegate* unmanaged<IntPtr, IntPtr*, InstructionSet, byte, byte>)
                &_notifyInstructionSetUsage;
            callbacks[158] = (delegate* unmanaged<IntPtr, IntPtr*, CORINFO_CONST_LOOKUP*, void>)
                &_updateEntryPointForTailCall;
            callbacks[159] = (delegate* unmanaged<IntPtr, IntPtr*, AllocMemArgs*, void>)&_allocMem;
            callbacks[160] = (delegate* unmanaged<IntPtr, IntPtr*, byte, byte, uint, void>)
                &_reserveUnwindInfo;
            ...
            callbacks[164] = (delegate* unmanaged<IntPtr, IntPtr*, uint, CORINFO_EH_CLAUSE*, void>)
                &_setEHinfo;
            callbacks[165] = (delegate* unmanaged<IntPtr, IntPtr*, uint, byte*, IntPtr, byte>)
                &_logMsg;
            callbacks[166] = (delegate* unmanaged<IntPtr, IntPtr*, byte*, int, byte*, int>)
                &_doAssert;
            callbacks[167] = (delegate* unmanaged<IntPtr, IntPtr*, CorJitResult, void>)
                &_reportFatalError;
            ...
            callbacks[171] = (delegate* unmanaged<
                ...
                void>)
                &_recordRelocation;
            callbacks[172] = (delegate* unmanaged<IntPtr, IntPtr*, void*, ushort>)
                &_getRelocTypeHint;
            callbacks[173] = (delegate* unmanaged<IntPtr, IntPtr*, uint>)
                &_getExpectedTargetArchitecture;
            callbacks[174] = (delegate* unmanaged<IntPtr, IntPtr*, CORJIT_FLAGS*, uint, uint>)
                &_getJitFlags;
