...
namespace Internal.Reflection.Execution.PayForPlayExperience
{
    internal static partial class DiagnosticMappingTables
    {
        ...
        )
        {
            ...
            {
                diagnosticName = GetTypeFullNameFromTypeRef(
                    typeReferenceHandle,
                    reader,
        ...
        public static string ConvertBackTickNameToNameWithReducerInputFormat(
            string typename,
            List<int> genericParameterOffsets
        )
        {
            ...
            if (indexOfBackTick != -1)
            {
                ...
                if ((indexOfBackTick + 1) < typename.Length)
                {
                    ...
                    if (
                        int.TryParse(textAfterBackTick, out genericParameterCount)
        ...
        public static bool TryGetArrayTypeElementType(
        ...
        public static bool TryGetPointerTypeTargetType(
