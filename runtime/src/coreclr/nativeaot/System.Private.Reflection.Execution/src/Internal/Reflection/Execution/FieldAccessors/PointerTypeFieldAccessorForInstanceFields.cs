...
namespace Internal.Reflection.Execution.FieldAccessors
{
    ...
    {
        public PointerTypeFieldAccessorForInstanceFields(
        ...
        {
            return RuntimeAugments.LoadPointerTypeFieldValueFromValueType(
                typedReference,
                this.Offset,
                this.FieldTypeHandle
            );
        ...
        {
            RuntimeAugments.StoreValueTypeFieldValueIntoValueType(
                typedReference,
                this.Offset,
                value,
                typeof(IntPtr).TypeHandle
