...
namespace Internal.Reflection.Execution
{
    ...
    internal sealed partial class ExecutionEnvironmentImplementation : ExecutionEnvironment
    {
        ...
        public sealed override QTypeDefinition GetMetadataForNamedType(
        ...
        {
            return TypeLoaderEnvironment.TryGetNamedTypeForMetadata(
                qTypeDefinition,
        ...
        //
        public sealed override RuntimeTypeHandle GetArrayTypeElementType(
        ...
        //
        public sealed override RuntimeTypeHandle GetPointerTypeTargetType(
        ...
        public override bool TryGetFunctionPointerTypeForComponents(
        ...
        //
        public override void GetFunctionPointerTypeComponents(
            RuntimeTypeHandle functionPointerHandle,
            out RuntimeTypeHandle returnTypeHandle,
        ...
        //
        public sealed override unsafe RuntimeTypeHandle GetByRefTypeTargetType(
        ...
        //      genericTypeArgumentHandles is an array of valid RuntimeTypeHandles.
        //
        public sealed override unsafe bool TryGetConstructedGenericTypeForComponentsNoConstraintCheck(
            RuntimeTypeHandle genericTypeDefinitionHandle,
            RuntimeTypeHandle[] genericTypeArgumentHandles,
            out RuntimeTypeHandle runtimeTypeHandle
        )
        ...
        >[] GetLdFtnReverseLookups_InvokeMap()
        {
            ...
            {
                var ldFtnReverseLookupBuilder =
                    new ArrayBuilder<
                        KeyValuePair<NativeFormatModuleInfo, FunctionPointersToOffsets>
                    >();
                foreach (NativeFormatModuleInfo module in ModuleList.EnumerateModules())
                {
                    ldFtnReverseLookupBuilder.Add(
                        new KeyValuePair<NativeFormatModuleInfo, FunctionPointersToOffsets>(
                            module,
                            ComputeLdftnReverseLookup_InvokeMap(module)
                        )
                    );
                }
        ...
        )
        {
            ...
            if ((entryFlags & InvokeTableFlags.HasMetadataHandle) != 0)
            {
                ...
                QTypeDefinition qTypeDefinition = GetMetadataForNamedType(
            ...
            )
            {
                if (_returnTypeAndParametersTypesCache == null)
                {
                    ...
                    _returnTypeAndParametersHandlesCache = new Handle[
                        _methodBase.GetParametersAsSpan().Length + 1
                    ];
