...
namespace Internal.Reflection.Execution
{
    ...
    internal sealed partial class ExecutionEnvironmentImplementation : ExecutionEnvironment
    {
        ...
        public sealed override unsafe bool TryGetMetadataForNamedType(
        ...
        public sealed override unsafe bool TryGetNamedTypeForMetadata(
        ...
        public sealed override unsafe bool TryGetTypeReferenceForNamedType(
            RuntimeTypeHandle runtimeTypeHandle,
        ...
        public sealed override unsafe bool TryGetNamedTypeForTypeReference(
        ...
        //
        public sealed override unsafe bool TryGetArrayTypeForElementType(
        ...
        //
        public sealed override unsafe bool TryGetArrayTypeElementType(
        ...
        //
        public sealed override unsafe bool TryGetMultiDimArrayTypeForElementType(
            RuntimeTypeHandle elementTypeHandle,
            int rank,
            out RuntimeTypeHandle arrayTypeHandle
        )
        ...
        //
        public sealed override unsafe bool TryGetPointerTypeForTargetType(
        ...
        //
        public sealed override unsafe bool TryGetPointerTypeTargetType(
        ...
        //     targetTypeHandle is a valid RuntimeTypeHandle.
        //
        public sealed override unsafe bool TryGetByRefTypeForTargetType(
            RuntimeTypeHandle targetTypeHandle,
        ...
        //
        public sealed override unsafe bool TryGetByRefTypeTargetType(
        ...
        //
        public sealed override unsafe bool TryGetConstructedGenericTypeForComponents(
...
#pragma warning restore 0420
        ...
        private KeyValuePair<
            NativeFormatModuleInfo,
            FunctionPointersToOffsets
        >[] GetLdFtnReverseLookups_ExactInstantiations()
        {
#pragma warning disable 0420 // GetLdFtnReverseLookups_Helper treats its first parameter as volatile by using explicit Volatile operations
            return GetLdFtnReverseLookups_Helper(
            ...
            else
            {
                ...
                foreach (
                    KeyValuePair<
                        NativeFormatModuleInfo,
                        FunctionPointersToOffsets
                    > perModuleLookup in GetLdFtnReverseLookups_ExactInstantiations()
                )
                {
                    int startIndex;
                    int endIndex;
