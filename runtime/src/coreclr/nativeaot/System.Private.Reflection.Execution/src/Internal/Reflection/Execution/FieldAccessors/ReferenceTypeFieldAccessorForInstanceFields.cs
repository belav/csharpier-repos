...
namespace Internal.Reflection.Execution.FieldAccessors
{
    ...
    {
        public ReferenceTypeFieldAccessorForInstanceFields(
        ...
        {
            return RuntimeAugments.LoadReferenceTypeFieldValueFromValueType(
                typedReference,
                this.Offset
            );
        }
        ...
        {
            RuntimeAugments.StoreReferenceTypeFieldValueIntoValueType(
                typedReference,
                this.Offset,
                value
            );
