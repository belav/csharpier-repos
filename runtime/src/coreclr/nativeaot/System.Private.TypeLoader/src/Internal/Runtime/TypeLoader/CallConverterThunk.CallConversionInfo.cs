...
namespace Internal.Runtime.TypeLoader
{
    ...
    internal class CallConversionInfo : IEquatable<CallConversionInfo>
    {
        ...
        private static LowLevelDictionary<CallConversionInfo, int> s_callConvertersCache =
            new LowLevelDictionary<CallConversionInfo, int>();
        ...
        internal string ThunkKindString()
        {
            switch (_thunkKind)
            {
                case ThunkKind.StandardToStandardInstantiating:
                    return "StandardToStandardInstantiating";
                case ThunkKind.StandardToGenericInstantiating:
                    return "StandardToGenericInstantiating";
                case ThunkKind.StandardToGenericInstantiatingIfNotHasThis:
                    return "StandardToGenericInstantiatingIfNotHasThis";
                case ThunkKind.StandardToGenericPassthruInstantiating:
                    return "StandardToGenericPassthruInstantiating";
                case ThunkKind.StandardToGenericPassthruInstantiatingIfNotHasThis:
                    return "StandardToGenericPassthruInstantiatingIfNotHasThis";
                case ThunkKind.StandardToGeneric:
                    return "StandardToGeneric";
                case ThunkKind.GenericToStandard:
                    return "GenericToStandard";
                case ThunkKind.StandardUnboxing:
                    return "StandardUnboxing";
                case ThunkKind.StandardUnboxingAndInstantiatingGeneric:
                    return "StandardUnboxingAndInstantiatingGeneric";
                case ThunkKind.GenericToStandardWithTargetPointerArg:
                    return "GenericToStandardWithTargetPointerArg";
        ...
        {
            if (_registrationKind != other._registrationKind)
                return false;
            if (_thunkKind != other._thunkKind)
                return false;
            if (_targetFunctionPointer != other._targetFunctionPointer)
                return false;
            if (_instantiatingArg != other._instantiatingArg)
                return false;
            ...
            switch (_registrationKind)
            {
                ...
                {
                    return (
                        _methodSignature.StructuralEquals(other._methodSignature)
        ...
        public override int GetHashCode()
        {
            if (!_hashCode.HasValue)
            {
                int hashCode =
                    79
                    + 971 * (int)_thunkKind
                    + 83 * (_targetFunctionPointer.GetHashCode() >> 7)
                    + 13 * (_instantiatingArg.GetHashCode() >> 3);
                switch (_registrationKind)
                {
                    case CallConversionInfoRegistrationKind.UsesMethodSignatureAndGenericArgs:
                ...
                TypeSystemContext context = TypeSystemContextFactory.Create();
                {
                    ...
                    )
                    {
                        ...
                        Environment.FailFast(
                            "Failed to get type handles for parameters in method signature"
                        );
                    }
                    ...
                    TypeHandle thReturnType = new TypeHandle(
                        CallConverterThunk.GetByRefIndicatorAtIndex(0, byRefParameters),
                        parameterHandles[0]
                    );
                    ...
                    if (parameters.Length > 1)
                    {
                        ...
                        for (int i = 1; i < parameters.Length; i++)
                        {
                            thParameters[i - 1] = new TypeHandle(
                                CallConverterThunk.GetByRefIndicatorAtIndex(i, byRefParameters),
                                parameterHandles[i]
                            );
                        }
                    }

                    _argIteratorData = new ArgIteratorData(
                        hasThis,
                        false,
                        thParameters,
                        thReturnType
        ...
        public static int RegisterCallConversionInfo(
            ThunkKind thunkKind,
        ...
        )
        {
            ...
            newConversionInfo._registrationKind =
                CallConversionInfoRegistrationKind.UsesMethodSignatureAndGenericArgs;
        ...
        )
        {
            CallConversionInfo newConversionInfo = new CallConversionInfo();
            newConversionInfo._registrationKind =
                CallConversionInfoRegistrationKind.UsesArgIteratorData;
            newConversionInfo._thunkKind = thunkKind;
            newConversionInfo._targetFunctionPointer = targetPointer;
            newConversionInfo._instantiatingArg = instantiatingArg;
            newConversionInfo._argIteratorData = new ArgIteratorData(
                hasThis,
                false,
                parameterTypes,
                returnType
        ...
        private static int AddConverter(CallConversionInfo newConversionInfo)
        {
            using (LockHolder.Hold(s_callConvertersCacheLock))
            {
                ...
                {
                    Debug.Assert(
                        (uint)converterId < (uint)s_callConvertersCount
                            && s_callConverters[converterId].Equals(newConversionInfo)
                    );
                    return converterId;
                }
                ...
                {
                    CallConversionInfo[] newArray = new CallConversionInfo[
                        s_callConverters.Length * 2
                    ];
        ...
        {
            get { return _targetFunctionPointer; }
        }
        ...
        public bool CalleeMayHaveParamType
        {
            ...
            {
                return _thunkKind
                    == ThunkKind.GenericToStandardWithTargetPointerArgAndMaybeParamArg;
            }
        }
        ...
        public bool IsOpenInstanceDelegateThunk
        {
            get { return _thunkKind == ThunkKind.DelegateInvokeOpenInstanceThunk; }
        }

        public bool IsClosedStaticDelegate
        {
            get { return _thunkKind == ThunkKind.DelegateInvokeClosedStaticThunk; }
        }

        public bool IsMulticastDelegate
        {
            get { return _thunkKind == ThunkKind.DelegateMulticastThunk; }
        }

        public bool IsObjectArrayDelegateThunk
        {
            get { return _thunkKind == ThunkKind.DelegateObjectArrayThunk; }
        }

        public bool IsDelegateDynamicInvokeThunk
        {
            get { return _thunkKind == ThunkKind.DelegateDynamicInvokeThunk; }
        }

        public bool IsReflectionDynamicInvokerThunk
        {
            get { return _thunkKind == ThunkKind.ReflectionDynamicInvokeThunk; }
        }
        ...
        public bool HasKnownTargetPointerAndInstantiatingArgument
        {
            get
            {
                ...
                if (
                    ...
                    || IsDelegateThunk
                    || IsAnyDynamicInvokerThunk
                    || _targetFunctionPointer == IntPtr.Zero
                )
                    return false;
                ...
                return _thunkKind == ThunkKind.StandardToGeneric
                    || _thunkKind == ThunkKind.GenericToStandard
                    || _thunkKind == ThunkKind.StandardUnboxing;
            }
        }
