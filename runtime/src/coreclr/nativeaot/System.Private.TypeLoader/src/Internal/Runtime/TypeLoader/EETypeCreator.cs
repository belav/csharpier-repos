    ...
    internal static unsafe class EETypeCreator
    {
        ...
        )
        {
            ...
            try
            {
                ...
                OptionalFieldsRuntimeBuilder optionalFields = new OptionalFieldsRuntimeBuilder(
                    pTemplateEEType->OptionalFieldsPtr
                );
                ...
                if (hasSealedVTable)
                {
                    ...
                    *((void**)((byte*)pEEType + cbSealedVirtualSlotsTypeOffset)) =
                        pTemplateEEType->GetSealedVirtualTable();
                }
        ...
        public static RuntimeTypeHandle CreateFunctionPointerEEType(
            uint hashCodeOfNewType,
        ...
        )
        {
            ...
            CreateEETypeWorker(
                typeof(delegate* <void>).TypeHandle.ToEETypePtr(),
                hashCodeOfNewType,
                0,
                state
            );
            ...
            TypeLoaderLogger.WriteLine(
                "Allocated new FUNCTION POINTER type "
                    + functionPointerType.ToString()
            ...
            state.HalfBakedRuntimeTypeHandle.ToEETypePtr()->FunctionPointerReturnType =
                returnTypeHandle.ToEETypePtr();
            Debug.Assert(
