    ...
    public sealed partial class TypeLoaderEnvironment
    {
        ...
        )
        {
            if (signature1.IsNativeLayoutSignature && signature2.IsNativeLayoutSignature)
            {
                ...
                NativeFormatModuleInfo module1 = ModuleList.Instance
                ...
                NativeFormatModuleInfo module2 = ModuleList.Instance
            ...
            else if (signature1.IsNativeLayoutSignature)
            {
                ...
                MetadataReader metadataReader = ModuleList.Instance
        ...
        )
        {
            ...
            else
            {
                ...
                var methodHandle = signature.Signature
                    .Token
                    .AsHandle()
        ...
        public MethodNameAndSignature GetMethodNameAndSignatureFromNativeLayoutOffset(
        ...
        private static bool TryGetTypeFromSimpleTypeSignature(
            ref NativeParser parser,
        ...
        private static bool CompareMethodSigs(
        ...
        private static bool CompareTypeSigs(
