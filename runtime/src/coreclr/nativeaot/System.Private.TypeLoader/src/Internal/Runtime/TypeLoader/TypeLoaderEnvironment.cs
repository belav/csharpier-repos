...
namespace Internal.Runtime.TypeLoader
{
    ...
    {
        public override bool TryGetOwningTypeForMethodDictionary(
            IntPtr dictionary,
            out RuntimeTypeHandle owningType
        )
        {
            // PERF: computing NameAndSignature and the instantiation (that we discard) was useless
            return TypeLoaderEnvironment.Instance.TryGetGenericMethodComponents(
                dictionary,
                out owningType,
                out _,
                out _
        ...
        )
        {
            ...
            return TypeLoaderEnvironment.InstanceOrNull.GetThreadStaticGCDescForDynamicType(
                typeManagerHandle,
                (uint)index
            );
        }
    ...
    public sealed partial class TypeLoaderEnvironment
    {
        ...
        //
        public MethodDesc GetMethodFromSignatureAndContext(
        ...
        public bool TryGetFunctionPointerTypeForComponents(
        ...
        public bool TryLookupFunctionPointerTypeForComponents(
            RuntimeTypeHandle returnTypeHandle,
            RuntimeTypeHandle[] parameterHandles,
            bool isUnmanaged,
            out RuntimeTypeHandle runtimeTypeHandle
        )
        {
            ...
            if (
                !RuntimeAugments.IsDynamicType(returnTypeHandle)
                && AllNonDynamicTypes(parameterHandles)
                && TryGetStaticFunctionPointerTypeForComponents(
                    returnTypeHandle,
                    parameterHandles,
                    isUnmanaged,
                    out runtimeTypeHandle
        ...
        )
        {
            ...
            if (
                ...
                && TryGetArrayTypeForNonDynamicElementType(
                    elementTypeHandle,
                    isMdArray,
                    rank,
                    out arrayTypeHandle
        ...
        public static bool TryGetPointerTypeForTargetType_LookupOnly(
            RuntimeTypeHandle pointeeTypeHandle,
            out RuntimeTypeHandle pointerTypeHandle
        )
        {
            ...
            if (
                !RuntimeAugments.IsDynamicType(pointeeTypeHandle)
                && TryGetPointerTypeForNonDynamicElementType(
                    pointeeTypeHandle,
                    out pointerTypeHandle
                )
            )
        ...
        public static bool TryGetByRefTypeForTargetType_LookupOnly(
            RuntimeTypeHandle pointeeTypeHandle,
            out RuntimeTypeHandle pointerTypeHandle
        )
        {
        ...
        private static object TryParseNativeSignatureWorker(
        ...
        )
        {
            ...
            InstantiatedMethod methodBeingLoaded = (InstantiatedMethod)
                context.ResolveGenericMethodInstantiation(
                    false,
                    declaringType,
                    nameAndSignature,
                    context.ResolveRuntimeTypeHandles(genericMethodArgHandles),
                    IntPtr.Zero,
                    false
                );
            ...
            if (
                TryLookupGenericMethodDictionary(
                    new MethodDescBasedGenericMethodLookup(methodBeingLoaded),
            ...
            using (_typeLoaderLock.EnterScope())
            {
                bool success = TypeBuilder.TryBuildGenericMethod(
                    methodBeingLoaded,
                    out methodDictionary
                );
