            ...
            else
            {
                ...
                if (conversionParams._conversionInfo.IsObjectArrayDelegateThunk)
                {
                    ...
                    else
                    {
                        returnValueToCopy = (void*)&pinnedResultObject;
#if TARGET_X86
                        ((TransitionBlock*)callerTransitionBlock)->m_returnBlock.returnValue =
                            pinnedResultObject;
#endif
                    }
                }
...
#error Platform not implemented
        ...
        )
        {
            ...
            ((TransitionBlock*)callerTransitionBlock)->m_argumentRegisters.ecx = new IntPtr(
                argStackPopSize
            );
#else
