...
namespace Internal.Runtime.TypeLoader
{
    ...
    {
        public static bool CompareTypeReferenceAcrossModules(
            TypeReferenceHandle tr1,
            MetadataReader mr1,
            TypeReferenceHandle tr2,
            MetadataReader mr2
        )
        {
            ...
            if (
                trData1.ParentNamespaceOrType.HandleType != trData2.ParentNamespaceOrType.HandleType
            )
                return false;

            if (trData1.ParentNamespaceOrType.HandleType == HandleType.TypeReference)
                return CompareTypeReferenceAcrossModules(
                    trData1.ParentNamespaceOrType.ToTypeReferenceHandle(mr1),
                    mr1,
                    trData2.ParentNamespaceOrType.ToTypeReferenceHandle(mr2),
                    mr2
                );

            return CompareNamespaceReferenceAcrossModules(
                trData1.ParentNamespaceOrType.ToNamespaceReferenceHandle(mr1),
                mr1,
                trData2.ParentNamespaceOrType.ToNamespaceReferenceHandle(mr2),
                mr2
            );
        }

        public static bool CompareNamespaceReferenceAcrossModules(
            NamespaceReferenceHandle nr1,
            MetadataReader mr1,
            NamespaceReferenceHandle nr2,
            MetadataReader mr2
        )
        {
            ...
            if (
                nrData1.ParentScopeOrNamespace.HandleType
                != nrData1.ParentScopeOrNamespace.HandleType
            )
                return false;
            ...
            if (nrData1.ParentScopeOrNamespace.HandleType == HandleType.NamespaceReference)
                return CompareNamespaceReferenceAcrossModules(
                    nrData1.ParentScopeOrNamespace.ToNamespaceReferenceHandle(mr1),
                    mr1,
                    nrData2.ParentScopeOrNamespace.ToNamespaceReferenceHandle(mr2),
                    mr2
                );

            return CompareScopeReferenceAcrossModules(
                nrData1.ParentScopeOrNamespace.ToScopeReferenceHandle(mr1),
                mr1,
                nrData2.ParentScopeOrNamespace.ToScopeReferenceHandle(mr2),
                mr2
            );
        }

        public static bool CompareScopeReferenceAcrossModules(
            ScopeReferenceHandle sr1,
            MetadataReader mr1,
            ScopeReferenceHandle sr2,
            MetadataReader mr2
        )
        {
        ...
        )
        {
            ...
            switch (trData1.ParentNamespaceOrType.HandleType)
            {
                case HandleType.TypeReference:
                    ...
                    return CompareTypeReferenceToDefinition(
                        trData1.ParentNamespaceOrType.ToTypeReferenceHandle(mr1),
                        mr1,
                        tdData2.EnclosingType,
                        mr2
                    );

                case HandleType.NamespaceReference:
                    return CompareNamespaceReferenceToDefinition(
                        trData1.ParentNamespaceOrType.ToNamespaceReferenceHandle(mr1),
                        mr1,
                        tdData2.NamespaceDefinition,
                        mr2
                    );
        ...
        public static bool CompareNamespaceReferenceToDefinition(
            NamespaceReferenceHandle nr1,
            MetadataReader mr1,
            NamespaceDefinitionHandle nd2,
            MetadataReader mr2
        )
        {
            NamespaceReference nrData1 = mr1.GetNamespaceReference(nr1);
            ...
            switch (nrData1.ParentScopeOrNamespace.HandleType)
            {
                case HandleType.NamespaceReference:
                    ...
                    return CompareNamespaceReferenceToDefinition(
                        nrData1.ParentScopeOrNamespace.ToNamespaceReferenceHandle(mr1),
                        mr1,
                        ndData2.ParentScopeOrNamespace.ToNamespaceDefinitionHandle(mr2),
                        mr2
                    );
                ...
                case HandleType.ScopeReference:
                    ...
                    return CompareScopeReferenceToDefinition(
                        nrData1.ParentScopeOrNamespace.ToScopeReferenceHandle(mr1),
                        mr1,
                        ndData2.ParentScopeOrNamespace.ToScopeDefinitionHandle(mr2),
                        mr2
                    );
        ...
        public static bool CompareScopeReferenceToDefinition(
            ScopeReferenceHandle sr1,
            MetadataReader mr1,
            ScopeDefinitionHandle sd2,
            MetadataReader mr2
        )
        {
            ScopeReference srData1 = mr1.GetScopeReference(sr1);
