...
namespace System.Reflection.Runtime.General
{
    internal sealed class ReflectionCoreCallbacksImplementation : ReflectionCoreCallbacks
    {
        ...
        public sealed override Assembly Load(AssemblyName assemblyRef, bool throwOnFileNotFound)
        {
            ...
            if (throwOnFileNotFound)
                ...
                return RuntimeAssemblyInfo.GetRuntimeAssemblyIfExists(
                    assemblyRef.ToRuntimeAssemblyName()
                );
        }
        ...
        //
        public sealed override MethodBase GetMethodFromHandle(
        ...
        )
        {
            ...
            if (
                !executionEnvironment.TryGetMethodFromHandle(
                    runtimeMethodHandle,
        ...
        )
        {
            ...
            RuntimeTypeHandle[] genericMethodTypeArgumentHandles;
            if (
                !executionEnvironment.TryGetMethodFromHandleAndType(
                    runtimeMethodHandle,
                    declaringTypeHandle,
                    out methodHandle,
                    out genericMethodTypeArgumentHandles
        ...
        public sealed override FieldInfo GetFieldFromHandle(RuntimeFieldHandle runtimeFieldHandle)
        {
            ...
            RuntimeTypeHandle declaringTypeHandle;
            if (
                !executionEnvironment.TryGetFieldFromHandle(
                    runtimeFieldHandle,
                    out declaringTypeHandle,
                    out fieldHandle
                )
            ...
            if (fieldInfo.DeclaringType.IsConstructedGenericType) // For compat with desktop, insist that the caller pass us the declaring type to resolve members of generic types.
                throw new ArgumentException(
                    SR.Format(SR.Argument_FieldDeclaringTypeGeneric, fieldInfo)
                );
            return fieldInfo;
        }
        ...
        //
        public sealed override FieldInfo GetFieldFromHandle(
        ...
        )
        {
            ...
            FieldHandle fieldHandle;
            if (
                !executionEnvironment.TryGetFieldFromHandleAndType(
                    runtimeFieldHandle,
                    declaringTypeHandle,
                    out fieldHandle
                )
        ...
        )
        {
            ...
            return NativeFormatRuntimeFieldInfo.GetRuntimeFieldInfo(
                fieldHandle,
                definingTypeInfo,
                contextTypeInfo,
                reflectedType
        ...
        {
            return ActivatorImplementation.CreateInstance(
                type,
                bindingAttr,
                binder,
                args,
        ...
        private static Delegate CreateDelegateWorker(
            Type type,
            object firstArgument,
            MethodInfo method,
            bool throwOnBindFailure,
        ...
        )
        {
            ...
            Delegate result = runtimeMethodInfo.CreateDelegateNoThrowOnBindFailure(
                runtimeDelegateType,
                firstArgument,
                allowClosed
            );
        ...
        )
        {
            ...
            RuntimeMethodInfo runtimeMethodInfo = LookupMethodForCreateDelegate(
                runtimeDelegateType,
                runtimeContainingType,
                method,
                isStatic: false,
            ...
            return runtimeMethodInfo.CreateDelegateWithoutSignatureValidation(
                type,
                target,
                isStatic: false,
                isOpen: false
        ...
        //
        private static RuntimeMethodInfo LookupMethodForCreateDelegate(
            RuntimeTypeInfo runtimeDelegateType,
            [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.All)]
                RuntimeTypeInfo containingType,
            string method,
            bool isStatic,
            bool ignoreCase
        )
        {
            ...
            {
                MethodInfo methodInfo = containingType.GetMethod(
                    method,
                    0,
                    bindingFlags,
                    null,
...
#pragma warning restore
        ...
        public sealed override IntPtr GetFunctionPointer(
            RuntimeMethodHandle runtimeMethodHandle,
            RuntimeTypeHandle declaringTypeHandle
        )
        {
            ...
            switch (method)
            {
                ...
                default:
                    Debug.Fail(
                        "RuntimeMethodHandle should only return a methodbase implemented by the runtime."
                    );
        ...
        public sealed override void MakeTypedReference(
            object target,
            FieldInfo[] flds,
            out Type type,
            out int offset
        ...
        public sealed override Assembly[] GetLoadedAssemblies() =>
            RuntimeAssemblyInfo.GetLoadedAssemblies();

        public sealed override EnumInfo GetEnumInfo(Type type) =>
            type.CastToRuntimeTypeInfo().EnumInfo;
    }
}
