...
namespace System.Reflection.Runtime.MethodInfos
{
            ...
            IEquatable<TRuntimeMethodCommon>
    {
        ...
        {
            get { return _common.Attributes; }
        }

        public sealed override CallingConventions CallingConvention
        {
            get { return _common.CallingConvention; }
        }
        ...
        {
            get { return _common.MethodImplementationFlags; }
        }
        ...
        {
            get { return _common.MetadataToken; }
        }
        ...
        public sealed override RuntimeMethodHandle MethodHandle =>
            _common.GetRuntimeMethodHandle(null);

        protected sealed override RuntimeParameterInfo[] RuntimeParameters
        {
            get
            {
                return _lazyParameters ??= RuntimeMethodHelpers.GetRuntimeParameters(
                    ref _common,
                    this,
                    Array.Empty<RuntimeTypeInfo>(),
                    out _
            ...
            get
            {
                if (_common.DefiningTypeInfo.IsAbstract)
                    throw new MemberAccessException(
                        SR.Format(SR.Acc_CreateAbstEx, _common.DefiningTypeInfo.FullName)
                    );
                ...
                invoker = _common.GetUncachedMethodInvoker(
                    Array.Empty<RuntimeTypeInfo>(),
                    this,
