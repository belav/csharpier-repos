    ...
    internal abstract partial class RuntimeTypeInfo
    {
        ...
        private MemberInfo GetDeclaredMemberWithSameMetadataDefinitionAs(MemberInfo member)
        {
            return member.MemberType switch
            {
                ...
                MemberTypes.Constructor => QueryMemberWithSameMetadataDefinitionAs(
                    ConstructorPolicies.Instance,
                    member
                ),
                ...
                MemberTypes.Field => QueryMemberWithSameMetadataDefinitionAs(
                    FieldPolicies.Instance,
                    member
                ),
                MemberTypes.Event => QueryMemberWithSameMetadataDefinitionAs(
                    EventPolicies.Instance,
                    member
                ),
                MemberTypes.NestedType => QueryMemberWithSameMetadataDefinitionAs(
                    NestedTypePolicies.Instance,
                    member
                ),
                _ => null,
        ...
        private M QueryMemberWithSameMetadataDefinitionAs<M>(
            MemberPolicies<M> policies,
            MemberInfo member
        )
            where M : MemberInfo
