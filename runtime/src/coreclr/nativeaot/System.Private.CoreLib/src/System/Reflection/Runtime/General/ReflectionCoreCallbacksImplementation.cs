...
#pragma warning restore
        ...
        public sealed override EnumInfo<TUnderlyingValue> GetEnumInfo<TUnderlyingValue>(Type type)
        {
            ...
            EnumInfo<TUnderlyingValue>? info =
                runtimeType.GenericCache as EnumInfo<TUnderlyingValue>;
            if (info != null)
                return info;
            ...
            ArraySortHelper<object, string>.IntrospectiveSort(
                unsortedValues,
                unsortedNames,
                EnumUnderlyingTypeComparer.Instance
            );
            ...
            info = new EnumInfo<TUnderlyingValue>(
                RuntimeAugments.GetEnumUnderlyingType(runtimeType.TypeHandle),
                values,
                unsortedNames,
                isFlags
            );
        ...
        {
            public static readonly EnumUnderlyingTypeComparer Instance =
                new EnumUnderlyingTypeComparer();
        ...
        public sealed override DynamicInvokeInfo GetDelegateDynamicInvokeInfo(Type type)
        {
            ...
            IntPtr invokeThunk =
                ReflectionCoreExecution.ExecutionDomain.ExecutionEnvironment.GetDynamicInvokeThunk(
                    methodInvoker
                );
