...
namespace System
{
    public abstract partial class Attribute
    {
        ...
        public static Attribute GetCustomAttribute(
            ...
            Type attributeType,
            bool inherit
        ) => GetCustomAttribute(element, attributeType); // "inherit" is meaningless for assemblies

        public static Attribute GetCustomAttribute(MemberInfo element, Type attributeType) =>
            GetCustomAttribute(element, attributeType, inherit: true);
        ...
        public static Attribute GetCustomAttribute(
            ...
            Type attributeType,
            bool inherit
        ) => GetCustomAttribute(element, attributeType); // "inherit" is meaningless for modules

        public static Attribute GetCustomAttribute(ParameterInfo element, Type attributeType) =>
            CustomAttributeExtensions.GetCustomAttribute(element, attributeType, inherit: true);
        ...
        public static Attribute[] GetCustomAttributes(Assembly element, bool inherit) =>
            GetCustomAttributes(element); // "inherit" is meaningless for assemblies
        ...
        public static Attribute[] GetCustomAttributes(
            ...
            Type attributeType,
            bool inherit
        ) => GetCustomAttributes(element, attributeType); // "inherit" is meaningless for modules

        public static Attribute[] GetCustomAttributes(MemberInfo element) =>
            GetCustomAttributes(element, inherit: true);
        ...
        public static Attribute[] GetCustomAttributes(MemberInfo element, Type attributeType) =>
            GetCustomAttributes(element, attributeType, inherit: true);
        ...
        public static bool IsDefined(Assembly element, Type attributeType, bool inherit) =>
            IsDefined(element, attributeType); // "inherit" is meaningless for assemblies
        ...
        public static bool IsDefined(Module element, Type attributeType, bool inherit) =>
            IsDefined(element, attributeType); // "inherit" is meaningless for modules
        ...
        private static Attribute[] Instantiate(
            IEnumerable<CustomAttributeData> cads,
