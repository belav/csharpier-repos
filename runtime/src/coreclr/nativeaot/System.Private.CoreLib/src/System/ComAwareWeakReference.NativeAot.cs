...
namespace System
{
    internal sealed partial class ComAwareWeakReference
    {
        ...
        {
            return s_comWeakRefToObjectCallback != null
                ? s_comWeakRefToObjectCallback(pComWeakRef, wrapperId)
                : null;
        }
        ...
        {
            return s_possiblyComObjectCallback != null
                ? s_possiblyComObjectCallback(target)
                : false;
        }
        ...
        {
            wrapperId = 0;
            return s_objectToComWeakRefCallback != null
                ? s_objectToComWeakRefCallback(target, out wrapperId)
                : IntPtr.Zero;
        }
    }
}
