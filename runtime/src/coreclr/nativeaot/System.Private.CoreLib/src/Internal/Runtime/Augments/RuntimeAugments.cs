...
namespace Internal.Runtime.Augments
{
    ...
    public static class RuntimeAugments
    {
        ...
        public static void InitializeStackTraceMetadataSupport(
            StackTraceMetadataCallbacks callbacks
        )
        {
        ...
        public static object NewObject(RuntimeTypeHandle typeHandle)
        {
            ...
            if (eeType.IsNullable || eeType == EETypePtr.EETypePtrOf<string>())
                return null;
        ...
        public static unsafe Array NewMultiDimArray(
        ...
        )
        {
            ...
            if (lengths.Length == 1)
            {
                ...
                Type elementType = Type.GetTypeFromHandle(
                    new RuntimeTypeHandle(typeHandleForArrayType.ToEETypePtr().ArrayElementType)
                )!;
            ...
            return Array.NewMultiDimArray(
                typeHandleForArrayType.ToEETypePtr(),
                pImmutableLengths,
                lengths.Length
            );
        }
        ...
        {
            return RuntimeImports.RhGetRuntimeHelperForType(
                CreateEETypePtr(type),
                RuntimeHelperKind.AllocateObject
            );
        }
        ...
        public static IntPtr GetAllocateArrayHelperForType(RuntimeTypeHandle type)
        {
            return RuntimeImports.RhGetRuntimeHelperForType(
                CreateEETypePtr(type),
                RuntimeHelperKind.AllocateArray
            );
        }
        ...
        public static Delegate CreateDelegate(
            RuntimeTypeHandle typeHandleForDelegate,
            IntPtr ldftnResult,
            object thisObject,
            bool isStatic,
            bool isOpen
        )
        {
            return Delegate.CreateDelegate(
                typeHandleForDelegate.ToEETypePtr(),
                ldftnResult,
                thisObject,
                isStatic: isStatic,
                isOpen: isOpen
        ...
        //
        public static IntPtr GetDelegateLdFtnResult(
            Delegate d,
        ...
        {
            return d.GetFunctionPointer(
                out typeOfFirstParameterIfInstanceDelegate,
                out isOpenResolver,
                out isInterpreterEntrypoint
            );
        }

        public static void GetDelegateData(
            Delegate delegateObj,
            out object firstParameter,
            out object helperObject,
            out IntPtr extraFunctionPointerOrData,
        ...
        public static unsafe bool FindBlob(
        ...
        {
            return RuntimeImports.RhFindBlob(
                typeManager,
                (uint)blobId,
                (byte**)ppbBlob,
                (uint*)pcbBlob
        ...
        public static unsafe void StoreValueTypeField(
            IntPtr address,
            object fieldValue,
        ...
        public static unsafe object LoadPointerTypeField(
            IntPtr address,
            RuntimeTypeHandle fieldType
        )
        {
        ...
        {
            ref byte address = ref Unsafe.AddByteOffset(
                ref obj.GetRawData(),
                new IntPtr(fieldOffset - ObjectHeaderSize)
            );
            RuntimeImports.RhUnbox(fieldValue, ref address, fieldType.ToEETypePtr());
        }

        public static unsafe object LoadValueTypeField(
            object obj,
            int fieldOffset,
            RuntimeTypeHandle fieldType
        )
        ...
        )
        {
            ...
            return Pointer.Box(
                (void*)Unsafe.As<byte, IntPtr>(ref address),
                Type.GetTypeFromHandle(fieldType)
            );
        }
        ...
        public static unsafe void StoreReferenceTypeField(IntPtr address, object fieldValue)
        {
            Volatile.Write<object>(
                ref Unsafe.As<IntPtr, object>(ref *(IntPtr*)address),
                fieldValue
            );
        }
        ...
        )
        {
            ...
            Unsafe.As<byte, object>(ref Unsafe.Add<byte>(ref typedReference.Value, fieldOffset)) =
                fieldValue;
        }
        ...
        )
        {
            ...
            IntPtr ptrValue = Unsafe.As<byte, IntPtr>(
                ref Unsafe.Add<byte>(ref typedReference.Value, fieldOffset)
            );
        ...
        public static unsafe void EnsureClassConstructorRun(IntPtr staticClassConstructionContext)
        {
            StaticClassConstructionContext* context =
                (StaticClassConstructionContext*)staticClassConstructionContext;
        ...
        public static void SetClosedStaticDelegateFirstParameter(
            Delegate del,
        ...
        {
            get { return typeof(Array<>).TypeHandle; }
        }
        ...
        //
        public const string HiddenScopeAssemblyName =
            "HiddenScope, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a";
        ...
        {
            return (
                null != RuntimeImports.IsInstanceOfInterface(interfaceTypeHandle.ToEETypePtr(), obj)
            );
        }
        ...
        //
        public static bool TryGetBaseType(
        ...
        //
        public static IEnumerable<RuntimeTypeHandle> TryGetImplementedInterfaces(
            RuntimeTypeHandle typeHandle
        )
        {
            EETypePtr eeType = typeHandle.ToEETypePtr();
            ...
            LowLevelList<RuntimeTypeHandle> implementedInterfaces =
                new LowLevelList<RuntimeTypeHandle>();
        ...
        public static IntPtr NewInterfaceDispatchCell(
        ...
        public static RuntimeTypeHandle GetGenericArgument(
            RuntimeTypeHandle typeHandle,
            int argumentIndex
        )
        {
        ...
        public static RuntimeTypeHandle GetGenericInstantiation(
            RuntimeTypeHandle typeHandle,
            out RuntimeTypeHandle[] genericTypeArgumentHandles
        )
        {
            EETypePtr eeType = typeHandle.ToEETypePtr();
        ...
        public static bool IsByRefLike(RuntimeTypeHandle typeHandle) =>
            typeHandle.ToEETypePtr().IsByRefLike;
        ...
        public static IntPtr ResolveDispatchOnType(
            RuntimeTypeHandle instanceType,
            RuntimeTypeHandle interfaceType,
            int slot
        )
        {
            return RuntimeImports.RhResolveDispatchOnType(
                CreateEETypePtr(instanceType),
                CreateEETypePtr(interfaceType),
                checked((ushort)slot)
            );
        }

        public static IntPtr ResolveDispatch(
            object instance,
            RuntimeTypeHandle interfaceType,
            int slot
        )
        {
            return RuntimeImports.RhResolveDispatch(
                instance,
                CreateEETypePtr(interfaceType),
                checked((ushort)slot)
            );
        ...
        public static object CheckArgument(
            object srcObject,
        ...
        public static object CheckArgumentForDirectFieldAccess(
            object srcObject,
            RuntimeTypeHandle dstType
        )
        {
            return InvokeUtils.CheckArgument(
                srcObject,
                dstType.ToEETypePtr(),
                InvokeUtils.CheckArgumentSemantics.SetFieldDirect,
                binderBundle: null
            );
        }
        ...
        public static unsafe string TryGetFullPathToApplicationModule(
            IntPtr ip,
        ...
        public static IntPtr RuntimeCacheLookup(
            IntPtr context,
            IntPtr signature,
        ...
        {
            get { return s_reflectionExecutionDomainCallbacks; }
        }
        ...
        {
            get { return s_stackTraceMetadataCallbacks; }
        }
        ...
        public static unsafe void BulkMoveWithWriteBarrier(IntPtr dmem, IntPtr smem, int size)
        {
            RuntimeImports.RhBulkMoveWithWriteBarrier(
                ref *(byte*)dmem.ToPointer(),
                ref *(byte*)smem.ToPointer(),
                (uint)size
            );
        }
        ...
        public static void SetThunkData(
            object thunksHeap,
            IntPtr thunkAddress,
            IntPtr context,
            IntPtr target
        ...
        public static bool TryGetThunkData(
            object thunksHeap,
            IntPtr thunkAddress,
            out IntPtr context,
            out IntPtr target
        ...
        {
            return RuntimeImports.RhTryGetThunkData(
                thunksHeap,
                thunkAddress,
                out context,
                out target
        ...
        internal static class RawCalliHelper
        {
            ...
            [DebuggerStepThrough]
            [MethodImplAttribute(MethodImplOptions.AggressiveInlining)]
            public static unsafe void Call<T, U>(
                System.IntPtr pfn,
                void* arg1,
                ref T arg2,
                ref U arg3
        ...
        [DebuggerGuidedStepThroughAttribute]
        [CLSCompliant(false)]
        public static unsafe void RunFunctionWithConservativelyReportedBuffer<T>(
            int cbBuffer,
            delegate* <void*, ref T, void> pfnTargetToInvoke,
            ref T context
        )
        {
            RuntimeImports.ConservativelyReportedRegionDesc regionDesc = default;
            RunFunctionWithConservativelyReportedBufferInternal(
                cbBuffer,
                pfnTargetToInvoke,
                ref context,
                ref regionDesc
        ...
        [DebuggerGuidedStepThroughAttribute]
        [MethodImpl(MethodImplOptions.NoInlining)]
        private static unsafe void RunFunctionWithConservativelyReportedBufferInternal<T>(
            int cbBuffer,
            delegate* <void*, ref T, void> pfnTargetToInvoke,
            ref T context,
            ref RuntimeImports.ConservativelyReportedRegionDesc regionDesc
        )
        {
            fixed (RuntimeImports.ConservativelyReportedRegionDesc* pRegionDesc = &regionDesc)
            {
                ...
                RuntimeImports.RhInitializeConservativeReportingRegion(
                    pRegionDesc,
                    region,
                    cbBufferAligned
                );
        ...
        [DebuggerGuidedStepThroughAttribute]
        [CLSCompliant(false)]
        public static unsafe void RunFunctionWithConservativelyReportedBuffer<T, U>(
            int cbBuffer,
            delegate* <void*, ref T, ref U, void> pfnTargetToInvoke,
            ref T context,
            ref U context2
        )
        {
        ...
        [DebuggerGuidedStepThroughAttribute]
        [MethodImpl(MethodImplOptions.NoInlining)]
        private static unsafe void RunFunctionWithConservativelyReportedBufferInternal<T, U>(
            int cbBuffer,
            delegate* <void*, ref T, ref U, void> pfnTargetToInvoke,
            ref T context,
            ref U context2,
        ...
        )
        {
            fixed (RuntimeImports.ConservativelyReportedRegionDesc* pRegionDesc = &regionDesc)
            {
                ...
                RawCalliHelper.Call<T, U>(
                    (IntPtr)pfnTargetToInvoke,
                    region,
                    ref context,
                    ref context2
                );
        ...
        {
            get { return Internal.Runtime.MethodTable.SupportsRelativePointers; }
        }
