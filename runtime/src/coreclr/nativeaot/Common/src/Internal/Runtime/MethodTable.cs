...
namespace Internal.Runtime
{
    ...
    internal unsafe partial struct MethodTable
    {
        ...
        {
            get { return _usComponentSize; }
#if TYPE_LOADER_IMPLEMENTATION
            set { _usComponentSize = value; }
#endif
        }
        ...
        {
            get { return (EETypeKind)(_usFlags & (ushort)EETypeFlags.EETypeKindMask); }
        }

        internal bool HasOptionalFields
        {
            get { return ((_usFlags & (ushort)EETypeFlags.OptionalFieldsFlag) != 0); }
        }
        ...
        {
            get { return ((_usFlags & (ushort)EETypeFlags.GenericVarianceFlag) != 0); }
        }

        internal bool IsFinalizable
        {
            get { return ((_usFlags & (ushort)EETypeFlags.HasFinalizerFlag) != 0); }
        }
        ...
        {
            get { return ((_usFlags & (ushort)EETypeFlags.IsGenericFlag) != 0); }
        }
        ...
        {
            get { return (_usFlags & (ushort)EETypeFlags.IsDynamicTypeFlag) != 0; }
        }
        ...
        {
            get { return ((_usFlags & (ushort)EETypeFlags.RelatedTypeViaIATFlag) != 0); }
        }
        ...
        {
            get { return ((_usFlags & (ushort)EETypeFlags.IDynamicInterfaceCastableFlag) != 0); }
        }
        ...
        {
            get { return ((_usFlags & (ushort)EETypeFlags.HasPointersFlag) != 0); }
#if TYPE_LOADER_IMPLEMENTATION
            set
            {
                if (value)
        ...
        internal EETypeElementType ElementType
        {
            get
            {
                return (EETypeElementType)(
                    (_usFlags & (ushort)EETypeFlags.ElementTypeMask)
                    >> (ushort)EETypeFlags.ElementTypeShift
                );
            }
        }
        ...
        )
        {
            return (uint)(
                ...
                + // pointer to data
                (fHasThreadStatics ? sizeof(uint) : 0)
            ); // tls offset
        }
#endif
    }
