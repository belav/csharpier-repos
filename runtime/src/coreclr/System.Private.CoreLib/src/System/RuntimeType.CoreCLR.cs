        ...
        internal sealed class RuntimeTypeCache
        {
                ...
                private void PopulateProperties(
                    ...
                    for (int i = 0; i < tkProperties.Length; i++)
                    {
                        ...
                        if (filter.RequiresStringComparison())
                        {
                            ...
                            MdUtf8String name = declaringType.GetRuntimeModule()
                                .MetadataImport.GetName(tkProperty);
            ...
            internal string GetNameSpace()
            {
                ...
                if (m_namespace == null)
                {
                    ...
                    m_namespace = RuntimeTypeHandle.GetMetadataImport((RuntimeType)type)
...
#pragma warning restore CA1823
        ...
        public override InterfaceMapping GetInterfaceMap(Type ifaceType)
        {
            ...
            for (int i = 0; i < ifaceInstanceMethodCount; i++)
            {
                ...
                RuntimeMethodHandleInternal classRtMethodHandle = GetTypeHandleInternal()
        ...
        public override GenericParameterAttributes GenericParameterAttributes
        {
            get
            {
                ...
                RuntimeTypeHandle.GetMetadataImport(this)
