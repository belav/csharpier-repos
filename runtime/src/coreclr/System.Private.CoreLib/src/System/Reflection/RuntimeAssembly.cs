...
{
    partial internal sealed class RuntimeAssembly : Assembly
    {
...
#pragma warning restore 169
        ...
        private sealed class ManifestResourceStream : UnmanagedMemoryStream
        {
            ...
            internal unsafe ManifestResourceStream(
                RuntimeAssembly manifestAssembly,
                byte* pointer,
                long length,
                long capacity,
                FileAccess access
        ...
        partial private static bool GetCodeBase(
...
#pragma warning restore SYSLIB0037
        ...
        partial private static void GetFullName(
            QCallAssembly assembly,
            StringHandleOnStack retString
        );
        ...
        partial private static void GetEntryPoint(
            QCallAssembly assembly,
        ...
        public override MethodInfo? EntryPoint
        {
            get
            {
                ...
                GetEntryPoint(
                    new QCallAssembly(ref runtimeAssembly),
                    ObjectHandleOnStack.Create(ref methodHandle)
                );
        ...
        [LibraryImport(
            ...
            EntryPoint = "AssemblyNative_GetType",
        ...
        )
        {
            ...
            AssemblyLoadContext? assemblyLoadContextStack =
        ...
        partial private static void GetExportedTypes(
            QCallAssembly assembly,
        ...
        partial internal static Interop.BOOL GetIsCollectible(QCallAssembly assembly);
        ...
        public override bool IsCollectible
        {
            ...
            {
                RuntimeAssembly runtimeAssembly = this;
                return GetIsCollectible(new QCallAssembly(ref runtimeAssembly))
                    != Interop.BOOL.FALSE;
            }
        }
        ...
        [LibraryImport(
            RuntimeHelpers.QCall,
            EntryPoint = "AssemblyNative_GetResource",
            StringMarshalling = StringMarshalling.Utf16
        )]
        partial private static unsafe byte* GetResource(
            QCallAssembly assembly,
            string resourceName,
            out uint length
        );
        ...
        public override unsafe Stream? GetManifestResourceStream(string name)
        {
            ...
            {
                return new ManifestResourceStream(
                    this,
                    pbInMemoryResource,
                    length,
                    length,
        ...
        internal static unsafe RuntimeAssembly InternalLoad(
        ...
        )
        {
            ...
            fixed (byte* pPublicKeyOrToken = publicKeyOrToken)
            {
                ...
                nameParts._cbPublicKeyOrToken =
                    (publicKeyOrToken != null) ? publicKeyOrToken.Length : 0;
        ...
        partial private static unsafe void InternalLoad(
        ...
        [LibraryImport(
            RuntimeHelpers.QCall,
            EntryPoint = "AssemblyNative_GetModule",
            StringMarshalling = StringMarshalling.Utf16
        )]
        partial private static void GetModule(
            QCallAssembly assembly,
            string name,
        ...
        public override Module? GetModule(string name)
        {
            ...
            GetModule(
                new QCallAssembly(ref runtimeAssembly),
                name,
                ObjectHandleOnStack.Create(ref retModule)
            );
            return retModule;
        }
        ...
        [LibraryImport(
            RuntimeHelpers.QCall,
            EntryPoint = "AssemblyNative_GetManifestResourceInfo",
            StringMarshalling = StringMarshalling.Utf16
        )]
        partial private static int GetManifestResourceInfo(
            QCallAssembly assembly,
            string resourceName,
        ...
        partial private static void GetLocation(
            QCallAssembly assembly,
            StringHandleOnStack retString
        );
        ...
        public override string Location
        {
            get
            {
                ...
                GetLocation(
                    new QCallAssembly(ref runtimeAssembly),
                    new StringHandleOnStack(ref location)
                );
        ...
        partial private static void GetImageRuntimeVersion(
            QCallAssembly assembly,
            StringHandleOnStack retString
        );
        ...
        partial private static void GetVersion(
            QCallAssembly assembly,
            out int majVer,
            out int minVer,
            out int buildNum,
        ...
        partial private static void GetLocale(
            QCallAssembly assembly,
            StringHandleOnStack retString
        );
        ...
        partial private static void GetSimpleName(
            QCallAssembly assembly,
        ...
        partial private static AssemblyHashAlgorithm GetHashAlgorithm(QCallAssembly assembly);
        ...
        partial private static AssemblyNameFlags GetFlags(QCallAssembly assembly);
        ...
        partial private static void GetPublicKey(
            QCallAssembly assembly,
        ...
        internal byte[]? GetPublicKey()
        {
            ...
            GetPublicKey(
                new QCallAssembly(ref runtimeAssembly),
                ObjectHandleOnStack.Create(ref publicKey)
            );
            return publicKey;
        }
        ...
        )
        {
            ...
            RuntimeAssembly? retAssembly = InternalLoad(
                an,
                ref unused,
                requestingAssembly: this,
            ...
            if (retAssembly == null && throwOnFileNotFound)
            {
                throw new FileNotFoundException(
                    SR.Format(culture, SR.IO_FileNotFound_FileName, an.Name)
                );
            }
        ...
        partial private static void GetModules(
            QCallAssembly assembly,
        ...
        private RuntimeModule[] GetModulesInternal(bool loadIfNotFound, bool getResourceModules)
        {
            ...
            GetModules(
                ...
                loadIfNotFound,
                getResourceModules,
                ObjectHandleOnStack.Create(ref modules)
            );
            return modules!;
        }
        ...
        partial private static void GetForwardedType(
            QCallAssembly assembly,
            MetadataToken mdtExternalType,
            ObjectHandleOnStack type
        );
    }
}
