...
namespace System.Reflection.Emit
{
    ...
    public sealed partial class AssemblyBuilder : Assembly
    {
        ...
        {
            InternalModuleBuilder modBuilder =
                (InternalModuleBuilder)GetInMemoryAssemblyModule(InternalAssembly);
        ...
        private ModuleBuilder DefineDynamicModuleInternalNoLock(string name, bool emitSymbolInfo)
        {
            ...
            if (emitSymbolInfo)
            {
                ...
                IntPtr pInternalSymWriter = ModuleBuilder.nCreateISymWriterForDynamicModule(
