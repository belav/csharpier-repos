...
namespace System.Reflection.Emit
{
    public sealed class TypeBuilder : TypeInfo
    {
        ...
        [DllImport(RuntimeHelpers.QCall, CharSet = CharSet.Unicode)]
        private static extern void SetPInvokeData(
            QCallModule module,
            string DllName,
            string name,
            int token,
            ...
            if (value != null)
            {
                ...
                switch (corType)
                {
                    ...
                    case CorElementType.ELEMENT_TYPE_R8:
                        fixed (byte* pData = &value.GetRawData())SetConstantValue(
                            new QCallModule(ref module),
                            tk,
                            (int)corType,
                            pData
                    ...
                    default:
                        ...
                        {
                            fixed (char* pString = (string)value)SetConstantValue(
                                new QCallModule(ref module),
                                tk,
        ...
        )
        {
            ...
            lock (SyncRoot)
            {
                ...
                ModuleBuilder module = m_module;
                SetPInvokeData(new QCallModule(ref module), dllName, importName, token, linkFlags);
