...
namespace System.Reflection.Metadata
{
    public static partial class AssemblyExtensions
    {
        ...
        /// <summary>
        /// Retrieves the metadata section of the assembly, for use with <see
        // cref="T:System.Reflection.Metadata.MetadataReader" />.
        /// </summary>
        /// <param name="assembly">The assembly from which to retrieve the metadata.</param>
        /// <param name="blob">When this method returns, contains the pointer to the metadata section
        // blob.</param>
        /// <param name="length">When this method returns, contains the length of the metadata section
        // blob.</param>
        /// <returns>
        /// <see langword="true" /> if the metadata is retrieved successfully; <see langword="false" /> upon
        // failure.
        /// The metadata might not be available for some assemblies, such as <see
        // cref="Emit.AssemblyBuilder" />, AOT images, etc.
        /// </returns>
        /// <remarks>
        ...
        /// <para>The caller is responsible for keeping the assembly object alive while accessing the
        // metadata blob.</para>
        /// </remarks>
