...
namespace GenUnicodeProp
{
    internal static class Program
    {
        ...
        private static void Main(string[] args)
        {
            ...
            IncludeCasingData = args.Contains(
                "-IncludeCasingData",
            ...
            categoryCasingTable.GenerateTable(
                "CategoryCasingTable",
                categoryCasingTableLevelBits.Level2Bits,
                categoryCasingTableLevelBits.Level3Bits
            );
            numericGraphemeTable.GenerateTable(
                "NumericGraphemeTable",
                numericGraphemeTableLevelBits.Level2Bits,
                numericGraphemeTableLevelBits.Level3Bits
            );
            ...
            using (StreamWriter file = File.CreateText(SOURCE_NAME))
            {
                ...
                PrintAssertTableLevelsBitCountRoutine(
                    "CategoryCasing",
                    file,
                    categoryCasingTableLevelBits
                );
                ...
                PrintValueArray(
                    "CategoriesValues",
                    categoryCasingMap,
                    CategoryCasingInfo.ToCategoryBytes,
                    file
                );
                ...
                if (IncludeCasingData)
                {
                    ...
                    PrintValueArray(
                        "UppercaseValues",
                        categoryCasingMap,
                        CategoryCasingInfo.ToUpperBytes,
                        file
                    );
                    ...
                    PrintValueArray(
                        "LowercaseValues",
                        categoryCasingMap,
                        CategoryCasingInfo.ToLowerBytes,
                        file
                    );
                    ...
                    PrintValueArray(
                        "TitlecaseValues",
                        categoryCasingMap,
                        CategoryCasingInfo.ToTitleBytes,
                        file
                    );
                    ...
                    PrintValueArray(
                        "CaseFoldValues",
                        categoryCasingMap,
                        CategoryCasingInfo.ToCaseFoldBytes,
                        file
                    );
                }
                ...
                PrintValueArray(
                    "DigitValues",
                    numericGraphemeMap,
                    NumericGraphemeInfo.ToDigitBytes,
                    file
                );
                ...
                PrintValueArray(
                    "NumericValues",
                    numericGraphemeMap,
                    NumericGraphemeInfo.ToNumericBytes,
                    file
                );

                file.Write("\n        // Contains grapheme cluster segmentation values");
                PrintValueArray(
                    "GraphemeSegmentationValues",
                    numericGraphemeMap,
                    NumericGraphemeInfo.ToGraphemeBytes,
                    file
                );
            ...
            if (Environment.NewLine != "\n")
            {
                File.WriteAllText(
                    SOURCE_NAME,
                    File.ReadAllText(SOURCE_NAME).Replace("\n", Environment.NewLine)
                );
            }
        ...
        private static void PrintValueArray<T>(
            string tableName,
            Dictionary<T, byte> d,
        ...
        private static void PrintAssertTableLevelsBitCountRoutine(
            string tableName,
            StreamWriter file,
        ...
        )
        {
            ...
            file.Write(
                $"        private static void Assert{tableName}TableLevels(int level1BitCount, int level2BitCount, int level3BitCount)\n"
            );
            file.Write("        {\n");
            file.Write(
            ...
            file.Write(
                $"            Debug.Assert(level1BitCount == {expectedLevels.Level1Bits}, \"Unexpected level 1 bit count.\");\n"
            );
            file.Write(
                $"            Debug.Assert(level2BitCount == {expectedLevels.Level2Bits}, \"Unexpected level 2 bit count.\");\n"
            );
            file.Write(
                $"            Debug.Assert(level3BitCount == {expectedLevels.Level3Bits}, \"Unexpected level 3 bit count.\");\n"
            );
            file.Write("        }\n");
        }
    }
