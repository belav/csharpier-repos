...
namespace Microsoft.DotNet.CoreSetup.Test.HostActivation
{
    public partial class MultilevelSharedFxLookup
    {
        ...
        public void TPA_Version_Check_App_Wins()
        {
            ...
            var fixture = ConfigureAppAndFrameworks(
                "99.0.0.1",
                null,
                "7777.0.0",
                out appAssembly,
        ...
        public void TPA_Version_Check_UberFx_Wins(
        ...
        )
        {
            ...
            SharedFramework.AddAvailableSharedUberFxVersions(
                ...
                "9999.0.0",
                uberFxProductVersion
            );

            // Copy NetCoreApp's copy of the assembly to the app location
            netcoreAssembly = Path.Combine(
                _exeSharedFxBaseDir,
                "9999.0.0",
                "System.Collections.Immutable.dll"
            );
            appAssembly = Path.Combine(
                fixture.TestProject.OutputDirectory,
                "System.Collections.Immutable.dll"
            );
            ...
            string appDepsJson = Path.Combine(
                fixture.TestProject.OutputDirectory,
                "SharedFxLookupPortableApp.deps.json"
            );
            ...
            SharedFramework.AddReferenceToDepsJson(
                appDepsJson,
                "SharedFxLookupPortableApp/1.0.0",
                "System.Collections.Immutable",
                "1.0.0",
                versionInfo
            );

            uberAssembly = Path.Combine(
                _exeSharedUberFxBaseDir,
                uberFxProductVersion,
                "System.Collections.Immutable.dll"
            );
