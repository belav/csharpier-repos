...
namespace Microsoft.DotNet.CoreSetup.Test.HostActivation.FrameworkResolution
{
          ...
          IClassFixture<RollForwardMultipleFrameworks.SharedTestState>
    {
        ...
        [InlineData(
            ...
            ResolvedFramework.FailedToReconcile
        )]
        ...
        public void PreferReleaseToRelease(
        ...
        public void PropagateRollToHighestVersion(
            string appRollForward,
            string fxRefVersion,
            string fxRollForward,
            string resolvedFramework
