...
namespace Microsoft.DotNet.CoreSetup.Test.HostActivation.FrameworkResolution
{
            ...
            IClassFixture<RollForwardReleaseAndPreRelease.SharedTestState>
    {
        ...
        public void RollFromExisting_FromPreReleaseToRelease(
            string rollForward,
            bool? applyPatches,
            string resolvedFramework
        )
        ...
        [InlineData(Constants.RollForwardSetting.Major, false, "5.1.0-preview.1")]
        [InlineData(Constants.RollForwardSetting.LatestMajor, null, "6.0.2-preview.1")]
        public void RollForwardOnPatch_FromPreReleaseToRelease(
            string rollForward,
            bool? applyPatches,
            string resolvedFramework
        )
        ...
        [InlineData(Constants.RollForwardSetting.Major, false, "5.1.0-preview.1")]
        [InlineData(Constants.RollForwardSetting.LatestMajor, null, "6.0.2-preview.1")]
        public void RollForwardOnMinor_FromPreReleaseToRelease(
            string rollForward,
            bool? applyPatches,
            string resolvedFramework
        )
        ...
        [InlineData(Constants.RollForwardSetting.Major, false, "5.1.0-preview.1")]
        [InlineData(Constants.RollForwardSetting.LatestMajor, null, "6.0.2-preview.1")]
        public void RollForwardOnMajor_FromPreReleaseToRelease(
            string rollForward,
            bool? applyPatches,
            string resolvedFramework
        )
