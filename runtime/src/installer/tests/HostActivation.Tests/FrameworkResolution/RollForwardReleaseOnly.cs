...
namespace Microsoft.DotNet.CoreSetup.Test.HostActivation.FrameworkResolution
{
            ...
            IClassFixture<RollForwardReleaseOnly.SharedTestState>
    {
        ...
        {
            RunTest(frameworkReferenceVersion: "2.1.3", rollForward: null, applyPatches: null)
        ...
        public void RollFromExisting_ReleaseOnly(
            string rollForward,
            bool? applyPatches,
        ...
        public void RollForwardOnPatch_ReleaseOnly(
            string rollForward,
            bool? applyPatches,
            string resolvedFramework
        )
        ...
        [InlineData(Constants.RollForwardSetting.Major, false, "2.1.2")]
        [InlineData(Constants.RollForwardSetting.LatestMajor, null, "3.1.2")]
        public void RollForwardOnMinor_ReleaseOnly(
            string rollForward,
            bool? applyPatches,
            string resolvedFramework
        )
        ...
        public void RollForwardOnMajor_ReleaseOnly(
            string rollForward,
            bool? applyPatches,
            string resolvedFramework
        )
        ...
        {
            RunTest("2.1.4", rollForward, applyPatches)
        ...
        {
            RunTest("2.5.0", rollForward, applyPatches)
                .ShouldFailToFindCompatibleFrameworkVersion();
        }
        ...
        {
            RunTest("4.1.0", rollForward, applyPatches)
                .ShouldFailToFindCompatibleFrameworkVersion();
        }
