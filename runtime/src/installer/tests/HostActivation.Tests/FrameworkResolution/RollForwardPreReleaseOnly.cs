...
namespace Microsoft.DotNet.CoreSetup.Test.HostActivation.FrameworkResolution
{
            ...
            IClassFixture<RollForwardPreReleaseOnly.SharedTestState>
    {
        ...
        [InlineData(Constants.RollForwardSetting.Major, false, "5.1.1-preview.1")]
        [InlineData(Constants.RollForwardSetting.LatestMajor, null, "6.1.0-preview.2")]
        public void RollForwardOnMinor_FromReleaseToPreRelease(
            string rollForward,
            bool? applyPatches,
            string resolvedFramework
        )
        ...
        public void RollForwardOnMajor_FromReleaseToPreRelease(
            string rollForward,
            bool? applyPatches,
            string resolvedFramework
        )
        ...
        {
            RunTest("5.1.2-preview.3", rollForward, applyPatches)
        ...
        {
            RunTest("5.1.3-preview.1", rollForward, applyPatches)
                .ShouldFailToFindCompatibleFrameworkVersion();
        }
        ...
        {
            RunTest("5.3.0-preview.1", rollForward, applyPatches)
                .ShouldFailToFindCompatibleFrameworkVersion();
        }
        ...
        {
            RunTest("7.1.0-preview.1", rollForward, applyPatches)
                .ShouldFailToFindCompatibleFrameworkVersion();
        }
        ...
        [InlineData(Constants.RollForwardSetting.Major, false, "5.1.1-preview.1")]
        [InlineData(Constants.RollForwardSetting.LatestMajor, null, "6.1.0-preview.2")]
        public void RollFromExisting_PreReleaseOnly(
            string rollForward,
            bool? applyPatches,
            string resolvedFramework
        )
        ...
        [InlineData(Constants.RollForwardSetting.LatestMajor, null, "6.1.0-preview.2")]
        public void RollForwardOnPreRelease_PreReleaseOnly(
            string rollForward,
            bool? applyPatches,
            string resolvedFramework
        )
        ...
        [InlineData(Constants.RollForwardSetting.Major, false, "5.1.1-preview.1")]
        [InlineData(Constants.RollForwardSetting.LatestMajor, null, "6.1.0-preview.2")]
        public void RollForwardOnPatch_PreReleaseOnly(
            string rollForward,
            bool? applyPatches,
            string resolvedFramework
        )
        ...
        [InlineData(Constants.RollForwardSetting.Major, false, "5.1.1-preview.1")]
        [InlineData(Constants.RollForwardSetting.LatestMajor, null, "6.1.0-preview.2")]
        public void RollForwardOnMinor_PreReleaseOnly(
            string rollForward,
            bool? applyPatches,
            string resolvedFramework
        )
        ...
        [InlineData(Constants.RollForwardSetting.LatestMajor, null, "6.1.0-preview.2")]
        [InlineData(Constants.RollForwardSetting.LatestMajor, false, "6.1.0-preview.2")]
        public void RollForwardOnMajor_PreReleaseOnly(
            string rollForward,
            bool? applyPatches,
            string resolvedFramework
        )
