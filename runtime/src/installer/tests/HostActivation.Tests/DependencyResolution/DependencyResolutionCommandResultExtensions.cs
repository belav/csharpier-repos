...
namespace Microsoft.DotNet.CoreSetup.Test.HostActivation.DependencyResolution
{
    public static class DependencyResolutionCommandResultExtensions
    {
        ...
        public static AndConstraint<CommandResultAssertions> HaveRuntimePropertyContaining(
        ...
        public static AndConstraint<CommandResultAssertions> NotHaveRuntimePropertyContaining(
            this CommandResultAssertions assertion,
            string propertyName,
            params string[] values
        )
        ...
        public static AndConstraint<CommandResultAssertions> HaveResolvedAssembly(
            this CommandResultAssertions assertion,
            string assemblyPath,
            TestApp app = null
        )
        ...
        public static AndConstraint<CommandResultAssertions> NotHaveResolvedAssembly(
            this CommandResultAssertions assertion,
            string assemblyPath,
            TestApp app = null
        )
        ...
        public static AndConstraint<CommandResultAssertions> HaveResolvedNativeLibraryPath(
            this CommandResultAssertions assertion,
            string path,
            TestApp app = null
        )
        ...
        public static AndConstraint<CommandResultAssertions> NotHaveResolvedNativeLibraryPath(
            this CommandResultAssertions assertion,
            string path,
            TestApp app = null
        )
        ...
        public static AndConstraint<CommandResultAssertions> ErrorWithMissingAssembly(
            this CommandResultAssertions assertion,
            string depsFileName,
        ...
        )
        {
            return assertion.HaveStdErrContaining(
                $"Error:{Environment.NewLine}"
                    + $"  An assembly specified in the application dependencies manifest ({depsFileName}) was not found:"
                    + Environment.NewLine
                    + $"    package: \'{dependencyName}\', version: \'{dependencyVersion}\'"
                    + Environment.NewLine
                    + $"    path: \'{dependencyName}.dll\'"
            );
        }

        public static AndConstraint<CommandResultAssertions> HaveUsedAdditionalDeps(
            this CommandResultAssertions assertion,
            string depsFilePath
        )
        {
            return assertion.HaveStdErrContaining(
                $"Using specified additional deps.json: '{depsFilePath}'"
            );
        }

        public static AndConstraint<CommandResultAssertions> HaveUsedAdditionalProbingPath(
            this CommandResultAssertions assertion,
            string path
        )
        {
        ...
        public static AndConstraint<CommandResultAssertions> HaveUsedFallbackRid(
            this CommandResultAssertions assertion,
            bool usedFallbackRid
        )
        {
            string msg = "Falling back to base HostRID";
            return usedFallbackRid
                ? assertion.HaveStdErrContaining(msg)
                : assertion.NotHaveStdErrContaining(msg);
        }

        public static AndConstraint<CommandResultAssertions> HaveUsedFrameworkProbe(
            this CommandResultAssertions assertion,
            string path,
            int level
        )
        {
            return assertion.HaveStdErrContaining(
                $"probe type=framework dir=[{path}] fx_level={level}"
            );
        }

        public static AndConstraint<CommandResultAssertions> NotHaveUsedFrameworkProbe(
            this CommandResultAssertions assertion,
            string path
        )
        {
        ...
        private static string GetAppMockPropertyValue(
            CommandResultAssertions assertion,
            string propertyName
        ) => GetMockPropertyValue(assertion, $"mock property[{propertyName}] = ");

        private static string GetComponentMockPropertyValue(
            CommandResultAssertions assertion,
            string propertyName
        ) =>
            GetMockPropertyValue(
                assertion,
                $"corehost_resolve_component_dependencies {propertyName}:"
            );
        ...
        private static string[] RelativePathsToAbsoluteAppPaths(string relativePaths, TestApp app)
        {
            ...
            foreach (
                string relativePath in relativePaths.Split(
                    ';',
