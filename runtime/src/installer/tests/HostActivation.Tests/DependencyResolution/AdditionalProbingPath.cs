        ...
        public class SharedTestState : DependencyResolutionBase.SharedTestStateBase
        {
            ...
            public SharedTestState()
            {
                ...
                string nativeDependencyRelPath =
                    $"{RepoDirectoriesProvider.Default.TargetRID}/{Binaries.GetSharedLibraryFileNameForCurrentPlatform("native")}";
                ...
                AdditionalProbingPath_ArchTfm = Path.Combine(
                    AdditionalProbingPath,
                    RepoDirectoriesProvider.Default.BuildArchitecture,
                    RepoDirectoriesProvider.Default.Tfm
                );
