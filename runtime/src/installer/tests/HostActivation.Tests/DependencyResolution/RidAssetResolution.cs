...
namespace Microsoft.DotNet.CoreSetup.Test.HostActivation.DependencyResolution
{
    public abstract class RidAssetResolutionBase : ComponentDependencyResolutionBase
    {
        ...
        public void RidSpecificAssembly(string rid, string includedPath, string excludedPath)
        {
            RunTest(
                p =>
                    p.WithAssemblyGroup("win", g => g.WithAsset("win/WindowsAssembly.dll"))
        ...
        )
        {
            ...
            RunTest(
                ...
                excludedAssemblyPaths: null,
                includedNativeLibraryPaths: expectedNativePath,
                excludedNativeLibraryPaths: null
            );
        }
          ...
          IClassFixture<RidAssetResolutionBase.SharedTestState>
    {
        ...
        )
        {
            ...
            SharedState.RunComponentResolutionTest(component, command => command.RuntimeId(rid))
                .Should()
                .Pass()
          ...
          IClassFixture<PortableComponentOnSelfContainedAppRidAssetResolution.ComponentSharedTestState>
    {
        ...
        )
        {
            ...
            {
                assemblyPaths =
                    assemblyPaths.Length == 0
                        ? (";" + excludedAssemblyPaths)
                        : excludedAssemblyPaths;
            }
