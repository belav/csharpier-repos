...
namespace Microsoft.DotNet.CoreSetup.Test.HostActivation
{
    public class NativeHostApis : IClassFixture<NativeHostApis.SharedTestState>
    {
        ...
        public void Hostfxr_corehost_set_error_writer_test()
        {
            ...
            fixture
                .BuiltDotnet.Exec(fixture.TestProject.AppDll, "Test_hostfxr_set_error_writer")
                .CaptureStdOut()
                .CaptureStdErr()
                .Execute()
                .Should()
        ...
        public void Hostpolicy_corehost_set_error_writer_test()
        {
            ...
            fixture
                .BuiltDotnet.Exec(fixture.TestProject.AppDll, "Test_corehost_set_error_writer")
                .CaptureStdOut()
                .CaptureStdErr()
                .Execute()
                .Should()
        ...
        public void HostRuntimeContract_get_runtime_property()
        {
            ...
            fixture
                ...
                .And.HaveStdOutContaining(
                    $"ENTRY_ASSEMBLY_NAME = {fixture.TestProject.AssemblyName}"
                );
        }
