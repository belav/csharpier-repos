...
namespace HostApiInvokerApp
{
    public static class HostPolicy
    {
        ...
        {
            hostpolicy.corehost_error_writer_fn writer1 = (message) =>
            {
                Console.WriteLine(nameof(writer1));
            };
            ...
            hostpolicy.corehost_error_writer_fn writer2 = (message) =>
            {
                Console.WriteLine(nameof(writer2));
            };
            ...
            if (previousWriterPtr != writer1Ptr)
            {
                throw new ApplicationException(
                    "First: The previous writer returned is not the one expected."
                );
            }
            ...
            {
                throw new ApplicationException(
                    "Second: The previous writer returned is not the one expected."
                );
            }
        }
