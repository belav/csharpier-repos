...
namespace Microsoft.DotNet.CoreSetup.Test
{
    public class CommandResultAssertions
    {
        ...
        {
            Execute
                .Assertion.ForCondition(Result.ExitCode == expectedExitCode)
                .FailWith(
        ...
        {
            Execute
                .Assertion.ForCondition(Result.ExitCode == 0)
        ...
        {
            Execute
                .Assertion.ForCondition(!string.IsNullOrEmpty(Result.StdOut))
        ...
        public AndConstraint<CommandResultAssertions> HaveStdOut(string expectedOutput)
        {
            Execute
                .Assertion.ForCondition(
                    Result.StdOut.Equals(expectedOutput, StringComparison.Ordinal)
                )
                .FailWith(
        ...
        {
            Execute
                .Assertion.ForCondition(Result.StdOut.Contains(pattern))
                .FailWith(
        ...
        {
            Execute
                .Assertion.ForCondition(Regex.IsMatch(Result.StdOut, pattern, options))
                .FailWith(
        ...
        public AndConstraint<CommandResultAssertions> NotHaveStdOutMatching(
            string pattern,
            RegexOptions options = RegexOptions.None
        )
        {
        ...
        {
            Execute
                .Assertion.ForCondition(!string.IsNullOrEmpty(Result.StdErr))
        ...
        {
            Execute
                .Assertion.ForCondition(Result.StdErr.Contains(pattern))
                .FailWith(
        ...
        {
            Execute
                .Assertion.ForCondition(Regex.IsMatch(Result.StdErr, pattern, options))
                .FailWith(
        ...
        {
            Execute
                .Assertion.ForCondition(System.IO.File.Exists(path))
                .FailWith(
        ...
        public AndConstraint<CommandResultAssertions> FileContains(string path, string pattern)
        {
            ...
            Execute
                .Assertion.ForCondition(fileContent.Contains(pattern))
                .FailWith(
