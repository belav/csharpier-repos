...
namespace AppHost.Bundle.Tests
{
            ...
            IClassFixture<HammerServiceTest.SharedTestState>
    {
        ...
        [SkipOnPlatform(
            ...
            "On Windows, the hammer servicing location is %ProgramFiles%\\coreservicing. Since writing to this location requires administrative privilege, we do not run the test on Windows."
        )]
