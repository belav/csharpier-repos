...
namespace Microsoft.NET.HostModel.Tests
{
    public class BundlerConsistencyTests : IClassFixture<BundlerConsistencyTests.SharedTestState>
    {
        ...
        public void TestWithExactDuplicateEntriesPasses()
        {
            ...
            bundler.BundleManifest.Files.Where(
        ...
        public void TestBaseNameComputation()
        {
            ...
            bundler.BundleManifest.Files.Where(entry => entry.RelativePath.Equals(depsJson))
                .Single()
                .Type.Should()
                .Be(FileType.DepsJson);
            bundler.BundleManifest.Files.Where(
                    entry => entry.RelativePath.Equals(runtimeconfigJson)
                )
                .Single()
                .Type.Should()
        ...
        public void TestFilesNeverBundled(BundleOptions options)
        {
            ...
            bundler.BundleManifest.Contains($"{appBaseName}.runtimeconfig.dev.json")
                .Should()
                .BeFalse();
        }
        ...
        public void TestBundlingSymbols(BundleOptions options)
        {
            ...
            bundler.BundleManifest.Contains($"{appBaseName}.pdb")
                .Should()
        ...
        public void TestBundlingNativeBinaries(BundleOptions options)
        {
            ...
            bundler.BundleManifest.Contains($"{coreclr}")
                .Should()
