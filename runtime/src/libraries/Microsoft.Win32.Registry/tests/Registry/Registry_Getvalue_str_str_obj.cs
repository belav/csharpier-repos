...
namespace Microsoft.Win32.RegistryTests
{
    public class Registry_GetValue_str_str_obj : RegistryTestsBase
    {
        ...
        public static readonly object[][] ArgumentExceptionTestData =
        {
            ...
            {
                new string('a', 21),
            } // String of length 21 that isn't HKEY_PERFORMANCE_DATA.
            ,
        };
        ...
        public void TestGetValueWithValueTypes(string valueName, object testValue)
        {
            ...
            Assert.Equal(
                testValue.ToString(),
                Registry.GetValue(TestRegistryKey.Name, valueName, null).ToString()
            );
        ...
        public static void GetValueFromDifferentKeys(
            RegistryKey key,
            string valueName,
            bool useSeparator
        )
        ...
        [Theory]
        [MemberData(nameof(TestRegistryKeys))]
        public static void GetDefaultValueFromDifferentKeys(
            RegistryKey key,
            string valueName,
            bool useSeparator
        )
            ...
            try
            {
                ...
                else
                {
                    Assert.Equal(
                        ...
                        Registry.GetValue(keyName, valueName, TestData.DefaultValue)
                    );
                }
            }
            catch (IOException) { }
