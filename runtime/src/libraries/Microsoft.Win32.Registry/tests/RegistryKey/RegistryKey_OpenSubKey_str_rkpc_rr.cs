...
namespace Microsoft.Win32.RegistryTests
{
    public class RegistryKey_OpenSubKey_str_rkpc_rr : RegistryKeyOpenSubKeyTestsBase
    {
        ...
        public void OpenSubKeyTest()
        {
            ...
            using (
                var rk = TestRegistryKey.OpenSubKey(
                    "",
        ...
        private const RegistryKeyPermissionCheck DefaultPermissionCheck =
            RegistryKeyPermissionCheck.Default;
        private const RegistryKeyPermissionCheck WritablePermissionCheck =
            RegistryKeyPermissionCheck.ReadWriteSubTree;
        private const RegistryKeyPermissionCheck NonWritablePermissionCheck =
        ...
        public void OpenSubKey_DefaultPermissionCheck_WritableRegistryRights_KeyExists_OpensWithFixedUpName(
            string expected,
            string subKeyName
        ) =>
        ...
        [Theory]
        [MemberData(nameof(TestRegistrySubKeyNames))]
        public void OpenSubKey_DefaultPermissionCheck_NonWritableRegistryRights_KeyExists_OpensWithFixedUpName(
            string expected,
            string subKeyName
        ) =>
            Verify_OpenSubKey_KeyExists_OpensWithFixedUpName(
        ...
        [Theory]
        [MemberData(nameof(TestRegistrySubKeyNames))]
        public void OpenSubKey_WritablePermissionCheck_WritableRegistryRights_KeyExists_OpensWithFixedUpName(
            string expected,
            string subKeyName
        ) =>
            Verify_OpenSubKey_KeyExists_OpensWithFixedUpName(
        ...
        [Theory]
        [MemberData(nameof(TestRegistrySubKeyNames))]
        public void OpenSubKey_WritablePermissionCheck_NonWritableRegistryRights_KeyExists_OpensWithFixedUpName(
            string expected,
            string subKeyName
        ) =>
            Verify_OpenSubKey_KeyExists_OpensWithFixedUpName(
        ...
        [Theory]
        [MemberData(nameof(TestRegistrySubKeyNames))]
        public void OpenSubKey_NonWritablePermissionCheck_WritableRegistryRights_KeyExists_OpensWithFixedUpName(
            string expected,
            string subKeyName
        ) =>
            Verify_OpenSubKey_KeyExists_OpensWithFixedUpName(
        ...
        [Theory]
        [MemberData(nameof(TestRegistrySubKeyNames))]
        public void OpenSubKey_NonWritablePermissionCheck_NonWritableRegistryRights_KeyExists_OpensWithFixedUpName(
            string expected,
            string subKeyName
        ) =>
            Verify_OpenSubKey_KeyExists_OpensWithFixedUpName(
        ...
        [Theory]
        [MemberData(nameof(TestRegistrySubKeyNames))]
        public void OpenSubKey_DefaultPermissionCheck_WritableRegistryRights_KeyDoesNotExist_ReturnsNull(
            string expected,
            string subKeyName
        ) =>
        ...
        [Theory]
        [MemberData(nameof(TestRegistrySubKeyNames))]
        public void OpenSubKey_DefaultPermissionCheck_NonWritableRegistryRights_KeyDoesNotExist_ReturnsNull(
            string expected,
            string subKeyName
        ) =>
            Verify_OpenSubKey_KeyDoesNotExist_ReturnsNull(
        ...
        [Theory]
        [MemberData(nameof(TestRegistrySubKeyNames))]
        public void OpenSubKey_WritablePermissionCheck_WritableRegistryRights_KeyDoesNotExist_ReturnsNull(
            string expected,
            string subKeyName
        ) =>
            Verify_OpenSubKey_KeyDoesNotExist_ReturnsNull(
        ...
        [Theory]
        [MemberData(nameof(TestRegistrySubKeyNames))]
        public void OpenSubKey_WritablePermissionCheck_NonWritableRegistryRights_KeyDoesNotExist_ReturnsNull(
            string expected,
            string subKeyName
        ) =>
            Verify_OpenSubKey_KeyDoesNotExist_ReturnsNull(
        ...
        [Theory]
        [MemberData(nameof(TestRegistrySubKeyNames))]
        public void OpenSubKey_NonWritablePermissionCheck_WritableRegistryRights_KeyDoesNotExist_ReturnsNull(
            string expected,
            string subKeyName
        ) =>
            Verify_OpenSubKey_KeyDoesNotExist_ReturnsNull(
        ...
        [Theory]
        [MemberData(nameof(TestRegistrySubKeyNames))]
        public void OpenSubKey_NonWritablePermissionCheck_NonWritableRegistryRights_KeyDoesNotExist_ReturnsNull(
            string expected,
            string subKeyName
        ) =>
            Verify_OpenSubKey_KeyDoesNotExist_ReturnsNull(
