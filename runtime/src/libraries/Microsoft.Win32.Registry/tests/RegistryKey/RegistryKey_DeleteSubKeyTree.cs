...
namespace Microsoft.Win32.RegistryTests
{
    public class RegistryKey_DeleteSubKeyTree : RegistryKeyDeleteSubKeyTreeTestsBase
    {
        ...
        public void DeleteSubKeyTree_ThrowOnMissing_KeyExists_KeyDeleted(
            string expected,
            string subKeyName
        ) =>
        ...
        [Theory]
        [MemberData(nameof(TestRegistrySubKeyNames))]
        public void DeleteSubKeyTree_DoNotThrow_KeyExists_KeyDeleted(
            string expected,
            string subKeyName
        ) =>
            Verify_DeleteSubKeyTree_KeyExists_KeyDeleted(
        ...
        [Theory]
        [MemberData(nameof(TestRegistrySubKeyNames))]
        public void DeleteSubKeyTree_ThrowOnMissing_KeyDoesNotExists_Throws(
            string expected,
            string subKeyName
        ) =>
        ...
        [Theory]
        [MemberData(nameof(TestRegistrySubKeyNames))]
        public void DeleteSubKeyTree_DoNotThrow_KeyDoesNotExists_DoesNotThrow(
            string expected,
            string subKeyName
        ) =>
