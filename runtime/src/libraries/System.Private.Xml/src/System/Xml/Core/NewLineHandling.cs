...
namespace System.Xml
{
    ...
    //  Replace  = Replaces all new line characters with XmlWriterSettings.NewLineChars so all new lines
    // are the same; by default NewLineChars == Environment.NewLine
    //  Entitize = Replaces all new line characters that would be normalized away by a normalizing
    // XmlReader with character entities
