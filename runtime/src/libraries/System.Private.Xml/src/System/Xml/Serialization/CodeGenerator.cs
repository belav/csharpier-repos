...
namespace System.Xml.Serialization
{
    ...
    {
        internal const BindingFlags InstancePublicBindingFlags =
        ...
        internal const MethodAttributes PublicMethodAttributes =
            MethodAttributes.Public | MethodAttributes.HideBySig;
        internal const MethodAttributes PublicOverrideMethodAttributes =
            MethodAttributes.Public | MethodAttributes.Virtual | MethodAttributes.HideBySig;
        internal const MethodAttributes ProtectedOverrideMethodAttributes =
            MethodAttributes.Family | MethodAttributes.Virtual | MethodAttributes.HideBySig;
        internal const MethodAttributes PrivateMethodAttributes =
        ...
        )
        {
            ...
            InitILGeneration(
                argTypes,
                argNames,
                (_methodBuilder.Attributes & MethodAttributes.Static) == MethodAttributes.Static
            );
        }
        ...
        internal void EndFor()
        {
            ...
            if (forState.Index != null)
            {
                ...
                else
                {
                    ...
                    Debug.Assert(
                        ICollection_get_Count.IsVirtual
                            && !ICollection_get_Count.DeclaringType!.IsValueType
                    );
        ...
        internal void StackallocSpan(Type elementType, int len)
        {
            ...
            _ilGen!.Emit(
                ...
                typeof(Span<>)
                    ...
                    .GetConstructor(new Type[] { typeof(void*), typeof(int) })!
            );
        }
            ...
            else
            {
                ...
                if (property != null)
                {
                    MethodInfo? getMethod =
                        property.GetMethod ?? GetPropertyMethodFromBaseType(property, true);
            ...
            else
            {
                ...
                if (property != null)
                {
                    MethodInfo? setMethod =
                        property.SetMethod ?? GetPropertyMethodFromBaseType(property, false);
                    ...
                    default:
                        ...
                        else
                        {
                            throw new NotSupportedException(
                                SR.Format(SR.UnknownConstantType, valueType.AssemblyQualifiedName)
                            );
                        }
                }
            }
