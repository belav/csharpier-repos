...
namespace System.Xml.Serialization
{
    internal sealed class XmlSerializationWriterILGen : XmlSerializationILGen
    {
        ...
        )
        {
            ...
            MethodInfo XmlSerializationWriter_method = typeof(XmlSerializationWriter)
                .GetMethod(method, CodeGenerator.InstanceBindingFlags, argTypes.ToArray())
                !;
        ...
        private void WriteEndElement()
        {
            MethodInfo XmlSerializationWriter_WriteEndElement = typeof(XmlSerializationWriter)
                .GetMethod("WriteEndElement", CodeGenerator.InstanceBindingFlags, Type.EmptyTypes)
                !;
            ilg.Ldarg(0);
        ...
        private string GenerateMembersElement(XmlMembersMapping xmlMembersMapping)
        {
            ...
            MethodInfo XmlSerializationWriter_TopLevelElement = typeof(XmlSerializationWriter)
                .GetMethod("TopLevelElement", CodeGenerator.InstanceBindingFlags, Type.EmptyTypes)
                !;
            ilg.Ldarg(0);
            ...
            if (constants.Length > 0)
            {
                ...
                else
                {
                    ...
                    MethodInfo CultureInfo_get_InvariantCulture = typeof(CultureInfo)
                        ...
                        !;
                    MethodInfo Int64_ToString = typeof(long)
                        .GetMethod(
                            "ToString",
                            CodeGenerator.InstanceBindingFlags,
        ...
        private void WriteStructMethod(StructMapping mapping)
        {
            ...
            MethodInfo Object_GetType = typeof(object)
                .GetMethod("GetType", CodeGenerator.InstanceBindingFlags, Type.EmptyTypes)
                !;
            ...
            if (!mapping.TypeDesc.IsAbstract)
            {
                ...
                for (int i = 0; i < members.Length; i++)
                {
                    ...
                    if (m.Attribute != null)
                    {
                        ...
                        {
                            string memberGet = RaCodeGen.GetStringForMember(
                                "o",
                                $"{m.Name}Specified",
                                mapping.TypeDesc
                            );
                        ...
                        WriteMember(
                            RaCodeGen.GetSourceForMember("o", m, mapping.TypeDesc, ilg),
                            m.Attribute,
                            m.TypeDesc!,
                            "o"
                        );
                ...
                for (int i = 0; i < members.Length; i++)
                {
                    ...
                    if (m.ChoiceIdentifier != null)
                    {
                        ...
                        choiceSource = RaCodeGen.GetStringForMember(
                            "o",
                    ...
                    WriteMember(
                        RaCodeGen.GetSourceForMember("o", m, m.MemberInfo, mapping.TypeDesc, ilg),
                        choiceSource,
            ...
            if (memberTypeDesc.IsArrayLike)
            {
                ...
                if (attribute.IsList)
                {
                    ...
                    else
                    {
                        ...
                        ConstructorInfo StringBuilder_ctor = typeof(StringBuilder)
                ...
                else
                {
                    ...
                    WriteLocalDecl(
                        aiVar,
                        RaCodeGen.GetStringForArrayMember(aVar, iVar, memberTypeDesc),
        ...
        )
        {
            ...
            if (arrayTypeDesc.IsEnumerable)
            {
                ...
                MethodInfo IEnumerator_MoveNext = typeof(IEnumerator)
                    .GetMethod("MoveNext", CodeGenerator.InstanceBindingFlags, Type.EmptyTypes)
                    !;
                ilg.Ldloc(eLoc);
            ...
            else
            {
                ...
                if (count > 1)
                {
                    WriteLocalDecl(
                        arrayNamePlusI,
                        RaCodeGen.GetStringForArrayMember(arrayName, iPlusArrayName, arrayTypeDesc),
                        arrayElementTypeDesc.Type!
                    );
                    if (choice != null)
                    {
                        WriteLocalDecl(
                            $"{choiceName}i",
                            RaCodeGen.GetStringForArrayMember(
                                choiceName,
                                iPlusArrayName,
                                choice.Mapping!.TypeDesc!
                            ),
    ...
    internal sealed class ReflectionAwareILGen
    {
        ...
        )
        {
            ...
            ilg.Ldc(type);
            MethodInfo getTypeInfoMehod = typeof(IntrospectionExtensions)
                .GetMethod("GetTypeInfo", CodeGenerator.StaticBindingFlags, new[] { typeof(Type) })
                !;
            ...
            MethodInfo getDeclaredConstructors = typeof(TypeInfo)
                .GetMethod("get_DeclaredConstructors")
                !;
            ...
            ilg.WhileBeginCondition(); // while (e.MoveNext())
            MethodInfo IEnumeratorMoveNext = typeof(IEnumerator)
                .GetMethod("MoveNext", CodeGenerator.InstanceBindingFlags, Type.EmptyTypes)
                !;
            ilg.Ldloc(enumerator);
        ...
        [RequiresUnreferencedCode("calls ILGenForCreateInstance")]
        internal void WriteCreateInstance(
            string source,
            bool ctorInaccessible,
            Type type,
            CodeGenerator ilg
        ...
        [RequiresUnreferencedCode("calls Load")]
        internal void WriteArrayLocalDecl(
            string typeName,
            string variableName,
            SourceInfo initValue,
            TypeDesc arrayTypeDesc
