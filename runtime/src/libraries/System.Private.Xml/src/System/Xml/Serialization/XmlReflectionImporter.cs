    ...
    public class XmlReflectionImporter
    {
        ...
        )
        {
            ...
            if (CountAtLevel(_savedArrayItemAttributes, _arrayNestingLevel) == 0)
                _savedArrayItemAttributes.Add(
                    CreateArrayItemAttribute(
                        _typeScope.GetTypeDesc(model.Element.Type),
                        _arrayNestingLevel
                    )
                );
            CreateArrayElementsFromAttributes(
                ...
                model.Element.Type,
                _savedArrayNamespace == null ? ns : _savedArrayNamespace,
                limiter
            );
        ...
        )
        {
            ...
            throw new InvalidOperationException(
                SR.Format(SR.XmlChoiceIdentiferMemberMissing, choice.MemberName, accessorName)
            );
        }
        ...
        )
        {
            ...
            if (infos == null || infos.Length == 0)
            {
                ...
                if (info == null)
                {
                    ...
                    throw new InvalidOperationException(
                        SR.Format(
                            SR.XmlChoiceIdentiferMemberMissing,
                            choice.MemberName,
                            accessorName
                        )
                    );
            ...
            else if (infos.Length > 1)
            {
                ...
                throw new InvalidOperationException(
                    SR.Format(SR.XmlChoiceIdentiferAmbiguous, choice.MemberName)
                );
            }
