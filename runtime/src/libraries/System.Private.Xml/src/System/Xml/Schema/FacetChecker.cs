...
namespace System.Xml.Schema
{
    ...
    internal sealed class Numeric10FacetsChecker : FacetsChecker
    {
        ...
        internal static bool MatchEnumeration(
            decimal value,
            ArrayList enumeration,
        ...
        internal static Exception? CheckTotalAndFractionDigits(
            decimal value,
            int totalDigits,
            int fractionDigits,
            bool checkTotal,
    ...
    internal sealed class Numeric2FacetsChecker : FacetsChecker
    {
        ...
        private static bool MatchEnumeration(
            double value,
            ArrayList enumeration,
            XmlValueConverter valueConverter
        )
    ...
    { //All types derived from string & anyURI
        ...
        internal static Exception? CheckValueFacets(
            string value,
            XmlSchemaDatatype datatype,
            bool verifyUri
        )
