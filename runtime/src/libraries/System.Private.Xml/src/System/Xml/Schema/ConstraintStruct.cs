...
namespace System.Xml.Schema
{
            ...
            switch (_xsdtype.TypeCode)
            {
                ...
                case XmlTypeCode.NonPositiveInteger:
                    ...
                    if (_isList)
                    {
                        ...
                        {
                            _dstruct.Dvalue[i] = Convert.ToDecimal(
                                ((Array)_ovalue!).GetValue(i),
    ...
    internal sealed class KeySequence
    {
        ...
        public object this[int index]
        {
            ...
            set { _ks[index] = (TypedObject)value; }
        }
                ...
                else
                {
                    if (_ks[i].Value is Array arr)
                    {
                        ...
                        if (atomicValues != null)
                        {
                            ...
                            {
                                _hashcode += ((XmlAtomicValue)atomicValues.GetValue(j)!).TypedValue
                                    .GetHashCode();
                            }
                        }
                        else
