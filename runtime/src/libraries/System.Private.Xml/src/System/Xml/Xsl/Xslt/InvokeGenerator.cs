...
ARGS:
QilFunction func      -- Functions which should be invoked. Arguments of this function (formalArgs)
are Let nodes
...
ArrayList actualArgs  -- Array of QilNodes annotated with names. When name of formalArg match name
actualArg last one
