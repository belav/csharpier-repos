...
namespace System.Xml.Xsl.IlGen
{
    ...
    internal sealed class XmlILStorageMethods
    {
        ...
        public XmlILStorageMethods(Type storageType)
        {
            ...
            SeqReuseSgl = sequenceType
                .GetMethod("CreateOrReuse", new[] { sequenceType, storageType })
                !;
    ...
    {
        public static readonly ConstructorInfo DecFromParts = typeof(decimal)
            .GetConstructor(
                new[] { typeof(int), typeof(int), typeof(int), typeof(bool), typeof(byte) }
            )
            !;
        public static readonly ConstructorInfo DecFromInt32 = typeof(decimal)
            .GetConstructor(new[] { typeof(int) })
            !;
        public static readonly ConstructorInfo DecFromInt64 = typeof(decimal)
            .GetConstructor(new[] { typeof(long) })
            !;
        public static readonly ConstructorInfo Debuggable = typeof(DebuggableAttribute)
            .GetConstructor(new[] { typeof(DebuggableAttribute.DebuggingModes) })
            !;
        public static readonly ConstructorInfo NonUserCode = typeof(DebuggerNonUserCodeAttribute)
            .GetConstructor(Type.EmptyTypes)
            !;
        public static readonly ConstructorInfo QName = typeof(XmlQualifiedName)
            .GetConstructor(new[] { typeof(string), typeof(string) })
            !;
        public static readonly ConstructorInfo StepThrough = typeof(DebuggerStepThroughAttribute)
            .GetConstructor(Type.EmptyTypes)
            !;
        public static readonly ConstructorInfo Transparent = typeof(SecurityTransparentAttribute)
            .GetConstructor(Type.EmptyTypes)
            !;
    }
    ...
    internal static class XmlILMethods
    {
        ...
        public static readonly MethodInfo NavLocalName = typeof(XPathNavigator)
            .GetMethod("get_LocalName")
            !;
        public static readonly MethodInfo NavMoveAttr = typeof(XPathNavigator)
            .GetMethod("MoveToAttribute", new[] { typeof(string), typeof(string) })
            !;
        ...
        public static readonly MethodInfo DecCmp = typeof(decimal)
            .GetMethod("Compare", new[] { typeof(decimal), typeof(decimal) })
            !;
        public static readonly MethodInfo DecEq = typeof(decimal)
            .GetMethod("Equals", new[] { typeof(decimal), typeof(decimal) })
            !;
        ...
        public static readonly MethodInfo StrCat3 = typeof(string)
            .GetMethod("Concat", new[] { typeof(string), typeof(string), typeof(string) })
            !;
        ...
        public static readonly MethodInfo StrCmp = typeof(string)
            .GetMethod("CompareOrdinal", new[] { typeof(string), typeof(string) })
            !;
