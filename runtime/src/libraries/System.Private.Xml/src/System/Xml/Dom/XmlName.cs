...
namespace System.Xml
{
    ...
    internal class XmlName : IXmlSchemaInfo
    {
        ...
        {
            get { return XmlSchemaValidity.NotKnown; }
        }
    ...
    internal sealed class XmlNameEx : XmlName
    {
        ...
        {
            get { return (_flags & IsDefaultBit) != 0; }
        }

        public override bool IsNil
        {
            get { return (_flags & IsNilBit) != 0; }
        }
        ...
        {
            get { return _decl as XmlSchemaElement; }
        }

        public override XmlSchemaAttribute? SchemaAttribute
        {
            get { return _decl as XmlSchemaAttribute; }
        }
        ...
        {
            if (value)
                _flags = (byte)(_flags | IsDefaultBit);
            else
                _flags = (byte)(_flags & ~IsDefaultBit);
        }
