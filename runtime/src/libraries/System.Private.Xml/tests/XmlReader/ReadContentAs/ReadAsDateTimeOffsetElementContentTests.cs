    ...
    public class DateTimeOffsetElementContentTests
    {
        ...
        public static void ReadElementContentAsDateTimeOffset100()
        {
            var reader = Utils.CreateFragmentReader(
                "<Root><![CDATA[00]]>01-01-01<?a?>T00:00:0<!-- Comment inbetween-->0+00:00</Root>"
            );
        ...
        {
            var reader = Utils.CreateFragmentReader(
                "<Root>   0001-01-01T00<?a?>:00:00<!-- Comment inbetween-->-1<!-- Comment inbetween-->3:<![CDATA[60]]>   </Root>"
            );
            reader.PositionOnElement("Root");
            Assert.Equal(
                new DateTimeOffset(1, 1, 1, 0, 0, 0, TimeSpan.FromHours(-14)).ToString(),
                reader.ReadElementContentAs(typeof(DateTimeOffset), null, "Root", "").ToString()
            );
        }
        ...
        {
            var reader = Utils.CreateFragmentReader(
                "<Root>0<!-- Comment inbetween-->01-0<?a?>1-01T00:00:00+00:00</Root>"
            );
            reader.PositionOnElement("Root");
            Assert.Throws<XmlException>(() =>
                reader.ReadElementContentAs(typeof(DateTimeOffset), null, "Root", "")
            );
            Assert.Throws<XmlException>(() =>
                reader.ReadElementContentAs(typeof(DateTimeOffset), null, "Root", "")
            );
        ...
        {
            var reader = Utils.CreateFragmentReader(
                "<Root>0001-01-<!-- Comment inbetween-->01T00:0<?a?>0:00-14:01</Root>"
            );
            reader.PositionOnElement("Root");
        ...
        {
            var reader = Utils.CreateFragmentReader(
                "<Root>9999-<!-- Comment inbetween-->12-3<?a?>1T1<![CDATA[2]]>:59:59+15:00</Root>"
            );
            reader.PositionOnElement("Root");
            Assert.Throws<ArgumentOutOfRangeException>(() =>
                reader.ReadElementContentAs(typeof(DateTimeOffset), null, "Root", "")
        ...
        {
            var reader = Utils.CreateFragmentReader(
                "<Root>999<!-- Comment inbetween-->9-1<![CDATA[2]]>-31T1<![CDATA[2]]>:59:6<?a?>0-1<?a?>1:00</Root>"
            );
            reader.PositionOnElement("Root");
            Assert.Throws<XmlException>(() =>
                reader.ReadElementContentAs(typeof(DateTimeOffset), null, "Root", "")
        ...
        {
            var reader = Utils.CreateFragmentReader(
                "<Root>99<!-- Comment inbetween-->9<![CDATA[z]]></Root>"
            );
            reader.PositionOnElement("Root");
            Assert.Throws<XmlException>(() =>
                reader.ReadElementContentAs(typeof(DateTimeOffset), null, "Root", "")
        ...
        public static void ReadElementContentAsDateTimeOffset11()
        {
            ...
            Assert.Equal(
                ...
                (DateTimeOffset)reader.ReadElementContentAs(typeof(DateTimeOffset), null)
            );
        }
        ...
        {
            var reader = Utils.CreateFragmentReader(
                "<Root><![CDATA[2]]>100-02-29T23:59:59.9999999+13:60</Root>"
            );
            reader.PositionOnElement("Root");
            Assert.Throws<XmlException>(() =>
                reader.ReadElementContentAs(typeof(DateTimeOffset), null, "Root", "")
        ...
        {
            var reader = Utils.CreateFragmentReader(
                "<Root>300<!-- Comment inbetween-->0-0<![CDATA[2]]>-29T23:59:<?a?>59.999999999999-13:60</Root>"
            );
            reader.PositionOnElement("Root");
            Assert.Throws<XmlException>(() =>
                reader.ReadElementContentAs(typeof(DateTimeOffset), null, "Root", "")
        ...
        {
            var reader = Utils.CreateFragmentReader(
                "<Root>21<!-- Comment inbetween-->00-02-29T<![CDATA[2]]>3:59:59.<?a?>999999999999Z</Root>"
            );
            reader.PositionOnElement("Root");
            Assert.Throws<XmlException>(() =>
                reader.ReadElementContentAs(typeof(DateTimeOffset), null, "Root", "")
        ...
        {
            var reader = Utils.CreateFragmentReader(
                "<Root>3<!-- Comment inbetween-->000-02<!-- Comment inbetween-->-29T<?a?>23:59:59.999<![CDATA[2]]>99999999z</Root>"
            );
            reader.PositionOnElement("Root");
            Assert.Throws<XmlException>(() =>
                reader.ReadElementContentAs(typeof(DateTimeOffset), null, "Root", "")
        ...
        {
            var reader = Utils.CreateFragmentReader(
                "<Root><![CDATA[2]]>0<!-- Comment inbetween-->0<?a?><![CDATA[2]]>-13-30</Root>"
            );
            reader.PositionOnElement("Root");
            Assert.Throws<XmlException>(() =>
                reader.ReadElementContentAs(typeof(DateTimeOffset), null, "Root", "")
        ...
        public static void ReadElementContentAsDateTimeOffset17()
        {
            ...
            Assert.Equal(
                new DateTimeOffset(
                    new DateTime(2000, 2, 29, 23, 59, 59, DateTimeKind.Local).AddTicks(9999999)
                ),
                (DateTimeOffset)reader.ReadElementContentAs(typeof(DateTimeOffset), null)
            );
        }
        ...
        {
            var reader = Utils.CreateFragmentReader(
                "<Root>0001-<![CDATA[0<!-- Comment inbetween-->1]]>-01T0<?a?>0:00:00</Root>"
            );
            reader.PositionOnElement("Root");
            Assert.Throws<XmlException>(() =>
                reader.ReadElementContentAs(typeof(DateTimeOffset), null)
            );
        }
        ...
        {
            var reader = Utils.CreateFragmentReader(
                "<Root>  20<?9?>02-1<![CDATA[2]]>-3<!-- Comment inbetween-->0  </Root>"
            );
            reader.PositionOnElement("Root");
            Assert.Throws<XmlException>(() =>
                reader.ReadElementContentAs(typeof(DateTimeOffset), null)
        ...
        {
            var reader = Utils.CreateFragmentReader(
                "<Root>  000<!-- Comment inbetween-->1-01-01T00:00:00-14:00z  </Root>"
            );
            reader.PositionOnElement("Root");
            Assert.Throws<XmlException>(() =>
                reader.ReadElementContentAs(typeof(DateTimeOffset), null)
        ...
        {
            var reader = Utils.CreateFragmentReader(
                "<Root>9999-1<![CDATA[0<!-- Comment inbetween-->1]]>-31T12:59:59+14:00z</Root>"
            );
            reader.PositionOnElement("Root");
            Assert.Throws<XmlException>(() =>
                reader.ReadElementContentAs(typeof(DateTimeOffset), null)
        ...
        {
            var reader = Utils.CreateFragmentReader(
                "<Root>   200<!-- Comment inbetween-->2-<![CDATA[12]]>-3<?a?>0Z   </Root>"
            );
            reader.PositionOnElement("Root");
            Assert.Equal(
                new DateTimeOffset(2002, 12, 30, 0, 0, 0, TimeSpan.FromHours(0)).ToString(),
        ...
        {
            var reader = Utils.CreateFragmentReader(
                "<Root><![CDATA[9]]>99<?a?>9-12-31T12:<!-- Comment inbetween-->5<![CDATA[9]]>:5<![CDATA[9]]>+14:00</Root>"
            );
            reader.PositionOnElement("Root");
            Assert.Equal(
                new DateTimeOffset(9999, 12, 31, 12, 59, 59, TimeSpan.FromHours(+14)).ToString(),
                reader.ReadElementContentAs(typeof(DateTimeOffset), null).ToString()
            );
        }
        ...
        {
            var reader = Utils.CreateFragmentReader(
                "<Root>  9<![CDATA[9]]>99-1<?a?>2-31T1<!-- Comment inbetween-->2:59:59-10:60     </Root>"
            );
            reader.PositionOnElement("Root");
            Assert.Equal(
        ...
        {
            var reader = Utils.CreateFragmentReader(
                "<Root>  20<!-- Comment inbetween-->05 </Root>"
            );
            reader.PositionOnElement("Root");
            Assert.Equal(
                new DateTimeOffset(
        ...
        {
            var reader = Utils.CreateFragmentReader(
                "<Root> 9<![CDATA[9]]>9<!-- Comment inbetween-->9<?a?> </Root>"
            );
            reader.PositionOnElement("Root");
            Assert.Equal(
                new DateTimeOffset(
        ...
        {
            var reader = Utils.CreateFragmentReader(
                "<Root> 0<?a?>0<!-- Comment inbetween-->01Z </Root>"
            );
            reader.PositionOnElement("Root");
            Assert.Equal(
                new DateTimeOffset(1, 1, 1, 0, 0, 0, TimeSpan.FromHours(0)).ToString(),
        ...
        {
            var reader = Utils.CreateFragmentReader(
                "<Root>99<!-- Comment inbetween-->9<![CDATA[9]]>Z<?a?></Root>"
            );
            reader.PositionOnElement("Root");
            Assert.Equal(
                new DateTimeOffset(9999, 1, 1, 0, 0, 0, TimeSpan.FromHours(0)).ToString(),
                reader.ReadElementContentAs(typeof(DateTimeOffset), null).ToString()
            );
        }
        ...
        {
            var reader = Utils.CreateFragmentReader(
                "<Root>2<!-- Comment inbetween-->000-02-29T23:5<?a?>9:5<![CDATA[9]]>.999999<![CDATA[9]]>+13:60  </Root>"
            );
            reader.PositionOnElement("Root");
            Assert.Equal(
                new DateTimeOffset(2000, 2, 29, 23, 59, 59, TimeSpan.FromHours(14)).ToString(),
                reader.ReadElementContentAs(typeof(DateTimeOffset), null).ToString()
            );
        }
        ...
        {
            var reader = Utils.CreateFragmentReader(
                "<Root>    20<?a?>00-02-29T23:59:59.999999999999-<!-- Comment inbetween-->13:60</Root>"
            );
            reader.PositionOnElement("Root");
            Assert.Equal(
        ...
        {
            var reader = Utils.CreateFragmentReader(
                "<Root>2<?a?>00<!-- Comment inbetween-->2-12-3<![CDATA[0]]></Root>"
            );
            reader.PositionOnElement("Root");
            Assert.Equal(
                new DateTimeOffset(
        ...
        {
            var reader = Utils.CreateFragmentReader(
                "<Root>  20<?9?>02-1<![CDATA[2]]>-<?a?>3<!-- Comment inbetween-->0  </Root>"
            );
            reader.PositionOnElement("Root");
            Assert.Throws<XmlException>(() =>
                reader.ReadElementContentAs(typeof(DateTimeOffset), null)
        ...
        {
            var reader = Utils.CreateFragmentReader(
                "<Root><![CDATA[2]]>01-01-01T00<?a?>:0<!-- Comment inbetween-->0:00+00:00</Root>"
            );
            reader.PositionOnElement("Root");
            Assert.Throws<XmlException>(() =>
                reader.ReadElementContentAs(typeof(DateTimeOffset), null)
        ...
        {
            var reader = Utils.CreateFragmentReader(
                "<Root><![CDATA[2]]>00<?a?>1-01-01T00:<!-- Comment inbetween-->00:00-14:01</Root>"
            );
            reader.PositionOnElement("Root");
            Assert.Throws<ArgumentOutOfRangeException>(() =>
                reader.ReadElementContentAs(typeof(DateTimeOffset), null)
        ...
        {
            var reader = Utils.CreateFragmentReader(
                "<Root><!-- Comment inbetween-->99<?a?>99-12-31T12:59:59+14:0<![CDATA[2]]></Root>"
            );
            reader.PositionOnElement("Root");
            Assert.Throws<ArgumentOutOfRangeException>(() =>
                reader.ReadElementContentAs(typeof(DateTimeOffset), null)
        ...
        {
            var reader = Utils.CreateFragmentReader(
                "<Root>9<?a?>999-1<!-- Comment inbetween-->2-31T12:<![CDATA[2]]>9:60-11:00</Root>"
            );
            reader.PositionOnElement("Root");
            Assert.Throws<XmlException>(() =>
                reader.ReadElementContentAs(typeof(DateTimeOffset), null)
        ...
        {
            var reader = Utils.CreateFragmentReader(
                "<Root><?a?>0<![CDATA[2]]><!-- Comment inbetween--></Root>"
            );
            reader.PositionOnElement("Root");
            Assert.Throws<XmlException>(() =>
                reader.ReadElementContentAs(typeof(DateTimeOffset), null)
        ...
        {
            var reader = Utils.CreateFragmentReader(
                "<Root>9<?a?>9<!-- Comment inbetween-->9<![CDATA[z]]></Root>"
            );
            reader.PositionOnElement("Root");
            Assert.Throws<XmlException>(() =>
                reader.ReadElementContentAs(typeof(DateTimeOffset), null)
        ...
        {
            var reader = Utils.CreateFragmentReader(
                "<Root><![CDATA[z<!-- Comment inbetween-->]]></Root>"
            );
            reader.PositionOnElement("Root");
            Assert.Throws<XmlException>(() =>
                reader.ReadElementContentAs(typeof(DateTimeOffset), null)
        ...
        {
            var reader = Utils.CreateFragmentReader(
                "<Root><![CDATA[<!-- Comment inbetween-->Z]]></Root>"
            );
            reader.PositionOnElement("Root");
            Assert.Throws<XmlException>(() =>
                reader.ReadElementContentAs(typeof(DateTimeOffset), null)
        ...
        {
            var reader = Utils.CreateFragmentReader(
                "<Root>21<!-- Comment inbetween-->00-02-<![CDATA[2]]>9T23:59:59.9999999+13:60</Root>"
            );
            reader.PositionOnElement("Root");
            Assert.Throws<XmlException>(() =>
                reader.ReadElementContentAs(typeof(DateTimeOffset), null)
        ...
        {
            var reader = Utils.CreateFragmentReader(
                "<Root>30<!-- Comment inbetween-->00-02-29T<![CDATA[2]]>3:59:59.999999999999-13:60</Root>"
            );
            reader.PositionOnElement("Root");
            Assert.Throws<XmlException>(() =>
                reader.ReadElementContentAs(typeof(DateTimeOffset), null)
        ...
        public static void ReadElementContentAsDateTimeOffsetnull1()
        {
            ...
            Assert.Throws<ArgumentNullException>(() =>
                reader.ReadElementContentAs(typeof(DateTimeOffset), null, null, "")
            );
            Assert.Throws<ArgumentNullException>(() =>
                reader.ReadElementContentAs(typeof(DateTimeOffset), null, null, "")
            );
        ...
        public static void ReadElementContentAsDateTimeOffsetnull3()
        {
            ...
            reader.PositionOnElement("Root");
            Assert.Throws<ArgumentNullException>(() =>
                reader.ReadElementContentAs(typeof(DateTimeOffset), null, "Root", null)
            );
            Assert.Throws<ArgumentNullException>(() =>
                reader.ReadElementContentAs(typeof(DateTimeOffset), null, "Root", null)
            );
