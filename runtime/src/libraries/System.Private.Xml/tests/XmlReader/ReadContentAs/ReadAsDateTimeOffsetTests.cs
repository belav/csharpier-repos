...
namespace System.Xml.XmlReaderTests
{
    public class DateTimeOffsetTests
    {
        ...
        {
            var reader = Utils.CreateFragmentReader(
                "<Root>20<?a?>0<![CDATA[2<?a?>]]>-13-30  </Root>"
            );
            reader.PositionOnElement("Root");
            reader.Read();
            Assert.Throws<XmlException>(() => reader.ReadContentAsDateTimeOffset());
        ...
        {
            var reader = Utils.CreateFragmentReader(
                "<Root>   001-01-01<?a?>T00:00:00+00:00   </Root>"
            );
            reader.PositionOnElement("Root");
            reader.Read();
            Assert.Throws<XmlException>(() => reader.ReadContentAsDateTimeOffset());
        ...
        {
            var reader = Utils.CreateFragmentReader(
                "<Root>9999-1<![CDATA[2]]>-31T12:59:59+14:00:00</Root>"
            );
            reader.PositionOnElement("Root");
            reader.Read();
            Assert.Throws<XmlException>(() => reader.ReadContentAsDateTimeOffset());
        ...
        {
            var reader = Utils.CreateFragmentReader(
                "<Root>  9<?a?>9<!-- Comment inbetween-->99  Z  </Root>"
            );
            reader.PositionOnElement("Root");
            reader.Read();
            Assert.Throws<XmlException>(() => reader.ReadContentAsDateTimeOffset());
        ...
        {
            var reader = Utils.CreateFragmentReader(
                "<Root>A<?a?>B<!-- Comment inbetween-->CD</Root>"
            );
            reader.PositionOnElement("Root");
            reader.Read();
            Assert.Throws<XmlException>(() => reader.ReadContentAsDateTimeOffset());
        ...
        {
            var reader = Utils.CreateFragmentReader(
                "<Root>   21<?a?>00<!-- Comment inbetween-->-02-29T23:59:59.9999999+13:60  </Root>"
            );
            reader.PositionOnElement("Root");
            reader.Read();
            Assert.Throws<XmlException>(() => reader.ReadContentAsDateTimeOffset());
        ...
        {
            var reader = Utils.CreateFragmentReader(
                "<Root>3000-<?a?>02-29T<!-- Comment inbetween-->23:59:59.999999999999-13:60</Root>"
            );
            reader.PositionOnElement("Root");
            reader.Read();
            Assert.Throws<XmlException>(() => reader.ReadContentAsDateTimeOffset());
        ...
        {
            var reader = Utils.CreateFragmentReader(
                "<Root>9999-12-31T12:5<?a?>9:59+14:00:00</Root>"
            );
            reader.PositionOnElement("Root");
            reader.Read();
            Assert.Throws<XmlException>(() => reader.ReadContentAs(typeof(DateTimeOffset), null));
        ...
        {
            var reader = Utils.CreateFragmentReader(
                "<Root>21<!-- Comment inbetween-->00-02-29T23:59:59.9999999+13:60</Root>"
            );
            reader.PositionOnElement("Root");
            reader.Read();
            Assert.Throws<XmlException>(() => reader.ReadContentAs(typeof(DateTimeOffset), null));
        ...
        {
            var reader = Utils.CreateFragmentReader(
                "<Root>3000-02-29T23:59:<!-- Comment inbetween-->9.999999999999-13:60</Root>"
            );
            reader.PositionOnElement("Root");
            reader.Read();
            Assert.Throws<XmlException>(() => reader.ReadContentAs(typeof(DateTimeOffset), null));
        ...
        {
            var reader = Utils.CreateFragmentReader(
                "<Root>001-01-01T0<?a?>0:00:00<!-- Comment inbetween-->+00:00</Root>"
            );
            reader.PositionOnElement("Root");
            reader.Read();
            Assert.Throws<XmlException>(() => reader.ReadContentAs(typeof(DateTimeOffset), null));
