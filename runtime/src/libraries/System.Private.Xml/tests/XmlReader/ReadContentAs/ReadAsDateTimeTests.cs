    ...
    public class DateTimeTests
    {
        ...
        public static void ReadContentAsDateTime1()
        {
            var reader = Utils.CreateFragmentReader(
                "<Root>0001-<![CDATA[01]]>-01T0<?a?>0:00:00<!-- Comment inbetween--></Root>"
            );
        ...
        {
            var reader = Utils.CreateFragmentReader(
                "<Root>  20<?a?>02-1<![CDATA[2]]>-3<!-- Comment inbetween-->0  </Root>"
            );
            reader.PositionOnElement("Root");
            reader.Read();
            Assert.Equal(
        ...
        {
            var reader = Utils.CreateFragmentReader(
                "<Root>  <![CDATA[2]]>00<?a?>2-1<!-- Comment inbetween-->2-30Z  </Root>"
            );
            reader.PositionOnElement("Root");
            reader.Read();
            Assert.Equal(
                new DateTime(2002, 12, 30, 0, 0, 0, 0).Add(new TimeSpan(0, 0, 0)),
                (DateTime)reader.ReadContentAs(typeof(DateTime), null)
            );
        }
        ...
        {
            var reader = Utils.CreateFragmentReader(
                "<Root>  <!-- Comment inbetween-->0002-01-01T00:00:00+00:00  </Root>"
            );
            reader.PositionOnElement("Root");
            reader.Read();
            Assert.Equal(
        ...
        {
            var reader = Utils.CreateFragmentReader(
                "<Root>99<?a?>99-12-31T12:59:59+14:00:00</Root>"
            );
            reader.PositionOnElement("Root");
            reader.Read();
            Assert.Throws<XmlException>(() => reader.ReadContentAs(typeof(DateTime), null));
        ...
        {
            var reader = Utils.CreateFragmentReader(
                "<Root>21<?a?>00-02-29T23:59:59.9999999+13:60  </Root>"
            );
            reader.PositionOnElement("Root");
            reader.Read();
            Assert.Throws<XmlException>(() => reader.ReadContentAs(typeof(DateTime), null));
        ...
        {
            var reader = Utils.CreateFragmentReader(
                "<Root>99<!-- Comment inbetween-->99-1<?a?>2-31T1<![CDATA[2]]>:59:59</Root>"
            );
            reader.PositionOnElement("Root");
            reader.Read();
            Assert.Equal(
        ...
        {
            var reader = Utils.CreateFragmentReader(
                "<Root>3  000-0<?a?>2-29T23:59:59.999999999999-13:60</Root>"
            );
            reader.PositionOnElement("Root");
            reader.Read();
            Assert.Throws<XmlException>(() => reader.ReadContentAs(typeof(DateTime), null));
        ...
        {
            var reader = Utils.CreateFragmentReader(
                "<Root>  0<?a?>0:0<!-- Comment inbetween-->0:00+00:00   </Root>"
            );
            reader.PositionOnElement("Root");
            reader.Read();
            Assert.Equal(
        ...
        {
            var reader = Utils.CreateFragmentReader(
                "<Root>  999<!-- Comment inbetween-->9  </Root>"
            );
            reader.PositionOnElement("Root");
            reader.Read();
            Assert.Equal(
        ...
        public static void ReadContentAsDateTime7()
        {
            ...
            reader.Read();
            Assert.Equal(
                new DateTime(9999, 1, 1, 0, 0, 0, 0).Add(new TimeSpan(0, 0, 0)),
                (DateTime)reader.ReadContentAs(typeof(DateTime), null)
            );
        }
        ...
        {
            var reader = Utils.CreateFragmentReader(
                "<Root>   2000-0<![CDATA[2]]>-29T23:59:59.999<?a?>9999   </Root>"
            );
            reader.PositionOnElement("Root");
            reader.Read();
            Assert.Equal(
        ...
        {
            var reader = Utils.CreateFragmentReader(
                "<Root>  2<?a?>00<!-- Comment inbetween-->0-02-29T23:59:5<?a?>9-13:<![CDATA[60]]>    </Root>"
            );
            reader.PositionOnElement("Root");
            reader.Read();
            Assert.Equal(
        ...
        {
            var reader = Utils.CreateFragmentReader(
                @"<doc>   99<!-- Comment inbetween-->99-1<![CDATA[2]]>-31T01:60:5<?a?>9.99<?a?>9999<![CDATA[4]]>9<?Zz?>-00<![CDATA[:]]>00   </doc>"
            );
        ...
        {
            var reader = Utils.CreateFragmentReader(
                @"<f a='2002-02-29T23:59:59.9999999999999+13:61'/>"
            );
        ...
        public static void ReadContentAsDateTimeWithWhitespace2()
        {
            ...
            Assert.Equal(
                new DateTimeOffset(
                    ...
                    0,
                    0,
                    TimeZoneInfo.Local.GetUtcOffset(new DateTime(9999, 12, 31))
                ).ToString(),
