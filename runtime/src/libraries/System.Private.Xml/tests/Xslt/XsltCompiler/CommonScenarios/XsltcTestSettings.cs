...
namespace System.Xml.Tests
{
    ...
    public class XsltcTestSettings : XsltcTestCaseBase
    {
        ...
        public XsltcTestSettings(ITestOutputHelper output)
            : base(output)
        {
            _output = output;
        }
        ...
        [InlineData(
            "/settings:script+document- sft44.xsl",
            "sft44.dll",
            "no",
            "sft44",
            "sft44.pdb",
        ...
        [InlineData(
            "/settings:script+ sft3.xsl sft4.xsl",
            "sft3.dll",
            "yes",
            "",
            "sft3.pdb",
