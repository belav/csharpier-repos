...
namespace System.Xml.Tests
{
    ...
    public class ToTypeTests : CTestCase
    {
        ...
        {
            AddChild(
                new CVariation(ToType1) { Attribute = new Variation("ToBoolean - valid cases") }
            );
            AddChild(
                new CVariation(ToType2) { Attribute = new Variation("ToBoolean - invalid cases") }
            );
            AddChild(new CVariation(ToType3) { Attribute = new Variation("ToByte - valid cases") });
            AddChild(
                new CVariation(ToType4) { Attribute = new Variation("ToByte - invalid cases") }
            );
            AddChild(new CVariation(ToType5) { Attribute = new Variation("ToChar - valid cases") });
            AddChild(
                new CVariation(ToType6) { Attribute = new Variation("ToChar - invalid cases") }
            );
            AddChild(
                new CVariation(ToType9) { Attribute = new Variation("ToDecimal - valid cases") }
            );
            AddChild(
                new CVariation(ToType10) { Attribute = new Variation("ToDecimal - invalid cases") }
            );
            AddChild(
                new CVariation(ToType11) { Attribute = new Variation("ToDouble - valid cases") }
            );
            AddChild(
                new CVariation(ToType12) { Attribute = new Variation("ToDouble - invalid cases") }
            );
            AddChild(
                new CVariation(ToType13) { Attribute = new Variation("ToInt16 - valid cases") }
            );
            AddChild(
                new CVariation(ToType14) { Attribute = new Variation("ToInt16 - invalid cases") }
            );
            AddChild(
                new CVariation(ToType15) { Attribute = new Variation("ToInt32 - valid cases") }
            );
            AddChild(
                new CVariation(ToType16) { Attribute = new Variation("ToInt32 - invalid cases") }
            );
            AddChild(
                new CVariation(ToType17) { Attribute = new Variation("ToInt64 - valid cases") }
            );
            AddChild(
                new CVariation(ToType18) { Attribute = new Variation("ToInt64 - invalid cases") }
            );
            AddChild(
                new CVariation(ToType19) { Attribute = new Variation("ToSingle - valid cases") }
            );
            AddChild(
                new CVariation(ToType20) { Attribute = new Variation("ToSingle - invalid cases") }
            );
            AddChild(
                new CVariation(ToType21) { Attribute = new Variation("ToSByte - valid cases") }
            );
            AddChild(
                new CVariation(ToType22) { Attribute = new Variation("ToSByte - invalid cases") }
            );
            AddChild(
                new CVariation(ToType23) { Attribute = new Variation("ToTimeSpan - valid cases") }
            );
            AddChild(
                new CVariation(ToType24) { Attribute = new Variation("ToTimeSpan - invalid cases") }
            );
            AddChild(
                new CVariation(ToType25) { Attribute = new Variation("ToUInt16 - valid cases") }
            );
            AddChild(
                new CVariation(ToType26) { Attribute = new Variation("ToUInt16 - invalid cases") }
            );
            AddChild(
                new CVariation(ToType27) { Attribute = new Variation("ToUInt32 - valid cases") }
            );
            AddChild(
                new CVariation(ToType28) { Attribute = new Variation("ToUInt32 - invalid cases") }
            );
            AddChild(
                new CVariation(ToType29) { Attribute = new Variation("ToUInt64 - valid cases") }
            );
            AddChild(
                new CVariation(ToType30) { Attribute = new Variation("ToUInt64 - invalid cases") }
            );
            AddChild(
                new CVariation(ToType31) { Attribute = new Variation("ToGuid - valid cases") }
            );
            AddChild(
                new CVariation(ToType32) { Attribute = new Variation("ToGuid - invalid cases") }
            );
            AddChild(
        ...
        public int ToType23()
        {
            object[] array0 =
            {
                ...
                " PT00H07M45S",
                "-P6DT07H45M58.45S",
                "P6DT07H45M58.4521547S",
                "P100Y250M362DT455H2542M1245.4521547S",
                "P1D",
                "P1M",
                "P1YT1S",
                "P0Y",
            ...
            object[] array1 =
            {
                new TimeSpan(6, 7, 45, 58, 450),
                new TimeSpan(401, 7, 45, 58),
                new TimeSpan(0, 7, 45),
                -new TimeSpan(6, 7, 45, 58, 450),
                (new TimeSpan(6, 7, 45, 58)).Add(new TimeSpan(4521547)),
                (new TimeSpan(44482, 17, 42, 45)).Add(new TimeSpan(4521547)),
                new TimeSpan(1, 0, 0, 0),
                new TimeSpan(30, 0, 0, 0),
                new TimeSpan(365, 0, 0, 1),
        ...
        public int ToType32()
        {
            ...
            {
                "0000000a-",
                "0000000Z-000b-000c-0001-020304050607",
        ...
        public int ToType35()
        {
            ...
            CError.Compare(
                XmlConvert.ToString(243.657745094698e-23),
                "2.43657745094698E-21",
                "double"
            );
        ...
        public int ToType36()
        {
            ...
            CError.Compare(
                XmlConvert.ToString((decimal)0.0000000000000000000000001),
                "0.0000000000000000000000001",
                "decimal"
            );
            CError.Compare(
                XmlConvert.ToString((decimal)145896.233422154),
                "145896.233422154",
                "decimal"
            );
            CError.Compare(
            ...
            CError.Compare(
                XmlConvert.ToString((decimal)1234567890123456789),
                (1234567890123456789M).ToString(),
                "decimal"
            );
        ...
        public int ToType38()
        {
            // TimeSpan
            CError.Compare(
                XmlConvert.ToString(new TimeSpan(6, 7, 45, 58, 450)),
                "P6DT7H45M58.45S",
                "timespan"
            );
            CError.Compare(
        ...
        {
            CError.Compare(
                XmlConvert.ToString(new Guid(0xa, 0xb, 0xc, 0, 1, 2, 3, 4, 5, 6, 7)),
                "0000000a-000b-000c-0001-020304050607",
                "guid"
            );
            return TEST_PASS;
        ...
        public int ToType43()
        {
            ...
            dt = new DateTime();
            dtLocal = XmlConvert.ToDateTime(
                "2002-12-31T07:15:55.0000000Z",
                XmlDateTimeSerializationMode.Local
            ); // this is just to get the offset
            dt = XmlConvert.ToDateTime(
                "2002-12-31T07:15:55.0000000Z",
                XmlDateTimeSerializationMode.RoundtripKind
            );
            if (
            ...
            dt = new DateTime();
            dt = XmlConvert.ToDateTime(
                "2002-12-31T07:15:55.0000000-00:00",
                XmlDateTimeSerializationMode.RoundtripKind
            );
            if (
                TimeZoneInfo.Local.GetUtcOffset(dt).Hours == -8
        ...
        public int ToType46()
        {
            ...
            CError.Equals(
                XmlConvert.ToString(dt, XmlDateTimeSerializationMode.Unspecified),
                expDateTime,
                "Read in Universal Time"
            );
        ...
        public int ToType47()
        {
            ...
            {
                "2002-12-30",
                "2002-12-30T23:15:55.100",
                "2002-01-09T04:02:08.145",
                "23:15:55.1004555",
                "2002-01-09T04:02:08",
                "23:15:55",
                "2002-01-09T04:02:08",
                "2002-01-09T04:02:08Z",
                "2002-01-09Z",
                "04:02:08Z",
                "2002-01-09T04:02:08-05:00",
                "2002-01-09-05:00",
                "04:02:08-05:00",
            ...
            object[] array1 =
            {
                ...
                new DateTime(2002, 12, 30, 23, 15, 55, 100),
                new DateTime(2002, 1, 9, 4, 2, 8, 145),
                (
                    new DateTime(
                        DateTime.Now.Year,
                        DateTime.Now.Month,
        ...
        public int ToType52()
        {
            ...
            object[] array0 =
            {
                ...
                "9999",
                "9999Z",
                "9999-12-31T12:59:59+14:00",
                "9999-12-31T12:59:59-11:00",
                "9999-12-31T12:59:59-10:59",
                "9999-12-31T12:59:59+13:59",
                "9999-12-31T23:59:59-00:00",
                "9999-12-31T23:59:59+14:00",
                "9998-12-31T12:59:59+14:00",
                "9998-12-31T12:59:59-14:00",
                "0002",
                "0001Z",
                "0002-01-01T00:00:00-14:00",
                "0002-01-01T00:00:00-13:59",
            ...
            object[] array1 =
            {
                ...
                new DateTimeOffset(
                    ...
                    0,
                    0,
                    TimeZoneInfo.Local.GetUtcOffset(new DateTime(2016, 2, 29))
                ),
                new DateTimeOffset(
                    9999,
                    1,
                ...
                new DateTimeOffset(9999, 12, 31, 12, 59, 59, TimeSpan.FromHours(14.0)),
                ...
                new DateTimeOffset(9999, 12, 31, 23, 59, 59, TimeSpan.FromHours(14.0)),
                ...
                new DateTimeOffset(2, 1, 1, 0, 0, 0, TimeSpan.FromHours(-14.0)),
                new DateTimeOffset(
                    2,
                    1,
                    1,
        ...
        public int ToType53()
        {
            ...
            object[] array0 =
            {
                "9999-12-31T12:59:59-10:60",
                "9999-12-31T12:59:59+13:60",
                "9998-12-31T12:59:59-12:99",
                "9998-12-31T12:59:59+12:99",
                "0001-01-01T00:00:00-13:60",
                "2000-02-29T23:59:59.999999999999999+01:99",
                "2000-02-29T23:59:59.99999999999999999-00:99",
                "0001-01-01T00:00:00.99999999999999999999-13:60",
                "0001-01-01T00:00:00.99999999999999999-00:00",
                "9999-12-31T12:59:59.99999999999+13:60",
                "9999-12-31T12:59:59.99999999999999999999999999999-10:59",
            ...
            object[] array1 =
            {
                ...
                new DateTimeOffset(
                    ...
                    59,
                    59,
                    TimeSpan.FromHours(-13) + TimeSpan.FromMinutes(-39)
                ),
                new DateTimeOffset(
                    9998,
                    12,
                ...
                new DateTimeOffset(
                    ...
                    0,
                    0,
                    TimeSpan.FromHours(2) + TimeSpan.FromMinutes(39)
                ),
                new DateTimeOffset(
                    2000,
                    3,
                    ...
                    0,
                    0,
                    TimeSpan.FromHours(-1) + TimeSpan.FromMinutes(-39)
                ),
                new DateTimeOffset(1, 1, 1, 0, 0, 1, TimeSpan.FromHours(-14.0)),
                new DateTimeOffset(1, 1, 1, 0, 0, 1, TimeSpan.FromHours(-0)),
                new DateTimeOffset(9999, 12, 31, 13, 0, 0, TimeSpan.FromHours(+14.0)),
                new DateTimeOffset(
                    9999,
                    12,
                    31,
        ...
        public int ToType54()
        {
            ...
            string[] array =
            {
                "9999-12-31T12:59:59-10:60",
                "9999-12-31T12:59:59+13:60",
                "9998-12-31T12:59:59-13:60",
                "9998-12-31T12:59:59+13:60",
                "0001-01-01T00:00:00-13:60",
                "2000-02-29T23:59:59.999999999999999+13:60",
                "2000-02-29T23:59:59.99999999999999999-13:60",
                "0001-01-01T00:00:00.99999999999999999999-13:60",
        ...
        public int ToType55()
        {
            ...
            string[] array =
            {
                ...
                "2002-01-9",
                "2002-01-09T04:02:8",
                "02002-01-09T04:02:08",
                "02002-01-09",
                "02002-01-09T",
                ":02:08",
                "04:08",
                "04:02:8",
                "9999-12-31T12:59:59-12:00",
                "1/1/0001",
                "1:1:0001",
                "9999/12/31",
                "9999:12:31",
                "9998-12-31T12:59:59-15:00",
                "0001-01-01T00:00:00-99:00",
                "0001-01-01T00:00:00+00:165",
                "9998-12-31T12:59:59-13:61",
                "9998-12-31T12:59:59+13:61",
                "9999-12-31T12:59:59+15:00",
                "0001-01-01T00:00:00+00:01",
                "9999-12-31T23:59:59-00:01",
                "9999-12-31T23:59:59+14:01",
        ...
        public int ToType57()
        {
            ...
            dto = new DateTimeOffset(2002, 12, 30, 23, 15, 55, TimeSpan.Zero);
            CError.Equals(
                XmlConvert.ToString(dto, "yyyy-MM-ddTHH:mm:sszzzzzz"),
                "2002-12-30T23:15:55+00:00",
                "datetimeOffset4"
            );
            ...
            dto = new DateTimeOffset(1, 1, 1, 0, 0, 0, 1, TimeSpan.FromHours(-0));
            CError.Equals(
                XmlConvert.ToString(dto, "yyyy-MM-ddTHH:mm:ss.FFFFFFFzzzzzz"),
                "0001-01-01T00:00:00.001+00:00",
                "datetimeOffset22"
            );
