...
namespace System.Xml.XmlConvertTests
{
    public class XmlConvertTests : CTestModule
    {
        ...
        public static CTestModule Create()
        {
            ...
            module.AddChild(
                new XmlCombiningCharConvertTests1
                {
                    Attribute = new TestCase
                    {
            ...
            module.AddChild(
                new XmlCombiningCharConvertTests2
                {
                    Attribute = new TestCase
                    {
                        Name =
            ...
            module.AddChild(
                new XmlCombiningCharConvertTests3
                {
                    Attribute = new TestCase
                    {
            ...
            module.AddChild(
                new XmlEmbeddedNullCharConvertTests1
                {
                    Attribute = new TestCase
                    {
            ...
            module.AddChild(
                new XmlEmbeddedNullCharConvertTests2
                {
                    Attribute = new TestCase
                    {
            ...
            module.AddChild(
                new XmlEmbeddedNullCharConvertTests3
                {
                    Attribute = new TestCase
                    {
            ...
            module.AddChild(
                new XmlIdeographicCharConvertTests1
                {
                    Attribute = new TestCase
                    {
                        Name =
            ...
            module.AddChild(
                new XmlIdeographicCharConvertTests2
                {
                    Attribute = new TestCase
                    {
                        Name =
