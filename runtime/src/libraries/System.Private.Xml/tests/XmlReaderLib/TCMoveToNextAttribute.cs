...
{
    partial public class TCMoveToNextAttribute : TCXMLReaderBaseGeneral
    {
        ...
        public override void AddChildren()
        {
            ...
            {
                this.AddChild(
                    new CVariation(MoveToNextAttribute1)
                    {
            ...
            {
                this.AddChild(
                    new CVariation(MoveToNextAttribute2)
                    {
                        Attribute = new Variation(
            ...
            {
                this.AddChild(
                    new CVariation(MoveToNextAttribute3)
                    {
                        Attribute = new Variation(
            ...
            {
                this.AddChild(
                    new CVariation(MoveToNextAttribute4)
                    {
                        Attribute = new Variation(
            ...
            {
                this.AddChild(
                    new CVariation(MoveToNextAttribute9)
                    {
                        Attribute = new Variation(
