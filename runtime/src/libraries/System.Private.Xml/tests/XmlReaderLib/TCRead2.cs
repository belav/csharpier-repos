...
{
    partial public class TCRead2 : TCXMLReaderBaseGeneral
    {
        ...
        public override void AddChildren()
        {
            ...
            {
                this.AddChild(
                    new CVariation(v3) { Attribute = new Variation("Read stream less than 4K") }
                );
            }
            ...
            {
                this.AddChild(
                    new CVariation(v14) { Attribute = new Variation("File with external DTD") }
                );
            }
            ...
            {
                this.AddChild(
                    new CVariation(XmlExceptionCtorWithNoParamsDoesNotThrow)
                    {
                        Attribute = new Variation(
