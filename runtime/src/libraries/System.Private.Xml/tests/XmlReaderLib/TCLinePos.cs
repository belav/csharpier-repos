...
{
    partial public class TCLinePos : TCXMLReaderBaseGeneral
    {
        ...
        public override void AddChildren()
        {
            ...
            {
                this.AddChild(
                    new CVariation(TestLinePos45) { Attribute = new Variation("HasLineInfo") }
                );
            }
            ...
            {
                this.AddChild(
                    new CVariation(XmlReaderShouldIncreaseLineNumberAfterNewLineInElementTag)
                    {
                        Attribute = new Variation(
