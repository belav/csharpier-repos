...
{
    partial public class TCIsEmptyElement : TCXMLReaderBaseGeneral
    {
        ...
        public override void AddChildren()
        {
            ...
            {
                this.AddChild(
                    new CVariation(TestEmptyNodeType_Whitespace)
                    {
                        Attribute = new Variation(
