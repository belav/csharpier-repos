...
{
    partial public class TCReadToNextSibling : TCXMLReaderBaseGeneral
    {
        ...
        public override void AddChildren()
        {
            ...
            // for function v3
            {
                this.AddChild(
                    new CVariation(v3)
                    {
                        Attribute = new Variation("Read on next sibling with same names 3")
                        {
                            Params = new object[]
                            {
                                "NS",
                ...
                this.AddChild(
                    new CVariation(v3)
                    {
                        Attribute = new Variation("Read on next sibling with same names 2")
                        {
                            Params = new object[]
                            {
                                "DNS",
                ...
                this.AddChild(
                    new CVariation(v3)
                    {
                        Attribute = new Variation("Read to next sibling with same names 1")
                        {
                            Params = new object[]
                            {
                                "NNS",
