...
{
    partial public class TCReadToFollowing : TCXMLReaderBaseGeneral
    {
        ...
        public override void AddChildren()
        {
            ...
            // for function v2
            {
                this.AddChild(
                    new CVariation(v2)
                    {
                        Attribute = new Variation("Read on following with same names")
                        {
                            Params = new object[] { "DNS" },
                            Pri = 1
                        }
            ...
            // for function v4
            {
                this.AddChild(
                    new CVariation(v4)
                    {
                        Attribute = new Variation("If name not found, go to eof") { Pri = 1 }
                    }
                );
            }
            ...
            // for function v5_1
            {
                this.AddChild(
                    new CVariation(v5_1)
                    {
                        Attribute = new Variation("If localname not found go to eof") { Pri = 1 }
                    }
                );
            }
            ...
            // for function v5_2
            {
                this.AddChild(
                    new CVariation(v5_2)
                    {
                        Attribute = new Variation("If uri not found, go to eof") { Pri = 1 }
                    }
                );
            }
