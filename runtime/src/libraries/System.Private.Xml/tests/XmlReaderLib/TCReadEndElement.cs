...
{
    partial public class TCReadEndElement : TCXMLReaderBaseGeneral
    {
        ...
        public override void AddChildren()
        {
            ...
            {
                this.AddChild(
                    new CVariation(TestReadEndElement1)
                    {
            ...
            {
                this.AddChild(
                    new CVariation(TestReadEndElement2)
                    {
            ...
            {
                this.AddChild(
                    new CVariation(TestReadEndElement4)
                    {
            ...
            {
                this.AddChild(
                    new CVariation(TestReadEndElement5)
                    {
            ...
            {
                this.AddChild(
                    new CVariation(TestReadEndElement6)
                    {
