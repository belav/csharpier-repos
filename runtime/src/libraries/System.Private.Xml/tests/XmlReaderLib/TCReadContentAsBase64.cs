...
{
    partial public class TCReadContentAsBase64 : TCXMLReaderBaseGeneral
    {
        ...
        public override void AddChildren()
        {
            ...
            {
                this.AddChild(
                    new CVariation(TestReadBase64_2)
                    {
            ...
            {
                this.AddChild(
                    new CVariation(TestReadBase64_5)
                    {
            ...
            {
                this.AddChild(
                    new CVariation(TestReadBase64_6)
                    {
                        Attribute = new Variation(
            ...
            {
                this.AddChild(
                    new CVariation(TestReadBase64_13)
                    {
                        Attribute = new Variation(
            ...
            {
                this.AddChild(
                    new CVariation(ReadBase64BufferOverflowWorksProperly)
                    {
                        Attribute = new Variation("105376: ReadBase64 runs into an Overflow")
                        {
