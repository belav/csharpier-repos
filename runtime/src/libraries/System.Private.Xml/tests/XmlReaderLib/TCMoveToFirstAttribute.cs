...
{
    partial public class TCMoveToFirstAttribute : TCXMLReaderBaseGeneral
    {
        ...
        public override void AddChildren()
        {
            ...
            {
                this.AddChild(
                    new CVariation(MoveToFirstAttribute1)
                    {
            ...
            {
                this.AddChild(
                    new CVariation(MoveToFirstAttribute2)
                    {
                        Attribute = new Variation(
                            "MoveToFirstAttribute() When AttributeCount=0, <NONEMPTY1>ABCDE</NONEMPTY1> "
                        )
                    }
                );
            }
            ...
            {
                this.AddChild(
                    new CVariation(MoveToFirstAttribute3)
                    {
                        Attribute = new Variation(
                            "MoveToFirstAttribute() When iOrdinal=0, with namespace"
                        )
                    }
                );
            }
            ...
            {
                this.AddChild(
                    new CVariation(MoveToFirstAttribute4)
                    {
                        Attribute = new Variation(
                            "MoveToFirstAttribute() When iOrdinal=0, without namespace"
                        )
                    }
                );
            }
            ...
            {
                this.AddChild(
                    new CVariation(MoveToFirstAttribute5)
                    {
                        Attribute = new Variation(
            ...
            {
                this.AddChild(
                    new CVariation(MoveToFirstAttribute6)
                    {
                        Attribute = new Variation(
            ...
            {
                this.AddChild(
                    new CVariation(MoveToFirstAttribute7)
                    {
                        Attribute = new Variation(
            ...
            {
                this.AddChild(
                    new CVariation(MoveToFirstAttribute8)
                    {
                        Attribute = new Variation(
