...
{
    partial public class TCReadStartElement : TCXMLReaderBaseGeneral
    {
        ...
        public override void AddChildren()
        {
            ...
            {
                this.AddChild(
                    new CVariation(TestReadStartElement1)
                    {
            ...
            {
                this.AddChild(
                    new CVariation(TestReadStartElement2)
                    {
            ...
            {
                this.AddChild(
                    new CVariation(TestReadStartElement3)
                    {
                        Attribute = new Variation(
            ...
            {
                this.AddChild(
                    new CVariation(TestReadStartElement4)
                    {
                        Attribute = new Variation(
            ...
            {
                this.AddChild(
                    new CVariation(TestReadStartElement5)
                    {
                        Attribute = new Variation(
            ...
            {
                this.AddChild(
                    new CVariation(TestReadStartElement7)
                    {
                        Attribute = new Variation(
            ...
            {
                this.AddChild(
                    new CVariation(TestReadStartElement8)
                    {
                        Attribute = new Variation(
            ...
            {
                this.AddChild(
                    new CVariation(TestReadStartElement10)
                    {
                        Attribute = new Variation(
            ...
            {
                this.AddChild(
                    new CVariation(TestReadStartElement14)
                    {
                        Attribute = new Variation(
            ...
            {
                this.AddChild(
                    new CVariation(TestReadStartElement15)
                    {
                        Attribute = new Variation(
            ...
            {
                this.AddChild(
                    new CVariation(TestReadStartElement16)
                    {
                        Attribute = new Variation(
