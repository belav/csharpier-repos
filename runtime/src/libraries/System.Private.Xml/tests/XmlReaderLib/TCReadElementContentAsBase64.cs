...
{
    partial public class TCReadElementContentAsBase64 : TCXMLReaderBaseGeneral
    {
        ...
        public override void AddChildren()
        {
            ...
            {
                this.AddChild(
                    new CVariation(ReadBase64RunsIntoOverflow)
                    {
            ...
            {
                this.AddChild(
                    new CVariation(TestReadBase64ReadsTheContent)
                    {
                        Attribute = new Variation(
            ...
            {
                this.AddChild(
                    new CVariation(SubtreeReaderInsertedAttributesWorkWithReadContentAsBase64)
                    {
                        Attribute = new Variation(
            ...
            {
                this.AddChild(
                    new CVariation(TestReadBase64_30)
                    {
                        Attribute = new Variation(
            ...
            {
                this.AddChild(
                    new CVariation(TestReadBase64_31)
                    {
                        Attribute = new Variation(
            ...
            {
                this.AddChild(
                    new CVariation(TestReadBase64_32)
                    {
                        Attribute = new Variation(
            ...
            {
                this.AddChild(
                    new CVariation(TestReadBase64_33)
                    {
                        Attribute = new Variation(
            ...
            {
                this.AddChild(
                    new CVariation(TestReadBase64_34)
                    {
            ...
            {
                this.AddChild(
                    new CVariation(TestReadReadBase64_35)
                    {
                        Attribute = new Variation(
            ...
            {
                this.AddChild(
                    new CVariation(TestReadReadBase64_36)
                    {
                        Attribute = new Variation(
