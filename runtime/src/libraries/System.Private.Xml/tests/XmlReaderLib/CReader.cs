...
namespace System.Xml.Tests
{
    public class XmlCustomReader : XmlReader
    {
        ...
        public override XmlReaderSettings Settings
        {
            ...
            {
                this.IsCalled = true;
                return _wrappedreader.Settings;
            }
        }
        ...
        public override string NamespaceURI
        {
            ...
            {
                this.IsCalled = true;
                return _wrappedreader.NamespaceURI;
            }
        }
        ...
        public override bool HasValue
        {
            ...
            {
                this.IsCalled = true;
                return _wrappedreader.HasValue;
            }
        }
        ...
        public override bool IsEmptyElement
        {
            ...
            {
                this.IsCalled = true;
                return _wrappedreader.IsEmptyElement;
            }
        }
        public override bool IsDefault
        {
            ...
            {
                this.IsCalled = true;
                return _wrappedreader.IsDefault;
            }
        }
        public override XmlSpace XmlSpace
        {
            ...
            {
                this.IsCalled = true;
                return _wrappedreader.XmlSpace;
            }
        }
        ...
        {
            this.IsCalled = true;
            return _wrappedreader.ReadElementContentAsObject();
        }
        ...
        {
            this.IsCalled = true;
            return _wrappedreader.ReadValueChunk(buffer, startIndex, count);
        }
        ...
        {
            this.IsCalled = true;
            return _wrappedreader.ReadElementContentAsBinHex(buffer, startIndex, count);
        }
        ...
        public override int AttributeCount
        {
            ...
            {
                this.IsCalled = true;
                return _wrappedreader.AttributeCount;
            }
        }
        ...
        {
            this.IsCalled = true;
            return _wrappedreader.ReadOuterXml();
        }
        ...
        {
            this.IsCalled = true;
            return _wrappedreader.ReadToNextSibling(localName, namespaceURI);
        }
        ...
        public override bool CanResolveEntity
        {
            ...
            {
                this.IsCalled = true;
                return _wrappedreader.CanResolveEntity;
            }
        }
    }
}
