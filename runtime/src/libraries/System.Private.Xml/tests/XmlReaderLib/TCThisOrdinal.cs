...
namespace System.Xml.Tests
{
    public partial class TCThisOrdinal : TCXMLReaderBaseGeneral
    {
        ...
        public override void AddChildren()
        {
            ...
            {
                this.AddChild(
                    new CVariation(OrdinalWithGetAttrDoubleQ)
                    {
            ...
            {
                this.AddChild(
                    new CVariation(OrdinalWithGetAttrSingleQ)
                    {
                        Attribute = new Variation(
                            "This[i] Verify with GetAttribute[i] - Single Quote"
                        ),
                    }
                );
            }
            ...
            {
                this.AddChild(
                    new CVariation(OrdinalWithMoveAttrDoubleQ)
                    {
                        Attribute = new Variation(
            ...
            {
                this.AddChild(
                    new CVariation(OrdinalWithMoveAttrSingleQ)
                    {
                        Attribute = new Variation(
                            "This[i] Verify with MoveToAttribute[i] - Single Quote"
                        ),
                    }
                );
            }
            ...
            {
                this.AddChild(
                    new CVariation(NegativeOneOrdinal)
                    {
                        Attribute = new Variation("ThisOrdinal NegativeOneOrdinal") { Pri = 0 },
                    }
                );
            }
            ...
            // for function FieldCountOrdinal
            {
                this.AddChild(
                    ...
                    {
                        Attribute = new Variation("ThisOrdinal FieldCountOrdinal"),
                    }
                );
            }
            ...
            // for function OrdinalPlusOne
            {
                this.AddChild(
                    ...
                    {
                        Attribute = new Variation("ThisOrdinal OrdinalPlusOne") { Pri = 0 },
                    }
                );
            }
            ...
            // for function OrdinalMinusOne
            {
                this.AddChild(
                    ...
                    {
                        Attribute = new Variation("ThisOrdinal OrdinalMinusOne"),
                    }
                );
            }
        }
