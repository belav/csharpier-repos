...
namespace System.Xml.Tests
{
    public partial class TCReadSubtree : TCXMLReaderBaseGeneral
    {
        ...
        public override void AddChildren()
        {
            ...
            {
                this.AddChild(
                    new CVariation(ReadSubtreeWorksOnlyOnElementNode)
                    {
                        Attribute = new Variation("ReadSubtree only works on Element Node"),
                    }
                );
            }
            ...
            // for function v2
            {
                this.AddChild(
                    new CVariation(v2)
                    {
                        Attribute = new Variation("ReadSubtree Test depth=1")
                        {
                            Params = new object[]
                            {
                                "elem1",
                ...
                this.AddChild(
                    new CVariation(v2)
                    {
                        Attribute = new Variation("ReadSubtree Test empty element before root")
                        {
                            Params = new object[]
                            {
                                "elem6",
                ...
                this.AddChild(
                    new CVariation(v2)
                    {
                        Attribute = new Variation("ReadSubtree Test PI after element")
                        {
                            Params = new object[]
                            {
                                "elempi",
                ...
                this.AddChild(
                    new CVariation(v2)
                    {
                        Attribute = new Variation("ReadSubtree Test on Root")
                        {
                ...
                this.AddChild(
                    new CVariation(v2)
                    {
                        Attribute = new Variation("ReadSubtree Test depth=3")
                        {
                            Params = new object[]
                            {
                                "x:elem3",
                ...
                this.AddChild(
                    new CVariation(v2)
                    {
                        Attribute = new Variation("ReadSubtree Test depth=4")
                        {
                            Params = new object[]
                            {
                                "elem4",
                ...
                this.AddChild(
                    new CVariation(v2)
                    {
                        Attribute = new Variation("ReadSubtree Test empty element")
                        {
                            Params = new object[]
                            {
                                "elem5",
                ...
                this.AddChild(
                    new CVariation(v2)
                    {
                        Attribute = new Variation("ReadSubtree Test depth=2")
                        {
                            Params = new object[]
                            {
                                "elem2",
                ...
                this.AddChild(
                    new CVariation(v2)
                    {
                        Attribute = new Variation("ReadSubtree Test Comment after element")
                        {
                            Params = new object[]
                            {
                                "elem",
            ...
            // for function v3
            {
                this.AddChild(
                    new CVariation(v3)
                    {
                        Attribute = new Variation("Read with entities") { Pri = 1 },
                    }
                );
            }
            ...
            // for function v4
            {
                this.AddChild(
                    new CVariation(v4)
                    {
                        Attribute = new Variation("Inner XML on Subtree reader") { Pri = 1 },
                    }
                );
            }
            ...
            // for function v5
            {
                this.AddChild(
                    new CVariation(v5)
                    {
                        Attribute = new Variation("Outer XML on Subtree reader") { Pri = 1 },
                    }
                );
            }
            ...
            // for function v8
            {
                this.AddChild(
                    new CVariation(v8)
                    {
                        Attribute = new Variation("Nested Subtree reader calls") { Pri = 2 },
                    }
                );
            }
            ...
            {
                this.AddChild(
                    new CVariation(SubtreeReaderCanDealWithMultipleNamespaces)
                    {
                        Attribute = new Variation("Multiple Namespaces on Subtree reader")
                        {
                            Pri = 1,
                        },
                    }
            ...
            {
                this.AddChild(
                    new CVariation(SubtreeReaderReadsProperlyNodeTypeOfAttributes)
                    {
                        Attribute = new Variation(
            ...
            {
                this.AddChild(
                    new CVariation(XmlSubtreeReaderDoesntDuplicateLocalNames)
                    {
                        Attribute = new Variation(
                            "XmlSubtreeReader add duplicate namespace declaration"
                        ),
                    }
                );
            }
            ...
            {
                this.AddChild(
                    new CVariation(XmlSubtreeReaderDoesntAddMultipleNamespaceDeclarations)
                    {
                        Attribute = new Variation(
                            "XmlSubtreeReader adds duplicate namespace declaration"
                        ),
                    }
                );
            }
            ...
            {
                this.AddChild(
                    new CVariation(XmlReaderDisposeDoesntDisposeMainReader)
                    {
                        Attribute = new Variation(
                            "XmlSubtreeReader.Dispose disposes the main reader"
                        ),
                    }
                );
            }
            ...
            {
                this.AddChild(
                    new CVariation(XmlReaderNameIsConsistentWhenReadingNamespaceNodeAttribute)
                    {
                        Attribute = new Variation(
            ...
            {
                this.AddChild(
                    new CVariation(IndexingMethodsWorksProperly)
                    {
                        Attribute = new Variation(
                            "Indexing methods cause infinite recursion & stack overflow"
                        ),
                    }
                );
            }
            ...
            {
                this.AddChild(
                    new CVariation(DisposingSubtreeReaderThatIsInErrorStateWorksProperly)
                    {
                        Attribute = new Variation(
            ...
            // for function v101
            {
                this.AddChild(
                    new CVariation(v101)
                    {
                        Attribute = new Variation("SubtreeReader has empty namespace"),
                    }
                );
            }
