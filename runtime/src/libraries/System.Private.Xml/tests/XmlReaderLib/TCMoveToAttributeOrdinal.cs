...
namespace System.Xml.Tests
{
    public partial class TCMoveToAttributeOrdinal : TCXMLReaderBaseGeneral
    {
        ...
        public override void AddChildren()
        {
            ...
            {
                this.AddChild(
                    new CVariation(MoveToAttributeWithGetAttrDoubleQ)
                    {
            ...
            {
                this.AddChild(
                    new CVariation(MoveToAttributeWithGetAttrSingleQ)
                    {
                        Attribute = new Variation(
            ...
            {
                this.AddChild(
                    new CVariation(MoveToAttributeWithMoveAttrDoubleQ)
                    {
                        Attribute = new Variation(
            ...
            {
                this.AddChild(
                    new CVariation(MoveToAttributeWithMoveAttrSingleQ)
                    {
                        Attribute = new Variation(
