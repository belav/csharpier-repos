...
namespace System.Xml.Tests
{
    public partial class TCXMLException : TCXMLReaderBaseGeneral
    {
        ...
        public override void AddChildren()
        {
            ...
            {
                this.AddChild(
                    new CVariation(v1) { Attribute = new Variation("XmlException(message)") }
                );
            }
            ...
            {
                this.AddChild(
                    new CVariation(InvalidEncodingCharacterThrowsExceptionWithCorrectLineNumberAndPosition) {
                        Attribute = new Variation(
            ...
            {
                this.AddChild(
                    new CVariation(UnexpectedTokenThrowsErrorWithCorrectPositions)
                    {
                        Attribute = new Variation(
