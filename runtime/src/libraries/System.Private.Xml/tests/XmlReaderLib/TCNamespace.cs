...
{
    partial public class TCNamespace : TCXMLReaderBaseGeneral
    {
        ...
        public override void AddChildren()
        {
            ...
            {
                this.AddChild(
                    new CVariation(TestNamespace7)
                    {
                        Attribute = new Variation("Namespace URI for xml prefix") { Pri = 0 }
                    }
                );
            }
        }
