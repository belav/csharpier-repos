...
namespace System.Xml.WrappedReaderTests
{
    public partial class WrappedReaderTest : CGenericTestModule
    {
        ...
        public static CTestModule Create()
        {
            ...
            module.AddChild(
                new TCGetAttributeOrdinalReader()
                {
                    Attribute = new TestCase()
                    {
            ...
            module.AddChild(
                new TCMoveToAttributeOrdinalReader()
                {
                    Attribute = new TestCase()
                    {
            ...
            module.AddChild(
                new TCMoveToNextAttributeReader()
                {
                    Attribute = new TestCase()
                    {
            ...
            module.AddChild(
                new TCAttributeXmlDeclarationReader()
                {
                    Attribute = new TestCase()
                    {
                        Name = "Attributes test on XmlDeclaration DCR52258",
                        Desc = "WrappedReader",
                    },
                }
            );
            module.AddChild(
                new TCXmlnsReader()
                {
                    Attribute = new TestCase()
                    {
                        Name = "xmlns as local name DCR50345",
                        Desc = "WrappedReader",
                    },
                }
            );
            module.AddChild(
                new TCXmlnsPrefixReader()
                {
                    Attribute = new TestCase()
                    {
                        Name = "bounded namespace to xmlns prefix DCR50881",
                        Desc = "WrappedReader",
                    },
                }
            );
            ...
            module.AddChild(
                new TCReadAttributeValueReader()
                {
                    Attribute = new TestCase()
                    {
            ...
            module.AddChild(
                new TCReadContentAsBase64Reader()
                {
                    Attribute = new TestCase()
                    {
            ...
            module.AddChild(
                new TCReadElementContentAsBase64Reader()
                {
                    Attribute = new TestCase()
                    {
            ...
            module.AddChild(
                new TCReadContentAsBinHexReader()
                {
                    Attribute = new TestCase()
                    {
            ...
            module.AddChild(
                new TCReadElementContentAsBinHexReader()
                {
                    Attribute = new TestCase()
                    {
