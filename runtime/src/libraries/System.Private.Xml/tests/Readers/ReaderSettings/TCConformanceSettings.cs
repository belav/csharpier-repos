...
namespace System.Xml.ReaderSettingsTests
{
    public partial class TCConformanceSettings : TCXMLReaderBaseGeneral
    {
        ...
        public override void AddChildren()
        {
            ...
            {
                this.AddChild(
                    new CVariation(wrappingTests)
                    {
                        Attribute = new Variation("Wrapping Tests: CR with CR")
                        {
                            Params = new object[]
                            {
                                "Fragment",
                ...
                this.AddChild(
                    new CVariation(wrappingTests)
                    {
                        Attribute = new Variation("Wrapping Tests: CR with CR")
                        {
                            Params = new object[] { "Document", "Auto", "<root/>", "true" },
                            Pri = 2,
                        },
                    }
                );
                this.AddChild(
                    new CVariation(wrappingTests)
                    {
                        Attribute = new Variation("Wrapping Tests: CR with CR")
                        {
                            Params = new object[] { "Auto", "Fragment", "<root/>", "false" },
                            Pri = 2,
                        },
                    }
                );
                this.AddChild(
                    new CVariation(wrappingTests)
                    {
                        Attribute = new Variation("Wrapping Tests: CR with CR")
                        {
                            Params = new object[] { "Fragment", "Fragment", "<root/>", "true" },
                            Pri = 2,
                        },
                    }
                );
                this.AddChild(
                    new CVariation(wrappingTests)
                    {
                        Attribute = new Variation("Wrapping Tests: CR with CR")
                        {
                            Params = new object[] { "Auto", "Auto", "<root/>", "true" },
                            Pri = 2,
                        },
                    }
                );
                this.AddChild(
                    new CVariation(wrappingTests)
                    {
                        Attribute = new Variation("Wrapping Tests: CR with CR")
                        {
                            Params = new object[] { "Document", "Fragment", "<root/>", "false" },
                            Pri = 2,
                        },
                    }
                );
                this.AddChild(
                    new CVariation(wrappingTests)
                    {
                        Attribute = new Variation("Wrapping Tests: CR with CR")
                        {
                            Params = new object[] { "Auto", "Document", "<root/>", "false" },
                            Pri = 2,
                        },
                    }
                );
                ...
                this.AddChild(
                    new CVariation(wrappingTests)
                    {
                        Attribute = new Variation("Wrapping Tests: CR with CR")
                        {
                            Params = new object[] { "Document", "Document", "<root/>", "true" },
                            Pri = 2,
                        },
                    }
                );
                this.AddChild(
                    new CVariation(wrappingTests)
                    {
                        Attribute = new Variation("Wrapping Tests: CR with CR")
                        {
                            Params = new object[] { "Auto", "Auto", "<root/><root/>", "true" },
                            Pri = 2,
                        },
                    }
                );
                this.AddChild(
                    new CVariation(wrappingTests)
                    {
                        Attribute = new Variation("Wrapping Tests: CR with CR")
                        {
                            Params = new object[] { "Fragment", "Auto", "<root/><root/>", "true" },
                            Pri = 2,
                        },
                    }
                );
            ...
            {
                this.AddChild(
                    new CVariation(InvalidValueRange)
                    {
                        Attribute = new Variation("Test Invalid Value Range for enum properties")
                        {
                            Pri = 1,
                        },
                    }
