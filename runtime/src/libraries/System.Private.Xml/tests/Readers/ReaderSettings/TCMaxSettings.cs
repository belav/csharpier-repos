        ...
        public override void AddChildren()
        {
            // for function v1
            {
                this.AddChild(
                    new CVariation(v1)
                    {
                        Attribute = new Variation("MaxSettings: get default values") { Pri = 0 },
                    }
                );
            }
            ...
            // for function v2
            {
                this.AddChild(
                    new CVariation(v2)
                    {
                        Attribute = new Variation("MaxSettings: set, get values") { Pri = 0 },
                    }
                );
            }
            ...
            // for function v20
            {
                this.AddChild(
                    new CVariation(v20)
                    {
                        Attribute = new Variation("MaxEnt = 1, MaxDoc = length - 1")
                        {
                            Params = new object[]
                            {
                                "<Root foo='&amp; &lt; &gt; &quot; &apos; &#65;'/>",
                ...
                this.AddChild(
                    new CVariation(v20)
                    {
                        Attribute = new Variation("MaxEnt = 1, MaxDoc = length - 1")
                        {
                            Params = new object[]
                            {
                                "<!DOCTYPE doc [  <!ELEMENT doc ANY>  <!ENTITY book 'a&a'>]><doc>&book;</doc>",
                            },
                            Pri = 2,
                        },
                    }
                ...
                this.AddChild(
                    new CVariation(v20)
                    {
                        Attribute = new Variation("MaxEnt = 1, MaxDoc = length - 1")
                        {
                            Params = new object[]
                            {
                                "<?xml version='1.0'?><!DOCTYPE test [ <!ELEMENT test ANY> <!ELEMENT a ANY> <!ELEMENT b ANY> <!ELEMENT c ANY> <!ENTITY a '<a>&a;</a>'>]><test>&a;</test>",
                            },
                            Pri = 2,
                        },
                    }
                ...
                this.AddChild(
                    new CVariation(v20)
                    {
                        Attribute = new Variation("MaxEnt = 1, MaxDoc = length - 1")
                        {
                            Params = new object[]
                            {
                                "<!DOCTYPE root [<!ELEMENT root ANY><!ENTITY e '\ud812\udd12'>]><root>&e;</root>",
                            },
                            Pri = 2,
                        },
                    }
                ...
                this.AddChild(
                    new CVariation(v20)
                    {
                        Attribute = new Variation("MaxEnt = 1, MaxDoc = length - 1")
                        {
                            Params = new object[] { "<root>va&lt;/root&gt;lue</root>" },
                            Pri = 2,
                        },
                    }
                );
            ...
            // for function v30
            {
                this.AddChild(
                    new CVariation(v30)
                    {
                        Attribute = new Variation("MaxEnt not set, MaxDoc = length")
                        {
                            Params = new object[] { "<Root a='b&quot;c' />" },
                            Pri = 0,
                        },
            ...
            // for function v40
            {
                this.AddChild(
                    new CVariation(v40)
                    {
                        Attribute = new Variation("MaxEnt = 1, MaxDoc = length")
                        {
                            Params = new object[] { "<Root a='b&quot;c' />" },
                            Pri = 0,
                        },
            ...
            // for function v50
            {
                this.AddChild(
                    new CVariation(v50)
                    {
                        Attribute = new Variation("MaxEnt = 0, MaxDoc = 0")
                        {
                            Params = new object[] { "<Root><!--\ud812\udd12--></Root>" },
                            Pri = 0,
                        },
            ...
            // for function v60
            {
                this.AddChild(
                    new CVariation(v60)
                    {
                        Attribute = new Variation("MaxEnt not set, MaxDoc not set")
                        {
                            Params = new object[] { "<root>va&lt;/root&gt;lue</root>" },
                            Pri = 0,
                        },
            ...
            // for function v260
            {
                this.AddChild(
                    new CVariation(v260)
                    {
                        Attribute = new Variation("nwf xml: MaxEnt = bigVal, MaxDoc = bigVal")
                        {
                            Params = new object[] { "" },
                            Pri = 2,
                        },
                ...
                this.AddChild(
                    new CVariation(v260)
                    {
                        Attribute = new Variation("nwf xml: MaxEnt = bigVal, MaxDoc = bigVal")
                        {
                            Params = new object[]
                            {
                                "<?xml version='1.0'?><!DOCTYPE test [ <!ELEMENT test ANY> <!ELEMENT a ANY> <!ELEMENT b ANY> <!ELEMENT c ANY> <!ENTITY a '<a>&amp;</a>'>]><test>&a;<test>",
                            },
                            Pri = 2,
                        },
                    }
            ...
            // for function v270
            {
                this.AddChild(
                    new CVariation(v270)
                    {
                        Attribute = new Variation("nwf xml: MaxEnt = 1, MaxDoc = val")
                        {
                            Params = new object[]
                            {
                                "<!DOCTYPE ROOT [<!ENTITY a '&a;'>]><ROOT att='&a;'/>",
