...
{
    partial public class TCDtdProcessingCoreReader : TCXMLReaderBaseGeneral
    {
        ...
        public override void AddChildren()
        {
            ...
            {
                this.AddChild(
                    new CVariation(V3) { Attribute = new Variation("Testing default values.") }
                );
            }
            ...
            // for function V4
            {
                this.AddChild(
                    new CVariation(V4)
                    {
                        Attribute = new Variation("Parse a file with inline DTD.Ignore")
                        {
                            Param = 1
                        }
                    }
                ...
                this.AddChild(
                    new CVariation(V4)
                    {
                        Attribute = new Variation("Parse a file with inline DTD.Prohibit")
                        {
                            Param = 0
                        }
                    }
            ...
            // for function V4c
            {
                this.AddChild(
                    new CVariation(V4c)
                    {
                        Attribute = new Variation("Parse a xml with inline inv.DTD.Ignore")
                        {
                            Param = 1
                        }
                    }
                ...
                this.AddChild(
                    new CVariation(V4c)
                    {
                        Attribute = new Variation("Parse a xml with inline inv.DTD.Prohibit")
                        {
                            Param = 0
                        }
                    }
            ...
            // for function V16
            {
                this.AddChild(
                    ...
                    {
                        Attribute = new Variation(
                            "Parse a valid xml DTD and check NodeType.Prohibit"
                        )
                        {
                            Param = 0
                        }
                ...
                this.AddChild(
                    new CVariation(V16)
                    {
                        Attribute = new Variation("Parse a valid xml DTD and check NodeType.Ignore")
                        {
                            Param = 1
                        }
                    }
