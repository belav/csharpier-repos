    ...
    public class NamedArgumentTests
    {
        ...
        public void TestGenericInference()
        {
            Helpers.OverrideConsoleAndRun(console =>
            {
                ...
                CallSite<Action<CallSite, Type, int, string>> compileTimeTypeCallSite = CallSite<
        ...
        public void TestPositionalUnaffected2()
        {
            ...
            string message = Assert
                .Throws<RuntimeBinderException>(() => callSite.Target(callSite, typeof(C8), 1, 2))
                .Message;
        ...
        public void TestNamedParams()
        {
            ...
            string message = Assert
                .Throws<RuntimeBinderException>(() => callSite.Target(callSite, typeof(C9), 1, 2))
                .Message;
        ...
        public void TestNamedParams3()
        {
            ...
            string message = Assert
                .Throws<RuntimeBinderException>(() => callSite.Target(callSite, typeof(C11), 1, 2))
                .Message;
        ...
        public void TestBadNonTrailing()
        {
            ...
            string message = Assert
                .Throws<RuntimeBinderException>(() => callSite.Target(callSite, typeof(C13), 3, 2))
                .Message;
            //Named argument 'c' is used out-of-position but is followed by an unnamed argument
            Assert.Contains(" 'c' ", message);
        }
