...
namespace Microsoft.CSharp.RuntimeBinder.Tests
{
    ...
    {
        private static readonly IEnumerable<CSharpArgumentInfoFlags> AllPossibleFlags = Enumerable
            .Range(0, ((int[])Enum.GetValues(typeof(CSharpArgumentInfoFlags))).Max() * 2)
