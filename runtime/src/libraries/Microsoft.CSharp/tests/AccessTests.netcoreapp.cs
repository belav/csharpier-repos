...
namespace Microsoft.CSharp.RuntimeBinder.Tests
{
    public partial class AccessTests
    {
        ...
        public AccessTests()
        {
            ...
            _internalDerived = module.DefineType("InternalDerived", TypeAttributes.Public, baseType)
                .CreateType();
            ...
            _externalDerived = module.DefineType("ExternalDerived", TypeAttributes.Public, baseType)
                .CreateType();
        }
        ...
        public void ProtectedPrivateMethodFromOutside()
        {
            dynamic d = Activator.CreateInstance(_baseType);
            string message =
                Assert.Throws<RuntimeBinderException>(() => d.ProtectedPrivateMethod(19)).Message;
        ...
        public void ProtectedPrivateFieldFromDerivedDifferentAssembly()
        {
            ...
            var getCallSite = CallSite<Func<CallSite, object, object>>
                .Create(
                    Binder.GetMember(
                        CSharpBinderFlags.None,
                        "AField",
