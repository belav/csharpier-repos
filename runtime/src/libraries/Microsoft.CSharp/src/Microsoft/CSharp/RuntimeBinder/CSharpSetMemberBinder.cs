...
{
    /// <summary>
    /// Represents a dynamic property access in C#, providing the binding semantics and the details
    // about the operation.
    ...
    internal sealed class CSharpSetMemberBinder : SetMemberBinder, ICSharpBinder
    {
        ...
        /// <param name="isCompoundAssignment">True if the assignment comes from a compound assignment in
        // source.</param>
        /// <param name="isChecked">True if the operation is defined in a checked context; otherwise,
        // false.</param>
        /// <param name="callingContext">The <see cref="Type"/> that indicates where this operation is
        // defined.</param>
