...
namespace Microsoft.CSharp.RuntimeBinder.Semantics
{
    ...
    {
        private static readonly AggregateSymbol[] s_predefSymbols = new AggregateSymbol[
            (int)PredefinedType.PT_COUNT
        ];
        ...
        private static AggregateSymbol DelayLoadPredefSym(PredefinedType pt)
        {
            AggregateType type = (AggregateType)
                SymbolTable.GetCTypeFromType(PredefinedTypeFacts.GetAssociatedSystemType(pt));
        ...
        )
        {
            ...
            sym.SetSkipUDOps(
                pt <= PredefinedType.PT_ENUM
                    && pt != PredefinedType.PT_INTPTR
                    && pt != PredefinedType.PT_UINTPTR
    ...
    internal static class PredefinedTypeFacts
    {
        ...
        internal static Type GetAssociatedSystemType(PredefinedType type) =>
            s_types[(int)type].AssociatedSystemType;

        internal static bool IsSimpleType(PredefinedType type) =>
            type < PredefinedType.FirstNonSimpleType;
        ...
        private static readonly PredefinedTypeInfo[] s_types =
        {
            ...
            new PredefinedTypeInfo(
                PredefinedType.PT_G_IQUERYABLE,
