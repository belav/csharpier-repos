...
namespace System.Reflection.Emit.Tests
{
    public class CustomAttributeBuilderTests
    {
        public static IEnumerable<object[]> Ctor_TestData()
        {
            ...
            {
                typeof(TestAttribute).GetConstructor(new Type[] { typeof(string), typeof(int) }),
                new object[] { stringValue1, intValue1 },
                new string[0],
                new object[0],
                new object[] { intValue2, null, stringValue1, intValue1 },
                new string[] { nameof(TestAttribute.TestInt) },
            ...
            yield return new object[]
            {
                typeof(TestAttribute).GetConstructor(new Type[0]),
                new object[0],
                new string[0],
                new object[0],
            ...
            yield return new object[]
            {
                ...
                new string[]
                {
                    nameof(TestAttribute.TestInt),
                    nameof(TestAttribute.TestStringField)
                },
            ...
            yield return new object[]
            {
                ...
                new string[] { nameof(TestAttribute.TestStringField) },
            ...
            yield return new object[]
            {
                typeof(TestAttribute).GetConstructor(new Type[] { typeof(string), typeof(int) }),
                new object[] { stringValue1, intValue1 },
                new string[] { nameof(TestAttribute.TestInt32) },
                new object[] { intValue2 },
                new object[] { intValue2, null, stringValue1, intValue1 },
                new object[0],
                new object[0],
            ...
            yield return new object[]
            {
                typeof(TestAttribute).GetConstructor(new Type[] { typeof(string), typeof(int) }),
                new object[] { stringValue1, intValue1 },
                new string[] { nameof(TestAttribute.TestString) },
            ...
            {
                typeof(TestAttribute).GetConstructor(new Type[] { typeof(string), typeof(int) }),
                new object[] { shortString, intValue1 },
                new string[] { nameof(TestAttribute.TestString) },
                new object[] { longString },
            ...
            yield return new object[]
            {
                typeof(SubAttribute).GetConstructor(new Type[0]),
                new object[0],
                new string[] { nameof(TestAttribute.TestString) },
                new object[] { stringValue1 },
                new object[] { intValue1, stringValue1, null, 0 },
        ...
        )
        {
            ...
            {
                VerifyCustomAttributeBuilder(
                    attr,
                    TestAttribute.AllProperties,
                    expectedPropertyValues,
                    TestAttribute.AllFields,
                    expectedFieldValues
                );
            }
            ...
            if (namedProperties.Length == 0)
            {
                if (namedFields.Length == 0)
                {
                    ...
                    CustomAttributeBuilder attribute1 = new CustomAttributeBuilder(
                        con,
                        constructorArgs
                    );
                    Verify(attribute1);
                ...
                CustomAttributeBuilder attribute2 = new CustomAttributeBuilder(
                    con,
                    constructorArgs,
                    namedFields,
                    fieldValues
            ...
            if (namedFields.Length == 0)
            {
                ...
                CustomAttributeBuilder attribute3 = new CustomAttributeBuilder(
                    con,
                    constructorArgs,
                    namedProperties,
                    propertyValues
            ...
            CustomAttributeBuilder attribute4 = new CustomAttributeBuilder(
                con,
                constructorArgs,
                namedProperties,
                propertyValues,
        ...
        private static void VerifyCustomAttributeBuilder(
            CustomAttributeBuilder builder,
            PropertyInfo[] propertyNames,
            object[] propertyValues,
        ...
        public static void Ctor_AllPrimitives()
        {
            ...
            PropertyInfo[] namedProperties = Helpers.GetProperties(
                ...
                new string[]
                {
                    nameof(Primitives.SByteProperty),
                    nameof(Primitives.ByteProperty),
                    nameof(Primitives.ShortProperty),
                    nameof(Primitives.UShortProperty),
                    nameof(Primitives.IntProperty),
                    nameof(Primitives.UIntProperty),
                    nameof(Primitives.LongProperty),
                    nameof(Primitives.ULongProperty),
                    nameof(Primitives.SByteEnumProperty),
                    nameof(Primitives.ByteEnumProperty),
                    nameof(Primitives.ShortEnumProperty),
                    nameof(Primitives.UShortEnumProperty),
                    nameof(Primitives.IntEnumProperty),
                    nameof(Primitives.UIntEnumProperty),
                    nameof(Primitives.LongEnumProperty),
                    nameof(Primitives.ULongEnumProperty),
                    nameof(Primitives.CharProperty),
                    nameof(Primitives.BoolProperty),
                    nameof(Primitives.FloatProperty),
                    nameof(Primitives.DoubleProperty),
                    nameof(Primitives.StringProperty),
                    nameof(Primitives.TypeProperty),
                    nameof(Primitives.ArrayProperty),
                    nameof(Primitives.ObjectProperty)
                }
            );
            ...
            FieldInfo[] namedFields = Helpers.GetFields(
                typeof(Primitives),
                new string[]
                {
                    nameof(Primitives.SByteField),
                    nameof(Primitives.ByteField),
                    nameof(Primitives.ShortField),
                    nameof(Primitives.UShortField),
                    nameof(Primitives.IntField),
                    nameof(Primitives.UIntField),
                    nameof(Primitives.LongField),
                    nameof(Primitives.ULongField),
                    nameof(Primitives.SByteEnumField),
                    nameof(Primitives.ByteEnumField),
                    nameof(Primitives.ShortEnumField),
                    nameof(Primitives.UShortEnumField),
                    nameof(Primitives.IntEnumField),
                    nameof(Primitives.UIntEnumField),
                    nameof(Primitives.LongEnumField),
                    nameof(Primitives.ULongEnumField),
                    nameof(Primitives.CharField),
                    nameof(Primitives.BoolField),
                    nameof(Primitives.FloatField),
                    nameof(Primitives.DoubleField),
                    nameof(Primitives.StringField),
                    nameof(Primitives.TypeField),
                    nameof(Primitives.ArrayField),
                    nameof(Primitives.ObjectField)
                }
            );
        ...
        public static IEnumerable<object[]> Ctor_RefEmitParameters_TestData()
        {
            ...
            TypeBuilder typeBuilder = assemblyBuilder.DefineDynamicModule("DynamicModule")
                .DefineType("DynamicType", TypeAttributes.Public, typeof(Attribute));
            ...
            FieldBuilder fieldBuilderProperty = typeBuilder.DefineField(
                "PropertyField",
                typeof(int),
                FieldAttributes.Public
            );
            ...
            yield return new object[]
            {
                constructorBuilder,
                new object[0],
                new PropertyInfo[] { createdType.GetProperty(propertyBuilder.Name) },
                new object[] { 1 },
                new FieldInfo[] { createdType.GetField(fieldBuilder.Name) },
                new object[] { 2 }
            };
            ...
            yield return new object[]
            {
                createdType.GetConstructor(new Type[0]),
                new object[0],
                new PropertyInfo[] { propertyBuilder },
                new object[] { 1 },
                new FieldInfo[] { fieldBuilder },
                new object[] { 2 }
            };
        ...
        public static void Ctor_RefEmitParameters(
            ConstructorInfo con,
            object[] constructorArgs,
        ...
        )
        {
            ...
            Assert.Equal(
                propertyValues[0],
                createdAttribute.GetType().GetField("PropertyField").GetValue(createdAttribute)
            );
            Assert.Equal(
                fieldValues[0],
                createdAttribute.GetType().GetField("Field").GetValue(createdAttribute)
            );
        }
        ...
        public void NamedFields_ContainsReadonlyOrStaticField_Works(string name)
        {
            ...
            Assert.Equal(
                fieldValues[0],
                namedFields[0].GetValue(namedFields[0].IsStatic ? null : customAttribute)
            );
        }
        ...
        {
            ConstructorInfo con = typeof(TestAttribute).GetConstructor(new Type[0]);
            PropertyInfo[] namedProperties = new PropertyInfo[]
            {
                typeof(TestAttribute).GetProperty(nameof(TestAttribute.StaticProperty))
            };
        ...
        public static IEnumerable<object[]> NotSupportedObject_Constructor_TestData()
        {
            ...
            yield return new object[]
            {
                Enum.GetValues(CreateEnum(typeof(bool), true)).GetValue(0)
            };
        }
        ...
        public static IEnumerable<object[]> FloatEnum_DoubleEnum_TestData()
        {
            yield return new object[]
            {
                Enum.GetValues(CreateEnum(typeof(float), 0.0f)).GetValue(0)
            };
            yield return new object[]
            {
                Enum.GetValues(CreateEnum(typeof(double), 0.0)).GetValue(0)
            };
        }
        ...
        [SkipOnTargetFramework(
            ...
            "Netfx doesn't support Enum.GetEnumName for float or double enums."
        )]
        ...
        [SkipOnTargetFramework(
            TargetFrameworkMonikers.NetFramework,
            "Coreclr fixed an issue where IntPtr/UIntPtr in constructorParameters causes a corrupt created binary."
        )]
        ...
        [SkipOnTargetFramework(
            TargetFrameworkMonikers.NetFramework,
            "Used to throw a NullReferenceException, see https://github.com/dotnet/runtime/issues/18552."
        )]
        ...
        [SkipOnTargetFramework(
            TargetFrameworkMonikers.NetFramework,
            "Coreclr fixed an issue where IntPtr/UIntPtr in constructorArgs causes a corrupt created binary."
        )]
        ...
        public static IEnumerable<object[]> FieldDoesntBelongToConstructorDeclaringType_TestData()
        {
            ...
            {
                typeof(TestAttribute).GetConstructor(new Type[0]),
                typeof(OtherTestAttribute).GetField(nameof(OtherTestAttribute.Field))
            };
            ...
            {
                typeof(TestAttribute).GetConstructor(new Type[0]),
                typeof(SubAttribute).GetField(nameof(SubAttribute.SubField))
            };
        }
        ...
        public void NamedFields_ContainsConstField_ThrowsArgumentException()
        {
            ...
            {
                typeof(TestAttribute).GetField(nameof(TestAttribute.ConstField))
            };
            object[] propertyValues = new object[] { 5 };
            CustomAttributeBuilder attribute = new CustomAttributeBuilder(
                con,
        ...
        public static void NotSupportedObjectInFieldValues_ThrowsArgumentException(object value)
        {
            ...
            FieldInfo[] namedFields = Helpers.GetFields(
                typeof(TestAttribute),
                nameof(TestAttribute.ObjectField)
            );
            object[] fieldValues = new object[] { value };
        ...
        [SkipOnTargetFramework(
            TargetFrameworkMonikers.NetFramework,
            "Coreclr fixed an issue where IntPtr/UIntPtr in fieldValues causes a corrupt created binary."
        )]
        ...
        [InlineData(
            new string[] { nameof(TestAttribute.TestInt), nameof(TestAttribute.TestStringField) },
            new object[] { "TestString", 10 },
            null
        )]
        [InlineData(
        ...
        public void NamedFieldAndFieldValuesDifferentLengths_ThrowsArgumentException(
            string[] fieldNames,
            object[] fieldValues,
            string paramName
        )
        ...
        public static void IndexerInNamedProperties_ThrowsCustomAttributeFormatExceptionOnCreation()
        {
            ...
            PropertyInfo[] namedProperties = new PropertyInfo[]
            {
                typeof(IndexerAttribute).GetProperty("Item")
            };
            CustomAttributeBuilder attribute = new CustomAttributeBuilder(
                con,
                new object[0],
        ...
        public static IEnumerable<object[]> PropertyDoesntBelongToConstructorDeclaringType_TestData()
        {
            ...
            {
                typeof(TestAttribute).GetConstructor(new Type[0]),
                typeof(OtherTestAttribute).GetProperty(nameof(OtherTestAttribute.Property))
            };
            ...
            {
                typeof(TestAttribute).GetConstructor(new Type[0]),
                typeof(SubAttribute).GetProperty(nameof(SubAttribute.SubProperty))
            };
        }
        ...
        public static void NullObjectInPropertyValues_ThrowsArgumentNullException()
        {
            ...
            PropertyInfo[] namedProperties = Helpers.GetProperties(
                typeof(TestAttribute),
                nameof(TestAttribute.TestInt32)
            );
        ...
        [SkipOnTargetFramework(
            TargetFrameworkMonikers.NetFramework,
            "Coreclr fixed an issue where IntPtr/UIntPtr in propertValues causes a corrupt created binary."
        )]
        ...
        [InlineData(
            new string[] { nameof(TestAttribute.GetOnlyInt32) },
            new object[] { "TestString" },
            null
        )]
        [InlineData(
            new string[] { nameof(TestAttribute.GetOnlyString) },
            new object[] { "TestString" },
            null
        )]
        [InlineData(
        ...
        public void NamedPropertyAndPropertyValuesDifferentLengths_ThrowsArgumentException(
            string[] propertyNames,
            object[] propertyValues,
            string paramName
        )
