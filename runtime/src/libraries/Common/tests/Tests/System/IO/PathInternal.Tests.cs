...
namespace Tests.System.IO
{
    public class PathInternal_Windows_Tests
    {
        ...
        public void EqualStartingCharacterCount(
            string first,
            string second,
            bool ignoreCase,
            int expected
        ...
        public static TheoryData<string, int, string> RemoveRelativeSegmentsData =>
        ...
        public static TheoryData<string, int, string> RemoveRelativeSegmentsFirstRelativeSegment =>
            new TheoryData<string, int, string>
            {
                { @"C:\\git\runtime", 2, @"C:\git\runtime" },
                { @"C:\.\git\runtime", 2, @"C:\git\runtime" },
        ...
        public static TheoryData<string, int, string> RemoveRelativeSegmentsSkipAboveRoot =>
            new TheoryData<string, int, string>
            {
                { @"C:\temp\..\", 7, @"C:\temp\" },
        ...
        public static TheoryData<
            ...
            int,
            string
        > RemoveRelativeSegmentsFirstRelativeSegmentRoot =>
            new TheoryData<string, int, string>
            {
        ...
        public void RemoveRelativeSegmentsTest(string path, int skip, string expected)
        {
            ...
            Assert.Equal(
                @"\\.\" + expected,
                PathInternal.RemoveRelativeSegments(@"\\.\" + path, skip + 4)
            );
            Assert.Equal(
                @"\\?\" + expected,
                PathInternal.RemoveRelativeSegments(@"\\?\" + path, skip + 4)
        ...
        public static TheoryData<string, int, string> RemoveRelativeSegmentsUncData =>
            new TheoryData<string, int, string>
            {
        ...
        [Theory, MemberData(nameof(RemoveRelativeSegmentsUncData))]
        [PlatformSpecific(TestPlatforms.Windows)]
        public void RemoveRelativeSegmentsUncTest(string path, int skip, string expected)
        {
            Assert.Equal(
                @"\\" + expected,
                PathInternal.RemoveRelativeSegments(@"\\" + path, skip + 2)
            );
            Assert.Equal(
                @"\\.\UNC\" + expected,
                PathInternal.RemoveRelativeSegments(@"\\.\UNC\" + path, skip + 8)
            );
            Assert.Equal(
                @"\\?\UNC\" + expected,
                PathInternal.RemoveRelativeSegments(@"\\?\UNC\" + path, skip + 8)
        ...
        public static TheoryData<string, int, string> RemoveRelativeSegmentsDeviceData =>
            new TheoryData<string, int, string>
            {
        ...
        public static TheoryData<string, int, string> RemoveRelativeSegmentsDeviceRootData =>
            new TheoryData<string, int, string>
            {
        ...
        public static TheoryData<string, int, string> RemoveRelativeSegmentUnixData =>
            new TheoryData<string, int, string>
            {
                { "/tmp/home", 1, "/tmp/home" },
                { "/tmp/..", 1, "/" },
        ...
        [Theory, MemberData(nameof(RemoveRelativeSegmentUnixData))]
