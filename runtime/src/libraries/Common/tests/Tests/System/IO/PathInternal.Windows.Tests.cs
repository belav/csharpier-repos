...
namespace Tests.System.IO
{
    ...
    public class PathInternalTests_Windows
    {
        ...
        public static TheoryData<string, int, int> GetRootLength_Data =>
        ...
        public static TheoryData<string, int> GetRootLengthRooted =>
        ...
        [Theory, MemberData(nameof(GetRootLength_Data))]
        ...
        [Theory, MemberData(nameof(GetRootLengthRooted))]
        public void GetRootLength_Rooted(string path, int length)
        {
            Assert.Equal(length, PathInternal.GetRootLength(path));
        }

        public static TheoryData<string, int> GetRootLength_UNCData =>
            new TheoryData<string, int>
            {
        ...
        [Theory, MemberData(nameof(GetRootLength_UNCData))]
        public void GetRootLengthUnc(string path, int length)
        {
            Assert.Equal(length + 2, PathInternal.GetRootLength(@"\\" + path));
            Assert.Equal(
                length + PathInternal.UncExtendedPrefixLength,
                PathInternal.GetRootLength(@"\\?\UNC\" + path)
            );
            Assert.Equal(
                length + PathInternal.UncExtendedPrefixLength,
                PathInternal.GetRootLength(@"\\.\UNC\" + path)
        ...
        public static TheoryData<string, int> GetRootLength_DeviceData =>
            new TheoryData<string, int>
            {
                { @"..\", 3 },
                { @"..\..\", 3 },
        ...
        [Theory, MemberData(nameof(GetRootLength_DeviceData))]
        public void GetRootLengthDevice(string path, int length)
        {
            Assert.Equal(
                length + PathInternal.ExtendedPathPrefix.Length,
