...
namespace System.Tests
{
    ...
    public partial class StringTests
    {
        ...
        [InlineData(
            new char[] { 'a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', '\0', 'i', 'j' },
            "abcdefgh"
        )]
        ...
        public static unsafe void Ctor_CharPtr_Int_Int(
            char[] valueArray,
            int startIndex,
            int length,
            string expected
        ...
        public static unsafe void Ctor_CharPtr_Int_Int_Invalid()
        {
            ...
            AssertExtensions.Throws<ArgumentOutOfRangeException>("length", () =>
            {
                fixed (char* value = valueArray)
                {
                    new string(value, 0, -1);
                } // Length < 0
            });

            AssertExtensions.Throws<ArgumentOutOfRangeException>("ptr", () =>
                new string((char*)null, 0, 1)
            ); // null ptr with non-zero length
            AssertExtensions.Throws<ArgumentOutOfRangeException>("startIndex", () =>
                new string(UIntPtr.Size == 4 ? (char*)uint.MaxValue : (char*)ulong.MaxValue, 42, 0)
            ); // overflowing ptr + startIndex
        }
        ...
        public static void Ctor_CharArray_Invalid()
        {
            ...
            AssertExtensions.Throws<ArgumentOutOfRangeException>("startIndex", () =>
                new string(value, 0, 9)
            ); // Length > array length
            AssertExtensions.Throws<ArgumentOutOfRangeException>("length", () =>
                new string(value, 5, -1)
            ); // Length < 0
            AssertExtensions.Throws<ArgumentOutOfRangeException>("startIndex", () =>
                new string(value, -1, 1)
            ); // Start Index < 0
            AssertExtensions.Throws<ArgumentOutOfRangeException>("startIndex", () =>
                new string(value, 6, 5)
            ); // Walks off array
        }
        ...
        public static IEnumerable<object[]> Concat_Strings_LessThan2_GreaterThan4_TestData()
        {
            ...
            {
                new string[] { "abcd", "efgh", "ijkl", "mnop", "qrst", "uvwx", "yz" },
        ...
        public static void Concat_Invalid()
        {
            AssertExtensions.Throws<ArgumentNullException>("values", () =>
                string.Concat((IEnumerable<string>)null)
            ); // Values is null
            AssertExtensions.Throws<ArgumentNullException>("values", () =>
                string.Concat<string>((IEnumerable<string>)null)
            ); // Generic overload
        ...
        public static void CopyTo_Invalid()
        {
            ...
            AssertExtensions.Throws<ArgumentOutOfRangeException>("destinationIndex", () =>
                s.CopyTo(0, dst, dst.Length, 1)
            ); // Destination index > dst.Length
            ...
            AssertExtensions.Throws<ArgumentOutOfRangeException>("sourceIndex", () =>
                s.CopyTo(s.Length, dst, 0, 1)
            );
            AssertExtensions.Throws<ArgumentOutOfRangeException>("sourceIndex", () =>
                s.CopyTo(s.Length - 1, dst, 0, 2)
            );
            AssertExtensions.Throws<ArgumentOutOfRangeException>("sourceIndex", () =>
                s.CopyTo(0, dst, 0, 6)
            );
        ...
        public static IEnumerable<object[]> Compare_TestData()
        {
            ...
            yield return new object[]
            {
                ...
                StringComparison.Ordinal,
                -1,
            }; // Recalculated length, second string longer
            yield return new object[]
            {
                "Hello123",
                0,
                ...
                StringComparison.Ordinal,
                1,
            }; // Recalculated length, first string longer
            yield return new object[]
            {
                "---aaaaaaaaaaa",
                3,
            ...
            yield return new object[]
            {
                ...
                StringComparison.Ordinal,
                -1,
            }; // 64-bit: first long compare is different
            yield return new object[]
            {
                "abcdefgxxxxxxxxxxxxxxxxxx",
                0,
                "abcdefhxxxxxxxxxxx",
                0,
                int.MaxValue,
                StringComparison.Ordinal,
                -1,
            }; // 64-bit: second long compare is different
            yield return new object[]
            {
                "abcdefghijkxxxxxxxxxxxxxx",
                0,
                "abcdefghijlxxxxxxx",
                0,
                int.MaxValue,
                StringComparison.Ordinal,
                -1,
            }; // 64-bit: third long compare is different
            yield return new object[]
            {
                "abcdexxxxxxxxxxxxxxxxxxxx",
                0,
                "abcdfxxxxxxxxxxxxx",
                0,
                int.MaxValue,
                StringComparison.Ordinal,
                -1,
            }; // 32-bit: second int compare is different
            yield return new object[]
            {
                ...
                StringComparison.Ordinal,
                -1,
            }; // 32-bit: fourth int compare is different
        ...
        )
        {
            ...
            bool indicesReferToEntireString = (
                ...
                && indexA == 0
                && indexB == 0
                && (length == strB.Length || length == strA.Length)
            );
            bool skipNonComparisonOverloads =
                length != 0 && ((strA == null && indexA != 0) || (strB == null && indexB != 0));
            if (hasNullInputs || indicesReferToEntireString)
            {
                if (comparisonType == StringComparison.CurrentCulture)
                {
                    ...
                    Assert.Equal(
                        expected,
                        Math.Sign(string.Compare(strA, strB, ignoreCase: false))
                    );
                    if (strA != null)
                    {
            ...
            if (comparisonType == StringComparison.CurrentCulture)
            {
                ...
                if (!skipNonComparisonOverloads)
                {
                    ...
                    Assert.Equal(
                        expected,
                        Math.Sign(string.Compare(strA, indexA, strB, indexB, length))
                    );
                    Assert.Equal(
                        expected,
                        Math.Sign(
                            string.Compare(strA, indexA, strB, indexB, length, ignoreCase: false)
                        )
                    );
                }
            }
            else if (comparisonType == StringComparison.CurrentCultureIgnoreCase)
            {
                ...
                if (!skipNonComparisonOverloads)
                {
                    ...
                    Assert.Equal(
                        expected,
                        Math.Sign(
                            string.Compare(strA, indexA, strB, indexB, length, ignoreCase: true)
                        )
                    );
                }
            }
            else if (comparisonType == StringComparison.Ordinal)
            {
                ...
                Assert.Equal(
                    expected,
                    Math.Sign(string.CompareOrdinal(strA, indexA, strB, indexB, length))
                );
            }
            // Use Compare(string, int, string, int, int, StringComparison)
            Assert.Equal(
                expected,
                Math.Sign(string.Compare(strA, indexA, strB, indexB, length, comparisonType))
            );
            ...
            if (indexA >= 0 && indexB >= 0 && length >= 0)
            {
                ...
                ReadOnlySpan<char> span =
                    length <= (strA.AsSpan().Length - indexA)
                        ? strA.AsSpan(indexA, length)
                        : strA.AsSpan(indexA);
                ReadOnlySpan<char> value =
                    length <= (strB.AsSpan().Length - indexB)
                        ? strB.AsSpan(indexB, length)
                        : strB.AsSpan(indexB);
        ...
        public static void ZeroLengthCompareTo_StringComparison()
        {
            ...
            Assert.Equal(
                0,
                string.Compare(emptyValue, s, StringComparison.CurrentCultureIgnoreCase)
            );
            Assert.Equal(0, string.Compare(emptyValue, s, StringComparison.InvariantCulture));
            Assert.Equal(
                0,
                string.Compare(emptyValue, s, StringComparison.InvariantCultureIgnoreCase)
            );
            ...
            Assert.True(
                0 < span.CompareTo(emptySlice, StringComparison.InvariantCultureIgnoreCase)
            );
            ...
            Assert.Equal(
                0,
                span.CompareTo(emptySlice, StringComparison.InvariantCultureIgnoreCase)
            );
        ...
        public static void SameValueCompareTo_StringComparison()
        {
            ...
            Assert.Equal(
                0,
                string.Compare(value, value, StringComparison.CurrentCultureIgnoreCase)
            );
            Assert.Equal(0, string.Compare(value, value, StringComparison.InvariantCulture));
            Assert.Equal(
                0,
                string.Compare(value, value, StringComparison.InvariantCultureIgnoreCase)
            );
        ...
        public static void MakeSureNoCompareToChecksGoOutOfRange_StringComparison()
        {
            for (int length = 0; length < 100; length++)
            {
                ...
                Assert.Equal(
                    0,
                    span1.CompareTo(span2, StringComparison.InvariantCultureIgnoreCase)
                );
        ...
        public static void Compare_Invalid()
        {
            ...
            AssertExtensions.Throws<ArgumentException>("comparisonType", () =>
                string.Compare("a", "bb", StringComparison.CurrentCulture - 1)
            );
            AssertExtensions.Throws<ArgumentException>("comparisonType", () =>
                string.Compare("a", "bb", StringComparison.OrdinalIgnoreCase + 1)
            );
            AssertExtensions.Throws<ArgumentException>("comparisonType", () =>
                string.Compare("a", 0, "bb", 0, 1, StringComparison.CurrentCulture - 1)
            );
            AssertExtensions.Throws<ArgumentException>("comparisonType", () =>
                string.Compare("a", 0, "bb", 0, 1, StringComparison.OrdinalIgnoreCase + 1)
            );

            // IndexA < 0
            AssertExtensions.Throws<ArgumentOutOfRangeException>("offset1", () =>
                string.Compare("a", -1, "bb", 0, 1)
            );
            AssertExtensions.Throws<ArgumentOutOfRangeException>("indexA", () =>
                string.Compare("a", -1, "bb", 0, 1, StringComparison.CurrentCulture)
            );

            // IndexA > stringA.Length
            AssertExtensions.Throws<ArgumentOutOfRangeException>("length1", () =>
                string.Compare("a", 2, "bb", 0, 1)
            );
            AssertExtensions.Throws<ArgumentOutOfRangeException>("indexA", () =>
                string.Compare("a", 2, "bb", 0, 1, StringComparison.CurrentCulture)
            );

            // IndexB < 0
            AssertExtensions.Throws<ArgumentOutOfRangeException>("offset2", () =>
                string.Compare("a", 0, "bb", -1, 1)
            );
            AssertExtensions.Throws<ArgumentOutOfRangeException>("indexB", () =>
                string.Compare("a", 0, "bb", -1, 1, StringComparison.CurrentCulture)
            );

            // IndexB > stringB.Length
            AssertExtensions.Throws<ArgumentOutOfRangeException>("length2", () =>
                string.Compare("a", 0, "bb", 3, 0)
            );
            AssertExtensions.Throws<ArgumentOutOfRangeException>("indexB", () =>
                string.Compare("a", 0, "bb", 3, 0, StringComparison.CurrentCulture)
            );

            // Length < 0
            AssertExtensions.Throws<ArgumentOutOfRangeException>("length1", () =>
                string.Compare("a", 0, "bb", 0, -1)
            );
            AssertExtensions.Throws<ArgumentOutOfRangeException>("length", () =>
                string.Compare("a", 0, "bb", 0, -1, StringComparison.CurrentCulture)
            );
            ...
            AssertExtensions.Throws<ArgumentException>("comparisonType", () =>
                string.Compare(null, 0, null, 0, 0, StringComparison.CurrentCulture - 1)
            ); // comparisonType should be validated before null short-circuiting...
            // Tests to ensure null is short-circuited before validating the arguments are in the Compare() theory
            AssertExtensions.Throws<ArgumentOutOfRangeException>("length", () =>
                string.Compare("foo", -1, "foo", -1, -1, StringComparison.CurrentCulture)
            ); // length should be validated before indexA/indexB
            AssertExtensions.Throws<ArgumentOutOfRangeException>("indexA", () =>
                string.Compare("foo", -1, "foo", -1, 3, StringComparison.CurrentCulture)
            ); // then indexA
            AssertExtensions.Throws<ArgumentOutOfRangeException>("indexB", () =>
                string.Compare("foo", 0, "foo", -1, 3, StringComparison.CurrentCulture)
            ); // then indexB
        ...
        public static void CompareOrdinal_Invalid()
        {
            ...
            AssertExtensions.Throws<ArgumentOutOfRangeException>("indexA", () =>
                string.CompareOrdinal("a", -1, "bb", 0, 0)
            );
            AssertExtensions.Throws<ArgumentOutOfRangeException>("indexA", () =>
                string.CompareOrdinal("a", 6, "bb", 0, 0)
            );

            // IndexB < 0 or IndexB > strB.Length
            AssertExtensions.Throws<ArgumentOutOfRangeException>("indexB", () =>
                string.CompareOrdinal("a", 0, "bb", -1, 0)
            ); // IndexB < 0
            AssertExtensions.Throws<ArgumentOutOfRangeException>("indexB", () =>
                string.CompareOrdinal("a", 0, "bb", 3, 0)
            ); // IndexB > strB.Length

            // We must validate arguments before any short-circuiting is done (besides for nulls)
            AssertExtensions.Throws<ArgumentOutOfRangeException>("indexA", () =>
                string.CompareOrdinal("foo", -1, "foo", -1, 0)
            ); // then indexA
            AssertExtensions.Throws<ArgumentOutOfRangeException>("indexB", () =>
                string.CompareOrdinal("foo", 0, "foo", -1, 0)
            ); // then indexB
            AssertExtensions.Throws<ArgumentOutOfRangeException>("indexA", () =>
                string.CompareOrdinal("foo", 4, "foo", 4, 0)
            ); // indexA > strA.Length first
            AssertExtensions.Throws<ArgumentOutOfRangeException>("indexB", () =>
                string.CompareOrdinal("foo", 3, "foo", 4, 0)
            ); // then indexB > strB.Length
        }

        [Fact]
        public static void CompareOrdinal_NegativeLength_ThrowsArgumentOutOfRangeException()
        {
            AssertExtensions.Throws<ArgumentOutOfRangeException>("length", "count", () =>
                string.CompareOrdinal("a", 0, "bb", 0, -1)
            );

            // length should be validated first
            AssertExtensions.Throws<ArgumentOutOfRangeException>("length", "count", () =>
                string.CompareOrdinal("foo", -1, "foo", -1, -1)
            );

            // early return should not kick in if length is invalid
            AssertExtensions.Throws<ArgumentOutOfRangeException>("length", "count", () =>
                string.CompareOrdinal("foo", 0, "foo", 0, -1)
            );
        }
        ...
        public static void ContainsNoMatch_StringComparison()
        {
            for (int length = 1; length < 150; length++)
            {
                for (int mismatchIndex = 0; mismatchIndex < length; mismatchIndex++)
                {
                    ...
                    Assert.False(
                        firstSpan.Contains(secondSpan, StringComparison.OrdinalIgnoreCase)
                    );
                    ...
                    Assert.Equal(
                        firstSpan
                            .ToString()
                            .StartsWith(secondSpan.ToString(), StringComparison.CurrentCulture),
                    ...
                    Assert.Equal(
                        firstSpan
                            .ToString()
                            .StartsWith(secondSpan.ToString(), StringComparison.InvariantCulture),
...
#pragma warning restore 0618 // restore warning when accessing obsolete members
        ...
        public static void EndsWith_Invalid()
        {
            ...
            AssertExtensions.Throws<ArgumentNullException>("value", () =>
                "foo".EndsWith(null, StringComparison.CurrentCulture)
            );

            // Invalid comparison type with empty string
            AssertExtensions.Throws<ArgumentException>("comparisonType", () =>
                "foo".EndsWith("", StringComparison.CurrentCulture - 1)
            );
            AssertExtensions.Throws<ArgumentException>("comparisonType", () =>
                "foo".EndsWith("", StringComparison.OrdinalIgnoreCase + 1)
            );

            // Invalid comparison type with same string
            AssertExtensions.Throws<ArgumentException>("comparisonType", () =>
                "foo".EndsWith("foo", StringComparison.CurrentCulture - 1)
            );
            AssertExtensions.Throws<ArgumentException>("comparisonType", () =>
                "foo".EndsWith("foo", StringComparison.OrdinalIgnoreCase + 1)
            );

            // Invalid comparison type with non-empty different string
            AssertExtensions.Throws<ArgumentException>("comparisonType", () =>
                "foo".EndsWith("a", StringComparison.CurrentCulture - 1)
            );
            AssertExtensions.Throws<ArgumentException>("comparisonType", () =>
                "foo".EndsWith("a", StringComparison.OrdinalIgnoreCase + 1)
            );
        }
        ...
        public static void EndsWithNoMatch_StringComparison()
        {
            for (int length = 1; length < 150; length++)
            {
                for (int mismatchIndex = 0; mismatchIndex < length; mismatchIndex++)
                {
                    ...
                    Assert.Equal(
                        s1.ToString()
                            .EndsWith(s2.ToString(), StringComparison.CurrentCultureIgnoreCase),
                    ...
                    Assert.Equal(
                        s1.ToString()
                            .EndsWith(s2.ToString(), StringComparison.InvariantCultureIgnoreCase),
                    ...
                    Assert.False(
                        firstSpan.EndsWith(secondSpan, StringComparison.OrdinalIgnoreCase)
                    );
                    ...
                    Assert.Equal(
                        firstSpan
                            .ToString()
                            .EndsWith(secondSpan.ToString(), StringComparison.CurrentCulture),
                    ...
                    Assert.Equal(
                        firstSpan
                            .ToString()
                            .EndsWith(secondSpan.ToString(), StringComparison.InvariantCulture),
        ...
        public static void EndsWithMatchNonOrdinal_StringComparison()
        {
            ...
            Assert.Equal(
                s.ToString()
                    .EndsWith(value.ToString(), StringComparison.InvariantCultureIgnoreCase),
            ...
            Assert.Equal(
                span.ToString()
                    .EndsWith(spanValue.ToString(), StringComparison.InvariantCultureIgnoreCase),
        ...
        )
        {
            ...
            AssertExtensions.Throws<ArgumentException>("comparisonType", () =>
                string.Equals("a", null, comparisonType)
            );
            AssertExtensions.Throws<ArgumentException>("comparisonType", () =>
                string.Equals("a", "b", comparisonType)
            );
            AssertExtensions.Throws<ArgumentException>("comparisonType", () =>
                "a".Equals("a", comparisonType)
            );
            AssertExtensions.Throws<ArgumentException>("comparisonType", () =>
                "a".Equals(null, comparisonType)
            );
            AssertExtensions.Throws<ArgumentException>("comparisonType", () =>
        ...
        public static IEnumerable<object[]> Format_Valid_TestData()
        {
            ...
            yield return new object[]
            {
                null,
                "0 = {0} 1 = {1} 2 = {2} 3 = {3} 4 = {4}",
                new object[] { "zero", "one", "two", "three", "four" },
        ...
        public static void Format_Valid(
        ...
        )
        {
            ...
            switch (values.Length)
            {
                ...
                case 3:
                    Assert.Equal(
                        expected,
                        string.Format(provider, format, values[0], values[1], values[2])
                    );
                    if (provider is null)
                    {
                        Assert.Equal(
                            expected,
                            string.Format(format, values[0], values[1], values[2])
                        );
                    }
                    break;
            }
        ...
        public static void Format_Invalid_ArgumentException()
        {
            ...
            AssertExtensions.Throws<ArgumentNullException>("format", () =>
                string.Format(null, obj1)
            );
            AssertExtensions.Throws<ArgumentNullException>("format", () =>
                string.Format(null, obj1, obj2)
            );
            AssertExtensions.Throws<ArgumentNullException>("format", () =>
                string.Format(null, obj1, obj2, obj3)
            );
            AssertExtensions.Throws<ArgumentNullException>("format", () =>
                string.Format(null, obj1, obj2, obj3, obj4)
            );

            AssertExtensions.Throws<ArgumentNullException>("format", () =>
                string.Format(formatter, (string)null, obj1)
            );
            AssertExtensions.Throws<ArgumentNullException>("format", () =>
                string.Format(formatter, (string)null, obj1, obj2)
            );
            AssertExtensions.Throws<ArgumentNullException>("format", () =>
                string.Format(formatter, (string)null, obj1, obj2, obj3)
            );

            // Args is null
            AssertExtensions.Throws<ArgumentNullException>("args", () => string.Format("", null));
            AssertExtensions.Throws<ArgumentNullException>("args", () =>
                string.Format(formatter, "", null)
            );

            // Args and format are null
            AssertExtensions.Throws<ArgumentNullException>("format", () =>
                string.Format(null, (object[])null)
            );
            AssertExtensions.Throws<ArgumentNullException>("format", () =>
                string.Format(formatter, (string)null, null)
            );
        }
        ...
        public static void Format_Invalid_FormatExceptionFromFormatOrArgs(
            IFormatProvider provider,
            string format,
            object[] args
        )
        ...
        [InlineData("!@#$%^&*", '%', 0, 8, 4)]
        [InlineData("", 'H', 0, 0, -1)]
        public static void IndexOf_SingleLetter(
            string s,
            char target,
            int startIndex,
            int count,
        ...
        )
        {
            ...
            if (count + startIndex == s.Length)
            {
                if (startIndex == 0)
                {
                    ...
                    Assert.Equal(
                        expected,
                        s.IndexOf(target.ToString(), StringComparison.OrdinalIgnoreCase)
                    );

                    Assert.Equal(
                        expectedFromSpan,
                        span.IndexOf(targetSpan, StringComparison.Ordinal)
                    );
                    Assert.Equal(
                        expectedFromSpan,
                        span.IndexOf(targetSpan, StringComparison.OrdinalIgnoreCase)
                    );
                    ...
                    if (safeForCurrentCulture)
                    {
                        ...
                        Assert.Equal(
                            expected,
                            s.IndexOf(target.ToString(), StringComparison.CurrentCulture)
                        );

                        Assert.Equal(
                            expectedFromSpan,
                            span.IndexOf(targetSpan, StringComparison.CurrentCulture)
                        );
                    }
                }
                ...
                Assert.Equal(
                    expected,
                    s.IndexOf(target.ToString(), startIndex, StringComparison.Ordinal)
                );
                Assert.Equal(
                    expected,
                    s.IndexOf(target.ToString(), startIndex, StringComparison.OrdinalIgnoreCase)
                );

                Assert.Equal(
                    expectedFromSpan,
                    span.Slice(startIndex).IndexOf(targetSpan, StringComparison.Ordinal)
                );
                Assert.Equal(
                    expectedFromSpan,
                    span.Slice(startIndex).IndexOf(targetSpan, StringComparison.OrdinalIgnoreCase)
                );
                ...
                if (safeForCurrentCulture)
                {
                    ...
                    Assert.Equal(
                        expected,
                        s.IndexOf(target.ToString(), startIndex, StringComparison.CurrentCulture)
                    );

                    Assert.Equal(
                        expectedFromSpan,
                        span.Slice(startIndex).IndexOf(targetSpan, StringComparison.CurrentCulture)
                    );
                }
            }
            ...
            Assert.Equal(
                expected,
                s.IndexOf(target.ToString(), startIndex, count, StringComparison.Ordinal)
            );
            Assert.Equal(
                expected,
                s.IndexOf(target.ToString(), startIndex, count, StringComparison.OrdinalIgnoreCase)
            );

            Assert.Equal(
                expectedFromSpan,
                span.Slice(startIndex, count).IndexOf(targetSpan, StringComparison.Ordinal)
            );
            Assert.Equal(
                expectedFromSpan,
                span.Slice(startIndex, count)
                    .IndexOf(targetSpan, StringComparison.OrdinalIgnoreCase)
            );
            ...
            if (safeForCurrentCulture)
            {
                ...
                Assert.Equal(
                    expected,
                    s.IndexOf(target.ToString(), startIndex, count, StringComparison.CurrentCulture)
                );

                Assert.Equal(
                    expectedFromSpan,
                    span.Slice(startIndex, count)
                        .IndexOf(targetSpan, StringComparison.CurrentCulture)
                );
            }
        }
        ...
        public static void IndexOf_AllSubstrings(
            string s,
            string value,
            int startIndex,
        ...
        )
        {
            ...
            Assert.Equal(
                ignoringCase ? startIndex : -1,
                s.AsSpan().IndexOf(value.AsSpan(), comparison)
            );
        }
        ...
        public static void IndexOf_TurkishI_TurkishCulture()
        {
            using (new ThreadCultureChange("tr-TR"))
            {
                ...
                Assert.Equal(
                    4,
                    span.IndexOf(value.AsSpan(), StringComparison.CurrentCultureIgnoreCase)
                );
            ...
            using (new ThreadCultureChange("hu-HU"))
            {
                ...
                */
                ...
                Assert.Equal(
                    ...
                    source.IndexOf(target, StringComparison.CurrentCulture)
                );
                ...
                Assert.Equal(
                    PlatformDetection.IsNlsGlobalization ? 0 : -1,
                    span.IndexOf(target.AsSpan(), StringComparison.CurrentCulture)
                );

                Assert.Equal(
                    0,
                    span.IndexOf(target.AsSpan(), StringComparison.CurrentCultureIgnoreCase)
                );
        ...
        public static void IndexOf_Invalid()
        {
            ...
            AssertExtensions.Throws<ArgumentNullException>("value", () =>
                "foo".IndexOf(null, 0, 0)
            );
            AssertExtensions.Throws<ArgumentNullException>("value", () =>
                "foo".IndexOf(null, 0, StringComparison.CurrentCulture)
            );
            AssertExtensions.Throws<ArgumentNullException>("value", () =>
                "foo".IndexOf(null, 0, 0, StringComparison.CurrentCulture)
            );
            ...
            AssertExtensions.Throws<ArgumentOutOfRangeException>("startIndex", () =>
                "foo".IndexOf("o", -1, StringComparison.CurrentCulture)
            );
            AssertExtensions.Throws<ArgumentOutOfRangeException>("startIndex", () =>
                "foo".IndexOf("o", -1, 0, StringComparison.CurrentCulture)
            );
            ...
            AssertExtensions.Throws<ArgumentOutOfRangeException>("startIndex", () =>
                "foo".IndexOf("o", 4, 0, StringComparison.CurrentCulture)
            );
            AssertExtensions.Throws<ArgumentOutOfRangeException>("startIndex", () =>
                "foo".IndexOf("o", 4, 0, StringComparison.CurrentCulture)
            );
            ...
            AssertExtensions.Throws<ArgumentOutOfRangeException>("count", () =>
                "foo".IndexOf("o", 0, -1, StringComparison.CurrentCulture)
            );
            ...
            AssertExtensions.Throws<ArgumentOutOfRangeException>("count", () =>
                "foo".IndexOf("o", 0, 4, StringComparison.CurrentCulture)
            );
            ...
            AssertExtensions.Throws<ArgumentException>("comparisonType", () =>
                "foo".AsSpan().IndexOf("o".AsSpan(), StringComparison.CurrentCulture - 1)
            );
            AssertExtensions.Throws<ArgumentException>("comparisonType", () =>
                "foo".IndexOf("o", StringComparison.OrdinalIgnoreCase + 1)
            );
            AssertExtensions.Throws<ArgumentException>("comparisonType", () =>
                "foo".AsSpan().IndexOf("o".AsSpan(), StringComparison.OrdinalIgnoreCase + 1)
            );
            AssertExtensions.Throws<ArgumentException>("comparisonType", () =>
                "foo".IndexOf("o", 0, StringComparison.CurrentCulture - 1)
            );
            AssertExtensions.Throws<ArgumentException>("comparisonType", () =>
                "foo".IndexOf("o", 0, StringComparison.OrdinalIgnoreCase + 1)
            );
            AssertExtensions.Throws<ArgumentException>("comparisonType", () =>
                "foo".IndexOf("o", 0, 0, StringComparison.CurrentCulture - 1)
            );
            AssertExtensions.Throws<ArgumentException>("comparisonType", () =>
                "foo".IndexOf("o", 0, 0, StringComparison.OrdinalIgnoreCase + 1)
            );
        }
        ...
        [InlineData(
            "\x4E16\x754C\x60A8\x597D",
            new char[] { '\x754C', '\x60A8', '\x4E16' },
            0,
            4,
            0
        )]
        [InlineData(
            "\x4E16\x754C\x60A8\x597D",
            new char[] { '\x754C', '\x60A8', '\x4E16', '\x597D' },
            0,
            4,
            0
        )]
        ...
        {
            AssertExtensions.Throws<ArgumentNullException>("anyOf", null, () =>
                "foo".IndexOfAny(null)
            );
            AssertExtensions.Throws<ArgumentNullException>("anyOf", null, () =>
                "foo".IndexOfAny(null, 0)
            );
            AssertExtensions.Throws<ArgumentNullException>("anyOf", null, () =>
                "foo".IndexOfAny(null, 0, 0)
            );
        }
        ...
        {
            AssertExtensions.Throws<ArgumentOutOfRangeException>("startIndex", null, () =>
                "foo".IndexOfAny(new char[] { 'o' }, startIndex)
            );
            AssertExtensions.Throws<ArgumentOutOfRangeException>("startIndex", null, () =>
                "foo".IndexOfAny(new char[] { 'o' }, startIndex, 0)
            );
        }
        ...
        public static void IsWhiteSpaceTrueLatin1()
        {
            ...
            for (int length = 0; length < 32; length++)
            {
                ...
                {
                    s1 = new string(
                        Enumerable.Repeat(s_whiteSpaceCharacters[i], a.Length).ToArray()
                    );
                ...
                for (int i = 0; i < s_whiteSpaceCharacters.Length - 1; i++)
                {
                    ...
                    Assert.Equal(
                        string.IsNullOrWhiteSpace(new string(span.ToArray())),
        ...
        public static void Join_StringArray(
            string separator,
            string[] values,
            int startIndex,
            int count,
        ...
        )
        {
            if (startIndex + count == values.Length && count != 0)
            {
                ...
                Assert.Equal(
                    expected,
                    string.Join<string>(separator, iEnumerableStringNotOptimized)
                );
        ...
        public static void Join_String_NullValues_ThrowsArgumentNullException()
        {
            ...
            AssertExtensions.Throws<ArgumentNullException>("value", () =>
                string.Join("$$", null, 0, 0)
            );
            AssertExtensions.Throws<ArgumentNullException>("values", () =>
                string.Join("|", (IEnumerable<string>)null)
            );
            AssertExtensions.Throws<ArgumentNullException>("values", () =>
                string.Join<string>("|", (IEnumerable<string>)null)
            ); // Generic overload
        }
        ...
        [InlineData("", 'H', 0, 0, -1)]
        public static void LastIndexOf_SingleLetter(
            string s,
            char value,
            int startIndex,
            int count,
        ...
        )
        {
            ...
            Assert.Equal(
                expected,
                s.LastIndexOf(value.ToString(), startIndex, count, StringComparison.CurrentCulture)
            );
            Assert.Equal(
                expected,
                s.LastIndexOf(value.ToString(), startIndex, count, StringComparison.Ordinal)
            );
            Assert.Equal(
                expected,
                s.LastIndexOf(
            ...
            Assert.Equal(
                expectedFromSpan,
                span.LastIndexOf(valueSpan, StringComparison.CurrentCulture)
            );
            Assert.Equal(expectedFromSpan, span.LastIndexOf(valueSpan, StringComparison.Ordinal));
            Assert.Equal(
                expectedFromSpan,
                span.LastIndexOf(valueSpan, StringComparison.OrdinalIgnoreCase)
            );
            Assert.Equal(
                expectedFromSpan,
                span.LastIndexOf(valueSpan, StringComparison.InvariantCulture)
            );
            Assert.Equal(
                expectedFromSpan,
                span.LastIndexOf(valueSpan, StringComparison.InvariantCultureIgnoreCase)
            );
        }
        ...
        [Theory]
        [MemberData(nameof(AllSubstringsAndComparisons), new object[] { "abcde" })]
        public static void LastIndexOf_AllSubstrings(
            string s,
            string value,
            int startIndex,
            StringComparison comparison
        )
        {
            ...
            Assert.Equal(
                startIndex,
                s.LastIndexOf(value, startIndex + value.Length - 1, comparison)
            ); // starting at end of substring
            ...
            if (startIndex + value.Length < s.Length)
            {
                Assert.Equal(
                    startIndex,
                    s.LastIndexOf(value, startIndex + value.Length + 1, comparison)
                ); // starting a bit more beyond end of substring
                Assert.Equal(
                    startIndex,
                    s.AsSpan(0, startIndex + value.Length + 1)
                        .LastIndexOf(value.AsSpan(), comparison)
                ); // starting a bit more beyond end of substring
            }
            if (startIndex + value.Length > 1)
            {
                ...
                Assert.Equal(
                    -1,
                    s.AsSpan(0, startIndex + value.Length - 2)
                        .LastIndexOf(value.AsSpan(), comparison)
                ); // starting before end of substring
            }
            ...
            s = s.ToUpperInvariant();
            Assert.Equal(
                ignoringCase ? halfLen + startIndex : -1,
                s.LastIndexOf(value, comparison)
            );
            Assert.Equal(
                ignoringCase ? halfLen + startIndex : -1,
                s.AsSpan().LastIndexOf(value.AsSpan(), comparison)
            );
        }
        ...
        public static void LastIndexOf_Invalid()
        {
            ...
            AssertExtensions.Throws<ArgumentNullException>("value", () =>
                s.LastIndexOf(null, StringComparison.CurrentCulture)
            );
            AssertExtensions.Throws<ArgumentNullException>("value", () => s.LastIndexOf(null, 0));
            AssertExtensions.Throws<ArgumentNullException>("value", () =>
                s.LastIndexOf(null, 0, 0)
            );
            AssertExtensions.Throws<ArgumentNullException>("value", () =>
                s.LastIndexOf(null, 0, 0, StringComparison.CurrentCulture)
            );
            ...
            AssertExtensions.Throws<ArgumentOutOfRangeException>("startIndex", () =>
                s.LastIndexOf("a", -1, StringComparison.CurrentCulture)
            );
            AssertExtensions.Throws<ArgumentOutOfRangeException>("startIndex", () =>
                s.LastIndexOf("a", -1, 0)
            );
            AssertExtensions.Throws<ArgumentOutOfRangeException>("startIndex", () =>
                s.LastIndexOf("a", -1, 0, StringComparison.CurrentCulture)
            );
            ...
            AssertExtensions.Throws<ArgumentOutOfRangeException>("startIndex", () =>
                s.LastIndexOf('a', s.Length + 1, 0)
            );
            AssertExtensions.Throws<ArgumentOutOfRangeException>("startIndex", () =>
                s.LastIndexOf("a", s.Length + 1)
            );
            AssertExtensions.Throws<ArgumentOutOfRangeException>("startIndex", () =>
                s.LastIndexOf("a", s.Length + 1, StringComparison.CurrentCulture)
            );
            AssertExtensions.Throws<ArgumentOutOfRangeException>("startIndex", () =>
                s.LastIndexOf("a", s.Length + 1, 0)
            );
            AssertExtensions.Throws<ArgumentOutOfRangeException>("startIndex", () =>
                s.LastIndexOf("a", s.Length + 1, 0, StringComparison.CurrentCulture)
            );
            ...
            AssertExtensions.Throws<ArgumentOutOfRangeException>("count", () =>
                s.LastIndexOf("a", 0, -1, StringComparison.CurrentCulture)
            );

            // Start index - count + 1 < 0
            AssertExtensions.Throws<ArgumentOutOfRangeException>("count", () =>
                s.LastIndexOf('a', 0, s.Length + 2)
            );
            AssertExtensions.Throws<ArgumentOutOfRangeException>("count", () =>
                s.LastIndexOf("a", 0, s.Length + 2)
            );
            AssertExtensions.Throws<ArgumentOutOfRangeException>("count", () =>
                s.LastIndexOf("a", 0, s.Length + 2, StringComparison.CurrentCulture)
            );

            // Invalid comparison type
            AssertExtensions.Throws<ArgumentException>("comparisonType", () =>
                s.LastIndexOf("a", StringComparison.CurrentCulture - 1)
            );
            AssertExtensions.Throws<ArgumentException>("comparisonType", () =>
                s.AsSpan().LastIndexOf("a".AsSpan(), StringComparison.CurrentCulture - 1)
            );
            AssertExtensions.Throws<ArgumentException>("comparisonType", () =>
                s.LastIndexOf("a", StringComparison.OrdinalIgnoreCase + 1)
            );
            AssertExtensions.Throws<ArgumentException>("comparisonType", () =>
                s.AsSpan().LastIndexOf("a".AsSpan(), StringComparison.OrdinalIgnoreCase + 1)
            );
            AssertExtensions.Throws<ArgumentException>("comparisonType", () =>
                s.LastIndexOf("a", 0, StringComparison.CurrentCulture - 1)
            );
            AssertExtensions.Throws<ArgumentException>("comparisonType", () =>
                s.LastIndexOf("a", 0, StringComparison.OrdinalIgnoreCase + 1)
            );
            AssertExtensions.Throws<ArgumentException>("comparisonType", () =>
                s.LastIndexOf("a", 0, 0, StringComparison.CurrentCulture - 1)
            );
            AssertExtensions.Throws<ArgumentException>("comparisonType", () =>
                s.LastIndexOf("a", 0, 0, StringComparison.OrdinalIgnoreCase + 1)
            );
        }
        ...
        public static void LastIndexOf_TurkishI_TurkishCulture()
        {
            using (new ThreadCultureChange("tr-TR"))
            {
                ...
                Assert.Equal(
                    19,
                    span.LastIndexOf(value.AsSpan(), StringComparison.CurrentCultureIgnoreCase)
                );
                Assert.Equal(19, span.LastIndexOf(value.AsSpan(), StringComparison.Ordinal));
                Assert.Equal(
                    19,
                    span.LastIndexOf(value.AsSpan(), StringComparison.OrdinalIgnoreCase)
                );
        ...
        public static void LastIndexOf_EmptyString(string s, int expected)
        {
            ...
            Assert.Equal(
                expected,
                s.AsSpan().LastIndexOf("".AsSpan(), StringComparison.OrdinalIgnoreCase)
            );
        }
        ...
        public static void LastIndexOfAny(
            string s,
            char[] anyOf,
            int startIndex,
            int count,
        ...
        public static void LastIndexOfAny_Invalid()
        {
            ...
            // Start index < 0
            AssertExtensions.Throws<ArgumentOutOfRangeException>("startIndex", () =>
                "foo".LastIndexOfAny(new char[] { 'o' }, -1)
            );
            AssertExtensions.Throws<ArgumentOutOfRangeException>("startIndex", () =>
                "foo".LastIndexOfAny(new char[] { 'o' }, -1, 0)
            );

            // Start index > string.Length
            AssertExtensions.Throws<ArgumentOutOfRangeException>("startIndex", () =>
                "foo".LastIndexOfAny(new char[] { 'o' }, 4)
            );
            AssertExtensions.Throws<ArgumentOutOfRangeException>("startIndex", () =>
                "foo".LastIndexOfAny(new char[] { 'o' }, 4, 0)
            );

            // Count < 0 or count > string.Length
            AssertExtensions.Throws<ArgumentOutOfRangeException>("count", () =>
                "foo".LastIndexOfAny(new char[] { 'o' }, 0, -1)
            );
            AssertExtensions.Throws<ArgumentOutOfRangeException>("count", () =>
                "foo".LastIndexOfAny(new char[] { 'o' }, 0, 4)
            );

            // Start index + count > string.Length
            AssertExtensions.Throws<ArgumentOutOfRangeException>("startIndex", () =>
                "foo".LastIndexOfAny(new char[] { 'o' }, 3, 1)
            );
        }
        ...
        {
            AssertExtensions.Throws<ArgumentOutOfRangeException>("totalWidth", () =>
                "".PadLeft(-1, '.')
            );
        }
        ...
        [InlineData(
            "aaaAaaaaaaaBAbbbbbbCcccccccDddAdddd",
            'A',
            'a',
            "aaaaaaaaaaaBabbbbbbCcccccccDddadddd"
        )]
        ...
        [InlineData(
            "aaaAaaaaaaaBAbbbbbbCcccccccDddAdddddAd",
            'A',
            'a',
            "aaaaaaaaaaaBabbbbbbCcccccccDddadddddad"
        )]
        ...
        [InlineData(
            "AaaaaaaaBAbbbbbbCcccccccDddAdddd",
            'A',
            'a',
            "aaaaaaaaBabbbbbbCcccccccDddadddd"
        )]
        ...
        [InlineData(
            "AaaaaaaaBAbbbbbbCcccccccDddAdddddAd",
            'A',
            'a',
            "aaaaaaaaBabbbbbbCcccccccDddadddddad"
        )]
        ...
        [InlineData("", '1', '2')]
        [InlineData("XYZ", 'a', 'a')]
        public static void Replace_Char_Char_DoesntAllocateIfNothingIsReplaced(
            string s,
            char oldChar,
            char newChar
        )
        ...
        [InlineData(
            "Aa1Bbb1Cccc1Ddddd1Eeeeee1Fffffff",
            "1",
            "23",
            "Aa23Bbb23Cccc23Ddddd23Eeeeee23Fffffff"
        )]
        [InlineData(
        ...
        )] //  Checks if we handle the max # of matches
        [InlineData("11111111111111111111111", "1", "", "")] // Checks if we handle the max # of matches
        public static void Replace_String_String(
            string s,
            string oldValue,
            string newValue,
            string expected
        ...
        [InlineData("XYZ", "1", "2")]
        [InlineData("", "1", "2")]
        public static void Replace_String_String_DoesntAllocateIfNothingIsReplaced(
            string s,
            string oldValue,
            string newValue
        )
        ...
        public static void StartsWith_Invalid()
        {
            ...
            AssertExtensions.Throws<ArgumentNullException>("value", () =>
                s.StartsWith(null, StringComparison.OrdinalIgnoreCase)
            );

            // Invalid comparison type
            AssertExtensions.Throws<ArgumentException>("comparisonType", () =>
                s.StartsWith("H", StringComparison.CurrentCulture - 1)
            );
            AssertExtensions.Throws<ArgumentException>("comparisonType", () =>
                s.AsSpan().StartsWith("H".AsSpan(), StringComparison.CurrentCulture - 1)
            );

            AssertExtensions.Throws<ArgumentException>("comparisonType", () =>
                s.StartsWith("H", StringComparison.OrdinalIgnoreCase + 1)
            );
            AssertExtensions.Throws<ArgumentException>("comparisonType", () =>
                s.AsSpan().StartsWith("H".AsSpan(), StringComparison.OrdinalIgnoreCase + 1)
            );
        }
        ...
        private static IEnumerable<object[]> ToLower_Culture_TestData()
        {
            ...
            foreach (Tuple<char, char, CultureInfo> tuple in tuples)
            {
                yield return new object[]
                {
                    $"{tuple.Item1}Hello World",
                    $"{tuple.Item2}hello world",
                    tuple.Item3,
                };
                yield return new object[]
                {
                    $"HeLlO{tuple.Item1} WORLD",
                    $"hello{tuple.Item2} world",
                    tuple.Item3,
                };
                yield return new object[]
                {
                    $"hello world{tuple.Item1}",
                    $"hello world{tuple.Item2}",
                    tuple.Item3,
                };
                yield return new object[]
                {
                    new string(tuple.Item1, 100),
                    new string(tuple.Item2, 100),
                    tuple.Item3,
                };
            }
        }
        ...
        private static void ToLower_Culture(string input, string expected, CultureInfo culture)
        {
            ...
            {
                Assert.True(
                    input.ToLower().Equals(expected, StringComparison.Ordinal),
                    $"Input: {input}, Expected: {expected}, Actual: {input.ToLower()}"
                );
        ...
        public static void ToLower_CharArray()
        {
...

            {
                ...
                Assert.Equal(
                    expectedDestination,
                    s1.ToLower(CultureInfo.CurrentCulture).ToCharArray()
                );
        ...
        public static void ToUpper_CharArray()
        {
...

            {
                ...
                Assert.Equal(
                    expectedDestination,
                    s1.ToUpper(CultureInfo.CurrentCulture).ToCharArray()
                );
        ...
        public static void ToUpper_TurkishI_TurkishCulture(string s, string expected)
        {
            ...
            {
                Assert.True(
                    s.ToUpper().Equals(expected, StringComparison.Ordinal),
                    "Actual: " + s.ToUpper()
                );
        ...
        public static void TrimCharacterMultipleTimes()
        {
            for (int length = 3; length < 32; length++)
            {
                ...
                Assert.True(
                    trimStartResultString.SequenceEqual(trimStartResultString.TrimStart('a'))
                );
        ...
        public static void OnlyTrimCharacters()
        {
            ...
            for (int length = 0; length < 32; length++)
            {
                ...
                ReadOnlySpan<char> span = s1.AsSpan();
                Assert.True(
                    ReadOnlySpan<char>.Empty.SequenceEqual(span.Trim(chars)),
                    "G: " + length
                );
                Assert.True(
                    ReadOnlySpan<char>.Empty.SequenceEqual(span.TrimStart(chars)),
                    "H: " + length
                );
                Assert.True(
                    ReadOnlySpan<char>.Empty.SequenceEqual(span.TrimEnd(chars)),
                    "I: " + length
                );
            }
            ...
            Assert.True(
                ReadOnlySpan<char>.Empty.SequenceEqual(stringSpan.TrimStart(trimChars)),
                "K"
            );
        ...
        public static void TrimCharactersMultipleTimes()
        {
            ...
            for (int length = 3; length < 32; length++)
            {
                ...
                Assert.True(
                    trimStartResultString.SequenceEqual(trimStartResultString.TrimStart(chars))
                );
            ...
            // 2nd attempt should do nothing
            Assert.True(
                trimStringResultString.SequenceEqual(trimStringResultString.Trim(trimCharsString))
            );
            Assert.True(
                trimStartStringResultString.SequenceEqual(
                    trimStartStringResultString.TrimStart(trimCharsString)
                )
            );
            Assert.True(
                trimEndStringResultString.SequenceEqual(
                    trimEndStringResultString.TrimEnd(trimCharsString)
                )
            );
            ...
            Assert.True(
                trimStartStringResult.SequenceEqual(trimStartStringResult.TrimStart(trimChars))
            );
        ...
        public static IEnumerable<object[]> UpperLowerCasing_TestData()
        {
            ...
            if (PlatformDetection.IsNotInvariantGlobalization)
            {
                ...
                {
                    "\ud801\udc29",
                    PlatformDetection.IsWindows7 ? "\ud801\udc29" : "\ud801\udc01",
                    "en-US",
                };
            }
        }
        ...
        )
        {
            ...
            Assert.Equal(
                expected,
                Math.Sign(String.Compare(s1, 0, s2, 0, s1 == null ? 0 : s1.Length, ignoreCase, ci))
            );
            Assert.Equal(
                expected,
                Math.Sign(
                    String.Compare(s1, 0, s2, 0, s1 == null ? 0 : s1.Length, ci, ignoreCaseOption)
                )
            );
            ...
            Assert.Equal(
                ...
                Math.Sign(String.Compare(s1, s2, ci, CompareOptions.Ordinal))
            );
            Assert.Equal(
                Math.Sign(String.Compare(s1, s2, StringComparison.OrdinalIgnoreCase)),
                Math.Sign(String.Compare(s1, s2, ci, CompareOptions.OrdinalIgnoreCase))
            );
            ...
            if (ci != null && PlatformDetection.IsNotInvariantGlobalization)
            {
                using (new ThreadCultureChange(ci))
                {
                    Assert.Equal(
                        expected,
                        String.Compare(s1, 0, s2, 0, s1 == null ? 0 : s1.Length, ignoreCase)
                    );
                }
            }
        }
        ...
        public static void StartEndWithTest(
            string source,
            string start,
            string end,
            string cultureName,
        ...
        public static void StartEndWith_ZeroWeightValue(
            string value,
            StringComparison comparison,
        ...
        )
        {
            ...
            Assert.Equal(
                expectedStartsAndEndsWithResult ? 0 : -1,
                string.Empty.IndexOf(value, comparison)
            );
            Assert.Equal(
                expectedStartsAndEndsWithResult ? 0 : -1,
                string.Empty.LastIndexOf(value, comparison)
            );
        }
        ...
        {
            AssertExtensions.Throws<ArgumentNullException>("value", () =>
                "".StartsWith(null, true, null)
            );
            AssertExtensions.Throws<ArgumentNullException>("value", () =>
                "".EndsWith(null, true, null)
            );
        }
        ...
        public static unsafe void Ctor_SByte()
        {
            ...
            fixed (byte* pBytes = encodedBytes)
            {
                ...
                Assert.Equal(
                    s,
                    new string((sbyte*)pBytes, 0, encodedBytes.Length, Encoding.Default)
                );
            }
        ...
        public static void StartsWithNoMatch_StringComparison()
        {
            for (int length = 1; length < 150; length++)
            {
                for (int mismatchIndex = 0; mismatchIndex < length; mismatchIndex++)
                {
                    ...
                    Assert.Equal(
                        s1.ToString()
                            .StartsWith(s2.ToString(), StringComparison.CurrentCultureIgnoreCase),
                    ...
                    Assert.Equal(
                        s1.ToString()
                            .StartsWith(s2.ToString(), StringComparison.InvariantCultureIgnoreCase),
                    ...
                    Assert.False(
                        firstSpan.StartsWith(secondSpan, StringComparison.OrdinalIgnoreCase)
                    );
        ...
        public static void StartsWithMatchNonOrdinal_StringComparison()
        {
            ...
            Assert.Equal(
                span.ToString()
                    .StartsWith(value.ToString(), StringComparison.InvariantCultureIgnoreCase),
        ...
        public static unsafe void Ctor_SByte_InvalidArguments()
        {
            ...
            AssertExtensions.Throws<ArgumentNullException>("value", () =>
                new string((sbyte*)null, 1, 1, Encoding.Default)
            );
            ...
            AssertExtensions.Throws<ArgumentNullException>("value", () =>
                new string((sbyte*)null, 1, 1, null)
            );
            ...
            AssertExtensions.Throws<ArgumentOutOfRangeException>("startIndex", () =>
                new string((sbyte*)null, -1, 0, Encoding.UTF8)
            );
            AssertExtensions.Throws<ArgumentOutOfRangeException>("length", () =>
                new string((sbyte*)null, 0, -1)
            );
            AssertExtensions.Throws<ArgumentOutOfRangeException>("length", () =>
                new string((sbyte*)null, 0, -1, Encoding.UTF8)
            );
            AssertExtensions.Throws<ArgumentOutOfRangeException>("value", () =>
                new string(
                    UIntPtr.Size == 4 ? (sbyte*)uint.MaxValue : (sbyte*)ulong.MaxValue,
                    42,
                    0
                )
            );
        ...
        public static void CreateStringFromEncoding_0Length_EmptyStringReturned() // basic test for code coverage; more tests in encodings tests
        {
            Assert.Same(
                string.Empty,
                new AsciiEncodingWithZeroReturningGetCharCount().GetString(
                    "hello"u8.ToArray(),
                    0,
                    0
                )
        ...
        public static unsafe void CloneTest()
        {
            ...
            Assert.True(
                object.ReferenceEquals(s, cloned),
                "cloned object should return same instance of the string"
            );
        }
...
#pragma warning disable 0618 // suppress obsolete warning for String.Copy
            ...
            Assert.Equal(s, copy);
            Assert.False(
                object.ReferenceEquals(s, copy),
                "copy should return new instance of the string"
            );
#pragma warning restore 0618 // restore warning when accessing obsolete members
        }
        ...
        public static unsafe void InternTest()
        {
            ...
            Assert.False(
                ...
                "Created string from StringBuilder should have different reference than the literal string"
            );
            Assert.True(
                object.ReferenceEquals(s1, s3),
                "Created intern string should have same reference as the literal string"
            );

            Assert.True(
                String.IsInterned(s1).Equals(s1),
                "Expected to the literal string interned"
            );
            Assert.True(
                String.IsInterned(s2).Equals(s1),
                "Expected to the interned string to be in the string pool now"
            );
        }
...
#pragma warning restore 0618 // restore warning when accessing obsolete members
        ...
        public static unsafe void NormalizationTest() // basic test; more tests in globalization tests
        {
            ...
            Assert.False(
                s.IsNormalized(),
                "String should be not normalized when checking with the default which same as FormC"
            );
            Assert.False(
                s.IsNormalized(NormalizationForm.FormC),
                "String should be not normalized when checking with FormC"
            );
            Assert.False(
                s.IsNormalized(NormalizationForm.FormD),
                "String should be not normalized when checking with FormD"
            );
            ...
            {
                Assert.False(
                    s.IsNormalized(NormalizationForm.FormKC),
                    "String should be not normalized when checking with FormKC"
                );
                Assert.False(
                    s.IsNormalized(NormalizationForm.FormKD),
                    "String should be not normalized when checking with FormKD"
                );
            }
            ...
            Assert.True(
                ...
                "Expected to have the normalized string with default form FormC"
            );
            Assert.True(
                normalized.IsNormalized(NormalizationForm.FormC),
                "Expected to have the normalized string with FormC"
            );

            normalized = s.Normalize(NormalizationForm.FormC);
            Assert.True(
                normalized.IsNormalized(),
                "Expected to have the normalized string with default form FormC when using NormalizationForm.FormC"
            );
            Assert.True(
                normalized.IsNormalized(NormalizationForm.FormC),
                "Expected to have the normalized string with FormC when using NormalizationForm.FormC"
            );

            normalized = s.Normalize(NormalizationForm.FormD);
            Assert.True(
                normalized.IsNormalized(NormalizationForm.FormD),
                "Expected to have the normalized string with FormD"
            );
            ...
            if (supportsKCKD)
            {
                ...
                Assert.True(
                    normalized.IsNormalized(NormalizationForm.FormKC),
                    "Expected to have the normalized string with FormKC"
                );

                normalized = s.Normalize(NormalizationForm.FormKD);
                Assert.True(
                    normalized.IsNormalized(NormalizationForm.FormKD),
                    "Expected to have the normalized string with FormKD"
                );
            }
        ...
        public static unsafe void GetEnumeratorTest()
        {
            ...
            foreach (char c in s)
            {
                Assert.True(
                    chEnum.MoveNext(),
                    "expect to have characters to enumerate in the string"
                );
