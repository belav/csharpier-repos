    ...
    public partial class StringTests
    {
        ...
        public static unsafe void Ctor_CharPtr_Int_Int_Invalid()
        {
            ...
            AssertExtensions.Throws<ArgumentOutOfRangeException>(
                ...
                () =>
                    new string(
                        UIntPtr.Size == 4 ? (char*)uint.MaxValue : (char*)ulong.MaxValue,
                        42,
                        0
                    )
...
#pragma warning restore 0618 // restore warning when accessing obsolete members
        ...
        public static void Format_Invalid()
        {
            ...
            AssertExtensions.Throws<ArgumentNullException>(
                "format",
                () => string.Format(formatter, null, obj1)
            );
            AssertExtensions.Throws<ArgumentNullException>(
                "format",
                () => string.Format(formatter, null, obj1, obj2)
            );
            AssertExtensions.Throws<ArgumentNullException>(
                "format",
                () => string.Format(formatter, null, obj1, obj2, obj3)
            );
            ...
            AssertExtensions.Throws<ArgumentNullException>(
                "format",
                () => string.Format(formatter, null, null)
            );
            ...
            Assert.Throws<FormatException>(
                () => string.Format(formatter, "{-1}", obj1, obj2, obj3)
            ); // Format has value < 0
            Assert.Throws<FormatException>(
                () => string.Format(formatter, "{-1}", obj1, obj2, obj3, obj4)
            ); // Format has value < 0
            ...
            Assert.Throws<FormatException>(
                () => string.Format(formatter, "{4}", obj1, obj2, obj3, obj4)
            ); // Format has value >= 4
        ...
        public static void SameSpanToLower()
        {
            ...
            {
                AssertExtensions.AssertThrows<InvalidOperationException, char>(
                    a,
                    a =>
                    {
