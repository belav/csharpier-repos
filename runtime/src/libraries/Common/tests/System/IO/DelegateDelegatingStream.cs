...
namespace System.IO
{
    ...
    internal sealed class DelegateDelegatingStream : DelegatingStream
    {
        ...
        public override long Position =>
            GetPositionFunc != null ? GetPositionFunc() : base.Position;

        public override int Read(byte[] buffer, int offset, int count) =>
            ReadFunc != null ? ReadFunc(buffer, offset, count) : base.Read(buffer, offset, count);

        public override int Read(Span<byte> buffer) =>
            ReadSpanFunc != null ? ReadSpanFunc(buffer) : base.Read(buffer);
        ...
        public override ValueTask<int> ReadAsync(
            ...
            ReadAsyncMemoryFunc != null
                ? ReadAsyncMemoryFunc(buffer, cancellationToken)
        ...
        public override ValueTask WriteAsync(
            ...
            WriteAsyncMemoryFunc != null
                ? WriteAsyncMemoryFunc(buffer, cancellationToken)
                : base.WriteAsync(buffer, cancellationToken);

        public override void CopyTo(Stream destination, int bufferSize)
        {
            if (CopyToFunc != null)
                CopyToFunc(destination, bufferSize);
            else
        ...
        public override Task CopyToAsync(
            ...
            CopyToAsyncFunc != null
                ? CopyToAsyncFunc(destination, bufferSize, cancellationToken)
