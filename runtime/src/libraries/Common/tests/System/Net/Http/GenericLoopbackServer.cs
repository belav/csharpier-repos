...
namespace System.Net.Test.Common
{
    ...
    public abstract class LoopbackServerFactory
    {
        ...
        public const int LoopbackServerTimeoutMilliseconds = (int)(
            TestHelper.PassingTestTimeoutMilliseconds * 1.2
        );
        ...
        public abstract Task<GenericLoopbackConnection> CreateConnectionAsync(
        ...
        public Task CreateClientAndServerAsync(
    ...
    {
        public const int LoopbackServerTimeoutMilliseconds =
            LoopbackServerFactory.LoopbackServerTimeoutMilliseconds;
        ...
        public abstract Task<HttpRequestData> HandleRequestAsync(
        ...
        // Legacy API.
        public Task<HttpRequestData> AcceptConnectionSendResponseAndCloseAsync(
            HttpStatusCode statusCode = HttpStatusCode.OK,
            string content = "",
    ...
    public sealed class SocketWrapper : IDisposable
    {
        ...
        private void CloseWebSocket()
        {
            ...
            try
            {
                var task = _websocket.CloseAsync(
    ...
    public class GenericLoopbackOptions
    {
        ...
        public bool UseSsl { get; set; } =
            PlatformDetection.SupportsAlpn && !Capability.Http2ForceUnencryptedLoopback();
    ...
    public struct HttpHeaderData
    {
        ...
        public override string ToString() =>
            Name == null ? "<empty>" : (Name + ": " + (Value ?? string.Empty));
    }
    ...
    public class HttpRequestData
    {
        ...
        {
            return Headers
                .Where(h => h.Name.Equals(headerName, StringComparison.OrdinalIgnoreCase))
                .Select(h => h.Value)
                .ToArray();
        }
