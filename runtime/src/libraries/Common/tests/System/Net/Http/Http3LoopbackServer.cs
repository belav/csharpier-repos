...
namespace System.Net.Test.Common
{
    public sealed class Http3LoopbackServer : GenericLoopbackServer
    {
        ...
        )
        {
            ...
            _listener = new QuicListener(
                quicImplementationProvider ?? QuicImplementationProviders.Default,
                listenerOptions
            );
        }
        ...
        {
            using Http3LoopbackConnection con = await EstablishHttp3ConnectionAsync()
    ...
    public sealed class Http3LoopbackServerFactory : LoopbackServerFactory
    {
        ...
        public static Http3LoopbackServerFactory Singleton { get; } =
            new Http3LoopbackServerFactory(null);
