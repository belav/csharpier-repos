        ...
        )
        {
            ...
            for (int i = 0; i < values.Length; i++)
            {
                ...
                else if (trimmedValue.StartsWith(nameof(algorithm)))
                {
                    ...
                    {
                        startIndex += 1;
                        algorithm = trimmedValue.Substring(
                            startIndex,
                            trimmedValue.Length - startIndex
                        )
                            .Trim();
                    }
                }
                ...
                else if (trimmedValue.StartsWith(nameof(qop)))
                {
                    ...
                    {
                        startIndex += 1;
                        qop = trimmedValue.Substring(startIndex, trimmedValue.Length - startIndex)
                            .Trim();
                    }
                }
                else if (trimmedValue.StartsWith(nameof(nc)))
                {
                    ...
                    {
                        startIndex += 1;
                        nc = trimmedValue.Substring(startIndex, trimmedValue.Length - startIndex)
                            .Trim();
                    }
                }
            }
