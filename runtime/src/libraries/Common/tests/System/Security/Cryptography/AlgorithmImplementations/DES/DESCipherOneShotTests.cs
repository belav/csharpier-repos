...
namespace System.Security.Cryptography.Encryption.Des.Tests
{
    ...
    public class DesCipherOneShotTests : SymmetricOneShotBase
    {
        protected override byte[] Key =>
            new byte[] { 0x74, 0x4B, 0x93, 0x3A, 0x96, 0x33, 0x61, 0xD6 };

        protected override byte[] IV =>
            new byte[] { 0x01, 0x01, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08 };
        ...
        [Theory]
        [MemberData(nameof(TestCases))]
        public void TryDecryptOneShot_DestinationTooSmall(
            byte[] plaintext,
            byte[] ciphertext,
            PaddingMode padding,
            CipherMode mode,
            ...
            TryDecryptOneShot_DestinationTooSmallTest(
                plaintext,
                ciphertext,
                padding,
                mode,
        ...
        [Theory]
        [MemberData(nameof(TestCases))]
        public void TryEncryptOneShot_DestinationTooSmall(
            byte[] plaintext,
            byte[] ciphertext,
            PaddingMode padding,
            CipherMode mode,
            ...
            TryEncryptOneShot_DestinationTooSmallTest(
                plaintext,
                ciphertext,
                padding,
                mode,
        ...
        [Theory]
        [MemberData(nameof(TestCases))]
        public void TryDecryptOneShot_DestinationJustRight(
            byte[] plaintext,
            byte[] ciphertext,
            PaddingMode padding,
            CipherMode mode,
            ...
            TryDecryptOneShot_DestinationJustRightTest(
                plaintext,
                ciphertext,
                padding,
                mode,
        ...
        [Theory]
        [MemberData(nameof(TestCases))]
        public void TryEncryptOneShot_DestinationJustRight(
            byte[] plaintext,
            byte[] ciphertext,
            PaddingMode padding,
            CipherMode mode,
            ...
            TryEncryptOneShot_DestinationJustRightTest(
                plaintext,
                ciphertext,
                padding,
                mode,
        ...
        [Theory]
        [MemberData(nameof(TestCases))]
        public void TryDecryptOneShot_DestinationLarger(
            byte[] plaintext,
            byte[] ciphertext,
            PaddingMode padding,
            CipherMode mode,
            ...
            TryDecryptOneShot_DestinationLargerTest(
                plaintext,
                ciphertext,
                padding,
                mode,
        ...
        [Theory]
        [MemberData(nameof(TestCases))]
        public void TryEncryptOneShot_DestinationLarger(
            byte[] plaintext,
            byte[] ciphertext,
            PaddingMode padding,
            CipherMode mode,
            ...
            TryEncryptOneShot_DestinationLargerTest(
                plaintext,
                ciphertext,
                padding,
                mode,
        ...
        [Theory]
        [MemberData(nameof(TestCases))]
        public void TryDecryptOneShot_Overlaps(
            byte[] plaintext,
            byte[] ciphertext,
            PaddingMode padding,
            CipherMode mode,
        ...
        [Theory]
        [MemberData(nameof(TestCases))]
        public void TryEncryptOneShot_Overlaps(
            byte[] plaintext,
            byte[] ciphertext,
            PaddingMode padding,
            CipherMode mode,
        ...
        [Theory]
        [MemberData(nameof(TestCases))]
        public void DecryptOneShot_Span(
            byte[] plaintext,
            byte[] ciphertext,
            PaddingMode padding,
            CipherMode mode,
        ...
        [Theory]
        [MemberData(nameof(TestCases))]
        public void EncryptOneShot_Span(
            byte[] plaintext,
            byte[] ciphertext,
            PaddingMode padding,
            CipherMode mode,
        ...
        [Theory]
        [MemberData(nameof(TestCases))]
        public void DecryptOneShot_Array(
            byte[] plaintext,
            byte[] ciphertext,
            PaddingMode padding,
            CipherMode mode,
        ...
        [Theory]
        [MemberData(nameof(TestCases))]
        public void EncryptOneShot_Array(
            byte[] plaintext,
            byte[] ciphertext,
            PaddingMode padding,
            CipherMode mode,
        ...
        public static IEnumerable<object[]> TestCases
        {
            get
            {
                ...
                yield return new object[]
                {
                    ...
                    Array.Empty<byte>(),
                    // ciphertext
                    new byte[] { 0x49, 0xD5, 0xE1, 0x5E, 0x17, 0x12, 0x23, 0xCF },
                    PaddingMode.PKCS7,
                    CipherMode.CBC,
                };
