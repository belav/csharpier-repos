...
namespace System.Security.Cryptography.Dsa.Tests
{
    public abstract partial class DSASignVerify
    {
        ...
        public void Fips186_3_L2048_N256_SHA256_1()
        {
            ...
            const string q = "e71f8567447f42e75f5ef85ca20fe557ab0343d37ed09edc3f6e68604d6b9dfb";
            ...
            const string x = "446969025446247f84fdea74d02d7dd13672b2deb7c085be11111441955a377b";
            ...
            const string r = "633055e055f237c38999d81c397848c38cce80a55b649d9e7905c298e2a51447";

            const string s = "2bbf68317660ec1e4b154915027b0bc00ee19cfc0bf75d01930504f2ce10a8b0";
        ...
        public void Fips186_3_L2048_N256_SHA384_1()
        {
            ...
            const string q = "8427529044d214c07574f7b359c2e01c23fd97701b328ac8c1385b81c5373895";
            ...
            const string r = "4fd8f25c059030027381d4167c3174b6be0088c15f0a573d7ebd05960f5a1eb2";
        ...
        public void Fips186_3_L2048_N256_SHA1_1()
        {
            ...
            const string q = "8000000000000000000000001bd62c65e8b87c89797f8f0cbfa55e4a6810e2c7";
            ...
            const string x = "5a42e77248358f06ae980a2c64f6a22bea2bf7b4fc0015745053c432b7132a67";
            ...
            const string r = "363e01c564f380a27d7d23b207af3f961d48fc0995487f60052775d724ab3d10";

            const string s = "4916d91b2927294e429d537c06dd2463d1845018cca2873e90a6c837b445fdde";
        ...
        public void Fips186_3_L2048_N256_SHA384_3()
        {
            ...
            const string r = "006b759fb718c34f1a6e518f834053b9f1825dd3eb8d719465c7bcc830322f4b";
        ...
        public void Fips186_3_L3072_N256_SHA256_1()
        {
            ...
            const string q = "876fa09e1dc62b236ce1c3155ba48b0ccfda29f3ac5a97f7ffa1bd87b68d2a4b";
            ...
            const string x = "3470832055dade94e14cd8777171d18e5d06f66aeff4c61471e4eba74ee56164";
            ...
            const string r = "53bae6c6f336e2eb311c1e92d95fc449a929444ef81ec4279660b200d59433de";
        ...
        public void Fips186_3_L3072_N256_SHA384_1()
        {
            ...
            const string x = "6d4c934391b7f6fb6e19e3141f8c0018ef5726118a11064358c7d35b37737377";
            ...
            const string r = "7695698a14755db4206e850b4f5f19c540b07d07e08aac591e20081646e6eedc";

            const string s = "3dae01154ecff7b19007a953f185f0663ef7f2537f0b15e04fb343c961f36de2";
        ...
        public void Fips186_3_L3072_N256_SHA512_1()
        {
            ...
            const string q = "bf65441c987b7737385eadec158dd01614da6f15386248e59f3cddbefc8e9dd1";
            ...
            const string x = "150b5c51ea6402276bc912322f0404f6d57ff7d32afcaa83b6dfde11abb48181";
            ...
            const string r = "a40a6c905654c55fc58e99c7d1a3feea2c5be64823d4086ce811f334cfdc448d";
        ...
        public void Fips186_3_L3072_N256_SHA512_12()
        {
            ...
            const string x = "bd3006cf5d3ac04a8a5128140df6025d9942d78544e9b27efe28b2ca1f79e313";
            ...
            const string r = "8d357b0b956fb90e8e0b9ff284cedc88a04d171a90c5997d8ee1e9bc4d0b35ff";
        ...
        )
        {
            ...
            using (DSA dsa = DSAFactory.Create())
            {
                ...
                Assert.True(
                    VerifyData(dsa, message, signature, hashAlgorithm),
                    "Public+Private Valid Signature"
                );

                signature[0] ^= 0xFF;
                Assert.False(
                    VerifyData(dsa, message, signature, hashAlgorithm),
                    "Public+Private Tampered Signature"
                );
            }
            ...
            using (DSA dsa = DSAFactory.Create())
            {
                ...
                Assert.True(
                    VerifyData(dsa, message, signature, hashAlgorithm),
                    "Public-Only Valid Signature"
                );

                signature[0] ^= 0xFF;
                Assert.False(
                    VerifyData(dsa, message, signature, hashAlgorithm),
                    "Public-Only Tampered Signature"
                );
            }
        }
    }
