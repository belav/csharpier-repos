...
namespace System.Security.Cryptography.Tests
{
    public static partial class SP800108HmacCounterKdfTests
    {
        ...
        {
            using SP800108HmacCounterKdf kdf = new SP800108HmacCounterKdf(
                s_kdk,
                HashAlgorithmName.SHA256
            );
        ...
        public static void DeriveKey_Allocating_String_InvalidUTF8()
        {
            ...
            Assert.Throws<EncoderFallbackException>(() => kdf.DeriveKey("\uD800", Context, 42));

            Assert.Throws<EncoderFallbackException>(() => kdf.DeriveKey(Label, "\uD800", 42));
        }
