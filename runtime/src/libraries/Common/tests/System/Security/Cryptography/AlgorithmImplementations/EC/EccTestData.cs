...
namespace System.Security.Cryptography.Tests
{
    ...
    internal static class EccTestData
    {
        ...
        internal static ECCurve GetNistP521ExplicitCurve()
        {
            ...
            return new ECCurve
            {
                ...
                G = new ECPoint
                {
                    ...
                    X = (
                        "00C6858E06B70404E9CD9E3ECB662395B4429C648139053FB521F828"
        ...
        internal static ECParameters GetNistP256ExplicitTestData()
        {
            ...
            p.Q = new ECPoint
            {
                X = ("96E476F7473CB17C5B38684DAAE437277AE1EFADCEB380FAD3D7072BE2FFE5F0")
                    .HexToByteArray(),
                Y = ("B54A94C2D6951F073BFC25E7B81AC2A4C41317904929D167C3DFC99122175A94")
                    .HexToByteArray()
            };
            ECCurve c = p.Curve;
            c.CurveType = ECCurve.ECCurveType.PrimeShortWeierstrass;
            c.A = ("FFFFFFFF00000001000000000000000000000000FFFFFFFFFFFFFFFFFFFFFFFC")
                .HexToByteArray();
            c.B = ("5AC635D8AA3A93E7B3EBBD55769886BC651D06B0CC53B0F63BCE3C3E27D2604B")
                .HexToByteArray();
            c.G = new ECPoint()
            {
                X = ("6B17D1F2E12C4247F8BCE6E563A440F277037D812DEB33A0F4A13945D898C296")
            ...
            c.Order = ("FFFFFFFF00000000FFFFFFFFFFFFFFFFBCE6FAADA7179E84F3B9CAC2FC632551")
                .HexToByteArray();
            c.Prime = ("FFFFFFFF00000001000000000000000000000000FFFFFFFFFFFFFFFFFFFFFFFF")
                .HexToByteArray();
            c.Seed = null;
            c.Hash = null;
            p.Curve = c;
            ...
            return new ECParameters
            {
                ...
                Q = new ECPoint
                {
                    X = (
                        ...
                        + "2C021183F10A0B23E34EC9BED2F59525CC45CFB0E6870FD61EA4FFEAFBD08CDF73"
                    )
                        .HexToByteArray(),
                    Y = (
                ...
                D = (
                    ...
                    + "956FA22DD3C8682751296C129D55F8F8C15483103D99899446E13285998B7E0F05"
                )
                    .HexToByteArray(),
            };
        }
        ...
        internal static ECParameters GetNistP256ReferenceKey()
        {
            ...
            return new ECParameters
            {
                ...
                Q =
                {
                    X = "8101ECE47464A6EAD70CF69A6E2BD3D88691A3262D22CBA4F7635EAFF26680A8"
                        .HexToByteArray(),
                    Y = "D8A12BA61D599235F67D9CB4D58F1783D3CA43E78F0A5ABAA624079936C0C3A9"
                        .HexToByteArray(),
                },
        ...
        internal static readonly ECParameters BrainpoolP160r1Key1 = new ECParameters
        {
        ...
        internal static readonly ECParameters Sect163k1Key1 = new ECParameters
        {
        ...
        internal static readonly ECParameters Sect163k1Key1Explicit = new ECParameters
        {
            Curve =
            {
        ...
        internal static readonly ECParameters Sect283k1Key1 = new ECParameters
        {
            Curve = ECCurve.CreateFromValue("1.3.132.0.16"),
            Q =
            {
                X = "0752770BD33E6A6EE2096CB6B120E7497B47B6C077A147CB57DAF693909D840716EEA7AA"
                    .HexToByteArray(),
                Y = "047DB9995C35603C5E6B2F8CDFF0EB71D37AE3431BA0849EBAB13A4C9003C7969F55CD90"
                    .HexToByteArray(),
            },
            D = "00B4F1AE1E7FDCD4B0E82053C08A908852B26231E6C01670FCC6C3EA2C5D3FED40EDF037"
                .HexToByteArray(),
        };
        ...
        internal static readonly ECParameters C2pnb163v1Key1Explicit = new ECParameters
        {
            Curve =
            {
                CurveType = ECCurve.ECCurveType.Characteristic2,
