    ...
    public abstract partial class ECDsaTests : ECDsaTestsBase
    {
        ...
        public void ValidateNistP256Sha3_256()
        {
            ...
            ECParameters parameters = new ECParameters
            {
                ...
                {
                    X =
                        "b7e08afdfe94bad3f1dc8c734798ba1c62b3a0ad1e9ea2a38201cd0889bc7a19".HexToByteArray(),
                    Y =
                        "3603f747959dbf7a4bb226e41928729063adc7ae43529e61b563bbc606cc5e09".HexToByteArray(),
                },
                D =
                    "c477f9f65c22cce20657faa5b2d1d8122336f851a508a1ed04e479c34985bf96".HexToByteArray(),
            };
        ...
        public void ValidateNistP384Sha3_384()
        {
            ...
            ECParameters parameters = new ECParameters
            {
                ...
                {
                    X = (
                        "3bf701bc9e9d36b4d5f1455343f09126f2564390f2b48736"
                        + "5071243c61e6471fb9d2ab74657b82f9086489d9ef0f5cb5"
                    ).HexToByteArray(),
                    Y = (
                        "d1a358eafbf952e68d533855ccbdaa6ff75b137a51014431"
                        + "99325583552a6295ffe5382d00cfcda30344a9b5b68db855"
                    ).HexToByteArray(),
                },
                D = (
                    "f92c02ed629e4b48c0584b1c6ce3a3e3b4faae4afc6acb04"
        ...
        public void ValidateNistP521Sha3_512()
        {
            ...
            ECParameters parameters = new ECParameters
            {
                ...
                {
                    X = (
                        "0098e91eef9a68452822309c52fab453f5f117c1da8ed796b255e9ab8f6410cca1"
                        + "6e59df403a6bdc6ca467a37056b1e54b3005d8ac030decfeb68df18b171885d5c4"
                    ).HexToByteArray(),
                    Y = (
                        "0164350c321aecfc1cca1ba4364c9b15656150b4b78d6a48d7d28e7f31985ef17b"
                        + "e8554376b72900712c4b83ad668327231526e313f5f092999a4632fd50d946bc2e"
                    ).HexToByteArray(),
                },
                D = (
                    "0100085f47b8e1b8b11b7eb33028c0b2888e304bfc98501955b45bba1478dc184e"
