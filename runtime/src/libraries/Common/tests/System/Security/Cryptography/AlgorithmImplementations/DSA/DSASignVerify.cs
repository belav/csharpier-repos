    ...
    public abstract partial class DSASignVerify
    {
        ...
        public void InvalidKeySize_DoesNotInvalidateKey()
        {
            using (DSA dsa = DSAFactory.Create())
            {
                ...
                Assert.True(
                    VerifyData(dsa, DSATestData.HelloBytes, signature, HashAlgorithmName.SHA1)
                );
            }
        }
        ...
        public void VerifyKnown_512()
        {
            byte[] signature = (
                ...
                +
                // s:
                "C37534CC7D9630339936C581690E832BD85C6C79"
            ).HexToByteArray();
        ...
        public void VerifyKnown_576()
        {
            byte[] signature = (
                ...
                +
                // s:
                "3F883FE96524D4CC596F67B64A3382E794C8D65B"
            ).HexToByteArray();
        ...
        public void VerifyKnown_2048_SHA256()
        {
            ...
            using (DSA dsa = DSAFactory.Create())
            {
                ...
                Assert.True(
                    VerifyData(dsa, DSATestData.HelloBytes, signature, HashAlgorithmName.SHA256)
                );
                Assert.False(
                    VerifyData(dsa, DSATestData.HelloBytes, signature, HashAlgorithmName.SHA384)
                );
                Assert.False(
                    VerifyData(dsa, DSATestData.HelloBytes, signature, HashAlgorithmName.SHA512)
                );
            }
        }
        ...
        public void Verify2048WithSha1()
        {
            ...
            using (DSA dsa = DSAFactory.Create())
            {
                ...
                Assert.True(
                    VerifyData(dsa, data, signature, HashAlgorithmName.SHA1),
