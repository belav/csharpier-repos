    ...
    internal class DSATestData
    {
        ...
        internal static DSAParameters Dsa512Parameters = new DSAParameters
        {
            P = (
                ...
                + "146363627D91925142DCDEE384BE0A1E04ED5BF5F471486F4D986D42A2E7DF95"
            ).HexToByteArray(),
            ...
            G = (
                ...
                + "F7BBECE19A4EFE2A6D9C229D360083CEA9F721F39B05BAF97052DEFC67A58A2B"
            ).HexToByteArray(),
            ...
            Y = (
                ...
                + "541A480AC80038AAC863827D6E3984061A25905C18BD2499A839663C3CA45605"
            ).HexToByteArray(),
        };
        ...
        internal static DSAParameters GetDSA2048Params()
        {
            ...
            p.Q =
                "C93AB229237282997F23541A399BBF75CECD30BE0BE9592C07043ED30221EACB".HexToByteArray();
            p.X =
                "B8BFF7B3328E6B6DBC8325A275A1193EF81C975ECF88B340C468B770FB5E2658".HexToByteArray();
            p.Y = (
        ...
        internal static DSAParameters Dsa2048DeficientXParameters = new DSAParameters
        {
            P = (
                ...
                + "678643F32ACC00525DB22F0020D92F9C2F4088B8D35A1E764DCD8B70C0B3D2EB"
            ).HexToByteArray(),
            ...
            G = (
                ...
                + "7374544BE3225CC4F8F3C501D5A2526F7BB64D656A7BBDFE7E72CB16D71E8A38"
            ).HexToByteArray(),
            ...
            Y = (
                ...
                + "CD73E4B1D56FAD1563C71DBC92F6725692DDD6A39141844D11FDA230B7BE6BAC"
            ).HexToByteArray(),
        ...
        internal static void GetDSA1024_186_2(
