...
namespace System.Net.Sockets
{
    internal static class SocketErrorPal
    {
        ...
        {
            Debug.Assert(
                s_nativeErrorToSocketError.Count == NativeErrorToSocketErrorCount,
            ...
            Debug.Assert(
                s_socketErrorToNativeError.Count == SocketErrorToNativeErrorCount,
        ...
        private static readonly Dictionary<Interop.Error, SocketError> s_nativeErrorToSocketError =
            new Dictionary<Interop.Error, SocketError>(NativeErrorToSocketErrorCount)
            {
        ...
        private static readonly Dictionary<SocketError, Interop.Error> s_socketErrorToNativeError =
            new Dictionary<SocketError, Interop.Error>(SocketErrorToNativeErrorCount)
            {
