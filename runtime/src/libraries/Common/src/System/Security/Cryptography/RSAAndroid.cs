    ...
    internal static partial class RSAImplementation
    {
        public sealed partial class RSAAndroid : RSA, IRuntimeAlgorithm
        {
            ...
            public override byte[] Encrypt(byte[] data, RSAEncryptionPadding padding)
            {
                ...
                bool encrypted = TryEncrypt(key, data, buf, rsaPadding, out int bytesWritten);
            ...
            )
            {
                ...
                int returnValue = Interop.AndroidCrypto.RsaPublicEncrypt(
                    data.Length,
                    data,
                    destination,
                    key,
            ...
            public override void ImportParameters(RSAParameters parameters)
            {
                ...
                if (
                    ...
                    || parameters.Modulus.AsSpan().IndexOfAnyExcept((byte)0) < 0
                )
                {
            ...
            )
            {
                ...
                try
                {
                    ...
                    {
                        return RsaPaddingProcessor.VerifyPss(
                            hashAlgorithm,
                            hash,
                            unwrapped,
                            KeySize
