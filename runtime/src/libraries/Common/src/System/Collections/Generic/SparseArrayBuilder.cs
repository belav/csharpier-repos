...
namespace System.Collections.Generic
{
    ...
    internal struct SparseArrayBuilder<T>
    {
        ...
        /// <summary>
        /// Reserves a region if the items' count can be predetermined; otherwise, adds the items to this
        // builder.
        /// </summary>
        ...
        /// <remarks>
        /// If the items' count is predetermined to be 0, no reservation is made and the return value is
        // <c>false</c>.
        /// The effect is the same as if the items were added, since adding an empty collection does
        // nothing.
        /// </remarks>
