...
namespace System.Diagnostics
{
    internal static class DiagnosticsHelper
    {
        ...
        /// </remarks>
        internal static bool CompareTags(
            List<KeyValuePair<string, object?>>? sortedTags,
        ...
        )
        {
            ...
            BitMapper bitMapper = new BitMapper(
                size <= 100 ? stackalloc ulong[size] : new ulong[size]
            );
