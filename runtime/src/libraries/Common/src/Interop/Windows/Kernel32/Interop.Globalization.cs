...
internal static partial class Interop
{
    internal static partial class Kernel32
    {
        ...
        internal static extern unsafe int LCIDToLocaleName(
            int locale,
            char* pLocaleName,
            int cchName,
            uint dwFlags
        ...
        internal static extern unsafe Interop.BOOL GetUserPreferredUILanguages(
            uint dwFlags,
        ...
        [DllImport("kernel32.dll", CharSet = CharSet.Unicode)]
        internal static extern unsafe int GetLocaleInfoEx(
            string lpLocaleName,
            uint LCType,
            void* lpLCData,
            int cchData
        ...
        [DllImport("kernel32.dll", CharSet = CharSet.Unicode)]
        internal static extern unsafe bool EnumSystemLocalesEx(
        ...
        [DllImport("kernel32.dll", CharSet = CharSet.Unicode)]
        internal static extern unsafe int GetGeoInfo(
            int location,
            int geoType,
            char* lpGeoData,
            int cchData,
        ...
        [DllImport("kernel32.dll", CharSet = CharSet.Unicode)]
        internal static extern unsafe bool EnumCalendarInfoExEx(
        ...
        [DllImport("kernel32.dll", CharSet = CharSet.Unicode)]
        internal static extern unsafe bool GetNLSVersionEx(
            int function,
            string localeName,
