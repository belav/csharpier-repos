...
partial internal static class Interop
{
    partial internal static class AppleCrypto
    {
        ...
        private static readonly SafeCreateHandle s_cfHttp2Str =
            CoreFoundation.CFStringCreateWithCString("h2");
        private static readonly SafeCreateHandle s_cfHttp11Str =
            CoreFoundation.CFStringCreateWithCString("http/1.1");
        ...
        private static readonly SafeCreateHandle s_cfAlpnHttp11Protocols =
            CoreFoundation.CFArrayCreate(s_cfAlpnHttp11Protocol, (UIntPtr)1);
        private static readonly SafeCreateHandle s_cfAlpnHttp2Protocols =
            CoreFoundation.CFArrayCreate(s_cfAlpnHttp2Protocol, (UIntPtr)1);
        private static readonly SafeCreateHandle s_cfAlpnHttp211Protocols =
            CoreFoundation.CFArrayCreate(s_cfAlpnHttp211Protocol, (UIntPtr)2);
        ...
        [LibraryImport(
            Interop.Libraries.AppleCryptoNative,
            EntryPoint = "AppleCryptoNative_SslCreateContext"
        )]
        partial internal static System.Net.SafeSslHandle SslCreateContext(int isServer);

        [LibraryImport(
            Interop.Libraries.AppleCryptoNative,
            EntryPoint = "AppleCryptoNative_SslSetConnection"
        )]
        partial internal static int SslSetConnection(SafeSslHandle sslHandle, IntPtr sslConnection);

        [LibraryImport(Interop.Libraries.AppleCryptoNative)]
        partial private static int AppleCryptoNative_SslSetMinProtocolVersion(
            SafeSslHandle sslHandle,
            SslProtocols minProtocolId
        );

        [LibraryImport(Interop.Libraries.AppleCryptoNative)]
        partial private static int AppleCryptoNative_SslSetMaxProtocolVersion(
            SafeSslHandle sslHandle,
            SslProtocols maxProtocolId
        );

        [LibraryImport(Interop.Libraries.AppleCryptoNative)]
        partial private static int AppleCryptoNative_SslCopyCertChain(
            SafeSslHandle sslHandle,
        ...
        [LibraryImport(Interop.Libraries.AppleCryptoNative)]
        partial private static int AppleCryptoNative_SslCopyCADistinguishedNames(
            SafeSslHandle sslHandle,
        ...
        [LibraryImport(Interop.Libraries.AppleCryptoNative)]
        partial private static int AppleCryptoNative_SslSetBreakOnServerAuth(
            SafeSslHandle sslHandle,
            int setBreak,
            out int pOSStatus
        );
        ...
        [LibraryImport(Interop.Libraries.AppleCryptoNative)]
        partial private static int AppleCryptoNative_SslSetBreakOnClientAuth(
            SafeSslHandle sslHandle,
            int setBreak,
            out int pOSStatus
        );
        ...
        [LibraryImport(Interop.Libraries.AppleCryptoNative)]
        partial private static int AppleCryptoNative_SslSetBreakOnClientHello(
            SafeSslHandle sslHandle,
            int setBreak,
            out int pOSStatus
        );
        ...
        [LibraryImport(Interop.Libraries.AppleCryptoNative)]
        partial private static int AppleCryptoNative_SslSetBreakOnCertRequested(
            SafeSslHandle sslHandle,
            int setBreak,
            out int pOSStatus
        );
        ...
        [LibraryImport(Interop.Libraries.AppleCryptoNative)]
        partial private static int AppleCryptoNative_SslSetCertificate(
            SafeSslHandle sslHandle,
        ...
        partial private static int AppleCryptoNative_SslSetTargetName(
            SafeSslHandle sslHandle,
            string targetName,
            int cbTargetName,
            out int osStatus
        ...
        [LibraryImport(
            Interop.Libraries.AppleCryptoNative,
            EntryPoint = "AppleCryptoNative_SSLSetALPNProtocols"
        )]
        partial internal static int SSLSetALPNProtocols(
            SafeSslHandle ctx,
            SafeCreateHandle cfProtocolsRefs,
            out int osStatus
        );

        [LibraryImport(
            Interop.Libraries.AppleCryptoNative,
            EntryPoint = "AppleCryptoNative_SSLSetALPNProtocol"
        )]
        partial internal static unsafe int SSLSetALPNProtocol(
            SafeSslHandle ctx,
            void* protocol,
            int length,
            out int osStatus
        ...
        [LibraryImport(
            Interop.Libraries.AppleCryptoNative,
            EntryPoint = "AppleCryptoNative_SslGetAlpnSelected"
        )]
        partial internal static int SslGetAlpnSelected(
            SafeSslHandle ssl,
            out SafeCFDataHandle protocol
        );

        [LibraryImport(
            Interop.Libraries.AppleCryptoNative,
            EntryPoint = "AppleCryptoNative_SslHandshake"
        )]
        partial internal static PAL_TlsHandshakeState SslHandshake(SafeSslHandle sslHandle);

        [LibraryImport(Interop.Libraries.AppleCryptoNative)]
        partial private static int AppleCryptoNative_SslSetAcceptClientCert(
            SafeSslHandle sslHandle
        );

        [LibraryImport(
            Interop.Libraries.AppleCryptoNative,
            EntryPoint = "AppleCryptoNative_SslSetIoCallbacks"
        )]
        partial internal static unsafe int SslSetIoCallbacks(
            SafeSslHandle sslHandle,
        ...
        [LibraryImport(
            Interop.Libraries.AppleCryptoNative,
            EntryPoint = "AppleCryptoNative_SslWrite"
        )]
        partial internal static unsafe PAL_TlsIo SslWrite(
            SafeSslHandle sslHandle,
            byte* writeFrom,
            int count,
        ...
        [LibraryImport(
            Interop.Libraries.AppleCryptoNative,
            EntryPoint = "AppleCryptoNative_SslRead"
        )]
        partial internal static unsafe PAL_TlsIo SslRead(
            SafeSslHandle sslHandle,
            byte* writeFrom,
            int count,
            out int bytesWritten
        ...
        [LibraryImport(Interop.Libraries.AppleCryptoNative)]
        partial private static int AppleCryptoNative_SslIsHostnameMatch(
        ...
        [LibraryImport(
            Interop.Libraries.AppleCryptoNative,
            EntryPoint = "AppleCryptoNative_SslShutdown"
        )]
        partial internal static int SslShutdown(SafeSslHandle sslHandle);

        [LibraryImport(
            Interop.Libraries.AppleCryptoNative,
            EntryPoint = "AppleCryptoNative_SslGetCipherSuite"
        )]
        partial internal static int SslGetCipherSuite(
            SafeSslHandle sslHandle,
            out TlsCipherSuite cipherSuite
        );

        [LibraryImport(
            Interop.Libraries.AppleCryptoNative,
            EntryPoint = "AppleCryptoNative_SslGetProtocolVersion"
        )]
        partial internal static int SslGetProtocolVersion(
            SafeSslHandle sslHandle,
            out SslProtocols protocol
        );

        [LibraryImport(
            Interop.Libraries.AppleCryptoNative,
            EntryPoint = "AppleCryptoNative_SslSetEnabledCipherSuites"
        )]
        partial internal static unsafe int SslSetEnabledCipherSuites(
            SafeSslHandle sslHandle,
            uint* cipherSuites,
            int numCipherSuites
        );
        ...
        [LibraryImport(
            Interop.Libraries.AppleCryptoNative,
            EntryPoint = "AppleCryptoNative_SslSetCertificateAuthorities"
        )]
        partial internal static int SslSetCertificateAuthorities(
            SafeSslHandle sslHandle,
            SafeCreateHandle certificateOrArray,
            int replaceExisting
        );

        internal static unsafe void SslSetCertificateAuthorities(
            SafeSslHandle sslHandle,
            Span<IntPtr> certificates,
            bool replaceExisting
        )
        {
            using (SafeCreateHandle cfCertRefs = CoreFoundation.CFArrayCreate(certificates))
            {
                int osStatus = SslSetCertificateAuthorities(
                    sslHandle,
                    cfCertRefs,
                    replaceExisting ? 1 : 0
                );
        ...
        internal static SafeX509ChainHandle SslCopyCertChain(SafeSslHandle sslHandle)
        {
            ...
            int osStatus;
            int result = AppleCryptoNative_SslCopyCertChain(
                sslHandle,
                out chainHandle,
                out osStatus
            );
        ...
        internal static SafeCFArrayHandle SslCopyCADistinguishedNames(SafeSslHandle sslHandle)
        {
            ...
            int osStatus;
            int result = AppleCryptoNative_SslCopyCADistinguishedNames(
                sslHandle,
                out dnArray,
                out osStatus
            );
        ...
        {
            int osStatus;
            int result = AppleCryptoNative_SslSetBreakOnServerAuth(
                sslHandle,
                setBreak ? 1 : 0,
                out osStatus
            );
        ...
        {
            int osStatus;
            int result = AppleCryptoNative_SslSetBreakOnClientAuth(
                sslHandle,
                setBreak ? 1 : 0,
                out osStatus
            );
        ...
        {
            int osStatus;
            int result = AppleCryptoNative_SslSetBreakOnClientHello(
                sslHandle,
                setBreak ? 1 : 0,
                out osStatus
            );
        ...
        {
            int osStatus;
            int result = AppleCryptoNative_SslSetBreakOnCertRequested(
                sslHandle,
                setBreak ? 1 : 0,
                out osStatus
            );
        ...
        {
            using (
                SafeCreateHandle cfCertRefs = CoreFoundation.CFArrayCreate(
                    certChainPtrs,
        ...
        internal static void SslSetTargetName(SafeSslHandle sslHandle, string targetName)
        {
            ...
            int result = AppleCryptoNative_SslSetTargetName(
                sslHandle,
                targetName,
                cbTargetName,
                out osStatus
        ...
        )
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    {
                        cfProtocolsArrayRef[i] = CoreFoundation.CFStringCreateWithCString(
                            protocols[i].ToString()
                        );
                        protocolsPtr[i] = cfProtocolsArrayRef[i].DangerousGetHandle();
                    }

                    cfProtocolsRefs = CoreFoundation.CFArrayCreate(
                        protocolsPtr,
                        (UIntPtr)protocols.Count
                    );
                }
        ...
        internal static unsafe int SslCtxSetAlpnProtocol(
            SafeSslHandle ctx,
        ...
        public static bool SslCheckHostnameMatch(
            SafeSslHandle handle,
            string hostName,
            DateTime notBefore,
            out int osStatus
                ...
                default:
                    if (NetEventSource.Log.IsEnabled())
                        NetEventSource.Error(
                            null,
                            $"AppleCryptoNative_SslIsHostnameMatch returned '{result}' for '{hostName}'"
                        );
