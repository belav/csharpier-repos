...
internal static partial class Interop
{
    internal static partial class SystemConfiguration
    {
        ...
        /// <param name="callout">The function to be called when a watched value in the dynamic store is
        // changed.
        ...
        /// <summary>
        /// Creates a dynamic store key that can be used to access the per-service network configuration
        // information.
        /// Follows the "Create Rule" where if you create it, you delete it.
        /// </summary>
        /// <param name="allocator">Should be IntPtr.Zero</param>
        /// <param name="domain">The desired domain, such as the requested configuration or the current
        // state.</param>
        ...
        /// <param name="keys">An array of keys to be monitored or IntPtr.Zero if no specific keys are to be
        // monitored.</param>
        /// <param name="patterns">An array of POSIX regex pattern strings used to match keys to be
        // monitored,
        /// or IntPtr.Zero if no key patterns are to be monitored.</param>
        /// <returns>Non-zero if the set of notification keys and patterns was successfully updated; zero
        // otherwise.</returns>
        [LibraryImport(Libraries.SystemConfigurationLibrary)]
