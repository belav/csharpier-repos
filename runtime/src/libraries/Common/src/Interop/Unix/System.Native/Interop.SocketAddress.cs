...
internal static partial class Interop
{
    internal static partial class Sys
    {
        ...
        internal static extern unsafe Error GetIPSocketAddressSizes(
        ...
        [SuppressGCTransition]
        internal static extern unsafe Error GetAddressFamily(
            byte* socketAddress,
        ...
        [SuppressGCTransition]
        internal static extern unsafe Error SetAddressFamily(
            byte* socketAddress,
            int socketAddressLen,
            int addressFamily
        );
        ...
        [SuppressGCTransition]
        internal static extern unsafe Error GetPort(
            byte* socketAddress,
            int socketAddressLen,
            ushort* port
        );
        ...
        [SuppressGCTransition]
        internal static extern unsafe Error SetPort(
            byte* socketAddress,
            int socketAddressLen,
            ushort port
        );
        ...
        [SuppressGCTransition]
        internal static extern unsafe Error GetIPv4Address(
            byte* socketAddress,
            int socketAddressLen,
            uint* address
        );
        ...
        [SuppressGCTransition]
        internal static extern unsafe Error SetIPv4Address(
            byte* socketAddress,
            int socketAddressLen,
            uint address
        );
        ...
        internal static extern unsafe Error GetIPv6Address(
            byte* socketAddress,
            int socketAddressLen,
            byte* address,
            int addressLen,
        ...
        internal static extern unsafe Error SetIPv6Address(
            byte* socketAddress,
            int socketAddressLen,
            byte* address,
            int addressLen,
