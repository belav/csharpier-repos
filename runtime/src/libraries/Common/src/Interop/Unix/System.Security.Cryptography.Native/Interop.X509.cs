...
partial internal static class Interop
{
    partial internal static class Crypto
    {
        ...
        partial internal static IntPtr GetX509NotBefore(SafeX509Handle x509);

        [LibraryImport(Libraries.CryptoNative, EntryPoint = "CryptoNative_GetX509NotAfter")]
        partial internal static IntPtr GetX509NotAfter(SafeX509Handle x509);

        [LibraryImport(
            Libraries.CryptoNative,
            EntryPoint = "CryptoNative_GetX509SignatureAlgorithm"
        )]
        partial internal static IntPtr GetX509SignatureAlgorithm(SafeX509Handle x509);

        [LibraryImport(
            Libraries.CryptoNative,
            EntryPoint = "CryptoNative_GetX509PublicKeyAlgorithm"
        )]
        partial internal static IntPtr GetX509PublicKeyAlgorithm(SafeX509Handle x509);

        [LibraryImport(Libraries.CryptoNative, EntryPoint = "CryptoNative_GetX509PublicKeyBytes")]
        partial internal static IntPtr GetX509PublicKeyBytes(SafeX509Handle x509);

        [LibraryImport(Libraries.CryptoNative, EntryPoint = "CryptoNative_GetX509EvpPublicKey")]
        partial internal static SafeEvpPKeyHandle GetX509EvpPublicKey(SafeX509Handle x509);

        [LibraryImport(Libraries.CryptoNative, EntryPoint = "CryptoNative_DecodeX509Crl")]
        partial internal static SafeX509CrlHandle DecodeX509Crl(byte[] buf, int len);

        [LibraryImport(Libraries.CryptoNative, EntryPoint = "CryptoNative_DecodeX509")]
        partial internal static SafeX509Handle DecodeX509(ref byte buf, int len);

        [LibraryImport(Libraries.CryptoNative, EntryPoint = "CryptoNative_DecodeX509")]
        partial internal static SafeX509Handle DecodeX509(IntPtr buf, int len);

        [LibraryImport(Libraries.CryptoNative, EntryPoint = "CryptoNative_GetX509DerSize")]
        partial internal static int GetX509DerSize(SafeX509Handle x);

        [LibraryImport(Libraries.CryptoNative, EntryPoint = "CryptoNative_EncodeX509")]
        partial internal static int EncodeX509(SafeX509Handle x, byte[] buf);

        [LibraryImport(Libraries.CryptoNative, EntryPoint = "CryptoNative_X509Destroy")]
        partial internal static void X509Destroy(IntPtr a);

        /// <summary>
        /// Clone the input certificate into a new object.
        /// </summary>
        [LibraryImport(Libraries.CryptoNative, EntryPoint = "CryptoNative_X509Duplicate")]
        partial internal static SafeX509Handle X509Duplicate(IntPtr handle);

        /// <summary>
        /// Clone the input certificate into a new object.
        /// </summary>
        [LibraryImport(Libraries.CryptoNative, EntryPoint = "CryptoNative_X509Duplicate")]
        partial internal static SafeX509Handle X509Duplicate(SafeX509Handle handle);
        ...
        partial internal static SafeX509Handle X509UpRef(IntPtr handle);
        ...
        /// </summary>
        [LibraryImport(Libraries.CryptoNative, EntryPoint = "CryptoNative_X509UpRef")]
        partial internal static SafeX509Handle X509UpRef(SafeX509Handle handle);

        [LibraryImport(Libraries.CryptoNative, EntryPoint = "CryptoNative_PemReadX509FromBio")]
        partial internal static SafeX509Handle PemReadX509FromBio(SafeBioHandle bio);

        [LibraryImport(Libraries.CryptoNative, EntryPoint = "CryptoNative_PemReadX509FromBioAux")]
        partial internal static SafeX509Handle PemReadX509FromBioAux(SafeBioHandle bio);

        [LibraryImport(Libraries.CryptoNative)]
        partial private static SafeSharedAsn1IntegerHandle CryptoNative_X509GetSerialNumber(
            SafeX509Handle x
        );
        ...
        internal static SafeSharedAsn1IntegerHandle X509GetSerialNumber(SafeX509Handle x)
        {
            ...
            return SafeInteriorHandle.OpenInteriorHandle(CryptoNative_X509GetSerialNumber, x);
        }

        [LibraryImport(Libraries.CryptoNative, EntryPoint = "CryptoNative_X509GetIssuerName")]
        partial internal static IntPtr X509GetIssuerName(SafeX509Handle x);

        [LibraryImport(Libraries.CryptoNative, EntryPoint = "CryptoNative_X509GetSubjectName")]
        partial internal static IntPtr X509GetSubjectName(SafeX509Handle x);

        [LibraryImport(Libraries.CryptoNative, EntryPoint = "CryptoNative_X509CheckPurpose")]
        [return: MarshalAs(UnmanagedType.Bool)]
        partial internal static bool X509CheckPurpose(SafeX509Handle x, int id, int ca);

        [LibraryImport(Libraries.CryptoNative, EntryPoint = "CryptoNative_X509IssuerNameHash")]
        partial internal static ulong X509IssuerNameHash(SafeX509Handle x);

        [LibraryImport(Libraries.CryptoNative)]
        partial private static SafeSharedAsn1OctetStringHandle CryptoNative_X509FindExtensionData(
            SafeX509Handle x,
            int extensionNid
        );
        ...
        partial internal static int X509GetExtCount(SafeX509Handle x);
        ...
        partial internal static IntPtr X509GetExt(SafeX509Handle x, int loc);
        ...
        partial internal static IntPtr X509ExtensionGetOid(IntPtr ex);

        // Returns a pointer already being tracked by a SafeX509Handle, shouldn't be SafeHandle tracked/freed.
        [LibraryImport(Libraries.CryptoNative, EntryPoint = "CryptoNative_X509ExtensionGetData")]
        partial internal static IntPtr X509ExtensionGetData(IntPtr ex);
        ...
        [return: MarshalAs(UnmanagedType.Bool)]
        partial internal static bool X509ExtensionGetCritical(IntPtr ex);

        [LibraryImport(Libraries.CryptoNative)]
        partial private static SafeX509StoreHandle CryptoNative_X509ChainNew(
        ...
        partial internal static void X509StoreDestroy(IntPtr v);

        [LibraryImport(Libraries.CryptoNative, EntryPoint = "CryptoNative_X509StoreAddCrl")]
        [return: MarshalAs(UnmanagedType.Bool)]
        partial internal static bool X509StoreAddCrl(SafeX509StoreHandle ctx, SafeX509CrlHandle x);

        [LibraryImport(Libraries.CryptoNative)]
        [return: MarshalAs(UnmanagedType.Bool)]
        partial private static bool CryptoNative_X509StoreSetRevocationFlag(
        ...
        [return: MarshalAs(UnmanagedType.Bool)]
        partial internal static bool X509StoreCtxInit(
        ...
        [LibraryImport(Libraries.CryptoNative)]
        partial private static int CryptoNative_X509VerifyCert(SafeX509StoreCtxHandle ctx);
        ...
        [LibraryImport(Libraries.CryptoNative)]
        partial internal static int CryptoNative_X509StoreCtxGetError(SafeX509StoreCtxHandle ctx);
        ...
        [LibraryImport(Libraries.CryptoNative)]
        partial private static int CryptoNative_X509StoreCtxReset(SafeX509StoreCtxHandle ctx);
        ...
        [LibraryImport(Libraries.CryptoNative)]
        partial private static int CryptoNative_X509StoreCtxRebuildChain(
            SafeX509StoreCtxHandle ctx
        );
        ...
        partial internal static int X509StoreCtxGetErrorDepth(SafeX509StoreCtxHandle ctx);

        [LibraryImport(Libraries.CryptoNative)]
        partial private static unsafe int CryptoNative_X509StoreCtxSetVerifyCallback(
            SafeX509StoreCtxHandle ctx,
            delegate* unmanaged<int, IntPtr, int> callback,
            void* appData
        );

        internal static unsafe void X509StoreCtxSetVerifyCallback(
            SafeX509StoreCtxHandle ctx,
            delegate* unmanaged<int, IntPtr, int> callback,
            void* appData
        )
        ...
        partial internal static unsafe void* X509StoreCtxGetAppData(SafeX509StoreCtxHandle ctx);
        ...
        [LibraryImport(Libraries.CryptoNative)]
        partial private static IntPtr CryptoNative_X509VerifyCertErrorString(int n);

        [LibraryImport(Libraries.CryptoNative, EntryPoint = "CryptoNative_X509CrlDestroy")]
        partial internal static void X509CrlDestroy(IntPtr a);

        [LibraryImport(Libraries.CryptoNative, EntryPoint = "CryptoNative_PemWriteBioX509Crl")]
        partial internal static int PemWriteBioX509Crl(SafeBioHandle bio, SafeX509CrlHandle crl);

        [LibraryImport(Libraries.CryptoNative, EntryPoint = "CryptoNative_PemReadBioX509Crl")]
        partial internal static SafeX509CrlHandle PemReadBioX509Crl(SafeBioHandle bio);

        [LibraryImport(
            Libraries.CryptoNative,
            EntryPoint = "CryptoNative_GetX509SubjectPublicKeyInfoDerSize"
        )]
        partial internal static int GetX509SubjectPublicKeyInfoDerSize(SafeX509Handle x509);

        [LibraryImport(
            Libraries.CryptoNative,
            EntryPoint = "CryptoNative_EncodeX509SubjectPublicKeyInfo"
        )]
        partial internal static int EncodeX509SubjectPublicKeyInfo(SafeX509Handle x509, byte[] buf);
