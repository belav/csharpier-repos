...
internal static partial class Interop
{
    internal static partial class Crypto
    {
        ...
        private static unsafe partial int EvpDigestFinalXOF(
            SafeEvpMdCtxHandle ctx,
            Span<byte> md,
            uint len
        );
        ...
        private static unsafe partial int EvpDigestCurrentXOF(
            SafeEvpMdCtxHandle ctx,
            Span<byte> md,
            uint len
        );
        ...
        private static unsafe partial int EvpDigestXOFOneShot(
            IntPtr type,
