...
internal delegate int LDAP_SASL_INTERACT_PROC(
    IntPtr ld,
    uint flags,
    IntPtr defaults,
    IntPtr interact
...
internal static partial class Interop
{
    ...
    internal static partial class Ldap
    {
        ...
        public static extern int ldap_unbind_ext_s(
            IntPtr ld,
            ref IntPtr serverctrls,
            ref IntPtr clientctrls
        );

        [DllImport(Libraries.OpenLdap, EntryPoint = "ldap_get_dn", CharSet = CharSet.Ansi)]
        public static extern IntPtr ldap_get_dn(
            [In] ConnectionHandle ldapHandle,
            [In] IntPtr result
        );

        [DllImport(Libraries.OpenLdap, EntryPoint = "ldap_get_option", CharSet = CharSet.Ansi)]
        public static extern int ldap_get_option_bool(
            [In] ConnectionHandle ldapHandle,
            [In] LdapOption option,
            ref bool outValue
        );

        [DllImport(Libraries.OpenLdap, EntryPoint = "ldap_get_option", CharSet = CharSet.Ansi)]
        public static extern int ldap_get_option_secInfo(
            [In] ConnectionHandle ldapHandle,
            [In] LdapOption option,
            [In, Out] SecurityPackageContextConnectionInformation outValue
        );

        [DllImport(Libraries.OpenLdap, EntryPoint = "ldap_get_option", CharSet = CharSet.Ansi)]
        public static extern int ldap_get_option_sechandle(
            [In] ConnectionHandle ldapHandle,
            [In] LdapOption option,
        ...
        [DllImport(Libraries.OpenLdap, EntryPoint = "ldap_get_option", CharSet = CharSet.Ansi)]
        private static extern int ldap_get_option_int(
            [In] IntPtr ldapHandle,
            [In] LdapOption option,
            ref int outValue
        );

        [DllImport(Libraries.OpenLdap, EntryPoint = "ldap_get_option", CharSet = CharSet.Ansi)]
        public static extern int ldap_get_option_int(
            [In] ConnectionHandle ldapHandle,
            [In] LdapOption option,
            ref int outValue
        );
        ...
        [DllImport(Libraries.OpenLdap, EntryPoint = "ldap_get_option", CharSet = CharSet.Ansi)]
        public static extern int ldap_get_option_ptr(
            [In] ConnectionHandle ldapHandle,
            [In] LdapOption option,
            ref IntPtr outValue
        );
        ...
        public static extern int ldap_search(
            [In] ConnectionHandle ldapHandle,
            string dn,
            int scope,
            string filter,
        ...
        [DllImport(
            Libraries.OpenLdap,
            EntryPoint = "ldap_set_option",
            CharSet = CharSet.Ansi,
            SetLastError = true
        )]
        public static extern int ldap_set_option_bool(
            [In] ConnectionHandle ld,
            [In] LdapOption option,
            bool value
        );

        [DllImport(Libraries.OpenLdap, EntryPoint = "ldap_set_option", CharSet = CharSet.Ansi)]
        public static extern int ldap_set_option_clientcert(
            [In] ConnectionHandle ldapHandle,
            [In] LdapOption option,
        ...
        [DllImport(Libraries.OpenLdap, EntryPoint = "ldap_set_option", CharSet = CharSet.Ansi)]
        public static extern int ldap_set_option_servercert(
            [In] ConnectionHandle ldapHandle,
            [In] LdapOption option,
        ...
        public static extern int ldap_set_option_int(
            [In] ConnectionHandle ld,
            [In] LdapOption option,
            ref int inValue
        );
        ...
        [DllImport(Libraries.OpenLdap, EntryPoint = "ldap_set_option", CharSet = CharSet.Ansi)]
        public static extern int ldap_set_option_string(
            [In] ConnectionHandle ldapHandle,
            [In] LdapOption option,
            string inValue
        );
        ...
        [DllImport(Libraries.OpenLdap, EntryPoint = "ldap_set_option", CharSet = CharSet.Ansi)]
        public static extern int ldap_set_option_referral(
            [In] ConnectionHandle ldapHandle,
            [In] LdapOption option,
        ...
        public static extern int ldap_start_tls(
        ...
        [DllImport(Libraries.OpenLdap, EntryPoint = "ldap_parse_result", CharSet = CharSet.Ansi)]
        public static extern int ldap_parse_result_referral(
            [In] ConnectionHandle ldapHandle,
            [In] IntPtr result,
            IntPtr serverError,
            IntPtr dn,
        ...
        [DllImport(
            Libraries.OpenLdap,
            EntryPoint = "ldap_parse_extended_result",
            CharSet = CharSet.Ansi
        )]
        public static extern int ldap_parse_extended_result(
            [In] ConnectionHandle ldapHandle,
            [In] IntPtr result,
            ref IntPtr oid,
            ref IntPtr data,
        ...
        public static extern int ldap_parse_reference(
            [In] ConnectionHandle ldapHandle,
            [In] IntPtr result,
        ...
        [DllImport(
            Libraries.OpenLdap,
            EntryPoint = "ldap_sasl_interactive_bind_s",
            CharSet = CharSet.Ansi
        )]
        internal static extern int ldap_sasl_interactive_bind(
            [In] ConnectionHandle ld,
            string dn,
            string mechanism,
            IntPtr serverctrls,
            IntPtr clientctrls,
            uint flags,
            [MarshalAs(UnmanagedType.FunctionPtr)] LDAP_SASL_INTERACT_PROC proc,
            IntPtr defaults
        );
        ...
        [DllImport(
            Libraries.OpenLdap,
            EntryPoint = "ldap_extended_operation",
            CharSet = CharSet.Ansi
        )]
        public static extern int ldap_extended_operation(
            [In] ConnectionHandle ldapHandle,
            string oid,
            berval data,
            IntPtr servercontrol,
        ...
        public static extern IntPtr ldap_first_reference(
            [In] ConnectionHandle ldapHandle,
            [In] IntPtr result
        );
        ...
        [DllImport(
            Libraries.OpenLdap,
            EntryPoint = "ldap_create_sort_control",
            CharSet = CharSet.Ansi
        )]
        public static extern int ldap_create_sort_control(
        ...
        public static extern IntPtr ldap_next_reference(
            [In] ConnectionHandle ldapHandle,
            [In] IntPtr result
        );
        ...
        public static extern int ldap_delete_ext(
            [In] ConnectionHandle ldapHandle,
            string dn,
            IntPtr servercontrol,
            IntPtr clientcontrol,
        ...
        public static extern int ldap_compare(
            [In] ConnectionHandle ldapHandle,
            string dn,
