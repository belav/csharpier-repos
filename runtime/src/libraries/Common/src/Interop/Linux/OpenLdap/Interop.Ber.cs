...
internal static partial class Interop
{
    internal static partial class Ldap
    {
        ...
        private static extern int ber_put_ostring(
            SafeBerHandle berElement,
            HGlobalMemHandle value,
            nuint length,
            nuint tag
        ...
        private static extern int ber_put_string(
            SafeBerHandle berElement,
            HGlobalMemHandle value,
            nuint tag
        );
        ...
        private static extern int ber_put_bitstring(
            SafeBerHandle berElement,
            HGlobalMemHandle value,
            nuint length,
            nuint tag
        ...
        private static extern int ber_get_stringb(
            SafeBerHandle berElement,
            ref IntPtr value,
            ref nuint bitLength
        );
