...
internal static partial class Interop
{
    internal static partial class Globalization
    {
        [LibraryImport(
            ...
            EntryPoint = "GlobalizationNative_GetDefaultLocaleNameNative",
        ...
        [LibraryImport(
            Libraries.GlobalizationNative,
            EntryPoint = "GlobalizationNative_GetLocaleInfoIntNative",
            StringMarshalling = StringMarshalling.Utf8
        )]
        ...
        [LibraryImport(
            Libraries.GlobalizationNative,
            EntryPoint = "GlobalizationNative_GetLocaleInfoPrimaryGroupingSizeNative",
            StringMarshalling = StringMarshalling.Utf8
        )]
        ...
        [LibraryImport(
            Libraries.GlobalizationNative,
            EntryPoint = "GlobalizationNative_GetLocaleInfoSecondaryGroupingSizeNative",
            StringMarshalling = StringMarshalling.Utf8
        )]
        ...
        [LibraryImport(
            Libraries.GlobalizationNative,
            EntryPoint = "GlobalizationNative_GetLocaleNameNative",
            StringMarshalling = StringMarshalling.Utf8
        )]
        ...
        [LibraryImport(
            Libraries.GlobalizationNative,
            EntryPoint = "GlobalizationNative_GetLocalesNative",
        ...
        [LibraryImport(
            Libraries.GlobalizationNative,
            EntryPoint = "GlobalizationNative_GetLocaleTimeFormatNative",
            StringMarshalling = StringMarshalling.Utf8
        )]
        internal static partial string GetLocaleTimeFormatNative(
            string localeName,
        ...
        [LibraryImport(
            Libraries.GlobalizationNative,
            EntryPoint = "GlobalizationNative_IsPredefinedLocaleNative",
            StringMarshalling = StringMarshalling.Utf8
        )]
