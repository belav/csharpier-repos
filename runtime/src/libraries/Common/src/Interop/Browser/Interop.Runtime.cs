...
internal static partial class Interop
{
    internal static partial class Runtime
    {
        ...
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern void InvokeJSWithArgsRef(
            IntPtr jsHandle,
            in string method,
            in object?[] parms,
        ...
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern void SetObjectPropertyRef(
            IntPtr jsHandle,
            in string propertyName,
            in object? value,
        ...
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern void GetByIndexRef(
            IntPtr jsHandle,
            int index,
            out int exceptionalResult,
            out object result
        ...
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern void SetByIndexRef(
            IntPtr jsHandle,
            int index,
            in object? value,
            out int exceptionalResult,
        ...
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern void GetGlobalObjectRef(
            in string? globalName,
            out int exceptionalResult,
            out object result
        );

        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern void TypedArrayToArrayRef(
            IntPtr jsHandle,
            out int exceptionalResult,
            out object result
        );
        ...
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern void CreateCSOwnedObjectRef(
            in string className,
            in object[] parms,
            out int exceptionalResult,
            out object result
        ...
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern void TypedArrayFromRef(
            int arrayPtr,
            int begin,
            int end,
            int bytesPerElement,
        ...
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern void TypedArrayCopyFromRef(
            IntPtr jsHandle,
            int arrayPtr,
            int begin,
            int end,
        ...
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern void WebSocketReceive(
            IntPtr webSocketJSHandle,
            IntPtr bufferPtr,
            int offset,
            int length,
        ...
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern void WebSocketOpenRef(
            in string uri,
            in object[]? subProtocols,
            in Delegate onClosed,
        ...
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern void WebSocketAbort(
            IntPtr webSocketJSHandle,
            out int exceptionalResult,
            out string result
        );
        ...
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern void WebSocketCloseRef(
            IntPtr webSocketJSHandle,
            int code,
            in string? reason,
        ...
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern void CancelPromiseRef(
            IntPtr promiseJSHandle,
            out int exceptionalResult,
            out string result
        );
