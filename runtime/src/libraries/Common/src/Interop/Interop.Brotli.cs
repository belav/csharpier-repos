...
internal static partial class Interop
{
    internal static class Brotli
    {
        ...
        internal static extern SafeBrotliDecoderHandle BrotliDecoderCreateInstance(
            IntPtr allocFunc,
            IntPtr freeFunc,
            IntPtr opaque
        );
        ...
        [DllImport(Libraries.CompressionNative)]
        internal static extern unsafe bool BrotliDecoderDecompress(
            nuint availableInput,
            byte* inBytes,
            ref nuint availableOutput,
            byte* outBytes
        );
        ...
        [DllImport(Libraries.CompressionNative)]
        internal static extern SafeBrotliEncoderHandle BrotliEncoderCreateInstance(
            IntPtr allocFunc,
            IntPtr freeFunc,
            IntPtr opaque
        );
        ...
        [DllImport(Libraries.CompressionNative)]
        internal static extern unsafe bool BrotliEncoderCompress(
            int quality,
            int window,
            int v,
            nuint availableInput,
