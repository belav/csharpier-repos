...
namespace System.IO.Ports
{
    internal sealed partial class SerialStream : Stream
    {
        ...
        internal int BytesToWrite
        {
            get
            {
                return Interop.Termios
                    .TermiosGetAvailableBytes(_handle, Interop.Termios.Queue.SendQueue);
            }
        }
        ...
        internal int BytesToRead
        {
            ...
            {
                return Interop.Termios
                    .TermiosGetAvailableBytes(_handle, Interop.Termios.Queue.ReceiveQueue);
            }
        }
