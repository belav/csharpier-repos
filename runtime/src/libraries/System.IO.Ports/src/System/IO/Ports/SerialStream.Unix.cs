...
namespace System.IO.Ports
{
    internal sealed partial class SerialStream : Stream
    {
        ...
        private ConcurrentQueue<SerialStreamIORequest> _readQueue =
            new ConcurrentQueue<SerialStreamIORequest>();
        private ConcurrentQueue<SerialStreamIORequest> _writeQueue =
            new ConcurrentQueue<SerialStreamIORequest>();
        ...
        private abstract class SerialStreamIORequest : TaskCompletionSource<int>
        {
                ...
                : base(TaskCreationOptions.RunContinuationsAsynchronously)
            {
                ...
                _cancellationTokenRegistration = ct.Register(
                    s => ((TaskCompletionSource<int>)s).TrySetCanceled(),
                    this
                );
            }
        ...
        private sealed class SerialStreamReadRequest : SerialStreamIORequest
        {
            ...
            public SerialStreamReadRequest(CancellationToken ct, Memory<byte> buffer) : base(ct)
            {
                Buffer = buffer;
            }
        }
