...
namespace System.Collections.Concurrent.Tests
{
    ...
    public class BlockingCollectionTests
    {
        ...
        [InlineData(10, 10, 9)]
        [OuterLoop]
        public static void TestAddTake_Longrunning(
            int numOfAdds,
            int numOfTakes,
            int boundedCapacity
        )
        ...
        public static void TestConcurrentAddTake(int numOfThreads, int numOfElementsPerThread)
        {
            ...
            VerifyElementsAreMembersOfSequence(
                ...
                0,
                (numOfThreads / 2 * numOfElementsPerThread) - 1
            );
        }
        ...
        public static void Test4_Dispose()
        {
            ...
            Assert.Throws<ObjectDisposedException>(
                () =>
                    BlockingCollection<int>
                        .TryAddToAny(blockingCollections, value++, new TimeSpan(3))
            );
            ...
            Assert.Throws<ObjectDisposedException>(
                () =>
                    BlockingCollection<int>
                        .TryTakeFromAny(blockingCollections, out item, new TimeSpan(4))
            );
        ...
        {
            ConcurrentStackCollection<int> concurrentCollection =
            ...
            {
                Assert.Equal<int>(
                    resultOfEnumOfBlockingCollection[i],
                    resultOfEnumOfConcurrentCollection[i]
                );
            }
        }
        ...
        public static void Test6_GetConsumingEnumerable()
        {
            ...
            for (int i = 0; i < resultOfEnumOfBlockingCollection.Count; ++i)
            {
                Assert.Equal<int>(
                    resultOfEnumOfBlockingCollection[i],
                    resultOfEnumOfBlockingCollectionMirror[i]
                );
            }
        }
        ...
        {
            ConcurrentStackCollection<byte> concurrentCollection =
                new ConcurrentStackCollection<byte>();
        ...
        public static void Test12_IsCompleted_AddingIsCompleted()
        {
            ...
            Assert.False(
                blockingCollection.IsAddingCompleted,
        ...
        [OuterLoop]
        public static void TestAddAnyTakeAny_Longrunning(
            int numOfAdds,
            int numOfTakes,
            int numOfBlockingCollections,
            int indexOfBlockingCollectionUnderTest,
                    ...
                    threads[i] = Task.Run(
                        delegate()
                        {
                            ...
                            for (int j = 0; j < numOfElementsPerThread; ++j)
                            {
                                ...
                                Assert.InRange(
                                    BlockingCollection<int>
                                        .TakeFromAny(blockingCollections, out item),
                                    0,
                                    int.MaxValue
                                );
        ...
        public static void Test19_AddAnyExceptions()
        {
            ...
            Assert.Throws<ArgumentOutOfRangeException>(
                () =>
                    BlockingCollection<int>
                        .TryAddToAny(blockingCollections, 0, new TimeSpan(0, 0, 0, 1, 2147483647))
            );
            Assert.Throws<ArgumentOutOfRangeException>(
            ...
            AssertExtensions.Throws<ArgumentException>(
                ...
                () =>
                    BlockingCollection<int>
                        .TryAddToAny(new BlockingCollection<int>[NUM_OF_COLLECTIONS], 0)
            );
            AssertExtensions.Throws<ArgumentException>(
                "collections",
            ...
            Assert.Throws<InvalidOperationException>(
                () =>
                    BlockingCollection<int>
                        .AddToAny(new BlockingCollection<int>[] { collection }, 1)
            );
        }
        ...
        public static void Test20_TakeAnyExceptions()
        {
            ...
            AssertExtensions.Throws<ArgumentException>(
                ...
                () =>
                    BlockingCollection<int>
                        .TryTakeFromAny(new BlockingCollection<int>[NUM_OF_COLLECTIONS], out item)
            );
            AssertExtensions.Throws<ArgumentException>(
                "collections",
                () =>
        ...
        public static void Test_LargeSize()
        {
            ...
            Assert.Throws<ArgumentOutOfRangeException>(
                () =>
                    BlockingCollection<int>
                        .TryAddToAny(ConstructBlockingCollectionArray<int>(64), 1)
            );
        }
            ...
            Thread t = new Thread(
                () =>
                {
                    Assert.Equal(
                        0,
                        BlockingCollection<int>
                            .TryAddToAny(ConstructBlockingCollectionArray<int>(62), 1)
                    );
                    Assert.Throws<ArgumentOutOfRangeException>(
                        () =>
                            BlockingCollection<int>
                                .TryAddToAny(ConstructBlockingCollectionArray<int>(63), 1)
                    );
                }
            );
        ...
        )
        {
            ...
            for (int i = 0; i < numOfAdds; ++i)
            {
                ...
                {
                    int indexOfCollectionThatAcceptedTheOperation = BlockingCollection<int>
                        .TryAddToAny(blockingCollections, numberToAdd);
                    if (
            ...
            for (int i = 0; i < numOfTakes; ++i)
            {
                ...
                {
                    int indexOfCollectionThatAcceptedTheOperation = BlockingCollection<int>
                        .TryTakeFromAny(blockingCollections, out itemFromBlockingCollection);
                    if (
                        indexOfCollectionThatAcceptedTheOperation
                        == indexOfBlockingCollectionUnderTest
                    )
            ...
            int result;
            int index = BlockingCollection<int>
                .TryTakeFromAny(collectionsArray, out result, Timeout.Infinite);
        ...
        /// <returns></returns>
        private static void VerifyElementsAreMembersOfSequence(
