...
namespace System.Threading.RateLimiting
{
    ...
    public sealed class ConcurrencyLimiterOptions
    {
        ...
        /// Must be set to a value > 0 by the time these options are passed to the constructor of <see
        // cref="ConcurrencyLimiter"/>.
        /// </summary>
        public int PermitLimit { get; set; }

        /// <summary>
        /// Determines the behaviour of <see cref="RateLimiter.AcquireAsync"/> when not enough resources can
        // be leased.
        /// </summary>
        /// <value>
