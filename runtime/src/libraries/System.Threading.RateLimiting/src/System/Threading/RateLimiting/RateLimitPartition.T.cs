...
{
    /// <summary>
    /// Type returned by <see cref="RateLimitPartition.Get"/> methods to be used by <see
    // cref="PartitionedRateLimiter.Create"/> to know what partitions are configured.
    /// </summary>
    /// <typeparam name="TKey">The type to distinguish partitions with.</typeparam>
    public struct RateLimitPartition<TKey>
    {
        /// <summary>
        /// Constructs the <see cref="RateLimitPartition{TKey}"/> for use in <see
        // cref="PartitionedRateLimiter.Create"/>.
        /// </summary>
        /// <param name="partitionKey">The specific key for this partition.</param>
        /// <param name="factory">The function called when a rate limiter for the given <paramref
        // name="partitionKey"/> is needed.</param>
