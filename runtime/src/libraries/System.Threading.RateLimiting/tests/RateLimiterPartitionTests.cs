...
namespace System.Threading.RateLimiting.Tests
{
    public class RateLimiterPartitionTests
    {
        ...
        public void Create_Concurrency()
        {
            ...
            var factoryProperty = typeof(RateLimitPartition<int>).GetField(
                "Factory",
        ...
        public void Create_AnyLimiter()
        {
            var partition = RateLimitPartition.Create(
                ...
                key =>
                    new ConcurrencyLimiter(
                        new ConcurrencyLimiterOptions(1, QueueProcessingOrder.NewestFirst, 10)
                    )
            );
            ...
            var partition2 = RateLimitPartition.Create(
                1,
                key =>
