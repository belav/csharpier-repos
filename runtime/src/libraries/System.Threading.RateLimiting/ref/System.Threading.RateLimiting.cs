...
namespace System.Threading.RateLimiting
{
    public sealed partial class ConcurrencyLimiter : System.Threading.RateLimiting.RateLimiter
    {
        ...
        protected override System.Threading.RateLimiting.RateLimitLease AcquireCore(int permitCount)
        {
            throw null;
        }
        ...
        protected override System.Threading.Tasks.ValueTask<System.Threading.RateLimiting.RateLimitLease> WaitAsyncCore(
            int permitCount,
    ...
    public sealed partial class ConcurrencyLimiterOptions
    {
        public ConcurrencyLimiterOptions(
            int permitLimit,
            System.Threading.RateLimiting.QueueProcessingOrder queueProcessingOrder,
            int queueLimit
        ) { }
            ...
            System.IDisposable
    {
        ...
        protected abstract System.Threading.RateLimiting.RateLimitLease AcquireCore(
            TResource resourceID,
            int permitCount
        );
        ...
        public System.Threading.Tasks.ValueTask<System.Threading.RateLimiting.RateLimitLease> WaitAsync(
            TResource resourceID,
            int permitCount = 1,
            System.Threading.CancellationToken cancellationToken =
                default(System.Threading.CancellationToken)
        ...
        protected abstract System.Threading.Tasks.ValueTask<System.Threading.RateLimiting.RateLimitLease> WaitAsyncCore(
            TResource resourceID,
            int permitCount,
            System.Threading.CancellationToken cancellationToken
        );
    ...
    public abstract partial class RateLimiter : System.IAsyncDisposable, System.IDisposable
    {
        ...
        public System.Threading.RateLimiting.RateLimitLease Acquire(int permitCount = 1)
        {
            throw null;
        }
    ...
    {
        public static System.Threading.RateLimiting.RateLimitPartition<TKey> CreateConcurrencyLimiter<TKey>(
            TKey partitionKey,
        ...
        public static System.Threading.RateLimiting.RateLimitPartition<TKey> CreateNoLimiter<TKey>(
            TKey partitionKey
        )
        {
            throw null;
        ...
        public static System.Threading.RateLimiting.RateLimitPartition<TKey> CreateTokenBucketLimiter<TKey>(
            TKey partitionKey,
        ...
        public static System.Threading.RateLimiting.RateLimitPartition<TKey> Create<TKey>(
            TKey partitionKey,
        ...
        : System.Threading.RateLimiting.ReplenishingRateLimiter
    {
        ...
        protected override System.Threading.RateLimiting.RateLimitLease AcquireCore(int tokenCount)
        {
            throw null;
        }
    ...
    public sealed partial class TokenBucketRateLimiterOptions
    {
        public TokenBucketRateLimiterOptions(
            ...
            System.Threading.RateLimiting.QueueProcessingOrder queueProcessingOrder,
            int queueLimit,
            System.TimeSpan replenishmentPeriod,
            int tokensPerPeriod,
        ...
        : System.Threading.RateLimiting.ReplenishingRateLimiter
    {
        ...
        protected override System.Threading.RateLimiting.RateLimitLease AcquireCore(
            int requestCount
        )
        {
            throw null;
