...
namespace Microsoft.Extensions.Configuration
{
    ...
    public static class UserSecretsConfigurationExtensions
    {
        ...
        /// </para>
        /// <para>
        /// A user secrets ID is unique value used to store and identify a collection of secret
        // configuration values.
        /// </para>
        /// </summary>
        /// <param name="configuration">The configuration builder.</param>
        /// <typeparam name="T">The type from the assembly to search for an instance of <see
        // cref="UserSecretsIdAttribute"/>.</typeparam>
        /// <exception cref="InvalidOperationException">Thrown when the assembly containing <typeparamref
        // name="T"/> does not have <see cref="UserSecretsIdAttribute"/>.</exception>
        ...
        /// </summary>
        /// <param name="configuration">The configuration builder.</param>
        /// <param name="optional">Whether loading secrets is optional. When false, this method may
        // throw.</param>
        /// <exception cref="InvalidOperationException">Thrown when <paramref name="optional"/> is false and
        // the assembly containing <typeparamref name="T"/> does not have a valid <see
        // cref="UserSecretsIdAttribute"/>.</exception>
        /// <typeparam name="T">The type from the assembly to search for an instance of <see
        // cref="UserSecretsIdAttribute"/>.</typeparam>
        /// <returns>The configuration builder.</returns>
        public static IConfigurationBuilder AddUserSecrets<T>(
        ...
        /// <summary>
        /// <para>
        /// Adds the user secrets configuration source. This searches <paramref name="assembly"/> for an
        // instance
        ...
        /// <exception cref="InvalidOperationException">Thrown when <paramref name="assembly"/> does not
        // have a valid <see cref="UserSecretsIdAttribute"/></exception>
        /// <returns>The configuration builder.</returns>
        ...
        // throw.</param>
        /// <exception cref="InvalidOperationException">Thrown when <paramref name="optional"/> is false and
        // <paramref name="assembly"/> does not have a valid <see cref="UserSecretsIdAttribute"/>.</exception>
        /// <returns>The configuration builder.</returns>
        public static IConfigurationBuilder AddUserSecrets(
            this IConfigurationBuilder configuration,
            Assembly assembly,
