...
namespace System.Net
{
    ...
    public sealed class Cookie
    {
        ...
        private static readonly SearchValues<char> s_domainChars = SearchValues.Create(
...
#pragma warning restore 0649
        ...
        private static bool DomainCharsTest(string name) =>
            !string.IsNullOrEmpty(name) && !name.AsSpan().ContainsAnyExcept(s_domainChars);
