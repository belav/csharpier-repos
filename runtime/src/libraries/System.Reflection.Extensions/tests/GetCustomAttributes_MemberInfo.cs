...
namespace System.Reflection.Tests
{
    public class GetCustomAttributes_MemberInfo
    {
        ...
        public void IsDefined_Inherit()
        {
            Assert.False(
                CustomAttributeExtensions.IsDefined(
                    ...
                    typeof(MyAttribute_Single_Inherited),
                    false
                )
            );
        }
        ...
        {
            Attribute attribute =
                CustomAttributeExtensions.GetCustomAttribute<MyAttribute_Single_Inherited>(
                    s_typeTestClass.GetTypeInfo(),
                    false
                );
        ...
        {
            var attributes =
                CustomAttributeExtensions.GetCustomAttributes<MyAttribute_AllowMultiple_Inherited>(
                    s_typeTestClass.GetTypeInfo(),
                    false
                );
        ...
        public void GetCustomAttributeOfT_Multiple()
        {
            IEnumerable<Attribute> attributes =
                CustomAttributeExtensions.GetCustomAttributes<MyAttribute_Single_Inherited>(
                    s_typeTestClass.GetTypeInfo()
                );
            Assert.Equal(1, attributes.Count());
        ...
        {
            var attribute = CustomAttributeExtensions.GetCustomAttribute(
                s_typeTestClass.GetTypeInfo(),
            ...
            var attributes = CustomAttributeExtensions.GetCustomAttributes(
                s_typeTestClass.GetTypeInfo(),
                typeof(MyAttribute_AllowMultiple_Inherited),
                false
            );
        ...
        public void GetCustomAttributeAll()
        {
            ...
            Assert.Equal(
                1,
                attributeData.Count(attr => attr.ToString().Contains("MyAttribute_Single_M"))
            );
        }
    }
