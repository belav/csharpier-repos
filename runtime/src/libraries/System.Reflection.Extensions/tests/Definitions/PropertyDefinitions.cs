...
namespace System.Reflection.Tests
{
    internal class PropertyTestBaseClass
    {
        ...
        public static string[] DeclaredPropertyNames = new string[]
        {
            "SubPubprop1",
            "Pubprop1",
            "Pubprop2",
    ...
    internal class PropertyTestSubClass : PropertyTestBaseClass
    {
        ...
        public static new string[] DeclaredPropertyNames = new string[]
        {
            "Pubprop1",
            "Pubprop2",
            "Pubprop3",
        ...
        public static new string[] PublicPropertyNames = new string[]
        {
            "Pubprop1",
            "Pubprop2",
            "Pubprop3",
