...
namespace System.Reflection.Tests
{
    public class FieldTestBaseClass
    {
        ...
        public static string[] DeclaredFieldNames = new string[]
        {
            "SubPubfld1",
            "Pubfld1",
            "Pubfld2",
    ...
    public class FieldTestSubClass : FieldTestBaseClass
    {
        ...
        public static new string[] DeclaredFieldNames = new string[]
        {
            "Pubfld1",
            "Pubfld2",
            "Pubfld3",
        ...
        public static new string[] InheritedFieldNames = new string[]
        {
            "SubPubfld1",
            "SubIntfld1",
            "SubProfld1",
        ...
        public static string[] NewFieldNames = new string[]
        {
            "Pubfld1",
            "Pubfld2",
            "Pubfld3",
