...
namespace System.ComponentModel.DataAnnotations
{
    ...
    ///     <para>Override <see cref="IsValid(object, ValidationContext)" /> to implement validation
    // logic.</para>
    /// </summary>
    /// <remarks>
    ///     The properties <see cref="ErrorMessageResourceType" /> and <see
    // cref="ErrorMessageResourceName" /> are used to
    ///     provide
    ///     a localized error message, but they cannot be set if <see cref="ErrorMessage" /> is also
    // used to provide a
    ///     non-localized
    ///     error message.
    /// </remarks>
    public abstract class ValidationAttribute : Attribute
    {
        ...
        /// </summary>
        /// <param name="errorMessage">A non-localized error message to use in <see
        // cref="ErrorMessageString" />.</param>
        protected ValidationAttribute(string errorMessage)
            : this(() => errorMessage) { }

        /// <summary>
        ///     Allows for providing a resource accessor function that will be used by the <see
        // cref="ErrorMessageString" />
        ...
        /// </summary>
        /// <param name="errorMessageAccessor">The <see cref="Func{T}" /> that will return an error
        // message.</param>
        ...
        {
            Debug.Assert(
                populateErrorMessageResourceAccessor is false,
        ...
        /// <summary>
        /// Sets the delayed resource accessor in cases where we can't pass it directly to the base
        // constructor.
        /// </summary>
        private protected Func<string> ErrorMessageResourceAccessor
        {
            ...
            {
                Debug.Assert(
                    _defaultErrorMessage is null
                        && _errorMessageResourceName is null
                        && _errorMessage is null
                        && _errorMessageResourceType is null
                );
        ...
        /// <summary>
        ///     Gets the localized error message string, coming either from <see cref="ErrorMessage" />, or
        // from evaluating the
        ...
        /// <summary>
        ///     A flag indicating whether a developer has customized the attribute's error message by
        // setting any one of
        ...
        ///     <see cref="ErrorMessageResourceType" /> and <see cref="ErrorMessageResourceName" /> for
        ...
        /// <summary>
        ///     Gets or sets the resource name (property name) to use as the key for lookups on the resource
        // type.
        /// </summary>
        /// <value>
        ///     Use this property to set the name of the property within <see
        // cref="ErrorMessageResourceType" />
        ///     that will provide a localized error message.  Use <see cref="ErrorMessage" /> for
        ...
        /// </summary>
        /// <value>
        ///     Use this property only in conjunction with <see cref="ErrorMessageResourceName" />.  They
        // are
        ///     used together to retrieve localized error messages at runtime.
        ///     <para>
        ///         Use <see cref="ErrorMessage" /> instead of this pair if error messages are not
        // localized.
        ///     </para>
        /// </value>
        [DynamicallyAccessedMembers(
        ...
        /// <summary>
        ///     Validates the configuration of this attribute and sets up the appropriate error string
        // accessor.
        ...
        private void SetResourceAccessorByPropertyLookup()
        {
            ...
            var property = _errorMessageResourceType.GetProperty(
        ...
        private protected ValidationResult CreateFailedValidationResult(
        ...
        ///     It applies the <paramref name="name" /> (for example, the name of a field) to the formatted
        ...
        ///     </para>
        ///     <para>
        ///         The base class implementation will use <see cref="ErrorMessageString" /> to obtain a
        // localized
        ///         error message from properties within the current attribute.  If those have not been set,
        // a generic
        ...
        ///     <para>
        ///         Derived classes should not override this method as it is only available for backwards
        // compatibility.
        ///         Instead, implement <see cref="IsValid(object, ValidationContext)" />.
        ///     </para>
        /// </summary>
        /// <remarks>
        ///     The preferred public entry point for clients requesting validation is the <see
        // cref="GetValidationResult" />
        ///     method.
        /// </remarks>
        /// <param name="value">The value to validate</param>
        /// <returns><c>true</c> if the <paramref name="value" /> is acceptable, <c>false</c> if it is not
        // acceptable</returns>
        /// <exception cref="InvalidOperationException"> is thrown if the current attribute is
        // malformed.</exception>
        ...
        ///     <para>
        ///         Derived classes should override this method instead of <see cref="IsValid(object)" />,
        // which is deprecated.
        ///     </para>
        /// </summary>
        /// <param name="value">The value to validate.</param>
        ...
        /// </summary>
        /// <remarks>
        ///     If this method returns <see cref="ValidationResult.Success" />, then validation was
        ...
        )
        {
            ...
            // If validation fails, we want to ensure we have a ValidationResult that guarantees it has an
            // ErrorMessage
            if (result != null)
            {
        ...
        /// <summary>
        ///     Validates the specified <paramref name="value" /> and throws <see cref="ValidationException"
        // /> if it is not.
        ///     <para>
        ///         The overloaded <see cref="Validate(object, ValidationContext)" /> is the recommended
        // entry point as it
        ///         can provide additional context to the <see cref="ValidationAttribute" /> being
        // validated.
        ///     </para>
        /// </summary>
        /// <remarks>
        ///     This base method invokes the <see cref="IsValid(object)" /> method to determine whether or
        // not the
        ///     <paramref name="value" /> is acceptable.  If <see cref="IsValid(object)" /> returns
        // <c>false</c>, this base
        ///     method will invoke the <see cref="FormatErrorMessage" /> to obtain a localized message
        // describing
        ///     the problem, and it will throw a <see cref="ValidationException" />
        /// </remarks>
        /// <param name="value">The value to validate</param>
        /// <param name="name">The string to be included in the validation error message if <paramref
        // name="value" /> is not valid</param>
        ...
        ///     If that method doesn't return <see cref="ValidationResult.Success" />, this base method will
        // throw
        ///     a <see cref="ValidationException" /> containing the <see cref="ValidationResult" />
        // describing the problem.
        /// </remarks>
        /// <param name="value">The value to validate</param>
        /// <param name="validationContext">Additional context that may be used for validation.  It cannot
        // be null.</param>
        /// <exception cref="ValidationException">
