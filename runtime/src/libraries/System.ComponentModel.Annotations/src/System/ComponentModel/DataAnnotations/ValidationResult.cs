...
namespace System.ComponentModel.DataAnnotations
{
    ...
    ///     <para>
    ///         Use the static <see cref="ValidationResult.Success" /> to represent successful
    // validation.
    ///     </para>
    /// </summary>
    ...
    public class ValidationResult
    {
        ...
        /// </summary>
        /// <remarks>
        ///     The <c>null</c> value is used to indicate success.  Consumers of <see
        // cref="ValidationResult" />s
        ///     should compare the values to <see cref="ValidationResult.Success" /> rather than checking
        // for null.
        /// </remarks>
        ...
        /// <summary>
        ///     Constructor that accepts an error message.  This error message would override any error
        // message
        ///     provided on the <see cref="ValidationAttribute" />.
        /// </summary>
        /// <param name="errorMessage">
        ///     The user-visible error message.  If null, <see
        // cref="ValidationAttribute.GetValidationResult" />
        ...
        /// <summary>
        ///     Constructor that accepts an error message as well as a list of member names involved in the
        // validation.
        ///     This error message would override any error message provided on the <see
        ...
        ///     This list of member names is meant to be used by presentation layers to indicate which
        // fields are in error.
        /// </param>
        ...
        /// <exception cref="System.ArgumentNullException">The <paramref name="validationResult" /> is
        // null.</exception>
        ...
        /// <summary>
        ///     Gets the collection of member names affected by this result.  The collection may be empty
