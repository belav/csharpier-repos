...
#pragma warning disable 618 // FilterUIHintAttribute is marked as Obsolete
        public static IEnumerable<object[]> Ctor_TestData()
        {
            ...
            yield return new object[]
            {
                ...
                "def",
                new object[] { "abc", 5 },
                new Dictionary<string, object>() { { "abc", 5 } },
            };
            yield return new object[]
            {
                "abc",
                "def",
                new object[] { "abc", 5, "", 6 },
                new Dictionary<string, object>() { { "abc", 5 }, { "", 6 } },
            };
        ...
        )
        {
            if (controlParameters == null || controlParameters.Length == 0)
            {
                if (presentationLayer == null)
                {
                    ...
                    VerifyAttribute(
                        ...
                        filterUIHint,
                        presentationLayer,
                        expectedControlParameters
                    );
                }
                // Use FilterUIHintAttribute(string, string)
                FilterUIHintAttribute attribute2 = new FilterUIHintAttribute(
                    filterUIHint,
                    presentationLayer
                );
                VerifyAttribute(
            ...
            FilterUIHintAttribute attribute3 = new FilterUIHintAttribute(
                filterUIHint,
                presentationLayer,
                controlParameters
            );
        ...
        private static void VerifyAttribute(
            FilterUIHintAttribute attribute,
            string filterUIHint,
            string presentationLayer,
        ...
        {
            FilterUIHintAttribute attribute = new FilterUIHintAttribute(
                "FilterUIHint",
                "PresentationLayer",
                controlParameters
            );
        ...
        public static IEnumerable<object[]> Equals_TestData()
        {
            yield return new object[]
            {
                new FilterUIHintAttribute("abc", "def", new object[] { "1", 2 }),
                new FilterUIHintAttribute("abc", "def", new object[] { "1", 2 }),
                true,
            };
            yield return new object[]
            {
                new FilterUIHintAttribute(null, null, null),
                new FilterUIHintAttribute(null, null, null),
                true,
            };
            yield return new object[]
            {
                new FilterUIHintAttribute("abc", "def", new object[0]),
                new FilterUIHintAttribute("xyz", "def", new object[0]),
                false,
            };
            yield return new object[]
            {
                new FilterUIHintAttribute("abc", "def", new object[0]),
                new FilterUIHintAttribute("abc", "xyz", new object[0]),
                false,
            };
            yield return new object[]
            {
            ...
            {
                new FilterUIHintAttribute("abc", "def", new object[] { "1", 2 }),
                new FilterUIHintAttribute("abc", "def", new object[] { "1" }),
                false,
            };
            yield return new object[]
            {
                new FilterUIHintAttribute("abc", "def", new object[] { "1", 2 }),
                new FilterUIHintAttribute("abc", "def", new object[] { "1", 2, "3", 4 }),
                false,
            };
