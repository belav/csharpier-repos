...
namespace System.ComponentModel.DataAnnotations.Tests
{
    public class ValidationAttributeTests
    {
        ...
        [Theory]
        [InlineData(
            nameof(ValidationAttributeOverrideBothIsValids.PublicErrorMessageTestProperty),
            typeof(ValidationAttributeOverrideBothIsValids),
            "Error Message from PublicErrorMessageTestProperty"
        )]
        [InlineData(
            nameof(ValidationAttributeOverrideBothIsValids.PublicErrorMessageTestPropertyWithName),
            typeof(ValidationAttributeOverrideBothIsValids),
            "Error Message from PublicErrorMessageTestProperty With Name <name>"
        )]
        [InlineData(
            nameof(ValidationAttributeOverrideBothIsValids.StaticInternalProperty),
            typeof(ValidationAttributeOverrideBothIsValids),
            "ErrorMessage"
        )]
        ...
        [InlineData(
            nameof(ValidationAttributeOverrideBothIsValids.GetSetProperty),
            typeof(ValidationAttributeOverrideBothIsValids)
        )]
        [InlineData(
            nameof(ValidationAttributeOverrideBothIsValids.GetOnlyProperty),
            typeof(ValidationAttributeOverrideBothIsValids)
        )]
        [InlineData(
            nameof(ValidationAttributeOverrideBothIsValids.SetOnlyProperty),
            typeof(ValidationAttributeOverrideBothIsValids)
        )]
        [InlineData(
            nameof(ValidationAttributeOverrideBothIsValids.StaticSetOnlyProperty),
            typeof(ValidationAttributeOverrideBothIsValids)
        )]
        [InlineData(
            nameof(ValidationAttributeOverrideBothIsValids.StaticIntProperty),
            typeof(ValidationAttributeOverrideBothIsValids)
        )]
        ...
        [InlineData(
            nameof(ValidationAttributeOverrideBothIsValids.StaticProtectedInternalProperty),
            typeof(ValidationAttributeOverrideBothIsValids)
        )]
        ...
        {
            ValidationAttributeAlwaysInvalidNullErrorMessage attribute =
                new ValidationAttributeAlwaysInvalidNullErrorMessage();
        ...
        {
            ValidationAttributeAlwaysInvalidEmptyErrorMessage attribute =
                new ValidationAttributeAlwaysInvalidEmptyErrorMessage();
            ValidationResult validationResult = attribute.GetValidationResult(
                "abc",
                new ValidationContext(new object())
            );
        ...
        public class ValidationAttributeOverrideTwoArgsIsValid : ValidationAttribute
        {
            protected override ValidationResult IsValid(object value, ValidationContext _)
            {
                ...
                return new ValidationResult(
                    "TestValidationAttributeOverrideTwoArgsIsValid IsValid failed"
                );
            }
        }
        ...
        public class ValidationAttributeOverrideBothIsValids : ValidationAttribute
        {
            ...
            protected internal static string StaticProtectedInternalProperty { get; set; } =
                "ErrorMessage";

            public override bool IsValid(object value)
            {
                var valueAsString = value as string;
                if ("Valid 1-Arg Value".Equals(valueAsString))
                {
                    return true;
                }
                return false;
            ...
            {
                var valueAsString = value as string;
                if ("Valid 2-Args Value".Equals(valueAsString))
                {
                    return ValidationResult.Success;
                }
                return new ValidationResult(
    ...
    internal class ErrorMessageResources
    {
        internal static string InternalErrorMessageTestProperty
        {
            get
            {
                return "Error Message from ErrorMessageResources.InternalErrorMessageTestProperty";
            }
        }
