...
namespace System.ComponentModel.DataAnnotations.Tests
{
    public class UIHintAttributeTests
    {
        ...
        )
        {
            ...
            UIHintAttribute attribute3 = new UIHintAttribute(
                filterUIHint,
                presentationLayer,
                controlParameters
            );
        ...
        public static IEnumerable<object[]> Equals_TestData()
        {
            yield return new object[]
            {
                new UIHintAttribute("abc", "def", new object[] { "1", 2 }),
                new UIHintAttribute("abc", "def", new object[] { "1", 2 }),
                true,
            };
            yield return new object[]
            {
                new UIHintAttribute(null, null, null),
                new UIHintAttribute(null, null, null),
                true,
            };
            yield return new object[]
            {
                new UIHintAttribute("abc", "def", new object[0]),
                new UIHintAttribute("xyz", "def", new object[0]),
                false,
            };
            yield return new object[]
            {
                new UIHintAttribute("abc", "def", new object[0]),
                new UIHintAttribute("abc", "xyz", new object[0]),
                false,
            };
            yield return new object[]
            {
            ...
            {
                new UIHintAttribute("abc", "def", new object[] { "1", 2 }),
                new UIHintAttribute("abc", "def", new object[] { "1" }),
                false,
            };
            yield return new object[]
            {
                new UIHintAttribute("abc", "def", new object[] { "1", 2 }),
                new UIHintAttribute("abc", "def", new object[] { "1", 2, "3", 4 }),
                false,
            };
