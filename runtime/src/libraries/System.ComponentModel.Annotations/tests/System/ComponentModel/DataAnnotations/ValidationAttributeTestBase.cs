...
namespace System.ComponentModel.DataAnnotations.Tests
{
    public abstract class ValidationAttributeTestBase
    {
        ...
        private Type InvalidErrorMessage_Type =>
            RespectsErrorMessage ? typeof(InvalidOperationException) : typeof(ValidationException);
        ...
        [SkipOnTargetFramework(
            ...
            "EmailAddressAttribute in the .NET Framework has a bug with values that are null or not string type"
        )]
        ...
        public void ErrorMessage_Invalid_Throws()
        {
            ...
            ErrorMessageResourceNameSet_ErrorMessageResourceTypeSet_NoSuchProperty(
                InvalidValues().First()
            );
            ErrorMessageResourceNameSet_ErrorMessageResourceTypeSet_InstanceProperty(
                InvalidValues().First()
            );
            ErrorMessageResourceNameSet_ErrorMessageResourceTypeSet_PrivateProperty(
                InvalidValues().First()
            );
            ErrorMessageResourceNameSet_ErrorMessageResourceTypeSet_NonStringProperty(
                InvalidValues().First()
            );
        }
