...
namespace System.Globalization.Tests
{
    public class DateTimeFormatInfoMiscTests
    {
        public static IEnumerable<object[]> DateTimeFormatInfo_TestData()
        {
            ...
            {
                (DateTimeFormatInfo)new CultureInfo("en-US").DateTimeFormat.Clone(),
                new GregorianCalendar(),
                "Gregorian Calendar"
            };
            yield return new object[]
            {
                (DateTimeFormatInfo)new CultureInfo("ar-SA").DateTimeFormat.Clone(),
                new HijriCalendar(),
                "\u0627\u0644\u062a\u0642\u0648\u064a\u0645\u00a0\u0627\u0644\u0647\u062c\u0631\u064a"
            };
            yield return new object[]
            ...
            yield return new object[]
            {
                (DateTimeFormatInfo)new CultureInfo("ja-JP").DateTimeFormat.Clone(),
                new JapaneseCalendar(),
                "\u548c\u66a6"
            };
            yield return new object[]
            {
                (DateTimeFormatInfo)new CultureInfo("th-TH").DateTimeFormat.Clone(),
                new ThaiBuddhistCalendar(),
                "\u0e1e\u0e38\u0e17\u0e18\u0e28\u0e31\u0e01\u0e23\u0e32\u0e0a"
            };
            yield return new object[]
            {
                (DateTimeFormatInfo)new CultureInfo("he-IL").DateTimeFormat.Clone(),
                new HebrewCalendar(),
                "\u05dc\u05d5\u05d7\u00a0\u05e9\u05e0\u05d4\u00a0\u05e2\u05d1\u05e8\u05d9"
            };
            yield return new object[]
            {
                (DateTimeFormatInfo)new CultureInfo("ko-KR").DateTimeFormat.Clone(),
                new KoreanCalendar(),
                "\ub2e8\uae30"
            };
            yield return new object[]
            {
                (DateTimeFormatInfo)new CultureInfo("fa-IR").DateTimeFormat.Clone(),
                new PersianCalendar(),
                "\u062a\u0642\u0648\u06cc\u0645\u0020\u0647\u062c\u0631\u06cc\u0020\u0634\u0645\u0633\u06cc"
            };
        }
        ...
        public void DateSeparatorTimeSeparator_Get_ReturnsExpected()
        {
            ...
            Assert.True(
                dtfi.ShortDatePattern.IndexOf(dateSep) > 0,
                "dtfi.ShortDatePattern should be greater than 0"
            );
            Assert.True(
                dtfi.ShortTimePattern.IndexOf(timeSep) > 0,
                "dtfi.ShortTimePattern should be greater than 0"
            );
            ...
            Assert.True(
                formattedDate.IndexOf(dateSep) > 0,
                "Expected to find date separator in the formatted string"
            );
            dtfi.DateSeparator = "-";
            ...
            Assert.True(
                formattedTime.IndexOf(timeSep) > 0,
                "Expected to find time separator in the formatted string"
            );
            dtfi.TimeSeparator = ".";
        ...
        public void NativeCalendarName_Get_ReturnsExpected(
            DateTimeFormatInfo dtfi,
            Calendar calendar,
            ...
            catch
            {
                if (PlatformDetection.IsNlsGlobalization)
                {
                    ...
                    Assert.True(
                        ...
                        "Exception can occur only with PersianCalendar"
                    );
                }
                else // !PlatformDetection.IsNlsGlobalization
                {
                    Assert.True(
                        calendar is HijriCalendar
                            ...
                            || calendar is ThaiBuddhistCalendar
                            || calendar is HebrewCalendar
                            || calendar is KoreanCalendar,
                        "failed to set the calendar on DTFI"
                    );
                }
            }
        }
        ...
        public void GetAllDateTimePatterns_Invoke_ReturnsExpected(string cultureName)
        {
            ...
            DateTimeFormatInfo dtfi =
                (DateTimeFormatInfo)new CultureInfo(cultureName).DateTimeFormat.Clone();
            ...
            {
                Assert.True(
                    dic.TryGetValue(pattern, out value),
                    "Couldn't find the pattern in the patterns list"
                );
            }
        ...
        public void Months_GetHebrew_ReturnsExpected()
        {
            ...
            for (int i = 0; i < 13; i++)
            {
                ...
                Assert.Equal(
                    dt,
                    DateTime.ParseExact(formatted, ci.DateTimeFormat.LongDatePattern, ci)
                );
        ...
        public void TestFirstYearOfJapaneseEra()
        {
            ...
            Assert.True(
                formattedDate.IndexOf("\u5143", StringComparison.Ordinal) >= 0
                    == DateTime.TryParseExact(
                        formattedDateWithGannen,
                        pattern,
                        jpnFormat,
                        DateTimeStyles.None,
                        out parsedDate
        ...
        public void JapaneseAbbreviatedEnglishEraNamesTest()
        {
            ...
            int numberOfErasToTest = Math.Min(
                eraNames.Length,
                ci.DateTimeFormat.Calendar.Eras.Length
            );
