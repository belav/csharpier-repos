...
namespace System.Globalization.Tests
{
    public partial class CompareInfoTests
    {
        ...
        )
        {
            ...
            Assert.Equal(
                expected,
                invariantCompare.GetHashCode(source1, options1)
        ...
        [ConditionalTheory(
            typeof(CompareInfoCompareTests),
            nameof(CompareInfoCompareTests.IsNotWindowsKanaRegressedVersion)
        )]
        ...
        public void GetHashCode_NullAndEmptySpan()
        {
            ...
            int hashCodeOfNullSpan = CultureInfo.InvariantCulture.CompareInfo
                .GetHashCode(ReadOnlySpan<char>.Empty, CompareOptions.None);
            int hashCodeOfNotNullEmptySpan = CultureInfo.InvariantCulture.CompareInfo
