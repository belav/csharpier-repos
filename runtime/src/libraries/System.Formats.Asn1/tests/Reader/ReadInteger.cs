...
namespace System.Formats.Asn1.Tests.Reader
{
    public sealed class ReadInteger
    {
        ...
        public static void ReadInt32_TooMuchData(AsnEncodingRules ruleSet, string inputHex)
        {
            byte[] data = inputHex.HexToByteArray();
            AsnReader reader = new AsnReader(data, ruleSet);
        ...
        [InlineData(
            ...
            "020785848382818012",
            unchecked((long)0xFF858483_82818012)
        )]
        [InlineData(
            AsnEncodingRules.DER,
            "02088685848382818012",
            unchecked((long)0x86858483_82818012)
        )]
        ...
        public static void ReadInt64_TooMuchData(AsnEncodingRules ruleSet, string inputHex)
        {
            byte[] data = inputHex.HexToByteArray();
            AsnReader reader = new AsnReader(data, ruleSet);
        ...
        public static void TagMustBeCorrect_Universal(AsnEncodingRules ruleSet)
        {
            ...
            Assert.Throws<AsnContentException>(() =>
                reader.ReadIntegerBytes(new Asn1Tag(TagClass.ContextSpecific, 0))
            );
        ...
        public static void TagMustBeCorrect_Custom(AsnEncodingRules ruleSet)
        {
            ...
            Assert.Throws<AsnContentException>(() =>
                reader.ReadIntegerBytes(new Asn1Tag(TagClass.Application, 0))
            );

            Assert.True(reader.HasData, "HasData after wrong custom class");

            Assert.Throws<AsnContentException>(() =>
                reader.ReadIntegerBytes(new Asn1Tag(TagClass.ContextSpecific, 1))
            );
        ...
        )
        {
            ...
            ReadOnlyMemory<byte> val2 = reader.ReadIntegerBytes(
