...
namespace System.Formats.Asn1.Tests.Reader
{
    public sealed class ReadUtcTime
    {
        ...
        [InlineData(
            ...
            "17113137303930383130333530332D30373030",
            2017,
            9,
            8,
            10,
        ...
        [InlineData(
            AsnEncodingRules.BER,
            "17113137303930383130333530332D30303530",
            2017,
            9,
            8,
            10,
        ...
        [InlineData(
            AsnEncodingRules.BER,
            "17113137303930383130333530332B30373030",
            2017,
            9,
            8,
            10,
        ...
        [InlineData(
            AsnEncodingRules.BER,
            "17113030303130313030303030302B30303030",
            2000,
            1,
            1,
            0,
        ...
        [InlineData(
            AsnEncodingRules.BER,
            "17113030303130313030303030302D31343030",
            2000,
            1,
            1,
            0,
        ...
        [InlineData(
            AsnEncodingRules.BER,
            "170F313730393038313033352D30373030",
            2017,
            9,
            8,
            10,
        ...
        [InlineData(
            AsnEncodingRules.BER,
            "170F323730393038313033352B30393132",
            2027,
            9,
            8,
            10,
        ...
        [InlineData(
            "A,B1,C2-NotPlusMinus",
            AsnEncodingRules.BER,
            "170F313730393038313033352C30373030"
        )]
        [InlineData(
            "A,B2,C2-NotPlusMinus",
            AsnEncodingRules.BER,
            "17113137303930383130333530332C30373030"
        )]
        [InlineData(
            "A,B2,C2-MinuteOutOfRange",
            AsnEncodingRules.BER,
            "17113030303030303030303030302D31353630"
        )]
        [InlineData(
            "A,B1,C2-MinuteOutOfRange",
            AsnEncodingRules.BER,
            "170F303030303030303030302D31353630"
        )]
        [InlineData("A1,B2,C1-NotZ", AsnEncodingRules.DER, "170D3530303130323132333435365B")]
        [InlineData(
            "A,B2,C2-MissingDigit",
            AsnEncodingRules.BER,
            "17103137303930383130333530332C303730"
        )]
        [InlineData(
            "A,B2,C2-TooLong",
            AsnEncodingRules.BER,
            "17123137303930383130333530332B3037303030"
        )]
        ...
        public static void TagMustBeCorrect_Custom(AsnEncodingRules ruleSet)
        {
            ...
            Assert.Equal(
                ...
                reader.ReadUtcTime(
                    TwoDigitYearMax,
                    expectedTag: new Asn1Tag(TagClass.ContextSpecific, 5)
                )
            );
            Assert.False(reader.HasData, "HasData after reading value");
        }
        ...
        [InlineData(
            AsnEncodingRules.BER,
            "800D3530303130323132333435365A",
            TagClass.ContextSpecific,
            0
        )]
        [InlineData(
            AsnEncodingRules.CER,
            "4C0D3530303130323132333435365A",
            TagClass.Application,
            12
        )]
        [InlineData(
            AsnEncodingRules.DER,
            "DF8A460D3530303130323132333435365A",
            TagClass.Private,
            1350
        )]
        ...
        )
        {
            ...
            DateTimeOffset val1 = reader.ReadUtcTime(
                expectedTag: new Asn1Tag(tagClass, tagValue, true)
            );
            ...
            DateTimeOffset val2 = reader.ReadUtcTime(
                expectedTag: new Asn1Tag(tagClass, tagValue, false)
            );
