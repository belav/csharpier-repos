        ...
        public static void WriteMicrosoftDotComCert()
        {
            ...
            using (writer.PushSequence())
            {
                ...
                using (writer.PushSequence())
                {
                    ...
                    BigInteger serialValue = BigInteger.Parse(
                        "82365655871428336739211871484630851433"
                    );
                        ...
                        using (writer.PushSequence())
                        {
                            ...
                            using (writer.PushSequence())
                            {
                                ...
                                byte[] authorityKeyIdentifier =
                                    "0159ABE7DD3A0B59A66463D6CF200757D591E76A".HexToByteArray();
            ...
            Assert.True(
                writer.EncodedValueEquals(ComprehensiveReadTests.MicrosoftDotComSslCertBytes)
            );
        }

        private static void WriteRdn(
            AsnWriter writer,
            string oid,
            string value,
