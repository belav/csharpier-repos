...
namespace System.Formats.Asn1.Tests.Writer
{
    public class WriteEnumerated : Asn1WriterTests
    {
        ...
        [InlineData(
            ...
            (ReadEnumerated.UShortBacked)short.MaxValue,
            false,
            "0A027FFF"
        )]
        [InlineData(
            AsnEncodingRules.BER,
            (ReadEnumerated.UShortBacked)ushort.MaxValue,
            true,
            "4D0300FFFF"
        )]
        ...
        [InlineData(
            ...
            ReadEnumerated.IntBacked.Pillow,
            true,
            "5F81FF7F03FEFFFF"
        )]
        ...
        [InlineData(
            AsnEncodingRules.CER,
            (ReadEnumerated.IntBacked)int.MinValue,
            true,
            "5F81FF7F0480000000"
        )]
        [InlineData(
            AsnEncodingRules.CER,
            (ReadEnumerated.IntBacked)int.MaxValue,
            false,
            "0A047FFFFFFF"
        )]
        ...
        )
        {
            ...
            if (customTag)
            {
                writer.WriteEnumeratedValue(
                    value,
                    new Asn1Tag(TagClass.Application, short.MaxValue)
                );
            }
            else
            {
        ...
        [InlineData(
            AsnEncodingRules.BER,
            ReadEnumerated.UIntBacked.Fluff,
            true,
            "9F61050080000005"
        )]
        ...
        [InlineData(
            AsnEncodingRules.DER,
            (ReadEnumerated.UIntBacked)short.MaxValue,
            false,
            "0A027FFF"
        )]
        [InlineData(
            AsnEncodingRules.BER,
            (ReadEnumerated.UIntBacked)ushort.MaxValue,
            true,
            "9F610300FFFF"
        )]
        ...
        [InlineData(
            AsnEncodingRules.CER,
            (ReadEnumerated.LongBacked)int.MinValue,
            true,
            "800480000000"
        )]
        [InlineData(
            AsnEncodingRules.DER,
            (ReadEnumerated.LongBacked)int.MaxValue,
            false,
            "0A047FFFFFFF"
        )]
        [InlineData(
            AsnEncodingRules.BER,
            (ReadEnumerated.LongBacked)long.MinValue,
            false,
            "0A088000000000000000"
        )]
        [InlineData(
            AsnEncodingRules.CER,
            (ReadEnumerated.LongBacked)long.MaxValue,
            true,
            "80087FFFFFFFFFFFFFFF"
        )]
        ...
        [InlineData(
            ...
            false,
            "0A0900FACEF00DCAFEBEEF"
        )]
        [InlineData(
            AsnEncodingRules.BER,
            ReadEnumerated.ULongBacked.Fluff,
            true,
            "C10900FACEF00DCAFEBEEF"
        )]
        [InlineData(AsnEncodingRules.CER, (ReadEnumerated.ULongBacked)11, false, "0A010B")]
        [InlineData(
            AsnEncodingRules.DER,
            (ReadEnumerated.ULongBacked)short.MaxValue,
            false,
            "0A027FFF"
        )]
        [InlineData(
            AsnEncodingRules.BER,
            (ReadEnumerated.ULongBacked)ushort.MaxValue,
            true,
            "C10300FFFF"
        )]
        [InlineData(
            AsnEncodingRules.CER,
            (ReadEnumerated.ULongBacked)long.MaxValue,
            true,
            "C1087FFFFFFFFFFFFFFF"
        )]
        [InlineData(
            AsnEncodingRules.DER,
            (ReadEnumerated.ULongBacked)ulong.MaxValue,
            false,
