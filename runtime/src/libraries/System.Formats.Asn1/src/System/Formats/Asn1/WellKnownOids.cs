...
namespace System.Formats.Asn1
{
    internal static class WellKnownOids
    {
        ...
        private static ReadOnlySpan<byte> SHA1 => new byte[] { 0x2B, 0x0E, 0x03, 0x02, 0x1A, };
        private static ReadOnlySpan<byte> DES => new byte[] { 0x2B, 0x0E, 0x03, 0x02, 0x07, };
        private static ReadOnlySpan<byte> Secp384r1 => new byte[] { 0x2B, 0x81, 0x04, 0x00, 0x22, };
        private static ReadOnlySpan<byte> Secp521r1 => new byte[] { 0x2B, 0x81, 0x04, 0x00, 0x23, };
        private static ReadOnlySpan<byte> CommonName => new byte[] { 0x55, 0x04, 0x03, };
        private static ReadOnlySpan<byte> SerialNumber => new byte[] { 0x55, 0x04, 0x05, };
        private static ReadOnlySpan<byte> CountryOrRegionName => new byte[] { 0x55, 0x04, 0x06, };
        private static ReadOnlySpan<byte> Locality => new byte[] { 0x55, 0x04, 0x07, };
        private static ReadOnlySpan<byte> StateOrProvinceName => new byte[] { 0x55, 0x04, 0x08, };
        private static ReadOnlySpan<byte> OrganizationName => new byte[] { 0x55, 0x04, 0x0A, };
        private static ReadOnlySpan<byte> OrganizationalUnit => new byte[] { 0x55, 0x04, 0x0B, };
        private static ReadOnlySpan<byte> OrganizationIdentifier =>
            new byte[] { 0x55, 0x04, 0x61, };
        private static ReadOnlySpan<byte> SubjectKeyIdentifier => new byte[] { 0x55, 0x1D, 0x0E, };
        private static ReadOnlySpan<byte> KeyUsage => new byte[] { 0x55, 0x1D, 0x0F, };
        private static ReadOnlySpan<byte> SubjectAlternativeName =>
            new byte[] { 0x55, 0x1D, 0x11, };
        private static ReadOnlySpan<byte> BasicConstraints => new byte[] { 0x55, 0x1D, 0x13, };
        private static ReadOnlySpan<byte> CrlNumber => new byte[] { 0x55, 0x1D, 0x14, };
