    ...
    internal static class WellKnownOids
    {
        internal static string? GetValue(ReadOnlySpan<byte> contents)
        {
            return contents switch
            {
                ...
                [0x2B, 0x06, 0x01, 0x04, 0x01, 0x82, 0x37, 0x11, 0x03, 0x14] =>
                    "1.3.6.1.4.1.311.17.3.20",
                [0x2B, 0x06, 0x01, 0x04, 0x01, 0x82, 0x37, 0x14, 0x02, 0x03] =>
                    "1.3.6.1.4.1.311.20.2.3",
                [0x2B, 0x06, 0x01, 0x04, 0x01, 0x82, 0x37, 0x58, 0x02, 0x01] =>
                    "1.3.6.1.4.1.311.88.2.1",
                [0x2B, 0x06, 0x01, 0x04, 0x01, 0x82, 0x37, 0x58, 0x02, 0x02] =>
        ...
        internal static ReadOnlySpan<byte> GetContents(ReadOnlySpan<char> value)
        {
            ...
            [
                ...
                0x01,
                0x05,
                0x0D, // PasswordBasedEncryptionScheme2
                0x2A,
                0x86,
                0x48,
                0x86,
                ...
                0x07,
                0x03,
                0x04, // KeyPurposeEmailProtection
                0x2B,
                0x06,
                0x01,
                0x05,
                ...
                0x55,
                0x04,
                0x0B, // OrganizationalUnit
                0x55,
                0x04,
                0x61, // OrganizationIdentifier
                0x55,
                0x1D,
                0x0E, // SubjectKeyIdentifier
                0x55,
                0x1D,
                0x0F, // KeyUsage
                0x55,
                0x1D,
                0x11, // SubjectAlternativeName
                0x55,
                0x1D,
                0x13, // BasicConstraints
                0x55,
                0x1D,
                0x14, // CrlNumber
                0x55,
                0x1D,
                0x23, // AuthorityKeyIdentifier
                0x60,
                0x86,
                0x48,
                0x01,
