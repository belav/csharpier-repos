    ...
    */
    ...
    partial internal static class UnsafeNativeMethods
    {
        [LibraryImport(
            ...
            EntryPoint = "ADsEncodeBinaryData",
            StringMarshalling = StringMarshalling.Utf16
        )]
        partial public static int ADsEncodeBinaryData(byte[] data, int length, ref IntPtr result);
        ...
        partial public static int DsGetSiteName(string? dcName, ref IntPtr ptr);
        ...
        partial public static int DsEnumerateDomainTrustsW(
            string serverName,
            int flags,
            out IntPtr domains,
            out int count
        ...
        partial public static int NetApiBufferFree(IntPtr buffer);

        [LibraryImport(
            global::Interop.Libraries.Advapi32,
            EntryPoint = "LsaSetForestTrustInformation"
        )]
        partial public static uint LsaSetForestTrustInformation(
            SafeLsaPolicyHandle handle,
            in global::Interop.UNICODE_STRING target,
        ...
        [LibraryImport(
            global::Interop.Libraries.Advapi32,
            EntryPoint = "LsaQueryForestTrustInformation"
        )]
        partial public static uint LsaQueryForestTrustInformation(
            SafeLsaPolicyHandle handle,
            in global::Interop.UNICODE_STRING target,
        ...
        [LibraryImport(
            global::Interop.Libraries.Advapi32,
            EntryPoint = "LsaQueryTrustedDomainInfoByName"
        )]
        partial public static uint LsaQueryTrustedDomainInfoByName(
            SafeLsaPolicyHandle handle,
            in global::Interop.UNICODE_STRING trustedDomain,
        ...
        [LibraryImport(
            global::Interop.Libraries.Advapi32,
            EntryPoint = "LsaSetTrustedDomainInfoByName"
        )]
        partial public static uint LsaSetTrustedDomainInfoByName(
            SafeLsaPolicyHandle handle,
            in global::Interop.UNICODE_STRING trustedDomain,
            TRUSTED_INFORMATION_CLASS infoClass,
            IntPtr buffer
        ...
        partial public static uint LsaDeleteTrustedDomain(SafeLsaPolicyHandle handle, IntPtr pSid);
        ...
        partial public static int I_NetLogonControl2(
            string serverName,
            int FunctionCode,
            int QueryLevel,
            IntPtr data,
        ...
        partial public static void GetSystemTimeAsFileTime(IntPtr fileTime);

        [LibraryImport(global::Interop.Libraries.Advapi32, EntryPoint = "LsaCreateTrustedDomainEx")]
        partial public static uint LsaCreateTrustedDomainEx(
            SafeLsaPolicyHandle handle,
            in TRUSTED_DOMAIN_INFORMATION_EX domainEx,
            in TRUSTED_DOMAIN_AUTH_INFORMATION authInfo,
            int classInfo,
        ...
        partial public static IntPtr OpenThread(
            uint desiredAccess,
            [MarshalAs(UnmanagedType.Bool)] bool inheirted,
            int threadID
        );

        [LibraryImport(
            global::Interop.Libraries.Advapi32,
            EntryPoint = "ImpersonateAnonymousToken",
            SetLastError = true
        )]
        partial public static int ImpersonateAnonymousToken(IntPtr token);

        [LibraryImport(global::Interop.Libraries.NtDll, EntryPoint = "RtlInitUnicodeString")]
        partial public static int RtlInitUnicodeString(
            out global::Interop.UNICODE_STRING result,
            IntPtr s
        );
        ...
        partial public static int DsRoleGetPrimaryDomainInformation(
