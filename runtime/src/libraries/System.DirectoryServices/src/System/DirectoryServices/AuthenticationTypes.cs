...
namespace System.DirectoryServices
{
    ...
    public enum AuthenticationTypes
    {
        ...
        // Manager (NTLM)
        ///     to authenticate the client. Active Directory will use Kerberos, and possibly NTLM, to
        ...
        /// <devdoc>
        ///     Encrypts the channel with SSL. Data will be encrypted using SSL. Active Directory requires
        // that the
        ...
        /// <devdoc>
        ///     For a WinNT provider, ADSI tries to connect to a primary domain controller or a backup
        // domain
        ///     controller. For Active Directory, this flag indicates that a writeable server is not
        // required for a
        ///     serverless binding.
        /// </devdoc>
        ...
        /// <devdoc>
        ///     Request no authentication. The providers may attempt to bind client, as an anonymous user,
        // to the targeted
        ///     object. The WinNT provider does not support this flag. Active Directory establishes a
        // connection between
        ///     the client and the targeted object, but will not perform any authentication. Setting this
        // flag amounts to
        ...
        /// <devdoc>
        ///     When this flag is set, ADSI will not attempt to query the objectClass property and thus will
        // only expose
        ...
        /// <devdoc>
        ///     Verifies data integrity to ensure the data received is the same as the data sent. The Secure
        // flag
        ...
        /// <devdoc>
        ///     Enables ADSI to delegate the user's security context, which is necessary for moving objects
        // across domains.
        /// </devdoc>
        Delegation = NativeMethods.AuthenticationModes.UseDelegation,

        /// <devdoc>
        ///     Specify this flag when using the LDAP provider if your ADsPath includes a server name. Do
        // not use
