...
namespace System.Reflection.TypeLoading.Ecma
{
    internal static class EcmaHelpers
    {
        ...
        public static CoreType ToCoreType(this PrimitiveTypeCode typeCode)
        {
            switch (typeCode)
            {
                ...
                case PrimitiveTypeCode.IntPtr:
                    return CoreType.IntPtr;
                case PrimitiveTypeCode.Object:
                    return CoreType.Object;
                case PrimitiveTypeCode.SByte:
                    return CoreType.SByte;
                case PrimitiveTypeCode.Single:
                    return CoreType.Single;
                case PrimitiveTypeCode.String:
                    return CoreType.String;
                case PrimitiveTypeCode.TypedReference:
                    return CoreType.TypedReference;
                case PrimitiveTypeCode.UInt16:
                    return CoreType.UInt16;
                case PrimitiveTypeCode.UInt32:
                    return CoreType.UInt32;
                case PrimitiveTypeCode.UInt64:
                    return CoreType.UInt64;
        ...
        public static ExceptionHandlingClauseOptions ToExceptionHandlingClauseOptions(
            this ExceptionRegionKind kind
        ...
        public static bool IsConstructor(this in MethodDefinition method, MetadataReader reader)
        {
            ...
            return stringComparer.Equals(nameHandle, ConstructorInfo.ConstructorName)
        ...
        public static RoMethod? ToMethodOrNull(
        ...
        public static RoMethod ToMethod(
            this MethodDefinitionHandle handle,
            RoInstantiationProviderType declaringType,
            Type reflectedType
        )
        {
            return new RoDefinitionMethod<EcmaMethodDecoder>(
                declaringType,
                reflectedType,
                new EcmaMethodDecoder(handle, (EcmaModule)(declaringType.Module))
            );
        }
    }
}
