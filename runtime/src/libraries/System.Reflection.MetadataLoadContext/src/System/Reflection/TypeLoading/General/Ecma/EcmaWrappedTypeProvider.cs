...
namespace System.Reflection.TypeLoading.Ecma
{
    ...
    internal abstract class EcmaWrappedTypeProvider : ISignatureTypeProvider<RoType, TypeContext>
    {
        ...
        public RoType GetTypeFromSpecification(
            ...
            byte rawTypeKind
        ) => _typeProvider.GetTypeFromSpecification(reader, genericContext, handle, rawTypeKind);
        ...
        )
        {
            ...
            {
                filteredTypeArguments = filteredTypeArguments.Add(
                    typeArguments[i].SkipTypeWrappers()
                );
            }
        ...
        public RoType GetFunctionPointerType(MethodSignature<RoType> signature) =>
            _typeProvider.GetFunctionPointerType(signature);

        public abstract RoType GetModifiedType(
            RoType modifier,
        ...
        public RoType GetPrimitiveType(PrimitiveTypeCode typeCode) =>
            _typeProvider.GetPrimitiveType(typeCode);
    }
}
