...
namespace System.Reflection.TypeLoading
{
    internal abstract partial class RoModule
    {
        ...
        private readonly ConcurrentDictionary<RoType, RoArrayType> _szArrayDict =
            new ConcurrentDictionary<RoType, RoArrayType>();
        ...
        {
            return _mdArrayDict.GetOrAdd(
                new RoArrayType.Key(elementType, rank: rank),
        ...
        private readonly ConcurrentDictionary<RoArrayType.Key, RoArrayType> _mdArrayDict =
            new ConcurrentDictionary<RoArrayType.Key, RoArrayType>();
        ...
        private readonly ConcurrentDictionary<RoType, RoByRefType> _byRefDict =
            new ConcurrentDictionary<RoType, RoByRefType>();
        ...
        > s_constructedGenericTypeFactory = (k) =>
            new RoConstructedGenericType(k.GenericTypeDefinition, k.GenericTypeArguments);
