...
namespace System.Reflection
{
    ...
    internal abstract class RoModifiedType : RoType
    {
        ...
        public static RoModifiedType Create(RoType unmodifiedType)
        {
            ...
            else if (unmodifiedType.IsFunctionPointer)
            {
                modifiedType = new RoModifiedFunctionPointerType(
                    (RoFunctionPointerType)unmodifiedType
                );
            }
        ...
        protected override TypeAttributes ComputeAttributeFlags() =>
        ...
        protected override RoType? ComputeDeclaringType() =>
            throw new NotSupportedException(SR.NotSupported_ModifiedType);
        ...
        internal override bool IsCustomAttributeDefined(
            ReadOnlySpan<byte> ns,
            ReadOnlySpan<byte> name
        ) => _unmodifiedType.IsCustomAttributeDefined(ns, name);

        internal override CustomAttributeData? TryFindCustomAttribute(
            ReadOnlySpan<byte> ns,
            ReadOnlySpan<byte> name
        ) => _unmodifiedType.TryFindCustomAttribute(ns, name);
        ...
        internal override RoType[] GetGenericTypeArgumentsNoCopy() =>
            _unmodifiedType.GetGenericTypeArgumentsNoCopy();

        protected internal override RoType[] GetGenericArgumentsNoCopy() =>
            _unmodifiedType.GetGenericArgumentsNoCopy();
        ...
        protected internal override RoType ComputeEnumUnderlyingType() =>
            throw new NotSupportedException(SR.NotSupported_ModifiedType);
        ...
        internal override IEnumerable<ConstructorInfo> GetConstructorsCore(NameFilter? filter) =>
            throw new NotSupportedException(SR.NotSupported_ModifiedType);
        ...
        internal override IEnumerable<RoType> GetNestedTypesCore(NameFilter? filter) =>
            throw new NotSupportedException(SR.NotSupported_ModifiedType);
    }
}
