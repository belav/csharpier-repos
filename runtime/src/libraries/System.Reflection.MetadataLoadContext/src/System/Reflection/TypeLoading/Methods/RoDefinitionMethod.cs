        ...
        where TMethodDecoder : IMethodDecoder
    {
        ...
        public sealed override IEnumerable<CustomAttributeData> CustomAttributes
        {
            get
            {
                ...
                CustomAttributeData? dllImportCustomAttribute =
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                if (!(typeArgument is RoType roTypeArgument && roTypeArgument.Loader == Loader))
                    throw new ArgumentException(
                        SR.Format(SR.MakeGenericType_NotLoadedByMetadataLoadContext, typeArgument)
                    );
        ...
        protected sealed override RoType[] ComputeGenericArgumentsOrParameters() =>
            _decoder.ComputeGenericArgumentsOrParameters();
        ...
        public sealed override TypeContext TypeContext =>
            new TypeContext(_declaringType.Instantiation, GetGenericTypeParametersNoCopy());
    }
}
