...
namespace System.Reflection.TypeLoading.Ecma
{
    ...
    {
        public static RoType ResolveTypeDefRefOrSpec(
        ...
        private static readonly Func<
            ...
            EcmaModule,
            EcmaDefinitionType
        > s_resolveTypeDef = (h, m) => new EcmaDefinitionType((TypeDefinitionHandle)h, m);
        ...
        private static RoDefinitionType ComputeTypeRefResolution(
            ...
            if (scope.IsNil)
            {
                ...
                RoDefinitionType? type = module.GetEcmaAssembly()
                    .GetTypeCore(ns, name, ignoreCase: false, out Exception? e);
                if (type == null)
                    throw e!;
                return type;
            }
            ...
            switch (scopeKind)
            {
                case HandleKind.AssemblyReference:
                {
                    ...
                    RoDefinitionType? type = assembly.GetTypeCore(
                        ns,
                        name,
                        ignoreCase: false,
                        out Exception? e
                ...
                {
                    RoDefinitionType? type = module.GetTypeCore(
                        ns,
                        name,
                        ignoreCase: false,
                        out Exception? e
                ...
                {
                    string moduleName = ((ModuleReferenceHandle)scope).GetModuleReference(
                            module.Reader
                        )
                    ...
                    if (targetModule == null)
                        throw new BadImageFormatException(
                            SR.Format(
                                SR.BadImageFormat_TypeRefModuleNotInManifest,
                                module.Assembly.FullName,
                                $"0x{handle.GetToken():x8}"
                            )
                        );

                    RoDefinitionType? type = targetModule.GetTypeCore(
                        ns,
                        name,
                        ignoreCase: false,
                        out Exception? e
                ...
                default:
                    throw new BadImageFormatException(
                        SR.Format(
                            SR.BadImageFormat_TypeRefBadScopeType,
                            module.Assembly.FullName,
                            $"0x{handle.GetToken():x8}"
                        )
                    );
        ...
        public static RoType ResolveTypeSpec(
        ...
        > s_resolveGenericParam = (EntityHandle h, EcmaModule module) =>
        {
            MetadataReader reader = module.Reader;
        ...
        public static RoAssembly? TryResolveAssembly(
            this AssemblyReferenceHandle handle,
            EcmaModule module,
            out Exception? e
        ) {
        ...
        public static T ResolveMethod<T>(
        ...
        ) where T : MethodBase
        {
            ...
            RoInstantiationProviderType declaringType = methodDefinition.GetDeclaringType()
