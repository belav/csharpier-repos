    ...
    internal static class EcmaResolver
    {
        ...
        )
        {
            ...
            return handle.Kind switch
            {
                ...
                HandleKind.TypeSpecification => ((TypeSpecificationHandle)handle).ResolveTypeSpec(
                    module,
                    typeContext
                ),
            ...
            where T : MethodBase
        {
            ...
            RoInstantiationProviderType declaringType = methodDefinition
                .GetDeclaringType()
