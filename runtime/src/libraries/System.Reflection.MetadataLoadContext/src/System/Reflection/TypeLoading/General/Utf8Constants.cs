...
namespace System.Reflection.TypeLoading
{
    internal static class Utf8Constants
    {
        ...
        public static ReadOnlySpan<byte> SystemReflection =>
            new byte[]
            {
                83,
                121,
        ...
        public static ReadOnlySpan<byte> SystemCollectionsGeneric =>
            new byte[]
            {
                83,
                121,
        ...
        public static ReadOnlySpan<byte> NullableT =>
            new byte[] { 78, 117, 108, 108, 97, 98, 108, 101, 96, 49 };
        ...
        public static ReadOnlySpan<byte> TypedReference =>
            new byte[] { 84, 121, 112, 101, 100, 82, 101, 102, 101, 114, 101, 110, 99, 101 };
        ...
        public static ReadOnlySpan<byte> ValueType =>
            new byte[] { 86, 97, 108, 117, 101, 84, 121, 112, 101 };
        public static ReadOnlySpan<byte> Void => new byte[] { 86, 111, 105, 100 };
        public static ReadOnlySpan<byte> MulticastDelegate =>
            new byte[]
            {
                77,
                117,
        ...
        public static ReadOnlySpan<byte> IEnumerableT =>
            new byte[] { 73, 69, 110, 117, 109, 101, 114, 97, 98, 108, 101, 96, 49 };
        public static ReadOnlySpan<byte> ICollectionT =>
            new byte[] { 73, 67, 111, 108, 108, 101, 99, 116, 105, 111, 110, 96, 49 };
        public static ReadOnlySpan<byte> IListT => new byte[] { 73, 76, 105, 115, 116, 96, 49 };
        public static ReadOnlySpan<byte> IReadOnlyListT =>
            new byte[] { 73, 82, 101, 97, 100, 79, 110, 108, 121, 76, 105, 115, 116, 96, 49 };
        ...
        public static ReadOnlySpan<byte> DateTime =>
            new byte[] { 68, 97, 116, 101, 84, 105, 109, 101 };
        public static ReadOnlySpan<byte> ComImportAttribute =>
            new byte[]
            {
                67,
                111,
        ...
        public static ReadOnlySpan<byte> DllImportAttribute =>
            new byte[]
            {
                68,
                108,
        ...
        public static ReadOnlySpan<byte> CallingConvention =>
            new byte[]
            {
                67,
                97,
        ...
        public static ReadOnlySpan<byte> MarshalAsAttribute =>
            new byte[]
            {
                77,
                97,
        ...
        public static ReadOnlySpan<byte> UnmanagedType =>
            new byte[] { 85, 110, 109, 97, 110, 97, 103, 101, 100, 84, 121, 112, 101 };
        public static ReadOnlySpan<byte> VarEnum => new byte[] { 86, 97, 114, 69, 110, 117, 109 };
        public static ReadOnlySpan<byte> InAttribute =>
            new byte[] { 73, 110, 65, 116, 116, 114, 105, 98, 117, 116, 101 };
        public static ReadOnlySpan<byte> OutAttriubute =>
            new byte[] { 79, 117, 116, 65, 116, 116, 114, 105, 98, 117, 116, 101 };
        public static ReadOnlySpan<byte> OptionalAttribute =>
            new byte[]
            {
                79,
                112,
        ...
        public static ReadOnlySpan<byte> PreserveSigAttribute =>
            new byte[]
            {
                80,
                114,
        ...
        public static ReadOnlySpan<byte> FieldOffsetAttribute =>
            new byte[]
            {
                70,
                105,
        ...
        public static ReadOnlySpan<byte> IsByRefLikeAttribute =>
            new byte[]
            {
                73,
                115,
        ...
        public static ReadOnlySpan<byte> DecimalConstantAttribute =>
            new byte[]
            {
                68,
                101,
        ...
        public static ReadOnlySpan<byte> CustomConstantAttribute =>
            new byte[]
            {
                67,
                117,
        ...
        public static ReadOnlySpan<byte> GuidAttribute =>
            new byte[] { 71, 117, 105, 100, 65, 116, 116, 114, 105, 98, 117, 116, 101 };
        public static ReadOnlySpan<byte> DefaultMemberAttribute =>
            new byte[]
            {
                68,
                101,
        ...
        public static ReadOnlySpan<byte> DateTimeConstantAttribute =>
            new byte[]
            {
                68,
                97,
