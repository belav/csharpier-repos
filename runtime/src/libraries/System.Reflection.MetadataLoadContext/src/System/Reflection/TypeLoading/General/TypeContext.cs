...
{
    //
    // Passed as an argument to code that parses signatures or typespecs. Specifies the substitution
    // values for ET_VAR and ET_MVAR elements inside the signature.
