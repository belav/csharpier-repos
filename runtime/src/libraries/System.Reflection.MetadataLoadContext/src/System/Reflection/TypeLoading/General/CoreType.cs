        ...
        )
        {
            switch (coreType)
            {
                ...
                case CoreType.FieldOffsetAttribute:
                    ...
                    return;
                case CoreType.CallConvCdecl:
                    ns = Utf8Constants.SystemRuntimeCompilerServices;
                    name = Utf8Constants.CallConvCdecl;
                    return;
                case CoreType.CallConvStdcall:
                    ns = Utf8Constants.SystemRuntimeCompilerServices;
                    name = Utf8Constants.CallConvStdcall;
                    return;
                case CoreType.CallConvThiscall:
                    ns = Utf8Constants.SystemRuntimeCompilerServices;
                    name = Utf8Constants.CallConvThiscall;
                    return;
                case CoreType.CallConvFastcall:
                    ns = Utf8Constants.SystemRuntimeCompilerServices;
                    name = Utf8Constants.CallConvFastcall;
                    return;
                default:
