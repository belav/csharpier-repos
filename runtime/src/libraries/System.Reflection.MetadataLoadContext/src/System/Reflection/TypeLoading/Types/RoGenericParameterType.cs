...
{
    /// <summary>
    /// Base type for all RoTypes that return true for IsGenericParameter. This can a generic parameter
    // defined on a type or a method.
    /// </summary>
    internal abstract partial class RoGenericParameterType : RoType
    {
        ...
        private RoType[] GetGenericParameterConstraintsNoCopy() =>
            _lazyConstraints ??= ComputeGenericParameterConstraints();
