...
namespace System.Reflection.Tests
{
    public class TypeInfoDeclaredGenericTypeArgumentsTests
    {
        ...
        {
            VerifyGenericTypeArguments(
                typeof(Test_IG2<int, string>).Project(),
        ...
        {
            VerifyGenericTypeArguments(
                typeof(Test_SG2<int, string>).Project(),
                new string[] { "Int32", "String" },
                null
            );
        }
        ...
        {
            VerifyGenericTypeArguments(
                typeof(Test_SIG2<int, string>).Project(),
                new string[] { "Int32", "String" },
                new string[] { "Int32", "String" }
            );
        }
        ...
        {
            VerifyGenericTypeArguments(
                typeof(Test_SIG_Int<string>).Project(),
                new string[] { "String" },
        ...
        {
            VerifyGenericTypeArguments(
                typeof(Test_CG2<int, string>).Project(),
                new string[] { "Int32", "String" },
                null
            );
        }
        ...
        {
            VerifyGenericTypeArguments(
                typeof(Test_CIG2<int, string>).Project(),
                new string[] { "Int32", "String" },
                new string[] { "Int32", "String" }
            );
        }
        ...
        {
            VerifyGenericTypeArguments(
                typeof(Test_CIG_Int<string>).Project(),
                new string[] { "String" },
                new string[] { "String", "Int32" }
            );
        }
        ...
        private static void VerifyGenericTypeArguments(
            Type type,
            string[] expectedGTA,
