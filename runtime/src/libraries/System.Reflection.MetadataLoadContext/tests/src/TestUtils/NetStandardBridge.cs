    ...
    internal static class NetCoreApiEmulators
    {
        ...
        public static bool IsByRefLike(this Type t)
        {
            if (t.IsImplementedByRuntime())
                return t.CustomAttributes.Any(cad =>
        ...
        //
        public static T CallUsingReflection<T>(
            this object _this,
            string name,
        ...
        )
        {
            ...
            MethodInfo m = implementationType.GetMethod(
                name,
            ...
            if (m == null)
                throw new Exception(
                    "This Reflection provider does not support this method: " + name
                );
