    ...
    public class StackFrameTests
    {
        ...
        public void Ctor_Default()
        {
            ...
            VerifyStackFrame(
                ...
                false,
                0,
                typeof(StackFrameTests).GetMethod(nameof(Ctor_Default)),
                isCurrentFrame: true
            );
        }
        ...
        public void Ctor_FNeedFileInfo(bool fNeedFileInfo)
        {
            ...
            VerifyStackFrame(
                ...
                fNeedFileInfo,
                0,
                typeof(StackFrameTests).GetMethod(nameof(Ctor_FNeedFileInfo))
            );
        }
        ...
        public void Ctor_SkipFrames(int skipFrames)
        {
            ...
            VerifyStackFrame(
                ...
                true,
                skipFrames,
                typeof(StackFrameTests).GetMethod(nameof(Ctor_SkipFrames)),
                isCurrentFrame: skipFrames == 0
            );
        }
        ...
        public void Ctor_SkipFrames_FNeedFileInfo(int skipFrames, bool fNeedFileInfo)
        {
            ...
            VerifyStackFrame(
                ...
                fNeedFileInfo,
                skipFrames,
                typeof(StackFrameTests).GetMethod(nameof(Ctor_SkipFrames_FNeedFileInfo))
            );
        }
        ...
        public void Ctor_Filename_LineNumber(string fileName, int lineNumber)
        {
            ...
            VerifyStackFrameSkipFrames(
                stackFrame,
                true,
                0,
                typeof(StackFrameTests).GetMethod(nameof(Ctor_Filename_LineNumber))
            );
        }
        ...
        public void Ctor_Filename_LineNumber_ColNumber(
            string fileName,
            int lineNumber,
            int columnNumber
        )
        {
            ...
            VerifyStackFrameSkipFrames(
                ...
                true,
                0,
                typeof(StackFrameTests).GetMethod(nameof(Ctor_Filename_LineNumber_ColNumber))
            );
        }
        ...
        public static IEnumerable<object[]> ToString_TestData()
        {
            ...
            {
                new StackFrame(),
                "MoveNext at offset {offset} in file:line:column {fileName}:{lineNumber}:{column}"
                    + Environment.NewLine
            };
            yield return new object[]
            {
                new StackFrame("FileName", 1, 2),
                "MoveNext at offset {offset} in file:line:column FileName:1:2" + Environment.NewLine
            };
            yield return new object[]
            {
                new StackFrame(int.MaxValue),
                "<null>" + Environment.NewLine
            };
            yield return new object[]
            {
                GenericMethod<string>(),
                "GenericMethod<T> at offset {offset} in file:line:column {fileName}:{lineNumber}:{column}"
                    + Environment.NewLine
            };
            yield return new object[]
            {
                GenericMethod<string, int>(),
                "GenericMethod<T,U> at offset {offset} in file:line:column {fileName}:{lineNumber}:{column}"
                    + Environment.NewLine
            };
            yield return new object[]
            {
                new ClassWithConstructor().StackFrame,
                ".ctor at offset {offset} in file:line:column {fileName}:{lineNumber}:{column}"
                    + Environment.NewLine
            };
        }
        ...
        public void ToString_Invoke_ReturnsExpected(StackFrame stackFrame, string expectedToString)
        {
            expectedToString = expectedToString
                .Replace("{offset}", stackFrame.GetNativeOffset().ToString())
        ...
        private static void VerifyStackFrame(
        ...
        private static void VerifyStackFrameSkipFrames(
            StackFrame stackFrame,
            bool isFileConstructor,
            int skipFrames,
            MethodInfo expectedMethod,
            bool isCurrentFrame = false
        )
        {
            ...
            {
                Assert.True(
                    stackFrame.GetILOffset() >= 0,
                    $"Expected GetILOffset() {stackFrame.GetILOffset()} for {stackFrame} to be greater or equal to zero."
                );
            }
            ...
            {
                Assert.True(
                    stackFrame.GetNativeOffset() > 0,
                    $"Expected GetNativeOffset() {stackFrame.GetNativeOffset()} for {stackFrame} to be greater than zero."
                );
