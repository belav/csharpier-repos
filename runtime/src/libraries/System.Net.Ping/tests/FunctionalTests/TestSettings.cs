...
namespace System.Net.NetworkInformation.Tests
{
    internal static class TestSettings
    {
        ...
        public static readonly byte[] PayloadAsBytes = Encoding.UTF8
            .GetBytes(TestSettings.PayloadAsString);

        public static readonly byte[] PayloadAsBytesShort = Encoding.UTF8
        ...
        )
        {
            ...
            if (addressFamily == AddressFamily.Unspecified)
            {
                ...
                throw new InvalidOperationException(
                    "Unable to discover any addresses for the local host."
                );
            }
