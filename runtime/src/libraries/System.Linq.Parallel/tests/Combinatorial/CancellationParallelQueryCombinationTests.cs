...
namespace System.Linq.Parallel.Tests
{
    public static partial class ParallelQueryCombinationTests
    {
        ...
        )
        {
            ...
            AssertThrows.EventuallyCanceled(
                (source, canceler) => operation.Item(source, canceler).Aggregate(0, (i, j) => j)
            );
            AssertThrows.EventuallyCanceled(
                (source, canceler) =>
                    operation.Item(source, canceler).Aggregate(0, (i, j) => j, i => i)
            );
            AssertThrows.EventuallyCanceled(
                (source, canceler) =>
                    operation.Item(source, canceler).Aggregate(0, (i, j) => j, (i, j) => i, i => i)
            );
            AssertThrows.EventuallyCanceled(
                (source, canceler) =>
                    operation
                        .Item(source, canceler)
                        .Aggregate(() => 0, (i, j) => j, (i, j) => i, i => i)
            );
        }
        ...
        )
        {
            AssertThrows.AlreadyCanceled(source =>
                operation.Item(source, () => { }).Aggregate((x, y) => x)
            );
            AssertThrows.AlreadyCanceled(source =>
                operation.Item(source, () => { }).Aggregate(0, (x, y) => x + y)
            );
            AssertThrows.AlreadyCanceled(source =>
                operation.Item(source, () => { }).Aggregate(0, (x, y) => x + y, r => r)
            );
            AssertThrows.AlreadyCanceled(source =>
                operation
                    .Item(source, () => { })
        ...
        )
        {
            ...
            AssertThrows.EventuallyCanceled(
                (source, canceler) => operation.Item(source, canceler).Average(x => (int?)x)
            );

            AssertThrows.EventuallyCanceled(
                (source, canceler) => operation.Item(source, canceler).Average(x => (long)x)
            );
            AssertThrows.EventuallyCanceled(
                (source, canceler) => operation.Item(source, canceler).Average(x => (long?)x)
            );
            ...
            AssertThrows.EventuallyCanceled(
                (source, canceler) => operation.Item(source, canceler).Average(x => (float)x)
            );
            AssertThrows.EventuallyCanceled(
                (source, canceler) => operation.Item(source, canceler).Average(x => (float?)x)
            );
            ...
            AssertThrows.EventuallyCanceled(
                (source, canceler) => operation.Item(source, canceler).Average(x => (double)x)
            );
            AssertThrows.EventuallyCanceled(
                (source, canceler) => operation.Item(source, canceler).Average(x => (double?)x)
            );
            ...
            AssertThrows.EventuallyCanceled(
                (source, canceler) => operation.Item(source, canceler).Average(x => (decimal)x)
            );
            AssertThrows.EventuallyCanceled(
                (source, canceler) => operation.Item(source, canceler).Average(x => (decimal?)x)
            );
        ...
        {
            AssertThrows.AlreadyCanceled(source =>
                operation.Item(source, () => { }).Contains(DefaultStart)
            );
        }
        ...
        )
        {
            ...
            AssertThrows.EventuallyCanceled(
                (source, canceler) => operation.Item(source, canceler).LongCount()
            );
            AssertThrows.EventuallyCanceled(
                (source, canceler) => operation.Item(source, canceler).Count(x => true)
            );
            AssertThrows.EventuallyCanceled(
                (source, canceler) => operation.Item(source, canceler).LongCount(x => true)
            );
        }
        ...
        )
        {
            ...
            AssertThrows.AlreadyCanceled(source =>
                operation.Item(source, () => { }).Count(x => true)
            );
            AssertThrows.AlreadyCanceled(source =>
                operation.Item(source, () => { }).LongCount(x => true)
            );
        }
        ...
        {
            AssertThrows.AlreadyCanceled(source =>
                operation.Item(source, () => { }).ElementAtOrDefault(0)
            );
            AssertThrows.AlreadyCanceled(source =>
                operation.Item(source, () => { }).ElementAtOrDefault(DefaultSize + 1)
            );
        }
        ...
        )
        {
            ...
            AssertThrows.AlreadyCanceled(source =>
                operation.Item(source, () => { }).First(x => false)
            );
        }
        ...
        {
            AssertThrows.AlreadyCanceled(source =>
                operation.Item(source, () => { }).FirstOrDefault()
            );
            AssertThrows.AlreadyCanceled(source =>
                operation.Item(source, () => { }).FirstOrDefault(x => false)
            );
        }
        ...
        {
            AssertThrows.AlreadyCanceled(source =>
                operation.Item(source, () => { }).ForAll(x => { })
            );
        }
        ...
        )
        {
            AssertThrows.EventuallyCanceled(
                (source, canceler) =>
                {
                    foreach (int i in operation.Item(source, canceler))
                        ;
                }
            );
        }
        ...
        )
        {
            ...
            AssertThrows.EventuallyCanceled(
                (source, canceler) => operation.Item(source, canceler).Last(x => true)
            );
        }
        ...
        )
        {
            ...
            AssertThrows.EventuallyCanceled(
                (source, canceler) => operation.Item(source, canceler).LastOrDefault(x => true)
            );
        }
        ...
        )
        {
            ...
            AssertThrows.EventuallyCanceled(
                (source, canceler) => operation.Item(source, canceler).Max(x => (int)x)
            );
            AssertThrows.EventuallyCanceled(
                (source, canceler) => operation.Item(source, canceler).Max(x => (int?)x)
            );
            ...
            AssertThrows.EventuallyCanceled(
                (source, canceler) => operation.Item(source, canceler).Max(x => (long)x)
            );
            AssertThrows.EventuallyCanceled(
                (source, canceler) => operation.Item(source, canceler).Max(x => (long?)x)
            );
            ...
            AssertThrows.EventuallyCanceled(
                (source, canceler) => operation.Item(source, canceler).Max(x => (float)x)
            );
            AssertThrows.EventuallyCanceled(
                (source, canceler) => operation.Item(source, canceler).Max(x => (float?)x)
            );
            ...
            AssertThrows.EventuallyCanceled(
                (source, canceler) => operation.Item(source, canceler).Max(x => (double)x)
            );
            AssertThrows.EventuallyCanceled(
                (source, canceler) => operation.Item(source, canceler).Max(x => (double?)x)
            );
            ...
            AssertThrows.EventuallyCanceled(
                (source, canceler) => operation.Item(source, canceler).Max(x => (decimal)x)
            );
            AssertThrows.EventuallyCanceled(
                (source, canceler) => operation.Item(source, canceler).Max(x => (decimal?)x)
            );
        ...
        )
        {
            ...
            AssertThrows.EventuallyCanceled(
                (source, canceler) => operation.Item(source, canceler).Min(x => (int)x)
            );
            AssertThrows.EventuallyCanceled(
                (source, canceler) => operation.Item(source, canceler).Min(x => (int?)x)
            );
            ...
            AssertThrows.EventuallyCanceled(
                (source, canceler) => operation.Item(source, canceler).Min(x => (long)x)
            );
            AssertThrows.EventuallyCanceled(
                (source, canceler) => operation.Item(source, canceler).Min(x => (long?)x)
            );
            ...
            AssertThrows.EventuallyCanceled(
                (source, canceler) => operation.Item(source, canceler).Min(x => (float)x)
            );
            AssertThrows.EventuallyCanceled(
                (source, canceler) => operation.Item(source, canceler).Min(x => (float?)x)
            );
            ...
            AssertThrows.EventuallyCanceled(
                (source, canceler) => operation.Item(source, canceler).Min(x => (double)x)
            );
            AssertThrows.EventuallyCanceled(
                (source, canceler) => operation.Item(source, canceler).Min(x => (double?)x)
            );
            ...
            AssertThrows.EventuallyCanceled(
                (source, canceler) => operation.Item(source, canceler).Min(x => (decimal)x)
            );
            AssertThrows.EventuallyCanceled(
                (source, canceler) => operation.Item(source, canceler).Min(x => (decimal?)x)
            );
            ...
            AssertThrows.EventuallyCanceled(
                (source, canceler) =>
                    operation
                        .Item(source, canceler)
                        .SequenceEqual(
                            ParallelEnumerable.Range(0, EventualCancellationSize).AsOrdered()
                        )
            );
            AssertThrows.EventuallyCanceled(
                (source, canceler) =>
                    ParallelEnumerable
                        ...
                        .AsOrdered()
                        .SequenceEqual(operation.Item(source, canceler))
            );
        }
            ...
            SequenceEqual_AssertAggregateAlternateCanceled(
                (token, canceler) =>
                    WithCancellation(token, canceler, operation)
                        .SequenceEqual(ParallelEnumerable.Range(0, 128).AsOrdered())
            );
            SequenceEqual_AssertAggregateAlternateCanceled(
                (token, canceler) =>
                    ParallelEnumerable
                        .Range(0, 128)
                        .AsOrdered()
                        .SequenceEqual(WithCancellation(token, canceler, operation))
            );
            SequenceEqual_AssertAggregateNotCanceled(
                (token, canceler) =>
                    WithCancellation(token, canceler, operation)
                        .SequenceEqual(ParallelEnumerable.Range(0, 128).AsOrdered())
            );
        ...
        )
        {
            ...
            AssertThrows.AlreadyCanceled(source =>
                operation.Item(source, () => { }).Single(x => false)
            );
        }
        ...
        {
            AssertThrows.AlreadyCanceled(source =>
                operation.Item(source, () => { }).SingleOrDefault()
            );
            AssertThrows.AlreadyCanceled(source =>
                operation.Item(source, () => { }).SingleOrDefault(x => false)
            );
        }
        ...
        )
        {
            ...
            AssertThrows.EventuallyCanceled(
                (source, canceler) => operation.Item(source, canceler).Sum(x => (int?)x)
            );

            AssertThrows.EventuallyCanceled(
                (source, canceler) => operation.Item(source, canceler).Sum(x => (long)x)
            );
            AssertThrows.EventuallyCanceled(
                (source, canceler) => operation.Item(source, canceler).Sum(x => (long?)x)
            );
            ...
            AssertThrows.EventuallyCanceled(
                (source, canceler) => operation.Item(source, canceler).Sum(x => (float)x)
            );
            AssertThrows.EventuallyCanceled(
                (source, canceler) => operation.Item(source, canceler).Sum(x => (float?)x)
            );
            ...
            AssertThrows.EventuallyCanceled(
                (source, canceler) => operation.Item(source, canceler).Sum(x => (double)x)
            );
            AssertThrows.EventuallyCanceled(
                (source, canceler) => operation.Item(source, canceler).Sum(x => (double?)x)
            );
            ...
            AssertThrows.EventuallyCanceled(
                (source, canceler) => operation.Item(source, canceler).Sum(x => (decimal)x)
            );
            AssertThrows.EventuallyCanceled(
                (source, canceler) => operation.Item(source, canceler).Sum(x => (decimal?)x)
            );
        ...
        )
        {
            ...
            AssertThrows.EventuallyCanceled(
                (source, canceler) => operation.Item(source, canceler).ToDictionary(x => x, y => y)
            );
        }
        ...
        {
            AssertThrows.AlreadyCanceled(source =>
                operation.Item(source, () => { }).ToDictionary(x => x)
            );
            AssertThrows.AlreadyCanceled(source =>
                operation.Item(source, () => { }).ToDictionary(x => x, y => y)
            );
        }
        ...
        )
        {
            ...
            AssertThrows.EventuallyCanceled(
                (source, canceler) => operation.Item(source, canceler).ToLookup(x => x, y => y)
            );
        }
        ...
        {
            AssertThrows.AlreadyCanceled(source =>
                operation.Item(source, () => { }).ToLookup(x => x)
            );
            AssertThrows.AlreadyCanceled(source =>
                operation.Item(source, () => { }).ToLookup(x => x, y => y)
            );
        }

        private static ParallelQuery<int> WithCancellation(
        ...
        )
        {
            ...
            Action canceler = () =>
            {
                throw new OperationCanceledException(cs.Token);
            };
