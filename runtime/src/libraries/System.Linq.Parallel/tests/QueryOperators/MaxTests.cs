    ...
    public static class MaxTests
    {
        ...
        public static IEnumerable<object[]> MaxData(int[] counts)
        {
            ...
            foreach (int count in counts)
            {
                ...
                {
                    Labeled.Label("Default", UnorderedSources.Default(0, count)),
                    count,
                    Max(count)
                };
            }
        ...
        [Theory]
        [MemberData(nameof(MaxData), new[] { 1, 2, 16 })]
        public static void Max_Long_SomeNull(
            Labeled<ParallelQuery<int>> labeled,
            int count,
            long max
        ) {
        ...
        [Theory]
        [MemberData(nameof(MaxData), new[] { 1, 2, 16 })]
        public static void Max_Long_AllNull(
            Labeled<ParallelQuery<int>> labeled,
            int count,
            long max
        ) {
        ...
        public static void Max_Float(Labeled<ParallelQuery<int>> labeled, int count, float max)
        {
            ...
            Assert.Equal(
                ...
                query.Select(x => x == count / 2 ? float.PositiveInfinity : x).Max()
            );
            Assert.Equal(
                float.PositiveInfinity,
                query.Select(x => x == count / 2 ? (float?)float.PositiveInfinity : x).Max()
            );
        }
        ...
        [Theory]
        [MemberData(nameof(MaxData), new[] { 1, 2, 16 })]
        public static void Max_Float_SomeNull(
            Labeled<ParallelQuery<int>> labeled,
            int count,
            float max
        ) {
        ...
        [Theory]
        [MemberData(nameof(MaxData), new[] { 1, 2, 16 })]
        public static void Max_Float_AllNull(
            Labeled<ParallelQuery<int>> labeled,
            int count,
            float max
        ) {
        ...
        public static void Max_Double(Labeled<ParallelQuery<int>> labeled, int count, double max)
        {
            ...
            Assert.Equal(
                ...
                query.Select(x => x == count / 2 ? double.PositiveInfinity : x).Max()
            );
            Assert.Equal(
                double.PositiveInfinity,
                query.Select(x => x == count / 2 ? (double?)double.PositiveInfinity : x).Max()
            );
        }
        ...
        [Theory]
        [MemberData(nameof(MaxData), new[] { 1, 2, 16 })]
        public static void Max_Double_SomeNull(
            Labeled<ParallelQuery<int>> labeled,
            int count,
            double max
        ) {
        ...
        [Theory]
        [MemberData(nameof(MaxData), new[] { 1, 2, 16 })]
        public static void Max_Double_AllNull(
            Labeled<ParallelQuery<int>> labeled,
            int count,
            double max
        ) {
        ...
        [Theory]
        [MemberData(nameof(MaxData), new[] { 1, 2, 16 })]
        public static void Max_Decimal_SomeNull(
            Labeled<ParallelQuery<int>> labeled,
            int count,
            decimal max
        ) {
        ...
        [Theory]
        [MemberData(nameof(MaxData), new[] { 1, 2, 16 })]
        public static void Max_Decimal_AllNull(
            Labeled<ParallelQuery<int>> labeled,
            int count,
            decimal max
        ) {
        ...
        public static void Max_Other(Labeled<ParallelQuery<int>> labeled, int count, int max)
        {
            ...
            Assert.Equal(
                max,
                query.Select(x => DelgatedComparable.Delegate(x, Comparer<int>.Default)).Max().Value
            );
            Assert.Equal(
                0,
        ...
        public static void Max_NotComparable(
            Labeled<ParallelQuery<int>> labeled,
            int count,
            int max
        ) {
        ...
        [Theory]
        [MemberData(nameof(MaxData), new[] { 1, 2, 16 })]
        public static void Max_Other_SomeNull(
            Labeled<ParallelQuery<int>> labeled,
            int count,
            int max
        ) {
        ...
        [Theory]
        [MemberData(nameof(MaxData), new[] { 1, 2, 16 })]
        public static void Max_Other_AllNull(
            Labeled<ParallelQuery<int>> labeled,
            int count,
            int max
        ) {
