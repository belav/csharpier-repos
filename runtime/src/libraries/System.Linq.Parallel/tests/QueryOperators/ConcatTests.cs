...
namespace System.Linq.Parallel.Tests
{
    public static class ConcatTests
    {
        ...
        {
            foreach (
                object[] parms in UnorderedSources.BinaryRanges(
...
#pragma warning restore 618
        ...
        public static void Concat_UnionSources_PrematureMerges()
        {
            ...
            ParallelQuery<int> leftQuery = ParallelEnumerable
                .Range(0, ElementCount / 4)
                .Union(ParallelEnumerable.Range(ElementCount / 4, ElementCount / 4));
            ParallelQuery<int> rightQuery = ParallelEnumerable
                .Range(2 * ElementCount / 4, ElementCount / 4)
