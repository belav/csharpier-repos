...
namespace System.Runtime.Serialization.Schema.Tests
{
    internal class SchemaUtils
    {
        ...
        internal static XmlSchemaSet IsReferenceSchemas =>
            ReadStringsIntoSchemaSet(_isReferenceSchemas);
        ...
        internal static string[] NegativeSchemaStrings = new string[]
        {
            @"", // null
        ...
        internal static (
            ...
            string schemaString
        )[] CanImportTests = new (bool, bool, XmlQualifiedName[], string)[]
        {
            (
                false,
                false,
        ...
        internal static XmlQualifiedName[] ValidTypeNames = new XmlQualifiedName[]
        {
            ...
            new XmlQualifiedName(
                "AnotherValidType",
                "http://schemas.datacontract.org/2004/07/barNs"
            ),
            new XmlQualifiedName(
                "NonAttributedType",
                "http://schemas.datacontract.org/2004/07/Suites.SchemaImport"
            ),
            new XmlQualifiedName(
                "NonRefType",
                "http://schemas.datacontract.org/2004/07/Suites.SchemaImport.ReferencedTypes"
            ),
            new XmlQualifiedName(
                "RefType1",
                "http://schemas.datacontract.org/2004/07/Suites.SchemaImport.ReferencedTypes"
        ...
        internal static string GlobalSchema =
            @"<xs:schema targetNamespace='http://myns/'  xmlns:tns='http://myns/' xmlns:xs='http://www.w3.org/2001/XMLSchema'>
        ...
        internal static void SetSchemaString(
            XmlSchemaSet schemaSet,
            string targetNs,
            string schemaString
        )
        ...
        internal static string InsertElement(
            string xml,
            string xpath,
            string xmlFrag,
            bool insertAfter
