...
namespace System.Runtime.Serialization.Schema.Tests
{
    ...
    public class SurrogateTests
    {
        ...
        public void DefaultScenario()
        {
            ...
            Assert.Contains(
                @"[assembly: System.Runtime.Serialization.ContractNamespaceAttribute(""http://special1.tempuri.org"", ClrNamespace=""special1.tempuri.org"")]",
                code
            );
            Assert.Contains(
            ...
            Assert.Matches(
                @"\[System.Runtime.Serialization.DataContractAttribute\(Name=""CircleContainer"", Namespace=""http://special1.tempuri.org""\)\]\s*public partial class CircleContainer : object, System.Runtime.Serialization.IExtensibleDataObject",
                code
            );
            Assert.Contains(
                @"private System.Runtime.Serialization.Schema.Tests.DataContracts.SerializableSquare[] circlesField;",
                code
            );
            Assert.Contains(
                @"private System.Runtime.Serialization.Schema.Tests.DataContracts.SerializableSquare CircleField;",
                code
            );
            Assert.Matches(
                @"\[System.Runtime.Serialization.DataMemberAttribute\(\)\]\s*public System.Runtime.Serialization.Schema.Tests.DataContracts.SerializableSquare Circle",
                code
            );
            Assert.Contains(
                @"public partial class SerializableSquare : object, System.Runtime.Serialization.IExtensibleDataObject",
                code
            );
            ...
            Assert.Matches(
                @"\[System.Runtime.Serialization.DataContractAttribute\(Name\s*=\s*""SerializableNode"", Namespace\s*=\s*""http://schemas.datacontract.org/2004/07/System.Runtime.Serialization.Schema.Tests""\s*\+\s*"".DataContracts""\)\]\s*public partial class SerializableNode : object, System.Runtime.Serialization.IExtensibleDataObject",
                code
            );
            Assert.Matches(
                @"\[System.Xml.Serialization.XmlSchemaProviderAttribute\(""ExportSchema""\)\]\s*\[System.Xml.Serialization.XmlRootAttribute\(ElementName\s*=\s*""XmlSerializerPersonElement"", Namespace\s*=\s*""""\)\]\s*public partial class XmlSerializerPerson : object, System.Xml.Serialization.IXmlSerializable",
                code
            );
        }
        ...
        public void WithReferencedType()
        {
            ...
            Assert.Contains(
                @"private System.Runtime.Serialization.Schema.Tests.DataContracts.SerializableCircle CircleField;",
                code
            );
            Assert.Matches(
                @"\[System.Runtime.Serialization.DataMemberAttribute\(\)\]\s*public System.Runtime.Serialization.Schema.Tests.DataContracts.SerializableCircle Circle",
                code
            );
        ...
        public void WithSurrogateBinding()
        {
            ...
            Assert.Contains(
                @"private System.Runtime.Serialization.Schema.Tests.DataContracts.SerializableCircle[] circlesField;",
                code
            );
            Assert.Contains(
                @"private System.Runtime.Serialization.Schema.Tests.DataContracts.SerializableCircle CircleField;",
    ...
    {
        static XmlQualifiedName s_circleList = new XsdDataContractExporter().GetSchemaTypeName(
            typeof(SerializableCircle[])
        );
        static XmlQualifiedName s_square = new XsdDataContractExporter().GetSchemaTypeName(
            typeof(SerializableSquare)
        );
        static XmlQualifiedName s_serializableNode =
            new XsdDataContractExporter().GetSchemaTypeName(typeof(SerializableNode));
        static XmlQualifiedName s_xmlSerializerPersonAdapter =
            new XsdDataContractExporter().GetSchemaTypeName(
                typeof(XmlSerializerAdapter<XmlSerializerPerson>)
            );

        bool _surrogateBinding;

        public SurrogateProvider(bool surrogateBinding)
        {
            _surrogateBinding = surrogateBinding;
        }
        ...
        public Type? GetReferencedTypeOnImport(string name, string ns, object? customData)
        {
            if (!_surrogateBinding)
            {
                ...
                return (name == s_circleList.Name && ns == s_circleList.Namespace)
                    ? typeof(SerializableSquare[])
                    : null;
            }
            ...
            if (name == s_serializableNode.Name && ns == s_serializableNode.Namespace)
                return typeof(Node);
            if (
                name == s_xmlSerializerPersonAdapter.Name
                && ns == s_xmlSerializerPersonAdapter.Namespace
            )
