...
namespace System.Reflection.Tests
{
    public class AssemblyTests : FileCleanupTestBase
    {
        ...
        [ActiveIssue(
            "https://github.com/dotnet/runtime/issues/36892",
        ...
        public void GetEntryAssembly()
        {
            ...
            string expectedAssembly = PlatformDetection.IsNativeAot
                ? "System.Reflection.Tests"
                : "xunit.console";

            bool correct =
                assembly.IndexOf(expectedAssembly, StringComparison.OrdinalIgnoreCase) != -1;
...
#pragma warning restore SYSLIB0012
        ...
        [Fact]
        [ActiveIssue(
            "https://github.com/dotnet/runtime/issues/67569",
            typeof(PlatformDetection),
            nameof(PlatformDetection.IsNativeAot)
        )]
