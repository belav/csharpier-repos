...
namespace System.Reflection.Tests
{
    public class MethodInfoTests
    {
        ...
        [Fact]
        [ActiveIssue(
            "https://github.com/dotnet/runtime/issues/67531",
        ...
        public void InvokeNullableRefs()
        {
            ...
            args = new object[] { iNull, 10 };
            Assert.True(
                (bool)GetMethod(nameof(NullableRefMethods.NullToValueBoxed)).Invoke(null, args)
            );
            Assert.IsType<int>(args[0]);
            Assert.Equal(10, (int)args[0]);
        ...
        public static void InvokeCopiesBackMissingArgument(
            string methodName,
            object defaultValue,
            object passingValue
        )
        ...
        {
            MethodInfo mi = typeof(System.Reflection.TestAssembly.ClassToInvoke).GetMethod(
                nameof(System.Reflection.TestAssembly.ClassToInvoke.CallMe_AggressiveInlining),
                BindingFlags.Public | BindingFlags.Static
            )!;
