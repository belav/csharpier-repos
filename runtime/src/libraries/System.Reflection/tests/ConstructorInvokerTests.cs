...
namespace System.Reflection.Tests
{
    ...
    public sealed class ConstructorInvokerTests : ConstructorCommonTests
    {
        ...
        public void Args_0()
        {
            ConstructorInvoker invoker = ConstructorInvoker.Create(
        ...
        {
            ConstructorInvoker invoker = ConstructorInvoker.Create(
                typeof(TestClass).GetConstructor(new Type[] { typeof(string) })
            );
            Assert.Equal("1", ((TestClass)invoker.Invoke("1"))._args);
            Assert.Equal(
                "1",
                ((TestClass)invoker.Invoke(new Span<object?>(new object[] { "1" })))._args
            );
        }
        ...
        {
            ConstructorInvoker invoker = ConstructorInvoker.Create(
                typeof(TestClass).GetConstructor(new Type[] { typeof(string), typeof(string) })
            );

            Assert.Equal("12", ((TestClass)invoker.Invoke("1", "2"))._args);
            Assert.Equal(
                "12",
                ((TestClass)invoker.Invoke(new Span<object?>(new object[] { "1", "2" })))._args
            );
        }
        ...
        public void Args_3()
        {
            ...
            Assert.Equal(
                "123",
                ((TestClass)invoker.Invoke(new Span<object?>(new object[] { "1", "2", "3" })))._args
            );
        }
        ...
        public void Args_4()
        {
            ...
            Assert.Equal(
                ...
                (
                    (TestClass)
                        invoker.Invoke(new Span<object?>(new object[] { "1", "2", "3", "4" }))
                )._args
            );
        }
        ...
        {
            ConstructorInvoker invoker = ConstructorInvoker.Create(
                typeof(TestClassThrowsOnCreate).GetConstructor(new Type[] { })
            );
        ...
        {
            ConstructorInvoker invoker = ConstructorInvoker.Create(
                typeof(TestClassThrowsOnCreate).GetConstructor(new Type[] { typeof(string) })
            );
        ...
        {
            ConstructorInvoker invoker = ConstructorInvoker.Create(
                typeof(TestClassThrowsOnCreate).GetConstructor(
                    new Type[]
                    {
                        typeof(string),
                        typeof(string),
        ...
        {
            public TestClassThrowsOnCreate() => throw new InvalidOperationException();

            public TestClassThrowsOnCreate(string arg1) => throw new InvalidOperationException();
