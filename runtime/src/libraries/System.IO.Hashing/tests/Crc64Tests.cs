...
namespace System.IO.Hashing.Tests
{
    public class Crc64Tests : NonCryptoHashTestDriver
    {
        ...
        public Crc64Tests() : base(s_emptyHashValue) { }
        ...
        protected static IEnumerable<TestCase> TestCaseDefinitions { get; } =
            new[]
            {
                new TestCase("Empty", "", "0000000000000000"),
                new TestCase("One", "01", "42F0E1EBA9EA3693"),
                ...
                new TestCase("{ 0x00 }", "00", "0000000000000000"),
                // Once it has left the initial state, zero-value bytes matter.
                new TestCase("{ 0x01, 0x00 }", "0100", "AF052A6B538EDF09"),
                new TestCase("Zero-Residue", "0000000000000000", "0000000000000000"),
                new TestCase("Self-test 123456789", "123456789"u8.ToArray(), "6C40DF5F0B497347"),
                new TestCase(
                    "Self-test residue",
