    ...
    public class XxHash3Tests
    {
        ...
        public void Hash_OneShot_Expected()
        {
            ...
            foreach ((ulong Hash, long Seed, string Ascii) test in TestCases())
            {
                ...
                if (test.Seed == 0)
                {
                    Assert.Equal(
                        test.Hash,
                        BinaryPrimitives.ReadUInt64BigEndian(XxHash3.Hash(input))
                    );
                    Assert.Equal(
                        test.Hash,
                        BinaryPrimitives.ReadUInt64BigEndian(
                            XxHash3.Hash((ReadOnlySpan<byte>)input)
                        )
                    );
                }
                Assert.Equal(
                    test.Hash,
                    BinaryPrimitives.ReadUInt64BigEndian(XxHash3.Hash(input, test.Seed))
                );
                Assert.Equal(
                    test.Hash,
                    BinaryPrimitives.ReadUInt64BigEndian(
                        XxHash3.Hash((ReadOnlySpan<byte>)input, test.Seed)
                    )
                );
        ...
        public void Hash_Streaming_Expected()
        {
            ...
            foreach ((ulong Hash, long Seed, string Ascii) test in TestCases().OrderBy(t => t.Seed))
            {
                ...
                {
                    XxHash3 hash = ctorIteration == 0 ? new XxHash3(test.Seed) : new XxHash3();
                    ...
                    for (int trial = 0; trial < 2; trial++)
                    {
                        ...
                        while (!input.IsEmpty)
                        {
                            ...
                            Assert.Equal(
                                XxHash3.HashToUInt64(asciiBytes.AsSpan(0, processed), test.Seed),
        ...
        private static IEnumerable<(ulong Hash, long Seed, string Ascii)> TestCases()
        {
            ...
            yield return (
                Hash: 0x2f37d7c5257055c5UL,
                Seed: 0x000000000000021fL,
                Ascii: "a2WBB5GKMkHnAySB7uXFtoT8z1GgX0MPgzX4Zu4QWjZ5sfUPXZq3UXFUbG74Fw8Jk55geWbT9PB35YSVEbtIizEgLcpOll09vmDXlLcR6MxmGl6apvXEAodsve1dgw4eq9Lsx8LLdd5kJY1HlJL7Sd4fckloMiVNR1n8UdOzUdyZa0T0iKRc9wYvpG6py0QWwevVqXlZjwEyYmSQsHoXEtwzjUaRL5Fx15E21ANuyugJVKk7S"
            ...
            yield return (
                Hash: 0xda2ff091f3590e72UL,
                Seed: 0x0000000000001865L,
                Ascii: "USxLu2Huv2su0RCa7ZAFf0cMpMLk7oYmPAUhnDBXAQyRMWT8Eoryj3FWiuo6LaGF60OFmx5lUXL6jvD741QrSZ54Ik312oxZurB9bBdCwQVzfnM65KgPdW3Adl5EQCf2zY8v9KZmkSjp6hIBc0iBhJtB1Pj2keW35tvQQhTfMWhmIHM2ZpB4AwK8aPrax3EmoGvs2sjcaijbVZOBQu1SNff8QmAWK4k6FldD3a7oz0OYk1rxaT"
            ...
            yield return (
                Hash: 0x80eb9cc47d75ef79UL,
                Seed: 0x0000000000000000L,
                Ascii: "TI6XYevJji9MGqpXH8Wa3hChji5jt91W8MyhwuKrpPUEBwp9sqWdebdVvoOEfJ2vGg1lNZIvuLwmVDKd8Vou3qGCT5VcqI8goIxXDF0jZF0XDLAQXCFikOvcx0CvZZYJjBVqiY49rbSIAqw4CdR2ex3guwaubHERWWU1WL4AwBYvqM40BZVP52jArDymVhTEg7kjsEgOPQbYxHCOiE0OVgDxvOfvLfnOvbVHAbJtACeFR7EuTQ"
            ...
            yield return (
                Hash: 0x58793064f61ffc57UL,
                Seed: 0x104dff97b01e2965L,
                Ascii: "OeWmLYqrzy5uyrJpXEdAKKylrcZqYQ3vcpqZ5qMNlhCR2cSVfKIImaObd0qLjRPXXtHA3Ql0vBXbWRKXcCTxLpVAiPRx39Rgc8F6tMTBhLKh3rIq3ZU8r21tsdsnsnmHfxFgdcRTjdacf3Ml8eQIH8eelifyq3po08CvFbR1WF4DCDuRNCBd8THV6eTVMumdzRG2L9Vr2qVDsRkSzaDKAghjfLrnhxbDxtcXJKA8Lw9aIFJSNo"
            ...
            yield return (
                Hash: 0xc05b765025561928UL,
                Seed: 0x0000000000000000L,
                Ascii: "iyWHI6mdPnxxYq6y3OF9nYbygTqAT8PWWoFZtq7PntXBgqqwIhA6vYF4SLIQwN9to5YH2CYIXqJ6ZmTxbw1GJwnUfdOYDtUQgX3ZioRMKDlHdIwjlYPD4wEvPGu3aRl5R0sW9ppujWlpFO7I2CrNVXb4mBxCAgjbRCoONwDStGDirdQeU1Ug5KfwfWYDSUYr2rUfeBV3O4HcH36SgY7LlIqIvKBEBgBnUa9gUMeD5dAyNAlqvR"
