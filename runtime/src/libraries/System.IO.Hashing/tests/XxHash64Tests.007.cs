...
namespace System.IO.Hashing.Tests
{
    public class XxHash64Tests_Seeded_007 : NonCryptoHashTestDriver
    {
        ...
        public XxHash64Tests_Seeded_007() : base(s_emptyHashValue) { }
        ...
        protected static IEnumerable<TestCase> TestCaseDefinitions { get; } =
            new[]
            {
                ...
                new TestCase("abc", Encoding.ASCII.GetBytes("abc"), "6BF4B26E3CA10C20"),
                new TestCase("123456", "313233343536", "CA35E96DF53D4962"),
                new TestCase(
