...
{
    /// <summary>
    /// RandomNumberGenerator implementation is the 64-bit random number generator based on the
    // Xoshiro256StarStar algorithm (known as shift-register generators).
    /// </summary>
    internal sealed class RandomNumberGenerator
    {
        ...
        public unsafe RandomNumberGenerator()
        {
            do
            {
                ...
                // Guid uses the 4 most significant bits of the first long as the version which would be fixed and
                // not randomized.
                // and uses 2 other bits in the second long for variants which would be fixed and not randomized
                // too.
