...
namespace System.Diagnostics.Metrics.Tests
{
    public class MetricsTests
    {
        ...
        public void InstrumentCreationTest()
        {
            RemoteExecutor
                .Invoke(() =>
                {
                    ...
                    UpDownCounter<int> upDownCounter = meter.CreateUpDownCounter<int>(
                        "UpDownCounter",
                        "seconds",
                        "Seconds UpDownCounter"
                    );
                    ValidateInstrumentInfo(
                        upDownCounter,
                        "UpDownCounter",
                    ...
                    Histogram<float> histogram = meter.CreateHistogram<float>(
                        "Histogram",
                        "centimeters",
                        "centimeters Histogram"
                    );
                    ValidateInstrumentInfo(
                        histogram,
                        "Histogram",
                    ...
                    ObservableCounter<long> observableCounter = meter.CreateObservableCounter<long>(
                        "ObservableCounter",
                        () => 10,
                        "millisecond",
                    ...
                    ObservableUpDownCounter<long> observableUpDownCounter =
                        meter.CreateObservableUpDownCounter<long>(
                            "ObservableUpDownCounter",
                            () => -1,
                            "request",
                            "request ObservableUpDownCounter"
                        );
                    ValidateInstrumentInfo(
                        observableUpDownCounter,
                        "ObservableUpDownCounter",
                    ...
                    ObservableGauge<double> observableGauge = meter.CreateObservableGauge<double>(
                        "ObservableGauge",
                        () => 10,
                        "Fahrenheit",
                        "Fahrenheit ObservableGauge"
                    );
                    ValidateInstrumentInfo(
                        observableGauge,
                        "ObservableGauge",
        ...
        public void SupportedGenericParameterTypesTest()
        {
            RemoteExecutor
                .Invoke(() =>
                {
                    ...
                    Counter<byte> counter1 = meter.CreateCounter<byte>(
                        "Counter1",
                        "seconds",
                        "Seconds Counter"
                    );
                    Counter<short> counter2 = meter.CreateCounter<short>(
                        "Counter2",
                        "seconds",
                        "Seconds Counter"
                    );
                    Counter<int> counter3 = meter.CreateCounter<int>(
                        "Counter3",
                        "seconds",
                        "Seconds Counter"
                    );
                    Counter<long> counter4 = meter.CreateCounter<long>(
                        "Counter4",
                        "seconds",
                        "Seconds Counter"
                    );
                    Counter<float> counter5 = meter.CreateCounter<float>(
                        "Counter5",
                        "seconds",
                        "Seconds Counter"
                    );
                    Counter<double> counter6 = meter.CreateCounter<double>(
                        "Counter6",
                        "seconds",
                        "Seconds Counter"
                    );
                    Counter<decimal> counter7 = meter.CreateCounter<decimal>(
                        "Counter7",
                        "seconds",
                        "Seconds Counter"
                    );

                    UpDownCounter<byte> upDownCounter1 = meter.CreateUpDownCounter<byte>(
                        "UpDownCounter1",
                        "seconds",
                        "Seconds UpDownCounter"
                    );
                    UpDownCounter<short> upDownCounter2 = meter.CreateUpDownCounter<short>(
                        "UpDownCounter2",
                        "seconds",
                        "Seconds Counter"
                    );
                    UpDownCounter<int> upDownCounter3 = meter.CreateUpDownCounter<int>(
                        "UpDownCounter3",
                        "seconds",
                        "Seconds UpDownCounter"
                    );
                    UpDownCounter<long> upDownCounter4 = meter.CreateUpDownCounter<long>(
                        "UpDownCounter4",
                        "seconds",
                        "Seconds UpDownCounter"
                    );
                    UpDownCounter<float> upDownCounter5 = meter.CreateUpDownCounter<float>(
                        "UpDownCounter5",
                        "seconds",
                        "Seconds UpDownCounter"
                    );
                    UpDownCounter<double> upDownCounter6 = meter.CreateUpDownCounter<double>(
                        "UpDownCounter6",
                        "seconds",
                        "Seconds UpDownCounter"
                    );
                    UpDownCounter<decimal> upDownCounter7 = meter.CreateUpDownCounter<decimal>(
                        "UpDownCounter7",
                        "seconds",
                        "Seconds UpDownCounter"
                    );

                    Histogram<byte> histogram1 = meter.CreateHistogram<byte>(
                        "histogram1",
                        "seconds",
                        "Seconds histogram"
                    );
                    Histogram<short> histogram2 = meter.CreateHistogram<short>(
                        "histogram2",
                        "seconds",
                        "Seconds histogram"
                    );
                    Histogram<int> histogram3 = meter.CreateHistogram<int>(
                        "histogram3",
                        "seconds",
                        "Seconds histogram"
                    );
                    Histogram<long> histogram4 = meter.CreateHistogram<long>(
                        "histogram4",
                        "seconds",
                        "Seconds histogram"
                    );
                    Histogram<float> histogram5 = meter.CreateHistogram<float>(
                        "histogram5",
                        "seconds",
                        "Seconds histogram"
                    );
                    Histogram<double> histogram6 = meter.CreateHistogram<double>(
                        "histogram6",
                        "seconds",
                        "Seconds histogram"
                    );
                    Histogram<decimal> histogram7 = meter.CreateHistogram<decimal>(
                        "histogram7",
                        "seconds",
                        "Seconds histogram"
                    );

                    ObservableCounter<byte> observableCounter1 =
                    ...
                    ObservableCounter<short> observableCounter2 =
                    ...
                    ObservableCounter<int> observableCounter3 = meter.CreateObservableCounter<int>(
                        "observableCounter3",
                        () => 0,
                        "seconds",
                        "Seconds ObservableCounter"
                    );
                    ObservableCounter<long> observableCounter4 =
                        meter.CreateObservableCounter<long>(
                            "observableCounter4",
                            () => 0,
                            "seconds",
                    ...
                    ObservableCounter<float> observableCounter5 =
                    ...
                    ObservableCounter<double> observableCounter6 =
                    ...
                    ObservableCounter<decimal> observableCounter7 =
                    ...
                    ObservableUpDownCounter<byte> observableUpDownCounter1 =
                        meter.CreateObservableUpDownCounter<byte>(
                            "observableUpDownCounter1",
                            () => 0,
                            "items",
                            "Items ObservableUpDownCounter"
                        );
                    ObservableUpDownCounter<short> observableUpDownCounter2 =
                        meter.CreateObservableUpDownCounter<short>(
                            "observableUpDownCounter2",
                            () => 0,
                            "items",
                            "Items ObservableCounter"
                        );
                    ObservableUpDownCounter<int> observableUpDownCounter3 =
                        meter.CreateObservableUpDownCounter<int>(
                            "observableUpDownCounter3",
                            () => 0,
                            "items",
                            "Items ObservableUpDownCounter"
                        );
                    ObservableUpDownCounter<long> observableUpDownCounter4 =
                        meter.CreateObservableUpDownCounter<long>(
                            "observableUpDownCounter4",
                            () => 0,
                            "items",
                            "Items ObservableUpDownCounter"
                        );
                    ObservableUpDownCounter<float> observableUpDownCounter5 =
                    ...
                    ObservableUpDownCounter<double> observableUpDownCounter6 =
                        meter.CreateObservableUpDownCounter<double>(
                            "observableUpDownCounter6",
                            () => 0,
                            "items",
                            "Items ObservableUpDownCounter"
                        );
                    ObservableUpDownCounter<decimal> observableUpDownCounter7 =
                        meter.CreateObservableUpDownCounter<decimal>(
                            "observableUpDownCounter7",
                            () => 0,
                            "items",
                            "Items ObservableUpDownCounter"
                        );

                    ObservableGauge<byte> observableGauge1 = meter.CreateObservableGauge<byte>(
                        "observableGauge1",
                        () => 0,
                        "seconds",
                        "Seconds ObservableGauge"
                    );
                    ObservableGauge<short> observableGauge2 = meter.CreateObservableGauge<short>(
                        "observableGauge2",
                        () => 0,
                        "seconds",
                        "Seconds ObservableGauge"
                    );
                    ObservableGauge<int> observableGauge3 = meter.CreateObservableGauge<int>(
                        "observableGauge3",
                        () => 0,
                        "seconds",
                        "Seconds ObservableGauge"
                    );
                    ObservableGauge<long> observableGauge4 = meter.CreateObservableGauge<long>(
                        "observableGauge4",
                        () => 0,
                        "seconds",
                        "Seconds ObservableGauge"
                    );
                    ObservableGauge<float> observableGauge5 = meter.CreateObservableGauge<float>(
                        "observableGauge5",
                        () => 0,
                        "seconds",
                        "Seconds ObservableGauge"
                    );
                    ObservableGauge<double> observableGauge6 = meter.CreateObservableGauge<double>(
                        "observableGauge6",
                        () => 0,
                        "seconds",
                        "Seconds ObservableGauge"
                    );
                    ObservableGauge<decimal> observableGauge7 =
                    ...
                    Assert.Throws<InvalidOperationException>(
                        () =>
                            meter.CreateUpDownCounter<uint>(
                                "UpDownCounter",
                                "items",
                                "Items Counter"
                            )
            ...
            RemoteExecutor
                .Invoke(() =>
                {
                    ...
                    using (MeterListener listener = new MeterListener())
                    {
                        ...
                        ObservableGauge<byte> observableGauge = meter.CreateObservableGauge<byte>(
                            "observableGauge1",
                            () => 0,
                            "seconds",
                            "Seconds ObservableGauge"
                        ...
                        listener.InstrumentPublished = (instruments, theListener) =>
                        ...
                        Histogram<byte> histogram = meter.CreateHistogram<byte>(
                            "histogram1",
                            "seconds",
                            "Seconds histogram"
                        );
                        ObservableCounter<byte> observableCounter =
                            meter.CreateObservableCounter<byte>(
                                "observableCounter1",
                                () => 0,
                                "seconds",
                        ...
                        UpDownCounter<long> upDownCounter = meter.CreateUpDownCounter<long>(
                            "UpDownCounter4",
                            "request",
                            "Requests UpDownCounter"
                        );
                        ObservableUpDownCounter<byte> observableUpDownCounter =
                            meter.CreateObservableUpDownCounter<byte>(
                                "observableUpDownCounter1",
                                () => 0,
                                "items",
                        ...
                        listener.MeasurementsCompleted = (instruments, state) =>
                        {
                            instrumentsEncountered--;
                            Assert.Same(state, instruments);
                        };
            ...
            RemoteExecutor
                .Invoke(() =>
                {
                    using Meter meter = new Meter(
                        "ThrowingExceptionsFromObservableInstrumentCallbacks"
                    );

                    using (MeterListener listener = new MeterListener())
                    {
                        ObservableCounter<int> counter1 = meter.CreateObservableCounter<int>(
                            "observableCounter1",
                            (Func<int>)(() => throw new ArgumentOutOfRangeException())
                        );
                        ObservableGauge<int> gauge1 = meter.CreateObservableGauge<int>(
                            "observableGauge1",
                            (Func<int>)(() => throw new ArgumentException())
                        );
                        ObservableCounter<int> counter2 = meter.CreateObservableCounter<int>(
                            "observableCounter2",
                            (Func<int>)(() => throw new PlatformNotSupportedException())
                        );
                        ObservableGauge<int> gauge2 = meter.CreateObservableGauge<int>(
                            "observableGauge2",
                            (Func<int>)(() => throw new NullReferenceException())
                        );
                        ObservableUpDownCounter<int> upDownCounterCounter1 =
                            meter.CreateObservableUpDownCounter<int>(
                                "upDownCounter1",
                                (Func<int>)(() => throw new ArgumentOutOfRangeException())
                            );
                        ObservableUpDownCounter<int> upDownCounterCounter2 =
                            meter.CreateObservableUpDownCounter<int>(
                                "upDownCounter2",
                                (Func<int>)(() => throw new PlatformNotSupportedException())
                            );
                        ObservableCounter<int> counter3 = meter.CreateObservableCounter<int>(
                            "observableCounter3",
                            () => 5
                        );
                        ObservableGauge<int> gauge3 = meter.CreateObservableGauge<int>(
                            "observableGauge3",
                            () => 7
                        );
                        ObservableUpDownCounter<int> upDownCounterCounter3 =
                            meter.CreateObservableUpDownCounter<int>(
                                "ObservableUpDownCounter3",
                                () => -1
                            );
                        ...
                        listener.SetMeasurementEventCallback<int>(
                            (inst, measurement, tags, state) => accumulated += measurement
                        );
        ...
        public void ObservableInstrumentMeasurementTest()
        {
            RemoteExecutor
                .Invoke(() =>
                {
                    ...
                    //
                    ObservableCounter<byte> observableCounter = meter.CreateObservableCounter<byte>(
                    ...
                    ObservableInstrumentMeasurementAggregationValidation(
                        observableCounter1,
                        new Measurement<short>[] { new Measurement<short>(30_000) }
                    );
                    ObservableCounter<int> observableCounter2 = meter.CreateObservableCounter<int>(
                        "IntObservableCounter",
                        () => 1_000_000
                    );
                    ObservableInstrumentMeasurementAggregationValidation(
                        observableCounter2,
                    ...
                    ObservableInstrumentMeasurementAggregationValidation(
                        observableCounter3,
                        new Measurement<long>[] { new Measurement<long>(1_000_000_000) }
                    );
                    ObservableCounter<float> observableCounter4 =
                        meter.CreateObservableCounter<float>("floatObservableCounter", () => 3.14f);
                    ObservableInstrumentMeasurementAggregationValidation(
                        observableCounter4,
                        new Measurement<float>[] { new Measurement<float>(3.14f) }
                    );
                    ObservableCounter<double> observableCounter5 =
                        meter.CreateObservableCounter<double>("doubleObservableCounter", () => 1e6);
                    ObservableInstrumentMeasurementAggregationValidation(
                        observableCounter5,
                    ...
                    ObservableInstrumentMeasurementAggregationValidation(
                        observableCounter6,
                        new Measurement<decimal>[] { new Measurement<decimal>(1.5E6m) }
                    );
                    ...
                    ObservableUpDownCounter<byte> observableUpDownCounter =
                        meter.CreateObservableUpDownCounter<byte>(
                            "ByteObservableUpDownCounter",
                            () => 10
                        );
                    ObservableInstrumentMeasurementAggregationValidation(
                        observableUpDownCounter,
                        new Measurement<byte>[] { new Measurement<byte>(10) }
                    );
                    ObservableUpDownCounter<short> observableUpDownCounter1 =
                        meter.CreateObservableUpDownCounter<short>(
                            "shortObservableUpDownCounter",
                            () => -10
                        );
                    ObservableInstrumentMeasurementAggregationValidation(
                        observableUpDownCounter1,
                    ...
                    ObservableInstrumentMeasurementAggregationValidation(
                        observableUpDownCounter2,
                        new Measurement<int>[] { new Measurement<int>(-12) }
                    );
                    ObservableUpDownCounter<long> observableUpDownCounter3 =
                        meter.CreateObservableUpDownCounter<long>(
                    ...
                    ObservableInstrumentMeasurementAggregationValidation(
                        observableUpDownCounter3,
                        new Measurement<long>[] { new Measurement<long>(-100) }
                    );
                    ObservableUpDownCounter<float> observableUpDownCounter4 =
                        meter.CreateObservableUpDownCounter<float>(
                            "floatObservableUpDownCounter",
                            () => -3.4f
                        );
                    ObservableInstrumentMeasurementAggregationValidation(
                        observableUpDownCounter4,
                        new Measurement<float>[] { new Measurement<float>(-3.4f) }
                    );
                    ObservableUpDownCounter<double> observableUpDownCounter5 =
                        meter.CreateObservableUpDownCounter<double>(
                    ...
                    ObservableInstrumentMeasurementAggregationValidation(
                        observableUpDownCounter5,
                        new Measurement<double>[] { new Measurement<double>(-3.14) }
                    );
                    ObservableUpDownCounter<decimal> observableUpDownCounter6 =
                        meter.CreateObservableUpDownCounter<decimal>(
                            "doubleObservableUpDownCounter",
                            () => -32222.14m
                        );
                    ObservableInstrumentMeasurementAggregationValidation(
                        observableUpDownCounter6,
                        new Measurement<decimal>[] { new Measurement<decimal>(-32222.14m) }
                    );
                    ...
                    ObservableInstrumentMeasurementAggregationValidation(
                        observableGauge,
                        new Measurement<byte>[] { new Measurement<byte>(100) }
                    );
                    ObservableGauge<short> observableGauge1 = meter.CreateObservableGauge<short>(
                        "ShortObservableGauge",
                        () => 30_123
                    );
                    ObservableInstrumentMeasurementAggregationValidation(
                        observableGauge1,
                        new Measurement<short>[] { new Measurement<short>(30_123) }
                    );
                    ObservableGauge<int> observableGauge2 = meter.CreateObservableGauge<int>(
                        "IntObservableGauge",
                        () => 2_123_456
                    );
                    ObservableInstrumentMeasurementAggregationValidation(
                        observableGauge2,
                        new Measurement<int>[] { new Measurement<int>(2_123_456) }
                    );
                    ObservableGauge<long> observableGauge3 = meter.CreateObservableGauge<long>(
                        "longObservableGauge",
                        () => 3_123_456_789
                    );
                    ObservableInstrumentMeasurementAggregationValidation(
                        observableGauge3,
                        new Measurement<long>[] { new Measurement<long>(3_123_456_789) }
                    );
                    ObservableGauge<float> observableGauge4 = meter.CreateObservableGauge<float>(
                        "floatObservableGauge",
                        () => 1.6f
                    );
                    ObservableInstrumentMeasurementAggregationValidation(
                        observableGauge4,
                        new Measurement<float>[] { new Measurement<float>(1.6f) }
                    );
                    ObservableGauge<double> observableGauge5 = meter.CreateObservableGauge<double>(
                        "doubleObservableGauge",
                        () => 1e5
                    );
                    ObservableInstrumentMeasurementAggregationValidation(
                        observableGauge5,
                    ...
                    ObservableInstrumentMeasurementAggregationValidation(
                        observableGauge6,
                        new Measurement<decimal>[] { new Measurement<decimal>(2.5E7m) }
                    );

                    //
                    // CreateObservableCounter using Func<Measurement<T>>
                    //
                    Measurement<byte> byteMeasurement = new Measurement<byte>(
                        60,
                    ...
                    ObservableInstrumentMeasurementAggregationValidation(
                        observableCounter7,
                        new Measurement<byte>[] { byteMeasurement }
                    );

                    Measurement<short> shortMeasurement = new Measurement<short>(
                        20_000,
                        new KeyValuePair<string, object?>[]
                        {
                    ...
                    ObservableInstrumentMeasurementAggregationValidation(
                        observableCounter8,
                        new Measurement<short>[] { shortMeasurement }
                    );

                    Measurement<int> intMeasurement = new Measurement<int>(
                        2_000_000,
                        new KeyValuePair<string, object?>[]
                        {
                    ...
                    ObservableCounter<int> observableCounter9 = meter.CreateObservableCounter<int>(
                        "IntObservableCounter",
                        () => intMeasurement
                    );
                    ObservableInstrumentMeasurementAggregationValidation(
                        observableCounter9,
                        new Measurement<int>[] { intMeasurement }
                    );

                    Measurement<long> longMeasurement = new Measurement<long>(
                        20_000_000_000,
                        new KeyValuePair<string, object?>[]
                        {
                            new KeyValuePair<string, object?>("T7", "V7"),
                            new KeyValuePair<string, object?>("T8", "V8")
                        }
                    );
                    ...
                    ObservableInstrumentMeasurementAggregationValidation(
                        observableCounter10,
                        new Measurement<long>[] { longMeasurement }
                    );

                    Measurement<float> floatMeasurement = new Measurement<float>(
                        1e2f,
                        new KeyValuePair<string, object?>[]
                        {
                            new KeyValuePair<string, object?>("T9", "V10"),
                            new KeyValuePair<string, object?>("T11", "V12")
                        }
                    );
                    ObservableCounter<float> observableCounter11 =
                        meter.CreateObservableCounter<float>("floatObservableCounter", () => 3.14f);
                    ObservableInstrumentMeasurementAggregationValidation(
                        observableCounter11,
                        new Measurement<float>[] { new Measurement<float>(3.14f) }
                    ...
                    Measurement<double> doubleMeasurement = new Measurement<double>(
                        2.5e7,
                        new KeyValuePair<string, object?>[]
                        {
                            new KeyValuePair<string, object?>("T13", "V14"),
                            new KeyValuePair<string, object?>("T15", "V16")
                        }
                    );
                    ...
                    ObservableInstrumentMeasurementAggregationValidation(
                        observableCounter12,
                        new Measurement<double>[] { doubleMeasurement }
                    );

                    Measurement<decimal> decimalMeasurement = new Measurement<decimal>(
                        3.2e20m,
                        new KeyValuePair<string, object?>[]
                        {
                            new KeyValuePair<string, object?>("T17", "V18"),
                            new KeyValuePair<string, object?>("T19", "V20")
                        }
                    );
                    ...
                    ObservableInstrumentMeasurementAggregationValidation(
                        observableCounter13,
                        new Measurement<decimal>[] { decimalMeasurement }
                    );

                    //
                    // CreateObservableUpDownCounter using Func<Measurement<T>>
                    //
                    Measurement<byte> byteMeasurement1 = new Measurement<byte>(
                        100,
                        new KeyValuePair<string, object?>[]
                        {
                            new KeyValuePair<string, object?>("T1", "V1"),
                    ...
                    ObservableUpDownCounter<byte> observableUpDownCounter7 =
                        meter.CreateObservableUpDownCounter<byte>(
                            "ByteObservableUpDownCounter",
                            () => byteMeasurement1
                        );
                    ObservableInstrumentMeasurementAggregationValidation(
                        observableUpDownCounter7,
                        new Measurement<byte>[] { byteMeasurement1 }
                    );

                    Measurement<short> shortMeasurement1 = new Measurement<short>(
                        -20_000,
                        new KeyValuePair<string, object?>[]
                        {
                            new KeyValuePair<string, object?>("T3", "V3"),
                    ...
                    ObservableUpDownCounter<short> observableUpDownCounter8 =
                        meter.CreateObservableUpDownCounter<short>(
                            "ShortObservableUpDownCounter",
                            () => shortMeasurement1
                        );
                    ObservableInstrumentMeasurementAggregationValidation(
                        observableUpDownCounter8,
                        new Measurement<short>[] { shortMeasurement1 }
                    );

                    Measurement<int> intMeasurement1 = new Measurement<int>(
                        -2_000_000,
                        new KeyValuePair<string, object?>[]
                        {
                            new KeyValuePair<string, object?>("T5", "V5"),
                    ...
                    ObservableInstrumentMeasurementAggregationValidation(
                        ...
                        new Measurement<int>[] { intMeasurement1 }
                    );

                    Measurement<long> longMeasurement1 = new Measurement<long>(
                        -20_000_000_000,
                        new KeyValuePair<string, object?>[]
                        {
                            new KeyValuePair<string, object?>("T7", "V7"),
                    ...
                    ObservableUpDownCounter<long> observableUpDownCounter10 =
                        meter.CreateObservableUpDownCounter<long>(
                            "longObservableUpDownCounter",
                            () => longMeasurement1
                        );
                    ObservableInstrumentMeasurementAggregationValidation(
                        ...
                        new Measurement<long>[] { longMeasurement1 }
                    );

                    Measurement<float> floatMeasurement1 = new Measurement<float>(
                        -1e2f,
                        new KeyValuePair<string, object?>[]
                        {
                            new KeyValuePair<string, object?>("T9", "V10"),
                    ...
                    ObservableUpDownCounter<float> observableUpDownCounter11 =
                        meter.CreateObservableUpDownCounter<float>(
                            "floatObservableUpDownCounter",
                            () => floatMeasurement1
                        );
                    ObservableInstrumentMeasurementAggregationValidation(
                        observableUpDownCounter11,
                        new Measurement<float>[] { floatMeasurement1 }
                    );

                    Measurement<double> doubleMeasurement1 = new Measurement<double>(
                        -2.5e7,
                        new KeyValuePair<string, object?>[]
                        {
                            new KeyValuePair<string, object?>("T13", "V14"),
                    ...
                    ObservableUpDownCounter<double> observableUpDownCounter12 =
                        meter.CreateObservableUpDownCounter<double>(
                            "doubleObservableUpDownCounter",
                            () => doubleMeasurement1
                        );
                    ObservableInstrumentMeasurementAggregationValidation(
                        observableUpDownCounter12,
                        new Measurement<double>[] { doubleMeasurement1 }
                    );

                    Measurement<decimal> decimalMeasurement1 = new Measurement<decimal>(
                        -3.2e20m,
                        new KeyValuePair<string, object?>[]
                        {
                            new KeyValuePair<string, object?>("T17", "V18"),
                    ...
                    ObservableUpDownCounter<decimal> observableUpDownCounter13 =
                        meter.CreateObservableUpDownCounter<decimal>(
                            "decimalObservableUpDownCounter",
                            () => decimalMeasurement1
                        );
                    ObservableInstrumentMeasurementAggregationValidation(
                        observableUpDownCounter13,
                        new Measurement<decimal>[] { decimalMeasurement1 }
                    );

                    //
                    // CreateObservableGauge using Func<Measurement<T>>
                    //
                    Measurement<byte> byteGaugeMeasurement = new Measurement<byte>(
                        35,
                        new KeyValuePair<string, object?>[]
                        {
                            new KeyValuePair<string, object?>("T21", "V22"),
                            new KeyValuePair<string, object?>("T23", "V24")
                        }
                    );
                    ObservableGauge<byte> observableGauge7 = meter.CreateObservableGauge<byte>(
                        "ByteObservableGauge",
                        () => byteGaugeMeasurement
                    );
                    ObservableInstrumentMeasurementAggregationValidation(
                        observableGauge7,
                        new Measurement<byte>[] { byteGaugeMeasurement }
                    );

                    Measurement<short> shortGaugeMeasurement = new Measurement<short>(
                        23_987,
                        new KeyValuePair<string, object?>[]
                        {
                            new KeyValuePair<string, object?>("T25", "V26"),
                            new KeyValuePair<string, object?>("T27", "V28")
                        }
                    );
                    ObservableGauge<short> observableGauge8 = meter.CreateObservableGauge<short>(
                        "ShortObservableGauge",
                        () => shortGaugeMeasurement
                    );
                    ObservableInstrumentMeasurementAggregationValidation(
                        observableGauge8,
                        new Measurement<short>[] { shortGaugeMeasurement }
                    );

                    Measurement<int> intGaugeMeasurement = new Measurement<int>(
                        1_987_765,
                        new KeyValuePair<string, object?>[]
                        {
                            new KeyValuePair<string, object?>("T29", "V30"),
                            new KeyValuePair<string, object?>("T31", "V32")
                        }
                    );
                    ObservableGauge<int> observableGauge9 = meter.CreateObservableGauge<int>(
                        "IntObservableGauge",
                        () => intGaugeMeasurement
                    );
                    ObservableInstrumentMeasurementAggregationValidation(
                        observableGauge9,
                        new Measurement<int>[] { intGaugeMeasurement }
                    );

                    Measurement<long> longGaugeMeasurement = new Measurement<long>(
                        10_000_234_343,
                        new KeyValuePair<string, object?>[]
                        {
                            new KeyValuePair<string, object?>("T33", "V342"),
                            new KeyValuePair<string, object?>("T35", "V36")
                        }
                    );
                    ObservableGauge<long> observableGauge10 = meter.CreateObservableGauge<long>(
                        "longObservableGauge",
                        () => longGaugeMeasurement
                    );
                    ObservableInstrumentMeasurementAggregationValidation(
                        observableGauge10,
                        new Measurement<long>[] { longGaugeMeasurement }
                    );

                    Measurement<float> floatGaugeMeasurement = new Measurement<float>(
                        2.1f,
                        new KeyValuePair<string, object?>[]
                        {
                            new KeyValuePair<string, object?>("T37", "V38"),
                            new KeyValuePair<string, object?>("T39", "V40")
                        }
                    );
                    ObservableGauge<float> observableGauge11 = meter.CreateObservableGauge<float>(
                        "floatObservableGauge",
                        () => floatGaugeMeasurement
                    );
                    ObservableInstrumentMeasurementAggregationValidation(
                        observableGauge11,
                        new Measurement<float>[] { floatGaugeMeasurement }
                    );

                    Measurement<double> doubleGaugeMeasurement = new Measurement<double>(
                        1.5e30,
                        new KeyValuePair<string, object?>[]
                        {
                            new KeyValuePair<string, object?>("T41", "V42"),
                            new KeyValuePair<string, object?>("T43", "V44")
                        }
                    );
                    ObservableGauge<double> observableGauge12 = meter.CreateObservableGauge<double>(
                        "doubleObservableGauge",
                        () => doubleGaugeMeasurement
                    );
                    ObservableInstrumentMeasurementAggregationValidation(
                        observableGauge12,
                        new Measurement<double>[] { doubleGaugeMeasurement }
                    );

                    Measurement<decimal> decimalGaugeMeasurement = new Measurement<decimal>(
                        2.5e20m,
                        new KeyValuePair<string, object?>[]
                        {
                            new KeyValuePair<string, object?>("T45", "V46"),
                            new KeyValuePair<string, object?>("T47", "V48")
                        }
                    );
                    ...
                    ObservableInstrumentMeasurementAggregationValidation(
                        observableGauge13,
                        new Measurement<decimal>[] { decimalGaugeMeasurement }
                    );
                    ...
                    {
                        new Measurement<byte>(
                            0,
                            new KeyValuePair<string, object?>[]
                            {
                                new KeyValuePair<string, object?>("T48", "V49"),
                                new KeyValuePair<string, object?>("T50", "V51")
                            }
                        ),
                        new Measurement<byte>(
                            1,
                            new KeyValuePair<string, object?>[]
                            {
                                new KeyValuePair<string, object?>("T51", "V52"),
                                new KeyValuePair<string, object?>("T53", "V54")
                            }
                        ),
                    };
                    ...
                    Measurement<short>[] shortGaugeMeasurementList = new Measurement<short>[]
                    {
                        new Measurement<short>(
                            ...
                            new KeyValuePair<string, object?>[]
                            {
                                new KeyValuePair<string, object?>("T55", "V56"),
                                new KeyValuePair<string, object?>("T57", "V58")
                            }
                        ),
                        new Measurement<short>(
                            30_000,
                            new KeyValuePair<string, object?>[]
                            {
                                new KeyValuePair<string, object?>("T59", "V60"),
                                new KeyValuePair<string, object?>("T61", "V62")
                            }
                        ),
                    };
                    ...
                    Measurement<int>[] intGaugeMeasurementList = new Measurement<int>[]
                    {
                        new Measurement<int>(
                            ...
                            new KeyValuePair<string, object?>[]
                            {
                                new KeyValuePair<string, object?>("T63", "V64"),
                                new KeyValuePair<string, object?>("T65", "V66")
                            }
                        ),
                        new Measurement<int>(
                            1_000_002,
                            new KeyValuePair<string, object?>[]
                            {
                                new KeyValuePair<string, object?>("T67", "V68"),
                                new KeyValuePair<string, object?>("T69", "V70")
                            }
                        ),
                    };
                    ObservableCounter<int> observableCounter16 = meter.CreateObservableCounter<int>(
                        "IntObservableCounter",
                    ...
                    Measurement<long>[] longGaugeMeasurementList = new Measurement<long>[]
                    {
                        new Measurement<long>(
                            ...
                            new KeyValuePair<string, object?>[]
                            {
                                new KeyValuePair<string, object?>("T71", "V72"),
                                new KeyValuePair<string, object?>("T73", "V74")
                            }
                        ),
                        new Measurement<long>(
                            1_000_002_002,
                            new KeyValuePair<string, object?>[]
                            {
                                new KeyValuePair<string, object?>("T75", "V76"),
                                new KeyValuePair<string, object?>("T77", "V78")
                            }
                        ),
                    };
                    ...
                    Measurement<float>[] floatGaugeMeasurementList = new Measurement<float>[]
                    {
                        new Measurement<float>(
                            ...
                            new KeyValuePair<string, object?>[]
                            {
                                new KeyValuePair<string, object?>("T79", "V80"),
                                new KeyValuePair<string, object?>("T81", "V82")
                            }
                        ),
                        new Measurement<float>(
                            68.15e6f,
                            new KeyValuePair<string, object?>[]
                            {
                                new KeyValuePair<string, object?>("T83", "V84"),
                                new KeyValuePair<string, object?>("T85", "V86")
                            }
                        ),
                    };
                    ...
                    Measurement<double>[] doubleGaugeMeasurementList = new Measurement<double>[]
                    {
                        new Measurement<double>(
                            ...
                            new KeyValuePair<string, object?>[]
                            {
                                new KeyValuePair<string, object?>("T87", "V88"),
                                new KeyValuePair<string, object?>("T89", "V90")
                            }
                        ),
                        new Measurement<double>(
                            68.15e21,
                            new KeyValuePair<string, object?>[]
                            {
                                new KeyValuePair<string, object?>("T91", "V92"),
                                new KeyValuePair<string, object?>("T93", "V94")
                            }
                        ),
                    };
                    ...
                    Measurement<decimal>[] decimalGaugeMeasurementList = new Measurement<decimal>[]
                    {
                        new Measurement<decimal>(
                            ...
                            new KeyValuePair<string, object?>[]
                            {
                                new KeyValuePair<string, object?>("T95", "V96"),
                                new KeyValuePair<string, object?>("T97", "V98")
                            }
                        ),
                        new Measurement<decimal>(
                            68.15e6m,
                            new KeyValuePair<string, object?>[]
                            {
                                new KeyValuePair<string, object?>("T99", "V100"),
                                new KeyValuePair<string, object?>("T101", "V102")
                            }
                        ),
                    };
                    ...
                    ObservableUpDownCounter<byte> observableUpDownCounter14 =
                        meter.CreateObservableUpDownCounter<byte>(
                            "ByteObservableUpDownCounter",
                            () => byteUpDownCounterMeasurementList
                        );
                    ObservableInstrumentMeasurementAggregationValidation(
                    ...
                    Measurement<short>[] shortUpDownCounterMeasurementList =
                        new Measurement<short>[]
                        {
                            new Measurement<short>(
                                -20_000,
                    ...
                    ObservableUpDownCounter<short> observableUpDownCounter15 =
                        meter.CreateObservableUpDownCounter<short>(
                            "ShortObservableUpDownCounter",
                            () => shortUpDownCounterMeasurementList
                        );
                    ObservableInstrumentMeasurementAggregationValidation(
                        observableUpDownCounter15,
                        shortUpDownCounterMeasurementList
                    );
                    ...
                    ObservableUpDownCounter<long> observableUpDownCounter17 =
                        meter.CreateObservableUpDownCounter<long>(
                            "longObservableUpDownCounter",
                    ...
                    Measurement<float>[] floatUpDownCounterMeasurementList =
                        new Measurement<float>[]
                        {
                            new Measurement<float>(
                                -68.15e8f,
                    ...
                    ObservableUpDownCounter<float> observableUpDownCounter18 =
                        meter.CreateObservableUpDownCounter<float>(
                            "floatObservableUpDownCounter",
                            () => floatUpDownCounterMeasurementList
                        );
                    ObservableInstrumentMeasurementAggregationValidation(
                        observableUpDownCounter18,
                        floatUpDownCounterMeasurementList
                    );

                    Measurement<double>[] doubleUpDownCounterMeasurementList =
                        new Measurement<double>[]
                        {
                            new Measurement<double>(
                                -68.15e20,
                    ...
                    ObservableUpDownCounter<double> observableUpDownCounter19 =
                        meter.CreateObservableUpDownCounter<double>(
                            "doubleObservableUpDownCounter",
                            () => doubleUpDownCounterMeasurementList
                        );
                    ObservableInstrumentMeasurementAggregationValidation(
                    ...
                    Measurement<decimal>[] decimalUpDownCounterMeasurementList =
                        new Measurement<decimal>[]
                        {
                            new Measurement<decimal>(
                                68.15e8m,
                    ...
                    ObservableUpDownCounter<decimal> observableUpDownCounter20 =
                        meter.CreateObservableUpDownCounter<decimal>(
                            "decimalObservableUpDownCounter",
                    ...
                    //
                    ObservableGauge<byte> observableGauge14 = meter.CreateObservableGauge<byte>(
                        "ByteObservableGauge",
                        () => byteGaugeMeasurementList
                    );
                    ObservableInstrumentMeasurementAggregationValidation(
                    ...
                    ObservableGauge<short> observableGauge15 = meter.CreateObservableGauge<short>(
                        "ShortObservableGauge",
                        () => shortGaugeMeasurementList
                    );
                    ObservableInstrumentMeasurementAggregationValidation(
                    ...
                    ObservableGauge<int> observableGauge16 = meter.CreateObservableGauge<int>(
                        "IntObservableGauge",
                        () => intGaugeMeasurementList
                    );
                    ObservableInstrumentMeasurementAggregationValidation(
                    ...
                    ObservableGauge<long> observableGauge17 = meter.CreateObservableGauge<long>(
                        "longObservableGauge",
                        () => longGaugeMeasurementList
                    );
                    ObservableInstrumentMeasurementAggregationValidation(
                    ...
                    ObservableGauge<float> observableGauge18 = meter.CreateObservableGauge<float>(
                        "floatObservableGauge",
                        () => floatGaugeMeasurementList
                    );
                    ObservableInstrumentMeasurementAggregationValidation(
                    ...
                    ObservableGauge<double> observableGauge19 = meter.CreateObservableGauge<double>(
                        "doubleObservableGauge",
                        () => doubleGaugeMeasurementList
                    );
                    ObservableInstrumentMeasurementAggregationValidation(
        ...
        public void PassingVariableTagsParametersTest()
        {
            RemoteExecutor
                .Invoke(() =>
                {
                    ...
                    InstrumentPassingVariableTagsParametersTest<byte>(
                        meter.CreateCounter<byte>("Counter"),
                    ...
                    InstrumentPassingVariableTagsParametersTest<short>(
                        meter.CreateCounter<short>("Counter"),
                        (instrument, value, tags) =>
                        {
                    ...
                    InstrumentPassingVariableTagsParametersTest<int>(
                    ...
                    InstrumentPassingVariableTagsParametersTest<long>(
                        meter.CreateCounter<long>("Counter"),
                        (instrument, value, tags) =>
                        {
                    ...
                    InstrumentPassingVariableTagsParametersTest<float>(
                        meter.CreateCounter<float>("Counter"),
                        (instrument, value, tags) =>
                        {
                    ...
                    InstrumentPassingVariableTagsParametersTest<double>(
                        meter.CreateCounter<double>("Counter"),
                        (instrument, value, tags) =>
                        {
                    ...
                    InstrumentPassingVariableTagsParametersTest<decimal>(
                        meter.CreateCounter<decimal>("Counter"),
                        (instrument, value, tags) =>
                        {
                    ...
                    InstrumentPassingVariableTagsParametersTest<byte>(
                        meter.CreateUpDownCounter<byte>("Counter"),
                        (instrument, value, tags) =>
                        {
                            PublishUpDownCounterMeasurement(
                                instrument as UpDownCounter<byte>,
                                value,
                                tags
                            );
                            return (byte)(value * 2);
                    ...
                    InstrumentPassingVariableTagsParametersTest<short>(
                        meter.CreateUpDownCounter<short>("Counter"),
                        (instrument, value, tags) =>
                        {
                            PublishUpDownCounterMeasurement(
                                instrument as UpDownCounter<short>,
                                value,
                                tags
                            );
                            return (short)(-value * 2);
                    ...
                    InstrumentPassingVariableTagsParametersTest<int>(
                        meter.CreateUpDownCounter<int>("Counter"),
                        (instrument, value, tags) =>
                        {
                            PublishUpDownCounterMeasurement(
                                instrument as UpDownCounter<int>,
                                value,
                                tags
                            );
                            return (int)(-value * 2);
                    ...
                    InstrumentPassingVariableTagsParametersTest<long>(
                        meter.CreateUpDownCounter<long>("Counter"),
                        (instrument, value, tags) =>
                        {
                            PublishUpDownCounterMeasurement(
                                instrument as UpDownCounter<long>,
                                value,
                                tags
                            );
                            return (long)(-value * 2);
                    ...
                    InstrumentPassingVariableTagsParametersTest<float>(
                        meter.CreateUpDownCounter<float>("Counter"),
                        (instrument, value, tags) =>
                        {
                            PublishUpDownCounterMeasurement(
                                instrument as UpDownCounter<float>,
                                value,
                                tags
                            );
                            return (float)(-value * 2);
                    ...
                    InstrumentPassingVariableTagsParametersTest<double>(
                        meter.CreateUpDownCounter<double>("Counter"),
                        (instrument, value, tags) =>
                        {
                            PublishUpDownCounterMeasurement(
                                instrument as UpDownCounter<double>,
                                value,
                                tags
                            );
                            return (double)(-value * 2);
                    ...
                    InstrumentPassingVariableTagsParametersTest<decimal>(
                        meter.CreateUpDownCounter<decimal>("Counter"),
                        (instrument, value, tags) =>
                        {
                            PublishUpDownCounterMeasurement(
                                instrument as UpDownCounter<decimal>,
                                value,
                                tags
                            );
                            return (decimal)(-value * 2);
                    ...
                    InstrumentPassingVariableTagsParametersTest<byte>(
                        meter.CreateHistogram<byte>("Histogram"),
                        (instrument, value, tags) =>
                        {
                    ...
                    InstrumentPassingVariableTagsParametersTest<short>(
                        meter.CreateHistogram<short>("Histogram"),
                        (instrument, value, tags) =>
                        {
                            PublishHistogramMeasurement(
                                instrument as Histogram<short>,
                                value,
                                tags
                            );
                            return (short)(value * 2);
                    ...
                    InstrumentPassingVariableTagsParametersTest<int>(
                        meter.CreateHistogram<int>("Histogram"),
                        (instrument, value, tags) =>
                        {
                    ...
                    InstrumentPassingVariableTagsParametersTest<long>(
                        meter.CreateHistogram<long>("Histogram"),
                        (instrument, value, tags) =>
                        {
                    ...
                    InstrumentPassingVariableTagsParametersTest<float>(
                        meter.CreateHistogram<float>("Histogram"),
                        (instrument, value, tags) =>
                        {
                            PublishHistogramMeasurement(
                                instrument as Histogram<float>,
                                value,
                                tags
                            );
                            return (float)(value * 2);
                    ...
                    InstrumentPassingVariableTagsParametersTest<double>(
                        meter.CreateHistogram<double>("Histogram"),
                        (instrument, value, tags) =>
                        {
                            PublishHistogramMeasurement(
                                instrument as Histogram<double>,
                                value,
                                tags
                            );
                            return (double)(value * 2);
                    ...
                    InstrumentPassingVariableTagsParametersTest<decimal>(
                        meter.CreateHistogram<decimal>("Histogram"),
                        (instrument, value, tags) =>
                        {
                            PublishHistogramMeasurement(
                                instrument as Histogram<decimal>,
                                value,
                                tags
                            );
                            return (decimal)(value * 2);
        ...
        public void MeterDisposalsTest()
        {
            RemoteExecutor
                .Invoke(() =>
                {
                    ...
                    listener.SetMeasurementEventCallback<int>(
                        (inst, measurement, tags, state) => count++
                    );
                    listener.SetMeasurementEventCallback<short>(
                        (inst, measurement, tags, state) => count++
                    );
        ...
        public void ListenerDisposalsTest()
        {
            RemoteExecutor
                .Invoke(() =>
                {
                    ...
                    UpDownCounter<short> upDownCounter = meter.CreateUpDownCounter<short>(
                        "upDownCounter"
                    );
                    ...
                    ObservableGauge<decimal> observableGauge = meter.CreateObservableGauge<decimal>(
                        "ObservableGauge",
                        () =>
                            new Measurement<decimal>(
                                5.7m,
                    ...
                    listener.InstrumentPublished = (theInstrument, theListener) =>
                        theListener.EnableMeasurementEvents(theInstrument, theInstrument);
                    listener.MeasurementsCompleted = (theInstrument, state) =>
        ...
        public void MultipleListenersTest()
        {
            RemoteExecutor
                .Invoke(() =>
                {
                    ...
                    listener1.InstrumentPublished =
                        listener2.InstrumentPublished =
                        listener3.InstrumentPublished =
                            (theInstrument, theListener) =>
                                theListener.EnableMeasurementEvents(theInstrument, theInstrument);

                    int count = 0;

                    listener1.SetMeasurementEventCallback<int>(
                        (inst, measurement, tags, state) => count++
                    );
                    listener2.SetMeasurementEventCallback<int>(
                        (inst, measurement, tags, state) => count++
                    );
                    listener3.SetMeasurementEventCallback<int>(
                        (inst, measurement, tags, state) => count++
                    );
        ...
        public void ParallelRunningTest()
        {
            RemoteExecutor
                .Invoke(() =>
                {
                    ...
                    ObservableCounter<int> observableCounter = meter.CreateObservableCounter<int>(
                        "ObservableCounter",
                        () => 1
                    );
                    ObservableUpDownCounter<int> observableUpDownCounter =
                ...
                .Invoke(() =>
                {
                    ...
                    MeterListener listener = new MeterListener()
                    {
                        InstrumentPublished = (instrument, theListener) =>
                        {
                            ...
                            {
                                Assert.False(
                                    instruments.ContainsKey(instrument),
                                    $"{instrument.Name}, {instrument.Meter.Name} is already published before"
                                );
                        ...
                        MeasurementsCompleted = (instrument, state) =>
                        {
                            lock (instruments)
                            {
                                Assert.True(
                                    ...
                                    $"{instrument.Name}, {instrument.Meter.Name} is not published while getting completed results"
                                );
                            }
                        }
                    };
                        ...
                        jobs[i] = Task.Run(() =>
                        {
                            for (int j = 0; j < 10; j++)
                            {
                                ...
                                for (int k = 0; k < 10; k++)
                                {
                                    ...
                                    Counter<int> counter = meters[index].CreateCounter<int>(
                                        "Counter"
                                    );
                                    counter.Add(1);
                                }
            ...
            RemoteExecutor
                .Invoke(() =>
                {
                    ...
                    using (MeterListener listener = new MeterListener())
                    {
                        ...
                        histogram.Record(
                            10,
                            new TagList() { new KeyValuePair<string, object?>("Key1", "Value1") }
                        );
            ...
            RemoteExecutor
                .Invoke(() =>
                {
                    ...
                    using Meter meter2 = new Meter(
                        "TestMeterCreationWithOptions2",
                        "2.0",
                        new TagList() { { "Key1", "Value1" } }
                    );
                    ...
                    using Meter meter3 = new Meter(
                        "TestMeterCreationWithOptions3",
                        "3.0",
                        new TagList() { { "Key3", "Value3" } },
                        "Scope"
                    );
                    Assert.Equal("TestMeterCreationWithOptions3", meter3.Name);
                    Assert.Equal("3.0", meter3.Version);
                    Assert.Equal(
                        new[] { new KeyValuePair<string, object?>("Key3", "Value3") },
                        meter3.Tags
                    );
                    ...
                    using Meter meter5 = new Meter(
                        new MeterOptions("TestMeterCreationWithOptions5") { Version = "5.0" }
                    );
                    ...
                    using Meter meter6 = new Meter(
                        new MeterOptions("TestMeterCreationWithOptions6")
                        {
                            Tags = new TagList() { { "Key6", "Value6" } }
                        }
                    );
                    Assert.Equal("TestMeterCreationWithOptions6", meter6.Name);
                    Assert.Null(meter6.Version);
                    Assert.Equal(
                        new[] { new KeyValuePair<string, object?>("Key6", "Value6") },
                        meter6.Tags
                    );
                    Assert.Null(meter5.Scope);

                    using Meter meter7 = new Meter(
                        new MeterOptions("TestMeterCreationWithOptions7") { Scope = "Scope7" }
                    );
                    ...
                    using Meter meter8 = new Meter(
                        new MeterOptions("TestMeterCreationWithOptions8")
                        {
                            Version = "8.0",
                            Tags = new TagList() { { "Key8", "Value8" } },
                            Scope = "Scope8"
                        }
                    );
                    ...
                    Assert.Equal(
                        new[] { new KeyValuePair<string, object?>("Key8", "Value8") },
                        meter8.Tags
                    );
                    ...
                    using Meter meter9 = new Meter(
                        new MeterOptions("TestMeterCreationWithOptions9")
                        {
                            Version = "8.0",
                            Tags = l,
                            Scope = "Scope8"
        ...
        public void TestCachedInstruments()
        {
            RemoteExecutor
                .Invoke(() =>
                {
                    ...
                    Histogram<int> histogram1 = meter.CreateHistogram<int>(
                        "name",
                        null,
                        null,
                        list2
                    ...
                    Histogram<int> histogram2 = meter.CreateHistogram<int>(
                        "name",
                        null,
                        null,
                        list2
                    ...
                    UpDownCounter<int> upDownCounter1 = meter.CreateUpDownCounter<int>(
                        "name",
                        null,
                        null,
                        list2
                    ...
                    List<KeyValuePair<string, object?>> l2 = new List<
                        KeyValuePair<string, object?>
                    >()
                    {
                        new KeyValuePair<string, object?>("w", "b"),
                        new KeyValuePair<string, object?>("h", o),
                        new KeyValuePair<string, object?>("a", null),
                        new KeyValuePair<string, object?>("d", "b"),
                        new KeyValuePair<string, object?>("f", "a"),
                        new KeyValuePair<string, object?>("N", null),
                        new KeyValuePair<string, object?>("a", "b")
                    };
                    HashSet<KeyValuePair<string, object?>> l3 = new HashSet<
                        KeyValuePair<string, object?>
                    >()
                    {
                        new KeyValuePair<string, object?>("d", "b"),
        ...
        public void TestInstrumentCreationWithTags()
        {
            RemoteExecutor
                .Invoke(() =>
                {
                    ...
                    Instrument ins1 = meter.CreateCounter<int>(
                        "counter",
                        null,
                        null,
                        new TagList() { { "c1", "cv-1" } }
                    ...
                    Assert.Equal(
                        new[] { new KeyValuePair<string, object?>("c1", "cv-1") },
                        ins1.Tags
                    );

                    Instrument ins2 = meter.CreateHistogram<double>(
                        "histogram",
                        null,
                        null,
                        new TagList() { { "h1", "hv-1" } }
                    ...
                    Assert.Equal(
                        new[] { new KeyValuePair<string, object?>("h1", "hv-1") },
                        ins2.Tags
                    );

                    Instrument ins3 = meter.CreateUpDownCounter<long>(
                        "UpDownCounter",
                        null,
                        null,
                        new TagList() { { "udc1", "udc-v1" } }
                    );
                    Assert.Equal(
                        new[] { new KeyValuePair<string, object?>("udc1", "udc-v1") },
                        ins3.Tags
                    );

                    Instrument ins4 = meter.CreateObservableCounter<short>(
                        "ObservableCounter1",
                        () => 1,
                        null,
                        null,
                        new TagList() { { "oc1", "oc-v1" } }
                    );
                    Assert.Equal(
                        new[] { new KeyValuePair<string, object?>("oc1", "oc-v1") },
                        ins4.Tags
                    );

                    Instrument ins5 = meter.CreateObservableCounter<short>(
                        "ObservableCounter2",
                        () => new Measurement<short>(2),
                        null,
                        null,
                        new TagList() { { "oc2", "oc-v2" } }
                    );
                    Assert.Equal(
                        new[] { new KeyValuePair<string, object?>("oc2", "oc-v2") },
                        ins5.Tags
                    );

                    Instrument ins6 = meter.CreateObservableCounter<short>(
                        "ObservableCounter3",
                        () => new Measurement<short>[] { new Measurement<short>(3) },
                        null,
                        null,
                        new TagList() { { "oc3", "oc-v3" } }
                    );
                    Assert.Equal(
                        new[] { new KeyValuePair<string, object?>("oc3", "oc-v3") },
                        ins6.Tags
                    );

                    Instrument ins7 = meter.CreateObservableGauge<long>(
                        "ObservableGauge1",
                        () => 1,
                        null,
                        null,
                        new TagList() { { "og1", "og-v1" } }
                    );
                    Assert.Equal(
                        new[] { new KeyValuePair<string, object?>("og1", "og-v1") },
                        ins7.Tags
                    );

                    Instrument ins8 = meter.CreateObservableGauge<long>(
                        "ObservableGauge2",
                        () => new Measurement<long>(2),
                        null,
                        null,
                        new TagList() { { "og2", "og-v2" } }
                    );
                    Assert.Equal(
                        new[] { new KeyValuePair<string, object?>("og2", "og-v2") },
                        ins8.Tags
                    );

                    Instrument ins9 = meter.CreateObservableGauge<long>(
                        "ObservableGauge3",
                        () => new Measurement<long>[] { new Measurement<long>(3) },
                        null,
                        null,
                        new TagList() { { "og3", "og-v3" } }
                    );
                    Assert.Equal(
                        new[] { new KeyValuePair<string, object?>("og3", "og-v3") },
                        ins9.Tags
                    );

                    Instrument ins10 = meter.CreateObservableUpDownCounter<float>(
                        "ObservableUpDownCounter1",
                        () => 1,
                        null,
                        null,
                        new TagList() { { "oudc1", "oudc-v1" } }
                    );
                    Assert.Equal(
                        new[] { new KeyValuePair<string, object?>("oudc1", "oudc-v1") },
                        ins10.Tags
                    );

                    Instrument ins11 = meter.CreateObservableGauge<float>(
                        "ObservableUpDownCounter2",
                        () => new Measurement<float>(2),
                        null,
                        null,
                        new TagList() { { "oudc2", "oudc-v2" } }
                    );
                    Assert.Equal(
                        new[] { new KeyValuePair<string, object?>("oudc2", "oudc-v2") },
                        ins11.Tags
                    );

                    Instrument ins12 = meter.CreateObservableGauge<float>(
                        "ObservableUpDownCounter3",
                        () => new Measurement<float>[] { new Measurement<float>(3) },
                        null,
                        null,
                        new TagList() { { "oudc3", "oudc-v3" } }
                    );
                    Assert.Equal(
                        new[] { new KeyValuePair<string, object?>("oudc3", "oudc-v3") },
                        ins12.Tags
                    );
        ...
        private void PublishCounterMeasurement<T>(
            Counter<T> counter,
            T value,
            ...
            where T : struct
        {
            switch (tags.Length)
            {
                case 0:
                    ...
                    break;
                case 1:
                    counter.Add(value, tags[0]);
                    break;
                case 2:
                    counter.Add(value, tags[0], tags[1]);
                    break;
                case 3:
                    counter.Add(value, tags[0], tags[1], tags[2]);
                    break;
                case 4:
                    counter.Add(value, tags[0], tags[1], tags[2], tags[3]);
                    break;
                case 5:
                    counter.Add(value, tags[0], tags[1], tags[2], tags[3], tags[4]);
                    break;
                case 6:
                    counter.Add(value, tags[0], tags[1], tags[2], tags[3], tags[4], tags[5]);
                    break;
                case 7:
                    counter.Add(
                        value,
        ...
        private void PublishUpDownCounterMeasurement<T>(
        ...
        private void PublishHistogramMeasurement<T>(
            ...
            where T : struct
        {
            switch (tags.Length)
            {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    histogram.Record(value, tags[0], tags[1], tags[2], tags[3]);
                    break;
                case 5:
                    histogram.Record(value, tags[0], tags[1], tags[2], tags[3], tags[4]);
                    break;
                case 6:
                    histogram.Record(value, tags[0], tags[1], tags[2], tags[3], tags[4], tags[5]);
                    break;
                case 7:
                    histogram.Record(
                        value,
        ...
        private void ValidateInstrumentInfo(
        ...
        private void InstrumentMeasurementAggregationValidation<T>(
            ...
            where T : struct
        {
            ...
            listener.SetMeasurementEventCallback<T>(
                (inst, measurement, tags, state) =>
                {
                    ...
                    Assert.Same(instrument, state);
                    Assert.True(
                        index < expectedResult.Length,
                        "We are getting more unexpected results"
                    );
            ...
            where T : struct
        {
            ...
            KeyValuePair<string, object?>[] expectedTags = Array.Empty<
                KeyValuePair<string, object?>
            >();
            T expectedValue = default;
            ...
            expectedTags = new List<KeyValuePair<string, object?>> { { "K1", "V1" }, }.ToArray();
            expectedValue = record(instrument, expectedValue, expectedTags);
            expectedTags = new List<KeyValuePair<string, object?>>
            {
                { "K1", "V1" },
    ...
    public static class DiagnosticsCollectionExtensions
    {
        public static void Add<T1, T2>(
            this ICollection<KeyValuePair<T1, T2>> collection,
            T1 item1,
            T2 item2
        ) => collection?.Add(new KeyValuePair<T1, T2>(item1, item2));

        public static bool Same<T>(
            this IEnumerable<Measurement<T>> measurements,
            IEnumerable<Measurement<T>> expected
        )
            where T : struct
        {
            ...
            while (enumerator.MoveNext())
            {
                ...
                if (
                    measurement.Value.Equals(expectedMeasurement.Value)
