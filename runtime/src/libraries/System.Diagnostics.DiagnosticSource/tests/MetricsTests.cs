...
namespace System.Diagnostics.Metrics.Tests
{
    public class MetricsTests
    {
        ...
        public void InstrumentMeasurementTest()
        {
            RemoteExecutor
                .Invoke(() =>
                {
                    ...
                    InstruementMeasurementAggregationValidation(
                        counter,
                        (value, tags) =>
                        {
        ...
        private void InstruementMeasurementAggregationValidation<T>(
        ...
        private void ObservableInstruementMeasurementAggregationValidation<T>(
