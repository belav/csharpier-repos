...
namespace System.IO.Tests.Enumeration
{
    public class GetTimesTests : FileSystemTest
    {
        private class AllEntries
            : FileSystemEnumerator<(DateTimeOffset CreationTimeUtc, DateTimeOffset LastAccessTimeUtc, DateTimeOffset LastWriteTimeUtc)>
        {
            public AllEntries(string directory, EnumerationOptions options)
                : base(directory, options) { }

            protected override (DateTimeOffset CreationTimeUtc, DateTimeOffset LastAccessTimeUtc, DateTimeOffset LastWriteTimeUtc) TransformEntry(
