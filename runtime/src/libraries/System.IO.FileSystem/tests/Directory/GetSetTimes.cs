...
namespace System.IO.Tests
{
    public class Directory_GetSetTimes : StaticGetSetTimes
    {
        ...
        protected override string GetExistingItem(bool _) =>
            Directory.CreateDirectory(GetTestFilePath()).FullName;

        protected override string CreateSymlink(string path, string pathToTarget) =>
            Directory.CreateSymbolicLink(path, pathToTarget).FullName;
