...
namespace System.IO.Tests
{
    public class Directory_Move : FileSystemTest
    {
        ...
        public void TrailingDirectorySeparators()
        {
            ...
            Directory.CreateDirectory(testDirSource);
            Directory.Move(
                testDirSource + Path.DirectorySeparatorChar,
        ...
        public void WithDifferentRootCase()
        {
            ...
            Directory.Move(
                $"{TestDirectory}/bar".Replace(root, root.ToLower()),
                $"{TestDirectory}/foo"
            );
        ...
        [Fact]
        [PlatformSpecific(
            TestPlatforms.Windows | TestPlatforms.OSX | TestPlatforms.FreeBSD | TestPlatforms.NetBSD
        )]
