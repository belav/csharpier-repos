...
namespace System.IO.Tests
{
    ...
    public class Directory_EnumFSE_str_str_so : Directory_GetFileSystemEntries_str_str_so
    {
        public override string[] GetEntries(string dirName)
        {
            return Directory.EnumerateFileSystemEntries(dirName, "*", SearchOption.TopDirectoryOnly)
                .ToArray();
        }
        ...
        : Directory_GetFileSystemEntries_str_str_so_alldirs
    {
        public override string[] GetEntries(string dirName)
        {
            return Directory.EnumerateFileSystemEntries(dirName, "*", SearchOption.AllDirectories)
                .ToArray();
        }
    ...
    public class Directory_EnumDir_str_str_so : Directory_GetDirectories_str_str_so
    {
        public override string[] GetEntries(string dirName)
        {
            return Directory.EnumerateDirectories(dirName, "*", SearchOption.TopDirectoryOnly)
                .ToArray();
        }
