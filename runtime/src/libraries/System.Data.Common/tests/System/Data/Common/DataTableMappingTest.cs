...
namespace System.Data.Common
{
    public class DataTableMappingTest
    {
        ...
        public DataTableMappingTest()
        {
            ...
            _dataColumnMappings[0] = new DataColumnMapping(
                "firstSourceColumn",
                "firstDataSetColumn"
            );
            _dataColumnMappings[1] = new DataColumnMapping(
                "secondSourceColumn",
                "secondDataSetColumn"
            );
            _dataTableMapping = new DataTableMapping(
                "MyCustomSourceTable",
                "MyCustomDataSetTable",
                _dataColumnMappings
            );
        }
        ...
        public void GetDataTableBySchemaAction()
        {
            ...
            DataTable result = _dataTableMapping.GetDataTableBySchemaAction(
                dataSet,
            ...
            Assert.Throws<InvalidOperationException>(
                () =>
                    _dataTableMapping.GetDataTableBySchemaAction(dataSet, MissingSchemaAction.Error)
            );
            ...
            dataTable = new DataTable("UnknownDataSet");
            dataSet.Tables.Add(dataTable);
            result = _dataTableMapping.GetDataTableBySchemaAction(
                dataSet,
            ...
            Assert.Throws<ArgumentOutOfRangeException>(
                () => _dataTableMapping.GetDataTableBySchemaAction(dataSet, 0)
            );
        }
        ...
        public void SourceTableParentValidation()
        {
            ...
            DataTableMapping secondDataTableMapping = new DataTableMapping(
                "AnotherCustomSourceTable",
                ""
            );
            ...
            Assert.Throws<ArgumentException>(
                () => secondDataTableMapping.SourceTable = "MyCustomSourceTable"
            );
        }
        ...
        public void Clone()
        {
            ...
            Assert.Equal(
                _dataTableMapping.ColumnMappings.Count,
                clonedDataTableMapping.ColumnMappings.Count
            );
        }
