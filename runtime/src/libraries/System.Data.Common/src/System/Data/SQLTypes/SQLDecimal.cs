    ...
    public struct SqlDecimal : INullable, IComparable, IXmlSerializable
    {
        ...
        */
        ...
        public static SqlDecimal operator *(SqlDecimal x, SqlDecimal y)
        {
            ...
            ReadOnlySpan<uint> rglData1 =
                stackalloc uint[4] { x._data1, x._data2, x._data3, x._data4 };
            ReadOnlySpan<uint> rglData2 =
                stackalloc uint[4] { y._data1, y._data2, y._data3, y._data4 };
        ...
        */
        ...
        private int LAbsCmp(SqlDecimal snumOp)
        {
            ...
            ReadOnlySpan<uint> rglData2 =
                stackalloc uint[4] { snumOp._data1, snumOp._data2, snumOp._data3, snumOp._data4 };
