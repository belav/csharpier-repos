...
namespace System.Data
{
          ...
          IXmlSerializable
    {
        ...
        internal void SerializeTableSchema(
            SerializationInfo info,
            StreamingContext context,
            bool isSingleTable
        )
        {
            ...
            for (int i = 0; i < Columns.Count; i++)
            {
                ...
                info.AddValue(
                    string
                        .Format(formatProvider, "DataTable.DataColumn_{0}.AutoIncrementCurrent", i),
        ...
        internal void DeserializeTableSchema(
            SerializationInfo info,
            StreamingContext context,
            bool isSingleTable
        )
            ...
            for (int i = 0; i < Constraints.Count; i++)
            {
                ...
                else
                {
                    ...
                    bool shouldSerialize =
                        (allConstraints == true) || (fk.Table == this && fk.RelatedTable == this);
        ...
        internal void DeserializeTableData(
            SerializationInfo info,
            StreamingContext context,
            int serIndex
        )
                        ...
                        if (_dataSet != null)
                        {
                            ...
                            if (
                                (
                                    0
                                    == string
                                        .Compare(value, _dataSet.DataSetName, true, _dataSet.Locale)
                                ) && !_fNestedInDataset
                            )
                            {
                    ...
                    if (value != _tableNamespace)
                    {
                        if (_dataSet != null)
                        {
                            string realNamespace = (
                                value == null ? GetInheritedNamespace(new List<DataTable>()) : value
                            );
                ...
                try
                {
                    ...
                    int saveIdxRecord =
                        (saveRowState == DataRowState.Added)
                            ...
                            : saveIdxRecord = targetRow._oldRecord;
                    int newRecord;
                    int oldRecord;
                    if (
...
#nullable enable
        ...
        public DataRow[] Select(string? filterExpression)
        {
            ...
            return new Select(this, filterExpression, "", DataViewRowState.CurrentRows)
                .SelectRows();
        }
        ...
        public DataRow[] Select(string? filterExpression, string? sort)
        {
            ...
            return new Select(this, filterExpression, sort, DataViewRowState.CurrentRows)
                .SelectRows();
        }
        ...
        internal DataColumn AddForeignKey(DataColumn parentKey)
        {
            Debug.Assert(
                parentKey != null,
                "AddForeignKey: Invalid paramter.. related primary key is null"
            );
            ...
            try
            {
                ...
                if (writer != null)
                {
                    if (mode == XmlWriteMode.DiffGram)
                    {
                        ...
                        new NewDiffgramGen(this, writeHierarchy)
                            .Save(writer, this);
                    }
                    else
                    {
        ...
        internal void ReadXmlSchema(XmlReader? reader, bool denyResolving)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    string CurrentTableName = CurrentTableFullName.Substring(
                        nsSeperator + 1,
                        CurrentTableFullName.Length - nsSeperator - 1
                    );
