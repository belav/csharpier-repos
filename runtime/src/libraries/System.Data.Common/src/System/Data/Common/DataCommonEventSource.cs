...
namespace System.Data
{
    ...
    internal sealed class DataCommonEventSource : EventSource
    {
        ...
        [NonEvent]
        internal void Trace<T0, T1, T2, T3, T4>(
            string format,
            T0 arg0,
            T1 arg1,
            T2 arg2,
        ...
        [NonEvent]
        internal void Trace<T0, T1, T2, T3, T4, T5, T6>(
            string format,
            T0 arg0,
            T1 arg1,
            T2 arg2,
        ...
        internal long EnterScope<T1>(string format, T1 arg1) =>
            Log.IsEnabled() ? EnterScope(string.Format(format, arg1)) : 0;

        [NonEvent]
        internal long EnterScope<T1, T2>(string format, T1 arg1, T2 arg2) =>
            Log.IsEnabled() ? EnterScope(string.Format(format, arg1, arg2)) : 0;

        [NonEvent]
        internal long EnterScope<T1, T2, T3>(string format, T1 arg1, T2 arg2, T3 arg3) =>
            Log.IsEnabled() ? EnterScope(string.Format(format, arg1, arg2, arg3)) : 0;

        [NonEvent]
        internal long EnterScope<T1, T2, T3, T4>(
            string format,
            T1 arg1,
            T2 arg2,
            T3 arg3,
            T4 arg4
        ) => Log.IsEnabled() ? EnterScope(string.Format(format, arg1, arg2, arg3, arg4)) : 0;
