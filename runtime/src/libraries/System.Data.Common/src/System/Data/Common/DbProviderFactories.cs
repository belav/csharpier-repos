...
namespace System.Data.Common
{
    public static partial class DbProviderFactories
    {
        ...
        > _registeredFactories = new ConcurrentDictionary<string, ProviderRegistration>();
        ...
        public static DbProviderFactory GetFactory(DataRow providerRow)
        {
            ...
            DataColumn? assemblyQualifiedNameColumn = providerRow.Table.Columns[
        ...
        )
        {
            ...
            bool wasRegistered = _registeredFactories.TryGetValue(
