...
namespace System.Collections.Immutable.Tests
{
    public class ImmutableDictionaryBuilderTest : ImmutableDictionaryBuilderTestBase
    {
        ...
        {
            ImmutableDictionary<string, int>.Builder builder = ImmutableDictionary
                .Create<string, int>()
                .ToBuilder();
        ...
        {
            ImmutableDictionary<string, int> map = ImmutableDictionary
                .Create<string, int>()
                .Add("five", 5);
        ...
        {
            ImmutableDictionary<string, string>.Builder builder = ImmutableDictionary
        ...
        {
            ImmutableDictionary<string, int>.Builder empty = ImmutableDictionary
                .Create<string, int>()
                .ToBuilder();
            ImmutableDictionary<string, int>.Builder populated = ImmutableDictionary
                .Create<string, int>()
                .Add("a", 5)
                .ToBuilder();
        ...
        public void DebuggerAttributesValid()
        {
            ...
            ImmutableDictionary<int, string>.Builder builder = ImmutableDictionary.CreateBuilder<
                int,
                string
            >();
            builder.Add(1, "One");
        ...
        {
            ImmutableDictionary<int, int>.Builder builder = ImmutableDictionary.CreateBuilder<
                int,
                int
            >();
            builder.Add(0, 0);
