...
namespace System.Collections.Immutable.Tests
{
    public partial class ImmutableSortedDictionaryTest : ImmutableDictionaryTestBase
    {
        ...
        public void RandomOperationsTest()
        {
            ...
            ImmutableSortedDictionary<int, bool> actual = ImmutableSortedDictionary<
                int,
                bool
            >.Empty;
            ...
            for (int iOp = 0; iOp < operationCount; iOp++)
            {
                switch ((Operation)random.Next((int)Operation.Last))
                {
                    ...
                    case Operation.Set:
                        ...
                        Debug.WriteLine(
                            "Setting \"{0}\"={1} to the set (overwrite={2}).",
                            key,
                            value,
                            overwrite
                        );
        ...
        {
            IImmutableDictionary<int, GenericParameterHelper> sortedMap = Empty<
                int,
        ...
        public void SortChangeTest()
        {
            ...
            ImmutableSortedDictionary<string, string> newMap = map.ToImmutableSortedDictionary(
        ...
        public void InitialBulkAddUniqueTest()
        {
            ...
            IImmutableDictionary<string, string> map = Empty<string, string>(
        ...
        public void ContainsValueTest()
        {
            this.ContainsValueTestHelper(
                ImmutableSortedDictionary<int, GenericParameterHelper>.Empty,
                1,
        ...
        public void Create()
        {
            ...
            ImmutableSortedDictionary<string, string> dictionary = ImmutableSortedDictionary.Create<
                string,
                string
            >();
        ...
        public void ToImmutableSortedDictionary()
        {
            ...
            ImmutableSortedDictionary<string, string> dictionary =
            ...
            dictionary = pairs.ToImmutableSortedDictionary(
        ...
        {
            ImmutableSortedDictionary<string, string> map = ImmutableSortedDictionary
        ...
        {
            ImmutableSortedDictionary<string, string> map = ImmutableSortedDictionary.Create<
                string,
                string
            >();
            Assert.Same(Comparer<string>.Default, map.KeyComparer);
        ...
        {
            ImmutableSortedDictionary<int, int> collection = ImmutableSortedDictionary
                .Create<int, int>()
                .Add(3, 5);
        ...
        public void DebuggerAttributesValid()
        {
            ...
            ImmutableSortedDictionary<int, int> dict = ImmutableSortedDictionary
                .Create<int, int>()
                .Add(1, 2)
                .Add(2, 3)
                .Add(3, 4);
            ...
            object rootNode = DebuggerAttributes.GetFieldValue(
                ImmutableSortedDictionary.Create<string, string>(),
                "_root"
            );
