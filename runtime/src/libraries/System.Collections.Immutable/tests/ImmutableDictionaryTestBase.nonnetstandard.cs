...
namespace System.Collections.Immutable.Tests
{
    public abstract partial class ImmutableDictionaryTestBase : ImmutablesTestBase
    {
        ...
        {
            IImmutableDictionary<int, GenericParameterHelper> map = Empty<
                int,
            ...
            IImmutableDictionary<int, GenericParameterHelper> map2 = Empty<
                int,
                GenericParameterHelper
            >();
        ...
        protected void AddRemoveEnumerableTestHelper(IImmutableDictionary<int, int> empty)
        {
            ...
            IImmutableDictionary<int, int> halfRemoved = nonEmpty.RemoveRange(
        ...
        protected void EnumeratorTestHelper(IImmutableDictionary<int, GenericParameterHelper> map)
        {
            ...
            using (
                IEnumerator<KeyValuePair<int, GenericParameterHelper>> enumerator =
                    map.GetEnumerator()
            )
            {
