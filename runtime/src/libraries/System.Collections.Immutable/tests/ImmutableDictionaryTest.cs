...
namespace System.Collections.Immutable.Tests
{
    public partial class ImmutableDictionaryTest : ImmutableDictionaryTestBase
    {
        ...
        {
            var map = Empty<string, CaseInsensitiveString>()
        ...
        public void ToImmutableDictionary()
        {
            ...
            var stringIntDictionary = list.ToImmutableDictionary(
                n => n.ToString(),
        ...
        public void WithComparersCollisions()
        {
            ...
            var map = ImmutableDictionary.Create<string, string>().Add("a", "1").Add("A", "1");
            map = map.WithComparers(StringComparer.OrdinalIgnoreCase);
            Assert.Same(StringComparer.OrdinalIgnoreCase, map.KeyComparer);
        ...
        public void CollisionExceptionMessageContainsKey()
        {
            var map = ImmutableDictionary
                ...
                .Add("firstKey", "1")
                .Add("secondKey", "2");
            var exception = AssertExtensions.Throws<ArgumentException>(
                null,
                () => map.Add("firstKey", "3")
            );
        ...
        {
            var map = ImmutableDictionary.Create<string, string>().Add("a", "1").Add("b", "2");
