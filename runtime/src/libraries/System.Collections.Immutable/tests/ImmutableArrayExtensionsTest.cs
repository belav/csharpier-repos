...
namespace System.Collections.Immutable.Tests
{
    public class ImmutableArrayExtensionsTest
    {
        ...
        private static readonly ImmutableArray<int>.Builder s_emptyBuilder =
            ImmutableArray.Create<int>().ToBuilder();
        private static readonly ImmutableArray<int>.Builder s_oneElementBuilder =
            ImmutableArray.Create<int>(1).ToBuilder();
        private static readonly ImmutableArray<int>.Builder s_manyElementsBuilder =
            ImmutableArray.Create<int>(1, 2, 3).ToBuilder();
        ...
        public void ToDictionary()
        {
            ...
            var stringToString = ImmutableArrayExtensions.ToDictionary(
                s_manyElements,
                n => n.ToString(),
                n => (n * 2).ToString()
            );
            ...
            var stringToInt = ImmutableArrayExtensions.ToDictionary(
                s_manyElements,
                n => n.ToString()
            );
            Assert.Equal(stringToString.Count, s_manyElements.Length);
