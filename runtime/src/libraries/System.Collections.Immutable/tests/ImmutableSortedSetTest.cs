...
namespace System.Collections.Immutable.Tests
{
    public partial class ImmutableSortedSetTest : ImmutableSetTest
    {
            ...
            for (int iOp = 0; iOp < operationCount; iOp++)
            {
                switch ((Operation)random.Next((int)Operation.Last))
                {
                    ...
                    case Operation.Union:
                        ...
                        int[] values = Enumerable.Range(0, inputLength)
        ...
        {
            var ordinalSet = ImmutableSortedSet<string>.Empty.WithComparer(StringComparer.Ordinal)
                .Add("apple")
                .Add("APPLE");
        ...
        {
            var set = ImmutableSortedSet.Create<string>("a")
