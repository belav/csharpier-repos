...
namespace System.Collections.Immutable
{
    ...
    public interface IImmutableDictionary<TKey, TValue> : IReadOnlyDictionary<TKey, TValue>
    {
        ...
        /// <exception cref="ArgumentException">Thrown when the given key already exists in the dictionary
        // but has a different value.</exception>
        /// <remarks>
        ...
        /// <exception cref="ArgumentException">Thrown when one of the given keys already exists in the
        // dictionary but has a different value.</exception>
        IImmutableDictionary<TKey, TValue> AddRange(IEnumerable<KeyValuePair<TKey, TValue>> pairs);

        /// <summary>
        /// Sets the specified key and value to the dictionary, possibly overwriting an existing value for
        // the given key.
        /// </summary>
        /// <param name="key">The key of the entry to add.</param>
        /// <param name="value">The value of the entry to add.</param>
        ...
        /// <remarks>
        /// If the given key-value pair are already in the dictionary, the existing instance is returned.
        /// If the key already exists but with a different value, a new instance with the overwritten value
        // will be returned.
        /// </remarks>
        ...
        /// </summary>
        /// <param name="items">The key=value pairs to set on the dictionary.  Any keys that conflict with
        // existing keys will overwrite the previous values.</param>
        ...
        /// <returns>A new dictionary with those keys removed; or this instance if those keys are not in the
        // dictionary.</returns>
        ...
        /// <returns>A new dictionary with the matching entry removed; or this instance if the key is not in
