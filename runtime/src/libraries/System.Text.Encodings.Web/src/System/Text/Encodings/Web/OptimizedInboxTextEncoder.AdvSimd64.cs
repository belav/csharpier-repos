        ...
        private unsafe nuint GetIndexOfFirstByteToEncodeAdvSimd64(byte* pData, nuint lengthInBytes)
        {
            ...
            if (lengthInBytes >= 16)
            {
                ...
                do
                {
                    ...
                    var allowedCodePointsShuffled = AdvSimd
                        .Arm64
                        .VectorTableLookup(allowedCodePoints, AdvSimd.And(packed, vec0xF));
                    var vecPowersOfTwoShuffled = AdvSimd
                        .Arm64
                        .VectorTableLookup(
                            vecPowersOfTwo,
            ...
            if ((lengthInBytes & 4) != 0)
            {
                ...
                Vector128<byte> packed = Vector128
                    .CreateScalarUnsafe(Unsafe.ReadUnaligned<uint>(pData + i))
                    .AsByte();
                var allowedCodePointsShuffled = AdvSimd
                    .Arm64
                    .VectorTableLookup(allowedCodePoints, AdvSimd.And(packed, vec0xF));
            ...
            if (lengthInChars >= 16)
            {
                ...
                do
                {
                    ...
                    Vector128<byte> packed = AdvSimd.ExtractNarrowingSaturateUnsignedUpper(
                        AdvSimd.ExtractNarrowingSaturateUnsignedLower(
