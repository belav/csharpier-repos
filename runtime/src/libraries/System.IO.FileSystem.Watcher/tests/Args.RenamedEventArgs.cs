...
namespace System.IO.Tests
{
    public class RenamedEventArgsTests
    {
        ...
        public static void RenamedEventArgs_ctor_NonPathPropertiesAreSetCorrectly(
        ...
        public static void RenamedEventArgs_ctor_OldFullPath_DirectoryIsAnAbsolutePath_Windows(
            string directory,
            string name,
            string oldName,
            string expectedOldFullPath
        )
        {
            RenamedEventArgs args = new RenamedEventArgs(
        ...
        public static void RenamedEventArgs_ctor_OldFullPath_DirectoryIsAnAbsolutePath_Unix(
            string directory,
            string name,
            string oldName,
            string expectedOldFullPath
        ...
        public static void RenamedEventArgs_ctor_OldFullPath_DirectoryIsRelativePath_Windows(
            string directory,
            string name,
            string oldName,
            string expectedOldFullPath
        ...
        [InlineData("bar", "foo.txt", "bar.txt", "bar/bar.txt")]
        [InlineData("bar/baz", "foo.txt", "bar.txt", "bar/baz/bar.txt")]
        public static void RenamedEventArgs_ctor_OldFullPath_DirectoryIsRelativePath_Unix(
            string directory,
            string name,
            string oldName,
            string expectedOldFullPath
        ...
        public static void RenamedEventArgs_ctor_EmptyOldFileName_Windows(
            string directory,
            string name,
            string oldName,
            string expectedOldFullPath
        ...
        [InlineData("bar", null, null, "bar/")]
        [InlineData("bar", "foo.txt", null, "bar/")]
        public static void RenamedEventArgs_ctor_EmptyOldFileName_Unix(
            string directory,
            string name,
            string oldName,
            string expectedOldFullPath
