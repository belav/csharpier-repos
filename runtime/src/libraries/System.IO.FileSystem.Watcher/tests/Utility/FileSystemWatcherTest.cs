...
namespace System.IO.Tests
{
    ...
    public abstract partial class FileSystemWatcherTest : FileCleanupTestBase
    {
        ...
        /// </summary>
        public static (AutoResetEvent EventOccured, FileSystemEventHandler Handler) WatchCreated(
            FileSystemWatcher watcher,
            string[] expectedPaths = null,
        ...
        /// </summary>
        public static (AutoResetEvent EventOccured, FileSystemEventHandler Handler) WatchDeleted(
            FileSystemWatcher watcher,
            string[] expectedPaths = null,
            ITestOutputHelper _output = null
        )
        ...
        /// Renamed event is thrown by the watcher.
        /// </summary>
        public static (AutoResetEvent EventOccured, RenamedEventHandler Handler) WatchRenamed(
            FileSystemWatcher watcher,
            string[] expectedPaths = null,
            ITestOutputHelper _output = null
        )
        ...
        )
        {
            bool result = true,
                ...
                verifyDeleted = true,
                verifyRenamed = true;
            (AutoResetEvent EventOccured, FileSystemEventHandler Handler) changed = default,
                created = default,
                deleted = default;
