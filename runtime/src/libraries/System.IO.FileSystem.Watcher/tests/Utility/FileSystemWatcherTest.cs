...
namespace System.IO.Tests
{
    public abstract partial class FileSystemWatcherTest : FileCleanupTestBase
    {
        ...
        /// </summary>
        public static (AutoResetEvent EventOccurred, FileSystemEventHandler Handler) WatchChanged(
        ...
        /// </summary>
        public static (AutoResetEvent EventOccurred, FileSystemEventHandler Handler) WatchCreated(
            FileSystemWatcher watcher,
            string[] expectedPaths = null,
        ...
        /// </summary>
        public static (AutoResetEvent EventOccurred, FileSystemEventHandler Handler) WatchDeleted(
            FileSystemWatcher watcher,
            string[] expectedPaths = null,
            ITestOutputHelper _output = null
        )
        ...
        /// Renamed event is thrown by the watcher.
        /// </summary>
        public static (AutoResetEvent EventOccurred, RenamedEventHandler Handler) WatchRenamed(
            FileSystemWatcher watcher,
            string[] expectedPaths = null,
            ITestOutputHelper _output = null
        )
        ...
        )
        {
            ExpectEvent(
                ...
                action,
                cleanup,
                expectedPath == null ? null : new string[] { expectedPath },
                attempts,
                timeout
            );
        }
        ...
        public static void ExpectNoEvent(
            FileSystemWatcher watcher,
            WatcherChangeTypes unExpectedEvents,
            Action action,
            Action cleanup = null,
            string expectedPath = null,
            int timeout = WaitForExpectedEventTimeout
        ...
        )
        {
            bool result = true,
                ...
                verifyDeleted = true,
                verifyRenamed = true;
            (AutoResetEvent EventOccurred, FileSystemEventHandler Handler) changed = default,
                created = default,
                deleted = default;
            ...
            if (verifyChanged)
            {
                ...
                if (assertExpected)
                    Assert.True(
                        Changed_expected == Changed_actual,
            ...
            if (verifyCreated)
            {
                ...
                bool Created_actual = created.EventOccurred.WaitOne(
                ...
                if (assertExpected)
                    Assert.True(
                        Created_expected == Created_actual,
            ...
            if (verifyDeleted)
            {
                ...
                bool Deleted_actual = deleted.EventOccurred.WaitOne(
                ...
                if (assertExpected)
                    Assert.True(
                        Deleted_expected == Deleted_actual,
            ...
            if (verifyRenamed)
            {
                ...
                bool Renamed_actual = renamed.EventOccurred.WaitOne(
                ...
                if (assertExpected)
                    Assert.True(
                        Renamed_expected == Renamed_actual,
        ...
        public const NotifyFilters LinuxFiltersForAttribute =
            ...
            | NotifyFilters.Size;
        public const NotifyFilters LinuxFiltersForModify =
            NotifyFilters.LastAccess
            | NotifyFilters.LastWrite
            | NotifyFilters.Security
            | NotifyFilters.Size;
        public const NotifyFilters OSXFiltersForModify =
            NotifyFilters.Attributes
            | NotifyFilters.CreationTime
            | NotifyFilters.LastAccess
            | NotifyFilters.LastWrite
        ...
        internal readonly struct FiredEvent
        {
            public FiredEvent(WatcherChangeTypes eventType, string dir1, string dir2 = "") =>
                (EventType, Dir1, Dir2) = (eventType, dir1, dir2);
            ...
            public bool Equals(FiredEvent other) =>
                EventType == other.EventType && Dir1 == other.Dir1 && Dir2 == other.Dir2;

            public override int GetHashCode() =>
                EventType.GetHashCode() ^ Dir1.GetHashCode() ^ Dir2.GetHashCode();
        ...
        )
        {
            ...
            RenamedEventHandler renameWatcherEvent = (_, e) =>
                AddEvent(e.ChangeType, e.FullPath, e.OldFullPath);
            ...
            {
                Assert.Fail(
                    $"Filewatcher error event triggered: {error.GetException()?.Message ?? "Unknow error"}"
                );
            }
