    ...
    public class HttpRequestCachePolicyTest
    {
        public static IEnumerable<object[]> Ctor_ExpectedPropertyValues_MemberData()
        {
            ...
            foreach (HttpRequestCacheLevel level in Enum.GetValues(typeof(HttpRequestCacheLevel)))
            {
                yield return new object[]
                {
                    new HttpRequestCachePolicy(level),
                    level,
                    TimeSpan.MaxValue,
                    TimeSpan.MinValue,
                    TimeSpan.MinValue,
            ...
            yield return new object[]
            {
                new HttpRequestCachePolicy(new DateTime(504000000000)),
                HttpRequestCacheLevel.Default,
                TimeSpan.MaxValue,
                TimeSpan.MinValue,
                TimeSpan.MinValue,
            ...
            yield return new object[]
            {
                new HttpRequestCachePolicy(HttpCacheAgeControl.MaxAge, TimeSpan.FromSeconds(1)),
                HttpRequestCacheLevel.Default,
            ...
            yield return new object[]
            {
                new HttpRequestCachePolicy(HttpCacheAgeControl.MaxStale, TimeSpan.FromSeconds(1)),
                HttpRequestCacheLevel.Default,
                TimeSpan.MaxValue,
                TimeSpan.FromSeconds(1),
                TimeSpan.MinValue,
            ...
            yield return new object[]
            {
                new HttpRequestCachePolicy(HttpCacheAgeControl.MinFresh, TimeSpan.FromSeconds(1)),
                HttpRequestCacheLevel.Default,
                TimeSpan.MaxValue,
                TimeSpan.MinValue,
                TimeSpan.FromSeconds(1),
        ...
        public void Ctor_InvalidArgs_Throws()
        {
            AssertExtensions.Throws<ArgumentOutOfRangeException>("level", () =>
                new HttpRequestCachePolicy((HttpRequestCacheLevel)42)
            );
            AssertExtensions.Throws<ArgumentException>("cacheAgeControl", () =>
                new HttpRequestCachePolicy(
                    HttpCacheAgeControl.MaxAgeAndMinFresh,
                    TimeSpan.FromSeconds(1)
                )
