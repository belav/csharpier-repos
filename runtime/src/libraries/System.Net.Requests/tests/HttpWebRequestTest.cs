...
namespace System.Net.Tests
{
    ...
    {
        public HttpWebRequestTest_Async(ITestOutputHelper output)
            : base(output) { }
    ...
    {
        public HttpWebRequestTest_Sync(ITestOutputHelper output)
            : base(output) { }
    ...
    public abstract partial class HttpWebRequestTest
    {
        ...
        private readonly NetworkCredential _explicitCredential = new NetworkCredential(
            "user",
            "password",
            "domain"
        );
        ...
        public static IEnumerable<object[]> CachableWebRequestParameters()
        {
            ...
            yield return new object[]
            {
                new HttpWebRequestParameters
                {
                    ...
                    AutomaticDecompression = DecompressionMethods.GZip,
                    MaximumAutomaticRedirections = 2,
                    MaximumResponseHeadersLength = 110,
                    PreAuthenticate = true,
                    SslProtocols = SecurityProtocolType.Tls12,
                    Timeout = 10000,
                },
            ...
            yield return new object[]
            {
                new HttpWebRequestParameters
                {
                    ...
                    MaximumResponseHeadersLength = 100,
                    PreAuthenticate = true,
                    SslProtocols = SecurityProtocolType.Tls11,
                    Timeout = 10000,
                },
                false,
            };
        ...
        public static IEnumerable<object[]> MixedWebRequestParameters()
        {
            ...
            yield return new object[]
            {
                new HttpWebRequestParameters
                {
                    ...
                    SslProtocols = SecurityProtocolType.Tls12,
                    Timeout = 100000,
                    NewServerCertificateValidationCallback = true,
                },
                false,
            };
            yield return new object[]
        ...
        )
        {
            ...
            AssertExtensions.Throws<ArgumentOutOfRangeException>(
                "value",
                () => request.MaximumResponseHeadersLength = -2
            );
        }
        ...
        [Theory, MemberData(nameof(EchoServers))]
        public void MaximumAutomaticRedirections_SetZeroOrNegative_ThrowsArgumentOutOfRangeException(
            Uri remoteServer
        )
        {
            HttpWebRequest request = WebRequest.CreateHttp(remoteServer);
            ...
            await LoopbackServer.CreateServerAsync(
                async (server, url) =>
                {
                    ...
                    await TaskTimeoutExtensions.WhenAllOrAnyFailed(
                        new Task[] { getResponseTask, serverTask }
                    );
        ...
        )
        {
            ...
            Assert.Same(
                serverCertificateVallidationCallback,
        ...
        public void ClientCertificates_SetNullX509_ThrowsArgumentNullException(Uri remoteServer)
        {
            ...
            AssertExtensions.Throws<ArgumentNullException>(
                "value",
                () => request.ClientCertificates = null
            );
        }
            ...
            await LoopbackServer.CreateClientAndServerAsync(
                ...
                async server =>
                {
                    ...
                    HttpRequestData requestData = await server.HandleRequestAsync(
                        headers: new HttpHeaderData[] { new HttpHeaderData("Host", host) }
                    );
        ...
        public async Task Headers_GetResponseHeaders_ContainsExpectedValue(bool useSsl)
        {
            ...
            await LoopbackServer.CreateClientAndServerAsync(
                ...
                {
                    HttpRequestData requestData = await server.HandleRequestAsync(
                        headers: new[] { new HttpHeaderData("Content-Type", HeadersPartialContent) }
                    );
        ...
        public async Task ProxySetViaEnvironmentVariable_DefaultProxyCredentialsUsed()
        {
            ...
            await LoopbackServer.CreateServerAsync(
                async (proxyServer, proxyUri) =>
                {
                    ...
                    proxyTask = proxyServer.AcceptConnectionPerformAuthenticationAndCloseAsync(
                    ...
                    RemoteExecutor
                        .Invoke(
                            ...
                            (this is HttpWebRequestTest_Async).ToString(),
                            cred.UserName,
                            cred.Password,
            ...
            await LoopbackServer.CreateClientAndServerAsync(
                ...
                async server =>
                {
                    HttpRequestData requestData = await server.HandleRequestAsync(
                        ...
                        {
                            new HttpHeaderData("Content-Type", ContentType),
                        }
                    );
        ...
        [
            ...
            MemberData(nameof(MixedWebRequestParameters))
        ]
        ...
        )
        {
            RemoteExecutor
                .Invoke(
                    ...
                    (this is HttpWebRequestTest_Async).ToString(),
                    JsonSerializer.Serialize<HttpWebRequestParameters>(requestParameters),
                    connectionReusedParameter.ToString()
                )
                .Dispose();
        }
        ...
        [InlineData(
            ...
            null,
            null,
            new string[] { "Cache-Control: only-if-cached" }
        )]
        [InlineData(
            HttpRequestCacheLevel.Default,
            HttpCacheAgeControl.MinFresh,
            10,
            new string[] { "Cache-Control: min-fresh=10" }
        )]
        [InlineData(
            HttpRequestCacheLevel.Default,
            HttpCacheAgeControl.MaxAge,
            10,
            new string[] { "Cache-Control: max-age=10" }
        )]
        [InlineData(
            HttpRequestCacheLevel.Default,
            HttpCacheAgeControl.MaxStale,
            10,
            new string[] { "Cache-Control: max-stale=10" }
        )]
        [InlineData(
            HttpRequestCacheLevel.Refresh,
            null,
            null,
            new string[] { "Pragma: no-cache", "Cache-Control: max-age=0" }
        )]
        public async Task SendHttpGetRequest_WithHttpCachePolicy_AddCacheHeaders(
            HttpRequestCacheLevel requestCacheLevel,
            HttpCacheAgeControl? ageControl,
            int? age,
                    ...
                    request.CachePolicy =
                        ageControl != null
                            ? new HttpRequestCachePolicy(
                                ageControl.Value,
                                TimeSpan.FromSeconds((double)age)
                            )
        ...
        private static async Task ReplyToClient(
            string responseContent,
            Socket server,
