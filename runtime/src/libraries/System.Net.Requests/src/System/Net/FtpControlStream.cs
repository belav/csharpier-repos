...
namespace System.Net
{
    ...
    internal sealed class FtpControlStream : CommandStream
    {
        ...
        protected override PipelineEntry[] BuildCommandsList(WebRequest req)
        {
            ...
            if (!request.MethodInfo.IsCommandOnly)
            {
                ...
                else
                {
                    ...
                    commandList.Add(
                        new PipelineEntry(FormatFtpCommand(portCommand, GetPortCommandLine()))
                    );
                }
        ...
        {
            get { return _bannerMessage?.ToString(); }
        }
        ...
        {
            get { return _welcomeMessage?.ToString(); }
        }
        ...
        {
            get { return _exitMessage?.ToString(); }
        }
