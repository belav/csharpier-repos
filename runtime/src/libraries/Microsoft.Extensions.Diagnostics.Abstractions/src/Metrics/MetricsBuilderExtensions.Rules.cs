...
namespace Microsoft.Extensions.Diagnostics.Metrics
{
    ...
    public static partial class MetricsBuilderExtensions
    {
        ...
        public static IMetricsBuilder EnableMetrics(
            ...
            builder.ConfigureRule(
                options => options.EnableMetrics(meterName, instrumentName, listenerName, scopes)
            );
        ...
        public static IMetricsBuilder DisableMetrics(
            ...
            builder.ConfigureRule(
                options => options.DisableMetrics(meterName, instrumentName, listenerName, scopes)
            );
        ...
        private static IMetricsBuilder ConfigureRule(
            this IMetricsBuilder builder,
        ...
        private static MetricsOptions AddRule(
            this MetricsOptions options,
            string? meterName,
