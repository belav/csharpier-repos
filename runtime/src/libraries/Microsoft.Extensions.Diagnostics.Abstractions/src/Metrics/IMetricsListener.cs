...
namespace Microsoft.Extensions.Diagnostics.Metrics
{
    ...
    public interface IMetricsListener
    {
        ...
        /// <summary>
        /// Called once by the runtime to provide a <see cref="IObservableInstrumentsSource"/> used to pull
        // for fresh metrics data.
        /// </summary>
        /// <param name="source">A <see cref="IObservableInstrumentsSource"/> that can be called to request
        // current metrics.</param>
        ...
        /// <param name="userState">Listener state associated with this instrument. This will be returned to
        // <see cref="MeasurementCallback{T}"/>
        /// and <see cref="MeasurementsCompleted(Instrument, object?)"/>.</param>
        /// <returns>Returns true if the listener wants to subscribe to this instrument, otherwise
        // false.</returns>
        ...
        /// <param name="userState">The original listener state returned by <see
        // cref="InstrumentPublished(Instrument, out object?)"/>.</param>
        public void MeasurementsCompleted(Instrument instrument, object? userState);

        /// <summary>
        /// Called once to get the <see cref="MeasurementHandlers"/> that will be used to process
        // measurements.
        /// </summary>
