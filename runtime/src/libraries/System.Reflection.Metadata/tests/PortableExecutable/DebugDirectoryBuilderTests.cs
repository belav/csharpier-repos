    ...
    public class DebugDirectoryBuilderTests
    {
        ...
        public void Empty()
        {
            ...
            var id = new BlobContentId(
                new Guid("3C88E66E-E0B9-4508-9290-11E0DB51A1C5"),
                0x12345678
            );
        ...
        public void AddCodeViewEntry1()
        {
            ...
            {
                var actual = PEReader.ReadDebugDirectoryEntries(
                    pinned.CreateReader(0, DebugDirectoryEntry.Size)
                );
        ...
        public void AddCodeViewEntry2()
        {
            ...
            b.AddCodeViewEntry(
                "foo.pdb" + new string('\0', 260 - "foo.pdb".Length - 1),
                id,
                0xABCD,
                0x99
            );
        ...
        public void EmbeddedPortablePdb()
        {
            ...
            AssertEx.Equal(
                ...
                decoded.GetContentUnchecked(0, decoded.Size)
            );
        }
