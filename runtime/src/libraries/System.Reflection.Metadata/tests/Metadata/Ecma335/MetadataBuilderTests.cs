...
namespace System.Reflection.Metadata.Ecma335.Tests
{
    public class MetadataBuilderTests
    {
        ...
        public void Add()
        {
            ...
            var assemblyReference = builder.AddAssemblyReference(
                default(StringHandle),
                new Version(0, 0, 0, 0),
                default(StringHandle),
                default(BlobHandle),
            ...
            var typeDefinition = builder.AddTypeDefinition(
            ...
            var typeReference = builder.AddTypeReference(
            ...
            var genericParameter = builder.AddGenericParameter(
                MetadataTokens.MethodDefinitionHandle(1),
            ...
            var methodDefinition = builder.AddMethodDefinition(
            ...
            builder.AddMethodImport(
                MetadataTokens.MethodDefinitionHandle(1),
                default(MethodImportAttributes),
                default(StringHandle),
                default(ModuleReferenceHandle)
            );
            ...
            var memberReference = builder.AddMemberReference(
                MetadataTokens.TypeDefinitionHandle(1),
                default(StringHandle),
                default(BlobHandle)
            );
            ...
            builder.AddManifestResource(
                default(ManifestResourceAttributes),
                default(StringHandle),
            ...
            builder.AddDeclarativeSecurityAttribute(
                MetadataTokens.TypeDefinitionHandle(1),
                default(DeclarativeSecurityAction),
                default(BlobHandle)
            );
            ...
            builder.AddEncLogEntry(
                MetadataTokens.TypeDefinitionHandle(1),
                default(EditAndContinueOperation)
            );
            ...
            var document = builder.AddDocument(
                default(BlobHandle),
                default(GuidHandle),
                default(BlobHandle),
                default(GuidHandle)
            ...
            var localScope = builder.AddLocalScope(
                default(MethodDefinitionHandle),
                default(ImportScopeHandle),
                default(LocalVariableHandle),
                default(LocalConstantHandle),
                default(int),
                default(int)
            );
            ...
            var localVariable = builder.AddLocalVariable(
                default(LocalVariableAttributes),
                default(int),
                default(StringHandle)
            );
            ...
            var localConstant = builder.AddLocalConstant(
                default(StringHandle),
                default(BlobHandle)
            );
            ...
            var importScope = builder.AddImportScope(
                default(ImportScopeHandle),
                default(BlobHandle)
            );
        ...
        public void Add_BadValues()
        {
            ...
            builder.AddMethodImport(
                default(MethodDefinitionHandle),
                (MethodImportAttributes)(-1),
                default(StringHandle),
                default(ModuleReferenceHandle)
            );
            builder.AddManifestResource(
                (ManifestResourceAttributes)(-1),
                default(StringHandle),
        ...
        {
            var mdBuilder = new MetadataBuilder();
            var serialized = mdBuilder.GetSerializedMetadata(
        ...
        public void GetOrAddDocumentName2()
        {
            ...
            using (var provider = MetadataReaderProvider.FromMetadataImage(mdImage))
            {
                ...
                Assert.Equal(
                    "",
                    mdReader.GetString(
                        MetadataTokens.DocumentNameBlobHandle(MetadataTokens.GetHeapOffset(n1))
                    )
                );
                Assert.Equal(
                    "/a/b/c",
                    mdReader.GetString(
                        MetadataTokens.DocumentNameBlobHandle(MetadataTokens.GetHeapOffset(n2))
                    )
                );
                Assert.Equal(
                    @"\a\b\cc",
                    mdReader.GetString(
                        MetadataTokens.DocumentNameBlobHandle(MetadataTokens.GetHeapOffset(n3))
                    )
                );
                Assert.Equal(
                    @"/a/b\c",
                    mdReader.GetString(
                        MetadataTokens.DocumentNameBlobHandle(MetadataTokens.GetHeapOffset(n4))
                    )
                );
                Assert.Equal(
                    @"/\a/\b\\//c",
                    mdReader.GetString(
                        MetadataTokens.DocumentNameBlobHandle(MetadataTokens.GetHeapOffset(n5))
                    )
                );
                Assert.Equal(
                    @"a/",
                    mdReader.GetString(
                        MetadataTokens.DocumentNameBlobHandle(MetadataTokens.GetHeapOffset(n6))
                    )
                );
                Assert.Equal(
                    @"/",
                    mdReader.GetString(
                        MetadataTokens.DocumentNameBlobHandle(MetadataTokens.GetHeapOffset(n7))
                    )
                );
                Assert.Equal(
                    @"\\",
                    mdReader.GetString(
                        MetadataTokens.DocumentNameBlobHandle(MetadataTokens.GetHeapOffset(n8))
                    )
                );
                if (PlatformDetection.IsNetCore)
                {
                    Assert.Equal(
                        "\uFFFD\uFFFD\uFFFD",
                        mdReader.GetString(
                            MetadataTokens.DocumentNameBlobHandle(MetadataTokens.GetHeapOffset(n9))
                        )
                    );
                }
                else
                ...
                Assert.Equal(
                    "\0",
                    mdReader.GetString(
                        MetadataTokens.DocumentNameBlobHandle(MetadataTokens.GetHeapOffset(n10))
                    )
                );
            }
        }
        ...
        public void HeapOverflow_UserString()
        {
            ...
            Assert.Equal(
                0x70000001,
                MetadataTokens.GetToken(builder1.GetOrAddUserString(veryLargeString))
            );
            ...
            Assert.Equal(
                0x70fffff6,
                MetadataTokens.GetToken(builder1.GetOrAddUserString(veryLargeString + "z"))
            );
            ...
            Assert.Equal(
                0x70000009,
                MetadataTokens.GetToken(builder2.GetOrAddUserString(veryLargeString))
            );
        ...
        public void ValidateGenericParamConstaintTable()
        {
            var builder = new MetadataBuilder();
            builder.AddGenericParameterConstraint(
                MetadataTokens.GenericParameterHandle(2),
                default(TypeDefinitionHandle)
            );
            builder.AddGenericParameterConstraint(
