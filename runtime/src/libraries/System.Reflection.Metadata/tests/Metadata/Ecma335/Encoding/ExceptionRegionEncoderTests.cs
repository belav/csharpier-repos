...
namespace System.Reflection.Metadata.Ecma335.Tests
{
    public class ExceptionRegionEncoderTests
    {
        ...
        public void IsSmallExceptionRegion()
        {
            ...
            Assert.True(
                ExceptionRegionEncoder.IsSmallExceptionRegion(ushort.MaxValue, byte.MaxValue)
            );

            Assert.False(
                ExceptionRegionEncoder.IsSmallExceptionRegion(ushort.MaxValue + 1, byte.MaxValue)
            );
            Assert.False(
                ExceptionRegionEncoder.IsSmallExceptionRegion(ushort.MaxValue, byte.MaxValue + 1)
            );
        ...
        public void SerializeTableHeader()
        {
            ...
            ExceptionRegionEncoder.SerializeTableHeader(
                builder,
                ExceptionRegionEncoder.MaxSmallExceptionRegions,
            ...
            ExceptionRegionEncoder.SerializeTableHeader(
                builder,
                ExceptionRegionEncoder.MaxExceptionRegions,
        ...
        public void Add_Small()
        {
            ...
            encoder.Add(
                ...
                4,
                5,
                catchType: MetadataTokens.TypeDefinitionHandle(1)
            );
            ...
            AssertExtensions.Throws<ArgumentException>(
                ...
                () =>
                    fatEncoder.Add(
                        ...
                        4,
                        5,
                        catchType: default(EntityHandle)
                    )
            );
            AssertExtensions.Throws<ArgumentException>(
                "catchType",
                () =>
                    fatEncoder.Add(
                        ...
                        4,
                        5,
                        catchType: MetadataTokens.ImportScopeHandle(1)
                    )
            );
        }
    }
