...
namespace System.Reflection.Metadata.Ecma335.Tests
{
    public class InstructionEncoderTests
    {
        ...
        public void OpCode()
        {
            ...
            AssertEx.Equal(
                new byte[] { 0xFF, 0x58, 0xEE, 0xFE, 0x00, 0xDD, 0xFE, 0x1E, 0xCC },
                builder.ToArray()
            );
        }
        ...
        public void Branch()
        {
            ...
            AssertEx.Equal(
                new byte[]
                {
                    (byte)ILOpCode.Br_s,
                    0xff,
                    (byte)ILOpCode.Brfalse_s,
                    0xff,
                    (byte)ILOpCode.Brtrue_s,
                    0xff,
                    (byte)ILOpCode.Beq_s,
                    0xff,
                    (byte)ILOpCode.Bge_s,
                    ...
                    (byte)ILOpCode.Blt_s,
                    0xff,
                    (byte)ILOpCode.Bne_un_s,
                    0xff,
                    (byte)ILOpCode.Bge_un_s,
                    0xff,
                    (byte)ILOpCode.Bgt_un_s,
                    0xff,
                    ...
                    0xff,
                    0xff,
                    (byte)ILOpCode.Bne_un,
                    0xff,
                    0xff,
                    0xff,
                    0xff,
                    (byte)ILOpCode.Bge_un,
                    0xff,
                    0xff,
                    0xff,
                    0xff,
                    (byte)ILOpCode.Bgt_un,
                    0xff,
                    0xff,
                    0xff,
                    0xff,
                    (byte)ILOpCode.Ble_un,
                    0xff,
                    0xff,
                    0xff,
                    0xff,
                    (byte)ILOpCode.Blt_un,
                    0xff,
                    0xff,
                    0xff,
                    0xff,
