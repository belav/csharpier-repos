...
namespace System.Reflection.Metadata.Decoding.Tests
{
    public class MethodSignatureTests
    {
        ...
        public void VerifyConstructor()
        {
            ...
            var methodSignature = new MethodSignature<int>(
                header,
                returnType,
        ...
        public void VerifyConstructor2()
        {
            var header = new SignatureHeader(
                ...
                SignatureAttributes.ExplicitThis | SignatureAttributes.Generic
            );
            ...
            Assert.Equal(
                0xff,
                new SignatureHeader(0, (SignatureCallingConvention)0xff, 0).RawValue
            );
