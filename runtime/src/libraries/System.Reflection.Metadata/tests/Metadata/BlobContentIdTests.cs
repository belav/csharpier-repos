...
namespace System.Reflection.Metadata.Tests
{
    public class BlobContentIdTests
    {
        ...
        public void Ctor()
        {
            ...
            var id2 = new BlobContentId(
                new Guid("D6D61CDE-5BAF-4E77-ADDD-3B80F4020BF2"),
                0x12345678
            );
        ...
        {
            var id1 = BlobContentId.FromHash(
                ImmutableArray.Create<byte>(
                    1,
                    2,
                    3,
            ...
            var id2 = BlobContentId.FromHash(
            ...
            var id3 = BlobContentId.FromHash(
                new byte[]
                {
                    0xff,
                    0xff,
