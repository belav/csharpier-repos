...
namespace System.Reflection.Metadata.Ecma335
{
    internal static class TypeDefOrRefTag
    {
        ...
        internal const uint TagToTokenTypeByteVector =
            TokenTypeIds.TypeDef >> 24 | TokenTypeIds.TypeRef >> 16 | TokenTypeIds.TypeSpec >> 8;
        internal const TableMask TablesReferenced =
            TableMask.TypeDef | TableMask.TypeRef | TableMask.TypeSpec;
        ...
        {
            uint tokenType =
                (TagToTokenTypeByteVector >> ((int)(typeDefOrRefTag & TagMask) << 3))
