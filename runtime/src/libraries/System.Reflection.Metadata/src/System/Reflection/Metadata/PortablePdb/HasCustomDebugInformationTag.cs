    ...
    internal static class HasCustomDebugInformationTag
    {
        ...
        internal static uint ConvertToTag(EntityHandle handle)
        {
            ...
            return (tokenType >> TokenTypeIds.RowIdBitCount) switch
            {
                ...
                TokenTypeIds.Document >> TokenTypeIds.RowIdBitCount
                    => rowId << NumberOfBits | Document,
                TokenTypeIds.LocalScope >> TokenTypeIds.RowIdBitCount
                    => rowId << NumberOfBits | LocalScope,
                TokenTypeIds.LocalVariable >> TokenTypeIds.RowIdBitCount
                    => rowId << NumberOfBits | LocalVariable,
                TokenTypeIds.LocalConstant >> TokenTypeIds.RowIdBitCount
                    => rowId << NumberOfBits | LocalConstant,
                TokenTypeIds.ImportScope >> TokenTypeIds.RowIdBitCount
