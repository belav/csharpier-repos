        ...
        private sealed class MulInt64 : MulInstruction
        {
            public override int Run(InterpretedFrame frame)
            {
                ...
                if (left != null)
                {
                    object? right = stack[index - 1];
                    stack[index - 2] =
                        right == null ? null : (object)unchecked((long)left * (long)right);
                }
        ...
        private sealed class MulUInt32 : MulInstruction
        {
            public override int Run(InterpretedFrame frame)
            {
                ...
                if (left != null)
                {
                    object? right = stack[index - 1];
                    stack[index - 2] =
                        right == null ? null : (object)unchecked((uint)left * (uint)right);
                }
        ...
        private sealed class MulUInt64 : MulInstruction
        {
            public override int Run(InterpretedFrame frame)
            {
                ...
                if (left != null)
                {
                    object? right = stack[index - 1];
                    stack[index - 2] =
                        right == null ? null : (object)unchecked((ulong)left * (ulong)right);
                }
        ...
        private sealed class MulOvfInt16 : MulOvfInstruction
        {
            public override int Run(InterpretedFrame frame)
            {
                ...
                if (left != null)
                {
                    object? right = stack[index - 1];
                    stack[index - 2] =
                        right == null ? null : (object)checked((short)((short)left * (short)right));
                }
        ...
        private sealed class MulOvfInt64 : MulOvfInstruction
        {
            public override int Run(InterpretedFrame frame)
            {
                ...
                if (left != null)
                {
                    object? right = stack[index - 1];
                    stack[index - 2] =
                        right == null ? null : (object)checked((long)left * (long)right);
                }
            ...
            public override int Run(InterpretedFrame frame)
            {
                ...
                if (left != null)
                {
                    ...
                    stack[index - 2] =
                        right == null
                            ? null
                            : (object)checked((ushort)((ushort)left * (ushort)right));
                }
        ...
        private sealed class MulOvfUInt32 : MulOvfInstruction
        {
            public override int Run(InterpretedFrame frame)
            {
                ...
                if (left != null)
                {
                    object? right = stack[index - 1];
                    stack[index - 2] =
                        right == null ? null : (object)checked((uint)left * (uint)right);
                }
        ...
        private sealed class MulOvfUInt64 : MulOvfInstruction
        {
            public override int Run(InterpretedFrame frame)
            {
                ...
                if (left != null)
                {
                    object? right = stack[index - 1];
                    stack[index - 2] =
                        right == null ? null : (object)checked((ulong)left * (ulong)right);
                }
