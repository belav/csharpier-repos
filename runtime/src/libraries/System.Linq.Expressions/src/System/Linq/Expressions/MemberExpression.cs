...
namespace System.Linq.Expressions
{
    ...
    public partial class Expression
    {
        ...
        /// </summary>
        /// <param name="expression">The containing object of the field.  This can be null for static
        // fields.</param>
        ...
        public static MemberExpression Field(Expression? expression, FieldInfo field)
        {
            ...
            else
            {
                ...
                {
                    throw Error.FieldInfoNotDefinedForType(
                        field.DeclaringType,
                        field.Name,
                        expression.Type
                    );
        ...
        /// </summary>
        /// <param name="expression">The containing object of the property.  This can be null for static
        // properties.</param>
        ...
        public static MemberExpression Property(Expression expression, string propertyName)
        {
            ...
            if (pi == null)
            {
                throw Error.InstancePropertyNotDefinedForType(
                    propertyName,
                    expression.Type,
                    nameof(propertyName)
                );
        ...
        public static MemberExpression Property(Expression? expression, PropertyInfo property)
        {
            ...
            else
            {
                ...
                {
                    throw Error.PropertyNotDefinedForType(
                        property,
                        expression.Type,
                        nameof(property)
                    );
        ...
        /// </summary>
        /// <param name="expression">The containing object of the member.  This can be null for static
        // members.</param>
