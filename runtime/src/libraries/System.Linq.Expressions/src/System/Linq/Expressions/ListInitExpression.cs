...
namespace System.Linq.Expressions
{
    ...
    /// </summary>
    /// <remarks>
    /// Use the <see cref="Expression.ListInit(NewExpression, Expression[])"/> factory methods to create
    ...
    {
        /// <summary>
        /// Creates a <see cref="ListInitExpression"/> that uses a method named "Add" to add elements to a
        // collection.
        /// </summary>
        /// <param name="newExpression">A <see cref="NewExpression"/> to set the <see
        // cref="ListInitExpression.NewExpression"/> property equal to.</param>
        /// <param name="initializers">An array of <see cref="Expression"/> objects to use to populate the
        // <see cref="ListInitExpression.Initializers"/> collection.</param>
        /// <returns>A <see cref="ListInitExpression"/> that has the <see cref="NodeType"/> property equal
        // to <see cref="ExpressionType.ListInit"/> and the <see cref="ListInitExpression.NewExpression"/>
        ...
        // cref="ListInitExpression.Initializers"/> collection.</param>
        /// <returns>A <see cref="ListInitExpression"/> that has the <see cref="NodeType"/> property equal
        // to <see cref="ExpressionType.ListInit"/> and the <see cref="ListInitExpression.NewExpression"/>
        // property set to the specified value.</returns>
        [RequiresUnreferencedCode(ExpressionRequiresUnreferencedCode)]
        ...
        /// <summary>
        /// Creates a <see cref="ListInitExpression"/> that uses a specified method to add elements to a
        // collection.
        /// </summary>
        /// <param name="newExpression">A <see cref="NewExpression"/> to set the <see
        // cref="ListInitExpression.NewExpression"/> property equal to.</param>
        /// <param name="addMethod">A <see cref="MethodInfo"/> that represents an instance method named
        // "Add" (case insensitive), that adds an element to a collection.</param>
        /// <param name="initializers">An array of <see cref="Expression"/> objects to use to populate the
        // <see cref="ListInitExpression.Initializers"/> collection.</param>
        /// <returns>A <see cref="ListInitExpression"/> that has the <see cref="NodeType"/> property equal
        // to <see cref="ExpressionType.ListInit"/> and the <see cref="ListInitExpression.NewExpression"/>
        ...
        // "Add" (case insensitive), that adds an element to a collection.</param>
        /// <param name="initializers">An <see cref="IEnumerable{T}"/> that contains <see
        // cref="Expression"/> objects to use to populate the Initializers collection.</param>
        /// <returns>A <see cref="ListInitExpression"/> that has the <see cref="NodeType"/> property equal
        // to <see cref="ExpressionType.ListInit"/> and the <see cref="ListInitExpression.NewExpression"/>
        // property set to the specified value.</returns>
        [RequiresUnreferencedCode(ExpressionRequiresUnreferencedCode)]
        ...
        /// <summary>
        /// Creates a <see cref="ListInitExpression"/> that uses specified <see
        // cref="Expressions.ElementInit"/> objects to initialize a collection.
        /// </summary>
        /// <param name="newExpression">A <see cref="NewExpression"/> to set the <see
        // cref="ListInitExpression.NewExpression"/> property equal to.</param>
        /// <param name="initializers">An array that contains <see cref="Expressions.ElementInit"/> objects
        // to use to populate the <see cref="ListInitExpression.Initializers"/> collection.</param>
        /// <returns>
        /// A <see cref="ListInitExpression"/> that has the <see cref="NodeType"/> property equal to <see
        // cref="ExpressionType.ListInit"/>
        /// and the <see cref="ListInitExpression.NewExpression"/> and <see
        // cref="ListInitExpression.Initializers"/> properties set to the specified values.
        /// </returns>
        /// <remarks>
        /// The <see cref="Type"/> property of <paramref name="newExpression"/> must represent a type that
        // implements <see cref="Collections.IEnumerable"/>.
        ...
        // cref="Expressions.ElementInit"/> objects to use to populate the <see
        // cref="ListInitExpression.Initializers"/> collection.</param>
        /// <returns>An <see cref="IEnumerable{T}"/> that contains <see cref="Expressions.ElementInit"/>
