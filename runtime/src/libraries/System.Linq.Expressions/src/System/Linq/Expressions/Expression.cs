...
namespace System.Linq.Expressions
{
    ...
    public abstract partial class Expression
    {
        ...
        internal const string PropertyFromAccessorRequiresUnreferencedCode =
            "The Property metadata or other accessor may be trimmed.";
        internal const string GenericMethodRequiresUnreferencedCode =
        ...
        internal const string GenericMethodRequiresDynamicCode =
            "Calling a generic method requires dynamic code generation. This can be suppressed if the method is not generic.";
        internal const string CallSiteRequiresDynamicCode =
            "Creating a call site may require dynamic code generation.";
        internal const string LambdaCompilerRequiresDynamicCode =
            "Compiling a lambda expression requires dynamic code generation.";
        internal const string StrongBoxRequiresDynamicCode =
            "Creating a StrongBox requires dynamic code generation.";
        internal const string NewArrayRequiresDynamicCode =
            "Creating arrays at runtime requires dynamic code generation.";
        internal const string DelegateCreationRequiresDynamicCode =
            "Delegate creation requires dynamic code generation.";

        private static readonly CacheDict<Type, MethodInfo> s_lambdaDelegateCache = new CacheDict<
            Type,
            MethodInfo
        >(40);
        private static volatile CacheDict<
            Type,
            Func<
                Expression,
                string?,
        ...
        /// </summary>
        /// <param name="nodeType">The <see ctype="ExpressionType"/> of the <see
        // cref="Expression"/>.</param>
        ...
        /// <summary>
        /// Reduces the node and then calls the <see cref="ExpressionVisitor.Visit(Expression)"/> method
        // passing the reduced expression.
        /// Throws an exception if the node isn't reducible.
        /// </summary>
        /// <param name="visitor">An instance of <see cref="ExpressionVisitor"/>.</param>
        /// <returns>The expression being visited, or an expression which should replace it in the
        // tree.</returns>
        /// <remarks>
        ...
        public Expression ReduceAndCheck()
        {
            ...
            // 2. Reduction must return a new node whose result type can be assigned to the type of the original
            // node
        ...
        {
            // Note that this property is often accessed using reflection. As such it will have more
            // dependencies than one
            // might surmise from its being internal, and removing it requires greater caution than with other
            // internal methods.
            get
            {
                using (
        ...
        /// <summary>
        /// Creates a <see cref="DynamicExpression" /> that represents a dynamic operation bound by the
        // provided <see cref="CallSiteBinder" />.
        /// </summary>
        ...
        /// <summary>
        /// Creates a <see cref="DynamicExpression" /> that represents a dynamic operation bound by the
        // provided <see cref="CallSiteBinder" /> and one argument.
        /// </summary>
        /// <param name="delegateType">The type of the delegate used by the <see cref="CallSite" />.</param>
        /// <param name="binder">The runtime binder for the dynamic operation.</param>
        ...
        /// <summary>
        /// Creates a <see cref="DynamicExpression" /> that represents a dynamic operation bound by the
        // provided <see cref="CallSiteBinder" /> and two arguments.
        /// </summary>
        /// <param name="delegateType">The type of the delegate used by the <see cref="CallSite" />.</param>
        /// <param name="binder">The runtime binder for the dynamic operation.</param>
        /// <param name="arg0">The first argument to the dynamic operation.</param>
        ...
        /// <summary>
        /// Creates a <see cref="DynamicExpression" /> that represents a dynamic operation bound by the
        // provided <see cref="CallSiteBinder" /> and three arguments.
        /// </summary>
        /// <param name="delegateType">The type of the delegate used by the <see cref="CallSite" />.</param>
        /// <param name="binder">The runtime binder for the dynamic operation.</param>
        /// <param name="arg0">The first argument to the dynamic operation.</param>
        ...
        /// <summary>
        /// Creates a <see cref="DynamicExpression" /> that represents a dynamic operation bound by the
        // provided <see cref="CallSiteBinder" /> and four arguments.
        /// </summary>
        /// <param name="delegateType">The type of the delegate used by the <see cref="CallSite" />.</param>
        /// <param name="binder">The runtime binder for the dynamic operation.</param>
        /// <param name="arg0">The first argument to the dynamic operation.</param>
