...
namespace System.Linq.Expressions.Compiler
{
    ...
    internal sealed class AssemblyGen
    {
        ...
        )
        {
            ...
            // An unhandled Exception: System.Runtime.InteropServices.COMException (0x80131130): Record not
            // found on lookup.
            // is thrown if there is any of the characters []*&+,\ in the type name and a method defined on the
            // type is called.
            sb.Replace('+', '_')
                .Replace('[', '_')
                .Replace(']', '_')
