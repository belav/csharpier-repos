...
namespace System.Linq.Expressions.Tests
{
    public class SwitchTests
    {
        ...
        public void IntSwitch1(bool useInterpreter)
        {
            ...
            Func<int, string> f = Expression.Lambda<Func<int, string>>(block, p)
        ...
        public void SwitchToGotosOutOfTry(bool useInterpreter)
        {
            ...
            Func<char, string> f = Expression.Lambda<Func<char, string>>(block, p)
                .Compile(useInterpreter);
        ...
        public void IntSwitch2(bool useInterpreter)
        {
            ...
            Func<byte, string> f = Expression.Lambda<Func<byte, string>>(block, p)
                .Compile(useInterpreter);
        ...
        public void IntSwitch3(bool useInterpreter)
        {
            ...
            Func<uint, string> f = Expression.Lambda<Func<uint, string>>(block, p)
                .Compile(useInterpreter);
        ...
        public void LongSwitch(bool useInterpreter)
        {
            ...
            Func<long, string> f = Expression.Lambda<Func<long, string>>(block, p)
                .Compile(useInterpreter);
        ...
        public void ULongSwitch(bool useInterpreter)
        {
            ...
            Func<ulong, string> f = Expression.Lambda<Func<ulong, string>>(block, p)
                .Compile(useInterpreter);
        ...
        public void StringSwitch(bool useInterpreter)
        {
            ...
            Func<string, string> f = Expression.Lambda<Func<string, string>>(s, p)
                .Compile(useInterpreter);
        ...
        public void StringSwitchTailCall(bool useInterpreter)
        {
            ...
            Func<string, string> f = Expression.Lambda<Func<string, string>>(s, true, p)
                .Compile(useInterpreter);
        ...
        public void StringSwitchTailCallButNotLast(bool useInterpreter)
        {
            ...
            Func<string, string> f = Expression.Lambda<Func<string, string>>(block, true, p)
                .Compile(useInterpreter);
        ...
        public void StringSwitch1(bool useInterpreter)
        {
            ...
            Func<string, string> f = Expression.Lambda<Func<string, string>>(block, p)
                .Compile(useInterpreter);
        ...
        public void ObjectSwitch1(bool useInterpreter)
        {
            ...
            Func<object, string> f = Expression.Lambda<Func<object, string>>(block, p)
                .Compile(useInterpreter);
        ...
        public void DefaultOnlySwitch(bool useInterpreter)
        {
            ...
            Func<int, int> fInt32Int32 = Expression.Lambda<Func<int, int>>(s, p)
                .Compile(useInterpreter);
            ...
            Func<int, object> fInt32Object = Expression.Lambda<Func<int, object>>(s, p)
                .Compile(useInterpreter);
            ...
            Func<string, string> fStringString = Expression.Lambda<Func<string, string>>(s, p)
                .Compile(useInterpreter);
        ...
        public void DefaultOnlySwitchWithSideEffect(bool useInterpreter)
        {
            ...
            RefSettingDelegate fInt32Int32 = Expression.Lambda<RefSettingDelegate>(s, pOut)
                .Compile(useInterpreter);
        ...
        public void NoDefaultOrCasesSwitchWithSideEffect(bool useInterpreter)
        {
            ...
            JustRefSettingDelegate f = Expression.Lambda<JustRefSettingDelegate>(s, pOut)
                .Compile(useInterpreter);
        ...
        public void SwitchOnString(bool useInterpreter)
        {
            ...
            {
                SwitchCase[] cases = values.Take(i)
                    .Select(
                        (s, j) =>
                            Expression.SwitchCase(
