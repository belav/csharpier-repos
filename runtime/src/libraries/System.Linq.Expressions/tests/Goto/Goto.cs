...
namespace System.Linq.Expressions.Tests
{
    public class Goto : GotoExpressionTests
    {
        ...
        public void NullValueOnNonVoidGoto(Type type)
        {
            AssertExtensions.Throws<ArgumentException>(
                "target",
                () => Expression.Goto(Expression.Label(type))
            );
            AssertExtensions.Throws<ArgumentException>(
                "target",
                () => Expression.Goto(Expression.Label(type), default(Expression))
            );
            AssertExtensions.Throws<ArgumentException>(
                "target",
                () => Expression.Goto(Expression.Label(type), null, type)
            );
        }
        ...
        public void ExplicitNullTypeWithValue(object value)
        {
            AssertExtensions.Throws<ArgumentException>(
                "target",
                () => Expression.Goto(Expression.Label(value.GetType()), default(Type))
            );
        }
        ...
        public void UnreadableLabel()
        {
            ...
            AssertExtensions.Throws<ArgumentException>(
                "value",
                () => Expression.Goto(target, value, typeof(string))
            );
        }
        ...
        public void CannotAssignValueTypesToObject(object value)
        {
            AssertExtensions.Throws<ArgumentException>(
                null,
                () => Expression.Goto(Expression.Label(typeof(object)), Expression.Constant(value))
            );
        }
        ...
        public void OpenGenericType()
        {
            AssertExtensions.Throws<ArgumentException>(
                "type",
                () => Expression.Goto(Expression.Label(typeof(void)), typeof(List<>))
            );
        }
        ...
        public static void TypeContainsGenericParameters()
        {
            AssertExtensions.Throws<ArgumentException>(
                "type",
                () => Expression.Goto(Expression.Label(typeof(void)), typeof(List<>.Enumerator))
            );
            AssertExtensions.Throws<ArgumentException>(
                "type",
                () =>
        ...
        public void PointerType()
        {
            AssertExtensions.Throws<ArgumentException>(
                "type",
                () => Expression.Goto(Expression.Label(typeof(void)), typeof(int).MakePointerType())
            );
        }
        ...
        public void ByRefType()
        {
            AssertExtensions.Throws<ArgumentException>(
                "type",
                () => Expression.Goto(Expression.Label(typeof(void)), typeof(int).MakeByRefType())
            );
        }
        ...
        {
            Expression<Action> goNowhere = Expression.Lambda<Action>(
