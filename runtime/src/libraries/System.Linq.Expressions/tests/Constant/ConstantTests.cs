...
namespace System.Linq.Expressions.Tests
{
    public static class ConstantTests
    {
        ...
        public static void BoundConstantCaching1(bool useInterpreter)
        {
            ...
            BinaryExpression e = Expression.Add(
                Expression.Field(c, "Foo"),
                Expression.Subtract(Expression.Field(c, "Baz"), Expression.Field(c, "Qux"))
            );
        ...
        public static void BoundConstantCaching2(bool useInterpreter)
        {
            ...
            BinaryExpression e = Expression.Add(
                ...
                Expression.Subtract(Expression.Field(c2, "Baz"), Expression.Field(c3, "Qux"))
            );
        ...
        private static void CheckGenericWithStructRestrictionConstantHelper<Ts>(bool useInterpreter)
            where Ts : struct
        {
        ...
        private static void CheckGenericWithClassRestrictionHelper<Tc>(bool useInterpreter)
            where Tc : class
        {
        ...
        private static void CheckGenericWithClassAndNewRestrictionHelper<Tcn>(bool useInterpreter)
            where Tcn : class, new()
        {
        ...
        private static void CheckGenericWithSubClassRestrictionHelper<TC>(bool useInterpreter)
            where TC : C
        {
        ...
        {
            Expression<Func<Type>> e = Expression.Lambda<Func<Type>>(
        ...
        {
            Expression<Func<MethodInfo>> e = Expression.Lambda<Func<MethodInfo>>(
        ...
        private static void VerifyGenericWithStructRestriction<Ts>(Ts value, bool useInterpreter)
            where Ts : struct
        {
        ...
        private static void VerifyGenericWithClassRestriction<Tc>(Tc value, bool useInterpreter)
            where Tc : class
        {
        ...
        private static void VerifyGenericWithSubClassRestriction<TC>(TC value, bool useInterpreter)
            where TC : C
        {
            Expression<Func<TC>> e = Expression.Lambda<Func<TC>>(
                Expression.Constant(value, typeof(TC)),
