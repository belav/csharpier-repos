...
namespace System.Linq.Expressions.Tests
{
    public static class ConstantArrayTests
    {
        ...
        {
            foreach (
                IEquatable<D>[] value in new IEquatable<D>[][]
                {
                    null,
                    new IEquatable<D>[0],
        ...
        private static void CheckGenericWithClassRestrictionArrayHelper<Tc>(bool useInterpreter)
            where Tc : class
        {
            foreach (
                Tc[] value in new Tc[][]
