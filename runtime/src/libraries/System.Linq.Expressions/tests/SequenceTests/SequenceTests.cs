...
namespace System.Linq.Expressions.Tests
{
    public class Expression_Tests
    {
        ...
        public static void NewMakeBinary()
        {
            ...
            BinaryExpression v = Expression.MakeBinary(
...
#pragma warning restore xUnit1013
        ...
        public class Atom
        {
            public static implicit operator bool(Atom atom)
            {
                return true;
            }
            ...
            public Atom this[Atom b0, Atom b1]
            {
                get { return null; }
            }
        }
        ...
        public static void EqualityBetweenReferenceAndInterfacesSucceeds()
        {
            ...
            Expression.Equal(
                Expression.Constant(null, typeof(BaseClass)),
                Expression.Constant(null, typeof(IEnumerable))
            );
            Expression.Equal(
                Expression.Constant(null, typeof(IEnumerable)),
        ...
        public static void EqualityBetweenInheritedTypesSucceeds()
        {
            Expression.Equal(
                Expression.Constant(null, typeof(BaseClass)),
                Expression.Constant(null, typeof(DerivedClass))
            );
            Expression.Equal(
                Expression.Constant(null, typeof(DerivedClass)),
                Expression.Constant(null, typeof(BaseClass))
        ...
        private static void TestUserDefinedMathOperators<X, Y>()
        {
            ...
            AssertIsOp(
                Expression.AddChecked(x, y, nnX.GetMethod("op_Subtraction")),
                "op_Subtraction"
            );
            ...
            AssertIsOp(
                Expression.SubtractChecked(x, y, nnX.GetMethod("op_Addition")),
                "op_Addition"
            );
            ...
            AssertIsOp(
                Expression.MultiplyChecked(x, y, nnY.GetMethod("op_Division")),
                "op_Division"
            );
        ...
        private static void TestUserDefinedComparisonOperators<X, Y>()
        {
            ...
            AssertIsOp(
                Expression.LessThan(x, y, false, nnX.GetMethod("op_GreaterThan")),
                "op_GreaterThan"
            );
            AssertIsOp(
                Expression.LessThan(x, y, true, nnX.GetMethod("op_GreaterThan")),
                "op_GreaterThan"
            );
            ...
            AssertIsOp(
                Expression.LessThanOrEqual(x, y, false, nnX.GetMethod("op_GreaterThan")),
                "op_GreaterThan"
            );
            AssertIsOp(
                Expression.LessThanOrEqual(x, y, true, nnX.GetMethod("op_GreaterThan")),
                "op_GreaterThan"
            );
            ...
            AssertIsOp(
                Expression.GreaterThan(x, y, false, nnX.GetMethod("op_LessThan")),
                "op_LessThan"
            );
            AssertIsOp(
                Expression.GreaterThan(x, y, true, nnX.GetMethod("op_LessThan")),
                "op_LessThan"
            );
            ...
            AssertIsOp(
                Expression.GreaterThanOrEqual(x, y, false, nnX.GetMethod("op_LessThan")),
                "op_LessThan"
            );
            AssertIsOp(
                Expression.GreaterThanOrEqual(x, y, true, nnX.GetMethod("op_LessThan")),
                "op_LessThan"
            );
            ...
            AssertIsOp(
                Expression.Equal(x, y, false, nnX.GetMethod("op_Inequality")),
                "op_Inequality"
            );
            AssertIsOp(
                Expression.Equal(x, y, true, nnX.GetMethod("op_Inequality")),
                "op_Inequality"
            );
            ...
            AssertIsOp(
                Expression.NotEqual(x, y, false, nnX.GetMethod("op_Equality")),
                "op_Equality"
            );
            AssertIsOp(
                Expression.NotEqual(x, y, true, nnX.GetMethod("op_Equality")),
                "op_Equality"
            );
        }
        ...
        private static void TestUserDefinedBitwiseOperators<X, Y>()
        {
            ...
            AssertIsOp(
                Expression.ExclusiveOr(x, y, nnX.GetMethod("op_BitwiseAnd")),
                "op_BitwiseAnd"
            );
        ...
        private static void TestUserDefinedCoercion<X, Y>()
        {
            ...
            AssertIsCoercion(
                Expression.Convert(x, typeof(Y), nnX.GetMethod("Foo")),
                "Foo",
                typeof(Y)
            );
            ...
            AssertIsCoercion(
                Expression.Convert(y, typeof(X), nnY.GetMethod("Bar")),
                "Bar",
                typeof(X)
            );
            AssertIsCoercion(Expression.ConvertChecked(x, typeof(Y)), "op_Implicit", typeof(Y));
            AssertIsCoercion(
                Expression.ConvertChecked(x, typeof(Y), null),
                "op_Implicit",
                typeof(Y)
            );
            AssertIsCoercion(
                Expression.ConvertChecked(x, typeof(Y), nnX.GetMethod("Foo")),
                "Foo",
                typeof(Y)
            );
            AssertIsCoercion(Expression.ConvertChecked(y, typeof(X)), "op_Explicit", typeof(X));
            AssertIsCoercion(
                Expression.ConvertChecked(y, typeof(X), null),
                "op_Explicit",
                typeof(X)
            );
            AssertIsCoercion(
                Expression.ConvertChecked(y, typeof(X), nnY.GetMethod("Bar")),
                "Bar",
                typeof(X)
            );
            AssertIsCoercion(Expression.Convert(x, typeof(Y)), "op_Implicit", typeof(Y));
        ...
        {
            Expression_Tests obj = new Expression_Tests();
            MethodCallExpression mc1 = Expression.Call(
            ...
            MethodCallExpression mc2 = Expression.Call(
                Expression.Constant(obj),
                "Somemethod",
                null,
            ...
            MethodCallExpression mc3 = Expression.Call(
                Expression.Constant(obj),
                "someMethod",
        ...
        public static void TestCallStaticMethodsByName()
        {
            ...
            Expression<Func<NWindProxy.Customer, IEnumerable<NWindProxy.Order>>> selOrders = c =>
                c.Orders;
            Expression<Func<NWindProxy.Customer, NWindProxy.Customer, NWindProxy.Customer>> agg = (
                c1,
                c2
            ) => c1;
            Expression<Func<NWindProxy.Customer, NWindProxy.Order, string>> joinPair = (c, o) =>
                c.ContactName + o.CustomerID;
            Expression<Func<string, IEnumerable<NWindProxy.Customer>, string>> strCusts = (s, cs) =>
                s + cs.Count();
            Expression<Func<string, IEnumerable<string>, string>> strStrs = (s, ss) =>
                s + ss.Count();
            Expression<Func<NWindProxy.Customer, IEnumerable<NWindProxy.Order>, string>> custOrds =
                (c, os) => c.ContactName + os.Count();
            Expression<Func<string, NWindProxy.Customer, string>> agg2 = (s, c) =>
                c.ContactName + s;
            ...
            Type[] taCustOrder = new Type[]
            {
                typeof(NWindProxy.Customer),
                typeof(NWindProxy.Order),
            };
            Type[] taCustOrderString = new Type[]
            {
                typeof(NWindProxy.Customer),
                typeof(NWindProxy.Order),
                typeof(string),
            ...
            Type[] taCustStringString = new Type[]
            {
                typeof(NWindProxy.Customer),
                typeof(string),
                typeof(string),
            };
            Type[] taCustStringInt = new Type[]
            {
                typeof(NWindProxy.Customer),
                typeof(string),
                typeof(int),
            };
            Type[] taCustOrderStringString = new Type[]
            {
                typeof(NWindProxy.Customer),
                typeof(NWindProxy.Order),
                typeof(string),
            ...
            CheckMethod(
                "Aggregate",
                Expression.Call(typeof(Queryable), "Aggregate", taCust, query, agg)
            );
            CheckMethod(
                "Aggregate",
                Expression.Call(
            ...
            CheckMethod(
                "Cast",
                Expression.Call(typeof(Queryable), "Cast", new Type[] { typeof(object) }, query)
            );
            CheckMethod(
                "Concat",
                Expression.Call(typeof(Queryable), "Concat", taCust, query, query)
            );
            ...
            CheckMethod(
                "SequenceEqual",
                Expression.Call(typeof(Queryable), "SequenceEqual", taCust, query, query)
            );
            CheckMethod(
                "Except",
                Expression.Call(typeof(Queryable), "Except", taCust, query, query)
            );
            ...
            CheckMethod(
                "FirstOrDefault",
                Expression.Call(typeof(Queryable), "FirstOrDefault", taCust, query)
            );
            CheckMethod(
                "FirstOrDefault",
                Expression.Call(typeof(Queryable), "FirstOrDefault", taCust, query, pred)
            );
            CheckMethod(
                "GroupBy",
                Expression.Call(typeof(Queryable), "GroupBy", taCustString, query, selName)
            );
            CheckMethod(
                "GroupBy",
                Expression.Call(
            ...
            CheckMethod(
                "Intersect",
                Expression.Call(typeof(Queryable), "Intersect", taCust, query, query)
            );
            CheckMethod(
                "LongCount",
                Expression.Call(typeof(Queryable), "LongCount", taCust, query)
            );
            CheckMethod(
                "LongCount",
                Expression.Call(typeof(Queryable), "LongCount", taCust, query, pred)
            );
            CheckMethod("Max", Expression.Call(typeof(Queryable), "Max", taCust, query));
            CheckMethod(
                "Max",
                Expression.Call(typeof(Queryable), "Max", taCustString, query, selName)
            );
            CheckMethod("Min", Expression.Call(typeof(Queryable), "Min", taCust, query));
            CheckMethod(
                "Min",
                Expression.Call(typeof(Queryable), "Min", taCustString, query, selName)
            );
            CheckMethod(
                "OfType",
                Expression.Call(typeof(Queryable), "OfType", new Type[] { typeof(object) }, query)
            );
            MethodCallExpression ordered = Expression.Call(
                typeof(Queryable),
                "OrderBy",
                taCustString,
                query,
            ...
            CheckMethod(
                "Select",
                Expression.Call(typeof(Queryable), "Select", taCustString, query, selName)
            );
            CheckMethod(
                "SelectMany",
                Expression.Call(typeof(Queryable), "SelectMany", taCustOrder, query, selOrders)
            );
            CheckMethod(
                "SelectMany",
                Expression.Call(
            ...
            CheckMethod(
                "Single",
                Expression.Call(typeof(Queryable), "Single", taCust, query, pred)
            );
            CheckMethod(
                "SingleOrDefault",
                Expression.Call(typeof(Queryable), "SingleOrDefault", taCust, query)
            );
            CheckMethod(
                "SingleOrDefault",
                Expression.Call(typeof(Queryable), "SingleOrDefault", taCust, query, pred)
            );
            CheckMethod(
                "Skip",
                Expression.Call(typeof(Queryable), "Skip", taCust, query, Expression.Constant(1))
            );
            CheckMethod(
                "SkipWhile",
                Expression.Call(typeof(Queryable), "SkipWhile", taCust, query, pred)
            );
            CheckMethod(
                "Take",
                Expression.Call(typeof(Queryable), "Take", taCust, query, Expression.Constant(1))
            );
            CheckMethod(
                "TakeWhile",
                Expression.Call(typeof(Queryable), "TakeWhile", taCust, query, pred)
            );
            CheckMethod(
                "ThenBy",
                Expression.Call(typeof(Queryable), "ThenBy", taCustString, ordered, selName)
            );
            CheckMethod(
                "ThenByDescending",
                Expression.Call(
        ...
        private static void ConstructAggregates<T>(T value)
        {
            ...
            CheckMethod(
                "Average",
                Expression.Call(typeof(Queryable), "Average", taCust, custs, cvalue)
            );
        }
    ...
    public class Compiler_Tests
    {
        ...
        public static void ObjectCallOnValueType(bool useInterpreter)
        {
            ...
            Expression<Func<string>> lam = Expression.Lambda<Func<string>>(
                Expression.Call(Expression.Constant(st_local), mi, null),
                null
            );
        ...
        public static void AndAlsoLift(bool useInterpreter)
        {
            ...
            Expression<Func<TC1?>> e1 = Expression.Lambda<Func<TC1?>>(
                Expression.Invoke(
                    Expression.Lambda<Func<TC1?, TC1?, TC1?>>(
                        (result),
        ...
        public static void Writeback(bool useInterpreter)
        {
            ...
            Expression<Func<int>> e1 = Expression.Lambda<Func<int>>(
                Expression.Call(
                    typeof(CustomerWriteBack).GetMethod("Funct1"),
                    new[]
                    {
                        Expression.Property(null, typeof(CustomerWriteBack).GetProperty("Prop")),
                    }
                ),
                null
            );
            ...
            Expression<Func<string>> e = Expression.Lambda<Func<string>>(
                Expression.Call(
                    ...
                    new Expression[]
                    {
                        Expression.Property(Expression.Constant(a, typeof(CustomerWriteBack)), pi),
                    }
                ),
                null
            );
        ...
        public static void UnaryPlus(bool useInterpreter)
        {
            ...
            Expression<Func<Complex>> e1 = Expression.Lambda<Func<Complex>>(
        ...
        public static void CompileRelationOperatorsWithIsLiftToNullTrue(bool useInterpreter)
        {
            ...
            Expression<Func<int?, int?, bool?>> e = Expression.Lambda<Func<int?, int?, bool?>>(
                Expression.GreaterThan(p1, p2, true, null),
            ...
            Expression<Func<int?, int?, bool?>> e1 = Expression.Lambda<Func<int?, int?, bool?>>(
                Expression.LessThan(p1, p2, true, null),
                new ParameterExpression[] { p1, p2 }
            );
            ...
            Expression<Func<int?, int?, bool?>> e2 = Expression.Lambda<Func<int?, int?, bool?>>(
                Expression.GreaterThanOrEqual(p1, p2, true, null),
                new ParameterExpression[] { p1, p2 }
            );
            ...
            Expression<Func<int?, int?, bool?>> e3 = Expression.Lambda<Func<int?, int?, bool?>>(
                Expression.Equal(p1, p2, true, null),
                new ParameterExpression[] { p1, p2 }
            );
            ...
            Expression<Func<int?, int?, bool?>> e4 = Expression.Lambda<Func<int?, int?, bool?>>(
                Expression.LessThanOrEqual(p1, p2, true, null),
                new ParameterExpression[] { p1, p2 }
            );
            ...
            Expression<Func<int?, int?, bool?>> e5 = Expression.Lambda<Func<int?, int?, bool?>>(
                Expression.NotEqual(p1, p2, true, null),
                new ParameterExpression[] { p1, p2 }
            );
        ...
        public static void NewExpressionwithMemberAssignInit(bool useInterpreter)
        {
            ...
            MemberInfo[] members = new MemberInfo[]
            {
                ...
                typeof(TestClass).GetProperty("Val"),
            };
        ...
        public static void TypeAsNullableToObject(bool useInterpreter)
        {
            Expression<Func<object>> e = Expression.Lambda<Func<object>>(
                Expression.TypeAs(Expression.Constant(0, typeof(int?)), typeof(object))
            );
        ...
        public static void TypesIsConstantValueType(bool useInterpreter)
        {
            Expression<Func<bool>> e = Expression.Lambda<Func<bool>>(
                Expression.TypeIs(Expression.Constant(5), typeof(object))
            );
        ...
        public static void Casts(bool useInterpreter)
        {
            ...
            Assert.Equal(
                ExpressionType.Add,
                TestCast<System.ValueType, ExpressionType>(ExpressionType.Add, useInterpreter)
            );

            // System.Enum to enum type
            Assert.Equal(
                ExpressionType.Add,
                TestCast<System.Enum, ExpressionType>(ExpressionType.Add, useInterpreter)
            );
            ...
            Assert.Equal(
                ExpressionType.Add,
                TestCast<ExpressionType, System.Enum>(ExpressionType.Add, useInterpreter)
            );

            // Enum to System.ValueType
            Assert.Equal(
                ExpressionType.Add,
                TestCast<ExpressionType, System.ValueType>(ExpressionType.Add, useInterpreter)
            );
        ...
        public static void ConvertMinMax(bool useInterpreter)
        {
            unchecked
            {
                ...
                Assert.Equal(
                    ...
                    TestConvert<uint, double>(uint.MaxValue, useInterpreter)
                );
                Assert.Equal(
                    (float?)uint.MaxValue,
                    TestConvert<uint, float?>(uint.MaxValue, useInterpreter)
                ...
                Assert.Equal(
                    ...
                    TestConvert<ulong, float>(ulong.MaxValue, useInterpreter)
                );
                Assert.Equal(
                    (double)ulong.MaxValue,
                    TestConvert<ulong, double>(ulong.MaxValue, useInterpreter)
                );
                Assert.Equal(
                    (float?)ulong.MaxValue,
                    TestConvert<ulong, float?>(ulong.MaxValue, useInterpreter)
                ...
                Assert.Equal(
                    (float)(ulong?)ulong.MaxValue,
                    TestConvert<ulong?, float>(ulong.MaxValue, useInterpreter)
                );
                Assert.Equal(
                    (double)(ulong?)ulong.MaxValue,
                    TestConvert<ulong?, double>(ulong.MaxValue, useInterpreter)
                );
                Assert.Equal(
                    (float?)(ulong?)ulong.MaxValue,
        ...
        public static void CoalesceChars(bool useInterpreter)
        {
            ...
            Expression<Func<char?, char?, char?>> e = Expression.Lambda<Func<char?, char?, char?>>(
        ...
        {
            Func<char> f = Expression
                .Lambda<Func<Char>>(Expression.Convert(Expression.Constant((byte)65), typeof(char)))
                .Compile(useInterpreter);
            Assert.Equal('A', f());

            Func<char> f2 = Expression
                .Lambda<Func<Char>>(Expression.Convert(Expression.Constant(65), typeof(char)))
                .Compile(useInterpreter);
            Assert.Equal('A', f2());

            Func<char> f3 = Expression
                .Lambda<Func<Char>>(Expression.Convert(Expression.Constant(-1), typeof(char)))
                .Compile(useInterpreter);
            char c3 = f3();
            Func<int> f4 = Expression
                .Lambda<Func<int>>(Expression.Convert(Expression.Constant(c3), typeof(int)))
                .Compile(useInterpreter);
        ...
        public static void NewArrayInvoke(bool useInterpreter)
        {
            ...
            InvocationExpression linq1a = Expression.Invoke(
                linq1,
        ...
        {
            Expression<Func<int, int>> f = x => x + 1;
            InvocationExpression ie = Expression.Invoke(
                Expression.Quote(f),
                Expression.Constant(5)
            );
            Expression<Func<int>> lambda = Expression.Lambda<Func<int>>(ie);
        ...
        {
            Expression<Func<int, List<ClassY>>> f = x => new List<ClassY>
            {
                new ClassY { B = x },
                new ClassY { B = x + 1 },
                new ClassY { B = x + 2 },
        ...
        {
            Expression<Func<int, ClassX>> f = v => new ClassX
            {
                A = v,
                B = v + 1,
                Ys = { new ClassY { B = v + 2 } },
        ...
        {
            Expression<Func<int, StructX>> f = v => new StructX
            {
                A = v,
                B = v + 1,
                Ys = { new ClassY { B = v + 2 } },
        ...
        private static Expression<
            Func<int, T>
        > GetExpressionTreeForMemberInitializationThroughProperty<T>()
        {
            ...
            return Expression.Lambda<Func<int, T>>(
                ...
                Expression.MemberInit(
                    ...
                    new MemberBinding[]
                    {
                        ...
                        Expression.Bind(
                            typeof(T).GetField("B"),
                            Expression.Add(parameterV, Expression.Constant(1, typeof(int)))
                        ),
                        // SYP = { B = v + 2 }
                        Expression.MemberBind(
                            ...
                            new MemberBinding[]
                            {
                                Expression.Bind(
                                    ...
                                    Expression.Add(parameterV, Expression.Constant(2, typeof(int)))
                                ),
                            }
                        ),
                    }
        ...
        public static void UnaryOperators(bool useInterpreter)
        {
            ...
            Assert.Equal(
                -1,
                TestUnary<int?, int?>(ExpressionType.NegateChecked, 1, useInterpreter)
            );
            ...
            Assert.Equal(
                -1,
                TestUnary<decimal?, decimal?>(ExpressionType.Negate, 1, useInterpreter)
            );
            Assert.Null(TestUnary<decimal?, decimal?>(ExpressionType.Negate, null, useInterpreter));
            Assert.Equal(
                -1,
                TestUnary<decimal, decimal>(ExpressionType.NegateChecked, 1, useInterpreter)
            );
            Assert.Equal(
                -1,
                TestUnary<decimal?, decimal?>(ExpressionType.NegateChecked, 1, useInterpreter)
            ...
            Assert.Null(
                TestUnary<decimal?, decimal?>(ExpressionType.NegateChecked, null, useInterpreter)
            );
        }
        ...
        private static R TestUnary<T, R>(ExpressionType op, T v, bool useInterpreter)
        {
            ...
            Expression<Func<T, R>> f = Expression.Lambda<Func<T, R>>(
                Expression.MakeUnary(op, p, null),
                p
            );
        ...
        static class System_Linq_Expressions_Expression_TDelegate__1
        {
            ...
            public static void UseSystem_Linq_Expressions_Expression_TDelegate__1(bool call) // call this passing false
            {
                if (call)
                {
                    ...
                    Default<System.Linq.Expressions.Expression<System.Object>>()
                        .Update(
        ...
        {
            System_Linq_Expressions_Expression_TDelegate__1.UseSystem_Linq_Expressions_Expression_TDelegate__1(
                false
            );
        }
        ...
        public static void BinaryOperators(bool useInterpreter)
        {
            ...
            Assert.False(
                TestBinary<bool, bool>(ExpressionType.AndAlso, false, true, useInterpreter)
            );
            Assert.False(
                TestBinary<bool, bool>(ExpressionType.AndAlso, true, false, useInterpreter)
            );
            Assert.False(
                TestBinary<bool, bool>(ExpressionType.AndAlso, false, false, useInterpreter)
            );
            Assert.True(
                (bool)TestBinary<bool?, bool?>(ExpressionType.AndAlso, true, true, useInterpreter)
            );
            Assert.False(
                (bool)TestBinary<bool?, bool?>(ExpressionType.AndAlso, true, false, useInterpreter)
            );
            Assert.False(
                (bool)TestBinary<bool?, bool?>(ExpressionType.AndAlso, false, true, useInterpreter)
            );
            Assert.False(
                (bool)TestBinary<bool?, bool?>(ExpressionType.AndAlso, false, false, useInterpreter)
            );
            Assert.Null(
                TestBinary<bool?, bool?>(ExpressionType.AndAlso, true, null, useInterpreter)
            );
            Assert.Null(
                TestBinary<bool?, bool?>(ExpressionType.AndAlso, null, true, useInterpreter)
            );
            Assert.False(
                (bool)TestBinary<bool?, bool?>(ExpressionType.AndAlso, false, null, useInterpreter)
            );
            Assert.False(
                (bool)TestBinary<bool?, bool?>(ExpressionType.AndAlso, null, false, useInterpreter)
            );
            Assert.Null(
                TestBinary<bool?, bool?>(ExpressionType.AndAlso, null, null, useInterpreter)
            );
            ...
            Assert.False(
                TestBinary<bool, bool>(ExpressionType.OrElse, false, false, useInterpreter)
            );
            Assert.True(
                (bool)TestBinary<bool?, bool?>(ExpressionType.OrElse, true, true, useInterpreter)
            );
            Assert.True(
                (bool)TestBinary<bool?, bool?>(ExpressionType.OrElse, true, false, useInterpreter)
            );
            Assert.True(
                (bool)TestBinary<bool?, bool?>(ExpressionType.OrElse, false, true, useInterpreter)
            );
            Assert.False(
                (bool)TestBinary<bool?, bool?>(ExpressionType.OrElse, false, false, useInterpreter)
            );
            Assert.True(
                (bool)TestBinary<bool?, bool?>(ExpressionType.OrElse, true, null, useInterpreter)
            );
            Assert.True(
                (bool)TestBinary<bool?, bool?>(ExpressionType.OrElse, null, true, useInterpreter)
            );
            Assert.Null(
                TestBinary<bool?, bool?>(ExpressionType.OrElse, false, null, useInterpreter)
            );
            Assert.Null(
                TestBinary<bool?, bool?>(ExpressionType.OrElse, null, false, useInterpreter)
            );
            Assert.Null(
                TestBinary<bool?, bool?>(ExpressionType.OrElse, null, null, useInterpreter)
            );
            ...
            Assert.True(
                (bool)TestBinary<bool?, bool?>(ExpressionType.And, true, true, useInterpreter)
            );
            Assert.False(
                (bool)TestBinary<bool?, bool?>(ExpressionType.And, true, false, useInterpreter)
            );
            Assert.False(
                (bool)TestBinary<bool?, bool?>(ExpressionType.And, false, true, useInterpreter)
            );
            Assert.False(
                (bool)TestBinary<bool?, bool?>(ExpressionType.And, false, false, useInterpreter)
            );
            ...
            Assert.False(
                (bool)TestBinary<bool?, bool?>(ExpressionType.And, false, null, useInterpreter)
            );
            Assert.False(
                (bool)TestBinary<bool?, bool?>(ExpressionType.And, null, false, useInterpreter)
            );
            ...
            Assert.True(
                (bool)TestBinary<bool?, bool?>(ExpressionType.Or, true, true, useInterpreter)
            );
            Assert.True(
                (bool)TestBinary<bool?, bool?>(ExpressionType.Or, true, false, useInterpreter)
            );
            Assert.True(
                (bool)TestBinary<bool?, bool?>(ExpressionType.Or, false, true, useInterpreter)
            );
            Assert.False(
                (bool)TestBinary<bool?, bool?>(ExpressionType.Or, false, false, useInterpreter)
            );
            Assert.True(
                (bool)TestBinary<bool?, bool?>(ExpressionType.Or, true, null, useInterpreter)
            );
            Assert.True(
                (bool)TestBinary<bool?, bool?>(ExpressionType.Or, null, true, useInterpreter)
            );
            ...
            Assert.True(
                TestBinary<bool, bool>(ExpressionType.ExclusiveOr, true, false, useInterpreter)
            );
            Assert.True(
                TestBinary<bool, bool>(ExpressionType.ExclusiveOr, false, true, useInterpreter)
            );
            Assert.False(
            ...
            Assert.Null(
                TestBinary<bool?, bool?>(ExpressionType.ExclusiveOr, null, true, useInterpreter)
            );
            Assert.Null(
                TestBinary<bool?, bool?>(ExpressionType.ExclusiveOr, false, null, useInterpreter)
            );
            Assert.Null(
                TestBinary<bool?, bool?>(ExpressionType.ExclusiveOr, null, false, useInterpreter)
            );
            Assert.Null(
                TestBinary<bool?, bool?>(ExpressionType.ExclusiveOr, null, null, useInterpreter)
            );
            Assert.Equal(4, TestBinary<int, int>(ExpressionType.ExclusiveOr, 5, 1, useInterpreter));
            Assert.Equal(
                4,
                TestBinary<int?, int?>(ExpressionType.ExclusiveOr, 5, 1, useInterpreter)
            );
            Assert.Null(
                TestBinary<int?, int?>(ExpressionType.ExclusiveOr, null, 1, useInterpreter)
            );
            Assert.Null(
                TestBinary<int?, int?>(ExpressionType.ExclusiveOr, 5, null, useInterpreter)
            );
            Assert.Null(
                TestBinary<int?, int?>(ExpressionType.ExclusiveOr, null, null, useInterpreter)
            );
            ...
            Assert.True(
                TestBinary<decimal?, bool>(ExpressionType.Equal, null, null, useInterpreter)
            );
            ...
            Assert.False(
                TestBinary<int?, bool>(ExpressionType.NotEqual, null, null, useInterpreter)
            );
            ...
            Assert.False(TestBinary<decimal?, bool>(ExpressionType.NotEqual, 1, 1, useInterpreter));
            Assert.True(
                TestBinary<decimal?, bool>(ExpressionType.NotEqual, null, 2, useInterpreter)
            );
            Assert.True(
                TestBinary<decimal?, bool>(ExpressionType.NotEqual, 1, null, useInterpreter)
            );
            Assert.False(
                TestBinary<decimal?, bool>(ExpressionType.NotEqual, null, null, useInterpreter)
            );
            ...
            Assert.False(
                TestBinary<int?, bool>(ExpressionType.LessThan, null, null, useInterpreter)
            );
            ...
            Assert.False(TestBinary<decimal?, bool>(ExpressionType.LessThan, 2, 2, useInterpreter));
            Assert.False(
                TestBinary<decimal?, bool>(ExpressionType.LessThan, null, 2, useInterpreter)
            );
            Assert.False(
                TestBinary<decimal?, bool>(ExpressionType.LessThan, 2, null, useInterpreter)
            );
            Assert.False(
                TestBinary<decimal?, bool>(ExpressionType.LessThan, null, null, useInterpreter)
            );

            // LessThanOrEqual
            Assert.True(
                TestBinary<int, bool>(ExpressionType.LessThanOrEqual, 1, 2, useInterpreter)
            );
            Assert.False(
                TestBinary<int, bool>(ExpressionType.LessThanOrEqual, 2, 1, useInterpreter)
            );
            Assert.True(
                TestBinary<int, bool>(ExpressionType.LessThanOrEqual, 2, 2, useInterpreter)
            );
            Assert.True(
                TestBinary<int?, bool>(ExpressionType.LessThanOrEqual, 1, 2, useInterpreter)
            );
            ...
            Assert.False(
                TestBinary<int?, bool>(ExpressionType.LessThanOrEqual, null, 2, useInterpreter)
            );
            Assert.False(
                TestBinary<int?, bool>(ExpressionType.LessThanOrEqual, 2, null, useInterpreter)
            );
            Assert.False(
                TestBinary<int?, bool>(ExpressionType.LessThanOrEqual, null, null, useInterpreter)
            );

            Assert.True(
                TestBinary<decimal, bool>(ExpressionType.LessThanOrEqual, 1, 2, useInterpreter)
            );
            Assert.False(
                TestBinary<decimal, bool>(ExpressionType.LessThanOrEqual, 2, 1, useInterpreter)
            );
            Assert.True(
                TestBinary<decimal, bool>(ExpressionType.LessThanOrEqual, 2, 2, useInterpreter)
            );
            Assert.True(
                TestBinary<decimal?, bool>(ExpressionType.LessThanOrEqual, 1, 2, useInterpreter)
            );
            ...
            Assert.False(
                TestBinary<decimal?, bool>(ExpressionType.LessThanOrEqual, null, 2, useInterpreter)
            );
            Assert.False(
                TestBinary<decimal?, bool>(ExpressionType.LessThanOrEqual, 2, null, useInterpreter)
            );
            Assert.False(
                TestBinary<decimal?, bool>(
            ...
            Assert.False(TestBinary<int?, bool>(ExpressionType.GreaterThan, 2, 2, useInterpreter));
            Assert.False(
                TestBinary<int?, bool>(ExpressionType.GreaterThan, null, 2, useInterpreter)
            );
            Assert.False(
                TestBinary<int?, bool>(ExpressionType.GreaterThan, 2, null, useInterpreter)
            );
            Assert.False(
                TestBinary<int?, bool>(ExpressionType.GreaterThan, null, null, useInterpreter)
            );

            Assert.False(
                TestBinary<decimal, bool>(ExpressionType.GreaterThan, 1, 2, useInterpreter)
            );
            Assert.True(
                TestBinary<decimal, bool>(ExpressionType.GreaterThan, 2, 1, useInterpreter)
            );
            Assert.False(
                TestBinary<decimal, bool>(ExpressionType.GreaterThan, 2, 2, useInterpreter)
            );
            Assert.False(
                TestBinary<decimal?, bool>(ExpressionType.GreaterThan, 1, 2, useInterpreter)
            );
            ...
            Assert.False(
                TestBinary<decimal?, bool>(ExpressionType.GreaterThan, null, 2, useInterpreter)
            );
            Assert.False(
                TestBinary<decimal?, bool>(ExpressionType.GreaterThan, 2, null, useInterpreter)
            );
            Assert.False(
                TestBinary<decimal?, bool>(ExpressionType.GreaterThan, null, null, useInterpreter)
            );

            // GreaterThanOrEqual
            Assert.False(
                TestBinary<int, bool>(ExpressionType.GreaterThanOrEqual, 1, 2, useInterpreter)
            );
            Assert.True(
                TestBinary<int, bool>(ExpressionType.GreaterThanOrEqual, 2, 1, useInterpreter)
            );
            Assert.True(
                TestBinary<int, bool>(ExpressionType.GreaterThanOrEqual, 2, 2, useInterpreter)
            );
            Assert.False(
                TestBinary<int?, bool>(ExpressionType.GreaterThanOrEqual, 1, 2, useInterpreter)
            );
            ...
            Assert.False(
                TestBinary<int?, bool>(ExpressionType.GreaterThanOrEqual, null, 2, useInterpreter)
            );
            Assert.False(
                TestBinary<int?, bool>(ExpressionType.GreaterThanOrEqual, 2, null, useInterpreter)
            );
            Assert.False(
                TestBinary<int?, bool>(
            ...
            Assert.False(
                TestBinary<decimal, bool>(ExpressionType.GreaterThanOrEqual, 1, 2, useInterpreter)
            );
            Assert.True(
                TestBinary<decimal, bool>(ExpressionType.GreaterThanOrEqual, 2, 1, useInterpreter)
            );
            Assert.True(
                TestBinary<decimal, bool>(ExpressionType.GreaterThanOrEqual, 2, 2, useInterpreter)
            );
            Assert.False(
                TestBinary<decimal?, bool>(ExpressionType.GreaterThanOrEqual, 1, 2, useInterpreter)
            );
            ...
            Assert.Equal(
                3,
                TestBinary<decimal?, decimal?>(ExpressionType.Add, 1, 2, useInterpreter)
            );
            Assert.Null(
                TestBinary<decimal?, decimal?>(ExpressionType.Add, null, 2, useInterpreter)
            );
            Assert.Null(
                TestBinary<decimal?, decimal?>(ExpressionType.Add, 1, null, useInterpreter)
            );
            Assert.Null(
                TestBinary<decimal?, decimal?>(ExpressionType.Add, null, null, useInterpreter)
            );
            ...
            Assert.Equal(
                3,
                TestBinary<int?, int?>(ExpressionType.AddChecked, 1, 2, useInterpreter)
            );
            ...
            Assert.Null(
                TestBinary<int?, int?>(ExpressionType.AddChecked, null, null, useInterpreter)
            );
            ...
            Assert.Null(
                TestBinary<int?, int?>(ExpressionType.Subtract, null, null, useInterpreter)
            );

            Assert.Equal(
                1,
                TestBinary<decimal, decimal>(ExpressionType.Subtract, 2, 1, useInterpreter)
            );
            Assert.Equal(
                1,
                TestBinary<decimal?, decimal?>(ExpressionType.Subtract, 2, 1, useInterpreter)
            ...
            Assert.Null(
                TestBinary<decimal?, decimal?>(ExpressionType.Subtract, null, 1, useInterpreter)
            );
            Assert.Null(
                TestBinary<decimal?, decimal?>(ExpressionType.Subtract, 2, null, useInterpreter)
            );
            Assert.Null(
                TestBinary<decimal?, decimal?>(ExpressionType.Subtract, null, null, useInterpreter)
            );

            // SubtractChecked
            Assert.Equal(
                1,
                TestBinary<int, int>(ExpressionType.SubtractChecked, 2, 1, useInterpreter)
            );
            Assert.Equal(
                1,
                TestBinary<int?, int?>(ExpressionType.SubtractChecked, 2, 1, useInterpreter)
            ...
            Assert.Null(
                TestBinary<int?, int?>(ExpressionType.SubtractChecked, null, 1, useInterpreter)
            );
            Assert.Null(
                TestBinary<int?, int?>(ExpressionType.SubtractChecked, 2, null, useInterpreter)
            );
            Assert.Null(
                TestBinary<int?, int?>(ExpressionType.SubtractChecked, null, null, useInterpreter)
            );
            ...
            Assert.Null(
                TestBinary<int?, int?>(ExpressionType.Multiply, null, null, useInterpreter)
            );

            Assert.Equal(
                2,
                TestBinary<decimal, decimal>(ExpressionType.Multiply, 2, 1, useInterpreter)
            );
            Assert.Equal(
                2,
                TestBinary<decimal?, decimal?>(ExpressionType.Multiply, 2, 1, useInterpreter)
            ...
            Assert.Null(
                TestBinary<decimal?, decimal?>(ExpressionType.Multiply, null, 1, useInterpreter)
            );
            Assert.Null(
                TestBinary<decimal?, decimal?>(ExpressionType.Multiply, 2, null, useInterpreter)
            );
            Assert.Null(
                TestBinary<decimal?, decimal?>(ExpressionType.Multiply, null, null, useInterpreter)
            );

            // MultiplyChecked
            Assert.Equal(
                2,
                TestBinary<int, int>(ExpressionType.MultiplyChecked, 2, 1, useInterpreter)
            );
            Assert.Equal(
                2,
                TestBinary<int?, int?>(ExpressionType.MultiplyChecked, 2, 1, useInterpreter)
            ...
            Assert.Null(
                TestBinary<int?, int?>(ExpressionType.MultiplyChecked, null, 1, useInterpreter)
            );
            Assert.Null(
                TestBinary<int?, int?>(ExpressionType.MultiplyChecked, 2, null, useInterpreter)
            );
            Assert.Null(
                TestBinary<int?, int?>(ExpressionType.MultiplyChecked, null, null, useInterpreter)
            );
            ...
            Assert.Equal(
                2.5m,
                TestBinary<decimal, decimal>(ExpressionType.Divide, 5, 2, useInterpreter)
            );
            Assert.Equal(
                2.5m,
                TestBinary<decimal?, decimal?>(ExpressionType.Divide, 5, 2, useInterpreter)
            ...
            Assert.Null(
                TestBinary<decimal?, decimal?>(ExpressionType.Divide, null, 2, useInterpreter)
            );
            Assert.Null(
                TestBinary<decimal?, decimal?>(ExpressionType.Divide, 5, null, useInterpreter)
            );
            Assert.Null(
                TestBinary<decimal?, decimal?>(ExpressionType.Divide, null, null, useInterpreter)
            );
            ...
            Assert.Equal(
                3,
                TestBinary<decimal, decimal>(ExpressionType.Modulo, 7, 4, useInterpreter)
            );
            Assert.Equal(
                3,
                TestBinary<decimal?, decimal?>(ExpressionType.Modulo, 7, 4, useInterpreter)
            ...
            Assert.Null(
                TestBinary<decimal?, decimal?>(ExpressionType.Modulo, null, 4, useInterpreter)
            );
            Assert.Null(
                TestBinary<decimal?, decimal?>(ExpressionType.Modulo, 7, null, useInterpreter)
            );
            Assert.Null(
                TestBinary<decimal?, decimal?>(ExpressionType.Modulo, null, null, useInterpreter)
            );

            // Power
            Assert.Equal(
                16,
                TestBinary<double, double>(ExpressionType.Power, 2, 4, useInterpreter)
            );
            Assert.Equal(
                16,
                TestBinary<double?, double?>(ExpressionType.Power, 2, 4, useInterpreter)
            ...
            Assert.Null(
                TestBinary<double?, double?>(ExpressionType.Power, null, 4, useInterpreter)
            );
            Assert.Null(
                TestBinary<double?, double?>(ExpressionType.Power, 2, null, useInterpreter)
            );
            Assert.Null(
                TestBinary<double?, double?>(ExpressionType.Power, null, null, useInterpreter)
            );
            ...
            Assert.Equal(
                10,
                TestBinary<int?, int?>(ExpressionType.LeftShift, 5, 1, useInterpreter)
            );
            ...
            Assert.Null(
                TestBinary<int?, int?>(ExpressionType.LeftShift, null, null, useInterpreter)
            );
            ...
            Assert.Equal(
                2,
                TestBinary<int?, int?>(ExpressionType.RightShift, 4, 1, useInterpreter)
            );
            ...
            Assert.Null(
                TestBinary<int?, int?>(ExpressionType.RightShift, null, null, useInterpreter)
            );
        }

        private static R TestBinary<T, R>(
            Expression<Func<T, T, R>> f,
            T v1,
            T v2,
            bool useInterpreter
        )
        ...
        private static R TestBinary<T, R>(ExpressionType op, T v1, T v2, bool useInterpreter)
        {
            ...
            Expression<Func<T, T, R>> f = Expression.Lambda<Func<T, T, R>>(
                Expression.MakeBinary(op, p1, p2),
                p1,
                p2
            );
        ...
        private static void TestNullableCall<T, U>(
            T arg,
            Func<T?, U> f,
        ...
        {
            NWindProxy.Customer cust = new NWindProxy.Customer
            {
                CustomerID = "BUBBA",
                ContactName = "Bubba Gump",
            };
            ...
            Assert.Equal(
                cust.ContactName,
                Expression
                    .Lambda(Expression.PropertyOrField(c, "ContactName"), c)
                    .Compile(useInterpreter)
                    .DynamicInvoke(cust)
            );
            Assert.Equal(
                cust.Orders,
                Expression
                    .Lambda(Expression.PropertyOrField(c, "Orders"), c)
                    .Compile(useInterpreter)
                    .DynamicInvoke(cust)
            );
            Assert.Equal(
                cust.CustomerID,
                Expression
                    .Lambda(Expression.PropertyOrField(c, "CustomerId"), c)
                    .Compile(useInterpreter)
                    .DynamicInvoke(cust)
            );
            Assert.True(
        ...
        private static void ArimeticOperatorTests(
            Type type,
            object value,
            bool testUnSigned,
            bool useInterpreter
        )
        {
            ...
            if (testUnSigned)
                Expression
                    .Lambda(Expression.Negate(p), p)
                    .Compile(useInterpreter)
                    .DynamicInvoke(new object[] { value });
            Expression
                .Lambda(Expression.Add(p, p), p)
                .Compile(useInterpreter)
                .DynamicInvoke(new object[] { value });
            Expression
                .Lambda(Expression.Subtract(p, p), p)
                .Compile(useInterpreter)
                .DynamicInvoke(new object[] { value });
            Expression
                .Lambda(Expression.Multiply(p, p), p)
                .Compile(useInterpreter)
                .DynamicInvoke(new object[] { value });
            Expression
                .Lambda(Expression.Divide(p, p), p)
                .Compile(useInterpreter)
                .DynamicInvoke(new object[] { value });
        }

        private static void RelationalOperatorTests(
            Type type,
            object value,
            bool testModulo,
            bool useInterpreter
        )
        {
            ...
            if (testModulo)
                Expression
                    .Lambda(Expression.Modulo(p, p), p)
                    .Compile(useInterpreter)
                    .DynamicInvoke(new object[] { value });
            Expression
                .Lambda(Expression.Equal(p, p), p)
                .Compile(useInterpreter)
                .DynamicInvoke(new object[] { value });
            Expression
                .Lambda(Expression.NotEqual(p, p), p)
                .Compile(useInterpreter)
                .DynamicInvoke(new object[] { value });
            Expression
                .Lambda(Expression.LessThan(p, p), p)
                .Compile(useInterpreter)
                .DynamicInvoke(new object[] { value });
            Expression
                .Lambda(Expression.LessThanOrEqual(p, p), p)
                .Compile(useInterpreter)
                .DynamicInvoke(new object[] { value });
            Expression
                .Lambda(Expression.GreaterThan(p, p), p)
                .Compile(useInterpreter)
                .DynamicInvoke(new object[] { value });
            Expression
                .Lambda(Expression.GreaterThanOrEqual(p, p), p)
                .Compile(useInterpreter)
                .DynamicInvoke(new object[] { value });
        }

        private static void NumericOperatorTests(
            Type type,
            object value,
            bool testModulo,
            bool testUnSigned,
        ...
        private static void IntegerOperatorTests(
            Type type,
            object value,
            bool testModulo,
            bool testUnsigned,
        ...
        private static void LogicalOperatorTests(Type type, object value, bool useInterpreter)
        {
            ParameterExpression p = Expression.Parameter(type, "x");
            Expression
                .Lambda(Expression.Not(p), p)
                .Compile(useInterpreter)
                .DynamicInvoke(new object[] { value });
            Expression
                .Lambda(Expression.Or(p, p), p)
                .Compile(useInterpreter)
                .DynamicInvoke(new object[] { value });
            Expression
                .Lambda(Expression.And(p, p), p)
                .Compile(useInterpreter)
                .DynamicInvoke(new object[] { value });
            Expression
                .Lambda(Expression.ExclusiveOr(p, p), p)
                .Compile(useInterpreter)
                .DynamicInvoke(new object[] { value });
        }
        ...
        private static void TrueBooleanOperatorTests(
            Type type,
            object arg1,
            object arg2,
            bool useInterpreter
        )
        {
            ...
            Expression
                .Lambda(Expression.AndAlso(x, y), x, y)
                .Compile(useInterpreter)
                .DynamicInvoke(new object[] { arg1, arg2 });
            Expression
                .Lambda(Expression.OrElse(x, y), x, y)
                .Compile(useInterpreter)
                .DynamicInvoke(new object[] { arg1, arg2 });
            GeneralBooleanOperatorTests(type, arg1, arg2, useInterpreter);
        }

        private static void GeneralBooleanOperatorTests(
            Type type,
            object arg1,
            object arg2,
            bool useInterpreter
        )
        {
            ...
            ParameterExpression y = Expression.Parameter(type, "y");
            Expression
                .Lambda(Expression.And(x, y), x, y)
                .Compile(useInterpreter)
                .DynamicInvoke(new object[] { arg1, arg2 });
            Expression
                .Lambda(Expression.Or(x, y), x, y)
                .Compile(useInterpreter)
                .DynamicInvoke(new object[] { arg1, arg2 });
            Expression
                .Lambda(Expression.Not(x), x)
                .Compile(useInterpreter)
                .DynamicInvoke(new object[] { arg1 });
            Expression
                .Lambda(Expression.Equal(x, y), x, y)
                .Compile(useInterpreter)
                .DynamicInvoke(new object[] { arg1, arg2 });
            Expression
                .Lambda(Expression.NotEqual(x, y), x, y)
                .Compile(useInterpreter)
                .DynamicInvoke(new object[] { arg1, arg2 });
        }
