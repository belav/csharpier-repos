...
namespace System.Linq.Expressions.Tests
{
    public class RuntimeVariablesTests
    {
        ...
        public void ReadAndReturnVars(bool useInterpreter)
        {
            ...
            IRuntimeVariables vars = Expression
                .Lambda<Func<IRuntimeVariables>>(
                    Expression.Block(
                        new[] { x, y, z },
        ...
        {
            IRuntimeVariables vars = Expression
                .Lambda<Func<IRuntimeVariables>>(Expression.RuntimeVariables())
                .Compile(useInterpreter)();
        ...
        {
            RuntimeVariablesExpression vars = Expression.RuntimeVariables(
        ...
        public void UpdateSameCollectionSameNode()
        {
            ...
            {
                Expression.Variable(typeof(RuntimeVariablesTests)),
            };
        ...
        {
            RuntimeVariablesExpression varExp = Expression.RuntimeVariables(
                Enumerable.Repeat(Expression.Variable(typeof(RuntimeVariablesTests)), 1)
            );
            Assert.NotSame(
                varExp,
                varExp.Update(new[] { Expression.Variable(typeof(RuntimeVariablesTests)) })
            );
        }
            ...
            Assert.NotSame(
                ...
                varExp.Update(
                    new RunOnceEnumerable<ParameterExpression>(
                        new[] { Expression.Variable(typeof(RuntimeVariablesTests)) }
                    )
                )
            );
        }
        ...
        {
            RuntimeVariablesExpression varExp = Expression.RuntimeVariables(
                Enumerable.Repeat(Expression.Variable(typeof(RuntimeVariablesTests)), 0)
            );
        ...
        public void ToStringTest()
        {
            ...
            RuntimeVariablesExpression e2 = Expression.RuntimeVariables(
                Expression.Parameter(typeof(int), "x")
            );
            Assert.Equal("(x)", e2.ToString());

            RuntimeVariablesExpression e3 = Expression.RuntimeVariables(
                Expression.Parameter(typeof(int), "x"),
