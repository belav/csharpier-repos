...
namespace System.Linq.Expressions.Tests
{
    public static class ArrayArrayIndexTests
    {
        ...
        public static void CheckExceptionInterfaceArrayArrayIndexTest(bool useInterpreter)
        {
            ...
            // index out of bounds
            CheckExceptionInterfaceArrayArrayIndex(
        ...
        public static void CheckExceptionIEquatableArrayArrayIndexTest(bool useInterpreter)
        {
            ...
            // index out of bounds
            CheckExceptionIEquatableArrayArrayIndex(
                GenerateIEquatableArrayArray(0),
                -1,
                useInterpreter
            );
            CheckExceptionIEquatableArrayArrayIndex(
            ...
            CheckExceptionIEquatableArrayArrayIndex(
                GenerateIEquatableArrayArray(1),
                -1,
                useInterpreter
            );
            CheckExceptionIEquatableArrayArrayIndex(
            ...
            CheckExceptionIEquatableArrayArrayIndex(
                GenerateIEquatableArrayArray(5),
                -1,
                useInterpreter
            );
            CheckExceptionIEquatableArrayArrayIndex(
        ...
        public static void CheckExceptionIEquatable2ArrayArrayIndexTest(bool useInterpreter)
        {
            ...
            // index out of bounds
            CheckExceptionIEquatable2ArrayArrayIndex(
                GenerateIEquatable2ArrayArray(0),
                -1,
                useInterpreter
            );
            CheckExceptionIEquatable2ArrayArrayIndex(
            ...
            CheckExceptionIEquatable2ArrayArrayIndex(
                GenerateIEquatable2ArrayArray(1),
                -1,
                useInterpreter
            );
            CheckExceptionIEquatable2ArrayArrayIndex(
            ...
            CheckExceptionIEquatable2ArrayArrayIndex(
                GenerateIEquatable2ArrayArray(5),
                -1,
                useInterpreter
            );
            CheckExceptionIEquatable2ArrayArrayIndex(
        ...
        {
            CheckStructWithStringArrayArrayIndex(
        ...
        public static void CheckExceptionStructWithStringArrayArrayIndexTest(bool useInterpreter)
        {
            ...
            // index out of bounds
            CheckExceptionStructWithStringArrayArrayIndex(
                GenerateStructWithStringArrayArray(0),
                -1,
                useInterpreter
            );
        ...
        {
            CheckStructWithStringAndStructArrayArrayIndex(
                GenerateStructWithStringAndStructArrayArray(0),
                useInterpreter
            );
            CheckStructWithStringAndStructArrayArrayIndex(
                GenerateStructWithStringAndStructArrayArray(1),
                useInterpreter
            );
            CheckStructWithStringAndStructArrayArrayIndex(
                GenerateStructWithStringAndStructArrayArray(5),
                useInterpreter
            );
        }
        ...
        )
        {
            ...
            // index out of bounds
            CheckExceptionStructWithStringAndStructArrayArrayIndex(
                GenerateStructWithStringAndStructArrayArray(0),
                -1,
                useInterpreter
            );
        ...
        {
            CheckStructWithTwoFieldsArrayArrayIndex(
                GenerateStructWithTwoFieldsArrayArray(0),
                useInterpreter
            );
            CheckStructWithTwoFieldsArrayArrayIndex(
                GenerateStructWithTwoFieldsArrayArray(1),
                useInterpreter
            );
            CheckStructWithTwoFieldsArrayArrayIndex(
                GenerateStructWithTwoFieldsArrayArray(5),
                useInterpreter
            );
        }
        ...
        public static void CheckExceptionStructWithTwoFieldsArrayArrayIndexTest(bool useInterpreter)
        {
            ...
            // index out of bounds
            CheckExceptionStructWithTwoFieldsArrayArrayIndex(
                GenerateStructWithTwoFieldsArrayArray(0),
                -1,
                useInterpreter
            );
        ...
        {
            CheckStructWithValueArrayArrayIndex(
        ...
        public static void CheckExceptionStructWithValueArrayArrayIndexTest(bool useInterpreter)
        {
            ...
            // index out of bounds
            CheckExceptionStructWithValueArrayArrayIndex(
                GenerateStructWithValueArrayArray(0),
                -1,
                useInterpreter
            );
        ...
        private static void CheckExceptionGenericArrayArrayIndexTestHelper<T>(bool useInterpreter)
        {
            ...
            // index out of bounds
            CheckExceptionGenericArrayArrayIndex<T>(
            ...
            where Tc : class
        {
            ...
            // index out of bounds
            CheckExceptionGenericWithClassRestrictionArrayArrayIndex<Tc>(
                GenerateGenericWithClassRestrictionArrayArray<Tc>(0),
                -1,
                useInterpreter
            );
        ...
        private static void CheckIEquatableArrayArrayIndex(
            IEquatable<C>[][] array,
            bool useInterpreter
        )
        {
        ...
        private static void CheckIEquatable2ArrayArrayIndex(
            IEquatable<D>[][] array,
            bool useInterpreter
        )
        {
        ...
        private static void CheckStructWithStringAndStructArrayArrayIndex(
            Scs[][] array,
            bool useInterpreter
        )
        {
            ...
            for (int i = 0; i < array.Length; i++)
            {
                success &= CheckStructWithStringAndStructArrayArrayIndexExpression(
                    array,
                    i,
                    useInterpreter
                );
        ...
        private static void CheckStructWithTwoFieldsArrayArrayIndex(
            Sp[][] array,
            bool useInterpreter
        )
        {
            ...
            for (int i = 0; i < array.Length; i++)
            {
                success &= CheckStructWithTwoFieldsArrayArrayIndexExpression(
                    array,
                    i,
                    useInterpreter
                );
        ...
        private static void CheckGenericWithCustomArrayArrayIndex<T>(
            T[][] array,
            bool useInterpreter
        )
        {
            ...
            for (int i = 0; i < array.Length; i++)
            {
                success &= CheckGenericWithCustomArrayArrayIndexExpression<T>(
                    array,
                    i,
                    useInterpreter
                );
            ...
            where Tc : class
        {
            ...
            for (int i = 0; i < array.Length; i++)
            {
                success &= CheckGenericWithClassRestrictionArrayArrayIndexExpression<Tc>(
                    array,
                    i,
                    useInterpreter
                );
            ...
            where Tcn : class, new()
        {
            ...
            for (int i = 0; i < array.Length; i++)
            {
                success &= CheckGenericWithClassAndNewRestrictionArrayArrayIndexExpression<Tcn>(
                    array,
                    i,
                    useInterpreter
                );
            ...
            where TC : C
        {
            ...
            for (int i = 0; i < array.Length; i++)
            {
                success &= CheckGenericWithSubClassRestrictionArrayArrayIndexExpression<TC>(
                    array,
                    i,
                    useInterpreter
                );
            ...
            where TCn : C, new()
        {
            ...
            for (int i = 0; i < array.Length; i++)
            {
                success &= CheckGenericWithSubClassAndNewRestrictionArrayArrayIndexExpression<TCn>(
                    array,
                    i,
                    useInterpreter
                );
        ...
        private static bool CheckBoolArrayArrayIndexExpression(
            bool[][] array,
            int index,
            bool useInterpreter
        )
        ...
        private static bool CheckByteArrayArrayIndexExpression(
            byte[][] array,
            int index,
            bool useInterpreter
        )
        ...
        private static bool CheckCustomArrayArrayIndexExpression(
            C[][] array,
            int index,
            bool useInterpreter
        )
        ...
        private static bool CheckCharArrayArrayIndexExpression(
            char[][] array,
            int index,
            bool useInterpreter
        )
        ...
        private static bool CheckCustom2ArrayArrayIndexExpression(
            D[][] array,
            int index,
            bool useInterpreter
        )
        ...
        private static bool CheckDecimalArrayArrayIndexExpression(
            decimal[][] array,
            int index,
            bool useInterpreter
        )
        ...
        private static bool CheckDelegateArrayArrayIndexExpression(
            Delegate[][] array,
            int index,
            bool useInterpreter
        )
        ...
        private static bool CheckDoubleArrayArrayIndexExpression(
            double[][] array,
            int index,
            bool useInterpreter
        )
        ...
        private static bool CheckEnumArrayArrayIndexExpression(
            E[][] array,
            int index,
            bool useInterpreter
        )
        ...
        private static bool CheckEnumLongArrayArrayIndexExpression(
            El[][] array,
            int index,
            bool useInterpreter
        )
        ...
        private static bool CheckFloatArrayArrayIndexExpression(
            float[][] array,
            int index,
            bool useInterpreter
        )
        ...
        private static bool CheckFuncArrayArrayIndexExpression(
            Func<object>[][] array,
            int index,
            bool useInterpreter
        )
        ...
        private static bool CheckInterfaceArrayArrayIndexExpression(
            I[][] array,
            int index,
            bool useInterpreter
        )
        ...
        private static bool CheckIEquatableArrayArrayIndexExpression(
            IEquatable<C>[][] array,
            int index,
            bool useInterpreter
        )
        ...
        private static bool CheckIEquatable2ArrayArrayIndexExpression(
            IEquatable<D>[][] array,
            int index,
            bool useInterpreter
        )
        ...
        private static bool CheckIntArrayArrayIndexExpression(
            int[][] array,
            int index,
            bool useInterpreter
        )
        ...
        private static bool CheckLongArrayArrayIndexExpression(
            long[][] array,
            int index,
            bool useInterpreter
        )
        ...
        private static bool CheckObjectArrayArrayIndexExpression(
            object[][] array,
            int index,
            bool useInterpreter
        )
        ...
        private static bool CheckStructArrayArrayIndexExpression(
            S[][] array,
            int index,
            bool useInterpreter
        )
        ...
        private static bool CheckSByteArrayArrayIndexExpression(
            sbyte[][] array,
            int index,
            bool useInterpreter
        )
        ...
        private static bool CheckStructWithStringArrayArrayIndexExpression(
            Sc[][] array,
            int index,
            bool useInterpreter
        )
        ...
        private static bool CheckStructWithStringAndStructArrayArrayIndexExpression(
            Scs[][] array,
            int index,
            bool useInterpreter
        )
        ...
        private static bool CheckShortArrayArrayIndexExpression(
            short[][] array,
            int index,
            bool useInterpreter
        )
        ...
        private static bool CheckStructWithTwoFieldsArrayArrayIndexExpression(
            Sp[][] array,
            int index,
            bool useInterpreter
        )
        ...
        private static bool CheckStructWithValueArrayArrayIndexExpression(
            Ss[][] array,
            int index,
            bool useInterpreter
        )
        ...
        private static bool CheckStringArrayArrayIndexExpression(
            string[][] array,
            int index,
            bool useInterpreter
        )
        ...
        private static bool CheckUIntArrayArrayIndexExpression(
            uint[][] array,
            int index,
            bool useInterpreter
        )
        ...
        private static bool CheckULongArrayArrayIndexExpression(
            ulong[][] array,
            int index,
            bool useInterpreter
        )
        ...
        private static bool CheckUShortArrayArrayIndexExpression(
            ushort[][] array,
            int index,
            bool useInterpreter
        )
        ...
        private static bool CheckGenericWithCustomArrayArrayIndexExpression<T>(
            T[][] array,
            int index,
            bool useInterpreter
        )
        ...
        private static bool CheckArrayArrayIndexExpression<T>(
            T[][] array,
            int index,
            bool useInterpreter
        )
        ...
        private static bool CheckGenericWithClassRestrictionArrayArrayIndexExpression<Tc>(
            Tc[][] array,
            int index,
            bool useInterpreter
        )
        ...
        private static bool CheckGenericWithClassAndNewRestrictionArrayArrayIndexExpression<Tcn>(
            Tcn[][] array,
            int index,
            bool useInterpreter
        )
        ...
        private static bool CheckGenericWithSubClassRestrictionArrayArrayIndexExpression<TC>(
            TC[][] array,
            int index,
            bool useInterpreter
        )
        ...
        private static bool CheckGenericWithSubClassAndNewRestrictionArrayArrayIndexExpression<TCn>(
            TCn[][] array,
            int index,
            bool useInterpreter
        )
        ...
        private static void CheckExceptionBoolArrayArrayIndex(
            bool[][] array,
            int index,
            bool useInterpreter
        )
        {
            if (array == null)
                Assert.Throws<NullReferenceException>(() =>
                    CheckBoolArrayArrayIndexExpression(array, index, useInterpreter)
                );
            else
        ...
        private static void CheckExceptionByteArrayArrayIndex(
            byte[][] array,
            int index,
            bool useInterpreter
        )
        {
            if (array == null)
                Assert.Throws<NullReferenceException>(() =>
                    CheckByteArrayArrayIndexExpression(array, index, useInterpreter)
                );
            else
                Assert.Throws<IndexOutOfRangeException>(() =>
                    CheckByteArrayArrayIndexExpression(array, index, useInterpreter)
        ...
        private static void CheckExceptionCustomArrayArrayIndex(
            C[][] array,
            int index,
            bool useInterpreter
        )
        {
            if (array == null)
                Assert.Throws<NullReferenceException>(() =>
                    CheckCustomArrayArrayIndexExpression(array, index, useInterpreter)
                );
            else
                Assert.Throws<IndexOutOfRangeException>(() =>
                    CheckCustomArrayArrayIndexExpression(array, index, useInterpreter)
        ...
        private static void CheckExceptionCharArrayArrayIndex(
            char[][] array,
            int index,
            bool useInterpreter
        )
        {
            if (array == null)
                Assert.Throws<NullReferenceException>(() =>
                    CheckCharArrayArrayIndexExpression(array, index, useInterpreter)
                );
            else
                Assert.Throws<IndexOutOfRangeException>(() =>
                    CheckCharArrayArrayIndexExpression(array, index, useInterpreter)
        ...
        private static void CheckExceptionCustom2ArrayArrayIndex(
            D[][] array,
            int index,
            bool useInterpreter
        )
        {
            if (array == null)
                Assert.Throws<NullReferenceException>(() =>
                    CheckCustom2ArrayArrayIndexExpression(array, index, useInterpreter)
                );
            else
                Assert.Throws<IndexOutOfRangeException>(() =>
                    CheckCustom2ArrayArrayIndexExpression(array, index, useInterpreter)
        ...
        private static void CheckExceptionDecimalArrayArrayIndex(
            decimal[][] array,
            int index,
            bool useInterpreter
        )
        {
            if (array == null)
                Assert.Throws<NullReferenceException>(() =>
                    CheckDecimalArrayArrayIndexExpression(array, index, useInterpreter)
                );
            else
                Assert.Throws<IndexOutOfRangeException>(() =>
                    CheckDecimalArrayArrayIndexExpression(array, index, useInterpreter)
        ...
        private static void CheckExceptionDelegateArrayArrayIndex(
            Delegate[][] array,
            int index,
            bool useInterpreter
        )
        {
            if (array == null)
                Assert.Throws<NullReferenceException>(() =>
                    CheckDelegateArrayArrayIndexExpression(array, index, useInterpreter)
                );
            else
                Assert.Throws<IndexOutOfRangeException>(() =>
                    CheckDelegateArrayArrayIndexExpression(array, index, useInterpreter)
        ...
        private static void CheckExceptiondoubleArrayArrayIndex(
            double[][] array,
            int index,
            bool useInterpreter
        )
        {
            if (array == null)
                Assert.Throws<NullReferenceException>(() =>
                    CheckDoubleArrayArrayIndexExpression(array, index, useInterpreter)
                );
            else
                Assert.Throws<IndexOutOfRangeException>(() =>
                    CheckDoubleArrayArrayIndexExpression(array, index, useInterpreter)
        ...
        private static void CheckExceptionEnumArrayArrayIndex(
            E[][] array,
            int index,
            bool useInterpreter
        )
        {
            if (array == null)
                Assert.Throws<NullReferenceException>(() =>
                    CheckEnumArrayArrayIndexExpression(array, index, useInterpreter)
                );
            else
                Assert.Throws<IndexOutOfRangeException>(() =>
                    CheckEnumArrayArrayIndexExpression(array, index, useInterpreter)
        ...
        private static void CheckExceptionEnumLongArrayArrayIndex(
            El[][] array,
            int index,
            bool useInterpreter
        )
        {
            if (array == null)
                Assert.Throws<NullReferenceException>(() =>
                    CheckEnumLongArrayArrayIndexExpression(array, index, useInterpreter)
                );
            else
                Assert.Throws<IndexOutOfRangeException>(() =>
                    CheckEnumLongArrayArrayIndexExpression(array, index, useInterpreter)
        ...
        private static void CheckExceptionFloatArrayArrayIndex(
            float[][] array,
            int index,
            bool useInterpreter
        )
        {
            if (array == null)
                Assert.Throws<NullReferenceException>(() =>
                    CheckFloatArrayArrayIndexExpression(array, index, useInterpreter)
                );
            else
                Assert.Throws<IndexOutOfRangeException>(() =>
                    CheckFloatArrayArrayIndexExpression(array, index, useInterpreter)
        ...
        private static void CheckExceptionFuncArrayArrayIndex(
            Func<object>[][] array,
            int index,
            bool useInterpreter
        )
        {
            if (array == null)
                Assert.Throws<NullReferenceException>(() =>
                    CheckFuncArrayArrayIndexExpression(array, index, useInterpreter)
                );
            else
                Assert.Throws<IndexOutOfRangeException>(() =>
                    CheckFuncArrayArrayIndexExpression(array, index, useInterpreter)
        ...
        private static void CheckExceptionInterfaceArrayArrayIndex(
            I[][] array,
            int index,
            bool useInterpreter
        )
        {
            if (array == null)
                Assert.Throws<NullReferenceException>(() =>
                    CheckInterfaceArrayArrayIndexExpression(array, index, useInterpreter)
                );
            else
                Assert.Throws<IndexOutOfRangeException>(() =>
                    CheckInterfaceArrayArrayIndexExpression(array, index, useInterpreter)
        ...
        private static void CheckExceptionIEquatableArrayArrayIndex(
            IEquatable<C>[][] array,
            int index,
            bool useInterpreter
        )
        {
            if (array == null)
                Assert.Throws<NullReferenceException>(() =>
                    CheckIEquatableArrayArrayIndexExpression(array, index, useInterpreter)
                );
            else
                Assert.Throws<IndexOutOfRangeException>(() =>
                    CheckIEquatableArrayArrayIndexExpression(array, index, useInterpreter)
        ...
        private static void CheckExceptionIEquatable2ArrayArrayIndex(
            IEquatable<D>[][] array,
            int index,
            bool useInterpreter
        )
        {
            if (array == null)
                Assert.Throws<NullReferenceException>(() =>
                    CheckIEquatable2ArrayArrayIndexExpression(array, index, useInterpreter)
                );
            else
                Assert.Throws<IndexOutOfRangeException>(() =>
                    CheckIEquatable2ArrayArrayIndexExpression(array, index, useInterpreter)
        ...
        private static void CheckExceptionIntArrayArrayIndex(
            int[][] array,
            int index,
            bool useInterpreter
        )
        {
            if (array == null)
                Assert.Throws<NullReferenceException>(() =>
                    CheckIntArrayArrayIndexExpression(array, index, useInterpreter)
                );
            else
                Assert.Throws<IndexOutOfRangeException>(() =>
                    CheckIntArrayArrayIndexExpression(array, index, useInterpreter)
        ...
        private static void CheckExceptionLongArrayArrayIndex(
            long[][] array,
            int index,
            bool useInterpreter
        )
        {
            if (array == null)
                Assert.Throws<NullReferenceException>(() =>
                    CheckLongArrayArrayIndexExpression(array, index, useInterpreter)
                );
            else
                Assert.Throws<IndexOutOfRangeException>(() =>
                    CheckLongArrayArrayIndexExpression(array, index, useInterpreter)
        ...
        private static void CheckExceptionObjectArrayArrayIndex(
            object[][] array,
            int index,
            bool useInterpreter
        )
        {
            if (array == null)
                Assert.Throws<NullReferenceException>(() =>
                    CheckObjectArrayArrayIndexExpression(array, index, useInterpreter)
                );
            else
                Assert.Throws<IndexOutOfRangeException>(() =>
                    CheckObjectArrayArrayIndexExpression(array, index, useInterpreter)
        ...
        private static void CheckExceptionStructArrayArrayIndex(
            S[][] array,
            int index,
            bool useInterpreter
        )
        {
            if (array == null)
                Assert.Throws<NullReferenceException>(() =>
                    CheckStructArrayArrayIndexExpression(array, index, useInterpreter)
                );
            else
                Assert.Throws<IndexOutOfRangeException>(() =>
                    CheckStructArrayArrayIndexExpression(array, index, useInterpreter)
        ...
        private static void CheckExceptionSByteArrayArrayIndex(
            sbyte[][] array,
            int index,
            bool useInterpreter
        )
        {
            if (array == null)
                Assert.Throws<NullReferenceException>(() =>
                    CheckSByteArrayArrayIndexExpression(array, index, useInterpreter)
                );
            else
                Assert.Throws<IndexOutOfRangeException>(() =>
                    CheckSByteArrayArrayIndexExpression(array, index, useInterpreter)
        ...
        private static void CheckExceptionStructWithStringArrayArrayIndex(
            Sc[][] array,
            int index,
            bool useInterpreter
        )
        {
            if (array == null)
                Assert.Throws<NullReferenceException>(() =>
                    CheckStructWithStringArrayArrayIndexExpression(array, index, useInterpreter)
                );
            else
                Assert.Throws<IndexOutOfRangeException>(() =>
                    CheckStructWithStringArrayArrayIndexExpression(array, index, useInterpreter)
        ...
        private static void CheckExceptionStructWithStringAndStructArrayArrayIndex(
            Scs[][] array,
            int index,
            bool useInterpreter
        )
        {
            if (array == null)
                Assert.Throws<NullReferenceException>(() =>
                    CheckStructWithStringAndStructArrayArrayIndexExpression(
                        array,
                        index,
                        useInterpreter
                    )
        ...
        private static void CheckExceptionShortArrayArrayIndex(
            short[][] array,
            int index,
            bool useInterpreter
        )
        {
            if (array == null)
                Assert.Throws<NullReferenceException>(() =>
                    CheckShortArrayArrayIndexExpression(array, index, useInterpreter)
                );
            else
                Assert.Throws<IndexOutOfRangeException>(() =>
                    CheckShortArrayArrayIndexExpression(array, index, useInterpreter)
        ...
        private static void CheckExceptionStructWithTwoFieldsArrayArrayIndex(
            Sp[][] array,
            int index,
            bool useInterpreter
        )
        {
            if (array == null)
                Assert.Throws<NullReferenceException>(() =>
                    CheckStructWithTwoFieldsArrayArrayIndexExpression(array, index, useInterpreter)
                );
            else
                Assert.Throws<IndexOutOfRangeException>(() =>
                    CheckStructWithTwoFieldsArrayArrayIndexExpression(array, index, useInterpreter)
        ...
        private static void CheckExceptionStructWithValueArrayArrayIndex(
            Ss[][] array,
            int index,
            bool useInterpreter
        )
        {
            if (array == null)
                Assert.Throws<NullReferenceException>(() =>
                    CheckStructWithValueArrayArrayIndexExpression(array, index, useInterpreter)
                );
            else
                Assert.Throws<IndexOutOfRangeException>(() =>
                    CheckStructWithValueArrayArrayIndexExpression(array, index, useInterpreter)
        ...
        private static void CheckExceptionStringArrayArrayIndex(
            string[][] array,
            int index,
            bool useInterpreter
        )
        {
            if (array == null)
                Assert.Throws<NullReferenceException>(() =>
                    CheckStringArrayArrayIndexExpression(array, index, useInterpreter)
                );
            else
                Assert.Throws<IndexOutOfRangeException>(() =>
                    CheckStringArrayArrayIndexExpression(array, index, useInterpreter)
        ...
        private static void CheckExceptionUIntArrayArrayIndex(
            uint[][] array,
            int index,
            bool useInterpreter
        )
        {
            if (array == null)
                Assert.Throws<NullReferenceException>(() =>
                    CheckUIntArrayArrayIndexExpression(array, index, useInterpreter)
                );
            else
                Assert.Throws<IndexOutOfRangeException>(() =>
                    CheckUIntArrayArrayIndexExpression(array, index, useInterpreter)
        ...
        private static void CheckExceptionULongArrayArrayIndex(
            ulong[][] array,
            int index,
            bool useInterpreter
        )
        {
            if (array == null)
                Assert.Throws<NullReferenceException>(() =>
                    CheckULongArrayArrayIndexExpression(array, index, useInterpreter)
                );
            else
                Assert.Throws<IndexOutOfRangeException>(() =>
                    CheckULongArrayArrayIndexExpression(array, index, useInterpreter)
        ...
        private static void CheckExceptionUShortArrayArrayIndex(
            ushort[][] array,
            int index,
            bool useInterpreter
        )
        {
            if (array == null)
                Assert.Throws<NullReferenceException>(() =>
                    CheckUShortArrayArrayIndexExpression(array, index, useInterpreter)
                );
            else
                Assert.Throws<IndexOutOfRangeException>(() =>
                    CheckUShortArrayArrayIndexExpression(array, index, useInterpreter)
        ...
        private static void CheckExceptionGenericWithCustomArrayArrayIndex<T>(
            T[][] array,
            int index,
            bool useInterpreter
        )
        {
            if (array == null)
                Assert.Throws<NullReferenceException>(() =>
                    CheckGenericWithCustomArrayArrayIndexExpression(array, index, useInterpreter)
                );
            else
                Assert.Throws<IndexOutOfRangeException>(() =>
                    CheckGenericWithCustomArrayArrayIndexExpression(array, index, useInterpreter)
        ...
        private static void CheckExceptionGenericArrayArrayIndex<T>(
            T[][] array,
            int index,
            bool useInterpreter
        )
        {
            if (array == null)
                Assert.Throws<NullReferenceException>(() =>
                    CheckArrayArrayIndexExpression(array, index, useInterpreter)
                );
            else
                Assert.Throws<IndexOutOfRangeException>(() =>
                    CheckArrayArrayIndexExpression(array, index, useInterpreter)
        ...
        private static void CheckExceptionGenericWithClassRestrictionArrayArrayIndex<Tc>(
            Tc[][] array,
            int index,
            bool useInterpreter
        )
            where Tc : class
        {
            if (array == null)
                Assert.Throws<NullReferenceException>(() =>
                    CheckGenericWithClassRestrictionArrayArrayIndexExpression(
                        array,
                        index,
                        useInterpreter
                    )
        ...
        private static void CheckExceptionGenericWithClassAndNewRestrictionArrayArrayIndex<Tcn>(
            Tcn[][] array,
            int index,
            bool useInterpreter
        )
            where Tcn : class, new()
        {
            if (array == null)
                Assert.Throws<NullReferenceException>(() =>
                    CheckGenericWithClassAndNewRestrictionArrayArrayIndexExpression(
                        array,
                        index,
                        useInterpreter
                    )
        ...
        private static void CheckExceptionGenericWithSubClassRestrictionArrayArrayIndex<TC>(
            TC[][] array,
            int index,
            bool useInterpreter
        )
            where TC : C
        {
            if (array == null)
                Assert.Throws<NullReferenceException>(() =>
                    CheckGenericWithSubClassRestrictionArrayArrayIndexExpression(
                        array,
                        index,
                        useInterpreter
                    )
        ...
        private static void CheckExceptionGenericWithSubClassAndNewRestrictionArrayArrayIndex<TCn>(
            TCn[][] array,
            int index,
            bool useInterpreter
        )
            where TCn : C, new()
        {
            if (array == null)
                Assert.Throws<NullReferenceException>(() =>
                    CheckGenericWithSubClassAndNewRestrictionArrayArrayIndexExpression(
                        array,
                        index,
                        useInterpreter
                    )
