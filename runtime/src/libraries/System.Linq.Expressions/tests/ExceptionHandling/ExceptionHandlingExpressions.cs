...
namespace System.Linq.Expressions.Tests
{
    public class ExceptionHandlingExpressions
    {
        ...
        public void DefaultThrowTypeIsVoid()
        {
            ...
            Assert.Equal(
                typeof(void),
                Expression.Throw(Expression.Constant(new TestException())).Type
            );
        ...
        public void CannotRethrowWithinFinallyWithinCatch(bool useInterpreter)
        {
            LambdaExpression rethrowFinally = Expression.Lambda<Action>(
                Expression.TryCatch(
                    ...
                    Expression.Catch(
                        typeof(Exception),
                        Expression.TryFinally(Expression.Empty(), Expression.Rethrow())
                    )
                )
            );
        ...
        public void CannotRethrowWithinFaultWithinCatch(bool useInterpreter)
        {
            LambdaExpression rethrowFinally = Expression.Lambda<Action>(
                Expression.TryCatch(
                    ...
                    Expression.Catch(
                        typeof(Exception),
                        Expression.TryFault(Expression.Empty(), Expression.Rethrow())
                    )
                )
            );
            Assert.Throws<InvalidOperationException>(() => rethrowFinally.Compile(useInterpreter));
        ...
        public void ThrownNonExceptionPassesThroughNonMatchingHandlers(bool useInterpreter)
        {
            ...
            TryExpression nested = Expression.TryCatch(
                ...
                Expression.Catch(
                    ex,
                    Expression.Property(Expression.Convert(ex, typeof(string)), "Length")
                )
            );
        ...
        public void CatchFromExternallyThrownString(bool useInterpreter)
        {
            ...
            {
                CustomAttributeBuilder custAtt = new CustomAttributeBuilder(
                    typeof(RuntimeCompatibilityAttribute).GetConstructors()[0],
                    Array.Empty<object>(),
                    new[]
                    {
                ...
                TryExpression tryCatch = Expression.TryCatch(
                    Expression.Block(
                        Expression.Call(createdType.GetMethod("WillThrow")),
                        Expression.Constant("Nothing Thrown")
                    ),
                    Expression.Catch(ex, ex)
                );
                Func<string> func = Expression
                    .Lambda<Func<string>>(tryCatch)
        ...
        {
            Action throwNull = Expression
                .Lambda<Action>(Expression.Throw(Expression.Constant(null, typeof(Expression))))
                .Compile(useInterpreter);
        ...
        {
            Func<int> throwCatchNull = Expression
                .Lambda<Func<int>>(
                    Expression.TryCatch(
                        Expression.Throw(
        ...
        {
            Func<int> throwCatchAsObject = Expression
                .Lambda<Func<int>>(
                    Expression.TryCatch(
        ...
        public void CanCatchExceptionAsObjectObtainingException(bool useInterpreter)
        {
            ...
            Func<object> throwCatchAsObject = Expression
                .Lambda<Func<object>>(
                    Expression.TryCatch(
        ...
        public void CanAccessExceptionCaught(bool useInterpreter)
        {
            ...
            Assert.Equal(
                ...
                Expression.Lambda<Func<string>>(throwCatch).Compile(useInterpreter)()
            );
        }
        ...
        {
            Action throwWrapped = Expression
                .Lambda<Action>(Expression.Throw(Expression.Constant("Hello")))
                .Compile(useInterpreter);
        ...
        {
            TryExpression finally2 = Expression.TryFinally(
                Expression.Constant(1),
                Expression.Constant(2)
            );
        ...
        {
            TryExpression noExplicitType = Expression.TryFault(
                Expression.Constant(1),
                Expression.Empty()
            );
        ...
        {
            TryExpression explicitType = Expression.MakeTry(
                typeof(object),
            ...
            Assert.Equal(
                "hello",
                Expression.Lambda<Func<object>>(explicitType).Compile(useInterpreter)()
            );
        }
        ...
        public void FilterCanAccessException(bool useInterpreter)
        {
            ...
            TryExpression tryExp = Expression.TryCatch(
                ...
                Expression.Catch(
                    ...
                    Expression.Constant(1),
                    Expression.Equal(
                        Expression.Constant("This is not a drill."),
                        Expression.Property(exception, "Message")
                    )
                ),
                Expression.Catch(
                    exception,
                    Expression.Constant(2),
                    Expression.Equal(
                        Expression.Constant("This is a test exception"),
                        Expression.Property(exception, "Message")
                    )
                ),
            ...
            TryExpression tryExp = Expression.TryCatch(
                ...
                Expression.Catch(
                    ...
                    Expression.Block(
                        Expression.Assign(
                            exception,
                            Expression.Constant(null, typeof(TestException))
                        ),
                        Expression.Constant(true)
                    )
                )
            ...
            TryExpression tryExp = Expression.TryCatch(
                ...
                Expression.Catch(
                    ...
                    Expression.ReferenceNotEqual(
                        Expression.Call(builder, "Append", noTypes, Expression.Constant('C')),
                        Expression.Constant(null)
                    )
                )
            );
            Func<StringBuilder> func = Expression
                .Lambda<Func<StringBuilder>>(tryExp)
                .Compile(useInterpreter);
            ...
            TryExpression tryExp = Expression.TryCatch(
                ...
                Expression.Catch(
                    ...
                    Expression.LessThan(
                        Expression.Constant(3),
                        Expression.Throw(
                            Expression.Constant(new InvalidOperationException()),
                            typeof(int)
                        )
                    )
                ),
        ...
        public void TryCatchWithinFilter(bool useInterpreter)
        {
            TryExpression tryExp = Expression.TryCatch(
                ...
                Expression.Catch(
                    ...
                    Expression.TryCatch(
                        Expression.Constant(false),
                        Expression.Catch(typeof(Expression), Expression.Constant(false))
                    )
                ),
                Expression.Catch(
                    typeof(TestException),
                    ...
                    Expression.TryCatch(
                        Expression.Constant(true),
                        Expression.Catch(typeof(Expression), Expression.Constant(true))
                    )
                ),
                Expression.Catch(typeof(TestException), Expression.Constant(3))
            );
        ...
        public void TryCatchThrowingWithinFilter(bool useInterpreter)
        {
            TryExpression tryExp = Expression.TryCatch(
                ...
                Expression.Catch(
                    ...
                    Expression.TryCatch(
                        Expression.Throw(Expression.Constant(new TestException()), typeof(bool)),
                        Expression.Catch(typeof(Exception), Expression.Constant(true))
                    )
                ),
                Expression.Catch(typeof(TestException), Expression.Constant(3))
            );
        ...
        public void JumpOutOfExceptionFilter(bool useInterpreter)
        {
            ...
            Expression<Func<int>> tryExp = Expression.Lambda<Func<int>>(
                Expression.TryCatch(
                    ...
                    Expression.Catch(
                        typeof(TestException),
                        Expression.Block(Expression.Label(target), Expression.Constant(0)),
                        Expression.Block(Expression.Goto(target), Expression.Constant(true))
                    )
                )
            );
        ...
        public void JumpIntoTry(bool useInterpreter)
        {
            ...
            Expression<Action> tryExp = Expression.Lambda<Action>(
                Expression.Block(
                    ...
                    Expression.TryFinally(Expression.Label(target), Expression.Empty())
                )
            );
            Assert.Throws<InvalidOperationException>(() => tryExp.Compile(useInterpreter));
        }
        ...
        public void JumpOutOfTryToPreviousLabel(bool useInterpreter)
        {
            ...
            Expression<Func<int>> tryExp = Expression.Lambda<Func<int>>(
                Expression.Block(
                    ...
                    Expression.Label(backToStart),
                    Expression.Return(skipToEnd, Expression.Constant(1)),
                    Expression.Label(skipStart),
                    Expression.TryCatch(
                        Expression.Goto(backToStart),
        ...
        {
            CatchBlock cb = Expression.Catch(
                Expression.Variable(typeof(TestException), "ex"),
                Expression.Empty()
            );
        ...
        {
            TryExpression tryExp = Expression.TryCatchFinally(
                Expression.Empty(),
                Expression.Empty(),
                Expression.Catch(typeof(Exception), Expression.Empty())
            );
            Assert.Same(
                tryExp,
                tryExp.Update(tryExp.Body, tryExp.Handlers, tryExp.Finally, tryExp.Fault)
            );
        ...
        public void UpdateTrySameChildrenDifferentCollectionsSameNode()
        {
            ...
            Assert.Same(
                tryExp,
                tryExp.Update(tryExp.Body, tryExp.Handlers.ToArray(), tryExp.Finally, null)
            );
            tryExp = Expression.TryFault(Expression.Empty(), Expression.Empty());
        ...
        public void UpdateTryDiffBodyDiffNode()
        {
            ...
            Assert.NotSame(
                tryExp,
                tryExp.Update(Expression.Empty(), tryExp.Handlers, tryExp.Finally, null)
            );
            tryExp = Expression.TryFault(Expression.Empty(), Expression.Empty());
        ...
        public void UpdateTryDiffHandlersDiffNode()
        {
            ...
            Assert.NotSame(
                ...
                tryExp.Update(
                    tryExp.Body,
                    new[] { Expression.Catch(typeof(Exception), Expression.Empty()) },
                    tryExp.Finally,
                    null
                )
            );
        ...
        public void UpdateDoesntRepeatEnumeration()
        {
            ...
            IEnumerable<CatchBlock> newHandlers = new RunOnceEnumerable<CatchBlock>(
                new[] { Expression.Catch(typeof(Exception), Expression.Empty()) }
            );
        ...
        public void UpdateTryDiffFinallyDiffNode()
        {
            ...
            Assert.NotSame(
                tryExp,
                tryExp.Update(tryExp.Body, tryExp.Handlers, Expression.Empty(), null)
            );
        }
        ...
        public void UpdateTryDiffFaultDiffNode()
        {
            ...
            Assert.NotSame(
                tryExp,
                tryExp.Update(tryExp.Body, tryExp.Handlers, tryExp.Finally, Expression.Empty())
            );
        }
        ...
        public void ToStringTest()
        {
            ...
            TryExpression e4 = Expression.TryCatch(
                Expression.Empty(),
                Expression.Catch(typeof(Exception), Expression.Empty())
            );
            ...
            CatchBlock e6 = Expression.Catch(
            ...
            CatchBlock e7 = Expression.Catch(
                Expression.Parameter(typeof(Exception), "ex"),
                Expression.Empty(),
                Expression.Constant(true)
            );
