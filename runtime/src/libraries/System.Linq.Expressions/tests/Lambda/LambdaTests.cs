...
namespace System.Linq.Expressions.Tests
{
    ...
    public class LambdaTests
    {
        ...
        {
            ParameterExpression[] paramList = Enumerable
                .Range(0, 20)
        ...
        public void AnyTypeCanBeReturnedVoid(bool useInterpreter)
        {
            Action act = Expression
                .Lambda<Action>(Expression.Constant("foo"))
            ...
            if (pars.Length != 0)
            {
                ...
                IEnumerable<ParameterExpression> diffPars =
                    new RunOnceEnumerable<ParameterExpression>(
                        Enumerable
                            .Range(0, lamda.Parameters.Count) // Trigger Parameters collection build.
        ...
        public void ParameterListBehavior(int parCount, string name, bool tailCall)
        {
            ...
            ParameterExpression[] pars = Enumerable
                .Range(0, parCount)
                .Select(_ => Expression.Parameter(typeof(int)))
                .ToArray();
...
"
        ...
        public void AboveByteMaxArityArgAddressIL()
        {
            ...
            ParameterExpression[] pars = Enumerable
                ...
                .ToArray();
            Expression
                .Lambda<TricentaryIntAndMutableFunc>(
                    Expression.Call(
                        parToMutate,
                        nameof(Mutable.Mutate),
                        Type.EmptyTypes,
