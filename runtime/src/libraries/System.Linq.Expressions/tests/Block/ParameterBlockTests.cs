...
namespace System.Linq.Expressions.Tests
{
    public class ParameterBlockTests : SharedBlockTests
    {
        ...
        )
        {
            ...
            Assert.True(
                Expression.Lambda<Func<bool>>(Expression.Equal(constant, fromParamsBlock))
                    .Compile(useInterpreter)()
            );
            Assert.True(
                Expression.Lambda<Func<bool>>(Expression.Equal(constant, fromEnumBlock))
                    .Compile(useInterpreter)()
            );
        }
        ...
        {
            IEnumerable<ParameterExpression> vars = Enumerable.Range(0, blockSize)
