...
#pragma warning restore
        ...
        public static void UnboxReturnsReference(bool useInterpreter)
        {
            ...
            Func<object, int> lambda = Expression
                .Lambda<Func<object, int>>(call, p)
        ...
        public static void ArrayWriteBack(bool useInterpreter)
        {
            ...
            Func<Mutable[], int> lambda = Expression
                .Lambda<Func<Mutable[], int>>(call, p)
                .Compile(useInterpreter);
        ...
        public static void EnumArgAndReturn(bool useInterpreter)
        {
            ...
            MethodCallExpression call = Expression.Call(
                typeof(NonGenericClass).GetMethod("FooEnum"),
                p
            );
            Func<NonGenericClass.E1, NonGenericClass.E2> lambda = Expression
                .Lambda<Func<NonGenericClass.E1, NonGenericClass.E2>>(call, p)
                .Compile(useInterpreter);
        ...
        {
            ParameterExpression p = Expression.Parameter(typeof(Mutable[,]));
            MethodCallExpression indexed = Expression.ArrayIndex(
                p,
        ...
        {
            ParameterExpression p = Expression.Parameter(typeof(Mutable[,]));
            IndexExpression indexed = Expression.ArrayAccess(
                p,
                Expression.Constant(0),
                Expression.Constant(0)
            );
        ...
        public static void IndexedPropertyAccessNoWriteBack(bool useInterpreter)
        {
            ...
            IndexExpression indexed = Expression.Property(
                p,
                typeof(List<Mutable>).GetProperty("Item"),
                Expression.Constant(0)
            );
            MethodCallExpression call = Expression.Call(indexed, typeof(Mutable).GetMethod("Foo"));
            Func<List<Mutable>, int> lambda = Expression
                .Lambda<Func<List<Mutable>, int>>(call, p)
                .Compile(useInterpreter);
        ...
        public static void FieldAccessWriteBack(bool useInterpreter)
        {
            ...
            MemberExpression member = Expression.Field(
                p,
                typeof(Wrapper<Mutable>).GetField("Field")
            );
            MethodCallExpression call = Expression.Call(member, typeof(Mutable).GetMethod("Foo"));
            Func<Wrapper<Mutable>, int> lambda = Expression
                .Lambda<Func<Wrapper<Mutable>, int>>(call, p)
                .Compile(useInterpreter);
        ...
        public static void PropertyAccessNoWriteBack(bool useInterpreter)
        {
            ...
            MemberExpression member = Expression.Property(
                p,
                typeof(Wrapper<Mutable>).GetProperty("Property")
            );
            MethodCallExpression call = Expression.Call(member, typeof(Mutable).GetMethod("Foo"));
            Func<Wrapper<Mutable>, int> lambda = Expression
                .Lambda<Func<Wrapper<Mutable>, int>>(call, p)
        ...
        public static void ReadonlyFieldAccessWriteBack(bool useInterpreter)
        {
            ...
            MemberExpression member = Expression.Field(
                p,
                typeof(Wrapper<Mutable>).GetField("ReadOnlyField")
            );
            MethodCallExpression call = Expression.Call(member, typeof(Mutable).GetMethod("Foo"));
            Func<Wrapper<Mutable>, int> lambda = Expression
                .Lambda<Func<Wrapper<Mutable>, int>>(call, p)
        ...
        public static void ConstFieldAccessWriteBack(bool useInterpreter)
        {
            MemberExpression member = Expression.Field(
                null,
                typeof(Wrapper<Mutable>).GetField("Zero")
            );
        ...
        public static void CallByRefMutableStructPropertyWriteBack(bool useInterpreter)
        {
            ...
            Func<Mutable, int> lambda = Expression
                .Lambda<Func<Mutable, int>>(body, p)
                .Compile(useInterpreter);
        ...
        public static void CallByRefMutableStructIndexWriteBack(bool useInterpreter)
        {
            ...
            ParameterExpression p = Expression.Parameter(typeof(Mutable));
            IndexExpression x = Expression.MakeIndex(
                p,
                typeof(Mutable).GetProperty("Item"),
                new[] { Expression.Constant(0) }
            );
            MethodCallExpression call = Expression.Call(typeof(Methods).GetMethod("ByRef"), x);
            Action<Mutable> act = Expression
                .Lambda<Action<Mutable>>(call, true, p)
                .Compile(useInterpreter);
        ...
        public static IEnumerable<object[]> Call_NoParameters_TestData()
        {
            ...
            {
                Expression.Constant(new ClassWithInterface1()),
                typeof(ClassWithInterface1).GetMethod(nameof(ClassWithInterface1.Method)),
                2,
            };
            yield return new object[]
            {
                Expression.Constant(new StructWithInterface1()),
                typeof(StructWithInterface1).GetMethod(nameof(StructWithInterface1.Method)),
                2,
            };
            ...
            yield return new object[]
            {
                Expression.Constant(new StructWithInterface1()),
                typeof(object).GetMethod(nameof(object.GetType)),
                typeof(StructWithInterface1),
            };
            yield return new object[]
            {
                Expression.Constant(Int32Enum.A),
                typeof(object).GetMethod(nameof(object.GetType)),
                typeof(Int32Enum),
            };
            ...
            {
                Expression.Constant(new StructWithInterface1()),
                typeof(ValueType).GetMethod(nameof(ValueType.ToString)),
                new StructWithInterface1().ToString(),
            };
            ...
            {
                Expression.Constant(Int32Enum.A),
                typeof(Enum).GetMethod(nameof(Enum.ToString), new Type[0]),
                "A",
            };
            ...
            {
                Expression.Constant(new ClassWithInterface1()),
                typeof(Interface1).GetMethod(nameof(Interface1.InterfaceMethod)),
                1,
            };
            yield return new object[]
            {
            ...
            yield return new object[]
            {
                Expression.Constant(new ClassWithCompoundInterface()),
                typeof(Interface1).GetMethod(nameof(Interface1.InterfaceMethod)),
                1,
            };
            yield return new object[]
            {
                Expression.Constant(new StructWithCompoundInterface()),
                typeof(Interface1).GetMethod(nameof(Interface1.InterfaceMethod)),
                1,
            };
            ...
            yield return new object[]
            {
                Expression.Constant(new ClassWithInterface1(), typeof(Interface1)),
                typeof(Interface1).GetMethod(nameof(Interface1.InterfaceMethod)),
                1,
            };
            yield return new object[]
            {
                Expression.Constant(new StructWithInterface1(), typeof(Interface1)),
                typeof(Interface1).GetMethod(nameof(Interface1.InterfaceMethod)),
                1,
            };
        }
        ...
        public static void Call_NoParameters(
            Expression instance,
            MethodInfo method,
            object expected,
            bool useInterpreter
        ...
        public static IEnumerable<object[]> Method_Invalid_TestData()
        {
            ...
            yield return new object[]
            {
                typeof(GenericClass<>).GetMethod(nameof(GenericClass<string>.NonGenericMethod)),
        ...
        public static IEnumerable<object[]> Method_DoesntBelongToInstance_TestData()
        {
            ...
            {
                Expression.Constant(new ClassWithInterface1()),
                typeof(OtherClassWithInterface1).GetMethod(nameof(Interface1.InterfaceMethod)),
            };
            yield return new object[]
            {
                Expression.Constant(new StructWithInterface1()),
                typeof(OtherStructWithInterface1).GetMethod(nameof(Interface1.InterfaceMethod)),
            };
            ...
            {
                Expression.Constant(new ClassWithInterface1()),
                typeof(Interface2).GetMethod(nameof(Interface2.InterfaceMethod)),
            };
            yield return new object[]
            {
                Expression.Constant(new StructWithInterface1()),
            ...
            yield return new object[]
            {
                Expression.Constant(new ClassWithInterface1(), typeof(object)),
                typeof(ClassWithInterface1).GetMethod(nameof(ClassWithInterface1.Method)),
            };
            yield return new object[]
            {
                Expression.Constant(new StructWithInterface1(), typeof(object)),
                typeof(ClassWithInterface1).GetMethod(nameof(ClassWithInterface1.Method)),
            };
        }
        ...
        public static void Arg0_Invalid(Expression arg, Type exceptionType)
        {
            ...
            AssertArgumentException(
                () => Expression.Call(s_method2, arg, s_valid),
                exceptionType,
                "arg0"
            );
            AssertArgumentException(
                () => Expression.Call(s_method3, arg, s_valid, s_valid),
                exceptionType,
                "arg0"
            );
            AssertArgumentException(
                () => Expression.Call(s_method4, arg, s_valid, s_valid, s_valid),
                exceptionType,
                "arg0"
            );
            AssertArgumentException(
                () => Expression.Call(s_method5, arg, s_valid, s_valid, s_valid, s_valid),
                exceptionType,
                "arg0"
            );

            AssertArgumentException(
                () => Expression.Call(null, s_method1, arg),
                exceptionType,
                "arg0"
            );
            AssertArgumentException(
                () => Expression.Call(null, s_method2, arg, s_valid),
                exceptionType,
                "arg0"
            );
            AssertArgumentException(
                () => Expression.Call(null, s_method3, arg, s_valid, s_valid),
                exceptionType,
                "arg0"
            );
        }
        ...
        {
            AssertArgumentException(
                () => Expression.Call(s_method2, s_valid, arg),
                exceptionType,
                "arg1"
            );
            AssertArgumentException(
                () => Expression.Call(s_method3, s_valid, arg, s_valid),
                exceptionType,
                "arg1"
            );
            AssertArgumentException(
                () => Expression.Call(s_method4, s_valid, arg, s_valid, s_valid),
                exceptionType,
                "arg1"
            );
            AssertArgumentException(
                () => Expression.Call(s_method5, s_valid, arg, s_valid, s_valid, s_valid),
                exceptionType,
                "arg1"
            );

            AssertArgumentException(
                () => Expression.Call(null, s_method2, s_valid, arg),
                exceptionType,
                "arg1"
            );
            AssertArgumentException(
                () => Expression.Call(null, s_method3, s_valid, arg, s_valid),
                exceptionType,
                "arg1"
            );
        }
        ...
        {
            AssertArgumentException(
                () => Expression.Call(s_method3, s_valid, s_valid, arg),
                exceptionType,
                "arg2"
            );
            AssertArgumentException(
                () => Expression.Call(s_method4, s_valid, s_valid, arg, s_valid),
                exceptionType,
                "arg2"
            );
            AssertArgumentException(
                () => Expression.Call(s_method5, s_valid, s_valid, arg, s_valid, s_valid),
                exceptionType,
                "arg2"
            );

            AssertArgumentException(
                () => Expression.Call(null, s_method3, s_valid, s_valid, arg),
                exceptionType,
                "arg2"
            );
        }
        ...
        {
            AssertArgumentException(
                () => Expression.Call(s_method4, s_valid, s_valid, s_valid, arg),
                exceptionType,
                "arg3"
            );
            AssertArgumentException(
                () => Expression.Call(s_method5, s_valid, s_valid, s_valid, arg, s_valid),
                exceptionType,
                "arg3"
            );
        }
        ...
        {
            AssertArgumentException(
                () => Expression.Call(s_method5, s_valid, s_valid, s_valid, s_valid, arg),
                exceptionType,
                "arg4"
            );
        }
        ...
        public static void InvalidArgumentCount_ThrowsArgumentException(
            Type type,
            string name,
            int count
        )
        ...
        public static void GetArguments()
        {
            ...
            VerifyGetArguments(
                Expression.Call(site, nameof(NonGenericClass.InstanceMethod0), null)
            );
            VerifyGetArguments(
                Expression.Call(
                    site,
            ...
            VerifyGetArguments(
                Expression.Call(
                    site,
                    nameof(NonGenericClass.InstanceMethod2),
                    null,
            ...
            VerifyGetArguments(
                Expression.Call(
                    site,
                    nameof(NonGenericClass.InstanceMethod3),
                    null,
            ...
            VerifyGetArguments(
                Expression.Call(
                    site,
                    nameof(NonGenericClass.InstanceMethod4),
                    null,
