...
namespace System.Linq.Expressions.Tests
{
    public abstract class DelegateCreationTests
    {
        public static IEnumerable<object[]> ValidTypeArgs(bool includesReturnType)
        {
            ...
            {
                new[] { typeof(string), typeof(int), typeof(decimal), typeof(float) },
            };
            yield return new object[]
            {
                new[]
        ...
        public static IEnumerable<object[]> ByRefTypeArgs()
        {
            yield return new object[]
            {
                new[] { typeof(int), typeof(int).MakeByRefType(), typeof(string) },
            };
            yield return new object[] { new[] { typeof(int).MakeByRefType() } };
            yield return new object[]
            {
                Enumerable.Repeat(typeof(double).MakeByRefType(), 20).ToArray(),
            };
        }
        ...
        public static IEnumerable<object[]> PointerTypeArgs()
        {
            ...
            yield return new object[]
            {
                new[] { typeof(string), typeof(double).MakePointerType(), typeof(int) },
            };
            yield return new object[]
            {
                Enumerable.Repeat(typeof(int).MakePointerType(), 20).ToArray(),
            };
        }
        ...
        public static IEnumerable<object[]> ManagedPointerTypeArgs()
        {
            ...
            yield return new object[]
            {
                new[] { typeof(int), typeof(string).MakePointerType(), typeof(double) },
            };
            yield return new object[]
            {
                Enumerable.Repeat(typeof(string).MakePointerType(), 20).ToArray(),
            };
        }
