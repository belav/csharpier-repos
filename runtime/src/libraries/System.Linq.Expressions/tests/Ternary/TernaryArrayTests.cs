...
namespace System.Linq.Expressions.Tests
{
    public static class TernaryArrayTests
    {
        ...
        {
            bool[] array1 = new bool[] { false, true };
            IEquatable<D>[][] array2 = new IEquatable<D>[][]
            {
                null,
                new IEquatable<D>[0],
            ...
            for (int i = 0; i < array1.Length; i++)
            {
                for (int j = 0; j < array2.Length; j++)
                {
                    for (int k = 0; k < array2.Length; k++)
                    {
                        VerifyArrayIEquatableOfCustom2(
                            array1[i],
                            array2[j],
                            array2[k],
                            useInterpreter
        ...
        public static void CheckTernaryArrayStructWithStringArrayTest(bool useInterpreter)
        {
            ...
            for (int i = 0; i < array1.Length; i++)
            {
                for (int j = 0; j < array2.Length; j++)
                {
                    for (int k = 0; k < array2.Length; k++)
                    {
                        VerifyArrayStructWithStringArray(
                            array1[i],
                            array2[j],
                            array2[k],
                            useInterpreter
        ...
        public static void CheckTernaryArrayStructWithStringAndFieldArrayTest(bool useInterpreter)
        {
            ...
            for (int i = 0; i < array1.Length; i++)
            {
                for (int j = 0; j < array2.Length; j++)
                {
                    for (int k = 0; k < array2.Length; k++)
                    {
                        VerifyArrayStructWithStringAndFieldArray(
                            array1[i],
                            array2[j],
                            array2[k],
                            useInterpreter
        ...
        public static void CheckTernaryArrayStructWithTwoValuesArrayTest(bool useInterpreter)
        {
            ...
            for (int i = 0; i < array1.Length; i++)
            {
                for (int j = 0; j < array2.Length; j++)
                {
                    for (int k = 0; k < array2.Length; k++)
                    {
                        VerifyArrayStructWithTwoValuesArray(
                            array1[i],
                            array2[j],
                            array2[k],
                            useInterpreter
        ...
        public static void CheckTernaryArrayStructWithValueArrayTest(bool useInterpreter)
        {
            ...
            for (int i = 0; i < array1.Length; i++)
            {
                for (int j = 0; j < array2.Length; j++)
                {
                    for (int k = 0; k < array2.Length; k++)
                    {
                        VerifyArrayStructWithValueArray(
                            array1[i],
                            array2[j],
                            array2[k],
                            useInterpreter
            ...
            where Tc : class
        {
            ...
            for (int i = 0; i < array1.Length; i++)
            {
                for (int j = 0; j < array2.Length; j++)
                {
                    for (int k = 0; k < array2.Length; k++)
                    {
                        VerifyArrayGenericWithClassRestrictionArray<Tc>(
                            array1[i],
                            array2[j],
                            array2[k],
                            useInterpreter
            ...
            where TC : C
        {
            ...
            for (int i = 0; i < array1.Length; i++)
            {
                for (int j = 0; j < array2.Length; j++)
                {
                    for (int k = 0; k < array2.Length; k++)
                    {
                        VerifyArrayGenericWithSubClassRestrictionArray<TC>(
                            array1[i],
                            array2[j],
                            array2[k],
                            useInterpreter
            ...
            where Tcn : class, new()
        {
            ...
            for (int i = 0; i < array1.Length; i++)
            {
                for (int j = 0; j < array2.Length; j++)
                {
                    for (int k = 0; k < array2.Length; k++)
                    {
                        VerifyArrayGenericWithClassAndNewRestrictionArray<Tcn>(
                            array1[i],
                            array2[j],
                            array2[k],
                            useInterpreter
            ...
            where TCn : C, new()
        {
            ...
            for (int i = 0; i < array1.Length; i++)
            {
                for (int j = 0; j < array2.Length; j++)
                {
                    for (int k = 0; k < array2.Length; k++)
                    {
                        VerifyArrayGenericWithSubClassAndNewRestrictionArray<TCn>(
                            array1[i],
                            array2[j],
                            array2[k],
                            useInterpreter
            ...
            where Ts : struct
        {
            ...
            for (int i = 0; i < array1.Length; i++)
            {
                for (int j = 0; j < array2.Length; j++)
                {
                    for (int k = 0; k < array2.Length; k++)
                    {
                        VerifyArrayGenericWithStructRestrictionArray<Ts>(
                            array1[i],
                            array2[j],
                            array2[k],
                            useInterpreter
        ...
        private static void VerifyArrayBoolArray(
            bool condition,
            bool[] a,
            bool[] b,
            bool useInterpreter
        ...
        private static void VerifyArrayByteArray(
            bool condition,
            byte[] a,
            byte[] b,
            bool useInterpreter
        ...
        private static void VerifyArrayCustomArray(
            bool condition,
            C[] a,
            C[] b,
            bool useInterpreter
        ...
        private static void VerifyArrayCharArray(
            bool condition,
            char[] a,
            char[] b,
            bool useInterpreter
        ...
        private static void VerifyArrayCustom2Array(
            bool condition,
            D[] a,
            D[] b,
            bool useInterpreter
        ...
        private static void VerifyArrayDecimalArray(
            bool condition,
            decimal[] a,
            decimal[] b,
            bool useInterpreter
        ...
        private static void VerifyArrayDelegateArray(
            bool condition,
            Delegate[] a,
            Delegate[] b,
            bool useInterpreter
        ...
        private static void VerifyArrayDoubleArray(
            bool condition,
            double[] a,
            double[] b,
            bool useInterpreter
        ...
        private static void VerifyArrayEnumLongArray(
            bool condition,
            El[] a,
            El[] b,
            bool useInterpreter
        ...
        private static void VerifyArrayFloatArray(
            bool condition,
            float[] a,
            float[] b,
            bool useInterpreter
        ...
        private static void VerifyArrayFuncOfObject(
            bool condition,
            Func<object>[] a,
            Func<object>[] b,
            bool useInterpreter
        ...
        private static void VerifyArrayInterfaceArray(
            bool condition,
            I[] a,
            I[] b,
            bool useInterpreter
        ...
        private static void VerifyArrayIEquatableOfCustom(
            bool condition,
            IEquatable<C>[] a,
            IEquatable<C>[] b,
            bool useInterpreter
        ...
        private static void VerifyArrayIEquatableOfCustom2(
            bool condition,
            IEquatable<D>[] a,
            IEquatable<D>[] b,
            bool useInterpreter
        ...
        private static void VerifyArrayIntArray(
            bool condition,
            int[] a,
            int[] b,
            bool useInterpreter
        ...
        private static void VerifyArrayLongArray(
            bool condition,
            long[] a,
            long[] b,
            bool useInterpreter
        ...
        private static void VerifyArrayObjectArray(
            bool condition,
            object[] a,
            object[] b,
            bool useInterpreter
        ...
        private static void VerifyArrayStructArray(
            bool condition,
            S[] a,
            S[] b,
            bool useInterpreter
        ...
        private static void VerifyArraySByteArray(
            bool condition,
            sbyte[] a,
            sbyte[] b,
            bool useInterpreter
        ...
        private static void VerifyArrayStructWithStringArray(
            bool condition,
            Sc[] a,
            Sc[] b,
            bool useInterpreter
        ...
        private static void VerifyArrayStructWithStringAndFieldArray(
            bool condition,
            Scs[] a,
            Scs[] b,
            bool useInterpreter
        ...
        private static void VerifyArrayShortArray(
            bool condition,
            short[] a,
            short[] b,
            bool useInterpreter
        ...
        private static void VerifyArrayStructWithTwoValuesArray(
            bool condition,
            Sp[] a,
            Sp[] b,
            bool useInterpreter
        ...
        private static void VerifyArrayStructWithValueArray(
            bool condition,
            Ss[] a,
            Ss[] b,
            bool useInterpreter
        ...
        private static void VerifyArrayStringArray(
            bool condition,
            string[] a,
            string[] b,
            bool useInterpreter
        ...
        private static void VerifyArrayUIntArray(
            bool condition,
            uint[] a,
            uint[] b,
            bool useInterpreter
        ...
        private static void VerifyArrayULongArray(
            bool condition,
            ulong[] a,
            ulong[] b,
            bool useInterpreter
        ...
        private static void VerifyArrayUShortArray(
            bool condition,
            ushort[] a,
            ushort[] b,
            bool useInterpreter
        ...
        private static void VerifyArrayGenericArray<T>(
            bool condition,
            T[] a,
            T[] b,
            bool useInterpreter
        ...
        private static void VerifyArrayGenericWithClassRestrictionArray<Tc>(
            bool condition,
            Tc[] a,
            Tc[] b,
            bool useInterpreter
        ...
        private static void VerifyArrayGenericWithSubClassRestrictionArray<TC>(
            bool condition,
            TC[] a,
            TC[] b,
            bool useInterpreter
        ...
        private static void VerifyArrayGenericWithClassAndNewRestrictionArray<Tcn>(
            bool condition,
            Tcn[] a,
            Tcn[] b,
            bool useInterpreter
        ...
        private static void VerifyArrayGenericWithSubClassAndNewRestrictionArray<TCn>(
            bool condition,
            TCn[] a,
            TCn[] b,
            bool useInterpreter
        ...
        private static void VerifyArrayGenericWithStructRestrictionArray<Ts>(
            bool condition,
            Ts[] a,
            Ts[] b,
            bool useInterpreter
