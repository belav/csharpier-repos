...
namespace System.Linq.Expressions.Tests
{
    public static class TernaryNullableTests
    {
        ...
        public static void CheckTernaryNullableStructWithStringTest(bool useInterpreter)
        {
            ...
            for (int i = 0; i < array1.Length; i++)
            {
                for (int j = 0; j < array2.Length; j++)
                {
                    for (int k = 0; k < array2.Length; k++)
                    {
                        VerifyNullableStructWithString(
                            array1[i],
                            array2[j],
                            array2[k],
                            useInterpreter
        ...
        public static void CheckTernaryNullableStructWithStringAndFieldTest(bool useInterpreter)
        {
            ...
            for (int i = 0; i < array1.Length; i++)
            {
                for (int j = 0; j < array2.Length; j++)
                {
                    for (int k = 0; k < array2.Length; k++)
                    {
                        VerifyNullableStructWithStringAndField(
                            array1[i],
                            array2[j],
                            array2[k],
                            useInterpreter
        ...
        public static void CheckTernaryNullableStructWithTwoValuesTest(bool useInterpreter)
        {
            ...
            for (int i = 0; i < array1.Length; i++)
            {
                for (int j = 0; j < array2.Length; j++)
                {
                    for (int k = 0; k < array2.Length; k++)
                    {
                        VerifyNullableStructWithTwoValues(
                            array1[i],
                            array2[j],
                            array2[k],
                            useInterpreter
            ...
            where Ts : struct
        {
            ...
            for (int i = 0; i < array1.Length; i++)
            {
                for (int j = 0; j < array2.Length; j++)
                {
                    for (int k = 0; k < array2.Length; k++)
                    {
                        VerifyNullableGenericWithStructRestriction<Ts>(
                            array1[i],
                            array2[j],
                            array2[k],
                            useInterpreter
        ...
        private static void VerifyNullableBool(
            bool condition,
            bool? a,
            bool? b,
            bool useInterpreter
        ...
        private static void VerifyNullableByte(
            bool condition,
            byte? a,
            byte? b,
            bool useInterpreter
        ...
        private static void VerifyNullableChar(
            bool condition,
            char? a,
            char? b,
            bool useInterpreter
        ...
        private static void VerifyNullableDecimal(
            bool condition,
            decimal? a,
            decimal? b,
            bool useInterpreter
        ...
        private static void VerifyNullableDouble(
            bool condition,
            double? a,
            double? b,
            bool useInterpreter
        ...
        private static void VerifyNullableEnumLong(
            bool condition,
            El? a,
            El? b,
            bool useInterpreter
        ...
        private static void VerifyNullableFloat(
            bool condition,
            float? a,
            float? b,
            bool useInterpreter
        ...
        private static void VerifyNullableLong(
            bool condition,
            long? a,
            long? b,
            bool useInterpreter
        ...
        private static void VerifyNullableSByte(
            bool condition,
            sbyte? a,
            sbyte? b,
            bool useInterpreter
        ...
        private static void VerifyNullableStructWithStringAndField(
            bool condition,
            Scs? a,
            Scs? b,
            bool useInterpreter
        ...
        private static void VerifyNullableShort(
            bool condition,
            short? a,
            short? b,
            bool useInterpreter
        ...
        private static void VerifyNullableStructWithTwoValues(
            bool condition,
            Sp? a,
            Sp? b,
            bool useInterpreter
        ...
        private static void VerifyNullableStructWithValue(
            bool condition,
            Ss? a,
            Ss? b,
            bool useInterpreter
        ...
        private static void VerifyNullableUInt(
            bool condition,
            uint? a,
            uint? b,
            bool useInterpreter
        ...
        private static void VerifyNullableULong(
            bool condition,
            ulong? a,
            ulong? b,
            bool useInterpreter
        ...
        private static void VerifyNullableUShort(
            bool condition,
            ushort? a,
            ushort? b,
            bool useInterpreter
