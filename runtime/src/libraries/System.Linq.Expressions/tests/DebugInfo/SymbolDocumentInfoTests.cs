...
namespace System.Linq.Expressions.Tests
{
    public static class SymbolDocumentInfoTests
    {
        ...
        public static void SymbolDocument(
            string fileName,
            Guid language,
            Guid languageVendor,
            Guid documentType
        )
        {
            ...
            )
            {
                if (languageVendor == Guid.Empty)
                {
                    ...
                    SymbolDocumentInfo symbolDocument2 = Expression.SymbolDocument(
                        fileName,
                        language
                    );
                    VerifySymbolDocumentInfo(
                ...
                // SymbolDocument(string, Guid)
                SymbolDocumentInfo symbolDocument3 = Expression.SymbolDocument(
                    fileName,
                    language,
                    languageVendor
                );
            ...
            SymbolDocumentInfo symbolDocument4 = Expression.SymbolDocument(
                fileName,
                language,
                languageVendor,
                documentType
        ...
        private static void VerifySymbolDocumentInfo(
