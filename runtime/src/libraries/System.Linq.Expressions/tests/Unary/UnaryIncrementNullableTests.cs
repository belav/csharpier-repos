...
namespace System.Linq.Expressions.Tests
{
    public class UnaryIncrementNullableTests : IncrementDecrementTests
    {
        ...
        public static IEnumerable<object[]> IncrementableWhenNullableValues()
        {
            ...
            {
                new IncrementableWhenNullable(0),
                new IncrementableWhenNullable(1)
            };
            yield return new object[] { new IncrementableWhenNullable(-1), null };
            yield return new object[]
            {
                new IncrementableWhenNullable(int.MinValue),
                new IncrementableWhenNullable(int.MinValue + 1)
            };
            yield return new object[]
            {
                new IncrementableWhenNullable(int.MaxValue),
                new IncrementableWhenNullable(int.MinValue)
            };
        ...
        [
            Theory,
            MemberData(nameof(NonArithmeticObjects), false)
        ]
        public static void DecrementNonArithmetic(object value)
        {
            Expression ex = Expression.Constant(
                value,
        ...
        public static void CustomOpIncrement(
            Incrementable? operand,
            Incrementable? expected,
            bool useInterpreter
        )
        {
            Func<Incrementable?> func = Expression
                .Lambda<Func<Incrementable?>>(
                    Expression.Increment(Expression.Constant(operand, typeof(Incrementable?)))
                )
        ...
        public static void NonLiftedNullableOpIncrement(
            IncrementableWhenNullable? operand,
            IncrementableWhenNullable? expected,
            bool useInterpreter
        )
        {
            Func<IncrementableWhenNullable?> func = Expression
                .Lambda<Func<IncrementableWhenNullable?>>(
                    Expression.Increment(
                        Expression.Constant(operand, typeof(IncrementableWhenNullable?))
                    )
                )
                .Compile(useInterpreter);
            Assert.Equal(expected, func());
        ...
        public static void UserDefinedOpIncrement(
            Incrementable? operand,
            Incrementable? expected,
            bool useInterpreter
        )
        {
            ...
            Func<Incrementable?> func = Expression
                .Lambda<Func<Incrementable?>>(
                    Expression.Increment(
                        Expression.Constant(operand, typeof(Incrementable?)),
                        method
                    )
                )
                .Compile(useInterpreter);
        ...
        public static void UserDefinedOpIncrementArithmeticType(
            int? operand,
            int? expected,
            bool useInterpreter
        )
        {
            ...
            Func<int?> func = Expression
                .Lambda<Func<int?>>(
                    Expression.Increment(Expression.Constant(operand, typeof(int?)), method)
                )
                .Compile(useInterpreter);
            Assert.Equal(expected, func());
        }
