    ...
    public class PreDecrementAssignTests : IncDecAssignTests
    {
        ...
        public void IncorrectMethodType()
        {
            ...
            Assert.Throws<InvalidOperationException>(
                () => Expression.PreDecrementAssign(variable, method)
            );
        }
        ...
        public void NullOperand()
        {
            AssertExtensions.Throws<ArgumentNullException>(
                "expression",
                () => Expression.PreDecrementAssign(null)
            );
        }
        ...
        public void UnwritableOperand()
        {
            AssertExtensions.Throws<ArgumentException>(
                "expression",
                () => Expression.PreDecrementAssign(Expression.Constant(1))
            );
        }
        ...
        {
            UnaryExpression e = Expression.PreDecrementAssign(
