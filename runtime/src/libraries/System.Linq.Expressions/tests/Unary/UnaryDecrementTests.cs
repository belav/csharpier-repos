...
namespace System.Linq.Expressions.Tests
{
    public class UnaryDecrementTests : IncrementDecrementTests
    {
        ...
        public static void CustomOpDecrement(
            Decrementable operand,
            Decrementable expected,
            bool useInterpreter
        )
        {
            Func<Decrementable> func = Expression
                .Lambda<Func<Decrementable>>(Expression.Decrement(Expression.Constant(operand)))
        ...
        )
        {
            ...
            Func<Decrementable> func = Expression
                .Lambda<Func<Decrementable>>(
                    Expression.Decrement(Expression.Constant(operand), method)
                )
                .Compile(useInterpreter);
            Assert.Equal(expected.Value, func().Value);
        }
        ...
        public static void UserDefinedOpDecrementArithmeticType(
            int operand,
            int expected,
            bool useInterpreter
        )
        {
            ...
            Func<int> func = Expression
                .Lambda<Func<int>>(Expression.Decrement(Expression.Constant(operand), method))
                .Compile(useInterpreter);
        ...
        {
            Expression operand = Expression.Property(
                null,
