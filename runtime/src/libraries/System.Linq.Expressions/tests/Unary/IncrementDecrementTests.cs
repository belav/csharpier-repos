...
namespace System.Linq.Expressions.Tests
{
    public abstract class IncrementDecrementTests
    {
        public struct Decrementable
        {
            ...
            public static Decrementable operator --(Decrementable operand) =>
                new Decrementable(unchecked(operand.Value - 1));
        }
        ...
        public struct Incrementable
        {
            ...
            public static Incrementable operator ++(Incrementable operand) =>
                new Incrementable(unchecked(operand.Value + 1));
        }

        public static Incrementable DoublyIncrement(Incrementable operand) =>
            new Incrementable(unchecked(operand.Value + 2));

        public static int DoublyIncrementInt32(int operand) => unchecked(operand + 2);

        public static Decrementable DoublyDecrement(Decrementable operand) =>
            new Decrementable(unchecked(operand.Value - 2));
        ...
        public static IEnumerable<object[]> IncrementableValues(bool includeNulls)
        {
            ...
            {
                new Incrementable(int.MinValue),
                new Incrementable(int.MinValue + 1),
            };
            yield return new object[]
            {
                new Incrementable(int.MaxValue),
                new Incrementable(int.MinValue),
            };
        ...
        public static IEnumerable<object[]> DoublyIncrementedIncrementableValues(bool includeNulls)
        {
            ...
            {
                new Incrementable(int.MinValue),
                new Incrementable(int.MinValue + 2),
            };
            yield return new object[]
            {
                new Incrementable(int.MaxValue),
        ...
        public static IEnumerable<object[]> DecrementableValues(bool includeNulls)
        {
            ...
            yield return new object[]
            {
                new Decrementable(int.MaxValue),
                new Decrementable(int.MaxValue - 1),
            };
            yield return new object[]
            {
                new Decrementable(int.MinValue),
                new Decrementable(int.MaxValue),
            };
        ...
        public static IEnumerable<object[]> DoublyDecrementedDecrementableValues(bool includeNulls)
        {
            ...
            {
                new Decrementable(int.MaxValue),
                new Decrementable(int.MaxValue - 2),
            };
            yield return new object[]
            {
                new Decrementable(int.MinValue),
