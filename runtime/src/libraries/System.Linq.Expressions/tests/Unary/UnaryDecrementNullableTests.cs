...
namespace System.Linq.Expressions.Tests
{
    public class UnaryDecrementNullableTests : IncrementDecrementTests
    {
        ...
        public static IEnumerable<object[]> DecrementableWhenNullableValues()
        {
            ...
            {
                new DecrementableWhenNullable(0),
                new DecrementableWhenNullable(-1),
            };
            yield return new object[] { new DecrementableWhenNullable(1), null };
            yield return new object[]
            {
                new DecrementableWhenNullable(int.MaxValue),
                new DecrementableWhenNullable(int.MaxValue - 1),
            };
            yield return new object[]
            {
                new DecrementableWhenNullable(int.MinValue),
                new DecrementableWhenNullable(int.MaxValue),
            };
        ...
        {
            Func<DecrementableWhenNullable?> func = Expression
                .Lambda<Func<DecrementableWhenNullable?>>(
