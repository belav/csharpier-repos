    ...
    public static class BinaryExclusiveOrTests
    {
        ...
        public static void ThrowsOnLeftNull()
        {
            AssertExtensions.Throws<ArgumentNullException>(
                "left",
                () => Expression.ExclusiveOr(null, Expression.Constant(""))
            );
        }
        ...
        public static void ThrowsOnRightNull()
        {
            AssertExtensions.Throws<ArgumentNullException>(
                "right",
                () => Expression.ExclusiveOr(Expression.Constant(""), null)
            );
        }
        ...
        public static void ThrowsOnLeftUnreadable()
        {
            ...
            AssertExtensions.Throws<ArgumentException>(
                "left",
                () => Expression.ExclusiveOr(value, Expression.Constant(1))
            );
        }
        ...
        public static void ThrowsOnRightUnreadable()
        {
            ...
            AssertExtensions.Throws<ArgumentException>(
                "right",
                () => Expression.ExclusiveOr(Expression.Constant(1), value)
            );
        }
        ...
        {
            BinaryExpression e = Expression.ExclusiveOr(
