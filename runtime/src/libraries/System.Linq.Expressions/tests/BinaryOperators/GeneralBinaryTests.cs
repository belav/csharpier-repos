...
namespace System.Linq.Expressions.Tests
{
    public class GeneralBinaryTests
    {
        ...
        public static bool CustomLessThan(object a, object b) =>
            BothNotNull(a, b) && !IsNaN(a) && !IsNaN(b) && !CustomGreaterThanOrEqual(a, b);
        ...
        )
        {
            ...
            Expression<Action> sillyLambda = Expression.Lambda<Action>(
        ...
        private class GenericClassWithNonGenericMethod<TClassType>
        {
            ...
            public static GenericClassWithNonGenericMethod<TClassType> DoBooleanStuff(
                GenericClassWithNonGenericMethod<TClassType> x,
                GenericClassWithNonGenericMethod<TClassType> y
            ) => x;

            public static bool operator true(GenericClassWithNonGenericMethod<TClassType> obj) =>
                true;

            public static bool operator false(GenericClassWithNonGenericMethod<TClassType> obj) =>
                false;
        }
        ...
        {
            GenericClassWithNonGenericMethod<bool> value =
                new GenericClassWithNonGenericMethod<bool>();
            ConstantExpression left = Expression.Constant(value);
            ConstantExpression right = Expression.Constant(
                new GenericClassWithNonGenericMethod<bool>()
            );
            var genType = typeof(GenericClassWithNonGenericMethod<>);
            MethodInfo method = genType.GetMethod(
            ...
            method = validType.GetMethod(
                nameof(GenericClassWithNonGenericMethod<bool>.DoBooleanStuff)
            );
            Expression exp = Expression.MakeBinary(type, left, right, false, method);
            Func<GenericClassWithNonGenericMethod<bool>> f = Expression
                .Lambda<Func<GenericClassWithNonGenericMethod<bool>>>(exp)
