    ...
    public static class BinaryCoalesceTests
    {
        public static IEnumerable<object[]> TestData()
        {
            foreach (bool useInterpreter in new bool[] { true, false })
            {
                ...
                yield return new object[]
                {
                    new E?[] { null, 0, E.A, E.B, (E)int.MaxValue, (E)int.MinValue },
                    new E[] { 0, E.A, E.B, (E)int.MaxValue, (E)int.MinValue },
                    useInterpreter
                };
                yield return new object[]
                {
                    new El?[] { null, 0, El.A, El.B, (El)long.MaxValue, (El)long.MinValue },
                    new El[] { 0, El.A, El.B, (El)long.MaxValue, (El)long.MinValue },
                    useInterpreter
                };
                yield return new object[]
                {
                ...
                yield return new object[]
                {
                    new Sc?[] { null, default(Sc), new Sc(), new Sc(null) },
                    new Sc[] { default(Sc), new Sc(), new Sc(null) },
                    useInterpreter
                };
                yield return new object[]
                {
                    new Scs?[] { null, default(Scs), new Scs(), new Scs(null, new S()) },
                ...
                yield return new object[]
                {
                    new Sp?[] { null, default(Sp), new Sp(), new Sp(5, 5.0) },
                    new Sp[] { default(Sp), new Sp(), new Sp(5, 5.0) },
                    useInterpreter
                };
                yield return new object[]
                {
                    new Ss?[] { null, default(Ss), new Ss(), new Ss(new S()) },
                ...
                yield return new object[]
                {
                    new E?[] { null, (E)0, E.A, E.B, (E)int.MaxValue, (E)int.MinValue },
                    new E?[] { null, (E)0, E.A, E.B, (E)int.MaxValue, (E)int.MinValue },
                    useInterpreter
                };
                yield return new object[]
                {
                    new El?[] { null, (El)0, El.A, El.B, (El)long.MaxValue, (El)long.MinValue },
                    new El?[] { null, (El)0, El.A, El.B, (El)long.MaxValue, (El)long.MinValue },
                    useInterpreter
                };
                yield return new object[]
        ...
        public static IEnumerable<object[]> ImplicitNumericConversionData()
        {
            foreach (bool useInterpreter in new bool[] { true, false })
            {
                ...
                {
                    new int?[] { null, 1 },
                    new object[] { (int)4, (long)5, (float)3.14, (double)3.14, (decimal)49.95 },
                    useInterpreter
                };
                yield return new object[]
                {
                    new ulong?[] { null, 1 },
                    new object[] { (ulong)5, (float)3.14, (double)3.14, (decimal)49.95 },
                    useInterpreter
                };
                yield return new object[]
                {
                    new long?[] { null, 1 },
                    new object[] { (long)5, (float)3.14, (double)3.14, (decimal)49.95 },
                    useInterpreter
                };
                yield return new object[]
                {
                ...
                {
                    new float?[] { null, 1F },
                    new object[] { (float)3.14, (double)3.14 },
                    useInterpreter
                };
                yield return new object[]
                {
        ...
        public static void ImplicitNumericConversions(
            Array array1,
            Array array2,
            bool useInterpreter
        )
        ...
        private static void CheckGenericWithClassRestrictionCoalesceHelper<Tc>(bool useInterpreter)
            where Tc : class
        {
        ...
        private static void CheckGenericWithStructRestrictionCoalesceHelper<Ts>(bool useInterpreter)
            where Ts : struct
        {
        ...
        private static void VerifyCoalesce(
            object obj1,
            Type type1,
            object obj2,
            Type type2,
        ...
        {
            Expression exp = Expression.Coalesce(
        ...
        public static void Conversion_String(string parameter, string expected, bool useInterpreter)
        {
            ...
            BinaryExpression coalescion = Expression.Coalesce(
                parameterExpression,
                Expression.Constant("YY"),
                conversion
            );

            Func<string, string> result = Expression
                .Lambda<Func<string, string>>(coalescion, parameterExpression)
        ...
        public static void Conversion_NullableInt(
            int? parameter,
            int? expected,
            bool useInterpreter
        )
        {
            ...
            Func<int?, int?> result = Expression
                .Lambda<Func<int?, int?>>(coalescion, parameterExpression)
                .Compile(useInterpreter);
            Assert.Equal(expected, result(parameter));
        }
        ...
        {
            BinaryExpression e = Expression.Coalesce(
        ...
        public static void VerifyIL_NullableIntCoalesceToNullableInt()
        {
            ...
            Expression<Func<int?, int?, int?>> f = Expression.Lambda<Func<int?, int?, int?>>(
        ...
        public static void CoalesceWideningLeft(bool useInterpreter)
        {
            ...
            Func<int?, long, long> func = Expression
                .Lambda<Func<int?, long, long>>(Expression.Coalesce(x, y), x, y)
                .Compile(useInterpreter);
        ...
        public static void CoalesceWideningRight(bool useInterpreter)
        {
            ...
            ParameterExpression y = Expression.Parameter(typeof(int));
            Func<long?, int, long> func = Expression
                .Lambda<Func<long?, int, long>>(Expression.Coalesce(x, y), x, y)
                .Compile(useInterpreter);
            Assert.Equal(2, func(null, 2));
            Assert.Equal(2, func(2, 1));
        }
