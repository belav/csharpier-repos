    ...
    public static class BinaryDivideTests
    {
        ...
        public static void ThrowsOnLeftNull()
        {
            AssertExtensions.Throws<ArgumentNullException>(
                "left",
                () => Expression.Divide(null, Expression.Constant(""))
            );
        }
        ...
        public static void ThrowsOnRightNull()
        {
            AssertExtensions.Throws<ArgumentNullException>(
                "right",
                () => Expression.Divide(Expression.Constant(""), null)
            );
        }
        ...
        public static void ThrowsOnLeftUnreadable()
        {
            ...
            AssertExtensions.Throws<ArgumentException>(
                "left",
                () => Expression.Divide(value, Expression.Constant(1))
            );
        }
        ...
        public static void ThrowsOnRightUnreadable()
        {
            ...
            AssertExtensions.Throws<ArgumentException>(
                "right",
                () => Expression.Divide(Expression.Constant(1), value)
            );
        }
        ...
        {
            BinaryExpression e = Expression.Divide(
