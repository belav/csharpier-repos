...
namespace System.Linq.Expressions.Tests
{
    public static class BinaryLogicalTests
    {
        ...
        )
        {
            ...
            Func<TrueFalseClass> lambda = Expression
                .Lambda<Func<TrueFalseClass>>(expression)
        ...
        )
        {
            ...
            Func<TrueFalseClass> lambda = Expression
                .Lambda<Func<TrueFalseClass>>(expression, true)
                .Compile(useInterpreter);
            Assert.Equal(expectedValue, lambda().Value);
        ...
        public static void AndAlso_UserDefinedOperator_HasMethodNotOperator(bool useInterpreter)
        {
            ...
            Func<NamedMethods> lambda = Expression
                .Lambda<Func<NamedMethods>>(expression)
                .Compile(useInterpreter);
        ...
        )
        {
            ...
            AssertExtensions.Throws<ArgumentException>(null, () =>
                Expression.OrElse(Expression.Constant(obj), Expression.Constant(obj), createdMethod)
            );
        }
