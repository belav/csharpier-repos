...
namespace System.Runtime.Serialization.Xml.XsdDataContractExporterTests
{
    public class ExporterApiTests
    {
        ...
        public void CanExport(
            bool expectedResult,
            string testname,
            Func<XsdDataContractExporter, bool> canExport,
        ...
        public void Export(
            string testname,
            Action<XsdDataContractExporter> export,
        ...
        public static IEnumerable<object[]> Export_MemberData()
        {
            ...
            {
                "Exp1",
                (XsdDataContractExporter exp) => exp.Export(typeof(Types.Point)),
                (string s, XmlSchemaSet ss) =>
                {
                    ...
                    SchemaUtils.OrderedContains(
                        @"<xs:schema xmlns:tns=""http://basic"" elementFormDefault=""qualified"" targetNamespace=""http://basic"" xmlns:xs=""http://www.w3.org/2001/XMLSchema"">",
                        ref s
                    );
            ...
            yield return new object[]
            {
                "Exp2",
                (XsdDataContractExporter exp) =>
                    exp.Export(new Assembly[] { typeof(DataContractTypes).Assembly }),
                (string s, XmlSchemaSet ss) =>
                {
            ...
            yield return new object[]
            {
                "Exp3",
                (XsdDataContractExporter exp) =>
                    exp.Export(new Type[] { typeof(Types.Point), typeof(Types.Circle) }),
                (string s, XmlSchemaSet ss) =>
                {
                    ...
                    // Circle
                    SchemaUtils.OrderedContains(
                        @"<xs:schema xmlns:tns=""http://shapes"" elementFormDefault=""qualified"" targetNamespace=""http://shapes"" xmlns:xs=""http://www.w3.org/2001/XMLSchema"">",
                        ref s
                    );
                    ...
                    SchemaUtils.OrderedContains(
                        @"<xs:element minOccurs=""0"" name=""Center"" nillable=""true"" xmlns:q1=""http://basic"" type=""q1:Point"" />",
                        ref s
                    );
                    SchemaUtils.OrderedContains(
            ...
            yield return new object[]
            {
                ...
                (string s, XmlSchemaSet ss) =>
                {
                    ...
                    SchemaUtils.OrderedContains(
                        @"<xs:import namespace=""http://shapes"" />",
                        ref s
                    );
                    // *Types*
                    // NonAttributedPersonStruct
                    SchemaUtils.OrderedContains(
                        @"<xs:complexType name=""NonAttributedPersonStruct"">",
                        ref s
                    );
                    Assert.Matches(
                        @"<xs:appinfo>\s*<IsValueType xmlns=""http://schemas.microsoft.com/2003/10/Serialization/"">true</IsValueType>",
                        s
                    );
                    SchemaUtils.OrderedContains(
                    ...
                    SchemaUtils.OrderedContains(
                        @"<xs:element name=""NonAttributedPersonStruct"" nillable=""true"" type=""tns:NonAttributedPersonStruct"" />",
                        ref s
                    );
                    // NonAttributedPersonClass
                    SchemaUtils.OrderedContains(
                        @"<xs:complexType name=""NonAttributedPersonClass"">",
                        ref s
                    );
                    SchemaUtils.OrderedContains(
                        @"<xs:element minOccurs=""0"" name=""firstName"" nillable=""true"" type=""xs:string"" />",
                    ...
                    SchemaUtils.OrderedContains(
                        @"<xs:element name=""NonAttributedPersonClass"" nillable=""true"" type=""tns:NonAttributedPersonClass"" />",
                        ref s
                    );
                    // ExtendedSquare
                    ...
                    SchemaUtils.OrderedContains(
                        @"<xs:extension xmlns:q1=""http://shapes"" base=""q1:Square"">",
                        ref s
                    );
                    SchemaUtils.OrderedContains(
                    ...
                    SchemaUtils.OrderedContains(
                        @"<xs:element name=""ExtendedSquare"" nillable=""true"" type=""tns:ExtendedSquare"" />",
                        ref s
                    );
                    // *shapes*
                    // Square
                    ...
                    SchemaUtils.OrderedContains(
                        @"<xs:element minOccurs=""0"" name=""BottomLeft"" nillable=""true"" xmlns:q1=""http://basic"" type=""q1:Point"" />",
                        ref s
                    );
                    SchemaUtils.OrderedContains(
            ...
            yield return new object[]
            {
                "ExpEnum",
                (XsdDataContractExporter exp) =>
                    exp.Export(new Type[] { typeof(System.Reflection.TypeAttributes) }),
                (string s, XmlSchemaSet ss) =>
                {
                    Assert.Equal(3, ss.Count);
        ...
        public void Export_NegativeCases(
            string testname,
            Action<XsdDataContractExporter> export,
        ...
        public static IEnumerable<object[]> GetSchemaTypeName_MemberData()
        {
            ...
            {
                "DCTT_Addr2",
                typeof(DataContractTypes.Address2),
                new XmlQualifiedName(
                    "Address",
        ...
        public void GetRootElementName(
            string testname,
            Type t,
            XmlQualifiedName rName,
            Type expectedExceptionType = null,
            string msg = null
        )
        {
