...
namespace LibraryImportGenerator.UnitTests
{
    public class Compiles
    {
        ...
        public static IEnumerable<object[]> CodeSnippetsToCompile()
        {
            ...
            {
                ID(),
                CustomStructMarshallingCodeSnippets<CodeSnippets>.StructMarshallerEntryPoint
            };
            yield return new[]
            {
                ID(),
                CustomStructMarshallingCodeSnippets<CodeSnippets>.Stateless.ParametersAndModifiers
            };
            yield return new[]
            {
                ID(),
                CustomStructMarshallingCodeSnippets<CodeSnippets>
                    .Stateless
                    .MarshalUsingParametersAndModifiers
            };
            yield return new[]
            {
                ID(),
                CustomStructMarshallingCodeSnippets<CodeSnippets>
                    .Stateless
                    .NativeToManagedOnlyOutParameter
            };
            yield return new[]
            {
                ID(),
            ...
            yield return new[]
            {
                ...
                CustomStructMarshallingCodeSnippets<CodeSnippets>
                    .Stateless
                    .NativeToManagedOnlyReturnValue
            };
            yield return new[]
            {
                ID(),
                CustomStructMarshallingCodeSnippets<CodeSnippets>
                    .Stateless
                    .NativeToManagedFinallyOnlyReturnValue
            };
            yield return new[]
            {
                ID(),
                CustomStructMarshallingCodeSnippets<CodeSnippets>.Stateless.ByValueInParameter
            };
            yield return new[]
            {
                ID(),
                CustomStructMarshallingCodeSnippets<CodeSnippets>.Stateless.PinByValueInParameter
            };
            yield return new[]
            {
                ID(),
                CustomStructMarshallingCodeSnippets<CodeSnippets>
                    .Stateless
                    .StackallocByValueInParameter
            };
            yield return new[]
            {
                ID(),
                CustomStructMarshallingCodeSnippets<CodeSnippets>.Stateless.RefParameter
            };
            yield return new[]
            {
                ID(),
                CustomStructMarshallingCodeSnippets<CodeSnippets>
                    .Stateless
                    .StackallocParametersAndModifiersNoRef
            };
            yield return new[]
            {
                ID(),
            ...
            yield return new[]
            {
                ...
                CustomStructMarshallingCodeSnippets<CodeSnippets>
                    .Stateless
                    .DefaultModeByValueInParameter
            };
            yield return new[]
            {
                ID(),
                CustomStructMarshallingCodeSnippets<CodeSnippets>.Stateless.DefaultModeReturnValue
            };
            yield return new[]
            {
                ID(),
                CustomStructMarshallingCodeSnippets<CodeSnippets>.Stateful.ParametersAndModifiers
            };
            yield return new[]
            {
                ID(),
                CustomStructMarshallingCodeSnippets<CodeSnippets>
                    .Stateful
                    .ParametersAndModifiersWithFree
            };
            yield return new[]
            {
                ID(),
                CustomStructMarshallingCodeSnippets<CodeSnippets>
                    .Stateful
                    .ParametersAndModifiersWithOnInvoked
            };
            yield return new[]
            {
                ID(),
            ...
            {
                ID(),
                CustomStructMarshallingCodeSnippets<CodeSnippets>.Stateful.ByValueInParameter
            };
            yield return new[]
            {
                ID(),
            ...
            {
                ID(),
                CustomStructMarshallingCodeSnippets<CodeSnippets>.Stateful.PinByValueInParameter
            };
            yield return new[]
            {
                ID(),
                CustomStructMarshallingCodeSnippets<CodeSnippets>
                    .Stateful
                    .MarshallerPinByValueInParameter
            };
            yield return new[]
            {
                ID(),
                CustomStructMarshallingCodeSnippets<CodeSnippets>.Stateful.RefParameter
            };
            yield return new[]
            {
                ID(),
            ...
            {
                ID(),
                CustomStructMarshallingCodeSnippets<CodeSnippets>.Stateful.DefaultModeReturnValue
            };
        ...
        public static IEnumerable<object[]> CustomCollections()
        {
            ...
            {
                ID(),
                CustomCollectionMarshallingCodeSnippets<CodeSnippets>.Stateless.ByValue<byte>()
            };
            yield return new[]
            {
                ID(),
                CustomCollectionMarshallingCodeSnippets<CodeSnippets>.Stateless.ByValue<sbyte>()
            };
            yield return new[]
            {
                ID(),
                CustomCollectionMarshallingCodeSnippets<CodeSnippets>.Stateless.ByValue<short>()
            };
            yield return new[]
            {
                ID(),
                CustomCollectionMarshallingCodeSnippets<CodeSnippets>.Stateless.ByValue<ushort>()
            };
            yield return new[]
            {
                ID(),
                CustomCollectionMarshallingCodeSnippets<CodeSnippets>.Stateless.ByValue<int>()
            };
            yield return new[]
            {
                ID(),
                CustomCollectionMarshallingCodeSnippets<CodeSnippets>.Stateless.ByValue<uint>()
            };
            yield return new[]
            {
                ID(),
                CustomCollectionMarshallingCodeSnippets<CodeSnippets>.Stateless.ByValue<long>()
            };
            yield return new[]
            {
                ID(),
                CustomCollectionMarshallingCodeSnippets<CodeSnippets>.Stateless.ByValue<ulong>()
            };
            yield return new[]
            {
                ID(),
                CustomCollectionMarshallingCodeSnippets<CodeSnippets>.Stateless.ByValue<float>()
            };
            yield return new[]
            {
                ID(),
                CustomCollectionMarshallingCodeSnippets<CodeSnippets>.Stateless.ByValue<double>()
            };
            yield return new[]
            {
                ID(),
                CustomCollectionMarshallingCodeSnippets<CodeSnippets>.Stateless.ByValue<IntPtr>()
            };
            yield return new[]
            {
                ID(),
                CustomCollectionMarshallingCodeSnippets<CodeSnippets>.Stateless.ByValue<UIntPtr>()
            };
            yield return new[]
            {
                ID(),
            ...
            {
                ID(),
                CustomCollectionMarshallingCodeSnippets<CodeSnippets>.Stateful.ByValue<byte>()
            };
            yield return new[]
            {
                ID(),
                CustomCollectionMarshallingCodeSnippets<CodeSnippets>.Stateful.ByValue<sbyte>()
            };
            yield return new[]
            {
                ID(),
                CustomCollectionMarshallingCodeSnippets<CodeSnippets>.Stateful.ByValue<short>()
            };
            yield return new[]
            {
                ID(),
                CustomCollectionMarshallingCodeSnippets<CodeSnippets>.Stateful.ByValue<ushort>()
            };
            yield return new[]
            {
                ID(),
                CustomCollectionMarshallingCodeSnippets<CodeSnippets>.Stateful.ByValue<int>()
            };
            yield return new[]
            {
                ID(),
                CustomCollectionMarshallingCodeSnippets<CodeSnippets>.Stateful.ByValue<uint>()
            };
            yield return new[]
            {
                ID(),
                CustomCollectionMarshallingCodeSnippets<CodeSnippets>.Stateful.ByValue<long>()
            };
            yield return new[]
            {
                ID(),
                CustomCollectionMarshallingCodeSnippets<CodeSnippets>.Stateful.ByValue<ulong>()
            };
            yield return new[]
            {
                ID(),
                CustomCollectionMarshallingCodeSnippets<CodeSnippets>.Stateful.ByValue<float>()
            };
            yield return new[]
            {
                ID(),
                CustomCollectionMarshallingCodeSnippets<CodeSnippets>.Stateful.ByValue<double>()
            };
            yield return new[]
            {
                ID(),
                CustomCollectionMarshallingCodeSnippets<CodeSnippets>.Stateful.ByValue<IntPtr>()
            };
            yield return new[]
            {
                ID(),
                CustomCollectionMarshallingCodeSnippets<CodeSnippets>.Stateful.ByValue<UIntPtr>()
            };
            yield return new[]
            {
                ID(),
