...
namespace LibraryImportGenerator.UnitTests
{
    public class ByValueContentsMarshalling
    {
        public static IEnumerable<object[]> ByValueMarshalAttributeOnValueTypes()
        {
            ...
            {
                ID(),
                CodeSnippets.ByValueParameterWithModifier("string", In + " , " + MarshalUsingUtf16),
                InIsNotSupported,
            };
            yield return new object[]
            {
                ID(),
                CodeSnippets.ByValueParameterWithModifier(
                    "IntStruct",
                    In,
            ...
            {
                ID(),
                CodeSnippets.ByValueParameterWithModifier("int", InOut),
                InOutIsNotSupported,
            };
            yield return new object[]
            {
                ID(),
                CodeSnippets.ByValueParameterWithModifier("byte", InOut),
                InOutIsNotSupported,
            };
            yield return new object[]
            {
            ...
            var inAndOutNotAllowedWithRefKind = new DiagnosticResult(
                GeneratorDiagnostics.ParameterTypeNotSupportedWithDetails
            )
                .WithLocation(0)
                .WithArguments(
            ...
            {
                ID(),
                CodeSnippets.ByValueParameterWithModifier("ref int", InOut),
                InAndOutNotAllowedWithRefKind,
            };
            yield return new object[]
            {
        ...
        public static IEnumerable<object[]> ByValueMarshalAttributeOnArrays()
        {
            ...
            const string Out = "OutAttribute";
            const string InOut = "InAttribute, OutAttribute";
            const string MarshalUsingUtf16 =
            ...
            {
                ID(),
                CodeSnippets.ByValueParameterWithModifier("int[]", string.Join(',', Count, In)),
                None,
            };
            yield return new object[]
            {
                ID(),
                CodeSnippets.ByValueParameterWithModifier("byte[]", string.Join(',', Count, In)),
                None,
            };
            yield return new object[]
            {
                ...
                CodeSnippets.ByValueParameterWithModifier(
                    "string[]",
                    string.Join(',', Count, In, MarshalUsingUtf16)
                ),
                None,
            };
            yield return new object[]
            ...
            {
                ID(),
                CodeSnippets.ByValueParameterWithModifier("int[]", string.Join(',', Count, Out)),
                None,
            };
            yield return new object[]
            {
                ID(),
                CodeSnippets.ByValueParameterWithModifier("byte[]", string.Join(',', Count, Out)),
                None,
            };
            yield return new object[]
            {
                ...
                CodeSnippets.ByValueParameterWithModifier(
                    "string[]",
                    string.Join(',', Count, Out, MarshalUsingUtf16)
                ),
                None,
            };
            yield return new object[]
            ...
            {
                ID(),
                CodeSnippets.ByValueParameterWithModifier("int[]", string.Join(',', Count, InOut)),
                None,
            };
            yield return new object[]
            {
                ID(),
                CodeSnippets.ByValueParameterWithModifier("byte[]", string.Join(',', Count, InOut)),
                None,
            };
            yield return new object[]
            {
                ...
                CodeSnippets.ByValueParameterWithModifier(
                    "string[]",
                    string.Join(',', Count, InOut, MarshalUsingUtf16)
                ),
                None,
            };
            yield return new object[]
            ...
            DiagnosticResult preferAttributes = new DiagnosticResult(
            ...
            {
                ID(),
                CodeSnippets.ByValueParameterWithModifier("int[]", Count),
                PreferAttributes,
            };
            yield return new object[]
            {
                ID(),
                CodeSnippets.ByValueParameterWithModifier("byte[]", Count),
                PreferAttributes,
            };
            yield return new object[]
            {
                ...
                CodeSnippets.ByValueParameterWithModifier(
                    "string[]",
                    string.Join(',', Count, MarshalUsingUtf16)
                ),
                PreferAttributes,
            };
            yield return new object[]
            ...
            {
                ID(),
                CodeSnippets.ByValueParameterWithModifier("in int[]", string.Join(',', Count, In)),
                InAndOutNotAllowedWithRefKind,
            };
            yield return new object[]
            {
                ID(),
                CodeSnippets.ByValueParameterWithModifier("ref int[]", string.Join(',', Count, In)),
                InAndOutNotAllowedWithRefKind,
            };
            yield return new object[]
            {
