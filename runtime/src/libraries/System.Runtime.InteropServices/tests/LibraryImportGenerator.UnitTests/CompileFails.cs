...
namespace LibraryImportGenerator.UnitTests
{
    public class CompileFails
    {
        ...
        public static IEnumerable<object[]> CodeSnippetsToCompile()
        {
            ...
            {
                ID(),
                CodeSnippets.UserDefinedPrefixedAttributes,
            ...
            {
                ID(),
                CodeSnippets.BasicParametersAndModifiers<char>(),
                new[]
                {
                    VerifyCS
            ...
            {
                ID(),
                CodeSnippets.BasicParametersAndModifiers<string>(),
                new[]
                {
                    VerifyCS
                        .Diagnostic(GeneratorDiagnostics.ReturnTypeNotSupportedWithDetails)
            ...
            {
                ID(),
                CodeSnippets.MarshalAsArrayParametersAndModifiers<char>(),
                new[]
                {
                    VerifyCS
                        .Diagnostic(GeneratorDiagnostics.ReturnTypeNotSupportedWithDetails)
            ...
            {
                ID(),
                CodeSnippets.MarshalAsArrayParametersAndModifiers<string>(),
                new[]
                {
                    VerifyCS
                        .Diagnostic(GeneratorDiagnostics.ReturnTypeNotSupportedWithDetails)
            ...
            {
                ID(),
                CodeSnippets.BasicParametersAndModifiers<bool>(),
                new[]
                {
                    VerifyCS
                        .Diagnostic(GeneratorDiagnostics.ReturnTypeNotSupportedWithDetails)
            ...
            {
                ID(),
                CodeSnippets.MarshalAsArrayParametersAndModifiers<bool>(),
                new[]
                {
                    VerifyCS
                        .Diagnostic(GeneratorDiagnostics.ReturnTypeNotSupportedWithDetails)
            ...
            yield return new object[]
            {
                ...
                new[]
                {
                    VerifyCS
                        ...
                        .WithLocation(1)
                        .WithArguments(
                            "Marshalling char with 'StringMarshalling.Utf8' is not supported. Instead, manually convert the char type to the desired byte representation and pass to the source-generated P/Invoke.",
                            "Method"
                        ),
                    VerifyCS
                        .Diagnostic(GeneratorDiagnostics.ParameterTypeNotSupportedWithDetails)
            ...
            {
                ID(),
                CodeSnippets.CustomStringMarshallingParametersAndModifiers<char>(),
                new[]
                {
                    VerifyCS
                        .Diagnostic(GeneratorDiagnostics.ReturnTypeNotSupportedWithDetails)
            ...
            {
                ID(),
                CodeSnippets.MarshalAsParametersAndModifiers<char>(UnmanagedType.I1),
                new[]
                {
                    VerifyCS
                        .Diagnostic(GeneratorDiagnostics.ReturnConfigurationNotSupported)
                        .WithLocation(0)
                        .WithArguments("MarshalAsAttribute", "Method"),
                    VerifyCS
                        .Diagnostic(GeneratorDiagnostics.ParameterConfigurationNotSupported)
                        .WithLocation(1)
            ...
            {
                ID(),
                CodeSnippets.MarshalAsParametersAndModifiers<char>(UnmanagedType.U1),
                new[]
                {
                    VerifyCS
                        .Diagnostic(GeneratorDiagnostics.ReturnConfigurationNotSupported)
            ...
            {
                ID(),
                CodeSnippets.MarshalAsParametersAndModifiers<int[]>(UnmanagedType.SafeArray),
                new[]
                {
                    VerifyCS
            ...
            {
                ID(),
                CodeSnippets.MarshalAsCustomMarshalerOnTypes,
                new[]
                {
                    VerifyCS
                        .Diagnostic(GeneratorDiagnostics.ConfigurationValueNotSupported)
            ...
            {
                ID(),
                CodeSnippets.LCIDConversionAttribute,
                new[]
                {
                    VerifyCS
                        .Diagnostic(GeneratorDiagnostics.ConfigurationNotSupported)
            ...
            {
                ID(),
                CodeSnippets.BasicParametersAndModifiers<byte[]>(
            ...
            {
                ID(),
                CodeSnippets.BasicParametersAndModifiers<sbyte[]>(
                    CodeSnippets.DisableRuntimeMarshalling
                ),
                new[]
                {
            ...
            {
                ID(),
                CodeSnippets.BasicParametersAndModifiers<short[]>(
                    CodeSnippets.DisableRuntimeMarshalling
                ),
                new[]
                {
            ...
            {
                ID(),
                CodeSnippets.BasicParametersAndModifiers<ushort[]>(
                    CodeSnippets.DisableRuntimeMarshalling
                ),
                new[]
                {
            ...
            {
                ID(),
                CodeSnippets.BasicParametersAndModifiers<uint[]>(
                    CodeSnippets.DisableRuntimeMarshalling
                ),
                new[]
                {
            ...
            {
                ID(),
                CodeSnippets.BasicParametersAndModifiers<long[]>(
                    CodeSnippets.DisableRuntimeMarshalling
                ),
                new[]
                {
            ...
            {
                ID(),
                CodeSnippets.BasicParametersAndModifiers<ulong[]>(
                    CodeSnippets.DisableRuntimeMarshalling
                ),
                new[]
                {
            ...
            {
                ID(),
                CodeSnippets.BasicParametersAndModifiers<float[]>(
                    CodeSnippets.DisableRuntimeMarshalling
                ),
                new[]
                {
            ...
            {
                ID(),
                CodeSnippets.BasicParametersAndModifiers<double[]>(
                    CodeSnippets.DisableRuntimeMarshalling
                ),
                new[]
                {
            ...
            {
                ID(),
                CodeSnippets.BasicParametersAndModifiers<IntPtr[]>(
                    CodeSnippets.DisableRuntimeMarshalling
                ),
                new[]
                {
            ...
            {
                ID(),
                CodeSnippets.BasicParametersAndModifiers<UIntPtr[]>(
                    CodeSnippets.DisableRuntimeMarshalling
                ),
                new[]
                {
            ...
            {
                ID(),
                CodeSnippets.MarshalAsArrayParameterWithSizeParam<float>(isByRef: false),
                new[]
                {
                    VerifyCS
                        .Diagnostic(GeneratorDiagnostics.ParameterTypeNotSupportedWithDetails)
            ...
            {
                ID(),
                CodeSnippets.MarshalAsArrayParameterWithSizeParam<double>(isByRef: false),
                new[]
                {
                    VerifyCS
                        .Diagnostic(GeneratorDiagnostics.ParameterTypeNotSupportedWithDetails)
            ...
            {
                ID(),
                CodeSnippets.MarshalAsArrayParameterWithSizeParam<bool>(isByRef: false),
                new[]
                {
                    VerifyCS
                        .Diagnostic(GeneratorDiagnostics.ParameterTypeNotSupportedWithDetails)
            ...
            {
                ID(),
                CodeSnippets.MarshalAsArrayParameterWithSizeParam<float>(isByRef: true),
                new[]
                {
                    VerifyCS
                        .Diagnostic(GeneratorDiagnostics.ParameterTypeNotSupportedWithDetails)
            ...
            {
                ID(),
                CodeSnippets.MarshalAsArrayParameterWithSizeParam<double>(isByRef: true),
                new[]
                {
                    VerifyCS
                        .Diagnostic(GeneratorDiagnostics.ParameterTypeNotSupportedWithDetails)
            ...
            {
                ID(),
                CodeSnippets.MarshalAsArrayParameterWithSizeParam<bool>(isByRef: true),
                new[]
                {
                    VerifyCS
                        .Diagnostic(GeneratorDiagnostics.ParameterTypeNotSupportedWithDetails)
            ...
            {
                ID(),
                customStructMarshallingCodeSnippets.NonStaticMarshallerEntryPoint,
                new[]
                {
                    VerifyCS
                        .Diagnostic(GeneratorDiagnostics.ParameterTypeNotSupported)
                    ...
                    VerifyCS
                        ...
                        .WithArguments(
                            string.Format(
                                SR.MarshallerTypeMustBeStaticClassOrStruct,
                                "Marshaller",
                                "S"
                            )
                        ),
            ...
            {
                ID(),
                customStructMarshallingCodeSnippets.Stateless.ManagedToNativeOnlyOutParameter,
                new[]
                {
                    VerifyCS
                        .Diagnostic(GeneratorDiagnostics.ParameterTypeNotSupportedWithDetails)
                        .WithLocation(0)
                        .WithArguments(
                            "The specified parameter needs to be marshalled from unmanaged to managed, but the marshaller type 'global::Marshaller' does not support it.",
                            "p"
                        ),
                },
            };
            ...
            {
                ID(),
                customStructMarshallingCodeSnippets.Stateless.ManagedToNativeOnlyReturnValue,
                new[]
                {
                    VerifyCS
                        .Diagnostic(GeneratorDiagnostics.ReturnTypeNotSupportedWithDetails)
            ...
            yield return new object[]
            {
                ...
                new[]
                {
                    VerifyCS
                        ...
                        .WithLocation(0)
                        .WithArguments(
                            "The specified parameter needs to be marshalled from managed to unmanaged, but the marshaller type 'global::Marshaller' does not support it.",
                            "p"
                        ),
                },
            };
            ...
            {
                ID(),
                customStructMarshallingCodeSnippets.Stateless.StackallocOnlyRefParameter,
                new[]
                {
                    VerifyCS
                        .Diagnostic(GeneratorDiagnostics.ParameterTypeNotSupportedWithDetails)
                        .WithLocation(0)
                        .WithArguments(
                            "The specified parameter needs to be marshalled from managed to unmanaged and unmanaged to managed, but the marshaller type 'global::Marshaller' does not support it.",
                            "p"
                        ),
                },
            };
            ...
            {
                ID(),
                CodeSnippets.BasicParameterWithByRefModifier(
                    "ref",
                ...
                new[]
                {
                    VerifyCS
                        ...
                        .WithLocation(0)
                        .WithArguments(
                            "The specified parameter needs to be marshalled from managed to unmanaged and unmanaged to managed, but the marshaller type 'global::System.Runtime.InteropServices.Marshalling.SafeHandleMarshaller<global::System.Runtime.InteropServices.SafeHandle>' does not support it.",
                            "p"
                        ),
                },
            };
            ...
            {
                ID(),
                CodeSnippets.MarshalAsArrayParametersAndModifiers(
                ...
                new[]
                {
                    VerifyCS
                        ...
                        .WithLocation(0)
                        .WithArguments(
                            "The specified parameter needs to be marshalled from unmanaged to managed, but the marshaller type 'global::System.Runtime.InteropServices.Marshalling.SafeHandleMarshaller<global::Microsoft.Win32.SafeHandles.SafeFileHandle>' does not support it.",
                            "Method"
                        ),
                    VerifyCS
                        .Diagnostic(GeneratorDiagnostics.ParameterTypeNotSupportedWithDetails)
                        .WithLocation(1)
                        .WithArguments(
                            "The specified parameter needs to be marshalled from managed to unmanaged, but the marshaller type 'global::System.Runtime.InteropServices.Marshalling.SafeHandleMarshaller<global::Microsoft.Win32.SafeHandles.SafeFileHandle>' does not support it.",
                            "p"
                        ),
                    VerifyCS
                        .Diagnostic(GeneratorDiagnostics.ParameterTypeNotSupportedWithDetails)
                    ...
                    VerifyCS
                        ...
                        .WithLocation(4)
                        .WithArguments(
                            "The specified parameter needs to be marshalled from managed to unmanaged and unmanaged to managed, but the marshaller type 'global::System.Runtime.InteropServices.Marshalling.SafeHandleMarshaller<global::Microsoft.Win32.SafeHandles.SafeFileHandle>' does not support it.",
                            "pRef"
                        ),
                    VerifyCS
                        .Diagnostic(GeneratorDiagnostics.ParameterTypeNotSupportedWithDetails)
            ...
            yield return new object[]
            {
                ...
                new[]
                {
                    VerifyCS
                        ...
                        .WithLocation(0)
                        .WithArguments(
                            "The specified parameter needs to be marshalled from unmanaged to managed, but the marshaller type 'global::System.Runtime.InteropServices.Marshalling.SafeHandleMarshaller<global::MySafeHandle>' does not support it.",
                            "Method"
                        ),
                    VerifyCS
                        .Diagnostic(GeneratorDiagnostics.ParameterTypeNotSupportedWithDetails)
                        .WithLocation(3)
                        .WithArguments(
                            "The specified parameter needs to be marshalled from managed to unmanaged and unmanaged to managed, but the marshaller type 'global::System.Runtime.InteropServices.Marshalling.SafeHandleMarshaller<global::MySafeHandle>' does not support it.",
                            "pRef"
                        ),
                    VerifyCS
                        .Diagnostic(GeneratorDiagnostics.ParameterTypeNotSupportedWithDetails)
            ...
            {
                ID(),
                CodeSnippets.MarshalUsingCollectionWithConstantAndElementCount,
                new[]
                {
                    VerifyCS
                        .Diagnostic(
            ...
            {
                ID(),
                CodeSnippets.MarshalUsingCollectionWithNullElementName,
                new[]
                {
                    VerifyCS
                        .Diagnostic(GeneratorDiagnostics.ConfigurationValueNotSupported)
            ...
            yield return new object[]
            {
                ...
                new[]
                {
                    ...
                    VerifyCS
                        ...
                        .WithArguments(
                            string.Format(
                                SR.MarshallerEntryPointTypeMustMatchArity,
                                "Marshaller<T, U, TUnmanagedElement>",
                                "TestCollection<T>"
                            )
                        ),
                },
            ...
            {
                ID(),
                CodeSnippets.MarshalAsAndMarshalUsingOnReturnValue,
                new[]
                {
                    VerifyCS
                        .Diagnostic(
            ...
            {
                ID(),
                CodeSnippets.CustomElementMarshallingDuplicateElementIndirectionDepth,
                new[]
                {
                    VerifyCS
                        .Diagnostic(
            ...
            {
                ID(),
                CodeSnippets.CustomElementMarshallingUnusedElementIndirectionDepth,
                new[]
                {
                    VerifyCS
                        .Diagnostic(
            ...
            {
                ID(),
                CodeSnippets.RecursiveCountElementNameOnReturnValue,
                new[]
                {
                    VerifyCS
                        .Diagnostic(
            ...
            {
                ID(),
                CodeSnippets.RecursiveCountElementNameOnParameter,
                new[]
                {
                    VerifyCS
                        .Diagnostic(
            ...
            {
                ID(),
                CodeSnippets.MutuallyRecursiveCountElementNameOnParameter,
                new[]
                {
                    VerifyCS
                        .Diagnostic(
            ...
            {
                ID(),
                CodeSnippets.MutuallyRecursiveSizeParamIndexOnParameter,
                new[]
                {
                    VerifyCS
                        .Diagnostic(
