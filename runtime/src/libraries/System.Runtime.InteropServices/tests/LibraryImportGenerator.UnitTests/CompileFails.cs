...
namespace LibraryImportGenerator.UnitTests
{
    public class CompileFails
    {
        ...
        public static IEnumerable<object[]> CodeSnippetsToCompile()
        {
            ...
            {
                ID(),
                CustomStructMarshallingCodeSnippets<CodeSnippets>.NonStaticMarshallerEntryPoint,
                2,
                0
            };
            yield return new object[]
            {
                ...
                CustomStructMarshallingCodeSnippets<CodeSnippets>
                    .Stateless
                    .ManagedToNativeOnlyOutParameter,
                1,
                0
            };
            yield return new object[]
            {
                ...
                CustomStructMarshallingCodeSnippets<CodeSnippets>
                    .Stateless
                    .ManagedToNativeOnlyReturnValue,
                1,
                0
            };
            yield return new object[]
            {
                ...
                CustomStructMarshallingCodeSnippets<CodeSnippets>
                    .Stateless
                    .NativeToManagedOnlyInParameter,
                1,
                0
            };
            yield return new object[]
