    ...
    public class CustomMarshallerAttributeAnalyzerTests_StatefulValueShapeValidation
    {
        ...
        public async Task ModeThatUsesManagedToUnmanagedShape_Missing_AllMethods_ReportsDiagnostic()
        {
            ...
            await CustomMarshallerAttributeFixerTest.VerifyCodeFixAsync(
                ...
                VerifyCS
                    ...
                    .WithLocation(1),
                VerifyCS
                    .DiagnosticWithArguments(StatefulMarshallerRequiresFreeRule, "MarshallerType")
                    .WithLocation(0),
                VerifyCS
                    .DiagnosticWithArguments(StatefulMarshallerRequiresFreeRule, "MarshallerType")
                    .WithLocation(1)
        ...
        public async Task Overloaded_FromUnmanaged_ReportsDiagnostic()
        {
            ...
            await VerifyCS.VerifyAnalyzerAsync(
                source,
                VerifyCS
                    .Diagnostic(FromUnmanagedOverloadsNotSupportedRule)
                    .WithLocation(0)
        ...
        public async Task ModeThatUsesBidirectionalShape_MismatchedUnmanagedTypes_ReportsDiagnostic()
        {
            ...
            await VerifyCS.VerifyAnalyzerAsync(
                ...
                VerifyCS
                    ...
                    .WithLocation(0)
                    .WithArguments(
                        "MarshallerType.FromUnmanaged(float)",
                        "MarshallerType.ToUnmanaged()"
                    ),
                VerifyCS
                    .Diagnostic(FirstParameterMustMatchReturnTypeRule)
                    .WithLocation(1)
        ...
        public async Task ModeThatUsesElementMode_ReportsDiagnostic()
        {
            ...
            await VerifyCS.VerifyAnalyzerAsync(
                source,
                VerifyCS
                    .Diagnostic(ElementMarshallerCannotBeStatefulRule)
                    .WithLocation(0)
                    .WithArguments("MarshallerType", MarshalMode.ElementIn),
                VerifyCS
                    .Diagnostic(ElementMarshallerCannotBeStatefulRule)
                    .WithLocation(1)
                    .WithArguments("MarshallerType", MarshalMode.ElementRef),
                VerifyCS
                    .Diagnostic(ElementMarshallerCannotBeStatefulRule)
                    .WithLocation(2)
                    .WithArguments("MarshallerType", MarshalMode.ElementOut)
            );
        }
        ...
        public async Task DefaultMode_Missing_AllMethods_ReportsDiagnostic()
        {
            ...
            await CustomMarshallerAttributeFixerTest.VerifyCodeFixAsync(
                ...
                fixedSource,
                VerifyCS
                    .Diagnostic(StatefulMarshallerRequiresFreeRule)
                    .WithLocation(0)
                    .WithArguments("MarshallerType"),
                VerifyCS
                    .DiagnosticWithArguments(
