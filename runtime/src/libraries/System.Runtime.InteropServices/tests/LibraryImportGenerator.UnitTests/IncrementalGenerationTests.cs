    ...
    public class IncrementalGenerationTests
    {
        ...
        public async Task AddingNewUnrelatedType_DoesNotRegenerateSource()
        {
            ...
            GeneratorDriver driver = TestUtils.CreateDriver(
                ...
                EnableIncrementalTrackingDriverOptions
            );
        ...
        public async Task ReplacingFileWithNewLibraryImport_DoesNotRegenerateStubsInOtherFiles()
        {
            ...
            Compilation comp2 = comp1.ReplaceSyntaxTree(
                ...
                CSharpSyntaxTree.ParseText(
                    RemoveTestMarkup(CodeSnippets.BasicParametersAndModifiers<ulong>()),
                    new CSharpParseOptions(LanguageVersion.Preview)
                )
            );
            GeneratorDriver driver2 = driver.RunGenerators(comp2);
        ...
        {
            string stubSource = RemoveTestMarkup(
        ...
        public async Task ChangingMarshallingAttributes_SameStrategy_DoesNotRegenerate()
        {
            ...
            SyntaxTree newTree = syntaxTree.WithRootAndOptions(
                SyntaxFactory.ParseCompilationUnit(
                    RemoveTestMarkup(
                        CodeSnippets.MarshalAsParametersAndModifiers<int>(
        ...
        )
        {
            ...
            var (reference, driver) = RunTwoGeneratorOnTwoIterativeCompilationsAndReturnFirst(
                comp1
            );
            ...
            ) RunTwoGeneratorOnTwoIterativeCompilationsAndReturnFirst(
                Compilation startingCompilation
            )
            {
                Compilation comp2 = startingCompilation.AddSyntaxTrees(
                    CSharpSyntaxTree.ParseText(
                        "struct NewType {}",
                        new CSharpParseOptions(LanguageVersion.Preview)
                    )
                ...
                Compilation comp3 = comp2.AddSyntaxTrees(
                    CSharpSyntaxTree.ParseText(
                        "struct NewType2 {}",
                        new CSharpParseOptions(LanguageVersion.Preview)
                    )
