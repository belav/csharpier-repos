    ...
    public class CustomMarshallerAttributeAnalyzerTests_StatelessLinearCollectionShapeValidation
    {
        ...
        public async Task ModeThatUsesManagedToUnmanagedShape_Missing_ContainerMethods_ReportsDiagnostic()
        {
            ...
            await CustomMarshallerAttributeFixerTest.VerifyCodeFixAsync(
                ...
                fixedSource,
                VerifyCS
                    .Diagnostic(StatelessLinearCollectionInRequiresCollectionMethodsRule)
                    .WithLocation(0)
                    .WithArguments(
                        "MarshallerType<T>",
                        MarshalMode.ManagedToUnmanagedIn,
                ...
                VerifyCS
                    .Diagnostic(StatelessLinearCollectionInRequiresCollectionMethodsRule)
                    .WithLocation(2)
                    .WithArguments("MarshallerType<T>", MarshalMode.ElementIn, "ManagedType")
            );
        }
        ...
        public async Task ModeThatUsesManagedToUnmanagedShape_MismatchedUnmanagedType_ReportsDiagnostic()
        {
            ...
            await VerifyCS.VerifyAnalyzerAsync(
                ...
                VerifyCS
                    ...
                    .WithLocation(0)
                    .WithArguments(
                        "MarshallerType<T>.GetUnmanagedValuesDestination(int, int)",
                        "MarshallerType<T>.AllocateContainerForUnmanagedElements(ManagedType, out int)"
                    ),
                VerifyCS
                    .Diagnostic(FirstParameterMustMatchReturnTypeRule)
                    .WithLocation(1)
        ...
        public async Task ModeThatUsesManagedToUnmanagedShape_InvalidCollectionElementType_ReportsDiagnostic()
        {
            ...
            await VerifyCS.VerifyAnalyzerAsync(
                source,
                VerifyCS
                    .Diagnostic(ReturnTypeMustBeExpectedTypeRule)
                    .WithLocation(0)
                    .WithArguments(
                        "MarshallerType<T>.GetUnmanagedValuesDestination(nint, int)",
                        "System.Span<T>"
                    ),
                VerifyCS
                    .Diagnostic(ReturnTypeMustBeExpectedTypeRule)
        ...
        public async Task ModeThatUsesUnmanagedToManagedShape_Missing_ContainerMethods_ReportsDiagnostic()
        {
            ...
            await CustomMarshallerAttributeFixerTest.VerifyCodeFixAsync(
                ...
                fixedSource,
                VerifyCS
                    .Diagnostic(StatelessLinearCollectionOutRequiresCollectionMethodsRule)
                    .WithLocation(0)
                    .WithArguments(
                        "MarshallerType<T>",
                        MarshalMode.ManagedToUnmanagedOut,
                ...
                VerifyCS
                    .Diagnostic(StatelessLinearCollectionOutRequiresCollectionMethodsRule)
                    .WithLocation(2)
                    .WithArguments("MarshallerType<T>", MarshalMode.ElementOut, "ManagedType")
            );
        }
        ...
        public async Task ModeThatUsesUnmanagedToManagedShape_MismatchedUnmanagedType_ReportsDiagnostic()
        {
            ...
            await VerifyCS.VerifyAnalyzerAsync(
                source,
                VerifyCS
                    .Diagnostic(FirstParametersMustMatchRule)
                    .WithLocation(0)
                    .WithArguments(
                        "MarshallerType<T>.GetUnmanagedValuesSource(int, int)",
                        "MarshallerType<T>.AllocateContainerForManagedElements(nint, out int)"
                    ),
                VerifyCS
                    .Diagnostic(FirstParametersMustMatchRule)
                    .WithLocation(1)
        ...
        public async Task ModeThatUsesUnmanagedToManagedShape_InvalidCollectionElementType_ReportsDiagnostic()
        {
            ...
            await VerifyCS.VerifyAnalyzerAsync(
                ...
                VerifyCS
                    ...
                    .WithLocation(0)
                    .WithArguments(
                        "MarshallerType<T>.GetUnmanagedValuesSource(nint, int)",
        ...
        public async Task CallerAllocatedBuffer_NoBufferSize_ReportsDiagnostic()
        {
            ...
            await CustomMarshallerAttributeFixerTest.VerifyCodeFixAsync(
                ...
                VerifyCS
                    ...
                    .WithLocation(0)
                    .WithArguments("MarshallerType<T>", "byte")
            );
        }
        ...
        public async Task ModeThatUsesBidirectionalShape_MismatchedManagedElementTypes_ReportsDiagnostic()
        {
            ...
            await VerifyCS.VerifyAnalyzerAsync(
                source,
                VerifyCS
                    .Diagnostic(ElementTypesOfReturnTypesMustMatchRule)
                    .WithLocation(0)
                    .WithArguments(
                        "MarshallerType<T>.GetManagedValuesSource(ManagedType)",
                        "MarshallerType<T>.GetManagedValuesDestination(ManagedType)"
                    ),
                VerifyCS
                    .Diagnostic(ElementTypesOfReturnTypesMustMatchRule)
                    .WithLocation(1)
