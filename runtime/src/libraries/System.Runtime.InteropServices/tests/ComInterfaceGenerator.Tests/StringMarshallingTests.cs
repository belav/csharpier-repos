...
namespace ComInterfaceGenerator.Tests
{
    public unsafe partial class StringMarshallingTests
    {
        ...
        [LibraryImport(
            ...
            EntryPoint = "new_utf16_marshalling"
        )]
        public static partial void* NewIUtf16Marshalling();

        [LibraryImport(
            NativeExportsNE.NativeExportsNE_Binary,
            EntryPoint = "new_string_marshalling_override"
        )]
        ...
        public void ValidateStringMarshallingRCW()
        {
            ...
            IUTF8Marshalling obj8 = (IUTF8Marshalling)
                cw.GetOrCreateObjectForComInstance((nint)utf8, CreateObjectFlags.None);
            ...
            IUTF16Marshalling obj16 = (IUTF16Marshalling)
                cw.GetOrCreateObjectForComInstance((nint)utf16, CreateObjectFlags.None);
            ...
            ICustomStringMarshallingUtf16 objCustom = (ICustomStringMarshallingUtf16)
                cw.GetOrCreateObjectForComInstance((nint)utf16custom, CreateObjectFlags.None);
        ...
        public void RcwToCcw()
        {
            ...
            var utf8ComInstance = cw.GetOrCreateComInterfaceForObject(
                utf8,
                CreateComInterfaceFlags.None
            );
            var utf8ComObject = (IUTF8Marshalling)
                cw.GetOrCreateObjectForComInstance(utf8ComInstance, CreateObjectFlags.None);
            ...
            var utf16ComInstance = cw.GetOrCreateComInterfaceForObject(
                utf16,
                CreateComInterfaceFlags.None
            );
            var utf16ComObject = (IUTF16Marshalling)
                cw.GetOrCreateObjectForComInstance(utf16ComInstance, CreateObjectFlags.None);
            ...
            var customUtf16ComInstance = cw.GetOrCreateComInterfaceForObject(
                customUtf16,
                CreateComInterfaceFlags.None
            );
            var customUtf16ComObject = (ICustomStringMarshallingUtf16)
                cw.GetOrCreateObjectForComInstance(customUtf16ComInstance, CreateObjectFlags.None);
        ...
        public void MarshalAsAndMarshalUsingOverrideStringMarshalling()
        {
            ...
            Assert.Equal(
                "Your string: MyUtf8String",
                stringMarshallingOverride.StringMarshallingUtf8("MyUtf8String")
            );
            Assert.Equal(
                "Your string: MyLPWStrString",
                stringMarshallingOverride.MarshalAsLPWString("MyLPWStrString")
            );
            Assert.Equal(
                "Your string: MyUtf16String",
                stringMarshallingOverride.MarshalUsingUtf16("MyUtf16String")
            );
            ...
            Assert.Equal(
                "Your string: MyUtf8String",
                stringMarshallingOverrideDerived.StringMarshallingUtf8("MyUtf8String")
            );
            Assert.Equal(
                "Your string: MyLPWStrString",
                stringMarshallingOverrideDerived.MarshalAsLPWString("MyLPWStrString")
            );
            Assert.Equal(
                "Your string: MyUtf16String",
                stringMarshallingOverrideDerived.MarshalUsingUtf16("MyUtf16String")
            );
            Assert.Equal(
                "Your string 2: MyUtf8String",
                stringMarshallingOverrideDerived.StringMarshallingUtf8_2("MyUtf8String")
            );
            Assert.Equal(
                "Your string 2: MyLPWStrString",
                stringMarshallingOverrideDerived.MarshalAsLPWString_2("MyLPWStrString")
            );
            Assert.Equal(
                "Your string 2: MyUtf16String",
                stringMarshallingOverrideDerived.MarshalUsingUtf16_2("MyUtf16String")
            );
        }
    }
}
