...
namespace System.Runtime.InteropServices.Tests
{
    public partial class GetNativeVariantForObjectTests
    {
        ...
        public static IEnumerable<object[]> GetNativeVariantForObject_ComObjectArray_TestData()
        {
            ...
            {
                new ComImportObject[] { empty, null },
                (VarEnum.VT_ARRAY | VarEnum.VT_UNKNOWN),
                new object[] { empty, null },
            };
            ...
            yield return new object[]
            {
                new NonDualComObjectEmpty[] { nonDualEmpty, null },
                (VarEnum.VT_ARRAY | VarEnum.VT_UNKNOWN),
                new object[] { nonDualEmpty, null },
            };
            yield return new object[]
            {
                new AutoDispatchComObjectEmpty[] { autoDispatchEmpty, null },
                (VarEnum.VT_ARRAY | VarEnum.VT_UNKNOWN),
                new object[] { autoDispatchEmpty, null },
            };
            yield return new object[]
            {
                new AutoDualComObjectEmpty[] { autoDualEmpty, null },
                (VarEnum.VT_ARRAY | VarEnum.VT_UNKNOWN),
                new object[] { autoDualEmpty, null },
            };
        }
        ...
        public void GetNativeVariantForObject_ComObjectArray_Success(
            object obj,
        ...
        public static IEnumerable<object[]> GetNativeVariantForObject_WrappedComObject_TestData()
        {
            ...
            yield return new object[]
            {
                new UnknownWrapper(iUnknown),
                iUnknown,
                VarEnum.VT_UNKNOWN,
            };
            yield return new object[]
            {
                new UnknownWrapper(iDispatch),
                iDispatch,
                VarEnum.VT_UNKNOWN,
            };
            yield return new object[]
            {
                new UnknownWrapper(iInspectable),
                iInspectable,
                VarEnum.VT_UNKNOWN,
            };
            ...
            yield return new object[]
            {
                new UnknownWrapper(autoDispatch),
                autoDispatch,
                VarEnum.VT_UNKNOWN,
            };
            yield return new object[]
            {
                new UnknownWrapper(autoDual),
                autoDual,
                VarEnum.VT_UNKNOWN,
            };
            ...
            yield return new object[]
            {
                new DispatchWrapper(iUnknown),
                iUnknown,
                VarEnum.VT_DISPATCH,
            };
            yield return new object[]
            {
                new DispatchWrapper(iDispatch),
                iDispatch,
                VarEnum.VT_DISPATCH,
            };
            yield return new object[]
            {
                new DispatchWrapper(iInspectable),
                iInspectable,
                VarEnum.VT_DISPATCH,
            };
            yield return new object[]
            {
                new DispatchWrapper(nonDual),
                nonDual,
                VarEnum.VT_DISPATCH,
            };
            yield return new object[]
            {
                new DispatchWrapper(autoDispatch),
                autoDispatch,
                VarEnum.VT_DISPATCH,
            };
            yield return new object[]
            {
                new DispatchWrapper(autoDual),
                autoDual,
                VarEnum.VT_DISPATCH,
            };
        }
        ...
        public static IEnumerable<object[]> GetNativeVariantForObject_InvalidArrayType_TestData()
        {
            ...
            yield return new object[]
            {
                new IDispatchComObject[] { new IDispatchComObject(), null },
            };
            yield return new object[] { new NonDualComObject[] { new NonDualComObject(), null } };
            yield return new object[]
            {
                new AutoDispatchComObject[] { new AutoDispatchComObject(), null },
            };
