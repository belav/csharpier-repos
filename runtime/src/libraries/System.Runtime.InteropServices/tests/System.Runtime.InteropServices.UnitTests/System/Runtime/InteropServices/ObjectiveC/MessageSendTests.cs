...
namespace System.Runtime.InteropServices.Tests
{
    ...
    public unsafe class MessageSendTests
    {
        ...
        private static IntPtr ObjCMsgSend(IntPtr inst, IntPtr sel) =>
            ReturnPtr(MessageSendFunction.MsgSend);

        [UnmanagedCallersOnly]
        private static IntPtr ObjCMsgSendFpret(IntPtr inst, IntPtr sel) =>
            ReturnPtr(MessageSendFunction.MsgSendFpret);

        [UnmanagedCallersOnly]
        private static void ObjCMsgSendStret(IntPtr* ret, IntPtr inst, IntPtr sel) =>
            *ret = ReturnPtr(MessageSendFunction.MsgSendStret);

        [UnmanagedCallersOnly]
        private static IntPtr ObjCMsgSendSuper(IntPtr inst, IntPtr sel) =>
            ReturnPtr(MessageSendFunction.MsgSendSuper);

        [UnmanagedCallersOnly]
        private static void ObjCMsgSendSuperStret(IntPtr* ret, IntPtr inst, IntPtr sel) =>
            *ret = ReturnPtr(MessageSendFunction.MsgSendSuperStret);
        ...
        private static (MessageSendFunction MsgSend, IntPtr Func)[] msgSendOverrides =
        {
            (
                ...
                (IntPtr)(delegate* unmanaged<IntPtr, IntPtr, IntPtr>)&ObjCMsgSend
            ),
            (
                MessageSendFunction.MsgSendFpret,
                (IntPtr)(delegate* unmanaged<IntPtr, IntPtr, IntPtr>)&ObjCMsgSendFpret
            ),
            (
                MessageSendFunction.MsgSendStret,
                (IntPtr)(delegate* unmanaged<IntPtr*, IntPtr, IntPtr, void>)&ObjCMsgSendStret
            ),
            (
                MessageSendFunction.MsgSendSuper,
                (IntPtr)(delegate* unmanaged<IntPtr, IntPtr, IntPtr>)&ObjCMsgSendSuper
            ),
            (
                MessageSendFunction.MsgSendSuperStret,
                (IntPtr)(delegate* unmanaged<IntPtr*, IntPtr, IntPtr, void>)&ObjCMsgSendSuperStret
            ),
        };
        ...
        public void SetMessageSendCallback(MessageSendFunction[] funcsToOverride)
        {
            ...
            RemoteExecutor
                .Invoke(
                    (string funcsToOverrideAsStr) =>
                    {
                        string[] msgSendStrArray = funcsToOverrideAsStr.Split(';');
                        MessageSendFunction[] msgSendArray = new MessageSendFunction[
                            msgSendStrArray.Length
                        ];
        ...
        private static void SetMessageSendCallbackImpl(MessageSendFunction[] funcsToOverride)
        {
            foreach (var (msgSend, func) in msgSendOverrides)
            {
                ...
                {
                    if (
                        msgSend == MessageSendFunction.MsgSendSuper
