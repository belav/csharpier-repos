...
namespace System.Runtime.InteropServices.Tests
{
    public class NFloatTests_GenericMath
    {
        ...
        {
            Assert.False(
                ComparisonOperatorsHelper<NFloat, NFloat>.op_GreaterThan(
                    NFloat.NegativeInfinity,
                    One
                )
            );
            Assert.False(
                ComparisonOperatorsHelper<NFloat, NFloat>.op_GreaterThan(NFloat.MinValue, One)
            );
            Assert.False(
                ComparisonOperatorsHelper<NFloat, NFloat>.op_GreaterThan(NegativeOne, One)
            );
            Assert.False(ComparisonOperatorsHelper<NFloat, NFloat>.op_GreaterThan(-MinNormal, One));
            Assert.False(
                ComparisonOperatorsHelper<NFloat, NFloat>.op_GreaterThan(-MaxSubnormal, One)
            );
            Assert.False(
                ComparisonOperatorsHelper<NFloat, NFloat>.op_GreaterThan(-NFloat.Epsilon, One)
            );
            Assert.False(
                ComparisonOperatorsHelper<NFloat, NFloat>.op_GreaterThan(NegativeZero, One)
            );
            ...
            Assert.True(
                ComparisonOperatorsHelper<NFloat, NFloat>.op_GreaterThan(NFloat.MaxValue, One)
            );
            Assert.True(
                ComparisonOperatorsHelper<NFloat, NFloat>.op_GreaterThan(
                    NFloat.PositiveInfinity,
        ...
        {
            Assert.False(
                ComparisonOperatorsHelper<NFloat, NFloat>.op_GreaterThanOrEqual(
                    NFloat.NegativeInfinity,
                    One
                )
            );
            ...
            Assert.False(
                ComparisonOperatorsHelper<NFloat, NFloat>.op_GreaterThanOrEqual(NegativeOne, One)
            );
            Assert.False(
                ComparisonOperatorsHelper<NFloat, NFloat>.op_GreaterThanOrEqual(-MinNormal, One)
            );
            Assert.False(
                ComparisonOperatorsHelper<NFloat, NFloat>.op_GreaterThanOrEqual(-MaxSubnormal, One)
            );
            Assert.False(
                ComparisonOperatorsHelper<NFloat, NFloat>.op_GreaterThanOrEqual(
                    -NFloat.Epsilon,
            ...
            Assert.False(
                ComparisonOperatorsHelper<NFloat, NFloat>.op_GreaterThanOrEqual(NegativeZero, One)
            );
            Assert.False(
                ComparisonOperatorsHelper<NFloat, NFloat>.op_GreaterThanOrEqual(NFloat.NaN, One)
            );
            Assert.False(
                ComparisonOperatorsHelper<NFloat, NFloat>.op_GreaterThanOrEqual(Zero, One)
            );
            Assert.False(
                ComparisonOperatorsHelper<NFloat, NFloat>.op_GreaterThanOrEqual(NFloat.Epsilon, One)
            );
            Assert.False(
                ComparisonOperatorsHelper<NFloat, NFloat>.op_GreaterThanOrEqual(MaxSubnormal, One)
            );
        ...
        {
            Assert.True(
                ComparisonOperatorsHelper<NFloat, NFloat>.op_LessThan(NFloat.NegativeInfinity, One)
            );
            Assert.True(
                ComparisonOperatorsHelper<NFloat, NFloat>.op_LessThan(NFloat.MinValue, One)
            );
            ...
            Assert.True(
                ComparisonOperatorsHelper<NFloat, NFloat>.op_LessThan(-NFloat.Epsilon, One)
            );
            ...
            Assert.False(
                ComparisonOperatorsHelper<NFloat, NFloat>.op_LessThan(NFloat.MaxValue, One)
            );
            Assert.False(
                ComparisonOperatorsHelper<NFloat, NFloat>.op_LessThan(NFloat.PositiveInfinity, One)
            );
        }
        ...
        {
            Assert.True(
                ComparisonOperatorsHelper<NFloat, NFloat>.op_LessThanOrEqual(
                    NFloat.NegativeInfinity,
                    One
                )
            );
            Assert.True(
                ComparisonOperatorsHelper<NFloat, NFloat>.op_LessThanOrEqual(NFloat.MinValue, One)
            );
            Assert.True(
                ComparisonOperatorsHelper<NFloat, NFloat>.op_LessThanOrEqual(NegativeOne, One)
            );
            Assert.True(
                ComparisonOperatorsHelper<NFloat, NFloat>.op_LessThanOrEqual(-MinNormal, One)
            );
            Assert.True(
                ComparisonOperatorsHelper<NFloat, NFloat>.op_LessThanOrEqual(-MaxSubnormal, One)
            );
            Assert.True(
                ComparisonOperatorsHelper<NFloat, NFloat>.op_LessThanOrEqual(-NFloat.Epsilon, One)
            );
            Assert.True(
                ComparisonOperatorsHelper<NFloat, NFloat>.op_LessThanOrEqual(NegativeZero, One)
            );
            Assert.False(
                ComparisonOperatorsHelper<NFloat, NFloat>.op_LessThanOrEqual(NFloat.NaN, One)
            );
            ...
            Assert.False(
                ComparisonOperatorsHelper<NFloat, NFloat>.op_LessThanOrEqual(NFloat.MaxValue, One)
            );
            Assert.False(
                ComparisonOperatorsHelper<NFloat, NFloat>.op_LessThanOrEqual(
                    NFloat.PositiveInfinity,
        ...
        {
            Assert.False(
                EqualityOperatorsHelper<NFloat, NFloat>.op_Equality(NFloat.NegativeInfinity, One)
            );
            ...
            Assert.False(
                EqualityOperatorsHelper<NFloat, NFloat>.op_Equality(NFloat.PositiveInfinity, One)
            );
        }
        ...
        {
            Assert.True(
                EqualityOperatorsHelper<NFloat, NFloat>.op_Inequality(NFloat.NegativeInfinity, One)
            );
            Assert.True(
                EqualityOperatorsHelper<NFloat, NFloat>.op_Inequality(NFloat.MinValue, One)
            );
            ...
            Assert.True(
                EqualityOperatorsHelper<NFloat, NFloat>.op_Inequality(-NFloat.Epsilon, One)
            );
            ...
            Assert.True(
                EqualityOperatorsHelper<NFloat, NFloat>.op_Inequality(NFloat.MaxValue, One)
            );
            Assert.True(
                EqualityOperatorsHelper<NFloat, NFloat>.op_Inequality(NFloat.PositiveInfinity, One)
            );
        }
