...
#pragma warning restore xUnit2000
        ...
        public static void MaxMagnitudeNumberTest64(double x, double y, double expectedResult)
        {
            AssertExtensions.Equal(
                expectedResult,
                NFloat.MaxMagnitudeNumber((NFloat)x, (NFloat)y),
                0.0
            );
        }
        ...
        public static void MinMagnitudeNumberTest64(double x, double y, double expectedResult)
        {
            AssertExtensions.Equal(
                expectedResult,
                NFloat.MinMagnitudeNumber((NFloat)x, (NFloat)y),
                0.0
            );
        }
        ...
        public static void Atan2PiTest32(
            float y,
            float x,
        ...
        [InlineData(
            ...
            CrossPlatformMachineEpsilon64 / 1000
        )] // value: -(pi)
        [InlineData(
            -2.7182818284590452,
            0.0019130141022243176,
            CrossPlatformMachineEpsilon64 / 100
        )] // value: -(e)
        [InlineData(
            -2.3025850929940457,
        ...
        [InlineData(double.PositiveInfinity, double.PositiveInfinity, 0.0)]
        public static void Exp10M1Test64(
            double value,
        ...
        [InlineData(double.PositiveInfinity, double.PositiveInfinity, 0.0)]
        public static void Log10P1Test64(
            double value,
            double expectedResult,
            double allowedVariance
        )
        ...
        [InlineData(
            ...
            0.31830988618379067,
            2.7368553638387594,
            CrossPlatformMachineEpsilon64 * 10
        )] // x: (e)   y: (1 / pi)
        [InlineData(
            2.7182818284590452,
            0.43429448190325183,
        ...
        )
        {
            AssertExtensions.Equal(
                expectedResult,
                NFloat.Hypot((NFloat)(-x), (NFloat)(-y)),
                allowedVariance
            );
            AssertExtensions.Equal(
                expectedResult,
            ...
            AssertExtensions.Equal(
                expectedResult,
                NFloat.Hypot((NFloat)(-y), (NFloat)(-x)),
                allowedVariance
            );
            AssertExtensions.Equal(
                expectedResult,
        ...
        )
        {
            AssertExtensions.Equal(
                -expectedResult,
                NFloat.Atan2Pi((NFloat)(-y), (NFloat)(+x)),
                allowedVariance
            );
            AssertExtensions.Equal(
                +expectedResult,
        ...
        )
        {
            AssertExtensions.Equal(
                +expectedResult,
                (float)NFloat.Lerp(+value1, +value2, amount),
                0
            );
            AssertExtensions.Equal(
                (expectedResult == 0.0f) ? expectedResult : -expectedResult,
                (float)NFloat.Lerp(-value1, -value2, amount),
                0
            );
        }
        ...
        )
        {
            AssertExtensions.Equal(
                +expectedResult,
                NFloat.Lerp((NFloat)(+value1), (NFloat)(+value2), (NFloat)(amount)),
                0
            );
            AssertExtensions.Equal(
                (expectedResult == 0.0) ? expectedResult : -expectedResult,
                NFloat.Lerp((NFloat)(-value1), (NFloat)(-value2), (NFloat)(amount)),
                0
            );
        }
        ...
        [InlineData(float.PositiveInfinity, float.PositiveInfinity, 0.0f)]
        public static void DegreesToRadiansTest32(
            float value,
            float expectedResult,
            float allowedVariance
        )
        {
            AssertExtensions.Equal(
                -expectedResult,
                (float)NFloat.DegreesToRadians(-value),
                allowedVariance
            );
            AssertExtensions.Equal(
                +expectedResult,
        ...
        [InlineData(double.PositiveInfinity, double.PositiveInfinity, 0.0)]
        public static void DegreesToRadiansTest64(
            double value,
            double expectedResult,
            double allowedVariance
        )
        {
            AssertExtensions.Equal(
                -expectedResult,
                NFloat.DegreesToRadians((NFloat)(-value)),
                allowedVariance
            );
            AssertExtensions.Equal(
                +expectedResult,
        ...
        [InlineData(float.PositiveInfinity, float.PositiveInfinity, 0.0)]
        public static void RadiansToDegreesTest32(
            float value,
            float expectedResult,
            float allowedVariance
        )
        {
            AssertExtensions.Equal(
                -expectedResult,
                (float)NFloat.RadiansToDegrees(-value),
                allowedVariance
            );
            AssertExtensions.Equal(
                +expectedResult,
        ...
        [InlineData(double.PositiveInfinity, double.PositiveInfinity, 0.0)]
        public static void RadiansToDegreesTest64(
            double value,
            double expectedResult,
            double allowedVariance
        )
        {
            AssertExtensions.Equal(
                -expectedResult,
                NFloat.RadiansToDegrees((NFloat)(-value)),
                allowedVariance
            );
            AssertExtensions.Equal(
                +expectedResult,
