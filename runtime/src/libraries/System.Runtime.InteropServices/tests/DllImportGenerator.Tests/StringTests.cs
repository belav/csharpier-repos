...
namespace DllImportGenerator.IntegrationTests
{
    partial class NativeExportsNE
    {
        ...
        partial public class LPTStr
        {
            ...
            partial public static int ReturnLength_IgnoreCharSet(
