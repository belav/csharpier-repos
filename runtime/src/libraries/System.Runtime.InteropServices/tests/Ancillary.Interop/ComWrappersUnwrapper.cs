...
// Types that are only needed for the VTable source generator or to provide abstract concepts that
// the COM generator would use under the hood.
...
namespace System.Runtime.InteropServices.Marshalling
{
    ...
    // If we decide to not expose the VTable source generator, we don't need to expose this and we can
