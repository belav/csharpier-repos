...
{
    /// <summary>
    /// A factory to create an unmanaged "this pointer" from a managed object and to get a managed
    // object from an unmanaged "this pointer".
    /// </summary>
    /// <remarks>
    /// This interface would be used by the VTable source generator to enable users to indicate how to
    // get the managed object from the "this pointer".
