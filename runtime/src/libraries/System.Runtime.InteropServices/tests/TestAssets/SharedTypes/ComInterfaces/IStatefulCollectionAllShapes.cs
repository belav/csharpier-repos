...
namespace SharedTypes.ComInterfaces
{
    ...
    internal partial interface IStatefulCollectionAllShapes
    {
        void Method(
            [MarshalUsing(CountElementName = nameof(size))]
                StatefulCollectionAllShapes<StatelessType> param,
            int size
        );
        void MethodIn(
            [MarshalUsing(CountElementName = nameof(size))]
                in StatefulCollectionAllShapes<StatelessType> param,
            int size
        );
        void MethodOut(
            [MarshalUsing(CountElementName = nameof(size))]
                out StatefulCollectionAllShapes<StatelessType> param,
            out int size
        );
        void MethodRef(
            [MarshalUsing(CountElementName = nameof(size))]
                ref StatefulCollectionAllShapes<StatelessType> param,
            int size
        );
    ...
    [CustomMarshaller(
        typeof(StatefulCollectionAllShapes<>),
        MarshalMode.Default,
        typeof(StatefulCollectionAllShapesMarshaller<,>)
    )]
    internal unsafe struct StatefulCollectionAllShapesMarshaller<TManagedElement, TUnmanagedElement>
        where TUnmanagedElement : unmanaged
    {
        ...
        // ManagedToUnmanaged
        public void FromManaged(StatefulCollectionAllShapes<TManagedElement> collection) =>
        ...
        public static ref TUnmanagedElement* GetPinnableReference(
            StatefulCollectionAllShapes<TManagedElement> collection
        ) => throw new NotImplementedException();
        ...
        public ReadOnlySpan<TUnmanagedElement> GetUnmanagedValuesSource(int numElements) =>
            throw new NotImplementedException(); // Can throw exceptions.

        public Span<TManagedElement> GetManagedValuesDestination(int numElements) =>
            throw new NotImplementedException(); // Can throw exceptions.

        public StatefulCollectionAllShapes<TManagedElement> ToManaged() =>
            throw new NotImplementedException(); // Can throw exceptions

        public void Free() { }

        // UnmanagedToManaged with guaranteed unmarshalling
        public StatefulCollectionAllShapes<TManagedElement> ToManagedFinally() =>
            throw new NotImplementedException();
    }
}
