...
namespace SharedTypes.ComInterfaces
{
    ...
    {
        void Method(
            [MarshalUsing(CountElementName = nameof(size))] StatelessPinnedType param,
            int size
        );
        void MethodIn(
            [MarshalUsing(CountElementName = nameof(size))] in StatelessPinnedType param,
            int size
        );
        void MethodOut(
            [MarshalUsing(CountElementName = nameof(size))] out StatelessPinnedType param,
            int size
        );
        void MethodRef(
            [MarshalUsing(CountElementName = nameof(size))] ref StatelessPinnedType param,
            int size
        );
    ...
    {
        public void Method(
            [MarshalUsing(CountElementName = "size")] StatelessPinnedType param,
            int size
        ) { }

        public void MethodIn(
            [MarshalUsing(CountElementName = "size")] in StatelessPinnedType param,
            int size
        ) { }

        public void MethodOut(
            [MarshalUsing(CountElementName = "size")] out StatelessPinnedType param,
            int size
        )
        {
            param = new StatelessPinnedType { I = 42 };
        }

        public void MethodRef(
            [MarshalUsing(CountElementName = "size")] ref StatelessPinnedType param,
            int size
        )
        {
            param = new StatelessPinnedType { I = 200 };
        }
    ...
    [CustomMarshaller(
        typeof(StatelessPinnedType),
        MarshalMode.Default,
        typeof(StatelessPinnedTypeMarshaller)
    )]
    internal static class StatelessPinnedTypeMarshaller
    {
        ...
        public static StatelessPinnedType ConvertToManaged(nint unmanaged) =>
            new StatelessPinnedType { I = (int)unmanaged };
