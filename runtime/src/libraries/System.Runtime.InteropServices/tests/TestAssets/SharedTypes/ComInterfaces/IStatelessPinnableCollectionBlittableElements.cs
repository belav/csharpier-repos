...
namespace SharedTypes.ComInterfaces
{
    ...
    internal partial interface IStatelessPinnableCollectionBlittableElements
    {
        ...
        void MethodRef(
            [MarshalUsing(CountElementName = nameof(size))]
                ref StatelessPinnableCollection<int> pRef,
            int size
        );

        void MethodOut(
            [MarshalUsing(CountElementName = nameof(size))]
                out StatelessPinnableCollection<int> pOut,
            out int size
        );
    ...
    internal class StatelessPinnableCollection<T>
        where T : unmanaged { }

    internal unsafe struct StatelessPinnableCollectionNative<T>
        where T : unmanaged
    {
        public static explicit operator StatelessPinnableCollectionNative<T>(void* ptr) =>
            new StatelessPinnableCollectionNative<T>();

        public static explicit operator void*(StatelessPinnableCollectionNative<T> ptr) =>
            (void*)null;
    }

    [ContiguousCollectionMarshaller]
    [CustomMarshaller(
        typeof(StatelessPinnableCollection<>),
        MarshalMode.ManagedToUnmanagedIn,
        typeof(StatelessPinnableCollectionMarshaller<,>.ManagedToUnmanaged)
    )]
    [CustomMarshaller(
        typeof(StatelessPinnableCollection<>),
    ...
    [CustomMarshaller(
        ...
        typeof(StatelessPinnableCollectionMarshaller<,>.UnmanagedToManaged)
    )]
    [CustomMarshaller(
        typeof(StatelessPinnableCollection<>),
    ...
    [CustomMarshaller(
        ...
        typeof(StatelessPinnableCollectionMarshaller<,>.Bidirectional)
    )]
    [CustomMarshaller(
        typeof(StatelessPinnableCollection<>),
        ...
        where TUnmanagedElement : unmanaged
    {
        ...
        {
            public static StatelessPinnableCollectionNative<T> AllocateContainerForUnmanagedElements(
                StatelessPinnableCollection<T> managed,
                out int numElements
            )
            {
            ...
            public static StatelessPinnableCollection<T> AllocateContainerForManagedElements(
                StatelessPinnableCollectionNative<T> unmanaged,
                int numElements
            )
            {
                throw new NotImplementedException();
            ...
            public static ref StatelessPinnableCollectionNative<T> GetPinnableReference(
                StatelessPinnableCollection<T> managed
            )
            {
                throw new NotImplementedException();
