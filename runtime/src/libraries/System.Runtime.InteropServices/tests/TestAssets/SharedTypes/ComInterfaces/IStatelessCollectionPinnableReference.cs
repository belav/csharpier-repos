...
namespace SharedTypes.ComInterfaces
{
    ...
    internal partial interface IStatelessCollectionPinnableReference
    {
        void Method(
            [MarshalUsing(CountElementName = nameof(size))]
                StatelessCollectionPinnableReference<int> p,
            int size
        );

        void MethodIn(
            [MarshalUsing(CountElementName = nameof(size))]
                in StatelessCollectionPinnableReference<int> pIn,
            in int size
        );

        void MethodRef(
            [MarshalUsing(CountElementName = nameof(size))]
                ref StatelessCollectionPinnableReference<int> pRef,
            int size
        );

        void MethodOut(
            [MarshalUsing(CountElementName = nameof(size))]
                out StatelessCollectionPinnableReference<int> pOut,
            out int size
        );
    ...
    internal struct StatelessCollectionPinnableReferenceNative
    {
        public static unsafe explicit operator void*(
            StatelessCollectionPinnableReferenceNative _
    ...
    [CustomMarshaller(
        ...
        typeof(StatelessCollectionPinnableReferenceMarshaller<,>.Bidirectional)
    )]
    [CustomMarshaller(
        typeof(StatelessCollectionPinnableReference<>),
    ...
    [CustomMarshaller(
        ...
        typeof(StatelessCollectionPinnableReferenceMarshaller<,>.UnmanagedToManaged)
    )]
    [CustomMarshaller(
        typeof(StatelessCollectionPinnableReference<>),
    ...
    [CustomMarshaller(
        ...
        typeof(StatelessCollectionPinnableReferenceMarshaller<,>.ManagedToUnmanaged)
    )]
    [CustomMarshaller(
        typeof(StatelessCollectionPinnableReference<>),
    ...
    internal static class StatelessCollectionPinnableReferenceMarshaller<T, TUnmanaged>
        where TUnmanaged : unmanaged
    {
        public static class Bidirectional
        {
            public static ref StatelessCollectionPinnableReferenceNative GetPinnableReference(
                StatelessCollectionPinnableReference<T> managed
            ) => throw new NotImplementedException();

            public static StatelessCollectionPinnableReferenceNative AllocateContainerForUnmanagedElements(
                StatelessCollectionPinnableReference<T> managed,
                out int numElements
            ) => throw new NotImplementedException();

            public static StatelessCollectionPinnableReference<T> AllocateContainerForManagedElements(
                StatelessCollectionPinnableReferenceNative unmanaged,
                int numElements
            ) => throw new NotImplementedException();
            ...
            public static Span<TUnmanaged> GetUnmanagedValuesDestination(
                StatelessCollectionPinnableReferenceNative unmanaged,
                int numElements
            ) => throw new NotImplementedException();

            public static ReadOnlySpan<TUnmanaged> GetUnmanagedValuesSource(
                StatelessCollectionPinnableReferenceNative unmanaged,
                int numElements
            ) => throw new NotImplementedException();
