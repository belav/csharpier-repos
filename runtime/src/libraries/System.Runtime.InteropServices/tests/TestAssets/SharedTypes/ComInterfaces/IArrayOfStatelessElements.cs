...
namespace SharedTypes.ComInterfaces
{
    ...
    {
        void Method(
            [MarshalUsing(CountElementName = nameof(size))] StatelessType[] param,
            int size
        );
        void MethodIn(
            [MarshalUsing(CountElementName = nameof(size))] in StatelessType[] param,
            int size
        );
        void MethodOut(
            [MarshalUsing(CountElementName = nameof(size))] out StatelessType[] param,
            int size
        );
        void MethodRef(
            [MarshalUsing(CountElementName = nameof(size))] ref StatelessType[] param,
            int size
        );
        void MethodContentsIn(
            [MarshalUsing(CountElementName = nameof(size))] [In] StatelessType[] param,
            int size
        );
        void MethodContentsOut(
            [MarshalUsing(CountElementName = nameof(size))] [Out] StatelessType[] param,
            int size
        );
        void MethodContentsInOut(
            [MarshalUsing(CountElementName = nameof(size))] [In, Out] StatelessType[] param,
            int size
        );
    }
    ...
    {
        public void Method(StatelessType[] param, int size) =>
            throw new ManagedComMethodFailureException();
