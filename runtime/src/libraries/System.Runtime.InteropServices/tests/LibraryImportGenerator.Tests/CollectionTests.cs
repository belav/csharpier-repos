...
namespace LibraryImportGenerator.IntegrationTests
{
    ...
    public class CollectionTests
    {
            ...
            Assert.Throws<Exception>(
                () =>
                    NativeExportsNE
                        .Collections
                        .Stateless
                        .GuaranteedUnmarshal(out List<BoolStruct> _)
            );
            Assert.True(
                NativeExportsNE
                    .Collections
        ...
        public void ElementsFreed()
        {
            ...
            Assert.Equal(
                startingCount + list.Count,
                IntWrapperMarshallerWithFreeCounts.NumCallsToFree
            );
