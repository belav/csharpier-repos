...
namespace ComInterfaceGenerator.Unit.Tests
{
    ...
    {
        private static IComInterfaceAttributeProvider GetAttributeProvider(
        ...
        public static IEnumerable<object[]> ByValueMarshalAttributeOnValueTypes()
        {
            var codeSnippets = new CodeSnippets(
                GetAttributeProvider(GeneratorKind.ComInterfaceGenerator)
            );
        ...
        public static IEnumerable<object[]> ByValueMarshalAttributeOnPinnedMarshalledTypes()
        {
            ...
            const string MarshalAsBoolArray =
                "[MarshalAs(UnmanagedType.LPArray, ArraySubType = UnmanagedType.U1, SizeConst = 10)]";
            const string MarshalUsingIntMarshaller =
                "[MarshalUsing(typeof(IntMarshaller), ElementIndirectionDepth = 1)]";
            const string MarshalUsingIntStructMarshaller =
                "[MarshalUsing(typeof(IntStructMarshaller), ElementIndirectionDepth = 1)]";
            const string MarshalUsingIntClassMarshaller =
                "[MarshalUsing(typeof(IntClassMarshaller), ElementIndirectionDepth = 1)]";
            ...
            yield return new object[]
            {
                ID(),
                codeSnippets.ByValueMarshallingOfType(
                    In + MarshalUsingIntMarshaller + Count,
                    "int[]",
                    p
            ...
            yield return new object[]
            {
                ID(),
                codeSnippets.ByValueMarshallingOfType(
                    In + Count + MarshalUsingIntStructMarshaller,
                    "IntStruct[]",
                    p
                ) + CodeSnippets.IntStructAndMarshaller,
                None,
            ...
            yield return new object[]
            {
                ID(),
                codeSnippets.ByValueMarshallingOfType(
                    In + Count + MarshalUsingIntClassMarshaller,
                    "IntClass[]",
                    p
                ) + CodeSnippets.IntClassAndMarshaller,
                None,
            ...
            yield return new object[]
            {
                ID(),
                codeSnippets.ByValueMarshallingOfType(
                    In + Out + MarshalUsingIntMarshaller + Count,
                    "int[]",
                    p
                ) + CodeSnippets.IntMarshaller,
                None,
            ...
            yield return new object[]
            {
                ID(),
                codeSnippets.ByValueMarshallingOfType(
                    In + Out + Count + MarshalUsingIntStructMarshaller,
                    "IntStruct[]",
                    p
                ) + CodeSnippets.IntStructAndMarshaller,
                None,
            ...
            yield return new object[]
            {
                ID(),
                codeSnippets.ByValueMarshallingOfType(
                    In + Out + Count + MarshalUsingIntClassMarshaller,
                    "IntClass[]",
                    p
                ) + CodeSnippets.IntClassAndMarshaller,
                None,
            ...
            yield return new object[]
            {
                ID(),
                codeSnippets.ByValueMarshallingOfType(
                    Out + MarshalUsingIntMarshaller + Count,
                    "int[]",
                    p
                ) + CodeSnippets.IntMarshaller,
                None,
            ...
            yield return new object[]
            {
                ID(),
                codeSnippets.ByValueMarshallingOfType(
                    Out + Count + MarshalUsingIntStructMarshaller,
                    "IntStruct[]",
                    p
                ) + CodeSnippets.IntStructAndMarshaller,
                None,
            ...
            yield return new object[]
            {
                ID(),
                codeSnippets.ByValueMarshallingOfType(
                    Out + Count + MarshalUsingIntClassMarshaller,
                    "IntClass[]",
                    p
                ) + CodeSnippets.IntClassAndMarshaller,
                None,
            ...
            var preferExplicitAttributesDiagnostic = new DiagnosticResult(
            ...
            yield return new object[]
            {
                ID(),
                codeSnippets.ByValueMarshallingOfType(
                    Count + MarshalUsingIntStructMarshaller,
                    "IntStruct[]",
                    p
                ) + CodeSnippets.IntStructAndMarshaller,
                PreferInOutAttributes,
            ...
            yield return new object[]
            {
                ID(),
                codeSnippets.ByValueMarshallingOfType(
                    Count + MarshalUsingIntClassMarshaller,
                    "IntClass[]",
                    p
                ) + CodeSnippets.IntClassAndMarshaller,
                PreferInOutAttributes,
            ...
            yield return new object[]
            {
                ID(),
                codeSnippets.ByValueMarshallingOfType(
                    MarshalUsingIntMarshaller + Count,
                    "in int[]",
                    p
                ) + CodeSnippets.IntMarshaller,
                None,
        ...
        public static IEnumerable<object[]> ByValueMarshalAttributeOnCustomCollections()
        {
            ...
            {
                return codeSnippets.ByValueMarshallingOfType(
                        Attributes + MarshalCollection(),
                        CodeSnippets.GetCustomCollectionType(type),
                        p,
                        stringMarshalling
                    ) + CodeSnippets.CustomCollectionAndMarshaller;
            }
