    ...
    internal sealed class ComMethodContext : IEquatable<ComMethodContext>
    {
        ...
        private GeneratedMethodContextBase CreateManagedToUnmanagedStub()
        {
            ...
            var (methodStub, diagnostics) =
                VirtualMethodPointerStubGenerator.GenerateManagedToNativeStub(GenerationContext);
        ...
        private GeneratedMethodContextBase CreateUnmanagedToManagedStub()
        {
            ...
            var (methodStub, diagnostics) =
                VirtualMethodPointerStubGenerator.GenerateNativeToManagedStub(GenerationContext);
            return new GeneratedStubCodeContext(
