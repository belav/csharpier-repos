...
namespace Microsoft.Interop
{
    ...
    internal sealed class NativeToManagedThisMarshallerFactory : IMarshallingGeneratorFactory
    {
        ...
        public IMarshallingGenerator Create(TypePositionInfo info, StubCodeContext context) =>
            info.MarshallingAttributeInfo is NativeThisInfo(ManagedTypeInfo typeKeyType)
                ? new Marshaller(typeKeyType)
                        ...
                        InvocationExpression(
                            MemberAccessExpression(
                                ...
                                GenericName(
                                    ...
                                    TypeArgumentList(SingletonSeparatedList(_typeKeyType.Syntax))
                                ),
                                GenericName(
