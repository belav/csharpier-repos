...
namespace Microsoft.Interop
{
    ...
    public sealed class VtableIndexStubGenerator : IIncrementalGenerator
    {
        internal sealed record IncrementalStubGenerationContext(
            ...
            )> ManagedToUnmanagedGeneratorFactory,
            MarshallingGeneratorFactoryKey<(
                TargetFramework TargetFramework,
                Version TargetFrameworkVersion
            )> UnmanagedToManagedGeneratorFactory,
        ...
        public void Initialize(IncrementalGeneratorInitializationContext context)
        {
            ...
            var methodsToGenerate = methodsWithDiagnostics.Where(
                static data => data.Diagnostic is null
            );
            var invalidMethodDiagnostics = methodsWithDiagnostics.Where(
                static data => data.Diagnostic is not null
            );
            ...
            // for each method.
            IncrementalValuesProvider<IncrementalStubGenerationContext> generateStubInformation =
                methodsToGenerate
            ...
            IncrementalValuesProvider<(
                ...
                .Select(static (data, ct) => GenerateManagedToNativeStub(data))
            ...
            context.RegisterConcatenatedSyntaxOutputs(
                generateManagedToNativeStub.Select((data, ct) => data.Item1),
            ...
            IncrementalValuesProvider<(
                ...
                .Select(static (data, ct) => GenerateNativeToManagedStub(data))
                .WithComparer(Comparers.GeneratedSyntax)
            ...
            context.RegisterConcatenatedSyntaxOutputs(
                generateNativeToManagedStub.Select((data, ct) => data.Item1),
            ...
            IncrementalValuesProvider<MemberDeclarationSyntax> populateVTable =
                nativeToManagedStubContexts
                    .Collect()
                    .SelectMany(
                        static (data, ct) => data.GroupBy(stub => stub.ContainingSyntaxContext)
                    )
        ...
        private static ImmutableArray<FunctionPointerUnmanagedCallingConventionSyntax> GenerateCallConvSyntaxFromAttributes(
            AttributeData? suppressGCTransitionAttribute,
            AttributeData? unmanagedCallConvAttribute
        )
        {
            const string CallConvsField = "CallConvs";
            ImmutableArray<FunctionPointerUnmanagedCallingConventionSyntax>.Builder callingConventions =
                ImmutableArray.CreateBuilder<FunctionPointerUnmanagedCallingConventionSyntax>();

            if (suppressGCTransitionAttribute is not null)
            {
                callingConventions.Add(
                    FunctionPointerUnmanagedCallingConvention(Identifier("SuppressGCTransition"))
                );
            }
                ...
                )
                {
                    if (arg.Key == CallConvsField)
                    {
                        foreach (TypedConstant callConv in arg.Value.Values)
                        {
                            ...
                            if (
                                callConvSymbol.Name.StartsWith("CallConv", StringComparison.Ordinal)
                            )
                            {
                                callingConventions.Add(
                                    FunctionPointerUnmanagedCallingConvention(
                                        Identifier(callConvSymbol.Name.Substring("CallConv".Length))
                                    )
                                );
                            }
                        }
        ...
        private static VirtualMethodIndexData? ProcessVirtualMethodIndexAttribute(
        ...
        )
        {
            ...
            if (
                ...
                || attrData.ConstructorArguments[0].Value is not int
            )
            {
                return null;
            }
            ...
            if (
                namedArguments.TryGetValue(
                    nameof(VirtualMethodIndexData.Direction),
            ...
            if (
                namedArguments.TryGetValue(
                    nameof(VirtualMethodIndexData.ImplicitThisParameter),
            ...
            if (
                namedArguments.TryGetValue(
                    nameof(VirtualMethodIndexData.ExceptionMarshalling),
            ...
            if (
                namedArguments.TryGetValue(
                    nameof(VirtualMethodIndexData.ExceptionMarshallingCustomType),
            ...
            )
            {
                ...
                exceptionMarshallingCustomType = (INamedTypeSymbol)
                    exceptionMarshallingCustomTypeValue.Value;
            }

            return new VirtualMethodIndexData(
                (int)attrData.ConstructorArguments[0].Value
            ).WithValuesFromNamedArguments(namedArguments) with
            {
                Direction = direction,
        ...
        )
        {
            ...
            VirtualMethodIndexData? virtualMethodIndexData = ProcessVirtualMethodIndexAttribute(
            ...
            )
            {
                ...
                if (
                    ...
                    && virtualMethodIndexData.StringMarshallingCustomType is null
                )
                {
            ...
            if (
                !virtualMethodIndexData.ImplicitThisParameter
                && virtualMethodIndexData.Direction
                    is MarshalDirection.UnmanagedToManaged
                        or MarshalDirection.Bidirectional
            )
            {
            ...
            var methodSyntaxTemplate = new ContainingSyntax(
                syntax.Modifiers.StripTriviaFromTokens(),
            ...
            else
            {
                ...
                // second argument.
                typeKeyType = ManagedTypeInfo.CreateTypeInfoForTypeSymbol(
                    iUnmanagedInterfaceTypeInstantiation.TypeArguments[1]
                );
            }

            MarshallingInfo exceptionMarshallingInfo = CreateExceptionMarshallingInfo(
                virtualMethodIndexAttr,
                symbol,
            ...
            return new IncrementalStubGenerationContext(
                ...
                new SequenceEqualImmutableArray<FunctionPointerUnmanagedCallingConventionSyntax>(
                    callConv,
                    SyntaxEquivalentComparer.Instance
                ),
                virtualMethodIndexData,
                exceptionMarshallingInfo,
                ComInterfaceGeneratorHelpers.CreateGeneratorFactory(
                    environment,
                ...
                typeKeyType,
                typeKeyOwner,
                new SequenceEqualImmutableArray<Diagnostic>(
                    generatorDiagnostics.Diagnostics.ToImmutableArray()
                )
            );
        }

        private static MarshallingInfo CreateExceptionMarshallingInfo(
            AttributeData virtualMethodIndexAttr,
            ISymbol symbol,
            Compilation compilation,
            GeneratorDiagnostics diagnostics,
            VirtualMethodIndexData virtualMethodIndexData
        )
        {
            if (virtualMethodIndexData.ExceptionMarshallingDefined)
            {
                ...
                )
                {
                    diagnostics.ReportInvalidExceptionMarshallingConfiguration(
                        virtualMethodIndexAttr,
                        symbol.Name,
                        SR.InvalidExceptionMarshallingConfigurationMissingCustomType
                    );
                ...
                )
                {
                    diagnostics.ReportInvalidExceptionMarshallingConfiguration(
                        virtualMethodIndexAttr,
                        symbol.Name,
                        SR.InvalidExceptionMarshallingConfigurationNotCustom
                    );
                }
            }
            ...
            diagnostics.ReportInvalidExceptionMarshallingConfiguration(
                virtualMethodIndexAttr,
                symbol.Name,
                SR.InvalidExceptionMarshallingValue
            );
            return NoMarshallingInfo.Instance;
        }
        ...
        private static (
            MemberDeclarationSyntax,
            ImmutableArray<Diagnostic>
        ) GenerateManagedToNativeStub(IncrementalStubGenerationContext methodStub)
        {
        ...
        private static (
            MemberDeclarationSyntax,
            ImmutableArray<Diagnostic>
        ) GenerateNativeToManagedStub(IncrementalStubGenerationContext methodStub)
        {
            var diagnostics = new GeneratorDiagnostics();
            ...
            (ParameterListSyntax unmanagedParameterList, TypeSyntax returnType, _) =
            ...
            if (methodStub.CallingConvention.Array.Length != 0)
            {
                unmanagedCallersOnlyAttribute =
                    unmanagedCallersOnlyAttribute.AddArgumentListArguments(
                        AttributeArgument(
            ...
            MethodDeclarationSyntax unmanagedToManagedStub = MethodDeclaration(
                    returnType,
                    $"ABI_{methodStub.StubMethodSyntaxTemplate.Identifier.Text}"
                )
                .WithModifiers(
                ...
                .AddAttributeLists(
                    AttributeList(SingletonSeparatedList(unmanagedCallersOnlyAttribute))
                )
                .WithBody(code);
        ...
        private static ImmutableArray<TypePositionInfo> AddImplicitElementInfos(
        ...
        )
        {
            ...
            elements.Add(
                new TypePositionInfo(
                    methodStub.TypeKeyOwner,
                    new NativeThisInfo(methodStub.TypeKeyType)
                )
                {
                ...
                elements.Add(
                    new TypePositionInfo(
                        new ReferenceTypeInfo(
                            $"global::{TypeNames.System_Exception}",
        ...
        private static MemberDeclarationSyntax GenerateNativeInterfaceMetadata(
        ...
        private static MemberDeclarationSyntax GeneratePopulateVTableMethod(
            IGrouping<ContainingSyntaxContext, IncrementalStubGenerationContext> vtableMethods
        )
        {
                    ...
                    Parameter(Identifier(vtableParameter))
                        .WithType(
                            GenericName(TypeNames.System_Span)
                                .AddTypeArgumentListArguments(IdentifierName("nint"))
                        )
                );
            ...
            foreach (var method in vtableMethods)
            {
                ...
                FunctionPointerTypeSyntax functionPointerType = FunctionPointerType(
                    FunctionPointerCallingConvention(
                        ...
                        callConv.IsEmpty
                            ? null
                            : FunctionPointerUnmanagedCallingConventionList(SeparatedList(callConv))
                    ),
                ...
                populateVtableMethod = populateVtableMethod.AddBodyStatements(
                    ExpressionStatement(
                        AssignmentExpression(
                            ...
                            ElementAccessExpression(IdentifierName(vtableParameter))
                                .AddArgumentListArguments(
                                    Argument(
                                        LiteralExpression(
                                            SyntaxKind.NumericLiteralExpression,
                                            Literal(method.VtableIndexData.Index)
                                        )
                                    )
                                ),
                            CastExpression(
            ...
            return containingSyntax.WrapMemberInContainingSyntaxWithUnsafeModifier(
                populateVtableMethod
            );
        }
    }
}
