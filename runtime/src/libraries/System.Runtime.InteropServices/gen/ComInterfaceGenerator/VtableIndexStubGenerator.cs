...
namespace Microsoft.Interop
{
    ...
    public sealed class VtableIndexStubGenerator : IIncrementalGenerator
    {
        ...
        public void Initialize(IncrementalGeneratorInitializationContext context)
        {
            ...
            // for each method.
            IncrementalValuesProvider<IncrementalMethodStubGenerationContext> generateStubInformation =
                methodsToGenerate
        ...
        private static VirtualMethodIndexCompilationData? ProcessVirtualMethodIndexAttribute(
        ...
        )
        {
            ...
            if (
                namedArguments.TryGetValue(
                    nameof(VirtualMethodIndexCompilationData.Direction),
            ...
            if (
                namedArguments.TryGetValue(
                    nameof(VirtualMethodIndexCompilationData.ImplicitThisParameter),
            ...
            if (
                namedArguments.TryGetValue(
                    nameof(VirtualMethodIndexCompilationData.ExceptionMarshalling),
            ...
            if (
                namedArguments.TryGetValue(
                    nameof(VirtualMethodIndexCompilationData.ExceptionMarshallingCustomType),
            ...
            return new VirtualMethodIndexCompilationData(
        ...
        )
        {
            ...
            INamedTypeSymbol? lcidConversionAttrType = environment.Compilation
                .GetTypeByMetadataName(TypeNames.LCIDConversionAttribute);
            INamedTypeSymbol? suppressGCTransitionAttrType = environment.Compilation
                .GetTypeByMetadataName(TypeNames.SuppressGCTransitionAttribute);
            INamedTypeSymbol? unmanagedCallConvAttrType = environment.Compilation
                .GetTypeByMetadataName(TypeNames.UnmanagedCallConvAttribute);
            INamedTypeSymbol iUnmanagedInterfaceTypeType = environment.Compilation
            ...
            VirtualMethodIndexCompilationData? virtualMethodIndexData =
                ProcessVirtualMethodIndexAttribute(virtualMethodIndexAttr!);
            ...
            if (
                virtualMethodIndexData.IsUserDefined
            ...
            var methodSyntaxTemplate = new ContainingSyntax(
                syntax.Modifiers.StripAccessibilityModifiers(),
            ...
            ImmutableArray<FunctionPointerUnmanagedCallingConventionSyntax> callConv =
                VirtualMethodPointerStubGenerator.GenerateCallConvSyntaxFromAttributes(
                    suppressGCTransitionAttribute,
                    unmanagedCallConvAttribute,
                    defaultCallingConventions: ImmutableArray<FunctionPointerUnmanagedCallingConventionSyntax>.Empty
                );
            ...
            bool implementsIUnmanagedInterfaceOfSelf = symbol.ContainingType
                .AllInterfaces
                .Any(iface =>
            ...
            var unmanagedObjectUnwrapper = symbol.ContainingType
                .GetAttributes()
                .FirstOrDefault(att =>
            ...
            var unwrapperSyntax = ParseTypeName(
                unmanagedObjectUnwrapper.AttributeClass.TypeArguments[0].ToDisplayString()
            );
        ...
        private static (
            MemberDeclarationSyntax,
            ImmutableArray<DiagnosticInfo>
        ) GenerateManagedToNativeStub(IncrementalMethodStubGenerationContext methodStub)
        {
            var (stub, diagnostics) = VirtualMethodPointerStubGenerator.GenerateManagedToNativeStub(
                methodStub,
                VtableIndexStubGeneratorHelpers.GetGeneratorFactory
            );
        ...
        private static (
            MemberDeclarationSyntax,
            ImmutableArray<DiagnosticInfo>
        ) GenerateNativeToManagedStub(IncrementalMethodStubGenerationContext methodStub)
        {
            var (stub, diagnostics) = VirtualMethodPointerStubGenerator.GenerateNativeToManagedStub(
                methodStub,
                VtableIndexStubGeneratorHelpers.GetGeneratorFactory
            );
                ...
                InterfaceDeclaration("Native")
                    ...
                    .AddAttributeLists(
                        AttributeList(
                            SingletonSeparatedList(
                                Attribute(
                                    NameSyntaxes.System_Runtime_InteropServices_DynamicInterfaceCastableImplementationAttribute
                                )
                            )
                        )
                    )
        ...
        {
            ContainingSyntaxContext containingSyntax = vtableMethods.Key
                .AddContainingSyntax(NativeTypeContainingSyntax);
