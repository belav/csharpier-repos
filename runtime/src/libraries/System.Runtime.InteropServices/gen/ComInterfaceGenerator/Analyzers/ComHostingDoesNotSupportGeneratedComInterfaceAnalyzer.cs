...
namespace Microsoft.Interop.Analyzers
{
    ...
    public class ComHostingDoesNotSupportGeneratedComInterfaceAnalyzer : DiagnosticAnalyzer
    {
        public override ImmutableArray<DiagnosticDescriptor> SupportedDiagnostics =>
            ImmutableArray.Create(ComHostingDoesNotSupportGeneratedComInterface);
        ...
        public override void Initialize(AnalysisContext context)
        {
            ...
            context.RegisterCompilationStartAction(context =>
            {
                ...
                if (
                    generatedComClassAttribute is null
                    || generatedComInterfaceAttribute is null
                    || comVisibleAttribute is null
                )
                {
                    return;
                }
                ...
                context.RegisterOperationAction(
                    context =>
                    {
                        ...
                        if (
                            attr.Operation is not IObjectCreationOperation ctor
                            || !comVisibleAttribute.Equals(
                                ctor.Type,
                        ...
                        INamedTypeSymbol containingType = (INamedTypeSymbol)
