...
namespace Microsoft.Interop
{
    ...
    internal sealed record GeneratedComInterfaceData : InteropAttributeData
    {
        ...
        public static GeneratedComInterfaceData From(
            GeneratedComInterfaceCompilationData generatedComInterfaceAttr
        ) =>
            new GeneratedComInterfaceData() with
            {
                ...
                StringMarshallingCustomType = generatedComInterfaceAttr.StringMarshallingCustomType
                    is not null
    ...
    internal sealed record GeneratedComInterfaceCompilationData : InteropAttributeCompilationData
    {
        ...
        public static bool TryGetGeneratedComInterfaceAttributeFromInterface(
            ...
            [NotNullWhen(true)] out AttributeData? generatedComInterfaceAttribute
        )
        {
            ...
            {
                if (
                    generatedComInterfaceAttribute is null
        ...
        public static GeneratedComInterfaceCompilationData GetAttributeDataFromInterfaceSymbol(
            INamedTypeSymbol interfaceSymbol
        )
        {
            bool found = TryGetGeneratedComInterfaceAttributeFromInterface(
                interfaceSymbol,
                out var attr
            );
            Debug.Assert(found);
        ...
        public static GeneratedComInterfaceCompilationData GetDataFromAttribute(AttributeData attr)
        {
            ...
            generatedComInterfaceAttributeData =
                generatedComInterfaceAttributeData.WithValuesFromNamedArguments(args);
