...
{
    internal record DllImportGeneratorOptions(
    ...
    public static class OptionsHelper
    {
        public const string UseMarshalTypeOption =
            "build_property.DllImportGenerator_UseMarshalType";
        public const string GenerateForwardersOption =
            "build_property.DllImportGenerator_GenerateForwarders";
        public const string UseInternalUnsafeTypeOption =
            "build_property.DllImportGenerator_UseInternalUnsafeType";
        ...
        internal static bool UseInternalUnsafeType(this AnalyzerConfigOptions options) =>
            options.GetBoolOption(UseInternalUnsafeTypeOption);
    }
}
