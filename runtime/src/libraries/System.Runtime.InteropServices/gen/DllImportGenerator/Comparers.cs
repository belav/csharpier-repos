...
namespace Microsoft.Interop
{
    internal static class Comparers
    {
        ...
        public static readonly IEqualityComparer<(
            string,
            ImmutableArray<Diagnostic>
        )> GeneratedSource = new CustomValueTupleElementComparer<
            string,
            ImmutableArray<Diagnostic>
        >(
            EqualityComparer<string>.Default,
        ...
        public static readonly IEqualityComparer<(
            ...
            DllImportGenerator.IncrementalStubGenerationContext StubContext
        )> CalculatedContextWithSyntax = new CustomValueTupleElementComparer<
