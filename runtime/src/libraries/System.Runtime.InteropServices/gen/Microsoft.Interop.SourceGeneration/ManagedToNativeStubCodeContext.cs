...
namespace Microsoft.Interop
{
    public sealed record ManagedToNativeStubCodeContext : StubCodeContext
    {
        ...
        public override (string managed, string native) GetIdentifiers(TypePositionInfo info)
        {
            ...
            // We can't use ReturnIdentifier or ReturnNativeIdentifier since that will be used by the managed
            // return value.
            // Additionally, since all use cases today of a TypePositionInfo in the native position but not the
            // managed
            // are for infos that aren't in the managed signature at all (PreserveSig scenario), we don't have a
            // name
