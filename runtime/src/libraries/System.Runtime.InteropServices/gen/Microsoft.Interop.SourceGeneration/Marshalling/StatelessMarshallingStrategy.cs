...
namespace Microsoft.Interop
{
    ...
    internal sealed class StatelessValueMarshalling : ICustomTypeMarshallingStrategy
    {
        ...
        public StatelessValueMarshalling(
        ...
        {
            if (
                !_shape.HasFlag(MarshallerShape.ToUnmanaged)
            ...
            {
                var rewriter = new PointerNativeTypeAssignmentRewriter(
                    assignment.Right.ToString(),
                    (PointerTypeSyntax)pointer.Syntax
                );
    ...
    internal sealed class StatelessCallerAllocatedBufferMarshalling : ICustomTypeMarshallingStrategy
    {
        ...
        public StatelessCallerAllocatedBufferMarshalling(
            ICustomTypeMarshallingStrategy innerMarshaller,
            TypeSyntax marshallerType,
            TypeSyntax bufferElementType,
                ...
                yield return LocalDeclarationStatement(
                    VariableDeclaration(
                        GenericName(
                            ...
                            TypeArgumentList(SingletonSeparatedList(_bufferElementType))
                        ),
    ...
    internal sealed class StatelessFreeMarshalling : ICustomTypeMarshallingStrategy
    {
        ...
        public StatelessFreeMarshalling(
            ICustomTypeMarshallingStrategy innerMarshaller,
            TypeSyntax marshallerType
        )
        {
        ...
        )
        {
            ...
            foreach (
                StatementSyntax statement in _innerMarshaller.GenerateCleanupCallerAllocatedResourcesStatements(
                    info,
                    context
                )
            )
        ...
        )
        {
            ...
            foreach (
                StatementSyntax statement in _innerMarshaller.GenerateCleanupCalleeAllocatedResourcesStatements(
                    info,
                    context
                )
            )
    ...
    internal sealed class StatelessLinearCollectionSpaceAllocator : ICustomTypeMarshallingStrategy
    {
        ...
        public StatelessLinearCollectionSpaceAllocator(
            TypeSyntax marshallerTypeSyntax,
            ManagedTypeInfo unmanagedType,
            MarshallerShape shape,
        ...
        )
        {
            ...
            yield return LocalDeclarationStatement(
                VariableDeclaration(
                    ...
                    SingletonSeparatedList(VariableDeclarator(numElementsIdentifier))
                )
            );
    ...
    internal sealed class StatelessLinearCollectionMarshalling : ICustomTypeMarshallingStrategy
    {
        ...
        )
        {
            ...
            StatementSyntax elementCleanup = _elementsMarshalling.GenerateElementCleanupStatement(
                info,
                context
            );
            ...
            if (
                MarshallerHelpers.GetCleanupStage(info, context)
                is StubCodeContext.Stage.CleanupCallerAllocated
            )
            {
                foreach (
                    var statement in _spaceMarshallingStrategy.GenerateCleanupCallerAllocatedResourcesStatements(
                        info,
                        context
                    )
                )
        ...
        )
        {
            ...
            {
                foreach (
                    var statement in _spaceMarshallingStrategy.GenerateCleanupCalleeAllocatedResourcesStatements(
                        info,
                        context
                    )
                )
        ...
        public IEnumerable<StatementSyntax> GenerateGuaranteedUnmarshalStatements(
            TypePositionInfo info,
            StubCodeContext context
        ) => _spaceMarshallingStrategy.GenerateGuaranteedUnmarshalStatements(info, context);
        ...
        )
        {
            ...
            foreach (
                var statement in _spaceMarshallingStrategy.GenerateMarshalStatements(info, context)
            )
            {
                yield return statement;
            }
        ...
        public IEnumerable<StatementSyntax> GenerateNotifyForSuccessfulInvokeStatements(
            TypePositionInfo info,
            StubCodeContext context
        ) => _spaceMarshallingStrategy.GenerateNotifyForSuccessfulInvokeStatements(info, context);

        public IEnumerable<StatementSyntax> GeneratePinnedMarshalStatements(
            TypePositionInfo info,
            StubCodeContext context
        ) => _spaceMarshallingStrategy.GeneratePinnedMarshalStatements(info, context);

        public IEnumerable<StatementSyntax> GeneratePinStatements(
            TypePositionInfo info,
            StubCodeContext context
        ) => _spaceMarshallingStrategy.GeneratePinStatements(info, context);
        ...
        )
        {
            ...
            )
            {
                ...
                foreach (
                    var statement in _spaceMarshallingStrategy.GenerateUnmarshalStatements(
                        info,
                        context
                    )
                )
