...
namespace Microsoft.Interop
{
    ...
    {
        private static readonly ManagedTypeInfo s_nativeType = new SpecialTypeInfo(
            "ushort",
            "ushort",
        ...
        public bool UsesNativeIdentifier(TypePositionInfo info, StubCodeContext context)
        {
            ...
            return !IsPinningPathSupported(info, context)
                && (elementMarshalDirection != MarshalDirection.ManagedToUnmanaged || info.IsByRef);
        }
        ...
        {
            return ByValueMarshalKindSupportDescriptor.Default
