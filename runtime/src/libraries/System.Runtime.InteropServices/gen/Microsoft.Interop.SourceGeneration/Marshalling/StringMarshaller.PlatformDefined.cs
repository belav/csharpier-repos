...
namespace Microsoft.Interop
{
    public sealed class PlatformDefinedStringMarshaller : ConditionalStackallocMarshallingGenerator
    {
        ...
        public PlatformDefinedStringMarshaller(
            IMarshallingGenerator windowsMarshaller,
            IMarshallingGenerator nonWindowsMarshaller
        )
        {
        ...
        public override ArgumentSyntax AsArgument(TypePositionInfo info, StubCodeContext context)
        {
            ...
            return Argument(ConditionalExpression(IsWindows, windowsExpr, nonWindowsExpr));
        }
        ...
        )
        {
            switch (context.CurrentStage)
            {
                ...
                case StubCodeContext.Stage.Marshal:
                    ...
                    {
                        if (
                            TryGetConditionalBlockForStatements(
        ...
        )
        {
            ...
            else if (hasNonWindowsStatements)
            {
                ...
                //     << non-Windows code >>
                // }
                conditionalBlock = IfStatement(
                    PrefixUnaryExpression(SyntaxKind.LogicalNotExpression, IsWindows),
