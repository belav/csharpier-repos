...
namespace Microsoft.Interop
{
    ...
    internal sealed class CustomTypeMarshallingGenerator : IMarshallingGenerator
    {
        ...
        public CustomTypeMarshallingGenerator(
            ...
            ByValueMarshalKindSupportDescriptor byValueContentsMarshallingSupport,
            bool isPinned
        )
        {
            ...
            switch (context.CurrentStage)
            {
                ...
                case StubCodeContext.Stage.Marshal:
                    if (
                        ...
                        || (
                            ...
                            && ShouldGenerateByValueOutMarshalling(info, context)
                        )
                    )
                    {
                ...
                case StubCodeContext.Stage.Pin:
                    if (
                        ...
                        && elementMarshalDirection is MarshalDirection.ManagedToUnmanaged
                    )
                    {
                ...
                case StubCodeContext.Stage.CleanupCallerAllocated:
                    return _nativeTypeMarshaller.GenerateCleanupCallerAllocatedResourcesStatements(
                        info,
                        context
                    );
                case StubCodeContext.Stage.CleanupCalleeAllocated:
                    return _nativeTypeMarshaller.GenerateCleanupCalleeAllocatedResourcesStatements(
                        info,
                        context
                    );
                default:
        ...
        )
        {
            return info.ByValueContentsMarshalKind.HasFlag(ByValueContentsMarshalKind.Out)
                && _byValueContentsMarshallingSupport.GetSupport(
        ...
        {
            return _byValueContentsMarshallingSupport.GetSupport(
                marshalKind,
                info,
                context,
                out diagnostic
