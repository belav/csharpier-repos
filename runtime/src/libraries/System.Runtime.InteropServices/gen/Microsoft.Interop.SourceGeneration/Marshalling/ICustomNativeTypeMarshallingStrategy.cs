...
namespace Microsoft.Interop
{
    ...
    /// </summary>
    internal sealed class CustomNativeTypeWithToFromNativeValueMarshalling
        : ICustomNativeTypeMarshallingStrategy
    {
        ...
        public CustomNativeTypeWithToFromNativeValueMarshalling(
            ICustomNativeTypeMarshallingStrategy innerMarshaller,
            TypeSyntax nativeValueTypeSyntax
        )
        {
        ...
        private static StatementSyntax GenerateFromNativeValueInvocation(
            TypePositionInfo info,
            StubCodeContext context,
            CustomNativeTypeWithToFromNativeValueContext subContext
        )
        {
                ...
                yield return Argument(
                    ObjectCreationExpression(
                            GenericName(
                                ...
                                TypeArgumentList(
                                    SingletonSeparatedList<TypeSyntax>(_bufferElementType)
                                )
                            )
                        )
                        .WithArgumentList(
    ...
    internal sealed class PinnableMarshallerTypeMarshalling : ICustomNativeTypeMarshallingStrategy
    {
        ...
        private static StatementSyntax GenerateToNativeValueInvocation(
            TypePositionInfo info,
            StubCodeContext context,
            CustomNativeTypeWithToFromNativeValueContext subContext
        )
        ...
        )
        {
            ...
            yield return FixedStatement(
                VariableDeclaration(
                    ...
                    SingletonSeparatedList(
                        VariableDeclarator(
                                Identifier(context.GetAdditionalIdentifier(info, "ignored"))
                            )
                            .WithInitializer(
                                EqualsValueClause(
                                    IdentifierName(subContext.GetIdentifiers(info).native)
    ...
    internal sealed class SizeOfElementMarshalling : ICustomNativeTypeMarshallingStrategy
    {
        ...
        public SizeOfElementMarshalling(
            ICustomNativeTypeMarshallingStrategy innerMarshaller,
    ...
    /// </summary>
    internal sealed class LinearCollectionWithBlittableElementsMarshalling
        : ICustomNativeTypeMarshallingStrategy
    {
        private readonly ICustomNativeTypeMarshallingStrategy _innerMarshaller;
        ...
        public LinearCollectionWithBlittableElementsMarshalling(
            ICustomNativeTypeMarshallingStrategy innerMarshaller,
                ...
                InvocationExpression(
                        MemberAccessExpression(
                            ...
                            InvocationExpression(
                                ...
                                .AddArgumentListArguments(Argument(copySource)),
                            IdentifierName("CopyTo")
                        )
                    )
                    .AddArgumentListArguments(Argument(copyDestination))
            );
    ...
    /// </summary>
    internal sealed class LinearCollectionWithNonBlittableElementsMarshalling
        : ICustomNativeTypeMarshallingStrategy
    {
        private readonly ICustomNativeTypeMarshallingStrategy _innerMarshaller;
        ...
        public LinearCollectionWithNonBlittableElementsMarshalling(
            ICustomNativeTypeMarshallingStrategy innerMarshaller,
        ...
        private LocalDeclarationStatementSyntax GenerateNativeValuesSourceDeclaration(
            TypePositionInfo info,
            StubCodeContext context,
        ...
        private LocalDeclarationStatementSyntax GeneratedManagedValuesSourceDeclaration(
            TypePositionInfo info,
            StubCodeContext context
        )
        {
        ...
        private LocalDeclarationStatementSyntax GeneratedManagedValuesDestinationDeclaration(
            TypePositionInfo info,
            StubCodeContext context,
            string numElementsIdentifier
        )
        ...
        )
        {
            ...
            if (elementStatements.Any())
            {
                ...
                return MarshallerHelpers
                    .GetForLoop(lengthExpression, elementSubContext.IndexerIdentifier)
        ...
        private StatementSyntax GenerateByValueUnmarshalStatement(
            TypePositionInfo info,
            StubCodeContext context
        )
        {
            ...
            LocalDeclarationStatementSyntax managedValuesDeclaration = LocalDeclarationStatement(
                VariableDeclaration(
                    GenericName(
                        Identifier(TypeNames.System_Span),
                        TypeArgumentList(SingletonSeparatedList(_elementInfo.ManagedType.Syntax))
                    ...
                    SingletonSeparatedList(
                        VariableDeclarator(managedSpanIdentifier)
                            .WithInitializer(
                                EqualsValueClause(
                                    InvocationExpression(
                                            MemberAccessExpression(
            ...
            LocalDeclarationStatementSyntax nativeValuesDeclaration =
                GenerateNativeValuesDestinationDeclaration(info, context);

            return Block(
                numElementsDeclaration,
        ...
        )
        {
            ...
            else
            {
                yield return Block(
                    ...
                    GeneratedManagedValuesDestinationDeclaration(
                        info,
                        context,
                        numElementsIdentifier
                    ),
