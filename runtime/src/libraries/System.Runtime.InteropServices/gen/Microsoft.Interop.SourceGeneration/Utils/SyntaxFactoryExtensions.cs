...
namespace Microsoft.Interop
{
    public static class SyntaxFactoryExtensions
    {
        ...
        public static InvocationExpressionSyntax MethodInvocation(
            ExpressionSyntax objectOrClass,
        ...
        /// </code>
        /// </summary>
        public static ExpressionStatementSyntax MethodInvocationStatement(
            ExpressionSyntax objectOrClass,
            SimpleNameSyntax methodName,
            params ArgumentSyntax[] arguments
        ...
        public static GenericNameSyntax SpanOf(TypeSyntax type) =>
            GenericName(_span, TypeArgumentList(SingletonSeparatedList(type)));

        private static readonly SyntaxToken _readonlySpan = Identifier(
            TypeNames.System_ReadOnlySpan
        );

        public static GenericNameSyntax ReadOnlySpanOf(TypeSyntax type) =>
            GenericName(_readonlySpan, TypeArgumentList(SingletonSeparatedList(type)));

        public static MemberAccessExpressionSyntax Dot(
            this ExpressionSyntax expression,
            SimpleNameSyntax member
        ) => MemberAccessExpression(SyntaxKind.SimpleMemberAccessExpression, expression, member);

        public static ElementAccessExpressionSyntax IndexExpression(
            ExpressionSyntax indexed,
        ...
        public static LiteralExpressionSyntax IntLiteral(int number) =>
        ...
        /// </code>
        /// </summary>
        public static ForStatementSyntax ForLoop(
