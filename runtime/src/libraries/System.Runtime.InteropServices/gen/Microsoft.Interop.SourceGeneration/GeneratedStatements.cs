...
namespace Microsoft.Interop
{
    public struct GeneratedStatements
    {
        ...
        )
        {
            ...
            else
            {
                throw new ArgumentException(
                    "Direction must be ManagedToUnmanaged or UnmanagedToManaged"
                );
            }
        }
        ...
        private static StatementSyntax GenerateStatementForManagedInvoke(
            BoundGenerators marshallers,
            StubCodeContext context,
            ExpressionSyntax expressionToInvoke
        )
        ...
        private static ImmutableArray<CatchClauseSyntax> GenerateCatchClauseForManagedException(
            BoundGenerators marshallers,
            StubCodeContext context
        )
        {
            ...
            ImmutableArray<StatementSyntax>.Builder catchClauseBuilder =
                ImmutableArray.CreateBuilder<StatementSyntax>();
            ...
            return ImmutableArray.Create(
                CatchClause(
                    CatchDeclaration(
                        ParseTypeName(TypeNames.System_Exception),
                        Identifier(managed)
                    ),
                    filter: null,
