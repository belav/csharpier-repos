...
namespace Microsoft.Interop
{
    public static class IncrementalValuesProviderExtensions
    {
        ...
        /// <summary>
        /// Format the syntax nodes in the given provider such that we will not re-normalize if the input
        ...
        /// <remarks>
        /// Normalizing whitespace is very expensive, so if a generator will have cases where the input
        // information into the step
        /// that creates <paramref name="provider"/> may change but the results of <paramref
        // name="provider"/> will say the same,
        /// using this method to format the code in a separate step will reduce the amount of work the
        // generator repeats when the
