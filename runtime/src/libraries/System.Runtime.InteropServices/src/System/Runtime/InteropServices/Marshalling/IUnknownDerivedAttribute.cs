...
{
    /// <summary>
    /// An attribute to mark this interface as a managed representation of an IUnknown-derived
    // interface.
    /// </summary>
    /// <typeparam name="T">The type that provides type-level information about the
    // interface.</typeparam>
    /// <typeparam name="TImpl">The type to use for calling from managed callers to unmanaged
    // implementations of the interface.</typeparam>
