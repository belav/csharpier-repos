    ...
    public class SignedXmlTest
    {
        ...
        public void StaticValues()
        {
            ...
            Assert.Equal(
                ...
                SignedXml.XmlDsigMinimalCanonicalizationUrl
            );
        ...
        private const string AsymmetricRSAMixedCaseAttributesResult =
        ...
        public void SignElementWithoutPrefixedNamespace()
        {
            ...
            byte[] key = Convert.FromBase64String("1W5EigVnbnRjGLbg99ElieOmuUgYO+KcwMJtE35SAGI=");
        ...
        // the signature
        static XmlDocument CreateSignedXml(
...
<ExampleDoc>Example doc to be signed.&xxe;<Signature xmlns=""http://www.w3.org/2000/09/xmldsig#"">
    ...
    <SignatureValue>o0IAVyovNUYKs5CCIRpZVy6noLpdJBp8LwWrqzzhKPg=</SignatureValue>
            ...
            Task listenerTask = ProcessRequests(
                listener,
                () => listenerContacted = true,
                tokenSource.Token
            );
        ...
        {
            const string expectedSignatureMethod =
                "http://www.w3.org/2001/04/xmldsig-more#rsa-sha256";
...
<test>some text node</test>
            ...
            {
                var sxml = new SignedXml(doc) { SigningKey = key };
        ...
        private SignedXml CreateSubjectForMultipleEnvelopedSignatures(
            string xml,
        ...
        )
        {
            ...
            XmlNode parentNode = string.IsNullOrEmpty(signatureParent)
                ? doc.DocumentElement
                : doc.SelectSingleNode("//x[@ID='" + signatureParent + "']");
        ...
        [SkipOnTargetFramework(
            ...
            "SignedXml has been failing validation on nested signatures all the time with .NET Framework and .NET (Core) up to .NET 6. This test was added together with a fix for .NET 7."
        )]
        public void CheckSignatureMultipleEnvelopedSignatures(
            string signatureParent /*, int expectedPosition*/
        )
        {
            SignedXml subject = CreateSubjectForMultipleEnvelopedSignatures(
                multipleSignaturesXml,
                signatureParent
            );
            ...
            Assert.True(
                ...
                "Multiple signatures, validating " + signatureParent
            );
        }
        ...
        {
            var tampered = multipleSignaturesXml.Replace(
                $"ID=\"{tamperNode}\"",
                $"ID=\"{tamperNode}\" Hackerz=\"true\""
            );
