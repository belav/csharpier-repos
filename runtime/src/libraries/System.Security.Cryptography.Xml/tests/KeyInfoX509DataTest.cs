...
namespace System.Security.Cryptography.Xml.Tests
{
    public class KeyInfoX509DataTest
    {
        ...
        public void Constructor_X509Certificate_X509IncludeOptionBad()
        {
            KeyInfoX509Data data = new KeyInfoX509Data(
                new X509Certificate(cert),
                (X509IncludeOption)int.MinValue
            );
            Assert.Null(data.Certificates);
            Assert.Null(data.CRL);
            Assert.Null(data.IssuerSerials);
        ...
        {
            KeyInfoX509Data data = new KeyInfoX509Data();
            AssertExtensions.Throws<ArgumentException>("issuerName", () =>
        ...
        {
            KeyInfoX509Data data = new KeyInfoX509Data();
            AssertExtensions.Throws<ArgumentException>("serialNumber", () =>
        ...
        public void AddIssuerSerial_Invalid_Serial()
        {
            KeyInfoX509Data data = new KeyInfoX509Data();
            AssertExtensions.Throws<ArgumentException>("serialNumber", () =>
                data.AddIssuerSerial("issuer", "NotANumber")
            );
        }
        ...
        public void AddSubjectName_Null()
        {
            ...
            Assert.Equal(
                "<X509Data xmlns=\"http://www.w3.org/2000/09/xmldsig#\"><X509SubjectName></X509SubjectName></X509Data>",
                data.GetXml().OuterXml
            );
        }
        ...
        public void ImportX509Data()
        {
            ...
            string crl =
                "<X509Data xmlns=\"http://www.w3.org/2000/09/xmldsig#\"><X509CRL></X509CRL></X509Data>";
            doc.LoadXml(crl);
