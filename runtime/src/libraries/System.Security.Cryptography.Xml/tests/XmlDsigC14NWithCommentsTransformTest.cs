    ...
    public class XmlDsigC14NWithCommentsTransformTest
    {
        ...
        public void Constructor()
        {
            ...
            Assert.Equal(
                ...
                xmlDsigC14NWithCommentsTransform.Algorithm
            );
            Assert.Equal(
                new[] { typeof(Stream), typeof(XmlDocument), typeof(XmlNodeList) },
                xmlDsigC14NWithCommentsTransform.InputTypes
            );
        ...
        {
            UnprotectedXmlDsigC14NWithCommentsTransform transform =
                new UnprotectedXmlDsigC14NWithCommentsTransform();
        ...
        public void C14NSpecExample1()
        {
            ...
            string res = TestHelpers.ExecuteTransform(
        ...
        private string ExecuteXmlDSigC14NTransform(
            string inputXml,
