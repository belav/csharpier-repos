...
namespace System.Reflection.Emit.Tests
{
    public class PropertyBuilderTest6
    {
        ...
        public void DeclaringType_NestedClass()
        {
            ...
            PropertyBuilder property = nestedType.DefineProperty(
                "TestProperty",
                PropertyAttributes.None,
                typeof(int),
                null
        ...
        {
            TypeBuilder baseClass = Helpers.DynamicType(
                TypeAttributes.Class | TypeAttributes.Public,
                typeName: "BaseClass"
            );
            TypeBuilder subClass = Helpers.DynamicType(
                TypeAttributes.Class | TypeAttributes.Public,
                typeName: "SubClass"
            );
            subClass.SetParent(baseClass.AsType());

            PropertyBuilder property = subClass.DefineProperty(
                "TestProperty",
                PropertyAttributes.None,
                typeof(int),
                null
        ...
        public void DeclaringType_BaseClass()
        {
            ...
            PropertyBuilder property = baseClass.DefineProperty(
                "TestProperty",
                PropertyAttributes.None,
                typeof(int),
                null
