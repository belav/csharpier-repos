...
namespace System.Reflection.Emit.Tests
{
    ...
    public class AssemblySaveConstructorBuilderTests
    {
        ...
        public void DefineConstructorsTest()
        {
            ...
            ConstructorBuilder constructor2 = type.DefineConstructor(
        ...
        public void DefineDefaultConstructor_WithTypeBuilderParent()
        {
            ...
            TypeBuilder child = ab.GetDynamicModule("MyModule")
                .DefineType("ChildType", TypeAttributes.Public | TypeAttributes.Class);
            child.SetParent(type);
            child.DefineDefaultConstructor(MethodAttributes.Family);
            child.CreateType();

            ConstructorInfo[] ctors = child.GetConstructors(
        ...
        public void DefineDefaultConstructor_Interface_ThrowsInvalidOperationException()
        {
            ...
            TypeBuilder type = ab.DefineDynamicModule("MyModule")
                .DefineType(
                    "MyType",
        ...
        public void DefineDefaultConstructor_ParentNoDefaultConstructor_ThrowsNotSupportedException()
        {
            ...
            TypeBuilder derivedType = ab.GetDynamicModule("MyModule")
        ...
        public void DefineDefaultConstructor_ParentPrivateDefaultConstructor_ThrowsNotSupportedException(
            MethodAttributes attributes
        )
        {
            AssemblySaveTools.PopulateAssemblyBuilderTypeBuilderAndSaveMethod(
                out TypeBuilder baseType,
                out MethodInfo _
            );
