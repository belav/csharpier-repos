    ...
    public class TypeBuilderDefineProperty
    {
        public static IEnumerable<object[]> TestData()
        {
            ...
            yield return new object[]
            {
                ...
                typeof(int[]),
                new Type[] { typeof(int), typeof(double) },
                "a",
                PropertyAttributes.None,
            };
            yield return new object[]
            ...
            {
                "\uDC00",
                (PropertyAttributes)0x8000,
                typeof(EmptyGenericStruct<string>),
                new Type[] { typeof(EmptyGenericClass<string>) },
                "\uFFFD",
                PropertyAttributes.None,
            };
            yield return new object[]
        ...
        )
        {
            ...
            Assert.Equal(
                type.AsType().GetProperties(Helpers.AllFlags),
                createdType.GetProperties(Helpers.AllFlags)
            );
        ...
        public void DefineProperty_OpenGenericParameterType_ThrowsBadImageFormatExceptionGettingCreatedPropertyType()
        {
            ...
            type.DefineProperty(
                ...
                PropertyAttributes.None,
                typeof(int),
                new Type[] { typeof(EmptyGenericStruct<>) }
            );
        ...
        public void DefineProperty_DynamicPropertyTypeNotCreated_ThrowsTypeLoadException()
        {
            ...
            Type createdType = type.CreateType();
            PropertyInfo property = createdType.GetProperty(
                "Name",
        ...
        public void DefineProperty_CalledMultipleTimes_Works()
        {
            ...
            Type createdType = type.CreateType();
            PropertyInfo[] properties = createdType.GetProperties(
                BindingFlags.Static
                    | BindingFlags.Instance
                    | BindingFlags.Public
                    | BindingFlags.NonPublic
