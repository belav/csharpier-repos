...
namespace System.Reflection.Emit.Tests
{
    ...
    public class MethodBuilderDefineMethodOverride
    {
        ...
        public void DefineMethodOverride_InterfaceMethodWithConflictingName()
        {
            ...
            Assert.Equal(
                1,
                createdMethod.Invoke(
                    Activator.CreateInstance(typeof(DefineMethodOverrideClass)),
                    null
                )
            );
        }
        ...
        public void DefineMethodOverride_GenericInterface_Succeeds()
        {
            ...
            Assert.Equal(
                "Hello World",
                interfaceMethod.Invoke(Activator.CreateInstance(createdType), null)
            );
        }
        ...
        public void DefineMethodOverride_NullMethodInfoBody_ThrowsArgumentNullException()
        {
            ...
            AssertExtensions.Throws<ArgumentNullException>("methodInfoBody", () =>
                type.DefineMethodOverride(null, method)
            );
        }
        ...
        public void DefineMethodOverride_NullMethodInfoDeclaration_ThrowsArgumentNullException()
        {
            ...
            AssertExtensions.Throws<ArgumentNullException>("methodInfoDeclaration", () =>
                type.DefineMethodOverride(method, null)
            );
        }
        ...
        public void DefineMethodOverride_StaticVirtualInterfaceMethod()
        {
            ...
            MethodBuilder svmInterface = interfaceType.DefineMethod(
                "StaticVirtualMethod",
                MethodAttributes.Public
            ...
            MethodBuilder vmInterface = interfaceType.DefineMethod(
            ...
            TypeBuilder implType = module.DefineType(
                "ImplType",
                TypeAttributes.Public,
                parent: typeof(object),
                new Type[] { interfaceTypeActual }
            );
            MethodBuilder svmImpl = implType.DefineMethod(
                "StaticVirtualMethodImpl",
                MethodAttributes.Public | MethodAttributes.Static,
                CallingConventions.Standard,
                typeof(void),
                Array.Empty<Type>()
            ...
            MethodBuilder vmImpl = implType.DefineMethod(
                "NormalVirtualMethodImpl",
                MethodAttributes.Public | MethodAttributes.Virtual,
                CallingConventions.HasThis,
                typeof(void),
                Array.Empty<Type>()
        ...
        public void DefineMethodOverride_StaticVirtualInterfaceMethod_VerifyWithInterfaceMap()
        {
            ...
            Assert.Equal(
                Array.IndexOf(actualMapping.InterfaceMethods, svmInterfaceActual),
                Array.IndexOf(actualMapping.TargetMethods, svmImplActual)
            );
            Assert.Equal(
                Array.IndexOf(actualMapping.InterfaceMethods, vmInterfaceActual),
                Array.IndexOf(actualMapping.TargetMethods, vmImplActual)
            );
        }
    }
}
