...
namespace System.Reflection.Emit.Tests
{
    ...
    public class FieldBuilderSetConstant
    {
        ...
        {
            FieldBuilder field = s_type.DefineField(
                "BoolField",
                typeof(bool),
        ...
        public void SetConstant_CustomObject()
        {
            FieldBuilder field = s_type.DefineField(
                "CustomObjectField",
                typeof(FieldBuilderSetConstant),
                FieldAttributes.Public
            );
        ...
        {
            FieldBuilder boolField = s_type.DefineField(
                "BoolField2",
                typeof(bool),
                FieldAttributes.Public
            );
            ...
            FieldBuilder intField = s_type.DefineField(
                "IntField2",
                typeof(int),
                FieldAttributes.Public
            );
            ...
            FieldBuilder sbyteField = s_type.DefineField(
                "SByteField2",
                typeof(sbyte),
                FieldAttributes.Public
            );
            ...
            FieldBuilder shortField = s_type.DefineField(
                "ShortField2",
                typeof(short),
                FieldAttributes.Public
            );
            ...
            FieldBuilder longField = s_type.DefineField(
                "LongField2",
                typeof(long),
                FieldAttributes.Public
            );
            ...
            FieldBuilder byteField = s_type.DefineField(
                "ByteField2",
                typeof(byte),
                FieldAttributes.Public
            );
            ...
            FieldBuilder ushortField = s_type.DefineField(
                "UShortField2",
                typeof(ushort),
                FieldAttributes.Public
            );
            ...
            FieldBuilder uintField = s_type.DefineField(
                "UIntField2",
                typeof(uint),
                FieldAttributes.Public
            );
            ...
            FieldBuilder ulongField = s_type.DefineField(
                "ULongField2",
                typeof(ulong),
                FieldAttributes.Public
            );
            ...
            FieldBuilder floatField = s_type.DefineField(
                "FloatField2",
                typeof(float),
                FieldAttributes.Public
            );
            ...
            FieldBuilder doubleField = s_type.DefineField(
                "DoubleField2",
                typeof(double),
                FieldAttributes.Public
            );
            ...
            FieldBuilder dateTimeField = s_type.DefineField(
                "DateTimeField2",
                typeof(DateTime),
                FieldAttributes.Public
            );
            ...
            FieldBuilder charField = s_type.DefineField(
                "CharField2",
                typeof(char),
                FieldAttributes.Public
            );
            ...
            FieldBuilder stringField = s_type.DefineField(
                "StringField2",
                typeof(string),
                FieldAttributes.Public
            );
            ...
            FieldBuilder enumField = s_type.DefineField(
                "EnumField2",
                typeof(CustomEnum),
                FieldAttributes.Public
            );
            ...
            FieldBuilder decimalField = s_type.DefineField(
                "DecimalField2",
                typeof(decimal),
                FieldAttributes.Public
            );
            ...
            FieldBuilder objectField = s_type.DefineField(
                "ObjectField2",
                typeof(object),
                FieldAttributes.Public
            );
            ...
            FieldBuilder structField = s_type.DefineField(
                "LongField2",
                typeof(FBTestStruct),
                FieldAttributes.Public
            );
