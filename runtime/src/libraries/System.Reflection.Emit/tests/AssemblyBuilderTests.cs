...
namespace System.Reflection.Emit.Tests
{
    ...
    public class AssemblyTests
    {
        ...
        public void SetCustomAttribute_GetCustomAttributesData_NonPublicVisibility_DefinedInternally()
        {
            ...
            TypeBuilder internalAttributeType = module.DefineType(
                "DynamicInternalAttribute",
                TypeAttributes.NotPublic,
                typeof(Attribute)
            );
            ConstructorBuilder internalAttributeCtor = internalAttributeType.DefineConstructor(
            ...
            ConstructorInfo internalAttributeCtorInfo = internalAttributeType
                .CreateTypeInfo()
                .GetConstructor(Array.Empty<Type>());
            CustomAttributeBuilder customAttribute = new CustomAttributeBuilder(
                internalAttributeCtorInfo,
                Array.Empty<object>()
            );
        ...
        public void SetCustomAttribute_GetCustomAttributesData_NonPublicVisibility_DefinedExternally()
        {
            ...
            TypeBuilder internalAttributeType = module1.DefineType(
                "DynamicInternalAttribute",
                TypeAttributes.NotPublic,
                typeof(Attribute)
            );
