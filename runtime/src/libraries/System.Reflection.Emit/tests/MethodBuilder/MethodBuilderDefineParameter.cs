...
namespace System.Reflection.Emit.Tests
{
    ...
    {
        private const MethodAttributes TestMethodAttributes =
        ...
        public void DefineParameter_TwoParameters()
        {
            ...
            Assert.Equal(
                expectedReturn,
                resultMethod.Invoke(null, new object[] { "hello", new object() })
            );

            // Verify MetadataToken
            Assert.Equal(method.MetadataToken, resultMethod.MetadataToken);
            MethodInfo methodFromToken = (MethodInfo)type.Module
                .ResolveMethod(method.MetadataToken);
        ...
        public void DefineParameter_InvalidPosition_ThrowsArgumentOutOfRangeException(
        ...
        public void DefineParameter_NoParameters_NonZeroPosition_ThrowsArgumentOutOfRangeException(
            TypeAttributes typeAttributes,
            MethodAttributes methodAttributes,
            ParameterAttributes parameterAttributes
        )
        ...
        )
        {
            ...
            int removedReservedAttributes =
                (int)expectedAttributes & ~ReservedMaskParameterAttribute;
            Assert.Equal(
                removedReservedAttributes,
                (parameter.Attributes & removedReservedAttributes)
            );
