    ...
    public class ModuleBuilderDefineInitializedData
    {
        ...
        public void DefineInitializedData_EmptyName_ThrowsArgumentException()
        {
            ...
            AssertExtensions.Throws<ArgumentException>("name", () =>
                module.DefineInitializedData("", new byte[] { 1, 0, 1 }, FieldAttributes.Private)
            );
        }
        ...
        public void DefineInitializedData_InvalidDataLength_ThrowsArgumentException(int length)
        {
            ...
            AssertExtensions.Throws<ArgumentException>(null, () =>
                module.DefineInitializedData("MyField", new byte[length], FieldAttributes.Public)
            );
        }
        ...
        public void DefineInitializedData_NullName_ThrowsArgumentNullException()
        {
            ...
            AssertExtensions.Throws<ArgumentNullException>("name", () =>
                module.DefineInitializedData(null, new byte[] { 1, 0, 1 }, FieldAttributes.Public)
            );
        }
        ...
        [ActiveIssue(
            "https://github.com/dotnet/runtime/issues/65558",
            typeof(PlatformDetection),
        ...
        public void DefineInitializedData_EnsureAlignmentIsMinimumNeededForUseOfCreateSpan()
        {
            ...
            FieldBuilder field1Byte = module.DefineInitializedData(
                "Field1Byte",
                new byte[] { 1 },
                FieldAttributes.Public
            );
            ...
            FieldBuilder field4Byte_1 = module.DefineInitializedData(
                "Field4Bytes_1",
                field4Byte_1_data,
                FieldAttributes.Public
            );
            FieldBuilder field8Byte_1 = module.DefineInitializedData(
                "Field8Bytes_1",
                field8Byte_1_data,
                FieldAttributes.Public
            );
            FieldBuilder field4Byte_2 = module.DefineInitializedData(
                "Field4Bytes_2",
                field4Byte_2_data,
                FieldAttributes.Public
            );
            FieldBuilder field8Byte_2 = module.DefineInitializedData(
                "Field8Bytes_2",
                field8Byte_2_data,
                FieldAttributes.Public
            );
            ...
            {
                var loadAddressMethod = checkTypeBuilder.DefineMethod(
                    name,
            ...
            void CheckMethod(string name, int minAlignmentRequired, byte[] dataToVerify)
            {
                ...
                Assert.Equal(
                    name + "_0" + "_" + address.ToString(),
                    name
                        + "_"
                        + (address % minAlignmentRequired).ToString()
                        + "_"
                        + address.ToString()
                );
            }
