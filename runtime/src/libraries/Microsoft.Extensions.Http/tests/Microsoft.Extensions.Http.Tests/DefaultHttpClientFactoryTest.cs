...
namespace Microsoft.Extensions.Http
{
    public class DefaultHttpClientFactoryTest
    {
        ...
        public IEnumerable<IHttpMessageHandlerBuilderFilter> EmptyFilters =
            Array.Empty<IHttpMessageHandlerBuilderFilter>();
        ...
        public void Factory_CreateClient_FiltersCanDecorateBuilder()
        {
            ...
            filter1.Setup(f => f.Configure(It.IsAny<Action<HttpMessageHandlerBuilder>>()))
                .Returns<Action<HttpMessageHandlerBuilder>>(
                    next =>
                        (b) =>
                        {
            ...
            filter2.Setup(f => f.Configure(It.IsAny<Action<HttpMessageHandlerBuilder>>()))
                .Returns<Action<HttpMessageHandlerBuilder>>(
                    next =>
                        (b) =>
                        {
            ...
            filter3.Setup(f => f.Configure(It.IsAny<Action<HttpMessageHandlerBuilder>>()))
                .Returns<Action<HttpMessageHandlerBuilder>>(
                    next =>
                        (b) =>
                        {
        ...
        public async Task Factory_CleanupCycle_DisposesLiveHandler()
        {
            ...
            var cleanupEntry = await SimulateClientUse_Factory_CleanupCycle_DisposesLiveHandler(
                factory,
                disposeHandler
            );
