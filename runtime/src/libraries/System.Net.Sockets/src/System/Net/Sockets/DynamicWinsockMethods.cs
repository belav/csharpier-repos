...
namespace System.Net.Sockets
{
    internal sealed class DynamicWinsockMethods
    {
        ...
        internal AcceptExDelegate GetAcceptExDelegate(SafeSocketHandle socketHandle) =>
            _acceptEx
            ?? CreateDelegate(ref _acceptEx, socketHandle, "b5367df1cbac11cf95ca00805f48a192");

        internal GetAcceptExSockaddrsDelegate GetGetAcceptExSockaddrsDelegate(
            SafeSocketHandle socketHandle
        ) =>
        ...
        internal ConnectExDelegate GetConnectExDelegate(SafeSocketHandle socketHandle) =>
            _connectEx
            ?? CreateDelegate(ref _connectEx, socketHandle, "25a207b9ddf346608ee976e58c74063e");

        internal DisconnectExDelegate GetDisconnectExDelegate(SafeSocketHandle socketHandle) =>
            _disconnectEx
            ?? CreateDelegate(ref _disconnectEx, socketHandle, "7fda2e118630436fa031f536a6eec157");

        internal WSARecvMsgDelegate GetWSARecvMsgDelegate(SafeSocketHandle socketHandle) =>
            _recvMsg
            ?? CreateDelegate(ref _recvMsg, socketHandle, "f689d7c86f1f436b8a53e54fe351c322");

        internal TransmitPacketsDelegate GetTransmitPacketsDelegate(
            SafeSocketHandle socketHandle
        ) =>
            _transmitPackets
            ?? CreateDelegate(
