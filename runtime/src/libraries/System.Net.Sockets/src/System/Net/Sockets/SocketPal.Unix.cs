...
namespace System.Net.Sockets
{
    internal static partial class SocketPal
    {
        ...
        )
        {
            ...
            Interop.Error error = Interop.Sys.Socket(
                (int)addressFamily,
                (int)socketType,
                (int)protocolType,
                &fd
        ...
        )
        {
            Debug.Assert(
                ...
                $"Unexpected socketAddressLen: {socketAddress.Length}"
            );
        ...
        public static unsafe bool TryCompleteReceiveFrom(
            ...
            SocketFlags flags,
            Span<byte> socketAddress,
            out int receivedSocketAddressLength,
            out int bytesReceived,
            out SocketFlags receivedFlags,
            out SocketError errorCode
        )
            ...
            try
            {
                ...
                else if (buffers != null)
                {
                    ...
                    received = SysReceive(
                        ...
                        buffers,
                        socketAddress,
                        out receivedSocketAddressLength,
                        out receivedFlags,
                        out errno
                    );
                }
                ...
                try
                {
                    ...
                    else
                    {
                        sent =
                            ...
                            : socketAddress == null
                                ? SysSend(socket, flags, buffer, ref offset, ref count, out errno)
                            : SysSend(
                                socket,
                                flags,
                                buffer,
        ...
        public static SocketError ReceiveMessageFrom(
            ...
            out SocketAddress receiveAddress,
            out IPPacketInformation ipPacketInformation,
            out int bytesTransferred
        )
        {
