...
#pragma warning restore CS0618
                        ...
                        if (e.MemoryBuffer != null)
                        {
                            bytesTransferred =
                                await socket
                                    ...
                                    .ConfigureAwait(false) + bytesTransferred;
                        }
                        else
                        {
                            SafeFileHandle fileHandle =
                                fileHandles[i] ?? e.FileStream!.SafeFileHandle;
        ...
        )
        {
            Interop.Error err = Interop.Sys.Poll(
                ...
                Interop.PollEvents.POLLOUT,
                timeout: 0,
                out Interop.PollEvents outEvents
            );
            if (err != Interop.Error.SUCCESS)
            {
            ...
            SocketError errorCode = GetSockOpt(
                handle,
                SocketOptionLevel.Socket,
