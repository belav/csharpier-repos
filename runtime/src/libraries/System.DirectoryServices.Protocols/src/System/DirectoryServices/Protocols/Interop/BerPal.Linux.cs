...
namespace System.DirectoryServices.Protocols
{
    internal static class BerPal
    {
        ...
        internal static int PrintBerArray(
            ...
            IntPtr value,
            nuint tag
        ) => Interop.Ldap.ber_printf_berarray(berElement, format, value, tag);
        ...
        internal static int PrintByteArray(
            ...
            nuint length,
            nuint tag
        ) => Interop.Ldap.ber_printf_bytearray(berElement, format, value, length, tag);

        internal static int PrintEmptyArgument(
            SafeBerHandle berElement,
            string format,
            nuint tag
        ) => Interop.Ldap.ber_printf_emptyarg(berElement, format, tag);
        ...
        internal static int PrintInt(
            ...
            int value,
            nuint tag
        ) => Interop.Ldap.ber_printf_int(berElement, format, value, tag);
        ...
        internal static int ScanNext(SafeBerHandle berElement, string format) =>
            Interop.Ldap.ber_scanf_emptyarg(berElement, format);
        ...
        internal static int ScanNextMultiByteArray(
            ...
            string format,
            ref IntPtr value
        ) => Interop.Ldap.ber_scanf_multibytearray(berElement, format, ref value);
