...
namespace System.DirectoryServices.Protocols
{
    internal static class LdapPal
    {
        ...
        ) => Interop.Ldap.ldap_parse_reference(ldapHandle, result, ref referrals);
        ...
        internal static int BindToDirectory(ConnectionHandle ld, string who, string passwd) =>
            Interop.Ldap.ldap_simple_bind_s(ld, who, passwd);
        ...
        internal static byte StopTls(ConnectionHandle ldapHandle) =>
            Interop.Ldap.ldap_stop_tls(ldapHandle);
        ...
        internal static string PtrToString(IntPtr requestName) =>
            Marshal.PtrToStringUni(requestName);
