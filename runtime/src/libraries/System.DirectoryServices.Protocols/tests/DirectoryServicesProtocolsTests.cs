...
namespace System.DirectoryServices.Protocols.Tests
{
    public partial class DirectoryServicesProtocolsTests
    {
        ...
        internal static bool IsServerSideSortSupported =>
            IsLdapConfigurationExist && LdapConfiguration.Configuration.SupportsServerSideSort;
        ...
        public static IEnumerable<object[]> TestCompareRequestTheory_TestData()
        {
            ...
            {
                "http://example.com/",
                Encoding.UTF8.GetBytes("http://example.com/"),
                ResultCode.CompareTrue
            };
            ...
            {
                "http://example.com/",
                Encoding.UTF8.GetBytes("http://false/"),
                ResultCode.CompareFalse
            };
        }
