...
namespace System.DirectoryServices.Protocols.Tests
{
    public class ModifyRequestTests
    {
        ...
        public static IEnumerable<object[]> Ctor_DistinguishedName_Modifications_TestData()
        {
            ...
            {
                "DistinguishedName",
                new DirectoryAttributeModification[] { new DirectoryAttributeModification() }
            };
        }
        ...
        )
        {
            ...
            Assert.Equal(
                modifications ?? Enumerable.Empty<DirectoryAttributeModification>(),
                request.Modifications.Cast<DirectoryAttributeModification>()
            );
            Assert.Null(request.RequestId);
        }
