    ...
    public class VlvRequestControlTests
    {
        ...
        public void Ctor_Default()
        {
            ...
            var expected =
                (RuntimeInformation.IsOSPlatform(OSPlatform.Windows))
                    ...
                    : new byte[] { 48, 14, 2, 1, 0, 2, 1, 0, 160, 6, 2, 1, 0, 2, 1, 0 };
        ...
        public static IEnumerable<object[]> Ctor_BeforeCount_AfterCount_Offset_Data()
        {
            ...
            yield return new object[]
            {
                ...
                (RuntimeInformation.IsOSPlatform(OSPlatform.Windows))
                    ...
                    : new byte[] { 48, 14, 2, 1, 10, 2, 1, 10, 160, 6, 2, 1, 10, 2, 1, 0 }
            };
        }

        [Theory]
        [MemberData(nameof(Ctor_BeforeCount_AfterCount_Offset_Data))]
        public void Ctor_BeforeCount_AfterCount_Offset(
            int beforeCount,
            int afterCount,
            int offset,
            byte[] expectedValue
        ...
        public static IEnumerable<object[]> Ctor_BeforeCount_AfterCount_StringTarget_Data()
        {
            ...
            yield return new object[]
            {
                ...
                new byte[] { 97, 98, 99 },
                (RuntimeInformation.IsOSPlatform(OSPlatform.Windows))
                    ? new byte[] { 48, 132, 0, 0, 0, 11, 2, 1, 10, 2, 1, 10, 129, 3, 97, 98, 99 }
                    : new byte[] { 48, 11, 2, 1, 10, 2, 1, 10, 129, 3, 97, 98, 99 }
            };
        }

        [Theory]
        [MemberData(nameof(Ctor_BeforeCount_AfterCount_StringTarget_Data))]
        public void Ctor_BeforeCount_AfterCount_StringTarget(
            int beforeCount,
            int afterCount,
            string target,
            byte[] expectedTarget,
        ...
        public static IEnumerable<object[]> Ctor_BeforeCount_AfterCount_ByteArrayTarget_Data()
        {
            ...
            yield return new object[]
            {
                ...
                new byte[] { 1, 2, 3 },
                (RuntimeInformation.IsOSPlatform(OSPlatform.Windows))
                    ? new byte[] { 48, 132, 0, 0, 0, 11, 2, 1, 10, 2, 1, 10, 129, 3, 1, 2, 3 }
                    : new byte[] { 48, 11, 2, 1, 10, 2, 1, 10, 129, 3, 1, 2, 3 }
            };
        }

        [Theory]
        [MemberData(nameof(Ctor_BeforeCount_AfterCount_ByteArrayTarget_Data))]
        public void Ctor_BeforeCount_AfterCount_ByteArrayTarget(
            int beforeCount,
            int afterCount,
            byte[] target,
            byte[] expectedValue
