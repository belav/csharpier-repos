    ...
    public static class Util
    {
        ...
        public static T Abs<T>(T value) where T : struct
        {
            ...
            // signed types
                ...
                return (T)(ValueType)(short)(Math.Abs((short)(ValueType)value));
            else if (value is int)
                return (T)(ValueType)(int)(Math.Abs((int)(ValueType)value));
            else if (value is long)
                return (T)(ValueType)(long)(Math.Abs((long)(ValueType)value));
            else if (value is sbyte)
                return (T)(ValueType)(sbyte)(Math.Abs((sbyte)(ValueType)value));
            else if (value is float)
                return (T)(ValueType)(float)(Math.Abs((float)(ValueType)value));
            else if (value is double)
                return (T)(ValueType)(double)(Math.Abs((double)(ValueType)value));
            else
        ...
        public static T Sqrt<T>(T value) where T : struct
        {
            ...
            {
                if (value is short)
                    return (T)(ValueType)(short)(Math.Sqrt((short)(ValueType)value));
                else if (value is int)
                    return (T)(ValueType)(int)(Math.Sqrt((int)(ValueType)value));
                else if (value is long)
                    return (T)(ValueType)(long)(Math.Sqrt((long)(ValueType)value));
                else if (value is ushort)
                    return (T)(ValueType)(ushort)(Math.Sqrt((ushort)(ValueType)value));
                else if (value is uint)
                    return (T)(ValueType)(uint)(Math.Sqrt((uint)(ValueType)value));
                else if (value is ulong)
                    return (T)(ValueType)(ulong)(Math.Sqrt((ulong)(ValueType)value));
                else if (value is byte)
                    return (T)(ValueType)(byte)(Math.Sqrt((byte)(ValueType)value));
                else if (value is sbyte)
                    return (T)(ValueType)(sbyte)(Math.Sqrt((sbyte)(ValueType)value));
                else if (value is float)
                    return (T)(ValueType)(float)(Math.Sqrt((float)(ValueType)value));
                else if (value is double)
                    return (T)(ValueType)(double)(Math.Sqrt((double)(ValueType)value));
                else
                    throw new NotImplementedException();
            }
        }
        ...
        public static T Multiply<T>(T left, T right) where T : struct
        {
            ...
            {
                if (left is short)
                    return (T)(ValueType)(short)((short)(ValueType)left * (short)(ValueType)right);
                else if (left is int)
                    return (T)(ValueType)(int)((int)(ValueType)left * (int)(ValueType)right);
                    ...
                    return (T)(ValueType)(ulong)((ulong)(ValueType)left * (ulong)(ValueType)right);
                else if (left is byte)
                    return (T)(ValueType)(byte)((byte)(ValueType)left * (byte)(ValueType)right);
                else if (left is sbyte)
                    return (T)(ValueType)(sbyte)((sbyte)(ValueType)left * (sbyte)(ValueType)right);
        ...
        public static T Divide<T>(T left, T right) where T : struct
        {
            if (left is short)
                ...
                return (T)(ValueType)(ushort)((ushort)(ValueType)left / (ushort)(ValueType)right);
            else if (left is uint)
                return (T)(ValueType)(uint)((uint)(ValueType)left / (uint)(ValueType)right);
            else if (left is ulong)
                return (T)(ValueType)(ulong)((ulong)(ValueType)left / (ulong)(ValueType)right);
                ...
                return (T)(ValueType)(double)((double)(ValueType)left / (double)(ValueType)right);
            else
                throw new NotImplementedException();
        }
        ...
        public static T OnesComplement<T>(T left) where T : struct
        {
            ...
            {
                if (left is short)
                    return (T)(ValueType)(short)(~(short)(ValueType)left);
                else if (left is int)
                    return (T)(ValueType)(int)(~(int)(ValueType)left);
                else if (left is long)
                    return (T)(ValueType)(long)(~(long)(ValueType)left);
                else if (left is ushort)
                    return (T)(ValueType)(ushort)(~(ushort)(ValueType)left);
                else if (left is uint)
                    return (T)(ValueType)(uint)(~(uint)(ValueType)left);
                else if (left is ulong)
                    return (T)(ValueType)(ulong)(~(ulong)(ValueType)left);
                else if (left is byte)
                    return (T)(ValueType)(byte)(~(byte)(ValueType)left);
                else if (left is sbyte)
                    return (T)(ValueType)(sbyte)(~(sbyte)(ValueType)left);
                else
                    throw new NotImplementedException();
            }
        }
        ...
        public static T Zero<T>() where T : struct
        {
            if (typeof(T) == typeof(short))
                ...
                return (T)(ValueType)(int)0;
            else if (typeof(T) == typeof(long))
                return (T)(ValueType)(long)0;
            else if (typeof(T) == typeof(ushort))
                return (T)(ValueType)(ushort)0;
            else if (typeof(T) == typeof(uint))
                return (T)(ValueType)(uint)0;
            else if (typeof(T) == typeof(ulong))
                return (T)(ValueType)(ulong)0;
            else if (typeof(T) == typeof(byte))
                return (T)(ValueType)(byte)0;
            else if (typeof(T) == typeof(sbyte))
                return (T)(ValueType)(sbyte)0;
            else if (typeof(T) == typeof(float))
                return (T)(ValueType)(float)0;
            else if (typeof(T) == typeof(double))
                return (T)(ValueType)(double)0;
            else
                throw new NotImplementedException();
        }
        ...
        public static T One<T>() where T : struct
        {
            if (typeof(T) == typeof(short))
                ...
                return (T)(ValueType)(int)1;
            else if (typeof(T) == typeof(long))
                return (T)(ValueType)(long)1;
            else if (typeof(T) == typeof(ushort))
                return (T)(ValueType)(ushort)1;
            else if (typeof(T) == typeof(uint))
                return (T)(ValueType)(uint)1;
            else if (typeof(T) == typeof(ulong))
                return (T)(ValueType)(ulong)1;
            else if (typeof(T) == typeof(byte))
                return (T)(ValueType)(byte)1;
            else if (typeof(T) == typeof(sbyte))
                return (T)(ValueType)(sbyte)1;
            else if (typeof(T) == typeof(float))
                return (T)(ValueType)(float)1;
            else if (typeof(T) == typeof(double))
                return (T)(ValueType)(double)1;
            else
                throw new NotImplementedException();
        }
        ...
        {
            if (left is short)
                return (short)(ValueType)left > (short)(ValueType)right;
            else if (left is int)
                return (int)(ValueType)left > (int)(ValueType)right;
            else if (left is long)
                return (long)(ValueType)left > (long)(ValueType)right;
            else if (left is ushort)
                return (ushort)(ValueType)left > (ushort)(ValueType)right;
            else if (left is uint)
                return (uint)(ValueType)left > (uint)(ValueType)right;
            else if (left is ulong)
                return (ulong)(ValueType)left > (ulong)(ValueType)right;
            else if (left is byte)
                return (byte)(ValueType)left > (byte)(ValueType)right;
            else if (left is sbyte)
                return (sbyte)(ValueType)left > (sbyte)(ValueType)right;
            else if (left is float)
                return (float)(ValueType)left > (float)(ValueType)right;
            else if (left is double)
