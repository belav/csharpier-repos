...
namespace System.Threading.Channels
{
    ...
    {
        /// <summary>Creates an unbounded channel usable by any number of readers and writers
        ...
        /// <typeparam name="T">Specifies the type of data in the channel.</typeparam>
        /// <param name="options">Options that guide the behavior of the channel.</param>
        /// <param name="itemDropped">Delegate that will be called when item is being dropped from channel.
        // See <see cref="BoundedChannelFullMode"/>.</param>
        /// <returns>The created channel.</returns>
