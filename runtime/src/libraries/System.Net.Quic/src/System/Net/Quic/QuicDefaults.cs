...
/// <summary>
/// Default values for <see cref="QuicListenerOptions" />, <see cref="QuicClientConnectionOptions"
// /> and <see cref="QuicServerConnectionOptions" />.
/// </summary>
internal static partial class QuicDefaults
{
    ...
    /// <summary>
    /// <see cref="QuicClientConnectionOptions" />.<see
    // cref="QuicConnectionOptions.MaxInboundBidirectionalStreams" />.
    /// </summary>
    public const int DefaultClientMaxInboundBidirectionalStreams = 0;

    /// <summary>
    /// <see cref="QuicClientConnectionOptions" />.<see
    // cref="QuicConnectionOptions.MaxInboundUnidirectionalStreams" />.
    /// </summary>
    public const int DefaultClientMaxInboundUnidirectionalStreams = 0;

    /// <summary>
    /// <see cref="QuicServerConnectionOptions" />.<see
    // cref="QuicConnectionOptions.MaxInboundBidirectionalStreams" />.
    /// </summary>
    ...
    /// <summary>
    /// Max value for application error codes that can be sent by QUIC, see <see
    // href="https://www.rfc-editor.org/rfc/rfc9000.html#integer-encoding"/>.
    /// </summary>
