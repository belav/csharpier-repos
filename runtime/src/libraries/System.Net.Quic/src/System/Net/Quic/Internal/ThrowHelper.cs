    ...
    internal static Exception GetExceptionForMsQuicStatus(int status, string? message = null)
    {
        ...
        static Exception GetExceptionInternal(int status, string? message)
        {
            ...
            if (status == QUIC_STATUS_UNREACHABLE)
                return new QuicException(
                    QuicError.HostUnreachable,
                    null,
                    SR.net_quic_host_unreachable
                );
            ...
            if (status == QUIC_STATUS_INVALID_ADDRESS)
                return new QuicException(
                    QuicError.InvalidAddress,
                    null,
                    SR.net_quic_invalid_address
                );
            ...
            if (status == QUIC_STATUS_ALPN_IN_USE)
                return new QuicException(QuicError.AlpnInUse, null, SR.net_quic_protocol_error);
