...
namespace System.Net.Quic
{
    public sealed class QuicConnection : IDisposable
    {
        ...
        /// </summary>
        /// <returns></returns>
        public async ValueTask<QuicStream> OpenUnidirectionalStreamAsync(
        ...
        /// </summary>
        /// <returns></returns>
        public async ValueTask<QuicStream> OpenBidirectionalStreamAsync(
            CancellationToken cancellationToken = default
        ) =>
            new QuicStream(
                await _provider
                    .OpenBidirectionalStreamAsync(cancellationToken)
                    .ConfigureAwait(false)
            );
