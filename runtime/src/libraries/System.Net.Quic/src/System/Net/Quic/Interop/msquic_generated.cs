...
namespace Microsoft.Quic
{
    ...
    internal partial struct QUIC_STATISTICS_V2
    {
        ...
        {
            get { return (_bitfield >> 5) & 0x7FFFFFFu; }
    ...
    internal partial struct QUIC_GLOBAL_SETTINGS
    {
        ...
        internal partial struct _Anonymous_e__Union
        {
            ...
            internal partial struct _IsSet_e__Struct
            {
                ...
                {
                    get { return (_bitfield >> 2) & 0x3FFFFFFFUL; }
                    set
                    {
                        _bitfield =
                            (_bitfield & ~(0x3FFFFFFFUL << 2)) | ((value & 0x3FFFFFFFUL) << 2);
                    }
                }
            }
        }
    ...
    internal partial struct QUIC_SETTINGS
    {
        ...
        internal partial struct _Anonymous_e__Union
        {
            ...
            internal partial struct _IsSet_e__Struct
            {
                ...
                internal ulong RESERVED
                {
                    get { return (_bitfield >> 33) & 0x7FFFFFFFUL; }
                    set
                    {
                        _bitfield =
                            (_bitfield & ~(0x7FFFFFFFUL << 33)) | ((value & 0x7FFFFFFFUL) << 33);
                    }
                }
            }
        }
