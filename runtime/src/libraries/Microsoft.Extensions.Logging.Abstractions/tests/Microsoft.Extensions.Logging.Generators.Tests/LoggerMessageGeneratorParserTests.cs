...
namespace Microsoft.Extensions.Logging.Generators.Tests
{
    ...
    public class LoggerMessageGeneratorParserTests
    {
        ...
        [Theory]
        [InlineData(
            "EventId = null, Level = LogLevel.Debug, Message = \"This is a message with {foo}\""
        )]
        [InlineData(
            "eventId: null, level: LogLevel.Debug, message: \"This is a message with {foo}\""
        )]
        ...
        public async Task InvalidRefKindsOut()
        {
            ...
            Assert.Single(diagnostics);
            Assert.Equal(
                DiagnosticDescriptors.InvalidLoggingMethodParameterOut.Id,
                diagnostics[0].Id
            );
        ...
        public static void SyntaxListWithManyItems()
        {
            ...
            (ImmutableArray<Diagnostic> diagnostics, _) = RoslynTestUtils.RunGenerator(
                compilation,
                generator
            );
        ...
        public async Task LanguageVersionTest()
        {
            ...
            Assembly[]? refs = new[]
            {
                ...
                typeof(LoggerMessageAttribute).Assembly,
            };
