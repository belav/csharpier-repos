...
namespace System.Drawing
{
    ...
    internal static partial class SafeNativeMethods
    {
        internal static unsafe partial class Gdip
        {
            ...
            [DllImport(LibraryName, ExactSpelling = true)]
            internal static extern int GdipGetImageDecoders(
                int numDecoders,
                int size,
                IntPtr decoders
            );
            ...
            [DllImport(LibraryName, ExactSpelling = true)]
            internal static extern int GdipGetImageEncoders(
                int numEncoders,
                int size,
                IntPtr encoders
            );
            ...
            [DllImport(LibraryName, ExactSpelling = true)]
            internal static extern int GdipCreatePen1(
                int argb,
                float width,
                int unit,
                out IntPtr pen
            ...
            [DllImport(LibraryName, ExactSpelling = true)]
            internal static extern int GdipCreateRegionRect(
                ref RectangleF gprectf,
                out IntPtr region
            );

            [DllImport(LibraryName, ExactSpelling = true)]
            internal static extern int GdipCreateRegionRectI(
            ...
            [DllImport(LibraryName, ExactSpelling = true, CharSet = CharSet.Unicode)]
            internal static extern int GdipCreateBitmapFromFileICM(
                string filename,
                out IntPtr bitmap
            );
