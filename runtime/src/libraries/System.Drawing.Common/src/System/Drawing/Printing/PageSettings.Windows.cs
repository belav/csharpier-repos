    ...
    public partial class PageSettings : ICloneable
    {
        ...
        public float HardMarginY
        {
            get
            {
                ...
                try
                {
                    int dpiY = Interop.Gdi32
                        .GetDeviceCaps(
                            new HandleRef(dc, dc.Hdc),
                            Interop.Gdi32.DeviceCapability.LOGPIXELSY
                        );
                    int hardMarginY_DU = Interop.Gdi32
                        .GetDeviceCaps(
                            new HandleRef(dc, dc.Hdc),
        ...
        public PaperSource PaperSource
        {
            get
            {
                ...
                {
                    IntPtr modeHandle = printerSettings.GetHdevmode();
                    IntPtr modePointer = Interop.Kernel32
            ...
            get
            {
                ...
                try
                {
                    ...
                    if (!Landscape)
                    {
                        ...
                        printableArea.X =
                            (float)Interop.Gdi32
                                .GetDeviceCaps(hdc, Interop.Gdi32.DeviceCapability.PHYSICALOFFSETX)
                            * 100
                            / dpiX;
                        printableArea.Y =
                            (float)Interop.Gdi32
                                .GetDeviceCaps(hdc, Interop.Gdi32.DeviceCapability.PHYSICALOFFSETY)
                            * 100
                            / dpiY;
                        printableArea.Width =
                            (float)Interop.Gdi32
                                .GetDeviceCaps(hdc, Interop.Gdi32.DeviceCapability.HORZRES) * 100
                            / dpiX;
                        printableArea.Height =
                            (float)Interop.Gdi32
                                .GetDeviceCaps(hdc, Interop.Gdi32.DeviceCapability.VERTRES) * 100
                            / dpiY;
                    }
                    else
                    {
