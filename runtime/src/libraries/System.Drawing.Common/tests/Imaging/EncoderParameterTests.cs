...
namespace System.Drawing.Imaging.Tests
{
    public class EncoderParameterTests
    {
        ...
        [InlineData(0, 0, 0, 0)]
        [InlineData(1, 2, 3, 4)]
        public void Ctor_Encoder_Numerator1_Denominator1_Numerator2_Denominator2(
            int numerator1,
            int denominator1,
            int numerator2,
            int denominator2
        ...
        public void Ctor_Encoder_ByteArray_Bool(
            byte[] value,
            bool undefined,
        ...
        public void Ctor_Encoder_Numerator1Array_Denominator1Array_Numerator2Array_Denominator2Array(
            int[] numerator1,
            int[] denominator1,
            int[] numerator2,
            int[] denominator2
        ...
        public void Ctor_Encoder_NumberOfValues_Type_Value(
            int numberOfValues,
        ...
        public void Ctor_Encoder_Numerator1Array_Denominator1Array_Numerator2Array_Denominator2Array_InvalidParameters_ThrowsExpected(
            int[] numerator1,
            int[] denominator1,
            int[] numerator2,
            int[] denominator2,
        ...
        public void Ctor_RangeBegin_RangeEnd_InvalidValues_ThrowsExpected(
            long[] rangeBegin,
            long[] rangeEnd,
            Type expected
        ) {
        ...
        public static IEnumerable<object[]> EncoderParameterCtor_NullEncoder_TestData
        {
            get
            {
                ...
                yield return new object[]
                {
                    new Action(() => new EncoderParameter(null, (byte)0, false))
                };
                yield return new object[]
                {
                    new Action(() => new EncoderParameter(null, (short)0))
                };
                yield return new object[]
                {
                    new Action(() => new EncoderParameter(null, numerator: 0, denominator: 0))
                };
                yield return new object[]
                {
                    new Action(() => new EncoderParameter(null, rangebegin: 0, rangeend: 0))
                };
                yield return new object[]
                {
                    new Action(() => new EncoderParameter(null, 0, 0, 0, 0))
                };
                yield return new object[]
                {
                    new Action(() => new EncoderParameter(null, "anyString"))
                };
                yield return new object[]
                {
