    ...
    public class Graphics_DrawBezierTests : DrawingTest
    {
        ...
        public void DrawBezier_PointFs()
        {
            ...
            using (Graphics graphics = Graphics.FromImage(image))
            {
                PointF[] points =
                {
                    ...
                    new PointF(35.0F, 5.0F),
                    new PointF(50.0F, 10.0F),
                    new PointF(60.0F, 15.0F),
                    new PointF(65.0F, 25.0F),
                    new PointF(50.0F, 30.0F)
                };
        ...
        public void DrawBezier_NullPen_ThrowsArgumentNullException()
        {
            ...
            using (Graphics graphics = Graphics.FromImage(image))
            {
                AssertExtensions.Throws<ArgumentNullException>(
                    "pen",
                    () => graphics.DrawBezier(null, 1, 2, 3, 4, 5, 6, 7, 8)
                );
                AssertExtensions.Throws<ArgumentNullException>(
                    "pen",
                    () =>
        ...
        public void DrawBezier_DisposedPen_ThrowsArgumentException()
        {
            ...
            using (Graphics graphics = Graphics.FromImage(image))
            {
                ...
                AssertExtensions.Throws<ArgumentException>(
                    null,
                    () =>
                        graphics.DrawBezier(pen, Point.Empty, Point.Empty, Point.Empty, Point.Empty)
                );
                AssertExtensions.Throws<ArgumentException>(
                    null,
                    () =>
        ...
        public void DrawBeziers_NullPen_ThrowsArgumentNullException()
        {
            ...
            using (Graphics graphics = Graphics.FromImage(image))
            {
                AssertExtensions.Throws<ArgumentNullException>(
                    "pen",
                    () => graphics.DrawBeziers(null, new Point[2])
                );
                AssertExtensions.Throws<ArgumentNullException>(
                    "pen",
                    () => graphics.DrawBeziers(null, new PointF[2])
                );
            }
        }
        ...
        public void DrawBeziers_NullPoints_ThrowsArgumentNullException()
        {
            ...
            using (var pen = new Pen(Color.Red))
            {
                AssertExtensions.Throws<ArgumentNullException>(
                    "points",
                    () => graphics.DrawBeziers(pen, (Point[])null)
                );
                AssertExtensions.Throws<ArgumentNullException>(
                    "points",
                    () => graphics.DrawBeziers(pen, (PointF[])null)
                );
            }
        }
        ...
        public void DrawBeziers_EmptyPoints_ThrowsArgumentException()
        {
            ...
            using (var pen = new Pen(Color.Red))
            {
                AssertExtensions.Throws<ArgumentException>(
                    null,
                    () => graphics.DrawBeziers(pen, new Point[0])
                );
                AssertExtensions.Throws<ArgumentException>(
                    null,
                    () => graphics.DrawBeziers(pen, new PointF[0])
                );
            }
        }
