    ...
    public class WebSocketDeflateTests
    {
        ...
        public async Task ReceiveHelloWithContextTakeover()
        {
            ...
            using WebSocket websocket = WebSocket.CreateFromStream(
                stream,
                new WebSocketCreationOptions { DangerousDeflateOptions = new() }
            );
        ...
        public async Task SendHelloWithContextTakeover()
        {
            ...
            using WebSocket websocket = WebSocket.CreateFromStream(
                stream.Remote,
                new WebSocketCreationOptions { IsServer = true, DangerousDeflateOptions = new() }
            );
        ...
        public async Task SendHelloWithEmptyFrame()
        {
            ...
            using WebSocket client = WebSocket.CreateFromStream(
                stream,
                new WebSocketCreationOptions { IsServer = false, DangerousDeflateOptions = new() }
            );
        ...
        public async Task ReceiveHelloWithoutContextTakeover()
        {
            ...
            using WebSocket websocket = WebSocket.CreateFromStream(
                ...
                {
                    DangerousDeflateOptions = new() { ClientContextTakeover = false }
                }
            );
        ...
        public async Task SendHelloWithoutContextTakeover()
        {
            ...
            using WebSocket websocket = WebSocket.CreateFromStream(
                ...
                {
                    IsServer = true,
                    DangerousDeflateOptions = new() { ServerContextTakeover = false }
                }
            );
        ...
        public async Task LargeMessageSplitInMultipleFrames(int windowBits)
        {
            ...
            using WebSocket server = WebSocket.CreateFromStream(
                ...
                {
                    IsServer = true,
                    DangerousDeflateOptions = new() { ClientMaxWindowBits = windowBits }
                }
            );
            using WebSocket client = WebSocket.CreateFromStream(
                stream.Remote,
