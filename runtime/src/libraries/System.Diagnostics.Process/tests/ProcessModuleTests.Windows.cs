...
namespace System.Diagnostics.Tests
{
    public partial class ProcessModuleTests : ProcessTestBase
    {
        ...
        {
            // To be able to test Long Path support for ProcessModule.FileName we need a .dll that has a path >
            // 260 chars.
            ...
            // Loading from new path is possible because the type exposed by the assembly is not referenced in
            // any explicit way.
