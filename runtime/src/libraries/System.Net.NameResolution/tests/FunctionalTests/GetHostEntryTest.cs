...
namespace System.Net.NameResolution.Tests
{
    public class GetHostEntryTest
    {
        ...
        public async Task Dns_GetHostEntryAsync_NullIPAddressHost_Fail()
        {
            ...
            await Assert.ThrowsAsync<ArgumentNullException>(() =>
                Task.Factory
                    .FromAsync(Dns.BeginGetHostEntry, Dns.EndGetHostEntry, (IPAddress)null, null)
            );
        }
        ...
        public async Task Dns_GetHostEntry_AnyIPAddress_Fail(IPAddress address)
        {
            ...
            await Assert.ThrowsAsync<ArgumentException>(() =>
                Task.Factory
                    .FromAsync(Dns.BeginGetHostEntry, Dns.EndGetHostEntry, address.ToString(), null)
            );
        }
        ...
        public async Task DnsGetHostEntry_BadName_ThrowsSocketException(string hostNameOrAddress)
        {
            ...
            await Assert.ThrowsAnyAsync<SocketException>(() =>
                Task.Factory
                    .FromAsync(Dns.BeginGetHostEntry, Dns.EndGetHostEntry, hostNameOrAddress, null)
            );
        }
