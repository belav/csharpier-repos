    ...
    public class MetricsTest
    {
        ...
        public static async Task ResolveInvalidHostName_MetricsRecorded()
        {
            const string InvalidHostName =
                $"invalid...example.com...{nameof(ResolveInvalidHostName_MetricsRecorded)}";
        ...
        private static double[] GetMeasurementsForHostname(
            InstrumentRecorder<double> recorder,
            string hostname,
            ...
            return recorder
                ...
                .Where(m =>
                {
                    ...
                    string? actualErrorType =
                        tags.FirstOrDefault(t => t.Key == "error.type").Value as string;
        ...
        private sealed class InstrumentRecorder<T> : IDisposable
            where T : struct
        {
            ...
            public InstrumentRecorder(string instrumentName)
            {
                ...
                {
                    if (
                        instrument.Meter.Name == "System.Net.NameResolution"
