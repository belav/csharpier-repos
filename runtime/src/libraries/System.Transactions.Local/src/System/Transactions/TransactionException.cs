...
namespace System.Transactions
{
    ...
    public class TransactionException : SystemException
    {
        ...
        internal static TransactionException Create(string? message, Exception? innerException)
        {
            ...
            if (etwLog.IsEnabled())
            {
                etwLog.TransactionExceptionTrace(
                    TransactionExceptionType.TransactionException,
                    message,
                    innerException == null ? string.Empty : innerException.ToString()
                );
            }
        ...
        internal static TransactionException Create(
    ...
    public class TransactionAbortedException : TransactionException
    {
        ...
        )
        {
            ...
            {
                etwLog.TransactionExceptionTrace(
                    TransactionExceptionType.TransactionAbortedException,
                    message,
                    innerException == null ? string.Empty : innerException.ToString()
                );
            }
    ...
    {
        internal static new TransactionInDoubtException Create(
            TraceSourceType traceSource,
            string? message,
            Exception? innerException,
            Guid distributedTxId
        ...
        )
        {
            ...
            if (etwLog.IsEnabled())
            {
                etwLog.TransactionExceptionTrace(
                    traceSource,
                    TransactionExceptionType.TransactionInDoubtException,
                    message,
                    innerException == null ? string.Empty : innerException.ToString()
                );
            }
    ...
    public class TransactionManagerCommunicationException : TransactionException
    {
        ...
        )
        {
            ...
            {
                etwLog.TransactionExceptionTrace(
                    TransactionExceptionType.TransactionManagerCommunicationException,
                    message,
                    innerException == null ? string.Empty : innerException.ToString()
                );
            }
