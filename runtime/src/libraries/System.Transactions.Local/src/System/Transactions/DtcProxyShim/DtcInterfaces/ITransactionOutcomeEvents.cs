...
{
    void Committed([MarshalAs(UnmanagedType.Bool)] bool fRetaining, IntPtr pNewUOW, int hresult);
    ...
    void HeuristicDecision(OletxTransactionHeuristic dwDecision, IntPtr pboidReason, int hresult);
