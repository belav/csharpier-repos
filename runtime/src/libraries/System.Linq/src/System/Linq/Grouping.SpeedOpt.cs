...
namespace System.Linq
{
        ...
        : IIListProvider<TResult>
    {
        public TResult[] ToArray() =>
            Lookup<TKey, TElement>
                ...
                .ToArray(_resultSelector);

        public List<TResult> ToList() =>
            Lookup<TKey, TElement>
                .Create(_source, _keySelector, _elementSelector, _comparer)
                .ToList(_resultSelector);

        public int GetCount(bool onlyIfCheap) =>
            onlyIfCheap
                ? -1
                : Lookup<TKey, TElement>
                      .Create(_source, _keySelector, _elementSelector, _comparer).Count;
    }
        ...
        : IIListProvider<IGrouping<TKey, TElement>>
    {
        ...
        {
            IIListProvider<IGrouping<TKey, TElement>> lookup = Lookup<TKey, TElement>
                .Create(_source, _keySelector, _elementSelector, _comparer);
        ...
        : IIListProvider<IGrouping<TKey, TSource>>
    {
        ...
        {
            IIListProvider<IGrouping<TKey, TSource>> lookup = Lookup<TKey, TSource>
