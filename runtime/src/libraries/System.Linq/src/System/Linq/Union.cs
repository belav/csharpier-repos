...
namespace System.Linq
{
    public static partial class Enumerable
    {
        ...
        /// <param name="first">An <see cref="IEnumerable{T}" /> whose distinct elements form the first set
        // for the union.</param>
        /// <param name="second">An <see cref="IEnumerable{T}" /> whose distinct elements form the second
        // set for the union.</param>
        /// <param name="keySelector">A function to extract the key for each element.</param>
        /// <returns>An <see cref="IEnumerable{T}" /> that contains the elements from both input sequences,
        ...
        // compare values.</para>
        /// <para>When the object returned by this method is enumerated, <see cref="O:Enumerable.UnionBy" />
        // enumerates <paramref name="first" /> and <paramref name="second" /> in that order and yields each
        // element that has not already been yielded.</para>
        /// </remarks>
