...
namespace System.Linq
{
    public static partial class Enumerable
    {
        ...
        // sequence.</returns>
        /// <remarks>
        /// <para>If the type of <paramref name="source" /> implements <see cref="IList{T}" />, that
        // implementation is used to obtain the element at the specified index. Otherwise, this method obtains
        // the specified element.</para>
        /// <para>This method throws an exception if <paramref name="index" /> is out of range. To instead
        // return a default value when the specified index is out of range, use the <see
        // cref="O:Enumerable.ElementAtOrDefault" /> method.</para>
        /// </remarks>
