    ...
    public partial class GroupByTests : EnumerableTests
    {
        ...
        public void SingleNullKeySingleNullElement()
        {
            ...
            AssertGroupingCorrect(
                key,
                element,
                new string[] { null }.GroupBy(e => e, e => e, EqualityComparer<string>.Default),
        ...
        public void SingleElementResultSelectorUsed()
        {
            ...
            Assert.Equal(
                ...
                source.GroupBy(
                    e => e.Name,
                    (k, es) => (long)(k ?? " ").Length * es.Sum(e => e.Score)
                )
            );
        }
        ...
        public void NullComparerResultSelectorUsed()
        {
            ...
            Assert.Equal(
                expected,
                source.GroupBy(e => e.Name, (k, es) => k.Length * es.Sum(e => (long)e.Score), null)
            );
        }
        ...
        public void GroupingWithElementSelectorToArray()
        {
            ...
            IGrouping<string, int>[] groupedArray = source.GroupBy(r => r.Name, e => e.Score)
                .ToArray();
            Assert.Equal(4, groupedArray.Length);
        ...
        public void GroupingWithElementSelectorAndResultsToArray()
        {
            ...
            IEnumerable<Record>[] groupedArray = source.GroupBy(r => r.Name, e => e, (r, e) => e)
                .ToArray();
            Assert.Equal(4, groupedArray.Length);
        ...
        public void GroupingWithElementSelectorToList()
        {
            ...
            List<IGrouping<string, int>> groupedList = source.GroupBy(r => r.Name, e => e.Score)
                .ToList();
            Assert.Equal(4, groupedList.Count);
        ...
        public void GroupingWithResultsToList()
        {
            ...
            List<IEnumerable<Record>> groupedList = source.GroupBy(r => r.Name, (r, e) => e)
                .ToList();
            Assert.Equal(4, groupedList.Count);
        ...
        public void GroupingWithElementSelectorAndResultsToList()
        {
            ...
            List<IEnumerable<Record>> groupedList = source.GroupBy(r => r.Name, e => e, (r, e) => e)
                .ToList();
            Assert.Equal(4, groupedList.Count);
        ...
        {
            Assert.Empty(
                Enumerable.Empty<int>().GroupBy(i => i, (x, y) => x + y.Count()).ToArray()
            );
        }
        ...
        public void EmptyGroupingWithResultCount()
        {
            Assert.Equal(
                0,
                Enumerable.Empty<int>().GroupBy(i => i, (x, y) => x + y.Count()).Count()
            );
        }
        ...
        public static void GroupingKeyIsPublic()
        {
            ...
            PropertyInfo key = grouptype.GetProperty(
                "Key",
