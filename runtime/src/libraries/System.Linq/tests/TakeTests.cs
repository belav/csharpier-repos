...
namespace System.Linq.Tests
{
    public class TakeTests : EnumerableTests
    {
        ...
        [SkipOnTargetFramework(
            ...
            ".NET Core optimizes Take(...).Skip(...) on lazy sequences to avoid unnecessary allocation. Without this optimization this test takes many minutes. See https://github.com/dotnet/corefx/pull/13628."
        )]
