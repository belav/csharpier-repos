...
namespace System.Linq.Tests
{
    public class MaxTests : EnumerableTests
    {
        ...
        public static IEnumerable<object[]> Max_Int_TestData()
        {
            ...
            {
                new int[] { -16, 0, 50, 100, 1000 }.Concat(Enumerable.Repeat(int.MaxValue, 1)),
                int.MaxValue
            };
        ...
        public static IEnumerable<object[]> Max_Long_TestData()
        {
            ...
            yield return new object[]
            {
                new long[] { -16, 0, 50, 100, 1000 }.Concat(Enumerable.Repeat(long.MaxValue, 1)),
                long.MaxValue
            };
        ...
        public static IEnumerable<object[]> Max_Float_TestData()
        {
            ...
            yield return new object[]
            {
                new float[] { -16, 0, 50, 100, 1000 }.Concat(Enumerable.Repeat(float.MaxValue, 1)),
                float.MaxValue
            };
            ...
            yield return new object[]
            {
                new float[] { 6.8f, 9.4f, -10f, 0f, float.NaN, 53.6f },
                53.6f
            };
            yield return new object[]
            {
                new float[] { -5.5f, float.PositiveInfinity, 9.9f, float.PositiveInfinity },
        ...
        public static IEnumerable<object[]> Max_Double_TestData()
        {
            ...
            yield return new object[]
            {
                new double[] { -5.5, double.PositiveInfinity, 9.9, double.PositiveInfinity },
                double.PositiveInfinity
            };
            yield return new object[]
            {
                new double[] { double.NaN, 6.8, 9.4, 10.5, 0, -5.6 },
                10.5
            };
            yield return new object[]
            {
                new double[] { 6.8, 9.4, 10.5, 0, -5.6, double.NaN },
                10.5
            };
            yield return new object[]
            {
            ...
            yield return new object[]
            {
                new double[] { -1F, -10, double.NaN, 10, 200, 1000 },
                1000.0
            };
            yield return new object[]
            {
        ...
        public static IEnumerable<object[]> Max_Decimal_TestData()
        {
            ...
            yield return new object[]
            {
                new decimal[] { 6.8m, 9.4m, 10m, 0m, 0m, decimal.MaxValue },
                decimal.MaxValue
            };
        ...
        public static IEnumerable<object[]> Max_NullableInt_TestData()
        {
            ...
            yield return new object[]
            {
                Enumerable.Range(1, 10).Select(i => (int?)i).ToArray(),
                10
            };
        ...
        public static IEnumerable<object[]> Max_NullableLong_TestData()
        {
            ...
            yield return new object[]
            {
                new long?[] { long.MaxValue, null, 9, 10, null, 7, 8 },
                long.MaxValue
            };
            yield return new object[]
            {
        ...
        public static IEnumerable<object[]> Max_NullableFloat_TestData()
        {
            ...
            yield return new object[]
            {
                new float?[] { 14.50f, null, float.NaN, 10.98f, null, 7.5f, 8.6f },
                14.50f
            };
        ...
        public static IEnumerable<object[]> Max_NullableDouble_TestData()
        {
            ...
            yield return new object[]
            {
                new double?[] { 14.50, null, double.NaN, 10.98, null, 7.5, 8.6 },
                14.50
            };
            ...
            yield return new object[]
            {
                new double?[] { double.NaN, 6.8, 9.4, 10.5, 0, null, -5.6 },
                10.5
            };
            yield return new object[]
            {
                new double?[] { 6.8, 9.4, 10.8, 0, null, -5.6, double.NaN },
                10.8
            };
            yield return new object[]
            {
        ...
        public static IEnumerable<object[]> Max_NullableDecimal_TestData()
        {
            ...
            yield return new object[]
            {
                new decimal?[] { 14.50m, null, null, 10.98m, null, 7.5m, 8.6m },
                14.50m
            };
        ...
        public static IEnumerable<object[]> Max_DateTime_TestData()
        {
            ...
            yield return new object[]
            {
                threeThousand.Concat(Enumerable.Repeat(DateTime.MaxValue, 1)),
                DateTime.MaxValue
            };
        }
        ...
        public static IEnumerable<object[]> Max_String_TestData()
        {
            ...
            yield return new object[]
            {
                new string[] { "Alice", "Bob", "Charlie", "Eve", "Mallory", "Victor", "Trent" },
                "Victor"
            };
            yield return new object[]
            {
            ...
            yield return new object[]
            {
                new string[] { "zzz", "aaa", "abcd", "bark", "temp", "cat" },
                "zzz"
            };
            yield return new object[] { new string[] { null, null, null, null, "aAa" }, "aAa" };
            yield return new object[]
            {
                new string[] { "ooo", "ccc", "ccc", "ooo", "ooo", "nnn" },
                "ooo"
            };
        ...
        public static void Max_Generic_HasExpectedOutput<TSource>(
        ...
        [Theory]
        [MemberData(nameof(Max_Generic_TestData))]
        public static void Max_Generic_RunOnce_HasExpectedOutput<TSource>(
            IEnumerable<TSource> source,
            IComparer<TSource>? comparer,
            TSource? expected
        )
        ...
        public static IEnumerable<object[]> Max_Generic_TestData()
        {
            ...
            yield return WrapArgs(source: Enumerable.Range(0, 10), comparer: null, expected: 9);
        ...
        public static void MaxBy_Generic_EmptyNullableSource_ReturnsNull()
        {
            ...
            Assert.Null(
                Enumerable
                    .Empty<int?>()
                    .MaxBy(x => x.GetHashCode(), Comparer<int>.Create((_, _) => 0))
            );
        }
        ...
        public static void MaxBy_Generic_NullableSourceAllKeysAreNull_ReturnsFirstElement()
        {
            ...
            Assert.Equal(
                0,
                Enumerable.Range(0, 5).Cast<int?>().MaxBy(x => default(int?), comparer: null)
            );
            Assert.Equal(
                0,
                Enumerable
        ...
        public static void MaxBy_Generic_ReferenceSourceAllKeysAreNull_ReturnsFirstElement()
        {
            Assert.Equal(
                "0",
                Enumerable.Range(0, 5).Select(x => x.ToString()).MaxBy(x => default(string))
            );
            Assert.Equal(
                "0",
                Enumerable
                    .Range(0, 5)
                    .Select(x => x.ToString())
                    .MaxBy(x => default(string), comparer: null)
            );
            Assert.Equal(
                "0",
                Enumerable
        ...
        public static void MaxBy_Generic_HasExpectedOutput<TSource, TKey>(
            IEnumerable<TSource> source,
        ...
        [Theory]
        [MemberData(nameof(MaxBy_Generic_TestData))]
        public static void MaxBy_Generic_RunOnce_HasExpectedOutput<TSource, TKey>(
            IEnumerable<TSource> source,
            Func<TSource, TKey> keySelector,
            IComparer<TKey>? comparer,
            TSource? expected
