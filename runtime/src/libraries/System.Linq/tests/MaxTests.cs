        ...
        public static IEnumerable<object[]> Max_Long_TestData()
        {
            foreach (
                (long[] array, long expected) in new[]
                {
                    ...
                    (
                        new long[] { -16, 0, 50, 100, 1000 }
                            .Concat(Enumerable.Repeat(long.MaxValue, 1))
                            .ToArray(),
                        long.MaxValue
                    ),
        ...
        public static IEnumerable<object[]> Max_Float_TestData()
        {
            foreach (
                (float[] array, float expected) in new[]
                {
                    ...
                    (
                        new float[] { -16, 0, 50, 100, 1000 }
                            .Concat(Enumerable.Repeat(float.MaxValue, 1))
                            .ToArray(),
                        float.MaxValue
                    ),
                    (new[] { 5.5f }, 5.5f),
