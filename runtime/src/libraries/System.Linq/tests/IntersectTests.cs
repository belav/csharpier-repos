...
namespace System.Linq.Tests
{
    public class IntersectTests : EnumerableTests
    {
        ...
        {
            var first = from x1 in new int?[] { 2, 3, null, 2, null, 4, 5 } select x1;
            var second = from x2 in new int?[] { 1, 9, null, 4 } select x2;
        ...
        public static IEnumerable<object[]> String_TestData()
        {
            ...
            yield return new object[]
            {
                new string[] { "Tim", "Bob", "Mike", "Robert" },
                new string[] { "ekiM", "bBo" },
                null,
                new string[0],
            };
        ...
        public static IEnumerable<object[]> NullableInt_TestData()
        {
            ...
            {
                new int?[0],
                new int?[] { -5, 0, null, 1, 2, 9, 2 },
                new int?[0],
            };
            yield return new object[]
            {
                new int?[] { -5, 0, 1, 2, null, 9, 2 },
                new int?[0],
                new int?[0],
            };
            yield return new object[]
            {
                new int?[] { 1, 2, null, 3, 4, 5, 6 },
                new int?[] { 6, 7, 7, 7, null, 8, 1 },
                new int?[] { 1, null, 6 },
            };
        }
        ...
        public void ForcedToEnumeratorDoesntEnumerate()
        {
            var iterator = NumberRangeGuaranteedNotCollectionType(0, 3)
                .Intersect(Enumerable.Range(0, 3));
        ...
        public void HashSetWithBuiltInComparer_HashSetContainsNotUsed()
        {
            ...
            Assert.Equal(
                ...
                input1.Intersect(input2, EqualityComparer<string>.Default)
            );
            ...
            Assert.Equal(
                Enumerable.Empty<string>(),
                input2.Intersect(input1, EqualityComparer<string>.Default)
            );
        ...
        public static void IntersectBy_HasExpectedOutput<TSource, TKey>(
        ...
        [Theory]
        [MemberData(nameof(IntersectBy_TestData))]
        public static void IntersectBy_RunOnce_HasExpectedOutput<TSource, TKey>(
            IEnumerable<TSource> first,
            IEnumerable<TKey> second,
            Func<TSource, TKey> keySelector,
            IEqualityComparer<TKey>? comparer,
