...
namespace System.Linq.Tests
{
    public class ExceptTests : EnumerableTests
    {
        ...
        public static IEnumerable<object[]> String_TestData()
        {
            ...
            yield return new object[]
            {
                new string[] { null, null, string.Empty },
                new string[1],
                defaultComparer,
            ...
            yield return new object[]
            {
                new string[] { "Bob", "Tim", "Robert", "Chris" },
                new string[] { "bBo", "shriC" },
                null,
                new string[] { "Bob", "Tim", "Robert", "Chris" },
            };
            yield return new object[]
        ...
        public static IEnumerable<object[]> NullableInt_TestData()
        {
            yield return new object[]
            {
                new int?[] { -6, -8, -6, 2, 0, 0, 5, 6, null, null },
                new int?[0],
                new int?[] { -6, -8, 2, 0, 5, 6, null },
            };

            yield return new object[]
            {
                new int?[] { 1, 2, 2, 3, 4, 5 },
                new int?[] { 5, 3, 2, 6, 6, 3, 1, null, null },
                new int?[] { 4 },
            };
            yield return new object[]
            {
                new int?[] { 2, 3, null, 2, null, 4, 5 },
                new int?[] { 1, 9, null, 4 },
                new int?[] { 2, 3, 5 },
            };
        }
        ...
        public void HashSetWithBuiltInComparer_HashSetContainsNotUsed()
        {
            ...
            Assert.Equal(
                ...
                input1.Except(input2, StringComparer.OrdinalIgnoreCase)
            );
            ...
            Assert.Equal(
                Enumerable.Empty<string>(),
                input2.Except(input1, StringComparer.OrdinalIgnoreCase)
            );
        }
        ...
        public static void ExceptBy_HasExpectedOutput<TSource, TKey>(
        ...
        [Theory]
        [MemberData(nameof(ExceptBy_TestData))]
        public static void ExceptBy_RunOnce_HasExpectedOutput<TSource, TKey>(
            IEnumerable<TSource> first,
            IEnumerable<TKey> second,
            Func<TSource, TKey> keySelector,
            IEqualityComparer<TKey>? comparer,
