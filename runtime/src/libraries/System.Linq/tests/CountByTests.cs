...
namespace System.Linq.Tests
{
    public class CountByTests : EnumerableTests
    {
        ...
        public static void CountBy_HasExpectedOutput<TSource, TKey>(
            IEnumerable<TSource> source,
            Func<TSource, TKey> keySelector,
            IEqualityComparer<TKey>? comparer,
            IEnumerable<KeyValuePair<TKey, int>> expected
        )
        {
        ...
        [MemberData(nameof(CountBy_TestData))]
        public static void CountBy_RunOnce_HasExpectedOutput<TSource, TKey>(
            IEnumerable<TSource> source,
            Func<TSource, TKey> keySelector,
            IEqualityComparer<TKey>? comparer,
            IEnumerable<KeyValuePair<TKey, int>> expected
        ...
        public static IEnumerable<object[]> CountBy_TestData()
        {
            ...
            yield return WrapArgs(
                ...
                expected: new Dictionary<string, int>() { { "Bob", 3 }, { "tim", 2 } }
            );
            ...
            yield return WrapArgs(
                ...
                keySelector: x => x.Age,
                comparer: null,
                expected: new Dictionary<int, int>() { { 20, 2 }, { 40, 1 } }
            );
            ...
            yield return WrapArgs(
                ...
                expected: new Dictionary<string, int>() { { "Bob", 2 }, { "Harry", 1 } }
            );
