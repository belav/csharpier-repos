...
namespace System.Linq.Tests
{
    public class ChunkTests : EnumerableTests
    {
        ...
        [Theory]
        [InlineData(
            new[] { 9999, 0, 888, -1, 66, -777, 1, 2, -12345 },
            typeof(TestReadOnlyCollection<int>)
        )]
        [InlineData(
            new[] { 9999, 0, 888, -1, 66, -777, 1, 2, -12345 },
            typeof(TestCollection<int>)
        )]
        [InlineData(
            new[] { 9999, 0, 888, -1, 66, -777, 1, 2, -12345 },
            typeof(TestEnumerable<int>)
        )]
        ...
        public void RemovingFromSourceBeforeIterating()
        {
            ...
            Assert.Equal(
                new[] { new[] { 9999, 0, 888 }, new[] { -1, -777, 1 }, new[] { 2, -12345 } },
                chunks
            );
        }
