...
namespace System.Linq.Tests
{
    public class OrderedSubsetting : EnumerableTests
    {
        ...
        [SkipOnTargetFramework(
            ...
            "This fails with an OOM, as it iterates through the large array. See https://github.com/dotnet/corefx/pull/6821."
        )]
        ...
        {
            var iterator = Enumerable.Range(-1, 8)
                .Shuffle()
                .OrderBy(i => i)
                .Skip(1)
                .Take(5)
