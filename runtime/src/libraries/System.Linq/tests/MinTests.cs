...
namespace System.Linq.Tests
{
    public class MinTests : EnumerableTests
    {
        ...
        {
            foreach (
                (int[] array, long expected) in new[]
                {
                    (new[] { 42 }, 42),
            ...
            for (int length = 2; length < 33; length++)
            {
                ...
                {
                    Shuffler.Shuffle(Enumerable.Range(length, length)),
                    length
                };
                yield return new object[]
                {
                    Shuffler.Shuffle(Enumerable.Range(length, length).ToArray()),
                    length
                };
            }
        }
        ...
        {
            foreach (
                (long[] array, long expected) in new[]
                {
                    (new[] { 42L }, 42L),
                    ...
                    (
                        new long[] { 3000, 100, 200, 1000 }
                            .Concat(Enumerable.Repeat(long.MinValue, 1))
                            .ToArray(),
                        long.MinValue
                    ),
        ...
        {
            foreach (
                (float[] array, float expected) in new[]
                {
                    (new[] { 42f }, 42f),
                    ...
                    (
                        new float[] { 3000, 100, 200, 1000 }
                            .Concat(Enumerable.Repeat(float.MinValue, 1))
                            .ToArray(),
                        float.MinValue
                    ),
                    (new[] { 5.5f }, 5.5f),
        ...
        {
            foreach (
                (double[] array, double expected) in new[]
                {
                    (new[] { 42.0 }, 42.0),
                    ...
                    (
                        new double[] { 3000, 100, 200, 1000 }
                            .Concat(Enumerable.Repeat(double.MinValue, 1))
                            .ToArray(),
                        double.MinValue
                    ),
                    (new[] { 5.5 }, 5.5),
        ...
        {
            foreach (
                (decimal[] array, decimal expected) in new[]
                {
                    (new[] { 42m }, 42m),
