...
namespace System.Linq.Tests
{
    public class MinTests : EnumerableTests
    {
        ...
        public static IEnumerable<object[]> Min_Int_TestData()
        {
            ...
            {
                new int[] { 3000, 100, 200, 1000 }.Concat(Enumerable.Repeat(int.MinValue, 1)),
                int.MinValue
            };
        ...
        public static IEnumerable<object[]> Min_Long_TestData()
        {
            ...
            yield return new object[]
            {
                new long[] { 3000, 100, 200, 1000 }.Concat(Enumerable.Repeat(long.MinValue, 1)),
                long.MinValue
            };

            yield return new object[]
            {
                Enumerable.Repeat(int.MaxValue + 10L, 1),
                int.MaxValue + 10L
            };
            ...
            yield return new object[]
            {
                new long[] { 6, 9, 10, 0, -int.MaxValue - 50L },
                -int.MaxValue - 50L
            };
        ...
        public static IEnumerable<object[]> Min_Float_TestData()
        {
            ...
            yield return new object[]
            {
                new float[] { 3000, 100, 200, 1000 }.Concat(Enumerable.Repeat(float.MinValue, 1)),
                float.MinValue
            };
            ...
            yield return new object[]
            {
                new float[] { -5.5f, float.NegativeInfinity, 9.9f, float.NegativeInfinity },
                float.NegativeInfinity
            };

            yield return new object[]
            {
                new float[] { float.NaN, 6.8f, 9.4f, 10f, 0, -5.6f },
                float.NaN
            };
            yield return new object[]
            {
                new float[] { 6.8f, 9.4f, 10f, 0, -5.6f, float.NaN },
                float.NaN
            };
            yield return new object[]
            {
            ...
            yield return new object[]
            {
                Enumerable
                    .Range(1, 10)
                    .Select(i => (float)i)
                    .Concat(Enumerable.Repeat(float.NaN, 1))
                    .ToArray(),
                float.NaN
            };
            yield return new object[]
            {
                new float[] { -1F, -10, float.NaN, 10, 200, 1000 },
                float.NaN
            };
            yield return new object[]
            {
                new float[] { float.MinValue, 3000F, 100, 200, float.NaN, 1000 },
                float.NaN
            };
        }
        ...
        public static IEnumerable<object[]> Min_Double_TestData()
        {
            ...
            yield return new object[]
            {
                new double[] { 3000, 100, 200, 1000 }.Concat(Enumerable.Repeat(double.MinValue, 1)),
                double.MinValue
            };
            ...
            yield return new object[]
            {
                new double[] { -5.5, double.NegativeInfinity, 9.9, double.NegativeInfinity },
            ...
            yield return new object[]
            {
                new double[] { double.NaN, 6.8, 9.4, 10, 0, -5.6 },
                double.NaN
            };
            yield return new object[]
            {
            ...
            yield return new object[]
            {
                Enumerable
                    .Range(1, 10)
                    .Select(i => (double)i)
                    .Concat(Enumerable.Repeat(double.NaN, 1))
                    .ToArray(),
                double.NaN
            };
            yield return new object[]
            {
                new double[] { -1, -10, double.NaN, 10, 200, 1000 },
                double.NaN
            };
            yield return new object[]
            {
                new double[] { double.MinValue, 3000F, 100, 200, double.NaN, 1000 },
                double.NaN
            };
        }
        ...
        public static IEnumerable<object[]> Min_Decimal_TestData()
        {
            ...
            yield return new object[]
            {
                new decimal[] { 6.8m, 9.4m, 10m, 0m, 0m, decimal.MinValue },
                decimal.MinValue
            };
        ...
        public static void Min_Generic_HasExpectedOutput<TSource>(
        ...
        [Theory]
        [MemberData(nameof(Min_Generic_TestData))]
        public static void Min_Generic_RunOnce_HasExpectedOutput<TSource>(
            IEnumerable<TSource> source,
            IComparer<TSource>? comparer,
            TSource? expected
        )
        ...
        {
            yield return WrapArgs(source: Enumerable.Empty<int?>(), comparer: null, expected: null);
            ...
            yield return WrapArgs(source: Enumerable.Range(0, 10), comparer: null, expected: 0);
        ...
        public static void MinBy_Generic_EmptyNullableSource_ReturnsNull()
        {
            ...
            Assert.Null(
                Enumerable
                    .Empty<int?>()
                    .MinBy(x => x.GetHashCode(), Comparer<int>.Create((_, _) => 0))
            );
        }
        ...
        public static void MinBy_Generic_NullableSourceAllKeysAreNull_ReturnsFirstElement()
        {
            ...
            Assert.Equal(
                0,
                Enumerable.Range(0, 5).Cast<int?>().MinBy(x => default(int?), comparer: null)
            );
            Assert.Equal(
                0,
                Enumerable
        ...
        public static void MinBy_Generic_ReferenceSourceAllKeysAreNull_ReturnsFirstElement()
        {
            Assert.Equal(
                "0",
                Enumerable.Range(0, 5).Select(x => x.ToString()).MinBy(x => default(string))
            );
            Assert.Equal(
                "0",
                Enumerable
                    .Range(0, 5)
                    .Select(x => x.ToString())
                    .MinBy(x => default(string), comparer: null)
            );
            Assert.Equal(
                "0",
                Enumerable
        ...
        public static void MinBy_Generic_HasExpectedOutput<TSource, TKey>(
            IEnumerable<TSource> source,
        ...
        [Theory]
        [MemberData(nameof(MinBy_Generic_TestData))]
        public static void MinBy_Generic_RunOnce_HasExpectedOutput<TSource, TKey>(
            IEnumerable<TSource> source,
            Func<TSource, TKey> keySelector,
            IComparer<TKey>? comparer,
            TSource? expected
