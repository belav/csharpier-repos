...
namespace System.ServiceProcess.Tests
{
    ...
    public class ServiceControllerTests : IDisposable
    {
        ...
        public void Dependencies()
        {
            ...
            var dependentController = new ServiceController(
                _testService.TestServiceName + ".Dependent"
            );
            ...
            Assert.Equal(
                ...
                dependentController.ServiceName
            );
            Assert.Equal(
                dependentController.DependentServices[0].ServiceName,
