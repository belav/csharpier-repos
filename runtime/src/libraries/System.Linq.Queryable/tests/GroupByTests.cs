    ...
    public class GroupByTests : EnumerableBasedTests
    {
        ...
        public void SingleNullKeySingleNullElement()
        {
            ...
            AssertGroupingCorrect(
                ...
                new string[] { null }
                    .AsQueryable()
                    .GroupBy(e => e, e => e, EqualityComparer<string>.Default),
        ...
        public void SourceIsNull()
        {
            ...
            AssertExtensions.Throws<ArgumentNullException>("source", () =>
                source.GroupBy(e => e.Name, e => e.Score)
            );
            AssertExtensions.Throws<ArgumentNullException>("source", () =>
                source.GroupBy(e => e.Name)
            );
            AssertExtensions.Throws<ArgumentNullException>("source", () =>
                source.GroupBy(
                    e => e.Name,
        ...
        public void KeySelectorNull()
        {
            ...
            AssertExtensions.Throws<ArgumentNullException>("keySelector", () =>
                source.AsQueryable().GroupBy(null, e => e.Score, new AnagramEqualityComparer())
            );
            AssertExtensions.Throws<ArgumentNullException>("keySelector", () =>
                source
                    .AsQueryable()
                    .GroupBy(null, e => e.Score, (k, es) => es.Sum(), new AnagramEqualityComparer())
            );
            AssertExtensions.Throws<ArgumentNullException>("keySelector", () =>
                source.AsQueryable().GroupBy(keySelector, e => e.Score, (k, es) => es.Sum())
            );
            AssertExtensions.Throws<ArgumentNullException>("keySelector", () =>
                source.AsQueryable().GroupBy(keySelector, e => e.Score)
            );
            AssertExtensions.Throws<ArgumentNullException>("keySelector", () =>
                source.AsQueryable().GroupBy(keySelector, e => e.Score, (k, es) => es.Sum())
            );
            AssertExtensions.Throws<ArgumentNullException>("keySelector", () =>
                source
                    .AsQueryable()
                    .GroupBy(null, (k, es) => es.Sum(e => e.Score), new AnagramEqualityComparer())
            );
            AssertExtensions.Throws<ArgumentNullException>("keySelector", () =>
                source.AsQueryable().GroupBy(keySelector, (k, es) => es.Sum(e => e.Score))
            );
            AssertExtensions.Throws<ArgumentNullException>("keySelector", () =>
                source.AsQueryable().GroupBy(null, new AnagramEqualityComparer())
            );
            AssertExtensions.Throws<ArgumentNullException>("keySelector", () =>
                source.AsQueryable().GroupBy(keySelector)
            );
        }
        ...
        public void ElementSelectorNull()
        {
            ...
            AssertExtensions.Throws<ArgumentNullException>("elementSelector", () =>
                source.AsQueryable().GroupBy(e => e.Name, elementSelector)
            );
            AssertExtensions.Throws<ArgumentNullException>("elementSelector", () =>
                source
                    .AsQueryable()
                    .GroupBy(e => e.Name, elementSelector, new AnagramEqualityComparer())
            );
            AssertExtensions.Throws<ArgumentNullException>("elementSelector", () =>
                source.AsQueryable().GroupBy(e => e.Name, elementSelector, (k, es) => es.Sum())
            );
            AssertExtensions.Throws<ArgumentNullException>("elementSelector", () =>
                source
                    .AsQueryable()
        ...
        public void ResultSelectorNullNoComparer()
        {
            ...
            AssertExtensions.Throws<ArgumentNullException>("resultSelector", () =>
                source.AsQueryable().GroupBy(e => e.Name, e => e.Score, resultSelector)
            );
        }
        ...
        public void ResultSelectorNullNoElementSelector()
        {
            ...
            AssertExtensions.Throws<ArgumentNullException>("resultSelector", () =>
                source.AsQueryable().GroupBy(e => e.Name, resultSelector)
            );
        }
        ...
        public void ResultSelectorNullNoElementSelectorCustomComparer()
        {
            ...
            AssertExtensions.Throws<ArgumentNullException>("resultSelector", () =>
                source
                    .AsQueryable()
                    .GroupBy(e => e.Name, resultSelector, new AnagramEqualityComparer())
            );
        }
        ...
        public void SingleNonNullElement()
        {
            ...
            AssertGroupingCorrect(
                key.AsQueryable(),
                source.AsQueryable(),
                source.AsQueryable().GroupBy(e => e.Name)
            );
        }
        ...
        public void AllElementsSameKey()
        {
            ...
            AssertGroupingCorrect(
                key.AsQueryable(),
                source.AsQueryable(),
                source.AsQueryable().GroupBy(e => e.Name, new AnagramEqualityComparer()),
                new AnagramEqualityComparer()
            );
        }
        ...
        public void AllElementsSameKeyResultSelectorUsed()
        {
            ...
            Assert.Equal(
                ...
                source
                    ...
                    .GroupBy(
                        e => e.Name,
                        (k, es) => k.Length * es.Sum(e => (long)e.Score),
                        new AnagramEqualityComparer()
                    )
            );
        }
        ...
        public void NullComparerResultSelectorUsed()
        {
            ...
            Assert.Equal(
                ...
                source
                    .AsQueryable()
                    .GroupBy(e => e.Name, (k, es) => k.Length * es.Sum(e => (long)e.Score), null)
            );
        }
        ...
        public void GroupBy2()
        {
            var count = new[] { 0, 1, 2, 2, 0 }
                .AsQueryable()
                .GroupBy(n => n, EqualityComparer<int>.Default)
                .Count();
            Assert.Equal(3, count);
        }
        ...
        public void GroupBy4()
        {
            var count = new[] { 0, 1, 2, 2, 0 }
                .AsQueryable()
                .GroupBy(n => n, n => n, EqualityComparer<int>.Default)
                .Count();
            Assert.Equal(3, count);
        }
        ...
        public void GroupBy7()
        {
            var count = new[] { 0, 1, 2, 2, 0 }
                .AsQueryable()
                .GroupBy(n => n, n => n, (k, g) => k, EqualityComparer<int>.Default)
                .Count();
            Assert.Equal(3, count);
        }
        ...
        public void GroupBy8()
        {
            var count = new[] { 0, 1, 2, 2, 0 }
                .AsQueryable()
                .GroupBy(n => n, (k, g) => k, EqualityComparer<int>.Default)
                .Count();
            Assert.Equal(3, count);
        }
    }
