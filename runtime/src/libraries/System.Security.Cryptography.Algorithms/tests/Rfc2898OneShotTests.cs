...
namespace System.Security.Cryptography.DeriveBytesTests
{
    ...
    public static class Rfc2898OneShotTests
    {
        ...
        )
        {
            ...
            using (
                Rfc2898DeriveBytes instanceKdf = new Rfc2898DeriveBytes(
                    password,
                    salt,
                    iterations,
                    hashAlgorithmName
        ...
        public static void Pbkdf2_Rfc6070(
            string password,
            string salt,
            int iterations,
            string expectedHex
        ...
        [Fact]
        [OuterLoop(
            "Uses a high number of iterations that can take over 20 seconds on some machines"
        )]
        ...
        public static IEnumerable<object[]> Pbkdf2_PasswordBytes_Compare_Data()
        {
            ...
            foreach (HashAlgorithmName hashAlgorithm in SupportedHashAlgorithms)
            {
                ...
                yield return new object[]
                {
                    ...
                    1,
                    1,
                    s_passwordBytes.ByteArrayToHex(),
                    s_salt.ByteArrayToHex()
                };
