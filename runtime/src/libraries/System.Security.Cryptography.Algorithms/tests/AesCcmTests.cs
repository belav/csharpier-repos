    ...
    public class AesCcmTests : AesAEADTests
    {
        ...
        private static readonly AEADTest[] s_nistCcmTestVectorsSelectedCases = new AEADTest[]
        {
            ...
            new AEADTest
            {
                ...
                Nonce = "5a8aa485c316e9".HexToByteArray(),
                Plaintext = Array.Empty<byte>(),
                AssociatedData = "3796cf51b8726652a4204733b8fbb047cf00fb91a9837e22ec22b1a268f88e2c"
                    .HexToByteArray(),
                Ciphertext = Array.Empty<byte>(),
            ...
            new AEADTest
            {
                ...
                Nonce = "a544218dadd3c1".HexToByteArray(),
                Plaintext = Array.Empty<byte>(),
                AssociatedData = "d3d5424e20fbec43ae495353ed830271515ab104f8860c988d15b6d36c038eab"
                    .HexToByteArray(),
                Ciphertext = Array.Empty<byte>(),
            ...
            new AEADTest
            {
                ...
                AssociatedData = "0b3e8d9785c74c8f41ea257d4d87495ffbbb335542b12e0d62bb177ec7a164d9"
                    .HexToByteArray(),
            ...
            new AEADTest
            {
                ...
                AssociatedData = "2f1821aa57e5278ffd33c17d46615b77363149dbc98470413f6543a6b749f2ca"
                    .HexToByteArray(),
            ...
            new AEADTest
            {
                ...
                AssociatedData = "17c87889a2652636bcf712d111c86b9d68d64d18d531928030a5ec97c59931a4"
                    .HexToByteArray(),
            ...
            new AEADTest
            {
                ...
                AssociatedData = "26c12e5cdfe225a5be56d7a8aaf9fd4eb327d2f29c2ebc7396022f884f33ce54"
                    .HexToByteArray(),
            ...
            new AEADTest
            {
                ...
                AssociatedData = "0245484bcd987787fe97fda6c8ffb6e7058d7b8f7064f27514afaac4048767fd"
                    .HexToByteArray(),
            ...
            new AEADTest
            {
                ...
                AssociatedData = "6e80dd7f1badf3a1c9ab25c75f10bde78c23fa0eb8f9aaa53adefbf4cbf78fe4"
                    .HexToByteArray(),
            ...
            new AEADTest
            {
                ...
                AssociatedData = "64f8a0eee5487a4958a489ed35f1327e2096542c1bdb2134fb942ca91804c274"
                    .HexToByteArray(),
            ...
            new AEADTest
            {
                ...
                AssociatedData = "4efbd225553b541c3f53cabe8a1ac03845b0e846c8616b3ea2cc7d50d344340c"
                    .HexToByteArray(),
            ...
            new AEADTest
            {
                ...
                AssociatedData = "feccf08d8c3a9be9a2c0f93f888e486b0076e2e9e2fd068c04b2db735cbeb23a"
                    .HexToByteArray(),
            ...
            new AEADTest
            {
                ...
                AssociatedData = "308443033ecd4a814475672b814b7c6d813d0ec2a0caeecbcaba18a2840cdb6c"
                    .HexToByteArray(),
            ...
            new AEADTest
            {
                ...
                AssociatedData = "a355d4c611812e5f9258d7188b3df8851477094ffc2af2cf0c8670db903fbbe0"
                    .HexToByteArray(),
            ...
            new AEADTest
            {
                ...
                AssociatedData = "d50741d34c8564d92f396b97be782923ff3c855ea9757bde419f632c83997630"
                    .HexToByteArray(),
            ...
            new AEADTest
            {
                ...
                AssociatedData = "48e06c3b2940819e58eb24122a2988c997697347a6e34c21267d76049febdcf8"
                    .HexToByteArray(),
            ...
            new AEADTest
            {
                ...
                AssociatedData = "7f596bc7a815d103ed9f6dc428b60e72aeadcb9382ccde4ac9f3b61e7e8047fd"
                    .HexToByteArray(),
            ...
            new AEADTest
            {
                ...
                AssociatedData = "282f05f734f249c0535ee396282218b7c4913c39b59ad2a03ffaf5b0e9b0f780"
                    .HexToByteArray(),
