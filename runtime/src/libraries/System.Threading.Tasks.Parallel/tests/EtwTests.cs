            ...
            RemoteExecutor.Invoke(
                    () =>
                    {
                        ...
                        using (
                            ...
                            Assert.Equal(
                                expected: 1,
                                actual: events.Count(i => i == BeginLoopEventId)
                            );
                            Assert.Equal(
                                expected: 1,
                                actual: events.Count(i => i == BeginInvokeEventId)
                            );
                            ...
                            Assert.Equal(
                                expected: 1,
                                actual: events.Count(i => i == EndLoopEventId)
                            );
                            Assert.Equal(
                                expected: 1,
                                actual: events.Count(i => i == EndInvokeEventId)
                            );
                            ...
                            Assert.Equal(
                                events.Count(i => i == ForkEventId),
                                events.Count(i => i == JoinEventId)
                            );
                        }
                    }
                )
