    ...
    public static class Partitioner1Chunk
    {
        ...
        public static void OneMoveNext()
        {
            static void oneMoveNext(int length, bool isOrderable)
            {
                ...
                if (isOrderable)
                {
                    IEnumerator<KeyValuePair<long, int>> enumerator =
                        partitioner.GetOrderableDynamicPartitions().GetEnumerator();
                ...
                {
                    IEnumerator<int> enumerator = partitioner.GetDynamicPartitions()
                        .GetEnumerator();
