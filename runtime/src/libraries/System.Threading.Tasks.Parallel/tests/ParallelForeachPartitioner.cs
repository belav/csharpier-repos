...
namespace System.Threading.Tasks.Tests
{
    public static class ParallelForeachPartitionerTests
    {
        ...
        [InlineData(
            10,
            1,
            PartitionerType.ArrayBalancedOOB,
            WithParallelOption.None,
            ActionWithLocal.None,
            ActionWithState.None
        )]
        [InlineData(
            1,
            -1,
        ...
        [InlineData(
            ...
            3,
            PartitionerType.ArrayBalancedOOB,
            WithParallelOption.WithDOP,
            ActionWithLocal.HasFinally,
            ActionWithState.Stop
        )]
        [InlineData(
            97,
            97,
        ...
        [InlineData(
            10,
            10,
            PartitionerType.IEnumerableOOB,
            WithParallelOption.WithDOP,
            ActionWithLocal.None,
            ActionWithState.Stop
        )]
        ...
        [InlineData(
            10,
            -1,
            PartitionerType.IListBalancedOOB,
            WithParallelOption.WithDOP,
            ActionWithLocal.HasFinally,
            ActionWithState.None
        )]
        ...
        [InlineData(
            10,
            3,
            PartitionerType.RangePartitioner,
            WithParallelOption.WithDOP,
            ActionWithLocal.None,
            ActionWithState.None
        )]
        ...
        public static void TestForeach_Partitioner(
            int count,
            int chunkSize,
