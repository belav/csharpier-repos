...
namespace System.Reflection.Tests
{
    ...
    public class EventInfoTests
    {
        public static IEnumerable<object[]> AddEventHandler_TestData()
        {
            ...
            {
                TypeExtensions.GetEvent(typeof(EI_Class), "PublicEvent"),
                tc1,
                new VoidDelegate(tc1.PublicVoidMethod1),
                1,
            };
            yield return new object[]
            {
                TypeExtensions.GetEvent(typeof(EI_Class), "PublicStaticEvent"),
                null,
                new VoidDelegate(tc1.ProtectedInternalVoidMethod),
                2,
            };
            yield return new object[]
            {
                TypeExtensions.GetEvent(typeof(EI_Class), "PublicStaticEvent"),
                tc1,
                new VoidDelegate(tc1.PublicVoidMethod2),
                3,
            };
        }
        ...
        public void AddEventHandler_RemoveEventHandler(
            EventInfo eventInfo,
            EI_Class target,
            Delegate handler,
        ...
        )
        {
            ...
            Assert.Equal(
                expectedStaticVariable,
                EI_Class.AddEventHandler_RemoveEventHandler_Test_TrackingVariable
            );
        ...
        [Theory]
        [InlineData(
            nameof(EI_Class.PublicEvent),
            "Void add_PublicEvent(System.Reflection.Tests.VoidDelegate)",
            false
        )]
        [InlineData(
            "PrivateEvent",
            "Void add_PrivateEvent(System.Reflection.Tests.VoidDelegate)",
            true
        )]
        [InlineData(
            "ProtectedEvent",
            "Void add_ProtectedEvent(System.Reflection.Tests.VoidDelegate)",
            true
        )]
        [InlineData(
            nameof(EI_Class.ProtectedInternalEvent),
            "Void add_ProtectedInternalEvent(System.Reflection.Tests.VoidDelegate)",
            true
        )]
        ...
        [InlineData(
            nameof(EI_Class.PublicEvent),
            "Void remove_PublicEvent(System.Reflection.Tests.VoidDelegate)",
            false
        )]
        [InlineData(
            "PrivateEvent",
            "Void remove_PrivateEvent(System.Reflection.Tests.VoidDelegate)",
            true
        )]
        [InlineData(
            "ProtectedEvent",
            "Void remove_ProtectedEvent(System.Reflection.Tests.VoidDelegate)",
            true
        )]
        [InlineData(
            nameof(EI_Class.ProtectedInternalEvent),
            "Void remove_ProtectedInternalEvent(System.Reflection.Tests.VoidDelegate)",
            true
        )]
