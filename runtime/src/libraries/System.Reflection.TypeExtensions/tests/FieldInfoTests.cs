...
namespace System.Reflection.Tests
{
    public class FieldInfoTests
    {
        ...
        [InlineData(
            "s_protectedField",
            FieldAttributes.Family | FieldAttributes.Static,
            typeof(BindingFlags)
        )]
        [InlineData(
            "s_internalField",
        ...
        [InlineData(
            "s_protectedInternalField",
            FieldAttributes.FamORAssem | FieldAttributes.Static,
            typeof(int[])
        )]
        ...
        [InlineData(
            ...
            typeof(FI_GenericClass<string>.NestedClass)
        )]
        [InlineData(
            "_protectedInternalField",
            FieldAttributes.FamORAssem,
            typeof(FI_EmptyInterface)
        )]
        [InlineData(
            "ConstField",
        ...
        {
            FieldInfo field = TypeExtensions.GetField(
                typeof(FI_BaseClass),
                "_privateStringField",
                Helpers.AllFlags
            );
