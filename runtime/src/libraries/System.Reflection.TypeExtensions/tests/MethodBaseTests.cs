    ...
    public class MethodBaseTests
    {
        public static IEnumerable<object[]> ContainsGenericParameters_TestData()
        {
            ...
            yield return new object[]
            {
                TypeExtensions.GetMethod(
                    typeof(NonGenericClass),
                    nameof(NonGenericClass.TestMethod),
                    Helpers.AllFlags
                ),
                false,
            };
            yield return new object[]
            {
                TypeExtensions.GetMethod(
                    typeof(NonGenericClass),
                    nameof(NonGenericClass.TestPartialGenericMethod),
                    Helpers.AllFlags
                ),
                true,
            };
            yield return new object[]
            {
                TypeExtensions.GetMethod(
                    typeof(NonGenericClass),
                    nameof(NonGenericClass.TestGenericReturnTypeMethod),
                    Helpers.AllFlags
                ),
                true,
            };
            ...
            yield return new object[]
            {
                TypeExtensions.GetMethod(
                    ...
                    nameof(GenericClass<int>.TestMethod),
                    Helpers.AllFlags
                ),
                false,
            };
            ...
            yield return new object[]
            {
                TypeExtensions.GetMethod(
                    typeof(GenericClass<>),
                    nameof(GenericClass<int>.TestMultipleGenericMethod),
                    Helpers.AllFlags
                ),
                true,
            };
            ...
            yield return new object[]
            {
                TypeExtensions.GetMethod(
                    typeof(GenericClass<>),
                    nameof(GenericClass<int>.TestVoidMethod),
                    Helpers.AllFlags
                ),
                true,
            };
            ...
            yield return new object[]
            {
                TypeExtensions.GetConstructor(typeof(NonGenericClass), new Type[0]),
                false,
            };
            yield return new object[]
            {
                TypeExtensions.GetConstructor(typeof(NonGenericClass), new Type[] { typeof(int) }),
                false,
            };
        ...
        [InlineData(
            typeof(NonGenericClass),
            "TestMethod2",
            new Type[] { typeof(int), typeof(float), typeof(string) }
        )]
