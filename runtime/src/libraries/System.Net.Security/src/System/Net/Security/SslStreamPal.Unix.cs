    ...
    internal static class SslStreamPal
    {
        ...
        )
        {
            ...
            try
            {
                ...
                {
                    context = new SafeDeleteSslContext(
                ...
                return new SecurityStatusPal(
                    done ? SecurityStatusPalErrorCode.OK : SecurityStatusPalErrorCode.ContinueNeeded
                );
            }
            catch (Exception exc)
            {
        ...
        private static SecurityStatusPal EncryptDecryptHelper(
            SafeDeleteContext securityContext,
            ReadOnlyMemory<byte> input,
            int offset,
            int size,
        ...
        )
        {
            ...
            else
            {
                return new SecurityStatusPal(
                    SecurityStatusPalErrorCode.InternalError,
                    new Interop.OpenSsl.SslException((int)code)
                );
            }
        }
    }
