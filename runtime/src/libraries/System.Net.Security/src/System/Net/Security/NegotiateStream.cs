            ...
            else if (statusCode != NegotiateAuthenticationStatusCode.ContinueNeeded)
            {
                int errorCode = statusCode switch
                {
                    ...
                    NegotiateAuthenticationStatusCode.CredentialsExpired
                        => (int)Interop.SECURITY_STATUS.CertExpired,
                    ...
                    NegotiateAuthenticationStatusCode.InvalidToken
                        => (int)Interop.SECURITY_STATUS.InvalidToken,
                    NegotiateAuthenticationStatusCode.UnknownCredentials
                        => (int)Interop.SECURITY_STATUS.UnknownCredentials,
                    ...
                    NegotiateAuthenticationStatusCode.OutOfSequence
                        => (int)Interop.SECURITY_STATUS.OutOfSequence,
