    ...
    public partial class SslStream
    {
            ...
            where TIOAdapter : IReadWriteAdapter
        {
            ...
            try
            {
                ...
                {
                    await TIOAdapter
                        .WriteAsync(InnerStream, nextmsg, 0, nextmsg.Length, cancellationToken)
                        .ConfigureAwait(false);
                    await TIOAdapter
            ...
            try
            {
                ...
                while (!handshakeCompleted)
                {
                    ...
                    if (payload != null && size > 0)
                    {
                        ...
                        await TIOAdapter
                            .WriteAsync(InnerStream, payload!, 0, size, cancellationToken)
                            .ConfigureAwait(false);
                        await TIOAdapter
                            .FlushAsync(InnerStream, cancellationToken)
                            .ConfigureAwait(false);
        ...
        ) where TIOAdapter : IReadWriteAdapter
        {
            ...
            switch (_lastFrame.Header.Type)
            {
                ...
                case TlsContentType.Handshake:
                    if (
                        !_isRenego
                        && _buffer.EncryptedReadOnlySpan[TlsFrameHelper.HeaderSize]
