...
namespace System.Net.Security
{
    internal partial struct SslConnectionInfo
    {
        private void MapCipherSuite(TlsCipherSuite cipherSuite)
        {
            ...
            KeyExchKeySize = 0;
            ReadOnlySpan<int> keyExchangeAlgs = new[]
            {
                (int)ExchangeAlgorithmType.None,
                (int)ExchangeAlgorithmType.RsaSign,
                (int)ExchangeAlgorithmType.RsaKeyX,
                (int)ExchangeAlgorithmType.DiffieHellman,
            };
            ReadOnlySpan<int> dataCipherAlgs = new[]
            {
                (int)CipherAlgorithmType.None,
                (int)CipherAlgorithmType.Null,
                (int)CipherAlgorithmType.Des,
                (int)CipherAlgorithmType.Rc2,
                (int)CipherAlgorithmType.TripleDes,
                (int)CipherAlgorithmType.Aes128,
                (int)CipherAlgorithmType.Aes192,
                (int)CipherAlgorithmType.Aes256,
                (int)CipherAlgorithmType.Aes,
                (int)CipherAlgorithmType.Rc4,
            };
            ReadOnlySpan<int> dataKeySizes = new[] { 0, 40, 56, 128, 168, 256 };
            ReadOnlySpan<int> dataHashAlgs = new[]
            {
                (int)HashAlgorithmType.None,
            ...
            ReadOnlySpan<int> dataHashKeySizes = new[] { 0, 128, 160, 256, 384, 512 };
