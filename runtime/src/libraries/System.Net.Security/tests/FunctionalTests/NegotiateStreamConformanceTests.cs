...
namespace System.Net.Security.Tests
{
    ...
    public sealed class NegotiateStreamMemoryConformanceTests
        : WrappingConnectedStreamConformanceTests
    {
        ...
        protected override Task<StreamPair> CreateConnectedStreamsAsync() =>
            CreateWrappedConnectedStreamsAsync(
                ConnectedStreams.CreateBidirectional(),
                leaveOpen: false
            );
        ...
        )
        {
            ...
            await Task.WhenAll(
                negotiate1.AuthenticateAsClientAsync(),
                negotiate2.AuthenticateAsServerAsync()
            );
