...
#pragma warning restore SYSLIB0039
            Assert.Equal(
                TlsFrameHelper.ApplicationProtocolInfo.Http11
                    | TlsFrameHelper.ApplicationProtocolInfo.Http2,
                info.ApplicationProtocols
            );
        }
...
#pragma warning restore SYSLIB0039
        ...
        public static IEnumerable<object[]> InvalidClientHelloDataTruncatedBytes()
        {
            ...
            foreach (byte[] invalidClientHello in InvalidClientHello())
            {
                ...
                {
                    uniqueInvalidHellos.Add(
                        Convert.ToBase64String(invalidClientHello.Take(i).ToArray())
                    );
                }
            }
            ...
            {
                uniqueInvalidHellos.Add(
                    Convert.ToBase64String(s_validClientHello.Take(i).ToArray())
                );
            }
        ...
        private static IEnumerable<byte[]> InvalidClientHello()
        {
            ...
            yield return new byte[]
            {
                ...
                0x80,
                0x80,
                0x61, // 0x80 0x80 0x80 0x80 is a forbidden utf-8 sequence
                0x61,
                0x61,
                0x61,
                0x61,
