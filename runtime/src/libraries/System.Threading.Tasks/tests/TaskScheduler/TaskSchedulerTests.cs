    ...
    public static class TaskSchedulerTests
    {
        ...
        public static void RunBuggySchedulerTests()
        {
            ...
            try
            {
                ...
                Assert.True(
                    false,
                    string.Format("    > FAILED.  No exception thrown from Wait().")
                );
            }
            ...
            catch (Exception e)
            {
                Assert.True(
                    false,
                    string.Format("    > FAILED.  Wrong exception thrown (sync): {0}", e)
                );
            }
            ...
            catch (Exception e)
            {
                Assert.True(
                    false,
                    string.Format("    > FAILED.  Wrong exception thrown (async): {0}", e)
                );
            }
