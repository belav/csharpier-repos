...
namespace Microsoft.NETCore.Platforms.BuildTasks.Tests
{
    public class RidTests
    {
        public static IEnumerable<object[]> ValidRIDData()
        {
            ...
            {
                "linux-x64",
                new RID() { BaseRID = "linux", Architecture = "x64" }
            };
            yield return new object[]
            {
                "linux-x64",
            ...
            yield return new object[]
            {
                ...
                {
                    BaseRID = "linuxmint",
                    Version = new RuntimeVersion("19.2"),
                    Architecture = "x64"
                }
            };
            yield return new object[]
            {
                ...
                {
                    BaseRID = "ubuntu",
                    Version = new RuntimeVersion("14.04"),
                    Architecture = "x64"
                }
            };
            yield return new object[]
