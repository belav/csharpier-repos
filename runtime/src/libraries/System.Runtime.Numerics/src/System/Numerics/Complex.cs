...
namespace System.Numerics
{
            ...
            ISignedNumber<Complex>
    {
        ...
        static Complex IAdditionOperators<Complex, Complex, Complex>.operator checked +(
            Complex left,
            Complex right
        ) => left + right;
        ...
        static Complex IDivisionOperators<Complex, Complex, Complex>.operator checked /(
            Complex left,
            Complex right
        ) => left / right;
        ...
        static Complex IMultiplyOperators<Complex, Complex, Complex>.operator checked *(
            Complex left,
            Complex right
        ) => left * right;
        ...
        )
        {
            ...
            {
                byte actualResult =
                    (value.m_real >= byte.MaxValue)
                        ? byte.MaxValue
                        : (value.m_real <= byte.MinValue)
                            ? byte.MinValue
                            : (byte)value.m_real;
                result = (TOther)(object)actualResult;
                return true;
            ...
            {
                char actualResult =
                    (value.m_real >= char.MaxValue)
                        ? char.MaxValue
                        : (value.m_real <= char.MinValue)
                            ? char.MinValue
                            : (char)value.m_real;
                result = (TOther)(object)actualResult;
                return true;
            ...
            else if (typeof(TOther) == typeof(decimal))
            {
                decimal actualResult =
                    (value.m_real >= (double)decimal.MaxValue)
                        ? decimal.MaxValue
                        : (value.m_real <= (double)decimal.MinValue)
                            ? decimal.MinValue
            ...
            {
                short actualResult =
                    (value.m_real >= short.MaxValue)
                        ? short.MaxValue
                        : (value.m_real <= short.MinValue)
                            ? short.MinValue
                            : (short)value.m_real;
                result = (TOther)(object)actualResult;
                return true;
            ...
            {
                int actualResult =
                    (value.m_real >= int.MaxValue)
                        ? int.MaxValue
                        : (value.m_real <= int.MinValue)
                            ? int.MinValue
                            : (int)value.m_real;
                result = (TOther)(object)actualResult;
                return true;
            ...
            {
                long actualResult =
                    (value.m_real >= long.MaxValue)
                        ? long.MaxValue
                        : (value.m_real <= long.MinValue)
                            ? long.MinValue
                            : (long)value.m_real;
                result = (TOther)(object)actualResult;
                return true;
            ...
            {
                Int128 actualResult =
                    (value.m_real >= +170141183460469231731687303715884105727.0)
                        ? Int128.MaxValue
            ...
            {
                sbyte actualResult =
                    (value.m_real >= sbyte.MaxValue)
                        ? sbyte.MaxValue
                        : (value.m_real <= sbyte.MinValue)
                            ? sbyte.MinValue
                            : (sbyte)value.m_real;
                result = (TOther)(object)actualResult;
                return true;
            ...
            {
                ushort actualResult =
                    (value.m_real >= ushort.MaxValue)
                        ? ushort.MaxValue
                        : (value.m_real <= ushort.MinValue)
                            ? ushort.MinValue
                            : (ushort)value.m_real;
                result = (TOther)(object)actualResult;
                return true;
            ...
            {
                uint actualResult =
                    (value.m_real >= uint.MaxValue)
                        ? uint.MaxValue
                        : (value.m_real <= uint.MinValue)
                            ? uint.MinValue
                            : (uint)value.m_real;
                result = (TOther)(object)actualResult;
                return true;
            ...
            {
                ulong actualResult =
                    (value.m_real >= ulong.MaxValue)
                        ? ulong.MaxValue
                        : (value.m_real <= ulong.MinValue)
                            ? ulong.MinValue
                            : (ulong)value.m_real;
                result = (TOther)(object)actualResult;
                return true;
            ...
            else if (typeof(TOther) == typeof(UInt128))
            {
                UInt128 actualResult =
                    (value.m_real >= 340282366920938463463374607431768211455.0)
                        ? UInt128.MaxValue
                        : (value.m_real <= 0.0)
                            ? UInt128.MinValue
            ...
            {
                nuint actualResult =
                    (value.m_real >= nuint.MaxValue)
                        ? nuint.MaxValue
                        : (value.m_real <= nuint.MinValue)
                            ? nuint.MinValue
                            : (nuint)value.m_real;
                result = (TOther)(object)actualResult;
                return true;
        ...
        )
        {
            ...
            bool tryFormatSucceeded = m_real.TryFormat(
                destination.Slice(charsWrittenSoFar),
                out int tryFormatCharsWritten,
                format,
                provider
            );
            ...
            tryFormatSucceeded = m_imaginary.TryFormat(
                destination.Slice(charsWrittenSoFar),
                out tryFormatCharsWritten,
                format,
                provider
            );
            charsWrittenSoFar += tryFormatCharsWritten;
        ...
        static Complex ISubtractionOperators<Complex, Complex, Complex>.operator checked -(
            Complex left,
            Complex right
        ) => left - right;
        ...
        static Complex IUnaryNegationOperators<Complex, Complex>.operator checked -(
            Complex value
        ) => -value;
