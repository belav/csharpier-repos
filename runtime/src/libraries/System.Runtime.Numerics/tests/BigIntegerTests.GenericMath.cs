...
namespace System.Numerics.Tests
{
    public class BigIntegerTests_GenericMath
    {
        ...
        public static void TrailingZeroCountTest()
        {
            ...
            Assert.Equal(
                (BigInteger)1000,
                BinaryIntegerHelper<BigInteger>.TrailingZeroCount(BigInteger.Pow(2, 1000))
            );
            Assert.Equal(
                (BigInteger)1000,
                BinaryIntegerHelper<BigInteger>.TrailingZeroCount(-BigInteger.Pow(2, 1000))
        ...
        {
            Assert.False(
                ComparisonOperatorsHelper<BigInteger, BigInteger, bool>.op_GreaterThan(Zero, 1)
            );
            Assert.False(
                ComparisonOperatorsHelper<BigInteger, BigInteger, bool>.op_GreaterThan(One, 1)
            );
            Assert.True(
                ComparisonOperatorsHelper<BigInteger, BigInteger, bool>.op_GreaterThan(
                    Int64MaxValue,
                    1
                )
            );
        ...
        {
            Assert.False(
                ComparisonOperatorsHelper<BigInteger, BigInteger, bool>.op_GreaterThanOrEqual(
                    Zero,
                    1
                )
            );
        ...
        {
            Assert.True(
                ComparisonOperatorsHelper<BigInteger, BigInteger, bool>.op_LessThan(Zero, 1)
            );
            Assert.False(
                ComparisonOperatorsHelper<BigInteger, BigInteger, bool>.op_LessThan(One, 1)
            );
            Assert.False(
                ComparisonOperatorsHelper<BigInteger, BigInteger, bool>.op_LessThan(
                    Int64MaxValue,
                    1
                )
            );
            ...
            Assert.True(
                ComparisonOperatorsHelper<BigInteger, BigInteger, bool>.op_LessThan(NegativeOne, 1)
            );
        ...
        {
            Assert.True(
                ComparisonOperatorsHelper<BigInteger, BigInteger, bool>.op_LessThanOrEqual(Zero, 1)
            );
            Assert.True(
                ComparisonOperatorsHelper<BigInteger, BigInteger, bool>.op_LessThanOrEqual(One, 1)
            );
            Assert.False(
                ComparisonOperatorsHelper<BigInteger, BigInteger, bool>.op_LessThanOrEqual(
                    Int64MaxValue,
                    1
                )
            );
        ...
        {
            Assert.False(
                EqualityOperatorsHelper<BigInteger, BigInteger, bool>.op_Equality(Zero, 1)
            );
            Assert.True(EqualityOperatorsHelper<BigInteger, BigInteger, bool>.op_Equality(One, 1));
            Assert.False(
                EqualityOperatorsHelper<BigInteger, BigInteger, bool>.op_Equality(Int64MaxValue, 1)
            );

            Assert.False(
                EqualityOperatorsHelper<BigInteger, BigInteger, bool>.op_Equality(Int64MinValue, 1)
            );
            Assert.False(
                EqualityOperatorsHelper<BigInteger, BigInteger, bool>.op_Equality(NegativeOne, 1)
            );

            Assert.False(
                EqualityOperatorsHelper<BigInteger, BigInteger, bool>.op_Equality(
                    Int64MaxValuePlusOne,
                    1
                )
            );
            Assert.False(
                EqualityOperatorsHelper<BigInteger, BigInteger, bool>.op_Equality(UInt64MaxValue, 1)
            );
        }
        ...
        {
            Assert.True(
                EqualityOperatorsHelper<BigInteger, BigInteger, bool>.op_Inequality(Zero, 1)
            );
            Assert.False(
                EqualityOperatorsHelper<BigInteger, BigInteger, bool>.op_Inequality(One, 1)
            );
            Assert.True(
                EqualityOperatorsHelper<BigInteger, BigInteger, bool>.op_Inequality(
                    Int64MaxValue,
                    1
                )
            );
            ...
            Assert.True(
                EqualityOperatorsHelper<BigInteger, BigInteger, bool>.op_Inequality(NegativeOne, 1)
            );
        ...
        public static void TryConvertToTruncatingInt128Test()
        {
            ...
            Assert.Equal(
                Int128.MaxValue,
                NumberBaseHelper<Int128>.CreateTruncating<BigInteger>(Int128MaxValue)
            );
            Assert.Equal(
                Int128.MinValue,
                NumberBaseHelper<Int128>.CreateTruncating<BigInteger>(Int128MinValue)
            );
            Assert.Equal(
                Int128.NegativeOne,
                NumberBaseHelper<Int128>.CreateTruncating<BigInteger>(NegativeOne)
            );
        }
        ...
        public static void op_LeftShiftTest()
        {
            Assert.Equal(
                Zero,
                ShiftOperatorsHelper<BigInteger, int, BigInteger>.op_LeftShift(Zero, 1)
            );
            Assert.Equal(
                Two,
                ShiftOperatorsHelper<BigInteger, int, BigInteger>.op_LeftShift(One, 1)
            );
            Assert.Equal(
                unchecked((BigInteger)0xFFFFFFFFFFFFFFFE),
                ShiftOperatorsHelper<BigInteger, int, BigInteger>.op_LeftShift(Int64MaxValue, 1)
            );

            Assert.Equal(
                NegativeTwoPow64,
                ShiftOperatorsHelper<BigInteger, int, BigInteger>.op_LeftShift(Int64MinValue, 1)
            );
            Assert.Equal(
                unchecked((BigInteger)(int)0xFFFFFFFE),
                ShiftOperatorsHelper<BigInteger, int, BigInteger>.op_LeftShift(NegativeOne, 1)
            );

            Assert.Equal(
                TwoPow64,
                ShiftOperatorsHelper<BigInteger, int, BigInteger>.op_LeftShift(
                    Int64MaxValuePlusOne,
                    1
                )
            );
            Assert.Equal(
                UInt64MaxValueTimesTwo,
                ShiftOperatorsHelper<BigInteger, int, BigInteger>.op_LeftShift(UInt64MaxValue, 1)
            );
        }
        ...
        public static void op_RightShiftTest()
        {
            Assert.Equal(
                Zero,
                ShiftOperatorsHelper<BigInteger, int, BigInteger>.op_RightShift(Zero, 1)
            );
            Assert.Equal(
                Zero,
                ShiftOperatorsHelper<BigInteger, int, BigInteger>.op_RightShift(One, 1)
            );
            Assert.Equal(
                (BigInteger)0x3FFFFFFFFFFFFFFF,
                ShiftOperatorsHelper<BigInteger, int, BigInteger>.op_RightShift(Int64MaxValue, 1)
            );

            Assert.Equal(
                unchecked((BigInteger)(long)0xC000000000000000),
                ShiftOperatorsHelper<BigInteger, int, BigInteger>.op_RightShift(Int64MinValue, 1)
            );
            Assert.Equal(
                NegativeOne,
                ShiftOperatorsHelper<BigInteger, int, BigInteger>.op_RightShift(NegativeOne, 1)
            );

            Assert.Equal(
                unchecked((BigInteger)0x4000000000000000),
                ShiftOperatorsHelper<BigInteger, int, BigInteger>.op_RightShift(
                    Int64MaxValuePlusOne,
                    1
                )
            );
            Assert.Equal(
                Int64MaxValue,
                ShiftOperatorsHelper<BigInteger, int, BigInteger>.op_RightShift(UInt64MaxValue, 1)
            );
        }
        ...
        public static void op_UnsignedRightShiftTest()
        {
            Assert.Equal(
                Zero,
                ShiftOperatorsHelper<BigInteger, int, BigInteger>.op_UnsignedRightShift(Zero, 1)
            );
            Assert.Equal(
                Zero,
                ShiftOperatorsHelper<BigInteger, int, BigInteger>.op_UnsignedRightShift(One, 1)
            );
            Assert.Equal(
                (BigInteger)0x3FFFFFFFFFFFFFFF,
                ShiftOperatorsHelper<BigInteger, int, BigInteger>.op_UnsignedRightShift(
                    Int64MaxValue,
                    1
                )
            );
