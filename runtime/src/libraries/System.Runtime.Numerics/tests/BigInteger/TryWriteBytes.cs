...
namespace System.Numerics.Tests
{
    public partial class ExtractBytesMembersTests
    {
        ...
        public void TryWriteBytes_FromIntTests(
            int i,
            bool isUnsigned,
            bool isBigEndian,
            byte[] expectedBytes
        ) =>
            ValidateGetByteCountAndTryWriteBytes(
                new BigInteger(i),
                isUnsigned,
                isBigEndian,
                expectedBytes
        ...
        public void TryWriteBytes_FromLongTests(
            long l,
            bool isUnsigned,
            bool isBigEndian,
            byte[] expectedBytes
        ...
        public void TryWriteBytes_FromStringTests(
            string str,
            bool isUnsigned,
            bool isBigEndian,
            byte[] expectedBytes
        ...
        private void ValidateGetByteCountAndTryWriteBytes(
            BigInteger bi,
            bool isUnsigned,
            bool isBigEndian,
            byte[] expectedBytes
        )
        {
            ...
            void Validate(Span<byte> destination)
            {
                ...
                Assert.False(
                    bi.TryWriteBytes(
                        destination.Slice(0, expectedBytes.Length - 1),
                        out bytesWritten,
                        isUnsigned,
                        isBigEndian
                    )
                ...
                Assert.True(
                    bi.TryWriteBytes(destination, out bytesWritten, isUnsigned, isBigEndian)
                );
