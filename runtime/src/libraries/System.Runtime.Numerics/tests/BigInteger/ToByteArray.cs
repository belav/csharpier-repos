...
namespace System.Numerics.Tests
{
    public partial class ExtractBytesMembersTests
    {
        ...
        public static IEnumerable<object[]> FromLongTests_MemberDataSeed()
        {
            ...
            {
                0x8000112233L,
                new byte[] { 0x33, 0x22, 0x11, 0x00, 0x80, 0x00 },
            };
            yield return new object[]
            {
                0x3cd00112233L,
                new byte[] { 0x33, 0x22, 0x11, 0x00, 0xcd, 0x03 },
            };
            yield return new object[]
            {
                0xf92100112233L,
                new byte[] { 0x33, 0x22, 0x11, 0x00, 0x21, 0xf9, 0x00 },
            };
            yield return new object[]
            {
                0x749aa00112233L,
                new byte[] { 0x33, 0x22, 0x11, 0x00, 0xaa, 0x49, 0x07 },
            };
            yield return new object[]
            {
                0x80112200112233L,
                new byte[] { 0x33, 0x22, 0x11, 0x00, 0x22, 0x11, 0x80, 0x00 },
            };
            yield return new object[]
            {
                0x7654321000112233L,
                new byte[] { 0x33, 0x22, 0x11, 0x00, 0x10, 0x32, 0x54, 0x76 },
            };
            yield return new object[]
            {
                long.MaxValue,
            ...
            {
                -0x100112233L,
                new byte[] { 0xcd, 0xdd, 0xee, 0xff, 0xfe },
            };
            yield return new object[]
            {
                -0x8000112233L,
                new byte[] { 0xcd, 0xdd, 0xee, 0xff, 0x7f, 0xff },
            };
            yield return new object[]
            {
                -0x3cd00112233L,
                new byte[] { 0xcd, 0xdd, 0xee, 0xff, 0x32, 0xfc },
            };
            yield return new object[]
            {
                -0xf92100112233L,
                new byte[] { 0xcd, 0xdd, 0xee, 0xff, 0xde, 0x06, 0xff },
            };
            yield return new object[]
            {
                -0x749aa00112233L,
                new byte[] { 0xcd, 0xdd, 0xee, 0xff, 0x55, 0xb6, 0xf8 },
            };
            yield return new object[]
            {
                -0x80112200112233L,
                new byte[] { 0xcd, 0xdd, 0xee, 0xff, 0xdd, 0xee, 0x7f, 0xff },
            };
            yield return new object[]
            {
                -0x7654321000112233L,
                new byte[] { 0xcd, 0xdd, 0xee, 0xff, 0xef, 0xcd, 0xab, 0x89 },
            };
            yield return new object[]
            {
                long.MinValue,
            ...
            {
                -0xfe00000000L,
                new byte[] { 0x00, 0x00, 0x00, 0x00, 0x02, 0xff },
            };
            yield return new object[]
            {
                -0xff00000000L,
                new byte[] { 0x00, 0x00, 0x00, 0x00, 0x01, 0xff },
            };
            yield return new object[]
            {
                -0xfeff00000000L,
                new byte[] { 0x00, 0x00, 0x00, 0x00, 0x01, 0x01, 0xff },
            };
            yield return new object[]
            {
                -0xffff00000000L,
                new byte[] { 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0xff },
            };
            yield return new object[]
            {
                -0xfeffff00000000L,
                new byte[] { 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x01, 0xff },
            };
            yield return new object[]
            {
                -0xffffff00000000L,
                new byte[] { 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0xff },
            };
        }
        ...
        public static IEnumerable<object[]> FromStringTests_MemberDataSeed()
        {
            ...
            yield return new object[]
            {
                "-18374686475376656384",
                new byte[] { 0xff, 0x01, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00 },
            };
            yield return new object[]
            {
                "-18446744069414584320",
                new byte[] { 0xff, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00 },
            };
            yield return new object[]
            {
        ...
        public void ToByteArray_FromIntTests_Advanced(
            int i,
            bool isUnsigned,
            bool isBigEndian,
            byte[] expectedBytes
        ...
        public void ToByteArray_FromLongTests_Advanced(
            long l,
            bool isUnsigned,
            bool isBigEndian,
            byte[] expectedBytes
        ...
        public void ToByteArray_FromStringTests_Advanced(
            string str,
            bool isUnsigned,
            bool isBigEndian,
            byte[] expectedBytes
