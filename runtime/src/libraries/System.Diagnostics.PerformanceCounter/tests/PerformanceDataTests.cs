...
namespace System.Diagnostics.Tests
{
    public class PerformanceDataTests : IClassFixture<PerformanceDataTestsFixture>
    {
        ...
        private static bool IsRunnableEnvironment =>
            Helpers.IsElevatedAndCanWriteAndReadNetPerfCounters
            && TestEnvironment.IsStressModeEnabled
            && RemoteExecutor.IsSupported;

        /// <summary>
        /// This test was taken from System.Diagnostics.PerformanceData documentation
        ...
        {
            // We run test in isolated process to avoid interferences on internal performance counter shared
        ...
        public void PerformanceCounter_PerformanceData_AddCounter_InvalidCounterName(
            string counterName,
            ...
            )
            {
                ...
                )
                {
                    AssertExtensions.Throws<ArgumentNullException>(
                        "counterName",
                        "CounterName",
                        () => typingCsInstance.Counters[counterName]
                    );
                }
            }
        }
    ...
    public class PerformanceDataTestsFixture : IDisposable
    {
        ...
        void RegisterCounters()
        {
            ...
            File.Copy(
                "System.Diagnostics.PerformanceCounter.Tests.dll",
                Path.Combine(
                    Path.GetDirectoryName(_manifestPathTmp),
                    "System.Diagnostics.PerformanceCounter.Tests.dll"
                )
            );
