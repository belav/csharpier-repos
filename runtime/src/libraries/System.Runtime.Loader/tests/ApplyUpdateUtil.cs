...
namespace System.Reflection.Metadata
{
    public class ApplyUpdateUtil
    {
        ...
        public static bool IsSupported =>
            (IsModifiableAssembliesSet || IsRemoteExecutorSupported)
        ...
        public static bool TestUsingRemoteExecutor =>
            IsRemoteExecutorSupported && !IsModifiableAssembliesSet;
        ...
        public static bool TestUsingLaunchEnvironment =>
            (!IsMonoRuntime || IsSupportedMonoConfiguration) && IsModifiableAssembliesSet;

        public static bool IsModifiableAssembliesSet =>
            String.Equals(
                DotNetModifiableAssembliesValue,
                Environment.GetEnvironmentVariable(DotNetModifiableAssembliesSwitch),
                StringComparison.InvariantCultureIgnoreCase
            );

        // static cctor for RemoteExecutor throws on wasm.
        public static bool IsRemoteExecutorSupported =>
            !RuntimeInformation.IsOSPlatform(OSPlatform.Create("BROWSER"))
            && RemoteExecutor.IsSupported;

        public static bool IsMonoRuntime => PlatformDetection.IsMonoRuntime;

        private static readonly Lazy<bool> s_isSupportedMonoConfiguration = new Lazy<bool>(
            CheckSupportedMonoConfiguration
        );
        ...
        private static void AppendEnvironmentVariable(
        ...
        public static void TestCase(Action testBody, RemoteInvokeOptions options = null)
        {
