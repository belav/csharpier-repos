...
namespace System.Runtime.Loader.Tests
{
    public class SatelliteAssembliesTestsFixture
    {
        ...
        public SatelliteAssembliesTestsFixture()
        {
            ...
            var satelliteAssembliesTestsPath = AssemblyPathHelper.GetAssemblyLocation(
                typeof(SatelliteAssembliesTests).Assembly
            );
            ...
            var referencedClassLibPath = AssemblyPathHelper.GetAssemblyLocation(
                typeof(ReferencedClassLib.Program).Assembly
            );
            referencedClassLib.LoadFromAssemblyPath(referencedClassLibPath);

            AssemblyLoadContext referencedClassLibNeutralIsSatellite = new AssemblyLoadContext(
...
#region DescribeTests
        ...
        public static IEnumerable<object[]> MainResources_TestData()
        {
            ...
            if (PlatformDetection.IsNotInvariantGlobalization)
            {
                ...
                {
                    "es-MX",
                    "Spanish (Mexico) language Main description 1.0.0"
                };
        ...
        public static string Describe(string lang)
        {
            ResourceManager rm = new ResourceManager(
                "System.Runtime.Loader.Tests.MainStrings",
                typeof(SatelliteAssembliesTests).Assembly
            );
        ...
        public static IEnumerable<object[]> DescribeLib_TestData()
        {
            ...
            {
                "Default",
                "System.Runtime.Loader.Tests.SatelliteAssembliesTests",
                "",
                "Neutral language Main description 1.0.0"
            };
            yield return new object[]
            {
                "Default",
                "System.Runtime.Loader.Tests.SatelliteAssembliesTests",
                "en",
                "English language Main description 1.0.0"
            };
            yield return new object[]
            {
                "Default",
            ...
            {
                "Default",
                "ReferencedClassLib.Program, ReferencedClassLib",
                "",
                "Neutral language ReferencedClassLib description 1.0.0"
            };
            yield return new object[]
            {
                "Default",
                "ReferencedClassLib.Program, ReferencedClassLib",
                "en",
                "English language ReferencedClassLib description 1.0.0"
            };
            yield return new object[]
            {
                "Default",
            ...
            {
                "Default",
                "ReferencedClassLibNeutralIsSatellite.Program, ReferencedClassLibNeutralIsSatellite",
                "",
                "Neutral (es) language ReferencedClassLibNeutralIsSatellite description 1.0.0"
            };
            yield return new object[]
            {
                "Default",
                "ReferencedClassLibNeutralIsSatellite.Program, ReferencedClassLibNeutralIsSatellite",
                "en",
                "English language ReferencedClassLibNeutralIsSatellite description 1.0.0"
            };
            yield return new object[]
            {
                "Default",
        ...
        public void SatelliteLoadsCorrectly_FromName(
            string alc,
            string assemblyName,
            string culture
        )
        {
            ...
            Assert.Same(
                AssemblyLoadContext.GetLoadContext(parentAssembly),
                AssemblyLoadContext.GetLoadContext(satelliteAssembly)
            );
        ...
        [MemberData(nameof(SatelliteLoadsCorrectly_TestData))]
        public void SatelliteLoadsCorrectly_FromPath(
            string alc,
            string assemblyName,
            string culture
        )
