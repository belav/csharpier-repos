...
namespace System.IO.Pipes.Tests
{
    ...
    internal static partial class InteropTest
    {
        ...
        )
        {
            ...
            return TryHandleGetImpersonationUserNameError(
                handle,
                Marshal.GetLastPInvokeError(),
                UserNameMaxLength,
                userName,
                out impersonationUserName
            );
        }
        ...
        internal static bool TryGetHostName(out string hostName)
        {
            throw new Exception("Should not call on Windows.");
        }

        private static unsafe bool TryHandleGetImpersonationUserNameError(
            SafePipeHandle handle,
            int error,
