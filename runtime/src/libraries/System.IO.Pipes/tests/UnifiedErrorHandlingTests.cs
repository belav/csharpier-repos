...
namespace System.IO.Pipes.Tests
{
    public static class UnifiedErrorHandlingTests
    {
        ...
        public static async Task When_NamedPipeServer_IsClosed_NamedPipeClient_ReadReturnsZero(
            bool asyncHandles
        ) =>
            DisposeServerAndVerifyClientBehaviour(
                await GetConnectedNamedPipeStreams(
                    asyncHandles,
                    PipeDirection.Out,
                    PipeDirection.In
                ),
        ...
        public static async Task When_NamedPipeServer_IsClosed_FileStreamClient_ReadReturnsZero(
            bool asyncHandles
        ) =>
            DisposeServerAndVerifyClientBehaviour(
                await GetConnectedNamedPipeServerAndFileStreamClientStreams(
                    asyncHandles,
                    PipeDirection.Out,
                    FileAccess.Read
                ),
        ...
        public static async Task When_NamedPipeServer_IsClosed_NamedPipeClient_WriteThrows(
            bool asyncHandles
        ) =>
            DisposeServerAndVerifyClientBehaviour(
                await GetConnectedNamedPipeStreams(
        ...
        public static async Task When_NamedPipeServer_IsClosed_FileStreamClient_WriteThrows(
            bool asyncHandles
        ) =>
            DisposeServerAndVerifyClientBehaviour(
                await GetConnectedNamedPipeServerAndFileStreamClientStreams(
        ...
        public static async Task When_NamedPipeServer_IsClosed_NamedPipeClient_ReadAsyncReturnsZero(
            bool asyncHandles
        ) =>
        ...
        public static async Task When_NamedPipeServer_IsClosed_FileStreamClient_ReadAsyncReturnsZero(
            bool asyncHandles
        ) =>
            await DisposeServerAndVerifyClientBehaviourAsync(
                await GetConnectedNamedPipeServerAndFileStreamClientStreams(
        ...
        public static async Task When_NamedPipeServer_IsClosed_NamedPipeClient_WriteAsyncThrows(
            bool asyncHandles
        ) =>
            await DisposeServerAndVerifyClientBehaviourAsync(
                await GetConnectedNamedPipeStreams(
        ...
        public static async Task When_NamedPipeServer_IsClosed_FileStreamClient_WriteAsyncThrows(
            bool asyncHandles
        ) =>
            await DisposeServerAndVerifyClientBehaviourAsync(
                await GetConnectedNamedPipeServerAndFileStreamClientStreams(
        ...
        public static async Task When_NamedPipeServerDisconnectsNamedPipeClient_ReadReturnsZero(
            bool asyncHandles
        ) =>
        ...
        public static async Task When_NamedPipeServerDisconnectsFileStreamClient_ReadReturnsZero(
            bool asyncHandles
        ) =>
            DisconnectServerAndVerifyClientBehaviour(
                await GetConnectedNamedPipeServerAndFileStreamClientStreams(
        ...
        public static async Task When_NamedPipeServerDisconnectsNamedPipeClient_WriteThrows(
            bool asyncHandles
        ) =>
            DisconnectServerAndVerifyClientBehaviour(
                await GetConnectedNamedPipeStreams(
        ...
        public static async Task When_NamedPipeServerDisconnectsFileStreamClient_WriteThrows(
            bool asyncHandles
        ) =>
            DisconnectServerAndVerifyClientBehaviour(
                await GetConnectedNamedPipeServerAndFileStreamClientStreams(
        ...
        public static async Task When_NamedPipeServerDisconnectsNamedPipeClient_ReadAsyncReturnsZero(
            bool asyncHandles
        ) =>
        ...
        public static async Task When_NamedPipeServerDisconnectsFileStreamClient_ReadAsyncReturnsZero(
            bool asyncHandles
        ) =>
            await DisconnectServerAndVerifyClientBehaviourAsync(
                await GetConnectedNamedPipeServerAndFileStreamClientStreams(
        ...
        public static async Task When_NamedPipeServerDisconnectsNamedPipeClient_WriteAsyncThrows(
            bool asyncHandles
        ) =>
            await DisconnectServerAndVerifyClientBehaviourAsync(
                await GetConnectedNamedPipeStreams(
        ...
        public static async Task When_NamedPipeServerDisconnectsFileStreamClient_WriteAsyncThrows(
            bool asyncHandles
        ) =>
            await DisconnectServerAndVerifyClientBehaviourAsync(
                await GetConnectedNamedPipeServerAndFileStreamClientStreams(
        ...
        public static Task When_NamedPipeServer_IsClosed_CopyToAsyncJustFinishesWithoutThrowing(
            bool asyncHandles
        ...
        [InlineData(false)]
        [PlatformSpecific(TestPlatforms.Windows)]
        public static Task When_NamedPipeServerDisconnectsCopyToAsyncJustFinishesWithoutThrowing(
            bool asyncHandles
        ) => TestCopyToAsync(asyncHandles, dispose: false);

        private static async Task TestCopyToAsync(bool asyncHandles, bool dispose)
        {
            (NamedPipeServerStream server, FileStream client) =
                await GetConnectedNamedPipeServerAndFileStreamClientStreams(
                    asyncHandles,
                    PipeDirection.Out,
                    FileAccess.Read
        ...
        ) GetAnonymousPipeStreams(PipeDirection serverDirection, PipeDirection clientDirection)
        {
        ...
        private static (
            AnonymousPipeServerStream server,
            FileStream client
        ) GetAnonymousPipeServerAndFileStreamClient(
        ...
        private static async Task<(
            NamedPipeServerStream server,
            FileStream client
        )> GetConnectedNamedPipeServerAndFileStreamClientStreams(
            bool asyncHandles,
            PipeDirection serverDirection,
            FileAccess clientAccess
        )
        {
            ...
            {
                PipeOptions pipeOptions = asyncHandles
                    ? PipeOptions.Asynchronous
                    : PipeOptions.None;
                FileOptions fileOptions = asyncHandles
            ...
            {
                (NamedPipeServerStream server, NamedPipeClientStream namedPipeClient) =
                    await GetConnectedNamedPipeStreams(
                        asyncHandles,
                        serverDirection,
        ...
        private static void DisposeServerAndVerifyClientBehaviour(
            (Stream server, Stream client) connectedStreams,
            Action<Stream> assertMethod
        )
        {
        ...
        private static void DisconnectServerAndVerifyClientBehaviour(
            (NamedPipeServerStream server, Stream client) connectedStreams,
            Action<Stream> assertMethod
        )
        {
        ...
        private static async Task DisposeServerAndVerifyClientBehaviourAsync(
            (Stream server, Stream client) connectedStreams,
            Func<Stream, Task> assertMethod
        )
        {
        ...
        private static async Task DisconnectServerAndVerifyClientBehaviourAsync(
            (NamedPipeServerStream server, Stream client) connectedStreams,
            Func<Stream, Task> assertMethod
        )
        {
