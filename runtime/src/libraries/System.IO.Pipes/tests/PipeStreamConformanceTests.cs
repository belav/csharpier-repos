...
namespace System.IO.Pipes.Tests
{
    ...
    public sealed class NamedPipeTest_ServerOut_ClientIn_Synchronous
        : NamedPipeTest_ServerOut_ClientIn
    {
        protected override PipeOptions Options => PipeOptions.None;
    }

    public sealed class NamedPipeTest_ServerOut_ClientIn_Asynchronous
        : NamedPipeTest_ServerOut_ClientIn
    {
        protected override PipeOptions Options => PipeOptions.Asynchronous;
    }

    public sealed class NamedPipeTest_ServerIn_ClientOut_Synchronous
        : NamedPipeTest_ServerIn_ClientOut
    {
        protected override PipeOptions Options => PipeOptions.None;
    }

    public sealed class NamedPipeTest_ServerIn_ClientOut_Asynchronous
        : NamedPipeTest_ServerIn_ClientOut
    {
        protected override PipeOptions Options => PipeOptions.Asynchronous;
    }
    ...
    public sealed class NamedPipeTest_ServerInOut_ClientInOut_Synchronous
        : NamedPipeTest_ServerInOut_ClientInOut
    {
        protected override PipeOptions Options => PipeOptions.None;
    }

    public sealed class NamedPipeTest_ServerInOut_ClientInOut_Asynchronous
        : NamedPipeTest_ServerInOut_ClientInOut
    {
        protected override PipeOptions Options => PipeOptions.Asynchronous;
    }
