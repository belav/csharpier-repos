...
namespace System.Tests
{
    public class ConvertToBase64StringTests
    {
        ...
        public static IEnumerable<object[]> ConvertToBase64StringTests_TestData()
        {
            ...
            {
                Enumerable.Range(0, 1).Select(i => (byte)i).ToArray(),
                "AA=="
            };
            yield return new object[]
            {
                Enumerable.Range(0, 2).Select(i => (byte)i).ToArray(),
                "AAE="
            };
            yield return new object[]
            {
                Enumerable.Range(0, 3).Select(i => (byte)i).ToArray(),
                "AAEC"
            };
            yield return new object[]
            {
                Enumerable.Range(0, 4).Select(i => (byte)i).ToArray(),
                "AAECAw=="
            };
            yield return new object[]
            {
                Enumerable.Range(0, 5).Select(i => (byte)i).ToArray(),
                "AAECAwQ="
            };
            yield return new object[]
            {
            ...
            yield return new object[]
            {
                Enumerable.Range(0, 7).Select(i => (byte)i).ToArray(),
                "AAECAwQFBg=="
            };
            yield return new object[]
            {
            ...
            yield return new object[]
            {
                Enumerable.Range(0, 9).Select(i => (byte)i).ToArray(),
                "AAECAwQFBgcI"
            };
            yield return new object[]
            {
                Enumerable.Range(0, 10).Select(i => (byte)i).ToArray(),
                "AAECAwQFBgcICQ=="
            };
            yield return new object[]
            {
                Enumerable.Range(0, 11).Select(i => (byte)i).ToArray(),
                "AAECAwQFBgcICQo="
            };
            yield return new object[]
            {
            ...
            yield return new object[]
            {
                Enumerable.Range(0, 13).Select(i => (byte)i).ToArray(),
                "AAECAwQFBgcICQoLDA=="
            };
            yield return new object[]
            {
                Enumerable.Range(0, 14).Select(i => (byte)i).ToArray(),
                "AAECAwQFBgcICQoLDA0="
            };
            yield return new object[]
            {
            ...
            yield return new object[]
            {
                Enumerable.Range(0, 17).Select(i => (byte)i).ToArray(),
                "AAECAwQFBgcICQoLDA0ODxA="
            };
            yield return new object[]
            {
                Enumerable.Range(0, 18).Select(i => (byte)i).ToArray(),
                "AAECAwQFBgcICQoLDA0ODxAR"
            };
            yield return new object[]
            {
                Enumerable.Range(0, 19).Select(i => (byte)i).ToArray(),
                "AAECAwQFBgcICQoLDA0ODxAREg=="
            };
            yield return new object[]
            {
                Enumerable.Range(0, 20).Select(i => (byte)i).ToArray(),
                "AAECAwQFBgcICQoLDA0ODxAREhM="
            };
            yield return new object[]
            {
                Enumerable.Range(0, 21).Select(i => (byte)i).ToArray(),
                "AAECAwQFBgcICQoLDA0ODxAREhMU"
            };
            yield return new object[]
            {
                Enumerable.Range(0, 22).Select(i => (byte)i).ToArray(),
                "AAECAwQFBgcICQoLDA0ODxAREhMUFQ=="
            };
            yield return new object[]
            {
                Enumerable.Range(0, 23).Select(i => (byte)i).ToArray(),
            ...
            yield return new object[]
            {
                Enumerable.Range(0, 25).Select(i => (byte)i).ToArray(),
                "AAECAwQFBgcICQoLDA0ODxAREhMUFRYXGA=="
            };
            yield return new object[]
            {
                Enumerable.Range(0, 26).Select(i => (byte)i).ToArray(),
                "AAECAwQFBgcICQoLDA0ODxAREhMUFRYXGBk="
            };
            yield return new object[]
            {
                Enumerable.Range(0, 27).Select(i => (byte)i).ToArray(),
                "AAECAwQFBgcICQoLDA0ODxAREhMUFRYXGBka"
            };
            yield return new object[]
            {
                Enumerable.Range(0, 28).Select(i => (byte)i).ToArray(),
                "AAECAwQFBgcICQoLDA0ODxAREhMUFRYXGBkaGw=="
            };
            yield return new object[]
            {
                Enumerable.Range(0, 29).Select(i => (byte)i).ToArray(),
                "AAECAwQFBgcICQoLDA0ODxAREhMUFRYXGBkaGxw="
            };
            yield return new object[]
            {
                Enumerable.Range(0, 30).Select(i => (byte)i).ToArray(),
            ...
            yield return new object[]
            {
                Enumerable.Range(0, 33).Select(i => (byte)i).ToArray(),
                "AAECAwQFBgcICQoLDA0ODxAREhMUFRYXGBkaGxwdHh8g"
            };
            yield return new object[]
            {
                Enumerable.Range(0, 34).Select(i => (byte)i).ToArray(),
                "AAECAwQFBgcICQoLDA0ODxAREhMUFRYXGBkaGxwdHh8gIQ=="
            };
            yield return new object[]
            {
                Enumerable.Range(0, 35).Select(i => (byte)i).ToArray(),
                "AAECAwQFBgcICQoLDA0ODxAREhMUFRYXGBkaGxwdHh8gISI="
            };
            yield return new object[]
            {
                Enumerable.Range(0, 36).Select(i => (byte)i).ToArray(),
                "AAECAwQFBgcICQoLDA0ODxAREhMUFRYXGBkaGxwdHh8gISIj"
            };
            yield return new object[]
            {
                Enumerable.Range(0, 37).Select(i => (byte)i).ToArray(),
                "AAECAwQFBgcICQoLDA0ODxAREhMUFRYXGBkaGxwdHh8gISIjJA=="
            };
            yield return new object[]
            {
                Enumerable.Range(0, 38).Select(i => (byte)i).ToArray(),
                "AAECAwQFBgcICQoLDA0ODxAREhMUFRYXGBkaGxwdHh8gISIjJCU="
            };
            yield return new object[]
            {
                Enumerable.Range(0, 39).Select(i => (byte)i).ToArray(),
                "AAECAwQFBgcICQoLDA0ODxAREhMUFRYXGBkaGxwdHh8gISIjJCUm"
            };
            yield return new object[]
            {
                Enumerable.Range(0, 40).Select(i => (byte)i).ToArray(),
                "AAECAwQFBgcICQoLDA0ODxAREhMUFRYXGBkaGxwdHh8gISIjJCUmJw=="
            };
            yield return new object[]
            {
                Enumerable.Range(0, 41).Select(i => (byte)i).ToArray(),
            ...
            yield return new object[]
            {
                Enumerable.Range(0, 57).Select(i => (byte)i).ToArray(),
                "AAECAwQFBgcICQoLDA0ODxAREhMUFRYXGBkaGxwdHh8gISIjJCUmJygpKissLS4vMDEyMzQ1Njc4"
            };
            yield return new object[]
            {
                Enumerable.Range(0, 58).Select(i => (byte)i).ToArray(),
                "AAECAwQFBgcICQoLDA0ODxAREhMUFRYXGBkaGxwdHh8gISIjJCUmJygpKissLS4vMDEyMzQ1Njc4OQ=="
            };
            yield return new object[]
            {
                Enumerable.Range(0, 59).Select(i => (byte)i).ToArray(),
            ...
            yield return new object[]
            {
                Enumerable.Range(0, 61).Select(i => (byte)i).ToArray(),
                "AAECAwQFBgcICQoLDA0ODxAREhMUFRYXGBkaGxwdHh8gISIjJCUmJygpKissLS4vMDEyMzQ1Njc4OTo7PA=="
            };
            yield return new object[]
            {
                Enumerable.Range(0, 62).Select(i => (byte)i).ToArray(),
                "AAECAwQFBgcICQoLDA0ODxAREhMUFRYXGBkaGxwdHh8gISIjJCUmJygpKissLS4vMDEyMzQ1Njc4OTo7PD0="
            };
            yield return new object[]
            {
                Enumerable.Range(0, 63).Select(i => (byte)i).ToArray(),
                "AAECAwQFBgcICQoLDA0ODxAREhMUFRYXGBkaGxwdHh8gISIjJCUmJygpKissLS4vMDEyMzQ1Njc4OTo7PD0+"
            };
            yield return new object[]
            {
                Encoding.Unicode.GetBytes(
                    "aaaabbbbccccdddddddeeeeeaaaabbbbccccdddddddeeeeeaaaabbbbccccdd"
                ),
            ...
            {
                Encoding.Unicode.GetBytes(
                    "vbnmbbbbccccdddddddeeeeeaaaabbbbccccdddddddeeeeeaaaabbbbccccddx"
                ),
            ...
            {
                Encoding.Unicode.GetBytes(
                    "rrrrbbbbccccdddddddeeeeeaaaabbbbccccdddddddeeeeeaaaabbbbccccdd\0"
                ),
            ...
            yield return new object[]
            {
                ...
                "dQB1AHUAdQBiAGIAYgBiAGMAYwBjAGMAZABkAGQAZABkAGQAZABlAGUAZQBlAGUAYQBhAGEAYQBiAGIAYgBiAGMAYwBjAGMAZABkAGQAZABkAGQAZABlAGUAZQBlAGUAYQBhAGEAYQBiAGIAYgBiAGMAYwBjAGMAZABkAAAAZgBlAGYAZgBlAA=="
            };
            yield return new object[]
            {
                Encoding.Unicode.GetBytes(
                ...
                "awBrAGsAawBrAGIAYgBiAGIAYwBjAGMAYwBkAGQAZABkAGQAZABkAGUAZQBlAGUAZQBhAGEAYQBhAGIAYgBiAGIAYwBjAGMAYwBkAGQAZABkAGQAZABkAGUAZQBlAGUAZQBhAGEAYQBhAGIAYgBiAGIAYwBjAGMAYwBkAGQAeAA/BEAEOAQyBDUEQgQ8BDgEQARgT31ZFk5MdQ=="
            };
            yield return new object[]
            {
                Encoding.Unicode.GetBytes(
