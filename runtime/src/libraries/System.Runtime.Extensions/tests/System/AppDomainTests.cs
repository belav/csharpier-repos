...
#pragma warning restore 618
        ...
        public void GetAssemblies()
        {
            RemoteExecutor.Invoke(
                    () =>
                    {
                        ...
                        Assert.True(
                            ctr > 0,
                            "Assembly.LoadFile should cause file to be loaded again"
                        );
                    }
                )
                .Dispose();
        ...
        private void CopyTestAssemblies()
        {
            ...
            destTestAssemblyPath = Path.Combine(
                Environment.CurrentDirectory,
                "TestAppOutsideOfTPA",
                "TestAppOutsideOfTPA.exe"
            );
...
#pragma warning restore SYSLIB0003 // Obsolete: CAS
        ...
        [Theory]
        [ActiveIssue(
            "https://github.com/dotnet/runtime/issues/34030",
            TestPlatforms.Linux | TestPlatforms.Browser | TestPlatforms.Android,
        ...
        public static TheoryData<
            ...
            string,
            Type
        > TestingCreateInstanceFromObjectHandleData =>
            new TheoryData<string, string, string, string, Type>
            {
        ...
        public void AssemblyResolve_FirstChanceException()
        {
            RemoteExecutor.Invoke(
                    () =>
                    {
                        ...
                        assembly.GetType(
                            "System.Tests.AGenericClass`1[[Bogus, BogusAssembly]]",
                            false
                        );
                        Assert.Null(firstChanceExceptionThrown);
