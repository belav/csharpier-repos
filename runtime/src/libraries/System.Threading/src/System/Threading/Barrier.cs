...
namespace System.Threading
{
    ...
    /// </remarks>
    [DebuggerDisplay(
        "ParticipantCount = {ParticipantCount}, ParticipantsRemaining = {ParticipantsRemaining}"
    )]
    public class Barrier : IDisposable
    {
        ...
        private static void GetCurrentTotal(
            int currentTotal,
            out int current,
            out int total,
            out bool sense
        ...
        public void RemoveParticipants(int participantCount)
        {
            ...
            while (true)
            {
                ...
                {
                    throw new InvalidOperationException(
                        SR.Barrier_RemoveParticipants_InvalidOperation
                    );
                }
        ...
        public bool SignalAndWait(int millisecondsTimeout, CancellationToken cancellationToken)
        {
            ...
            while (true)
            {
                ...
                {
                    throw new InvalidOperationException(
                        SR.Barrier_SignalAndWait_InvalidOperation_ZeroTotal
                    );
                }
                ...
                {
                    throw new InvalidOperationException(
                        SR.Barrier_SignalAndWait_InvalidOperation_ThreadsExceeded
                    );
                }
