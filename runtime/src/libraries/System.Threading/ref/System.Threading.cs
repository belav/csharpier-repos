...
namespace System.Threading
{
    ...
    public static partial class Interlocked
    {
        ...
        public static System.IntPtr CompareExchange(
        ...
        [System.CLSCompliantAttribute(false)]
        public static System.UIntPtr CompareExchange(
            ref System.UIntPtr location1,
            System.UIntPtr value,
            System.UIntPtr comparand
        )
        {
            throw null;
        }
        ...
        public static long Read(readonly ref long location)
        {
            throw null;
        }

        [System.CLSCompliantAttribute(false)]
        public static ulong Read(readonly ref ulong location)
        {
            throw null;
        }
    }
    ...
    public static partial class LazyInitializer
    {
        ...
        public static T EnsureInitialized<
            [System.Diagnostics.CodeAnalysis.DynamicallyAccessedMembersAttribute(
                ...
                T
        >(
            [System.Diagnostics.CodeAnalysis.AllowNullAttribute] ref T target,
    ...
    {
        public static bool Read(readonly ref bool location)
        {
            throw null;
        }

        public static byte Read(readonly ref byte location)
        {
            throw null;
        }

        public static double Read(readonly ref double location)
        {
            throw null;
        }

        public static short Read(readonly ref short location)
        {
            throw null;
        }

        public static int Read(readonly ref int location)
        {
            throw null;
        }
        ...
        public static System.IntPtr Read(readonly ref System.IntPtr location)
        {
            throw null;
        }

        [System.CLSCompliantAttribute(false)]
        public static sbyte Read(readonly ref sbyte location)
        {
            throw null;
        }

        public static float Read(readonly ref float location)
        {
            throw null;
        }

        [System.CLSCompliantAttribute(false)]
        public static ushort Read(readonly ref ushort location)
        {
            throw null;
        }

        [System.CLSCompliantAttribute(false)]
        public static uint Read(readonly ref uint location)
        {
            throw null;
        }
        ...
        [System.CLSCompliantAttribute(false)]
        public static System.UIntPtr Read(readonly ref System.UIntPtr location)
        {
            throw null;
        }
