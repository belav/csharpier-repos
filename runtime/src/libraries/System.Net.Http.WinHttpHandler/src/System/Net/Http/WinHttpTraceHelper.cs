...
namespace System.Net.Http
{
    ...
    {
        public static void TraceCallbackStatus(
        ...
        public static void TraceAsyncError(
            object thisOrContextObject,
        ...
        private static string GetNameFromError(uint error) =>
            error switch
            {
                ...
                Interop.WinHttp.ERROR_WINHTTP_INCORRECT_HANDLE_STATE =>
        ...
        private static string GetStringFromInternetStatus(uint status) =>
            status switch
            {
                ...
                Interop.WinHttp.WINHTTP_CALLBACK_STATUS_CONNECTING_TO_SERVER =>
                ...
                Interop.WinHttp.WINHTTP_CALLBACK_STATUS_RECEIVING_RESPONSE =>
                    "STATUS_RECEIVING_RESPONSE",
                Interop.WinHttp.WINHTTP_CALLBACK_STATUS_RESPONSE_RECEIVED =>
                    "STATUS_RESPONSE_RECEIVED",
                Interop.WinHttp.WINHTTP_CALLBACK_STATUS_CLOSING_CONNECTION =>
                    "STATUS_CLOSING_CONNECTION",
                Interop.WinHttp.WINHTTP_CALLBACK_STATUS_CONNECTION_CLOSED =>
                ...
                Interop.WinHttp.WINHTTP_CALLBACK_STATUS_INTERMEDIATE_RESPONSE =>
                    "STATUS_INTERMEDIATE_RESPONSE",
                ...
                Interop.WinHttp.WINHTTP_CALLBACK_STATUS_GETPROXYFORURL_COMPLETE =>
                    "STATUS_GETPROXYFORURL_COMPLETE",
                Interop.WinHttp.WINHTTP_CALLBACK_STATUS_CLOSE_COMPLETE => "STATUS_CLOSE_COMPLETE",
                Interop.WinHttp.WINHTTP_CALLBACK_STATUS_SHUTDOWN_COMPLETE =>
                    "STATUS_SHUTDOWN_COMPLETE",
                _ => $"0x{status:X}",
            };
    }
}
