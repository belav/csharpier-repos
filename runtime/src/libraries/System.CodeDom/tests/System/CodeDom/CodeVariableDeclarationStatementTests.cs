...
{
    public class CodeVariableDeclarationStatementTests
        : CodeObjectTestBase<CodeVariableDeclarationStatement>
    {
        [Fact]
        ...
        public void Ctor_CodeTypeReference_String(CodeTypeReference type, string name)
        {
            ...
            Assert.Equal(
                ...
                variableDeclaration.Type.BaseType
            );
        ...
        public void Ctor_CodeTypeReference_String_CodeExpression(
        ...
        public void Ctor_String_String_CodeExpression(
            string type,
            string name,
            CodeExpression initExpression,
        ...
        public void Ctor_Type_String_CodeExpression(
            Type type,
            string name,
            CodeExpression initExpression,
            string expectedBaseType
