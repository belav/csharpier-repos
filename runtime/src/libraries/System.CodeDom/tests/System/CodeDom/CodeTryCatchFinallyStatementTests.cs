...
{
    public class CodeTryCatchFinallyStatementTests
        : CodeStatementTestBase<CodeTryCatchFinallyStatement>
    {
        [Fact]
        ...
        [Theory]
        [MemberData(
            nameof(Ctor_CodeStatementArray_CodeCatchClauseArray_CodeStatementArray_TestData)
        )]
        public void Ctor_CodeStatementArray_CodeCatchClauseArray_CodeStatementArray(
            CodeStatement[] tryStatements,
            CodeCatchClause[] catchClauses,
        ...
        )
        {
            ...
            Assert.Equal(
                finallyStatements,
                tryCatchFinally.FinallyStatements.Cast<CodeStatement>()
            );
        }
        ...
        public void TryStatements_AddMultiple_ReturnsExpected()
        {
            ...
            Assert.Equal(
                ...
                tryCatchFinally.TryStatements.Cast<CodeStatement>()
            );
        ...
        public void CatchClauses_AddMultiple_ReturnsExpected()
        {
            ...
            Assert.Equal(
                new CodeCatchClause[] { catchClause1 },
                tryCatchFinally.CatchClauses.Cast<CodeCatchClause>()
            );

            CodeCatchClause catchClause2 = new CodeCatchClause("Local2");
            tryCatchFinally.CatchClauses.Add(catchClause2);
            Assert.Equal(
                new CodeCatchClause[] { catchClause1, catchClause2 },
                tryCatchFinally.CatchClauses.Cast<CodeCatchClause>()
            );
        }
