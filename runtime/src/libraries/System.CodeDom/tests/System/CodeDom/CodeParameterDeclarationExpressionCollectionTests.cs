...
namespace System.CodeDom.Tests
{
        ...
        >
    {
        ...
        protected override int Count(CodeParameterDeclarationExpressionCollection collection) =>
            collection.Count;

        protected override CodeParameterDeclarationExpression GetItem(
            CodeParameterDeclarationExpressionCollection collection,
            int index
        ) => collection[index];
        ...
        protected override object Add(
            CodeParameterDeclarationExpressionCollection collection,
            CodeParameterDeclarationExpression obj
        ) => collection.Add(obj);
