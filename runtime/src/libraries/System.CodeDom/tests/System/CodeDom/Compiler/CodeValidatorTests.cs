...
namespace System.CodeDom.Compiler.Tests
{
    public class CodeValidatorTests
    {
        public static IEnumerable<object[]> ValidateIdentifiers_Valid_TestData()
        {
            ...
            {
                new CodeChecksumPragma(string.Empty, Guid.NewGuid(), new byte[0])
            };
            yield return new object[]
            {
            ...
            yield return new object[]
            {
                new CodeRegionDirective(CodeRegionMode.None, string.Empty)
            };
            ...
            var fullNamespaceImport = new CodeNamespaceImport("nameSpace")
            {
            ...
            var fullParameter = new CodeParameterDeclarationExpression(
            ...
            var invalidParameterAttribute2 = new CodeParameterDeclarationExpression(
                new CodeTypeReference("type"),
                "name"
            );
            invalidParameterAttribute2
                .CustomAttributes
            ...
            var invalidParameterAttribute5 = new CodeParameterDeclarationExpression(
                new CodeTypeReference("type"),
                "name"
            );
            invalidParameterAttribute5
                .CustomAttributes
                .Add(
                    new CodeAttributeDeclaration(
                        "name",
            ...
            var abstractEntryPointMethod = new CodeEntryPointMethod
            {
                Name = "name",
                Attributes = MemberAttributes.Abstract
            };
            ...
            var abstractTypeConstructor = new CodeTypeConstructor
            {
                Name = "name",
                Attributes = MemberAttributes.Abstract
            };
            ...
            var fullSnippetCompileUnit = new CodeSnippetCompileUnit("value")
            {
                LinePragma = new CodeLinePragma()
            };
            fullSnippetCompileUnit.StartDirectives.Add(new CodeChecksumPragma());
            fullSnippetCompileUnit
                .StartDirectives
                .Add(new CodeChecksumPragma("fileName", Guid.NewGuid(), new byte[0]));
            ...
            yield return new object[]
            {
                new CodeArrayCreateExpression(new CodeTypeReference((string)null))
            };
            yield return new object[]
            {
                new CodeArrayCreateExpression(new CodeTypeReference(string.Empty))
            };
            yield return new object[]
            {
                new CodeArrayCreateExpression(new CodeTypeReference("name"))
            };
            yield return new object[]
            {
                new CodeArrayCreateExpression(new CodeTypeReference("name"))
            ...
            yield return new object[]
            {
                new CodeCastExpression(
                    new CodeTypeReference((string)null),
                    new CodePrimitiveExpression(1)
                )
            };
            yield return new object[]
            ...
            yield return new object[]
            {
                new CodeDefaultValueExpression(new CodeTypeReference((string)null))
            };
            yield return new object[]
            {
                new CodeDefaultValueExpression(new CodeTypeReference(string.Empty))
            };
            yield return new object[]
            {
                new CodeDefaultValueExpression(new CodeTypeReference("name"))
            };
            ...
            yield return new object[]
            {
                new CodeFieldReferenceExpression(new CodePrimitiveExpression(1), "name")
            };
            ...
            yield return new object[]
            {
                new CodeMethodInvokeExpression(new CodeMethodReferenceExpression(null, "name"))
            };
            yield return new object[]
            {
                new CodeMethodInvokeExpression(
                    new CodeMethodReferenceExpression(new CodePrimitiveExpression(1), "name")
                )
            };
            yield return new object[]
            {
            ...
            yield return new object[]
            {
                new CodeEventReferenceExpression(new CodePrimitiveExpression(1), "name")
            };
            ...
            yield return new object[]
            {
                new CodePropertyReferenceExpression(new CodePrimitiveExpression(1), "name")
            };
            ...
            yield return new object[]
            {
                new CodeTypeReferenceExpression(new CodeTypeReference("name"))
            };
            ...
            yield return new object[]
            {
                new CodeTryCatchFinallyStatement(
                    ...
                    new CodeCatchClause[]
                    {
                        new CodeCatchClause("localName"),
                        new CodeCatchClause("localName", new CodeTypeReference("exceptionType")),
                        new CodeCatchClause(
                            "localName",
                            new CodeTypeReference("exceptionType"),
                            new CodeMethodReturnStatement(),
                            new CodeMethodReturnStatement { LinePragma = new CodeLinePragma() }
                        )
                    },
            ...
            yield return new object[]
            {
                new CodeVariableDeclarationStatement(new CodeTypeReference("name"), "name")
            };
            yield return new object[]
            {
            ...
            yield return new object[]
            {
                new CodeAttachEventStatement(
                    new CodeEventReferenceExpression(null, "name"),
                    new CodePrimitiveExpression(1)
                )
            };
            yield return new object[]
            ...
            yield return new object[]
            {
                new CodeLabeledStatement("name", new CodeMethodReturnStatement())
            };
        ...
        public static IEnumerable<object[]> ValidateIdentifiers_Invalid_TestData()
        {
            ...
            yield return new object[]
            {
                new CodeMemberEvent { PrivateImplementationType = new CodeTypeReference("name") }
            };
            yield return new object[]
            {
                new CodeMemberEvent
                {
                    Name = null,
                    PrivateImplementationType = new CodeTypeReference("name")
                }
            };
            yield return new object[]
            {
            ...
            yield return new object[]
            {
                new CodeMemberField(new CodeTypeReference("type"), string.Empty)
            };
            ...
            var invalidFieldStartDirective2 = new CodeMemberField(
                new CodeTypeReference("type"),
                "name"
            );
            invalidFieldStartDirective2
                .StartDirectives
                .Add(new CodeChecksumPragma("\0", Guid.NewGuid(), new byte[0]));
            ...
            foreach (char newLineChar in new char[] { '\r', '\n', '\u2028', '\u2029', '\u0085' })
            {
                var invalidFieldStartDirective3 = new CodeMemberField(
                    new CodeTypeReference("type"),
                    "name"
                );
                invalidFieldStartDirective3
                    .StartDirectives
                    .Add(new CodeRegionDirective(CodeRegionMode.None, $"te{newLineChar}xt"));
                yield return new object[] { invalidFieldStartDirective3 };
            }

            var invalidFieldEndDirective1 = new CodeMemberField(
                new CodeTypeReference("type"),
                "name"
            );
            ...
            var invalidFieldEndDirective2 = new CodeMemberField(
                new CodeTypeReference("type"),
                "name"
            );
            invalidFieldEndDirective2
                .EndDirectives
                .Add(new CodeChecksumPragma("\0", Guid.NewGuid(), new byte[0]));
            ...
            foreach (char newLineChar in new char[] { '\r', '\n', '\u2028', '\u2029', '\u0085' })
            {
                var invalidFieldEndDirective3 = new CodeMemberField(
                    new CodeTypeReference("type"),
                    "name"
                );
                invalidFieldEndDirective3
                    .EndDirectives
                    .Add(new CodeRegionDirective(CodeRegionMode.None, $"te{newLineChar}xt"));
            ...
            yield return new object[]
            {
                new CodeMemberField(new CodeTypeReference("type"), "name")
                {
                    InitExpression = new CodeExpression()
                }
            };
            ...
            yield return new object[]
            {
                ...
                {
                    Name = "name",
                    PrivateImplementationType = invalidTypeReference1
                }
            };
            yield return new object[]
            {
                ...
                {
                    Name = "name",
                    PrivateImplementationType = invalidTypeReference2
                }
            };
            yield return new object[]
            {
                ...
                {
                    Name = "name",
                    PrivateImplementationType = invalidTypeReference3
                }
            };
            ...
            invalidMethodReturnTypeAttribute1
                .ReturnTypeCustomAttributes
            ...
            invalidMethodReturnTypeAttribute2
                .ReturnTypeCustomAttributes
                .Add(new CodeAttributeDeclaration((string)null));
            ...
            invalidMethodReturnTypeAttribute3
                .ReturnTypeCustomAttributes
                .Add(new CodeAttributeDeclaration(string.Empty));
            ...
            invalidMethodReturnTypeAttribute4
                .ReturnTypeCustomAttributes
            ...
            invalidMethodReturnTypeAttribute5
                .ReturnTypeCustomAttributes
                .Add(
                    new CodeAttributeDeclaration(
                        "name",
            ...
            invalidMethodReturnTypeAttribute6
                .ReturnTypeCustomAttributes
                .Add(
                    new CodeAttributeDeclaration(
                        "name",
            ...
            invalidEntryPointMethodStartDirective2
                .StartDirectives
                .Add(new CodeChecksumPragma("\0", Guid.NewGuid(), new byte[0]));
            ...
            foreach (char newLineChar in new char[] { '\r', '\n', '\u2028', '\u2029', '\u0085' })
            {
                var invalidEntryPointMethodStartDirective3 = new CodeEntryPointMethod
                {
                    Name = "name"
                };
                invalidEntryPointMethodStartDirective3
                    .StartDirectives
                    .Add(new CodeRegionDirective(CodeRegionMode.None, $"te{newLineChar}xt"));
            ...
            invalidEntryPointMethodEndDirective2
                .EndDirectives
                .Add(new CodeChecksumPragma("\0", Guid.NewGuid(), new byte[0]));
            ...
            foreach (char newLineChar in new char[] { '\r', '\n', '\u2028', '\u2029', '\u0085' })
            {
                var invalidEntryPointMethodEndDirective3 = new CodeEntryPointMethod
                {
                    Name = "name"
                };
                invalidEntryPointMethodEndDirective3
                    .EndDirectives
                    .Add(new CodeRegionDirective(CodeRegionMode.None, $"te{newLineChar}xt"));
                yield return new object[] { invalidEntryPointMethodEndDirective3 };
            }

            var invalidEntryPointMethodImplementationType1 = new CodeEntryPointMethod
            {
                Name = "name"
            };
            invalidEntryPointMethodImplementationType1
                .ImplementationTypes
            ...
            invalidEntryPointMethodImplementationType2
                .ImplementationTypes
            ...
            invalidEntryPointMethodImplementationType3
                .ImplementationTypes
            ...
            invalidEntryPointMethodImplementationType4
                .ImplementationTypes
            ...
            invalidEntryPointMethodImplementationType5
                .ImplementationTypes
            ...
            var invalidEntryPointMethodStatement2 = new CodeEntryPointMethod
            {
                Name = "name",
                Attributes = MemberAttributes.Abstract
            };
            ...
            invalidEntryPointMethodTypeParameter3
                .TypeParameters
            ...
            var invalidEntryPointMethodTypeParameterAttribute1 = new CodeEntryPointMethod
            {
                Name = "name"
            };
            invalidEntryPointMethodTypeParameterAttribute1
                .TypeParameters
            ...
            invalidEntryPointMethodTypeParameterAttribute2
                .TypeParameters
            ...
            invalidEntryPointMethodTypeParameterAttribute3
                .TypeParameters
            ...
            invalidEntryPointMethodTypeParameterAttribute4
                .TypeParameters
            ...
            invalidEntryPointMethodTypeParameterAttribute5
                .TypeParameters
            ...
            invalidEntryPointMethodTypeParameterAttribute6
                .TypeParameters
            ...
            invalidConstructorStartDirective2
                .StartDirectives
                .Add(new CodeChecksumPragma("\0", Guid.NewGuid(), new byte[0]));
            ...
            foreach (char newLineChar in new char[] { '\r', '\n', '\u2028', '\u2029', '\u0085' })
            {
                ...
                invalidConstructorStartDirective3
                    .StartDirectives
                    .Add(new CodeRegionDirective(CodeRegionMode.None, $"te{newLineChar}xt"));
            ...
            invalidConstructorEndDirective2
                .EndDirectives
                .Add(new CodeChecksumPragma("\0", Guid.NewGuid(), new byte[0]));
            ...
            foreach (char newLineChar in new char[] { '\r', '\n', '\u2028', '\u2029', '\u0085' })
            {
                ...
                invalidConstructorEndDirective3
                    .EndDirectives
                    .Add(new CodeRegionDirective(CodeRegionMode.None, $"te{newLineChar}xt"));
            ...
            invalidConstructorImplementationType2
                .ImplementationTypes
                .Add(new CodeTypeReference("0"));
            ...
            var invalidConstructorStatement2 = new CodeConstructor
            {
                Name = "name",
                Attributes = MemberAttributes.Abstract
            };
            ...
            invalidConstructorTypeParameter3
                .TypeParameters
                .Add(new CodeTypeParameter(string.Empty));
            ...
            invalidConstructorTypeParameterAttribute1
                .TypeParameters
                .Add(invalidTypeParameterAttribute1);
            ...
            invalidConstructorTypeParameterAttribute2
                .TypeParameters
                .Add(invalidTypeParameterAttribute2);
            ...
            invalidConstructorTypeParameterAttribute3
                .TypeParameters
                .Add(invalidTypeParameterAttribute3);
            ...
            invalidConstructorTypeParameterAttribute4
                .TypeParameters
                .Add(invalidTypeParameterAttribute4);
            ...
            invalidConstructorTypeParameterAttribute5
                .TypeParameters
                .Add(invalidTypeParameterAttribute5);
            ...
            invalidConstructorTypeParameterAttribute6
                .TypeParameters
                .Add(invalidTypeParameterAttribute6);
            ...
            invalidConstructorChainedConstructorArg
            ...
            invalidTypeConstructorStartDirective2
                .StartDirectives
                .Add(new CodeChecksumPragma("\0", Guid.NewGuid(), new byte[0]));
            ...
            foreach (char newLineChar in new char[] { '\r', '\n', '\u2028', '\u2029', '\u0085' })
            {
                var invalidTypeConstructorStartDirective3 = new CodeTypeConstructor
                {
                    Name = "name"
                };
                invalidTypeConstructorStartDirective3
                    .StartDirectives
                    .Add(new CodeRegionDirective(CodeRegionMode.None, $"te{newLineChar}xt"));
            ...
            invalidTypeConstructorEndDirective2
                .EndDirectives
                .Add(new CodeChecksumPragma("\0", Guid.NewGuid(), new byte[0]));
            ...
            foreach (char newLineChar in new char[] { '\r', '\n', '\u2028', '\u2029', '\u0085' })
            {
                ...
                invalidTypeConstructorEndDirective3
                    .EndDirectives
                    .Add(new CodeRegionDirective(CodeRegionMode.None, $"te{newLineChar}xt"));
                yield return new object[] { invalidTypeConstructorEndDirective3 };
            }

            var invalidTypeConstructorImplementationType1 = new CodeTypeConstructor
            {
                Name = "name"
            };
            invalidTypeConstructorImplementationType1
                .ImplementationTypes
                .Add(new CodeTypeReference());
            ...
            invalidTypeConstructorImplementationType2
                .ImplementationTypes
                .Add(new CodeTypeReference("0"));
            ...
            invalidTypeConstructorImplementationType3
                .ImplementationTypes
                .Add(invalidTypeReference1);
            ...
            invalidTypeConstructorImplementationType4
                .ImplementationTypes
                .Add(invalidTypeReference2);
            ...
            invalidTypeConstructorImplementationType5
                .ImplementationTypes
                .Add(invalidTypeReference3);
            ...
            var invalidTypeConstructorStatement2 = new CodeTypeConstructor
            {
                Name = "name",
                Attributes = MemberAttributes.Abstract
            };
            ...
            invalidTypeConstructorTypeParameter3
                .TypeParameters
                .Add(new CodeTypeParameter(string.Empty));
            ...
            var invalidTypeConstructorTypeParameterAttribute1 = new CodeTypeConstructor
            {
                Name = "name"
            };
            invalidTypeConstructorTypeParameterAttribute1
                .TypeParameters
                .Add(invalidTypeParameterAttribute1);
            ...
            invalidTypeConstructorTypeParameterAttribute2
                .TypeParameters
                .Add(invalidTypeParameterAttribute2);
            ...
            invalidTypeConstructorTypeParameterAttribute3
                .TypeParameters
                .Add(invalidTypeParameterAttribute3);
            ...
            invalidTypeConstructorTypeParameterAttribute4
                .TypeParameters
                .Add(invalidTypeParameterAttribute4);
            ...
            invalidTypeConstructorTypeParameterAttribute5
                .TypeParameters
                .Add(invalidTypeParameterAttribute5);
            ...
            invalidTypeConstructorTypeParameterAttribute6
                .TypeParameters
                .Add(invalidTypeParameterAttribute6);
            ...
            invalidPropertyStartDirective2
                .StartDirectives
                .Add(new CodeChecksumPragma("\0", Guid.NewGuid(), new byte[0]));
            ...
            foreach (char newLineChar in new char[] { '\r', '\n', '\u2028', '\u2029', '\u0085' })
            {
                ...
                invalidPropertyStartDirective3
                    .StartDirectives
                    .Add(new CodeRegionDirective(CodeRegionMode.None, $"te{newLineChar}xt"));
            ...
            yield return new object[]
            {
                new CodeTypeDelegate("name") { ReturnType = new CodeTypeReference() }
            };
            yield return new object[]
            {
                new CodeTypeDelegate("name") { ReturnType = new CodeTypeReference("0") }
            };
            yield return new object[]
            {
                new CodeTypeDelegate("name") { ReturnType = invalidTypeReference1 }
            };
            yield return new object[]
            {
                new CodeTypeDelegate("name") { ReturnType = invalidTypeReference2 }
            };
            yield return new object[]
            {
                new CodeTypeDelegate("name") { ReturnType = invalidTypeReference3 }
            };
            ...
            invalidDelegateTypeParameterAttribute1
                .TypeParameters
                .Add(invalidTypeParameterAttribute1);
            ...
            invalidDelegateTypeParameterAttribute2
                .TypeParameters
                .Add(invalidTypeParameterAttribute2);
            ...
            invalidDelegateTypeParameterAttribute3
                .TypeParameters
                .Add(invalidTypeParameterAttribute3);
            ...
            invalidDelegateTypeParameterAttribute4
                .TypeParameters
                .Add(invalidTypeParameterAttribute4);
            ...
            invalidDelegateTypeParameterAttribute5
                .TypeParameters
                .Add(invalidTypeParameterAttribute5);
            ...
            invalidDelegateTypeParameterAttribute6
                .TypeParameters
                .Add(invalidTypeParameterAttribute6);
            ...
            invalidCompileUnitStartDirective2
                .StartDirectives
                .Add(new CodeChecksumPragma("\0", Guid.NewGuid(), new byte[0]));
            ...
            foreach (char newLineChar in new char[] { '\r', '\n', '\u2028', '\u2029', '\u0085' })
            {
                ...
                invalidCompileUnitStartDirective3
                    .StartDirectives
                    .Add(new CodeRegionDirective(CodeRegionMode.None, $"te{newLineChar}xt"));
            ...
            invalidCompileUnitEndDirective2
                .EndDirectives
                .Add(new CodeChecksumPragma("\0", Guid.NewGuid(), new byte[0]));
            ...
            foreach (char newLineChar in new char[] { '\r', '\n', '\u2028', '\u2029', '\u0085' })
            {
                ...
                invalidCompileUnitEndDirective3
                    .EndDirectives
                    .Add(new CodeRegionDirective(CodeRegionMode.None, $"te{newLineChar}xt"));
            ...
            invalidSnippetCompileUnitStartDirective2
                .StartDirectives
                .Add(new CodeChecksumPragma("\0", Guid.NewGuid(), new byte[0]));
            ...
            foreach (char newLineChar in new char[] { '\r', '\n', '\u2028', '\u2029', '\u0085' })
            {
                ...
                invalidSnippetCompileUnitStartDirective3
                    .StartDirectives
                    .Add(new CodeRegionDirective(CodeRegionMode.None, $"te{newLineChar}xt"));
            ...
            invalidSnippetCompileUnitEndDirective2
                .EndDirectives
                .Add(new CodeChecksumPragma("\0", Guid.NewGuid(), new byte[0]));
            ...
            foreach (char newLineChar in new char[] { '\r', '\n', '\u2028', '\u2029', '\u0085' })
            {
                ...
                invalidSnippetCompileUnitEndDirective3
                    .EndDirectives
                    .Add(new CodeRegionDirective(CodeRegionMode.None, $"te{newLineChar}xt"));
            ...
            yield return new object[]
            {
                new CodeArrayCreateExpression(invalidTypeReference3)
                {
                    SizeExpression = new CodeExpression()
                }
            };
            ...
            yield return new object[]
            {
                new CodeCastExpression(new CodeTypeReference(), new CodePrimitiveExpression(2))
            };
            yield return new object[]
            {
                new CodeCastExpression(new CodeTypeReference("0"), new CodePrimitiveExpression(2))
            };
            yield return new object[]
            {
                new CodeCastExpression(invalidTypeReference1, new CodePrimitiveExpression(2))
            };
            yield return new object[]
            {
                new CodeCastExpression(invalidTypeReference2, new CodePrimitiveExpression(2))
            };
            yield return new object[]
            {
                new CodeCastExpression(invalidTypeReference3, new CodePrimitiveExpression(2))
            };
            yield return new object[]
            {
            ...
            yield return new object[]
            {
                new CodeDefaultValueExpression(new CodeTypeReference("0"))
            };
            ...
            yield return new object[]
            {
                new CodeFieldReferenceExpression(new CodeExpression(), "name")
            };
            ...
            yield return new object[]
            {
                new CodeMethodInvokeExpression(new CodeMethodReferenceExpression(null, null))
            };
            yield return new object[]
            {
                new CodeMethodInvokeExpression(
            ...
            yield return new object[]
            {
                new CodeMethodInvokeExpression(new CodeMethodReferenceExpression(null, "0"))
            };
            yield return new object[]
            {
                new CodeMethodInvokeExpression(
                    new CodeMethodReferenceExpression(new CodeExpression(), "name")
                )
            };
            yield return new object[]
            {
                new CodeMethodInvokeExpression(
                    new CodeMethodReferenceExpression(
                        new CodePrimitiveExpression(1),
                        "name",
                        new CodeTypeReference[] { new CodeTypeReference() }
                    )
                )
            };
            yield return new object[]
            {
                new CodeMethodInvokeExpression(
                    new CodeMethodReferenceExpression(
                        new CodePrimitiveExpression(1),
                        "name",
                        new CodeTypeReference[] { new CodeTypeReference("0") }
                    )
                )
            };
            yield return new object[]
            {
                new CodeMethodInvokeExpression(
                    new CodeMethodReferenceExpression(
                        new CodePrimitiveExpression(1),
                        "name",
                        new CodeTypeReference[] { invalidTypeReference1 }
                    )
                )
            };
            yield return new object[]
            {
                new CodeMethodInvokeExpression(
                    new CodeMethodReferenceExpression(
                        new CodePrimitiveExpression(1),
                        "name",
                        new CodeTypeReference[] { invalidTypeReference2 }
                    )
                )
            };
            yield return new object[]
            {
                new CodeMethodInvokeExpression(
                    new CodeMethodReferenceExpression(
                        new CodePrimitiveExpression(1),
                        "name",
                        new CodeTypeReference[] { invalidTypeReference3 }
                    )
                )
            };
            yield return new object[]
            {
                new CodeMethodInvokeExpression(
                    new CodeMethodReferenceExpression(null, "name"),
                    new CodeExpression()
                )
            };
            ...
            yield return new object[]
            {
                new CodeObjectCreateExpression(new CodeTypeReference("0"))
            };
            ...
            yield return new object[]
            {
                new CodeObjectCreateExpression(new CodeTypeReference("name"), new CodeExpression())
            };
            ...
            yield return new object[]
            {
                new CodePropertyReferenceExpression(new CodeExpression(), "name")
            };
            ...
            yield return new object[]
            {
                new CodeTypeReferenceExpression(new CodeTypeReference("0"))
            };
            ...
            yield return new object[]
            {
                new CodeTryCatchFinallyStatement(
                    ...
                    new CodeCatchClause[]
                    {
                        new CodeCatchClause("localName", new CodeTypeReference())
                    },
                    new CodeStatement[] { new CodeMethodReturnStatement() }
                )
            };
            yield return new object[]
            {
                new CodeTryCatchFinallyStatement(
                    ...
                    new CodeCatchClause[]
                    {
                        new CodeCatchClause("localName", new CodeTypeReference("0"))
                    },
                    new CodeStatement[] { new CodeMethodReturnStatement() }
                )
            };
            ...
            yield return new object[]
            {
                new CodeVariableDeclarationStatement(new CodeTypeReference(), "name")
            };
            yield return new object[]
            {
                new CodeVariableDeclarationStatement(new CodeTypeReference("0"), "name")
            };
            yield return new object[]
            {
                new CodeVariableDeclarationStatement(invalidTypeReference1, "name")
            };
            yield return new object[]
            {
                new CodeVariableDeclarationStatement(invalidTypeReference2, "name")
            };
            yield return new object[]
            {
                new CodeVariableDeclarationStatement(invalidTypeReference3, "name")
            };
            yield return new object[]
            {
                new CodeVariableDeclarationStatement(new CodeTypeReference("name"), null)
            };
            yield return new object[]
            {
                new CodeVariableDeclarationStatement(new CodeTypeReference("name"), string.Empty)
            };
            yield return new object[]
            {
                new CodeVariableDeclarationStatement(new CodeTypeReference("name"), "0")
            };
            yield return new object[]
            {
                new CodeVariableDeclarationStatement(
            ...
            {
                new CodeAttachEventStatement(
                    new CodeEventReferenceExpression(null, null),
                    new CodePrimitiveExpression(1)
                )
            };
            yield return new object[]
            ...
            {
                new CodeAttachEventStatement(
                    new CodeEventReferenceExpression(null, "0"),
                    new CodePrimitiveExpression(1)
                )
            };
            yield return new object[]
        ...
        [SkipOnTargetFramework(
            ...
            "Fixed incorrect param name in some situations"
        )]
        ...
        public static IEnumerable<object[]> ValidateIdentifiers_NullE_TestData()
        {
            ...
            yield return new object[]
            {
                new CodeDelegateCreateExpression(new CodeTypeReference("name"), null, "methodName")
            };
