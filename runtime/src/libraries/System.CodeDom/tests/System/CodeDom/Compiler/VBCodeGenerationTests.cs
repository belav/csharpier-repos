    ...
    public class VBCodeGenerationTests : CodeGenerationTests
    {
        ...
        public void CallingMethods()
        {
            ...
            CodeMethodInvokeExpression methodinvoke2 = new CodeMethodInvokeExpression(
                new CodeCastExpression("ClassWNewMethod", new CodeVariableReferenceExpression("t")),
                "VirtualMethod"
            );
        ...
        public void MethodWithRefParameter()
        {
            ...
            cmm.Attributes = MemberAttributes.Public | MemberAttributes.Static;
            CodeParameterDeclarationExpression parames = new CodeParameterDeclarationExpression(
                typeof(int),
                "a"
            );
            ...
            CodeMethodInvokeExpression methodinvoked = new CodeMethodInvokeExpression(
                new CodeMethodReferenceExpression(new CodeTypeReferenceExpression("TEST"), "Work")
            );
            // add parameter with ref direction
            CodeDirectionExpression parameter = new CodeDirectionExpression(
                FieldDirection.Ref,
                new CodeVariableReferenceExpression("a")
            );
            methodinvoked.Parameters.Add(parameter);
            // add parameter with out direction
            parameter = new CodeDirectionExpression(
                FieldDirection.Out,
                new CodeVariableReferenceExpression("b")
            );
            methodinvoked.Parameters.Add(parameter);
        ...
        [SkipOnTargetFramework(
            ...
            ".NET Framework outputs C# keywords rather than type names"
        )]
        [Theory]
        ...
        [InlineData(
            typeof(ushort),
            "Sub System_UInt16_MyMethod() Implements UShort.MyMethod End Sub"
        )]
        [InlineData(typeof(int), "Sub System_Int32_MyMethod() Implements Integer.MyMethod End Sub")]
        [InlineData(
            typeof(uint),
            "Sub System_UInt32_MyMethod() Implements UInteger.MyMethod End Sub"
        )]
        [InlineData(typeof(long), "Sub System_Int64_MyMethod() Implements Long.MyMethod End Sub")]
        [InlineData(
            typeof(ulong),
            "Sub System_UInt64_MyMethod() Implements ULong.MyMethod End Sub"
        )]
        [InlineData(
            typeof(string),
            "Sub System_[String]_MyMethod() Implements String.MyMethod End Sub"
        )]
        [InlineData(
            typeof(object),
            "Sub System_[Object]_MyMethod() Implements Object.MyMethod End Sub"
        )]
        [InlineData(
            typeof(bool),
            "Sub System_[Boolean]_MyMethod() Implements Boolean.MyMethod End Sub"
        )]
        [InlineData(
            typeof(void),
            "Sub System_Void_MyMethod() Implements System.Void.MyMethod End Sub"
        )]
        [InlineData(typeof(char), "Sub System_[Char]_MyMethod() Implements Char.MyMethod End Sub")]
        [InlineData(
            typeof(float),
            "Sub System_[Single]_MyMethod() Implements Single.MyMethod End Sub"
        )]
        [InlineData(
            typeof(double),
            "Sub System_[Double]_MyMethod() Implements Double.MyMethod End Sub"
        )]
        [InlineData(
            typeof(decimal),
            "Sub System_[Decimal]_MyMethod() Implements Decimal.MyMethod End Sub"
        )]
        ...
        public void MetadataAttributes()
        {
            using (new ThreadCultureChange(CultureInfo.InvariantCulture))
            {
                ...
                mfield.InitExpression = new CodeObjectCreateExpression(
                    new CodeTypeReference("Button")
                );
        ...
        public void CastingOperations()
        {
            ...
            CodeParameterDeclarationExpression strParam = new CodeParameterDeclarationExpression(
                typeof(string),
                "value"
            );
            ...
            CodeParameterDeclarationExpression valueParam = new CodeParameterDeclarationExpression(
                typeof(int),
                "value"
            );
        ...
        public void BinaryOperators()
        {
            ...
            variableDeclaration = new CodeVariableDeclarationStatement(
                typeof(int),
                "x1",
                cboExpression
            );
        ...
        public void ValueTypes()
        {
            ...
            CodeVariableDeclarationStatement varStructA = new CodeVariableDeclarationStatement(
                "structA",
                "varStructA"
            );
            ...
            CodeVariableDeclarationStatement varStructC = new CodeVariableDeclarationStatement(
                "structC",
                "varStructC"
            );
            nonPrimitiveStructMethod.Statements.Add(varStructC);
            nonPrimitiveStructMethod.Statements
                .Add(
                    new CodeAssignStatement(
                        /* Expression1 */new CodeFieldReferenceExpression(
        ...
        public void RegionsSnippetsAndLinePragmas()
        {
            using (new ThreadCultureChange(CultureInfo.InvariantCulture))
            {
                ...
                evt1.Attributes =
                    (evt1.Attributes & ~MemberAttributes.AccessMask) | MemberAttributes.Public;
                ...
                constructor1.Attributes =
                    (constructor1.Attributes & ~MemberAttributes.AccessMask)
        ...
        public void Properties()
        {
            ...
            CodeParameterDeclarationExpression intParam = new CodeParameterDeclarationExpression(
                typeof(int),
                "value"
            );
        ...
        public void Params()
        {
            static CodeStatement CreateStatement(string objName, int iNum)
            {
                CodeAssignStatement statement = new CodeAssignStatement(
                    ...
                    new CodeMethodInvokeExpression(
                        new CodeMethodReferenceExpression(
                            new CodeTypeReferenceExpression(new CodeTypeReference(objName)),
                            "Replace"
                        ),
                        new CodeExpression[]
                        {
                            ...
                            new CodeMethodInvokeExpression(
                                new CodeArrayIndexerExpression(
                                    new CodeVariableReferenceExpression("array"),
                                    new CodePrimitiveExpression(iNum)
                                ),
                                "ToString"
                            ),
        ...
        public void ForLoops()
        {
            ...
            iteration.InitStatement = new CodeAssignStatement(
                new CodeVariableReferenceExpression("i"),
                new CodePrimitiveExpression(0)
            );
            ...
            CodeConditionStatement secondIf = new CodeConditionStatement(
                new CodeBinaryOperatorExpression(
            ...
            secondFor.IncrementStatement = new CodeAssignStatement(
                new CodeVariableReferenceExpression("b"),
                new CodeBinaryOperatorExpression(
                    new CodeVariableReferenceExpression("b"),
                    CodeBinaryOperatorType.Add,
            ...
            secondFor.InitStatement = new CodeAssignStatement(
                new CodeVariableReferenceExpression("b"),
                new CodePrimitiveExpression(0)
            );
            secondFor.TestExpression = (
                new CodeBinaryOperatorExpression(
                    new CodeVariableReferenceExpression("b"),
                    CodeBinaryOperatorType.LessThan,
                    new CodePrimitiveExpression(2)
        ...
        public void GlobalKeyword()
        {
            ...
            method1.Attributes =
                (method1.Attributes & ~MemberAttributes.AccessMask)
                | MemberAttributes.Public
            ...
            CodeMethodInvokeExpression cmie = new CodeMethodInvokeExpression(
                new CodeMethodReferenceExpression(
                    new CodeTypeReferenceExpression(
                        new CodeTypeReference("Foo.Foo", CodeTypeReferenceOptions.GlobalReference)
                    ),
                    "TestMethod01"
                )
            );
            CodeAssignStatement cas = new CodeAssignStatement(
                new CodeVariableReferenceExpression("iReturn"),
                cmie
            );
            ...
            method3.Attributes =
                (method3.Attributes & ~MemberAttributes.AccessMask) | MemberAttributes.Public;
            ...
            cmie = new CodeMethodInvokeExpression(
                new CodeMethodReferenceExpression(new CodeTypeReferenceExpression(ctr), "Abs"),
                new CodeExpression[] { new CodePrimitiveExpression(-1) }
            );
        ...
        public void ProviderSupports()
        {
            using (new ThreadCultureChange(CultureInfo.InvariantCulture))
            {
                ...
                if (provider.Supports(GeneratorSupport.DeclareEnums))
                {
                    ...
                    CodeMethodReturnStatement truestmt = new CodeMethodReturnStatement(
                        new CodeCastExpression(
                            typeof(int),
                            new CodeFieldReferenceExpression(
                                new CodeTypeReferenceExpression("DecimalEnum"),
                                "Num3"
                            )
                        )
                    );
                ...
                if (provider.Supports(GeneratorSupport.NestedTypes))
                {
                    ...
                    class1.IsClass = true;
                    nspace.Types.Add(class1);
                    CodeTypeDeclaration nestedClass = new CodeTypeDeclaration(
                        "PublicNestedClassB1"
                    );
                    ...
                    nestedClass.IsClass = true;
                    class1.Members.Add(nestedClass);
                    CodeTypeDeclaration innerNestedClass = new CodeTypeDeclaration(
                        "PublicNestedClassC"
                    );
                ...
                if (provider.Supports(GeneratorSupport.ReferenceParameters))
                {
                    ...
                    CodeMethodInvokeExpression methodinvoked = new CodeMethodInvokeExpression(
                        new CodeMethodReferenceExpression(
                            new CodeTypeReferenceExpression("TEST"),
                            "Work"
                        )
                    );
                    // add parameter with ref direction
        ...
        public void GenericTypesAndConstraints()
        {
            ...
            string dictionaryTypeName = typeof(System.Collections.Generic.Dictionary<
                int,
        ...
        [SkipOnTargetFramework(
            TargetFrameworkMonikers.NetFramework,
            "The bug was present on .NET Framework: https://github.com/dotnet/runtime/issues/56267"
        )]
