...
namespace System.CodeDom.Compiler.Tests
{
    public class CSharpCodeGenerationTests : CodeGenerationTests
    {
        ...
        [Fact]
        [ActiveIssue(
            "https://github.com/dotnet/runtime/issues/1913",
            ~TargetFrameworkMonikers.NetFramework
        )]
        ...
        public void Goto()
        {
            ...
            param = new CodeParameterDeclarationExpression(typeof(int), "i");
            cmm.Parameters.Add(param);
            CodeAssignStatement assignmt = new CodeAssignStatement(
                new CodeVariableReferenceExpression("i"),
                new CodeBinaryOperatorExpression(
                    new CodeVariableReferenceExpression("i"),
                    CodeBinaryOperatorType.Add,
        ...
        {
            var codeTypeDeclaration = new CodeTypeDeclaration("ClassWithGenericMethod")
            {
                IsClass = true
            };
