...
namespace System.ComponentModel.Composition
{
    public class CompositionServicesTests
    {
        ...
        [Fact]
        [ActiveIssue("https://github.com/mono/mono/issues/15168", TestRuntimes.Mono)]
        ...
        public void GetDefaultContractNameTest()
        {
            ...
            expectations.Add(
                typeof(NestedParent.NestedChild),
                "System.ComponentModel.Composition.NestedParent+NestedChild"
            );
            ...
            expectations.Add(
                typeof(int).MakePointerType().MakeArrayType(3).MakeArrayType().MakePointerType(),
                "System.Int32*[][,,]*"
            );
            expectations.Add(typeof(int).MakeByRefType(), "System.Int32&");
            expectations.Add(
                typeof(int).MakePointerType().MakeArrayType(4).MakeArrayType().MakeByRefType(),
                "System.Int32*[][,,,]&"
            );
            ...
            expectations.Add(
                typeof(Dictionary<Dictionary<int, double>, double>),
                "System.Collections.Generic.Dictionary(System.Collections.Generic.Dictionary(System.Int32,System.Double),System.Double)"
            );
            expectations.Add(
                typeof(GenericContract1<int>.GenericContract2.GenericContract3<double>),
                "System.ComponentModel.Composition.GenericContract1(System.Int32)+GenericContract2+GenericContract3(System.Double)"
            );
            expectations.Add(
                typeof(GenericContract4<int, double>.GenericContract5<double, int>.GenericContract6<
                    int,
                    double
                >),
            ...
            expectations.Add(
                typeof(GenericContract7),
                "System.ComponentModel.Composition.GenericContract7"
            );
            expectations.Add(
                typeof(GenericContract8<int>),
                "System.ComponentModel.Composition.GenericContract8(System.Int32)"
            );
            expectations.Add(
            ...
            expectations.Add(
                typeof(OuterClassWithGenericNested.GenericNested<int>),
                "System.ComponentModel.Composition.OuterClassWithGenericNested+GenericNested(System.Int32)"
            );
            ...
            expectations.Add(
                typeof(DelegateCompositionTests.DoWorkDelegate),
                "System.Object(System.Int32,System.Object&,System.String&)"
            );
            expectations.Add(
                typeof(DelegateCompositionTests.DelegateOneArg),
                "System.Int32(System.Int32)"
            );
            expectations.Add(
                typeof(DelegateCompositionTests.DelegateTwoArgs),
                "System.Int32(System.Int32,System.Int32)"
            );
            expectations.Add(typeof(DelegateCompositionTests.SimpleDelegate), "System.Int32()");
            expectations.Add(
                EmitGenericType("MyGeneratedType", typeof(int)),
                "MyGeneratedType(System.Int32)"
            );
            expectations.Add(
                EmitGenericType("MyGeneratedType`1", typeof(string)),
                "MyGeneratedType(System.String)"
            );
            expectations.Add(
                EmitGenericType("_name_", typeof(List<>)),
                "_name_(System.Collections.Generic.List({0}))"
            );
            ...
            expectations.Add(
                EmitGenericType("System.Void", typeof(int)),
        ...
        public Type EmitGenericType(string typeName, Type genericArgumentType)
        {
            ...
            GenericTypeParameterBuilder T = typeBuilder.DefineGenericParameters(
                new string[] { "T" }
            )[0];
            typeBuilder.SetCustomAttribute(
                new CustomAttributeBuilder(
                    typeof(ExportAttribute).GetConstructor(Type.EmptyTypes),
                    new object[0]
                )
            );
