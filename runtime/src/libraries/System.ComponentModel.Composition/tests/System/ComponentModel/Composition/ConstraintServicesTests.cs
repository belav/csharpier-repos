...
namespace System.ComponentModel.Composition
{
    public class ConstraintServicesTests
    {
        ...
        public void TypeIdentityConstraint_ValidMatchingExportDef_ShouldMatch()
        {
            ...
            var typeIdentity = AttributedModelServices.GetTypeIdentity(
                typeof(ConstraintServicesTests)
            );
            ...
            var constraint = ConstraintServices.CreateConstraint(
                contractName,
                typeIdentity,
                null,
                CreationPolicy.Any
        ...
        public void PartCreatorConstraint_ShouldMatchPartCreatorExportDefinition()
        {
            var partCreatorImportDef = ReflectionModelServices.CreateImportDefinition(
                ...
                {
                    new KeyValuePair<string, Type>("MDKey", typeof(string)),
                },
        ...
        public void TryParseConstraint_ContractNameOperatorEqualsAsConstraintArgument_CanParse()
        {
            ...
            expectations.Add(item => item.ContractName == "{ContractName}", "{ContractName}");
            expectations.Add(
                item => item.ContractName == "{ContractName}Name",
                "{ContractName}Name"
            );
            expectations.Add(
                item => item.ContractName == "System.Windows.Forms.Control",
        ...
        public void TryParseConstraint_MetadataContainsKeyAsConstraintArgument_CanParse()
        {
            ...
            expectations.Add(
                item =>
                    typeof(string).IsInstanceOfType(item.Metadata["Value"])
                    && typeof(int).IsInstanceOfType(item.Metadata["value"]),
            ...
            expectations.Add(
                item =>
                    typeof(string).IsInstanceOfType(item.Metadata["Value"])
                    && typeof(int).IsInstanceOfType(item.Metadata["value"])
                    && typeof(object).IsInstanceOfType(item.Metadata["Metadata"]),
                new Dictionary<string, Type>
                {
                    { "Value", typeof(string) },
                    { "value", typeof(int) },
        ...
        public void TryParseConstraint_ContractNameOperatorEqualsAndMetadataContainsKeyAsConstraintArgumen_CanParse()
        {
            ...
            expectations.Add(
                item =>
                    ...
                    && typeof(string).IsInstanceOfType(item.Metadata[""]),
                new KeyValuePair<string, Type>[]
                {
            ...
            expectations.Add(
                ...
                new KeyValuePair<string, Type>[]
                {
                    new KeyValuePair<string, Type>("Value", typeof(string)),
                    new KeyValuePair<string, Type>("value", typeof(int)),
                    new KeyValuePair<string, Type>("Metadata", typeof(object)),
                }
            );
        ...
        public void TryParseConstraint_ContractNameReverseOperatorEqualsAsConstraintArgument_CanParse()
        {
            ...
            expectations.Add(item => "{ContractName}" == item.ContractName, "{ContractName}");
            expectations.Add(
                item => "{ContractName}Name" == item.ContractName,
                "{ContractName}Name"
            );
            expectations.Add(
                item => "System.Windows.Forms.Control" == item.ContractName,
                "System.Windows.Forms.Control"
            );
            expectations.Add(
                item => "{System.Windows.Forms}Control" == item.ContractName,
        ...
        private static void AssertCanParse(
        ...
        )
        {
            ...
            bool success = ConstraintParser.TryParseConstraint(
                constraint,
                out contractNameResult,
                out requiredMetadataResult
            );
        ...
        private static void AssertCanNotParse(Expression<Func<ExportDefinition, bool>> constraint)
        {
            ...
            var success = ConstraintParser.TryParseConstraint(
                constraint,
                out contractNameResult,
                out requiredMetadataResult
            );
