...
namespace System.ComponentModel.Composition.Primitives
{
    ...
    public class Export
    {
        ...
        public object? Value
        {
            get
            {
                // NOTE : the logic below guarantees that the value will be set exactly once. It DOES NOT, however,
                // guarantee that GetExportedValueCore() will be executed
                // only once, as locking would be required for that. The said locking is problematic, as we can't
                // reliable call 3rd party code under a lock.
