        ...
        )
        {
            ...
            if (!string.IsNullOrEmpty(requiredTypeIdentity))
            {
                Expression typeIdentityConstraintBody =
                    ConstraintServices.CreateTypeIdentityContraint(requiredTypeIdentity, parameter);
            ...
            {
                Expression policyConstraintBody = ConstraintServices.CreateCreationPolicyContraint(
