...
namespace System.ComponentModel.Composition
{
    internal static class ConstraintServices
    {
        ...
        private static readonly MethodInfo _metadataItemMethod = typeof(IDictionary<
            ...
            object
        >).GetMethod("get_Item")!;
        private static readonly MethodInfo _metadataEqualsMethod = typeof(object).GetMethod(
            "Equals",
        ...
        )
        {
            ...
            Expression constraintBody = ConstraintServices.CreateContractConstraintBody(
                contractName,
                parameter
            );
            ...
            if (!string.IsNullOrEmpty(requiredTypeIdentity))
            {
                Expression typeIdentityConstraintBody =
                    ConstraintServices.CreateTypeIdentityConstraint(
            ...
            if (requiredMetadata != null)
            {
                Expression? metadataConstraintBody =
                    ConstraintServices.CreateMetadataConstraintBody(requiredMetadata, parameter);
            ...
            {
                Expression policyConstraintBody = ConstraintServices.CreateCreationPolicyConstraint(
        ...
        )
        {
            ...
            return Expression.Equal(
                Expression.Property(
                    parameter,
                    ConstraintServices._exportDefinitionContractNameProperty
                ),
        ...
        )
        {
            ...
            foreach (KeyValuePair<string, Type> requiredMetadataItem in requiredMetadata)
            {
                ...
                Expression metadataItemExpression = CreateMetadataContainsKeyExpression(
                    parameter,
                    requiredMetadataItem.Key
                );

                body =
                    (body != null)
                        ? Expression.AndAlso(body, metadataItemExpression)
                        : metadataItemExpression;
                body = Expression.AndAlso(
                    body,
                    CreateMetadataOfTypeExpression(
                        parameter,
                        requiredMetadataItem.Key,
                        requiredMetadataItem.Value
                    )
                );
            }
        ...
        private static Expression CreateCreationPolicyConstraint(
        ...
        )
        {
            ...
            return Expression.MakeBinary(
                ...
                Expression.MakeBinary(
                    ExpressionType.OrElse,
                    Expression.Not(
                        CreateMetadataContainsKeyExpression(
                            parameter,
                            CompositionConstants.PartCreationPolicyMetadataName
                        )
                    ),
                    CreateMetadataValueEqualsExpression(
                        parameter,
                        CreationPolicy.Any,
                        CompositionConstants.PartCreationPolicyMetadataName
                    )
        ...
        private static Expression CreateTypeIdentityConstraint(
            string requiredTypeIdentity,
            ParameterExpression parameter
        )
        {
        ...
        )
        {
            ...
            return Expression.Call(
                Expression.Property(
                    parameter,
                    ConstraintServices._exportDefinitionMetadataProperty
                ),
        ...
        private static Expression CreateMetadataOfTypeExpression(
            ParameterExpression parameter,
            string constantKey,
            Type constantType
        )
        ...
        private static Expression CreateMetadataValueEqualsExpression(
            ParameterExpression parameter,
        ...
        )
        {
            ...
            Expression metadataExpression = Expression.Property(
            ...
            >(
                Expression.AndAlso(
                    baseConstraint.Body,
                    Expression.AndAlso(containsProductExpression, productMatchExpression)
                ),
                exportDefinitionParameter
            );
