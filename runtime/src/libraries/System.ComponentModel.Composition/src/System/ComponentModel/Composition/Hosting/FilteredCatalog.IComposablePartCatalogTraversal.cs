...
namespace System.ComponentModel.Composition.Hosting
{
    ...
    {
        /// <summary>
        /// This is designed to traverse a set of parts based on whatever pattern. There are no real
        // expectations
        /// as to what the pattern is and what properties is posseses
        /// NOTE : we both with this interface - as opposed to just a simple delegate - due to minute
        // performance reasons,
        /// as this will be invoked very often. Also, each traversal is typically associated with a big
        // state bag, which is
