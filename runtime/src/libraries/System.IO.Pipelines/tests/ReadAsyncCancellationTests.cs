...
namespace System.IO.Pipelines.Tests
{
    public class ReadAsyncCancellationTests : PipeTest
    {
        ...
        public void ReadAsyncCancellationDeadlock()
        {
            ...
            Assert.True(
                completed,
                $"Read tasks are not completed. CancellationTask: {cancellationTask.Status} BlockingTask: {blockingTask.Status}"
            );
        }
        ...
        public void GetResultThrowsIfFlushAsyncTokenFiredAfterCancelPending()
        {
            ...
            ValueTaskAwaiter<ReadResult> awaiter = Pipe.Reader.ReadAsync(
        ...
        public void ReadAsyncThrowsIfPassedCanceledCancellationToken()
        {
            ...
            Assert.Throws<OperationCanceledException>(
                () => Pipe.Reader.ReadAsync(cancellationTokenSource.Token)
            );
        }
