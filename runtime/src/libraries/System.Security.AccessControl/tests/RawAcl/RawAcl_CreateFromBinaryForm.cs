...
namespace System.Security.AccessControl.Tests
{
    public class RawAcl_CreateFromBinaryForm
    {
        ...
        public static void BasicValidationTestCases()
        {
            ...
            Assert.True(
                TestCreateFromBinaryForm(binaryForm, offset, revision, 1, rawAcl.BinaryLength)
            );
            ...
            rawAcl.GetBinaryForm(binaryForm, 0);
            Assert.True(
                TestCreateFromBinaryForm(binaryForm, offset, revision, 0, rawAcl.BinaryLength)
            );
            ...
            rawAcl.GetBinaryForm(binaryForm, 0);
            Assert.True(
                TestCreateFromBinaryForm(binaryForm, offset, revision, 5, rawAcl.BinaryLength)
            );
        }
        ...
        public static void AdditionalTestCases()
        {
            ...
            Assert.True(
                TestCreateFromBinaryForm(binaryForm, 1000, revision, 256, rawAcl.BinaryLength)
            );
