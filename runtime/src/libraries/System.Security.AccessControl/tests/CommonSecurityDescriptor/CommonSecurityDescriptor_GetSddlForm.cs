...
{
    partial public class CommonSecurityDescriptor_GetSddlForm
    {
        ...
        public static void TestGetSddlForm(
            bool isContainer,
            bool isDS,
            int flags,
            string ownerStr,
        ...
        )
        {
            ...
            Assert.True(
                string.Compare(expectedSddl, resultSddl, StringComparison.CurrentCultureIgnoreCase)
                    == 0
            );
        }
    }
