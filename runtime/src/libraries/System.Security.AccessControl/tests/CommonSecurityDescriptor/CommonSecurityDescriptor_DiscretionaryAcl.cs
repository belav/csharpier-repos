...
{
    partial public class CommonSecurityDescriptor_DiscretionaryAcl
    {
        ...
        public static void TestDiscretionaryAcl(
            bool isContainerSD,
            bool isDSSD,
            string sddl,
        ...
        )
        {
                ...
                )
                {
                    if (dacl == null)
                    {
                        ...
                        if (
                            ...
                            && Utils.VerifyDaclWithCraftedAce(
                                commonSecurityDescriptor.IsContainer,
            ...
            {
                Assert.True(
                    (dacl.IsContainer != commonSecurityDescriptor.IsContainer)
                        || (dacl.IsDS != commonSecurityDescriptor.IsDS)
                );
                result = true;
            }
            Assert.True(result);
