...
{
    partial public class CommonSecurityDescriptor_Constructor
    {
        ...
        )
        {
            ...
            try
            {
                ...
                )
                {
                    if (dacl == null)
                    {
                        ...
                        if (
                            isContainer == commonSecurityDescriptor.DiscretionaryAcl.IsContainer
            ...
            {
                if (
                    (sacl != null && sacl.IsContainer != isContainer)
