            ...
            public partial class PrefixImprovements : XLinqTestCase
            {
                ...
                public void var_1()
                {
                    XElement e = new XElement(
                        ...
                        new XElement(
                            "B",
                            new XAttribute(XNamespace.Xmlns + "q", "p"),
                            new XElement("{p}C", new XAttribute(XNamespace.Xmlns + "q", "q"))
                        )
                    );
                    CompareStringThroughXmlReader(
                        e.ToString(SaveOptions.DisableFormatting),
                        @"<A xmlns:p='p'><B xmlns:q='p'><p:C xmlns:q='q' /></B></A>"
                    );
                }
                ...
                public void var_1a()
                {
                    XElement e = new XElement(
                        ...
                        new XElement(
                            "B",
                            new XAttribute(XNamespace.Xmlns + "q", "p"),
                            new XAttribute("{p}a", "a"),
                            new XElement(
                                "{q}C",
                                new XAttribute(XNamespace.Xmlns + "q", "q"),
                                new XAttribute("{p}a", "a")
                            )
                        )
                    );
                    CompareStringThroughXmlReader(
                        e.ToString(SaveOptions.DisableFormatting),
                        @"<A xmlns:p='p'><B xmlns:q='p' q:a='a'><q:C xmlns:q='q' p:a='a' /></B></A>"
                    );
                }
                ...
                public void var_2()
                {
                    XElement e = new XElement(
                        ...
                        new XElement(
                            "{p}B",
                            new XAttribute("xmlns", "p"),
                            new XElement("{p}C", new XAttribute("xmlns", "q"))
                        )
                    );
                    CompareStringThroughXmlReader(
                        e.ToString(SaveOptions.DisableFormatting),
                        @"<A xmlns:p='p'><B xmlns='p'><p:C xmlns='q' /></B></A>"
                    );
                }
                ...
                public void var_2a()
                {
                    ...
                    CompareStringThroughXmlReader(
                        e.ToString(SaveOptions.DisableFormatting),
                        @"<A xmlns:p='p'><B xmlns='p' p:a='a'><C xmlns='q' p:a='a' /></B></A>"
                    );
                }
                ...
                public void var_3()
                {
                    ...
                    CompareStringThroughXmlReader(
                        e.ToString(SaveOptions.DisableFormatting),
                        @"<A xmlns='p'><p:B xmlns:p='p'><C xmlns:p='q' /></p:B></A>"
                    );
                }
                ...
                public void var_3a()
                {
                    XElement e = new XElement(
                        ...
                        new XElement(
                            ...
                            new XElement(
                                "{q}C",
                                new XAttribute(XNamespace.Xmlns + "p", "q"),
                                new XAttribute("{p}a", "a")
                            )
                        )
                    );
                    CompareStringThroughXmlReader(
                        e.ToString(SaveOptions.DisableFormatting),
                        @"<A xmlns='p'><p:B xmlns:p='p' p:a='a'><p:C xmlns:p='q' p3:a='a' xmlns:p3='p' /></p:B></A>"
                    );
                }
                ...
                public void var_4()
                {
                    ...
                    CompareStringThroughXmlReader(
                        e.ToString(SaveOptions.DisableFormatting),
                        @"<A xmlns='p'><p:B xmlns:p='p'><C xmlns:p='q'><p:X xmlns:p='p'><p:Y /></p:X></C></p:B></A>"
                    );
                }
                ...
                public void var_5a()
                {
                    ...
                    CompareStringThroughXmlReader(
                        e.ToString(SaveOptions.DisableFormatting),
                        @"<A xmlns:p='p'><B xmlns='p' p:a='a' ><C p:c='c' /></B></A>"
                    );
                }
                ...
                public void var_5b()
                {
                    XElement e = new XElement(
                        "A",
                        new XAttribute(XNamespace.Xmlns + "q", "q"),
                        new XAttribute(XNamespace.Xmlns + "top", "p"),
                        new XElement(
                            "{q}B",
                            new XAttribute(XNamespace.Xmlns + "p", "p"),
                            new XAttribute("xmlns", "q"),
                            ...
                            new XElement(
                                "{g}G",
                                new XAttribute("xmlns", "g"),
                                new XAttribute("{g}g", "givemeprefix")
                            )
                        )
                    ); // autogenerate new prefix

                    string expResult =
                        @"<A xmlns:q='q' xmlns:top='p'>
                                              <B xmlns:p='p' xmlns='q'>
                ...
                public void var_6()
                {
                    ...
                    CompareStringThroughXmlReader(
                        ...
                        @"<A xmlns:a='a'><B xmlns:b='a'><B xmlns:c='a'><B xmlns:d='a'><a:C xmlns:d='b' xmlns:c='b' xmlns:b='b' /></B></B></B></A>"
                    );
                }
                ...
                public void var_6b()
                {
                    ...
                    CompareStringThroughXmlReader(
                        root.ToString(SaveOptions.DisableFormatting),
                        @"<A xmlns:a='a'><B xmlns:b='a'><B xmlns:c='a'><B xmlns:d='a'><a:C xmlns:b='b' xmlns:c='b' xmlns:d='b' /></B></B></B></A>"
                    );
                }
                ...
                public void var_7()
                {
                    ...
                    XElement e = new XElement(
                        ...
                        new XElement(
                            "{a}B",
                            new XAttribute("xmlns", "a"),
                            new XElement(
                                "{ii}C",
                                new XAttribute(XNamespace.Xmlns + "b", "a"), // This one auto generates xmlns='ii'"
                                new XElement("{a}D", new XAttribute(XNamespace.Xmlns + "b", "X"))
                            )
                        )
                    );
                    string expected =
                        @"<A xmlns:a='a'><B xmlns='a'><C xmlns:b='a' xmlns='ii'><a:D xmlns:b='X' /></C></B></A>";
                    try
                    {
