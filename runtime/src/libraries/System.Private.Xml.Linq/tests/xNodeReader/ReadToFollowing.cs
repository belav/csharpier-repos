        ...
        public partial class XNodeReaderTests : XLinqTestCase
        {
            ...
            public partial class TCReadToFollowing : BridgeHelpers
            {
                ...
                public void v6()
                {
                    ...
                    TestLog.Compare(
                        DataReader.ReadToFollowing("child4"),
                        true,
                ...
                public void v7()
                {
                    ...
                    TestLog.Compare(
                        DataReader.ReadToFollowing("child1", "elem"),
                        true,
                        "Cant find child1"
                    );
                    TestLog.Compare(
                ...
                public void v8()
                {
                    ...
                    TestLog.Compare(
                        DataReader.ReadToFollowing("e:child1"),
                        true,
                        "Cant find child1"
                    );
                    TestLog.Compare(
                        DataReader.ReadToFollowing("e:child2"),
                        true,
                        "Cant find child2"
                    );
                    TestLog.Compare(
                        DataReader.ReadToFollowing("e:child3"),
                        true,
                        "Cant find child3"
                    );
                    TestLog.Compare(
                        DataReader.ReadToFollowing("e:child4"),
                        true,
                        "Cant fine child4"
                    );
                    TestLog.Compare(DataReader.NodeType, XmlNodeType.Element, "Not on Element");
                ...
                public void v9()
                {
                    ...
                    TestLog.Compare(
                        DataReader.ReadToFollowing("child3"),
                        true,
                        "Read fails child3"
                    );
                    TestLog.Compare(
                        DataReader.ReadToNextSibling("child4"),
                        true,
                        "Read fails child4"
                    );
                ...
                public void v11()
                {
                    ...
                    TestLog.Compare(
                        DataReader.ReadToNextSibling("e:child4"),
                        true,
                        "Read fails child4"
                    );
