        ...
        public partial class XNodeReaderTests : XLinqTestCase
        {
            ...
            public partial class TCReadToDescendant : BridgeHelpers
            {
                ...
                public void v6()
                {
                    ...
                    TestLog.Compare(
                        DataReader.ReadToDescendant("child2"),
                        true,
                        "Cant find child2"
                    );
                    TestLog.Compare(
                        DataReader.ReadToDescendant("child3"),
                        true,
                        "Cant find child3"
                    );
                    TestLog.Compare(
                        DataReader.ReadToDescendant("child4"),
                        false,
                ...
                public void v7()
                {
                    ...
                    TestLog.Compare(
                        DataReader.ReadToDescendant("child1", "elem"),
                        true,
                        "Cant find child1"
                    );
                    TestLog.Compare(
                ...
                public void v8()
                {
                    ...
                    TestLog.Compare(
                        DataReader.ReadToDescendant("e:child1"),
                        true,
                        "Cant find child1"
                    );
                    TestLog.Compare(
                        DataReader.ReadToDescendant("e:child2"),
                        true,
                        "Cant find child2"
                    );
                    TestLog.Compare(
                        DataReader.ReadToDescendant("e:child3"),
                        true,
                        "Cant find child3"
                    );
                    TestLog.Compare(
                        DataReader.ReadToDescendant("e:child4"),
                        false,
                        "Shouldn't find child4"
                    );
                    TestLog.Compare(DataReader.NodeType, XmlNodeType.Element, "Not on EndElement");
                ...
                public void v19()
                {
                    ...
                    TestLog.Compare(
                        DataReader.ReadToDescendant("foo"),
                        false,
                        "Should fail without assert"
                    );
