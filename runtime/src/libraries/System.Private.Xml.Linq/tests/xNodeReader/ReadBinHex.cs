        ...
        partial public class XNodeReaderTests : XLinqTestCase
        {
            partial public class TCReadContentAsBinHex : BridgeHelpers
            {
                ...
                public void TestReadBinHex_16()
                {
                    ...
                    DataReader.Read();
                    TestLog.Compare(
                        VerifyNode(DataReader, XmlNodeType.Element, "ElemText", string.Empty),
                        "1vn"
                    );
                }
                ...
                public void TestReadBinHex_17()
                {
                    ...
                    TestLog.Compare(
                        VerifyNode(DataReader, XmlNodeType.EndElement, "ElemNum", string.Empty),
                        "1vn"
                    );
                }
                ...
                {
                    XmlReader DataReader = GetReaderStr(
                        @"<root>
<boo>hey</boo>
</root>"
                    );
            ...
            public class TCReadElementContentAsBinHex : BridgeHelpers
            {
                ...
                public void TestReadBinHex_4()
                {
                    ...
                    XmlReader DataReader = GetReader(
                        new StringReader("<root>AB<!--Comment-->CD<?pi target?>EF</root>")
                    );
                    PositionOnElement(DataReader, "root");
                    if (!DataReader.CanReadBinaryContent)
                        return;
