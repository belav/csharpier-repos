...
namespace XLinqTests
{
    public class LoadFromStream : XLinqTestCase
    {
        ...
        private readonly XDocument _purchaseOrder = new XDocument(
            new XElement(
                "PurchaseOrder",
                new XElement(
                    "Item",
        ...
        {
            AddChild(
                new TestVariation(StreamStateAfterLoading)
                {
                    Attribute = new VariationAttribute("Stream state after loading")
                    {
                        Priority = 0,
                    },
                }
            ...
            AddChild(
                new TestVariation(LoadOptionsPWS)
                {
                    Attribute = new VariationAttribute(
            ...
            AddChild(
                new TestVariation(LoadOptionsBU)
                {
                    Attribute = new VariationAttribute(
            ...
            AddChild(
                new TestVariation(LoadOptionsLI)
                {
                    Attribute = new VariationAttribute(
            ...
            AddChild(
                new TestVariation(XE_LoadOptionsPWS)
                {
                    Attribute = new VariationAttribute(
            ...
            AddChild(
                new TestVariation(XE_LoadOptionsBU)
                {
                    Attribute = new VariationAttribute(
            ...
            AddChild(
                new TestVariation(XE_LoadOptionsLI)
                {
                    Attribute = new VariationAttribute(
            ...
            AddChild(
                new TestVariation(SaveOptionsTests)
                {
                    Attribute = new VariationAttribute(
            ...
            AddChild(
                new TestVariation(SaveOptionsTests)
                {
                    Attribute = new VariationAttribute("XDocument.Save(), SaveOptions.None")
                    {
                        Param = 0,
                        Priority = 1,
                    },
            ...
            AddChild(
                new TestVariation(ElementSaveOptionsTests)
                {
                    Attribute = new VariationAttribute(
            ...
            AddChild(
                new TestVariation(ElementSaveOptionsTests)
                {
                    Attribute = new VariationAttribute("XElement.Save(), SaveOptions.None")
                    {
                        Param = 0,
                        Priority = 1,
                    },
            ...
            AddChild(
                new TestVariation(SaveOptionsDefaultTests)
                {
                    Attribute = new VariationAttribute("XDocument.Save(), SaveOptions - default")
                    {
                        Priority = 1,
                    },
                }
            ...
            AddChild(
                new TestVariation(ElementSaveOptionsDefaultTests)
                {
                    Attribute = new VariationAttribute("XElement.Save(), SaveOptions - default")
                    {
                        Priority = 1,
                    },
                }
            ...
            AddChild(
                new TestVariation(EncodingHints)
                {
                    Attribute = new VariationAttribute("XDocument.Save(), Encoding hints UTF-8")
                    {
                        Param = "UTF-8",
                        Priority = 1,
                    },
            ...
            AddChild(
                new TestVariation(EncodingHintsDefault)
                {
                    Attribute = new VariationAttribute(
        ...
        public void ElementSaveOptionsDefaultTests()
        {
            ...
            var doc = new XDocument(
                ...
                new XElement(
                    ...
                    new XAttribute(XNamespace.Xmlns + "p", "ns1"),
                    new XElement("{ns1}A", new XAttribute(XNamespace.Xmlns + "p", "ns1"))
                )
            );
        ...
        public void EncodingHints()
        {
            ...
            var doc = new XDocument(
                new XDeclaration("1.0", enc.WebName, "yes"),
                new XElement(
                    "root",
                    new XProcessingInstruction("PI", ""),
                    new XAttribute("id", "root"),
        ...
        public void EncodingHintsDefault()
        {
            ...
            using (var ms = new MemoryStream())
            {
                ...
                using (var sr = new StreamReader(ms))
                {
                    XDocument d1 = XDocument.Load(sr);
                    TestLog.Compare(
                        sr.CurrentEncoding.Equals(Encoding.UTF8),
        ...
        public void LoadOptionsBU()
        {
            ...
            )
            {
                ...
                if (!string.IsNullOrWhiteSpace(baseUri))
                {
                    TestLog.Compare(
                        new Uri(baseUri),
                        new Uri(GetFullTestPath(fileName)),
                        "base uri failed"
                    );
                }
            }
        ...
        public void LoadOptionsPWS()
        {
            ...
            TestLog.Compare(
                doc.Root.FirstNode.NodeType == XmlNodeType.Text,
                "First node in root should be whitespace"
            );

            // PreserveWhitespace = false ... default
            doc = GetXDocument(fileName, LoadOptions.None, how);
            TestLog.Compare(
                doc.Root.FirstNode.NodeType == XmlNodeType.Element,
        ...
        public void XE_LoadOptionsPWS()
        {
            ...
            TestLog.Compare(
                e.FirstNode.NodeType == XmlNodeType.Text,
                "First node in root should be whitespace"
            );
            ...
            e = GetXElement(fileName, LoadOptions.None, how);
            TestLog.Compare(
                e.FirstNode.NodeType == XmlNodeType.Element,
                "First node in root should be element(no ws)"
            );
        }
            ...
            switch (how)
            {
                ...
                default:
                    throw new TestFailedException(
                        "TEST FAILED: don't know how to create XDocument"
                    );
            }
        }
