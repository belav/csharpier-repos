    ...
    public class XContainerReplaceNodesOnXElement : XContainerReplaceNodes
    {
        public override void AddChildren()
        {
            AddChild(
                new TestVariation(OnXElement)
                {
                    ...
                    )
                    {
                        ...
                        {
                            2,
                            "<A xmlns='ns1' xmlns:p='nsp'>_text_content_</A>",
                            false,
                        },
                        Priority = 0,
                    },
            ...
            AddChild(
                new TestVariation(OnXElement)
                {
                    Attribute = new VariationAttribute("XElement: Replace with single node")
                    {
                        Params = new object[]
                        {
                            1,
            ...
            AddChild(
                new TestVariation(OnXElement)
                {
                    Attribute = new VariationAttribute("XElement: Replace with multiple nodes")
                    {
                        Params = new object[]
                        {
                            4,
