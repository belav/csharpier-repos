...
namespace XLinqTests
{
    public class TreeManipulationTests : TestModule
    {
        ...
        {
            RunTestCase(
                new ParamsObjectsCreation
                {
                    Attribute = new TestCaseAttribute
                    {
                        Name = "Constructors with params - XDocument",
                    },
                }
            );
        }
        ...
        {
            RunTestCase(
                new ParamsObjectsCreationElem
                {
                    Attribute = new TestCaseAttribute
                    {
                        Name = "Constructors with params - XElement - array",
                        Param = 0,
                    },
                }
            ); //Param = InputParamStyle.Array
        }
        ...
        public static void ConstructorXElementIEnumerable()
        {
            RunTestCase(
                new ParamsObjectsCreationElem
                {
                    Attribute = new TestCaseAttribute
                    {
                        Name = "Constructors with params - XElement - IEnumerable",
                        Param = 2,
                    },
                }
        ...
        public static void ConstructorXElementNodeArray()
        {
            RunTestCase(
                new ParamsObjectsCreationElem
                {
                    Attribute = new TestCaseAttribute
                    {
                        Name = "Constructors with params - XElement - node + array",
                        Param = 1,
                    },
                }
        ...
        {
            RunTestCase(
                new XAttributeEnumRemove
                {
                    Attribute = new TestCaseAttribute
                    {
                        Name = "IEnumerable<XAttribute>.Remove()",
        ...
        public static void IEnumerableOfXAttributeRemoveWithRemove()
        {
            RunTestCase(
                new XAttributeEnumRemove
                {
                    Attribute = new TestCaseAttribute
                    {
                        Name = "IEnumerable<XAttribute>.Remove() with Events",
        ...
        {
            RunTestCase(
                new XNodeSequenceRemove
                {
                    Attribute = new TestCaseAttribute
                    {
                        Name = "IEnumerable<XNode>.Remove()",
                        Params = new object[] { false },
                    },
                }
            );
        ...
        public static void IEnumerableOfXNodeRemoveWithEvents()
        {
            RunTestCase(
                new XNodeSequenceRemove
                {
                    Attribute = new TestCaseAttribute
                    {
                        Name = "IEnumerable<XNode>.Remove() with Events",
                        Params = new object[] { true },
                    },
                }
            );
        ...
        public static void LoadFromReader()
        {
            RunTestCase(
                new LoadFromReader
                {
                    Attribute = new TestCaseAttribute { Name = "Load from Reader" },
                }
            );
        }
        ...
        public static void LoadFromStreamSanity()
        {
            RunTestCase(
                new LoadFromStream
                {
                    Attribute = new TestCaseAttribute { Name = "Load from Stream - sanity" },
                }
            );
        }
        ...
        public static void SaveWithWriter()
        {
            RunTestCase(
                new SaveWithWriter
                {
                    Attribute = new TestCaseAttribute { Name = "Save with Writer" },
                }
            );
        }
        ...
        {
            RunTestCase(
                new SimpleObjectsCreation
                {
                    Attribute = new TestCaseAttribute { Name = "Simple constructors" },
                }
            );
        }
        ...
        {
            RunTestCase(
                new XAttributeRemove
                {
                    Attribute = new TestCaseAttribute
                    {
                        Name = "XAttribute.Remove",
                        Params = new object[] { false },
                    },
                }
            );
        ...
        public static void XAttributeRemoveWithEvents()
        {
            RunTestCase(
                new XAttributeRemove
                {
                    Attribute = new TestCaseAttribute
                    {
                        Name = "XAttribute.Remove with Events",
                        Params = new object[] { true },
                    },
                }
            );
        ...
        {
            RunTestCase(
                new XContainerAddIntoElement
                {
                    Attribute = new TestCaseAttribute
                    {
                        Name = "XContainer.Add1",
                        Params = new object[] { false },
                    },
                }
            );
        ...
        {
            RunTestCase(
                new XContainerAddIntoDocument
                {
                    Attribute = new TestCaseAttribute
                    {
                        Name = "XContainer.Add2",
                        Params = new object[] { false },
                    },
                }
            );
        ...
        {
            RunTestCase(
                new AddFirstInvalidIntoXDocument
                {
                    Attribute = new TestCaseAttribute
                    {
                        Name = "XContainer.AddFirst",
                        Params = new object[] { false },
                    },
                }
            );
        ...
        public static void XContainerAddFirstInvalidIntoXDocumentWithEvents()
        {
            RunTestCase(
                new AddFirstInvalidIntoXDocument
                {
                    Attribute = new TestCaseAttribute
                    {
                        Name = "XContainer.AddFirst with Events",
                        Params = new object[] { true },
                    },
                }
            );
        ...
        {
            RunTestCase(
                new AddFirstSingeNodeAddIntoElement
                {
                    Attribute = new TestCaseAttribute
                    {
                        Name = "XContainer.AddFirstAddFirstSingeNodeAddIntoElement",
                        Params = new object[] { false },
                    },
                }
            );
        ...
        public static void AddFirstSingeNodeAddIntoElementWithEvents()
        {
            RunTestCase(
                new AddFirstSingeNodeAddIntoElement
                {
                    Attribute = new TestCaseAttribute
                    {
                        Name = "XContainer.AddFirstAddFirstSingeNodeAddIntoElement with Events",
                        Params = new object[] { true },
                    },
                }
            );
        ...
        {
            RunTestCase(
                new AddFirstAddFirstIntoDocument
                {
                    Attribute = new TestCaseAttribute
                    {
                        Name = "XContainer.AddFirstAddFirstAddFirstIntoDocument",
                        Params = new object[] { false },
                    },
                }
            );
        ...
        public static void AddFirstAddFirstIntoDocumentWithEvents()
        {
            RunTestCase(
                new AddFirstAddFirstIntoDocument
                {
                    Attribute = new TestCaseAttribute
                    {
                        Name = "XContainer.AddFirstAddFirstAddFirstIntoDocument with Events",
                        Params = new object[] { true },
                    },
                }
            );
        ...
        public static void XContainerAddIntoElementWithEvents()
        {
            RunTestCase(
                new XContainerAddIntoElement
                {
                    Attribute = new TestCaseAttribute
                    {
                        Name = "XContainer.Add with Events",
                        Params = new object[] { true },
                    },
                }
            );
        ...
        public static void XContainerNextPreviousNode()
        {
            RunTestCase(
                new NextNode
                {
                    Attribute = new TestCaseAttribute { Name = "XContainer.Next/PreviousNode" },
                }
            );
        }
        ...
        {
            RunTestCase(
                new XContainerRemoveNodesOnXElement
                {
                    Attribute = new TestCaseAttribute
                    {
                        Name = "XContainer.RemoveNodes()",
                        Params = new object[] { false },
                    },
                }
            );
        ...
        public static void XContainerRemoveNodesOnXElementWithEvents()
        {
            RunTestCase(
                new XContainerRemoveNodesOnXElement
                {
                    Attribute = new TestCaseAttribute
                    {
                        Name = "XContainer.RemoveNodes() with Events",
                        Params = new object[] { true },
                    },
                }
            );
        ...
        {
            RunTestCase(
                new XContainerRemoveNodesOnXDocument
                {
                    Attribute = new TestCaseAttribute
                    {
                        Name = "XContainer.RemoveNodes()",
        ...
        {
            RunTestCase(
                new XContainerReplaceNodesOnDocument
                {
                    Attribute = new TestCaseAttribute
                    {
                        Name = "XContainer.ReplaceNodesOnXDocument()",
                        Params = new object[] { false },
                    },
                }
            );
        ...
        public static void XContainerReplaceNodesOnDocumentWithEvents()
        {
            RunTestCase(
                new XContainerReplaceNodesOnDocument
                {
                    Attribute = new TestCaseAttribute
                    {
                        Name = "XContainer.ReplaceNodesOnXDocument() with Events",
                        Params = new object[] { true },
                    },
                }
            );
        ...
        {
            RunTestCase(
                new XContainerReplaceNodesOnXElement
                {
                    Attribute = new TestCaseAttribute
                    {
                        Name = "XContainer.ReplaceNodesOnXElement()",
                        Params = new object[] { false },
                    },
                }
            );
        ...
        public static void XContainerReplaceNodesOnXElementWithEvents()
        {
            RunTestCase(
                new XContainerReplaceNodesOnXElement
                {
                    Attribute = new TestCaseAttribute
                    {
                        Name = "XContainer.ReplaceNodesOnXElement() with Events",
                        Params = new object[] { true },
                    },
                }
            );
        ...
        public static void XElementRemoveAttributes()
        {
            RunTestCase(
                new RemoveAttributes
                {
                    Attribute = new TestCaseAttribute
                    {
                        Name = "XElement.RemoveAttributes",
                        Params = new object[] { false },
                    },
                }
            );
        ...
        public static void XElementRemoveAttributesWithEvents()
        {
            RunTestCase(
                new RemoveAttributes
                {
                    Attribute = new TestCaseAttribute
                    {
                        Name = "XElement.RemoveAttributes with Events",
                        Params = new object[] { true },
                    },
                }
            );
        ...
        {
            RunTestCase(
                new XElement_SetAttributeValue
                {
                    Attribute = new TestCaseAttribute
                    {
                        Name = "XElement.SetAttributeValue()",
                        Params = new object[] { false },
                    },
                }
            );
        ...
        public static void XElementSetAttributeValueWithEvents()
        {
            RunTestCase(
                new XElement_SetAttributeValue
                {
                    Attribute = new TestCaseAttribute
                    {
                        Name = "XElement.SetAttributeValue() with Events",
                        Params = new object[] { true },
                    },
                }
            );
        ...
        {
            RunTestCase(
                new XElement_SetElementValue
                {
                    Attribute = new TestCaseAttribute
                    {
                        Name = "XElement.SetElementValue()",
                        Params = new object[] { false },
                    },
                }
            );
        ...
        public static void XElementSetElementValueWithEvents()
        {
            RunTestCase(
                new XElement_SetElementValue
                {
                    Attribute = new TestCaseAttribute
                    {
                        Name = "XElement.SetElementValue() with Events",
                        Params = new object[] { true },
                    },
                }
            );
        ...
        public static void XNodeAddAfterWithEvents()
        {
            RunTestCase(
                new AddNodeAfter
                {
                    Attribute = new TestCaseAttribute
                    {
                        Name = "XNode.AddAfter with Events",
                        Params = new object[] { true },
                    },
                }
            );
        ...
        public static void XNodeAddBeforeWithEvents()
        {
            RunTestCase(
                new AddNodeBefore
                {
                    Attribute = new TestCaseAttribute
                    {
                        Name = "XNode.AddBefore with Events",
                        Params = new object[] { true },
                    },
                }
            );
        ...
        {
            RunTestCase(
                new XNodeReplaceOnDocument1
                {
                    Attribute = new TestCaseAttribute
                    {
                        Name = "XNode.ReplaceWith",
                        Params = new object[] { false },
                    },
                }
            );
        ...
        public static void XNodeReplaceOnDocument1WithEvents()
        {
            RunTestCase(
                new XNodeReplaceOnDocument1
                {
                    Attribute = new TestCaseAttribute
                    {
                        Name = "XNode.ReplaceWith with Events",
                        Params = new object[] { true },
                    },
                }
            );
