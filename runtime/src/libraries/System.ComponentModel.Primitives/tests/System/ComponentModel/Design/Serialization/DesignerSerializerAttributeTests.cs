...
namespace System.ComponentModel.Design.Serialization.Tests
{
    public class DesignerSerializerAttributeTests
    {
        ...
        [InlineData(
            typeof(DefaultSerializationProviderAttributeTests),
        ...
        )
        {
            ...
            Assert.Equal(
                ...
                attribute.SerializerBaseTypeName
            );
        }
        ...
        public void Ctor_NullBaseSerializerType_ThrowsArgumentNullException()
        {
            AssertExtensions.Throws<ArgumentNullException, NullReferenceException>(
                "baseSerializerType",
                () => new DesignerSerializerAttribute(typeof(int), (Type)null)
            );
            AssertExtensions.Throws<ArgumentNullException, NullReferenceException>(
                "baseSerializerType",
                () => new DesignerSerializerAttribute("int", (Type)null)
            );
        }
        ...
        public static IEnumerable<object[]> TypeId_TestData()
        {
            ...
            {
                "BaseSerializerTypeName",
                "System.ComponentModel.Design.Serialization.DesignerSerializerAttributeBaseSerializerTypeName",
            };
            yield return new object[]
            {
