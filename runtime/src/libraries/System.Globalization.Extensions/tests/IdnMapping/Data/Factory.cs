...
namespace System.Globalization.Tests
{
    public static class Factory
    {
        ...
        /// when the IDNA implementation is updated to a newer version of Unicode.  Windows 10 up to 1607
        // supports
        /// and uses 6.0 in IDNA processing. Windows 10 1703 and greater currently uses 9.0 in IDNA
        // processing.
        ///
        /// This method retrieves the dataset to be used by the test.  Windows implementation uses
        // transitional
        /// mappings, which only affect 4 characters, known as deviations.  See the description at
        /// http://www.unicode.org/reports/tr46/#Deviations for more information.  Windows also throws an
        // error
