...
namespace System.Net.WebSockets.Client.Tests
{
    ...
    {
        public HttpClientSendReceiveTest_Http2(ITestOutputHelper output)
            : base(output) { }
    ...
    {
        public InvokerSendReceiveTest_Http2(ITestOutputHelper output)
            : base(output) { }
    ...
    {
        public SendReceiveTest_Http2(ITestOutputHelper output)
            : base(output) { }
