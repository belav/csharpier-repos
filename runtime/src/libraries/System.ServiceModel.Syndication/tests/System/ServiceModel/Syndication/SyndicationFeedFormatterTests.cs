    ...
    public partial class SyndicationFeedFormatterTests
    {
        ...
        public void CreateCategory_NullItem_ThrowsArgumentNullException()
        {
            AssertExtensions.Throws<ArgumentNullException>("item", () =>
                Formatter.CreateCategoryEntryPoint((SyndicationItem)null)
            );
        }
        ...
        public void CreateCategory_NullFeed_ThrowsArgumentNullException()
        {
            AssertExtensions.Throws<ArgumentNullException>("feed", () =>
                Formatter.CreateCategoryEntryPoint((SyndicationFeed)null)
            );
        }
        ...
        public void CreateCategory_FeedReturnsNull_ThrowsInvalidOperationException()
        {
            ...
            Assert.Throws<InvalidOperationException>(() =>
                Formatter.CreateCategoryEntryPoint(feed)
            );
        }
        ...
        {
            AssertExtensions.Throws<ArgumentNullException>("feed", () =>
                Formatter.CreateItemEntryPoint((SyndicationFeed)null)
            );
        }
        ...
        {
            AssertExtensions.Throws<ArgumentNullException>("item", () =>
                Formatter.CreateLinkEntryPoint((SyndicationItem)null)
            );
        }
        ...
        {
            AssertExtensions.Throws<ArgumentNullException>("feed", () =>
                Formatter.CreateLinkEntryPoint((SyndicationFeed)null)
            );
        }
        ...
        {
            AssertExtensions.Throws<ArgumentNullException>("item", () =>
                Formatter.CreatePersonEntryPoint((SyndicationItem)null)
            );
        }
        ...
        {
            AssertExtensions.Throws<ArgumentNullException>("feed", () =>
                Formatter.CreatePersonEntryPoint((SyndicationFeed)null)
            );
        }
        ...
        public void LoadElementExtensions_Feed_Success()
        {
            ...
            using (XmlReader reader = XmlReader.Create(stringReader, settings))
            {
                ...
                Assert.Equal(
                    "http://www.w3.org/TR/html4/",
                    feed.ElementExtensions[1].OuterNamespace
                );
            }
        }
        ...
        public void LoadElementExtensions_NullReader_ThrowsArgumentNullException()
        {
            ...
            AssertExtensions.Throws<ArgumentNullException>("readerOverUnparsedExtensions", () =>
                Formatter.LoadElementExtensionsEntryPoint(null, new SyndicationFeed(), int.MaxValue)
            );
            AssertExtensions.Throws<ArgumentNullException>("readerOverUnparsedExtensions", () =>
        ...
        public void LoadElementExtensions_NegativeMaxExtensionSize_ThrowsArgumentOutOfRangeException()
        {
            ...
            AssertExtensions.Throws<ArgumentOutOfRangeException>("maxExtensionSize", () =>
                Formatter.LoadElementExtensionsEntryPoint(reader, new SyndicationFeed(), -1)
            );
            AssertExtensions.Throws<ArgumentOutOfRangeException>("maxExtensionSize", () =>
        ...
        public void ToString_Invoke_ReturnsExpected()
        {
            var formatter = new Formatter();
            Assert.Equal(
                "System.ServiceModel.Syndication.Tests.SyndicationFeedFormatterTests+Formatter, SyndicationVersion=Version",
                formatter.ToString()
            );
        }
        ...
        [Theory]
        [MemberData(nameof(TryParseAttribute_TestData))]
        public void TryParseAttribute_Feed_ReturnsExpected(
            string name,
            string ns,
            string value,
            string version,
        ...
        {
            Assert.False(
                Formatter.TryParseElementEntryPoint(reader, new SyndicationFeed(), version)
            );
        }
        ...
        public void TryParseElement_NullFeed_ThrowsArgumentNullException()
        {
            XmlReader reader = new XElement("Name").CreateReader();
            AssertExtensions.Throws<ArgumentNullException>("feed", () =>
                Formatter.TryParseElementEntryPoint(reader, (SyndicationFeed)null, "version")
            );
        }
        ...
        public void WriteAttributeExtensions_Feed_Success(string version)
        {
            var feed = new SyndicationFeed();
            CompareHelper.AssertEqualWriteOutput("", writer =>
                Formatter.WriteAttributeExtensionsEntryPoint(writer, feed, version)
            );
            ...
            CompareHelper.AssertEqualWriteOutput(
                @"name1=""value"" d0p1:name2="""" name3=""""",
                writer => Formatter.WriteAttributeExtensionsEntryPoint(writer, feed, version)
            );
        }
...
<SyndicationFeedFormatterTests.ExtensionObject xmlns:i=""http://www.w3.org/2001/XMLSchema-instance"" xmlns=""http://schemas.datacontract.org/2004/07/System.ServiceModel.Syndication.Tests"">
    <Value>11</Value>
        ...
        public void WriteElementExtensions_Item_Success(string version)
        {
            var feed = new SyndicationFeed();
            CompareHelper.AssertEqualWriteOutput("", writer =>
                Formatter.WriteElementExtensionsEntryPoint(writer, feed, version)
            );
...
<SyndicationFeedFormatterTests.ExtensionObject xmlns:i=""http://www.w3.org/2001/XMLSchema-instance"" xmlns=""http://schemas.datacontract.org/2004/07/System.ServiceModel.Syndication.Tests"">
    <Value>11</Value>
                ...
                writer => Formatter.WriteElementExtensionsEntryPoint(writer, feed, version)
            );
        }
...
<SyndicationFeedFormatterTests.ExtensionObject xmlns:i=""http://www.w3.org/2001/XMLSchema-instance"" xmlns=""http://schemas.datacontract.org/2004/07/System.ServiceModel.Syndication.Tests"">
    <Value>11</Value>
        ...
        public class Formatter : SyndicationFeedFormatter
        {
            ...
            public static SyndicationItem CreateItemEntryPoint(SyndicationFeed feed) =>
                CreateItem(feed);

            public static SyndicationLink CreateLinkEntryPoint(SyndicationFeed feed) =>
                CreateLink(feed);

            public static SyndicationLink CreateLinkEntryPoint(SyndicationItem item) =>
                CreateLink(item);

            public static SyndicationPerson CreatePersonEntryPoint(SyndicationFeed feed) =>
                CreatePerson(feed);
            ...
            public static void LoadElementExtensionsEntryPoint(
                ...
                int maxExtensionSize
            ) => LoadElementExtensions(reader, feed, maxExtensionSize);
