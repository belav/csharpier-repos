    ...
    public partial class SyndicationItemFormatterTests
    {
        ...
        public void LoadElementExtensions_Categories_Success()
        {
            ...
            using (XmlReader reader = XmlReader.Create(stringReader, settings))
            {
                ...
                Assert.Equal(
                    ...
                    category.ElementExtensions[1].OuterNamespace
                );
            }
        }
        ...
        public void LoadElementExtensions_Item_Success()
        {
            ...
            using (XmlReader reader = XmlReader.Create(stringReader, settings))
            {
                ...
                Assert.Equal(
                    "http://www.w3.org/TR/html4/",
                    item.ElementExtensions[1].OuterNamespace
                );
            }
        }
        ...
        public void LoadElementExtensions_Link_Success()
        {
            ...
            using (XmlReader reader = XmlReader.Create(stringReader, settings))
            {
                ...
                Assert.Equal(
                    "http://www.w3.org/TR/html4/",
                    link.ElementExtensions[1].OuterNamespace
                );
            }
        }
        ...
        public void LoadElementExtensions_Person_Success()
        {
            ...
            using (XmlReader reader = XmlReader.Create(stringReader, settings))
            {
                ...
                Assert.Equal(
                    "http://www.w3.org/TR/html4/",
                    person.ElementExtensions[1].OuterNamespace
                );
            }
        }
        ...
        public void ToString_Invoke_ReturnsExpected()
        {
            var formatter = new Formatter();
            Assert.Equal(
                "System.ServiceModel.Syndication.Tests.SyndicationItemFormatterTests+Formatter, SyndicationVersion=Version",
                formatter.ToString()
            );
        }
        ...
        public void TryParseAttribute_Category_ReturnsExpected(
            string name,
            string ns,
            string value,
            string version,
        ...
        [Theory]
        [MemberData(nameof(TryParseAttribute_TestData))]
        public void TryParseAttribute_Item_ReturnsExpected(
            string name,
            string ns,
            string value,
            string version,
        ...
        [Theory]
        [MemberData(nameof(TryParseAttribute_TestData))]
        public void TryParseAttribute_Link_ReturnsExpected(
            string name,
            string ns,
            string value,
            string version,
        ...
        [Theory]
        [MemberData(nameof(TryParseAttribute_TestData))]
        public void TryParseAttribute_Person_ReturnsExpected(
            string name,
            string ns,
            string value,
            string version,
        ...
        public void TryParseContent_Invoke_ReturnsFalse(
            XmlReader reader,
            string contentType,
            string version
        )
        ...
        {
            Assert.False(
                Formatter.TryParseElementEntryPoint(reader, new SyndicationCategory(), version)
            );
        }
        ...
        {
            Assert.False(
                Formatter.TryParseElementEntryPoint(reader, new SyndicationItem(), version)
            );
        }
        ...
        {
            Assert.False(
                Formatter.TryParseElementEntryPoint(reader, new SyndicationLink(), version)
            );
        }
        ...
        {
            Assert.False(
                Formatter.TryParseElementEntryPoint(reader, new SyndicationPerson(), version)
            );
        }
...
<SyndicationItemFormatterTests.ExtensionObject xmlns:i=""http://www.w3.org/2001/XMLSchema-instance"" xmlns=""http://schemas.datacontract.org/2004/07/System.ServiceModel.Syndication.Tests"">
    <Value>11</Value>
        ...
        public class Formatter : SyndicationItemFormatter
        {
            ...
            public static SyndicationLink CreateLinkEntryPoint(SyndicationItem item) =>
                CreateLink(item);

            public static SyndicationPerson CreatePersonEntryPoint(SyndicationItem item) =>
                CreatePerson(item);
            ...
            ) => LoadElementExtensions(reader, category, maxExtensionSize);

            public static void LoadElementExtensionsEntryPoint(
                XmlReader reader,
                SyndicationItem item,
                int maxExtensionSize
            ) => LoadElementExtensions(reader, item, maxExtensionSize);

            public static void LoadElementExtensionsEntryPoint(
                XmlReader reader,
                SyndicationLink link,
                int maxExtensionSize
            ) => LoadElementExtensions(reader, link, maxExtensionSize);

            public static void LoadElementExtensionsEntryPoint(
                XmlReader reader,
                SyndicationPerson person,
                int maxExtensionSize
            ) => LoadElementExtensions(reader, person, maxExtensionSize);
            ...
            public static bool TryParseContentEntryPoint(
                XmlReader reader,
                SyndicationItem item,
                string contentType,
                string version,
            ...
            public void WriteElementExtensionsEntryPoint(
                XmlWriter writer,
                SyndicationCategory category,
                string version
            )
