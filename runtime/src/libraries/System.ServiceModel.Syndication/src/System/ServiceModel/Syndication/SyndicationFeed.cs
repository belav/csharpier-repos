    ...
    public class SyndicationFeed : IExtensibleSyndicationObject
    {
        ...
        public SyndicationLink Documentation
        {
            get =>
                ...
                ?? (InternalDocumentation = TryReadDocumentationFromExtension(ElementExtensions));
        ...
        public TimeSpan? TimeToLive
        {
            get =>
                InternalTimeToLive
                ?? (InternalTimeToLive = TryReadTimeToLiveFromExtension(ElementExtensions));
            set
            {
                if (
                    value.HasValue
        ...
        public SyndicationTextInput TextInput
        {
            get =>
                InternalTextInput
                ?? (InternalTextInput = TryReadTextInputFromExtension(ElementExtensions));
