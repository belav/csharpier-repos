...
namespace System
{
    ...
    internal static class ConsolePal
    {
        ...
        {
            return new WasmConsoleStream(
                Interop.Sys.Dup(Interop.Sys.FileDescriptors.STDERR_FILENO),
                FileAccess.Write
            );
        }
        ...
        public static void Clear()
        {
            ...
            {
                s_console = (JSObject)
                    System.Runtime.InteropServices.JavaScript.Runtime.GetGlobalObject("console");
