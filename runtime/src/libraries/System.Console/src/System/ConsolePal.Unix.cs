...
namespace System
{
    ...
    internal static partial class ConsolePal
    {
        ...
        private static readonly Lazy<TerminalFormatStrings> s_terminalFormatStringsInstance =
            new(() => new TerminalFormatStrings(TermInfo.DatabaseFactory.ReadActiveDatabase()));
            ...
            get
            {
                ...
                static SyncTextReader EnsureInitialized()
                {
                    ...
                    SyncTextReader reader = SyncTextReader.GetSynchronizedTextReader(
                        new StdInReader(encoding: Console.InputEncoding)
                    );
        ...
        public static void Beep()
        {
            if (!Console.IsOutputRedirected)
            {
                WriteTerminalAnsiString(
                    TerminalFormatStringsInstance.Bell,
...
#pragma warning restore IDE0060
        ...
        private static void WriteSetColorString(bool foreground, ConsoleColor color)
        {
            ...
            string? formatString = foreground
                ? TerminalFormatStringsInstance.Foreground
                : TerminalFormatStringsInstance.Background;
        ...
        private static unsafe void EnsureInitializedCore()
        {
            lock (Console.Out) // ensure that writing the ANSI string and setting initialized to true are done atomically
            {
                if (!s_initialized)
                {
                    ...
                    s_terminalHandle =
                        !Console.IsOutputRedirected ? Interop.Sys.FileDescriptors.STDOUT_FILENO
        ...
        internal static void WriteToTerminal(
        ...
        internal static void WriteTerminalAnsiString(
            string? value,
            bool mayChangeCursorPosition = true
        )
        {
