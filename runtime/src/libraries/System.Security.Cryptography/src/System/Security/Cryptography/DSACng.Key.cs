...
namespace System.Security.Cryptography
{
    ...
    {
        /// <summary>
        ///     Gets the key that will be used by the DSA object for any cryptographic operation that it
        // uses.
        ///     This key object will be disposed if the key is reset, for instance by changing the KeySize
        ///     property, using ImportParamers to create a new key, or by Disposing of the parent DSA
        // object.
            ...
            private set
            {
                ...
                if (key.AlgorithmGroup != CngAlgorithmGroup.Dsa)
                    throw new ArgumentException(
                        SR.Cryptography_ArgDSARequiresDSAKey,
                        nameof(value)
                    );
                _core.SetKey(key);
