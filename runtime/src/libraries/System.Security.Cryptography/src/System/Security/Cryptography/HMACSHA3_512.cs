...
namespace System.Security.Cryptography
{
    ...
    public class HMACSHA3_512 : HMAC
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="HMACSHA3_512" /> class with a randomly generated key.
        /// </summary>
        /// <remarks>
        /// <para>
        /// <see cref="HMACSHA3_512" /> is a type of keyed hash algorithm that is constructed from the SHA3-512 hash
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="HMACSHA3_512" /> class with the specified key data.
        /// </summary>
        /// <param name="key">
        /// The secret key for <see cref="HMACSHA3_512" />. The key can be any length.
        /// </param>
        ...
        public static bool IsSupported { get; } =
            HashProviderDispenser.MacSupported(HashAlgorithmNames.SHA3_512);
        ...
        )
        {
            ...
            bytesWritten = HashProviderDispenser
                .OneShotHashProvider
                .MacData(HashAlgorithmNames.SHA3_512, key, source, destination);
