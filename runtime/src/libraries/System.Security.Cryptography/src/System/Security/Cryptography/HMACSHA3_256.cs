...
namespace System.Security.Cryptography
{
    ...
    public class HMACSHA3_256 : HMAC
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="HMACSHA3_256" /> class with a randomly generated key.
        /// </summary>
        /// <remarks>
        /// <para>
        /// <see cref="HMACSHA3_256" /> is a type of keyed hash algorithm that is constructed from the SHA3-256 hash
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="HMACSHA3_256" /> class with the specified key data.
        /// </summary>
        /// <param name="key">
        /// The secret key for <see cref="HMACSHA3_256" />. The key can be any length.
        /// </param>
        ...
        public static bool IsSupported { get; } =
            HashProviderDispenser.MacSupported(HashAlgorithmNames.SHA3_256);
        ...
        )
        {
            ...
            bytesWritten = HashProviderDispenser.OneShotHashProvider
                .MacData(HashAlgorithmNames.SHA3_256, key, source, destination);
