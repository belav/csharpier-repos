...
namespace System.Security.Cryptography.X509Certificates
{
    internal sealed partial class StorePal
    {
        private sealed class AndroidKeyStore : IStorePal
        {
            ...
            public void Add(ICertificatePal cert)
            {
                ...
                if (certPal.HasPrivateKey)
                {
                    Interop.AndroidCrypto.PAL_KeyAlgorithm algorithm =
                        certPal.PrivateKeyHandle switch
                        {
                            ...
                            SafeDsaHandle => throw new PlatformNotSupportedException(
            ...
            private static unsafe void EnumCertificatesCallback(
                void* certPtr,
                void* privateKeyPtr,
...
#pragma warning restore 8500
                ...
                if (privateKeyPtr != null)
                {
                    ...
                    {
                        Interop.AndroidCrypto.PAL_KeyAlgorithm.DSA => new SafeDsaHandle(
                            (IntPtr)privateKeyPtr
                        ),
                        Interop.AndroidCrypto.PAL_KeyAlgorithm.EC => new SafeEcKeyHandle(
                            (IntPtr)privateKeyPtr
                        ),
                        Interop.AndroidCrypto.PAL_KeyAlgorithm.RSA => new SafeRsaHandle(
                            (IntPtr)privateKeyPtr
                        ),
                        _ => throw new NotSupportedException(SR.NotSupported_KeyAlgorithm),
                    };
