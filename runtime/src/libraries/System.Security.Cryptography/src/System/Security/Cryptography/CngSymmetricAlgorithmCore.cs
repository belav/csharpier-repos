...
namespace System.Security.Cryptography
{
    ...
    internal struct CngSymmetricAlgorithmCore
    {
        ...
        public ILiteSymmetricCipher CreateLiteSymmetricCipher(
        ...
        )
        {
            ...
            return CreatePersistedLiteSymmetricCipher(
                ProduceCngKey,
                iv,
                encrypting,
                padding,
        ...
        )
        {
            ...
            if (
                !iv.IsEmpty && iv.Length != AsymmetricAlgorithmHelpers.BitsToBytes(_outer.BlockSize)
            )
            {
        ...
        )
        {
            ...
            if (
                rgbIV != null
                && rgbIV.Length != AsymmetricAlgorithmHelpers.BitsToBytes(_outer.BlockSize)
            )
            {
