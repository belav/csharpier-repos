...
{
    public abstract class SignatureAlgorithmHashTests<TAlgorithm>
        where TAlgorithm : IHashSigningAlgorithm, new()
    {
        [Theory]
        ...
        [Theory]
        [MemberData(nameof(HashTheoryData))]
        public void TryHashData_Success(
            byte[] data,
            byte[] expectedHash,
            HashAlgorithmName hashAlgorithmName
        )
        {
            using (TAlgorithm algorithm = new TAlgorithm())
            {
                ...
                bool success = algorithm.TryHashDataImpl(
                    data,
                    destination,
                    hashAlgorithmName,
                    out int written
    ...
    public class ECDsaAlgorithmHashTests
        : SignatureAlgorithmHashTests<ECDsaAlgorithmHashTests.ECDsaUserDerivedImplementation>
    {
        public sealed class ECDsaUserDerivedImplementation : ECDsa, IHashSigningAlgorithm
        {
            ...
            public byte[] HashDataImpl(Stream data, HashAlgorithmName hashAlgorithm) =>
                HashData(data, hashAlgorithm);

            public byte[] HashDataImpl(
                byte[] data,
                int offset,
                int count,
    ...
    [SkipOnPlatform(TestPlatforms.Browser, "Not supported on Browser")]
    public class DSAAlgorithmHashTests
        : SignatureAlgorithmHashTests<DSAAlgorithmHashTests.DSAUserDerivedImplementation>
    {
        public sealed class DSAUserDerivedImplementation : DSA, IHashSigningAlgorithm
        {
            ...
            public override DSAParameters ExportParameters(bool includePrivate) =>
                throw new NotImplementedException();
    ...
    [SkipOnPlatform(TestPlatforms.Browser, "Not supported on Browser")]
    public class RSAAlgorithmHashTests
        : SignatureAlgorithmHashTests<RSAAlgorithmHashTests.RSAUserDerivedImplementation>
    {
        public sealed class RSAUserDerivedImplementation : RSA, IHashSigningAlgorithm
        {
            ...
            public override RSAParameters ExportParameters(bool includePrivate) =>
                throw new NotImplementedException();
