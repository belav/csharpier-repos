...
namespace System.Security.Cryptography.Tests
{
    public class HmacSha3_384Tests : HmacTests<HmacSha3_384Tests.Traits>
    {
        ...
        ) => HMACSHA3_384.HashDataAsync(key, source, destination, cancellationToken);

        protected override ValueTask<byte[]> HashDataOneShotAsync(
            ReadOnlyMemory<byte> key,
            Stream source,
            CancellationToken cancellationToken
        ) => HMACSHA3_384.HashDataAsync(key, source, cancellationToken);
        ...
        public HmacSha3_384Tests()
            : base(s_testKeys, s_testData, s_testMacs) { }
