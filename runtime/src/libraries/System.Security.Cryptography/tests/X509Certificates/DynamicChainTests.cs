...
namespace System.Security.Cryptography.X509Certificates.Tests
{
    ...
    public static class DynamicChainTests
    {
        ...
        [Fact]
        [SkipOnPlatform(
            PlatformSupport.AppleCrypto,
            "macOS appears to just completely ignore min/max."
        )]
        ...
        public static IEnumerable<object[]> BuildChainWithNotSignatureValidData()
        {
            yield return new object[]
            {
                true,
                X509ChainStatusFlags.NoError,
                BuildChainWithNotSignatureValidTest.TrustedRoot,
            };
            yield return new object[]
            {
                false,
                X509ChainStatusFlags.UntrustedRoot | X509ChainStatusFlags.NotSignatureValid,
                BuildChainWithNotSignatureValidTest.UntrustedRoot,
            };
            yield return new object[]
            {
                false,
                X509ChainStatusFlags.PartialChain,
                BuildChainWithNotSignatureValidTest.PartialChain,
            };
            yield return new object[]
            {
                false,
                X509ChainStatusFlags.NotSignatureValid,
                BuildChainWithNotSignatureValidTest.TrustedRootEndCertNotSignatureValid,
            };
            yield return new object[]
            {
                false,
                X509ChainStatusFlags.PartialChain | X509ChainStatusFlags.NotSignatureValid,
                BuildChainWithNotSignatureValidTest.PartialChainEndCertNotSignatureValid,
            };
        }
