...
/* [SuppressMessage("Microsoft.Security", "CS002:SecretInNextLine", Justification="This PKCS#12 blob
only contains public info.")] */@"
...
"
        ...
        // 'cert.pem' generated using 'openssl req -x509 -newkey rsa:2048 -keyout key.pem -out cert.pem
        // -days 365'
...
"
        ...
        public static readonly byte[] PfxSha256Empty_ExpectedSig = (
            ...
            + "56f89a69b84cd53434457de3296f80fbbe4eb938b4066b51638e35bce1e1c308"
        ).HexToByteArray();
...
-----END CERTIFICATE-----"
        ...
        internal static readonly byte[] ECDsabrainpoolP160r1_ExplicitCertificatePemBytes =
            ByteUtils.AsciiBytes(
                @"-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----"
        ...
        // The PFX in ECDsaP256_DigitalSignature_Pfx_Windows_TripleDESContentEncryption washed through
        // OpenSSL
        ...
        internal static byte[] CertificateWithUtf8 = (
            ...
            + "05be8c67b92bc7df9984f30535ad53817cb4abcd77cb521856"
        ).HexToByteArray();
        ...
        internal static byte[] RsaSha3_256SignedCertificate = (
            ...
            + "ad82f8f331c63b3b5f256af0b702cf2413f6a1dc37a57d1d69"
        ).HexToByteArray();
...
-----END PUBLIC KEY-----";
        ...
        public static readonly byte[] PfxWithNoPassword = (
            ...
            + "4D7314FCB4041469835268466D1390373566F7034C4736346CD17D020207D0"
        ).HexToByteArray();

        internal static readonly byte[] Pkcs12NoPasswordRandomCounts = Convert.FromBase64String(
/* [SuppressMessage("Microsoft.Security", "CS002:SecretInNextLine", Justification="Self-signed cert
created specifically for inclusion in public-facing unit tests.")] */@"
