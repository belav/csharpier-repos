...
namespace System.Security.Cryptography.X509Certificates.Tests
{
    public static class X500DistinguishedNameTests
    {
        ...
        [SkipOnPlatform(TestPlatforms.Browser, "Browser doesn't support an X.509 PAL")]
        public static void QuotedWithQuotesAsAppropriate(
            string quoted,
            string notQuoted,
            string hexEncoded
        )
        ...
        public static void TpmIdentifiers()
        {
            ...
            X500DistinguishedName dn = new X500DistinguishedName(
                "OID.2.23.133.2.3=id:0020065,OID.2.23.133.2.2=,OID.2.23.133.2.1=id:564D5700"
            );
            X500DistinguishedName dn2 = new X500DistinguishedName(dn.RawData);
            Assert.Equal(
                "TPMManufacturer=id:564D5700, TPMModel=\"\", TPMVersion=id:0020065",
                dn2.Decode(X500DistinguishedNameFlags.None)
            );
        }
        ...
        public static void NameWithNumericString()
        {
            ...
            Assert.Equal(
                "OID.1.1.1.2.2.3=123 654 7890, CN=Test",
                dn.Decode(X500DistinguishedNameFlags.None)
            );
        }
        ...
        public static void EnumeratorWithNonTextualData()
        {
            ...
            X500DistinguishedName dn = new X500DistinguishedName(encoded);
            IEnumerable<X500RelativeDistinguishedName> able =
                dn.EnumerateRelativeDistinguishedNames(false);
            ...
            )
            {
                ...
                Assert.False(
                    ator.Current.HasMultipleElements,
                    $"ator.Current.HasMultipleElements {index}"
                );
        ...
        public static void EnumeratorWithInvalidData()
        {
            ...
            foreach (
                X500RelativeDistinguishedName rdn in dn.EnumerateRelativeDistinguishedNames(
                    reversed: false
                )
            )
            {
        ...
        public static void CheckCachedOids()
        {
            ...
            Assert.Equal(
                rdns[0].GetSingleElementType().Value,
                rdns[3].GetSingleElementType().Value
            );
        ...
        [InlineData(
            new[] { "2.5.4.3", "2.5.4.8", "0.0" },
            new[] { "0C02504A", "3000", "0C024141" },
        ...
        [SkipOnPlatform(TestPlatforms.Browser, "Browser doesn't support an X.509 PAL")]
        public static void Format_ComponentWithNonStringContent(
            string[] oids,
        ...
        {
            // Empty value
            new object[] { "CN=\"\"", "300B3109300706035504031300" },
            // Comma (RDN separator)
            new object[]
            {
                "CN=\"Common,Name\"",
        ...
        public static readonly object[][] T61Cases =
        {
            ...
            new object[] { "L=\u00c2\u00a2\u00f8", "300E310C300A06035504071403C2A2F8" },
        };
