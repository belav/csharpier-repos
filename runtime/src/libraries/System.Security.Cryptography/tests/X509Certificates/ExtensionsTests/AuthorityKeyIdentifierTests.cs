    ...
    public static class AuthorityKeyIdentifierTests
    {
        ...
        public static void RoundtripFull()
        {
            byte[] encoded = (
                ...
                + "301206035504030C0B49737375696E6743657274820852E6DEFA1D32A969"
            ).HexToByteArray();

            X509AuthorityKeyIdentifierExtension akid = new X509AuthorityKeyIdentifierExtension(
                encoded,
                true
            );
        ...
        public static void CreateEmptyFromCertificate()
        {
            ...
            using (
                X509Certificate2 cert = new X509Certificate2(TestData.MicrosoftDotComIssuerBytes)
            )
            {
        ...
        public static void CreateKeyIdOnlyFromCertificate()
        {
            ...
            Assert.False(akid.Critical, "akid.Critical");
            Assert.Equal(
                "30168014B5760C3011CEC792424D4CC75C2CC8A90CE80B64",
                akid.RawData.ByteArrayToHex()
            );
        ...
        public static void CreateFullWithNegativeSerialNumber(bool fromArray)
        {
            ...
            const string ExpectedHex =
                "30228003010204A117A41530133111300F060355040313084E65676174697665" + "82028002";
        ...
        public static void DecodeWithTwoX500Names()
        {
            ...
            Assert.Equal(
                "000000000000000880",
                akid.KeyIdentifier.GetValueOrDefault().Span.ByteArrayToHex()
            );
            Assert.Equal("00EE7B", akid.SerialNumber.GetValueOrDefault().Span.ByteArrayToHex());
            Assert.Null(akid.NamedIssuer);
            AssertExtensions.SequenceEqual(
                encoded.Slice(13, 44),
                akid.RawIssuer.GetValueOrDefault().Span
            );
        }
        ...
        public static void CreateIssuerAndNegativeSerial(bool fromArray)
        {
            ...
            const string ExpectedHex =
                "301DA117A41530133111300F060355040313084E6567617469766582028002";
