...
namespace System.Security.Cryptography.X509Certificates.Tests
{
    ...
    {
        internal override X509Certificate Import(byte[] blob) => new X509Certificate(blob);
        ...
        internal override X509Certificate Import(string fileName) => new X509Certificate(fileName);
