...
namespace System.Security.Cryptography.X509Certificates.Tests.CertificateCreation
{
    ...
    public static class CrlBuilderTests
    {
        ...
        {
            BuildCertificateAndRun(
                new X509Extension[] { X509BasicConstraintsExtension.CreateForEndEntity() },
                static (cert, now) =>
                {
                    CertificateRevocationListBuilder builder =
                        new CertificateRevocationListBuilder();
        ...
        public static void BuildSingleEntry()
        {
            BuildRsaCertificateAndRun(
                ...
                static (cert, notNow) =>
                {
                    ...
                    ReadOnlySpan<byte> serialToAdd = new byte[]
                    {
                        0x01,
                        0x01,
                        0x02,
        ...
        public static void BuildSingleEntryWithReason()
        {
            BuildRsaCertificateAndRun(
                ...
                static (cert, notNow) =>
                {
                    ...
                    byte[] explicitUpdateTime = builder.Build(
                        cert,
                        123,
                        now.AddMinutes(5),
                        hashAlg,
        ...
        public static void AddTwiceRemoveOnce()
        {
            BuildRsaCertificateAndRun(
                ...
                static (cert, notNow) =>
                {
                    ...
                    CertificateRevocationListBuilder builder =
                        new CertificateRevocationListBuilder();
                    ReadOnlySpan<byte> serial = new byte[]
                    {
                        0x01,
                        0x01,
                        0x02,
                    ...
                    byte[] expected = (
                        ...
                        + "6AAA7E7A32930C2E8289D62E1CBF7AFAB632FF260B1B49F9"
                    ).HexToByteArray();
        ...
        public static void DsaNotDirectlySupported()
        {
            ...
            using (DSA key = DSA.Create(TestData.GetDSA1024Params()))
            {
                ...
                using (
                    X509Certificate2 certPub = req.Create(
                        dn,
                        gen,
                        now.AddMonths(-1),
                        now.AddYears(1),
                ...
                using (X509Certificate2 cert = certPub.CopyWithPrivateKey(key))
                {
                    ...
                    VerifyCrlFields(crl, cert.SubjectName, null, nextUpdate, akid, crlNumber);
                }
            }
        }
        ...
        public static void RemovePresent_ReturnsTrue()
        {
            ...
            Assert.False(
                builder.RemoveEntry(needle.AsSpan()),
                "builder.RemoveEntry(span) when missing"
            );
            ...
            BuildRsaCertificateAndRun(
                ...
                static (cert, notNow) =>
                {
                    ...
                    byte[] expected = (
                        ...
                        + "2F26EDF7B69DD7D630266BC82B5A5AB265E06847280B5A2C658F3E"
                    ).HexToByteArray();
            ...
            BuildRsaCertificateAndRun(
                ...
                static (cert, notNow) =>
                {
                    ...
                    byte[] expected = (
                        ...
                        + "F7AF4A60117A20431AF0ABCBAFA0A52E6EF5E47793CD"
                    ).HexToByteArray();
            ...
            BuildRsaCertificateAndRun(
                ...
                static (cert, notNow) =>
                {
                    ...
                    byte[] toLoad = (
                        ...
                        + "7B300D06092A864886F70D01010C0500030100"
                    ).HexToByteArray();
                    ...
                    BigInteger nextCrlNumber = BigInteger.Parse(
                        "20530908075641000000000000000000001"
                    );
                    byte[] built = builder.Build(
                        cert,
                        nextCrlNumber,
                    ...
                    byte[] expected = (
                        ...
                        + "69A28F554C7BE6FDEC59ADD39D607F548E2F05C086FEDF9439862720"
                    ).HexToByteArray();
            ...
            BuildRsaCertificateAndRun(
                ...
                static (cert, notNow) =>
                {
                    ...
                    byte[] toLoad = (
                        ...
                        + "DE4753F848A9D7F9A0000130070603551D14050003020780"
                    ).HexToByteArray();
                    ...
                    BigInteger expectedCrlNumber = BigInteger.Parse(
                        "20530908075641000000000000000000001"
                    );
...
-----END X509 CRL-----";
            ...
            using (RSA rsa = RSA.Create(4096))
            {
                ...
                DateTimeOffset nextUpdate = new DateTimeOffset(
                    2022,
                    4,
                    21,
                    13,
        ...
        private static ReadOnlySpan<byte> BuildEmptyExpectedCrl =>
            new byte[]
            {
                0x30,
                0x82,
        ...
        private static ReadOnlySpan<byte> AddEntryFromCertificateExpectedCrl =>
            new byte[]
            {
                0x30,
                0x82,
        ...
        private static ReadOnlySpan<byte> BuildSingleEntryExpectedCrl =>
            new byte[]
            {
                0x30,
                0x82,
