    ...
    public class EccTestData
    {
            ...
            KeyParameters = new ECParameters
            {
                ...
                Q = new ECPoint
                {
                    ...
                    Y = (
                        ...
                        + "96ADC04B0201721F9D842C32588909B61F7E2236200E3EB29233A322E661A2EA05"
                    ).HexToByteArray(),
                },

                D = (
                    "01CD352B44ED263B4BE0D8CDCB78B2CF9283FA8C74D27CA7629E600F0A15514278"
                    + "5769022DEEA3FDFC5C9830E546D7321A1080E574473A81D6DAF45E1D437926E9AF"
                ).HexToByteArray(),
            },
        };
            ...
            KeyParameters = new ECParameters
            {
                ...
                Q = new ECPoint
                {
                    ...
                    Y = (
                        ...
                        + "FE2C13349B3680855D8CA303DA540D5C78C8FDD7DF08963B9C855BB6B199730A32"
                    ).HexToByteArray(),
                },

                D = (
                    "01E262CBEA07EF60695D05D79257B6A57A175AB4243CEC99C60AD7BC5058666AB4"
                    + "C9DCF18443DCDEFDA5E08A7158D404BF328C7CECCD447F064FC5D681400509BCD8"
                ).HexToByteArray(),
            },
        };
        ...
        internal static readonly EccTestData BrainpoolP256r1Data = new EccTestData
        {
            ...
            KeyParameters = new ECParameters
            {
                ...
                {
                    X =
                        "419A7BB2B7CEBDD62A6BD3483FDE3985BFC2F3E0CD2AF362B430BC4A737BAC38".HexToByteArray(),
                    Y =
                        "631730AF824E760DA912EB012893BE5692A7F3BFDD156CB9F7313DE2ECA3C184".HexToByteArray(),
                },

                D =
                    "67DE7D6322530549BEC961149582C2EA9532B3641D273F13CD881D0D735EA531".HexToByteArray(),
            },
        };
        ...
        internal static readonly EccTestData BrainpoolP256t1Data = new EccTestData
        {
            ...
            KeyParameters = new ECParameters
            {
                ...
                {
                    X =
                        "9A34B1EF0077DBCECC2034A101229B5D1B8DDF191D8064B4662C452414B508C1".HexToByteArray(),
                    Y =
                        "96BA5E99FDF30EC25F3DA1A1F572C07D8810F63F7B8E8740ED666426C2E70836".HexToByteArray(),
                },

                D =
                    "6FA384038FFCA28C21F9A491B99EC07DD021B241E6696C4F96BC5EB922B1D806".HexToByteArray(),
            },
        };
