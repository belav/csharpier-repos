...
namespace System.Text.Tests
{
    public class UTF7EncodingDecode
    {
        public static IEnumerable<object[]> Decode_TestData()
        {
            ...
            yield return new object[]
            {
                new byte[] { 0x2B, 0x41, 0x45, 0x45, 0x41, 0x43, 0x51 },
                0,
                7,
                "A\t"
            };
            ...
            yield return new object[]
            {
                new byte[] { 0x2B, 0x80, 0x81, 0x82, 0x2D },
                0,
                5,
                "\u0080\u0081\u0082-"
            };
            ...
            yield return new object[]
            {
                new byte[] { 0x2B, 0x80, 0x21, 0x80, 0x21, 0x1E, 0x2D },
                0,
                7,
                "\u0080!\u0080!\u001E-"
            };
            ...
            yield return new object[]
            {
                new byte[] { 0x2B, 0x41, 0x43, 0x45, 0x41, 0x66, 0x51 },
                0,
                7,
                "!}"
            };
            ...
            yield return new object[]
            {
                new byte[] { 0x2B, 0x41, 0x43, 0x45, 0x2D },
                0,
                2,
                string.Empty
            };
            ...
            yield return new object[]
            {
                new byte[] { 0x2B, 0x44, 0x6C, 0x6B, 0x46, 0x30, 0x51 },
                0,
                7,
                "\u0E59\u05D1"
            };
            ...
            yield return new object[]
            {
                new byte[] { 0x41, 0x21, 0x7D, 0x09, 0x2B, 0x44, 0x6C, 0x6B, 0x46, 0x30, 0x51 },
                0,
                11,
                "\u0041\u0021\u007D\u0009\u0E59\u05D1"
            };
            ...
            yield return new object[]
            {
                new byte[] { 0x2B, 0x2B, 0x41, 0x41, 0x2D },
                0,
                5,
                "\uF800"
            };
            yield return new object[]
            {
                new byte[] { 0x2B, 0x41, 0x43, 0x48, 0x35, 0x41, 0x41, 0x2D },
                0,
                8,
                "\u0021\uF900"
            };
