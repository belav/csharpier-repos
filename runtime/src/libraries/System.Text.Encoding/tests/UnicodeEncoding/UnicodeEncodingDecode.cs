...
namespace System.Text.Tests
{
    public class UnicodeEncodingDecode
    {
        public static IEnumerable<object[]> Decode_TestData()
        {
            ...
            yield return new object[]
            {
                new byte[] { 84, 0, 101, 0, 115, 0, 116, 0, 84, 0, 101, 0, 115, 0, 116, 0 },
                0,
                16,
                "TestTest"
            };
            ...
            yield return new object[]
            {
                new byte[] { 70, 0, 111, 0, 111, 0, 66, 0, 65, 0, 0, 4, 82, 0 },
                0,
                14,
                "FooBA\u0400R"
            };
            ...
            yield return new object[]
            {
                new byte[] { 192, 0, 110, 0, 105, 0, 109, 0, 97, 0, 0, 3, 108, 0 },
                0,
                14,
                "\u00C0nima\u0300l"
            };
            yield return new object[]
            {
                new byte[] { 122, 0, 97, 0, 6, 3, 253, 1, 178, 3 },
                0,
                10,
                "za\u0306\u01fd\u03b2"
            };
            ...
            yield return new object[]
            {
                new byte[] { 3, 216, 117, 221, 3, 216, 117, 221, 3, 216, 117, 221 },
                0,
                12,
                "\uD803\uDD75\uD803\uDD75\uD803\uDD75"
            };
            yield return new object[]
            {
                new byte[] { 3, 216, 117, 221, 3, 216, 117, 221 },
                0,
                8,
                "\uD803\uDD75\uD803\uDD75"
            };
            ...
            yield return new object[]
            {
                new byte[] { 92, 0, 97, 0, 98, 0, 99, 0, 32, 0, },
                0,
                10,
                "\\abc\u0020"
            };
        ...
        public void Decode(byte[] littleEndianBytes, int index, int count, string expected)
        {
            ...
            EncodingHelpers.Decode(
                new UnicodeEncoding(false, true, false),
                littleEndianBytes,
                index,
                count,
                expected
            ...
            EncodingHelpers.Decode(
                new UnicodeEncoding(true, true, false),
                bigEndianBytes,
                index,
                count,
                expected
        ...
        public static IEnumerable<object[]> Decode_InvalidBytes_TestData()
        {
            yield return new object[]
            {
                new byte[] { 70, 0, 111, 0, 111, 0, 66, 0, 65, 0, 0, 4, 82, 0, 70 },
                0,
                15,
                "FooBA\u0400R\uFFFD"
            };
            ...
            yield return new object[]
            {
                new byte[] { 84, 0, 101, 0, 115, 0, 116, 0, 84, 0, 101, 0, 115, 0, 116, 0, 3, 216 },
                0,
                17,
                "TestTest\uFFFD"
            };
