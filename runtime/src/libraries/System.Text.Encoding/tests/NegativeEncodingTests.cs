...
namespace System.Text.Tests
{
    public static class NegativeEncodingTests
    {
        ...
        public static unsafe void GetByteCount_Invalid(Encoding encoding)
        {
            ...
            if (PlatformDetection.IsNetCore)
            {
                AssertExtensions.Throws<ArgumentNullException>(
                    (encoding is ASCIIEncoding || encoding is UTF8Encoding) ? "chars" : "s",
            ...
            {
                AssertExtensions.Throws<ArgumentNullException>(
                    (encoding is ASCIIEncoding) ? "chars" : "s",
                    () => encoding.GetByteCount((string)null)
                );
            }
            AssertExtensions.Throws<ArgumentNullException>(
        ...
        public static void GetMaxByteCount_Invalid(Encoding encoding)
        {
            ...
            {
                Encoding customizedMaxCharCountEncoding = Encoding.GetEncoding(
                    encoding.CodePage,
        ...
        public static void GetString_Invalid(Encoding encoding)
        {
            ...
            // Index or count < 0
            AssertExtensions.Throws<ArgumentOutOfRangeException>(
                encoding is ASCIIEncoding ? "byteIndex" : "index",
                () => encoding.GetString(new byte[1], -1, 0)
            );
            AssertExtensions.Throws<ArgumentOutOfRangeException>(
                encoding is ASCIIEncoding ? "byteCount" : "count",
                () => encoding.GetString(new byte[1], 0, -1)
            );
        ...
        internal static unsafe void Encode_Invalid(
            Encoding encoding,
            string chars,
            int index,
            int count
        ...
        internal static unsafe void Decode_Invalid(
            Encoding encoding,
            byte[] bytes,
            int index,
            int count
        ...
        public static void Decoder_GetCharCount_Invalid(
            Encoding encoding,
            Decoder decoder,
            bool flush
        )
