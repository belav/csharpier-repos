...
namespace Microsoft.Win32.SystemEventsTests
{
    public class UserPreferenceTests : SystemEventsTest
    {
        ...
        public void SignalsUserPreferenceEventsAsynchronously(
            int message,
            int uiAction,
            string area,
        ...
        public void SignalsUserPreferenceEventsAsynchronouslyOnThemeChanged()
        {
            ...
            List<UserPreferenceChangedEventArgs> changedArgs =
                new List<UserPreferenceChangedEventArgs>();
            UserPreferenceChangingEventArgs changingDuringChanged = null;
            UserPreferenceChangedEventHandler changedHandler = (o, e) =>
            {
                changedArgs.Add(e);
        ...
        [MemberData(nameof(PreferenceChangingCases))]
        public void SignalsUserPreferenceEventsSynchronously(
            int message,
            int uiAction,
            string area,
            UserPreferenceCategory expectedCategory
