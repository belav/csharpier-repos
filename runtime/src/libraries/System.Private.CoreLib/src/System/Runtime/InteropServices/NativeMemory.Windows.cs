...
namespace System.Runtime.InteropServices
{
    ...
    {
        /// <summary>Allocates an aligned block of memory of the specified size and alignment, in
        // bytes.</summary>
        /// <param name="byteCount">The size, in bytes, of the block to allocate.</param>
        /// <param name="alignment">The alignment, in bytes, of the block to allocate. This must be a power
        // of <c>2</c>.</param>
        /// <returns>A pointer to the allocated aligned block of memory.</returns>
        /// <exception cref="ArgumentException"><paramref name="alignment" /> is not a power of
        // two.</exception>
        /// <exception cref="OutOfMemoryException">Allocating <paramref name="byteCount" /> of memory with
        // <paramref name="alignment" /> failed.</exception>
        /// <remarks>
        ///     <para>This method allows <paramref name="byteCount" /> to be <c>0</c> and will return a
        // valid pointer that should not be dereferenced and that should be passed to free to avoid memory
        // leaks.</para>
        ///     <para>This method is a thin wrapper over the C <c>aligned_alloc</c> API or a platform
        // dependent aligned allocation API such as <c>_aligned_malloc</c> on Win32.</para>
        ///     <para>This method is not compatible with <see cref="Free" /> or <see cref="Realloc" />,
        ...
        public static void* AlignedAlloc(nuint byteCount, nuint alignment)
        {
            ...
            {
                // The C standard doesn't define what a valid alignment is, however Windows and POSIX The Windows
                // implementation requires a power of 2
                ThrowHelper.ThrowArgumentException(ExceptionResource.Argument_AlignmentMustBePow2);
            }

            // Unlike the C standard and POSIX, Windows does not requires size to be a multiple of alignment.
        ...
        ///    <para>This method is a thin wrapper over the C <c>free</c> API or a platform dependent
        // aligned free API such as <c>_aligned_free</c> on Win32.</para>
        /// </remarks>
        [CLSCompliant(false)]
        ...
        /// <summary>Reallocates an aligned block of memory of the specified size and alignment, in
        // bytes.</summary>
        ...
        /// <exception cref="ArgumentException"><paramref name="alignment" /> is not a power of
        // two.</exception>
        /// <exception cref="OutOfMemoryException">Reallocating <paramref name="byteCount" /> of memory with
        // <paramref name="alignment" /> failed.</exception>
        /// <remarks>
        ///     <para>This method acts as <see cref="AlignedAlloc" /> if <paramref name="ptr" /> is
        // <c>null</c>.</para>
        ///     <para>This method allows <paramref name="byteCount" /> to be <c>0</c> and will return a
        // valid pointer that should not be dereferenced and that should be passed to free to avoid memory
        // leaks.</para>
        ///     <para>This method is a platform dependent aligned reallocation API such as
        // <c>_aligned_realloc</c> on Win32.</para>
        ///     <para>This method is not compatible with <see cref="Free" /> or <see cref="Realloc" />,
        // instead <see cref="AlignedFree" /> or <see cref="AlignedRealloc" /> should be called.</para>
        /// </remarks>
        [CLSCompliant(false)]
        ...
        /// <exception cref="OutOfMemoryException">Allocating <paramref name="byteCount" /> of memory
        // failed.</exception>
        /// <remarks>
        ///     <para>This method allows <paramref name="byteCount" /> to be <c>0</c> and will return a
        // valid pointer that should not be dereferenced and that should be passed to free to avoid memory
        ...
        /// <exception cref="OutOfMemoryException">Allocating <paramref name="elementCount" /> * <paramref
        // name="elementSize" /> bytes of memory failed.</exception>
        /// <remarks>
        ///     <para>This method allows <paramref name="elementCount" /> and/or <paramref
        // name="elementSize" /> to be <c>0</c> and will return a valid pointer that should not be dereferenced
        // and that should be passed to free to avoid memory leaks.</para>
        ...
        /// <exception cref="OutOfMemoryException">Reallocating <paramref name="byteCount" /> of memory
        // failed.</exception>
        /// <remarks>
        ///     <para>This method acts as <see cref="Alloc" /> if <paramref name="ptr" /> is
        // <c>null</c>.</para>
        ///     <para>This method allows <paramref name="byteCount" /> to be <c>0</c> and will return a
        // valid pointer that should not be dereferenced and that should be passed to free to avoid memory
        // leaks.</para>
