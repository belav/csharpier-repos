...
namespace System.Runtime.InteropServices.ObjectiveC
{
    ...
    {
        /// <summary>
        /// Handler for unhandled Exceptions crossing the managed -> native boundary (that is, Reverse
        // P/Invoke).
        /// </summary>
        ...
        /// unmanaged callback can be returned, otherwise <c>null</c>. The <see cref="RuntimeMethodHandle"/>
        // is to the
        /// last managed method that was executed prior to leaving the runtime. Along with the returned
        // callback
        /// the handler can return a context that will be passed to the callback during dispatch.
        ///
        /// The returned handler will be passed the context when called and it is the responsibility of the
        // callback
        /// to manage. The handler must not return and is expected to propagate the exception (for example,
        ...
        /// <param name="isReferencedCallback">Called to determine if a managed object instance is
        // referenced elsewhere, and must not be collected by the GC.</param>
        /// <param name="trackedObjectEnteredFinalization">Called when a tracked object enters the
        // finalization queue.</param>
        /// <param name="unhandledExceptionPropagationHandler">Handler for the propagation of unhandled
        // Exceptions across a managed -> native boundary (that is, Reverse P/Invoke).</param>
        /// <exception cref="InvalidOperationException">Thrown if this API has already been
        // called.</exception>
        /// <remarks>
        /// All unmanaged function pointers must be written in native code since they will be called by the
        // GC and
        ...
        /// The associated begin/end pair will never be nested. When using Workstation GC, the begin/end
        // pair
        ...
        /// <exception cref="InvalidOperationException">Thrown if the ObjectiveCMarshal API has not been
        ...
        {
            /// <summary>
            /// Overrides the Objective-C runtime's <see
            // href="https://developer.apple.com/documentation/objectivec/1456712-objc_msgsend">msgSend()</see>.
            /// </summary>
            MsgSend,
            ...
            /// Overrides the Objective-C runtime's <see
            //
            // href="https://developer.apple.com/documentation/objectivec/1456697-objc_msgsend_fpret">objc_msgSend_fpret()</see>.
            /// </summary>
            MsgSendFpret,
            ...
            /// Overrides the Objective-C runtime's <see
            //
            // href="https://developer.apple.com/documentation/objectivec/1456730-objc_msgsend_stret">objc_msgSend_stret()</see>.
            /// </summary>
            MsgSendStret,
            ...
            /// Overrides the Objective-C runtime's <see
            //
            // href="https://developer.apple.com/documentation/objectivec/1456716-objc_msgsendsuper">objc_msgSendSuper()</see>.
            /// </summary>
            MsgSendSuper,
            ...
            /// Overrides the Objective-C runtime's <see
            //
            // href="https://developer.apple.com/documentation/objectivec/1456722-objc_msgsendsuper_stret">objc_msgSendSuper_stret()</see>.
            /// </summary>
            MsgSendSuperStret,
        }
        ...
        /// <exception cref="InvalidOperationException">Thrown if the msgSend function has already been
