...
{
    /// <summary>
    /// <see cref="CULong"/> is an immutable value type that represents the <c>unsigned long</c> type in
    // C and C++.
    /// It is meant to be used as an exchange type at the managed/unmanaged boundary to accurately
    // represent
    ...
    public readonly struct CULong : IEquatable<CULong>
    {
        ...
        // underlying storage type.</exception>
        ...
        /// <returns><c>true</c> if <paramref name="o"/> is an instance of <see cref="CULong"/> and equals
        // the value of this instance; otherwise, <c>false</c>.</returns>
        public override bool Equals([NotNullWhen(true)] object? o) =>
            o is CULong other && Equals(other);

        /// <summary>
        /// Returns a value indicating whether this instance is equal to a specified <see cref="CLong"/>
        // value.
        /// </summary>
        /// <param name="other">A <see cref="CULong"/> value to compare to this instance.</param>
        /// <returns><c>true</c> if <paramref name="other"/> has the same value as this instance; otherwise,
        // <c>false</c>.</returns>
        ...
        // digits ranging from 0 to 9 with no leading zeroes.</returns>
