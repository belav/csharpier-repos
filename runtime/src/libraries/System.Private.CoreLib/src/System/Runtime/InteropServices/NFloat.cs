...
namespace System.Runtime.InteropServices
{
    ...
    public readonly struct NFloat : IBinaryFloatingPointIeee754<NFloat>, IMinMaxValue<NFloat>
    {
        ...
        static NFloat IAdditionOperators<NFloat, NFloat, NFloat>.operator checked +(
            NFloat left,
            NFloat right
        ) => left + right;
        ...
        static NFloat IDivisionOperators<NFloat, NFloat, NFloat>.operator checked /(
            NFloat left,
            NFloat right
        ) => left / right;
        ...
        static NFloat IMultiplyOperators<NFloat, NFloat, NFloat>.operator checked *(
            NFloat left,
            NFloat right
        ) => left * right;
        ...
        static NFloat ISubtractionOperators<NFloat, NFloat, NFloat>.operator checked -(
            NFloat left,
            NFloat right
        ) => left - right;
