...
namespace System.Runtime.Intrinsics.Wasm
{
    ...
    public abstract class PackedSimd
    {
        ...
        public static bool AnyTrue(Vector128<nint> value)
        {
            throw new PlatformNotSupportedException();
        }

        public static bool AnyTrue(Vector128<nuint> value)
        {
            throw new PlatformNotSupportedException();
        }
        ...
        public static bool AllTrue(Vector128<nint> value)
        {
            throw new PlatformNotSupportedException();
        }

        public static bool AllTrue(Vector128<nuint> value)
        {
            throw new PlatformNotSupportedException();
        }
