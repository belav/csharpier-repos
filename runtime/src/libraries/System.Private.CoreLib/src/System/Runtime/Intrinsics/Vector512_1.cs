...
namespace System.Runtime.Intrinsics
{
    ...
    /// <summary>Represents a 512-bit vector of a specified numeric type that is suitable for low-level
    ...
    public readonly unsafe struct Vector512<T> : ISimdVector<Vector512<T>, T>
    {
        ...
        /// <summary>Gets the number of <typeparamref name="T" /> that are in a <see cref="Vector512{T}"
        // />.</summary>
        /// <exception cref="NotSupportedException">The type of the vector (<typeparamref name="T" />) is
        // not supported.</exception>
        public static int Count
        {
            [Intrinsic]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get { return Vector256<T>.Count * 2; }
        }
        ...
        /// <returns><c>true</c> if <paramref name="obj" /> is a <see cref="Vector512{T}" /> and is equal to
        // the current instance; otherwise, <c>false</c>.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public override bool Equals([NotNullWhen(true)] object? obj) =>
            (obj is Vector512<T> other) && Equals(other);

        /// <summary>Determines whether the specified <see cref="Vector512{T}" /> is equal to the current
        // instance.</summary>
        /// <param name="other">The <see cref="Vector512{T}" /> to compare with the current
        // instance.</param>
        ...
        public bool Equals(Vector512<T> other)
        {
            ...
            if (Vector512.IsHardwareAccelerated)
            {
                ...
                {
                    Vector512<T> result =
                        Vector512.Equals(this, other)
                        | ~(Vector512.Equals(this, this) | Vector512.Equals(other, other));
        ...
        static Vector512<T> ISimdVector<Vector512<T>, T>.Abs(Vector512<T> vector) =>
            Vector512.Abs(vector);

        /// <inheritdoc cref="ISimdVector{TSelf, T}.Add(TSelf, TSelf)" />
        static Vector512<T> ISimdVector<Vector512<T>, T>.Add(
            Vector512<T> left,
            Vector512<T> right
        ) => Vector512.Add(left, right);

        /// <inheritdoc cref="ISimdVector{TSelf, T}.AndNot(TSelf, TSelf)" />
        static Vector512<T> ISimdVector<Vector512<T>, T>.AndNot(
            Vector512<T> left,
            Vector512<T> right
        ) => Vector512.AndNot(left, right);

        /// <inheritdoc cref="ISimdVector{TSelf, T}.BitwiseAnd(TSelf, TSelf)" />
        static Vector512<T> ISimdVector<Vector512<T>, T>.BitwiseAnd(
            Vector512<T> left,
            Vector512<T> right
        ) => Vector512.BitwiseAnd(left, right);

        /// <inheritdoc cref="ISimdVector{TSelf, T}.BitwiseOr(TSelf, TSelf)" />
        static Vector512<T> ISimdVector<Vector512<T>, T>.BitwiseOr(
            Vector512<T> left,
            Vector512<T> right
        ) => Vector512.BitwiseOr(left, right);

        /// <inheritdoc cref="ISimdVector{TSelf, T}.Ceiling(TSelf)" />
        static Vector512<T> ISimdVector<Vector512<T>, T>.Ceiling(Vector512<T> vector) =>
            Vector512.Ceiling(vector);

        /// <inheritdoc cref="ISimdVector{TSelf, T}.ConditionalSelect(TSelf, TSelf, TSelf)" />
        static Vector512<T> ISimdVector<Vector512<T>, T>.ConditionalSelect(
        ...
        static void ISimdVector<Vector512<T>, T>.CopyTo(
            Vector512<T> vector,
            T[] destination,
            int startIndex
        ...
        static Vector512<T> ISimdVector<Vector512<T>, T>.CreateScalarUnsafe(T value) =>
            Vector512.CreateScalarUnsafe(value);

        /// <inheritdoc cref="ISimdVector{TSelf, T}.Divide(TSelf, T)" />
        static Vector512<T> ISimdVector<Vector512<T>, T>.Divide(
            Vector512<T> left,
            Vector512<T> right
        ) => Vector512.Divide(left, right);
        ...
        static T ISimdVector<Vector512<T>, T>.Dot(Vector512<T> left, Vector512<T> right) =>
            Vector512.Dot(left, right);

        /// <inheritdoc cref="ISimdVector{TSelf, T}.Equals(TSelf, TSelf)" />
        static Vector512<T> ISimdVector<Vector512<T>, T>.Equals(
            Vector512<T> left,
            Vector512<T> right
        ...
        static T ISimdVector<Vector512<T>, T>.GetElement(Vector512<T> vector, int index) =>
            Vector512.GetElement(vector, index);

        /// <inheritdoc cref="ISimdVector{TSelf, T}.GreaterThan(TSelf, TSelf)" />
        static Vector512<T> ISimdVector<Vector512<T>, T>.GreaterThan(
            Vector512<T> left,
            Vector512<T> right
        ) => Vector512.GreaterThan(left, right);

        /// <inheritdoc cref="ISimdVector{TSelf, T}.GreaterThanAll(TSelf, TSelf)" />
        static bool ISimdVector<Vector512<T>, T>.GreaterThanAll(
            Vector512<T> left,
            Vector512<T> right
        ) => Vector512.GreaterThanAll(left, right);

        /// <inheritdoc cref="ISimdVector{TSelf, T}.GreaterThanAny(TSelf, TSelf)" />
        static bool ISimdVector<Vector512<T>, T>.GreaterThanAny(
            Vector512<T> left,
            Vector512<T> right
        ) => Vector512.GreaterThanAny(left, right);

        /// <inheritdoc cref="ISimdVector{TSelf, T}.GreaterThanOrEqual(TSelf, TSelf)" />
        static Vector512<T> ISimdVector<Vector512<T>, T>.GreaterThanOrEqual(
            Vector512<T> left,
            Vector512<T> right
        ) => Vector512.GreaterThanOrEqual(left, right);

        /// <inheritdoc cref="ISimdVector{TSelf, T}.GreaterThanOrEqualAll(TSelf, TSelf)" />
        static bool ISimdVector<Vector512<T>, T>.GreaterThanOrEqualAll(
            Vector512<T> left,
            Vector512<T> right
        ) => Vector512.GreaterThanOrEqualAll(left, right);

        /// <inheritdoc cref="ISimdVector{TSelf, T}.GreaterThanOrEqualAny(TSelf, TSelf)" />
        static bool ISimdVector<Vector512<T>, T>.GreaterThanOrEqualAny(
            Vector512<T> left,
            Vector512<T> right
        ) => Vector512.GreaterThanOrEqualAny(left, right);

        /// <inheritdoc cref="ISimdVector{TSelf, T}.LessThan(TSelf, TSelf)" />
        static Vector512<T> ISimdVector<Vector512<T>, T>.LessThan(
            Vector512<T> left,
            Vector512<T> right
        ) => Vector512.LessThan(left, right);

        /// <inheritdoc cref="ISimdVector{TSelf, T}.LessThanAll(TSelf, TSelf)" />
        static bool ISimdVector<Vector512<T>, T>.LessThanAll(
            Vector512<T> left,
            Vector512<T> right
        ) => Vector512.LessThanAll(left, right);

        /// <inheritdoc cref="ISimdVector{TSelf, T}.LessThanAny(TSelf, TSelf)" />
        static bool ISimdVector<Vector512<T>, T>.LessThanAny(
            Vector512<T> left,
            Vector512<T> right
        ) => Vector512.LessThanAny(left, right);

        /// <inheritdoc cref="ISimdVector{TSelf, T}.LessThanOrEqual(TSelf, TSelf)" />
        static Vector512<T> ISimdVector<Vector512<T>, T>.LessThanOrEqual(
            Vector512<T> left,
            Vector512<T> right
        ) => Vector512.LessThanOrEqual(left, right);

        /// <inheritdoc cref="ISimdVector{TSelf, T}.LessThanOrEqualAll(TSelf, TSelf)" />
        static bool ISimdVector<Vector512<T>, T>.LessThanOrEqualAll(
            Vector512<T> left,
            Vector512<T> right
        ) => Vector512.LessThanOrEqualAll(left, right);

        /// <inheritdoc cref="ISimdVector{TSelf, T}.LessThanOrEqualAny(TSelf, TSelf)" />
        static bool ISimdVector<Vector512<T>, T>.LessThanOrEqualAny(
            Vector512<T> left,
            Vector512<T> right
        ) => Vector512.LessThanOrEqualAny(left, right);
...
#pragma warning disable CS8500 // This takes the address of, gets the size of, or declares a pointer to a managed type ('T')
        ...
        static Vector512<T> ISimdVector<Vector512<T>, T>.LoadAligned(T* source) =>
            Vector512.LoadAligned(source);

        /// <inheritdoc cref="ISimdVector{TSelf, T}.LoadAlignedNonTemporal(T*)" />
        static Vector512<T> ISimdVector<Vector512<T>, T>.LoadAlignedNonTemporal(T* source) =>
            Vector512.LoadAlignedNonTemporal(source);
#pragma warning restore CS8500 // This takes the address of, gets the size of, or declares a pointer to a managed type ('T')
        ...
        static Vector512<T> ISimdVector<Vector512<T>, T>.LoadUnsafe(ref readonly T source) =>
            Vector512.LoadUnsafe(in source);

        /// <inheritdoc cref="ISimdVector{TSelf, T}.LoadUnsafe(ref readonly T, nuint)" />
        static Vector512<T> ISimdVector<Vector512<T>, T>.LoadUnsafe(
            ref readonly T source,
            nuint elementOffset
        ) => Vector512.LoadUnsafe(in source, elementOffset);

        /// <inheritdoc cref="ISimdVector{TSelf, T}.Max(TSelf, TSelf)" />
        static Vector512<T> ISimdVector<Vector512<T>, T>.Max(
            Vector512<T> left,
            Vector512<T> right
        ) => Vector512.Max(left, right);

        /// <inheritdoc cref="ISimdVector{TSelf, T}.Min(TSelf, TSelf)" />
        static Vector512<T> ISimdVector<Vector512<T>, T>.Min(
            Vector512<T> left,
            Vector512<T> right
        ) => Vector512.Min(left, right);

        /// <inheritdoc cref="ISimdVector{TSelf, T}.Multiply(TSelf, T)" />
        static Vector512<T> ISimdVector<Vector512<T>, T>.Multiply(
            Vector512<T> left,
            Vector512<T> right
        ) => Vector512.Multiply(left, right);
        ...
        static Vector512<T> ISimdVector<Vector512<T>, T>.OnesComplement(Vector512<T> vector) =>
            Vector512.OnesComplement(vector);

        /// <inheritdoc cref="ISimdVector{TSelf, T}.ShiftLeft(TSelf, int)" />
        static Vector512<T> ISimdVector<Vector512<T>, T>.ShiftLeft(
            Vector512<T> vector,
            int shiftCount
        ) => Vector512.ShiftLeft(vector, shiftCount);

        /// <inheritdoc cref="ISimdVector{TSelf, T}.ShiftRightArithmetic(TSelf, int)" />
        static Vector512<T> ISimdVector<Vector512<T>, T>.ShiftRightArithmetic(
            Vector512<T> vector,
            int shiftCount
        ) => Vector512.ShiftRightArithmetic(vector, shiftCount);

        /// <inheritdoc cref="ISimdVector{TSelf, T}.ShiftRightLogical(TSelf, int)" />
        static Vector512<T> ISimdVector<Vector512<T>, T>.ShiftRightLogical(
            Vector512<T> vector,
            int shiftCount
        ) => Vector512.ShiftRightLogical(vector, shiftCount);

        /// <inheritdoc cref="ISimdVector{TSelf, T}.Sqrt(TSelf)" />
        static Vector512<T> ISimdVector<Vector512<T>, T>.Sqrt(Vector512<T> vector) =>
            Vector512.Sqrt(vector);

#pragma warning disable CS8500 // This takes the address of, gets the size of, or declares a pointer to a managed type ('T')
        /// <inheritdoc cref="ISimdVector{TSelf, T}.Store(TSelf, T*)" />
        static void ISimdVector<Vector512<T>, T>.Store(Vector512<T> source, T* destination) =>
            Vector512.Store(source, destination);

        /// <inheritdoc cref="ISimdVector{TSelf, T}.StoreAligned(TSelf, T*)" />
        static void ISimdVector<Vector512<T>, T>.StoreAligned(
            Vector512<T> source,
            T* destination
        ) => Vector512.StoreAligned(source, destination);

        /// <inheritdoc cref="ISimdVector{TSelf, T}.StoreAlignedNonTemporal(TSelf, T*)" />
        static void ISimdVector<Vector512<T>, T>.StoreAlignedNonTemporal(
            Vector512<T> source,
            T* destination
        ) => Vector512.StoreAlignedNonTemporal(source, destination);
#pragma warning restore CS8500 // This takes the address of, gets the size of, or declares a pointer to a managed type ('T')

        /// <inheritdoc cref="ISimdVector{TSelf, T}.StoreUnsafe(TSelf, ref T)" />
        static void ISimdVector<Vector512<T>, T>.StoreUnsafe(
            Vector512<T> vector,
            ref T destination
        ) => Vector512.StoreUnsafe(vector, ref destination);
        ...
        static void ISimdVector<Vector512<T>, T>.StoreUnsafe(
            ...
            ref T destination,
            nuint elementOffset
        ) => Vector512.StoreUnsafe(vector, ref destination, elementOffset);

        /// <inheritdoc cref="ISimdVector{TSelf, T}.Subtract(TSelf, TSelf)" />
        static Vector512<T> ISimdVector<Vector512<T>, T>.Subtract(
            Vector512<T> left,
            Vector512<T> right
        ) => Vector512.Subtract(left, right);
        ...
        static T ISimdVector<Vector512<T>, T>.ToScalar(Vector512<T> vector) =>
            Vector512.ToScalar(vector);

        /// <inheritdoc cref="ISimdVector{TSelf, T}.TryCopyTo(TSelf, Span{T})" />
        static bool ISimdVector<Vector512<T>, T>.TryCopyTo(
            Vector512<T> vector,
            Span<T> destination
        ) => Vector512.TryCopyTo(vector, destination);

        /// <inheritdoc cref="ISimdVector{TSelf, T}.WithElement(TSelf, int, T)" />
        static Vector512<T> ISimdVector<Vector512<T>, T>.WithElement(
            Vector512<T> vector,
            int index,
            T value
        ) => Vector512.WithElement(vector, index, value);

        /// <inheritdoc cref="ISimdVector{TSelf, T}.Xor" />
        static Vector512<T> ISimdVector<Vector512<T>, T>.Xor(
            Vector512<T> left,
            Vector512<T> right
        ) => Vector512.Xor(left, right);
