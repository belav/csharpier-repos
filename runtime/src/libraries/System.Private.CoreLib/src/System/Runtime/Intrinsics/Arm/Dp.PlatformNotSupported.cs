...
namespace System.Runtime.Intrinsics.Arm
{
    ...
    public abstract class Dp : AdvSimd
    {
        ...
        /// </summary>
        public static Vector64<int> DotProduct(
            Vector64<int> addend,
            Vector64<sbyte> left,
        ...
        /// </summary>
        public static Vector64<uint> DotProduct(
        ...
        /// </summary>
        public static Vector128<int> DotProduct(
        ...
        /// </summary>
        public static Vector128<uint> DotProduct(
        ...
        /// </summary>
        public static Vector64<int> DotProductBySelectedQuadruplet(
            Vector64<int> addend,
            Vector64<sbyte> left,
            Vector64<sbyte> right,
            [ConstantExpected(Max = (byte)(7))] byte rightScaledIndex
        )
        {
            throw new PlatformNotSupportedException();
        }
        ...
        public static Vector64<int> DotProductBySelectedQuadruplet(
            ...
            Vector64<sbyte> left,
            Vector128<sbyte> right,
            [ConstantExpected(Max = (byte)(15))] byte rightScaledIndex
        )
        {
            throw new PlatformNotSupportedException();
        }
        ...
        /// </summary>
        public static Vector64<uint> DotProductBySelectedQuadruplet(
            Vector64<uint> addend,
            Vector64<byte> left,
            Vector64<byte> right,
            [ConstantExpected(Max = (byte)(7))] byte rightScaledIndex
        ...
        /// </summary>
        public static Vector128<int> DotProductBySelectedQuadruplet(
            Vector128<int> addend,
            Vector128<sbyte> left,
            Vector128<sbyte> right,
            [ConstantExpected(Max = (byte)(15))] byte rightScaledIndex
        ...
        /// </summary>
        public static Vector128<uint> DotProductBySelectedQuadruplet(
            Vector128<uint> addend,
            Vector128<byte> left,
            Vector128<byte> right,
            [ConstantExpected(Max = (byte)(15))] byte rightScaledIndex
