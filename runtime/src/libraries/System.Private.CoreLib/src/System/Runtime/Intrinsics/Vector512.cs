...
namespace System.Runtime.Intrinsics
{
    ...
    /// <summary>Provides a collection of static methods for creating, manipulating, and otherwise
    // operting on 512-bit vectors.</summary>
    public static unsafe class Vector512
    {
        ...
        /// <summary>Gets a value that indicates whether 512-bit vector operations are subject to hardware
        // acceleration through JIT intrinsic support.</summary>
        /// <value><see langword="true" /> if 512-bit vector operations are subject to hardware
        // acceleration; otherwise, <see langword="false" />.</value>
        /// <remarks>512-bit vector operations are subject to hardware acceleration on systems that support
        // Single Instruction, Multiple Data (SIMD) instructions for 512-bit vectors and the RyuJIT
        // just-in-time compiler is used to compile managed code.</remarks>
        ...
        /// <returns>A vector whose elements are the absolute value of the elements in <paramref
        // name="vector" />.</returns>
        /// <exception cref="NotSupportedException">The type of <paramref name="vector" /> (<typeparamref
        ...
        /// <exception cref="NotSupportedException">The type of <paramref name="left" /> and <paramref
        // name="right" /> (<typeparamref name="T" />) is not supported.</exception>
        [Intrinsic]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vector512<T> Add<T>(Vector512<T> left, Vector512<T> right) => left + right;

        /// <summary>Computes the bitwise-and of a given vector and the ones complement of another
        // vector.</summary>
        /// <typeparam name="T">The type of the elements in the vector.</typeparam>
        /// <param name="left">The vector to bitwise-and with <paramref name="right" />.</param>
        /// <param name="right">The vector to that is ones-complemented before being bitwise-and with
        // <paramref name="left" />.</param>
        /// <returns>The bitwise-and of <paramref name="left" /> and the ones-complement of <paramref
        // name="right" />.</returns>
        /// <exception cref="NotSupportedException">The type of <paramref name="left" /> and <paramref
        // name="right" /> (<typeparamref name="T" />) is not supported.</exception>
        [Intrinsic]
        ...
        /// <summary>Reinterprets a <see cref="Vector512{TFrom}" /> as a new <see cref="Vector512{TTo}"
        // />.</summary>
        ...
        /// <returns><paramref name="vector" /> reinterpreted as a new <see cref="Vector512{TTo}"
        // />.</returns>
        /// <exception cref="NotSupportedException">The type of <paramref name="vector" /> (<typeparamref
        // name="TFrom" />) or the type of the target (<typeparamref name="TTo" />) is not
        // supported.</exception>
        [Intrinsic]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>Reinterprets a <see cref="Vector512{T}" /> as a new <see cref="Vector512{Byte}"
        // />.</summary>
        /// <typeparam name="T">The type of the elements in the vector.</typeparam>
        /// <param name="vector">The vector to reinterpret.</param>
        /// <returns><paramref name="vector" /> reinterpreted as a new <see cref="Vector512{Byte}"
        // />.</returns>
        /// <exception cref="NotSupportedException">The type of <paramref name="vector" /> (<typeparamref
        // name="T" />) is not supported.</exception>
        [Intrinsic]
        ...
        /// <summary>Reinterprets a <see cref="Vector512{T}" /> as a new <see cref="Vector512{Double}"
        // />.</summary>
        /// <typeparam name="T">The type of the elements in the vector.</typeparam>
        /// <param name="vector">The vector to reinterpret.</param>
        /// <returns><paramref name="vector" /> reinterpreted as a new <see cref="Vector512{Double}"
        // />.</returns>
        /// <exception cref="NotSupportedException">The type of <paramref name="vector" /> (<typeparamref
        // name="T" />) is not supported.</exception>
        [Intrinsic]
        ...
        /// <summary>Reinterprets a <see cref="Vector512{T}" /> as a new <see cref="Vector512{Int16}"
        // />.</summary>
        /// <typeparam name="T">The type of the elements in the vector.</typeparam>
        /// <param name="vector">The vector to reinterpret.</param>
        /// <returns><paramref name="vector" /> reinterpreted as a new <see cref="Vector512{Int16}"
        // />.</returns>
        /// <exception cref="NotSupportedException">The type of <paramref name="vector" /> (<typeparamref
        // name="T" />) is not supported.</exception>
        [Intrinsic]
        ...
        /// <summary>Reinterprets a <see cref="Vector512{T}" /> as a new <see cref="Vector512{Int32}"
        // />.</summary>
        /// <typeparam name="T">The type of the elements in the vector.</typeparam>
        /// <param name="vector">The vector to reinterpret.</param>
        /// <returns><paramref name="vector" /> reinterpreted as a new <see cref="Vector512{Int32}"
        // />.</returns>
        /// <exception cref="NotSupportedException">The type of <paramref name="vector" /> (<typeparamref
        // name="T" />) is not supported.</exception>
        [Intrinsic]
        ...
        /// <summary>Reinterprets a <see cref="Vector512{T}" /> as a new <see cref="Vector512{Int64}"
        // />.</summary>
        /// <typeparam name="T">The type of the elements in the vector.</typeparam>
        /// <param name="vector">The vector to reinterpret.</param>
        /// <returns><paramref name="vector" /> reinterpreted as a new <see cref="Vector512{Int64}"
        // />.</returns>
        /// <exception cref="NotSupportedException">The type of <paramref name="vector" /> (<typeparamref
        // name="T" />) is not supported.</exception>
        [Intrinsic]
        ...
        /// <summary>Reinterprets a <see cref="Vector512{T}" /> as a new <see cref="Vector512{IntPtr}"
        // />.</summary>
        /// <typeparam name="T">The type of the elements in the vector.</typeparam>
        /// <param name="vector">The vector to reinterpret.</param>
        /// <returns><paramref name="vector" /> reinterpreted as a new <see cref="Vector512{IntPtr}"
        // />.</returns>
        /// <exception cref="NotSupportedException">The type of <paramref name="vector" /> (<typeparamref
        // name="T" />) is not supported.</exception>
        [Intrinsic]
        ...
        /// <summary>Reinterprets a <see cref="Vector512{T}" /> as a new <see cref="Vector512{UIntPtr}"
        // />.</summary>
        /// <typeparam name="T">The type of the elements in the vector.</typeparam>
        /// <param name="vector">The vector to reinterpret.</param>
        /// <returns><paramref name="vector" /> reinterpreted as a new <see cref="Vector512{UIntPtr}"
        // />.</returns>
        /// <exception cref="NotSupportedException">The type of <paramref name="vector" /> (<typeparamref
        // name="T" />) is not supported.</exception>
        [Intrinsic]
        ...
        /// <summary>Reinterprets a <see cref="Vector512{T}" /> as a new <see cref="Vector512{SByte}"
        // />.</summary>
        /// <typeparam name="T">The type of the elements in the vector.</typeparam>
        /// <param name="vector">The vector to reinterpret.</param>
        /// <returns><paramref name="vector" /> reinterpreted as a new <see cref="Vector512{SByte}"
        // />.</returns>
        /// <exception cref="NotSupportedException">The type of <paramref name="vector" /> (<typeparamref
        // name="T" />) is not supported.</exception>
        [Intrinsic]
        ...
        /// <summary>Reinterprets a <see cref="Vector512{T}" /> as a new <see cref="Vector512{Single}"
        // />.</summary>
        /// <typeparam name="T">The type of the elements in the vector.</typeparam>
        /// <param name="vector">The vector to reinterpret.</param>
        /// <returns><paramref name="vector" /> reinterpreted as a new <see cref="Vector512{Single}"
        // />.</returns>
        /// <exception cref="NotSupportedException">The type of <paramref name="vector" /> (<typeparamref
        // name="T" />) is not supported.</exception>
        [Intrinsic]
        ...
        /// <summary>Reinterprets a <see cref="Vector512{T}" /> as a new <see cref="Vector512{UInt16}"
        // />.</summary>
        /// <typeparam name="T">The type of the elements in the vector.</typeparam>
        /// <param name="vector">The vector to reinterpret.</param>
        /// <returns><paramref name="vector" /> reinterpreted as a new <see cref="Vector512{UInt16}"
        // />.</returns>
        /// <exception cref="NotSupportedException">The type of <paramref name="vector" /> (<typeparamref
        // name="T" />) is not supported.</exception>
        [Intrinsic]
        ...
        /// <summary>Reinterprets a <see cref="Vector512{T}" /> as a new <see cref="Vector512{UInt32}"
        // />.</summary>
        /// <typeparam name="T">The type of the elements in the vector.</typeparam>
        /// <param name="vector">The vector to reinterpret.</param>
        /// <returns><paramref name="vector" /> reinterpreted as a new <see cref="Vector512{UInt32}"
        // />.</returns>
        /// <exception cref="NotSupportedException">The type of <paramref name="vector" /> (<typeparamref
        // name="T" />) is not supported.</exception>
        [Intrinsic]
        ...
        /// <summary>Reinterprets a <see cref="Vector512{T}" /> as a new <see cref="Vector512{UInt64}"
        // />.</summary>
        /// <typeparam name="T">The type of the elements in the vector.</typeparam>
        /// <param name="vector">The vector to reinterpret.</param>
        /// <returns><paramref name="vector" /> reinterpreted as a new <see cref="Vector512{UInt64}"
        // />.</returns>
        /// <exception cref="NotSupportedException">The type of <paramref name="vector" /> (<typeparamref
        // name="T" />) is not supported.</exception>
        [Intrinsic]
        ...
        /// <returns>A vector whose elements are the ceiling of the elements in <paramref name="vector"
        // />.</returns>
        [Intrinsic]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <typeparam name="T">The type of the elements in the vector.</typeparam>
        /// <param name="condition">The mask that is used to select a value from <paramref name="left" /> or
        // <paramref name="right" />.</param>
        /// <param name="left">The vector that is selected when the corresponding bit in <paramref
        // name="condition" /> is one.</param>
        /// <param name="right">The vector that is selected when the corresponding bit in <paramref
        // name="condition" /> is zero.</param>
        /// <returns>A vector whose bits come from <paramref name="left" /> or <paramref name="right" />
        // based on the value of <paramref name="condition" />.</returns>
        /// <exception cref="NotSupportedException">The type of <paramref name="condition" />, <paramref
        // name="left" />, and <paramref name="right" /> (<typeparamref name="T" />) is not
        // supported.</exception>
        [Intrinsic]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>Converts a <see cref="Vector512{Int64}" /> to a <see cref="Vector512{Double}"
        // />.</summary>
        ...
        /// <summary>Converts a <see cref="Vector512{UInt64}" /> to a <see cref="Vector512{Double}"
        // />.</summary>
        /// <param name="vector">The vector to convert.</param>
        /// <returns>The converted vector.</returns>
        [Intrinsic]
        ...
        /// <summary>Converts a <see cref="Vector512{Single}" /> to a <see cref="Vector512{Int32}"
        // />.</summary>
        /// <param name="vector">The vector to convert.</param>
        /// <returns>The converted vector.</returns>
        [Intrinsic]
        ...
        /// <summary>Converts a <see cref="Vector512{Double}" /> to a <see cref="Vector512{Int64}"
        // />.</summary>
        /// <param name="vector">The vector to convert.</param>
        /// <returns>The converted vector.</returns>
        [Intrinsic]
        ...
        /// <summary>Converts a <see cref="Vector512{Int32}" /> to a <see cref="Vector512{Single}"
        // />.</summary>
        /// <param name="vector">The vector to convert.</param>
        /// <returns>The converted vector.</returns>
        [Intrinsic]
        ...
        /// <summary>Converts a <see cref="Vector512{UInt32}" /> to a <see cref="Vector512{Single}"
        // />.</summary>
        /// <param name="vector">The vector to convert.</param>
        /// <returns>The converted vector.</returns>
        [Intrinsic]
        ...
        /// <summary>Converts a <see cref="Vector512{Single}" /> to a <see cref="Vector512{UInt32}"
        // />.</summary>
        /// <param name="vector">The vector to convert.</param>
        /// <returns>The converted vector.</returns>
        [Intrinsic]
        ...
        /// <summary>Converts a <see cref="Vector512{Double}" /> to a <see cref="Vector512{UInt64}"
        // />.</summary>
        /// <param name="vector">The vector to convert.</param>
        /// <returns>The converted vector.</returns>
        [Intrinsic]
        ...
        // <see cref="Vector512{T}.Count" />.</exception>
        /// <exception cref="NotSupportedException">The type of <paramref name="vector" /> and <paramref
        // name="destination" /> (<typeparamref name="T" />) is not supported.</exception>
        ...
        /// <summary>Copies a <see cref="Vector512{T}" /> to a given array starting at the specified
        // index.</summary>
        /// <typeparam name="T">The type of the elements in the vector.</typeparam>
        /// <param name="vector">The vector to be copied.</param>
        /// <param name="destination">The array to which <paramref name="vector" /> is copied.</param>
        /// <param name="startIndex">The starting index of <paramref name="destination" /> which <paramref
        // name="vector" /> will be copied to.</param>
        /// <exception cref="ArgumentException">The length of <paramref name="destination" /> is less than
        // <see cref="Vector512{T}.Count" />.</exception>
        ...
        /// <summary>Creates a new <see cref="Vector512{T}" /> instance with all elements initialized to the
        // specified value.</summary>
        /// <typeparam name="T">The type of the elements in the vector.</typeparam>
        /// <param name="value">The value that all elements will be initialized to.</param>
        /// <returns>A new <see cref="Vector512{T}" /> with all elements initialized to <paramref
        // name="value" />.</returns>
        /// <exception cref="NotSupportedException">The type of <paramref name="value" /> (<typeparamref
        // name="T" />) is not supported.</exception>
        [Intrinsic]
        ...
        /// <summary>Creates a new <see cref="Vector512{Byte}" /> instance with all elements initialized to
        // the specified value.</summary>
        /// <param name="value">The value that all elements will be initialized to.</param>
        /// <returns>A new <see cref="Vector512{Byte}" /> with all elements initialized to <paramref
        // name="value" />.</returns>
        ...
        /// <summary>Creates a new <see cref="Vector512{Double}" /> instance with all elements initialized
        // to the specified value.</summary>
        /// <param name="value">The value that all elements will be initialized to.</param>
        /// <returns>A new <see cref="Vector512{Double}" /> with all elements initialized to <paramref
        // name="value" />.</returns>
        ...
        /// <summary>Creates a new <see cref="Vector512{Int16}" /> instance with all elements initialized to
        // the specified value.</summary>
        /// <param name="value">The value that all elements will be initialized to.</param>
        /// <returns>A new <see cref="Vector512{Int16}" /> with all elements initialized to <paramref
        // name="value" />.</returns>
        ...
        /// <summary>Creates a new <see cref="Vector512{Int32}" /> instance with all elements initialized to
        // the specified value.</summary>
        /// <param name="value">The value that all elements will be initialized to.</param>
        /// <returns>A new <see cref="Vector512{Int32}" /> with all elements initialized to <paramref
        // name="value" />.</returns>
        ...
        /// <summary>Creates a new <see cref="Vector512{Int64}" /> instance with all elements initialized to
        // the specified value.</summary>
        /// <param name="value">The value that all elements will be initialized to.</param>
        /// <returns>A new <see cref="Vector512{Int64}" /> with all elements initialized to <paramref
        // name="value" />.</returns>
        ...
        /// <summary>Creates a new <see cref="Vector512{IntPtr}" /> instance with all elements initialized
        // to the specified value.</summary>
        /// <param name="value">The value that all elements will be initialized to.</param>
        /// <returns>A new <see cref="Vector512{IntPtr}" /> with all elements initialized to <paramref
        // name="value" />.</returns>
        [Intrinsic]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vector512<nint> Create(nint value) => Create<nint>(value);

        /// <summary>Creates a new <see cref="Vector512{UIntPtr}" /> instance with all elements initialized
        // to the specified value.</summary>
        /// <param name="value">The value that all elements will be initialized to.</param>
        /// <returns>A new <see cref="Vector512{UIntPtr}" /> with all elements initialized to <paramref
        // name="value" />.</returns>
        [Intrinsic]
        [CLSCompliant(false)]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>Creates a new <see cref="Vector512{SByte}" /> instance with all elements initialized to
        // the specified value.</summary>
        /// <param name="value">The value that all elements will be initialized to.</param>
        /// <returns>A new <see cref="Vector512{SByte}" /> with all elements initialized to <paramref
        // name="value" />.</returns>
        /// <remarks>On x86, this method corresponds to __m512i _mm512_set1_epi8</remarks>
        [Intrinsic]
        [CLSCompliant(false)]
        ...
        /// <summary>Creates a new <see cref="Vector512{Single}" /> instance with all elements initialized
        // to the specified value.</summary>
        /// <param name="value">The value that all elements will be initialized to.</param>
        /// <returns>A new <see cref="Vector512{Single}" /> with all elements initialized to <paramref
        // name="value" />.</returns>
        ...
        /// <summary>Creates a new <see cref="Vector512{UInt16}" /> instance with all elements initialized
        // to the specified value.</summary>
        /// <param name="value">The value that all elements will be initialized to.</param>
        /// <returns>A new <see cref="Vector512{UInt16}" /> with all elements initialized to <paramref
        // name="value" />.</returns>
        /// <remarks>On x86, this method corresponds to __m512i _mm512_set1_epi16</remarks>
        [Intrinsic]
        [CLSCompliant(false)]
        ...
        /// <summary>Creates a new <see cref="Vector512{UInt32}" /> instance with all elements initialized
        // to the specified value.</summary>
        /// <param name="value">The value that all elements will be initialized to.</param>
        /// <returns>A new <see cref="Vector512{UInt32}" /> with all elements initialized to <paramref
        // name="value" />.</returns>
        /// <remarks>On x86, this method corresponds to __m512i _mm512_set1_epi32</remarks>
        [Intrinsic]
        [CLSCompliant(false)]
        ...
        /// <summary>Creates a new <see cref="Vector512{UInt64}" /> instance with all elements initialized
        // to the specified value.</summary>
        /// <param name="value">The value that all elements will be initialized to.</param>
        /// <returns>A new <see cref="Vector512{UInt64}" /> with all elements initialized to <paramref
        // name="value" />.</returns>
        /// <remarks>On x86, this method corresponds to __m512i _mm512_set1_epi64x</remarks>
        [Intrinsic]
        [CLSCompliant(false)]
        ...
        /// <returns>A new <see cref="Vector512{T}" /> with its elements set to the first <see
        // cref="Vector512{T}.Count" /> elements from <paramref name="values" />.</returns>
        /// <exception cref="ArgumentOutOfRangeException">The length of <paramref name="values" /> is less
        // than <see cref="Vector512{T}.Count" />.</exception>
        /// <exception cref="NotSupportedException">The type of <paramref name="values" /> (<typeparamref
        // name="T" />) is not supported.</exception>
        ...
        // elements.</param>
        /// <returns>A new <see cref="Vector512{T}" /> with its elements set to the first <see
        // cref="Vector256{T}.Count" /> elements from <paramref name="values" />.</returns>
        /// <exception cref="ArgumentOutOfRangeException">The length of <paramref name="values" />, starting
        // from <paramref name="index" />, is less than <see cref="Vector512{T}.Count" />.</exception>
        /// <exception cref="NotSupportedException">The type of <paramref name="values" /> (<typeparamref
        // name="T" />) is not supported.</exception>
        /// <exception cref="NullReferenceException"><paramref name="values" /> is <c>null</c>.</exception>
        ...
        /// <summary>Creates a new <see cref="Vector512{Byte}" /> instance with each element initialized to
        // the corresponding specified value.</summary>
        ...
        /// <returns>A new <see cref="Vector512{Byte}" /> with each element initialized to corresponding
        ...
        /// <summary>Creates a new <see cref="Vector512{Double}" /> instance with each element initialized
        // to the corresponding specified value.</summary>
        /// <param name="e0">The value that element 0 will be initialized to.</param>
        /// <param name="e1">The value that element 1 will be initialized to.</param>
        /// <param name="e2">The value that element 2 will be initialized to.</param>
        /// <param name="e3">The value that element 3 will be initialized to.</param>
        ...
        /// <param name="e6">The value that element 6 will be initialized to.</param>
        /// <param name="e7">The value that element 7 will be initialized to.</param>
        /// <returns>A new <see cref="Vector512{Double}" /> with each element initialized to corresponding
        // specified value.</returns>
        ...
        /// <summary>Creates a new <see cref="Vector512{Int16}" /> instance with each element initialized to
        // the corresponding specified value.</summary>
        /// <param name="e0">The value that element 0 will be initialized to.</param>
        /// <param name="e1">The value that element 1 will be initialized to.</param>
        /// <param name="e2">The value that element 2 will be initialized to.</param>
        ...
        /// <param name="e30">The value that element 30 will be initialized to.</param>
        /// <param name="e31">The value that element 31 will be initialized to.</param>
        /// <returns>A new <see cref="Vector512{Int16}" /> with each element initialized to corresponding
        // specified value.</returns>
        ...
        /// <summary>Creates a new <see cref="Vector512{Int32}" /> instance with each element initialized to
        // the corresponding specified value.</summary>
        /// <param name="e0">The value that element 0 will be initialized to.</param>
        /// <param name="e1">The value that element 1 will be initialized to.</param>
        /// <param name="e2">The value that element 2 will be initialized to.</param>
        ...
        /// <param name="e14">The value that element 14 will be initialized to.</param>
        /// <param name="e15">The value that element 15 will be initialized to.</param>
        /// <returns>A new <see cref="Vector512{Int32}" /> with each element initialized to corresponding
        // specified value.</returns>
        ...
        /// <summary>Creates a new <see cref="Vector512{Int64}" /> instance with each element initialized to
        // the corresponding specified value.</summary>
        /// <param name="e0">The value that element 0 will be initialized to.</param>
        /// <param name="e1">The value that element 1 will be initialized to.</param>
        /// <param name="e2">The value that element 2 will be initialized to.</param>
        ...
        /// <param name="e6">The value that element 6 will be initialized to.</param>
        /// <param name="e7">The value that element 7 will be initialized to.</param>
        /// <returns>A new <see cref="Vector512{Int64}" /> with each element initialized to corresponding
        // specified value.</returns>
        ...
        /// <summary>Creates a new <see cref="Vector512{SByte}" /> instance with each element initialized to
        // the corresponding specified value.</summary>
        /// <param name="e0">The value that element 0 will be initialized to.</param>
        /// <param name="e1">The value that element 1 will be initialized to.</param>
        /// <param name="e2">The value that element 2 will be initialized to.</param>
        ...
        /// <param name="e62">The value that element 62 will be initialized to.</param>
        /// <param name="e63">The value that element 63 will be initialized to.</param>
        /// <returns>A new <see cref="Vector512{SByte}" /> with each element initialized to corresponding
        // specified value.</returns>
        /// <remarks>On x86, this method corresponds to __m512i _mm512_setr_epi8</remarks>
        [Intrinsic]
        [CLSCompliant(false)]
        ...
        /// <summary>Creates a new <see cref="Vector512{Single}" /> instance with each element initialized
        // to the corresponding specified value.</summary>
        /// <param name="e0">The value that element 0 will be initialized to.</param>
        /// <param name="e1">The value that element 1 will be initialized to.</param>
        /// <param name="e2">The value that element 2 will be initialized to.</param>
        ...
        /// <param name="e14">The value that element 14 will be initialized to.</param>
        /// <param name="e15">The value that element 15 will be initialized to.</param>
        /// <returns>A new <see cref="Vector512{Single}" /> with each element initialized to corresponding
        // specified value.</returns>
        ...
        /// <summary>Creates a new <see cref="Vector512{UInt16}" /> instance with each element initialized
        // to the corresponding specified value.</summary>
        /// <param name="e0">The value that element 0 will be initialized to.</param>
        /// <param name="e1">The value that element 1 will be initialized to.</param>
        /// <param name="e2">The value that element 2 will be initialized to.</param>
        ...
        /// <param name="e30">The value that element 30 will be initialized to.</param>
        /// <param name="e31">The value that element 31 will be initialized to.</param>
        /// <returns>A new <see cref="Vector512{UInt16}" /> with each element initialized to corresponding
        // specified value.</returns>
        /// <remarks>On x86, this method corresponds to __m512i _mm512_setr_epi16</remarks>
        [Intrinsic]
        [CLSCompliant(false)]
        ...
        /// <summary>Creates a new <see cref="Vector512{UInt32}" /> instance with each element initialized
        // to the corresponding specified value.</summary>
        /// <param name="e0">The value that element 0 will be initialized to.</param>
        /// <param name="e1">The value that element 1 will be initialized to.</param>
        /// <param name="e2">The value that element 2 will be initialized to.</param>
        ...
        /// <param name="e14">The value that element 14 will be initialized to.</param>
        /// <param name="e15">The value that element 15 will be initialized to.</param>
        /// <returns>A new <see cref="Vector512{UInt32}" /> with each element initialized to corresponding
        // specified value.</returns>
        /// <remarks>On x86, this method corresponds to __m512i _mm512_setr_epi32</remarks>
        [Intrinsic]
        [CLSCompliant(false)]
        ...
        /// <summary>Creates a new <see cref="Vector512{UInt64}" /> instance with each element initialized
        // to the corresponding specified value.</summary>
        /// <param name="e0">The value that element 0 will be initialized to.</param>
        /// <param name="e1">The value that element 1 will be initialized to.</param>
        /// <param name="e2">The value that element 2 will be initialized to.</param>
        ...
        /// <param name="e6">The value that element 6 will be initialized to.</param>
        /// <param name="e7">The value that element 7 will be initialized to.</param>
        /// <returns>A new <see cref="Vector512{UInt64}" /> with each element initialized to corresponding
        // specified value.</returns>
        /// <remarks>On x86, this method corresponds to __m512i _mm512_setr_epi64x</remarks>
        [Intrinsic]
        [CLSCompliant(false)]
        ...
        /// <summary>Creates a new <see cref="Vector512{T}" /> instance from two <see cref="Vector256{T}" />
        // instances.</summary>
        /// <typeparam name="T">The type of the elements in the vector.</typeparam>
        ...
        /// <returns>A new <see cref="Vector512{T}" /> initialized from <paramref name="lower" /> and
        // <paramref name="upper" />.</returns>
        /// <exception cref="NotSupportedException">The type of <paramref name="lower" /> and <paramref
        // name="upper" /> (<typeparamref name="T" />) is not supported.</exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>Creates a new <see cref="Vector512{Byte}" /> instance from two <see
        // cref="Vector256{Byte}" /> instances.</summary>
        /// <param name="lower">The value that the lower 256-bits will be initialized to.</param>
        /// <param name="upper">The value that the upper 256-bits will be initialized to.</param>
        /// <returns>A new <see cref="Vector512{Byte}" /> initialized from <paramref name="lower" /> and
        // <paramref name="upper" />.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vector512<byte> Create(Vector256<byte> lower, Vector256<byte> upper) =>
            Create<byte>(lower, upper);

        /// <summary>Creates a new <see cref="Vector512{Double}" /> instance from two <see
        // cref="Vector256{Double}" /> instances.</summary>
        /// <param name="lower">The value that the lower 256-bits will be initialized to.</param>
        /// <param name="upper">The value that the upper 256-bits will be initialized to.</param>
        /// <returns>A new <see cref="Vector512{Double}" /> initialized from <paramref name="lower" /> and
        // <paramref name="upper" />.</returns>
        /// <remarks>On x86, this method corresponds to __m512d _mm512_setr_m256d (__m256d lo, __m256d
        // hi)</remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vector512<double> Create(Vector256<double> lower, Vector256<double> upper) =>
            Create<double>(lower, upper);

        /// <summary>Creates a new <see cref="Vector512{Int16}" /> instance from two <see
        // cref="Vector256{Int16}" /> instances.</summary>
        /// <param name="lower">The value that the lower 256-bits will be initialized to.</param>
        /// <param name="upper">The value that the upper 256-bits will be initialized to.</param>
        /// <returns>A new <see cref="Vector512{Int16}" /> initialized from <paramref name="lower" /> and
        // <paramref name="upper" />.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vector512<short> Create(Vector256<short> lower, Vector256<short> upper) =>
            Create<short>(lower, upper);

        /// <summary>Creates a new <see cref="Vector512{Int32}" /> instance from two <see
        // cref="Vector256{Int32}" /> instances.</summary>
        /// <param name="lower">The value that the lower 256-bits will be initialized to.</param>
        /// <param name="upper">The value that the upper 256-bits will be initialized to.</param>
        /// <returns>A new <see cref="Vector512{Int32}" /> initialized from <paramref name="lower" /> and
        // <paramref name="upper" />.</returns>
        /// <remarks>On x86, this method corresponds to __m512i _mm512_setr_m256i (__m256i lo, __m256i
        // hi)</remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vector512<int> Create(Vector256<int> lower, Vector256<int> upper) =>
            Create<int>(lower, upper);

        /// <summary>Creates a new <see cref="Vector512{Int64}" /> instance from two <see
        // cref="Vector256{Int64}" /> instances.</summary>
        /// <param name="lower">The value that the lower 256-bits will be initialized to.</param>
        /// <param name="upper">The value that the upper 256-bits will be initialized to.</param>
        /// <returns>A new <see cref="Vector512{Int64}" /> initialized from <paramref name="lower" /> and
        // <paramref name="upper" />.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vector512<long> Create(Vector256<long> lower, Vector256<long> upper) =>
            Create<long>(lower, upper);

        /// <summary>Creates a new <see cref="Vector512{IntPtr}" /> instance from two <see
        // cref="Vector256{IntPtr}" /> instances.</summary>
        /// <param name="lower">The value that the lower 256-bits will be initialized to.</param>
        /// <param name="upper">The value that the upper 256-bits will be initialized to.</param>
        /// <returns>A new <see cref="Vector512{IntPtr}" /> initialized from <paramref name="lower" /> and
        // <paramref name="upper" />.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vector512<nint> Create(Vector256<nint> lower, Vector256<nint> upper) =>
            Create<nint>(lower, upper);

        /// <summary>Creates a new <see cref="Vector512{UIntPtr}" /> instance from two <see
        // cref="Vector256{UIntPtr}" /> instances.</summary>
        /// <param name="lower">The value that the lower 256-bits will be initialized to.</param>
        /// <param name="upper">The value that the upper 256-bits will be initialized to.</param>
        /// <returns>A new <see cref="Vector512{UIntPtr}" /> initialized from <paramref name="lower" /> and
        // <paramref name="upper" />.</returns>
        [CLSCompliant(false)]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>Creates a new <see cref="Vector512{SByte}" /> instance from two <see
        // cref="Vector256{SByte}" /> instances.</summary>
        /// <param name="lower">The value that the lower 256-bits will be initialized to.</param>
        /// <param name="upper">The value that the upper 256-bits will be initialized to.</param>
        /// <returns>A new <see cref="Vector512{SByte}" /> initialized from <paramref name="lower" /> and
        // <paramref name="upper" />.</returns>
        [CLSCompliant(false)]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>Creates a new <see cref="Vector512{Single}" /> instance from two <see
        // cref="Vector256{Single}" /> instances.</summary>
        /// <param name="lower">The value that the lower 256-bits will be initialized to.</param>
        /// <param name="upper">The value that the upper 256-bits will be initialized to.</param>
        /// <returns>A new <see cref="Vector512{Single}" /> initialized from <paramref name="lower" /> and
        // <paramref name="upper" />.</returns>
        /// <remarks>On x86, this method corresponds to __m512 _mm512_setr_m256 (__m256 lo, __m256
        // hi)</remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vector512<float> Create(Vector256<float> lower, Vector256<float> upper) =>
            Create<float>(lower, upper);

        /// <summary>Creates a new <see cref="Vector512{UInt16}" /> instance from two <see
        // cref="Vector256{UInt16}" /> instances.</summary>
        /// <param name="lower">The value that the lower 256-bits will be initialized to.</param>
        /// <param name="upper">The value that the upper 256-bits will be initialized to.</param>
        /// <returns>A new <see cref="Vector512{UInt16}" /> initialized from <paramref name="lower" /> and
        // <paramref name="upper" />.</returns>
        [CLSCompliant(false)]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>Creates a new <see cref="Vector512{UInt32}" /> instance from two <see
        // cref="Vector256{UInt32}" /> instances.</summary>
        /// <param name="lower">The value that the lower 256-bits will be initialized to.</param>
        /// <param name="upper">The value that the upper 256-bits will be initialized to.</param>
        /// <returns>A new <see cref="Vector512{UInt32}" /> initialized from <paramref name="lower" /> and
        // <paramref name="upper" />.</returns>
        /// <remarks>On x86, this method corresponds to __m512i _mm512_setr_m256i (__m256i lo, __m256i
        // hi)</remarks>
        [CLSCompliant(false)]
        ...
        /// <summary>Creates a new <see cref="Vector512{UInt64}" /> instance from two <see
        // cref="Vector256{UInt64}" /> instances.</summary>
        /// <param name="lower">The value that the lower 256-bits will be initialized to.</param>
        /// <param name="upper">The value that the upper 256-bits will be initialized to.</param>
        /// <returns>A new <see cref="Vector512{UInt64}" /> initialized from <paramref name="lower" /> and
        // <paramref name="upper" />.</returns>
        [CLSCompliant(false)]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>Creates a new <see cref="Vector512{T}" /> instance with the first element initialized
        // to the specified value and the remaining elements initialized to zero.</summary>
        /// <typeparam name="T">The type of the elements in the vector.</typeparam>
        /// <param name="value">The value that element 0 will be initialized to.</param>
        /// <returns>A new <see cref="Vector512{T}" /> instance with the first element initialized to
        // <paramref name="value" /> and the remaining elements initialized to zero.</returns>
        /// <exception cref="NotSupportedException">The type of <paramref name="value" /> (<typeparamref
        // name="T" />) is not supported.</exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>Creates a new <see cref="Vector512{Byte}" /> instance with the first element
        // initialized to the specified value and the remaining elements initialized to zero.</summary>
        /// <param name="value">The value that element 0 will be initialized to.</param>
        /// <returns>A new <see cref="Vector512{Byte}" /> instance with the first element initialized to
        // <paramref name="value" /> and the remaining elements initialized to zero.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vector512<byte> CreateScalar(byte value) => CreateScalar<byte>(value);

        /// <summary>Creates a new <see cref="Vector512{Double}" /> instance with the first element
        // initialized to the specified value and the remaining elements initialized to zero.</summary>
        /// <param name="value">The value that element 0 will be initialized to.</param>
        /// <returns>A new <see cref="Vector512{Double}" /> instance with the first element initialized to
        // <paramref name="value" /> and the remaining elements initialized to zero.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vector512<double> CreateScalar(double value) => CreateScalar<double>(value);

        /// <summary>Creates a new <see cref="Vector512{Int16}" /> instance with the first element
        // initialized to the specified value and the remaining elements initialized to zero.</summary>
        /// <param name="value">The value that element 0 will be initialized to.</param>
        /// <returns>A new <see cref="Vector512{Int16}" /> instance with the first element initialized to
        // <paramref name="value" /> and the remaining elements initialized to zero.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vector512<short> CreateScalar(short value) => CreateScalar<short>(value);

        /// <summary>Creates a new <see cref="Vector512{Int32}" /> instance with the first element
        // initialized to the specified value and the remaining elements initialized to zero.</summary>
        /// <param name="value">The value that element 0 will be initialized to.</param>
        /// <returns>A new <see cref="Vector512{Int32}" /> instance with the first element initialized to
        // <paramref name="value" /> and the remaining elements initialized to zero.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vector512<int> CreateScalar(int value) => CreateScalar<int>(value);

        /// <summary>Creates a new <see cref="Vector512{Int64}" /> instance with the first element
        // initialized to the specified value and the remaining elements initialized to zero.</summary>
        /// <param name="value">The value that element 0 will be initialized to.</param>
        /// <returns>A new <see cref="Vector512{Int64}" /> instance with the first element initialized to
        // <paramref name="value" /> and the remaining elements initialized to zero.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vector512<long> CreateScalar(long value) => CreateScalar<long>(value);

        /// <summary>Creates a new <see cref="Vector512{IntPtr}" /> instance with the first element
        // initialized to the specified value and the remaining elements initialized to zero.</summary>
        /// <param name="value">The value that element 0 will be initialized to.</param>
        /// <returns>A new <see cref="Vector512{IntPtr}" /> instance with the first element initialized to
        // <paramref name="value"/> and the remaining elements initialized to zero.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vector512<nint> CreateScalar(nint value) => CreateScalar<nint>(value);

        /// <summary>Creates a new <see cref="Vector512{UIntPtr}" /> instance with the first element
        // initialized to the specified value and the remaining elements initialized to zero.</summary>
        /// <param name="value">The value that element 0 will be initialized to.</param>
        /// <returns>A new <see cref="Vector512{UIntPtr}" /> instance with the first element initialized to
        // <paramref name="value"/> and the remaining elements initialized to zero.</returns>
        [CLSCompliant(false)]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vector512<nuint> CreateScalar(nuint value) => CreateScalar<nuint>(value);

        /// <summary>Creates a new <see cref="Vector512{SByte}" /> instance with the first element
        // initialized to the specified value and the remaining elements initialized to zero.</summary>
        /// <param name="value">The value that element 0 will be initialized to.</param>
        /// <returns>A new <see cref="Vector512{SByte}" /> instance with the first element initialized to
        // <paramref name="value" /> and the remaining elements initialized to zero.</returns>
        [CLSCompliant(false)]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vector512<sbyte> CreateScalar(sbyte value) => CreateScalar<sbyte>(value);

        /// <summary>Creates a new <see cref="Vector512{Single}" /> instance with the first element
        // initialized to the specified value and the remaining elements initialized to zero.</summary>
        /// <param name="value">The value that element 0 will be initialized to.</param>
        /// <returns>A new <see cref="Vector512{Single}" /> instance with the first element initialized to
        // <paramref name="value" /> and the remaining elements initialized to zero.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vector512<float> CreateScalar(float value) => CreateScalar<float>(value);

        /// <summary>Creates a new <see cref="Vector512{UInt16}" /> instance with the first element
        // initialized to the specified value and the remaining elements initialized to zero.</summary>
        /// <param name="value">The value that element 0 will be initialized to.</param>
        /// <returns>A new <see cref="Vector512{UInt16}" /> instance with the first element initialized to
        // <paramref name="value" /> and the remaining elements initialized to zero.</returns>
        [CLSCompliant(false)]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vector512<ushort> CreateScalar(ushort value) => CreateScalar<ushort>(value);

        /// <summary>Creates a new <see cref="Vector512{UInt32}" /> instance with the first element
        // initialized to the specified value and the remaining elements initialized to zero.</summary>
        /// <param name="value">The value that element 0 will be initialized to.</param>
        /// <returns>A new <see cref="Vector512{UInt32}" /> instance with the first element initialized to
        // <paramref name="value" /> and the remaining elements initialized to zero.</returns>
        [CLSCompliant(false)]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vector512<uint> CreateScalar(uint value) => CreateScalar<uint>(value);

        /// <summary>Creates a new <see cref="Vector512{UInt64}" /> instance with the first element
        // initialized to the specified value and the remaining elements initialized to zero.</summary>
        /// <param name="value">The value that element 0 will be initialized to.</param>
        /// <returns>A new <see cref="Vector512{UInt64}" /> instance with the first element initialized to
        // <paramref name="value" /> and the remaining elements initialized to zero.</returns>
        [CLSCompliant(false)]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>Creates a new <see cref="Vector512{T}" /> instance with the first element initialized
        // to the specified value and the remaining elements left uninitialized.</summary>
        /// <typeparam name="T">The type of the elements in the vector.</typeparam>
        /// <param name="value">The value that element 0 will be initialized to.</param>
        /// <returns>A new <see cref="Vector512{T}" /> instance with the first element initialized to
        // <paramref name="value" /> and the remaining elements left uninitialized.</returns>
        /// <exception cref="NotSupportedException">The type of <paramref name="value" /> (<typeparamref
        // name="T" />) is not supported.</exception>
        [Intrinsic]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <returns>A vector whose elements are all-bits-set or zero, depending on if the corresponding
        // elements in <paramref name="left" /> and <paramref name="right" /> were equal.</returns>
        /// <exception cref="NotSupportedException">The type of <paramref name="left" /> and <paramref
        // name="right" /> (<typeparamref name="T" />) is not supported.</exception>
        [Intrinsic]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <param name="right">The vector to compare with <paramref name="left" />.</param>
        /// <typeparam name="T">The type of the elements in the vector.</typeparam>
        /// <returns><c>true</c> if any elements in <paramref name="left" /> was equal to the corresponding
        // element in <paramref name="right" />.</returns>
        /// <exception cref="NotSupportedException">The type of <paramref name="left" /> and <paramref
        // name="right" /> (<typeparamref name="T" />) is not supported.</exception>
        [Intrinsic]
        ...
        /// <param name="vector">The vector whose elements should have their most significant bit
        // extracted.</param>
        /// <typeparam name="T">The type of the elements in the vector.</typeparam>
        /// <returns>The packed most significant bits extracted from the elements in <paramref name="vector"
        // />.</returns>
        /// <exception cref="NotSupportedException">The type of <paramref name="vector" /> (<typeparamref
        // name="T" />) is not supported.</exception>
        [Intrinsic]
        ...
        /// <returns>A vector whose elements are the floor of the elements in <paramref name="vector"
        // />.</returns>
        [Intrinsic]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <returns>A vector whose elements are all-bits-set or zero, depending on if which of the
        // corresponding elements in <paramref name="left" /> and <paramref name="right" /> were
        // greater.</returns>
        /// <exception cref="NotSupportedException">The type of <paramref name="left" /> and <paramref
        // name="right" /> (<typeparamref name="T" />) is not supported.</exception>
        [Intrinsic]
        ...
        /// <param name="left">The vector to compare with <paramref name="right" />.</param>
        /// <param name="right">The vector to compare with <paramref name="left" />.</param>
        /// <returns><c>true</c> if all elements in <paramref name="left" /> were greater than the
        ...
        /// <param name="left">The vector to compare with <paramref name="right" />.</param>
        /// <param name="right">The vector to compare with <paramref name="left" />.</param>
        /// <returns><c>true</c> if any elements in <paramref name="left" /> was greater than the
        // corresponding element in <paramref name="right" />.</returns>
        /// <exception cref="NotSupportedException">The type of <paramref name="left" /> and <paramref
        // name="right" /> (<typeparamref name="T" />) is not supported.</exception>
        [Intrinsic]
        ...
        /// <summary>Compares two vectors to determine which is greater or equal on a per-element
        // basis.</summary>
        /// <typeparam name="T">The type of the elements in the vector.</typeparam>
        /// <param name="left">The vector to compare with <paramref name="left" />.</param>
        /// <param name="right">The vector to compare with <paramref name="right" />.</param>
        /// <returns>A vector whose elements are all-bits-set or zero, depending on if which of the
        // corresponding elements in <paramref name="left" /> and <paramref name="right" /> were greater or
        // equal.</returns>
        /// <exception cref="NotSupportedException">The type of <paramref name="left" /> and <paramref
        // name="right" /> (<typeparamref name="T" />) is not supported.</exception>
        [Intrinsic]
        ...
        /// <param name="left">The vector to compare with <paramref name="right" />.</param>
        /// <param name="right">The vector to compare with <paramref name="left" />.</param>
        /// <returns><c>true</c> if all elements in <paramref name="left" /> were greater than or equal to
        // the corresponding element in <paramref name="right" />.</returns>
        /// <exception cref="NotSupportedException">The type of <paramref name="left" /> and <paramref
        // name="right" /> (<typeparamref name="T" />) is not supported.</exception>
        [Intrinsic]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <param name="left">The vector to compare with <paramref name="right" />.</param>
        /// <param name="right">The vector to compare with <paramref name="left" />.</param>
        /// <returns><c>true</c> if any elements in <paramref name="left" /> was greater than or equal to
        // the corresponding element in <paramref name="right" />.</returns>
        /// <exception cref="NotSupportedException">The type of <paramref name="left" /> and <paramref
        // name="right" /> (<typeparamref name="T" />) is not supported.</exception>
        [Intrinsic]
        ...
        /// <param name="left">The vector to compare with <paramref name="right" />.</param>
        /// <param name="right">The vector to compare with <paramref name="left" />.</param>
        /// <returns><c>true</c> if all elements in <paramref name="left" /> were less than the
        // corresponding element in <paramref name="right" />.</returns>
        /// <exception cref="NotSupportedException">The type of <paramref name="left" /> and <paramref
        // name="right" /> (<typeparamref name="T" />) is not supported.</exception>
        [Intrinsic]
        ...
        /// <param name="left">The vector to compare with <paramref name="right" />.</param>
        /// <param name="right">The vector to compare with <paramref name="left" />.</param>
        /// <returns><c>true</c> if any elements in <paramref name="left" /> was less than the corresponding
        // element in <paramref name="right" />.</returns>
        /// <exception cref="NotSupportedException">The type of <paramref name="left" /> and <paramref
        // name="right" /> (<typeparamref name="T" />) is not supported.</exception>
        [Intrinsic]
        ...
        /// <summary>Compares two vectors to determine which is less or equal on a per-element
        // basis.</summary>
        /// <typeparam name="T">The type of the elements in the vector.</typeparam>
        /// <param name="left">The vector to compare with <paramref name="left" />.</param>
        /// <param name="right">The vector to compare with <paramref name="right" />.</param>
        /// <returns>A vector whose elements are all-bits-set or zero, depending on if which of the
        // corresponding elements in <paramref name="left" /> and <paramref name="right" /> were less or
        // equal.</returns>
        /// <exception cref="NotSupportedException">The type of <paramref name="left" /> and <paramref
        // name="right" /> (<typeparamref name="T" />) is not supported.</exception>
        [Intrinsic]
        ...
        /// <param name="left">The vector to compare with <paramref name="right" />.</param>
        /// <param name="right">The vector to compare with <paramref name="left" />.</param>
        /// <returns><c>true</c> if all elements in <paramref name="left" /> were less than or equal to the
        // corresponding element in <paramref name="right" />.</returns>
        /// <exception cref="NotSupportedException">The type of <paramref name="left" /> and <paramref
        // name="right" /> (<typeparamref name="T" />) is not supported.</exception>
        [Intrinsic]
        ...
        /// <param name="left">The vector to compare with <paramref name="right" />.</param>
        /// <param name="right">The vector to compare with <paramref name="left" />.</param>
        /// <returns><c>true</c> if any elements in <paramref name="left" /> was less than or equal to the
        // corresponding element in <paramref name="right" />.</returns>
        /// <exception cref="NotSupportedException">The type of <paramref name="left" /> and <paramref
        // name="right" /> (<typeparamref name="T" />) is not supported.</exception>
        [Intrinsic]
...
#pragma warning disable CS8500 // This takes the address of, gets the size of, or declares a pointer to a managed type ('T')
        ...
        /// <exception cref="NotSupportedException">The type of <paramref name="source" /> (<typeparamref
        // name="T" />) is not supported.</exception>
        [Intrinsic]
        [CLSCompliant(false)]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
...
#pragma warning restore CS8500 // This takes the address of, gets the size of, or declares a pointer to a managed type ('T')
        ...
        /// <typeparam name="T">The type of the elements in the vector.</typeparam>
        /// <param name="source">The source to which <paramref name="elementOffset" /> will be added before
        // loading the vector.</param>
        /// <param name="elementOffset">The element offset from <paramref name="source" /> from which the
        // vector will be loaded.</param>
        /// <returns>The vector loaded from <paramref name="source" /> plus <paramref name="elementOffset"
        // />.</returns>
        /// <exception cref="NotSupportedException">The type of <paramref name="source" /> (<typeparamref
        // name="T" />) is not supported.</exception>
        [Intrinsic]
        ...
        /// <summary>Loads a vector from the given source and reinterprets it as <see
        // cref="ushort"/>.</summary>
        /// <param name="source">The source from which the vector will be loaded.</param>
        /// <returns>The vector loaded from <paramref name="source" />.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>Loads a vector from the given source and element offset and reinterprets it as <see
        // cref="ushort"/>.</summary>
        /// <param name="source">The source to which <paramref name="elementOffset" /> will be added before
        // loading the vector.</param>
        /// <param name="elementOffset">The element offset from <paramref name="source" /> from which the
        ...
        /// <param name="left">The vector to compare with <paramref name="right" />.</param>
        /// <param name="right">The vector to compare with <paramref name="left" />.</param>
        /// <returns>A vector whose elements are the maximum of the corresponding elements in <paramref
        // name="left" /> and <paramref name="right" />.</returns>
        /// <exception cref="NotSupportedException">The type of <paramref name="left" /> and <paramref
        // name="right" /> (<typeparamref name="T" />) is not supported.</exception>
        [Intrinsic]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <param name="left">The vector to compare with <paramref name="right" />.</param>
        /// <param name="right">The vector to compare with <paramref name="left" />.</param>
        /// <returns>A vector whose elements are the minimum of the corresponding elements in <paramref
        // name="left" /> and <paramref name="right" />.</returns>
        /// <exception cref="NotSupportedException">The type of <paramref name="left" /> and <paramref
        // name="right" /> (<typeparamref name="T" />) is not supported.</exception>
        [Intrinsic]
        ...
        /// <summary>Narrows two <see cref="Vector512{Double}"/> instances into one <see
        // cref="Vector512{Single}" />.</summary>
        /// <param name="lower">The vector that will be narrowed to the lower half of the result
        // vector.</param>
        /// <param name="upper">The vector that will be narrowed to the upper half of the result
        // vector.</param>
        /// <returns>A <see cref="Vector512{Single}"/> containing elements narrowed from <paramref
        // name="lower" /> and <paramref name="upper" />.</returns>
        [Intrinsic]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>Narrows two <see cref="Vector512{Int16}"/> instances into one <see
        // cref="Vector512{SByte}" />.</summary>
        /// <param name="lower">The vector that will be narrowed to the lower half of the result
        // vector.</param>
        /// <param name="upper">The vector that will be narrowed to the upper half of the result
        // vector.</param>
        /// <returns>A <see cref="Vector512{SByte}"/> containing elements narrowed from <paramref
        // name="lower" /> and <paramref name="upper" />.</returns>
        [Intrinsic]
        [CLSCompliant(false)]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>Narrows two <see cref="Vector512{Int32}"/> instances into one <see
        // cref="Vector512{Int16}" />.</summary>
        /// <param name="lower">The vector that will be narrowed to the lower half of the result
        // vector.</param>
        /// <param name="upper">The vector that will be narrowed to the upper half of the result
        // vector.</param>
        /// <returns>A <see cref="Vector512{Int16}"/> containing elements narrowed from <paramref
        // name="lower" /> and <paramref name="upper" />.</returns>
        [Intrinsic]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>Narrows two <see cref="Vector512{Int64}"/> instances into one <see
        // cref="Vector512{Int32}" />.</summary>
        /// <param name="lower">The vector that will be narrowed to the lower half of the result
        // vector.</param>
        /// <param name="upper">The vector that will be narrowed to the upper half of the result
        // vector.</param>
        /// <returns>A <see cref="Vector512{Int32}"/> containing elements narrowed from <paramref
        // name="lower" /> and <paramref name="upper" />.</returns>
        [Intrinsic]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>Narrows two <see cref="Vector512{UInt16}"/> instances into one <see
        // cref="Vector512{Byte}" />.</summary>
        /// <param name="lower">The vector that will be narrowed to the lower half of the result
        // vector.</param>
        /// <param name="upper">The vector that will be narrowed to the upper half of the result
        // vector.</param>
        /// <returns>A <see cref="Vector512{Byte}"/> containing elements narrowed from <paramref
        // name="lower" /> and <paramref name="upper" />.</returns>
        [Intrinsic]
        [CLSCompliant(false)]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>Narrows two <see cref="Vector512{UInt32}"/> instances into one <see
        // cref="Vector512{UInt16}" />.</summary>
        /// <param name="lower">The vector that will be narrowed to the lower half of the result
        // vector.</param>
        /// <param name="upper">The vector that will be narrowed to the upper half of the result
        // vector.</param>
        /// <returns>A <see cref="Vector512{UInt16}"/> containing elements narrowed from <paramref
        // name="lower" /> and <paramref name="upper" />.</returns>
        [Intrinsic]
        [CLSCompliant(false)]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>Narrows two <see cref="Vector512{UInt64}"/> instances into one <see
        // cref="Vector512{UInt32}" />.</summary>
        /// <param name="lower">The vector that will be narrowed to the lower half of the result
        // vector.</param>
        /// <param name="upper">The vector that will be narrowed to the upper half of the result
        // vector.</param>
        /// <returns>A <see cref="Vector512{UInt32}"/> containing elements narrowed from <paramref
        // name="lower" /> and <paramref name="upper" />.</returns>
        [Intrinsic]
        [CLSCompliant(false)]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <returns>A vector whose elements are the negation of the corresponding elements in <paramref
        // name="vector" />.</returns>
        /// <exception cref="NotSupportedException">The type of <paramref name="vector" /> (<typeparamref
        // name="T" />) is not supported.</exception>
        [Intrinsic]
        ...
        /// <summary>Creates a new vector by selecting values from an input vector using a set of
        // indices.</summary>
        /// <param name="vector">The input vector from which values are selected.</param>
        /// <param name="indices">The per-element indices used to select a value from <paramref
        // name="vector" />.</param>
        /// <returns>A new vector containing the values from <paramref name="vector" /> selected by the
        // given <paramref name="indices" />.</returns>
        [Intrinsic]
        ...
        /// <returns>A vector whose elements are the square root of the corresponding elements in <paramref
        // name="vector" />.</returns>
        /// <exception cref="NotSupportedException">The type of <paramref name="vector" /> (<typeparamref
        // name="T" />) is not supported.</exception>
        [Intrinsic]
...
#pragma warning disable CS8500 // This takes the address of, gets the size of, or declares a pointer to a managed type ('T')
        ...
        /// <param name="destination">The destination at which <paramref name="source" /> will be
        // stored.</param>
        /// <exception cref="NotSupportedException">The type of <paramref name="source" /> and <paramref
        // name="destination" /> (<typeparamref name="T" />) is not supported.</exception>
        [Intrinsic]
        [CLSCompliant(false)]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <typeparam name="T">The type of the elements in the vector.</typeparam>
        /// <param name="source">The vector that will be stored.</param>
        /// <param name="destination">The aligned destination at which <paramref name="source" /> will be
        // stored.</param>
        /// <exception cref="NotSupportedException">The type of <paramref name="source" /> and <paramref
        // name="destination" /> (<typeparamref name="T" />) is not supported.</exception>
        [Intrinsic]
...
#pragma warning restore CS8500 // This takes the address of, gets the size of, or declares a pointer to a managed type ('T')
        ...
        /// <typeparam name="T">The type of the elements in the vector.</typeparam>
        /// <param name="source">The vector that will be stored.</param>
        /// <param name="destination">The destination to which <paramref name="elementOffset" /> will be
        // added before the vector will be stored.</param>
        /// <param name="elementOffset">The element offset from <paramref name="destination" /> from which
        // the vector will be stored.</param>
        /// <exception cref="NotSupportedException">The type of <paramref name="source" /> and <paramref
        // name="destination" /> (<typeparamref name="T" />) is not supported.</exception>
        [Intrinsic]
        [CLSCompliant(false)]
        ...
        /// <summary>Converts the given vector to a scalar containing the value of the first
        // element.</summary>
        /// <typeparam name="T">The type of the input vector.</typeparam>
        ...
        /// <returns><c>true</c> if <paramref name="vector" /> was successfully copied to <paramref
        // name="destination" />; otherwise, <c>false</c> if the length of <paramref name="destination" />
        // is
        // less than <see cref="Vector512{T}.Count" />.</returns>
        /// <exception cref="NotSupportedException">The type of <paramref name="vector" /> and <paramref
        // name="destination" /> (<typeparamref name="T" />) is not supported.</exception>
        ...
        /// <summary>Widens a <see cref="Vector512{Byte}" /> into two <see cref="Vector512{UInt16} "
        // />.</summary>
        /// <param name="source">The vector whose elements are to be widened.</param>
        /// <returns>A pair of vectors that contain the widened lower and upper halves of <paramref
        // name="source" />.</returns>
        [CLSCompliant(false)]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>Widens a <see cref="Vector512{Int16}" /> into two <see cref="Vector512{Int32} "
        // />.</summary>
        /// <param name="source">The vector whose elements are to be widened.</param>
        /// <returns>A pair of vectors that contain the widened lower and upper halves of <paramref
        // name="source" />.</returns>
        ...
        /// <summary>Widens a <see cref="Vector512{Int32}" /> into two <see cref="Vector512{Int64} "
        // />.</summary>
        /// <param name="source">The vector whose elements are to be widened.</param>
        /// <returns>A pair of vectors that contain the widened lower and upper halves of <paramref
        // name="source" />.</returns>
        ...
        /// <summary>Widens a <see cref="Vector512{SByte}" /> into two <see cref="Vector512{Int16} "
        // />.</summary>
        /// <param name="source">The vector whose elements are to be widened.</param>
        /// <returns>A pair of vectors that contain the widened lower and upper halves of <paramref
        // name="source" />.</returns>
        ...
        /// <summary>Widens a <see cref="Vector512{Single}" /> into two <see cref="Vector512{Double} "
        // />.</summary>
        /// <param name="source">The vector whose elements are to be widened.</param>
        /// <returns>A pair of vectors that contain the widened lower and upper halves of <paramref
        // name="source" />.</returns>
        ...
        /// <summary>Widens a <see cref="Vector512{UInt16}" /> into two <see cref="Vector512{UInt32} "
        // />.</summary>
        /// <param name="source">The vector whose elements are to be widened.</param>
        /// <returns>A pair of vectors that contain the widened lower and upper halves of <paramref
        // name="source" />.</returns>
        ...
        /// <summary>Widens a <see cref="Vector512{UInt32}" /> into two <see cref="Vector512{UInt64} "
        // />.</summary>
        /// <param name="source">The vector whose elements are to be widened.</param>
        /// <returns>A pair of vectors that contain the widened lower and upper halves of <paramref
        // name="source" />.</returns>
        ...
        /// <summary>Widens the lower half of a <see cref="Vector512{Byte}" /> into a <see
        // cref="Vector512{UInt16} " />.</summary>
        /// <param name="source">The vector whose elements are to be widened.</param>
        ...
        /// <summary>Widens the lower half of a <see cref="Vector512{Int16}" /> into a <see
        // cref="Vector512{Int32} " />.</summary>
        /// <param name="source">The vector whose elements are to be widened.</param>
        /// <returns>A vector that contain the widened lower half of <paramref name="source" />.</returns>
        [Intrinsic]
        ...
        /// <summary>Widens the lower half of a <see cref="Vector512{Int32}" /> into a <see
        // cref="Vector512{Int64} " />.</summary>
        /// <param name="source">The vector whose elements are to be widened.</param>
        /// <returns>A vector that contain the widened lower half of <paramref name="source" />.</returns>
        [Intrinsic]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>Widens the lower half of a <see cref="Vector512{SByte}" /> into a <see
        // cref="Vector512{Int16} " />.</summary>
        /// <param name="source">The vector whose elements are to be widened.</param>
        /// <returns>A vector that contain the widened lower half of <paramref name="source" />.</returns>
        [Intrinsic]
        ...
        /// <summary>Widens the lower half of a <see cref="Vector512{Single}" /> into a <see
        // cref="Vector512{Double} " />.</summary>
        /// <param name="source">The vector whose elements are to be widened.</param>
        /// <returns>A vector that contain the widened lower half of <paramref name="source" />.</returns>
        [Intrinsic]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>Widens the lower half of a <see cref="Vector512{UInt16}" /> into a <see
        // cref="Vector512{UInt32} " />.</summary>
        /// <param name="source">The vector whose elements are to be widened.</param>
        /// <returns>A vector that contain the widened lower half of <paramref name="source" />.</returns>
        [Intrinsic]
        ...
        /// <summary>Widens the lower half of a <see cref="Vector512{UInt32}" /> into a <see
        // cref="Vector512{UInt64} " />.</summary>
        /// <param name="source">The vector whose elements are to be widened.</param>
        /// <returns>A vector that contain the widened lower half of <paramref name="source" />.</returns>
        [Intrinsic]
        [CLSCompliant(false)]
        ...
        /// <summary>Widens the upper half of a <see cref="Vector512{Byte}" /> into a <see
        // cref="Vector512{UInt16} " />.</summary>
        /// <param name="source">The vector whose elements are to be widened.</param>
        ...
        /// <summary>Widens the upper half of a <see cref="Vector512{Int16}" /> into a <see
        // cref="Vector512{Int32} " />.</summary>
        /// <param name="source">The vector whose elements are to be widened.</param>
        /// <returns>A vector that contain the widened upper half of <paramref name="source" />.</returns>
        [Intrinsic]
        ...
        /// <summary>Widens the upper half of a <see cref="Vector512{Int32}" /> into a <see
        // cref="Vector512{Int64} " />.</summary>
        /// <param name="source">The vector whose elements are to be widened.</param>
        /// <returns>A vector that contain the widened upper half of <paramref name="source" />.</returns>
        [Intrinsic]
        ...
        /// <summary>Widens the upper half of a <see cref="Vector512{SByte}" /> into a <see
        // cref="Vector512{Int16} " />.</summary>
        /// <param name="source">The vector whose elements are to be widened.</param>
        /// <returns>A vector that contain the widened upper half of <paramref name="source" />.</returns>
        [Intrinsic]
        ...
        /// <summary>Widens the upper half of a <see cref="Vector512{Single}" /> into a <see
        // cref="Vector512{Double} " />.</summary>
        /// <param name="source">The vector whose elements are to be widened.</param>
        /// <returns>A vector that contain the widened upper half of <paramref name="source" />.</returns>
        [Intrinsic]
        ...
        /// <summary>Widens the upper half of a <see cref="Vector512{UInt16}" /> into a <see
        // cref="Vector512{UInt32} " />.</summary>
        /// <param name="source">The vector whose elements are to be widened.</param>
        /// <returns>A vector that contain the widened upper half of <paramref name="source" />.</returns>
        [Intrinsic]
        ...
        /// <summary>Widens the upper half of a <see cref="Vector512{UInt32}" /> into a <see
        // cref="Vector512{UInt64} " />.</summary>
        /// <param name="source">The vector whose elements are to be widened.</param>
        /// <returns>A vector that contain the widened upper half of <paramref name="source" />.</returns>
        [Intrinsic]
        ...
        /// <summary>Creates a new <see cref="Vector512{T}" /> with the element at the specified index set
        // to the specified value and the remaining elements set to the same value as that in the given
        // vector.</summary>
        /// <typeparam name="T">The type of the input vector.</typeparam>
        /// <param name="vector">The vector to get the remaining elements from.</param>
        /// <param name="index">The index of the element to set.</param>
        /// <param name="value">The value to set the element to.</param>
        /// <returns>A <see cref="Vector512{T}" /> with the value of the element at <paramref name="index"
        // /> set to <paramref name="value" /> and the remaining elements set to the same value as that in
        // <paramref name="vector" />.</returns>
        /// <exception cref="ArgumentOutOfRangeException"><paramref name="index" /> was less than zero or
        // greater than the number of elements.</exception>
        /// <exception cref="NotSupportedException">The type of <paramref name="vector" /> (<typeparamref
        ...
        /// <summary>Creates a new <see cref="Vector512{T}" /> with the lower 256-bits set to the specified
        // value and the upper 256-bits set to the same value as that in the given vector.</summary>
        /// <typeparam name="T">The type of the input vector.</typeparam>
        /// <param name="vector">The vector to get the upper 256-bits from.</param>
        /// <param name="value">The value of the lower 256-bits as a <see cref="Vector256{T}" />.</param>
        /// <returns>A new <see cref="Vector512{T}" /> with the lower 256-bits set to <paramref name="value"
        // /> and the upper 256-bits set to the same value as that in <paramref name="vector" />.</returns>
        /// <exception cref="NotSupportedException">The type of <paramref name="vector" /> (<typeparamref
        // name="T" />) is not supported.</exception>
        [Intrinsic]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>Creates a new <see cref="Vector512{T}" /> with the upper 256-bits set to the specified
        // value and the lower 256-bits set to the same value as that in the given vector.</summary>
        /// <typeparam name="T">The type of the input vector.</typeparam>
        /// <param name="vector">The vector to get the lower 256-bits from.</param>
        /// <param name="value">The value of the upper 256-bits as a <see cref="Vector256{T}" />.</param>
        /// <returns>A new <see cref="Vector512{T}" /> with the upper 256-bits set to <paramref name="value"
        // /> and the lower 256-bits set to the same value as that in <paramref name="vector" />.</returns>
        /// <exception cref="NotSupportedException">The type of <paramref name="vector" /> (<typeparamref
        // name="T" />) is not supported.</exception>
        [Intrinsic]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
