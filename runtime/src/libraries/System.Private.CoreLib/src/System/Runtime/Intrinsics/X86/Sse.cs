    ...
    public abstract class Sse : X86Base
    {
        ...
        public new abstract class X64 : X86Base.X64
        {
            ...
            public static long ConvertToInt64WithTruncation(Vector128<float> value) =>
                ConvertToInt64WithTruncation(value);
        }
        ...
        /// </summary>
        public static Vector128<float> CompareEqual(
        ...
        public static bool CompareScalarOrderedEqual(
            Vector128<float> left,
            Vector128<float> right
        ) => CompareScalarOrderedEqual(left, right);
        ...
        public static bool CompareScalarUnorderedEqual(
            Vector128<float> left,
            Vector128<float> right
        ) => CompareScalarUnorderedEqual(left, right);
        ...
        public static bool CompareScalarOrderedGreaterThan(
            Vector128<float> left,
            Vector128<float> right
        ) => CompareScalarOrderedGreaterThan(left, right);
        ...
        public static bool CompareScalarUnorderedGreaterThan(
            Vector128<float> left,
            Vector128<float> right
        ) => CompareScalarUnorderedGreaterThan(left, right);
        ...
        public static Vector128<float> CompareScalarGreaterThan(
            Vector128<float> left,
            Vector128<float> right
        ) => CompareScalarGreaterThan(left, right);
        ...
        public static bool CompareScalarOrderedGreaterThanOrEqual(
            Vector128<float> left,
            Vector128<float> right
        ) => CompareScalarOrderedGreaterThanOrEqual(left, right);
        ...
        public static bool CompareScalarUnorderedGreaterThanOrEqual(
            Vector128<float> left,
            Vector128<float> right
        ) => CompareScalarUnorderedGreaterThanOrEqual(left, right);
        ...
        public static Vector128<float> CompareScalarGreaterThanOrEqual(
            Vector128<float> left,
            Vector128<float> right
        ) => CompareScalarGreaterThanOrEqual(left, right);
        ...
        public static bool CompareScalarOrderedLessThan(
            Vector128<float> left,
            Vector128<float> right
        ) => CompareScalarOrderedLessThan(left, right);
        ...
        public static bool CompareScalarUnorderedLessThan(
            Vector128<float> left,
            Vector128<float> right
        ) => CompareScalarUnorderedLessThan(left, right);
        ...
        public static Vector128<float> CompareScalarLessThan(
            Vector128<float> left,
            Vector128<float> right
        ) => CompareScalarLessThan(left, right);
        ...
        public static bool CompareScalarOrderedLessThanOrEqual(
            Vector128<float> left,
            Vector128<float> right
        ) => CompareScalarOrderedLessThanOrEqual(left, right);
        ...
        public static bool CompareScalarUnorderedLessThanOrEqual(
            Vector128<float> left,
            Vector128<float> right
        ) => CompareScalarUnorderedLessThanOrEqual(left, right);
        ...
        public static Vector128<float> CompareScalarLessThanOrEqual(
            Vector128<float> left,
            Vector128<float> right
        ) => CompareScalarLessThanOrEqual(left, right);
        ...
        public static bool CompareScalarOrderedNotEqual(
            Vector128<float> left,
            Vector128<float> right
        ) => CompareScalarOrderedNotEqual(left, right);
        ...
        public static bool CompareScalarUnorderedNotEqual(
            Vector128<float> left,
            Vector128<float> right
        ) => CompareScalarUnorderedNotEqual(left, right);
        ...
        public static Vector128<float> CompareScalarNotEqual(
            Vector128<float> left,
            Vector128<float> right
        ) => CompareScalarNotEqual(left, right);
        ...
        public static Vector128<float> CompareNotGreaterThan(
            Vector128<float> left,
            Vector128<float> right
        ) => CompareNotGreaterThan(left, right);
        ...
        public static Vector128<float> CompareScalarNotGreaterThan(
            Vector128<float> left,
            Vector128<float> right
        ) => CompareScalarNotGreaterThan(left, right);
        ...
        public static Vector128<float> CompareNotGreaterThanOrEqual(
            Vector128<float> left,
            Vector128<float> right
        ) => CompareNotGreaterThanOrEqual(left, right);
        ...
        public static Vector128<float> CompareScalarNotGreaterThanOrEqual(
            Vector128<float> left,
            Vector128<float> right
        ) => CompareScalarNotGreaterThanOrEqual(left, right);
        ...
        public static Vector128<float> CompareScalarNotLessThan(
            Vector128<float> left,
            Vector128<float> right
        ) => CompareScalarNotLessThan(left, right);
        ...
        public static Vector128<float> CompareNotLessThanOrEqual(
            Vector128<float> left,
            Vector128<float> right
        ) => CompareNotLessThanOrEqual(left, right);
        ...
        public static Vector128<float> CompareScalarNotLessThanOrEqual(
            Vector128<float> left,
            Vector128<float> right
        ) => CompareScalarNotLessThanOrEqual(left, right);

        /// <summary>
        /// __m128 _mm_cmpord_ps (__m128 a,  __m128 b)
        ///   CMPPS xmm, xmm/m128, imm8(7)
        /// </summary>
        public static Vector128<float> CompareOrdered(
            Vector128<float> left,
            Vector128<float> right
        ...
        public static Vector128<float> CompareScalarOrdered(
            Vector128<float> left,
            Vector128<float> right
        ) => CompareScalarOrdered(left, right);
        ...
        public static Vector128<float> CompareScalarUnordered(
            Vector128<float> left,
            Vector128<float> right
        ) => CompareScalarUnordered(left, right);
        ...
        public static int ConvertToInt32WithTruncation(Vector128<float> value) =>
            ConvertToInt32WithTruncation(value);
        ...
        ///   DIVSS xmm, xmm/m32
        /// </summary>
        public static Vector128<float> DivideScalar(
            Vector128<float> left,
            Vector128<float> right
        ...
        ///   MOVUPS xmm, m128
        /// </summary>
        public static unsafe Vector128<float> LoadVector128(float* address) =>
        ...
        ///   MOVSS xmm, m32
        /// </summary>
        public static unsafe Vector128<float> LoadScalarVector128(float* address) =>
        ...
        ///   MOVAPS xmm, m128
        /// </summary>
        public static unsafe Vector128<float> LoadAlignedVector128(float* address) =>
        ...
        public static unsafe Vector128<float> LoadHigh(Vector128<float> lower, float* address) =>
            LoadHigh(lower, address);

        /// <summary>
        /// __m128 _mm_loadl_pi (__m128 a, __m64 const* mem_addr)
        ///   MOVLPS xmm, m64
        /// </summary>
        public static unsafe Vector128<float> LoadLow(Vector128<float> upper, float* address) =>
            LoadLow(upper, address);
        ...
        public static Vector128<float> MoveScalar(Vector128<float> upper, Vector128<float> value) =>
            MoveScalar(upper, value);

        /// <summary>
        /// __m128 _mm_movehl_ps (__m128 a,  __m128 b)
        ///   MOVHLPS xmm, xmm
        /// </summary>
        public static Vector128<float> MoveHighToLow(
            Vector128<float> left,
            Vector128<float> right
        ) => MoveHighToLow(left, right);

        /// <summary>
        /// __m128 _mm_movelh_ps (__m128 a,  __m128 b)
        ///   MOVLHPS xmm, xmm
        /// </summary>
        public static Vector128<float> MoveLowToHigh(
            Vector128<float> left,
            Vector128<float> right
        ) => MoveLowToHigh(left, right);
        ...
        ///   MULPS xmm, xmm/m32
        /// </summary>
        public static Vector128<float> MultiplyScalar(
            Vector128<float> left,
            Vector128<float> right
        ...
        public static Vector128<float> ReciprocalSqrtScalar(
            Vector128<float> upper,
            Vector128<float> value
        ) => ReciprocalSqrtScalar(upper, value);

        /// <summary>
        /// __m128 _mm_shuffle_ps (__m128 a,  __m128 b, unsigned int control)
        ///   SHUFPS xmm, xmm/m128, imm8
        /// </summary>
        public static Vector128<float> Shuffle(
            Vector128<float> left,
            Vector128<float> right,
            byte control
        ) => Shuffle(left, right, control);
        ...
        ///   MOVUPS m128, xmm
        /// </summary>
        public static unsafe void Store(float* address, Vector128<float> source) =>
        ...
        ///   MOVSS m32, xmm
        /// </summary>
        public static unsafe void StoreScalar(float* address, Vector128<float> source) =>
        ...
        ///   MOVHPS m64, xmm
        /// </summary>
        public static unsafe void StoreHigh(float* address, Vector128<float> source) =>
        ...
        ///   MOVLPS m64, xmm
        /// </summary>
        public static unsafe void StoreLow(float* address, Vector128<float> source) =>
        ...
        ///   SUBSS xmm, xmm/m32
        /// </summary>
        public static Vector128<float> SubtractScalar(
            Vector128<float> left,
            Vector128<float> right
