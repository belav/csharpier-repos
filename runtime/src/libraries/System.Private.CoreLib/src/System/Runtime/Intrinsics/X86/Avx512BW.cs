...
{
    /// <summary>This class provides access to X86 AVX512BW hardware instructions via
    // intrinsics</summary>
    [Intrinsic]
    [CLSCompliant(false)]
    public abstract class Avx512BW : Avx512F
    {
        ...
        public new abstract class VL : Avx512F.VL
        {
            ...
            ) => PermuteVar8x16x2(lower, indices, upper);
            ...
            ) => SumAbsoluteDifferencesInBlock32(left, right, control);
        ...
        /// </summary>
        public static Vector512<ushort> AddSaturate(
        ...
        /// </summary>
        public static Vector512<byte> CompareLessThan(
            Vector512<byte> left,
            Vector512<byte> right
        ) => CompareLessThan(left, right);
        ...
        /// </summary>
        public static Vector512<byte> CompareNotEqual(
            Vector512<byte> left,
            Vector512<byte> right
        ) => CompareNotEqual(left, right);
        ...
        /// </summary>
        public static Vector512<short> CompareEqual(
            Vector512<short> left,
            Vector512<short> right
        ) => CompareEqual(left, right);
        ...
        ///   VPCMPEQB k1 {k2}, zmm2, zmm3/m512
        /// </summary>
        public static Vector512<sbyte> CompareEqual(
            Vector512<sbyte> left,
            Vector512<sbyte> right
        ) => CompareEqual(left, right);
        ...
        /// </summary>
        public static Vector256<byte> ConvertToVector256ByteWithSaturation(
            Vector512<ushort> value
        ) => ConvertToVector256ByteWithSaturation(value);
        ...
        /// </summary>
        public static Vector256<sbyte> ConvertToVector256SByteWithSaturation(
            Vector512<short> value
        ) => ConvertToVector256SByteWithSaturation(value);
        ...
        public static Vector512<ushort> ConvertToVector512UInt16(Vector256<sbyte> value) =>
            ConvertToVector512UInt16(value);
        ...
        /// </summary>
        public static Vector512<short> MultiplyHigh(
            Vector512<short> left,
            Vector512<short> right
        ...
        ///   VPMULLW zmm1 {k1}{z}, zmm2, zmm3/m512
        /// </summary>
        public static Vector512<ushort> MultiplyLow(
            Vector512<ushort> left,
            Vector512<ushort> right
        ) => MultiplyLow(left, right);
        ...
        /// </summary>
        public static Vector512<short> PackSignedSaturate(
            Vector512<int> left,
            Vector512<int> right
        ) => PackSignedSaturate(left, right);
        ...
        ) => PermuteVar32x16x2(lower, indices, upper);
        ...
        /// </summary>
        public static Vector512<byte> SubtractSaturate(
            Vector512<byte> left,
            Vector512<byte> right
        ) => SubtractSaturate(left, right);
        ...
        ///   VPUNPCKHWD zmm1 {k1}{z}, zmm2, zmm3/m512
        /// </summary>
        public static Vector512<ushort> UnpackHigh(
            Vector512<ushort> left,
            Vector512<ushort> right
        ) => UnpackHigh(left, right);
        ...
        ///   VPUNPCKLWD zmm1 {k1}{z}, zmm2, zmm3/m512
        /// </summary>
        public static Vector512<ushort> UnpackLow(
            Vector512<ushort> left,
            Vector512<ushort> right
        ) => UnpackLow(left, right);
    }
