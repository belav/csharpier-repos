...
namespace System.Runtime.Intrinsics.Wasm
{
    ...
    public abstract class PackedSimd
    {
        ...
        /// </summary>
        [Intrinsic]
        public static int ExtractScalar(
            Vector128<sbyte> value,
            [ConstantExpected(Max = (byte)(15))] byte index
        ) => ExtractScalar(value, index); // takes ImmLaneIdx16

        /// <summary>
        ///   i8x16.extract_lane_u
        /// </summary>
        [Intrinsic]
        public static uint ExtractScalar(
        ...
        public static int ExtractScalar(
            ...
            [ConstantExpected(Max = (byte)(7))] byte index
        ) => ExtractScalar(value, index); // takes ImmLaneIdx8
        ...
        public static int ExtractScalar(
            Vector128<int> value,
            [ConstantExpected(Max = (byte)(3))] byte index
        ) => ExtractScalar(value, index); // takes ImmLaneIdx4
        ...
        /// </summary>
        [Intrinsic]
        public static long ExtractScalar(
            Vector128<long> value,
            [ConstantExpected(Max = (byte)(1))] byte index
        ) => ExtractScalar(value, index); // takes ImmLaneIdx2

        /// <summary>
        ///   i64x2.extract_lane
        /// </summary>
        [Intrinsic]
        public static ulong ExtractScalar(
        ...
        /// </summary>
        [Intrinsic]
        public static float ExtractScalar(
        ...
        /// </summary>
        [Intrinsic]
        public static double ExtractScalar(
        ...
        /// </summary>
        [Intrinsic]
        public static nint ExtractScalar(
            Vector128<nint> value,
            [ConstantExpected(Max = (byte)(3))] byte index
        ) => ExtractScalar(value, index);

        /// <summary>
        ///   i32x4.extract_lane
        /// </summary>
        [Intrinsic]
        public static nuint ExtractScalar(
            Vector128<nuint> value,
            [ConstantExpected(Max = (byte)(3))] byte index
        ) => ExtractScalar(value, index);
        ...
        /// </summary>
        [Intrinsic]
        public static Vector128<sbyte> ReplaceScalar(
            Vector128<sbyte> vector,
            [ConstantExpected(Max = (byte)(15))] byte imm,
            int value
        ) => ReplaceScalar(vector, imm, value); // takes ImmLaneIdx16

        /// <summary>
        ///   i8x16.replace_lane
        /// </summary>
        [Intrinsic]
        public static Vector128<byte> ReplaceScalar(
        ...
        /// </summary>
        [Intrinsic]
        public static Vector128<short> ReplaceScalar(
            Vector128<short> vector,
            [ConstantExpected(Max = (byte)(7))] byte imm,
            int value
        ) => ReplaceScalar(vector, imm, value); // takes ImmLaneIdx8

        /// <summary>
        ///   i16x8.replace_lane
        /// </summary>
        [Intrinsic]
        public static Vector128<ushort> ReplaceScalar(
        ...
        /// </summary>
        [Intrinsic]
        public static Vector128<int> ReplaceScalar(
            Vector128<int> vector,
            [ConstantExpected(Max = (byte)(3))] byte imm,
            int value
        ) => ReplaceScalar(vector, imm, value); // takes ImmLaneIdx4
        ...
        /// </summary>
        [Intrinsic]
        public static Vector128<long> ReplaceScalar(
            Vector128<long> vector,
            [ConstantExpected(Max = (byte)(1))] byte imm,
            long value
        ) => ReplaceScalar(vector, imm, value); // takes ImmLaneIdx2

        /// <summary>
        ///   i64x2.replace_lane
        /// </summary>
        [Intrinsic]
        public static Vector128<ulong> ReplaceScalar(
            Vector128<ulong> vector,
            [ConstantExpected(Max = (byte)(1))] byte imm,
            ulong value
        ) => ReplaceScalar(vector, imm, value); // takes ImmLaneIdx2
        ...
        /// </summary>
        [Intrinsic]
        public static Vector128<float> ReplaceScalar(
        ...
        /// </summary>
        [Intrinsic]
        public static Vector128<double> ReplaceScalar(
        ...
        /// </summary>
        [Intrinsic]
        public static Vector128<nint> ReplaceScalar(
            Vector128<nint> vector,
            [ConstantExpected(Max = (byte)(3))] byte imm,
            nint value
        ) => ReplaceScalar(vector, imm, value);

        /// <summary>
        ///   i32x4.replace_lane
        /// </summary>
        [Intrinsic]
        public static Vector128<nuint> ReplaceScalar(
            Vector128<nuint> vector,
            [ConstantExpected(Max = (byte)(3))] byte imm,
            nuint value
        ) => ReplaceScalar(vector, imm, value);
        ...
        /// </summary>
        [Intrinsic]
        internal static Vector128<sbyte> Shuffle(
            Vector128<sbyte> lower,
            Vector128<sbyte> upper,
            Vector128<sbyte> indices
        ) => Shuffle(lower, upper, indices);

        /// <summary>
        ///   i8x16.shuffle
        /// </summary>
        [Intrinsic]
        internal static Vector128<byte> Shuffle(
        ...
        ///   i16x8.q15mulr.sat.s
        /// </summary>
        public static Vector128<short> MultiplyRoundedSaturateQ15(
            Vector128<short> left,
            Vector128<short> right
        ) => MultiplyRoundedSaturateQ15(left, right);
        ...
        ///   i16x8.avgr.u
        /// </summary>
        public static Vector128<ushort> AverageRounded(
            Vector128<ushort> left,
            Vector128<ushort> right
        ) => AverageRounded(left, right);
        ...
        ) => BitwiseSelect(left, right, select);
        ...
        /// </summary>
        [Intrinsic]
        public static Vector128<nint> BitwiseSelect(
            Vector128<nint> left,
            Vector128<nint> right,
            Vector128<nint> select
        ) => BitwiseSelect(left, right, select);
        ...
        /// </summary>
        [Intrinsic]
        public static Vector128<nuint> BitwiseSelect(
            Vector128<nuint> left,
            Vector128<nuint> right,
            Vector128<nuint> select
        ) => BitwiseSelect(left, right, select);
        ...
        /// </summary>
        [Intrinsic]
        public static Vector128<nuint> CompareEqual(
            Vector128<nuint> left,
            Vector128<nuint> right
        ) => CompareEqual(left, right);
        ...
        /// </summary>
        [Intrinsic]
        public static Vector128<sbyte> CompareNotEqual(
            Vector128<sbyte> left,
            Vector128<sbyte> right
        ...
        /// </summary>
        [Intrinsic]
        public static Vector128<byte> CompareNotEqual(
            Vector128<byte> left,
            Vector128<byte> right
        ) => CompareNotEqual(left, right);
        ...
        /// </summary>
        [Intrinsic]
        public static Vector128<short> CompareNotEqual(
            Vector128<short> left,
            Vector128<short> right
        ) => CompareNotEqual(left, right);
        ...
        /// </summary>
        [Intrinsic]
        public static Vector128<ushort> CompareNotEqual(
            Vector128<ushort> left,
            Vector128<ushort> right
        ) => CompareNotEqual(left, right);
        ...
        /// </summary>
        [Intrinsic]
        public static Vector128<uint> CompareNotEqual(
            Vector128<uint> left,
            Vector128<uint> right
        ) => CompareNotEqual(left, right);
        ...
        /// </summary>
        [Intrinsic]
        public static Vector128<long> CompareNotEqual(
            Vector128<long> left,
            Vector128<long> right
        ) => CompareNotEqual(left, right);
        ...
        /// </summary>
        [Intrinsic]
        public static Vector128<ulong> CompareNotEqual(
            Vector128<ulong> left,
            Vector128<ulong> right
        ) => CompareNotEqual(left, right);
        ...
        /// </summary>
        [Intrinsic]
        public static Vector128<nint> CompareNotEqual(
            Vector128<nint> left,
            Vector128<nint> right
        ) => CompareNotEqual(left, right);
        ...
        /// </summary>
        [Intrinsic]
        public static Vector128<nuint> CompareNotEqual(
            Vector128<nuint> left,
            Vector128<nuint> right
        ) => CompareNotEqual(left, right);
        ...
        /// </summary>
        [Intrinsic]
        public static Vector128<nint> CompareLessThan(
            Vector128<nint> left,
            Vector128<nint> right
        ) => CompareLessThan(left, right);
        ...
        /// </summary>
        [Intrinsic]
        public static Vector128<nuint> CompareLessThan(
            Vector128<nuint> left,
            Vector128<nuint> right
        ) => CompareLessThan(left, right);
        ...
        /// </summary>
        [Intrinsic]
        public static Vector128<nint> CompareLessThanOrEqual(
            Vector128<nint> left,
            Vector128<nint> right
        ) => CompareLessThanOrEqual(left, right);
        ...
        /// </summary>
        [Intrinsic]
        public static Vector128<nuint> CompareLessThanOrEqual(
            Vector128<nuint> left,
            Vector128<nuint> right
        ) => CompareLessThanOrEqual(left, right);
        ...
        /// </summary>
        [Intrinsic]
        public static Vector128<nint> CompareGreaterThan(
            Vector128<nint> left,
            Vector128<nint> right
        ) => CompareGreaterThan(left, right);
        ...
        /// </summary>
        [Intrinsic]
        public static Vector128<nuint> CompareGreaterThan(
            Vector128<nuint> left,
            Vector128<nuint> right
        ) => CompareGreaterThan(left, right);
        ...
        /// </summary>
        [Intrinsic]
        public static Vector128<nint> CompareGreaterThanOrEqual(
            Vector128<nint> left,
            Vector128<nint> right
        ) => CompareGreaterThanOrEqual(left, right);
        ...
        /// </summary>
        [Intrinsic]
        public static Vector128<nuint> CompareGreaterThanOrEqual(
            Vector128<nuint> left,
            Vector128<nuint> right
        ) => CompareGreaterThanOrEqual(left, right);
        ...
        /// </summary>
        [Intrinsic]
        public static unsafe Vector128<sbyte> LoadScalarAndSplatVector128(sbyte* address) =>
            LoadScalarAndSplatVector128(address);

        /// <summary>
        ///   v128.load8_splat
        /// </summary>
        [Intrinsic]
        public static unsafe Vector128<byte> LoadScalarAndSplatVector128(byte* address) =>
            LoadScalarAndSplatVector128(address);
        ...
        /// </summary>
        [Intrinsic]
        public static unsafe Vector128<short> LoadScalarAndSplatVector128(short* address) =>
            LoadScalarAndSplatVector128(address);
        ...
        /// </summary>
        [Intrinsic]
        public static unsafe Vector128<ushort> LoadScalarAndSplatVector128(ushort* address) =>
            LoadScalarAndSplatVector128(address);
        ...
        /// </summary>
        [Intrinsic]
        public static unsafe Vector128<int> LoadScalarAndSplatVector128(int* address) =>
            LoadScalarAndSplatVector128(address);
        ...
        /// </summary>
        [Intrinsic]
        public static unsafe Vector128<uint> LoadScalarAndSplatVector128(uint* address) =>
            LoadScalarAndSplatVector128(address);
        ...
        /// </summary>
        [Intrinsic]
        public static unsafe Vector128<long> LoadScalarAndSplatVector128(long* address) =>
            LoadScalarAndSplatVector128(address);
        ...
        /// </summary>
        [Intrinsic]
        public static unsafe Vector128<ulong> LoadScalarAndSplatVector128(ulong* address) =>
            LoadScalarAndSplatVector128(address);
        ...
        /// </summary>
        [Intrinsic]
        public static unsafe Vector128<float> LoadScalarAndSplatVector128(float* address) =>
            LoadScalarAndSplatVector128(address);
        ...
        /// </summary>
        [Intrinsic]
        public static unsafe Vector128<double> LoadScalarAndSplatVector128(double* address) =>
            LoadScalarAndSplatVector128(address);
        ...
        /// </summary>
        [Intrinsic]
        public static unsafe Vector128<nint> LoadScalarAndSplatVector128(nint* address) =>
            LoadScalarAndSplatVector128(address);
        ...
        /// </summary>
        [Intrinsic]
        public static unsafe Vector128<nuint> LoadScalarAndSplatVector128(nuint* address) =>
            LoadScalarAndSplatVector128(address);
        ...
        /// </summary>
        [Intrinsic]
        public static unsafe Vector128<sbyte> LoadScalarAndInsert(
            sbyte* address,
            Vector128<sbyte> vector,
            [ConstantExpected(Max = (byte)(15))] byte index
        ) => LoadScalarAndInsert(address, vector, index); // takes ImmLaneIdx16

        /// <summary>
        ///   v128.load8_lane
        /// </summary>
        [Intrinsic]
        public static unsafe Vector128<byte> LoadScalarAndInsert(
            byte* address,
            Vector128<byte> vector,
            [ConstantExpected(Max = (byte)(15))] byte index
        ) => LoadScalarAndInsert(address, vector, index); // takes ImmLaneIdx16
        ...
        /// </summary>
        [Intrinsic]
        public static unsafe Vector128<short> LoadScalarAndInsert(
            short* address,
            Vector128<short> vector,
            [ConstantExpected(Max = (byte)(7))] byte index
        ) => LoadScalarAndInsert(address, vector, index); // takes ImmLaneIdx8

        /// <summary>
        ///   v128.load16_lane
        /// </summary>
        [Intrinsic]
        public static unsafe Vector128<ushort> LoadScalarAndInsert(
            ushort* address,
            Vector128<ushort> vector,
            [ConstantExpected(Max = (byte)(7))] byte index
        ) => LoadScalarAndInsert(address, vector, index); // takes ImmLaneIdx8
        ...
        /// </summary>
        [Intrinsic]
        public static unsafe Vector128<int> LoadScalarAndInsert(
            int* address,
            Vector128<int> vector,
            [ConstantExpected(Max = (byte)(3))] byte index
        ) => LoadScalarAndInsert(address, vector, index); // takes ImmLaneIdx4

        /// <summary>
        ///   v128.load32_lane
        /// </summary>
        [Intrinsic]
        public static unsafe Vector128<uint> LoadScalarAndInsert(
            uint* address,
            Vector128<uint> vector,
            [ConstantExpected(Max = (byte)(3))] byte index
        ) => LoadScalarAndInsert(address, vector, index); // takes ImmLaneIdx4
        ...
        /// </summary>
        [Intrinsic]
        public static unsafe Vector128<long> LoadScalarAndInsert(
            long* address,
            Vector128<long> vector,
            [ConstantExpected(Max = (byte)(1))] byte index
        ) => LoadScalarAndInsert(address, vector, index); // takes ImmLaneIdx2

        /// <summary>
        ///   v128.load64_lane
        /// </summary>
        [Intrinsic]
        public static unsafe Vector128<ulong> LoadScalarAndInsert(
            ulong* address,
            Vector128<ulong> vector,
            [ConstantExpected(Max = (byte)(1))] byte index
        ) => LoadScalarAndInsert(address, vector, index); // takes ImmLaneIdx2
        ...
        /// </summary>
        [Intrinsic]
        public static unsafe Vector128<float> LoadScalarAndInsert(
            float* address,
            Vector128<float> vector,
            [ConstantExpected(Max = (byte)(3))] byte index
        ) => LoadScalarAndInsert(address, vector, index); // takes ImmLaneIdx4
        ...
        /// </summary>
        [Intrinsic]
        public static unsafe Vector128<double> LoadScalarAndInsert(
            double* address,
            Vector128<double> vector,
            [ConstantExpected(Max = (byte)(1))] byte index
        ) => LoadScalarAndInsert(address, vector, index); // takes ImmLaneIdx2
        ...
        /// </summary>
        [Intrinsic]
        public static unsafe Vector128<nint> LoadScalarAndInsert(
            nint* address,
            Vector128<nint> vector,
            [ConstantExpected(Max = (byte)(3))] byte index
        ) => LoadScalarAndInsert(address, vector, index); // takes ImmLaneIdx4
        ...
        /// </summary>
        [Intrinsic]
        public static unsafe Vector128<nuint> LoadScalarAndInsert(
            nuint* address,
            Vector128<nuint> vector,
            [ConstantExpected(Max = (byte)(3))] byte index
        ) => LoadScalarAndInsert(address, vector, index); // takes ImmLaneIdx4
        ...
        public static unsafe void StoreSelectedScalar(
            ...
            [ConstantExpected(Max = (byte)(15))] byte index
        ) => StoreSelectedScalar(address, source, index); // takes ImmLaneIdx16
        ...
        public static unsafe void StoreSelectedScalar(
            ...
            [ConstantExpected(Max = (byte)(7))] byte index
        ) => StoreSelectedScalar(address, source, index); // takes ImmLaneIdx8
        ...
        public static unsafe void StoreSelectedScalar(
            ...
            [ConstantExpected(Max = (byte)(3))] byte index
        ) => StoreSelectedScalar(address, source, index); // takes ImmLaneIdx4
        ...
        public static unsafe void StoreSelectedScalar(
            ...
            [ConstantExpected(Max = (byte)(1))] byte index
        ) => StoreSelectedScalar(address, source, index); // takes ImmLaneIdx2
        ...
        public static unsafe void StoreSelectedScalar(
            nint* address,
            Vector128<nint> source,
            [ConstantExpected(Max = (byte)(3))] byte index
        ) => StoreSelectedScalar(address, source, index);
        ...
        /// </summary>
        [Intrinsic]
        public static unsafe Vector128<short> LoadWideningVector128(sbyte* address) =>
            LoadWideningVector128(address);

        /// <summary>
        ///   v128.load8x8_u
        /// </summary>
        [Intrinsic]
        public static unsafe Vector128<ushort> LoadWideningVector128(byte* address) =>
            LoadWideningVector128(address);
        ...
        /// </summary>
        [Intrinsic]
        public static unsafe Vector128<int> LoadWideningVector128(short* address) =>
            LoadWideningVector128(address);
        ...
        /// </summary>
        [Intrinsic]
        public static unsafe Vector128<uint> LoadWideningVector128(ushort* address) =>
            LoadWideningVector128(address);
        ...
        /// </summary>
        [Intrinsic]
        public static unsafe Vector128<long> LoadWideningVector128(int* address) =>
            LoadWideningVector128(address);
        ...
        /// </summary>
        [Intrinsic]
        public static unsafe Vector128<ulong> LoadWideningVector128(uint* address) =>
            LoadWideningVector128(address);
        ...
        /// </summary>
        [Intrinsic]
        public static Vector128<double> PseudoMin(
            Vector128<double> left,
            Vector128<double> right
        ) => PseudoMin(left, right);
        ...
        public static Vector128<float> PseudoMax(Vector128<float> left, Vector128<float> right) =>
            PseudoMax(left, right);

        /// <summary>
        ///   f64x2.pmax
        /// </summary>
        [Intrinsic]
        public static Vector128<double> PseudoMax(
            Vector128<double> left,
            Vector128<double> right
        ) => PseudoMax(left, right);
        ...
        /// </summary>
        [Intrinsic]
        public static Vector128<sbyte> ConvertNarrowingSaturateSigned(
            Vector128<short> lower,
            Vector128<short> upper
        ) => ConvertNarrowingSaturateSigned(lower, upper);

        /// <summary>
        ///   i16x8.narrow_i32x4_s
        /// </summary>
        [Intrinsic]
        public static Vector128<short> ConvertNarrowingSaturateSigned(
            Vector128<int> lower,
            Vector128<int> upper
        ) => ConvertNarrowingSaturateSigned(lower, upper);
        ...
        /// </summary>
        [Intrinsic]
        public static Vector128<byte> ConvertNarrowingSaturateUnsigned(
            Vector128<short> lower,
            Vector128<short> upper
        ) => ConvertNarrowingSaturateUnsigned(lower, upper);

        /// <summary>
        ///   i16x8.narrow_i32x4_u
        /// </summary>
        [Intrinsic]
        public static Vector128<ushort> ConvertNarrowingSaturateUnsigned(
            Vector128<int> lower,
            Vector128<int> upper
        ) => ConvertNarrowingSaturateUnsigned(lower, upper);
