...
namespace System.Runtime.Intrinsics.Wasm
{
    ...
    public abstract class PackedSimd
    {
        ...
        public static int ExtractLane(Vector128<sbyte> value, byte index) =>
            ExtractLane(value, index); // takes ImmLaneIdx16
        ...
        public static int ExtractLane(Vector128<short> value, byte index) =>
            ExtractLane(value, index); // takes ImmLaneIdx8
        ...
        public static int ExtractLane(Vector128<int> value, byte index) =>
            ExtractLane(value, index); // takes ImmLaneIdx4
        ...
        public static long ExtractLane(Vector128<long> value, byte index) =>
            ExtractLane(value, index); // takes ImmLaneIdx2
        ...
        public static Vector128<sbyte> ReplaceLane(Vector128<sbyte> vector, byte imm, int value) =>
            ReplaceLane(vector, imm, value); // takes ImmLaneIdx16
        ...
        public static Vector128<short> ReplaceLane(Vector128<short> vector, byte imm, int value) =>
            ReplaceLane(vector, imm, value); // takes ImmLaneIdx8

        /// <summary>
        ///   i16x8.replace_lane
        /// </summary>
        [Intrinsic]
        public static Vector128<ushort> ReplaceLane(
        ...
        public static Vector128<int> ReplaceLane(Vector128<int> vector, byte imm, int value) =>
            ReplaceLane(vector, imm, value); // takes ImmLaneIdx4
        ...
        public static Vector128<long> ReplaceLane(Vector128<long> vector, byte imm, long value) =>
            ReplaceLane(vector, imm, value); // takes ImmLaneIdx2

        /// <summary>
        ///   i64x2.replace_lane
        /// </summary>
        [Intrinsic]
        public static Vector128<ulong> ReplaceLane(
        ...
        /// </summary>
        [Intrinsic]
        public static Vector128<float> ReplaceLane(
        ...
        /// </summary>
        [Intrinsic]
        public static Vector128<double> ReplaceLane(
        ...
        public static Vector128<nint> ReplaceLane(Vector128<nint> vector, byte imm, nint value) =>
            ReplaceLane(vector, imm, value);

        /// <summary>
        ///   i32x4.replace_lane
        /// </summary>
        [Intrinsic]
        public static Vector128<nuint> ReplaceLane(
        ...
        /// </summary>
        [Intrinsic]
        public static Vector128<sbyte> Shuffle(
        ...
        /// </summary>
        [Intrinsic]
        public static Vector128<byte> Shuffle(
