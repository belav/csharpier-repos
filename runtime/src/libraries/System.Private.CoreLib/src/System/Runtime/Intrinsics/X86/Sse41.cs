...
namespace System.Runtime.Intrinsics.X86
{
    ...
    public abstract class Sse41 : Ssse3
    {
        ...
        public new abstract class X64 : Ssse3.X64
        {
            ...
            /// This intrinsic is only available on 64-bit processes
            /// </summary>
            public static Vector128<long> Insert(
                Vector128<long> value,
                long data,
                [ConstantExpected] byte index
            ...
            /// This intrinsic is only available on 64-bit processes
            /// </summary>
            public static Vector128<ulong> Insert(
        ...
        /// </summary>
        public static Vector128<short> Blend(
        ...
        ///   VPBLENDW xmm1, xmm2, xmm3/m128 imm8
        /// </summary>
        public static Vector128<ushort> Blend(
        ...
        /// </summary>
        public static Vector128<float> Blend(
        ...
        /// </summary>
        public static Vector128<double> Blend(
        ...
        /// </summary>
        public static Vector128<sbyte> BlendVariable(
        ...
        ///   VPBLENDVB xmm1, xmm2, xmm3/m128, xmm4
        /// </summary>
        public static Vector128<byte> BlendVariable(
            Vector128<byte> left,
        ...
        /// </summary>
        public static Vector128<float> BlendVariable(
            Vector128<float> left,
            Vector128<float> right,
        ...
        /// </summary>
        public static Vector128<double> BlendVariable(
            Vector128<double> left,
            Vector128<double> right,
        ...
        ///   VROUNDSS xmm1, xmm2, xmm3/m128, imm8(10)
        /// </summary>
        public static Vector128<float> CeilingScalar(
            Vector128<float> upper,
            Vector128<float> value
        ) => CeilingScalar(upper, value);
        ...
        /// </summary>
        public static unsafe Vector128<short> ConvertToVector128Int16(sbyte* address) =>
            ConvertToVector128Int16(address);
        ...
        /// The native signature does not exist. We provide this additional overload for completeness.
        /// </summary>
        public static unsafe Vector128<short> ConvertToVector128Int16(byte* address) =>
            ConvertToVector128Int16(address);
        ...
        /// The native signature does not exist. We provide this additional overload for completeness.
        /// </summary>
        public static unsafe Vector128<int> ConvertToVector128Int32(sbyte* address) =>
            ConvertToVector128Int32(address);
        ...
        /// The native signature does not exist. We provide this additional overload for completeness.
        /// </summary>
        public static unsafe Vector128<int> ConvertToVector128Int32(byte* address) =>
            ConvertToVector128Int32(address);
        ...
        /// The native signature does not exist. We provide this additional overload for completeness.
        /// </summary>
        public static unsafe Vector128<int> ConvertToVector128Int32(short* address) =>
            ConvertToVector128Int32(address);
        ...
        /// The native signature does not exist. We provide this additional overload for completeness.
        /// </summary>
        public static unsafe Vector128<int> ConvertToVector128Int32(ushort* address) =>
            ConvertToVector128Int32(address);
        ...
        /// The native signature does not exist. We provide this additional overload for completeness.
        /// </summary>
        public static unsafe Vector128<long> ConvertToVector128Int64(sbyte* address) =>
            ConvertToVector128Int64(address);
        ...
        /// The native signature does not exist. We provide this additional overload for completeness.
        /// </summary>
        public static unsafe Vector128<long> ConvertToVector128Int64(byte* address) =>
            ConvertToVector128Int64(address);
        ...
        /// The native signature does not exist. We provide this additional overload for completeness.
        /// </summary>
        public static unsafe Vector128<long> ConvertToVector128Int64(short* address) =>
            ConvertToVector128Int64(address);
        ...
        /// The native signature does not exist. We provide this additional overload for completeness.
        /// </summary>
        public static unsafe Vector128<long> ConvertToVector128Int64(ushort* address) =>
            ConvertToVector128Int64(address);
        ...
        /// The native signature does not exist. We provide this additional overload for completeness.
        /// </summary>
        public static unsafe Vector128<long> ConvertToVector128Int64(int* address) =>
            ConvertToVector128Int64(address);
        ...
        /// The native signature does not exist. We provide this additional overload for completeness.
        /// </summary>
        public static unsafe Vector128<long> ConvertToVector128Int64(uint* address) =>
            ConvertToVector128Int64(address);
        ...
        /// </summary>
        public static Vector128<float> DotProduct(
            Vector128<float> left,
            Vector128<float> right,
            [ConstantExpected] byte control
        ) => DotProduct(left, right, control);
        ...
        /// </summary>
        public static Vector128<double> DotProduct(
            Vector128<double> left,
            Vector128<double> right,
            [ConstantExpected] byte control
        ) => DotProduct(left, right, control);
        ...
        ///   VROUNDSS xmm1, xmm2, xmm3/m128, imm8(9)
        /// </summary>
        public static Vector128<float> FloorScalar(
            Vector128<float> upper,
            Vector128<float> value
        ) => FloorScalar(upper, value);
        ...
        /// </summary>
        public static Vector128<sbyte> Insert(
        ...
        ///   VPINSRB xmm1, xmm2, r/m8, imm8
        /// </summary>
        public static Vector128<byte> Insert(
        ...
        /// </summary>
        public static Vector128<int> Insert(
            Vector128<int> value,
            int data,
            [ConstantExpected] byte index
        ) => Insert(value, data, index);
        ...
        ///   VPINSRD xmm1, xmm2, r/m32, imm8
        /// </summary>
        public static Vector128<uint> Insert(
        ...
        /// </summary>
        public static Vector128<float> Insert(
            Vector128<float> value,
        ...
        public static unsafe Vector128<sbyte> LoadAlignedVector128NonTemporal(sbyte* address) =>
            LoadAlignedVector128NonTemporal(address);
        ...
        /// </summary>
        public static Vector128<ushort> MultipleSumAbsoluteDifferences(
            Vector128<byte> left,
            Vector128<byte> right,
        ...
        public static Vector128<float> RoundCurrentDirectionScalar(Vector128<float> value) =>
            RoundCurrentDirectionScalar(value);
        ...
        public static Vector128<float> RoundCurrentDirectionScalar(
            Vector128<float> upper,
            Vector128<float> value
        ) => RoundCurrentDirectionScalar(upper, value);
        ...
        public static Vector128<float> RoundToNearestIntegerScalar(Vector128<float> value) =>
            RoundToNearestIntegerScalar(value);
        ...
        public static Vector128<float> RoundToNearestIntegerScalar(
            Vector128<float> upper,
            Vector128<float> value
        ) => RoundToNearestIntegerScalar(upper, value);
        ...
        public static Vector128<float> RoundToNegativeInfinityScalar(
            Vector128<float> upper,
            Vector128<float> value
        ) => RoundToNegativeInfinityScalar(upper, value);
        ...
        public static Vector128<float> RoundToPositiveInfinityScalar(
            Vector128<float> upper,
            Vector128<float> value
        ) => RoundToPositiveInfinityScalar(upper, value);
