...
namespace System.Runtime.Intrinsics.X86
{
    ...
    public abstract class Sse3 : Sse2
    {
        ...
        /// </summary>
        public static Vector128<double> AddSubtract(
        ...
        ///   HADDPS xmm, xmm/m128
        /// </summary>
        public static Vector128<float> HorizontalAdd(
        ...
        public static unsafe Vector128<double> LoadAndDuplicateToVector128(double* address) =>
            LoadAndDuplicateToVector128(address);
