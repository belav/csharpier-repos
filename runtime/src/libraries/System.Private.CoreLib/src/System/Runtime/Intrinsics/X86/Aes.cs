...
namespace System.Runtime.Intrinsics.X86
{
    ...
    public abstract class Aes : Sse2
    {
        ...
        /// </summary>
        public static Vector128<byte> DecryptLast(
            Vector128<byte> value,
            Vector128<byte> roundKey
        ) => DecryptLast(value, roundKey);
        ...
        /// </summary>
        public static Vector128<byte> EncryptLast(
            Vector128<byte> value,
            Vector128<byte> roundKey
        ) => EncryptLast(value, roundKey);
        ...
        /// </summary>
        public static Vector128<byte> KeygenAssist(
            Vector128<byte> value,
            [ConstantExpected] byte control
        ) => KeygenAssist(value, control);
    }
}
