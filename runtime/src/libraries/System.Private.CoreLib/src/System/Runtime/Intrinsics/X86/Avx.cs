...
namespace System.Runtime.Intrinsics.X86
{
    ...
    public abstract class Avx : Sse42
    {
        ...
        /// </summary>
        public static Vector256<double> AddSubtract(
        ...
        /// </summary>
        public static Vector256<float> CompareEqual(
            Vector256<float> left,
            Vector256<float> right
        ...
        /// The above native signature does not exist. We provide this additional overload for completeness.
        /// </summary>
        public static Vector256<float> CompareOrdered(
            Vector256<float> left,
            Vector256<float> right
        ...
        /// </summary>
        public static Vector256<float> HorizontalAdd(
            Vector256<float> left,
            Vector256<float> right
        ...
        /// </summary>
        public static Vector128<double> PermuteVar(
            Vector128<double> left,
        ...
        /// </summary>
        public static Vector256<double> PermuteVar(
            Vector256<double> left,
        ...
        /// </summary>
        public static Vector256<double> UnpackHigh(
            Vector256<double> left,
            Vector256<double> right
        ) => UnpackHigh(left, right);
        ...
        /// </summary>
        public static Vector256<double> UnpackLow(
            Vector256<double> left,
            Vector256<double> right
        ) => UnpackLow(left, right);
