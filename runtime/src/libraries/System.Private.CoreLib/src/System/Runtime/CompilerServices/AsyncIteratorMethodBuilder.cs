...
namespace System.Runtime.CompilerServices
{
    ...
    {
        /// <summary>The lazily-initialized box/task object, created the first time the iterator awaits
        // something not yet completed.</summary>
        /// <remarks>
        /// This will be the async state machine box created for the compiler-generated class (not struct)
        // state machine
        /// object for the async enumerator.  Even though its not exposed as a Task property as on
        // AsyncTaskMethodBuilder,
        /// it needs to be stored if for no other reason than <see cref="Complete"/> needs to mark it
        // completed in order to clean up.
        /// </remarks>
