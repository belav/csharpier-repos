...
{
    /// <summary>Represents a builder for asynchronous methods that returns a <see
    ...
    public struct AsyncValueTaskMethodBuilder<TResult>
    {
        ...
        /// <remarks>
        /// To avoid memory safety issues even in the face of invalid race conditions, we ensure that the
        // type of this object
        /// is valid for the mode in which we're operating.  As such, it's cached on the generic builder per
        // TResult
        ...
        /// <summary>The wrapped task.  If the operation completed synchronously and successfully, this will
        // be a sentinel object compared by reference identity.</summary>
        private Task<TResult>? m_task; // Debugger depends on the exact name of this field.

        /// <summary>The result for this builder if it's completed synchronously, in which case <see
        // cref="m_task"/> will be <see cref="s_syncSuccessSentinel"/>.</summary>
        private TResult _result;

        /// <summary>Creates an instance of the <see cref="AsyncValueTaskMethodBuilder{TResult}"/>
        // struct.</summary>
        ...
        /// <summary>Marks the value task as failed and binds the specified exception to the value
        // task.</summary>
