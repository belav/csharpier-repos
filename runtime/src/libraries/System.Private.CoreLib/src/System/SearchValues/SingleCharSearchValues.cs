...
namespace System.Buffers
{
        ...
        where TShouldUsePacked : struct, SearchValues.IRuntimeConst
    {
        ...
        public SingleCharSearchValues(char value) => _e0 = value;

        internal override char[] GetValues() => new[] { _e0 };

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal override bool ContainsCore(char value) => value == _e0;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal override int LastIndexOfAny(ReadOnlySpan<char> span) => span.LastIndexOf(_e0);
