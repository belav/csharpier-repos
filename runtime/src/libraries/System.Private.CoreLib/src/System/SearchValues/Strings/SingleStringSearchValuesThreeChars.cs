        ...
        where TCaseSensitivity : struct, ICaseSensitivity
    {
        ...
        private int IndexOf(ref char searchSpace, int searchSpaceLength)
        {
            ...
            )
            {
                ...
                ref char lastSearchSpace = ref Unsafe.Add(
                    ref searchSpace,
                ...
                while (true)
                {
                    ...
                    ValidateReadPosition(
                        ...
                        searchSpaceLength,
                        ref searchSpace,
                        Vector512<ushort>.Count + (int)(_ch2ByteOffset / 2)
                    );
                    ValidateReadPosition(
                        ref searchSpaceStart,
                        searchSpaceLength,
                        ref searchSpace,
                        Vector512<ushort>.Count + (int)(_ch3ByteOffset / 2)
                    );
                    ...
                    if (Unsafe.IsAddressGreaterThan(ref searchSpace, ref lastSearchSpace))
                    {
                        if (
                            Unsafe.AreSame(
                                ref searchSpace,
                                ref Unsafe.Add(ref lastSearchSpace, Vector512<ushort>.Count)
                            )
                        )
                        {
                            return -1;
            ...
            )
            {
                ...
                while (true)
                {
                    ...
                    ValidateReadPosition(
                        ...
                        searchSpaceLength,
                        ref searchSpace,
                        Vector256<ushort>.Count + (int)(_ch2ByteOffset / 2)
                    );
                    ValidateReadPosition(
                        ref searchSpaceStart,
                        searchSpaceLength,
                        ref searchSpace,
                        Vector256<ushort>.Count + (int)(_ch3ByteOffset / 2)
                    );
                    ...
                    if (Unsafe.IsAddressGreaterThan(ref searchSpace, ref lastSearchSpace))
                    {
                        if (
                            Unsafe.AreSame(
                                ref searchSpace,
                                ref Unsafe.Add(ref lastSearchSpace, Vector256<ushort>.Count)
                            )
                        )
                        {
                            return -1;
            ...
            else
            {
                ...
                while (true)
                {
                    ...
                    ValidateReadPosition(
                        ...
                        searchSpaceLength,
                        ref searchSpace,
                        Vector128<ushort>.Count + (int)(_ch2ByteOffset / 2)
                    );
                    ValidateReadPosition(
                        ref searchSpaceStart,
                        searchSpaceLength,
                        ref searchSpace,
                        Vector128<ushort>.Count + (int)(_ch3ByteOffset / 2)
                    );
                    ...
                    if (Unsafe.IsAddressGreaterThan(ref searchSpace, ref lastSearchSpace))
                    {
                        if (
                            Unsafe.AreSame(
                                ref searchSpace,
                                ref Unsafe.Add(ref lastSearchSpace, Vector128<ushort>.Count)
                            )
                        )
                        {
                            return -1;
            ...
            for (nint i = 0; i < searchSpaceMinusValueTailLength; i++)
            {
                ...
                if (
                    (
                        ...
                        || TCaseSensitivity.TransformInput(cur) == valueHead
        ...
        private static Vector128<byte> GetComparisonResult(
            ...
            nuint ch2ByteOffset,
            nuint ch3ByteOffset,
            Vector128<ushort> ch1,
            Vector128<ushort> ch2,
            Vector128<ushort> ch3
        )
        {
            ...
            if (typeof(TCaseSensitivity) == typeof(CaseSensitive))
            {
                ...
                Vector128<ushort> cmpCh2 = Vector128.Equals(
                    ch2,
                    Vector128
                        .LoadUnsafe(ref Unsafe.As<char, byte>(ref searchSpace), ch2ByteOffset)
                        .AsUInt16()
                );
                Vector128<ushort> cmpCh3 = Vector128.Equals(
                    ch3,
                    Vector128
            ...
            else
            {
                ...
                Vector128<ushort> cmpCh1 = Vector128.Equals(
                    ch1,
                    Vector128.LoadUnsafe(ref searchSpace) & caseConversion
                );
                Vector128<ushort> cmpCh2 = Vector128.Equals(
                    ch2,
                    Vector128
        ...
        private static Vector256<byte> GetComparisonResult(
            ...
            nuint ch2ByteOffset,
            nuint ch3ByteOffset,
            Vector256<ushort> ch1,
            Vector256<ushort> ch2,
            Vector256<ushort> ch3
        )
        {
            ...
            if (typeof(TCaseSensitivity) == typeof(CaseSensitive))
            {
                ...
                Vector256<ushort> cmpCh3 = Vector256.Equals(
                    ch3,
                    Vector256
                        .LoadUnsafe(ref Unsafe.As<char, byte>(ref searchSpace), ch3ByteOffset)
                        .AsUInt16()
            ...
            else
            {
                ...
                Vector256<ushort> cmpCh1 = Vector256.Equals(
                    ch1,
                    Vector256.LoadUnsafe(ref searchSpace) & caseConversion
                );
                Vector256<ushort> cmpCh2 = Vector256.Equals(
                    ch2,
                    Vector256
        ...
        private static Vector512<byte> GetComparisonResult(
            ...
            nuint ch2ByteOffset,
            nuint ch3ByteOffset,
            Vector512<ushort> ch1,
            Vector512<ushort> ch2,
            Vector512<ushort> ch3
        )
        {
            // See comments in 'GetComparisonResult' for Vector128<byte> above.
            ...
            if (typeof(TCaseSensitivity) == typeof(CaseSensitive))
            {
                ...
                Vector512<ushort> cmpCh3 = Vector512.Equals(
                    ch3,
                    Vector512
                        .LoadUnsafe(ref Unsafe.As<char, byte>(ref searchSpace), ch3ByteOffset)
                        .AsUInt16()
            ...
            else
            {
                ...
                Vector512<ushort> cmpCh1 = Vector512.Equals(
                    ch1,
                    Vector512.LoadUnsafe(ref searchSpace) & caseConversion
                );
                Vector512<ushort> cmpCh2 = Vector512.Equals(
                    ch2,
                    Vector512
        ...
        )
        {
            ...
            do
            {
                ...
                {
                    offsetFromStart = (int)(
                        (nuint)Unsafe.ByteOffset(ref searchSpaceStart, ref matchRef) / 2
                    );
                    return true;
                }
        ...
        internal override string[] GetValues() =>
            HasUniqueValues ? base.GetValues() : new string[] { _value };
    }
}
