...
namespace System.Buffers
{
    internal static class CharacterFrequencyHelper
    {
        ...
        public static void GetSingleStringMultiCharacterOffsets(
            string value,
            bool ignoreCase,
            out int ch2Offset,
            out int ch3Offset
        )
        {
            ...
            if (value.Length > 2)
            {
                ch3Offset = IndexOfAsciiCharWithLowestFrequency(
                    value,
                    ignoreCase,
                    excludeIndex: ch2Offset
                );
        ...
        private static int IndexOfAsciiCharWithLowestFrequency(
