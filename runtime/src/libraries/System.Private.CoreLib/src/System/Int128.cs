...
namespace System
{
            ...
            IBinaryIntegerParseAndFormatInfo<Int128>
    {
        ...
        )
        {
            ...
            return Number.ParseBinaryInteger<char, Int128>(
                s,
                style,
        ...
        public static Int128 LeadingZeroCount(Int128 value) => LeadingZeroCountAsInt32(value);
        ...
        static bool IBinaryInteger<Int128>.TryReadBigEndian(
        ...
        static bool IBinaryInteger<Int128>.TryReadLittleEndian(
            ReadOnlySpan<byte> source,
            bool isUnsigned,
            out Int128 value
        )
        ...
        public static Int128 operator /(Int128 left, Int128 right)
        {
            ...
            return new Int128(result.Upper, result.Lower);
        }
            ...
            where TOther : INumberBase<TOther>
        {
            ...
            if (typeof(TOther) == typeof(double))
            {
                double actualValue = (double)(object)value;
                result =
                    (actualValue >= +170141183460469231731687303715884105727.0) ? MaxValue
                    : (actualValue <= -170141183460469231731687303715884105728.0) ? MinValue
                    : (Int128)actualValue;
                return true;
            }
            else if (typeof(TOther) == typeof(Half))
            {
                Half actualValue = (Half)(object)value;
                result =
                    (actualValue == Half.PositiveInfinity) ? MaxValue
                    : (actualValue == Half.NegativeInfinity) ? MinValue
                    : (Int128)actualValue;
                return true;
            }
            else if (typeof(TOther) == typeof(short))
            ...
            else if (typeof(TOther) == typeof(float))
            {
                float actualValue = (float)(object)value;
                result =
                    (actualValue >= +170141183460469231731687303715884105727.0f) ? MaxValue
                    : (actualValue <= -170141183460469231731687303715884105728.0f) ? MinValue
                    : (Int128)actualValue;
                return true;
            }
            else
        ...
        )
        {
            ...
            else if (typeof(TOther) == typeof(nuint))
            {
                nuint actualResult =
                    ...
                    : (value <= nuint.MinValue) ? nuint.MinValue
                    : (nuint)value;
                result = (TOther)(object)actualResult;
                return true;
            }
        ...
        {
            NumberFormatInfo.ValidateParseStyleInteger(style);
            return Number.ParseBinaryInteger<byte, Int128>(
                utf8Text,
                style,
                NumberFormatInfo.GetInstance(provider)
            );
        ...
        static Int128 IBinaryIntegerParseAndFormatInfo<Int128>.MaxValueDiv10 =>
            new Int128(0x0CCC_CCCC_CCCC_CCCC, 0xCCCC_CCCC_CCCC_CCCC);

        static string IBinaryIntegerParseAndFormatInfo<Int128>.OverflowMessage =>
            SR.Overflow_Int128;

        static bool IBinaryIntegerParseAndFormatInfo<Int128>.IsGreaterThanAsUnsigned(
            Int128 left,
            Int128 right
