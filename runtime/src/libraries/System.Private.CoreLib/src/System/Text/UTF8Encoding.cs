...
namespace System.Text
{
    ...
    public partial class UTF8Encoding : Encoding
    {
        ...
        public UTF8Encoding() : base(UTF8_CODEPAGE) { }

        public UTF8Encoding(bool encoderShouldEmitUTF8Identifier) : this()
        {
        ...
        )
        {
            ...
            char* ptrToFirstInvalidChar = Utf16Utility.GetPointerToFirstInvalidChar(
                pChars,
                charsLength,
        ...
        private protected sealed override unsafe int GetCharsWithFallback(
        ...
        )
        {
            ...
            if (
                ((decoder is null) ? this.DecoderFallback : decoder.Fallback)
            ...
            )
            {
                ...
                Utf8.ToUtf16(
                    ...
                    isFinalBlock: decoder is null || decoder.MustFlush
                );
        ...
        private unsafe int GetCharCountCommon(byte* pBytes, int byteCount)
        {
            ...
            int totalCharCount = GetCharCountFast(
                pBytes,
                byteCount,
                fallback: null,
                out int bytesConsumed
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)] // called directly by GetCharCountCommon
        private protected sealed override unsafe int GetCharCountFast(
            byte* pBytes,
            int bytesLength,
        ...
        )
        {
            ...
            byte* ptrToFirstInvalidByte = Utf8Utility.GetPointerToFirstInvalidByte(
                pBytes,
                bytesLength,
        ...
        public override int GetHashCode()
        {
            ...
            return this.EncoderFallback.GetHashCode()
