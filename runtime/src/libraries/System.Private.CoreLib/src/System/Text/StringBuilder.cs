...
#pragma warning restore CA1830
        ...
        private unsafe StringBuilder AppendJoinCore<T>(
            char* separator,
            int separatorLength,
        ...
        public StringBuilder Replace(string oldValue, string? newValue, int startIndex, int count)
        {
            ...
            while (count > 0)
            {
                ...
                if (indexInChunk >= chunk.m_ChunkLength || count == 0) // Have we moved out of the current chunk?
                {
                    ...
                    Debug.Assert(
                        replacements != null || replacementsCount == 0,
                        "replacements was null and replacementsCount != 0"
                    );
                    ReplaceAllInChunk(
                        replacements,
                        replacementsCount,
        ...
        private void ReplaceAllInChunk(
            ...
            unsafe
            {
                fixed (char* valuePtr = value)
                {
                    Debug.Assert(
                        replacements != null,
                        "replacements was null when replacementsCount > 0"
                    );
