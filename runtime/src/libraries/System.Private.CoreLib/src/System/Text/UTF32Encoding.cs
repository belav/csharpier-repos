...
*/
        ...
        internal static readonly UTF32Encoding s_default = new UTF32Encoding(
            bigEndian: false,
            byteOrderMark: true
        );
        internal static readonly UTF32Encoding s_bigEndianDefault = new UTF32Encoding(
            bigEndian: true,
            byteOrderMark: true
        );
        ...
        )
        {
            ...
            Debug.Assert(
                highSurrogate == 0 || (encoder is not null && !encoder.MustFlush),
