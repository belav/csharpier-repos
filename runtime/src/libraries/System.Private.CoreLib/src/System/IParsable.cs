...
namespace System
{
        ...
        where TSelf : IParsable<TSelf>?
    {
        ...
        /// <exception cref="FormatException"><paramref name="s" /> is not in the correct
        // format.</exception>
        /// <exception cref="OverflowException"><paramref name="s" /> is not representable by <typeparamref
        // name="TSelf" />.</exception>
        ...
        /// <param name="provider">An object that provides culture-specific formatting information about
        // <paramref name="s" />.</param>
        /// <param name="result">On return, contains the result of successfully parsing <paramref name="s"
        // /> or an undefined value on failure.</param>
        /// <returns><c>true</c> if <paramref name="s" /> was successfully parsed; otherwise,
        // <c>false</c>.</returns>
