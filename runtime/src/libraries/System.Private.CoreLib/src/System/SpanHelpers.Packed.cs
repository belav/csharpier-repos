...
namespace System
{
    ...
    internal static partial class PackedSpanHelpers
    {
        ...
        public static int IndexOf(ref char searchSpace, char value, int length) =>
            IndexOf<SpanHelpers.DontNegate<short>>(
        ...
        public static int IndexOfAnyExcept(ref char searchSpace, char value, int length) =>
            IndexOf<SpanHelpers.Negate<short>>(
                ref Unsafe.As<char, short>(ref searchSpace),
                (short)value,
                length
            );
        ...
        public static int IndexOfAny(ref char searchSpace, char value0, char value1, int length) =>
            IndexOfAny<SpanHelpers.DontNegate<short>>(
                ref Unsafe.As<char, short>(ref searchSpace),
                (short)value0,
                (short)value1,
                length
        ...
        public static int IndexOfAnyExcept(
            ...
            IndexOfAny<SpanHelpers.Negate<short>>(
                ref Unsafe.As<char, short>(ref searchSpace),
                (short)value0,
                (short)value1,
                length
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [CompExactlyDependsOn(typeof(Sse2))]
        public static int IndexOfAnyInRange(
            ref char searchSpace,
            char lowInclusive,
            char rangeInclusive,
            int length
        ) =>
            IndexOfAnyInRange<SpanHelpers.DontNegate<short>>(
                ref Unsafe.As<char, short>(ref searchSpace),
                (short)lowInclusive,
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [CompExactlyDependsOn(typeof(Sse2))]
        public static int IndexOfAnyExceptInRange(
            ref char searchSpace,
            char lowInclusive,
            char rangeInclusive,
            int length
        ) =>
            IndexOfAnyInRange<SpanHelpers.Negate<short>>(
                ref Unsafe.As<char, short>(ref searchSpace),
                (short)lowInclusive,
                (short)rangeInclusive,
                length
...
#pragma warning restore IntrinsicsInSystemPrivateCoreLibAttributeNotSpecificEnough
                {
                    ...
                    if (length > 2 * Vector512<short>.Count)
                    {
                        ...
                        do
                        {
                            ...
                            Vector512<short> source1 = Vector512.LoadUnsafe(
                                ref currentSearchSpace,
                                (nuint)Vector512<short>.Count
                            );
                            ...
                            currentSearchSpace = ref Unsafe.Add(
                                ref currentSearchSpace,
                                2 * Vector512<short>.Count
                            );
                        } while (
                            Unsafe.IsAddressLessThan(
                                ref currentSearchSpace,
                                ref twoVectorsAwayFromEnd
                            )
                        );
                    }
...
#pragma warning restore IntrinsicsInSystemPrivateCoreLibAttributeNotSpecificEnough
                {
                        ...
                        do
                        {
                            ...
                            if (HasMatch<TNegator>(packedValue, packedSource))
                            {
                                return ComputeFirstIndex(
                                    ref searchSpace,
                                    ref currentSearchSpace,
                                    GetMatchMask<TNegator>(packedValue, packedSource)
                                );
                            }
                    ...
                    // They may overlap, but we'll handle that in the index calculation if we do get a match.
                    {
                        ...
                        if (HasMatch<TNegator>(packedValue, packedSource))
                        {
                            return ComputeFirstIndexOverlapped(
                                ref searchSpace,
                                ref firstVector,
                                ref oneVectorAwayFromEnd,
                                GetMatchMask<TNegator>(packedValue, packedSource)
...
#pragma warning restore IntrinsicsInSystemPrivateCoreLibAttributeNotSpecificEnough
                {
                    ...
                    if (length > 2 * Vector512<short>.Count)
                    {
                        ...
                        do
                        {
                            ...
                            Vector512<byte> packedSource = PackSources(source0, source1);
                            Vector512<byte> result = NegateIfNeeded<TNegator>(
                                Vector512.Equals(packedValue0, packedSource)
                                    | Vector512.Equals(packedValue1, packedSource)
                            );
                    ...
                    if (length > 2 * Vector256<short>.Count)
                    {
                        ...
                        do
                        {
                            ...
                            Vector256<byte> result =
                                Vector256.Equals(packedValue0, packedSource)
                                | Vector256.Equals(packedValue1, packedSource);
                            result = NegateIfNeeded<TNegator>(result);
...
#pragma warning restore IntrinsicsInSystemPrivateCoreLibConditionParsing
                    {
                        ...
                        do
                        {
                            ...
                            Vector128<byte> result =
                                Vector128.Equals(packedValue0, packedSource)
                                | Vector128.Equals(packedValue1, packedSource);
                            result = NegateIfNeeded<TNegator>(result);
                    ...
                    if (length > 2 * Vector512<short>.Count)
                    {
                        ...
                        do
                        {
                            ...
                            Vector512<byte> result = NegateIfNeeded<TNegator>(
                                Vector512.Equals(packedValue0, packedSource)
                                    | Vector512.Equals(packedValue1, packedSource)
                                    | Vector512.Equals(packedValue2, packedSource)
                            );
                    ...
                    if (length > 2 * Vector256<short>.Count)
                    {
                        ...
                        do
                        {
                            ...
                            Vector256<byte> result =
                                Vector256.Equals(packedValue0, packedSource)
                                | Vector256.Equals(packedValue1, packedSource)
                                | Vector256.Equals(packedValue2, packedSource);
                            result = NegateIfNeeded<TNegator>(result);
...
#pragma warning restore IntrinsicsInSystemPrivateCoreLibConditionParsing
                    {
                        ...
                        do
                        {
                            ...
                            Vector128<byte> result =
                                Vector128.Equals(packedValue0, packedSource)
                                | Vector128.Equals(packedValue1, packedSource)
                                | Vector128.Equals(packedValue2, packedSource);
                            result = NegateIfNeeded<TNegator>(result);
        ...
        [CompExactlyDependsOn(typeof(Sse2))]
        private static int IndexOfAnyInRange<TNegator>(
            ref short searchSpace,
            short lowInclusive,
            short rangeInclusive,
            int length
...
#pragma warning restore IntrinsicsInSystemPrivateCoreLibAttributeNotSpecificEnough
                {
                    ...
                    if (length > 2 * Vector512<short>.Count)
                    {
                        ...
                        do
                        {
                            ...
                            Vector512<byte> packedSource =
                                PackSources(source0, source1) - lowVector;
                            ...
                            if (HasMatchInRange<TNegator>(packedSource, rangeVector))
                            {
                                return ComputeFirstIndex(
                                    ref searchSpace,
                                    ref currentSearchSpace,
                                    GetMatchInRangeMask<TNegator>(packedSource, rangeVector)
                                );
                            }
...
#pragma warning restore IntrinsicsInSystemPrivateCoreLibAttributeNotSpecificEnough
                {
                    ...
                    if (length > 2 * Vector256<short>.Count)
                    {
                        ...
                        do
                        {
                            ...
                            Vector256<byte> packedSource = PackSources(source0, source1);
                            Vector256<byte> result = Vector256.LessThanOrEqual(
                                packedSource - lowVector,
                                rangeVector
                            );
                            result = NegateIfNeeded<TNegator>(result);
...
#pragma warning restore IntrinsicsInSystemPrivateCoreLibConditionParsing
                    {
                        ...
                        do
                        {
                            ...
                            Vector128<byte> packedSource = PackSources(source0, source1);
                            Vector128<byte> result = Vector128.LessThanOrEqual(
                                packedSource - lowVector,
                                rangeVector
                            );
                            result = NegateIfNeeded<TNegator>(result);
        ...
        private static Vector512<byte> PackSources(
            Vector512<short> source0,
            Vector512<short> source1
        )
        {
        ...
        private static Vector256<byte> PackSources(
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [CompExactlyDependsOn(typeof(Sse2))]
        private static Vector128<byte> PackSources(
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static Vector512<byte> GetMatchMask<TNegator>(
            Vector512<byte> left,
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static Vector512<byte> GetMatchInRangeMask<TNegator>(
            Vector512<byte> left,
            Vector512<byte> right
        )
            where TNegator : struct, SpanHelpers.INegator<short>
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static int ComputeFirstIndex(
            ref short searchSpace,
            ref short current,
        ...
        )
        {
            ...
            return index
                + (int)((nuint)Unsafe.ByteOffset(ref searchSpace, ref current) / sizeof(short));
        }
        ...
        {
            uint notEqualsElements = FixUpPackedVector256Result(equals)
        ...
        {
            ulong notEqualsElements = FixUpPackedVector512Result(equals)
                .ExtractMostSignificantBits();
            int index = BitOperations.TrailingZeroCount(notEqualsElements);
            return index
                + (int)((nuint)Unsafe.ByteOffset(ref searchSpace, ref current) / sizeof(short));
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static int ComputeFirstIndexOverlapped(
            ref short searchSpace,
            ref short current0,
            ref short current1,
            Vector128<byte> equals
        )
        {
            ...
            return offsetInVector
                + (int)((nuint)Unsafe.ByteOffset(ref searchSpace, ref current0) / sizeof(short));
        }
        ...
        internal static Vector512<byte> FixUpPackedVector512Result(Vector512<byte> result)
        {
            ...
            return Avx512F
                .PermuteVar8x64(result.AsInt64(), Vector512.Create(0, 2, 4, 6, 1, 3, 5, 7))
                .AsByte();
        }
    }
}
