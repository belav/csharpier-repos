...
{
    partial public static class CharUnicodeInfo
    {
        ...
        [Conditional("DEBUG")]
        private static void AssertCategoryCasingTableLevels(
            int level1BitCount,
            int level2BitCount,
            int level3BitCount
        )
        ...
        private static ReadOnlySpan<byte> CategoryCasingLevel1Index =>
            new byte[2176]
            {
                0x00,
                0x01,
        ...
        private static ReadOnlySpan<byte> CategoryCasingLevel2Index =>
            new byte[6528]
            {
                0x00,
                0x00,
        ...
        private static ReadOnlySpan<byte> CategoryCasingLevel3Index =>
            new byte[11952]
            {
                0x00,
                0x00,
        ...
        private static ReadOnlySpan<byte> CategoriesValues =>
            new byte[234]
            {
                0x0e,
                0x8e,
        ...
        private static ReadOnlySpan<byte> UppercaseValues =>
            new byte[468]
            {
                0x00,
                0x00,
        ...
        private static ReadOnlySpan<byte> LowercaseValues =>
            new byte[468]
            {
                0x00,
                0x00,
        ...
        [Conditional("DEBUG")]
        private static void AssertNumericGraphemeTableLevels(
            int level1BitCount,
            int level2BitCount,
            int level3BitCount
        )
        ...
        private static ReadOnlySpan<byte> NumericGraphemeLevel1Index =>
            new byte[2176]
            {
                0x00,
                0x01,
        ...
        private static ReadOnlySpan<byte> NumericGraphemeLevel2Index =>
            new byte[4992]
            {
                0x00,
                0x00,
        ...
        private static ReadOnlySpan<byte> NumericGraphemeLevel3Index =>
            new byte[6176]
            {
                0x00,
                0x00,
        ...
        private static ReadOnlySpan<byte> DigitValues =>
            new byte[177]
            {
                0x00,
                0x00,
        ...
        private static ReadOnlySpan<byte> GraphemeSegmentationValues =>
            new byte[177]
            {
                0x03,
                0x02,
