...
namespace System.Globalization
{
    ...
    public class HebrewCalendar : Calendar
    {
        ...
        private static ReadOnlySpan<byte> HebrewTable =>
            new byte[] // rely on C# compiler optimization to reference static data
            {
                7,
                3,
                17,
                3, // 1583-1584  (Hebrew year: 5343 - 5344)
                0,
                4,
                11,
                2,
        ...
        private static readonly DateTime s_calendarMaxValue = new DateTime(
        ...
        internal virtual int GetDatePart(long ticks, int part)
        {
            ...
            AbsoluteDate = GregorianCalendar.GetAbsoluteDate(
                gregorianYear,
                gregorianMonth,
                gregorianDay
            );
            ...
            // is true.
            numDays -= (long)(
                LunarMonthLen[hebrewYearType * MaxMonthPlusOne + lunarDate.month] - lunarDate.day
            );
                ...
                while (
                    ...
                    if (
                        ...
                        hebrewYearType = HebrewTable[
                            (gregorianYear + 1 - FirstGregorianTableYear) * 2 + 1
                        ];
        ...
        public override DateTime AddMonths(DateTime time, int months)
        {
            try
            {
                ...
                return new DateTime(
                    ToDateTime(y, i, d, 0, 0, 0, 0).Ticks + (time.Ticks % TicksPerDay)
                );
            }
        ...
        public override int GetDaysInMonth(int year, int month, int era)
        {
            ...
            Debug.Assert(
                hebrewYearType >= 1 && hebrewYearType <= 6,
                "hebrewYearType should be from  1 to 6, but now hebrewYearType = "
                    + hebrewYearType
                    + " for hebrew year "
                    + year
            );
        ...
        /// </summary>
        private static DateTime HebrewToGregorian(
            int hebrewYear,
            int hebrewMonth,
            int hebrewDay,
            int hour,
