    ...
    internal static partial class IcuLocaleData
    {
        private static ReadOnlySpan<byte> CultureNames =>
            new byte[]
            {
                ...
                (byte)'-',
                (byte)'u',
                (byte)'s', // chr, chr-cher, chr-cher-us
                (byte)'c',
                (byte)'o',
                (byte)'-',
                (byte)'f',
                ...
                (byte)'-',
                (byte)'g',
                (byte)'t', // quc, quc-latn, quc-latn-gt
                (byte)'q',
                (byte)'u',
                (byte)'z',
                (byte)'-',
                ...
                (byte)'-',
                (byte)'m',
                (byte)'a', // shi, shi-latn, shi-latn-ma
                (byte)'s',
                (byte)'h',
                (byte)'i',
                (byte)'-',
                ...
                (byte)'-',
                (byte)'m',
                (byte)'a', // tzm, tzm-arab, tzm-arab-ma
                (byte)'t',
                (byte)'z',
                (byte)'m',
                (byte)'-',
                ...
                (byte)'-',
                (byte)'l',
                (byte)'r', // vai, vai-latn, vai-latn-lr
                (byte)'v',
                (byte)'a',
                (byte)'i',
                (byte)'-',
                ...
                (byte)'-',
                (byte)'m',
                (byte)'a', // zgh, zgh-tfng, zgh-tfng-ma
                (byte)'z',
                (byte)'h',
                (byte)'-',
                (byte)'c',
        ...
        private static ReadOnlySpan<byte> LocalesNamesIndexes =>
            new byte[CulturesCount * 2]
            {
                0,
                2, // aa
                0,
        ...
        private static ReadOnlySpan<byte> LcidToCultureNameIndices =>
            new byte[LcidCount * 4]
            {
                0x00,
                0x01,
                0x02,
        ...
        private static ReadOnlySpan<byte> NameIndexToNumericData =>
            new byte[CulturesCount * NumericLocaleDataBytesPerRow]
            {
                0x00,
                0x10,
                0x00,
        ...
        internal static int GetLocaleDataNumericPart(string cultureName, IcuLocaleDataParts part)
        {
            ...
            ReadOnlySpan<byte> numericData = NameIndexToNumericData.Slice(
                index * NumericLocaleDataBytesPerRow,
                NumericLocaleDataBytesPerRow
            );
