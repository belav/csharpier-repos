...
namespace System.Globalization
{
    internal sealed partial class CalendarData
    {
        private bool LoadCalendarDataFromNative(string localeName, CalendarId calendarId)
        {
            ...
            sNativeName = GetCalendarInfoNative(
                localeName,
                calendarId,
                CalendarDataType.NativeName
            );
            sMonthDay = GetCalendarInfoNative(localeName, calendarId, CalendarDataType.MonthDay);
            saShortDates = GetCalendarInfoNative(
                    localeName,
                    calendarId,
                    CalendarDataType.ShortDates
                )
                .Split("||");
            saLongDates = GetCalendarInfoNative(localeName, calendarId, CalendarDataType.LongDates)
                .Split("||");
            saYearMonths = GetCalendarInfoNative(
                    localeName,
                    calendarId,
                    CalendarDataType.YearMonths
                )
                .Split("||");
            saDayNames = GetCalendarInfoNative(localeName, calendarId, CalendarDataType.DayNames)
                .Split("||");
            saAbbrevDayNames = GetCalendarInfoNative(
                    localeName,
                    calendarId,
                    CalendarDataType.AbbrevDayNames
                )
                .Split("||");
            saSuperShortDayNames = GetCalendarInfoNative(
                    localeName,
                    calendarId,
            ...
            saMonthNames = NormalizeMonthArray(
                GetCalendarInfoNative(localeName, calendarId, CalendarDataType.MonthNames)
                    .Split("||"),
                calendarId,
            ...
            saAbbrevMonthNames = NormalizeMonthArray(
                GetCalendarInfoNative(localeName, calendarId, CalendarDataType.AbbrevMonthNames)
                    .Split("||"),
                calendarId,
                ref leapHebrewMonthName
            );
            saMonthGenitiveNames = NormalizeMonthArray(
                GetCalendarInfoNative(localeName, calendarId, CalendarDataType.MonthGenitiveNames)
                    .Split("||"),
                calendarId,
                ref leapHebrewMonthName
            );
            saAbbrevMonthGenitiveNames = NormalizeMonthArray(
            ...
            saEraNames = NormalizeEraNames(
                calendarId,
                GetCalendarInfoNative(localeName, calendarId, CalendarDataType.EraNames).Split("||")
            );
            saAbbrevEraNames = Array.Empty<string>();

            return sNativeName != null
                && saShortDates != null
                && saLongDates != null
                && saYearMonths != null
                && saDayNames != null
        ...
        private static string[] NormalizeMonthArray(
            string[] months,
        ...
        )
        {
            ...
            throw new Exception(
                "CalendarData.GetCalendarInfoNative() returned an unexpected number of month names."
            );
        }

        private static string GetCalendarInfoNative(
            string localeName,
            CalendarId calendarId,
        ...
        )
        {
            ...
            return Interop.Globalization.GetCalendarInfoNative(
                localeName,
                calendarId,
                calendarDataType
            );
