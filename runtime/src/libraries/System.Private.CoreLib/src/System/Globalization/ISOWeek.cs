...
namespace System.Globalization
{
    public static class ISOWeek
    {
        ...
        // ISO week year numbering therefore slightly deviates from the Gregorian for some days close to 1
        // January.
        ...
        //
        // The long years, with 53 weeks in them, can be described by any of the following equivalent
        // definitions:
        //
        ...
        // - Years in which 1 January and 31 December (in common years) or either (in leap years) are
        // Thursdays.
        //
        ...
        //
        // Multiply the week number by 7, then add the weekday. From this sum subtract the correction for
        // the year.
        // The result is the ordinal date, which can be converted into a calendar date.
        //
        // If the ordinal date thus obtained is zero or negative, the date belongs to the previous calendar
        // year.
        ...
        //
        // If the week number thus obtained equals 0, it means that the given date belongs to the preceding
        // (week-based) year.
        // If a week number of 53 is obtained, one must check that the date is not actually in week 1 of the
        // following year.
        ...
        // Day of week in ISO is represented by an integer from 1 through 7, beginning with Monday and
        // ending with Sunday.
        // This matches the underlying values of the DayOfWeek enum, except for Sunday, which needs to be
        // converted.
