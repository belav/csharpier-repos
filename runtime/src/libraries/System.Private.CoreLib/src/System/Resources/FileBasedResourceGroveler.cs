                ...
                if (tryParents)
                {
                    ...
                    if (culture.HasInvariantCultureName)
                    {
                        ...
                        throw new MissingManifestResourceException(
                            $"{SR.MissingManifestResource_NoNeutralDisk}{Environment.NewLineConst}baseName: {_mediator.BaseNameField}  locationInfo: {locationInfo}  fileName: {_mediator.GetResourceFileName(culture)}"
                        );
                    }
                }
            }
