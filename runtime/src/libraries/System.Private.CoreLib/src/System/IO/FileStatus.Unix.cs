    ...
    internal partial struct FileStatus
    {
        ...
        internal bool HasReadOnlyFlag
        {
            get
            {
                ...
                return (_fileCache.Mode & (int)readBit) != 0
                    && // has read permission
        ...
        private bool HasSymbolicLinkFlag
        {
            get
            {
                ...
                return (_fileCache.Mode & Interop.Sys.FileTypes.S_IFMT)
        ...
        internal bool IsNameHidden(ReadOnlySpan<char> fileName) =>
