...
namespace System.IO.Strategies
{
    ...
    internal sealed class DerivedFileStreamStrategy : FileStreamStrategy
    {
        ...
        public override int EndRead(IAsyncResult asyncResult) =>
            _strategy.IsAsync
                ? _strategy.EndRead(asyncResult)
                : _fileStream.BaseEndRead(asyncResult);

        public override int Read(byte[] buffer, int offset, int count) =>
            _strategy.Read(buffer, offset, count);
        ...
        public override int Read(Span<byte> buffer) => _fileStream.BaseRead(buffer);
        ...
        public override void Write(ReadOnlySpan<byte> buffer) => _fileStream.BaseWrite(buffer);
