    ...
    internal static partial class SR
    {
        ...
        private static string InternalGetResourceString(string key)
        {
            ...
            try
            {
                ...
                Debug.Assert(
                    s != null,
                    "Managed resource string lookup failed.  Was your resource name misspelled?  Did you rebuild mscorlib after adding a resource to resources.txt?  Debug this w/ cordbg and bug whoever owns the code that called SR.GetResourceString.  Resource name was: \""
                        + key
                        + "\""
                );
                return s ?? key;
