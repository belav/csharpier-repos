        ...
        private static string InternalGetResourceString(string key)
        {
            ...
            try
            {
                ...
                )
                {
                    ...
                    string message =
                        $@"Encountered infinite recursion while looking up resource '{key}' in {System.CoreLib.Name}. Verify the installation of .NET is complete and does not need repairing, and that the state of the process has not become corrupted.";
