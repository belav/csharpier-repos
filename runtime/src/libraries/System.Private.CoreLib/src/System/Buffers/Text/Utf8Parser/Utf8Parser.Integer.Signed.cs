...
namespace System.Buffers.Text
{
    ...
    public static partial class Utf8Parser
    {
        ...
        /// <param name="bytesConsumed">On a successful parse, receives the length in bytes of the substring
        ...
        /// false if the string was not syntactically valid or an overflow or underflow occurred.
        // "bytesConsumed" is set to 0.
        /// </returns>
        /// <remarks>
        /// Formats supported:
        ///     G/g (default)
        ...
        )
        {
            ...
            switch (standardFormat | 0x20) // convert to lowercase
            {
                ...
                case 'x':
                    ...
                    return TryParseByteX(
                        source,
                        out Unsafe.As<sbyte, byte>(ref value),
                        out bytesConsumed
                    );
        ...
        )
        {
            ...
            switch (standardFormat | 0x20) // convert to lowercase
            {
                ...
                case 'x':
                    ...
                    return TryParseUInt16X(
                        source,
                        out Unsafe.As<short, ushort>(ref value),
                        out bytesConsumed
                    );
        ...
        )
        {
            ...
            switch (standardFormat | 0x20) // convert to lowercase
            {
                ...
                case 'x':
                    ...
                    return TryParseUInt32X(
                        source,
                        out Unsafe.As<int, uint>(ref value),
                        out bytesConsumed
                    );
        ...
        )
        {
            ...
            switch (standardFormat | 0x20) // convert to lowercase
            {
                ...
                case 'x':
                    ...
                    return TryParseUInt64X(
                        source,
                        out Unsafe.As<long, ulong>(ref value),
                        out bytesConsumed
                    );
