...
namespace System.Buffers.Binary
{
    public static partial class BinaryPrimitives
    {
        ...
        public static void ReverseEndianness(ReadOnlySpan<nuint> source, Span<nuint> destination) =>
            ...
            ReverseEndianness<
                int,
                Int32EndiannessReverser
            >(MemoryMarshal.Cast<nuint, int>(source), MemoryMarshal.Cast<nuint, int>(destination));
#endif
        ...
        public static void ReverseEndianness(ReadOnlySpan<nint> source, Span<nint> destination) =>
            ...
            ReverseEndianness<
                int,
                Int32EndiannessReverser
            >(MemoryMarshal.Cast<nint, int>(source), MemoryMarshal.Cast<nint, int>(destination));
#endif
