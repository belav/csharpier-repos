        ...
        private struct DecCalc
        {
            ...
            private static int VarDecCmpSub(in decimal d1, in decimal d2)
            {
                ...
                if (scale != 0)
                {
                    ...
                    {
                        uint power =
                            scale >= MaxInt32Scale ? TenToPowerNine : UInt32Powers10[scale];
            ...
            internal static unsafe void VarDecMul(ref DecCalc d1, ref DecCalc d2)
            {
                ...
                if ((d1.High | d1.Mid) == 0)
                {
                    if ((d2.High | d2.Mid) == 0)
                    {
                        ...
                        d1.Low64 = low64;
                        d1.uflags =
                            ((d2.uflags ^ d1.uflags) & SignMask) | ((uint)scale << ScaleShift);
                        return;
                    }
                    else
                    {
            ...
            internal static double VarR8FromDec(in decimal value)
            {
                ...
                double dbl =
                    ((double)value.Low64 + (double)value.High * ds2to64)
                    / DoublePowers10[value.Scale];
            ...
            internal static unsafe void VarDecDiv(ref DecCalc d1, ref DecCalc d2)
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        bufDivisor.U2 = (uint)(
                            (d2.Mid + ((ulong)d2.High << 32)) >> (32 - curScale)
                        );
                        ...
                        while (true)
                        {
                            ...
                            )
                            {
                                ...
                                if (
                                    bufRem.U2 > bufDivisor.U2
                                    || bufRem.U2 == bufDivisor.U2
                                        && (
                                            bufRem.Low64 > bufDivisor.Low64
                                            || bufRem.Low64 == bufDivisor.Low64
                                                && (bufQuo.U0 & 1) != 0
                                        )
                                )
                            ...
                            if (!Add32To96(ref bufQuo, tmp))
                            {
                                scale = OverflowUnscale(
                                    ref bufQuo,
                                    scale,
                                    (bufRem.Low64 | bufRem.High64) != 0
                                );
                                break;
                            }
                        } // while (true)
            ...
            internal static void VarDecMod(ref DecCalc d1, ref DecCalc d2)
            {
                ...
                int cmp = VarDecCmpSub(
                    in Unsafe.As<DecCalc, decimal>(ref d1),
                    in Unsafe.As<DecCalc, decimal>(ref d2)
                );
                if (cmp == 0)
                {
                    d1.ulo = 0;
                    ...
                    if (scale < 0)
                    {
                        ...
                        do
                        {
                            ...
                            if (iCurScale == 0)
                                break;
                            uint power =
                                iCurScale >= MaxInt32Scale
                                    ? TenToPowerNine
                                    : UInt32Powers10[iCurScale];
                            scale += iCurScale;
