...
namespace System.Numerics
{
    ...
    /// <typeparam name="TResult">The type that contains the result of negating <typeparamref
    // name="TSelf" />.</typeparam>
        ...
        where TSelf : IUnaryNegationOperators<TSelf, TResult>?
    {
        ...
        /// <param name="value">The value for which to compute its unary negation.</param>
        /// <returns>The unary negation of <paramref name="value" />.</returns>
        /// <exception cref="OverflowException">The unary negation of <paramref name="value" /> is not
        // representable by <typeparamref name="TResult" />.</exception>
