...
namespace System.Numerics
{
    ...
    public partial struct Matrix3x2 : IEquatable<Matrix3x2>
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Matrix3x2 operator -(Matrix3x2 value) => (-value.AsImpl()).AsM3x2();
        ...
        public static Matrix3x2 CreateScale(Vector2 scales) => Impl.CreateScale(scales).AsM3x2();
        ...
        /// <returns>The scaling matrix.</returns>
        public static Matrix3x2 CreateScale(float scale) => Impl.CreateScale(scale).AsM3x2();
        ...
        /// <returns>The negated matrix.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Matrix3x2 Negate(Matrix3x2 value) => (-value.AsImpl()).AsM3x2();
        ...
        /// <remarks>Two matrices are equal if all their corresponding elements are equal.</remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly bool Equals(Matrix3x2 other) => AsROImpl().Equals(in other.AsImpl());
