...
namespace System.Numerics
{
    ...
    public partial struct Matrix4x4 : IEquatable<Matrix4x4>
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Matrix4x4 operator -(Matrix4x4 value) => (-value.AsImpl()).AsM4x4();
        ...
        public static Matrix4x4 CreateBillboard(
            ...
            Impl.CreateBillboard(
                    in objectPosition,
                    in cameraPosition,
                    in cameraUpVector,
                    in cameraForwardVector
                )
                .AsM4x4();
        ...
        public static Matrix4x4 CreateConstrainedBillboard(
            ...
            Impl.CreateConstrainedBillboard(
                    in objectPosition,
                    in cameraPosition,
                    in rotateAxis,
                    in cameraForwardVector,
                    in objectForwardVector
                )
                .AsM4x4();
        ...
        )
        {
            ...
            return Impl.CreateLookTo(in cameraPosition, in cameraDirection, in cameraUpVector)
                .AsM4x4();
        }
        ...
        {
            Vector3 cameraDirection = cameraTarget - cameraPosition;
            return Impl.CreateLookToLeftHanded(
                    in cameraPosition,
                    in cameraDirection,
                    in cameraUpVector
                )
        ...
        public static Matrix4x4 CreateOrthographicLeftHanded(
            float width,
            float height,
            float zNearPlane,
            float zFarPlane
        ...
        public static Matrix4x4 CreateOrthographicOffCenter(
            ...
            Impl.CreateOrthographicOffCenter(left, right, bottom, top, zNearPlane, zFarPlane)
                .AsM4x4();
        ...
        /// <param name="zFarPlane">The maximum Z-value of the view volume.</param>
        /// <returns>The left-handed orthographic projection matrix.</returns>
        public static Matrix4x4 CreateOrthographicOffCenterLeftHanded(
            float left,
            float right,
            float bottom,
            float top,
            ...
            Impl.CreateOrthographicOffCenterLeftHanded(
                    left,
                    right,
                    bottom,
                    top,
        ...
        /// -or-
        /// <paramref name="nearPlaneDistance" /> is greater than or equal to <paramref name="farPlaneDistance" />.</exception>
        public static Matrix4x4 CreatePerspectiveLeftHanded(
            float width,
            float height,
            float nearPlaneDistance,
            float farPlaneDistance
        ) =>
            Impl.CreatePerspectiveLeftHanded(width, height, nearPlaneDistance, farPlaneDistance)
                .AsM4x4();
        ...
        public static Matrix4x4 CreatePerspectiveFieldOfView(
            ...
            Impl.CreatePerspectiveFieldOfView(
                    fieldOfView,
                    aspectRatio,
                    nearPlaneDistance,
                    farPlaneDistance
        ...
        public static Matrix4x4 CreatePerspectiveOffCenter(
            ...
            Impl.CreatePerspectiveOffCenter(
                    left,
                    right,
                    bottom,
                    top,
        ...
        /// -or-
        /// <paramref name="nearPlaneDistance" /> is greater than or equal to <paramref name="farPlaneDistance" />.</exception>
        public static Matrix4x4 CreatePerspectiveOffCenterLeftHanded(
            float left,
            float right,
            float bottom,
            float top,
            ...
            Impl.CreatePerspectiveOffCenterLeftHanded(
                    left,
                    right,
                    bottom,
                    top,
        ...
        /// <returns>The scaling matrix.</returns>
        public static Matrix4x4 CreateScale(Vector3 scales) => Impl.CreateScale(in scales).AsM4x4();
        ...
        /// <returns>The scaling matrix.</returns>
        public static Matrix4x4 CreateScale(float scale) => Impl.CreateScale(scale).AsM4x4();
        ...
        /// </remarks>
        public static Matrix4x4 CreateViewport(
            float x,
            float y,
            float width,
            float height,
        ...
        /// | x + width / 2 | y + height / 2 |       minDepth      | 1 |
        /// </remarks>
        public static Matrix4x4 CreateViewportLeftHanded(
            float x,
            float y,
            float width,
            float height,
        ...
        /// <returns>The negated matrix.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Matrix4x4 Negate(Matrix4x4 value) => (-value.AsImpl()).AsM4x4();
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly bool Equals(Matrix4x4 other) => AsROImpl().Equals(in other.AsImpl());

        /// <summary>Calculates the determinant of the current 4x4 matrix.</summary>
        /// <returns>The determinant.</returns>
        public readonly float GetDeterminant() => AsROImpl().GetDeterminant();

        /// <summary>Returns the hash code for this instance.</summary>
        /// <returns>The hash code.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public override readonly int GetHashCode() => AsROImpl().GetHashCode();
