...
namespace System.Numerics
{
    ...
    public struct Matrix4x4 : IEquatable<Matrix4x4>
    {
        ...
        public static unsafe Matrix4x4 operator +(Matrix4x4 value1, Matrix4x4 value2)
        {
            if (AdvSimd.IsSupported)
            {
                AdvSimd.Store(
                    &value1.M11,
                    AdvSimd.Add(
                        AdvSimd.LoadVector128(&value1.M11),
                        AdvSimd.LoadVector128(&value2.M11)
                    )
                );
                AdvSimd.Store(
                    &value1.M21,
                    AdvSimd.Add(
                        AdvSimd.LoadVector128(&value1.M21),
                        AdvSimd.LoadVector128(&value2.M21)
                    )
                );
                AdvSimd.Store(
                    &value1.M31,
                    AdvSimd.Add(
                        AdvSimd.LoadVector128(&value1.M31),
                ...
                AdvSimd.Store(
                    &value1.M41,
                    AdvSimd.Add(
                        AdvSimd.LoadVector128(&value1.M41),
            ...
            else if (Sse.IsSupported)
            {
                Sse.Store(
                    &value1.M11,
                    Sse.Add(Sse.LoadVector128(&value1.M11), Sse.LoadVector128(&value2.M11))
                );
                Sse.Store(
                    &value1.M21,
                    Sse.Add(Sse.LoadVector128(&value1.M21), Sse.LoadVector128(&value2.M21))
                );
                Sse.Store(
                    &value1.M31,
                    Sse.Add(Sse.LoadVector128(&value1.M31), Sse.LoadVector128(&value2.M31))
                );
                Sse.Store(
                    &value1.M41,
                    Sse.Add(Sse.LoadVector128(&value1.M41), Sse.LoadVector128(&value2.M41))
                );
                return value1;
            }
        ...
        public static unsafe bool operator ==(Matrix4x4 value1, Matrix4x4 value2)
        {
            ...
            {
                return VectorMath.Equal(
                        Sse.LoadVector128(&value1.M11),
                        Sse.LoadVector128(&value2.M11)
                    )
                    && VectorMath.Equal(
                        Sse.LoadVector128(&value1.M21),
                        Sse.LoadVector128(&value2.M21)
                    )
                    && VectorMath.Equal(
                        Sse.LoadVector128(&value1.M31),
                        Sse.LoadVector128(&value2.M31)
                    )
                    && VectorMath.Equal(
                        Sse.LoadVector128(&value1.M41),
        ...
        public static unsafe Matrix4x4 operator *(Matrix4x4 value1, Matrix4x4 value2)
        {
            if (AdvSimd.Arm64.IsSupported)
            {
                ...
                Vector128<float> vX = AdvSimd.MultiplyBySelectedScalar(
                    AdvSimd.LoadVector128(&value2.M11),
                    M11,
                    0
                );
                Vector128<float> vY = AdvSimd.MultiplyBySelectedScalar(
                    AdvSimd.LoadVector128(&value2.M21),
                    M11,
                    1
                );
            ...
            else if (Sse.IsSupported)
            {
                ...
                Sse.Store(
                    ...
                    Sse.Add(
                        Sse.Add(
                            Sse.Multiply(
                                Sse.Shuffle(row, row, 0x00),
                                Sse.LoadVector128(&value2.M11)
                            ),
                            Sse.Multiply(
                                Sse.Shuffle(row, row, 0x55),
                                Sse.LoadVector128(&value2.M21)
                            )
                        ),
                        Sse.Add(
                            Sse.Multiply(
                                Sse.Shuffle(row, row, 0xAA),
                                Sse.LoadVector128(&value2.M31)
                            ),
                            Sse.Multiply(
                                Sse.Shuffle(row, row, 0xFF),
                                Sse.LoadVector128(&value2.M41)
                            )
                        )
                    )
        ...
        public static unsafe Matrix4x4 operator *(Matrix4x4 value1, float value2)
        {
            if (AdvSimd.IsSupported)
            {
                ...
                AdvSimd.Store(
                    &value1.M11,
                    AdvSimd.Multiply(AdvSimd.LoadVector128(&value1.M11), value2Vec)
                );
                AdvSimd.Store(
                    &value1.M21,
                    AdvSimd.Multiply(AdvSimd.LoadVector128(&value1.M21), value2Vec)
                );
                AdvSimd.Store(
                    &value1.M31,
                    AdvSimd.Multiply(AdvSimd.LoadVector128(&value1.M31), value2Vec)
                );
                AdvSimd.Store(
                    &value1.M41,
                    AdvSimd.Multiply(AdvSimd.LoadVector128(&value1.M41), value2Vec)
                );
                return value1;
            }
            else if (Sse.IsSupported)
        ...
        public static unsafe Matrix4x4 operator -(Matrix4x4 value1, Matrix4x4 value2)
        {
            ...
            else if (Sse.IsSupported)
            {
                Sse.Store(
                    &value1.M11,
                    Sse.Subtract(Sse.LoadVector128(&value1.M11), Sse.LoadVector128(&value2.M11))
                );
                Sse.Store(
                    &value1.M21,
                    Sse.Subtract(Sse.LoadVector128(&value1.M21), Sse.LoadVector128(&value2.M21))
                );
                Sse.Store(
                    &value1.M31,
                    Sse.Subtract(Sse.LoadVector128(&value1.M31), Sse.LoadVector128(&value2.M31))
                );
                Sse.Store(
                    &value1.M41,
                    Sse.Subtract(Sse.LoadVector128(&value1.M41), Sse.LoadVector128(&value2.M41))
                );
                return value1;
            }
        ...
        )
        {
            ...
            if (MathF.Abs(dot) > BillboardMinAngle)
            {
                ...
                {
                    zaxis =
                        (MathF.Abs(rotateAxis.Z) > BillboardMinAngle)
                            ? new Vector3(1, 0, 0)
                            : new Vector3(0, 0, -1);
                }
        ...
        public static unsafe Matrix4x4 Lerp(Matrix4x4 matrix1, Matrix4x4 matrix2, float amount)
        {
            if (AdvSimd.IsSupported)
            {
                ...
                AdvSimd.Store(
                    &matrix1.M11,
                    VectorMath.Lerp(
                        AdvSimd.LoadVector128(&matrix1.M11),
                        AdvSimd.LoadVector128(&matrix2.M11),
                        amountVec
                    )
                );
                AdvSimd.Store(
                    &matrix1.M21,
                    VectorMath.Lerp(
                        AdvSimd.LoadVector128(&matrix1.M21),
                        AdvSimd.LoadVector128(&matrix2.M21),
                        amountVec
                    )
                );
                AdvSimd.Store(
                    &matrix1.M31,
                    VectorMath.Lerp(
                        AdvSimd.LoadVector128(&matrix1.M31),
                        AdvSimd.LoadVector128(&matrix2.M31),
                        amountVec
                    )
                );
                AdvSimd.Store(
                    &matrix1.M41,
                    VectorMath.Lerp(
                        AdvSimd.LoadVector128(&matrix1.M41),
                        AdvSimd.LoadVector128(&matrix2.M41),
                        amountVec
                    )
                );
                return matrix1;
            ...
            else if (Sse.IsSupported)
            {
                ...
                Sse.Store(
                    &matrix1.M11,
                    VectorMath.Lerp(
                        Sse.LoadVector128(&matrix1.M11),
                        Sse.LoadVector128(&matrix2.M11),
                        amountVec
                    )
                );
                Sse.Store(
                    &matrix1.M21,
                    VectorMath.Lerp(
                        Sse.LoadVector128(&matrix1.M21),
                        Sse.LoadVector128(&matrix2.M21),
                        amountVec
                    )
                );
                Sse.Store(
                    &matrix1.M31,
                    VectorMath.Lerp(
                        Sse.LoadVector128(&matrix1.M31),
                        Sse.LoadVector128(&matrix2.M31),
                        amountVec
                    )
                );
                Sse.Store(
                    &matrix1.M41,
                    VectorMath.Lerp(
                        Sse.LoadVector128(&matrix1.M41),
                        Sse.LoadVector128(&matrix2.M41),
                        amountVec
                    )
                );
                return matrix1;
        ...
        public readonly bool Equals(Matrix4x4 other)
        {
            ...
            {
                return Vector128
                        .LoadUnsafe(ref Unsafe.AsRef(in M11))
                        .Equals(Vector128.LoadUnsafe(ref other.M11))
                    && Vector128
                        .LoadUnsafe(ref Unsafe.AsRef(in M21))
                        .Equals(Vector128.LoadUnsafe(ref other.M21))
                    && Vector128
                        .LoadUnsafe(ref Unsafe.AsRef(in M31))
                        .Equals(Vector128.LoadUnsafe(ref other.M31))
                    && Vector128
                        .LoadUnsafe(ref Unsafe.AsRef(in M41))
                        .Equals(Vector128.LoadUnsafe(ref other.M41));
            }
            ...
            {
                return self.M11.Equals(other.M11)
                    && self.M22.Equals(other.M22)
                    && self.M33.Equals(other.M33)
                    && self.M44.Equals(other.M44) // Check diagonal element first for early out.
                    && self.M12.Equals(other.M12)
                    && self.M13.Equals(other.M13)
                    && self.M14.Equals(other.M14)
                    && self.M21.Equals(other.M21)
                    && self.M23.Equals(other.M23)
                    && self.M24.Equals(other.M24)
                    && self.M31.Equals(other.M31)
                    && self.M32.Equals(other.M32)
                    && self.M34.Equals(other.M34)
                    && self.M41.Equals(other.M41)
                    && self.M42.Equals(other.M42)
                    && self.M43.Equals(other.M43);
            }
        }
