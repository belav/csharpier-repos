...
namespace System.Numerics
{
    ...
    public partial struct Vector2 : IEquatable<Vector2>, IFormattable
    {
        ...
        /// <summary>Creates a new <see cref="Vector2" /> object whose two elements have the same
        // value.</summary>
        ...
        // contain at least 2 elements.</summary>
        ...
        /// <value>A vector whose two elements are equal to zero (that is, it returns the vector
        // <c>(0,0)</c>.</value>
        ...
        /// <value>A vector whose two elements are equal to one (that is, it returns the vector
        // <c>(1,1)</c>.</value>
        ...
        // name="right" />.</returns>
        /// <remarks>The <see cref="Vector2.op_Division" /> method defines the division operation for <see
        // cref="Vector2" /> objects.</remarks>
        [Intrinsic]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vector2 operator /(Vector2 left, Vector2 right)
        ...
        /// <remarks>Two <see cref="Vector2" /> objects are equal if each value in <paramref name="left" />
        // is equal to the corresponding value in <paramref name="right" />.</remarks>
        [Intrinsic]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <remarks>The <see cref="Vector2.op_Multiply" /> method defines the multiplication operation for
        // <see cref="Vector2" /> objects.</remarks>
        [Intrinsic]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vector2 operator *(Vector2 left, Vector2 right)
        {
        ...
        /// <remarks><paramref name="array" /> must have at least two elements. The method copies the
        ...
        // two vector elements. In other words, elements <paramref name="index" /> and <paramref name="index"
        // /> + 1 must already exist in <paramref name="array" />.</remarks>
        /// <exception cref="NullReferenceException"><paramref name="array" /> is <see langword="null"
        // />.</exception>
        /// <exception cref="ArgumentException">The number of elements in the current instance is greater
        // than in the array.</exception>
        ...
        // span must be at least 2.</summary>
        ...
        // destination span must be at least 2.</summary>
        /// <param name="destination">The destination span which the values are copied into.</param>
        ...
        // is a <see cref="Vector2" /> object and their <see cref="X" /> and <see cref="Y" /> elements are
        // equal.</remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        // />.</returns>
        /// <remarks>Two vectors are equal if their <see cref="X" /> and <see cref="Y" /> elements are
        // equal.</remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
