...
namespace System.Numerics
{
        ...
        where TSelf : IFloatingPoint<TSelf>?
    {
        ...
        /// <summary>Rounds a value to the nearest integer using the default rounding mode (<see
        // cref="MidpointRounding.ToEven" />).</summary>
        /// <param name="x">The value to round.</param>
        /// <returns>The result of rounding <paramref name="x" /> to the nearest integer using the default
        // rounding mode.</returns>
        static virtual TSelf Round(TSelf x) => TSelf.Round(x, digits: 0, MidpointRounding.ToEven);

        /// <summary>Rounds a value to a specified number of fractional-digits using the default rounding
        // mode (<see cref="MidpointRounding.ToEven" />).</summary>
        /// <param name="x">The value to round.</param>
        /// <param name="digits">The number of fractional digits to which <paramref name="x" /> should be
        // rounded.</param>
        /// <returns>The result of rounding <paramref name="x" /> to <paramref name="digits" />
        // fractional-digits using the default rounding mode.</returns>
        ...
        /// <returns>The result of rounding <paramref name="x" /> to the nearest integer using <paramref
        // name="mode" />.</returns>
        static virtual TSelf Round(TSelf x, MidpointRounding mode) =>
            TSelf.Round(x, digits: 0, mode);

        /// <summary>Rounds a value to a specified number of fractional-digits using the specified rounding
        // mode.</summary>
        /// <param name="x">The value to round.</param>
        /// <param name="digits">The number of fractional digits to which <paramref name="x" /> should be
        // rounded.</param>
        /// <param name="mode">The mode under which <paramref name="x" /> should be rounded.</param>
        /// <returns>The result of rounding <paramref name="x" /> to <paramref name="digits" />
        // fractional-digits using <paramref name="mode" />.</returns>
        ...
        /// <returns>The number of bytes that will be written as part of <see
        // cref="TryWriteSignificandLittleEndian(Span{byte}, out int)" />.</returns>
        ...
        // />.</param>
        /// <returns><c>true</c> if the exponent was successfully written to <paramref name="destination"
        // />; otherwise, <c>false</c>.</returns>
        bool TryWriteExponentBigEndian(Span<byte> destination, out int bytesWritten);

        /// <summary>Tries to write the current exponent, in little-endian format, to a given
        // span.</summary>
        /// <param name="destination">The span to which the current exponent should be written.</param>
        /// <param name="bytesWritten">The number of bytes written to <paramref name="destination"
        // />.</param>
        ...
        /// <summary>Tries to write the current significand, in big-endian format, to a given
        // span.</summary>
        /// <param name="destination">The span to which the current significand should be written.</param>
        /// <param name="bytesWritten">The number of bytes written to <paramref name="destination"
        // />.</param>
        /// <returns><c>true</c> if the significand was successfully written to <paramref name="destination"
        // />; otherwise, <c>false</c>.</returns>
        bool TryWriteSignificandBigEndian(Span<byte> destination, out int bytesWritten);

        /// <summary>Tries to write the current significand, in little-endian format, to a given
        // span.</summary>
        /// <param name="destination">The span to which the current significand should be written.</param>
        /// <param name="bytesWritten">The number of bytes written to <paramref name="destination"
        // />.</param>
