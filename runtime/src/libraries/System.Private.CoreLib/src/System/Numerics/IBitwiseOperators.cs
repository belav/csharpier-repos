...
namespace System.Numerics
{
    ...
    /// <typeparam name="TOther">The type that will is used in the operation with <typeparamref
    // name="TSelf" />.</typeparam>
    /// <typeparam name="TResult">The type that contains the result of <typeparamref name="TSelf" /> op
    // <typeparamref name="TOther" />.</typeparam>
