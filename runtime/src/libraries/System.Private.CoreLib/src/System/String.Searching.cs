...
#pragma warning restore CA2249
        ...
        public bool Contains(char value) =>
            SpanHelpers.ContainsValueType(
                ref Unsafe.As<char, short>(ref _firstChar),
                (short)value,
                Length
            );
...
#pragma warning restore CA2249
        ...
        public unsafe int IndexOf(char value, int startIndex, int count)
        {
            ...
            int result = SpanHelpers.IndexOfChar(
...
*/
        ...
        public int LastIndexOf(char value) =>
            SpanHelpers.LastIndexOfValueType(
                ref Unsafe.As<char, short>(ref _firstChar),
                (short)value,
                Length
            );
        ...
        public unsafe int LastIndexOf(char value, int startIndex, int count)
        {
            ...
            int result = SpanHelpers.LastIndexOfValueType(
                ref Unsafe.As<char, short>(ref Unsafe.Add(ref _firstChar, startSearchAt)),
                (short)value,
                count
            );
