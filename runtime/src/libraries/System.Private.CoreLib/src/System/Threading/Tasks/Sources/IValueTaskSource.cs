...
namespace System.Threading.Tasks.Sources
{
    ...
    /// <see cref="IValueTaskSource.OnCompleted"/> and <see
    // cref="IValueTaskSource{TResult}.OnCompleted"/>
    /// to control behavior.
    /// </summary>
    [Flags]
    public enum ValueTaskSourceOnCompletedFlags
    {
        ...
        /// <summary>
        /// Set if OnCompleted should capture the current ExecutionContext and use it to run the
        // continuation.
        /// </summary>
        FlowExecutionContext = 0x2,
    }

    /// <summary>Indicates the status of an <see cref="IValueTaskSource"/> or <see
    // cref="IValueTaskSource{TResult}"/>.</summary>
    ...
    public interface IValueTaskSource
    {
        ...
        /// <param name="token">Opaque value that was provided to the <see cref="ValueTask"/>'s
        // constructor.</param>
        ValueTaskSourceStatus GetStatus(short token);

        /// <summary>Schedules the continuation action for this <see cref="IValueTaskSource"/>.</summary>
        /// <param name="continuation">The continuation to invoke when the operation has completed.</param>
        /// <param name="state">The state object to pass to <paramref name="continuation"/> when it's
        // invoked.</param>
        /// <param name="token">Opaque value that was provided to the <see cref="ValueTask"/>'s
        // constructor.</param>
    ...
    /// <summary>Represents an object that can be wrapped by a <see
    // cref="ValueTask{TResult}"/>.</summary>
    ...
    public interface IValueTaskSource<out TResult>
    {
        ...
        /// <summary>Schedules the continuation action for this <see
        // cref="IValueTaskSource{TResult}"/>.</summary>
        /// <param name="continuation">The continuation to invoke when the operation has completed.</param>
        /// <param name="state">The state object to pass to <paramref name="continuation"/> when it's
        // invoked.</param>
