...
namespace System
{
    partial public abstract class Type : MemberInfo, IReflect
    {
        ...
        public MethodInfo? GetMethod(string name, Type[] types, ParameterModifier[]? modifiers) =>
            GetMethod(name, Type.DefaultLookup, null, types, modifiers);
        ...
        public MethodInfo? GetMethod(
            ...
            Type[] types,
            ParameterModifier[]? modifiers
        ) => GetMethod(name, genericParameterCount, Type.DefaultLookup, null, types, modifiers);
        ...
        public PropertyInfo? GetProperty(
            ...
            Type[] types,
            ParameterModifier[]? modifiers
        ) => GetProperty(name, Type.DefaultLookup, null, returnType, types, modifiers);
        ...
        [RequiresDynamicCode(
            "It might not be possible to create an array of the enum type at runtime. Use the GetEnumValues<TEnum> overload or the GetEnumValuesAsUnderlyingType method instead."
        )]
        ...
        public virtual bool Equals(Type? o) =>
            o == null
                ? false
                : object.ReferenceEquals(this.UnderlyingSystemType, o.UnderlyingSystemType);
