    ...
    public abstract partial class Enum : ValueType, IComparable, ISpanFormattable, IConvertible
    {
            ...
            where TEnum : struct, Enum
        {
            ...
            if (underlyingType == typeof(bool))
                return GetNameInlined(GetEnumInfo<byte>(rt), *(bool*)&value ? (byte)1 : (byte)0);
#endif
            ...
            where TEnum : struct, Enum
        {
            ...
            if (underlyingType == typeof(sbyte))
                names = GetEnumInfo<sbyte>(rt).Names;
            else if (underlyingType == typeof(byte))
                names = GetEnumInfo<byte>(rt).Names;
            else if (underlyingType == typeof(short))
                names = GetEnumInfo<short>(rt).Names;
            else if (underlyingType == typeof(ushort))
                names = GetEnumInfo<ushort>(rt).Names;
            else if (underlyingType == typeof(int))
                names = GetEnumInfo<int>(rt).Names;
            else if (underlyingType == typeof(uint))
                names = GetEnumInfo<uint>(rt).Names;
            else if (underlyingType == typeof(long))
                names = GetEnumInfo<long>(rt).Names;
            else if (underlyingType == typeof(ulong))
                names = GetEnumInfo<ulong>(rt).Names;
#if RARE_ENUMS
            else if (underlyingType == typeof(nint))
                names = GetEnumInfo<nint>(rt).Names;
        ...
        internal static string[] GetNamesNoCopy(RuntimeType enumType)
        {
            ...
            return InternalGetCorElementType(enumType) switch
            {
                ...
                CorElementType.ELEMENT_TYPE_R4
                    => GetEnumInfo<float>(enumType).Names,
        ...
        internal static Array GetValuesAsUnderlyingType(RuntimeType enumType)
        {
            ...
            return InternalGetCorElementType(enumType) switch
            {
                CorElementType.ELEMENT_TYPE_I1
                    => GetEnumInfo<sbyte>(enumType, getNames: false).CloneValues(),
                CorElementType.ELEMENT_TYPE_U1
                    => GetEnumInfo<byte>(enumType, getNames: false).CloneValues(),
                CorElementType.ELEMENT_TYPE_I2
                    => GetEnumInfo<short>(enumType, getNames: false).CloneValues(),
                CorElementType.ELEMENT_TYPE_U2
                    => GetEnumInfo<ushort>(enumType, getNames: false).CloneValues(),
                CorElementType.ELEMENT_TYPE_I4
                    => GetEnumInfo<int>(enumType, getNames: false).CloneValues(),
                CorElementType.ELEMENT_TYPE_U4
                    => GetEnumInfo<uint>(enumType, getNames: false).CloneValues(),
                CorElementType.ELEMENT_TYPE_I8
                    => GetEnumInfo<long>(enumType, getNames: false).CloneValues(),
                CorElementType.ELEMENT_TYPE_U8
                    => GetEnumInfo<ulong>(enumType, getNames: false).CloneValues(),
#if RARE_ENUMS
                CorElementType.ELEMENT_TYPE_R4
                    => GetEnumInfo<float>(enumType, getNames: false).CloneValues(),
                CorElementType.ELEMENT_TYPE_R8
                    => GetEnumInfo<double>(enumType, getNames: false).CloneValues(),
                CorElementType.ELEMENT_TYPE_I
                    => GetEnumInfo<nint>(enumType, getNames: false).CloneValues(),
                CorElementType.ELEMENT_TYPE_U
                    => GetEnumInfo<nuint>(enumType, getNames: false).CloneValues(),
                CorElementType.ELEMENT_TYPE_CHAR
                    => GetEnumInfo<char>(enumType, getNames: false).CloneValues(),
                CorElementType.ELEMENT_TYPE_BOOLEAN
                    => CopyByteArrayToNewBoolArray(
        ...
        internal static Array GetValuesAsUnderlyingTypeNoCopy(RuntimeType enumType)
        {
            ...
            {
                CorElementType.ELEMENT_TYPE_I1
                    => GetEnumInfo<sbyte>(enumType, getNames: false).Values,
                CorElementType.ELEMENT_TYPE_U1
                    => GetEnumInfo<byte>(enumType, getNames: false).Values,
                CorElementType.ELEMENT_TYPE_I2
                    => GetEnumInfo<short>(enumType, getNames: false).Values,
                CorElementType.ELEMENT_TYPE_U2
                    => GetEnumInfo<ushort>(enumType, getNames: false).Values,
                CorElementType.ELEMENT_TYPE_I4
                    => GetEnumInfo<int>(enumType, getNames: false).Values,
                CorElementType.ELEMENT_TYPE_U4
                    => GetEnumInfo<uint>(enumType, getNames: false).Values,
                CorElementType.ELEMENT_TYPE_I8
                    => GetEnumInfo<long>(enumType, getNames: false).Values,
                CorElementType.ELEMENT_TYPE_U8
                ...
                CorElementType.ELEMENT_TYPE_I
                    => GetEnumInfo<nint>(enumType, getNames: false).Values,
                CorElementType.ELEMENT_TYPE_U
                ...
                CorElementType.ELEMENT_TYPE_BOOLEAN
                    => CopyByteArrayToNewBoolArray(
                        GetEnumInfo<byte>(enumType, getNames: false).Values
                    ), // this is the only case that clones, out of necessity
#endif
                _ => throw CreateUnknownEnumTypeException(),
            };
        }
            ...
            where TEnum : struct, Enum
        {
            ...
            if (underlyingType == typeof(sbyte))
                return IsDefinedPrimitive(rt, *(sbyte*)&value);
            if (underlyingType == typeof(byte))
                return IsDefinedPrimitive(rt, *(byte*)&value);
            if (underlyingType == typeof(short))
                return IsDefinedPrimitive(rt, *(short*)&value);
            if (underlyingType == typeof(ushort))
                return IsDefinedPrimitive(rt, *(ushort*)&value);
            if (underlyingType == typeof(int))
                return IsDefinedPrimitive(rt, *(int*)&value);
            if (underlyingType == typeof(uint))
                return IsDefinedPrimitive(rt, *(uint*)&value);
            if (underlyingType == typeof(long))
                return IsDefinedPrimitive(rt, *(long*)&value);
            if (underlyingType == typeof(ulong))
                return IsDefinedPrimitive(rt, *(ulong*)&value);
#if RARE_ENUMS
            if (underlyingType == typeof(nint))
                return IsDefinedPrimitive(rt, *(nint*)&value);
            if (underlyingType == typeof(nuint))
            ...
            if (underlyingType == typeof(bool))
                return IsDefinedPrimitive(rt, *(bool*)&value ? (byte)1 : (byte)0);
#endif
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static int FindDefinedIndex<TUnderlyingValue>(
        ...
        private static unsafe bool TryParseByValueOrName<TUnderlyingValue>(
            ...
            bool ignoreCase,
            bool throwOnFailure,
            out TUnderlyingValue result
        )
            where TUnderlyingValue : struct,
                INumber<TUnderlyingValue>,
                IBitwiseOperators<TUnderlyingValue, TUnderlyingValue, TUnderlyingValue>,
                IMinMaxValue<TUnderlyingValue>
        {
            if (!value.IsEmpty)
            {
                char c = value[0];
                ...
                if (typeof(TUnderlyingValue) == typeof(int))
                {
                    ...
                    status = Number.TryParseInt32IntegerStyle(
                        ...
                        NumberStyle,
                        numberFormat,
                        out Unsafe.As<TUnderlyingValue, int>(ref result)
                    );
                ...
                else if (typeof(TUnderlyingValue) == typeof(uint))
                {
                    ...
                    status = Number.TryParseUInt32IntegerStyle(
                        ...
                        NumberStyle,
                        numberFormat,
                        out Unsafe.As<TUnderlyingValue, uint>(ref result)
                    );
                    if (status == Number.ParsingStatus.OK)
                    {
                        return true;
                ...
                else if (typeof(TUnderlyingValue) == typeof(long))
                {
                    ...
                    status = Number.TryParseInt64IntegerStyle(
                        ...
                        NumberStyle,
                        numberFormat,
                        out Unsafe.As<TUnderlyingValue, long>(ref result)
                    );
                    if (status == Number.ParsingStatus.OK)
                    {
                        return true;
                ...
                else if (typeof(TUnderlyingValue) == typeof(ulong))
                {
                    ...
                    status = Number.TryParseUInt64IntegerStyle(
                        ...
                        NumberStyle,
                        numberFormat,
                        out Unsafe.As<TUnderlyingValue, ulong>(ref result)
                    );
                    if (status == Number.ParsingStatus.OK)
                    {
                        return true;
                    ...
                    typeof(TUnderlyingValue) == typeof(byte)
                    || typeof(TUnderlyingValue) == typeof(ushort)
                )
                {
                    status = Number.TryParseUInt32IntegerStyle(
                        value,
                ...
                )
                {
                    ...
                    {
                        if (
                            int32result >= int.CreateTruncating(TUnderlyingValue.MinValue)
                            && int32result <= int.CreateTruncating(TUnderlyingValue.MaxValue)
                        )
                        {
                ...
                else
                {
                    ...
                    try
                    {
                        result = (TUnderlyingValue)ToObject(
                            enumType,
                            Convert.ChangeType(
                                value.ToString(),
                                underlyingType,
        ...
        private static bool TryParseByName<TUnderlyingValue>(
            RuntimeType enumType,
            ReadOnlySpan<char> value,
            bool ignoreCase,
            bool throwOnFailure,
...
#if RARE_ENUMS
                CorElementType.ELEMENT_TYPE_R4
                    => Unsafe.As<byte, float>(ref data).GetHashCode(),
        ...
        public override string ToString()
        {
            ...
            return InternalGetCorElementType() switch
            {
                ...
                CorElementType.ELEMENT_TYPE_I1
                    => ToString<sbyte>(enumType, ref rawData),
            ...
            static string HandleRareTypes(RuntimeType enumType, ref byte rawData) =>
                ...
                InternalGetCorElementType(enumType) switch
                {
                    ...
                    CorElementType.ELEMENT_TYPE_BOOLEAN
                        => ToStringBool(enumType, null, ref rawData),
                    _ => throw CreateUnknownEnumTypeException(),
                };
#else
                throw CreateUnknownEnumTypeException();
        ...
        public string ToString([StringSyntax(StringSyntaxAttribute.EnumFormat)] string? format)
        {
            ...
            if (format.Length == 1)
            {
                ...
                return InternalGetCorElementType() switch
                {
                    // Inlined for the most common base types
                    CorElementType.ELEMENT_TYPE_I1
                        => ToString<sbyte>(enumType, formatChar, ref rawData),
                    CorElementType.ELEMENT_TYPE_U1
                        => ToStringInlined<byte>(enumType, formatChar, ref rawData),
                    CorElementType.ELEMENT_TYPE_I2
                        => ToString<short>(enumType, formatChar, ref rawData),
                    CorElementType.ELEMENT_TYPE_U2
                        => ToString<ushort>(enumType, formatChar, ref rawData),
                    CorElementType.ELEMENT_TYPE_I4
                        => ToStringInlined<int>(enumType, formatChar, ref rawData),
                    CorElementType.ELEMENT_TYPE_U4
                        => ToString<uint>(enumType, formatChar, ref rawData),
                    CorElementType.ELEMENT_TYPE_I8
                        => ToString<long>(enumType, formatChar, ref rawData),
                    CorElementType.ELEMENT_TYPE_U8
                        => ToString<ulong>(enumType, formatChar, ref rawData),
            ...
            static string HandleRareTypes(
                ...
                {
                    CorElementType.ELEMENT_TYPE_R4
                        => ToString<float>(enumType, formatChar, ref rawData),
                    CorElementType.ELEMENT_TYPE_R8
                        => ToString<double>(enumType, formatChar, ref rawData),
                    CorElementType.ELEMENT_TYPE_I
                        => ToString<nint>(enumType, formatChar, ref rawData),
                    CorElementType.ELEMENT_TYPE_U
                        => ToString<nuint>(enumType, formatChar, ref rawData),
                    CorElementType.ELEMENT_TYPE_CHAR
                        => ToString<char>(enumType, formatChar, ref rawData),
                    CorElementType.ELEMENT_TYPE_BOOLEAN
                        => ToStringBool(enumType, formatChar.ToString(), ref rawData),
                    _ => throw CreateUnknownEnumTypeException(),
                };
#else
                throw CreateUnknownEnumTypeException();
        ...
        private static string ToStringInlined<TUnderlyingValue>(
            RuntimeType enumType,
            ref byte rawData
        )
            where TUnderlyingValue : struct,
        ...
        [MethodImpl(MethodImplOptions.NoInlining)] // avoid bloating call sites for underlying types and/or call sites that aren't perf critical
        private static string ToString<TUnderlyingValue>(
            RuntimeType enumType,
            char format,
            ref byte rawData
        )
        ...
        private static string ToStringBool(RuntimeType enumType, string? format, ref byte rawData)
        {
            ...
            switch (format[0] | 0x20)
            {
                case 'g':
                    ...
                    result = enumInfo.HasFlagsAttribute
                        ? FormatFlagNames(enumInfo, byteValue)
                        : GetName(enumInfo, byteValue);
                    if (result is null)
                    {
                        goto case 'd';
                    }
        ...
        private static bool TryFormatBool(
            RuntimeType enumType,
            bool boolValue,
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static unsafe string FormatNumberAsHex<TUnderlyingValue>(ref byte data)
            where TUnderlyingValue : struct
        {
            fixed (byte* ptr = &data)
            {
                return string.Create(
                    Unsafe.SizeOf<TUnderlyingValue>() * 2,
                    (IntPtr)ptr,
                    (destination, intptr) =>
                    {
                        bool success = TryFormatNumberAsHex<TUnderlyingValue>(
                            ref *(byte*)intptr,
                            destination,
                            out int charsWritten
                        );
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static bool TryFormatNumberAsHex<TUnderlyingValue>(
            ref byte data,
            Span<char> destination,
            out int charsWritten
        )
            where TUnderlyingValue : struct
        {
            if (Unsafe.SizeOf<TUnderlyingValue>() * 2 <= destination.Length)
            {
                ...
                )
                {
                    ...
                    typeof(TUnderlyingValue) == typeof(uint)
                    ||
#if TARGET_32BIT
                ...
                )
                {
                    ...
                    typeof(TUnderlyingValue) == typeof(ulong)
                    ||
#if TARGET_64BIT
                    typeof(TUnderlyingValue) == typeof(nuint)
                    || typeof(TUnderlyingValue) == typeof(nint)
        ...
        )
        {
            ...
            else
            {
                ...
                if (format.Length == 1)
                {
                    ...
                    {
                        CorElementType.ELEMENT_TYPE_I1
                            => ToString<sbyte>(rtType, formatChar, ref rawData),
                        CorElementType.ELEMENT_TYPE_U1
                            => ToString<byte>(rtType, formatChar, ref rawData),
                        CorElementType.ELEMENT_TYPE_I2
                            => ToString<short>(rtType, formatChar, ref rawData),
                        CorElementType.ELEMENT_TYPE_U2
                            => ToString<ushort>(rtType, formatChar, ref rawData),
                        CorElementType.ELEMENT_TYPE_I4
                            => ToString<int>(rtType, formatChar, ref rawData),
                        CorElementType.ELEMENT_TYPE_U4
                            => ToString<uint>(rtType, formatChar, ref rawData),
                        CorElementType.ELEMENT_TYPE_I8
                            => ToString<long>(rtType, formatChar, ref rawData),
                        CorElementType.ELEMENT_TYPE_U8
                            => ToString<ulong>(rtType, formatChar, ref rawData),
#if RARE_ENUMS
                        CorElementType.ELEMENT_TYPE_R4
                            => ToString<float>(rtType, formatChar, ref rawData),
                        CorElementType.ELEMENT_TYPE_R8
                            => ToString<double>(rtType, formatChar, ref rawData),
                        CorElementType.ELEMENT_TYPE_I
                            => ToString<nint>(rtType, formatChar, ref rawData),
                        CorElementType.ELEMENT_TYPE_U
                            => ToString<nuint>(rtType, formatChar, ref rawData),
                        CorElementType.ELEMENT_TYPE_CHAR
                            => ToString<char>(rtType, formatChar, ref rawData),
                        CorElementType.ELEMENT_TYPE_BOOLEAN
                            => ToStringBool(rtType, format, ref rawData),
#endif
                        _ => throw CreateUnknownEnumTypeException(),
                    };
                }
            ...
            where TEnum : struct, Enum
        {
            ...
            {
                if (underlyingType == typeof(int))
                    return TryFormatPrimitiveDefault(
                        rt,
                        *(int*)&value,
                        destination,
                        out charsWritten
            ...
            {
                if (underlyingType == typeof(int))
                    return TryFormatPrimitiveNonDefault(
                        rt,
                        *(int*)&value,
                        destination,
                        out charsWritten,
                ...
                if (underlyingType == typeof(bool))
                    return TryFormatBool(rt, *(bool*)&value, destination, out charsWritten, format);
#endif
            }
        ...
        private static bool TryFormatPrimitiveDefault<TUnderlyingValue>(
            RuntimeType enumType,
            TUnderlyingValue value,
            Span<char> destination,
            out int charsWritten
        ...
        private static bool TryFormatPrimitiveNonDefault<TUnderlyingValue>(
            RuntimeType enumType,
            TUnderlyingValue value,
            Span<char> destination,
            out int charsWritten,
                ...
                IMinMaxValue<TUnderlyingValue>
        {
            ...
            if (format.Length == 1)
            {
                switch (format[0] | 0x20)
                {
                    ...
                    case 'x':
                        return TryFormatNumberAsHex<TUnderlyingValue>(
                            ref Unsafe.As<TUnderlyingValue, byte>(ref value),
                            destination,
                            out charsWritten
                        );
        ...
        private static string? FormatFlagNames<TUnderlyingValue>(
            EnumInfo<TUnderlyingValue> enumInfo,
            TUnderlyingValue resultValue
        )
            where TUnderlyingValue : struct,
                INumber<TUnderlyingValue>,
                IBitwiseOperators<TUnderlyingValue, TUnderlyingValue, TUnderlyingValue>
        ...
        /// </returns>
        private static bool TryFormatFlagNames<TUnderlyingValue>(
            EnumInfo<TUnderlyingValue> enumInfo,
            TUnderlyingValue resultValue,
            Span<char> destination,
            out int charsWritten,
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)] // used twice, once from string-based and once from span-based code path
        private static string? GetSingleFlagsEnumNameForValue<TUnderlyingValue>(
            TUnderlyingValue resultValue,
            string[] names,
            TUnderlyingValue[] values,
            out int index
            ...
            where TUnderlyingValue : struct, INumber<TUnderlyingValue>
        {
            ...
            {
                index = 0;
                return values.Length > 0 && values[0] == TUnderlyingValue.Zero ? names[0] : "0";
            }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)] // used twice, once from string-based and once from span-based code path
        private static bool TryFindFlagsNames<TUnderlyingValue>(
            TUnderlyingValue resultValue,
            string[] names,
            TUnderlyingValue[] values,
            int index,
        ...
        internal static bool AreSequentialFromZero<TUnderlyingValue>(TUnderlyingValue[] values)
            where TUnderlyingValue : struct, INumber<TUnderlyingValue>
        {
        ...
        internal static bool AreSorted<TUnderlyingValue>(TUnderlyingValue[] values)
            where TUnderlyingValue : struct, IComparable<TUnderlyingValue>
        {
