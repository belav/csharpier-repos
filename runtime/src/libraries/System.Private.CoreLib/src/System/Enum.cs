    ...
    public abstract partial class Enum : ValueType, IComparable, IFormattable, IConvertible
    {
        ...
        public int CompareTo(object? target)
        {
            ...
            switch (InternalGetCorElementType())
            {
                ...
                case CorElementType.ELEMENT_TYPE_I:
#endif
                    return Unsafe.As<byte, int>(ref pThisValue)
                ...
                case CorElementType.ELEMENT_TYPE_I:
#endif
                    return Unsafe.As<byte, long>(ref pThisValue)
                ...
                case CorElementType.ELEMENT_TYPE_R4:
                    return Unsafe.As<byte, float>(ref pThisValue)
                        .CompareTo(Unsafe.As<byte, float>(ref pTargetValue));
                case CorElementType.ELEMENT_TYPE_R8:
                    return Unsafe.As<byte, double>(ref pThisValue)
