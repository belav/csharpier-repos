...
namespace System
{
    partial internal sealed class RuntimeType : TypeInfo, ICloneable
    {
            ...
            return GetTypeCode(underlyingType) switch
            {
                ...
                _
                    => underlyingType == typeof(nint)
                        ? Enum.IsDefinedPrimitive(this, (nint)value)
                        : underlyingType == typeof(nuint)
                            ? Enum.IsDefinedPrimitive(this, (nuint)value)
                            : throw new InvalidOperationException(
                                SR.InvalidOperation_UnknownEnumType
                            ),
            };
        }
        ...
        internal static bool TryGetByRefElementType(
            RuntimeType type,
            [NotNullWhen(true)] out RuntimeType? elementType
        )
        {
        ...
        )
        {
            ...
            if (
                result == CheckValueStatus.ArgumentException
        ...
        )
        {
            ...
            if (TryGetByRefElementType(this, out sigElementType))
            {
                ...
                if (value == null)
                {
                    ...
                    copyBack = sigElementType.IsNullableOfT
                        ? ParameterCopyBackAction.CopyNullable
                        : ParameterCopyBackAction.Copy;
                    return CheckValueStatus.Success;
                }
        ...
        {
            if (
                TryGetByRefElementType(this, out RuntimeType? sigElementType)
