...
namespace System.Reflection
{
    public class TypeDelegator : TypeInfo
    {
        ...
        public override ConstructorInfo[] GetConstructors(BindingFlags bindingAttr) =>
            typeImpl.GetConstructors(bindingAttr);
        ...
        public override MethodInfo[] GetMethods(BindingFlags bindingAttr) =>
            typeImpl.GetMethods(bindingAttr);
        ...
        public override FieldInfo? GetField(string name, BindingFlags bindingAttr) =>
            typeImpl.GetField(name, bindingAttr);
        ...
        public override EventInfo? GetEvent(string name, BindingFlags bindingAttr) =>
            typeImpl.GetEvent(name, bindingAttr);
        ...
        public override PropertyInfo[] GetProperties(BindingFlags bindingAttr) =>
            typeImpl.GetProperties(bindingAttr);
        ...
        public override EventInfo[] GetEvents(BindingFlags bindingAttr) =>
            typeImpl.GetEvents(bindingAttr);
        ...
        public override Type[] GetNestedTypes(BindingFlags bindingAttr) =>
            typeImpl.GetNestedTypes(bindingAttr);
        ...
        public override Type? GetNestedType(string name, BindingFlags bindingAttr) =>
            typeImpl.GetNestedType(name, bindingAttr);
        ...
        public override MemberInfo[] GetMember(
            ...
            MemberTypes type,
            BindingFlags bindingAttr
        ) => typeImpl.GetMember(name, type, bindingAttr);
        ...
        public override MemberInfo GetMemberWithSameMetadataDefinitionAs(MemberInfo member) =>
            typeImpl.GetMemberWithSameMetadataDefinitionAs(member);
