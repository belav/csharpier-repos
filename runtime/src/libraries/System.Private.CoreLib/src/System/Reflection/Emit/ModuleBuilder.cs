...
namespace System.Reflection.Emit
{
    public abstract class ModuleBuilder : Module
    {
        ...
        public void CreateGlobalFunctions() => CreateGlobalFunctionsCore();
        ...
        protected abstract EnumBuilder DefineEnumCore(
            string name,
        ...
        protected abstract MethodBuilder DefineGlobalMethodCore(
            string name,
            MethodAttributes attributes,
            CallingConventions callingConvention,
            Type? returnType,
        ...
        protected abstract TypeBuilder DefineTypeCore(
            string name,
            TypeAttributes attr,
            [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.All)] Type? parent,
            Type[]? interfaces,
        ...
        protected abstract MethodInfo GetArrayMethodCore(
            Type arrayClass,
            string methodName,
            CallingConventions callingConvention,
            Type? returnType,
