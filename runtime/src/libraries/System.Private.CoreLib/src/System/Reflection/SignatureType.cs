...
namespace System.Reflection
{
    ...
    internal abstract class SignatureType : Type
    {
        ...
        public sealed override bool IsGenericType =>
            IsGenericTypeDefinition || IsConstructedGenericType;
        ...
        public sealed override Type MakeGenericType(params Type[] typeArguments) =>
            throw new NotSupportedException(SR.NotSupported_SignatureType); // There is no SignatureType for type definition types so it would never be legal to call this.
