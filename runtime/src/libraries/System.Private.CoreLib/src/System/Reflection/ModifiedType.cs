...
namespace System.Reflection
{
    ...
    internal partial class ModifiedType : Type
    {
        ...
        public override Type GetFunctionPointerReturnType() =>
            _unmodifiedType.GetFunctionPointerReturnType();
        ...
        public override object[] GetCustomAttributes(bool inherit) =>
            _unmodifiedType.GetCustomAttributes(inherit);

        public override object[] GetCustomAttributes(Type attributeType, bool inherit) =>
            _unmodifiedType.GetCustomAttributes(attributeType, inherit);

        public override bool IsDefined(Type attributeType, bool inherit) =>
            _unmodifiedType.IsDefined(attributeType, inherit);
    }
}
