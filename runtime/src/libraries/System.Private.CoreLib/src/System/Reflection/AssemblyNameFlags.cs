...
namespace System.Reflection
{
    ...
    public enum AssemblyNameFlags
    {
        ...
        // Flag used to indicate that an assembly ref contains the full public key, not the compressed
        // token.
        ...
        Retargetable = 0x0100,
        // ContentType             = 0x0E00, // Bits describing the ContentType are accessible via
