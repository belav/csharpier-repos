...
namespace System
{
    ...
    public static partial class MemoryExtensions
    {
            ...
            where T : IEquatable<T>?
        {
            ...
            return SpanHelpers.LastIndexOf<T>(
                ref MemoryMarshal.GetReference(span),
                value,
                span.Length
            );
        ...
        /// </returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int IndexOfAnyExcept<T>(this Span<T> span, IndexOfAnyValues<T> values)
            where T : IEquatable<T>? => IndexOfAnyExcept((ReadOnlySpan<T>)span, values);
        ...
        public static int IndexOfAnyExcept<T>(this ReadOnlySpan<T> span, IndexOfAnyValues<T> values)
            where T : IEquatable<T>? => IndexOfAnyValues<T>.IndexOfAnyExcept(span, values);
        ...
        /// </returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int LastIndexOfAnyExcept<T>(this Span<T> span, IndexOfAnyValues<T> values)
            where T : IEquatable<T>? => LastIndexOfAnyExcept((ReadOnlySpan<T>)span, values);
        ...
        /// <param name="values">The set of values to search for.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int IndexOfAny<T>(this Span<T> span, IndexOfAnyValues<T> values)
            where T : IEquatable<T>? => IndexOfAny((ReadOnlySpan<T>)span, values);
        ...
        public static int IndexOfAny<T>(this ReadOnlySpan<T> span, IndexOfAnyValues<T> values)
            where T : IEquatable<T>? => IndexOfAnyValues<T>.IndexOfAny(span, values);
        ...
        /// <param name="values">The set of values to search for.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int LastIndexOfAny<T>(this Span<T> span, IndexOfAnyValues<T> values)
            where T : IEquatable<T>? => LastIndexOfAny((ReadOnlySpan<T>)span, values);
        ...
        public static int LastIndexOfAny<T>(this ReadOnlySpan<T> span, IndexOfAnyValues<T> values)
            where T : IEquatable<T>? => IndexOfAnyValues<T>.LastIndexOfAny(span, values);
        ...
        public static bool TryWrite(
            ...
            [InterpolatedStringHandlerArgument("destination", "provider")]
                ref TryWriteInterpolatedStringHandler handler,
            out int charsWritten
        ) =>
                    ...
                    if ((uint)pos < destination.Length - 1)
                    {
                        Unsafe.WriteUnaligned(
                            ref Unsafe.As<char, byte>(
                                ref Unsafe.Add(ref MemoryMarshal.GetReference(destination), pos)
                            ),
