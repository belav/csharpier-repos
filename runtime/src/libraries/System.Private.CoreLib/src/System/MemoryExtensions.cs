    ...
    public static partial class MemoryExtensions
    {
        ...
        public static Span<T> AsSpan<T>(this T[]? array, Index startIndex)
        {
            ...
            return new Span<T>(
                ref Unsafe.Add(
                    ref MemoryMarshal.GetArrayDataReference(array),
                    (nint)(uint)actualIndex /* force zero-extension */
                ),
                array.Length - actualIndex
            );
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static unsafe bool Contains<T>(this ReadOnlySpan<T> span, T value)
            where T : IEquatable<T>?
        {
            if (RuntimeHelpers.IsBitwiseEquatable<T>())
            {
        ...
        public static bool ContainsAny<T>(this Span<T> span, T value0, T value1)
            where T : IEquatable<T>? => ContainsAny((ReadOnlySpan<T>)span, value0, value1);
        ...
        public static bool ContainsAny<T>(this Span<T> span, T value0, T value1, T value2)
            where T : IEquatable<T>? => ContainsAny((ReadOnlySpan<T>)span, value0, value1, value2);
        ...
        public static bool ContainsAny<T>(this Span<T> span, ReadOnlySpan<T> values)
            where T : IEquatable<T>? => ContainsAny((ReadOnlySpan<T>)span, values);

        /// <inheritdoc cref="ContainsAny{T}(ReadOnlySpan{T}, SearchValues{T})"/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool ContainsAny<T>(this Span<T> span, SearchValues<T> values)
            where T : IEquatable<T>? => ContainsAny((ReadOnlySpan<T>)span, values);
        ...
        public static bool ContainsAnyExcept<T>(this Span<T> span, T value)
            where T : IEquatable<T>? => ContainsAnyExcept((ReadOnlySpan<T>)span, value);
        ...
        public static bool ContainsAnyExcept<T>(this Span<T> span, T value0, T value1)
            where T : IEquatable<T>? => ContainsAnyExcept((ReadOnlySpan<T>)span, value0, value1);
        ...
        public static bool ContainsAnyExcept<T>(this Span<T> span, ReadOnlySpan<T> values)
            where T : IEquatable<T>? => ContainsAnyExcept((ReadOnlySpan<T>)span, values);

        /// <inheritdoc cref="ContainsAnyExcept{T}(ReadOnlySpan{T}, SearchValues{T})"/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool ContainsAnyExcept<T>(this Span<T> span, SearchValues<T> values)
            where T : IEquatable<T>? => ContainsAnyExcept((ReadOnlySpan<T>)span, values);
        ...
        public static bool ContainsAny<T>(this ReadOnlySpan<T> span, T value0, T value1)
            where T : IEquatable<T>? => IndexOfAny(span, value0, value1) >= 0;
        ...
        public static bool ContainsAny<T>(this ReadOnlySpan<T> span, T value0, T value1, T value2)
            where T : IEquatable<T>? => IndexOfAny(span, value0, value1, value2) >= 0;
        ...
        public static bool ContainsAny<T>(this ReadOnlySpan<T> span, ReadOnlySpan<T> values)
            where T : IEquatable<T>? => IndexOfAny(span, values) >= 0;
        ...
        /// <param name="values">The set of values to search for.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool ContainsAny<T>(this ReadOnlySpan<T> span, SearchValues<T> values)
            where T : IEquatable<T>? => IndexOfAny(span, values) >= 0;
        ...
        public static bool ContainsAnyExcept<T>(this ReadOnlySpan<T> span, T value)
            where T : IEquatable<T>? => IndexOfAnyExcept(span, value) >= 0;
        ...
        public static bool ContainsAnyExcept<T>(this ReadOnlySpan<T> span, T value0, T value1)
            where T : IEquatable<T>? => IndexOfAnyExcept(span, value0, value1) >= 0;
        ...
        public static bool ContainsAnyExcept<T>(
            ...
            where T : IEquatable<T>? => IndexOfAnyExcept(span, value0, value1, value2) >= 0;
        ...
        public static bool ContainsAnyExcept<T>(this ReadOnlySpan<T> span, ReadOnlySpan<T> values)
            where T : IEquatable<T>? => IndexOfAnyExcept(span, values) >= 0;
        ...
        /// </returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool ContainsAnyExcept<T>(this ReadOnlySpan<T> span, SearchValues<T> values)
            where T : IEquatable<T>? => IndexOfAnyExcept(span, values) >= 0;
        ...
        public static bool ContainsAnyInRange<T>(
            ...
            where T : IComparable<T> => IndexOfAnyInRange(span, lowInclusive, highInclusive) >= 0;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static unsafe int IndexOf<T>(this Span<T> span, ReadOnlySpan<T> value)
            where T : IEquatable<T>?
        {
            if (RuntimeHelpers.IsBitwiseEquatable<T>())
            {
        ...
        /// <param name="value">The sequence to search for.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static unsafe int LastIndexOf<T>(this Span<T> span, ReadOnlySpan<T> value)
            where T : IEquatable<T>?
        {
            if (RuntimeHelpers.IsBitwiseEquatable<T>())
            {
        ...
        public static int IndexOfAnyExcept<T>(this Span<T> span, T value)
            where T : IEquatable<T>? => IndexOfAnyExcept((ReadOnlySpan<T>)span, value);
        ...
        public static int IndexOfAnyExcept<T>(this Span<T> span, T value0, T value1)
            where T : IEquatable<T>? => IndexOfAnyExcept((ReadOnlySpan<T>)span, value0, value1);
        ...
        public static int IndexOfAnyExcept<T>(this Span<T> span, ReadOnlySpan<T> values)
            where T : IEquatable<T>? => IndexOfAnyExcept((ReadOnlySpan<T>)span, values);
        ...
        /// </returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int IndexOfAnyExcept<T>(this Span<T> span, SearchValues<T> values)
            where T : IEquatable<T>? => IndexOfAnyExcept((ReadOnlySpan<T>)span, values);
        ...
        /// </returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static unsafe int IndexOfAnyExcept<T>(this ReadOnlySpan<T> span, T value)
            where T : IEquatable<T>?
        {
            if (RuntimeHelpers.IsBitwiseEquatable<T>())
            {
        ...
        /// </returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static unsafe int IndexOfAnyExcept<T>(this ReadOnlySpan<T> span, T value0, T value1)
            where T : IEquatable<T>?
        {
            if (RuntimeHelpers.IsBitwiseEquatable<T>())
            {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static unsafe int IndexOfAnyExcept<T>(
            this ReadOnlySpan<T> span,
            T value0,
            T value1,
            T value2,
            ...
            switch (values.Length)
            {
                ...
                default:
                    if (RuntimeHelpers.IsBitwiseEquatable<T>())
                    {
                        ...
                        {
                            ref byte valuesRef = ref Unsafe.As<T, byte>(
                        ...
                        {
                            ref short valuesRef = ref Unsafe.As<T, short>(
                                ref MemoryMarshal.GetReference(values)
                            );
        ...
        /// </returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int IndexOfAnyExcept<T>(this ReadOnlySpan<T> span, SearchValues<T> values)
            where T : IEquatable<T>?
        {
            if (values is null)
            {
        ...
        public static int LastIndexOfAnyExcept<T>(this Span<T> span, T value)
            where T : IEquatable<T>? => LastIndexOfAnyExcept((ReadOnlySpan<T>)span, value);
        ...
        public static int LastIndexOfAnyExcept<T>(this Span<T> span, T value0, T value1)
            where T : IEquatable<T>? => LastIndexOfAnyExcept((ReadOnlySpan<T>)span, value0, value1);
        ...
        public static int LastIndexOfAnyExcept<T>(this Span<T> span, ReadOnlySpan<T> values)
            where T : IEquatable<T>? => LastIndexOfAnyExcept((ReadOnlySpan<T>)span, values);
        ...
        /// </returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int LastIndexOfAnyExcept<T>(this Span<T> span, SearchValues<T> values)
            where T : IEquatable<T>? => LastIndexOfAnyExcept((ReadOnlySpan<T>)span, values);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static unsafe int LastIndexOfAnyExcept<T>(
            this ReadOnlySpan<T> span,
            T value0,
            T value1,
            T value2,
        ...
        /// </returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int LastIndexOfAnyExcept<T>(this ReadOnlySpan<T> span, SearchValues<T> values)
            where T : IEquatable<T>?
        {
            if (values is null)
            {
            ...
            where T : IComparable<T>
        {
            ...
            if (Vector128.IsHardwareAccelerated)
            {
                ...
                if (
                    lowInclusive is int or uint
                    || (IntPtr.Size == 4 && (lowInclusive is nint or nuint))
                )
                {
                    return SpanHelpers.IndexOfAnyInRangeUnsignedNumber(
                ...
                if (
                    lowInclusive is long or ulong
                    || (IntPtr.Size == 8 && (lowInclusive is nint or nuint))
                )
                {
                    return SpanHelpers.IndexOfAnyInRangeUnsignedNumber(
            ...
            return SpanHelpers.IndexOfAnyInRange(
                ref MemoryMarshal.GetReference(span),
                lowInclusive,
                highInclusive,
                span.Length
            ...
            where T : IComparable<T>
        {
            ...
            return SpanHelpers.IndexOfAnyExceptInRange(
                ref MemoryMarshal.GetReference(span),
                lowInclusive,
                highInclusive,
                span.Length
            ...
            where T : IComparable<T>
        {
            ...
            return SpanHelpers.LastIndexOfAnyInRange(
                ref MemoryMarshal.GetReference(span),
                lowInclusive,
                highInclusive,
                span.Length
            ...
            where T : IComparable<T>
        {
            ...
            return SpanHelpers.LastIndexOfAnyExceptInRange(
                ref MemoryMarshal.GetReference(span),
                lowInclusive,
                highInclusive,
                span.Length
        ...
        private static void ThrowNullLowHighInclusive<T>(T? lowInclusive, T? highInclusive)
        {
            ...
            throw new ArgumentNullException(
                lowInclusive is null ? nameof(lowInclusive) : nameof(highInclusive)
            );
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static unsafe bool SequenceEqual<T>(this Span<T> span, ReadOnlySpan<T> other)
            where T : IEquatable<T>?
        {
            ...
            if (RuntimeHelpers.IsBitwiseEquatable<T>())
            {
                return length == otherLength
                    && SpanHelpers.SequenceEqual(
                        ...
                        ((uint)otherLength) * (nuint)sizeof(T)
        ...
        /// <param name="value1">One of the values to search for.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static unsafe int IndexOfAny<T>(this Span<T> span, T value0, T value1)
            where T : IEquatable<T>?
        {
            if (RuntimeHelpers.IsBitwiseEquatable<T>())
            {
        ...
        /// <param name="value2">One of the values to search for.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static unsafe int IndexOfAny<T>(this Span<T> span, T value0, T value1, T value2)
            where T : IEquatable<T>?
        {
            if (RuntimeHelpers.IsBitwiseEquatable<T>())
            {
        ...
        public static int IndexOfAny<T>(this Span<T> span, ReadOnlySpan<T> values)
            where T : IEquatable<T>? => IndexOfAny((ReadOnlySpan<T>)span, values);
        ...
        /// <param name="values">The set of values to search for.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int IndexOfAny<T>(this Span<T> span, SearchValues<T> values)
            where T : IEquatable<T>? => IndexOfAny((ReadOnlySpan<T>)span, values);
            ...
            where T : IEquatable<T>?
        {
            if (RuntimeHelpers.IsBitwiseEquatable<T>())
            {
                if (sizeof(T) == sizeof(byte))
                {
                    ...
                    ref byte valueRef = ref Unsafe.As<T, byte>(
                        ref MemoryMarshal.GetReference(values)
                    );
                    switch (values.Length)
                    {
                ...
                if (sizeof(T) == sizeof(short))
                {
                    ref short spanRef = ref Unsafe.As<T, short>(
                        ref MemoryMarshal.GetReference(span)
                    );
                    ref short valueRef = ref Unsafe.As<T, short>(
                        ref MemoryMarshal.GetReference(values)
                    );
                    switch (values.Length)
                    {
                        ...
                        default:
                            return ProbabilisticMap.IndexOfAny(
                                ref Unsafe.As<short, char>(ref spanRef),
                                span.Length,
                                ref Unsafe.As<short, char>(ref valueRef),
                                values.Length
                            );
                    }
                }
        ...
        /// <param name="values">The set of values to search for.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int IndexOfAny<T>(this ReadOnlySpan<T> span, SearchValues<T> values)
            where T : IEquatable<T>?
        {
            if (values is null)
            {
        ...
        /// <param name="value1">One of the values to search for.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static unsafe int LastIndexOfAny<T>(this Span<T> span, T value0, T value1)
            where T : IEquatable<T>?
        {
            if (RuntimeHelpers.IsBitwiseEquatable<T>())
            {
        ...
        /// <param name="value2">One of the values to search for.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static unsafe int LastIndexOfAny<T>(this Span<T> span, T value0, T value1, T value2)
            where T : IEquatable<T>?
        {
            if (RuntimeHelpers.IsBitwiseEquatable<T>())
            {
        ...
        public static int LastIndexOfAny<T>(this Span<T> span, ReadOnlySpan<T> values)
            where T : IEquatable<T>? => LastIndexOfAny((ReadOnlySpan<T>)span, values);
        ...
        /// <param name="values">The set of values to search for.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int LastIndexOfAny<T>(this Span<T> span, SearchValues<T> values)
            where T : IEquatable<T>? => LastIndexOfAny((ReadOnlySpan<T>)span, values);
        ...
        /// <param name="values">The set of values to search for.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int LastIndexOfAny<T>(this ReadOnlySpan<T> span, SearchValues<T> values)
            where T : IEquatable<T>?
        {
            if (values is null)
            {
                ...
                if (comparer is null || comparer == EqualityComparer<T>.Default)
                {
                    ...
                    if (RuntimeHelpers.IsBitwiseEquatable<T>())
                    {
                        return SpanHelpers.SequenceEqual(
                            ref Unsafe.As<T, byte>(ref MemoryMarshal.GetReference(span)),
                            ref Unsafe.As<T, byte>(ref MemoryMarshal.GetReference(other)),
                            ((uint)span.Length) * (nuint)sizeof(T)
                        ); // If this multiplication overflows, the Span we got overflows the entire address range. There's no happy outcome for this API in such a case so we choose not to take the overhead of checking.
                    }
        ...
        [Intrinsic] // Unrolled and vectorized for half-constant input
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static unsafe bool StartsWith<T>(this Span<T> span, ReadOnlySpan<T> value)
            where T : IEquatable<T>?
        {
            ...
            if (RuntimeHelpers.IsBitwiseEquatable<T>())
            {
                return valueLength <= span.Length
                    && SpanHelpers.SequenceEqual(
                        ref Unsafe.As<T, byte>(ref MemoryMarshal.GetReference(span)),
                        ref Unsafe.As<T, byte>(ref MemoryMarshal.GetReference(value)),
                        ((uint)valueLength) * (nuint)sizeof(T)
                    ); // If this multiplication overflows, the Span we got overflows the entire address range. There's no happy outcome for this api in such a case so we choose not to take the overhead of checking.
            }
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static unsafe bool EndsWith<T>(this Span<T> span, ReadOnlySpan<T> value)
            where T : IEquatable<T>?
        {
                ...
                return valueLength <= spanLength
                    && SpanHelpers.SequenceEqual(
                        ref Unsafe.As<T, byte>(
                            ref Unsafe.Add(
                                ref MemoryMarshal.GetReference(span),
                                (nint)(uint)(spanLength - valueLength) /* force zero-extension */
                            )
                        ),
                        ref Unsafe.As<T, byte>(ref MemoryMarshal.GetReference(value)),
                        ((uint)valueLength) * (nuint)sizeof(T)
        ...
        /// Determines whether two sequences overlap in memory and outputs the element offset.
        /// </summary>
        public static unsafe bool Overlaps<T>(
            this ReadOnlySpan<T> span,
            ReadOnlySpan<T> other,
            out int elementOffset
        )
        {
            ...
            if (
                (nuint)byteOffset < (nuint)((nint)span.Length * sizeof(T))
                || (nuint)byteOffset > (nuint)(-((nint)other.Length * sizeof(T)))
            )
            {
            ...
            where TComparer : IComparer<T>
        {
            ...
            var comparable = new SpanHelpers.ComparerComparable<T, TComparer>(value, comparer);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static unsafe void Replace<T>(this Span<T> span, T oldValue, T newValue)
            where T : IEquatable<T>?
        {
        ...
        /// <param name="other">The second sequence to compare.</param>
        /// <returns>The length of the common prefix shared by the two spans.  If there's no shared prefix, 0 is returned.</returns>
        public static unsafe int CommonPrefixLength<T>(
            this ReadOnlySpan<T> span,
            ReadOnlySpan<T> other
        )
        {
        ...
        )
        {
            ...
            if (
                ...
                && (comparer is null || comparer == EqualityComparer<T>.Default)
            )
            {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static void SliceLongerSpanToMatchShorterLength<T>(
            ref ReadOnlySpan<T> span,
            ref ReadOnlySpan<T> other
        )
        {
        ...
        )
        {
            ...
            if (separator.IsEmpty)
            {
                if (!destination.IsEmpty)
                {
                    ...
                    {
                        (startInclusive, endExclusive) = TrimSplitEntry(
                            source,
                            startInclusive,
                            endExclusive
                        );
        ...
        private static int SplitCore(
            ...
            Span<Range> destination,
            ReadOnlySpan<char> separatorOrSeparators,
        ...
        )
        {
            ...
            scoped ValueListBuilder<int> separatorList = new ValueListBuilder<int>(
                stackalloc int[string.StackallocIntBufferSizeLimit]
            );
            ...
            {
                lengthList = new ValueListBuilder<int>(
                    stackalloc int[string.StackallocIntBufferSizeLimit]
                );
                string.MakeSeparatorListAny(
                    source,
                    stringSeparators,
                    ref separatorList,
                    ref lengthList
            ...
            while (
                separatorIndex < separatorList.Length
        ...
        private static (int StartInclusive, int EndExclusive) TrimSplitEntry(
            ReadOnlySpan<char> source,
            int startInclusive,
            int endExclusive
        )
        ...
        public static int Count<T>(this Span<T> span, T value)
            where T : IEquatable<T>? => Count((ReadOnlySpan<T>)span, value);
        ...
        /// <param name="value">The value for which to search.</param>
        /// <returns>The number of times <paramref name="value"/> was found in the <paramref name="span"/>.</returns>
        public static int Count<T>(this Span<T> span, ReadOnlySpan<T> value)
            where T : IEquatable<T>? => Count((ReadOnlySpan<T>)span, value);
        ...
        /// <param name="value">The value for which to search.</param>
        /// <returns>The number of times <paramref name="value"/> was found in the <paramref name="span"/>.</returns>
        public static int Count<T>(this ReadOnlySpan<T> span, ReadOnlySpan<T> value)
            where T : IEquatable<T>?
        {
            switch (value.Length)
            {
        ...
        private static bool TryWrite<TArg0, TArg1, TArg2>(
        ...
        )
        {
            ...
            var handler = new TryWriteInterpolatedStringHandler(
            ...
            if (shouldAppend)
            {
                ...
                )
                {
                    ...
                    else
                    {
                        ...
                        {
                            case 0:
                                appended = handler.AppendFormatted(
                                    arg0,
                                    segment.Alignment,
                                    segment.Format
                                );
