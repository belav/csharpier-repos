            ...
            IStructuralEquatable
    {
        ...
        public static unsafe Array CreateInstanceFromArrayType(Type arrayType, int length)
        {
            ...
            if (t == null)
                ThrowHelper.ThrowArgumentException(
                    ExceptionResource.Arg_MustBeType,
                    ExceptionArgument.arrayType
                );

            if (!t.IsArray)
                ThrowHelper.ThrowArgumentException(
                    ExceptionResource.Argument_HasToBeArrayClass,
                    ExceptionArgument.arrayType
                );
        ...
        /// better performance and it is AOT-friendly.</remarks>
        public static unsafe Array CreateInstanceFromArrayType(
            Type arrayType,
            int[] lengths,
            int[] lowerBounds
        )
        ...
        public static unsafe void Copy(Array sourceArray, Array destinationArray, int length)
        {
            ...
            if (
                MethodTable.AreSameType(pMT, RuntimeHelpers.GetMethodTable(destinationArray))
...
#pragma warning restore CA1825
        ...
        public static void Fill<T>(T[] array, T value, int startIndex, int count)
        {
            ...
            {
                ref T first = ref Unsafe.Add(
                    ref MemoryMarshal.GetArrayDataReference(array),
                    (nint)(uint)startIndex
                );
        ...
        public static unsafe int IndexOf<T>(T[] array, T value, int startIndex, int count)
        {
            ...
            if (RuntimeHelpers.IsBitwiseEquatable<T>())
            {
                ...
                else if (sizeof(T) == sizeof(short))
                {
                    int result = SpanHelpers.IndexOfValueType(
                        ref Unsafe.Add(
                            ref Unsafe.As<T, short>(ref MemoryMarshal.GetArrayDataReference(array)),
                            startIndex
                        ),
                ...
                else if (sizeof(T) == sizeof(int))
                {
                    int result = SpanHelpers.IndexOfValueType(
                        ref Unsafe.Add(
                            ref Unsafe.As<T, int>(ref MemoryMarshal.GetArrayDataReference(array)),
                            startIndex
                        ),
                ...
                else if (sizeof(T) == sizeof(long))
                {
                    int result = SpanHelpers.IndexOfValueType(
                        ref Unsafe.Add(
                            ref Unsafe.As<T, long>(ref MemoryMarshal.GetArrayDataReference(array)),
                            startIndex
                        ),
