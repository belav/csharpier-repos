...
namespace System.ComponentModel.Tests
{
    public class EnumConverterTests : ConverterTestBase
    {
        ...
        public static void ConvertTo_WithContext_EnumConverter()
        {
            ...
            object actual = EnumConverterTests.s_someEnumConverter
                .ConvertTo(
            ...
            var actualInstanceDescriptor =
                (InstanceDescriptor)EnumConverterTests.s_someEnumConverter
        ...
        public static void ConvertTo_WithContext_Flags()
        {
            ...
            object actual = EnumConverterTests.s_someFlagsEnumConverter
                .ConvertTo(
                    TypeConverterTests.s_context,
                    CultureInfo.InvariantCulture,
                    SomeFlagsEnum.Option1 | SomeFlagsEnum.Option2,
            ...
            actual = EnumConverterTests.s_someFlagsEnumConverter
                .ConvertTo(
                    TypeConverterTests.s_context,
                    null,
            ...
            var actualInstanceDescriptor =
                (InstanceDescriptor)EnumConverterTests.s_someFlagsEnumConverter
                    .ConvertTo(
                        SomeFlagsEnum.Option1 | SomeFlagsEnum.Option2,
                        typeof(InstanceDescriptor)
                    );
            var expectedMemberInfo = typeof(Enum)
                .GetMethod("ToObject", new Type[] { typeof(Type), typeof(int) });
            Assert.Equal(expectedMemberInfo, actualInstanceDescriptor.MemberInfo);
            Assert.Equal(
                new object[]
                {
