...
namespace System.ComponentModel.Tests
{
    public class EventDescriptorTests
    {
        ...
        public void RaiseAddedEventHandler()
        {
            ...
            var eventInfo = typeof(DescriptorTestComponent)
                .GetEvent(nameof(DescriptorTestComponent.ActionEvent));
            EventDescriptor eventDescriptor = TypeDescriptor.CreateEvent(
                component.GetType(),
                nameof(component.ActionEvent),
                typeof(Action)
            );
        ...
        public void RemoveAddedEventHandler()
        {
            var component = new DescriptorTestComponent();
            Action eventHandler = () =>
                Assert.True(false, "EventDescriptor failed to remove an event handler");
            EventDescriptor eventDescriptor = TypeDescriptor.CreateEvent(
                component.GetType(),
                nameof(component.ActionEvent),
                typeof(Action)
        ...
        {
            var oldEventDescriptor = TypeDescriptor.CreateEvent(
                typeof(DescriptorTestComponent),
                nameof(DescriptorTestComponent.ActionEvent),
                typeof(Action)
            );
            ...
            EventDescriptor newEventDescriptor = TypeDescriptor.CreateEvent(
                typeof(DescriptorTestComponent),
                oldEventDescriptor,
                new[] { newAttribute }
            );
        ...
        public void GetEventType()
        {
            ...
            var eventDescriptor = TypeDescriptor.CreateEvent(
                typeof(DescriptorTestComponent),
                nameof(DescriptorTestComponent.ActionEvent),
                eventType,
                null
