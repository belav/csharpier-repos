    ...
    public class RootDesignerSerializerAttributeTests
    {
        ...
        public void Ctor_NullSerializerType_ThrowsNullReferenceException()
        {
            AssertExtensions.Throws<ArgumentNullException, NullReferenceException>(
                "serializerType",
                () => new RootDesignerSerializerAttribute((Type)null, typeof(int), false)
            );
        }
        ...
        public void Ctor_NullBaseSerializerType_ThrowsNullReferenceException()
        {
            AssertExtensions.Throws<ArgumentNullException, NullReferenceException>(
                "baseSerializerType",
                () => new RootDesignerSerializerAttribute(typeof(int), (Type)null, false)
            );
            AssertExtensions.Throws<ArgumentNullException, NullReferenceException>(
                "baseSerializerType",
                () => new RootDesignerSerializerAttribute("int", (Type)null, false)
            );
        }
