...
namespace System.ComponentModel.Tests
{
    public class TypeConverterAttributeTests
    {
        ...
        private static TypeConverterAttribute s_attributeFromType = new TypeConverterAttribute(
            typeof(int)
        );
        private static TypeConverterAttribute s_attributeFromString = new TypeConverterAttribute(
            "System.Int32"
        );
        ...
        public static void Get_ConverterTypeName()
        {
            Assert.Equal(
                ...
                TypeConverterAttributeTests.s_attributeFromType.ConverterTypeName
            );
            Assert.Equal(
                "System.Int32",
                TypeConverterAttributeTests.s_attributeFromString.ConverterTypeName
            );
        }
        ...
        public static void GetHashCode_Positive()
        {
            Assert.Equal(
                ...
                TypeConverterAttributeTests.s_attributeFromString.GetHashCode()
            );
        }
    }
}
