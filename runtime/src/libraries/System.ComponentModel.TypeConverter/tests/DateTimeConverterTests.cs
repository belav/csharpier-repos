    ...
    public class DateTimeConverterTests : TypeConverterTestBase
    {
        ...
        public override IEnumerable<ConvertTest> ConvertFromTestData()
        {
            ...
            yield return ConvertTest.Valid(
                date.ToString(CultureInfo.InvariantCulture.DateTimeFormat),
                date,
        ...
        public override IEnumerable<ConvertTest> ConvertToTestData()
        {
            ...
            yield return ConvertTest
                .Valid(
                    date,
                    date.ToString(
                        frenchCulture.DateTimeFormat.ShortDatePattern,
            ...
            yield return ConvertTest
                ...
                .WithRemoteInvokeCulture(frenchCulture);
            yield return ConvertTest
                .Valid(date, "1998-12-05", CultureInfo.InvariantCulture)
                .WithRemoteInvokeCulture(polandCulture);
            ...
            yield return ConvertTest
                .Valid(
                    ...
                    dateWithTime.ToString(
                        frenchCulture.DateTimeFormat.ShortDatePattern
                            + " "
                            + frenchCulture.DateTimeFormat.ShortTimePattern,
                        frenchCulture.DateTimeFormat
                    ),
                    frenchCulture
                )
            ...
            yield return ConvertTest
                ...
                .WithRemoteInvokeCulture(frenchCulture);
            yield return ConvertTest
                .Valid(dateWithTime, "12/05/1998 22:30:30", CultureInfo.InvariantCulture)
                .WithRemoteInvokeCulture(polandCulture);
