...
namespace System.ComponentModel
{
    ...
    public class CultureInfoConverter : TypeConverter
    {
        ...
        /// </summary>
        private static string DefaultCultureString =>
            SR.GetResourceString(nameof(SR.CultureInfoConverterDefaultCultureString), "(Default)");
            ...
            if (value is string text)
            {
                ...
                if (retVal == null)
                {
                    throw new ArgumentException(
                        SR.Format(SR.CultureInfoConverterInvalidCulture, (string)value),
                        nameof(value)
                    );
                }
        ...
        public override StandardValuesCollection GetStandardValues(ITypeDescriptorContext? context)
        {
            if (_values == null)
            {
                CultureInfo?[] installedCultures = CultureInfo.GetCultures(
