...
namespace System.ComponentModel.Design
{
    ...
    public class StandardCommands
    {
        ...
        /// </summary>
        private static readonly Guid s_ndpCommandSet = new Guid(
            "{74D21313-2AEE-11d1-8BFB-00A0C90F26F7}"
        );
        ...
        /// </summary>
        public static readonly CommandID AlignBottom = new CommandID(
        ...
        /// only.
        /// </summary>
        public static readonly CommandID AlignHorizontalCenters = new CommandID(
            s_standardCommandSet,
        ...
        /// </summary>
        public static readonly CommandID AlignLeft = new CommandID(
            s_standardCommandSet,
            VSStandardCommands.cmdidAlignLeft
        );

        /// <summary>
        /// Gets the GUID/integer value pair for the AlignRight command. Read only.
        /// </summary>
        public static readonly CommandID AlignRight = new CommandID(
            s_standardCommandSet,
        ...
        /// </summary>
        public static readonly CommandID AlignToGrid = new CommandID(
            s_standardCommandSet,
            VSStandardCommands.cmdidAlignToGrid
        );

        /// <summary>
        /// Gets the GUID/integer value pair for the AlignTop command. Read only.
        /// </summary>
        public static readonly CommandID AlignTop = new CommandID(
            s_standardCommandSet,
            VSStandardCommands.cmdidAlignTop
        );

        /// <summary>
        /// Gets the GUID/integer value pair for the AlignVerticalCenters command. Read only.
        /// </summary>
        public static readonly CommandID AlignVerticalCenters = new CommandID(
            s_standardCommandSet,
            VSStandardCommands.cmdidAlignVerticalCenters
        );

        /// <summary>
        /// Gets the GUID/integer value pair for the ArrangeBottom command. Read only.
        /// </summary>
        public static readonly CommandID ArrangeBottom = new CommandID(
            s_standardCommandSet,
            VSStandardCommands.cmdidArrangeBottom
        );

        /// <summary>
        /// Gets the GUID/integer value pair for the ArrangeRight command. Read only.
        /// </summary>
        public static readonly CommandID ArrangeRight = new CommandID(
            s_standardCommandSet,
            VSStandardCommands.cmdidArrangeRight
        );

        /// <summary>
        /// Gets the GUID/integer value pair for the BringForward command. Read only.
        /// </summary>
        public static readonly CommandID BringForward = new CommandID(
            s_standardCommandSet,
            VSStandardCommands.cmdidBringForward
        );

        /// <summary>
        /// Gets the GUID/integer value pair for the BringToFront command. Read only.
        /// </summary>
        public static readonly CommandID BringToFront = new CommandID(
            s_standardCommandSet,
            VSStandardCommands.cmdidBringToFront
        );

        /// <summary>
        /// Gets the GUID/integer value pair for the CenterHorizontally command. Read only.
        /// </summary>
        public static readonly CommandID CenterHorizontally = new CommandID(
            s_standardCommandSet,
            VSStandardCommands.cmdidCenterHorizontally
        );

        /// <summary>
        /// Gets the GUID/integer value pair for the CenterVertically command. Read only.
        /// </summary>
        public static readonly CommandID CenterVertically = new CommandID(
            s_standardCommandSet,
            VSStandardCommands.cmdidCenterVertically
        );

        /// <summary>
        /// Gets the GUID/integer value pair for the Code command. Read only.
        /// </summary>
        public static readonly CommandID ViewCode = new CommandID(
            s_standardCommandSet,
            VSStandardCommands.cmdidViewCode
        );

        /// <summary>
        /// Gets the GUID/integer value pair for the DocumentOutline command. Read only.
        /// </summary>
        public static readonly CommandID DocumentOutline = new CommandID(
            s_standardCommandSet,
            VSStandardCommands.cmdidDocOutlineWindow
        );

        /// <summary>
        /// Gets the GUID/integer value pair for the Copy command. Read only.
        /// </summary>
        public static readonly CommandID Copy = new CommandID(
            s_standardCommandSet,
            VSStandardCommands.cmdidCopy
        );

        /// <summary>
        /// Gets the GUID/integer value pair for the Cut command. Read only.
        /// </summary>
        public static readonly CommandID Cut = new CommandID(
            s_standardCommandSet,
        ...
        /// </summary>
        public static readonly CommandID Delete = new CommandID(
            s_standardCommandSet,
            VSStandardCommands.cmdidDelete
        );

        /// <summary>
        /// Gets the GUID/integer value pair for the Group command. Read only.
        /// </summary>
        public static readonly CommandID Group = new CommandID(
            s_standardCommandSet,
        ...
        /// </summary>
        public static readonly CommandID HorizSpaceConcatenate = new CommandID(
            s_standardCommandSet,
        ...
        /// </summary>
        public static readonly CommandID HorizSpaceDecrease = new CommandID(
            s_standardCommandSet,
        ...
        /// </summary>
        public static readonly CommandID HorizSpaceIncrease = new CommandID(
            s_standardCommandSet,
            VSStandardCommands.cmdidHorizSpaceIncrease
        );
        ...
        /// </summary>
        public static readonly CommandID Paste = new CommandID(
            s_standardCommandSet,
            VSStandardCommands.cmdidPaste
        );

        /// <summary>
        /// Gets the GUID/integer value pair for the Properties command. Read only.
        /// </summary>
        public static readonly CommandID Properties = new CommandID(
            s_standardCommandSet,
            VSStandardCommands.cmdidProperties
        );

        /// <summary>
        /// Gets the GUID/integer value pair for the Redo command. Read only.
        /// </summary>
        public static readonly CommandID Redo = new CommandID(
            s_standardCommandSet,
            VSStandardCommands.cmdidRedo
        );

        /// <summary>
        /// Gets the GUID/integer value pair for the MultiLevelRedo command. Read only.
        /// </summary>
        public static readonly CommandID MultiLevelRedo = new CommandID(
            s_standardCommandSet,
            VSStandardCommands.cmdidMultiLevelRedo
        );

        /// <summary>
        /// Gets the GUID/integer value pair for the SelectAll command. Read only.
        /// </summary>
        public static readonly CommandID SelectAll = new CommandID(
            s_standardCommandSet,
            VSStandardCommands.cmdidSelectAll
        );

        /// <summary>
        /// Gets the GUID/integer value pair for the SendBackward command. Read only.
        /// </summary>
        public static readonly CommandID SendBackward = new CommandID(
            s_standardCommandSet,
            VSStandardCommands.cmdidSendBackward
        );

        /// <summary>
        /// Gets the GUID/integer value pair for the SendToBack command. Read only.
        /// </summary>
        public static readonly CommandID SendToBack = new CommandID(
            s_standardCommandSet,
            VSStandardCommands.cmdidSendToBack
        );

        /// <summary>
        /// Gets the GUID/integer value pair for the SizeToControl command. Read only.
        /// </summary>
        public static readonly CommandID SizeToControl = new CommandID(
            s_standardCommandSet,
            VSStandardCommands.cmdidSizeToControl
        );

        /// <summary>
        /// Gets the GUID/integer value pair for the SizeToControlHeight command. Read only.
        /// </summary>
        public static readonly CommandID SizeToControlHeight = new CommandID(
            s_standardCommandSet,
        ...
        /// </summary>
        public static readonly CommandID SizeToControlWidth = new CommandID(
            s_standardCommandSet,
            VSStandardCommands.cmdidSizeToControlWidth
        );

        /// <summary>
        /// Gets the GUID/integer value pair for the SizeToFit command. Read only.
        /// </summary>
        public static readonly CommandID SizeToFit = new CommandID(
            s_standardCommandSet,
            VSStandardCommands.cmdidSizeToFit
        );

        /// <summary>
        /// Gets the GUID/integer value pair for the SizeToGrid command. Read only.
        /// </summary>
        public static readonly CommandID SizeToGrid = new CommandID(
            s_standardCommandSet,
            VSStandardCommands.cmdidSizeToGrid
        );

        /// <summary>
        /// Gets the GUID/integer value pair for the SnapToGrid command. Read only.
        /// </summary>
        public static readonly CommandID SnapToGrid = new CommandID(
            s_standardCommandSet,
            VSStandardCommands.cmdidSnapToGrid
        );

        /// <summary>
        /// Gets the GUID/integer value pair for the TabOrder command. Read only.
        /// </summary>
        public static readonly CommandID TabOrder = new CommandID(
            s_standardCommandSet,
            VSStandardCommands.cmdidTabOrder
        );

        /// <summary>
        /// Gets the GUID/integer value pair for the Undo command. Read only.
        /// </summary>
        public static readonly CommandID Undo = new CommandID(
            s_standardCommandSet,
            VSStandardCommands.cmdidUndo
        );

        /// <summary>
        /// Gets the GUID/integer value pair for the MultiLevelUndo command. Read only.
        /// </summary>
        public static readonly CommandID MultiLevelUndo = new CommandID(
            s_standardCommandSet,
            VSStandardCommands.cmdidMultiLevelUndo
        );

        /// <summary>
        /// Gets the GUID/integer value pair for the Ungroup command. Read only.
        /// </summary>
        public static readonly CommandID Ungroup = new CommandID(
            s_standardCommandSet,
            VSStandardCommands.cmdidUngroup
        );

        /// <summary>
        /// Gets the GUID/integer value pair for the VertSpaceConcatenate command. Read only.
        /// </summary>
        public static readonly CommandID VertSpaceConcatenate = new CommandID(
            s_standardCommandSet,
            VSStandardCommands.cmdidVertSpaceConcatenate
        );

        /// <summary>
        /// Gets the GUID/integer value pair for the VertSpaceDecrease command. Read only.
        /// </summary>
        public static readonly CommandID VertSpaceDecrease = new CommandID(
            s_standardCommandSet,
            VSStandardCommands.cmdidVertSpaceDecrease
        );

        /// <summary>
        /// Gets the GUID/integer value pair for the VertSpaceIncrease command. Read only.
        /// </summary>
        public static readonly CommandID VertSpaceIncrease = new CommandID(
            s_standardCommandSet,
            VSStandardCommands.cmdidVertSpaceIncrease
        );

        /// <summary>
        /// Gets the GUID/integer value pair for the VertSpaceMakeEqual command. Read only.
        /// </summary>
        public static readonly CommandID VertSpaceMakeEqual = new CommandID(
            s_standardCommandSet,
            VSStandardCommands.cmdidVertSpaceMakeEqual
        );

        /// <summary>
        /// Gets the GUID/integer value pair for the ShowGrid command. Read only.
        /// </summary>
        public static readonly CommandID ShowGrid = new CommandID(
            s_standardCommandSet,
            VSStandardCommands.cmdidShowGrid
        );

        /// <summary>
        /// Gets the GUID/integer value pair for the ViewGrid command. Read only.
        /// </summary>
        public static readonly CommandID ViewGrid = new CommandID(
            s_standardCommandSet,
        ...
        /// </summary>
        public static readonly CommandID Replace = new CommandID(
            s_standardCommandSet,
            VSStandardCommands.cmdidReplace
        );

        /// <summary>
        /// Gets the GUID/integer value pair for the PropertiesWindow command. Read only.
        /// </summary>
        public static readonly CommandID PropertiesWindow = new CommandID(
            s_standardCommandSet,
            VSStandardCommands.cmdidPropertiesWindow
        );

        /// <summary>
        /// Gets the GUID/integer value pair for the LockControls command. Read only.
        /// </summary>
        public static readonly CommandID LockControls = new CommandID(
            s_standardCommandSet,
        ...
        /// </summary>
        public static readonly CommandID F1Help = new CommandID(
            s_standardCommandSet,
            VSStandardCommands.cmdidF1Help
        );
        ...
        private static class ShellGuids
        {
            ...
            internal static readonly Guid guidDsdCmdId = new Guid(
                "{1F0FD094-8e53-11d2-8f9c-0060089fc486}"
            );
            internal static readonly Guid SID_SOleComponentUIManager = new Guid(
                "{5efc7974-14bc-11cf-9b2b-00aa00573819}"
            );
            internal static readonly Guid GUID_VSTASKCATEGORY_DATADESIGNER = new Guid(
                "{6B32EAED-13BB-11d3-A64F-00C04F683820}"
            );
            internal static readonly Guid GUID_PropertyBrowserToolWindow = new Guid(
                unchecked((int)0xeefa5220),
                unchecked((short)0xe298),
                unchecked((short)0x11d0),
