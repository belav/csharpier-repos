...
{
    /// <summary>
    /// An InstanceCreationEditor allows the user to create an instance of a particular type of property
    // from a dropdown
    ...
    public abstract class InstanceCreationEditor
    {
        public virtual string Text =>
            SR.UsingResourceKeys() ? "(New...)" : SR.InstanceCreationEditorDefaultText;
