...
namespace Internal.Cryptography.Pal
{
    internal sealed class SecTrustChainPal : IChainPal
    {
        ...
        private static readonly SafeCreateHandle s_emptyArray = Interop.CoreFoundation
        ...
        private SafeCreateHandle PreparePoliciesArray(bool checkRevocation)
        {
            ...
            SafeCreateHandle policiesArray = Interop.CoreFoundation
                .CFArrayCreate(policies, (UIntPtr)policies.Length);
        ...
        )
        {
            ...
            if (trustMode == X509ChainTrustMode.CustomRootTrust && customTrustStore != null)
            {
                for (int i = 0; i < customTrustStore.Count; i++)
                {
                    ...
                    if (
                        !customTrustStore[i].SubjectName.RawData
        ...
        private SafeCreateHandle GetCertsArray(IList<SafeHandle> safeHandles)
        {
            ...
            try
            {
                ...
                SafeCreateHandle certsArray = Interop.CoreFoundation
        ...
        )
        {
            ...
            using (
                SafeCFDateHandle cfEvaluationTime = Interop.CoreFoundation
