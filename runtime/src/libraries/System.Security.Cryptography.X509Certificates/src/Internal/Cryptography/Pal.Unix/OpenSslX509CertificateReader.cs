...
namespace Internal.Cryptography.Pal
{
    internal sealed class OpenSslX509CertificateReader : ICertificatePal
    {
        ...
        public string Issuer
        {
            get
            {
                ...
                return _issuer ??= UseCertInteriorData(
                    static cert =>
                    {
                        return Interop.Crypto.LoadX500Name(
                            Interop.Crypto.X509GetIssuerName(cert)
                        ).Name;
                    }
                );
            }
        ...
        public string Subject
        {
            get
            {
                ...
                return _subject ??= UseCertInteriorData(
                    ...
                    {
                        return Interop.Crypto.LoadX500Name(
                            Interop.Crypto.X509GetSubjectName(cert)
                        ).Name;
                    }
                );
            }
        ...
        public X500DistinguishedName SubjectName
        {
            get
            {
                return _subjectName ??= UseCertInteriorData(
                    static cert =>
                    {
        ...
        public X500DistinguishedName IssuerName
        {
            get
            {
                return _issuerName ??= UseCertInteriorData(
                    static cert =>
                    {
