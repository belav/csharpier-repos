...
internal static partial class Interop
{
    public static partial class crypt32
    {
        ...
        {
            int cchCount = Crypt32.CertGetNameString(
                certContext,
                certNameType,
                certNameFlags,
                strType,
        ...
        public static SafeCertStoreHandle CertOpenStore(
            ...
            IntPtr hCryptProv,
            Interop.Crypt32.CertStoreFlags dwFlags,
            string? pvPara
        )
        {
        ...
        )
        {
            ...
            pCertContext.SetHandle(
                (IntPtr)Crypt32.CertEnumCertificatesInStore(hCertStore, pPrevCertContext)
            );
        ...
        public static bool CryptDecodeObject(
            ...
            byte[] pbEncoded,
            int cbEncoded,
            Interop.Crypt32.CryptDecodeObjectFlags dwFlags,
            byte[]? pvStructInfo,
        ...
        public static partial bool CryptHashPublicKeyInfo(
            ...
            int dwFlags,
            Interop.Crypt32.CertEncodingType dwCertEncodingType,
            ref Interop.Crypt32.CERT_PUBLIC_KEY_INFO pInfo,
            byte[] pbComputedHash,
        ...
        public static partial bool CertSaveStore(
            ...
            ref Interop.Crypt32.DATA_BLOB pvSaveToPara,
            int dwFlags
        );
