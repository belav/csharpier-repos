    ...
    internal sealed partial class FindPal : IFindPal
    {
        ...
        private unsafe void FindByTime(DateTime dateTime, int compareResult)
        {
            ...
            FindCore(
                ...
                static (state, pCertContext) =>
                {
                    int comparison = Interop.crypt32
        ...
        public unsafe void FindByTemplateName(string templateName)
        {
            FindCore(
                ...
                static (templateName, pCertContext) =>
                {
                    ...
                    {
                        CERT_EXTENSION* pV1Template = Interop.crypt32
                            .CertFindExtension(
                                ...
                                !extensionRawData.DecodeObjectNoThrow(
                                    ...
                                    delegate(void* pvDecoded, int cbDecoded)
                                    {
                                        ...
                                        string? actual = Marshal.PtrToStringUni(
                                            new IntPtr(pNameValue->Value.pbData)
                                        );
                                        if (
                                            templateName.Equals(
                                                actual,
                    ...
                    if (!foundMatch)
                    {
                        CERT_EXTENSION* pV2Template = Interop.crypt32
                            .CertFindExtension(
        ...
        public unsafe void FindByCertificatePolicy(string oidValue)
        {
            FindCore(
                ...
                {
                    CERT_INFO* pCertInfo = pCertContext.CertContext->pCertInfo;
                    CERT_EXTENSION* pCertExtension = Interop.crypt32
                        .CertFindExtension(
                            Oids.CertPolicies,
                            pCertInfo->cExtension,
                            pCertInfo->rgExtension
        ...
        {
            SafeCertStoreHandle findResults = Interop.crypt32
                .CertOpenStore(
