    ...
    public class EccTestData
    {
        ...
        internal static readonly EccTestData BrainpoolP256r1Data = new EccTestData
        {
            ...
            KeyParameters = new ECParameters
            {
                ...
                Q = new ECPoint
                {
                    X = "419A7BB2B7CEBDD62A6BD3483FDE3985BFC2F3E0CD2AF362B430BC4A737BAC38"
                        .HexToByteArray(),
                    Y = "631730AF824E760DA912EB012893BE5692A7F3BFDD156CB9F7313DE2ECA3C184"
                        .HexToByteArray(),
                },
                D = "67DE7D6322530549BEC961149582C2EA9532B3641D273F13CD881D0D735EA531"
                    .HexToByteArray(),
            },
        };
        ...
        internal static readonly EccTestData BrainpoolP256t1Data = new EccTestData
        {
            ...
            KeyParameters = new ECParameters
            {
                ...
                Q = new ECPoint
                {
                    X = "9A34B1EF0077DBCECC2034A101229B5D1B8DDF191D8064B4662C452414B508C1"
                        .HexToByteArray(),
                    Y = "96BA5E99FDF30EC25F3DA1A1F572C07D8810F63F7B8E8740ED666426C2E70836"
                        .HexToByteArray(),
                },
                D = "6FA384038FFCA28C21F9A491B99EC07DD021B241E6696C4F96BC5EB922B1D806"
                    .HexToByteArray(),
            },
        };
