...
namespace System.Security.Cryptography.X509Certificates.Tests
{
    public static class X500DistinguishedNameEncodingTests
    {
        ...
        public static void EncodeEmptyValue()
        {
            ...
            ProcessTestCase(new SimpleEncoderTestCase("", null, "3000", null), dn);
        }
        ...
        public static readonly object[][] SingleRdnTestCases =
        {
            ...
            new object[]
            {
                ...
                new SimpleEncoderTestCase("CN=", "CN=\"\"", "300B3109300706035504031300", null),
            },
            new object[]
            {
        ...
        {
            new object[] { X500DistinguishedNameFlags.None, },
            new object[] { X500DistinguishedNameFlags.UseNewLines },
            new object[] { X500DistinguishedNameFlags.UseCommas },
            new object[]
            {
                X500DistinguishedNameFlags.UseCommas | X500DistinguishedNameFlags.UseNewLines
            },
            new object[] { X500DistinguishedNameFlags.UseSemicolons },
            new object[]
            {
                X500DistinguishedNameFlags.UseSemicolons | X500DistinguishedNameFlags.UseNewLines
            },
            new object[]
            {
                X500DistinguishedNameFlags.UseSemicolons | X500DistinguishedNameFlags.UseCommas
            },
            new object[]
            {
