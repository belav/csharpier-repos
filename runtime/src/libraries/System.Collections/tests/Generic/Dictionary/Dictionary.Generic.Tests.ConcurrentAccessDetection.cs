...
namespace Generic.Dictionary
{
    ...
    {
        private async Task DictionaryConcurrentAccessDetection<TKey, TValue>(
            Dictionary<TKey, TValue> dictionary,
            bool isValueType,
            object comparer,
            Action<Dictionary<TKey, TValue>> add,
        ...
        public async Task DictionaryConcurrentAccessDetection_ValueTypeKey(Type comparerType)
        {
            ...
            await DictionaryConcurrentAccessDetection(
                dic,
            ...
            Dictionary<DummyRefType, DummyRefType> dic =
                comparerType == null
                    ? new Dictionary<DummyRefType, DummyRefType>(
                        (customComparer = EqualityComparer<DummyRefType>.Default)
                    )
                    : new Dictionary<DummyRefType, DummyRefType>(
                        (
                            customComparer =
