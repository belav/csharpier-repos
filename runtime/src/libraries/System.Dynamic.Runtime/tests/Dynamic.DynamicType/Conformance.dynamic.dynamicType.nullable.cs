    ...
    namespace Test
    {
        public class Program
        {
            ...
            public static int MainMethod()
            {
                ...
                dynamic[] expected = new dynamic[] { E.One, null, new S(), new S() };
                result[0] = x ?? d1;
                result[1] = y ?? d2;
                result[2] = d1 ?? x;
                result[3] = d1 ?? y;
                if (
                    result[0] == expected[0]
                    && result[1] == expected[1]
                    && result[2].GetType() == expected[2].GetType()
                    && result[3].GetType() == expected[3].GetType()
                )
                    return 0;
                return 1;
            }
    ...
    namespace Test
    {
        public class Program
        {
            ...
            public static int MainMethod()
            {
                ...
                dynamic d2 = null;
                dynamic[] result = new dynamic[4];
                dynamic[] expected = new dynamic[] { new S(), null, E.One, E.One };
                result[0] = x ?? d1;
                result[1] = y ?? d2;
                result[2] = d1 ?? x;
                result[3] = d1 ?? y;
                if (
                    result[0].GetType() == expected[0].GetType()
                    && result[1] == expected[1]
                    && result[2] == expected[2]
                    && result[3] == expected[3]
                )
    ...
    namespace Test
    {
        public class Program
        {
            ...
            public static int MainMethod()
            {
                ...
                S? s1 = d1,
                    s2 = d2;
                dynamic result = new dynamic[] { i1, i2, c1, c2, m1, m2, e1, e2, s1, s2 };
