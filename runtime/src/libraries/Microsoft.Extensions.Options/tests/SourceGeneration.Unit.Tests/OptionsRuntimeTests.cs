...
namespace Microsoft.Gen.OptionsValidation.Unit.Test
{
        ...
        public void TestCustomGeneratedAttributes()
        {
            ...
            Assert.True(
                Validator.TryValidateObject(
                    noFailures,
                    new ValidationContext(noFailures),
                    results,
                    true
                )
            );
            ...
            Assert.True(
                validator.Validate("OptionsUsingGeneratedAttributes", noFailures).Succeeded
            );
            ...
            Assert.False(
                Validator.TryValidateObject(failing, new ValidationContext(failing), results, true)
            );

            ValidateOptionsResult generatorResult = validator.Validate(
                "OptionsUsingGeneratedAttributes",
                failing
            );
            ...
            Assert.Equal(
                new[]
                {
                    ...
                    string.Format(
                        ...
                        "P11: The field OptionsUsingGeneratedAttributes.P11 must be between {0} and {1}.",
    ...
    public class FakeCount(int count)
    {
        public int Count
        {
            get { return count; }
    ...
    [OptionsValidator]
    public partial class OptionsUsingGeneratedAttributesValidator
        : IValidateOptions<OptionsUsingGeneratedAttributes> { }
