...
namespace System.Drawing.Primitives.Tests
{
    ...
    public class DataContractSerializerTests
    {
        ...
        {
            var objs = new Point[] { new Point(0, 0), new Point(1, 2), new Point(new Size(1, 2)) };
            ...
            {
                Assert.StrictEqual(
                    DataContractSerializerHelper.SerializeAndDeserialize<Point>(
                        objs[i],
                        serializedStrings[i]
                    ),
                    objs[i]
        ...
        public static void DCS_PointF()
        {
            ...
            {
                Assert.StrictEqual(
                    DataContractSerializerHelper.SerializeAndDeserialize<PointF>(
                        objs[i],
                        serializedStrings[i]
                    ),
                    objs[i]
        ...
        public static void DCS_Rectangle()
        {
            ...
            {
                Assert.StrictEqual(
                    DataContractSerializerHelper.SerializeAndDeserialize<Rectangle>(
                        objs[i],
                        serializedStrings[i]
                    ),
                    objs[i]
        ...
        public static void DCS_RectangleF()
        {
            ...
            {
                Assert.StrictEqual(
                    DataContractSerializerHelper.SerializeAndDeserialize<RectangleF>(
                        objs[i],
                        serializedStrings[i]
                    ),
                    objs[i]
        ...
        {
            var objs = new Size[] { new Size(0, 0), new Size(new Point(1, 2)), new Size(1, 2) };
            var serializedStrings = new string[]
            {
            ...
            {
                Assert.StrictEqual(
                    DataContractSerializerHelper.SerializeAndDeserialize<Size>(
                        objs[i],
                        serializedStrings[i]
                    ),
                    objs[i]
        ...
        public static void DCS_SizeF()
        {
            ...
            {
                Assert.StrictEqual(
                    DataContractSerializerHelper.SerializeAndDeserialize<SizeF>(
                        objs[i],
                        serializedStrings[i]
                    ),
                    objs[i]
