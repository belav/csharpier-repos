...
namespace System.Data.Odbc
{
    ...
    internal sealed class OdbcStatementHandle : OdbcHandle
    {
        ...
        {
            ODBC32.SQLRETURN retcode = Interop.Odbc.SQLBindCol(
                this,
        ...
        internal ODBC32.SQLRETURN BindColumn3(
            int columnNumber,
            ODBC32.SQL_C targetType,
            IntPtr srLen_or_Ind
        )
        ...
        internal ODBC32.SQLRETURN BindParameter(
            short ordinal,
        ...
        {
            ODBC32.SQLRETURN retcode = Interop.Odbc.SQLBindParameter(
                this,
        ...
        internal ODBC32.SQLRETURN ColumnAttribute(
            int columnNumber,
        ...
        {
            IntPtr result;
            ODBC32.SQLRETURN retcode = Interop.Odbc.SQLColAttributeW(
                this,
        ...
        internal ODBC32.SQLRETURN Columns(
            string tableCatalog,
            string tableSchema,
            string tableName,
            string columnName
        ...
        {
            ODBC32.SQLRETURN retcode = Interop.Odbc.SQLColumnsW(
                this,
                tableCatalog,
        ...
        {
            ODBC32.SQLRETURN retcode = Interop.Odbc.SQLExecDirectW(
                this,
                commandText,
                ODBC32.SQL_NTS
            );
        ...
        internal ODBC32.SQLRETURN GetData(
            int index,
            ODBC32.SQL_C sqlctype,
        ...
        {
            ODBC32.SQLRETURN retcode = Interop.Odbc.SQLGetData(
                this,
        ...
        internal ODBC32.SQLRETURN GetStatementAttribute(
            ODBC32.SQL_ATTR attribute,
            out IntPtr value,
            out int stringLength
        )
        {
            ODBC32.SQLRETURN retcode = Interop.Odbc.SQLGetStmtAttrW(
                this,
                attribute,
                out value,
                ADP.PtrSize,
        ...
        internal ODBC32.SQLRETURN PrimaryKeys(
            string? catalogName,
            string? schemaName,
            string tableName
        )
        {
            ODBC32.SQLRETURN retcode = Interop.Odbc.SQLPrimaryKeysW(
                this,
                catalogName,
        ...
        internal ODBC32.SQLRETURN Procedures(
            string procedureCatalog,
            string procedureSchema,
            string procedureName
        )
        {
            ODBC32.SQLRETURN retcode = Interop.Odbc.SQLProceduresW(
                this,
                procedureCatalog,
        ...
        internal ODBC32.SQLRETURN ProcedureColumns(
            string? procedureCatalog,
            string? procedureSchema,
            string? procedureName,
            string? columnName
        ...
        {
            ODBC32.SQLRETURN retcode = Interop.Odbc.SQLProcedureColumnsW(
                this,
                procedureCatalog,
                ODBC.ShortStringLength(procedureCatalog),
                procedureSchema,
        ...
        internal ODBC32.SQLRETURN SetStatementAttribute(
            ODBC32.SQL_ATTR attribute,
            IntPtr value,
            ODBC32.SQL_IS stringLength
        )
        {
            ODBC32.SQLRETURN retcode = Interop.Odbc.SQLSetStmtAttrW(
                this,
                (int)attribute,
                value,
                (int)stringLength
        ...
        {
            ODBC32.SQLRETURN retcode = Interop.Odbc.SQLSpecialColumnsW(
                this,
        ...
        internal ODBC32.SQLRETURN Statistics(
            string? tableCatalog,
            string? tableSchema,
            string tableName,
            short unique,
        ...
        )
        {
            ...
            try
            {
                retcode = Interop.Odbc.SQLStatisticsW(
                    this,
                    tableCatalog,
                    ODBC.ShortStringLength(tableCatalog),
                    tableSchema,
        ...
        internal ODBC32.SQLRETURN Tables(
            string tableCatalog,
            string tableSchema,
            string tableName,
            string tableType
        ...
        {
            ODBC32.SQLRETURN retcode = Interop.Odbc.SQLTablesW(
                this,
                tableCatalog,
                ODBC.ShortStringLength(tableCatalog),
                tableSchema,
