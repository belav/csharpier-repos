...
namespace System.Data.Odbc
{
    internal static class ODBC
    {
        ...
        internal static Exception ConnectionStringTooLong()
        {
            return ADP.Argument(
                SR.GetString(
                    SR.OdbcConnection_ConnectionStringTooLong,
                    ODBC32.MAX_CONNECTION_STRING_LENGTH
                )
            );
        }
        ...
        internal static InvalidOperationException NoMappingForSqlTransactionLevel(int value)
        {
            return ADP.DataAdapter(
                SR.GetString(
                    SR.Odbc_NoMappingForSqlTransactionLevel,
    ...
    public static partial class ODBC32
    {
        ...
        internal static string RetcodeToString(SQLRETURN retcode)
        {
            switch (retcode)
            {
                case SQLRETURN.SUCCESS:
                    return "SUCCESS";
                case SQLRETURN.SUCCESS_WITH_INFO:
                    return "SUCCESS_WITH_INFO";
                case SQLRETURN.ERROR:
                    return "ERROR";
                case SQLRETURN.INVALID_HANDLE:
                    return "INVALID_HANDLE";
                case SQLRETURN.NO_DATA:
                    return "NO_DATA";
                default:
        ...
        // Helpers
        internal static OdbcErrorCollection GetDiagErrors(
            string? source,
            OdbcHandle hrHandle,
            SQLRETURN retcode
        )
        ...
        )
        {
            ...
            if (SQLRETURN.SUCCESS != retcode)
            {
                ...
                while (moreerrors)
                {
                    ...
                    moreerrors = (
                        retcode == SQLRETURN.SUCCESS || retcode == SQLRETURN.SUCCESS_WITH_INFO
                    );
                    if (moreerrors)
                    {
                        //Sets up the InnerException as well...
                        errors.Add(
                            new OdbcError(source, message.ToString(), sqlState, NativeError)
                        );
                    }
                }
            }
    ...
    { // MDAC 68988
        ...
        private static readonly TypeMap s_dateTime = new TypeMap(
            ...
            DbType.DateTime,
            typeof(DateTime),
            ODBC32.SQL_TYPE.TYPE_TIMESTAMP,
            ODBC32.SQL_C.TYPE_TIMESTAMP,
            ODBC32.SQL_C.TYPE_TIMESTAMP,
            16,
            23,
            false
        ...
        private static readonly TypeMap s_date = new TypeMap(
            ...
            DbType.Date,
            typeof(DateTime),
            ODBC32.SQL_TYPE.TYPE_DATE,
            ODBC32.SQL_C.TYPE_DATE,
            ODBC32.SQL_C.TYPE_DATE,
            6,
            10,
            false
        ...
        private static readonly TypeMap s_time = new TypeMap(
            ...
            DbType.Time,
            typeof(TimeSpan),
            ODBC32.SQL_TYPE.TYPE_TIME,
            ODBC32.SQL_C.TYPE_TIME,
            ODBC32.SQL_C.TYPE_TIME,
            6,
            12,
            false
        ...
        private TypeMap(
            ...
            DbType dbType,
            Type type,
            ODBC32.SQL_TYPE sql_type,
            ODBC32.SQL_C sql_c,
            ODBC32.SQL_C param_sql_c,
            int bsize,
            int csize,
            bool signType
        )
