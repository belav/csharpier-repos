...
#pragma warning restore CS0169
            ...
            if (
                ...
                if (componentSet._behavior == KeyRestrictionBehavior.AllowOnly)
                {
                    if (combinedSet._behavior == KeyRestrictionBehavior.AllowOnly)
                    {
                        ...
                        Debug.Assert(
                            !combinedSet._restrictionValues.Except(componentSet._restrictionValues)
                                .Any(),
                ...
                else if (componentSet._behavior == KeyRestrictionBehavior.PreventUsage)
                {
                    if (combinedSet._behavior == KeyRestrictionBehavior.AllowOnly)
                    {
                        ...
                        Debug.Assert(
                            !combinedSet._restrictionValues.Intersect(
                    ...
                    else if (combinedSet._behavior == KeyRestrictionBehavior.PreventUsage)
                    {
                        ...
                        Debug.Assert(
                            !componentSet._restrictionValues.Except(combinedSet._restrictionValues)
                                .Any(),
        ...
        private static string[]? ParseRestrictions(
            ...
            while (nextStartPosition < endPosition)
            {
                ...
                string? keyname,
                    keyvalue; // since parsing restrictions ignores values, it doesn't matter if we use ODBC rules or OLEDB rules
