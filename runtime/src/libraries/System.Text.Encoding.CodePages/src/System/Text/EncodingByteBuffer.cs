    ...
    internal sealed class EncodingByteBuffer
    {
        ...
        internal unsafe EncodingByteBuffer(
            ...
            else
            {
                ...
                if (
                    _encoder.m_throwOnOverflow
                    && _encoder.InternalHasFallbackBuffer
        ...
        internal unsafe void MovePrevious(bool bThrow)
        {
            ...
            {
                Debug.Assert(
                    _chars > _charStart || ((bThrow == true) && (_bytes == _byteStart)),
        ...
        {
            get { return (int)(_chars - _charStart); }
        }

        internal unsafe int Count
        {
            get { return _byteCountResult; }
        }
    }
}
