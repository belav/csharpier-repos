...
namespace System.Security.Principal
{
    ...
    public class WindowsPrincipal : ClaimsPrincipal
    {
        ...
        // This method (with a SID parameter) is more general than the 2 overloads that accept a
        // WindowsBuiltInRole or
        // a rid (as an int). It is also better from a performance standpoint than the overload that accepts
        // a string.
