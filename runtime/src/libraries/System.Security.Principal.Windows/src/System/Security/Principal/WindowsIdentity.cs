...
namespace System.Security.Principal
{
            ...
            IDeserializationCallback
    {
            ...
            : base(null, null, null, ClaimTypes.Name, ClaimTypes.GroupSid)
        {
            ...
            using (SafeLsaHandle lsaHandle = ConnectToLsa())
            {
                ...
                unsafe
                {
                    ...
                    sourceName.CopyTo(
                        new Span<byte>(sourceContext.SourceName, TOKEN_SOURCE.TOKEN_SOURCE_LENGTH)
                    );
                }
                ...
                unsafe
                {
                    ...
                    )
                    {
                        ...
                        )
                        {
                            sourceName.CopyTo(
                                new Span<byte>(
                                    (void*)sourceNameBuffer.DangerousGetHandle(),
                                    sourceName.Length
                                )
                            );
                ...
                if (_authType == null)
                {
                    ...
                    try
                    {
                        ...
                        pLogonSessionData.Initialize(
                            (uint)sizeof(Interop.SECURITY_LOGON_SESSION_DATA)
                        );
            ...
            get
            {
                ...
                if (_groups == null)
                {
                    ...
                    )
                    {
                        ...
                        pGroups.ReadArray(
                            (uint)
                                sizeof(IntPtr) /* offsetof(Interop.TOKEN_GROUPS, Groups) */
                            ,
                            groupDetails,
                            0,
                            groupDetails.Length
            ...
            try
            {
                ...
                switch (dwErrorCode)
                {
                    ...
                    case Interop.Errors.ERROR_INSUFFICIENT_BUFFER:
                        ...
                        safeLocalAllocHandle = SafeLocalAllocHandle.LocalAlloc(
        ...
        private unsafe void AddDeviceGroupSidClaims(
        ...
        private unsafe void AddTokenClaims(
            List<Claim> instanceClaims,
            TokenInformationClass tokenInformationClass,
            ...
            try
            {
                ...
                for (int attribute = 0; attribute < claimAttributes.AttributeCount; attribute++)
                {
                    Interop.CLAIM_SECURITY_ATTRIBUTE_V1 windowsClaim = (
                        (Interop.CLAIM_SECURITY_ATTRIBUTE_V1*)claimAttributes.Attribute.pAttributeV1
                    )[attribute];
                    ...
                    switch (windowsClaim.ValueType)
                    {
                        case Interop
                            ...
                            for (int item = 0; item < windowsClaim.ValueCount; item++)
                            {
                                Claim c = new Claim(
                                    name,
                                    Marshal.PtrToStringUni(stringPointers[item])!,
                                    ClaimValueTypes.String,
                                    _issuerName,
                                    _issuerName,
                                    this
