            ...
            await Task.Run(
                    () =>
                    {
                        foreach (NetworkInterface nic in NetworkInterface.GetAllNetworkInterfaces())
                        {
                            ...
                            _log.WriteLine(
                                "- Anycast Addresses: " + ipProperties.AnycastAddresses.Count
                            );
                            ...
                            _log.WriteLine(
                                "- Dynamic Dns Enabled: " + ipProperties.IsDynamicDnsEnabled
                            );
                            ...
                            )
                            {
                                ...
                                _log.WriteLine(
                                    "--- Preferred Lifetime: " + uni.AddressPreferredLifetime
                                );
            ...
            await Task.Run(
                    () =>
                    {
                        foreach (NetworkInterface nic in NetworkInterface.GetAllNetworkInterfaces())
                        {
                            ...
                            _log.WriteLine(
                                "ScopeID: " + ipv6Properties.GetScopeId(ScopeLevel.Link)
                            );
                        }
                    }
                )
