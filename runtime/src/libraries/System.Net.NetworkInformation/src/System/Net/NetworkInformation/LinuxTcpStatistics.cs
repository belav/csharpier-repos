...
namespace System.Net.NetworkInformation
{
    internal sealed class LinuxTcpStatistics : TcpStatistics
    {
        ...
        {
            _table = StringParsingHelpers.ParseTcpGlobalStatisticsFromSnmpFile(
            ...
            _currentConnections = StringParsingHelpers.ParseNumSocketConnections(
                sockstatFile,
                protoName
            );
        }
        ...
        {
            get { return _table.RetransSegs; }
        }

        public override long SegmentsSent
        {
            get { return _table.OutSegs; }
        }
    }
}
