...
public class ZipFile_Create_Stream : ZipFileTestBase
{
    ...
    public void CreateFromDirectory_CompressionLevel_OutOfRange_Throws(
        CompressionLevel invalidCompressionLevel
    )
    {
        using MemoryStream ms = new MemoryStream();
    ...
    public void CreateFromDirectoryUnicode()
    {
        ...
        IEnumerable<string> expected = Directory
            .EnumerateFileSystemEntries(zfolder("unicode"), "*", SearchOption.AllDirectories)
            .ToList();
        Assert.True(
