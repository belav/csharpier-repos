...
namespace System.Numerics.Tensors
{
    ...
    internal class BoolArithmetic : ITensorArithmetic<bool>
    {
        ...
        public void And(DenseTensor<bool> left, DenseTensor<bool> right, DenseTensor<bool> result)
        {
            ...
            else
            {
                ...
                ref int resultIndex = ref result.IsReversedStride
                    ? ref colMajorIndex
                    : ref rowMajorIndex;
                ref int op1Index = ref left.IsReversedStride
                    ? ref colMajorIndex
                    : ref rowMajorIndex;

                ref int op2Index = ref right.IsReversedStride
                    ? ref colMajorIndex
                    : ref rowMajorIndex;
        ...
        public void And(DenseTensor<bool> tensor, bool scalar, DenseTensor<bool> result)
        {
            ...
            else
            {
                ...
                ref int resultIndex = ref result.IsReversedStride
                    ? ref colMajorIndex
                    : ref rowMajorIndex;
                ref int op1Index = ref tensor.IsReversedStride
                    ? ref colMajorIndex
                    : ref rowMajorIndex;
    ...
    internal class ByteArithmetic : ITensorArithmetic<byte>
    {
        ...
        )
        {
            ...
            ArrayUtilities.SplitStrides(
                left.strides,
                leftAxes,
                leftNonSummingStrides,
                0,
                leftSummingStrides,
                0
            );
            ...
            ArrayUtilities.SplitStrides(
                right.strides,
                rightAxes,
                rightNonSummingStrides,
                rightNonSummingStridesOffset,
                rightSummingStrides,
                0
            );
            ...
            for (int resultIndex = 0; resultIndex < result.Length; resultIndex++)
            {
                ...
                ArrayUtilities.GetIndices(
                    result.strides,
                    result.IsReversedStride,
                    resultIndex,
                    resultIndices
                );
                ...
                {
                    int leftIndexSumming = ArrayUtilities.TransformIndexByStrides(
                        summingIndex,
                        summingStrides,
                        false,
                        leftSummingStrides
                    );
                    int rightIndexSumming = ArrayUtilities.TransformIndexByStrides(
                        summingIndex,
                        summingStrides,
                        false,
                        rightSummingStrides
