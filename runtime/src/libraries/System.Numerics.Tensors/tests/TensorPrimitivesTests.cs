...
namespace System.Numerics.Tensors.Tests
{
    public static partial class TensorPrimitivesTests
    {
        ...
        public static IEnumerable<object[]> VectorLengthAndIteratedRange(
            float min,
            float max,
            float increment
        )
        ...
        private static void AssertEqualTolerance(
            double expected,
            double actual,
        ...
        public static void CosineSimilarity(int tensorLength)
        {
            ...
            AssertEqualTolerance(
                dot / (MathF.Sqrt(squareX) * MathF.Sqrt(squareY)),
        ...
        public static void Divide_TwoTensors_ThrowsForOverlapppingInputsWithOutputs()
        {
            float[] array = new float[10];
            AssertExtensions.Throws<ArgumentException>("destination", () =>
                TensorPrimitives.Divide(array.AsSpan(1, 2), array.AsSpan(4, 2), array.AsSpan(0, 2))
            );
            AssertExtensions.Throws<ArgumentException>("destination", () =>
                TensorPrimitives.Divide(array.AsSpan(1, 2), array.AsSpan(4, 2), array.AsSpan(2, 2))
            );
            AssertExtensions.Throws<ArgumentException>("destination", () =>
                TensorPrimitives.Divide(array.AsSpan(1, 2), array.AsSpan(4, 2), array.AsSpan(3, 2))
            );
            AssertExtensions.Throws<ArgumentException>("destination", () =>
                TensorPrimitives.Divide(array.AsSpan(1, 2), array.AsSpan(4, 2), array.AsSpan(5, 2))
            );
        }
        ...
        public static void Max_Tensor(int tensorLength)
        {
            ...
            Assert.Equal(
                SingleToUInt32(x[TensorPrimitives.IndexOfMax(x)]),
                SingleToUInt32(TensorPrimitives.Max(x))
            );
        }
        ...
        public static void MaxMagnitude_Tensor(int tensorLength)
        {
            ...
            Assert.Equal(
                SingleToUInt32(x[TensorPrimitives.IndexOfMaxMagnitude(x)]),
                SingleToUInt32(TensorPrimitives.MaxMagnitude(x))
            );
        }
        ...
        public static void Min_Tensor(int tensorLength)
        {
            ...
            Assert.Equal(
                SingleToUInt32(x[TensorPrimitives.IndexOfMin(x)]),
                SingleToUInt32(TensorPrimitives.Min(x))
            );
        }
        ...
        public static void MinMagnitude_Tensor(int tensorLength)
        {
            ...
            Assert.Equal(
                SingleToUInt32(x[TensorPrimitives.IndexOfMinMagnitude(x)]),
                SingleToUInt32(TensorPrimitives.MinMagnitude(x))
            );
        }
