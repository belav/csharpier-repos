...
namespace System.Composition.Hosting.Core.Tests
{
    public class CompositionHostTests
    {
        ...
        public class MultipleDependency : ExportDescriptorProvider
        {
            ...
            )
            {
                var target = new ExportDescriptorPromise(
                    ...
                    () =>
                    {
                        var dependencyTarget = new ExportDescriptorPromise(
                            new CompositionContract(typeof(int)),
                            "Origin2",
                            true,
                        ...
                        {
                            CompositionDependency.Satisfied(
                                contract,
                                dependencyTarget,
                                true,
                                "Site"
        ...
        [InlineData(
            typeof(Lazy<int, Dictionary<string, object>>),
            new Type[] { typeof(int), typeof(Lazy<int, Dictionary<string, object>>) }
        )]
        [InlineData(
            typeof(Lazy<int, ParameterlessConstructor>),
            new Type[] { typeof(int), typeof(Lazy<int, ParameterlessConstructor>) }
        )]
        ...
        [InlineData(
            ...
            new Type[] { typeof(ICollection<string>), typeof(string) }
        )]
        [InlineData(
            typeof(IEnumerable<string>),
            new Type[] { typeof(IEnumerable<string>), typeof(string) }
        )]
        ...
        [InlineData(
            typeof(ExportFactory<int, ParameterlessConstructor>),
            null,
            new Type[] { typeof(int), typeof(ExportFactory<int, ParameterlessConstructor>) }
        )]
        [InlineData(
            typeof(ExportFactory<int, ParameterlessConstructor>),
            new string[] { "1", "2", "3" },
