...
namespace System.Composition.Hosting.Providers.ExportFactory
{
    ...
    {
        private static readonly MethodInfo s_getExportFactoryDefinitionsMethod =
            typeof(ExportFactoryExportDescriptorProvider)
                .GetTypeInfo()
        ...
        )
        {
            ...
            var gld = s_getExportFactoryDefinitionsMethod.MakeGenericMethod(
                            ...
                            (c, o) =>
                            {
                                return new ExportFactory<TProduct>(() =>
                                {
                                    ...
                                    return Tuple.Create<TProduct, Action>(
                                        (TProduct)CompositionOperation.Run(lifetimeContext, da),
