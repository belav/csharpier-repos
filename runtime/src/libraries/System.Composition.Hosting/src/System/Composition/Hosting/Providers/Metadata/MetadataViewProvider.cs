...
namespace System.Composition.Hosting.Providers.Metadata
{
    internal static class MetadataViewProvider
    {
        ...
        public static Func<
            ...
            TMetadata
        > GetMetadataViewProvider<TMetadata>()
        {
            ...
            if (!typeof(TMetadata).GetTypeInfo().IsClass)
                throw new CompositionFailedException(
                    SR.Format(
                        SR.MetadataViewProvider_InvalidViewImplementation,
            ...
            throw new CompositionFailedException(
                SR.Format(SR.MetadataViewProvider_InvalidViewImplementation, typeof(TMetadata).Name)
            );
        }

        private static TValue GetMetadataValue<TValue>(
