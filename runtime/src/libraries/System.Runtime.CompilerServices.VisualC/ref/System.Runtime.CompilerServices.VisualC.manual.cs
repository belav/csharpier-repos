...
// We need to add an InternalsVisibleToAttribute here to mscorlib since we need to expose these
// types via type forwards in mscorlib
// since tooling expects these types to live there and not in
