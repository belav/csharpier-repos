...
namespace Microsoft.Extensions.DependencyInjection.Tests
{
    ...
    public class DependencyInjectionEventSourceTests : IDisposable
    {
        ...
        public void ExistsWithCorrectId()
        {
            ...
            Assert.Equal(
                Guid.Parse("27837f46-1a43-573d-d30c-276de7d02192"),
        ...
        public void EmitsCallSiteBuiltEvent()
        {
            ...
            >();
            serviceCollection.AddSingleton<IFakeMultipleService>(
                provider => new FakeDisposableCallbackInnerService(fakeDisposeCallback)
            );
            ...
            var callsiteBuiltEvent = _listener.EventData.Single(
                e => e.EventName == "CallSiteBuilt"
            );
            ...
            Assert.Equal(
                "System.Collections.Generic.IEnumerable`1[Microsoft.Extensions.DependencyInjection.Specification.Fakes.IFakeOuterService]",
                GetProperty<string>(callsiteBuiltEvent, "serviceType")
            );
        ...
        public void EmitsServiceResolvedEvent()
        {
            ...
            var serviceResolvedEvents = _listener
                .EventData.Where(e => e.EventName == "ServiceResolved")
                .ToArray();
            ...
            foreach (var serviceResolvedEvent in serviceResolvedEvents)
            {
                Assert.Equal(
                    ...
                    GetProperty<string>(serviceResolvedEvent, "serviceType")
                );
        ...
        public void EmitsExpressionTreeBuiltEvent()
        {
            ...
            var expressionTreeGeneratedEvent = _listener.EventData.Single(
                e => e.EventName == "ExpressionTreeGenerated"
            );

            Assert.Equal(
                "Microsoft.Extensions.DependencyInjection.Specification.Fakes.IFakeService",
                GetProperty<string>(expressionTreeGeneratedEvent, "serviceType")
            );
        ...
        public void EmitsDynamicMethodBuiltEvent()
        {
            ...
            var serviceProvider = serviceCollection.BuildServiceProvider(
                ServiceProviderMode.ILEmit
            );

            serviceProvider.GetService<IFakeService>();

            var expressionTreeGeneratedEvent = _listener.EventData.Single(
                e => e.EventName == "DynamicMethodBuilt"
            );
        ...
        public void EmitsScopeDisposedEvent()
        {
            ...
            var scopeDisposedEvent = _listener.EventData.Single(
                e => e.EventName == "ScopeDisposed"
            );
        ...
        public void EmitsServiceRealizationFailedEvent()
        {
            ...
            var serviceRealizationFailedEvent = _listener.EventData.Single(
                e => e.EventName == eventName
            );

            Assert.Equal(
                "System.Exception: Test error.",
                GetProperty<string>(serviceRealizationFailedEvent, "exceptionMessage")
            );
            Assert.Equal(
                1234,
                GetProperty<int>(serviceRealizationFailedEvent, "serviceProviderHashCode")
            );
        ...
        public void EmitsServiceProviderBuilt()
        {
            ...
            serviceCollection.AddTransient<
                ...
                FakeOpenGenericService<PocoClass>
            >();

            using ServiceProvider provider = serviceCollection.BuildServiceProvider();

            EventWrittenEventArgs serviceProviderBuiltEvent = _listener.EventData.Single(
                e => e.EventName == "ServiceProviderBuilt"
            );
            ...
            EventWrittenEventArgs serviceProviderDescriptorsEvent = _listener.EventData.Single(
                e => e.EventName == "ServiceProviderDescriptors"
            );
            Assert.Equal(
                string.Join(
                    Environment.NewLine,
                ...
                JObject
                    .Parse(GetProperty<string>(serviceProviderDescriptorsEvent, "descriptors"))
                    .ToString()
            );
