...
namespace Microsoft.Extensions.DependencyModel
{
    public class DependencyContextWriter
    {
        ...
        private void AddStringPropertyIfNotNull(
            string name,
            string? value,
            Utf8JsonWriter jsonWriter
        )
        ...
        private void WritePortableTarget(
            string key,
        ...
        private void WritePortableTargetLibrary(
            string key,
        ...
        private bool AddRuntimeSpecificAssetGroups(
            string assetType,
            ...
            foreach (RuntimeAssetGroup group in groups)
            {
                ...
                else
                {
                    ...
                    string pseudoPathFolder =
                        assetType == DependencyContextStrings.RuntimeAssetType ? "lib" : "native";
        ...
        private void AddRuntimeSpecificAssets(
