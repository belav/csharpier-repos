...
namespace Microsoft.Extensions.DependencyModel.Tests
{
    public class DependencyContextTests
    {
        ...
        public void GetRuntimeNativeAssetsReturnsMostSpecificAssetIfRIDSpecificAssetInLibrary()
        {
            ...
            assets.Should()
                .BeEquivalentTo(
                    Path.Combine("runtimes", "linux-x64", "native", "System.Banana.Native.so")
                );
        }
                ...
                runtimeLibraries: new[]
                {
                    new RuntimeLibrary(
                        ...
                        new[]
                        {
                            new RuntimeAssetGroup(
                                string.Empty,
                                Path.Combine("lib", "netstandard1.3", "System.Collections.dll")
                            ),
        ...
        public void MergeMergesLibraries()
        {
            ...
            result.CompileLibraries.Should()
                .BeEquivalentTo(
                    new[]
                    {
            ...
            result.RuntimeLibraries.Should()
                .BeEquivalentTo(
        ...
        public void MergeMergesLibrariesWithDifferentCasing()
        {
            ...
            result.CompileLibraries.Should().BeEquivalentTo(new[] { compilationLibraries[0] });

            result.RuntimeLibraries.Should().BeEquivalentTo(new[] { runtimeLibraries[0] });
        }
        ...
        {
            return new TargetInfo("Framework", "runtime", "runtimeSignature", true);
        }
