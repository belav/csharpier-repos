...
namespace Microsoft.Extensions.DependencyModel.Tests
{
    public class ReferenceAssemblyResolverTests
    {
        ...
        public void SkipsNonReferenceAssembly()
        {
            ...
            var library = F.Create(F.PackageType);
        ...
        {
            var environment = EnvironmentMockBuilder
                .Create()
                .SetIsWindows(true)
                .AddVariable("DOTNET_REFERENCE_ASSEMBLIES_PATH", ReferencePath)
                .Build();

            var result = ReferenceAssemblyPathResolver.GetDefaultReferenceAssembliesPath(
        ...
        public void ReturnsProgramFilesAsDefaultLocationOnWin32()
        {
            ...
            result
                .Should()
                .Be(
                    Path.Combine("Program Files", "Reference Assemblies", "Microsoft", "Framework")
                );
        }
        ...
        public void ReturnNet20PathAsFallbackOnWindows()
        {
            ...
            var fileSystem = FileSystemMockBuilder.Create().AddFiles(net20Path, "some.dll").Build();
            ...
            var result = ReferenceAssemblyPathResolver.GetFallbackSearchPaths(
                fileSystem,
                environment
            );
        ...
        public void ShouldResolveAll()
        {
            ...
            var library = F.Create(
                libraryType: F.ReferenceAssemblyType,
                assemblies: F.TwoAssemblies
            );
            var assemblies = new List<string>();
