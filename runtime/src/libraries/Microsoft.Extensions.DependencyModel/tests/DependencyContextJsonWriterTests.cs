    ...
    public class DependencyContextJsonWriterTests
    {
        ...
        public void SavesRuntimeGraph()
        {
            ...
            rids.Should()
                ...
                .BeOfType<JArray>()
                .Which.Values<string>()
                .ShouldBeEquivalentTo(new[] { "win6", "win5" });
            ...
            rids.Should()
                ...
                .BeOfType<JArray>()
                .Which.Values<string>()
                .ShouldBeEquivalentTo(new[] { "win7-x64" });
        }
        ...
        {
            var result = Save(
                Create("Target", "runtime", false, runtimeSignature: "runtimeSignature")
            );
            result.Should()
        ...
        {
            var result = Save(
                Create("Target", "runtime", true, runtimeSignature: "runtimeSignature")
            );
            result.Should()
                .HavePropertyAsObject("runtimeTarget")
                .Which.Should()
        ...
        public void WritesRuntimeLibrariesToRuntimeTargetWithAssemblyVersions()
        {
            ...
            {
                new RuntimeFile("Banana.Win7-x64.dll", "1.2.3", "7.8.9")
            };
        ...
        private JObject WritesRuntimeLibrariesToRuntimeTargetCore(RuntimeAssetGroup group)
        {
                ...
                Create(
                    ...
                    runtimeLibraries: new[]
                    {
                        new RuntimeLibrary(
                            ...
                            "1.2.3",
                            "HASH",
                            new[] { new RuntimeAssetGroup(string.Empty, "Banana.dll"), group },
                            new[]
                            {
            ...
            var runtimeAssembly =
                runtimeTargets.Should().HavePropertyAsObject("Banana.Win7-x64.dll").Subject;
            runtimeAssembly.Should().HavePropertyValue("rid", "win7-x64");
            runtimeAssembly.Should().HavePropertyValue("assetType", "runtime");

            var nativeLibrary =
                runtimeTargets.Should().HavePropertyAsObject("native/Banana.Win7-x64.so").Subject;
            ...
            var resourceAssembly =
                resourceAssemblies.Should()
                    .HavePropertyAsObject("en-US/Banana.Resource.dll").Subject;
            ...
            library.Should().HavePropertyValue("hashPath", "PackageHashPath");
            library.Should()
                .HavePropertyValue("runtimeStoreManifestName", "placeHolderManifest.xml");
                    ...
                    runtimeLibraries: new[]
                    {
                        new RuntimeLibrary(
                            ...
                            new[]
                            {
                                new RuntimeAssetGroup(
                                    string.Empty,
                                    new[] { new RuntimeFile("coreclr.dll", "4.5.6", "5.6.7"), }
                                ),
                            },
        ...
        public void MergesRuntimeAndCompileLibrariesForPortable()
        {
            ...
            var nativeLibrary =
                runtimeTargets.Should().HavePropertyAsObject("Banana.Win7-x64.so").Subject;
            nativeLibrary.Should().HavePropertyValue("rid", "win7-x64");
            nativeLibrary.Should().HavePropertyValue("assetType", "native");
        ...
        public void WritesPlaceholderRuntimeTargetsForEmptyGroups()
        {
            ...
            var winPlaceholder =
                runtimeTargets.Should().HavePropertyAsObject("runtime/win7-x64/lib/_._").Subject;
            winPlaceholder.Should().HavePropertyValue("rid", "win7-x64");
            winPlaceholder.Should().HavePropertyValue("assetType", "runtime");

            var winRuntime =
                runtimeTargets.Should().HavePropertyAsObject("lib/x86Support.dll").Subject;
            winPlaceholder.Should().HavePropertyValue("rid", "win7-x64");
            winPlaceholder.Should().HavePropertyValue("assetType", "runtime");

            var linuxPlaceholder =
                runtimeTargets.Should()
                    .HavePropertyAsObject("runtime/linux-x64/native/_._").Subject;
            linuxPlaceholder.Should().HavePropertyValue("rid", "linux-x64");
            linuxPlaceholder.Should().HavePropertyValue("assetType", "native");

            var osxNative =
                runtimeTargets.Should().HavePropertyAsObject("native/OSXSupport.dylib").Subject;
        ...
        public void WritesResourceAssembliesForNonPortable()
        {
            ...
            var resource =
                resources.Should().HavePropertyAsObject("en-US/Fruits.resources.dll").Subject;
