        ...
        public async Task ValidateOnStart_NamedOptions_ValidatesFailureOnStart()
        {
            var hostBuilder = CreateHostBuilder(
                services =>
                {
                    ...
                    services.AddOptions<FakeSettings>("named").Configure<FakeService>(
                        (o, _) =>
                        {
                            o.Name = "named";
                        }
                    ).Validate(o => o.Name == null, "trigger validation failure for named option!").ValidateOnStart();
                }
            );
        ...
        private async Task ValidateOnStart_AddOptionsMultipleTimesForSameType_LastOneGetsTriggered()
        {
            ...
            var hostBuilder = CreateHostBuilder(
                services =>
                {
                    ...
                    services.AddOptions<ComplexOptions>("bad_configuration2").Configure(
                        o =>
                        {
                            o.Boolean = false;
                            o.Integer = 11;
                        ...
                        "Boolean"
                    ).Validate(o => o.Integer > 12, "Integer").ValidateOnStart();
                }
            );
        ...
        public async Task ValidateOnStart_AddBothLazyAndEagerValidationOnDifferentTypes_ValidatesWhenHostStartsOnlyForEagerValidations()
        {
            ...
            var hostBuilder = CreateHostBuilder(
                services =>
                {
                    ...
                    services.AddOptions<NestedOptions>().Configure(o => o.Integer = 11).Validate(
                        o =>
                        {
        ...
        public async Task ValidateOnStart_MultipleErrorsInOneValidationCall_ValidatesFailureWithMultipleErrors()
        {
            var hostBuilder = CreateHostBuilder(
                services =>
                {
                    ...
                    ).Validate(o => o.Boolean).Validate(o => o.Integer > 12).ValidateOnStart();
                }
            );
        ...
        public async Task ValidateOnStart_MultipleErrorsInOneValidationCallUsingCustomErrors_FailuresContainCustomErrors()
        {
            var hostBuilder = CreateHostBuilder(
                services =>
                {
                    ...
                    ).Validate(o => o.Boolean).Validate(o => o.Virtual == null, "Virtual").Validate(o => o.Integer > 12, "Integer").ValidateOnStart();
                }
            );
            using (var host = hostBuilder.Build())
            {
