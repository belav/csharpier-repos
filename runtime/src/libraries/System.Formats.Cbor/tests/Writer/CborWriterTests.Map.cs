...
namespace System.Formats.Cbor.Tests
{
    public partial class CborWriterTests
    {
        ...
        [InlineData(
            new object[] { Map, "d", "D", "e", "E", "a", "A", "b", "B", "c", "C" },
            "a56161614161626142616361436164614461656145"
        )]
        [InlineData(
            new object[] { Map, "a", "A", -1, 2, new byte[] { }, new byte[] { 1 } },
        ...
        public static void WriteMap_SimpleValues_ShouldSortKeysAccordingToConformanceMode(
