...
namespace System.Formats.Cbor.Tests
{
    public partial class CborReaderTests
    {
        ...
        public static void ReadTag_SingleValue_HappyPath(
            ulong expectedTag,
        ...
        [InlineData(
            ...
            "c0c0c074323031332d30332d32315432303a30343a30305a"
        )]
        [InlineData(
            new ulong[] { int.MaxValue, ulong.MaxValue },
            1363896240,
            "da7fffffffdbffffffffffffffff1a514b67b0"
        )]
        [InlineData(new ulong[] { 23, 24, 100 }, new byte[] { 1, 2, 3, 4 }, "d7d818d8644401020304")]
        [InlineData(
            new ulong[] { 32, 1, 1 },
            new object[] { 1, "lorem ipsum" },
            "d820c1c182016b6c6f72656d20697073756d"
        )]
        public static void ReadTag_NestedTags_HappyPath(
            ulong[] expectedTags,
            object expectedValue,
            string hexEncoding
        )
        ...
        [InlineData(
            "2020-04-09T14:31:21.3535941+01:00",
            "c07821323032302d30342d30395431343a33313a32312e333533353934312b30313a3030"
        )]
        [InlineData(
            "2020-04-09T11:41:19.12-08:00",
            "c0781c323032302d30342d30395431313a34313a31392e31322d30383a3030"
        )]
        [InlineData(
            "2020-04-09T11:41:19.12-08:00",
            "c07f781c323032302d30342d30395431313a34313a31392e31322d30383a3030ff"
        )] // indefinite-length date string
        ...
        public static void ReadDateTimeOffset_IsCultureInvariant()
        {
            ...
            RemoteExecutor
                .Invoke(static () =>
                {
                    DateTimeOffset expectedValue = DateTimeOffset.Parse(
                        "2020-04-09T14:31:21.3535941+01:00",
        ...
        public static void ReadTaggedValue_SupportedConformance_ShouldSucceed(
        ...
        public static void ReadTaggedValue_UnsupportedConformance_ShouldThrowCborContentException(
            CborConformanceMode mode,
            object expectedValue,
            string hexEncoding
        )
