...
#pragma warning restore CS0618
        ...
        public void ParameterInvalid()
        {
            ...
            Assert.StartsWith(
                string.Format(SR.GetResourceString("Parameter_Invalid", null), "foo"),
                e.Message
            );
        }
        ...
        public void ParameterNullOrEmpty()
        {
            ...
            Assert.Equal("foo", e.ParamName);
            Assert.StartsWith(
                string.Format(SR.GetResourceString("Parameter_NullOrEmpty", null), "foo"),
                e.Message
            );
        }
        ...
        public void PropertyInvalid()
        {
            ...
            Assert.Equal("foo", e.ParamName);
            Assert.StartsWith(
                string.Format(SR.GetResourceString("Property_Invalid", null), "foo"),
                e.Message
            );
        }
        ...
        public void PropertyNullOrEmpty()
        {
            ...
            Assert.Equal("foo", e.ParamName);
            Assert.StartsWith(
                string.Format(SR.GetResourceString("Property_NullOrEmpty", null), "foo"),
                e.Message
            );
        }
        ...
        public void UnexpectedError()
        {
            ...
            Assert.NotNull(e);
            Assert.StartsWith(
                string.Format(SR.GetResourceString("Unexpected_Error", null), "foo"),
                e.Message
            );
        }
    }
