...
namespace System.Configuration
{
    ...
    public abstract class ConfigurationElement
    {
        ...
        public ElementInformation ElementInformation =>
            _evaluationElement ?? (_evaluationElement = new ElementInformation(this));
        ...
        internal void MergeLocks(ConfigurationElement source)
        {
            ...
            _itemLockedFlag =
                (source._itemLockedFlag & ConfigurationValueFlags.Locked) != 0
            ...
            foreach (PropertyInformation propInfo in source.ElementInformation.Properties)
                ...
                )
                {
                    ...
                    if (ElementInformation.Properties[propInfo.Name] == null)
                    {
                        ...
                        ConfigurationProperty prop = source.Properties[propInfo.Name];
                        ...
                        ConfigurationValueFlags flags =
                            ConfigurationValueFlags.Inherited | ConfigurationValueFlags.Locked;
                        Values.SetValue(
                            propInfo.Name,
                            propInfo.Value,
                            flags,
        ...
        protected internal virtual bool IsModified()
        {
            if (
                ...
                || (
                    ...
                    && _lockedAllExceptAttributesList.IsModified
                )
                || ((_lockedElementsList != null) && _lockedElementsList.IsModified)
                || (
                    (_lockedAllExceptElementsList != null)
                    && _lockedAllExceptElementsList.IsModified
                )
        ...
        internal void ResetLockLists(ConfigurationElement parentElement)
        {
            ...
            _itemLockedFlag =
                (parentElement._itemLockedFlag & ConfigurationValueFlags.Locked) != 0
            ...
            foreach (ConfigurationProperty configProperty in Properties)
            {
                ...
                if (!Equals(thisValue, otherValue))
                {
                    ...
                    if (
                        !(
                            (
                                IsNullOrNullProperty(thisValue)
                                && Equals(otherValue, configProperty.DefaultValue)
                            )
                            || (
                                IsNullOrNullProperty(otherValue)
                                && Equals(thisValue, configProperty.DefaultValue)
                            )
                        )
                    )
                        return false;
        ...
        private static void ApplyValidatorsRecursive(ConfigurationElement root)
        {
            ...
            foreach (ConfigurationElement elem in root.Values.ConfigurationElements)
        ...
        internal string PropertyFileName(string propertyName)
        {
            ...
            PropertySourceInfo p =
                PropertyInfoInternal(propertyName) ?? PropertyInfoInternal(string.Empty);
        ...
        )
        {
            ...
            if (hasAnyChildElements)
            {
                foreach (ConfigurationProperty prop in Properties)
                    if (prop.IsConfigurationElementType)
                    {
                        ConfigurationElement pElem = (ConfigurationElement)parentElement?[prop];
                        ConfigurationElement childElement = (ConfigurationElement)this[prop];
        ...
        )
        {
            ...
            for (int index = 0; index < Values.Count; index++)
            {
                ...
                else
                {
                    ...
                    )
                    {
                        ...
                        {
                            throw new ConfigurationErrorsException(
                                SR.Format(SR.Config_base_required_attribute_locked, prop.Name)
                            );
                        }
                        value = s_nullPropertyValue;
                    }

                    if (value == s_nullPropertyValue || (serializeCollectionKey && !prop.IsKey))
                        continue;
            ...
            if (hasAnyChildElements)
            {
                for (int index = 0; index < Values.Count; index++)
                {
                    ...
                    if (
                        ((_lockedElementsList != null) && _lockedElementsList.DefinedInParent(key))
                        || (
                            (_lockedAllExceptElementsList != null)
                            && _lockedAllExceptElementsList.HasParentElements
        ...
        private static bool SerializeLockList(
        ...
        )
        {
            ...
            )
            {
                format =
                    value != null
                        ...
                        : SR.Config_base_invalid_element_to_lock_by_add;
            }
            else
            {
                format =
                    value != null
                        ? SR.Config_base_invalid_attribute_to_lock
                        : SR.Config_base_invalid_attribute_to_lock_by_add;
            }
            ...
            throw new ConfigurationErrorsException(SR.Format(format, attribToLockTrim, sb));
        }
        ...
        )
        {
            ...
            if (
                ...
                throw new ConfigurationErrorsException(
                    SR.Format(SR.Config_base_element_locked, reader.Name),
                    reader
                );
                        ...
                        switch (propertyName)
                        {
                            case LockItemKey:
                                ...
                                catch
                                {
                                    throw new ConfigurationErrorsException(
                                        SR.Format(
                                            SR.Config_invalid_boolean_attribute,
                                            propertyName
                                        ),
                                        reader
                                    );
        ...
        )
        {
            ...
            )
            {
                ...
                {
                    throw new ConfigurationErrorsException(
                        SR.Format(SR.Validator_does_not_support_elem_type, elem.GetType().Name)
                    );
                }
            }
            ...
            {
                throw new ConfigurationErrorsException(
                    SR.Format(SR.Validator_element_not_valid, elem.ElementTagName, ex.Message)
                );
            }
