...
namespace System.Configuration
{
    ...
    internal abstract class BaseConfigurationRecord : IInternalConfigRecord
    {
        ...
        private static readonly SearchValues<char> s_invalidSubPathChars = SearchValues.Create(
            InvalidSubPathCharactersString
        );
#else
        private static ReadOnlySpan<char> s_invalidSubPathChars =>
            InvalidSubPathCharactersString.AsSpan();
#endif
        ...
        private static ConfigXmlReader FindSectionRecursive(
            string[] keys,
            int iKey,
            XmlUtil xmlUtil,
            ref int lineNumber
        ...
        )
        {
            ...
            if (mode == OverrideMode.Inherit)
            {
                ...
                OverrideMode defaultMode = FindFactoryRecord(configKey, true)
                    .OverrideModeDefault
                    .OverrideMode;
