    ...
    public class PersianCalendarTests : CalendarTestBase
    {
        ...
        public void CalendarConversion()
        {
            ...
            for (int i = 0; i < s_dates.Length; i += 6)
            {
                ...
                DateTime result = calendar.ToDateTime(
                    s_dates[i],
                    s_dates[i + 1],
                    s_dates[i + 2],
                    0,
        ...
        public void IsLeapYear()
        {
            ...
            foreach (int year in s_leapYears)
            {
                Assert.True(
                    ...
                    string.Format("Year {0} is not recognized as leap year", year)
                );
                Assert.False(
                    calendar.IsLeapYear(lastNonLeap),
                    string.Format("Year {0} is recognized as leap year", lastNonLeap)
                );
                lastNonLeap = year - 1;
            }
