...
namespace System.Globalization.Tests
{
    public abstract class CalendarTestBase
    {
        ...
        public void AddMonths_Invalid_ThrowsArgumentException()
        {
            ...
            Assert.ThrowsAny<ArgumentException>(() =>
                calendar.AddMonths(calendar.MinSupportedDateTime, -1)); // JapaneseCalendar throws ArgumentException
        ...
        public void GetEra_Invalid_ThrowsArgumentOutOfRangeException()
        {
            ...
            Assert.All(
                ...
                dt =>
                {
                    ...
                    if (
                        (calendar is JapaneseCalendar && PlatformDetection.IsNlsGlobalization)
