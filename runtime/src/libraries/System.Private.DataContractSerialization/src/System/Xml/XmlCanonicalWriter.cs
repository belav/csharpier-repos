                ...
                for (int i = 0; i < inclusivePrefixes.Length; ++i)
                {
                    if (inclusivePrefixes[i] == null)
                    {
                        throw DiagnosticUtility
                            .ExceptionUtility
                            .ThrowHelperArgument(SR.InvalidInclusivePrefixListCollection);
                    }
        ...
        public void WriteStartElement(string prefix, string localName)
        {
            if (prefix == null)
                throw System
                    ...
                    .DiagnosticUtility
                    .ExceptionUtility
                    .ThrowHelperArgumentNull(nameof(prefix));
            if (localName == null)
                throw System
                    .Runtime
                    .Serialization
        ...
        )
        {
            if (prefixBuffer == null)
                throw System
                    ...
                    .DiagnosticUtility
                    .ExceptionUtility
                    .ThrowHelperError(new ArgumentNullException(nameof(prefixBuffer)));
            if (prefixOffset < 0)
                throw System
                    .Runtime
                    .Serialization
            ...
            if (localNameBuffer == null)
                throw System
                    ...
                    .DiagnosticUtility
                    .ExceptionUtility
                    .ThrowHelperError(new ArgumentNullException(nameof(localNameBuffer)));
        ...
        )
        {
            ...
            if (nsBuffer == null)
                throw System
                    ...
                    .DiagnosticUtility
                    .ExceptionUtility
                    .ThrowHelperError(new ArgumentNullException(nameof(nsBuffer)));
            if (nsOffset < 0)
                throw System
                    .Runtime
                    .Serialization
