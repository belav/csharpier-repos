...
namespace System.Xml
{
        ...
        private struct AttributeValue
        {
            ...
            public void WriteText(string s)
            {
                if (_captureStream != null)
                {
                    ...
                    _captureText = XmlConverter.Base64Encoding
    ...
    internal sealed class XmlBinaryWriter : XmlBaseWriter, IXmlBinaryWriterInitializer
    {
        ...
        )
        {
            if (stream == null)
                throw System.Runtime.Serialization.DiagnosticUtility.ExceptionUtility
                    .ThrowHelperError(new ArgumentNullException(nameof(stream)));
            if (_writer == null)
        ...
        private unsafe void UnsafeWriteArray(
            string? prefix,
            string localName,
            string? namespaceUri,
            XmlBinaryNodeType nodeType,
        ...
        public unsafe override void WriteArray(
            string? prefix,
            string localName,
            string? namespaceUri,
            bool[] array,
