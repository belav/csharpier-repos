...
namespace System.Xml
{
    internal abstract class XmlBaseWriter : XmlDictionaryWriter, IFragmentCapableXmlDictionaryWriter
    {
        ...
        public override void WriteXmlnsAttribute(string? prefix, string ns)
        {
            ...
            if (_writeState != WriteState.Element)
                throw new InvalidOperationException(
                    SR.Format(SR.XmlInvalidWriteState, "WriteXmlnsAttribute", WriteState.ToString())
                );
        ...
        )
        {
            ...
            if (_writeState != WriteState.Element)
                throw new InvalidOperationException(
                    SR.Format(SR.XmlInvalidWriteState, "WriteStartAttribute", WriteState.ToString())
                );
        ...
        public override void WriteEndAttribute()
        {
            ...
            if (_writeState != WriteState.Attribute)
                throw new InvalidOperationException(
                    SR.Format(SR.XmlInvalidWriteState, "WriteEndAttribute", WriteState.ToString())
                );
        ...
        public override void WriteFullEndElement()
        {
            ...
            if (_writeState != WriteState.Element && _writeState != WriteState.Content)
                throw new InvalidOperationException(
                    SR.Format(SR.XmlInvalidWriteState, "WriteFullEndElement", WriteState.ToString())
                );
        ...
        )
        {
            ...
            if (_writeState == WriteState.Attribute)
                throw new InvalidOperationException(
                    SR.Format(SR.XmlInvalidWriteState, "WriteStartElement", WriteState.ToString())
                );
        ...
        public override void WriteStartDocument()
        {
            ...
            if (_writeState != WriteState.Start)
                throw new InvalidOperationException(
                    SR.Format(SR.XmlInvalidWriteState, "WriteStartDocument", WriteState.ToString())
                );
