    ...
    public static class JsonFormatGeneratorStatics
    {
        ...
        public static MethodInfo GetJsonDataContractMethod
        {
            ...
            get
            {
                ...
                {
                    s_getJsonDataContractMethod = typeof(JsonDataContract).GetMethod(
                        "GetJsonDataContract",
                        Globals.ScanAllMembers
                    );
        ...
        public static PropertyInfo LocalNameProperty
        {
            get
            {
                ...
                {
                    s_localNameProperty = typeof(XmlReaderDelegator).GetProperty(
                        "LocalName",
                        Globals.ScanAllMembers
                    );
        ...
        public static PropertyInfo NamespaceProperty
        {
            get
            {
                ...
                {
                    s_namespaceProperty = typeof(XmlReaderDelegator).GetProperty(
                        "NamespaceProperty",
                        Globals.ScanAllMembers
                    );
        ...
        public static MethodInfo MoveToContentMethod
        {
            get
            {
                ...
                {
                    s_moveToContentMethod = typeof(XmlReaderDelegator).GetMethod(
                        "MoveToContent",
                        Globals.ScanAllMembers
                    );
        ...
        public static MethodInfo ReadJsonValueMethod
        {
            ...
            get
            {
                ...
                {
                    s_readJsonValueMethod = typeof(DataContractJsonSerializer).GetMethod(
                        "ReadJsonValue",
                        Globals.ScanAllMembers
                    );
        ...
        public static MethodInfo WriteJsonValueMethod
        {
            ...
            get
            {
                ...
                {
                    s_writeJsonValueMethod = typeof(DataContractJsonSerializer).GetMethod(
                        "WriteJsonValue",
                        Globals.ScanAllMembers
                    );
        ...
        public static MethodInfo WriteStartElementStringMethod
        {
            get
            {
                ...
                {
                    s_writeStartElementStringMethod = typeof(XmlWriterDelegator).GetMethod(
                        "WriteStartElement",
                        Globals.ScanAllMembers,
        ...
        public static MethodInfo ParseEnumMethod
        {
            get
            {
                ...
                {
                    s_parseEnumMethod = typeof(Enum).GetMethod(
                        "Parse",
