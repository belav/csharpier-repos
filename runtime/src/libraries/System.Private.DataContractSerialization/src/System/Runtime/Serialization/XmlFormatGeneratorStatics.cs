...
namespace System.Runtime.Serialization
{
    internal static class XmlFormatGeneratorStatics
    {
        ...
        internal static ConstructorInfo SerializationExceptionCtor =>
            s_serializationExceptionCtor ??= typeof(SerializationException).GetConstructor(
        ...
        internal static MethodInfo ReplaceDeserializedObjectMethod
        {
            get
            {
                ...
                {
                    s_replaceDeserializedObjectMethod =
                        typeof(XmlObjectSerializerReadContext).GetMethod(
        ...
        internal static MethodInfo GetMemoryStreamMethod
        {
            get
            {
                ...
                {
                    s_getMemoryStreamMethod = typeof(MemoryStreamAdapter).GetMethod(
                        "GetMemoryStream",
                        Globals.ScanAllMembers
                    );
        ...
        internal static MethodInfo GetMemoryStreamAdapterMethod
        {
            get
            {
                ...
                {
                    s_getMemoryStreamAdapterMethod = typeof(MemoryStreamAdapter).GetMethod(
