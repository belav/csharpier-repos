...
namespace System.Runtime.Serialization
{
    internal class XmlObjectSerializerReadContextComplex : XmlObjectSerializerReadContext
    {
        ...
        )
        {
            ...
            {
                return InternalDeserializeInSharedTypeMode(
                    xmlReader,
                    declaredTypeID,
                    Type.GetTypeFromHandle(declaredTypeHandle)!,
                    name,
        ...
        [RequiresUnreferencedCode(DataContract.SerializerTrimmerWarning)]
        private object? InternalDeserializeInSharedTypeMode(
            XmlReaderDelegator xmlReader,
            int declaredTypeID,
            Type declaredType,
            string? name,
        ...
        )
        {
            ...
            {
                Assembly assembly;
                DataContract? tempDataContract = ResolveDataContractInSharedTypeMode(
                    assemblyName,
                    typeName,
                    out assembly,
                    out _
                ...
                if (tempDataContract == null)
                {
                    if (assembly == null)
                        throw XmlObjectSerializer.CreateSerializationException(
                            SR.Format(SR.AssemblyNotFound, assemblyName)
                        );

                    throw XmlObjectSerializer.CreateSerializationException(
                        SR.Format(SR.ClrTypeNotFound, assembly.FullName, typeName)
                    );
                }
                ...
                if (declaredType != null && declaredType.IsArray)
                    dataContract =
                        (declaredTypeID < 0)
                            ...
                            : GetDataContract(declaredTypeID, declaredType.TypeHandle);
            }
            else
            {
        ...
        )
        {
            ...
            DataContract dataContract =
                ...
                ?? GetDataContract(
                    DataContractSurrogateCaller.GetDataContractType(
            ...
            object? oldObj = InternalDeserialize(
                xmlReader,
                name,
                ns,
                declaredType,
            ...
            object? obj = DataContractSurrogateCaller.GetDeserializedObject(
                _serializationSurrogateProvider,
                oldObj,
        ...
        private static Type ResolveDataContractTypeInSharedTypeMode(
            string assemblyName,
            string typeName,
        ...
        )
        {
            ...
            throw new PlatformNotSupportedException(
                SR.PlatformNotSupported_NetDataContractSerializer
            );
        }
