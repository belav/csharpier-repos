...
namespace System.Runtime.Serialization
{
    internal class XmlObjectSerializerReadContext : XmlObjectSerializerContext
    {
        ...
        {
            throw XmlObjectSerializer.CreateSerializationException(
                SR.Format(SR.ArrayExceededSize, arraySize, DataContract.GetClrTypeFullName(type))
            );
        }
                    ...
                    else
                    {
                        throw XmlObjectSerializer.CreateSerializationException(
                            SR.Format(
                                ...
                                DataContract.GetClrTypeFullName(factoryDataContract.UnderlyingType),
        ...
        )
        {
            ...
            if (arraySize != -1)
            {
                ...
                if (dataNode.Items == null)
                {
                    ...
                    throw XmlObjectSerializer.CreateSerializationException(
                        SR.Format(SR.ArraySizeAttributeIncorrect, arraySize, dataNode.Items.Count)
                    );
            }
            else
            {
