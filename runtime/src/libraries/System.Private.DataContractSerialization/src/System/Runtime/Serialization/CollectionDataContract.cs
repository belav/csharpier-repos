...
namespace System.Runtime.Serialization.DataContracts
{
    internal sealed class CollectionDataContract : DataContract
    {
        ...
        private static Type[] KnownInterfaces =>
            CollectionDataContractCriticalHelper.KnownInterfaces;
        ...
        public override bool IsDictionaryLike(
            ...
            get
            {
                if (_helper.XmlFormatWriterDelegate == null)
                {
                    lock (this)
                    {
                        if (_helper.XmlFormatWriterDelegate == null)
                        {
                            XmlFormatCollectionWriterDelegate tempDelegate =
                        ...
                        if (_helper.XmlFormatReaderDelegate == null)
                        {
                            if (IsReadOnlyContract)
                            {
                                ThrowInvalidDataContractException(
                                    _helper.DeserializationExceptionMessage,
                                    type: null
                                );
                            }

                            XmlFormatCollectionReaderDelegate tempDelegate =
            ...
            : DataContract.DataContractCriticalHelper
        {
            ...
            )
            {
                ...
                if (itemType != null)
                {
                    ...
                    XmlDictionary dictionary = isDictionary
                        ? new XmlDictionary(5)
                        : new XmlDictionary(3);
                    ...
                    _itemName =
                        itemName
                        ?? DataContract.GetXmlName(DataContract.UnwrapNullableType(itemType)).Name;
                ...
                : base(type)
            {
                ...
                XmlName = CreateQualifiedName(
                    Globals.ArrayPrefix + itemContract.XmlName.Name,
                    itemContract.XmlName.Namespace
                );
                ...
                : base(type)
            {
                ...
                CollectionDataContractAttribute? collectionContractAttribute;
                XmlName = DataContract.GetCollectionXmlName(
                    type,
                    itemType,
                ...
                : base(type)
            {
                ...
                _invalidCollectionInSharedContractMessage =
                    invalidCollectionInSharedContractMessage;
            }
            ...
            )
            {
                if (_incrementCollectionCountDelegate == null)
                {
                    switch (Kind)
                    {
                        ...
                        case CollectionKind.GenericList:
                            {
                                MethodInfo? buildIncrementCollectionCountDelegate =
                        ...
                        case CollectionKind.GenericDictionary:
                            {
                                MethodInfo? buildIncrementCollectionCountDelegate =
                                    GetBuildIncrementCollectionCountGenericDelegate(
                ...
                static MethodInfo GetBuildIncrementCollectionCountGenericDelegate(Type type) =>
                    BuildIncrementCollectionCountDelegateMethod.MakeGenericMethod(type);
            }
            ...
            private delegate IEnumerator CreateGenericDictionaryEnumeratorDelegate(
            ...
            internal IEnumerator GetEnumeratorForCollection(object obj)
            {
                ...
                static MethodInfo GetBuildCreateGenericDictionaryEnumeratorGenericMethod(
                    Type[] keyValueTypes
                ) =>
                    GetBuildCreateGenericDictionaryEnumeratorMethodInfo.MakeGenericMethod(
                        keyValueTypes[0],
                        keyValueTypes[1]
                    );
            }
            ...
            internal Type GetCollectionElementType()
            {
                Debug.Assert(
                    ...
                    "GetCollectionElementType should not be called on Arrays"
                );
                Debug.Assert(
                    GetEnumeratorMethod != null,
                    "GetEnumeratorMethod should be non-null for non-Arrays"
                );
            ...
            private static CreateGenericDictionaryEnumeratorDelegate BuildCreateGenericDictionaryEnumerator<
                K,
                V
            >()
            {
                return (enumerator) =>
                {
                    return new GenericDictionaryEnumerator<K, V>(
...
#pragma warning restore SYSLIB0050
        ...
        [RequiresDynamicCode(DataContract.SerializerAOTWarning)]
        [RequiresUnreferencedCode(DataContract.SerializerTrimmerWarning)]
        internal static bool IsCollection(
            Type type,
        ...
        [RequiresDynamicCode(DataContract.SerializerAOTWarning)]
        [RequiresUnreferencedCode(DataContract.SerializerTrimmerWarning)]
        private static bool IsCollectionHelper(
            Type type,
            [NotNullWhen(true)] out Type? itemType,
            bool constructorRequired,
            bool skipIfReadOnlyContract = false
        )
        {
        ...
        [RequiresDynamicCode(DataContract.SerializerAOTWarning)]
        [RequiresUnreferencedCode(DataContract.SerializerTrimmerWarning)]
        private static bool IsCollectionOrTryCreate(
            Type type,
            bool tryCreate,
        ...
        )
        {
            ...
            if (DataContract.GetBuiltInDataContract(type) != null)
            {
                return HandleIfInvalidCollection(
                    type,
                    tryCreate,
                    false /*hasCollectionDataContract*/
                    ,
                    false /*isBaseTypeCollection*/
                    ,
                    SR.CollectionTypeCannotBeBuiltIn,
                    null,
                    ref dataContract
                );
            }
...
#pragma warning restore SYSLIB0050
            ...
            if (type.IsDefined(Globals.TypeOfDataContractAttribute, false))
            {
                return HandleIfInvalidCollection(
                    ...
                    SR.CollectionTypeCannotHaveDataContract,
                    null,
                    ref dataContract
                );
            }
            ...
            if (!Globals.TypeOfIEnumerable.IsAssignableFrom(type))
            {
                return HandleIfInvalidCollection(
                    ...
                    hasCollectionDataContract,
                    createContractWithException,
                    SR.CollectionTypeIsNotIEnumerable,
                    null,
                    ref dataContract
                );
            }
...
#pragma warning restore SYSLIB0050
                    else
                    {
                        ...
                        GetReadOnlyCollectionExceptionMessages(
                            ...
                            SR.CollectionTypeDoesNotHaveDefaultCtor,
                            null,
                            out serializationExceptionMessage,
                            out deserializationExceptionMessage
                        );
                    }
                }
            }
...
#pragma warning disable SYSLIB0050 // Type.IsSerializable is obsolete
                    if (type.IsSerializable || skipIfReadOnlyContract)
                    {
                        return HandleIfInvalidCollection(
                            ...
                            tryCreate,
                            hasCollectionDataContract,
                            createContractWithException && !skipIfReadOnlyContract,
...
#pragma warning restore SYSLIB0050
            ...
            else
            {
                if (multipleDefinitions)
                {
                    return HandleIfInvalidCollection(
                        ...
                        KnownInterfaces[(int)kind - 1].Name,
                        ref dataContract
                    );
                }
        ...
        [RequiresDynamicCode(DataContract.SerializerAOTWarning)]
        [RequiresUnreferencedCode(DataContract.SerializerTrimmerWarning)]
        private static bool HandleIfInvalidCollection(
            Type type,
            bool tryCreate,
        ...
        private static void GetReadOnlyCollectionExceptionMessages(
            Type type,
            bool hasCollectionDataContract,
            string message,
            string? param,
            out string serializationExceptionMessage,
            out string deserializationExceptionMessage
        )
        {
            serializationExceptionMessage = GetInvalidCollectionMessage(
                message,
                SR.Format(
                    hasCollectionDataContract
                        ? SR.InvalidCollectionDataContract
        ...
        private static string GetInvalidCollectionMessage(
            string message,
            ...
            if (addMethodOnInterface)
            {
                ...
                )
                {
                    ...
                    if (addMethod == null)
                    {
                        ...
                        Array.Sort(
                            parentInterfaceTypes,
                            (x, y) => string.Compare(x.FullName, y.FullName)
                        );
        ...
        )
        {
            ...
            for (int i = 0; i < paramTypes.Length; i++)
            {
                if (paramTypes[i].IsGenericParameter)
                    paramTypes[i] = paramContracts[
                        paramTypes[i].GenericParameterPosition
                    ].UnderlyingType;
            }
            ...
            boundCollectionContract.ItemContract = ItemContract.BindGenericParameters(
                paramContracts,
                boundContracts
            );
            ...
            boundCollectionContract.ItemName = ItemNameSetExplicit
                ? ItemName
                : boundCollectionContract.ItemContract.XmlName.Name;
            ...
            boundCollectionContract.XmlName = CreateQualifiedName(
                ...
                IsCollectionDataContract(UnderlyingType)
                    ? XmlName.Namespace
                    : DataContract.GetCollectionNamespace(
                        boundCollectionContract.ItemContract.XmlName.Namespace
                    )
            );
            ...
            if (base.Equals(other, checkedContracts))
            {
                if (other is CollectionDataContract dataContract)
                {
                    bool thisItemTypeIsNullable =
                        (ItemContract == null) ? false : !ItemContract.IsValueType;
                    bool otherItemTypeIsNullable =
                        (dataContract.ItemContract == null)
                            ? false
                            : !dataContract.ItemContract.IsValueType;
                    return ItemName == dataContract.ItemName
                        && (IsItemTypeNullable || thisItemTypeIsNullable)
                            == (dataContract.IsItemTypeNullable || otherItemTypeIsNullable)
                        && ItemContract != null
        ...
        internal sealed class DictionaryEnumerator : IEnumerator<KeyValue<object, object?>>
        {
            ...
            public KeyValue<object, object?> Current =>
                new KeyValue<object, object?>(_enumerator.Key, _enumerator.Value);
