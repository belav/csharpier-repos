    ...
    internal sealed class ReflectionJsonFormatWriter
    {
        ...
        )
        {
            ...
            XmlDictionaryString itemName =
                XmlObjectSerializerWriteContextComplexJson.CollectionItemName;
            ...
            if (collectionContract.Kind == CollectionKind.Array)
            {
                ...
                if (!ReflectionTryWritePrimitiveArray(jsonWriter, obj, itemType, itemName))
                {
                    ...
                    for (int i = 0; i < array.Length; ++i)
                    {
                        ...
                        ReflectionJsonClassWriter.ReflectionWriteValue(
                            jsonWriter,
                            context,
                            itemType,
                            array.GetValue(i),
            ...
            else
            {
                ...
                if (canWriteSimpleDictionary && useSimpleDictionaryFormat)
                {
                    ...
                    while (enumerator.MoveNext())
                    {
                        ...
                        ReflectionJsonClassWriter.ReflectionWriteStartElement(
                            jsonWriter,
                            key.ToString()!
                        );
                        ReflectionJsonClassWriter.ReflectionWriteValue(
