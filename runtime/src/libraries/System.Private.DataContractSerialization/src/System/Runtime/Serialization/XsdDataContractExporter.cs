...
namespace System.Runtime.Serialization
{
    public class XsdDataContractExporter
    {
        ...
        {
            get { throw new PlatformNotSupportedException(SR.PlatformNotSupported_SchemaImporter); }
        }
        ...
        private DataContractSet DataContractSet
        {
            get
            {
                ...
                throw new PlatformNotSupportedException(
                    SR.PlatformNotSupported_IDataContractSurrogate
                );
            }
        }
        ...
        public void Export(ICollection<Assembly> assemblies)
        {
            if (assemblies == null)
                throw System
                    ...
                    .DiagnosticUtility
                    .ExceptionUtility
                    .ThrowHelperError(new ArgumentNullException(nameof(assemblies)));
                        ...
                        throw System
                            ...
                            .ThrowHelperError(
                                new ArgumentException(
                                    SR.Format(SR.CannotExportNullAssembly, nameof(assemblies))
                                )
                            );
        ...
        public void Export(ICollection<Type> types)
        {
            if (types == null)
                throw System
                    ...
                    .DiagnosticUtility
                    .ExceptionUtility
                    .ThrowHelperError(new ArgumentNullException(nameof(types)));
                ...
                foreach (Type type in types)
                {
                    if (type == null)
                        throw System
                            ...
                            .ThrowHelperError(
                                new ArgumentException(
                                    SR.Format(SR.CannotExportNullType, nameof(types))
                                )
                            );
                    AddType(type);
                }
                    ...
                    for (int i = 0; i < knownTypes.Count; i++)
                    {
                        ...
                        if (type == null)
                            throw System
                                ...
                                .ExceptionUtility
                                .ThrowHelperError(
                                    new ArgumentException(SR.CannotExportNullKnownType)
                                );
                        AddType(type);
                    }
                }
