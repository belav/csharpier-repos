...
namespace System.Runtime.Serialization
{
    internal sealed class SchemaImporter
    {
        ...
        internal SchemaImporter(
            ...
            IEnumerable<XmlQualifiedName>? typeNames,
        ...
        internal void Import(
            [NotNullIfNotNull("_elements")] out List<XmlQualifiedName>? elementTypeNames
        )
        {
...
#pragma warning suppress 56500 // covered by FxCOP
                ...
                if (_elements != null)
                {
                    ...
                    foreach (XmlSchemaElement element in _elements)
                    {
                        ...
                        else
                        {
                            ...
                            {
                                elementNameList.Add(
                                    ImportAnonymousElement(element, element.QualifiedName).XmlName
                                );
                            }
                            else
                            {
        ...
        {
            get { return _schemaObjects ??= CreateSchemaObjects(); }
        }

        private List<XmlSchemaRedefine> RedefineList
        {
            get { return _redefineList ??= CreateRedefineList(); }
        }
        ...
        )
        {
                ...
                foreach (XmlSchemaRedefine redefine in RedefineList)
                {
                    if (redefine.SchemaTypes[typeName] != null)
                        ThrowTypeCannotBeImportedException(
                            typeName.Name,
                            typeName.Namespace,
                            SR.Format(SR.RedefineNotSupported)
                        );
                }
                ...
                if (type is XmlSchemaSimpleType simpleType)
                {
                    ...
                    if (content is XmlSchemaSimpleTypeUnion)
                        ThrowTypeCannotBeImportedException(
                            typeName.Name,
                            typeName.Namespace,
                            SR.Format(SR.SimpleTypeUnionNotSupported)
                        );
                    ...
                    else
                    {
                        ...
                        if (contentModel is XmlSchemaSimpleContent)
                            ThrowTypeCannotBeImportedException(
                                typeName.Name,
                                typeName.Namespace,
                                SR.Format(SR.SimpleContentNotSupported)
                            );
                        else if (contentModel is XmlSchemaComplexContent complexContent)
                        {
                            if (complexContent.IsMixed)
                                ThrowTypeCannotBeImportedException(
                                    typeName.Name,
                                    typeName.Namespace,
                                    SR.Format(SR.MixedContentNotSupported)
                                );
                            ...
                            )
                            {
                                ...
                                if (baseTypeName == SchemaExporter.AnytypeQualifiedName)
                                    ...
                                    ThrowTypeCannotBeImportedException(
                                        typeName.Name,
                                        typeName.Namespace,
                                        SR.Format(SR.ComplexTypeRestrictionNotSupported)
                                    );
                            }
                        }
                    }
            ...
            Type? referencedType;
            if (
                _dataContractSet.TryGetReferencedType(typeName, dataContract, out referencedType)
                || (
                    string.IsNullOrEmpty(type.Name)
                    && _dataContractSet.TryGetReferencedType(
        ...
        {
            ClassDataContract? oldContract =
                _dataContractSet.GetDataContract(typeName) as ClassDataContract;
            _dataContractSet.Remove(typeName);
            if (oldContract != null)
            {
        ...
        private static bool CheckIfISerializable(
        ...
        )
        {
            ...
            {
                if (
                    items[i] is XmlSchemaElement element
                ...
                )
                {
                    if (s_serializationSchemaElements == null)
                    {
                        XmlSchema serializationSchema = XmlSchema.Read(
                            ...
                            null
                        )!; // Source is our constant. Schema is valid.
                        ...
                        foreach (XmlSchemaObject schemaObject in serializationSchema.Items)
                        {
                            if (schemaObject is XmlSchemaElement schemaElement)
                                if (schemaElement.Name != null)
                                    s_serializationSchemaElements.Add(
                                        schemaElement.Name,
                                        schemaElement
                                    );
                        }
            ...
            else if (rootParticle is XmlSchemaSequence rootSequence)
            {
                if (rootSequence.MinOccurs != 1)
                    ThrowTypeCannotBeImportedException(
                        typeName.Name,
                        typeName.Namespace,
                        SR.Format(SR.RootSequenceMustBeRequired)
                    );
                if (rootSequence.MaxOccurs != 1)
                    ThrowTypeCannotBeImportedException(
                        typeName.Name,
                        typeName.Namespace,
                        SR.Format(SR.RootSequenceMaxOccursMustBe)
                    );
                ...
                ThrowTypeCannotBeImportedException(
                    typeName.Name,
                    typeName.Namespace,
                    SR.Format(SR.RootParticleMustBeSequence)
                );
            return dataContract;
        }
        ...
        [RequiresDynamicCode(DataContract.SerializerAOTWarning)]
        [RequiresUnreferencedCode(DataContract.SerializerTrimmerWarning)]
        private ClassDataContract ImportClass(
            XmlQualifiedName typeName,
            XmlSchemaSequence rootSequence,
            XmlQualifiedName? baseTypeName,
            XmlSchemaAnnotation? annotation,
                ...
                for (int memberIndex = 0; memberIndex < rootSequence.Items.Count; memberIndex++)
                {
                    ...
                    if (element == null)
                        ThrowTypeCannotBeImportedException(
                            typeName.Name,
                            typeName.Namespace,
                            SR.Format(SR.MustContainOnlyLocalElements)
                        );
        ...
        [RequiresDynamicCode(DataContract.SerializerAOTWarning)]
        [RequiresUnreferencedCode(DataContract.SerializerTrimmerWarning)]
        private DataContract ImportXmlDataType(
            XmlQualifiedName typeName,
        ...
        private XmlDataContract? ImportSpecialXmlDataType(XmlSchemaType xsdType, bool isAnonymous)
        {
            ...
            if (IsXmlAnyElementType(complexType))
            {
                ...
                Type? referencedType;
                if (
                    _dataContractSet.TryGetReferencedType(xlinqTypeName, null, out referencedType)
        ...
        [RequiresDynamicCode(DataContract.SerializerAOTWarning)]
        [RequiresUnreferencedCode(DataContract.SerializerTrimmerWarning)]
        private ClassDataContract ImportISerializable(
            XmlQualifiedName typeName,
            XmlSchemaSequence rootSequence,
            XmlQualifiedName? baseTypeName,
            XmlSchemaObjectCollection attributes,
            ...
            else
            {
                ...
                if (!IsISerializableDerived(typeName, rootSequence))
                    ThrowISerializableTypeCannotBeImportedException(
                        typeName.Name,
                        typeName.Namespace,
                        SR.Format(SR.ISerializableDerivedContainsOneOrMoreItems)
                    );
            }
        ...
        private static void CheckISerializableBase(
            XmlQualifiedName typeName,
            XmlSchemaSequence? rootSequence,
            XmlSchemaObjectCollection attributes
        )
        {
            if (rootSequence == null)
                ThrowISerializableTypeCannotBeImportedException(
                    typeName.Name,
                    typeName.Namespace,
                    SR.Format(SR.ISerializableDoesNotContainAny)
                );
            ...
            if (rootSequence.Items == null || rootSequence.Items.Count < 1)
                ...
                ThrowISerializableTypeCannotBeImportedException(
                    typeName.Name,
                    typeName.Namespace,
                    SR.Format(SR.ISerializableContainsMoreThanOneItems)
                );
        ...
        private static bool IsISerializableDerived(
            XmlQualifiedName typeName,
            XmlSchemaSequence? rootSequence
        )
        {
        ...
        [RequiresDynamicCode(DataContract.SerializerAOTWarning)]
        [RequiresUnreferencedCode(DataContract.SerializerTrimmerWarning)]
        private void ImportBaseContract(
            XmlQualifiedName baseTypeName,
        ...
        )
        {
            ...
            while (ancestorDataContract != null)
            {
                DataContractDictionary knownDataContracts =
                    ancestorDataContract.KnownDataContracts!; // Might be .Count == 0, but always non-null for ClassDataContract
                knownDataContracts.Add(dataContract.XmlName, dataContract);
                ancestorDataContract = ancestorDataContract.BaseClassContract;
            }
        ...
        private void ImportClassMember(XmlSchemaElement element, ClassDataContract dataContract)
        {
            ...
            if (element.MinOccurs > 1)
                ThrowTypeCannotBeImportedException(
                    typeName.Name,
                    typeName.Namespace,
                    SR.Format(SR.ElementMinOccursMustBe, element.Name)
                );
            if (element.MaxOccurs != 1)
                ThrowTypeCannotBeImportedException(
                    typeName.Name,
                    typeName.Namespace,
                    SR.Format(SR.ElementMaxOccursMustBe, element.Name)
                );
            ...
            {
                XmlSchema? schema = SchemaHelper.GetSchemaWithType(
                    SchemaObjects,
                    _schemaSet,
                    typeName
                );
            ...
            if (elementForm != XmlSchemaForm.Qualified)
                ThrowTypeCannotBeImportedException(
                    typeName.Name,
                    typeName.Namespace,
                    SR.Format(SR.FormMustBeQualified, element.Name)
                );
            ...
            if (prevMemberIndex >= 0)
            {
                ...
                if (compare == 0)
                    ThrowTypeCannotBeImportedException(
                        typeName.Name,
                        typeName.Namespace,
                        SR.Format(SR.CannotHaveDuplicateElementNames, memberName)
                    );
                else if (compare > 0)
                    memberOrder = dataContract.Members.Count;
            }
            ...
            _dataContractSet.SetSurrogateData(
                dataMember,
                ImportSurrogateData(
        ...
        [RequiresDynamicCode(DataContract.SerializerAOTWarning)]
        [RequiresUnreferencedCode(DataContract.SerializerTrimmerWarning)]
        private CollectionDataContract ImportCollection(
            XmlQualifiedName typeName,
            XmlSchemaSequence rootSequence,
            XmlSchemaObjectCollection attributes,
            XmlSchemaAnnotation? annotation,
        ...
        )
        {
            ...
            if (elementForm != XmlSchemaForm.Qualified)
                ThrowArrayTypeCannotBeImportedException(
                    typeName.Name,
                    typeName.Namespace,
                    SR.Format(SR.ArrayItemFormMustBe, element.Name)
                );
            CheckIfElementUsesUnsupportedConstructs(typeName, element);
            ...
            if (IsDictionary(typeName, annotation))
            {
                ...
                DataMember key = null!,
                    value = null!; // Set in the following || conditional chain. If the chain triggers before setting these, an exception is thrown.
                if (
                ...
                )
                {
                    ThrowArrayTypeCannotBeImportedException(
                        typeName.Name,
                        typeName.Namespace,
                        SR.Format(SR.InvalidKeyValueType, element.Name)
                    );
                }
                ...
                if (element.SchemaType != null)
                {
                    ...
                    GenericInfo genericInfo = new GenericInfo(
                        DataContract.GetXmlName(Globals.TypeOfKeyValue),
                    ...
                    dataContract.ItemContract.XmlName = new XmlQualifiedName(
                        genericInfo.GetExpandedXmlName().Name,
                        typeName.Namespace
                    );
                }
            }
        ...
        [RequiresDynamicCode(DataContract.SerializerAOTWarning)]
        [RequiresUnreferencedCode(DataContract.SerializerTrimmerWarning)]
        private EnumDataContract? ImportFlagsEnum(
            XmlQualifiedName typeName,
        ...
        )
        {
            ...
            if (anonymousType == null)
                ThrowEnumTypeCannotBeImportedException(
                    typeName.Name,
                    typeName.Namespace,
                    SR.Format(SR.EnumListMustContainAnonymousType)
                );
            ...
            if (content is XmlSchemaSimpleTypeUnion)
                ThrowEnumTypeCannotBeImportedException(
                    typeName.Name,
                    typeName.Namespace,
                    SR.Format(SR.EnumUnionInAnonymousTypeNotSupported)
                );
            else if (content is XmlSchemaSimpleTypeList)
                ThrowEnumTypeCannotBeImportedException(
                    typeName.Name,
                    typeName.Namespace,
                    SR.Format(SR.EnumListInAnonymousTypeNotSupported)
                );
            else if (content is XmlSchemaSimpleTypeRestriction)
            {
                if (
                    content is XmlSchemaSimpleTypeRestriction restriction
                    && CheckIfEnum(restriction)
                )
                    return ImportEnum(
                        typeName,
                        restriction,
                    ...
                    ThrowEnumTypeCannotBeImportedException(
                        typeName.Name,
                        typeName.Namespace,
                        SR.Format(SR.EnumRestrictionInvalid)
                    );
            }
            return null;
        }
        ...
        [RequiresDynamicCode(DataContract.SerializerAOTWarning)]
        [RequiresUnreferencedCode(DataContract.SerializerTrimmerWarning)]
        private EnumDataContract ImportEnum(
            XmlQualifiedName typeName,
            ...
            foreach (XmlSchemaFacet facet in restriction.Facets)
            {
                ...
                if (enumFacet == null)
                    ThrowEnumTypeCannotBeImportedException(
                        typeName.Name,
                        typeName.Namespace,
                        SR.Format(SR.EnumOnlyEnumerationFacetsSupported)
                    );
                if (enumFacet.Value == null)
                    ThrowEnumTypeCannotBeImportedException(
                        typeName.Name,
                        typeName.Namespace,
                        SR.Format(SR.EnumEnumerationFacetsMustHaveValue)
                    );
        ...
        [RequiresDynamicCode(DataContract.SerializerAOTWarning)]
        [RequiresUnreferencedCode(DataContract.SerializerTrimmerWarning)]
        private DataContract ImportSimpleTypeRestriction(
            XmlQualifiedName typeName,
            XmlSchemaSimpleTypeRestriction restriction
        )
        {
            ...
            if (!restriction.BaseTypeName.IsEmpty)
                ...
                ThrowTypeCannotBeImportedException(
                    typeName.Name,
                    typeName.Namespace,
                    SR.Format(SR.SimpleTypeRestrictionDoesNotSpecifyBase)
                );
        ...
        {
            if (
                _dataContractSet.SerializationExtendedSurrogateProvider != null
                && typeElement != null
            )
            {
        ...
        private static void CheckComplexType(XmlQualifiedName typeName, XmlSchemaComplexType type)
        {
            if (type.IsAbstract)
                ThrowTypeCannotBeImportedException(
                    typeName.Name,
                    typeName.Namespace,
                    SR.Format(SR.AbstractTypeNotSupported)
                );
            if (type.IsMixed)
                ThrowTypeCannotBeImportedException(
                    typeName.Name,
        ...
        private static void CheckIfElementUsesUnsupportedConstructs(
            XmlQualifiedName typeName,
            XmlSchemaElement element
        )
        {
            if (element.IsAbstract)
                ThrowTypeCannotBeImportedException(
                    typeName.Name,
                    typeName.Namespace,
                    SR.Format(SR.AbstractElementNotSupported, element.Name)
                );
            if (element.DefaultValue != null)
                ThrowTypeCannotBeImportedException(
                    typeName.Name,
                    typeName.Namespace,
                    SR.Format(SR.DefaultOnElementNotSupported, element.Name)
                );
            if (element.FixedValue != null)
                ThrowTypeCannotBeImportedException(
                    typeName.Name,
                    typeName.Namespace,
                    SR.Format(SR.FixedOnElementNotSupported, element.Name)
                );
            if (!element.SubstitutionGroup.IsEmpty)
                ThrowTypeCannotBeImportedException(
                    typeName.Name,
                    typeName.Namespace,
                    SR.Format(SR.SubstitutionGroupOnElementNotSupported, element.Name)
                );
        }

        private static void ImportAttributes(
            XmlQualifiedName typeName,
            XmlSchemaObjectCollection attributes,
            XmlSchemaAnyAttribute? anyAttribute,
        ...
        )
        {
            if (anyAttribute != null)
                ThrowTypeCannotBeImportedException(
                    typeName.Name,
                    typeName.Namespace,
                    SR.Format(SR.AnyAttributeNotSupported)
                );
        ...
        private static bool TryCheckIfAttribute(
            XmlQualifiedName typeName,
        ...
        )
        {
            ...
            if (foundAttribute)
                ThrowTypeCannotBeImportedException(
                    typeName.Name,
                    typeName.Namespace,
                    SR.Format(SR.CannotHaveDuplicateAttributeNames, refName.Name)
                );
            foundAttribute = true;
            return true;
        }
        ...
        )
        {
            ...
            )
            {
                ...
                if (markup != null)
                {
                    ...
                    {
                        if (
                            markup[i] is XmlElement annotationElement
        ...
        [DoesNotReturn]
        private static void ThrowTypeCannotBeImportedException(
            string name,
            string ns,
            string message
        )
        {
            ThrowTypeCannotBeImportedException(
                SR.Format(SR.TypeCannotBeImported, name, ns, message)
            );
        }

        [DoesNotReturn]
        private static void ThrowArrayTypeCannotBeImportedException(
            string name,
            string ns,
            string message
        )
        {
            ThrowTypeCannotBeImportedException(
                SR.Format(SR.ArrayTypeCannotBeImported, name, ns, message)
            );
        }

        [DoesNotReturn]
        private static void ThrowEnumTypeCannotBeImportedException(
            string name,
            string ns,
            string message
        )
        {
            ThrowTypeCannotBeImportedException(
                SR.Format(SR.EnumTypeCannotBeImported, name, ns, message)
            );
        }
        ...
        {
            ThrowTypeCannotBeImportedException(
                SR.Format(SR.ISerializableTypeCannotBeImported, name, ns, message)
            );
        }
