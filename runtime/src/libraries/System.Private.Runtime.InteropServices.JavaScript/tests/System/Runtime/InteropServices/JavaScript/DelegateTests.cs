    ...
    public static class DelegateTests
    {
        ...
        public static IEnumerable<object[]> ArrayType_TestData()
        {
            ...
            yield return new object[]
            {
                _objectPrototype.Call(),
                "Uint8ClampedArray",
                Uint8ClampedArray.From(new byte[10])
            };
            yield return new object[]
            {
                _objectPrototype.Call(),
                "Int8Array",
                Int8Array.From(new sbyte[10])
            };
            yield return new object[]
            {
                _objectPrototype.Call(),
                "Uint16Array",
                Uint16Array.From(new ushort[10])
            };
            yield return new object[]
            {
                _objectPrototype.Call(),
                "Int16Array",
                Int16Array.From(new short[10])
            };
            yield return new object[]
            {
                _objectPrototype.Call(),
                "Uint32Array",
                Uint32Array.From(new uint[10])
            };
            yield return new object[]
            {
                _objectPrototype.Call(),
                "Int32Array",
                Int32Array.From(new int[10])
            };
            yield return new object[]
            {
                _objectPrototype.Call(),
                "Float32Array",
                Float32Array.From(new float[10])
            };
            yield return new object[]
            {
                _objectPrototype.Call(),
                "Float64Array",
                Float64Array.From(new double[10])
            };
        ...
        public static void InvokeFunctionAcceptingArrayTypes(
            ...
            Assert.Equal(
                HelperMarshal._funcActionBufferObjectResultValue.Length,
