...
namespace System.Security.Cryptography.Pkcs.Tests
{
    public static class TimestampRequestTests
    {
        ...
        {
            Oid hashAlgorithmId = new Oid(
                "2.16.840.1.101.3.4.2.1",
                "Nothing should read this friendly name"
            );
        ...
        public static void BuildFromSignerInfo()
        {
            ...
            Rfc3161TimestampRequest fromSigner = Rfc3161TimestampRequest.CreateFromSignerInfo(
                signerInfo,
                HashAlgorithmName.SHA256
            );
            Rfc3161TimestampRequest fromData = Rfc3161TimestampRequest.CreateFromData(
                sig,
                HashAlgorithmName.SHA256
            );
        ...
        public static void TryDecode_WithExtensions(bool withExcessData)
        {
            ...
            var dataRange = new ReadOnlyMemory<byte>(
                inputBytes,
                0,
                inputBytes.Length - PaddingHex.Length / 2
            );
            ...
            Assert.True(
                Rfc3161TimestampRequest.TryDecode(toUse, out request, out bytesRead),
                "TryDecode"
            );
        ...
        )
        {
            ...
            string inputHex =
                ...
                + "6A47E3E28EB64E734356A6374E4CB05EC3"
                + Padding;
            ...
            Rfc3161TimestampRequest request = Rfc3161TimestampRequest.CreateFromHash(
                ...
                hashAlgorithmName,
                nonce: nonce,
                requestSignerCertificates: expectedStatus
                    != Rfc3161RequestResponseStatus.UnexpectedCertificates
            );
        ...
        )
        {
            ...
            string inputHex =
                ...
                + "C51BA0D8DA57FB5692039F4B102608AECA217204BBD4"
                + Padding;
            ...
            Rfc3161TimestampRequest request = Rfc3161TimestampRequest.CreateFromHash(
                ...
                nonce: nonce,
                requestSignerCertificates: expectedStatus
                    == Rfc3161RequestResponseStatus.RequestedCertificatesMissing
            );
        ...
        )
        {
            ...
            bool result = request.TryProcessResponse(
                inputBytes,
                out token,
                out status,
                out bytesRead
            ...
            if (result)
            {
                Rfc3161TimestampToken token2 = request.ProcessResponse(
                    inputBytes,
                    out int bytesRead2
                );
