...
namespace System.Security.Cryptography.Pkcs.EnvelopedCmsTests.Tests
{
    public static partial class UnprotectedAttributeTests
    {
        ...
        {
            byte[] encodedMessage = CreateEcmsWithAttributes(
                new Pkcs9DocumentDescription("My Description")
            );
        ...
        {
            byte[] encodedMessage = CreateEcmsWithAttributes(
                new Pkcs9SigningTime(new DateTime(2018, 4, 1, 8, 30, 05))
            );
        ...
        public static void TestUnprotectedAttributes1_ContentType_RoundTrip()
        {
            ...
            Pkcs9AttributeObject pkcs9ContentType = new Pkcs9AttributeObject(
                Oids.ContentType,
                rawData
            );
        ...
        public static void TestUnprotectedAttributes1_MessageDigest_RoundTrip()
        {
            ...
            Pkcs9AttributeObject pkcs9MessageDigest = new Pkcs9AttributeObject(
                Oids.MessageDigest,
                rawData
            );
        ...
        public static void TestUnprotectedAttributes1_EmptySet()
        {
            ...
            CryptographicAttributeObject documentDescObj =
                (attrObj0Oid == Oids.DocumentDescription) ? collection[0] : collection[1];

            CryptographicAttributeObject documentNameObj =
                (attrObj0Oid == Oids.DocumentName) ? collection[0] : collection[1];
