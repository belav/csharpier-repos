...
namespace System.Security.Cryptography.Pkcs.EnvelopedCmsTests.Tests
{
    ...
    {
        public DecryptTestsUsingCertWithPrivateKey()
            : base(false) { }
        ...
        public static void DecryptMultipleRecipients()
        {
            ...
            EnvelopedCms ecms = new EnvelopedCms(
                ...
                new AlgorithmIdentifier(new Oid(Oids.Aes256))
            );
        ...
        public static void DecryptUsingCertificateWithSameSubjectKeyIdentifierButDifferentKeyPair()
        {
            ...
            )
            {
                ...
                Assert.Equal(
                    GetSubjectKeyIdentifier(recipientCert),
                    GetSubjectKeyIdentifier(otherRecipientWithSameSki)
                );
