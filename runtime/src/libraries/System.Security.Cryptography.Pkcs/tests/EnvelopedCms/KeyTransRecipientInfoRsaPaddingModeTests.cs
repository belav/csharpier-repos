...
namespace System.Security.Cryptography.Pkcs.EnvelopedCmsTests.Tests
{
    public static partial class KeyTransRecipientInfoRsaPaddingModeTests
    {
        ...
        public static void TestKeyTransEncryptedKey_RsaAlgorithms(
        ...
        private static readonly byte[] s_rsaOaepSha384Parameters =
        {
            0x30,
            0x2f,
            0xa0,
        ...
        private static readonly byte[] s_rsaOaepSha512Parameters =
        {
            0x30,
            0x2f,
            0xa0,
