...
namespace System.Security.Cryptography.Pkcs.Asn1
{
    ...
    internal partial struct RecipientEncryptedKeyAsn
    {
        ...
        internal static RecipientEncryptedKeyAsn Decode(
        ...
        internal static void Decode(
            ...
            out RecipientEncryptedKeyAsn decoded
        )
        {
        ...
        )
        {
            ...
            System.Security.Cryptography.Pkcs.Asn1.KeyAgreeRecipientIdentifierAsn
                .Decode(ref sequenceReader, rebind, out decoded.Rid);

            if (sequenceReader.TryReadPrimitiveOctetString(out tmpSpan))
            {
                decoded.EncryptedKey = rebindSpan.Overlaps(tmpSpan, out offset)
