...
namespace System.Security.Cryptography.Pkcs.Asn1
{
    ...
    internal partial struct RecipientInfoAsn
    {
        ...
        internal static RecipientInfoAsn Decode(
        ...
        )
        {
            ...
            if (tag.HasSameClassAndValue(Asn1Tag.Sequence))
            {
                ...
                System.Security.Cryptography.Pkcs.Asn1.KeyTransRecipientInfoAsn
            ...
            else if (tag.HasSameClassAndValue(new Asn1Tag(TagClass.ContextSpecific, 1)))
            {
                ...
                System.Security.Cryptography.Pkcs.Asn1.KeyAgreeRecipientInfoAsn
                    .Decode(
                        ref reader,
