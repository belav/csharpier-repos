...
namespace System.Security.Cryptography.Pkcs.Asn1
{
    ...
    internal partial struct OriginatorIdentifierOrKeyAsn
    {
        ...
        internal static OriginatorIdentifierOrKeyAsn Decode(
        ...
        internal static void Decode(
            ...
            out OriginatorIdentifierOrKeyAsn decoded
        )
        {
            try
            {
        ...
        )
        {
            ...
            else if (tag.HasSameClassAndValue(new Asn1Tag(TagClass.ContextSpecific, 1)))
            {
                ...
                System.Security.Cryptography.Pkcs.Asn1.OriginatorPublicKeyAsn
                    .Decode(
                        ref reader,
