...
namespace System.Security.Cryptography.Pkcs.Asn1
{
    ...
    internal partial struct KeyAgreeRecipientInfoAsn
    {
        ...
        )
        {
            ...
            System.Security.Cryptography.Pkcs.Asn1.OriginatorIdentifierOrKeyAsn
            ...
            // Decode SEQUENCE OF for RecipientEncryptedKeys
            {
                ...
                var tmpList =
                    new List<System.Security.Cryptography.Pkcs.Asn1.RecipientEncryptedKeyAsn>();
                System.Security.Cryptography.Pkcs.Asn1.RecipientEncryptedKeyAsn tmpItem;

                while (collectionReader.HasData)
                {
                    System.Security.Cryptography.Pkcs.Asn1.RecipientEncryptedKeyAsn
