    ...
    internal sealed partial class DecryptorPalWindows : DecryptorPal
    {
        ...
        )
        {
            ...
            if (privateKey != null)
            {
                ...
                byte[]? cek = AnyOS.ManagedPkcsPal.ManagedKeyTransPal
                    .DecryptCekCore(
                        cert,
                        key,
                ...
                fixed (byte* pinnedCek = cek)
                {
                    try
                    {
                        ...
                        return AnyOS.ManagedPkcsPal.ManagedDecryptorPal
                            .TryDecryptCore(
                                cek!,
        ...
        private Exception? TryDecryptTrans(
            KeyTransRecipientInfo recipientInfo,
                            ...
                            case CMsgKeyAgreeOriginatorChoice.CMSG_KEY_AGREE_ORIGINATOR_CERT:
                            {
                                ...
                                )
                                {
                                    ...
                                    decryptPara.OriginatorPublicKey =
                                        pOriginatorCertContext->pCertInfo->SubjectPublicKeyInfo.PublicKey;
