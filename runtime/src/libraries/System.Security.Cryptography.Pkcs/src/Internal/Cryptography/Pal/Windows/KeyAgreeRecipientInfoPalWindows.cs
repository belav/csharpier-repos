...
namespace Internal.Cryptography.Pal.Windows
{
    internal sealed class KeyAgreeRecipientInfoPalWindows : KeyAgreeRecipientInfoPal
    {
        ...
        // Provides access to the native CMSG_KEY_TRANS_RECIPIENT_INFO* structure. This helper is structured
        // as taking a delegate to
        // help avoid the easy trap of forgetting to prevent the underlying memory block from being GC'd
        // early.
        ...
        // This is the backing store for the CMSG_CMS_RECIPIENT_INFO* structure for this RecipientInfo.
        // CMSG_CMS_RECIPIENT_INFO is full of interior
