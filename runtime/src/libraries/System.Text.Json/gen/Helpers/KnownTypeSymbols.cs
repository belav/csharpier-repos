...
namespace System.Text.Json.SourceGeneration
{
    internal sealed class KnownTypeSymbols
    {
        ...
        public INamedTypeSymbol? IListOfTType =>
            GetOrResolveType(typeof(IList<>), ref _IListOfTType);
        private Option<INamedTypeSymbol?> _IListOfTType;

        public INamedTypeSymbol? ICollectionOfTType =>
            GetOrResolveType(typeof(ICollection<>), ref _ICollectionOfTType);
        private Option<INamedTypeSymbol?> _ICollectionOfTType;

        public INamedTypeSymbol? IEnumerableType =>
            GetOrResolveType(typeof(IEnumerable), ref _IEnumerableType);
        private Option<INamedTypeSymbol?> _IEnumerableType;

        public INamedTypeSymbol? IEnumerableOfTType =>
            GetOrResolveType(typeof(IEnumerable<>), ref _IEnumerableOfTType);
        ...
        public INamedTypeSymbol? StackOfTType =>
            GetOrResolveType(typeof(Stack<>), ref _StackOfTType);
        private Option<INamedTypeSymbol?> _StackOfTType;

        public INamedTypeSymbol? QueueOfTType =>
            GetOrResolveType(typeof(Queue<>), ref _QueueOfTType);
        ...
        public INamedTypeSymbol? IDictionaryType =>
            GetOrResolveType(typeof(IDictionary), ref _IDictionaryType);
        ...
        public INamedTypeSymbol? KeyValuePair =>
            GetOrResolveType(typeof(KeyValuePair<,>), ref _KeyValuePair);
        private Option<INamedTypeSymbol?> _KeyValuePair;

        public INamedTypeSymbol? ImmutableArrayType =>
            GetOrResolveType(typeof(ImmutableArray<>), ref _ImmutableArrayType);
        private Option<INamedTypeSymbol?> _ImmutableArrayType;

        public INamedTypeSymbol? ImmutableListType =>
            GetOrResolveType(typeof(ImmutableList<>), ref _ImmutableListType);
        private Option<INamedTypeSymbol?> _ImmutableListType;

        public INamedTypeSymbol? IImmutableListType =>
            GetOrResolveType(typeof(IImmutableList<>), ref _IImmutableListType);
        private Option<INamedTypeSymbol?> _IImmutableListType;

        public INamedTypeSymbol? ImmutableStackType =>
            GetOrResolveType(typeof(ImmutableStack<>), ref _ImmutableStackType);
        ...
        public INamedTypeSymbol? ImmutableQueueType =>
            GetOrResolveType(typeof(ImmutableQueue<>), ref _ImmutableQueueType);
        ...
        public INamedTypeSymbol? IImmutableSetType =>
            GetOrResolveType(typeof(IImmutableSet<>), ref _IImmutableSetType);
        ...
        public INamedTypeSymbol? DateTimeOffsetType =>
            GetOrResolveType(typeof(DateTimeOffset), ref _DateTimeOffsetType);
        private Option<INamedTypeSymbol?> _DateTimeOffsetType;

        public INamedTypeSymbol? TimeSpanType =>
            GetOrResolveType(typeof(TimeSpan), ref _TimeSpanType);
        private Option<INamedTypeSymbol?> _TimeSpanType;

        public INamedTypeSymbol? DateOnlyType =>
            GetOrResolveType("System.DateOnly", ref _DateOnlyType);
        private Option<INamedTypeSymbol?> _DateOnlyType;

        public INamedTypeSymbol? TimeOnlyType =>
            GetOrResolveType("System.TimeOnly", ref _TimeOnlyType);
        ...
        public INamedTypeSymbol? UInt128Type =>
            GetOrResolveType("System.UInt128", ref _UInt128Type);
        ...
        public IArrayTypeSymbol? ByteArrayType =>
            _ByteArrayType.HasValue
        ...
        public INamedTypeSymbol? MemoryByteType =>
            _MemoryByteType.HasValue
                ? _MemoryByteType.Value
                : (
                    _MemoryByteType = new(
                        MemoryType?.Construct(Compilation.GetSpecialType(SpecialType.System_Byte))
                    )
                ).Value;

        private Option<INamedTypeSymbol?> _MemoryByteType;

        public INamedTypeSymbol? ReadOnlyMemoryByteType =>
            _ReadOnlyMemoryByteType.HasValue
                ? _ReadOnlyMemoryByteType.Value
                : (
                    _ReadOnlyMemoryByteType = new(
                        ReadOnlyMemoryType?.Construct(
                            Compilation.GetSpecialType(SpecialType.System_Byte)
                        )
                    )
                ).Value;
        ...
        public INamedTypeSymbol? JsonSerializerContextType =>
            GetOrResolveType(
                ...
                ref _JsonSerializerContextType
            );
        ...
        public INamedTypeSymbol? JsonElementType =>
            GetOrResolveType("System.Text.Json.JsonElement", ref _JsonElementType);
        private Option<INamedTypeSymbol?> _JsonElementType;

        public INamedTypeSymbol? JsonNodeType =>
            GetOrResolveType("System.Text.Json.Nodes.JsonNode", ref _JsonNodeType);
        private Option<INamedTypeSymbol?> _JsonNodeType;

        public INamedTypeSymbol? JsonValueType =>
            GetOrResolveType("System.Text.Json.Nodes.JsonValue", ref _JsonValueType);
        ...
        public INamedTypeSymbol? JsonArrayType =>
            GetOrResolveType("System.Text.Json.Nodes.JsonArray", ref _JsonArrayType);
        ...
        public INamedTypeSymbol? JsonConverterAttributeType =>
            GetOrResolveType(
                ...
                ref _JsonConverterAttributeType
            );
        ...
        public INamedTypeSymbol? JsonDerivedTypeAttributeType =>
            GetOrResolveType(
                ...
                ref _JsonDerivedTypeAttributeType
            );
        private Option<INamedTypeSymbol?> _JsonDerivedTypeAttributeType;

        public INamedTypeSymbol? JsonNumberHandlingAttributeType =>
            GetOrResolveType(
                "System.Text.Json.Serialization.JsonNumberHandlingAttribute",
                ref _JsonNumberHandlingAttributeType
            );
        private Option<INamedTypeSymbol?> _JsonNumberHandlingAttributeType;

        public INamedTypeSymbol? JsonObjectCreationHandlingAttributeType =>
            GetOrResolveType(
        ...
        public INamedTypeSymbol? JsonSourceGenerationOptionsAttributeType =>
            GetOrResolveType(
        ...
        public INamedTypeSymbol? JsonUnmappedMemberHandlingAttributeType =>
            GetOrResolveType(
        ...
        public INamedTypeSymbol? JsonConstructorAttributeType =>
            GetOrResolveType(
                ...
                ref _JsonConstructorAttributeType
            );
        ...
        public INamedTypeSymbol? SetsRequiredMembersAttributeType =>
            GetOrResolveType(
                ...
                ref _SetsRequiredMembersAttributeType
            );
        ...
        public INamedTypeSymbol? JsonStringEnumConverterType =>
            GetOrResolveType(
                ...
                ref _JsonStringEnumConverterType
            );
        private Option<INamedTypeSymbol?> _JsonStringEnumConverterType;

        public INamedTypeSymbol? JsonStringEnumConverterOfTType =>
            GetOrResolveType(
                "System.Text.Json.Serialization.JsonStringEnumConverter`1",
                ref _JsonStringEnumConverterOfTType
            );
        private Option<INamedTypeSymbol?> _JsonStringEnumConverterOfTType;

        public INamedTypeSymbol? IJsonOnSerializingType =>
            GetOrResolveType(JsonConstants.IJsonOnSerializingFullName, ref _IJsonOnSerializingType);
        private Option<INamedTypeSymbol?> _IJsonOnSerializingType;

        public INamedTypeSymbol? IJsonOnSerializedType =>
            GetOrResolveType(JsonConstants.IJsonOnSerializedFullName, ref _IJsonOnSerializedType);
        ...
        public INamedTypeSymbol? MemberInfoType =>
            GetOrResolveType(typeof(MemberInfo), ref _MemberInfoType);
        ...
        public INamedTypeSymbol? ReadOnlyMemoryType =>
            GetOrResolveType(typeof(ReadOnlyMemory<>), ref _ReadOnlyMemoryType);
        ...
        public bool IsImmutableEnumerableType(ITypeSymbol type, out string? factoryTypeFullName)
        {
            if (
                ...
                {
                    IsGenericType: true,
                    ConstructedFrom: INamedTypeSymbol genericTypeDef
                }
            )
            {
            ...
            if (
                cmp.Equals(genericTypeDef, ImmutableListType)
            ...
            if (
                cmp.Equals(genericTypeDef, ImmutableStackType)
            ...
            if (
                cmp.Equals(genericTypeDef, ImmutableQueueType)
            ...
            if (
                cmp.Equals(genericTypeDef, ImmutableHashSetType)
        ...
        public bool IsImmutableDictionaryType(ITypeSymbol type, out string? factoryTypeFullName)
        {
            ...
            if (
                cmp.Equals(genericTypeDef, ImmutableDictionaryType)
        ...
        private INamedTypeSymbol? GetOrResolveType(
            Type type,
            ref Option<INamedTypeSymbol?> field
