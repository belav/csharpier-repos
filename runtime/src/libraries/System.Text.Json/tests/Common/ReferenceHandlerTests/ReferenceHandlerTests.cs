...
namespace System.Text.Json.Serialization.Tests
{
    public abstract partial class ReferenceHandlerTests : SerializerTests
    {
        ...
        public async Task ObjectLoop()
        {
            ...
            // Ensure round-trip
            Employee angelaCopy = await Serializer.DeserializeWrapper<Employee>(
                actual,
        ...
        public async Task KeyValuePairTest()
        {
            ...
            KeyValuePair<string, string> kvp2 = await Serializer.DeserializeWrapper<
        ...
        public async Task ObjectZeroLengthProperty()
        {
            ...
            ClassWithZeroLengthProperty<int> rootValue = await RoundTripZeroLengthProperty(
                new ClassWithZeroLengthProperty<int>(),
                10
            );
            Assert.Equal(10, rootValue.ZeroLengthProperty);

            ClassWithZeroLengthProperty<Employee> rootObject = await RoundTripZeroLengthProperty(
                new ClassWithZeroLengthProperty<Employee>(),
                new Employee { Name = "Test" }
            );
            Assert.Equal("Test", rootObject.ZeroLengthProperty.Name);

            ClassWithZeroLengthProperty<List<int>> rootArray = await RoundTripZeroLengthProperty(
            ...
            ClassWithZeroLengthProperty<int> rootValue2 = await RoundTripZeroLengthProperty(
                new ClassWithZeroLengthProperty<int>(),
                10,
            ...
            ClassWithZeroLengthProperty<Employee> rootObject2 = await RoundTripZeroLengthProperty(
                new ClassWithZeroLengthProperty<Employee>(),
                new Employee { Name = "Test" },
                s_deserializerOptionsPreserve
            );
            ...
            ClassWithZeroLengthProperty<List<int>> rootArray2 = await RoundTripZeroLengthProperty(
                new ClassWithZeroLengthProperty<List<int>>(),
                new List<int>(),
                s_deserializerOptionsPreserve
            );
        ...
        private async Task<ClassWithZeroLengthProperty<TValue>> RoundTripZeroLengthProperty<TValue>(
        ...
        )
        {
            ...
            return await Serializer.DeserializeWrapper<ClassWithZeroLengthProperty<TValue>>(
                json,
                opts
            );
        }
        ...
        public async Task UnicodePropertyNames()
        {
            ...
            // Round-trip
            ClassWithUnicodeProperty objCopy =
            ...
            // Round-trip
            objCopy = await Serializer.DeserializeWrapper<ClassWithUnicodeProperty>(
                json,
                optionsWithEncoder
            );
            Assert.Equal(1, objCopy.A\u0467);
        ...
        public async Task DictionaryLoop()
        {
            ...
            DictionaryWithGenericCycle rootCopy =
                await Serializer.DeserializeWrapper<DictionaryWithGenericCycle>(
                    actual,
                    s_serializerOptionsPreserve
                );
        ...
        public async Task DictionaryObjectLoop()
        {
            ...
            Dictionary<string, Employee> rootCopy = await Serializer.DeserializeWrapper<
        ...
        public async Task DictionaryArrayLoop()
        {
            ...
            DictionaryWithGenericCycleWithinList rootCopy =
                await Serializer.DeserializeWrapper<DictionaryWithGenericCycleWithinList>(
                    actual,
                    s_serializerOptionsPreserve
                );
        ...
        public async Task DictionaryZeroLengthKey()
        {
            ...
            Dictionary<string, int> rootValue = await RoundTripDictionaryZeroLengthKey(
                new Dictionary<string, int>(),
                10
            );
            Assert.Equal(10, rootValue[string.Empty]);

            Dictionary<string, Employee> rootObject = await RoundTripDictionaryZeroLengthKey(
                new Dictionary<string, Employee>(),
                new Employee { Name = "Test" }
            );
            Assert.Equal("Test", rootObject[string.Empty].Name);

            Dictionary<string, List<int>> rootArray = await RoundTripDictionaryZeroLengthKey(
            ...
            Dictionary<string, int> rootValue2 = await RoundTripDictionaryZeroLengthKey(
                new Dictionary<string, int>(),
                10,
                s_deserializerOptionsPreserve
            );
            ...
            Dictionary<string, Employee> rootObject2 = await RoundTripDictionaryZeroLengthKey(
                new Dictionary<string, Employee>(),
                new Employee { Name = "Test" },
                s_deserializerOptionsPreserve
            );
            ...
            Dictionary<string, List<int>> rootArray2 = await RoundTripDictionaryZeroLengthKey(
                new Dictionary<string, List<int>>(),
                new List<int>(),
                s_deserializerOptionsPreserve
            );
        ...
        private async Task<Dictionary<string, TValue>> RoundTripDictionaryZeroLengthKey<TValue>(
        ...
        public async Task UnicodeDictionaryKeys()
        {
            ...
            // Round-trip
            Dictionary<string, int> objCopy = await Serializer.DeserializeWrapper<
            ...
            // Round-trip
            objCopy = await Serializer.DeserializeWrapper<Dictionary<string, int>>(
                json,
                optionsWithEncoder
            );
            Assert.Equal(1, objCopy["A\u0467"]);
        ...
        public async Task ArrayLoop()
        {
            ...
            ListWithGenericCycle rootCopy =
                await Serializer.DeserializeWrapper<ListWithGenericCycle>(
                    actual,
                    s_serializerOptionsPreserve
                );
            ...
            rootCopy = await Serializer.DeserializeWrapper<ListWithGenericCycle>(
                actual,
                s_serializerOptionsPreserve
            );
            Assert.Same(rootCopy, rootCopy[0]);
        ...
        public async Task ArrayObjectLoop()
        {
            ...
            List<Employee> rootCopy = await Serializer.DeserializeWrapper<List<Employee>>(
                actual,
                s_serializerOptionsPreserve
            );
        ...
        public async Task ArrayDictionaryLoop()
        {
            ...
            ListWithGenericCycleWithinDictionary rootCopy =
                await Serializer.DeserializeWrapper<ListWithGenericCycleWithinDictionary>(
                    actual,
                    s_serializerOptionsPreserve
                );
  ...
  },
  {
    ""$ref"": ""ae3c399c-058d-431d-91b0-a36c266441b9""
            ...
            ImmutableArray<PersonReference> people = await Serializer.DeserializeWrapper<
            ...
            Assert.Equal(
                json,
                await Serializer.SerializeWrapper(people, options),
  ...
  },
  {
    ""$ref"": ""ae3c399c-058d-431d-91b0-a36c266441b9""
            ...
            ImmutableArray<PersonReference> firstListOfPeople = await Serializer.DeserializeWrapper<
                ImmutableArray<PersonReference>
            >(json, options);
  ...
  },
  {
    ""$ref"": ""ae3c399c-058d-431d-91b0-a36c266441b9""
            ...
            ImmutableArray<PersonReference> secondListOfPeople =
                await Serializer.DeserializeWrapper<ImmutableArray<PersonReference>>(json, options);
            ...
            Assert.Equal(
                json,
                await Serializer.SerializeWrapper(secondListOfPeople, options),
                ignoreLineEndingDifferences: true
            );
        }
        ...
        public async Task PreserveReferenceOfTypeOfObjectOnCollection()
        {
            ...
            ClassWithListOfObjectProperty rootCopy =
                await Serializer.DeserializeWrapper<ClassWithListOfObjectProperty>(
                    json,
                    s_serializerOptionsPreserve
                );
        ...
        public async Task DoNotPreserveReferenceWhenRefPropertyIsAbsent()
        {
            ...
            ClassWithObjectProperty root =
                await Serializer.DeserializeWrapper<ClassWithObjectProperty>(json);
