...
namespace System.Text.Json.Serialization.Tests
{
    ...
    public abstract partial class StreamingJsonSerializerWrapper : JsonSerializerWrapper
    {
        ...
        public abstract Task SerializeWrapper(
            Stream stream,
            object value,
            Type inputType,
            JsonSerializerOptions? options = null
        );
        public abstract Task SerializeWrapper<T>(
            Stream stream,
            T value,
            JsonSerializerOptions? options = null
        );
        ...
        public override async Task<string> SerializeWrapper(
            object value,
            Type inputType,
            JsonSerializerOptions options = null
        )
        ...
        public override async Task<string> SerializeWrapper<T>(
            T value,
            JsonSerializerOptions options = null
        )
        {
