...
public abstract partial class JsonCreationHandlingTests : SerializerTests
{
    ...
    public async Task CreationHandlingSetWithAttribute_CanPopulateReadOnlyProperty_SimpleClass()
    {
        ...
        var obj = await Serializer.DeserializeWrapper<ClassWithReadOnlyProperty_SimpleClass>(
            json,
            options
        );
        Assert.NotNull(obj);
    ...
    public async Task CreationHandlingSetWithAttribute_CanPopulateReadOnlyProperty_SimpleClass_PropertyOccurredMultipleTimes()
    {
        ...
        json =
            """{"Property":{"StringValue":"NewValue"}, "Property":{}, "Property":{"IntValue":45}}""";
        obj = await Serializer.DeserializeWrapper<ClassWithReadOnlyProperty_SimpleClass>(
            json,
            options
        );
        Assert.NotNull(obj);
    ...
    public async Task CreationHandlingSetWithAttribute_PopulateWritableProperty_SimpleClass_DeserializingNull()
    {
        JsonSerializerOptions options = Serializer.CreateOptions();
        string json = """{"Property":null}""";
        var obj = await Serializer.DeserializeWrapper<ClassWithWritableProperty_SimpleClass>(
            json,
            options
        );
        ...
        obj = await Serializer.DeserializeWrapper<ClassWithWritableProperty_SimpleClass>(
            json,
            options
        );
        Assert.NotNull(obj.Property);
        ...
        json =
            """{"Property":null,"Property":{"StringValue":"NewValue"},"Property":{"IntValue":45}}""";
        obj = await Serializer.DeserializeWrapper<ClassWithWritableProperty_SimpleClass>(
            json,
            options
        );
        ...
        JsonSerializerOptions options = Serializer.CreateOptions(modifier: ti =>
        {
            if (ti.Type == typeof(ClassWithReadOnlyProperty_SimpleClass))
            {
                Assert.Equal(
                    ...
                    ti.Properties[0].ObjectCreationHandling
                );
    ...
    internal class ClassWithReadOnlyProperty_SimpleClass
    {
        ...
        public SimpleClass Property { get; } =
            new() { StringValue = "InitialValue", IntValue = 43 };
    }

    internal class ClassWithWritableProperty_SimpleClass
    {
        [JsonObjectCreationHandling(JsonObjectCreationHandling.Populate)]
        public SimpleClass Property { get; set; } =
            new() { StringValue = "InitialValue", IntValue = 43 };
    }
    ...
    public async Task CreationHandlingSetWithAttribute_CanPopulateWritableProperty_SimpleStruct()
    {
        ...
        var obj = await Serializer.DeserializeWrapper<StructWithWritableProperty_SimpleStruct>(
            json,
            options
        );
        Assert.Equal("NewValue", obj.Property.StringValue);
    ...
    public async Task CreationHandlingSetWithAttribute_CanPopulateWritableProperty_SimpleStruct_PropertyOccurredMultipleTimes()
    {
        ...
        json =
            """{"Property":{"StringValue":"NewValue"}, "Property":{}, "Property":{"IntValue":45}}""";
        obj = await Serializer.DeserializeWrapper<StructWithWritableProperty_SimpleStruct>(
            json,
            options
        );
        Assert.Equal("NewValue", obj.Property.StringValue);
    ...
    {
        [JsonObjectCreationHandling(JsonObjectCreationHandling.Populate)]
        public SimpleStruct Property { get; } =
            new() { StringValue = "InitialValue", IntValue = 43 };
    ...
    {
        [JsonObjectCreationHandling(JsonObjectCreationHandling.Populate)]
        public SimpleStruct Property { get; set; } =
            new() { StringValue = "InitialValue", IntValue = 43 };
    ...
    public async Task CreationHandlingSetWithAttribute_PopulateWritableProperty_SimpleClassWithSmallParametrizedCtor_DeserializingNull()
    {
        ...
        string json = """{"Property":null}""";
        var obj =
            await Serializer.DeserializeWrapper<ClassWithWritableProperty_SimpleClassWithSmallParametrizedCtor>(
                json,
                options
            );
        Assert.Null(obj.Property);
    ...
    {
        [JsonObjectCreationHandling(JsonObjectCreationHandling.Populate)]
        public SimpleClassWithSmallParametrizedCtor Property { get; set; } =
            new("InitialValue", 43);
    }
    ...
    public async Task CreationHandlingSetWithAttribute_PopulateWritableProperty_SimpleClassWithLargeParametrizedCtor_DeserializingNull()
    {
        ...
        string json = """{"Property":null}""";
        var obj =
            await Serializer.DeserializeWrapper<ClassWithWritableProperty_SimpleClassWithLargeParametrizedCtor>(
                json,
                options
            );
        Assert.Null(obj.Property);
        ...
        json =
            """{"Property":null,"Property":{},"Property":{"A":"NewValue"},"Property":{"F":99}}""";
        obj =
            await Serializer.DeserializeWrapper<ClassWithWritableProperty_SimpleClassWithLargeParametrizedCtor>(
                json,
                options
    ...
    {
        [JsonObjectCreationHandling(JsonObjectCreationHandling.Populate)]
        public SimpleClassWithLargeParametrizedCtor Property { get; } =
            new("InitialValue1", 43, "InitialValue2", 44, "InitialValue3", 45, "InitialValue4");
    }

    internal class ClassWithWritableProperty_SimpleClassWithLargeParametrizedCtor
    {
        [JsonObjectCreationHandling(JsonObjectCreationHandling.Populate)]
        public SimpleClassWithLargeParametrizedCtor Property { get; set; } =
            new("InitialValue1", 43, "InitialValue2", 44, "InitialValue3", 45, "InitialValue4");
    }

    internal class SimpleClassWithLargeParametrizedCtor
    {
        public SimpleClassWithLargeParametrizedCtor(
            string? a,
            int b,
            string? c,
            int d,
    ...
    public async Task CreationHandlingSetWithAttribute_CanPopulateAndSerialize_ClassWithEnabledPolymorphismOnSerialization()
    {
        ...
        Assert.Equal(
            """{"Property":{"DerivedClassProp":"derived","BaseClassProp":"base"}}""",
            json
        );

        json =
            """{"Property":{"BaseClassProp":"BaseNewValue","DerivedClassProp":"DerivedNewValue"}}""";
        obj =
            await Serializer.DeserializeWrapper<ClassWithProperty_BaseClassWithPolymorphismOnSerializationOnly>(
                json,
                options
            );
        Assert.IsType<DerivedClass_DerivingFrom_BaseClassWithPolymorphismOnSerializationOnly>(
            obj.Property
        );
        ...
        Assert.Equal(
            "derived",
            (
                (DerivedClass_DerivingFrom_BaseClassWithPolymorphismOnSerializationOnly)obj.Property
            ).DerivedClassProp
        );
        ...
        json =
            """{"Property":null,"Property":{"BaseClassProp":"BaseNewValue","DerivedClassProp":"DerivedNewValue"}}""";
        obj =
            await Serializer.DeserializeWrapper<ClassWithProperty_BaseClassWithPolymorphismOnSerializationOnly>(
                json,
                options
    ...
    [JsonDerivedType(
        typeof(DerivedClass_DerivingFrom_BaseClassWithPolymorphismOnSerializationOnly)
    )]
    ...
    public class DerivedClass_DerivingFrom_BaseClassWithPolymorphismOnSerializationOnly
        : BaseClassWithPolymorphismOnSerializationOnly
    {
    ...
    public async Task CreationHandlingSetWithAttribute_CanPopulateOrSerialize_ClassWithReadOnlyFieldAndIgnoreReadOnlyProperties()
    {
        ...
        obj = await Serializer.DeserializeWrapper<ClassWithReadOnlyInitializedField<SimpleClass>>(
            json,
            options
        );
    ...
    public async Task CreationHandlingSetWithAttribute_CanPopulateOrSerialize_ClassWithWritablePropertyAndIgnoreReadOnlyProperties()
    {
        ...
        obj = await Serializer.DeserializeWrapper<ClassWithInitializedProperty<SimpleClass>>(
            json,
            options
        );
    ...
    public async Task CreationHandlingSetWithAttribute_CanPopulateOrSerialize_ClassWithReadOnlyPropertyAndIgnoreReadOnlyFields()
    {
        ...
        json = """{"Property":{"StringValue":"SomeNewValue"},"Property":{"IntValue":43}}""";
        obj = await Serializer.DeserializeWrapper<
            ClassWithReadOnlyInitializedProperty<SimpleClass>
        >(json, options);
        Assert.Equal("SomeNewValue", obj.Property.StringValue);
        Assert.Equal(43, obj.Property.IntValue);
    ...
    public async Task CreationHandlingSetWithAttribute_CanPopulateOrSerialize_ClassWithFieldAndIgnoreReadOnlyFields()
    {
        ...
        json = """{"Field":{"StringValue":"SomeNewValue"},"Field":{"IntValue":43}}""";
        obj = await Serializer.DeserializeWrapper<ClassWithInitializedField<SimpleClass>>(
            json,
            options
        );
        Assert.Equal("SomeNewValue", obj.Field.StringValue);
    ...
    public async Task CreationHandlingSetWithAttribute_CanPopulateOrSerialize_RequiredProperties()
    {
        ...
        json =
            """{"Property":null,"Property":{"RequiredValue":"NewValue","OptionalValue":"test"},"Property":{"RequiredValue":"NewValue2"}}""";
        obj = await Serializer.DeserializeWrapper<
            ClassWithInitializedProperty<ClassWithRequiredProperty>
        >(json, options);
        ...
        json =
            """{"Property":{"RequiredValue":"NewValue", "OptionalValue":"test"},"Property":{"RequiredValue":"NewValue2"}}""";
        obj = await Serializer.DeserializeWrapper<
            ClassWithInitializedProperty<ClassWithRequiredProperty>
        >(json, options);
        Assert.Equal("test", obj.Property.OptionalValue);
    ...
    public async Task CreationHandlingSetWithOptions_CanPopulateOrSerialize_RequiredPropertiesRecursive()
    {
        ...
        var obj = await Serializer.DeserializeWrapper<ClassWithRecursiveRequiredProperty>(
            json,
            options
        );
        Check(obj, 1);
        ...
        json =
            """{"Value":1,"Next":{"Value":2,"Next":null},"Next":{"Next":{"Value":3,"Next":null}}}""";
        obj = await Serializer.DeserializeWrapper<ClassWithRecursiveRequiredProperty>(
            json,
            options
        );
        Check(obj, 3);
    ...
    public async Task CreationHandlingSetWithAttribute_CanPopulateOrSerialize_Callbacks(Type type)
    {
        ...
        async Task DeserializeAndEnsureCallbacksCalled(
            string json,
            int expectedTimesCallbacksCalled
        )
        {
    ...
    [Theory]
    [InlineData(
        typeof(IInterfaceWithInterfacePropertyWithPopulateOnType),
        typeof(ClassImplementingInterfaceWithPopulateOnTypeWithInterfaceProperty),
        true
    )]
    [InlineData(
        typeof(ClassImplementingInterfaceWithPopulateOnTypeWithInterfaceProperty),
    ...
    [InlineData(
        typeof(IInterfaceWithInterfaceProperty),
        typeof(ClassImplementingInterfaceWithInterfaceProperty),
        false
    )]
    ...
    )
    {
        ...
        ISimpleInterface prop = (ISimpleInterface)
            typeToDeserialize.GetProperty("Property").GetValue(obj);
        Assert.NotNull(prop);
    ...
    internal class ClassImplementingInterfaceWithPopulateOnTypeWithInterfaceProperty
        : IInterfaceWithInterfacePropertyWithPopulateOnType
    {
        public ISimpleInterface Property { get; } =
            new SimpleClassImplementingInterface() { StringValue = "InitialValue", IntValue = 42 };
    }
    ...
    public async Task ReplaceOnType_SetWithMetadata_PopulatableProperty_PropagatesCorrectly(
        bool expectPopulate,
        JsonObjectCreationHandling optionsValue,
        JsonObjectCreationHandling? typeValue,
        JsonObjectCreationHandling? propertyValue
    )
    {
        JsonSerializerOptions options = Serializer.CreateOptions(
            configure: opt =>
        ...
        string json = """{"Property":{"StringValue":"NewValue"}}""";
        var obj =
            await Serializer.DeserializeWrapper<ClassWithReplaceOnTypeAndWritableProperty_SimpleClass>(
                json,
                options
            );
        Assert.Equal("NewValue", obj.Property.StringValue);
    ...
    {
        foreach (
            JsonObjectCreationHandling optionsSett in new JsonObjectCreationHandling[]
            {
                JsonObjectCreationHandling.Replace,
                JsonObjectCreationHandling.Populate,
            }
        ...
        {
            foreach (
                JsonObjectCreationHandling? typeSett in new JsonObjectCreationHandling?[]
                {
                    null,
                    JsonObjectCreationHandling.Replace,
                    JsonObjectCreationHandling.Populate,
            ...
            {
                foreach (
                    JsonObjectCreationHandling? propSett in new JsonObjectCreationHandling?[]
                    {
                        null,
                        JsonObjectCreationHandling.Replace,
                        JsonObjectCreationHandling.Populate,
                ...
                {
                    JsonObjectCreationHandling effectiveHandling =
                        propSett ?? typeSett ?? optionsSett;
    ...
    {
        public SimpleClass Property { get; set; } =
            new SimpleClass() { StringValue = "InitialValue", IntValue = 43 };
    }

    [Theory]
    [MemberData(nameof(CombinationsForNonPopulatableProperty))]
    public async Task ReplaceOnType_SetWithMetadata_NonPopulatableProperty_PropagatesCorrectly(
        bool expectError,
        JsonObjectCreationHandling optionsValue,
        JsonObjectCreationHandling? typeValue,
        JsonObjectCreationHandling? propertyValue
    )
    {
        ...
        {
            var obj = await Serializer.DeserializeWrapper<SimpleClassWitNonPopulatableProperty>(
                json,
                options
            );
    ...
    {
        [JsonObjectCreationHandling(JsonObjectCreationHandling.Populate)]
        public SomeClass PopulatedPropertyReadOnly { get; } =
            new() { StringValue = "InitialForPopulate1" };
    ...
    public void JsonObjectCreationHandlingAttribute_InvalidConstructorArgument_ThrowsArgumentOutOfRangeException(
    ...
    public async Task ClassWithParameterizedCtor_UsingPopulateConfiguration_ThrowsNotSupportedException(
        Type type
    )
    {
    ...
    public async Task ClassWithParameterizedCtor_NoPopulateConfiguration_WorksWithGlobalPopulateConfiguration()
    {
        ...
        ClassWithParameterizedConstructorNoPopulate result =
            await Serializer.DeserializeWrapper<ClassWithParameterizedConstructorNoPopulate>(
                json,
                options
            );
