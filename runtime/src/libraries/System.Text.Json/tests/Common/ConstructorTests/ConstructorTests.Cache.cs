...
namespace System.Text.Json.Serialization.Tests
{
    public abstract partial class ConstructorTests
    {
        ...
        public async Task MultipleThreads()
        {
            ...
            Assert.True(
                typeof(ObjWCtorMixedParams).GetProperties(
        ...
        public async Task PropertyCacheWithMinInputsFirst()
        {
            ...
            testObj = await JsonSerializerWrapperForString.DeserializeWrapper<ObjWCtorMixedParams>(
                json,
                options
            );
            testObj.Verify();
        ...
        public async Task MultipleTypes()
        {
            ...
            {
                ITestClass obj =
                    (ITestClass)await JsonSerializerWrapperForString.DeserializeWrapper<T>(
                        json,
                        s_options
                    );
                obj.Verify();
