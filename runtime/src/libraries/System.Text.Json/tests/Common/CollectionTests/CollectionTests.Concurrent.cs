...
namespace System.Text.Json.Serialization.Tests
{
    public abstract partial class CollectionTests
    {
        ...
        public async Task Read_ConcurrentCollection()
        {
            ...
            ConcurrentQueue<string> qc = await JsonSerializerWrapperForString.DeserializeWrapper<
            ...
            ConcurrentStack<string> qs = await JsonSerializerWrapperForString.DeserializeWrapper<
