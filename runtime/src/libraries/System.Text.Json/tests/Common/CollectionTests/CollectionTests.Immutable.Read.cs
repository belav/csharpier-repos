...
namespace System.Text.Json.Serialization.Tests
{
    public abstract partial class CollectionTests
    {
        ...
        {
            ImmutableArray<ImmutableArray<int>> result =
        ...
        {
            ImmutableArray<int[]> result = await JsonSerializerWrapperForString.DeserializeWrapper<
                ImmutableArray<int[]>
            >(@"[[1,2],[3,4]]");
            int expected = 1;
        ...
        public async Task ReadArrayOfImmutableArray()
        {
            ImmutableArray<int>[] result =
                await JsonSerializerWrapperForString.DeserializeWrapper<ImmutableArray<int>[]>(
                    @"[[1,2],[3,4]]"
                );
            int expected = 1;
        ...
        public async Task ReadSimpleClassWithImmutableArray()
        {
            SimpleTestClassWithImmutableArray obj =
                await JsonSerializerWrapperForString.DeserializeWrapper<SimpleTestClassWithImmutableArray>(
        ...
        {
            IImmutableList<IImmutableList<int>> result =
                await JsonSerializerWrapperForString.DeserializeWrapper<
        ...
        {
            IImmutableList<int[]> result = await JsonSerializerWrapperForString.DeserializeWrapper<
                IImmutableList<int[]>
            >(@"[[1,2],[3,4]]");
            int expected = 1;
        ...
        {
            IImmutableList<int>[] result =
                await JsonSerializerWrapperForString.DeserializeWrapper<IImmutableList<int>[]>(
                    @"[[1,2],[3,4]]"
                );
            int expected = 1;
        ...
        public async Task ReadPrimitiveIImmutableListT()
        {
            ...
            await Assert.ThrowsAsync<NotSupportedException>(
                async () =>
                    await JsonSerializerWrapperForString.DeserializeWrapper<StringIImmutableListWrapper>(
                        @"[""1"",""2""]"
                    )
            );
            await Assert.ThrowsAsync<NotSupportedException>(
        ...
        {
            IImmutableStack<IImmutableStack<int>> result =
                await JsonSerializerWrapperForString.DeserializeWrapper<
        ...
        {
            IImmutableStack<int[]> result = await JsonSerializerWrapperForString.DeserializeWrapper<
                IImmutableStack<int[]>
            >(@"[[1,2],[3,4]]");
            int expected = 3;
        ...
        {
            IImmutableStack<int>[] result =
                await JsonSerializerWrapperForString.DeserializeWrapper<IImmutableStack<int>[]>(
                    @"[[1,2],[3,4]]"
                );
            int expected = 2;
        ...
        public async Task ReadPrimitiveIImmutableStackT()
        {
            ...
            await Assert.ThrowsAsync<NotSupportedException>(
                async () =>
                    await JsonSerializerWrapperForString.DeserializeWrapper<StringIImmutableStackWrapper>(
                        @"[""1"",""2""]"
                    )
            );
            await Assert.ThrowsAsync<NotSupportedException>(
        ...
        {
            IImmutableQueue<IImmutableQueue<int>> result =
                await JsonSerializerWrapperForString.DeserializeWrapper<
        ...
        {
            IImmutableQueue<int[]> result = await JsonSerializerWrapperForString.DeserializeWrapper<
                IImmutableQueue<int[]>
            >(@"[[1,2],[3,4]]");
            int expected = 1;
        ...
        {
            IImmutableQueue<int>[] result =
                await JsonSerializerWrapperForString.DeserializeWrapper<IImmutableQueue<int>[]>(
                    @"[[1,2],[3,4]]"
                );
            int expected = 1;
        ...
        public async Task ReadPrimitiveIImmutableQueueT()
        {
            ...
            await Assert.ThrowsAsync<NotSupportedException>(
                async () =>
                    await JsonSerializerWrapperForString.DeserializeWrapper<StringIImmutableQueueWrapper>(
                        @"[""1"",""2""]"
                    )
            );
            await Assert.ThrowsAsync<NotSupportedException>(
        ...
        {
            IImmutableSet<IImmutableSet<int>> result =
                await JsonSerializerWrapperForString.DeserializeWrapper<
        ...
        {
            IImmutableSet<int[]> result = await JsonSerializerWrapperForString.DeserializeWrapper<
                IImmutableSet<int[]>
            >(@"[[1,2],[3,4]]");
            List<int> expected = new List<int> { 1, 2, 3, 4 };
        ...
        {
            IImmutableSet<int>[] result =
                await JsonSerializerWrapperForString.DeserializeWrapper<IImmutableSet<int>[]>(
                    @"[[1,2],[3,4]]"
                );
            List<int> expected = new List<int> { 1, 2, 3, 4 };
        ...
        public async Task ReadPrimitiveIImmutableSetT()
        {
            ...
            await Assert.ThrowsAsync<NotSupportedException>(
                async () =>
                    await JsonSerializerWrapperForString.DeserializeWrapper<StringIImmutableSetWrapper>(
                        @"[""1"",""2""]"
                    )
            );
            await Assert.ThrowsAsync<NotSupportedException>(
        ...
        {
            ImmutableHashSet<ImmutableHashSet<int>> result =
                await JsonSerializerWrapperForString.DeserializeWrapper<
        ...
        public async Task ReadImmutableHashSetTOfArray()
        {
            ImmutableHashSet<int[]> result =
                await JsonSerializerWrapperForString.DeserializeWrapper<ImmutableHashSet<int[]>>(
                    @"[[1,2],[3,4]]"
                );
            List<int> expected = new List<int> { 1, 2, 3, 4 };
        ...
        {
            ImmutableHashSet<int> result = await JsonSerializerWrapperForString.DeserializeWrapper<
        ...
        {
            ImmutableList<ImmutableList<int>> result =
                await JsonSerializerWrapperForString.DeserializeWrapper<
        ...
        {
            ImmutableList<int[]> result = await JsonSerializerWrapperForString.DeserializeWrapper<
                ImmutableList<int[]>
            >(@"[[1,2],[3,4]]");
            int expected = 1;
        ...
        {
            ImmutableList<int>[] result =
                await JsonSerializerWrapperForString.DeserializeWrapper<ImmutableList<int>[]>(
                    @"[[1,2],[3,4]]"
                );
            int expected = 1;
        ...
        {
            ImmutableStack<ImmutableStack<int>> result =
                await JsonSerializerWrapperForString.DeserializeWrapper<
        ...
        {
            ImmutableStack<int[]> result = await JsonSerializerWrapperForString.DeserializeWrapper<
                ImmutableStack<int[]>
            >(@"[[1,2],[3,4]]");
            int expected = 3;
        ...
        {
            ImmutableStack<int>[] result =
                await JsonSerializerWrapperForString.DeserializeWrapper<ImmutableStack<int>[]>(
                    @"[[1,2],[3,4]]"
                );
            int expected = 2;
        ...
        {
            ImmutableQueue<ImmutableQueue<int>> result =
                await JsonSerializerWrapperForString.DeserializeWrapper<
        ...
        {
            ImmutableQueue<int[]> result = await JsonSerializerWrapperForString.DeserializeWrapper<
                ImmutableQueue<int[]>
            >(@"[[1,2],[3,4]]");
            int expected = 1;
        ...
        {
            ImmutableQueue<int>[] result =
                await JsonSerializerWrapperForString.DeserializeWrapper<ImmutableQueue<int>[]>(
                    @"[[1,2],[3,4]]"
                );
            int expected = 1;
        ...
        public async Task ReadArrayOfIImmutableSortedSetT()
        {
            ImmutableSortedSet<int>[] result =
                await JsonSerializerWrapperForString.DeserializeWrapper<ImmutableSortedSet<int>[]>(
                    @"[[1,2],[3,4]]"
                );
            int expected = 1;
        ...
        public async Task ReadPrimitiveImmutableSortedSetT()
        {
            ...
            result = await JsonSerializerWrapperForString.DeserializeWrapper<
        ...
        public async Task ReadSimpleTestClass_ImmutableCollectionWrappers_Throws()
        {
            await Assert.ThrowsAsync<NotSupportedException>(
                async () =>
                    await JsonSerializerWrapperForString.DeserializeWrapper<SimpleTestClassWithIImmutableDictionaryWrapper>(
                        SimpleTestClassWithIImmutableDictionaryWrapper.s_json
                    )
            );
            await Assert.ThrowsAsync<NotSupportedException>(
                async () =>
                    await JsonSerializerWrapperForString.DeserializeWrapper<SimpleTestClassWithImmutableListWrapper>(
                        SimpleTestClassWithImmutableListWrapper.s_json
                    )
            );
            await Assert.ThrowsAsync<NotSupportedException>(
                async () =>
                    await JsonSerializerWrapperForString.DeserializeWrapper<SimpleTestClassWithImmutableStackWrapper>(
                        SimpleTestClassWithImmutableStackWrapper.s_json
                    )
            );
            await Assert.ThrowsAsync<NotSupportedException>(
                async () =>
                    await JsonSerializerWrapperForString.DeserializeWrapper<SimpleTestClassWithImmutableQueueWrapper>(
                        SimpleTestClassWithImmutableQueueWrapper.s_json
                    )
            );
            await Assert.ThrowsAsync<NotSupportedException>(
                async () =>
                    await JsonSerializerWrapperForString.DeserializeWrapper<SimpleTestClassWithImmutableSetWrapper>(
