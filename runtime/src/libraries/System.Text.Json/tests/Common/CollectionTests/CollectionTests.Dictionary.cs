...
namespace System.Text.Json.Serialization.Tests
{
    public abstract partial class CollectionTests
    {
        ...
        public async Task DictionaryOfString()
        {
            ...
            {
                Dictionary<string, string> obj = await Serializer.DeserializeWrapper<
            ...
            {
                SortedDictionary<string, string> obj = await Serializer.DeserializeWrapper<
            ...
            {
                IDictionary<string, string> obj = await Serializer.DeserializeWrapper<
            ...
            {
                IReadOnlyDictionary<string, string> obj = await Serializer.DeserializeWrapper<
            ...
            {
                ImmutableDictionary<string, string> obj = await Serializer.DeserializeWrapper<
            ...
            {
                IImmutableDictionary<string, string> obj = await Serializer.DeserializeWrapper<
            ...
            {
                ImmutableSortedDictionary<string, string> obj = await Serializer.DeserializeWrapper<
        ...
        public async Task ImplementsDictionary_DictionaryOfString()
        {
...

            {
                WrapperForIDictionary obj =
                    await Serializer.DeserializeWrapper<WrapperForIDictionary>(JsonString);
                Assert.Equal("World", ((JsonElement)obj["Hello"]).GetString());
                Assert.Equal("World2", ((JsonElement)obj["Hello2"]).GetString());
...

            {
                StringToStringDictionaryWrapper obj =
                    await Serializer.DeserializeWrapper<StringToStringDictionaryWrapper>(
                        JsonString
                    );
                Assert.Equal("World", obj["Hello"]);
                Assert.Equal("World2", obj["Hello2"]);
...

            {
                StringToStringSortedDictionaryWrapper obj =
                    await Serializer.DeserializeWrapper<StringToStringSortedDictionaryWrapper>(
                        JsonString
                    );
                Assert.Equal("World", obj["Hello"]);
                Assert.Equal("World2", obj["Hello2"]);
            ...
            {
                GenericIDictionaryWrapper<string, string> obj = await Serializer.DeserializeWrapper<
...

            {
                await Assert.ThrowsAsync<NotSupportedException>(
                    async () =>
                        await Serializer.DeserializeWrapper<StringToStringIImmutableDictionaryWrapper>(
                            JsonString
                        )
                );
            ...
            {
                HashtableWrapper obj = await Serializer.DeserializeWrapper<HashtableWrapper>(
                    JsonString
                );
                Assert.Equal("World", ((JsonElement)obj["Hello"]).GetString());
                Assert.Equal("World2", ((JsonElement)obj["Hello2"]).GetString());
            ...
            {
                SortedListWrapper obj = await Serializer.DeserializeWrapper<SortedListWrapper>(
                    JsonString
                );
                Assert.Equal("World", ((JsonElement)obj["Hello"]).GetString());
                Assert.Equal("World2", ((JsonElement)obj["Hello2"]).GetString());
            ...
            {
                GenericStructIDictionaryWrapper<string, string>? obj =
                    await Serializer.DeserializeWrapper<GenericStructIDictionaryWrapper<
                        string,
                        string
                    >?>(JsonString);
        ...
        {
            {
                Dictionary<string, object> obj = await Serializer.DeserializeWrapper<
            ...
            {
                IDictionary<string, object> obj = await Serializer.DeserializeWrapper<
        ...
        public async Task DictionaryOfList()
        {
            ...
            {
                IDictionary<string, List<int>> obj = await Serializer.DeserializeWrapper<
            ...
            {
                ImmutableDictionary<string, List<int>> obj = await Serializer.DeserializeWrapper<
            ...
            {
                IImmutableDictionary<string, List<int>> obj = await Serializer.DeserializeWrapper<
        ...
        public async Task ListOfDictionary()
        {
            ...
            {
                List<Dictionary<string, int>> obj = await Serializer.DeserializeWrapper<
            ...
            {
                List<ImmutableSortedDictionary<string, int>> obj =
                    await Serializer.DeserializeWrapper<
        ...
        public async Task ArrayOfDictionary()
        {
...

            {
                ImmutableSortedDictionary<string, int>[] obj =
                    await Serializer.DeserializeWrapper<ImmutableSortedDictionary<string, int>[]>(
                        JsonString
                    );
        ...
        public async Task DictionaryOfDictionary()
        {
            ...
            {
                Dictionary<string, Dictionary<string, int>> obj =
                    await Serializer.DeserializeWrapper<
        ...
        public async Task DictionaryOfArrayOfDictionary()
        {
            ...
            Dictionary<string, Dictionary<string, int>[]> obj = await Serializer.DeserializeWrapper<
                Dictionary<string, Dictionary<string, int>[]>
            >(JsonString);
        ...
        [ActiveIssue(
            "Too many dynamically generated serializable types to manually add to a serialization context."
        )]
#endif
        [Fact]
        [ActiveIssue(
        ...
        public async Task NestedDictionariesRoundtrip()
        {
            ...
            {
                object dict = await Serializer.DeserializeWrapper(
                    testJson,
                    dictionaryType,
                    options
                );
        ...
        {
            {
...

                {
                    ...
                    {
                        SimpleTestClass result =
                            await Serializer.DeserializeWrapper<SimpleTestClass>(
                                element.GetRawText()
                            );
                        result.Verify();
                    }
...

            {
...

                {
                    string json =
                        ...
                        + SimpleTestClass.s_json
                        + "}";
                    obj = await Serializer.DeserializeWrapper<Dictionary<string, SimpleTestClass>>(
                        json
                    );
                    Assert.Equal(2, obj.Count);
                    obj["Key1"].Verify();
        ...
        public async Task ObjectToStringFail()
        {
            ...
            await Assert.ThrowsAsync<JsonException>(
                async () => await Serializer.DeserializeWrapper<Dictionary<string, string>>(json)
            );
        }
        ...
        {
            string json = @"{""MyDictionary"":{""Key"":""Value""}}";
            Dictionary<string, JsonElement> result = await Serializer.DeserializeWrapper<
        ...
        public async Task DeserializeDictionaryWithDuplicateKeys()
        {
            ...
            IDictionary iDictionary = await Serializer.DeserializeWrapper<IDictionary>(
                @"{""Hello"":""World"", ""Hello"":""NewValue""}"
            );
            Assert.Equal("NewValue", iDictionary["Hello"].ToString());

            // Generic IDictionary case.
            IDictionary<string, string> iNonGenericDictionary = await Serializer.DeserializeWrapper<
                IDictionary<string, string>
            >(@"{""Hello"":""World"", ""Hello"":""NewValue""}");
            Assert.Equal("NewValue", iNonGenericDictionary["Hello"]);

            IDictionary<string, object> iNonGenericObjectDictionary =
                await Serializer.DeserializeWrapper<IDictionary<string, object>>(
                    @"{""Hello"":""World"", ""Hello"":""NewValue""}"
                );
            ...
            dictionary = await Serializer.DeserializeWrapper<Dictionary<string, string>>(
                @"{""Hello"":""World"", ""myKey"" : ""myValue"", ""Hello"":""NewValue""}"
            );
            Assert.Equal("NewValue", dictionary["Hello"]);

            // Weakly-typed IDictionary case.
            Dictionary<string, object> dictionaryObject = await Serializer.DeserializeWrapper<
                Dictionary<string, object>
        ...
        {
            PocoDuplicate foo = await Serializer.DeserializeWrapper<PocoDuplicate>(
                @"{""BoolProperty"": false, ""BoolProperty"": true}"
            );
            Assert.True(foo.BoolProperty);

            foo = await Serializer.DeserializeWrapper<PocoDuplicate>(
        ...
        public async Task ClassWithNoSetterAndDictionary()
        {
            ...
            ClassWithPopulatedDictionaryAndNoSetter obj =
                await Serializer.DeserializeWrapper<ClassWithPopulatedDictionaryAndNoSetter>(json);
        ...
        public async Task IgnoreDictionaryProperty(string json)
        {
            ...
            ClassWithIgnoredDictionary2 obj =
                await Serializer.DeserializeWrapper<ClassWithIgnoredDictionary2>(json);
            ...
            ClassWithIgnoredDictionary2 objRoundTripped =
                await Serializer.DeserializeWrapper<ClassWithIgnoredDictionary2>(jsonRoundTripped);
        ...
        public async Task IgnoreDictionaryPropertyWithDifferentOrdering()
        {
            ...
            await VerifyIgnore<ClassWithIgnoreAttributeDictionary>(
                false,
                true,
                false,
                addMissing: true
            );
            await VerifyIgnore<ClassWithIgnoredImmutableDictionary>(
                false,
                true,
                false,
                addMissing: true
        ...
        private async Task VerifyIgnore<T>(
            bool skip1,
            bool skip2,
            bool skip3,
        ...
        public async Task ClassWithPopulatedDictionary()
        {
            ...
            ClassWithPopulatedDictionaryAndSetter obj =
                await Serializer.DeserializeWrapper<ClassWithPopulatedDictionaryAndSetter>(json);
        ...
        public async Task DictionaryNotSupported()
        {
            ...
            NotSupportedException ex = await Assert.ThrowsAsync<NotSupportedException>(
                async () =>
                    await Serializer.DeserializeWrapper<ClassWithNotSupportedDictionary>(json)
            );
        ...
        public async Task DictionaryNotSupportedButIgnored()
        {
            ...
            ClassWithNotSupportedDictionaryButIgnored obj =
                await Serializer.DeserializeWrapper<ClassWithNotSupportedDictionaryButIgnored>(
                    json
                );
        ...
        public async Task Serialize_IDictionaryOfPoco()
        {
            ...
            var actual = await Serializer.SerializeWrapper(
                value,
        ...
        public async Task Deserialize_IDictionaryOfPoco()
        {
            ...
            var actual = await Serializer.DeserializeWrapper<AllSingleUpperPropertiesParent>(
                json,
                new JsonSerializerOptions() { PropertyNamingPolicy = JsonNamingPolicy.CamelCase }
            );
        ...
        public async Task ShouldHandleNullInDictionaries_Deserialize()
        {
            ...
            ClassWithDictionaryOfString_ChildWithDictionaryOfString actual =
                await Serializer.DeserializeWrapper<ClassWithDictionaryOfString_ChildWithDictionaryOfString>(
                    json
                );
        ...
        public async Task DictionaryWithNullShouldPreserveOrder_Deserialize()
        {
            ...
            ClassWithDictionaryAndProperty_DictionaryFirst dictionaryFirst =
                await Serializer.DeserializeWrapper<ClassWithDictionaryAndProperty_DictionaryFirst>(
                    json
                );
            ...
            ClassWithDictionaryAndProperty_DictionaryLast dictionaryLast =
                await Serializer.DeserializeWrapper<ClassWithDictionaryAndProperty_DictionaryLast>(
                    json
                );
        ...
        public async Task NullDictionaryValuesShouldDeserializeAsNull()
        {
            ...
            SimpleClassWithDictionaries obj =
                await Serializer.DeserializeWrapper<SimpleClassWithDictionaries>(json);
        ...
        public async Task DictionaryOfTOnlyWithStringTValueAsInt()
        {
            ...
            dictionary = await Serializer.DeserializeWrapper<
        ...
        public async Task DictionaryOfTOnlyWithStringPoco()
        {
            ...
            dictionary =
                await Serializer.DeserializeWrapper<DictionaryThatOnlyImplementsIDictionaryOfStringPoco>(
                    Json
                );
            Assert.Equal(1, dictionary["One"].Id);
            Assert.Equal(2, dictionary["Two"].Id);
        ...
        public async Task VerifyDictionaryThatHasIncomatibleEnumeratorWithInt()
        {
            ...
            dictionary =
                await Serializer.DeserializeWrapper<DictionaryThatHasIncompatibleEnumerator>(Json);
            Assert.Equal(1, ((JsonElement)dictionary["One"]).GetInt32());
            Assert.Equal(2, ((JsonElement)dictionary["Two"]).GetInt32());
            await Assert.ThrowsAsync<NotSupportedException>(
                async () => await Serializer.SerializeWrapper(dictionary)
            );
        }
