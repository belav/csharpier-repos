...
namespace System.Text.Json.Serialization.Tests
{
    public abstract partial class CollectionTests
    {
        ...
        {
            Collection<bool> c = await Serializer.DeserializeWrapper<Collection<bool>>(
                "[true,false]"
            );
            ...
            ObservableCollection<bool> oc = await Serializer.DeserializeWrapper<
            ...
            SimpleKeyedCollection kc = await Serializer.DeserializeWrapper<SimpleKeyedCollection>(
                "[true]"
            );
