...
namespace System.Text.Json.Serialization.Tests
{
    public abstract partial class CollectionTests
    {
        ...
        {
            Collection<bool> c = await JsonSerializerWrapperForString.DeserializeWrapper<
                Collection<bool>
            >("[true,false]");
            ...
            ObservableCollection<bool> oc = await JsonSerializerWrapperForString.DeserializeWrapper<
            ...
            SimpleKeyedCollection kc =
                await JsonSerializerWrapperForString.DeserializeWrapper<SimpleKeyedCollection>(
                    "[true]"
                );
        ...
        public async Task Read_ObjectModelCollection_Throws()
        {
            ...
            await Assert.ThrowsAsync<NotSupportedException>(async () =>
                await JsonSerializerWrapperForString.DeserializeWrapper<ReadOnlyCollection<bool>>(
                    "[true,false]"
                ));
            // No default constructor.
            await Assert.ThrowsAsync<NotSupportedException>(async () =>
                await JsonSerializerWrapperForString.DeserializeWrapper<
                    ReadOnlyObservableCollection<bool>
                >("[true,false]"));
            // No default constructor.
            await Assert.ThrowsAsync<NotSupportedException>(async () =>
                await JsonSerializerWrapperForString.DeserializeWrapper<
                    ReadOnlyDictionary<string, bool>
                >(@"{""true"":false}"));
