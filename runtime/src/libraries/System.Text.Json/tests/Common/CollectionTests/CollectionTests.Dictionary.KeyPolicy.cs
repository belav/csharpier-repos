...
namespace System.Text.Json.Serialization.Tests
{
    public abstract partial class CollectionTests
    {
        ...
        public async Task CamelCaseDeserialize()
        {
            ...
            Dictionary<string, int>[] obj = await Serializer.DeserializeWrapper<Dictionary<
                string,
                int
            >[]>(JsonString);
            ...
            obj = await Serializer.DeserializeWrapper<Dictionary<string, int>[]>(
                JsonString,
                options
            );
        ...
        public async Task IgnoreKeyPolicyForExtensionData()
        {
            ...
            Assert.Equal(
                @"{""Key1"":1,""Key2"":2}",
                await Serializer.SerializeWrapper(myClass, options)
            );
        }
        ...
        public async Task EnumSerialization_DictionaryPolicy_NotApplied_WhenEnumsAreSerialized()
        {
            ...
            value = await Serializer.SerializeWrapper(
                new List<DayOfWeek>
                {
                    DayOfWeek.Sunday,
                    DayOfWeek.Monday,
