    ...
    public abstract partial class CollectionTests
    {
        ...
        public async Task CamelCaseDeserialize()
        {
            ...
            Dictionary<string, int>[] obj =
                await JsonSerializerWrapperForString.DeserializeWrapper<Dictionary<string, int>[]>(
                    JsonString
                );
            ...
            obj = await JsonSerializerWrapperForString.DeserializeWrapper<Dictionary<
                    string,
                    int
                >[]>(JsonString, options);
        ...
        public async Task IgnoreKeyPolicyForExtensionData()
        {
            ...
            ClassWithExtensionData myClass =
                await JsonSerializerWrapperForString.DeserializeWrapper<ClassWithExtensionData>(
                    @"{""Key1"":1, ""Key2"":2}",
                    options
                );
            ...
            Assert.Equal(
                @"{""Key1"":1,""Key2"":2}",
                await JsonSerializerWrapperForString.SerializeWrapper(myClass, options)
            );
        }
        ...
        public async Task CustomNameDeserialize()
        {
            ...
            // Ensure we ignore key policy and deserialize keys as they are.
            obj = await JsonSerializerWrapperForString.DeserializeWrapper<Dictionary<string, int>>(
                @"{""myint"":1}",
                options
            );
            Assert.Equal(1, obj["myint"]);
        ...
        public async Task CamelCaseSerialize_ApplyDictionaryKeyPolicy()
        {
            ...
            var json = await JsonSerializerWrapperForString.SerializeWrapper(
                obj,
