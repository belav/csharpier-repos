...
namespace System.Text.Json.Serialization.Tests
{
    public abstract partial class PropertyVisibilityTests
    {
        ...
        public async Task NonPublic_AccessorsNotSupported_WithoutAttribute()
        {
            ...
            var obj =
                await JsonSerializerWrapperForString.DeserializeWrapper<MyClass_WithNonPublicAccessors>(
                    json
                );
        ...
        public async Task ExtensionDataCanHaveNonPublicSetter()
        {
            ...
            // Baseline
            var obj1 =
                await JsonSerializerWrapperForString.DeserializeWrapper<ClassWithExtensionData_NonPublicSetter>(
                    json
                );
            ...
            // With attribute
            var obj2 =
                await JsonSerializerWrapperForString.DeserializeWrapper<ClassWithExtensionData_NonPublicSetter_WithAttribute>(
                    json
                );
        ...
        public async Task HonorCaseInsensitivity()
        {
            ...
            Assert.Null(
                (
                    await JsonSerializerWrapperForString.DeserializeWrapper<MyStruct_WithNonPublicAccessors_WithTypeAttribute>(
                        json
                    )
                ).MyString
            );
        ...
        {
            var obj =
                await JsonSerializerWrapperForString.DeserializeWrapper<PointWith_JsonSerializableProperties>(
                    @"{""X"":1,""Y"":2}"
                );
