...
namespace System.Text.Json.Serialization.Tests
{
    ...
    {
        public ExtensionDataTests(JsonSerializerWrapperForString serializerWrapper)
        ...
        public async Task EmptyPropertyName_WinsOver_ExtensionDataEmptyPropertyName()
        {
            ...
            obj =
                await JsonSerializerWrapperForString.DeserializeWrapper<ClassWithEmptyPropertyNameAndExtensionProperty>(
                    json,
                    options
                );
        ...
        {
            {
                ...
                EmptyClassWithExtensionProperty obj =
                    await JsonSerializerWrapperForString.DeserializeWrapper<EmptyClassWithExtensionProperty>(
                        json
                    );
        ...
        public async Task ExtensionFieldNotUsed()
        {
            ...
            ClassWithExtensionField obj =
                await JsonSerializerWrapperForString.DeserializeWrapper<ClassWithExtensionField>(
                    json
                );
            Assert.Null(obj.MyOverflow);
        }
        ...
        {
            string expected = @"{}";
            string actual = await JsonSerializerWrapperForString.SerializeWrapper(
        ...
        public async Task InvalidExtensionPropertyFail()
        {
            ...
            await Assert.ThrowsAsync<InvalidOperationException>(
                async () =>
                    await JsonSerializerWrapperForString.DeserializeWrapper<ClassWithInvalidExtensionProperty>(
                        @"{}"
                    )
            );
            await Assert.ThrowsAsync<InvalidOperationException>(
                async () =>
                    await JsonSerializerWrapperForString.DeserializeWrapper<ClassWithTwoExtensionProperties>(
                        @"{}"
                    )
            );
        }
        ...
        {
            ClassWithIgnoredData obj =
                await JsonSerializerWrapperForString.DeserializeWrapper<ClassWithIgnoredData>(
                    @"{""MyInt"":1}"
                );
        ...
        public class ClassWithExtensionDataWithAttributedConverter
        ...
        public class ClassWithJsonElementExtensionDataWithAttributedConverter
        ...
        public class ClassWithCustomElementExtensionDataWithAttributedConverter
        ...
        public void ExtensionProperty_SupportsWritingToCustomSerializerWithExplicitConverter(
            Type attributedType,
            Type dictionaryType
        )
        {
        ...
        public void ExtensionProperty_IgnoresCustomSerializerWithOptions(
            Type overflowType,
            Type converterType,
            Type elementType
        )
        ...
        public void ExtensionProperty_IgnoresCustomSerializerWithExplicitConverter(
            Type attributedType,
            Type dictionaryType,
            Type elementType
        )
        ...
        public async Task ExtensionPropertyObjectValue_Empty()
        {
            ClassWithExtensionPropertyAlreadyInstantiated obj =
                await JsonSerializerWrapperForString.DeserializeWrapper<ClassWithExtensionPropertyAlreadyInstantiated>(
                    @"{}"
                );
        ...
        public async Task ExtensionPropertyDuplicateNames(JsonSerializerOptions options)
        {
            ...
            obj =
                await JsonSerializerWrapperForString.DeserializeWrapper<ClassWithExtensionPropertyAsObjectAndNameProperty>(
                    json,
                    options
                );
        ...
        public async Task Null_SystemObject(JsonSerializerOptions options)
        {
...

            {
                ClassWithExtensionPropertyAsJsonObject obj =
                    await JsonSerializerWrapperForString.DeserializeWrapper<ClassWithExtensionPropertyAsJsonObject>(
                        json,
                        options
                    );
        ...
        public async Task Null_JsonElement()
        {
            ...
            ClassWithExtensionPropertyAsJsonElement obj =
                await JsonSerializerWrapperForString.DeserializeWrapper<ClassWithExtensionPropertyAsJsonElement>(
                    json
                );
            object elem = obj.MyOverflow["MissingProperty"];
        ...
        public async Task DeserializeIntoSystemObjectProperty()
        {
            ...
            await Assert.ThrowsAsync<InvalidOperationException>(
                async () =>
                    await JsonSerializerWrapperForString.DeserializeWrapper<ClassWithExtensionPropertyAsSystemObject>(
                        json
                    )
            );
        ...
        public async Task NestedClassWithObjectExtensionDataProperty()
        {
            ...
            parent = await JsonSerializerWrapperForString.DeserializeWrapper<ParentClassWithObject>(
                json
            );
        ...
        public async Task NestedClassWithJsonElementExtensionDataProperty()
        {
            ...
            string json = await JsonSerializerWrapperForString.SerializeWrapper(parent);
            parent =
                await JsonSerializerWrapperForString.DeserializeWrapper<ParentClassWithJsonElement>(
                    json
                );
            Verify();
        ...
        public async Task DeserializeIntoMultipleDictionaries()
        {
            ...
            obj =
                await JsonSerializerWrapperForString.DeserializeWrapper<ClassWithMultipleDictionaries>(
                    json
                );
            Assert.Equal(1, obj.MyOverflow.Count);
            Assert.Equal(
        ...
        public async Task SerializerOutputRoundtripsWhenEscaping()
        {
            ...
            ClassWithEscapedProperty input =
                await JsonSerializerWrapperForString.DeserializeWrapper<ClassWithEscapedProperty>(
                    jsonString
                );
        ...
        public async Task ExtensionProperty_InvalidDictionary()
        {
            ...
            await Assert.ThrowsAsync<InvalidOperationException>(
                async () => await JsonSerializerWrapperForString.SerializeWrapper(obj1)
            );

            var obj2 = new ClassWithInvalidExtensionPropertyObjectString();
            await Assert.ThrowsAsync<InvalidOperationException>(
                async () => await JsonSerializerWrapperForString.SerializeWrapper(obj2)
            );

            var obj3 = new ClassWithInvalidExtensionPropertyStringJsonNode();
            await Assert.ThrowsAsync<InvalidOperationException>(
                async () => await JsonSerializerWrapperForString.SerializeWrapper(obj3)
            );
        }
        ...
        public async Task DeserializeIntoImmutableDictionaryProperty()
        {
            ...
            await Assert.ThrowsAsync<InvalidOperationException>(
                async () =>
                    await JsonSerializerWrapperForString.DeserializeWrapper<ClassWithExtensionPropertyCustomIImmutable>(
                        "{\"hello\":\"world\"}"
                    )
            );
            await Assert.ThrowsAsync<InvalidOperationException>(
                async () =>
                    await JsonSerializerWrapperForString.DeserializeWrapper<ClassWithExtensionPropertyCustomIImmutableJsonElement>(
                        "{\"hello\":\"world\"}"
                    )
            );
        }
        ...
        public async Task LongPropertyNames(int propertyLength, char ch)
        {
            ...
            string jsonRoundTripped = await JsonSerializerWrapperForString.SerializeWrapper(
                obj,
                options
            );
