...
namespace System.Text.Json.Serialization.Tests
{
    ...
    {
        public JsonCreationHandlingTests(JsonSerializerWrapper serializerUnderTest)
        ...
        public async Task CreationHandlingSetWithAttribute_PopulateSetWithModifierWithInvalidTypeThrows(
            Type type
        )
        {
        ...
        public Task CreationHandlingSetWithAttribute_PopulatedPropertyDeserializeNull(
            TypeWitness typeWitness
        ) =>
            typeWitness.Accept(
                CreationHandling_PopulatedPropertyDeserializeNull_TestBody.Instance,
                Serializer
            );

        private sealed class CreationHandling_PopulatedPropertyDeserializeNull_TestBody
            : ITypeVisitor<JsonSerializerWrapper, Task>
        {
            public static readonly CreationHandling_PopulatedPropertyDeserializeNull_TestBody Instance =
                new();
        ...
        [Theory]
        [MemberData(nameof(GetTestedCollectionTypes))]
        public Task CreationHandlingSetWithAttribute_PopulatedPropertyDeserializeNullOnReadOnlyProperty(
            TypeWitness typeWitness
        ) =>
            typeWitness.Accept(
                CreationHandling_PopulatedPropertyDeserializeNullOnReadOnlyPropertyGeneric_TestBody.Instance,
                Serializer
            );

        private sealed class CreationHandling_PopulatedPropertyDeserializeNullOnReadOnlyPropertyGeneric_TestBody
            : ITypeVisitor<JsonSerializerWrapper, Task>
        {
            public static readonly CreationHandling_PopulatedPropertyDeserializeNullOnReadOnlyPropertyGeneric_TestBody Instance =
                new();
        ...
        [Theory]
        [MemberData(nameof(GetTestedCollectionTypes))]
        public Task CreationHandlingSetWithAttribute_PopulatedPropertyDeserializeInitiallyNull(
            TypeWitness typeWitness
        ) =>
            typeWitness.Accept(
                CreationHandlingSetWithAttribute_PopulatedPropertyDeserializeInitiallyNull_TestBody.Instance,
                Serializer
            );

        private sealed class CreationHandlingSetWithAttribute_PopulatedPropertyDeserializeInitiallyNull_TestBody
            : ITypeVisitor<JsonSerializerWrapper, Task>
        {
            public static readonly CreationHandlingSetWithAttribute_PopulatedPropertyDeserializeInitiallyNull_TestBody Instance =
                new();
        ...
        private static void CheckGenericDictionaryContent(
        ...
        )
        {
            ...
            for (int i = 0; i < expectedNumberOfElements; i++)
            {
                ...
                Assert.True(
                    dict.ContainsKey(expectedKey),
                    $"Dictionary does not contain '{expectedKey}' key."
                );
                Assert.Equal(expectedValue, dict[expectedKey]);
            }
        }

        private static void CheckDictionaryContent(
            IDictionary dict,
            int expectedNumberOfElements = 6
        )
        {
        ...
        private static void CheckTypeHasSinglePropertyWithPopulateHandling(
        ...
        internal class ClassWithReadOnlyInitializedProperty<T>
            where T : new()
        {
            [JsonObjectCreationHandling(JsonObjectCreationHandling.Populate)]
        ...
        internal class ClassWithInitializedProperty<T>
            where T : new()
        {
            [JsonObjectCreationHandling(JsonObjectCreationHandling.Populate)]
        ...
        internal class ClassWithReadOnlyInitializedField<T>
            where T : new()
        {
            [JsonObjectCreationHandling(JsonObjectCreationHandling.Populate)]
        ...
        internal class ClassWithInitializedField<T>
            where T : new()
        {
            [JsonObjectCreationHandling(JsonObjectCreationHandling.Populate)]
            public T Field = new();
