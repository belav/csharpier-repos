...
namespace System.Text.Json.SourceGeneration.Tests
{
    ...
    public class SerializationContextTests : RealWorldContextTests
    {
        ...
        public override void EnsureFastPathGeneratedAsExpected()
        {
            ...
            Assert.NotNull(
                SerializationContext.Default.TypeWithValidationAttributes.SerializeHandler
            );
        ...
        public override void PositionalRecord()
        {
            ...
            JsonTestHelper.AssertThrows_PropMetadataInit(
                () => JsonSerializer.Deserialize(json, DefaultContext.HighLowTempsRecord),
                typeof(HighLowTempsRecord)
            );
        }
    ...
    public sealed class SerializationWithPerTypeAttributeContextTests : SerializationContextTests
    {
        ...
        public override void EnsureFastPathGeneratedAsExpected()
        {
            ...
            Assert.NotNull(
                SerializationWithPerTypeAttributeContext.Default.HighLowTempsRecord.SerializeHandler
            );
            Assert.NotNull(
            ...
            Assert.Null(
                SerializationWithPerTypeAttributeContext.Default.JsonDocument.SerializeHandler
            );
            Assert.Null(
            ...
            Assert.Null(
                SerializationWithPerTypeAttributeContext.Default.PolymorphicClass.SerializeHandler
            );
        }
    }
}
