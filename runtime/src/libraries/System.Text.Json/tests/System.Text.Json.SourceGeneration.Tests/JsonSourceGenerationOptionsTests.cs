...
namespace System.Text.Json.SourceGeneration.Tests
{
    public static partial class JsonSourceGenerationOptionsTests
    {
        ...
        [JsonSerializable(typeof(PersonStruct))]
        public partial class ContextWithWebDefaultsAndOverriddenPropertyNamingPolicy
        ...
        [JsonSourceGenerationOptions(
            ...
            Converters = new[]
            {
                typeof(JsonStringEnumConverter<BindingFlags>),
                typeof(JsonStringEnumConverter<JsonIgnoreCondition>),
            },
            DefaultBufferSize = 128,
            DefaultIgnoreCondition = JsonIgnoreCondition.WhenWritingDefault,
        ...
        {
            var value = new ClassWithEnumProperty
            {
                StringValue = MyEnum.A,
                NumberValue = MyEnum.A,
            };
            string expectedJson = """{"StringValue":"A","NumberValue":0}""";

            string json = JsonSerializer.Serialize(
                value,
                ContextWithStringEnumConverterEnabled.Default.ClassWithEnumProperty
            );
