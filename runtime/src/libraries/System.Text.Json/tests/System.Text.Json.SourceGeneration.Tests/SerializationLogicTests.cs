...
namespace System.Text.Json.SourceGeneration.Tests
{
    public static class SerializationLogicTests
    {
        ...
        public static void SerializationFuncNotInvokedWhenNotSupported(
        ...
        )
        {
            ...
            JsonContext context = new(options);
            JsonTestHelper.AssertThrows_PropMetadataInit(
                () => JsonSerializer.Serialize(message, context.JsonMessage),
                typeof(JsonMessage)
            );
            JsonTestHelper.AssertThrows_PropMetadataInit(
        ...
        public static void DictionaryFastPathPrimitiveValueSupported()
        {
            ...
            Assert.NotNull(
                DictionaryTypeContext.Default.DictionaryStringJsonMessage.SerializeHandler
            );
        ...
        public static IEnumerable<object[]> GetOptionsUsingDeserializationOnlyFeatures()
        {
            ...
            {
                new JsonSerializerOptions(s_compatibleOptions) { AllowTrailingCommas = true },
            };
            yield return new object[]
            {
                new JsonSerializerOptions(s_compatibleOptions) { DefaultBufferSize = 8192 },
            };
            yield return new object[]
            {
                new JsonSerializerOptions(s_compatibleOptions)
                {
...
#pragma warning restore SYSLIB0020 // Type or member is obsolete
        ...
        public static IEnumerable<object[]> GetIncompatibleOptions()
        {
            ...
            yield return new object[]
            {
                new JsonSerializerOptions { NumberHandling = JsonNumberHandling.WriteAsString },
            };
            yield return new object[]
            {
            ...
            yield return new object[]
            {
                new JsonSerializerOptions(s_compatibleOptions) { IgnoreReadOnlyFields = true },
            };
        }
        ...
        public static void WriterIsFlushedAtRootCall()
        {
            ...
            JsonSerializer.Serialize(
                writer,
                new HighLowTemps(),
                SerializationContext.Default.HighLowTemps
            );
        ...
        {
            PersonStruct? person = new() { FirstName = "Jane", LastName = "Doe" };
        ...
        internal partial class NullablePersonContext : JsonSerializerContext
        {
            ...
            public JsonTypeInfo<PersonStruct?> NullablePersonStruct =>
                JsonMetadataServices.CreateValueInfo<PersonStruct?>(
                    s_options,
                    JsonMetadataServices.GetNullableConverter(underlyingTypeInfo: PersonStruct)
                );
