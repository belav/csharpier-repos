...
namespace System.Text.Json.Node.Tests
{
    public static class ParseTests
    {
        ...
        public static void Parse()
        {
            ...
            DateTimeOffset dtOffset = JsonNode.Parse("\"2020-07-08T01:02:03+01:15\"")
        ...
        public static void Parse_TryGetValue()
        {
            ...
            Assert.True(
                JsonNode.Parse("\"ed957609-cdfe-412f-88c1-02daca1b4f51\"")
                    .AsValue()
                    .TryGetValue(out Guid? _)
            );
            Assert.True(
                JsonNode.Parse("\"2020-07-08T01:02:03+01:15\"")
                    .AsValue()
