...
namespace System.Text.Json.Serialization.Tests
{
    ...
    {
        public ConstructorTests_Stream()
    ...
    public abstract partial class ConstructorTests
    {
        ...
        public async Task CaseInsensitivityWorks()
        {
            ...
            Point_2D point = await Serializer.DeserializeWrapper<Point_2D>(
                @"{""x"":1,""y"":2}",
                options
            );
            Assert.Equal(1, point.X);
        ...
        {
            Point_3D point = await Serializer.DeserializeWrapper<Point_3D>(
                @"{""X"":1,""Y"":2,""Z"":3}"
            );
            Assert.Equal(1, point.X);
            Assert.Equal(2, point.Y);
        ...
        {
            List<Point_3D> list = await Serializer.DeserializeWrapper<List<Point_3D>>(
                @"[{""Y"":2,""Z"":3,""X"":1},{""Z"":10,""Y"":30,""X"":20}]"
            );
        ...
        {
            Dictionary<string, Point_3D> dict = await Serializer.DeserializeWrapper<
                Dictionary<string, Point_3D>
            >(@"{""0"":{""Y"":2,""Z"":3,""X"":1},""1"":{""Z"":10,""Y"":30,""X"":20}}");
        ...
        {
            WrapperForPoint_3D obj = await Serializer.DeserializeWrapper<WrapperForPoint_3D>(
                @"{""Point_3D"":{""Y"":2,""Z"":3,""X"":1}}"
            );
        ...
        {
            ClassWrapperForPoint_3D obj =
                await Serializer.DeserializeWrapper<ClassWrapperForPoint_3D>(
                    @"{""Point3D"":{""Y"":2,""Z"":3,""X"":1}}"
                );
        ...
        {
            ClassWrapper_For_Int_String obj =
                await Serializer.DeserializeWrapper<ClassWrapper_For_Int_String>(
                    @"{""Int"":1,""String"":""1""}"
                );
        ...
        public async Task PassDefaultValueToComplexStruct()
        {
            ...
            ClassWrapper_For_Int_Point_3D_String obj1 =
                await Serializer.DeserializeWrapper<ClassWrapper_For_Int_Point_3D_String>(@"{}");
        ...
        public async Task Null_AsArgument_To_ParameterThat_CanBeNull()
        {
            ClassWrapper_For_Int_Point_3D_String obj1 =
                await Serializer.DeserializeWrapper<ClassWrapper_For_Int_Point_3D_String>(
                    @"{""MyInt"":1,""MyPoint3DStruct"":{},""MyString"":null}"
                );
        ...
        {
            var personClass = await Serializer.DeserializeWrapper<Person_Class>(
                Person_Class.s_json
            );
            personClass.Verify();

            var personStruct = await Serializer.DeserializeWrapper<Person_Struct>(
                Person_Struct.s_json
            );
            personStruct.Verify();
        }
        ...
        {
            Point_2D_With_ExtData point =
                await Serializer.DeserializeWrapper<Point_2D_With_ExtData>(
                    @"{""X"":1,""y"":2,""b"":3}"
                );
            Assert.Equal(1, point.X);
        ...
        {
            var obj = await Serializer.DeserializeWrapper<Point_CtorsIgnoreJson>(
                @"{""X"":1,""Y"":2}"
            );
        ...
        public async Task NumerousSimpleAndComplexParameters()
        {
            var obj =
                await Serializer.DeserializeWrapper<ClassWithConstructor_SimpleAndComplexParameters>(
                    ClassWithConstructor_SimpleAndComplexParameters.s_json
                );
            obj.Verify();
        }
        ...
        public async Task ClassWithPrimitives_Parameterless()
        {
            ...
            var deserialized =
                await Serializer.DeserializeWrapper<Parameterless_ClassWithPrimitives>(json);
        ...
        {
            var point = new Parameterized_ClassWithPrimitives_3Args(
                x: 234235,
                y: 912874,
                z: 434934
            );
        ...
        {
            var tuple = await Serializer.DeserializeWrapper<Tuple<string, double>>(
                @"{""Item1"":""New York"",""Item2"":32.68}"
            );
            Assert.Equal("New York", tuple.Item1);
            Assert.Equal(32.68, tuple.Item2);

            var tupleWrapper = await Serializer.DeserializeWrapper<TupleWrapper>(
                @"{""Tuple"":{""Item1"":""New York"",""Item2"":32.68}}"
            );
            tuple = tupleWrapper.Tuple;
            Assert.Equal("New York", tuple.Item1);
            Assert.Equal(32.68, tuple.Item2);

            var tupleList = await Serializer.DeserializeWrapper<List<Tuple<string, double>>>(
                @"[{""Item1"":""New York"",""Item2"":32.68}]"
            );
            tuple = tupleList[0];
            Assert.Equal("New York", tuple.Item1);
        ...
        public async Task TupleDeserialization_DefaultValuesUsed_WhenJsonMissing()
        {
            ...
            var obj = await Serializer.DeserializeWrapper<
                Tuple<int, string, int, string, string, int, Point_3D_Struct>
            >(input);
        ...
        public async Task TupleDeserializationWorks_ClassWithParameterizedCtor()
        {
            ...
            var complexTuple = await Serializer.DeserializeWrapper<
                Tuple<
        ...
        public async Task Cannot_Deserialize_ObjectWith_Ctor_With_65_Params()
        {
            async Task RunTestAsync<T>()
            {
                ...
                NotSupportedException ex = await Assert.ThrowsAsync<NotSupportedException>(
                    () => Serializer.DeserializeWrapper<T>(input)
                );
        ...
        {
            var obj1 =
                await Serializer.DeserializeWrapper<SimpleClassWithParameterizedCtor_GenericDictionary_JsonElementExt>(
                    @"{""key"": ""value""}"
                );
            Assert.Equal("value", obj1.ExtensionData["key"].GetString());

            var obj2 =
                await Serializer.DeserializeWrapper<SimpleClassWithParameterizedCtor_GenericDictionary_ObjectExt>(
                    @"{""key"": ""value""}"
                );
            Assert.Equal("value", ((JsonElement)obj2.ExtensionData["key"]).GetString());

            var obj3 =
                await Serializer.DeserializeWrapper<SimpleClassWithParameterizedCtor_Derived_GenericIDictionary_JsonElementExt>(
                    @"{""key"": ""value""}"
                );
            Assert.Equal("value", obj3.ExtensionData["key"].GetString());

            var obj4 =
                await Serializer.DeserializeWrapper<SimpleClassWithParameterizedCtor_Derived_GenericIDictionary_ObjectExt>(
                    @"{""key"": ""value""}"
                );
        ...
        {
            ClassWithFiveArgs_MembersHave_JsonNumberHandlingAttributes obj =
                await Serializer.DeserializeWrapper<ClassWithFiveArgs_MembersHave_JsonNumberHandlingAttributes>(
                    ClassWithFiveArgs_MembersHave_JsonNumberHandlingAttributes.s_json
                );
            obj.Verify();
        ...
        public async Task ArgumentDeserialization_Honors_JsonPropertyName_CaseInsensitiveWorks()
        {
            ...
            Point_MembersHave_JsonPropertyName point =
                await Serializer.DeserializeWrapper<Point_MembersHave_JsonPropertyName>(json);

            var options = new JsonSerializerOptions { PropertyNameCaseInsensitive = true };
            point = await Serializer.DeserializeWrapper<Point_MembersHave_JsonPropertyName>(
                json,
                options
            );
            Assert.Equal(1, point.X);
        ...
        {
            var point = await Serializer.DeserializeWrapper<Point_MembersHave_JsonConverter>(
                Point_MembersHave_JsonConverter.s_json
            );
            point.Verify();
        }
        ...
        {
            var point = await Serializer.DeserializeWrapper<Point_MembersHave_JsonIgnore>(
                Point_MembersHave_JsonIgnore.s_json
            );
            point.Verify();
        }
        ...
        public async Task ArgumentDeserialization_UseNamingPolicy_ToMatch_CaseInsensitiveWorks()
        {
            ...
            Point_ExtendedPropNames point =
                await Serializer.DeserializeWrapper<Point_ExtendedPropNames>(json, options1);
            Assert.Equal(0, point.XValue);
            Assert.Equal(0, point.YValue);
        ...
        {
            Point_With_Array obj1 = await Serializer.DeserializeWrapper<Point_With_Array>(
                Point_With_Array.s_json
            );
            ((ITestClass)obj1).Verify();

            Point_With_Dictionary obj2 = await Serializer.DeserializeWrapper<Point_With_Dictionary>(
                Point_With_Dictionary.s_json
            );
            ((ITestClass)obj2).Verify();

            Point_With_Object obj3 = await Serializer.DeserializeWrapper<Point_With_Object>(
                Point_With_Object.s_json
            );
        ...
        public async Task ArgumentStateNotOverwritten()
        {
            ...
            ClassWithNestedClass obj1 = new ClassWithNestedClass(
                myClass: obj,
                myPoint: new Point_2D_Struct_WithAttribute(1, 2)
            );
            ClassWithNestedClass obj2 = new ClassWithNestedClass(
                myClass: obj1,
                myPoint: new Point_2D_Struct_WithAttribute(3, 4)
            );
        ...
        {
            MyRecordWithUnboundCtorProperty obj =
                JsonSerializer.Deserialize<MyRecordWithUnboundCtorProperty>(
