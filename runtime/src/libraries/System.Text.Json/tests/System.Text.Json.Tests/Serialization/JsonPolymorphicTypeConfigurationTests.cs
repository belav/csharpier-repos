...
namespace System.Text.Json.Tests.Serialization
{
    public static class JsonPolymorphicTypeConfigurationTests
    {
        ...
        public static void SupportedDerivedTypeArgument_ShouldSucceed(
            Type baseType,
            Type derivedType
        )
        {
            var configuration = new JsonPolymorphicTypeConfiguration(baseType).WithDerivedType(
                derivedType
            );
            Assert.Equal(new (Type, object?)[] { (derivedType, null) }, configuration);

            configuration = new JsonPolymorphicTypeConfiguration(baseType).WithDerivedType(
                derivedType,
                "typeDiscriminator"
            );
            Assert.Equal(
                new (Type, object?)[] { (derivedType, "typeDiscriminator") },
                configuration
            );
        ...
        {
            var configuration = new JsonPolymorphicTypeConfiguration(typeof(Class)).WithDerivedType(
                typeof(Class)
            );

            Assert.Equal(new (Type, object?)[] { (typeof(Class), null) }, configuration);

            configuration = new JsonPolymorphicTypeConfiguration(typeof(Class)).WithDerivedType(
                typeof(Class),
                "typeDiscriminator"
            );

            Assert.Equal(
                new (Type, object?)[] { (typeof(Class), "typeDiscriminator") },
                configuration
            );
        ...
        public static void InvalidDerivedTypeArgument_ThrowsArgumentException(
            Type baseType,
            Type derivedType
        )
        {
            ...
            Assert.Throws<ArgumentException>(
                () => configuration.WithDerivedType(derivedType, "typeDiscriminator")
            );
            Assert.Empty(configuration);
        }
        ...
        public static void NullDerivedTypeArgument_ThrowsArgumentNullException()
        {
            ...
            Assert.Throws<ArgumentNullException>(
                () => configuration.WithDerivedType(derivedType: null)
            );
            Assert.Empty(configuration);
        }
        ...
        public static void DuplicateDerivedType_ThrowsArgumentException()
        {
            ...
            Assert.Throws<ArgumentException>(
                () => configuration.WithDerivedType(typeof(GenericClass<int>))
            );
            Assert.Equal(
                new (Type, object?)[] { (typeof(GenericClass<int>), null) },
                configuration
            );
        }
        ...
        public static void DuplicateTypeDiscriminator_String_ThrowsArgumentException()
        {
            ...
            Assert.Equal(
                new (Type, object?)[]
                {
                    (typeof(GenericClass<int>), "discriminator1"),
                    (typeof(GenericClass<string>), "discriminator2")
                },
                configuration
            );

            Assert.Throws<ArgumentException>(
                () => configuration.WithDerivedType(typeof(GenericClass<bool>), "discriminator2")
            );
        ...
        public static void DuplicateTypeDiscriminator_Int_ThrowsArgumentException()
        {
            ...
            Assert.Equal(
                new (Type, object?)[]
                {
                    (typeof(GenericClass<int>), 0),
                    (typeof(GenericClass<string>), 1)
                },
                configuration
            );

            Assert.Throws<ArgumentException>(
                () => configuration.WithDerivedType(typeof(GenericClass<bool>), 1)
            );
        ...
        {
            var config = new JsonPolymorphicTypeConfiguration(typeof(Class)).WithDerivedType(
                typeof(GenericClass<int>),
                "derived"
            );
            ...
            Assert.Throws<InvalidOperationException>(
                () => config.WithDerivedType(typeof(GenericClass<string>), "derived2")
            );
            Assert.Throws<InvalidOperationException>(
                () => config.WithDerivedType(typeof(GenericClass<string>), 42)
            );
            Assert.Throws<InvalidOperationException>(
                () => config.TypeDiscriminatorPropertyName = "_case"
            );
            Assert.Throws<InvalidOperationException>(
                () =>
                    config.UnknownDerivedTypeHandling =
                        JsonUnknownDerivedTypeHandling.FallBackToBaseType
            );
            Assert.Throws<InvalidOperationException>(
                () => config.IgnoreUnrecognizedTypeDiscriminators = true
            );
        }
