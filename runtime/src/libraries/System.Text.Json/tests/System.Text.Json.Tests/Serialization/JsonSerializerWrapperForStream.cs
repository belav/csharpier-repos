...
namespace System.Text.Json.Serialization.Tests
{
    ...
    {
        public static JsonSerializerWrapperForStream AsyncStreamSerializer =>
            new AsyncStreamSerializerWrapper();
        public static JsonSerializerWrapperForStream SyncStreamSerializer =>
            new SyncStreamSerializerWrapper();

        private class AsyncStreamSerializerWrapper : JsonSerializerWrapperForStream
        {
            protected internal override async Task SerializeWrapper<T>(
                Stream utf8Json,
                T value,
            ...
            protected internal override async Task SerializeWrapper(
                Stream utf8Json,
                object value,
                Type inputType,
                JsonSerializerOptions options = null
            ...
            protected internal override async Task<object> DeserializeWrapper(
                Stream utf8Json,
                Type returnType,
                JsonSerializerOptions options = null
            )
