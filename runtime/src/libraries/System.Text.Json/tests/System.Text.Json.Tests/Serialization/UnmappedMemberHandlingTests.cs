...
namespace System.Text.Json.Serialization.Tests
{
    ...
    {
        public UnmappedMemberHandlingTests_String()
            : base(JsonSerializerWrapper.StringSerializer) { }
    }

    public sealed partial class UnmappedMemberHandlingTests_AsyncStream
        : UnmappedMemberHandlingTests
    {
        public UnmappedMemberHandlingTests_AsyncStream()
