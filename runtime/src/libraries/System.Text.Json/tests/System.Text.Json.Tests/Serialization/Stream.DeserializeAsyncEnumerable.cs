...
namespace System.Text.Json.Serialization.Tests
{
    partial public static class StreamTests_DeserializeAsyncEnumerable
    {
        ...
        )
        {
            ...
            List<TElement> results = await DeserializeAsyncEnumerableWrapper<TElement>(
                    stream,
                    options,
                    overload: overload
                )
        ...
        )
        {
            ...
            IAsyncEnumerable<int> asyncEnumerable = DeserializeAsyncEnumerableWrapper<int>(
                stream,
                options,
                overload: overload
            );
            ...
            for (int i = 0; i < 20; i++)
            {
                ...
                Assert.True(
                    stream.Position < stream.Capacity / 2,
                    "should have consumed less than half of the stream contents."
                );
            }
        }
        ...
        )
        {
            ...
            byte[] data = JsonSerializer.SerializeToUtf8Bytes(
                Enumerable.Repeat(Enumerable.Repeat(1, 3), expectedCount)
            );
            ...
            int callbackCount = 0;
            await foreach (
                Queue<int> nestedQueue in DeserializeAsyncEnumerableWrapper<Queue<int>>(
                    stream,
                    options,
                    overload: overload
                )
        ...
        private class DegenerateQueueConverterFactory : JsonConverterFactory
        {
            ...
            )
            {
                ...
                Type converterType = typeof(DegenerateQueueConverter<>).MakeGenericType(
                    queueElement
                );
            ...
            AssertExtensions.Throws<ArgumentNullException>(
                ...
                () =>
                    JsonSerializer.DeserializeAsyncEnumerable<int>(
                        utf8Json: null,
                        jsonTypeInfo: ResolveJsonTypeInfo<int>()
                    )
            );
            AssertExtensions.Throws<ArgumentNullException>(
                "utf8Json",
                () =>
                    JsonSerializer.DeserializeAsyncEnumerable(
                        utf8Json: null,
                        jsonTypeInfo: ResolveJsonTypeInfo(typeof(int))
                    )
            );
            AssertExtensions.Throws<ArgumentNullException>(
                "jsonTypeInfo",
        ...
        [InlineData("\"\"")]
        [InlineData("{}")]
        public static async Task DeserializeAsyncEnumerable_NotARootLevelJsonArray_ThrowsJsonException(
            string json
        )
        {
            ...
            {
                IAsyncEnumerable<int> asyncEnumerable = JsonSerializer.DeserializeAsyncEnumerable(
                    utf8Json,
        ...
        )
        {
            ...
            using var stream = new MemoryStream(data);
            var cancellableAsyncEnumerable = DeserializeAsyncEnumerableWrapper<int>(
                stream,
                options,
                token,
                overload
        ...
        public static IEnumerable<object[]> GetAsyncEnumerableSources()
        {
            ...
            yield return WrapArgs(
                Enumerable.Empty<int>(),
                1,
                DeserializeAsyncEnumerableOverload.UntypedJsonSerializerOptions
            );
            yield return WrapArgs(
                Enumerable.Empty<int>(),
                1,
            ...
            yield return WrapArgs(
                Enumerable.Empty<int>(),
                1,
                DeserializeAsyncEnumerableOverload.UntypedJsonTypeInfo
            );
            yield return WrapArgs(
            ...
            static object[] WrapArgs<TSource>(
                IEnumerable<TSource> source,
                int bufferSize,
                DeserializeAsyncEnumerableOverload overload
            ) => new object[] { source, bufferSize, overload };
        }

        public enum DeserializeAsyncEnumerableOverload
        {
            JsonSerializerOptions,
            UntypedJsonSerializerOptions,
            JsonTypeInfo,
            UntypedJsonTypeInfo
        };
        ...
        )
        {
            return overload switch
            {
                ...
                DeserializeAsyncEnumerableOverload.UntypedJsonTypeInfo
                    => Cast(
                        JsonSerializer.DeserializeAsyncEnumerable(
                            stream,
                            ResolveJsonTypeInfo(typeof(T), options),
                            cancellationToken
                        )
                    ),
                DeserializeAsyncEnumerableOverload.UntypedJsonSerializerOptions
            ...
            static async IAsyncEnumerable<T> Cast(
        ...
        private static JsonTypeInfo ResolveJsonTypeInfo(
            Type type,
            JsonSerializerOptions? options = null
        )
        {
