    ...
    public static partial class StreamTests_DeserializeAsyncEnumerable
    {
        ...
        )
        {
            ...
            List<TElement> results = await DeserializeAsyncEnumerableWrapper<TElement>(
                    stream,
                    options,
                    useJsonTypeInfoOverload: useJsonTypeInfoOverload
                )
                .ToListAsync();
        ...
        public static IEnumerable<object[]> GetAsyncEnumerableSources()
        {
            ...
            static object[] WrapArgs<TSource>(
                ...
                int bufferSize,
                bool useJsonTypeInfoOverload
            ) => new object[] { source, bufferSize, useJsonTypeInfoOverload };
        }
        ...
        private static IAsyncEnumerable<T> DeserializeAsyncEnumerableWrapper<T>(
            ...
            bool useJsonTypeInfoOverload = false
        )
        {
