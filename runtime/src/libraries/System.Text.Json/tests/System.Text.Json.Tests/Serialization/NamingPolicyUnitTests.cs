...
namespace System.Text.Json.Serialization.Tests
{
    ...
    {
        private static readonly CamelCaseNamingStrategy s_newtonsoftCamelCaseNamingStrategy = new();
        ...
        public static void ToCamelCaseTest(string expectedResult, string name)
        {
            ...
            string newtonsoftResult = s_newtonsoftCamelCaseNamingStrategy.GetPropertyName(
                name,
                false
            );
