    ...
    public partial class StreamTests
    {
        ...
        public async Task ReadNullArgumentFail()
        {
            await Assert.ThrowsAsync<ArgumentNullException>(async () =>
                await Serializer.DeserializeWrapper<string>((Stream)null)
            );
            await Assert.ThrowsAsync<ArgumentNullException>(async () =>
                await Serializer.DeserializeWrapper((Stream)null, (Type)null)
            );
            await Assert.ThrowsAsync<ArgumentNullException>(async () =>
                await Serializer.DeserializeWrapper((Stream)null, typeof(string))
            );
            await Assert.ThrowsAsync<ArgumentNullException>(async () =>
                await Serializer.DeserializeWrapper(new MemoryStream(), (Type)null)
            );
        }
        ...
        public async Task ReadReferenceTypeCollectionPassingNullValueAsync()
        {
            ...
            {
                IList<object> referenceTypeCollection = await Serializer.DeserializeWrapper<
                    IList<object>
                >(stream);
        ...
        public async Task ReadValueTypeCollectionPassingNullValueAsync()
        {
            using (MemoryStream stream = new MemoryStream("null"u8.ToArray()))
            {
                IList<int> valueTypeCollection = await Serializer.DeserializeWrapper<IList<int>>(
                    stream
                );
        ...
        public static IEnumerable<object[]> BOMTestData =>
            new List<object[]>
            {
                ...
                {
                    new byte[] { 0xEF, 0xBB, 0xBF, 49 },
                    new JsonSerializerOptions { DefaultBufferSize = 2 },
                    1,
                },
                new object[]
                {
                    new byte[] { 0xEF, 0xBB, 0xBF, 49 },
                    new JsonSerializerOptions { DefaultBufferSize = 3 },
                    1,
                },
                new object[]
                {
                    new byte[] { 0xEF, 0xBB, 0xBF, 49 },
                    new JsonSerializerOptions { DefaultBufferSize = 4 },
                    1,
                },
                new object[]
                {
                    new byte[] { 0xEF, 0xBB, 0xBF, 49 },
                    new JsonSerializerOptions { DefaultBufferSize = 15 },
                    1,
                },
                new object[]
                {
                ...
                {
                    new byte[] { 0xEF, 0xBB, 0xBF, 49 },
                    new JsonSerializerOptions { DefaultBufferSize = 16 },
                    1,
                },
                new object[]
                {
                ...
                {
                    new byte[] { 0xEF, 0xBB, 0xBF, 49 },
                    new JsonSerializerOptions { DefaultBufferSize = 17 },
                    1,
                },
                new object[]
                {
        ...
        public async Task TestBOMWithSingleJsonValue(
        ...
        public async Task TestBOMWithNoJsonValue()
        {
            ...
            using (Stream stream = new MemoryStream(utf8BomAndValueArray))
            {
                await Assert.ThrowsAsync<JsonException>(async () =>
                    await Serializer.DeserializeWrapper<byte>(stream)
                );
            }
        }
        ...
        public static IEnumerable<object[]> BOMWithStreamTestData
        {
            get
            {
                foreach (object[] testData in Yield(100, 6601))
                    yield return testData;
                foreach (object[] testData in Yield(200, 13201))
                    yield return testData;
                foreach (object[] testData in Yield(400, 26401))
                    yield return testData;
                foreach (object[] testData in Yield(800, 52801))
                    yield return testData;
                foreach (object[] testData in Yield(1600, 105601))
                    yield return testData;
                ...
                {
                    byte[] objBytes =
                        @"{""Test"":{},""Test2"":[],""Test3"":{""Value"":{}},""PersonType"":0,""Id"":2}"u8.ToArray();
        ...
        public async Task TestBOMWithShortAndLongBuffers(
            Stream stream,
            int count,
        ...
        )
        {
            ...
            void VerifyElement(int index)
            {
                ...
                Assert.Equal(
                    ...
                    value[index].GetProperty("Test3").GetProperty("Value").ValueKind
                );
                Assert.False(
                    value[index]
                        .GetProperty("Test3")
        ...
        public async Task ReadPrimitiveWithWhitespaceAndThenInvalid(int bufferSize)
        {
            ...
            using (MemoryStream stream = new MemoryStream(data))
            {
                JsonException ex = await Assert.ThrowsAsync<JsonException>(async () =>
                    await Serializer.DeserializeWrapper<int>(stream, options)
                );
        ...
        public async Task ReadObjectWithWhitespaceAndThenInvalid(int bufferSize)
        {
            ...
            {
                JsonException ex = await Assert.ThrowsAsync<JsonException>(async () =>
                    await Serializer.DeserializeWrapper<SimpleTestClass>(stream, options)
                );
                Assert.Equal(16387, stream.Position);
