    ...
    public partial class Utf8JsonWriterTests
    {
        ...
        public static void WriteRawValidJson(byte[] rawJson, Action<byte[]> verifyWithDeserialize)
        {
            ...
            void RunTests(bool skipInputValidation)
            {
                ...
                writer.Reset();
                ms.SetLength(0);
                WriteRawValueWithSetting(
                    writer,
                    rawJsonAsStr,
                    OverloadParamType.ByteArray,
                    skipInputValidation
                );
                writer.Flush();
        ...
        public static IEnumerable<object[]> GetObjects()
        {
            ...
            validate = (data) =>
            {
                KeyValuePair<string, string> kvp = JsonSerializer
        ...
        public static void WriteRawArrayElements(
        ...
        public static void WriteRawObjectProperty(
            bool skipInputValidation,
            int numElements,
            string expectedJson
        )
        ...
        public static void WriteRawHonorSkipValidation(bool skipValidation)
        {
            ...
            void RunTest(bool skipInputValidation)
            {
                ...
                if (skipValidation)
                {
                    ...
                    writer.Flush();
                    Assert.True(
                        ms.ToArray().SequenceEqual(new byte[] { (byte)'{', (byte)'{', (byte)'}' })
                    );
                }
                else
                {
        ...
        private static ReadOnlySequence<byte> CreateLargeReadOnlySequence(long len)
        {
            ...
            var readonlySeq = new ReadOnlySequence<byte>(
                startSegment,
                0,
                endSegment,
                endSegment.Memory.Length
            );
