    ...
    public static class Net80RegressionTests
    {
        ...
        public static void SupportedTypeRoundtrip_OptionsBased<T>(T value, string expectedJson)
        {
            ...
            T deserializedValue = JsonSerializer.Deserialize<T>(
                json,
                Net80GeneratedContext.Default.Options
            );
        ...
        public static void UnsupportedType_ThrowsInvalidOperationException()
        {
            ...
            Assert.Throws<InvalidOperationException>(
                () =>
                    JsonSerializer.Serialize(value, value.GetType(), Net80GeneratedContext.Default)
            );
            Assert.Throws<InvalidOperationException>(
                () =>
                    JsonSerializer.Deserialize(json, value.GetType(), Net80GeneratedContext.Default)
            );
        }
        ...
        public static void CombinedContexts_WorksAsExpected()
        {
            ...
            string expected = JsonSerializer.Serialize(
                new HighLowTemps(),
                Net80GeneratedContext.Default.HighLowTemps
            );
