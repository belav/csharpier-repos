...
namespace System.Text.Json.Tests
{
    public static partial class Utf8JsonReaderTests
    {
        ...
        public static void DefaultUtf8JsonReader()
        {
            ...
            JsonTestHelper.AssertThrows<InvalidOperationException>(
                ref json,
                (ref Utf8JsonReader jsonReader) => jsonReader.ValueTextEquals("")
            );
            JsonTestHelper.AssertThrows<InvalidOperationException>(
                ref json,
                (ref Utf8JsonReader jsonReader) => jsonReader.ValueTextEquals("".AsSpan())
            );
            JsonTestHelper.AssertThrows<InvalidOperationException>(
                ref json,
                (ref Utf8JsonReader jsonReader) =>
                    jsonReader.ValueTextEquals(default(ReadOnlySpan<char>))
            );
            JsonTestHelper.AssertThrows<InvalidOperationException>(
                ref json,
                (ref Utf8JsonReader jsonReader) =>
                    jsonReader.ValueTextEquals(default(ReadOnlySpan<byte>))
            );
        ...
        private static void TestGetMethodsOnDefault()
        {
            ...
            JsonTestHelper.AssertThrows<InvalidOperationException>(
                ref json,
                (ref Utf8JsonReader jsonReader) => jsonReader.TryGetByte(out _)
            );
            JsonTestHelper.AssertThrows<InvalidOperationException>(
                ref json,
                (ref Utf8JsonReader jsonReader) => jsonReader.GetByte()
            );

            json = default;
            JsonTestHelper.AssertThrows<InvalidOperationException>(
                ref json,
                (ref Utf8JsonReader jsonReader) => jsonReader.GetComment()
            );

            json = default;
            JsonTestHelper.AssertThrows<InvalidOperationException>(
                ref json,
                (ref Utf8JsonReader jsonReader) => jsonReader.TryGetDateTime(out _)
            );
            JsonTestHelper.AssertThrows<InvalidOperationException>(
                ref json,
            ...
            JsonTestHelper.AssertThrows<InvalidOperationException>(
                ref json,
                (ref Utf8JsonReader jsonReader) => jsonReader.TryGetDateTimeOffset(out _)
            );
            JsonTestHelper.AssertThrows<InvalidOperationException>(
                ref json,
            ...
            JsonTestHelper.AssertThrows<InvalidOperationException>(
                ref json,
                (ref Utf8JsonReader jsonReader) => jsonReader.TryGetDecimal(out _)
            );
            JsonTestHelper.AssertThrows<InvalidOperationException>(
                ref json,
                (ref Utf8JsonReader jsonReader) => jsonReader.GetDecimal()
            );

            json = default;
            JsonTestHelper.AssertThrows<InvalidOperationException>(
                ref json,
                (ref Utf8JsonReader jsonReader) => jsonReader.TryGetDouble(out _)
            );
            JsonTestHelper.AssertThrows<InvalidOperationException>(
                ref json,
                (ref Utf8JsonReader jsonReader) => jsonReader.GetDouble()
            );

            json = default;
            JsonTestHelper.AssertThrows<InvalidOperationException>(
                ref json,
                (ref Utf8JsonReader jsonReader) => jsonReader.TryGetInt16(out _)
            );
            JsonTestHelper.AssertThrows<InvalidOperationException>(
                ref json,
                (ref Utf8JsonReader jsonReader) => jsonReader.GetInt16()
            );

            json = default;
            JsonTestHelper.AssertThrows<InvalidOperationException>(
                ref json,
                (ref Utf8JsonReader jsonReader) => jsonReader.TryGetInt32(out _)
            );
            JsonTestHelper.AssertThrows<InvalidOperationException>(
                ref json,
                (ref Utf8JsonReader jsonReader) => jsonReader.GetInt32()
            );

            json = default;
            JsonTestHelper.AssertThrows<InvalidOperationException>(
                ref json,
                (ref Utf8JsonReader jsonReader) => jsonReader.TryGetInt64(out _)
            );
            JsonTestHelper.AssertThrows<InvalidOperationException>(
                ref json,
                (ref Utf8JsonReader jsonReader) => jsonReader.GetInt64()
            );

            json = default;
            JsonTestHelper.AssertThrows<InvalidOperationException>(
                ref json,
                (ref Utf8JsonReader jsonReader) => jsonReader.TryGetSByte(out _)
            );
            JsonTestHelper.AssertThrows<InvalidOperationException>(
                ref json,
                (ref Utf8JsonReader jsonReader) => jsonReader.GetSByte()
            );

            json = default;
            JsonTestHelper.AssertThrows<InvalidOperationException>(
                ref json,
                (ref Utf8JsonReader jsonReader) => jsonReader.TryGetSingle(out _)
            );
            JsonTestHelper.AssertThrows<InvalidOperationException>(
                ref json,
                (ref Utf8JsonReader jsonReader) => jsonReader.GetSingle()
            );

            json = default;
            JsonTestHelper.AssertThrows<InvalidOperationException>(
                ref json,
                (ref Utf8JsonReader jsonReader) => jsonReader.TryGetUInt16(out _)
            );
            JsonTestHelper.AssertThrows<InvalidOperationException>(
                ref json,
                (ref Utf8JsonReader jsonReader) => jsonReader.GetUInt16()
            );

            json = default;
            JsonTestHelper.AssertThrows<InvalidOperationException>(
                ref json,
                (ref Utf8JsonReader jsonReader) => jsonReader.TryGetUInt32(out _)
            );
            JsonTestHelper.AssertThrows<InvalidOperationException>(
                ref json,
                (ref Utf8JsonReader jsonReader) => jsonReader.GetUInt32()
            );

            json = default;
            JsonTestHelper.AssertThrows<InvalidOperationException>(
                ref json,
                (ref Utf8JsonReader jsonReader) => jsonReader.TryGetUInt64(out _)
            );
            JsonTestHelper.AssertThrows<InvalidOperationException>(
                ref json,
                (ref Utf8JsonReader jsonReader) => jsonReader.GetUInt64()
            );
            ...
            JsonTestHelper.AssertThrows<InvalidOperationException>(
                ref json,
                (ref Utf8JsonReader jsonReader) => jsonReader.CopyString(new byte[16])
            );
            JsonTestHelper.AssertThrows<InvalidOperationException>(
                ref json,
                (ref Utf8JsonReader jsonReader) => jsonReader.CopyString(new char[16])
            );

            json = default;
            JsonTestHelper.AssertThrows<InvalidOperationException>(
                ref json,
                (ref Utf8JsonReader jsonReader) => jsonReader.GetBoolean()
            );
        }
        ...
        public static void StateRecovery()
        {
            ...
            json = new Utf8JsonReader(
                utf8.Slice((int)json.BytesConsumed),
                isFinalBlock: true,
                state
            );
    ...
    ""array"": [
        ...
        public static void ValueIsEscaped_IsFalseOnTokensWithoutEscaping(
            string json,
        ...
        [InlineData("[]")]
        [InlineData("/* comment */ null", JsonCommentHandling.Allow)]
        public static void ValueIsEscaped_AfterEscapedStrings_IsFalseOnNonEscapedTokens(
            string jsonValue,
            JsonCommentHandling commentHandling = default
        )
        {
        ...
        [InlineData("[]")]
        [InlineData("/* comment */ null", JsonCommentHandling.Allow)]
        public static void ValueIsEscaped_AfterEscapedPropertyNames_IsFalseOnNonEscapedTokens(
            string jsonValue,
            JsonCommentHandling commentHandling = default
        )
        {
