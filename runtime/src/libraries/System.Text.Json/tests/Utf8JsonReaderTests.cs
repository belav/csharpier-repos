...
namespace System.Text.Json.Tests
{
    public static partial class Utf8JsonReaderTests
    {
        ...
        public static void DefaultUtf8JsonReader()
        {
            ...
            JsonTestHelper.AssertThrows<InvalidOperationException>(
                json,
                (jsonReader) => jsonReader.ValueTextEquals("")
            );
            JsonTestHelper.AssertThrows<InvalidOperationException>(
                json,
                (jsonReader) => jsonReader.ValueTextEquals("".AsSpan())
            );
            JsonTestHelper.AssertThrows<InvalidOperationException>(
                json,
                (jsonReader) => jsonReader.ValueTextEquals(default(ReadOnlySpan<char>))
            );
            JsonTestHelper.AssertThrows<InvalidOperationException>(
                json,
                (jsonReader) => jsonReader.ValueTextEquals(default(ReadOnlySpan<byte>))
            );
        ...
        private static void TestGetMethodsOnDefault()
        {
            ...
            JsonTestHelper.AssertThrows<InvalidOperationException>(
                json,
                (jsonReader) => jsonReader.TryGetByte(out _)
            );
            JsonTestHelper.AssertThrows<InvalidOperationException>(
                json,
                (jsonReader) => jsonReader.GetByte()
            );

            json = default;
            JsonTestHelper.AssertThrows<InvalidOperationException>(
                json,
                (jsonReader) => jsonReader.GetComment()
            );

            json = default;
            JsonTestHelper.AssertThrows<InvalidOperationException>(
                json,
                (jsonReader) => jsonReader.TryGetDateTime(out _)
            );
            JsonTestHelper.AssertThrows<InvalidOperationException>(
                json,
                (jsonReader) => jsonReader.GetDateTime()
            );

            json = default;
            JsonTestHelper.AssertThrows<InvalidOperationException>(
                json,
                (jsonReader) => jsonReader.TryGetDateTimeOffset(out _)
            );
            JsonTestHelper.AssertThrows<InvalidOperationException>(
                json,
                (jsonReader) => jsonReader.GetDateTimeOffset()
            );

            json = default;
            JsonTestHelper.AssertThrows<InvalidOperationException>(
                json,
                (jsonReader) => jsonReader.TryGetDecimal(out _)
            );
            JsonTestHelper.AssertThrows<InvalidOperationException>(
                json,
                (jsonReader) => jsonReader.GetDecimal()
            );

            json = default;
            JsonTestHelper.AssertThrows<InvalidOperationException>(
                json,
                (jsonReader) => jsonReader.TryGetDouble(out _)
            );
            JsonTestHelper.AssertThrows<InvalidOperationException>(
                json,
                (jsonReader) => jsonReader.GetDouble()
            );

            json = default;
            JsonTestHelper.AssertThrows<InvalidOperationException>(
                json,
                (jsonReader) => jsonReader.TryGetInt16(out _)
            );
            JsonTestHelper.AssertThrows<InvalidOperationException>(
                json,
                (jsonReader) => jsonReader.GetInt16()
            );

            json = default;
            JsonTestHelper.AssertThrows<InvalidOperationException>(
                json,
                (jsonReader) => jsonReader.TryGetInt32(out _)
            );
            JsonTestHelper.AssertThrows<InvalidOperationException>(
                json,
                (jsonReader) => jsonReader.GetInt32()
            );

            json = default;
            JsonTestHelper.AssertThrows<InvalidOperationException>(
                json,
                (jsonReader) => jsonReader.TryGetInt64(out _)
            );
            JsonTestHelper.AssertThrows<InvalidOperationException>(
                json,
                (jsonReader) => jsonReader.GetInt64()
            );

            json = default;
            JsonTestHelper.AssertThrows<InvalidOperationException>(
                json,
                (jsonReader) => jsonReader.TryGetSByte(out _)
            );
            JsonTestHelper.AssertThrows<InvalidOperationException>(
                json,
                (jsonReader) => jsonReader.GetSByte()
            );

            json = default;
            JsonTestHelper.AssertThrows<InvalidOperationException>(
                json,
                (jsonReader) => jsonReader.TryGetSingle(out _)
            );
            JsonTestHelper.AssertThrows<InvalidOperationException>(
                json,
                (jsonReader) => jsonReader.GetSingle()
            );

            json = default;
            JsonTestHelper.AssertThrows<InvalidOperationException>(
                json,
                (jsonReader) => jsonReader.TryGetUInt16(out _)
            );
            JsonTestHelper.AssertThrows<InvalidOperationException>(
                json,
                (jsonReader) => jsonReader.GetUInt16()
            );

            json = default;
            JsonTestHelper.AssertThrows<InvalidOperationException>(
                json,
                (jsonReader) => jsonReader.TryGetUInt32(out _)
            );
            JsonTestHelper.AssertThrows<InvalidOperationException>(
                json,
                (jsonReader) => jsonReader.GetUInt32()
            );

            json = default;
            JsonTestHelper.AssertThrows<InvalidOperationException>(
                json,
                (jsonReader) => jsonReader.TryGetUInt64(out _)
            );
            JsonTestHelper.AssertThrows<InvalidOperationException>(
                json,
                (jsonReader) => jsonReader.GetUInt64()
            );

            json = default;
            JsonTestHelper.AssertThrows<InvalidOperationException>(
                json,
                (jsonReader) => jsonReader.GetString()
            );

            json = default;
            JsonTestHelper.AssertThrows<InvalidOperationException>(
                json,
                (jsonReader) => jsonReader.GetBoolean()
            );
        }
        ...
        public static void StateRecovery()
        {
            ...
            json = new Utf8JsonReader(
                utf8.AsSpan((int)json.BytesConsumed),
                isFinalBlock: true,
                state
            );
        ...
        public static void TestJsonReaderUtf8(
            bool compactData,
            TestCaseType type,
            string jsonString
        )
        {
            ...
            result = JsonTestHelper.ReturnBytesHelper(
                dataUtf8,
                out length,
                JsonCommentHandling.Skip
            );
            actualStr = Encoding.UTF8.GetString(result, 0, length);
            resultSequence = JsonTestHelper.SequenceReturnBytesHelper(
                dataUtf8,
                out length,
                JsonCommentHandling.Skip
            );
        ...
        public static void TestPartialLargeJsonReader(
            bool compactData,
            TestCaseType type,
            string jsonString
        )
        {
            ...
            for (int i = 0; i < dataUtf8.Length; i++)
            {
                ...
                byte[] output = JsonTestHelper.ReaderLoop(
                    outputSpan.Length,
                    out int firstLength,
                    ref json
                );
                ...
                json = new Utf8JsonReader(
                    dataUtf8.AsSpan((int)consumed),
                    isFinalBlock: true,
                    json.CurrentState
                );
                output = JsonTestHelper.ReaderLoop(
                    outputSpan.Length - written,
                    out int length,
                    ref json
                );
        ...
        )
        {
            ...
            for (int i = 0; i < dataUtf8.Length; i++)
            {
                ...
                for (long j = consumed; j < dataUtf8.Length - consumed; j++)
                {
                    ...
                    written = firstLength;
                    json = new Utf8JsonReader(
                        dataUtf8.AsSpan((int)consumed, (int)j),
                        isFinalBlock: false,
                        jsonState
                    );
                    output = JsonTestHelper.ReaderLoop(
                    ...
                    json = new Utf8JsonReader(
                        dataUtf8.AsSpan((int)(consumed + consumedInner)),
                        isFinalBlock: true,
                        json.CurrentState
                    );
                    output = JsonTestHelper.ReaderLoop(
    ...
    ""array"": [
        ...
        public static void BasicTrySkipIncomplete(
            string jsonString,
            int readCount,
        ...
        public static void TrySkipPartialAndContinueWithWhiteSpace()
        {
            ...
            reader = new Utf8JsonReader(
                utf8Data.AsSpan(previousConsumed),
                isFinalBlock: true,
                reader.CurrentState
            );
            Assert.True(reader.TrySkip());
                ...
                while (json.TrySkip())
                {
                    Assert.True(
                        json.TokenType != JsonTokenType.PropertyName
                            ...
                            && json.TokenType != JsonTokenType.StartArray
                    );
        ...
        public static void SkipIncomplete(
            string jsonString,
            int numReads,
            JsonTokenType skipTokenType
        )
        {
            byte[] dataUtf8 = Encoding.UTF8.GetBytes(jsonString);
        ...
        {
            string jsonString =
                @"{""propertyName"": {""foo"": ""bar""},""nestedArray"": {""numbers"": [1,2,3]}}";
        ...
        public static void TestPartialJsonReaderWithDepthPadding(
            int depthPadding,
            bool padByObject,
            bool compactData
        )
        {
            ...
            string jsonString =
                builderPrefix.ToString() + SR.FullJsonSchema1 + builderSuffix.ToString();
            ...
            byte[] result = JsonTestHelper.ReturnBytesHelper(
                dataUtf8,
        ...
        [OuterLoop]
        [MemberData(nameof(SpecialNumTestCases))]
        public static void TestPartialJsonReaderSlicesSpecialNumbers(
            TestCaseType type,
            string jsonString
        )
        {
                ...
                for (int i = 0; i < dataUtf8.Length; i++)
                {
                    ...
                    for (long j = consumed; j < dataUtf8.Length - consumed; j++)
                    {
                        ...
                        while (json.Read())
                            ;
                        Assert.Equal(
                            dataUtf8.Length - consumedInner - consumed,
                            json.BytesConsumed
                        );
                    }
                }
        ...
        public static void TestDepth(int depth)
        {
            ...
            )
            {
                ...
                {
                    string jsonStr = JsonTestHelper.WriteDepthObject(
                        i,
        ...
        public static void TestDepthWithObjectArrayMismatch(int depth)
        {
            ...
            )
            {
                for (int i = 0; i < depth; i++)
                {
                    string jsonStr = JsonTestHelper.WriteDepthObjectWithArray(
                        i,
                        commentHandling == JsonCommentHandling.Allow
                    );
                    Span<byte> data = Encoding.UTF8.GetBytes(jsonStr);
        ...
        public static void AllowCommentStackMismatch(
            string jsonString,
        ...
        )
        {
            ...
            )
            {
                ...
                result = JsonTestHelper.SequenceReturnBytesHelper(
                    dataUtf8,
                    out length,
                    commentHandling
                );
            ...
            )
            {
                for (int i = 0; i < dataUtf8.Length; i++)
                {
                    ...
                    while (json.Read())
                    {
                        ...
                        Assert.Equal(
                            expectedString,
                            Encoding.UTF8.GetString(json.ValueSpan.ToArray())
                        );
        ...
        [InlineData(
            "{\"s\u6F22\u5B57trings\":[\"a\u6F22\u5B57bc\", \"def\"], \"ints\":[1, 2, 3, 4, 5]}",
            36,
            36
        )] // "{\"s\u6F22\u5B57trings\":[\"a\u6F22\u5B57bc\", \"def\""
        [InlineData(
            "{\"a\u6F22\u5B57ge\":30, \"name\":\"test}:[]\", \"another \u6F22\u5B57string\" : \"tests\"}",
            25,
            24
        )] // "{\"a\u6F22\u5B57ge\":30, \"name\":\"test}"
        [InlineData(
        ...
        [InlineData(
            "{\"property\\u1234Name\": \"String value with hex: \\uABCD in the middle.\"}",
            51,
            23
        )] // "{\"property\\u1234Name\": \"String value with hex: \\uAB"
        ...
        public static void PartialJson(string jsonString, int splitLocation, int consumed)
        {
            ...
            )
            {
                ...
                json = new Utf8JsonReader(
                    dataUtf8.AsSpan((int)json.BytesConsumed),
                    true,
                    json.CurrentState
                );
                while (json.Read())
            ...
            )
            {
                ...
                var json = new Utf8JsonReader(
                    dataUtf8.AsSpan(0, splitLocation),
                    options: new JsonReaderOptions { CommentHandling = commentHandling }
                );
        ...
        [InlineData("{\r\n\"is\\r\\nAct\u6F22\u5B57ive\": false, 5\r\n}", 31, 30, 1, 29)]
        [InlineData("{\r\n\"is\\r\\nAct\u6F22\u5B57ive\": false, 5\r\n}", 32, 30, 1, 29)]
        public static void InvalidJsonSplitRemainsInvalid(
            string jsonString,
            int splitLocation,
            int consumed,
        ...
        public static void InvalidJsonWhenPartial(
            string jsonString,
            int expectedlineNumber,
            int expectedBytePosition,
            int maxDepth
        ...
        [Theory]
        [InlineData(
            "{\"text\": \"\u0E4F\u0020\u0E2A\u0E27\u0E31\u0E2A\u0E14\u0E35\\uABCZ \u0E42\u0E25\u0E01\"}",
            0,
            37
        )] // * Hello\\uABCZ World in thai
        [InlineData(
            "{\"text\": \"\u0E4F\u0020\u0E2A\u0E39\u0E07\\n\u0E15\u0E48\u0E33\\uABCZ \u0E42\u0E25\u0E01\"}",
            0,
            39
        )] // * High\\nlow\\uABCZ World in thai
        public static void PositionInCodeUnits(
            string jsonString,
            int expectedlineNumber,
            int expectedBytePosition
        )
        ...
        [Theory]
        [MemberData(nameof(InvalidJsonStrings))]
        public static void InvalidJsonSingleSegment(
            string jsonString,
            int expectedlineNumber,
            int expectedBytePosition,
            int maxDepth = 64
        )
        {
            ...
            )
            {
                ...
                for (int i = 0; i < dataUtf8.Length; i++)
                {
                    try
                    {
                        var stateInner = new JsonReaderState(
                            new JsonReaderOptions
                            {
                                CommentHandling = commentHandling,
                                MaxDepth = maxDepth
                        ...
                        Assert.True(
                            false,
                            "Expected JsonException was not thrown with multi-segment data."
                        );
                    }
                    catch (JsonException ex)
                    {
                        ...
                        string secondSegmentString = Encoding.UTF8
                        ...
                        errorMessage =
                            $"expectedBytePosition: {expectedBytePosition} | actual: {ex.BytePositionInLine} | index: {i} | option: {commentHandling}";
                        errorMessage += " | " + firstSegmentString + " | " + secondSegmentString;
        ...
        [InlineData("/*/*/", "/", 5)]
        [InlineData(
            "//T\u6F22\u5B57his is a \u6F22\u5B57comment before json\n\"hello\"",
            "T\u6F22\u5B57his is a \u6F22\u5B57comment before json",
            44
        )]
        [InlineData(
            "\"h\u6F22\u5B57ello\"//This is a \u6F22\u5B57comment after json",
        ...
        [InlineData(
            "\"h\u6F22\u5B57ello\"//This is a \u6F22\u5B57comment after json with new line\n",
        ...
        [InlineData(
            "{\"a\u6F22\u5B57ge\" : 30//This is a \u6F22\u5B57comment between key-value pairs on the same line\n}",
            "This is a \u6F22\u5B57comment between key-value pairs on the same line",
            84
        )]
        [InlineData(
            "/*T\u6F22\u5B57his is a multi-line \u6F22\u5B57comment before json*/\"hello\"",
            "T\u6F22\u5B57his is a multi-line \u6F22\u5B57comment before json",
            56
        )]
        [InlineData(
            "\"h\u6F22\u5B57ello\"/*This is a multi-line \u6F22\u5B57comment after json*/",
            "This is a multi-line \u6F22\u5B57comment after json",
            62
        )]
        [InlineData(
        ...
        [InlineData(
            "/*T\u6F22\u5B57his is a split multi-line \n\u6F22\u5B57comment before json*/\"hello\"",
            "T\u6F22\u5B57his is a split multi-line \n\u6F22\u5B57comment before json",
            63
        )]
        [InlineData(
            "\"h\u6F22\u5B57ello\"/*This is a split multi-line \n\u6F22\u5B57comment after json*/",
        ...
        [InlineData(
            ...
            "This is a split multi-line \n\u6F22\u5B57comment between key-value pairs",
            85
        )]
        [InlineData(
            "{\"a\u6F22\u5B57ge\" : 30/*This is a split multi-line \n\u6F22\u5B57comment between key-value pairs on the same line*/}",
            "This is a split multi-line \n\u6F22\u5B57comment between key-value pairs on the same line",
            103
        )]
        ...
        public static void AllowSingleSegment(
            string jsonString,
        ...
        )
        {
            ...
            for (int i = 0; i < dataUtf8.Length; i++)
            {
                ...
                jsonSlice = new Utf8JsonReader(
                    dataUtf8.AsSpan(consumed),
                    isFinalBlock: true,
                    jsonSlice.CurrentState
                );
            ...
            while (json.Read())
            {
                ...
                switch (tokenType)
                {
                    case JsonTokenType.Comment:
                        Assert.True(
                            false,
                            "TokenType should never be 'Comment' when we are skipping them."
                        );
                        break;
                }
        ...
        public static void CommentsAreInvalidByDefault(
            string jsonString,
            int expectedlineNumber,
        ...
        public static void CommentsAreInvalidByDefaultSingleSegment(
            string jsonString,
            int expectedlineNumber,
            int expectedPosition
        )
        {
            ...
            for (int i = 0; i < dataUtf8.Length; i++)
            {
                ...
                try
                {
                    ...
                    jsonSlice = new Utf8JsonReader(
                        dataUtf8.AsSpan((int)jsonSlice.BytesConsumed),
                        isFinalBlock: true,
                        jsonSlice.CurrentState
                    );
                    while (jsonSlice.Read())
        ...
        [InlineData(
            "{\"age\" : 30//This is a comment between key-value pairs on the same line\n}{",
            1,
            1
        )]
        ...
        [InlineData(
            "{\"age\" : \n/*This is a split multi-line \ncomment between key-value pairs*/ 30}{",
            2,
            37
        )]
        [InlineData(
            "{\"age\" : 30/*This is a split multi-line \ncomment between key-value pairs on the same line*/}{",
            1,
            51
        )]
        [InlineData("//\n\u6F22\u5B57}", 1, 0)]
        ...
        [InlineData(
            "\"g\u6F22\u5B57amma\" \r\n//This is a comment after json\n//Here is another comment\n/*and a multi-line comment*/\u6F22\u5B57{//Another single-line comment",
            3,
            28
        )]
        [InlineData(
        ...
        [InlineData(
            "\"h\u6F22\u5B57ello\"//This is a comment after json with new line\n\u6F22\u5B57{",
            1,
            0
        )]
        [InlineData(
        ...
        [InlineData(
            "{\"a\u6F22\u5B57ge\" : 30//This is a comment between key-value pairs on the same line\n}\u6F22\u5B57{",
            1,
            1
        )]
        [InlineData(
            "/*T\u6F22\u5B57his is a multi-line comment before json*/\"hello\"\u6F22\u5B57{",
            0,
            57
        )]
        [InlineData(
            "\"h\u6F22\u5B57ello\"/*This is a multi-line comment after json*/\u6F22\u5B57{",
            0,
            56
        )]
        [InlineData(
        ...
        [InlineData(
            "{\"a\u6F22\u5B57ge\" : \n/*This is a comment between key-value pairs*/ 30}\u6F22\u5B57{",
            1,
            49
        )]
        [InlineData(
            "{\"a\u6F22\u5B57ge\" : 30/*This is a comment between key-value pairs on the same line*/}\u6F22\u5B57{",
            0,
            80
        )]
        [InlineData(
            "/*T\u6F22\u5B57his is a split multi-line \ncomment before json*/\"hello\"\u6F22\u5B57{",
            1,
            28
        )]
        [InlineData(
            "\"h\u6F22\u5B57ello\"/*This is a split multi-line \ncomment after json*/\u6F22\u5B57{",
            1,
            20
        )]
        [InlineData(
        ...
        [InlineData(
            "{\"a\u6F22\u5B57ge\" : \n/*This is a split multi-line \ncomment between key-value pairs*/ 30}\u6F22\u5B57{",
            2,
            37
        )]
        [InlineData(
            "{\"a\u6F22\u5B57ge\" : 30/*This is a split multi-line \ncomment between key-value pairs on the same line*/}\u6F22\u5B57{",
            1,
            51
        )]
        [InlineData("{   // comment \n   ]", 1, 3)]
        ...
        [InlineData("[   /* comment */   }", 0, 20)]
        public static void InvalidJsonWithComments(
            string jsonString,
            int expectedlineNumber,
            int expectedPosition
        )
        ...
        public static void InvalidJsonWithCommentsSingleSegment(
            string jsonString,
            int expectedlineNumber,
            int expectedPosition
        )
        ...
        [InlineData("//asd\r\n", "asd", 7)]
        [InlineData("//asd\n", "asd", 6)]
        public static void JsonWithASingleCommentEndingWithLineEndingSingleSegment(
            string jsonString,
            string expectedComment,
        ...
        [InlineData("// \u2028\r")]
        [InlineData("// \u2028 \r")]
        public static void JsonWithSingleLineCommentEndingWithNonStandardLineEnding(
            string jsonString
        )
        {
            byte[] dataUtf8 = Encoding.UTF8.GetBytes(jsonString);
        ...
        [InlineData("//\u2069 \u2068 \u2068\n", "\u2069 \u2068 \u2068")]
        [InlineData("// \u2069 \u2068 \u2068 \n", " \u2069 \u2068 \u2068 ")]
        public static void JsonWithSingleCorrectLineCommentWithPartialNonStandardLineEnding(
            string jsonString,
            string expectedComment
        )
        {
        ...
        public static void JsonContainingOnlyCommentsIsInvalid(
            string jsonString,
            int expectedConsumed,
            int expectedLineNumber
        )
        ...
        public static void SkipLotsOfComments(
            string valueString,
            bool insideArray,
        ...
        )
        {
            ...
            {
                Assert.True(json.ValueSequence.IsEmpty);
                bool isTokenPrimitive =
                    json.TokenType >= JsonTokenType.String && json.TokenType <= JsonTokenType.Null;
        ...
        [Theory]
        [MemberData(nameof(LotsOfCommentsTests))]
        public static void ConsumeLotsOfComments(
            string valueString,
            bool insideArray,
            string expectedString
        )
        ...
        private static void TrailingCommasHelperPartial(
            byte[] utf8,
            JsonReaderState state,
            bool expectThrow
        )
        ...
        public static void TestTokenStartIndex_SingleValueCommentsAllow(
            string jsonString,
            int expectedIndex
        )
        {
        ...
        public static void TestTokenStartIndex_SingleValueWithComments(
            string jsonString,
            int expectedIndex
        )
        {
        ...
        public static void TestTokenStartIndex_ComplexArrayValue(
            string jsonString,
            int expectedIndex
        )
        {
        ...
        public static void TestTokenStartIndex_ComplexObjectValue(
            string jsonString,
        ...
        public static void TestTokenStartIndex_ComplexObjectManyValues(
            string jsonString,
            int expectedIndexProperty,
            int expectedIndexValue
        )
        ...
        public static IEnumerable<object[]> GetCommentTestData
        {
            get
            {
                ...
                foreach (string delim in new[] { "\r", "\r\n", "\n" })
                {
                    ...
                    dataList.Add(
                        new object[] { $"{{//{singleLineComment}{delim}}}", singleLineComment }
                    );

                    var multilineComment = $" Multiline {delim} Comment ";
                    dataList.Add(
                        new object[] { $"{{/*{multilineComment}*/{delim}}}", multilineComment }
                    );
                }
                return dataList;
            }
