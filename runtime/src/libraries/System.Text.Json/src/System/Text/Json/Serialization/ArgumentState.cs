...
namespace System.Text.Json
{
    ...
    internal sealed class ArgumentState
    {
        ...
        // When deserializing objects with parameterized ctors asynchronously, the properties we find on the
        // first pass.
        ...
        // For performance, we order the parameters by the first deserialize and PropertyIndex helps find
        // the right slot quicker.
