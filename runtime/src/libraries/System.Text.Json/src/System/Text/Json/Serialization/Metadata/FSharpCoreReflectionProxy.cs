...
namespace System.Text.Json.Serialization.Metadata
{
    ...
    internal sealed class FSharpCoreReflectionProxy
    {
        ...
        private FSharpCoreReflectionProxy(Assembly fsharpCoreAssembly)
        {
            ...
            Type compilationMappingAttributeType = fsharpCoreAssembly
                .GetType(CompilationMappingAttributeTypeName)
                !;
        ...
        private SourceConstructFlags GetSourceConstructFlags(
            ...
            _sourceConstructFlagsGetter is null
                ...
                : (SourceConstructFlags)_sourceConstructFlagsGetter
                      .Invoke(compilationMappingAttribute, null)
                      !;
        ...
        private static TDelegate CreateDelegate<TDelegate>(MethodInfo methodInfo)
            ...
            (TDelegate)Delegate
                .CreateDelegate(typeof(TDelegate), methodInfo, throwOnBindFailure: true)
                !;
