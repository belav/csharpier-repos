...
namespace System.Text.Json.Serialization.Converters
{
    ...
    internal sealed class CastingConverter<T> : JsonConverter<T>
    {
        ...
        internal override bool SupportsCreateObjectDelegate =>
            _sourceConverter.SupportsCreateObjectDelegate;
        ...
        internal CastingConverter(JsonConverter sourceConverter)
        {
            ...
            Debug.Assert(
                sourceConverter.SourceConverterForCastingConverter is null,
                "casting converters should not be layered."
            );
        ...
        public override T? Read(
            ...
            JsonSerializer.UnboxOnRead<T>(
                _sourceConverter.ReadAsObject(ref reader, typeToConvert, options)
            );
        ...
        {
            bool result = _sourceConverter.OnTryReadAsObject(
                ref reader,
                typeToConvert,
                options,
                ref state,
        ...
        public override T ReadAsPropertyName(
            ...
            JsonSerializer.UnboxOnRead<T>(
                _sourceConverter.ReadAsPropertyNameAsObject(ref reader, typeToConvert, options)
            )!;
        ...
        internal override T ReadAsPropertyNameCore(
            ...
            JsonSerializer.UnboxOnRead<T>(
                _sourceConverter.ReadAsPropertyNameCoreAsObject(ref reader, typeToConvert, options)
            )!;
        ...
        internal override void WriteAsPropertyNameCore(
            ...
            _sourceConverter.WriteAsPropertyNameCoreAsObject(
                writer,
                value,
                options,
        ...
        internal override T ReadNumberWithCustomHandling(
            ...
            JsonSerializer.UnboxOnRead<T>(
                _sourceConverter.ReadNumberWithCustomHandlingAsObject(ref reader, handling, options)
            )!;
