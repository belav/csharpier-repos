...
namespace System.Text.Json.Serialization.Converters
{
    ...
    internal sealed class CastingConverter<T, TSource> : JsonConverter<T>
    {
        ...
        {
            bool result = _sourceConverter.OnTryRead(
                ref reader,
                typeToConvert,
                options,
                ref state,
        ...
        internal override void WriteAsPropertyNameCore(
            ...
            _sourceConverter.WriteAsPropertyNameCore(
                writer,
                CastOnWrite(value),
                options,
        ...
        internal override T ReadNumberWithCustomHandling(
            ...
            CastOnRead(
                _sourceConverter.ReadNumberWithCustomHandling(ref reader, handling, options)
            );
