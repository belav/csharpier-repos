...
namespace System.Text.Json
{
    public sealed partial class Utf8JsonWriter
    {
            ...
            Debug.Assert(
                escapedPropertyName.Length
                    < (int.MaxValue / JsonConstants.MaxExpansionFactorWhileTranscoding)
                        - JsonConstants.MaximumFormatInt64Length
                        - 4
            );
        ...
        private void WriteNumberMinimized(ReadOnlySpan<byte> escapedPropertyName, long value)
        {
            Debug.Assert(
                escapedPropertyName.Length
                    < int.MaxValue - JsonConstants.MaximumFormatInt64Length - 4
            );

            int minRequired =
                escapedPropertyName.Length + JsonConstants.MaximumFormatInt64Length + 3; // 2 quotes for property name, and 1 colon
        ...
        private void WriteNumberIndented(ReadOnlySpan<byte> escapedPropertyName, long value)
        {
            ...
            int minRequired =
                indent + escapedPropertyName.Length + JsonConstants.MaximumFormatInt64Length + 4; // 2 quotes for property name, 1 colon, and 1 space
