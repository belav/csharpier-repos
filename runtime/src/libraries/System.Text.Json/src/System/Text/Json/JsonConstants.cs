...
namespace System.Text.Json
{
    internal static partial class JsonConstants
    {
        ...
        public static ReadOnlySpan<byte> NegativeInfinityValue =>
            new byte[]
            {
                (byte)'-',
                (byte)'I',
