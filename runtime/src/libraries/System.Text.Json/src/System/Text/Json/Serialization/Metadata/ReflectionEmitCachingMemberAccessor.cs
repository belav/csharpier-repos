...
namespace System.Text.Json.Serialization.Metadata
{
    ...
    internal sealed partial class ReflectionEmitCachingMemberAccessor : MemberAccessor
    {
        ...
        >() =>
            s_cache.GetOrAdd(
                (nameof(CreateAddMethodDelegate), typeof(TCollection), null),
        ...
        public override Func<object>? CreateParameterlessConstructor(
            ...
            s_cache.GetOrAdd(
                (nameof(CreateParameterlessConstructor), type, ctorInfo),
...
#pragma warning disable IL2077 // The suppression doesn't work for the trim analyzer: https://github.com/dotnet/roslyn/issues/59746
                static (key) =>
                    s_sourceAccessor.CreateParameterlessConstructor(
                        key.declaringType,
                        (ConstructorInfo?)key.member
                    )
            );
#pragma warning restore IL2077
        ...
        public override Func<object, TProperty> CreateFieldGetter<TProperty>(FieldInfo fieldInfo) =>
            s_cache.GetOrAdd(
                (nameof(CreateFieldGetter), typeof(TProperty), fieldInfo),
        ...
        public override Action<object, TProperty> CreateFieldSetter<TProperty>(
            ...
            s_cache.GetOrAdd(
                (nameof(CreateFieldSetter), typeof(TProperty), fieldInfo),
        ...
        > CreateImmutableDictionaryCreateRangeDelegate<TCollection, TKey, TValue>() =>
            s_cache.GetOrAdd(
                (
                    nameof(CreateImmutableDictionaryCreateRangeDelegate),
                    typeof((TCollection, TKey, TValue)),
                    null
                ),
                static (_) =>
                    s_sourceAccessor.CreateImmutableDictionaryCreateRangeDelegate<
                        TCollection,
                        TKey,
                        TValue
                    >()
        ...
        > CreateImmutableEnumerableCreateRangeDelegate<TCollection, TElement>() =>
            s_cache.GetOrAdd(
                (
                    nameof(CreateImmutableEnumerableCreateRangeDelegate),
                    typeof((TCollection, TElement)),
                    null
                ),
                static (_) =>
                    s_sourceAccessor.CreateImmutableEnumerableCreateRangeDelegate<
                        TCollection,
                        TElement
                    >()
            );
        ...
        public override Func<object[], T> CreateParameterizedConstructor<T>(
            ...
            s_cache.GetOrAdd(
                (nameof(CreateParameterizedConstructor), typeof(T), constructor),
                static key =>
                    s_sourceAccessor.CreateParameterizedConstructor<T>((ConstructorInfo)key.member!)
            );
        ...
        >? CreateParameterizedConstructor<T, TArg0, TArg1, TArg2, TArg3>(
            ...
            s_cache.GetOrAdd(
                (nameof(CreateParameterizedConstructor), typeof(T), constructor),
                static key =>
                    s_sourceAccessor.CreateParameterizedConstructor<T, TArg0, TArg1, TArg2, TArg3>(
                        (ConstructorInfo)key.member!
                    )
            );
        ...
        public override Func<object, TProperty> CreatePropertyGetter<TProperty>(
            ...
            s_cache.GetOrAdd(
                (nameof(CreatePropertyGetter), typeof(TProperty), propertyInfo),
                static key =>
                    s_sourceAccessor.CreatePropertyGetter<TProperty>((PropertyInfo)key.member!)
            );
        ...
        public override Action<object, TProperty> CreatePropertySetter<TProperty>(
            ...
            s_cache.GetOrAdd(
                (nameof(CreatePropertySetter), typeof(TProperty), propertyInfo),
                static key =>
                    s_sourceAccessor.CreatePropertySetter<TProperty>((PropertyInfo)key.member!)
            );
    }
}
#endif
