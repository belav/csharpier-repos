...
namespace System.Text.Json
{
    public sealed partial class Utf8JsonWriter
    {
        ...
        private void WriteNumberValueIndented(float value)
        {
            ...
            int maxRequired =
                indent + JsonConstants.MaximumFormatSingleLength + 1 + s_newLineLength; // Optionally, 1 list separator and 1-2 bytes for new line
        ...
        )
        {
            ...
            string utf16Text = value.ToString(
                JsonConstants.SingleFormatString,
