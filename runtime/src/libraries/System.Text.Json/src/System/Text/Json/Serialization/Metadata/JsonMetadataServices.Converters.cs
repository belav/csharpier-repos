...
namespace System.Text.Json.Serialization.Metadata
{
    public static partial class JsonMetadataServices
    {
        ...
        /// <summary>
        /// Returns a <see cref="JsonConverter{T}"/> instance that converts <see cref="DateTimeOffset"/>
        // values.
        /// </summary>
        /// <remarks>This API is for use by the output of the System.Text.Json source generator and should
        // not be called directly.</remarks>
        ...
        /// <remarks>This API is for use by the output of the System.Text.Json source generator and should
        // not be called directly.</remarks>
        public static JsonConverter<Int128> Int128Converter =>
        ...
        // not be called directly.</remarks>
        [CLSCompliant(false)]
        public static JsonConverter<UInt128> UInt128Converter =>
        ...
        public static JsonConverter<JsonArray?> JsonArrayConverter =>
            s_jsonArrayConverter ??= new JsonArrayConverter();
        private static JsonConverter<JsonArray?>? s_jsonArrayConverter;

        /// <summary>
        /// Returns a <see cref="JsonConverter{T}"/> instance that converts <see cref="JsonElement"/>
        // values.
        /// </summary>
        /// <remarks>This API is for use by the output of the System.Text.Json source generator and should
        // not be called directly.</remarks>
        public static JsonConverter<JsonElement> JsonElementConverter =>
            s_jsonElementConverter ??= new JsonElementConverter();
        ...
        public static JsonConverter<JsonNode?> JsonNodeConverter =>
            s_jsonNodeConverter ??= new JsonNodeConverter();
        ...
        public static JsonConverter<JsonObject?> JsonObjectConverter =>
            s_jsonObjectConverter ??= new JsonObjectConverter();
        ...
        public static JsonConverter<JsonValue?> JsonValueConverter =>
            s_jsonValueConverter ??= new JsonValueConverter();
        private static JsonConverter<JsonValue?>? s_jsonValueConverter;

        /// <summary>
        /// Returns a <see cref="JsonConverter{T}"/> instance that converts <see cref="JsonDocument"/>
        // values.
        /// </summary>
        /// <remarks>This API is for use by the output of the System.Text.Json source generator and should
        // not be called directly.</remarks>
        public static JsonConverter<JsonDocument?> JsonDocumentConverter =>
            s_jsonDocumentConverter ??= new JsonDocumentConverter();
        private static JsonConverter<JsonDocument?>? s_jsonDocumentConverter;

        /// <summary>
        /// Returns a <see cref="JsonConverter{T}"/> instance that converts <see cref="Memory{Byte}"/>
        // values.
        /// </summary>
        /// <remarks>This API is for use by the output of the System.Text.Json source generator and should
        // not be called directly.</remarks>
        ...
        /// <summary>
        /// Returns a <see cref="JsonConverter{T}"/> instance that converts <see
        // cref="ReadOnlyMemory{Byte}"/> values.
        /// </summary>
        /// <remarks>This API is for use by the output of the System.Text.Json source generator and should
        // not be called directly.</remarks>
        ...
        /// <summary>
        /// Creates a <see cref="JsonConverter{T}"/> instance that throws <see
        // cref="NotSupportedException"/>.
        /// </summary>
        /// <typeparam name="T">The generic definition for the type.</typeparam>
        /// <returns>A <see cref="JsonConverter{T}"/> instance that throws <see
        // cref="NotSupportedException"/></returns>
        /// <remarks>This API is for use by the output of the System.Text.Json source generator and should
        // not be called directly.</remarks>
        ...
        /// <param name="options">The <see cref="JsonSerializerOptions"/> to use for serialization and
        // deserialization.</param>
        /// <returns>A <see cref="JsonConverter{T}"/> instance that converts <typeparamref name="T"/>
        // values.</returns>
        /// <remarks>This API is for use by the output of the System.Text.Json source generator and should
        // not be called directly.</remarks>
        ...
        /// <summary>
        /// Creates a <see cref="JsonConverter{T}"/> instance that converts <typeparamref name="T?"/>
        // values.
        /// </summary>
        /// <typeparam name="T">The generic definition for the underlying nullable type.</typeparam>
        /// <param name="underlyingTypeInfo">Serialization metadata for the underlying nullable
        // type.</param>
        /// <returns>A <see cref="JsonConverter{T}"/> instance that converts <typeparamref name="T?"/>
        // values</returns>
        /// <remarks>This API is for use by the output of the System.Text.Json source generator and should
            ...
            where T : struct
        {
            ...
            JsonConverter<T> underlyingConverter = GetTypedConverter<T>(
        ...
        internal static JsonConverter<T> GetTypedConverter<T>(JsonConverter converter)
        {
            ...
            if (typedConverter == null)
            {
                throw new InvalidOperationException(
                    SR.Format(SR.SerializationConverterNotCompatible, typedConverter, typeof(T))
                );
            }
