...
namespace System.Text.Json
{
    public sealed partial class Utf8JsonWriter
    {
        ...
        private void WriteStringMinimized(ReadOnlySpan<byte> escapedPropertyName, Guid value)
        {
            Debug.Assert(
                escapedPropertyName.Length
                    < int.MaxValue - JsonConstants.MaximumFormatGuidLength - 6
            );

            int minRequired =
                escapedPropertyName.Length + JsonConstants.MaximumFormatGuidLength + 5; // 2 quotes for property name, 2 quotes for date, and 1 colon
        ...
        private void WriteStringIndented(ReadOnlySpan<byte> escapedPropertyName, Guid value)
        {
            ...
            int minRequired =
                indent + escapedPropertyName.Length + JsonConstants.MaximumFormatGuidLength + 6; // 2 quotes for property name, 2 quotes for date, 1 colon, and 1 space
