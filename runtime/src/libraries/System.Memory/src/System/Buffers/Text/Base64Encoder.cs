...
namespace System.Buffers.Text
{
    ...
    public static partial class Base64
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static unsafe void Ssse3Encode(
            ref byte* srcBytes,
            ref byte* destBytes,
            byte* srcEnd,
            int sourceLength,
        ...
        private static ReadOnlySpan<byte> s_encodingMap =>
            new byte[]
            {
                65,
                66,
        ...
        private static ReadOnlySpan<sbyte> s_sseEncodeShuffleVec =>
            new sbyte[] { 1, 0, 2, 1, 4, 3, 5, 4, 7, 6, 8, 7, 10, 9, 11, 10 };

        private static ReadOnlySpan<sbyte> s_sseEncodeLut =>
            new sbyte[] { 65, 71, -4, -4, -4, -4, -4, -4, -4, -4, -4, -4, -19, -16, 0, 0 };

        private static ReadOnlySpan<sbyte> s_avxEncodePermuteVec =>
            new sbyte[]
            {
                0,
                0,
        ...
        private static ReadOnlySpan<sbyte> s_avxEncodeShuffleVec =>
            new sbyte[]
            {
                5,
                4,
        ...
        private static ReadOnlySpan<sbyte> s_avxEncodeLut =>
            new sbyte[]
            {
                65,
                71,
