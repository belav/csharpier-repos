...
namespace System.Buffers.Binary.Tests
{
    public class BinaryWriterUnitTests
    {
        ...
        public void SpanWriteFail()
        {
            ...
            TestHelpers.AssertThrows<ArgumentException, byte>(span, (_span) =>
                MemoryMarshal.Write<TestHelpers.TestValueTypeWithReference>(_span, in structValue)
            );
            TestHelpers.AssertThrows<ArgumentException, byte>(span, (_span) =>
