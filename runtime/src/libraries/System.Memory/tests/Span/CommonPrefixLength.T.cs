...
namespace System.SpanTests
{
    public static class CommonPrefixLengthTests
    {
        ...
        {
            ValidateWithDefaultValues(
                length1,
                length2,
                NonDefaultEqualityComparer<char>.Instance,
                0
            );
        }
        ...
        private static void ValidateWithDefaultValues<T>(
            int length1,
            int length2,
        ...
        )
        {
            Assert.Equal(
                expected,
                MemoryExtensions.CommonPrefixLength((ReadOnlySpan<T>)new T[length1], new T[length2])
            );
            Assert.Equal(
                expected,
                MemoryExtensions.CommonPrefixLength(
                    (ReadOnlySpan<T>)new T[length1],
                    new T[length2],
                    null
                )
            );
            ...
            Assert.Equal(
                expected,
                MemoryExtensions.CommonPrefixLength((Span<T>)new T[length1], new T[length2])
            );
            Assert.Equal(
                expected,
                MemoryExtensions.CommonPrefixLength((Span<T>)new T[length1], new T[length2], null)
            );
            Assert.Equal(
                expected,
                MemoryExtensions.CommonPrefixLength(
                    (Span<T>)new T[length1],
                    new T[length2],
                    EqualityComparer<T>.Default
                )
            );
        ...
        public static void PartialEquals_ReturnsPrefixLength_Byte()
        {
            ...
            Assert.Equal(
                3,
                MemoryExtensions.CommonPrefixLength((ReadOnlySpan<byte>)arr1, arr2, null)
            );
            Assert.Equal(
                3,
                MemoryExtensions.CommonPrefixLength(
                    (ReadOnlySpan<byte>)arr1,
                    arr2,
            ...
            Assert.Equal(
                ...
                MemoryExtensions.CommonPrefixLength(
                    (ReadOnlySpan<byte>)arr1,
                    arr2,
                    NonDefaultEqualityComparer<byte>.Instance
                )
            );
        ...
        public static void PartialEquals_ReturnsPrefixLength_ValueType()
        {
            ...
            Assert.Equal(
                2,
                MemoryExtensions.CommonPrefixLength((ReadOnlySpan<int>)arr1, arr2, null)
            );
            Assert.Equal(
                2,
                MemoryExtensions.CommonPrefixLength(
                    (ReadOnlySpan<int>)arr1,
                    arr2,
            ...
            Assert.Equal(
                ...
                MemoryExtensions.CommonPrefixLength(
                    (ReadOnlySpan<int>)arr1,
                    arr2,
                    NonDefaultEqualityComparer<int>.Instance
                )
            );
        ...
        public static void PartialEquals_ReturnsPrefixLength_ReferenceType()
        {
            ...
            Assert.Equal(
                4,
                MemoryExtensions.CommonPrefixLength((ReadOnlySpan<string>)arr1, arr2, null)
            );
            Assert.Equal(
                4,
                MemoryExtensions.CommonPrefixLength(
                    (ReadOnlySpan<string>)arr1,
                    arr2,
        ...
        public static void Comparer_UsedInComparisons_ValueType()
        {
            ...
            EqualityComparer<int> absoluteValueComparer = EqualityComparer<int>.Create(
            ...
            Assert.Equal(
                4,
                MemoryExtensions.CommonPrefixLength((Span<int>)arr1, arr2, absoluteValueComparer)
            );
        ...
        {
            public static EqualityComparer<T> Instance { get; } =
                EqualityComparer<T>.Create((x, y) => EqualityComparer<T>.Default.Equals(x, y));
        }
    }
}
