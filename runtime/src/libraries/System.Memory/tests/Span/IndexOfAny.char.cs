...
namespace System.SpanTests
{
    partial public static class SpanTests
    {
        ...
        private static int IndexOf(Span<char> span, char value)
        {
            ...
            Assert.Equal(
                index,
                span.IndexOfAny(IndexOfAnyValues.Create(stackalloc char[] { value }))
            );
            return index;
        }
        ...
        private static int IndexOfAny(Span<char> span, char value0, char value1)
        {
            ...
            Assert.Equal(
                index,
                span.IndexOfAny(IndexOfAnyValues.Create(stackalloc char[] { value0, value1 }))
            );
            return index;
        }
        ...
        private static int IndexOfAny(Span<char> span, char value0, char value1, char value2)
        {
            ...
            Assert.Equal(
                index,
                span.IndexOfAny(
                    IndexOfAnyValues.Create(stackalloc char[] { value0, value1, value2 })
                )
            );
            return index;
        }
