...
namespace System.Text.Tests
{
    public class EncodingExtensionsTests
    {
        ...
        public static void Convert_Decoder_ReadOnlySequence_Single_Sliced()
        {
            ...
            ReadOnlySequence<byte> inputData = SequenceFactory
                .Create(new byte[] { 0x00, 0x20, 0x61, 0xC2, 0x80, 0xED, 0x9F, 0xBF })
                .Slice(1);
            EncodingExtensions.Convert(
                decoder,
                inputData,
            ...
            inputData = SequenceFactory.Create(new byte[] { 0x00, 0xF4, 0x80 }).Slice(1);
            EncodingExtensions.Convert(
                decoder,
                inputData,
                writer,
            ...
            inputData = SequenceFactory.Create(new byte[] { 0x00, 0x80, 0x80, 0xC2 }).Slice(1);
            EncodingExtensions.Convert(
                decoder,
                inputData,
                writer,
        ...
        public static void Convert_Encoder_ReadOnlySequence_Single_Sliced()
        {
            ...
            ReadOnlySequence<char> inputData = SequenceFactory
                .Create(new char[] { ' ', '\u0020', '\ud7ff' })
                .Slice(1);
            EncodingExtensions.Convert(
                encoder,
            ...
            inputData = SequenceFactory.Create(new char[] { ' ', '\udbc0' }).Slice(1);
            EncodingExtensions.Convert(
                encoder,
                inputData,
                writer,
        ...
        public static void GetBytes_Encoding_ReadOnlySequence()
        {
            ...
            Assert.Equal(
                "\u0020\u0061\u0080\U00010000\U0010FFFF\ufffd"u8.ToArray(),
                EncodingExtensions.GetBytes(Encoding.UTF8, sequence)
            );
        }
