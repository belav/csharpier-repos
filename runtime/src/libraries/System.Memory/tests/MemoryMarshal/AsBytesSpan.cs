...
namespace System.SpanTests
{
    public static partial class MemoryMarshalTests
    {
        ...
        public static void Span_AsBytesUIntToByte()
        {
            ...
            Assert.True(
                Unsafe.AreSame<byte>(
                    ref Unsafe.As<uint, byte>(ref MemoryMarshal.GetReference(span)),
                    ref MemoryMarshal.GetReference(asBytes)
                )
            );
        ...
        {
            Span<TestHelpers.StructWithReferences> span =
                new Span<TestHelpers.StructWithReferences>(
