...
namespace System.SpanTests
{
    public static partial class ReadOnlySpanTests
    {
        public static readonly TheoryData<(
            ...
            uint Value,
            int ExpectedIndex
        )> s_casesUInt = new TheoryData<(uint[] Array, uint Value, int ExpectedIndex)>
        {
            (new uint[] { }, 0u, -1),
            (new uint[] { 1u }, 0u, -1),
            (new uint[] { 1u }, 1u, 0),
        ...
        public static readonly TheoryData<(
            ...
            double Value,
            int ExpectedIndex
        )> s_casesDouble = new TheoryData<(double[] Array, double Value, int ExpectedIndex)>
        {
            (new double[] { }, 0.0, -1),
        ...
        public static readonly TheoryData<(
            ...
            string Value,
            int ExpectedIndex
        )> s_casesString = new TheoryData<(string[] Array, string Value, int ExpectedIndex)>
        {
            (new string[] { }, "a", -1),
            (new string[] { "b" }, "a", -1),
            (new string[] { "b" }, "b", 0),
        ...
        public static void BinarySearch_UInt((uint[] Array, uint Value, int ExpectedIndex) testCase)
        {
        ...
        // NOTE: BinarySearch_MaxLength_NoOverflow test is constrained to run on Windows and MacOSX because
        // it causes
        ...
        public static unsafe void BinarySearch_MaxLength_NoOverflow()
        {
            if (sizeof(IntPtr) == sizeof(long))
            {
                ...
                {
                    Console.WriteLine(
                        $"Span.BinarySearch test {nameof(BinarySearch_MaxLength_NoOverflow)} skipped (could not alloc memory)."
                    );
                    return;
                }
                try
