    ...
    public class FormatterTests
    {
        ...
        public void DefaultCtor_ObjectsInitialized()
        {
            ...
            AssertExtensions.Throws<ArgumentNullException>(
                "obj",
                () => f.m_idGenerator.GetId(null, out firstTime)
            );
            AssertExtensions.Throws<ArgumentNullException>(
                "obj",
                () => f.m_idGenerator.HasId(null, out firstTime)
            );
        }
        ...
        public void WriteMember_InvokesProperMethod()
        {
            ...
            // verify("WriteTimeSpan", TimeSpan.FromSeconds(42)); // Fails on both .NET Framework and core,
            // getting routed as a normal ValueType:
