...
namespace DispatchProxyTests
{
    public static class DispatchProxyTests
    {
        ...
        {
            TestType_IHelloService proxy = CreateHelper<TestType_IHelloService, TestDispatchProxy>(
                useGenericCreate
            );
        ...
        {
            TestType_IHelloAndGoodbyeService proxy = CreateHelper<
        ...
        {
            TestType_InternalInterfaceService proxy = CreateHelper<
        ...
        public static void Create_Same_Proxy_Type_And_Base_Type_Reuses_Same_Generated_Type(
            bool useGenericCreate
        )
        {
            TestType_IHelloService proxy1 = CreateHelper<TestType_IHelloService, TestDispatchProxy>(
                useGenericCreate
            );
            TestType_IHelloService proxy2 = CreateHelper<TestType_IHelloService, TestDispatchProxy>(
                useGenericCreate
            );
        ...
        )
        {
            ...
            TestType_IHelloService proxy2 = CreateHelper<
        ...
        )
        {
            ...
            TestType_IGoodbyeService proxy2 = CreateHelper<
        ...
        )
        {
            AssertExtensions.Throws<ArgumentException>(
                useGenericCreate ? "T" : "interfaceType",
                () => CreateHelper<TestType_ConcreteClass, TestDispatchProxy>(useGenericCreate)
            );
        }
        ...
        {
            AssertExtensions.Throws<ArgumentException>(
                useGenericCreate ? "TProxy" : "proxyType",
                () =>
                    CreateHelper<TestType_IHelloService, Sealed_TestDispatchProxy>(useGenericCreate)
            );
        }
        ...
        )
        {
            AssertExtensions.Throws<ArgumentException>(
                useGenericCreate ? "TProxy" : "proxyType",
                () =>
                    CreateHelper<TestType_IHelloService, Abstract_TestDispatchProxy>(
                        useGenericCreate
                    )
            );
        }
        ...
        [InlineData(false)]
        [InlineData(true)]
        public static void Create_Using_Abstract_Generic_BaseType_Throws_ArgumentException(
            bool useGenericCreate
        )
        {
            AssertExtensions.Throws<ArgumentException>(
                ...
                () =>
                    CreateHelper<
                        TestType_IHelloService,
                        Abstract_GenericDispatchProxy<TestDispatchProxy>
                    >(useGenericCreate)
            );
        }
        ...
        )
        {
            AssertExtensions.Throws<ArgumentException>(
                useGenericCreate ? "TProxy" : "proxyType",
                () =>
                    CreateHelper<TestType_IHelloService, NoDefaultCtor_TestDispatchProxy>(
                        useGenericCreate
                    )
            );
        }
        ...
        {
            Assert.NotNull(
                CreateHelper<TestType_InternalInterfaceService, InternalInvokeProxy>(
                    useGenericCreate
                )
            );
        }
        ...
        {
            Assert.NotNull(
                CreateHelper<TestType_IHelloService, TestType_InternalProxyInternalBaseType>(
                    useGenericCreate
                )
            );
        }
        ...
        public static void Invoke_Receives_Correct_MethodInfo_And_Arguments(bool useGenericCreate)
        {
            ...
            Func<MethodInfo, object[], object> invokeCallback = (method, args) =>
            {
                ...
                {
                    MethodInfo expectedMethod = typeof(TestType_IHelloService)
                        .GetTypeInfo()
        ...
        )
        {
            ...
            TestType_IMultipleParameterService proxy = CreateHelper<
        ...
        public static void Invoke_Void_Returning_Method_Accepts_Null_Return(bool useGenericCreate)
        {
            ...
            TestType_IOneWay proxy = CreateHelper<TestType_IOneWay, TestDispatchProxy>(
                useGenericCreate
            );
            ((TestDispatchProxy)proxy).CallOnInvoke = (method, args) =>
            {
            ...
            MethodInfo expectedMethod = typeof(TestType_IOneWay)
                .GetTypeInfo()
        ...
        )
        {
            ...
            TestType_IHelloService1And2 proxy = CreateHelper<
            ...
            expectedMethod = typeof(TestType_IHelloService2)
                .GetTypeInfo()
                .GetDeclaredMethod("Hello");
            Assert.True(
        ...
        )
        {
            ...
            TestType_IPropertyService proxy = CreateHelper<
            ...
            PropertyInfo propertyInfo = typeof(TestType_IPropertyService)
                .GetTypeInfo()
        ...
        public static void Proxy_Declares_Interface_Properties(bool useGenericCreate)
        {
            TestType_IPropertyService proxy = CreateHelper<
                ...
                TestDispatchProxy
            >(useGenericCreate);
            PropertyInfo propertyInfo = proxy
                .GetType()
                .GetTypeInfo()
                .GetDeclaredProperty("ReadWrite");
            Assert.NotNull(propertyInfo);
        ...
        public static void Invoke_Event_Add_And_Remove_And_Raise_Invokes_Correct_Methods_Generic_And_Non_Generic_Tests()
        {
            ...
            Invoke_Event_Add_And_Remove_And_Raise_Invokes_Correct_Methods(
                ieventServiceTypeInfo,
                true
            );
            Invoke_Event_Add_And_Remove_And_Raise_Invokes_Correct_Methods(
                ieventServiceTypeInfo,
        ...
        static void Invoke_Event_Add_And_Remove_And_Raise_Invokes_Correct_Methods(
            TypeInfo ieventServiceTypeInfo,
            bool useGenericCreate
        )
        {
            List<MethodInfo> invokedMethods = new List<MethodInfo>();
            ...
            if (useGenericCreate)
            {
                proxy = typeof(DispatchProxy)
                    .GetRuntimeMethod("Create", Type.EmptyTypes)
            ...
            else
            {
                proxy = typeof(DispatchProxy)
                    ...
                    .Invoke(
                        null,
                        new object[] { ieventServiceTypeInfo.AsType(), typeof(TestDispatchProxy) }
                    );
            }
        ...
        {
            TestType_IEventService proxy = CreateHelper<TestType_IEventService, TestDispatchProxy>(
                useGenericCreate
            );
        ...
        )
        {
            ...
            TestType_IIndexerService proxy = CreateHelper<
            ...
            PropertyInfo propertyInfo = typeof(TestType_IIndexerService)
                .GetTypeInfo()
        ...
        public static void Invoke_Ref_Out_In_Method(bool useGenericCreate)
        {
            ...
            TestRefOutInInvocation(
                p => p.InAttribute_OutAttribute(value),
                "Hello",
                useGenericCreate
            );
        ...
        public static void Test_Multiple_AssemblyLoadContexts(bool useGenericCreate)
        {
            ...
            object proxyDefaultAlc = CreateTestDispatchProxy(
                typeof(TestDispatchProxy),
                useGenericCreate
            );
            Assert.True(proxyDefaultAlc.GetType().IsAssignableTo(typeof(TestDispatchProxy)));

            Type proxyCustomAlcType = new AssemblyLoadContext(
                nameof(Test_Multiple_AssemblyLoadContexts)
            )
        ...
        private static TInterface CreateHelper<TInterface, TProxy>(bool useGenericCreate)
