...
namespace System.Reflection
{
    ...
    internal static class DispatchProxyGenerator
    {
        ...
        )
        {
            ...
            {
                if (
                    !s_baseTypeAndInterfaceToGeneratedProxyType.TryGetValue(
                        baseType,
        ...
        private sealed class ProxyBuilder
        {
            ...
            {
                public static readonly MethodInfoEqualityComparer Instance =
                ...
                public sealed override bool Equals(MethodInfo? left, MethodInfo? right)
                {
                    ...
                    for (int i = 0; i < leftParameters.Length; i++)
                    {
                        if (
                            !Equals(
                                leftParameters[i].ParameterType,
                                rightParameters[i].ParameterType
                            )
                        )
                            return false;
                    }
