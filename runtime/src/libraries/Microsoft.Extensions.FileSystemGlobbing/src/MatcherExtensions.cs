...
namespace Microsoft.Extensions.FileSystemGlobbing
{
    ...
    {
        /// <summary>
        /// Adds multiple exclude patterns to <see cref="Matcher" />. <seealso
        // cref="Matcher.AddExclude(string)" />
        /// </summary>
        ...
        /// <summary>
        /// Adds multiple patterns to include in <see cref="Matcher" />. See <seealso
        // cref="Matcher.AddInclude(string)" />
        /// </summary>
        ...
        /// <summary>
        /// Searches the directory specified for all files matching patterns added to this instance of <see
        // cref="Matcher" />
        /// </summary>
        /// <param name="matcher">The matcher</param>
        /// <param name="directoryPath">The root directory for the search</param>
        /// <returns>Absolute file paths of all files matched. Empty enumerable if no files matched given
        // patterns.</returns>
