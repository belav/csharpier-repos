...
namespace Microsoft.Extensions.FileSystemGlobbing
{
    ...
    public class InMemoryDirectoryInfo : DirectoryInfoBase
    {
        ...
        private InMemoryDirectoryInfo(string rootDir, IEnumerable<string> files, bool normalized)
        {
            ...
            else
            {
                ...
                FullName = Path.GetFullPath(
                    rootDir.Replace(Path.AltDirectorySeparatorChar, Path.DirectorySeparatorChar)
                );
            }
        }
        ...
        {
            get { return new InMemoryDirectoryInfo(Path.GetDirectoryName(FullName), _files, true); }
        }
        ...
        public override DirectoryInfoBase GetDirectory(string path)
        {
            ...
            {
                string normPath = Path.GetFullPath(
