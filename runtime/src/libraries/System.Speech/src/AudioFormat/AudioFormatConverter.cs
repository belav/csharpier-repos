    ...
    internal static class AudioFormatConverter
    {
        ...
        internal static SpeechAudioFormatInfo ToSpeechAudioFormatInfo(IntPtr waveFormatPtr)
        {
            ...
            return new SpeechAudioFormatInfo(
                (EncodingFormat)waveFormatEx.wFormatTag,
                (int)waveFormatEx.nSamplesPerSec,
                (short)waveFormatEx.wBitsPerSample,
                (short)waveFormatEx.nChannels,
                (int)waveFormatEx.nAvgBytesPerSec,
                (short)waveFormatEx.nBlockAlign,
                extraData
            );
        }
