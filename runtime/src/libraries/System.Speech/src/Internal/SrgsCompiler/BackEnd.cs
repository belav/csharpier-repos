    ...
    internal sealed partial class Backend
    {
        ...
        internal void Commit(StreamMarshaler streamBuffer)
        {
            ...
            System.Diagnostics.Debug.Assert(
                streamBuffer.Stream.Position - startStreamPostion == header.pszWords
            );
            streamBuffer.WriteArrayChar(_words.SerializeData(), _words.SerializeSize());

            System.Diagnostics.Debug.Assert(
                streamBuffer.Stream.Position - startStreamPostion == header.pszSymbols
            );
            streamBuffer.WriteArrayChar(_symbols.SerializeData(), _symbols.SerializeSize());

            System.Diagnostics.Debug.Assert(
                streamBuffer.Stream.Position - startStreamPostion == header.pRules
            );
            ...
            System.Diagnostics.Debug.Assert(
                streamBuffer.Stream.Position - startStreamPostion == header.pArcs
            );
            ...
            System.Diagnostics.Debug.Assert(
                streamBuffer.Stream.Position - startStreamPostion == header.pWeights
            );
            ...
            System.Diagnostics.Debug.Assert(
                streamBuffer.Stream.Position - startStreamPostion == header.tags
            );
