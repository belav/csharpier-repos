...
#pragma warning restore 0618
            ...
            else
            {
                ...
                if (cfgSerializedHeader.cBasePath > 0)
                {
                    streamHelper.Stream.Position =
                        ...
                        + (header.rules.Length * Marshal.SizeOf(typeof(CfgRule)));
        ...
        )
        {
            ...
            if (pFH.cRules > 0)
            {
                CheckSetOffsets(
                    pFH.pRules,
                    pFH.cRules * Marshal.SizeOf(typeof(CfgRule)),
                    ref ullStartOffset,
                    pFH.ulTotalSerializedSize
                );
            }
            ...
            if (pFH.cArcs > 0)
            {
                CheckSetOffsets(
                    pFH.pArcs,
                    pFH.cArcs * Marshal.SizeOf(typeof(CfgArc)),
                    ref ullStartOffset,
                    pFH.ulTotalSerializedSize
                );
            }
            ...
            if (pFH.pWeights > 0)
            {
                CheckSetOffsets(
                    pFH.pWeights,
                    pFH.cArcs * Marshal.SizeOf(typeof(float)),
                    ref ullStartOffset,
                    pFH.ulTotalSerializedSize
                );
            }
            ...
            if (pFH.cTags > 0)
            {
                CheckSetOffsets(
                    pFH.tags,
                    pFH.cTags * Marshal.SizeOf(typeof(CfgSemanticTag)),
                    ref ullStartOffset,
                    pFH.ulTotalSerializedSize
                );
...
#pragma warning restore 0618
            ...
            if (pFH.cScripts > 0)
            {
                CheckSetOffsets(
                    pFH.pScripts,
                    pFH.cScripts * Marshal.SizeOf(typeof(CfgScriptRef)),
                    ref ullStartOffset,
                    pFH.ulTotalSerializedSize
                );
            }
            ...
            if (pFH.cIL > 0)
            {
                CheckSetOffsets(
                    pFH.pIL,
                    pFH.cIL * Marshal.SizeOf(typeof(byte)),
                    ref ullStartOffset,
                    pFH.ulTotalSerializedSize
                );
            }
            ...
            if (pFH.cPDB > 0)
            {
                CheckSetOffsets(
                    pFH.pPDB,
                    pFH.cPDB * Marshal.SizeOf(typeof(byte)),
                    ref ullStartOffset,
                    pFH.ulTotalSerializedSize
                );
            }
