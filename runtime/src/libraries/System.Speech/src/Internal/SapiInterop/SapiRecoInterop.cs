...
namespace System.Speech.Internal.SapiInterop
{
    ...
    internal enum SPGRAMMAROPTIONS
    {
        ...
        SPGO_SRGS_SCRIPT =
            SPGO_SRGS | SPGO_SRGS_MSS_SCRIPT | SPGO_SRGS_W3C_SCRIPT | SPGO_SRGS_STG_SCRIPT,
    ...
    internal class SPPHRASE
    {
        ...
        /// </summary>
        internal static ISpPhrase CreatePhraseFromText(
            string phrase,
            CultureInfo culture,
        ...
        )
        {
            ...
            {
                wordUnits[i] = new RecognizedWordUnit(
                    null,
                    1.0f,
                    null,
                    words[i],
        ...
        )
        {
            ...
            try
            {
                for (int i = 0; i < words.Length; i++)
                {
                    ...
                    elements[i] = new SPPHRASEELEMENT
                    {
                        ...
                        // Timing information
                        ulAudioTimeOffset = unchecked(
                            (uint)(word._audioPosition.Ticks * 10000 / TimeSpan.TicksPerMillisecond)
                        ),
                    ...
                    Marshal.StructureToPtr<SPPHRASEELEMENT>(
                        elements[i],
                        new IntPtr((long)coMem + size * i),
                        false
                    );
                }
            }
            ...
            spPhrase.Rule = new SPPHRASERULE { ulCountOfElements = (uint)words.Length };
    ...
    internal interface ISpRecoGrammar : ISpGrammarBuilder
    {
        ...
        void LoadDictation(
            [MarshalAs(UnmanagedType.LPWStr)] string pszTopicName,
            SPLOADOPTIONS Options
        );
    ...
    internal interface ISpRecoGrammar2
    {
        ...
        void LoadCmdFromFile2(
            [MarshalAs(UnmanagedType.LPWStr)] string pszFileName,
            SPLOADOPTIONS Options,
            [MarshalAs(UnmanagedType.LPWStr)] string pszSharingUri,
            [MarshalAs(UnmanagedType.LPWStr)] string pszBaseUri
        );
        void LoadCmdFromMemory2(
            IntPtr pGrammar,
            SPLOADOPTIONS Options,
            [MarshalAs(UnmanagedType.LPWStr)] string pszSharingUri,
            [MarshalAs(UnmanagedType.LPWStr)] string pszBaseUri
        ...
        void SetRulePriority(
            [MarshalAs(UnmanagedType.LPWStr)] string pszRuleName,
            uint ulRuleId,
            int nRulePriority
        );
        void SetRuleWeight(
    ...
    internal interface ISpRecoContext2
    {
        ...
        void SetAdaptationData2(
            [MarshalAs(UnmanagedType.LPWStr)] string pAdaptationData,
            uint cch,
            [MarshalAs(UnmanagedType.LPWStr)] string pTopicName,
    ...
    internal interface ISpProperties
    {
        ...
        int GetPropertyString(
            [MarshalAs(UnmanagedType.LPWStr)] string pName,
            [MarshalAs(UnmanagedType.LPWStr)] out string ppCoMemValue
        );
    }
    ...
    internal interface ISpRecognizer : ISpProperties
    {
        ...
        void SetInput(
            [MarshalAs(UnmanagedType.IUnknown)] object pUnkInput,
            [MarshalAs(UnmanagedType.Bool)] bool fAllowFormatChanges
        );
        ...
        void GetFormat(
            ...
            out Guid pFormatId,
            out IntPtr ppCoMemWFEX
        );
        void IsUISupported(
            [MarshalAs(UnmanagedType.LPWStr)] string pszTypeOfUI,
            IntPtr pvExtraData,
            uint cbExtraData,
    ...
    internal interface ISpeechRecognizer
    {
        ...
        int EmulateRecognition(
            object TextElements,
            ref object ElementDisplayAttributes,
            int LanguageId
        );
    ...
    internal interface ISpPhrase
    {
        ...
        void GetText(
            uint ulStart,
            uint ulCount,
            [MarshalAs(UnmanagedType.Bool)] bool fUseTextReplacements,
            [MarshalAs(UnmanagedType.LPWStr)] out string ppszCoMemText,
    ...
    internal interface ISpRecoResult : ISpPhrase
    {
        ...
        void GetAlternates(
            ...
            int cElements,
            int ulRequestCount,
            [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 2), Out] IntPtr[] ppPhrases,
            out int pcPhrasesReturned
        );
    ...
    internal interface ISpPhraseAlt : ISpPhrase
    {
        ...
        void GetAltInfo(
            ...
            out uint pulStartElementInParent,
            out uint pcElementsInParent,
            out uint pcElementsInAlt
        );
        void Commit();
    }
    ...
    internal interface ISpRecoResult2 : ISpRecoResult
    {
        ...
        void CommitText(
            ...
            [MarshalAs(UnmanagedType.LPWStr)] string pszCorrectedData,
            SPCOMMITFLAGS commitFlags
        );
        void SetTextFeedback(
            [MarshalAs(UnmanagedType.LPWStr)] string pszFeedback,
            [MarshalAs(UnmanagedType.Bool)] bool fSuccessful
        );
    }
    ...
    internal interface ISpXMLRecoResult : ISpRecoResult
    {
        ...
        void GetXMLResult(
            [MarshalAs(UnmanagedType.LPWStr)] out string ppszCoMemXMLResult,
    ...
    {
        void GetDisplayAlternates(
            IntPtr pPhrase,
            uint cRequestCount,
            [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 2), Out] IntPtr[] ppCoMemPhrases,
            out uint pcPhrasesReturned
        );
    }
