    ...
    internal static class AudioFormatConverter
    {
        ...
        internal static short[] Convert(byte[] data, AudioCodec from, AudioCodec to)
        {
            ...
            switch (from)
            {
                case AudioCodec.PCM8:
                    switch (to)
                    {
                        case AudioCodec.PCM16:
                            cnvDlgt = new ConvertByteShort(ConvertLinear8LinearByteShort);
                            break;
                    }
                    break;
                case AudioCodec.PCM16:
                    ...
                    {
                        case AudioCodec.PCM16:
                            cnvDlgt = new ConvertByteShort(ConvertLinear2LinearByteShort);
                            break;
                    }
                    break;
                ...
                case AudioCodec.G711U:
                    ...
                    {
                        case AudioCodec.PCM16:
                            cnvDlgt = new ConvertByteShort(ConvertULaw2Linear);
                            break;
                    }
                    break;
                case AudioCodec.G711A:
                    ...
                    {
                        case AudioCodec.PCM16:
                            cnvDlgt = new ConvertByteShort(ConvertALaw2Linear);
                            break;
                    }
                    break;
        ...
        internal static byte[] Convert(short[] data, AudioCodec from, AudioCodec to)
        {
            ...
            switch (from)
            {
                case AudioCodec.PCM16:
                    ...
                    {
                        case AudioCodec.PCM8:
                            cnvDlgt = new ConvertShortByte(ConvertLinear8LinearShortByte);
                            break;
                        case AudioCodec.PCM16:
                            cnvDlgt = new ConvertShortByte(ConvertLinear2LinearShortByte);
                            break;
                        case AudioCodec.G711U:
                            cnvDlgt = new ConvertShortByte(ConvertLinear2ULaw);
                            break;
                        case AudioCodec.G711A:
                            cnvDlgt = new ConvertShortByte(ConvertLinear2ALaw);
                            break;
                    }
                    break;
        ...
        internal static byte[] ConvertLinear2ULaw(short[] data, int size)
        {
            ...
            s_uLawCompTableCached =
                s_uLawCompTableCached == null ? CalcLinear2ULawTable() : s_uLawCompTableCached;
        ...
        internal static byte[] ConvertLinear2ALaw(short[] data, int size)
        {
            ...
            s_aLawCompTableCached =
                s_aLawCompTableCached == null ? CalcLinear2ALawTable() : s_aLawCompTableCached;
