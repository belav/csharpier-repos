...
{
    /// <summary>
    /// Represents the result of a call composition of <see
    // cref="IFileProvider.GetDirectoryContents(string)"/>
    ...
    public class CompositeDirectoryContents : IDirectoryContents
    {
        ...
        /// <summary>
        /// Creates a new instance of <see cref="CompositeDirectoryContents"/> to represents the result of a
        // call composition of
        /// <see cref="IFileProvider.GetDirectoryContents(string)"/>.
        /// </summary>
        /// <param name="fileProviders">The list of <see cref="IFileProvider"/> for which the results have
        // to be composed.</param>
