            ...
            IDebuggerDisplay
    {
        ...
        )
        {
            ...
            if (dataflowBlockOptions.BoundedCapacity > 0)
                onItemsRemoved = static (owningSource, count) =>
                    ((TransformBlock<TInput, TOutput>)owningSource)._target.ChangeBoundingCount(
                        -count
                    );
            ...
            _source = new SourceCore<TOutput>(
                ...
                static owningSource =>
                    ((TransformBlock<TInput, TOutput>)owningSource)._target.Complete(
                        exception: null,
        ...
        )
        {
            ...
            task.ContinueWith(
                ...
                {
                    var tuple =
                        (Tuple<TransformBlock<TInput, TOutput>, KeyValuePair<TInput, long>>)state!;
        ...
        )
        {
            ...
            // reordering buffer, so it knows that an item isn't missing.
                ...
                _reorderingBuffer.AddItem(
                    messageWithId.Value,
                    outputItem!,
                    itemIsValid: gotOutputItem
                );
        ...
        private sealed class DebugView
        {
            ...
            public int Id
            {
                get { return Common.GetBlockId(_transformBlock); }
            }
