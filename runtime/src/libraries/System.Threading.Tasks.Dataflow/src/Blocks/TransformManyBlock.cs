...
namespace System.Threading.Tasks.Dataflow
{
          ...
          IDebuggerDisplay
    {
        ...
        )
        {
            ...
            Debug.Assert(
                transformSync == null ^ transformAsync == null,
                "Exactly one of transformSync and transformAsync must be null."
            );
