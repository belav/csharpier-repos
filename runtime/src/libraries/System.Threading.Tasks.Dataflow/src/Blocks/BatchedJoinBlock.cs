...
{
    /// <summary>
    /// Provides a dataflow block that batches a specified number of inputs of potentially differing
    // types
    /// provided to one or more of its targets.
    /// </summary>
    /// <typeparam name="T1">Specifies the type of data accepted by the block's first
    // target.</typeparam>
    /// <typeparam name="T2">Specifies the type of data accepted by the block's second
    // target.</typeparam>
            ...
            IDebuggerDisplay
    {
        ...
        /// <summary>Initializes this <see cref="BatchedJoinBlock{T1,T2}"/> with the specified
        // configuration.</summary>
        /// <param name="batchSize">The number of items to group into a batch.</param>
        /// <exception cref="System.ArgumentOutOfRangeException">The <paramref name="batchSize"/> must be
        // positive.</exception>
        ...
        // cref="BatchedJoinBlock{T1,T2}"/>.</param>
        /// <exception cref="System.ArgumentOutOfRangeException">The <paramref name="batchSize"/> must be
        // positive.</exception>
        ...
        public BatchedJoinBlock(int batchSize, GroupingDataflowBlockOptions dataflowBlockOptions)
        {
            ...
            if (dataflowBlockOptions.BoundedCapacity != DataflowBlockOptions.Unbounded)
                throw new ArgumentException(
                    SR.Argument_BoundedCapacityNotSupported,
                    nameof(dataflowBlockOptions)
                );
            ...
            _source = new SourceCore<Tuple<IList<T1>, IList<T2>>>(
                ...
                static owningSource => ((BatchedJoinBlock<T1, T2>)owningSource).CompleteEachTarget()
            );
            ...
            Action createBatchAction = () =>
            {
                if (_target1!.Count > 0 || _target2!.Count > 0)
                {
                    _source.AddMessage(
                        Tuple.Create(
                            _target1.GetAndEmptyMessages(),
                            _target2!.GetAndEmptyMessages()
                        )
                    );
                }
            };
            ...
            Common.WireCancellationToComplete(
                ...
                _source.Completion,
                static (state, _) => ((BatchedJoinBlock<T1, T2>)state!).CompleteEachTarget(),
                this
            );
        ...
        /// <summary>Gets the size of the batches generated by this <see
        // cref="BatchedJoinBlock{T1,T2}"/>.</summary>
        ...
        void IDataflowBlock.Fault(Exception exception)
        {
            ...
            Debug.Assert(
                _sharedResources._incomingLock != null,
                "_sharedResources._incomingLock not initialized"
            );
        ...
        private sealed class DebugView
        {
            ...
            public int Id
            {
                get { return Common.GetBlockId(_batchedJoinBlock); }
            }
    ...
    /// <typeparam name="T2">Specifies the type of data accepted by the block's second
    // target.</typeparam>
    /// <typeparam name="T3">Specifies the type of data accepted by the block's third
    // target.</typeparam>
    [DebuggerDisplay("{DebuggerDisplayContent,nq}")]
    [DebuggerTypeProxy(typeof(BatchedJoinBlock<,,>.DebugView))]
            ...
            IDebuggerDisplay
    {
        ...
        /// <summary>Initializes this <see cref="BatchedJoinBlock{T1,T2,T3}"/> with the specified
        // configuration.</summary>
        /// <param name="batchSize">The number of items to group into a batch.</param>
        /// <exception cref="System.ArgumentOutOfRangeException">The <paramref name="batchSize"/> must be
        // positive.</exception>
        ...
        public BatchedJoinBlock(int batchSize, GroupingDataflowBlockOptions dataflowBlockOptions)
        {
            ...
            Common.WireCancellationToComplete(
                dataflowBlockOptions.CancellationToken,
                _source.Completion,
                static (state, _) => ((BatchedJoinBlock<T1, T2, T3>)state!).CompleteEachTarget(),
                this
            );
            DataflowEtwProvider etwLog = DataflowEtwProvider.Log;
            if (etwLog.IsEnabled())
        ...
        /// <summary>Gets the size of the batches generated by this <see
        // cref="BatchedJoinBlock{T1,T2,T3}"/>.</summary>
        public int BatchSize
        {
            get { return _batchSize; }
        }
        ...
        /// <include file='XmlDocs/CommonXmlDocComments.xml'
        // path='CommonXmlDocComments/Sources/Member[@name="ConsumeMessage"]/*' />
        Tuple<IList<T1>, IList<T2>, IList<T3>>? ISourceBlock<
        ...
        private sealed class DebugView
        {
            ...
            public ITargetBlock<T3> Target3
            {
                get { return _batchedJoinBlock._target3; }
            }
...
namespace System.Threading.Tasks.Dataflow.Internal
{
    ...
    {
        /// <summary>The shared resources used by all targets associated with the same batched join
        // instance.</summary>
        private readonly BatchedJoinBlockTargetSharedResources _sharedResources;
        ...
        /// <param name="sharedResources">The shared resources used by all targets associated with this
        // batched join.</param>
        internal BatchedJoinBlockTarget(BatchedJoinBlockTargetSharedResources sharedResources)
        {
            Debug.Assert(
                sharedResources != null,
                "Targets require a shared resources through which to communicate."
            );
        ...
        private sealed class DebugView
        {
            ...
            {
                get { return _batchedJoinBlockTarget._messages; }
            }
    ...
    /// <summary>Provides a container for resources shared across all targets used by the same
    // BatchedJoinBlock instance.</summary>
    internal sealed class BatchedJoinBlockTargetSharedResources
    {
        ...
        /// <param name="dataflowBlockOptions">The options used to configure the shared resources.  Assumed
        // to be immutable.</param>
        /// <param name="batchSizeReachedAction">The action to invoke when a batch is completed.</param>
        /// <param name="allTargetsDecliningAction">The action to invoke when no more targets are accepting
        // input.</param>
        /// <param name="exceptionAction">The action to invoke when an exception needs to be logged.</param>
        /// <param name="completionAction">The action to invoke when completing, typically invoked due to a
        // call to Fault.</param>
        internal BatchedJoinBlockTargetSharedResources(
            int batchSize,
            GroupingDataflowBlockOptions dataflowBlockOptions,
            Action batchSizeReachedAction,
        ...
        )
        {
            ...
            Debug.Assert(
                ...
                "Need an action to invoke for each batch."
            );
            Debug.Assert(
                allTargetsDecliningAction != null,
        ...
        /// <summary>The action to invoke when enough elements have been accumulated to make a
        // batch.</summary>
