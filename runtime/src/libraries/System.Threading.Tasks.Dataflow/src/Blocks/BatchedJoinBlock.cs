          ...
          IDebuggerDisplay
    {
        ...
        public BatchedJoinBlock(int batchSize, GroupingDataflowBlockOptions dataflowBlockOptions)
        {
            ...
            _source = new SourceCore<Tuple<IList<T1>, IList<T2>>>(
                ...
                owningSource => ((BatchedJoinBlock<T1, T2>)owningSource).CompleteEachTarget()
            );
            ...
            Common.WireCancellationToComplete(
                ...
                _source.Completion,
                state => ((BatchedJoinBlock<T1, T2>)state!).CompleteEachTarget(),
                this
            );
          ...
          IDebuggerDisplay
    {
        ...
        public BatchedJoinBlock(int batchSize, GroupingDataflowBlockOptions dataflowBlockOptions)
        {
            ...
            _source = new SourceCore<Tuple<IList<T1>, IList<T2>, IList<T3>>>(
                this,
                dataflowBlockOptions,
                owningSource => ((BatchedJoinBlock<T1, T2, T3>)owningSource).CompleteEachTarget()
            );
            ...
            Common.WireCancellationToComplete(
                dataflowBlockOptions.CancellationToken,
                _source.Completion,
                state => ((BatchedJoinBlock<T1, T2, T3>)state!).CompleteEachTarget(),
                this
            );
            DataflowEtwProvider etwLog = DataflowEtwProvider.Log;
            if (etwLog.IsEnabled())
