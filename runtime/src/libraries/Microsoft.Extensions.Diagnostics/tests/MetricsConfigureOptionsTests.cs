...
namespace Microsoft.Extensions.Diagnostics.Metrics.Configuration
{
    public class MetricsConfigureOptionsTests
    {
        ...
        public void LoadInstrumentRulesTest()
        {
            ...
            MetricsConfigureOptions.LoadInstrumentRules(
                options,
                configuration.GetSection("MeterName1"),
                MeterScope.Local,
                "ListenerName"
            );
        ...
        public void LoadMeterRulesBoolTest()
        {
            ...
            MetricsConfigureOptions.LoadMeterRules(
                options,
        ...
        public void LoadMeterRulesWithInstrumentsTest()
        {
            ...
            var rule1 = options.Rules.Single(
                rule => rule.MeterName == "MeterName1" && rule.InstrumentName == "InstrumentName1"
            );
            AssertRule(
                rule1,
                "MeterName1",
            ...
            var rule2 = options.Rules.Single(
                rule => rule.MeterName == "MeterName1" && rule.InstrumentName == "InstrumentName2"
            );
            AssertRule(
                rule2,
                "MeterName1",
            ...
            var rule3 = options.Rules.Single(
                rule => rule.MeterName == "MeterName1" && rule.InstrumentName == null
            );
            AssertRule(rule3, "MeterName1", null, "ListenerName", MeterScope.Local, true);

            var rule4 = options.Rules.Single(
                rule => rule.MeterName == "MeterName2" && rule.InstrumentName == "InstrumentName1"
            );
            AssertRule(
                rule4,
                "MeterName2",
            ...
            var rule5 = options.Rules.Single(
                rule => rule.MeterName == "MeterName2" && rule.InstrumentName == "InstrumentName2"
            );
            AssertRule(
                rule5,
                "MeterName2",
            ...
            var rule6 = options.Rules.Single(
                rule => rule.MeterName == "MeterName2" && rule.InstrumentName == null
            );
        ...
        [InlineData(
            "EnabledMetrics:MeterName:Default",
            "true",
            "MeterName",
            null,
            null,
        ...
        [InlineData(
            "EnabledMetrics:MeterName:InstrumentName",
            "false",
            "MeterName",
            "InstrumentName",
            null,
        ...
        [InlineData(
            "EnabledGlobalMetrics:MeterName",
            "false",
            "MeterName",
            null,
            null,
        ...
        [InlineData(
            "EnabledGlobalMetrics:MeterName:Default",
            "true",
            "MeterName",
            null,
            null,
        ...
        [InlineData(
            "EnabledGlobalMetrics:MeterName:InstrumentName",
            "false",
            "MeterName",
            "InstrumentName",
            null,
        ...
        [InlineData(
            "EnabledLocalMetrics:MeterName:Default",
            "true",
            "MeterName",
            null,
            null,
        ...
        [InlineData(
            "EnabledLocalMetrics:MeterName:InstrumentName",
            "false",
            "MeterName",
            "InstrumentName",
            null,
        ...
        [InlineData(
            "Listener:EnabledMetrics:Default",
            "true",
            null,
            null,
            "Listener",
        ...
        [InlineData(
            "Listener:EnabledMetrics:MeterName",
            "false",
            "MeterName",
            null,
            "Listener",
        ...
        [InlineData(
            "Listener:EnabledMetrics:MeterName:Default",
            "true",
            "MeterName",
            null,
            "Listener",
        ...
        [InlineData(
            "Listener:EnabledMetrics:MeterName:InstrumentName",
            "false",
            "MeterName",
            "InstrumentName",
            "Listener",
        ...
        [InlineData(
            "Listener:EnabledGlobalMetrics:Default",
            "true",
            null,
            null,
            "Listener",
        ...
        [InlineData(
            "Listener:EnabledGlobalMetrics:MeterName",
            "false",
            "MeterName",
            null,
            "Listener",
        ...
        [InlineData(
            "Listener:EnabledGlobalMetrics:MeterName:Default",
            "true",
            "MeterName",
            null,
            "Listener",
        ...
        [InlineData(
            "Listener:EnabledGlobalMetrics:MeterName:InstrumentName",
            "false",
            "MeterName",
            "InstrumentName",
            "Listener",
        ...
        [InlineData(
            "Listener:EnabledLocalMetrics:Default",
            "true",
            null,
            null,
            "Listener",
        ...
        [InlineData(
            "Listener:EnabledLocalMetrics:MeterName",
            "false",
            "MeterName",
            null,
            "Listener",
        ...
        [InlineData(
            "Listener:EnabledLocalMetrics:MeterName:Default",
            "true",
            "MeterName",
            null,
            "Listener",
        ...
        [InlineData(
            "Listener:EnabledLocalMetrics:MeterName:InstrumentName",
            "false",
            "MeterName",
            "InstrumentName",
            "Listener",
        ...
        public void LoadTopLevelRulesTest(
            string key,
            string value,
            string? meterName,
