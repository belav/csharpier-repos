...
namespace System.Net
{
    ...
    public class HttpListenerTimeoutManager
    {
        ...
        internal HttpListenerTimeoutManager(HttpListener context)
        {
            ...
            //
            // We have to maintain local state since we allow applications to set individual timeouts. Native
            // Http
            // API for setting timeouts expects all timeout values in every call so we have remember timeout
            // values
            ...
            //
            // No initialization is required because a value of zero indicates that system defaults should be
            // used.
            _timeouts = new int[5];
        }
        ...
        private void SetTimespanTimeout(Interop.HttpApi.HTTP_TIMEOUT_TYPE type, TimeSpan value)
        {
            ...
            //
            // All timeouts are defined as USHORT in native layer (except MinSendRate, which is ULONG). Make
            // sure that
        ...
        // The time, in seconds, allowed for the request entity body to arrive.  The default timer is 2
        // minutes.
        //
        // The HTTP Server API turns on this timer when the request has an entity body. The timer expiration
        // is
        // initially set to the configured value. When the HTTP Server API receives additional data
        // indications on the
        ...
        // The time, in seconds, allowed for the HTTP Server API to drain the entity body on a Keep-Alive
        // connection.
        // The default timer is 2 minutes.
        //
        // On a Keep-Alive connection, after the application has sent a response for a request and before
        // the request
        // entity body has completely arrived, the HTTP Server API starts draining the remainder of the
        // entity body to
        // reach another potentially pipelined request from the client. If the time to drain the remaining
        // entity body
        ...
        // The time, in seconds, allowed for the request to remain in the request queue before the
        // application picks
        ...
        //
        // This timeout is only enforced after the first request on the connection is routed to the
        // application.
        //
        // Use TimeSpan.Zero to indicate that system defaults should be used.
        ...
        // The time, in seconds, allowed for the HTTP Server API to parse the request header.  The default
        // timer is
        // 2 minutes.
        //
        // This timeout is only enforced after the first request on the connection is routed to the
        ...
        // The minimum send rate, in bytes-per-second, for the response. The default response send rate is
        // 150
        // bytes-per-second.
        //
