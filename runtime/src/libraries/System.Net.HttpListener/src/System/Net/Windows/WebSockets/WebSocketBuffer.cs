        ...
        )
        {
            ...
            Debug.Assert(
                ...
                "'receiveBufferSize' MUST be at least "
                    + HttpWebSocket.MinReceiveBufferSize.ToString(NumberFormatInfo.InvariantInfo)
                    + "."
            );
            Debug.Assert(
                sendBufferSize >= HttpWebSocket.MinSendBufferSize,
                "'sendBufferSize' MUST be at least "
                    + HttpWebSocket.MinSendBufferSize.ToString(NumberFormatInfo.InvariantInfo)
                    + "."
            );
            Debug.Assert(
                receiveBufferSize <= HttpWebSocket.MaxBufferSize,
                "'receiveBufferSize' MUST NOT exceed "
                    + HttpWebSocket.MaxBufferSize.ToString(NumberFormatInfo.InvariantInfo)
                    + "."
            );
            Debug.Assert(
