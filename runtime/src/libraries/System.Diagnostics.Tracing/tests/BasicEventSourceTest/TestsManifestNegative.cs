...
namespace BasicEventSourceTests
{
    public class TestsManifestNegative
    {
        ...
        [SkipOnTargetFramework(
            ...
            "https://github.com/dotnet/runtime/issues/21421"
        )]
        [ActiveIssue(
        ...
        public void Test_GenerateManifest_InvalidEventSources()
        {
            ...
            var strictOptions =
                EventManifestOptions.Strict | EventManifestOptions.AllowEventSourceOverride;
            ...
            Assert.NotNull(
                EventSource.GenerateManifest(typeof(Sdt.EventWithReturnEventSource), string.Empty)
            );

            Assert.NotNull(
                EventSource.GenerateManifest(
                    typeof(Sdt.EventWithReturnEventSource),
                    string.Empty,
                    strictOptions
                )
            );
            ...
            AsserExceptionStringsEqual(
                () => GetResourceString("EventSource_NeedPositiveId", "WriteInteger"),
                e
            );
            ...
            e = AssertExtensions.Throws<ArgumentException>(
                GetResourceString("EventSource_MaxChannelExceeded"),
                () =>
                    EventSource.GenerateManifest(
                        typeof(Sdt.TooManyChannelsEventSource),
                        string.Empty
                    )
            );
#endif
            ...
            Assert.NotNull(
                EventSource.GenerateManifest(typeof(Sdt.MismatchIdEventSource), string.Empty)
            );
            ...
            AsserExceptionStringsEqual(
                () =>
                    GetResourceString("EventSource_MismatchIdToWriteEvent", "WriteInteger", 10, 1),
                e
            );
            ...
            AsserExceptionStringsEqual(
                () =>
                    GetResourceString(
                        ...
                        "SdtEventSources.ILogging.Error",
                        1
                    ),
                e
            );
