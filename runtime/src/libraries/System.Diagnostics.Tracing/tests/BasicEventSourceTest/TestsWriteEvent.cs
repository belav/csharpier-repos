...
#endif
using System.Text.RegularExpressions;using SdtEventSources;
...
namespace BasicEventSourceTests
{
    public partial class TestsWriteEvent
    {
        ...
        )
        {
            using (var logger = new EventSourceTest(useSelfDescribingEvents))
            {
                ...
                tests.Add(
                    new SubTest(
                        "WriteEvent/Basic/EventWithIntIntString",
                        delegate()
                        {
                ...
                tests.Add(
                    new SubTest(
                        "WriteEvent/Basic/EventWithIntLongString",
                        delegate()
                        {
                ...
                tests.Add(
                    new SubTest(
                        "WriteEvent/Basic/EventWithString",
                        delegate()
                        {
                ...
                tests.Add(
                    new SubTest(
                        "WriteEvent/Basic/EventWithIntAndString",
                        delegate()
                        {
                ...
                tests.Add(
                    new SubTest(
                        "WriteEvent/Basic/EventWithLongAndString",
                        delegate()
                        {
                ...
                tests.Add(
                    new SubTest(
                        "WriteEvent/Basic/EventWithStringAndInt",
                        delegate()
                        {
                ...
                tests.Add(
                    new SubTest(
                        "WriteEvent/Basic/EventWithStringAndIntAndInt",
                        delegate()
                        {
                ...
                tests.Add(
                    new SubTest(
                        "WriteEvent/Basic/EventWithStringAndLong",
                        delegate()
                        {
                ...
                tests.Add(
                    new SubTest(
                        "WriteEvent/Basic/EventWithStringAndString",
                        delegate()
                        {
                ...
                tests.Add(
                    new SubTest(
                        "WriteEvent/Basic/EventWithStringAndStringAndString",
                        delegate()
                        {
                ...
                if (useSelfDescribingEvents && !(isEtwListener))
                {
                    tests.Add(
                        new SubTest(
                            "WriteEvent/Basic/EventVarArgsWithString",
                            delegate()
                            {
                ...
                if (!useSelfDescribingEvents)
                {
                    tests.Add(
                        new SubTest(
                            "WriteEvent/Basic/EventWithIncorrectNumberOfParameters",
                            delegate()
                            {
                                logger.EventWithIncorrectNumberOfParameters(
                                    "TestMessage",
                                    "TestPath",
                                    10
                                );
                            ...
                            delegate(List<Event> evts)
                            {
                                ...
                                Assert.Equal(
                                    "EventWithIncorrectNumberOfParameters",
                                    evts[eventIdx].EventName
                                );
                                Assert.Equal(
                                    "{TestPath:10}TestMessage",
                                    evts[eventIdx].PayloadString(0, "message")
                                );
                            }
                        )
                    );
        ...
        private void Test_WriteEvent_ComplexData_SelfDescribing(Listener listener)
        {
            using (var logger = new EventSourceTestSelfDescribingOnly())
            {
                ...
                tests.Add(
                    new SubTest(
                        "WriteEvent/SelfDescribingOnly/Byte[]",
                        delegate()
                        {
                ...
                tests.Add(
                    new SubTest(
                        "WriteEvent/SelfDescribingOnly/Int12",
                        delegate()
                        {
                ...
                tests.Add(
                    new SubTest(
                        "WriteEvent/SelfDescribingOnly/IntNull",
                        delegate()
                        {
                ...
                tests.Add(
                    new SubTest(
                        "WriteEvent/SelfDescribingOnly/DateTimeNow",
                        delegate()
                        {
                ...
                tests.Add(
                    new SubTest(
                        "WriteEvent/SelfDescribingOnly/DateTimeNull",
                        delegate()
                        {
                        ...
                        delegate(Event evt)
                        {
                            ...
                            Assert.Equal(
                                nullableDate2,
                                TestUtilities.UnwrapNullable<DateTime>(nullableDate2)
                            );
                            Assert.Equal(5, evt.PayloadValue(1, "anInt"));
                        }
                    )
        ...
        private void Test_WriteEvent_ByteArray(bool useSelfDescribingEvents, Listener listener)
        {
            ...
            using (var logger = new EventSourceTestByteArray(settings))
            {
                ...
                tests.Add(
                    new SubTest(
                        "Write/Array/EventWithByteArrayArg",
                        delegate()
                        {
                ...
                if (!useSelfDescribingEvents)
                {
                    ...
                    tests.Add(
                        new SubTest(
                            "Write/Array/NonEventCallingEventWithBytePtrArg",
                            delegate()
                            {
                ...
                tests.Add(
                    new SubTest(
                        "Write/Array/EventWithLongByteArray",
                        delegate()
                        {
                ...
                */
                ...
                tests.Add(
                    new SubTest(
                        "Write/Array/EventWithEmptyByteArray",
                        delegate()
                        {
    ...
    public sealed class EventSourceTestByteArray : EventSource
    {
        ...
        [NonEvent]
        public unsafe void NonEventCallingEventWithBytePtrArg(
            byte[] blob,
            int start,
            uint size,
            int n
