...
namespace System.Composition.Convention.Tests
{
    public class ExportBuilderTests
    {
        ...
        public void ExportInterfaceWithTypeOf2()
        {
            ...
            Collections.Generic.IEnumerable<ExportAttribute> exports =
                builder.GetDeclaredAttributes(typeof(FooImpl), typeof(FooImpl).GetTypeInfo())
                    .Where<Attribute>(e => e is ExportAttribute)
                    .Cast<ExportAttribute>();
            Assert.Equal(1, exports.Count());
            Assert.Equal(typeof(IFoo), exports.First().ContractType);
        ...
        public void AsContractName_AndContractType_ComputeContractNameFromType()
        {
            ...
            builder.ForTypesDerivedFrom<IFoo>()
                .Export(
                    e => e.AsContractName(t => "Contract:" + t.FullName).AsContractType<IFoo>()
                );
