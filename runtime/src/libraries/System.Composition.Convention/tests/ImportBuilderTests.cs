...
namespace System.Composition.Convention.Tests
{
    public class ImportBuilderTests
    {
        ...
        public void AsContractName_SetsContractName()
        {
            ...
            builder
                .ForType<FooImpl>()
                .ImportProperty((p) => p.IFooProperty, (c) => c.AsContractName("hey"));
        ...
        public void AsContractName_AndContractType_ComputeContractNameFromType()
        {
            ...
            builder
                ...
                .ImportProperty(
                    (p) => p.IFooProperty,
                    c => c.AsContractName(t => "Contract:" + t.FullName)
                );
        ...
        public void AllowDefault_SetsAllowDefaultProperty()
        {
            ...
            builder
                .ForType<FooImpl>()
                .ImportProperty((p) => p.IFooProperty, (c) => c.AllowDefault());
        ...
        public void AsMany_And_ContractName_ChangesGeneratedAttributeToImportMany()
        {
            ...
            builder
                .ForType<FooImpl>()
                .ImportProperty((p) => p.IFooProperty, (c) => c.AsContractName("hey").AsMany());
        ...
        public void AddImportConstraint_AddsImportConstraintMetadataAttribute()
        {
            ...
            builder
                ...
                .ImportProperty(
                    (p) => p.IFooProperty,
                    (c) => c.AddMetadataConstraint("name", "val")
                );

            ImportMetadataConstraintAttribute importMetadataConstraint =
                GetImportMetadataConstraintAttribute(builder);
        ...
        public void AddImportConstraintFuncVal_AddsImportConstraintMetadataAttribute()
        {
            ...
            builder
                ...
                .ImportProperty(
                    (p) => p.IFooProperty,
                    (c) => c.AddMetadataConstraint("name", t => t.Name)
                );
