...
namespace Microsoft.Extensions.Primitives
{
    ...
    {
        /// <summary>
        /// Gets a <see cref="StringSegmentComparer"/> object that performs a case-sensitive ordinal <see
        // cref="StringSegment"/> comparison.
        /// </summary>
        public static StringSegmentComparer Ordinal { get; } =
            new StringSegmentComparer(StringComparison.Ordinal, StringComparer.Ordinal);

        /// <summary>
        /// Gets a <see cref="StringSegmentComparer"/> object that performs a case-insensitive ordinal <see
        // cref="StringSegment"/> comparison.
        /// </summary>
        ...
        /// <summary>
        /// Compares two <see cref="StringSegment"/> objects and returns an indication of their relative
        // sort order.
        /// </summary>
        ...
        /// <param name="x">The first <see cref="StringSegment"/> to compare.</param>
        /// <param name="y">The second <see cref="StringSegment"/> to compare.</param>
        /// <returns><see langword="true"/> if the two <see cref="StringSegment"/> objects are equal;
        ...
        /// <returns>A hash code for a <see cref="StringSegment"/>, suitable for use in hashing algorithms
        ...
        public int GetHashCode(StringSegment obj)
        {
            ...
            // .NET Core strings use randomized hash codes for security reasons. Consequently we must
            // materialize the StringSegment as a string
