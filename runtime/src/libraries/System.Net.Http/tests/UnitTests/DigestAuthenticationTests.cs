...
namespace System.Net.Http.Tests
{
    [SkipOnPlatform(
        ...
        "System.Security.Cryptography is not supported on Browser, see https://github.com/dotnet/runtime/pull/38379"
    )]
    public class DigestAuthenticationTests
    {
        private static readonly List<string> s_keyListWithCountTwo = new List<string>
        {
            "key1",
            "key2",
        };
        private static readonly List<string> s_valueListWithCountTwo = new List<string>
        {
            "value1",
            "value2",
        };
        ...
        public void DigestResponse_Parse_Succeeds(
            string challenge,
            List<string> keys,
            List<string> values
        )
        ...
        public static IEnumerable<object[]> DigestResponse_Challenge_TestData()
        {
            yield return new object[]
            {
                ...
                s_keyListWithCountTwo,
                s_valueListWithCountTwo,
            };
            yield return new object[]
            {
                "\tkey1===value1,key2 \t===\tvalue2",
            ...
            yield return new object[]
            {
                "item1 === item1,key2=, value2",
                s_listWithCountOne,
                s_listWithCountOne,
            };
            yield return new object[]
            {
                "item1,==item1,,,    key2=\"value2\", key3 m",
                new List<string> { "item1," },
                s_listWithCountOne,
            };
            yield return new object[]
            {
                "key1= \"value1   \",key2  =  \"v alu#e2\"   ,",
                s_keyListWithCountTwo,
                new List<string> { "value1   ", "v alu#e2" },
            };
        ...
        [Theory]
        [InlineData(
            "realm=\"NetCore\", nonce=\"qMRqWgAAAAAQMjIABgAAAFwEiEwAAAAA\", qop=\"auth\", stale=false",
            true
        )]
        ...
        public async Task DigestResponse_AuthToken_Handling(string response, bool expectedResult)
        {
            ...
            string parameter = await AuthenticationHelper
                .GetDigestTokenForCredential(credential, request, digestResponse)
        ...
        public async Task DigestResponse_UserName_Encoding(string username, string encodedUserName)
        {
            ...
            AuthenticationHelper.DigestResponse digestResponse =
                new AuthenticationHelper.DigestResponse(
                    "realm=\"NetCore\", nonce=\"qMRqWgAAAAAQMjIABgAAAFwEiEwAAAAA\""
                );
            HttpRequestMessage request = new HttpRequestMessage(
                HttpMethod.Get,
                "http://microsoft.com/"
        ...
        public static IEnumerable<object[]> DigestResponse_ShouldSendQop_TestData()
        {
            ...
            yield return new object[]
            {
                "realm=\"NetCore\", nonce=\"qMRqWgAAAAAQMjIABgAAAFwEiEwAAAAA\", stale=false",
                "(?=.*username=)(?=.*realm=)(?=.*nonce=)(?=.*uri=)(?=.*response=)",
                "(qop=|cnonce=|opaque=|algorithm=)",
                5,
            };
            yield return new object[]
            {
                "realm=\"NetCore\", nonce=\"qMRqWgAAAAAQMjIABgAAAFwEiEwAAAAA\", stale=false, algorithm=MD5",
            ...
            yield return new object[]
            {
                "realm=\"NetCore\", nonce=\"qMRqWgAAAAAQMjIABgAAAFwEiEwAAAAA\", qop=\"auth\", stale=false, opaque=\"qMRqWgAAAAAA\"",
            ...
            yield return new object[]
            {
                "realm=\"NetCore\", nonce=\"qMRqWgAAAAAQMjIABgAAAFwEiEwAAAAA\", stale=false, opaque=\"qMRqWgAAAAAA\"",
            ...
            yield return new object[]
            {
                "realm=\"NetCore\", nonce=\"qMRqWgAAAAAQMjIABgAAAFwEiEwAAAAA\", stale=false, algorithm=MD5-sess, qop=\"auth\"",
            ...
            yield return new object[]
            {
                "realm=\"NetCore\", nonce=\"qMRqWgAAAAAQMjIABgAAAFwEiEwAAAAA\", opaque=\"qMRqWgAAAAAA\", stale=false, algorithm=MD5-sess, qop=\"auth\"",
                "(?=.*username=)(?=.*realm=)(?=.*nonce=)(?=.*uri=)(?=.*response=)(?=.*qop=)(?=.*nc=)(?=.*cnonce=)(?=.*algorithm=)(?=.*opaque=)",
                null,
                10,
            };
            yield return new object[]
            {
                "realm=\"NetCore\", nonce=\"qMRqWgAAAAAQMjIABgAAAFwEiEwAAAAA\", opaque=\"\", stale=false, algorithm=MD5, qop=\"auth\"",
                "(?=.*username=)(?=.*realm=)(?=.*nonce=)(?=.*uri=)(?=.*response=)(?=.*qop=)(?=.*nc=)(?=.*cnonce=)(?=.*algorithm=)(?=.*opaque=)",
                null,
                10,
            };
        ...
        public async Task DigestResponse_ShouldSendQop(
            string response,
            string match,
            string doesNotMatch,
            int fieldCount
        ...
        public static void DigestResponse_CnonceRandom()
        {
            ...
            MethodInfo mi = typeof(AuthenticationHelper).GetMethod(
