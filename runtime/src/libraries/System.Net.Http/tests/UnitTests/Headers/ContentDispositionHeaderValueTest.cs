...
namespace System.Net.Http.Tests
{
    public class ContentDispositionHeaderValueTest
    {
        ...
        public void FileName_UnknownOrBadEncoding_PropertyFails()
        {
            ...
            // Note that uppercase letters are used. Comparison should happen case-insensitive.
            NameValueHeaderValue fileName = new NameValueHeaderValue(
                "FILENAME",
        ...
        public void FileNameStar_UnknownOrBadEncoding_PropertyFails()
        {
            ...
            // Note that uppercase letters are used. Comparison should happen case-insensitive.
            NameValueHeaderValue fileNameStar = new NameValueHeaderValue(
                "FILENAME*",
        ...
        public void Dates_AddDateParameterThenUseProperty_ParametersEntryIsOverwritten()
        {
            ...
            // Note that uppercase letters are used. Comparison should happen case-insensitive.
            NameValueHeaderValue dateParameter = new NameValueHeaderValue(
                "Creation-DATE",
                validDateString
            );
        ...
        public void ToString_UseDifferentContentDispositions_AllSerializedCorrectly()
        {
            ...
            contentDisposition.CreationDate = new DateTimeOffset(
                new DateTime(2011, 2, 15, 8, 0, 0, DateTimeKind.Utc)
            );
            Assert.Equal(
        ...
        {
            ContentDispositionHeaderValue contentDisposition1 = new ContentDispositionHeaderValue(
                "inline"
            );
            ContentDispositionHeaderValue contentDisposition2 = new ContentDispositionHeaderValue(
                "inline"
            );
            contentDisposition2.Name = "myname";
            ContentDispositionHeaderValue contentDisposition3 = new ContentDispositionHeaderValue(
                "inline"
            );
            contentDisposition3.Parameters.Add(new NameValueHeaderValue("name", "value"));
            ContentDispositionHeaderValue contentDisposition4 = new ContentDispositionHeaderValue(
                "INLINE"
            );
            ContentDispositionHeaderValue contentDisposition5 = new ContentDispositionHeaderValue(
                "INLINE"
            );
        ...
        public void Equals_UseContentDispositionWithAndWithoutParameters_EqualOrNotEqualNoExceptions()
        {
            ...
            ContentDispositionHeaderValue contentDisposition7 = new ContentDispositionHeaderValue(
                "attachment"
            );
        ...
        public void GetDispositionTypeLength_DifferentValidScenarios_AllReturnNonZero()
        {
            ...
            Assert.Equal(
                6,
                ContentDispositionHeaderValue.GetDispositionTypeLength("inline", 0, out result)
            );
            value = (ContentDispositionHeaderValue)result;
            Assert.Equal("inline", value.DispositionType);
            Assert.Equal(0, value.Parameters.Count);
            ...
            Assert.Equal(
                32,
                ContentDispositionHeaderValue.GetDispositionTypeLength(
                    " inline; custom=value;name=myName",
                    1,
                    out result
                )
            );
            ...
            Assert.Equal(
                38,
                ContentDispositionHeaderValue.GetDispositionTypeLength(
                    "inline ; custom = \"x\" ; name = myName , next",
                    0,
                    out result
                )
            );
        ...
        public void GetDispositionTypeLength_DifferentInvalidScenarios_AllReturnZero()
        {
            ...
            Assert.Equal(
                0,
                ContentDispositionHeaderValue.GetDispositionTypeLength(null, 0, out result)
            );
            Assert.Null(result);
            Assert.Equal(
                0,
                ContentDispositionHeaderValue.GetDispositionTypeLength(string.Empty, 0, out result)
            );
            Assert.Null(result);
        }
        ...
        private static Dictionary<string, ContentDispositionValue> ContentDispositionTestCases =
            new Dictionary<string, ContentDispositionValue>()
            {
                // Valid values
                {
                    "valid1",
                    new ContentDispositionValue(
                        @"inline",
                ...
                {
                    "valid5",
                    new ContentDispositionValue(@"attachment", @"'attachment' only", true)
                },
                {
                    "valid6",
                    new ContentDispositionValue(@"ATTACHMENT", @"'ATTACHMENT' only", true)
                ...
                },
                {
                    ...
                    new ContentDispositionValue(
                        @"attachment; filename =""foo.html""",
                        @"'attachment', specifying a filename of foo.html, with one blank space <em>before</em> the equals character.",
                        true
                    )
                },
                {
                ...
                },
                {
                    ...
                    new ContentDispositionValue(
                        ...
                        @"'attachment', plus creation-date (see <a href=""http://greenbytes.de/tech/webdav/rfc2183.html#rfc.section.2.4"">Section 2.4 of RFC 2183</a>)",
                        true
                    )
                },
                {
                    ...
                    new ContentDispositionValue(
                        ...
                        @"'attachment', plus modification-date (see <a href=""http://greenbytes.de/tech/webdav/rfc2183.html#rfc.section.2.5"">Section 2.5 of RFC 2183</a>)",
                        true
                    )
                },
                {
                ...
                },
                {
                    ...
                    new ContentDispositionValue(
                        ...
                        @"'attachment', specifying a filename of foo[1](2).html, but missing the quotes. Also, ""["", ""]"", ""("" and "")"" are not allowed in the HTTP <a href=""http://greenbytes.de/tech/webdav/draft-ietf-httpbis-p1-messaging-latest.html#rfc.section.1.2.2"">token</a> production.",
                        false
                    )
                },
                {
                ...
                },
                {
                    ...
                    new ContentDispositionValue(
                        ...
                        @"'attachment', two comma-separated instances of the header field. As Content-Disposition doesn't use a list-style syntax, this is invalid syntax and, according to <a href=""http://greenbytes.de/tech/webdav/rfc2616.html#rfc.section.4.2.p.5"">RFC 2616, Section 4.2</a>, roughly equivalent to having two separate header field instances.",
                        false
                    )
                },
                {
        ...
        private static void ValidateExtensionParameter(
            ContentDispositionHeaderValue header,
            string name,
        ...
        private void CheckInvalidParse(string input)
        {
            ...
            Assert.False(
                ContentDispositionHeaderValue.TryParse(
                    input,
                    out ContentDispositionHeaderValue result
                ),
                input
            );
            Assert.Null(result);
