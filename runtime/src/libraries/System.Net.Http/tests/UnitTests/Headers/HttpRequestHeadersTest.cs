...
namespace System.Net.Http.Tests
{
    public class HttpRequestHeadersTest
    {
        ...
        public void AcceptCharset_UseTryAddWithoutValidationMethodWithInvalidValue_InvalidValueNotRemoved()
        {
            ...
            Assert.Equal(
                new[] { "iso-8859-5, \r\n utf-8; q=0.300" },
                headers.NonValidated["Accept-Charset"]
            );
        }
        ...
        public void From_UseAddMethodWithInvalidValue_InvalidValueRecognized()
        {
            ...
            Assert.Equal(
                "info@example.com ,",
                headers.GetSingleParsedValue(KnownHeaders.From.Descriptor)
            );
        ...
        public void CacheControl_ValidAndInvalidValues_ReturnValidValue()
        {
            ...
            headers.TryAddWithoutValidation(
                "Cache-Control",
                "no-cache=\"token1\", must-revalidate, max-age=3"
            );
            ...
            Assert.Equal(
                "public, must-revalidate, no-cache=\"token1\", max-age=3, s-maxage=15",
                headers.NonValidated["Cache-Control"].ElementAt(1)
            );
        }
