...
namespace System.Net.Http.Tests
{
    public class WarningHeaderValueTest
    {
        ...
        {
            WarningHeaderValue warning = new WarningHeaderValue(
                111,
                ".host",
                "\"Revalidation failed\""
            );
        ...
        public void ToString_UseDifferentRanges_AllSerializedCorrectly()
        {
            ...
            warning = new WarningHeaderValue(
                199,
                "[::1]",
            ...
            Assert.Equal(
                "199 [::1] \"Miscellaneous warning\" \"Mon, 19 Jul 2010 18:31:27 GMT\"",
                warning.ToString()
            );
        }
        ...
        {
            WarningHeaderValue warning1 = new WarningHeaderValue(
                214,
                "host",
                "\"Transformation applied\""
            );
            WarningHeaderValue warning2 = new WarningHeaderValue(
                214,
                "HOST",
                "\"Transformation applied\""
            );
            WarningHeaderValue warning3 = new WarningHeaderValue(
                215,
                "host",
                "\"Transformation applied\""
            );
            WarningHeaderValue warning4 = new WarningHeaderValue(
                214,
                "other",
                "\"Transformation applied\""
            );
            WarningHeaderValue warning5 = new WarningHeaderValue(
                214,
                "host",
                "\"TRANSFORMATION APPLIED\""
            );
            WarningHeaderValue warning6 = new WarningHeaderValue(
                214,
                "host",
                "\"Transformation applied\"",
                new DateTimeOffset(2010, 7, 19, 18, 31, 27, TimeSpan.Zero)
            );
            WarningHeaderValue warning7 = new WarningHeaderValue(
                214,
                "host",
                "\"Transformation applied\"",
                new DateTimeOffset(2011, 7, 19, 18, 31, 27, TimeSpan.Zero)
            );
            WarningHeaderValue warning8 = new WarningHeaderValue(
                214,
                "host",
                "\"Transformation applied\"",
                new DateTimeOffset(2010, 7, 19, 18, 31, 27, TimeSpan.Zero)
        ...
        public void Equals_UseSameAndDifferentRanges_EqualOrNotEqualNoExceptions()
        {
            ...
            Assert.False(
                warning1.Equals(warning7),
                "214 host \"t.a.\" vs. 214 host \"t.a.\" \"D\""
            );
            Assert.False(
                warning7.Equals(warning1),
                "214 host \"t.a.\" \"D\" vs. 214 host \"t.a.\""
            );
            Assert.False(
                warning6.Equals(warning7),
                "214 host \"t.a.\" \"D\" vs. 214 host \"t.a.\" \"other D\""
            );
            Assert.True(
                warning6.Equals(warning8),
        ...
        {
            WarningHeaderValue source = new WarningHeaderValue(
                299,
                "host",
        ...
        {
            CheckGetWarningLength(
                " 199 .host \"Miscellaneous warning\"  ",
                1,
                35,
                new WarningHeaderValue(199, ".host", "\"Miscellaneous warning\"")
            );
            CheckGetWarningLength(
                "987 [FE18:AB64::156]:80 \"\" \"Tue, 20 Jul 2010 01:02:03 GMT\"",
                0,
                58,
        ...
        public void Parse_SetOfValidValueStrings_ParsedCorrectly()
        {
            ...
            CheckValidParse(
                " 50  192.168.0.1  \"text  \"  \"Tue, 20 Jul 2010 01:02:03 GMT\" ",
                new WarningHeaderValue(
                    50,
                    "192.168.0.1",
                    "\"text  \"",
        ...
        private static void CheckGetWarningLength(
            string input,
            int startIndex,
            int expectedLength,
        ...
        )
        {
            ...
            Assert.Equal(
                expectedLength,
                WarningHeaderValue.GetWarningLength(input, startIndex, out result)
            );
            Assert.Equal(expectedResult, result);
        }
