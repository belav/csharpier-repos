...
namespace System.Net.Http.Functional.Tests
{
    public abstract class DiagnosticsTest : HttpClientHandlerTestBase
    {
        ...
        public async Task SendAsync_ExpectedActivityPropagationWithoutListener(
        ...
        [InlineData(true)]
        [InlineData(false)]
        public async Task SendAsync_ExpectedActivityPropagationWithoutListenerOrParentActivity(
            bool useSocketsHttpHandler
        )
        {
            await GetFactoryForVersion(UseVersion)
        ...
        )
        {
            ...
            if (useSocketsHttpHandler)
            {
                ...
                socketsHttpHandler.SslOptions.RemoteCertificateValidationCallback = delegate
                {
                    return true;
                };
