...
namespace System.Net.Http
{
    ...
    internal sealed class Http3Connection : HttpConnectionBase, IDisposable
    {
        ...
        public static readonly SslApplicationProtocol Http3ApplicationProtocol29 =
            new SslApplicationProtocol("h3-29");
        public static readonly SslApplicationProtocol Http3ApplicationProtocol30 =
            new SslApplicationProtocol("h3-30");
        public static readonly SslApplicationProtocol Http3ApplicationProtocol31 =
        ...
        private readonly Queue<TaskCompletionSourceWithCancellation<bool>> _waitingRequests =
            new Queue<TaskCompletionSourceWithCancellation<bool>>();
        ...
        private void CheckForShutdown()
        {
            ...
            if (_connection != null)
            {
                ...
                {
                    _connectionClosedTask = _connection.CloseAsync((long)Http3ErrorCode.NoError)
                        .AsTask();
                }
        ...
        )
        {
            ...
            {
                await waitForAvailableStreamTcs.WaitWithCancellationAsync(cancellationToken)
            ...
            try
            {
                ...
                await quicStream.WriteAsync(Array.Empty<byte>(), cancellationToken)
                    .ConfigureAwait(false);
                ...
                {
                    goAway =
                        _lastProcessedStreamId != -1
                        && requestStream.StreamId > _lastProcessedStreamId;
                }
            ...
            catch (QuicConnectionAbortedException ex)
            {
                ...
                Abort(ex);
                throw new HttpRequestException(
                    SR.Format(SR.net_http_http3_connection_error, ex.ErrorCode),
                    ex,
                    RequestRetryType.RetryOnSameOrNextProxy
                );
            }
        ...
        internal Exception Abort(Exception abortException)
        {
            ...
            Http3ErrorCode connectionResetErrorCode =
                (abortException as Http3ProtocolException)?.ErrorCode
            ...
            lock (SyncObj)
            {
                ...
                {
                    _connectionClosedTask = _connection.CloseAsync((long)connectionResetErrorCode)
                        .AsTask();
                }
        ...
        public static byte[] BuildSettingsFrame(HttpConnectionSettings settings)
        {
            ...
            int integerLength = VariableLengthIntegerHelper.WriteInteger(
                buffer.Slice(4),
                settings._maxResponseHeadersLength * 1024L
            );
