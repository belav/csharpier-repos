...
namespace System.Net.Http.Headers
{
    ...
    internal readonly struct HeaderDescriptor : IEquatable<HeaderDescriptor>
    {
        ...
        public HttpHeaderType HeaderType =>
            _knownHeader == null ? HttpHeaderType.Custom : _knownHeader.HeaderType;
        ...
        public string GetHeaderValue(ReadOnlySpan<byte> headerValue, Encoding? valueEncoding)
        {
            ...
            if (_knownHeader != null)
            {
                ...
                if (knownValues != null)
                {
                    ...
                    {
                        if (
                            ByteArrayHelpers.EqualsOrdinalAsciiIgnoreCase(
                                knownValues[i],
                                headerValue
                            )
                        )
                ...
                case 24:
                    switch (contentTypeValue[0] | 0x20)
                    {
                        case 'a':
                            ...
                            break; // application/octet-stream
                        case 't':
                            candidate = "text/html; charset=utf-8";
                            break; // text/html; charset=utf-8
                    }
                    break;
