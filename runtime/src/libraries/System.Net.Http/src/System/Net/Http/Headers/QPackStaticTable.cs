    ...
    internal static class QPackStaticTable
    {
        ...
        internal static (HeaderDescriptor descriptor, string value)[] HeaderLookup { get; } =
            new (HeaderDescriptor descriptor, string value)[]
            {
                ...
                (
                    new HeaderDescriptor(KnownHeaders.ContentType),
                ...
                (
                    new HeaderDescriptor(KnownHeaders.StrictTransportSecurity),
                ...
                (
                    new HeaderDescriptor(KnownHeaders.AccessControlAllowMethods),
                    "get, post, options"
                ), // 77
                ...
                (
                    new HeaderDescriptor(KnownHeaders.ContentSecurityPolicy),
