...
namespace System.Net.Http
{
    internal sealed partial class Http2Connection
    {
        private sealed class Http2Stream : IValueTaskSource, IHttpStreamHeadersHandler, IHttpTrace
        {
            ...
            private static ReadOnlySpan<int> HpackStaticStatusCodeTable =>
                new int[LastHPackStatusPseudoHeaderId - FirstHPackStatusPseudoHeaderId + 1]
                {
                    200,
                    204,
                    206,
            ...
            private static readonly (
                ...
                byte[] value
            )[] s_hpackStaticHeaderTable = new (HeaderDescriptor, byte[])[
            ...
            void IHttpStreamHeadersHandler.OnStaticIndexedHeader(int index)
            {
                ...
                if (index <= LastHPackRequestPseudoHeaderId)
                {
                    ...
                    throw new HttpRequestException(
                        ...
                        SR.net_http_invalid_response
                    );
                }
                else if (index <= LastHPackStatusPseudoHeaderId)
                {
                    int statusCode = HpackStaticStatusCodeTable[
            ...
            private sealed class Http2WriteStream : Http2ReadWriteStream
            {
                ...
                public override int Read(Span<byte> buffer) =>
                    throw new NotSupportedException(SR.net_http_content_writeonly_stream);
