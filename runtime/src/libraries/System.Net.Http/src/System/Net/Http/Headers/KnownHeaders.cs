...
namespace System.Net.Http.Headers
{
    internal static class KnownHeaders
    {
        ...
        public static readonly KnownHeader Accept = new KnownHeader(
            ...
            null,
            H2StaticTable.Accept,
            H3StaticTable.AcceptAny
        );
        public static readonly KnownHeader AcceptCharset = new KnownHeader(
            "Accept-Charset",
            HttpHeaderType.Request,
            GenericHeaderParser.MultipleValueStringWithQualityParser,
            null,
        ...
        public static readonly KnownHeader AcceptEncoding = new KnownHeader(
            ...
            GenericHeaderParser.MultipleValueStringWithQualityParser,
            null,
            H2StaticTable.AcceptEncoding,
            H3StaticTable.AcceptEncodingGzipDeflateBr
        );
        public static readonly KnownHeader AcceptLanguage = new KnownHeader(
            ...
            GenericHeaderParser.MultipleValueStringWithQualityParser,
            null,
            H2StaticTable.AcceptLanguage,
            H3StaticTable.AcceptLanguage
        );
        ...
        public static readonly KnownHeader AcceptRanges = new KnownHeader(
            ...
            H3StaticTable.AcceptRangesBytes
        );
        ...
        public static readonly KnownHeader AccessControlAllowOrigin = new KnownHeader(
            ...
            parser: null,
            new string[] { "*", "null" },
            H2StaticTable.AccessControlAllowOrigin,
            H3StaticTable.AccessControlAllowOriginAny
        );
        ...
        public static readonly KnownHeader Age = new KnownHeader(
            "Age",
            HttpHeaderType.Response | HttpHeaderType.NonTrailing,
            TimeSpanHeaderParser.Parser,
            null,
            H2StaticTable.Age,
            H3StaticTable.Age0
        );
        ...
        public static readonly KnownHeader Authorization = new KnownHeader(
            "Authorization",
            HttpHeaderType.Request | HttpHeaderType.NonTrailing,
            GenericHeaderParser.SingleValueAuthenticationParser,
            null,
            H2StaticTable.Authorization,
            H3StaticTable.Authorization
        );
        public static readonly KnownHeader CacheControl = new KnownHeader(
            "Cache-Control",
            HttpHeaderType.General | HttpHeaderType.NonTrailing,
        ...
        public static readonly KnownHeader ContentDisposition = new KnownHeader(
            "Content-Disposition",
            HttpHeaderType.Content | HttpHeaderType.NonTrailing,
            GenericHeaderParser.ContentDispositionParser,
            new string[] { "inline", "attachment" },
            H2StaticTable.ContentDisposition,
            H3StaticTable.ContentDisposition
        );
        public static readonly KnownHeader ContentEncoding = new KnownHeader(
            ...
            H2StaticTable.ContentEncoding,
            H3StaticTable.ContentEncodingBr
        );
        ...
        public static readonly KnownHeader ContentLength = new KnownHeader(
            "Content-Length",
            HttpHeaderType.Content | HttpHeaderType.NonTrailing,
            Int64NumberHeaderParser.Parser,
            null,
            H2StaticTable.ContentLength,
            H3StaticTable.ContentLength0
        );
        public static readonly KnownHeader ContentLocation = new KnownHeader(
            "Content-Location",
            HttpHeaderType.Content | HttpHeaderType.NonTrailing,
            UriHeaderParser.RelativeOrAbsoluteUriParser,
            null,
        ...
        public static readonly KnownHeader ContentType = new KnownHeader(
            ...
            null,
            H2StaticTable.ContentType,
            H3StaticTable.ContentTypeApplicationDnsMessage
        );
        public static readonly KnownHeader Cookie = new KnownHeader(
            "Cookie",
            HttpHeaderType.Custom,
            CookieHeaderParser.Parser,
            null,
            H2StaticTable.Cookie,
        ...
        public static readonly KnownHeader From = new KnownHeader(
            "From",
            HttpHeaderType.Request,
            GenericHeaderParser.SingleValueParserWithoutValidation,
            null,
            H2StaticTable.From
        );
        ...
        public static readonly KnownHeader Host = new KnownHeader(
            "Host",
            HttpHeaderType.Request | HttpHeaderType.NonTrailing,
            GenericHeaderParser.HostParser,
            null,
            H2StaticTable.Host
        );
        public static readonly KnownHeader IfMatch = new KnownHeader(
            "If-Match",
            HttpHeaderType.Request | HttpHeaderType.NonTrailing,
            GenericHeaderParser.MultipleValueEntityTagParser,
            null,
        ...
        public static readonly KnownHeader IfModifiedSince = new KnownHeader(
            ...
            DateHeaderParser.Parser,
            null,
            H2StaticTable.IfModifiedSince,
            H3StaticTable.IfModifiedSince
        );
        public static readonly KnownHeader IfNoneMatch = new KnownHeader(
            ...
            GenericHeaderParser.MultipleValueEntityTagParser,
            null,
            H2StaticTable.IfNoneMatch,
            H3StaticTable.IfNoneMatch
        );
        public static readonly KnownHeader IfRange = new KnownHeader(
            ...
            null,
            H2StaticTable.IfRange,
            H3StaticTable.IfRange
        );
        ...
        public static readonly KnownHeader LastModified = new KnownHeader(
            ...
            DateHeaderParser.Parser,
            null,
            H2StaticTable.LastModified,
            H3StaticTable.LastModified
        );
        ...
        public static readonly KnownHeader Range = new KnownHeader(
            "Range",
            HttpHeaderType.Request | HttpHeaderType.NonTrailing,
            GenericHeaderParser.RangeParser,
            null,
            H2StaticTable.Range,
            H3StaticTable.RangeBytes0ToAll
        );
        public static readonly KnownHeader Referer = new KnownHeader(
            ...
            UriHeaderParser.RelativeOrAbsoluteUriParser,
            null,
            H2StaticTable.Referer,
            H3StaticTable.Referer
        ); // NB: The spelling-mistake "Referer" for "Referrer" must be matched.
        ...
        public static readonly KnownHeader Server = new KnownHeader(
            "Server",
            HttpHeaderType.Response,
            ProductInfoHeaderParser.MultipleValueParser,
            null,
            H2StaticTable.Server,
            H3StaticTable.Server
        );
        ...
        public static readonly KnownHeader SetCookie = new KnownHeader(
            "Set-Cookie",
            HttpHeaderType.Custom | HttpHeaderType.NonTrailing,
            null,
            null,
            H2StaticTable.SetCookie,
            H3StaticTable.SetCookie
        );
        ...
        public static readonly KnownHeader StrictTransportSecurity = new KnownHeader(
            ...
            H2StaticTable.StrictTransportSecurity,
            H3StaticTable.StrictTransportSecurityMaxAge31536000
        );
        public static readonly KnownHeader TE = new KnownHeader(
            "TE",
            HttpHeaderType.Request | HttpHeaderType.NonTrailing,
            TransferCodingHeaderParser.MultipleValueWithQualityParser,
        ...
        public static readonly KnownHeader TransferEncoding = new KnownHeader(
            "Transfer-Encoding",
            HttpHeaderType.General | HttpHeaderType.NonTrailing,
            TransferCodingHeaderParser.MultipleValueParser,
        ...
        public static readonly KnownHeader UserAgent = new KnownHeader(
            ...
            ProductInfoHeaderParser.MultipleValueParser,
            null,
            H2StaticTable.UserAgent,
            H3StaticTable.UserAgent
        );
        public static readonly KnownHeader Vary = new KnownHeader(
            ...
            new string[] { "*" },
            H2StaticTable.Vary,
            H3StaticTable.VaryAcceptEncoding
        );
        public static readonly KnownHeader Via = new KnownHeader(
            "Via",
            HttpHeaderType.General,
            GenericHeaderParser.MultipleValueViaParser,
            null,
            H2StaticTable.Via
        );
        ...
        public static readonly KnownHeader XFrameOptions = new KnownHeader(
            ...
            HttpHeaderType.Custom,
            null,
            new string[] { "DENY", "SAMEORIGIN" },
            http3StaticTableIndex: H3StaticTable.XFrameOptionsDeny
        );
        ...
        /// </summary>
        /// <remarks>
        /// Matching is case-insensitive. Because of this, we do not preserve the case of the original
        // header,
        /// whether from the wire or from the user explicitly setting a known header using a header name
        // string.
        /// </remarks>
            ...
            where T : struct, IHeaderNameAccessor // Enforce struct for performance
        {
            ...
            switch (length)
            {
                ...
                case 6:
                    ...
                    {
                        case 'a':
                            return Accept; // [A]ccept
                        case 'c':
                            return Cookie; // [C]ookie
                        case 'e':
                            return Expect; // [E]xpect
                        case 'o':
                            return Origin; // [O]rigin
                        case 'p':
                            return Pragma; // [P]ragma
                        case 's':
                            return Server; // [S]erver
                    }
                    break;
                ...
                case 7:
                    ...
                    {
                        case ':':
                            return PseudoStatus; // [:]status
                        case 'a':
                            return AltSvc; // [A]lt-Svc
                        case 'c':
                            return Cookie2; // [C]ookie2
                        case 'e':
                            return Expires; // [E]xpires
                        case 'r':
                            switch (key[3] | 0x20)
                            {
                                case 'e':
                                    return Referer; // [R]ef[e]rer
                                case 'r':
                                    return Refresh; // [R]ef[r]esh
                            }
                            break;
                        case 't':
                            return Trailer; // [T]railer
                        case 'u':
                            return Upgrade; // [U]pgrade
                        case 'w':
                            return Warning; // [W]arning
                        case 'x':
                            return XCache; // [X]-Cache
                    }
                    break;
                ...
                case 8:
                    ...
                    {
                        case '-':
                            return AltUsed; // Alt[-]Used
                        case 'a':
                            return Location; // Loc[a]tion
                        case 'm':
                            return IfMatch; // If-[M]atch
                        case 'r':
                            return IfRange; // If-[R]ange
                    }
                    break;
                ...
                case 10:
                    ...
                    {
                        case 'c':
                            return Connection; // [C]onnection
                        case 'k':
                            return KeepAlive; // [K]eep-Alive
                        case 's':
                            return SetCookie; // [S]et-Cookie
                        case 'u':
                            return UserAgent; // [U]ser-Agent
                    }
                    break;
                ...
                case 11:
                    ...
                    {
                        case 'c':
                            return ContentMD5; // [C]ontent-MD5
                        case 'g':
                            return GrpcStatus; // [g]rpc-status
                        case 'r':
                            return RetryAfter; // [R]etry-After
                        case 's':
                            return SetCookie2; // [S]et-Cookie2
                    }
                    break;
                ...
                case 12:
                    ...
                    {
                        case 'd':
                            return XMSEdgeRef; // X-MSE[d]ge-Ref
                        case 'e':
                            return XPoweredBy; // X-Pow[e]red-By
                        case 'm':
                            return GrpcMessage; // grpc-[m]essage
                        case 'n':
                            return ContentType; // Conte[n]t-Type
                        case 'o':
                            return MaxForwards; // Max-F[o]rwards
                        case 't':
                            return AcceptPatch; // Accep[t]-Patch
                        case 'u':
                            return XRequestID; // X-Req[u]est-ID
                    }
                    break;
                ...
                case 13:
                    ...
                    {
                        case 'd':
                            return LastModified; // Last-Modifie[d]
                        case 'e':
                            return ContentRange; // Content-Rang[e]
                        case 'g':
                            switch (key[0] | 0x20)
                            {
                                case 's':
                                    return ServerTiming; // [S]erver-Timin[g]
                                case 'g':
                                    return GrpcEncoding; // [g]rpc-encodin[g]
                            }
                            break;
                        case 'h':
                            return IfNoneMatch; // If-None-Matc[h]
                        case 'l':
                            return CacheControl; // Cache-Contro[l]
                        case 'n':
                            return Authorization; // Authorizatio[n]
                        case 's':
                            return AcceptRanges; // Accept-Range[s]
                        case 't':
                            return ProxySupport; // Proxy-Suppor[t]
                    }
                    break;
                ...
                case 14:
                    ...
                    {
                        case 'a':
                            return AcceptCharset; // [A]ccept-Charset
                        case 'c':
                            return ContentLength; // [C]ontent-Length
                    }
                    break;
                ...
                case 15:
                    ...
                    {
                        case '-':
                            return XFrameOptions; // X-Frame[-]Options
                        case 'e':
                            return AcceptEncoding; // Accept-[E]ncoding
                        case 'k':
                            return PublicKeyPins; // Public-[K]ey-Pins
                        case 'l':
                            return AcceptLanguage; // Accept-[L]anguage
                        case 'm':
                            return XUACompatible; // X-UA-Co[m]patible
                        case 'r':
                            return ReferrerPolicy; // Referre[r]-Policy
                    }
                    break;
                ...
                case 16:
                    ...
                    {
                        case 'a':
                            return ContentLocation; // Content-Loc[a]tion
                        case 'c':
                            switch (key[0] | 0x20)
                            {
                                case 'p':
                                    return ProxyConnection; // [P]roxy-Conne[c]tion
                                case 'x':
                                    return XXssProtection; // [X]-XSS-Prote[c]tion
                            }
                            break;
                        case 'g':
                            return ContentLanguage; // Content-Lan[g]uage
                        case 'i':
                            return WWWAuthenticate; // WWW-Authent[i]cate
                        case 'o':
                            return ContentEncoding; // Content-Enc[o]ding
                        case 'r':
                            return XAspNetVersion; // X-AspNet-Ve[r]sion
                    }
                    break;
                ...
                case 17:
                    ...
                    {
                        case 'i':
                            return IfModifiedSince; // [I]f-Modified-Since
                        case 's':
                            return SecWebSocketKey; // [S]ec-WebSocket-Key
                        case 't':
                            return TransferEncoding; // [T]ransfer-Encoding
                    }
                    break;
                ...
                case 18:
                    ...
                    {
                        case 'p':
                            return ProxyAuthenticate; // [P]roxy-Authenticate
                        case 'x':
                            return XContentDuration; // [X]-Content-Duration
                    }
                    break;
                ...
                case 19:
                    ...
                    {
                        case 'c':
                            return ContentDisposition; // [C]ontent-Disposition
                        case 'i':
                            return IfUnmodifiedSince; // [I]f-Unmodified-Since
                        case 'p':
                            return ProxyAuthorization; // [P]roxy-Authorization
                    }
                    break;
                ...
                case 22:
                    ...
                    {
                        case 'a':
                            return AccessControlMaxAge; // [A]ccess-Control-Max-Age
                        case 's':
                            return SecWebSocketProtocol; // [S]ec-WebSocket-Protocol
                        case 'x':
                            return XContentTypeOptions; // [X]-Content-Type-Options
                    }
                    break;
                ...
                case 25:
                    ...
                    {
                        case 's':
                            return StrictTransportSecurity; // [S]trict-Transport-Security
                        case 'u':
                            return UpgradeInsecureRequests; // [U]pgrade-Insecure-Requests
                    }
                    break;
                ...
                case 28:
                    ...
                    {
                        case 'h':
                            return AccessControlAllowHeaders; // Access-Control-Allow-[H]eaders
                        case 'm':
                            return AccessControlAllowMethods; // Access-Control-Allow-[M]ethods
                    }
                    break;
