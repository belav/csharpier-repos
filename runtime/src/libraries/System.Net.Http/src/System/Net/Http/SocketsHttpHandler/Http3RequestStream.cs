...
namespace System.Net.Http
{
    ...
    internal sealed class Http3RequestStream : IHttpHeadersHandler, IAsyncDisposable, IDisposable
    {
        ...
        )
        {
            ...
            {
                await content.CopyToAsync(writeStream, null, cancellationToken)
                    .ConfigureAwait(false);
            }
            ...
            if (_sendBuffer.ActiveLength != 0)
            {
                ...
                await _stream.WriteAsync(_sendBuffer.ActiveMemory, cancellationToken)
                    .ConfigureAwait(false);
                _sendBuffer.Discard(_sendBuffer.ActiveLength);
            }
        ...
        )
        {
            ...
            if (remaining != -1)
            {
                ...
                if (_sendBuffer.ActiveLength != 0)
                {
                    ...
                    await _stream.WriteAsync(_gatheredSendBuffer, cancellationToken)
                        .ConfigureAwait(false);
