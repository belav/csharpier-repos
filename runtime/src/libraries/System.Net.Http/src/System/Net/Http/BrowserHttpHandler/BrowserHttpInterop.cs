...
namespace System.Net.Http
{
    internal static partial class BrowserHttpInterop
    {
        ...
        public static partial Task TransformStreamClose(JSObject transformStream);

        [JSImport("INTERNAL.http_wasm_transform_stream_abort")]
        public static partial void TransformStreamAbort(JSObject transformStream);
        ...
        public static unsafe Task<JSObject> Fetch(
            string uri,
            string[] headerNames,
            string[] headerValues,
            string[] optionNames,
        ...
        public static async ValueTask CancelationHelper(
            Task promise,
            CancellationToken cancellationToken,
            JSObject? fetchResponse = null
        )
        {
            ...
            {
                using (
                    var operationRegistration = cancellationToken.Register(
                        static s =>
                        {
                            (Task _promise, JSObject? _fetchResponse) = ((Task, JSObject?))s!;
                            CancelablePromise.CancelPromise(
                                _promise,
                                static (JSObject? __fetchResponse) =>
                                {
        ...
        public static async ValueTask<T> CancelationHelper<T>(
            Task<T> promise,
            CancellationToken cancellationToken,
            JSObject? fetchResponse = null
        )
        {
            ...
            await CancelationHelper((Task)promise, cancellationToken, fetchResponse)
                .ConfigureAwait(true);
