...
namespace System.Net.Http
{
    internal static class HttpRuleParser
    {
        ...
        private static readonly IndexOfAnyValues<char> s_tokenChars = IndexOfAnyValues.Create(
            "!#$%&'*+-.0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ^_`abcdefghijklmnopqrstuvwxyz|~"
        );

        private static readonly IndexOfAnyValues<byte> s_tokenBytes = IndexOfAnyValues.Create(
