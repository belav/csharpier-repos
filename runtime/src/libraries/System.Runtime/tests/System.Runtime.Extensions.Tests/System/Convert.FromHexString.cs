    ...
    public class ConvertFromHexStringTests
    {
        ...
        private static void TestSequence(byte[] expected, string actual)
        {
            ...
            Assert.Equal(
                ...
                Convert.FromHexString(actual, tryResult, out int consumed, out int written)
            );
        ...
        public static void InvalidInputString_FormatException_Or_FalseResult(string invalidInput)
        {
            ...
            Assert.Equal(
                ...
                Convert.FromHexString(invalidInput.AsSpan(), buffer, out _, out _)
            );
        }
        ...
        public static void ZeroLength()
        {
            ...
            OperationStatus convertResult = Convert.FromHexString(
                string.Empty,
                Span<byte>.Empty,
                out int consumed,
                out int written
        ...
        public static void TooShortDestination()
        {
            ...
            byte[] data = Security.Cryptography
        ...
        public static void NeedMoreData_OrFormatException()
        {
            ...
            var singeResult = Convert.FromHexString(
                spanHex,
                destination,
                out int consumed,
                out int written
            ...
            var oneOffResult = Convert.FromHexString(
                spanHex,
                destination,
                out consumed,
                out written
