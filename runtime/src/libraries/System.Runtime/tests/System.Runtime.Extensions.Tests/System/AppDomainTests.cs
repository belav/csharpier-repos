...
namespace System.Tests
{
    public class AppDomainTests : FileCleanupTestBase
    {
        ...
        [SkipOnPlatform(
            ...
            "The dotnet sdk will not be available on these platforms"
        )]
        ...
        [SkipOnPlatform(
            TestPlatforms.OSX,
            "Unhandled exception on a separate process causes xunit to crash on osx"
        )]
        [ConditionalFact(typeof(RemoteExecutor), nameof(RemoteExecutor.IsSupported))]
...
#pragma warning restore SYSLIB0024
        ...
        [ConditionalFact(
            ...
            nameof(PlatformDetection.IsNonBundledAssemblyLoadingSupported)
        )]
...
#pragma warning restore SYSLIB0003
            ...
            Assert.Equal(
                10,
                AppDomain.CurrentDomain.ExecuteAssembly(name, new string[2] { "2", "3" })
            );
        }
...
#pragma warning restore 618
            ...
            RemoteExecutor
                .Invoke(() =>
                {
                    ...
                    AppDomain.CurrentDomain.Load(
                        typeof(AppDomainTests).Assembly.GetName().FullName
                    );
                    ...
                    Assert.True(
                        assemblies1.Length >= assemblies.Length,
                        "Assembly.Load of an already loaded assembly should not cause another load"
                    );
                    ...
                    Assert.True(
                        assemblies2.Length > assemblies.Length,
                        "Assembly.LoadFile should cause an increase in GetAssemblies list"
                    );
                    int ctr = 0;
        ...
        public void AssemblyResolveInvalidAssemblyName()
        {
            RemoteExecutor
                .Invoke(() =>
                {
                    ...
                    Type t = Type.GetType(
                        "AssemblyResolveTestApp.Class1, InvalidAssemblyName",
                        throwOnError: false
                    );
                    Assert.Null(t);
                ...
                .Invoke(() =>
                {
                    ...
                    ResolveEventHandler handler = (sender, args) =>
                    {
                        ...
                        return Assembly.LoadFile(
                            Path.Combine(Environment.CurrentDirectory, "AssemblyResolveTestApp.dll")
                        );
                    };
                    ...
                    Type t = Type.GetType(
                        "AssemblyResolveTestApp.Class1, AssemblyResolveTestApp",
                        true
                    );
                    Assert.NotNull(t);
            ...
            RemoteExecutor
                .Invoke(() =>
                {
                    ...
                    Assembly a = Assembly.LoadFile(
                        Path.Combine(Environment.CurrentDirectory, "TestAppOutsideOfTPA.exe")
                    );
        ...
        private void CopyTestAssemblies()
        {
            ...
            string destTestAssemblyPath = Path.Combine(
                assemblyResolvePath,
                "AssemblyResolveTestApp.dll"
            );
...
#pragma warning restore SYSLIB0003 // Obsolete: CAS
        ...
        public static bool FileCreateCaseSensitiveAndAssemblyLoadingSupported =>
            PlatformDetection.FileCreateCaseSensitive
            && PlatformDetection.IsAssemblyLoadingSupported;
        ...
        public static void TestingCreateInstanceFromObjectHandle(
        ...
        )
        {
            ...
            {
                oh = AppDomain.CurrentDomain.CreateInstanceFrom(
                    assemblyFile: assemblyFile,
                    typeName: type
                );
        ...
        public static IEnumerable<object[]> TestingCreateInstanceFromObjectHandleData()
        {
            ...
            yield return new object[]
            {
                "AssemblyResolveTestApp.dll",
                "AssemblyResolveTestApp.dll",
                "AssemblyResolveTestApp.PublicClassSample",
                "AssemblyResolveTestApp.PublicClassSample",
                null,
            };
            yield return new object[]
            ...
            yield return new object[]
            {
                "AssemblyResolveTestApp.dll",
                "AssemblyResolveTestApp.dll",
                "AssemblyResolveTestApp.PublicClassNoDefaultConstructorSample",
                "AssemblyResolveTestApp.PublicClassNoDefaultConstructorSample",
        ...
        public static void TestingCreateInstanceObjectHandle(
            string assemblyName,
            string type,
            string returnedFullNameType,
            Type exceptionType
        )
        {
            ...
            {
                oh = AppDomain.CurrentDomain.CreateInstance(
                    assemblyName: assemblyName,
                    typeName: type
                );
                CheckValidity(oh, returnedFullNameType);

                obj = AppDomain.CurrentDomain.CreateInstanceAndUnwrap(
                    assemblyName: assemblyName,
                    typeName: type
                );
                CheckValidity(obj, returnedFullNameType);
        ...
        public static TheoryData<
            ...
            string,
            Type
        > TestingCreateInstanceObjectHandleData =>
            new TheoryData<string, string, string, Type>()
            {
        ...
        public static void TestingCreateInstanceFromObjectHandleFullSignature(
            string physicalFileName,
            string assemblyFile,
            string type,
            bool ignoreCase,
        ...
        public static void TestingCreateInstanceObjectHandleFullSignature(
            string assemblyName,
            string type,
            bool ignoreCase,
            BindingFlags bindingAttr,
        ...
        public void AssemblyResolve_FirstChanceException()
        {
            RemoteExecutor
                .Invoke(() =>
                {
                    ...
                    EventHandler<System.Runtime.ExceptionServices.FirstChanceExceptionEventArgs> firstChanceHandler =
                        (source, args) =>
                        {
