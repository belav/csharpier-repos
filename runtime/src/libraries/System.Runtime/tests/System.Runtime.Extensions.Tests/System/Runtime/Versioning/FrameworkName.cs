...
namespace System.Runtime.Versioning.Tests
{
    public static class FrameworkNameTests
    {
        ...
        private static readonly string s_testNameString =
            $"{TestIdentifier},Version=v{s_testVersion},Profile={TestProfile}";
        ...
        public static void ConstructFromString()
        {
            ...
            VerifyConstructor(
                new FrameworkName(emptyProfileFrameworkName),
                emptyProfileFrameworkName,
                TestIdentifier,
                s_testVersion,
                string.Empty
            );
            VerifyConstructor(
                new FrameworkName(emptyProfileFrameworkName + ",Profile="),
                emptyProfileFrameworkName,
                TestIdentifier,
                s_testVersion,
                string.Empty
        ...
        public static void ConstructFromInvalidString()
        {
            ...
            AssertExtensions.Throws<ArgumentException>("frameworkName", () =>
                new FrameworkName(string.Empty)
            );
            AssertExtensions.Throws<ArgumentException>("frameworkName", () =>
                new FrameworkName(" ,A")
            );
            ...
            AssertExtensions.Throws<ArgumentException>("frameworkName", () =>
                new FrameworkName("A,B")
            );
            AssertExtensions.Throws<ArgumentException>("frameworkName", () =>
                new FrameworkName("A,B,C")
            );
            AssertExtensions.Throws<ArgumentException>("frameworkName", () =>
                new FrameworkName("A,Version=1.0.0.0,C")
            );
            AssertExtensions.Throws<ArgumentException>("frameworkName", () =>
                new FrameworkName("A,1.0.0.0,Profile=C")
            );
            AssertExtensions.Throws<ArgumentException>("frameworkName", () =>
                new FrameworkName("A,Version=1.z.0.0,Profile=C")
            );
            AssertExtensions.Throws<ArgumentException>("frameworkName", () =>
                new FrameworkName("A,Something=1.z.0.0,Profile=C")
            );
            AssertExtensions.Throws<ArgumentException>("frameworkName", () =>
                new FrameworkName("A,Profile=C")
            );
            AssertExtensions.Throws<ArgumentException>("frameworkName", () =>
                new FrameworkName("A,======")
            );
        ...
        {
            VerifyConstructor(
                new FrameworkName(TestIdentifier, s_testVersion),
                s_testNameNoProfileString,
                TestIdentifier,
                s_testVersion,
                string.Empty
        ...
        public static void ConstructFromInvalidIdentifierVersion()
        {
            ...
            AssertExtensions.Throws<ArgumentException>("identifier", () =>
                new FrameworkName(string.Empty, s_testVersion)
            );
            AssertExtensions.Throws<ArgumentException>("identifier", () =>
                new FrameworkName("   \r\n\t", s_testVersion)
            );
        ...
        {
            VerifyConstructor(
                new FrameworkName(TestIdentifier, s_testVersion, TestProfile),
                s_testNameString,
                TestIdentifier,
                s_testVersion,
                TestProfile
            ...
            VerifyConstructor(
                new FrameworkName(TestIdentifier, s_testVersion, null),
                s_testNameNoProfileString,
                TestIdentifier,
                s_testVersion,
                string.Empty
        ...
        public static void Inequality()
        {
            ...
            VerifyInequality(
                s_testName,
                new FrameworkName("NotTheTestIdentifier", s_testVersion, TestProfile)
            );
            VerifyInequality(s_testName, new FrameworkName(TestIdentifier, s_testVersion));
            VerifyInequality(
                s_testName,
                new FrameworkName(TestIdentifier, new Version(9, 8, 7, 6), TestProfile)
            );
        }
