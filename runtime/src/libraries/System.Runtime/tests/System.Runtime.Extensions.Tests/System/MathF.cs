    ...
    public static class MathFTests
    {
        ...
        public static void IEEERemainder()
        {
            ...
            AssertExtensions.Equal(
                1.8f,
                MathF.IEEERemainder(17.8f, 4.0f),
                CrossPlatformMachineEpsilon * 10
            );
            AssertExtensions.Equal(
                1.4f,
                MathF.IEEERemainder(17.8f, 4.1f),
                CrossPlatformMachineEpsilon * 10
            );
            AssertExtensions.Equal(
                0.1000004f,
                MathF.IEEERemainder(-16.3f, 4.1f),
                CrossPlatformMachineEpsilon / 10
            );
            AssertExtensions.Equal(
                1.4f,
        ...
        )
        {
            AssertExtensions.Equal(
                expectedResult,
                MathF.ReciprocalSqrtEstimate(value),
                allowedVariance
            );
        }
