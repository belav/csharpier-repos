...
namespace System.Tests
{
    public static partial class MathTests
    {
        ...
        {
            Assert.Equal(
                unchecked((long)0x4005BF0A8B145769),
                BitConverter.DoubleToInt64Bits(Math.E)
            );
        }
        ...
        {
            Assert.Equal(
                unchecked((long)0x400921FB54442D18),
                BitConverter.DoubleToInt64Bits(Math.PI)
            );
        }
        ...
        {
            Assert.Equal(
                unchecked((long)0x401921FB54442D18),
                BitConverter.DoubleToInt64Bits(Math.Tau)
            );
        }
        ...
        public static IEnumerable<object[]> Atan2_TestData
        {
            get
            {
                yield return new object[]
                {
                    ...
                    -1.0,
                    -1.5707963267948966,
                    CrossPlatformMachineEpsilon * 10,
                }; // expected: -(pi / 2)
                yield return new object[]
                {
                    double.NegativeInfinity,
                ...
                yield return new object[]
                {
                    ...
                    -2.3561944901923449,
                    CrossPlatformMachineEpsilon * 10,
                }; // expected: -(3 * pi / 4),         y: -(1 / sqrt(2))   x: -(1 / sqrt(2))
                yield return new object[]
                {
                    -0.70710678118654752,
                    0.70710678118654752,
                    -0.78539816339744831,
                    CrossPlatformMachineEpsilon,
                }; // expected: -(pi / 4),             y: -(1 / sqrt(2))   x:  (1 / sqrt(2))
                yield return new object[]
                {
                    -0.64963693908006244,
                    -0.76024459707563015,
        ...
        public static void Ceiling_Double_IEEE(
            double value,
            double expectedResult,
            double allowedVariance
        )
        ...
        [Theory]
        [InlineData(-0.0, -0.0, 0.0)]
        public static void Floor_Double_IEEE(
            double value,
            double expectedResult,
            double allowedVariance
        )
        ...
        public static IEnumerable<object[]> Pow_TestData
        {
            get
            {
                ...
                yield return new object[]
                {
                    10.0,
                    -3.1415926535897932,
                    0.00072178415907472774,
                    CrossPlatformMachineEpsilon / 1000,
                }; //          y: -(pi)
                yield return new object[]
                {
                    10.0,
                    -2.7182818284590452,
                    0.0019130141022243176,
                    CrossPlatformMachineEpsilon / 100,
                }; //          y: -(e)
                yield return new object[]
                {
                ...
                yield return new object[]
                {
                    ...
                    3.1415926535897932,
                    1385.4557313670111,
                    CrossPlatformMachineEpsilon * 10000,
                }; //          y:  (pi)
                yield return new object[]
                {
                    10.0,
        ...
        public static void ReciprocalEstimate(
            double value,
            double expectedResult,
            double allowedVariance
        )
        ...
        [InlineData(double.PositiveInfinity, 0.0, 0.0)]
        public static void ReciprocalSqrtEstimate(
            double value,
            double expectedResult,
            double allowedVariance
        )
        {
            AssertExtensions.Equal(
                expectedResult,
                Math.ReciprocalSqrtEstimate(value),
                allowedVariance
            );
        }
        ...
        public static void Round_Double_Digits_SpecificCases()
        {
            ...
            Assert.Equal(
                double.PositiveInfinity,
                Math.Round(double.PositiveInfinity, 3, MidpointRounding.AwayFromZero)
            );
            Assert.Equal(
                double.NegativeInfinity,
                Math.Round(double.NegativeInfinity, 3, MidpointRounding.AwayFromZero)
            );
        }
        ...
        [InlineData(
            ...
            CrossPlatformMachineEpsilon,
            CrossPlatformMachineEpsilon
        )] // value: -(pi / 4),        expected_sin: -(1 / sqrt(2)),    expected_cos: 1
        [InlineData(
            -0.70710678118654752,
            -0.64963693908006244,
            0.76024459707563015,
        ...
        [InlineData(1, 0, 0, 0)]
        [InlineData(0, 0, 0, 0)]
        public static void DivRemSByte(
            sbyte dividend,
            sbyte divisor,
        ...
        [InlineData(1, 0, 0, 0)]
        [InlineData(0, 0, 0, 0)]
        public static void DivRemInt16(
            short dividend,
            short divisor,
        ...
        [InlineData(1, 0, 0, 0)]
        [InlineData(0, 0, 0, 0)]
        public static void DivRemUInt16(
            ushort dividend,
            ushort divisor,
        ...
        [InlineData(0, 0, 0, 0)]
        public static void DivRemInt32(
            int dividend,
            int divisor,
        ...
        [InlineData(1, 0, 0, 0)]
        [InlineData(0, 0, 0, 0)]
        public static void DivRemUInt32(
            uint dividend,
            uint divisor,
        ...
        [InlineData(1, 0, 0, 0)]
        [InlineData(0, 0, 0, 0)]
        public static void DivRemInt64(
            long dividend,
            long divisor,
        ...
        [InlineData(1, 0, 0, 0)]
        [InlineData(0, 0, 0, 0)]
        public static void DivRemUInt64(
            ulong dividend,
            ulong divisor,
        ...
        private static void DivRemNativeInt(
            nint dividend,
            nint divisor,
            nint expectedQuotient,
            nint expectedRemainder
        ...
        [MethodImpl(MethodImplOptions.NoInlining)]
        private static void DivRemNativeUInt(
            nuint dividend,
            nuint divisor,
            nuint expectedQuotient,
            nuint expectedRemainder
        ...
        public static void Clamp_MinGreaterThanMax_ThrowsArgumentException()
        {
            AssertExtensions.Throws<ArgumentException>(
                null,
                () => Math.Clamp((sbyte)1, (sbyte)2, (sbyte)1)
            );
            AssertExtensions.Throws<ArgumentException>(
                null,
                () => Math.Clamp((byte)1, (byte)2, (byte)1)
            );
            AssertExtensions.Throws<ArgumentException>(
                null,
                () => Math.Clamp((short)1, (short)2, (short)1)
            );
            AssertExtensions.Throws<ArgumentException>(
                null,
                () => Math.Clamp((ushort)1, (ushort)2, (ushort)1)
            );
            AssertExtensions.Throws<ArgumentException>(
                null,
                () => Math.Clamp((int)1, (int)2, (int)1)
            );
            AssertExtensions.Throws<ArgumentException>(
                null,
                () => Math.Clamp((uint)1, (uint)2, (uint)1)
            );
            AssertExtensions.Throws<ArgumentException>(
                null,
                () => Math.Clamp((long)1, (long)2, (long)1)
            );
            AssertExtensions.Throws<ArgumentException>(
                null,
                () => Math.Clamp((ulong)1, (ulong)2, (ulong)1)
            );

            AssertExtensions.Throws<ArgumentException>(
                null,
                () => Math.Clamp((float)1, (float)2, (float)1)
            );
            AssertExtensions.Throws<ArgumentException>(
                null,
                () => Math.Clamp((double)1, (double)2, (double)1)
            );
            AssertExtensions.Throws<ArgumentException>(
                null,
                () => Math.Clamp((decimal)1, (decimal)2, (decimal)1)
            );
        }
        ...
        [InlineData(
            0.11331473229676087,
            -4,
            0.0070821707685475542,
            CrossPlatformMachineEpsilon / 100
        )]
        [InlineData(
            0.15195522325791297,
            -3,
            0.018994402907239121,
            CrossPlatformMachineEpsilon / 10
        )]
        [InlineData(
            0.20269956628651730,
            -3,
            0.025337445785814663,
            CrossPlatformMachineEpsilon / 10
        )]
        [InlineData(
            0.33662253682241906,
            -2,
            0.084155634205604762,
            CrossPlatformMachineEpsilon / 10
        )]
        [InlineData(
            0.36787944117144232,
            -2,
            0.091969860292860584,
            CrossPlatformMachineEpsilon / 10
        )]
        [InlineData(
            0.37521422724648177,
            -2,
            0.093803556811620448,
            CrossPlatformMachineEpsilon / 10
        )]
