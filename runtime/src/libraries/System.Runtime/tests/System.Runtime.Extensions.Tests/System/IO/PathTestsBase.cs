...
namespace System.IO.Tests
{
    public class PathTestsBase
    {
        ...
        public static TheoryData<string> TestData_EmbeddedNull => new TheoryData<string> { "a\0b" };
        ...
        public static TheoryData<string> TestData_Periods =>
            new TheoryData<string>
            {
        ...
        public static TheoryData<string> TestData_ExtendedWildcards =>
            new TheoryData<string>
            {
        ...
        public static TheoryData<string> TestData_InvalidUnc =>
            new TheoryData<string>
            {
        ...
        public static TheoryData<string, string> TestData_GetPathRoot_DevicePaths =>
            new TheoryData<string, string>
            {
                {
                    @"\\?\UNC\test\unc\path\to\something",
                    PathFeatures.IsUsingLegacyPathNormalization() ? @"\\?\UNC" : @"\\?\UNC\test\unc"
                },
                {
                    @"\\?\UNC\test\unc",
                    PathFeatures.IsUsingLegacyPathNormalization() ? @"\\?\UNC" : @"\\?\UNC\test\unc"
                ...
                {
                    @"\\?\UNC\a\b1",
                    PathFeatures.IsUsingLegacyPathNormalization() ? @"\\?\UNC" : @"\\?\UNC\a\b1"
                },
                {
                    @"\\?\UNC\a\b2\",
                    PathFeatures.IsUsingLegacyPathNormalization() ? @"\\?\UNC" : @"\\?\UNC\a\b2"
                },
                {
                    @"\\?\C:\foo\bar.txt",
        ...
        protected static void GetTempPath_SetEnvVar_Helper(
            string envVar,
            string expected,
            string newTempPath
        )
