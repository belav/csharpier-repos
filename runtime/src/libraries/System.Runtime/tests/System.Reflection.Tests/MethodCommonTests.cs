...
namespace System.Reflection.Tests
{
    ...
    public abstract class MethodCommonTests
    {
        ...
        public void InvokeNullableRefs()
        {
            ...
            Assert.True(
                (bool)Invoke(GetMethod(nameof(NullableRefMethods.NullToValue)), null, args)
            );
            ...
            Assert.True(
                (bool)Invoke(GetMethod(nameof(NullableRefMethods.ValueToNull)), null, args)
            );
            Assert.Null(args[0]);
            ...
            args = new object[] { iNull, 10 };
            Assert.True(
                (bool)Invoke(GetMethod(nameof(NullableRefMethods.NullToValueBoxed)), null, args)
            );
            Assert.IsType<int>(args[0]);
            Assert.Equal(10, (int)args[0]);

            static MethodInfo GetMethod(string name) =>
                typeof(NullableRefMethods).GetMethod(
                    name,
        ...
        public void InvokeEnum()
        {
            ...
            Assert.True(
                (bool)
                    GetMethod(nameof(EnumMethods.PassColorsInt))
        ...
        {
            MethodInfo method = typeof(EnumMethods).GetMethod(
                "NullableEnumDefaultNo",
        ...
        public void ValueTypeMembers_WithOverrides()
        {
            ...
            Assert.Equal(
                ...
                (string)Invoke(
                    GetMethod(
                        typeof(ValueTypeWithOverrides),
                        nameof(ValueTypeWithOverrides.ToString)
                    ),
                    obj,
                    null
                )
            ...
            Assert.Equal(
                1,
                (int)Invoke(
                    GetMethod(typeof(ValueTypeWithOverrides), nameof(ValueTypeWithOverrides.GetId)),
                    obj,
                    null
                )
            );
        ...
        public void ValueTypeMembers_WithoutOverrides()
        {
            ...
            Assert.Equal(
                typeof(ValueTypeWithoutOverrides).ToString(),
                (string)Invoke(
                    GetMethod(
                        typeof(ValueTypeWithoutOverrides),
                        nameof(ValueTypeWithoutOverrides.ToString)
                    ),
                    obj,
                    null
                )
            ...
            Assert.Equal(
                ...
                (int)Invoke(
                    GetMethod(
                        typeof(ValueTypeWithoutOverrides),
                        nameof(ValueTypeWithoutOverrides.GetId)
                    ),
                    obj,
                    null
                )
        ...
        public void CopyBackWithByRefArgs()
        {
            ...
            Invoke(
                GetMethod(typeof(CopyBackMethods), nameof(CopyBackMethods.IncrementByRef)),
                null,
                args
            );
            ...
            args = new object[] { i };
            Invoke(
                GetMethod(typeof(CopyBackMethods), nameof(CopyBackMethods.IncrementByNullableRef)),
                null,
                args
            );
            Assert.Equal(43, (int)args[0]);
            ...
            args = new object[] { o };
            Invoke(
                GetMethod(typeof(CopyBackMethods), nameof(CopyBackMethods.SetToNonNullByRef)),
                null,
                args
            );
            ...
            args = new object[] { o };
            Invoke(
                GetMethod(typeof(CopyBackMethods), nameof(CopyBackMethods.SetToNullByRef)),
                null,
                args
            );
            Assert.Null(args[0]);
        ...
        public unsafe void TestFunctionPointerAsIntPtrArgType()
        {
            ...
            m = GetMethod(
                typeof(FunctionPointerMethods),
                nameof(FunctionPointerMethods.CallFcnPtr_IntPtr)
            );
            ...
            m = GetMethod(
                typeof(FunctionPointerMethods),
                nameof(FunctionPointerMethods.CallFcnPtr_Void)
            );
            Assert.True((bool)Invoke(m, null, new object[] { (IntPtr)fn, 42 }));
            Assert.False((bool)Invoke(m, null, new object[] { (IntPtr)fn, 41 }));
        }
        ...
        public unsafe void TestFunctionPointerAsUIntPtrArgType()
        {
            ...
            m = GetMethod(
                typeof(FunctionPointerMethods),
                nameof(FunctionPointerMethods.CallFcnPtr_UIntPtr)
            );
        ...
        public unsafe void TestFunctionPointerAsArgType()
        {
            ...
            MethodInfo m = GetMethod(
                typeof(FunctionPointerMethods),
                nameof(FunctionPointerMethods.CallFcnPtr_FP)
            );
            Assert.True((bool)Invoke(m, null, new object[] { (IntPtr)fn, 42 }));
            Assert.False((bool)Invoke(m, null, new object[] { (IntPtr)fn, 41 }));
        }
        ...
        public unsafe void TestFunctionPointerAsReturnType()
        {
            MethodInfo m = GetMethod(
                typeof(FunctionPointerMethods),
                nameof(FunctionPointerMethods.GetFunctionPointer)
            );
