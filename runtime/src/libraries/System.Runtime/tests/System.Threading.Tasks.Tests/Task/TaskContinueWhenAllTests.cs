    ...
    public class TaskContinueWhenAllTests
    {
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                for (int j = 0; j < 2; j++)
                {
                    ...
                    for (int x = 0; x < 2; x++)
                    {
                        ...
                        if (useFutureFactory && !continuationsAreFutures)
                            continue;

                        Debug.WriteLine(
                            "    Testing {0} = {3}.Factory.CWAll({1}, {2})",
                        ...
                        {
                            makeCWAllFutureArrays(
                                smallSize,
                                largeSize,
                                out smallFutureArray,
                        ...
                        Assert.True(
                            (result == 10) || (!continuationsAreFutures),
                            "Expected valid result from tSmall"
                        );
                        ...
                        Assert.True(
                            (result == 20) || (!continuationsAreFutures),
                            "Expected valid result from tLarge"
                        );
                ...
                for (int j = 0; j < 2; j++)
                {
                    ...
                    for (int k = 0; k < 2; k++)
                    {
                        ...
                        for (int x = 0; x < 2; x++)
                        {
                            ...
                            Debug.WriteLine(
                                "    Testing {0} = {4}.Factory.CWAll({1}, {3}, ct({2}))",
                                continuationsAreFutures ? "Future" : "Task",
                                antecedentsAreFutures ? "Future[]" : "Task[]",
                            ...
                            Assert.True(
                                ...
                                "Expected tSmall.Wait() exception only on preCanceledToken"
                            );
                            if (preCanceledToken)
                            {
                                if (ex != null)
                                ...
                                Assert.True(
                                    tLarge.IsCompleted,
                                    "Expected tLarge to complete immediately on pre-canceled token"
                                );
                            ...
                            else // !preCanceledToken
                            {
                                ...
                                Assert.False(
                                    tLarge.IsCompleted,
                                    "tLarge completed before its time"
                                );
                            }
                            ...
                            Assert.True(
                                preCanceledToken == (ex != null),
                                "Expected tLarge.Wait() exception only on preCanceledToken"
                            );
                            if (preCanceledToken)
                            {
                                if (ex != null)
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                for (int j = 0; j < 2; j++)
                {
                    ...
                    for (int k = 0; k < 2; k++)
                    {
                        ...
                        TaskContinuationOptions tco = longRunning
                        ...
                        for (int x = 0; x < 2; x++)
                        {
                            ...
                            Debug.WriteLine(
                                "    Testing {0} = {3}.Factory.CWAll({1}, {2}, {4})",
                                continuationsAreFutures ? "Future" : "Task",
                                antecedentsAreFutures ? "Future[]" : "Task[]",
                                continuationsAreFutures ? "func" : "action",
                                useFutureFactory ? "Task<int>" : "Task",
                            ...
                            Assert.False(tLarge.IsCompleted, "tLarge completed before its time");
                            Assert.Equal(
                                (tSmall.CreationOptions & TaskCreationOptions.LongRunning) != 0,
                                longRunning
                            );
                            Assert.True(
                                (tSmall.CreationOptions == TaskCreationOptions.None) || longRunning,
                                "tSmall CreationOptions should be None unless longRunning is true"
                            );
                            ...
                            Assert.Equal(
                                (tLarge.CreationOptions & TaskCreationOptions.LongRunning) != 0,
                                longRunning
                            );
                            Assert.True(
                                (tLarge.CreationOptions == TaskCreationOptions.None) || longRunning,
                                "tLarge CreationOptions should be None unless longRunning is true"
                            );
                        } // end x-loop (FutureFactory or TaskFactory)
                ...
                for (int j = 0; j < 2; j++)
                {
                    ...
                    for (int k = 0; k < 2; k++)
                    {
                        ...
                        for (int x = 0; x < 2; x++)
                        {
                            ...
                            Debug.WriteLine(
                                "    Testing {0} = {4}.Factory.CWAll({1}, {3}, ct({2}), tco.None, ts.Default)",
                                continuationsAreFutures ? "Future" : "Task",
                                antecedentsAreFutures ? "Future[]" : "Task[]",
                                preCanceledToken ? "signaled" : "unsignaled",
                                continuationsAreFutures ? "func" : "action",
        ...
        private static void CheckForCorrectCT(Task canceledTask, CancellationToken correctToken)
        {
            try
            {
                canceledTask.Wait();
                Assert.Fail(
                    string.Format("    > FAILED!  Pre-canceled result did not throw from Wait()")
                );
            }
        ...
        private static void makeCWAllFutureArrays(
            int smallSize,
            int largeSize,
            out Task<int>[] aSmall,
            out Task<int>[] aLarge
        ...
        private static void makeCWAllTaskArrays(
            int smallSize,
            int largeSize,
            out Task[] aSmall,
            out Task[] aLarge
