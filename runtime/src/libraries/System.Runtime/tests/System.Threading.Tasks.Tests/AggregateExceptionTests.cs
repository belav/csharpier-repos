...
namespace System.Threading.Tasks.Tests
{
    public class AggregateExceptionTests
    {
        ...
        public static void ConstructorBasic()
        {
            ...
            Assert.True(
                ex.Message != null,
                "RunAggregateException_Constructor:  FAILED. Message property is null when the default constructor is used, expected a default message"
            );
            ...
            Assert.True(
                ex.Message != null,
                "RunAggregateException_Constructor:  FAILED. Message property is  null when the default constructor(string) is used"
            );
            ...
            Assert.True(
                ex.Message != null,
                "RunAggregateException_Constructor:  FAILED. Message property is  null when the default constructor(string, Exception) is used"
            );
        }
        ...
        public static void Handle()
        {
            ...
            ex = new AggregateException(
                new[] { new ArgumentException(), new ArgumentException(), new ArgumentException() }
            );
            int handledCount = 0;
            ex.Handle(
                (e) =>
        ...
        public static void Flatten()
        {
            ...
            AggregateException aggExceptionBase = new AggregateException(
                "message",
                exceptionA,
                exceptionB,
                exceptionC
            ...
            Exception[] expected1 = new Exception[] { exceptionA, exceptionB, exceptionC };
            ...
            AggregateException aggExceptionRecurse = new AggregateException(
                "message",
                aggExceptionBase,
                aggExceptionBase
            );
