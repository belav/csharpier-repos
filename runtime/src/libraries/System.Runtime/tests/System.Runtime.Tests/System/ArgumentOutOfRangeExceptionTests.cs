...
namespace System.Tests
{
    public static class ArgumentOutOfRangeExceptionTests
    {
        ...
        private static Action EqualHelper<T>(T value, T other)
            where T : IEquatable<T> => () => ArgumentOutOfRangeException.ThrowIfEqual(value, other);

        private static Action NotEqualHelper<T>(T value, T other)
        ...
        public static void GenericHelpers_ThrowIfZero_Throws()
        {
            Assert.Equal(
                0,
                AssertExtensions
                    .Throws<ArgumentOutOfRangeException>(HelpersParamName, ZeroHelper<int>(0))
                    .ActualValue
            );
            Assert.Equal(
                0u,
                AssertExtensions
                    .Throws<ArgumentOutOfRangeException>(HelpersParamName, ZeroHelper<uint>(0))
                    .ActualValue
            );
            ...
            Assert.Equal(
                0.0f,
                AssertExtensions
                    .Throws<ArgumentOutOfRangeException>(HelpersParamName, ZeroHelper<float>(0.0f))
                    .ActualValue
            );
            Assert.Equal(
                -0.0f,
            ...
            Assert.Equal(
                (double)0,
                AssertExtensions
                    .Throws<ArgumentOutOfRangeException>(HelpersParamName, ZeroHelper<double>(0))
                    .ActualValue
            );
            Assert.Equal(
                +0.0,
                AssertExtensions
                    .Throws<ArgumentOutOfRangeException>(HelpersParamName, ZeroHelper<double>(+0.0))
                    .ActualValue
            );
            Assert.Equal(
                -0.0,
        ...
        public static void GenericHelpers_ThrowIfNegativeZero_Throws()
        {
            ...
            Assert.Equal(
                ...
                AssertExtensions
                    .Throws<ArgumentOutOfRangeException>(
                        HelpersParamName,
                        NegativeOrZeroHelper<float>(-0.0f)
                    )
                    .ActualValue
            );
            Assert.Equal(
                ...
                AssertExtensions
                    .Throws<ArgumentOutOfRangeException>(
                        HelpersParamName,
                        NegativeOrZeroHelper<double>(-0.0)
                    )
                    .ActualValue
            );
        ...
        public static void GenericHelpers_ThrowIfGreaterThan_Throws()
        {
            ...
            Assert.Equal(
                ...
                AssertExtensions
                    .Throws<ArgumentOutOfRangeException>(
                        HelpersParamName,
                        GreaterThanHelper<double>(1.000000001, 1)
                    )
                    .ActualValue
            );
            Assert.Equal(
                ...
                AssertExtensions
                    .Throws<ArgumentOutOfRangeException>(
                        HelpersParamName,
                        GreaterThanHelper<float>(1.00001f, 1)
                    )
                    .ActualValue
            );
        ...
        public static void GenericHelpers_ThrowIfGreaterThanOrEqual_Throws()
        {
            Assert.Equal(
                ...
                AssertExtensions
                    .Throws<ArgumentOutOfRangeException>(
                        HelpersParamName,
                        GreaterThanOrEqualHelper<int>(1, 1)
                    )
                    .ActualValue
            );
            Assert.Equal(
                ...
                AssertExtensions
                    .Throws<ArgumentOutOfRangeException>(
                        HelpersParamName,
                        GreaterThanOrEqualHelper<uint>(1, 1)
                    )
                    .ActualValue
            );
            Assert.Equal(
                ...
                AssertExtensions
                    .Throws<ArgumentOutOfRangeException>(
                        HelpersParamName,
                        GreaterThanOrEqualHelper<double>(1, 1)
                    )
                    .ActualValue
            );
            Assert.Equal(
                ...
                AssertExtensions
                    .Throws<ArgumentOutOfRangeException>(
                        HelpersParamName,
                        GreaterThanOrEqualHelper<float>(1, 1)
                    )
                    .ActualValue
            );
            ...
            Assert.Equal(
                ...
                AssertExtensions
                    .Throws<ArgumentOutOfRangeException>(
                        HelpersParamName,
                        GreaterThanOrEqualHelper<int>(3, 1)
                    )
                    .ActualValue
            );
            Assert.Equal(
                ...
                AssertExtensions
                    .Throws<ArgumentOutOfRangeException>(
                        HelpersParamName,
                        GreaterThanOrEqualHelper<uint>(4, 1)
                    )
                    .ActualValue
            );
            Assert.Equal(
                ...
                AssertExtensions
                    .Throws<ArgumentOutOfRangeException>(
                        HelpersParamName,
                        GreaterThanOrEqualHelper<double>(1.1, 1)
                    )
                    .ActualValue
            );
            Assert.Equal(
                ...
                AssertExtensions
                    .Throws<ArgumentOutOfRangeException>(
                        HelpersParamName,
                        GreaterThanOrEqualHelper<float>(2.1f, 1)
                    )
                    .ActualValue
            );
        ...
        public static void GenericHelpers_ThrowIfLessThan_Throws()
        {
            ...
            Assert.Equal(
                ...
                AssertExtensions
                    .Throws<ArgumentOutOfRangeException>(
                        HelpersParamName,
                        LessThanHelper<double>(1, 1.000000001)
                    )
                    .ActualValue
            );
            Assert.Equal(
                ...
                AssertExtensions
                    .Throws<ArgumentOutOfRangeException>(
                        HelpersParamName,
                        LessThanHelper<float>(1, 1.00001f)
                    )
                    .ActualValue
            );
        ...
        public static void GenericHelpers_ThrowIfLessThanOrEqual_Throws()
        {
            ...
            Assert.Equal(
                ...
                AssertExtensions
                    .Throws<ArgumentOutOfRangeException>(
                        HelpersParamName,
                        LessThanOrEqualHelper<uint>(0, 1)
                    )
                    .ActualValue
            );
            Assert.Equal(
                ...
                AssertExtensions
                    .Throws<ArgumentOutOfRangeException>(
                        HelpersParamName,
                        LessThanOrEqualHelper<double>(0.9, 1)
                    )
                    .ActualValue
            );
            Assert.Equal(
                ...
                AssertExtensions
                    .Throws<ArgumentOutOfRangeException>(
                        HelpersParamName,
                        LessThanOrEqualHelper<float>(-0.1f, 1)
                    )
                    .ActualValue
            );
            ...
            Assert.Equal(
                ...
                AssertExtensions
                    .Throws<ArgumentOutOfRangeException>(
                        HelpersParamName,
                        LessThanOrEqualHelper<uint>(1, 1)
                    )
                    .ActualValue
            );
            Assert.Equal(
                ...
                AssertExtensions
                    .Throws<ArgumentOutOfRangeException>(
                        HelpersParamName,
                        LessThanOrEqualHelper<double>(1, 1)
                    )
                    .ActualValue
            );
            Assert.Equal(
                ...
                AssertExtensions
                    .Throws<ArgumentOutOfRangeException>(
                        HelpersParamName,
                        LessThanOrEqualHelper<float>(1, 1)
                    )
                    .ActualValue
            );
        ...
        public static void GenericHelpers_ThrowIfEqual_Throws()
        {
            Assert.Equal(
                1,
                AssertExtensions
                    .Throws<ArgumentOutOfRangeException>(HelpersParamName, EqualHelper<int>(1, 1))
                    .ActualValue
            );
            Assert.Equal(
                1u,
                AssertExtensions
                    .Throws<ArgumentOutOfRangeException>(HelpersParamName, EqualHelper<uint>(1, 1))
                    .ActualValue
            );
            Assert.Equal(
                (double)1,
            ...
            Assert.Equal(
                1f,
                AssertExtensions
                    .Throws<ArgumentOutOfRangeException>(HelpersParamName, EqualHelper<float>(1, 1))
                    .ActualValue
            );
            Assert.Null(
                AssertExtensions
        ...
        public static void GenericHelpers_ThrowIfNotEqual_Throws()
        {
            ...
            Assert.Equal(
                ...
                AssertExtensions
                    .Throws<ArgumentOutOfRangeException>(
                        HelpersParamName,
                        NotEqualHelper<string>("test", null)
                    )
                    .ActualValue
            );
            Assert.Null(
                AssertExtensions
                    .Throws<ArgumentOutOfRangeException>(
                        HelpersParamName,
                        NotEqualHelper<string>(null, "test")
                    )
                    .ActualValue
            );
