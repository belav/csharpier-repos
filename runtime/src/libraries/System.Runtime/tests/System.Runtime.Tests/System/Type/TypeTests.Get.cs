...
namespace System.Tests
{
    public partial class TypeTests
    {
        public static IEnumerable<object[]> GetInterface_TestData()
        {
            ...
            yield return new object[]
            {
                typeof(ClassWithNamespacedInterfaces),
                "System.Tests.Inner.Interface1",
                false,
                typeof(Inner.Interface1),
            };
            yield return new object[]
            {
                typeof(ClassWithNamespacedInterfaces),
            ...
            yield return new object[]
            {
                ...
                "MixedInterface",
                false,
                typeof(MixedInterface),
            };

            // Generic type variables.
            yield return new object[]
            {
                typeof(GenericClassWithNoConstraints<>).GetTypeInfo().GenericTypeParameters[0],
                "NoSuchInterface",
                false,
                null,
            };
            ...
            yield return new object[]
            {
                typeof(GenericClassWithConstraints<>).GetTypeInfo().GenericTypeParameters[0],
                "Interface1",
                false,
                typeof(Interface1),
            };
        ...
        public void GetInterface_Invoke_ReturnsExpected(
            Type type,
            string name,
            bool ignoreCase,
            Type expected
        ...
        {
            AssertExtensions.Throws<ArgumentNullException>("fullname", () =>
                typeof(int).GetInterface(null)
            );
        }
