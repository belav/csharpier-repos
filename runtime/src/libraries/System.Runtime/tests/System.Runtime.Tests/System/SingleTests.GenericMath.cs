    ...
    public class SingleTests_GenericMath
    {
        ...
        public static void op_AdditionTest()
        {
            AssertBitwiseEqual(
                ...
                AdditionOperatorsHelper<float, float, float>.op_Addition(
                    float.NegativeInfinity,
                    1.0f
                )
            );
            AssertBitwiseEqual(
                float.MinValue,
                AdditionOperatorsHelper<float, float, float>.op_Addition(float.MinValue, 1.0f)
            );
            AssertBitwiseEqual(
                0.0f,
                AdditionOperatorsHelper<float, float, float>.op_Addition(-1.0f, 1.0f)
            );
            AssertBitwiseEqual(
                1.0f,
                AdditionOperatorsHelper<float, float, float>.op_Addition(-MinNormal, 1.0f)
            );
            AssertBitwiseEqual(
                1.0f,
                AdditionOperatorsHelper<float, float, float>.op_Addition(-MaxSubnormal, 1.0f)
            );
            AssertBitwiseEqual(
                1.0f,
                AdditionOperatorsHelper<float, float, float>.op_Addition(-float.Epsilon, 1.0f)
            );
            AssertBitwiseEqual(
                1.0f,
                AdditionOperatorsHelper<float, float, float>.op_Addition(-0.0f, 1.0f)
            );
            AssertBitwiseEqual(
                float.NaN,
                AdditionOperatorsHelper<float, float, float>.op_Addition(float.NaN, 1.0f)
            );
            AssertBitwiseEqual(
                1.0f,
                AdditionOperatorsHelper<float, float, float>.op_Addition(0.0f, 1.0f)
            ...
            AssertBitwiseEqual(
                float.MaxValue,
                AdditionOperatorsHelper<float, float, float>.op_Addition(float.MaxValue, 1.0f)
            );
            AssertBitwiseEqual(
        ...
        public static void op_CheckedAdditionTest()
        {
            AssertBitwiseEqual(
                float.NegativeInfinity,
                AdditionOperatorsHelper<float, float, float>.op_CheckedAddition(
                    float.NegativeInfinity,
                    1.0f
                )
            );
            ...
            AssertBitwiseEqual(
                0.0f,
                AdditionOperatorsHelper<float, float, float>.op_CheckedAddition(-1.0f, 1.0f)
            );
            AssertBitwiseEqual(
                1.0f,
                AdditionOperatorsHelper<float, float, float>.op_CheckedAddition(-MinNormal, 1.0f)
            );
            AssertBitwiseEqual(
                1.0f,
                AdditionOperatorsHelper<float, float, float>.op_CheckedAddition(-MaxSubnormal, 1.0f)
            );
            AssertBitwiseEqual(
                1.0f,
                AdditionOperatorsHelper<float, float, float>.op_CheckedAddition(
            ...
            AssertBitwiseEqual(
                1.0f,
                AdditionOperatorsHelper<float, float, float>.op_CheckedAddition(-0.0f, 1.0f)
            );
            AssertBitwiseEqual(
                float.NaN,
                AdditionOperatorsHelper<float, float, float>.op_CheckedAddition(float.NaN, 1.0f)
            );
            AssertBitwiseEqual(
                1.0f,
                AdditionOperatorsHelper<float, float, float>.op_CheckedAddition(0.0f, 1.0f)
            ...
            AssertBitwiseEqual(
                1.0f,
                AdditionOperatorsHelper<float, float, float>.op_CheckedAddition(float.Epsilon, 1.0f)
            );
            AssertBitwiseEqual(
                1.0f,
                AdditionOperatorsHelper<float, float, float>.op_CheckedAddition(MaxSubnormal, 1.0f)
        ...
        public static void AllBitsSetTest()
        {
            Assert.Equal(
                0xFFFF_FFFF,
                BitConverter.SingleToUInt32Bits(BinaryNumberHelper<float>.AllBitsSet)
            );
            Assert.Equal(
                0U,
                ~BitConverter.SingleToUInt32Bits(BinaryNumberHelper<float>.AllBitsSet)
        ...
        public static void Log2Test()
        {
            ...
            AssertBitwiseEqual(
                float.PositiveInfinity,
                BinaryNumberHelper<float>.Log2(float.PositiveInfinity)
            );
        }
        ...
        {
            Assert.False(
                ComparisonOperatorsHelper<float, float, bool>.op_GreaterThan(
                    float.NegativeInfinity,
                    1.0f
                )
            );
            Assert.False(
                ComparisonOperatorsHelper<float, float, bool>.op_GreaterThan(float.MinValue, 1.0f)
            );
            Assert.False(ComparisonOperatorsHelper<float, float, bool>.op_GreaterThan(-1.0f, 1.0f));
            Assert.False(
                ComparisonOperatorsHelper<float, float, bool>.op_GreaterThan(-MinNormal, 1.0f)
            );
            Assert.False(
                ComparisonOperatorsHelper<float, float, bool>.op_GreaterThan(-MaxSubnormal, 1.0f)
            );
            Assert.False(
                ComparisonOperatorsHelper<float, float, bool>.op_GreaterThan(-float.Epsilon, 1.0f)
            );
            Assert.False(ComparisonOperatorsHelper<float, float, bool>.op_GreaterThan(-0.0f, 1.0f));
            Assert.False(
                ComparisonOperatorsHelper<float, float, bool>.op_GreaterThan(float.NaN, 1.0f)
            );
            Assert.False(ComparisonOperatorsHelper<float, float, bool>.op_GreaterThan(0.0f, 1.0f));
            Assert.False(
                ComparisonOperatorsHelper<float, float, bool>.op_GreaterThan(float.Epsilon, 1.0f)
            ...
            Assert.False(ComparisonOperatorsHelper<float, float, bool>.op_GreaterThan(1.0f, 1.0f));
            Assert.True(
                ComparisonOperatorsHelper<float, float, bool>.op_GreaterThan(float.MaxValue, 1.0f)
            );
            Assert.True(
                ComparisonOperatorsHelper<float, float, bool>.op_GreaterThan(
                    float.PositiveInfinity,
        ...
        {
            Assert.False(
                ComparisonOperatorsHelper<float, float, bool>.op_GreaterThanOrEqual(
                    float.NegativeInfinity,
                    1.0f
                )
            );
            ...
            Assert.False(
                ComparisonOperatorsHelper<float, float, bool>.op_GreaterThanOrEqual(-1.0f, 1.0f)
            );
            Assert.False(
                ComparisonOperatorsHelper<float, float, bool>.op_GreaterThanOrEqual(
                    -MinNormal,
            ...
            Assert.False(
                ComparisonOperatorsHelper<float, float, bool>.op_GreaterThanOrEqual(-0.0f, 1.0f)
            );
            Assert.False(
                ComparisonOperatorsHelper<float, float, bool>.op_GreaterThanOrEqual(float.NaN, 1.0f)
            );
            Assert.False(
                ComparisonOperatorsHelper<float, float, bool>.op_GreaterThanOrEqual(0.0f, 1.0f)
            );
            ...
            Assert.False(
                ComparisonOperatorsHelper<float, float, bool>.op_GreaterThanOrEqual(MinNormal, 1.0f)
            );
            Assert.True(
                ComparisonOperatorsHelper<float, float, bool>.op_GreaterThanOrEqual(1.0f, 1.0f)
            );
        ...
        {
            Assert.True(
                ComparisonOperatorsHelper<float, float, bool>.op_LessThan(
                    float.NegativeInfinity,
                    1.0f
                )
            );
            Assert.True(
                ComparisonOperatorsHelper<float, float, bool>.op_LessThan(float.MinValue, 1.0f)
            );
            Assert.True(ComparisonOperatorsHelper<float, float, bool>.op_LessThan(-1.0f, 1.0f));
            Assert.True(
                ComparisonOperatorsHelper<float, float, bool>.op_LessThan(-MinNormal, 1.0f)
            );
            Assert.True(
                ComparisonOperatorsHelper<float, float, bool>.op_LessThan(-MaxSubnormal, 1.0f)
            );
            Assert.True(
                ComparisonOperatorsHelper<float, float, bool>.op_LessThan(-float.Epsilon, 1.0f)
            );
            Assert.True(ComparisonOperatorsHelper<float, float, bool>.op_LessThan(-0.0f, 1.0f));
            Assert.False(
                ComparisonOperatorsHelper<float, float, bool>.op_LessThan(float.NaN, 1.0f)
            );
            Assert.True(ComparisonOperatorsHelper<float, float, bool>.op_LessThan(0.0f, 1.0f));
            Assert.True(
                ComparisonOperatorsHelper<float, float, bool>.op_LessThan(float.Epsilon, 1.0f)
            ...
            Assert.False(
                ComparisonOperatorsHelper<float, float, bool>.op_LessThan(float.MaxValue, 1.0f)
            );
            Assert.False(
                ComparisonOperatorsHelper<float, float, bool>.op_LessThan(
                    float.PositiveInfinity,
        ...
        {
            Assert.True(
                ComparisonOperatorsHelper<float, float, bool>.op_LessThanOrEqual(
                    float.NegativeInfinity,
                    1.0f
                )
            );
            ...
            Assert.True(
                ComparisonOperatorsHelper<float, float, bool>.op_LessThanOrEqual(-1.0f, 1.0f)
            );
            Assert.True(
                ComparisonOperatorsHelper<float, float, bool>.op_LessThanOrEqual(-MinNormal, 1.0f)
            );
            Assert.True(
                ComparisonOperatorsHelper<float, float, bool>.op_LessThanOrEqual(
                    -MaxSubnormal,
            ...
            Assert.True(
                ComparisonOperatorsHelper<float, float, bool>.op_LessThanOrEqual(-0.0f, 1.0f)
            );
            Assert.False(
                ComparisonOperatorsHelper<float, float, bool>.op_LessThanOrEqual(float.NaN, 1.0f)
            );
            Assert.True(
                ComparisonOperatorsHelper<float, float, bool>.op_LessThanOrEqual(0.0f, 1.0f)
            );
            ...
            Assert.True(
                ComparisonOperatorsHelper<float, float, bool>.op_LessThanOrEqual(MaxSubnormal, 1.0f)
            );
            Assert.True(
                ComparisonOperatorsHelper<float, float, bool>.op_LessThanOrEqual(MinNormal, 1.0f)
            );
        ...
        public static void op_DecrementTest()
        {
            AssertBitwiseEqual(
                float.NegativeInfinity,
                DecrementOperatorsHelper<float>.op_Decrement(float.NegativeInfinity)
            );
            AssertBitwiseEqual(
                float.MinValue,
                DecrementOperatorsHelper<float>.op_Decrement(float.MinValue)
            );
            ...
            AssertBitwiseEqual(
                float.MaxValue,
                DecrementOperatorsHelper<float>.op_Decrement(float.MaxValue)
            );
            AssertBitwiseEqual(
                float.PositiveInfinity,
                DecrementOperatorsHelper<float>.op_Decrement(float.PositiveInfinity)
            );
        }
        ...
        public static void op_CheckedDecrementTest()
        {
            AssertBitwiseEqual(
                float.NegativeInfinity,
                DecrementOperatorsHelper<float>.op_CheckedDecrement(float.NegativeInfinity)
            );
            AssertBitwiseEqual(
                float.MinValue,
                DecrementOperatorsHelper<float>.op_CheckedDecrement(float.MinValue)
            );
            AssertBitwiseEqual(-2.0f, DecrementOperatorsHelper<float>.op_CheckedDecrement(-1.0f));
            AssertBitwiseEqual(
                -1.0f,
                DecrementOperatorsHelper<float>.op_CheckedDecrement(-MinNormal)
            );
            AssertBitwiseEqual(
                -1.0f,
                DecrementOperatorsHelper<float>.op_CheckedDecrement(-MaxSubnormal)
            );
            AssertBitwiseEqual(
                -1.0f,
                DecrementOperatorsHelper<float>.op_CheckedDecrement(-float.Epsilon)
            );
            AssertBitwiseEqual(-1.0f, DecrementOperatorsHelper<float>.op_CheckedDecrement(-0.0f));
            AssertBitwiseEqual(
                float.NaN,
                DecrementOperatorsHelper<float>.op_CheckedDecrement(float.NaN)
            );
            AssertBitwiseEqual(-1.0f, DecrementOperatorsHelper<float>.op_CheckedDecrement(0.0f));
            AssertBitwiseEqual(
                -1.0f,
            ...
            AssertBitwiseEqual(
                float.MaxValue,
                DecrementOperatorsHelper<float>.op_CheckedDecrement(float.MaxValue)
            );
            AssertBitwiseEqual(
                float.PositiveInfinity,
                DecrementOperatorsHelper<float>.op_CheckedDecrement(float.PositiveInfinity)
            );
        }
        ...
        public static void op_DivisionTest()
        {
            AssertBitwiseEqual(
                float.NegativeInfinity,
                DivisionOperatorsHelper<float, float, float>.op_Division(
                    float.NegativeInfinity,
                    2.0f
                )
            );
            AssertBitwiseEqual(
                -1.70141173E+38f,
                DivisionOperatorsHelper<float, float, float>.op_Division(float.MinValue, 2.0f)
            );
            AssertBitwiseEqual(
                -0.5f,
                DivisionOperatorsHelper<float, float, float>.op_Division(-1.0f, 2.0f)
            );
            AssertBitwiseEqual(
                -5.87747175E-39f,
                DivisionOperatorsHelper<float, float, float>.op_Division(-MinNormal, 2.0f)
            );
            AssertBitwiseEqual(
                -5.87747175E-39f,
                DivisionOperatorsHelper<float, float, float>.op_Division(-MaxSubnormal, 2.0f)
            );
            AssertBitwiseEqual(
                -0.0f,
                DivisionOperatorsHelper<float, float, float>.op_Division(-float.Epsilon, 2.0f)
            );
            AssertBitwiseEqual(
                -0.0f,
                DivisionOperatorsHelper<float, float, float>.op_Division(-0.0f, 2.0f)
            );
            AssertBitwiseEqual(
                float.NaN,
                DivisionOperatorsHelper<float, float, float>.op_Division(float.NaN, 2.0f)
            );
            AssertBitwiseEqual(
                0.0f,
                DivisionOperatorsHelper<float, float, float>.op_Division(0.0f, 2.0f)
            ...
            AssertBitwiseEqual(
                1.70141173E+38f,
                DivisionOperatorsHelper<float, float, float>.op_Division(float.MaxValue, 2.0f)
            );
            AssertBitwiseEqual(
                float.PositiveInfinity,
                DivisionOperatorsHelper<float, float, float>.op_Division(
        ...
        public static void op_CheckedDivisionTest()
        {
            AssertBitwiseEqual(
                float.NegativeInfinity,
                DivisionOperatorsHelper<float, float, float>.op_CheckedDivision(
                    float.NegativeInfinity,
                    2.0f
                )
            );
            ...
            AssertBitwiseEqual(
                -0.5f,
                DivisionOperatorsHelper<float, float, float>.op_CheckedDivision(-1.0f, 2.0f)
            );
            AssertBitwiseEqual(
                -5.87747175E-39f,
                DivisionOperatorsHelper<float, float, float>.op_CheckedDivision(-MinNormal, 2.0f)
            );
            AssertBitwiseEqual(
                -5.87747175E-39f,
                DivisionOperatorsHelper<float, float, float>.op_CheckedDivision(-MaxSubnormal, 2.0f)
            );
            AssertBitwiseEqual(
                -0.0f,
                DivisionOperatorsHelper<float, float, float>.op_CheckedDivision(
            ...
            AssertBitwiseEqual(
                -0.0f,
                DivisionOperatorsHelper<float, float, float>.op_CheckedDivision(-0.0f, 2.0f)
            );
            AssertBitwiseEqual(
                float.NaN,
                DivisionOperatorsHelper<float, float, float>.op_CheckedDivision(float.NaN, 2.0f)
            );
            AssertBitwiseEqual(
                0.0f,
                DivisionOperatorsHelper<float, float, float>.op_CheckedDivision(0.0f, 2.0f)
            ...
            AssertBitwiseEqual(
                0.0f,
                DivisionOperatorsHelper<float, float, float>.op_CheckedDivision(float.Epsilon, 2.0f)
            );
            AssertBitwiseEqual(
                5.87747175E-39f,
                DivisionOperatorsHelper<float, float, float>.op_CheckedDivision(MaxSubnormal, 2.0f)
        ...
        {
            Assert.False(
                EqualityOperatorsHelper<float, float, bool>.op_Equality(
                    float.NegativeInfinity,
                    1.0f
                )
            );
            Assert.False(
                EqualityOperatorsHelper<float, float, bool>.op_Equality(float.MinValue, 1.0f)
            );
            ...
            Assert.False(
                EqualityOperatorsHelper<float, float, bool>.op_Equality(-MaxSubnormal, 1.0f)
            );
            Assert.False(
                EqualityOperatorsHelper<float, float, bool>.op_Equality(-float.Epsilon, 1.0f)
            );
            ...
            Assert.False(
                EqualityOperatorsHelper<float, float, bool>.op_Equality(float.MaxValue, 1.0f)
            );
            Assert.False(
                EqualityOperatorsHelper<float, float, bool>.op_Equality(
                    float.PositiveInfinity,
        ...
        {
            Assert.True(
                EqualityOperatorsHelper<float, float, bool>.op_Inequality(
                    float.NegativeInfinity,
                    1.0f
                )
            );
            Assert.True(
                EqualityOperatorsHelper<float, float, bool>.op_Inequality(float.MinValue, 1.0f)
            );
            Assert.True(EqualityOperatorsHelper<float, float, bool>.op_Inequality(-1.0f, 1.0f));
            Assert.True(
                EqualityOperatorsHelper<float, float, bool>.op_Inequality(-MinNormal, 1.0f)
            );
            Assert.True(
                EqualityOperatorsHelper<float, float, bool>.op_Inequality(-MaxSubnormal, 1.0f)
            );
            Assert.True(
                EqualityOperatorsHelper<float, float, bool>.op_Inequality(-float.Epsilon, 1.0f)
            );
            ...
            Assert.True(
                EqualityOperatorsHelper<float, float, bool>.op_Inequality(float.MaxValue, 1.0f)
            );
            Assert.True(
                EqualityOperatorsHelper<float, float, bool>.op_Inequality(
                    float.PositiveInfinity,
        ...
        public static void GetExponentByteCountTest()
        {
            Assert.Equal(
                1,
                FloatingPointHelper<float>.GetExponentByteCount(float.NegativeInfinity)
            );
            ...
            Assert.Equal(
                1,
                FloatingPointHelper<float>.GetExponentByteCount(float.PositiveInfinity)
            );
        }
        ...
        public static void GetExponentShortestBitLengthTest()
        {
            Assert.Equal(
                8,
                FloatingPointHelper<float>.GetExponentShortestBitLength(float.NegativeInfinity)
            );
            Assert.Equal(
                7,
                FloatingPointHelper<float>.GetExponentShortestBitLength(float.MinValue)
            );
            ...
            Assert.Equal(
                8,
                FloatingPointHelper<float>.GetExponentShortestBitLength(-float.Epsilon)
            );
            ...
            Assert.Equal(
                7,
                FloatingPointHelper<float>.GetExponentShortestBitLength(float.MaxValue)
            );
            Assert.Equal(
                8,
                FloatingPointHelper<float>.GetExponentShortestBitLength(float.PositiveInfinity)
            );
        }
        ...
        public static void GetSignificandByteCountTest()
        {
            Assert.Equal(
                4,
                FloatingPointHelper<float>.GetSignificandByteCount(float.NegativeInfinity)
            );
            ...
            Assert.Equal(
                4,
                FloatingPointHelper<float>.GetSignificandByteCount(float.PositiveInfinity)
            );
        }
        ...
        public static void GetSignificandBitLengthTest()
        {
            Assert.Equal(
                24,
                FloatingPointHelper<float>.GetSignificandBitLength(float.NegativeInfinity)
            );
            ...
            Assert.Equal(
                24,
                FloatingPointHelper<float>.GetSignificandBitLength(float.PositiveInfinity)
            );
        }
        ...
        public static void TryWriteExponentBigEndianTest()
        {
            ...
            Assert.True(
                FloatingPointHelper<float>.TryWriteExponentBigEndian(
                    float.NegativeInfinity,
                    destination,
                    out bytesWritten
                )
        ...
        public static void TryWriteExponentLittleEndianTest()
        {
            ...
            Assert.True(
                FloatingPointHelper<float>.TryWriteExponentLittleEndian(
                    float.NegativeInfinity,
                    destination,
                    out bytesWritten
                )
        ...
        public static void TryWriteSignificandBigEndianTest()
        {
            ...
            Assert.True(
                FloatingPointHelper<float>.TryWriteSignificandBigEndian(
                    float.NegativeInfinity,
                    destination,
                    out bytesWritten
                )
        ...
        public static void TryWriteSignificandLittleEndianTest()
        {
            ...
            Assert.True(
                FloatingPointHelper<float>.TryWriteSignificandLittleEndian(
                    float.NegativeInfinity,
                    destination,
                    out bytesWritten
                )
        ...
        public static void op_IncrementTest()
        {
            AssertBitwiseEqual(
                float.NegativeInfinity,
                IncrementOperatorsHelper<float>.op_Increment(float.NegativeInfinity)
            );
            AssertBitwiseEqual(
                float.MinValue,
                IncrementOperatorsHelper<float>.op_Increment(float.MinValue)
            );
            ...
            AssertBitwiseEqual(
                float.MaxValue,
                IncrementOperatorsHelper<float>.op_Increment(float.MaxValue)
            );
            AssertBitwiseEqual(
                float.PositiveInfinity,
                IncrementOperatorsHelper<float>.op_Increment(float.PositiveInfinity)
            );
        }
        ...
        public static void op_CheckedIncrementTest()
        {
            AssertBitwiseEqual(
                float.NegativeInfinity,
                IncrementOperatorsHelper<float>.op_CheckedIncrement(float.NegativeInfinity)
            );
            AssertBitwiseEqual(
                float.MinValue,
                IncrementOperatorsHelper<float>.op_CheckedIncrement(float.MinValue)
            );
            AssertBitwiseEqual(0.0f, IncrementOperatorsHelper<float>.op_CheckedIncrement(-1.0f));
            AssertBitwiseEqual(
                1.0f,
                IncrementOperatorsHelper<float>.op_CheckedIncrement(-MinNormal)
            );
            AssertBitwiseEqual(
                1.0f,
                IncrementOperatorsHelper<float>.op_CheckedIncrement(-MaxSubnormal)
            );
            AssertBitwiseEqual(
                1.0f,
                IncrementOperatorsHelper<float>.op_CheckedIncrement(-float.Epsilon)
            );
            AssertBitwiseEqual(1.0f, IncrementOperatorsHelper<float>.op_CheckedIncrement(-0.0f));
            AssertBitwiseEqual(
                float.NaN,
                IncrementOperatorsHelper<float>.op_CheckedIncrement(float.NaN)
            );
            AssertBitwiseEqual(1.0f, IncrementOperatorsHelper<float>.op_CheckedIncrement(0.0f));
            AssertBitwiseEqual(
                1.0f,
            ...
            AssertBitwiseEqual(
                float.MaxValue,
                IncrementOperatorsHelper<float>.op_CheckedIncrement(float.MaxValue)
            );
            AssertBitwiseEqual(
                float.PositiveInfinity,
                IncrementOperatorsHelper<float>.op_CheckedIncrement(float.PositiveInfinity)
            );
        }
        ...
        public static void op_ModulusTest()
        {
            AssertBitwiseEqual(
                float.NaN,
                ModulusOperatorsHelper<float, float, float>.op_Modulus(float.NegativeInfinity, 2.0f)
            );
            AssertBitwiseEqual(
                -0.0f,
                ModulusOperatorsHelper<float, float, float>.op_Modulus(float.MinValue, 2.0f)
            );
            AssertBitwiseEqual(
                -1.0f,
                ModulusOperatorsHelper<float, float, float>.op_Modulus(-1.0f, 2.0f)
            );
            AssertBitwiseEqual(
                -MinNormal,
                ModulusOperatorsHelper<float, float, float>.op_Modulus(-MinNormal, 2.0f)
            );
            AssertBitwiseEqual(
                -MaxSubnormal,
                ModulusOperatorsHelper<float, float, float>.op_Modulus(-MaxSubnormal, 2.0f)
            );
            AssertBitwiseEqual(
                -float.Epsilon,
                ModulusOperatorsHelper<float, float, float>.op_Modulus(-float.Epsilon, 2.0f)
            );
            ;
            AssertBitwiseEqual(
                -0.0f,
                ModulusOperatorsHelper<float, float, float>.op_Modulus(-0.0f, 2.0f)
            );
            AssertBitwiseEqual(
                float.NaN,
                ModulusOperatorsHelper<float, float, float>.op_Modulus(float.NaN, 2.0f)
            );
            AssertBitwiseEqual(
                0.0f,
                ModulusOperatorsHelper<float, float, float>.op_Modulus(0.0f, 2.0f)
            ...
            AssertBitwiseEqual(
                0.0f,
                ModulusOperatorsHelper<float, float, float>.op_Modulus(float.MaxValue, 2.0f)
            );
            AssertBitwiseEqual(
                float.NaN,
                ModulusOperatorsHelper<float, float, float>.op_Modulus(float.PositiveInfinity, 2.0f)
            );
        }
        ...
        public static void MultiplicativeIdentityTest()
        {
            AssertBitwiseEqual(
                1.0f,
                MultiplicativeIdentityHelper<float, float>.MultiplicativeIdentity
            );
        }
        ...
        public static void op_MultiplyTest()
        {
            AssertBitwiseEqual(
                float.NegativeInfinity,
                MultiplyOperatorsHelper<float, float, float>.op_Multiply(
                    float.NegativeInfinity,
                    2.0f
                )
            );
            AssertBitwiseEqual(
                float.NegativeInfinity,
                MultiplyOperatorsHelper<float, float, float>.op_Multiply(float.MinValue, 2.0f)
            );
            AssertBitwiseEqual(
                -2.0f,
                MultiplyOperatorsHelper<float, float, float>.op_Multiply(-1.0f, 2.0f)
            );
            AssertBitwiseEqual(
                -2.3509887E-38f,
                MultiplyOperatorsHelper<float, float, float>.op_Multiply(-MinNormal, 2.0f)
            );
            AssertBitwiseEqual(
                -2.35098842E-38f,
                MultiplyOperatorsHelper<float, float, float>.op_Multiply(-MaxSubnormal, 2.0f)
            );
            AssertBitwiseEqual(
                -2.80259693E-45f,
                MultiplyOperatorsHelper<float, float, float>.op_Multiply(-float.Epsilon, 2.0f)
            );
            AssertBitwiseEqual(
                -0.0f,
                MultiplyOperatorsHelper<float, float, float>.op_Multiply(-0.0f, 2.0f)
            );
            AssertBitwiseEqual(
                float.NaN,
                MultiplyOperatorsHelper<float, float, float>.op_Multiply(float.NaN, 2.0f)
            );
            AssertBitwiseEqual(
                0.0f,
                MultiplyOperatorsHelper<float, float, float>.op_Multiply(0.0f, 2.0f)
            ...
            AssertBitwiseEqual(
                float.PositiveInfinity,
                MultiplyOperatorsHelper<float, float, float>.op_Multiply(float.MaxValue, 2.0f)
            );
            AssertBitwiseEqual(
                float.PositiveInfinity,
                MultiplyOperatorsHelper<float, float, float>.op_Multiply(
        ...
        public static void op_CheckedMultiplyTest()
        {
            AssertBitwiseEqual(
                float.NegativeInfinity,
                MultiplyOperatorsHelper<float, float, float>.op_CheckedMultiply(
                    float.NegativeInfinity,
                    2.0f
                )
            );
            ...
            AssertBitwiseEqual(
                -2.0f,
                MultiplyOperatorsHelper<float, float, float>.op_CheckedMultiply(-1.0f, 2.0f)
            );
            AssertBitwiseEqual(
                -2.3509887E-38f,
                MultiplyOperatorsHelper<float, float, float>.op_CheckedMultiply(-MinNormal, 2.0f)
            );
            AssertBitwiseEqual(
                -2.35098842E-38f,
                MultiplyOperatorsHelper<float, float, float>.op_CheckedMultiply(-MaxSubnormal, 2.0f)
            );
            AssertBitwiseEqual(
                -2.80259693E-45f,
                MultiplyOperatorsHelper<float, float, float>.op_CheckedMultiply(
            ...
            AssertBitwiseEqual(
                -0.0f,
                MultiplyOperatorsHelper<float, float, float>.op_CheckedMultiply(-0.0f, 2.0f)
            );
            AssertBitwiseEqual(
                float.NaN,
                MultiplyOperatorsHelper<float, float, float>.op_CheckedMultiply(float.NaN, 2.0f)
            );
            AssertBitwiseEqual(
                0.0f,
                MultiplyOperatorsHelper<float, float, float>.op_CheckedMultiply(0.0f, 2.0f)
            ...
            AssertBitwiseEqual(
                2.80259693E-45f,
                MultiplyOperatorsHelper<float, float, float>.op_CheckedMultiply(float.Epsilon, 2.0f)
            );
            AssertBitwiseEqual(
                2.35098842E-38f,
                MultiplyOperatorsHelper<float, float, float>.op_CheckedMultiply(MaxSubnormal, 2.0f)
        ...
        public static void ClampTest()
        {
            AssertBitwiseEqual(
                1.0f,
                NumberHelper<float>.Clamp(float.NegativeInfinity, 1.0f, 63.0f)
            );
            ...
            AssertBitwiseEqual(
                63.0f,
                NumberHelper<float>.Clamp(float.PositiveInfinity, 1.0f, 63.0f)
            );
        }
        ...
        public static void MaxTest()
        {
            ...
            AssertBitwiseEqual(
                float.PositiveInfinity,
                NumberHelper<float>.Max(float.PositiveInfinity, 1.0f)
            );
        }
        ...
        public static void MaxNumberTest()
        {
            ...
            AssertBitwiseEqual(
                float.PositiveInfinity,
                NumberHelper<float>.MaxNumber(float.PositiveInfinity, 1.0f)
            );
        }
        ...
        public static void MinTest()
        {
            AssertBitwiseEqual(
                float.NegativeInfinity,
                NumberHelper<float>.Min(float.NegativeInfinity, 1.0f)
            );
        ...
        public static void MinNumberTest()
        {
            AssertBitwiseEqual(
                float.NegativeInfinity,
                NumberHelper<float>.MinNumber(float.NegativeInfinity, 1.0f)
            );
        ...
        public static void AbsTest()
        {
            AssertBitwiseEqual(
                float.PositiveInfinity,
                NumberBaseHelper<float>.Abs(float.NegativeInfinity)
            );
            ...
            AssertBitwiseEqual(
                float.PositiveInfinity,
                NumberBaseHelper<float>.Abs(float.PositiveInfinity)
            );
        }
        ...
        public static void CreateCheckedFromDecimalTest()
        {
            AssertBitwiseEqual(
                ...
                NumberBaseHelper<float>.CreateChecked<decimal>(decimal.MinValue)
            );
            ...
            AssertBitwiseEqual(
                +79228162514264337593543950335.0f,
                NumberBaseHelper<float>.CreateChecked<decimal>(decimal.MaxValue)
            );
        }
        ...
        public static void CreateCheckedFromDoubleTest()
        {
            AssertBitwiseEqual(
                float.NegativeInfinity,
                NumberBaseHelper<float>.CreateChecked<double>(double.NegativeInfinity)
            );
            AssertBitwiseEqual(
                float.NegativeInfinity,
                NumberBaseHelper<float>.CreateChecked<double>(double.MinValue)
            );
            ...
            AssertBitwiseEqual(
                -0.0f,
                NumberBaseHelper<float>.CreateChecked<double>(-DoubleTests_GenericMath.MinNormal)
            );
            AssertBitwiseEqual(
                -0.0f,
                NumberBaseHelper<float>.CreateChecked<double>(-DoubleTests_GenericMath.MaxSubnormal)
            );
            AssertBitwiseEqual(
                -0.0f,
                NumberBaseHelper<float>.CreateChecked<double>(-double.Epsilon)
            );
            ...
            AssertBitwiseEqual(
                float.PositiveInfinity,
                NumberBaseHelper<float>.CreateChecked<double>(double.MaxValue)
            );
            AssertBitwiseEqual(
                float.PositiveInfinity,
                NumberBaseHelper<float>.CreateChecked<double>(double.PositiveInfinity)
            );

            AssertBitwiseEqual(
                float.NaN,
                NumberBaseHelper<float>.CreateChecked<double>(double.NaN)
            );
        }
        ...
        public static void CreateCheckedFromHalfTest()
        {
            AssertBitwiseEqual(
                float.NegativeInfinity,
                NumberBaseHelper<float>.CreateChecked<Half>(Half.NegativeInfinity)
            );

            AssertBitwiseEqual(
                -65504.0f,
                NumberBaseHelper<float>.CreateChecked<Half>(Half.MinValue)
            );
            AssertBitwiseEqual(
                -1.0f,
                NumberBaseHelper<float>.CreateChecked<Half>(Half.NegativeOne)
            );

            AssertBitwiseEqual(
                -6.1035156E-05f,
                NumberBaseHelper<float>.CreateChecked<Half>(-HalfTests_GenericMath.MinNormal)
            );
            AssertBitwiseEqual(
                -6.097555E-05f,
                NumberBaseHelper<float>.CreateChecked<Half>(-HalfTests_GenericMath.MaxSubnormal)
            );
            AssertBitwiseEqual(
                -5.9604645E-08f,
                NumberBaseHelper<float>.CreateChecked<Half>(-Half.Epsilon)
            );
            AssertBitwiseEqual(
                -0.0f,
                NumberBaseHelper<float>.CreateChecked<Half>(Half.NegativeZero)
            );
            ...
            AssertBitwiseEqual(
                +65504.0f,
                NumberBaseHelper<float>.CreateChecked<Half>(Half.MaxValue)
            );

            AssertBitwiseEqual(
                float.PositiveInfinity,
                NumberBaseHelper<float>.CreateChecked<Half>(Half.PositiveInfinity)
            );
        ...
        public static void CreateCheckedFromInt16Test()
        {
            ...
            AssertBitwiseEqual(
                -32768.0f,
                NumberBaseHelper<float>.CreateChecked<short>(unchecked((short)0x8000))
            );
            AssertBitwiseEqual(
                -1.0f,
                NumberBaseHelper<float>.CreateChecked<short>(unchecked((short)0xFFFF))
            );
        }
        ...
        public static void CreateCheckedFromInt32Test()
        {
            ...
            AssertBitwiseEqual(
                2147483647.0f,
                NumberBaseHelper<float>.CreateChecked<int>(0x7FFFFFFF)
            );
            AssertBitwiseEqual(
                -2147483648.0f,
                NumberBaseHelper<float>.CreateChecked<int>(unchecked((int)0x80000000))
            );
            AssertBitwiseEqual(
                -1.0f,
                NumberBaseHelper<float>.CreateChecked<int>(unchecked((int)0xFFFFFFFF))
            );
        }
        ...
        public static void CreateCheckedFromInt64Test()
        {
            AssertBitwiseEqual(
                0.0f,
                NumberBaseHelper<float>.CreateChecked<long>(0x0000000000000000)
            );
            AssertBitwiseEqual(
                1.0f,
                NumberBaseHelper<float>.CreateChecked<long>(0x0000000000000001)
            );
            AssertBitwiseEqual(
                9223372036854775807.0f,
                NumberBaseHelper<float>.CreateChecked<long>(0x7FFFFFFFFFFFFFFF)
            );
            AssertBitwiseEqual(
                -9223372036854775808.0f,
                NumberBaseHelper<float>.CreateChecked<long>(
        ...
        public static void CreateCheckedFromInt128Test()
        {
            AssertBitwiseEqual(
                0.0f,
                NumberBaseHelper<float>.CreateChecked<Int128>(
        ...
        public static void CreateCheckedFromIntPtrTest()
        {
            if (Environment.Is64BitProcess)
            {
                AssertBitwiseEqual(
                    0.0f,
                    NumberBaseHelper<float>.CreateChecked<nint>(unchecked((nint)0x0000000000000000))
                );
                AssertBitwiseEqual(
                    1.0f,
                    NumberBaseHelper<float>.CreateChecked<nint>(unchecked((nint)0x0000000000000001))
                );
                AssertBitwiseEqual(
                    9223372036854775807.0f,
                    NumberBaseHelper<float>.CreateChecked<nint>(unchecked((nint)0x7FFFFFFFFFFFFFFF))
                );
                AssertBitwiseEqual(
                    -9223372036854775808.0f,
                    NumberBaseHelper<float>.CreateChecked<nint>(unchecked((nint)0x8000000000000000))
                );
                AssertBitwiseEqual(
                    -1.0f,
                    NumberBaseHelper<float>.CreateChecked<nint>(unchecked((nint)0xFFFFFFFFFFFFFFFF))
                );
            }
            else
            {
                AssertBitwiseEqual(
                    0.0f,
                    NumberBaseHelper<float>.CreateChecked<nint>((nint)0x00000000)
                );
                AssertBitwiseEqual(
                    1.0f,
                    NumberBaseHelper<float>.CreateChecked<nint>((nint)0x00000001)
                );
                AssertBitwiseEqual(
                    2147483647.0f,
                    NumberBaseHelper<float>.CreateChecked<nint>((nint)0x7FFFFFFF)
                );
                AssertBitwiseEqual(
                    -2147483648.0f,
                    NumberBaseHelper<float>.CreateChecked<nint>(unchecked((nint)0x80000000))
                );
                AssertBitwiseEqual(
                    -1.0f,
                    NumberBaseHelper<float>.CreateChecked<nint>(unchecked((nint)0xFFFFFFFF))
                );
            }
        }
        ...
        public static void CreateCheckedFromNFloatTest()
        {
            AssertBitwiseEqual(
                float.NegativeInfinity,
                NumberBaseHelper<float>.CreateChecked<NFloat>(NFloat.NegativeInfinity)
            );
            ...
            AssertBitwiseEqual(
                float.PositiveInfinity,
                NumberBaseHelper<float>.CreateChecked<NFloat>(NFloat.PositiveInfinity)
            );
            ...
            if (Environment.Is64BitProcess)
            {
                AssertBitwiseEqual(
                    float.NegativeInfinity,
                    NumberBaseHelper<float>.CreateChecked<NFloat>(NFloat.MinValue)
                );

                AssertBitwiseEqual(
                    -0.0f,
                    NumberBaseHelper<float>.CreateChecked<NFloat>(
                        (NFloat)(-DoubleTests_GenericMath.MinNormal)
                    )
                );
                AssertBitwiseEqual(
                    -0.0f,
                ...
                AssertBitwiseEqual(
                    -0.0f,
                    NumberBaseHelper<float>.CreateChecked<NFloat>(-NFloat.Epsilon)
                );
                ...
                AssertBitwiseEqual(
                    float.PositiveInfinity,
                    NumberBaseHelper<float>.CreateChecked<NFloat>(NFloat.MaxValue)
                );
            }
            else
            {
                ...
                AssertBitwiseEqual(
                    -MinNormal,
                    NumberBaseHelper<float>.CreateChecked<NFloat>(-MinNormal)
                );
                AssertBitwiseEqual(
                    -MaxSubnormal,
                    NumberBaseHelper<float>.CreateChecked<NFloat>(-MaxSubnormal)
                );
                AssertBitwiseEqual(
                    -float.Epsilon,
                    NumberBaseHelper<float>.CreateChecked<NFloat>(-NFloat.Epsilon)
            ...
            AssertBitwiseEqual(
                float.NaN,
                NumberBaseHelper<float>.CreateChecked<NFloat>(NFloat.NaN)
            );
        }
        ...
        public static void CreateCheckedFromSByteTest()
        {
            ...
            AssertBitwiseEqual(
                -128.0f,
                NumberBaseHelper<float>.CreateChecked<sbyte>(unchecked((sbyte)0x80))
            );
            AssertBitwiseEqual(
                -1.0f,
                NumberBaseHelper<float>.CreateChecked<sbyte>(unchecked((sbyte)0xFF))
            );
        }
        ...
        public static void CreateCheckedFromSingleTest()
        {
            AssertBitwiseEqual(
                float.NegativeInfinity,
                NumberBaseHelper<float>.CreateChecked<float>(float.NegativeInfinity)
            );
            AssertBitwiseEqual(
                float.MinValue,
                NumberBaseHelper<float>.CreateChecked<float>(float.MinValue)
            );
            ...
            AssertBitwiseEqual(
                -MinNormal,
                NumberBaseHelper<float>.CreateChecked<float>(-MinNormal)
            );
            AssertBitwiseEqual(
                -MaxSubnormal,
                NumberBaseHelper<float>.CreateChecked<float>(-MaxSubnormal)
            );
            AssertBitwiseEqual(
                -float.Epsilon,
                NumberBaseHelper<float>.CreateChecked<float>(-float.Epsilon)
            );
            ...
            AssertBitwiseEqual(
                float.MaxValue,
                NumberBaseHelper<float>.CreateChecked<float>(float.MaxValue)
            );
            AssertBitwiseEqual(
                float.PositiveInfinity,
                NumberBaseHelper<float>.CreateChecked<float>(float.PositiveInfinity)
            );
        ...
        public static void CreateCheckedFromUInt32Test()
        {
            ...
            AssertBitwiseEqual(
                2147483647.0f,
                NumberBaseHelper<float>.CreateChecked<uint>(0x7FFFFFFF)
            );
            AssertBitwiseEqual(
                2147483648.0f,
                NumberBaseHelper<float>.CreateChecked<uint>(0x80000000)
            );
            AssertBitwiseEqual(
                4294967295.0f,
                NumberBaseHelper<float>.CreateChecked<uint>(0xFFFFFFFF)
            );
        }
        ...
        public static void CreateCheckedFromUInt64Test()
        {
            AssertBitwiseEqual(
                0.0f,
                NumberBaseHelper<float>.CreateChecked<ulong>(0x0000000000000000)
            );
            AssertBitwiseEqual(
                1.0f,
                NumberBaseHelper<float>.CreateChecked<ulong>(0x0000000000000001)
            );
            AssertBitwiseEqual(
                9223372036854775807.0f,
                NumberBaseHelper<float>.CreateChecked<ulong>(0x7FFFFFFFFFFFFFFF)
            );
            AssertBitwiseEqual(
                9223372036854775808.0f,
                NumberBaseHelper<float>.CreateChecked<ulong>(0x8000000000000000)
            );
            AssertBitwiseEqual(
                18446744073709551615.0f,
                NumberBaseHelper<float>.CreateChecked<ulong>(0xFFFFFFFFFFFFFFFF)
            );
        }
        ...
        public static void CreateCheckedFromUInt128Test()
        {
            AssertBitwiseEqual(
                0.0f,
                NumberBaseHelper<float>.CreateChecked<UInt128>(
        ...
        public static void CreateCheckedFromUIntPtrTest()
        {
            if (Environment.Is64BitProcess)
            {
                AssertBitwiseEqual(
                    0.0f,
                    NumberBaseHelper<float>.CreateChecked<nuint>(
                ...
                // AssertBitwiseEqual(9223372036854775808.0f,
                // NumberBaseHelper<float>.CreateChecked<nuint>(unchecked((nuint)0x8000000000000000)));
                //
            ...
            else
            {
                AssertBitwiseEqual(
                    0.0f,
                    NumberBaseHelper<float>.CreateChecked<nuint>((nuint)0x00000000)
                );
                AssertBitwiseEqual(
                    1.0f,
                    NumberBaseHelper<float>.CreateChecked<nuint>((nuint)0x00000001)
                );
                AssertBitwiseEqual(
                    2147483647.0f,
                    NumberBaseHelper<float>.CreateChecked<nuint>((nuint)0x7FFFFFFF)
                );

                // https://github.com/dotnet/roslyn/issues/60714
                // AssertBitwiseEqual(2147483648.0f,
                // NumberBaseHelper<float>.CreateChecked<nuint>((nuint)0x80000000));
                // AssertBitwiseEqual(4294967295.0f,
                // NumberBaseHelper<float>.CreateChecked<nuint>((nuint)0xFFFFFFFF));
            }
        }
        ...
        public static void CreateSaturatingFromCharTest()
        {
            ...
            AssertBitwiseEqual(
                32767.0f,
                NumberBaseHelper<float>.CreateSaturating<char>((char)0x7FFF)
            );
            AssertBitwiseEqual(
                32768.0f,
                NumberBaseHelper<float>.CreateSaturating<char>((char)0x8000)
            );
            AssertBitwiseEqual(
                65535.0f,
                NumberBaseHelper<float>.CreateSaturating<char>((char)0xFFFF)
            );
        }
        ...
        public static void CreateSaturatingFromDecimalTest()
        {
            AssertBitwiseEqual(
                -79228162514264337593543950335.0f,
                NumberBaseHelper<float>.CreateSaturating<decimal>(decimal.MinValue)
            );
            ...
            AssertBitwiseEqual(
                +79228162514264337593543950335.0f,
                NumberBaseHelper<float>.CreateSaturating<decimal>(decimal.MaxValue)
            );
        }
        ...
        public static void CreateSaturatingFromDoubleTest()
        {
            AssertBitwiseEqual(
                float.NegativeInfinity,
                NumberBaseHelper<float>.CreateSaturating<double>(double.NegativeInfinity)
            );
            AssertBitwiseEqual(
                float.NegativeInfinity,
                NumberBaseHelper<float>.CreateSaturating<double>(double.MinValue)
            );
            ...
            AssertBitwiseEqual(
                -0.0f,
                NumberBaseHelper<float>.CreateSaturating<double>(-DoubleTests_GenericMath.MinNormal)
            );
            AssertBitwiseEqual(
                -0.0f,
                NumberBaseHelper<float>.CreateSaturating<double>(
                    -DoubleTests_GenericMath.MaxSubnormal
                )
            );
            AssertBitwiseEqual(
                -0.0f,
                NumberBaseHelper<float>.CreateSaturating<double>(-double.Epsilon)
            );
            ...
            AssertBitwiseEqual(
                float.PositiveInfinity,
                NumberBaseHelper<float>.CreateSaturating<double>(double.MaxValue)
            );
            AssertBitwiseEqual(
                float.PositiveInfinity,
                NumberBaseHelper<float>.CreateSaturating<double>(double.PositiveInfinity)
            );

            AssertBitwiseEqual(
                float.NaN,
                NumberBaseHelper<float>.CreateSaturating<double>(double.NaN)
            );
        }
        ...
        public static void CreateSaturatingFromHalfTest()
        {
            AssertBitwiseEqual(
                float.NegativeInfinity,
                NumberBaseHelper<float>.CreateSaturating<Half>(Half.NegativeInfinity)
            );

            AssertBitwiseEqual(
                -65504.0f,
                NumberBaseHelper<float>.CreateSaturating<Half>(Half.MinValue)
            );
            AssertBitwiseEqual(
                -1.0f,
                NumberBaseHelper<float>.CreateSaturating<Half>(Half.NegativeOne)
            );

            AssertBitwiseEqual(
                -6.1035156E-05f,
                NumberBaseHelper<float>.CreateSaturating<Half>(-HalfTests_GenericMath.MinNormal)
            );
            AssertBitwiseEqual(
                -6.097555E-05f,
                NumberBaseHelper<float>.CreateSaturating<Half>(-HalfTests_GenericMath.MaxSubnormal)
            );
            AssertBitwiseEqual(
                -5.9604645E-08f,
                NumberBaseHelper<float>.CreateSaturating<Half>(-Half.Epsilon)
            );
            AssertBitwiseEqual(
                -0.0f,
                NumberBaseHelper<float>.CreateSaturating<Half>(Half.NegativeZero)
            );
            ...
            AssertBitwiseEqual(
                +65504.0f,
                NumberBaseHelper<float>.CreateSaturating<Half>(Half.MaxValue)
            );

            AssertBitwiseEqual(
                float.PositiveInfinity,
                NumberBaseHelper<float>.CreateSaturating<Half>(Half.PositiveInfinity)
            );
        ...
        public static void CreateSaturatingFromInt16Test()
        {
            ...
            AssertBitwiseEqual(
                -32768.0f,
                NumberBaseHelper<float>.CreateSaturating<short>(unchecked((short)0x8000))
            );
            AssertBitwiseEqual(
                -1.0f,
                NumberBaseHelper<float>.CreateSaturating<short>(unchecked((short)0xFFFF))
            );
        }
        ...
        public static void CreateSaturatingFromInt32Test()
        {
            ...
            AssertBitwiseEqual(
                2147483647.0f,
                NumberBaseHelper<float>.CreateSaturating<int>(0x7FFFFFFF)
            );
            AssertBitwiseEqual(
                -2147483648.0f,
                NumberBaseHelper<float>.CreateSaturating<int>(unchecked((int)0x80000000))
            );
            AssertBitwiseEqual(
                -1.0f,
                NumberBaseHelper<float>.CreateSaturating<int>(unchecked((int)0xFFFFFFFF))
            );
        }
        ...
        public static void CreateSaturatingFromInt64Test()
        {
            AssertBitwiseEqual(
                0.0f,
                NumberBaseHelper<float>.CreateSaturating<long>(0x0000000000000000)
            );
            AssertBitwiseEqual(
                1.0f,
                NumberBaseHelper<float>.CreateSaturating<long>(0x0000000000000001)
            );
            AssertBitwiseEqual(
                9223372036854775807.0f,
                NumberBaseHelper<float>.CreateSaturating<long>(0x7FFFFFFFFFFFFFFF)
            );
            AssertBitwiseEqual(
                -9223372036854775808.0f,
                NumberBaseHelper<float>.CreateSaturating<long>(
                    unchecked(unchecked((long)0x8000000000000000))
                )
            );
            AssertBitwiseEqual(
        ...
        public static void CreateSaturatingFromInt128Test()
        {
            AssertBitwiseEqual(
                0.0f,
                NumberBaseHelper<float>.CreateSaturating<Int128>(
                    new Int128(0x0000_0000_0000_0000, 0x0000_0000_0000_0000)
                )
            );
            AssertBitwiseEqual(
        ...
        public static void CreateSaturatingFromIntPtrTest()
        {
            if (Environment.Is64BitProcess)
            {
                AssertBitwiseEqual(
                    0.0f,
                    NumberBaseHelper<float>.CreateSaturating<nint>(
            ...
            else
            {
                AssertBitwiseEqual(
                    0.0f,
                    NumberBaseHelper<float>.CreateSaturating<nint>((nint)0x00000000)
                );
                AssertBitwiseEqual(
                    1.0f,
                    NumberBaseHelper<float>.CreateSaturating<nint>((nint)0x00000001)
                );
                AssertBitwiseEqual(
                    2147483647.0f,
                    NumberBaseHelper<float>.CreateSaturating<nint>((nint)0x7FFFFFFF)
                );
                AssertBitwiseEqual(
                    -2147483648.0f,
                    NumberBaseHelper<float>.CreateSaturating<nint>(unchecked((nint)0x80000000))
                );
                AssertBitwiseEqual(
                    -1.0f,
                    NumberBaseHelper<float>.CreateSaturating<nint>(unchecked((nint)0xFFFFFFFF))
                );
            }
        }
        ...
        public static void CreateSaturatingFromNFloatTest()
        {
            AssertBitwiseEqual(
                float.NegativeInfinity,
                NumberBaseHelper<float>.CreateSaturating<NFloat>(NFloat.NegativeInfinity)
            );
            ...
            AssertBitwiseEqual(
                float.PositiveInfinity,
                NumberBaseHelper<float>.CreateSaturating<NFloat>(NFloat.PositiveInfinity)
            );
            ...
            if (Environment.Is64BitProcess)
            {
                AssertBitwiseEqual(
                    float.NegativeInfinity,
                    NumberBaseHelper<float>.CreateSaturating<NFloat>(NFloat.MinValue)
                );

                AssertBitwiseEqual(
                    -0.0f,
                    NumberBaseHelper<float>.CreateSaturating<NFloat>(
                        (NFloat)(-DoubleTests_GenericMath.MinNormal)
                    )
                );
                AssertBitwiseEqual(
                ...
                AssertBitwiseEqual(
                    -0.0f,
                    NumberBaseHelper<float>.CreateSaturating<NFloat>(-NFloat.Epsilon)
                );
                ...
                AssertBitwiseEqual(
                    float.PositiveInfinity,
                    NumberBaseHelper<float>.CreateSaturating<NFloat>(NFloat.MaxValue)
                );
            }
            else
            {
                ...
                AssertBitwiseEqual(
                    -MinNormal,
                    NumberBaseHelper<float>.CreateSaturating<NFloat>(-MinNormal)
                );
                AssertBitwiseEqual(
                    -MaxSubnormal,
                    NumberBaseHelper<float>.CreateSaturating<NFloat>(-MaxSubnormal)
                );
                AssertBitwiseEqual(
                    -float.Epsilon,
                    NumberBaseHelper<float>.CreateSaturating<NFloat>(-NFloat.Epsilon)
            ...
            AssertBitwiseEqual(
                float.NaN,
                NumberBaseHelper<float>.CreateSaturating<NFloat>(NFloat.NaN)
            );
        }
        ...
        public static void CreateSaturatingFromSByteTest()
        {
            ...
            AssertBitwiseEqual(
                -128.0f,
                NumberBaseHelper<float>.CreateSaturating<sbyte>(unchecked((sbyte)0x80))
            );
            AssertBitwiseEqual(
                -1.0f,
                NumberBaseHelper<float>.CreateSaturating<sbyte>(unchecked((sbyte)0xFF))
            );
        }
        ...
        public static void CreateSaturatingFromSingleTest()
        {
            AssertBitwiseEqual(
                float.NegativeInfinity,
                NumberBaseHelper<float>.CreateSaturating<float>(float.NegativeInfinity)
            );
            AssertBitwiseEqual(
                float.MinValue,
                NumberBaseHelper<float>.CreateSaturating<float>(float.MinValue)
            );
            ...
            AssertBitwiseEqual(
                -MinNormal,
                NumberBaseHelper<float>.CreateSaturating<float>(-MinNormal)
            );
            AssertBitwiseEqual(
                -MaxSubnormal,
                NumberBaseHelper<float>.CreateSaturating<float>(-MaxSubnormal)
            );
            AssertBitwiseEqual(
                -float.Epsilon,
                NumberBaseHelper<float>.CreateSaturating<float>(-float.Epsilon)
            );
            ...
            AssertBitwiseEqual(
                float.MaxValue,
                NumberBaseHelper<float>.CreateSaturating<float>(float.MaxValue)
            );
            AssertBitwiseEqual(
                float.PositiveInfinity,
                NumberBaseHelper<float>.CreateSaturating<float>(float.PositiveInfinity)
            );

            AssertBitwiseEqual(
                float.NaN,
                NumberBaseHelper<float>.CreateSaturating<float>(float.NaN)
            );
        }
        ...
        public static void CreateSaturatingFromUInt32Test()
        {
            ...
            AssertBitwiseEqual(
                2147483647.0f,
                NumberBaseHelper<float>.CreateSaturating<uint>(0x7FFFFFFF)
            );
            AssertBitwiseEqual(
                2147483648.0f,
                NumberBaseHelper<float>.CreateSaturating<uint>(0x80000000)
            );
            AssertBitwiseEqual(
                4294967295.0f,
                NumberBaseHelper<float>.CreateSaturating<uint>(0xFFFFFFFF)
            );
        }
        ...
        public static void CreateSaturatingFromUInt64Test()
        {
            AssertBitwiseEqual(
                0.0f,
                NumberBaseHelper<float>.CreateSaturating<ulong>(0x0000000000000000)
            );
            AssertBitwiseEqual(
                1.0f,
                NumberBaseHelper<float>.CreateSaturating<ulong>(0x0000000000000001)
            );
            AssertBitwiseEqual(
                9223372036854775807.0f,
                NumberBaseHelper<float>.CreateSaturating<ulong>(0x7FFFFFFFFFFFFFFF)
            );
            AssertBitwiseEqual(
                9223372036854775808.0f,
                NumberBaseHelper<float>.CreateSaturating<ulong>(0x8000000000000000)
            );
            AssertBitwiseEqual(
                18446744073709551615.0f,
                NumberBaseHelper<float>.CreateSaturating<ulong>(0xFFFFFFFFFFFFFFFF)
            );
        }
        ...
        public static void CreateSaturatingFromUInt128Test()
        {
            AssertBitwiseEqual(
                0.0f,
                NumberBaseHelper<float>.CreateSaturating<UInt128>(
                    new UInt128(0x0000_0000_0000_0000, 0x0000_0000_0000_0000)
                )
            );
            AssertBitwiseEqual(
        ...
        public static void CreateSaturatingFromUIntPtrTest()
        {
            if (Environment.Is64BitProcess)
            {
                AssertBitwiseEqual(
                    0.0f,
                    NumberBaseHelper<float>.CreateSaturating<nuint>(
                        unchecked((nuint)0x0000000000000000)
                    )
                );
                AssertBitwiseEqual(
                ...
                // https://github.com/dotnet/roslyn/issues/60714
                // AssertBitwiseEqual(9223372036854775808.0f,
                // NumberBaseHelper<float>.CreateSaturating<nuint>(unchecked((nuint)0x8000000000000000)));
                // AssertBitwiseEqual(18446744073709551615.0f,
                // NumberBaseHelper<float>.CreateSaturating<nuint>(unchecked((nuint)0xFFFFFFFFFFFFFFFF)));
            }
            else
            {
                AssertBitwiseEqual(
                    0.0f,
                    NumberBaseHelper<float>.CreateSaturating<nuint>((nuint)0x00000000)
                );
                AssertBitwiseEqual(
                    1.0f,
                    NumberBaseHelper<float>.CreateSaturating<nuint>((nuint)0x00000001)
                );
                AssertBitwiseEqual(
                    2147483647.0f,
                    NumberBaseHelper<float>.CreateSaturating<nuint>((nuint)0x7FFFFFFF)
                );

                // https://github.com/dotnet/roslyn/issues/60714
                // AssertBitwiseEqual(2147483648.0f,
                // NumberBaseHelper<float>.CreateSaturating<nuint>((nuint)0x80000000));
                // AssertBitwiseEqual(4294967295.0f,
                // NumberBaseHelper<float>.CreateSaturating<nuint>((nuint)0xFFFFFFFF));
            }
        }
        ...
        public static void CreateTruncatingFromCharTest()
        {
            ...
            AssertBitwiseEqual(
                32767.0f,
                NumberBaseHelper<float>.CreateTruncating<char>((char)0x7FFF)
            );
            AssertBitwiseEqual(
                32768.0f,
                NumberBaseHelper<float>.CreateTruncating<char>((char)0x8000)
            );
            AssertBitwiseEqual(
                65535.0f,
                NumberBaseHelper<float>.CreateTruncating<char>((char)0xFFFF)
            );
        }
        ...
        public static void CreateTruncatingFromDecimalTest()
        {
            AssertBitwiseEqual(
                -79228162514264337593543950335.0f,
                NumberBaseHelper<float>.CreateTruncating<decimal>(decimal.MinValue)
            );
            ...
            AssertBitwiseEqual(
                +79228162514264337593543950335.0f,
                NumberBaseHelper<float>.CreateTruncating<decimal>(decimal.MaxValue)
            );
        }
        ...
        public static void CreateTruncatingFromDoubleTest()
        {
            AssertBitwiseEqual(
                float.NegativeInfinity,
                NumberBaseHelper<float>.CreateTruncating<double>(double.NegativeInfinity)
            );
            AssertBitwiseEqual(
                float.NegativeInfinity,
                NumberBaseHelper<float>.CreateTruncating<double>(double.MinValue)
            );
            ...
            AssertBitwiseEqual(
                -0.0f,
                NumberBaseHelper<float>.CreateTruncating<double>(-DoubleTests_GenericMath.MinNormal)
            );
            AssertBitwiseEqual(
                -0.0f,
                NumberBaseHelper<float>.CreateTruncating<double>(
                    -DoubleTests_GenericMath.MaxSubnormal
                )
            );
            AssertBitwiseEqual(
                -0.0f,
                NumberBaseHelper<float>.CreateTruncating<double>(-double.Epsilon)
            );
            ...
            AssertBitwiseEqual(
                float.PositiveInfinity,
                NumberBaseHelper<float>.CreateTruncating<double>(double.MaxValue)
            );
            AssertBitwiseEqual(
                float.PositiveInfinity,
                NumberBaseHelper<float>.CreateTruncating<double>(double.PositiveInfinity)
            );

            AssertBitwiseEqual(
                float.NaN,
                NumberBaseHelper<float>.CreateTruncating<double>(double.NaN)
            );
        }
        ...
        public static void CreateTruncatingFromHalfTest()
        {
            AssertBitwiseEqual(
                float.NegativeInfinity,
                NumberBaseHelper<float>.CreateTruncating<Half>(Half.NegativeInfinity)
            );

            AssertBitwiseEqual(
                -65504.0f,
                NumberBaseHelper<float>.CreateTruncating<Half>(Half.MinValue)
            );
            AssertBitwiseEqual(
                -1.0f,
                NumberBaseHelper<float>.CreateTruncating<Half>(Half.NegativeOne)
            );

            AssertBitwiseEqual(
                -6.1035156E-05f,
                NumberBaseHelper<float>.CreateTruncating<Half>(-HalfTests_GenericMath.MinNormal)
            );
            AssertBitwiseEqual(
                -6.097555E-05f,
                NumberBaseHelper<float>.CreateTruncating<Half>(-HalfTests_GenericMath.MaxSubnormal)
            );
            AssertBitwiseEqual(
                -5.9604645E-08f,
                NumberBaseHelper<float>.CreateTruncating<Half>(-Half.Epsilon)
            );
            AssertBitwiseEqual(
                -0.0f,
                NumberBaseHelper<float>.CreateTruncating<Half>(Half.NegativeZero)
            );
            ...
            AssertBitwiseEqual(
                +65504.0f,
                NumberBaseHelper<float>.CreateTruncating<Half>(Half.MaxValue)
            );

            AssertBitwiseEqual(
                float.PositiveInfinity,
                NumberBaseHelper<float>.CreateTruncating<Half>(Half.PositiveInfinity)
            );
        ...
        public static void CreateTruncatingFromInt16Test()
        {
            ...
            AssertBitwiseEqual(
                -32768.0f,
                NumberBaseHelper<float>.CreateTruncating<short>(unchecked((short)0x8000))
            );
            AssertBitwiseEqual(
                -1.0f,
                NumberBaseHelper<float>.CreateTruncating<short>(unchecked((short)0xFFFF))
            );
        }
        ...
        public static void CreateTruncatingFromInt32Test()
        {
            ...
            AssertBitwiseEqual(
                2147483647.0f,
                NumberBaseHelper<float>.CreateTruncating<int>(0x7FFFFFFF)
            );
            AssertBitwiseEqual(
                -2147483648.0f,
                NumberBaseHelper<float>.CreateTruncating<int>(unchecked((int)0x80000000))
            );
            AssertBitwiseEqual(
                -1.0f,
                NumberBaseHelper<float>.CreateTruncating<int>(unchecked((int)0xFFFFFFFF))
            );
        }
        ...
        public static void CreateTruncatingFromInt64Test()
        {
            AssertBitwiseEqual(
                0.0f,
                NumberBaseHelper<float>.CreateTruncating<long>(0x0000000000000000)
            );
            AssertBitwiseEqual(
                1.0f,
                NumberBaseHelper<float>.CreateTruncating<long>(0x0000000000000001)
            );
            AssertBitwiseEqual(
                9223372036854775807.0f,
                NumberBaseHelper<float>.CreateTruncating<long>(0x7FFFFFFFFFFFFFFF)
            );
            AssertBitwiseEqual(
                -9223372036854775808.0f,
                NumberBaseHelper<float>.CreateTruncating<long>(
                    unchecked(unchecked((long)0x8000000000000000))
                )
            );
            AssertBitwiseEqual(
        ...
        public static void CreateTruncatingFromInt128Test()
        {
            AssertBitwiseEqual(
                0.0f,
                NumberBaseHelper<float>.CreateTruncating<Int128>(
                    new Int128(0x0000_0000_0000_0000, 0x0000_0000_0000_0000)
                )
            );
            AssertBitwiseEqual(
        ...
        public static void CreateTruncatingFromIntPtrTest()
        {
            if (Environment.Is64BitProcess)
            {
                AssertBitwiseEqual(
                    0.0f,
                    NumberBaseHelper<float>.CreateTruncating<nint>(
                        unchecked((nint)0x0000000000000000)
                    )
                );
                AssertBitwiseEqual(
            ...
            else
            {
                AssertBitwiseEqual(
                    0.0f,
                    NumberBaseHelper<float>.CreateTruncating<nint>((nint)0x00000000)
                );
                AssertBitwiseEqual(
                    1.0f,
                    NumberBaseHelper<float>.CreateTruncating<nint>((nint)0x00000001)
                );
                AssertBitwiseEqual(
                    2147483647.0f,
                    NumberBaseHelper<float>.CreateTruncating<nint>((nint)0x7FFFFFFF)
                );
                AssertBitwiseEqual(
                    -2147483648.0f,
                    NumberBaseHelper<float>.CreateTruncating<nint>(unchecked((nint)0x80000000))
                );
                AssertBitwiseEqual(
                    -1.0f,
                    NumberBaseHelper<float>.CreateTruncating<nint>(unchecked((nint)0xFFFFFFFF))
                );
            }
        }
        ...
        public static void CreateTruncatingFromNFloatTest()
        {
            AssertBitwiseEqual(
                float.NegativeInfinity,
                NumberBaseHelper<float>.CreateTruncating<NFloat>(NFloat.NegativeInfinity)
            );
            ...
            AssertBitwiseEqual(
                float.PositiveInfinity,
                NumberBaseHelper<float>.CreateTruncating<NFloat>(NFloat.PositiveInfinity)
            );
            ...
            if (Environment.Is64BitProcess)
            {
                AssertBitwiseEqual(
                    float.NegativeInfinity,
                    NumberBaseHelper<float>.CreateTruncating<NFloat>(NFloat.MinValue)
                );

                AssertBitwiseEqual(
                    -0.0f,
                    NumberBaseHelper<float>.CreateTruncating<NFloat>(
                        (NFloat)(-DoubleTests_GenericMath.MinNormal)
                    )
                );
                AssertBitwiseEqual(
                ...
                AssertBitwiseEqual(
                    -0.0f,
                    NumberBaseHelper<float>.CreateTruncating<NFloat>(-NFloat.Epsilon)
                );
                ...
                AssertBitwiseEqual(
                    float.PositiveInfinity,
                    NumberBaseHelper<float>.CreateTruncating<NFloat>(NFloat.MaxValue)
                );
            }
            else
            {
                ...
                AssertBitwiseEqual(
                    -MinNormal,
                    NumberBaseHelper<float>.CreateTruncating<NFloat>(-MinNormal)
                );
                AssertBitwiseEqual(
                    -MaxSubnormal,
                    NumberBaseHelper<float>.CreateTruncating<NFloat>(-MaxSubnormal)
                );
                AssertBitwiseEqual(
                    -float.Epsilon,
                    NumberBaseHelper<float>.CreateTruncating<NFloat>(-NFloat.Epsilon)
            ...
            AssertBitwiseEqual(
                float.NaN,
                NumberBaseHelper<float>.CreateTruncating<NFloat>(NFloat.NaN)
            );
        }
        ...
        public static void CreateTruncatingFromSByteTest()
        {
            ...
            AssertBitwiseEqual(
                -128.0f,
                NumberBaseHelper<float>.CreateTruncating<sbyte>(unchecked((sbyte)0x80))
            );
            AssertBitwiseEqual(
                -1.0f,
                NumberBaseHelper<float>.CreateTruncating<sbyte>(unchecked((sbyte)0xFF))
            );
        }
        ...
        public static void CreateTruncatingFromSingleTest()
        {
            AssertBitwiseEqual(
                float.NegativeInfinity,
                NumberBaseHelper<float>.CreateTruncating<float>(float.NegativeInfinity)
            );
            AssertBitwiseEqual(
                float.MinValue,
                NumberBaseHelper<float>.CreateTruncating<float>(float.MinValue)
            );
            ...
            AssertBitwiseEqual(
                -MinNormal,
                NumberBaseHelper<float>.CreateTruncating<float>(-MinNormal)
            );
            AssertBitwiseEqual(
                -MaxSubnormal,
                NumberBaseHelper<float>.CreateTruncating<float>(-MaxSubnormal)
            );
            AssertBitwiseEqual(
                -float.Epsilon,
                NumberBaseHelper<float>.CreateTruncating<float>(-float.Epsilon)
            );
            ...
            AssertBitwiseEqual(
                float.MaxValue,
                NumberBaseHelper<float>.CreateTruncating<float>(float.MaxValue)
            );
            AssertBitwiseEqual(
                float.PositiveInfinity,
                NumberBaseHelper<float>.CreateTruncating<float>(float.PositiveInfinity)
            );

            AssertBitwiseEqual(
                float.NaN,
                NumberBaseHelper<float>.CreateTruncating<float>(float.NaN)
            );
        }
        ...
        public static void CreateTruncatingFromUInt32Test()
        {
            ...
            AssertBitwiseEqual(
                2147483647.0f,
                NumberBaseHelper<float>.CreateTruncating<uint>(0x7FFFFFFF)
            );
            AssertBitwiseEqual(
                2147483648.0f,
                NumberBaseHelper<float>.CreateTruncating<uint>(0x80000000)
            );
            AssertBitwiseEqual(
                4294967295.0f,
                NumberBaseHelper<float>.CreateTruncating<uint>(0xFFFFFFFF)
            );
        }
        ...
        public static void CreateTruncatingFromUInt64Test()
        {
            AssertBitwiseEqual(
                0.0f,
                NumberBaseHelper<float>.CreateTruncating<ulong>(0x0000000000000000)
            );
            AssertBitwiseEqual(
                1.0f,
                NumberBaseHelper<float>.CreateTruncating<ulong>(0x0000000000000001)
            );
            AssertBitwiseEqual(
                9223372036854775807.0f,
                NumberBaseHelper<float>.CreateTruncating<ulong>(0x7FFFFFFFFFFFFFFF)
            );
            AssertBitwiseEqual(
                9223372036854775808.0f,
                NumberBaseHelper<float>.CreateTruncating<ulong>(0x8000000000000000)
            );
            AssertBitwiseEqual(
                18446744073709551615.0f,
                NumberBaseHelper<float>.CreateTruncating<ulong>(0xFFFFFFFFFFFFFFFF)
            );
        }
        ...
        public static void CreateTruncatingFromUInt128Test()
        {
            AssertBitwiseEqual(
                0.0f,
                NumberBaseHelper<float>.CreateTruncating<UInt128>(
                    new UInt128(0x0000_0000_0000_0000, 0x0000_0000_0000_0000)
                )
            );
            AssertBitwiseEqual(
        ...
        public static void CreateTruncatingFromUIntPtrTest()
        {
            if (Environment.Is64BitProcess)
            {
                AssertBitwiseEqual(
                    0.0f,
                    NumberBaseHelper<float>.CreateTruncating<nuint>(
                        unchecked((nuint)0x0000000000000000)
                    )
                );
                AssertBitwiseEqual(
                ...
                // https://github.com/dotnet/roslyn/issues/60714
                // AssertBitwiseEqual(9223372036854775808.0f,
                // NumberBaseHelper<float>.CreateTruncating<nuint>(unchecked((nuint)0x8000000000000000)));
                // AssertBitwiseEqual(18446744073709551615.0f,
                // NumberBaseHelper<float>.CreateTruncating<nuint>(unchecked((nuint)0xFFFFFFFFFFFFFFFF)));
            }
            else
            {
                AssertBitwiseEqual(
                    0.0f,
                    NumberBaseHelper<float>.CreateTruncating<nuint>((nuint)0x00000000)
                );
                AssertBitwiseEqual(
                    1.0f,
                    NumberBaseHelper<float>.CreateTruncating<nuint>((nuint)0x00000001)
                );
                AssertBitwiseEqual(
                    2147483647.0f,
                    NumberBaseHelper<float>.CreateTruncating<nuint>((nuint)0x7FFFFFFF)
                );

                // https://github.com/dotnet/roslyn/issues/60714
                // AssertBitwiseEqual(2147483648.0f,
                // NumberBaseHelper<float>.CreateTruncating<nuint>((nuint)0x80000000));
                // AssertBitwiseEqual(4294967295.0f,
                // NumberBaseHelper<float>.CreateTruncating<nuint>((nuint)0xFFFFFFFF));
            }
        }
        ...
        public static void MaxMagnitudeTest()
        {
            AssertBitwiseEqual(
                float.NegativeInfinity,
                NumberBaseHelper<float>.MaxMagnitude(float.NegativeInfinity, 1.0f)
            );
            AssertBitwiseEqual(
                float.MinValue,
                NumberBaseHelper<float>.MaxMagnitude(float.MinValue, 1.0f)
            );
            ...
            AssertBitwiseEqual(
                float.MaxValue,
                NumberBaseHelper<float>.MaxMagnitude(float.MaxValue, 1.0f)
            );
            AssertBitwiseEqual(
                float.PositiveInfinity,
                NumberBaseHelper<float>.MaxMagnitude(float.PositiveInfinity, 1.0f)
            );
        }
        ...
        public static void MaxMagnitudeNumberTest()
        {
            AssertBitwiseEqual(
                float.NegativeInfinity,
                NumberBaseHelper<float>.MaxMagnitudeNumber(float.NegativeInfinity, 1.0f)
            );
            AssertBitwiseEqual(
                float.MinValue,
                NumberBaseHelper<float>.MaxMagnitudeNumber(float.MinValue, 1.0f)
            );
            ...
            AssertBitwiseEqual(
                1.0f,
                NumberBaseHelper<float>.MaxMagnitudeNumber(-MaxSubnormal, 1.0f)
            );
            AssertBitwiseEqual(
                1.0f,
                NumberBaseHelper<float>.MaxMagnitudeNumber(-float.Epsilon, 1.0f)
            );
            ...
            AssertBitwiseEqual(
                float.MaxValue,
                NumberBaseHelper<float>.MaxMagnitudeNumber(float.MaxValue, 1.0f)
            );
            AssertBitwiseEqual(
                float.PositiveInfinity,
                NumberBaseHelper<float>.MaxMagnitudeNumber(float.PositiveInfinity, 1.0f)
            );
        }
        ...
        public static void MinMagnitudeTest()
        {
            AssertBitwiseEqual(
                1.0f,
                NumberBaseHelper<float>.MinMagnitude(float.NegativeInfinity, 1.0f)
            );
            ...
            AssertBitwiseEqual(
                -MaxSubnormal,
                NumberBaseHelper<float>.MinMagnitude(-MaxSubnormal, 1.0f)
            );
            AssertBitwiseEqual(
                -float.Epsilon,
                NumberBaseHelper<float>.MinMagnitude(-float.Epsilon, 1.0f)
            );
            ...
            AssertBitwiseEqual(
                1.0f,
                NumberBaseHelper<float>.MinMagnitude(float.PositiveInfinity, 1.0f)
            );
        }
        ...
        public static void MinMagnitudeNumberTest()
        {
            AssertBitwiseEqual(
                1.0f,
                NumberBaseHelper<float>.MinMagnitudeNumber(float.NegativeInfinity, 1.0f)
            );
            AssertBitwiseEqual(
                1.0f,
                NumberBaseHelper<float>.MinMagnitudeNumber(float.MinValue, 1.0f)
            );
            AssertBitwiseEqual(-1.0f, NumberBaseHelper<float>.MinMagnitudeNumber(-1.0f, 1.0f));
            AssertBitwiseEqual(
                -MinNormal,
                NumberBaseHelper<float>.MinMagnitudeNumber(-MinNormal, 1.0f)
            );
            AssertBitwiseEqual(
                -MaxSubnormal,
                NumberBaseHelper<float>.MinMagnitudeNumber(-MaxSubnormal, 1.0f)
            );
            AssertBitwiseEqual(
                -float.Epsilon,
                NumberBaseHelper<float>.MinMagnitudeNumber(-float.Epsilon, 1.0f)
            );
            ...
            AssertBitwiseEqual(
                1.0f,
                NumberBaseHelper<float>.MinMagnitudeNumber(float.MaxValue, 1.0f)
            );
            AssertBitwiseEqual(
                1.0f,
                NumberBaseHelper<float>.MinMagnitudeNumber(float.PositiveInfinity, 1.0f)
            );
        }
        ...
        public static void op_SubtractionTest()
        {
            AssertBitwiseEqual(
                float.NegativeInfinity,
                SubtractionOperatorsHelper<float, float, float>.op_Subtraction(
                    float.NegativeInfinity,
                    1.0f
                )
            );
            AssertBitwiseEqual(
                float.MinValue,
                SubtractionOperatorsHelper<float, float, float>.op_Subtraction(float.MinValue, 1.0f)
            );
            AssertBitwiseEqual(
                -2.0f,
                SubtractionOperatorsHelper<float, float, float>.op_Subtraction(-1.0f, 1.0f)
            );
            AssertBitwiseEqual(
                -1.0f,
                SubtractionOperatorsHelper<float, float, float>.op_Subtraction(-MinNormal, 1.0f)
            );
            AssertBitwiseEqual(
                -1.0f,
                SubtractionOperatorsHelper<float, float, float>.op_Subtraction(-MaxSubnormal, 1.0f)
            );
            AssertBitwiseEqual(
                -1.0f,
                SubtractionOperatorsHelper<float, float, float>.op_Subtraction(-float.Epsilon, 1.0f)
            );
            AssertBitwiseEqual(
                -1.0f,
                SubtractionOperatorsHelper<float, float, float>.op_Subtraction(-0.0f, 1.0f)
            );
            AssertBitwiseEqual(
                float.NaN,
                SubtractionOperatorsHelper<float, float, float>.op_Subtraction(float.NaN, 1.0f)
            );
            AssertBitwiseEqual(
                -1.0f,
                SubtractionOperatorsHelper<float, float, float>.op_Subtraction(0.0f, 1.0f)
            ...
            AssertBitwiseEqual(
                float.MaxValue,
                SubtractionOperatorsHelper<float, float, float>.op_Subtraction(float.MaxValue, 1.0f)
            );
            AssertBitwiseEqual(
                float.PositiveInfinity,
                SubtractionOperatorsHelper<float, float, float>.op_Subtraction(
        ...
        public static void op_CheckedSubtractionTest()
        {
            AssertBitwiseEqual(
                float.NegativeInfinity,
                SubtractionOperatorsHelper<float, float, float>.op_CheckedSubtraction(
                    float.NegativeInfinity,
                    1.0f
                )
            );
            ...
            AssertBitwiseEqual(
                -2.0f,
                SubtractionOperatorsHelper<float, float, float>.op_CheckedSubtraction(-1.0f, 1.0f)
            );
            AssertBitwiseEqual(
                -1.0f,
                SubtractionOperatorsHelper<float, float, float>.op_CheckedSubtraction(
            ...
            AssertBitwiseEqual(
                -1.0f,
                SubtractionOperatorsHelper<float, float, float>.op_CheckedSubtraction(-0.0f, 1.0f)
            );
            AssertBitwiseEqual(
                float.NaN,
                SubtractionOperatorsHelper<float, float, float>.op_CheckedSubtraction(
        ...
        public static void op_UnaryNegationTest()
        {
            AssertBitwiseEqual(
                float.PositiveInfinity,
                UnaryNegationOperatorsHelper<float, float>.op_UnaryNegation(float.NegativeInfinity)
            );
            AssertBitwiseEqual(
                float.MaxValue,
                UnaryNegationOperatorsHelper<float, float>.op_UnaryNegation(float.MinValue)
            );
            AssertBitwiseEqual(
                1.0f,
                UnaryNegationOperatorsHelper<float, float>.op_UnaryNegation(-1.0f)
            );
            AssertBitwiseEqual(
                MinNormal,
                UnaryNegationOperatorsHelper<float, float>.op_UnaryNegation(-MinNormal)
            );
            AssertBitwiseEqual(
                MaxSubnormal,
                UnaryNegationOperatorsHelper<float, float>.op_UnaryNegation(-MaxSubnormal)
            );
            AssertBitwiseEqual(
                float.Epsilon,
                UnaryNegationOperatorsHelper<float, float>.op_UnaryNegation(-float.Epsilon)
            );
            AssertBitwiseEqual(
                0.0f,
                UnaryNegationOperatorsHelper<float, float>.op_UnaryNegation(-0.0f)
            );
            AssertBitwiseEqual(
                float.NaN,
                UnaryNegationOperatorsHelper<float, float>.op_UnaryNegation(float.NaN)
            );
            AssertBitwiseEqual(
                -0.0f,
                UnaryNegationOperatorsHelper<float, float>.op_UnaryNegation(0.0f)
            ...
            AssertBitwiseEqual(
                float.MinValue,
                UnaryNegationOperatorsHelper<float, float>.op_UnaryNegation(float.MaxValue)
            );
            AssertBitwiseEqual(
                float.NegativeInfinity,
                UnaryNegationOperatorsHelper<float, float>.op_UnaryNegation(float.PositiveInfinity)
            );
        }
        ...
        public static void op_CheckedUnaryNegationTest()
        {
            AssertBitwiseEqual(
                float.PositiveInfinity,
                UnaryNegationOperatorsHelper<float, float>.op_CheckedUnaryNegation(
                    float.NegativeInfinity
                )
            );
            AssertBitwiseEqual(
                float.MaxValue,
                UnaryNegationOperatorsHelper<float, float>.op_CheckedUnaryNegation(float.MinValue)
            );
            AssertBitwiseEqual(
                1.0f,
                UnaryNegationOperatorsHelper<float, float>.op_CheckedUnaryNegation(-1.0f)
            );
            AssertBitwiseEqual(
                MinNormal,
                UnaryNegationOperatorsHelper<float, float>.op_CheckedUnaryNegation(-MinNormal)
            );
            AssertBitwiseEqual(
                MaxSubnormal,
                UnaryNegationOperatorsHelper<float, float>.op_CheckedUnaryNegation(-MaxSubnormal)
            );
            AssertBitwiseEqual(
                float.Epsilon,
                UnaryNegationOperatorsHelper<float, float>.op_CheckedUnaryNegation(-float.Epsilon)
            );
            AssertBitwiseEqual(
                0.0f,
                UnaryNegationOperatorsHelper<float, float>.op_CheckedUnaryNegation(-0.0f)
            );
            AssertBitwiseEqual(
                float.NaN,
                UnaryNegationOperatorsHelper<float, float>.op_CheckedUnaryNegation(float.NaN)
            );
            AssertBitwiseEqual(
                -0.0f,
                UnaryNegationOperatorsHelper<float, float>.op_CheckedUnaryNegation(0.0f)
            ...
            AssertBitwiseEqual(
                float.MinValue,
                UnaryNegationOperatorsHelper<float, float>.op_CheckedUnaryNegation(float.MaxValue)
            );
            AssertBitwiseEqual(
                float.NegativeInfinity,
                UnaryNegationOperatorsHelper<float, float>.op_CheckedUnaryNegation(
        ...
        public static void op_UnaryPlusTest()
        {
            AssertBitwiseEqual(
                float.NegativeInfinity,
                UnaryPlusOperatorsHelper<float, float>.op_UnaryPlus(float.NegativeInfinity)
            );
            AssertBitwiseEqual(
                float.MinValue,
                UnaryPlusOperatorsHelper<float, float>.op_UnaryPlus(float.MinValue)
            );
            AssertBitwiseEqual(-1.0f, UnaryPlusOperatorsHelper<float, float>.op_UnaryPlus(-1.0f));
            AssertBitwiseEqual(
                -MinNormal,
                UnaryPlusOperatorsHelper<float, float>.op_UnaryPlus(-MinNormal)
            );
            AssertBitwiseEqual(
                -MaxSubnormal,
                UnaryPlusOperatorsHelper<float, float>.op_UnaryPlus(-MaxSubnormal)
            );
            AssertBitwiseEqual(
                -float.Epsilon,
                UnaryPlusOperatorsHelper<float, float>.op_UnaryPlus(-float.Epsilon)
            );
            AssertBitwiseEqual(-0.0f, UnaryPlusOperatorsHelper<float, float>.op_UnaryPlus(-0.0f));
            AssertBitwiseEqual(
                float.NaN,
                UnaryPlusOperatorsHelper<float, float>.op_UnaryPlus(float.NaN)
            );
            AssertBitwiseEqual(0.0f, UnaryPlusOperatorsHelper<float, float>.op_UnaryPlus(0.0f));
            AssertBitwiseEqual(
                float.Epsilon,
            ...
            AssertBitwiseEqual(
                float.MaxValue,
                UnaryPlusOperatorsHelper<float, float>.op_UnaryPlus(float.MaxValue)
            );
            AssertBitwiseEqual(
                float.PositiveInfinity,
                UnaryPlusOperatorsHelper<float, float>.op_UnaryPlus(float.PositiveInfinity)
            );
        }
        ...
        )
        {
            ...
            if (isDefaultProvider)
            {
                ...
                Assert.True(
                    NumberBaseHelper<float>.TryParse(
                        value,
                        style,
                ...
                Assert.Equal(
                    expected,
                    NumberBaseHelper<float>.Parse(value, style, NumberFormatInfo.CurrentInfo)
                );
            }
        }
        ...
        )
        {
            ...
            Assert.Throws(
                exceptionType,
                () => NumberBaseHelper<float>.Parse(value, style, provider)
            );
            ...
            if (isDefaultProvider)
            {
                ...
                Assert.Throws(
                    exceptionType,
                    () => NumberBaseHelper<float>.Parse(value, style, null)
                );
                Assert.Throws(
                    exceptionType,
                    () => NumberBaseHelper<float>.Parse(value, style, NumberFormatInfo.CurrentInfo)
        ...
        [Theory]
        [MemberData(
            nameof(SingleTests.Parse_ValidWithOffsetCount_TestData),
            MemberType = typeof(SingleTests)
        )]
        ...
        )
        {
            ...
            )
            {
                ...
                {
                    Assert.True(
                        SpanParsableHelper<float>.TryParse(
                    ...
                    Assert.Equal(
                        expected,
                        SpanParsableHelper<float>.Parse(value.AsSpan(offset, count), null)
                    );
                }

                Assert.Equal(
                    expected,
                    SpanParsableHelper<float>.Parse(value.AsSpan(offset, count), provider: provider)
                );
            }

            Assert.Equal(
                expected,
                NumberBaseHelper<float>.Parse(value.AsSpan(offset, count), style, provider)
            );
        ...
        )
        {
            if (value != null)
            {
                Assert.Throws(
                    exceptionType,
                    () => NumberBaseHelper<float>.Parse(value.AsSpan(), style, provider)
                );
