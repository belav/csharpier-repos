    ...
    public class TimeSpanTests
    {
        ...
        public static IEnumerable<object[]> Add_TestData()
        {
            ...
            yield return new object[]
            {
                ...
                new TimeSpan(1, 2, 3),
                new TimeSpan(1, 3, 5, 7, 5),
            };
            yield return new object[]
            {
                new TimeSpan(1, 2, 3, 4, 5),
                new TimeSpan(10, 12, 13, 14, 15),
                new TimeSpan(11, 14, 16, 18, 20),
            };
            yield return new object[]
            {
                new TimeSpan(10000),
        ...
        {
            double maxDays =
                long.MaxValue / (TimeSpan.TicksPerMillisecond / 1000.0 / 60.0 / 60.0 / 24.0);
        ...
        public static IEnumerable<object[]> Parse_Valid_TestData()
        {
            ...
            yield return new object[]
            {
                "1:1:1.1",
                CultureInfo.InvariantCulture,
                new TimeSpan(0, 1, 1, 1, 100),
            };
            yield return new object[]
            {
                "1:1:1.01",
                CultureInfo.InvariantCulture,
                new TimeSpan(0, 1, 1, 1, 10),
            };
            yield return new object[]
            {
                "1:1:1.001",
            ...
            yield return new object[]
            {
                "1:1:1.000001",
                CultureInfo.InvariantCulture,
                new TimeSpan(36610000010),
            };
            yield return new object[]
            {
                "1:1:1.0000001",
                CultureInfo.InvariantCulture,
                new TimeSpan(36610000001),
            };
            ...
            yield return new object[]
            {
                "1:1:.1",
                CultureInfo.InvariantCulture,
                new TimeSpan(36601000000),
            };
            yield return new object[]
            {
                "1:1:.01",
                CultureInfo.InvariantCulture,
                new TimeSpan(36600100000),
            };
            yield return new object[]
            {
                "1:1:.001",
                CultureInfo.InvariantCulture,
                new TimeSpan(36600010000),
            };
            yield return new object[]
            {
                "1:1:.0001",
                CultureInfo.InvariantCulture,
                new TimeSpan(36600001000),
            };
            yield return new object[]
            {
                "1:1:.00001",
                CultureInfo.InvariantCulture,
                new TimeSpan(36600000100),
            };
            yield return new object[]
            {
                "1:1:.000001",
            ...
            yield return new object[]
            {
                "10675199:02:00:00",
                null,
                new TimeSpan(9223372008000000000),
            };
            yield return new object[]
            {
                "10675199:02:48:00",
                null,
                new TimeSpan(9223372036800000000),
            };
            yield return new object[]
            {
                "10675199:02:48:05",
                null,
                new TimeSpan(9223372036850000000),
            };
            yield return new object[]
            {
                "10675199:02:48:05.4775",
                CultureInfo.InvariantCulture,
                new TimeSpan(9223372036854775000),
            };
        ...
        public static IEnumerable<object[]> Parse_Invalid_TestData()
        {
            ...
            }; // overflowing days + hours + minutes + seconds + fraction
            yield return new object[]
            {
                "-10675199:02:48:05.4776",
                CultureInfo.InvariantCulture,
                typeof(OverflowException),
            }; // negative overflowing d + h + m + s +f
        ...
        public static IEnumerable<object[]> ParseExact_Valid_TestData()
        {
            ...
            yield return new object[]
            {
                "12.23:32:43",
                @"dd\.h\:m\:s",
                new TimeSpan(12, 23, 32, 43),
            };
            yield return new object[]
            {
                "012.23:32:43.893",
                @"ddd\.h\:m\:s\.fff",
                new TimeSpan(12, 23, 32, 43, 893),
            };
            yield return new object[]
            {
                "12.05:02:03",
                @"d\.hh\:mm\:ss",
                new TimeSpan(12, 5, 2, 3),
            };
            yield return new object[]
            {
                "12:34 minutes",
        ...
        public static void ParseExact(string input, string format, TimeSpan expected)
        {
            ...
            Assert.Equal(
                expected,
                TimeSpan.ParseExact(input, new[] { format }, new CultureInfo("en-US"))
            );
            Assert.Equal(
                expected,
                TimeSpan.ParseExact(
            ...
            Assert.True(
                TimeSpan.TryParseExact(input, format, new CultureInfo("en-US"), out result)
            );
            Assert.Equal(expected, result);
        ...
        )
        {
            if (inputString != null)
            {
                ...
                Assert.False(
                    TimeSpan.TryParse(inputString.AsSpan(), provider, out TimeSpan result)
                );
                Assert.Equal(TimeSpan.Zero, result);
            }
        }
        ...
        [Theory]
        [MemberData(nameof(ParseExact_Valid_TestData))]
        public static void ParseExact_Span_Valid(
            string inputString,
            string format,
            TimeSpan expected
        )
        ...
        [Theory]
        [MemberData(nameof(ParseExact_Invalid_TestData))]
        public static void ParseExactTest_Span_Invalid(
            string inputString,
            string format,
            Type exceptionType
        )
        ...
        public static IEnumerable<object[]> Subtract_TestData()
        {
            ...
            yield return new object[]
            {
                new TimeSpan(1, 2, 3, 4, 5),
                new TimeSpan(1, 2, 3),
                new TimeSpan(1, 1, 1, 1, 5),
            };
            yield return new object[]
            {
                new TimeSpan(10, 11, 12, 13, 14),
                new TimeSpan(1, 2, 3, 4, 5),
                new TimeSpan(9, 9, 9, 9, 9),
            };
            yield return new object[]
            {
                new TimeSpan(200000),
        ...
        public static IEnumerable<object[]> ToString_TestData()
        {
            ...
            CultureInfo[] cultureInfos = PlatformDetection.IsInvariantGlobalization
                ? new[] { (CultureInfo)null }
                : new[] { null, invariantInfo, commaSeparatorInfo };
        ...
        public static void ToString_Valid(
            TimeSpan input,
            string format,
            CultureInfo info,
            string expected
        ...
        private static void VerifyTimeSpan(
            TimeSpan timeSpan,
            int days,
            int hours,
            int minutes,
        ...
        [Theory]
        [MemberData(nameof(ToString_TestData))]
        public static void TryFormat_Valid(
            TimeSpan input,
            string format,
            CultureInfo info,
            string expected
