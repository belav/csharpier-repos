...
namespace System.Tests
{
    public class DecimalTests_GenericMath
    {
        ...
        {
            Assert.Equal(
                -79228162514264337593543950334.0m,
                AdditionOperatorsHelper<decimal, decimal, decimal>.op_Addition(
                    decimal.MinValue,
                    1.0m
                )
            );
            Assert.Equal(
                0.0m,
                AdditionOperatorsHelper<decimal, decimal, decimal>.op_Addition(-1.0m, 1.0m)
            );
            Assert.Equal(
                1.0m,
                AdditionOperatorsHelper<decimal, decimal, decimal>.op_Addition(-0.0m, 1.0m)
            );
            Assert.Equal(
                1.0m,
                AdditionOperatorsHelper<decimal, decimal, decimal>.op_Addition(0.0m, 1.0m)
        ...
        public static void op_CheckedAdditionTest()
        {
            Assert.Equal(
                -79228162514264337593543950334.0m,
                AdditionOperatorsHelper<decimal, decimal, decimal>.op_CheckedAddition(
                    decimal.MinValue,
                    1.0m
                )
            );
            Assert.Equal(
                0.0m,
                AdditionOperatorsHelper<decimal, decimal, decimal>.op_CheckedAddition(-1.0m, 1.0m)
            );
            Assert.Equal(
                1.0m,
                AdditionOperatorsHelper<decimal, decimal, decimal>.op_CheckedAddition(-0.0m, 1.0m)
            );
            Assert.Equal(
                1.0m,
                AdditionOperatorsHelper<decimal, decimal, decimal>.op_CheckedAddition(0.0m, 1.0m)
        ...
        {
            Assert.False(
                ComparisonOperatorsHelper<decimal, decimal, bool>.op_GreaterThan(
                    decimal.MinValue,
                    1.0m
                )
            );
            Assert.False(
                ComparisonOperatorsHelper<decimal, decimal, bool>.op_GreaterThan(-1.0m, 1.0m)
            );
            Assert.False(
                ComparisonOperatorsHelper<decimal, decimal, bool>.op_GreaterThan(-0.0m, 1.0m)
            );
            Assert.False(
                ComparisonOperatorsHelper<decimal, decimal, bool>.op_GreaterThan(0.0m, 1.0m)
            );
        ...
        {
            Assert.False(
                ComparisonOperatorsHelper<decimal, decimal, bool>.op_GreaterThanOrEqual(
                    decimal.MinValue,
                    1.0m
                )
            );
            Assert.False(
                ComparisonOperatorsHelper<decimal, decimal, bool>.op_GreaterThanOrEqual(-1.0m, 1.0m)
            );
            Assert.False(
                ComparisonOperatorsHelper<decimal, decimal, bool>.op_GreaterThanOrEqual(-0.0m, 1.0m)
            );
            Assert.False(
                ComparisonOperatorsHelper<decimal, decimal, bool>.op_GreaterThanOrEqual(0.0m, 1.0m)
            );
        ...
        {
            Assert.True(
                ComparisonOperatorsHelper<decimal, decimal, bool>.op_LessThan(
                    decimal.MinValue,
                    1.0m
                )
            );
        ...
        {
            Assert.True(
                ComparisonOperatorsHelper<decimal, decimal, bool>.op_LessThanOrEqual(
                    decimal.MinValue,
                    1.0m
                )
            );
            Assert.True(
                ComparisonOperatorsHelper<decimal, decimal, bool>.op_LessThanOrEqual(-1.0m, 1.0m)
            );
            Assert.True(
                ComparisonOperatorsHelper<decimal, decimal, bool>.op_LessThanOrEqual(-0.0m, 1.0m)
            );
            Assert.True(
                ComparisonOperatorsHelper<decimal, decimal, bool>.op_LessThanOrEqual(0.0m, 1.0m)
            );
        ...
        public static void op_DecrementTest()
        {
            ...
            Assert.Equal(
                79228162514264337593543950334.0m,
                DecrementOperatorsHelper<decimal>.op_Decrement(decimal.MaxValue)
            );

            Assert.Throws<OverflowException>(() =>
                DecrementOperatorsHelper<decimal>.op_Decrement(decimal.MinValue)
            );
        }
        ...
        public static void op_CheckedDecrementTest()
        {
            ...
            Assert.Equal(
                79228162514264337593543950334.0m,
                DecrementOperatorsHelper<decimal>.op_CheckedDecrement(decimal.MaxValue)
            );

            Assert.Throws<OverflowException>(() =>
                DecrementOperatorsHelper<decimal>.op_CheckedDecrement(decimal.MinValue)
            );
        }
        ...
        {
            Assert.Equal(
                -39614081257132168796771975168.0m,
                DivisionOperatorsHelper<decimal, decimal, decimal>.op_Division(
                    decimal.MinValue,
                    2.0m
                )
            );
            Assert.Equal(
                -0.5m,
                DivisionOperatorsHelper<decimal, decimal, decimal>.op_Division(-1.0m, 2.0m)
            );
            Assert.Equal(
                -0.0m,
                DivisionOperatorsHelper<decimal, decimal, decimal>.op_Division(-0.0m, 2.0m)
            );
            Assert.Equal(
                0.0m,
                DivisionOperatorsHelper<decimal, decimal, decimal>.op_Division(0.0m, 2.0m)
        ...
        public static void op_CheckedDivisionTest()
        {
            Assert.Equal(
                -39614081257132168796771975168.0m,
                DivisionOperatorsHelper<decimal, decimal, decimal>.op_CheckedDivision(
                    decimal.MinValue,
                    2.0m
                )
            );
            Assert.Equal(
                -0.5m,
                DivisionOperatorsHelper<decimal, decimal, decimal>.op_CheckedDivision(-1.0m, 2.0m)
            );
            Assert.Equal(
                -0.0m,
                DivisionOperatorsHelper<decimal, decimal, decimal>.op_CheckedDivision(-0.0m, 2.0m)
            );
            Assert.Equal(
                0.0m,
                DivisionOperatorsHelper<decimal, decimal, decimal>.op_CheckedDivision(0.0m, 2.0m)
        ...
        {
            Assert.False(
                EqualityOperatorsHelper<decimal, decimal, bool>.op_Equality(decimal.MinValue, 1.0m)
            );
            ...
            Assert.False(
                EqualityOperatorsHelper<decimal, decimal, bool>.op_Equality(decimal.MaxValue, 1.0m)
            );
        }
        ...
        {
            Assert.True(
                EqualityOperatorsHelper<decimal, decimal, bool>.op_Inequality(
                    decimal.MinValue,
                    1.0m
                )
            );
        ...
        public static void GetExponentShortestBitLengthTest()
        {
            Assert.Equal(
                7,
                FloatingPointHelper<decimal>.GetExponentShortestBitLength(decimal.MinValue)
            );
            ...
            Assert.Equal(
                7,
                FloatingPointHelper<decimal>.GetExponentShortestBitLength(decimal.MaxValue)
            );
        }
        ...
        public static void GetSignificandByteCountTest()
        {
            Assert.Equal(
                12,
                FloatingPointHelper<decimal>.GetSignificandByteCount(decimal.MinValue)
            );
            ...
            Assert.Equal(
                12,
                FloatingPointHelper<decimal>.GetSignificandByteCount(decimal.MaxValue)
            );
        }
        ...
        public static void GetSignificandBitLengthTest()
        {
            Assert.Equal(
                96,
                FloatingPointHelper<decimal>.GetSignificandBitLength(decimal.MinValue)
            );
            ...
            Assert.Equal(
                96,
                FloatingPointHelper<decimal>.GetSignificandBitLength(decimal.MaxValue)
            );
        }
        ...
        public static void TryWriteExponentBigEndianTest()
        {
            ...
            Assert.True(
                FloatingPointHelper<decimal>.TryWriteExponentBigEndian(
                    decimal.MinValue,
                    destination,
                    out bytesWritten
                )
        ...
        public static void TryWriteExponentLittleEndianTest()
        {
            ...
            Assert.True(
                FloatingPointHelper<decimal>.TryWriteExponentLittleEndian(
                    decimal.MinValue,
                    destination,
                    out bytesWritten
                )
        ...
        public static void TryWriteSignificandBigEndianTest()
        {
            ...
            Assert.True(
                FloatingPointHelper<decimal>.TryWriteSignificandBigEndian(
                    decimal.MinValue,
                    destination,
                    out bytesWritten
                )
        ...
        public static void TryWriteSignificandLittleEndianTest()
        {
            ...
            Assert.True(
                FloatingPointHelper<decimal>.TryWriteSignificandLittleEndian(
                    decimal.MinValue,
                    destination,
                    out bytesWritten
                )
        ...
        public static void op_IncrementTest()
        {
            Assert.Equal(
                -79228162514264337593543950334.0m,
                IncrementOperatorsHelper<decimal>.op_Increment(decimal.MinValue)
            );
            ...
            Assert.Throws<OverflowException>(() =>
                IncrementOperatorsHelper<decimal>.op_Increment(decimal.MaxValue)
            );
        }
        ...
        public static void op_CheckedIncrementTest()
        {
            Assert.Equal(
                -79228162514264337593543950334.0m,
                IncrementOperatorsHelper<decimal>.op_CheckedIncrement(decimal.MinValue)
            );
            ...
            Assert.Throws<OverflowException>(() =>
                IncrementOperatorsHelper<decimal>.op_CheckedIncrement(decimal.MaxValue)
            );
        }
        ...
        public static void op_ModulusTest()
        {
            Assert.Equal(
                -1.0m,
                ModulusOperatorsHelper<decimal, decimal, decimal>.op_Modulus(decimal.MinValue, 2.0m)
            );
            Assert.Equal(
                -1.0m,
                ModulusOperatorsHelper<decimal, decimal, decimal>.op_Modulus(-1.0m, 2.0m)
            );
            Assert.Equal(
                -0.0m,
                ModulusOperatorsHelper<decimal, decimal, decimal>.op_Modulus(-0.0m, 2.0m)
            );
            Assert.Equal(
                0.0m,
                ModulusOperatorsHelper<decimal, decimal, decimal>.op_Modulus(0.0m, 2.0m)
            ...
            Assert.Equal(
                1.0m,
                ModulusOperatorsHelper<decimal, decimal, decimal>.op_Modulus(decimal.MaxValue, 2.0m)
            );
        }
        ...
        public static void MultiplicativeIdentityTest()
        {
            Assert.Equal(
                1.0m,
                MultiplicativeIdentityHelper<decimal, decimal>.MultiplicativeIdentity
            );
        }
        ...
        public static void op_MultiplyTest()
        {
            Assert.Equal(
                -2.0m,
                MultiplyOperatorsHelper<decimal, decimal, decimal>.op_Multiply(-1.0m, 2.0m)
            );
            Assert.Equal(
                -0.0m,
                MultiplyOperatorsHelper<decimal, decimal, decimal>.op_Multiply(-0.0m, 2.0m)
            );
            Assert.Equal(
                0.0m,
                MultiplyOperatorsHelper<decimal, decimal, decimal>.op_Multiply(0.0m, 2.0m)
            ...
            Assert.Throws<OverflowException>(() =>
                MultiplyOperatorsHelper<decimal, decimal, decimal>.op_Multiply(
                    decimal.MinValue,
                    2.0m
                )
            );
        ...
        public static void op_CheckedMultiplyTest()
        {
            Assert.Equal(
                -2.0m,
                MultiplyOperatorsHelper<decimal, decimal, decimal>.op_CheckedMultiply(-1.0m, 2.0m)
            );
            Assert.Equal(
                -0.0m,
                MultiplyOperatorsHelper<decimal, decimal, decimal>.op_CheckedMultiply(-0.0m, 2.0m)
            );
            Assert.Equal(
                0.0m,
                MultiplyOperatorsHelper<decimal, decimal, decimal>.op_CheckedMultiply(0.0m, 2.0m)
            ...
            Assert.Throws<OverflowException>(() =>
                MultiplyOperatorsHelper<decimal, decimal, decimal>.op_CheckedMultiply(
                    decimal.MinValue,
                    2.0m
                )
            );
        ...
        public static void CreateCheckedFromDecimalTest()
        {
            ...
            Assert.Equal(
                decimal.MaxValue,
                NumberBaseHelper<decimal>.CreateChecked<decimal>(decimal.MaxValue)
            );
        }
        ...
        public static void CreateCheckedFromDoubleTest()
        {
            ...
            Assert.Equal(
                +79228162514264300000000000000.0m,
                NumberBaseHelper<decimal>.CreateChecked<double>(+79228162514264333195497439231.0)
            );
            Assert.Equal(
                -79228162514264300000000000000.0m,
                NumberBaseHelper<decimal>.CreateChecked<double>(-79228162514264333195497439231.0)
            ...
            Assert.Throws<OverflowException>(() =>
                NumberBaseHelper<decimal>.CreateChecked<double>(+79228162514264337593543950335.0)
            );
            Assert.Throws<OverflowException>(() =>
                NumberBaseHelper<decimal>.CreateChecked<double>(-79228162514264337593543950335.0)
            );
            ...
            Assert.Throws<OverflowException>(() =>
                NumberBaseHelper<decimal>.CreateChecked<double>(double.MaxValue)
            );
            Assert.Throws<OverflowException>(() =>
                NumberBaseHelper<decimal>.CreateChecked<double>(double.MinValue)
            );

            Assert.Throws<OverflowException>(() =>
                NumberBaseHelper<decimal>.CreateChecked<double>(double.PositiveInfinity)
            );
            Assert.Throws<OverflowException>(() =>
                NumberBaseHelper<decimal>.CreateChecked<double>(double.NegativeInfinity)
            );

            Assert.Throws<OverflowException>(() =>
                NumberBaseHelper<decimal>.CreateChecked<double>(double.NaN)
            );
        }
        ...
        public static void CreateCheckedFromHalfTest()
        {
            ...
            Assert.Equal(
                +0.00000005960464m,
                NumberBaseHelper<decimal>.CreateChecked<Half>(+Half.Epsilon)
            );
            Assert.Equal(
                -0.00000005960464m,
                NumberBaseHelper<decimal>.CreateChecked<Half>(-Half.Epsilon)
            ...
            Assert.Throws<OverflowException>(() =>
                NumberBaseHelper<decimal>.CreateChecked<Half>(Half.PositiveInfinity)
            );
            Assert.Throws<OverflowException>(() =>
                NumberBaseHelper<decimal>.CreateChecked<Half>(Half.NegativeInfinity)
            );

            Assert.Throws<OverflowException>(() =>
                NumberBaseHelper<decimal>.CreateChecked<Half>(Half.NaN)
            );
        }
        ...
        public static void CreateCheckedFromInt16Test()
        {
            ...
            Assert.Equal(
                -32768.0m,
                NumberBaseHelper<decimal>.CreateChecked<short>(unchecked((short)0x8000))
            );
            Assert.Equal(
                -1.0m,
                NumberBaseHelper<decimal>.CreateChecked<short>(unchecked((short)0xFFFF))
            );
        }
        ...
        public static void CreateCheckedFromInt32Test()
        {
            ...
            Assert.Equal(
                -2147483648.0m,
                NumberBaseHelper<decimal>.CreateChecked<int>(unchecked((int)0x80000000))
            );
            Assert.Equal(
                -1.0m,
                NumberBaseHelper<decimal>.CreateChecked<int>(unchecked((int)0xFFFFFFFF))
            );
        }
        ...
        public static void CreateCheckedFromInt64Test()
        {
            ...
            Assert.Equal(
                ...
                NumberBaseHelper<decimal>.CreateChecked<long>(0x7FFFFFFFFFFFFFFF)
            );
            Assert.Equal(
                -9223372036854775808.0m,
                NumberBaseHelper<decimal>.CreateChecked<long>(
        ...
        public static void CreateCheckedFromInt128Test()
        {
            Assert.Equal(
                0.0m,
                NumberBaseHelper<decimal>.CreateChecked<Int128>(
        ...
        public static void CreateCheckedFromIntPtrTest()
        {
            if (Environment.Is64BitProcess)
            {
                Assert.Equal(
                    0.0m,
                    NumberBaseHelper<decimal>.CreateChecked<nint>(
            ...
            else
            {
                ...
                Assert.Equal(
                    2147483647.0m,
                    NumberBaseHelper<decimal>.CreateChecked<nint>((nint)0x7FFFFFFF)
                );
                Assert.Equal(
                    -2147483648.0m,
                    NumberBaseHelper<decimal>.CreateChecked<nint>(unchecked((nint)0x80000000))
                );
                Assert.Equal(
                    -1.0m,
                    NumberBaseHelper<decimal>.CreateChecked<nint>(unchecked((nint)0xFFFFFFFF))
                );
            }
        }
        ...
        public static void CreateCheckedFromNFloatTest()
        {
            ...
            Assert.Equal(
                0.0m,
                NumberBaseHelper<decimal>.CreateChecked<NFloat>(NFloat.NegativeZero)
            );
            ...
            Assert.Throws<OverflowException>(() =>
                NumberBaseHelper<decimal>.CreateChecked<NFloat>(NFloat.MaxValue)
            );
            Assert.Throws<OverflowException>(() =>
                NumberBaseHelper<decimal>.CreateChecked<NFloat>(NFloat.MinValue)
            );

            Assert.Throws<OverflowException>(() =>
                NumberBaseHelper<decimal>.CreateChecked<NFloat>(NFloat.PositiveInfinity)
            );
            Assert.Throws<OverflowException>(() =>
                NumberBaseHelper<decimal>.CreateChecked<NFloat>(NFloat.NegativeInfinity)
            );

            Assert.Throws<OverflowException>(() =>
                NumberBaseHelper<decimal>.CreateChecked<NFloat>(NFloat.NaN)
            );
        }
        ...
        public static void CreateCheckedFromSByteTest()
        {
            ...
            Assert.Equal(
                -128.0m,
                NumberBaseHelper<decimal>.CreateChecked<sbyte>(unchecked((sbyte)0x80))
            );
            Assert.Equal(
                -1.0m,
                NumberBaseHelper<decimal>.CreateChecked<sbyte>(unchecked((sbyte)0xFF))
            );
        }
        ...
        public static void CreateCheckedFromSingleTest()
        {
            ...
            Assert.Equal(
                +79228160000000000000000000000.0m,
                NumberBaseHelper<decimal>.CreateChecked<float>(+79228160000000000000000000000.0f)
            );
            Assert.Equal(
                -79228160000000000000000000000.0m,
                NumberBaseHelper<decimal>.CreateChecked<float>(-79228160000000000000000000000.0f)
            ...
            Assert.Throws<OverflowException>(() =>
                NumberBaseHelper<decimal>.CreateChecked<float>(+79228162514264337593543950335.0f)
            );
            Assert.Throws<OverflowException>(() =>
                NumberBaseHelper<decimal>.CreateChecked<float>(-79228162514264337593543950335.0f)
            );
            ...
            Assert.Throws<OverflowException>(() =>
                NumberBaseHelper<decimal>.CreateChecked<float>(float.MaxValue)
            );
            Assert.Throws<OverflowException>(() =>
                NumberBaseHelper<decimal>.CreateChecked<float>(float.MinValue)
            );

            Assert.Throws<OverflowException>(() =>
                NumberBaseHelper<decimal>.CreateChecked<float>(float.PositiveInfinity)
            );
            Assert.Throws<OverflowException>(() =>
                NumberBaseHelper<decimal>.CreateChecked<float>(float.NegativeInfinity)
            );

            Assert.Throws<OverflowException>(() =>
                NumberBaseHelper<decimal>.CreateChecked<float>(float.NaN)
            );
        }
        ...
        public static void CreateCheckedFromUInt64Test()
        {
            ...
            Assert.Equal(
                9223372036854775807.0m,
                NumberBaseHelper<decimal>.CreateChecked<ulong>(0x7FFFFFFFFFFFFFFF)
            );
            Assert.Equal(
                9223372036854775808.0m,
                NumberBaseHelper<decimal>.CreateChecked<ulong>(0x8000000000000000)
            );
            Assert.Equal(
                18446744073709551615.0m,
                NumberBaseHelper<decimal>.CreateChecked<ulong>(0xFFFFFFFFFFFFFFFF)
            );
        }
        ...
        public static void CreateCheckedFromUInt128Test()
        {
            Assert.Equal(
                0.0m,
                NumberBaseHelper<decimal>.CreateChecked<UInt128>(
        ...
        public static void CreateCheckedFromUIntPtrTest()
        {
            if (Environment.Is64BitProcess)
            {
                Assert.Equal(
                    0.0m,
                    NumberBaseHelper<decimal>.CreateChecked<nuint>(
            ...
            else
            {
                Assert.Equal(
                    0.0m,
                    NumberBaseHelper<decimal>.CreateChecked<nuint>((nuint)0x00000000)
                );
                Assert.Equal(
                    1.0m,
                    NumberBaseHelper<decimal>.CreateChecked<nuint>((nuint)0x00000001)
                );
                Assert.Equal(
                    2147483647.0m,
                    NumberBaseHelper<decimal>.CreateChecked<nuint>((nuint)0x7FFFFFFF)
                );
                Assert.Equal(
                    2147483648.0m,
                    NumberBaseHelper<decimal>.CreateChecked<nuint>((nuint)0x80000000)
                );
                Assert.Equal(
                    4294967295.0m,
                    NumberBaseHelper<decimal>.CreateChecked<nuint>((nuint)0xFFFFFFFF)
                );
            }
        }
        ...
        public static void CreateSaturatingFromDecimalTest()
        {
            ...
            Assert.Equal(
                decimal.MaxValue,
                NumberBaseHelper<decimal>.CreateSaturating<decimal>(decimal.MaxValue)
            );
        }
        ...
        public static void CreateSaturatingFromDoubleTest()
        {
            ...
            Assert.Equal(
                +79228162514264300000000000000.0m,
                NumberBaseHelper<decimal>.CreateSaturating<double>(+79228162514264333195497439231.0)
            );
            Assert.Equal(
                -79228162514264300000000000000.0m,
                NumberBaseHelper<decimal>.CreateSaturating<double>(-79228162514264333195497439231.0)
            ...
            Assert.Equal(
                decimal.MaxValue,
                NumberBaseHelper<decimal>.CreateSaturating<double>(+79228162514264337593543950335.0)
            );
            Assert.Equal(
                decimal.MinValue,
                NumberBaseHelper<decimal>.CreateSaturating<double>(-79228162514264337593543950335.0)
            ...
            Assert.Equal(
                decimal.MaxValue,
                NumberBaseHelper<decimal>.CreateSaturating<double>(double.MaxValue)
            );
            Assert.Equal(
                decimal.MinValue,
                NumberBaseHelper<decimal>.CreateSaturating<double>(double.MinValue)
            );

            Assert.Equal(
                decimal.MaxValue,
                NumberBaseHelper<decimal>.CreateSaturating<double>(double.PositiveInfinity)
            );
            Assert.Equal(
                decimal.MinValue,
                NumberBaseHelper<decimal>.CreateSaturating<double>(double.NegativeInfinity)
            );

            Assert.Equal(
                decimal.Zero,
                NumberBaseHelper<decimal>.CreateSaturating<double>(double.NaN)
            );
        }
        ...
        public static void CreateSaturatingFromHalfTest()
        {
            ...
            Assert.Equal(
                +0.00000005960464m,
                NumberBaseHelper<decimal>.CreateSaturating<Half>(+Half.Epsilon)
            );
            Assert.Equal(
                -0.00000005960464m,
                NumberBaseHelper<decimal>.CreateSaturating<Half>(-Half.Epsilon)
            ...
            Assert.Equal(
                +65504.0m,
                NumberBaseHelper<decimal>.CreateSaturating<Half>(Half.MaxValue)
            );
            Assert.Equal(
                -65504.0m,
                NumberBaseHelper<decimal>.CreateSaturating<Half>(Half.MinValue)
            );

            Assert.Equal(
                decimal.MaxValue,
                NumberBaseHelper<decimal>.CreateSaturating<Half>(Half.PositiveInfinity)
            );
            Assert.Equal(
                decimal.MinValue,
                NumberBaseHelper<decimal>.CreateSaturating<Half>(Half.NegativeInfinity)
            );
        ...
        public static void CreateSaturatingFromInt16Test()
        {
            ...
            Assert.Equal(
                -32768.0m,
                NumberBaseHelper<decimal>.CreateSaturating<short>(unchecked((short)0x8000))
            );
            Assert.Equal(
                -1.0m,
                NumberBaseHelper<decimal>.CreateSaturating<short>(unchecked((short)0xFFFF))
            );
        }
        ...
        public static void CreateSaturatingFromInt32Test()
        {
            ...
            Assert.Equal(
                2147483647.0m,
                NumberBaseHelper<decimal>.CreateSaturating<int>(0x7FFFFFFF)
            );
            Assert.Equal(
                -2147483648.0m,
                NumberBaseHelper<decimal>.CreateSaturating<int>(unchecked((int)0x80000000))
            );
            Assert.Equal(
                -1.0m,
                NumberBaseHelper<decimal>.CreateSaturating<int>(unchecked((int)0xFFFFFFFF))
            );
        }
        ...
        public static void CreateSaturatingFromInt64Test()
        {
            Assert.Equal(
                0.0m,
                NumberBaseHelper<decimal>.CreateSaturating<long>(0x0000000000000000)
            );
            Assert.Equal(
                1.0m,
                NumberBaseHelper<decimal>.CreateSaturating<long>(0x0000000000000001)
            );
            Assert.Equal(
                9223372036854775807.0m,
                NumberBaseHelper<decimal>.CreateSaturating<long>(0x7FFFFFFFFFFFFFFF)
            );
            Assert.Equal(
                -9223372036854775808.0m,
                NumberBaseHelper<decimal>.CreateSaturating<long>(
                    unchecked(unchecked((long)0x8000000000000000))
                )
            );
            Assert.Equal(
        ...
        public static void CreateSaturatingFromInt128Test()
        {
            Assert.Equal(
                0.0m,
                NumberBaseHelper<decimal>.CreateSaturating<Int128>(
                    new Int128(0x0000_0000_0000_0000, 0x0000_0000_0000_0000)
                )
            );
        ...
        public static void CreateSaturatingFromIntPtrTest()
        {
            if (Environment.Is64BitProcess)
            {
                Assert.Equal(
                    0.0m,
                    NumberBaseHelper<decimal>.CreateSaturating<nint>(
                        unchecked((nint)0x0000000000000000)
                    )
                );
                Assert.Equal(
            ...
            else
            {
                Assert.Equal(
                    0.0m,
                    NumberBaseHelper<decimal>.CreateSaturating<nint>((nint)0x00000000)
                );
                Assert.Equal(
                    1.0m,
                    NumberBaseHelper<decimal>.CreateSaturating<nint>((nint)0x00000001)
                );
                Assert.Equal(
                    2147483647.0m,
                    NumberBaseHelper<decimal>.CreateSaturating<nint>((nint)0x7FFFFFFF)
                );
                Assert.Equal(
                    -2147483648.0m,
                    NumberBaseHelper<decimal>.CreateSaturating<nint>(unchecked((nint)0x80000000))
                );
                Assert.Equal(
                    -1.0m,
                    NumberBaseHelper<decimal>.CreateSaturating<nint>(unchecked((nint)0xFFFFFFFF))
                );
            }
        }
        ...
        public static void CreateSaturatingFromNFloatTest()
        {
            ...
            Assert.Equal(
                0.0m,
                NumberBaseHelper<decimal>.CreateSaturating<NFloat>(NFloat.NegativeZero)
            );
            ...
            Assert.Equal(
                decimal.MaxValue,
                NumberBaseHelper<decimal>.CreateSaturating<NFloat>(NFloat.MaxValue)
            );
            Assert.Equal(
                decimal.MinValue,
                NumberBaseHelper<decimal>.CreateSaturating<NFloat>(NFloat.MinValue)
            );

            Assert.Equal(
                decimal.MaxValue,
                NumberBaseHelper<decimal>.CreateSaturating<NFloat>(NFloat.PositiveInfinity)
            );
            Assert.Equal(
                decimal.MinValue,
                NumberBaseHelper<decimal>.CreateSaturating<NFloat>(NFloat.NegativeInfinity)
            );

            Assert.Equal(
                decimal.Zero,
                NumberBaseHelper<decimal>.CreateSaturating<NFloat>(NFloat.NaN)
            );
        }
        ...
        public static void CreateSaturatingFromSByteTest()
        {
            ...
            Assert.Equal(
                -128.0m,
                NumberBaseHelper<decimal>.CreateSaturating<sbyte>(unchecked((sbyte)0x80))
            );
            Assert.Equal(
                -1.0m,
                NumberBaseHelper<decimal>.CreateSaturating<sbyte>(unchecked((sbyte)0xFF))
            );
        }
        ...
        public static void CreateSaturatingFromSingleTest()
        {
            ...
            Assert.Equal(
                +79228160000000000000000000000.0m,
                NumberBaseHelper<decimal>.CreateSaturating<float>(+79228160000000000000000000000.0f)
            );
            Assert.Equal(
                -79228160000000000000000000000.0m,
                NumberBaseHelper<decimal>.CreateSaturating<float>(-79228160000000000000000000000.0f)
            ...
            Assert.Equal(
                decimal.MaxValue,
                NumberBaseHelper<decimal>.CreateSaturating<float>(+79228162514264337593543950335.0f)
            );
            Assert.Equal(
                decimal.MinValue,
                NumberBaseHelper<decimal>.CreateSaturating<float>(-79228162514264337593543950335.0f)
            ...
            Assert.Equal(
                decimal.MaxValue,
                NumberBaseHelper<decimal>.CreateSaturating<float>(float.MaxValue)
            );
            Assert.Equal(
                decimal.MinValue,
                NumberBaseHelper<decimal>.CreateSaturating<float>(float.MinValue)
            );

            Assert.Equal(
                decimal.MaxValue,
                NumberBaseHelper<decimal>.CreateSaturating<float>(float.PositiveInfinity)
            );
            Assert.Equal(
                decimal.MinValue,
                NumberBaseHelper<decimal>.CreateSaturating<float>(float.NegativeInfinity)
            );

            Assert.Equal(
                decimal.Zero,
                NumberBaseHelper<decimal>.CreateSaturating<float>(float.NaN)
            );
        }
        ...
        public static void CreateSaturatingFromUInt32Test()
        {
            ...
            Assert.Equal(
                2147483647.0m,
                NumberBaseHelper<decimal>.CreateSaturating<uint>(0x7FFFFFFF)
            );
            Assert.Equal(
                2147483648.0m,
                NumberBaseHelper<decimal>.CreateSaturating<uint>(0x80000000)
            );
            Assert.Equal(
                4294967295.0m,
                NumberBaseHelper<decimal>.CreateSaturating<uint>(0xFFFFFFFF)
            );
        }
        ...
        public static void CreateSaturatingFromUInt64Test()
        {
            Assert.Equal(
                0.0m,
                NumberBaseHelper<decimal>.CreateSaturating<ulong>(0x0000000000000000)
            );
            Assert.Equal(
                1.0m,
                NumberBaseHelper<decimal>.CreateSaturating<ulong>(0x0000000000000001)
            );
            Assert.Equal(
                9223372036854775807.0m,
                NumberBaseHelper<decimal>.CreateSaturating<ulong>(0x7FFFFFFFFFFFFFFF)
            );
            Assert.Equal(
                9223372036854775808.0m,
                NumberBaseHelper<decimal>.CreateSaturating<ulong>(0x8000000000000000)
            );
            Assert.Equal(
                18446744073709551615.0m,
                NumberBaseHelper<decimal>.CreateSaturating<ulong>(0xFFFFFFFFFFFFFFFF)
            );
        }
        ...
        public static void CreateSaturatingFromUInt128Test()
        {
            Assert.Equal(
                0.0m,
                NumberBaseHelper<decimal>.CreateSaturating<UInt128>(
                    new UInt128(0x0000_0000_0000_0000, 0x0000_0000_0000_0000)
                )
            );
        ...
        public static void CreateSaturatingFromUIntPtrTest()
        {
            if (Environment.Is64BitProcess)
            {
                Assert.Equal(
                    0.0m,
                    NumberBaseHelper<decimal>.CreateSaturating<nuint>(
                        unchecked((nuint)0x0000000000000000)
                    )
                );
                Assert.Equal(
            ...
            else
            {
                Assert.Equal(
                    0.0m,
                    NumberBaseHelper<decimal>.CreateSaturating<nuint>((nuint)0x00000000)
                );
                Assert.Equal(
                    1.0m,
                    NumberBaseHelper<decimal>.CreateSaturating<nuint>((nuint)0x00000001)
                );
                Assert.Equal(
                    2147483647.0m,
                    NumberBaseHelper<decimal>.CreateSaturating<nuint>((nuint)0x7FFFFFFF)
                );
                Assert.Equal(
                    2147483648.0m,
                    NumberBaseHelper<decimal>.CreateSaturating<nuint>((nuint)0x80000000)
                );
                Assert.Equal(
                    4294967295.0m,
                    NumberBaseHelper<decimal>.CreateSaturating<nuint>((nuint)0xFFFFFFFF)
                );
            }
        }
        ...
        public static void CreateTruncatingFromDecimalTest()
        {
            ...
            Assert.Equal(
                decimal.MaxValue,
                NumberBaseHelper<decimal>.CreateTruncating<decimal>(decimal.MaxValue)
            );
        }
        ...
        public static void CreateTruncatingFromDoubleTest()
        {
            ...
            Assert.Equal(
                +79228162514264300000000000000.0m,
                NumberBaseHelper<decimal>.CreateTruncating<double>(+79228162514264333195497439231.0)
            );
            Assert.Equal(
                -79228162514264300000000000000.0m,
                NumberBaseHelper<decimal>.CreateTruncating<double>(-79228162514264333195497439231.0)
            ...
            Assert.Equal(
                decimal.MaxValue,
                NumberBaseHelper<decimal>.CreateTruncating<double>(+79228162514264337593543950335.0)
            );
            Assert.Equal(
                decimal.MinValue,
                NumberBaseHelper<decimal>.CreateTruncating<double>(-79228162514264337593543950335.0)
            ...
            Assert.Equal(
                decimal.MaxValue,
                NumberBaseHelper<decimal>.CreateTruncating<double>(double.MaxValue)
            );
            Assert.Equal(
                decimal.MinValue,
                NumberBaseHelper<decimal>.CreateTruncating<double>(double.MinValue)
            );

            Assert.Equal(
                decimal.MaxValue,
                NumberBaseHelper<decimal>.CreateTruncating<double>(double.PositiveInfinity)
            );
            Assert.Equal(
                decimal.MinValue,
                NumberBaseHelper<decimal>.CreateTruncating<double>(double.NegativeInfinity)
            );

            Assert.Equal(
                decimal.Zero,
                NumberBaseHelper<decimal>.CreateTruncating<double>(double.NaN)
            );
        }
        ...
        public static void CreateTruncatingFromHalfTest()
        {
            ...
            Assert.Equal(
                +0.00000005960464m,
                NumberBaseHelper<decimal>.CreateTruncating<Half>(+Half.Epsilon)
            );
            Assert.Equal(
                -0.00000005960464m,
                NumberBaseHelper<decimal>.CreateTruncating<Half>(-Half.Epsilon)
            ...
            Assert.Equal(
                +65504.0m,
                NumberBaseHelper<decimal>.CreateTruncating<Half>(Half.MaxValue)
            );
            Assert.Equal(
                -65504.0m,
                NumberBaseHelper<decimal>.CreateTruncating<Half>(Half.MinValue)
            );

            Assert.Equal(
                decimal.MaxValue,
                NumberBaseHelper<decimal>.CreateTruncating<Half>(Half.PositiveInfinity)
            );
            Assert.Equal(
                decimal.MinValue,
                NumberBaseHelper<decimal>.CreateTruncating<Half>(Half.NegativeInfinity)
            );
        ...
        public static void CreateTruncatingFromInt16Test()
        {
            ...
            Assert.Equal(
                -32768.0m,
                NumberBaseHelper<decimal>.CreateTruncating<short>(unchecked((short)0x8000))
            );
            Assert.Equal(
                -1.0m,
                NumberBaseHelper<decimal>.CreateTruncating<short>(unchecked((short)0xFFFF))
            );
        }
        ...
        public static void CreateTruncatingFromInt32Test()
        {
            ...
            Assert.Equal(
                2147483647.0m,
                NumberBaseHelper<decimal>.CreateTruncating<int>(0x7FFFFFFF)
            );
            Assert.Equal(
                -2147483648.0m,
                NumberBaseHelper<decimal>.CreateTruncating<int>(unchecked((int)0x80000000))
            );
            Assert.Equal(
                -1.0m,
                NumberBaseHelper<decimal>.CreateTruncating<int>(unchecked((int)0xFFFFFFFF))
            );
        }
        ...
        public static void CreateTruncatingFromInt64Test()
        {
            Assert.Equal(
                0.0m,
                NumberBaseHelper<decimal>.CreateTruncating<long>(0x0000000000000000)
            );
            Assert.Equal(
                1.0m,
                NumberBaseHelper<decimal>.CreateTruncating<long>(0x0000000000000001)
            );
            Assert.Equal(
                9223372036854775807.0m,
                NumberBaseHelper<decimal>.CreateTruncating<long>(0x7FFFFFFFFFFFFFFF)
            );
            Assert.Equal(
                -9223372036854775808.0m,
                NumberBaseHelper<decimal>.CreateTruncating<long>(
                    unchecked(unchecked((long)0x8000000000000000))
                )
            );
            Assert.Equal(
        ...
        public static void CreateTruncatingFromInt128Test()
        {
            Assert.Equal(
                0.0m,
                NumberBaseHelper<decimal>.CreateTruncating<Int128>(
                    new Int128(0x0000_0000_0000_0000, 0x0000_0000_0000_0000)
                )
            );
        ...
        public static void CreateTruncatingFromIntPtrTest()
        {
            if (Environment.Is64BitProcess)
            {
                Assert.Equal(
                    0.0m,
                    NumberBaseHelper<decimal>.CreateTruncating<nint>(
                        unchecked((nint)0x0000000000000000)
                    )
                );
                Assert.Equal(
            ...
            else
            {
                Assert.Equal(
                    0.0m,
                    NumberBaseHelper<decimal>.CreateTruncating<nint>((nint)0x00000000)
                );
                Assert.Equal(
                    1.0m,
                    NumberBaseHelper<decimal>.CreateTruncating<nint>((nint)0x00000001)
                );
                Assert.Equal(
                    2147483647.0m,
                    NumberBaseHelper<decimal>.CreateTruncating<nint>((nint)0x7FFFFFFF)
                );
                Assert.Equal(
                    -2147483648.0m,
                    NumberBaseHelper<decimal>.CreateTruncating<nint>(unchecked((nint)0x80000000))
                );
                Assert.Equal(
                    -1.0m,
                    NumberBaseHelper<decimal>.CreateTruncating<nint>(unchecked((nint)0xFFFFFFFF))
                );
            }
        }
        ...
        public static void CreateTruncatingFromNFloatTest()
        {
            ...
            Assert.Equal(
                0.0m,
                NumberBaseHelper<decimal>.CreateTruncating<NFloat>(NFloat.NegativeZero)
            );
            ...
            Assert.Equal(
                decimal.MaxValue,
                NumberBaseHelper<decimal>.CreateTruncating<NFloat>(NFloat.MaxValue)
            );
            Assert.Equal(
                decimal.MinValue,
                NumberBaseHelper<decimal>.CreateTruncating<NFloat>(NFloat.MinValue)
            );

            Assert.Equal(
                decimal.MaxValue,
                NumberBaseHelper<decimal>.CreateTruncating<NFloat>(NFloat.PositiveInfinity)
            );
            Assert.Equal(
                decimal.MinValue,
                NumberBaseHelper<decimal>.CreateTruncating<NFloat>(NFloat.NegativeInfinity)
            );

            Assert.Equal(
                decimal.Zero,
                NumberBaseHelper<decimal>.CreateTruncating<NFloat>(NFloat.NaN)
            );
        }
        ...
        public static void CreateTruncatingFromSByteTest()
        {
            ...
            Assert.Equal(
                -128.0m,
                NumberBaseHelper<decimal>.CreateTruncating<sbyte>(unchecked((sbyte)0x80))
            );
            Assert.Equal(
                -1.0m,
                NumberBaseHelper<decimal>.CreateTruncating<sbyte>(unchecked((sbyte)0xFF))
            );
        }
        ...
        public static void CreateTruncatingFromSingleTest()
        {
            ...
            Assert.Equal(
                +79228160000000000000000000000.0m,
                NumberBaseHelper<decimal>.CreateTruncating<float>(+79228160000000000000000000000.0f)
            );
            Assert.Equal(
                -79228160000000000000000000000.0m,
                NumberBaseHelper<decimal>.CreateTruncating<float>(-79228160000000000000000000000.0f)
            ...
            Assert.Equal(
                decimal.MaxValue,
                NumberBaseHelper<decimal>.CreateTruncating<float>(+79228162514264337593543950335.0f)
            );
            Assert.Equal(
                decimal.MinValue,
                NumberBaseHelper<decimal>.CreateTruncating<float>(-79228162514264337593543950335.0f)
            ...
            Assert.Equal(
                decimal.MaxValue,
                NumberBaseHelper<decimal>.CreateTruncating<float>(float.MaxValue)
            );
            Assert.Equal(
                decimal.MinValue,
                NumberBaseHelper<decimal>.CreateTruncating<float>(float.MinValue)
            );

            Assert.Equal(
                decimal.MaxValue,
                NumberBaseHelper<decimal>.CreateTruncating<float>(float.PositiveInfinity)
            );
            Assert.Equal(
                decimal.MinValue,
                NumberBaseHelper<decimal>.CreateTruncating<float>(float.NegativeInfinity)
            );

            Assert.Equal(
                decimal.Zero,
                NumberBaseHelper<decimal>.CreateTruncating<float>(float.NaN)
            );
        }
        ...
        public static void CreateTruncatingFromUInt32Test()
        {
            ...
            Assert.Equal(
                2147483647.0m,
                NumberBaseHelper<decimal>.CreateTruncating<uint>(0x7FFFFFFF)
            );
            Assert.Equal(
                2147483648.0m,
                NumberBaseHelper<decimal>.CreateTruncating<uint>(0x80000000)
            );
            Assert.Equal(
                4294967295.0m,
                NumberBaseHelper<decimal>.CreateTruncating<uint>(0xFFFFFFFF)
            );
        }
        ...
        public static void CreateTruncatingFromUInt64Test()
        {
            Assert.Equal(
                0.0m,
                NumberBaseHelper<decimal>.CreateTruncating<ulong>(0x0000000000000000)
            );
            Assert.Equal(
                1.0m,
                NumberBaseHelper<decimal>.CreateTruncating<ulong>(0x0000000000000001)
            );
            Assert.Equal(
                9223372036854775807.0m,
                NumberBaseHelper<decimal>.CreateTruncating<ulong>(0x7FFFFFFFFFFFFFFF)
            );
            Assert.Equal(
                9223372036854775808.0m,
                NumberBaseHelper<decimal>.CreateTruncating<ulong>(0x8000000000000000)
            );
            Assert.Equal(
                18446744073709551615.0m,
                NumberBaseHelper<decimal>.CreateTruncating<ulong>(0xFFFFFFFFFFFFFFFF)
            );
        }
        ...
        public static void CreateTruncatingFromUInt128Test()
        {
            Assert.Equal(
                0.0m,
                NumberBaseHelper<decimal>.CreateTruncating<UInt128>(
                    new UInt128(0x0000_0000_0000_0000, 0x0000_0000_0000_0000)
                )
            );
        ...
        public static void CreateTruncatingFromUIntPtrTest()
        {
            if (Environment.Is64BitProcess)
            {
                Assert.Equal(
                    0.0m,
                    NumberBaseHelper<decimal>.CreateTruncating<nuint>(
                        unchecked((nuint)0x0000000000000000)
                    )
                );
                Assert.Equal(
            ...
            else
            {
                Assert.Equal(
                    0.0m,
                    NumberBaseHelper<decimal>.CreateTruncating<nuint>((nuint)0x00000000)
                );
                Assert.Equal(
                    1.0m,
                    NumberBaseHelper<decimal>.CreateTruncating<nuint>((nuint)0x00000001)
                );
                Assert.Equal(
                    2147483647.0m,
                    NumberBaseHelper<decimal>.CreateTruncating<nuint>((nuint)0x7FFFFFFF)
                );
                Assert.Equal(
                    2147483648.0m,
                    NumberBaseHelper<decimal>.CreateTruncating<nuint>((nuint)0x80000000)
                );
                Assert.Equal(
                    4294967295.0m,
                    NumberBaseHelper<decimal>.CreateTruncating<nuint>((nuint)0xFFFFFFFF)
                );
            }
        }
        ...
        public static void MaxMagnitudeTest()
        {
            Assert.Equal(
                decimal.MinValue,
                NumberBaseHelper<decimal>.MaxMagnitude(decimal.MinValue, 1.0m)
            );
            ...
            Assert.Equal(
                decimal.MaxValue,
                NumberBaseHelper<decimal>.MaxMagnitude(decimal.MaxValue, 1.0m)
            );
        }
        ...
        public static void MaxMagnitudeNumberTest()
        {
            Assert.Equal(
                decimal.MinValue,
                NumberBaseHelper<decimal>.MaxMagnitudeNumber(decimal.MinValue, 1.0m)
            );
            ...
            Assert.Equal(
                decimal.MaxValue,
                NumberBaseHelper<decimal>.MaxMagnitudeNumber(decimal.MaxValue, 1.0m)
            );
        }
        ...
        public static void MinMagnitudeNumberTest()
        {
            Assert.Equal(
                1.0m,
                NumberBaseHelper<decimal>.MinMagnitudeNumber(decimal.MinValue, 1.0m)
            );
            ...
            Assert.Equal(
                1.0m,
                NumberBaseHelper<decimal>.MinMagnitudeNumber(decimal.MaxValue, 1.0m)
            );
        }
        ...
        public static void op_SubtractionTest()
        {
            Assert.Equal(
                -2.0m,
                SubtractionOperatorsHelper<decimal, decimal, decimal>.op_Subtraction(-1.0m, 1.0m)
            );
            Assert.Equal(
                -1.0m,
                SubtractionOperatorsHelper<decimal, decimal, decimal>.op_Subtraction(-0.0m, 1.0m)
            );
            Assert.Equal(
                -1.0m,
                SubtractionOperatorsHelper<decimal, decimal, decimal>.op_Subtraction(0.0m, 1.0m)
            ...
            Assert.Equal(
                79228162514264337593543950334.0m,
                SubtractionOperatorsHelper<decimal, decimal, decimal>.op_Subtraction(
                    decimal.MaxValue,
                    1.0m
                )
            );
        ...
        public static void op_CheckedSubtractionTest()
        {
            Assert.Equal(
                -2.0m,
                SubtractionOperatorsHelper<decimal, decimal, decimal>.op_CheckedSubtraction(
                    -1.0m,
                    1.0m
                )
            );
        ...
        public static void op_UnaryNegationTest()
        {
            Assert.Equal(
                decimal.MaxValue,
                UnaryNegationOperatorsHelper<decimal, decimal>.op_UnaryNegation(decimal.MinValue)
            );
            Assert.Equal(
                1.0m,
                UnaryNegationOperatorsHelper<decimal, decimal>.op_UnaryNegation(-1.0m)
            );
            Assert.Equal(
                0.0m,
                UnaryNegationOperatorsHelper<decimal, decimal>.op_UnaryNegation(-0.0m)
            );
            Assert.Equal(
                -0.0m,
                UnaryNegationOperatorsHelper<decimal, decimal>.op_UnaryNegation(0.0m)
            ...
            Assert.Equal(
                decimal.MinValue,
                UnaryNegationOperatorsHelper<decimal, decimal>.op_UnaryNegation(decimal.MaxValue)
            );
        }
        ...
        public static void op_CheckedUnaryNegationTest()
        {
            Assert.Equal(
                decimal.MaxValue,
                UnaryNegationOperatorsHelper<decimal, decimal>.op_CheckedUnaryNegation(
                    decimal.MinValue
                )
            );
            Assert.Equal(
                1.0m,
                UnaryNegationOperatorsHelper<decimal, decimal>.op_CheckedUnaryNegation(-1.0m)
            );
            Assert.Equal(
                0.0m,
                UnaryNegationOperatorsHelper<decimal, decimal>.op_CheckedUnaryNegation(-0.0m)
            );
            Assert.Equal(
                -0.0m,
                UnaryNegationOperatorsHelper<decimal, decimal>.op_CheckedUnaryNegation(0.0m)
        ...
        public static void op_UnaryPlusTest()
        {
            Assert.Equal(
                decimal.MinValue,
                UnaryPlusOperatorsHelper<decimal, decimal>.op_UnaryPlus(decimal.MinValue)
            );
            ...
            Assert.Equal(
                decimal.MaxValue,
                UnaryPlusOperatorsHelper<decimal, decimal>.op_UnaryPlus(decimal.MaxValue)
            );
        }
        ...
        )
        {
            ...
            if (isDefaultProvider)
            {
                ...
                Assert.True(
                    NumberBaseHelper<decimal>.TryParse(
                        value,
                        style,
        ...
        [Theory]
        [MemberData(
            nameof(DecimalTests.Parse_ValidWithOffsetCount_TestData),
            MemberType = typeof(DecimalTests)
        )]
        ...
        )
        {
            ...
            )
            {
                ...
                {
                    Assert.True(
                        SpanParsableHelper<decimal>.TryParse(
                    ...
                    Assert.Equal(
                        expected,
                        SpanParsableHelper<decimal>.Parse(value.AsSpan(offset, count), null)
                    );
                }

                Assert.Equal(
                    expected,
                    SpanParsableHelper<decimal>.Parse(
                        value.AsSpan(offset, count),
                        provider: provider
                    )
                );
            ...
            Assert.Equal(
                expected,
                NumberBaseHelper<decimal>.Parse(value.AsSpan(offset, count), style, provider)
            );
