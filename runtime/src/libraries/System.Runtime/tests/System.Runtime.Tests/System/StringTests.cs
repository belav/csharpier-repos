...
namespace System.Tests
{
    public partial class StringTests
    {
        ...
        public static void Ctor_CharSpan_EmptyString(int length, int offset)
        {
            Assert.Same(
                string.Empty,
                new string(new ReadOnlySpan<char>(new char[length], offset, 0))
            );
        }
        ...
        [InlineData(
            new char[] { 'a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', '\0', 'i', 'j', 'k' },
            0,
            12,
            "abcdefgh\0ijk"
        )]
        ...
        public static void Ctor_CharSpan(
            char[] valueArray,
            int startIndex,
            int length,
            string expected
        ...
        public static void Create_InterpolatedString_ConstructsStringAndClearsBuilder()
        {
            ...
            Assert.Equal(
                "hello",
                string.Create(CultureInfo.InvariantCulture, initialBuffer, ref handler)
            );
            Assert.Equal(
                "",
                string.Create(CultureInfo.InvariantCulture, initialBuffer, ref handler)
        ...
        public static void Contains_Char_StringComparison(
            string s,
            char value,
        ...
        public static void Contains_String_StringComparison(
            string s,
            string value,
            StringComparison comparisonType,
            bool expected
        ...
        public static void Contains_StringComparison_TurkishI()
        {
            ...
            {
                Assert.True(
                    Source.Contains("\u0069\u0069", StringComparison.CurrentCultureIgnoreCase)
                );
                Assert.True(
                    Source
                        .AsSpan()
                        .Contains("\u0069\u0069", StringComparison.CurrentCultureIgnoreCase)
                );
            }
        ...
        public static void ReplaceLineEndings(string input, string[] expectedSegments)
        {
            ...
            Assert.Equal(
                string.Join("<SEPARATOR>", expectedSegments),
                input.ReplaceLineEndings("<SEPARATOR>")
            );
        ...
        public static void Join_Char_StringArray(
            char separator,
            string[] values,
            int startIndex,
            int count,
        ...
        public void Replace_StringComparison_ReturnsExpected(
            string original,
            string oldValue,
            string newValue,
            StringComparison comparisonType,
        ...
        public void Replace_StringComparison_TurkishI()
        {
            ...
            using (new ThreadCultureChange("tr-TR"))
            {
                ...
                Assert.Equal(
                    "a\u0130",
                    Source.Replace("\u0069", "a", StringComparison.CurrentCulture)
                );
                Assert.Equal(
                    "aa",
                    Source.Replace("\u0069", "a", StringComparison.CurrentCultureIgnoreCase)
                );
                Assert.Equal(
                    "\u0069a",
                    Source.Replace("\u0130", "a", StringComparison.CurrentCulture)
                );
                Assert.Equal(
                    "aa",
                    Source.Replace("\u0130", "a", StringComparison.CurrentCultureIgnoreCase)
                );
            }
        ...
        )
        {
            ...
            if (culture == null)
            {
                Assert.Equal(
                    expected,
                    original.Replace(oldValue, newValue, ignoreCase, CultureInfo.CurrentCulture)
                );
            }
        }
        ...
        public void Replace_StringComparison_WeightlessOldValue_WithOrdinalComparison_Succeeds()
        {
            ...
            Assert.Equal(
                "abcdef",
                ("abc" + ZeroWidthJoiner).Replace(ZeroWidthJoiner, "def", StringComparison.Ordinal)
            );
            Assert.Equal(
                "abcdef",
        ...
        {
            Assert.NotEqual(
                string.GetHashCode("\0AAAAAAAAA".AsSpan()),
                string.GetHashCode("\0BBBBBBBBBBBB".AsSpan())
            );
        }
        ...
        public static void GetHashCode_CompareInfo()
        {
            ...
            Assert.Equal(
                "abc".GetHashCode(),
                CultureInfo.InvariantCulture.CompareInfo.GetHashCode("abc", CompareOptions.Ordinal)
            );
            Assert.NotEqual(
                "abc".GetHashCode(),
                CultureInfo.InvariantCulture.CompareInfo.GetHashCode("ABC", CompareOptions.Ordinal)
            ...
            Assert.Equal(
                ...
                CultureInfo.CurrentCulture.CompareInfo.GetHashCode("aeiXXabc", CompareOptions.None)
            );
            Assert.Equal(
        ...
        public static IEnumerable<object[]> GetHashCode_StringComparison_Data =>
            StringComparisons.Select(value => new object[] { value });
        ...
        {
            int hashCodeFromStringComparer = StringComparer
        ...
        public static IEnumerable<object[]> GetHashCode_NoSuchStringComparison_ThrowsArgumentException_Data =>
            new[]
            {
        ...
        )
        {
            ...
            {
                Assert.Equal(
                    (IntPtr)Unsafe.AsPointer(ref Unsafe.AsRef(in rChar)),
            ...
            Assert.True(
                Unsafe.AreSame(
                    ref Unsafe.AsRef(in rChar),
                    ref MemoryMarshal.GetReference((ReadOnlySpan<char>)input)
                )
            );
            ...
            if (PlatformDetection.IsReflectionEmitSupported)
            {
                ...
                ilGen.Emit(
                    OpCodes.Call,
                    typeof(RuntimeHelpers).GetProperty("OffsetToStringData").GetMethod
                ); // get pointer to start of string data
        ...
        public static void IndexOf_SingleLetter_StringComparison(
            string s,
            char target,
        ...
        public static void IndexOf_TurkishI_TurkishCulture_Char()
        {
            using (new ThreadCultureChange("tr-TR"))
            {
                ...
                Assert.Equal(
                    19,
                    span.IndexOf(new char[] { value }, StringComparison.CurrentCulture)
                );
                Assert.Equal(
                    4,
                    span.IndexOf(new char[] { value }, StringComparison.CurrentCultureIgnoreCase)
                );
                Assert.Equal(19, span.IndexOf(new char[] { value }, StringComparison.Ordinal));
                Assert.Equal(
                    19,
                    span.IndexOf(new char[] { value }, StringComparison.OrdinalIgnoreCase)
                );
        ...
        public static void IndexOf_EquivalentDiacritics_InvariantCulture_Char()
        {
            ...
            using (new ThreadCultureChange(CultureInfo.InvariantCulture))
            {
                ...
                Assert.Equal(10, s.IndexOf(value, StringComparison.CurrentCulture));
                Assert.Equal(
                    PlatformDetection.IsInvariantGlobalization ? 10 : 8,
                    s.IndexOf(value, StringComparison.CurrentCultureIgnoreCase)
                );
            }
        }
        ...
        public static void IndexOf_Ordinal_Misc(
            string source,
            string target,
            StringComparison stringComparison,
            int expected
        ...
        public static void LastIndexOf_Ordinal_Misc(
            string source,
            string target,
            int startIndex,
            StringComparison stringComparison,
        ...
        public static void Compare_Ordinal_Misc(
            string source,
            string target,
            StringComparison stringComparison,
            bool expected
        )
        {
            ...
            Assert.Equal(
                expected,
                string.GetHashCode(source, stringComparison)
                    == string.GetHashCode(target, stringComparison)
            );
        }
        ...
        public static void StartsWith_Ordinal_Misc(
            string source,
            string target,
            StringComparison stringComparison,
            bool expected
        ...
        public static void EndsWith_Ordinal_Misc(
            string source,
            string target,
            StringComparison stringComparison,
            bool expected
        ...
        public static void TrimWhiteSpaceMultipleTimes_Memory()
        {
            for (int length = 3; length < 32; length++)
            {
                ...
                // Memory
                {
                    ...
                    Assert.True(
                        trimStartResult.Span.SequenceEqual(trimStartResult.TrimStart().Span)
                    );
            ...
            for (int i = 0; i < 128; i++)
            {
                for (int j = 0; j < 128; j++)
                {
                    for (int len = 0; len < 8; len++)
                    {
                        ...
                        bool expectedEqualOrdinalIgnoreCase =
                            (i == j)
                            || (
                                (i | 0x20) >= 'a' && (i | 0x20) <= 'z' && ((i | 0x20) == (j | 0x20))
                            );
                        ...
                        try
                        {
                            ...
                            Assert.Equal(
                                expectedEqualOrdinalIgnoreCase,
                                actualEqualOrdinalIgnoreCase
                            );
                            Assert.Equal(
                                expectedEqualOrdinalIgnoreCase,
                                actualCompareToOrdinalIgnoreCase == 0
                            );
                        }
                        catch (Exception ex)
                        {
                            throw new Exception(
                                $"Chars U+{i:X4} ('{(char)i}') and U+{j:X4} ('{(char)j}') did not compare as expected. Iteration: len = {len}.",
                                ex
                            );
                        }
                    }
