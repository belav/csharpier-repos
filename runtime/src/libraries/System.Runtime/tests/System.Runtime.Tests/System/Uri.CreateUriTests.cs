...
namespace System.Tests
{
    public class UriCreateUriTests
    {
        ...
        public static IEnumerable<object[]> Create_Uri_TestData()
        {
            ...
            {
                "http://host/",
                "path1/page?query=value#fragment",
                UriKind.RelativeOrAbsolute,
                "http://host/path1/page?query=value#fragment",
            };
            yield return new object[]
            {
                "http://host/",
            ...
            yield return new object[]
            {
                @"file://\\servername/path1",
                "/path",
                UriKind.RelativeOrAbsolute,
                "file://servername/path1/path",
            };
            yield return new object[]
            {
                @"\\servername\path1",
            ...
            yield return new object[]
            {
                "telnet://username:password@host:10",
                "path",
                UriKind.RelativeOrAbsolute,
                "telnet://username:password@host:10/path",
            };
        ...
        public static IEnumerable<object[]> Create_Uri_Invalid_TestData()
        {
            ...
            yield return new object[]
            {
                ...
                false,
            }; // Relative uri is invalid
        }

        [Theory]
        [MemberData(nameof(Create_Uri_Invalid_TestData))]
        public void Create_Uri_Invalid(
            Uri baseUri,
            string relativeUri,
            Type exceptionType,
            bool createUri
