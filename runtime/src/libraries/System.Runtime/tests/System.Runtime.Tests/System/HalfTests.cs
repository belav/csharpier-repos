...
namespace System.Tests
{
    public partial class HalfTests
    {
        ...
        )
        {
            ...
            Assert.True(
                expected.Equals(Half.Parse(valueUtf8, style, provider))
                    || (
                        Half.IsNaN(expected)
                        && Half.IsNaN(Half.Parse(value.AsSpan(offset, count), style, provider))
                    )
                ...
                foreach (object[] testdata in ToString_TestData())
                {
                    ...
                    try
                    {
                        NumberFormatTestHelper.TryFormatNumberTest(
                            ...
                            localProvider,
                            localExpected,
                            formatCasingMatchesOutput: false
                        );
                    }
                    catch (Exception exc)
                    {
        ...
        public static void LerpTest(Half value1, Half value2, Half amount, Half expectedResult)
        {
            ...
            AssertExtensions.Equal(
                (expectedResult == Half.Zero) ? expectedResult : -expectedResult,
                Half.Lerp(-value1, -value2, amount),
                Half.Zero
            );
        }
        ...
        public static void DegreesToRadiansTest(
            Half value,
            Half expectedResult,
            Half allowedVariance
        )
        {
        ...
        public static void RadiansToDegreesTest(
            Half value,
            Half expectedResult,
            Half allowedVariance
        )
