...
namespace System.Tests
{
    public class DoubleTests
    {
        ...
        {
            Assert.Equal(
                0x80000000_00000000u,
                BitConverter.DoubleToUInt64Bits(double.NegativeZero)
            );
        }
        ...
        )
        {
            if (value != null)
            {
                ...
                Assert.Throws(
                    exceptionType,
                    () => double.Parse(Encoding.UTF8.GetBytes(value), style, provider)
                );
        ...
        )
        {
            ...
            AssertExtensions.Equal(
                ...
                double.Lerp(-value1, -value2, amount),
                0
            );
        }
