...
namespace System.Tests
{
    public class UriCreateStringTests
    {
        ...
        public void OriginalString_AbsoluteUri_ToString(
            string uriString,
            string absoluteUri,
            string toString
        )
        ...
        public static IEnumerable<object[]> Scheme_Authority_TestData()
        {
            ...
            yield return new object[]
            {
                "http://userinfo@host:90#fragment",
                "http",
                "userinfo",
                "host",
                UriHostNameType.Dns,
            ...
            yield return new object[]
            {
                "http://part1-part2_part3-part4_part5/",
                "http",
                "",
                "part1-part2_part3-part4_part5",
                UriHostNameType.Dns,
                80,
                true,
                false,
            ...
            yield return new object[]
            {
                "http.http2-http3+3http://host/",
                "http.http2-http3+3http",
                "",
                "host",
                UriHostNameType.Dns,
                -1,
            ...
            yield return new object[]
            {
                "http://[1111:1111:1111:1111:1111:1111:1111:1111]",
                "http",
                "",
            ...
            yield return new object[]
            {
                "http://[2001:0db8:0000:0000:0000:ff00:0042:8329]:90/",
                "http",
                "",
                "[2001:db8::ff00:42:8329]",
                UriHostNameType.IPv6,
            ...
            yield return new object[]
            {
                "http://[fe80::0000:5efe:192.168.0.1]/",
                "http",
                "",
            ...
            yield return new object[]
            {
                @"file://\\[2001:0db8:0000:0000:0000:ff00:0042:8329]",
                "file",
                "",
                "[2001:db8::ff00:42:8329]",
                UriHostNameType.IPv6,
            ...
            yield return new object[]
            {
                "ftp://[2001:0db8:0000:0000:0000:ff00:0042:8329]",
                "ftp",
                "",
                "[2001:db8::ff00:42:8329]",
                UriHostNameType.IPv6,
            ...
            yield return new object[]
            {
                "telnet://[2001:0db8:0000:0000:0000:ff00:0042:8329]",
                "telnet",
                "",
                "[2001:db8::ff00:42:8329]",
                UriHostNameType.IPv6,
            ...
            yield return new object[]
            {
                "unknown://[2001:0db8:0000:0000:0000:ff00:0042:8329]",
                "unknown",
                "",
                "[2001:db8::ff00:42:8329]",
                UriHostNameType.IPv6,
            ...
            yield return new object[]
            {
                "http://userinfo!~+-_*()[]:;&$=123PLACEHOLDER@host/",
                "http",
                "userinfo!~+-_*()[]:;&$=123PLACEHOLDER",
                "host",
                UriHostNameType.Dns,
                80,
                true,
            ...
            yield return new object[]
            {
                "http://userinfo%%%2F%3F%23%5B%5D%40%3B%26%2B%2C%5C%2g%2G@host",
                "http",
                "userinfo%25%25%2F%3F%23%5B%5D%40%3B%26%2B%2C%5C%252g%252G",
                "host",
                UriHostNameType.Dns,
                80,
                true,
        ...
        public void Scheme_Authority_Basic(
            string uriString,
            string scheme,
            string userInfo,
            string host,
        ...
        public static IEnumerable<object[]> Scheme_Authority_IdnHost_TestData()
        {
            ...
            yield return new object[]
            {
                "http://[1111:2222:3333::431%16]:50/",
                "http",
                "",
                "[1111:2222:3333::431]",
                "1111:2222:3333::431%16",
                "1111:2222:3333::431%16",
                UriHostNameType.IPv6,
                50,
                false,
        ...
        public void Scheme_Authority_IdnHost(
            string uriString,
            string scheme,
            string userInfo,
            string host,
