...
namespace System.Globalization.Tests
{
    public class CultureInfoConstructor
    {
        ...
        [InlineData(
            "de-DE-u-xx-u-co-phonebk",
            "de-DE-u-xx-u-co-phonebk",
            "de-DE-u-xx-u-co-phonebk"
        )]
        [InlineData(
            "de-DE-t-xx-u-co-phonebk",
            "de-DE-t-xx-u-co-phonebk",
            "de-DE-t-xx-u-co-phonebk_phoneboo"
        )]
        ...
        [ConditionalTheory(
            typeof(PlatformDetection),
            nameof(PlatformDetection.IsIcuGlobalizationAndNotHybrid)
        )]
        public void TestCreationWithMangledSortName(
            string cultureName,
            string expectedCultureName,
            string expectedSortName
        )
        {
        ...
        public void TestCreationWithICUNormalizedNames(
            string cultureName,
            string expectedCultureName
        )
        {
        ...
        private static bool SupportRemoteExecutionWithIcu =>
            RemoteExecutor.IsSupported && PlatformDetection.IsIcuGlobalization;
