...
namespace System.Globalization.Tests
{
    public class NumberFormatInfoMiscTests
    {
        ...
        public static bool FullICUPlatform =>
            PlatformDetection.ICUVersion.Major >= 66 && PlatformDetection.IsNotBrowser;
        ...
        public void TestNativeDigits(string cultureName, string[] nativeDigits)
        {
            Assert.Equal(
                nativeDigits,
                CultureInfo.GetCultureInfo(cultureName).NumberFormat.NativeDigits
            );
        }
    }
}
