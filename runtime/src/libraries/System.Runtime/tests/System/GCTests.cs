...
namespace System.Tests
{
    public static class GCTests
    {
        ...
        [Theory]
        [ActiveIssue(
            "https://github.com/dotnet/runtime/issues/31657",
        ...
        public static void LatencyRoundtrips_LowLatency(GCLatencyMode value) =>
            LatencyRoundtrips(value);
    }
    ...
    public class GCExtendedTests
    {
        ...
        private static void AllocateArrayRefType()
        {
            ...
            Assert.Throws<ArgumentException>(
                () => GC.AllocateUninitializedArray<string>(100, pinned: true)
            );
        }
