...
namespace System.Tests
{
    public partial class HalfTests
    {
        ...
        public static IEnumerable<object[]> Equals_TestData()
        {
            ...
            {
                Half.MaxValue,
                BitConverter.UInt16BitsToHalf(0x0000),
                false
            };
        ...
        public static IEnumerable<object[]> ExplicitConversion_ToSingle_TestData()
        {
            (Half Original, float Expected)[] data = // Fraction is shifted left by 42, Exponent is -15 then +127 = +112
            {
                ...
                (
                    BitConverter.UInt16BitsToHalf(0b0_11111_1000000000),
                    BitConverter.Int32BitsToSingle(0x7FC00000)
                ), // Positive Quiet NaN
                (Half.NaN, float.NaN), // Negative Quiet NaN
                (
                    BitConverter.UInt16BitsToHalf(0b0_11111_1010101010),
                    BitConverter.Int32BitsToSingle(0x7FD54000)
                ), // Positive Signalling NaN - Should preserve payload
                (
                    BitConverter.UInt16BitsToHalf(0b1_11111_1010101010),
                    BitConverter.Int32BitsToSingle(unchecked((int)0xFFD54000))
                ), // Negative Signalling NaN - Should preserve payload
                ...
                (
                    BitConverter.UInt16BitsToHalf(0b0_00001_0000000000),
                    BitConverter.Int32BitsToSingle(0x38800000)
                ), // smallest normal
                (
                    BitConverter.UInt16BitsToHalf(0b0_00000_1111111111),
                    BitConverter.Int32BitsToSingle(0x387FC000)
                ), // largest subnormal
                (
                    BitConverter.UInt16BitsToHalf(0b0_00000_1000000000),
                    BitConverter.Int32BitsToSingle(0x38000000)
                ), // middle subnormal
                (
                    BitConverter.UInt16BitsToHalf(0b0_00000_0111111111),
                    BitConverter.Int32BitsToSingle(0x37FF8000)
                ), // just below middle subnormal
                (
                    BitConverter.UInt16BitsToHalf(0b0_00000_0000000001),
                    BitConverter.Int32BitsToSingle(0x33800000)
                ), // smallest subnormal
                (
                    BitConverter.UInt16BitsToHalf(0b1_00000_0000000001),
                    BitConverter.Int32BitsToSingle(unchecked((int)0xB3800000))
                ), // highest negative subnormal
                (
                    BitConverter.UInt16BitsToHalf(0b1_00000_0111111111),
                    BitConverter.Int32BitsToSingle(unchecked((int)0xB7FF8000))
                ), // just above negative middle subnormal
                (
                    BitConverter.UInt16BitsToHalf(0b1_00000_1000000000),
                    BitConverter.Int32BitsToSingle(unchecked((int)0xB8000000))
                ), // negative middle subnormal
                (
                    BitConverter.UInt16BitsToHalf(0b1_00000_1111111111),
                    BitConverter.Int32BitsToSingle(unchecked((int)0xB87FC000))
                ), // lowest negative subnormal
                (
                    BitConverter.UInt16BitsToHalf(0b1_00001_0000000000),
                    BitConverter.Int32BitsToSingle(unchecked((int)0xB8800000))
                ) // highest negative normal
            };
        ...
        public static IEnumerable<object[]> ExplicitConversion_ToDouble_TestData()
        {
            (Half Original, double Expected)[] data = // Fraction is shifted left by 42, Exponent is -15 then +127 = +112
            {
                ...
                (
                    BitConverter.UInt16BitsToHalf(0b0_11111_1010101010),
                    BitConverter.Int64BitsToDouble(0x7FFAA800_00000000)
                ), // Positive Signalling NaN - Should preserve payload
                (
                    BitConverter.UInt16BitsToHalf(0b1_11111_1010101010),
                    BitConverter.Int64BitsToDouble(unchecked((long)0xFFFAA800_00000000))
                ), // Negative Signalling NaN - Should preserve payload
        ...
        public static IEnumerable<object[]> ExplicitConversion_FromSingle_TestData()
        {
            (float, Half)[] data =
            {
                ...
                (
                    BitConverter.Int32BitsToSingle(0x7FD55555),
                    BitConverter.UInt16BitsToHalf(0b0_11111_1010101010)
                ...
                (
                    ...
                    BitConverter.UInt16BitsToHalf(0b0_11001_0000000100)
                ), // 1027.5+ULP rounds up
                (
                    BitConverter.Int32BitsToSingle(0b0_10001001_00000000111000000000000),
                    BitConverter.UInt16BitsToHalf(0b0_11001_0000000100)
                ), // 1027.5 rounds to even
                (
                    BitConverter.Int32BitsToSingle(0b0_10001001_00000000110111111111111),
                    BitConverter.UInt16BitsToHalf(0b0_11001_0000000011)
                ), // 1027.5-ULP rounds down
                (
                    BitConverter.Int32BitsToSingle(
                        unchecked((int)0b1_10001001_00000000110111111111111)
                    ),
                    BitConverter.UInt16BitsToHalf(0b1_11001_0000000011)
                ), // -1027.5+ULP rounds towards zero
                (
                    BitConverter.Int32BitsToSingle(
                        unchecked((int)0b1_10001001_00000000111000000000000)
                    ),
                    BitConverter.UInt16BitsToHalf(0b1_11001_0000000100)
                ), // -1027.5 rounds to even
                (
                    BitConverter.Int32BitsToSingle(
                        unchecked((int)0b1_10001001_00000000111000000000001)
                    ),
                    BitConverter.UInt16BitsToHalf(0b1_11001_0000000100)
                ), // -1027.5-ULP rounds away from zero
                (
                    BitConverter.Int32BitsToSingle(0b0_01110000_00000001110000000000001),
                    BitConverter.UInt16BitsToHalf(0b0_00000_1000000100)
                ), // subnormal + ULP rounds up
                (
                    BitConverter.Int32BitsToSingle(0b0_01110000_00000001110000000000000),
                    BitConverter.UInt16BitsToHalf(0b0_00000_1000000100)
                ), // subnormal rounds to even
                (
                    BitConverter.Int32BitsToSingle(0b0_01110000_00000001101111111111111),
                    BitConverter.UInt16BitsToHalf(0b0_00000_1000000011)
                ), // subnormal - ULP rounds down
                (
                    BitConverter.Int32BitsToSingle(
                        unchecked((int)0b1_01110000_00000001101111111111111)
                    ),
                    BitConverter.UInt16BitsToHalf(0b1_00000_1000000011)
                ), // neg subnormal + ULP rounds higher
                (
                    BitConverter.Int32BitsToSingle(
                        unchecked((int)0b1_01110000_00000001110000000000000)
                    ),
                    BitConverter.UInt16BitsToHalf(0b1_00000_1000000100)
                ), // neg subnormal rounds to even
                (
                    BitConverter.Int32BitsToSingle(
                        unchecked((int)0b1_01110000_00000001101111111111111)
                    ),
                    BitConverter.UInt16BitsToHalf(0b1_00000_1000000011)
                ), // neg subnormal - ULP rounds lower,
                (
                    BitConverter.Int32BitsToSingle(0x33000000),
                    BitConverter.UInt16BitsToHalf(0b0_00000_000000000)
                ), // (half-precision minimum subnormal / 2) should underflow to zero
            };
        ...
        public static IEnumerable<object[]> ExplicitConversion_FromDouble_TestData()
        {
            (double, Half)[] data =
            {
                ...
                (
                    BitConverter.Int64BitsToDouble(0x3E60000000000000),
                    BitConverter.UInt16BitsToHalf(0b0_00000_000000000)
                ), // (half-precision minimum subnormal / 2) should underflow to zero
            };
        ...
        public static IEnumerable<object[]> Parse_Valid_TestData()
        {
            ...
            yield return new object[]
            {
                new string('0', 13) + "65504" + emptyFormat.NumberDecimalSeparator,
                defaultStyle,
                null,
                65504f
            };
            yield return new object[]
            {
                new string('0', 14) + "65504" + emptyFormat.NumberDecimalSeparator,
                defaultStyle,
                null,
                65504f
            };
        ...
        )
        {
            ...
            Assert.True(
                expected.Equals(Half.Parse(value, style, provider))
                    || (Half.IsNaN(expected) && Half.IsNaN(result))
            );
            ...
            if (isDefaultProvider)
            {
                ...
                Assert.True(
                    expected.Equals(Half.Parse(value, style, NumberFormatInfo.CurrentInfo))
                );
            }
        }
        ...
        )
        {
            ...
            Assert.True(
                expected.Equals(Half.Parse(value.AsSpan(offset, count), style, provider))
                    || (
                        Half.IsNaN(expected)
                        && Half.IsNaN(Half.Parse(value.AsSpan(offset, count), style, provider))
                    )
            );
        ...
        public static void Test_ToString_NotNetFramework()
        {
            using (new ThreadCultureChange(CultureInfo.InvariantCulture))
            {
                ...
                {
                    ToStringTest(
                        testdata[0] is float floatData ? (Half)floatData : (Half)testdata[0],
                        (string)testdata[1],
        ...
        public static void ToStringRoundtrip(object o_value)
        {
            ...
            Assert.Equal(
                ...
                BitConverter.HalfToUInt16Bits(result)
            );
        }
        ...
        public static IEnumerable<object[]> ExpM1_TestData()
        {
            yield return new object[]
            {
                Half.NegativeInfinity,
                (Half)(-Half.One),
                CrossPlatformMachineEpsilon * (Half)10
            };
            yield return new object[]
            {
                (Half)(-3.14159265f),
            ...
            yield return new object[]
            {
                (Half)(2.71828183f),
                (Half)(14.1542622f),
                CrossPlatformMachineEpsilon * (Half)100
            }; // value:  (e)
            yield return new object[]
            {
                (Half)(3.14159265f),
        ...
        public static IEnumerable<object[]> Exp10_TestData()
        {
            ...
            {
                (Half)(-3.14159265f),
                (Half)0.000721784159f,
                CrossPlatformMachineEpsilon / (Half)1000
            }; // value: -(pi)
            yield return new object[]
            {
                (Half)(-2.71828183f),
            ...
            yield return new object[]
            {
                (Half)(3.14159265f),
                (Half)1385.45573f,
                CrossPlatformMachineEpsilon * (Half)10000
            }; // value:  (pi)
            yield return new object[] { Half.PositiveInfinity, Half.PositiveInfinity, (Half)0.0f };
        }
        ...
        public static IEnumerable<object[]> Atan2Pi_TestData()
        {
            ...
            yield return new object[]
            {
                ...
                (Half)0.434294482f,
                CrossPlatformMachineEpsilon
            }; // y: sinpi(log10(e))       x:  cospi(log10(e))
            ...
            yield return new object[]
            {
                ...
                (Half)0.707106781f,
                CrossPlatformMachineEpsilon
            }; // y: sinpi(1 / sqrt(2))    x:  cospi(1 / sqrt(2))
            yield return new object[]
            {
                (Half)0.624265953f,
                -(Half)0.781211892f,
            ...
            yield return new object[]
            {
                ...
                -(Half)0.871620833f,
                CrossPlatformMachineEpsilon
            }; // y: sinpi(2 / sqrt(pi))   x:  cospi(2 / sqrt(pi))
            yield return new object[]
            {
                -(Half)0.963902533f,
                -(Half)0.266255342f,
        ...
        public static IEnumerable<object[]> BitDecrement_TestData()
        {
            ...
            yield return new object[]
            {
                BitConverter.UInt16BitsToHalf(0xC248),
                BitConverter.UInt16BitsToHalf(0xC249)
            }; // value: -(pi)
            yield return new object[]
            {
                BitConverter.UInt16BitsToHalf(0xC170),
                BitConverter.UInt16BitsToHalf(0xC171)
            }; // value: -(e)
            yield return new object[]
            {
                BitConverter.UInt16BitsToHalf(0xC09B),
                BitConverter.UInt16BitsToHalf(0xC09C)
            }; // value: -(ln(10))
            yield return new object[]
            {
                BitConverter.UInt16BitsToHalf(0xBE48),
                BitConverter.UInt16BitsToHalf(0xBE49)
            }; // value: -(pi / 2)
            yield return new object[]
            {
                BitConverter.UInt16BitsToHalf(0xBDC5),
                BitConverter.UInt16BitsToHalf(0xBDC6)
            }; // value: -(log2(e))
            yield return new object[]
            {
                BitConverter.UInt16BitsToHalf(0xBDA8),
                BitConverter.UInt16BitsToHalf(0xBDA9)
            }; // value: -(sqrt(2))
            yield return new object[]
            {
                BitConverter.UInt16BitsToHalf(0xBC83),
                BitConverter.UInt16BitsToHalf(0xBC84)
            }; // value: -(2 / sqrt(pi))
            yield return new object[]
            {
                BitConverter.UInt16BitsToHalf(0xBC00),
                BitConverter.UInt16BitsToHalf(0xBC01)
            };
            yield return new object[]
            {
                BitConverter.UInt16BitsToHalf(0xBA48),
                BitConverter.UInt16BitsToHalf(0xBA49)
            }; // value: -(pi / 4)
            yield return new object[]
            {
                BitConverter.UInt16BitsToHalf(0xB9A8),
                BitConverter.UInt16BitsToHalf(0xB9A9)
            }; // value: -(1 / sqrt(2))
            yield return new object[]
            {
                BitConverter.UInt16BitsToHalf(0xB98C),
                BitConverter.UInt16BitsToHalf(0xB98D)
            }; // value: -(ln(2))
            yield return new object[]
            {
                BitConverter.UInt16BitsToHalf(0xB918),
                BitConverter.UInt16BitsToHalf(0xB919)
            }; // value: -(2 / pi)
            yield return new object[]
            {
                BitConverter.UInt16BitsToHalf(0xB6F3),
                BitConverter.UInt16BitsToHalf(0xB6F4)
            }; // value: -(log10(e))
            yield return new object[]
            {
                BitConverter.UInt16BitsToHalf(0xB518),
                BitConverter.UInt16BitsToHalf(0xB519)
            }; // value: -(1 / pi)
            ...
            yield return new object[]
            {
                BitConverter.UInt16BitsToHalf(0x3518),
                BitConverter.UInt16BitsToHalf(0x3517)
            }; // value:  (1 / pi)
            yield return new object[]
            {
                BitConverter.UInt16BitsToHalf(0x36F3),
                BitConverter.UInt16BitsToHalf(0x36F2)
            }; // value:  (log10(e))
            yield return new object[]
            {
                BitConverter.UInt16BitsToHalf(0x3918),
                BitConverter.UInt16BitsToHalf(0x3917)
            }; // value:  (2 / pi)
            yield return new object[]
            {
                BitConverter.UInt16BitsToHalf(0x398C),
                BitConverter.UInt16BitsToHalf(0x398B)
            }; // value:  (ln(2))
            yield return new object[]
            {
                BitConverter.UInt16BitsToHalf(0x39A8),
                BitConverter.UInt16BitsToHalf(0x39A7)
            }; // value:  (1 / sqrt(2))
            yield return new object[]
            {
                BitConverter.UInt16BitsToHalf(0x3A48),
                BitConverter.UInt16BitsToHalf(0x3A47)
            }; // value:  (pi / 4)
            yield return new object[]
            {
                BitConverter.UInt16BitsToHalf(0x3C00),
                BitConverter.UInt16BitsToHalf(0x3BFF)
            };
            yield return new object[]
            {
                BitConverter.UInt16BitsToHalf(0x3C83),
                BitConverter.UInt16BitsToHalf(0x3C82)
            }; // value:  (2 / sqrt(pi))
            yield return new object[]
            {
                BitConverter.UInt16BitsToHalf(0x3DA8),
                BitConverter.UInt16BitsToHalf(0x3DA7)
            }; // value:  (sqrt(2))
            yield return new object[]
            {
                BitConverter.UInt16BitsToHalf(0x3DC5),
                BitConverter.UInt16BitsToHalf(0x3DC4)
            }; // value:  (log2(e))
            yield return new object[]
            {
                BitConverter.UInt16BitsToHalf(0x3E48),
                BitConverter.UInt16BitsToHalf(0x3E47)
            }; // value:  (pi / 2)
            yield return new object[]
            {
                BitConverter.UInt16BitsToHalf(0x409B),
                BitConverter.UInt16BitsToHalf(0x409A)
            }; // value:  (ln(10))
            yield return new object[]
            {
                BitConverter.UInt16BitsToHalf(0x4170),
                BitConverter.UInt16BitsToHalf(0x416F)
            }; // value:  (e)
            yield return new object[]
            {
                BitConverter.UInt16BitsToHalf(0x4248),
                BitConverter.UInt16BitsToHalf(0x4247)
            }; // value:  (pi)
        ...
        public static IEnumerable<object[]> BitIncrement_TestData()
        {
            ...
            {
                BitConverter.UInt16BitsToHalf(0xC248),
                BitConverter.UInt16BitsToHalf(0xC247)
            }; // value: -(pi)
            yield return new object[]
            {
                BitConverter.UInt16BitsToHalf(0xC170),
                BitConverter.UInt16BitsToHalf(0xC16F)
            }; // value: -(e)
            yield return new object[]
            {
                BitConverter.UInt16BitsToHalf(0xC09B),
                BitConverter.UInt16BitsToHalf(0xC09A)
            }; // value: -(ln(10))
            yield return new object[]
            {
                BitConverter.UInt16BitsToHalf(0xBE48),
                BitConverter.UInt16BitsToHalf(0xBE47)
            }; // value: -(pi / 2)
            yield return new object[]
            {
                BitConverter.UInt16BitsToHalf(0xBDC5),
                BitConverter.UInt16BitsToHalf(0xBDC4)
            }; // value: -(log2(e))
            yield return new object[]
            {
                BitConverter.UInt16BitsToHalf(0xBDA8),
                BitConverter.UInt16BitsToHalf(0xBDA7)
            }; // value: -(sqrt(2))
            yield return new object[]
            {
                BitConverter.UInt16BitsToHalf(0xBC83),
                BitConverter.UInt16BitsToHalf(0xBC82)
            }; // value: -(2 / sqrt(pi))
            yield return new object[]
            {
                BitConverter.UInt16BitsToHalf(0xBC00),
                BitConverter.UInt16BitsToHalf(0xBBFF)
            };
            yield return new object[]
            {
                BitConverter.UInt16BitsToHalf(0xBA48),
                BitConverter.UInt16BitsToHalf(0xBA47)
            }; // value: -(pi / 4)
            yield return new object[]
            {
                BitConverter.UInt16BitsToHalf(0xB9A8),
                BitConverter.UInt16BitsToHalf(0xB9A7)
            }; // value: -(1 / sqrt(2))
            yield return new object[]
            {
                BitConverter.UInt16BitsToHalf(0xB98C),
                BitConverter.UInt16BitsToHalf(0xB98B)
            }; // value: -(ln(2))
            yield return new object[]
            {
                BitConverter.UInt16BitsToHalf(0xB918),
                BitConverter.UInt16BitsToHalf(0xB917)
            }; // value: -(2 / pi)
            yield return new object[]
            {
                BitConverter.UInt16BitsToHalf(0xB6F3),
                BitConverter.UInt16BitsToHalf(0xB6F2)
            }; // value: -(log10(e))
            yield return new object[]
            {
                BitConverter.UInt16BitsToHalf(0xB518),
                BitConverter.UInt16BitsToHalf(0xB517)
            }; // value: -(1 / pi)
            yield return new object[] { BitConverter.UInt16BitsToHalf(0x8000), Half.Epsilon };
            yield return new object[] { Half.NaN, Half.NaN };
            yield return new object[] { BitConverter.UInt16BitsToHalf(0x0000), Half.Epsilon };
            ...
            {
                BitConverter.UInt16BitsToHalf(0x3518),
                BitConverter.UInt16BitsToHalf(0x3519)
            }; // value:  (1 / pi)
            yield return new object[]
            {
                BitConverter.UInt16BitsToHalf(0x36F3),
                BitConverter.UInt16BitsToHalf(0x36F4)
            }; // value:  (log10(e))
            yield return new object[]
            {
                BitConverter.UInt16BitsToHalf(0x3918),
                BitConverter.UInt16BitsToHalf(0x3919)
            }; // value:  (2 / pi)
            yield return new object[]
            {
                BitConverter.UInt16BitsToHalf(0x398C),
                BitConverter.UInt16BitsToHalf(0x398D)
            }; // value:  (ln(2))
            yield return new object[]
            {
                BitConverter.UInt16BitsToHalf(0x39A8),
                BitConverter.UInt16BitsToHalf(0x39A9)
            }; // value:  (1 / sqrt(2))
            yield return new object[]
            {
                BitConverter.UInt16BitsToHalf(0x3A48),
                BitConverter.UInt16BitsToHalf(0x3A49)
            }; // value:  (pi / 4)
            yield return new object[]
            {
                BitConverter.UInt16BitsToHalf(0x3C00),
                BitConverter.UInt16BitsToHalf(0x3C01)
            };
            yield return new object[]
            {
                BitConverter.UInt16BitsToHalf(0x3C83),
                BitConverter.UInt16BitsToHalf(0x3C84)
            }; // value:  (2 / sqrt(pi))
            yield return new object[]
            {
                BitConverter.UInt16BitsToHalf(0x3DA8),
                BitConverter.UInt16BitsToHalf(0x3DA9)
            }; // value:  (sqrt(2))
            yield return new object[]
            {
                BitConverter.UInt16BitsToHalf(0x3DC5),
                BitConverter.UInt16BitsToHalf(0x3DC6)
            }; // value:  (log2(e))
            yield return new object[]
            {
                BitConverter.UInt16BitsToHalf(0x3E48),
                BitConverter.UInt16BitsToHalf(0x3E49)
            }; // value:  (pi / 2)
            yield return new object[]
            {
                BitConverter.UInt16BitsToHalf(0x409B),
                BitConverter.UInt16BitsToHalf(0x409C)
            }; // value:  (ln(10))
            yield return new object[]
            {
                BitConverter.UInt16BitsToHalf(0x4170),
                BitConverter.UInt16BitsToHalf(0x4171)
            }; // value:  (e)
            yield return new object[]
            {
                BitConverter.UInt16BitsToHalf(0x4248),
                BitConverter.UInt16BitsToHalf(0x4249)
            }; // value:  (pi)
