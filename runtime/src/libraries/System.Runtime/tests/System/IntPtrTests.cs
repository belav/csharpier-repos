    ...
    public static class IntPtrTests
    {
        ...
        public static IEnumerable<object[]> Add_TestData()
        {
            ...
            yield return new object[]
            {
                ...
                5,
                unchecked((long)0x8000000000000004)
            };
        ...
        public static unsafe void TestExplicitCast()
        {
            ...
            MethodInfo opExplicitFromInt32 = typeof(nint).GetMethod(
                "op_Explicit",
                new Type[] { typeof(int) }
            );
            MethodInfo opExplicitToInt32 = methods.Single(
                (methodInfo) =>
                    (methodInfo.Name == "op_Explicit") && (methodInfo.ReturnType == typeof(int))
            );
            ...
            MethodInfo opExplicitFromInt64 = typeof(nint).GetMethod(
                "op_Explicit",
                new Type[] { typeof(long) }
            );
            MethodInfo opExplicitToInt64 = methods.Single(
                (methodInfo) =>
                    (methodInfo.Name == "op_Explicit") && (methodInfo.ReturnType == typeof(long))
            );
            ...
            MethodInfo opExplicitFromPointer = typeof(nint).GetMethod(
                "op_Explicit",
            ...
            Exception ex = Assert.ThrowsAny<Exception>(
                () => opExplicitToInt32.Invoke(null, new object[] { value })
            );
        ...
        private static void Verify(nint value, long expected)
        {
            ...
            Assert.Equal(
                nint.Size == 4 ? expected32.ToString("x") : expected.ToString("x"),
                value.ToString("x")
            );
            ...
            foreach (NumberFormatInfo defaultFormat in new[] { null, NumberFormatInfo.CurrentInfo })
            {
                foreach (string defaultSpecifier in new[] { "G", "G\0", "\0N222", "\0", "", "R" })
                {
                    yield return new object[]
                    {
                        ...
                        defaultSpecifier,
                        defaultFormat,
                        Is64Bit ? "-9223372036854775808" : "-2147483648"
                    };
                    yield return new object[]
                    {
                        (nint)(-4567),
                    ...
                    yield return new object[]
                    {
                        ...
                        defaultSpecifier,
                        defaultFormat,
                        Is64Bit ? "9223372036854775807" : "2147483647"
                    };
                }
                ...
                yield return new object[]
                {
                    ...
                    "x",
                    defaultFormat,
                    Is64Bit ? "ffffffffffffdb98" : "ffffdb98"
                };
                yield return new object[]
                {
                    (nint)2468,
        ...
        )
        {
            ...
            if (provider == null)
            {
                ...
                Assert.Throws(
                    exceptionType,
                    () => nint.Parse(value, style, new NumberFormatInfo())
                );
            }
        ...
        )
        {
            ...
            AssertExtensions.Throws<ArgumentException>(
                paramName,
                () => nint.TryParse("1", style, null, out result)
            );
