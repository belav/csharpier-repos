...
namespace System.Tests
{
    public static class IntPtrTests
    {
        ...
        private static void VerifyPointer(IntPtr ptr, long expected)
        {
            ...
            Assert.Equal(
                IntPtr.Size == 4 ? expected32.ToString("x") : expected.ToString("x"),
                ptr.ToString("x")
            );
        ...
        public static void Parse_Invalid(
            ...
            if (provider == null)
            {
                ...
                Assert.Throws(
                    exceptionType,
                    () => IntPtr.Parse(value, style, new NumberFormatInfo())
                );
            }
        ...
        public static void TryParse_InvalidNumberStyle_ThrowsArgumentException(
            ...
            AssertExtensions.Throws<ArgumentException>(
                paramName,
                () => IntPtr.TryParse("1", style, null, out result)
            );
