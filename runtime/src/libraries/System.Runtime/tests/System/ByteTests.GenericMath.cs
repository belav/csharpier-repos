    ...
    public class ByteTests_GenericMath
    {
        ...
        public static void op_CheckedAdditionTest()
        {
            ...
            Assert.Throws<OverflowException>(
                () =>
                    AdditionOperatorsHelper<byte, byte, byte>.op_CheckedAddition(
                        (byte)0xFF,
                        (byte)1
                    )
            );
        ...
        public static void op_CheckedDivisionTest()
        {
            ...
            Assert.Throws<DivideByZeroException>(
                () =>
                    DivisionOperatorsHelper<byte, byte, byte>.op_CheckedDivision(
                        (byte)0x01,
                        (byte)0
                    )
            );
        ...
        public static void op_CheckedMultiplyTest()
        {
            ...
            Assert.Throws<OverflowException>(
                () =>
                    MultiplyOperatorsHelper<byte, byte, byte>.op_CheckedMultiply(
                        (byte)0x80,
                        (byte)2
                    )
            );
        ...
        public static void CreateCheckedFromIntPtrTest()
        {
            if (Environment.Is64BitProcess)
            {
                ...
                Assert.Throws<OverflowException>(
                    () =>
                        NumberBaseHelper<byte>.CreateChecked<nint>(
        ...
        public static void op_UnsignedRightShiftTest()
        {
            Assert.Equal(
                (byte)0x00,
                ShiftOperatorsHelper<byte, byte>.op_UnsignedRightShift((byte)0x00, 1)
            );
            Assert.Equal(
                (byte)0x00,
                ShiftOperatorsHelper<byte, byte>.op_UnsignedRightShift((byte)0x01, 1)
            );
            Assert.Equal(
                (byte)0x3F,
                ShiftOperatorsHelper<byte, byte>.op_UnsignedRightShift((byte)0x7F, 1)
            );
            Assert.Equal(
                (byte)0x40,
                ShiftOperatorsHelper<byte, byte>.op_UnsignedRightShift((byte)0x80, 1)
            );
            Assert.Equal(
                (byte)0x7F,
                ShiftOperatorsHelper<byte, byte>.op_UnsignedRightShift((byte)0xFF, 1)
            );
        }
