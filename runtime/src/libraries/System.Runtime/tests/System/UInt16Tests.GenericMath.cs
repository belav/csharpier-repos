    ...
    public class UInt16Tests_GenericMath
    {
        ...
        public static void CreateFromInt16Test()
        {
            ...
            Assert.Throws<OverflowException>(
                () => NumberHelper<ushort>.Create<short>(unchecked((short)0x8000))
            );
            Assert.Throws<OverflowException>(
                () => NumberHelper<ushort>.Create<short>(unchecked((short)0xFFFF))
            );
        }
        ...
        public static void CreateFromInt32Test()
        {
            ...
            Assert.Throws<OverflowException>(
                () => NumberHelper<ushort>.Create<int>(unchecked((int)0x80000000))
            );
            Assert.Throws<OverflowException>(
                () => NumberHelper<ushort>.Create<int>(unchecked((int)0xFFFFFFFF))
            );
        }
        ...
        public static void CreateFromInt64Test()
        {
            ...
            Assert.Throws<OverflowException>(
                () => NumberHelper<ushort>.Create<long>(0x7FFFFFFFFFFFFFFF)
            );
            Assert.Throws<OverflowException>(
                () => NumberHelper<ushort>.Create<long>(unchecked((long)0x8000000000000000))
            );
            Assert.Throws<OverflowException>(
                () => NumberHelper<ushort>.Create<long>(unchecked((long)0xFFFFFFFFFFFFFFFF))
            );
        }
        ...
        public static void CreateFromIntPtrTest()
        {
            if (Environment.Is64BitProcess)
            {
                Assert.Equal(
                    (ushort)0x0000,
                    NumberHelper<ushort>.Create<nint>(unchecked((nint)0x0000000000000000))
                );
                Assert.Equal(
                    (ushort)0x0001,
                    NumberHelper<ushort>.Create<nint>(unchecked((nint)0x0000000000000001))
                );
                Assert.Throws<OverflowException>(
                    () => NumberHelper<ushort>.Create<nint>(unchecked((nint)0x7FFFFFFFFFFFFFFF))
                );
                Assert.Throws<OverflowException>(
                    () => NumberHelper<ushort>.Create<nint>(unchecked((nint)0x8000000000000000))
                );
                Assert.Throws<OverflowException>(
                    () => NumberHelper<ushort>.Create<nint>(unchecked((nint)0xFFFFFFFFFFFFFFFF))
                );
            }
            else
            {
                ...
                Assert.Throws<OverflowException>(
                    () => NumberHelper<ushort>.Create<nint>((nint)0x7FFFFFFF)
                );
                Assert.Throws<OverflowException>(
                    () => NumberHelper<ushort>.Create<nint>(unchecked((nint)0x80000000))
                );
                Assert.Throws<OverflowException>(
                    () => NumberHelper<ushort>.Create<nint>(unchecked((nint)0xFFFFFFFF))
                );
            }
        }
        ...
        public static void CreateFromSByteTest()
        {
            ...
            Assert.Throws<OverflowException>(
                () => NumberHelper<ushort>.Create<sbyte>(unchecked((sbyte)0x80))
            );
            Assert.Throws<OverflowException>(
                () => NumberHelper<ushort>.Create<sbyte>(unchecked((sbyte)0xFF))
            );
        }
        ...
        public static void CreateFromUInt64Test()
        {
            ...
            Assert.Throws<OverflowException>(
                () => NumberHelper<ushort>.Create<ulong>(0x7FFFFFFFFFFFFFFF)
            );
            Assert.Throws<OverflowException>(
                () => NumberHelper<ushort>.Create<ulong>(0x8000000000000000)
            );
            Assert.Throws<OverflowException>(
                () => NumberHelper<ushort>.Create<ulong>(0xFFFFFFFFFFFFFFFF)
            );
        }
        ...
        public static void CreateFromUIntPtrTest()
        {
            if (Environment.Is64BitProcess)
            {
                Assert.Equal(
                    (ushort)0x0000,
                    NumberHelper<ushort>.Create<nuint>(unchecked((nuint)0x0000000000000000))
                );
                Assert.Equal(
                    (ushort)0x0001,
                    NumberHelper<ushort>.Create<nuint>(unchecked((nuint)0x0000000000000001))
                );
                Assert.Throws<OverflowException>(
                    () => NumberHelper<ushort>.Create<nuint>(unchecked((nuint)0x7FFFFFFFFFFFFFFF))
                );
                Assert.Throws<OverflowException>(
                    () => NumberHelper<ushort>.Create<nuint>(unchecked((nuint)0x8000000000000000))
                );
                Assert.Throws<OverflowException>(
                    () => NumberHelper<ushort>.Create<nuint>(unchecked((nuint)0xFFFFFFFFFFFFFFFF))
                );
            }
            else
            {
                ...
                Assert.Throws<OverflowException>(
                    () => NumberHelper<ushort>.Create<nuint>((nuint)0x7FFFFFFF)
                );
                Assert.Throws<OverflowException>(
                    () => NumberHelper<ushort>.Create<nuint>((nuint)0x80000000)
                );
                Assert.Throws<OverflowException>(
                    () => NumberHelper<ushort>.Create<nuint>((nuint)0xFFFFFFFF)
                );
            }
        }
        ...
        public static void CreateSaturatingFromInt16Test()
        {
            ...
            Assert.Equal(
                (ushort)0x0000,
                NumberHelper<ushort>.CreateSaturating<short>(unchecked((short)0x8000))
            );
            Assert.Equal(
                (ushort)0x0000,
                NumberHelper<ushort>.CreateSaturating<short>(unchecked((short)0xFFFF))
            );
        }
        ...
        public static void CreateSaturatingFromInt32Test()
        {
            ...
            Assert.Equal(
                (ushort)0x0000,
                NumberHelper<ushort>.CreateSaturating<int>(unchecked((int)0x80000000))
            );
            Assert.Equal(
                (ushort)0x0000,
                NumberHelper<ushort>.CreateSaturating<int>(unchecked((int)0xFFFFFFFF))
            );
        }
        ...
        public static void CreateSaturatingFromInt64Test()
        {
            Assert.Equal(
                (ushort)0x0000,
                NumberHelper<ushort>.CreateSaturating<long>(0x0000000000000000)
            );
            Assert.Equal(
                (ushort)0x0001,
                NumberHelper<ushort>.CreateSaturating<long>(0x0000000000000001)
            );
            Assert.Equal(
                (ushort)0xFFFF,
                NumberHelper<ushort>.CreateSaturating<long>(0x7FFFFFFFFFFFFFFF)
            );
            Assert.Equal(
                (ushort)0x0000,
                NumberHelper<ushort>.CreateSaturating<long>(unchecked((long)0x8000000000000000))
            );
            Assert.Equal(
                (ushort)0x0000,
                NumberHelper<ushort>.CreateSaturating<long>(unchecked((long)0xFFFFFFFFFFFFFFFF))
            );
        }
        ...
        public static void CreateSaturatingFromIntPtrTest()
        {
            if (Environment.Is64BitProcess)
            {
                Assert.Equal(
                    (ushort)0x0000,
                    NumberHelper<ushort>.CreateSaturating<nint>(unchecked((nint)0x0000000000000000))
                );
                Assert.Equal(
                    (ushort)0x0001,
                    NumberHelper<ushort>.CreateSaturating<nint>(unchecked((nint)0x0000000000000001))
                );
                Assert.Equal(
                    (ushort)0xFFFF,
                    NumberHelper<ushort>.CreateSaturating<nint>(unchecked((nint)0x7FFFFFFFFFFFFFFF))
                );
                Assert.Equal(
                    (ushort)0x0000,
                    NumberHelper<ushort>.CreateSaturating<nint>(unchecked((nint)0x8000000000000000))
                );
                Assert.Equal(
                    (ushort)0x0000,
                    NumberHelper<ushort>.CreateSaturating<nint>(unchecked((nint)0xFFFFFFFFFFFFFFFF))
                );
            }
            else
            {
                Assert.Equal(
                    (ushort)0x0000,
                    NumberHelper<ushort>.CreateSaturating<nint>((nint)0x00000000)
                );
                Assert.Equal(
                    (ushort)0x0001,
                    NumberHelper<ushort>.CreateSaturating<nint>((nint)0x00000001)
                );
                Assert.Equal(
                    (ushort)0xFFFF,
                    NumberHelper<ushort>.CreateSaturating<nint>((nint)0x7FFFFFFF)
                );
                Assert.Equal(
                    (ushort)0x0000,
                    NumberHelper<ushort>.CreateSaturating<nint>(unchecked((nint)0x80000000))
                );
                Assert.Equal(
                    (ushort)0x0000,
                    NumberHelper<ushort>.CreateSaturating<nint>(unchecked((nint)0xFFFFFFFF))
                );
            }
        }
        ...
        public static void CreateSaturatingFromSByteTest()
        {
            ...
            Assert.Equal(
                (ushort)0x0000,
                NumberHelper<ushort>.CreateSaturating<sbyte>(unchecked((sbyte)0x80))
            );
            Assert.Equal(
                (ushort)0x0000,
                NumberHelper<ushort>.CreateSaturating<sbyte>(unchecked((sbyte)0xFF))
            );
        }
        ...
        public static void CreateSaturatingFromUInt64Test()
        {
            Assert.Equal(
                (ushort)0x0000,
                NumberHelper<ushort>.CreateSaturating<ulong>(0x0000000000000000)
            );
            Assert.Equal(
                (ushort)0x0001,
                NumberHelper<ushort>.CreateSaturating<ulong>(0x0000000000000001)
            );
            Assert.Equal(
                (ushort)0xFFFF,
                NumberHelper<ushort>.CreateSaturating<ulong>(0x7FFFFFFFFFFFFFFF)
            );
            Assert.Equal(
                (ushort)0xFFFF,
                NumberHelper<ushort>.CreateSaturating<ulong>(0x8000000000000000)
            );
            Assert.Equal(
                (ushort)0xFFFF,
                NumberHelper<ushort>.CreateSaturating<ulong>(0xFFFFFFFFFFFFFFFF)
            );
        }
        ...
        public static void CreateSaturatingFromUIntPtrTest()
        {
            if (Environment.Is64BitProcess)
            {
                Assert.Equal(
                    (ushort)0x0000,
                    NumberHelper<ushort>.CreateSaturating<nuint>(
            ...
            else
            {
                Assert.Equal(
                    (ushort)0x0000,
                    NumberHelper<ushort>.CreateSaturating<nuint>((nuint)0x00000000)
                );
                Assert.Equal(
                    (ushort)0x0001,
                    NumberHelper<ushort>.CreateSaturating<nuint>((nuint)0x00000001)
                );
                Assert.Equal(
                    (ushort)0xFFFF,
                    NumberHelper<ushort>.CreateSaturating<nuint>((nuint)0x7FFFFFFF)
                );
                Assert.Equal(
                    (ushort)0xFFFF,
                    NumberHelper<ushort>.CreateSaturating<nuint>((nuint)0x80000000)
                );
                Assert.Equal(
                    (ushort)0xFFFF,
                    NumberHelper<ushort>.CreateSaturating<nuint>((nuint)0xFFFFFFFF)
                );
            }
        }
        ...
        public static void CreateTruncatingFromInt16Test()
        {
            ...
            Assert.Equal(
                (ushort)0x8000,
                NumberHelper<ushort>.CreateTruncating<short>(unchecked((short)0x8000))
            );
            Assert.Equal(
                (ushort)0xFFFF,
                NumberHelper<ushort>.CreateTruncating<short>(unchecked((short)0xFFFF))
            );
        }
        ...
        public static void CreateTruncatingFromInt32Test()
        {
            ...
            Assert.Equal(
                (ushort)0x0000,
                NumberHelper<ushort>.CreateTruncating<int>(unchecked((int)0x80000000))
            );
            Assert.Equal(
                (ushort)0xFFFF,
                NumberHelper<ushort>.CreateTruncating<int>(unchecked((int)0xFFFFFFFF))
            );
        }
        ...
        public static void CreateTruncatingFromInt64Test()
        {
            Assert.Equal(
                (ushort)0x0000,
                NumberHelper<ushort>.CreateTruncating<long>(0x0000000000000000)
            );
            Assert.Equal(
                (ushort)0x0001,
                NumberHelper<ushort>.CreateTruncating<long>(0x0000000000000001)
            );
            Assert.Equal(
                (ushort)0xFFFF,
                NumberHelper<ushort>.CreateTruncating<long>(0x7FFFFFFFFFFFFFFF)
            );
            Assert.Equal(
                (ushort)0x0000,
                NumberHelper<ushort>.CreateTruncating<long>(unchecked((long)0x8000000000000000))
            );
            Assert.Equal(
                (ushort)0xFFFF,
                NumberHelper<ushort>.CreateTruncating<long>(unchecked((long)0xFFFFFFFFFFFFFFFF))
            );
        }
        ...
        public static void CreateTruncatingFromIntPtrTest()
        {
            if (Environment.Is64BitProcess)
            {
                Assert.Equal(
                    (ushort)0x0000,
                    NumberHelper<ushort>.CreateTruncating<nint>(unchecked((nint)0x0000000000000000))
                );
                Assert.Equal(
                    (ushort)0x0001,
                    NumberHelper<ushort>.CreateTruncating<nint>(unchecked((nint)0x0000000000000001))
                );
                Assert.Equal(
                    (ushort)0xFFFF,
                    NumberHelper<ushort>.CreateTruncating<nint>(unchecked((nint)0x7FFFFFFFFFFFFFFF))
                );
                Assert.Equal(
                    (ushort)0x0000,
                    NumberHelper<ushort>.CreateTruncating<nint>(unchecked((nint)0x8000000000000000))
                );
                Assert.Equal(
                    (ushort)0xFFFF,
                    NumberHelper<ushort>.CreateTruncating<nint>(unchecked((nint)0xFFFFFFFFFFFFFFFF))
                );
            }
            else
            {
                Assert.Equal(
                    (ushort)0x0000,
                    NumberHelper<ushort>.CreateTruncating<nint>((nint)0x00000000)
                );
                Assert.Equal(
                    (ushort)0x0001,
                    NumberHelper<ushort>.CreateTruncating<nint>((nint)0x00000001)
                );
                Assert.Equal(
                    (ushort)0xFFFF,
                    NumberHelper<ushort>.CreateTruncating<nint>((nint)0x7FFFFFFF)
                );
                Assert.Equal(
                    (ushort)0x0000,
                    NumberHelper<ushort>.CreateTruncating<nint>(unchecked((nint)0x80000000))
                );
                Assert.Equal(
                    (ushort)0xFFFF,
                    NumberHelper<ushort>.CreateTruncating<nint>(unchecked((nint)0xFFFFFFFF))
                );
            }
        }
        ...
        public static void CreateTruncatingFromSByteTest()
        {
            ...
            Assert.Equal(
                (ushort)0xFF80,
                NumberHelper<ushort>.CreateTruncating<sbyte>(unchecked((sbyte)0x80))
            );
            Assert.Equal(
                (ushort)0xFFFF,
                NumberHelper<ushort>.CreateTruncating<sbyte>(unchecked((sbyte)0xFF))
            );
        }
        ...
        public static void CreateTruncatingFromUInt64Test()
        {
            Assert.Equal(
                (ushort)0x0000,
                NumberHelper<ushort>.CreateTruncating<ulong>(0x0000000000000000)
            );
            Assert.Equal(
                (ushort)0x0001,
                NumberHelper<ushort>.CreateTruncating<ulong>(0x0000000000000001)
            );
            Assert.Equal(
                (ushort)0xFFFF,
                NumberHelper<ushort>.CreateTruncating<ulong>(0x7FFFFFFFFFFFFFFF)
            );
            Assert.Equal(
                (ushort)0x0000,
                NumberHelper<ushort>.CreateTruncating<ulong>(0x8000000000000000)
            );
            Assert.Equal(
                (ushort)0xFFFF,
                NumberHelper<ushort>.CreateTruncating<ulong>(0xFFFFFFFFFFFFFFFF)
            );
        }
        ...
        public static void CreateTruncatingFromUIntPtrTest()
        {
            if (Environment.Is64BitProcess)
            {
                Assert.Equal(
                    (ushort)0x0000,
                    NumberHelper<ushort>.CreateTruncating<nuint>(
                        unchecked((nuint)0x0000000000000000)
                    )
                );
                Assert.Equal(
            ...
            else
            {
                Assert.Equal(
                    (ushort)0x0000,
                    NumberHelper<ushort>.CreateTruncating<nuint>((nuint)0x00000000)
                );
                Assert.Equal(
                    (ushort)0x0001,
                    NumberHelper<ushort>.CreateTruncating<nuint>((nuint)0x00000001)
                );
                Assert.Equal(
                    (ushort)0xFFFF,
                    NumberHelper<ushort>.CreateTruncating<nuint>((nuint)0x7FFFFFFF)
                );
                Assert.Equal(
                    (ushort)0x0000,
                    NumberHelper<ushort>.CreateTruncating<nuint>((nuint)0x80000000)
                );
                Assert.Equal(
                    (ushort)0xFFFF,
                    NumberHelper<ushort>.CreateTruncating<nuint>((nuint)0xFFFFFFFF)
                );
            }
        }
        ...
        public static void DivRemTest()
        {
            Assert.Equal(
                ...
                NumberHelper<ushort>.DivRem((ushort)0x0000, (ushort)2)
            );
            Assert.Equal(
                ((ushort)0x0000, (ushort)0x0001),
                NumberHelper<ushort>.DivRem((ushort)0x0001, (ushort)2)
            );
            Assert.Equal(
                ((ushort)0x3FFF, (ushort)0x0001),
                NumberHelper<ushort>.DivRem((ushort)0x7FFF, (ushort)2)
            );
            Assert.Equal(
                ((ushort)0x4000, (ushort)0x0000),
                NumberHelper<ushort>.DivRem((ushort)0x8000, (ushort)2)
            );
            Assert.Equal(
                ((ushort)0x7FFF, (ushort)0x0001),
                NumberHelper<ushort>.DivRem((ushort)0xFFFF, (ushort)2)
            );
        }
        ...
        public static void TryCreateFromInt16Test()
        {
            ...
            Assert.False(
                NumberHelper<ushort>.TryCreate<short>(unchecked((short)0x8000), out result)
            );
            Assert.Equal((ushort)0x0000, result);

            Assert.False(
                NumberHelper<ushort>.TryCreate<short>(unchecked((short)0xFFFF), out result)
            );
            Assert.Equal((ushort)0x0000, result);
        }
        ...
        public static void TryCreateFromInt32Test()
        {
            ...
            Assert.False(
                NumberHelper<ushort>.TryCreate<int>(unchecked((int)0x80000000), out result)
            );
            Assert.Equal((ushort)0x0000, result);

            Assert.False(
                NumberHelper<ushort>.TryCreate<int>(unchecked((int)0xFFFFFFFF), out result)
            );
            Assert.Equal((ushort)0x0000, result);
        }
        ...
        public static void TryCreateFromInt64Test()
        {
            ...
            Assert.False(
                NumberHelper<ushort>.TryCreate<long>(
        ...
        public static void TryCreateFromIntPtrTest()
        {
            ...
            {
                Assert.True(
                    NumberHelper<ushort>.TryCreate<nint>(
            ...
            else
            {
                ...
                Assert.False(
                    NumberHelper<ushort>.TryCreate<nint>(unchecked((nint)0x80000000), out result)
                );
                Assert.Equal((ushort)0x0000, result);

                Assert.False(
                    NumberHelper<ushort>.TryCreate<nint>(unchecked((nint)0xFFFFFFFF), out result)
                );
                Assert.Equal((ushort)0x0000, result);
            }
        }
        ...
        public static void TryCreateFromUIntPtrTest()
        {
            ...
            {
                Assert.True(
                    NumberHelper<ushort>.TryCreate<nuint>(
                        unchecked((nuint)0x0000000000000000),
                        out result
                    )
                );
            ...
            else
            {
                ...
                Assert.False(
                    NumberHelper<ushort>.TryCreate<nuint>(unchecked((nuint)0x80000000), out result)
                );
                Assert.Equal((ushort)0x0000, result);

                Assert.False(
                    NumberHelper<ushort>.TryCreate<nuint>(unchecked((nuint)0xFFFFFFFF), out result)
                );
                Assert.Equal((ushort)0x0000, result);
            }
        }
        ...
        )
        {
            ...
            if (provider is null)
            {
                ...
                Assert.True(
                    NumberHelper<ushort>.TryParse(value, style, new NumberFormatInfo(), out result)
                );
                Assert.Equal(expected, result);
                Assert.Equal(
                    expected,
                    NumberHelper<ushort>.Parse(value, style, new NumberFormatInfo())
                );
            }
        ...
        )
        {
            ...
            if (provider is null)
            {
                Assert.Throws(
                    exceptionType,
                    () => NumberHelper<ushort>.Parse(value, style, provider)
                );
        ...
        )
        {
            ...
            {
                Assert.True(
                    SpanParseableHelper<ushort>.TryParse(
            ...
            Assert.Equal(
                expected,
                NumberHelper<ushort>.Parse(value.AsSpan(offset, count), style, provider)
            );

            Assert.True(
                NumberHelper<ushort>.TryParse(
                    value.AsSpan(offset, count),
                    style,
                    provider,
                    out result
        ...
        )
        {
            ...
            {
                Assert.False(
                    SpanParseableHelper<ushort>.TryParse(value.AsSpan(), provider, out result)
                );
                Assert.Equal(default(ushort), result);
            }
            ...
            Assert.Throws(
                exceptionType,
                () => NumberHelper<ushort>.Parse(value.AsSpan(), style, provider)
            );

            Assert.False(
                NumberHelper<ushort>.TryParse(value.AsSpan(), style, provider, out result)
            );
            Assert.Equal(default(ushort), result);
        }
    }
