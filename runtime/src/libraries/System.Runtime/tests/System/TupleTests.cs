...
namespace System.Tests
{
    public class TupleTests
    {
        private class TupleTestDriver<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>
        {
            ...
            internal TupleTestDriver(params object[] values)
            {
                ...
                if (values.Length > 10)
                    throw new ArgumentOutOfRangeException(
                        nameof(values),
                        "You must provide at most 10 values"
                    );
                ...
                switch (_nItems)
                {
                    ...
                    case 4:
                        ...
                        break;
                    case 5:
                        Tuple5 = new Tuple<T1, T2, T3, T4, T5>(
                            (T1)values[0],
                            (T2)values[1],
                            (T3)values[2],
                            (T4)values[3],
                        ...
                        break;
                    case 6:
                        Tuple6 = new Tuple<T1, T2, T3, T4, T5, T6>(
                            (T1)values[0],
                            (T2)values[1],
                            (T3)values[2],
                            (T4)values[3],
                        ...
                        break;
                    case 7:
                        Tuple7 = new Tuple<T1, T2, T3, T4, T5, T6, T7>(
                            (T1)values[0],
                            (T2)values[1],
                            (T3)values[2],
                            (T4)values[3],
                        ...
                        break;
                    case 8:
                        Tuple8 = new Tuple<T1, T2, T3, T4, T5, T6, T7, Tuple<T8>>(
                            (T1)values[0],
                            (T2)values[1],
                            (T3)values[2],
                            (T4)values[3],
                            ...
                            (T6)values[5],
                            (T7)values[6],
                            new Tuple<T8>((T8)values[7])
                        );
                        Tuple = Tuple8;
                        break;
                    case 9:
                        Tuple9 = new Tuple<T1, T2, T3, T4, T5, T6, T7, Tuple<T8, T9>>(
                            (T1)values[0],
                            (T2)values[1],
                            (T3)values[2],
                            (T4)values[3],
                            ...
                            (T6)values[5],
                            (T7)values[6],
                            new Tuple<T8, T9>((T8)values[7], (T9)values[8])
                        );
                        Tuple = Tuple9;
                        break;
                    case 10:
                        Tuple10 = new Tuple<T1, T2, T3, T4, T5, T6, T7, Tuple<T8, T9, T10>>(
                            (T1)values[0],
                            (T2)values[1],
                            (T3)values[2],
                            (T4)values[3],
                            ...
                            (T6)values[5],
                            (T7)values[6],
                            new Tuple<T8, T9, T10>((T8)values[7], (T9)values[8], (T10)values[9])
                        );
                        Tuple = Tuple10;
                        break;
                }
                ...
                switch (_nItems)
                {
                    ...
                    default:
                        throw new ArgumentException(
                            "Must specify between 1 and 10 expected values (inclusive)."
                        );
                }
            }
            ...
            )
            {
                ...
                if (expectStructuallyEqual)
                {
                    ...
                    Assert.Equal(
                        equatable.GetHashCode(TestEqualityComparer.Instance),
                        otherEquatable.GetHashCode(TestEqualityComparer.Instance)
                    );
                }
                else
                {
            ...
            )
            {
                ...
                Assert.Equal(
                    ...
                    ((IStructuralComparable)Tuple).CompareTo(other.Tuple, TestComparer.Instance)
                );
        ...
        public static void Constructor()
        {
            ...
            > tupleDriverA;
            //Tuple-1
            tupleDriverA = new TupleTestDriver<
                short,
                int,
                long,
                string,
            ...
            tupleDriverA = new TupleTestDriver<
                ...
                Tuple<bool, object>,
                TimeSpan
            >((short)1, (int)1, long.MinValue, "This");
            ...
            tupleDriverA = new TupleTestDriver<
                ...
                Tuple<bool, object>,
                TimeSpan
            >((short)10, (int)100, (long)1, "testing", 'Z', float.MaxValue);
        ...
        public static void Equals_GetHashCode()
        {
            ...
            tupleDriverA = new TupleTestDriver<
                ...
                TimeSpan
            >(short.MaxValue);
            tupleDriverB = new TupleTestDriver<
                short,
                int,
                long,
                string,
                ...
                TimeSpan
            >(short.MaxValue);
            tupleDriverC = new TupleTestDriver<
                short,
                int,
                long,
                string,
                ...
                TimeSpan
            >(short.MinValue);
            tupleDriverD = new TupleTestDriver<
                short,
                int,
                long,
                string,
            ...
            tupleDriverD = new TupleTestDriver<
                ...
                Tuple<bool, object>,
                TimeSpan
            >((short)10, (int)100, (long)1, "testing", 'Z', float.MinValue);
            tupleDriverA.Equals_GetHashCode(tupleDriverB, true, true);
            tupleDriverA.Equals_GetHashCode(tupleDriverC, false, false);
            tupleDriverA.Equals_GetHashCode(tupleDriverD, false, false);
            //Tuple-6
            ...
            tupleDriverD = new TupleTestDriver<
                ...
                Tuple<bool, object>,
                TimeSpan
            >((short)(-101), (int)(-1001), (long)(-2), "tuples", ' ', float.MinValue, (double)0.0);
            tupleDriverA.Equals_GetHashCode(tupleDriverB, true, true);
            tupleDriverA.Equals_GetHashCode(tupleDriverC, false, false);
            tupleDriverA.Equals_GetHashCode(tupleDriverD, false, false);
            //Tuple-7
        ...
        public static void NotEqual()
        {
            ...
            tupleDriverA = new TupleTestDriver<
                ...
                bool,
                TimeSpan
            >((short)10000, (int)1000000, (long)10000000);
            tupleDriverA.NotEqual();
            //Tuple-4
            tupleDriverA = new TupleTestDriver<
                short,
                ...
                bool,
                TimeSpan
            >((short)10000, (int)1000000, (long)10000000, "2008?7?2?");
            tupleDriverA.NotEqual();
            //Tuple-5
            tupleDriverA = new TupleTestDriver<
                short,
                ...
                bool,
                TimeSpan
            >((short)10000, (int)1000000, (long)10000000, "2008?7?2?", '0');
            tupleDriverA.NotEqual();
            //Tuple-6
            tupleDriverA = new TupleTestDriver<
                short,
                ...
                bool,
                TimeSpan
            >((short)10000, (int)1000000, (long)10000000, "2008?7?2?", '0', float.NaN);
            tupleDriverA.NotEqual();
            //Tuple-7
            tupleDriverA = new TupleTestDriver<
                short,
        ...
        public static void NestedTuples2()
        {
            var a = Tuple.Create(
                ...
                5,
                6,
                Tuple.Create(7, 8, 9, 10, 11, 12, 13, Tuple.Create(14, 15))
            );
            var b = Tuple.Create(
                1,
                2,
                ...
                6,
                7,
                Tuple.Create(8, 9, 10, 11, 12, 13, 14, Tuple.Create(15, 16))
            );
