...
namespace System.Tests
{
    public class UriMethodTests
    {
        ...
        public void MakeRelative(Uri baseUri, Uri uri, Uri expected)
        {
            ...
            {
                UriCreateStringTests.VerifyRelativeUri(
                    relativeUri,
        ...
        [InlineData(
            "http://192.168.0.1/path1/page?query#fragment",
        ...
        public void EscapeDataString_Long_Success()
        {
            ...
            Assert.Equal(
                string.Concat(Enumerable.Repeat("%2F", LongCount)),
        ...
        public void EscapeUriString_Long_Success()
        {
            ...
            s = new string('<', LongCount);
            Assert.Equal(
                string.Concat(Enumerable.Repeat("%3C", LongCount)),
        ...
        public void GetComponents_Advanced(
            Uri uri,
