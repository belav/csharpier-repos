...
namespace System.Tests
{
    ...
    public static class AttributeGetCustomAttributes
    {
        ...
        {
            GenericAttributesTestHelper<string>(
                t => Attribute.GetCustomAttributes(typeof(HasGenericAttribute), t)
            );
        }
        ...
        public static void GetCustomAttributesWorksWithOpenAndClosedGenericTypesForProperty()
        {
            ...
            GenericAttributesTestHelper<List<object>>(
                t => Attribute.GetCustomAttributes(property, t)
            );
        }
