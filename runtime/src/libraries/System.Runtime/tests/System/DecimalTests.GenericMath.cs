...
namespace System.Tests
{
    public class DecimalTests_GenericMath
    {
        ...
        {
            Assert.False(
                ComparisonOperatorsHelper<decimal, decimal>.op_GreaterThan(decimal.MinValue, 1.0m)
            );
            ...
            Assert.False(ComparisonOperatorsHelper<decimal, decimal>.op_GreaterThan(1.0m, 1.0m));
            Assert.True(
                ComparisonOperatorsHelper<decimal, decimal>.op_GreaterThan(decimal.MaxValue, 1.0m)
            );
        }
        ...
        {
            Assert.False(
                ComparisonOperatorsHelper<decimal, decimal>.op_GreaterThanOrEqual(
                    decimal.MinValue,
                    1.0m
                )
            );
            Assert.False(
                ComparisonOperatorsHelper<decimal, decimal>.op_GreaterThanOrEqual(-1.0m, 1.0m)
            );
            Assert.False(
                ComparisonOperatorsHelper<decimal, decimal>.op_GreaterThanOrEqual(-0.0m, 1.0m)
            );
            Assert.False(
                ComparisonOperatorsHelper<decimal, decimal>.op_GreaterThanOrEqual(0.0m, 1.0m)
            );
        ...
        {
            Assert.True(
                ComparisonOperatorsHelper<decimal, decimal>.op_LessThan(decimal.MinValue, 1.0m)
            );
            ...
            Assert.False(
                ComparisonOperatorsHelper<decimal, decimal>.op_LessThan(decimal.MaxValue, 1.0m)
            );
        }
        ...
        {
            Assert.True(
                ComparisonOperatorsHelper<decimal, decimal>.op_LessThanOrEqual(
                    decimal.MinValue,
                    1.0m
                )
            );
            Assert.True(
                ComparisonOperatorsHelper<decimal, decimal>.op_LessThanOrEqual(-1.0m, 1.0m)
            );
            Assert.True(
                ComparisonOperatorsHelper<decimal, decimal>.op_LessThanOrEqual(-0.0m, 1.0m)
            );
        ...
        {
            Assert.False(
                EqualityOperatorsHelper<decimal, decimal>.op_Equality(decimal.MinValue, 1.0m)
            );
            ...
            Assert.False(
                EqualityOperatorsHelper<decimal, decimal>.op_Equality(decimal.MaxValue, 1.0m)
            );
        }
        ...
        {
            Assert.True(
                EqualityOperatorsHelper<decimal, decimal>.op_Inequality(decimal.MinValue, 1.0m)
            );
            ...
            Assert.True(
                EqualityOperatorsHelper<decimal, decimal>.op_Inequality(decimal.MaxValue, 1.0m)
            );
        }
