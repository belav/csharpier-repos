...
namespace System.Tests
{
    ...
    public class UInt32Tests_GenericMath
    {
        ...
        {
            Assert.True(
                ComparisonOperatorsHelper<uint, uint>.op_LessThanOrEqual((uint)0x00000000, 1)
            );
            Assert.True(
                ComparisonOperatorsHelper<uint, uint>.op_LessThanOrEqual((uint)0x00000001, 1)
            );
            Assert.False(
                ComparisonOperatorsHelper<uint, uint>.op_LessThanOrEqual((uint)0x7FFFFFFF, 1)
            );
            Assert.False(
                ComparisonOperatorsHelper<uint, uint>.op_LessThanOrEqual((uint)0x80000000, 1)
            );
            Assert.False(
                ComparisonOperatorsHelper<uint, uint>.op_LessThanOrEqual((uint)0xFFFFFFFF, 1)
            );
        }
        ...
        {
            Assert.False(
                ComparisonOperatorsHelper<uint, uint>.op_GreaterThanOrEqual((uint)0x00000000, 1)
            );
            Assert.True(
                ComparisonOperatorsHelper<uint, uint>.op_GreaterThanOrEqual((uint)0x00000001, 1)
            );
            Assert.True(
                ComparisonOperatorsHelper<uint, uint>.op_GreaterThanOrEqual((uint)0x7FFFFFFF, 1)
            );
            Assert.True(
                ComparisonOperatorsHelper<uint, uint>.op_GreaterThanOrEqual((uint)0x80000000, 1)
            );
            Assert.True(
                ComparisonOperatorsHelper<uint, uint>.op_GreaterThanOrEqual((uint)0xFFFFFFFF, 1)
            );
        }
        ...
        public static void CreateFromInt16Test()
        {
            ...
            Assert.Throws<OverflowException>(() =>
                NumberHelper<uint>.Create<short>(unchecked((short)0x8000)));
            Assert.Throws<OverflowException>(() =>
                NumberHelper<uint>.Create<short>(unchecked((short)0xFFFF)));
        }
        ...
        public static void CreateFromInt32Test()
        {
            ...
            Assert.Throws<OverflowException>(() =>
                NumberHelper<uint>.Create<int>(unchecked((int)0x80000000)));
            Assert.Throws<OverflowException>(() =>
                NumberHelper<uint>.Create<int>(unchecked((int)0xFFFFFFFF)));
        }
        ...
        public static void CreateFromInt64Test()
        {
            ...
            Assert.Throws<OverflowException>(() =>
                NumberHelper<uint>.Create<long>(0x7FFFFFFFFFFFFFFF));
            Assert.Throws<OverflowException>(() =>
                NumberHelper<uint>.Create<long>(unchecked((long)0x8000000000000000)));
            Assert.Throws<OverflowException>(() =>
                NumberHelper<uint>.Create<long>(unchecked((long)0xFFFFFFFFFFFFFFFF)));
        }
        ...
        public static void CreateFromIntPtrTest()
        {
            if (Environment.Is64BitProcess)
            {
                Assert.Equal(
                    (uint)0x00000000,
                    NumberHelper<uint>.Create<nint>(unchecked((nint)0x0000000000000000))
                );
                Assert.Equal(
                    (uint)0x00000001,
                    NumberHelper<uint>.Create<nint>(unchecked((nint)0x0000000000000001))
                );
                Assert.Throws<OverflowException>(() =>
                    NumberHelper<uint>.Create<nint>(unchecked((nint)0x7FFFFFFFFFFFFFFF)));
                Assert.Throws<OverflowException>(() =>
                    NumberHelper<uint>.Create<nint>(unchecked((nint)0x8000000000000000)));
                Assert.Throws<OverflowException>(() =>
                    NumberHelper<uint>.Create<nint>(unchecked((nint)0xFFFFFFFFFFFFFFFF)));
            }
            else
            {
                ...
                Assert.Throws<OverflowException>(() =>
                    NumberHelper<uint>.Create<nint>(unchecked((nint)0x80000000)));
                Assert.Throws<OverflowException>(() =>
                    NumberHelper<uint>.Create<nint>(unchecked((nint)0xFFFFFFFF)));
            }
        }
        ...
        public static void CreateFromSByteTest()
        {
            ...
            Assert.Throws<OverflowException>(() =>
                NumberHelper<uint>.Create<sbyte>(unchecked((sbyte)0x80)));
            Assert.Throws<OverflowException>(() =>
                NumberHelper<uint>.Create<sbyte>(unchecked((sbyte)0xFF)));
        }
        ...
        public static void CreateFromUInt64Test()
        {
            ...
            Assert.Throws<OverflowException>(() =>
                NumberHelper<uint>.Create<ulong>(0x7FFFFFFFFFFFFFFF));
            Assert.Throws<OverflowException>(() =>
                NumberHelper<uint>.Create<ulong>(0x8000000000000000));
            Assert.Throws<OverflowException>(() =>
                NumberHelper<uint>.Create<ulong>(0xFFFFFFFFFFFFFFFF));
        }
        ...
        public static void CreateFromUIntPtrTest()
        {
            if (Environment.Is64BitProcess)
            {
                Assert.Equal(
                    (uint)0x00000000,
                    NumberHelper<uint>.Create<nuint>(unchecked((nuint)0x0000000000000000))
                );
                Assert.Equal(
                    (uint)0x00000001,
                    NumberHelper<uint>.Create<nuint>(unchecked((nuint)0x0000000000000001))
                );
                Assert.Throws<OverflowException>(() =>
                    NumberHelper<uint>.Create<nuint>(unchecked((nuint)0x7FFFFFFFFFFFFFFF)));
                Assert.Throws<OverflowException>(() =>
                    NumberHelper<uint>.Create<nuint>(unchecked((nuint)0x8000000000000000)));
                Assert.Throws<OverflowException>(() =>
                    NumberHelper<uint>.Create<nuint>(unchecked((nuint)0xFFFFFFFFFFFFFFFF)));
            }
            else
            {
        ...
        public static void CreateSaturatingFromInt16Test()
        {
            ...
            Assert.Equal(
                (uint)0x00000000,
                NumberHelper<uint>.CreateSaturating<short>(unchecked((short)0x8000))
            );
            Assert.Equal(
                (uint)0x00000000,
                NumberHelper<uint>.CreateSaturating<short>(unchecked((short)0xFFFF))
            );
        }
        ...
        public static void CreateSaturatingFromInt32Test()
        {
            ...
            Assert.Equal(
                (uint)0x00000000,
                NumberHelper<uint>.CreateSaturating<int>(unchecked((int)0x80000000))
            );
            Assert.Equal(
                (uint)0x00000000,
                NumberHelper<uint>.CreateSaturating<int>(unchecked((int)0xFFFFFFFF))
            );
        }
        ...
        public static void CreateSaturatingFromInt64Test()
        {
            Assert.Equal(
                (uint)0x00000000,
                NumberHelper<uint>.CreateSaturating<long>(0x0000000000000000)
            );
            Assert.Equal(
                (uint)0x00000001,
                NumberHelper<uint>.CreateSaturating<long>(0x0000000000000001)
            );
            Assert.Equal(
                (uint)0xFFFFFFFF,
                NumberHelper<uint>.CreateSaturating<long>(0x7FFFFFFFFFFFFFFF)
            );
            Assert.Equal(
                (uint)0x00000000,
                NumberHelper<uint>.CreateSaturating<long>(unchecked((long)0x8000000000000000))
            );
            Assert.Equal(
                (uint)0x00000000,
                NumberHelper<uint>.CreateSaturating<long>(unchecked((long)0xFFFFFFFFFFFFFFFF))
            );
        }
        ...
        public static void CreateSaturatingFromIntPtrTest()
        {
            if (Environment.Is64BitProcess)
            {
                Assert.Equal(
                    (uint)0x00000000,
                    NumberHelper<uint>.CreateSaturating<nint>(unchecked((nint)0x0000000000000000))
                );
                Assert.Equal(
                    (uint)0x00000001,
                    NumberHelper<uint>.CreateSaturating<nint>(unchecked((nint)0x0000000000000001))
                );
                Assert.Equal(
                    (uint)0xFFFFFFFF,
                    NumberHelper<uint>.CreateSaturating<nint>(unchecked((nint)0x7FFFFFFFFFFFFFFF))
                );
                Assert.Equal(
                    (uint)0x00000000,
                    NumberHelper<uint>.CreateSaturating<nint>(unchecked((nint)0x8000000000000000))
                );
                Assert.Equal(
                    (uint)0x00000000,
                    NumberHelper<uint>.CreateSaturating<nint>(unchecked((nint)0xFFFFFFFFFFFFFFFF))
                );
            }
            else
            {
                Assert.Equal(
                    (uint)0x00000000,
                    NumberHelper<uint>.CreateSaturating<nint>((nint)0x00000000)
                );
                Assert.Equal(
                    (uint)0x00000001,
                    NumberHelper<uint>.CreateSaturating<nint>((nint)0x00000001)
                );
                Assert.Equal(
                    (uint)0x7FFFFFFF,
                    NumberHelper<uint>.CreateSaturating<nint>((nint)0x7FFFFFFF)
                );
                Assert.Equal(
                    (uint)0x00000000,
                    NumberHelper<uint>.CreateSaturating<nint>(unchecked((nint)0x80000000))
                );
                Assert.Equal(
                    (uint)0x00000000,
                    NumberHelper<uint>.CreateSaturating<nint>(unchecked((nint)0xFFFFFFFF))
                );
            }
        }
        ...
        public static void CreateSaturatingFromSByteTest()
        {
            ...
            Assert.Equal(
                (uint)0x00000000,
                NumberHelper<uint>.CreateSaturating<sbyte>(unchecked((sbyte)0x80))
            );
            Assert.Equal(
                (uint)0x00000000,
                NumberHelper<uint>.CreateSaturating<sbyte>(unchecked((sbyte)0xFF))
            );
        }
        ...
        public static void CreateSaturatingFromUInt64Test()
        {
            Assert.Equal(
                (uint)0x00000000,
                NumberHelper<uint>.CreateSaturating<ulong>(0x0000000000000000)
            );
            Assert.Equal(
                (uint)0x00000001,
                NumberHelper<uint>.CreateSaturating<ulong>(0x0000000000000001)
            );
            Assert.Equal(
                (uint)0xFFFFFFFF,
                NumberHelper<uint>.CreateSaturating<ulong>(0x7FFFFFFFFFFFFFFF)
            );
            Assert.Equal(
                (uint)0xFFFFFFFF,
                NumberHelper<uint>.CreateSaturating<ulong>(0x8000000000000000)
            );
            Assert.Equal(
                (uint)0xFFFFFFFF,
                NumberHelper<uint>.CreateSaturating<ulong>(0xFFFFFFFFFFFFFFFF)
            );
        }
        ...
        public static void CreateSaturatingFromUIntPtrTest()
        {
            if (Environment.Is64BitProcess)
            {
                Assert.Equal(
                    (uint)0x00000000,
                    NumberHelper<uint>.CreateSaturating<nuint>(unchecked((nuint)0x0000000000000000))
                );
                Assert.Equal(
                    (uint)0x00000001,
                    NumberHelper<uint>.CreateSaturating<nuint>(unchecked((nuint)0x0000000000000001))
                );
                Assert.Equal(
                    (uint)0xFFFFFFFF,
                    NumberHelper<uint>.CreateSaturating<nuint>(unchecked((nuint)0x7FFFFFFFFFFFFFFF))
                );
                Assert.Equal(
                    (uint)0xFFFFFFFF,
                    NumberHelper<uint>.CreateSaturating<nuint>(unchecked((nuint)0x8000000000000000))
                );
                Assert.Equal(
                    (uint)0xFFFFFFFF,
                    NumberHelper<uint>.CreateSaturating<nuint>(unchecked((nuint)0xFFFFFFFFFFFFFFFF))
                );
            }
            else
            {
                Assert.Equal(
                    (uint)0x00000000,
                    NumberHelper<uint>.CreateSaturating<nuint>((nuint)0x00000000)
                );
                Assert.Equal(
                    (uint)0x00000001,
                    NumberHelper<uint>.CreateSaturating<nuint>((nuint)0x00000001)
                );
                Assert.Equal(
                    (uint)0x7FFFFFFF,
                    NumberHelper<uint>.CreateSaturating<nuint>((nuint)0x7FFFFFFF)
                );
                Assert.Equal(
                    (uint)0x80000000,
                    NumberHelper<uint>.CreateSaturating<nuint>((nuint)0x80000000)
                );
                Assert.Equal(
                    (uint)0xFFFFFFFF,
                    NumberHelper<uint>.CreateSaturating<nuint>((nuint)0xFFFFFFFF)
                );
            }
        }
        ...
        public static void CreateTruncatingFromInt16Test()
        {
            ...
            Assert.Equal(
                (uint)0xFFFF8000,
                NumberHelper<uint>.CreateTruncating<short>(unchecked((short)0x8000))
            );
            Assert.Equal(
                (uint)0xFFFFFFFF,
                NumberHelper<uint>.CreateTruncating<short>(unchecked((short)0xFFFF))
            );
        }
        ...
        public static void CreateTruncatingFromInt32Test()
        {
            ...
            Assert.Equal(
                (uint)0x80000000,
                NumberHelper<uint>.CreateTruncating<int>(unchecked((int)0x80000000))
            );
            Assert.Equal(
                (uint)0xFFFFFFFF,
                NumberHelper<uint>.CreateTruncating<int>(unchecked((int)0xFFFFFFFF))
            );
        }
        ...
        public static void CreateTruncatingFromInt64Test()
        {
            Assert.Equal(
                (uint)0x00000000,
                NumberHelper<uint>.CreateTruncating<long>(0x0000000000000000)
            );
            Assert.Equal(
                (uint)0x00000001,
                NumberHelper<uint>.CreateTruncating<long>(0x0000000000000001)
            );
            Assert.Equal(
                (uint)0xFFFFFFFF,
                NumberHelper<uint>.CreateTruncating<long>(0x7FFFFFFFFFFFFFFF)
            );
            Assert.Equal(
                (uint)0x00000000,
                NumberHelper<uint>.CreateTruncating<long>(unchecked((long)0x8000000000000000))
            );
            Assert.Equal(
                (uint)0xFFFFFFFF,
                NumberHelper<uint>.CreateTruncating<long>(unchecked((long)0xFFFFFFFFFFFFFFFF))
            );
        }
        ...
        public static void CreateTruncatingFromIntPtrTest()
        {
            if (Environment.Is64BitProcess)
            {
                Assert.Equal(
                    (uint)0x00000000,
                    NumberHelper<uint>.CreateTruncating<nint>(unchecked((nint)0x0000000000000000))
                );
                Assert.Equal(
                    (uint)0x00000001,
                    NumberHelper<uint>.CreateTruncating<nint>(unchecked((nint)0x0000000000000001))
                );
                Assert.Equal(
                    (uint)0xFFFFFFFF,
                    NumberHelper<uint>.CreateTruncating<nint>(unchecked((nint)0x7FFFFFFFFFFFFFFF))
                );
                Assert.Equal(
                    (uint)0x00000000,
                    NumberHelper<uint>.CreateTruncating<nint>(unchecked((nint)0x8000000000000000))
                );
                Assert.Equal(
                    (uint)0xFFFFFFFF,
                    NumberHelper<uint>.CreateTruncating<nint>(unchecked((nint)0xFFFFFFFFFFFFFFFF))
                );
            }
            else
            {
                Assert.Equal(
                    (uint)0x00000000,
                    NumberHelper<uint>.CreateTruncating<nint>((nint)0x00000000)
                );
                Assert.Equal(
                    (uint)0x00000001,
                    NumberHelper<uint>.CreateTruncating<nint>((nint)0x00000001)
                );
                Assert.Equal(
                    (uint)0x7FFFFFFF,
                    NumberHelper<uint>.CreateTruncating<nint>((nint)0x7FFFFFFF)
                );
                Assert.Equal(
                    (uint)0x80000000,
                    NumberHelper<uint>.CreateTruncating<nint>(unchecked((nint)0x80000000))
                );
                Assert.Equal(
                    (uint)0xFFFFFFFF,
                    NumberHelper<uint>.CreateTruncating<nint>(unchecked((nint)0xFFFFFFFF))
                );
            }
        }
        ...
        public static void CreateTruncatingFromSByteTest()
        {
            ...
            Assert.Equal(
                (uint)0xFFFFFF80,
                NumberHelper<uint>.CreateTruncating<sbyte>(unchecked((sbyte)0x80))
            );
            Assert.Equal(
                (uint)0xFFFFFFFF,
                NumberHelper<uint>.CreateTruncating<sbyte>(unchecked((sbyte)0xFF))
            );
        }
        ...
        public static void CreateTruncatingFromUInt64Test()
        {
            Assert.Equal(
                (uint)0x00000000,
                NumberHelper<uint>.CreateTruncating<ulong>(0x0000000000000000)
            );
            Assert.Equal(
                (uint)0x00000001,
                NumberHelper<uint>.CreateTruncating<ulong>(0x0000000000000001)
            );
            Assert.Equal(
                (uint)0xFFFFFFFF,
                NumberHelper<uint>.CreateTruncating<ulong>(0x7FFFFFFFFFFFFFFF)
            );
            Assert.Equal(
                (uint)0x00000000,
                NumberHelper<uint>.CreateTruncating<ulong>(0x8000000000000000)
            );
            Assert.Equal(
                (uint)0xFFFFFFFF,
                NumberHelper<uint>.CreateTruncating<ulong>(0xFFFFFFFFFFFFFFFF)
            );
        }
        ...
        public static void CreateTruncatingFromUIntPtrTest()
        {
            if (Environment.Is64BitProcess)
            {
                Assert.Equal(
                    (uint)0x00000000,
                    NumberHelper<uint>.CreateTruncating<nuint>(unchecked((nuint)0x0000000000000000))
                );
                Assert.Equal(
                    (uint)0x00000001,
                    NumberHelper<uint>.CreateTruncating<nuint>(unchecked((nuint)0x0000000000000001))
                );
                Assert.Equal(
                    (uint)0xFFFFFFFF,
                    NumberHelper<uint>.CreateTruncating<nuint>(unchecked((nuint)0x7FFFFFFFFFFFFFFF))
                );
                Assert.Equal(
                    (uint)0x00000000,
                    NumberHelper<uint>.CreateTruncating<nuint>(unchecked((nuint)0x8000000000000000))
                );
                Assert.Equal(
                    (uint)0xFFFFFFFF,
                    NumberHelper<uint>.CreateTruncating<nuint>(unchecked((nuint)0xFFFFFFFFFFFFFFFF))
                );
            }
            else
            {
                Assert.Equal(
                    (uint)0x00000000,
                    NumberHelper<uint>.CreateTruncating<nuint>((nuint)0x00000000)
                );
                Assert.Equal(
                    (uint)0x00000001,
                    NumberHelper<uint>.CreateTruncating<nuint>((nuint)0x00000001)
                );
                Assert.Equal(
                    (uint)0x7FFFFFFF,
                    NumberHelper<uint>.CreateTruncating<nuint>((nuint)0x7FFFFFFF)
                );
                Assert.Equal(
                    (uint)0x80000000,
                    NumberHelper<uint>.CreateTruncating<nuint>((nuint)0x80000000)
                );
                Assert.Equal(
                    (uint)0xFFFFFFFF,
                    NumberHelper<uint>.CreateTruncating<nuint>((nuint)0xFFFFFFFF)
                );
            }
        }
        ...
        public static void DivRemTest()
        {
            Assert.Equal(
                ...
                NumberHelper<uint>.DivRem((uint)0x00000000, 2)
            );
            Assert.Equal(
                ((uint)0x00000000, (uint)0x00000001),
                NumberHelper<uint>.DivRem((uint)0x00000001, 2)
            );
            Assert.Equal(
                ((uint)0x3FFFFFFF, (uint)0x00000001),
                NumberHelper<uint>.DivRem((uint)0x7FFFFFFF, 2)
            );
            Assert.Equal(
                ((uint)0x40000000, (uint)0x00000000),
                NumberHelper<uint>.DivRem((uint)0x80000000, 2)
            );
            Assert.Equal(
                ((uint)0x7FFFFFFF, (uint)0x00000001),
                NumberHelper<uint>.DivRem((uint)0xFFFFFFFF, 2)
            );
        }
        ...
        public static void TryCreateFromInt64Test()
        {
            ...
            Assert.False(
                NumberHelper<uint>.TryCreate<long>(unchecked((long)0x8000000000000000), out result)
            );
            Assert.Equal((uint)0x00000000, result);

            Assert.False(
                NumberHelper<uint>.TryCreate<long>(unchecked((long)0xFFFFFFFFFFFFFFFF), out result)
            );
            Assert.Equal((uint)0x00000000, result);
        }
        ...
        public static void TryCreateFromIntPtrTest()
        {
            ...
            {
                Assert.True(
                    NumberHelper<uint>.TryCreate<nint>(
            ...
            else
            {
                ...
                Assert.False(
                    NumberHelper<uint>.TryCreate<nint>(unchecked((nint)0x80000000), out result)
                );
                Assert.Equal((uint)0x00000000, result);

                Assert.False(
                    NumberHelper<uint>.TryCreate<nint>(unchecked((nint)0xFFFFFFFF), out result)
                );
                Assert.Equal((uint)0x00000000, result);
            }
        }
        ...
        public static void TryCreateFromUIntPtrTest()
        {
            ...
            {
                Assert.True(
                    NumberHelper<uint>.TryCreate<nuint>(
            ...
            else
            {
                ...
                Assert.True(
                    NumberHelper<uint>.TryCreate<nuint>(unchecked((nuint)0x80000000), out result)
                );
                Assert.Equal((uint)0x80000000, result);

                Assert.True(
                    NumberHelper<uint>.TryCreate<nuint>(unchecked((nuint)0xFFFFFFFF), out result)
                );
                Assert.Equal((uint)0xFFFFFFFF, result);
            }
        }
        ...
        public static void op_LeftShiftTest()
        {
            Assert.Equal(
                (uint)0x00000000,
                ShiftOperatorsHelper<uint, uint>.op_LeftShift((uint)0x00000000, 1)
            );
            Assert.Equal(
                (uint)0x00000002,
                ShiftOperatorsHelper<uint, uint>.op_LeftShift((uint)0x00000001, 1)
            );
            Assert.Equal(
                (uint)0xFFFFFFFE,
                ShiftOperatorsHelper<uint, uint>.op_LeftShift((uint)0x7FFFFFFF, 1)
            );
            Assert.Equal(
                (uint)0x00000000,
                ShiftOperatorsHelper<uint, uint>.op_LeftShift((uint)0x80000000, 1)
            );
            Assert.Equal(
                (uint)0xFFFFFFFE,
                ShiftOperatorsHelper<uint, uint>.op_LeftShift((uint)0xFFFFFFFF, 1)
            );
        }
        ...
        public static void op_RightShiftTest()
        {
            Assert.Equal(
                (uint)0x00000000,
                ShiftOperatorsHelper<uint, uint>.op_RightShift((uint)0x00000000, 1)
            );
            Assert.Equal(
                (uint)0x00000000,
                ShiftOperatorsHelper<uint, uint>.op_RightShift((uint)0x00000001, 1)
            );
            Assert.Equal(
                (uint)0x3FFFFFFF,
                ShiftOperatorsHelper<uint, uint>.op_RightShift((uint)0x7FFFFFFF, 1)
            );
            Assert.Equal(
                (uint)0x40000000,
                ShiftOperatorsHelper<uint, uint>.op_RightShift((uint)0x80000000, 1)
            );
            Assert.Equal(
                (uint)0x7FFFFFFF,
                ShiftOperatorsHelper<uint, uint>.op_RightShift((uint)0xFFFFFFFF, 1)
            );
        }
        ...
        )
        {
            ...
            if (provider is null)
            {
                ...
                Assert.True(
                    NumberHelper<uint>.TryParse(value, style, new NumberFormatInfo(), out result)
                );
                Assert.Equal(expected, result);
                Assert.Equal(
                    expected,
                    NumberHelper<uint>.Parse(value, style, new NumberFormatInfo())
                );
            }
        ...
        )
        {
            ...
            if (provider is null)
            {
                Assert.Throws(
                    exceptionType,
                    () => NumberHelper<uint>.Parse(value, style, provider)
                );
        ...
        )
        {
            ...
            {
                Assert.True(
                    SpanParseableHelper<uint>.TryParse(
            ...
            Assert.Equal(
                expected,
                NumberHelper<uint>.Parse(value.AsSpan(offset, count), style, provider)
            );

            Assert.True(
                NumberHelper<uint>.TryParse(
                    value.AsSpan(offset, count),
                    style,
                    provider,
                    out result
        ...
        )
        {
            ...
            {
                Assert.False(
                    SpanParseableHelper<uint>.TryParse(value.AsSpan(), provider, out result)
                );
                Assert.Equal(default(uint), result);
            }
            ...
            Assert.Throws(
                exceptionType,
                () => NumberHelper<uint>.Parse(value.AsSpan(), style, provider)
            );
