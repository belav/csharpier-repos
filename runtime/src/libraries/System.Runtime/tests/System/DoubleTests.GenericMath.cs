    ...
    public class DoubleTests_GenericMath
    {
        ...
        public static void op_AdditionTest()
        {
            AssertBitwiseEqual(
                ...
                AdditionOperatorsHelper<double, double, double>.op_Addition(
                    double.NegativeInfinity,
                    1.0
                )
            );
            AssertBitwiseEqual(
                double.MinValue,
                AdditionOperatorsHelper<double, double, double>.op_Addition(double.MinValue, 1.0)
            );
            AssertBitwiseEqual(
                0.0,
                AdditionOperatorsHelper<double, double, double>.op_Addition(-1.0, 1.0)
            );
            AssertBitwiseEqual(
                1.0,
                AdditionOperatorsHelper<double, double, double>.op_Addition(-MinNormal, 1.0)
            );
            AssertBitwiseEqual(
                1.0,
                AdditionOperatorsHelper<double, double, double>.op_Addition(-MaxSubnormal, 1.0)
            );
            AssertBitwiseEqual(
                1.0,
                AdditionOperatorsHelper<double, double, double>.op_Addition(-double.Epsilon, 1.0)
            );
            AssertBitwiseEqual(
                1.0,
                AdditionOperatorsHelper<double, double, double>.op_Addition(-0.0, 1.0)
            );
            AssertBitwiseEqual(
                double.NaN,
                AdditionOperatorsHelper<double, double, double>.op_Addition(double.NaN, 1.0)
            );
            AssertBitwiseEqual(
                1.0,
                AdditionOperatorsHelper<double, double, double>.op_Addition(0.0, 1.0)
            ...
            AssertBitwiseEqual(
                double.MaxValue,
                AdditionOperatorsHelper<double, double, double>.op_Addition(double.MaxValue, 1.0)
            );
            AssertBitwiseEqual(
        ...
        public static void op_CheckedAdditionTest()
        {
            AssertBitwiseEqual(
                double.NegativeInfinity,
                AdditionOperatorsHelper<double, double, double>.op_CheckedAddition(
                    double.NegativeInfinity,
                    1.0
                )
            );
            ...
            AssertBitwiseEqual(
                0.0,
                AdditionOperatorsHelper<double, double, double>.op_CheckedAddition(-1.0, 1.0)
            );
            AssertBitwiseEqual(
                1.0,
                AdditionOperatorsHelper<double, double, double>.op_CheckedAddition(-MinNormal, 1.0)
            );
            AssertBitwiseEqual(
                1.0,
                AdditionOperatorsHelper<double, double, double>.op_CheckedAddition(
            ...
            AssertBitwiseEqual(
                1.0,
                AdditionOperatorsHelper<double, double, double>.op_CheckedAddition(-0.0, 1.0)
            );
            AssertBitwiseEqual(
                double.NaN,
                AdditionOperatorsHelper<double, double, double>.op_CheckedAddition(double.NaN, 1.0)
            );
            AssertBitwiseEqual(
                1.0,
                AdditionOperatorsHelper<double, double, double>.op_CheckedAddition(0.0, 1.0)
        ...
        public static void AllBitsSetTest()
        {
            Assert.Equal(
                ...
                BitConverter.DoubleToUInt64Bits(BinaryNumberHelper<double>.AllBitsSet)
            );
            Assert.Equal(
                0UL,
                ~BitConverter.DoubleToUInt64Bits(BinaryNumberHelper<double>.AllBitsSet)
        ...
        public static void Log2Test()
        {
            AssertBitwiseEqual(
                double.NaN,
                BinaryNumberHelper<double>.Log2(double.NegativeInfinity)
            );
            ...
            AssertBitwiseEqual(
                double.PositiveInfinity,
                BinaryNumberHelper<double>.Log2(double.PositiveInfinity)
            );
        }
        ...
        {
            Assert.False(
                ComparisonOperatorsHelper<double, double, bool>.op_GreaterThan(
                    double.NegativeInfinity,
                    1.0
                )
            );
            Assert.False(
                ComparisonOperatorsHelper<double, double, bool>.op_GreaterThan(double.MinValue, 1.0)
            );
            Assert.False(ComparisonOperatorsHelper<double, double, bool>.op_GreaterThan(-1.0, 1.0));
            Assert.False(
                ComparisonOperatorsHelper<double, double, bool>.op_GreaterThan(-MinNormal, 1.0)
            );
            Assert.False(
                ComparisonOperatorsHelper<double, double, bool>.op_GreaterThan(-MaxSubnormal, 1.0)
            );
            Assert.False(
                ComparisonOperatorsHelper<double, double, bool>.op_GreaterThan(-double.Epsilon, 1.0)
            );
            Assert.False(ComparisonOperatorsHelper<double, double, bool>.op_GreaterThan(-0.0, 1.0));
            Assert.False(
                ComparisonOperatorsHelper<double, double, bool>.op_GreaterThan(double.NaN, 1.0)
            );
            Assert.False(ComparisonOperatorsHelper<double, double, bool>.op_GreaterThan(0.0, 1.0));
            Assert.False(
                ComparisonOperatorsHelper<double, double, bool>.op_GreaterThan(double.Epsilon, 1.0)
            ...
            Assert.False(ComparisonOperatorsHelper<double, double, bool>.op_GreaterThan(1.0, 1.0));
            Assert.True(
                ComparisonOperatorsHelper<double, double, bool>.op_GreaterThan(double.MaxValue, 1.0)
            );
            Assert.True(
                ComparisonOperatorsHelper<double, double, bool>.op_GreaterThan(
                    double.PositiveInfinity,
        ...
        {
            Assert.False(
                ComparisonOperatorsHelper<double, double, bool>.op_GreaterThanOrEqual(
                    double.NegativeInfinity,
                    1.0
                )
            );
            ...
            Assert.False(
                ComparisonOperatorsHelper<double, double, bool>.op_GreaterThanOrEqual(-1.0, 1.0)
            );
            Assert.False(
                ComparisonOperatorsHelper<double, double, bool>.op_GreaterThanOrEqual(
                    -MinNormal,
            ...
            Assert.False(
                ComparisonOperatorsHelper<double, double, bool>.op_GreaterThanOrEqual(-0.0, 1.0)
            );
            Assert.False(
                ComparisonOperatorsHelper<double, double, bool>.op_GreaterThanOrEqual(
                    double.NaN,
        ...
        {
            Assert.True(
                ComparisonOperatorsHelper<double, double, bool>.op_LessThan(
                    double.NegativeInfinity,
                    1.0
                )
            );
            Assert.True(
                ComparisonOperatorsHelper<double, double, bool>.op_LessThan(double.MinValue, 1.0)
            );
            Assert.True(ComparisonOperatorsHelper<double, double, bool>.op_LessThan(-1.0, 1.0));
            Assert.True(
                ComparisonOperatorsHelper<double, double, bool>.op_LessThan(-MinNormal, 1.0)
            );
            Assert.True(
                ComparisonOperatorsHelper<double, double, bool>.op_LessThan(-MaxSubnormal, 1.0)
            );
            Assert.True(
                ComparisonOperatorsHelper<double, double, bool>.op_LessThan(-double.Epsilon, 1.0)
            );
            Assert.True(ComparisonOperatorsHelper<double, double, bool>.op_LessThan(-0.0, 1.0));
            Assert.False(
                ComparisonOperatorsHelper<double, double, bool>.op_LessThan(double.NaN, 1.0)
            );
            Assert.True(ComparisonOperatorsHelper<double, double, bool>.op_LessThan(0.0, 1.0));
            Assert.True(
                ComparisonOperatorsHelper<double, double, bool>.op_LessThan(double.Epsilon, 1.0)
            ...
            Assert.False(
                ComparisonOperatorsHelper<double, double, bool>.op_LessThan(double.MaxValue, 1.0)
            );
            Assert.False(
                ComparisonOperatorsHelper<double, double, bool>.op_LessThan(
                    double.PositiveInfinity,
        ...
        {
            Assert.True(
                ComparisonOperatorsHelper<double, double, bool>.op_LessThanOrEqual(
                    double.NegativeInfinity,
                    1.0
                )
            );
            ...
            Assert.True(
                ComparisonOperatorsHelper<double, double, bool>.op_LessThanOrEqual(-1.0, 1.0)
            );
            Assert.True(
                ComparisonOperatorsHelper<double, double, bool>.op_LessThanOrEqual(-MinNormal, 1.0)
            );
            Assert.True(
                ComparisonOperatorsHelper<double, double, bool>.op_LessThanOrEqual(
                    -MaxSubnormal,
            ...
            Assert.True(
                ComparisonOperatorsHelper<double, double, bool>.op_LessThanOrEqual(-0.0, 1.0)
            );
            Assert.False(
                ComparisonOperatorsHelper<double, double, bool>.op_LessThanOrEqual(double.NaN, 1.0)
            );
            Assert.True(
                ComparisonOperatorsHelper<double, double, bool>.op_LessThanOrEqual(0.0, 1.0)
            );
        ...
        public static void op_DecrementTest()
        {
            AssertBitwiseEqual(
                double.NegativeInfinity,
                DecrementOperatorsHelper<double>.op_Decrement(double.NegativeInfinity)
            );
            AssertBitwiseEqual(
                double.MinValue,
                DecrementOperatorsHelper<double>.op_Decrement(double.MinValue)
            );
            ...
            AssertBitwiseEqual(
                -1.0,
                DecrementOperatorsHelper<double>.op_Decrement(-double.Epsilon)
            );
            AssertBitwiseEqual(-1.0, DecrementOperatorsHelper<double>.op_Decrement(-0.0));
            AssertBitwiseEqual(
                double.NaN,
                DecrementOperatorsHelper<double>.op_Decrement(double.NaN)
            );
            AssertBitwiseEqual(-1.0, DecrementOperatorsHelper<double>.op_Decrement(0.0));
            ...
            AssertBitwiseEqual(
                double.MaxValue,
                DecrementOperatorsHelper<double>.op_Decrement(double.MaxValue)
            );
            AssertBitwiseEqual(
                double.PositiveInfinity,
                DecrementOperatorsHelper<double>.op_Decrement(double.PositiveInfinity)
            );
        }
        ...
        public static void op_CheckedDecrementTest()
        {
            AssertBitwiseEqual(
                double.NegativeInfinity,
                DecrementOperatorsHelper<double>.op_CheckedDecrement(double.NegativeInfinity)
            );
            AssertBitwiseEqual(
                double.MinValue,
                DecrementOperatorsHelper<double>.op_CheckedDecrement(double.MinValue)
            );
            AssertBitwiseEqual(-2.0, DecrementOperatorsHelper<double>.op_CheckedDecrement(-1.0));
            AssertBitwiseEqual(
                -1.0,
                DecrementOperatorsHelper<double>.op_CheckedDecrement(-MinNormal)
            );
            AssertBitwiseEqual(
                -1.0,
                DecrementOperatorsHelper<double>.op_CheckedDecrement(-MaxSubnormal)
            );
            AssertBitwiseEqual(
                -1.0,
                DecrementOperatorsHelper<double>.op_CheckedDecrement(-double.Epsilon)
            );
            AssertBitwiseEqual(-1.0, DecrementOperatorsHelper<double>.op_CheckedDecrement(-0.0));
            AssertBitwiseEqual(
                double.NaN,
                DecrementOperatorsHelper<double>.op_CheckedDecrement(double.NaN)
            );
            AssertBitwiseEqual(-1.0, DecrementOperatorsHelper<double>.op_CheckedDecrement(0.0));
            AssertBitwiseEqual(
                -1.0,
            ...
            AssertBitwiseEqual(
                double.MaxValue,
                DecrementOperatorsHelper<double>.op_CheckedDecrement(double.MaxValue)
            );
            AssertBitwiseEqual(
                double.PositiveInfinity,
                DecrementOperatorsHelper<double>.op_CheckedDecrement(double.PositiveInfinity)
            );
        }
        ...
        public static void op_DivisionTest()
        {
            AssertBitwiseEqual(
                double.NegativeInfinity,
                DivisionOperatorsHelper<double, double, double>.op_Division(
                    double.NegativeInfinity,
                    2.0
                )
            );
            AssertBitwiseEqual(
                ...
                DivisionOperatorsHelper<double, double, double>.op_Division(double.MinValue, 2.0)
            );
            AssertBitwiseEqual(
                -0.5,
                DivisionOperatorsHelper<double, double, double>.op_Division(-1.0, 2.0)
            );
            AssertBitwiseEqual(
                -1.1125369292536007E-308,
                DivisionOperatorsHelper<double, double, double>.op_Division(-MinNormal, 2.0)
            );
            AssertBitwiseEqual(
                -1.1125369292536007E-308,
                DivisionOperatorsHelper<double, double, double>.op_Division(-MaxSubnormal, 2.0)
            );
            AssertBitwiseEqual(
                -0.0,
                DivisionOperatorsHelper<double, double, double>.op_Division(-double.Epsilon, 2.0)
            );
            AssertBitwiseEqual(
                -0.0,
                DivisionOperatorsHelper<double, double, double>.op_Division(-0.0, 2.0)
            );
            AssertBitwiseEqual(
                double.NaN,
                DivisionOperatorsHelper<double, double, double>.op_Division(double.NaN, 2.0)
            );
            AssertBitwiseEqual(
                0.0,
                DivisionOperatorsHelper<double, double, double>.op_Division(0.0, 2.0)
            ...
            AssertBitwiseEqual(
                8.9884656743115785E+307,
                DivisionOperatorsHelper<double, double, double>.op_Division(double.MaxValue, 2.0)
            );
            AssertBitwiseEqual(
                double.PositiveInfinity,
                DivisionOperatorsHelper<double, double, double>.op_Division(
        ...
        public static void op_CheckedDivisionTest()
        {
            AssertBitwiseEqual(
                double.NegativeInfinity,
                DivisionOperatorsHelper<double, double, double>.op_CheckedDivision(
                    double.NegativeInfinity,
                    2.0
                )
            );
            ...
            AssertBitwiseEqual(
                -0.5,
                DivisionOperatorsHelper<double, double, double>.op_CheckedDivision(-1.0, 2.0)
            );
            AssertBitwiseEqual(
                -1.1125369292536007E-308,
                DivisionOperatorsHelper<double, double, double>.op_CheckedDivision(-MinNormal, 2.0)
            );
            AssertBitwiseEqual(
                -1.1125369292536007E-308,
                DivisionOperatorsHelper<double, double, double>.op_CheckedDivision(
            ...
            AssertBitwiseEqual(
                -0.0,
                DivisionOperatorsHelper<double, double, double>.op_CheckedDivision(-0.0, 2.0)
            );
            AssertBitwiseEqual(
                double.NaN,
                DivisionOperatorsHelper<double, double, double>.op_CheckedDivision(double.NaN, 2.0)
            );
            AssertBitwiseEqual(
                0.0,
                DivisionOperatorsHelper<double, double, double>.op_CheckedDivision(0.0, 2.0)
        ...
        {
            Assert.False(
                EqualityOperatorsHelper<double, double, bool>.op_Equality(
                    double.NegativeInfinity,
                    1.0
                )
            );
            Assert.False(
                EqualityOperatorsHelper<double, double, bool>.op_Equality(double.MinValue, 1.0)
            );
            Assert.False(EqualityOperatorsHelper<double, double, bool>.op_Equality(-1.0, 1.0));
            Assert.False(
                EqualityOperatorsHelper<double, double, bool>.op_Equality(-MinNormal, 1.0)
            );
            Assert.False(
                EqualityOperatorsHelper<double, double, bool>.op_Equality(-MaxSubnormal, 1.0)
            );
            Assert.False(
                EqualityOperatorsHelper<double, double, bool>.op_Equality(-double.Epsilon, 1.0)
            );
            Assert.False(EqualityOperatorsHelper<double, double, bool>.op_Equality(-0.0, 1.0));
            Assert.False(
                EqualityOperatorsHelper<double, double, bool>.op_Equality(double.NaN, 1.0)
            );
            Assert.False(EqualityOperatorsHelper<double, double, bool>.op_Equality(0.0, 1.0));
            Assert.False(
                EqualityOperatorsHelper<double, double, bool>.op_Equality(double.Epsilon, 1.0)
            ...
            Assert.False(
                EqualityOperatorsHelper<double, double, bool>.op_Equality(double.MaxValue, 1.0)
            );
            Assert.False(
                EqualityOperatorsHelper<double, double, bool>.op_Equality(
                    double.PositiveInfinity,
        ...
        {
            Assert.True(
                EqualityOperatorsHelper<double, double, bool>.op_Inequality(
                    double.NegativeInfinity,
                    1.0
                )
            );
            Assert.True(
                EqualityOperatorsHelper<double, double, bool>.op_Inequality(double.MinValue, 1.0)
            );
            Assert.True(EqualityOperatorsHelper<double, double, bool>.op_Inequality(-1.0, 1.0));
            Assert.True(
                EqualityOperatorsHelper<double, double, bool>.op_Inequality(-MinNormal, 1.0)
            );
            Assert.True(
                EqualityOperatorsHelper<double, double, bool>.op_Inequality(-MaxSubnormal, 1.0)
            );
            Assert.True(
                EqualityOperatorsHelper<double, double, bool>.op_Inequality(-double.Epsilon, 1.0)
            );
            Assert.True(EqualityOperatorsHelper<double, double, bool>.op_Inequality(-0.0, 1.0));
            Assert.True(
                EqualityOperatorsHelper<double, double, bool>.op_Inequality(double.NaN, 1.0)
            );
            Assert.True(EqualityOperatorsHelper<double, double, bool>.op_Inequality(0.0, 1.0));
            Assert.True(
                EqualityOperatorsHelper<double, double, bool>.op_Inequality(double.Epsilon, 1.0)
            ...
            Assert.True(
                EqualityOperatorsHelper<double, double, bool>.op_Inequality(double.MaxValue, 1.0)
            );
            Assert.True(
                EqualityOperatorsHelper<double, double, bool>.op_Inequality(
                    double.PositiveInfinity,
        ...
        public static void GetExponentByteCountTest()
        {
            Assert.Equal(
                2,
                FloatingPointHelper<double>.GetExponentByteCount(double.NegativeInfinity)
            );
            ...
            Assert.Equal(
                2,
                FloatingPointHelper<double>.GetExponentByteCount(double.PositiveInfinity)
            );
        }
        ...
        public static void GetExponentShortestBitLengthTest()
        {
            Assert.Equal(
                11,
                FloatingPointHelper<double>.GetExponentShortestBitLength(double.NegativeInfinity)
            );
            Assert.Equal(
                10,
                FloatingPointHelper<double>.GetExponentShortestBitLength(double.MinValue)
            );
            ...
            Assert.Equal(
                11,
                FloatingPointHelper<double>.GetExponentShortestBitLength(-MaxSubnormal)
            );
            Assert.Equal(
                11,
                FloatingPointHelper<double>.GetExponentShortestBitLength(-double.Epsilon)
            );
            ...
            Assert.Equal(
                10,
                FloatingPointHelper<double>.GetExponentShortestBitLength(double.MaxValue)
            );
            Assert.Equal(
                11,
                FloatingPointHelper<double>.GetExponentShortestBitLength(double.PositiveInfinity)
            );
        }
        ...
        public static void GetSignificandByteCountTest()
        {
            Assert.Equal(
                8,
                FloatingPointHelper<double>.GetSignificandByteCount(double.NegativeInfinity)
            );
            ...
            Assert.Equal(
                8,
                FloatingPointHelper<double>.GetSignificandByteCount(double.PositiveInfinity)
            );
        }
        ...
        public static void GetSignificandBitLengthTest()
        {
            Assert.Equal(
                53,
                FloatingPointHelper<double>.GetSignificandBitLength(double.NegativeInfinity)
            );
            ...
            Assert.Equal(
                53,
                FloatingPointHelper<double>.GetSignificandBitLength(double.PositiveInfinity)
            );
        }
        ...
        public static void TryWriteExponentBigEndianTest()
        {
            ...
            Assert.True(
                FloatingPointHelper<double>.TryWriteExponentBigEndian(
                    double.NegativeInfinity,
                    destination,
                    out bytesWritten
                )
        ...
        public static void TryWriteExponentLittleEndianTest()
        {
            ...
            Assert.True(
                FloatingPointHelper<double>.TryWriteExponentLittleEndian(
                    double.NegativeInfinity,
                    destination,
                    out bytesWritten
                )
        ...
        public static void TryWriteSignificandBigEndianTest()
        {
            ...
            Assert.True(
                FloatingPointHelper<double>.TryWriteSignificandBigEndian(
                    double.NegativeInfinity,
                    destination,
                    out bytesWritten
                )
        ...
        public static void TryWriteSignificandLittleEndianTest()
        {
            ...
            Assert.True(
                FloatingPointHelper<double>.TryWriteSignificandLittleEndian(
                    double.NegativeInfinity,
                    destination,
                    out bytesWritten
                )
        ...
        public static void op_IncrementTest()
        {
            AssertBitwiseEqual(
                double.NegativeInfinity,
                IncrementOperatorsHelper<double>.op_Increment(double.NegativeInfinity)
            );
            AssertBitwiseEqual(
                double.MinValue,
                IncrementOperatorsHelper<double>.op_Increment(double.MinValue)
            );
            ...
            AssertBitwiseEqual(
                double.NaN,
                IncrementOperatorsHelper<double>.op_Increment(double.NaN)
            );
            AssertBitwiseEqual(1.0, IncrementOperatorsHelper<double>.op_Increment(0.0));
            AssertBitwiseEqual(1.0, IncrementOperatorsHelper<double>.op_Increment(double.Epsilon));
            AssertBitwiseEqual(1.0, IncrementOperatorsHelper<double>.op_Increment(MaxSubnormal));
            ...
            AssertBitwiseEqual(
                double.MaxValue,
                IncrementOperatorsHelper<double>.op_Increment(double.MaxValue)
            );
            AssertBitwiseEqual(
                double.PositiveInfinity,
                IncrementOperatorsHelper<double>.op_Increment(double.PositiveInfinity)
            );
        }
        ...
        public static void op_CheckedIncrementTest()
        {
            AssertBitwiseEqual(
                double.NegativeInfinity,
                IncrementOperatorsHelper<double>.op_CheckedIncrement(double.NegativeInfinity)
            );
            AssertBitwiseEqual(
                double.MinValue,
                IncrementOperatorsHelper<double>.op_CheckedIncrement(double.MinValue)
            );
            AssertBitwiseEqual(0.0, IncrementOperatorsHelper<double>.op_CheckedIncrement(-1.0));
            AssertBitwiseEqual(
                1.0,
                IncrementOperatorsHelper<double>.op_CheckedIncrement(-MinNormal)
            );
            AssertBitwiseEqual(
                1.0,
                IncrementOperatorsHelper<double>.op_CheckedIncrement(-MaxSubnormal)
            );
            AssertBitwiseEqual(
                1.0,
                IncrementOperatorsHelper<double>.op_CheckedIncrement(-double.Epsilon)
            );
            AssertBitwiseEqual(1.0, IncrementOperatorsHelper<double>.op_CheckedIncrement(-0.0));
            AssertBitwiseEqual(
                double.NaN,
                IncrementOperatorsHelper<double>.op_CheckedIncrement(double.NaN)
            );
            AssertBitwiseEqual(1.0, IncrementOperatorsHelper<double>.op_CheckedIncrement(0.0));
            AssertBitwiseEqual(
                1.0,
            ...
            AssertBitwiseEqual(
                double.MaxValue,
                IncrementOperatorsHelper<double>.op_CheckedIncrement(double.MaxValue)
            );
            AssertBitwiseEqual(
                double.PositiveInfinity,
                IncrementOperatorsHelper<double>.op_CheckedIncrement(double.PositiveInfinity)
            );
        }
        ...
        public static void op_ModulusTest()
        {
            AssertBitwiseEqual(
                double.NaN,
                ModulusOperatorsHelper<double, double, double>.op_Modulus(
                    double.NegativeInfinity,
                    2.0
                )
            );
            AssertBitwiseEqual(
                -0.0,
                ModulusOperatorsHelper<double, double, double>.op_Modulus(double.MinValue, 2.0)
            );
            AssertBitwiseEqual(
                -1.0,
                ModulusOperatorsHelper<double, double, double>.op_Modulus(-1.0, 2.0)
            );
            AssertBitwiseEqual(
                -MinNormal,
                ModulusOperatorsHelper<double, double, double>.op_Modulus(-MinNormal, 2.0)
            );
            AssertBitwiseEqual(
                -MaxSubnormal,
                ModulusOperatorsHelper<double, double, double>.op_Modulus(-MaxSubnormal, 2.0)
            );
            AssertBitwiseEqual(
                -double.Epsilon,
                ModulusOperatorsHelper<double, double, double>.op_Modulus(-double.Epsilon, 2.0)
            );
            ;
            AssertBitwiseEqual(
                -0.0,
                ModulusOperatorsHelper<double, double, double>.op_Modulus(-0.0, 2.0)
            );
            AssertBitwiseEqual(
                double.NaN,
                ModulusOperatorsHelper<double, double, double>.op_Modulus(double.NaN, 2.0)
            );
            AssertBitwiseEqual(
                0.0,
                ModulusOperatorsHelper<double, double, double>.op_Modulus(0.0, 2.0)
            ...
            AssertBitwiseEqual(
                0.0,
                ModulusOperatorsHelper<double, double, double>.op_Modulus(double.MaxValue, 2.0)
            );
            AssertBitwiseEqual(
                double.NaN,
                ModulusOperatorsHelper<double, double, double>.op_Modulus(
        ...
        public static void MultiplicativeIdentityTest()
        {
            AssertBitwiseEqual(
                1.0,
                MultiplicativeIdentityHelper<double, double>.MultiplicativeIdentity
            );
        }
        ...
        public static void op_MultiplyTest()
        {
            AssertBitwiseEqual(
                double.NegativeInfinity,
                MultiplyOperatorsHelper<double, double, double>.op_Multiply(
                    double.NegativeInfinity,
                    2.0
                )
            );
            AssertBitwiseEqual(
                double.NegativeInfinity,
                MultiplyOperatorsHelper<double, double, double>.op_Multiply(double.MinValue, 2.0)
            );
            AssertBitwiseEqual(
                -2.0,
                MultiplyOperatorsHelper<double, double, double>.op_Multiply(-1.0, 2.0)
            );
            AssertBitwiseEqual(
                -4.4501477170144028E-308,
                MultiplyOperatorsHelper<double, double, double>.op_Multiply(-MinNormal, 2.0)
            );
            AssertBitwiseEqual(
                -4.4501477170144018E-308,
                MultiplyOperatorsHelper<double, double, double>.op_Multiply(-MaxSubnormal, 2.0)
            );
            AssertBitwiseEqual(
                -9.8813129168249309E-324,
                MultiplyOperatorsHelper<double, double, double>.op_Multiply(-double.Epsilon, 2.0)
            );
            AssertBitwiseEqual(
                -0.0,
                MultiplyOperatorsHelper<double, double, double>.op_Multiply(-0.0, 2.0)
            );
            AssertBitwiseEqual(
                double.NaN,
                MultiplyOperatorsHelper<double, double, double>.op_Multiply(double.NaN, 2.0)
            );
            AssertBitwiseEqual(
                0.0,
                MultiplyOperatorsHelper<double, double, double>.op_Multiply(0.0, 2.0)
            ...
            AssertBitwiseEqual(
                double.PositiveInfinity,
                MultiplyOperatorsHelper<double, double, double>.op_Multiply(double.MaxValue, 2.0)
            );
            AssertBitwiseEqual(
                double.PositiveInfinity,
                MultiplyOperatorsHelper<double, double, double>.op_Multiply(
        ...
        public static void op_CheckedMultiplyTest()
        {
            AssertBitwiseEqual(
                double.NegativeInfinity,
                MultiplyOperatorsHelper<double, double, double>.op_CheckedMultiply(
                    double.NegativeInfinity,
                    2.0
                )
            );
            ...
            AssertBitwiseEqual(
                -2.0,
                MultiplyOperatorsHelper<double, double, double>.op_CheckedMultiply(-1.0, 2.0)
            );
            AssertBitwiseEqual(
                -4.4501477170144028E-308,
                MultiplyOperatorsHelper<double, double, double>.op_CheckedMultiply(-MinNormal, 2.0)
            );
            AssertBitwiseEqual(
                -4.4501477170144018E-308,
                MultiplyOperatorsHelper<double, double, double>.op_CheckedMultiply(
            ...
            AssertBitwiseEqual(
                -0.0,
                MultiplyOperatorsHelper<double, double, double>.op_CheckedMultiply(-0.0, 2.0)
            );
            AssertBitwiseEqual(
                double.NaN,
                MultiplyOperatorsHelper<double, double, double>.op_CheckedMultiply(double.NaN, 2.0)
            );
            AssertBitwiseEqual(
                0.0,
                MultiplyOperatorsHelper<double, double, double>.op_CheckedMultiply(0.0, 2.0)
        ...
        public static void ClampTest()
        {
            ...
            AssertBitwiseEqual(
                63.0,
                NumberHelper<double>.Clamp(double.PositiveInfinity, 1.0, 63.0)
            );
        }
        ...
        public static void MaxTest()
        {
            ...
            AssertBitwiseEqual(
                double.PositiveInfinity,
                NumberHelper<double>.Max(double.PositiveInfinity, 1.0)
            );
        }
        ...
        public static void MaxNumberTest()
        {
            ...
            AssertBitwiseEqual(
                double.MaxValue,
                NumberHelper<double>.MaxNumber(double.MaxValue, 1.0)
            );
            AssertBitwiseEqual(
                double.PositiveInfinity,
                NumberHelper<double>.MaxNumber(double.PositiveInfinity, 1.0)
            );
        }
        ...
        public static void MinTest()
        {
            AssertBitwiseEqual(
                double.NegativeInfinity,
                NumberHelper<double>.Min(double.NegativeInfinity, 1.0)
            );
        ...
        public static void MinNumberTest()
        {
            AssertBitwiseEqual(
                double.NegativeInfinity,
                NumberHelper<double>.MinNumber(double.NegativeInfinity, 1.0)
            );
            AssertBitwiseEqual(
                double.MinValue,
                NumberHelper<double>.MinNumber(double.MinValue, 1.0)
            );
            ...
            AssertBitwiseEqual(
                -double.Epsilon,
                NumberHelper<double>.MinNumber(-double.Epsilon, 1.0)
            );
        ...
        public static void AbsTest()
        {
            AssertBitwiseEqual(
                double.PositiveInfinity,
                NumberBaseHelper<double>.Abs(double.NegativeInfinity)
            );
            ...
            AssertBitwiseEqual(
                double.PositiveInfinity,
                NumberBaseHelper<double>.Abs(double.PositiveInfinity)
            );
        }
        ...
        public static void CreateCheckedFromDecimalTest()
        {
            AssertBitwiseEqual(
                ...
                NumberBaseHelper<double>.CreateChecked<decimal>(decimal.MinValue)
            );
            ...
            AssertBitwiseEqual(
                +79228162514264337593543950335.0,
                NumberBaseHelper<double>.CreateChecked<decimal>(decimal.MaxValue)
            );
        }
        ...
        public static void CreateCheckedFromDoubleTest()
        {
            AssertBitwiseEqual(
                double.NegativeInfinity,
                NumberBaseHelper<double>.CreateChecked<double>(double.NegativeInfinity)
            );
            AssertBitwiseEqual(
                double.MinValue,
                NumberBaseHelper<double>.CreateChecked<double>(double.MinValue)
            );
            ...
            AssertBitwiseEqual(
                -MinNormal,
                NumberBaseHelper<double>.CreateChecked<double>(-MinNormal)
            );
            AssertBitwiseEqual(
                -MaxSubnormal,
                NumberBaseHelper<double>.CreateChecked<double>(-MaxSubnormal)
            );
            AssertBitwiseEqual(
                -double.Epsilon,
                NumberBaseHelper<double>.CreateChecked<double>(-double.Epsilon)
            );
            ...
            AssertBitwiseEqual(
                double.MaxValue,
                NumberBaseHelper<double>.CreateChecked<double>(double.MaxValue)
            );
            AssertBitwiseEqual(
                double.PositiveInfinity,
                NumberBaseHelper<double>.CreateChecked<double>(double.PositiveInfinity)
            );
        ...
        public static void CreateCheckedFromHalfTest()
        {
            AssertBitwiseEqual(
                double.NegativeInfinity,
                NumberBaseHelper<double>.CreateChecked<Half>(Half.NegativeInfinity)
            );

            AssertBitwiseEqual(
                -65504.0,
                NumberBaseHelper<double>.CreateChecked<Half>(Half.MinValue)
            );
            AssertBitwiseEqual(
                -1.0,
                NumberBaseHelper<double>.CreateChecked<Half>(Half.NegativeOne)
            );

            AssertBitwiseEqual(
                -6.103515625E-05,
                NumberBaseHelper<double>.CreateChecked<Half>(-HalfTests_GenericMath.MinNormal)
            );
            AssertBitwiseEqual(
                -6.097555160522461E-05,
                NumberBaseHelper<double>.CreateChecked<Half>(-HalfTests_GenericMath.MaxSubnormal)
            );
            AssertBitwiseEqual(
                -5.960464477539063E-08,
                NumberBaseHelper<double>.CreateChecked<Half>(-Half.Epsilon)
            );
            AssertBitwiseEqual(
                -0.0,
                NumberBaseHelper<double>.CreateChecked<Half>(Half.NegativeZero)
            );
            ...
            AssertBitwiseEqual(
                +65504.0,
                NumberBaseHelper<double>.CreateChecked<Half>(Half.MaxValue)
            );

            AssertBitwiseEqual(
                double.PositiveInfinity,
                NumberBaseHelper<double>.CreateChecked<Half>(Half.PositiveInfinity)
            );
        ...
        public static void CreateCheckedFromInt16Test()
        {
            ...
            AssertBitwiseEqual(
                -32768.0,
                NumberBaseHelper<double>.CreateChecked<short>(unchecked((short)0x8000))
            );
            AssertBitwiseEqual(
                -1.0,
                NumberBaseHelper<double>.CreateChecked<short>(unchecked((short)0xFFFF))
            );
        }
        ...
        public static void CreateCheckedFromInt32Test()
        {
            ...
            AssertBitwiseEqual(
                2147483647.0,
                NumberBaseHelper<double>.CreateChecked<int>(0x7FFFFFFF)
            );
            AssertBitwiseEqual(
                -2147483648.0,
                NumberBaseHelper<double>.CreateChecked<int>(unchecked((int)0x80000000))
            );
            AssertBitwiseEqual(
                -1.0,
                NumberBaseHelper<double>.CreateChecked<int>(unchecked((int)0xFFFFFFFF))
            );
        }
        ...
        public static void CreateCheckedFromInt64Test()
        {
            AssertBitwiseEqual(
                0.0,
                NumberBaseHelper<double>.CreateChecked<long>(0x0000000000000000)
            );
            AssertBitwiseEqual(
                1.0,
                NumberBaseHelper<double>.CreateChecked<long>(0x0000000000000001)
            );
            AssertBitwiseEqual(
                9223372036854775807.0,
                NumberBaseHelper<double>.CreateChecked<long>(0x7FFFFFFFFFFFFFFF)
            );
            AssertBitwiseEqual(
                -9223372036854775808.0,
                NumberBaseHelper<double>.CreateChecked<long>(
        ...
        public static void CreateCheckedFromInt128Test()
        {
            AssertBitwiseEqual(
                0.0,
                NumberBaseHelper<double>.CreateChecked<Int128>(
        ...
        public static void CreateCheckedFromIntPtrTest()
        {
            if (Environment.Is64BitProcess)
            {
                AssertBitwiseEqual(
                    0.0,
                    NumberBaseHelper<double>.CreateChecked<nint>(
            ...
            else
            {
                AssertBitwiseEqual(
                    0.0,
                    NumberBaseHelper<double>.CreateChecked<nint>((nint)0x00000000)
                );
                AssertBitwiseEqual(
                    1.0,
                    NumberBaseHelper<double>.CreateChecked<nint>((nint)0x00000001)
                );
                AssertBitwiseEqual(
                    2147483647.0,
                    NumberBaseHelper<double>.CreateChecked<nint>((nint)0x7FFFFFFF)
                );
                AssertBitwiseEqual(
                    -2147483648.0,
                    NumberBaseHelper<double>.CreateChecked<nint>(unchecked((nint)0x80000000))
                );
                AssertBitwiseEqual(
                    -1.0,
                    NumberBaseHelper<double>.CreateChecked<nint>(unchecked((nint)0xFFFFFFFF))
                );
            }
        }
        ...
        public static void CreateCheckedFromNFloatTest()
        {
            AssertBitwiseEqual(
                double.NegativeInfinity,
                NumberBaseHelper<double>.CreateChecked<NFloat>(NFloat.NegativeInfinity)
            );
            ...
            if (Environment.Is64BitProcess)
            {
                AssertBitwiseEqual(
                    double.MinValue,
                    NumberBaseHelper<double>.CreateChecked<NFloat>(NFloat.MinValue)
                );

                AssertBitwiseEqual(
                    -MinNormal,
                    NumberBaseHelper<double>.CreateChecked<NFloat>((NFloat)(-MinNormal))
                );
                AssertBitwiseEqual(
                    -MaxSubnormal,
                    NumberBaseHelper<double>.CreateChecked<NFloat>((NFloat)(-MaxSubnormal))
                );
                AssertBitwiseEqual(
                    -double.Epsilon,
                    NumberBaseHelper<double>.CreateChecked<NFloat>(-NFloat.Epsilon)
                );
                ...
                AssertBitwiseEqual(
                    double.MaxValue,
                    NumberBaseHelper<double>.CreateChecked<NFloat>(NFloat.MaxValue)
                );
            }
            else
            {
                ...
                AssertBitwiseEqual(
                    ...
                    NumberBaseHelper<double>.CreateChecked<NFloat>(
                        -SingleTests_GenericMath.MinNormal
                    )
                );
                AssertBitwiseEqual(
                    -1.1754942106924411E-38,
                    NumberBaseHelper<double>.CreateChecked<NFloat>(
                        -SingleTests_GenericMath.MaxSubnormal
                    )
                );
                AssertBitwiseEqual(
            ...
            AssertBitwiseEqual(
                double.PositiveInfinity,
                NumberBaseHelper<double>.CreateChecked<NFloat>(NFloat.PositiveInfinity)
            );

            AssertBitwiseEqual(
                double.NaN,
                NumberBaseHelper<double>.CreateChecked<NFloat>(NFloat.NaN)
            );
        }
        ...
        public static void CreateCheckedFromSByteTest()
        {
            ...
            AssertBitwiseEqual(
                -128.0,
                NumberBaseHelper<double>.CreateChecked<sbyte>(unchecked((sbyte)0x80))
            );
            AssertBitwiseEqual(
                -1.0,
                NumberBaseHelper<double>.CreateChecked<sbyte>(unchecked((sbyte)0xFF))
            );
        }
        ...
        public static void CreateCheckedFromSingleTest()
        {
            AssertBitwiseEqual(
                double.NegativeInfinity,
                NumberBaseHelper<double>.CreateChecked<float>(float.NegativeInfinity)
            );

            AssertBitwiseEqual(
                -3.4028234663852886E+38,
                NumberBaseHelper<double>.CreateChecked<float>(float.MinValue)
            );
            AssertBitwiseEqual(-1.0, NumberBaseHelper<double>.CreateChecked<float>(-1.0f));

            AssertBitwiseEqual(
                -1.1754943508222875E-38,
                NumberBaseHelper<double>.CreateChecked<float>(-SingleTests_GenericMath.MinNormal)
            );
            AssertBitwiseEqual(
                -1.1754942106924411E-38,
                NumberBaseHelper<double>.CreateChecked<float>(-SingleTests_GenericMath.MaxSubnormal)
            );
            AssertBitwiseEqual(
                -1.401298464324817E-45,
                NumberBaseHelper<double>.CreateChecked<float>(-float.Epsilon)
            );
            ...
            AssertBitwiseEqual(
                +3.4028234663852886E+38,
                NumberBaseHelper<double>.CreateChecked<float>(float.MaxValue)
            );

            AssertBitwiseEqual(
                double.PositiveInfinity,
                NumberBaseHelper<double>.CreateChecked<float>(float.PositiveInfinity)
            );

            AssertBitwiseEqual(
                double.NaN,
                NumberBaseHelper<double>.CreateChecked<float>(float.NaN)
            );
        }
        ...
        public static void CreateCheckedFromUInt32Test()
        {
            ...
            AssertBitwiseEqual(
                2147483647.0,
                NumberBaseHelper<double>.CreateChecked<uint>(0x7FFFFFFF)
            );
            AssertBitwiseEqual(
                2147483648.0,
                NumberBaseHelper<double>.CreateChecked<uint>(0x80000000)
            );
            AssertBitwiseEqual(
                4294967295.0,
                NumberBaseHelper<double>.CreateChecked<uint>(0xFFFFFFFF)
            );
        }
        ...
        public static void CreateCheckedFromUInt64Test()
        {
            AssertBitwiseEqual(
                0.0,
                NumberBaseHelper<double>.CreateChecked<ulong>(0x0000000000000000)
            );
            AssertBitwiseEqual(
                1.0,
                NumberBaseHelper<double>.CreateChecked<ulong>(0x0000000000000001)
            );
            AssertBitwiseEqual(
                9223372036854775807.0,
                NumberBaseHelper<double>.CreateChecked<ulong>(0x7FFFFFFFFFFFFFFF)
            );
            AssertBitwiseEqual(
                9223372036854775808.0,
                NumberBaseHelper<double>.CreateChecked<ulong>(0x8000000000000000)
            );
            AssertBitwiseEqual(
                18446744073709551615.0,
                NumberBaseHelper<double>.CreateChecked<ulong>(0xFFFFFFFFFFFFFFFF)
            );
        }
        ...
        public static void CreateCheckedFromUInt128Test()
        {
            AssertBitwiseEqual(
                0.0,
                NumberBaseHelper<double>.CreateChecked<UInt128>(
        ...
        public static void CreateCheckedFromUIntPtrTest()
        {
            if (Environment.Is64BitProcess)
            {
                AssertBitwiseEqual(
                    0.0,
                    NumberBaseHelper<double>.CreateChecked<nuint>(
            ...
            else
            {
                AssertBitwiseEqual(
                    0.0,
                    NumberBaseHelper<double>.CreateChecked<nuint>((nuint)0x00000000)
                );
                AssertBitwiseEqual(
                    1.0,
                    NumberBaseHelper<double>.CreateChecked<nuint>((nuint)0x00000001)
                );
                AssertBitwiseEqual(
                    2147483647.0,
                    NumberBaseHelper<double>.CreateChecked<nuint>((nuint)0x7FFFFFFF)
                );
        ...
        public static void CreateSaturatingFromCharTest()
        {
            ...
            AssertBitwiseEqual(
                32767.0,
                NumberBaseHelper<double>.CreateSaturating<char>((char)0x7FFF)
            );
            AssertBitwiseEqual(
                32768.0,
                NumberBaseHelper<double>.CreateSaturating<char>((char)0x8000)
            );
            AssertBitwiseEqual(
                65535.0,
                NumberBaseHelper<double>.CreateSaturating<char>((char)0xFFFF)
            );
        }
        ...
        public static void CreateSaturatingFromDecimalTest()
        {
            AssertBitwiseEqual(
                -79228162514264337593543950335.0,
                NumberBaseHelper<double>.CreateSaturating<decimal>(decimal.MinValue)
            );
            ...
            AssertBitwiseEqual(
                +79228162514264337593543950335.0,
                NumberBaseHelper<double>.CreateSaturating<decimal>(decimal.MaxValue)
            );
        }
        ...
        public static void CreateSaturatingFromDoubleTest()
        {
            AssertBitwiseEqual(
                double.NegativeInfinity,
                NumberBaseHelper<double>.CreateSaturating<double>(double.NegativeInfinity)
            );
            AssertBitwiseEqual(
                double.MinValue,
                NumberBaseHelper<double>.CreateSaturating<double>(double.MinValue)
            );
            ...
            AssertBitwiseEqual(
                -MinNormal,
                NumberBaseHelper<double>.CreateSaturating<double>(-MinNormal)
            );
            AssertBitwiseEqual(
                -MaxSubnormal,
                NumberBaseHelper<double>.CreateSaturating<double>(-MaxSubnormal)
            );
            AssertBitwiseEqual(
                -double.Epsilon,
                NumberBaseHelper<double>.CreateSaturating<double>(-double.Epsilon)
            );
            ...
            AssertBitwiseEqual(
                double.MaxValue,
                NumberBaseHelper<double>.CreateSaturating<double>(double.MaxValue)
            );
            AssertBitwiseEqual(
                double.PositiveInfinity,
                NumberBaseHelper<double>.CreateSaturating<double>(double.PositiveInfinity)
            );
        ...
        public static void CreateSaturatingFromHalfTest()
        {
            AssertBitwiseEqual(
                double.NegativeInfinity,
                NumberBaseHelper<double>.CreateSaturating<Half>(Half.NegativeInfinity)
            );

            AssertBitwiseEqual(
                -65504.0,
                NumberBaseHelper<double>.CreateSaturating<Half>(Half.MinValue)
            );
            AssertBitwiseEqual(
                -1.0,
                NumberBaseHelper<double>.CreateSaturating<Half>(Half.NegativeOne)
            );

            AssertBitwiseEqual(
                -6.103515625E-05,
                NumberBaseHelper<double>.CreateSaturating<Half>(-HalfTests_GenericMath.MinNormal)
            );
            AssertBitwiseEqual(
                -6.097555160522461E-05,
                NumberBaseHelper<double>.CreateSaturating<Half>(-HalfTests_GenericMath.MaxSubnormal)
            );
            AssertBitwiseEqual(
                -5.960464477539063E-08,
                NumberBaseHelper<double>.CreateSaturating<Half>(-Half.Epsilon)
            );
            AssertBitwiseEqual(
                -0.0,
                NumberBaseHelper<double>.CreateSaturating<Half>(Half.NegativeZero)
            );
            ...
            AssertBitwiseEqual(
                +65504.0,
                NumberBaseHelper<double>.CreateSaturating<Half>(Half.MaxValue)
            );

            AssertBitwiseEqual(
                double.PositiveInfinity,
                NumberBaseHelper<double>.CreateSaturating<Half>(Half.PositiveInfinity)
            );

            AssertBitwiseEqual(
                double.NaN,
                NumberBaseHelper<double>.CreateSaturating<Half>(Half.NaN)
            );
        }
        ...
        public static void CreateSaturatingFromInt16Test()
        {
            ...
            AssertBitwiseEqual(
                -32768.0,
                NumberBaseHelper<double>.CreateSaturating<short>(unchecked((short)0x8000))
            );
            AssertBitwiseEqual(
                -1.0,
                NumberBaseHelper<double>.CreateSaturating<short>(unchecked((short)0xFFFF))
            );
        }
        ...
        public static void CreateSaturatingFromInt32Test()
        {
            ...
            AssertBitwiseEqual(
                2147483647.0,
                NumberBaseHelper<double>.CreateSaturating<int>(0x7FFFFFFF)
            );
            AssertBitwiseEqual(
                -2147483648.0,
                NumberBaseHelper<double>.CreateSaturating<int>(unchecked((int)0x80000000))
            );
            AssertBitwiseEqual(
                -1.0,
                NumberBaseHelper<double>.CreateSaturating<int>(unchecked((int)0xFFFFFFFF))
            );
        }
        ...
        public static void CreateSaturatingFromInt64Test()
        {
            AssertBitwiseEqual(
                0.0,
                NumberBaseHelper<double>.CreateSaturating<long>(0x0000000000000000)
            );
            AssertBitwiseEqual(
                1.0,
                NumberBaseHelper<double>.CreateSaturating<long>(0x0000000000000001)
            );
            AssertBitwiseEqual(
                9223372036854775807.0,
                NumberBaseHelper<double>.CreateSaturating<long>(0x7FFFFFFFFFFFFFFF)
            );
            AssertBitwiseEqual(
                -9223372036854775808.0,
                NumberBaseHelper<double>.CreateSaturating<long>(
                    unchecked(unchecked((long)0x8000000000000000))
                )
            );
            AssertBitwiseEqual(
        ...
        public static void CreateSaturatingFromInt128Test()
        {
            AssertBitwiseEqual(
                0.0,
                NumberBaseHelper<double>.CreateSaturating<Int128>(
                    new Int128(0x0000_0000_0000_0000, 0x0000_0000_0000_0000)
                )
            );
            AssertBitwiseEqual(
        ...
        public static void CreateSaturatingFromIntPtrTest()
        {
            if (Environment.Is64BitProcess)
            {
                AssertBitwiseEqual(
                    0.0,
                    NumberBaseHelper<double>.CreateSaturating<nint>(
                        unchecked((nint)0x0000000000000000)
                    )
                );
                AssertBitwiseEqual(
            ...
            else
            {
                AssertBitwiseEqual(
                    0.0,
                    NumberBaseHelper<double>.CreateSaturating<nint>((nint)0x00000000)
                );
                AssertBitwiseEqual(
                    1.0,
                    NumberBaseHelper<double>.CreateSaturating<nint>((nint)0x00000001)
                );
                AssertBitwiseEqual(
                    2147483647.0,
                    NumberBaseHelper<double>.CreateSaturating<nint>((nint)0x7FFFFFFF)
                );
                AssertBitwiseEqual(
                    -2147483648.0,
                    NumberBaseHelper<double>.CreateSaturating<nint>(unchecked((nint)0x80000000))
                );
                AssertBitwiseEqual(
                    -1.0,
                    NumberBaseHelper<double>.CreateSaturating<nint>(unchecked((nint)0xFFFFFFFF))
                );
            }
        }
        ...
        public static void CreateSaturatingFromNFloatTest()
        {
            AssertBitwiseEqual(
                double.NegativeInfinity,
                NumberBaseHelper<double>.CreateSaturating<NFloat>(NFloat.NegativeInfinity)
            );
            ...
            if (Environment.Is64BitProcess)
            {
                AssertBitwiseEqual(
                    double.MinValue,
                    NumberBaseHelper<double>.CreateSaturating<NFloat>(NFloat.MinValue)
                );

                AssertBitwiseEqual(
                    -MinNormal,
                    NumberBaseHelper<double>.CreateSaturating<NFloat>((NFloat)(-MinNormal))
                );
                AssertBitwiseEqual(
                    -MaxSubnormal,
                    NumberBaseHelper<double>.CreateSaturating<NFloat>((NFloat)(-MaxSubnormal))
                );
                AssertBitwiseEqual(
                    -double.Epsilon,
                    NumberBaseHelper<double>.CreateSaturating<NFloat>(-NFloat.Epsilon)
                );
                ...
                AssertBitwiseEqual(
                    double.MaxValue,
                    NumberBaseHelper<double>.CreateSaturating<NFloat>(NFloat.MaxValue)
                );
            }
            else
            {
                ...
                AssertBitwiseEqual(
                    -1.1754943508222875E-38,
                    NumberBaseHelper<double>.CreateSaturating<NFloat>(
                        -SingleTests_GenericMath.MinNormal
                    )
                );
                AssertBitwiseEqual(
            ...
            AssertBitwiseEqual(
                double.PositiveInfinity,
                NumberBaseHelper<double>.CreateSaturating<NFloat>(NFloat.PositiveInfinity)
            );

            AssertBitwiseEqual(
                double.NaN,
                NumberBaseHelper<double>.CreateSaturating<NFloat>(NFloat.NaN)
            );
        }
        ...
        public static void CreateSaturatingFromSByteTest()
        {
            ...
            AssertBitwiseEqual(
                -128.0,
                NumberBaseHelper<double>.CreateSaturating<sbyte>(unchecked((sbyte)0x80))
            );
            AssertBitwiseEqual(
                -1.0,
                NumberBaseHelper<double>.CreateSaturating<sbyte>(unchecked((sbyte)0xFF))
            );
        }
        ...
        public static void CreateSaturatingFromSingleTest()
        {
            AssertBitwiseEqual(
                double.NegativeInfinity,
                NumberBaseHelper<double>.CreateSaturating<float>(float.NegativeInfinity)
            );

            AssertBitwiseEqual(
                -3.4028234663852886E+38,
                NumberBaseHelper<double>.CreateSaturating<float>(float.MinValue)
            );
            AssertBitwiseEqual(-1.0, NumberBaseHelper<double>.CreateSaturating<float>(-1.0f));

            AssertBitwiseEqual(
                -1.1754943508222875E-38,
                NumberBaseHelper<double>.CreateSaturating<float>(-SingleTests_GenericMath.MinNormal)
            );
            AssertBitwiseEqual(
                -1.1754942106924411E-38,
                NumberBaseHelper<double>.CreateSaturating<float>(
                    -SingleTests_GenericMath.MaxSubnormal
                )
            );
            AssertBitwiseEqual(
                -1.401298464324817E-45,
                NumberBaseHelper<double>.CreateSaturating<float>(-float.Epsilon)
            );
            ...
            AssertBitwiseEqual(
                +3.4028234663852886E+38,
                NumberBaseHelper<double>.CreateSaturating<float>(float.MaxValue)
            );

            AssertBitwiseEqual(
                double.PositiveInfinity,
                NumberBaseHelper<double>.CreateSaturating<float>(float.PositiveInfinity)
            );

            AssertBitwiseEqual(
                double.NaN,
                NumberBaseHelper<double>.CreateSaturating<float>(float.NaN)
            );
        }
        ...
        public static void CreateSaturatingFromUInt32Test()
        {
            ...
            AssertBitwiseEqual(
                2147483647.0,
                NumberBaseHelper<double>.CreateSaturating<uint>(0x7FFFFFFF)
            );
            AssertBitwiseEqual(
                2147483648.0,
                NumberBaseHelper<double>.CreateSaturating<uint>(0x80000000)
            );
            AssertBitwiseEqual(
                4294967295.0,
                NumberBaseHelper<double>.CreateSaturating<uint>(0xFFFFFFFF)
            );
        }
        ...
        public static void CreateSaturatingFromUInt64Test()
        {
            AssertBitwiseEqual(
                0.0,
                NumberBaseHelper<double>.CreateSaturating<ulong>(0x0000000000000000)
            );
            AssertBitwiseEqual(
                1.0,
                NumberBaseHelper<double>.CreateSaturating<ulong>(0x0000000000000001)
            );
            AssertBitwiseEqual(
                9223372036854775807.0,
                NumberBaseHelper<double>.CreateSaturating<ulong>(0x7FFFFFFFFFFFFFFF)
            );
            AssertBitwiseEqual(
                9223372036854775808.0,
                NumberBaseHelper<double>.CreateSaturating<ulong>(0x8000000000000000)
            );
            AssertBitwiseEqual(
                18446744073709551615.0,
                NumberBaseHelper<double>.CreateSaturating<ulong>(0xFFFFFFFFFFFFFFFF)
            );
        }
        ...
        public static void CreateSaturatingFromUInt128Test()
        {
            AssertBitwiseEqual(
                0.0,
                NumberBaseHelper<double>.CreateSaturating<UInt128>(
                    new UInt128(0x0000_0000_0000_0000, 0x0000_0000_0000_0000)
                )
            );
            AssertBitwiseEqual(
        ...
        public static void CreateSaturatingFromUIntPtrTest()
        {
            if (Environment.Is64BitProcess)
            {
                AssertBitwiseEqual(
                    0.0,
                    NumberBaseHelper<double>.CreateSaturating<nuint>(
                        unchecked((nuint)0x0000000000000000)
                    )
                );
                AssertBitwiseEqual(
            ...
            else
            {
                AssertBitwiseEqual(
                    0.0,
                    NumberBaseHelper<double>.CreateSaturating<nuint>((nuint)0x00000000)
                );
                AssertBitwiseEqual(
                    1.0,
                    NumberBaseHelper<double>.CreateSaturating<nuint>((nuint)0x00000001)
                );
                AssertBitwiseEqual(
                    2147483647.0,
                    NumberBaseHelper<double>.CreateSaturating<nuint>((nuint)0x7FFFFFFF)
                );
        ...
        public static void CreateTruncatingFromCharTest()
        {
            ...
            AssertBitwiseEqual(
                32767.0,
                NumberBaseHelper<double>.CreateTruncating<char>((char)0x7FFF)
            );
            AssertBitwiseEqual(
                32768.0,
                NumberBaseHelper<double>.CreateTruncating<char>((char)0x8000)
            );
            AssertBitwiseEqual(
                65535.0,
                NumberBaseHelper<double>.CreateTruncating<char>((char)0xFFFF)
            );
        }
        ...
        public static void CreateTruncatingFromDecimalTest()
        {
            AssertBitwiseEqual(
                -79228162514264337593543950335.0,
                NumberBaseHelper<double>.CreateTruncating<decimal>(decimal.MinValue)
            );
            ...
            AssertBitwiseEqual(
                +79228162514264337593543950335.0,
                NumberBaseHelper<double>.CreateTruncating<decimal>(decimal.MaxValue)
            );
        }
        ...
        public static void CreateTruncatingFromDoubleTest()
        {
            AssertBitwiseEqual(
                double.NegativeInfinity,
                NumberBaseHelper<double>.CreateTruncating<double>(double.NegativeInfinity)
            );
            AssertBitwiseEqual(
                double.MinValue,
                NumberBaseHelper<double>.CreateTruncating<double>(double.MinValue)
            );
            ...
            AssertBitwiseEqual(
                -MinNormal,
                NumberBaseHelper<double>.CreateTruncating<double>(-MinNormal)
            );
            AssertBitwiseEqual(
                -MaxSubnormal,
                NumberBaseHelper<double>.CreateTruncating<double>(-MaxSubnormal)
            );
            AssertBitwiseEqual(
                -double.Epsilon,
                NumberBaseHelper<double>.CreateTruncating<double>(-double.Epsilon)
            );
            ...
            AssertBitwiseEqual(
                double.MaxValue,
                NumberBaseHelper<double>.CreateTruncating<double>(double.MaxValue)
            );
            AssertBitwiseEqual(
                double.PositiveInfinity,
                NumberBaseHelper<double>.CreateTruncating<double>(double.PositiveInfinity)
            );
        ...
        public static void CreateTruncatingFromHalfTest()
        {
            AssertBitwiseEqual(
                double.NegativeInfinity,
                NumberBaseHelper<double>.CreateTruncating<Half>(Half.NegativeInfinity)
            );

            AssertBitwiseEqual(
                -65504.0,
                NumberBaseHelper<double>.CreateTruncating<Half>(Half.MinValue)
            );
            AssertBitwiseEqual(
                -1.0,
                NumberBaseHelper<double>.CreateTruncating<Half>(Half.NegativeOne)
            );

            AssertBitwiseEqual(
                -6.103515625E-05,
                NumberBaseHelper<double>.CreateTruncating<Half>(-HalfTests_GenericMath.MinNormal)
            );
            AssertBitwiseEqual(
                -6.097555160522461E-05,
                NumberBaseHelper<double>.CreateTruncating<Half>(-HalfTests_GenericMath.MaxSubnormal)
            );
            AssertBitwiseEqual(
                -5.960464477539063E-08,
                NumberBaseHelper<double>.CreateTruncating<Half>(-Half.Epsilon)
            );
            AssertBitwiseEqual(
                -0.0,
                NumberBaseHelper<double>.CreateTruncating<Half>(Half.NegativeZero)
            );
            ...
            AssertBitwiseEqual(
                +65504.0,
                NumberBaseHelper<double>.CreateTruncating<Half>(Half.MaxValue)
            );

            AssertBitwiseEqual(
                double.PositiveInfinity,
                NumberBaseHelper<double>.CreateTruncating<Half>(Half.PositiveInfinity)
            );

            AssertBitwiseEqual(
                double.NaN,
                NumberBaseHelper<double>.CreateTruncating<Half>(Half.NaN)
            );
        }
        ...
        public static void CreateTruncatingFromInt16Test()
        {
            ...
            AssertBitwiseEqual(
                -32768.0,
                NumberBaseHelper<double>.CreateTruncating<short>(unchecked((short)0x8000))
            );
            AssertBitwiseEqual(
                -1.0,
                NumberBaseHelper<double>.CreateTruncating<short>(unchecked((short)0xFFFF))
            );
        }
        ...
        public static void CreateTruncatingFromInt32Test()
        {
            ...
            AssertBitwiseEqual(
                2147483647.0,
                NumberBaseHelper<double>.CreateTruncating<int>(0x7FFFFFFF)
            );
            AssertBitwiseEqual(
                -2147483648.0,
                NumberBaseHelper<double>.CreateTruncating<int>(unchecked((int)0x80000000))
            );
            AssertBitwiseEqual(
                -1.0,
                NumberBaseHelper<double>.CreateTruncating<int>(unchecked((int)0xFFFFFFFF))
            );
        }
        ...
        public static void CreateTruncatingFromInt64Test()
        {
            AssertBitwiseEqual(
                0.0,
                NumberBaseHelper<double>.CreateTruncating<long>(0x0000000000000000)
            );
            AssertBitwiseEqual(
                1.0,
                NumberBaseHelper<double>.CreateTruncating<long>(0x0000000000000001)
            );
            AssertBitwiseEqual(
                9223372036854775807.0,
                NumberBaseHelper<double>.CreateTruncating<long>(0x7FFFFFFFFFFFFFFF)
            );
            AssertBitwiseEqual(
                -9223372036854775808.0,
                NumberBaseHelper<double>.CreateTruncating<long>(
                    unchecked(unchecked((long)0x8000000000000000))
                )
            );
            AssertBitwiseEqual(
        ...
        public static void CreateTruncatingFromInt128Test()
        {
            AssertBitwiseEqual(
                0.0,
                NumberBaseHelper<double>.CreateTruncating<Int128>(
                    new Int128(0x0000_0000_0000_0000, 0x0000_0000_0000_0000)
                )
            );
            AssertBitwiseEqual(
        ...
        public static void CreateTruncatingFromIntPtrTest()
        {
            if (Environment.Is64BitProcess)
            {
                AssertBitwiseEqual(
                    0.0,
                    NumberBaseHelper<double>.CreateTruncating<nint>(
                        unchecked((nint)0x0000000000000000)
                    )
                );
                AssertBitwiseEqual(
            ...
            else
            {
                AssertBitwiseEqual(
                    0.0,
                    NumberBaseHelper<double>.CreateTruncating<nint>((nint)0x00000000)
                );
                AssertBitwiseEqual(
                    1.0,
                    NumberBaseHelper<double>.CreateTruncating<nint>((nint)0x00000001)
                );
                AssertBitwiseEqual(
                    2147483647.0,
                    NumberBaseHelper<double>.CreateTruncating<nint>((nint)0x7FFFFFFF)
                );
                AssertBitwiseEqual(
                    -2147483648.0,
                    NumberBaseHelper<double>.CreateTruncating<nint>(unchecked((nint)0x80000000))
                );
                AssertBitwiseEqual(
                    -1.0,
                    NumberBaseHelper<double>.CreateTruncating<nint>(unchecked((nint)0xFFFFFFFF))
                );
            }
        }
        ...
        public static void CreateTruncatingFromNFloatTest()
        {
            AssertBitwiseEqual(
                double.NegativeInfinity,
                NumberBaseHelper<double>.CreateTruncating<NFloat>(NFloat.NegativeInfinity)
            );
            ...
            if (Environment.Is64BitProcess)
            {
                AssertBitwiseEqual(
                    double.MinValue,
                    NumberBaseHelper<double>.CreateTruncating<NFloat>(NFloat.MinValue)
                );

                AssertBitwiseEqual(
                    -MinNormal,
                    NumberBaseHelper<double>.CreateTruncating<NFloat>((NFloat)(-MinNormal))
                );
                AssertBitwiseEqual(
                    -MaxSubnormal,
                    NumberBaseHelper<double>.CreateTruncating<NFloat>((NFloat)(-MaxSubnormal))
                );
                AssertBitwiseEqual(
                    -double.Epsilon,
                    NumberBaseHelper<double>.CreateTruncating<NFloat>(-NFloat.Epsilon)
                );
                ...
                AssertBitwiseEqual(
                    double.MaxValue,
                    NumberBaseHelper<double>.CreateTruncating<NFloat>(NFloat.MaxValue)
                );
            }
            else
            {
                ...
                AssertBitwiseEqual(
                    -1.1754943508222875E-38,
                    NumberBaseHelper<double>.CreateTruncating<NFloat>(
                        -SingleTests_GenericMath.MinNormal
                    )
                );
                AssertBitwiseEqual(
            ...
            AssertBitwiseEqual(
                double.PositiveInfinity,
                NumberBaseHelper<double>.CreateTruncating<NFloat>(NFloat.PositiveInfinity)
            );

            AssertBitwiseEqual(
                double.NaN,
                NumberBaseHelper<double>.CreateTruncating<NFloat>(NFloat.NaN)
            );
        }
        ...
        public static void CreateTruncatingFromSByteTest()
        {
            ...
            AssertBitwiseEqual(
                -128.0,
                NumberBaseHelper<double>.CreateTruncating<sbyte>(unchecked((sbyte)0x80))
            );
            AssertBitwiseEqual(
                -1.0,
                NumberBaseHelper<double>.CreateTruncating<sbyte>(unchecked((sbyte)0xFF))
            );
        }
        ...
        public static void CreateTruncatingFromSingleTest()
        {
            AssertBitwiseEqual(
                double.NegativeInfinity,
                NumberBaseHelper<double>.CreateTruncating<float>(float.NegativeInfinity)
            );

            AssertBitwiseEqual(
                -3.4028234663852886E+38,
                NumberBaseHelper<double>.CreateTruncating<float>(float.MinValue)
            );
            AssertBitwiseEqual(-1.0, NumberBaseHelper<double>.CreateTruncating<float>(-1.0f));

            AssertBitwiseEqual(
                -1.1754943508222875E-38,
                NumberBaseHelper<double>.CreateTruncating<float>(-SingleTests_GenericMath.MinNormal)
            );
            AssertBitwiseEqual(
                -1.1754942106924411E-38,
                NumberBaseHelper<double>.CreateTruncating<float>(
                    -SingleTests_GenericMath.MaxSubnormal
                )
            );
            AssertBitwiseEqual(
                -1.401298464324817E-45,
                NumberBaseHelper<double>.CreateTruncating<float>(-float.Epsilon)
            );
            ...
            AssertBitwiseEqual(
                +3.4028234663852886E+38,
                NumberBaseHelper<double>.CreateTruncating<float>(float.MaxValue)
            );

            AssertBitwiseEqual(
                double.PositiveInfinity,
                NumberBaseHelper<double>.CreateTruncating<float>(float.PositiveInfinity)
            );

            AssertBitwiseEqual(
                double.NaN,
                NumberBaseHelper<double>.CreateTruncating<float>(float.NaN)
            );
        }
        ...
        public static void CreateTruncatingFromUInt32Test()
        {
            ...
            AssertBitwiseEqual(
                2147483647.0,
                NumberBaseHelper<double>.CreateTruncating<uint>(0x7FFFFFFF)
            );
            AssertBitwiseEqual(
                2147483648.0,
                NumberBaseHelper<double>.CreateTruncating<uint>(0x80000000)
            );
            AssertBitwiseEqual(
                4294967295.0,
                NumberBaseHelper<double>.CreateTruncating<uint>(0xFFFFFFFF)
            );
        }
        ...
        public static void CreateTruncatingFromUInt64Test()
        {
            AssertBitwiseEqual(
                0.0,
                NumberBaseHelper<double>.CreateTruncating<ulong>(0x0000000000000000)
            );
            AssertBitwiseEqual(
                1.0,
                NumberBaseHelper<double>.CreateTruncating<ulong>(0x0000000000000001)
            );
            AssertBitwiseEqual(
                9223372036854775807.0,
                NumberBaseHelper<double>.CreateTruncating<ulong>(0x7FFFFFFFFFFFFFFF)
            );
            AssertBitwiseEqual(
                9223372036854775808.0,
                NumberBaseHelper<double>.CreateTruncating<ulong>(0x8000000000000000)
            );
            AssertBitwiseEqual(
                18446744073709551615.0,
                NumberBaseHelper<double>.CreateTruncating<ulong>(0xFFFFFFFFFFFFFFFF)
            );
        }
        ...
        public static void CreateTruncatingFromUInt128Test()
        {
            AssertBitwiseEqual(
                0.0,
                NumberBaseHelper<double>.CreateTruncating<UInt128>(
                    new UInt128(0x0000_0000_0000_0000, 0x0000_0000_0000_0000)
                )
            );
            AssertBitwiseEqual(
        ...
        public static void CreateTruncatingFromUIntPtrTest()
        {
            if (Environment.Is64BitProcess)
            {
                AssertBitwiseEqual(
                    0.0,
                    NumberBaseHelper<double>.CreateTruncating<nuint>(
                        unchecked((nuint)0x0000000000000000)
                    )
                );
                AssertBitwiseEqual(
            ...
            else
            {
                AssertBitwiseEqual(
                    0.0,
                    NumberBaseHelper<double>.CreateTruncating<nuint>((nuint)0x00000000)
                );
                AssertBitwiseEqual(
                    1.0,
                    NumberBaseHelper<double>.CreateTruncating<nuint>((nuint)0x00000001)
                );
                AssertBitwiseEqual(
                    2147483647.0,
                    NumberBaseHelper<double>.CreateTruncating<nuint>((nuint)0x7FFFFFFF)
                );
        ...
        public static void MaxMagnitudeTest()
        {
            AssertBitwiseEqual(
                double.NegativeInfinity,
                NumberBaseHelper<double>.MaxMagnitude(double.NegativeInfinity, 1.0)
            );
            AssertBitwiseEqual(
                double.MinValue,
                NumberBaseHelper<double>.MaxMagnitude(double.MinValue, 1.0)
            );
            ...
            AssertBitwiseEqual(
                double.MaxValue,
                NumberBaseHelper<double>.MaxMagnitude(double.MaxValue, 1.0)
            );
            AssertBitwiseEqual(
                double.PositiveInfinity,
                NumberBaseHelper<double>.MaxMagnitude(double.PositiveInfinity, 1.0)
            );
        }
        ...
        public static void MaxMagnitudeNumberTest()
        {
            AssertBitwiseEqual(
                double.NegativeInfinity,
                NumberBaseHelper<double>.MaxMagnitudeNumber(double.NegativeInfinity, 1.0)
            );
            AssertBitwiseEqual(
                double.MinValue,
                NumberBaseHelper<double>.MaxMagnitudeNumber(double.MinValue, 1.0)
            );
            ...
            AssertBitwiseEqual(
                1.0,
                NumberBaseHelper<double>.MaxMagnitudeNumber(-MaxSubnormal, 1.0)
            );
            AssertBitwiseEqual(
                1.0,
                NumberBaseHelper<double>.MaxMagnitudeNumber(-double.Epsilon, 1.0)
            );
            ...
            AssertBitwiseEqual(
                double.MaxValue,
                NumberBaseHelper<double>.MaxMagnitudeNumber(double.MaxValue, 1.0)
            );
            AssertBitwiseEqual(
                double.PositiveInfinity,
                NumberBaseHelper<double>.MaxMagnitudeNumber(double.PositiveInfinity, 1.0)
            );
        }
        ...
        public static void MinMagnitudeTest()
        {
            AssertBitwiseEqual(
                1.0,
                NumberBaseHelper<double>.MinMagnitude(double.NegativeInfinity, 1.0)
            );
            ...
            AssertBitwiseEqual(
                -MaxSubnormal,
                NumberBaseHelper<double>.MinMagnitude(-MaxSubnormal, 1.0)
            );
            AssertBitwiseEqual(
                -double.Epsilon,
                NumberBaseHelper<double>.MinMagnitude(-double.Epsilon, 1.0)
            );
            ...
            AssertBitwiseEqual(
                1.0,
                NumberBaseHelper<double>.MinMagnitude(double.PositiveInfinity, 1.0)
            );
        }
        ...
        public static void MinMagnitudeNumberTest()
        {
            AssertBitwiseEqual(
                1.0,
                NumberBaseHelper<double>.MinMagnitudeNumber(double.NegativeInfinity, 1.0)
            );
            AssertBitwiseEqual(
                1.0,
                NumberBaseHelper<double>.MinMagnitudeNumber(double.MinValue, 1.0)
            );
            AssertBitwiseEqual(-1.0, NumberBaseHelper<double>.MinMagnitudeNumber(-1.0, 1.0));
            AssertBitwiseEqual(
                -MinNormal,
                NumberBaseHelper<double>.MinMagnitudeNumber(-MinNormal, 1.0)
            );
            AssertBitwiseEqual(
                -MaxSubnormal,
                NumberBaseHelper<double>.MinMagnitudeNumber(-MaxSubnormal, 1.0)
            );
            AssertBitwiseEqual(
                -double.Epsilon,
                NumberBaseHelper<double>.MinMagnitudeNumber(-double.Epsilon, 1.0)
            );
            ...
            AssertBitwiseEqual(
                1.0,
                NumberBaseHelper<double>.MinMagnitudeNumber(double.MaxValue, 1.0)
            );
            AssertBitwiseEqual(
                1.0,
                NumberBaseHelper<double>.MinMagnitudeNumber(double.PositiveInfinity, 1.0)
            );
        }
        ...
        public static void op_SubtractionTest()
        {
            AssertBitwiseEqual(
                double.NegativeInfinity,
                SubtractionOperatorsHelper<double, double, double>.op_Subtraction(
                    double.NegativeInfinity,
                    1.0
                )
            );
            ...
            AssertBitwiseEqual(
                -2.0,
                SubtractionOperatorsHelper<double, double, double>.op_Subtraction(-1.0, 1.0)
            );
            AssertBitwiseEqual(
                -1.0,
                SubtractionOperatorsHelper<double, double, double>.op_Subtraction(-MinNormal, 1.0)
            );
            AssertBitwiseEqual(
                -1.0,
                SubtractionOperatorsHelper<double, double, double>.op_Subtraction(
            ...
            AssertBitwiseEqual(
                -1.0,
                SubtractionOperatorsHelper<double, double, double>.op_Subtraction(-0.0, 1.0)
            );
            AssertBitwiseEqual(
                double.NaN,
                SubtractionOperatorsHelper<double, double, double>.op_Subtraction(double.NaN, 1.0)
            );
            AssertBitwiseEqual(
                -1.0,
                SubtractionOperatorsHelper<double, double, double>.op_Subtraction(0.0, 1.0)
            ...
            AssertBitwiseEqual(
                -1.0,
                SubtractionOperatorsHelper<double, double, double>.op_Subtraction(MaxSubnormal, 1.0)
            );
            AssertBitwiseEqual(
                -1.0,
                SubtractionOperatorsHelper<double, double, double>.op_Subtraction(MinNormal, 1.0)
        ...
        public static void op_CheckedSubtractionTest()
        {
            AssertBitwiseEqual(
                double.NegativeInfinity,
                SubtractionOperatorsHelper<double, double, double>.op_CheckedSubtraction(
                    double.NegativeInfinity,
                    1.0
                )
            );
            ...
            AssertBitwiseEqual(
                -2.0,
                SubtractionOperatorsHelper<double, double, double>.op_CheckedSubtraction(-1.0, 1.0)
            );
            AssertBitwiseEqual(
                -1.0,
                SubtractionOperatorsHelper<double, double, double>.op_CheckedSubtraction(
            ...
            AssertBitwiseEqual(
                -1.0,
                SubtractionOperatorsHelper<double, double, double>.op_CheckedSubtraction(-0.0, 1.0)
            );
            AssertBitwiseEqual(
                double.NaN,
                SubtractionOperatorsHelper<double, double, double>.op_CheckedSubtraction(
        ...
        public static void op_UnaryNegationTest()
        {
            AssertBitwiseEqual(
                double.PositiveInfinity,
                UnaryNegationOperatorsHelper<double, double>.op_UnaryNegation(
                    double.NegativeInfinity
                )
            );
            AssertBitwiseEqual(
                double.MaxValue,
                UnaryNegationOperatorsHelper<double, double>.op_UnaryNegation(double.MinValue)
            );
            AssertBitwiseEqual(
                1.0,
                UnaryNegationOperatorsHelper<double, double>.op_UnaryNegation(-1.0)
            );
            AssertBitwiseEqual(
                MinNormal,
                UnaryNegationOperatorsHelper<double, double>.op_UnaryNegation(-MinNormal)
            );
            AssertBitwiseEqual(
                MaxSubnormal,
                UnaryNegationOperatorsHelper<double, double>.op_UnaryNegation(-MaxSubnormal)
            );
            AssertBitwiseEqual(
                double.Epsilon,
                UnaryNegationOperatorsHelper<double, double>.op_UnaryNegation(-double.Epsilon)
            );
            AssertBitwiseEqual(
                0.0,
                UnaryNegationOperatorsHelper<double, double>.op_UnaryNegation(-0.0)
            );
            AssertBitwiseEqual(
                double.NaN,
                UnaryNegationOperatorsHelper<double, double>.op_UnaryNegation(double.NaN)
            );
            AssertBitwiseEqual(
                -0.0,
                UnaryNegationOperatorsHelper<double, double>.op_UnaryNegation(0.0)
            ...
            AssertBitwiseEqual(
                double.MinValue,
                UnaryNegationOperatorsHelper<double, double>.op_UnaryNegation(double.MaxValue)
            );
            AssertBitwiseEqual(
                double.NegativeInfinity,
                UnaryNegationOperatorsHelper<double, double>.op_UnaryNegation(
        ...
        public static void op_CheckedUnaryNegationTest()
        {
            AssertBitwiseEqual(
                double.PositiveInfinity,
                UnaryNegationOperatorsHelper<double, double>.op_CheckedUnaryNegation(
                    double.NegativeInfinity
                )
            );
            AssertBitwiseEqual(
            ...
            AssertBitwiseEqual(
                1.0,
                UnaryNegationOperatorsHelper<double, double>.op_CheckedUnaryNegation(-1.0)
            );
            AssertBitwiseEqual(
                MinNormal,
                UnaryNegationOperatorsHelper<double, double>.op_CheckedUnaryNegation(-MinNormal)
            );
            AssertBitwiseEqual(
                MaxSubnormal,
                UnaryNegationOperatorsHelper<double, double>.op_CheckedUnaryNegation(-MaxSubnormal)
            );
            AssertBitwiseEqual(
                double.Epsilon,
                UnaryNegationOperatorsHelper<double, double>.op_CheckedUnaryNegation(
            ...
            AssertBitwiseEqual(
                0.0,
                UnaryNegationOperatorsHelper<double, double>.op_CheckedUnaryNegation(-0.0)
            );
            AssertBitwiseEqual(
                double.NaN,
                UnaryNegationOperatorsHelper<double, double>.op_CheckedUnaryNegation(double.NaN)
            );
            AssertBitwiseEqual(
                -0.0,
                UnaryNegationOperatorsHelper<double, double>.op_CheckedUnaryNegation(0.0)
            ...
            AssertBitwiseEqual(
                -double.Epsilon,
                UnaryNegationOperatorsHelper<double, double>.op_CheckedUnaryNegation(double.Epsilon)
            );
            AssertBitwiseEqual(
                -MaxSubnormal,
                UnaryNegationOperatorsHelper<double, double>.op_CheckedUnaryNegation(MaxSubnormal)
        ...
        public static void op_UnaryPlusTest()
        {
            AssertBitwiseEqual(
                double.NegativeInfinity,
                UnaryPlusOperatorsHelper<double, double>.op_UnaryPlus(double.NegativeInfinity)
            );
            AssertBitwiseEqual(
                double.MinValue,
                UnaryPlusOperatorsHelper<double, double>.op_UnaryPlus(double.MinValue)
            );
            AssertBitwiseEqual(-1.0, UnaryPlusOperatorsHelper<double, double>.op_UnaryPlus(-1.0));
            AssertBitwiseEqual(
                -MinNormal,
                UnaryPlusOperatorsHelper<double, double>.op_UnaryPlus(-MinNormal)
            );
            AssertBitwiseEqual(
                -MaxSubnormal,
                UnaryPlusOperatorsHelper<double, double>.op_UnaryPlus(-MaxSubnormal)
            );
            AssertBitwiseEqual(
                -double.Epsilon,
                UnaryPlusOperatorsHelper<double, double>.op_UnaryPlus(-double.Epsilon)
            );
            AssertBitwiseEqual(-0.0, UnaryPlusOperatorsHelper<double, double>.op_UnaryPlus(-0.0));
            AssertBitwiseEqual(
                double.NaN,
                UnaryPlusOperatorsHelper<double, double>.op_UnaryPlus(double.NaN)
            );
            AssertBitwiseEqual(0.0, UnaryPlusOperatorsHelper<double, double>.op_UnaryPlus(0.0));
            AssertBitwiseEqual(
                double.Epsilon,
            ...
            AssertBitwiseEqual(
                double.MaxValue,
                UnaryPlusOperatorsHelper<double, double>.op_UnaryPlus(double.MaxValue)
            );
            AssertBitwiseEqual(
                double.PositiveInfinity,
                UnaryPlusOperatorsHelper<double, double>.op_UnaryPlus(double.PositiveInfinity)
            );
        }
        ...
        )
        {
            ...
            if (isDefaultProvider)
            {
                ...
                Assert.True(
                    NumberBaseHelper<double>.TryParse(
                        value,
                        style,
                ...
                Assert.Equal(
                    expected,
                    NumberBaseHelper<double>.Parse(value, style, NumberFormatInfo.CurrentInfo)
                );
            }
        }
        ...
        )
        {
            ...
            Assert.Throws(
                exceptionType,
                () => NumberBaseHelper<double>.Parse(value, style, provider)
            );
            ...
            if (isDefaultProvider)
            {
                ...
                Assert.Throws(
                    exceptionType,
                    () => NumberBaseHelper<double>.Parse(value, style, null)
                );
                Assert.Throws(
                    exceptionType,
                    () => NumberBaseHelper<double>.Parse(value, style, NumberFormatInfo.CurrentInfo)
        ...
        [Theory]
        [MemberData(
            nameof(DoubleTests.Parse_ValidWithOffsetCount_TestData),
            MemberType = typeof(DoubleTests)
        )]
        ...
        )
        {
            ...
            )
            {
                ...
                {
                    Assert.True(
                        SpanParsableHelper<double>.TryParse(
                    ...
                    Assert.Equal(
                        expected,
                        SpanParsableHelper<double>.Parse(value.AsSpan(offset, count), null)
                    );
                }

                Assert.Equal(
                    expected,
                    SpanParsableHelper<double>.Parse(
                        value.AsSpan(offset, count),
                        provider: provider
                    )
                );
            ...
            Assert.Equal(
                expected,
                NumberBaseHelper<double>.Parse(value.AsSpan(offset, count), style, provider)
            );
        ...
        )
        {
            if (value != null)
            {
                Assert.Throws(
                    exceptionType,
                    () => NumberBaseHelper<double>.Parse(value.AsSpan(), style, provider)
                );
