...
namespace System.Tests
{
    public class DoubleTests_GenericMath
    {
        ...
        {
            Assert.False(
                ComparisonOperatorsHelper<double, double>.op_GreaterThan(
                    double.NegativeInfinity,
                    1.0
                )
            );
            Assert.False(
                ComparisonOperatorsHelper<double, double>.op_GreaterThan(double.MinValue, 1.0)
            );
            ...
            Assert.False(
                ComparisonOperatorsHelper<double, double>.op_GreaterThan(-MaxSubnormal, 1.0)
            );
            Assert.False(
                ComparisonOperatorsHelper<double, double>.op_GreaterThan(-double.Epsilon, 1.0)
            );
            ...
            Assert.False(ComparisonOperatorsHelper<double, double>.op_GreaterThan(1.0, 1.0));
            Assert.True(
                ComparisonOperatorsHelper<double, double>.op_GreaterThan(double.MaxValue, 1.0)
            );
            Assert.True(
                ComparisonOperatorsHelper<double, double>.op_GreaterThan(
                    double.PositiveInfinity,
        ...
        {
            Assert.False(
                ComparisonOperatorsHelper<double, double>.op_GreaterThanOrEqual(
                    double.NegativeInfinity,
                    1.0
                )
            );
            ...
            Assert.False(
                ComparisonOperatorsHelper<double, double>.op_GreaterThanOrEqual(-1.0, 1.0)
            );
            Assert.False(
                ComparisonOperatorsHelper<double, double>.op_GreaterThanOrEqual(-MinNormal, 1.0)
            );
            Assert.False(
                ComparisonOperatorsHelper<double, double>.op_GreaterThanOrEqual(-MaxSubnormal, 1.0)
            );
            Assert.False(
                ComparisonOperatorsHelper<double, double>.op_GreaterThanOrEqual(
                    -double.Epsilon,
            ...
            Assert.False(
                ComparisonOperatorsHelper<double, double>.op_GreaterThanOrEqual(-0.0, 1.0)
            );
            Assert.False(
                ComparisonOperatorsHelper<double, double>.op_GreaterThanOrEqual(double.NaN, 1.0)
            );
            Assert.False(ComparisonOperatorsHelper<double, double>.op_GreaterThanOrEqual(0.0, 1.0));
            Assert.False(
                ComparisonOperatorsHelper<double, double>.op_GreaterThanOrEqual(double.Epsilon, 1.0)
            );
            Assert.False(
                ComparisonOperatorsHelper<double, double>.op_GreaterThanOrEqual(MaxSubnormal, 1.0)
            );
        ...
        {
            Assert.True(
                ComparisonOperatorsHelper<double, double>.op_LessThan(double.NegativeInfinity, 1.0)
            );
            Assert.True(
                ComparisonOperatorsHelper<double, double>.op_LessThan(double.MinValue, 1.0)
            );
            ...
            Assert.True(
                ComparisonOperatorsHelper<double, double>.op_LessThan(-double.Epsilon, 1.0)
            );
            ...
            Assert.False(
                ComparisonOperatorsHelper<double, double>.op_LessThan(double.MaxValue, 1.0)
            );
            Assert.False(
                ComparisonOperatorsHelper<double, double>.op_LessThan(double.PositiveInfinity, 1.0)
            );
        }
        ...
        {
            Assert.True(
                ComparisonOperatorsHelper<double, double>.op_LessThanOrEqual(
                    double.NegativeInfinity,
                    1.0
                )
            );
            Assert.True(
                ComparisonOperatorsHelper<double, double>.op_LessThanOrEqual(double.MinValue, 1.0)
            );
            Assert.True(ComparisonOperatorsHelper<double, double>.op_LessThanOrEqual(-1.0, 1.0));
            Assert.True(
                ComparisonOperatorsHelper<double, double>.op_LessThanOrEqual(-MinNormal, 1.0)
            );
            Assert.True(
                ComparisonOperatorsHelper<double, double>.op_LessThanOrEqual(-MaxSubnormal, 1.0)
            );
            Assert.True(
                ComparisonOperatorsHelper<double, double>.op_LessThanOrEqual(-double.Epsilon, 1.0)
            );
            Assert.True(ComparisonOperatorsHelper<double, double>.op_LessThanOrEqual(-0.0, 1.0));
            Assert.False(
                ComparisonOperatorsHelper<double, double>.op_LessThanOrEqual(double.NaN, 1.0)
            );
            Assert.True(ComparisonOperatorsHelper<double, double>.op_LessThanOrEqual(0.0, 1.0));
            Assert.True(
                ComparisonOperatorsHelper<double, double>.op_LessThanOrEqual(double.Epsilon, 1.0)
            ...
            Assert.True(ComparisonOperatorsHelper<double, double>.op_LessThanOrEqual(1.0, 1.0));
            Assert.False(
                ComparisonOperatorsHelper<double, double>.op_LessThanOrEqual(double.MaxValue, 1.0)
            );
            Assert.False(
                ComparisonOperatorsHelper<double, double>.op_LessThanOrEqual(
                    double.PositiveInfinity,
        ...
        {
            Assert.False(
                EqualityOperatorsHelper<double, double>.op_Equality(double.NegativeInfinity, 1.0)
            );
            ...
            Assert.False(
                EqualityOperatorsHelper<double, double>.op_Equality(double.PositiveInfinity, 1.0)
            );
        }
        ...
        {
            Assert.True(
                EqualityOperatorsHelper<double, double>.op_Inequality(double.NegativeInfinity, 1.0)
            );
            Assert.True(
                EqualityOperatorsHelper<double, double>.op_Inequality(double.MinValue, 1.0)
            );
            ...
            Assert.True(
                EqualityOperatorsHelper<double, double>.op_Inequality(-double.Epsilon, 1.0)
            );
            ...
            Assert.True(
                EqualityOperatorsHelper<double, double>.op_Inequality(double.MaxValue, 1.0)
            );
            Assert.True(
                EqualityOperatorsHelper<double, double>.op_Inequality(double.PositiveInfinity, 1.0)
            );
        }
