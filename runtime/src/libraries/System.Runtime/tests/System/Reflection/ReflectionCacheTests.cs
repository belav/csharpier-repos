...
namespace System.Reflection.Tests
{
    ...
    public class ReflectionCacheTests
    {
        ...
        {
            MethodInfo mi1 = typeof(ReflectionCacheTests)
                .GetMethod(nameof(GetMethod_MultipleCalls_SameObjects));
            Assert.NotNull(mi1);
        ...
        public void GetMethod_MultipleCalls_ClearCache_DifferentObjects(bool justSpecificType)
        {
            ...
            MethodInfo mi1 = typeof(ReflectionCacheTests)
                .GetMethod(nameof(GetMethod_MultipleCalls_ClearCache_DifferentObjects));
            Assert.NotNull(mi1);
