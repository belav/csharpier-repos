...
namespace System.Reflection.Tests
{
    ...
    {
        private static readonly NullabilityInfoContext nullabilityContext =
        ...
        )
        {
            ...
            Assert.Equal(
                readState,
                nullabilityContext.Create(property.GetMethod.ReturnParameter).ReadState
            );
            Assert.Equal(writeState, nullability.WriteState);
            if (property.SetMethod != null)
            {
                Assert.Equal(
                    writeState,
                    nullabilityContext.Create(property.SetMethod.GetParameters()[0]).WriteState
                );
            }
            Assert.Equal(type, nullability.Type);
            Assert.Empty(nullability.GenericTypeArguments);
        ...
        public void ArrayPropertyTest(
            string propertyName,
            NullabilityState elementState,
            NullabilityState propertyState
        )
        {
            PropertyInfo property = testType.GetProperty(propertyName, flags);
            NullabilityInfo nullability = nullabilityContext.Create(property);
        ...
        public void JaggedArrayPropertyTest(
            string propertyName,
            NullabilityState innermodtElementState,
            NullabilityState elementState,
            NullabilityState propertyState
        )
        {
        ...
        public void TuplePropertyTest(
            string propertyName,
            NullabilityState genericParam1,
            NullabilityState genericParam2,
            NullabilityState genericParam3,
            NullabilityState propertyState
        )
        {
            PropertyInfo property = testType.GetProperty(propertyName, flags);
        ...
        public void GenericTuplePropertyTest(
            string propertyName,
            NullabilityState genericParam1,
            NullabilityState genericParam2,
            NullabilityState genericParam3,
        ...
        public static IEnumerable<object[]> DictionaryPropertyTestData()
        {
            ...
            yield return new object[]
            {
                "PropertyDictionaryNullNullNullNon",
                NullabilityState.Nullable,
                NullabilityState.Nullable,
                NullabilityState.Nullable,
                NullabilityState.NotNull,
            ...
            yield return new object[]
            {
                "PropertyDictionaryNullNonNonNull",
                NullabilityState.Nullable,
                NullabilityState.NotNull,
                NullabilityState.NotNull,
                NullabilityState.Nullable,
            ...
            yield return new object[]
            {
                "PropertyDictionaryNonNullNonNon",
                NullabilityState.NotNull,
                NullabilityState.Nullable,
                NullabilityState.NotNull,
                NullabilityState.NotNull,
            ...
            yield return new object[]
            {
                "PropertyDictionaryNonNonNonNull",
                NullabilityState.NotNull,
                NullabilityState.NotNull,
                NullabilityState.NotNull,
                NullabilityState.Nullable,
            ...
            yield return new object[]
            {
                "PropertyDictionaryNonNonNonNon",
                NullabilityState.NotNull,
                NullabilityState.NotNull,
                NullabilityState.NotNull,
                NullabilityState.NotNull,
        ...
        public void DictionaryPropertyTest(
            string propertyName,
            NullabilityState keyState,
            NullabilityState valueElement,
            NullabilityState valueState,
            NullabilityState propertyState
        )
        {
            PropertyInfo property = testType.GetProperty(propertyName, flags);
        ...
        public void GenericDictionaryPropertyTest(
            string propertyName,
            NullabilityState keyState,
            NullabilityState valueElement,
            NullabilityState valueState,
...
#nullable enable
        ...
        public void GenericPropertyReferenceTypeTest(
            string fieldName,
            NullabilityState readState,
            NullabilityState writeState,
            Type type
        ...
        {
            PropertyInfo property = typeof(GenericTest<TypeWithNotNullContext?>).GetProperty(
                fieldName,
                flags
            )!;
            NullabilityInfo nullability = nullabilityContext.Create(property);
        ...
        public void GenericFieldReferenceTypeTest(
            string fieldName,
            NullabilityState readState,
            NullabilityState writeState,
            Type type
        ...
        {
            FieldInfo field = typeof(GenericTest<TypeWithNotNullContext?>).GetField(
                fieldName,
                flags
            )!;
            NullabilityInfo nullability = nullabilityContext.Create(field);
        ...
        public void GenericFieldNullableValueTypeTest(
            string fieldName,
            NullabilityState readState,
            NullabilityState writeState,
            Type type
        ...
        public void GenericNotNullConstraintFieldsTest(
            string fieldName,
            NullabilityState readState,
            NullabilityState writeState,
            Type type
        ...
        {
            FieldInfo field = typeof(GenericTestConstrainedNotNull<string>).GetField(
                fieldName,
                flags
            )!;
            NullabilityInfo nullability = nullabilityContext.Create(field);
        ...
        public void GenericNotNullConstraintPropertiesTest(
            string propertyName,
            NullabilityState readState,
            NullabilityState writeState,
            Type type
        ...
        {
            PropertyInfo property = typeof(GenericTestConstrainedNotNull<string>).GetProperty(
                propertyName,
                flags
            )!;
            NullabilityInfo nullability = nullabilityContext.Create(property);
        ...
        public void GenericStructConstraintFieldsTest(
            string fieldName,
            NullabilityState readState,
            NullabilityState writeState,
            Type type
        ...
        public void GenericStructConstraintPropertiesTest(
            string propertyName,
            NullabilityState readState,
            NullabilityState writeState,
            Type type
        ...
        {
            PropertyInfo property = typeof(GenericTestConstrainedStruct<int>).GetProperty(
                propertyName,
                flags
            )!;
            NullabilityInfo nullability = nullabilityContext.Create(property);
        ...
        public void GenericListAndDictionaryFieldTest()
        {
            ...
            Assert.Equal(
                NullabilityState.Nullable,
                listNullability.GenericTypeArguments[0].ReadState
            );
            ...
            Assert.Equal(
                NullabilityState.NotNull,
                dictNullability.GenericTypeArguments[0].ReadState
            );
            Assert.Equal(
                NullabilityState.Nullable,
                dictNullability.GenericTypeArguments[1].ReadState
            );
        ...
        public void MethodReturnParameterTest(
            string methodName,
            NullabilityState elementState,
            NullabilityState readState
        )
        ...
        public void MethodReturnsTupleTest(
            string methodName,
            NullabilityState param1,
            NullabilityState param2,
            NullabilityState readState
        )
        {
            MethodInfo method = testType.GetMethod(methodName, flags)!;
        ...
        public void MethodGenericReturnParameterTest(
            string methodName,
            NullabilityState readState,
            NullabilityState elementState
        )
        {
            MethodInfo method = typeof(GenericTest<TypeWithNotNullContext?>).GetMethod(
                methodName,
                flags
            )!;
            NullabilityInfo nullability = nullabilityContext.Create(method.ReturnParameter);
        ...
        public void MethodParametersTest(
            string methodName,
            NullabilityState stringState,
            NullabilityState dictKey,
            NullabilityState dictValueElement,
            NullabilityState dictValue,
            NullabilityState dictionaryState
        )
        {
            ...
            Assert.Equal(
                dictValueElement,
                dictionaryNullability.GenericTypeArguments[1].ElementType!.ReadState
            );
            Assert.Null(dictionaryNullability.ElementType);
        }

        public static IEnumerable<object[]> MethodByRefParametersTestData() =>
            new[]
            {
        ...
        {
            MethodInfo method = typeof(TypeWithNotNullContext).GetMethod(
                nameof(TypeWithNotNullContext.MethodWithByRefs)
            )!;
        ...
        public static IEnumerable<object?[]> MethodGenericByRefParametersTestData() =>
            new[]
            {
        ...
        {
            MethodInfo method = typeof(TypeWithNotNullContext).GetMethod(
                nameof(TypeWithNotNullContext.MethodWithGenericByRefs)
            )!;
            ParameterInfo parameter =
                parameterIndex == -1
                    ? method.ReturnParameter
            ...
            NullabilityState?[] genericArgumentStates = new[]
            {
        ...
        public void ConstrainedGenericMethodWithByRefTest()
        {
            ...
            MethodInfo method = typeof(TypeWithNotNullContext)
                .GetMethod(nameof(TypeWithNotNullContext.ConstrainedGenericMethodWithByRef))!
        ...
        public void MethodWithPointersTest()
        {
            ...
            MethodInfo method = typeof(TypeWithNotNullContext).GetMethod(
                nameof(TypeWithNotNullContext.MethodWithPointers)
            )!;
        ...
        public unsafe void GenericMethodWithPointersTest()
        {
            ...
            MethodInfo method = typeof(TypeWithNotNullContext)
                .GetMethod(nameof(TypeWithNotNullContext.GenericMethodWithPointers))!
        ...
        public static IEnumerable<object[]> MethodGenericParametersTestData()
        {
            ...
            yield return new object[]
            {
                "MethodArgsNullGenericNullDictValueGeneric",
                NullabilityState.Nullable,
                NullabilityState.NotNull,
                NullabilityState.Nullable,
                NullabilityState.Nullable,
            ...
            yield return new object[]
            {
                "MethodArgsGenericDictValueNullGeneric",
                NullabilityState.Nullable,
                NullabilityState.NotNull,
                NullabilityState.Nullable,
                NullabilityState.NotNull,
        ...
        public void MethodGenericParametersTest(
            string methodName,
            NullabilityState param1State,
            NullabilityState dictKey,
            NullabilityState dictValue,
            NullabilityState dictionaryState
        )
        {
            ParameterInfo[] parameters = typeof(GenericTest<TypeWithNotNullContext>)
        ...
        public void PropertyWithByRefGenericParametersTest()
        {
            ...
            PropertyInfo property = typeof(GenericTest<string>).GetProperty(
                "Item",
        ...
        public void NullablePublicOnlyStringTypeTest(
            string methodName,
            NullabilityState param1State,
            NullabilityState param2State,
            NullabilityState param3State,
            Type[] types
        )
        {
            ParameterInfo[] parameters = typeof(string)
        ...
        public void NullablePublicOnlyOtherTypesTest()
        {
            ...
            PropertyInfo publicGetPrivateSetNullableProperty = typeof(FileSystemEntry).GetProperty(
                "Directory",
                flags
            )!;
            ...
            ConstructorInfo privateConstructor = typeof(IndexOutOfRangeException).GetConstructor(
        ...
        public void AttributedParametersTest()
        {
            ...
            NullabilityInfo readNotNull = nullabilityContext.Create(
                nullableNotNullIfNotNullReturn[1]
            );
            ...
            Assert.Equal(
                NullabilityState.NotNull,
                nullabilityContext.Create(tryGetOutParameters[0]).ReadState
            );
        }
        ...
        public static IEnumerable<object[]> NestedGenericsCorrectOrderData()
        {
            yield return new object[]
            {
                ...
                new[]
                {
                    typeof(Tuple<Tuple<string, string>, string>),
        ...
        [SkipOnMono("Nullability attributes trimmed on Mono")]
        public void NestedGenericsCorrectOrderTest(
            string methodName,
            NullabilityState[] nullStates,
            Type[] types
        )
        {
            NullabilityInfo parentInfo = nullabilityContext.Create(
                typeof(TypeWithNotNullContext).GetMethod(methodName)!.ReturnParameter
            );
            var dataIndex = 0;
            Examine(parentInfo);
        ...
        [SkipOnMono("Nullability attributes trimmed on Mono")]
        public void NestedGenericsReturnParameterTest(
            string methodName,
            NullabilityState enumState,
            NullabilityState innerTupleState,
            NullabilityState intState,
            NullabilityState outerTupleState,
            NullabilityState stringState,
            NullabilityState objectState
        )
        {
            NullabilityInfo enumerabeNullability = nullabilityContext.Create(
                typeof(TypeWithNotNullContext).GetMethod(methodName, flags)!.ReturnParameter
            );
        ...
        public void RefReturnTestTest(
            string methodName,
            NullabilityState retReadState,
            NullabilityState retWriteState,
            NullabilityState paramReadState,
            NullabilityState paramWriteState
        )
        {
        ...
        [SkipOnMono("Nullability attributes trimmed on Mono")]
        public void TestValueTupleGenericTypeParameters(
            string fieldName,
            NullabilityState param1,
            NullabilityState param2,
            NullabilityState fieldState
        )
        {
        ...
        public void TestGenericInheritance(
            Type listType,
            NullabilityState parameterState,
            NullabilityState? subState
        )
        {
            var addParameterInfo = nullabilityContext.Create(
                listType.GetMethod("Add")!.GetParameters()[0]
            );
            Validate(addParameterInfo);

            var copyToParameterInfo = nullabilityContext.Create(
                listType
                    .GetMethod("CopyTo", new[] { addParameterInfo.Type.MakeArrayType() })!
                    .GetParameters()[0]
            );
        ...
        public void TestDeeplyNestedGenericInheritance()
        {
            var copyToMethodInfo = nullabilityContext.Create(
                typeof(ListOfTupleOfDictionaryOfStringNullableBoolIntNullableObject)
                    .GetMethod(
                        "CopyTo",
                        new[] { typeof((Dictionary<string, bool?>, int, object?)[]) }
                    )!
                    .GetParameters()[0]
            );
            ...
            Validate(
                copyToMethodInfo,
                typeof((Dictionary<string, bool?>, int, object?)[]),
                NullabilityState.NotNull
            );
        ...
        {
            var item3Info = nullabilityContext.Create(
                typeof(DerivesFromTupleOfNestedGenerics).GetProperty("Item3")!
            );
        ...
        public static IEnumerable<object[]> TestNullabilityInfoCreationOnPropertiesWithNestedGenericTypeArgumentsData() =>
            new[]
            {
                new object[]
                {
        ...
        [SkipOnMono("Nullability attributes trimmed on Mono")]
        [MemberData(
            nameof(TestNullabilityInfoCreationOnPropertiesWithNestedGenericTypeArgumentsData)
        )]
        public void TestNullabilityInfoCreationOnPropertiesWithNestedGenericTypeArguments(
            Type type,
            NullabilityState expectedGenericArgumentNullability
        )
        {
            ...
            Assert.Equal(
                expectedGenericArgumentNullability,
            ...
            Assert.Equal(
                expectedGenericArgumentNullability,
                info.GenericTypeArguments[0].GenericTypeArguments[0].ReadState
            );
            ...
            Assert.Equal(
                expectedGenericArgumentNullability,
                info.GenericTypeArguments[1].GenericTypeArguments[0].ReadState
            );
            ...
            Assert.Equal(
                expectedGenericArgumentNullability,
                info.GenericTypeArguments[2].GenericTypeArguments[0].ReadState
            );
            ...
            Assert.Equal(
                NullabilityState.NotNull,
                info.GenericTypeArguments[2].GenericTypeArguments[1].ReadState
            );
        }

        private static Type EnsureReflection(
            [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.All)] Type type
        ) => type;

        public static IEnumerable<object[]> TestCtorParametersData() =>
            new object[][]
            {
        ...
        public void TestCtorParameters(
            [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)]
                Type type,
            NullabilityState expectedRead,
            NullabilityState expectedWrite
        )
        {
        ...
        public void TestMethodsWithOpenGenericParameters(
        ...
        public void TestMethodsWithGenericParameters(
            Delegate @delegate,
            NullabilityState expectedRead,
            NullabilityState expectedWrite
        )
...
#nullable enable
        ...
        public string? AllowNullParameter(
            ...
            [NotNullIfNotNull(nameof(allowNull))] string? notNullIfNotNull
        )
        {
            return null;
        }
        ...
        public string? NullableNotNullIfNotNullReturn(
            string? nullable,
            [NotNull] ref string? readNotNull
        )
        {
...
#nullable enable
        ...
        public IDictionary<Type?, string?[]?> PropertyDictionaryNullNullNullNon { get; set; } =
            null!;
        ...
        public IEnumerable<(
            GenericStruct<string, object?> str,
            int? count
        )> MethodReturnsEnumerableNonValueTupleNonNullNonStructNonNullNon() => null!;

        public Tuple<
            Tuple<string?, string?>,
            string?
        > MethodReturnsNonTupleNonTupleNullStringNullStringNullString() => null!;
...
#nullable enable
    ...
    {
        public DerivesFromTupleOfNestedGenerics(
            List<string[]> item1,
    ...
    {
        public GenericTypeWithCtor_Maybe([MaybeNull] out T value)
        {
            value = default;
        }
    }
    ...
    public class GenericNonNullableTypeWithCtor<T>
        where T : notnull
    {
        public GenericNonNullableTypeWithCtor(T value) { }
    }

    public class GenericNonNullableTypeWithCtor_Disallow<T>
        where T : notnull
    {
        public GenericNonNullableTypeWithCtor_Disallow([DisallowNull] T value) { }
    }

    public class GenericNonNullableTypeWithCtor_Maybe<T>
        where T : notnull
    {
        public GenericNonNullableTypeWithCtor_Maybe([MaybeNull] out T value)
        {
            value = default;
        }
    }

    public class GenericNonNullableTypeWithCtor_Allow<T>
        where T : notnull
    {
    ...
    public class ClassWithGenericMethods
    {
        ...
        public static void GenericNotNullMethod<T>(T value)
            where T : notnull => throw new Exception();
    }
    ...
    public class ClassWithGenericMethods_Disallow
    {
        ...
        public static void GenericNotNullMethod<T>([DisallowNull] T value)
            where T : notnull => throw new Exception();
    }
    ...
    public class ClassWithGenericMethods_Maybe
    {
        ...
        public static void GenericNotNullMethod<T>([MaybeNull] out T value)
            where T : notnull => throw new Exception();
    }
    ...
    public class ClassWithGenericMethods_Allow
    {
        ...
        public static void GenericNotNullMethod<T>([AllowNull] T value)
            where T : notnull => throw new Exception();
    }
}
