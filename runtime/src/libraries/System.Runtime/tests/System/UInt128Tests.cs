...
namespace System.Tests
{
    public class UInt128Tests
    {
        ...
        public static IEnumerable<object[]> ToString_TestData()
        {
            foreach (NumberFormatInfo defaultFormat in new[] { null, NumberFormatInfo.CurrentInfo })
            {
                foreach (string defaultSpecifier in new[] { "G", "G\0", "\0N222", "\0", "", "R" })
                {
                    ...
                    yield return new object[]
                    {
                        new UInt128(0x0000_0000_0000_0001, 0x0000_0000_0000_0003),
                        defaultSpecifier,
                        defaultFormat,
                    ...
                    yield return new object[]
                    {
                        new UInt128(0x0000_0000_0000_0001, 0x0000_0000_0000_000A),
                        defaultSpecifier,
                        defaultFormat,
                    ...
                    yield return new object[]
                    {
                        new UInt128(0x0000_0000_0000_0005, 0x0000_0000_0000_0001),
                        defaultSpecifier,
                        defaultFormat,
                    ...
                    yield return new object[]
                    {
                        new UInt128(0x0000_0000_0000_0005, 0x6BC7_5E2D_6310_0000),
                        defaultSpecifier,
                        defaultFormat,
                    ...
                    yield return new object[]
                    {
                        new UInt128(0x0000_0000_0000_0036, 0x35C9_ADC5_DEA0_0000),
                        defaultSpecifier,
                        defaultFormat,
                    ...
                    yield return new object[]
                    {
                        new UInt128(0x0013_4261_72C7_4D82, 0x2B87_8FE8_0000_0000),
                        defaultSpecifier,
                        defaultFormat,
            ...
            yield return new object[]
            {
                ...
                "n5",
                customFormat,
                "340*282*366*920*938*463*463*374*607*431*768*211*455~00000"
            };
        }
        ...
        public static IEnumerable<object[]> Parse_Invalid_TestData()
        {
            ...
            {
                if (
                    (Type)objs[3] == typeof(OverflowException)
                    && (
            ...
            foreach (string ws in new[] { "", "    " })
            {
                ...
                yield return new object[]
                {
                    ws + "abc123" + ws,
                    NumberStyles.Integer,
                    new NumberFormatInfo { NegativeSign = "abc" },
                    typeof(OverflowException)
                };
            }
