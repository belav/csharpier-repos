    ...
    public static class DateTimeOffsetTests
    {
        ...
        public static void Ctor_DateTime()
        {
            ...
            dateTimeOffset = new DateTimeOffset(
                new DateTime(1986, 8, 15, 10, 20, 5, 4, DateTimeKind.Local)
            );
        ...
        public static void ParseExact_ToStringThenParseExactRoundtrip_Success(string standardFormat)
        {
            ...
            for (int i = 0; i < 200; i++) // test with a bunch of random dates
            {
                ...
                try
                {
                    ...
                    Assert.Equal(
                        expected,
                        DateTimeOffset.ParseExact(expected, standardFormat, null)
        ...
        public static void ToString_Slice_ParseSpan_RoundtripsSuccessfully(string roundtripFormat)
        {
            ...
            Assert.Equal(
                expectedString,
                DateTimeOffset.Parse(expectedSpan, null, DateTimeStyles.None)
        ...
        public static void ToString_ParseExactSpan_RoundtripsSuccessfully()
        {
            ...
            Assert.Equal(
                expectedString,
                DateTimeOffset.ParseExact(expectedString, "u", null, DateTimeStyles.None)
                    .ToString("u")
            );
            Assert.Equal(
                expectedString,
                DateTimeOffset.ParseExact(expectedString, new[] { "u" }, null, DateTimeStyles.None)
                    .ToString("u")
            );
