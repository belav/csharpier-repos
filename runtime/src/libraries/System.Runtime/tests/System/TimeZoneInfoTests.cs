...
namespace System.Tests
{
    public static partial class TimeZoneInfoTests
    {
        ...
        public static void TestSplittingRulesWhenReported()
        {
            ...
            TimeZoneInfo.AdjustmentRule[] rules = TimeZoneInfo.FindSystemTimeZoneById(s_strPacific)
                .GetAdjustmentRules();
        ...
        {
            TimeZoneInfo utcObject = TimeZoneInfo.GetSystemTimeZones()
        ...
        public static bool SupportIanaNamesConversion =>
            PlatformDetection.IsNotBrowser && PlatformDetection.ICUVersion.Major >= 52;
        ...
        public static void IsIanaIdTest()
        {
            ...
            Assert.False(
                ...
                $"`Pacific Standard Time` should not be IANA Id."
            );
            Assert.True(
