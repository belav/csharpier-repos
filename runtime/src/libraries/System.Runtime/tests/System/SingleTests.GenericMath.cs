...
namespace System.Tests
{
    public class SingleTests_GenericMath
    {
        ...
        {
            Assert.False(
                ComparisonOperatorsHelper<float, float>.op_GreaterThan(float.NegativeInfinity, 1.0f)
            );
            Assert.False(
                ComparisonOperatorsHelper<float, float>.op_GreaterThan(float.MinValue, 1.0f)
            );
            ...
            Assert.False(
                ComparisonOperatorsHelper<float, float>.op_GreaterThan(-MaxSubnormal, 1.0f)
            );
            Assert.False(
                ComparisonOperatorsHelper<float, float>.op_GreaterThan(-float.Epsilon, 1.0f)
            );
            ...
            Assert.False(ComparisonOperatorsHelper<float, float>.op_GreaterThan(1.0f, 1.0f));
            Assert.True(
                ComparisonOperatorsHelper<float, float>.op_GreaterThan(float.MaxValue, 1.0f)
            );
            Assert.True(
                ComparisonOperatorsHelper<float, float>.op_GreaterThan(float.PositiveInfinity, 1.0f)
            );
        }
        ...
        {
            Assert.False(
                ComparisonOperatorsHelper<float, float>.op_GreaterThanOrEqual(
                    float.NegativeInfinity,
                    1.0f
                )
            );
            Assert.False(
                ComparisonOperatorsHelper<float, float>.op_GreaterThanOrEqual(float.MinValue, 1.0f)
            );
            Assert.False(
                ComparisonOperatorsHelper<float, float>.op_GreaterThanOrEqual(-1.0f, 1.0f)
            );
            Assert.False(
                ComparisonOperatorsHelper<float, float>.op_GreaterThanOrEqual(-MinNormal, 1.0f)
            );
            Assert.False(
                ComparisonOperatorsHelper<float, float>.op_GreaterThanOrEqual(-MaxSubnormal, 1.0f)
            );
            Assert.False(
                ComparisonOperatorsHelper<float, float>.op_GreaterThanOrEqual(-float.Epsilon, 1.0f)
            );
            Assert.False(
                ComparisonOperatorsHelper<float, float>.op_GreaterThanOrEqual(-0.0f, 1.0f)
            );
            Assert.False(
                ComparisonOperatorsHelper<float, float>.op_GreaterThanOrEqual(float.NaN, 1.0f)
            );
            ...
            Assert.True(
                ComparisonOperatorsHelper<float, float>.op_GreaterThanOrEqual(float.MaxValue, 1.0f)
            );
            Assert.True(
                ComparisonOperatorsHelper<float, float>.op_GreaterThanOrEqual(
                    float.PositiveInfinity,
        ...
        {
            Assert.True(
                ComparisonOperatorsHelper<float, float>.op_LessThan(float.NegativeInfinity, 1.0f)
            );
            ...
            Assert.False(
                ComparisonOperatorsHelper<float, float>.op_LessThan(float.PositiveInfinity, 1.0f)
            );
        }
        ...
        {
            Assert.True(
                ComparisonOperatorsHelper<float, float>.op_LessThanOrEqual(
                    float.NegativeInfinity,
                    1.0f
                )
            );
            Assert.True(
                ComparisonOperatorsHelper<float, float>.op_LessThanOrEqual(float.MinValue, 1.0f)
            );
            Assert.True(ComparisonOperatorsHelper<float, float>.op_LessThanOrEqual(-1.0f, 1.0f));
            Assert.True(
                ComparisonOperatorsHelper<float, float>.op_LessThanOrEqual(-MinNormal, 1.0f)
            );
            Assert.True(
                ComparisonOperatorsHelper<float, float>.op_LessThanOrEqual(-MaxSubnormal, 1.0f)
            );
            Assert.True(
                ComparisonOperatorsHelper<float, float>.op_LessThanOrEqual(-float.Epsilon, 1.0f)
            );
            Assert.True(ComparisonOperatorsHelper<float, float>.op_LessThanOrEqual(-0.0f, 1.0f));
            Assert.False(
                ComparisonOperatorsHelper<float, float>.op_LessThanOrEqual(float.NaN, 1.0f)
            );
            Assert.True(ComparisonOperatorsHelper<float, float>.op_LessThanOrEqual(0.0f, 1.0f));
            Assert.True(
                ComparisonOperatorsHelper<float, float>.op_LessThanOrEqual(float.Epsilon, 1.0f)
            ...
            Assert.True(ComparisonOperatorsHelper<float, float>.op_LessThanOrEqual(1.0f, 1.0f));
            Assert.False(
                ComparisonOperatorsHelper<float, float>.op_LessThanOrEqual(float.MaxValue, 1.0f)
            );
            Assert.False(
                ComparisonOperatorsHelper<float, float>.op_LessThanOrEqual(
                    float.PositiveInfinity,
        ...
        {
            Assert.False(
                EqualityOperatorsHelper<float, float>.op_Equality(float.NegativeInfinity, 1.0f)
            );
            ...
            Assert.False(
                EqualityOperatorsHelper<float, float>.op_Equality(float.PositiveInfinity, 1.0f)
            );
        }
        ...
        {
            Assert.True(
                EqualityOperatorsHelper<float, float>.op_Inequality(float.NegativeInfinity, 1.0f)
            );
            ...
            Assert.True(
                EqualityOperatorsHelper<float, float>.op_Inequality(float.PositiveInfinity, 1.0f)
            );
        }
