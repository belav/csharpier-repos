...
namespace System.IO.Tests
{
    public class BinaryWriter_WriteTests
    {
        ...
        public void BinaryWriter_Write7BitEncodedInt64Test()
        {
            ...
            WriteTest(
                i64arr,
                (bw, s) => bw.Write7BitEncodedInt64(s),
                (br) => br.Read7BitEncodedInt64()
            );
        }
