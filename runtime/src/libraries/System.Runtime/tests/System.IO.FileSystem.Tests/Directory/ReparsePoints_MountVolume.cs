                        ...
                        try
                        {
                            ...
                            )
                            {
                                ...
                                files = Directory.GetFiles(
                                    dirNameReferredFromMountedDrive,
                                    "*.*",
                                ...
                                {
                                    string exDir = dirs[i]
                                        .Substring(dirNameReferredFromMountedDrive.Length);
                                    if (
                                        Eval(
                                            list.Contains(exDir),
