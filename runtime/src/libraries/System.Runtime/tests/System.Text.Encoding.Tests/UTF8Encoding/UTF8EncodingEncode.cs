    ...
    public class UTF8EncodingEncode
    {
        public static IEnumerable<object[]> Encode_TestData()
        {
            ...
            yield return new object[]
            {
                ...
                0,
                7,
                new byte[] { 122, 97, 204, 134, 199, 189, 206, 178, 241, 143, 179, 191 },
            };
            yield return new object[]
            {
                "za\u0306\u01FD\u03B2\uD8FF\uDCFF",
                4,
                3,
                new byte[] { 206, 178, 241, 143, 179, 191 },
            };
            ...
            yield return new object[]
            {
                ...
                0,
                5,
                new byte[] { 0x65, 0x65, 0x65, 0x65, 0x65 },
            };
            yield return new object[]
            {
                "e\u00E1eee",
                0,
                5,
                new byte[] { 0x65, 0xC3, 0xA1, 0x65, 0x65, 0x65 },
            };
            yield return new object[]
            {
                "\u0065\u8000\u0065\u0065\u0065",
                0,
                5,
                new byte[] { 0x65, 0xE8, 0x80, 0x80, 0x65, 0x65, 0x65 },
            };
            yield return new object[]
            {
                "\u0065\uD800\uDC00\u0065\u0065\u0065",
                0,
                6,
                new byte[] { 0x65, 0xF0, 0x90, 0x80, 0x80, 0x65, 0x65, 0x65 },
            };
            ...
            yield return new object[]
            {
                ...
                0,
                5,
                new byte[] { 0xC3, 0xA1, 0xC3, 0xA1, 0xC3, 0xA1, 0xC3, 0xA1, 0xC3, 0xA1 },
            };
            yield return new object[]
            {
                "\u00E1e\u00E1\u00E1\u00E1",
                0,
                5,
                new byte[] { 0xC3, 0xA1, 0x65, 0xC3, 0xA1, 0xC3, 0xA1, 0xC3, 0xA1 },
            };
            yield return new object[]
            {
                "\u00E1\u8000\u00E1\u00E1\u00E1",
                0,
                5,
                new byte[] { 0xC3, 0xA1, 0xE8, 0x80, 0x80, 0xC3, 0xA1, 0xC3, 0xA1, 0xC3, 0xA1 },
            };
            yield return new object[]
            {
                "\u00E1\uD800\uDC00\u00E1\u00E1\u00E1",
            ...
            yield return new object[]
            {
                ...
                0,
                4,
                new byte[] { 0xE8, 0x80, 0x80, 0x65, 0xE8, 0x80, 0x80, 0xE8, 0x80, 0x80 },
            };
            yield return new object[]
            {
                "\u8000\u00E1\u8000\u8000",
                0,
                4,
                new byte[] { 0xE8, 0x80, 0x80, 0xC3, 0xA1, 0xE8, 0x80, 0x80, 0xE8, 0x80, 0x80 },
            };
            yield return new object[]
            {
                "\u8000\uD800\uDC00\u8000\u8000",
            ...
            yield return new object[]
            {
                ...
                0,
                5,
                new byte[] { 0xF0, 0x90, 0x80, 0x80, 0x65, 0xF0, 0x90, 0x80, 0x80 },
            };
            ...
            yield return new object[]
            {
                ...
                0,
                5,
                new byte[] { 0xF0, 0x90, 0x80, 0x80, 0xC3, 0xA1, 0xF0, 0x90, 0x80, 0x80 },
            };
            yield return new object[]
            {
                "\uD800\uDC00\u8000\uD800\uDC00",
                0,
                5,
                new byte[] { 0xF0, 0x90, 0x80, 0x80, 0xE8, 0x80, 0x80, 0xF0, 0x90, 0x80, 0x80 },
            };
        ...
        public static IEnumerable<object[]> Encode_InvalidChars_TestData()
        {
            ...
            yield return new object[]
            {
                ...
                0,
                3,
                new byte[] { 0x41, 0xEF, 0xBF, 0xBD, 0xEE, 0x80, 0x80 },
            };
            yield return new object[]
            {
                "\uD800\u0041\uDC00",
                0,
                3,
                new byte[] { 0xEF, 0xBF, 0xBD, 0x41, 0xEF, 0xBF, 0xBD },
            };
            yield return new object[]
            {
                "\uD800\u0041\u0042\u07FF\u0043\uDC00",
                0,
                6,
                new byte[] { 0xEF, 0xBF, 0xBD, 0x41, 0x42, 0xDF, 0xBF, 0x43, 0xEF, 0xBF, 0xBD },
            };
            ...
            yield return new object[]
            {
                ...
                0,
                9,
                new byte[] { 84, 101, 115, 116, 239, 191, 189, 84, 101, 115, 116 },
            };
            yield return new object[]
            {
                "Test\uDD75Test",
            ...
            yield return new object[]
            {
                ...
                0,
                9,
                new byte[] { 84, 101, 115, 116, 84, 101, 115, 116, 239, 191, 189 },
            };
            yield return new object[]
            {
                "TestTest\uD803",
        ...
        private static unsafe void FixedEncodingHelper(
            char[] c,
            int charCount,
            byte[] b,
            int byteCount
        ...
        {
            byte[] expectedUtf8Output = expected
                .SelectMany(ch =>
