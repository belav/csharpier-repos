...
namespace System.Globalization.Tests
{
    public static class MiscCalendarsTests
    {
        ...
        public static void VietnameseTest_MatchAbbreviatedMonthName_ContinuesSearchAfterMatch(
            string monthAbberavition,
            int expectedMonthNum
        )
        {
            ...
            Assert.Equal(
                expectedMonthNum,
                DateTime.ParseExact(monthAbberavition, "MMM", dtfi).Month
            );
        }
    }
}
