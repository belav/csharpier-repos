...
namespace System.Globalization.Tests
{
    public class GregorianCalendarGetWeekOfYears
    {
        ...
        private static readonly int[] s_daysInMonthInLeapYear =
        {
            0,
            31,
            29,
        ...
        public static IEnumerable<object[]> GetWeekOfYear_TestData()
        {
            ...
            yield return new object[]
            {
                new DateTime(
                    RandomLeapYear(),
                    randomMonthNotFebruary,
                    RandomLeapYearDay(randomMonthNotFebruary)
                ),
                RandomCalendarWeekRule(),
                RandomDayOfWeek(),
            };
            ...
            yield return new object[]
            {
                new DateTime(RandomLeapYear(), 2, RandomLeapYearDay(2)),
                RandomCalendarWeekRule(),
                RandomDayOfWeek(),
            };
            ...
            yield return new object[]
            {
                new DateTime(RandomCommonYear(), 2, RandomCommonYearDay(2)),
                RandomCalendarWeekRule(),
                RandomDayOfWeek(),
            };
            ...
            yield return new object[]
            {
                new DateTime(
                    RandomCommonYear(),
                    randomMonthNotFebruary,
                    RandomCommonYearDay(randomMonthNotFebruary)
                ),
                RandomCalendarWeekRule(),
                RandomDayOfWeek(),
            };
            ...
            yield return new object[]
            {
                new DateTime(9999, randomMonth, RandomCommonYearDay(randomMonth)),
                RandomCalendarWeekRule(),
                RandomDayOfWeek(),
            };
            ...
            yield return new object[]
            {
                new DateTime(1, randomMonth, RandomCommonYearDay(randomMonth)),
                RandomCalendarWeekRule(),
                RandomDayOfWeek(),
            };
            ...
            yield return new object[]
            {
                new DateTime(randomYear, randomMonth, RandomDay(randomYear, randomMonth)),
                RandomCalendarWeekRule(),
                RandomDayOfWeek(),
            };
        }
        ...
        public void GetWeekOfYear(DateTime time, CalendarWeekRule rule, DayOfWeek firstDayOfWeek)
        {
            ...
            Assert.Equal(
                GetDayOfYearHelper(calendar, time, rule, firstDayOfWeek),
