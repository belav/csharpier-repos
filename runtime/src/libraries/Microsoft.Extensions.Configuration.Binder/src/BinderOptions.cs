...
namespace Microsoft.Extensions.Configuration
{
    ...
    public class BinderOptions
    {
        ...
        /// <summary>
        /// When false (the default), no exceptions are thrown when trying to convert a value or when a
        // configuration
        /// key is found for which the provided model object does not have an appropriate property which
        // matches the key's name.
