...
namespace Microsoft.Extensions.Configuration.Binder.SourceGeneration
{
    internal sealed class TypeIndex(IEnumerable<TypeSpec> typeSpecs)
    {
        ...
        public bool CanBindTo(TypeRef typeRef) =>
            GetEffectiveTypeSpec(typeRef) switch
            {
                ...
                ComplexTypeSpec complexTypeSpec
                    => CanInstantiate(complexTypeSpec) || HasBindableMembers(complexTypeSpec),
        ...
        public bool HasBindableMembers(ComplexTypeSpec typeSpec) =>
            typeSpec switch
            {
                ...
                DictionarySpec dictSpec
                    => KeyIsSupported(dictSpec) && CanBindTo(dictSpec.ElementTypeRef),
                CollectionSpec collectionSpec => CanBindTo(collectionSpec.ElementTypeRef),
                _ => throw new InvalidOperationException(),
            };
        ...
        public string GetGenericTypeDisplayString(
        ...
        )
        {
            ...
            string keyTypeDisplayString = GetTypeSpec(
                ((DictionarySpec)type).KeyTypeRef
            ).DisplayString;
        ...
        public static string GetParseMethodName(ParsableFromStringSpec type)
        {
            ...
            string parseMethod =
                type.StringParsableTypeKind is StringParsableTypeKind.ByteArray
                    ? "ParseByteArray"
