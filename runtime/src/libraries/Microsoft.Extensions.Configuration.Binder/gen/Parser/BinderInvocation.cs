...
namespace Microsoft.Extensions.Configuration.Binder.SourceGeneration
{
    internal sealed class BinderInvocation
    {
        ...
        public static BinderInvocation? Create(
        ...
        )
        {
            ...
            return
                context.SemanticModel.GetOperation(invocationSyntax, cancellationToken)
