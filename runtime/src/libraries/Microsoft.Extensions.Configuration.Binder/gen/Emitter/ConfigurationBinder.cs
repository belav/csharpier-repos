        ...
        private sealed partial class Emitter
        {
            ...
            private void EmitGetMethods()
            {
                ...
                if (ShouldEmitMethods(MethodsToGen.ConfigBinder_Get_T))
                {
                    ...
                    _writer.WriteLine(
                        $"public static T? {Identifier.Get}<T>(this {Identifier.IConfiguration} {Identifier.configuration}) => "
                ...
                if (ShouldEmitMethods(MethodsToGen.ConfigBinder_Get_T_BinderOptions))
                {
                    ...
                    _writer.WriteLine(
                        $"public static T? {Identifier.Get}<T>(this {Identifier.IConfiguration} {Identifier.configuration}, {TypeDisplayString.NullableActionOfBinderOptions} {Identifier.configureOptions}) => "
                ...
                if (ShouldEmitMethods(MethodsToGen.ConfigBinder_Get_TypeOf))
                {
                    ...
                    _writer.WriteLine(
                        $"public static object? {Identifier.Get}(this {Identifier.IConfiguration} {Identifier.configuration}, Type {Identifier.type}) => "
                ...
                if (ShouldEmitMethods(MethodsToGen.ConfigBinder_Get_TypeOf_BinderOptions))
                {
                    ...
                    _writer.WriteLine(
                        $"public static object? {Identifier.Get}(this {Identifier.IConfiguration} {Identifier.configuration}, Type {Identifier.type}, {TypeDisplayString.NullableActionOfBinderOptions} {Identifier.configureOptions}) => "
            ...
            {
                const string expressionForGetValueCore =
                    $"{Identifier.BindingExtensions}.{nameof(MethodsToGen_CoreBindingHelper.GetValueCore)}";
                const string documentation =
                ...
                if (ShouldEmitMethods(MethodsToGen.ConfigBinder_GetValue_T_key))
                {
                    ...
                    _writer.WriteLine(
                        $"public static T? {Identifier.GetValue}<T>(this {Identifier.IConfiguration} {Identifier.configuration}, string {Identifier.key}) => "
                ...
                if (ShouldEmitMethods(MethodsToGen.ConfigBinder_GetValue_T_key_defaultValue))
                {
                    ...
                    _writer.WriteLine(
                        $"public static T? {Identifier.GetValue}<T>(this {Identifier.IConfiguration} {Identifier.configuration}, string {Identifier.key}, T {Identifier.defaultValue}) => "
                ...
                if (ShouldEmitMethods(MethodsToGen.ConfigBinder_GetValue_TypeOf_key))
                {
                    ...
                    _writer.WriteLine(
                        $"public static object? {Identifier.GetValue}(this {Identifier.IConfiguration} {Identifier.configuration}, Type {Identifier.type}, string {Identifier.key}) => "
                ...
                if (ShouldEmitMethods(MethodsToGen.ConfigBinder_GetValue_TypeOf_key_defaultValue))
                {
                    ...
                    _writer.WriteLine(
                        $"public static object? {Identifier.GetValue}(this {Identifier.IConfiguration} {Identifier.configuration}, Type {Identifier.type}, string {Identifier.key}, object? {Identifier.defaultValue}) => "
            ...
            private void EmitBindMethods_ConfigurationBinder()
            {
                ...
                void EmitMethods(
                    ImmutableEquatableArray<TypedInterceptorInvocationInfo>? interceptorInfo,
                ...
                )
                {
                    ...
                    )
                    {
                        ...
                        EmitStartBlock(
                            $"public static void {Identifier.Bind}_{type.IdentifierCompatibleSubstring}(this {Identifier.IConfiguration} {Identifier.configuration}, {additionalParams})"
                        );

                        if (_typeIndex.HasBindableMembers(type))
                        {
                            Debug.Assert(!type.IsValueType);
                            string binderOptionsArg = configureOptions
                                ? $"{Identifier.GetBinderOptions}({Identifier.configureOptions})"
                                : $"{Identifier.binderOptions}: null";
