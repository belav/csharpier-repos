...
namespace Microsoft.Extensions.Configuration.Binder.SourceGeneration
{
    ...
    public sealed partial class ConfigurationBindingGenerator : IIncrementalGenerator
    {
                ...
                .Select(
                    (tuple, cancellationToken) =>
                    {
                        ...
                        try
                        {
                            ...
                            SourceGenerationSpec? spec = parser.GetSourceGenerationSpec(
                                tuple.Left,
                                cancellationToken
                            );
        ...
        private void ReportDiagnosticsAndEmitSource(
            ...
            (
                SourceGenerationSpec? SourceGenerationSpec,
                ImmutableEquatableArray<DiagnosticInfo>? Diagnostics
            ) input
        )
        {
        ...
        internal sealed class CompilationData
        {
            ...
            {
                // We don't have a CSharp21 value available yet. Polyfill the value here for forward compat, rather
                // than use the LanguageVersion.Preview enum value.
                //
                //
