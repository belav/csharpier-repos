...
namespace System.Security.Permissions.Tests
{
    public class ApplicationTrustTests
    {
        ...
        {
            ApplicationTrustCollection atc =
                (ApplicationTrustCollection)FormatterServices.GetUninitializedObject(
                    typeof(ApplicationTrustCollection)
                );
        ...
        {
            ApplicationTrustEnumerator ate =
                (ApplicationTrustEnumerator)FormatterServices.GetUninitializedObject(
                    typeof(ApplicationTrustEnumerator)
                );
