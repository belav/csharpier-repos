...
namespace System
{
    ...
    public partial class Uri : ISerializable
    {
        ...
        [Obsolete(
            "The method has been deprecated. Please use GetComponents() or static EscapeDataString() to escape a Uri component or a string. https://go.microsoft.com/fwlink/?linkid=14202"
        )]
