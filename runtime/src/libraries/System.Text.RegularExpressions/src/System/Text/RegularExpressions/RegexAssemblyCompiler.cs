...
namespace System.Text.RegularExpressions
{
    ...
    internal sealed class RegexAssemblyCompiler : RegexCompiler
    {
        ...
        internal RegexAssemblyCompiler(
            AssemblyName an,
        ...
        )
        {
            ...
            TypeBuilder regexRunnerTypeBuilder = DefineType(
                _module,
                $"{name}Runner{typenumString}",
                isPublic: false,
                isSealed: true,
                typeof(RegexRunner)
            );
            ...
            TypeBuilder regexRunnerFactoryTypeBuilder = DefineType(
                _module,
                $"{name}Factory{typenumString}",
                isPublic: false,
                isSealed: true,
                typeof(RegexRunnerFactory)
            );
            _ilg = DefineMethod(
                regexRunnerFactoryTypeBuilder,
                "CreateInstance",
                typeof(RegexRunner)
            );
            ...
            TypeBuilder regexTypeBuilder = DefineType(
                _module,
                name,
                isPublic,
                isSealed: false,
        ...
        private static ILGenerator DefineMethod(
