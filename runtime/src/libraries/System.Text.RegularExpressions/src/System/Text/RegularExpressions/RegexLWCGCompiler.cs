...
namespace System.Text.RegularExpressions
{
    internal sealed class RegexLWCGCompiler : RegexCompiler
    {
        ...
        private static readonly Type[] s_paramTypes = new Type[]
        {
            typeof(RegexRunner),
        ...
        )
        {
            ...
            DynamicMethod tryfindNextPossibleStartPositionMethod = DefineDynamicMethod(
                $"Regex{regexNum}_TryFindNextPossibleStartingPosition{description}",
                typeof(bool),
            ...
            DynamicMethod tryMatchAtCurrentPositionMethod = DefineDynamicMethod(
                $"Regex{regexNum}_TryMatchAtCurrentPosition{description}",
                typeof(bool),
                typeof(CompiledRegexRunner),
                s_paramTypes
            );
            ...
            DynamicMethod scanMethod = DefineDynamicMethod(
                $"Regex{regexNum}_Scan{description}",
                null,
                typeof(CompiledRegexRunner),
                new[] { typeof(RegexRunner), typeof(ReadOnlySpan<char>) }
            );
            EmitScan(
                options,
        ...
        [RequiresDynamicCode("Compiling a RegEx requires dynamic code.")]
        private DynamicMethod DefineDynamicMethod(
            string methname,
            Type? returntype,
            Type hostType,
            Type[] paramTypes
