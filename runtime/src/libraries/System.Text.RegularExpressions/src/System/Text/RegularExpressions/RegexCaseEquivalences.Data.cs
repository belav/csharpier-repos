...
{
    partial internal static class RegexCaseEquivalences
    {
        ...
        private static char[] EquivalenceCasingValues { get; } =
            new char[2336]
            {
                '\u0041',
                '\u0061',
        ...
        private static ushort[] EquivalenceFirstLevelLookup { get; } =
            new ushort[64]
            {
                0x0000,
                0x0400,
        ...
        private static ushort[] EquivalenceCasingMap { get; } =
            new ushort[10240]
            {
                0xffff,
                0xffff,
