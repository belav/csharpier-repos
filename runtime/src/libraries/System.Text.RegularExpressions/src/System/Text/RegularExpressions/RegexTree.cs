...
namespace System.Text.RegularExpressions
{
    ...
    internal sealed class RegexTree
    {
        ...
        )
        {
            ...
            Debug.Assert(
                captureNumberSparseMapping is null
                    || captureCount == captureNumberSparseMapping.Count
            );
            Debug.Assert(
                captureNameToNumberMapping is null
                    || captureCount == captureNameToNumberMapping.Count
            );
