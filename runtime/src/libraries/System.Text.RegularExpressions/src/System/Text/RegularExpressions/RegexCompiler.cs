    ...
    internal abstract class RegexCompiler
    {
        ...
        protected void EmitTryFindNextPossibleStartingPosition()
        {
            ...
            void EmitFixedSet_LeftToRight()
            {
                ...
                List<(char[]? Chars, string Set, int Distance)>? sets = _regexTree
                    .FindOptimizations
                    .FixedDistanceSets;
            ...
            void EmitFixedSet_RightToLeft()
            {
                ...
                (char[]? Chars, string Set, int Distance) set = _regexTree
                    .FindOptimizations
                    .FixedDistanceSets![0];
        ...
        protected void EmitTryMatchAtCurrentPosition()
        {
            ...
            )
            {
                ...
                if (
                    !rtl
                    && subsequent?.FindStartingLiteral()
                        is ValueTuple<char, string?, string?, bool> literal
                )
                {
                    ...
                    //     goto doneLabel;
                    // }
                    bool negated = literal.Item4;
                    Ldloca(inputSpan);
                    Ldloc(startingPos);
                    if (literal.Item2 is not null)
                    {
                        Debug.Assert(!negated, "strings should not be negated");
                        Ldloca(inputSpan);
                        Call(s_spanGetLengthMethod);
                        Ldloc(endingPos);
                    ...
                    else
                    {
                        ...
                        if (literal.Item3 is not null)
                        {
                            switch (literal.Item3.Length)
                            {
                                case 2:
                                    ...
                                    Call(
                                        negated
                                            ? s_spanLastIndexOfAnyExceptCharChar
                                            : s_spanLastIndexOfAnyCharChar
                                    );
                                    break;
                                ...
                                case 3:
                                    ...
                                    Call(
                                        negated
                                            ? s_spanLastIndexOfAnyExceptCharCharChar
                                ...
                                default:
                                    ...
                                    Call(
                                        negated
                                            ? s_spanLastIndexOfAnyExceptSpan
                        ...
                        {
                            Ldc(literal.Item1);
                            Call(negated ? s_spanLastIndexOfAnyExceptChar : s_spanLastIndexOfChar);
                        }
                    }
                    Stloc(endingPos);
                    Ldloc(endingPos);
            ...
            )
            {
                ...
                if (
                    ...
                    && subsequent?.FindStartingLiteral(4)
                        is ValueTuple<char, string?, string?, bool> literal
                ...
                ) // not negated; can't search for both the node.Ch and a negated subsequent char with an IndexOf* method
                {
                    ...
                    && subsequent?.FindStartingLiteral()
                        is ValueTuple<char, string?, string?, bool> literal2
                )
                {
                    ...
                    else if (literal2.Item3 is not null)
                    {
                        switch (literal2.Item3.Length)
                        {
                            ...
                            default:
                                ...
                                Call(s_stringAsSpanMethod);
                                Call(negated ? s_spanIndexOfAnyExceptSpan : s_spanIndexOfAnySpan);
                                break;
                        }
                    }
                    else
                    {
                        Ldc(literal2.Item1);
                        Call(negated ? s_spanIndexOfAnyExceptChar : s_spanIndexOfChar);
                    }
                    Stloc(startingPos);
                ...
                )
                {
                    ...
                    switch (numSetChars)
                    {
                        case 2:
                            ...
                            Ldc(setChars[1]);
                            Call(
                                negated ? s_spanIndexOfAnyCharChar : s_spanIndexOfAnyExceptCharChar
                            );
                            break;
