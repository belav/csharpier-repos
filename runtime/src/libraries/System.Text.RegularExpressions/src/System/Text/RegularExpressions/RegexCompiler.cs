    ...
    internal abstract class RegexCompiler
    {
        ...
        protected void EmitTryFindNextPossibleStartingPosition()
        {
            ...
            void EmitIndexOf_LeftToRight()
            {
                ...
                Ldloc(pos);
                if (
                    opts.FindMode == FindNextStartingPositionMode.FixedDistanceString_LeftToRight
                ...
                Call(s_spanSliceIntMethod);
                Ldstr(
                    opts.FindMode == FindNextStartingPositionMode.LeadingString_LeftToRight
                        ? opts.LeadingPrefix
                ...
                if (canUseIndexOf)
                {
                    ...
                    else
                    {
                        ...
                        )
                        {
                            ...
                            Call(
                                primarySet.Range.Value.Negated
            ...
            void EmitLiteralAfterAtomicLoop()
            {
                ...
                (RegexNode LoopNode, (char Char, string? String, char[]? Chars) Literal) target =
                    _regexTree.FindOptimizations.LiteralAfterLoop.Value;
