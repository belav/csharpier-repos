        ...
        public override IEnumerable<string> SampleMatches(int k, int randomseed)
        {
            ...
            lock (this)
            {
                ...
                for (int i = 0; i < k; i++)
                {
                    ...
                    states.InitializeFrom(
                        this,
                        _initialStates[GetCharKind<FullInputReader>(ReadOnlySpan<char>.Empty, -1)]
                    );
                    ...
                    while (true)
                    {
                        ...
                        StateFlags flags = SymbolicRegexMatcher<TSet>.NfaStateHandler
                        ...
                        if (flags.CanBeNullable())
                        {
                            ...
                            if (
                                flags.IsNullable()
                                || SymbolicRegexMatcher<TSet>.NfaStateHandler
                        ...
                        int[] mintermIds = SymbolicRegexMatcher<TSet>.NfaStateHandler
