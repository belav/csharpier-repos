...
namespace System.Text.RegularExpressions
{
    public partial class Regex
    {
        ...
        /// <param name="maxLabelLength">maximum length of labels in nodes anything over that length is
        // indicated with .. </param>
        ...
        /// <summary>
        /// Generates UnicodeCategoryRanges.cs for the namespace
        ...
        /// <summary>
        /// Explore transitions of the DFA and/or NFA exhaustively. DFA exploration, if requested, is done
        // only up to the
        /// DFA state limit. NFA exploration, if requested, continues from the states unexplored by the DFA
        // exploration,
        /// or from the initial states if DFA exploration was not requested. NFA exploration will always
        // finish.
        /// </summary>
        /// <remarks>
        /// This may result in a different automaton being explored than matching would produce, since if
        // the limit for
        /// the number of DFA states is reached then the order in which states and transitions are explored
        // is significant.
        /// During matching that order is driven by the input, while this function may use any order
        // (currently it is
        /// breadth-first).
        /// </remarks>
        /// <param name="includeDotStarred">whether to explore the .*? prefixed version of the
        // pattern</param>
