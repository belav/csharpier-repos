...
namespace System.Text.RegularExpressions.Tests
{
    public class RegexReductionTests
    {
        ...
        static RegexReductionTests()
        {
            ...
            s_regexCodeCodes = s_regexCode.FieldType
                .GetField(
                    "Codes",
                    BindingFlags.Public | BindingFlags.NonPublic | BindingFlags.Instance
                );
            ...
            s_regexCodeTree = s_regexCode.FieldType
                .GetField(
                    "Tree",
                    BindingFlags.Public | BindingFlags.NonPublic | BindingFlags.Instance
                );
            ...
            s_regexCodeTreeMinRequiredLength = s_regexCodeTree.FieldType
                .GetField(
                    "MinRequiredLength",
                    BindingFlags.Public | BindingFlags.NonPublic | BindingFlags.Instance
                );
