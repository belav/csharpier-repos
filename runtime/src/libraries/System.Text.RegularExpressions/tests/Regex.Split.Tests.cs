    ...
    public class RegexSplitTests
    {
        public static IEnumerable<object[]> Split_TestData()
        {
            foreach (RegexEngine engine in RegexHelpers.AvailableEngines)
            {
                ...
                yield return new object[]
                {
                    ...
                    32,
                    0,
                    new string[] { "word0", "word1", "word2", "word3" }
                };
                ...
                yield return new object[]
                {
                    ...
                    19,
                    0,
                    new string[] { "kkk", "lll", "mmm", "nnn", "ooo" }
                };
                yield return new object[]
                {
                    engine,
                ...
                if (!RegexHelpers.IsNonBacktracking(engine))
                {
                    ...
                    yield return new object[]
                    {
                        ...
                        19,
                        0,
                        new string[] { "123", "b", "d", "456aBCDe789" }
                    };
                    yield return new object[]
                    {
                        engine,
                        ...
                        19,
                        0,
                        new string[] { "123", "b", "d", "456", "B", "D", "789" }
                    };
                    ...
                    yield return new object[]
                    {
                        ...
                        19,
                        0,
                        new string[] { "123", "d", "b", "456aBCDe789" }
                    };
                    yield return new object[]
                    {
                        engine,
                        ...
                        19,
                        0,
                        new string[] { "123", "d", "b", "456", "D", "B", "789" }
                    };
                    ...
                    yield return new object[]
                    {
                        ...
                        20,
                        20,
                        new string[] { "", "a", "b", "c", "d", "e", "f", "g", "h", "i", "k" }
                    };
                    yield return new object[]
                    {
                        engine,
                        ...
                        10,
                        20,
                        new string[] { "1a", "b", "c", "d", "e", "f", "g", "h", "i", "k" }
                    };
                    yield return new object[]
                    {
                        engine,
                        ...
                        2,
                        20,
                        new string[] { "1a2b3c4d5e6f7g8h9i", "k" }
                    };
                    yield return new object[]
                    {
                        engine,
                        ...
                        1,
                        20,
                        new string[] { "1a2b3c4d5e6f7g8h9i0k" }
                    };
        ...
        public void Split_Invalid()
        {
            ...
            AssertExtensions.Throws<ArgumentNullException>(
                "input",
                () => Regex.Split(null, "pattern")
            );
            AssertExtensions.Throws<ArgumentNullException>(
                "input",
                () => Regex.Split(null, "pattern", RegexOptions.None)
            );
            AssertExtensions.Throws<ArgumentNullException>(
                "input",
                () => Regex.Split(null, "pattern", RegexOptions.None, TimeSpan.FromMilliseconds(1))
            );
            AssertExtensions.Throws<ArgumentNullException>(
                "input",
                () => new Regex("pattern").Split(null)
            );
            AssertExtensions.Throws<ArgumentNullException>(
                "input",
                () => new Regex("pattern").Split(null, 0)
            );
            AssertExtensions.Throws<ArgumentNullException>(
                "input",
                () => new Regex("pattern").Split(null, 0, 0)
            );

            // Pattern is null
            AssertExtensions.Throws<ArgumentNullException>(
                "pattern",
                () => Regex.Split("input", null)
            );
            AssertExtensions.Throws<ArgumentNullException>(
                "pattern",
                () => Regex.Split("input", null, RegexOptions.None)
            );
            AssertExtensions.Throws<ArgumentNullException>(
                "pattern",
                () => Regex.Split("input", null, RegexOptions.None, TimeSpan.FromMilliseconds(1))
            );

            // Count is invalid
            AssertExtensions.Throws<ArgumentOutOfRangeException>(
                "count",
                () => new Regex("pattern").Split("input", -1)
            );
            AssertExtensions.Throws<ArgumentOutOfRangeException>(
                "count",
                () => new Regex("pattern").Split("input", -1, 0)
            );

            // Start is invalid
            AssertExtensions.Throws<ArgumentOutOfRangeException>(
                "startat",
                () => new Regex("pattern").Split("input", 0, -1)
            );
            AssertExtensions.Throws<ArgumentOutOfRangeException>(
                "startat",
                () => new Regex("pattern").Split("input", 0, 6)
            );
        }
    }
}
