    ...
    public class MonoTests
    {
        ...
        public static IEnumerable<object[]> RegexTestCasesWithOptions()
        {
            foreach (object[] obj in RegexTestCases())
            {
                ...
                {
                    obj[0],
                    RegexOptions.CultureInvariant | (RegexOptions)obj[1],
                    obj[2],
                    obj[3]
                };
                yield return new object[]
                {
                    obj[0],
                    RegexOptions.Compiled | (RegexOptions)obj[1],
                    obj[2],
                    obj[3]
                };
                yield return new object[]
                {
                    obj[0],
                    RegexOptions.Compiled | RegexOptions.CultureInvariant | (RegexOptions)obj[1],
                    obj[2],
                    obj[3]
                };
            }
