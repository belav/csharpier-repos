    ...
    public class RegexGroupTests
    {
        public static IEnumerable<object[]> Groups_Basic_TestData()
        {
            ...
            yield return new object[]
            {
                ...
                "aaabbbcccdddeeefff"
            }; // <-- Nonbacktracking match same as for "(([a-z]*)|([a-d]*))"
            yield return new object[]
            {
                null,
                @"(([d-f]*)|([c-e]*))",
                ...
                "dddeeeccceee"
            }; // <-- Nonbacktracking match same as for "(([c-e]*)|([d-f]*))"
            yield return new object[]
            {
                null,
                @"(([c-e]*)|([d-f]*))",
            ...
            yield return new object[]
            {
                ...
                new string[] { "aaabbbcccddd", "aaabbbcccddd", "aaabbbcccddd", "" },
                "aaabbbcccdddeeefff"
            }; // <-- Nonbacktracking match same as for ".*"
            yield return new object[]
            {
                null,
                @"(([d-f]*)|(.*))",
            ...
            yield return new object[]
            {
                ...
                new string[] { "abc\n123" },
                "abc"
            }; // <-- Nonbacktracking match same as for "abc|.*123"
            yield return new object[]
            {
                null,
                @"abc|.*123",
            ...
            yield return new object[]
            {
                ...
                new string[] { "abc" },
                "abcghi"
            }; // <-- Nonbacktracking match same as for ".*ghi|.*abc"
            yield return new object[]
            {
                null,
                @".*ghi|.*abc",
