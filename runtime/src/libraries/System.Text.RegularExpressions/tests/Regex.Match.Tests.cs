...
namespace System.Text.RegularExpressions.Tests
{
    public class RegexMatchTests
    {
        ...
        [InlineData(RegexOptions.None)]
        [InlineData(
            RegexOptions.None | (RegexOptions)0x80 /* Debug */
        )]
        [InlineData(RegexOptions.Compiled)]
        [InlineData(
            RegexOptions.Compiled | (RegexOptions)0x80 /* Debug */
        )]
        public void Match_Timeout_Throws(RegexOptions options)
        {
            ...
            Assert.Throws<RegexMatchTimeoutException>(
                () => new Regex(Pattern, options, TimeSpan.FromMilliseconds(100)).Match(input)
            );
        }
        ...
        public static IEnumerable<object[]> Match_Advanced_TestData()
        {
            ...
            yield return new object[]
            {
                ...
                0,
                2,
                new CaptureData[] { new CaptureData("aa", 0, 2), new CaptureData("a", 0, 1), }
            };
        ...
        [MemberData(
            nameof(RegexCompilationHelper.TransformRegexOptions),
            nameof(Match_Advanced_TestData),
            2,
            MemberType = typeof(RegexCompilationHelper)
        )]
        public void Match_Advanced(
            string pattern,
            string input,
            RegexOptions options,
            int beginning,
        ...
        [MemberData(
            nameof(RegexCompilationHelper.TransformRegexOptions),
            nameof(Match_StartatDiffersFromBeginning_MemberData),
            2,
            MemberType = typeof(RegexCompilationHelper)
        )]
        public void Match_StartatDiffersFromBeginning(
            string pattern,
            string input,
            RegexOptions options,
            int startat,
        ...
        public void IsMatch_SucceedQuicklyDueToAutoAtomicity(
            string regex,
            string input,
            bool expected
        ) {
