    ...
    public class RegexGroupTests
    {
        public static IEnumerable<object[]> Groups_Basic_TestData()
        {
            ...
            (?(start)(?!)) ",
                ...
                foreach (
                    RegexOptions options in new[] { RegexOptions.None, RegexOptions.Singleline }
                )
                {
                    yield return new object[]
                    {
        ...
        )
        {
            ...
            try
            {
                regex = await RegexHelpers.GetRegexAsync(
                    engine,
                    pattern,
                    options,
                ...
                when (e is NotSupportedException or ArgumentOutOfRangeException
