...
namespace System.Text.RegularExpressions.Tests
{
    public class RegexGroupTests
    {
        public static IEnumerable<object[]> Groups_MemberData()
        {
            foreach (RegexEngine engine in RegexHelpers.AvailableEngines)
            {
                (
                    ...
                    string[] Expected
                )[] cases = Groups_MemberData_Cases(engine).ToArray();
        ...
        private static IEnumerable<(
            ...
            RegexOptions Options,
            string[] Expected
        )> Groups_MemberData_Cases(RegexEngine engine)
        {
            ...
            yield return (
                ...
                "az1234567890za",
                RegexOptions.None,
                new string[] { "1234567890", "0" }
            );
            yield return (
                enUS,
                @"([^0-9-[a-zAE-Z]]|[\w-[a-zAF-Z]])+",
                "azBCDE1234567890BCDEFza",
                RegexOptions.None,
                new string[] { "BCDE1234567890BCDE", "E" }
            );
            yield return (
                enUS,
                @"([\p{Ll}-[aeiou]]|[^\w-[\s]])+",
            ...
            yield return (
                enUS,
                @"(?:abc|def|ghi|hij|klm|no){1,4}",
                "this is a test nonoabcxyz this is only a test",
                RegexOptions.None,
                new string[] { "nonoabc" }
            );
            yield return (
            ...
            yield return (
                ...
                RegexOptions.None,
                new string[] { "bcdfghjklmnpqrstvwxyz" }
            );
            ...
            if (!RegexHelpers.IsNonBacktracking(engine)) // conditionals not supported
            {
                yield return (
                    ...
                    new string[] { "255", "255", "2", "5", "5", "", "255", "2", "5" }
                );
            }
            ...
            yield return (
                ...
                "\u01C5ello \u01C5orld",
                RegexOptions.None,
                new string[] { "\u01C5ello \u01C5orld", "\u01C5ello", "\u01C5orld" }
            );
            yield return (
                enUS,
                @"(\P{Lt}\w*)\s(\P{Lt}*\w*)",
            ...
            yield return (
                enUS,
                @"cat([\d]*)dog",
                "hello123cat230927dog1412d",
                RegexOptions.None,
                new string[] { "cat230927dog", "230927" }
            );
            yield return (
                enUS,
                @"([\D]*)dog",
            ...
            yield return (
                ...
                "catAAAdog",
                RegexOptions.None,
                new string[] { "catAAAdog", "cat", "AAA", "dog" }
            );
            yield return (
                enUS,
                @"(cat)([\u0041]*)(dog)",
            ...
            yield return (
                ...
                "cat\a\a\adog",
                RegexOptions.None,
                new string[] { "cat\a\a\adog", "cat", "\a\a\a", "dog" }
            );
            yield return (
                enUS,
                @"(cat)([\b]*)(dog)",
                "cat\b\b\bdog",
                RegexOptions.None,
                new string[] { "cat\b\b\bdog", "cat", "\b\b\b", "dog" }
            );
            yield return (
                enUS,
                @"(cat)([\e]*)(dog)",
            ...
            yield return (
                ...
                "cat\f\f\fdog",
                RegexOptions.None,
                new string[] { "cat\f\f\fdog", "cat", "\f\f\f", "dog" }
            );
            yield return (
                enUS,
                @"(cat)([\r]*)(dog)",
                "cat\r\r\rdog",
                RegexOptions.None,
                new string[] { "cat\r\r\rdog", "cat", "\r\r\r", "dog" }
            );
            yield return (
                enUS,
                @"(cat)([\v]*)(dog)",
                "cat\v\v\vdog",
                RegexOptions.None,
                new string[] { "cat\v\v\vdog", "cat", "\v\v\v", "dog" }
            );
            ...
            if (!RegexHelpers.IsNonBacktracking(engine)) // ECMAScript not supported
            {
                ...
                yield return (
                    ...
                    "Hello World",
                    RegexOptions.ECMAScript,
                    new string[] { "Hello World", "ello", "orld" }
                );
                yield return (
                    enUS,
                    @"\P{Ll}\p{Ll}*\s\P{Ll}\p{Ll}*",
            ...
            if (!RegexHelpers.IsNonBacktracking(engine)) // balancing groups not supported
            {
                yield return (
                    enUS,
                    @"(?<cat>cat)\w+(?<dog-cat>dog)",
                    "cat_Hello_World_dog",
                    RegexOptions.None,
                    new string[] { "cat_Hello_World_dog", "", "_Hello_World_" }
                );
                yield return (
                    enUS,
                    @"(?<cat>cat)\w+(?<-cat>dog)",
                    "cat_Hello_World_dog",
                    RegexOptions.None,
                    new string[] { "cat_Hello_World_dog", "" }
                );
                yield return (
                    enUS,
                    @"(?<cat>cat)\w+(?<cat-cat>dog)",
                    "cat_Hello_World_dog",
                    RegexOptions.None,
                    new string[] { "cat_Hello_World_dog", "_Hello_World_" }
                );
            ...
            yield return (
                enUS,
                @"(cat) (?#cat)    \s+ (?#followed by 1 or more whitespace) (dog)  (?#followed by dog)",
                "cat    dog",
                RegexOptions.IgnorePatternWhitespace,
                new string[] { "cat    dog", "cat", "dog" }
            );
            ...
            if (!RegexHelpers.IsNonBacktracking(engine)) // back references not supported
            {
                yield return (
                    enUS,
                    @"(?<cat>cat)(?<dog>dog)\k<cat>",
                    "asdfcatdogcatdog",
                    RegexOptions.None,
                    new string[] { "catdogcat", "cat", "dog" }
                );
                yield return (
                    enUS,
                    @"(?<cat>cat)\s+(?<dog>dog)\k<cat>",
                    "asdfcat   dogcat   dog",
                    RegexOptions.None,
                    new string[] { "cat   dogcat", "cat", "dog" }
                );
                yield return (
                    enUS,
                    @"(?<cat>cat)\s+(?<dog>dog)\k'cat'",
                ...
                yield return (
                    enUS,
                    @"(?<cat>cat)\s+(?<dog>dog)\k<dog>",
                    "asdfcat   dogdog   dog",
                    RegexOptions.None,
                    new string[] { "cat   dogdog", "cat", "dog" }
                );
                yield return (
                    enUS,
                    @"(?<cat>cat)\s+(?<dog>dog)\2",
            ...
            yield return (
                ...
                "asdlkcat\0\0dogiwod",
                RegexOptions.None,
                new string[] { "cat\0\0dog", "cat", "\0\0", "dog" }
            );
            yield return (
                enUS,
                @"(cat)(\cA*)(dog)",
            ...
            yield return (
                ...
                "cat\u02b0 dog\u02b1",
                RegexOptions.None,
                new string[] { "cat\u02b0 dog\u02b1", "cat\u02b0", "dog\u02b1" }
            );
            yield return (
                enUS,
                @"(cat\w+)\s+(dog\w+)",
                "STARTcat\u30FC dog\u3005END",
                RegexOptions.None,
                new string[] { "cat\u30FC dog\u3005END", "cat\u30FC", "dog\u3005END" }
            );
            yield return (
                enUS,
                @"(cat\w+)\s+(dog\w+)",
                "STARTcat\uff9e dog\uff9fEND",
                RegexOptions.None,
                new string[] { "cat\uff9e dog\uff9fEND", "cat\uff9e", "dog\uff9fEND" }
            );
            ...
            yield return (
                ...
                "aaabbb",
                RegexOptions.None,
                new string[] { "aaabbb", "aaabbb", "", "aaabbb" }
            );
            ...
            yield return (
                ...
                "dddeeeccceee",
                RegexOptions.None,
                new string[] { "dddeeeccceee", "dddeeeccceee", "", "dddeeeccceee" }
            );
            yield return (
                enUS,
                @"^(([c-e]*)|([d-f]*))$",
            ...
            yield return (
                ...
                "aaabbbcccdddeeefff",
                RegexOptions.None,
                new string[] { "aaabbbcccddd", "aaabbbcccddd", "aaabbbcccddd", "" }
            );
            yield return (
                enUS,
                @"(([d-f]*)|([c-e]*))",
                "dddeeeccceee",
                RegexOptions.None,
                new string[] { "dddeee", "dddeee", "dddeee", "" }
            );
            yield return (
                enUS,
                @"(([c-e]*)|([d-f]*))",
            ...
            if (!RegexHelpers.IsNonBacktracking(engine)) // ECMAScript not supported
            {
                yield return (
                    enUS,
                    @"(?<cat>cat)\s+(?<dog>dog)\s+\123\s+\234",
                    "asdfcat   dog     cat23    dog34eia",
                    RegexOptions.ECMAScript,
                    new string[] { "cat   dog     cat23    dog34", "cat", "dog" }
                );
            }
            ...
            yield return (
                ...
                "http://www.msn.com/",
                RegexOptions.IgnoreCase,
                new string[] { "http://www.msn.com/", "com", string.Empty }
            );
            yield return (
                enUS,
                @"http://([a-zA-Z0-9\-]*\.?)*?/",
                @"http://www.google.com/",
                RegexOptions.IgnoreCase,
                new string[] { "http://www.google.com/", "com" }
            );
            ...
            yield return (
                ...
                "/.aspx",
                RegexOptions.None,
                new string[] { "/.aspx", string.Empty, string.Empty }
            );
            yield return (
                enUS,
                @"(.*)/(.*).aspx",
                "/homepage.aspx",
                RegexOptions.None,
                new string[] { "/homepage.aspx", string.Empty, "homepage" }
            );
            yield return (
                enUS,
                @"(.*)/(.*).aspx",
                "pages/.aspx",
                RegexOptions.None,
                new string[] { "pages/.aspx", "pages", string.Empty }
            );
            yield return (
                enUS,
                @"(.*)/(.*).aspx",
                "pages/homepage.aspx",
                RegexOptions.None,
                new string[] { "pages/homepage.aspx", "pages", "homepage" }
            );
            yield return (
                enUS,
                @"(.*)/(.*).aspx",
            ...
            yield return (
                enUS,
                @"(.*)/(.*).aspx",
                "/pages/homepage/index.aspx",
                RegexOptions.None,
                new string[] { "/pages/homepage/index.aspx", "/pages/homepage", "index" }
            );
            yield return (
                enUS,
                @"(.*)/(.*).aspx",
                ...
                RegexOptions.None,
                new string[] { "/pages/homepage.aspx/index.aspx", "/pages/homepage.aspx", "index" }
            );
            yield return (
                enUS,
                @"(.*)/(.*)/(.*).aspx",
            ...
            yield return (
                ...
                "ababcdababcdababc",
                RegexOptions.None,
                new string[] { "ababcdababcd", "ababcd", "ab" }
            ); // loop
            if (!RegexHelpers.IsNonBacktracking(engine)) // lookarounds not supported)
            {
                yield return (
            ...
            foreach (string prefix in new[] { "", "xyz" })
            {
                ...
                yield return (
                    ...
                    prefix + "cdefadefbdef",
                    RegexOptions.None,
                    new string[] { prefix + "cdefadefbdef" }
                );
                yield return (
                    enUS,
                    prefix + @"(?:[abc]def){1,3}",
                    prefix + "cdefadefbdefadef",
                    RegexOptions.None,
                    new string[] { prefix + "cdefadefbdef" }
                );
                yield return (
            ...
            yield return (
                enUS,
                @"(?:abcd|efghj{2,}|j[klm]o+)i",
                "efghjjjjji",
                RegexOptions.None,
                new string[] { "efghjjjjji" }
            );
            yield return (
                enUS,
                @"(?:abcd|efghi{2,}|j[klm]o+)i",
                "efghiii",
                RegexOptions.None,
                new string[] { "efghiii" }
            );
            ...
            yield return (
                enUS,
                @"(?:(?:[ab]c[de]f){3}){2}",
                "acdfbcdfacefbcefbcefbcdfacdef",
                RegexOptions.None,
                new string[] { "acdfbcdfacefbcefbcefbcdf" }
            );
            yield return (
                enUS,
                @"(?:(?:[ab]c[de]f){3}hello){2}",
                "aaaaaacdfbcdfacefhellobcefbcefbcdfhellooooo",
                RegexOptions.None,
                new string[] { "acdfbcdfacefhellobcefbcefbcdfhello" }
            );
            yield return (
                enUS,
                @"CN=(.*[^,]+).*",
                "CN=localhost",
                RegexOptions.Singleline,
                new string[] { "CN=localhost", "localhost" }
            );
            // Nested atomic
            if (!RegexHelpers.IsNonBacktracking(engine)) // atomic not supported
            {
            ...
            if (!RegexHelpers.IsNonBacktracking(engine)) // backreferences not supported
            {
                yield return (
                    ...
                    "\n12345abc12345",
                    RegexOptions.Singleline,
                    new string[] { "12345abc12345", "12345" }
                );
                yield return (
                    enUS,
                    @"(.+)abc\1",
            ...
            yield return (
                ...
                "Match(Name)",
                RegexOptions.None,
                new string[] { "Match(Name)", "(Name)", "Match", "Name" }
            );
            yield return (
                enUS,
                @"\A\s*(?<name>\w+)(\s*\((?<arguments>.*)\))?\s*\Z",
            ...
            yield return (
                ...
                "123hello456",
                RegexOptions.None,
                new string[] { "123hello456", "123", "hello", "456" }
            );
            yield return (
                enUS,
                @"((\d*))[AaBbCc](\d*)",
            ...
            yield return (
                enUS,
                "([\u0000-\uFFFF-[azAZ09]]|[\u0000-\uFFFF-[^azAZ09]])+",
                "azAZBCDE1234567890BCDEFAZza",
                RegexOptions.None,
                new string[] { "azAZBCDE1234567890BCDEFAZza", "a" }
            );
            yield return (
                enUS,
                "[\u0000-\uFFFF-[\u0000-\uFFFF-[\u0000-\uFFFF-[\u0000-\uFFFF-[\u0000-\uFFFF-[a]]]]]]+",
        ...
        [ActiveIssue(
            "https://github.com/dotnet/runtime/issues/36900",
