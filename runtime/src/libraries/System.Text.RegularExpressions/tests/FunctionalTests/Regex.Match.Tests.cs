    ...
    public partial class RegexMatchTests
    {
        public static IEnumerable<object[]> Match_MemberData()
        {
            foreach (RegexEngine engine in RegexHelpers.AvailableEngines)
            {
                ...
                )[] cases = Match_MemberData_Cases(engine).ToArray();
        ...
        public async Task AllEnginesProduceTheSameCaptures()
        {
            ...
            (
                ...
                bool ExpectedSuccess,
                string ExpectedValue
            )[] interpreterTests = Match_MemberData_Cases(RegexEngine.Interpreter)
        ...
        public async Task Match_VaryingLengthStrings_Huge(RegexEngine engine)
        {
            Func<string, Task> func = static async engineStr =>
            {
                ...
                try
                {
                    await new RegexMatchTests().Match_VaryingLengthStrings(
                        engine,
                        RegexOptions.None,
                        100_000
                    );
        ...
        )
        {
            ...
            Func<string, string, string, Task> func = static async (
                engineStr,
                fullpattern,
                fullinput
            ) =>
