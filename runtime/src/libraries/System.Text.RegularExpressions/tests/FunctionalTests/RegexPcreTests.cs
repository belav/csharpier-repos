...
namespace System.Text.RegularExpressions.Tests
{
    ...
    public class RegexPcre2Tests
    {
        public static IEnumerable<object[]> PcreTestData()
        {
            ...
            {
                (string pattern, RegexOptions options, string input, bool expectedSuccess)[] cases =
                    PcreTestData_Cases(engine).ToArray();
        ...
        )> PcreTestData_Cases(RegexEngine engine)
        {
            ...
            yield return (
                ...
                RegexOptions.None,
                "abc\0def\0pqr\0xyz\00AB",
                true
            );
            yield return (
                "abc\\0def\\00pqr\\000xyz\\0000AB",
                RegexOptions.None,
                "abc456 abc\0def\0pqr\0xyz\00ABCDE",
                true
            );
            yield return (
                "abc\\x0def\\x00pqr\\x000xyz\\x0000AB",
                RegexOptions.None,
                "abc\ref\0pqr\00xyz\000AB",
                true
            );
            yield return (
                "abc\\x0def\\x00pqr\\x000xyz\\x0000AB",
                RegexOptions.None,
                "abc456 abc\ref\0pqr\00xyz\000ABCDE",
                true
            );
            ...
            if (!RegexHelpers.IsNonBacktracking(engine)) // These following patterns use features that are not currently supported by the non-backtracking engine
            {
                ...
                yield return (
                    "(\u00CE\u00A3\u00CE\u0086\u00CE\u009c\u00CE\u009f\u00CE\u00A3) \\1*",
                    RegexOptions.IgnoreCase,
                    "\u00CE\u00A3\u00CE\u0086\u00CE\u009c\u00CE\u009f\u00CE\u00A3 \u00CE\u00A3\u00CE\u0086\u00CE\u009c\u00CE\u009f\u00CE\u00A3\u00CF\u0083\u00CE\u00AC\u00CE\u00BC\u00CE\u00BF\u00CF\u0082\u00CF\u0083\u00CE\u00AC\u00CE\u00BC\u00CE\u00BF\u00CF\u0082",
                    true
                );
