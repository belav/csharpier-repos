...
namespace System.Text.RegularExpressions.Tests
{
    ...
    public class RegexCharacterSetTests
    {
        ...
        public async Task SetInclusionsExpected(
            RegexEngine engine,
            string set,
            RegexOptions options,
            char[] expectedIncluded
        )
        {
        ...
        public async Task SetExclusionsExpected(
            RegexEngine engine,
            string set,
            RegexOptions options,
            char[] expectedExcluded
        )
        {
            await ValidateSetAsync(
                engine,
        ...
        public static IEnumerable<object[]> UnicodeCategoryInclusionsExpected_MemberData()
        {
            foreach (RegexEngine engine in RegexHelpers.AvailableEngines)
            {
                yield return new object[]
                {
                    engine,
                    @"\p{Lu}",
                    new[] { UnicodeCategory.UppercaseLetter },
                };
                yield return new object[]
                {
                    engine,
        ...
        public async Task UnicodeCategoryInclusionsExpected(
            RegexEngine engine,
            string set,
        ...
        public static IEnumerable<object[]> NamedBlocksInclusionsExpected_MemberData()
        {
            foreach (RegexEngine engine in RegexHelpers.AvailableEngines)
            {
                ...
                {
                    engine,
                    @"\p{IsRunic}\p{IsHebrew}",
                    new[] { 0x0590, 0x05FF, 0x16A0, 0x16FF },
                };
                yield return new object[]
                {
                    engine,
        ...
        public async Task NamedBlocksInclusionsExpected(
            RegexEngine engine,
            string set,
            int[] ranges
        )
        ...
        public static IEnumerable<object[]> UnicodeCategoriesInclusionsExpected_MemberData()
        {
            foreach (RegexEngine engine in RegexHelpers.AvailableEngines)
            {
                ...
                yield return new object[]
                {
                    engine,
                    "Ll",
                    new[] { UnicodeCategory.LowercaseLetter },
                };
                yield return new object[]
                {
                    engine,
                    "Lt",
                    new[] { UnicodeCategory.TitlecaseLetter },
                };
                yield return new object[]
                {
                    engine,
                    "Lm",
                    new[] { UnicodeCategory.ModifierLetter },
                };
                ...
                yield return new object[]
                {
                    engine,
                    "Mn",
                    new[] { UnicodeCategory.NonSpacingMark },
                };
                yield return new object[]
                {
                    engine,
                    "Mc",
                    new[] { UnicodeCategory.SpacingCombiningMark },
                };
                ...
                yield return new object[]
                {
                    engine,
                    "Nd",
                    new[] { UnicodeCategory.DecimalDigitNumber },
                };
                ...
                yield return new object[]
                {
                    engine,
                    "Pc",
                    new[] { UnicodeCategory.ConnectorPunctuation },
                };
                yield return new object[]
                {
                    engine,
                    "Pd",
                    new[] { UnicodeCategory.DashPunctuation },
                };
                yield return new object[]
                {
                    engine,
                    "Ps",
                    new[] { UnicodeCategory.OpenPunctuation },
                };
                yield return new object[]
                {
                    engine,
                    "Pe",
                    new[] { UnicodeCategory.ClosePunctuation },
                };
                yield return new object[]
                {
                    engine,
                    "Pi",
                    new[] { UnicodeCategory.InitialQuotePunctuation },
                };
                yield return new object[]
                {
                    engine,
                    "Pf",
                    new[] { UnicodeCategory.FinalQuotePunctuation },
                };
                yield return new object[]
                {
                    engine,
                    "Po",
                    new[] { UnicodeCategory.OtherPunctuation },
                };
                ...
                yield return new object[]
                {
                    engine,
                    "Sc",
                    new[] { UnicodeCategory.CurrencySymbol },
                };
                yield return new object[]
                {
                    engine,
                    "Sk",
                    new[] { UnicodeCategory.ModifierSymbol },
                };
                ...
                yield return new object[]
                {
                    engine,
                    "Zs",
                    new[] { UnicodeCategory.SpaceSeparator },
                };
                ...
                yield return new object[]
                {
                    engine,
                    "Zp",
                    new[] { UnicodeCategory.ParagraphSeparator },
                };
                ...
                yield return new object[]
                {
                    engine,
                    "Cn",
                    new[] { UnicodeCategory.OtherNotAssigned },
                };
            }
        }
        ...
        public async Task UnicodeCategoriesInclusionsExpected(
            RegexEngine engine,
            string generalCategory,
            UnicodeCategory[] unicodeCategory
        ) =>
            await ValidateUnicodeCategoryInclusionExclusion(
                engine,
                @$"\p{{{generalCategory}}}",
                @$"\P{{{generalCategory}}}",
                unicodeCategory
        ...
        private async Task ValidateUnicodeCategoryInclusionExclusion(
            RegexEngine engine,
...
#pragma warning restore SYSLIB0052 // Type or member is obsolete
        ...
        private static async Task ValidateSetAsync(
            RegexEngine engine,
            string regex,
            RegexOptions options,
        ...
        )
        {
            ...
            if (validateEveryChar)
            {
                for (int i = 0; i <= char.MaxValue; i++)
                {
                    ...
                    bool expected =
                        included != null ? included.Contains((char)i) : !excluded.Contains((char)i);
                    if (actual != expected)
                    {
                        Fail(i);
                    }
