...
namespace System.Text.RegularExpressions.Tests
{
    public class SymbolicRegexTests
    {
        ...
        public void BDDNumberOfRepresentedCharactersTests(
            UnicodeCategory category,
            uint expectedCardinality
        )
        {
        ...
        public static IEnumerable<object[]> SafeThresholdTests_MemberData()
        {
            ...
            {
                RegexNode tree = RegexParser
                    .Parse(Pattern, options, CultureInfo.CurrentCulture)
                    .Root;
                SymbolicRegexNode<BDD> rootNode = converter.ConvertToSymbolicRegexNode(tree);
                yield return new object[] { bddBuilder, rootNode, ExpectedSafeSize };
            }
        ...
        )
        {
            ...
            List<BDD> minterms = MintermGenerator<BDD>.GenerateMinterms(
                builder._solver,
            ...
            while (frontier.Count > 0)
            {
                ...
                foreach (BDD minterm in minterms)
                {
                    ...
                    SymbolicRegexNode<BDD> target = source.Node
                ...
                minterm.Equals(builder._newLineSet)
                    ...
                    (
                        !builder._solver
                            ...
                            : // in \w
                            CharKind.General
                    ); // anything else, thus in particular in \W
        }
        ...
        {
            AppContext.SetData(
                SymbolicRegexThresholds.SymbolicRegexSafeSizeThreshold_ConfigKeyName,
                newThresholdData
            );
