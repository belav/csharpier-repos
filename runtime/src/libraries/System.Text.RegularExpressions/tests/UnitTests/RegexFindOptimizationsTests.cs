...
namespace System.Text.RegularExpressions.Tests
{
    public class RegexFindOptimizationsTests
    {
        ...
        [InlineData(
            @"^hello",
            0,
            (int)FindNextStartingPositionMode.LeadingAnchor_LeftToRight_Beginning
        )]
        [InlineData(
            @"^hello$",
            0,
        ...
        [InlineData(
            @"\Ghello",
            0,
            (int)FindNextStartingPositionMode.LeadingAnchor_LeftToRight_Start
        )]
        [InlineData(
            @"\Ghello$",
            0,
        ...
        [InlineData(
            @"\Zhello",
            0,
            (int)FindNextStartingPositionMode.LeadingAnchor_LeftToRight_EndZ
        )]
        [InlineData(
            @"\Zhello$",
            0,
        ...
        [InlineData(
            @"\zhello$",
            0,
            (int)FindNextStartingPositionMode.LeadingAnchor_LeftToRight_End
        )]
        [InlineData(
            @"\zhi|\zhello",
            0,
        ...
        [InlineData(
            @"^",
            (int)RegexOptions.RightToLeft,
            (int)FindNextStartingPositionMode.LeadingAnchor_RightToLeft_Beginning
        )]
        [InlineData(
            @"hello^",
            (int)RegexOptions.RightToLeft,
        ...
        [InlineData(
            @"\G",
            (int)RegexOptions.RightToLeft,
            (int)FindNextStartingPositionMode.LeadingAnchor_RightToLeft_Start
        )]
        [InlineData(
            @"hello\G",
            (int)RegexOptions.RightToLeft,
        ...
        [InlineData(
            @"\Z",
            (int)RegexOptions.RightToLeft,
            (int)FindNextStartingPositionMode.LeadingAnchor_RightToLeft_EndZ
        )]
        [InlineData(
            @"hello\Z",
            (int)RegexOptions.RightToLeft,
        ...
        [InlineData(
            @"\z",
            (int)RegexOptions.RightToLeft,
            (int)FindNextStartingPositionMode.LeadingAnchor_RightToLeft_End
        )]
        [InlineData(
            @"hello\z",
            (int)RegexOptions.RightToLeft,
        ...
        {
            Assert.Equal(
                (FindNextStartingPositionMode)expectedMode,
                ComputeOptimizations(pattern, (RegexOptions)options).FindMode
            );
        }
        ...
        [InlineData(
            @"abc\z",
            0,
            (int)FindNextStartingPositionMode.TrailingAnchor_FixedLength_LeftToRight_End,
            3,
            (int)RegexNodeKind.End
        )]
        [InlineData(
            @"abc\Z",
            0,
            (int)FindNextStartingPositionMode.TrailingAnchor_FixedLength_LeftToRight_EndZ,
            3,
            (int)RegexNodeKind.EndZ
        )]
        [InlineData(
            @"abc$",
            0,
        ...
        [InlineData(
            @"(abc|defg){1,2}\z",
            0,
            (int)FindNextStartingPositionMode.LeadingSet_LeftToRight,
            8,
            (int)RegexNodeKind.End
        )]
        public void TrailingAnchor(
            string pattern,
            int options,
            int expectedMode,
            int expectedLength,
        ...
        [InlineData(
            @"ab",
            (int)RegexOptions.RightToLeft,
            (int)FindNextStartingPositionMode.LeadingString_RightToLeft,
            "ab"
        )]
        [InlineData(
            @"(a)(bc)",
        ...
        [InlineData(
            ...
            (int)FindNextStartingPositionMode.LeadingString_OrdinalIgnoreCase_LeftToRight,
            "abc"
        )]
        public void LeadingPrefix(
            string pattern,
            int options,
            int expectedMode,
        ...
        [InlineData(
            @"[ab]",
            (int)RegexOptions.RightToLeft,
            (int)FindNextStartingPositionMode.LeadingSet_RightToLeft,
            "ab"
        )]
        [InlineData(
            @"[Aa]",
        ...
        [InlineData(
            @"a",
            (int)RegexOptions.IgnoreCase | (int)RegexOptions.RightToLeft,
            (int)FindNextStartingPositionMode.LeadingSet_RightToLeft,
            "Aa"
        )]
        [InlineData(
        ...
        [InlineData(
            @"\bab(?=\w)(?!=\d)c\b",
            (int)(RegexOptions.IgnoreCase | RegexOptions.RightToLeft),
            (int)FindNextStartingPositionMode.LeadingSet_RightToLeft,
            "Cc"
        )]
        ...
        [InlineData(
            @"\d*a",
            0,
            (int)FindNextStartingPositionMode.LiteralAfterLoop_LeftToRight,
            null,
        ...
        public void LiteralAfterLoop(
            string pattern,
            int options,
            int expectedMode,
            string? expectedString,
            StringComparison expectedStringComparison,
            char expectedChar,
            char[]? expectedSet
        )
        {
            ...
            Assert.Equal(
                expectedStringComparison,
                opts.LiteralAfterLoop.Value.Literal.StringComparison
            );
        ...
        [InlineData(
            @".ab",
            0,
            (int)FindNextStartingPositionMode.FixedDistanceString_LeftToRight,
            "ab",
            1
        )]
        [InlineData(
            @".ab\w\w\wcdef\w\w\w\w\wghijklmnopq\w\w\w",
            0,
            (int)FindNextStartingPositionMode.FixedDistanceString_LeftToRight,
            "ghijklmnopq",
            15
        ...
        public void FixedDistanceString(
            string pattern,
            int options,
            int expectedMode,
            string expectedString,
        ...
        private static RegexFindOptimizations ComputeOptimizations(
            string pattern,
