...
namespace System.Text.RegularExpressions.Tests
{
    public class RegexReplaceTests
    {
        ...
        public async Task Replace_MatchEvaluator_Test(
            RegexEngine engine,
            string pattern,
            string input,
        ...
        public void Replace_MatchEvaluator_Test_NonBacktracking_Matra()
        {
            ...
            Assert.Equal(
                boldExpected,
                re.Replace(boldInput, new MatchEvaluator(MatchEvaluatorBold))
            );
        }
        ...
        public void Replace_NoMatch(RegexOptions options)
        {
            ...
            Assert.Same(
                input,
                Regex.Replace(input, "no-match", new MatchEvaluator(MatchEvaluator1), options)
            );
        }
