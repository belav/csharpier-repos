    ...
    public class DataTable
    {
        ...
        public void GenerateDataTableWithPartitions(int numberOfPartitions, string outputFilePath)
        {
            ...
            void EmitFirstLevelLookupTable(StreamWriter writer)
            {
                ...
                writer.Write(
                    "        private static ushort[] EquivalenceFirstLevelLookup { get; } = new ushort["
                        + firstLevelLookupTable.Count
                        + "]\n        {\n"
                );
            ...
            void EmitMapArray(StreamWriter writer)
            {
                ...
                writer.Write(
                    "        private static ushort[] EquivalenceCasingMap { get; } = new ushort["
                        + flattenedMap.Count
                        + "]\n        {\n"
                );
            ...
            void EmitValuesArray(StreamWriter writer)
            {
                ...
                writer.Write(
                    "        private static char[] EquivalenceCasingValues { get; } = new char["
