    ...
    public class DataTable
    {
        ...
        public void GenerateDataTableWithPartitions(int numberOfPartitions, string outputFilePath)
        {
            ...
            void EmitFirstLevelLookupTable(StreamWriter writer)
            {
                ...
                writer.Write(
                    $"        private static ReadOnlySpan<ushort> EquivalenceFirstLevelLookup => // {firstLevelLookupTable.Count}\n        [\n"
                );
            ...
            void EmitMapArray(StreamWriter writer)
            {
                ...
                writer.Write(
                    $"        private static ReadOnlySpan<ushort> EquivalenceCasingMap => // {flattenedMap.Count}]\n        [\n"
                );
            ...
            List<ushort> FlattenMapDictionary()
            {
                ...
                for (int i = 0; i <= 0xFFFF; i++)
                {
                    ...
                    int index =
                        (i / charactersPerRange) < numberOfPartitions
                            ? i / charactersPerRange
            ...
            void EmitValuesArray(StreamWriter writer)
            {
                ...
                writer.Write(
                    $"        private static ReadOnlySpan<char> EquivalenceCasingValues => // {flattenedValues.Count}\n        [\n"
                );
