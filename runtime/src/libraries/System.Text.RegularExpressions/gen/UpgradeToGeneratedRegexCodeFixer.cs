...
namespace System.Text.RegularExpressions.Generator
{
    ...
    public sealed class UpgradeToGeneratedRegexCodeFixer : CodeFixProvider
    {
        ...
        )
        {
            ...
            {
                IArgumentOperation? patternArgument = arguments.SingleOrDefault(
                    arg => arg.Parameter.Name == UpgradeToGeneratedRegexAnalyzer.PatternArgumentName
                );
            ...
            {
                IArgumentOperation? optionsArgument = arguments.SingleOrDefault(
                    arg => arg.Parameter.Name == UpgradeToGeneratedRegexAnalyzer.OptionsArgumentName
                );

                return optionsArgument is null
                    ? RegexOptions.None
            ...
            {
                IArgumentOperation? argument = arguments.SingleOrDefault(
