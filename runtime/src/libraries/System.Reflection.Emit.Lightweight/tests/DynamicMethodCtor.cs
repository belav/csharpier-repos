...
namespace System.Reflection.Emit.Tests
{
    public class DynamicMethodctor1
    {
        ...
        [ActiveIssue(
            "https://github.com/dotnet/runtime/issues/51211",
        ...
        )
        {
            ...
            DynamicMethod method2 = new DynamicMethod(
                name,
                returnType,
                parameterTypes,
                module,
            ...
            DynamicMethod method3 = new DynamicMethod(
                name,
                returnType,
                parameterTypes,
                module,
            ...
            DynamicMethod method4 = new DynamicMethod(
                name,
                MethodAttributes.Public | MethodAttributes.Static,
                CallingConventions.Standard,
                returnType,
            ...
            DynamicMethod method5 = new DynamicMethod(
                name,
                MethodAttributes.Public | MethodAttributes.Static,
                CallingConventions.Standard,
                returnType,
        ...
        public void String_Type_TypeArray_Type(
            string name,
            Type returnType,
            Type[] parameterTypes,
            Type owner
