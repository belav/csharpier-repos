...
namespace System.Formats.Tar.Tests
{
    public abstract partial class TarTestsBase : FileCleanupTestBase
    {
        ...
        protected void SetSymbolicLink(V7TarEntry symbolicLink) =>
            SetCommonSymbolicLink(symbolicLink);

        protected void VerifyRegularFile(V7TarEntry regularFile, bool isWritable) =>
            VerifyCommonRegularFile(regularFile, isWritable, isV7RegularFile: true);
        ...
        protected void VerifySymbolicLink(V7TarEntry symbolicLink) =>
