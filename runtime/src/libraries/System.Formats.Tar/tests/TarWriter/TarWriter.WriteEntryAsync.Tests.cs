...
namespace System.Formats.Tar.Tests
{
    ...
    public class TarWriter_WriteEntryAsync_Tests : TarWriter_WriteEntry_Base
    {
        ...
        public async Task WriteEntry_UsingTarEntry_FromTarReader_IntoTarWriter_Async(
            TarEntryFormat entryFormat,
            TarEntryType entryType,
        ...
        public async Task WriteEntry_FileSizeOverLegacyLimit_Throws_Async(
            TarEntryFormat entryFormat,
            bool unseekableStream
        )
        {
            ...
            await using Stream s = unseekableStream
        ...
        [InlineData(TarEntryFormat.Pax)]
        [InlineData(TarEntryFormat.Gnu)]
        public async Task WritingUnseekableDataStream_To_UnseekableArchiveStream_Throws_Async(
            TarEntryFormat entryFormat
        )
        {
            await using MemoryStream internalDataStream = new();
            await using WrappedStream unseekableDataStream = new(
                internalDataStream,
                canRead: true,
                canWrite: false,
                canSeek: false
            ...
            await using WrappedStream unseekableArchiveStream = new(
        ...
        [InlineData(TarEntryFormat.Pax)]
        [InlineData(TarEntryFormat.Gnu)]
        public async Task Write_TwoEntries_With_UnseekableDataStreams_Async(
            TarEntryFormat entryFormat
        )
        {
            ...
            await using WrappedStream unseekableDataStream1 = new(
                internalDataStream1,
                canRead: true,
                canWrite: false,
                canSeek: false
            ...
            await using WrappedStream unseekableDataStream2 = new(
                internalDataStream2,
                canRead: true,
                canWrite: false,
                canSeek: false
