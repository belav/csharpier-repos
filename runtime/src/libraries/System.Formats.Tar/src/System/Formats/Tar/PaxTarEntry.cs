...
namespace System.Formats.Tar
{
    ...
    public sealed class PaxTarEntry : PosixTarEntry
    {
        ...
        /// <summary>
        /// Initializes a new <see cref="PaxTarEntry"/> instance with the specified entry type, entry name,
        // and the default extended attributes.
        /// </summary>
        /// <param name="entryType">The type of the entry.</param>
        /// <param name="entryName">A string with the path and file name of this entry.</param>
        /// <remarks><para>When creating an instance using the <see cref="PaxTarEntry(TarEntryType,
        ...
        /// </list>
        /// <para>Use the <see cref="PaxTarEntry(TarEntryType, string, IEnumerable{KeyValuePair{string,
        // string}})"/> constructor to include additional extended attributes when creating the entry.</para>
        /// <para>The following entries are always found in the Extended Attributes dictionary of any PAX
        // entry:</para>
        /// <list type="bullet">
        ...
        /// </list>
        /// <para>The following entries are only found in the Extended Attributes dictionary of a PAX entry
        // if certain conditions are met:</para>
        /// <list type="bullet">
        /// <item>Group name, under the name <c>gname</c>, as a string, if it is larger than 32
        // bytes.</item>
        /// <item>User name, under the name <c>uname</c>, as a string, if it is larger than 32 bytes.</item>
        /// <item>File length, under the name <c>size</c>, as an <see cref="int"/>, if the string
        // representation of the number is larger than 12 bytes.</item>
        /// </list>
        /// </remarks>
        ...
        /// <summary>
        /// Initializes a new <see cref="PaxTarEntry"/> instance with the specified entry type, entry name
        // and Extended Attributes enumeration.
        /// </summary>
        /// <param name="entryType">The type of the entry.</param>
        /// <param name="entryName">A string with the path and file name of this entry.</param>
        /// <param name="extendedAttributes">An enumeration of string key-value pairs that represents the
        // metadata to include in the Extended Attributes entry that precedes the current entry.</param>
        /// <remarks>When creating an instance using the <see cref="PaxTarEntry(TarEntryType, string)"/>
        ...
        // cref="TarEntryType.CharacterDevice"/> and <see cref="TarEntryType.Fifo"/>.</item>
        /// </list>
        /// The specified <paramref name="extendedAttributes"/> get appended to the default attributes,
        // unless the specified enumeration overrides any of them.
        /// <para>The following entries are always found in the Extended Attributes dictionary of any PAX
        // entry:</para>
        /// <list type="bullet">
        /// <item>Modification time, under the name <c>mtime</c>, as a <see cref="double"/> number.</item>
        ...
        /// </list>
        /// </remarks>
        /// <exception cref="ArgumentNullException"><paramref name="extendedAttributes"/> or <paramref
        // name="entryName"/> is <see langword="null"/>.</exception>
        /// <exception cref="ArgumentException"><para><paramref name="entryName"/> is empty.</para>
        /// <para>-or-</para>
        /// <para><paramref name="entryType"/> is not supported in the specified format.</para></exception>
        public PaxTarEntry(
        ...
        /// <summary>
        /// Initializes a new <see cref="PaxTarEntry"/> instance by converting the specified <paramref
        // name="other"/> entry into the PAX format.
        /// </summary>
        ...
        /// <para>-or-</para>
        /// <para>The entry type of <paramref name="other"/> is not supported for conversion to the PAX
        ...
        /// </summary>
        /// <remarks>The extended attributes are specified when constructing an entry. Use <see
        // cref="PaxTarEntry(TarEntryType, string, IEnumerable{KeyValuePair{string, string}})"/> to append your
        // own enumeration of extended attributes to the current entry on top of the default ones. Use <see
        // cref="PaxTarEntry(TarEntryType, string)"/> to only use the default extended attributes.
        /// <para>The following entries are always found in the Extended Attributes dictionary of any PAX
        // entry:</para>
        /// <list type="bullet">
        /// <item>Modification time, under the name <c>mtime</c>, as a <see cref="double"/> number.</item>
