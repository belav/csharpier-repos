...
namespace System.Security.Cryptography.Cng.Tests
{
    public class ECDsaCngTests : ECDsaTestsBase
    {
        ...
        public static void TestPositiveVerify384()
        {
            ...
            byte[] sig = (
                "7805c494b17bba8cba09d3e5cdd16d69ce785e56c4f2d9d9061d549fce0a6860cca1cb9326bd534da21ad4ff326a1e0810d8"
        ...
        public static void TestPositiveVerify521()
        {
            ...
            byte[] sig = (
                "0084461450745672df85735fbf89f2dccef804d6b56e86ca45ea5c366a05a5de96327eddb75582821c6315c8bb823c875845"
        ...
        public static void TestVerify521_EcdhKey()
        {
            ...
            using (CngKey ecdh521 = CngKey.Import(keyBlob, CngKeyBlobFormat.EccPrivateBlob))
            {
                ...
                using (ECDsa ecdsaFromEcdhKey = new ECDsaCng(ecdh521))
                {
                    ...
                    byte[] ecdsaKeySignature = ecdsaFromEcdsaKey.SignData(
                        keyBlob,
                        HashAlgorithmName.SHA512
                    );

                    Assert.True(
                        ecdsaFromEcdhKey.VerifyData(
                            keyBlob,
                            ecdsaKeySignature,
                            HashAlgorithmName.SHA512
                        ),
        ...
        public static void TestSpecialNistKeys(
            int keySize,
            string curveName,
