...
public static class JSHost
{
    ...
    public static System.Threading.Tasks.Task<JSObject> ImportAsync(
        string moduleName,
        string moduleUrl,
...
public struct JSMarshalerArgument
{
    ...
    public void ToManaged(out System.Threading.Tasks.Task? value)
    {
        throw null;
    }

    public void ToJS(System.Threading.Tasks.Task? value)
    {
        throw null;
    }

    public void ToManaged<T>(
        out System.Threading.Tasks.Task<T>? value,
        ArgumentToManagedCallback<T> marshaler
    )
    {
        throw null;
    }

    public void ToJS<T>(System.Threading.Tasks.Task<T>? value, ArgumentToJSCallback<T> marshaler)
    {
        throw null;
    }
    ...
    public void ToManaged<T1, T2, T3>(
    ...
    public void ToManaged<T, TResult>(
    ...
    public void ToManaged<T1, T2, TResult>(
    ...
    public void ToJS<T1, T2, TResult>(
    ...
    public void ToManaged<T1, T2, T3, TResult>(
    ...
    public void ToJS<T1, T2, T3, TResult>(
