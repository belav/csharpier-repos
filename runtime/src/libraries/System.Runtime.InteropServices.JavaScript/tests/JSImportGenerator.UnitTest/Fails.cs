...
namespace JSImportGenerator.Unit.Tests
{
    public class Fails
    {
        public static IEnumerable<object?[]> CodeSnippetsToFail()
        {
            ...
            {
                CodeSnippets.DefaultReturnMarshaler<long>(),
                new string[]
                {
            ...
            yield return new object?[]
            {
                CodeSnippets.DefaultReturnMarshaler("System.Action"),
                new string[]
                {
        ...
        public async Task ValidateFailSnippets(
            string source,
            string[]? generatorMessages,
