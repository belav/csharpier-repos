...
namespace System.Runtime.InteropServices.JavaScript.Tests
{
    public partial class JavaScriptTestHelper
    {
        ...
        [JSExport]
        [return: JSMarshalAs<JSType.Promise<JSType.Any>>]
        public static async Task<object> AwaitTaskOfObject(
            [JSMarshalAs<JSType.Promise<JSType.Any>>] Task<object> arg1
        )
        {
            var res = await arg1;
        ...
        [JSExport]
        [return: JSMarshalAs<JSType.Function<JSType.Number, JSType.Number>>]
        public static Func<int, int> BackFuncOfIntInt(
            [JSMarshalAs<JSType.Function<JSType.Number, JSType.Number>>] Func<int, int> arg1
        )
        {
            return (int a) =>
            {
        ...
        [JSExport]
        [return: JSMarshalAs<JSType.Date>]
        public static DateTimeOffset EchoDateTimeOffset(
            [JSMarshalAs<JSType.Date>] DateTimeOffset arg1
        )
        {
            return arg1;
        }
        ...
        public static async Task InitializeAsync()
        {
            if (_module == null)
            {
                ...
                _module = await JSHost.ImportAsync(
