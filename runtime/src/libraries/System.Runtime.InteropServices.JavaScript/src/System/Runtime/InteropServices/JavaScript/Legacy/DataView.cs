...
namespace System.Runtime.InteropServices.JavaScript
{
    ...
    public class DataView : JSObject
    {
        ...
        /// </summary>
        /// <param name="buffer">ArrayBuffer to use as the storage backing the new DataView object.</param>
        /// <param name="byteOffset">The offset, in bytes, to the first byte in the above buffer for the new
        // view to reference. If unspecified, the buffer view starts with the first byte.</param>
        ...
        /// <param name="byteOffset">The offset, in bytes, to the first byte in the above buffer for the new
        // view to reference. If unspecified, the buffer view starts with the first byte.</param>
        /// <param name="byteLength">The number of elements in the byte array. If unspecified, the view's
        // length will match the buffer's length.</param>
        ...
        /// <summary>
        /// Gets the length (in bytes) of this view from the start of its ArrayBuffer. Fixed at construction
        ...
        /// <summary>
        /// Gets the offset (in bytes) of this view from the start of its ArrayBuffer. Fixed at construction
        // time and thus read only.
        /// </summary>
        ...
        /// <summary>
        /// Gets the signed 32-bit float (float) at the specified byte offset from the start of the
        // DataView.
        /// </summary>
        /// <returns>A signed 32-bit float number.</returns>
        /// <param name="byteOffset">Byte offset.</param>
        /// <param name="littleEndian">Indicates whether the 32-bit float is stored in little- or big-endian
        // format. If <c>false</c>, a big-endian value is read.</param>
        ...
        /// <summary>
        /// Gets the signed 64-bit double (double) at the specified byte offset from the start of the
        // DataView.
        /// </summary>
        /// <returns>A signed 64-bit coulbe number.</returns>
        /// <param name="byteOffset">Byte offset.</param>
        /// <param name="littleEndian">Indicates whether the 64-bit float is stored in little- or big-endian
        // format. If <c>false</c>, a big-endian value is read.</param>
        ...
        /// <summary>
        /// Gets the signed 16-bit integer (short) at the specified byte offset from the start of the
        // DataView.
        /// </summary>
        /// <returns>A signed 16-bit ineger (short) number.</returns>
        /// <param name="byteOffset">Byte offset.</param>
        /// <param name="littleEndian">Indicates whether the 16-bit integer (short) is stored in little- or
        // big-endian format. If <c>false</c>, a big-endian value is read.</param>
        ...
        /// <summary>
        /// Gets the signed 32-bit integer (int) at the specified byte offset from the start of the
        // DataView.
        /// </summary>
        /// <returns>A signed 32-bit ineger (int) number.</returns>
        /// <param name="byteOffset">Byte offset.</param>
        /// <param name="littleEndian">Indicates whether the 32-bit integer (int) is stored in little- or
        // big-endian format. If <c>false</c>, a big-endian value is read.</param>
        ...
        /// <param name="byteOffset">Byte offset.</param>
        /// <param name="littleEndian">Indicates whether the 8-bit byte is stored in little- or big-endian
        // format. If <c>false</c>, a big-endian value is read.</param>
        [CLSCompliant(false)]
        ...
        /// <summary>
        /// Gets the unsigned 16-bit integer (short) at the specified byte offset from the start of the
        // DataView.
        /// </summary>
        /// <returns>A unsigned 16-bit integer (ushort) number.</returns>
        /// <param name="byteOffset">Byte offset.</param>
        /// <param name="littleEndian">Indicates whether the unsigned 16-bit float is stored in little- or
        // big-endian format. If <c>false</c>, a big-endian value is read.</param>
        [CLSCompliant(false)]
        ...
        /// <summary>
        /// Gets the usigned 32-bit integer (uint) at the specified byte offset from the start of the
        // DataView.
        /// </summary>
        ...
        /// <summary>
        /// Sets the signed 32-bit float (float) at the specified byte offset from the start of the
        // DataView.
        /// </summary>
        /// <param name="byteOffset">Byte offset.</param>
        ...
        /// <summary>
        /// Sets the signed 64-bit double (double) at the specified byte offset from the start of the
        // DataView.
        /// </summary>
        /// <param name="byteOffset">Byte offset.</param>
        ...
        /// <summary>
        /// Sets the signed 16-bit integer (short) at the specified byte offset from the start of the
        // DataView.
        /// </summary>
        /// <param name="byteOffset">Byte offset.</param>
        ...
        /// <summary>
        /// Sets the signed 32-bit integer (int) at the specified byte offset from the start of the
        // DataView.
        /// </summary>
        /// <param name="byteOffset">Byte offset.</param>
        ...
        /// <summary>
        /// Sets the unsigned 16-bit integer (short) at the specified byte offset from the start of the
        // DataView.
        /// </summary>
        /// <param name="byteOffset">Byte offset.</param>
        ...
        /// <summary>
        /// Sets the usigned 32-bit integer (uint) at the specified byte offset from the start of the
        // DataView.
        /// </summary>
        /// <param name="byteOffset">Byte offset.</param>
        ...
        /// <summary>
        /// Sets the unsigned 8-bit byte (sbyte) at the specified byte offset from the start of the
        // DataView.
        /// </summary>
        /// <param name="byteOffset">Byte offset.</param>
