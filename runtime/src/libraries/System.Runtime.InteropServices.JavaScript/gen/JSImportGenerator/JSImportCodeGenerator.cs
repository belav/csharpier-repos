...
namespace Microsoft.Interop.JavaScript
{
    internal abstract class JSCodeGenerator
    {
        ...
        public const string ReturnNativeIdentifier =
                ...
                new ArgumentSyntax[]
                {
                    Argument(
                        LiteralExpression(
                            ...
                            Literal(_context.AttributeData.FunctionName)
                        )
                    ),
                    Argument(
                        _context.AttributeData.ModuleName == null
                            ...
                            : LiteralExpression(
                                SyntaxKind.StringLiteralExpression,
                                Literal(_context.AttributeData.ModuleName)
                            )
                    ),
                                ...
                                AssignmentExpression(
                                    ...
                                    InvocationExpression(
                                            MemberAccessExpression(
                                                ...
                                                IdentifierName(Constants.BindJSFunctionMethod)
                                            )
                                        )
                                        .WithArgumentList(
                                            ArgumentList(SeparatedList(bindingParameters))
                                        )
                                )
                            )
                        )
        ...
        private void SetupSyntax(List<StatementSyntax> statementsToUpdate)
        {
            statementsToUpdate.Add(
                LocalDeclarationStatement(
                    VariableDeclaration(
                            GenericName(Identifier(Constants.SpanGlobal))
