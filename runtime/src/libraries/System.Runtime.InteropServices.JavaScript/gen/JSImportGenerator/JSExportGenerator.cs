...
namespace Microsoft.Interop.JavaScript
{
    ...
    public sealed class JSExportGenerator : IIncrementalGenerator
    {
        ...
        private static MemberDeclarationSyntax PrintGeneratedSource(
            ...
            BlockSyntax registerStatements
        )
        {
            var WrapperName = "__Wrapper_" + userDeclaredMethod.Identifier + "_" + stub.TypesHash;
            var RegistrationName =
                "__Register_" + userDeclaredMethod.Identifier + "_" + stub.TypesHash;
            ...
            MemberDeclarationSyntax registerMethod = MethodDeclaration(
                    PredefinedType(Token(SyntaxKind.VoidKeyword)),
                    Identifier(RegistrationName)
                )
                .WithAttributeLists(
                    List(
                                            ...
                                            AttributeArgumentList(
                                                SeparatedList(
                                                    new[]
                                                    {
                                                        ...
                                                        AttributeArgument(
                                                            TypeOfExpression(
                                                                ParseTypeName(stub.StubTypeFullName)
                                                            )
                                                        )
                                                    }
                                                )
        ...
        )
        {
            ...
            return (
                ...
                incrementalContext.Diagnostics.AddRange(diagnostics.Diagnostics)
            );
        }
