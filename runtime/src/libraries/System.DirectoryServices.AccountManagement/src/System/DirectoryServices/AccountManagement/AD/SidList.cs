...
namespace System.DirectoryServices.AccountManagement
{
    ...
    {
        internal SidList(List<byte[]> sidListByteFormat)
            : this(sidListByteFormat, null, null) { }
        ...
        private void TranslateSids(string target, IntPtr[] pSids)
        {
            ...
            try
            {
                ...
                if (
                    err != Interop.StatusOptions.STATUS_SUCCESS
                ...
                Interop.LSA_REFERENCED_DOMAIN_LIST domainList =
                    domainsHandle.Read<Interop.LSA_REFERENCED_DOMAIN_LIST>(0);
                ...
                Interop.LSA_TRUST_INFORMATION[] domains = new Interop.LSA_TRUST_INFORMATION[
                    domainCount
                ];
                ...
                {
                    domains[i] = (Interop.LSA_TRUST_INFORMATION)
                        Marshal.PtrToStructure(
                            pCurrentDomain,
                            typeof(Interop.LSA_TRUST_INFORMATION)
                        );
                    pCurrentDomain = new IntPtr(
                        pCurrentDomain.ToInt64()
                            + Marshal.SizeOf(typeof(Interop.LSA_TRUST_INFORMATION))
                    );
                }
