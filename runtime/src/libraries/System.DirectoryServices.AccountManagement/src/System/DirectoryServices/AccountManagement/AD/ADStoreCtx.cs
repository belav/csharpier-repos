    ...
    internal partial class ADStoreCtx : StoreCtx
    {
                ...
                if (null != ldapAttribute)
                {
                    if (propertyNameToLdapAttr.ContainsKey(propertyName))
                    {
                        string[] props = new string[
                            propertyNameToLdapAttr[propertyName].Length + 1
                        ];
        ...
        internal override bool IsLockedOut(AuthenticablePrincipal p)
        {
            try
            {
                ...
                de.RefreshCache(
                    new string[] { "msDS-User-Account-Control-Computed", "lockoutTime" }
                );
                ...
                if (p.ContextType != ContextType.ApplicationDirectory)
                {
                    ...
                    Forest forest = Forest.GetForest(
                        new DirectoryContext(
                            ...
                            this.DnsForestName,
                            this.credentials != null ? this.credentials.UserName : null,
                            this.credentials != null ? this.credentials.Password : null
                        )
                    );
