...
namespace System.IO.FileSystem.DriveInfoTests
{
    public class DriveInfoWindowsTests
    {
        ...
        {
            DriveInfo validDrive = DriveInfo.GetDrives()
        ...
        {
            var validDrive = DriveInfo.GetDrives()
                .Where(d => d.DriveType == DriveType.Fixed)
                .First();
        ...
        public void GetVolumeLabel_Returns_CorrectLabel()
        {
            void DoDriveCheck()
            {
                ...
                DriveInfo validDrive = DriveInfo.GetDrives()
                    .First(d => d.DriveType == DriveType.Fixed);
                bool volumeInformationSuccess = GetVolumeInformation(
                    validDrive.Name,
                    volumeName,
                    volNameLen,
                    out serialNumber,
        ...
        public void VolumeLabelOnNetworkOrCdRom_Throws()
        {
            ...
            var noAccessDrive = DriveInfo.GetDrives()
                .Where(d => d.DriveType == DriveType.Network || d.DriveType == DriveType.CDRom);
