...
namespace System.Security.Cryptography.Cose.Tests
{
    public class CoseHeaderLabelTests
    {
        ...
        {
            Assert.True(
                default(CoseHeaderLabel).Equals(default),
                "default(CoseHeaderLabel).Equals(default)"
            );
            Assert.True(
                default(CoseHeaderLabel).Equals(new CoseHeaderLabel(0)),
                "default(CoseHeaderLabel).Equals(new CoseHeaderLabel(0))"
            );
            Assert.True(
                new CoseHeaderLabel(1).Equals(new CoseHeaderLabel(1)),
                "new CoseHeaderLabel(1).Equals(new CoseHeaderLabel(1))"
            );
            Assert.True(
                new CoseHeaderLabel("").Equals(new CoseHeaderLabel("")),
                "new CoseHeaderLabel(\"\").Equals(new CoseHeaderLabel(\"\"))"
            );

            Assert.False(
                default(CoseHeaderLabel).Equals(new CoseHeaderLabel(1)),
                "default(CoseHeaderLabel).Equals(new CoseHeaderLabel(1))"
            );
            Assert.False(
                default(CoseHeaderLabel).Equals(new CoseHeaderLabel("")),
                "default(CoseHeaderLabel).Equals(new CoseHeaderLabel(\"\"))"
            );
            Assert.False(
                new CoseHeaderLabel(0).Equals(new CoseHeaderLabel(1)),
                "new CoseHeaderLabel(0).Equals(new CoseHeaderLabel(1))"
            );
            Assert.False(
                new CoseHeaderLabel("foo").Equals(new CoseHeaderLabel("bar")),
                "new CoseHeaderLabel(\"foo\").Equals(new CoseHeaderLabel(\"bar\"))"
            );
        }
        ...
        public void CoseHeaderLabel_op_Equality()
        {
            ...
            Assert.True(
                default(CoseHeaderLabel) == new CoseHeaderLabel(0),
                "default(CoseHeaderLabel) == new CoseHeaderLabel(0)"
            );
            Assert.True(
                new CoseHeaderLabel(1) == new CoseHeaderLabel(1),
                "new CoseHeaderLabel(1) == new CoseHeaderLabel(1)"
            );
            Assert.True(
                new CoseHeaderLabel("") == new CoseHeaderLabel(""),
                "new CoseHeaderLabel(\"\") == new CoseHeaderLabel(\"\")"
            );

            Assert.False(
                default(CoseHeaderLabel) == new CoseHeaderLabel(1),
                "default(CoseHeaderLabel) == new CoseHeaderLabel(1)"
            );
            Assert.False(
                default(CoseHeaderLabel) == new CoseHeaderLabel(""),
                "default(CoseHeaderLabel) == new CoseHeaderLabel(\"\")"
            );
            Assert.False(
                new CoseHeaderLabel(0) == new CoseHeaderLabel(1),
                "new CoseHeaderLabel(0) == new CoseHeaderLabel(1)"
            );
            Assert.False(
        ...
        {
            Assert.False(
                default(CoseHeaderLabel) != default,
                "default(CoseHeaderLabel) != default"
            );
            Assert.False(
                default(CoseHeaderLabel) != new CoseHeaderLabel(0),
