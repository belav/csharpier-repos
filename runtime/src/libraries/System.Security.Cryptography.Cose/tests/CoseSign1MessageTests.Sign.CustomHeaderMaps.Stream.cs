...
{
    public abstract class CoseSign1MessageTests_SignStream
        : CoseSign1MessageTests_Sign_CustomHeaderMaps
    {
    ...
    public class CoseSign1MessageTests_SignStream_Async : CoseSign1MessageTests_SignStream
    {
        ...
        )
        {
            ...
            if (content == null)
            {
                return CoseSign1Message
                    .SignAsync(null!, key, hashAlgorithm, protectedHeaders, unprotectedHeaders)
                    .GetAwaiter()
                    .GetResult();
            }
            ...
            return CoseSign1Message
                .SignAsync(stream, key, hashAlgorithm, protectedHeaders, unprotectedHeaders)
                .GetAwaiter()
                .GetResult();
        }
        ...
        public async Task SignAsyncWithUnseekableStream()
        {
            ...
            await Assert.ThrowsAsync<ArgumentException>(
                "detachedContent",
                () => CoseSign1Message.SignAsync(stream, DefaultKey, DefaultHash)
            );
        }
    ...
    public class CoseSign1MessageTests_SignStream_Sync : CoseSign1MessageTests_SignStream
    {
        ...
        public void SignWithUnseekableStream()
        {
            ...
            Assert.Throws<ArgumentException>(
                "detachedContent",
                () => CoseSign1Message.Sign(stream, DefaultKey, DefaultHash)
            );
        }
