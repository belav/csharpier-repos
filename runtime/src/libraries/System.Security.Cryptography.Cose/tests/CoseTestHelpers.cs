...
namespace System.Security.Cryptography.Cose.Tests
{
    public class CoseTestHelpers
    {
        ...
        internal static readonly byte[] s_sampleContent = Encoding.UTF8.GetBytes(
            "This is the content."
        );
        ...
        private static void AssertSign1ProtectedHeaders(
        ...
        private static void AssertSign1Headers(
            CborReader reader,
        ...
        )
        {
            ...
            {
                Assert.True(
                    headers.TryGetEncodedValue(
                        expectedLabel,
                        out ReadOnlyMemory<byte> encodedValue
                    ),
                    "headers.TryGetEncodedValue(expectedLabel, out ReadOnlyMemory<byte> encodedValue)"
                );
        ...
        internal static (T Key, HashAlgorithmName Hash) GetKeyHashPair<T>(
            CoseAlgorithm algorithm,
