...
namespace System.Security.Cryptography.Cose.Tests
{
    public abstract class CoseSign1MessageTests_Verify
    {
        ...
        [InlineData(
            (int)ECDsaAlgorithm.ES384,
            ""
        )]
        // https://github.com/cose-wg/Examples/blob/master/ecdsa-examples/ecdsa-sig-03.json
        [InlineData(
            (int)ECDsaAlgorithm.ES512,
            ""
        )]
        [InlineData(
            (int)RSAAlgorithm.PS256,
            ""
        )]
        [InlineData(
            (int)RSAAlgorithm.PS384,
            ""
        )]
        [InlineData(
            (int)RSAAlgorithm.PS512,
            ""
        )]
        ...
        public void TestVerify(int algorithm, string hexCborMessage)
        {
            ...
            foreach (bool useNonPrivateKey in new[] { false, true })
            {
                CoseSign1Message msg = CoseMessage.DecodeSign1(
                    ByteUtils.HexToByteArray(hexCborMessage)
                );
                AsymmetricAlgorithm key = GetKeyHashPair<AsymmetricAlgorithm>(
                ...
                else
                {
                    AssertExtensions.SequenceEqual(
                        s_sampleContent,
                        msg.Content.GetValueOrDefault().Span
                    );
                }

                Assert.True(
                    msg.ProtectedHeaders.TryGetEncodedValue(
        ...
        public void VerifyReturnsFalseWithDataNotMatchingSignature()
        {
            ...
            string hexCborMessageCorrupt1 = ReplaceFirst(
                hexCborMessage,
                "45A201260300",
                "45A201260301"
            );
            ...
            Assert.False(
                ...
                "Verification passed when should've failed - Corrupt protected header"
            );

            if (!UseDetachedContent)
            {
                string hexCborMessageCorrupt2 = ReplaceFirst(
                    hexCborMessage,
                    "546869732069732074686520636F6E74656E742E",
                    "546869732069732074686520636F6E74656E743E"
                );
                msg = CoseMessage.DecodeSign1(ByteUtils.HexToByteArray(hexCborMessageCorrupt2));
                Assert.False(
                    Verify(msg, DefaultKey, s_sampleContent),
                    "Verification passed when should've failed - Corrupt content"
                );
            }
        ...
        public void VerifyReturnsTrueAfterAttemptWithWrongContent()
        {
            ...
            ReadOnlySpan<byte> encodedMsg = CoseSign1Message.Sign(
                correctContent,
                DefaultKey,
                DefaultHash,
                isDetached: true
        ...
        public void VerifyThrowsIfContentIsNull()
        {
            ...
            byte[] encodedMsg = CoseSign1Message.Sign(
                s_sampleContent,
                DefaultKey,
                DefaultHash,
                isDetached: true
        ...
        public void VerifyThrowsIfUnsupportedHeaderWasIncluded()
        {
            ...
            {
                foreach (
                    CoseHeaderLabel unsupportedHeader in new[]
                    {
                        CoseHeaderLabel.Critical,
                ...
                )
                {
                    ...
                    (useProtected ? protectedHeaders : unprotectedHeaders).SetValue(
                        unsupportedHeader,
        ...
        private void ReplaceContentInHexCborMessage(ref string hexCborMessage)
        {
            if (UseDetachedContent)
            {
                hexCborMessage = hexCborMessage.Replace(
                    SampleContentByteStringCborHex,
                    NullCborHex
                );
            }
        }
