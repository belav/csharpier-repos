...
{
    public abstract class CoseMultiSignMessageTests_Sign_CustomHeaderMaps
        : CoseMessageTests_Sign_CustomHeaderMaps
    {
    ...
    public class CoseMultiSignMessageTests_Sign_ByteArray
        : CoseMultiSignMessageTests_Sign_CustomHeaderMaps
    {
        ...
        )
        {
            return isDetached
                ...
                : CoseMultiSignMessage.SignEmbedded(
                    content,
                    signer,
                    protectedHeaders,
                    unprotectedHeaders,
    ...
    public class CoseMultiSignMessageTests_TrySign : CoseMultiSignMessageTests_Sign_CustomHeaderMaps
    {
        ...
        )
        {
            ...
            int bytesWritten;
            byte[] expectedEncodedMsg = SignFixed(
                content,
                signer,
                protectedHeaders,
                unprotectedHeaders,
        ...
        private bool TrySign(
            ...
            isDetached
                ? CoseMultiSignMessage.TrySignDetached(
                    content,
                    destination,
                    signer,
                    out bytesWritten,
                ...
                : CoseMultiSignMessage.TrySignEmbedded(
                    content,
                    destination,
                    signer,
                    out bytesWritten,
