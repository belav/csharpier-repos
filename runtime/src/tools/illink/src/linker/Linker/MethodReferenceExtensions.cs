...
#pragma warning restore RS0030
            ...
            )
            {
                ...
                string name = methodDefinition.IsSetter
                    ? string.Concat(methodDefinition.Name.AsSpan(4), ".set")
                    : string.Concat(methodDefinition.Name.AsSpan(4), ".get");
                sb.Append(name);
...
#pragma warning restore RS0030 // Do not used banned APIs
        ...
        public static TypeReference? GetInflatedParameterType(
...
#pragma warning disable RS0030 // MethodReference.Parameters is banned -- it's best to leave this as is for now
            if (method.DeclaringType is GenericInstanceType genericInstance)
                return TypeReferenceExtensions.InflateGenericType(
                    genericInstance,
                    method.Parameters[parameterIndex].ParameterType,
                    context
                );
...
#pragma warning restore RS0030 // Do not used banned APIs
        ...
        /// </summary>
        public static IEnumerable<ReferenceKind> GetParameterReferenceKinds(
            this MethodReference method
        )
        {
