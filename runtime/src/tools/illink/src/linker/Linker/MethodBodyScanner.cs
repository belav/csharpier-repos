...
namespace Mono.Linker
{
    ...
    readonly struct InterfacesOnStackScanner
    {
        ...
        void AddMatchingInterfaces(
            HashSet<(InterfaceImplementation, TypeDefinition)> results,
            TypeDefinition type,
            TypeDefinition[] interfaceTypes
        )
        {
        ...
        void AddFromGenericParameterProvider(
