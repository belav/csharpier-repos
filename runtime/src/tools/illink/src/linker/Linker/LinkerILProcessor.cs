...
#pragma warning disable RS0030
    public sealed class LinkerILProcessor
    {
        ...
        public void Emit(OpCode opcode, TypeReference type) =>
            Append(_ilProcessor.Create(opcode, type));

        public void Emit(OpCode opcode, MethodReference method) =>
            Append(_ilProcessor.Create(opcode, method));

        public void Emit(OpCode opcode, VariableDefinition variable) =>
            Append(_ilProcessor.Create(opcode, variable));
        ...
        public void Append(Instruction instruction)
        {
            Instruction? lastInstruction =
                Instructions.Count == 0 ? null : Instructions[Instructions.Count - 1];
        ...
        public void Replace(int index, Instruction instruction) =>
            Replace(_ilProcessor.Body.Instructions[index], instruction);
        ...
        public void Remove(Instruction instruction)
        {
            ...
            Instruction? nextInstruction =
                Instructions.Count == index + 1 ? null : Instructions[index + 1];
