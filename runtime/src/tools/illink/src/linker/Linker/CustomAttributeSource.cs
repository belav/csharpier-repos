...
namespace Mono.Linker
{
    public class CustomAttributeSource
    {
        ...
        public static AssemblyDefinition GetAssemblyFromCustomAttributeProvider(
        ...
        public bool TryGetEmbeddedXmlInfo(
            ICustomAttributeProvider provider,
            [NotNullWhen(true)] out AttributeInfo? xmlInfo
        )
        {
        ...
        public bool TryGetCustomAttributeOrigin(
            ICustomAttributeProvider provider,
            CustomAttribute customAttribute,
            out MessageOrigin origin
        )
        {
            if (
