...
namespace Mono.Linker
{
    public static class EmbeddedXmlInfo
    {
        ...
        public static void ProcessDescriptors(AssemblyDefinition assembly, LinkContext context)
        {
            ...
            {
                context.LogMessage(
                    $"Processing embedded linker descriptor '{rsc.Name}' from '{assembly.Name}'."
                );
        ...
        public static SubstitutionInfo? ProcessSubstitutions(
            AssemblyDefinition assembly,
            LinkContext context
        )
        {
        ...
        public static AttributeInfo? ProcessAttributes(
            AssemblyDefinition assembly,
            LinkContext context
        )
        {
        ...
        static DescriptorMarker GetExternalResolveStep(
            LinkContext context,
        ...
        static BodySubstitutionParser GetExternalSubstitutionParser(
            LinkContext context,
            EmbeddedResource resource,
            AssemblyDefinition assembly
        )
        ...
        static LinkAttributesParser GetExternalLinkAttributesParser(
            LinkContext context,
            EmbeddedResource resource,
            AssemblyDefinition assembly
        )
