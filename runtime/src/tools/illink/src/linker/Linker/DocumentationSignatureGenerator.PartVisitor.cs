...
namespace Mono.Linker
{
    public sealed partial class DocumentationSignatureGenerator
    {
        ...
        internal sealed class PartVisitor
        {
            ...
            public void VisitMethodDefinition(
...
#pragma warning restore RS0030
            ...
            public static void VisitGenericParameter(
            ...
            public void VisitTypeReference(
            ...
            )
            {
                ...
                if (typeReference.IsNested)
                {
                    ...
                    VisitTypeReference(
                        typeReference.GetInflatedDeclaringType(resolver)!,
                        builder,
                        resolver
                    );
                    builder.Append('.');
                ...
                if (
                    ...
                    || typeReference is not GenericInstanceType genericInstance
                )
                    return;
            ...
            public void VisitByReferenceType(
