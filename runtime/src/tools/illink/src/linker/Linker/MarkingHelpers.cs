...
namespace Mono.Linker
{
    public class MarkingHelpers
    {
        ...
        public void MarkMatchingExportedType(
            TypeDefinition typeToMatch,
            ...
            if (typeReference.Scope is AssemblyNameReference)
            {
                ...
                if (
                    ...
                    MarkExportedType(
                        exportedType,
                        assembly.MainModule,
                        new DependencyInfo(DependencyKind.ExportedType, typeReference),
                        origin
                    );
            }
        }
