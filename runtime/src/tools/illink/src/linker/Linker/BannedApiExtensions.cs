...
public static class BannedApiExtensions
{
    ...
    public static Collection<ExceptionHandler> ExceptionHandlers(
        this MethodBody body,
        LinkContext context
    ) => context.GetMethodIL(body.Method).ExceptionHandlers;

    public static Collection<VariableDefinition> Variables(
        this MethodBody body,
        LinkContext context
    ...
    public static LinkerILProcessor GetLinkerILProcessor(this MethodBody body) => new(body);
}
