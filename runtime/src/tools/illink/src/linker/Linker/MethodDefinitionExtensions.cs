...
namespace Mono.Linker
{
    [SuppressMessage(
        ...
        Justification = "This class provides wrapper methods around the banned Parameters property"
    )]
    public static class MethodDefinitionExtensions
    {
        ...
        public static bool IsIntrinsic(this MethodDefinition method)
        {
            ...
            foreach (var ca in method.CustomAttributes)
            {
                ...
                if (
                    caType.Name == "IntrinsicAttribute"
        ...
        public static bool TryGetProperty(
            this MethodDefinition md,
            [NotNullWhen(true)] out PropertyDefinition? property
        )
        {
            property = null;
        ...
        public static bool TryGetEvent(
            this MethodDefinition md,
            [NotNullWhen(true)] out EventDefinition? @event
        )
        {
            @event = null;
            if (!md.IsEventMethod())
        ...
        /// </summary>
        internal static ParameterProxy? TryGetParameter(
        ...
        /// </summary>
        internal static ParameterProxy GetParameter(
            this MethodDefinition method,
            ParameterIndex index
        )
        {
            if (method.TryGetParameter(index) is not ParameterProxy param)
                throw new InvalidOperationException(
                    $"Cannot get parameter #{(int)index} of method {method.GetDisplayName()} with {method.GetParametersCount()} parameters"
                );
            return param;
        }
        ...
        internal static ParameterProxyEnumerable GetParameters(this MethodDefinition method)
        {
            ...
            return new ParameterProxyEnumerable(
                0,
                method.Parameters.Count + implicitThisOffset,
                method
            );
        }
