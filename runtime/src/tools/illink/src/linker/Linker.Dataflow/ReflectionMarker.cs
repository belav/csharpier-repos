    ...
    public readonly struct ReflectionMarker
    {
        ...
        )
        {
            if (_enabled)
            {
                ...
                _markStep.MarkTypeVisibleToReflection(
                    typeReference,
                    typeDefinition,
                    new DependencyInfo(DependencyKind.AccessedViaReflection, origin.Provider),
                    origin
                );
        ...
        )
        {
            ...
            _markStep.MarkTypeVisibleToReflection(
                type,
                type,
                new DependencyInfo(dependencyKind, origin.Provider),
                origin
            );
        }
        ...
        )
        {
            ...
            _markStep.MarkMethodVisibleToReflection(
                method,
                new DependencyInfo(dependencyKind, origin.Provider),
                origin
            );
        ...
        )
        {
            ...
            _markStep.MarkPropertyVisibleToReflection(
                property,
                new DependencyInfo(dependencyKind, origin.Provider),
                origin
            );
        ...
        )
        {
            ...
            _markStep.MarkEventVisibleToReflection(
                @event,
                new DependencyInfo(dependencyKind, origin.Provider),
                origin
            );
