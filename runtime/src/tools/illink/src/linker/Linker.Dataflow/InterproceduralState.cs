...
namespace Mono.Linker.Dataflow
{
    ...
    struct InterproceduralState : IEquatable<InterproceduralState>
    {
        ...
        public InterproceduralState(
            ValueSet<MethodIL> methodBodies,
        ...
        public override int GetHashCode() =>
            HashUtils.Combine(MethodBodies.GetHashCode(), HoistedLocals.GetHashCode());
    ...
    readonly struct InterproceduralStateLattice : ILattice<InterproceduralState>
    {
        ...
        public InterproceduralState Top =>
            new InterproceduralState(MethodBodyLattice.Top, HoistedLocalsLattice.Top, this);
