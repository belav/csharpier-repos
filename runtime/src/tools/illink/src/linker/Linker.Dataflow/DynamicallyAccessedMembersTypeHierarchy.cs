    ...
    sealed class DynamicallyAccessedMembersTypeHierarchy
    {
        ...
        )
        {
            ...
            if (baseType != null)
            {
                ...
                var annotationToApplyToBase = baseAnnotation.applied
                    ? Annotations.GetMissingMemberTypes(annotation, baseAnnotation.annotation)
                    : annotation;
            ...
            if (annotation.HasFlag(DynamicallyAccessedMemberTypes.Interfaces) && type.HasInterfaces)
            {
                ...
                foreach (var iface in type.Interfaces)
                {
                    ...
                    if (
                        interfaceAnnotation.applied
                        && interfaceAnnotation.annotation.HasFlag(annotationToApplyToInterfaces)
                    )
                        continue;
