...
namespace ILLink.CodeFix
{
    [
        ExportCodeFixProvider(
            ...
            Name = nameof(DynamicallyAccessedMembersCodeFixProvider)
        ),
        Shared
    ]
    public sealed class DynamicallyAccessedMembersCodeFixProvider
        : Microsoft.CodeAnalysis.CodeFixes.CodeFixProvider
    {
        ...
        private static LocalizableResourceString CodeFixTitle =>
            new LocalizableResourceString(
                nameof(Resources.DynamicallyAccessedMembersCodeFixTitle),
                Resources.ResourceManager,
                typeof(Resources)
            );

        private static string FullyQualifiedAttributeName =>
            DynamicallyAccessedMembersAnalyzer.FullyQualifiedDynamicallyAccessedMembersAttribute;
        ...
        public override async Task RegisterCodeFixesAsync(CodeFixContext context)
        {
            ...
            if (
                ...
                is not SyntaxNode targetNode
            )
                return;
            if (
                diagnostic.Properties["attributeArgument"] is not string stringArgs
                || stringArgs.Contains(",")
            )
                return;
                ...
                CodeAction.Create(
                    ...
                    createChangedDocument: ct =>
                        AddAttributeAsync(
                            ...
                            addGenericParameterAttribute: AttributeOnGeneric.Contains(
                                diagnostic.Id
                            ),
                            ct
                        ),
