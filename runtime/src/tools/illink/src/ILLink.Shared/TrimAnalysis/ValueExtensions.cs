...
namespace ILLink.Shared.TrimAnalysis
{
    internal static partial class ValueExtensions
    {
        ...
        private static ValueSet<SingleValue>.Enumerable Unknown =
            new ValueSet<SingleValue>.Enumerable(UnknownValue.Instance);
        ...
        {
            return multiValue.IsUnknown() ? Unknown : multiValue.GetKnownValues();
        }
    }
}
