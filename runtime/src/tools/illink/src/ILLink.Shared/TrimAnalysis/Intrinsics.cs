        ...
        public static IntrinsicId GetIntrinsicIdForMethod(MethodProxy calledMethod)
        {
            return calledMethod.Name switch
            {
                ...
                "New"
                    when calledMethod.IsDeclaredOnType("System.Linq.Expressions.Expression")
                        && calledMethod.HasParameterOfType((ParameterIndex)0, "System.Type")
                        && calledMethod.HasMetadataParametersCount(1) => IntrinsicId.Expression_New,

                // static Array System.Enum.GetValues (Type)
                "GetValues"
                    when calledMethod.IsDeclaredOnType("System.Enum")
                        && calledMethod.HasParameterOfType((ParameterIndex)0, "System.Type")
                        && calledMethod.HasMetadataParametersCount(1) => IntrinsicId.Enum_GetValues,
                ...
                "SizeOf"
                    when calledMethod.IsDeclaredOnType("System.Runtime.InteropServices.Marshal")
                        && calledMethod.HasParameterOfType((ParameterIndex)0, "System.Type")
                        && calledMethod.HasMetadataParametersCount(1) => IntrinsicId.Marshal_SizeOf,
                ...
                "get_BaseType"
                    when calledMethod.IsDeclaredOnType("System.Type")
                        && calledMethod.HasImplicitThis()
                        && !calledMethod.HasMetadataParameters() => IntrinsicId.Type_get_BaseType,
                ...
                "get_CodeBase"
                    when calledMethod.IsDeclaredOnType("System.Reflection.AssemblyName") =>
