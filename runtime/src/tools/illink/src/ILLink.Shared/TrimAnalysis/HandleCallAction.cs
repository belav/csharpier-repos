...
namespace ILLink.Shared.TrimAnalysis
{
    ...
    internal partial struct HandleCallAction
    {
        ...
        )
        {
            ...
            switch (intrinsicId)
            {
                            ...
                            value switch
                            {
                                RuntimeTypeHandleForNullableSystemTypeValue nullableSystemType =>
                                    new NullableSystemTypeValue(
                                        nullableSystemType.NullableType,
                                        nullableSystemType.UnderlyingTypeValue
                                    ),
                                ...
                                RuntimeTypeHandleForNullableValueWithDynamicallyAccessedMembers nullableDamType
                                    when nullableDamType.UnderlyingTypeValue
                                        is RuntimeTypeHandleForGenericParameterValue underlyingGenericParameter =>
                                    new NullableValueWithDynamicallyAccessedMembers(
                                        nullableDamType.NullableType,
                                        _annotations.GetGenericParameterValue(
                                            underlyingGenericParameter.GenericParameter
                                        )
                                    ),
                                // This should only happen if the code does something like typeof(Nullable<>).MakeGenericType(methodParameter).TypeHandle
                                RuntimeTypeHandleForNullableValueWithDynamicallyAccessedMembers nullableDamType
                                    when nullableDamType.UnderlyingTypeValue
                                        is ValueWithDynamicallyAccessedMembers underlyingTypeValue =>
                                    new NullableValueWithDynamicallyAccessedMembers(
                                        nullableDamType.NullableType,
                                        underlyingTypeValue
                                    ),
                                RuntimeTypeHandleValue typeHandle => new SystemTypeValue(
                            ...
                            AddReturnValue(
                                value switch
                                {
                                    NullableSystemTypeValue nullableSystemType =>
                                        new RuntimeTypeHandleForNullableSystemTypeValue(
                                            nullableSystemType.NullableType,
                                            nullableSystemType.UnderlyingTypeValue
                                        ),
                                    NullableValueWithDynamicallyAccessedMembers nullableDamType
                                        when nullableDamType.UnderlyingTypeValue
                                            is GenericParameterValue genericParam =>
                                    ...
                                    NullableValueWithDynamicallyAccessedMembers nullableDamType =>
                                        new RuntimeTypeHandleForNullableValueWithDynamicallyAccessedMembers(
                                            nullableDamType.NullableType,
                                            nullableDamType.UnderlyingTypeValue
                                        ),
                                    SystemTypeValue typeHandle => new RuntimeTypeHandleValue(
                                        typeHandle.RepresentedType
                                    ),
                ...
                case IntrinsicId.MethodBase_GetMethodFromHandle:
                    {
                        ...
                        foreach (var value in argumentValues[0].AsEnumerable())
                        {
                            if (value is RuntimeMethodHandleValue methodHandle)
                                AddReturnValue(
                                    new SystemReflectionMethodBaseValue(
                ...
                case IntrinsicId.Type_GetInterface:
                    {
                        ...
                        var targetValue = _annotations.GetMethodThisParameterValue(
                            calledMethod,
                        ...
                        foreach (var value in instanceValue.AsEnumerable())
                        {
                            foreach (var interfaceName in argumentValues[0].AsEnumerable())
                            {
                                if (interfaceName == NullValue.Instance)
                                {
                                    ...
                                    interfaceName is KnownStringValue stringValue
                                    && stringValue.Contents.Length == 0
                                )
                                {
                                ...
                                else
                                {
                                    ...
                                    AddReturnValue(
                                        _annotations.GetMethodReturnValue(
                                            calledMethod,
                                            returnMemberTypes
                                        )
                                    );
                        ...
                        if (BindingFlagsAreUnsupported(bindingFlags))
                        {
                            memberTypes = intrinsicId switch
                            {
                                ...
                                _ => throw new ArgumentException(
                                    $"Reflection call '{calledMethod.GetDisplayName()}' inside '{GetContainingSymbolDisplayName()}' is of unexpected member type."
                                ),
                            };
                        }
                        else
                ...
                case IntrinsicId.Type_GetEvent:
                    {
                        ...
                        foreach (var value in instanceValue.AsEnumerable())
                        {
                            if (value is SystemTypeValue systemTypeValue)
                            {
                                ...
                                {
                                    if (
                                        stringParam is KnownStringValue stringValue
                ...
                case IntrinsicId.Type_GetMember:
                    {
                        ...
                        )
                        {
                            ...
                            throw new ArgumentException(
                                $"Reflection call '{calledMethod.GetDisplayName()}' inside '{GetContainingSymbolDisplayName()}' is an unexpected intrinsic."
                            );
                            ...
                            if (value is SystemTypeValue systemTypeValue)
                            {
                                foreach (var stringParam in argumentValues[0].AsEnumerable())
                                {
                                    ...
                                    )
                                    {
                                        ...
                                        foreach (
                                            var methodValue in ProcessGetMethodByName(
                                                systemTypeValue.RepresentedType,
                                                stringValue.Contents,
                                                bindingFlags
                                            )
                            ...
                            if (value is SystemTypeValue systemTypeValue)
                            {
                                foreach (var stringParam in argumentValues[0].AsEnumerable())
                                {
                                    ...
                                    )
                                    {
                                        AddReturnValue(MultiValueLattice.Top);
                                        foreach (
                                            var nestedTypeValue in GetNestedTypesOnType(
                                                systemTypeValue.RepresentedType,
                                                stringValue.Contents,
                                                bindingFlags
                                            )
                ...
                case IntrinsicId.RuntimeReflectionExtensions_GetRuntimeProperty:
                    {
                        ...
                        var targetValue = _annotations.GetMethodParameterValue(
                            new(calledMethod, (ParameterIndex)1),
                            requiredMemberTypes
                        );
                                ...
                                foreach (var stringParam in argumentValues[1].AsEnumerable())
                                {
                                    if (stringParam is KnownStringValue stringValue)
                                    {
                                        switch (intrinsicId)
                                        {
                                            ...
                                            default:
                                                throw new ArgumentException(
                                                    $"Error processing reflection call '{calledMethod.GetDisplayName()}' inside {GetContainingSymbolDisplayName()}. Unexpected member kind."
                                                );
                                        }
                                    }
                                    else if (stringParam is NullValue)
                ...
                case IntrinsicId.Expression_New:
                    {
                        var targetValue = _annotations.GetMethodParameterValue(
                            new(calledMethod, (ParameterIndex)0),
                ...
                case IntrinsicId.Expression_Property
                    when calledMethod.HasParameterOfType(
                        (ParameterIndex)1,
                        ...
                        foreach (var value in argumentValues[1].AsEnumerable())
                        {
                            ...
                            _diagnosticContext.AddDiagnostic(
                                ...
                                _annotations
                                    ...
                                    .GetDiagnosticArgumentsForAnnotationMismatch()
                                    .ToArray()
                            );
                        }
                    }
                ...
                case IntrinsicId.Expression_Property:
                    {
                        DynamicallyAccessedMemberTypes memberTypes =
                            intrinsicId == IntrinsicId.Expression_Property
                                ? DynamicallyAccessedMemberTypes.PublicProperties
                                    | DynamicallyAccessedMemberTypes.NonPublicProperties
                                : DynamicallyAccessedMemberTypes.PublicFields
                                    | DynamicallyAccessedMemberTypes.NonPublicFields;
                        ...
                        foreach (var value in argumentValues[1].AsEnumerable())
                        {
                            if (value is SystemTypeValue systemTypeValue)
                            {
                                foreach (var stringParam in argumentValues[2].AsEnumerable())
                                {
                                    ...
                                    {
                                        BindingFlags bindingFlags =
                                            argumentValues[0].AsSingleValue() is NullValue
                                                ? BindingFlags.Static
                ...
                case IntrinsicId.Expression_Call:
                    {
                        ...
                        bool hasTypeArguments =
                            (argumentValues[2].AsSingleValue() as ArrayValue)?.Size.AsConstInt()
                            != 0;
                        foreach (var value in argumentValues[0].AsEnumerable())
                        {
                            if (value is SystemTypeValue systemTypeValue)
                            {
                                foreach (var stringParam in argumentValues[1].AsEnumerable())
                                {
                                    ...
                                    {
                                        foreach (
                                            var method in GetMethodsOnTypeHierarchy(
                                                systemTypeValue.RepresentedType,
                                                stringValue.Contents,
                                                bindingFlags
                                            )
                    ...
                    foreach (var singlevalue in argumentValues[0].AsEnumerable())
                    {
                        AddReturnValue(
                            singlevalue switch
                            {
                                ...
                                NullableSystemTypeValue nullableSystemType =>
                                    nullableSystemType.UnderlyingTypeValue,
                                NullableValueWithDynamicallyAccessedMembers nullableDamValue =>
                                    nullableDamValue.UnderlyingTypeValue,
                ...
                case IntrinsicId.Type_GetType:
                    {
                        ...
                        if (
                            (
                                ...
                                && argumentValues[2].AsConstInt() != 0
                            )
                            || (
                                calledMethod.HasMetadataParametersCount(5)
                                && argumentValues[4].AsConstInt() != 0
                            )
                        )
                        {
                            _diagnosticContext.AddDiagnostic(
                        ...
                        foreach (var typeNameValue in argumentValues[0].AsEnumerable())
                        {
                            ...
                            {
                                if (
                                    !_requireDynamicallyAccessedMembersAction.TryResolveTypeNameAndMark(
                    ...
                    foreach (var value in instanceValue.AsEnumerable())
                    {
                        if (value is SystemTypeValue typeValue)
                        {
                            ...
                            if (typeValue.RepresentedType.IsTypeOf("System", "Nullable`1"))
                            {
                                ...
                                {
                                    if (
                                        (argumentValue as ArrayValue)?.TryGetValueByIndex(
                                            0,
                                            out var underlyingMultiValue
                                        ) == true
                                    )
                                    {
                                        foreach (
                                            var underlyingValue in underlyingMultiValue.AsEnumerable()
                                        )
                                        {
                            ...
                            else
                            {
                                ...
                                var genericParameterValues = GetGenericParameterValues(
                                    typeValue.RepresentedType.GetGenericParameters()
                                );
                                if (
                ...
                case IntrinsicId.Type_GetConstructor:
                    {
                        ...
                        {
                            1 => (argumentValues[0].AsSingleValue() as ArrayValue)
                                ?.Size
                                .AsConstInt(),
                            2 => (argumentValues[1].AsSingleValue() as ArrayValue)
                                ?.Size
                                .AsConstInt(),
                            4 => (argumentValues[2].AsSingleValue() as ArrayValue)
                                ?.Size
                                .AsConstInt(),
                            5 => (argumentValues[3].AsSingleValue() as ArrayValue)
                                ?.Size
                                .AsConstInt(),
                            _ => null,
                        };
                        ...
                        foreach (var value in instanceValue.AsEnumerable())
                        {
                            ...
                            )
                            {
                                ...
                                {
                                    MarkPublicParameterlessConstructorOnType(
                                        systemTypeValue.RepresentedType
                                    );
                                }
                                else
                ...
                case IntrinsicId.Activator_CreateInstance__Type:
                    {
                        ...
                        {
                            if (
                                calledMethod.HasParameterOfType((ParameterIndex)1, "System.Boolean")
                            )
                            {
                            ...
                            else
                            {
                                ...
                                {
                                    if (
                                        argumentValues[argsParam].AsSingleValue()
                    ...
                    if (requiresDataFlowAnalysis)
                    {
                        foreach (var parameter in calledMethod.GetParameters())
                        {
                            ...
                            if (parameter.IsImplicitThis)
                            {
                                _requireDynamicallyAccessedMembersAction.Invoke(
                                    instanceValue,
                                    _annotations.GetMethodThisParameterValue(calledMethod)
                                );
                                continue;
                            }
                            _requireDynamicallyAccessedMembersAction.Invoke(
                                argumentValues[parameter.MetadataIndex],
                                _annotations.GetMethodParameterValue(parameter)
                            );
                        }
                    }
                    break;
            ...
            returnValue ??= calledMethod.ReturnsVoid()
            ...
            void AddReturnValue(MultiValue value)
            {
                returnValue =
                    (returnValue == null)
                        ? value
                        : MultiValueLattice.Meet(returnValue.Value, value);
            }
        }
        ...
        private bool AnalyzeGenericInstantiationTypeArray(
            in MultiValue arrayParam,
            in MethodProxy calledMethod,
            ImmutableArray<GenericParameterValue> genericParameters
        )
        {
            ...
            {
                if (
                    GetGenericParameterEffectiveMemberTypes(genericParameter)
                    != DynamicallyAccessedMemberTypes.None
                )
                {
            ...
            foreach (var typesValue in arrayParam.AsEnumerable())
            {
                ...
                {
                    if (
                        !array.TryGetValueByIndex(i, out MultiValue value)
                        || value.AsSingleValue() is UnknownValue
                    )
                    {
                ...
                for (int i = 0; i < size.Value; i++)
                {
                    if (array.TryGetValueByIndex(i, out MultiValue value))
                    {
                        ...
                        var targetValue = _annotations.GetMethodThisParameterValue(
                            calledMethod,
                            GetGenericParameterEffectiveMemberTypes(genericParameters[i]),
                            overrideIsThis: true
                        );
                        _requireDynamicallyAccessedMembersAction.Invoke(value, targetValue);
                    }
            ...
            static DynamicallyAccessedMemberTypes GetGenericParameterEffectiveMemberTypes(
                GenericParameterValue genericParameter
            )
            {
        ...
        )
        {
            ...
            var genericParameterValues = GetGenericParameterValues(
                genericMethod.GetGenericParameters()
            );
            if (
                !AnalyzeGenericInstantiationTypeArray(
        ...
        private ImmutableArray<GenericParameterValue> GetGenericParameterValues(
            ImmutableArray<GenericParameterProxy> genericParameters
        )
        {
            if (genericParameters.IsEmpty)
                return ImmutableArray<GenericParameterValue>.Empty;

            var builder = ImmutableArray.CreateBuilder<GenericParameterValue>(
        ...
        )
        {
            ...
            if (
                calledMethod.HasMetadataParametersCount(8)
                && calledMethod.HasParameterOfType((ParameterIndex)2 + offset, "System.Boolean")
            )
            {
            ...
            foreach (var assemblyNameValue in argumentValues[0].AsEnumerable())
            {
                ...
                {
                    if (
                        assemblyNameStringValue.Contents is string assemblyName
                    ...
                    foreach (var typeNameValue in argumentValues[1].AsEnumerable())
                    {
                        ...
                        {
                            if (
                                !TryResolveTypeNameForCreateInstanceAndMark(
                                    calledMethod,
                            ...
                            MarkConstructorsOnType(
                                resolvedType,
                                bindingFlags,
                                parameterlessConstructor ? 0 : null
                            );
                        }
                        else
                        {
        ...
        internal static BindingFlags? GetBindingFlagsFromValue(in MultiValue parameter) =>
        ...
        internal static bool HasBindingFlag(BindingFlags? bindingFlags, BindingFlags? search) =>
            bindingFlags != null && (bindingFlags & search) == search;

        internal static DynamicallyAccessedMemberTypes GetDynamicallyAccessedMemberTypesFromBindingFlagsForNestedTypes(
            BindingFlags? bindingFlags
        ) =>
            (
                HasBindingFlag(bindingFlags, BindingFlags.Public)
        ...
        internal static DynamicallyAccessedMemberTypes GetDynamicallyAccessedMemberTypesFromBindingFlagsForMethods(
            BindingFlags? bindingFlags
        ) =>
            (
                HasBindingFlag(bindingFlags, BindingFlags.Public)
        ...
        internal static DynamicallyAccessedMemberTypes GetDynamicallyAccessedMemberTypesFromBindingFlagsForFields(
            BindingFlags? bindingFlags
        ) =>
            (
                HasBindingFlag(bindingFlags, BindingFlags.Public)
        ...
        internal static DynamicallyAccessedMemberTypes GetDynamicallyAccessedMemberTypesFromBindingFlagsForProperties(
            BindingFlags? bindingFlags
        ) =>
            (
                HasBindingFlag(bindingFlags, BindingFlags.Public)
        ...
        internal static DynamicallyAccessedMemberTypes GetDynamicallyAccessedMemberTypesFromBindingFlagsForEvents(
            BindingFlags? bindingFlags
        ) =>
            (
                HasBindingFlag(bindingFlags, BindingFlags.Public)
        ...
        internal static DynamicallyAccessedMemberTypes GetDynamicallyAccessedMemberTypesFromBindingFlagsForMembers(
            BindingFlags? bindingFlags
        ) =>
