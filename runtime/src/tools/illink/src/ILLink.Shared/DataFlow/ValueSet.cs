...
{
    public readonly struct ValueSet<TValue>
        : IEquatable<ValueSet<TValue>>,
            IDeepCopyValue<ValueSet<TValue>>
        where TValue : notnull
    {
        ...
        public static bool operator ==(ValueSet<TValue> left, ValueSet<TValue> right) =>
            left.Equals(right);
        ...
        public Enumerable GetKnownValues() =>
            new Enumerable(_values == UnknownSentinel ? null : _values);
