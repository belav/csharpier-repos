...
namespace ILLink.Shared.DataFlow
{
    ...
    public struct DefaultValueDictionary<TKey, TValue>
        ...
        where TValue : IEquatable<TValue>
    {
        ...
        public DefaultValueDictionary(TValue defaultValue) =>
            (Dictionary, DefaultValue) = (null, defaultValue);

        private DefaultValueDictionary(TValue defaultValue, Dictionary<TKey, TValue> dictionary) =>
            (Dictionary, DefaultValue) = (dictionary, defaultValue);
        ...
        public TValue Get(TKey key) =>
            Dictionary?.TryGetValue(key, out var value) == true ? value : DefaultValue;
        ...
        public override bool Equals(object? obj) =>
            obj is DefaultValueDictionary<TKey, TValue> other && Equals(other);
        ...
        {
            var defaultValue = DefaultValue is IDeepCopyValue<TValue> copyDefaultValue
                ? copyDefaultValue.DeepCopy()
                : DefaultValue;
            if (Dictionary == null)
