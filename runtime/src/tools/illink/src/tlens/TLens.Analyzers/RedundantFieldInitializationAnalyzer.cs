...
namespace TLens.Analyzers
{
    ...
    {
        readonly Dictionary<MethodDefinition, List<FieldDefinition>> ctors =
                    ...
                    case Code.Stfld:
                        ...
                        switch (field.FieldType.MetadataType)
                        {
                            ...
                            case MetadataType.Pointer:
                                if (
                                    instr.Previous.OpCode.Code != Code.Conv_U
                                    || instr.Previous.Previous.OpCode.Code != Code.Ldc_I4_0
                                )
                                    continue;
        ...
        static bool IsLoadIntPtrOrUIntPtrZero(Instruction instruction)
        {
            ...
            if (
                fr.DeclaringType.FullName != "System.IntPtr"
                && fr.DeclaringType.FullName != "System.UIntPtr"
            )
                return false;
