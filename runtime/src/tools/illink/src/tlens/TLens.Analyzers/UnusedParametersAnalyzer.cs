    ...
    sealed class UnusedParametersAnalyzer : Analyzer
    {
        ...
        protected override void ProcessMethod(MethodDefinition method)
        {
            ...
            if (
                ...
                && method.CustomAttributes.Any(l => l.AttributeType.Name == "IntrinsicAttribute")
            )
                return;
        ...
        {
            var entries = methods
                .OrderBy(l => l.Item1.Parameters[l.Item2].ParameterType.IsPrimitive)
                .ThenBy(l => l.Item1.FullName)
                .Take(maxCount);
            if (!entries.Any())
                return;
