    ...
    sealed class Driver
    {
        static int Main(string[] args)
        {
            ...
            var options = new OptionSet
            {
                {
                    "l|lens=",
                    "{NAME} of the lens to use. Default subset is used if not specified.",
                    l =>
                    {
                ...
                {
                    "d|dir=",
                    "Additional location {PATH} to look for assembly references.",
                    l =>
                    {
        ...
        static List<AssemblyDefinition> LoadFiles(
            List<string> files,
            AssemlyReferenceResolver resolver
        )
        {
