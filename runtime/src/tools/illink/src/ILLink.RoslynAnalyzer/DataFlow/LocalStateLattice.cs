...
namespace ILLink.RoslynAnalyzer.DataFlow
{
    public readonly struct LocalKey : IEquatable<LocalKey>
    {
        ...
        public override bool Equals(object obj) => obj is LocalKey inst && Equals(inst);

        public override int GetHashCode() =>
            CaptureId is null
                ? SymbolEqualityComparer.Default.GetHashCode(Local)
                : CaptureId.GetHashCode();
        ...
        where TValue : IEquatable<TValue>
    {
        ...
        public DefaultValueDictionary<
            CaptureId,
            ValueSet<CapturedReferenceValue>
        > CapturedReferences;

        public LocalState(TValue defaultValue)
            : this(
                new DefaultValueDictionary<LocalKey, TValue>(defaultValue),
                new DefaultValueDictionary<CaptureId, ValueSet<CapturedReferenceValue>>(
                    default(ValueSet<CapturedReferenceValue>)
                )
            ) { }
        ...
        public override bool Equals(object obj) => obj is LocalState<TValue> inst && Equals(inst);
        ...
        where TValueLattice : ILattice<TValue>
    {
        ...
        public readonly DictionaryLattice<
            CaptureId,
            ValueSet<CapturedReferenceValue>,
            ValueSetLattice<CapturedReferenceValue>
        ...
        public LocalStateLattice(TValueLattice valueLattice)
        {
            ...
            CapturedReferenceLattice = new DictionaryLattice<
                ...
                ValueSet<CapturedReferenceValue>,
                ValueSetLattice<CapturedReferenceValue>
            >(default(ValueSetLattice<CapturedReferenceValue>));
            Top = new(Lattice.Top);
        }
