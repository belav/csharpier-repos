...
namespace ILLink.RoslynAnalyzer.DataFlow
{
    internal static class DynamicallyAccessedMembersBinder
    {
        ...
        public static IEnumerable<ISymbol> GetDynamicallyAccessedMembers(
            this ITypeSymbol typeDefinition,
        ...
        public static IEnumerable<IMethodSymbol> GetConstructorsOnType(
            this ITypeSymbol type,
            Func<IMethodSymbol, bool>? filter,
        ...
        public static IEnumerable<IMethodSymbol> GetMethodsOnTypeHierarchy(
            this ITypeSymbol thisType,
            Func<IMethodSymbol, bool>? filter,
            BindingFlags? bindingFlags = null
        )
        {
        ...
        public static IEnumerable<IFieldSymbol> GetFieldsOnTypeHierarchy(
            this ITypeSymbol thisType,
            Func<IFieldSymbol, bool>? filter,
        ...
        public static IEnumerable<ITypeSymbol> GetNestedTypesOnType(
            this ITypeSymbol type,
        ...
        public static IEnumerable<IPropertySymbol> GetPropertiesOnTypeHierarchy(
            this ITypeSymbol thisType,
            Func<IPropertySymbol, bool>? filter,
            BindingFlags? bindingFlags = BindingFlags.Default
        )
        {
            ITypeSymbol? type = thisType;
        ...
        public static IEnumerable<IEventSymbol> GetEventsOnTypeHierarchy(
            this ITypeSymbol thisType,
            Func<IEventSymbol, bool>? filter,
            BindingFlags? bindingFlags = BindingFlags.Default
        )
        {
            ITypeSymbol? type = thisType;
                ...
                foreach (var @event in type.GetMembers().OfType<IEventSymbol>())
                {
                    ...
                    if (
                        ...
                        && (
                            ...
                            || @event.RemoveMethod.DeclaredAccessibility == Accessibility.Private
                        )
                    )
                        continue;
                    ...
                    )
                    {
                        if (
                            (
                                @event.AddMethod == null
                                || (@event.AddMethod.DeclaredAccessibility != Accessibility.Public)
                            )
                            && (
                                @event.RemoveMethod == null
                                || (
                                    @event.RemoveMethod.DeclaredAccessibility
                    ...
                    )
                    {
                        ...
                        if (
                            (@event.RemoveMethod != null)
                            && @event.RemoveMethod.DeclaredAccessibility == Accessibility.Public
                        )
                            continue;
                    }
        ...
        public static IEnumerable<ITypeSymbol> GetAllInterfaceImplementations(
            this ITypeSymbol thisType,
            bool declaredOnly
        )
        {
