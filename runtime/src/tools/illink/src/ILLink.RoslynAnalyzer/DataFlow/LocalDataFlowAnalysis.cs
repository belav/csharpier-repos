...
namespace ILLink.RoslynAnalyzer.DataFlow
{
    ...
    >
        ...
        where TTransfer : LocalDataFlowVisitor<
                TValue,
                TContext,
                TLattice,
                TContextLattice,
        ...
        where TConditionValue : struct, INegate<TConditionValue>
    {
        ...
        static LocalStateAndContextLattice<
            TValue,
            TContext,
            TLattice,
            TContextLattice
        > GetLatticeAndEntryValue(
        ...
        public void InterproceduralAnalyze()
        {
            ...
            DictionaryLattice<
                LocalKey,
                Maybe<TValue>,
                MaybeLattice<TValue, TLattice>
            > hoistedLocalLattice = default;
            ...
            Debug.Assert(
                Context.OwningSymbol is not IMethodSymbol methodSymbol
                    || methodSymbol.MethodKind
                        is not (MethodKind.LambdaMethod or MethodKind.LocalFunction)
            );
