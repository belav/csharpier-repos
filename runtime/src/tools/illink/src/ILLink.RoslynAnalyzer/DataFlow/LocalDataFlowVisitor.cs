...
namespace ILLink.RoslynAnalyzer.DataFlow
{
    ...
    // - parameter
    // - method return
    public abstract class LocalDataFlowVisitor<TValue, TValueLattice>
        : OperationWalker<LocalDataFlowState<TValue, TValueLattice>, TValue>,
            ITransfer<
                BlockProxy,
                LocalState<TValue>,
                LocalDataFlowState<TValue, TValueLattice>,
                LocalStateLattice<TValue, TValueLattice>
            >
            ...
            switch (targetOperation)
            {
                ...
                case IParameterReferenceOperation:
                {
                    TValue targetValue = targetOperation switch
                    {
                        ...
                        IParameterReferenceOperation parameterRef
                            => GetParameterTargetValue(parameterRef.Parameter),
                ...
                default:
                    ...
                    throw new NotImplementedException(
                        $"{targetOperation.GetType().ToString()}: {targetOperation.Syntax.GetLocation().GetLineSpan()}"
                    );
            }
