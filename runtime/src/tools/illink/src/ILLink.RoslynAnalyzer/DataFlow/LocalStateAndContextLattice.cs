...
namespace ILLink.RoslynAnalyzer.DataFlow
{
    ...
    public struct LocalStateAndContext<TValue, TContext>
        : IEquatable<LocalStateAndContext<TValue, TContext>>
        ...
        where TContext : IEquatable<TContext>
    {
        ...
        public override bool Equals(object? obj) =>
            obj is LocalStateAndContext<TValue, TContext> other && Equals(other);

        public override int GetHashCode() => HashUtils.Combine(LocalState, Context);
    }

    public readonly struct LocalStateAndContextLattice<
        TValue,
        TContext,
        TValueLattice,
        TContextLattice
    > : ILattice<LocalStateAndContext<TValue, TContext>>
        ...
        where TContextLattice : ILattice<TContext>
    {
        ...
        public LocalStateAndContextLattice(
            LocalStateLattice<TValue, TValueLattice> localStateLattice,
        ...
        public LocalStateAndContext<TValue, TContext> Meet(
            LocalStateAndContext<TValue, TContext> left,
            LocalStateAndContext<TValue, TContext> right
        )
        {
