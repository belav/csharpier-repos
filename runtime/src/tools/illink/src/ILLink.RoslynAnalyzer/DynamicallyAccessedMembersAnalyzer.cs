...
namespace ILLink.RoslynAnalyzer
{
    ...
    public class DynamicallyAccessedMembersAnalyzer : DiagnosticAnalyzer
    {
        ...
        static void ProcessGenericParameters(SyntaxNodeAnalysisContext context)
        {
            ...
            {
                if (
                    parentNode is InvocationExpressionSyntax invocationExpression
        ...
        static IEnumerable<Diagnostic> GetDynamicallyAccessedMembersDiagnostics(
                ...
                if (methodTypeParameterAnnotation != overriddenMethodTypeParameterAnnotation)
                {
                    ...
                    context.ReportDiagnostic(
                        Diagnostic.Create(
                            ...
                            overrideMethod.TypeParameters[i].Locations[0],
                            sourceLocation,
                            DAMArgs?.ToImmutableDictionary(),
