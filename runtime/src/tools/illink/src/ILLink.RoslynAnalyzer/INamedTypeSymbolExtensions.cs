    ...
    static class INamedTypeSymbolExtensions
    {
        ...
        internal static bool HasName(this INamedTypeSymbol type, string typeName)
        {
            ...
            while (roSpan.Length > 0)
            {
                ...
                currentType =
                    (INamespaceOrTypeSymbol?)currentType.ContainingType
        ...
        internal static IEnumerable<(
            ...
            ISymbol ImplementationMember
        )> GetMemberInterfaceImplementationPairs(this INamedTypeSymbol namedType)
        {
        ...
        )
        {
            ...
            {
                if (
                    implementationSymbol.FindImplementationForInterfaceMember(interfaceMember)
                    is ISymbol implementationMember
                )
                {
                    yield return (
