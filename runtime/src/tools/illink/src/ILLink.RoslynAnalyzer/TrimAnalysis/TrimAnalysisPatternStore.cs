...
namespace ILLink.RoslynAnalyzer.TrimAnalysis
{
    public readonly struct TrimAnalysisPatternStore
    {
        ...
        readonly Dictionary<
            IOperation,
            TrimAnalysisReflectionAccessPattern
        ...
        {
            AssignmentPatterns =
                new Dictionary<(IOperation, bool), TrimAnalysisAssignmentPattern>();
            ...
            ReflectionAccessPatterns =
                new Dictionary<IOperation, TrimAnalysisReflectionAccessPattern>();
            Lattice = lattice;
            FeatureContextLattice = featureContextLattice;
        }
        ...
        public void Add(TrimAnalysisAssignmentPattern trimAnalysisPattern, bool isReturnValue)
        {
            ...
            if (
                !AssignmentPatterns.TryGetValue(
                    (trimAnalysisPattern.Operation, isReturnValue),
                    out var existingPattern
                )
            )
            {
                AssignmentPatterns.Add(
                    (trimAnalysisPattern.Operation, isReturnValue),
                    trimAnalysisPattern
                );
                return;
            ...
            AssignmentPatterns[(trimAnalysisPattern.Operation, isReturnValue)] =
                trimAnalysisPattern.Merge(Lattice, FeatureContextLattice, existingPattern);
        }
        ...
        public void Add(TrimAnalysisMethodCallPattern pattern)
        {
            ...
            MethodCallPatterns[pattern.Operation] = pattern.Merge(
                Lattice,
                FeatureContextLattice,
                existingPattern
            );
        ...
        public void Add(TrimAnalysisReflectionAccessPattern pattern)
        {
            ...
            ReflectionAccessPatterns[pattern.Operation] = pattern.Merge(
                Lattice,
                FeatureContextLattice,
                existingPattern
            );
