...
namespace ILLink.RoslynAnalyzer.TrimAnalysis
{
    public class TrimAnalysisVisitor
        : LocalDataFlowVisitor<MultiValue, ValueSetLattice<SingleValue>>
    {
        ...
        {
            return parameter.Type.IsTypeInterestingForDataflow()
                ...
                else
                {
                    switch (operation.Type?.SpecialType)
                    {
                        ...
                        case SpecialType.System_Int16
                            when constantValue is Int16 int16ConstantValue:
                            constValue = new ConstIntValue(int16ConstantValue);
                            return true;
                        case SpecialType.System_UInt16
                            when constantValue is UInt16 uint16ConstantValue:
                            constValue = new ConstIntValue(uint16ConstantValue);
                            return true;
                        case SpecialType.System_Int32
                            when constantValue is Int32 int32ConstantValue:
                            constValue = new ConstIntValue(int32ConstantValue);
                            return true;
                        case SpecialType.System_UInt32
                            when constantValue is UInt32 uint32ConstantValue:
