...
namespace ILLink.RoslynAnalyzer
{
    ...
    public sealed class RequiresDynamicCodeAnalyzer : RequiresAnalyzerBase
    {
        ...
        public const string FullyQualifiedRequiresDynamicCodeAttribute =
        ...
        public override ImmutableArray<DiagnosticDescriptor> SupportedDiagnostics =>
            ImmutableArray.Create(
                s_requiresDynamicCodeRule,
                s_requiresDynamicCodeAttributeMismatch,
                s_requiresDynamicCodeOnStaticCtor
            );
        ...
        private protected override string RequiresAttributeFullyQualifiedName =>
            FullyQualifiedRequiresDynamicCodeAttribute;
        ...
        )
        {
            ...
            var isDynamicCodeSupportedProperty = runtimeFeaturesType
                .GetMembers("IsDynamicCodeSupported")
