...
namespace ILLink.RoslynAnalyzer
{
    ...
    public sealed class RequiresUnreferencedCodeAnalyzer : RequiresAnalyzerBase
    {
        ...
        internal override bool IsRequiresCheck(
        ...
        )
        {
            ...
            var runtimeFeaturesType = compilation.GetTypeByMetadataName(
                "ILLink.RoslynAnalyzer.TestFeatures"
            );
            if (runtimeFeaturesType == null)
                return false;

            var isDynamicCodeSupportedProperty = runtimeFeaturesType
                .GetMembers("IsUnreferencedCodeSupported")
