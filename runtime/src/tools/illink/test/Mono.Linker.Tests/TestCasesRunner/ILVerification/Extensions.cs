...
public static class Extensions
{
    public static string GetMethodSignature(
        this MethodDefinitionHandle handler,
    ...
    public static string GetMethodDeclaringTypeFullName(
    ...
    )
    {
        ...
        {
            builder
                .Append(GetTypeFullName(declaringType, metadataReader))
                .Append("+")
        ...
        {
            builder
                .Append(metadataReader.GetString(typeDefinition.Namespace))
                .Append(".")
                .Append(metadataReader.GetString(typeDefinition.Name));
        }
    ...
    )
    {
        ...
        var builder = new StringBuilder();
        builder
            .Append(metadataReader.GetString(typeReference.Namespace))
            .Append(".")
