...
namespace Mono.Linker.Tests.TestCasesRunner
{
    public class ILCompiler
    {
...
#endif
            args.Append(
                $" {options.SourceFiles.Aggregate(string.Empty, (buff, file) => $"{buff} {file.InQuotes()}")}"
            );
        ...
        public static NPath LocateIlasmOnWindows()
        {
            ...
            var possiblePath = RuntimeEnvironment
                .GetRuntimeDirectory()
                .ToNPath()
                .Combine("ilasm.exe");
