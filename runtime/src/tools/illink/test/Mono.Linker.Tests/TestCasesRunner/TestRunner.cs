    ...
    public class TestRunner
    {
        ...
        )
        {
            ...
            try
            {
                ...
                expectationsAssemblyPath = GetResultOfTaskThatMakesNUnitAssertions(
                    expectationsTask
                );
            }
            catch (Exception)
        ...
        private LinkedTestCaseResult Link(
            TestCase testCase,
            TestCaseSandbox sandbox,
            ManagedCompilationResult compilationResult,
        ...
        protected virtual LinkerCustomizations CustomizeLinker(
            LinkerDriver linker,
            TestCaseMetadataProvider metadataProvider
        )
        {
        ...
        private static T GetResultOfTaskThatMakesNUnitAssertions<T>(Task<T> task)
        {
            ...
            catch (AggregateException e)
            {
                ...
                {
                    if (
                        e.InnerException is AssertionException
