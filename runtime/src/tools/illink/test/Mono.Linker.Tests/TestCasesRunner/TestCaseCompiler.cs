    ...
    public class TestCaseCompiler
    {
        ...
        )
        {
            ...
            string[] additionalArguments = string.IsNullOrEmpty(
                setupCompileInfo.AdditionalArguments
            )
                ? null
                : new[] { setupCompileInfo.AdditionalArguments };
            return new CompilerOptions
            {
        ...
        protected static NPath CompileCSharpAssemblyWithExternalCompiler(
            string executable,
        ...
        protected static string OptionsToCompilerCommandLineArguments(
            CompilerOptions options,
            string compilerSpecificArguments
        )
        {
