...
namespace Mono.Linker.Tests.TestCasesRunner
{
    public class TestCaseCollector
    {
        ...
        public IEnumerable<TestCase> Collect(IEnumerable<NPath> sourceFiles)
        {
            ...
            using (
                var caseAssemblyDefinition = AssemblyDefinition.ReadAssembly(
                    _testCaseAssemblyPath.ToString()
                )
            )
            {
        ...
        private bool CreateCase(
            AssemblyDefinition caseAssemblyDefinition,
            NPath sourceFile,
