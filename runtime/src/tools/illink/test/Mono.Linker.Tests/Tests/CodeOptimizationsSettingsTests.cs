...
namespace Mono.Linker.Tests
{
    ...
    public class CodeOptimizationsSettingsTests
    {
        ...
        {
            CodeOptimizationsSettings cos = new CodeOptimizationsSettings(
        ...
        public void ExcludedThenIncluded()
        {
            ...
            cos.Disable(CodeOptimizations.BeforeFieldInit, "testasm.dll");
            cos.Enable(
                CodeOptimizations.OverrideRemoval | CodeOptimizations.BeforeFieldInit,
                "testasm.dll"
            );
        ...
        public void PropagateFromGlobal()
        {
            ...
            cos.Disable(
                CodeOptimizations.IPConstantPropagation | CodeOptimizations.OverrideRemoval,
                "testasm.dll"
            );
