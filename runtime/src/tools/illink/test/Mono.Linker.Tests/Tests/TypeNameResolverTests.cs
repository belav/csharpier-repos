...
namespace Mono.Linker.Tests
{
    ...
    public class TypeNameResolverTests
    {
        ...
        public void TryParseAssemblyQualifiedTypeName_FullyQualified()
        {
            ...
            Assert.AreEqual(
                assemblyQualifiedTypeName.AssemblyName.FullName,
                typeof(TypeNameResolverTests).Assembly.FullName
            );
            Assert.AreEqual(
                assemblyQualifiedTypeName.TypeName.ToString(),
                typeof(TypeNameResolverTests).FullName
            );
        }
        ...
        {
            var value =
                $"{typeof(TypeNameResolverTests).FullName}, {typeof(TypeNameResolverTests).Assembly.GetName().Name}";
            var typeName = TypeParser.ParseTypeName(value);
            Assert.IsTrue(typeName is AssemblyQualifiedTypeName);
            AssemblyQualifiedTypeName assemblyQualifiedTypeName =
                (AssemblyQualifiedTypeName)typeName;
            Assert.AreEqual(
                ...
                typeof(TypeNameResolverTests).Assembly.GetName().Name
            );
            Assert.AreEqual(
                assemblyQualifiedTypeName.TypeName.ToString(),
                typeof(TypeNameResolverTests).FullName
        ...
        public void TryParseAssemblyQualifiedTypeName_GenericType_FullyQualified()
        {
            ...
            Assert.AreEqual(
                assemblyQualifiedTypeName.TypeName.ToString(),
                $"{typeof(TypeNameResolverTests).FullName}/GenericType`2"
            );
        }
        ...
        {
            var value =
                $"{typeof(GenericType<,>).FullName}, {typeof(TypeNameResolverTests).Assembly.GetName().Name}";
            var typeName = TypeParser.ParseTypeName(value);
            Assert.IsTrue(typeName is AssemblyQualifiedTypeName);
            AssemblyQualifiedTypeName assemblyQualifiedTypeName =
                (AssemblyQualifiedTypeName)typeName;
