...
namespace Mono.Linker.Tests.Cases.BCLFeatures.ETW
{
    ...
    class CustomCtorEventSourceNonVoidReturn : EventSource
    {
        ...
        [Kept]
        public static CustomCtorEventSourceNonVoidReturn Log =
            new MyEventSourceBasedOnCustomCtorEventSourceNonVoidReturn(1);
    ...
    class MyEventSourceBasedOnCustomCtorEventSourceNonVoidReturn
