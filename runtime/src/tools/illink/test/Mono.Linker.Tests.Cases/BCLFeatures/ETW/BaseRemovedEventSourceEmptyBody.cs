...
namespace Mono.Linker.Tests.Cases.BCLFeatures.ETW
{
    ...
    class CustomCtorEventSourceEmptyBody : EventSource
    {
        ...
        [Kept]
        public static CustomCtorEventSourceEmptyBody Log =
            new MyEventSourceBasedOnCustomCtorEventSourceEmptyBody(1);
    ...
    {
        [Kept]
        public MyEventSourceBasedOnCustomCtorEventSourceEmptyBody(int value)
            : base(value) { }
    }
}
