    ...
    class RequiresAccessedThrough
    {
        ...
        static void TestRequiresOnlyThroughReflection()
        {
            typeof(RequiresAccessedThrough)
                .GetMethod(
                    nameof(RequiresOnlyThroughReflection),
        ...
        class AccessedThroughReflectionOnGenericType<T>
        {
            ...
            [ExpectedWarning(
                "IL3002",
                "--GenericType.RequiresOnlyThroughReflection--",
                ProducedBy = Tool.NativeAot
            )]
            [ExpectedWarning(
                "IL3050",
        ...
        class AccessThroughDelegate
        {
            ...
            {
                Action a = [RequiresUnreferencedCode("--LambdaThroughDelegate--")]
        ...
        class AccessThroughUnsafeAccessor
        {
            ...
            static extern void MethodRequires(Target target);
            ...
            static extern Target Constructor(int i);
            ...
            [UnsafeAccessor(UnsafeAccessorKind.Constructor)]
            static extern TargetWithRequires TargetRequiresConstructor();
            ...
            static extern void TargetRequiresStaticMethod(TargetWithRequires target);
            ...
            static extern void TargetRequiresInstanceMethod(TargetWithRequires target);
            ...
            static extern ref int TargetRequiresStaticField(TargetWithRequires target);
            ...
            static extern ref int TargetRequiresInstanceField(TargetWithRequires target);
