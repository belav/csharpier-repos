...
namespace Mono.Linker.Tests.Cases.RequiresCapability
{
    ...
    class RequiresViaDataflow
    {
        ...
        class AnnotatedParameter
        {
            ...
            [ExpectedWarning(
                "IL2026",
                "--DynamicallyAccessedTypeWithRequires.MethodWithRequires--"
            )]
        ...
        class AnnotatedGenericParameter
        {
            ...
            {
                [RequiresUnreferencedCode(
                    "--AccessedThroughGenericParameterAnnotation.TypeWithRequiresMethod.MethodWhichRequires--"
                )]
                [RequiresDynamicCode(
                    "--AccessedThroughGenericParameterAnnotation.TypeWithRequiresMethod.MethodWhichRequires--"
                )]
            ...
            static void MethodWithPublicMethodsInference<
                [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicMethods)] T
            >(T instance) { }
