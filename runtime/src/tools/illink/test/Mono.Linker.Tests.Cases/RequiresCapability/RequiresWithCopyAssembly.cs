...
namespace Mono.Linker.Tests.Cases.RequiresCapability
{
    ...
    class RequiresWithCopyAssembly
    {
        ...
        [ExpectedWarning(
            "IL3002",
            "--IDerivedInterface.MethodInDerivedInterface--",
        ...
        [ExpectedWarning(
            "IL3002",
            "--IBaseInterface.MethodInBaseInterface--",
            ProducedBy = Tool.NativeAot
        )]
        [ExpectedWarning(
            "IL3050",
        ...
        public static void Main()
        {
            ...
            TestRequiresInDynamicallyAccessedMethodFromCopiedAssembly(
                typeof(RequiresInCopyAssembly.IDerivedInterface)
            );
        }
