...
namespace Mono.Linker.Tests.Cases.RequiresCapability
{
    ...
    class RequiresOnVirtualsAndInterfaces
    {
        ...
        class VirtualMethod
        {
            ...
            [ExpectedWarning(
                "IL3002",
                "--TypeWhichOverridesMethod.VirtualMethodRequires--",
                ProducedBy = Tool.NativeAot
            )]
            [ExpectedWarning(
                "IL3050",
            ...
            {
                BaseType tmp = new TypeWhichOverridesMethod();
                typeof(TypeWhichOverridesMethod)
                    .GetMethod("VirtualMethodRequires")
                    .Invoke(tmp, Array.Empty<object>());
            }

            static void CallMethodWithRequiresOnInstance<
            ...
            {
                CallMethodWithRequiresOnInstance<TypeWhichOverridesMethod>(
                    new TypeWhichOverridesMethod()
                );
            }
        ...
        class InterfaceMethod
        {
            ...
            [ExpectedWarning(
                "IL3002",
                "--ImplementationClass.RequiresMethod--",
                ProducedBy = Tool.Analyzer | Tool.NativeAot
            )]
            [ExpectedWarning(
                "IL3050",
            ...
            static void TestDirectReflectionAccess()
            {
                typeof(ImplementationClass)
                    .GetMethod("MethodWithRequires")
                    .Invoke(new ImplementationClass(), Array.Empty<object>());
            }
        ...
        class NewSlotVirtual
        {
            ...
            [ExpectedWarning(
                "IL3002",
                "Message for --NewSlotVirtual.Base.RUCMethod--",
                ProducedBy = Tool.NativeAot
            )]
            [ExpectedWarning(
                "IL3050",
