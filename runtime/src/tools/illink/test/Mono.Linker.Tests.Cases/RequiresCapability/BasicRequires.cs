...
namespace Mono.Linker.Tests.Cases.RequiresCapability
{
    ...
    public class BasicRequires
    {
        ...
        [ExpectedWarning(
            "IL3002",
            "Adds a trailing period to this message.",
            ProducedBy = Tool.Analyzer | Tool.NativeAot
        )]
        [ExpectedWarning(
            "IL3050",
        ...
        [ExpectedWarning(
            "IL3002",
            "Does not add a period to this message.",
            ProducedBy = Tool.Analyzer | Tool.NativeAot
        )]
        [ExpectedWarning(
            "IL3050",
        ...
        class RequiresOnGenerics
        {
            ...
            {
                [RequiresUnreferencedCode(
                    "Message for --GenericTypeWithStaticMethodWhichRequires--"
                )]
            ...
            [ExpectedWarning(
                "IL3002",
                "--GenericTypeWithStaticMethodWhichRequires--",
                ProducedBy = Tool.Analyzer | Tool.NativeAot
            )]
            [ExpectedWarning(
                "IL3050",
            ...
            {
                var _ = new Action(
                    GenericWithStaticMethod<TestType>.GenericTypeWithStaticMethodWhichRequires
                );
            }
