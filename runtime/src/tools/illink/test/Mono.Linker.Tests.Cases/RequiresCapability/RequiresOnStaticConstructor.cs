...
namespace Mono.Linker.Tests.Cases.RequiresCapability
{
    ...
    class RequiresOnStaticConstructor
    {
        ...
        {
            var cctor = typeof(StaticCtorOnTypeWithRequires).GetConstructor(
        ...
        static void TestRunClassConstructorOnConstructorWithRequires()
        {
            ...
            RuntimeHelpers.RunClassConstructor(
                typeof(StaticCtorForRunClassConstructorWithRequires).TypeHandle
            );
        }
        ...
        class StaticCtorTriggeredByMethodCall
        {
            ...
            [ExpectedWarning(
                "IL3004",
                "StaticCtorTriggeredByMethodCall..cctor()",
                ProducedBy = Tool.Analyzer | Tool.NativeAot
            )]
            [ExpectedWarning(
                "IL3056",
            ...
            [RequiresUnreferencedCode(
                "Message for --StaticCtorTriggeredByMethodCall.TriggerStaticCtorMarking--"
            )]
        ...
        [ExpectedWarning(
            "IL3002",
            "--StaticCtorTriggeredByMethodCall.TriggerStaticCtorMarking--",
            ProducedBy = Tool.Analyzer | Tool.NativeAot
        )]
        [ExpectedWarning(
            "IL3050",
        ...
        [LogContains(
            "IL2026: Mono.Linker.Tests.Cases.RequiresCapability.RequiresOnStaticConstructor.TypeIsBeforeFieldInit..cctor():"
        ...
        [LogContains(
            "IL3002: Mono.Linker.Tests.Cases.RequiresCapability.RequiresOnStaticConstructor.TypeIsBeforeFieldInit..cctor():",
            ProducedBy = Tool.NativeAot
        )]
        [LogContains(
            "IL3050: Mono.Linker.Tests.Cases.RequiresCapability.RequiresOnStaticConstructor.TypeIsBeforeFieldInit..cctor():",
            ProducedBy = Tool.NativeAot
        )]
