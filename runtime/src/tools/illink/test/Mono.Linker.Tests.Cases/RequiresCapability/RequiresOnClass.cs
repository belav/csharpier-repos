...
namespace Mono.Linker.Tests.Cases.RequiresCapability
{
    ...
    class RequiresOnClass
    {
        ...
        [ExpectedWarning(
            "IL2109",
            "RequiresOnClass.DerivedWithoutRequires",
            "RequiresOnClass.ClassWithRequires",
            "--ClassWithRequires--"
        )]
        ...
        [ExpectedWarning(
            "IL2026",
            "RequiresOnClass.StaticCtor.StaticCtor()",
            "Message for --StaticCtor--"
        )]
        [ExpectedWarning(
            "IL3050",
            "RequiresOnClass.StaticCtor.StaticCtor()",
        ...
        [ExpectedWarning(
            "IL2026",
            "StaticCtorTriggeredByFieldAccess.field",
        ...
        [ExpectedWarning(
            "IL2026",
            "StaticCCtorTriggeredByFieldAccessRead.field",
            "Message for --StaticCCtorTriggeredByFieldAccessRead--"
        )]
        [ExpectedWarning(
            "IL3050",
            "StaticCCtorTriggeredByFieldAccessRead.field",
        ...
        [ExpectedWarning(
            "IL2026",
            "StaticCtorTriggeredByCtorCalls.StaticCtorTriggeredByCtorCalls()"
        )]
        [ExpectedWarning(
            "IL3050",
            "StaticCtorTriggeredByCtorCalls.StaticCtorTriggeredByCtorCalls()",
        ...
        [ExpectedWarning(
            "IL3050",
            "ClassWithInstanceField.ClassWithInstanceField()",
            ProducedBy = Tool.Analyzer | Tool.NativeAot
        )]
        ...
        [ExpectedWarning(
            "IL3050",
            "Calling the constructor is dangerous",
            ProducedBy = Tool.Analyzer | Tool.NativeAot
        )]
        ...
        private class DerivedWithRequires2 : ClassWithRequires
        {
            ...
            [ExpectedWarning(
                "IL2109",
                "RequiresOnClass.DerivedWithRequires2.DerivedNestedClass",
                "--ClassWithRequires--"
            )]
        ...
        [ExpectedWarning(
            "IL2026",
            "RequiresOnClass.ClassWithRequires.StaticMethod()",
            "--ClassWithRequires--"
        )]
        [ExpectedWarning(
            "IL3050",
        ...
        [ExpectedWarning(
            "IL2026",
            "RequiresOnClass.DerivedWithRequires.StaticMethodInInheritedClass()",
            "--DerivedWithRequires--"
        )]
        [ExpectedWarning(
            "IL3050",
        ...
        [ExpectedWarning(
            "IL2026",
            "RequiresOnClass.DerivedWithRequires2.StaticMethodInInheritedClass()",
            "--DerivedWithRequires2--"
        )]
        [ExpectedWarning(
            "IL3050",
            "RequiresOnClass.DerivedWithRequires2.StaticMethodInInheritedClass()",
        ...
        [ExpectedWarning(
            "IL2026",
            "RequiresOnClass.ClassWithRequires.TestSuppressions(",
            "Type[])"
        )]
        [ExpectedWarning(
            "IL3050",
        ...
        class MemberTypesWithRequires
        {
            ...
            [ExpectedWarning(
                "IL2026",
                "MemberTypesWithRequires.Event.add",
                ProducedBy = Tool.Trimmer
            )]
            [ExpectedWarning(
                "IL2026",
                "MemberTypesWithRequires.Event.remove",
                ProducedBy = Tool.Trimmer
            )]
        ...
        [ExpectedWarning(
            "IL3050",
            "MemberTypesWithRequires.field",
            ProducedBy = Tool.Analyzer | Tool.NativeAot
        )]
        [ExpectedWarning("IL2026", "MemberTypesWithRequires.Property.set")]
        [ExpectedWarning(
            "IL3050",
            "MemberTypesWithRequires.Property.set",
            ProducedBy = Tool.Analyzer | Tool.NativeAot
        )]
        ...
        class ReflectionAccessOnMethod
        {
            ...
            [ExpectedWarning(
                "IL3050",
                "BaseWithoutRequiresOnType.Method()",
                ProducedBy = Tool.NativeAot
            )]
            [ExpectedWarning("IL2026", "BaseWithoutRequiresOnType.Method()")]
            [ExpectedWarning(
            ...
            static void TestDirectReflectionAccess()
            {
                ...
                typeof(BaseWithoutRequiresOnType).GetMethod(
                    nameof(BaseWithoutRequiresOnType.Method)
                );
                ...
                typeof(ImplementationWithRequiresOnType).GetMethod(
                    nameof(ImplementationWithRequiresOnType.Method)
                );
        ...
        class ReflectionAccessOnCtor
        {
            ...
            [ExpectedWarning(
                "IL2109",
                "ReflectionAccessOnCtor.DerivedWithoutRequires",
                "ReflectionAccessOnCtor.BaseWithRequires"
            )]
            class DerivedWithoutRequires : BaseWithRequires
            {
                ...
                )] // The body has direct call to the base.ctor()
            ...
            [ExpectedWarning(
                "IL3050",
                "BaseWithRequires.BaseWithRequires()",
                ProducedBy = Tool.NativeAot
            )]
            [ExpectedWarning("IL2026", "BaseWithRequires.BaseWithRequires()")]
            [ExpectedWarning(
            ...
            [ExpectedWarning(
                "IL2026",
                "DerivedWithRequiresOnBaseWithRequires.DerivedWithRequiresOnBaseWithRequires()"
            )]
            [ExpectedWarning(
                "IL3050",
                "DerivedWithRequiresOnBaseWithRequires.DerivedWithRequiresOnBaseWithRequires()",
            ...
            [ExpectedWarning(
                "IL2026",
                "DerivedWithRequiresOnBaseWithoutRequires.DerivedWithRequiresOnBaseWithoutRequires()"
            )]
            [ExpectedWarning(
                "IL3050",
                "DerivedWithRequiresOnBaseWithoutRequires.DerivedWithRequiresOnBaseWithoutRequires()",
            ...
            static void TestDirectReflectionAccess()
            {
                ...
                typeof(DerivedWithRequiresOnBaseWithRequires).GetConstructor(
        ...
        class ReflectionAccessOnField
        {
            ...
            [ExpectedWarning(
                "IL2109",
                "ReflectionAccessOnField.DerivedWithoutRequires",
                "ReflectionAccessOnField.WithRequires"
            )]
            ...
            [ExpectedWarning(
                "IL3050",
                "WithRequires.PrivateStaticField",
                ProducedBy = Tool.NativeAot
            )]
            [ExpectedWarning("IL2026", "DerivedWithRequires.DerivedStaticField")]
            [ExpectedWarning(
                "IL3050",
                "DerivedWithRequires.DerivedStaticField",
                ProducedBy = Tool.NativeAot
            )]
            static void TestDAMAccess()
            {
            ...
            static void TestDirectReflectionAccess()
            {
                ...
                typeof(WithRequiresOnlyInstanceFields).GetField(
                    nameof(WithRequiresOnlyInstanceFields.InstanceField)
                ); // Doesn't warn
                typeof(DerivedWithoutRequires).GetField(
                    nameof(DerivedWithoutRequires.DerivedStaticField)
                ); // Doesn't warn
                typeof(DerivedWithRequires).GetField(
                    nameof(DerivedWithRequires.DerivedStaticField)
                );
            }

            [ExpectedWarning(
                "IL2026",
                "WithRequires.StaticField",
                ProducedBy = Tool.Trimmer | Tool.NativeAot
            )]
            [ExpectedWarning("IL3050", "WithRequires.StaticField", ProducedBy = Tool.NativeAot)]
            [ExpectedWarning(
            ...
            [ExpectedWarning(
                "IL2113",
                "BaseForDAMAnnotatedClass.baseField",
                ProducedBy = Tool.Trimmer | Tool.NativeAot
            )]
            class DAMAnnotatedClass : BaseForDAMAnnotatedClass
            {
                ...
                [ExpectedWarning(
                    "IL2112",
                    "DAMAnnotatedClass.privatefield",
                    ProducedBy = Tool.Trimmer | Tool.NativeAot
                )]
            ...
            class DAMAnnotatedClassAccessedFromRUCScope
            {
                [ExpectedWarning(
                    "IL2112",
                    "DAMAnnotatedClassAccessedFromRUCScope.RUCMethod",
                    ProducedBy = Tool.Trimmer | Tool.NativeAot
                )]
            ...
            static void TestDAMOnTypeAccessInRUCScope(
                DAMAnnotatedClassAccessedFromRUCScope instance = null
            )
            {
        ...
        class ReflectionAccessOnProperties
        {
            ...
            [ExpectedWarning(
                "IL2109",
                "ReflectionAccessOnProperties.DerivedWithoutRequires",
                "ReflectionAccessOnProperties.WithRequires"
            )]
            class DerivedWithoutRequires : WithRequires
            {
            ...
            [ExpectedWarning(
                "IL3050",
                "WithRequires.InstanceProperty.get",
                ProducedBy = Tool.NativeAot
            )]
            [ExpectedWarning("IL2026", "WithRequires.InstanceProperty.get")]
            [ExpectedWarning(
            ...
            [ExpectedWarning(
                "IL3050",
                "WithRequires.InstanceProperty.set",
                ProducedBy = Tool.NativeAot
            )]
            [ExpectedWarning("IL2026", "WithRequires.InstanceProperty.set")]
            [ExpectedWarning(
            ...
            [ExpectedWarning(
                "IL3050",
                "WithRequires.StaticProperty.get",
                ProducedBy = Tool.NativeAot
            )]
            [ExpectedWarning("IL2026", "WithRequires.StaticProperty.get")]
            [ExpectedWarning(
            ...
            [ExpectedWarning(
                "IL3050",
                "WithRequires.StaticProperty.set",
                ProducedBy = Tool.NativeAot
            )]
            [ExpectedWarning("IL2026", "WithRequires.StaticProperty.set")]
            [ExpectedWarning(
            ...
            static void TestDirectReflectionAccess()
            {
                ...
                typeof(WithRequiresOnlyInstanceProperties).GetProperty(
                    nameof(WithRequiresOnlyInstanceProperties.InstanceProperty)
                );
                typeof(DerivedWithoutRequires).GetProperty(
                    nameof(DerivedWithRequires.DerivedStaticProperty)
                ); // Doesn't warn
                typeof(DerivedWithRequires).GetProperty(
                    nameof(DerivedWithRequires.DerivedStaticProperty)
                );
            }
            ...
            [ExpectedWarning(
                "IL2113",
                "BaseForDAMAnnotatedClass.baseProperty.get",
                ProducedBy = Tool.Trimmer | Tool.NativeAot
            )]
            [ExpectedWarning(
                "IL2113",
                "BaseForDAMAnnotatedClass.baseProperty.set",
                ProducedBy = Tool.Trimmer | Tool.NativeAot
            )]
            class DAMAnnotatedClass : BaseForDAMAnnotatedClass
            {
                public static int publicProperty
                {
                    [ExpectedWarning(
                        "IL2112",
                        "DAMAnnotatedClass.publicProperty.get",
                        ProducedBy = Tool.Trimmer | Tool.NativeAot
                    )]
                    get;
                    [ExpectedWarning(
                        "IL2112",
                        "DAMAnnotatedClass.publicProperty.set",
                        ProducedBy = Tool.Trimmer | Tool.NativeAot
                    )]
                    set;
                }
                ...
                static int privateProperty
                {
                    [ExpectedWarning(
                        "IL2112",
                        "DAMAnnotatedClass.privateProperty.get",
                        ProducedBy = Tool.Trimmer | Tool.NativeAot
                    )]
                    get;
                    [ExpectedWarning(
                        "IL2112",
                        "DAMAnnotatedClass.privateProperty.set",
                        ProducedBy = Tool.Trimmer | Tool.NativeAot
                    )]
                    set;
                }
        ...
        [ExpectedWarning(
            "IL3050",
            "AttributeWithRequires.AttributeWithRequires()",
            ProducedBy = Tool.Analyzer | Tool.NativeAot
        )]
        ...
        static void KeepFieldOnAttribute()
        {
            ...
            typeof(RequiresOnClass)
                .GetMethod(
                    nameof(KeepFieldOnAttributeInner),
        ...
        public class AttributeParametersAndProperties
        {
            ...
            class TestClass
            {
                ...
                [AttributeWithRequirementsOnParameters(
                    AnnotatedField = typeof(AttributeParametersAndProperties)
                )]
                public static void Test() { }
            }
        ...
        class MembersOnClassWithRequires<T>
        {
            public class RequiresAll<
                [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.All)] U
            > { }
            ...
            public class GenericAnnotatedWithWarningWithRequires<
        ...
        class ConstFieldsOnClassWithRequires
        {
            ...
            [ExpectedWarning(
                "IL2026",
                "--ConstClassWithRequires--",
                nameof(ConstClassWithRequires.Method)
            )]
            [ExpectedWarning(
                "IL3050",
                "--ConstClassWithRequires--",
            ...
            [ExpectedWarning(
                "IL2026",
                "--ConstClassWithRequiresUsingField--",
                nameof(ConstClassWithRequiresUsingField.Method)
            )]
            [ExpectedWarning(
                "IL3050",
                "--ConstClassWithRequiresUsingField--",
