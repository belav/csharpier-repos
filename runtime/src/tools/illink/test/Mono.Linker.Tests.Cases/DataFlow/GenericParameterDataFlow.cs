...
namespace Mono.Linker.Tests.Cases.DataFlow
{
    ...
    public class GenericParameterDataFlow
    {
        ...
        /// </summary>
        class GenericBaseTypeWithRequirements<
            [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicFields)] T
        >
        {
        ...
        class DerivedTypeWithInstantiatedGenericOnBase
            : GenericBaseTypeWithRequirements<TestType> { }

        class DerivedTypeWithInstantiationOverSelfOnBase
            : GenericBaseTypeWithRequirements<DerivedTypeWithInstantiationOverSelfOnBase> { }
        ...
        class DerivedTypeWithOpenGenericOnBase<T> : GenericBaseTypeWithRequirements<T>
        {
            ...
            [ExpectedWarning(
                "IL2091",
                nameof(GenericBaseTypeWithRequirements<T>),
        ...
        class DerivedTypeWithOpenGenericOnBaseWithRUCOnBase<T>
            : BaseTypeWithOpenGenericDAMTAndRUC<T>
        {
            [ExpectedWarning(
                "IL2091",
                nameof(DerivedTypeWithOpenGenericOnBaseWithRUCOnBase<T>),
                ProducedBy = ProducedBy.Trimmer
            )]
            [ExpectedWarning(
                "IL2026",
                nameof(BaseTypeWithOpenGenericDAMTAndRUC<T>),
                ProducedBy = ProducedBy.Trimmer
            )]
        ...
        class BaseTypeWithOpenGenericDAMTAndRUC<
            [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.All)] T
        > { }

        [ExpectedWarning(
            "IL2026",
            nameof(DerivedTypeWithOpenGenericOnBaseWithRUCOnDerived<TestType>)
        )]
        ...
        [RequiresUnreferencedCode("RUC")]
        class DerivedTypeWithOpenGenericOnBaseWithRUCOnDerived<T>
            : BaseTypeWithOpenGenericDAMT<T> { }

        class BaseTypeWithOpenGenericDAMT<
            [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.All)] T
        > { }

        class DerivedTypeWithOpenGenericOnBaseWithRequirements<
            [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicFields)] T
        > : GenericBaseTypeWithRequirements<T> { }

        static void TestMultipleGenericParametersOnType()
        {
            MultipleTypesWithDifferentRequirements<
                TestType,
                TestType,
                TestType,
                TestType
        ...
        class RootTypeWithRequirements<
            [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicFields)] TRoot
        >
        {
        ...
        {
            IGenericInterfaceTypeWithRequirements<TestType> instance =
                new InterfaceImplementationTypeWithInstantiatedGenericOnBase();
        ...
        interface IGenericInterfaceTypeWithRequirements<
            [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicFields)] T
        > { }

        class InterfaceImplementationTypeWithInstantiatedGenericOnBase
            : IGenericInterfaceTypeWithRequirements<TestType> { }

        interface IGenericInterfaceTypeWithRequiresAll<
            [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.All)] T
        > { }

        class InterfaceImplementationTypeWithInstantiationOverSelfOnBase
            : IGenericInterfaceTypeWithRequiresAll<InterfaceImplementationTypeWithInstantiationOverSelfOnBase> { }

        [ExpectedWarning("IL2091", nameof(IGenericInterfaceTypeWithRequirements<T>))]
        class InterfaceImplementationTypeWithOpenGenericOnBase<T>
            : IGenericInterfaceTypeWithRequirements<T> { }

        class InterfaceImplementationTypeWithOpenGenericOnBaseWithRequirements<
            [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicFields)] T
        > : IGenericInterfaceTypeWithRequirements<T> { }
        ...
        class TypeGenericRequirementsOnMembers<
            [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicFields)] TOuter
        >
        {
            ...
            public TypeRequiresPublicFields<TOuter> PublicFieldsProperty { get; set; }

            [ExpectedWarning(
                "IL2091",
                nameof(TypeGenericRequirementsOnMembers<TOuter>),
            ...
            public TypeRequiresPublicMethods<TOuter> PublicMethodsProperty
            {
                [ExpectedWarning(
                    "IL2091",
                    nameof(TypeRequiresPublicMethods<TOuter>),
                    ProducedBy = ProducedBy.Trimmer
                )]
                get => null;
                [ExpectedWarning(
            ...
            public TypeRequiresPublicFields<TOuter> PublicFieldsMethodReturnValue()
            {
                return null;
            }
            ...
            [ExpectedWarning("IL2091", nameof(TypeRequiresPublicMethods<TOuter>))]
            public TypeRequiresPublicMethods<TOuter> PublicMethodsMethodReturnValue()
            {
                return null;
            }
        ...
        class PartialyInstantiatedFields<
            [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicFields)] TOuter
        ...
        [ExpectedWarning(
            "IL2091",
            nameof(BaseForPartialInstantiation<TestType, TOuter>),
            "'TMethods'"
        )]
        class PartialyInstantiatedMethods<
            [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicFields)] TOuter
        ...
        {
            MethodMultipleWithDifferentRequirements_TestMultiple<
                TestType,
                TestType,
                TestType,
                TestType
            >();
            MethodMultipleWithDifferentRequirements_TestFields<
                TestType,
                TestType,
                TestType,
                TestType
            >();
            MethodMultipleWithDifferentRequirements_TestMethods<
                TestType,
                TestType,
                TestType,
                TestType
            >();
            MethodMultipleWithDifferentRequirements_TestBoth<
                TestType,
                TestType,
                TestType,
                TestType
            >();
            MethodMultipleWithDifferentRequirements_TestNothing<
                TestType,
                TestType,
                TestType,
                TestType
        ...
        {
            public static void StaticRequiresPublicFields<
                [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicFields)] T
            >() => typeof(T).RequiresPublicFields();

            public void InstanceRequiresPublicFields<
                [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicFields)] T
            >() => typeof(T).RequiresPublicFields();

            public virtual void VirtualRequiresPublicFields<
                [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicFields)] T
            >() => typeof(T).RequiresPublicFields();

            public static void StaticRequiresPublicMethods<
                [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicMethods)] T
            >() => typeof(T).RequiresPublicMethods();

            public void InstanceRequiresPublicMethods<
                [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicMethods)] T
            >() => typeof(T).RequiresPublicMethods();

            public virtual void VirtualRequiresPublicMethods<
                [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicMethods)] T
            >() => typeof(T).RequiresPublicMethods();
        ...
        {
            void InterfaceRequiresPublicFields<
                [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicFields)] T
            >();
            void InterfaceRequiresPublicMethods<
                [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicMethods)] T
            >();
        }

        class TypeWithInstantiatedGenericMethodViaGenericParameter<
            [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicFields)] TOuter
        > : BaseTypeWithGenericMethod, IInterfaceWithGenericMethod
        {
            ...
            public static void StaticRequiresPublicFields<
                [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicFields)] TInner
            >()
            {
            ...
            public override void VirtualRequiresPublicFields<
                [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicFields)] T
            >()
            {
                typeof(T).RequiresPublicFields();
            ...
            public override void VirtualRequiresPublicMethods<
                [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicMethods)] T
            >()
            {
                typeof(T).RequiresPublicMethods();
            ...
            public void InterfaceRequiresPublicFields<
                [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicFields)] T
            >()
            {
                typeof(T).RequiresPublicFields();
            ...
            public void InterfaceRequiresPublicMethods<
                [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicMethods)] T
            >()
            {
                typeof(T).RequiresPublicMethods();
        ...
        static void TestUnmanagedConstraintSatisfiesParameterlessConstructor<T>()
            where T : unmanaged
        {
            RequiresParameterlessConstructor<T>();
        }

        static void RequiresParameterlessConstructor<
            [DynamicallyAccessedMembers(
        ...
        [ExpectedWarning(
            "IL2026",
            "RUCTypeRequiresPublicFields<T>.StaticMethodRequiresPublicMethods<U>",
            "message"
        )]
        [ExpectedWarning(
            "IL2026",
        ...
        [ExpectedWarning(
            "IL2026",
            "RUCTypeRequiresPublicFields<T>.RUCTypeRequiresPublicFields",
            "message"
        )]
        // And about method generic parameters:
        [ExpectedWarning(
            "IL2091",
            "RUCTypeRequiresPublicFields<T>.InstanceMethodRequiresPublicMethods<U>()"
        )]
        [ExpectedWarning(
            "IL2091",
            "RUCTypeRequiresPublicFields<T>.StaticMethodRequiresPublicMethods<U>()"
        ...
        [ExpectedWarning(
            "IL2091",
            "RUCTypeRequiresPublicFields<T>.VirtualMethodRequiresPublicMethods<U>()"
        )]
        ...
        [ExpectedWarning(
            "IL2091",
            "RUCTypeRequiresPublicFields<T>",
            ProducedBy = ProducedBy.Trimmer
        )] // RUCTypeRequiresPublicFields<T> local
        [ExpectedWarning(
            "IL2091",
            "RUCTypeRequiresPublicFields<T>",
            ProducedBy = ProducedBy.Trimmer
        ...
        [ExpectedWarning(
            ...
            "RUCTypeRequiresPublicFields<T>",
            ProducedBy = ProducedBy.Trimmer
        )] // InstanceMethodRequiresPublicMethods<T>
        [ExpectedWarning(
            "IL2091",
            "RUCTypeRequiresPublicFields<T>",
            ProducedBy = ProducedBy.Trimmer
        ...
        [ExpectedWarning(
            ...
            "RUCTypeRequiresPublicFields<T>",
            ProducedBy = ProducedBy.Trimmer
        )] // VirtualMethodRequiresPublicMethods<T>
