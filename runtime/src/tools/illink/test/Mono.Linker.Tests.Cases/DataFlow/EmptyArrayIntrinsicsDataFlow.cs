...
namespace Mono.Linker.Tests.Cases.DataFlow
{
    ...
    class EmptyArrayIntrinsicsDataFlow
    {
        ...
        {
            s_typeWithKeptPublicParameterlessConstructor.GetConstructor(
                s_localEmptyArrayInvisibleToAnalysis
            );
        }
        ...
        static Type s_typeWithKeptPublicParameterlessConstructor =
            typeof(EmptyArrayIntrinsicsDataFlow);
    }
}
