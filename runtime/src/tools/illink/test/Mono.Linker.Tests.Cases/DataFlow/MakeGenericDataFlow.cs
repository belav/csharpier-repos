...
namespace Mono.Linker.Tests.Cases.DataFlow
{
    ...
    public class MakeGenericDataFlow
    {
        ...
        class MakeGenericType
        {
            ...
            class GenericWithPublicFieldsArgument<
                [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicFields)] T
            > { }
            ...
            {
                typeof(GenericWithMultipleArgumentsWithRequirements<,>).MakeGenericType(
                    typeof(TestType),
                    typeof(TestType)
                );
            }
            ...
            class NewConstraint
            {
                ...
                static void AnnotationAndConstraintMatch(
                    [DynamicallyAccessedMembers(
        ...
        class MakeGenericMethod
        {
            ...
            static void TestNullMethodName_GetRuntimeMethod()
            {
                ...
                MethodInfo noValue = typeof(MakeGenericMethod).GetRuntimeMethod(
                    null,
                    new Type[] { }
                );
                noValue.MakeGenericMethod(typeof(TestType));
            ...
            static void TestWithEmptyInputToGetMethod_GetRuntimeMethod(Type unknownType)
            {
                ...
                // No warning - since there's no method on input
                noValue
                    .GetRuntimeMethod("NoMethod", new Type[] { })
            ...
            static void TestWithEmptyInputNoSuchMethod_GetRuntimeMethod(Type unknownType)
            {
                // No warning - the method doesn't exist, so this should throw at runtime anyway
                typeof(TestType)
                    .GetRuntimeMethod("NoSuchMethod", new Type[] { })
                    .MakeGenericMethod(unknownType);
            }
            ...
            )
            {
                ...
                t.GetMethod(nameof(GenericWithNoRequirements), BindingFlags.Static)
                    .MakeGenericMethod(new Type[] { typeof(TestType) });
            }
            ...
            )
            {
                ...
                // This should warn just once due to case 2 - annotated type, but unknown method
                t.GetRuntimeMethod(nameof(GenericWithNoRequirements), new Type[] { })
                    .MakeGenericMethod(new Type[] { typeof(TestType) });
            }

            [ExpectedWarning("IL2060", nameof(MethodInfo.MakeGenericMethod))]
            static void TestWithMultipleNames(int p = 0, string unknownName = null)
            {
                string name = null;
                switch (p)
                {
                ...
                typeof(MakeGenericMethod)
                    .GetMethod(name, BindingFlags.Static)
                    .MakeGenericMethod(new Type[] { typeof(TestType) });
            }

            [ExpectedWarning("IL2060", nameof(MethodInfo.MakeGenericMethod))]
            static void TestWithMultipleNames_GetRuntimeMethod(int p = 0, string unknownName = null)
            {
                string name = null;
                switch (p)
                {
                ...
                // This should warn just once due to case 2 - unknown name
                typeof(MakeGenericMethod)
                    .GetRuntimeMethod(name, new Type[] { })
                    .MakeGenericMethod(new Type[] { typeof(TestType) });
            }
            ...
            static void TestNullTypeArgument()
            {
                Type t = null;
                typeof(MakeGenericMethod)
                    .GetMethod(nameof(GenericWithRequirements), BindingFlags.Static)
                    .MakeGenericMethod(t);
            }
            ...
            {
                typeof(MakeGenericMethod)
                    .GetRuntimeMethod(nameof(GenericWithRequirements), Type.EmptyTypes)
                    .MakeGenericMethod(typeof(TestType));
            }
            ...
            public static void GenericWithRequirements<
                [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicFields)] T
            >() { }
            ...
            {
                typeof(MakeGenericMethod)
                    .GetMethod(nameof(GenericMultipleParameters), BindingFlags.Static)
            ...
            {
                typeof(MakeGenericMethod)
                    .GetMethod(nameof(GenericWithNoRequirements), BindingFlags.Static)
                    .MakeGenericMethod(typeof(TestType));
            }
            ...
            {
                typeof(MakeGenericMethod)
                    .GetRuntimeMethod(nameof(GenericWithNoRequirements), Type.EmptyTypes)
                    .MakeGenericMethod(typeof(TestType));
            }
            ...
            {
                typeof(MakeGenericMethod)
                    .GetMethod(nameof(GenericWithNoRequirements))
                    .MakeGenericMethod(type);
            }
            ...
            static void TestWithMultipleArgumentsWithRequirements()
            {
                typeof(MakeGenericMethod)
                    .GetMethod(
                        nameof(GenericWithMultipleArgumentsWithRequirements),
                        BindingFlags.Static | BindingFlags.NonPublic
                    )
                    .MakeGenericMethod(typeof(TestType), typeof(TestType));
            }
            ...
            class StaticInterfaceMethods
            {
                ...
                static MethodInfo KnownType() =>
                    typeof(IFoo).GetMethod("Method").MakeGenericMethod(new Type[] { typeof(int) });

                [ExpectedWarning("IL2090", "T", "PublicMethods")]
                static MethodInfo UnannotatedGenericParam<T>() =>
                    typeof(IFoo).GetMethod("Method").MakeGenericMethod(new Type[] { typeof(T) });
            ...
            class NewConstraint
            {
                ...
                static void SpecificType()
                {
                    typeof(NewConstraint)
                        .GetMethod(
                            nameof(GenericWithNewConstraint),
                            BindingFlags.Static | BindingFlags.NonPublic
                        )
                        .MakeGenericMethod(typeof(TestType));
                }
                ...
                )
                {
                    typeof(NewConstraint)
                        .GetMethod(
                            nameof(GenericWithNewConstraintAndAnnotations),
                            BindingFlags.Static | BindingFlags.NonPublic
                        )
            ...
            class StructConstraint
            {
                ...
                static void SpecificType()
                {
                    typeof(StructConstraint)
                        .GetMethod(
                            nameof(GenericWithStructConstraint),
                            BindingFlags.Static | BindingFlags.NonPublic
                        )
                        .MakeGenericMethod(typeof(TestType));
                }
            ...
            class UnmanagedConstraint
            {
                ...
                static void SpecificType()
                {
                    typeof(UnmanagedConstraint)
                        .GetMethod(
                            nameof(GenericWithUnmanagedConstraint),
                            BindingFlags.Static | BindingFlags.NonPublic
                        )
                        .MakeGenericMethod(typeof(TestType));
                }
            ...
            )
            {
                MethodInfo m = (MethodInfo)
                    MethodInfo.GetMethodFromHandle(
                        typeof(MakeGenericMethod)
                            .GetMethod(nameof(GenericWithRequirements))
                            .MethodHandle
                    );
