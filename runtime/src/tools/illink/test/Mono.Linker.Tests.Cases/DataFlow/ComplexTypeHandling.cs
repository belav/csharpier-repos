...
namespace Mono.Linker.Tests.Cases.DataFlow
{
    ...
    [UnconditionalSuppressMessage(
        "AOT",
        "IL3050",
        Justification = "Applying DAM PublicMethods on an array will mark Array.CreateInstance which has RDC on it"
    )]
    ...
    public class ComplexTypeHandling
    {
        ...
        static void TestArrayInAttributeParameter()
        {
            ...
            typeof(ComplexTypeHandling)
                .GetMethod(
                    nameof(TestArrayInAttributeParameterImpl),
        ...
        class RequiresPublicMethodAttribute : Attribute
        {
            ...
            public RequiresPublicMethodAttribute(
                [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicMethods)]
                [KeptAttributeAttribute(typeof(DynamicallyAccessedMembersAttribute))] Type t
            ) { }
        }
    }
}
