...
namespace Mono.Linker.Tests.Cases.DataFlow
{
    ...
    public class CompilerGeneratedCodeDataflow
    {
        ...
        class Iterator
        {
            ...
            static IEnumerable<int> UseUnannotatedParameterBeforeYieldReturn(
            ...
            static IEnumerable<int> FlowUnannotatedParameterAcrossYieldReturn(
                Type unknownType = null
            )
            {
                yield return 0;
        ...
        class LocalFunction
        {
            ...
            )
            {
                ...
                [ExpectedWarning(
                    "IL2067",
                    nameof(ReadCapturedAnnotatedParameter),
                    "tParameter",
                    nameof(DataFlowTypeExtensions.RequiresAll)
                )]
                void LocalFunction() => tParameter.RequiresAll();
        ...
        class Complex
        {
            ...
            static void NestedLambdas()
            {
                ...
                var outerLambda = () =>
                {
                    var innerLambda = [ExpectedWarning(
                        "IL2072",
                        nameof(GetWithPublicMethods),
                        nameof(DataFlowTypeExtensions.RequiresAll)
                    )]
