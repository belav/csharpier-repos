...
#pragma warning disable CS4014 // async call is not awaited
    ...
    public class CompilerGeneratedTypes
    {
        ...
        {
            Local1<string>();
            IEnumerable<object> Local1<
                [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicMethods)] T1
            >()
            {
                foreach (var o in Local2<string>())
                {
                    yield return o;
                }
                IEnumerable<object> Local2<
        ...
        private static void IteratorInsideClosureMismatch()
        {
            ...
            IEnumerable<object> Outer<
                [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicProperties)] T1
            >()
            {
                int x = 0;
                foreach (var o in Inner<string>())
                ...
                IEnumerable<object> Inner<
                    [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicMethods)] T2
                >()
                {
                    x++;
                    foreach (var m in typeof(T1).GetMethods())
        ...
        private sealed class GlobalClosureClass<
            [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicMethods)] T
        >
        {
            public static void M1<
                [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicProperties)] U
            >()
            {
                Func<string, Action> a = (string s) =>
                    () => Console.WriteLine(s + typeof(T).GetMethods());
            ...
            {
                var l = [ExpectedWarning(
                    "IL2090",
                    nameof(GlobalClosureClass<T>),
                    nameof(System.Type.GetProperties)
                )]
        ...
        static IEnumerable<int> LambdaInsideIterator<
            [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicMethods)] T
        >()
        {
        ...
        static IEnumerable<int> LocalFunctionInsideIterator<
            [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicMethods)] T
        >()
        {
        ...
        static IEnumerable<int> CapturingLambdaInsideIterator<
            [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicMethods)] T
        >()
        {
            int i = 0;
        ...
        static IEnumerable<int> CapturingLocalFunctionInsideIterator<
            [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicMethods)] T
        >()
        {
            int i = 0;
        ...
        static async Task LambdaInsideAsync<
            [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicMethods)] T
        >()
        {
            var l = () => typeof(T).GetMethods();
        ...
        static async Task LocalFunctionInsideAsync<
            [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicMethods)] T
        >()
        {
            void LocalFunction() => typeof(T).GetMethods();
        ...
        class NestedStaticLambda
        {
            ...
            >
            {
                public static Func<Func<T, T>, Func<T, T>> NestedLambda = (Func<T, T> x) =>
                    v => x(v);
            }
