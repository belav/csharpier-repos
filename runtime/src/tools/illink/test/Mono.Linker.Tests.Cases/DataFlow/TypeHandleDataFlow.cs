...
namespace Mono.Linker.Tests.Cases.DataFlow
{
    ...
    class TypeHandleDataFlow
    {
        ...
        [ExpectedWarning(
            "IL2026",
            "--" + nameof(TestTypeWithRUCOnMembers.PublicMethodWithRUC) + "--"
        )]
        ...
        static void TestTypeOfFromGeneric<
        ...
        static void TestGetTypeHandle()
        {
            ...
            Type.GetTypeFromHandle(typeof(TestTypeWithRUCOnMembers).TypeHandle)
                .RequiresPublicMethods();
        }

        [ExpectedWarning("IL2087", nameof(DataFlowTypeExtensions.RequiresPublicFields))]
        static void TestGetTypeHandleFromGeneric<
            [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicMethods)] T
        >()
        {
