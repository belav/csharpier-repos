...
namespace Mono.Linker.Tests.Cases.DataFlow
{
    ...
    public class FeatureCheckDataFlow
    {
        ...
        class CallFeatureUnguarded
        {
            ...
            {
                var a = TestFeatures.IsUnreferencedCodeSupported
                    ? true
                    : RequiresUnreferencedCodeBool();
                var b = !TestFeatures.IsUnreferencedCodeSupported
                    ? RequiresUnreferencedCodeBool()
                    : true;
            }
        ...
        class CallFeatureGuarded
        {
            ...
            [ExpectedWarning(
                "IL2026",
                nameof(RequiresUnreferencedCode),
        ...
        class FeatureCheckBooleanExpressions
        {
            ...
            {
                if (
                    TestFeatures.IsUnreferencedCodeSupported
        ...
        class FeatureCheckCombinations
        {
            ...
            [ExpectedWarning(
                "IL2026",
                nameof(RequiresUnreferencedCode),
                ProducedBy = Tool.Analyzer | Tool.Trimmer
            )]
        ...
        class ExceptionalDataFlow
        {
            ...
            [ExpectedWarning(
                "IL2026",
                nameof(RequiresUnreferencedCode1),
                ProducedBy = Tool.Trimmer | Tool.NativeAot
            )]
            ...
            [ExpectedWarning(
                "IL2026",
                nameof(RequiresUnreferencedCode2),
                ProducedBy = Tool.Trimmer | Tool.NativeAot
            )]
            ...
            [ExpectedWarning(
                "IL2026",
                nameof(RequiresUnreferencedCode3),
                ProducedBy = Tool.Trimmer | Tool.NativeAot
            )]
            ...
            static void AssertInFinallyWithCatchNestedInTry()
            {
                try
                {
                    ...
                    { // This catch makes no difference to the result.
                    }
                    finally
                    {
                        Debug.Assert(TestFeatures.IsUnreferencedCodeSupported);
