...
namespace Mono.Linker.Tests.Cases.DataFlow
{
    ...
    class MethodByRefParameterDataFlow
    {
        ...
        static void TestAssignStaticToAnnotatedRefParameter(
        ...
        static void TestAssigningToRefParameter(
            [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicMethods)]
                Type inputTypeWithMethods,
            [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicMethods)]
                ref Type outputTypeWithMethods
        )
        {
        ...
        {
            static ref Type GetTypeRefWithoutAnnotations()
            {
                throw null;
            }

            [return: DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicMethods)]
            static ref Type GetTypeRefWithMethods()
            {
                throw null;
            }
            ...
            static ref Type GetTypeRefWithMethodsAndFields()
            {
                throw null;
            }
            ...
            [ExpectedWarning(
                "IL2068",
                nameof(GetTypeRefWithMethodsAndFields),
                "InnerMethodWithDam"
            )]
            static void MethodWithLocalMethodWithDam(
                Type t,
                [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicMethods)]
                    Type tWithMethods,
