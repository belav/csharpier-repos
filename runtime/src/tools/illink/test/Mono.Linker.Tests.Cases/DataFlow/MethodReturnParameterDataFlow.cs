...
namespace Mono.Linker.Tests.Cases.DataFlow
{
    ...
    public class MethodReturnParameterDataFlow
    {
        public static void Main()
        {
            ...
            NoRequirements();
            instance.ReturnPublicParameterlessConstructor(
                typeof(TestType),
                typeof(TestType),
                typeof(TestType)
            );
        ...
        [ExpectedWarning(
            ...
            nameof(DataFlowTypeExtensions)
                ...
                + "(Type)",
            nameof(MethodReturnParameterDataFlow)
                + "."
                + nameof(ReturnPublicParameterlessConstructor)
                + "(Type, Type, Type)"
        )]
        [ExpectedWarning(
            "IL2072",
        ...
        {
            Type t = ReturnPublicParameterlessConstructor(
                typeof(TestType),
                typeof(TestType),
                typeof(TestType)
            );
        ...
        [return: DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicMethods)]
        static object UnsupportedReturnTypeAndParameter(
            [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicMethods)] object param
        ) => null;
