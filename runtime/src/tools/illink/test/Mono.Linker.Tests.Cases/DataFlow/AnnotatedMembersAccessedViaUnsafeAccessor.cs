...
namespace Mono.Linker.Tests.Cases.DataFlow
{
    ...
    class AnnotatedMembersAccessedViaUnsafeAccessor
    {
        ...
        class Target
        {
            private static void MethodWithAnnotatedParameter(
            ...
            private static void MethodWithAnnotationMismatch(
                [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicMethods)] Type type
            ) { }
        ...
        static extern void MethodWithAnnotatedParameter(
            Target target,
            [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicMethods)] Type type
        );
        ...
        [UnsafeAccessor(UnsafeAccessorKind.StaticMethod)]
        [return: DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicMethods)]
        static extern Type StaticMethodWithAnnotatedReturnValue(Target target);

        [ExpectedWarning("IL2111", ProducedBy = Tool.Trimmer)]
        [UnsafeAccessor(UnsafeAccessorKind.Method)]
        [return: DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicMethods)]
        static extern Type VirtualMethodWithAnnotatedReturnValue(Target target);

        [ExpectedWarning("IL2110", ProducedBy = Tool.Trimmer)]
        [UnsafeAccessor(UnsafeAccessorKind.StaticField)]
        [return: DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicMethods)]
        static extern ref Type AnnotatedField(Target target);

        [ExpectedWarning("IL2111", ProducedBy = Tool.Trimmer)]
        [ExpectedWarning("IL2067", ProducedBy = Tool.NativeAot)]
        [UnsafeAccessor(UnsafeAccessorKind.StaticMethod)]
        static extern void MethodWithAnnotationMismatch(
            Target target,
        ...
        static extern ref Type FieldWithAnnotationMismatch(Target target);
    }
}
