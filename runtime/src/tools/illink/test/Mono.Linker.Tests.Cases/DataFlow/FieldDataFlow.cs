...
namespace Mono.Linker.Tests.Cases.DataFlow
{
    ...
    public class FieldDataFlow
    {
        ...
        [ExpectedWarning(
            "IL2074",
            nameof(FieldDataFlow) + "." + nameof(_typeWithPublicParameterlessConstructor),
        ...
        [ExpectedWarning(
            "IL2074",
            nameof(TypeStore) + "." + nameof(TypeStore._typeWithPublicParameterlessConstructor),
            nameof(GetUnknownType)
        )]
        [ExpectedWarning(
            "IL2074",
        ...
        private void WriteToInstanceFieldOnADifferentClass()
        {
            ...
            store._typeWithPublicParameterlessConstructor =
        ...
        [ExpectedWarning(
            "IL2074",
            nameof(FieldDataFlow) + "." + nameof(_staticTypeWithPublicParameterlessConstructor),
            nameof(GetUnknownType)
        )]
        [ExpectedWarning(
            "IL2074",
        ...
        private void ReadFromStaticFieldOnADifferentClass()
        {
            RequirePublicParameterlessConstructor(
                TypeStore._staticTypeWithPublicParameterlessConstructor
            );
        ...
        [ExpectedWarning(
            ...
            nameof(TypeStore)
                + "."
                + nameof(TypeStore._staticTypeWithPublicParameterlessConstructor),
            nameof(GetUnknownType)
        )]
        [ExpectedWarning(
            "IL2074",
        ...
        private void WriteToStaticFieldOnADifferentClass()
        {
            ...
            TypeStore._staticTypeWithPublicParameterlessConstructor =
                GetTypeWithNonPublicConstructors();
        ...
        class WriteFieldOfCapturedInstance
        {
            ...
            [ExpectedWarning(
                "IL2074",
                nameof(GetUnknownType),
                nameof(ClassWithAnnotatedField.field)
            )]
            static void TestNullCoalesce()
            {
        ...
        class AccessReturnedInstanceField
        {
            ...
            static AccessReturnedInstanceField GetInstance(
