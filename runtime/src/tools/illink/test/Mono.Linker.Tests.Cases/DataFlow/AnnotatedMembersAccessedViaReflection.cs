...
[assembly: AnnotatedMembersAccessedViaReflection.AnnotatedAttributeConstructorAttribute(
    typeof(AnnotatedMembersAccessedViaReflection.RequiresUnreferencedCodeType)
)]
...
namespace Mono.Linker.Tests.Cases.DataFlow
{
    ...
    class AnnotatedMembersAccessedViaReflection
    {
        ...
        class AnnotatedMethodParameters
        {
            ...
            [ExpectedWarning(
                "IL2111",
                nameof(IWithAnnotatedMethod.AnnotatedMethod),
                ProducedBy = ProducedBy.Trimmer
            )]
        ...
        class AnnotationOnGenerics
        {
            ...
            [ExpectedWarning(
                "IL2111",
                nameof(GenericMethodWithAnnotation),
                ProducedBy = ProducedBy.Trimmer
            )]
        ...
        class AccessThroughLdToken
        {
            ...
            public static void Test()
            {
                Expression<Func<Type>> getter = () =>
                    (new AccessThroughLdToken()).PropertyWithLdToken;
            }
        }

        public class AnnotatedAttributeConstructorAttribute : Attribute
        {
            public AnnotatedAttributeConstructorAttribute(
