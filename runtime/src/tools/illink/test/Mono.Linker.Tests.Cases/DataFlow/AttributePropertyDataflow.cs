...
namespace Mono.Linker.Tests.Cases.DataFlow
{
    ...
    class AttributePropertyDataflow
    {
        ...
        class AttributesOnMethod
        {
            ...
            [ExpectedWarning(
                "IL2026",
                "--ClassWithKeptPublicMethodsKeptByName--",
            ...
            {
                typeof(AttributesOnMethod)
                    .GetMethod(nameof(TestKeepsPublicMethodsByName))
                    .GetCustomAttribute(typeof(KeepsPublicMethodsAttribute));
            }
            ...
            {
                typeof(AttributesOnMethod)
                    .GetMethod(nameof(TestKeepsPublicFields))
                    .GetCustomAttribute(typeof(KeepsPublicFieldsAttribute));
            }
            ...
            {
                typeof(AttributesOnMethod)
                    .GetMethod(nameof(TestTypeArray))
                    .GetCustomAttribute(typeof(TypeArrayAttribute));
            }
        ...
        class AttributesOnEvent
        {
            ...
            public static void Test()
            {
                typeof(AttributesOnEvent)
                    .GetEvent("Event_FieldSyntax")
                    .GetCustomAttribute(typeof(KeepsPublicMethodsAttribute));
                typeof(AttributesOnEvent)
                    .GetEvent("Event_PropertySyntax")
                    .GetCustomAttribute(typeof(KeepsPublicMethodsAttribute));
        ...
        class AttributeWithConditionalExpression
        {
            ...
            [KeepsPublicMethods(
                TypeName = 1 + 1 == 2
                    ? "Mono.Linker.Tests.Cases.DataFlow.AttributePropertyDataflow+AttributeWithConditionalExpression+ClassWithKeptPublicMethods"
                    : null
            )]
            public static void Test()
            {
                typeof(AttributeWithConditionalExpression)
                    .GetMethod("Test")
                    .GetCustomAttribute(typeof(KeepsPublicMethodsAttribute));
                typeof(AttributeWithConditionalExpression)
                    .GetField("field")
        ...
        class RecursivePropertyDataFlow
        {
            ...
            public static void Test()
            {
                typeof(RecursivePropertyDataFlow)
                    .GetProperty(nameof(Property))
                    .GetCustomAttribute(typeof(KeepsPublicPropertiesAttribute));
                Property = 0;
            }
        }
        ...
        class RecursiveEventDataFlow
        {
            ...
            public static void Test()
            {
                typeof(RecursiveEventDataFlow)
                    .GetEvent(nameof(Event))
                    .GetCustomAttribute(typeof(KeepsPublicEventsAttribute));
                Event += (sender, e) => { };
            }
        }
        ...
        class RecursiveFieldDataFlow
        {
            ...
            public static void Test()
            {
                typeof(RecursiveMethodDataFlow)
