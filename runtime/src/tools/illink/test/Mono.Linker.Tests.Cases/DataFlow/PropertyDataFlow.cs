...
namespace Mono.Linker.Tests.Cases.DataFlow
{
    ...
    public class PropertyDataFlow
    {
        ...
        [ExpectedWarning(
            "IL2072",
            nameof(PropertyDataFlow) + "." + nameof(PropertyWithPublicConstructor) + ".set",
            nameof(GetTypeWithPublicParameterlessConstructor)
        )]
        [ExpectedWarning(
            "IL2072",
            nameof(PropertyDataFlow) + "." + nameof(PropertyWithPublicConstructor) + ".set",
        ...
        [ExpectedWarning(
            "IL2072",
            nameof(PropertyDataFlow) + "." + nameof(StaticPropertyWithPublicConstructor) + ".set",
            nameof(GetTypeWithPublicParameterlessConstructor)
        )]
        [ExpectedWarning(
            "IL2072",
        ...
        Type PropertyPublicParameterlessConstructorWithExplicitAccessors
        {
            ...
            [ExpectedWarning(
                "IL2069",
                nameof(PropertyDataFlow) + "." + nameof(_fieldWithPublicConstructors),
                "'value'",
        ...
        Type PropertyNonPublicConstructorsWithExplicitAccessors
        {
            [ExpectedWarning(
                "IL2078",
                nameof(PropertyDataFlow)
                    + "."
                    + nameof(PropertyNonPublicConstructorsWithExplicitAccessors)
                    + ".get",
        ...
        class TestAutomaticPropagationType
        {
            ...
            [ExpectedWarning(
                "IL2072",
                nameof(TestAutomaticPropagationType) + "." + nameof(ImplicitProperty) + ".set"
            )]
            ...
            [LogDoesNotContain(
                "Could not find a unique backing field for property 'System.Type Mono.Linker.Tests.Cases.DataFlow.PropertyDataFlow/TestAutomaticPropagationType::PropertyWithSimpleGetter()'"
            )]
            ...
            static Type PropertyWithSimpleGetter
            {
                [ExpectedWarning(
                    ...
                    nameof(TestAutomaticPropagationType)
                        + "."
                        + nameof(PropertyWithSimpleGetter)
                        + ".get"
                )]
            ...
            [ExpectedWarning(
                ...
                nameof(TestAutomaticPropagationType)
                    + "."
                    + nameof(PropertyWhichLooksLikeCompilerGenerated_Field),
            ...
            static Type PropertyWhichLooksLikeCompilerGenerated
            {
                ...
                [ExpectedWarning(
                    ...
                    nameof(TestAutomaticPropagationType)
                        + "."
                        + nameof(PropertyWhichLooksLikeCompilerGenerated)
                        + ".get",
                    nameof(TestAutomaticPropagationType)
                        + "."
                        + nameof(PropertyWhichLooksLikeCompilerGenerated_Field),
                ...
                get { return PropertyWhichLooksLikeCompilerGenerated_Field; }
            }
            ...
            // Make sure we don't warn about the field in context of property annotation propagation.
            [LogDoesNotContain(
                "Could not find a unique backing field for property 'System.Type Mono.Linker.Tests.Cases.DataFlow.PropertyDataFlow/TestAutomaticPropagationType::InstancePropertyWithStaticField()'"
            )]
            ...
            Type InstancePropertyWithStaticField
            {
                ...
                set { InstancePropertyWithStaticField_Field = value; }
            }
            ...
            [ExpectedWarning(
                ...
                nameof(TestAutomaticPropagationType)
                    + "."
                    + nameof(PropertyWithDifferentBackingFields)
                    + ".get",
                "Type",
                ProducedBy = Tool.Analyzer
            )]
            ...
            Type PropertyWithDifferentBackingFields
            {
                ...
                get { return PropertyWithDifferentBackingFields_GetterField; }
                set { PropertyWithDifferentBackingFields_SetterField = value; }
            }
            ...
            [ExpectedWarning(
                "IL2043",
                "PropertyWithExistingAttributes",
                "PropertyWithExistingAttributes.get",
                ProducedBy = Tool.Analyzer
            )]
            [ExpectedWarning(
                "IL2043",
                "PropertyWithExistingAttributes",
                "PropertyWithExistingAttributes.set",
                ProducedBy = Tool.Analyzer
            )]
            [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)]
            ...
            [ExpectedWarning(
                ...
                nameof(TestAutomaticPropagationType)
                    + "."
                    + nameof(PropertyWithConflictingAttributes)
                    + ".get",
                nameof(DataFlowTypeExtensions)
                    + "."
                    + nameof(DataFlowTypeExtensions.RequiresPublicConstructors)
            ...
            [ExpectedWarning(
                ...
                "PropertyWithConflictingAttributes_Field",
                ProducedBy = Tool.Trimmer | Tool.NativeAot
            )]
            ...
            [ExpectedWarning(
                "IL2043",
                "PropertyWithConflictingAttributes",
                "PropertyWithConflictingAttributes.get",
                ProducedBy = Tool.Analyzer
            )]
            [ExpectedWarning(
                "IL2043",
                "PropertyWithConflictingAttributes",
                "PropertyWithConflictingAttributes.set",
                ProducedBy = Tool.Analyzer
            )]
            [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)]
            ...
            [ExpectedWarning(
                ...
                nameof(TestAutomaticPropagationType)
                    + "."
                    + nameof(PropertyWithConflictingNoneAttributes)
                    + ".get",
                nameof(DataFlowTypeExtensions)
                    + "."
                    + nameof(DataFlowTypeExtensions.RequiresNonPublicConstructors)
            ...
            Type PropertyWithConflictingNoneAttributes
            {
                ...
                [ExpectedWarning(
                    ...
                    nameof(TestAutomaticPropagationType)
                        + "."
                        + nameof(PropertyWithConflictingNoneAttributes_Field),
                    ProducedBy = Tool.Analyzer
                )]
            ...
            [ExpectedWarning(
                "IL2067",
                nameof(PropertyWithIndexer) + ".Item.set",
                ProducedBy = Tool.Trimmer | Tool.NativeAot
            )]
            [ExpectedWarning(
                "IL2067",
                nameof(PropertyWithIndexer) + ".this[Int32].set",
                ProducedBy = Tool.Analyzer
            )]
            [ExpectedWarning(
                "IL2072",
            ...
            [LogDoesNotContain(
                "'Value passed to parameter 'index' of method 'Mono.Linker.Tests.Cases.DataFlow.PropertyDataFlow.TestAutomaticPropagationType.PropertyWithIndexer.Item.set'"
            )]
            ...
            public class PropertyWithIndexer
            {
                ...
                public Type this[int index]
                {
                    ...
                    [ExpectedWarning(
                        "IL2063",
                        nameof(PropertyWithIndexer) + ".Item.get",
                        ProducedBy = Tool.Trimmer | Tool.NativeAot
                    )]
                    [ExpectedWarning(
                        "IL2063",
                        nameof(PropertyWithIndexer) + ".this[Int32].get",
                        ProducedBy = Tool.Analyzer
                    )]
        ...
        class WriteToSetOnlyProperty
        {
            ...
            public static Type SetOnlyProperty
            {
                set => _setOnlyProperty = value;
            }
        ...
        class BasePropertyAccess
        {
            ...
            {
                [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.All)]
                public override Type DerivedGetOnly
                {
                    get => null;
                }

                [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicMethods)]
                public override Type DerivedSetOnly
                {
                    set => throw null;
                }
            }
            ...
            [ExpectedWarning(
                "IL2072",
                nameof(Derived.DerivedGetOnly) + ".set",
                nameof(GetTypeWithNonPublicConstructors)
            )]
            ...
            [ExpectedWarning(
                "IL2072",
                nameof(Derived.DerivedSetOnly) + ".get",
                nameof(DataFlowTypeExtensions.RequiresAll)
            )]
        ...
        class AccessReturnedInstanceProperty
        {
            ...
            static AccessReturnedInstanceProperty GetInstance(
                [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.All)] Type unused
            ) => null;
            ...
            class IndexWithTypeWithDam
            {
                class DamOnIndexOnly
                {
                    ...
                    [ExpectedWarning(
                        "IL2067",
                        "this[Type].get",
                        nameof(ParamDoesNotMeetRequirements),
                        ProducedBy = Tool.Analyzer
                    )]
                    [ExpectedWarning(
                        "IL2067",
                    ...
                    [ExpectedWarning(
                        "IL2087",
                        "this[Type].get",
                        nameof(TypeParamDoesNotMeetRequirements),
                        ProducedBy = Tool.Analyzer
                    )]
                    [ExpectedWarning(
                        "IL2087",
                    ...
                    static void TypeParamDoesMeetRequirements<
                ...
                static void ValueDoesNotMeetRequirementsIndexDoes(
                    [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicFields)]
                        Type t,
                    Type tUnannotated
                )
                ...
                static void ValueAndIndexMeetRequirements(
                    [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicFields)]
                        Type tFields,
                    [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicMethods)]
                        Type tMethods
