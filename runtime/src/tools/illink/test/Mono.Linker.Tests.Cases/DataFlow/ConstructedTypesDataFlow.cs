...
namespace Mono.Linker.Tests.Cases.DataFlow
{
    ...
    class ConstructedTypesDataFlow
    {
        ...
        class DeconstructedVariable
        {
            ...
            // https://github.com/dotnet/linker/issues/3158
            [ExpectedWarning("IL2067", ProducedBy = Tool.Trimmer | Tool.NativeAot)]
            static void DeconstructRecordManualWithMismatchAnnotation(
                TypeAndInstanceRecordManual value
            )
            {
                var (type, instance) = value;
        ...
        class ConstructedVariable
        {
            ...
            [ExpectedWarning("IL2077")]
            static void ConstructedTypeWithAnnotations(
            ...
            {
                var ct = new { Type = typeof(string), Value = 1 };
            ...
            [ExpectedWarning("IL2072")]
            static void AnonymousTypeWithAnnotation(
                [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicMethods)] Type type
            )
            {
                var ct = new { Type = type, Value = 1 };
