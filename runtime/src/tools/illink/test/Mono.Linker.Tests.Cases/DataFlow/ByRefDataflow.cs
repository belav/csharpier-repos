...
namespace Mono.Linker.Tests.Cases.DataFlow
{
    ...
    class ByRefDataflow
    {
        ...
        [ExpectedWarning(
            "IL2077",
            nameof(ByRefDataflow) + "." + nameof(MethodWithRefParameter) + "(ref Type)",
            ProducedBy = Tool.Analyzer
        )]
        [ExpectedWarning(
            "IL2069",
            nameof(s_typeWithPublicParameterlessConstructor),
            "parameter 'type'",
            nameof(MethodWithRefParameter),
            ProducedBy = Tool.Trimmer | Tool.NativeAot
        )]
        ...
        class MultipleRefCaptures
        {
            ...
            [ExpectedWarning(
                "IL2072",
                nameof(GetTypeWithPublicFields),
                nameof(DataFlowTypeExtensions.RequiresAll)
            )]
            [ExpectedWarning(
                "IL2072",
            ...
            [ExpectedWarning(
                "IL2074",
                nameof(_publicMethodsField),
                nameof(GetTypeWithPublicConstructors)
            )]
            [ExpectedWarning("IL2074", nameof(_publicPropertiesField), nameof(GetUnknownType))]
            [ExpectedWarning(
                "IL2074",
                nameof(_publicPropertiesField),
                nameof(GetTypeWithPublicConstructors)
            )]
            static void TestNullCoalescingAssignmentComplex(bool b = true)
            {
                (b ? ref _publicMethodsField : ref _publicPropertiesField) ??=
            ...
            {
                var value = (b ? ref _publicMethodsField : ref _publicPropertiesField) =
                    GetUnknownType();
                value.RequiresAll();
            }
