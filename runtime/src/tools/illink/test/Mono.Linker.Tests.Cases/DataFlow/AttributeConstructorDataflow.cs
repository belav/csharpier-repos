...
[assembly: KeptAttributeAttribute(
    typeof(AttributeConstructorDataflow.KeepsPublicPropertiesAttribute)
)]
// https://github.com/dotnet/linker/issues/2273
[assembly: ExpectedWarning(
    "IL2026",
    "--ClassWithKeptPublicProperties--",
    ProducedBy = Tool.Trimmer | Tool.NativeAot
)]
[assembly: AttributeConstructorDataflow.KeepsPublicProperties(
    typeof(AttributeConstructorDataflow.ClassWithKeptPublicProperties)
)]
...
namespace Mono.Linker.Tests.Cases.DataFlow
{
    ...
    class AttributeConstructorDataflow
    {
        ...
        [KeepsPublicMethods(
            "Mono.Linker.Tests.Cases.DataFlow.AttributeConstructorDataflow+ClassWithKeptPublicMethods"
        )]
        ...
        {
            typeof(AttributeConstructorDataflow)
                .GetMethod("Main")
                .GetCustomAttribute(typeof(KeepsPublicConstructorAttribute));
            typeof(AttributeConstructorDataflow)
                .GetMethod("Main")
