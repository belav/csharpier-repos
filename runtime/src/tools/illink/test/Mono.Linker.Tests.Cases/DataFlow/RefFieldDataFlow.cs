...
namespace Mono.Linker.Tests.Cases.DataFlow
{
    ...
    class RefFieldDataFlow
    {
        ...
        public static void Main()
        {
            ...
            AssignRefLocals<int, int, int, int>(
                withMethods,
                withFields,
                withMethodsAndFields,
                unannotated
            );
            AssignRefsToFields(withMethods);
            AssignParameters(withMethods, typeof(int), typeof(int), typeof(int), typeof(int));
            AssignRefParameters<int, int, int, int>(
                withMethods,
                ref field,
                ref fieldWithMethods,
                ref fieldWithFields,
                ref fieldWithMethodsAndFields
            );
        ...
        static void AssignFields(
            ...
            FieldWithMethods withMethods,
            FieldWithFields withFields,
            FieldWithMethodsAndFields withMethodsAndFields
        )
        {
        ...
        [ExpectedWarning(
            "IL2079",
            "RefFieldWithMethods.T",
            "RefFieldUnannotated.T",
            ProducedBy = Tool.Analyzer
        )]
        [ExpectedWarning(
            "IL2079",
            "RefFieldWithMethods.T",
            "RefFieldWithFields.T",
            ProducedBy = Tool.Analyzer
        )]
        // IL2064's are bugs - shouldn't be unknown values
        // https://github.com/dotnet/runtime/issues/85465
        ...
        [ExpectedWarning(
            ...
            "RefFieldWithMethods.T",
            ProducedBy = Tool.Trimmer | Tool.NativeAot
        )] // target.T = withMethodsAndFieldswithMtho.T;
        [ExpectedWarning(
            "IL2064",
            "RefFieldWithMethods.T",
            ProducedBy = Tool.Trimmer | Tool.NativeAot
        ...
        static void AssignRefProperties(
            RefFieldWithMethods target,
        ...
        static Type GetUnannotated() => throw new NotImplementedException();

        static ref Type GetRefUnannotated() => throw new NotImplementedException();

        [return: DAM(DAMT.PublicMethods)]
        static Type GetWithMethods() => throw new NotImplementedException();

        [return: DAM(DAMT.PublicMethods)]
        static ref Type GetRefWithMethods() => throw new NotImplementedException();

        [return: DAM(DAMT.PublicFields)]
        static Type GetWithFields() => throw new NotImplementedException();

        [return: DAM(DAMT.PublicFields)]
        static ref Type GetRefWithFields() => throw new NotImplementedException();

        [return: DAM(DAMT.PublicFields | DAMT.PublicMethods)]
        public static Type GetWithMethodsAndFields() => throw new NotImplementedException();

        [return: DAM(DAMT.PublicFields | DAMT.PublicMethods)]
        public static ref Type GetRefWithMethodsAndFields() => throw new NotImplementedException();
        ...
        ref struct RefFieldWithMethodsAndFields
        {
            ...
            [Kept]
            public RefFieldWithMethodsAndFields(
                [DAM(DAMT.PublicFields | DAMT.PublicMethods)] ref Type t
            )
            {
                T = ref t;
            }
