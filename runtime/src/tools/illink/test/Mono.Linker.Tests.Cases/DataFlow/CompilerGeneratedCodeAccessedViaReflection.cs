...
namespace Mono.Linker.Tests.Cases.DataFlow
{
    ...
    class CompilerGeneratedCodeAccessedViaReflection
    {
        ...
        [ExpectedWarning(
            "IL2120",
            "<" + nameof(BaseIteratorWithCorrectDataflow) + ">",
            "MoveNext",
        ...
        class IteratorStateMachines : BaseTypeWithIteratorStateMachines
        {
            ...
            [ExpectedWarning(
                "IL2119",
                "<" + nameof(IteratorCallsMethodWithRequires) + ">",
                "MoveNext",
                CompilerGeneratedCode = true,
                ProducedBy = Tool.Trimmer
            )]
            ...
            [ExpectedWarning(
                "IL2119",
                "<" + nameof(IteratorWithCorrectDataflow) + ">",
                "MoveNext",
                CompilerGeneratedCode = true,
                ProducedBy = Tool.Trimmer
            )]
            ...
            [ExpectedWarning(
                "IL2119",
                "<" + nameof(IteratorWithIntegerDataflow) + ">",
                "MoveNext",
                CompilerGeneratedCode = true,
                ProducedBy = Tool.Trimmer
            )]
            ...
            [ExpectedWarning(
                "IL2119",
                "<" + nameof(IteratorWithProblematicDataflow) + ">",
                "MoveNext",
                CompilerGeneratedCode = true,
                ProducedBy = Tool.Trimmer
            )]
            [ExpectedWarning(
                "IL2119",
                "<t_IteratorWithProblematicDataflow>",
                CompilerGeneratedCode = true,
                ProducedBy = Tool.Trimmer
            )]
            [ExpectedWarning(
            ...
            [ExpectedWarning(
                "IL2112",
                nameof(RUCTypeWithIterators) + "()",
                "--RUCTypeWithIterators--",
                CompilerGeneratedCode = true,
            ...
            class RUCTypeWithIterators
            {
                [ExpectedWarning(
                    "IL2112",
                    nameof(StaticIteratorCallsMethodWithRequires) + "()",
                    ProducedBy = Tool.Trimmer | Tool.NativeAot
                )]
                [ExpectedWarning(
                    "IL3002",
                ...
                [ExpectedWarning(
                    "IL2112",
                    nameof(InstanceIteratorCallsMethodWithRequires) + "()",
                    ProducedBy = Tool.Trimmer | Tool.NativeAot
                )]
                [ExpectedWarning(
                    "IL3002",
            ...
            [ExpectedWarning(
                "IL2026",
                nameof(RUCTypeWithIterators.StaticIteratorCallsMethodWithRequires) + "()",
                "--RUCTypeWithIterators--"
            )]
            [ExpectedWarning(
                "IL2026",
                nameof(RUCTypeWithIterators.InstanceIteratorCallsMethodWithRequires) + "()"
            )]
            [ExpectedWarning(
                "IL2118",
                "<" + nameof(IteratorWithCorrectDataflow) + ">",
        ...
        class AsyncStateMachines
        {
            ...
            [ExpectedWarning(
                "IL2118",
                "<" + nameof(AsyncWithProblematicDataflow) + ">",
                "MoveNext",
                ProducedBy = Tool.Trimmer
            )]
            [ExpectedWarning(
                "IL2118",
                "<" + nameof(AsyncCallsMethodWithRequires) + ">",
                "MoveNext",
                ProducedBy = Tool.Trimmer
            )]
            [ExpectedWarning(
                "IL2118",
                "<" + nameof(AsyncWithCorrectDataflow) + ">",
                "MoveNext",
                ProducedBy = Tool.Trimmer
            )]
            [ExpectedWarning(
                "IL2118",
                "<" + nameof(AsyncWithCorrectDataflow) + ">",
                "<t_AsyncWithCorrectDataflow>",
                ProducedBy = Tool.Trimmer
            )]
            [ExpectedWarning(
                "IL2118",
                "<" + nameof(AsyncWithProblematicDataflow) + ">",
                "<t_AsyncWithProblematicDataflow>",
                ProducedBy = Tool.Trimmer
            )]
        ...
        class AsyncIteratorStateMachines
        {
            ...
            [ExpectedWarning(
                "IL2118",
                "<" + nameof(AsyncIteratorWithProblematicDataflow) + ">",
                "MoveNext",
                ProducedBy = Tool.Trimmer
            )]
            [ExpectedWarning(
                "IL2118",
                "<" + nameof(AsyncIteratorCallsMethodWithRequires) + ">",
                "MoveNext",
                ProducedBy = Tool.Trimmer
            )]
            [ExpectedWarning(
                "IL2118",
                "<" + nameof(AsyncIteratorWithCorrectDataflow) + ">",
                "MoveNext",
                ProducedBy = Tool.Trimmer
            )]
            [ExpectedWarning(
        ...
        class Lambdas
        {
            ...
            static void LambdaCallsMethodWithRequires()
            {
                ...
                [ExpectedWarning(
                    "IL2119",
                    "<" + nameof(LambdaCallsMethodWithRequires) + ">",
                    ProducedBy = Tool.Trimmer
                )]
                () => MethodWithRequires();
                lambda();
            ...
            static void LambdaWithCorrectDataflow()
            {
                var lambda = [ExpectedWarning(
                    "IL2119",
                    "<" + nameof(LambdaWithCorrectDataflow) + ">",
                    ProducedBy = Tool.Trimmer
                )]
                () =>
                {
            ...
            static void LambdaWithProblematicDataflow()
            {
                var lambda = [ExpectedWarning(
                    "IL2119",
                    "<" + nameof(LambdaWithProblematicDataflow) + ">",
                    ProducedBy = Tool.Trimmer
                )]
            ...
            static void LambdaWithCapturedTypeToDAM()
            {
                ...
                var lambda = [ExpectedWarning(
                    "IL2119",
                    "<" + nameof(LambdaWithCapturedTypeToDAM) + ">",
                    ProducedBy = Tool.Trimmer
                )]
                [ExpectedWarning(
                    "IL2072",
            ...
            {
                var lambda = [ExpectedWarning("IL2050")]
                [ExpectedWarning(
                    "IL2119",
                    "<" + nameof(LambdaCallsPInvokeTakingObject) + ">",
                    ProducedBy = Tool.Trimmer
                )]
            ...
            class RUCTypeWithLambdas
            {
                ...
                public void MethodWithLambdas()
                {
                    ...
                    int i = 0;
                    var lambdaWithCapturedState = [ExpectedWarning(
                        "IL3002",
                        "--MethodWithRequires--",
                        ProducedBy = Tool.Analyzer | Tool.NativeAot
                    )]
            ...
            [ExpectedWarning(
                "IL2026",
                nameof(RUCTypeWithLambdas.MethodWithLambdas) + "()",
                "--RUCTypeWithLambdas--"
            )]
        ...
        class LocalFunctions
        {
            ...
            static void LocalFunctionCallsMethodWithRequires()
            {
                ...
                [ExpectedWarning(
                    "IL2119",
                    "<" + nameof(LocalFunctionCallsMethodWithRequires) + ">",
                    ProducedBy = Tool.Trimmer
                )]
            ...
            static void LocalFunctionWithCorrectDataflow()
            {
                [ExpectedWarning(
                    "IL2119",
                    "<" + nameof(LocalFunctionWithCorrectDataflow) + ">",
                    ProducedBy = Tool.Trimmer
                )]
                void LocalFunction()
                {
            ...
            static void LocalFunctionWithProblematicDataflow()
            {
                ...
                [ExpectedWarning(
                    "IL2119",
                    "<" + nameof(LocalFunctionWithProblematicDataflow) + ">",
                    ProducedBy = Tool.Trimmer
                )]
                void LocalFunction()
                {
            ...
            static void LocalFunctionWithCapturedTypeToDAM()
            {
                ...
                [ExpectedWarning(
                    "IL2119",
                    "<" + nameof(LocalFunctionWithCapturedTypeToDAM) + ">",
                    ProducedBy = Tool.Trimmer
                )]
                void LocalFunction()
                {
            ...
            static void LocalFunctionCallsPInvokeTakingObject()
            {
                ...
                [ExpectedWarning(
                    "IL2119",
                    "<" + nameof(LocalFunctionCallsPInvokeTakingObject) + ">",
                    ProducedBy = Tool.Trimmer
                )]
            ...
            [ExpectedWarning(
                "IL2112",
                nameof(RUCTypeWithLocalFunctions) + "()",
                CompilerGeneratedCode = true,
                ProducedBy = Tool.Trimmer | Tool.NativeAot
            )]
            ...
            class RUCTypeWithLocalFunctions
            {
                [ExpectedWarning(
                    "IL2112",
                    nameof(MethodWithLocalFunctions),
            ...
            [ExpectedWarning(
                "IL2026",
                nameof(RUCTypeWithLocalFunctions.MethodWithLocalFunctions) + "()"
            )]
        ...
        class SelfMarkingMethods
        {
            ...
            static void RequiresNonPublicMethodsOnT<
        ...
        class DAMReflectionAccessToCompilerGeneratedCode
        {
            ...
            static void LocalFunctionOnGeneric<
                [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicMethods)] T
            >()
            {
                LocalFunctionInner();
            ...
            static IEnumerable<int> IteratorOnGeneric<
                [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicMethods)] T
            >()
            {
                yield return 0;
            ...
            static async Task AsyncOnGeneric<
                [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicMethods)] T
            >()
            {
            ...
            static async IAsyncEnumerable<int> AsyncIteratorOnGeneric<
                [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicMethods)] T
            >()
            {
                yield return 0;
            ...
            [ExpectedWarning(
                "IL2118",
                "<" + nameof(LambdaOnGeneric) + ">",
                ProducedBy = Tool.Trimmer
            )]
            [ExpectedWarning(
                "IL2118",
                "<" + nameof(LocalFunctionOnGeneric) + ">",
                ProducedBy = Tool.Trimmer
            )]
            public static void Test()
            {
