...
namespace Mono.Linker.Tests.Cases.DataFlow
{
    ...
    public class GenericParameterWarningLocation
    {
        ...
        class TypeInheritance
        {
            ...
            class DerivedWithMatchingAnnotation<
            ...
            class DerivedWithNoAnnotations<TUnknown> : BaseWithPublicMethods<TUnknown>
            {
        ...
        {
            interface IWithPublicMethods<
                [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicMethods)]
                    TPublicMethods
            > { }

            interface IWithPublicFields<
                [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicFields)]
                    TPublicFields
            > { }
            ...
            class ImplementsWithSpecificType
                : IWithPublicMethods<TestType>,
                    IWithPublicFields<TestType> { }

            // No warning - matching annotations
            class ImplementsWithMatchingAnnotation<
                [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.All)] TAll
            > : IWithPublicMethods<TAll>, IWithPublicFields<TAll> { }

            [ExpectedWarning("IL2091", nameof(DynamicallyAccessedMemberTypes.PublicFields))]
            class ImplementsWithOneMismatch<
                [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicMethods)]
                    TPublicMethods
        ...
        class MethodParametersAndReturn
        {
            ...
            static void MethodWithSpecificType(
                TypeWithPublicMethods<TestType> one,
                IWithTwo<TestType, TestType> two
            ) { }
            ...
            [ExpectedWarning(
                "IL2091",
                nameof(IWithTwo<TestType, TestType>),
                ProducedBy = Tool.Trimmer | Tool.Analyzer
            )] // NativeAOT_StorageSpaceType
            [ExpectedWarning(
                "IL2091",
                nameof(TypeWithPublicMethods<TestType>),
                ProducedBy = Tool.Trimmer | Tool.Analyzer
            )] // NativeAOT_StorageSpaceType
            static void MethodWithTwoMismatches<
                ...
                [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicMethods)]
                    TPublicMethods
            >(
                IWithTwo<TPublicMethods, TPublicMethods> two,
                TypeWithPublicMethods<TPublicFields> one
            ) { }

            static TypeWithPublicMethods<TestType> MethodWithSpecificReturnType() => null;

            static TypeWithPublicMethods<TPublicMethods> MethodWithMatchingReturn<
                [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicMethods)]
                    TPublicMethods
            >() => null;
            ...
            class ConstructorWithOneMatchAndOneMismatch<
        ...
        class FieldDefinition
        {
            ...
            class MultipleReferencesToTheSameType<
                [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicMethods)]
                    TPublicMethods,
                TUnknown
            >
        ...
        class MethodBody
        {
            ...
            static void MethodWithPublicMethods<
                [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicMethods)]
                    TPublicMethods
            >() { }

            void InstanceMethodWithPublicMethods<
                [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicMethods)]
                    TPublicMethods
            >() { }
            ...
            class TypeOf
            {
                ...
                static void OneMatchingAnnotation<
                    [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicMethods)]
                        TPublicMethods
                >()
                {
            ...
            class MethodCallOnGenericType
            {
                ...
                static void InstanceMethodMismatch<TUnknown>()
                {
                    TypeWithPublicMethods<TUnknown> instance =
                        GetInstanceForTypeWithPublicMethods<TUnknown>();
            ...
            class LdTokenOfFieldOnGenericType
            {
                ...
                >()
                {
                    Expression<Func<string>> a = () =>
                        IWithTwo<TPublicFields, TPublicMethods>.Field;
                }
            ...
            class LdTokenOfPropertyOnGenericType
            {
                ...
                {
                    Expression<Func<string>> a = () =>
                        TypeWithPublicMethods<TPublicMethods>.Property;
                }
                ...
                {
                    Expression<Func<string>> a = () =>
                        IWithTwo<TPublicFields, TPublicMethods>.Property;
                }
            ...
            class ExceptionCatch
            {
                ...
                >()
                {
                    ...
                    catch (TypeWithPublicMethods<TUnknown>)
                    { // Warn
                    }
                ...
                >()
                {
                    ...
                    catch (TypeWithTwo<TPublicFields, TPublicMethods>)
                    { // Warn x2
                    }
                }
            ...
            class ExceptionFilter
            {
                ...
                >()
                {
                    ...
                    catch (Exception ex) when (ex is TypeWithPublicMethods<TUnknown>)
                    { // Warn
                    }
                ...
                >()
                {
                    ...
                    catch (Exception ex) when (ex is TypeWithTwo<TPublicFields, TPublicMethods>)
                    { // Warn x2
                    }
                }
            ...
            class AnnotatedString
            {
                ...
                [ExpectedWarning(
                    "IL2026",
                    "TypeWithRUCMethod.PrivateRUCMethod",
                    ProducedBy = Tool.Trimmer
                )]
                static void AnnotatedParameter()
                {
                    MethodWithAnnotatedParameter(
                        "Mono.Linker.Tests.Cases.DataFlow.GenericParameterWarningLocation+MethodBody+TypeWithPrivateMethods`1[[Mono.Linker.Tests.Cases.DataFlow.GenericParameterWarningLocation+MethodBody+TypeWithRUCMethod]]"
                    );
                }
        ...
        {
            class TypeWithPublicMethodsAttribute<
                [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicMethods)]
                    TPublicMethods
            > : Attribute { }
        ...
        class NestedGenerics
        {
            ...
            static void GenericMethodNesting<TUnknown>()
            {
                ...
                GenericMethodNoRequirements<
                    RequiresMethods<RequiresNothing<RequiresFields<TUnknown>>>
                >(); // IL2091
                GenericMethodNoRequirements<
                    RequiresMethods<RequiresNothing<RequiresMethods<TypeWithRUCMethod>>>
                >(); // IL2026
            }
            ...
            static void GenericMethodNestingAccessToT<TUnknown>()
            {
                ...
                GenericMethodNoRequirementsAccessToT<
                    RequiresMethods<RequiresNothing<RequiresFields<TUnknown>>>
                >(); // IL2091
                GenericMethodNoRequirementsAccessToT<
                    RequiresMethods<RequiresNothing<RequiresMethods<TypeWithRUCMethod>>>
            ...
            static void GenericInstanceMethodNesting<TUnknown>()
            {
                ...
                instance.GenericInstanceMethod<
                    RequiresMethods<RequiresNothing<RequiresFields<TUnknown>>>
                >(); // IL2091
                instance.GenericInstanceMethod<
                    RequiresMethods<RequiresNothing<RequiresMethods<TypeWithRUCMethod>>>
            ...
            static void MethodOnGenericTypeNesting<TUnknown>()
            {
                GenericTypeWithMethodAndField<
                    RequiresMethods<RequiresNothing<TUnknown>>
                >.GenericMethod<string>(); // No warning
                GenericTypeWithMethodAndField<
                    RequiresMethods<RequiresNothing<RequiresFields<TUnknown>>>
                > // IL2091
                .GenericMethod<
                    RequiresNothing<RequiresFields<RequiresFields<RequiresMethods<TUnknown>>>>
                >(); // IL2091
                GenericTypeWithMethodAndField<
                    RequiresMethods<RequiresNothing<RequiresMethods<TypeWithRUCMethod>>>
                > // IL2026
                .GenericMethod<
                    RequiresNothing<RequiresFields<RequiresMethods<TypeWithRUCMethod>>>
                >(); // IL2026
            }
            ...
            static void FieldOnGenericTypeNesting<TUnknown>()
            {
                ...
                _ = GenericTypeWithMethodAndField<
                    RequiresMethods<RequiresNothing<RequiresFields<TUnknown>>>
                >.Field; // IL2091
                _ = GenericTypeWithMethodAndField<
                    RequiresMethods<RequiresNothing<RequiresMethods<TypeWithRUCMethod>>>
