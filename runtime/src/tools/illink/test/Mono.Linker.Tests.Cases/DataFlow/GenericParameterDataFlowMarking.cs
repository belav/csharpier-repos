    ...
    public class GenericParameterDataFlowMarking
    {
        ...
        class NestedGenerics
        {
            ...
            class GenericInstanceMethod
            {
                ...
                public static void Test()
                {
                    ...
                    instance.GenericMethod<
                        RequiresFields<RequiresFields<RequiresMethods<RequiresMethods<TargetType>>>>
                    >();
                }
            }
            ...
            class GenericMethodOnGenericType
            {
                ...
                {
                    [Kept]
                    public static void GenericMethod<TMethod>()
                    {
                        _ = typeof(TType).Name + typeof(TMethod).Name;
                    }
                }
                ...
                {
                    GenericType<
                        RequiresFields<RequiresNothing<RequiresMethods<TargetTypeForTType>>>
                    >.GenericMethod<
                        RequiresMethods<RequiresFields<RequiresFields<TargetTypeForTMethod>>>
                    >();
                }
            }
            ...
            class BaseTypeGenericNesting
            {
                ...
                [KeptBaseTypeAttribute(
                    typeof(Base<RequiresMethods<RequiresNothing<RequiresMethods<TargetType>>>>),
                    By = Tool.Trimmer
                )]
            ...
            class InterfaceGenericNesting
            {
                ...
                [Kept]
                [KeptBaseTypeAttribute(
                    typeof(IBase<RequiresMethods<RequiresNothing<RequiresMethods<TargetType>>>>),
                    By = Tool.Trimmer
                )]
                class DerivedWithTarget
