...
namespace Mono.Linker.Tests.Cases.DataFlow
{
    ...
    public class TypeBaseTypeDataFlow
    {
        ...
        class AllPropagatedWithDerivedClass
        {
            ...
            [ExpectedWarning(
                "IL2072",
                nameof(DataFlowTypeExtensions.RequiresAll) + "(Type)",
                nameof(TestSystemTypeBase.BaseType) + ".get",
        ...
        static void TestInterfacesPropagated(
            [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.Interfaces)] Type derivedType
        )
        {
        ...
        class LoopPatterns
        {
            static void EnumerateInterfacesOnBaseTypes(
            ...
            static void EnumeratePrivatePropertiesOnBaseTypes(
            ...
            // Can only work with All annotation as NonPublicProperties doesn't propagate to base types
            static void EnumeratePrivatePropertiesOnBaseTypesWithForeach(
                [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.All)] Type type
            )
            {
                const BindingFlags DeclaredOnlyLookup =
