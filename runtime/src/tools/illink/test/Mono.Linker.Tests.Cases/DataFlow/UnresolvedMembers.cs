...
{
    [IgnoreTestCase(
        "Ignore in NativeAOT, see https://github.com/dotnet/runtime/issues/82447",
    ...
    [SetupCompileBefore(
        "UnresolvedLibrary.dll",
        new[] { "Dependencies/UnresolvedLibrary.cs" },
    ...
    class UnresolvedMembers
    {
        ...
        [ExpectedWarning(
            "IL2066",
            "TypeWithUnresolvedGenericArgument",
            ProducedBy = Tool.Trimmer | Tool.Analyzer
        )] // Local variable type
        [ExpectedWarning(
            "IL2066",
            "TypeWithUnresolvedGenericArgument",
            ProducedBy = Tool.Trimmer | Tool.Analyzer
        )] // Called method declaring type
        [ExpectedWarning(
            "IL2066",
            nameof(MethodWithUnresolvedGenericArgument),
            ProducedBy = Tool.Trimmer | Tool.Analyzer
        )]
        ...
        [ExpectedWarning(
            "IL2062",
            nameof(AttributeWithRequirements),
            ProducedBy = Tool.Trimmer | Tool.Analyzer
        )]
        ...
        [ExpectedWarning(
            "IL2062",
            nameof(AttributeWithRequirements.PropertyWithRequirements),
            ProducedBy = Tool.Trimmer | Tool.Analyzer
        )]
        [KeptAttributeAttribute(typeof(AttributeWithRequirements))]
        ...
        [ExpectedWarning(
            "IL2064",
            nameof(AttributeWithRequirements.FieldWithRequirements),
            ProducedBy = Tool.Trimmer | Tool.Analyzer
        )]
        [KeptAttributeAttribute(typeof(AttributeWithRequirements))]
        [AttributeWithRequirements(
