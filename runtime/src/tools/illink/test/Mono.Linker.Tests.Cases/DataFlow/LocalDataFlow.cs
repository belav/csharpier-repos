...
namespace Mono.Linker.Tests.Cases.DataFlow
{
    ...
    public class LocalDataFlow
    {
        ...
        [ExpectedWarning(
            ...
            nameof(DataFlowStringExtensions)
                + "."
        ...
        [ExpectedWarning(
            ...
            nameof(DataFlowStringExtensions)
                + "."
                + nameof(DataFlowStringExtensions.RequiresPublicMethods)
                + "(String)"
        )]
        ...
        [ExpectedWarning(
            ...
            nameof(DataFlowStringExtensions.RequiresAll)
        )]
        [ExpectedWarning(
            "IL2072",
        ...
        [ExpectedWarning(
            ...
            nameof(DataFlowStringExtensions)
                + "."
                + nameof(DataFlowStringExtensions.RequiresNonPublicMethods)
                + "(String)"
        )]
        [ExpectedWarning(
            "IL2072",
        ...
        [ExpectedWarning(
            ...
            nameof(DataFlowStringExtensions)
                + "."
                + nameof(DataFlowStringExtensions.RequiresPublicConstructors)
                + "(String)",
            ProducedBy = Tool.Trimmer
        )]
        [ExpectedWarning(
