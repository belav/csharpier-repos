...
namespace Mono.Linker.Tests.Cases.Resources
{
    [SetupCompileBefore(
        ...
        new[]
        {
            "Dependencies/EmbeddedLinkXmlFileInReferencedAssemblyIsNotProcessedIfNameDoesNotMatchAnAssembly_Lib1.cs",
        },
        resources: new object[]
        {
            "Dependencies/EmbeddedLinkXmlFileInReferencedAssemblyIsNotProcessedIfNameDoesNotMatchAnAssembly_Lib1_NotMatchingName.xml",
        }
    )]
    [IgnoreDescriptors(false)]
    [KeptResourceInAssembly(
        "library.dll",
    ...
    [RemovedMemberInAssembly(
        "library.dll",
        typeof(EmbeddedLinkXmlFileInReferencedAssemblyIsNotProcessedIfNameDoesNotMatchAnAssembly_Lib1),
        "Unused()"
    )]
