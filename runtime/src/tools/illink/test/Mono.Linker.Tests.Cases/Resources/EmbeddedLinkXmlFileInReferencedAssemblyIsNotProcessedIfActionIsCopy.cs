...
namespace Mono.Linker.Tests.Cases.Resources
{
    ...
    [KeptResourceInAssembly(
        "EmbeddedLinkXmlFileInReferencedAssemblyIsNotProcessedIfActionIsCopy_Lib1.dll",
        "EmbeddedLinkXmlFileInReferencedAssemblyIsNotProcessedIfActionIsCopy_Lib1.xml"
    )]
    [KeptMemberInAssembly(
        "EmbeddedLinkXmlFileInReferencedAssemblyIsNotProcessedIfActionIsCopy_Lib1.dll",
        typeof(EmbeddedLinkXmlFileInReferencedAssemblyIsNotProcessedIfActionIsCopy_Lib1),
        "Unused()"
    )]
