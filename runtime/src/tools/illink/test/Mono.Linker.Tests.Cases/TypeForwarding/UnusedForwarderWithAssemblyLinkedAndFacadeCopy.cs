...
namespace Mono.Linker.Tests.Cases.TypeForwarding
{
    ...
    [SetupCompileBefore(
        "Forwarder.dll",
        new[] { "Dependencies/ReferenceImplementationLibrary_3.cs" },
    ...
    [SetupCompileAfter(
        "Forwarder.dll",
        new[] { "Dependencies/ForwarderLibrary_3.cs" },
        references: new[] { "Implementation.dll" }
    )]
    [KeptTypeInAssembly(
        "Forwarder.dll",
        "Mono.Linker.Tests.Cases.TypeForwarding.Dependencies.ImplementationLibrary3B"
    )]
    [KeptTypeInAssembly(
        "Forwarder.dll",
        "Mono.Linker.Tests.Cases.TypeForwarding.Dependencies.RealClassInForwarder3"
    )]
    [KeptTypeInAssembly(
        "Implementation.dll",
        "Mono.Linker.Tests.Cases.TypeForwarding.Dependencies.ImplementationLibrary3B"
    ...
    [RemovedForwarder(
        "Forwarder.dll",
        "Mono.Linker.Tests.Cases.TypeForwarding.Dependencies.ImplementationLibrary3A"
    )]
