...
namespace Mono.Linker.Tests.Cases.TypeForwarding
{
    ...
    class UsedForwarderInGenericIsDynamicallyAccessedWithAssemblyCopyUsed
    {
        ...
        {
            PointToTypeInFacade(
                "Mono.Linker.Tests.Cases.TypeForwarding.OuterGeneric`1[[Mono.Linker.Tests.Cases.TypeForwarding.Dependencies.ImplementationLibrary, Forwarder]], test"
            );

            Activator.CreateInstance(
                "test",
                "Mono.Linker.Tests.Cases.TypeForwarding.OuterGenericForCreateInstance`1[[Mono.Linker.Tests.Cases.TypeForwarding.Dependencies.ImplementationLibraryImp, Forwarder]]"
            );
        }
