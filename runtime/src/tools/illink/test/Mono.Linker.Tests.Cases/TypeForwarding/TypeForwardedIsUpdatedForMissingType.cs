...
namespace Mono.Linker.Tests.Cases.TypeForwarding
{
    ...
    [SetupCompileBefore(
        "Lib.dll",
        new[] { "Dependencies/TypeForwardedIsUpdatedForMissingTypeLib.cs" }
    )]
    [SetupCompileBefore(
        "AnotherLibrary.dll",
        new[] { "Dependencies/TypeForwardedIsUpdatedForMissingTypeLib2.cs" }
    )]
    [SetupCompileAfter(
        "AnotherLibrary.dll",
        new[] { "Dependencies/TypeForwardedIsUpdatedForMissingTypeLib2.cs" }
    ...
    [SetupCompileAfter(
        "Lib.dll",
        new[] { "Dependencies/TypeForwardedIsUpdatedForMissingTypeFwd.cs" },
