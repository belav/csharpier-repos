...
namespace Mono.Linker.Tests.Cases.TypeForwarding
{
    ...
    [SetupCompileAfter(
        "Forwarder.dll",
        new[] { "Dependencies/ForwarderLibrary_2.cs" },
        references: new[] { "Implementation.dll", "Unused.dll" }
    )]
    ...
    [KeptTypeInAssembly(
        "Forwarder.dll",
        "Mono.Linker.Tests.Cases.TypeForwarding.Dependencies.AnotherLibrary`1"
    )]
    [KeptReferencesInAssembly(
        "Forwarder.dll",
        new[] { "System.Runtime", "Implementation", "Unused" }
    )]
