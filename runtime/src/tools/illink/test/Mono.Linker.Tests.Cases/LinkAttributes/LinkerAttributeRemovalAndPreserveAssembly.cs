...
namespace Mono.Linker.Tests.Cases.LinkAttributes
{
    ...
    [SetupCompileBefore(
        ...
        resources: new object[]
        {
            new string[]
            {
                "Dependencies/LinkerAttributeRemovalAndPreserveAssembly_Lib.Descriptor.xml",
    ...
    [ExpectedWarning(
        "IL2045",
        FileName = "ILLink.Descriptors.xml in lib, Version=0.0.0.0, Culture=neutral, PublicKeyToken"
    )]
    [ExpectedNoWarnings]
    [KeptMember(".ctor()")]
