...
namespace Mono.Linker.Tests.Cases.LinkAttributes
{
    ...
    [SetupCompileBefore(
        "library.dll",
        new string[] { "Dependencies/EmbeddedAttributeErrorCases.cs" },
        resources: new object[]
        {
            new string[]
            {
                "Dependencies/EmbeddedAttributeErrorCases.xml",
    ...
    [ExpectedWarning(
        "IL2007",
        "NonExistentAssembly2",
        FileName = "LinkAttributeErrorCases.xml",
        SourceLine = 67,
        SourceColumn = 4
    )]
    [ExpectedWarning(
        "IL2030",
        "NonExistentAssembly1",
        FileName = "LinkAttributeErrorCases.xml",
        SourceLine = 6,
        SourceColumn = 8
    )]
    [ExpectedWarning(
        "IL2030",
        "MalformedAssemblyName, thisiswrong",
        FileName = "LinkAttributeErrorCases.xml",
        SourceLine = 7,
        SourceColumn = 8
    )]
    ...
    [ExpectedWarning(
        "IL2022",
        "AttributeWithNoParametersAttribute",
        FileName = "LinkAttributeErrorCases.xml",
        SourceLine = 13,
        SourceColumn = 8
    )]
    ...
    [ExpectedWarning(
        "IL2022",
        "AttributeWithIntParameterAttribute",
        FileName = "LinkAttributeErrorCases.xml",
        SourceLine = 23,
        SourceColumn = 8
    )]
    ...
    [ExpectedWarning(
        "IL2100",
        FileName = "ILLink.LinkAttributes.xml",
        SourceLine = 3,
        SourceColumn = 4
    )]
    [ExpectedWarning(
