...
namespace Mono.Linker.Tests.Cases.Inheritance.Interfaces.StaticInterfaceMethods
{
    ...
    [SetupCompileBefore(
        "CustomStepSaveAssembly.dll",
        new[] { "Dependencies/CustomStepSaveAssembly.cs" },
        new[] { "illink.dll", "Mono.Cecil.dll", "netstandard.dll" }
    )]
    [SetupLinkerArgument(
        "--custom-step",
        "-MarkStep:CustomStepSaveAssembly,CustomStepSaveAssembly.dll"
    )]
