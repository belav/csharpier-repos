...
namespace Mono.Linker.Tests.Cases.Inheritance.Interfaces.StaticInterfaceMethods
{
    ...
    public static class StaticAbstractInterfaceMethodsLibrary
    {
        ...
        public static class InterfaceMethodsUsedThroughConstrainedType
        {
            ...
            public class UsesIUsedThroughConstrainedTypeMethods
                : IUsedThroughConstrainedType,
                    IUsedThroughConstrainedTypeInternal
            {
                [Kept]
            ...
            private class UnusedIUsedThroughConstrainedTypeMethodsPrivate
                : IUsedThroughConstrainedType,
                    IUsedThroughConstrainedTypeInternal
            {
                public static int UsedThroughConstrainedType() => 0;
            ...
            [Kept]
            public static void CallMethodOnConstrainedType<T>()
                where T : IUsedThroughConstrainedType
            {
            ...
            public static class ExplicitImplementation
            {
                ...
                public class UsedIUsedThroughConstrainedTypeExplicitMethods
                    : IUsedThroughConstrainedTypeExplicitImplementation
                {
                    [Kept]
                    [KeptOverride(typeof(IUsedThroughConstrainedTypeExplicitImplementation))]
                    static int IUsedThroughConstrainedTypeExplicitImplementation.UsedThroughConstrainedType() =>
                        0;
                }
                ...
                [Kept]
                public static void CallTypeConstrainedMethod<T>()
                    where T : IUsedThroughConstrainedTypeExplicitImplementation
                {
                    T.UsedThroughConstrainedType();
                }
        ...
        public static class InterfaceMethodUsedOnConcreteType
        {
            ...
            public class UsesIUsedOnConcreteTypeMethods
                : IUsedOnConcreteType,
                    IUsedOnConcreteTypeInternal
            {
                [Kept]
        ...
        public static class InterfaceWithMethodsUsedEachWay
        {
            ...
            public class UsedIUsedEveryWay
                : IUsedEveryWay,
                    IUsedEveryWayInternal,
                    IUnusedEveryWayInternal
            {
                [Kept]
            ...
            [KeptInterface(typeof(IUsedEveryWayInternal))]
            [KeptInterface(typeof(IUnusedEveryWayInternal))]
            internal class UnusedIUsedEveryWayInternal
                : IUsedEveryWay,
                    IUsedEveryWayInternal,
                    IUnusedEveryWayInternal
            {
            ...
            [Kept]
            internal static void CallTypeConstrainedMethodsInternal<T>()
                where T : IUsedEveryWayInternal
            {
                T.UsedThroughConstrainedType();
                T.UsedThroughConstrainedTypeExplicit();
            }
        ...
        public static class InterfaceMethodsKeptThroughReflection
        {
            ...
            public static void Test()
            {
                ...
                [Kept]
                static void UseMethodThroughTypeConstraint<T>()
                    where T : IMethodsKeptThroughReflection
                {
        ...
        public static class InterfaceHasStaticAndInstanceMethods
        {
            ...
            [Kept]
            internal static void CallExplicitImplMethod<T>()
            ...
            [Kept]
            internal static void CallExplicitImplMethodInternalUsed<T>()
            ...
            public class UsesAllMethods
                : IStaticAndInstanceMethods,
                    IStaticAndInstanceMethodsInternalUnused,
                    IStaticAndInstanceMethodsInternalUsed
            {
                [Kept]
        ...
        public static class StaticInterfaceInheritance
        {
            ...
            [Kept]
            public static void CallSingleInheritTypeConstrainedMethod<T>()
                where T : IInheritsFromBase
            {
                T.UsedOnConstrainedTypeExplicitImpl();
            }

            [Kept]
            internal static void CallDoubleInheritTypeConstrainedMethod<T>()
                where T : IInheritsFromMultipleBases
            {
                T.UsedOnConstrainedTypeExplicitImpl();
            }
        ...
        public static class RecursiveGenericInterface
        {
            ...
            public class ImplementsIGenericInterfaceOfSelf
                : IGenericInterface<ImplementsIGenericInterfaceOfSelf>,
                    IGenericInterfaceInternal<ImplementsIGenericInterfaceOfSelf>
            {
                [Kept]
                ...
                public static ImplementsIGenericInterfaceOfSelf GetT() =>
            ...
            [KeptInterface(typeof(IGenericInterface<ImplementsIGenericInterfaceOfSelf>))]
            [KeptInterface(typeof(IGenericInterfaceInternal<ImplementsIGenericInterfaceOfSelf>))]
            public class ImplementsIGenericInterfaceOfOther
                : IGenericInterface<ImplementsIGenericInterfaceOfSelf>,
                    IGenericInterfaceInternal<ImplementsIGenericInterfaceOfSelf>
            {
                [Kept]
            ...
            [KeptInterface(
                typeof(IGenericInterfaceInternal<ImplementsIGenericInterfaceOfSelfUnused>)
            )]
            internal class ImplementsIGenericInterfaceOfSelfUnused
                : IGenericInterface<ImplementsIGenericInterfaceOfSelfUnused>,
                    IGenericInterfaceInternal<ImplementsIGenericInterfaceOfSelfUnused>
            {
                [Kept]
                [KeptOverride(typeof(IGenericInterface<ImplementsIGenericInterfaceOfSelfUnused>))]
                public static ImplementsIGenericInterfaceOfSelfUnused GetT() =>
                    throw new NotImplementedException();
            ...
            [Kept]
            public static void CallExplicitGetT<T>()
                where T : IGenericInterface<ImplementsIGenericInterfaceOfSelf>
            {
                T.GetTExplicit();
            }
