    ...
    public class StaticAbstractInterfaceMethods
    {
        ...
        public class InterfaceHasStaticAndInstanceMethods
        {
            ...
            public static void Test()
            {
                UsesAllMethods.Test();
                UnusedMethods.Test();
                UnusedMethodsRelevantToVariantCasting.Test(
                    typeof(UnusedMethodsRelevantToVariantCasting)
                );
            }
        }
        ...
        public class StaticInterfaceInheritance
        {
            ...
            [Kept]
            public static void CallDoubleInheritTypeConstrainedMethod<T>()
        ...
        public class RecursiveGenericInterface
        {
            ...
            public class ImplementsIGenericInterfaceOfSelfUnused
