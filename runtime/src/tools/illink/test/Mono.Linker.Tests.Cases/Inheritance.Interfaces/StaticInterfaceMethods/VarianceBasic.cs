...
namespace Mono.Linker.Tests.Cases.Inheritance.Interfaces.StaticInterfaceMethods
{
    class VarianceBasic
    {
        ...
        public class TestEntrypoint
        {
            ...
            [Kept]
            public static string Test_Scenario2_1<T, ImplType>()
                where ImplType : InterfaceScenario2<T>
            {
                int x = ImplType.Method();
                return x.ToString();
            }
            ...
            [Kept]
            public static string Test_Scenario2_2<T, ImplType>()
                where ImplType : InterfaceScenario2<T>
            {
            ...
            public static int Test()
            {
                ...
                {
                    CheckForFailure(
                        "VariantDispatchToBaseTypeMethodVariantly",
                        "1",
                        TestEntrypoint.Test_Scenario<string, BaseScenario1>()
                    );
                    CheckForFailure(
                        "VariantDispatchToBaseTypeMethodFromDerivedTypeVariantly",
                        "1",
                        TestEntrypoint.Test_Scenario<string, DerivedScenario1>()
                    );
                }
                catch (Exception ex)
                {
                    CheckForFailure(
                        "VariantDispatchToBaseTypeMethod",
                        "No Exception",
                        ex.GetType().Name
                    );
                }
                ...
                {
                    CheckForFailure(
                        "NonVariantDispatchToMethodTakesPriorityOverVariantMatch",
                        "2",
                        TestEntrypoint.Test_Scenario2_1<string, BaseScenario2>()
                    );
                    CheckForFailure(
                        "NonVariantDispatchToMethodTakesPriorityOverVariantMatch",
                        "3",
                        TestEntrypoint.Test_Scenario2_1<object, BaseScenario2>()
                    );
                    CheckForFailure(
                        "NonVariantDispatchToMethodTakesPriorityOverVariantMatch",
                        "4",
                        TestEntrypoint.Test_Scenario2_2<string, BaseScenario2>()
                    );
                    CheckForFailure(
                        "NonVariantDispatchToMethodTakesPriorityOverVariantMatch",
                        "5",
                        TestEntrypoint.Test_Scenario2_2<object, BaseScenario2>()
                    );
                }
                catch (Exception ex)
                {
                ...
                {
                    CheckForFailure(
                        "VariantDispatchToMethodOnDerivedTypeOverridesExactMatchOnBaseType",
                        "6",
                        TestEntrypoint.Test_Scenario2_1<string, DerivedScenario2>()
                    );
                    CheckForFailure(
                        "VariantDispatchToMethodOnDerivedTypeOverridesExactMatchOnBaseType",
                        "6",
                        TestEntrypoint.Test_Scenario2_1<object, DerivedScenario2>()
                    );
                    CheckForFailure(
                        "VariantDispatchToMethodOnDerivedTypeOverridesExactMatchOnBaseType",
                        "7",
                        TestEntrypoint.Test_Scenario2_2<string, DerivedScenario2>()
                    );
                    CheckForFailure(
                        "VariantDispatchToMethodOnDerivedTypeOverridesExactMatchOnBaseType",
                        "7",
                        TestEntrypoint.Test_Scenario2_2<object, DerivedScenario2>()
                    );
                }
                catch (Exception ex)
                {
