...
namespace Mono.Linker.Tests.Cases.Inheritance.Interfaces.OnReferenceType
{
    ...
    class InterfaceMarkOrderingDoesNotMatter2_A
        : InterfaceMarkOrderingDoesNotMatter2_Z.A,
            InterfaceMarkOrderingDoesNotMatter2_Z.B,
            InterfaceMarkOrderingDoesNotMatter2_Z.Y,
            InterfaceMarkOrderingDoesNotMatter2_Z.Z,
            InterfaceMarkOrderingDoesNotMatter2_Z.C,
            InterfaceMarkOrderingDoesNotMatter2_Z.D,
            InterfaceMarkOrderingDoesNotMatter2_Z.Nested.F,
            InterfaceMarkOrderingDoesNotMatter2_Z.E
    {
        [Kept]
        public void AMethod() { }
    ...
    public class InterfaceMarkOrderingDoesNotMatter2
    {
        public static void Main()
        {
            ...
            InterfaceMarkOrderingDoesNotMatter2_A mUsedInCode =
                new InterfaceMarkOrderingDoesNotMatter2_A();
