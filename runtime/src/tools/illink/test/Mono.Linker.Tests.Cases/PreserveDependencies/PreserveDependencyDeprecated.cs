...
namespace Mono.Linker.Tests.Cases.PreserveDependencies
{
    [TestCaseRequirements(
        ...
        "This test checks that PreserveDependency correctly issues a warning on .NET Core where it is deprecated."
    )]
    [SetupCompileBefore(
    ...
    class PreserveDependencyDeprecated
    {
        ...
        class B
        {
            ...
            [PreserveDependency(
                ...
                "Mono.Linker.Tests.Cases.PreserveDependencies.D"
            )]
            ...
            [PreserveDependency(
                "NextOne (Mono.Linker.Tests.Cases.PreserveDependencies.PreserveDependencyDeprecated+Nested&)",
                "Mono.Linker.Tests.Cases.PreserveDependencies.PreserveDependencyDeprecated+Nested"
            )]
            [PreserveDependency(
                ".cctor()",
                "Mono.Linker.Tests.Cases.PreserveDependencies.PreserveDependencyDeprecated+Nested"
            ...
            [PreserveDependency(
                ".ctor()",
                "Mono.Linker.Tests.Cases.PreserveDependencies.PreserveDependencyDeprecated+NestedStruct"
            )]
