...
[assembly: DebuggerDisplay(
    "{Property}",
    TargetTypeName = "Mono.Linker.Tests.Cases.Attributes.Debugger.Dependencies.DebuggerDisplayAttributeOnAssemblyUsingTargetTypeNameInOtherAssembly_Lib+GenericType`1, library"
)]
...
namespace Mono.Linker.Tests.Cases.Attributes.Debugger.KeepDebugMembers
{
    ...
    [SetupCompileBefore(
        ...
        new[]
        {
            "../Dependencies/DebuggerDisplayAttributeOnAssemblyUsingTargetTypeNameInOtherAssembly_Lib.cs",
        }
    )]
    ...
    [KeptMemberInAssembly(
        "library.dll",
        typeof(DebuggerDisplayAttributeOnAssemblyUsingTargetTypeNameInOtherAssembly_Lib.GenericType<>),
        "get_PropertyOnGenericType()"
    )]
    [KeptMemberInAssembly(
        "library.dll",
        typeof(DebuggerDisplayAttributeOnAssemblyUsingTargetTypeNameInOtherAssembly_Lib.GenericType<>),
        "set_PropertyOnGenericType(T)"
    )]
