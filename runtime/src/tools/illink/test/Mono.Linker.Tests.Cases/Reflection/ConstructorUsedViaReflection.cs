...
namespace Mono.Linker.Tests.Cases.Reflection
{
    ...
    public class ConstructorUsedViaReflection
    {
        ...
        private class GetConstructor_Types
        {
            ...
            {
                var constructor = typeof(GetConstructor_Types).GetConstructor(
                    new Type[] { typeof(int) }
                );
        ...
        class GetConstructor_BindingAttr_Binder_Types_Modifiers
        {
            ...
            {
                var constructor = typeof(KnownBindingFlags).GetConstructor(
                    BindingFlags.Public,
                    GetNullValue("some argument", 2, 3),
                    new Type[] { },
            ...
            public static void TestWithUnknownBindingFlags(BindingFlags bindingFlags)
            {
                ...
                var constructor = typeof(UnknownBindingFlags).GetConstructor(
                    bindingFlags,
                    GetNullValue("some argument", 2, 3),
                    new Type[] { },
                    new ParameterModifier[] { }
        ...
        class GetConstructor_BindingAttr_Binder_CallConvention_Types_Modifiers
        {
            ...
            protected GetConstructor_BindingAttr_Binder_CallConvention_Types_Modifiers(
                int foo,
                int bar
            ) { }

            internal GetConstructor_BindingAttr_Binder_CallConvention_Types_Modifiers(
                int foo,
                int bar,
                int baz
            ) { }
            ...
            {
                var constructor =
                    typeof(GetConstructor_BindingAttr_Binder_CallConvention_Types_Modifiers).GetConstructor(
                        BindingFlags.Public,
                        GetNullValue("some argument", 2, 3),
        ...
        class GetConstructor_BindingAttr_Types
        {
            ...
            {
                var constructor = typeof(GetConstructor_BindingAttr_Types).GetConstructor(
                    BindingFlags.Public,
                    new Type[] { }
                );
                constructor.Invoke(null, new object[] { });
            ...
            {
                var constructor = typeof(NonEmptyTypes).GetConstructor(
                    BindingFlags.Public,
                    new Type[] { typeof(TestType) }
                );
                constructor.Invoke(null, new object[] { null });
            }
        ...
        class IfElse
        {
            ...
            public static void TestIfElse(bool decision)
            {
                ...
                var constructor = myType.GetConstructor(
                    BindingFlags.Public,
                    null,
                    new Type[] { },
                    null
