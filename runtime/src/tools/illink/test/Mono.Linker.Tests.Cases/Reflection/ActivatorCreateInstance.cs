...
namespace Mono.Linker.Tests.Cases.Reflection
{
    ...
    public class ActivatorCreateInstance
    {
        public static void Main()
        {
            ...
            Type fromParameterOnStaticMethodType =
                p == null
            ...
            FromParameterWithNonPublicConstructors(
                typeof(FromParameterWithNonPublicConstructorsType)
            );
        ...
        [ExpectedWarning(
            "IL2067",
            nameof(Activator) + "." + nameof(Activator.CreateInstance) + "(Type, Object[])",
            ProducedBy = Tool.Trimmer
        )]
        [ExpectedWarning(
            "IL2067",
            nameof(Activator) + "." + nameof(Activator.CreateInstance) + "(Type, params Object[])",
            ProducedBy = Tool.Analyzer
        )]
        [ExpectedWarning(
            "IL2067",
            nameof(Activator) + "." + nameof(Activator.CreateInstance),
            nameof(CultureInfo)
        )]
        [Kept]
        ...
        [ExpectedWarning(
            "IL2067",
            nameof(Activator) + "." + nameof(Activator.CreateInstance) + "(Type)"
        )]
        // Small formatting difference
        [ExpectedWarning(
            "IL2067",
        ...
        private static void WithAssemblyName()
        {
            Activator.CreateInstance(
                "test",
                "Mono.Linker.Tests.Cases.Reflection.ActivatorCreateInstance+WithAssemblyNameParameterless1"
            );
            Activator.CreateInstance(
                "test",
                "Mono.Linker.Tests.Cases.Reflection.ActivatorCreateInstance+WithAssemblyNameParameterless2",
                new object[] { }
            );
            Activator.CreateInstance(
                "test",
                "Mono.Linker.Tests.Cases.Reflection.ActivatorCreateInstance+WithAssemblyNamePublicOnly",
                false,
                BindingFlags.Public,
                null,
                new object[] { },
            ...
            Activator.CreateInstance(
                "test",
                "Mono.Linker.Tests.Cases.Reflection.ActivatorCreateInstance+WithAssemblyNamePrivateOnly",
                false,
                BindingFlags.NonPublic,
                null,
                new object[] { },
        ...
        private static void WithAssemblyPath()
        {
            Activator.CreateInstanceFrom(
                "test",
                "Mono.Linker.Tests.Cases.Reflection.ActivatorCreateInstance+WithAssemblyPathParameterless"
            );
        ...
        [ExpectedWarning(
            "IL2058",
            nameof(Assembly) + "." + nameof(Assembly.CreateInstance) + "(String)"
        )]
        [ExpectedWarning(
            "IL2058",
            nameof(Assembly) + "." + nameof(Assembly.CreateInstance) + "(String, Boolean)"
        )]
        [ExpectedWarning(
            "IL2058",
            nameof(Assembly) + "." + nameof(Assembly.CreateInstance),
            nameof(BindingFlags)
        )]
