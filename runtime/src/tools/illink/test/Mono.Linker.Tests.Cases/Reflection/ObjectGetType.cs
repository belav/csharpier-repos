    ...
    public class ObjectGetType
    {
        ...
        class BasicAnnotationWithNoDerivedClasses
        {
            ...
            static void TestInterface(
                ClassImplementingAnnotatedInterface classImplementingInterface
            )
            {
        ...
        class SingleDerivedWithAnnotatedParent
        {
            ...
            class HierarchyAnnotatedParentClassChild : HierarchyAnnotatedParentClass
            {
                ...
                [Kept]
                public static HierarchyAnnotatedParentClassChild Instance() =>
                    new HierarchyAnnotatedParentClassChild();
            }
        ...
        class DerivedWithBaseAndAnnotatedInterface
        {
            ...
            class HierarchyAnnotatedParentInterfaceChild : HierarchyAnnotatedParentInterfaceParent
            {
                ...
                [Kept]
                public static HierarchyAnnotatedParentInterfaceChild Instance() =>
                    new HierarchyAnnotatedParentInterfaceChild();
            }
        ...
        class AllAnnotationsAreApplied
        {
            ...
            class ImplementationClass
                : IMethodsAnnotatedInterface,
                    IPropertiesAnnotatedInterface,
                    IEventsAnnotatedInterface
            {
                [Kept]
        ...
        class SealedWithAnnotation
        {
            ...
            public static void Test()
            {
                ...
                GetInstance()
                    .GetType()
                    .GetMethod("PrivateMethod", System.Reflection.BindingFlags.NonPublic);
            }
        }
        ...
        class DiamondShapeWithAnnotatedInterface
        {
            ...
            [KeptInterface(typeof(IAnnotatedCommon))]
            [KeptMember(".ctor()")]
            class DerivedAndImplementsSameInterface
        ...
        class ApplyingAnnotationIntroducesTypesToApplyAnnotationToMultipleAnnotations
        {
            ...
            {
                [Kept]
                public AnotherMethodsDerived PublicMethod()
                {
                    return null;
                }
            ...
            {
                [Kept]
                public static AnotherPropertiesDerived PublicProperty
                {
                    [Kept]
                    get => null;
                }

                private static UnusedType PrivateProperty
                {
                    get => null;
                }
            }
            ...
            {
                [Kept]
                public static UsedType PublicProperty
                {
                    [Kept]
                    get => null;
                }
        ...
        class ApplyingAnnotationIntroducesTypesToApplyAnnotationToEntireType
        {
            ...
            class Derived : AnnotatedBase
            {
                ...
                [Kept]
                public AnotherAnnotatedType PublicProperty
                {
                    [Kept]
                    get => null;
                }
        ...
        class EnumerationOverInstances
        {
            ...
            [Kept]
            static IEnumerable<AnnotatedBase> GetInstances() =>
                new AnnotatedBase[] { new Derived() };
