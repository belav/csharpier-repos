    ...
    public class ParametersUsedViaReflection
    {
        ...
        static void TestClassParameters()
        {
            var type = Type.GetType(
                "Mono.Linker.Tests.Cases.Reflection.ParametersUsedViaReflection+GenericClass1`1"
            );
        ...
        class GetMethod_Name
        {
            ...
            [Kept]
            public static void CalledDirectly2< /*[RemovedNameValue]*/
                LongGenericName>([RemovedNameValue] int firstArg) { }
        ...
        [Kept]
        public class GenericClass2< /*[RemovedNameValue]*/
            TRKey>
        {
            [Kept]
