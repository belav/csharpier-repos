...
namespace Mono.Linker.Tests.Cases.Reflection
{
    ...
    public class TypeHierarchyReflectionWarnings
    {
        public static void Main()
        {
            ...
            annotatedPublicParameterlessConstructor
                .GetType()
                .RequiresPublicParameterlessConstructor();
        ...
        class AnnotatedPublicMethods
        {
            ...
            [return: DynamicallyAccessedMembersAttribute(
            ...
            [ExpectedWarning(
                "IL2114",
                nameof(AnnotatedPublicMethods),
                nameof(DAMReturnVirtualMethod)
            )]
            [return: KeptAttributeAttribute(typeof(DynamicallyAccessedMembersAttribute))]
            [return: DynamicallyAccessedMembersAttribute(
                DynamicallyAccessedMemberTypes.PublicMethods
        ...
        class AnnotatedPublicProperties
        {
            ...
            public static string DAMProperty
            {
                ...
                [ExpectedWarning(
                    "IL2114",
                    nameof(AnnotatedPublicProperties),
                    nameof(DAMProperty) + ".set"
                )]
                set;
            }
        }
        ...
        [ExpectedWarning("IL2113", "--RUC on AnnotatedPublicParameterlessConstructor()--")]
        class DerivedFromAnnotatedPublicParameterlessConstructor
            : AnnotatedPublicParameterlessConstructor
        {
            [Kept]
            [KeptAttributeAttribute(typeof(RequiresUnreferencedCodeAttribute))]
            [ExpectedWarning(
                "IL2112",
                "--RUC on DerivedFromAnnotatedPublicParameterlessConstructor()--"
            )]
            [ExpectedWarning(
                "IL2112",
                "--RUC on DerivedFromAnnotatedPublicParameterlessConstructor()--",
            ...
            [ExpectedWarning(
                "IL2112",
                "--RUC on DerivedFromAnnotatedPublicParameterlessConstructor(int)--"
            )]
            [RequiresUnreferencedCode(
                "--RUC on DerivedFromAnnotatedPublicParameterlessConstructor(int)--"
            )]
        ...
        class AnnotatedDerivedFromAnnotatedBase : AnnotatedBase
        {
            ...
            [ExpectedWarning(
                "IL2114",
                nameof(AnnotatedDerivedFromAnnotatedBase),
                nameof(DAMField2)
            )]
            [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.NonPublicMethods)]
        ...
        class AnnotatedDerivedFromBase : Base
        {
            ...
            public override string DAMVirtualProperty
            {
                ...
                [ExpectedWarning(
                    "IL2114",
                    nameof(AnnotatedDerivedFromBase),
                    nameof(DAMVirtualProperty)
                )]
                get;
            }
        }
        ...
        class DerivedFromAnnotatedDerivedFromBase : AnnotatedDerivedFromBase
        {
            ...
            [ExpectedWarning(
                "IL2114",
                nameof(DerivedFromAnnotatedDerivedFromBase),
                nameof(DAMField3)
            )]
            [KeptAttributeAttribute(typeof(DynamicallyAccessedMembersAttribute))]
            [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.NonPublicMethods)]
        ...
        [ExpectedWarning(
            "IL2113",
            nameof(BaseTypeOfNestedType),
            nameof(BaseTypeOfNestedType.RUCMethod)
        )]
        class AnnotatedPublicNestedTypes
        {
            ...
            [ExpectedWarning(
                "IL2112",
                nameof(NestedRUCTypeWithDefaultConstructor) + "()",
        ...
        class RUCOnNewSlotVirtualMethodDerivedAnnotated
        {
            ...
            public class Base
            {
                ...
                [KeptAttributeAttribute(typeof(RequiresUnreferencedCodeAttribute))]
                [RequiresUnreferencedCode(
                    "--RUCOnVirtualMethodDerivedAnnotated.Base.RUCVirtualMethod--"
                )]
                public virtual void RUCVirtualMethod() { }
            }
            ...
            public class Derived : Base
            {
                ...
                [KeptAttributeAttribute(typeof(RequiresUnreferencedCodeAttribute))]
                [RequiresUnreferencedCode(
                    "--RUCOnVirtualMethodDerivedAnnotated.Derived.RUCVirtualMethod--"
                )]
                [ExpectedWarning(
                    "IL2112",
                    "--RUCOnVirtualMethodDerivedAnnotated.Derived.RUCVirtualMethod--"
        ...
        class CompilerGeneratedBackingField
        {
            ...
            [ExpectedWarning(
                ...
                nameof(BaseWithField.CompilerGeneratedProperty)
            )]
        ...
        class CompilerGeneratedCodeRUC
        {
            ...
            {
                Action<Type> a = [RequiresUnreferencedCode("LambdaWithRUC")]
                (Type type) =>
                {
                    type.GetMethods();
                };
        ...
        class CompilerGeneratedCodeDAM
        {
            ...
            [ExpectedWarning(
                "IL2119",
                nameof(AsyncIteratorWithGenericDAM),
                CompilerGeneratedCode = true,
                ProducedBy = Tool.Trimmer
            )]
