...
// Disable warning about ambigous types - trimming tools only looks at names, not definition
// assemblies
...
namespace System
{
    public class Type
    {
        ...
        ) => GetConstructor(bindingAttr, binder, CallingConventions.Any, types, modifiers);
