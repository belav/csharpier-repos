...
namespace Mono.Linker.Tests.Cases.Reflection
{
    ...
    public class MethodUsedViaReflection
    {
        ...
        class GetMethod_Name_BindingAttr
        {
            ...
            {
                var method = typeof(GetMethod_Name_BindingAttr).GetMethod(
                    "OnlyCalledViaReflection",
            ...
            public static void TestUnknownBindingFlags(BindingFlags bindingFlags)
            {
                ...
                var method = typeof(UnknownBindingFlags).GetMethod(
                    "OnlyCalledViaReflection",
                    bindingFlags
                );
                method.Invoke(null, new object[] { });
            ...
            [Kept]
            public static void TestUnknownBindingFlagsAndName(
        ...
        class GetMethod_Name_BindingAttr_Binder_Types_Modifiers
        {
            ...
            {
                var method = typeof(GetMethod_Name_BindingAttr_Binder_Types_Modifiers).GetMethod(
                    "OnlyCalledViaReflection",
                    BindingFlags.Public,
                    null,
                    new Type[] { },
        ...
        class GetMethod_Name_BindingAttr_Binder_CallConvention_Types_Modifiers
        {
            ...
            {
                var method =
                    typeof(GetMethod_Name_BindingAttr_Binder_CallConvention_Types_Modifiers).GetMethod(
                        "OnlyCalledViaReflection",
        ...
        class GetMethod_Name_BindingAttr_Types
        {
            ...
            {
                var method = typeof(GetMethod_Name_BindingAttr_Types).GetMethod(
                    "OnlyCalledViaReflection",
                    BindingFlags.Public,
                    new Type[] { }
                );
        ...
        class GetMethod_Name_GenericParameterCount_Types
        {
            ...
            {
                var method = typeof(GetMethod_Name_GenericParameterCount_Types).GetMethod(
                    "OnlyCalledViaReflection",
                    1,
                    new Type[] { typeof(int) }
                );
        ...
        class GetMethod_Name_GenericParameterCount_Types_Modifiers
        {
            ...
            {
                var method = typeof(GetMethod_Name_GenericParameterCount_Types_Modifiers).GetMethod(
                    "OnlyCalledViaReflection",
                    1,
                    new Type[] { typeof(int) },
                    null
        ...
        class GetMethod_Name_GenericParameterCount_BindingAttr_Binder_Types_Modifiers
        {
            ...
            {
                var method =
                    typeof(GetMethod_Name_GenericParameterCount_BindingAttr_Binder_Types_Modifiers).GetMethod(
                        "OnlyCalledViaReflection",
                        1,
                        BindingFlags.Public,
                        null,
        ...
        class GetMethod_Name_GenericParameterCount_BindingAttr_Binder_Types_Modifiers_PrivateBinding
        {
            ...
            {
                var method =
                    typeof(GetMethod_Name_GenericParameterCount_BindingAttr_Binder_Types_Modifiers_PrivateBinding).GetMethod(
                        "OnlyCalledViaReflection",
                        1,
                        BindingFlags.NonPublic,
                        null,
        ...
        class GetMethod_Name_GenericParameterCount_BindingAttr_Binder_CallConvention_Types_Modifiers
        {
            ...
            {
                var method =
                    typeof(GetMethod_Name_GenericParameterCount_BindingAttr_Binder_CallConvention_Types_Modifiers).GetMethod(
                        "OnlyCalledViaReflection",
                        1,
        ...
        class IgnoreCaseBindingFlags
        {
            ...
            {
                var method = typeof(IgnoreCaseBindingFlags).GetMethod(
                    "onlycalledviareflection",
        ...
        class FailIgnoreCaseBindingFlags
        {
            ...
            {
                var method = typeof(FailIgnoreCaseBindingFlags).GetMethod(
                    "onlycalledviareflection",
                    BindingFlags.Public
                );
                method.Invoke(null, new object[] { });
        ...
        class IgnorableBindingFlags
        {
            ...
            {
                var method = typeof(IgnorableBindingFlags).GetMethod(
                    "OnlyCalledViaReflection",
        ...
        class UnsupportedBindingFlags
        {
            ...
            {
                var method = typeof(UnsupportedBindingFlags).GetMethod(
                    "OnlyCalledViaReflection",
