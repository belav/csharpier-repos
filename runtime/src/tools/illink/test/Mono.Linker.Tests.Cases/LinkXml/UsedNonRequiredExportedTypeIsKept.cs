...
namespace Mono.Linker.Tests.Cases.LinkXml
{
    ...
    [SetupCompileBefore(
        "libfwd.dll",
        new[] { "Dependencies/UsedNonRequiredExportedTypeIsKept_lib.cs" }
    )]
    [SetupCompileAfter(
        "lib.dll",
        new[] { "Dependencies/UsedNonRequiredExportedTypeIsKept_lib.cs" }
    ...
    [SetupCompileAfter(
        "libfwd.dll",
        new[] { "Dependencies/UsedNonRequiredExportedTypeIsKept_fwd.cs" },
        references: new[] { "lib.dll" }
    )]
    ...
    [KeptMemberInAssembly(
        "libfwd.dll",
        typeof(UsedNonRequiredExportedTypeIsKept_Used2),
        "Method()"
    )]
    [KeptMemberInAssembly(
        "libfwd.dll",
