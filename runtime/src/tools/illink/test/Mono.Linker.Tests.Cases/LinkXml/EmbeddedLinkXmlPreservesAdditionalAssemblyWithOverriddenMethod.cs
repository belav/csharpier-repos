...
namespace Mono.Linker.Tests.Cases.LinkXml
{
    [SetupCompileBefore(
        ...
        new[]
        {
            "Dependencies/EmbeddedLinkXmlPreservesAdditionalAssemblyWithOverriddenMethod/Base.cs",
        }
    )]
    [SetupCompileBefore(
        "Library1.dll",
        new[]
        {
            "Dependencies/EmbeddedLinkXmlPreservesAdditionalAssemblyWithOverriddenMethod/Library1.cs",
        },
        new[] { "Base.dll" },
        resources: new object[]
        {
            "Dependencies/EmbeddedLinkXmlPreservesAdditionalAssemblyWithOverriddenMethod/Library1.xml",
        }
    )]
    [SetupCompileBefore(
        "Library2.dll",
        new[]
        {
            "Dependencies/EmbeddedLinkXmlPreservesAdditionalAssemblyWithOverriddenMethod/Library2.cs",
        },
        new[] { "Base.dll" },
    ...
    [KeptMemberInAssembly(
        "Library2.dll",
        "Mono.Linker.Tests.Cases.LinkXml.Dependencies.EmbeddedLinkXmlPreservesAdditionalAssemblyWithOverriddenMethod.Library2",
        "VirtualMethodFromBase()"
    )]
