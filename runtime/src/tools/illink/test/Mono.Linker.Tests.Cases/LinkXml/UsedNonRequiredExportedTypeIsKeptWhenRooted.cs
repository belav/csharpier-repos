...
{
    [IgnoreTestCase(
        "NativeAOT doesn't implement 'visible' rooting behavior",
    ...
    [SetupCompileBefore(
        "libfwd.dll",
        new[] { "Dependencies/UsedNonRequiredExportedTypeIsKeptWhenRooted_lib.cs" }
    )]
    [SetupCompileAfter(
        "lib.dll",
        new[] { "Dependencies/UsedNonRequiredExportedTypeIsKeptWhenRooted_lib.cs" }
    ...
    [SetupCompileAfter(
        "libfwd.dll",
        new[] { "Dependencies/UsedNonRequiredExportedTypeIsKeptWhenRooted_fwd.cs" },
    ...
    [KeptMemberInAssembly(
        "lib.dll",
        typeof(UsedNonRequiredExportedTypeIsKeptWhenRooted_Used),
        "field",
        ExpectationAssemblyName = "libfwd.dll"
    )]
    [KeptMemberInAssembly(
        "lib.dll",
        typeof(UsedNonRequiredExportedTypeIsKeptWhenRooted_Used),
