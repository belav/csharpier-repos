...
[module: UnconditionalSuppressMessage(
    "Test",
    "IL2072:Suppress unrecognized reflection pattern warnings in this module"
)]
[module: UnconditionalSuppressMessage(
    "Test",
    "IL2026:Test that specifying an invalid scope will result in a global suppression being ignored.",
    Scope = "invalidScope",
...
namespace Mono.Linker.Tests.Cases.Warnings.WarningSuppression
{
    ...
    [LogContains(
        "warning IL2108:.*Invalid scope 'invalidScope' used in 'UnconditionalSuppressMessageAttribute'",
        regexMatch: true
    )]
    public class SuppressWarningsInModule
    {
        ...
        [RequiresUnreferencedCode(
            "Test that the global unconditional suppression will not work when using an invalid scope."
        )]
