...
namespace Mono.Linker.Tests.Cases.Warnings.WarningSuppression
{
    ...
    public class SuppressWarningsInMembersAndTypes
    {
        ...
        [UnconditionalSuppressMessage(
            "Test",
            "IL2072:Suppress UnrecognizedReflectionPattern warnings on a nested type"
        )]
    ...
    public class SuppressWarningsInMembers
    {
        ...
        [UnconditionalSuppressMessage(
            "Test",
            "IL2072:Suppression with scope value equal to null",
            Scope = null,
            Target = null,
            MessageId = null
        )]
    ...
    {
        [LogDoesNotContain(
            nameof(TypeWithSuppression) + " has more than one unconditional suppression"
        )]
