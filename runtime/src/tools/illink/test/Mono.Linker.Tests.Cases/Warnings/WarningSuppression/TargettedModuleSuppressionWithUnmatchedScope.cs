...
[module: UnconditionalSuppressMessage(
    ...
    "IL2072",
    Scope = "module",
    Target = "T:Mono.Linker.Tests.Cases.Warnings.WarningSuppression.TargettedModuleSuppressionWithUnmatchedScope"
)]
[module: UnconditionalSuppressMessage(
    "Test",
    "IL2026",
...
namespace Mono.Linker.Tests.Cases.Warnings.WarningSuppression
{
    ...
    [LogContains(
        "warning IL2108:.*Invalid scope '' used in 'UnconditionalSuppressMessageAttribute'",
        regexMatch: true
    )]
