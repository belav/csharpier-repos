...
namespace Mono.Linker.Tests.Cases.Warnings.WarningSuppression
{
    ...
    public class DetectRedundantSuppressionsInMembersAndTypes
    {
        ...
        public class RedundantSuppressionOnProperty
        {
            ...
            {
                get { return TrimmerCompatibleMethod(); }
                set { value = TrimmerCompatibleMethod(); }
            }
        }
        ...
        public class RedundantSuppressionOnPropertyAccessedByReflection
        {
            public static void Test()
            {
                typeof(RedundantSuppressionOnPropertyAccessedByReflection).GetProperty(
                    "TrimmerCompatibleProperty"
                );
            }
        ...
        public class RedundantSuppressionOnEventAccessedByReflection
        {
            public static void Test()
            {
                typeof(RedundantSuppressionOnEventAccessedByReflection).GetEvent(
                    "TrimmerCompatibleEvent"
                );
            }
