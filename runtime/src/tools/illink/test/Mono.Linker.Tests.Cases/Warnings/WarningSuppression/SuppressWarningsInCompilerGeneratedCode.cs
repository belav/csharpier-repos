    ...
    public class SuppressWarningsInCompilerGeneratedCode
    {
        ...
        class SuppressInLocalFunction
        {
            ...
            [UnconditionalSuppressMessage(
                "Test",
                "IL2121",
                Justification = "The IL2026 warning is issued only by the analyzer, for the ILLink this suppression is redundant."
            )]
            [UnconditionalSuppressMessage("Test", "IL2026")]
        ...
        class SuppressInLambda
        {
            ...
            class DynamicallyAccessedLambda
            {
                [ExpectedWarning(
                    "IL2118",
                    nameof(TestCallRUCMethodInDynamicallyAccessedLambda),
            ...
            class TestSuppressionOnOuterWithSameName
            {
                ...
                static void Outer(int i)
                {
                    var lambda = [ExpectedWarning("IL2026", "--RequiresUnreferencedCodeMethod--")]
                    () => RequiresUnreferencedCodeMethod();
        ...
        class SuppressInComplex
        {
            ...
            {
                TestEvent += [UnconditionalSuppressMessage("Test", "IL2026")]
                (sender, args) =>
                {
                    LocalFunction();
