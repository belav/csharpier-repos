...
namespace Mono.Linker.Tests.Cases.UnreachableBlock
{
    ...
    {
        [Kept]
        MethodWithParametersSubstitutions() { }
        ...
        [Kept]
        static void MethodWithValueParam_Reached() { }
        ...
        [Kept]
        static void MethodWithReferenceParam_Reached() { }

        static void MethodWithReferenceParam_NeverReached() { }

        [Kept]
        [ExpectedInstructionSequence(new[] { "nop", "nop", "ldc.i4.1", "pop", "ldc.i4.1", "ret" })]
            ...
            if (
                StaticMethod(
                    ...
                    new int[]
                    {
                        ...
                        arg++,
                        value = arg,
                        int.Parse(new TestStruct().ToString()),
                        ovalue ?? arg,
                    }
                )
            )
        ...
        [Kept]
        static void TestMethodWithComplexParams_3_Used() { }
        ...
        [Kept]
        static void TestMethodWithComplexParams_4_Used() { }

        [Kept]
        static void TestMethodWithComplexParams_4_Unused() { }
        ...
        bool TestMethodWithComplexParams_5_Propagate() =>
            _TestMethodWithComplexParameters_5_field?.TestMethodWithComplexParams_5_Substituted()
            ?? false;
        ...
        [Kept]
        [ExpectBodyModified]
        bool IsEnabledWithMultipleInParamsInstance(
            int p1,
            string p2,
            TestClass p3,
            TestStruct p4,
        ...
        {
            if (
                IsEnabledWithMultipleInParamsInstance(
                    0,
                    "",
                    new TestClass(),
                    new TestStruct(),
        ...
        [Kept]
        void MethodWithMultipleInParamsInstance_Reached() { }
        ...
        [Kept]
        static void MethodWithRefParam_Reached1() { }
        ...
        [Kept]
        static void MethodWithMultipleRefParams_Reached1() { }
        ...
        [Kept]
        static void MethodWithValueParamAndConstReturn_NoSubstitutions_Reached1() { }
        ...
        [Kept]
        static void MethodWithVarArgs_Reached1() { }

        [Kept]
        static void MethodWithVarArgs_Reached2() { }
        ...
        [Kept]
        static void MethodWithParamAndVarArgs_Reached1() { }

        [Kept]
        static void MethodWithParamAndVarArgs_Reached2() { }
