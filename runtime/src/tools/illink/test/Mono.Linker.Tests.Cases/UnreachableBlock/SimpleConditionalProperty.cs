...
namespace Mono.Linker.Tests.Cases.UnreachableBlock
{
    ...
    public class SimpleConditionalProperty
    {
        ...
        [ExpectedInstructionSequence(
            new[] { "ldc.i4.3", "ldc.i4.5", "ble.s il_4", "ldc.i4.0", "ret" }
        )]
        ...
        [Kept]
        [ExpectedInstructionSequence(new[] { "ldc.i4.0", "ldc.i4.0", "beq.s il_4", "ret" })]
        ...
        [Kept]
        [ExpectedInstructionSequence(new[] { "ldnull", "brfalse.s il_3", "ret" })]
