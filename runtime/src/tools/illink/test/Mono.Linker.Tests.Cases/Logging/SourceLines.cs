...
namespace Mono.Linker.Tests.Cases.Logging
{
    ...
    public class SourceLines
    {
        ...
        [ExpectedWarning(
            "IL2074",
            nameof(SourceLines) + "." + nameof(type),
            nameof(SourceLines) + "." + nameof(GetUnknownType) + "()",
        ...
        [ExpectedWarning("IL2091", "LocalFunction()", ProducedBy = Tool.Analyzer)]
        [ExpectedWarning(
            "IL2089",
            nameof(SourceLines) + "." + nameof(type),
            "TOuterMethod",
        ...
        static IEnumerable<int> GenericMethodIteratorWithRequirement<
            [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicMethods)] TOuterMethod
        >()
        {
            LocalFunction();
            yield return 1;
