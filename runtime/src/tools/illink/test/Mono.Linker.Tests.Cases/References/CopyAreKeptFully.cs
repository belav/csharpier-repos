...
namespace Mono.Linker.Tests.Cases.References
{
    ...
    [SetupCompileBefore(
        "unusedlibraryfromcopy.dll",
        new[] { "Dependencies/UnusedReferencedFromCopyAssembly.cs" }
    )]
    [KeptAllTypesAndMembersInAssembly("unusedlibraryfromcopy.dll")]
    // Unused assembly references are kept
    [SetupCompileBefore(
        "unusedlibrary.dll",
        new[] { "Dependencies/UnusedReferencedAssembly.cs" },
        references: new[] { "unusedlibraryfromcopy.dll" }
    )]
    [KeptAllTypesAndMembersInAssembly("unusedlibrary.dll")]
    // Unused dynamic references from copy assembly are kept
    [SetupCompileBefore(
        "unuseddynamiclibraryfromcopy.dll",
        new[] { "Dependencies/UnusedDynamicallyReferencedFromCopyAssembly.cs" }
    )]
    [KeptAllTypesAndMembersInAssembly("unuseddynamiclibraryfromcopy.dll")]
    // Unused references from dynamic copy assembly are kept
    [SetupCompileBefore(
        "unusedlibraryfromdynamiccopy.dll",
        new[] { "Dependencies/UnusedReferencedFromDynamicCopyAssembly.cs" }
    )]
    [KeptAllTypesAndMembersInAssembly("unusedlibraryfromdynamiccopy.dll")]
    // Used dynamic references are kept
    [SetupCompileBefore(
        "useddynamiclibrary.dll",
        new[] { "Dependencies/UsedDynamicallyReferencedAssembly.cs" },
        references: new[] { "unusedlibraryfromdynamiccopy.dll" }
    )]
    [KeptAllTypesAndMembersInAssembly("useddynamiclibrary.dll")]
    // Unused dynamic references from dynamic copy assembly are kept
    [SetupCompileBefore(
        "unuseddynamiclibraryfromdynamiccopy.dll",
        new[] { "Dependencies/UnusedDynamicallyReferencedFromDynamicCopyAssembly.cs" }
    )]
    ...
    [SetupCompileBefore(
        "unuseddynamiclibrary.dll",
        new[] { "Dependencies/UnusedDynamicallyReferencedAssembly.cs" }
    )]
    [KeptAllTypesAndMembersInAssembly("unuseddynamiclibrary.dll")]
    // Unreferenced libraries are kept (due to copy default action)
    [SetupCompileBefore(
        "unreferencedlibrary.dll",
        new[] { "Dependencies/UnreferencedAssembly.cs" }
    )]
    ...
    class CopyAreKeptFully
    {
        ...
        public static void Used()
        {
            ...
            var _2 = Type.GetType(
                "Mono.Linker.Tests.Cases.References.Dependencies.UsedDynamicallyReferencedAssembly, useddynamiclibrary"
            );
        }
        ...
        public static void Unused()
        {
            ...
            var _2 = Type.GetType(
                "Mono.Linker.Tests.Cases.References.Dependencies.UnusedDynamicallyReferencedAssembly, unuseddynamiclibrary"
            );
        }
    }
}
