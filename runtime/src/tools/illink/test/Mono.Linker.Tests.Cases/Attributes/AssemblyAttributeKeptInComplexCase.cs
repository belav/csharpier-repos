...
[assembly: KeptAttributeAttribute(
    typeof(AssemblyAttributeKeptInComplexCase_Lib.OtherAssemblyAttribute)
)]
...
namespace Mono.Linker.Tests.Cases.Attributes
{
    [SetupCompileBefore(
        "library2.dll",
        new[] { "Dependencies/AssemblyAttributeKeptInComplexCase_Lib.cs" }
    )]
    ...
    [KeptMemberInAssembly(
        "library2.dll",
        typeof(AssemblyAttributeKeptInComplexCase_Lib),
        "MethodThatWillBeUsed()"
    )]
