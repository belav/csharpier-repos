...
namespace Mono.Linker.Tests.Cases.Attributes.OnlyKeepUsed
{
    ...
    [SetupCompileBefore(
        "library.dll",
        new[] { "Dependencies/UnusedAttributeWithTypeForwarderIsRemoved_Lib.cs" }
    )]
    [SetupCompileAfter(
        "implementation.dll",
        new[] { "Dependencies/UnusedAttributeWithTypeForwarderIsRemoved_Lib.cs" }
    ...
    [SetupCompileAfter(
        "library.dll",
        new[] { "Dependencies/UnusedAttributeWithTypeForwarderIsRemoved_Forwarder.cs" },
        new[] { "implementation.dll" }
    )]
