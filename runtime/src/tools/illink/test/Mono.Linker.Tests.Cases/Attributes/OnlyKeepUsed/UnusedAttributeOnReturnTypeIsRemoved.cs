...
namespace Mono.Linker.Tests.Cases.Attributes.OnlyKeepUsed
{
    ...
    [SetupCompileBefore(
        "library.dll",
        new[] { "Dependencies/AssemblyWithUnusedAttributeOnReturnParameterDefinition.il" }
    )]
    [RemovedTypeInAssembly(
        "library.dll",
        "Mono.Linker.Tests.Cases.Attributes.OnlyKeepUsed.Dependencies.AssemblyWithUnusedAttributeOnReturnParameterDefinition/FooAttribute"
    )]
    [RemovedTypeInAssembly(
        "library.dll",
        "Mono.Linker.Tests.Cases.Attributes.OnlyKeepUsed.Dependencies.BarAttribute"
    )]
