...
namespace Mono.Linker.Tests.Cases.Attributes
{
    ...
    [SetupCompileBefore(
        "impl.dll",
        new[] { "Dependencies/IReferencedAssemblyImpl.cs" },
        references: new[] { "interface.dll" },
        addAsReference: false
    )]
    [KeptMemberInAssembly("interface.dll", typeof(IReferencedAssembly), "Foo()")]
    [KeptMemberInAssembly(
        "impl",
        "Mono.Linker.Tests.Cases.Attributes.Dependencies.IReferencedAssemblyImpl",
        "Foo()"
    )]
    [KeptInterfaceOnTypeInAssembly(
        ...
        "Mono.Linker.Tests.Cases.Attributes.Dependencies.IReferencedAssemblyImpl",
        "interface",
        "Mono.Linker.Tests.Cases.Attributes.Dependencies.IReferencedAssembly"
    )]
    ...
    class Foo : IDynamicInterfaceCastable
    {
        ...
        {
            return interfaceType.Equals(
                typeof(IReferencedInIDynamicInterfaceCastableType).TypeHandle
            );
        }
    }
        ...
        public RuntimeTypeHandle GetInterfaceImplementation(RuntimeTypeHandle interfaceType)
        {
            if (interfaceType.Equals(typeof(IReferencedAssembly).TypeHandle))
            {
                var type = Type.GetType(
                    "Mono.Linker.Tests.Cases.Attributes.Dependencies.IReferencedAssemblyImpl,impl"
                );
    ...
    [DynamicInterfaceCastableImplementation]
    interface IReferencedInIDynamicInterfaceCastableTypeImpl
        : IReferencedInIDynamicInterfaceCastableType
    {
