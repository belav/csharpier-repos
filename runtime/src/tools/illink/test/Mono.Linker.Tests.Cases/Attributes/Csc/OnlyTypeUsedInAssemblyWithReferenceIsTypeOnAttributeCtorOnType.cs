...
namespace Mono.Linker.Tests.Cases.Attributes.Csc
{
    ...
    [SetupCompileBefore(
        "LibraryWithTypeAndReference.dll",
        new[] { typeof(TypeDefinedInReferenceWithReference) },
        new[] { "LibraryWithType.dll", "LibraryWithAttribute.dll" },
        compilerToUse: "csc"
    )]
    [KeptTypeInAssembly(
        "LibraryWithTypeAndReference.dll",
        typeof(TypeDefinedInReferenceWithReference)
    )]
