...
namespace Mono.Linker.Tests.Cases.Generics
{
    ...
    class CorrectOverloadedMethodGetsStrippedInGenericClass
    {
        public static void Main()
        {
            ...
            GenericClassWithTwoOverloadedAbstractMethods<float> item =
                new SpecializedClassWithTwoOverloadedVirtualMethods();
        ...
        public class SpecializedClassWithTwoOverloadedVirtualMethods
            : GenericClassWithTwoOverloadedAbstractMethods<float>
        {
