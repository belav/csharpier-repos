...
namespace Mono.Linker.Tests.Cases.TestFramework
{
    ...
    // These are technically redundant, but the goal of this test is to verify the attributes are
    // working which we can do
    // by using them on the test case assembly even though you would normally use these attributes for
    // other checking other
