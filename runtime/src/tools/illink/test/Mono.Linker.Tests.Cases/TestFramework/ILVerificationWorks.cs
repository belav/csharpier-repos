...
[ExpectILFailure(
    "Mono.Linker.Tests.Cases.TestFramework.Dependencies.AssemblyWithInvalidIL.GiveMeAValue()",
...
[KeptMemberInAssembly(
    "ILAssembly.dll",
    "Mono.Linker.Tests.Cases.TestFramework.Dependencies.AssemblyWithInvalidIL",
    "GiveMeAValue()"
)]
public class ILVerificationWorks
{
    public static void Main()
    {
        ...
        System.Console.WriteLine(
            new Mono.Linker.Tests.Cases.TestFramework.Dependencies.AssemblyWithInvalidIL(
