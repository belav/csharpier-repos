...
namespace Mono.Linker.Tests.Cases.TestFramework
{
    ...
    [SetupCompileBefore(
        "library.dll",
        new[] { "Dependencies/VerifyAttributesInAssemblyWorks_Lib.cs" },
        new[] { "base.dll" }
    )]
    [KeptAttributeInAssembly(
        "library.dll",
        typeof(VerifyAttributesInAssemblyWorks_Base.ForAssertingKeptAttribute)
    )]
    [KeptAttributeInAssembly(
        "library.dll",
        typeof(VerifyAttributesInAssemblyWorks_Base.ForAssertingKeptAttribute),
        typeof(VerifyAttributesInAssemblyWorks_Lib.TypeWithKeptAttribute)
    )]
    [KeptAttributeInAssembly(
        "library.dll",
        typeof(VerifyAttributesInAssemblyWorks_Base.ForAssertingKeptAttribute),
    ...
    [RemovedAttributeInAssembly(
        "library.dll",
        typeof(VerifyAttributesInAssemblyWorks_Base.ForAssertingRemoveAttribute)
    )]
    [RemovedAttributeInAssembly(
        "library.dll",
        typeof(VerifyAttributesInAssemblyWorks_Base.ForAssertingRemoveAttribute),
        typeof(VerifyAttributesInAssemblyWorks_Lib.TypeWithRemovedAttribute)
    )]
    [RemovedAttributeInAssembly(
        "library.dll",
        typeof(VerifyAttributesInAssemblyWorks_Base.ForAssertingRemoveAttribute),
    ...
    public class VerifyAttributesInAssemblyWorks
    {
        public static void Main()
        {
            ...
            var tmp =
                typeof(VerifyAttributesInAssemblyWorks_Base.ForAssertingKeptAttribute).ToString();
