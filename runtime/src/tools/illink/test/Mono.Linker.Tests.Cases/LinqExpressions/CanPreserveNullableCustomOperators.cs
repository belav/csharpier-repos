...
namespace Mono.Linker.Tests.Cases.LinqExpressions
{
    ...
    public class CanPreserveNullableCustomOperators
    {
        ...
        class ReferenceTypeOperators
        {
            ...
            [Kept]
            public static ReferenceTypeOperators? operator +(
                ReferenceTypeOperators? left,
                ReferenceTypeOperators? right
            ) => null;

            [Kept]
            public static explicit operator TargetReferenceType(ReferenceTypeOperators? self) =>
                null;

            [Kept]
            public static explicit operator ReferenceTypeOperators(SourceReferenceType? other) =>
                null;
        }
        ...
        {
            [Kept]
            public static ValueTypeOperators operator +(ValueTypeOperators? c) =>
                default(ValueTypeOperators);
            ...
            [Kept]
            public static ValueTypeOperators? operator +(
                ValueTypeOperators? left,
                ValueTypeOperators? right
            ) => null;

            [Kept]
            public static ValueTypeOperators? operator +(
                ValueTypeOperators? left,
                AdditionValueType? right
            ) => null;
            ...
            [Kept]
            public static unsafe explicit operator ValueTypeOperators?(
                PointerElementValueType?* other
            ) => null;

            [Kept]
            public static unsafe explicit operator ValueTypeOperators?(
                delegate* <FunctionPointerArgumentValueType?, void> other
            ) => null;
        }
        ...
        {
            public static ValueTypeUnusedOperators? operator +(
                ValueTypeUnusedOperators? left,
                AdditionValueTypeUnused? right
            ) => null;

            public static explicit operator TargetValueTypeUnused?(
                ValueTypeUnusedOperators? self
            ) => null;

            public static explicit operator ValueTypeUnusedOperators?(
                SourceValueTypeUnused? other
            ) => null;
        }
