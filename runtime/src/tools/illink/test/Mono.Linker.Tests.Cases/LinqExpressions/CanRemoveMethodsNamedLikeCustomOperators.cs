...
namespace Mono.Linker.Tests.Cases.LinqExpressions
{
    public class CanRemoveMethodsNamedLikeCustomOperators
    {
        ...
        public class FakeOperators
        {
            ...
            public static FakeOperators op_Addition(FakeOperators left, FakeOperators right) =>
                null;

            public static FakeOperators op_Subtraction(FakeOperators left, SubtractionType right) =>
                null;
