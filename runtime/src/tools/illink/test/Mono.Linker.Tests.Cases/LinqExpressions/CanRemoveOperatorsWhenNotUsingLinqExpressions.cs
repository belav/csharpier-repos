...
namespace Mono.Linker.Tests.Cases.LinqExpressions
{
    public class CanRemoveOperatorsWhenNotUsingLinqExpressions
    {
        ...
        class CustomOperators
        {
            ...
            [Kept]
            public static CustomOperators operator +(CustomOperators left, CustomOperators right) =>
                null;

            public static CustomOperators operator +(
                CustomOperators left,
                AdditionTypeUnused right
            ) => null;
