...
namespace ILLink.Tasks.Tests
{
    public class CreateRuntimeRootDescriptorFileTests
    {
        ...
        public void TestCoreLibClassGen()
        {
            ...
            File.WriteAllText("namespace.h", "#define g_TestNS \"TestNS\"" + Environment.NewLine);
            ...
            XElement existingAssembly = new XElement(
                "assembly",
                new XAttribute("fullname", "testassembly"),
            ...
            string expectedXml = new XElement(
                ...
                new XElement(
                    ...
                    new XElement(
                        "type",
                        new XAttribute("fullname", "TestNS.TestClass"),
                        ...
                        new XElement(
                            "method",
                            new XAttribute("name", "TestMethodIfNotBothForILLink")
                        ),
                        new XElement("method", new XAttribute("name", "TestMethodForILLink"))
                    ),
                    new XElement(
                        "type",
                        new XAttribute("fullname", "TestNS.TestAlwaysException"),
                        new XElement("method", new XAttribute("name", ".ctor"))
                    ),
                    new XElement(
                        "type",
                        new XAttribute("fullname", "TestNS.TestFeatureOnException"),
                        new XElement("method", new XAttribute("name", ".ctor"))
                    )
                )
            ).ToString();
        ...
        public void TestCoreLibClassGenWithFeatureSwitch()
        {
            ...
            string expectedXml = new XElement(
                ...
                new XElement(
                    "assembly",
                    new XAttribute("fullname", "System.Private.CoreLib"),
                    new XAttribute("feature", "TestFeatureName"),
                    new XAttribute("featurevalue", "true"),
                    new XAttribute("featuredefault", "true"),
                    new XElement(
                        "type",
                        new XAttribute("fullname", "TestNS.TestClass"),
                        new XElement("method", new XAttribute("name", "TestMethod")),
