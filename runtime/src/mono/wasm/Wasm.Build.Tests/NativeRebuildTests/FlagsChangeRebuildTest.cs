...
namespace Wasm.Build.NativeRebuild.Tests
{
    ...
    {
        public FlagsChangeRebuildTests(
        ...
        [Theory]
        [MemberData(
            nameof(FlagsChangesForNativeRelinkingData),
            parameters: /*aot*/
            false
        )]
        [MemberData(
        ...
        public void ExtraEmccFlagsSetButNoRealChange(
            BuildArgs buildArgs,
            string extraCFlags,
            string extraLDFlags,
            RunHost host,
        ...
        )
        {
            ...
            TestUtils.AssertSubstring(
                "Linking with emcc",
                output,
                contains: extraLDFlags.Length > 0
            );
