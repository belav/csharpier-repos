...
public class MiscTests3 : BlazorWasmTestBase
{
        ...
        if (publish)
            BlazorPublish(
                new BlazorBuildOptions(
                    ...
                    ExpectRelinkDirWhenPublishing: build
                )
            );
    ...
    public void BugRegression_60479_WithRazorClassLib()
    {
        ...
        string razorClassLibraryFileName =
            $"RazorClassLibrary{ProjectProviderBase.WasmAssemblyExtension}";
        AddItemsPropertiesToProject(
            wasmProjectFile,
            extraItems: @$"
    ...
    private void BlazorAddRazorButton(
        string buttonText,
        string customCode,
        string methodName = "test",
        string razorPage = "Pages/Counter.razor"
    )
    {
