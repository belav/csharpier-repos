...
namespace Wasm.Build.Tests
{
    ...
    {
        public HybridGlobalizationTests(
        ...
        [Theory]
        [MemberData(
            nameof(HybridGlobalizationTestData),
        ...
        private void TestHybridGlobalizationTests(
            BuildArgs buildArgs,
            RunHost host,
            string id,
