...
namespace Wasm.Build.Templates.Tests
{
    public class NativeBuildTests : WasmTemplateTestBase
    {
        ...
        {
            string id =
                $"UndefinedNativeSymbol_{(allowUndefined ? "allowed" : "disabled")}_{GetRandomId()}";
            ...
            AddItemsPropertiesToProject(
                ...
                extraProperties: allowUndefined
            ...
            File.Copy(
                Path.Combine(BuildEnvironment.TestAssetsPath, "native-libs", "undefined-symbol.c"),
                Path.Combine(_projectDir!, "undefined_xyz.c")
            );
            ...
            else
            {
                ...
                Assert.Contains(
                    "Use '-p:WasmAllowUndefinedSymbols=true' to allow undefined symbols",
                    result.Output
                );
            }
        }
        ...
        public void ProjectWithDllImportsRequiringMarshalIlGen_ArrayTypeParameter(string config)
        {
            ...
            File.Copy(
                Path.Combine(BuildEnvironment.TestAssetsPath, "marshal_ilgen_test.cs"),
