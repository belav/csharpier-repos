...
public class IcuShardingTests2 : IcuTestsBase
{
    ...
    public static IEnumerable<object?[]> IcuExpectedAndMissingShardFromRuntimePackTestData(
        bool aot,
        RunHost host
    ) =>
    ...
    [Theory]
    [MemberData(
        nameof(IcuExpectedAndMissingShardFromRuntimePackTestData),
    ...
    public void DefaultAvailableIcuShardsFromRuntimePack(
        BuildArgs buildArgs,
        string shardName,
