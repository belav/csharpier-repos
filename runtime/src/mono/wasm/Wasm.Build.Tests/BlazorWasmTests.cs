...
namespace Wasm.Build.Tests
{
    public class BlazorWasmTests : BuildTestBase
    {
        ...
        {
            CommandResult res = PublishForRequiresWorkloadTest(
                config,
        ...
        private CommandResult PublishForRequiresWorkloadTest(
            string config,
            string extraItems = "",
        ...
        public void Net50Projects_NativeReference(string config) =>
            BuildNet50Project(
                ...
                aot: false,
                expectError: true,
                @"<NativeFileReference Include=""native-lib.o"" />"
            );

        public static TheoryData<string, bool, bool> Net50TestData =
            new()
            {
                {
                    "Debug", /*aot*/
        ...
        private void BuildNet50Project(
            string config,
            bool aot,
            bool expectError,
        ...
        )
        {
            ...
            Utils.DirectoryCopy(
                Path.Combine(BuildEnvironment.TestAssetsPath, "Blazor_net50"),
            ...
            else
            {
                ...
                string binFrameworkDir = FindBlazorBinFrameworkDir(
                    config,
                    forPublish: true,
                    framework: "net5.0"
                );
