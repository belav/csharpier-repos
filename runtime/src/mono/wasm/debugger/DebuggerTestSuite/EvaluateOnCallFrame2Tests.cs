...
namespace DebuggerTests
{
    ...
    {
        public EvaluateOnCallFrame2Tests(ITestOutputHelper testOutput)
            : base(testOutput) { }
            ...
            await CheckInspectLocalsAtBreakpointSite(
                ...
                wait_for_event_fn: async (pause_location) =>
                {
                    ...
                    await EvaluateOnCallFrameAndCheck(
                        ...
                        (
                            "test.SumDefaultNegativeAndRequiredParamFloats(-1.1f, -1.1f)",
                            TNumber("-2.2", isDecimal: true)
                        ),
                        (
                            "test.SumDefaultNegativeAndRequiredParamFloats(-1.1f)",
                            TNumber("-4.4", isDecimal: true)
                        ), // default: -3.3f
                        (
                            "test.SumDefaultNegativeAndRequiredParamDoubles(-0.1, -0.2)",
                            TNumber("-0.30000000000000004", isDecimal: true)
                        ), // expected result for doubles copied from coreclr response
                        (
                            "test.SumDefaultNegativeAndRequiredParamDoubles(-0.1)",
        ...
        [Fact]
        public async Task EvaluateStaticGetterInValueType() =>
            await CheckInspectLocalsAtBreakpointSite(
                $"DebuggerTests.TypeProperties",
                "Run",
                3,
        ...
        [Fact]
        public async Task EvaluateSumBetweenObjectAndString() =>
            await CheckInspectLocalsAtBreakpointSite(
                $"DebuggerTests.SumObjectAndString",
                "run",
                7,
                "DebuggerTests.SumObjectAndString.run",
                ...
                wait_for_event_fn: async (pause_location) =>
                {
                    ...
                    await EvaluateOnCallFrameAndCheck(
                        ...
                        (
                            "myList+\"asd\"",
                            TString("System.Collections.Generic.List`1[System.Int32]asd")
                        ),
        ...
        [Fact]
        public async Task EvaluateMethodsOnEnum() =>
            await CheckInspectLocalsAtBreakpointSite(
                $"DebuggerTests.EvaluateMethodsOnEnum",
                "run",
                2,
                "DebuggerTests.EvaluateMethodsOnEnum.run",
        ...
        [Fact]
        public async Task EvaluateObjectIndexingMultidimensional() =>
            await CheckInspectLocalsAtBreakpointSite(
        ...
        [Fact]
        public async Task EvaluateValueTypeIndexingMultidimensional() =>
            await CheckInspectLocalsAtBreakpointSite(
                "DebuggerTests.EvaluateLocalsWithIndexingTests",
                "EvaluateLocals",
                12,
        ...
        [Fact]
        public async Task EvaluateMethodsWithObjectParams() =>
            await CheckInspectLocalsAtBreakpointSite(
                "DebuggerTests.FastCheck",
                "run",
                6,
                "DebuggerTests.FastCheck.run",
                ...
                wait_for_event_fn: async (pause_location) =>
                {
                    ...
                    await EvaluateOnCallFrameAndCheck(
                        ...
                        (
                            "mc.Method(DebuggerTestsV2.EvaluateStaticFieldsInStaticClass.StaticField)",
                            TNumber(20)
                        ),
