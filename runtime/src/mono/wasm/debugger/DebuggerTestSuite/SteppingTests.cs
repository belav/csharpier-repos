...
namespace DebuggerTests
{
    ...
    {
        public SteppingTests(ITestOutputHelper testOutput)
            : base(testOutput) { }
        ...
        public async Task InspectLocalsInPreviousFramesDuringSteppingIn2(bool use_cfo)
        {
            ...
            var pause_location = await EvaluateAndCheck(
                ...
                35,
                8,
                "Simple.Complex.DoEvenMoreStuff",
                locals_fn: async (locals) =>
                {
            ...
            var locals_m1 = await GetLocalsForFrame(
                pause_location["callFrames"][3],
                debugger_test_loc,
                23,
                8,
                "Math.UseComplex"
            ...
            pause_location = await StepAndCheck(
                ...
                25,
                8,
                "Simple.Complex.DoStuff",
                times: 4
            );
            // Check UseComplex frame again
            locals_m1 = await GetLocalsForFrame(
                pause_location["callFrames"][1],
                debugger_test_loc,
                23,
                8,
                "Math.UseComplex"
        ...
        public async Task InspectLocalsInPreviousFramesDuringSteppingIn(bool use_cfo)
        {
            ...
            await CheckProps(
                ss_props,
                new { dt = TDateTime(dt), gs = TValueType("Math.GenericStruct<System.DateTime>") },
                "ss_props"
            );

            // Check OuterMethod frame
            var locals_m1 = await GetLocalsForFrame(
                wait_res["callFrames"][1],
                debugger_test_loc,
                87,
                8,
                "Math.OuterMethod"
        ...
        public async Task InspectLocalsInAsyncMethods(bool use_cfo)
        {
            ...
            var wait_res = await EvaluateAndCheck(
                ...
                120,
                12,
                "Math.NestedInMath.AsyncMethod0",
                locals_fn: async (locals) =>
                {
                    Assert.Equal(4, locals.Count());
            ...
            var pause_loc = await SendCommandAndCheck(
                null,
                "Debugger.resume",
                debugger_test_loc,
                135,
                12,
                "Math.NestedInMath.AsyncMethodNoReturn",
                locals_fn: async (locals) =>
                {
                    Assert.Equal(4, locals.Count());
        ...
        public async Task InspectValueTypeMethodArgsWhileStepping(bool use_cfo)
        {
            ...
            var pause_location = await EvaluateAndCheck(
                ...
                36,
                12,
                "DebuggerTests.ValueTypesTest.MethodWithStructArgs"
            );
            ...
            var ss_arg_updated = new
            {
                V = TGetter("V"),
                str_member = TString(
                    "ValueTypesTest#MethodWithStructArgs#updated#ss_arg#str_member"
                ),
                dt = TDateTime(dt),
                gs = TValueType("DebuggerTests.ValueTypesTest.GenericStruct<System.DateTime>"),
...

            {
                ...
                await CompareObjectPropertiesFor(
                    ...
                    {
                        StringField = TString(
                            "ValueTypesTest#MethodWithStructArgs#updated#gs#StringField#3"
                        ),
                        List = TObject(
                            "System.Collections.Generic.List<System.DateTime>",
                            description: "Count = 1"
...

            {
                ...
                await CheckString(
                    gs_props,
                    "StringField",
                    "ss_local#SimpleStruct#string#0#SimpleStruct#gs#StringField"
                );
                await CheckObject(
                    gs_props,
                    "List",
            ...
            pause_location = await StepAndCheck(
                ...
                30,
                12,
                "DebuggerTests.ValueTypesTest.TestStructsAsMethodArgs",
                times: 2,
                locals_fn: async (l) =>
                { /* non-null to make sure that locals get fetched */
                    await Task.CompletedTask;
        ...
        public async Task CheckUpdatedValueTypeFieldsOnResume()
        {
            ...
            var pause_location = await EvaluateAndCheck(
                ...
                lines[0],
                12,
                "DebuggerTests.ValueTypesTest.MethodUpdatingValueTypeMembers"
            );
            ...
            await CheckLocals(
                pause_location,
                new DateTime(9, 8, 7, 6, 5, 4),
                new DateTime(5, 1, 3, 7, 9, 10)
            );
        ...
        public async Task CheckUpdatedValueTypeLocalsOnResumeAsync()
        {
            ...
            var pause_location = await EvaluateAndCheck(
                ...
                lines[0],
                12,
                "DebuggerTests.ValueTypesTest.MethodUpdatingValueTypeLocalsAsync"
            );
        ...
        public async Task CheckUpdatedVTArrayMembersOnResume()
        {
            ...
            var pause_location = await EvaluateAndCheck(
                ...
                lines[0],
                12,
                "DebuggerTests.ValueTypesTest.MethodUpdatingVTArrayMembers"
            );
            ...
            async Task CheckArrayElements(JToken pause_location, DateTime dt)
            {
                ...
                await CheckProps(sst0, new { DT = TDateTime(dt) }, "dta [0]", num_fields: 5);
            }
        }
        ...
        public async Task SteppingIntoMscorlib()
        {
            ...
            AssertEqual(
                ...
                "Expected to be in WriteLine method"
            );
            var script_id = top_frame["functionLocation"]["scriptId"].Value<string>();
            Assert.Matches(
                "^dotnet://(mscorlib|System\\.Console)\\.dll/Console.cs",
                scripts[script_id]
            );
        }
        ...
        public async Task StepOutOfNonAsyncMethod()
        {
            ...
            await StepAndCheck(
                ...
                29,
                12,
                "DebuggerTests.AsyncStepClass.SimpleMethod"
            );
        }
        ...
        [InlineData(
            ...
            8,
            "StepOverHiddenSP3",
            "HiddenSequencePointTest.StepOverHiddenSP3"
        )]
        public async Task BreakpointOnHiddenLineShouldStopAtEarliestNextAvailableLine(
            int line_bp,
            int column_bp,
            int line_pause,
            int column_pause,
        ...
        )
        {
            ...
            await EvaluateAndCheck(
                "window.setTimeout(function() { invoke_static_method ('[debugger-test] HiddenSequencePointTest:"
                    + method_to_call
                    + "'); }, 1);",
                "dotnet://debugger-test.dll/debugger-test.cs",
                line_pause,
        ...
        [InlineData(
            ...
            201,
            8,
            "HiddenLinesAtTheEndOfANestedAsyncBlockWithWithLineDefaultOutsideTheMethod"
        )]
        [InlineData(
            224,
            20,
            220,
            8,
            "HiddenLinesAtTheEndOfANestedAsyncBlockWithWithLineDefaultOutsideTheMethod2"
        )]
        public async Task BreakpointOnHiddenLineShouldStopAtEarliestNextAvailableLineAsync_PauseEarlier(
            int line_bp,
            int column_bp,
            int line_pause,
            int column_pause,
        ...
        [InlineData(
            ...
            155,
            16,
            "HiddenLinesAtTheEndOfANestedAsyncBlockWithNoLinesAtEndOfTheMethod.AnonymousMethod__1"
        )]
        [InlineData(
            154,
            20,
        ...
        [InlineData(
            ...
            172,
            16,
            "HiddenLinesAtTheEndOfANestedAsyncBlockWithBreakableLineAtEndOfTheMethod.AnonymousMethod__1"
        )]
        [ActiveIssue(
        ...
        public async Task BreakpointOnHiddenLineShouldStopAtEarliestNextAvailableLineAsync(
            int line_bp,
            int column_bp,
            int line_pause,
            int column_pause,
        ...
        public async Task StepAndEvaluateExpression()
        {
            ...
            var pause_location = await StepAndCheck(
                StepKind.Into,
                "dotnet://debugger-test.dll/debugger-test.cs",
                671,
                4,
        ...
        {
            var pause_location = await SetBreakpointInMethod(
                "debugger-test.dll",
                "DebuggerAttribute",
                "RunDebuggerHidden",
                1
            ...
            var step_into = await SendCommandAndCheck(
                null,
                $"Debugger.stepInto",
                null,
                -1,
        ...
        public async Task SteppingIntoLibrarySymbolsLoadedFromSymbolServer(bool justMyCode)
        {
            ...
            var searchPaths = new JArray { "https://symbols.nuget.org/download/symbols" };
            var waitForScript = WaitForScriptParsedEventsAsync(new string[] { "JArray.cs" });
            var symbolOptions = JObject.FromObject(
                new { symbolOptions = JObject.FromObject(new { cachePath, searchPaths }) }
            );
            ...
            await StepAndCheck(
                ...
                justMyCode
                    ? "dotnet://debugger-test.dll/debugger-test.cs"
                    : "dotnet://Newtonsoft.Json.dll/JArray.cs",
                justMyCode ? 1575 : 350,
                justMyCode ? 8 : 12,
                justMyCode ? "TestLoadSymbols.Run" : "Newtonsoft.Json.Linq.JArray.Add",
                locals_fn: async (locals) =>
                {
                    if (!justMyCode)
                        await CheckObject(
        ...
        public async Task SteppingIntoLibrarySymbolsLoadedFromSymbolServerAddOtherSymbolServerAndStepAgain()
        {
            ...
            symbolOptions = JObject.FromObject(
                new { symbolOptions = JObject.FromObject(new { cachePath, searchPaths }) }
            );
            await SetSymbolOptions(symbolOptions);
            ...
            if (justMyCode)
                Assert.False(
                    pause_location["callFrames"]
                        ...
                        .Any(f =>
                            f
                                ?["scopeChain"]?[0]?["type"]?.Value<string>()
