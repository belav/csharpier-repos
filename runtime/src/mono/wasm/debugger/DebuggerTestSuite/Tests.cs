...
namespace DebuggerTests
{
    public class SourceList : DebuggerTestBase
    {
        ...
        [Fact]
        public async Task InspectTaskAtLocals() =>
            await CheckInspectLocalsAtBreakpointSite(
                "InspectTask",
                "RunInspectTask",
                10,
        ...
        public async Task MallocUntilReallocate() //https://github.com/xamarin/xamarin-android/issues/6161
        {
            ...
            var result = await cli.SendCommand(
                "Runtime.evaluate",
                JObject.FromObject(new { expression = eval_expr }),
                token
            );
