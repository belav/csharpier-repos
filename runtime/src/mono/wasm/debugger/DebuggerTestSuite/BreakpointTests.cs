...
namespace DebuggerTests
{
    ...
    {
        public BreakpointTests(ITestOutputHelper testOutput)
            : base(testOutput) { }
        ...
        public async Task CreateGoodBreakpoint()
        {
            ...
            Assert.Equal(
                ...
                scripts[loc["scriptId"]?.Value<string>()]
            );
        ...
        {
            var bp1_res = await SetBreakpoint(
            ...
            var bp2_res = await SetBreakpoint(
                "dotnet://debugger-test.dll/debugger-array-test.cs",
                219,
                55
            );
        ...
        public static TheoryData<string, string, string, bool> FalseConditions = new TheoryData<
            string,
            string,
            string,
            bool
        ...
        public static TheoryData<string, string, string, bool> TrueConditions = new TheoryData<
            string,
            string,
            string,
            bool
        ...
        public static TheoryData<string, string, string, bool> InvalidConditions = new TheoryData<
            string,
            string,
            string,
            bool
        ...
        public async Task ConditionalBreakpoint2(
        ...
        public async Task JSConditionalBreakpoint(
            string condition,
            int line_bp,
            int column_bp,
            int line_expected,
        ...
        )
        {
            ...
            await EvaluateAndCheck(
                ...
                line_expected,
                column_expected,
                "conditional_breakpoint_test"
            );
        }

        [Theory]
        [InlineData(
            "invoke_add_with_parms(10, 20)",
            "invoke_add_with_parms(10, 20)",
            "IntAdd",
            "c == 30",
            true,
        ...
        public async Task ConditionalBreakpointHitTwice(
            string function_to_call,
            string function_to_call2,
            string method_to_stop,
            string condition,
            bool bp_stop_expected,
        ...
        public async Task BreakpointInAssemblyUsingTypeFromAnotherAssembly_BothDynamicallyLoaded()
        {
            ...
            await SetBreakpoint(
                ".*/library-dependency-debugger-test1.cs$",
                line,
                0,
                use_regex: true
            );
            ...
            var source_location =
                "dotnet://library-dependency-debugger-test1.dll/library-dependency-debugger-test1.cs";
        ...
        {
            var bp_conditional = await SetBreakpointInMethod(
                "debugger-test.dll",
                "LoopClass",
                "LoopToBreak",
                4,
            ...
            var bp_check = await SetBreakpointInMethod(
                "debugger-test.dll",
                "LoopClass",
                "LoopToBreak",
                5
        ...
        )
        {
            ...
            var run_method = JObject.FromObject(
                new { expression = "window.setTimeout(function() { " + func_name + "(); }, 1);" }
            );
            ...
            run_method = JObject.FromObject(
                new { expression = "window.setTimeout(function() { reload_wasm_page(); }, 1);" }
            );
            await cli.SendCommand("Runtime.evaluate", run_method, token);
        ...
        {
            var bp_hidden = await SetBreakpointInMethod(
                "debugger-test.dll",
                "DebuggerAttribute",
                decoratedFunName,
                1
            );
            var bp_final = await SetBreakpointInMethod(
                "debugger-test.dll",
                "DebuggerAttribute",
                evalFunName,
                2
        ...
        {
            var bp_init = await SetBreakpointInMethod(
                "debugger-test.dll",
                "DebuggerAttribute",
                evalFunName,
                2
        ...
        [InlineData(
            ...
            847,
            8,
            "DebuggerAttribute.RunStepThrough"
        )]
        [InlineData(
            true,
            "RunStepThrough",
        ...
        [InlineData(
            ...
            852,
            4,
            "DebuggerAttribute.NonUserCodeBp"
        )]
        [InlineData(
            true,
            "RunNonUserCode",
            ...
            867,
            8,
            "DebuggerAttribute.RunNonUserCode"
        )]
        [InlineData(
            false,
            "RunStepThroughWithNonUserCode",
            "DebuggerAttribute",
            1,
            933,
            8,
            "DebuggerAttribute.RunStepThroughWithNonUserCode"
        )]
        [InlineData(
            true,
            "RunStepThroughWithNonUserCode",
        ...
        [InlineData(
            false,
            "EvaluateStepThroughAttr",
            "DefaultInterfaceMethod",
            2,
            1110,
            4,
            "DefaultInterfaceMethod.EvaluateStepThroughAttr"
        )]
        [InlineData(
            true,
            "EvaluateStepThroughAttr",
        ...
        [InlineData(
            false,
            "EvaluateNonUserCodeAttr",
            "DefaultInterfaceMethod",
            2,
            1067,
            4,
            "IExtendIDefaultInterface.NonUserCodeDefaultMethod"
        )]
        [InlineData(
            true,
            "EvaluateNonUserCodeAttr",
            ...
            1116,
            4,
            "DefaultInterfaceMethod.EvaluateNonUserCodeAttr"
        )]
        public async Task StepThroughOrNonUserCodeAttributeStepInNoBp2(
        ...
        )
        {
            ...
            {
                var bp1_decorated_fun = await SetBreakpointInMethod(
                    "debugger-test.dll",
                    "DebuggerAttribute",
                    decoratedFunName,
                    1
                );
                var bp2_decorated_fun = await SetBreakpointInMethod(
                    "debugger-test.dll",
                    "DebuggerAttribute",
                    decoratedFunName,
                    3
                ...
                await SendCommandAndCheck(
                    ...
                    line1,
                    8,
                    "DebuggerAttribute." + decoratedFunName
                );
                await SendCommandAndCheck(
                    null,
                    "Debugger.stepInto",
        ...
        public async Task StepThroughOrNonUserCodeAttributeResumeWithBp(
            bool justMyCodeEnabled,
            string evalFunName,
            string decoratedFunName
        )
        {
            ...
            var bp_outside_decorated_fun = await SetBreakpointInMethod(
                "debugger-test.dll",
                "DebuggerAttribute",
                evalFunName,
                2
        ...
        public async Task StepThroughOrNonUserCodeAttributeWithUserBp(
            bool justMyCodeEnabled,
            string debuggingFunction,
            string evalFunName,
            string functionNameCheck1,
            int line1,
            int col1,
            string functionNameCheck2,
            int line2,
            int col2
        )
        {
            ...
            if (line1 == -1)
                line1 =
                    bp_outside_decorated_fun.Value["locations"][0]["lineNumber"].Value<int>() - 1;
            if (line2 == -1)
            ...
            await SendCommandAndCheck(
                ...
                line1,
                col1,
                "DebuggerAttribute." + functionNameCheck1
            );
            await SendCommandAndCheck(
                null,
                debuggingFunction,
                ...
                line2,
                col2,
                "DebuggerAttribute." + functionNameCheck2
            );
        }
        ...
        [InlineData(
            "DefaultInterfaceMethod",
            "EvaluateStepperBoundaryAttr",
            "IExtendIDefaultInterface",
            "Debugger.stepInto",
            2,
            3,
            false
        ...
        public async Task StepperBoundary(
            string className,
            string evalFunName,
            string decoratedMethodClassName,
            string debuggingAction,
            int lineBpInit,
            int lineBpFinal,
            bool hasBpInDecoratedFun,
            bool isTestingUserBp = false
        )
        {
            ...
            {
                var bp_decorated_fun = await SetBreakpointInMethod(
                    "debugger-test.dll",
                    decoratedMethodClassName,
                    "BoundaryBp",
                    2
                );
                ...
                await SendCommandAndCheck(
                    ...
                    line_decorated_fun,
                    col_decorated_fun,
                    decoratedMethodClassName + ".BoundaryBp"
                );
            }
            if (isTestingUserBp)
                await SendCommandAndCheck(
                    ...
                    879,
                    8,
                    decoratedMethodClassName + ".BoundaryUserBp"
                );
        ...
        [InlineData(
            ...
            "DefaultMethod",
            "Evaluate",
            "DefaultInterfaceMethod.Evaluate",
            1089,
            1005,
            1003,
            1007
        ...
        [InlineData(
            "IExtendIDefaultInterface",
            "IDefaultInterface.DefaultMethodToOverride",
            "Evaluate",
            "DefaultInterfaceMethod.Evaluate",
            1090,
            1049,
        ...
        [InlineData(
            ...
            "DefaultMethodAsync",
            "EvaluateAsync",
            "System.Runtime.CompilerServices.AsyncMethodBuilderCore.Start<IDefaultInterface.<DefaultMethodAsync>d__3>",
            37,
            1018,
            1016,
            1020
        ...
        [InlineData(
            ...
            "DefaultMethodStatic",
            "EvaluateStatic",
            "DefaultInterfaceMethod.EvaluateStatic",
            1126,
            1024,
            1022,
            1026
        ...
        [InlineData(
            "IDefaultInterface",
            "DefaultMethodAsyncStatic",
            "EvaluateAsyncStatic",
            "System.Runtime.CompilerServices.AsyncMethodBuilderCore.Start<IDefaultInterface.<DefaultMethodAsyncStatic>d__5>",
            37,
            1033,
            1031,
            1035
        ...
        public async Task BreakInDefaultInterfaceMethod(
            ...
            string dimName,
            string entryMethod,
            string prevFrameInDim,
            int evaluateAsPrevFrameLine,
            int dimAsPrevFrameLine,
        ...
        )
        {
            ...
            var pauseInDim = await EvaluateAndCheck(
                ...
                wait_for_event_fn: async (pause_location) =>
                {
                    await CheckDefaultMethod(pause_location, dimClassName + "." + dimName);
                }
            );

            // check prev frame in DIM
            Assert.Equal(
                pauseInDim["callFrames"][1]["functionName"].Value<string>(),
                prevFrameInDim
            );
            ...
            var bpFunCalledFromDim = await SetBreakpointInMethod(
                "debugger-test.dll",
                "DefaultInterfaceMethod",
                funCalledFromDim,
                1
            ...
            var pauseInFunCalledFromDim = await SendCommandAndCheck(
                null,
                "Debugger.resume",
                null,
            ...
            Assert.Equal(
                pauseInFunCalledFromDim["callFrames"][1]["functionName"].Value<string>(),
                dimClassName + "." + prevFrameFromDim
            );
            CheckLocationLine(
                pauseInFunCalledFromDim["callFrames"][1]["location"],
                dimAsPrevFrameLine
            );
            ...
            async Task CheckDefaultMethod(JObject pause_location, string methodName)
            {
                Assert.Equal("other", pause_location["reason"]?.Value<string>());
                Assert.Equal(
                    bpDim.Value["breakpointId"]?.ToString(),
                    pause_location["hitBreakpoints"]?[0]?.Value<string>()
                );
        ...
        public async Task CheckDefaultInterfaceMethodHiddenAttribute()
        {
            ...
            string assembly = "dotnet://debugger-test.dll/debugger-test.cs";
            var hidden_bp = await SetBreakpointInMethod(
                "debugger-test.dll",
                "IExtendIDefaultInterface",
                "HiddenDefaultMethod",
                1
            );
            var final_bp = await SetBreakpointInMethod(
                "debugger-test.dll",
                "DefaultInterfaceMethod",
                methodName,
                3
