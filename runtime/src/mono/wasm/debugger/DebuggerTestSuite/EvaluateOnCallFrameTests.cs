...
namespace DebuggerTests
{
    ...
    public class EvaluateOnCallFrameTests : DebuggerTestBase
    {
        ...
        public async Task EvaluateSimpleMethodCallsError() =>
            await CheckInspectLocalsAtBreakpointSite(
                ...
                wait_for_event_fn: async (pause_location) =>
                {
                    ...
                    AssertEqual(
                        "Unable to evaluate method 'MyMethodWrong'",
                    ...
                    AssertEqual(
                        "Unable to evaluate method 'MyMethod'",
                        res.Error["message"]?.Value<string>(),
                        "wrong error message"
                    );
                    ...
                    AssertEqual(
                        "Unable to evaluate method 'CallMethodWithParm'",
                        res.Error["message"]?.Value<string>(),
                        "wrong error message"
                    );
        ...
        [Fact]
        public async Task EvaluateExpressionsWithElementAccessByConstant() =>
            await CheckInspectLocalsAtBreakpointSite(
                "DebuggerTests.EvaluateLocalsWithElementAccessTests",
                "EvaluateLocals",
                5,
                "EvaluateLocals",
        ...
        [Fact]
        public async Task EvaluateExpressionsWithElementAccessByLocalVariable() =>
            await CheckInspectLocalsAtBreakpointSite(
                "DebuggerTests.EvaluateLocalsWithElementAccessTests",
                "EvaluateLocals",
                5,
        ...
        [Fact]
        public async Task EvaluateExpressionsWithElementAccessByMemberVariables() =>
            await CheckInspectLocalsAtBreakpointSite(
                "DebuggerTests.EvaluateLocalsWithElementAccessTests",
                "EvaluateLocals",
                5,
        ...
        [Fact]
        public async Task EvaluateExpressionsWithElementAccessNested() =>
            await CheckInspectLocalsAtBreakpointSite(
                "DebuggerTests.EvaluateLocalsWithElementAccessTests",
                "EvaluateLocals",
                5,
        ...
        [Fact]
        public async Task EvaluateExpressionsWithElementAccessMultidimentional() =>
            await CheckInspectLocalsAtBreakpointSite(
                "DebuggerTests.EvaluateLocalsWithElementAccessTests",
                "EvaluateLocals",
                5,
        ...
        [Fact]
        public async Task EvaluateStaticClass() =>
            await CheckInspectLocalsAtBreakpointSite(
                "DebuggerTests.EvaluateMethodTestsClass/TestEvaluate",
                "run",
                9,
                ...
                wait_for_event_fn: async (pause_location) =>
                {
                    ...
                    await EvaluateOnCallFrameAndCheck(
                        id,
                        (
                            "DebuggerTests.EvaluateStaticClass.StaticProperty1",
                            TString("StaticProperty1")
                        )
                    );
                    await EvaluateOnCallFrameAndCheck(
                        id,
                        (
                            "DebuggerTests.EvaluateStaticClass.StaticPropertyWithError",
                            TString("System.Exception: not implemented")
                        )
                    );
                }
            );
        ...
        public async Task EvaluateStaticClassInvalidField() =>
            await CheckInspectLocalsAtBreakpointSite(
                ...
                wait_for_event_fn: async (pause_location) =>
                {
                    ...
                    var (_, res) = await EvaluateOnCallFrame(
                        id,
                        "DebuggerTests.EvaluateStaticClass.StaticProperty2",
                        expect_ok: false
                    );
                    AssertEqual(
                        "Failed to resolve member access for DebuggerTests.EvaluateStaticClass.StaticProperty2",
