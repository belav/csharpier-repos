...
namespace DebuggerTests
{
    ...
    public class EvaluateOnCallFrameTests : DebuggerTests
    {
        ...
        public async Task EvaluateSimpleMethodCallsError() =>
            await CheckInspectLocalsAtBreakpointSite(
                ...
                wait_for_event_fn: async (pause_location) =>
                {
                    ...
                    Assert.Equal(
                        "DebuggerTests.EvaluateMethodTestsClass.TestEvaluate.run",
                        exceptionDetailsStack?["functionName"]?.Value<string>()
                    );
        ...
        public async Task EvaluateIndexingNegative() =>
            await CheckInspectLocalsAtBreakpointSite(
                ...
                wait_for_event_fn: async (pause_location) =>
                {
                    ...
                    Assert.Equal(
                        "Unable to evaluate element access 'cc.idx0[2]': Cannot apply indexing with [] to a primitive object of type 'number'",
                        res.Error["result"]?["description"]?.Value<string>()
                    );
                    var exceptionDetailsStack = res.Error["exceptionDetails"]
                        ?["stackTrace"]
                    ...
                    Assert.Equal(
                        "Unable to evaluate element access 'c[1]': Cannot apply indexing with [] to an object of type 'DebuggerTests.EvaluateLocalsWithIndexingTests.ClassWithIndexers'",
                        res.Error["result"]?["description"]?.Value<string>()
                    );
                }
            );
        ...
        public async Task EvaluateIndexingByExpressionNegative() =>
            await CheckInspectLocalsAtBreakpointSite(
                ...
                wait_for_event_fn: async (pause_location) =>
                {
                    ...
                    Assert.Equal(
                        "Unable to evaluate element access 'cc.numList[\"a\" + 1]': Cannot index with an object of type 'string'",
                        res.Error["result"]?["description"]?.Value<string>()
                    );
                    var exceptionDetailsStack = res.Error["exceptionDetails"]
                        ?["stackTrace"]
            ...
            await CheckInspectLocalsAtBreakpointSite(
                ...
                wait_for_event_fn: async (pause_location) =>
                {
                    ...
                    await EvaluateOnCallFrameAndCheck(
                        ...
                        (
                            "cc.numArrayOfArrays[cc.numArray[cc.numList[1]]][cc.numList[0]]",
                            TNumber(2)
                        )
                    );
                }
        ...
        [InlineData(true)]
        [InlineData(false)]
        public async Task EvaluateMethodWithBPWhilePausedInADifferentMethodAndNotHit(
            bool setBreakpointBeforePause
        )
        {
            await cli.SendCommand(
                "DotnetDebugger.setEvaluationOptions",
                JObject.FromObject(new { options = new { noFuncEval = false } }),
                token
            );
            var waitForScript = WaitForConsoleMessage(
            ...
            if (setBreakpointBeforePause)
                await SetBreakpointInMethod(
                    "debugger-test.dll",
                    "TestEvaluateDontPauseOnBreakpoint",
                    "MyMethod2",
                    1
                );
            await CheckInspectLocalsAtBreakpointSite(
                ...
                "run",
                3,
                "TestEvaluateDontPauseOnBreakpoint.run",
                ...
                wait_for_event_fn: async (pause_location) =>
                {
                    ...
                    await EvaluateOnCallFrameAndCheck(
                        ...
                        (
                            "myVar",
                            TObject("TestEvaluateDontPauseOnBreakpoint", description: "Object 11")
                        )
                    );
            ...
            await SendCommandAndCheck(
                ...
                0,
                0,
                "TestEvaluateDontPauseOnBreakpoint.MyMethod2"
            );
            await SendCommandAndCheck(
                null,
                "Debugger.resume",
                ...
                0,
                0,
                "TestEvaluateDontPauseOnBreakpoint.MyMethod"
            );
