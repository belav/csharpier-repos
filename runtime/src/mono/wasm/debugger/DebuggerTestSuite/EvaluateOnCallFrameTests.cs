...
namespace DebuggerTests
{
    ...
    {
        public EvaluateOnCallFrameTests(ITestOutputHelper testOutput)
            : base(testOutput) { }
        ...
        [MemberData(
            nameof(InstanceMethodForTypeMembersTestData),
            parameters: "DebuggerTests.EvaluateTestsStructWithProperties"
        )]
        [MemberData(
            nameof(InstanceMethodForTypeMembersTestData),
            parameters: "DebuggerTests.EvaluateTestsClassWithProperties"
        )]
        public async Task EvaluateTypeInstanceMembers(
            string prefix,
            int bias,
            string type,
            string method,
                ...
                wait_for_event_fn: async (pause_location) =>
                {
                    ...
                    foreach (var pad in new[] { String.Empty, "  " })
                    {
                        ...
                        await EvaluateOnCallFrameAndCheck(
                            ...
                            // fields
                            (
                                $"{padded_prefix}dateTime.TimeOfDay",
                                TValueType("System.TimeSpan", dateTime.TimeOfDay.ToString())
                            ),
                            ($"{padded_prefix}dateTime", TDateTime(dateTime)),
                            (
                                $"{padded_prefix}dateTime.TimeOfDay.Minutes",
                                TNumber(dateTime.TimeOfDay.Minutes)
                            ),
                            // properties
                            (
                                $"{padded_prefix}DTProp.TimeOfDay.Minutes",
                                TNumber(DTProp.TimeOfDay.Minutes)
                            ),
                            ($"{padded_prefix}DTProp", TDateTime(DTProp)),
                            (
                                $"{padded_prefix}DTProp.TimeOfDay",
                                TValueType("System.TimeSpan", DTProp.TimeOfDay.ToString())
                            ),
                            ($"{padded_prefix}IntProp", TNumber(9)),
                            (
                                $"{padded_prefix}NullIfAIsNotZero",
                                TObject(
                                    "DebuggerTests.EvaluateTestsClassWithProperties",
                                    is_null: true
                                )
                            )
                        );
        ...
        [Theory]
        [MemberData(
            nameof(InstanceMethodsTestData),
            parameters: "DebuggerTests.EvaluateTestsStructWithProperties"
        )]
        [MemberData(
            nameof(InstanceMethodsTestData),
        ...
        public async Task EvaluateInstanceMethodArguments(
            string type,
            string method,
            string bp_function_name,
            bool is_async
        ...
        public async Task EvaluateMethodLocals(
            string type,
            string method,
            string bp_function_name,
            bool is_async
        ...
        public async Task EvaluateStaticLocalsWithDeepMemberAccess() =>
            await CheckInspectLocalsAtBreakpointSite(
                "DebuggerTests.EvaluateTestsClass",
                "EvaluateLocals",
                9,
                "DebuggerTests.EvaluateTestsClass.EvaluateLocals",
        ...
        public async Task EvaluateLocalsAsync() =>
            await CheckInspectLocalsAtBreakpointSite(
                ...
                "AsyncInstanceMethod",
                1,
                "DebuggerTests.Point.AsyncInstanceMethod",
                ...
                wait_for_event_fn: async (pause_location) =>
                {
                    ...
                    // sc_arg
                    {
                        ...
                        await EvaluateOnCallFrameAndCheck(
                            ...
                            (
                                "sc_arg.Id + (sc_arg.X==10 ? \"_is_ten\" : \"_not_ten\")",
                                TString($"sc#Id_is_ten")
                            )
                        );
                    }
                    ...
                    // local_gs
                    {
                        ...
                        var local_gs_props = await GetProperties(
                            local_gs["objectId"]?.Value<string>()
                        );
                        await CheckProps(
                            local_gs_props,
                            new
        ...
        public async Task EvaluateExpressionsWithDeepMemberAccesses(
            string prefix,
            int bias,
            string type,
            string method,
            ...
            await CheckInspectLocalsAtBreakpointSite(
                ...
                wait_for_event_fn: async (pause_location) =>
                {
                    ...
                    await EvaluateOnCallFrameAndCheck(
                        ...
                        (
                            $" {prefix}IntProp + ({prefix}DTProp.Second+{prefix}dateTime.Year)",
                            TNumber(9 + DTProp.Second + dateTime.Year)
                        ),
        ...
        public async Task InheritedAndPrivateMembersInAClass(string prefix) =>
            await CheckInspectLocalsAtBreakpointSite(
                "DebuggerTests.GetPropertiesTests.DerivedClass",
                "InstanceMethod",
                1,
                "DebuggerTests.GetPropertiesTests.DerivedClass.InstanceMethod",
                ...
                wait_for_event_fn: async (pause_location) =>
                {
                    ...
                    foreach (var pad in new[] { String.Empty, "  " })
                    {
                        ...
                        await EvaluateOnCallFrameAndCheck(
                            ...
                            // overridden
                            (
                                $"{padded_prefix}FirstName + \"_foo\"",
                                TString("DerivedClass#FirstName_foo")
                            ),
                            ($"{padded_prefix}DateTimeForOverride.Date.Year", TNumber(2190)),
                            ($"{padded_prefix}DateTimeForOverride.Date.Year - 10", TNumber(2180)),
                            (
                                $"\"foo_\" + {padded_prefix}StringPropertyForOverrideWithAutoProperty",
                                TString(
                                    "foo_DerivedClass#StringPropertyForOverrideWithAutoProperty"
                                )
                            ),
                            // private
                            (
                                $"{padded_prefix}_stringField + \"_foo\"",
                                TString("DerivedClass#_stringField_foo")
                            ),
                            ...
                            // inherited public
                            (
                                $"\"foo_\" + {padded_prefix}Base_AutoStringProperty",
        ...
        [Fact]
        public async Task EvaluateSimpleExpressions() =>
            await CheckInspectLocalsAtBreakpointSite(
                "DebuggerTests.EvaluateTestsClass.TestEvaluate",
                "run",
                9,
                "DebuggerTests.EvaluateTestsClass.TestEvaluate.run",
                "window.setTimeout(function() { invoke_static_method ('[debugger-test] DebuggerTests.EvaluateTestsClass:EvaluateLocals'); })",
                wait_for_event_fn: async (pause_location) =>
                {
                    var id = pause_location["callFrames"][0]["callFrameId"].Value<string>();
        ...
        public static TheoryData<string, string, string> ShadowMethodArgsTestData =>
            new TheoryData<string, string, string>
            {
                {
                    "DebuggerTests.EvaluateTestsClassWithProperties",
                    "EvaluateShadow",
                    "DebuggerTests.EvaluateTestsClassWithProperties.EvaluateShadow"
                },
                {
                    "DebuggerTests.EvaluateTestsClassWithProperties",
                    "EvaluateShadowAsync",
                    "DebuggerTests.EvaluateTestsClassWithProperties.EvaluateShadowAsync"
                },
                {
                    "DebuggerTests.EvaluateTestsStructWithProperties",
                    "EvaluateShadow",
                    "DebuggerTests.EvaluateTestsStructWithProperties.EvaluateShadow"
                },
                {
                    "DebuggerTests.EvaluateTestsStructWithProperties",
                    "EvaluateShadowAsync",
                    "DebuggerTests.EvaluateTestsStructWithProperties.EvaluateShadowAsync"
                },
            };
        ...
        public async Task LocalsAndArgsShadowingThisMembers(
            ...
            await CheckInspectLocalsAtBreakpointSite(
                ...
                2,
                bp_function_name,
                "window.setTimeout(function() { invoke_static_method ('[debugger-test] "
                    + type_name
                    + ":run'); })",
                wait_for_event_fn: async (pause_location) =>
                {
                    ...
                    async Task CheckExpressions(string prefix, DateTime dateTime)
                    {
                        await EvaluateOnCallFrameAndCheck(
                            ...
                            (
                                prefix + "dateTime.TimeOfDay.Minutes",
                                TNumber(dateTime.TimeOfDay.Minutes)
                            ),
                            (
                                prefix + "dateTime.TimeOfDay",
                                TValueType("System.TimeSpan", dateTime.TimeOfDay.ToString())
                            )
                        );
                    }
        ...
        public async Task EvaluateOnPreviousFrames(string type_name, bool is_valuetype) =>
            await CheckInspectLocalsAtBreakpointSite(
                type_name,
                "EvaluateShadow",
                1,
                $"{type_name}.EvaluateShadow",
                ...
                wait_for_event_fn: async (pause_location) =>
                {
                    ...
                    // check frame2
                    {
                        ...
                        await EvaluateOnCallFrameAndCheck(
                            id2,
                            ("obj", is_valuetype ? TValueType(type_name) : TObject(type_name))
                        );
                    }
                }
            );
        ...
        public async Task JSEvaluate()
        {
            ...
            await EvaluateOnCallFrameFail(id, ("me.foo", null), ("obj.foo.bar", null));

            await EvaluateOnCallFrame(id, "obj.foo", expect_ok: true);
        }

        [ConditionalFact(nameof(RunningOnChrome))]
        public async Task NegativeTestsInInstanceMethod() =>
            await CheckInspectLocalsAtBreakpointSite(
                "DebuggerTests.EvaluateTestsClass.TestEvaluate",
                "run",
                9,
        ...
        [ConditionalFact(nameof(RunningOnChrome))]
        public async Task NegativeTestsInStaticMethod() =>
            await CheckInspectLocalsAtBreakpointSite(
                "DebuggerTests.EvaluateTestsClass",
                "EvaluateLocals",
                9,
        ...
        public async Task EvaluatePropertyThatThrows() =>
            await CheckInspectLocalsAtBreakpointSite(
                "DebuggerTests.EvaluateTestsClassWithProperties",
                "InstanceMethod", /*line_offset*/
                1,
                "DebuggerTests.EvaluateTestsClassWithProperties.InstanceMethod",
                ...
                wait_for_event_fn: async (pause_location) =>
                {
                    ...
                    await EvaluateOnCallFrameAndCheck(
                        id,
                        ("this.PropertyThrowException", TString("System.Exception: error"))
                    );
                }
            );
        ...
        )
        {
            foreach (var arg in args)
            {
                ...
                if (arg.class_name != null)
                    AssertEqual(
                        arg.class_name,
                        res.Error["result"]?["className"]?.Value<string>(),
                        $"Error className did not match for expression '{arg.expression}'"
                    );
            }
        }

        [ConditionalFact(nameof(RunningOnChrome))]
        public async Task EvaluateSimpleMethodCallsError() =>
            await CheckInspectLocalsAtBreakpointSite(
                "DebuggerTests.EvaluateMethodTestsClass.TestEvaluate",
                "run",
                9,
                "DebuggerTests.EvaluateMethodTestsClass.TestEvaluate.run",
                ...
                wait_for_event_fn: async (pause_location) =>
                {
                    ...
                    (_, res) = await EvaluateOnCallFrame(
                        id,
                        "this.objToTest.MyMethod(1)",
                        expect_ok: false
                    );
                    Assert.Equal(
                    ...
                    (_, res) = await EvaluateOnCallFrame(
                        id,
                        "this.CallMethodWithParm(\"1\")",
                        expect_ok: false
                    );
                    Assert.Contains(
                        "No implementation of method 'CallMethodWithParm' matching 'this.CallMethodWithParm(\"1\")' found in type DebuggerTests.EvaluateMethodTestsClass.TestEvaluate.",
                        res.Error["result"]?["description"]?.Value<string>()
                    );

                    (_, res) = await EvaluateOnCallFrame(
                        id,
                        "this.ParmToTestObjNull.MyMethod()",
                        expect_ok: false
                    );
                    Assert.Equal(
                        "Expression 'this.ParmToTestObjNull.MyMethod' evaluated to null",
                        res.Error["message"]?.Value<string>()
                    );

                    (_, res) = await EvaluateOnCallFrame(
                        id,
                        "this.ParmToTestObjException.MyMethod()",
                        expect_ok: false
                    );
                    Assert.Equal(
                        "Method 'MyMethod' not found in type 'string'",
                        res.Error["result"]?["description"]?.Value<string>()
                    );
                }
            );
        ...
        [Fact]
        public async Task EvaluateSimpleMethodCallsWithoutParms() =>
            await CheckInspectLocalsAtBreakpointSite(
                "DebuggerTests.EvaluateMethodTestsClass.TestEvaluate",
                "run",
                9,
                ...
                wait_for_event_fn: async (pause_location) =>
                {
                    ...
                    await EvaluateOnCallFrameAndCheck(
                        ...
                        (
                            "this.ParmToTestObj.ToString()",
                            TString("DebuggerTests.EvaluateMethodTestsClass+ParmToTest")
                        ),
        ...
        [Fact]
        public async Task EvaluateSimpleMethodCallsWithConstParms() =>
            await CheckInspectLocalsAtBreakpointSite(
                "DebuggerTests.EvaluateMethodTestsClass.TestEvaluate",
                "run",
                9,
                ...
                wait_for_event_fn: async (pause_location) =>
                {
                    ...
                    await EvaluateOnCallFrameAndCheck(
                        ...
                        (
                            "this.CallMethodWithParmString_\u03BB(\"\uD83D\uDE80\")",
                            TString("\u03BB_\uD83D\uDE80")
                        ),
        ...
        [Fact]
        public async Task EvaluateSimpleMethodCallsWithVariableParms() =>
            await CheckInspectLocalsAtBreakpointSite(
                "DebuggerTests.EvaluateMethodTestsClass.TestEvaluate",
                "run",
                9,
                ...
                wait_for_event_fn: async (pause_location) =>
                {
                    ...
                    await EvaluateOnCallFrameAndCheck(
                        ...
                        (
                            "this.CallMethodWithParmString(this.str)",
                            TString("str_const_str_const_")
                        ),
        ...
        [ConditionalFact(nameof(RunningOnChrome))]
        public async Task EvaluateIndexingNegative() =>
            await CheckInspectLocalsAtBreakpointSite(
                "DebuggerTests.EvaluateLocalsWithIndexingTests",
                "EvaluateLocals",
                5,
                ...
                wait_for_event_fn: async (pause_location) =>
                {
                    ...
                    Assert.Equal(
                        "Unable to evaluate element access 'f.idx0[2]': Cannot apply indexing with [] to a primitive object of type 'number'",
                        res.Error["message"]?.Value<string>()
                    );
                    (_, res) = await EvaluateOnCallFrame(id, "f[1]", expect_ok: false);
                    Assert.Equal(
                        "Unable to evaluate element access 'f[1]': Cannot apply indexing with [] to an object of type 'DebuggerTests.EvaluateLocalsWithIndexingTests.TestEvaluate'",
                        res.Error["message"]?.Value<string>()
                    );
                }
            );
        ...
        [Fact]
        public async Task EvaluateIndexingsByConstant() =>
            await CheckInspectLocalsAtBreakpointSite(
                "DebuggerTests.EvaluateLocalsWithIndexingTests",
                "EvaluateLocals",
                5,
        ...
        [Fact]
        public async Task EvaluateIndexingByLocalVariable() =>
            await CheckInspectLocalsAtBreakpointSite(
                "DebuggerTests.EvaluateLocalsWithIndexingTests",
                "EvaluateLocals",
                5,
        ...
        [Fact]
        public async Task EvaluateObjectIndexingByNonIntConst() =>
            await CheckInspectLocalsAtBreakpointSite(
                "DebuggerTests.EvaluateLocalsWithIndexingTests",
                "EvaluateLocals",
                5,
        ...
        [Fact]
        public async Task EvaluateNestedObjectIndexingByNonIntLocals() =>
            await CheckInspectLocalsAtBreakpointSite(
                "DebuggerTests.EvaluateLocalsWithIndexingTests",
                "EvaluateLocals",
                12,
        ...
        [Fact]
        public async Task EvaluateIndexingByExpression() =>
            await CheckInspectLocalsAtBreakpointSite(
                "DebuggerTests.EvaluateLocalsWithIndexingTests",
                "EvaluateLocals",
                5,
        ...
        [Fact]
        public async Task EvaluateIndexingByExpressionMultidimensional() =>
            await CheckInspectLocalsAtBreakpointSite(
                "DebuggerTests.EvaluateLocalsWithMultidimensionalIndexingTests",
                "EvaluateLocals",
                5,
                "DebuggerTests.EvaluateLocalsWithMultidimensionalIndexingTests.EvaluateLocals",
        ...
        [ConditionalFact(nameof(RunningOnChrome))]
        public async Task EvaluateIndexingByExpressionNegative() =>
            await CheckInspectLocalsAtBreakpointSite(
                "DebuggerTests.EvaluateLocalsWithIndexingTests",
                "EvaluateLocals",
                5,
                ...
                wait_for_event_fn: async (pause_location) =>
                {
                    ...
                    Assert.Equal(
                        "Unable to evaluate element access 'f.numList[\"a\" + 1]': Cannot index with an object of type 'string'",
                        res.Error["message"]?.Value<string>()
                    );
                }
            );
        ...
        [ConditionalFact(nameof(RunningOnChrome))]
        public async Task EvaluateIndexingByExpressionContainingUnknownIdentifier() =>
            await CheckInspectLocalsAtBreakpointSite(
                "DebuggerTests.EvaluateLocalsWithIndexingTests",
                "EvaluateLocals",
                5,
        ...
        [Fact]
        public async Task EvaluateIndexingByMemberVariables() =>
            await CheckInspectLocalsAtBreakpointSite(
                "DebuggerTests.EvaluateLocalsWithIndexingTests",
                "EvaluateLocals",
                5,
        ...
        [Fact]
        public async Task EvaluateIndexingNested() =>
            await CheckInspectLocalsAtBreakpointSite(
                "DebuggerTests.EvaluateLocalsWithIndexingTests",
                "EvaluateLocals",
                5,
        ...
        [ConditionalFact(nameof(RunningOnChrome))]
        public async Task EvaluateIndexingMultidimensional() =>
            await CheckInspectLocalsAtBreakpointSite(
                "DebuggerTests.EvaluateLocalsWithMultidimensionalIndexingTests",
                "EvaluateLocals",
                5,
        ...
        [ConditionalFact(nameof(RunningOnChrome))]
        public async Task EvaluateIndexingJagged() =>
            await CheckInspectLocalsAtBreakpointSite(
                "DebuggerTests.EvaluateLocalsWithIndexingTests",
                "EvaluateLocals",
                5,
        ...
        [ConditionalFact(nameof(RunningOnChrome))]
        public async Task EvaluateSimpleMethodCallsCheckChangedValue() =>
            await CheckInspectLocalsAtBreakpointSite(
                "DebuggerTests.EvaluateMethodTestsClass.TestEvaluate",
                "run",
                9,
        ...
        [Theory]
        [InlineData(
            "DebuggerTestsV2.EvaluateStaticFieldsInStaticClass",
            "Run",
            "DebuggerTestsV2",
        ...
        [InlineData(
            "DebuggerTests.EvaluateStaticFieldsInStaticClass",
            "Run",
            "DebuggerTests",
            "EvaluateStaticFieldsInStaticClass",
            "EvaluateMethods",
        ...
        [InlineData(
            ...
            "DebuggerTests",
            "EvaluateStaticFieldsInStaticClass",
            "EvaluateMethodsAsync",
            1,
            1
        )]
        [InlineData(
            "DebuggerTests.EvaluateStaticFieldsInInstanceClass",
            "RunStatic",
            "DebuggerTests",
            "EvaluateStaticFieldsInInstanceClass",
            "EvaluateMethods",
            1,
            7
        )]
                ...
                wait_for_event_fn: async (pause_location) =>
                {
                    ...
                    foreach (var pad in new[] { String.Empty, "  " })
                    {
                        await EvaluateOnCallFrameAndCheck(
                            id,
                            (
                                $"{pad}{namespaceName}.{className}.StaticField",
                                TNumber(expectedInt * 10)
                            ),
                            (
                                $"{pad}{namespaceName}{pad}.{className}.{pad}StaticProperty",
                                TString($"StaticProperty{expectedInt}")
                            ),
                            (
                                $"{namespaceName}.{pad}{className}.StaticPropertyWithError",
                                TString($"System.Exception: not implemented {expectedInt}")
                            ),
                            ($"{pad}{className}.{pad}StaticField", TNumber(expectedInt * 10)),
                            (
                                $"{pad}{pad}{className}.StaticProperty",
                                TString($"StaticProperty{expectedInt}")
                            ),
                            (
                                $"{pad}{className}.StaticPropertyWithError",
                                TString($"System.Exception: not implemented {expectedInt}")
                            ),
                            ($"{pad}StaticField{pad}", TNumber(expectedInt * 10)),
                            ($"{pad}StaticProperty", TString($"StaticProperty{expectedInt}")),
                            (
                                $"{pad}StaticPropertyWithError",
                                TString($"System.Exception: not implemented {expectedInt}")
                            )
                        );
                    }
        ...
        [ConditionalFact(nameof(RunningOnChrome))]
        public async Task EvaluateStaticClassesNested() =>
            await CheckInspectLocalsAtBreakpointSite(
                "DebuggerTests.EvaluateMethodTestsClass",
                "EvaluateMethods",
                3,
                "DebuggerTests.EvaluateMethodTestsClass.EvaluateMethods",
                "window.setTimeout(function() { invoke_static_method ('[debugger-test] DebuggerTests.EvaluateMethodTestsClass:EvaluateMethods'); })",
                wait_for_event_fn: async (pause_location) =>
                {
                    var id = pause_location["callFrames"][0]["callFrameId"].Value<string>();
                    foreach (var pad in new[] { String.Empty, "  " })
                    {
                        await EvaluateOnCallFrameAndCheck(
                            id,
                            (
                                $"{pad}DebuggerTests{pad}.EvaluateStaticFieldsInStaticClass.NestedClass1.{pad}NestedClass2.NestedClass3.{pad}StaticField",
                                TNumber(3)
                            ),
                            (
                                $"{pad}DebuggerTests.EvaluateStaticFieldsInStaticClass.NestedClass1.NestedClass2.NestedClass3.StaticProperty",
                                TString("StaticProperty3")
                            ),
                            (
                                $"{pad}{pad}DebuggerTests.{pad}EvaluateStaticFieldsInStaticClass.NestedClass1.NestedClass2.NestedClass3.{pad}StaticPropertyWithError",
                                TString("System.Exception: not implemented 3")
                            ),
                            (
                                $"EvaluateStaticFieldsInStaticClass.{pad}NestedClass1.{pad}NestedClass2.NestedClass3.StaticField",
                                TNumber(3)
                            ),
                            (
                                $"EvaluateStaticFieldsInStaticClass.NestedClass1.{pad}{pad}NestedClass2.NestedClass3.{pad}StaticProperty",
                                TString("StaticProperty3")
                            ),
                            (
                                $"{pad}EvaluateStaticFieldsInStaticClass.NestedClass1.{pad}NestedClass2.{pad}NestedClass3.StaticPropertyWithError",
                                TString("System.Exception: not implemented 3")
                            )
                        );
                    }
        ...
        [Fact]
        public async Task EvaluateStaticClassesNestedWithNoNamespace() =>
            await CheckInspectLocalsAtBreakpointSite(
                "NoNamespaceClass",
                "EvaluateMethods",
                1,
                "NoNamespaceClass.EvaluateMethods",
                ...
                wait_for_event_fn: async (pause_location) =>
                {
                    ...
                    foreach (var pad in new[] { String.Empty, "  " })
                    {
                        await EvaluateOnCallFrameAndCheck(
                            id,
                            (
                                $"{pad}NoNamespaceClass.NestedClass1.NestedClass2.{pad}NestedClass3.StaticField",
                                TNumber(30)
                            ),
                            (
                                $"NoNamespaceClass.NestedClass1.{pad}NestedClass2.NestedClass3.StaticProperty",
                                TString("StaticProperty30")
                            ),
                            (
                                $"NoNamespaceClass.{pad}NestedClass1.NestedClass2.NestedClass3.{pad}StaticPropertyWithError",
                                TString("System.Exception: not implemented 30")
                            )
                        );
                    }
                }
        ...
        [Fact]
        public async Task EvaluateStaticClassesNestedWithSameNames() =>
            await CheckInspectLocalsAtBreakpointSite(
                "NestedWithSameNames.B.NestedWithSameNames.B",
                "Run",
                1,
                "NestedWithSameNames.B.NestedWithSameNames.B.Run",
                ...
                wait_for_event_fn: async (pause_location) =>
                {
                    ...
                    foreach (var pad in new[] { String.Empty, "  " })
                    {
                        await EvaluateOnCallFrameAndCheck(
                            ...
                            (
                                $"B.{pad}StaticPropertyWithError{pad}",
                                TString("System.Exception: not implemented V4")
                            )
                        );
                        await CheckEvaluateFail(
                            id,
                            (
                                $"{pad}NestedWithSameNames.B.{pad}StaticField",
                                GetPrimitiveHasNoMembersMessage("B")
                            ),
                            (
                                $"NestedWithSameNames.{pad}B.StaticProperty",
                                GetPrimitiveHasNoMembersMessage("B")
                            ),
                            (
                                $"{pad}NestedWithSameNames{pad}.{pad}B.StaticPropertyWithError",
                                GetPrimitiveHasNoMembersMessage("B")
                            ),
                            (
                                $"{pad}NestedWithSameNames.B.{pad}NestedWithSameNames",
                                GetPrimitiveHasNoMembersMessage("B")
                            ),
                            (
                                $"B.NestedWithSameNames.{pad}B{pad}.StaticField",
                                GetPrimitiveHasNoMembersMessage("B")
                            ),
                            (
                                $"{pad}B.NestedWithSameNames.{pad}B.StaticProperty",
                                GetPrimitiveHasNoMembersMessage("B")
                            ),
                            (
                                $"B.NestedWithSameNames{pad}.B.{pad}StaticPropertyWithError",
                                GetPrimitiveHasNoMembersMessage("B")
                            ),
                            (
                                $"{pad}NestedWithSameNames.B{pad}.NestedWithSameNames.B{pad}.NestedWithSameNames{pad}",
                                GetPrimitiveHasNoMembersMessage("B")
                            ),
                            (
                                $"NestedWithSameNames.B{pad}.{pad}{pad}NestedWithDifferentName.B.{pad}StaticField",
                                GetPrimitiveHasNoMembersMessage("B")
                            ),
                            (
                                $"{pad}NestedWithSameNames.B.NestedWithDifferentName.B.StaticProperty",
                                GetPrimitiveHasNoMembersMessage("B")
                            ),
                            (
                                $"NestedWithSameNames.{pad}B.{pad}NestedWithDifferentName.B.{pad}StaticPropertyWithError",
                                GetPrimitiveHasNoMembersMessage("B")
                            )
                        );
                    }
                    string GetPrimitiveHasNoMembersMessage(string name) =>
                        $"Cannot find member '{name}' on a primitive type";
                }
            );
                ...
                wait_for_event_fn: async (pause_location) =>
                {
                    ...
                    foreach (var pad in new[] { String.Empty, "  " })
                    {
                        await EvaluateOnCallFrameAndCheck(
                            ...
                            (
                                $"{pad}{namespaceName}.{pad}{className}.StaticField{pad}",
                                TNumber(expectedInt * 10)
                            ),
                            ($"{pad}StaticProperty", TString($"StaticProperty2")),
                            (
                                $"{pad}{namespaceName}.{pad}{className}.StaticProperty",
                                TString($"StaticProperty{expectedInt}")
                            ),
                            (
                                $"{pad}StaticPropertyWithError",
                                TString($"System.Exception: not implemented 2")
                            ),
                            (
                                $"{pad}{namespaceName}{pad}.{pad}{className}.StaticPropertyWithError",
                                TString($"System.Exception: not implemented {expectedInt}")
                            )
                        );
                        ...
                        if (!isFromDifferentNamespace)
                        {
                            await EvaluateOnCallFrameAndCheck(
                                ...
                                (
                                    $"{className}{pad}.StaticProperty{pad}",
                                    TString($"StaticProperty{expectedInt}")
                                ),
                                (
                                    $"{className}{pad}.{pad}StaticPropertyWithError",
                                    TString($"System.Exception: not implemented {expectedInt}")
                                )
                            );
                        }
                        ...
                        await EvaluateOnCallFrameAndCheck(
                            id_second,
                            (
                                $"{pad}{namespaceName}.{pad}{className}.{pad}StaticField",
                                TNumber(expectedInt * 10)
                            ),
                            ($"{pad}{className}.StaticField", TNumber(expectedIntInPrevFrame * 10)),
                            (
                                $"{namespaceName}{pad}.{pad}{className}.StaticProperty",
                                TString($"StaticProperty{expectedInt}")
                            ),
                            (
                                $"{pad}{className}.StaticProperty",
                                TString($"StaticProperty{expectedIntInPrevFrame}")
                            ),
                            (
                                $"{pad}{namespaceName}.{className}.StaticPropertyWithError",
                                TString($"System.Exception: not implemented {expectedInt}")
                            ),
                            (
                                $"{className}{pad}.StaticPropertyWithError{pad}",
                                TString(
                                    $"System.Exception: not implemented {expectedIntInPrevFrame}"
                                )
                            )
                        );
                        ...
                        await CheckEvaluateFail(
                            ...
                            (
                                ...
                                GetNonExistingVarMessage("StaticProperty")
                            ),
                            (
                                $"{pad}StaticPropertyWithError{pad}",
                                GetNonExistingVarMessage("StaticPropertyWithError")
                            )
                        );
                    }
                    string GetNonExistingVarMessage(string name) =>
                        $"The name {name} does not exist in the current context";
                }
            );

        [ConditionalFact(nameof(RunningOnChrome))]
        public async Task EvaluateStaticClassInvalidField() =>
            await CheckInspectLocalsAtBreakpointSite(
                "DebuggerTests.EvaluateMethodTestsClass.TestEvaluate",
                "run",
                9,
                ...
                wait_for_event_fn: async (pause_location) =>
                {
                    ...
                    AssertEqual(
                        "Failed to resolve member access for DebuggerTests.EvaluateStaticFieldsInStaticClass.StaticProperty2",
                        res.Error["result"]?["description"]?.Value<string>(),
                        "wrong error message"
                    );
                    ...
                    (_, res) = await EvaluateOnCallFrame(
                        id,
                        "DebuggerTests.InvalidEvaluateStaticClass.StaticProperty2",
                        expect_ok: false
                    );
                    AssertEqual(
                        "Failed to resolve member access for DebuggerTests.InvalidEvaluateStaticClass.StaticProperty2",
                        res.Error["result"]?["description"]?.Value<string>(),
                        "wrong error message"
                    );
                }
        ...
        [ConditionalFact(nameof(RunningOnChrome))]
        public async Task AsyncLocalsInContinueWithBlock() =>
            await CheckInspectLocalsAtBreakpointSite(
                "DebuggerTests.AsyncTests.ContinueWithTests",
                "ContinueWithStaticAsync",
                4,
                "DebuggerTests.AsyncTests.ContinueWithTests.ContinueWithStaticAsync.AnonymousMethod__3_0",
                ...
                wait_for_event_fn: async (pause_location) =>
                {
                    ...
                    await EvaluateOnCallFrameAndCheck(
                        ...
                        (
                            $"t.Status",
                            TEnum("System.Threading.Tasks.TaskStatus", "RanToCompletion")
                        ),
                        (
                            $"  t.Status",
                            TEnum("System.Threading.Tasks.TaskStatus", "RanToCompletion")
        ...
        [ConditionalFact(nameof(RunningOnChrome))]
        public async Task EvaluateConstantValueUsingRuntimeEvaluate() =>
            await CheckInspectLocalsAtBreakpointSite(
                "DebuggerTests.EvaluateTestsClass",
                "EvaluateLocals",
                9,
        ...
        [InlineData(
            "EvaluateBrowsableClassStatic",
            "TestEvaluatePropertiesNone",
            "testPropertiesNone",
            10
        )]
        [InlineData(
            "EvaluateBrowsableStructStatic",
        ...
        [InlineData(
            "EvaluateBrowsableNonAutoPropertiesClass",
            "TestEvaluatePropertiesNone",
            "testPropertiesNone",
            5,
            true
        ...
        [InlineData(
            "EvaluateBrowsableNonAutoPropertiesStruct",
            "TestEvaluatePropertiesNone",
            "testPropertiesNone",
            5,
            true
        ...
        [InlineData(
            "EvaluateBrowsableNonAutoPropertiesClassStatic",
            "TestEvaluatePropertiesNone",
            "testPropertiesNone",
            5,
            true
        ...
        [InlineData(
            "EvaluateBrowsableNonAutoPropertiesStructStatic",
            "TestEvaluatePropertiesNone",
            "testPropertiesNone",
            5,
            true
        ...
        public async Task EvaluateBrowsableNone(
            ...
            string localVarName,
            int breakLine,
            bool allMembersAreProperties = false
        ) =>
            await CheckInspectLocalsAtBreakpointSite(
                $"DebuggerTests.{outerClassName}",
                "Evaluate",
                breakLine,
                $"DebuggerTests.{outerClassName}.Evaluate",
                ...
                wait_for_event_fn: async (pause_location) =>
                {
                    ...
                    await CheckValue(
                        testNone,
                        TObject($"DebuggerTests.{outerClassName}.{className}"),
                        nameof(testNone)
                    );
                    ...
                    if (allMembersAreProperties)
                        await CheckProps(
                            ...
                            new
                            {
                                ...
                                valueTypeEnum = TGetter(
                                    "valueTypeEnum",
                                    TEnum("DebuggerTests.SampleEnum", "yes")
                                ),
                                sampleStruct = TGetter(
                                    "sampleStruct",
                                    TObject(
                                        "DebuggerTests.SampleStructure",
                                        description: "DebuggerTests.SampleStructure"
                                    )
                                ),
                                sampleClass = TGetter(
                                    "sampleClass",
        ...
        public async Task EvaluateBrowsableNever(
            string outerClassName,
            string className,
            string localVarName,
            int breakLine
            ...
            await CheckInspectLocalsAtBreakpointSite(
                ...
                wait_for_event_fn: async (pause_location) =>
                {
                    ...
                    var testNeverProps = await GetProperties(
                        testNever["objectId"]?.Value<string>()
                    );
                    await CheckProps(testNeverProps, new { }, "testNeverProps#1");
                }
            );
            ...
            await CheckInspectLocalsAtBreakpointSite(
                ...
                wait_for_event_fn: async (pause_location) =>
                {
                    ...
                    await CheckValue(
                        testCollapsed,
                        TObject($"DebuggerTests.{outerClassName}.{className}"),
                        nameof(testCollapsed)
                    );
                    var testCollapsedProps = await GetProperties(
                        testCollapsed["objectId"]?.Value<string>()
                    );
                    if (allMembersAreProperties)
                        await CheckProps(
                            testCollapsedProps,
                            new
                            {
                                ...
                                arrayCollapsed = TGetter(
                                    "arrayCollapsed",
                                    TObject("int[]", description: "int[2]")
                                ),
                                textCollapsed = TGetter("textCollapsed", TString("textCollapsed")),
                                nullCollapsed = TGetter(
                                    "nullCollapsed",
                                    TObject("bool[]", is_null: true)
                                ),
                                valueTypeEnumCollapsed = TGetter(
                                    "valueTypeEnumCollapsed",
                                    TEnum("DebuggerTests.SampleEnum", "yes")
                                ),
                                sampleStructCollapsed = TGetter(
                                    "sampleStructCollapsed",
                                    TObject(
                                        "DebuggerTests.SampleStructure",
                                        description: "DebuggerTests.SampleStructure"
                                    )
                                ),
                                sampleClassCollapsed = TGetter(
                                    "sampleClassCollapsed",
                                    TObject(
                                        "DebuggerTests.SampleClass",
                                        description: "DebuggerTests.SampleClass"
                                    )
        ...
        [InlineData(
            "EvaluateBrowsableClass",
            "TestEvaluateFieldsRootHidden",
            "testFieldsRootHidden",
            10
        )]
        [InlineData(
            "EvaluateBrowsableClass",
            "TestEvaluatePropertiesRootHidden",
            ...
            await CheckInspectLocalsAtBreakpointSite(
                ...
                wait_for_event_fn: async (pause_location) =>
                {
                    ...
                    await CheckValue(
                        testRootHidden,
                        TObject($"DebuggerTests.{outerClassName}.{className}"),
                        nameof(testRootHidden)
                    );
                    var testRootHiddenProps = await GetProperties(
                        testRootHidden["objectId"]?.Value<string>()
                    );
                    ...
                    JObject[] expectedTestRootHiddenProps = new[]
                    {
                        ...
                        JObject.FromObject(
                            new { value = TNumber(11), name = "arrayRootHidden[0]" }
                        ),
                        JObject.FromObject(
                            new { value = TNumber(22), name = "arrayRootHidden[1]" }
                        ),
                        JObject.FromObject(
                            new { value = TNumber(100), name = "sampleStructRootHidden.Id" }
                        ),
                        JObject.FromObject(
                            new { value = TBool(true), name = "sampleStructRootHidden.IsStruct" }
                        ),
                        JObject.FromObject(
                            new { value = TNumber(200), name = "sampleClassRootHidden.ClassId" }
                        ),
                        JObject.FromObject(
                            new
                            {
        ...
        [ConditionalFact(nameof(RunningOnChrome))]
        public async Task EvaluateStaticAttributeInAssemblyNotRelatedButLoaded() =>
            await CheckInspectLocalsAtBreakpointSite(
                "DebuggerTests.EvaluateTestsClass",
                "EvaluateLocals",
                9,
                ...
                wait_for_event_fn: async (pause_location) =>
                {
                    await RuntimeEvaluateAndCheck(("ClassToBreak.valueToCheck", TNumber(10)));
                }
            );
        ...
        public async Task EvaluateLocalObjectFromAssemblyNotRelatedButLoaded() =>
            await CheckInspectLocalsAtBreakpointSite(
                "DebuggerTests.EvaluateTestsClass",
                "EvaluateLocalsFromAnotherAssembly",
                5,
                "DebuggerTests.EvaluateTestsClass.EvaluateLocalsFromAnotherAssembly",
                ...
                wait_for_event_fn: async (pause_location) =>
                {
                    await RuntimeEvaluateAndCheck(("a.valueToCheck", TNumber(20)));
                }
            );

        [ConditionalFact(nameof(RunningOnChrome))]
        public async Task StructureGetters() =>
            await CheckInspectLocalsAtBreakpointSite(
                "DebuggerTests.StructureGetters",
                "Evaluate",
                2,
                $"DebuggerTests.StructureGetters.Evaluate",
                ...
                wait_for_event_fn: async (pause_location) =>
                {
                    ...
                    await CheckProps(props, new { Id = TGetter("Id", TNumber(123)) }, "s#1");
                }
            );

        [ConditionalFact(nameof(RunningOnChrome))]
        public async Task EvaluateMethodWithDefaultParam() =>
            await CheckInspectLocalsAtBreakpointSite(
                $"DebuggerTests.DefaultParamMethods",
                "Evaluate",
                2,
                "DebuggerTests.DefaultParamMethods.Evaluate",
                ...
                wait_for_event_fn: async (pause_location) =>
                {
                    ...
                    await EvaluateOnCallFrameAndCheck(
                        ...
                        (
                            "test.GetDefaultAndRequiredParamMixedTypes(\"a\")",
                            TString("a; -1; False")
                        ),
                        (
                            "test.GetDefaultAndRequiredParamMixedTypes(\"a\", 23)",
                            TString("a; 23; False")
                        ),
                        (
                            "test.GetDefaultAndRequiredParamMixedTypes(\"a\", 23, true)",
                            TString("a; 23; True")
                        )
                    );
                    ...
                    var (_, res) = await EvaluateOnCallFrame(
                        id,
                        "test.GetDefaultAndRequiredParamMixedTypes(\"a\", 23, true, 1.23f)",
                        expect_ok: false
                    );
                    AssertEqual(
        ...
        [Fact]
        public async Task EvaluateMethodWithLinq() =>
            await CheckInspectLocalsAtBreakpointSite(
                $"DebuggerTests.DefaultParamMethods",
                "Evaluate",
                2,
        ...
        [ConditionalFact(nameof(RunningOnChrome))]
        public async Task EvaluateNullObjectPropertiesPositive() =>
            await CheckInspectLocalsAtBreakpointSite(
                $"DebuggerTests.EvaluateNullableProperties",
                "Evaluate",
                11,
                "DebuggerTests.EvaluateNullableProperties.Evaluate",
                ...
                wait_for_event_fn: async (pause_location) =>
                {
                    ...
                    await EvaluateOnCallFrameAndCheck(
                        ...
                        (
                            "listNull",
                            TObject("System.Collections.Generic.List<int>", is_null: true)
                        ),
                        (
                            "listNull?.Count",
                            TObject("System.Collections.Generic.List<int>", is_null: true)
                        ...
                        (
                            "tcNull?.MemberListNull?.Count",
                            TObject(
                                "DebuggerTests.EvaluateNullableProperties.TestClass",
                                is_null: true
                            )
                        ),
        ...
        [Fact]
        public async Task EvaluateNullObjectPropertiesNegative() =>
            await CheckInspectLocalsAtBreakpointSite(
                $"DebuggerTests.EvaluateNullableProperties",
                "Evaluate",
                6,
                ...
                wait_for_event_fn: async (pause_location) =>
                {
                    ...
                    await CheckEvaluateFail(
                        ...
                        (
                            "tcNull.MemberListNull.Count",
                            GetNullReferenceErrorOn("\"MemberListNull\"")
                        ),
                        ("tc.MemberListNull.Count", GetNullReferenceErrorOn("\"Count\"")),
                        ("tcNull?.MemberListNull.Count", GetNullReferenceErrorOn("\"Count\"")),
                        (
                            "listNull?.Count.NonExistingProperty",
                            GetNullReferenceErrorOn("\"NonExistingProperty\"")
                        ),
                        ("tc?.MemberListNull! .Count", GetNullReferenceErrorOn("\"Count\"")),
                        ("tc?. MemberListNull!.Count", GetNullReferenceErrorOn("\"Count\"")),
                        ("tc?.MemberListNull.Count", GetNullReferenceErrorOn("\"Count\"")),
                        ...
                        ("tc!.MemberListNull. Count", GetNullReferenceErrorOn("\"Count\"")),
                        (
                            "tcNull?.Sibling.MemberListNull?.Count",
                            GetNullReferenceErrorOn("\"MemberListNull?\"")
                        ),
                    ...
                    string GetNullReferenceErrorOn(string name) =>
                        $"Expression threw NullReferenceException trying to access {name} on a null-valued object.";
                }
            );

        [Fact]
        public async Task EvaluateMethodsOnPrimitiveTypesReturningPrimitives() =>
            await CheckInspectLocalsAtBreakpointSite(
                "DebuggerTests.PrimitiveTypeMethods",
                "Evaluate",
                11,
                "DebuggerTests.PrimitiveTypeMethods.Evaluate",
            ...
            await CheckInspectLocalsAtBreakpointSite(
                ...
                wait_for_event_fn: async (pause_location) =>
                {
                    ...
                    await EvaluateOnCallFrameAndCheck(
                        id,
                        (
                            "test.propFloat.ToString()",
                            TString(floatMemberVal["description"]?.Value<string>())
                        ),
                        (
                            "test.propDouble.ToString()",
                            TString(doubleMemberVal["description"]?.Value<string>())
                        ),
                        (
                            "localFloat.ToString()",
                            TString(floatLocalVal["description"]?.Value<string>())
                        ),
                        (
                            "localDouble.ToString()",
                            TString(doubleLocalVal["description"]?.Value<string>())
                        )
                    );
                }
            );
        ...
        [Fact]
        public async Task EvaluateMethodsOnPrimitiveTypesReturningObjects() =>
            await CheckInspectLocalsAtBreakpointSite(
                "DebuggerTests.PrimitiveTypeMethods",
                "Evaluate",
                11,
                ...
                wait_for_event_fn: async (pause_location) =>
                {
                    ...
                    var (res, _) = await EvaluateOnCallFrame(
                        id,
                        "test.propString.Split('_', 3, System.StringSplitOptions.TrimEntries)"
                    );
                    ...
                    (res, _) = await EvaluateOnCallFrame(
                        id,
                        "localString.Split('*', 3, System.StringSplitOptions.RemoveEmptyEntries)"
                    );
        ...
        public async Task EvaluateLocalsInDefaultInterfaceMethod(
            string pauseMethod,
        ...
        public async Task EvaluateLocalsInDefaultInterfaceMethodStatic(
            string pauseMethod,
            string methodInterface,
            string entryMethod,
            bool isAsync = false
                ...
                wait_for_event_fn: async (pause_location) =>
                {
                    ...
                    await EvaluateOnCallFrameAndCheck(
                        ...
                        (
                            ...
                            TString("defaultInterfaceMember")
                        ),
        ...
        [Fact]
        public async Task EvaluateStringProperties() =>
            await CheckInspectLocalsAtBreakpointSite(
                $"DebuggerTests.TypeProperties",
                "Run",
                3,
                "DebuggerTests.TypeProperties.Run",
