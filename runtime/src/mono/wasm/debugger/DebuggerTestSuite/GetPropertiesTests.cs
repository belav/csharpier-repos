...
namespace DebuggerTests
{
    public class GetPropertiesTests : DebuggerTestBase
    {
        ...
        > ClassGetPropertiesTestData(bool is_async)
        {
            ...
            var all_props = new Dictionary<string, (JObject, bool)>()
            {
                ...
                { "DateTimeForOverride", (TGetter("DateTimeForOverride"), true) },
                {
                    ...
                    (TString("DerivedClass#StringPropertyForOverrideWithAutoProperty"), true)
                },
                {
                    "Base_AutoStringPropertyForOverrideWithField",
                    (TString("DerivedClass#Base_AutoStringPropertyForOverrideWithField"), true)
                },
                {
                    "Base_GetterForOverrideWithField",
                    (TString("DerivedClass#Base_GetterForOverrideWithField"), true)
                },
                {
                    "BaseBase_MemberForOverride",
                    (TString("DerivedClass#BaseBase_MemberForOverride"), true)
                },
        ...
        public async Task GetPropertiesTestJSAndManaged(
            ...
            if (test_js)
            {
                filtered_props = obj_props.Children()
            ...
            await CheckExpectedProperties(
                expected_names,
                name =>
                    filtered_props.Where(jt => jt["name"]?.Value<string>() == name)
                        .SingleOrDefault(),
                expected_props
            );
