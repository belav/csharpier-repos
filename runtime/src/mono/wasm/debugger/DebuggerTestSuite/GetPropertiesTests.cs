...
namespace DebuggerTests
{
    public class GetPropertiesTests : DebuggerTests
    {
            ...
            var all_props = new Dictionary<string, (JObject, bool)>()
            {
                ...
                { "BaseBase_PropertyForHidingWithField", (TNumber(210), true) },
                {
                    ...
                    (
                        TGetter(
                            "Base_PropertyForOverridingWithProperty",
                            TDateTime(new DateTime(2020, 7, 6, 5, 4, 3))
                        ),
                        true
                    )
                },
                {
                    ...
                    (
                        TGetter(
                            "BaseBase_PropertyForVHO",
                            TString("Derived#BaseBase_PropertyForVHO")
                        ),
                        true
                    )
                },
                {
                    ...
                    (
                        TGetter(
                            "BaseBase_PropertyForVOH",
                            TString("Derived#BaseBase_PropertyForVOH")
                        ),
                        true
                    )
                },
                // {"BaseBase_PropertyForVOO",                         (TGetter("BaseBase_PropertyForVOO", TString("Derived#BaseBase_PropertyForVOO")), true)}, //FixMe: Issue #69788
                {
                    ...
                    (TString("Derived#BaseBase_AutoPropertyForVHO"), true)
                },
                {
                    "BaseBase_AutoPropertyForVOH",
                    (TString("Derived#BaseBase_AutoPropertyForVOH"), true)
                },
                ...
                // protected / internal:
                {
                    ...
                    (
                        TGetter(
                            "BaseBase_AutoPropertyForHidingWithProperty",
                            TString("Derived#BaseBase_AutoPropertyForHidingWithProperty")
                        ),
                        true
                    )
                },
                {
                    ...
                    (TDateTime(new DateTime(2022, 7, 6, 5, 4, 3)), true)
                },
                {
                    "Base_AutoPropertyForOverridingWithAutoProperty",
                    (TDateTime(new DateTime(2023, 7, 6, 5, 4, 3)), true)
                },
                {
                    ...
                    (
                        TGetter(
                            "Base_AutoPropertyForOverridingWithProperty",
                            TDateTime(new DateTime(2021, 7, 6, 5, 4, 3))
                        ),
                        true
                    )
                },
                // private:
                {
                    ...
                    (TString("Derived#BaseBase_FieldForHidingWithAutoProperty"), true)
                },
                // inherited from Base:
                // public:
                { "BaseBase_AutoPropertyForHidingWithField", (TNumber(115), false) },
                {
                    ...
                    (
                        TGetter(
                            "BaseBase_PropertyForHidingWithProperty",
                            TString("Base#BaseBase_PropertyForHidingWithProperty")
                        ),
                        false
                    )
                },
                {
                    ...
                    (TString("Base#BaseBase_FieldForHidingWithAutoProperty"), false)
                },
                {
                    ...
                    (
                        TGetter(
                            "Base_VirtualPropertyNotOverriddenOrHidden",
                            TDateTime(new DateTime(2124, 5, 7, 1, 9, 2))
                        ),
                        false
                    )
                },
                ...
                { "LastName", (TGetter("LastName", TString("BaseClass#LastName")), false) },
                {
                    ...
                    (
                        TGetter(
                            "BaseBase_PropertyForVOH (BaseClass2)",
                            TString("Base#BaseBase_PropertyForVOH")
                        ),
                        false
                    )
                },
                {
                    "BaseBase_AutoPropertyForVOH (BaseClass2)",
                    (TString("Base#BaseBase_AutoPropertyForVOH"), false)
                },
                // protected / internal:
                ...
                },
                {
                    ...
                    (TString("Base#BaseBase_AutoPropertyForHidingWithAutoProperty"), false)
                },
                // private:
                { "BaseBase_FieldForHidingWithField", (TNumber(105), false) },
                {
                    ...
                    (
                        TGetter(
                            "BaseBase_AutoPropertyForHidingWithProperty (BaseClass2)",
                            TString("Base#BaseBase_AutoPropertyForHidingWithProperty")
                        ),
                        false
                    )
                },
                {
                    ...
                    (TString("Base#BaseBase_PropertyForHidingWithAutoProperty"), false)
                },
                ...
                {
                    "BaseBase_FieldForHidingWithProperty (BaseBaseClass2)",
                    (TString("BaseBase#BaseBase_FieldForHidingWithProperty"), false)
                },
                {
                    ...
                    (
                        TGetter(
                            "BaseBase_PropertyForHidingWithProperty (BaseBaseClass2)",
                            TString("BaseBase#BaseBase_PropertyForHidingWithProperty")
                        ),
                        false
                    )
                },
                {
                    ...
                    (TString("BaseBase#BaseBase_AutoPropertyForHidingWithProperty"), false)
                },
                {
                    "BaseBase_FieldForHidingWithAutoProperty (BaseBaseClass2)",
                    (TString("BaseBase#BaseBase_FieldForHidingWithAutoProperty"), false)
                },
                {
                    ...
                    (
                        TGetter(
                            "BaseBase_PropertyForHidingWithAutoProperty (BaseBaseClass2)",
                            TString("BaseBase#BaseBase_PropertyForHidingWithAutoProperty")
                        ),
                        false
                    )
                },
                {
                    ...
                    (TString("BaseBase#BaseBase_AutoPropertyForHidingWithAutoProperty"), false)
                },
                {
                    ...
                    (
                        TGetter(
                            "BaseBase_PropertyForVHO (BaseBaseClass2)",
                            TString("BaseBase#BaseBase_PropertyForVHO")
                        ),
                        false
                    )
                },
                {
                    "BaseBase_AutoPropertyForVHO (BaseBaseClass2)",
                    (TString("BaseBase#BaseBase_AutoPropertyForVHO"), false)
                },
                // ------------------static members--------------------------
                // own:
                // public:
                ...
                {
                    "S_BaseBase_FieldForHidingWithAutoProperty (BaseClass2)",
                    (TString(null), false)
                },
                // protected / internal:
                ...
                {
                    "S_BaseBase_AutoPropertyForHidingWithField (BaseBaseClass2)",
                    (TNumber(0), false)
                },
                {
                    "S_BaseBase_FieldForHidingWithProperty (BaseBaseClass2)",
                    (TString("BaseBase#BaseBase_FieldForHidingWithProperty"), false)
                },
                {
                ...
                {
                    "S_BaseBase_AutoPropertyForHidingWithProperty (BaseBaseClass2)",
                    (TString(null), false)
                },
                {
                    "S_BaseBase_FieldForHidingWithAutoProperty (BaseBaseClass2)",
                    (TString("BaseBase#BaseBase_FieldForHidingWithAutoProperty"), false)
                },
                {
                ...
                {
                    "S_BaseBase_AutoPropertyForHidingWithAutoProperty (BaseBaseClass2)",
                    (TString(null), false)
                },
            };
        ...
        > StructGetPropertiesTestData(bool is_async)
        {
            ...
            var all_accessor_names = new[] { "_DTProp", "DateTime", "FirstName", "LastName" };
        ...
        public async Task InspectTypeInheritedMembers(
            string type_name,
            bool? own_properties,
            bool? accessors_only,
            ...
            await InspectTypeInheritedMembersInternal(
                type_name,
                own_properties,
                accessors_only,
                expected_names,
        ...
        public async Task MembersForLocalNestedStruct(
            bool? own_properties,
            bool? accessors_only,
            string[] expected_names,
            Dictionary<string, (JObject, bool)> all_props,
            ...
            await CheckInspectLocalsAtBreakpointSite(
                ...
                wait_for_event_fn: async (pause_location) =>
                {
                    ...
                    var cs_props = await GetProperties(
                        cs_obj["value"]?["objectId"]?.Value<string>(),
                    ...
                    await CheckExpectedProperties(
                        expected_names,
                        name => GetAndAssertObjectWithName(cs_props, name),
                        all_props
                    );
        ...
        public static TheoryData<bool, bool?, bool?, string[]> JSGetPropertiesTestData(
            bool test_js
        ) =>
            new TheoryData<bool, bool?, bool?, string[]>
            {
                // default, no args set
                {
                    test_js,
                    null,
                    null,
                    new[] { "owner_name", "owner_last_name", "kind", "make", "available" }
                },
                // all props
                {
                    test_js,
                ...
                // all own
                { test_js, true, false, new[] { "owner_name", "owner_last_name" } },
                // all own accessors
                { test_js, true, true, new[] { "owner_last_name" } },
                // all accessors
                { test_js, false, true, new[] { "available", "owner_last_name" } }
            };
        ...
        public async Task GetPropertiesTestJSAndManaged(
            bool test_js,
            bool? own_properties,
            bool? accessors_only,
            string[] expected_names
        )
        {
            ...
            else
            {
                await SetBreakpointInMethod(
                    "debugger-test.dll",
                    "DebuggerTests.GetPropertiesTests.DerivedClassForJSTest",
                    "run",
                    2
                );
                eval_expr =
                    "window.setTimeout(function() { invoke_static_method ('[debugger-test] DebuggerTests.GetPropertiesTests.DerivedClassForJSTest:run'); }, 1)";
            }
            ...
            if (test_js)
            {
                filtered_props = obj_props
                    .Children()
                    .Where(jt => jt["enumerable"]?.Value<bool>() == true);
            }
            else
            {
            ...
            await CheckExpectedProperties(
                ...
                name =>
                    filtered_props
                        .Where(jt => jt["name"]?.Value<string>() == name)
                        .SingleOrDefault(),
                expected_props
            );
        ...
        private async Task CheckExpectedProperties(
            string[] expected_names,
        ...
        )
        {
            foreach (var exp_name in expected_names)
            {
                ...
                AssertEqual(
                    is_own,
                    actual_prop["isOwn"]?.Value<bool>() == true,
                    $"{exp_name}#isOwn"
                );
        ...
        private void AssertHasOnlyExpectedProperties(
            string[] expected_names,
        ...
        public static TheoryData<
            ...
            Dictionary<string, JObject>,
            string
        > GetDataForProtectionLevels()
        {
            var data =
                new TheoryData<Dictionary<string, JObject>, Dictionary<string, JObject>, string>();
            ...
            var public_props = new Dictionary<string, JObject>()
            {
                ...
                {
                    "BaseBase_PropertyForVHO",
                    TGetter("BaseBase_PropertyForVHO", TString("Derived#BaseBase_PropertyForVHO"))
                },
                {
                    "BaseBase_PropertyForVOH",
                    TGetter("BaseBase_PropertyForVOH", TString("Derived#BaseBase_PropertyForVOH"))
                },
                ...
                {
                    "BaseBase_FieldForHidingWithAutoProperty (BaseClass2)",
                    TString("Base#BaseBase_FieldForHidingWithAutoProperty")
                },
                ...
                {
                    "BaseBase_AutoPropertyForVOH (BaseClass2)",
                    TString("Base#BaseBase_AutoPropertyForVOH")
                },
                ...
                {
                    "BaseBase_PropertyForHidingWithField (BaseBaseClass2)",
                    TGetter("BaseBase_PropertyForHidingWithField (BaseBaseClass2)", TNumber(10))
                },
                { "BaseBase_AutoPropertyForHidingWithField (BaseBaseClass2)", TNumber(15) },
                {
                    "BaseBase_FieldForHidingWithProperty (BaseBaseClass2)",
                    TString("BaseBase#BaseBase_FieldForHidingWithProperty")
                },
                {
                    "BaseBase_PropertyForHidingWithProperty (BaseBaseClass2)",
                    TGetter(
                ...
                {
                    "BaseBase_AutoPropertyForHidingWithProperty (BaseBaseClass2)",
                    TString("BaseBase#BaseBase_AutoPropertyForHidingWithProperty")
                },
                {
                    "BaseBase_FieldForHidingWithAutoProperty (BaseBaseClass2)",
                    TString("BaseBase#BaseBase_FieldForHidingWithAutoProperty")
                },
                {
                    "BaseBase_PropertyForHidingWithAutoProperty (BaseBaseClass2)",
                    TGetter(
                ...
                {
                    "BaseBase_AutoPropertyForHidingWithAutoProperty (BaseBaseClass2)",
                    TString("BaseBase#BaseBase_AutoPropertyForHidingWithAutoProperty")
                },
                {
                    "BaseBase_PropertyForVHO (BaseBaseClass2)",
                    TGetter(
                ...
                {
                    "BaseBase_AutoPropertyForVHO (BaseBaseClass2)",
                    TString("BaseBase#BaseBase_AutoPropertyForVHO")
                },
                { "S_BaseBase_FieldForHidingWithField (BaseBaseClass2)", TNumber(5) },
                {
                    "S_BaseBase_PropertyForHidingWithField (BaseBaseClass2)",
                    TGetter("S_BaseBase_PropertyForHidingWithField (BaseBaseClass2)", TNumber(10))
                },
                ...
                {
                    "Base_PropertyForOverridingWithAutoProperty",
                    TDateTime(new DateTime(2022, 7, 6, 5, 4, 3))
                },
                {
                    "Base_AutoPropertyForOverridingWithAutoProperty",
                    TDateTime(new DateTime(2023, 7, 6, 5, 4, 3))
                },
                {
                    "Base_AutoPropertyForOverridingWithProperty",
                    TGetter(
                ...
                {
                    "BaseBase_AutoPropertyForHidingWithAutoProperty",
                    TString("Base#BaseBase_AutoPropertyForHidingWithAutoProperty")
                },
            ...
            var private_props = new Dictionary<string, JObject>()
            {
                ...
                {
                    "BaseBase_FieldForHidingWithAutoProperty",
                    TString("Derived#BaseBase_FieldForHidingWithAutoProperty")
                },
                ...
                {
                    "BaseBase_PropertyForHidingWithAutoProperty",
                    TString("Base#BaseBase_PropertyForHidingWithAutoProperty")
                },
        ...
        public async Task PropertiesSortedByProtectionLevel(
            Dictionary<string, JObject> expectedPublicInternalAndProtected,
            Dictionary<string, JObject> expectedPriv,
            string entryMethod
        ) =>
            await CheckInspectLocalsAtBreakpointSite(
                $"DebuggerTests.GetPropertiesTests.{entryMethod}",
                "InstanceMethod",
                1,
                $"DebuggerTests.GetPropertiesTests.{entryMethod}.InstanceMethod",
                ...
                wait_for_event_fn: async (pause_location) =>
                {
                    ...
                    var (pubInternalAndProtected, priv) =
                        await GetPropertiesSortedByProtectionLevels(
                            obj["objectId"]?.Value<string>()
                        );

                    AssertHasOnlyExpectedProperties(
                        expectedPublicInternalAndProtected.Keys.ToArray(),
                        pubInternalAndProtected.Values<JObject>()
                    );
                    AssertHasOnlyExpectedProperties(
                        expectedPriv.Keys.ToArray(),
                        priv.Values<JObject>()
                    );

                    await CheckProps(
                        pubInternalAndProtected,
                        expectedPublicInternalAndProtected,
                        "result"
                    );
        ...
        [MemberData(nameof(StructGetPropertiesTestData), parameters: true)]
        [MemberData(nameof(StructGetPropertiesTestData), parameters: false)]
        public async Task InspectTypeInheritedMembersAutoEvaluateOn(
            string type_name,
            bool? own_properties,
            bool? accessors_only,
            string[] expected_names,
        ...
        [MemberData(nameof(StructGetPropertiesTestData), parameters: true)]
        [MemberData(nameof(StructGetPropertiesTestData), parameters: false)]
        public async Task InspectTypeInheritedMembersAutoEvaluateOff(
            string type_name,
            bool? own_properties,
            bool? accessors_only,
            string[] expected_names,
        ...
        public async Task InspectTypeInheritedMembersInternal(
            string type_name,
            bool? own_properties,
            bool? accessors_only,
            string[] expected_names,
            Dictionary<string, (JObject, bool)> all_props,
            bool is_async,
            AutoEvaluate auto_evaluate_status
        )
        {
            if (auto_evaluate_status == AutoEvaluate.On)
                ...
                await cli.SendCommand(
                    "DotnetDebugger.setEvaluationOptions",
                    JObject.FromObject(new { options = new { noFuncEval = true } }),
                    token
                );
            await CheckInspectLocalsAtBreakpointSite(
                $"DebuggerTests.GetPropertiesTests.{type_name}",
                $"InstanceMethod{(is_async ? "Async" : "")}",
                1,
                $"DebuggerTests.GetPropertiesTests.{type_name}."
                    + (is_async ? "InstanceMethodAsync" : "InstanceMethod"),
                ...
                wait_for_event_fn: async (pause_location) =>
                {
                    ...
                    var this_props = await GetProperties(
                        this_obj["value"]?["objectId"]?.Value<string>(),
                        own_properties: own_properties,
                        accessors_only: accessors_only
                    );
                    ...
                    await CheckExpectedProperties(
                        expected_names,
                        name => GetAndAssertObjectWithName(this_props, name),
                        all_props,
                        auto_evaluate_status == AutoEvaluate.On
                    );

                    // indexer properties shouldn't show up here
                    var item = this_props.FirstOrDefault(
                        jt => jt["name"]?.Value<string>() == "Item"
                    );
                    Assert.Null(item);
                }
            );
