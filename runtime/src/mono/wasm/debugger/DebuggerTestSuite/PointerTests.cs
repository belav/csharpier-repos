...
namespace DebuggerTests
{
    ...
    {
        public PointerTests(ITestOutputHelper testOutput)
            : base(testOutput) { }
            ...
            {
                {
                    ...
                    "LocalPointers",
                    32,
                    "DebuggerTests.PointerTests.LocalPointers",
                    false
                },
                {
                    $"invoke_static_method ('[debugger-test] DebuggerTests.PointerTests:LocalPointers');",
        ...
        public async Task InspectLocalPointersToValueTypeArrays(
            ...
            await CheckInspectLocalsAtBreakpointSite(
                ...
                wait_for_event_fn: async (pause_location) =>
                {
                    ...
                    await CheckProps(
                        locals,
                        new { dtpa = TArray("System.DateTime*[]", "System.DateTime*[2]") },
                        "locals",
                        num_fields: 26
                    );
                ...
                wait_for_event_fn: async (pause_location) =>
                {
                    ...
                    await CheckProps(
                        ...
                        new
                        {
                            gspa = TArray(
                                "DebuggerTests.GenericStructWithUnmanagedT<System.DateTime>*[]",
                                "DebuggerTests.GenericStructWithUnmanagedT<System.DateTime>*[3]"
                            ),
                        },
                        "locals",
                        num_fields: 26
            ...
            {
                {
                    ...
                    "PointersAsArgsTest",
                    2,
                    "DebuggerTests.PointerTests.PointersAsArgsTest",
                    false
                },
                {
                    $"invoke_static_method ('[debugger-test] DebuggerTests.PointerTests:LocalPointers');",
