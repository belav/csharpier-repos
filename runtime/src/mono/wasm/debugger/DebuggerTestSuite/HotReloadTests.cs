    ...
    public class HotReloadTests : DebuggerTests
    {
        ...
        public async Task DebugHotReloadMethodChangedUserBreak()
        {
            var pause_location = await LoadAssemblyAndTestHotReload(
                ...
                "MethodBody1",
                "StaticMethod1",
                expectBpResolvedEvent: false,
                sourcesToWait: new string[] { "MethodBody0.cs", "MethodBody1.cs" }
            );
            var locals = await GetProperties(
                pause_location["callFrames"][0]["callFrameId"].Value<string>()
            );
            CheckNumber(locals, "a", 10);
            pause_location = await SendCommandAndCheck(
                JObject.FromObject(new { }),
                "Debugger.resume",
                "dotnet://ApplyUpdateReferencedAssembly.dll/MethodBody1.cs",
                12,
                16,
                "ApplyUpdateReferencedAssembly.MethodBody1.StaticMethod1"
            );
            locals = await GetProperties(
                pause_location["callFrames"][0]["callFrameId"].Value<string>()
            );
        ...
        public async Task DebugHotReloadMethodUnchanged()
        {
            ...
            pause_location = await SendCommandAndCheck(
                ...
                21,
                12,
                "ApplyUpdateReferencedAssembly.MethodBody2.StaticMethod1"
            );
            locals = await GetProperties(
                pause_location["callFrames"][0]["callFrameId"].Value<string>()
            );
        ...
        public async Task DebugHotReloadMethodAddBreakpoint(string assembly_name)
        {
            ...
            pause_location = await SendCommandAndCheck(
                JObject.FromObject(new { }),
                "Debugger.resume",
                $"dotnet://{assembly_name}.dll/MethodBody1.cs",
                30,
                12,
                "ApplyUpdateReferencedAssembly.MethodBody3.StaticMethod3"
            );
            locals = await GetProperties(
                pause_location["callFrames"][0]["callFrameId"].Value<string>()
            );
        ...
        public async Task DebugHotReloadMethodEmpty()
        {
            ...
            pause_location = await SendCommandAndCheck(
                ...
                38,
                12,
                "ApplyUpdateReferencedAssembly.MethodBody4.StaticMethod4"
            );
            locals = await GetProperties(
                pause_location["callFrames"][0]["callFrameId"].Value<string>()
            );
        ...
        {
            string asm_file = Path.Combine(
                DebuggerTestAppPath,
                "ApplyUpdateReferencedAssembly.dll"
            );
            string pdb_file = Path.Combine(
                DebuggerTestAppPath,
                "ApplyUpdateReferencedAssembly.pdb"
            );
            string asm_file_hot_reload = Path.Combine(
                DebuggerTestAppPath,
                "../wasm/ApplyUpdateReferencedAssembly.dll"
            );
            ...
            AssertEqual(
                "ApplyUpdateReferencedAssembly.MethodBody1.StaticMethod1",
                top_frame?["functionName"]?.Value<string>(),
                top_frame?.ToString()
            );
            CheckLocation(
                "dotnet://ApplyUpdateReferencedAssembly.dll/MethodBody1.cs",
        ...
        public async Task DebugHotReloadMethod_CheckBreakpointLineUpdated_ByVS_Simulated()
        {
            ...
            JToken top_frame = pause_location["callFrames"]?[0];
            AssertEqual(
                "ApplyUpdateReferencedAssembly.MethodBody5.StaticMethod1",
                top_frame?["functionName"]?.Value<string>(),
                top_frame?.ToString()
            );
            CheckLocation(
        ...
        public async Task DebugHotReloadMethod_CheckBreakpointLineUpdated_ByVS_Simulated_ReceivingBreakpointBeforeUpdate_BPNotChanged()
        {
            ...
            CheckLocation(
                ...
                12,
                scripts,
                pause_location["callFrames"]?[0]["location"]
            );
            //apply first update
            pause_location = await LoadAssemblyAndTestHotReloadUsingSDB(
                asm_file_hot_reload,
        ...
        public async Task DebugHotReloadMethod_AddingNewMethod()
        {
            ...
            JToken top_frame = pause_location["callFrames"]?[0];
            AssertEqual(
                "ApplyUpdateReferencedAssembly.MethodBody6.NewMethodStatic",
                top_frame?["functionName"]?.Value<string>(),
                top_frame?.ToString()
            );
            CheckLocation(
        ...
        public async Task DebugHotReloadMethod_AddingNewStaticField()
        {
            ...
            await EvaluateOnCallFrameAndCheck(
                top_frame["callFrameId"].Value<string>(),
        ...
        public async Task DebugHotReloadMethod_AddingNewClass()
        {
            ...
            JToken top_frame = pause_location["callFrames"]?[0];
            AssertEqual(
                "ApplyUpdateReferencedAssembly.MethodBody7.StaticMethod1",
                top_frame?["functionName"]?.Value<string>(),
                top_frame?.ToString()
            );
            CheckLocation(
            ...
            pause_location = await StepAndCheck(
                ...
                83,
                12,
                "ApplyUpdateReferencedAssembly.MethodBody7.InstanceMethod",
                locals_fn: async (locals) =>
                {
            ...
            top_frame = pause_location["callFrames"]?[0];
            AssertEqual(
                "ApplyUpdateReferencedAssembly.MethodBody8.InstanceMethod",
                top_frame?["functionName"]?.Value<string>(),
                top_frame?.ToString()
            );
            CheckLocation(
        ...
        public async Task DebugHotReloadMethod_AddingNewMethodWithoutAnyOtherChange()
        {
            string asm_file = Path.Combine(
                DebuggerTestAppPath,
                "ApplyUpdateReferencedAssembly2.dll"
            );
            string pdb_file = Path.Combine(
                DebuggerTestAppPath,
                "ApplyUpdateReferencedAssembly2.pdb"
            );
            string asm_file_hot_reload = Path.Combine(
                DebuggerTestAppPath,
                "../wasm/ApplyUpdateReferencedAssembly2.dll"
            );
            ...
            var pause_location = await LoadAssemblyAndTestHotReloadUsingSDBWithoutChanges(
                ...
                "StaticMethod1",
                expectBpResolvedEvent: false,
                sourcesToWait: new string[] { "MethodBody2.cs" }
            );
            CheckLocation(
                "dotnet://ApplyUpdateReferencedAssembly2.dll/MethodBody2.cs",
                12,
                12,
                scripts,
                pause_location["callFrames"]?[0]["location"]
            ...
            JToken top_frame = pause_location["callFrames"]?[0];
            AssertEqual(
                "ApplyUpdateReferencedAssembly.AddMethod.StaticMethod2",
                top_frame?["functionName"]?.Value<string>(),
                top_frame?.ToString()
            );
            CheckLocation(
            ...
            await SendCommandAndCheck(
                ...
                locals_fn: async (locals) =>
                {
                    await CheckObject(
                        locals,
                        "c",
                        "ApplyUpdateReferencedAssembly.AddInstanceFields.C"
                    );
                    var c = await GetObjectOnLocals(locals, "c");
                    await CheckProps(c, new { Field1 = TNumber(123) }, "c", num_fields: 1);
                    ...
                    await CheckProps(
                        c,
                        new { Field1 = TNumber("456.5", isDecimal: true) },
                        "c",
                        num_fields: 1
                    );
                }
        ...
        public async Task DebugHotReloadMethod_AddingNewClassUsingDebugAttribute()
        {
            ...
            JToken top_frame = pause_location["callFrames"]?[0];
            AssertEqual(
                "ApplyUpdateReferencedAssembly.MethodBody10.StaticMethod1",
                top_frame?["functionName"]?.Value<string>(),
                top_frame?.ToString()
            );
            CheckLocation(
        ...
        public async Task DebugHotReloadMethod_AddingNewMethodAndThrowException()
        {
            ...
            pause_location = await LoadAssemblyAndTestHotReloadUsingSDB(
                asm_file_hot_reload,
                "MethodBody11",
                "NewMethodStaticWithThrow",
                1
            );

            JToken top_frame = pause_location["callFrames"]?[0];
            AssertEqual(
                "ApplyUpdateReferencedAssembly.MethodBody11.NewMethodStaticWithThrow",
                top_frame?["functionName"]?.Value<string>(),
                top_frame?.ToString()
            );
            CheckLocation(
