...
namespace DebuggerTests
{
    ...
    {
        public AsyncTests(ITestOutputHelper testOutput)
            : base(testOutput) { }
        ...
        [InlineData(
            ...
            "DebuggerTests.AsyncTests.ContinueWithTests.ContinueWithInstanceAsync.AnonymousMethod__5_0"
        )]
        public async Task AsyncLocalsInContinueWith(
            string method_name,
            ...
            await CheckInspectLocalsAtBreakpointSite(
                ...
                wait_for_event_fn: async (pause_location) =>
                {
                    ...
                    var res = await InvokeGetter(
                        GetAndAssertObjectWithName(frame_locals, "t"),
                        "Status"
                    );
                    await CheckValue(
                        res.Value["result"],
        ...
        public async Task AsyncLocalsInContinueWithInstanceUsingThisBlock() =>
            await CheckInspectLocalsAtBreakpointSite(
                "DebuggerTests.AsyncTests.ContinueWithTests",
                "ContinueWithInstanceUsingThisAsync",
                5,
                "DebuggerTests.AsyncTests.ContinueWithTests.ContinueWithInstanceUsingThisAsync.AnonymousMethod__6_0",
                "window.setTimeout(function() { invoke_static_method('[debugger-test] DebuggerTests.AsyncTests.ContinueWithTests:RunAsync'); })",
                wait_for_event_fn: async (pause_location) =>
                {
                    var frame_locals = await GetProperties(
                    ...
                    res = await InvokeGetter(
                        GetAndAssertObjectWithName(frame_locals, "this"),
                        "Date"
                    );
                    await CheckValue(
                        res.Value["result"],
                        TDateTime(new DateTime(2510, 1, 2, 3, 4, 5)),
                        "this.Date"
                    );
                }
            );
        ...
        public async Task AsyncLocalsInNestedContinueWithStaticBlock() =>
            await CheckInspectLocalsAtBreakpointSite(
                "DebuggerTests.AsyncTests.ContinueWithTests",
                "NestedContinueWithStaticAsync",
                5,
                "DebuggerTests.AsyncTests.ContinueWithTests.NestedContinueWithStaticAsync",
                "window.setTimeout(function() { invoke_static_method('[debugger-test] DebuggerTests.AsyncTests.ContinueWithTests:RunAsync'); })",
                wait_for_event_fn: async (pause_location) =>
                {
                    var frame_locals = await GetProperties(
                    ...
                    await CheckProps(
                        ...
                        new
                        {
                            ...
                            str = TString("foobar"),
                            @this = TObject(
                                "DebuggerTests.AsyncTests.ContinueWithTests.<>c__DisplayClass4_0"
                            ),
        ...
        [InlineData(
            "RunNestedContinueWith",
            309,
            24,
            315,
            24,
            "RunNestedContinueWithSameVariableName.AnonymousMethod__1"
        )]
        ...
        [Theory]
        [InlineData(
            "[debugger-test-vb] DebuggerTestVB.TestVbScope:Run",
            14,
            12,
            22,
            12,
        ...
        public async Task InspectLocalsWithSameNameInDifferentScopesInAsyncMethod_VB(
            string method_to_run,
            int line1,
            int col1,
            int line2,
        ...
        private async Task InspectLocalsWithSameNameInDifferentScopesInAsyncMethod(
            string method_to_run,
            string source_to_pause,
            int line1,
            int col1,
            int line2,
            int col2,
        ...
        )
        {
            ...
            await EvaluateAndCheck(
                ...
                locals_fn: async (locals) =>
                {
                    ...
                    Assert.False(
                        locals.Any(jt => jt["name"]?.Value<string>() == "onlyInSecondScope")
                    );
                }
            );
            await StepAndCheck(
                ...
                locals_fn: async (locals) =>
                {
                    ...
                    Assert.False(
                        locals.Any(jt => jt["name"]?.Value<string>() == "onlyInFirstScope")
                    );
                }
            );
        }
        ...
        {
            var expression =
                $"{{ invoke_static_method('[debugger-test-vb] DebuggerTestVB.TestVbScope:Run'); }}";
            await EvaluateAndCheck(
                "window.setTimeout(function() {" + expression + "; }, 1);",
                "dotnet://debugger-test-vb.dll/debugger-test-vb.vb",
                14,
