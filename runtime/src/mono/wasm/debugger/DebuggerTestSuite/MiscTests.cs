...
namespace DebuggerTests
{
    ...
    {
        public MiscTests(ITestOutputHelper testOutput)
            : base(testOutput) { }
            ...
            await CheckInspectLocalsAtBreakpointSite(
                ...
                test_fn: async (locals) =>
                {
                    ...
                    await CheckArray(
                        ...
                        "list_arr",
                        "System.Collections.Generic.Dictionary<Math[], Math.IsMathNull>[]",
                        "System.Collections.Generic.Dictionary<Math[], Math.IsMathNull>[1]"
                    );
                    await CheckObject(
                        locals,
                        "list_arr_null",
        ...
        public async Task InspectLocalsWithStructs(bool use_cfo)
        {
            ...
            var pause_location = await EvaluateAndCheck(
                ...
                24,
                8,
                "DebuggerTests.ValueTypesTest.MethodWithLocalStructs"
            );
        ...
        public async Task InspectLocalsWithStructsStaticAsync(bool use_cfo)
        {
            ...
            var pause_location = await EvaluateAndCheck(
                ...
                54,
                12,
                "DebuggerTests.ValueTypesTest.MethodWithLocalStructsStaticAsync"
            );
        ...
        )
        {
            ...
            var pause_location = await EvaluateAndCheck(
                ...
                line,
                col,
                $"DebuggerTests.ValueTypesTest.{method_name}{(invoke_async ? "Async" : String.Empty)}"
            );
        ...
        public async Task MulticastDelegateTest() =>
            await CheckInspectLocalsAtBreakpointSite(
                ...
                "Test",
                5,
                "MulticastDelegateTestClass.Test",
                ...
                wait_for_event_fn: async (pause_location) =>
                {
                    ...
                    await CheckProps(
                        this_props,
                        new { Delegate = TSymbol("System.MulticastDelegate") },
                        "this_props"
                    );
                }
            );
        ...
        public async Task PreviousFrameForAReflectedCall() =>
            await CheckInspectLocalsAtBreakpointSite(
                ...
                "SimpleStaticMethod",
                1,
                "DebuggerTests.GetPropertiesTests.CloneableStruct.SimpleStaticMethod",
                    ...
                    await CheckProps(
                        ...
                        new
                        {
                            mi = TObject(
                                ...
                                description: "Void SimpleStaticMethod(System.DateTime, System.String)"
                            ), //this is what is returned when debugging desktop apps using VS
        ...
        public async Task DebugLazyLoadedAssemblyWithPdb(string assembly_name)
        {
            ...
            var pause_location = await EvaluateAndCheck(
                "window.setTimeout(function () { invoke_static_method('["
                    + assembly_name
                    + "] LazyMath:IntAdd', 5, 10); }, 1);",
                source_location,
                line,
                8,
                "LazyMath.IntAdd"
        ...
        public async Task GetSourceEmbeddedSource()
        {
            ...
            var source = await cli.SendCommand("Debugger.getScriptSource", sourceToGet, token);
            Assert.False(
                source.Value["scriptSource"].Value<string>().Contains("// Unable to read document")
            );
        }
        ...
        public async Task SetBreakpointInProjectWithSpecialCharactersInPath(
            ...
            string expectedFileNameEscaped
        )
        {
            var bp = await SetBreakpointInMethod(
                "debugger-test-special-char-in-path.dll",
                classWithNamespace,
                "Evaluate",
                1
            );
            ...
            Assert.EndsWith(
                expectedFileNameEscaped,
                ret["callFrames"][0]["url"].Value<string>(),
        ...
        {
            var bp = await SetBreakpointInMethod(
                "debugger-test-with-colon-in-source-name.dll",
                "DebuggerTests.CheckColonInSourceName",
                "Evaluate",
                1
            );
            var ret = await EvaluateAndCheck(
            ...
            Assert.EndsWith(
                "debugger-test-with-colon-in-source-name/test:.cs",
                ret["callFrames"][0]["url"].Value<string>(),
                StringComparison.InvariantCulture
            );
        }
        ...
        [Theory]
        [InlineData("DebugWithDeletedPdb", 1148)]
        ...
        [InlineData(
            "TestKlassGenericAsyncGeneric",
            "AsyncGeneric.MyKlass<bool, char>.GetAsyncMethod<int>"
        )]
        [InlineData(
            "TestKlassGenericAsyncGeneric2",
            "AsyncGeneric.MyKlass<bool>.GetAsyncMethod<int>"
        )]
        [InlineData(
            "TestKlassGenericAsyncGeneric3",
            "AsyncGeneric.MyKlass<bool>.GetAsyncMethod2<int, char>"
        )]
        [InlineData(
            "TestKlassGenericAsyncGeneric4",
            "AsyncGeneric.MyKlass<bool, double>.GetAsyncMethod2<int, char>"
        )]
        [InlineData(
            "TestKlassGenericAsyncGeneric5",
            "AsyncGeneric.MyKlass<bool>.MyKlassNested<int>.GetAsyncMethod<char>"
        )]
        [InlineData(
            "TestKlassGenericAsyncGeneric6",
            "AsyncGeneric.MyKlass<AsyncGeneric.MyKlass<int>>.GetAsyncMethod<char>"
        )]
        public async Task CheckCallStackOfAsyncGenericMethods(
            string method_name,
            string method_name_call_stack
        )
        {
            var expression =
                $"{{ invoke_static_method_async ('[debugger-test] AsyncGeneric:{method_name}'); }}";
        ...
        [InlineData(
            "GenericCustomAttributeDecoratedClassInheritsFromClassWithoutDebugSymbols",
            1618,
            true
        )]
        [InlineData(
        ...
        [InlineData(
            "GenericCustomAttributeDecoratedClassInheritsFromNonUserCodeClass",
            1635,
            false
        )]
        [InlineData(
            "GenericCustomAttributeDecoratedClassInheritsFromNonUserCodeClassThatInheritsFromNormalClass",
            1653,
            true
        )]
        [InlineData(
        ...
        public async Task InspectThisThatInheritsFromClassNonUserCode(
            string class_name,
            int line,
            bool jmc
        )
        {
            ...
            var expression =
                "{{ invoke_static_method('[debugger-test] " + class_name + ":Run'); }}";
        ...
        {
            var bp = await SetBreakpointInMethod(
                "debugger-test-chinese-char-in-path-ㄨ.dll",
                "DebuggerTests.CheckChineseCharacterInPath",
                "Evaluate",
                1
            );
            var ret = await EvaluateAndCheck(
            ...
            Assert.EndsWith(
                "debugger-test-chinese-char-in-path-%E3%84%A8/test.cs",
                ret["callFrames"][0]["url"].Value<string>(),
                StringComparison.InvariantCulture
            );
        }
            ...
            await StepAndCheck(
                ...
                locals_fn: async (locals) =>
                {
                    await CheckValueType(
                        ...
                        description: "System.ReadOnlySpan<Object>[0]"
                    );
                }
            );
        }
        ...
        public async Task TestDebugUsingMultiThreadedRuntime(int _attempt)
        {
            ...
            var expression =
                $"{{ invoke_static_method('[debugger-test] MultiThreadedTest:Run'); }}";
