...
internal static class EnvironmentVariables
{
    ...
    public static readonly bool SkipCleanup =
        Environment.GetEnvironmentVariable("SKIP_CLEANUP") == "1"
        || Environment.GetEnvironmentVariable("SKIP_CLEANUP") == "true";
    public static readonly string? WasmTestsUsingVariant = Environment.GetEnvironmentVariable(
        "WASM_TESTS_USING_VARIANT"
    );
}
