...
{
    public class DateTimeTestsCJK : DebuggerTests
    {
        public DateTimeTestsCJK(ITestOutputHelper testOutput)
            : base(testOutput, locale: "ja-JA") { }
        ...
        public async Task CheckDateTimeLocale(
            string locale,
            string fdtp,
            string ldp,
            string ltp,
        ...
        )
        {
            ...
            var pause_location = await EvaluateAndCheck(
                ...
                25,
                12,
                "DebuggerTests.DateTimeTest.LocaleTest",
    ...
    public class DateTimeTestsEFIGS : DebuggerTests
    {
        public DateTimeTestsEFIGS(ITestOutputHelper testOutput)
            : base(testOutput) { }
