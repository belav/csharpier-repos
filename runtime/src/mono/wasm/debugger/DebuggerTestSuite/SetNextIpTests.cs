...
public class SetNextIpTests : DebuggerTests
{
    ...
    public async Task SetAndCheck()
    {
        ...
        await SetNextIPAndCheck(
            top_frame["scriptId"].Value<string>(),
            "dotnet://debugger-test.dll/debugger-test.cs",
            12,
            8,
            "Math.IntAdd",
    ...
    public async Task Lambda()
    {
        ...
        var pause_location = await EvaluateAndCheck(
            ...
            77,
            12,
            "DebuggerTests.AsyncTests.ContinueWithTests.NestedContinueWithInstanceAsync",
            locals_fn: async (locals) =>
            {
                ...
                await CheckValueType(
                    ...
                    "dt0",
                    "System.DateTime",
                    description: "1/1/0001 12:00:00 AM"
                );
            }
        );
        var top_frame = pause_location["callFrames"][0]["functionLocation"];
