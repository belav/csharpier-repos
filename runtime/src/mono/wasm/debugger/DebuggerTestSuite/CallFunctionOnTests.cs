...
namespace DebuggerTests
{
    public class CallFunctionOnTests : DebuggerTests
    {
        ...
        )
        {
            ...
            await RunCallFunctionOn(
                ...
                test_fn: async (result) =>
                {
                    ...
                    var obj_accessors = await cli.SendCommand(
                    ...
                    var obj_own = await cli.SendCommand(
                        "Runtime.getProperties",
                        JObject.FromObject(
                            new
                            {
        ...
        public async Task RunOnVTArray(bool roundtrip) =>
            await RunCallFunctionOn(
                ...
                test_fn: async (result) =>
                {
                    ...
                    for (int i = 0; i < ret_len; i++)
                    {
                        var act_i = await CheckValueType(
                            obj_own_val,
                            i.ToString(),
                            "Math.SimpleStruct"
                        );
        ...
        public async Task RunOnJSObject(bool roundtrip) =>
            await RunCallFunctionOn(
                ...
                test_fn: async (result) =>
                {
                    ...
                    await CheckProps(
                        obj_own_val,
                        new { a_obj = TObject("Object"), b_arr = TArray("Array", "Array(2)") },
                        "obj_own"
                    );
                }
            );
        ...
        )
        {
            ...
            cfo_args = JObject.FromObject(
                new { functionDeclaration = "function () { return null; }", objectId = obj_id }
            );
        ...
        public async Task PropertyGettersTest(
            ...
            await CheckInspectLocalsAtBreakpointSite(
                ...
                wait_for_event_fn: async (pause_location) =>
                {
                    ...
                    await CheckValue(
                        res.Value["result"],
                        TArray("System.DateTime[]", "System.DateTime[2]"),
                        $"{local_name}.DTArray"
                    );
                    {
                        ...
                        var exp_elems = new[] { TDateTime(dt0), TDateTime(dt1) };
        ...
        public async Task InvokeInheritedAndPrivateGetters() =>
            await CheckInspectLocalsAtBreakpointSite(
                ...
                wait_for_event_fn: async (pause_location) =>
                {
                    ...
                    var args = new[]
                    {
                        ...
                        (
                            ...
                            TString("DerivedClass#StringPropertyForOverrideWithAutoProperty")
                        ),
                        // inherited
        ...
        )
        {
            ...
            foreach (var invalid_arg in invalid_args)
            {
                ...
                AssertEqual(
                    ...
                    $"Expected to get undefined result for non-existent accessor - {invalid_arg}"
                );
            }
        }
        ...
        )
        {
            ...
            async Task CheckCFOResult(Result result)
            {
                ...
                if (res_array_len < 0)
                    ...
                    await CheckValue(
                        result.Value["result"],
                        TArray("Array", $"Array({res_array_len})"),
                        $"cfo-res"
                    );
            }
        }
