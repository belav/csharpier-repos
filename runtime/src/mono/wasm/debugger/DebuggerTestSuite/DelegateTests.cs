...
namespace DebuggerTests
{
    ...
    {
        public DelegateTests(ITestOutputHelper testOutput)
            : base(testOutput) { }
                ...
                wait_for_event_fn: async (pause_location) =>
                {
                    ...
                    await CheckProps(
                        ...
                        new
                        {
                            ...
                            fn_func_arr = TArray(
                                "System.Func<Math, Math.GenericStruct<Math.GenericStruct<int[]>>, Math.GenericStruct<bool[]>>[]",
                                "System.Func<Math, Math.GenericStruct<Math.GenericStruct<int[]>>, Math.GenericStruct<bool[]>>[1]"
                            ),
                            ...
                            fn_del_arr = TArray(
                                "Math.DelegateForSignatureTest[]",
                                "Math.DelegateForSignatureTest[2]"
                            ),
                            m_obj = TObject("Math"),
                            ...
                            fn_void_del_arr = TArray(
                                "Math.DelegateWithVoidReturn[]",
                                "Math.DelegateWithVoidReturn[1]"
                            ),
                            ...
                            rets = TArray(
                                "Math.GenericStruct<bool[]>[]",
                                "Math.GenericStruct<bool[]>[6]"
                            ),
                        },
                        "locals"
                    );
                ...
                wait_for_event_fn: async (pause_location) =>
                {
                    ...
                    await CheckProps(
                        ...
                        new
                        {
                            ...
                            fn_action_arr = TArray(
                                "System.Action<Math.GenericStruct<int[]>>[]",
                                "System.Action<Math.GenericStruct<int[]>>[3]"
                            ),
                ...
                wait_for_event_fn: async (pause_location) =>
                {
                    ...
                    await CheckProps(
                        ...
                        new
                        {
                            ...
                            fn_func_arr = TArray(
                                "System.Func<System.Func<int, bool>, bool>[]",
                                "System.Func<System.Func<int, bool>, bool>[1]"
                            ),
                            fn_del_arr = TArray(
                                "System.Func<System.Func<int, bool>, bool>[]",
                                "System.Func<System.Func<int, bool>, bool>[1]"
