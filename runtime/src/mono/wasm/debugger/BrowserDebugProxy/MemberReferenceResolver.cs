    ...
    internal sealed class MemberReferenceResolver
    {
            ...
            try
            {
                ...
                switch (objectId.Scheme)
                {
                    ...
                    case "array":
                        ...
                        {
                            return (JObject)(
                                ((JArray)rootObject["value"]).FirstOrDefault(
                                    x => x["name"].Value<string>() == elementIdxInfo.ElementIdxStr
                                )["value"]
                            );
                        }
                    case "object":
        ...
        )
        {
            ...
            foreach ((ParameterInfo paramInfo, object indexObj) in paramInfos.Zip(indexObjects))
            {
                ...
                if (
                    indexObj is JObject indexJObj
                    && !CheckParameterCompatibility(paramInfo.TypeCode, indexJObj)
                )
                    return false;
            }
            return true;
