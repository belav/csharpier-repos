    ...
    internal sealed class AssemblyInfo
    {
        ...
        )
        {
            ...
            try
            {
                ...
                {
                    HandleKind.MethodDefinition => EnCGetMethodDefinition(
                            (MethodDefinitionHandle)ctorHandle
                        )
                        .GetDeclaringType(),
                    HandleKind.MemberReference => EnCGetMemberReference(
                ...
                {
                    HandleKind.TypeDefinition => EnCGetTypeDefinition(
                        (TypeDefinitionHandle)container.Value
                    ).Name,
                    HandleKind.TypeReference => EnCGetTypeReference(
                        (TypeReferenceHandle)container.Value
                    ).Name,
