    ...
    public class EvaluateLocalsWithIndexingTests
    {
        public class TestEvaluate
        {
            ...
            public void run()
            {
                ...
                indexedByStr = new Dictionary<string, bool>()
                {
                    { "1", true },
                    { "111", false },
                    { "true", true }
                ...
                indexedByBool = new Dictionary<bool, string>()
                {
                    { true, "TRUE" },
                    { false, "FALSE" }
                };
...
#nullable disable
            ...
            public int GetDefaultAndRequiredParam(int requiredParam, int optionalParam = 3) =>
