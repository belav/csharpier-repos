...
public class ClassInheritsFromClassWithoutDebugSymbols
    : DebuggerTests.ClassWithoutDebugSymbolsToInherit
{
    public static void Run()
    {
...
public class ClassInheritsFromNonUserCodeClassThatInheritsFromNormalClass
    : DebuggerTests.ClassNonUserCodeToInheritThatInheritsFromNormalClass
{
    public static void Run()
    {
...
public class GenericCustomAttributeDecoratedClassInheritsFromClassWithoutDebugSymbols
    : DebuggerTests.ClassWithoutDebugSymbolsToInherit
{
    public static void Run()
    {
...
public class GenericCustomAttributeDecoratedClassInheritsFromNonUserCodeClass
...
public class GenericCustomAttributeDecoratedClassInheritsFromNonUserCodeClassThatInheritsFromNormalClass
    : DebuggerTests.ClassNonUserCodeToInheritThatInheritsFromNormalClass
{
    public static void Run()
    {
