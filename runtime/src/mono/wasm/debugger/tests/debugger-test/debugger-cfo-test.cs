...
namespace DebuggerTests
{
    public class CallFunctionOnTest
    {
        public static void LocalsTest(int len)
        {
            ...
            var simple_struct = new Math.SimpleStruct()
            {
                ...
                gs = new Math.GenericStruct<DateTime>
                {
            ...
            for (int i = 0; i < len; i++)
                ...
                {
                    dt = new DateTime(2020 + i, 1, 2, 3, 4, 5),
                    gs = new Math.GenericStruct<DateTime>
                    {
    ...
    class ClassWithProperties
    {
        ...
        public uint Int
        {
            get { return V + (uint)DT.Month; }
        }
        public string String
        {
            get { return $"String property, V: 0x{V:X}"; }
        }
        public DateTime DT
        {
            get { return new DateTime(3, 4, 5, 6, 7, 8); }
        }
