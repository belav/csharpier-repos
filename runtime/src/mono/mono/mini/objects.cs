...
class Tests
{
    ...
    static int receive_small_sparc_many_args(
        int a,
        int a2,
        int a3,
        int a4,
    ...
    // bug #74992
    public static int arg_only_written(string file_name, int[] ncells)
    {
        if (file_name == null)
            return 1;
	...
	*/
    ...
    static double arm64_hfa_on_stack_inner(
        double d1,
        double d2,
        double d3,
        double d4,
    ...
    {
        [MethodImplAttribute(MethodImplOptions.NoInlining)]
        public unsafe void EncodeIntoBuffer(
            char* value,
            int valueLength,
            char* buffer,
            int bufferLength
    ...
    public static int test_0_cfold_with_non_constant_ternary_op()
    {
        ...
        var old = System.Threading.Interlocked.CompareExchange(
            ref variable_with_constant_address,
            1,
            0
        );
