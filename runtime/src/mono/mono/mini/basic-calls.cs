...
#endif
{
    ...
    static int pass_floats_doubles(
        float a,
        double b,
        double c,
        double d,
    ...
    static int pass_byref_ints_longs(
        ref long a,
        ref int b,
        ref byte c,
        ref short d,
    ...
    {
        return pass_takeaddr_ints_longs(
            1,
            2,
            253,
            -253,
    ...
    static int pass_byref_floats_doubles(
        ref float a,
        ref double b,
        ref double c,
        ref double d,
    ...
    static int pass_takeaddr_floats_doubles(
        float a,
        double b,
        double c,
        double d,
    ...
    public static int arm64_stack_arg_reg_sbyte(
        object o1,
        object o2,
        object o3,
        object o4,
