...
class MainClass
{
    ...
    public static int Main(string[] args)
    {
        ...
        // A test for #444383
        AppDomain.CreateDomain("1")
            .CreateInstance(typeof(Class1).Assembly.GetName().Name, "Class1");
...
public class Class1
{
    public Class1()
    {
        AppDomain.CreateDomain("2")
            .CreateInstance(typeof(Class1).Assembly.GetName().Name, "Class2");
    }
}
