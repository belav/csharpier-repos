...
public class Tests
{
    ...
    public static extern int mono_test_marshal_out_struct(
        int a,
        out SimpleStruct ss,
        int b,
        OutStructDelegate d
    ...
    public static extern int mono_test_marshal_in_struct(
        int a,
        ref SimpleStruct ss,
        int b,
        InStructDelegate d
    ...
    {
        return mono_test_marshal_return_delegate_delegate(
            new ReturnDelegateDelegate(return_delegate)
        );
    }
    ...
    {
        return mono_test_marshal_blittable_struct_delegate(
            new SimpleDelegate10(delegate_test_blittable_struct)
        );
    }
    ...
    {
        return mono_test_marshal_small_struct_delegate(
            new SmallStructDelegate1(delegate_test_struct)
        );
    }
    ...
    {
        return mono_test_marshal_small_struct_delegate(
            new SmallStructDelegate2(delegate_test_struct)
        );
    }
    ...
    {
        return mono_test_marshal_small_struct_delegate(
            new SmallStructDelegate3(delegate_test_struct)
        );
    }
    ...
    {
        return mono_test_marshal_small_struct_delegate(
            new SmallStructDelegate4(delegate_test_struct)
        );
    }
    ...
    {
        return mono_test_marshal_small_struct_delegate(
            new SmallStructDelegate5(delegate_test_struct)
        );
    }
    ...
    {
        return mono_test_marshal_small_struct_delegate(
            new SmallStructDelegate6(delegate_test_struct)
        );
    }
    ...
    {
        return mono_test_marshal_small_struct_delegate(
            new SmallStructDelegate7(delegate_test_struct)
        );
    }
    ...
    {
        return mono_test_marshal_small_struct_delegate(
            new SmallStructDelegate8(delegate_test_struct)
        );
    }
    ...
    {
        return mono_test_marshal_small_struct_delegate(
            new SmallStructDelegate9(delegate_test_struct)
        );
    }
    ...
    {
        return mono_test_marshal_small_struct_delegate(
            new SmallStructDelegate10(delegate_test_struct)
        );
    }
    ...
    {
        return mono_test_marshal_small_struct_delegate(
            new SmallStructDelegate11(delegate_test_struct)
        );
    }
    ...
    public static extern int mono_test_marshal_array_delegate1(
        string[] arr,
        int len,
        ArrayDelegate1 d
    );
    ...
    public static int test_0_marshal_array_delegate_string()
    {
        ...
        return mono_test_marshal_array_delegate1(
            arr,
            arr.Length,
    ...
    public delegate int ArrayDelegateBlittable(
        int i,
        string j,
        [
            In,
    ...
    public static int test_0_marshal_array_delegate_null_blittable()
    {
        return mono_test_marshal_array_delegate1(
            null,
            0,
            new ArrayDelegateBlittable(array_delegate_null_blittable)
        );
    }

    public delegate int ArrayDelegate3(
        int i,
        string j,
        [
            In,
    ...
    [DllImport("libtest", EntryPoint = "mono_test_marshal_array_delegate")]
    public static extern int mono_test_marshal_array_delegate3(
        string[] arr,
        int len,
        ArrayDelegate3 d
    );
    ...
    public delegate int ArrayDelegate4(
        int i,
        string j,
        [
            In,
    ...
    [DllImport("libtest", EntryPoint = "mono_test_marshal_array_delegate")]
    public static extern int mono_test_marshal_array_delegate4(
        string[] arr,
        int len,
        ArrayDelegate4 d
    );
    ...
    [DllImport("libtest", EntryPoint = "mono_test_marshal_array_delegate")]
    public static extern int mono_test_marshal_array_delegate4_2(
        string[] arr,
        int len,
        ArrayDelegate4_2 d
    );
    ...
    [DllImport("libtest", EntryPoint = "mono_test_marshal_array_delegate")]
    public static extern int mono_test_marshal_array_delegate4_3(
        string[] arr,
        int len,
        ArrayDelegate4_3 d
    );
    ...
    public delegate int ArrayDelegate5(
        int i,
        string j,
        [
            In,
    ...
    public static extern int mono_test_marshal_array_delegate5(
        string[] arr,
        int len,
        ArrayDelegate5 d
    );
    ...
    {
        string[] arr = new string[] { "ABC", "DEF" };
        return mono_test_marshal_array_delegate5(
            arr,
            arr.Length,
    ...
    public delegate int ArrayDelegate6(
        int i,
        string j,
        [In, MarshalAs(UnmanagedType.LPArray, ArraySubType = UnmanagedType.LPStr, SizeConst = 2)]
            string[] arr
    );

    [DllImport("libtest", EntryPoint = "mono_test_marshal_array_delegate")]
    public static extern int mono_test_marshal_array_delegate6(
        string[] arr,
        int len,
        ArrayDelegate6 d
    );
    ...
    public delegate int ArrayDelegate7(
        int i,
        string j,
        [
            In,
    ...
    [DllImport("libtest", EntryPoint = "mono_test_marshal_array_delegate")]
    public static extern int mono_test_marshal_array_delegate7(
        string[] arr,
        int len,
        ArrayDelegate7 d
    );
    ...
    public delegate int ArrayDelegate8(
        int i,
        string j,
        [In, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 0)] int[] arr
    );

    [DllImport("libtest", EntryPoint = "mono_test_marshal_array_delegate")]
    public static extern int mono_test_marshal_array_delegate8(
        int[] arr,
        int len,
        ArrayDelegate8 d
    );
    ...
    public static extern int mono_test_marshal_array_delegate8_2(
        string[] arr,
        long len,
        ArrayDelegate8_2 d
    );
    ...
    {
        string[] arr = new string[] { "ABC", "DEF" };
        return mono_test_marshal_array_delegate8_2(
            arr,
            arr.Length,
            new ArrayDelegate8_2(array_delegate8_2)
        );
    }
    ...
    public delegate int ArrayDelegate9(
        int i,
        string j,
        [Out, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 0)] int[] arr
    );

    [DllImport("libtest", EntryPoint = "mono_test_marshal_out_array_delegate")]
    public static extern int mono_test_marshal_out_array_delegate(
        int[] arr,
        int len,
        ArrayDelegate9 d
    );
    ...
    public delegate int ArrayDelegate10(
        int i,
        string j,
        [Out, MarshalAs(UnmanagedType.LPArray, ArraySubType = UnmanagedType.LPStr, SizeConst = 2)]
            string[] arr
    );

    [DllImport("libtest", EntryPoint = "mono_test_marshal_out_string_array_delegate")]
    public static extern int mono_test_marshal_out_string_array_delegate(
        string[] arr,
        int len,
        ArrayDelegate10 d
    );
    ...
    public static int test_0_marshal_out_string_array_delegate()
    {
        ...
        return mono_test_marshal_out_string_array_delegate(
            arr,
            2,
            new ArrayDelegate10(array_delegate10)
        );
    }
    ...
    public static extern int mono_test_marshal_inout_byval_class_delegate(
        InOutByvalClassDelegate d
    );
    ...
    {
        return mono_test_marshal_inout_byval_class_delegate(
            new InOutByvalClassDelegate(delegate_test_byval_class_inout)
        );
    }
    ...
    public static extern int mono_test_marshal_return_unicode_string_delegate(
        ReturnUnicodeStringDelegate d
    );
    ...
    {
        return mono_test_marshal_return_unicode_string_delegate(
            new ReturnUnicodeStringDelegate(return_unicode_string_delegate)
        );
    }
    ...
    {
        return mono_test_marshal_return_string_array_delegate(
    ...
    {
        return mono_test_marshal_byref_string_delegate(
    ...
    {
        int res = mono_test_marshal_thread_attach(
            delegate(int i)
            {
    ...
    {
        int res = mono_test_marshal_thread_attach_large_vt(
            delegate(ref LargeStruct s)
            {
                return 43;
            }
        );
    ...
    public static int test_0_icall_delegate()
    {
        ...
        return mono_test_marshal_icall_delegate(
            (IcallDelegate)Delegate.CreateDelegate(typeof(IcallDelegate), m)
        );
    }
}
