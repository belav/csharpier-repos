...
namespace T
{
    public class T
    {
        ...
        private static void ReplyHeaders(
            Socket sock,
            int code,
            String detail,
            String content_type,
        ...
        {
            ReplyHeaders(sock, 404, "Not Found", "text/html", "charset=iso-8859-1", 0);
        ...
        static void GetHeaders(out String req, out String[] headers, String data, Socket sock)
        {
        ...
        private static void Get(Socket sock, String data)
        {
            ...
            try
            {
                ...
                ReplyHeaders(sock, 200, "OK", mime_type, null, f.Length);
