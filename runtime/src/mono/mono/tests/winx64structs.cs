...
{
    [DllImport("libtest")]
    static extern int mono_test_Winx64_struct1_in(
        [MarshalAs(UnmanagedType.Struct)] winx64_struct1 var
    );

    [DllImport("libtest")]
    static extern int mono_test_Winx64_struct2_in(
        [MarshalAs(UnmanagedType.Struct)] winx64_struct2 var
    );

    [DllImport("libtest")]
    static extern int mono_test_Winx64_struct3_in(
        [MarshalAs(UnmanagedType.Struct)] winx64_struct3 var
    );

    [DllImport("libtest")]
    static extern int mono_test_Winx64_struct4_in(
        [MarshalAs(UnmanagedType.Struct)] winx64_struct4 var
    );

    [DllImport("libtest")]
    static extern int mono_test_Winx64_struct5_in(
        [MarshalAs(UnmanagedType.Struct)] winx64_struct5 var
    );

    [DllImport("libtest")]
    static extern int mono_test_Winx64_struct6_in(
        [MarshalAs(UnmanagedType.Struct)] winx64_struct6 var
    );

    [DllImport("libtest")]
    static extern int mono_test_Winx64_structs_in1(
        [MarshalAs(UnmanagedType.Struct)] winx64_struct1 var1,
    ...
    [DllImport("libtest")]
    static extern int mono_test_Winx64_structs_in2(
        [MarshalAs(UnmanagedType.Struct)] winx64_struct1 var1,
    ...
    [DllImport("libtest")]
    static extern int mono_test_Winx64_structs_in3(
        [MarshalAs(UnmanagedType.Struct)] winx64_struct1 var1,
    ...
    [DllImport("libtest")]
    [return: MarshalAs(UnmanagedType.Struct)]
    static extern winx64_struct1 mono_test_Winx64_struct1_ret_5_args(
        byte a,
        byte b,
        byte c,
        byte d,
    ...
    [DllImport("libtest")]
    [return: MarshalAs(UnmanagedType.Struct)]
    static extern winx64_struct5 mono_test_Winx64_struct5_ret6_args(
        byte a,
        byte b,
        byte c,
        byte d,
    ...
    [DllImport("libtest")]
    static extern int mono_test_Winx64_floatStruct(
        [MarshalAs(UnmanagedType.Struct)] winx64_floatStruct var
    );

    [DllImport("libtest")]
    static extern int mono_test_Winx64_doubleStruct(
        [MarshalAs(UnmanagedType.Struct)] winx64_doubleStruct var
    );

    public delegate int managed_struct1_delegate(
        [MarshalAs(UnmanagedType.Struct)] winx64_struct1 var
    );
    ...
    public delegate int managed_struct5_delegate(
        [MarshalAs(UnmanagedType.Struct)] winx64_struct5 var
    );
    ...
    public delegate int managed_struct1_struct5_delegate(
        winx64_struct1 var1,
        winx64_struct5 var2,
        winx64_struct1 var3,
        winx64_struct5 var4,
    ...
    [DllImport("libtest")]
    static extern int mono_test_managed_Winx64_struct1_struct5_in(
    ...
    [DllImport("libtest")]
    static extern int mono_test_Winx64_struct1_ret_managed(
        mono_test_Winx64_struct1_ret_delegate func
    );
    ...
    [DllImport("libtest")]
    static extern int mono_test_Winx64_struct5_ret_managed(
        mono_test_Winx64_struct5_ret_delegate func
    );
    ...
    public static int test_0_In_Args_Values_In_Multiple_Registers()
    {
        ...
        if (
            (
                retCode = mono_test_Winx64_structs_in1(
                    t_winx64_struct1,
                    t_winx64_struct2,
                    t_winx64_struct3,
                    t_winx64_struct4
    ...
    public static int test_0_Value_On_Stack_Local_Copy_Managed()
    {
        ...
        return
            (vector3Pair.second.x == 2 && vector3Pair.second.y == 3 && vector3Pair.second.z == 4)
          ? 0
          : 1;
    }
    ...
    public static int managed_struct1_struct5_test(
        winx64_struct1 var1,
        winx64_struct5 var2,
        winx64_struct1 var3,
        winx64_struct5 var4,
