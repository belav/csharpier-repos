...
if (oi != gtd) {
Console.WriteLine ("fully open instantiation of static type not the same of the generic type
definition");
return 1;
}
...
if (res != oires) {
Console.WriteLine ("fully open instantiation not the same of the generic type definition for the
TypeBuilder created type");
return 3;
}
...
Console.WriteLine ("fully open instantiation of TypeBuilder must have GetConstructors working {0}",
e);
return 4;
}
...
Console.WriteLine ("fully open instantiation of the TypeBuilder created type must have
GetConstructors working {0}", e);
return 5;
}*/
