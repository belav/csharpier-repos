...
namespace UnhandledExceptionTest
{
    class TestConfiguration
    {
                ...
                if (components.Length == 2)
                {
                    switch (components[0])
                    {
                        ...
                        case "DCIL":
                            ...
                            break;
                        case "DTDA":
                            useDifferentThreadInDifferentApplicationDomain = ParseArgumentValue(
                                components[1]
                            );
                            break;
                        case "HRA":
                            ...
                            break;
                        case "HDA":
                            addHandlerToDifferentApplicationDomain = ParseArgumentValue(
                                components[1]
                            );
                            break;
                        default:
        ...
        {
            Console.WriteLine(
                "Configuration: DT={0},DA={1},DCIL={2},DTDA={3},HRA={4},HDA={5}",
    ...
    class Test
    {
        ...
        public static void PrintUnhandledException(
            string caller,
            object sender,
