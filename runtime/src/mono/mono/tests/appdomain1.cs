...
class Container
{
    class MBRTest : MarshalByRefObject
    {
        public int Int
        {
            get { return (int)AppDomain.CurrentDomain.GetData("test_integer"); }
        }

        public string Str
        {
            get { return (string)AppDomain.CurrentDomain.GetData("test_string"); }
        }

        public bool Bool
        {
            get { return (bool)AppDomain.CurrentDomain.GetData("test_bool"); }
        }
