...
public class marshalbool
{
    ...
    [DllImport("libtest")]
    static extern int mono_test_marshal_bool_in(
        int arg,
        uint expected,
        bool bDefaultMarsh,
    ...
    [DllImport("libtest")]
    static extern int mono_test_marshal_bool_out(
        int arg,
        uint testVal,
    ...
    [DllImport("libtest")]
    static extern int mono_test_marshal_bool_ref(
        int arg,
        uint expected,
        uint testVal,
    ...
    delegate int MarshalBoolInDelegate(
        int arg,
        uint expected,
        bool bDefaultMarsh,
        [MarshalAs(UnmanagedType.Bool)] bool bBoolCustMarsh,
    ...
    delegate int MarshalBoolOutDelegate(
        int arg,
        uint testVal,
        out bool bDefaultMarsh,
        [MarshalAs(UnmanagedType.Bool)] out bool bBoolCustMarsh,
    ...
    delegate int MarshalBoolRefDelegate(
        int arg,
        uint expected,
        uint testVal,
        ref bool bDefaultMarsh,
    ...
    [DllImport("libtest")]
    static extern int mono_test_managed_marshal_bool_in(
        int arg,
        uint expected,
        uint testVal,
    ...
    [DllImport("libtest")]
    static extern int mono_test_managed_marshal_bool_out(
        int arg,
        uint expected,
        uint testVal,
    ...
    [DllImport("libtest")]
    static extern int mono_test_managed_marshal_bool_ref(
        int arg,
        uint expected,
        uint testVal,
        uint outExpected,
    ...
    public static unsafe int test_0_VariantBool_Ref_Native()
    {
        ...
        Marshal.WriteByte((IntPtr)ptestVal, 0x22);
        ret = mono_test_marshal_bool_ref(
            5,
            0xFFFF,
            0x2200,
            ref d,
