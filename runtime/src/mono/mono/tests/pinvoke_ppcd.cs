...
public class Test_double
{
    ...
    public static int Main(string[] args)
    {
        ...
        {
            Console.WriteLine(
                "   double2_nested sn2.nested1.f1: got {0} but expected {1}",
                sn2.nested1.f1,
                1 + 9
            );
            return 1;
        ...
        {
            Console.WriteLine(
                "   double2_nested sn2.nested2.f2: got {0} but expected {1}",
                sn2.nested2.f2,
                2 + 9
            );
            return 2;
...
/*
//  NOTE: this test does not work properly because mini_type_is_hfa in mini-codegen.c does not
handle arrays.
