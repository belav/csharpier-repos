...
class C
{
    class CrasherClass
    {
        ...
        static CrasherClass()
        {
            ...
            Crashers.Add(
                new Crasher(
                    ...
                    MerpCrashTestBreadcrumbs,
                    validator: ValidateBreadcrumbs
                )
            );
        }

        public static void MerpCrashManaged()
        {
            unsafe
            {
        ...
        public static void MerpCrashFailFast()
        {
        ...
        public static void ValidateFailFastMsg(object json)
        {
            ...
            if (s != failfastMsg)
                throw new ValidationException(
                    String.Format(
                        "incorrect fail fast message (expected: {0}, got: {1})",
                        failfastMsg,
                        s
                    )
                );
        ...
        public static void ValidateBreadcrumbs(object json)
        {
            ...
            var m = monoType.GetMethod(
                "CheckCrashReportReason",
            ...
            m = monoType.GetMethod(
                "CheckCrashReportHash",
                BindingFlags.NonPublic | BindingFlags.Static
            );
        ...
        public static void MerpCrashSnprintf()
        {
        ...
        public static void MerpCrashDladdr()
        {
        ...
        public static void MerpCrashMalloc()
        {
        ...
        public static void MerpCrashLoaderLock()
        {
        ...
        public static void MerpCrashDomainUnload()
        {
        ...
        public static void MerpCrashUnbalancedGCSafe()
        {
        ...
        public static void MerpCrashNullFp()
        {
        ...
        public static void MerpCrashSignalTerm()
        {
        ...
        public static void MerpCrashSignalAbrt()
        {
        ...
        public static void MerpCrashSignalFpe()
        {
        ...
        public static void MerpCrashSignalBus()
        {
        ...
        public static void MerpCrashSignalSegv()
        {
        ...
        public static void MerpCrashSignalIll()
        {
        ...
        public static void MerpCrashTestBreadcrumbs()
        {
            mono_test_MerpCrashSignalSegv();
        }
        ...
        private static object jsonGetKeys(object o, params string[] keys)
        {
            ...
            catch (KeyNotFoundException e)
            {
                throw new ValidationException(
                    String.Format(
                        "{0}, key not found, looking for key path [{1}]",
                        e.ToString(),
                        String.Join(", ", keys)
                    )
                );
    ...
    public static void CrashWithMerp(int testNum)
    {
    ...
    public static string this_assembly_path = Path.GetDirectoryName(
    ...
    public static void TestValidate(string configDir, bool silent, Action<object> validator = null)
    {
        ...
        if (crashFileExists)
        {
            ...
            {
                throw new Exception(
                    String.Format("Validation failed '{0}', json: {1}", e.Message, crashFile)
                );
            }
            catch (Exception e)
            {
                throw new Exception(
                    String.Format("Invalid json  ({0}:{1}): {2}", e.GetType(), e.Message, crashFile)
                );
            }
    ...
    public static void Cleanup(string configDir)
    {
    ...
    static void DumpLogCheck(string expected_level = "Done")
    {
        ...
        if (expected_level != levels[result])
            throw new Exception(
                String.Format(
                    "Crash level {0} does not match expected {1}",
                    levels[result],
                    expected_level
                )
            );
    ...
    public static void SpawnCrashingRuntime(string runtime, int testNum, bool silent)
    {
    ...
    public static int Main(string[] args)
    {
        if (args.Length == 0)
        {
            ...
            {
                Console.WriteLine(
                    "Sending managed exception to MERP failed: {0}\n{1}\n",
                    exception_test_failure.Message,
                    exception_test_failure.StackTrace
                );
            }
            ...
            if (failure_count > 0)
            {
                for (int i = 0; i < CrasherClass.Crashers.Count; i++)
                {
                    ...
                    {
                        Console.WriteLine(
                            "Crash reporter failed test {0}",
                            CrasherClass.Crashers[i].Name
                        );
                        Console.WriteLine(
                            "Cause: {0}\n{1}\n",
                            failures[i].Message,
            ...
            for (iter = 0; iter < 20; iter++)
            {
                ...
                {
                    Console.WriteLine(
                        "Stress test caught failure. Shutting down after {1} iterations.\n {0} \n\n",
                        e.InnerException,
                        iter
                    );
                    throw;
