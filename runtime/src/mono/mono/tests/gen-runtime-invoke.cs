...
/* There are multiple approaches, we generate c# directly */
        ...
        using (var w = new StreamWriter(Console.OpenStandardOutput()))
        {
            ...
            GenCase(
                ...
                "void",
                "",
                new string[] { "int", "int", "int", "FooStruct" },
            ...
            GenCase(
                ...
                "void",
                "",
                new string[] { "int", "int", "int", "FooStruct2" },
                new string[] { "1", "2", "3", "new FooStruct2 () { i = 0x123456789L }" }
            );
            ...
            GenCase(
                ...
                "void",
                "",
                new string[] { "int", "int", "int", "int", "FooStruct" },
            ...
            GenCase(
                ...
                new string[] { "FooStruct3" },
                new string[] { "new FooStruct3 () { i = true, j = false }" }
            );
            ...
            GenCase(
                ...
                "void",
                "",
                new string[] { "int", "int", "int", "int", "float" },
...
/* The caller */
        ...
        w.Write(
            "typeof (Tests).GetMethod (\"" + callee_name + "\").Invoke (null, new object [] { "
        );
        WriteList(w, values);
        w.WriteLine("});");
        if (retType != "void")
