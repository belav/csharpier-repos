...
public class BestFitMapping
{
    ...
    private static void TestMethod_CLPStr_In()
    {
        ...
        catch (Exception e)
        {
            ...
            TestFramework.LogError(
                "e01",
                "TestMethod_CLPStr_In:Unexpected Exception Occured:" + e.ToString()
            );
        }
    }
    ...
    private static void TestMethod_CLPStr_Out()
    {
        ...
        catch (Exception e)
        {
            ...
            TestFramework.LogError(
                "e02",
                "TestMethod_CLPStr_Out:Unexpected Exception Occured:" + e.ToString()
            );
        }
    }
    ...
    private static void TestMethod_CLPStr_InOut()
    {
        ...
        catch (Exception e)
        {
            ...
            TestFramework.LogError(
                "e03",
                "TestMethod_CLPStr_InOut:Unexpected Exception Occured:" + e.ToString()
            );
        }
    }
    ...
    private static void TestMethod_CLPStr_InRef()
    {
        ...
        catch (Exception e)
        {
            ...
            TestFramework.LogError(
                "e04",
                "TestMethod_CLPStr_InRef:Unexpected Exception Occured:" + e.ToString()
            );
        }
    }
    ...
    private static void TestMethod_CLPStr_OutRef()
    {
        ...
        catch (Exception e)
        {
            ...
            TestFramework.LogError(
                "e05",
                "TestMethod_CLPStr_OutRef:Unexpected Exception Occured:" + e.ToString()
            );
        }
    }
    ...
    private static void TestMethod_CLPStr_InOutRef()
    {
        ...
        catch (Exception e)
        {
            ...
            TestFramework.LogError(
                "e06",
                "TestMethod_CLPStr_InOutRef:Unexpected Exception Occured:" + e.ToString()
            );
        }
    }
    ...
    private static void TestMethod_CLPStr_DelegatePInvoke()
    {
        ...
        catch (Exception e)
        {
            ...
            TestFramework.LogError(
                "e07",
                "TestMethod_CLPStr_DelegatePInvoke:Unexpected Exception Occured:" + e.ToString()
            );
        }
    }
    ...
    private static void TestMethod_SLPStr_In()
    {
        ...
        catch (Exception e)
        {
            ...
            TestFramework.LogError(
                "e08",
                "TestMethod_SLPStr_In:Unexpected Exception Occured:" + e.ToString()
            );
        }
    }
    ...
    private static void TestMethod_SLPStr_Out()
    {
        ...
        catch (Exception e)
        {
            ...
            TestFramework.LogError(
                "e09",
                "TestMethod_SLPStr_Out:Unexpected Exception Occured:" + e.ToString()
            );
        }
    }
    ...
    private static void TestMethod_SLPStr_InOut()
    {
        ...
        catch (Exception e)
        {
            ...
            TestFramework.LogError(
                "e10",
                "TestMethod_SLPStr_InOut:Unexpected Exception Occured:" + e.ToString()
            );
        }
    }
    ...
    private static void TestMethod_SLPStr_InRef()
    {
        ...
        catch (Exception e)
        {
            ...
            TestFramework.LogError(
                "e11",
                "TestMethod_SLPStr_InRef:Unexpected Exception Occured:" + e.ToString()
            );
        }
    }
    ...
    private static void TestMethod_SLPStr_OutRef()
    {
        ...
        catch (Exception e)
        {
            ...
            TestFramework.LogError(
                "e12",
                "TestMethod_SLPStr_OutRef:Unexpected Exception Occured:" + e.ToString()
            );
        }
    }
    ...
    private static void TestMethod_SLPStr_InOutRef()
    {
        ...
        catch (Exception e)
        {
            ...
            TestFramework.LogError(
                "e13",
                "TestMethod_SLPStr_InOutRef:Unexpected Exception Occured:" + e.ToString()
            );
        }
    }
    ...
    private static void TestMethod_SLPStr_DelegatePInvoke()
    {
        ...
        catch (Exception e)
        {
            ...
            TestFramework.LogError(
                "e14",
                "TestMethod_SLPStr_DelegatePInvoke:Unexpected Exception Occured:" + e.ToString()
            );
        }
    }
