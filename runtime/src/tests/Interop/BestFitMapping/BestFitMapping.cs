...
public class BestFitMapping
{
    ...
    [return: MarshalAs(UnmanagedType.LPStr)]
    public static extern string CLPStr_InOut(
    ...
    [return: MarshalAs(UnmanagedType.LPStr)]
    public static extern string CLPStr_InByRef(
        [In, MarshalAs(UnmanagedType.LPStr)] ref StringBuilder str
    );
    ...
    [return: MarshalAs(UnmanagedType.LPStr)]
    public static extern string CLPStr_OutByRef(
        [MarshalAs(UnmanagedType.LPStr)] out StringBuilder str
    );
    ...
    [return: MarshalAs(UnmanagedType.LPStr)]
    public static extern string CLPStr_InOutByRef(
        [In, Out, MarshalAs(UnmanagedType.LPStr)] ref StringBuilder str
    );

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    [return: MarshalAs(UnmanagedType.LPStr)]
    public delegate string DelegatePInvoke_Cdecl(
        [In, Out, MarshalAs(UnmanagedType.LPStr)] ref StringBuilder str
    );
    ...
    [return: MarshalAs(UnmanagedType.LPStr)]
    public static extern string SLPStr_InOut(
        [In, Out, MarshalAs(UnmanagedType.LPStr)] StringBuilder str
    );
    ...
    [return: MarshalAs(UnmanagedType.LPStr)]
    public static extern string SLPStr_InByRef(
        [In, MarshalAs(UnmanagedType.LPStr)] ref StringBuilder str
    );
    ...
    [return: MarshalAs(UnmanagedType.LPStr)]
    public static extern string SLPStr_OutByRef(
        [MarshalAs(UnmanagedType.LPStr)] out StringBuilder str
    );
    ...
    [return: MarshalAs(UnmanagedType.LPStr)]
    public static extern string SLPStr_InOutByRef(
        [In, Out, MarshalAs(UnmanagedType.LPStr)] ref StringBuilder str
    );

    [UnmanagedFunctionPointer(CallingConvention.StdCall)]
    [return: MarshalAs(UnmanagedType.LPStr)]
    public delegate string DelegatePInvoke_StdCall(
        [In, Out, MarshalAs(UnmanagedType.LPStr)] ref StringBuilder str
    );
    ...
    private static void TestMethod_CLPStr_In()
    {
        ...
        catch (Exception e)
        {
            ...
            TestFramework.LogError(
                "e01",
                "TestMethod_CLPStr_In:Unexpected Exception Occurred:" + e.ToString()
            );
        }
    }
    ...
    private static void TestMethod_CLPStr_Out()
    {
        ...
        try
        {
            ...
            if (!NativeString.Equals(sb.ToString()))
            {
                ...
                TestFramework.LogError(
                    "004",
                    "TestMethod_CLPStr_Out:The Parameter value is wrong."
                );
            }
        }
        catch (Exception e)
        {
            ...
            TestFramework.LogError(
                "e02",
                "TestMethod_CLPStr_Out:Unexpected Exception Occurred:" + e.ToString()
            );
        }
    }
    ...
    private static void TestMethod_CLPStr_InOut()
    {
        ...
        try
        {
            ...
            if (!Compare(sTemp, sb.ToString()))
            {
                ...
                TestFramework.LogError(
                    "005",
                    "TestMethod_CLPStr_InOut:The Parameter value is wrong."
                );
            }
            //Check the return value
        ...
        catch (Exception e)
        {
            ...
            TestFramework.LogError(
                "e03",
                "TestMethod_CLPStr_InOut:Unexpected Exception Occurred:" + e.ToString()
            );
        }
    }
    ...
    private static void TestMethod_CLPStr_InRef()
    {
        ...
        try
        {
            ...
            if (!sTemp.Equals(sb.ToString()))
            {
                ...
                TestFramework.LogError(
                    "008",
                    "TestMethod_CLPStr_InRef:The Parameter value is wrong."
                );
            }
        }
        catch (Exception e)
        {
            ...
            TestFramework.LogError(
                "e04",
                "TestMethod_CLPStr_InRef:Unexpected Exception Occurred:" + e.ToString()
            );
        }
    }
    ...
    private static void TestMethod_CLPStr_OutRef()
    {
        ...
        try
        {
            ...
            if (!sNative.Equals(rstr))
            {
                ...
                TestFramework.LogError(
                    "009",
                    "TestMethod_CLPStr_OutRef:The Return value is wrong."
                );
            }
            //Check the Parameter
            if (!sNative.Equals(sb.ToString()))
            {
                ...
                TestFramework.LogError(
                    "010",
                    "TestMethod_CLPStr_OutRef:The Parameter value is wrong."
                );
            }
        }
        catch (Exception e)
        {
            ...
            TestFramework.LogError(
                "e05",
                "TestMethod_CLPStr_OutRef:Unexpected Exception Occurred:" + e.ToString()
            );
        }
    }
    ...
    private static void TestMethod_CLPStr_InOutRef()
    {
        ...
        try
        {
            ...
            if (!Compare(sTemp, rstr))
            {
                ...
                TestFramework.LogError(
                    "011",
                    "TestMethod_CLPStr_InOutRef:The Return value is wrong."
                );
            }
            //Check the Parameter
            if (!Compare(sTemp, sb.ToString()))
            {
                ...
                TestFramework.LogError(
                    "012",
                    "TestMethod_CLPStr_InOutRef:The Parameter value is wrong."
                );
            }
        }
        catch (Exception e)
        {
            ...
            TestFramework.LogError(
                "e06",
                "TestMethod_CLPStr_InOutRef:Unexpected Exception Occurred:" + e.ToString()
            );
        }
    }
    ...
    private static void TestMethod_CLPStr_DelegatePInvoke()
    {
        ...
        try
        {
            ...
            if (!Compare(sTemp, rstr))
            {
                ...
                TestFramework.LogError(
                    "013",
                    "TestMethod_CLPStr_DelegatePInvoke:The Return value is wrong."
                );
            }
            //Check the Parameter
            if (!Compare(sTemp, sb.ToString()))
            {
                ...
                TestFramework.LogError(
                    "014",
                    "TestMethod_CLPStr_DelegatePInvoke:The Parameter value is wrong."
                );
            }
        }
        catch (Exception e)
        {
            ...
            TestFramework.LogError(
                "e07",
                "TestMethod_CLPStr_DelegatePInvoke:Unexpected Exception Occurred:" + e.ToString()
            );
        }
    }
    ...
    private static void TestMethod_SLPStr_In()
    {
        ...
        catch (Exception e)
        {
            ...
            TestFramework.LogError(
                "e08",
                "TestMethod_SLPStr_In:Unexpected Exception Occurred:" + e.ToString()
            );
        }
    }
    ...
    private static void TestMethod_SLPStr_Out()
    {
        ...
        try
        {
            ...
            if (!NativeString.Equals(sb.ToString()))
            {
                ...
                TestFramework.LogError(
                    "018",
                    "TestMethod_SLPStr_Out:The Parameter value is wrong."
                );
            }
        }
        catch (Exception e)
        {
            ...
            TestFramework.LogError(
                "e09",
                "TestMethod_SLPStr_Out:Unexpected Exception Occurred:" + e.ToString()
            );
        }
    }
    ...
    private static void TestMethod_SLPStr_InOut()
    {
        ...
        try
        {
            ...
            if (!Compare(sTemp, sb.ToString()))
            {
                ...
                TestFramework.LogError(
                    "019",
                    "TestMethod_SLPStr_InOut:The Parameter value is wrong."
                );
            }
            //Check the return value
            if (!Compare(sTemp, rstr))
        ...
        catch (Exception e)
        {
            ...
            TestFramework.LogError(
                "e10",
                "TestMethod_SLPStr_InOut:Unexpected Exception Occurred:" + e.ToString()
            );
        }
    }
    ...
    private static void TestMethod_SLPStr_InRef()
    {
        ...
        try
        {
            ...
            if (!sTemp.Equals(sb.ToString()))
            {
                ...
                TestFramework.LogError(
                    "022",
                    "TestMethod_SLPStr_InRef:The Parameters value is wrong."
                );
            }
        }
        catch (Exception e)
        {
            ...
            TestFramework.LogError(
                "e11",
                "TestMethod_SLPStr_InRef:Unexpected Exception Occurred:" + e.ToString()
            );
        }
    }
    ...
    private static void TestMethod_SLPStr_OutRef()
    {
        ...
        catch (Exception e)
        {
            ...
            TestFramework.LogError(
                "e12",
                "TestMethod_SLPStr_OutRef:Unexpected Exception Occurred:" + e.ToString()
            );
        }
    }
    ...
    private static void TestMethod_SLPStr_InOutRef()
    {
        ...
        try
        {
            ...
            if (!Compare(sTemp, rstr))
            {
                ...
                TestFramework.LogError(
                    "025",
                    "TestMethod_SLPStr_InOutRef:The Return value is wrong."
                );
            }
            //Check the Parameter
            if (!Compare(sTemp, sb.ToString()))
            {
                ...
                TestFramework.LogError(
                    "026",
                    "TestMethod_SLPStr_InOutRef:The Parameter value is wrong."
                );
            }
        }
        catch (Exception e)
        {
            ...
            TestFramework.LogError(
                "e13",
                "TestMethod_SLPStr_InOutRef:Unexpected Exception Occurred:" + e.ToString()
            );
        }
    }
    ...
    private static void TestMethod_SLPStr_DelegatePInvoke()
    {
        ...
        try
        {
            ...
            if (!Compare(sTemp, rstr))
            {
                ...
                TestFramework.LogError(
                    "027",
                    "TestMethod_SLPStr_DelegatePInvoke:The Return value is wrong."
                );
            }
            //Check the Parameter
            if (!Compare(sTemp, sb.ToString()))
            {
                ...
                TestFramework.LogError(
                    "028",
                    "TestMethod_SLPStr_DelegatePInvoke:The Parameter value is wrong."
                );
            }
        }
        catch (Exception e)
        {
            ...
            TestFramework.LogError(
                "e14",
                "TestMethod_SLPStr_DelegatePInvoke:Unexpected Exception Occurred:" + e.ToString()
            );
        }
    }
    ...
    public static string TestMethod_CCallBackInOutByRef(ref string str)
    {
        ...
        if (sNative != str)
        {
            ...
            TestFramework.LogError(
                "032",
                "TestMethod_CCallBackInOutByRef:The Input value is wrong"
            );
        }
    ...
    public static string TestMethod_SCallBackIn(string str)
    {
        ...
        if (sNative != str)
        {
            ...
            TestFramework.LogError(
                "033",
                "TestMethod_SCallBackIn,Managed Side:The Input value is wrong"
            );
        }
    ...
    public static string TestMethod_SCallBackInOut(StringBuilder str)
    {
        ...
        if (!sNative.Equals(str.ToString()))
        {
            ...
            TestFramework.LogError(
                "034",
                "TestMethod_SCallBackInOut,Managed Side:The Input value is wrong"
            );
        }
    ...
    public static string TestMethod_SCallBackInByRef(ref string str)
    {
        ...
        if (sNative != str)
        {
            ...
            TestFramework.LogError(
                "035",
                "TestMethod_SCallBackInByRef,Managed Side:The Input value is wrong"
            );
        }
    ...
    public static string TestMethod_SCallBackInOutByRef(ref string str)
    {
        ...
        if (sNative != str)
        {
            ...
            TestFramework.LogError(
                "036",
                "TestMethod_SCallBackInOutByRef,Managed Side:The Input value is wrong"
            );
        }
