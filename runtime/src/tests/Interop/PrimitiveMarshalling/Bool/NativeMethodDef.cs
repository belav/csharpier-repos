...
public class BoolNative
{
    ...
    public static extern bool Marshal_As_In([In, MarshalAs(UnmanagedType.U1)] bool boolValue);
    ...
    [DllImport(nameof(BoolNative))]
    [return: MarshalAs(UnmanagedType.U1)]
    public static extern bool Marshal_As_Out([Out, MarshalAs(UnmanagedType.U1)] bool boolValue);
