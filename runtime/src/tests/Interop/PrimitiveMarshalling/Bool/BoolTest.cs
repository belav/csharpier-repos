...
public class Test
{
    ...
    public static void TestEntryPoint()
    {
        ...
        {
            ReportFailure(
                "Method Marshal_In[Managed Side],The return value is wrong",
                true,
                boolValueRet1
            );
        }
        ...
        {
            ReportFailure(
                "Method Marshal_InOut[Managed Side],The return value is wrong",
                true,
                boolValueRet2
            );
        }
        ...
        {
            ReportFailure(
                "Method Marshal_InOut[Managed Side],The parameter value is changed",
                boolManaged,
                boolValue2
            );
        }
        ...
        {
            ReportFailure(
                "Method Marshal_Out[Managed Side],The return value is wrong",
                true,
                boolValueRet3
            );
        }
        ...
        {
            ReportFailure(
                "Method Marshal_Out[Managed Side],The parameter value is changed",
                boolManaged,
                boolValue3
            );
        }
        ...
        {
            ReportFailure(
                "Method MarshalPointer_In[Managed Side],The return value is wrong",
                true,
                boolValueRet4
            );
        }
        ...
        {
            ReportFailure(
                "Method MarshalPointer_In[Managed Side],The parameter value is changed",
                boolManaged,
                boolValue4
            );
        }
        ...
        {
            ReportFailure(
                "Method MarshalPointer_InOut[Managed Side],The return value is wrong",
                true,
                boolValueRet5
            );
        }
        ...
        {
            ReportFailure(
                "Method MarshalPointer_InOut[Managed Side],The passed value is wrong",
                boolNative,
                boolValue5
            );
        }
        ...
        {
            ReportFailure(
                "Method Marshal_Out[Managed Side],The passed value is wrong",
                boolNative,
                boolValue6
            );
        }
        ...
        {
            ReportFailure(
                "Method Marshal_As_In[Managed Side],The return value is wrong",
                true,
                boolValueRet7
            );
        }
        ...
        {
            ReportFailure(
                "Method Marshal_As_InOut[Managed Side],The return value is wrong",
                true,
                boolValueRet8
            );
        }
        ...
        {
            ReportFailure(
                "Method Marshal_As_InOut[Managed Side],The parameter value is changed",
                boolManaged,
                boolValue8
            );
        }
        ...
        {
            ReportFailure(
                "Method Marshal_As_Out[Managed Side],The return value is wrong",
                true,
                boolValueRet9
            );
        }
        ...
        {
            ReportFailure(
                "Method Marshal_As_Out[Managed Side],The parameter value is changed",
                boolManaged,
                boolValue9
            );
        }
    ...
    private static void TestVariantBool()
    {
        ...
        {
            ReportFailure(
                "Method Marshal_ByValue_Variant[Managed Side], The return value is wrong",
                true,
                true
            );
        }
        ...
        {
            ReportFailure(
                "Method Marshal_Ref_Variant[Managed Side], The return value is wrong.",
                true,
                boolValueRet10
            );
        }
        ...
        {
            ReportFailure(
                "Method Marshal_Ref_Variant[Managed Side],The passed value is wrong",
                boolNative,
                boolValue10
            );
        }

        var trueStruct = new BoolNative.ContainsVariantBool { value = true };

        var falseStruct = new BoolNative.ContainsVariantBool { value = false };
        ...
        var boolValue11 = new BoolNative.ContainsVariantBool { value = boolManaged };
