    ...
    public static void RunGetDelForFcnPtrTest()
    {
        ...
        // Delegate -> FcnPtr -> Delegate
        {
            ...
            Assert.AreEqual(
                md.Target,
                del.Target,
                "Failure - the Target of the funcptr->delegate should be equal to the original method."
            );
            Assert.AreEqual(
                md.Method,
                del.Method,
                "Failure - The Method of the funcptr->delegate should be equal to the MethodInfo of the original method."
            );
        }
        ...
        // Native FcnPtr -> Delegate
        {
            ...
            Assert.AreEqual(
                null,
                del.Target,
                "Failure - the Target of the funcptr->delegate should be null since we provided native funcptr."
            );
            Assert.AreEqual(
                "Invoke",
                del.Method.Name,
                "Failure - The Method of the native funcptr->delegate should be the Invoke method."
            );
