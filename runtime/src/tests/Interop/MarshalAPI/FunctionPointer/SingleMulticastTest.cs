...
partial class FunctionPtr
{
    ...
    public static MultiDelegateWithLong s_MultidelWithLong =
        new MultiDelegateWithLong(MethodWithLong);
    ...
    public static void RunGetFcnPtrSingleMulticastTest()
    {
        ...
        {
            IntPtr fcnptr =
                Marshal.GetFunctionPointerForDelegate<DelegateWithLong>(s_DelWithLongBool);
            Assert.IsTrue(FunctionPointerNative.CheckFcnPtr(fcnptr));
        }

        {
            IntPtr fcnptr =
                Marshal.GetFunctionPointerForDelegate<MultiDelegateWithLong>(s_MultidelWithLong);
