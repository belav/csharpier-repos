...
public class StringTesting : Server.Contract.IStringTesting
{
    ...
    public void Reverse_LPStr_OutAttr(
        [MarshalAs(UnmanagedType.LPStr)] string a,
    ...
    [return: MarshalAs(UnmanagedType.LPStr)]
    public StringBuilder Reverse_SB_LPStr_InRef(
    ...
    public void Reverse_SB_LPStr_Out(
    ...
    public void Reverse_SB_LPStr_OutAttr(
        [MarshalAs(UnmanagedType.LPStr)] StringBuilder a,
    ...
    public void Reverse_LPWStr_Out(
        [MarshalAs(UnmanagedType.LPWStr)] string a,
    ...
    public void Reverse_LPWStr_OutAttr(
        [MarshalAs(UnmanagedType.LPWStr)] string a,
    ...
    [return: MarshalAs(UnmanagedType.LPWStr)]
    public StringBuilder Reverse_SB_LPWStr_Ref(
        [MarshalAs(UnmanagedType.LPWStr)] ref StringBuilder a
    )
    {
        return new StringBuilder(Reverse(a.ToString()));
    }
    ...
    [return: MarshalAs(UnmanagedType.LPWStr)]
    public StringBuilder Reverse_SB_LPWStr_InRef(
    ...
    public void Reverse_SB_LPWStr_Out(
    ...
    public void Reverse_SB_LPWStr_OutAttr(
        [MarshalAs(UnmanagedType.LPWStr)] StringBuilder a,
    ...
    public void Reverse_BStr_OutAttr(
        [MarshalAs(UnmanagedType.BStr)] string a,
