    ...
    internal class ParametersTest
    {
        ...
        private void Named()
        {
            ...
            Assert.AreAllEqual(
                expected,
                ret,
                "Unexpected result calling function with all named arguments"
            );
            ...
            Assert.AreAllEqual(
                expected,
                ret,
                "Unexpected result calling function with some named arguments"
            );
            ...
            Assert.AreAllEqual(
                expected,
                ret,
                "Unexpected result calling function with out-of-order named arguments"
            );
        ...
        private void DefaultValue()
        {
            ...
            Assert.AreAllEqual(
                expected,
                ret,
                "Unexpected result calling function with all arguments omitted"
            );
            ...
            Assert.AreAllEqual(
                expected,
                ret,
                "Unexpected result calling function with some arguments specified"
            );
            ...
            Assert.AreAllEqual(
                expected,
                ret,
                "Unexpected result calling function with all arguments specified"
            );
            ...
            Assert.AreAllEqual(
                expected,
                ret,
                "Unexpected result calling function with named arguments"
            );
        }
