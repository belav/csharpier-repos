...
public class PInvokeDetach
{
    ...
    public static int test_0_attach_invoke_foreign_thread()
    {
        ...
        bool skipped = mono_test_attach_invoke_foreign_thread(
            typeof(PInvokeDetach).Assembly.Location,
            TestNamespace,
            TestName,
            nameof(MethodInvokedFromNative),
            null
        );
    ...
    [DllImport(
        ...
        EntryPoint = "mono_test_attach_invoke_block_foreign_thread"
    )]
    ...
    public static int test_0_attach_invoke_block_foreign_thread()
    {
        bool skipped = mono_test_attach_invoke_block_foreign_thread(
            ...
            TestNamespace,
            TestName,
            nameof(MethodInvokedFromNative2),
            null
        );
        GC.Collect(); // should not hang waiting for the foreign thread
