...
public class Managed
{
    ...
    [DllImport("MarshalStructAsParam", EntryPoint = "MarshalStructAsParam_AsSeqByVal4")]
    static extern bool MarshalStructAsParam_AsSeqByValInOut4(
        [In, Out] CharSetUnicodeSequential str1
    );
    ...
    static extern bool MarshalStructAsParam_AsSeqByValInOut9(
        [In, Out] StringStructSequentialAnsi str1
    );
    ...
    [DllImport("MarshalStructAsParam")]
    static extern bool MarshalStructAsParam_AsSeqByRefIn10(
        [In] ref StringStructSequentialUnicode str1
    );

    [DllImport("MarshalStructAsParam")]
    static extern bool MarshalStructAsParam_AsSeqByValOut10(
        [Out] StringStructSequentialUnicode str1
    );
    ...
    [DllImport("MarshalStructAsParam", EntryPoint = "MarshalStructAsParam_AsSeqByVal10")]
    static extern bool MarshalStructAsParam_AsSeqByValInOut10(
        [In, Out] StringStructSequentialUnicode str1
    );
    ...
    [DllImport("MarshalStructAsParam")]
    static extern bool MarshalStructAsParam_AsSeqByRef13(
        ref IncludeOuterIntegerStructSequential str1
    );

    [DllImport("MarshalStructAsParam", EntryPoint = "MarshalStructAsParam_AsSeqByVal13")]
    static extern bool MarshalStructAsParam_AsSeqByValIn13(
        [In] IncludeOuterIntegerStructSequential str1
    );

    [DllImport("MarshalStructAsParam")]
    static extern bool MarshalStructAsParam_AsSeqByRefIn13(
        [In] ref IncludeOuterIntegerStructSequential str1
    );

    [DllImport("MarshalStructAsParam")]
    static extern bool MarshalStructAsParam_AsSeqByValOut13(
        [Out] IncludeOuterIntegerStructSequential str1
    );

    [DllImport("MarshalStructAsParam")]
    static extern bool MarshalStructAsParam_AsSeqByRefOut13(
        out IncludeOuterIntegerStructSequential str1
    );

    [DllImport("MarshalStructAsParam", EntryPoint = "MarshalStructAsParam_AsSeqByVal13")]
    static extern bool MarshalStructAsParam_AsSeqByValInOut13(
        [In, Out] IncludeOuterIntegerStructSequential str1
    );
    ...
    [DllImport("MarshalStructAsParam")]
    static extern bool MarshalStructAsParam_AsSeqByValSequentialDoubleWrapper(
        SequentialDoubleWrapper wrapper
    );

    [DllImport("MarshalStructAsParam")]
    static extern bool MarshalStructAsParam_AsSeqByValSequentialAggregateSequentialWrapper(
        AggregateSequentialWrapper wrapper
    );

    [DllImport("MarshalStructAsParam")]
    static extern bool MarshalStructAsParam_AsSeqByValFixedBufferClassificationTest(
        FixedBufferClassificationTest str,
        float f
    );

    [DllImport("MarshalStructAsParam")]
    static extern bool MarshalStructAsParam_AsSeqByValFixedBufferClassificationTest(
        FixedBufferClassificationTestBlittable str,
        float f
    );

    [DllImport("MarshalStructAsParam")]
    static extern bool MarshalStructAsParam_AsSeqByValFixedBufferClassificationTest(
        FixedArrayClassificationTest str,
        float f
    );

    [DllImport("MarshalStructAsParam")]
    static extern bool MarshalStructAsParam_AsSeqByValFixedBufferClassificationTest(
        InlineArrayClassificationTest str,
        float f
    );

    [DllImport("MarshalStructAsParam")]
    static extern bool MarshalStructAsParam_AsSeqByValFixedBufferClassificationTest(
        InlineArrayWithWrappedIntClassificationTest str,
        float f
    );

    [DllImport("MarshalStructAsParam")]
    static extern bool MarshalStructAsParam_AsSeqByValUnicodeCharArrayClassification(
        UnicodeCharArrayClassification str,
        float f
    );
    ...
    [DllImport("MarshalStructAsParam")]
    static extern void MarshalStructAsParam_DelegateFieldMarshaling(
        ref DelegateFieldMarshaling dfm
    );
        ...
        try
        {
            switch (id)
            {
                case StructID.InnerSequentialId:
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByVal.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                    if (
                        !Helper.ValidateInnerSequential(
                            source_is,
                            clone_is,
                ...
                case StructID.InnerArraySequentialId:
                    InnerArraySequential source_ias = Helper.NewInnerArraySequential(
                        1,
                        1.0F,
                        "some string"
                    );
                    InnerArraySequential clone_ias = Helper.NewInnerArraySequential(
                        1,
                        1.0F,
                        "some string"
                    );
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByVal2.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                    if (
                        !Helper.ValidateInnerArraySequential(
                            source_ias,
                            clone_ias,
                ...
                case StructID.CharSetAnsiSequentialId:
                    CharSetAnsiSequential source_csas = Helper.NewCharSetAnsiSequential(
                        "some string",
                        'c'
                    );
                    CharSetAnsiSequential clone_csas = Helper.NewCharSetAnsiSequential(
                        "some string",
                        'c'
                    );
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByVal3.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                    if (
                        !Helper.ValidateCharSetAnsiSequential(
                            source_csas,
                            clone_csas,
                ...
                case StructID.CharSetUnicodeSequentialId:
                    CharSetUnicodeSequential source_csus = Helper.NewCharSetUnicodeSequential(
                        "some string",
                        'c'
                    );
                    CharSetUnicodeSequential clone_csus = Helper.NewCharSetUnicodeSequential(
                        "some string",
                        'c'
                    );
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByVal4.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                    if (
                        !Helper.ValidateCharSetUnicodeSequential(
                            source_csus,
                            clone_csus,
                ...
                case StructID.NumberSequentialId:
                    NumberSequential source_ns = Helper.NewNumberSequential(
                        Int32.MinValue,
                        UInt32.MaxValue,
                        short.MinValue,
                        ushort.MaxValue,
                    ...
                    NumberSequential clone_ns = Helper.NewNumberSequential(
                        Int32.MinValue,
                        UInt32.MaxValue,
                        short.MinValue,
                        ushort.MaxValue,
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByVal6.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                    if (
                        !Helper.ValidateNumberSequential(
                            source_ns,
                            clone_ns,
                ...
                case StructID.S3Id:
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByVal7.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                ...
                case StructID.S5Id:
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByVal8.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                ...
                case StructID.StringStructSequentialAnsiId:
                    ...
                    StringStructSequentialAnsi source_sssa = Helper.NewStringStructSequentialAnsi(
                        strOne,
                        strTwo
                    );
                    StringStructSequentialAnsi clone_sssa = Helper.NewStringStructSequentialAnsi(
                        strOne,
                        strTwo
                    );
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByVal9.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                    if (
                        !Helper.ValidateStringStructSequentialAnsi(
                            source_sssa,
                            clone_sssa,
                ...
                case StructID.StringStructSequentialUnicodeId:
                    ...
                    StringStructSequentialUnicode source_sssu =
                        Helper.NewStringStructSequentialUnicode(strOne, strTwo);
                    StringStructSequentialUnicode clone_sssu =
                        Helper.NewStringStructSequentialUnicode(strOne, strTwo);
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByVal10.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                    if (
                        !Helper.ValidateStringStructSequentialUnicode(
                            source_sssu,
                            clone_sssu,
                ...
                case StructID.S8Id:
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByVal11.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                ...
                case StructID.S9Id:
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByVal12.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                ...
                case StructID.IncludeOuterIntegerStructSequentialId:
                    IncludeOuterIntegerStructSequential sourceIncludeOuterIntegerStructSequential =
                        Helper.NewIncludeOuterIntegerStructSequential(32, 32);
                    IncludeOuterIntegerStructSequential cloneIncludeOuterIntegerStructSequential =
                        Helper.NewIncludeOuterIntegerStructSequential(32, 32);
                    ...
                    if (
                        !Helper.ValidateIncludeOuterIntegerStructSequential(
                            sourceIncludeOuterIntegerStructSequential,
                ...
                case StructID.S11Id:
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByVal14.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                    if (
                ...
                case StructID.AutoStringId:
                    ...
                    {
                        AutoString autoStr = new AutoString { str = "Auto CharSet test string" };
                        int actual = GetStringLength(autoStr);
                        if (actual != autoStr.str.Length)
                        {
                            Console.WriteLine(
                                $"\tFAILED! Managed to Native failed in GetStringLength. Expected {autoStr.str.Length}, got {actual}"
                            );
                        }
                    }
                    break;
                case StructID.IntWithInnerSequentialId:
                    ...
                    Console.WriteLine(
                        "\tCalling MarshalStructAsParam_AsSeqByValIntWithInnerSequential..."
                    );
                    if (!MarshalStructAsParam_AsSeqByValIntWithInnerSequential(intWithInnerSeq, 42))
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByValIntWithInnerSequential.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                    break;
                case StructID.SequentialWrapperId:
                    ...
                    Console.WriteLine(
                        "\tCalling MarshalStructAsParam_AsSeqByValSequentialWrapper..."
                    );
                    if (!MarshalStructAsParam_AsSeqByValSequentialWrapper(sequentialWrapper))
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByValSequentialWrapper.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                    break;
                case StructID.SequentialDoubleWrapperId:
                    ...
                    Console.WriteLine(
                        "\tCalling MarshalStructAsParam_AsSeqByValSequentialDoubleWrapper..."
                    );
                    if (!MarshalStructAsParam_AsSeqByValSequentialDoubleWrapper(doubleWrapper))
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByValSequentialDoubleWrapper.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                    break;
                ...
                case StructID.FixedBufferClassificationTestId:
                    Console.WriteLine(
                        "\tCalling MarshalStructAsParam_AsSeqByValFixedBufferClassificationTest with nonblittable struct..."
                    );
                    unsafe
                    {
                        ...
                        if (
                            !MarshalStructAsParam_AsSeqByValFixedBufferClassificationTest(
                                str,
                                str.f.F
                            )
                        )
                    ...
                    Console.WriteLine(
                        "\tCalling MarshalStructAsParam_AsSeqByValFixedBufferClassificationTest with blittable struct..."
                    );
                    unsafe
                    {
                        FixedBufferClassificationTestBlittable str =
                            new FixedBufferClassificationTestBlittable();
                        str.arr[0] = 123456;
                        str.arr[1] = 78910;
                        str.arr[2] = 1234;
                        str.f = 56.789f;
                    ...
                    Console.WriteLine(
                        "\tCalling MarshalStructAsParam_AsSeqByValFixedBufferClassificationTest with fixed array..."
                    );
                    ...
                    Console.WriteLine(
                        "\tCalling MarshalStructAsParam_AsSeqByValFixedBufferClassificationTest with inline array..."
                    );

                    {
                        InlineArrayClassificationTest inlineArrayTest = new() { f = 56.789f };
                ...
                case StructID.UnicodeCharArrayClassificationId:
                    Console.WriteLine(
                        "\tCalling MarshalStructAsParam_AsSeqByValUnicodeCharArrayClassification with nonblittable struct..."
                    );
                    unsafe
                    {
                        UnicodeCharArrayClassification str = new UnicodeCharArrayClassification
                        {
                            arr = new char[6],
                        };
                        str.f = 56.789f;
                        if (
                            !MarshalStructAsParam_AsSeqByValUnicodeCharArrayClassification(
                                str,
                                str.f
                            )
                        )
    ...
    private static unsafe void MarshalStructAsParam_AsSeqByRef(StructID id)
    {
        try
        {
            switch (id)
            {
                case StructID.InnerSequentialId:
                    InnerSequential source_is = Helper.NewInnerSequential(1, 1.0F, "some string");
                    InnerSequential change_is = Helper.NewInnerSequential(
                        77,
                        77.0F,
                        "changed string"
                    );
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByRef.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                    if (
                ...
                case StructID.InnerArraySequentialId:
                    ...
                    InnerArraySequential change_ias = Helper.NewInnerArraySequential(
                        77,
                        77.0F,
                        "changed string"
                    );
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByRef2.Expected:True;Actual:False"
                        );
                    }
                    if (
                        !Helper.ValidateInnerArraySequential(
                ...
                case StructID.CharSetAnsiSequentialId:
                    ...
                    CharSetAnsiSequential changeStr1 = Helper.NewCharSetAnsiSequential(
                        "change string",
                        'n'
                    );
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByRef3.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                    if (
                ...
                case StructID.CharSetUnicodeSequentialId:
                    ...
                    CharSetUnicodeSequential change_csus = Helper.NewCharSetUnicodeSequential(
                        "change string",
                        'n'
                    );
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByRef4.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                    if (
                ...
                case StructID.NumberSequentialId:
                    ...
                    NumberSequential change_ns = Helper.NewNumberSequential(
                        0,
                        32,
                        0,
                        16,
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByRef6.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                    if (
                ...
                case StructID.S3Id:
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByRef7.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                ...
                case StructID.S5Id:
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByRef8.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                ...
                case StructID.StringStructSequentialAnsiId:
                    ...
                    StringStructSequentialAnsi change_sssa = Helper.NewStringStructSequentialAnsi(
                        strTwo,
                        strOne
                    );
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByRef9.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                    if (
                ...
                case StructID.StringStructSequentialUnicodeId:
                    ...
                    StringStructSequentialUnicode source_sssu =
                        Helper.NewStringStructSequentialUnicode(strOne, strTwo);
                    StringStructSequentialUnicode change_sssu =
                        Helper.NewStringStructSequentialUnicode(strTwo, strOne);

                    Console.WriteLine("\tCalling MarshalStructAsParam_AsSeqByRef10...");
                    if (!MarshalStructAsParam_AsSeqByRef10(ref source_sssu))
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByRef10.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                    if (
                ...
                case StructID.S8Id:
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByRef11.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                ...
                case StructID.S9Id:
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByRef12.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                ...
                case StructID.IncludeOuterIntegerStructSequentialId:
                    IncludeOuterIntegerStructSequential sourceIncludeOuterIntegerStructSequential =
                        Helper.NewIncludeOuterIntegerStructSequential(32, 32);
                    IncludeOuterIntegerStructSequential changeIncludeOuterIntegerStructSequential =
                        Helper.NewIncludeOuterIntegerStructSequential(64, 64);
                ...
                case StructID.S11Id:
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByRef14.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                    if (
        ...
        try
        {
            switch (id)
            {
                case StructID.InnerSequentialId:
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByValIn.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                    if (
                ...
                case StructID.InnerArraySequentialId:
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByValIn2.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                    if (
                ...
                case StructID.CharSetAnsiSequentialId:
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByValIn3.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                    if (
                ...
                case StructID.CharSetUnicodeSequentialId:
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByValIn4.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                    if (
                ...
                case StructID.NumberSequentialId:
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByValIn6.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                    if (
                ...
                case StructID.S3Id:
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByValIn7.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                ...
                case StructID.S5Id:
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByValIn8.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                ...
                case StructID.StringStructSequentialAnsiId:
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByValIn9.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                    if (
                ...
                case StructID.StringStructSequentialUnicodeId:
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByValIn10.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                    if (
                ...
                case StructID.S8Id:
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByValIn11.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                    if (
                ...
                case StructID.S9Id:
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByValIn12.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                    if (
                ...
                case StructID.S11Id:
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByValIn14.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                    if (
        ...
        try
        {
            switch (id)
            {
                case StructID.InnerSequentialId:
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByRefIn.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                    if (
                ...
                case StructID.InnerArraySequentialId:
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByRefIn2.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                    if (
                ...
                case StructID.CharSetAnsiSequentialId:
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByRefIn3.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                    if (
                ...
                case StructID.CharSetUnicodeSequentialId:
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByRefIn4.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                    if (
                ...
                case StructID.NumberSequentialId:
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByRefIn6.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                    if (
                ...
                case StructID.S3Id:
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByRefIn7.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                ...
                case StructID.S5Id:
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByRefIn8.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                ...
                case StructID.StringStructSequentialAnsiId:
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByRefIn9.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                    if (
                ...
                case StructID.StringStructSequentialUnicodeId:
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByRefIn10.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                    if (
                ...
                case StructID.S8Id:
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByRefIn11.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                    if (
                ...
                case StructID.S9Id:
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByRefIn12.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                    if (
                ...
                case StructID.S11Id:
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByRefIn14.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                    if (
        ...
        try
        {
            switch (id)
            {
                case StructID.InnerSequentialId:
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByValOut.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                    if (
                ...
                case StructID.InnerArraySequentialId:
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByValOut2.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                    if (
                ...
                case StructID.CharSetAnsiSequentialId:
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByValOut3.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                    if (
                ...
                case StructID.CharSetUnicodeSequentialId:
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByValOut4.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                    if (
                ...
                case StructID.NumberSequentialId:
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByValOut6.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                    if (
                ...
                case StructID.S3Id:
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByValOut7.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                    if (
                ...
                case StructID.S5Id:
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByValOut8.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                    if (
                ...
                case StructID.StringStructSequentialAnsiId:
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByValOut9.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                    if (
                ...
                case StructID.StringStructSequentialUnicodeId:
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByValOut10.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                    if (
                ...
                case StructID.S8Id:
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByValOut11.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                    if (
                ...
                case StructID.S9Id:
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByValOut12.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                    if (
                ...
                case StructID.S11Id:
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByValOut14.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                    if (
        ...
        try
        {
            switch (id)
            {
                case StructID.InnerSequentialId:
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByRefOut.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                    if (
                ...
                case StructID.InnerArraySequentialId:
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByRefOut2.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                    if (
                ...
                case StructID.CharSetAnsiSequentialId:
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByRefOut3.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                    if (
                ...
                case StructID.CharSetUnicodeSequentialId:
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByRefOut4.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                    if (
                ...
                case StructID.NumberSequentialId:
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByRefOut6.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                    if (
                ...
                case StructID.S3Id:
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByRefOut7.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                    if (
                ...
                case StructID.S5Id:
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByRefOut8.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                    if (
                ...
                case StructID.StringStructSequentialAnsiId:
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByRefOut9.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                    if (
                ...
                case StructID.StringStructSequentialUnicodeId:
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByRefOut10.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                    if (
                ...
                case StructID.S8Id:
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByRefOut11.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                    if (
                ...
                case StructID.S9Id:
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByRefOut12.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Native to Managed failed in MarshalStructAsParam_AsSeqByRefOut12."
                        );
                        failures++;
                    }
                    else
                ...
                case StructID.S11Id:
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByRefOut14.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                    if (
        ...
        try
        {
            switch (id)
            {
                case StructID.InnerSequentialId:
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByValInOut.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                    if (
                ...
                case StructID.InnerArraySequentialId:
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByValInOut2.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                    if (
                ...
                case StructID.CharSetAnsiSequentialId:
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByValInOut3.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                    if (
                ...
                case StructID.CharSetUnicodeSequentialId:
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByValInOut4.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                    if (
                ...
                case StructID.NumberSequentialId:
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByValInOut6.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                    if (
                ...
                case StructID.S3Id:
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByValInOut7.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                    if (
                ...
                case StructID.S5Id:
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByValInOut8.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                    if (
                ...
                case StructID.StringStructSequentialAnsiId:
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByValInOut9.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                    if (
                ...
                case StructID.StringStructSequentialUnicodeId:
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByValInOut10.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                    if (
                ...
                case StructID.S8Id:
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByValInOut11.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                    if (
                ...
                case StructID.S9Id:
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByValInOut12.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                    if (
                ...
                case StructID.S11Id:
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByValInOut14.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                    if (
        ...
        try
        {
            switch (id)
            {
                case StructID.InnerSequentialId:
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByRefInOut.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                    if (
                ...
                case StructID.InnerArraySequentialId:
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByRefInOut2.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                    if (
                ...
                case StructID.CharSetAnsiSequentialId:
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByRefInOut3.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                    if (
                ...
                case StructID.CharSetUnicodeSequentialId:
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByRefInOut4.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                    if (
                ...
                case StructID.NumberSequentialId:
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByRefInOut6.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                    if (
                ...
                case StructID.S3Id:
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByRefInOut7.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                    if (
                ...
                case StructID.S5Id:
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByRefInOut8.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                    if (
                ...
                case StructID.StringStructSequentialAnsiId:
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByRefInOut9.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                    if (
                ...
                case StructID.StringStructSequentialUnicodeId:
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByRefInOut10.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                    if (
                ...
                case StructID.S8Id:
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByRefInOut11.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                    if (
                ...
                case StructID.S9Id:
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByRefInOut12.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                    if (
                ...
                case StructID.S11Id:
                    ...
                    {
                        Console.WriteLine(
                            "\tFAILED! Managed to Native failed in MarshalStructAsParam_AsSeqByRefInOut14.Expected:True;Actual:False"
                        );
                        failures++;
                    }
                    if (
    ...
    private static void RunMarshalSeqStructAsReturn()
    {
        ...
        {
            Console.WriteLine(
                "Structure of two bools marshalled to BOOLs returned from native to managed failed"
            );
            failures++;
        }
    ...
    private static void RunMarshalSeqStructDelegateField()
    {
        ...
        {
            Console.WriteLine(
                $"Marshaling null function pointer as ${nameof(Delegate)} field should succeed"
            );
            failures++;
        }
        ...
        {
            Console.WriteLine(
                $"Marshaling function pointer as ${nameof(Delegate)} field should succeed"
            );
            failures++;
        }

        dfm.IntIntFunction = Marshal.GetDelegateForFunctionPointer<IntIntDelegate>(
            GetNativeIntIntFunction()
        );
        try
        {
            MarshalStructAsParam_DelegateFieldMarshaling(ref dfm);
        ...
        {
            Console.WriteLine(
                $"Marshaling native function pointer should throw {nameof(ArgumentException)}"
            );
            failures++;
        }
