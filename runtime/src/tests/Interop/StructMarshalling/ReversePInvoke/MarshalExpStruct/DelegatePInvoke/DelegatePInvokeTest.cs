...
public class Test_DelegatePInvokeTest
{
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate bool DelegateCdeclByRef_InnerArrayExplicit(
        [In, Out] ref InnerArrayExplicit iae
    );
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate bool DelegateCdeclByRef_ByteStructPack2Explicit(
    ...
    public delegate bool DelegateCdeclByRef_ShortStructPack4Explicit(
        [In, Out] ref ShortStructPack4Explicit bspe
    );
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate bool DelegateCdeclByRef_IntStructPack8Explicit(
        [In, Out] ref IntStructPack8Explicit bspe
    );
    ...
    public delegate bool DelegateCdeclByRef_LongStructPack16Explicit(
        [In, Out] ref LongStructPack16Explicit bspe
    );
    ...
    private static void TestMethod_DelegatePInvoke_MarshalByRef_Cdecl(StructID structid)
    {
        ...
        switch (structid)
        {
            case StructID.INNER2Id:
                ...
                DelegateCdeclByRef_INNER2 caller_INNER2 =
                    Get_MarshalStructAsParam_AsExpByRefINNER2_Cdecl_FuncPtr();
                Console.WriteLine(
            ...
            case StructID.InnerExplicitId:
                ...
                DelegateCdeclByRef_InnerExplicit caller_InnerExplicit =
                    Get_MarshalStructAsParam_AsExpByRefInnerExplicit_Cdecl_FuncPtr();
                Console.WriteLine(
                    "Calling Get_MarshalStructAsParam_AsExpByRefInnerExplicit_Cdecl_FuncPtr..."
                );
            ...
            case StructID.InnerArrayExplicitId:
                ...
                DelegateCdeclByRef_InnerArrayExplicit caller_InnerArrayExplicit =
                    Get_MarshalStructAsParam_AsExpByRefInnerArrayExplicit_Cdecl_FuncPtr();
                Console.WriteLine(
                    "Calling Get_MarshalStructAsParam_AsExpByRefInnerArrayExplicit_Cdecl_FuncPtr..."
                );
            ...
            case StructID.OUTER3Id:
                ...
                DelegateCdeclByRef_OUTER3 caller_OUTER3 =
                    Get_MarshalStructAsParam_AsExpByRefOUTER3_Cdecl_FuncPtr();
                Console.WriteLine(
                    "Calling Get_MarshalStructAsParam_AsExpByRefOUTER3_Cdecl_FuncPtr..."
                );
            ...
            case StructID.ByteStructPack2ExplicitId:
                ...
                DelegateCdeclByRef_ByteStructPack2Explicit caller_ByteStructPack2Explicit =
                    Get_MarshalStructAsParam_AsExpByRefByteStructPack2Explicit_Cdecl_FuncPtr();
                Console.WriteLine(
                    "Calling Get_MarshalStructAsParam_AsExpByRefByteStructPack2Explicit_Cdecl_FuncPtr..."
                );
            ...
            case StructID.ShortStructPack4ExplicitId:
                ...
                DelegateCdeclByRef_ShortStructPack4Explicit caller_ShortStructPack4Explicit =
                    Get_MarshalStructAsParam_AsExpByRefShortStructPack4Explicit_Cdecl_FuncPtr();
                Console.WriteLine(
                    "Calling Get_MarshalStructAsParam_AsExpByRefShortStructPack4Explicit_Cdecl_FuncPtr..."
                );
            ...
            case StructID.IntStructPack8ExplicitId:
                ...
                DelegateCdeclByRef_IntStructPack8Explicit caller_IntStructPack8Explicit =
                    Get_MarshalStructAsParam_AsExpByRefIntStructPack8Explicit_Cdecl_FuncPtr();
                Console.WriteLine(
                    "Calling Get_MarshalStructAsParam_AsExpByRefIntStructPack8Explicit_Cdecl_FuncPtr..."
                );
            ...
            case StructID.LongStructPack16ExplicitId:
                ...
                DelegateCdeclByRef_LongStructPack16Explicit caller_LongStructPack16Explicit =
                    Get_MarshalStructAsParam_AsExpByRefLongStructPack16Explicit_Cdecl_FuncPtr();
                Console.WriteLine(
                    "Calling Get_MarshalStructAsParam_AsExpByRefLongStructPack16Explicit_Cdecl_FuncPtr..."
                );
    ...
    [UnmanagedFunctionPointer(CallingConvention.StdCall)]
    public delegate bool DelegateStdcallByRef_InnerArrayExplicit(
        [In, Out] ref InnerArrayExplicit iae
    );
    ...
    [UnmanagedFunctionPointer(CallingConvention.StdCall)]
    public delegate bool DelegateStdcallByRef_ByteStructPack2Explicit(
        [In, Out] ref ByteStructPack2Explicit bspe
    );
    ...
    [UnmanagedFunctionPointer(CallingConvention.StdCall)]
    public delegate bool DelegateStdcallByRef_ShortStructPack4Explicit(
        [In, Out] ref ShortStructPack4Explicit bspe
    );
    ...
    [UnmanagedFunctionPointer(CallingConvention.StdCall)]
    public delegate bool DelegateStdcallByRef_IntStructPack8Explicit(
        [In, Out] ref IntStructPack8Explicit bspe
    );
    ...
    [UnmanagedFunctionPointer(CallingConvention.StdCall)]
    public delegate bool DelegateStdcallByRef_LongStructPack16Explicit(
        [In, Out] ref LongStructPack16Explicit bspe
    );
    ...
    private static void TestMethod_DelegatePInvoke_MarshalByRef_Stdcall(StructID structid)
    {
        ...
        switch (structid)
        {
            case StructID.INNER2Id:
                INNER2 sourceINNER2 = Helper.NewINNER2(1, 1.0F, "some string");
                INNER2 changeINNER2 = Helper.NewINNER2(77, 77.0F, "changed string");
                DelegateStdcallByRef_INNER2 caller_INNER2 =
                    Get_MarshalStructAsParam_AsExpByRefINNER2_Stdcall_FuncPtr();
                Console.WriteLine(
                    "Calling Get_MarshalStructAsParam_AsExpByRefINNER2_Stdcall_FuncPtr..."
                );
                Assert.True(caller_INNER2(ref sourceINNER2));
                Assert.True(
                    Helper.ValidateINNER2(
            ...
            case StructID.InnerExplicitId:
                ...
                changeInnerExplicit.f1 = 77;
                changeInnerExplicit.f3 = "changed string";
                DelegateStdcallByRef_InnerExplicit caller_InnerExplicit =
                    Get_MarshalStructAsParam_AsExpByRefInnerExplicit_Stdcall_FuncPtr();
                Console.WriteLine(
                    "Calling Get_MarshalStructAsParam_AsExpByRefInnerExplicit_Stdcall_FuncPtr..."
                );
                Assert.True(caller_InnerExplicit(ref sourceInnerExplicit));
                Assert.True(
                    Helper.ValidateInnerExplicit(
            ...
            case StructID.InnerArrayExplicitId:
                ...
                Console.WriteLine(
                    "Calling Get_MarshalStructAsParam_AsExpByRefInnerArrayExplicit_Stdcall_FuncPtr..."
                );
                Assert.True(caller_InnerArrayExplicit(ref sourceInnerArrayExplicit));
                Assert.True(
                    Helper.ValidateInnerArrayExplicit(
            ...
            case StructID.OUTER3Id:
                ...
                DelegateStdcallByRef_OUTER3 caller_OUTER3 =
                    Get_MarshalStructAsParam_AsExpByRefOUTER3_Stdcall_FuncPtr();
                Console.WriteLine(
                    "Calling Get_MarshalStructAsParam_AsExpByRefOUTER3_Stdcall_FuncPtr..."
                );
                Assert.True(caller_OUTER3(ref sourceOUTER3));
                Assert.True(
                    Helper.ValidateOUTER3(
            ...
            case StructID.UId:
                ...
                DelegateStdcallByRef_U caller_U =
                    Get_MarshalStructAsParam_AsExpByRefU_Stdcall_FuncPtr();
                Console.WriteLine(
                    "Calling Get_MarshalStructAsParam_AsExpByRefU_Stdcall_FuncPtr..."
                );
                Assert.True(caller_U(ref sourceU));
                Assert.True(
                    Helper.ValidateU(
            ...
            case StructID.ByteStructPack2ExplicitId:
                ByteStructPack2Explicit source_bspe = Helper.NewByteStructPack2Explicit(32, 32);
                ByteStructPack2Explicit change_bspe = Helper.NewByteStructPack2Explicit(64, 64);
                DelegateStdcallByRef_ByteStructPack2Explicit caller_ByteStructPack2Explicit =
                    Get_MarshalStructAsParam_AsExpByRefByteStructPack2Explicit_Stdcall_FuncPtr();
                Console.WriteLine(
                    "Calling Get_MarshalStructAsParam_AsExpByRefByteStructPack2Explicit_Stdcall_FuncPtr..."
                );
                Assert.True(caller_ByteStructPack2Explicit(ref source_bspe));
                Assert.True(
                    Helper.ValidateByteStructPack2Explicit(
            ...
            case StructID.ShortStructPack4ExplicitId:
                ShortStructPack4Explicit source_sspe = Helper.NewShortStructPack4Explicit(32, 32);
                ShortStructPack4Explicit change_sspe = Helper.NewShortStructPack4Explicit(64, 64);
                DelegateStdcallByRef_ShortStructPack4Explicit caller_ShortStructPack4Explicit =
                    Get_MarshalStructAsParam_AsExpByRefShortStructPack4Explicit_Stdcall_FuncPtr();
                Console.WriteLine(
                    "Calling Get_MarshalStructAsParam_AsExpByRefShortStructPack4Explicit_Stdcall_FuncPtr..."
                );
                Assert.True(caller_ShortStructPack4Explicit(ref source_sspe));
                Assert.True(
                    Helper.ValidateShortStructPack4Explicit(
            ...
            case StructID.IntStructPack8ExplicitId:
                IntStructPack8Explicit source_ispe = Helper.NewIntStructPack8Explicit(32, 32);
                IntStructPack8Explicit change_ispe = Helper.NewIntStructPack8Explicit(64, 64);
                DelegateStdcallByRef_IntStructPack8Explicit caller_IntStructPack8Explicit =
                    Get_MarshalStructAsParam_AsExpByRefIntStructPack8Explicit_Stdcall_FuncPtr();
                Console.WriteLine(
                    "Calling Get_MarshalStructAsParam_AsExpByRefIntStructPack8Explicit_Stdcall_FuncPtr..."
                );
                Assert.True(caller_IntStructPack8Explicit(ref source_ispe));
                Assert.True(
                    Helper.ValidateIntStructPack8Explicit(
            ...
            case StructID.LongStructPack16ExplicitId:
                LongStructPack16Explicit source_lspe = Helper.NewLongStructPack16Explicit(32, 32);
                LongStructPack16Explicit change_lspe = Helper.NewLongStructPack16Explicit(64, 64);
                DelegateStdcallByRef_LongStructPack16Explicit caller_LongStructPack16Explicit =
                    Get_MarshalStructAsParam_AsExpByRefLongStructPack16Explicit_Stdcall_FuncPtr();
                Console.WriteLine(
                    "Calling Get_MarshalStructAsParam_AsExpByRefLongStructPack16Explicit_Stdcall_FuncPtr..."
                );
                Assert.True(caller_LongStructPack16Explicit(ref source_lspe));
                Assert.True(
                    Helper.ValidateLongStructPack16Explicit(
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate bool DelegateCdeclByVal_ByteStructPack2Explicit(
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate bool DelegateCdeclByVal_ShortStructPack4Explicit(
        [In, Out] ShortStructPack4Explicit bspe
    );
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate bool DelegateCdeclByVal_IntStructPack8Explicit(
        [In, Out] IntStructPack8Explicit bspe
    );
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate bool DelegateCdeclByVal_LongStructPack16Explicit(
        [In, Out] LongStructPack16Explicit bspe
    );
    ...
    private static void TestMethod_DelegatePInvoke_MarshalByVal_Cdecl(StructID structid)
    {
        ...
        switch (structid)
        {
            case StructID.INNER2Id:
                ...
                DelegateCdeclByVal_INNER2 caller_INNER2 =
                    Get_MarshalStructAsParam_AsExpByValINNER2_Cdecl_FuncPtr();
                Console.WriteLine(
                    "Calling Get_MarshalStructAsParam_AsExpByValINNER2_Cdecl_FuncPtr..."
                );
            ...
            case StructID.InnerExplicitId:
                ...
                DelegateCdeclByVal_InnerExplicit caller_InnerExplicit =
                    Get_MarshalStructAsParam_AsExpByValInnerExplicit_Cdecl_FuncPtr();
                Console.WriteLine(
                    "Calling Get_MarshalStructAsParam_AsExpByValInnerExplicit_Cdecl_FuncPtr..."
                );
            ...
            case StructID.InnerArrayExplicitId:
                ...
                DelegateCdeclByVal_InnerArrayExplicit caller_InnerArrayExplicit =
                    Get_MarshalStructAsParam_AsExpByValInnerArrayExplicit_Cdecl_FuncPtr();
                Console.WriteLine(
                    "Calling Get_MarshalStructAsParam_AsExpByValInnerArrayExplicit_Cdecl_FuncPtr..."
                );
            ...
            case StructID.OUTER3Id:
                ...
                DelegateCdeclByVal_OUTER3 caller_OUTER3 =
                    Get_MarshalStructAsParam_AsExpByValOUTER3_Cdecl_FuncPtr();
                Console.WriteLine(
                    "Calling Get_MarshalStructAsParam_AsExpByValOUTER3_Cdecl_FuncPtr..."
                );
            ...
            case StructID.ByteStructPack2ExplicitId:
                ...
                DelegateCdeclByVal_ByteStructPack2Explicit caller_ByteStructPack2Explicit =
                    Get_MarshalStructAsParam_AsExpByValByteStructPack2Explicit_Cdecl_FuncPtr();
                Console.WriteLine(
                    "Calling Get_MarshalStructAsParam_AsExpByValByteStructPack2Explicit_Cdecl_FuncPtr..."
                );
            ...
            case StructID.ShortStructPack4ExplicitId:
                ...
                DelegateCdeclByVal_ShortStructPack4Explicit caller_ShortStructPack4Explicit =
                    Get_MarshalStructAsParam_AsExpByValShortStructPack4Explicit_Cdecl_FuncPtr();
                Console.WriteLine(
                    "Calling Get_MarshalStructAsParam_AsExpByValShortStructPack4Explicit_Cdecl_FuncPtr..."
                );
            ...
            case StructID.IntStructPack8ExplicitId:
                ...
                DelegateCdeclByVal_IntStructPack8Explicit caller_IntStructPack8Explicit =
                    Get_MarshalStructAsParam_AsExpByValIntStructPack8Explicit_Cdecl_FuncPtr();
                Console.WriteLine(
                    "Calling Get_MarshalStructAsParam_AsExpByValIntStructPack8Explicit_Cdecl_FuncPtr..."
                );
            ...
            case StructID.LongStructPack16ExplicitId:
                ...
                DelegateCdeclByVal_LongStructPack16Explicit caller_LongStructPack16Explicit =
                    Get_MarshalStructAsParam_AsExpByValLongStructPack16Explicit_Cdecl_FuncPtr();
                Console.WriteLine(
                    "Calling Get_MarshalStructAsParam_AsExpByValLongStructPack16Explicit_Cdecl_FuncPtr..."
                );
    ...
    [UnmanagedFunctionPointer(CallingConvention.StdCall)]
    public delegate bool DelegateStdcallByVal_ByteStructPack2Explicit(
        [In, Out] ByteStructPack2Explicit bspe
    );
    ...
    [UnmanagedFunctionPointer(CallingConvention.StdCall)]
    public delegate bool DelegateStdcallByVal_ShortStructPack4Explicit(
        [In, Out] ShortStructPack4Explicit bspe
    );
    ...
    [UnmanagedFunctionPointer(CallingConvention.StdCall)]
    public delegate bool DelegateStdcallByVal_IntStructPack8Explicit(
        [In, Out] IntStructPack8Explicit bspe
    );
    ...
    [UnmanagedFunctionPointer(CallingConvention.StdCall)]
    public delegate bool DelegateStdcallByVal_LongStructPack16Explicit(
        [In, Out] LongStructPack16Explicit bspe
    );
    ...
    private static void TestMethod_DelegatePInvoke_MarshalByVal_Stdcall(StructID structid)
    {
        ...
        switch (structid)
        {
            case StructID.INNER2Id:
                INNER2 sourceINNER2 = Helper.NewINNER2(1, 1.0F, "some string");
                INNER2 cloneINNER2 = Helper.NewINNER2(1, 1.0F, "some string");
                DelegateStdcallByVal_INNER2 caller_INNER2 =
                    Get_MarshalStructAsParam_AsExpByValINNER2_Stdcall_FuncPtr();
                Console.WriteLine(
                    "Calling Get_MarshalStructAsParam_AsExpByValINNER2_Stdcall_FuncPtr..."
                );
                Assert.True(caller_INNER2(sourceINNER2));
                Assert.True(
                    Helper.ValidateINNER2(
            ...
            case StructID.InnerExplicitId:
                ...
                cloneInnerExplicit.f1 = 1;
                cloneInnerExplicit.f3 = "some string";
                DelegateStdcallByVal_InnerExplicit caller_InnerExplicit =
                    Get_MarshalStructAsParam_AsExpByValInnerExplicit_Stdcall_FuncPtr();
                Console.WriteLine(
                    "Calling Get_MarshalStructAsParam_AsExpByValInnerExplicit_Stdcall_FuncPtr..."
                );
                Assert.True(caller_InnerExplicit(sourceInnerExplicit));
                Assert.True(
                    Helper.ValidateInnerExplicit(
            ...
            case StructID.InnerArrayExplicitId:
                ...
                DelegateStdcallByVal_InnerArrayExplicit caller_InnerArrayExplicit =
                    Get_MarshalStructAsParam_AsExpByValInnerArrayExplicit_Stdcall_FuncPtr();
                Console.WriteLine(
                    "Calling Get_MarshalStructAsParam_AsExpByValInnerArrayExplicit_Stdcall_FuncPtr..."
                );
                Assert.True(caller_InnerArrayExplicit(sourceInnerArrayExplicit));
                Assert.True(
                    Helper.ValidateInnerArrayExplicit(
            ...
            case StructID.OUTER3Id:
                OUTER3 sourceOUTER3 = Helper.NewOUTER3(1, 1.0F, "some string", "some string");
                OUTER3 cloneOUTER3 = Helper.NewOUTER3(1, 1.0F, "some string", "some string");
                DelegateStdcallByVal_OUTER3 caller_OUTER3 =
                    Get_MarshalStructAsParam_AsExpByValOUTER3_Stdcall_FuncPtr();
                Console.WriteLine(
                    "Calling Get_MarshalStructAsParam_AsExpByValOUTER3_Stdcall_FuncPtr..."
                );
                Assert.True(caller_OUTER3(sourceOUTER3));
                Assert.True(
                    Helper.ValidateOUTER3(
            ...
            case StructID.UId:
                ...
                DelegateStdcallByVal_U caller_U =
                    Get_MarshalStructAsParam_AsExpByValU_Stdcall_FuncPtr();
                Console.WriteLine(
                    "Calling Get_MarshalStructAsParam_AsExpByValU_Stdcall_FuncPtr..."
                );
                Assert.True(caller_U(sourceU));
                Assert.True(
                    Helper.ValidateU(
            ...
            case StructID.ByteStructPack2ExplicitId:
                ByteStructPack2Explicit source_bspe = Helper.NewByteStructPack2Explicit(32, 32);
                ByteStructPack2Explicit clone_bspe = Helper.NewByteStructPack2Explicit(32, 32);
                DelegateStdcallByVal_ByteStructPack2Explicit caller_ByteStructPack2Explicit =
                    Get_MarshalStructAsParam_AsExpByValByteStructPack2Explicit_Stdcall_FuncPtr();
                Console.WriteLine(
                    "Calling Get_MarshalStructAsParam_AsExpByValByteStructPack2Explicit_Stdcall_FuncPtr..."
                );
                Assert.True(caller_ByteStructPack2Explicit(source_bspe));
                Assert.True(
                    Helper.ValidateByteStructPack2Explicit(
            ...
            case StructID.ShortStructPack4ExplicitId:
                ShortStructPack4Explicit source_sspe = Helper.NewShortStructPack4Explicit(32, 32);
                ShortStructPack4Explicit clone_sspe = Helper.NewShortStructPack4Explicit(32, 32);
                DelegateStdcallByVal_ShortStructPack4Explicit caller_ShortStructPack4Explicit =
                    Get_MarshalStructAsParam_AsExpByValShortStructPack4Explicit_Stdcall_FuncPtr();
                Console.WriteLine(
                    "Calling Get_MarshalStructAsParam_AsExpByValShortStructPack4Explicit_Stdcall_FuncPtr..."
                );
                Assert.True(caller_ShortStructPack4Explicit(source_sspe));
                Assert.True(
                    Helper.ValidateShortStructPack4Explicit(
            ...
            case StructID.IntStructPack8ExplicitId:
                IntStructPack8Explicit source_ispe = Helper.NewIntStructPack8Explicit(32, 32);
                IntStructPack8Explicit clone_ispe = Helper.NewIntStructPack8Explicit(32, 32);
                DelegateStdcallByVal_IntStructPack8Explicit caller_IntStructPack8Explicit =
                    Get_MarshalStructAsParam_AsExpByValIntStructPack8Explicit_Stdcall_FuncPtr();
                Console.WriteLine(
                    "Calling Get_MarshalStructAsParam_AsExpByValIntStructPack8Explicit_Stdcall_FuncPtr..."
                );
                Assert.True(caller_IntStructPack8Explicit(source_ispe));
                Assert.True(
                    Helper.ValidateIntStructPack8Explicit(
            ...
            case StructID.LongStructPack16ExplicitId:
                LongStructPack16Explicit source_lspe = Helper.NewLongStructPack16Explicit(32, 32);
                LongStructPack16Explicit clone_lspe = Helper.NewLongStructPack16Explicit(32, 32);
                DelegateStdcallByVal_LongStructPack16Explicit caller_LongStructPack16Explicit =
                    Get_MarshalStructAsParam_AsExpByValLongStructPack16Explicit_Stdcall_FuncPtr();
                Console.WriteLine(
                    "Calling Get_MarshalStructAsParam_AsExpByValLongStructPack16Explicit_Stdcall_FuncPtr..."
                );
                Assert.True(caller_LongStructPack16Explicit(source_lspe));
                Assert.True(
                    Helper.ValidateLongStructPack16Explicit(
