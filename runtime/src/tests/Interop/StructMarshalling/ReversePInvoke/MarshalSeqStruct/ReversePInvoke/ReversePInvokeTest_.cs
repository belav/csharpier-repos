...
public class MarshalStructTest
{
    ...
    )
    {
        ...
        //Check the input
        Assert.True(
            Helper.ValidateIntergerStructSequential(
                argstr,
                changeIntergerStructSequential,
                "TestMethodForStructIntergerStructSequential_ReversePInvokeByVal_Cdecl"
            )
        );
        //Chanage the value
        argstr.i = 32;
    ...
    )
    {
        ...
        Assert.True(
            Helper.ValidateIntergerStructSequential(
                argstr,
                changeIntergerStructSequential,
                "TestMethodForStructIntergerStructSequential_ReversePInvokeByVal_StdCall"
            )
        );
        //Chanage the value
        argstr.i = 32;
    ...
    public static extern bool DoCallBack_MarshalStructIntergerStructSequentialByVal_StdCall(
        IntergerStructSequentialByValStdCallcaller caller
    );
    ...
    private static void TestMethod_DoCallBack_MarshalStructByRef_Cdecl(StructID structid)
    {
        switch (structid)
        {
            ...
            case StructID.IncludeOuterIntergerStructSequentialId:
                Console.WriteLine(
                    "Calling ReversePInvoke_MarshalStructIncludeOuterIntergerStructSequentialByRef_Cdecl..."
                );
                Assert.True(
    ...
    private static void TestMethod_DoCallBack_MarshalStructByRef_StdCall(StructID structid)
    {
        switch (structid)
        {
            ...
            case StructID.IncludeOuterIntergerStructSequentialId:
                Console.WriteLine(
                    "Calling ReversePInvoke_MarshalStructIncludeOuterIntergerStructSequentialByRef_StdCall..."
                );
                Assert.True(
    ...
    private static void TestMethod_DoCallBack_MarshalStructByVal_Cdecl(StructID structid)
    {
        switch (structid)
        {
            ...
            case StructID.IncludeOuterIntergerStructSequentialId:
                Console.WriteLine(
                    "Calling ReversePInvoke_MarshalStructIncludeOuterIntergerStructSequentialByVal_Cdecl..."
                );
                Assert.True(
    ...
    private static void TestMethod_DoCallBack_MarshalStructByVal_StdCall(StructID structid)
    {
        switch (structid)
        {
            ...
            case StructID.IncludeOuterIntergerStructSequentialId:
                Console.WriteLine(
                    "Calling ReversePInvoke_MarshalStructIncludeOuterIntergerStructSequentialByVal_StdCall..."
                );
                Assert.True(
