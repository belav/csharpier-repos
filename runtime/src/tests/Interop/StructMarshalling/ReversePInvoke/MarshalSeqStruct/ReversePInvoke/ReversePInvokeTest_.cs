...
public class MarshalStructTest
{
    ...
    private static bool TestMethodForStructS3_ReversePInvokeByRef_Cdecl(ref S3 argstr)
    {
        ...
        //Check the input
        Assert.True(
            Helper.ValidateS3(argstr, changeS3, "TestMethodForStructS3_ReversePInvokeByRef_Cdecl")
        );
        //Chanage the value
        argstr.flag = true;
    ...
    private static bool TestMethodForStructS3_ReversePInvokeByVal_Cdecl(S3 argstr)
    {
        ...
        //Check the input
        Assert.True(
            Helper.ValidateS3(argstr, changeS3, "TestMethodForStructS3_ReversePInvokeByVal_Cdecl")
        );
        //Chanage the value
        argstr.flag = true;
        argstr.str = "some string";
    ...
    private static bool TestMethodForStructS3_ReversePInvokeByVal_StdCall(S3 argstr)
    {
        ...
        //Check the input
        Assert.True(
            Helper.ValidateS3(argstr, changeS3, "TestMethodForStructS3_ReversePInvokeByVal_StdCall")
        );
        //Chanage the value
        argstr.flag = true;
        argstr.str = "some string";
    ...
    private static bool TestMethodForStructS5_ReversePInvokeByRef_Cdecl(ref S5 argstr)
    {
        ...
        //Check the input
        Assert.True(
            Helper.ValidateS5(argstr, changeS5, "TestMethodForStructS5_ReversePInvokeByRef_Cdecl")
        );
        //Chanage the value
        argstr.s4 = s4;
        argstr.ef = enums;
    ...
    private static bool TestMethodForStructS5_ReversePInvokeByRef_StdCall(ref S5 argstr)
    {
        ...
        //Check the input
        Assert.True(
            Helper.ValidateS5(argstr, changeS5, "TestMethodForStructS5_ReversePInvokeByRef_StdCall")
        );
        //Chanage the value
        argstr.s4 = s4;
        argstr.ef = enums;
    ...
    private static bool TestMethodForStructS5_ReversePInvokeByVal_Cdecl(S5 argstr)
    {
        ...
        //Check the input
        Assert.True(
            Helper.ValidateS5(argstr, changeS5, "TestMethodForStructS5_ReversePInvokeByVal_Cdecl")
        );
        //Chanage the value
        argstr.s4 = s4;
        argstr.ef = enums;
    ...
    private static bool TestMethodForStructS5_ReversePInvokeByVal_StdCall(S5 argstr)
    {
        ...
        //Check the input
        Assert.True(
            Helper.ValidateS5(argstr, changeS5, "TestMethodForStructS5_ReversePInvokeByVal_StdCall")
        );
        //Chanage the value
        argstr.s4 = s4;
        argstr.ef = enums;
    ...
    )
    {
        ...
        StringStructSequentialUnicode change_sssa = Helper.NewStringStructSequentialUnicode(
            strTwo,
            strOne
        );
        //Check the input
    ...
    private static bool TestMethodForStructS8_ReversePInvokeByRef_Cdecl(ref S8 argstr)
    {
        ...
        //Check the input
        Assert.True(
            Helper.ValidateS8(argstr, changeS8, "TestMethodForStructS8_ReversePInvokeByRef_Cdecl")
        );
        //Chanage the value
        argstr.name = "hello";
        argstr.gender = true;
    ...
    private static bool TestMethodForStructS8_ReversePInvokeByVal_Cdecl(S8 argstr)
    {
        ...
        //Check the input
        Assert.True(
            Helper.ValidateS8(argstr, changeS8, "TestMethodForStructS8_ReversePInvokeByVal_Cdecl")
        );
        //Chanage the value
        argstr.name = "hello";
        argstr.gender = true;
    ...
    private static bool TestMethodForStructS8_ReversePInvokeByVal_StdCall(S8 argstr)
    {
        ...
        //Check the input
        Assert.True(
            Helper.ValidateS8(argstr, changeS8, "TestMethodForStructS8_ReversePInvokeByVal_StdCall")
        );
        //Chanage the value
        argstr.name = "hello";
        argstr.gender = true;
    ...
    private static bool TestMethodForStructS9_ReversePInvokeByRef_Cdecl(ref S9 argstr)
    {
        ...
        //Check the input
        Assert.True(
            Helper.ValidateS9(argstr, changeS9, "TestMethodForStructS9_ReversePInvokeByRef_Cdecl")
        );
        //Chanage the value
        argstr.i32 = 128;
    ...
    private static bool TestMethodForStructS9_ReversePInvokeByRef_StdCall(ref S9 argstr)
    {
        ...
        //Check the input
        Assert.True(
            Helper.ValidateS9(argstr, changeS9, "TestMethodForStructS9_ReversePInvokeByRef_StdCall")
        );
        //Chanage the value
        argstr.i32 = 128;
        argstr.myDelegate1 = new TestDelegate1(testMethod);
    ...
    private static bool TestMethodForStructS9_ReversePInvokeByVal_Cdecl(S9 argstr)
    {
        ...
        //Check the input
        Assert.True(
            Helper.ValidateS9(argstr, changeS9, "TestMethodForStructS9_ReversePInvokeByVal_Cdecl")
        );
        //Chanage the value
        argstr.i32 = 128;
        argstr.myDelegate1 = new TestDelegate1(testMethod);
    ...
    private static bool TestMethodForStructS9_ReversePInvokeByVal_StdCall(S9 argstr)
    {
        ...
        //Check the input
        Assert.True(
            Helper.ValidateS9(argstr, changeS9, "TestMethodForStructS9_ReversePInvokeByVal_StdCall")
        );
        //Chanage the value
        argstr.i32 = 128;
        argstr.myDelegate1 = new TestDelegate1(testMethod);
    ...
    //For Reverse Pinvoke ByRef
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate bool IncludeOuterIntegerStructSequentialByRefCdeclcaller(
        [In, Out] ref IncludeOuterIntegerStructSequential argStr
    );

    private static bool TestMethodForStructIncludeOuterIntegerStructSequential_ReversePInvokeByRef_Cdecl(
        ref IncludeOuterIntegerStructSequential argstr
    )
    {
        Console.WriteLine("ReversePinvoke,By Ref,Cdecl");
    ...
    [UnmanagedFunctionPointer(CallingConvention.StdCall)]
    public delegate bool IncludeOuterIntegerStructSequentialByRefStdCallcaller(
        [In, Out] ref IncludeOuterIntegerStructSequential argStr
    );

    private static bool TestMethodForStructIncludeOuterIntegerStructSequential_ReversePInvokeByRef_StdCall(
        ref IncludeOuterIntegerStructSequential argstr
    )
    {
        Console.WriteLine("ReversePinvoke,By Ref,StdCall");
    ...
    //Reverse Pinvoke,cdecl
    [DllImport("SeqPInvokeNative", CallingConvention = CallingConvention.Cdecl)]
    public static extern bool DoCallBack_MarshalStructIncludeOuterIntegerStructSequentialByRef_Cdecl(
        IncludeOuterIntegerStructSequentialByRefCdeclcaller caller
    );

    //Reverse Pinvoke,stdcall
    [DllImport("SeqPInvokeNative", CallingConvention = CallingConvention.StdCall)]
    public static extern bool DoCallBack_MarshalStructIncludeOuterIntegerStructSequentialByRef_StdCall(
        IncludeOuterIntegerStructSequentialByRefStdCallcaller caller
    );
    ...
    //For Reverse Pinvoke ByVal
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate IncludeOuterIntegerStructSequential IncludeOuterIntegerStructSequentialByValCdeclcaller(
        [In, Out] IncludeOuterIntegerStructSequential argStr
    );

    private static IncludeOuterIntegerStructSequential TestMethodForStructIncludeOuterIntegerStructSequential_ReversePInvokeByVal_Cdecl(
    ...
    [UnmanagedFunctionPointer(CallingConvention.StdCall)]
    public delegate IncludeOuterIntegerStructSequential IncludeOuterIntegerStructSequentialByValStdCallcaller(
        [In, Out] IncludeOuterIntegerStructSequential argStr
    );

    private static IncludeOuterIntegerStructSequential TestMethodForStructIncludeOuterIntegerStructSequential_ReversePInvokeByVal_StdCall(
        IncludeOuterIntegerStructSequential argstr
    )
    {
        Console.WriteLine("ReversePinvoke,By Value,StdCall");
    ...
    //Reverse Pinvoke,cdecl
    [DllImport("SeqPInvokeNative", CallingConvention = CallingConvention.Cdecl)]
    public static extern bool DoCallBack_MarshalStructIncludeOuterIntegerStructSequentialByVal_Cdecl(
        IncludeOuterIntegerStructSequentialByValCdeclcaller caller
    );

    //Reverse Pinvoke,stdcall
    [DllImport("SeqPInvokeNative", CallingConvention = CallingConvention.StdCall)]
    public static extern bool DoCallBack_MarshalStructIncludeOuterIntegerStructSequentialByVal_StdCall(
        IncludeOuterIntegerStructSequentialByValStdCallcaller caller
    );
    ...
    private static unsafe bool TestMethodForStructS11_ReversePInvokeByRef_Cdecl(ref S11 argstr)
    {
        ...
        Assert.True(
            Helper.ValidateS11(
                argstr,
                changeS11,
                "TestMethodForStructS11_ReversePInvokeByRef_Cdecl"
            )
        );
        //Chanage the value
        argstr.i32 = (int*)(32);
    ...
    private static unsafe bool TestMethodForStructS11_ReversePInvokeByVal_Cdecl(S11 argstr)
    {
        ...
        Assert.True(
            Helper.ValidateS11(
                argstr,
                changeS11,
                "TestMethodForStructS11_ReversePInvokeByVal_Cdecl"
            )
        );
        //Chanage the value
        argstr.i32 = (int*)(32);
    ...
    #endregion
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate ByteStruct3Byte ByValCdeclcaller_ByteStruct3Byte(
        ByteStruct3Byte bspe,
        [MarshalAs(UnmanagedType.Bool)] out bool success
    );
    ...
    )
    {
        ...
        Assert.True(
            Helper.ValidateByteStruct3Byte(
                change_bspe,
                bspe,
    ...
    [UnmanagedFunctionPointer(CallingConvention.StdCall)]
    public delegate ByteStruct3Byte ByValStdCallcaller_ByteStruct3Byte(
        ByteStruct3Byte bspe,
        [MarshalAs(UnmanagedType.Bool)] out bool success
    );
    ...
    [DllImport("SeqPInvokeNative", CallingConvention = CallingConvention.StdCall)]
    public static extern bool DoCallBack_MarshalStructByVal_StdCall_ByteStruct3Byte(
        ByValStdCallcaller_ByteStruct3Byte caller
    );

    [DllImport("SeqPInvokeNative", CallingConvention = CallingConvention.Cdecl)]
    public static extern bool DoCallBack_MarshalStructByVal_Cdecl_ByteStruct3Byte(
        ByValCdeclcaller_ByteStruct3Byte caller
    );

    //For Reverse Pinvoke ByVal
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate IntegerStructSequential IntegerStructSequentialByValCdeclcaller(
        [In, Out] IntegerStructSequential argStr
    );

    private static IntegerStructSequential TestMethodForStructIntegerStructSequential_ReversePInvokeByVal_Cdecl(
        IntegerStructSequential argstr
    )
    {
        Console.WriteLine("ReversePinvoke,By Value,Cdecl");
        IntegerStructSequential changeIntegerStructSequential = Helper.NewIntegerStructSequential(
            64
        );
        //Check the input
        Assert.True(
            Helper.ValidateIntegerStructSequential(
                argstr,
                changeIntegerStructSequential,
                "TestMethodForStructIntegerStructSequential_ReversePInvokeByVal_Cdecl"
            )
        );
        //Chanage the value
        argstr.i = 32;
    ...
    [UnmanagedFunctionPointer(CallingConvention.StdCall)]
    public delegate IntegerStructSequential IntegerStructSequentialByValStdCallcaller(
        [In, Out] IntegerStructSequential argStr
    );

    private static IntegerStructSequential TestMethodForStructIntegerStructSequential_ReversePInvokeByVal_StdCall(
        IntegerStructSequential argstr
    )
    {
        Console.WriteLine("ReversePinvoke,By Value,StdCall");
    ...
    //Reverse Pinvoke,cdecl
    [DllImport("SeqPInvokeNative", CallingConvention = CallingConvention.Cdecl)]
    public static extern bool DoCallBack_MarshalStructIntegerStructSequentialByVal_Cdecl(
        IntegerStructSequentialByValCdeclcaller caller
    );

    //Reverse Pinvoke,stdcall
    [DllImport("SeqPInvokeNative", CallingConvention = CallingConvention.StdCall)]
    public static extern bool DoCallBack_MarshalStructIntegerStructSequentialByVal_StdCall(
        IntegerStructSequentialByValStdCallcaller caller
    );
    ...
    private static void TestMethod_DoCallBack_MarshalStructByRef_Cdecl(StructID structid)
    {
        switch (structid)
        {
            ...
            case StructID.InnerSequentialId:
                Console.WriteLine(
                    "Calling ReversePInvoke_MarshalStructInnerSequentialByRef_Cdecl..."
                );
                Assert.True(
            ...
            case StructID.InnerArraySequentialId:
                Console.WriteLine(
                    "Calling ReversePInvoke_MarshalStructInnerArraySequentialByRef_Cdecl..."
                );
                Assert.True(
            ...
            case StructID.CharSetAnsiSequentialId:
                Console.WriteLine(
                    "Calling ReversePInvoke_MarshalStructCharSetAnsiSequentialByRef_Cdecl..."
                );
                Assert.True(
            ...
            case StructID.CharSetUnicodeSequentialId:
                Console.WriteLine(
                    "Calling ReversePInvoke_MarshalStructCharSetUnicodeSequentialByRef_Cdecl..."
                );
                Assert.True(
            ...
            case StructID.NumberSequentialId:
                Console.WriteLine(
                    "Calling ReversePInvoke_MarshalStructNumberSequentialByRef_Cdecl..."
                );
                Assert.True(
            ...
            case StructID.S3Id:
                ...
                Assert.True(
                    DoCallBack_MarshalStructS3ByRef_Cdecl(
            ...
            case StructID.S5Id:
                ...
                Assert.True(
                    DoCallBack_MarshalStructS5ByRef_Cdecl(
                        new S5ByRefCdeclcaller(TestMethodForStructS5_ReversePInvokeByRef_Cdecl)
                    )
                );
                break;
            case StructID.StringStructSequentialAnsiId:
                Console.WriteLine(
                    "Calling ReversePInvoke_MarshalStructStringStructSequentialAnsiByRef_Cdecl..."
                );
                Assert.True(
            ...
            case StructID.StringStructSequentialUnicodeId:
                Console.WriteLine(
                    "Calling ReversePInvoke_MarshalStructStringStructSequentialUnicodeByRef_Cdecl..."
                );
                Assert.True(
            ...
            case StructID.S8Id:
                ...
                Assert.True(
                    DoCallBack_MarshalStructS8ByRef_Cdecl(
                        new S8ByRefCdeclcaller(TestMethodForStructS8_ReversePInvokeByRef_Cdecl)
                    )
                );
                break;
            case StructID.S9Id:
                ...
                Assert.True(
                    DoCallBack_MarshalStructS9ByRef_Cdecl(
                        new S9ByRefCdeclcaller(TestMethodForStructS9_ReversePInvokeByRef_Cdecl)
                    )
                );
                break;
            case StructID.IncludeOuterIntegerStructSequentialId:
                Console.WriteLine(
                    "Calling ReversePInvoke_MarshalStructIncludeOuterIntegerStructSequentialByRef_Cdecl..."
                );
                Assert.True(
                    DoCallBack_MarshalStructIncludeOuterIntegerStructSequentialByRef_Cdecl(
            ...
            case StructID.S11Id:
                ...
                Assert.True(
                    DoCallBack_MarshalStructS11ByRef_Cdecl(
                        new S11ByRefCdeclcaller(TestMethodForStructS11_ReversePInvokeByRef_Cdecl)
                    )
                );
                break;
            default:
                Assert.Fail(
                    "DoCallBack_MarshalStructByRef_Cdecl:The structid (Managed Side) is wrong"
                );
                break;
        }
    }
    ...
    private static void TestMethod_DoCallBack_MarshalStructByRef_StdCall(StructID structid)
    {
        switch (structid)
        {
            case StructID.ComplexStructId:
                Console.WriteLine(
                    "Calling ReversePInvoke_MarshalStructComplexStructByRef_StdCall..."
                );
                Assert.True(
            ...
            case StructID.InnerSequentialId:
                Console.WriteLine(
                    "Calling ReversePInvoke_MarshalStructInnerSequentialByRef_StdCall..."
                );
                Assert.True(
            ...
            case StructID.InnerArraySequentialId:
                Console.WriteLine(
                    "Calling ReversePInvoke_MarshalStructInnerArraySequentialByRef_StdCall..."
                );
                Assert.True(
            ...
            case StructID.CharSetAnsiSequentialId:
                Console.WriteLine(
                    "Calling ReversePInvoke_MarshalStructCharSetAnsiSequentialByRef_StdCall..."
                );
                Assert.True(
            ...
            case StructID.CharSetUnicodeSequentialId:
                Console.WriteLine(
                    "Calling ReversePInvoke_MarshalStructCharSetUnicodeSequentialByRef_StdCall..."
                );
                Assert.True(
            ...
            case StructID.NumberSequentialId:
                Console.WriteLine(
                    "Calling ReversePInvoke_MarshalStructNumberSequentialByRef_StdCall..."
                );
                Assert.True(
            ...
            case StructID.S3Id:
                ...
                Assert.True(
                    DoCallBack_MarshalStructS3ByRef_StdCall(
                        new S3ByRefStdCallcaller(TestMethodForStructS3_ReversePInvokeByRef_StdCall)
                    )
                );
                break;
            case StructID.S5Id:
                ...
                Assert.True(
                    DoCallBack_MarshalStructS5ByRef_StdCall(
            ...
            case StructID.StringStructSequentialAnsiId:
                Console.WriteLine(
                    "Calling ReversePInvoke_MarshalStructStringStructSequentialAnsiByRef_StdCall..."
                );
                Assert.True(
            ...
            case StructID.StringStructSequentialUnicodeId:
                Console.WriteLine(
                    "Calling ReversePInvoke_MarshalStructStringStructSequentialUnicodeByRef_StdCall..."
                );
                Assert.True(
            ...
            case StructID.S8Id:
                ...
                Assert.True(
                    DoCallBack_MarshalStructS8ByRef_StdCall(
                        new S8ByRefStdCallcaller(TestMethodForStructS8_ReversePInvokeByRef_StdCall)
                    )
                );
                break;
            case StructID.S9Id:
                ...
                Assert.True(
                    DoCallBack_MarshalStructS9ByRef_StdCall(
            ...
            case StructID.IncludeOuterIntegerStructSequentialId:
                Console.WriteLine(
                    "Calling ReversePInvoke_MarshalStructIncludeOuterIntegerStructSequentialByRef_StdCall..."
                );
                Assert.True(
                    DoCallBack_MarshalStructIncludeOuterIntegerStructSequentialByRef_StdCall(
                        new IncludeOuterIntegerStructSequentialByRefStdCallcaller(
                            TestMethodForStructIncludeOuterIntegerStructSequential_ReversePInvokeByRef_StdCall
                        )
                    )
                );
                break;
            ...
            default:
                Assert.Fail(
                    "DoCallBack_MarshalStructByRef_StdCall:The structid (Managed Side) is wrong"
                );
                break;
        }
    }
    ...
    private static void TestMethod_DoCallBack_MarshalStructByVal_Cdecl(StructID structid)
    {
        switch (structid)
        {
            case StructID.ComplexStructId:
                Console.WriteLine(
                    "Calling ReversePInvoke_MarshalStructComplexeStructByVal_Cdecl..."
                );
                Assert.True(
            ...
            case StructID.InnerSequentialId:
                Console.WriteLine(
                    "Calling ReversePInvoke_MarshalStructInnerSequentialByVal_Cdecl..."
                );
                Assert.True(
            ...
            case StructID.InnerArraySequentialId:
                Console.WriteLine(
                    "Calling ReversePInvoke_MarshalStructInnerArraySequentialByVal_Cdecl..."
                );
                Assert.True(
            ...
            case StructID.CharSetAnsiSequentialId:
                Console.WriteLine(
                    "Calling ReversePInvoke_MarshalStructCharSetAnsiSequentialByVal_Cdecl..."
                );
                Assert.True(
            ...
            case StructID.CharSetUnicodeSequentialId:
                Console.WriteLine(
                    "Calling ReversePInvoke_MarshalStructCharSetUnicodeSequentialByVal_Cdecl..."
                );
                Assert.True(
            ...
            case StructID.NumberSequentialId:
                Console.WriteLine(
                    "Calling ReversePInvoke_MarshalStructNumberSequentialByVal_Cdecl..."
                );
                Assert.True(
            ...
            case StructID.S3Id:
                ...
                Assert.True(
                    DoCallBack_MarshalStructS3ByVal_Cdecl(
                        new S3ByValCdeclcaller(TestMethodForStructS3_ReversePInvokeByVal_Cdecl)
                    )
                );
                break;
            case StructID.S5Id:
                ...
                Assert.True(
                    DoCallBack_MarshalStructS5ByVal_Cdecl(
                        new S5ByValCdeclcaller(TestMethodForStructS5_ReversePInvokeByVal_Cdecl)
                    )
                );
                break;
            case StructID.StringStructSequentialAnsiId:
                Console.WriteLine(
                    "Calling ReversePInvoke_MarshalStructStringStructSequentialAnsiByVal_Cdecl..."
                );
                Assert.True(
            ...
            case StructID.StringStructSequentialUnicodeId:
                Console.WriteLine(
                    "Calling ReversePInvoke_MarshalStructStringStructSequentialUnicodeByVal_Cdecl..."
                );
                Assert.True(
            ...
            case StructID.S8Id:
                ...
                Assert.True(
                    DoCallBack_MarshalStructS8ByVal_Cdecl(
                        new S8ByValCdeclcaller(TestMethodForStructS8_ReversePInvokeByVal_Cdecl)
                    )
                );
                break;
            case StructID.S9Id:
                ...
                Assert.True(
                    DoCallBack_MarshalStructS9ByVal_Cdecl(
                        new S9ByValCdeclcaller(TestMethodForStructS9_ReversePInvokeByVal_Cdecl)
                    )
                );
                break;
            case StructID.IncludeOuterIntegerStructSequentialId:
                Console.WriteLine(
                    "Calling ReversePInvoke_MarshalStructIncludeOuterIntegerStructSequentialByVal_Cdecl..."
                );
                Assert.True(
                    DoCallBack_MarshalStructIncludeOuterIntegerStructSequentialByVal_Cdecl(
                        new IncludeOuterIntegerStructSequentialByValCdeclcaller(
                            TestMethodForStructIncludeOuterIntegerStructSequential_ReversePInvokeByVal_Cdecl
                        )
                    )
                );
            ...
            case StructID.S11Id:
                ...
                Assert.True(
                    DoCallBack_MarshalStructS11ByVal_Cdecl(
                        new S11ByValCdeclcaller(TestMethodForStructS11_ReversePInvokeByVal_Cdecl)
                    )
                );
                break;
            ...
            default:
                Assert.Fail(
                    "DoCallBack_MarshalStructByVal_Cdecl:The structid (Managed Side) is wrong"
                );
                break;
        }
    }
    ...
    private static void TestMethod_DoCallBack_MarshalStructByVal_StdCall(StructID structid)
    {
        switch (structid)
        {
            case StructID.ComplexStructId:
                Console.WriteLine(
                    "Calling ReversePInvoke_MarshalStructComplexStructByVal_StdCall..."
                );
                Assert.True(
            ...
            case StructID.InnerSequentialId:
                Console.WriteLine(
                    "Calling ReversePInvoke_MarshalStructInnerSequentialByVal_StdCall..."
                );
                Assert.True(
            ...
            case StructID.InnerArraySequentialId:
                Console.WriteLine(
                    "Calling ReversePInvoke_MarshalStructInnerArraySequentialByVal_StdCall..."
                );
                Assert.True(
            ...
            case StructID.CharSetAnsiSequentialId:
                Console.WriteLine(
                    "Calling ReversePInvoke_MarshalStructCharSetAnsiSequentialByVal_StdCall..."
                );
                Assert.True(
            ...
            case StructID.CharSetUnicodeSequentialId:
                Console.WriteLine(
                    "Calling ReversePInvoke_MarshalStructCharSetUnicodeSequentialByVal_StdCall..."
                );
                Assert.True(
            ...
            case StructID.NumberSequentialId:
                Console.WriteLine(
                    "Calling ReversePInvoke_MarshalStructNumberSequentialByVal_StdCall..."
                );
                Assert.True(
            ...
            case StructID.S3Id:
                ...
                Assert.True(
                    DoCallBack_MarshalStructS3ByVal_StdCall(
                        new S3ByValStdCallcaller(TestMethodForStructS3_ReversePInvokeByVal_StdCall)
                    )
                );
                break;
            case StructID.S5Id:
                ...
                Assert.True(
                    DoCallBack_MarshalStructS5ByVal_StdCall(
                        new S5ByValStdCallcaller(TestMethodForStructS5_ReversePInvokeByVal_StdCall)
                    )
                );
                break;
            case StructID.StringStructSequentialAnsiId:
                Console.WriteLine(
                    "Calling ReversePInvoke_MarshalStructStringStructSequentialAnsiByVal_StdCall..."
                );
                Assert.True(
            ...
            case StructID.StringStructSequentialUnicodeId:
                Console.WriteLine(
                    "Calling ReversePInvoke_MarshalStructStringStructSequentialUnicodeByVal_StdCall..."
                );
                Assert.True(
            ...
            case StructID.S8Id:
                ...
                Assert.True(
                    DoCallBack_MarshalStructS8ByVal_StdCall(
                        new S8ByValStdCallcaller(TestMethodForStructS8_ReversePInvokeByVal_StdCall)
                    )
                );
                break;
            case StructID.S9Id:
                ...
                Assert.True(
                    DoCallBack_MarshalStructS9ByVal_StdCall(
                        new S9ByValStdCallcaller(TestMethodForStructS9_ReversePInvokeByVal_StdCall)
                    )
                );
                break;
            case StructID.IncludeOuterIntegerStructSequentialId:
                Console.WriteLine(
                    "Calling ReversePInvoke_MarshalStructIncludeOuterIntegerStructSequentialByVal_StdCall..."
                );
                Assert.True(
                    DoCallBack_MarshalStructIncludeOuterIntegerStructSequentialByVal_StdCall(
                        new IncludeOuterIntegerStructSequentialByValStdCallcaller(
                            TestMethodForStructIncludeOuterIntegerStructSequential_ReversePInvokeByVal_StdCall
                        )
                    )
                );
            ...
            case StructID.ByteStruct3Byte:
                Console.WriteLine(
                    "Calling DoCallBack_MarshalStructByVal_StdCall_ByteStruct3Byte..."
                );
                Assert.True(
            ...
            default:
                Assert.Fail(
                    "DoCallBack_MarshalStructByVal_StdCall:The structid (Managed Side) is wrong"
                );
                break;
        }
    }
    ...
    private static void Run_TestMethod_DoCallBack_MarshalStructByVal_Cdecl()
    {
        ...
        TestMethod_DoCallBack_MarshalStructByVal_Cdecl(
            StructID.IncludeOuterIntegerStructSequentialId
        );
    ...
    private static void Run_TestMethod_DoCallBack_MarshalStructByVal_StdCall()
    {
        ...
        TestMethod_DoCallBack_MarshalStructByVal_StdCall(
            StructID.IncludeOuterIntegerStructSequentialId
        );
