    ...
    unsafe private static void TestMethod_DelegatePInvoke_MarshalByRef_Cdecl(StructID structid)
    {
        ...
        switch (structid)
        {
            ...
            case StructID.IncludeOuterIntergerStructSequentialId:
                IncludeOuterIntergerStructSequential sourceIncludeOuterIntergerStructSequential =
                    Helper.NewIncludeOuterIntergerStructSequential(32, 32);
                ...
                Console.WriteLine(
                    "Calling DelegatePInvoke_MarshalStructIncludeOuterIntergerStructSequentialByRef_Cdecl..."
                );
                IncludeOuterIntergerStructSequentialByRefDelegateCdecl caller13 =
                    Get_MarshalStructIncludeOuterIntergerStructSequentialByRef_Cdecl_FuncPtr();
                Assert.True(caller13(ref sourceIncludeOuterIntergerStructSequential));
                Assert.True(
                    Helper.ValidateIncludeOuterIntergerStructSequential(
                        sourceIncludeOuterIntergerStructSequential,
                        changeIncludeOuterIntergerStructSequential,
                        "DelegatePInvoke_MarshalStructIncludeOuterIntergerStructSequentialByRef_Cdecl"
                    )
                );
                break;
            case StructID.S11Id:
        ...
        switch (structid)
        {
            ...
            case StructID.IncludeOuterIntergerStructSequentialId:
                ...
                IncludeOuterIntergerStructSequential changeIncludeOuterIntergerStructSequential =
                    Helper.NewIncludeOuterIntergerStructSequential(64, 64);
                Console.WriteLine(
                    "Calling DelegatePInvoke_MarshalStructIncludeOuterIntergerStructSequentialByRef_StdCall..."
                );
                IncludeOuterIntergerStructSequentialByRefDelegateStdCall caller13 =
                    Get_MarshalStructIncludeOuterIntergerStructSequentialByRef_StdCall_FuncPtr();
                Assert.True(caller13(ref sourceIncludeOuterIntergerStructSequential));
                Assert.True(
                    Helper.ValidateIncludeOuterIntergerStructSequential(
                        sourceIncludeOuterIntergerStructSequential,
                        changeIncludeOuterIntergerStructSequential,
                        "DelegatePInvoke_MarshalStructIncludeOuterIntergerStructSequentialByRef_StdCall"
                    )
                );
                break;
            case StructID.S11Id:
    ...
    unsafe private static void TestMethod_DelegatePInvoke_MarshalByVal_Cdecl(StructID structid)
    {
        ...
        switch (structid)
        {
            ...
            case StructID.IncludeOuterIntergerStructSequentialId:
                IncludeOuterIntergerStructSequential sourceIncludeOuterIntergerStructSequential =
                    Helper.NewIncludeOuterIntergerStructSequential(32, 32);
                IncludeOuterIntergerStructSequential cloneIncludeOuterIntergerStructSequential =
                    Helper.NewIncludeOuterIntergerStructSequential(32, 32);
                Console.WriteLine(
                    "Calling DelegatePInvoke_MarshalStructIncludeOuterIntergerStructSequentialByVal_Cdecl..."
                );
                IncludeOuterIntergerStructSequentialByValDelegateCdecl caller13 =
                    Get_MarshalStructIncludeOuterIntergerStructSequentialByVal_Cdecl_FuncPtr();
                Assert.True(caller13(sourceIncludeOuterIntergerStructSequential));
                Assert.True(
                    Helper.ValidateIncludeOuterIntergerStructSequential(
                        sourceIncludeOuterIntergerStructSequential,
                        cloneIncludeOuterIntergerStructSequential,
                        "DelegatePInvoke_MarshalStructIncludeOuterIntergerStructSequentialByVal_Cdecl"
                    )
                );
                break;
            case StructID.S11Id:
        ...
        switch (structid)
        {
            ...
            case StructID.IncludeOuterIntergerStructSequentialId:
                ...
                IncludeOuterIntergerStructSequential cloneIncludeOuterIntergerStructSequential =
                    Helper.NewIncludeOuterIntergerStructSequential(32, 32);
                Console.WriteLine(
                    "Calling DelegatePInvoke_MarshalStructIncludeOuterIntergerStructSequentialByVal_StdCall..."
                );
                IncludeOuterIntergerStructSequentialByValDelegateStdCall caller13 =
                    Get_MarshalStructIncludeOuterIntergerStructSequentialByVal_StdCall_FuncPtr();
                Assert.True(caller13(sourceIncludeOuterIntergerStructSequential));
                Assert.True(
                    Helper.ValidateIncludeOuterIntergerStructSequential(
                        sourceIncludeOuterIntergerStructSequential,
                        cloneIncludeOuterIntergerStructSequential,
                        "DelegatePInvoke_MarshalStructIncludeOuterIntergerStructSequentialByVal_StdCall"
                    )
                );
                break;
            case StructID.S11Id:
