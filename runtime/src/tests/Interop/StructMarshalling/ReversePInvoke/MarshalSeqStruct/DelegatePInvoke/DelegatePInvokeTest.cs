...
public class MarshalStructTest
{
    ...
    //For Delegate Pinvoke ByRef
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate bool IncludeOuterIntegerStructSequentialByRefDelegateCdecl(
        [In, Out] ref IncludeOuterIntegerStructSequential argStr
    );

    [UnmanagedFunctionPointer(CallingConvention.StdCall)]
    public delegate bool IncludeOuterIntegerStructSequentialByRefDelegateStdCall(
        [In, Out] ref IncludeOuterIntegerStructSequential argStr
    );

    //Pinvoke,cdecl
    [DllImport("SeqPInvokeNative", CallingConvention = CallingConvention.Cdecl)]
    public static extern bool MarshalStructIncludeOuterIntegerStructSequentialByRef_Cdecl(
        [In, Out] ref IncludeOuterIntegerStructSequential argStr
    );
    ...
    //Pinvoke,stdcall
    [DllImport("SeqPInvokeNative", CallingConvention = CallingConvention.StdCall)]
    public static extern bool MarshalStructIncludeOuterIntegerStructSequentialByRef_StdCall(
        [In, Out] ref IncludeOuterIntegerStructSequential argStr
    );
    ...
    //For Delegate Pinvoke ByVal
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate bool IncludeOuterIntegerStructSequentialByValDelegateCdecl(
        [In, Out] IncludeOuterIntegerStructSequential argStr
    );

    [UnmanagedFunctionPointer(CallingConvention.StdCall)]
    public delegate bool IncludeOuterIntegerStructSequentialByValDelegateStdCall(
        [In, Out] IncludeOuterIntegerStructSequential argStr
    );

    //Pinvoke,cdecl
    [DllImport("SeqPInvokeNative", CallingConvention = CallingConvention.Cdecl)]
    public static extern bool MarshalStructIncludeOuterIntegerStructSequentialByVal_Cdecl(
        [In, Out] IncludeOuterIntegerStructSequential argStr
    );
    ...
    //Pinvoke,stdcall
    [DllImport("SeqPInvokeNative", CallingConvention = CallingConvention.StdCall)]
    public static extern bool MarshalStructIncludeOuterIntegerStructSequentialByVal_StdCall(
        [In, Out] IncludeOuterIntegerStructSequential argStr
    );
    ...
    unsafe private static void TestMethod_DelegatePInvoke_MarshalByRef_Cdecl(StructID structid)
    {
        ...
        switch (structid)
        {
            case StructID.ComplexStructId:
                Console.WriteLine(
                    "Calling DelegatePInvoke_MarshalStructComplexStructByRef_Cdecl..."
                );
                ...
                ComplexStructByRefDelegateCdecl caller1 =
                    Get_MarshalStructComplexStructByRef_Cdecl_FuncPtr();
            ...
            case StructID.InnerSequentialId:
                ...
                Console.WriteLine(
                    "Calling DelegatePInvoke_MarshalStructInnerSequentialByRef_Cdecl..."
                );
                InnerSequentialByRefDelegateCdecl caller2 =
                    Get_MarshalStructInnerSequentialByRef_Cdecl_FuncPtr();
                Assert.True(caller2(ref source_is));
                Assert.True(
                    Helper.ValidateInnerSequential(
                        source_is,
                        change_is,
                        "DelegatePInvoke_MarshalStructInnerSequentialByRef_Cdecl"
                    )
                );
                break;
            case StructID.InnerArraySequentialId:
                ...
                Console.WriteLine(
                    "Calling DelegatePInvoke_MarshalStructInnerArraySequentialByRef_Cdecl..."
                );
                InnerArraySequentialByRefDelegateCdecl caller3 =
                ...
                Assert.True(
                    Helper.ValidateInnerArraySequential(
                        source_ias,
                        change_ias,
                        "DelegatePInvoke_MarshalStructInnerArraySequentialByRef_Cdecl"
                    )
                );
                break;
            case StructID.CharSetAnsiSequentialId:
                ...
                CharSetAnsiSequential change_csas = Helper.NewCharSetAnsiSequential(
                    "change string",
                    'n'
                );
                Console.WriteLine(
                    "Calling DelegatePInvoke_MarshalStructCharSetAnsiSequentialByRef_Cdecl..."
                );
                CharSetAnsiSequentialByRefDelegateCdecl caller4 =
                    Get_MarshalStructCharSetAnsiSequentialByRef_Cdecl_FuncPtr();
                Assert.True(caller4(ref source_csas));
                Assert.True(
                    Helper.ValidateCharSetAnsiSequential(
                        source_csas,
                        change_csas,
                        "DelegatePInvoke_MarshalStructCharSetAnsiSequentialByRef_Cdecl"
                    )
                );
                break;
            case StructID.CharSetUnicodeSequentialId:
                ...
                Console.WriteLine(
                    "Calling DelegatePInvoke_MarshalStructCharSetUnicodeSequentialByRef_Cdecl..."
                );
                CharSetUnicodeSequentialByRefDelegateCdecl caller5 =
                    Get_MarshalStructCharSetUnicodeSequentialByRef_Cdecl_FuncPtr();
                Assert.True(caller5(ref source_csus));
                Assert.True(
                    Helper.ValidateCharSetUnicodeSequential(
                        source_csus,
                        change_csus,
                        "DelegatePInvoke_MarshalStructCharSetUnicodeSequentialByRef_Cdecl"
                    )
                );
                break;
            case StructID.NumberSequentialId:
                ...
                Console.WriteLine(
                    "Calling DelegatePInvoke_MarshalStructNumberSequentialByRef_Cdecl..."
                );
                NumberSequentialByRefDelegateCdecl caller6 =
                    Get_MarshalStructNumberSequentialByRef_Cdecl_FuncPtr();
                Assert.True(caller6(ref source_ns));
                Assert.True(
                    Helper.ValidateNumberSequential(
                        source_ns,
                        change_ns,
                        "DelegatePInvoke_MarshalStructNumberSequentialByRef_Cdecl"
                    )
                );
                break;
            case StructID.S3Id:
                ...
                Assert.True(
                    Helper.ValidateS3(
                        sourceS3,
                        changeS3,
                        "DelegatePInvoke_MarshalStructS3ByRef_Cdecl"
                    )
                );
                break;
            case StructID.S5Id:
                ...
                Assert.True(
                    Helper.ValidateS5(
                        sourceS5,
                        changeS5,
                        "DelegatePInvoke_MarshalStructS5ByRef_Cdecl"
                    )
                );
                break;
            case StructID.StringStructSequentialAnsiId:
                ...
                Console.WriteLine(
                    "Calling DelegatePInvoke_MarshalStructStringStructSequentialAnsiByRef_Cdecl..."
                );
                StringStructSequentialAnsiByRefDelegateCdecl caller9 =
                    Get_MarshalStructStringStructSequentialAnsiByRef_Cdecl_FuncPtr();
                Assert.True(caller9(ref source_sssa));
                Assert.True(
                    Helper.ValidateStringStructSequentialAnsi(
                        source_sssa,
                        change_sssa,
                        "DelegatePInvoke_MarshalStructStringStructSequentialAnsiByRef_Cdecl"
                    )
                );
                break;
            case StructID.StringStructSequentialUnicodeId:
                ...
                StringStructSequentialUnicode source_sssu = Helper.NewStringStructSequentialUnicode(
                    strOne,
                    strTwo
                );
                StringStructSequentialUnicode change_sssu = Helper.NewStringStructSequentialUnicode(
                    strTwo,
                    strOne
                );
                Console.WriteLine(
                    "Calling DelegatePInvoke_MarshalStructStringStructSequentialUnicodeByRef_Cdecl..."
                );
                StringStructSequentialUnicodeByRefDelegateCdecl caller10 =
                    Get_MarshalStructStringStructSequentialUnicodeByRef_Cdecl_FuncPtr();
                Assert.True(caller10(ref source_sssu));
                Assert.True(
                    Helper.ValidateStringStructSequentialUnicode(
                        source_sssu,
                        change_sssu,
                        "DelegatePInvoke_MarshalStructStringStructSequentialUnicodeByRef_Cdecl"
                    )
                );
                break;
            case StructID.S8Id:
                ...
                Assert.True(
                    Helper.ValidateS8(
                        sourceS8,
                        changeS8,
                        "DelegatePInvoke_MarshalStructS8ByRef_Cdecl"
                    )
                );
                break;
            case StructID.S9Id:
                ...
                Assert.True(
                    Helper.ValidateS9(
                        sourceS9,
                        changeS9,
                        "DelegatePInvoke_MarshalStructS9ByRef_Cdecl"
                    )
                );
                break;
            case StructID.IncludeOuterIntegerStructSequentialId:
                ...
                Console.WriteLine(
                    "Calling DelegatePInvoke_MarshalStructIncludeOuterIntegerStructSequentialByRef_Cdecl..."
                );
                IncludeOuterIntegerStructSequentialByRefDelegateCdecl caller13 =
                    Get_MarshalStructIncludeOuterIntegerStructSequentialByRef_Cdecl_FuncPtr();
                ...
                Assert.True(
                    Helper.ValidateIncludeOuterIntegerStructSequential(
                        ...
                        "DelegatePInvoke_MarshalStructIncludeOuterIntegerStructSequentialByRef_Cdecl"
                    )
                );
                break;
            case StructID.S11Id:
                ...
                Assert.True(
                    Helper.ValidateS11(
                        sourceS11,
                        changeS11,
                        "DelegatePInvoke_MarshalStructS11ByRef_Cdecl"
                    )
                );
                break;
            default:
                Assert.Fail(
                    "TestMethod_DelegatePInvoke_MarshalByRef_Cdecl:The structid (Managed Side) is wrong"
                );
                break;
        }
    }

    private static unsafe void TestMethod_DelegatePInvoke_MarshalByRef_StdCall(StructID structid)
    {
        ...
        switch (structid)
        {
            case StructID.ComplexStructId:
                Console.WriteLine(
                    "Calling DelegatePInvoke_MarshalStructComplexStructByRef_StdCall..."
                );
                ComplexStruct cs = new ComplexStruct();
                cs.i = 321;
                cs.b = true;
                ...
                cs.type.idata = 123;
                cs.type.ptrdata = (IntPtr)0x120000;
                ComplexStructByRefDelegateStdCall caller1 =
                    Get_MarshalStructComplexStructByRef_StdCall_FuncPtr();
                Assert.True(caller1(ref cs));
                Assert.Equal(9999, cs.i);
                Assert.False(cs.b);
                Assert.Equal("Native", cs.str);
            ...
            case StructID.InnerSequentialId:
                ...
                InnerSequential change_is = Helper.NewInnerSequential(77, 77.0F, "changed string");
                Console.WriteLine(
                    "Calling DelegatePInvoke_MarshalStructInnerSequentialByRef_StdCall..."
                );
                InnerSequentialByRefDelegateStdCall caller2 =
                    Get_MarshalStructInnerSequentialByRef_StdCall_FuncPtr();
                Assert.True(caller2(ref source_is));
                Assert.True(
                    Helper.ValidateInnerSequential(
                        source_is,
                        change_is,
                        "DelegatePInvoke_MarshalStructInnerSequentialByRef_StdCall"
                    )
                );
                break;
            case StructID.InnerArraySequentialId:
                ...
                Console.WriteLine(
                    "Calling DelegatePInvoke_MarshalStructInnerArraySequentialByRef_StdCall..."
                );
                InnerArraySequentialByRefDelegateStdCall caller3 =
                    Get_MarshalStructInnerArraySequentialByRef_StdCall_FuncPtr();
                Assert.True(caller3(ref source_ias));
                Assert.True(
                    Helper.ValidateInnerArraySequential(
                        source_ias,
            ...
            case StructID.CharSetAnsiSequentialId:
                ...
                Console.WriteLine(
                    "Calling DelegatePInvoke_MarshalStructCharSetAnsiSequentialByRef_StdCall..."
                );
                CharSetAnsiSequentialByRefDelegateStdCall caller4 =
                    Get_MarshalStructCharSetAnsiSequentialByRef_StdCall_FuncPtr();
                Assert.True(caller4(ref source_csas));
                Assert.True(
                    Helper.ValidateCharSetAnsiSequential(
                        source_csas,
                        change_csas,
                        "DelegatePInvoke_MarshalStructCharSetAnsiSequentialByRef_StdCall"
                    )
                );
                break;
            case StructID.CharSetUnicodeSequentialId:
                ...
                Console.WriteLine(
                    "Calling DelegatePInvoke_MarshalStructCharSetUnicodeSequentialByRef_StdCall..."
                );
                CharSetUnicodeSequentialByRefDelegateStdCall caller5 =
                    Get_MarshalStructCharSetUnicodeSequentialByRef_StdCall_FuncPtr();
                Assert.True(caller5(ref source_csus));
                Assert.True(
                    Helper.ValidateCharSetUnicodeSequential(
                        source_csus,
                        change_csus,
                        "DelegatePInvoke_MarshalStructCharSetUnicodeSequentialByRef_StdCall"
                    )
                );
                break;
            case StructID.NumberSequentialId:
                ...
                Console.WriteLine(
                    "Calling DelegatePInvoke_MarshalStructNumberSequentialByRef_StdCall..."
                );
                NumberSequentialByRefDelegateStdCall caller6 =
                    Get_MarshalStructNumberSequentialByRef_StdCall_FuncPtr();
                Assert.True(caller6(ref source_ns));
                Assert.True(
                    Helper.ValidateNumberSequential(
                        source_ns,
                        change_ns,
                        "DelegatePInvoke_MarshalStructNumberSequentialByRef_StdCall"
                    )
                );
                break;
            case StructID.S3Id:
                ...
                Assert.True(
                    Helper.ValidateS3(
                        sourceS3,
                        changeS3,
                        "DelegatePInvoke_MarshalStructS3ByRef_StdCall"
                    )
                );
                break;
            case StructID.S5Id:
                ...
                Assert.True(
                    Helper.ValidateS5(
                        sourceS5,
                        changeS5,
                        "DelegatePInvoke_MarshalStructS5ByRef_StdCall"
                    )
                );
                break;
            case StructID.StringStructSequentialAnsiId:
                ...
                Console.WriteLine(
                    "Calling DelegatePInvoke_MarshalStructStringStructSequentialAnsiByRef_StdCall..."
                );
                StringStructSequentialAnsiByRefDelegateStdCall caller9 =
                    Get_MarshalStructStringStructSequentialAnsiByRef_StdCall_FuncPtr();
                Assert.True(caller9(ref source_sssa));
                Assert.True(
                    Helper.ValidateStringStructSequentialAnsi(
                        source_sssa,
                        change_sssa,
                        "DelegatePInvoke_MarshalStructStringStructSequentialAnsiByRef_StdCall"
                    )
                );
                break;
            case StructID.StringStructSequentialUnicodeId:
                ...
                Console.WriteLine(
                    "Calling DelegatePInvoke_MarshalStructStringStructSequentialUnicodeByRef_StdCall..."
                );
                StringStructSequentialUnicodeByRefDelegateStdCall caller10 =
                    Get_MarshalStructStringStructSequentialUnicodeByRef_StdCall_FuncPtr();
                Assert.True(caller10(ref source_sssu));
                Assert.True(
                    Helper.ValidateStringStructSequentialUnicode(
                        source_sssu,
                        change_sssu,
                        "DelegatePInvoke_MarshalStructStringStructSequentialUnicodeByRef_StdCall"
                    )
                );
                break;
            case StructID.S8Id:
                ...
                Assert.True(
                    Helper.ValidateS8(
                        sourceS8,
                        changeS8,
                        "DelegatePInvoke_MarshalStructS8ByRef_StdCall"
                    )
                );
                break;
            case StructID.S9Id:
                ...
                Assert.True(
                    Helper.ValidateS9(
                        sourceS9,
                        changeS9,
                        "DelegatePInvoke_MarshalStructS9ByRef_StdCall"
                    )
                );
                break;
            case StructID.IncludeOuterIntegerStructSequentialId:
                ...
                IncludeOuterIntegerStructSequential changeIncludeOuterIntegerStructSequential =
                    Helper.NewIncludeOuterIntegerStructSequential(64, 64);
                Console.WriteLine(
                    "Calling DelegatePInvoke_MarshalStructIncludeOuterIntegerStructSequentialByRef_StdCall..."
                );
                IncludeOuterIntegerStructSequentialByRefDelegateStdCall caller13 =
                    Get_MarshalStructIncludeOuterIntegerStructSequentialByRef_StdCall_FuncPtr();
                Assert.True(caller13(ref sourceIncludeOuterIntegerStructSequential));
                Assert.True(
                    Helper.ValidateIncludeOuterIntegerStructSequential(
                        sourceIncludeOuterIntegerStructSequential,
                        changeIncludeOuterIntegerStructSequential,
                        "DelegatePInvoke_MarshalStructIncludeOuterIntegerStructSequentialByRef_StdCall"
                    )
                );
                break;
            case StructID.S11Id:
                ...
                Assert.True(
                    Helper.ValidateS11(
                        sourceS11,
                        changeS11,
                        "DelegatePInvoke_MarshalStructS11ByRef_StdCall"
                    )
                );
                break;
            default:
                Assert.Fail(
                    "TestMethod_DelegatePInvoke_MarshalByRef_StdCall:The structid (Managed Side) is wrong"
                );
                break;
        }
    }

    private static unsafe void TestMethod_DelegatePInvoke_MarshalByVal_Cdecl(StructID structid)
    {
        ...
        switch (structid)
        {
            case StructID.ComplexStructId:
                Console.WriteLine(
                    "Calling DelegatePInvoke_MarshalStructComplexStructByVal_Cdecl..."
                );
                ComplexStruct cs = new ComplexStruct();
                cs.i = 321;
                cs.b = true;
                ...
                cs.type.idata = 123;
                cs.type.ptrdata = (IntPtr)0x120000;
                ComplexStructByValDelegateCdecl caller1 =
                    Get_MarshalStructComplexStructByVal_Cdecl_FuncPtr();
            ...
            case StructID.InnerSequentialId:
                Console.WriteLine(
                    "Calling DelegatePInvoke_MarshalStructInnerSequentialByVal_Cdecl..."
                );
                InnerSequential source_is = Helper.NewInnerSequential(1, 1.0F, "some string");
                InnerSequential clone_is1 = Helper.NewInnerSequential(1, 1.0F, "some string");
                InnerSequentialByValDelegateCdecl caller2 =
                    Get_MarshalStructInnerSequentialByVal_Cdecl_FuncPtr();
            ...
            case StructID.InnerArraySequentialId:
                Console.WriteLine(
                    "Calling DelegatePInvoke_MarshalStructInnerArraySequentialByVal_Cdecl..."
                );
                InnerArraySequential source_ias = Helper.NewInnerArraySequential(
                    1,
                    1.0F,
                ...
                InnerArraySequentialByValDelegateCdecl caller3 =
                    Get_MarshalStructInnerArraySequentialByVal_Cdecl_FuncPtr();
                Assert.True(caller3(source_ias));
                Assert.True(
                    Helper.ValidateInnerArraySequential(
                        source_ias,
                        clone_ias,
                        "DelegatePInvoke_MarshalStructInnerArraySequentialByVal_Cdecl"
                    )
                );
                break;
            case StructID.CharSetAnsiSequentialId:
                Console.WriteLine(
                    "Calling DelegatePInvoke_MarshalStructCharSetAnsiSequentialByVal_Cdecl..."
                );
                CharSetAnsiSequential source_csas = Helper.NewCharSetAnsiSequential(
                    "some string",
                    'c'
                ...
                CharSetAnsiSequentialByValDelegateCdecl caller4 =
                ...
                Assert.True(
                    Helper.ValidateCharSetAnsiSequential(
                        source_csas,
                        clone_csas,
                        "DelegatePInvoke_MarshalStructCharSetAnsiSequentialByVal_Cdecl"
                    )
                );
                break;
            case StructID.CharSetUnicodeSequentialId:
                Console.WriteLine(
                    "Calling DelegatePInvoke_MarshalStructCharSetUnicodeSequentialByVal_Cdecl..."
                );
                CharSetUnicodeSequential source_csus = Helper.NewCharSetUnicodeSequential(
                    "some string",
                    'c'
                ...
                CharSetUnicodeSequentialByValDelegateCdecl caller5 =
                    Get_MarshalStructCharSetUnicodeSequentialByVal_Cdecl_FuncPtr();
                Assert.True(caller5(source_csus));
                Assert.True(
                    Helper.ValidateCharSetUnicodeSequential(
                        source_csus,
                        clone_csus,
                        "DelegatePInvoke_MarshalStructCharSetUnicodeSequentialByVal_Cdecl"
                    )
                );
                break;
            case StructID.NumberSequentialId:
                Console.WriteLine(
                    "Calling DelegatePInvoke_MarshalStructNumberSequentialByVal_Cdecl..."
                );
                NumberSequential source_ns = Helper.NewNumberSequential(
                    Int32.MinValue,
                    UInt32.MaxValue,
                ...
                NumberSequentialByValDelegateCdecl caller6 =
                    Get_MarshalStructNumberSequentialByVal_Cdecl_FuncPtr();
                Assert.True(caller6(source_ns));
                Assert.True(
                    Helper.ValidateNumberSequential(
                        source_ns,
                        clone_ns,
                        "DelegatePInvoke_MarshalStructNumberSequentialByVal_Cdecl"
                    )
                );
                break;
            case StructID.S3Id:
                ...
                Assert.True(
                    Helper.ValidateS3(
                        sourceS3,
                        cloneS3,
                        "DelegatePInvoke_MarshalStructS3ByVal_Cdecl"
                    )
                );
                break;
            case StructID.S5Id:
                ...
                Assert.True(
                    Helper.ValidateS5(
                        sourceS5,
                        cloneS5,
                        "DelegatePInvoke_MarshalStructS5ByVal_Cdecl"
                    )
                );
                break;
            case StructID.StringStructSequentialAnsiId:
                ...
                Console.WriteLine(
                    "Calling DelegatePInvoke_MarshalStructStringStructSequentialAnsiByVal_Cdecl..."
                );
                StringStructSequentialAnsiByValDelegateCdecl caller9 =
                    Get_MarshalStructStringStructSequentialAnsiByVal_Cdecl_FuncPtr();
                Assert.True(caller9(source_sssa));
                Assert.True(
                    Helper.ValidateStringStructSequentialAnsi(
                        source_sssa,
                        clone_sssa,
                        "DelegatePInvoke_MarshalStructStringStructSequentialAnsiByVal_Cdecl"
                    )
                );
                break;
            case StructID.StringStructSequentialUnicodeId:
                ...
                StringStructSequentialUnicode clone_sssu = Helper.NewStringStructSequentialUnicode(
                    strOne,
                    strTwo
                );
                Console.WriteLine(
                    "Calling DelegatePInvoke_MarshalStructStringStructSequentialUnicodeByVal_Cdecl..."
                );
                StringStructSequentialUnicodeByValDelegateCdecl caller10 =
                    Get_MarshalStructStringStructSequentialUnicodeByVal_Cdecl_FuncPtr();
                Assert.True(caller10(source_sssu));
                Assert.True(
                    Helper.ValidateStringStructSequentialUnicode(
                        source_sssu,
                        clone_sssu,
                        "DelegatePInvoke_MarshalStructStringStructSequentialUnicodeByVal_Cdecl"
                    )
                );
                break;
            case StructID.S8Id:
                ...
                Assert.True(
                    Helper.ValidateS8(
                        sourceS8,
                        cloneS8,
                        "DelegatePInvoke_MarshalStructS8ByVal_Cdecl"
                    )
                );
                break;
            case StructID.S9Id:
                ...
                Assert.True(
                    Helper.ValidateS9(
                        sourceS9,
                        cloneS9,
                        "DelegatePInvoke_MarshalStructS9ByVal_Cdecl"
                    )
                );
                break;
            case StructID.IncludeOuterIntegerStructSequentialId:
                ...
                IncludeOuterIntegerStructSequential cloneIncludeOuterIntegerStructSequential =
                    Helper.NewIncludeOuterIntegerStructSequential(32, 32);
                Console.WriteLine(
                    "Calling DelegatePInvoke_MarshalStructIncludeOuterIntegerStructSequentialByVal_Cdecl..."
                );
                IncludeOuterIntegerStructSequentialByValDelegateCdecl caller13 =
                    Get_MarshalStructIncludeOuterIntegerStructSequentialByVal_Cdecl_FuncPtr();
                Assert.True(caller13(sourceIncludeOuterIntegerStructSequential));
                Assert.True(
                    Helper.ValidateIncludeOuterIntegerStructSequential(
                        sourceIncludeOuterIntegerStructSequential,
                        cloneIncludeOuterIntegerStructSequential,
                        "DelegatePInvoke_MarshalStructIncludeOuterIntegerStructSequentialByVal_Cdecl"
                    )
                );
                break;
            case StructID.S11Id:
                ...
                Assert.True(
                    Helper.ValidateS11(
                        sourceS11,
                        cloneS11,
                        "DelegatePInvoke_MarshalStructS11ByVal_Cdecl"
                    )
                );
                break;
            default:
                Assert.Fail(
                    "TestMethod_DelegatePInvoke_MarshalByVal_Cdecl:The structid (Managed Side) is wrong"
                );
                break;
        }
    }

    private static unsafe void TestMethod_DelegatePInvoke_MarshalByVal_StdCall(StructID structid)
    {
        ...
        switch (structid)
        {
            case StructID.ComplexStructId:
                Console.WriteLine(
                    "Calling DelegatePInvoke_MarshalStructComplexStructByVal_StdCall..."
                );
                ComplexStruct cs = new ComplexStruct();
                cs.i = 321;
                cs.b = true;
                ...
                cs.type.idata = 123;
                cs.type.ptrdata = (IntPtr)0x120000;
                ComplexStructByValDelegateStdCall caller1 =
            ...
            case StructID.InnerSequentialId:
                Console.WriteLine(
                    "Calling DelegatePInvoke_MarshalStructInnerSequentialByVal_StdCall..."
                );
                InnerSequential source_is = Helper.NewInnerSequential(1, 1.0F, "some string");
                InnerSequential clone_is1 = Helper.NewInnerSequential(1, 1.0F, "some string");
                InnerSequentialByValDelegateStdCall caller2 =
                    Get_MarshalStructInnerSequentialByVal_StdCall_FuncPtr();
                Assert.True(caller2(source_is));
                Assert.True(
                    Helper.ValidateInnerSequential(
                        source_is,
                        clone_is1,
                        "DelegatePInvoke_MarshalStructInnerSequentialByVal_StdCall"
                    )
                );
                break;
            case StructID.InnerArraySequentialId:
                Console.WriteLine(
                    "Calling DelegatePInvoke_MarshalStructInnerArraySequentialByVal_StdCall..."
                );
                InnerArraySequential source_ias = Helper.NewInnerArraySequential(
                    1,
                    1.0F,
                ...
                InnerArraySequentialByValDelegateStdCall caller3 =
                    Get_MarshalStructInnerArraySequentialByVal_StdCall_FuncPtr();
                Assert.True(caller3(source_ias));
                Assert.True(
                    Helper.ValidateInnerArraySequential(
                        source_ias,
                        clone_ias,
                        "DelegatePInvoke_MarshalStructInnerArraySequentialByVal_StdCall"
                    )
                );
                break;
            case StructID.CharSetAnsiSequentialId:
                Console.WriteLine(
                    "Calling DelegatePInvoke_MarshalStructCharSetAnsiSequentialByVal_StdCall..."
                );
                CharSetAnsiSequential source_csas = Helper.NewCharSetAnsiSequential(
                    "some string",
                    'c'
                ...
                CharSetAnsiSequentialByValDelegateStdCall caller4 =
                    Get_MarshalStructCharSetAnsiSequentialByVal_StdCall_FuncPtr();
                Assert.True(caller4(source_csas));
                Assert.True(
                    Helper.ValidateCharSetAnsiSequential(
                        source_csas,
                        clone_csas,
                        "DelegatePInvoke_MarshalStructCharSetAnsiSequentialByVal_StdCall"
                    )
                );
                break;
            case StructID.CharSetUnicodeSequentialId:
                Console.WriteLine(
                    "Calling DelegatePInvoke_MarshalStructCharSetUnicodeSequentialByVal_StdCall..."
                );
                CharSetUnicodeSequential source_csus = Helper.NewCharSetUnicodeSequential(
                    "some string",
                    'c'
                ...
                CharSetUnicodeSequentialByValDelegateStdCall caller5 =
                    Get_MarshalStructCharSetUnicodeSequentialByVal_StdCall_FuncPtr();
                Assert.True(caller5(source_csus));
                Assert.True(
                    Helper.ValidateCharSetUnicodeSequential(
                        source_csus,
                        clone_csus,
                        "DelegatePInvoke_MarshalStructCharSetUnicodeSequentialByVal_StdCall"
                    )
                );
                break;
            case StructID.NumberSequentialId:
                Console.WriteLine(
                    "Calling DelegatePInvoke_MarshalStructNumberSequentialByVal_StdCall..."
                );
                NumberSequential source_ns = Helper.NewNumberSequential(
                    Int32.MinValue,
                    UInt32.MaxValue,
                ...
                NumberSequentialByValDelegateStdCall caller6 =
                    Get_MarshalStructNumberSequentialByVal_StdCall_FuncPtr();
                Assert.True(caller6(source_ns));
                Assert.True(
                    Helper.ValidateNumberSequential(
                        source_ns,
                        clone_ns,
                        "DelegatePInvoke_MarshalStructNumberSequentialByVal_StdCall"
                    )
                );
                break;
            case StructID.S3Id:
                ...
                Assert.True(
                    Helper.ValidateS3(
                        sourceS3,
                        cloneS3,
                        "DelegatePInvoke_MarshalStructS3ByVal_StdCall"
                    )
                );
                break;
            case StructID.S5Id:
                ...
                Assert.True(
                    Helper.ValidateS5(
                        sourceS5,
                        cloneS5,
                        "DelegatePInvoke_MarshalStructS5ByVal_StdCall"
                    )
                );
                break;
            case StructID.StringStructSequentialAnsiId:
                ...
                Console.WriteLine(
                    "Calling DelegatePInvoke_MarshalStructStringStructSequentialAnsiByVal_StdCall..."
                );
                StringStructSequentialAnsiByValDelegateStdCall caller9 =
                    Get_MarshalStructStringStructSequentialAnsiByVal_StdCall_FuncPtr();
                Assert.True(caller9(source_sssa));
                Assert.True(
                    Helper.ValidateStringStructSequentialAnsi(
                        source_sssa,
                        clone_sssa,
                        "DelegatePInvoke_MarshalStructStringStructSequentialAnsiByVal_StdCall"
                    )
                );
                break;
            case StructID.StringStructSequentialUnicodeId:
                ...
                Console.WriteLine(
                    "Calling DelegatePInvoke_MarshalStructStringStructSequentialUnicodeByVal_StdCall..."
                );
                StringStructSequentialUnicodeByValDelegateStdCall caller10 =
                    Get_MarshalStructStringStructSequentialUnicodeByVal_StdCall_FuncPtr();
                Assert.True(caller10(source_sssu));
                Assert.True(
                    Helper.ValidateStringStructSequentialUnicode(
                        source_sssu,
                        clone_sssu,
                        "DelegatePInvoke_MarshalStructStringStructSequentialUnicodeByVal_StdCall"
                    )
                );
                break;
            case StructID.S8Id:
                ...
                Assert.True(
                    Helper.ValidateS8(
                        sourceS8,
                        cloneS8,
                        "DelegatePInvoke_MarshalStructS8ByVal_StdCall"
                    )
                );
                break;
            case StructID.S9Id:
                ...
                Assert.True(
                    Helper.ValidateS9(
                        sourceS9,
                        cloneS9,
                        "DelegatePInvoke_MarshalStructS9ByVal_StdCall"
                    )
                );
                break;
            case StructID.IncludeOuterIntegerStructSequentialId:
                ...
                IncludeOuterIntegerStructSequential cloneIncludeOuterIntegerStructSequential =
                    Helper.NewIncludeOuterIntegerStructSequential(32, 32);
                Console.WriteLine(
                    "Calling DelegatePInvoke_MarshalStructIncludeOuterIntegerStructSequentialByVal_StdCall..."
                );
                IncludeOuterIntegerStructSequentialByValDelegateStdCall caller13 =
                    Get_MarshalStructIncludeOuterIntegerStructSequentialByVal_StdCall_FuncPtr();
                Assert.True(caller13(sourceIncludeOuterIntegerStructSequential));
                Assert.True(
                    Helper.ValidateIncludeOuterIntegerStructSequential(
                        sourceIncludeOuterIntegerStructSequential,
                        cloneIncludeOuterIntegerStructSequential,
                        "DelegatePInvoke_MarshalStructIncludeOuterIntegerStructSequentialByVal_StdCall"
                    )
                );
                break;
            case StructID.S11Id:
            ...
            default:
                Assert.Fail(
                    "TestMethod_DelegatePInvoke_MarshalByVal_StdCall:The structid (Managed Side) is wrong"
                );
                break;
        }
    }
    ...
    unsafe private static void Run_TestMethod_DelegatePInvoke_MarshalByRef_Cdecl()
    {
        ...
        TestMethod_DelegatePInvoke_MarshalByRef_Cdecl(
            StructID.IncludeOuterIntegerStructSequentialId
        );
        TestMethod_DelegatePInvoke_MarshalByRef_Cdecl(StructID.S11Id);
    }

    private static unsafe void Run_TestMethod_DelegatePInvoke_MarshalByRef_StdCall()
    {
    ...
    private static unsafe void Run_TestMethod_DelegatePInvoke_MarshalByVal_StdCall()
    {
        ...
        TestMethod_DelegatePInvoke_MarshalByVal_StdCall(
            StructID.IncludeOuterIntegerStructSequentialId
        );
