...
public class Test_RefCharArrayTest
{
        ...
        try
        {
            ...
            if (!MarshalRefCharArray_Cdecl(ref pCharArray))
            {
                ...
                TestFramework.LogError(
                    "001",
                    "MarshalRefCharArray_Cdecl:The Input(From Managed To Native) is wrong"
                );
            }
    ...
    static bool TestMethod_PInvoke_StdCall()
    {
        ...
        try
        {
            ...
            if (!MarshalRefCharArray_Stdcall(ref pCharArray))
            {
                ...
                TestFramework.LogError(
                    "003",
                    "MarshalRefCharArray_Stdcall:The Input(From Managed To Native) is wrong"
                );
            }
            ...
            if ('z' != pCharArray[0])
            {
                ...
                TestFramework.LogError(
                    "004",
                    "MarshalRefCharArray_Stdcall:The value hasnt changed"
                );
            }
        }
        catch (Exception e)
    ...
    public static bool TestMethod_MarshalRefCharArray_Stdcall(ref char[] arr)
    {
        ...
        try
        {
            ...
            if ('z' != arr[0])
            {
                ...
                TestFramework.LogError(
                    "006",
                    "TestMethod_MarshalRefCharArray_StdCall:Managed Side"
                );
            }
            //Change value
            arr[0] = (char)('a');
    ...
    private static bool TestMethod_DelegatePInvokeCdecl()
    {
        ...
        try
        {
            ...
            if (!caller(ref p))
            {
                ...
                TestFramework.LogError(
                    "007",
                    "TestMethod_DelegatePInvokeCdecl:The return value is wrong"
                );
            }
            if ('z' != p[0])
            {
                ...
                TestFramework.LogError(
                    "008",
                    "TestMethod_DelegatePInvokeCdecl:The value hasnt changed"
                );
            }
        }
        catch (Exception e)
    ...
    private static bool TestMethod_DelegatePInvokeStdcall()
    {
        ...
        try
        {
            ...
            if (!caller(ref p))
            {
                ...
                TestFramework.LogError(
                    "009",
                    "TestMethod_DelegatePInvokeStdcall:The return value is wrong"
                );
            }
            if ('z' != p[0])
            {
                ...
                TestFramework.LogError(
                    "010",
                    "TestMethod_DelegatePInvokeStdcall:The value hasnt changed"
                );
            }
        }
        catch (Exception e)
    ...
    public static int TestEntryPoint()
    {
        ...
        bresult =
            bresult
            && DoCallBack_MarshalRefCharArray_Cdecl(
                new CdeclCallBack(TestMethod_MarshalRefCharArray_Cdecl)
            );

        //TestMethod4,ReversePinvoke,Stdcall
        bresult =
            bresult
            && DoCallBack_MarshalRefCharArray_Stdcall(
                new StdCallBack(TestMethod_MarshalRefCharArray_Stdcall)
            );
