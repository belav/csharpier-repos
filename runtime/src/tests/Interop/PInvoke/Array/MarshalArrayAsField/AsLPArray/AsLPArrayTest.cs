...
class Test
{
    ...
    static void RunTest1(string report)
    {
        ...
        Assert.Throws<TypeLoadException>(
            () => TakeIntArraySeqStructByVal(s1, ARRAY_SIZE),
        ...
        Assert.Throws<TypeLoadException>(
            () => TakeUIntArraySeqStructByVal(s2, ARRAY_SIZE),
        ...
        Assert.Throws<TypeLoadException>(
            () => TakeShortArraySeqStructByVal(s3, ARRAY_SIZE),
        ...
        Assert.Throws<TypeLoadException>(
            () => TakeWordArraySeqStructByVal(s4, ARRAY_SIZE),
        ...
        Assert.Throws<TypeLoadException>(
            () => TakeLong64ArraySeqStructByVal(s5, ARRAY_SIZE),
        ...
        Assert.Throws<TypeLoadException>(
            () => TakeULong64ArraySeqStructByVal(s6, ARRAY_SIZE),
        ...
        Assert.Throws<TypeLoadException>(
            () => TakeDoubleArraySeqStructByVal(s7, ARRAY_SIZE),
        ...
        Assert.Throws<TypeLoadException>(
            () => TakeFloatArraySeqStructByVal(s8, ARRAY_SIZE),
        ...
        Assert.Throws<TypeLoadException>(
            () => TakeByteArraySeqStructByVal(s9, ARRAY_SIZE),
        ...
        Assert.Throws<TypeLoadException>(
            () => TakeCharArraySeqStructByVal(s10, ARRAY_SIZE),
        ...
        Assert.Throws<TypeLoadException>(
            () => TakeLPSTRArraySeqStructByVal(s11, ARRAY_SIZE),
        ...
        Assert.Throws<TypeLoadException>(
            () => TakeLPCSTRArraySeqStructByVal(s12, ARRAY_SIZE),
        ...
        if (RuntimeInformation.IsOSPlatform(OSPlatform.Windows))
        {
            ...
            Assert.Throws<TypeLoadException>(
                () => TakeBSTRArraySeqStructByVal(s13, ARRAY_SIZE),
        ...
        Assert.Throws<TypeLoadException>(
            () => TakeStructArraySeqStructByVal(s14, ARRAY_SIZE),
    ...
    static void RunTest2(string report)
    {
        ...
        Assert.Throws<TypeLoadException>(
            () => TakeIntArraySeqClassByVal(c1, ARRAY_SIZE),
            "TakeIntArraySeqClassByVal"
        );

        C_UINTArray_Seq c2 = new C_UINTArray_Seq();
        c2.arr = InitArray<uint>(ARRAY_SIZE);
        Assert.Throws<TypeLoadException>(
            () => TakeUIntArraySeqClassByVal(c2, ARRAY_SIZE),
            "TakeUIntArraySeqClassByVal"
        );

        C_SHORTArray_Seq c3 = new C_SHORTArray_Seq();
        c3.arr = InitArray<short>(ARRAY_SIZE);
        Assert.Throws<TypeLoadException>(
            () => TakeShortArraySeqClassByVal(c3, ARRAY_SIZE),
            "TakeShortArraySeqClassByVal"
        );

        C_WORDArray_Seq c4 = new C_WORDArray_Seq();
        c4.arr = InitArray<ushort>(ARRAY_SIZE);
        Assert.Throws<TypeLoadException>(
            () => TakeWordArraySeqClassByVal(c4, ARRAY_SIZE),
        ...
        Assert.Throws<TypeLoadException>(
            () => TakeLong64ArraySeqClassByVal(c5, ARRAY_SIZE),
            "TakeLong64ArraySeqClassByVal"
        );

        C_ULONG64Array_Seq c6 = new C_ULONG64Array_Seq();
        c6.arr = InitArray<ulong>(ARRAY_SIZE);
        Assert.Throws<TypeLoadException>(
            () => TakeULong64ArraySeqClassByVal(c6, ARRAY_SIZE),
            "TakeULong64ArraySeqClassByVal"
        );

        C_DOUBLEArray_Seq c7 = new C_DOUBLEArray_Seq();
        c7.arr = InitArray<double>(ARRAY_SIZE);
        Assert.Throws<TypeLoadException>(
            () => TakeDoubleArraySeqClassByVal(c7, ARRAY_SIZE),
        ...
        Assert.Throws<TypeLoadException>(
            () => TakeFloatArraySeqClassByVal(c8, ARRAY_SIZE),
        ...
        Assert.Throws<TypeLoadException>(
            () => TakeByteArraySeqClassByVal(c9, ARRAY_SIZE),
            "TakeByteArraySeqClassByVal"
        );

        C_CHARArray_Seq c10 = new C_CHARArray_Seq();
        c10.arr = InitArray<char>(ARRAY_SIZE);
        Assert.Throws<TypeLoadException>(
            () => TakeCharArraySeqClassByVal(c10, ARRAY_SIZE),
            "TakeCharArraySeqClassByVal"
        );

        C_LPSTRArray_Seq c11 = new C_LPSTRArray_Seq();
        c11.arr = InitArray<string>(ARRAY_SIZE);
        Assert.Throws<TypeLoadException>(
            () => TakeLPSTRArraySeqClassByVal(c11, ARRAY_SIZE),
            "TakeLPSTRArraySeqClassByVal"
        );

        C_LPCSTRArray_Seq c12 = new C_LPCSTRArray_Seq();
        c12.arr = InitArray<string>(ARRAY_SIZE);
        Assert.Throws<TypeLoadException>(
            () => TakeLPCSTRArraySeqClassByVal(c12, ARRAY_SIZE),
            "TakeLPCSTRArraySeqClassByVal"
        );
        ...
        if (RuntimeInformation.IsOSPlatform(OSPlatform.Windows))
        {
            ...
            Assert.Throws<TypeLoadException>(
                () => TakeBSTRArraySeqClassByVal(c13, ARRAY_SIZE),
                "TakeBSTRArraySeqClassByVal"
            );
        }
        ...
        Assert.Throws<TypeLoadException>(
            () => TakeStructArraySeqClassByVal(c14, ARRAY_SIZE),
            "TakeStructArraySeqClassByVal"
        );
    }
    ...
    static void RunTest3(string report)
    {
        ...
        s1.arr = InitArray<int>(ARRAY_SIZE);
        Assert.Throws<TypeLoadException>(
            () => TakeIntArrayExpStructByVal(s1, ARRAY_SIZE),
        ...
        s2.arr = InitArray<uint>(ARRAY_SIZE);
        Assert.Throws<TypeLoadException>(
            () => TakeUIntArrayExpStructByVal(s2, ARRAY_SIZE),
        ...
        s3.arr = InitArray<short>(ARRAY_SIZE);
        Assert.Throws<TypeLoadException>(
            () => TakeShortArrayExpStructByVal(s3, ARRAY_SIZE),
        ...
        s4.arr = InitArray<ushort>(ARRAY_SIZE);
        Assert.Throws<TypeLoadException>(
            () => TakeWordArrayExpStructByVal(s4, ARRAY_SIZE),
        ...
        s5.arr = InitArray<long>(ARRAY_SIZE);
        Assert.Throws<TypeLoadException>(
            () => TakeLong64ArrayExpStructByVal(s5, ARRAY_SIZE),
        ...
        s6.arr = InitArray<ulong>(ARRAY_SIZE);
        Assert.Throws<TypeLoadException>(
            () => TakeULong64ArrayExpStructByVal(s6, ARRAY_SIZE),
        ...
        s7.arr = InitArray<double>(ARRAY_SIZE);
        Assert.Throws<TypeLoadException>(
            () => TakeDoubleArrayExpStructByVal(s7, ARRAY_SIZE),
        ...
        s8.arr = InitArray<float>(ARRAY_SIZE);
        Assert.Throws<TypeLoadException>(
            () => TakeFloatArrayExpStructByVal(s8, ARRAY_SIZE),
        ...
        s9.arr = InitArray<byte>(ARRAY_SIZE);
        Assert.Throws<TypeLoadException>(
            () => TakeByteArrayExpStructByVal(s9, ARRAY_SIZE),
        ...
        s10.arr = InitArray<char>(ARRAY_SIZE);
        Assert.Throws<TypeLoadException>(
            () => TakeCharArrayExpStructByVal(s10, ARRAY_SIZE),
        ...
        s11.arr = InitArray<string>(ARRAY_SIZE);
        Assert.Throws<TypeLoadException>(
            () => TakeLPSTRArrayExpStructByVal(s11, ARRAY_SIZE),
            "TakeLPSTRArrayExpStructByVal"
        );

        S_LPCSTRArray_Exp s12 = new S_LPCSTRArray_Exp();
        s12.arr = InitArray<string>(ARRAY_SIZE);
        Assert.Throws<TypeLoadException>(
            () => TakeLPCSTRArrayExpStructByVal(s12, ARRAY_SIZE),
            "TakeLPCSTRArrayExpStructByVal"
        );
        ...
        if (RuntimeInformation.IsOSPlatform(OSPlatform.Windows))
        {
            ...
            s13.arr = InitArray<string>(ARRAY_SIZE);
            Assert.Throws<TypeLoadException>(
                () => TakeBSTRArrayExpStructByVal(s13, ARRAY_SIZE),
        ...
        s14.arr = InitStructArray(ARRAY_SIZE);
        Assert.Throws<TypeLoadException>(
            () => TakeStructArrayExpStructByVal(s14, ARRAY_SIZE),
            "TakeStructArrayExpStructByVal"
        );
    }
    ...
    static void RunTest4(string report)
    {
        ...
        c1.arr = InitArray<int>(ARRAY_SIZE);
        Assert.Throws<TypeLoadException>(
            () => TakeIntArrayExpClassByVal(c1, ARRAY_SIZE),
            "TakeIntArrayExpClassByVal"
        );

        C_UINTArray_Exp c2 = new C_UINTArray_Exp();
        c2.arr = InitArray<uint>(ARRAY_SIZE);
        Assert.Throws<TypeLoadException>(
            () => TakeUIntArrayExpClassByVal(c2, ARRAY_SIZE),
            "TakeUIntArrayExpClassByVal"
        );

        C_SHORTArray_Exp c3 = new C_SHORTArray_Exp();
        c3.arr = InitArray<short>(ARRAY_SIZE);
        Assert.Throws<TypeLoadException>(
            () => TakeShortArrayExpClassByVal(c3, ARRAY_SIZE),
            "TakeShortArrayExpClassByVal"
        );

        C_WORDArray_Exp c4 = new C_WORDArray_Exp();
        c4.arr = InitArray<ushort>(ARRAY_SIZE);
        Assert.Throws<TypeLoadException>(
            () => TakeWordArrayExpClassByVal(c4, ARRAY_SIZE),
            "TakeWordArrayExpClassByVal"
        );

        C_LONG64Array_Exp c5 = new C_LONG64Array_Exp();
        c5.arr = InitArray<long>(ARRAY_SIZE);
        Assert.Throws<TypeLoadException>(
            () => TakeLong64ArrayExpClassByVal(c5, ARRAY_SIZE),
            "TakeLong64ArrayExpClassByVal"
        );

        C_ULONG64Array_Exp c6 = new C_ULONG64Array_Exp();
        c6.arr = InitArray<ulong>(ARRAY_SIZE);
        Assert.Throws<TypeLoadException>(
            () => TakeULong64ArrayExpClassByVal(c6, ARRAY_SIZE),
            "TakeULong64ArrayExpClassByVal"
        );

        C_DOUBLEArray_Exp c7 = new C_DOUBLEArray_Exp();
        c7.arr = InitArray<double>(ARRAY_SIZE);
        Assert.Throws<TypeLoadException>(
            () => TakeDoubleArrayExpClassByVal(c7, ARRAY_SIZE),
            "TakeDoubleArrayExpClassByVal"
        );

        C_FLOATArray_Exp c8 = new C_FLOATArray_Exp();
        c8.arr = InitArray<float>(ARRAY_SIZE);
        Assert.Throws<TypeLoadException>(
            () => TakeFloatArrayExpClassByVal(c8, ARRAY_SIZE),
            "TakeFloatArrayExpClassByVal"
        );

        C_BYTEArray_Exp c9 = new C_BYTEArray_Exp();
        c9.arr = InitArray<byte>(ARRAY_SIZE);
        Assert.Throws<TypeLoadException>(
            () => TakeByteArrayExpClassByVal(c9, ARRAY_SIZE),
            "TakeByteArrayExpClassByVal"
        );

        C_CHARArray_Exp c10 = new C_CHARArray_Exp();
        c10.arr = InitArray<char>(ARRAY_SIZE);
        Assert.Throws<TypeLoadException>(
            () => TakeCharArrayExpClassByVal(c10, ARRAY_SIZE),
            "TakeCharArrayExpClassByVal"
        );

        C_LPSTRArray_Exp c11 = new C_LPSTRArray_Exp();
        c11.arr = InitArray<string>(ARRAY_SIZE);
        Assert.Throws<TypeLoadException>(
            () => TakeLPSTRArrayExpClassByVal(c11, ARRAY_SIZE),
            "TakeLPSTRArrayExpClassByVal"
        );

        C_LPCSTRArray_Exp c12 = new C_LPCSTRArray_Exp();
        c12.arr = InitArray<string>(ARRAY_SIZE);
        Assert.Throws<TypeLoadException>(
            () => TakeLPCSTRArrayExpClassByVal(c12, ARRAY_SIZE),
            "TakeLPCSTRArrayExpClassByVal"
        );
        ...
        if (RuntimeInformation.IsOSPlatform(OSPlatform.Windows))
        {
            ...
            c13.arr = InitArray<string>(ARRAY_SIZE);
            Assert.Throws<TypeLoadException>(
                () => TakeBSTRArrayExpClassByVal(c13, ARRAY_SIZE),
                "TakeBSTRArrayExpClassByVal"
            );
        }
        ...
        c14.arr = InitStructArray(ARRAY_SIZE);
        Assert.Throws<TypeLoadException>(
            () => TakeStructArrayExpClassByVal(c14, ARRAY_SIZE),
