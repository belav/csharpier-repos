...
public class ArrayMarshal
{
    ...
    private static void TestMarshalByVal_NoAttributes()
    {
        ...
        Assert.IsTrue(
            CStyle_Array_Uint(InitArray<uint>(ARRAY_SIZE), ARRAY_SIZE),
            "CStyle_Array_Uint"
        );
        Assert.IsTrue(
            CStyle_Array_Short(InitArray<short>(ARRAY_SIZE), ARRAY_SIZE),
            "CStyle_Array_Short"
        );
        Assert.IsTrue(
            CStyle_Array_Word(InitArray<ushort>(ARRAY_SIZE), ARRAY_SIZE),
            "CStyle_Array_Word"
        );
        Assert.IsTrue(
            CStyle_Array_Long64(InitArray<long>(ARRAY_SIZE), ARRAY_SIZE),
            "CStyle_Array_Long64"
        );
        Assert.IsTrue(
            CStyle_Array_ULong64(InitArray<ulong>(ARRAY_SIZE), ARRAY_SIZE),
            "CStyle_Array_ULong64"
        );
        Assert.IsTrue(
            CStyle_Array_Double(InitArray<double>(ARRAY_SIZE), ARRAY_SIZE),
            "CStyle_Array_Double"
        );
        Assert.IsTrue(
            CStyle_Array_Float(InitArray<float>(ARRAY_SIZE), ARRAY_SIZE),
            "CStyle_Array_Float"
        );
        Assert.IsTrue(
            CStyle_Array_Byte(InitArray<byte>(ARRAY_SIZE), ARRAY_SIZE),
            "CStyle_Array_Byte"
        );
        Assert.IsTrue(
            CStyle_Array_Char(InitArray<char>(ARRAY_SIZE), ARRAY_SIZE),
            "CStyle_Array_Char"
        );
        ...
        Assert.IsTrue(
            CStyle_Array_Struct(InitStructArray(ARRAY_SIZE), ARRAY_SIZE),
            "CStyle_Array_Struct"
        );
        Assert.IsTrue(
            CStyle_Array_Bool(InitBoolArray(ARRAY_SIZE), ARRAY_SIZE),
            "CStyle_Array_Bool"
        );
    ...
    private static void TestMarshalByVal_In()
    {
        ...
        Assert.IsTrue(
            CStyle_Array_Int_In(InitArray<int>(ARRAY_SIZE), ARRAY_SIZE),
            "CStyle_Array_Int_In"
        );
        Assert.IsTrue(
            CStyle_Array_Uint_In(InitArray<uint>(ARRAY_SIZE), ARRAY_SIZE),
            "CStyle_Array_Uint_In"
        );
        Assert.IsTrue(
            CStyle_Array_Short_In(InitArray<short>(ARRAY_SIZE), ARRAY_SIZE),
            "CStyle_Array_Short_In"
        );
        Assert.IsTrue(
            CStyle_Array_Word_In(InitArray<ushort>(ARRAY_SIZE), ARRAY_SIZE),
            "CStyle_Array_Word_In"
        );
        Assert.IsTrue(
            CStyle_Array_Long64_In(InitArray<long>(ARRAY_SIZE), ARRAY_SIZE),
            "CStyle_Array_Long64_In"
        );
        Assert.IsTrue(
            CStyle_Array_ULong64_In(InitArray<ulong>(ARRAY_SIZE), ARRAY_SIZE),
            "CStyle_Array_ULong64_In"
        );
        Assert.IsTrue(
            CStyle_Array_Double_In(InitArray<double>(ARRAY_SIZE), ARRAY_SIZE),
            "CStyle_Array_Double_In"
        );
        Assert.IsTrue(
            CStyle_Array_Float_In(InitArray<float>(ARRAY_SIZE), ARRAY_SIZE),
            "CStyle_Array_Float_In"
        );
        Assert.IsTrue(
            CStyle_Array_Byte_In(InitArray<byte>(ARRAY_SIZE), ARRAY_SIZE),
            "CStyle_Array_Byte_In"
        );
        Assert.IsTrue(
            CStyle_Array_Char_In(InitArray<char>(ARRAY_SIZE), ARRAY_SIZE),
            "CStyle_Array_Char_In"
        );
        ...
        Assert.IsTrue(
            CStyle_Array_Struct_In(InitStructArray(ARRAY_SIZE), ARRAY_SIZE),
            "CStyle_Array_Struct_In"
        );
        Assert.IsTrue(
            CStyle_Array_Bool_In(InitBoolArray(ARRAY_SIZE), ARRAY_SIZE),
            "CStyle_Array_Bool_In"
        );
    ...
    private static void TestMarshalByVal_InOut()
    {
        ...
        Assert.IsTrue(
            Equals<int>(iArr, GetExpectedOutArray<int>(ARRAY_SIZE)),
            "CStyle_Array_Int_InOut:Equals<int>"
        );
        ...
        Assert.IsTrue(
            CStyle_Array_Int_InOut_ZeroLength(iArrLength0),
        ...
        Assert.IsTrue(
            Equals<uint>(uiArr, GetExpectedOutArray<uint>(ARRAY_SIZE)),
            "CStyle_Array_Uint_InOut:Equals<uint>"
        );

        short[] sArr = InitArray<short>(ARRAY_SIZE);
        Assert.IsTrue(CStyle_Array_Short_InOut(sArr, ARRAY_SIZE), "CStyle_Array_Short_InOut");
        Assert.IsTrue(
            Equals<short>(sArr, GetExpectedOutArray<short>(ARRAY_SIZE)),
            "CStyle_Array_Short_InOut:Equals<short>"
        );

        ushort[] usArr = InitArray<ushort>(ARRAY_SIZE);
        Assert.IsTrue(CStyle_Array_Word_InOut(usArr, ARRAY_SIZE), "CStyle_Array_Word_InOut");
        Assert.IsTrue(
            Equals<ushort>(usArr, GetExpectedOutArray<ushort>(ARRAY_SIZE)),
            "CStyle_Array_Word_InOut:Equals<ushort>"
        );

        long[] lArr = InitArray<long>(ARRAY_SIZE);
        Assert.IsTrue(CStyle_Array_Long64_InOut(lArr, ARRAY_SIZE), "CStyle_Array_Long64_InOut");
        Assert.IsTrue(
            Equals<long>(lArr, GetExpectedOutArray<long>(ARRAY_SIZE)),
            "CStyle_Array_Long64_InOut:Equals<long>"
        );
        ...
        Assert.IsTrue(
            Equals<string>(strArr, expectedArr),
            "CStyle_Array_LPSTR_InOut:Equals<string>"
        );
        ...
        Assert.IsTrue(
            Equals<TestStruct>(tsArr, GetExpectedOutStructArray(ARRAY_SIZE)),
            "CStyle_Array_Struct_InOut:Equals<TestStruct>"
        );

        bool[] boolArr = InitBoolArray(ARRAY_SIZE);
        Assert.IsTrue(CStyle_Array_Bool_InOut(boolArr, ARRAY_SIZE), "CStyle_Array_Bool_InOut");
        Assert.IsTrue(
            Equals<bool>(boolArr, GetExpectedOutBoolArray(ARRAY_SIZE)),
            "CStyle_Array_Bool_InOut:Equals<bool>"
        );
    }
    ...
    private static void TestMarshalByVal_Out()
    {
        ...
        Assert.IsTrue(
            Equals<int>(iArr, GetExpectedOutArray<int>(ARRAY_SIZE)),
            "CStyle_Array_Int_Out:Equals<int>"
        );
        ...
        Assert.IsTrue(
            CStyle_Array_Int_Out_ZeroLength(iArrLength0),
            "CStyle_Array_Int_Out_ZeroLength"
        );
        ...
        Assert.IsTrue(
            Equals<uint>(uiArr, GetExpectedOutArray<uint>(ARRAY_SIZE)),
            "CStyle_Array_Uint_Out:Equals<uint>"
        );
        ...
        Assert.IsTrue(
            Equals<short>(sArr, GetExpectedOutArray<short>(ARRAY_SIZE)),
            "CStyle_Array_Short_Out:Equals<short>"
        );
        ...
        Assert.IsTrue(
            Equals<ushort>(usArr, GetExpectedOutArray<ushort>(ARRAY_SIZE)),
            "CStyle_Array_Word_Out:Equals<ushort>"
        );
        ...
        Assert.IsTrue(
            Equals<long>(lArr, GetExpectedOutArray<long>(ARRAY_SIZE)),
            "CStyle_Array_Long64_Out:Equals<long>"
        );
        ...
        Assert.IsTrue(
            Equals<ulong>(ulArr, GetExpectedOutArray<ulong>(ARRAY_SIZE)),
            "CStyle_Array_ULong64_Out:Equals<ulong>"
        );
        ...
        Assert.IsTrue(
            Equals<double>(dArr, GetExpectedOutArray<double>(ARRAY_SIZE)),
            "CStyle_Array_Double_Out:Equals<double>"
        );
        ...
        Assert.IsTrue(
            Equals<float>(fArr, GetExpectedOutArray<float>(ARRAY_SIZE)),
            "CStyle_Array_Float_Out:Equals<float>"
        );
        ...
        Assert.IsTrue(
            Equals<byte>(bArr, GetExpectedOutArray<byte>(ARRAY_SIZE)),
            "CStyle_Array_Byte_Out:Equals<byte>"
        );
        ...
        Assert.IsTrue(
            Equals<char>(cArr, GetExpectedOutArray<char>(ARRAY_SIZE)),
            "CStyle_Array_Char_Out:Equals<char>"
        );
        ...
        Assert.IsTrue(
            Equals<TestStruct>(tsArr, GetExpectedOutStructArray(ARRAY_SIZE)),
            "CStyle_Array_Struct_Out:Equals<TestStruct>"
        );
        ...
        Assert.IsTrue(
            Equals<bool>(boolArr, GetExpectedOutBoolArray(ARRAY_SIZE)),
            "CStyle_Array_Bool_Out:Equals<bool>"
        );
        ...
        if (RuntimeInformation.IsOSPlatform(OSPlatform.Windows))
        {
            ...
            Assert.IsTrue(
                Equals<object>(oArr, expectedOArr),
                "CStyle_Array_Object_Out:Equals<object>"
            );
        }
    }
    #endregion
