...
unsafe partial class GenericsNative
{
    ...
    public static extern Vector256<bool> GetVector256B(
    ...
    [DllImport(nameof(GenericsNative))]
    public static extern void GetVector256BOut(
        [MarshalAs(UnmanagedType.U1)] bool e00,
        [MarshalAs(UnmanagedType.U1)] bool e01,
        [MarshalAs(UnmanagedType.U1)] bool e02,
        [MarshalAs(UnmanagedType.U1)] bool e03,
    ...
    public static extern void GetVector256BOut(
        ...
        [MarshalAs(UnmanagedType.U1)] bool e30,
        [MarshalAs(UnmanagedType.U1)] bool e31,
        out Vector256<bool> value
    );

    [DllImport(nameof(GenericsNative))]
    public static extern Vector256<bool>* GetVector256BPtr(
        [MarshalAs(UnmanagedType.U1)] bool e00,
        [MarshalAs(UnmanagedType.U1)] bool e01,
        [MarshalAs(UnmanagedType.U1)] bool e02,
        [MarshalAs(UnmanagedType.U1)] bool e03,
    ...
    public static extern ref readonly Vector256<bool> GetVector256BRef(
        [MarshalAs(UnmanagedType.U1)] bool e00,
        [MarshalAs(UnmanagedType.U1)] bool e01,
        [MarshalAs(UnmanagedType.U1)] bool e02,
        [MarshalAs(UnmanagedType.U1)] bool e03,
    ...
    [DllImport(nameof(GenericsNative))]
    public static extern Vector256<bool> AddVector256Bs(
        [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 1)] Vector256<bool>[] pValues,
        int count
    );
...
unsafe partial class GenericsTest
{
    private static void TestVector256B()
    {
        ...
        GenericsNative.GetVector256BOut(
            true,
            false,
            true,
            false,
        ...
        Assert.Throws<MarshalDirectiveException>(
            () =>
                GenericsNative.GetVector256BOut(
                    ...
                    true,
                    false,
                    out Vector256<bool> value3
                )
        );

        Vector256<bool>* value4 = GenericsNative.GetVector256BPtr(
            true,
            false,
            true,
            false,
        ...
        Assert.Throws<MarshalDirectiveException>(
            () =>
                GenericsNative.GetVector256BRef(
                    true,
                    false,
                    true,
                    false,
        ...
        Assert.Throws<MarshalDirectiveException>(
            () => GenericsNative.AddVector256B(default, default)
        );
        ...
        Assert.Throws<MarshalDirectiveException>(
            () => GenericsNative.AddVector256Bs(values, values.Length)
        );

        Assert.Throws<MarshalDirectiveException>(
            () => GenericsNative.AddVector256Bs(in values[0], values.Length)
        );
    }
}
