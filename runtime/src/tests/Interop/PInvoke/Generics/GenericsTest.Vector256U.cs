...
unsafe partial class GenericsNative
{
    ...
    public static extern Vector256<uint> GetVector256U(
        uint e00,
        uint e01,
        uint e02,
        uint e03,
    ...
    [DllImport(nameof(GenericsNative))]
    public static extern void GetVector256UOut(
        uint e00,
        uint e01,
        uint e02,
        uint e03,
    ...
    public static extern void GetVector256UOut(
        ...
        uint e06,
        uint e07,
        out Vector256<uint> value
    );

    [DllImport(nameof(GenericsNative))]
    public static extern Vector256<uint>* GetVector256UPtr(
        uint e00,
        uint e01,
        uint e02,
        uint e03,
    ...
    public static extern ref readonly Vector256<uint> GetVector256URef(
        uint e00,
        uint e01,
        uint e02,
        uint e03,
    ...
    [DllImport(nameof(GenericsNative))]
    public static extern Vector256<uint> AddVector256Us(
        [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 1)] Vector256<uint>[] pValues,
        int count
    );
...
unsafe partial class GenericsTest
{
    private static void TestVector256U()
    {
        ...
        Assert.Throws<MarshalDirectiveException>(() =>
            GenericsNative.GetVector256UOut(
                1u,
                2u,
                3u,
                4u,
