...
unsafe partial class GenericsNative
{
    ...
    [DllImport(nameof(GenericsNative))]
    public static extern void GetVector128FOut(
        float e00,
        float e01,
        float e02,
        float e03,
    ...
    public static extern void GetVector128FOut(
        ...
        float e02,
        float e03,
        out Vector128<float> value
    );

    [DllImport(nameof(GenericsNative))]
    public static extern Vector128<float>* GetVector128FPtr(
        float e00,
        float e01,
        float e02,
        float e03
    ...
    public static extern ref readonly Vector128<float> GetVector128FRef(
        float e00,
        float e01,
        float e02,
        float e03
    ...
    [DllImport(nameof(GenericsNative))]
    public static extern Vector128<float> AddVector128Fs(
        [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 1)] Vector128<float>[] pValues,
        int count
    );
