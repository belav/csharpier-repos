...
unsafe partial class GenericsNative
{
    ...
    public static extern Vector256<float> GetVector256F(
        float e00,
        float e01,
        float e02,
        float e03,
    ...
    [DllImport(nameof(GenericsNative))]
    public static extern void GetVector256FOut(
        float e00,
        float e01,
        float e02,
        float e03,
    ...
    public static extern void GetVector256FOut(
        ...
        float e06,
        float e07,
        out Vector256<float> value
    );

    [DllImport(nameof(GenericsNative))]
    public static extern Vector256<float>* GetVector256FPtr(
        float e00,
        float e01,
        float e02,
        float e03,
    ...
    public static extern ref readonly Vector256<float> GetVector256FRef(
        float e00,
        float e01,
        float e02,
        float e03,
    ...
    [DllImport(nameof(GenericsNative))]
    public static extern Vector256<float> AddVector256Fs(
        [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 1)] Vector256<float>[] pValues,
        int count
    );
...
unsafe partial class GenericsTest
{
    private static void TestVector256F()
    {
        Assert.Throws<MarshalDirectiveException>(() =>
            GenericsNative.GetVector256F(1.0f, 2.0f, 3.0f, 4.0f, 5.0f, 6.0f, 7.0f, 8.0f)
        );
        ...
        Assert.Throws<MarshalDirectiveException>(() =>
            GenericsNative.GetVector256FOut(
                1.0f,
                2.0f,
                3.0f,
                4.0f,
                ...
                7.0f,
                8.0f,
                out Vector256<float> value3
            )
        );

        Vector256<float>* value4 = GenericsNative.GetVector256FPtr(
            1.0f,
            2.0f,
            3.0f,
            4.0f,
        ...
        Assert.Throws<MarshalDirectiveException>(() =>
            GenericsNative.GetVector256FRef(1.0f, 2.0f, 3.0f, 4.0f, 5.0f, 6.0f, 7.0f, 8.0f)
        );

        Assert.Throws<MarshalDirectiveException>(() =>
            GenericsNative.AddVector256F(default, default)
        );
        ...
        Assert.Throws<MarshalDirectiveException>(() =>
            GenericsNative.AddVector256Fs(values, values.Length)
        );

        Assert.Throws<MarshalDirectiveException>(() =>
            GenericsNative.AddVector256Fs(in values[0], values.Length)
        );
    }
}
