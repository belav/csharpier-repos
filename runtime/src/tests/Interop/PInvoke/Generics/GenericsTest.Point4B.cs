...
unsafe partial class GenericsNative
{
    ...
    [DllImport(nameof(GenericsNative))]
    public static extern void GetPoint4BOut(
        bool e00,
        bool e01,
        bool e02,
        bool e03,
        out Point4<bool> value
    );

    [DllImport(nameof(GenericsNative), EntryPoint = "GetPoint4BPtr")]
    public static extern ref readonly Point4<bool> GetPoint4BRef(
        bool e00,
        bool e01,
        bool e02,
        bool e03
    ...
    [DllImport(nameof(GenericsNative))]
    public static extern Point4<bool> AddPoint4Bs(
        [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 1)] Point4<bool>[] pValues,
        int count
    );
