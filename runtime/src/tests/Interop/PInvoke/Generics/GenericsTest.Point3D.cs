...
unsafe partial class GenericsNative
{
    ...
    [DllImport(nameof(GenericsNative))]
    public static extern void GetPoint3DOut(
        double e00,
        double e01,
        double e02,
        Point3<double>* value
    ...
    public static extern ref readonly Point3<double> GetPoint3DRef(
        double e00,
        double e01,
        double e02
    );
    ...
    [DllImport(nameof(GenericsNative))]
    public static extern Point3<double> AddPoint3Ds(
        [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 1)] Point3<double>[] pValues,
        int count
    );
...
unsafe partial class GenericsTest
{
    private static void TestPoint3D()
    {
        ...
        ref readonly GenericsNative.Point3<double> value5 = ref GenericsNative.GetPoint3DRef(
            1.0,
            2.0,
            3.0
        );
        ...
        {
            GenericsNative.Point3<double> result2 = GenericsNative.AddPoint3Ds(
                pValues,
                values.Length
            );
        ...
        GenericsNative.Point3<double> result4 = GenericsNative.AddPoint3Ds(
            in values[0],
            values.Length
        );
