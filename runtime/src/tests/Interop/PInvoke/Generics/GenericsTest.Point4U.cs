...
unsafe partial class GenericsNative
{
    ...
    [DllImport(nameof(GenericsNative))]
    public static extern void GetPoint4UOut(
        uint e00,
        uint e01,
        uint e02,
        uint e03,
    ...
    public static extern ref readonly Point4<uint> GetPoint4URef(
        uint e00,
        uint e01,
        uint e02,
        uint e03
    ...
    [DllImport(nameof(GenericsNative))]
    public static extern Point4<uint> AddPoint4Us(
        [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 1)] Point4<uint>[] pValues,
        int count
    );
...
unsafe partial class GenericsTest
{
    private static void TestPoint4U()
    {
        ...
        ref readonly GenericsNative.Point4<uint> value5 = ref GenericsNative.GetPoint4URef(
            1u,
            2u,
            3u,
            4u
        ...
        {
            GenericsNative.Point4<uint> result2 = GenericsNative.AddPoint4Us(
                pValues,
                values.Length
            );
        ...
        GenericsNative.Point4<uint> result4 = GenericsNative.AddPoint4Us(
            in values[0],
            values.Length
        );
