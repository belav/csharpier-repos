...
unsafe partial class GenericsNative
{
    ...
    public static extern Vector256<double> GetVector256D(
        double e00,
        double e01,
        double e02,
        double e03
    ...
    [DllImport(nameof(GenericsNative))]
    public static extern void GetVector256DOut(
        double e00,
        double e01,
        double e02,
        double e03,
    ...
    public static extern void GetVector256DOut(
        ...
        double e02,
        double e03,
        out Vector256<double> value
    );

    [DllImport(nameof(GenericsNative))]
    public static extern Vector256<double>* GetVector256DPtr(
        double e00,
        double e01,
        double e02,
        double e03
    ...
    public static extern ref readonly Vector256<double> GetVector256DRef(
        double e00,
        double e01,
        double e02,
        double e03
    ...
    [DllImport(nameof(GenericsNative))]
    public static extern Vector256<double> AddVector256D(
        Vector256<double> lhs,
        Vector256<double> rhs
    );
    ...
    [DllImport(nameof(GenericsNative))]
    public static extern Vector256<double> AddVector256Ds(
        [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 1)] Vector256<double>[] pValues,
        int count
    );
...
unsafe partial class GenericsTest
{
    private static void TestVector256D()
    {
        Assert.Throws<MarshalDirectiveException>(() =>
            GenericsNative.GetVector256D(1.0, 2.0, 3.0, 4.0)
        );
        ...
        Assert.Throws<MarshalDirectiveException>(() =>
            GenericsNative.GetVector256DOut(1.0, 2.0, 3.0, 4.0, out Vector256<double> value3)
        );
        ...
        Assert.Throws<MarshalDirectiveException>(() =>
            GenericsNative.GetVector256DRef(1.0, 2.0, 3.0, 4.0)
        );

        Assert.Throws<MarshalDirectiveException>(() =>
            GenericsNative.AddVector256D(default, default)
        );
        ...
        Assert.Throws<MarshalDirectiveException>(() =>
            GenericsNative.AddVector256Ds(in values[0], values.Length)
        );
    }
}
