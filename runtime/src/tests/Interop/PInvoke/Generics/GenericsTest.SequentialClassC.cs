...
unsafe partial class GenericsNative
{
    ...
    [DllImport(nameof(GenericsNative))]
    public static extern SequentialClass<char> AddSequentialClassC(
        SequentialClass<char> lhs,
        SequentialClass<char> rhs
    );

    [DllImport(nameof(GenericsNative))]
    public static extern SequentialClass<char> AddSequentialClassCs(
        [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 1)] SequentialClass<char>[] pValues,
        int count
    );

    [DllImport(nameof(GenericsNative))]
    public static extern SequentialClass<char> AddSequentialClassCs(
        in SequentialClass<char> pValues,
        int count
    );
}
