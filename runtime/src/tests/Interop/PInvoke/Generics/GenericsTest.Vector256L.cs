...
unsafe partial class GenericsNative
{
    ...
    [DllImport(nameof(GenericsNative))]
    public static extern void GetVector256LOut(
        long e00,
        long e01,
        long e02,
        long e03,
    ...
    public static extern ref readonly Vector256<long> GetVector256LRef(
        long e00,
        long e01,
        long e02,
        long e03
    ...
    [DllImport(nameof(GenericsNative))]
    public static extern Vector256<long> AddVector256Ls(
        [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 1)] Vector256<long>[] pValues,
        int count
    );
...
unsafe partial class GenericsTest
{
    private static void TestVector256L()
    {
        ...
        Assert.Throws<MarshalDirectiveException>(() =>
            GenericsNative.GetVector256LOut(1L, 2L, 3L, 4L, out Vector256<long> value3)
        );
        ...
        Assert.Throws<MarshalDirectiveException>(() =>
            GenericsNative.GetVector256LRef(1L, 2L, 3L, 4L)
        );

        Assert.Throws<MarshalDirectiveException>(() =>
            GenericsNative.AddVector256L(default, default)
        );
        ...
        Assert.Throws<MarshalDirectiveException>(() =>
            GenericsNative.AddVector256Ls(values, values.Length)
        );

        Assert.Throws<MarshalDirectiveException>(() =>
            GenericsNative.AddVector256Ls(in values[0], values.Length)
        );
    }
}
