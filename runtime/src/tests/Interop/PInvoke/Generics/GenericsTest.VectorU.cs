...
unsafe partial class GenericsNative
{
    ...
    [DllImport(nameof(GenericsNative))]
    public static extern Vector<uint> GetVectorU256(
        uint e00,
        uint e01,
        uint e02,
        uint e03,
    ...
    [DllImport(nameof(GenericsNative))]
    public static extern void GetVectorU128Out(
        uint e00,
        uint e01,
        uint e02,
        uint e03,
    ...
    [DllImport(nameof(GenericsNative))]
    public static extern void GetVectorU256Out(
        uint e00,
        uint e01,
        uint e02,
        uint e03,
    ...
    [DllImport(nameof(GenericsNative))]
    public static extern Vector<uint>* GetVectorU256Ptr(
        uint e00,
        uint e01,
        uint e02,
        uint e03,
    ...
    public static extern ref readonly Vector<uint> GetVectorU128Ref(
        uint e00,
        uint e01,
        uint e02,
        uint e03
    ...
    public static extern ref readonly Vector<uint> GetVectorU256Ref(
        uint e00,
        uint e01,
        uint e02,
        uint e03,
    ...
    [DllImport(nameof(GenericsNative))]
    public static extern Vector<uint> AddVectorU128s(
        [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 1)] Vector<uint>[] pValues,
        int count
    );

    [DllImport(nameof(GenericsNative))]
    public static extern Vector<uint> AddVectorU256s(
        [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 1)] Vector<uint>[] pValues,
        int count
    );
