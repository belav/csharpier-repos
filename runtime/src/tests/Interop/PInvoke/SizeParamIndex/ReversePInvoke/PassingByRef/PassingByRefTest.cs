...
public class ReversePInvoke_MashalArrayByRef_AsManagedTest
{
    ...
    public static void RunTestByRef()
    {
        ...
        Console.WriteLine(
            "\tScenario 4 : short ==> SHORT, Array_Size = 10, Return_Array_Size = -1"
        );
        Assert.True(
        ...
        Console.WriteLine(
            "\tScenario 5 : ushort ==> USHORT, Array_Size = ushort.MaxValue, Return_Array_Size = 20"
        );
        Assert.True(
        ...
        Console.WriteLine(
            "\tScenario 7 : UInt32 ==> ULONG, Array_Size = 10, Return_Array_Size = 20"
        );
        Assert.True(
        ...
        Console.WriteLine(
            "\tScenario 8 : long ==> LONGLONG, Array_Size = 10, Return_Array_Size = 20"
        );
        Assert.True(
        ...
        Console.WriteLine(
            "\tScenario 9 : ulong ==> ULONGLONG, Array_Size = 10, Return_Array_Size = 20"
        );
        Assert.True(
