...
public class ClientMarshalArrayAsSizeParamIndexByRefTest
{
    ...
    private static extern bool MarshalCStyleArrayByte_AsByRef_AsSizeParamIndex(
        ref byte arrSize,
        [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 0)] ref byte[] arrByte
    );

    [DllImport("PInvokePassingByRefNative")]
    private static extern bool MarshalCStyleArraySbyte_AsByRef_AsSizeParamIndex(
        ref sbyte arrSize,
        [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 0)] ref sbyte[] arrSbyte
    );

    [DllImport("PInvokePassingByRefNative")]
    private static extern bool MarshalCStyleArrayShort_AsByRef_AsSizeParamIndex(
        ref short arrSize,
        [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 0)] ref short[] arrShort
    );
    ...
    private static extern bool MarshalCStyleArrayUshort_AsByRef_AsSizeParamIndex(
        [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 1)] ref ushort[] arrUshort,
        ref ushort arrSize
    );
    ...
    private static extern bool MarshalCStyleArrayInt_AsByRef_AsSizeParamIndex(
        ref Int32 arrSize,
        Int32 unused,
        [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 0)] ref Int32[] arrInt32
    );

    [DllImport("PInvokePassingByRefNative")]
    private static extern bool MarshalCStyleArrayUInt_AsByRef_AsSizeParamIndex(
        [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 2)] ref UInt32[] arrUInt32,
        UInt32 unused,
        ref UInt32 arrSize
    );
    ...
    private static extern bool MarshalCStyleArrayLong_AsByRef_AsSizeParamIndex(
        ref long arrSize,
        [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 0)] ref long[] arrLong
    );

    [DllImport("PInvokePassingByRefNative")]
    private static extern bool MarshalCStyleArrayUlong_AsByRef_AsSizeParamIndex(
        ref ulong arrSize,
        [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 0)] ref ulong[] arrUlong
    );

    [DllImport("PInvokePassingByRefNative")]
    private static extern bool MarshalCStyleArrayString_AsByRef_AsSizeParamIndex(
        ref int arrSize,
        [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 0, ArraySubType = UnmanagedType.BStr)]
            ref string[] arrStr,
    ...
    static void SizeParamTypeIsByte()
    {
        string strDescription =
            "Scenario(byte==>BYTE):Array_Size(M->N)=1,Array_Size(N->M)= byte.MinValue";
        Console.WriteLine();
        ...
        Assert.True(
            MarshalCStyleArrayByte_AsByRef_AsSizeParamIndex(ref byte_Array_Size, ref arrByte)
        );
    ...
    {
        string strDescription =
            "Scenario(sbyte==>CHAR): Array_Size(M->N) = 10, Array_Size(N->M) = sbyte.Max";
        Console.WriteLine();
        Console.WriteLine(strDescription + " Starts!");
        ...
        Assert.True(
            MarshalCStyleArraySbyte_AsByRef_AsSizeParamIndex(ref sbyte_Array_Size, ref arrSbyte)
        );
    ...
    {
        string strDescription =
            "Scenario(short==>SHORT)1: Array_Size(M->N) = -1, Array_Size(N->M) = 20";
        Console.WriteLine();
        Console.WriteLine(strDescription + " Starts!");
        ...
        Assert.True(
            MarshalCStyleArrayShort_AsByRef_AsSizeParamIndex(ref short_Array_Size, ref arrShort)
        );
        ...
        Assert.True(
            Helper.EqualArray<short>(
                arrShort,
                (int)short_Array_Size,
                expectedArrShort,
                expectedArrShort.Length
            )
        );
    ...
    {
        string strDescription =
            "Scenario(short==>SHORT)2: Array_Size(M->N) = 10, Array_Size(N->M) = -1";
        Console.WriteLine();
        Console.WriteLine(strDescription + " Starts!");
    ...
    {
        string strDescription =
            "Scenario(ushort==>USHORT): Array_Size(M->N) = 0, Array_Size(N->M) = ushort.MaxValue";
        Console.WriteLine();
        Console.WriteLine(strDescription + " Starts!");
        ...
        Assert.True(
            MarshalCStyleArrayUshort_AsByRef_AsSizeParamIndex(ref arrUshort, ref ushort_Array_Size)
        );
    ...
    static void SizeParamTypeIsInt32()
    {
        ...
        Assert.True(
            MarshalCStyleArrayInt_AsByRef_AsSizeParamIndex(
                ref Int32_Array_Size,
                Int32.MaxValue,
                ref arrInt32
            )
        );
    ...
    {
        string strDescription =
            "Scenario(UInt32==>ULONG):Array_Size(M->N)=1234,Array_Size(N->M)=4321";
        Console.WriteLine();
        Console.WriteLine(strDescription + " Starts!");
        ...
        Assert.True(
            MarshalCStyleArrayUInt_AsByRef_AsSizeParamIndex(
                ref arrUInt32,
                1234,
                ref UInt32_Array_Size
            )
        );
    ...
    static void SizeParamTypeIsLong()
    {
        ...
        Assert.True(
            MarshalCStyleArrayLong_AsByRef_AsSizeParamIndex(ref long_Array_Size, ref arrLong)
        );
    ...
    {
        string strDescription =
            "Scenario(ulong==>ULONGLONG):Array_Size(M->N)=0, Array_Size(N->M)=0";
        Console.WriteLine();
        Console.WriteLine(strDescription + " Starts!");
        ...
        Assert.True(
            MarshalCStyleArrayUlong_AsByRef_AsSizeParamIndex(ref ulong_Array_Size, ref arrUlong)
        );
    ...
    static void SizeParamTypeIsString()
    {
        ...
        Assert.True(
            MarshalCStyleArrayString_AsByRef_AsSizeParamIndex(
                ref array_Size,
                ref arrString,
                ref arrString2
            )
        ...
        Assert.True(
            Helper.EqualArray<String>(arrString, array_Size, expArrString, expArrString.Length)
        );
