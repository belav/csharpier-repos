...
public class ClientMarshalArrayAsSizeParamIndexByRefTest
{
    ...
    static void SizeParamTypeIsByte()
    {
        string strDescription =
            "Scenario(byte==>uint8_t):Array_Size(M->N)=1,Array_Size(N->M)= byte.MinValue";
        Console.WriteLine();
    ...
    {
        string strDescription =
            "Scenario(short==>int16_t)1: Array_Size(M->N) = -1, Array_Size(N->M) = 20";
        Console.WriteLine();
        Console.WriteLine(strDescription + " Starts!");
    ...
    {
        string strDescription =
            "Scenario(short==>int16_t)2: Array_Size(M->N) = 10, Array_Size(N->M) = -1";
        Console.WriteLine();
        Console.WriteLine(strDescription + " Starts!");
    ...
    {
        string strDescription =
            "Scenario(ushort==>uint16_t): Array_Size(M->N) = 0, Array_Size(N->M) = ushort.MaxValue";
        Console.WriteLine();
        Console.WriteLine(strDescription + " Starts!");
    ...
    {
        string strDescription =
            "Scenario(UInt32==>uint32_t):Array_Size(M->N)=1234,Array_Size(N->M)=4321";
        Console.WriteLine();
        Console.WriteLine(strDescription + " Starts!");
