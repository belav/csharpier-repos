...
public class Helper
{
    ...
    public static bool EqualArray<T>(
        T[] actualArray,
        int actualSize,
        T[] expectedArray,
        int expectedSize
    )
    {
        ...
        {
            Console.WriteLine(
                "\tTwo array are not equal.The sourcArr is null,but the expectedArray is not null"
            );
            return false;
        }
        else if (actualArray != null && expectedArray == null)
        {
            Console.WriteLine(
                "\tTwo array are not equal.The sourcArr is not null but the expectedArray is null"
            );
            return false;
        }
        ...
        {
            Console.WriteLine(
                "\tTwo array are not equal.The sizes are not equal. Expected: {0}, Actual: {1}",
                expectedSize,
                actualSize
            );
            return false;
        ...
        for (int i = 0; i < expectedSize; ++i)
        {
            if (!actualArray[i].Equals(expectedArray[i]))
            {
                ...
                Console.WriteLine(
                    "\t\tThe actualArray is {0},the expectedArray is {1}",
