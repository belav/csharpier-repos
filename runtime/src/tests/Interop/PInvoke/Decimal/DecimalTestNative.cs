...
static class DecimalTestNative
{
    ...
    [DllImport(nameof(DecimalTestNative))]
    public static extern bool LPDecimalEqualToInt(
        [MarshalAs(UnmanagedType.LPStruct)] decimal dec,
        int i
    );
    ...
    [DllImport(nameof(DecimalTestNative))]
    public static extern bool ValidateAndChangeWrappedDecimal(
        ref DecimalWrapper dec,
        int expected,
        int newValue
    );

    [DllImport(nameof(DecimalTestNative))]
    public static extern bool ValidateAndChangeLPDecimal(
        [MarshalAs(UnmanagedType.LPStruct)] ref decimal dec,
        int expected,
        int newValue
    );
    ...
    [DllImport(nameof(DecimalTestNative))]
    public static extern void GetLPDecimalForInt(
        int i,
        [MarshalAs(UnmanagedType.LPStruct)] out decimal dec
    );
    ...
    [DllImport(nameof(DecimalTestNative))]
    public static extern bool CurrencyEqualToInt(
        [MarshalAs(UnmanagedType.Currency)] decimal currency,
        int i
    );
    ...
    [DllImport(nameof(DecimalTestNative))]
    public static extern bool ValidateAndChangeCurrency(
        [MarshalAs(UnmanagedType.Currency)] ref decimal currency,
        int expected,
        int newValue
    );

    [DllImport(nameof(DecimalTestNative))]
    public static extern bool ValidateAndChangeWrappedCurrency(
        ref CurrencyWrapper currency,
        int expected,
        int newValue
    );

    [DllImport(nameof(DecimalTestNative))]
    public static extern void GetCurrencyForInt(
        int i,
        [MarshalAs(UnmanagedType.Currency)] out decimal currency
    );
    ...
    [DllImport(nameof(DecimalTestNative))]
    public static extern void PassThroughLPDecimalToCallback(
        [MarshalAs(UnmanagedType.LPStruct)] decimal dec,
        LPDecimalCallback callback
    );

    [DllImport(nameof(DecimalTestNative))]
    public static extern void PassThroughCurrencyToCallback(
        [MarshalAs(UnmanagedType.Currency)] decimal dec,
        CurrencyCallback callback
    );
}
