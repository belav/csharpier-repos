...
public class DecimalTest
{
    ...
    private static void RunDecimalTests()
    {
        ...
        DecimalTestNative.PassThroughDecimalToCallback(
            (decimal)NewIntValue,
            d => Assert.AreEqual((decimal)NewIntValue, d)
        );
    }
    ...
    private static void RunLPDecimalTests()
    {
        ...
        DecimalTestNative.PassThroughLPDecimalToCallback(
            (decimal)NewIntValue,
            d => Assert.AreEqual((decimal)NewIntValue, d)
        );
    }
    ...
    private static void RunCurrencyTests()
    {
        ...
        DecimalTestNative.PassThroughCurrencyToCallback(
            (decimal)NewIntValue,
            d => Assert.AreEqual((decimal)NewIntValue, d)
        );
    }
