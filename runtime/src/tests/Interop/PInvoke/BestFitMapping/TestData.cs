...
public static class TestData
{
    ...
    public static readonly string InvalidString = new string(
        new char[] { (char)0x2216, (char)0x2044, (char)0x2215, (char)0x0589, (char)0x2236 }
    );
    public static readonly string UnmappableString = new string(
        new char[] { '\u4E40', '\u2126', '\u706B' }
    );
    ...
    public static readonly StringBuilder UnmappableStringBuilder = new StringBuilder(
        UnmappableString
    );
    public static readonly StringBuilder ValidStringBuilder = new StringBuilder(ValidString);

    public static readonly string[] InvalidStringArray = new string[]
    {
        InvalidString,
        InvalidString,
        InvalidString,
