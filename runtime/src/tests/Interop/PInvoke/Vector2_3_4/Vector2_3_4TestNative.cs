...
static class Vector2_3_4TestNative
{
    ...
    [DllImport(nameof(Vector2_3_4TestNative))]
    public static extern bool ValidateAndChangeVector2(
        ref Vector2 dec,
        float expectedX,
        float expectedY,
        float newX,
    ...
    public static extern bool ValidateAndChangeWrappedVector2(
        ref Vector2Wrapper dec,
        float expectedX,
        float expectedY,
        float newX,
        float newY
    ...
    [DllImport(nameof(Vector2_3_4TestNative))]
    public static extern Vector2 PassThroughVector2ToCallback(
