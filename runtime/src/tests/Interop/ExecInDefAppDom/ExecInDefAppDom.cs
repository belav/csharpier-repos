...
public class Program
{
    public static class NativeMethods
    {
        ...
        public static extern int CallExecuteInDefaultAppDomain(
    ...
    static int TestExecuteInAppDomain(
        string assemblyPath,
        string typeName,
        string methodName,
        string argument,
    ...
    )
    {
        ...
        {
            int result = 0;
            int hresult = NativeMethods.CallExecuteInDefaultAppDomain(
                assemblyPath,
                typeName,
                methodName,
                argument,
