...
public struct S : I
{
    ...
    public S(int i)
    {
        ...
        f8 = 0;
        f9 = 0;
        f10 = 0; //@BUGBUG - It puzzles me to no end why there is a compiler error if I don't initialize these in the constructor
        value = i;
    }
...
public class RefInst
{ //Instance methods on a reference class
...
{ //Static methods on a reference class
    //The out parameters are a crude tag to verify which method
    //was actually called.  Necessary because the other functionality
    //of the methods is pretty much identical
