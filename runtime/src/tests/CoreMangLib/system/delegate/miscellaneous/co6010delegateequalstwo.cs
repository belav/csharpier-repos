...
public class TestClass
{
    ...
    public static int TestEntryPoint()
    {
        ...
        int iTestCount = 0;
        {
            iTestCount++;
            Console.WriteLine(
                "test1: delegates point to different static method with same signature"
            );
            ...
            {
                Console.WriteLine(
                    "Err_101: delegates point to different static method with same signature should not equals"
                );
                iErrorCount++;
            }
        }

        {
            iTestCount++;
            Console.WriteLine(
                "test2: delegates point to static method with same name but in different classes "
            );
            Void_VoidDelegate sdg1 = new Void_VoidDelegate(staticMethVoid_Void1);
            ...
            {
                Console.WriteLine(
                    "Err_202: delegates point to static method with same name but in different classes should not equals"
                );
                iErrorCount++;
            }
        }

        {
            iTestCount++;
            Console.WriteLine(
                "test3: delegates point to static method with same name but in different nested classes "
            );
            Void_VoidDelegate sdg1 = new Void_VoidDelegate(
                Foo_Globİı.NestFoo_Globİı.staticMethVoid_Void1
            );
            Void_VoidDelegate sdg2 = new Void_VoidDelegate(Foo_Globİı.staticMethVoid_Void1);
            if (sdg1.Equals(sdg2))
            {
                Console.WriteLine(
                    "Err_301: delegates point to static method with same name but in different nested classes should not equals"
                );
                iErrorCount++;
            }
        }

        {
            iTestCount++;
            Console.WriteLine(
                "test3.1: delegates point to same static method in same nested classes "
            );
            Void_VoidDelegate sdg1 = new Void_VoidDelegate(
                Foo_Globİı.NestFoo_Globİı.staticMethVoid_Void1
            );
            Void_VoidDelegate sdg2 = new Void_VoidDelegate(
                Foo_Globİı.NestFoo_Globİı.staticMethVoid_Void1
            );
            if (!sdg1.Equals(sdg2))
            {
                Console.WriteLine(
                    "Err_302: delegates point to same static method in same nested classes should equals"
                );
                iErrorCount++;
            }
        }

        {
            iTestCount++;
            Console.WriteLine(
                "test4: delegates point to static method with same name but one is newslot function in derived class "
            );
            ...
            {
                Console.WriteLine(
                    "Err_401: delegates point to static method with same name but one is newslot function in derived class should not equals"
                );
                iErrorCount++;
            }
        }

        {
            iTestCount++;
            Console.WriteLine(
                "test5: delegates point to same static method, DFoo2 drives from Foo"
            );
            Void_VoidDelegate sdg1 = new Void_VoidDelegate(Foo_Globİı.staticMethVoid_Void1);
            ...
            {
                Console.WriteLine(
                    "Err_501: delegates point to same static method, DFoo2 drives from Foo_Globİı. should equals"
                );
                iErrorCount++;
            }
        }

        {
            iTestCount++;
            Console.WriteLine(
                "test6: delegates point to static method with same name in Foo_Globİı.NestFoo_Globİı and DFoo1.NestFoo_Globİı "
            );
            Void_VoidDelegate sdg1 = new Void_VoidDelegate(
                Foo_Globİı.NestFoo_Globİı.staticMethVoid_Void1
            );
            Void_VoidDelegate sdg2 = new Void_VoidDelegate(
                DFoo1.NestFoo_Globİı.staticMethVoid_Void1
            );
            if (sdg1.Equals(sdg2))
            {
                Console.WriteLine(
                    "Err_601: delegates point to static method with same name in Foo_Globİı.NestFoo_Globİı and DFoo1.NestFoo_Globİı should not equals"
                );
                iErrorCount++;
            }
        }

        {
            iTestCount++;
            Console.WriteLine(
                "test6.1: delegates point to same static method in Foo_Globİı.NestFoo_Globİı and DFoo2.NestFoo_Globİı "
            );
            Void_VoidDelegate sdg1 = new Void_VoidDelegate(
                Foo_Globİı.NestFoo_Globİı.staticMethVoid_Void1
            );
            Void_VoidDelegate sdg2 = new Void_VoidDelegate(
                DFoo2.NestFoo_Globİı.staticMethVoid_Void1
            );
            if (!sdg1.Equals(sdg2))
            {
                Console.WriteLine(
                    "Err_602: delegates point to same static method in Foo_Globİı.NestFoo_Globİı and DFoo2.NestFoo_Globİı should equals"
                );
                iErrorCount++;
            }
        }

        {
            iTestCount++;
            Console.WriteLine(
                "test7: delegates point to different instance method with same signature"
            );
            ...
            {
                Console.WriteLine(
                    "Err_701: delegates point to different instance method with same signature should not equals"
                );
                iErrorCount++;
            }
        }

        {
            iTestCount++;
            Console.WriteLine(
                "test8: delegates point to same instance method on different objects"
            );
            TestClass obj1 = new TestClass();
            ...
            {
                Console.WriteLine(
                    "Err_101: delegates point to same instance method on different objects should not equals"
                );
                iErrorCount++;
            }
        }
        {
            iTestCount++;
            Console.WriteLine(
                "test9: delegates point to instance method with same name but in different classes "
            );
            TestClass obj1 = new TestClass();
            ...
            {
                Console.WriteLine(
                    "Err_902: delegates point to instance method with same name but in different classes should not equals"
                );
                iErrorCount++;
            }
        }

        {
            iTestCount++;
            Console.WriteLine(
                "test10: delegates point to instance method with same name but in different nested classes "
            );
            ...
            {
                Console.WriteLine(
                    "Err_1001: delegates point to instance method with same name but in different nested classes should not equals"
                );
                iErrorCount++;
            }
        }

        {
            iTestCount++;
            Console.WriteLine(
                "test11: delegates point to instance method with same name but in different nested classes "
            );
            ...
            {
                Console.WriteLine(
                    "Err_1101: delegates point to instance method with same name but in same nested classes should equals"
                );
                iErrorCount++;
            }
        }

        {
            iTestCount++;
            Console.WriteLine(
                "test12: delegates point to instance method with same name but one is newslot function in derived class "
            );
            Foo_Globİı obj1 = new Foo_Globİı();
            ...
            {
                Console.WriteLine(
                    "Err_1201: delegates point to instance method with same name but one is newslot function in derived class should not equals"
                );
                iErrorCount++;
            }
        }

        {
            iTestCount++;
            Console.WriteLine(
                "test13: delegates point to same instance method of DFoo2, DFoo2 drives from Foo"
            );
            ...
            {
                Console.WriteLine(
                    "Err_1301: delegates point to same instance method, DFoo2 drives from Foo_Globİı. should equals"
                );
                iErrorCount++;
            }
        }

        {
            iTestCount++;
            Console.WriteLine(
                "test14: delegates point to same instance method on instance of DFoo2 and Foo_Globİı. DFoo2 drives from Foo"
            );
            Foo_Globİı obj1 = new Foo_Globİı();
            DFoo2 obj2 = new DFoo2();
            Void_VoidDelegate sdg1 = new Void_VoidDelegate(obj1.instanceMethVoid_Void1);
            ...
            {
                Console.WriteLine(
                    "Err_1401: delegates point to same instance method on instance of DFoo2 and Foo_Globİı. DFoo2 drives from Foo_Globİı. should not equals"
                );
                iErrorCount++;
            }
        }

        {
            iTestCount++;
            Console.WriteLine(
                "test15: delegates point to instance method with same name in Foo_Globİı.NestFoo_Globİı and DFoo1.NestFoo_Globİı "
            );
            Foo_Globİı.NestFoo_Globİı obj1 = new Foo_Globİı.NestFoo_Globİı();
            ...
            {
                Console.WriteLine(
                    "Err_1501: delegates point to instance method with same name in Foo_Globİı.NestFoo_Globİı and DFoo1.NestFoo_Globİı should not equals"
                );
                iErrorCount++;
            }
        }

        {
            iTestCount++;
            Console.WriteLine(
                "test16: delegates point to instance method should not equals to the one point to static method "
            );
            Foo_Globİı obj1 = new Foo_Globİı();
            Void_VoidDelegate sdg1 = new Void_VoidDelegate(obj1.instanceMethVoid_Void1);
            Void_VoidDelegate sdg2 = new Void_VoidDelegate(Foo_Globİı.staticMethVoid_Void1);
            ...
            {
                Console.WriteLine(
                    "Err_1601: delegates point to instance method should not equals to the one point to static method"
                );
                iErrorCount++;
            }
        }
