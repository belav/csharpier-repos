    ...
    public static int Main(string[] args)
    {
        ...
        try
        {
...

            {
                ...
                {
                    Console.WriteLine(
                        "Err_001 : should be equal, but one is :" + ihc1 + " other one is " + ihc2
                    );
                    iErrorCount++;
                }
            }

            {
                ...
                {
                    Console.WriteLine(
                        "Err_002 : should be equal, but one is :" + ihc1 + " other one is " + ihc2
                    );
                    iErrorCount++;
                }
            }
        ...
        {
            Console.WriteLine(
                "Total tests count" + iTestCount + " . Failed tests count" + iErrorCount
            );
            iExitCode = 101;
        }
        else
