    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            try
            {
                ...
                if (s_dotnetExe == null)
                {
                    ...
                    {
                        Console.WriteLine(
                            $"** Using core libraries found at {options.CoreLibariesDirectory}"
                        );
        ...
        private sealed class SoDBenchOptions
        {
            ...
            [Option(
                "corelibs",
                Required = false,
                HelpText = "Specifies the location of .NET Core libaries to patch into dotnet. Cannot be used with --dotnet"
            )]
