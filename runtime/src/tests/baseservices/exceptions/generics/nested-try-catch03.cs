    ...
    public void InternalExceptionTest(bool throwException)
    {
        ...
        try
        {
            try
            {
                ...
                if (throwException)
                {
                    Test_nested_try_catch03.Eval(false);
                }
            }
            catch (Exception E)
            {
                Test_nested_try_catch03.Eval(E is GenException<T>);
                throw;
            }
        }
        catch (Exception E)
        ...
        Test_nested_try_catch03.Eval(set);
    }
...
public class Test_nested_try_catch03
{
