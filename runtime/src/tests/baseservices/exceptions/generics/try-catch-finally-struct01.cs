...
public struct Gen<T>
{
    public void InternalExceptionTest(bool throwException)
    {
        ...
        try
        {
            ...
            if (throwException)
            {
                Test_try_catch_finally_struct01.Eval(false);
            }
        }
        catch (Exception E)
        {
            set = true;
            Test_try_catch_finally_struct01.Eval(E is GenException<T>);
        }
        finally
        {
            Test_try_catch_finally_struct01.Eval(set);
        }
    }
...
public class Test_try_catch_finally_struct01
{
