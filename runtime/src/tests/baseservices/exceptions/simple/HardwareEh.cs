...
public class HardwareEh
{
    ...
    public bool PosTest12()
    {
        return ExceptionTest(
            12,
            "IndexOutOfRange (single dim [less than])",
    ...
    public bool PosTest13()
    {
        return ExceptionTest(
            13,
            "IndexOutOfRange (single dim [greater than])",
            typeof(IndexOutOfRangeException),
            delegate()
            {
                int[] arr = new int[10];
    ...
    public bool PosTest14()
    {
        return ExceptionTest(
            14,
            "IndexOutOfRange (multi dim [less than])",
            typeof(IndexOutOfRangeException),
            delegate()
            {
    ...
    public bool PosTest15()
    {
        return ExceptionTest(
            15,
            "IndexOutOfRange (multi dim [greater than])",
            typeof(IndexOutOfRangeException),
            delegate()
            {
                int[,] arr = new int[10, 10];
    ...
    public bool PosTest16()
    {
        return ExceptionTest(
            16,
            "IndexOutOfRange (jagged [less than])",
            typeof(IndexOutOfRangeException),
            delegate()
            {
                int[][] arr = new int[10][];
    ...
    public bool PosTest17()
    {
        return ExceptionTest(
            17,
            "IndexOutOfRange (jagged [greater than])",
            typeof(IndexOutOfRangeException),
            delegate()
            {
                int[][] arr = new int[10][];
