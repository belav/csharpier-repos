    ...
    class Program
    {
        ...
        static bool TestStackOverflow(
            ...
            testProcess.StartInfo.Arguments =
                $"{Path.Combine(s_currentPath, "..", testName, $"{testName}.dll")} {testArgs}";
            ...
            {
                Console.WriteLine(
                    $"Exit code: 0x{testProcess.ExitCode:X8}, expected 0x{expectedExitCode:X8}"
                );
                return false;
            }
