    ...
    public static int TestEntryPoint()
    {
        ...
        try
        {
            ...
            throw new DllNotFoundException(
                "The DLL is unavailable, please try again later.",
                new Exception()
            );
        }
        catch (DllNotFoundException e)
        ...
        try
        {
            ...
            throw new DirectoryNotFoundException(
                "You've been had, the folder is gone.",
                new Exception()
            );
        }
        ...
        try
        {
            ...
            throw new InvalidProgramException(
                "This program is invalid, parental guidance is advised."
            );
        }
        catch (InvalidProgramException e)
        {
        ...
        try
        {
            ...
            throw new MissingManifestResourceException(
                "No deaders today but walkin' ones, looks like!",
                new Exception()
            );
        }
        ...
        try
        {
            ...
            throw new InvalidComObjectException(
                "At this altitude, it's IMPOSSIBLE!!",
                new Exception()
            );
        }
        ...
        try
        {
            ...
            throw new InvalidOleVariantTypeException(
                "It may be impossible but they did it!",
                new Exception()
            );
        }
        ...
        try
        {
            ...
            throw new SEHException(
                "A den of STINKIN' EVIL! Cover your nose Boo, we'll leave no crevice untouched!!",
                new Exception()
            );
        }
        catch (SEHException e)
        ...
        try
        {
            ...
            throw new SafeArrayTypeMismatchException(
                "Aww, we are all heroes, you and Boo and I, hamsters and rangers everywhere.. REJOICE!!",
                new Exception()
            );
        }
        ...
        try
        {
            ...
            throw new VerificationException(
                "Butts will be liberally kicked when I get out!!",
                new Exception()
            );
        }
