                    ...
                    public void runtest()
                    {
                        try
                        {
                            try
                            {
                                try
                                {
                                    try
                                    {
                                        ...
                                        {
                                            case 0:
                                                throw new UserException1(ThreadId);
                                            case 1:
                                    ...
                                    catch (UserException4 e)
                                    {
                                        ...
                                        {
                                            Console.WriteLine(
                                                "Exception4 was caught by Thread " + e.ExceptionId
                                            );
                                            throw;
                                        }
                                    }
                                ...
                                catch (UserException3 e)
                                {
                                    ...
                                    {
                                        Console.WriteLine(
                                            "Exception3 was caught by Thread " + e.ExceptionId
                                        );
                                        throw;
                                    }
                                }
                            ...
                            catch (UserException2 e)
                            {
                                ...
                                {
                                    Console.WriteLine(
                                        "Exception2 was caught by Thread " + e.ExceptionId
                                    );
                                    throw;
                                }
                            }
                        ...
                        catch (UserException1 e)
                        {
                            ...
                            {
                                Console.WriteLine(
                                    "Exception1 was caught by Thread " + e.ExceptionId
                                );
                            }
                        }
                        catch (Exception)
