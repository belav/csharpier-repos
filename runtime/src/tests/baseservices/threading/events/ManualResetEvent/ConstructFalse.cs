...
public class MRETestClass
{
    ...
    public int Run()
    {
        ...
        Console.WriteLine(
            "Expect WaitOne to return False and time-out after 1000 milliseconds waiting for signal."
        );
        ...
        Console.WriteLine(
            "Expect WaitOne to return True and time-out after 1000 milliseconds waiting for signal."
        );
        Console.WriteLine("Actual return is: " + ret.ToString());
        Console.WriteLine();
        if (!ret)
