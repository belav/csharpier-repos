...
class Gen<T>
{
    ...
    {
        ManualResetEvent[] evts = new ManualResetEvent[Test_thread06.nThreads];
        WaitHandle[] hdls = new WaitHandle[Test_thread06.nThreads];

        for (int i = 0; i < Test_thread06.nThreads; i++)
        {
