...
public class InterlockedCompareExchange4
{
    ...
    public bool PosTest1()
    {
        ...
        TestLibrary
            .TestFramework
            .BeginScenario(
                "PosTest1: Single Interlocked.CompareExchange(Single&,Single,Single) where comparand is equal"
            );
    ...
    public bool PosTest2()
    {
        ...
        TestLibrary
            .TestFramework
            .BeginScenario(
                "PosTest2: Single Interlocked.CompareExchange(Single&,Single,Single) where comparand are not equal"
            );
