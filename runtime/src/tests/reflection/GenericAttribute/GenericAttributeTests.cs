...
public class Program
{
    ...
    public static void TestEntryPoint()
    {
        ...
        Assert(
            CustomAttributeExtensions
                .GetCustomAttributes(assembly, typeof(SingleAttribute<>))
                .GetEnumerator()
                .MoveNext()
        );
        Assert(
        ...
        Assert(
            CustomAttributeExtensions.GetCustomAttribute<SingleAttribute<int>>(programTypeInfo)
                != null
        );
        Assert(
        ...
        Assert(
            CustomAttributeExtensions.GetCustomAttribute<SingleAttribute<int>>(propertyPropertyInfo)
                != null
        );
        Assert(
        ...
        Assert(
            CustomAttributeExtensions.GetCustomAttribute<SingleAttribute<int>>(
                deriveTypeInfo,
                false
            ) == null
        );
        ...
        Assert(
            CustomAttributeExtensions.GetCustomAttribute<SingleAttribute<int>>(deriveTypeInfo, true)
                != null
        );
        Assert(
            CustomAttributeExtensions.GetCustomAttribute<SingleAttribute<bool>>(
        ...
        Assert(
            CustomAttributeExtensions.IsDefined(deriveTypeInfo, typeof(SingleAttribute<int>), true)
        );
        Assert(
            ((ICustomAttributeProvider)deriveTypeInfo).IsDefined(typeof(SingleAttribute<int>), true)
        );
        Assert(
        ...
        var a4 = CustomAttributeExtensions.GetCustomAttributes<SingleAttribute<int>>(
            programTypeInfo,
            true
        );
        ...
        var a7 = CustomAttributeExtensions.GetCustomAttributes<MultiAttribute<bool>>(
            programTypeInfo,
            true
        );
        ...
        var a8 = CustomAttributeExtensions.GetCustomAttributes<MultiAttribute<bool?>>(
            programTypeInfo,
            true
        );
        ...
        var a10 = CustomAttributeExtensions.GetCustomAttributes<MultiAttribute<Type>>(
            programTypeInfo,
            true
        );
        ...
        Assert(
            CustomAttributeExtensions
                .GetCustomAttributes(programTypeInfo, typeof(MultiAttribute<>), false)
                .GetEnumerator()
                .MoveNext()
        );
        Assert(
            CustomAttributeExtensions
                .GetCustomAttributes(programTypeInfo, typeof(MultiAttribute<>), true)
                .GetEnumerator()
                .MoveNext()
        );
        Assert(
    ...
    static void AssertAny(
        IEnumerable<CustomAttributeData> source,
        Func<CustomAttributeData, bool> condition,
        int count = 1,
        [CallerLineNumberAttribute] int line = 0
    )
    {
