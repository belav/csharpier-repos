        ...
        )
        {
            ...
            if (IsNotUsingWorkloads)
            {
                ...
                File.Copy(
                    Path.Combine(
                        ...
                        "Blazor.Local.Directory.Build.props"
                    ),
                ...
                File.Copy(
                    Path.Combine(
                        BuildEnvironment.TestDataPath,
                        "Blazor.Local.Directory.Build.targets"
                    ),
            ...
            return new DotNetCommand(s_buildEnv)
                ...
                .ExecuteWithCapturedOutput(
                    ...
                    "-p:MSBuildEnableWorkloadResolver=true"
                ); // WasmApp.LocalBuild.* disables this, but it is needed for this test
        }
