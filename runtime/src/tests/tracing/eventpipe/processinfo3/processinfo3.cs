    ...
    public class ProcessInfoValidation
    {
        ...
        public static int Main()
        {
            ...
            Utils.Assert(
                ...
                $"Unexpected response version. Expected: {expectedVersion}, Received: {actualVersion}"
            );
            ...
            Logger.logger.Log(
                $"managedEntrypointAssemblyNameLength: {managedEntrypointAssemblyNameLength}"
            );
            ...
            string managedEntrypointAssemblyName = System.Text.Encoding.Unicode
                .GetString(response.Payload[start..end])
                .TrimEnd('\0');
            Logger.logger.Log(
            ...
            string expectedManagedEntrypointAssemblyName = System.Reflection.Assembly
                .GetExecutingAssembly()
                .GetName()
                .Name;

            Utils.Assert(
                expectedManagedEntrypointAssemblyName.Equals(managedEntrypointAssemblyName),
                $"ManagedEntrypointAssemblyName must match. Expected: \"{expectedManagedEntrypointAssemblyName}\", received: \"{managedEntrypointAssemblyName}\""
            );
            ...
            string clrProductVersion = System.Text.Encoding.Unicode
                .GetString(response.Payload[start..end])
                .TrimEnd('\0');
            ...
            Utils.Assert(
                ...
                $"ClrProductVersion must match. Expected: \"{expectedClrProductVersion}\", received: \"{clrProductVersion}\""
            );
            ...
            string portableRid = System.Text.Encoding.Unicode
                .GetString(response.Payload[start..end])
                .TrimEnd('\0');
            ...
            Utils.Assert(
                !string.IsNullOrEmpty(expectedPortableRidOs),
            ...
            Utils.Assert(
                expectedPortableRid.Equals(portableRid),
                $"PortableRid must match. Expected: \"{expectedPortableRid}\", received: \"{portableRid}\""
            );
