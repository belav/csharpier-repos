...
public class Program
{
    ...
    {
        int numFailures = 0;
        var foo = new StructAPITest<string>();
        foo._id = "ABC";
        Data d;
        d._a = 123;
        d._b = true;
        ...
        s_InstStr = "";
        numFailures += AssertEqual(
            ReturnsIntSmallParam.Invoke(foo, new object[] { (int)3434 }),
            3434
        );
        numFailures += AssertEqual(s_InstStr, "StructAPITest`1[System.String] - ABC");
        ...
        s_InstStr = "";
        numFailures += AssertEqual(
            ReturnsIntDoubleRegisterParam.Invoke(foo, new object[] { (long)5656 }),
            5656
        );
        numFailures += AssertEqual(s_InstStr, "StructAPITest`1[System.String] - ABC");
        ...
        d._c = 999;
        numFailures += AssertEqual(
            ReturnNeedBufferSmallParam.Invoke(foo, new object[] { (int)789 }),
            d
        );
        numFailures += AssertEqual(s_InstStr, "StructAPITest`1[System.String] - ABC");
