...
public class test86865
{
    ...
    public static int TestEntryPoint()
    {
        ...
        ReadOnlySpan<MyEnum> myEnums = new[] { MyEnum.A, MyEnum.B, MyEnum.C, MyEnum.B, MyEnum.C };
        ...
        var mi = typeof(System.Runtime.CompilerServices.RuntimeHelpers).GetMethod(
            "GetSpanDataFrom",
        ...
        var fi = pid.GetField(
            "0B77DC554B4A81403D62BE25FB5404020AD451151D4203D544BF60E3FEDBD8AE4",
            BindingFlags.Static | BindingFlags.NonPublic
        );
        if (fi == null)
        {
            Console.WriteLine(
                "Could not find the expected array data in <PrivateImplementationDetails>. The available static non-public fields are:"
            );
        ...
        var parms = new object[] { fi.FieldHandle, typeof(MyEnum).TypeHandle, new int() };
