...
public class Program
{
    ...
    private struct Breadth<T1, T2, T3, T4, T5, T6>
    {
        public static long TypeNestedFactorial(int count)
        {
            ...
            long result = 0;
            if (result < count)
                result = Breadth<T2, T3, T4, T5, T6, Oper1<T1>>.TypeNestedFactorial(count - 1);
            if (result < count)
                result = Breadth<T2, T3, T4, T5, T6, Oper2<T1>>.TypeNestedFactorial(count - 1);
            if (result < count)
                result = Breadth<T2, T3, T4, T5, T6, Oper3<T1>>.TypeNestedFactorial(count - 1);
            if (result < count)
                result = Breadth<T2, T3, T4, T5, T6, Oper4<T1>>.TypeNestedFactorial(count - 1);
            if (result < count)
                result = Breadth<T2, T3, T4, T5, T6, Oper5<T1>>.TypeNestedFactorial(count - 1);
            return count * result;
        }
    }
    ...
    public static void BreadthTest()
    {
        ...
        Assert.Equal(
            Factorial20,
            Breadth<byte, char, int, long, float, double>.TypeNestedFactorial(
                ReturnTwentyAndDontTellJIT()
            )
        );
    }
