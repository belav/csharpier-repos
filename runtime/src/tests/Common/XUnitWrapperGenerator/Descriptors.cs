...
{
    public static readonly DiagnosticDescriptor XUWG1001 = new DiagnosticDescriptor(
        "XUW1001",
    ...
    public static readonly DiagnosticDescriptor XUWG1002 = new DiagnosticDescriptor(
        "XUW1002",
    ...
    public static readonly DiagnosticDescriptor XUWG1003 = new DiagnosticDescriptor(
        "XUW1003",
    ...
    public static readonly DiagnosticDescriptor XUWG1004 = new DiagnosticDescriptor(
        "XUW1004",
