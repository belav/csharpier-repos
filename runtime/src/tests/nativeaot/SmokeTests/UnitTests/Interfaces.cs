...
public class Interfaces
{
    ...
    class TestSharedIntefaceMethods
    {
        ...
        public static void Run()
        {
            ...
            if (
                r1
                != "'My inner value' over 'Interfaces+TestSharedIntefaceMethods+Atom1' with 'The Atom1'"
            )
                throw new Exception();
            string r2 = ((IFace<Atom2>)x).GrabValue(new Atom2());
            if (
                r2
                != "'My inner value' over 'Interfaces+TestSharedIntefaceMethods+Atom2' with 'The Atom2'"
            )
                throw new Exception();
