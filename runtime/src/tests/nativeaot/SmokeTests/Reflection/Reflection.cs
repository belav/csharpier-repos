...
internal static class ReflectionTest
{
    ...
    class TestReflectionInvoke
    {
        ...
        public static unsafe void Run()
        {
...

            {
                ...
                result = (string)
                    MethodInvoker.Create(helloMethod).Invoke(null, new Span<object?>(ref arg));
                if (result != "Hello world")
                    throw new Exception();
            }

            {
                ...
                result = (string)
                    MethodInvoker
                        .Create(helloGenericMethod)
                        .Invoke(null, new Span<object?>(ref arg));
                if (result != "Hello 12345")
                    throw new Exception();
            }
...

            {
                ...
                resultNull = (string)
                    MethodInvoker.Create(helloPointerMethod).Invoke(null, arg1: null);
                if (resultNull != "Hello 0")
                    throw new Exception();
...

            {
                ...
                result = MethodInvoker
                    .Create(getPointerMethod)
                    .Invoke(null, new Span<object?>(args));
                if (Pointer.Unbox(result) != (void*)2018)
                    throw new Exception();
            }

            {
                ...
                string result = (string)
                    helloMethod.Invoke(new InvokeTestsGeneric<string>(), new object[] { arg });
                if (result != "Hello world System.String")
                    throw new Exception();

                result = (string)
                    MethodInvoker.Create(helloMethod).Invoke(new InvokeTestsGeneric<string>(), arg);
                if (result != "Hello world System.String")
                    throw new Exception();
                ...
                result = (string)
                    MethodInvoker
                        .Create(helloMethod)
                        .Invoke(new InvokeTestsGeneric<string>(), new Span<object?>(ref arg));
                if (result != "Hello world System.String")
                    throw new Exception();
            }

            {
                ...
                result = (string)
                    MethodInvoker
                        .Create(helloGenericMethod)
                        .Invoke(new InvokeTestsGeneric<string>(), arg);
                if (result != "Hello world System.Object")
                    throw new Exception();
...

            {
                ...
                string result = (string)
                    helloMethod.Invoke(new InvokeTestsGeneric<int>(), new object[] { arg });
                if (result != "Hello world System.Int32")
                    throw new Exception();

                result = (string)
                    MethodInvoker.Create(helloMethod).Invoke(new InvokeTestsGeneric<int>(), arg);
                if (result != "Hello world System.Int32")
                    throw new Exception();
                ...
                result = (string)
                    MethodInvoker
                        .Create(helloMethod)
                        .Invoke(new InvokeTestsGeneric<int>(), new Span<object?>(ref arg));
                if (result != "Hello world System.Int32")
                    throw new Exception();
            }

            {
                ...
                string result = (string)
                    helloGenericMethod.Invoke(new InvokeTestsGeneric<int>(), new object[] { arg });
                ...
                result = (string)
                    MethodInvoker
                        .Create(helloGenericMethod)
                        .Invoke(new InvokeTestsGeneric<int>(), arg);
                if (result != "Hello 1 System.Double")
                    throw new Exception();
    ...
    class TestConstructors
    {
        public static void Run()
        {
            ...
            ConstructorInfo ctor = typeof(ClassToConstruct).GetConstructor(
                new Type[] { typeof(int) }
            );
    ...
    class TestTypesInMethodSignatures
    {
        ...
        public static void Run()
        {
            var mi = typeof(TestTypesInMethodSignatures).GetMethod(
                nameof(DoSomething),
    ...
    class TestBaseOnlyUsedFromCode
    {
        ...
        public static void Run()
        {
            ...
            var inst = Activator.CreateInstance(
                typeof(OtherGenericClass<>).MakeGenericType(GetSomeReferenceType())
            );
    ...
    class TestGenericMethodOnGenericType
    {
        ...
        public static void Run()
        {
            ...
            (
                (MethodInfo)(
                    typeof(GenericType<Atom2>).GetMemberWithSameMetadataDefinitionAs(
                        s_genericMethod2
                    )
                )
            )
    ...
    class TestMdArrayLoad
    {
        ...
        public static void Run()
        {
            var mi = typeof(TestMdArrayLoad)
                .GetMethod(nameof(MakeMdArray))
                .MakeGenericMethod(typeof(Atom));
    ...
    class TestByRefTypeLoad
    {
        ...
        public static void Run()
        {
            var mi = typeof(TestByRefTypeLoad)
                .GetMethod(nameof(MakeFnPtrType))
                .MakeGenericMethod(typeof(Atom));
