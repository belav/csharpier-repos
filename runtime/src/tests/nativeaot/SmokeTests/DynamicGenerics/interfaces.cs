...
public class InterfacesTests
{
    ...
    {
        string IFrobber<string>.Frob()
        {
            return "String Frob";
        }

        string IFrobber<CommonType1>.Frob()
        {
            return "CommonType1 Frob";
        }
    }

    public struct AnotherFrobtasticFrobberStruct : IFrobber<object>, IFrobber<CommonType1>
    {
        string IFrobber<object>.Frob()
        {
            return "Object Frob";
        }
    ...
    public static void TestGenericCollapsingInInterfaceMap()
    {
        ...
        MethodInfo mi = typeof(InterfacesTests)
            .GetTypeInfo()
            .GetDeclaredMethod("TestGenericCollapsingInInterfaceMapHelper")
            .MakeGenericMethod(TypeOf.CommonType1, TypeOf.CommonType2);
    ...
    {
        {
            // Direct call case
            {
                Type useFrobberType = TypeOf.IT_UseFrobber
