...
#pragma warning restore 0414
    ...
    public class TestFieldsBase
    {
        ...
        public virtual object GetVal2()
        {
            return null;
        }

        public virtual object GetVal3()
        {
            return null;
        }

        public virtual object GetVal4()
        {
            return null;
        }

        public virtual object GetVal5()
        {
            return null;
        }

        public virtual object GetVal6()
        {
            return null;
        }
    }
    ...
    public class UCGInstanceFields<T, U> : TestFieldsBase
    {
        ...
        public override void SetVal1(object val)
        {
            _1 = (T)val;
        }

        public override void SetVal2(object val)
        {
            _2 = (U)val;
        }

        public override void SetVal3(object val)
        {
            _3 = (int)val;
        }

        public override object GetVal1()
        {
            return _1;
        }

        public override object GetVal2()
        {
            return _2;
        }

        public override object GetVal3()
        {
            return _3;
        }
    }
    ...
    public class UCGInstanceFieldsDerived<T, U> : UCGInstanceFields<T, T>
    {
        ...
        public override void SetVal4(object val)
        {
            _4 = (T)val;
        }

        public override void SetVal5(object val)
        {
            _5 = (double)val;
        }

        public override void SetVal6(object val)
        {
            _6 = (U)val;
        }
        ...
        public override object GetVal4()
        {
            return _4;
        }

        public override object GetVal5()
        {
            return _5;
        }

        public override object GetVal6()
        {
            return _6;
        }
    }
    ...
    public class UCGStaticFieldsLayoutCompatDynamic<T, U> : TestFieldsBase
    {
        public override void SetVal1(object val)
        {
            UCGStaticFieldsLayoutCompatStatic<T, U>._1 = (T)val;
        }

        public override void SetVal2(object val)
        {
            UCGStaticFieldsLayoutCompatStatic<T, U>._2 = (U)val;
        }

        public override void SetVal3(object val)
        {
            UCGStaticFieldsLayoutCompatStatic<T, U>._3 = (int)val;
        }

        public override object GetVal1()
        {
            return UCGStaticFieldsLayoutCompatStatic<T, U>._1;
        }

        public override object GetVal2()
        {
            return UCGStaticFieldsLayoutCompatStatic<T, U>._2;
        }

        public override object GetVal3()
        {
            return UCGStaticFieldsLayoutCompatStatic<T, U>._3;
        }
    }
        ...
        where T : new()
    {
        ...
        {
            _instance = new GenDerivedType<TimeSpan, T>(
                _listToUseAsParam,
                _tToUseAsParam,
                new Func<object, IList, TimeSpan, T, IComparer<TimeSpan>, IDisposable>(
                    FuncForDelegate
                ),
                _timeSpanToUseAsParam
            );
        }

        public static IDisposable FuncForDelegate(
            object stringObj,
            IList iListObject,
            TimeSpan ts,
            T tValue,
            IComparer<TimeSpan> comparer
        )
        {
    ...
    public class TestClassConstructorBase
    {
        ...
        public virtual bool QueryStatic()
        {
            return false;
        }
    }
    ...
    public class UCGClassConstructorType<T> : TestClassConstructorBase
    {
        ...
        public override bool QueryStatic()
        {
            return s_cctorRun;
        }
    }
    ...
    {
        public virtual string CallGvm(IGVMTest obj)
        {
            return null;
        }
    }
    ...
    public class Base
    {
        ...
        public virtual object dupTest(object o1, object o2)
        {
            return null;
        }

        public virtual bool FunctionCallTestsSetMember(object o1)
        {
            return false;
        }

        public virtual bool FunctionCallTestsSetMemberByRef(object o1)
        {
            return false;
        }

        public virtual bool FunctionCallTestsByRefGC(object o1)
        {
            return false;
        }

        public virtual bool FunctionCallTestsSetByValue(object o1)
        {
            return false;
        }

        public virtual bool FunctionCallTestsSetLocalByRef(object o1)
        {
            return false;
        }

        public virtual bool FunctionCallTestsSetByValue2(object o1)
        {
            return false;
        }
    ...
    public class Test
    {
        ...
        public static void TestUSGSamples()
        {
            ...
            Assert.AreEqual((short)o.dupTest((short)12, (short)-453), (short)12);
        ...
        public static void TestMakeGenericType()
        {
            ...
            Assert.AreEqual(
                t.ToString(),
                "UniversalGen.MyGen`1[System.Collections.Generic.KeyValuePair`2[System.String,System.Object]]"
            );
            ...
            // List test
            {
                ...
                Assert.AreEqual(
                    t.ToString(),
                    "UniversalGen.MyDerivedList`1[UniversalGen.MyListItem]"
                );

                var l = Activator.CreateInstance(t);

                MethodInfo ListTest = typeof(Test)
                    .GetTypeInfo()
                    .GetDeclaredMethod("ListTest")
                    .MakeGenericMethod(TypeOf.UG_MyListItem);
        ...
        public static void TestUSCInstanceFieldUsage()
        {
            ...
            Assert.AreEqual(
                o2.ToString(),
                "GenDerivedType_Activator<UniversalGen.MyGenStruct`1[System.Double]>.FuncForDelegate"
            );
        }
        ...
        public static void TestUSCThreadStaticFieldUsage()
        {
            ...
            // Test with valuetypes as field types
            t = TypeOf.UG_UCGThreadStaticFields
                .MakeGenericType(TypeOf.UG_UCGWrapperStruct, TypeOf.UG_UCGWrapperStruct);
            o = (TestFieldsBase)Activator.CreateInstance(t);
        ...
        public static void TestUSCStaticFieldLayoutCompat()
        {
            ...
            o.SetVal2(11);
            o.SetVal3(12);
            var t = TypeOf.UG_UCGStaticFieldsLayoutCompatDynamic
            ...
            o.SetVal3(15);
            t = TypeOf.UG_UCGStaticFieldsLayoutCompatDynamic
                .MakeGenericType(TypeOf.UG_UCGWrapperStruct, TypeOf.UG_UCGWrapperStruct);
            o = (TestFieldsBase)Activator.CreateInstance(t);
        ...
        public static void TestUniversalGenericsGvmCall()
        {
            ...
            Assert.AreEqual(
                TypeOf.Int32.ToString() + TypeOf.Int16.ToString(),
                o.CallGvm(testClass)
            );
            ...
            Assert.AreEqual(
                TypeOf.Double.ToString() + TypeOf.Int16.ToString(),
                o.CallGvm(testStruct)
            );
        }
    }
}
...
#pragma warning disable 0114
    public class Base<T>
    {
        ...
        {
            return "Base<" + typeof(T) + ">.Method1";
        }

        public virtual string Method2()
        {
            return "Base<" + typeof(T) + ">.Method2";
        }

        public virtual string Method3()
        {
            return "Base<" + typeof(T) + ">.Method3";
        }
    }
    ...
    public class Derived<T, U> : Base<T>, IBase<T, U>
    {
        public virtual string Method1()
        {
            return "Derived<" + typeof(T) + "," + typeof(U) + ">.Method1";
        }

        public virtual string Method2()
        {
            return "Derived<" + typeof(T) + "," + typeof(U) + ">.Method2";
        }

        public virtual string Method3()
        {
            return "Derived<" + typeof(T) + "," + typeof(U) + ">.Method3";
        }

        public virtual string Method4()
        {
            return "Derived<" + typeof(T) + "," + typeof(U) + ">.Method4";
        }

        public virtual string Method5()
        {
            return "Derived<" + typeof(T) + "," + typeof(U) + ">.Method5";
        }

        public virtual string Method6()
        {
            return "Derived<" + typeof(T) + "," + typeof(U) + ">.Method6";
        }
    }
    ...
    public class Derived2<T, U> : Derived<T, int>
    {
        ...
        {
            return "Derived2<" + typeof(T) + "," + typeof(U) + ">.Method1";
        }

        public override string Method2()
        {
            return "Derived2<" + typeof(T) + "," + typeof(U) + ">.Method2";
        }

        public override string Method3()
        {
            return "Derived2<" + typeof(T) + "," + typeof(U) + ">.Method3";
        }

        public override string Method4()
        {
            return "Derived2<" + typeof(T) + "," + typeof(U) + ">.Method4";
        }

        public override string Method5()
        {
            return "Derived2<" + typeof(T) + "," + typeof(U) + ">.Method5";
        }

        public override string Method6()
        {
            return "Derived2<" + typeof(T) + "," + typeof(U) + ">.Method6";
        }
    }
    ...
    public class Derived3<T, U> : Derived2<T, Type>
    {
        public virtual string Method1()
        {
            return "Derived3<" + typeof(T) + "," + typeof(U) + ">.Method1";
        }

        public virtual string Method2()
        {
            return "Derived3<" + typeof(T) + "," + typeof(U) + ">.Method2";
        }

        public virtual string Method3()
        {
            return "Derived3<" + typeof(T) + "," + typeof(U) + ">.Method3";
        }

        public virtual string Method4()
        {
            return "Derived3<" + typeof(T) + "," + typeof(U) + ">.Method4";
        }

        public virtual string Method5()
        {
            return "Derived3<" + typeof(T) + "," + typeof(U) + ">.Method5";
        }

        public virtual string Method6()
        {
            return "Derived3<" + typeof(T) + "," + typeof(U) + ">.Method6";
        }
    }
#pragma warning restore 114
    ...
    public class NullableCaseTest<T> : TestRelatedTypeCases
    {
        public override void DoTest()
        {
            ...
            Assert.IsTrue(
                nullable.GetType().ToString()
                    == "Nullable<MyStruct<" + typeof(T) + "," + typeof(T) + ">>"
            );
            ...
            Assert.IsTrue(
                nullable2.GetType().ToString()
                    == "Nullable<MyStruct<" + typeof(T) + ",System.Int32>>"
            );
        }
    }
    ...
    public class Test
    {
        ...
        public static void TestVirtualCallsPartialUSGVTableMismatch()
        {
            ...
            MethodInfo GetKeyForItem = collectionType
                .GetTypeInfo()
                .GetDeclaredMethod("GetKeyForItem");
            short result = (short)
                GetKeyForItem.Invoke(
                    collection,
                    new object[] { new DictionaryEntry((short)123, "abc") }
                );
                ...
                {
                    {
                        ...
                        var obj = Activator.CreateInstance(
                            TypeOf.PCT_Derived.MakeGenericType(typeArg, typeArg)
                        );
                    ...
                    {
                        var t_int = TypeOf.PCT_UCGTestVirtualCalls
                            .MakeGenericType(typeArg, TypeOf.Int32);
                        var t_type = TypeOf.PCT_UCGTestVirtualCalls
                        ...
                        TestVirtualCallsBase caller_type = (TestVirtualCallsBase)
                            Activator.CreateInstance(t_type);

                        var obj = Activator.CreateInstance(
                            TypeOf.PCT_Derived3.MakeGenericType(typeArg, typeArg)
                        );
                        caller_int.TestVirtualCall0(obj);
                        caller_type.TestVirtualCall0(obj);

                        caller_int.TestVirtualCall1(
                            obj,
                            "Derived2<" + typeArg + "," + TypeOf.Type + ">"
                        );
                        try
                        {
                        ...
                        caller_int.TestVirtualCall4(
                            obj,
                            "Derived3<" + typeArg + "," + typeArg + ">"
                        );
                        caller_type.TestVirtualCall4(
                            obj,
                            "Derived3<" + typeArg + "," + typeArg + ">"
                        );
                    }
...
namespace VirtualCalls
{
    ...
    public class UCGTestVirtualCalls<T> : TestVirtualCallsBase
    {
        ...
        public override void TestUniversalGenericMethodCallOnNonUniversalContainingType()
        {
            ...
            Assert.AreEqual(
                result,
                "UCGTestVirtualCalls<TestClass>.GenericMethod<" + typeof(T).Name + ">"
            );
            result = UCGTestVirtualCalls<TestClass>.StaticGenericMethod<T>();
            Assert.AreEqual(
                result,
                "UCGTestVirtualCalls<TestClass>.StaticGenericMethod<" + typeof(T).Name + ">"
            );
            ...
            Assert.AreEqual(
                result,
                "UCGTestVirtualCalls<TestStruct>.GenericMethod<" + typeof(T).Name + ">"
            );
            result = UCGTestVirtualCalls<TestStruct>.StaticGenericMethod<T>();
            Assert.AreEqual(
                result,
                "UCGTestVirtualCalls<TestStruct>.StaticGenericMethod<" + typeof(T).Name + ">"
            );
        }

        string GenericMethod<ARG>()
        {
            return "UCGTestVirtualCalls<"
                + typeof(T).Name
                + ">.GenericMethod<"
                + typeof(ARG).Name
                + ">";
        ...
        static string StaticGenericMethod<ARG>()
        {
            return "UCGTestVirtualCalls<"
                + typeof(T).Name
                + ">.StaticGenericMethod<"
        ...
        void VerifyCallResult<ARG>(string result, string methodName, object o)
        {
            ...
            if (o.GetType().ToString().Contains("Derived_NoOverride"))
            {
                ...
                expected = "Derived_WithOverride<" + typeof(ARG) + ">." + methodName;
    ...
    public class NonGenBase
    {
        public virtual string Method1()
        {
            return "NonGenBase.Method1";
        }

        public virtual string Method2()
        {
            return "NonGenBase.Method2";
        }

        public virtual string Method3()
        {
            return "NonGenBase.Method3";
        }
    }
    ...
    public class NonGenDerived : NonGenBase
    {
        public override string Method1()
        {
            return "NonGenDerived.Method1";
        }

        public override string Method2()
        {
            return "NonGenDerived.Method2";
        }

        public override string Method3()
        {
            return "NonGenDerived.Method3";
        }
    }
    ...
    public class Derived<T> : Base<T>
    {
        ...
        {
            return "Derived<" + typeof(T) + ">.Method4";
        }

        public virtual string Method5(T t)
        {
            return "Derived<" + typeof(T) + ">.Method5";
        }

        public virtual string Method6(T t)
        {
            return "Derived<" + typeof(T) + ">.Method6";
        }
    }
#pragma warning disable 114     // 'method' hides inherited member 'method'
    public class Derived_NoOverride<T> : Derived<T>
    {
        public virtual string Method1(T t)
        {
            return "Derived_NoOverride<" + typeof(T) + ">.Method1";
        }

        public virtual string Method2(T t)
        {
            return "Derived_NoOverride<" + typeof(T) + ">.Method2";
        }

        public virtual string Method3(T t)
        {
            return "Derived_NoOverride<" + typeof(T) + ">.Method3";
        }

        public virtual string Method4(T t)
        {
            return "Derived_NoOverride<" + typeof(T) + ">.Method4";
        }

        public virtual string Method5(T t)
        {
            return "Derived_NoOverride<" + typeof(T) + ">.Method5";
        }

        public virtual string Method6(T t)
        {
            return "Derived_NoOverride<" + typeof(T) + ">.Method6";
        }
    }
#pragma warning restore 114
    public class Derived_WithOverride<T> : Derived<T>
    {
        public override string Method1(T t)
        {
            return "Derived_WithOverride<" + typeof(T) + ">.Method1";
        }

        public override string Method2(T t)
        {
            return "Derived_WithOverride<" + typeof(T) + ">.Method2";
        }

        public override string Method3(T t)
        {
            return "Derived_WithOverride<" + typeof(T) + ">.Method3";
        }

        public override string Method4(T t)
        {
            return "Derived_WithOverride<" + typeof(T) + ">.Method4";
        }

        public override string Method5(T t)
        {
            return "Derived_WithOverride<" + typeof(T) + ">.Method5";
        }

        public override string Method6(T t)
        {
            return "Derived_WithOverride<" + typeof(T) + ">.Method6";
        }
    }
        ...
        public static void TestVirtualCalls()
        {
            ...
            for (int i = 0; i < 10; i++)
            {
                ...
                )
                {
                    ...
                    var obj = Activator.CreateInstance(
                        TypeOf.VCT_Derived_NoOverride.MakeGenericType(typeArg)
                    );
                    ...
                    caller.TestVirtualCallStaticallyCompiledGenericInstance(
                        new Derived_NoOverride<double>(),
                        new Derived_NoOverride<Type>()
                    );
                    caller.TestUniversalGenericMethodCallOnNonUniversalContainingType();

                    obj = Activator.CreateInstance(
                        TypeOf.VCT_Derived_WithOverride.MakeGenericType(typeArg)
                    );
                    caller.TestVirtualCall(obj, value);
                    caller.TestVirtualCallUsingDelegates(obj, value);
                    caller.TestVirtualCallNonGenericInstance(new NonGenDerived());
                    caller.TestVirtualCallStaticallyCompiledGenericInstance(
                        new Derived_WithOverride<double>(),
                        new Derived_WithOverride<Type>()
                    );
                    caller.TestUniversalGenericMethodCallOnNonUniversalContainingType();
                }
            }
...
namespace CallingConvention
{
    ...
    public unsafe class CCTester<T> : IBase<T>
    {
        ...
        public virtual T VirtualCoolFunc(
            object o,
            Bar<T> b,
            Foo<T> f,
            T[] a,
    ...
    {
        public virtual object TestNonVirtualInstanceFunction(object o, object value)
        {
            return null;
        }
    }
    ...
    public class EmptyClass<T>
    {
        public override string ToString()
        {
            return "EmptyClass<" + typeof(T).Name + ">";
        }
    }
    ...
    public struct TestStructKnownSize<T>
    {
        ...
        internal TestStructKnownSize(EmptyClass<T> l, T tValue)
        {
            _field1 = l;
            _field2 = new ClassWithTField<T>(tValue);
        }

        public override string ToString()
        {
            return "TestStructKnownSize<"
                + typeof(T).Name
                + ">. _field1 = {"
                + _field1.ToString()
                + "}. _field2 = {"
    ...
    public struct TestStructIndeterminateSize<T>
    {
        ...
        internal TestStructIndeterminateSize(EmptyClass<T> l, T tValue)
        {
            _field1 = l;
            _field2 = new StructWithTField<T>(tValue);
        }

        public override string ToString()
        {
            return "TestStructIndeterminateSize<"
                + typeof(T).Name
                + ">. _field1 = {"
                + _field1.ToString()
                + "}. _field2 = {"
    ...
    public struct StructWithOneField1<T>
    {
        ...
        internal StructWithOneField1(MainClass<T, T> f)
        {
            _field1 = f;
        }
    ...
    public struct StructWithOneField2<T>
    {
        ...
        internal StructWithOneField2(ClassWithTField<T> f)
        {
            _field1 = f;
        }
    ...
    public struct StructWithOneField3<T>
    {
        ...
        internal StructWithOneField3(StructWithTField<T> f)
        {
            _field1 = f;
        }
    ...
    public struct StructWithTwoFields1<T>
    {
        ...
        internal StructWithTwoFields1(MainClass<T, T> f, T tValue)
        {
            _field1 = f;
            _field2 = new TestStructKnownSize<T>(new EmptyClass<T>(), tValue);
        }

        public override string ToString()
        {
            return "StructWithTwoFields1<"
                + typeof(T).Name
                + ">. _field1 = {"
                + _field1.ToString()
                + "}. _field2 = {"
    ...
    public struct StructWithTwoFields2<T>
    {
        ...
        internal StructWithTwoFields2(MainClass<T, T> f, T tValue)
        {
            _field1 = f;
            _field2 = new TestStructIndeterminateSize<T>(new EmptyClass<T>(), tValue);
        }

        public override string ToString()
        {
            return "StructWithTwoFields2<"
                + typeof(T).Name
                + ">. _field1 = {"
                + _field1.ToString()
                + "}. _field2 = {"
    ...
    public struct StructWithTwoGenParams<T, U>
    {
        ...
        public StructWithTwoGenParams(T t)
        {
            _field1 = t;
        }
    ...
    public struct StructWithOneFieldTwoGenParams1<T, U>
    {
        ...
        internal StructWithOneFieldTwoGenParams1(MainClass<T, T> f)
        {
            _field1 = f;
        }
        ...
        public override string ToString()
        {
            return "StructWithOneFieldTwoGenParams1<"
                + typeof(T)
                + ","
                + typeof(U)
                + ">. _field1 = {"
    ...
    public struct StructWithOneFieldTwoGenParams2<T, U>
    {
        ...
        internal StructWithOneFieldTwoGenParams2(ClassWithTField<T> f)
        {
            _field1 = f;
        }
        ...
        public override string ToString()
        {
            return "StructWithOneFieldTwoGenParams2<"
                + typeof(T)
                + ","
                + typeof(U)
                + ">. _field1 = {"
    ...
    public struct StructWithOneFieldTwoGenParams3<T, U>
    {
        ...
        internal StructWithOneFieldTwoGenParams3(StructWithTField<T> f)
        {
            _field1 = f;
        }
        ...
        public override string ToString()
        {
            return "StructWithOneFieldTwoGenParams3<"
                + typeof(T)
                + ","
                + typeof(U)
                + ">. _field1 = {"
    ...
    public struct StructWithTwoFieldsTwoGenParams1<T, U>
    {
        ...
        internal StructWithTwoFieldsTwoGenParams1(MainClass<T, T> f, T tValue)
        {
            _field1 = f;
            _field2 = new TestStructKnownSize<T>(new EmptyClass<T>(), tValue);
        }
        ...
        public override string ToString()
        {
            return "StructWithTwoFieldsTwoGenParams1<"
                + typeof(T)
                + ","
                + typeof(U)
                + ">. _field1 = {"
    ...
    public struct StructWithTwoFieldsTwoGenParams2<T, U>
    {
        ...
        internal StructWithTwoFieldsTwoGenParams2(MainClass<T, T> f, T tValue)
        {
            _field1 = f;
            _field2 = new TestStructIndeterminateSize<T>(new EmptyClass<T>(), tValue);
        }
        ...
        public override string ToString()
        {
            return "StructWithTwoFieldsTwoGenParams2<"
                + typeof(T)
                + ","
                + typeof(U)
                + ">. _field1 = {"
    ...
    public class MainClass<T, U>
    {
        ...
        public ClassWithTField<T> GetClassWithTField()
        {
            return new ClassWithTField<T>(_tValue);
        }

        public ClassWithTField<T> PassthruClassWithTField(ClassWithTField<T> value)
        {
            return value;
        }

        public delegate ClassWithTField<T> PassthruClassWithTFieldDelegate(
            MainClass<T, U> obj,
            ClassWithTField<T> value
        );

        public object PassthruClassWithTFieldDelegateDirectCall(
            MainClass<T, U> obj,
            ClassWithTField<T> value,
            PassthruClassWithTFieldDelegate del
        )
        {
            return del(obj, value);
        }

        public StructWithTField<T> GetStructWithTField()
        {
            return new StructWithTField<T>(_tValue);
        }

        public StructWithTField<T> PassthruStructWithTField(StructWithTField<T> value)
        {
            return value;
        }

        public delegate StructWithTField<T> PassthruStructWithTFieldDelegate(
            MainClass<T, U> obj,
            StructWithTField<T> value
        );

        public object PassthruStructWithTFieldDelegateDirectCall(
            MainClass<T, U> obj,
            StructWithTField<T> value,
            PassthruStructWithTFieldDelegate del
        )
        {
            return del(obj, value);
        }

        public TestStructKnownSize<T> GetTestStructKnownSize()
        {
            return new TestStructKnownSize<T>(new EmptyClass<T>(), _tValue);
        }

        public TestStructKnownSize<T> PassthruTestStructKnownSize(TestStructKnownSize<T> value)
        {
            return value;
        }

        public delegate TestStructKnownSize<T> PassthruTestStructKnownSizeDelegate(
            MainClass<T, U> obj,
            TestStructKnownSize<T> value
        );

        public object PassthruTestStructKnownSizeDelegateDirectCall(
            MainClass<T, U> obj,
            TestStructKnownSize<T> value,
            PassthruTestStructKnownSizeDelegate del
        )
        {
            return del(obj, value);
        }

        public TestStructIndeterminateSize<T> GetTestStructIndeterminateSize()
        {
            return new TestStructIndeterminateSize<T>(new EmptyClass<T>(), _tValue);
        }

        public TestStructIndeterminateSize<T> PassthruTestStructIndeterminateSize(
            TestStructIndeterminateSize<T> value
        )
        {
            return value;
        }

        public delegate TestStructIndeterminateSize<T> PassthruTestStructIndeterminateSizeDelegate(
            MainClass<T, U> obj,
            TestStructIndeterminateSize<T> value
        );

        public object PassthruTestStructIndeterminateSizeDelegateDirectCall(
            MainClass<T, U> obj,
            TestStructIndeterminateSize<T> value,
            PassthruTestStructIndeterminateSizeDelegate del
        )
        {
            return del(obj, value);
        }

        public TestStructKnownSize<
            TestStructIndeterminateSize<T>
        > GetTestStructKnownSizeWrappingTestStructIndeterminateSize()
        {
            return new TestStructKnownSize<TestStructIndeterminateSize<T>>(
                new EmptyClass<TestStructIndeterminateSize<T>>(),
                new TestStructIndeterminateSize<T>(new EmptyClass<T>(), _tValue)
            );
        }

        public TestStructKnownSize<
            TestStructIndeterminateSize<T>
        > PassthruTestStructKnownSizeWrappingTestStructIndeterminateSize(
            TestStructKnownSize<TestStructIndeterminateSize<T>> value
        )
        {
            return value;
        }

        public delegate TestStructKnownSize<
            TestStructIndeterminateSize<T>
        > PassthruTestStructKnownSizeWrappingTestStructIndeterminateSizeDelegate(
            MainClass<T, U> obj,
            TestStructKnownSize<TestStructIndeterminateSize<T>> value
        );

        public object PassthruTestStructKnownSizeWrappingTestStructIndeterminateSizeDelegateDirectCall(
            MainClass<T, U> obj,
            TestStructKnownSize<TestStructIndeterminateSize<T>> value,
            PassthruTestStructKnownSizeWrappingTestStructIndeterminateSizeDelegate del
        )
        {
            return del(obj, value);
        }

        public TestStructIndeterminateSize<
            TestStructKnownSize<T>
        > GetTestStructIndeterminateSizeWrappingTestStructKnownSize()
        {
            return new TestStructIndeterminateSize<TestStructKnownSize<T>>(
                new EmptyClass<TestStructKnownSize<T>>(),
                new TestStructKnownSize<T>(new EmptyClass<T>(), _tValue)
            );
        }

        public TestStructIndeterminateSize<
            TestStructKnownSize<T>
        > PassthruTestStructIndeterminateSizeWrappingTestStructKnownSize(
            TestStructIndeterminateSize<TestStructKnownSize<T>> value
        )
        {
            return value;
        }

        public delegate TestStructIndeterminateSize<
            TestStructKnownSize<T>
        > PassthruTestStructIndeterminateSizeWrappingTestStructKnownSizeDelegate(
            MainClass<T, U> obj,
            TestStructIndeterminateSize<TestStructKnownSize<T>> value
        );

        public object PassthruTestStructIndeterminateSizeWrappingTestStructKnownSizeDelegateDirectCall(
            MainClass<T, U> obj,
            TestStructIndeterminateSize<TestStructKnownSize<T>> value,
            PassthruTestStructIndeterminateSizeWrappingTestStructKnownSizeDelegate del
        )
        {
            return del(obj, value);
        }
        ...
        public TestStructIndeterminateSize<
            TestStructKnownSize<ClassWithTField<T>>
        > GetTestStructIndeterminateSizeWrappingTestStructKnownSizeWrappingReferenceType()
        {
            return new TestStructIndeterminateSize<TestStructKnownSize<ClassWithTField<T>>>(
                new EmptyClass<TestStructKnownSize<ClassWithTField<T>>>(),
                new TestStructKnownSize<ClassWithTField<T>>(
                    new EmptyClass<ClassWithTField<T>>(),
                    new ClassWithTField<T>(_tValue)
                )
            );
        }
        ...
        public TestStructIndeterminateSize<
            TestStructKnownSize<ClassWithTField<T>>
        > PassthruTestStructIndeterminateSizeWrappingTestStructKnownSizeWrappingReferenceType(
            TestStructIndeterminateSize<TestStructKnownSize<ClassWithTField<T>>> value
        )
        {
            return value;
        }
        ...
        public delegate TestStructIndeterminateSize<
            TestStructKnownSize<ClassWithTField<T>>
        > PassthruTestStructIndeterminateSizeWrappingTestStructKnownSizeWrappingReferenceTypeDelegate(
            MainClass<T, U> obj,
            TestStructIndeterminateSize<TestStructKnownSize<ClassWithTField<T>>> value
        );
        ...
        public object PassthruTestStructIndeterminateSizeWrappingTestStructKnownSizeWrappingReferenceTypeDelegateDirectCall(
            MainClass<T, U> obj,
            TestStructIndeterminateSize<TestStructKnownSize<ClassWithTField<T>>> value,
            PassthruTestStructIndeterminateSizeWrappingTestStructKnownSizeWrappingReferenceTypeDelegate del
        )
        {
            return del(obj, value);
        }
        ...
        public TestStructIndeterminateSize<
            TestStructIndeterminateSize<ClassWithTField<T>>
        > GetTestStructIndeterminateSizeWrappingTestStructIndeterminateSizeWrappingReferenceType()
        {
            return new TestStructIndeterminateSize<TestStructIndeterminateSize<ClassWithTField<T>>>(
                new EmptyClass<TestStructIndeterminateSize<ClassWithTField<T>>>(),
                new TestStructIndeterminateSize<ClassWithTField<T>>(
                    new EmptyClass<ClassWithTField<T>>(),
                    new ClassWithTField<T>(_tValue)
                )
            );
        ...
        public TestStructIndeterminateSize<
            TestStructIndeterminateSize<ClassWithTField<T>>
        > PassthruTestStructIndeterminateSizeWrappingTestStructIndeterminateSizeWrappingReferenceType(
            TestStructIndeterminateSize<TestStructIndeterminateSize<ClassWithTField<T>>> value
        )
        {
            return value;
        }
        ...
        public delegate TestStructIndeterminateSize<
            TestStructIndeterminateSize<ClassWithTField<T>>
        > PassthruTestStructIndeterminateSizeWrappingTestStructIndeterminateSizeWrappingReferenceTypeDelegate(
            MainClass<T, U> obj,
            TestStructIndeterminateSize<TestStructIndeterminateSize<ClassWithTField<T>>> value
        );

        public object PassthruTestStructIndeterminateSizeWrappingTestStructIndeterminateSizeWrappingReferenceTypeDelegateDirectCall(
            MainClass<T, U> obj,
            TestStructIndeterminateSize<TestStructIndeterminateSize<ClassWithTField<T>>> value,
            PassthruTestStructIndeterminateSizeWrappingTestStructIndeterminateSizeWrappingReferenceTypeDelegate del
        )
        {
            return del(obj, value);
        }

        public StructWithOneField1<T> GetStructWithOneField1()
        {
            return new StructWithOneField1<T>(GetMainTT());
        }

        public StructWithOneField1<T> PassthruStructWithOneField1(StructWithOneField1<T> value)
        {
            return value;
        }

        public delegate StructWithOneField1<T> PassthruStructWithOneField1Delegate(
            MainClass<T, U> obj,
            StructWithOneField1<T> value
        );

        public object PassthruStructWithOneField1DelegateDirectCall(
            MainClass<T, U> obj,
            StructWithOneField1<T> value,
            PassthruStructWithOneField1Delegate del
        )
        {
            return del(obj, value);
        }

        public StructWithOneField2<T> GetStructWithOneField2()
        {
            return new StructWithOneField2<T>(new ClassWithTField<T>(_tValue));
        }

        public StructWithOneField2<T> PassthruStructWithOneField2(StructWithOneField2<T> value)
        {
            return value;
        }

        public delegate StructWithOneField2<T> PassthruStructWithOneField2Delegate(
            MainClass<T, U> obj,
            StructWithOneField2<T> value
        );

        public object PassthruStructWithOneField2DelegateDirectCall(
            MainClass<T, U> obj,
            StructWithOneField2<T> value,
            PassthruStructWithOneField2Delegate del
        )
        {
            return del(obj, value);
        }

        public StructWithOneField3<T> GetStructWithOneField3()
        {
            return new StructWithOneField3<T>(new StructWithTField<T>(_tValue));
        }

        public StructWithOneField3<T> PassthruStructWithOneField3(StructWithOneField3<T> value)
        {
            return value;
        }

        public delegate StructWithOneField3<T> PassthruStructWithOneField3Delegate(
            MainClass<T, U> obj,
            StructWithOneField3<T> value
        );

        public object PassthruStructWithOneField3DelegateDirectCall(
            MainClass<T, U> obj,
            StructWithOneField3<T> value,
            PassthruStructWithOneField3Delegate del
        )
        {
            return del(obj, value);
        }

        public StructWithTwoFields1<T> GetStructWithTwoFields1()
        {
            return new StructWithTwoFields1<T>(GetMainTT(), _tValue);
        }

        public StructWithTwoFields1<T> PassthruStructWithTwoFields1(StructWithTwoFields1<T> value)
        {
            return value;
        }

        public delegate StructWithTwoFields1<T> PassthruStructWithTwoFields1Delegate(
            MainClass<T, U> obj,
            StructWithTwoFields1<T> value
        );

        public object PassthruStructWithTwoFields1DelegateDirectCall(
            MainClass<T, U> obj,
            StructWithTwoFields1<T> value,
            PassthruStructWithTwoFields1Delegate del
        )
        {
            return del(obj, value);
        }

        public StructWithTwoFields2<T> GetStructWithTwoFields2()
        {
            return new StructWithTwoFields2<T>(GetMainTT(), _tValue);
        }

        public StructWithTwoFields2<T> PassthruStructWithTwoFields2(StructWithTwoFields2<T> value)
        {
            return value;
        }

        public delegate StructWithTwoFields2<T> PassthruStructWithTwoFields2Delegate(
            MainClass<T, U> obj,
            StructWithTwoFields2<T> value
        );

        public object PassthruStructWithTwoFields2DelegateDirectCall(
            MainClass<T, U> obj,
            StructWithTwoFields2<T> value,
            PassthruStructWithTwoFields2Delegate del
        )
        {
            return del(obj, value);
        }

        public StructWithTwoGenParams<int, T> GetStructWithTwoGenParams1()
        {
            return new StructWithTwoGenParams<int, T>(int.Parse(_id));
        }

        public StructWithTwoGenParams<int, T> PassthruStructWithTwoGenParams1(
            StructWithTwoGenParams<int, T> value
        )
        {
            return value;
        }

        public delegate StructWithTwoGenParams<int, T> PassthruStructWithTwoGenParams1Delegate(
            MainClass<T, U> obj,
            StructWithTwoGenParams<int, T> value
        );

        public object PassthruStructWithTwoGenParams1DelegateDirectCall(
            MainClass<T, U> obj,
            StructWithTwoGenParams<int, T> value,
            PassthruStructWithTwoGenParams1Delegate del
        )
        {
            return del(obj, value);
        }

        public StructWithTwoGenParams<
            int,
            KeyValuePair<int, StructWithTwoGenParams<List<T>, T>>
        > GetStructWithTwoGenParams2()
        {
            return new StructWithTwoGenParams<
                int,
                KeyValuePair<int, StructWithTwoGenParams<List<T>, T>>
            >(int.Parse(_id));
        }
        ...
        public StructWithTwoGenParams<
            int,
            KeyValuePair<int, StructWithTwoGenParams<List<T>, T>>
        > PassthruStructWithTwoGenParams2(
            StructWithTwoGenParams<int, KeyValuePair<int, StructWithTwoGenParams<List<T>, T>>> value
        )
        {
            return value;
        }

        public delegate StructWithTwoGenParams<
            int,
            KeyValuePair<int, StructWithTwoGenParams<List<T>, T>>
        > PassthruStructWithTwoGenParams2Delegate(
            MainClass<T, U> obj,
            StructWithTwoGenParams<int, KeyValuePair<int, StructWithTwoGenParams<List<T>, T>>> value
        );

        public object PassthruStructWithTwoGenParams2DelegateDirectCall(
            MainClass<T, U> obj,
            StructWithTwoGenParams<
                int,
                KeyValuePair<int, StructWithTwoGenParams<List<T>, T>>
            > value,
            PassthruStructWithTwoGenParams2Delegate del
        )
        {
            return del(obj, value);
        }
        ...
        public StructWithTwoGenParams<
            int,
            StructWithTwoGenParams<List<T>, KeyValuePair<T, T>>
        > GetStructWithTwoGenParams3()
        {
            return new StructWithTwoGenParams<
                int,
                StructWithTwoGenParams<List<T>, KeyValuePair<T, T>>
        ...
        public StructWithTwoGenParams<
            int,
            StructWithTwoGenParams<List<T>, KeyValuePair<T, T>>
        > PassthruStructWithTwoGenParams3(
            StructWithTwoGenParams<int, StructWithTwoGenParams<List<T>, KeyValuePair<T, T>>> value
        )
        {
            return value;
        }
        ...
        public delegate StructWithTwoGenParams<
            int,
            StructWithTwoGenParams<List<T>, KeyValuePair<T, T>>
        > PassthruStructWithTwoGenParams3Delegate(
            MainClass<T, U> obj,
            StructWithTwoGenParams<int, StructWithTwoGenParams<List<T>, KeyValuePair<T, T>>> value
        );

        public object PassthruStructWithTwoGenParams3DelegateDirectCall(
            MainClass<T, U> obj,
            StructWithTwoGenParams<int, StructWithTwoGenParams<List<T>, KeyValuePair<T, T>>> value,
            PassthruStructWithTwoGenParams3Delegate del
        )
        {
            return del(obj, value);
        }
        ...
        public StructWithTwoGenParams<
            int,
            StructWithTwoGenParams<List<int>, KeyValuePair<int, string>>
        > GetStructWithTwoGenParams4()
        {
            return new StructWithTwoGenParams<
                int,
                StructWithTwoGenParams<List<int>, KeyValuePair<int, string>>
        ...
        public StructWithTwoGenParams<
            int,
            StructWithTwoGenParams<List<int>, KeyValuePair<int, string>>
        > PassthruStructWithTwoGenParams4(
            StructWithTwoGenParams<
                int,
                StructWithTwoGenParams<List<int>, KeyValuePair<int, string>>
            > value
        ...
        public delegate StructWithTwoGenParams<
            int,
            StructWithTwoGenParams<List<int>, KeyValuePair<int, string>>
        > PassthruStructWithTwoGenParams4Delegate(
            MainClass<T, U> obj,
            StructWithTwoGenParams<
                int,
                StructWithTwoGenParams<List<int>, KeyValuePair<int, string>>
        ...
        public object PassthruStructWithTwoGenParams4DelegateDirectCall(
            MainClass<T, U> obj,
            StructWithTwoGenParams<
                int,
                StructWithTwoGenParams<List<int>, KeyValuePair<int, string>>
            > value,
            PassthruStructWithTwoGenParams4Delegate del
        )
        {
            return del(obj, value);
        }

        public StructWithOneFieldTwoGenParams1<T, T> GetStructWithOneFieldTwoGenParams1()
        {
            return new StructWithOneFieldTwoGenParams1<T, T>(GetMainTT());
        }

        public StructWithOneFieldTwoGenParams1<T, T> PassthruStructWithOneFieldTwoGenParams1(
            StructWithOneFieldTwoGenParams1<T, T> value
        )
        {
            return value;
        }

        public delegate StructWithOneFieldTwoGenParams1<
            T,
            T
        > PassthruStructWithOneFieldTwoGenParams1Delegate(
            MainClass<T, U> obj,
            StructWithOneFieldTwoGenParams1<T, T> value
        );

        public object PassthruStructWithOneFieldTwoGenParams1DelegateDirectCall(
            MainClass<T, U> obj,
            StructWithOneFieldTwoGenParams1<T, T> value,
            PassthruStructWithOneFieldTwoGenParams1Delegate del
        )
        {
            return del(obj, value);
        }

        public StructWithOneFieldTwoGenParams2<T, T> GetStructWithOneFieldTwoGenParams2()
        {
            return new StructWithOneFieldTwoGenParams2<T, T>(new ClassWithTField<T>(_tValue));
        }

        public StructWithOneFieldTwoGenParams2<T, T> PassthruStructWithOneFieldTwoGenParams2(
            StructWithOneFieldTwoGenParams2<T, T> value
        )
        {
            return value;
        }

        public delegate StructWithOneFieldTwoGenParams2<
            T,
            T
        > PassthruStructWithOneFieldTwoGenParams2Delegate(
            MainClass<T, U> obj,
            StructWithOneFieldTwoGenParams2<T, T> value
        );

        public object PassthruStructWithOneFieldTwoGenParams2DelegateDirectCall(
            MainClass<T, U> obj,
            StructWithOneFieldTwoGenParams2<T, T> value,
            PassthruStructWithOneFieldTwoGenParams2Delegate del
        )
        {
            return del(obj, value);
        }

        public StructWithOneFieldTwoGenParams3<T, T> GetStructWithOneFieldTwoGenParams3()
        {
            return new StructWithOneFieldTwoGenParams3<T, T>(new StructWithTField<T>(_tValue));
        }

        public StructWithOneFieldTwoGenParams3<T, T> PassthruStructWithOneFieldTwoGenParams3(
            StructWithOneFieldTwoGenParams3<T, T> value
        )
        {
            return value;
        }

        public delegate StructWithOneFieldTwoGenParams3<
            T,
            T
        > PassthruStructWithOneFieldTwoGenParams3Delegate(
            MainClass<T, U> obj,
            StructWithOneFieldTwoGenParams3<T, T> value
        );

        public object PassthruStructWithOneFieldTwoGenParams3DelegateDirectCall(
            MainClass<T, U> obj,
            StructWithOneFieldTwoGenParams3<T, T> value,
            PassthruStructWithOneFieldTwoGenParams3Delegate del
        )
        {
            return del(obj, value);
        }

        public StructWithTwoFieldsTwoGenParams1<T, T> GetStructWithTwoFieldsTwoGenParams1()
        {
            return new StructWithTwoFieldsTwoGenParams1<T, T>(GetMainTT(), _tValue);
        }

        public StructWithTwoFieldsTwoGenParams1<T, T> PassthruStructWithTwoFieldsTwoGenParams1(
            StructWithTwoFieldsTwoGenParams1<T, T> value
        )
        {
            return value;
        }

        public delegate StructWithTwoFieldsTwoGenParams1<
            T,
            T
        > PassthruStructWithTwoFieldsTwoGenParams1Delegate(
            MainClass<T, U> obj,
            StructWithTwoFieldsTwoGenParams1<T, T> value
        );

        public object PassthruStructWithTwoFieldsTwoGenParams1DelegateDirectCall(
            MainClass<T, U> obj,
            StructWithTwoFieldsTwoGenParams1<T, T> value,
            PassthruStructWithTwoFieldsTwoGenParams1Delegate del
        )
        {
            return del(obj, value);
        }

        public StructWithTwoFieldsTwoGenParams2<T, T> GetStructWithTwoFieldsTwoGenParams2()
        {
            return new StructWithTwoFieldsTwoGenParams2<T, T>(GetMainTT(), _tValue);
        }

        public StructWithTwoFieldsTwoGenParams2<T, T> PassthruStructWithTwoFieldsTwoGenParams2(
            StructWithTwoFieldsTwoGenParams2<T, T> value
        )
        {
            return value;
        }

        public delegate StructWithTwoFieldsTwoGenParams2<
            T,
            T
        > PassthruStructWithTwoFieldsTwoGenParams2Delegate(
            MainClass<T, U> obj,
            StructWithTwoFieldsTwoGenParams2<T, T> value
        );

        public object PassthruStructWithTwoFieldsTwoGenParams2DelegateDirectCall(
            MainClass<T, U> obj,
            StructWithTwoFieldsTwoGenParams2<T, T> value,
            PassthruStructWithTwoFieldsTwoGenParams2Delegate del
        )
        {
            return del(obj, value);
        }

        public StructWithOneFieldTwoGenParams1<T, float> GetStructWithOneFieldTwoGenParams1_KnownU()
        {
            return new StructWithOneFieldTwoGenParams1<T, float>(GetMainTT());
        }

        public StructWithOneFieldTwoGenParams1<
            T,
            float
        > PassthruStructWithOneFieldTwoGenParams1_KnownU(
            StructWithOneFieldTwoGenParams1<T, float> value
        )
        {
            return value;
        }
        ...
        public delegate StructWithOneFieldTwoGenParams1<
            T,
            float
        > PassthruStructWithOneFieldTwoGenParams1_KnownUDelegate(
            MainClass<T, U> obj,
            StructWithOneFieldTwoGenParams1<T, float> value
        );

        public object PassthruStructWithOneFieldTwoGenParams1_KnownUDelegateDirectCall(
            MainClass<T, U> obj,
            StructWithOneFieldTwoGenParams1<T, float> value,
            PassthruStructWithOneFieldTwoGenParams1_KnownUDelegate del
        )
        {
            return del(obj, value);
        }

        public StructWithOneFieldTwoGenParams2<T, float> GetStructWithOneFieldTwoGenParams2_KnownU()
        {
            return new StructWithOneFieldTwoGenParams2<T, float>(new ClassWithTField<T>(_tValue));
        }

        public StructWithOneFieldTwoGenParams2<
            T,
            float
        > PassthruStructWithOneFieldTwoGenParams2_KnownU(
            StructWithOneFieldTwoGenParams2<T, float> value
        )
        {
            return value;
        }
        ...
        public delegate StructWithOneFieldTwoGenParams2<
            T,
            float
        > PassthruStructWithOneFieldTwoGenParams2_KnownUDelegate(
            MainClass<T, U> obj,
            StructWithOneFieldTwoGenParams2<T, float> value
        );

        public object PassthruStructWithOneFieldTwoGenParams2_KnownUDelegateDirectCall(
            MainClass<T, U> obj,
            StructWithOneFieldTwoGenParams2<T, float> value,
            PassthruStructWithOneFieldTwoGenParams2_KnownUDelegate del
        )
        {
            return del(obj, value);
        }

        public StructWithOneFieldTwoGenParams3<T, float> GetStructWithOneFieldTwoGenParams3_KnownU()
        {
            return new StructWithOneFieldTwoGenParams3<T, float>(new StructWithTField<T>(_tValue));
        }

        public StructWithOneFieldTwoGenParams3<
            T,
            float
        > PassthruStructWithOneFieldTwoGenParams3_KnownU(
            StructWithOneFieldTwoGenParams3<T, float> value
        )
        {
            return value;
        }
        ...
        public delegate StructWithOneFieldTwoGenParams3<
            T,
            float
        > PassthruStructWithOneFieldTwoGenParams3_KnownUDelegate(
            MainClass<T, U> obj,
            StructWithOneFieldTwoGenParams3<T, float> value
        );

        public object PassthruStructWithOneFieldTwoGenParams3_KnownUDelegateDirectCall(
            MainClass<T, U> obj,
            StructWithOneFieldTwoGenParams3<T, float> value,
            PassthruStructWithOneFieldTwoGenParams3_KnownUDelegate del
        )
        {
            return del(obj, value);
        }

        public StructWithTwoFieldsTwoGenParams1<
            T,
            float
        > GetStructWithTwoFieldsTwoGenParams1_KnownU()
        {
            return new StructWithTwoFieldsTwoGenParams1<T, float>(GetMainTT(), _tValue);
        }

        public StructWithTwoFieldsTwoGenParams1<
            T,
            float
        > PassthruStructWithTwoFieldsTwoGenParams1_KnownU(
            StructWithTwoFieldsTwoGenParams1<T, float> value
        )
        {
            return value;
        }
        ...
        public delegate StructWithTwoFieldsTwoGenParams1<
            T,
            float
        > PassthruStructWithTwoFieldsTwoGenParams1_KnownUDelegate(
            MainClass<T, U> obj,
            StructWithTwoFieldsTwoGenParams1<T, float> value
        );

        public object PassthruStructWithTwoFieldsTwoGenParams1_KnownUDelegateDirectCall(
            MainClass<T, U> obj,
            StructWithTwoFieldsTwoGenParams1<T, float> value,
            PassthruStructWithTwoFieldsTwoGenParams1_KnownUDelegate del
        )
        {
            return del(obj, value);
        }

        public StructWithTwoFieldsTwoGenParams2<
            T,
            float
        > GetStructWithTwoFieldsTwoGenParams2_KnownU()
        {
            return new StructWithTwoFieldsTwoGenParams2<T, float>(GetMainTT(), _tValue);
        }

        public StructWithTwoFieldsTwoGenParams2<
            T,
            float
        > PassthruStructWithTwoFieldsTwoGenParams2_KnownU(
            StructWithTwoFieldsTwoGenParams2<T, float> value
        )
        {
            return value;
        }
        ...
        public delegate StructWithTwoFieldsTwoGenParams2<
            T,
            float
        > PassthruStructWithTwoFieldsTwoGenParams2_KnownUDelegate(
            MainClass<T, U> obj,
            StructWithTwoFieldsTwoGenParams2<T, float> value
        );

        public object PassthruStructWithTwoFieldsTwoGenParams2_KnownUDelegateDirectCall(
            MainClass<T, U> obj,
            StructWithTwoFieldsTwoGenParams2<T, float> value,
            PassthruStructWithTwoFieldsTwoGenParams2_KnownUDelegate del
        )
        {
            return del(obj, value);
        }

        public StructWithOneFieldTwoGenParams1<long, T> GetStructWithOneFieldTwoGenParams1_KnownT()
        {
            return new StructWithOneFieldTwoGenParams1<long, T>(
                new MainClass<long, long>("123", long.Parse(_id))
            );
        }
        ...
        public StructWithOneFieldTwoGenParams1<
            long,
            T
        > PassthruStructWithOneFieldTwoGenParams1_KnownT(
            StructWithOneFieldTwoGenParams1<long, T> value
        )
        {
            return value;
        }
        ...
        public delegate StructWithOneFieldTwoGenParams1<
            long,
            T
        > PassthruStructWithOneFieldTwoGenParams1_KnownTDelegate(
            MainClass<T, U> obj,
            StructWithOneFieldTwoGenParams1<long, T> value
        );

        public object PassthruStructWithOneFieldTwoGenParams1_KnownTDelegateDirectCall(
            MainClass<T, U> obj,
            StructWithOneFieldTwoGenParams1<long, T> value,
            PassthruStructWithOneFieldTwoGenParams1_KnownTDelegate del
        )
        {
            return del(obj, value);
        }

        public StructWithOneFieldTwoGenParams2<long, T> GetStructWithOneFieldTwoGenParams2_KnownT()
        {
            return new StructWithOneFieldTwoGenParams2<long, T>(
                new ClassWithTField<long>(long.Parse(_id))
            );
        }
        ...
        public StructWithOneFieldTwoGenParams2<
            long,
            T
        > PassthruStructWithOneFieldTwoGenParams2_KnownT(
            StructWithOneFieldTwoGenParams2<long, T> value
        )
        {
            return value;
        }
        ...
        public delegate StructWithOneFieldTwoGenParams2<
            long,
            T
        > PassthruStructWithOneFieldTwoGenParams2_KnownTDelegate(
            MainClass<T, U> obj,
            StructWithOneFieldTwoGenParams2<long, T> value
        );

        public object PassthruStructWithOneFieldTwoGenParams2_KnownTDelegateDirectCall(
            MainClass<T, U> obj,
            StructWithOneFieldTwoGenParams2<long, T> value,
            PassthruStructWithOneFieldTwoGenParams2_KnownTDelegate del
        )
        {
            return del(obj, value);
        }

        public StructWithOneFieldTwoGenParams3<long, T> GetStructWithOneFieldTwoGenParams3_KnownT()
        {
            return new StructWithOneFieldTwoGenParams3<long, T>(
                new StructWithTField<long>(long.Parse(_id))
            );
        }
        ...
        public StructWithOneFieldTwoGenParams3<
            long,
            T
        > PassthruStructWithOneFieldTwoGenParams3_KnownT(
            StructWithOneFieldTwoGenParams3<long, T> value
        )
        {
            return value;
        }
        ...
        public delegate StructWithOneFieldTwoGenParams3<
            long,
            T
        > PassthruStructWithOneFieldTwoGenParams3_KnownTDelegate(
            MainClass<T, U> obj,
            StructWithOneFieldTwoGenParams3<long, T> value
        );

        public object PassthruStructWithOneFieldTwoGenParams3_KnownTDelegateDirectCall(
            MainClass<T, U> obj,
            StructWithOneFieldTwoGenParams3<long, T> value,
            PassthruStructWithOneFieldTwoGenParams3_KnownTDelegate del
        )
        {
            return del(obj, value);
        }
        ...
        public StructWithTwoFieldsTwoGenParams1<
            long,
            T
        > GetStructWithTwoFieldsTwoGenParams1_KnownT()
        {
            return new StructWithTwoFieldsTwoGenParams1<long, T>(
                new MainClass<long, long>("456", long.Parse(_id)),
                long.Parse(_id)
            );
        }
        ...
        public StructWithTwoFieldsTwoGenParams1<
            long,
            T
        > PassthruStructWithTwoFieldsTwoGenParams1_KnownT(
            StructWithTwoFieldsTwoGenParams1<long, T> value
        )
        {
            return value;
        }
        ...
        public delegate StructWithTwoFieldsTwoGenParams1<
            long,
            T
        > PassthruStructWithTwoFieldsTwoGenParams1_KnownTDelegate(
            MainClass<T, U> obj,
            StructWithTwoFieldsTwoGenParams1<long, T> value
        );

        public object PassthruStructWithTwoFieldsTwoGenParams1_KnownTDelegateDirectCall(
            MainClass<T, U> obj,
            StructWithTwoFieldsTwoGenParams1<long, T> value,
            PassthruStructWithTwoFieldsTwoGenParams1_KnownTDelegate del
        )
        {
            return del(obj, value);
        }
        ...
        public StructWithTwoFieldsTwoGenParams2<
            long,
            T
        > GetStructWithTwoFieldsTwoGenParams2_KnownT()
        {
            return new StructWithTwoFieldsTwoGenParams2<long, T>(
                new MainClass<long, long>("789", long.Parse(_id)),
                long.Parse(_id)
            );
        }
        ...
        public StructWithTwoFieldsTwoGenParams2<
            long,
            T
        > PassthruStructWithTwoFieldsTwoGenParams2_KnownT(
            StructWithTwoFieldsTwoGenParams2<long, T> value
        )
        {
            return value;
        }
        ...
        public delegate StructWithTwoFieldsTwoGenParams2<
            long,
            T
        > PassthruStructWithTwoFieldsTwoGenParams2_KnownTDelegate(
            MainClass<T, U> obj,
            StructWithTwoFieldsTwoGenParams2<long, T> value
        );

        public object PassthruStructWithTwoFieldsTwoGenParams2_KnownTDelegateDirectCall(
            MainClass<T, U> obj,
            StructWithTwoFieldsTwoGenParams2<long, T> value,
            PassthruStructWithTwoFieldsTwoGenParams2_KnownTDelegate del
        )
        {
            return del(obj, value);
        }

        public string ObjectToString<Y>(Y x)
        {
            return x.ToString();
        }
    }
    ...
    public class Test
    {
        ...
        public static void TestInstancesOfKnownAndUnknownSizes()
        {
            foreach (Type genArg in new Type[] { TypeOf.Double, TypeOf.String })
            {
                ...
                TestInstancesOfKnownAndUnknownSizes_Inner(
                    t,
                    o,
                    "GetClassWithTField",
                    "abc",
                ...
                TestInstancesOfKnownAndUnknownSizes_Inner(
                    t,
                    o,
                    "GetTestStructIndeterminateSize",
                    "abc",
                    genArgInst
                );
                TestInstancesOfKnownAndUnknownSizes_Inner(
                ...
                TestInstancesOfKnownAndUnknownSizes_Inner(
                    t,
                    o,
                    "GetStructWithOneFieldTwoGenParams1",
                    "abc",
                    genArgInst
                );
                TestInstancesOfKnownAndUnknownSizes_Inner(
                    t,
                    o,
                    "GetStructWithOneFieldTwoGenParams2",
                    "abc",
                    genArgInst
                );
                TestInstancesOfKnownAndUnknownSizes_Inner(
                    t,
                    o,
                    "GetStructWithOneFieldTwoGenParams3",
                    "abc",
                    genArgInst
                );
                TestInstancesOfKnownAndUnknownSizes_Inner(
                    t,
                    o,
                    "GetStructWithTwoFieldsTwoGenParams1",
                    "abc",
                    genArgInst
                );
                TestInstancesOfKnownAndUnknownSizes_Inner(
                    t,
                    o,
                    "GetStructWithTwoFieldsTwoGenParams2",
                    "abc",
                    genArgInst
                );
                ...
                TestInstancesOfKnownAndUnknownSizes_Inner(
                    t,
                    o,
                    "GetStructWithOneFieldTwoGenParams1_KnownU",
                    "abc",
                    genArgInst
                );
                TestInstancesOfKnownAndUnknownSizes_Inner(
                    t,
                    o,
                    "GetStructWithOneFieldTwoGenParams2_KnownU",
                    "abc",
                    genArgInst
                );
                TestInstancesOfKnownAndUnknownSizes_Inner(
                    t,
                    o,
                    "GetStructWithOneFieldTwoGenParams3_KnownU",
                    "abc",
                    genArgInst
                );
                TestInstancesOfKnownAndUnknownSizes_Inner(
                ...
                TestInstancesOfKnownAndUnknownSizes_Inner(
                    t,
                    o,
                    "GetStructWithOneFieldTwoGenParams1_KnownT",
                    "123",
                    "55"
                );
                TestInstancesOfKnownAndUnknownSizes_Inner(
                    t,
                    o,
                    "GetStructWithOneFieldTwoGenParams2_KnownT",
                    "55",
                    null
                );
                TestInstancesOfKnownAndUnknownSizes_Inner(
                    t,
                    o,
                    "GetStructWithOneFieldTwoGenParams3_KnownT",
                    "55",
                    null
                );
                TestInstancesOfKnownAndUnknownSizes_Inner(
        ...
        static string TestInstancesOfKnownAndUnknownSizes_GetExpectedResult(
            Type t,
            object a,
            object b,
            string getterFunc
        )
        {
            switch (getterFunc)
            {
                case "GetClassWithTField":
                    return "ClassWithTField<" + t.Name + ">. _field1 = {" + b + "}";
                case "GetStructWithTField":
                    return "StructWithTField<" + t.Name + ">. _field1 = {" + b + "}";
                case "GetTestStructKnownSize":
                    return "TestStructKnownSize<"
                        + t.Name
                        + ">. _field1 = {EmptyClass<"
                        + t.Name
                        + ">}. _field2 = {ClassWithTField<"
                        + t.Name
                        + ">. _field1 = {"
                        + b
                        + "}}";
                case "GetTestStructIndeterminateSize":
                    return "TestStructIndeterminateSize<"
                        + t.Name
                        + ">. _field1 = {EmptyClass<"
                        + t.Name
                        + ">}. _field2 = {StructWithTField<"
                        + t.Name
                        + ">. _field1 = {"
                        + b
                        + "}}";
                case "GetTestStructKnownSizeWrappingTestStructIndeterminateSize":
                    return "TestStructKnownSize<TestStructIndeterminateSize`1>. _field1 = {EmptyClass<TestStructIndeterminateSize`1>}. _field2 = {ClassWithTField<TestStructIndeterminateSize`1>. _field1 = {TestStructIndeterminateSize<"
                        + t.Name
                        + ">. _field1 = {EmptyClass<"
                        + t.Name
                        + ">}. _field2 = {StructWithTField<"
                        ...
                        + b
                        + "}}}}";
                case "GetTestStructIndeterminateSizeWrappingTestStructKnownSize":
                    return "TestStructIndeterminateSize<TestStructKnownSize`1>. _field1 = {EmptyClass<TestStructKnownSize`1>}. _field2 = {StructWithTField<TestStructKnownSize`1>. _field1 = {TestStructKnownSize<"
                        + t.Name
                        + ">. _field1 = {EmptyClass<"
                        + t.Name
                        + ">}. _field2 = {ClassWithTField<"
                        ...
                        + b
                        + "}}}}";
                case "GetTestStructIndeterminateSizeWrappingTestStructKnownSizeWrappingReferenceType":
                    return "TestStructIndeterminateSize<TestStructKnownSize`1>. _field1 = {EmptyClass<TestStructKnownSize`1>}. _field2 = {StructWithTField<TestStructKnownSize`1>. _field1 = {TestStructKnownSize<ClassWithTField`1>. _field1 = {EmptyClass<ClassWithTField`1>}. _field2 = {ClassWithTField<ClassWithTField`1>. _field1 = {ClassWithTField<"
                        ...
                        + b
                        + "}}}}}";
                case "GetTestStructIndeterminateSizeWrappingTestStructIndeterminateSizeWrappingReferenceType":
                ...
                case "GetStructWithOneField1":
                    return "StructWithOneField1<"
                        ...
                        + b
                        + "}}";
                case "GetStructWithOneField2":
                    return "StructWithOneField2<"
                        + t.Name
                        + ">. _field1 = {ClassWithTField<"
                        + t.Name
                        + ">. _field1 = {"
                        + b
                        + "}}";
                case "GetStructWithOneField3":
                    return "StructWithOneField3<"
                        + t.Name
                        + ">. _field1 = {StructWithTField<"
                        + t.Name
                        + ">. _field1 = {"
                        + b
                        + "}}";
                case "GetStructWithTwoFields1":
                    return "StructWithTwoFields1<"
                        + t.Name
                        + ">. _field1 = {MainClass<"
                        + t.Name
                ...
                case "GetStructWithTwoFields2":
                    return "StructWithTwoFields2<"
                        ...
                        + "}. _tValue = {"
                        + b
                        + "}}. _field2 = {TestStructIndeterminateSize<"
                        + t.Name
                        + ">. _field1 = {EmptyClass<"
                        + t.Name
                        + ">}. _field2 = {StructWithTField<"
                ...
                case "GetStructWithTwoGenParams1":
                    return "StructWithTwoGenParams<System.Int32," + t + ">. _field1 = {" + a + "}";
                case "GetStructWithTwoGenParams2":
                    return "StructWithTwoGenParams<System.Int32,System.Collections.Generic.KeyValuePair`2[System.Int32,CallingConvention.StructWithTwoGenParams`2[System.Collections.Generic.List`1["
                        + t
                        + "],"
                        + t
                        + "]]>. _field1 = {"
                        + a
                        + "}";
                case "GetStructWithTwoGenParams3":
                    return "StructWithTwoGenParams<System.Int32,CallingConvention.StructWithTwoGenParams`2[System.Collections.Generic.List`1["
                        + t
                        ...
                        + a
                        + "}";
                case "GetStructWithTwoGenParams4":
                    return "StructWithTwoGenParams<System.Int32,CallingConvention.StructWithTwoGenParams`2[System.Collections.Generic.List`1[System.Int32],System.Collections.Generic.KeyValuePair`2[System.Int32,System.String]]>. _field1 = {"
                        + a
                        + "}";

                case "GetStructWithOneFieldTwoGenParams1":
                    return "StructWithOneFieldTwoGenParams1<"
                        + t
                        + ","
                        + t
                        ...
                        + b
                        + "}}";
                case "GetStructWithOneFieldTwoGenParams2":
                    return "StructWithOneFieldTwoGenParams2<"
                        + t
                        + ","
                        + t
                        ...
                        + b
                        + "}}";
                case "GetStructWithOneFieldTwoGenParams3":
                    return "StructWithOneFieldTwoGenParams3<"
                        + t
                        + ","
                        + t
                        ...
                        + b
                        + "}}";
                case "GetStructWithTwoFieldsTwoGenParams1":
                    return "StructWithTwoFieldsTwoGenParams1<"
                        + t
                        + ","
                        + t
                        ...
                        + b
                        + "}}}";
                case "GetStructWithTwoFieldsTwoGenParams2":
                    return "StructWithTwoFieldsTwoGenParams2<"
                        + t
                        + ","
                        + t
                ...
                case "GetStructWithOneFieldTwoGenParams1_KnownU":
                    return "StructWithOneFieldTwoGenParams1<"
                        + t
                        + ",System.Single>. _field1 = {MainClass<"
                        + t.Name
                        + ">. _id = {"
                        + a
                        + "}. _tValue = {"
                        + b
                        + "}}";
                case "GetStructWithOneFieldTwoGenParams2_KnownU":
                    return "StructWithOneFieldTwoGenParams2<"
                        + t
                        + ",System.Single>. _field1 = {ClassWithTField<"
                        + t.Name
                        + ">. _field1 = {"
                        + b
                        + "}}";
                case "GetStructWithOneFieldTwoGenParams3_KnownU":
                    return "StructWithOneFieldTwoGenParams3<"
                        + t
                        + ",System.Single>. _field1 = {StructWithTField<"
                        + t.Name
                        + ">. _field1 = {"
                        + b
                        + "}}";
                case "GetStructWithTwoFieldsTwoGenParams1_KnownU":
                    return "StructWithTwoFieldsTwoGenParams1<"
                        + t
                        + ",System.Single>. _field1 = {MainClass<"
                        + t.Name
                        ...
                        + b
                        + "}}}";
                case "GetStructWithTwoFieldsTwoGenParams2_KnownU":
                    return "StructWithTwoFieldsTwoGenParams2<"
                        + t
                        + ",System.Single>. _field1 = {MainClass<"
                        + t.Name
                ...
                case "GetStructWithOneFieldTwoGenParams1_KnownT":
                    return "StructWithOneFieldTwoGenParams1<System.Int64,"
                        + t
                        + ">. _field1 = {MainClass<Int64>. _id = {"
                        + a
                        + "}. _tValue = {"
                        + b
                        + "}}";
                case "GetStructWithOneFieldTwoGenParams2_KnownT":
                    return "StructWithOneFieldTwoGenParams2<System.Int64,"
                        + t
                        + ">. _field1 = {ClassWithTField<Int64>. _field1 = {"
                        + a
                        + "}}";
                case "GetStructWithOneFieldTwoGenParams3_KnownT":
                    return "StructWithOneFieldTwoGenParams3<System.Int64,"
                        + t
                        + ">. _field1 = {StructWithTField<Int64>. _field1 = {"
                        + a
                        + "}}";
                case "GetStructWithTwoFieldsTwoGenParams1_KnownT":
                    return "StructWithTwoFieldsTwoGenParams1<System.Int64,"
                        + t
                        + ">. _field1 = {MainClass<Int64>. _id = {"
                        + a
                        + "}. _tValue = {"
                        + b
                        + "}}. _field2 = {TestStructKnownSize<Int64>. _field1 = {EmptyClass<Int64>}. _field2 = {ClassWithTField<Int64>. _field1 = {"
                        + b
                        + "}}}";
                case "GetStructWithTwoFieldsTwoGenParams2_KnownT":
                    return "StructWithTwoFieldsTwoGenParams2<System.Int64,"
                        + t
                        + ">. _field1 = {MainClass<Int64>. _id = {"
                        + a
                        + "}. _tValue = {"
                        + b
                        + "}}. _field2 = {TestStructIndeterminateSize<Int64>. _field1 = {EmptyClass<Int64>}. _field2 = {StructWithTField<Int64>. _field1 = {"
                        + b
                        + "}}}";
        ...
        static void TestInstancesOfKnownAndUnknownSizes_Inner(
            Type t,
            object o,
            string getterFunc,
            object a,
        ...
        {
            string expectedResult = TestInstancesOfKnownAndUnknownSizes_GetExpectedResult(
            ...
            MethodInfo toString = t.GetTypeInfo()
                .GetDeclaredMethod("ObjectToString")
                .MakeGenericMethod(retVal.GetType());
            ...
            Type delegateType = t.GetTypeInfo()
                .GetDeclaredNestedType(passthruName + "Delegate")
                .AsType();
            ...
            MethodInfo delegateDirectCall = delegateDirectCall = t.GetTypeInfo()
                .GetDeclaredMethod(passthruName + "DelegateDirectCall");

            if (delegateDirectCall != null)
            {
                object passthruDelegateDirectCallRetVal = delegateDirectCall.Invoke(
                    o,
                    new object[] { o, passthruDelegateRetVal, passthruDelegate }
                );
        ...
        public static void TestCallInstanceFunction()
        {
            ...
            TestNonVirtualFunctionCallUseBase o = (TestNonVirtualFunctionCallUseBase)
                Activator.CreateInstance(t);

            new UCGSeparateClass<short>().BoxParam(4);

            short testValue = (short)3817;
            object returnValue = o.TestNonVirtualInstanceFunction(
                new UCGSeparateClass<short>(),
                (object)testValue
            );
...
namespace DynamicInvoke
{
    public class Type1<T>
    {
        ...
        public override string ToString()
        {
            return "Type1<" + typeof(T) + ">._myField = " + _myField.ToString();
        }
    }
    ...
    public class Type2<T>
    {
        ...
        public override string ToString()
        {
            return "Type2<" + typeof(T) + ">._myField = " + _myField.ToString();
        }
    }
    ...
    public class Type3<T>
    {
        ...
        public Type3(T t1, T t2, T t3)
        {
            _myField = new T[] { t1, t2, t3 };
        }

        public T Get_A_T(int index)
        {
            return _myField[index];
        }
    }
    ...
    public class TestType<T, U, V>
    {
        ...
        public KeyValuePair<Type3<T>, U> ComplexMethod(KeyValuePair<Type1<T[]>, U> kvp)
        {
            ...
            return new KeyValuePair<Type3<T>, U>(
                new Type3<T>(array[0], array[1], array[2]),
                kvp.Value
            );
        }
    }
    ...
    public class Test
    {
        ...
        public static void TestDynamicInvoke_Inner<T>(T argParam1, T argParam2)
        {
            ...
            // SimpleMethod2
            {
                ...
                Assert.AreEqual(
                    result,
                    "SimpleMethod2(123,456,System.Collections.Generic.Dictionary`2[System.Object,System.String],1.2,3.4,5.6)"
                );

                Delegate simpleMethod2Del = simpleMethod2.CreateDelegate(
                    typeof(Func<int, string, Dictionary<object, string>, List<float>, string>),
                    o
                );
            ...
            // Method2 and Method3
            {
                ...
                Assert.AreEqual(
                    resultStr_method2,
                    "Type2<" + typeof(T) + ">._myField = " + argParam1.ToString()
                );
                Assert.AreEqual(resultStr_method3, "Type2<System.String>._myField = hello");

                Assert.AreEqual(
                    result_of_method2,
                    "Type1<" + typeof(T) + ">._myField = " + argParam2.ToString()
                );
            ...
            // ComplexMethod
            {
                ...
                object result = complex_method.Invoke(
                    o,
                    new object[] { new KeyValuePair<Type1<T[]>, string>(myType1, "hello") }
                );
...
namespace TypeLayout
{
    ...
    public class Test
    {
        ...
        public static GenClassStatic<sbyte, sbyte, sbyte> s_staticClass =
            new GenClassStatic<sbyte, sbyte, sbyte>();
        public static GenClassDynamic<sbyte, sbyte, sbyte> s_dynamicClass =
            new GenClassDynamic<sbyte, sbyte, sbyte>();
        ...
        public static void TestTypeGCDescs()
        {
            ...
            staticType = typeof(GenStructStatic<
                bool,
                GenStructStatic<object, object, bool>,
                object
            >);
            staticArrayType = typeof(GenStructStatic<
                bool,
                GenStructStatic<object, object, bool>,
                object
            >[]);

            innerType = typeof(GenStructDynamic<,,>).MakeGenericType(
                TypeOf.Object,
                TypeOf.Object,
                TypeOf.Bool
            );

            dynamicType = typeof(GenStructDynamic<,,>).MakeGenericType(
                TypeOf.Bool,
                innerType,
                TypeOf.Object
            );
            ...
            dynamicType = typeof(GenClassDynamic<,,>).MakeGenericType(
                TypeOf.Bool,
                TypeOf.Object,
                TypeOf.Bool
            );
...
namespace ActivatorCreateInstance
{
    ...
    public class GenReferenceType<T>
    {
        ...
        public GenReferenceType()
        {
            _field = "GenReferenceType<" + typeof(T) + ">.ctor";
        }
    ...
    public class ReferenceTypeNoDefaultCtor
    {
        ...
        public ReferenceTypeNoDefaultCtor(int param1)
        {
            _field = "ReferenceTypeNoDefaultCtor.ctor";
        }
    ...
    public class GenReferenceTypeNoDefaultCtor<T>
    {
        ...
        public GenReferenceTypeNoDefaultCtor(bool param1)
        {
            _field = "GenReferenceTypeNoDefaultCtor<" + typeof(T) + ">.ctor";
        }
    ...
    public struct AValueType
    {
        ...
        public override string ToString()
        {
            return "AValueType.ctor" + _a + _b + _c;
        }
    }
    ...
    public struct AGenValueType<T>
    {
        ...
        public AGenValueType(double param)
        {
            _a = default(T);
            _c = "3";
        }
        ...
        public override string ToString()
        {
            return "AGenValueType<" + typeof(T) + ">.ctor" + _a + _c;
        }
    }
    ...
    public class Test
    {
        ...
        public static void TestCreateInstance()
        {
            ...
            TestActivatorCreateInstance_Inner(
                TypeOf.ACI_GenReferenceType.MakeGenericType(TypeOf.String),
                "GenReferenceType<System.String>.ctor"
            );
            TestActivatorCreateInstance_Inner(
                TypeOf.ACI_GenReferenceType.MakeGenericType(TypeOf.Double),
                "GenReferenceType<System.Double>.ctor"
            );
            TestActivatorCreateInstance_Inner(
                typeof(GenReferenceType<CommonType1>),
                "GenReferenceType<CommonType1>.ctor"
            );

            TestActivatorCreateInstance_Inner(typeof(ReferenceTypeNoDefaultCtor), null, true);
            TestActivatorCreateInstance_Inner(
                TypeOf.ACI_GenReferenceTypeNoDefaultCtor.MakeGenericType(TypeOf.String),
                null,
                true
            );
            TestActivatorCreateInstance_Inner(
                TypeOf.ACI_GenReferenceTypeNoDefaultCtor.MakeGenericType(TypeOf.Double),
                null,
                true
            );
            TestActivatorCreateInstance_Inner(
                typeof(GenReferenceTypeNoDefaultCtor<CommonType1>),
                null,
                true
            );
            ...
            TestActivatorCreateInstance_Inner(
                TypeOf.ACI_AGenValueType.MakeGenericType(TypeOf.String),
                "AGenValueType<System.String>.ctor"
            );
            TestActivatorCreateInstance_Inner(
                TypeOf.ACI_AGenValueType.MakeGenericType(TypeOf.Double),
                "AGenValueType<System.Double>.ctor0"
            );
#if USC
            TestActivatorCreateInstance_Inner(
                typeof(AGenValueType<CommonType1>),
                "AGenValueType<CommonType1>.ctorCommonType1"
            );
#else
            TestActivatorCreateInstance_Inner(
                typeof(AGenValueType<CommonType1>),
                "AGenValueType<CommonType1>.ctor"
            );
#endif
        }

        static void TestActivatorCreateInstance_Inner(
            Type typeArg,
            string toStrVal,
            bool expectMissingMemberException = false
        )
        {
            Type t;
            Base o;
...
namespace Heuristics
{
    ...
    public struct OnlyUseViaReflection<T>
    {
        ...
        public OnlyUseViaReflection(int dummyToMakeCscPass)
        {
            _a = default(T);
        }
        ...
        public override string ToString()
        {
            return "OnlyUseViaReflection<" + typeof(T) + ">.ctor" + _a;
        }
...
namespace ArrayVarianceTest
{
            ...
            switch (testId)
            {
                case 0:
                {
                    return collection == null
                        ? "NULL"
                        : (collection.Count + " items in ICollection<" + typeof(T).Name + ">");
                }
    ...
    public class Test
    {
        ...
        public static void RunTest()
        {
            ...
            MyTestEnum[] enum_array = new MyTestEnum[]
            {
                MyTestEnum.MTE_1,
                MyTestEnum.MTE_1,
                MyTestEnum.MTE_2,
            ...
            Assert.AreEqual(
                "2 items in ICollection<String>",
                mi.Invoke(o, new object[] { coll_str, 0 })
            );
            Assert.AreEqual("NULL", mi.Invoke(o, new object[] { int_array, 0 }));
            Assert.AreEqual(
                "2 items in IEnumerable<String>",
                mi.Invoke(o, new object[] { coll_str, 1 })
            );
            Assert.AreEqual("NULL", mi.Invoke(o, new object[] { int_array, 1 }));
            ...
            mi = t.GetTypeInfo().GetDeclaredMethod("RunTest");
            Assert.AreEqual(
                "2 items in ICollection<Object>",
                mi.Invoke(o, new object[] { coll_str, 0 })
            );
            Assert.AreEqual("NULL", mi.Invoke(o, new object[] { int_array, 0 }));
            Assert.AreEqual(
                "2 items in IEnumerable<Object>",
                mi.Invoke(o, new object[] { coll_str, 1 })
            );
            Assert.AreEqual("NULL", mi.Invoke(o, new object[] { int_array, 1 }));
            ...
            Assert.AreEqual("NULL", mi.Invoke(o, new object[] { coll_str, 0 }));
            Assert.AreEqual(
                "3 items in ICollection<Int32>",
                mi.Invoke(o, new object[] { int_array, 0 })
            );
            Assert.AreEqual(
                "6 items in ICollection<Int32>",
                mi.Invoke(o, new object[] { enum_array, 0 })
            );
            Assert.AreEqual("NULL", mi.Invoke(o, new object[] { coll_str, 1 }));
            Assert.AreEqual(
                "3 items in IEnumerable<Int32>",
                mi.Invoke(o, new object[] { int_array, 1 })
            );
            Assert.AreEqual(
                "6 items in IEnumerable<Int32>",
                mi.Invoke(o, new object[] { enum_array, 1 })
            );
            ...
            Assert.AreEqual("NULL", mi.Invoke(o, new object[] { coll_str, 0 }));
            Assert.AreEqual(
                "3 items in ICollection<MyTestEnum>",
                mi.Invoke(o, new object[] { int_array, 0 })
            );
            Assert.AreEqual(
                "6 items in ICollection<MyTestEnum>",
                mi.Invoke(o, new object[] { enum_array, 0 })
            );
            Assert.AreEqual("NULL", mi.Invoke(o, new object[] { coll_str, 1 }));
            Assert.AreEqual(
                "3 items in IEnumerable<MyTestEnum>",
                mi.Invoke(o, new object[] { int_array, 1 })
            );
            Assert.AreEqual(
                "6 items in IEnumerable<MyTestEnum>",
                mi.Invoke(o, new object[] { enum_array, 1 })
            );
        }
    }
...
namespace IsInstTest
{
    ...
    public class TestRunner
    {
        ...
        public static unsafe void RunIsInstAndCheckCastTest()
        {
            ...
            MethodInfo ActivateObject_IsInstT = typeof(TestType)
                .GetTypeInfo()
                .GetDeclaredMethod("ActivateObject_IsInstT")
                .MakeGenericMethod(typeof(IObject), TypeOf.Double);
            IObject myObject1 = (IObject)
                ActivateObject_IsInstT.Invoke(new TestType(), new object[] { "1", false });
            Assert.AreEqual(myObject1.Func(), "MyObject{1}");
            IObject myObject2 = (IObject)
                ActivateObject_IsInstT.Invoke(new TestType(), new object[] { "2", true });
            Assert.AreEqual(myObject2.Func(), "MyStruct{2}");

            // Test isinst of a class
            ActivateObject_IsInstT = typeof(TestType)
                .GetTypeInfo()
                .GetDeclaredMethod("ActivateObject_IsInstT")
                .MakeGenericMethod(typeof(MyObject), TypeOf.Double);
            IObject myObject3 = (IObject)
                ActivateObject_IsInstT.Invoke(new TestType(), new object[] { "3", false });
            Assert.AreEqual(myObject3.Func(), "MyObject{3}");
            IObject myObject4 = (IObject)
                ActivateObject_IsInstT.Invoke(new TestType(), new object[] { "4", true });
            Assert.IsTrue(myObject4 == null);

            // Test isinst of an array
            MethodInfo ActivateArray_IsInstT = typeof(TestType)
                .GetTypeInfo()
                .GetDeclaredMethod("ActivateArray_IsInstT")
                .MakeGenericMethod(typeof(IBase[]), TypeOf.Double);
            IBase[] myArray1 = (IBase[])
                ActivateArray_IsInstT.Invoke(new TestType(), new object[] { "5", false });
            ...
            IBase[] myArray2 = (IBase[])
                ActivateArray_IsInstT.Invoke(new TestType(), new object[] { "6", true });
...
namespace DelegateCallTest
{
    ...
    public class TestRunner
    {
        ...
        public static unsafe void TestCallMethodThroughUsgDelegate()
        {
            ...
            MethodInfo Method = typeof(Foo)
                .GetTypeInfo()
                .GetDeclaredMethod("Method")
                .MakeGenericMethod(TypeOf.Double);
            Type delType = typeof(Func<,,>).MakeGenericType(
                typeof(IBar),
                TypeOf.Double,
                TypeOf.String
            );
            ...
            MethodInfo CallMethodThroughDelegate = typeof(Foo)
                .GetTypeInfo()
                .GetDeclaredMethod("CallMethodThroughDelegate")
                .MakeGenericMethod(TypeOf.Double);
...
namespace FieldLayoutBugRepro
{
    ...
    public class Caller<TState> : CallerBase
    {
        public override string DoCall(object state, TimeSpan dueTime, object action)
        {
            ...
            return obj.Schedule<TState>(
                (TState)state,
                dueTime,
                (Func<IInterface, TState, string>)action
            );
        }
    }
    ...
    {
        public virtual string Schedule<TState>(
            TState state,
            TimeSpan dueTime,
            Func<IInterface, TState, string> action
        )
    ...
    {
        public override string Schedule<TState>(
            TState state,
            TimeSpan dueTime,
            Func<IInterface, TState, string> action
        )
        {
            ...
            ScheduledItem<TimeSpan, TState> scheduledItem = new ScheduledItem<TimeSpan, TState>(
                this,
                state,
                action,
                dueTime
    ...
    public class ScheduledItem<TAbsolute, TValue> : ScheduledItem<TAbsolute>
        where TAbsolute : IComparable<TAbsolute>
    {
        ...
        {
            return this.ToString() + "=" + _action(_scheduler, _state);
        }
    ...
    public class StateProducer<TSource> : StateProducerBase
    {
        public struct State
        {
            ...
            public override string ToString()
            {
                return "StateProducer<" + typeof(TSource) + ">/State[" + _s1 + _s2 + "]";
            }
        }

        [MethodImpl(MethodImplOptions.NoInlining)]
        public override object GetState(string s1, string s2)
        {
    ...
    public partial class Runner
    {
        ...
        public static unsafe void EntryPoint()
        {
            ...
            Type targ3 = typeof(StateProducer<>)
                .GetTypeInfo()
                .GetDeclaredNestedType("State")
                .MakeGenericType(targ1);
            Type delType = typeof(Func<,,>).MakeGenericType(
                typeof(IInterface),
                targ3,
                TypeOf.String
            ...
            Delegate action = typeof(Runner)
                .GetTypeInfo()
                .GetDeclaredMethod("MyDelTarget")
                .MakeGenericMethod(targ3)
                .CreateDelegate(delType);
            ...
            Assert.AreEqual(
                "ScheduledItem<System.TimeSpan,FieldLayoutBugRepro.StateProducer`1+State[FieldLayoutBugRepro.EventPattern`1[System.String]]>{_dueTime=00:00:00.0000291,_comparer=MyComparer<System.TimeSpan>}={scheduler=DerivedType,state=StateProducer<FieldLayoutBugRepro.EventPattern`1[System.String]>/State[abcdef]}",
                result
            );
        }
...
namespace DelegateTest
{
    public class BaseType
    {
        public virtual Func<T, string> GVMethod1<T>(T t)
        {
            return null;
        }

        public virtual Func<T, string> GVMethod2<T>(T t)
        {
            return null;
        }
    }
    ...
    public partial class TestRunner
    {
        ...
        public static unsafe void TestMethodCellsWithUSGTargetsUsedOnNonUSGInstantiations()
        {
            ...
            MethodInfo GVMethod1 = typeof(BaseType)
                .GetTypeInfo()
            ...
            MethodInfo GVMethod2 = typeof(BaseType)
                .GetTypeInfo()
...
namespace ArrayExceptionsTest
{
    ...
    public class Runner
    {
        ...
        {
            Type t = typeof(DerivedType<,,>).MakeGenericType(
                TypeOf.String,
                TypeOf.Object,
                TypeOf.Short
            );
...
namespace UnboxAnyTests
{
    ...
    public class Runner
    {
        ...
        public static unsafe void TestUnboxAnyToString()
        {
            ...
            {
                o.TestUnboxAnyAndRebox(new object());
            });
        }
        ...
        public static unsafe void TestUnboxAnyToInt()
        {
            ...
            Assert.AreEqual(
                IntBasedEnum.Val,
                (IntBasedEnum)o.TestUnboxAnyAndRebox(IntBasedEnum.Val)
            );
            Assert.Throws<InvalidCastException>(() =>
            {
                o.TestUnboxAnyAndRebox(new object());
        ...
        public static unsafe void TestUnboxAnyToNullableInt()
        {
            ...
            Assert.Throws<InvalidCastException>(() =>
            {
                o.TestUnboxAnyAndRebox(IntBasedEnum.Val);
            });
            Assert.Throws<InvalidCastException>(() =>
            {
                o.TestUnboxAnyAndRebox(new object());
        ...
        public static unsafe void TestUnboxAnyToShort_NonUSG()
        {
            ...
            Assert.AreEqual(
                ShortBasedEnum.Val,
                (ShortBasedEnum)o.TestUnboxAnyAndRebox(ShortBasedEnum.Val)
            );
            Assert.Throws<InvalidCastException>(() =>
            {
                o.TestUnboxAnyAndRebox(new object());
        ...
        public static unsafe void TestUnboxAnyToNullableShort_NonUSG()
        {
            ...
            Assert.Throws<InvalidCastException>(() =>
            {
                o.TestUnboxAnyAndRebox(ShortBasedEnum.Val);
            });
            Assert.Throws<InvalidCastException>(() =>
            {
                o.TestUnboxAnyAndRebox(new object());
        ...
        public static unsafe void TestUnboxAnyToNullableShortBasedEnum_NonUSG()
        {
            ...
            Assert.Throws<InvalidCastException>(() =>
            {
                o.TestUnboxAnyAndRebox((object)(short)14);
            });
            Assert.AreEqual(
                ShortBasedEnum.Val,
                (ShortBasedEnum)o.TestUnboxAnyAndRebox(ShortBasedEnum.Val)
...
namespace HFATest
{
    public struct Struct00<F, D, I, L>
    {
        public D _f1;
    }

    public struct Struct01<F, D, I, L>
    {
        public F _f1;
    }

    public struct Struct02<F, D, I, L>
    {
        public I _f1;
    }

    public struct Struct03<F, D, I, L>
    {
        public L _f1;
    }

    public struct Struct10<F, D, I, L>
    {
        public F _f1;
        public D _f2;
    }

    public struct Struct11<F, D, I, L>
    {
        public F _f1;
        public F _f2;
    }

    public struct Struct12<F, D, I, L>
    {
        public F _f1;
        public I _f2;
    }

    public struct Struct13<F, D, I, L>
    {
        public F _f1;
        public L _f2;
    }

    public struct Struct14<F, D, I, L>
    {
        public D _f1;
        public D _f2;
    }

    public struct Struct15<F, D, I, L>
    {
        public D _f1;
        public F _f2;
    }

    public struct Struct16<F, D, I, L>
    {
        public D _f1;
        public I _f2;
    }

    public struct Struct17<F, D, I, L>
    {
        public D _f1;
        public L _f2;
    }

    public struct Struct20<F, D, I, L>
    {
        public F _f1;
        public D _f2;
        public F _f3;
    ...
    public struct Struct21<F, D, I, L>
    {
        public F _f1;
        public F _f2;
        public F _f3;
    ...
    public struct Struct22<F, D, I, L>
    {
        public F _f1;
        public I _f2;
        public F _f3;
    ...
    public struct Struct23<F, D, I, L>
    {
        public F _f1;
        public L _f2;
        public F _f3;
    ...
    public struct Struct24<F, D, I, L>
    {
        public D _f1;
        public D _f2;
        public D _f3;
    ...
    public struct Struct25<F, D, I, L>
    {
        public D _f1;
        public F _f2;
        public D _f3;
    ...
    public struct Struct26<F, D, I, L>
    {
        public D _f1;
        public I _f2;
        public D _f3;
    ...
    public struct Struct27<F, D, I, L>
    {
        public D _f1;
        public L _f2;
        public D _f3;
    ...
    public struct Struct30<F, D, I, L>
    {
        public F _f1;
        public D _f2;
        public F _f3;
    ...
    public struct Struct31<F, D, I, L>
    {
        public F _f1;
        public F _f2;
        public F _f3;
    ...
    public struct Struct32<F, D, I, L>
    {
        public F _f1;
        public I _f2;
        public F _f3;
    ...
    public struct Struct33<F, D, I, L>
    {
        public F _f1;
        public L _f2;
        public F _f3;
    ...
    public struct Struct34<F, D, I, L>
    {
        public D _f1;
        public D _f2;
        public D _f3;
    ...
    public struct Struct35<F, D, I, L>
    {
        public D _f1;
        public F _f2;
        public D _f3;
    ...
    public struct Struct36<F, D, I, L>
    {
        public D _f1;
        public I _f2;
        public D _f3;
    ...
    public struct Struct37<F, D, I, L>
    {
        public D _f1;
        public L _f2;
        public D _f3;
    ...
    public struct Struct40<F, D, I, L>
    {
        public F _f1;
        public F _f2;
        public F _f3;
    ...
    public struct Struct41<F, D, I, L>
    {
        public F _f1;
        public F _f2;
        public F _f3;
    ...
    public struct Struct42<F, D, I, L>
    {
        public F _f1;
        public F _f2;
        public F _f3;
    ...
    public struct Struct43<F, D, I, L>
    {
        public F _f1;
        public F _f2;
        public F _f3;
    ...
    public struct Struct44<F, D, I, L>
    {
        public D _f1;
        public D _f2;
        public D _f3;
    ...
    public struct Struct45<F, D, I, L>
    {
        public D _f1;
        public D _f2;
        public D _f3;
    ...
    public struct Struct46<F, D, I, L>
    {
        public D _f1;
        public D _f2;
        public D _f3;
    ...
    public struct Struct47<F, D, I, L>
    {
        public D _f1;
        public D _f2;
        public D _f3;
    ...
    public struct FComplex00<F, D, I, L>
    {
        public F _f1;
        public Struct00<F, D, I, L> _f2;
    }

    public struct FComplex01<F, D, I, L>
    {
        public F _f1;
        public Struct01<F, D, I, L> _f2;
    }

    public struct FComplex02<F, D, I, L>
    {
        public F _f1;
        public Struct02<F, D, I, L> _f2;
    }

    public struct FComplex03<F, D, I, L>
    {
        public F _f1;
        public Struct03<F, D, I, L> _f2;
    }

    public struct FComplex10<F, D, I, L>
    {
        public F _f1;
        public Struct20<F, D, I, L> _f2;
    }

    public struct FComplex11<F, D, I, L>
    {
        public F _f1;
        public Struct21<F, D, I, L> _f2;
    }

    public struct FComplex12<F, D, I, L>
    {
        public F _f1;
        public Struct22<F, D, I, L> _f2;
    }

    public struct FComplex13<F, D, I, L>
    {
        public F _f1;
        public Struct23<F, D, I, L> _f2;
    }

    public struct FComplex14<F, D, I, L>
    {
        public F _f1;
        public Struct24<F, D, I, L> _f2;
    }

    public struct FComplex15<F, D, I, L>
    {
        public F _f1;
        public Struct25<F, D, I, L> _f2;
    }

    public struct FComplex16<F, D, I, L>
    {
        public F _f1;
        public Struct26<F, D, I, L> _f2;
    }

    public struct FComplex17<F, D, I, L>
    {
        public F _f1;
        public Struct27<F, D, I, L> _f2;
    }

    public struct DComplex00<F, D, I, L>
    {
        public D _f1;
        public Struct00<F, D, I, L> _f2;
    }

    public struct DComplex01<F, D, I, L>
    {
        public D _f1;
        public Struct01<F, D, I, L> _f2;
    }

    public struct DComplex02<F, D, I, L>
    {
        public D _f1;
        public Struct02<F, D, I, L> _f2;
    }

    public struct DComplex03<F, D, I, L>
    {
        public D _f1;
        public Struct03<F, D, I, L> _f2;
    }

    public struct DComplex10<F, D, I, L>
    {
        public D _f1;
        public Struct20<F, D, I, L> _f2;
    }

    public struct DComplex11<F, D, I, L>
    {
        public D _f1;
        public Struct21<F, D, I, L> _f2;
    }

    public struct DComplex12<F, D, I, L>
    {
        public D _f1;
        public Struct22<F, D, I, L> _f2;
    }

    public struct DComplex13<F, D, I, L>
    {
        public D _f1;
        public Struct23<F, D, I, L> _f2;
    }

    public struct DComplex14<F, D, I, L>
    {
        public D _f1;
        public Struct24<F, D, I, L> _f2;
    }

    public struct DComplex15<F, D, I, L>
    {
        public D _f1;
        public Struct25<F, D, I, L> _f2;
    }

    public struct DComplex16<F, D, I, L>
    {
        public D _f1;
        public Struct26<F, D, I, L> _f2;
    }

    public struct DComplex17<F, D, I, L>
    {
        public D _f1;
        public Struct27<F, D, I, L> _f2;
    }

    public struct Floats3<F, D, I, L>
    {
        public F _f1;
        public F _f2;
        public F _f3;
    ...
    public struct Floats3Complex<F, D, I, L>
    {
        public Floats3<F, D, I, L> _f1;
    }

    public struct Floats4Complex1<F, D, I, L>
    {
        public Floats3<F, D, I, L> _f1;
        public F _f2;
    }

    public struct Floats4Complex2<F, D, I, L>
    {
        public Floats4<F, D, I, L> _f1;
    }

    public struct Floats4Complex3<F, D, I, L>
    {
        public Floats4<F, D, I, L> _f1;
        public F _f2;
    }

    public struct Doubles3<F, D, I, L>
    {
        public D _f1;
        public D _f2;
        public D _f3;
    ...
    public struct Doubles4<F, D, I, L>
    {
        public D _f1;
        public D _f2;
        public D _f3;
    ...
    public struct Doubles3Complex<F, D, I, L>
    {
        public Doubles3<F, D, I, L> _f1;
    }

    public struct Doubles4Complex1<F, D, I, L>
    {
        public Doubles3<F, D, I, L> _f1;
        public D _f2;
    }

    public struct Doubles4Complex2<F, D, I, L>
    {
        public Doubles4<F, D, I, L> _f1;
    }

    public struct Doubles4Complex3<F, D, I, L>
    {
        public Doubles4<F, D, I, L> _f1;
        public D _f2;
    }

    public struct GenStructWrapper<T>
    {
        public T _f1;
    }
    ...
    public class TestClass<T>
    {
        ...
        static void CheckFieldValues(object obj, TypeInfo ti, object[] values, int index)
        {
            for (int i = 1; i <= 5; i++)
            {
                ...
                if (
                    fi.FieldType.Name.Contains("Struct")
                    || fi.FieldType.Name.Contains("Floats")
                    || fi.FieldType.Name.Contains("Doubles")
                    || fi.DeclaringType.Name.Contains("GenStructWrapper")
                )
                {
    ...
    public class Runner
    {
        ...
        {
            Type genStructInst = structType.MakeGenericType(
                TypeOf.Float,
                TypeOf.Double,
                TypeOf.Int32,
                TypeOf.Long
...

            {
                TypeOf.HFA_TestClass
                    ...
                    .Invoke(null, GetInstanceAndValuesArray(genStructInst));
            }

            {
                ...
                TypeOf.HFA_TestClass
                    ...
                    .GetTypeInfo()
                    .GetDeclaredMethod("TestStruct")
                    .Invoke(null, GetInstanceAndValuesArray(genStructWrapper));
            }
        }
...
namespace ComparerOfTTests
{
    ...
    struct StructThatImplementsIComparable : IComparable<StructThatImplementsIComparable>
    {
        ...
        int IComparable<StructThatImplementsIComparable>.CompareTo(
            StructThatImplementsIComparable other
        )
        {
            if (_x == other._x)
                return 0;
    ...
    public class DerivedType<T, V> : BaseType
    {
        private static void TestC(T x, T y)
        {
            ...
            else if (x is StructThatImplementsIComparable?)
            {
                ...
                {
                    IComparable<StructThatImplementsIComparable> xv = (
                        (StructThatImplementsIComparable?)(object)x
                    ).Value;
                    StructThatImplementsIComparable yv = (
                        (StructThatImplementsIComparable?)(object)y
                    ).Value;
    ...
    public class Runner
    {
        ...
        {
            Type t = typeof(DerivedType<,>).MakeGenericType(
                typeof(StructThatImplementsIComparable),
                TypeOf.Short
            );
            BaseType o = (BaseType)Activator.CreateInstance(t);
        ...
        {
            Type t = typeof(DerivedType<,>).MakeGenericType(
                typeof(StructThatImplementsIComparableOfObject),
                TypeOf.Short
            );
            BaseType o = (BaseType)Activator.CreateInstance(t);
...
namespace ArrayOfGenericStructGCTests
{
    ...
    [StructLayout(LayoutKind.Sequential)]
    public class ClassWithNonPointerSizedFinalFieldBase2<T>
        : ClassWithNonPointerSizedFinalFieldBase<T>
    {
        public object o3;
        public object o4;
        public byte b2;
    ...
    public class Runner
    {
        ...
        {
            Type t = typeof(Derived<,,>).MakeGenericType(
                typeof(StructWithGCReference),
                typeof(StructWithoutGCReference),
                TypeOf.Short
            );
            Base o = (Base)Activator.CreateInstance(t);
            ...
            GenericStruct<object, IntPtr, bool> tempStruct =
                new GenericStruct<object, IntPtr, bool>();
...
namespace DelegatesToStructMethods
{
    ...
    public class Runner
    {
        ...
        {
            MethodInfo testMi = typeof(Runner)
                .GetTypeInfo()
                .GetDeclaredMethod("TestDelegateInvokeToMethods_Inner")
                .MakeGenericMethod(TypeOf.Short);

            testMi.Invoke(
                null,
                new object[] { (short)44, (short)55, "StructFunc", "GenStructFunc", true }
            );
            testMi.Invoke(
                null,
                new object[] { (short)44, (short)55, "ClassFunc", "GenClassFunc", false }
            );
        }
        ...
        public static void TestDelegateInvokeToMethods_Inner<T>(
            T tval1,
            T tval2,
            string funcName,
            string genFuncName,
        ...
        )
        {
            // USG case
            {
                ...
                {
                    MethodInfo delCreator = t.GetTypeInfo()
                        .GetDeclaredMethod("SimpleDelegateCreator");
                    MethodInfo genDelCreator = t.GetTypeInfo()
                        .GetDeclaredMethod("SimpleGenDelegateCreator");

                    MethodInfo mi = t.GetTypeInfo().GetDeclaredMethod(funcName);
                    Func<short, string> del1 =
                        (Func<short, string>)mi.CreateDelegate(typeof(Func<short, string>), o);
                    ...
                    MethodInfo miGen = t.GetTypeInfo()
                        .GetDeclaredMethod(genFuncName)
                        .MakeGenericMethod(TypeOf.Short);
                    Func<short, string> genDel1 =
                        (Func<short, string>)miGen.CreateDelegate(typeof(Func<short, string>), o);
                    Func<short, string> genDel2 =
                        (Func<short, string>)genDelCreator.Invoke(o, null);
                ...
                {
                    MethodInfo delCreator = t.GetTypeInfo()
                        .GetDeclaredMethod("ComplexDelegateCreator");
                    MethodInfo genDelCreator = t.GetTypeInfo()
                        .GetDeclaredMethod("ComplexGenDelegateCreator");

                    MethodInfo mi = t.GetTypeInfo().GetDeclaredMethod(funcName + "NeedingCCC");
                    Func<T, string> del1 =
                        (Func<T, string>)mi.CreateDelegate(typeof(Func<T, string>), o);
                    ...
                    MethodInfo miGen = t.GetTypeInfo()
                        .GetDeclaredMethod(genFuncName + "NeedingCCC")
                        .MakeGenericMethod(TypeOf.Short);
                    Func<T, string> genDel1 =
                        (Func<T, string>)miGen.CreateDelegate(typeof(Func<T, string>), o);
