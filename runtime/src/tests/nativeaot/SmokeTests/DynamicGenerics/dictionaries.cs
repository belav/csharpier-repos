...
namespace Dictionaries
{
    ...
    public class DictionariesTest
    {
        ...
        public static void TestBasicDictionaryEntryTypes()
        {
            ...
            Type singleUseArrayOnlyGenOfType = TypeOf.D_SingleUseArrayOnlyGen
    ...
    public class CallerType<X, Y>
    {
        public string CallerMethod(int testId)
        {
            switch (testId)
            {
                ...
                case 8:
                    return TestClass<I3<I2<I1<X, Y>>>>.NestedGenTestClass<K3<K2<K1<X, Y>>>>
                        .MyMethod();
                case 9:
                    return TestClass<J3<J2<J1<X, Y>>>>.NestedGenTestClass<L3<L2<L1<X, Y>>>>
                        .MyGenMethod<X>();
                ...
                case 13:
                    return TestClass.NestedTestClass
                        .MyGenMethod<P3<P2<P1<X, Y>.Nested>.Nested>.Nested>();
                case 14:
                    return TestClass.NestedGenTestClass<Q3<Q2<Q1<X, Y>.Nested>.Nested>.Nested>
                        .MyMethod();
                case 15:
                    return TestClass.NestedGenTestClass<R3<R2<R1<X, Y>.Nested>.Nested>.Nested>
                        .MyGenMethod<X>();
            }
            return null;
        }
