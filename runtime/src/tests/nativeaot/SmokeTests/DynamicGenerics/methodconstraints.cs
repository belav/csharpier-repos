...
public class MethodConstraintsTests
{
    ...
    {
        return t.GetTypeInfo().GetDeclaredMethod("Method").MakeGenericMethod(genArg);
    }

    static MethodInfo MakeGenericMethod(Type t, Type genArg1, Type genArg2)
    {
        return t.GetTypeInfo().GetDeclaredMethod("Method").MakeGenericMethod(genArg1, genArg2);
    }
    ...
    public static void TestTypeConstraints()
    {
        ...
        MakeGenericMethod(
            TypeOf.MCT_GenericType.MakeGenericType(new Type[] { typeof(object), typeof(object) }),
            typeof(String)
        );
