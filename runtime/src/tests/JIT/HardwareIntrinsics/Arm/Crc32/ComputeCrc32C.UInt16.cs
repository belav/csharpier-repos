...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    public sealed unsafe class ScalarBinaryOpTest__ComputeCrc32C_UInt16
    {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Crc32)
                .GetMethod(
                    ...
                    new Type[] { typeof(UInt32), typeof(UInt16) }
                )
                .Invoke(
                    null,
                    new object[]
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Crc32.ComputeCrc32C(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            uint expectedResult = 0x9F50ACBD;
            ...
            if (isUnexpectedResult)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Crc32)}.{nameof(Crc32.ComputeCrc32C)}<UInt32>(UInt32, UInt16): ComputeCrc32C failed:"
                    );
