    ...
    public sealed unsafe class SecureHashTernaryOpTest__HashUpdate1_Vector128_UInt32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SecureHashTernaryOpTest__HashUpdate1_Vector128_UInt32 testClass
            )
            {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Sha256.HashUpdate1(_clsVar1, _clsVar2, _clsVar3);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Sha256)}.{nameof(Sha256.HashUpdate1)}<UInt32>(Vector128<UInt32>, Vector128<UInt32>, Vector128<UInt32>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
