    ...
    public sealed unsafe class SecureHashTernaryOpTest__HashUpdate2_Vector128_UInt32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SecureHashTernaryOpTest__HashUpdate2_Vector128_UInt32 testClass
            )
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Sha256).GetMethod(
                    nameof(Sha256.HashUpdate2),
                    new Type[]
                    {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Sha256.HashUpdate2(_clsVar1, _clsVar2, _clsVar3);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(Sha256)}.{nameof(Sha256.HashUpdate2)}<UInt32>(Vector128<UInt32>, Vector128<UInt32>, Vector128<UInt32>): {method} failed:"
                );
                TestLibrary.TestFramework.LogInformation(
