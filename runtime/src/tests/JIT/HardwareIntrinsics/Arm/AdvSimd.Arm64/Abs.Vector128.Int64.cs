...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    public sealed unsafe class SimpleUnaryOpTest__Abs_Vector128_Int64
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleUnaryOpTest__Abs_Vector128_Int64 testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleUnaryOpTest__Abs_Vector128_Int64 testClass)
            {
                fixed (Vector128<Int64>* pFld1 = &_fld1)
                {
                    var result = AdvSimd.Arm64.Abs(AdvSimd.LoadVector128((Int64*)(pFld1)));
        ...
        static SimpleUnaryOpTest__Abs_Vector128_Int64()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = -TestLibrary.Generator.GetInt64();
        ...
        public SimpleUnaryOpTest__Abs_Vector128_Int64()
        {
            Succeeded = true;
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.Arm64.Abs(Unsafe.Read<Vector128<Int64>>(_dataTable.inArray1Ptr));
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var result = AdvSimd.Arm64.Abs(AdvSimd.LoadVector128((Int64*)(_dataTable.inArray1Ptr)));
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64)
                .GetMethod(nameof(AdvSimd.Arm64.Abs), new Type[] { typeof(Vector128<Int64>) })
                .Invoke(
                    null,
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.Arm64.Abs(_clsVar1);
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            {
                var result = AdvSimd.Arm64.Abs(AdvSimd.LoadVector128((Int64*)(pClsVar1)));
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = AdvSimd.Arm64.Abs(AdvSimd.LoadVector128((Int64*)(&test._fld1)));
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.Abs)}<UInt64>(Vector128<Int64>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
