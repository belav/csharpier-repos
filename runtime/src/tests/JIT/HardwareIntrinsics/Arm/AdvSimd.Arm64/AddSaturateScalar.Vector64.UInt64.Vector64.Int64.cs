...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void AddSaturateScalar_Vector64_UInt64_Vector64_Int64()
        {
            var test = new SimpleBinaryOpTest__AddSaturateScalar_Vector64_UInt64_Vector64_Int64();
    ...
    public sealed unsafe class SimpleBinaryOpTest__AddSaturateScalar_Vector64_UInt64_Vector64_Int64
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__AddSaturateScalar_Vector64_UInt64_Vector64_Int64 testClass
            )
            {
        ...
        static SimpleBinaryOpTest__AddSaturateScalar_Vector64_UInt64_Vector64_Int64()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetUInt64();
        ...
        public SimpleBinaryOpTest__AddSaturateScalar_Vector64_UInt64_Vector64_Int64()
        {
            Succeeded = true;
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.AddSaturateScalar)}<UInt64>(Vector64<UInt64>, Vector64<Int64>): {method} failed:"
                    );
