    ...
    public sealed unsafe class SimpleUnaryOpTest__AbsSaturateScalar_Vector64_Int16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__AbsSaturateScalar_Vector64_Int16 testClass
            )
            {
            ...
            )
            {
                fixed (Vector64<Int16>* pFld1 = &_fld1)
                {
                    var result = AdvSimd
                        .Arm64
                        .AbsSaturateScalar(AdvSimd.LoadVector64((Int16*)(pFld1)));
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd
                .Arm64
                .AbsSaturateScalar(Unsafe.Read<Vector64<Int16>>(_dataTable.inArray1Ptr));
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var result = AdvSimd
                .Arm64
                .AbsSaturateScalar(AdvSimd.LoadVector64((Int16*)(_dataTable.inArray1Ptr)));
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            fixed (Vector64<Int16>* pClsVar1 = &_clsVar1)
            {
                var result = AdvSimd
                    .Arm64
                    .AbsSaturateScalar(AdvSimd.LoadVector64((Int16*)(pClsVar1)));
        ...
        public void RunClassLclFldScenario_Load()
        {
            ...
            {
                var result = AdvSimd.Arm64.AbsSaturateScalar(AdvSimd.LoadVector64((Int16*)(pFld1)));
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var result = AdvSimd
                .Arm64
                .AbsSaturateScalar(AdvSimd.LoadVector64((Int16*)(&test._fld1)));
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.AbsSaturateScalar)}<Int16>(Vector64<Int16>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
