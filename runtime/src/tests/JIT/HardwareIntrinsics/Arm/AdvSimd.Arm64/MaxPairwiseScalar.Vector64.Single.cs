...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    public sealed unsafe class SimpleUnaryOpTest__MaxPairwiseScalar_Vector64_Single
    {
        ...
        private struct TestStruct
        {
            ...
            )
            {
                fixed (Vector64<Single>* pFld1 = &_fld1)
                {
                    var result = AdvSimd
                        .Arm64
                        .MaxPairwiseScalar(AdvSimd.LoadVector64((Single*)(pFld1)));
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd
                .Arm64
                .MaxPairwiseScalar(Unsafe.Read<Vector64<Single>>(_dataTable.inArray1Ptr));
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var result = AdvSimd
                .Arm64
                .MaxPairwiseScalar(AdvSimd.LoadVector64((Single*)(_dataTable.inArray1Ptr)));
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            fixed (Vector64<Single>* pClsVar1 = &_clsVar1)
            {
                var result = AdvSimd
                    .Arm64
                    .MaxPairwiseScalar(AdvSimd.LoadVector64((Single*)(pClsVar1)));
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var result = AdvSimd
                .Arm64
                .MaxPairwiseScalar(AdvSimd.LoadVector64((Single*)(&test._fld1)));
