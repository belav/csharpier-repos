    ...
    public sealed unsafe class SimpleBinaryOpTest__Max_Vector128_Double
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario_Load(
                SimpleBinaryOpTest__Max_Vector128_Double testClass
            )
            {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.Arm64.Max(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            {
                if (
                    BitConverter.DoubleToInt64Bits(Helpers.Max(left[i], right[i]))
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.Max)}<Double>(Vector128<Double>, Vector128<Double>): {method} failed:"
                    );
