...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void AddSaturate_Vector128_Int64_Vector128_UInt64()
        {
            var test = new SimpleBinaryOpTest__AddSaturate_Vector128_Int64_Vector128_UInt64();
    ...
    public sealed unsafe class SimpleBinaryOpTest__AddSaturate_Vector128_Int64_Vector128_UInt64
    {
        private struct DataTable
        {
            ...
            public DataTable(Int64[] inArray1, UInt64[] inArray2, Int64[] outArray, int alignment)
            {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__AddSaturate_Vector128_Int64_Vector128_UInt64 testClass
            ) {
            ...
            public void RunStructFldScenario_Load(
                ...
                fixed (Vector128<Int64>* pFld1 = &_fld1)fixed (Vector128<UInt64>* pFld2 = &_fld2)
                {
        ...
        static SimpleBinaryOpTest__AddSaturate_Vector128_Int64_Vector128_UInt64()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetInt64();
        ...
        public SimpleBinaryOpTest__AddSaturate_Vector128_Int64_Vector128_UInt64()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64).GetMethod(
                    ...
                    new Type[] { typeof(Vector128<Int64>), typeof(Vector128<UInt64>) }
                )
                .Invoke(
                    null,
                    new object[]
        ...
        private void ValidateResult(
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.AddSaturate)}<Int64>(Vector128<Int64>, Vector128<UInt64>): {method} failed:"
                );
