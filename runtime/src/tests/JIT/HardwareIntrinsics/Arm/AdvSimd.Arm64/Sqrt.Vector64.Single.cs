    ...
    public sealed unsafe class SimpleUnaryOpTest__Sqrt_Vector64_Single
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario_Load(SimpleUnaryOpTest__Sqrt_Vector64_Single testClass)
            {
                ...
                {
                    var result = AdvSimd.Arm64.Sqrt(AdvSimd.LoadVector64((Single*)(pFld1)));
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.Arm64.Sqrt(Unsafe.Read<Vector64<Single>>(_dataTable.inArray1Ptr));
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            {
                var result = AdvSimd.Arm64.Sqrt(AdvSimd.LoadVector64((Single*)(pClsVar1)));
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = AdvSimd.Arm64.Sqrt(AdvSimd.LoadVector64((Single*)(&test._fld1)));
