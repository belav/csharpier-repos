    ...
    public sealed unsafe class ImmUnaryOpTest__ShiftLeftLogicalSaturateScalar_Vector64_Int32_31
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                ImmUnaryOpTest__ShiftLeftLogicalSaturateScalar_Vector64_Int32_31 testClass
            )
            {
            ...
            )
            {
                fixed (Vector64<Int32>* pFld = &_fld)
                {
                    var result = AdvSimd
                        .Arm64
                        .ShiftLeftLogicalSaturateScalar(AdvSimd.LoadVector64((Int32*)(pFld)), 31);
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64)
                ...
                .Invoke(
                    null,
                    new object[] { Unsafe.Read<Vector64<Int32>>(_dataTable.inArrayPtr), (byte)31 }
                );
        ...
        public void RunReflectionScenario_Load()
        {
            ...
            var result = typeof(AdvSimd.Arm64)
                ...
                .Invoke(
                    null,
                    new object[] { AdvSimd.LoadVector64((Int32*)(_dataTable.inArrayPtr)), (byte)31 }
                );
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.Arm64.ShiftLeftLogicalSaturateScalar(_clsVar, 31);
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            fixed (Vector64<Int32>* pClsVar = &_clsVar)
            {
                var result = AdvSimd
                    .Arm64
                    .ShiftLeftLogicalSaturateScalar(AdvSimd.LoadVector64((Int32*)(pClsVar)), 31);
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var result = AdvSimd
                .Arm64
                .ShiftLeftLogicalSaturateScalar(AdvSimd.LoadVector64((Int32*)(&test._fld)), 31);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.ShiftLeftLogicalSaturateScalar)}<Int32>(Vector64<Int32>, 31): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
