    ...
    public sealed unsafe class StoreBinaryOpTest__StorePair_Vector64_Double
    {
        ...
        )
        {
            ...
            Unsafe.CopyBlockUnaligned(
                ...
                (uint)(RetElementCount * Unsafe.SizeOf<Double>())
            );
        ...
        )
        {
            ...
            {
                if (
                    BitConverter.DoubleToInt64Bits(Helpers.Concat(firstOp, secondOp, i))
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.StorePair)}<Double>(Vector64<Double>, Vector64<Double>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
