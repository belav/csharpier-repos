    ...
    public sealed unsafe class SimpleUnaryOpTest__NegateSaturate_Vector128_Int64
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__NegateSaturate_Vector128_Int64 testClass
            )
            {
            ...
            )
            {
                fixed (Vector128<Int64>* pFld1 = &_fld1)
                {
                    var result = AdvSimd
                        .Arm64
                        .NegateSaturate(AdvSimd.LoadVector128((Int64*)(pFld1)));
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd
                .Arm64
                .NegateSaturate(Unsafe.Read<Vector128<Int64>>(_dataTable.inArray1Ptr));
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var result = AdvSimd
                .Arm64
                .NegateSaturate(AdvSimd.LoadVector128((Int64*)(_dataTable.inArray1Ptr)));
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64)
                .GetMethod(
                    nameof(AdvSimd.Arm64.NegateSaturate),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.Arm64.NegateSaturate(_clsVar1);
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            fixed (Vector128<Int64>* pClsVar1 = &_clsVar1)
            {
                var result = AdvSimd
                    .Arm64
                    .NegateSaturate(AdvSimd.LoadVector128((Int64*)(pClsVar1)));
        ...
        public void RunClassLclFldScenario_Load()
        {
            ...
            {
                var result = AdvSimd.Arm64.NegateSaturate(AdvSimd.LoadVector128((Int64*)(pFld1)));
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = AdvSimd.Arm64.NegateSaturate(AdvSimd.LoadVector128((Int64*)(&test._fld1)));
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.NegateSaturate)}<Int64>(Vector128<Int64>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
