...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void MultiplyDoublingWideningAndAddSaturateScalar_Vector64_Int32()
        {
            var test =
                new SimpleTernaryOpTest__MultiplyDoublingWideningAndAddSaturateScalar_Vector64_Int32();
    ...
    public sealed unsafe class SimpleTernaryOpTest__MultiplyDoublingWideningAndAddSaturateScalar_Vector64_Int32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleTernaryOpTest__MultiplyDoublingWideningAndAddSaturateScalar_Vector64_Int32 testClass
            ) {
                var result = AdvSimd.Arm64.MultiplyDoublingWideningAndAddSaturateScalar(
                    _fld1,
                    _fld2,
                    _fld3
                );
            ...
            public void RunStructFldScenario_Load(
                ...
                fixed (Vector64<Int64>* pFld1 = &_fld1)fixed (
        ...
        static SimpleTernaryOpTest__MultiplyDoublingWideningAndAddSaturateScalar_Vector64_Int32()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetInt64();
        ...
        public SimpleTernaryOpTest__MultiplyDoublingWideningAndAddSaturateScalar_Vector64_Int32()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64).GetMethod(
                    nameof(AdvSimd.Arm64.MultiplyDoublingWideningAndAddSaturateScalar),
                    new Type[]
                    {
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.Arm64.MultiplyDoublingWideningAndAddSaturateScalar(op1, op2, op3);
        ...
        public void RunClassLclFldScenario_Load()
        {
            ...
            fixed (Vector64<Int64>* pFld1 = &test._fld1)fixed (
        ...
        public void RunClassFldScenario_Load()
        {
            ...
            fixed (Vector64<Int64>* pFld1 = &_fld1)fixed (Vector64<Int32>* pFld2 = &_fld2)fixed (
        ...
        private void ValidateResult(
            ...
            if (
                Helpers.MultiplyDoublingWideningAndAddSaturate(firstOp[0], secondOp[0], thirdOp[0])
                != result[0]
            ) {
                succeeded = false;
            }
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.MultiplyDoublingWideningAndAddSaturateScalar)}<Int64>(Vector64<Int64>, Vector64<Int32>, Vector64<Int32>): {method} failed:"
                );
                TestLibrary.TestFramework.LogInformation(
