    ...
    public sealed unsafe class ImmUnaryOpTest__ShiftLeftLogicalSaturateScalar_Vector64_Int16_15
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                ImmUnaryOpTest__ShiftLeftLogicalSaturateScalar_Vector64_Int16_15 testClass
            )
            {
            ...
            )
            {
                fixed (Vector64<Int16>* pFld = &_fld)
                {
                    var result = AdvSimd
                        .Arm64
                        .ShiftLeftLogicalSaturateScalar(AdvSimd.LoadVector64((Int16*)(pFld)), 15);
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64)
                .GetMethod(
                    nameof(AdvSimd.Arm64.ShiftLeftLogicalSaturateScalar),
                    new Type[] { typeof(Vector64<Int16>), typeof(byte) }
                )
                .Invoke(
                    null,
                    new object[] { Unsafe.Read<Vector64<Int16>>(_dataTable.inArrayPtr), (byte)15 }
                );
        ...
        public void RunReflectionScenario_Load()
        {
            ...
            var result = typeof(AdvSimd.Arm64)
                ...
                .Invoke(
                    null,
                    new object[] { AdvSimd.LoadVector64((Int16*)(_dataTable.inArrayPtr)), (byte)15 }
                );
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.Arm64.ShiftLeftLogicalSaturateScalar(_clsVar, 15);
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            fixed (Vector64<Int16>* pClsVar = &_clsVar)
            {
                var result = AdvSimd
                    .Arm64
                    .ShiftLeftLogicalSaturateScalar(AdvSimd.LoadVector64((Int16*)(pClsVar)), 15);
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var result = AdvSimd
                .Arm64
                .ShiftLeftLogicalSaturateScalar(AdvSimd.LoadVector64((Int16*)(&test._fld)), 15);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.ShiftLeftLogicalSaturateScalar)}<Int16>(Vector64<Int16>, 15): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
