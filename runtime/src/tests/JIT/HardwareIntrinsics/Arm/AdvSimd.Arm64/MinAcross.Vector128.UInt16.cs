    ...
    public sealed unsafe class SimpleUnaryOpTest__MinAcross_Vector128_UInt16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__MinAcross_Vector128_UInt16 testClass
            )
            {
            ...
            )
            {
                ...
                {
                    var result = AdvSimd.Arm64.MinAcross(AdvSimd.LoadVector128((UInt16*)(pFld1)));
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd
                .Arm64
                .MinAcross(Unsafe.Read<Vector128<UInt16>>(_dataTable.inArray1Ptr));
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var result = AdvSimd
                .Arm64
                .MinAcross(AdvSimd.LoadVector128((UInt16*)(_dataTable.inArray1Ptr)));
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            {
                var result = AdvSimd.Arm64.MinAcross(AdvSimd.LoadVector128((UInt16*)(pClsVar1)));
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = AdvSimd.Arm64.MinAcross(AdvSimd.LoadVector128((UInt16*)(&test._fld1)));
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.MinAcross)}<UInt16>(Vector128<UInt16>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
