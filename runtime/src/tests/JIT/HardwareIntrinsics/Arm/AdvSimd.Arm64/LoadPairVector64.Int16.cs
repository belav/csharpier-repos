...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void LoadPairVector64_Int16()
        {
            var test = new LoadPairVector64_Int16();
    ...
    public sealed unsafe class LoadPairVector64_Int16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(LoadPairVector64_Int16 testClass)
            {
        ...
        private static readonly int RetElementCount =
            Unsafe.SizeOf<(Vector64<Int16>, Vector64<Int16>)>() / sizeof(Int16);
        ...
        public void RunBasicScenario()
        {
            ...
            var result = AdvSimd.Arm64.LoadPairVector64((Int16*)(_dataTable.inArrayPtr));
        ...
        public void RunReflectionScenario()
        {
            ...
            var result = typeof(AdvSimd.Arm64)
                .GetMethod(nameof(AdvSimd.Arm64.LoadPairVector64), new Type[] { typeof(Int16*) })
        ...
        public void RunClsVarScenario()
        {
            ...
            _clsVar = AdvSimd.Arm64.LoadPairVector64((Int16*)(_dataTable.inArrayPtr));
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new LoadPairVector64_Int16();
            test._fld = AdvSimd.Arm64.LoadPairVector64((Int16*)(_dataTable.inArrayPtr));
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.LoadPairVector64)}<Int16>(Vector64<Int16>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
