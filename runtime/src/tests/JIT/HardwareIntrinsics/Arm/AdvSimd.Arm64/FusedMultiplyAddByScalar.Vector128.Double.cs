    ...
    public sealed unsafe class SimpleTernaryOpTest__FusedMultiplyAddByScalar_Vector128_Double
    {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64)
                .GetMethod(
                    nameof(AdvSimd.Arm64.FusedMultiplyAddByScalar),
                    new Type[]
                    {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.Arm64.FusedMultiplyAddByScalar(_clsVar1, _clsVar2, _clsVar3);
        ...
        )
        {
            ...
            for (var i = 0; i < RetElementCount; i++)
            {
                if (
                    BitConverter.DoubleToInt64Bits(
                        Helpers.FusedMultiplyAdd(firstOp[i], secondOp[i], thirdOp[0])
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.FusedMultiplyAddByScalar)}<Double>(Vector128<Double>, Vector128<Double>, Vector64<Double>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
