    ...
    public sealed unsafe class SimpleBinaryOpTest__AddSaturate_Vector128_SByte_Vector128_Byte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__AddSaturate_Vector128_SByte_Vector128_Byte testClass
            ) {
            ...
            public void RunStructFldScenario_Load(
                ...
                fixed (Vector128<SByte>* pFld1 = &_fld1)fixed (Vector128<Byte>* pFld2 = &_fld2)
                {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64).GetMethod(
                    ...
                    new Type[] { typeof(Vector128<SByte>), typeof(Vector128<Byte>) }
                )
                .Invoke(
                    null,
                    new object[]
        ...
        private void ValidateResult(
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.AddSaturate)}<SByte>(Vector128<SByte>, Vector128<Byte>): {method} failed:"
                );
