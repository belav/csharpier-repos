    ...
    public sealed unsafe class ImmUnaryOpTest__ShiftLeftLogicalSaturateScalar_Vector64_UInt16_1
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                ImmUnaryOpTest__ShiftLeftLogicalSaturateScalar_Vector64_UInt16_1 testClass
            )
            {
            ...
            )
            {
                fixed (Vector64<UInt16>* pFld = &_fld)
                {
                    var result = AdvSimd
                        .Arm64
                        .ShiftLeftLogicalSaturateScalar(AdvSimd.LoadVector64((UInt16*)(pFld)), 1);
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.Arm64.ShiftLeftLogicalSaturateScalar(_clsVar, 1);
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            fixed (Vector64<UInt16>* pClsVar = &_clsVar)
            {
                var result = AdvSimd
                    .Arm64
                    .ShiftLeftLogicalSaturateScalar(AdvSimd.LoadVector64((UInt16*)(pClsVar)), 1);
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var result = AdvSimd
                .Arm64
                .ShiftLeftLogicalSaturateScalar(AdvSimd.LoadVector64((UInt16*)(&test._fld)), 1);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.ShiftLeftLogicalSaturateScalar)}<UInt16>(Vector64<UInt16>, 1): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
