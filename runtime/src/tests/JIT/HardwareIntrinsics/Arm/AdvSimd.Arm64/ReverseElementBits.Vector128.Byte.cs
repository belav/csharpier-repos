    ...
    public sealed unsafe class SimpleUnaryOpTest__ReverseElementBits_Vector128_Byte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__ReverseElementBits_Vector128_Byte testClass
            )
            {
            ...
            )
            {
                fixed (Vector128<Byte>* pFld1 = &_fld1)
                {
                    var result = AdvSimd
                        .Arm64
                        .ReverseElementBits(AdvSimd.LoadVector128((Byte*)(pFld1)));
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd
                .Arm64
                .ReverseElementBits(Unsafe.Read<Vector128<Byte>>(_dataTable.inArray1Ptr));
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var result = AdvSimd
                .Arm64
                .ReverseElementBits(AdvSimd.LoadVector128((Byte*)(_dataTable.inArray1Ptr)));
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            fixed (Vector128<Byte>* pClsVar1 = &_clsVar1)
            {
                var result = AdvSimd
                    .Arm64
                    .ReverseElementBits(AdvSimd.LoadVector128((Byte*)(pClsVar1)));
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var result = AdvSimd
                .Arm64
                .ReverseElementBits(AdvSimd.LoadVector128((Byte*)(&test._fld1)));
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.ReverseElementBits)}<Byte>(Vector128<Byte>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
