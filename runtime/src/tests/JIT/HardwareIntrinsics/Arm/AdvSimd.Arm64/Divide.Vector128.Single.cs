...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void Divide_Vector128_Single()
        {
    ...
    public sealed unsafe class SimpleBinaryOpTest__Divide_Vector128_Single
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__Divide_Vector128_Single testClass)
            {
        ...
        static SimpleBinaryOpTest__Divide_Vector128_Single()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetSingle();
        ...
        public SimpleBinaryOpTest__Divide_Vector128_Single()
        {
            Succeeded = true;
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.Arm64.Divide(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            {
                if (
                    BitConverter.SingleToInt32Bits(Helpers.Divide(left[i], right[i]))
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.Divide)}<Single>(Vector128<Single>, Vector128<Single>): {method} failed:"
                    );
