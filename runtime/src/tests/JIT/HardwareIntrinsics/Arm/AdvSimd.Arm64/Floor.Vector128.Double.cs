...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void Floor_Vector128_Double()
        {
            var test = new SimpleUnaryOpTest__Floor_Vector128_Double();
    ...
    public sealed unsafe class SimpleUnaryOpTest__Floor_Vector128_Double
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleUnaryOpTest__Floor_Vector128_Double testClass)
            {
                var result = AdvSimd.Arm64.Floor(_fld1);
            ...
            public void RunStructFldScenario_Load(
                SimpleUnaryOpTest__Floor_Vector128_Double testClass
            )
            {
                fixed (Vector128<Double>* pFld1 = &_fld1)
                {
                    var result = AdvSimd.Arm64.Floor(AdvSimd.LoadVector128((Double*)(pFld1)));
        ...
        static SimpleUnaryOpTest__Floor_Vector128_Double()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetDouble();
        ...
        public SimpleUnaryOpTest__Floor_Vector128_Double()
        {
            Succeeded = true;
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.Arm64.Floor(_clsVar1);
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            {
                var result = AdvSimd.Arm64.Floor(AdvSimd.LoadVector128((Double*)(pClsVar1)));
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.Arm64.Floor(op1);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimpleUnaryOpTest__Floor_Vector128_Double();
            var result = AdvSimd.Arm64.Floor(test._fld1);
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = AdvSimd.Arm64.Floor(AdvSimd.LoadVector128((Double*)(&test._fld1)));
        ...
        )
        {
            ...
            {
                if (
                    BitConverter.DoubleToInt64Bits(Helpers.Floor(firstOp[i]))
