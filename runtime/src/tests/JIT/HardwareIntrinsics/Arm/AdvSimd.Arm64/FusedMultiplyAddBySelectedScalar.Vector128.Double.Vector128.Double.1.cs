...
namespace JIT.HardwareIntrinsics.Arm
{
    public static partial class Program
    {
        ...
        {
            var test =
                new SimpleTernaryOpTest__FusedMultiplyAddBySelectedScalar_Vector128_Double_Vector128_Double_1();
    ...
    public sealed unsafe class SimpleTernaryOpTest__FusedMultiplyAddBySelectedScalar_Vector128_Double_Vector128_Double_1
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleTernaryOpTest__FusedMultiplyAddBySelectedScalar_Vector128_Double_Vector128_Double_1 testClass
            )
            {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd
                .Arm64
                .FusedMultiplyAddBySelectedScalar(_clsVar1, _clsVar2, _clsVar3, 1);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var result = AdvSimd
                .Arm64
                .FusedMultiplyAddBySelectedScalar(test._fld1, test._fld2, test._fld3, 1);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.FusedMultiplyAddBySelectedScalar)}<Double>(Vector128<Double>, Vector128<Double>, Vector128<Double>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
