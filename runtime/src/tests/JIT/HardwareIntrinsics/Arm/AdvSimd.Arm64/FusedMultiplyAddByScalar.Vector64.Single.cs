    ...
    public sealed unsafe class SimpleTernaryOpTest__FusedMultiplyAddByScalar_Vector64_Single
    {
        ...
        private struct TestStruct
        {
            ...
            public static TestStruct Create()
            {
                ...
                Unsafe.CopyBlockUnaligned(
                    ref Unsafe.As<Vector64<Single>, byte>(ref testStruct._fld3),
            ...
            public void RunStructFldScenario(
                SimpleTernaryOpTest__FusedMultiplyAddByScalar_Vector64_Single testClass
            )
            {
        ...
        static SimpleTernaryOpTest__FusedMultiplyAddByScalar_Vector64_Single()
        {
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector64<Single>, byte>(ref _clsVar3),
                ref Unsafe.As<Single, byte>(ref _data3[0]),
                (uint)Unsafe.SizeOf<Vector64<Single>>()
            );
        }
        ...
        public SimpleTernaryOpTest__FusedMultiplyAddByScalar_Vector64_Single()
        {
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector64<Single>, byte>(ref _fld3),
                ref Unsafe.As<Single, byte>(ref _data3[0]),
                (uint)Unsafe.SizeOf<Vector64<Single>>()
            );
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.FusedMultiplyAddByScalar)}<Single>(Vector64<Single>, Vector64<Single>, Vector64<Single>): {method} failed:"
                );
                TestLibrary.TestFramework.LogInformation(
