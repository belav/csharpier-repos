...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void LoadPairVector128NonTemporal_Int64()
        {
            var test = new LoadPairVector128NonTemporal_Int64();
    ...
    public sealed unsafe class LoadPairVector128NonTemporal_Int64
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(LoadPairVector128NonTemporal_Int64 testClass)
            {
                _fld = AdvSimd
                    .Arm64
                    .LoadPairVector128NonTemporal((Int64*)(testClass._dataTable.inArrayPtr));
        ...
        private static readonly int RetElementCount =
            Unsafe.SizeOf<(Vector128<Int64>, Vector128<Int64>)>() / sizeof(Int64);
        ...
        public LoadPairVector128NonTemporal_Int64()
        {
            Succeeded = true;
        ...
        public void RunBasicScenario()
        {
            ...
            var result = AdvSimd
                .Arm64
                .LoadPairVector128NonTemporal((Int64*)(_dataTable.inArrayPtr));
        ...
        public void RunClsVarScenario()
        {
            ...
            _clsVar = AdvSimd.Arm64.LoadPairVector128NonTemporal((Int64*)(_dataTable.inArrayPtr));
        ...
        )
        {
            ...
            Unsafe.CopyBlockUnaligned(
                ...
                (uint)(Unsafe.SizeOf<Int64>() * Op1ElementCount)
            );
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Int64, byte>(ref outArray[0]),
                ref Unsafe.AsRef<byte>(result),
                (uint)(Unsafe.SizeOf<Int64>() * RetElementCount)
            );
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.LoadPairVector128NonTemporal)}<Int64>(Vector128<Int64>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
