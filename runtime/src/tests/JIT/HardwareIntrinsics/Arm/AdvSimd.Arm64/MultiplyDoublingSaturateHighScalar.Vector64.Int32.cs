...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void MultiplyDoublingSaturateHighScalar_Vector64_Int32()
        {
            var test = new SimpleBinaryOpTest__MultiplyDoublingSaturateHighScalar_Vector64_Int32();
    ...
    public sealed unsafe class SimpleBinaryOpTest__MultiplyDoublingSaturateHighScalar_Vector64_Int32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__MultiplyDoublingSaturateHighScalar_Vector64_Int32 testClass
            )
            {
                var result = AdvSimd.Arm64.MultiplyDoublingSaturateHighScalar(_fld1, _fld2);
            ...
            )
            {
                ...
                {
                    var result = AdvSimd.Arm64.MultiplyDoublingSaturateHighScalar(
        ...
        static SimpleBinaryOpTest__MultiplyDoublingSaturateHighScalar_Vector64_Int32()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetInt32();
        ...
        public SimpleBinaryOpTest__MultiplyDoublingSaturateHighScalar_Vector64_Int32()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64)
                .GetMethod(
                    nameof(AdvSimd.Arm64.MultiplyDoublingSaturateHighScalar),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.Arm64.MultiplyDoublingSaturateHighScalar(_clsVar1, _clsVar2);
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.Arm64.MultiplyDoublingSaturateHighScalar(op1, op2);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimpleBinaryOpTest__MultiplyDoublingSaturateHighScalar_Vector64_Int32();
            var result = AdvSimd.Arm64.MultiplyDoublingSaturateHighScalar(test._fld1, test._fld2);
        ...
        )
        {
            ...
            if (Helpers.MultiplyDoublingSaturateHigh(left[0], right[0]) != result[0])
            {
                succeeded = false;
            }
            else
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.MultiplyDoublingSaturateHighScalar)}<Int32>(Vector64<Int32>, Vector64<Int32>): {method} failed:"
                );
