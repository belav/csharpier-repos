...
namespace JIT.HardwareIntrinsics.Arm
{
    public static partial class Program
    {
        ...
        {
            var test =
                new ImmBinaryOpTest__MultiplyDoublingScalarBySelectedScalarSaturateHigh_Vector64_Int32_Vector128_Int32_3();
    ...
    public sealed unsafe class ImmBinaryOpTest__MultiplyDoublingScalarBySelectedScalarSaturateHigh_Vector64_Int32_Vector128_Int32_3
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                ImmBinaryOpTest__MultiplyDoublingScalarBySelectedScalarSaturateHigh_Vector64_Int32_Vector128_Int32_3 testClass
            )
            {
                var result = AdvSimd
                    .Arm64
                    .MultiplyDoublingScalarBySelectedScalarSaturateHigh(_fld1, _fld2, 2);
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64)
                .GetMethod(
                    ...
                    new Type[] { typeof(Vector64<Int32>), typeof(Vector128<Int32>), typeof(byte) }
                )
                .Invoke(
                    null,
                    new object[]
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd
                .Arm64
                .MultiplyDoublingScalarBySelectedScalarSaturateHigh(_clsVar1, _clsVar2, 2);
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd
                .Arm64
                .MultiplyDoublingScalarBySelectedScalarSaturateHigh(op1, op2, 2);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var result = AdvSimd
                .Arm64
                .MultiplyDoublingScalarBySelectedScalarSaturateHigh(test._fld1, test._fld2, 2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.MultiplyDoublingScalarBySelectedScalarSaturateHigh)}<Int32>(Vector64<Int32>, Vector128<Int32>, 2): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
