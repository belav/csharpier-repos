...
namespace JIT.HardwareIntrinsics.Arm
{
    public static partial class Program
    {
        ...
        {
            var test =
                new InsertSelectedScalarTest__InsertSelectedScalar_Vector64_UInt32_1_Vector128_UInt32_3();
    ...
    public sealed unsafe class InsertSelectedScalarTest__InsertSelectedScalar_Vector64_UInt32_1_Vector128_UInt32_3
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                InsertSelectedScalarTest__InsertSelectedScalar_Vector64_UInt32_1_Vector128_UInt32_3 testClass
            )
            {
            ...
            {
                fixed (Vector64<UInt32>* pFld1 = &_fld1)fixed (Vector128<UInt32>* pFld2 = &_fld3)
                {
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.InsertSelectedScalar)}<UInt32>(Vector64<UInt32>, {1}, Vector128<UInt32>, {3}): {method} failed:"
                );
                TestLibrary.TestFramework.LogInformation(
