...
namespace JIT.HardwareIntrinsics.Arm
{
    public static partial class Program
    {
        ...
        {
            var test =
                new InsertSelectedScalarTest__InsertSelectedScalar_Vector128_UInt16_7_Vector64_UInt16_3();
    ...
    public sealed unsafe class InsertSelectedScalarTest__InsertSelectedScalar_Vector128_UInt16_7_Vector64_UInt16_3
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                InsertSelectedScalarTest__InsertSelectedScalar_Vector128_UInt16_7_Vector64_UInt16_3 testClass
            )
            {
            ...
            {
                fixed (Vector128<UInt16>* pFld1 = &_fld1)fixed (Vector64<UInt16>* pFld2 = &_fld3)
                {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.Arm64.InsertSelectedScalar(_clsVar1, 7, _clsVar3, 3);
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            fixed (Vector128<UInt16>* pClsVar1 = &_clsVar1)fixed (
                Vector64<UInt16>* pClsVar3 = &_clsVar3
            )
            {
                var result = AdvSimd.Arm64.InsertSelectedScalar(
        ...
        public void RunClassLclFldScenario_Load()
        {
            ...
            fixed (Vector128<UInt16>* pFld1 = &test._fld1)fixed (
                Vector64<UInt16>* pFld2 = &test._fld3
            )
            {
                var result = AdvSimd.Arm64.InsertSelectedScalar(
                    AdvSimd.LoadVector128((UInt16*)pFld1),
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.InsertSelectedScalar)}<UInt16>(Vector128<UInt16>, {7}, Vector64<UInt16>, {3}): {method} failed:"
                );
                TestLibrary.TestFramework.LogInformation(
