...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ConvertToInt64RoundToNegativeInfinity_Vector128_Double()
        {
            var test =
                new SimpleUnaryOpTest__ConvertToInt64RoundToNegativeInfinity_Vector128_Double();
    ...
    public sealed unsafe class SimpleUnaryOpTest__ConvertToInt64RoundToNegativeInfinity_Vector128_Double
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__ConvertToInt64RoundToNegativeInfinity_Vector128_Double testClass
            )
            {
                var result = AdvSimd.Arm64.ConvertToInt64RoundToNegativeInfinity(_fld1);
        ...
        static SimpleUnaryOpTest__ConvertToInt64RoundToNegativeInfinity_Vector128_Double()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetDouble();
        ...
        public SimpleUnaryOpTest__ConvertToInt64RoundToNegativeInfinity_Vector128_Double()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64)
                .GetMethod(
                    nameof(AdvSimd.Arm64.ConvertToInt64RoundToNegativeInfinity),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.Arm64.ConvertToInt64RoundToNegativeInfinity(_clsVar1);
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.Arm64.ConvertToInt64RoundToNegativeInfinity(op1);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test =
                new SimpleUnaryOpTest__ConvertToInt64RoundToNegativeInfinity_Vector128_Double();
            var result = AdvSimd.Arm64.ConvertToInt64RoundToNegativeInfinity(test._fld1);
        ...
        public void RunClassLclFldScenario_Load()
        {
            ...
            fixed (Vector128<Double>* pFld1 = &test._fld1)
            {
                var result = AdvSimd
                    .Arm64
                    .ConvertToInt64RoundToNegativeInfinity(AdvSimd.LoadVector128((Double*)(pFld1)));
        ...
        )
        {
            ...
            {
                if (Helpers.ConvertToInt64RoundToNegativeInfinity(firstOp[i]) != result[i])
                {
                    succeeded = false;
                    break;
                }
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.ConvertToInt64RoundToNegativeInfinity)}<Int64>(Vector128<Double>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
