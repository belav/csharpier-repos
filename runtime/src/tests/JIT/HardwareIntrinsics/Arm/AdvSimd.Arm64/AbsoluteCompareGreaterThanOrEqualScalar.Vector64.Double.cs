...
namespace JIT.HardwareIntrinsics.Arm
{
    public static partial class Program
    {
        ...
        {
            var test =
                new SimpleBinaryOpTest__AbsoluteCompareGreaterThanOrEqualScalar_Vector64_Double();
    ...
    public sealed unsafe class SimpleBinaryOpTest__AbsoluteCompareGreaterThanOrEqualScalar_Vector64_Double
    {
        ...
        private struct TestStruct
        {
            ...
            public static TestStruct Create()
            {
                ...
                Unsafe.CopyBlockUnaligned(
                    ref Unsafe.As<Vector64<Double>, byte>(ref testStruct._fld2),
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__AbsoluteCompareGreaterThanOrEqualScalar_Vector64_Double testClass
            ) {
                var result = AdvSimd.Arm64.AbsoluteCompareGreaterThanOrEqualScalar(_fld1, _fld2);
            ...
            public void RunStructFldScenario_Load(
                ...
                {
                    var result = AdvSimd.Arm64.AbsoluteCompareGreaterThanOrEqualScalar(
        ...
        static SimpleBinaryOpTest__AbsoluteCompareGreaterThanOrEqualScalar_Vector64_Double()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetDouble();
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector64<Double>, byte>(ref _clsVar2),
                ref Unsafe.As<Double, byte>(ref _data2[0]),
                (uint)Unsafe.SizeOf<Vector64<Double>>()
            );
        }

        public SimpleBinaryOpTest__AbsoluteCompareGreaterThanOrEqualScalar_Vector64_Double()
        {
            Succeeded = true;
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector64<Double>, byte>(ref _fld2),
                ref Unsafe.As<Double, byte>(ref _data2[0]),
                (uint)Unsafe.SizeOf<Vector64<Double>>()
            );
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64).GetMethod(
                    nameof(AdvSimd.Arm64.AbsoluteCompareGreaterThanOrEqualScalar),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.Arm64.AbsoluteCompareGreaterThanOrEqualScalar(_clsVar1, _clsVar2);
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.Arm64.AbsoluteCompareGreaterThanOrEqualScalar(op1, op2);
        ...
        private void ValidateResult(
            ...
            if (
                BitConverter.DoubleToInt64Bits(
                    Helpers.AbsoluteCompareGreaterThanOrEqual(left[0], right[0])
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.AbsoluteCompareGreaterThanOrEqualScalar)}<Double>(Vector64<Double>, Vector64<Double>): {method} failed:"
                );
