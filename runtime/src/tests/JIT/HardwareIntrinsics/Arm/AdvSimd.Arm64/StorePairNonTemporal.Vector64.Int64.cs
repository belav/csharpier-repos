    ...
    public sealed unsafe class StoreBinaryOpTest__StorePairNonTemporal_Vector64_Int64
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                StoreBinaryOpTest__StorePairNonTemporal_Vector64_Int64 testClass
            )
            {
                AdvSimd
                    .Arm64
                    .StorePairNonTemporal((Int64*)testClass._dataTable.outArrayPtr, _fld1, _fld2);
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            typeof(AdvSimd.Arm64)
                .GetMethod(
                    ...
                    new Type[] { typeof(Int64*), typeof(Vector64<Int64>), typeof(Vector64<Int64>) }
                )
                .Invoke(
                    null,
                    new object[]
        ...
        public void RunClassLclFldScenario()
        {
            ...
            AdvSimd
                .Arm64
                .StorePairNonTemporal((Int64*)_dataTable.outArrayPtr, test._fld1, test._fld2);
        ...
        )
        {
            ...
            Unsafe.CopyBlockUnaligned(
                ...
                (uint)(RetElementCount * Unsafe.SizeOf<Int64>())
            );
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.StorePairNonTemporal)}<Int64>(Vector64<Int64>, Vector64<Int64>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
