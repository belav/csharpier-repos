...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ConvertToDoubleScalar_Vector64_Int64()
        {
            var test = new SimpleUnaryOpTest__ConvertToDoubleScalar_Vector64_Int64();
    ...
    public sealed unsafe class SimpleUnaryOpTest__ConvertToDoubleScalar_Vector64_Int64
    {
        ...
        private struct TestStruct
        {
            ...
            )
            {
                fixed (Vector64<Int64>* pFld1 = &_fld1)
                {
                    var result = AdvSimd
                        .Arm64
                        .ConvertToDoubleScalar(AdvSimd.LoadVector64((Int64*)(pFld1)));
        ...
        static SimpleUnaryOpTest__ConvertToDoubleScalar_Vector64_Int64()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetInt64();
        ...
        public SimpleUnaryOpTest__ConvertToDoubleScalar_Vector64_Int64()
        {
            Succeeded = true;
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd
                .Arm64
                .ConvertToDoubleScalar(Unsafe.Read<Vector64<Int64>>(_dataTable.inArray1Ptr));
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var result = AdvSimd
                .Arm64
                .ConvertToDoubleScalar(AdvSimd.LoadVector64((Int64*)(_dataTable.inArray1Ptr)));
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64)
                .GetMethod(
                    nameof(AdvSimd.Arm64.ConvertToDoubleScalar),
                    new Type[] { typeof(Vector64<Int64>) }
                )
                .Invoke(
                    null,
                    new object[] { Unsafe.Read<Vector64<Int64>>(_dataTable.inArray1Ptr) }
                );
        ...
        public void RunReflectionScenario_Load()
        {
            ...
            var result = typeof(AdvSimd.Arm64)
                ...
                .Invoke(
                    null,
                    new object[] { AdvSimd.LoadVector64((Int64*)(_dataTable.inArray1Ptr)) }
                );
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.Arm64.ConvertToDoubleScalar(_clsVar1);
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            fixed (Vector64<Int64>* pClsVar1 = &_clsVar1)
            {
                var result = AdvSimd
                    .Arm64
                    .ConvertToDoubleScalar(AdvSimd.LoadVector64((Int64*)(pClsVar1)));
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.Arm64.ConvertToDoubleScalar(op1);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimpleUnaryOpTest__ConvertToDoubleScalar_Vector64_Int64();
            var result = AdvSimd.Arm64.ConvertToDoubleScalar(test._fld1);
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var result = AdvSimd
                .Arm64
                .ConvertToDoubleScalar(AdvSimd.LoadVector64((Int64*)(&test._fld1)));
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.ConvertToDoubleScalar)}<Double>(Vector64<Int64>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
