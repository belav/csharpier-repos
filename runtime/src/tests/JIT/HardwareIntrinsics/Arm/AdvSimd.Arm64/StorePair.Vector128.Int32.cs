...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void StorePair_Vector128_Int32()
        {
            var test = new StoreBinaryOpTest__StorePair_Vector128_Int32();
    ...
    public sealed unsafe class StoreBinaryOpTest__StorePair_Vector128_Int32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(StoreBinaryOpTest__StorePair_Vector128_Int32 testClass)
            {
                AdvSimd.Arm64.StorePair((Int32*)testClass._dataTable.outArrayPtr, _fld1, _fld2);

                testClass.ValidateResult(_fld1, _fld2, testClass._dataTable.outArrayPtr);
            }

            public void RunStructFldScenario_Load(
                StoreBinaryOpTest__StorePair_Vector128_Int32 testClass
            )
            {
        ...
        static StoreBinaryOpTest__StorePair_Vector128_Int32()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetInt32();
        ...
        public StoreBinaryOpTest__StorePair_Vector128_Int32()
        {
            Succeeded = true;
        ...
        public void RunClsVarScenario()
        {
            ...
            AdvSimd.Arm64.StorePair((Int32*)_dataTable.outArrayPtr, _clsVar1, _clsVar2);
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            AdvSimd.Arm64.StorePair((Int32*)_dataTable.outArrayPtr, op1, op2);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new StoreBinaryOpTest__StorePair_Vector128_Int32();
            AdvSimd.Arm64.StorePair((Int32*)_dataTable.outArrayPtr, test._fld1, test._fld2);
        ...
        public void RunClassFldScenario()
        {
            ...
            AdvSimd.Arm64.StorePair((Int32*)_dataTable.outArrayPtr, _fld1, _fld2);
        ...
        )
        {
            ...
            Unsafe.CopyBlockUnaligned(
                ...
                (uint)(RetElementCount * Unsafe.SizeOf<Int32>())
            );
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.StorePair)}<Int32>(Vector128<Int32>, Vector128<Int32>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
