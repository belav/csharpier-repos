...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void StorePair_Vector64_UInt16()
        {
    ...
    public sealed unsafe class StoreBinaryOpTest__StorePair_Vector64_UInt16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(StoreBinaryOpTest__StorePair_Vector64_UInt16 testClass)
            {
            ...
            public void RunStructFldScenario_Load(
                StoreBinaryOpTest__StorePair_Vector64_UInt16 testClass
            )
            {
        ...
        static StoreBinaryOpTest__StorePair_Vector64_UInt16()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetUInt16();
        ...
        public StoreBinaryOpTest__StorePair_Vector64_UInt16()
        {
            Succeeded = true;
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.StorePair)}<UInt16>(Vector64<UInt16>, Vector64<UInt16>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
