    ...
    public sealed unsafe class SimpleUnaryOpTest__MaxNumberAcross_Vector128_Single
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__MaxNumberAcross_Vector128_Single testClass
            )
            {
            ...
            )
            {
                fixed (Vector128<Single>* pFld1 = &_fld1)
                {
                    var result = AdvSimd
                        .Arm64
                        .MaxNumberAcross(AdvSimd.LoadVector128((Single*)(pFld1)));
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd
                .Arm64
                .MaxNumberAcross(Unsafe.Read<Vector128<Single>>(_dataTable.inArray1Ptr));
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var result = AdvSimd
                .Arm64
                .MaxNumberAcross(AdvSimd.LoadVector128((Single*)(_dataTable.inArray1Ptr)));
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64)
                .GetMethod(
                    nameof(AdvSimd.Arm64.MaxNumberAcross),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.Arm64.MaxNumberAcross(_clsVar1);
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            fixed (Vector128<Single>* pClsVar1 = &_clsVar1)
            {
                var result = AdvSimd
                    .Arm64
                    .MaxNumberAcross(AdvSimd.LoadVector128((Single*)(pClsVar1)));
        ...
        public void RunClassLclFldScenario_Load()
        {
            ...
            {
                var result = AdvSimd.Arm64.MaxNumberAcross(AdvSimd.LoadVector128((Single*)(pFld1)));
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var result = AdvSimd
                .Arm64
                .MaxNumberAcross(AdvSimd.LoadVector128((Single*)(&test._fld1)));
        ...
        )
        {
            ...
            if (
                BitConverter.SingleToInt32Bits(Helpers.MaxNumberAcross(firstOp))
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.MaxNumberAcross)}<Single>(Vector128<Single>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
