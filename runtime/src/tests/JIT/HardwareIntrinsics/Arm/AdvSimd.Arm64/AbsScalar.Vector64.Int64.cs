    ...
    public sealed unsafe class SimpleUnaryOpTest__AbsScalar_Vector64_Int64
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario_Load(
                SimpleUnaryOpTest__AbsScalar_Vector64_Int64 testClass
            )
            {
                fixed (Vector64<Int64>* pFld1 = &_fld1)
                {
                    var result = AdvSimd.Arm64.AbsScalar(AdvSimd.LoadVector64((Int64*)(pFld1)));
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd
                .Arm64
                .AbsScalar(Unsafe.Read<Vector64<Int64>>(_dataTable.inArray1Ptr));
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var result = AdvSimd
                .Arm64
                .AbsScalar(AdvSimd.LoadVector64((Int64*)(_dataTable.inArray1Ptr)));
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64)
                .GetMethod(nameof(AdvSimd.Arm64.AbsScalar), new Type[] { typeof(Vector64<Int64>) })
                .Invoke(
                    null,
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.Arm64.AbsScalar(_clsVar1);
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            {
                var result = AdvSimd.Arm64.AbsScalar(AdvSimd.LoadVector64((Int64*)(pClsVar1)));
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = AdvSimd.Arm64.AbsScalar(AdvSimd.LoadVector64((Int64*)(&test._fld1)));
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.AbsScalar)}<UInt64>(Vector64<Int64>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
