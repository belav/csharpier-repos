...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    public sealed unsafe class SimpleUnaryOpTest__RoundToNegativeInfinity_Vector128_Double
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__RoundToNegativeInfinity_Vector128_Double testClass
            )
            {
                var result = AdvSimd.Arm64.RoundToNegativeInfinity(_fld1);
        ...
        static SimpleUnaryOpTest__RoundToNegativeInfinity_Vector128_Double()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetDouble();
        ...
        public SimpleUnaryOpTest__RoundToNegativeInfinity_Vector128_Double()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64)
                .GetMethod(
                    nameof(AdvSimd.Arm64.RoundToNegativeInfinity),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.Arm64.RoundToNegativeInfinity(_clsVar1);
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.Arm64.RoundToNegativeInfinity(op1);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimpleUnaryOpTest__RoundToNegativeInfinity_Vector128_Double();
            var result = AdvSimd.Arm64.RoundToNegativeInfinity(test._fld1);
        ...
        )
        {
            ...
            {
                if (
                    BitConverter.DoubleToInt64Bits(Helpers.RoundToNegativeInfinity(firstOp[i]))
