...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ConvertToInt64RoundToEven_Vector128_Double()
        {
            var test = new SimpleUnaryOpTest__ConvertToInt64RoundToEven_Vector128_Double();
    ...
    public sealed unsafe class SimpleUnaryOpTest__ConvertToInt64RoundToEven_Vector128_Double
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__ConvertToInt64RoundToEven_Vector128_Double testClass
            )
            {
                var result = AdvSimd.Arm64.ConvertToInt64RoundToEven(_fld1);
            ...
            )
            {
                fixed (Vector128<Double>* pFld1 = &_fld1)
                {
                    var result = AdvSimd
                        .Arm64
                        .ConvertToInt64RoundToEven(AdvSimd.LoadVector128((Double*)(pFld1)));
        ...
        static SimpleUnaryOpTest__ConvertToInt64RoundToEven_Vector128_Double()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetDouble();
        ...
        public SimpleUnaryOpTest__ConvertToInt64RoundToEven_Vector128_Double()
        {
            Succeeded = true;
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd
                .Arm64
                .ConvertToInt64RoundToEven(Unsafe.Read<Vector128<Double>>(_dataTable.inArray1Ptr));
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64)
                .GetMethod(
                    nameof(AdvSimd.Arm64.ConvertToInt64RoundToEven),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.Arm64.ConvertToInt64RoundToEven(_clsVar1);
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            fixed (Vector128<Double>* pClsVar1 = &_clsVar1)
            {
                var result = AdvSimd
                    .Arm64
                    .ConvertToInt64RoundToEven(AdvSimd.LoadVector128((Double*)(pClsVar1)));
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.Arm64.ConvertToInt64RoundToEven(op1);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimpleUnaryOpTest__ConvertToInt64RoundToEven_Vector128_Double();
            var result = AdvSimd.Arm64.ConvertToInt64RoundToEven(test._fld1);
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var result = AdvSimd
                .Arm64
                .ConvertToInt64RoundToEven(AdvSimd.LoadVector128((Double*)(&test._fld1)));
        ...
        )
        {
            ...
            {
                if (Helpers.ConvertToInt64RoundToEven(firstOp[i]) != result[i])
                {
                    succeeded = false;
                    break;
                }
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.ConvertToInt64RoundToEven)}<Int64>(Vector128<Double>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
