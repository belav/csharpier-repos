    ...
    public sealed unsafe class SimpleBinaryOpTest__AddSaturateScalar_Vector64_Int16_Vector64_UInt16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__AddSaturateScalar_Vector64_Int16_Vector64_UInt16 testClass
            )
            {
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.AddSaturateScalar)}<Int16>(Vector64<Int16>, Vector64<UInt16>): {method} failed:"
                    );
