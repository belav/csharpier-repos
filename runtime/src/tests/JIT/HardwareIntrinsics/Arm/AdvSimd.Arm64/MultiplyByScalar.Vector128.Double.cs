    ...
    public sealed unsafe class SimpleBinaryOpTest__MultiplyByScalar_Vector128_Double
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__MultiplyByScalar_Vector128_Double testClass
            ) {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64).GetMethod(
                    nameof(AdvSimd.Arm64.MultiplyByScalar),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.Arm64.MultiplyByScalar(_clsVar1, _clsVar2);
        ...
        private void ValidateResult(
            ...
            {
                if (
                    BitConverter.DoubleToInt64Bits(Helpers.Multiply(left[i], right[0]))
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.MultiplyByScalar)}<Double>(Vector128<Double>, Vector64<Double>): {method} failed:"
                );
