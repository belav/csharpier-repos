    ...
    public sealed unsafe class SimpleTernaryOpTest__FusedMultiplyAddByScalar_Vector128_Single
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleTernaryOpTest__FusedMultiplyAddByScalar_Vector128_Single testClass
            )
            {
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.FusedMultiplyAddByScalar)}<Single>(Vector128<Single>, Vector128<Single>, Vector64<Single>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
