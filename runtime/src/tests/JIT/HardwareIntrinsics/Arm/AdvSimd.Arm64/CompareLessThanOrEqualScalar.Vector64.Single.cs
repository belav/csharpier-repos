    ...
    public sealed unsafe class SimpleBinaryOpTest__CompareLessThanOrEqualScalar_Vector64_Single
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__CompareLessThanOrEqualScalar_Vector64_Single testClass
            )
            {
        ...
        )
        {
            ...
            if (
                BitConverter.SingleToInt32Bits(Helpers.CompareLessThanOrEqual(left[0], right[0]))
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.CompareLessThanOrEqualScalar)}<Single>(Vector64<Single>, Vector64<Single>): {method} failed:"
                    );
