...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    public sealed unsafe class ImmOpTest__DuplicateToVector128_UInt64_31
    {
        ...
        public void RunBasicScenario()
        {
            ...
            var result = AdvSimd.Arm64.DuplicateToVector128((UInt64)31);
        ...
        public void RunReflectionScenario()
        {
            ...
            var result = typeof(AdvSimd.Arm64)
                ...
                .Invoke(null, new object[] { (UInt64)31 });
        ...
        private void ValidateResult(UInt64[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.DuplicateToVector128)}<UInt64>(31): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
