    ...
    public sealed unsafe class SimpleUnaryOpTest__MaxAcross_Vector64_Byte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario_Load(
                SimpleUnaryOpTest__MaxAcross_Vector64_Byte testClass
            )
            {
                fixed (Vector64<Byte>* pFld1 = &_fld1)
                {
                    var result = AdvSimd.Arm64.MaxAcross(AdvSimd.LoadVector64((Byte*)(pFld1)));
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd
                .Arm64
                .MaxAcross(Unsafe.Read<Vector64<Byte>>(_dataTable.inArray1Ptr));
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var result = AdvSimd
                .Arm64
                .MaxAcross(AdvSimd.LoadVector64((Byte*)(_dataTable.inArray1Ptr)));
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64)
                .GetMethod(nameof(AdvSimd.Arm64.MaxAcross), new Type[] { typeof(Vector64<Byte>) })
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            {
                var result = AdvSimd.Arm64.MaxAcross(AdvSimd.LoadVector64((Byte*)(pClsVar1)));
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = AdvSimd.Arm64.MaxAcross(AdvSimd.LoadVector64((Byte*)(&test._fld1)));
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.MaxAcross)}<Byte>(Vector64<Byte>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
