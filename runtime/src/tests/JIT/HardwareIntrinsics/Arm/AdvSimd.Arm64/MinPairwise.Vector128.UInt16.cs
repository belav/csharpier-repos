    ...
    public sealed unsafe class SimpleBinaryOpTest__MinPairwise_Vector128_UInt16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__MinPairwise_Vector128_UInt16 testClass
            )
            {
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.MinPairwise)}<UInt16>(Vector128<UInt16>, Vector128<UInt16>): {method} failed:"
                    );
