...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ConvertToUInt64RoundToNegativeInfinity_Vector128_Double()
        {
            var test =
                new SimpleUnaryOpTest__ConvertToUInt64RoundToNegativeInfinity_Vector128_Double();
    ...
    public sealed unsafe class SimpleUnaryOpTest__ConvertToUInt64RoundToNegativeInfinity_Vector128_Double
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__ConvertToUInt64RoundToNegativeInfinity_Vector128_Double testClass
            )
            {
                var result = AdvSimd.Arm64.ConvertToUInt64RoundToNegativeInfinity(_fld1);
            ...
            )
            {
                ...
                {
                    var result = AdvSimd.Arm64.ConvertToUInt64RoundToNegativeInfinity(
        ...
        static SimpleUnaryOpTest__ConvertToUInt64RoundToNegativeInfinity_Vector128_Double()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetDouble();
        ...
        public SimpleUnaryOpTest__ConvertToUInt64RoundToNegativeInfinity_Vector128_Double()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64).GetMethod(
                    nameof(AdvSimd.Arm64.ConvertToUInt64RoundToNegativeInfinity),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.Arm64.ConvertToUInt64RoundToNegativeInfinity(_clsVar1);
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.Arm64.ConvertToUInt64RoundToNegativeInfinity(op1);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test =
                new SimpleUnaryOpTest__ConvertToUInt64RoundToNegativeInfinity_Vector128_Double();
            var result = AdvSimd.Arm64.ConvertToUInt64RoundToNegativeInfinity(test._fld1);
        ...
        )
        {
            ...
            {
                if (Helpers.ConvertToUInt64RoundToNegativeInfinity(firstOp[i]) != result[i])
                {
                    succeeded = false;
                    break;
                }
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.ConvertToUInt64RoundToNegativeInfinity)}<UInt64>(Vector128<Double>): {method} failed:"
                );
                TestLibrary.TestFramework.LogInformation(
