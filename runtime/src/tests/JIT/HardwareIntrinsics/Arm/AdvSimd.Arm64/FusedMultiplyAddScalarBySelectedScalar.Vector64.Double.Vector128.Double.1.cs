...
namespace JIT.HardwareIntrinsics.Arm
{
    public static partial class Program
    {
        ...
        {
            var test =
                new SimpleTernaryOpTest__FusedMultiplyAddScalarBySelectedScalar_Vector64_Double_Vector128_Double_1();
    ...
    public sealed unsafe class SimpleTernaryOpTest__FusedMultiplyAddScalarBySelectedScalar_Vector64_Double_Vector128_Double_1
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleTernaryOpTest__FusedMultiplyAddScalarBySelectedScalar_Vector64_Double_Vector128_Double_1 testClass
            )
            {
                var result = AdvSimd
                    .Arm64
                    .FusedMultiplyAddScalarBySelectedScalar(_fld1, _fld2, _fld3, 1);
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd
                .Arm64
                .FusedMultiplyAddScalarBySelectedScalar(_clsVar1, _clsVar2, _clsVar3, 1);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var result = AdvSimd
                .Arm64
                .FusedMultiplyAddScalarBySelectedScalar(test._fld1, test._fld2, test._fld3, 1);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.FusedMultiplyAddScalarBySelectedScalar)}<Double>(Vector64<Double>, Vector64<Double>, Vector128<Double>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
