...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void AddSaturate_Vector64_Int16_Vector64_UInt16()
        {
            var test = new SimpleBinaryOpTest__AddSaturate_Vector64_Int16_Vector64_UInt16();
    ...
    public sealed unsafe class SimpleBinaryOpTest__AddSaturate_Vector64_Int16_Vector64_UInt16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__AddSaturate_Vector64_Int16_Vector64_UInt16 testClass
            ) {
            ...
            public void RunStructFldScenario_Load(
                ...
                fixed (Vector64<Int16>* pFld1 = &_fld1)fixed (Vector64<UInt16>* pFld2 = &_fld2)
                {
        ...
        static SimpleBinaryOpTest__AddSaturate_Vector64_Int16_Vector64_UInt16()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetInt16();
        ...
        public SimpleBinaryOpTest__AddSaturate_Vector64_Int16_Vector64_UInt16()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64).GetMethod(
                    ...
                    new Type[] { typeof(Vector64<Int16>), typeof(Vector64<UInt16>) }
                )
                .Invoke(
                    null,
                    new object[]
        ...
        private void ValidateResult(
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.AddSaturate)}<Int16>(Vector64<Int16>, Vector64<UInt16>): {method} failed:"
                );
