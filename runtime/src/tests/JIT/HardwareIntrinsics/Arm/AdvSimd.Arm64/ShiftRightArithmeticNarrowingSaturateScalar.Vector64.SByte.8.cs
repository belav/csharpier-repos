...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ShiftRightArithmeticNarrowingSaturateScalar_Vector64_SByte_8()
        {
            var test =
                new ImmUnaryOpTest__ShiftRightArithmeticNarrowingSaturateScalar_Vector64_SByte_8();
    ...
    public sealed unsafe class ImmUnaryOpTest__ShiftRightArithmeticNarrowingSaturateScalar_Vector64_SByte_8
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                ImmUnaryOpTest__ShiftRightArithmeticNarrowingSaturateScalar_Vector64_SByte_8 testClass
            )
            {
                var result = AdvSimd.Arm64.ShiftRightArithmeticNarrowingSaturateScalar(_fld, 8);
        ...
        static ImmUnaryOpTest__ShiftRightArithmeticNarrowingSaturateScalar_Vector64_SByte_8()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data[i] = TestLibrary.Generator.GetInt16();
        ...
        public ImmUnaryOpTest__ShiftRightArithmeticNarrowingSaturateScalar_Vector64_SByte_8()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64)
                .GetMethod(
                    nameof(AdvSimd.Arm64.ShiftRightArithmeticNarrowingSaturateScalar),
                    new Type[] { typeof(Vector64<Int16>), typeof(byte) }
                )
                .Invoke(
                    null,
                    new object[] { Unsafe.Read<Vector64<Int16>>(_dataTable.inArrayPtr), (byte)8 }
                );
        ...
        public void RunReflectionScenario_Load()
        {
            ...
            var result = typeof(AdvSimd.Arm64)
                ...
                .Invoke(
                    null,
                    new object[] { AdvSimd.LoadVector64((Int16*)(_dataTable.inArrayPtr)), (byte)8 }
                );
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.Arm64.ShiftRightArithmeticNarrowingSaturateScalar(_clsVar, 8);
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.Arm64.ShiftRightArithmeticNarrowingSaturateScalar(firstOp, 8);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test =
                new ImmUnaryOpTest__ShiftRightArithmeticNarrowingSaturateScalar_Vector64_SByte_8();
            var result = AdvSimd.Arm64.ShiftRightArithmeticNarrowingSaturateScalar(test._fld, 8);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.ShiftRightArithmeticNarrowingSaturateScalar)}<SByte>(Vector64<Int16>, 8): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
