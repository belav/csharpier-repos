...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void StorePairNonTemporal_Vector64_Int32()
        {
    ...
    public sealed unsafe class StoreBinaryOpTest__StorePairNonTemporal_Vector64_Int32
    {
        ...
        static StoreBinaryOpTest__StorePairNonTemporal_Vector64_Int32()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetInt32();
        ...
        public StoreBinaryOpTest__StorePairNonTemporal_Vector64_Int32()
        {
            Succeeded = true;
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.StorePairNonTemporal)}<Int32>(Vector64<Int32>, Vector64<Int32>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
