...
namespace JIT.HardwareIntrinsics.Arm
{
    public static partial class Program
    {
        ...
        {
            var test =
                new SimpleUnaryOpTest__ConvertToUInt64RoundToPositiveInfinityScalar_Vector64_Double();
    ...
    public sealed unsafe class SimpleUnaryOpTest__ConvertToUInt64RoundToPositiveInfinityScalar_Vector64_Double
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__ConvertToUInt64RoundToPositiveInfinityScalar_Vector64_Double testClass
            )
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64)
                .GetMethod(
                    nameof(AdvSimd.Arm64.ConvertToUInt64RoundToPositiveInfinityScalar),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.Arm64.ConvertToUInt64RoundToPositiveInfinityScalar(_clsVar1);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.ConvertToUInt64RoundToPositiveInfinityScalar)}<UInt64>(Vector64<Double>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
