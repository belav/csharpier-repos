...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void LoadPairVector64_UInt16()
        {
            var test = new LoadPairVector64_UInt16();
    ...
    public sealed unsafe class LoadPairVector64_UInt16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(LoadPairVector64_UInt16 testClass)
            {
                _fld = AdvSimd.Arm64.LoadPairVector64((UInt16*)(testClass._dataTable.inArrayPtr));
        ...
        public LoadPairVector64_UInt16()
        {
            Succeeded = true;
        ...
        public void RunBasicScenario()
        {
            ...
            var result = AdvSimd.Arm64.LoadPairVector64((UInt16*)(_dataTable.inArrayPtr));
        ...
        public void RunReflectionScenario()
        {
            ...
            var result = typeof(AdvSimd.Arm64)
                .GetMethod(nameof(AdvSimd.Arm64.LoadPairVector64), new Type[] { typeof(UInt16*) })
        ...
        public void RunClsVarScenario()
        {
            ...
            _clsVar = AdvSimd.Arm64.LoadPairVector64((UInt16*)(_dataTable.inArrayPtr));
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.LoadPairVector64)}<UInt16>(Vector64<UInt16>): {method} failed:"
                );
                TestLibrary.TestFramework.LogInformation(
