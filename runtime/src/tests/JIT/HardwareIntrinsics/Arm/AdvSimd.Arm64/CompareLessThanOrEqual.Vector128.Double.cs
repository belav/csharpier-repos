    ...
    public sealed unsafe class SimpleBinaryOpTest__CompareLessThanOrEqual_Vector128_Double
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__CompareLessThanOrEqual_Vector128_Double testClass
            )
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64)
                .GetMethod(
                    nameof(AdvSimd.Arm64.CompareLessThanOrEqual),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.Arm64.CompareLessThanOrEqual(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.CompareLessThanOrEqual)}<Double>(Vector128<Double>, Vector128<Double>): {method} failed:"
                    );
