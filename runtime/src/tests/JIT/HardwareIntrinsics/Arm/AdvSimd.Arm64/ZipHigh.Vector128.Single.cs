    ...
    public sealed unsafe class SimpleBinaryOpTest__ZipHigh_Vector128_Single
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario_Load(
                SimpleBinaryOpTest__ZipHigh_Vector128_Single testClass
            )
            {
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.ZipHigh)}<Single>(Vector128<Single>, Vector128<Single>): {method} failed:"
                    );
