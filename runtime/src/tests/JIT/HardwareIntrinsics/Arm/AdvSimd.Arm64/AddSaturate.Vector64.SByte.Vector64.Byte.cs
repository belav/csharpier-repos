...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void AddSaturate_Vector64_SByte_Vector64_Byte()
        {
            var test = new SimpleBinaryOpTest__AddSaturate_Vector64_SByte_Vector64_Byte();
    ...
    public sealed unsafe class SimpleBinaryOpTest__AddSaturate_Vector64_SByte_Vector64_Byte
    {
        private struct DataTable
        {
            ...
            public DataTable(SByte[] inArray1, Byte[] inArray2, SByte[] outArray, int alignment)
            {
        ...
        static SimpleBinaryOpTest__AddSaturate_Vector64_SByte_Vector64_Byte()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetSByte();
        ...
        public SimpleBinaryOpTest__AddSaturate_Vector64_SByte_Vector64_Byte()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64).GetMethod(
                    nameof(AdvSimd.Arm64.AddSaturate),
                    new Type[] { typeof(Vector64<SByte>), typeof(Vector64<Byte>) }
                )
                .Invoke(
                    null,
                    new object[]
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.Arm64.AddSaturate(_clsVar1, _clsVar2);
        ...
        public void RunClassLclFldScenario_Load()
        {
            ...
            fixed (Vector64<SByte>* pFld1 = &test._fld1)fixed (Vector64<Byte>* pFld2 = &test._fld2)
            {
                var result = AdvSimd.Arm64.AddSaturate(
                    AdvSimd.LoadVector64((SByte*)(pFld1)),
                    AdvSimd.LoadVector64((Byte*)(pFld2))
        ...
        private void ValidateResult(
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.AddSaturate)}<SByte>(Vector64<SByte>, Vector64<Byte>): {method} failed:"
                );
