...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void AddSaturate_Vector128_UInt64_Vector128_Int64()
        {
    ...
    public sealed unsafe class SimpleBinaryOpTest__AddSaturate_Vector128_UInt64_Vector128_Int64
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__AddSaturate_Vector128_UInt64_Vector128_Int64 testClass
            ) {
            ...
            public void RunStructFldScenario_Load(
                ...
                fixed (Vector128<UInt64>* pFld1 = &_fld1)fixed (Vector128<Int64>* pFld2 = &_fld2)
                {
        ...
        static SimpleBinaryOpTest__AddSaturate_Vector128_UInt64_Vector128_Int64()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetUInt64();
        ...
        public SimpleBinaryOpTest__AddSaturate_Vector128_UInt64_Vector128_Int64()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64).GetMethod(
                    ...
                    new Type[] { typeof(Vector128<UInt64>), typeof(Vector128<Int64>) }
                )
                .Invoke(
                    null,
                    new object[]
        ...
        private void ValidateResult(
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.AddSaturate)}<UInt64>(Vector128<UInt64>, Vector128<Int64>): {method} failed:"
                );
