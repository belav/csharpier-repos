...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ReciprocalSquareRootStep_Vector128_Double()
        {
            var test = new SimpleBinaryOpTest__ReciprocalSquareRootStep_Vector128_Double();
    ...
    public sealed unsafe class SimpleBinaryOpTest__ReciprocalSquareRootStep_Vector128_Double
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__ReciprocalSquareRootStep_Vector128_Double testClass
            )
            {
                var result = AdvSimd.Arm64.ReciprocalSquareRootStep(_fld1, _fld2);
            ...
            )
            {
                ...
                {
                    var result = AdvSimd.Arm64.ReciprocalSquareRootStep(
        ...
        static SimpleBinaryOpTest__ReciprocalSquareRootStep_Vector128_Double()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetDouble();
        ...
        public SimpleBinaryOpTest__ReciprocalSquareRootStep_Vector128_Double()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64)
                .GetMethod(
                    nameof(AdvSimd.Arm64.ReciprocalSquareRootStep),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.Arm64.ReciprocalSquareRootStep(_clsVar1, _clsVar2);
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.Arm64.ReciprocalSquareRootStep(op1, op2);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimpleBinaryOpTest__ReciprocalSquareRootStep_Vector128_Double();
            var result = AdvSimd.Arm64.ReciprocalSquareRootStep(test._fld1, test._fld2);
        ...
        )
        {
            ...
            {
                if (
                    BitConverter.DoubleToInt64Bits(Helpers.FPRSqrtStepFused(left[i], right[i]))
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.ReciprocalSquareRootStep)}<Double>(Vector128<Double>, Vector128<Double>): {method} failed:"
                );
