    ...
    public sealed unsafe class SimpleBinaryOpTest__VectorTableLookup_Vector128_Byte
    {
        ...
        private struct TestStruct
        {
            ...
            public static TestStruct Create()
            {
                ...
                {
                    _data2[i] = (Byte)(TestLibrary.Generator.GetByte() % 20);
                }
                Unsafe.CopyBlockUnaligned(
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__VectorTableLookup_Vector128_Byte testClass
            )
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64)
                .GetMethod(
                    nameof(AdvSimd.Arm64.VectorTableLookup),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.Arm64.VectorTableLookup(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.VectorTableLookup)}<Byte>(Vector128<Byte>, Vector128<Byte>): {method} failed:"
                    );
