...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ExtractNarrowingSaturateScalar_Vector64_UInt16()
        {
            var test = new SimpleUnaryOpTest__ExtractNarrowingSaturateScalar_Vector64_UInt16();
    ...
    public sealed unsafe class SimpleUnaryOpTest__ExtractNarrowingSaturateScalar_Vector64_UInt16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__ExtractNarrowingSaturateScalar_Vector64_UInt16 testClass
            )
            {
            ...
            )
            {
                fixed (Vector64<UInt32>* pFld1 = &_fld1)
                {
                    var result = AdvSimd
                        .Arm64
                        .ExtractNarrowingSaturateScalar(AdvSimd.LoadVector64((UInt32*)(pFld1)));
        ...
        static SimpleUnaryOpTest__ExtractNarrowingSaturateScalar_Vector64_UInt16()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetUInt32();
        ...
        public SimpleUnaryOpTest__ExtractNarrowingSaturateScalar_Vector64_UInt16()
        {
            Succeeded = true;
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            fixed (Vector64<UInt32>* pClsVar1 = &_clsVar1)
            {
                var result = AdvSimd
                    .Arm64
                    .ExtractNarrowingSaturateScalar(AdvSimd.LoadVector64((UInt32*)(pClsVar1)));
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var result = AdvSimd
                .Arm64
                .ExtractNarrowingSaturateScalar(AdvSimd.LoadVector64((UInt32*)(&test._fld1)));
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.ExtractNarrowingSaturateScalar)}<UInt16>(Vector64<UInt32>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
