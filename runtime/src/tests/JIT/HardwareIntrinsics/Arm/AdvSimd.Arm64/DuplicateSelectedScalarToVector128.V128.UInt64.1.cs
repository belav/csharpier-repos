...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    public sealed unsafe class ImmUnaryOpTest__DuplicateSelectedScalarToVector128_V128_UInt64_1
    {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.Arm64.DuplicateSelectedScalarToVector128(_clsVar, 1);
        ...
        public void RunClassLclFldScenario_Load()
        {
            ...
            fixed (Vector128<UInt64>* pFld = &test._fld)
            {
                var result = AdvSimd
                    .Arm64
                    .DuplicateSelectedScalarToVector128(AdvSimd.LoadVector128((UInt64*)(pFld)), 1);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.DuplicateSelectedScalarToVector128)}<UInt64>(Vector128<UInt64>, 1): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
