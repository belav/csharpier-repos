    ...
    public sealed unsafe class SimpleBinaryOpTest__MaxNumberPairwise_Vector128_Single
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__MaxNumberPairwise_Vector128_Single testClass
            )
            {
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.MaxNumberPairwise)}<Single>(Vector128<Single>, Vector128<Single>): {method} failed:"
                    );
