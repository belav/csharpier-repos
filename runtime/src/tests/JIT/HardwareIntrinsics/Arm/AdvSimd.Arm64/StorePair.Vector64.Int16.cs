...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void StorePair_Vector64_Int16()
        {
    ...
    public sealed unsafe class StoreBinaryOpTest__StorePair_Vector64_Int16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(StoreBinaryOpTest__StorePair_Vector64_Int16 testClass)
            {
                AdvSimd.Arm64.StorePair((Int16*)testClass._dataTable.outArrayPtr, _fld1, _fld2);

                testClass.ValidateResult(_fld1, _fld2, testClass._dataTable.outArrayPtr);
            }

            public void RunStructFldScenario_Load(
                StoreBinaryOpTest__StorePair_Vector64_Int16 testClass
            )
            {
        ...
        static StoreBinaryOpTest__StorePair_Vector64_Int16()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetInt16();
        ...
        public StoreBinaryOpTest__StorePair_Vector64_Int16()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            typeof(AdvSimd.Arm64)
                .GetMethod(
                    ...
                    new Type[] { typeof(Int16*), typeof(Vector64<Int16>), typeof(Vector64<Int16>) }
                )
                .Invoke(
                    null,
                    new object[]
        ...
        public void RunClsVarScenario()
        {
            ...
            AdvSimd.Arm64.StorePair((Int16*)_dataTable.outArrayPtr, _clsVar1, _clsVar2);
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            AdvSimd.Arm64.StorePair((Int16*)_dataTable.outArrayPtr, op1, op2);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new StoreBinaryOpTest__StorePair_Vector64_Int16();
            AdvSimd.Arm64.StorePair((Int16*)_dataTable.outArrayPtr, test._fld1, test._fld2);
        ...
        public void RunClassFldScenario()
        {
            ...
            AdvSimd.Arm64.StorePair((Int16*)_dataTable.outArrayPtr, _fld1, _fld2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.StorePair)}<Int16>(Vector64<Int16>, Vector64<Int16>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
