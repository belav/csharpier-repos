    ...
    public sealed unsafe class ImmUnaryOpTest__ShiftLeftLogicalSaturateScalar_Vector64_Byte_7
    {
        ...
        private struct TestStruct
        {
            ...
            )
            {
                fixed (Vector64<Byte>* pFld = &_fld)
                {
                    var result = AdvSimd
                        .Arm64
                        .ShiftLeftLogicalSaturateScalar(AdvSimd.LoadVector64((Byte*)(pFld)), 7);
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64)
                ...
                .Invoke(
                    null,
                    new object[] { Unsafe.Read<Vector64<Byte>>(_dataTable.inArrayPtr), (byte)7 }
                );
        ...
        public void RunReflectionScenario_Load()
        {
            ...
            var result = typeof(AdvSimd.Arm64)
                ...
                .Invoke(
                    null,
                    new object[] { AdvSimd.LoadVector64((Byte*)(_dataTable.inArrayPtr)), (byte)7 }
                );
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.Arm64.ShiftLeftLogicalSaturateScalar(_clsVar, 7);
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            fixed (Vector64<Byte>* pClsVar = &_clsVar)
            {
                var result = AdvSimd
                    .Arm64
                    .ShiftLeftLogicalSaturateScalar(AdvSimd.LoadVector64((Byte*)(pClsVar)), 7);
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var result = AdvSimd
                .Arm64
                .ShiftLeftLogicalSaturateScalar(AdvSimd.LoadVector64((Byte*)(&test._fld)), 7);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.ShiftLeftLogicalSaturateScalar)}<Byte>(Vector64<Byte>, 7): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
