...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void AddAcrossWidening_Vector128_Int16()
        {
            var test = new SimpleUnaryOpTest__AddAcrossWidening_Vector128_Int16();
    ...
    public sealed unsafe class SimpleUnaryOpTest__AddAcrossWidening_Vector128_Int16
    {
        ...
        private struct TestStruct
        {
            ...
            )
            {
                fixed (Vector128<Int16>* pFld1 = &_fld1)
                {
                    var result = AdvSimd
                        .Arm64
                        .AddAcrossWidening(AdvSimd.LoadVector128((Int16*)(pFld1)));
        ...
        static SimpleUnaryOpTest__AddAcrossWidening_Vector128_Int16()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetInt16();
        ...
        public SimpleUnaryOpTest__AddAcrossWidening_Vector128_Int16()
        {
            Succeeded = true;
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd
                .Arm64
                .AddAcrossWidening(Unsafe.Read<Vector128<Int16>>(_dataTable.inArray1Ptr));
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var result = AdvSimd
                .Arm64
                .AddAcrossWidening(AdvSimd.LoadVector128((Int16*)(_dataTable.inArray1Ptr)));
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            fixed (Vector128<Int16>* pClsVar1 = &_clsVar1)
            {
                var result = AdvSimd
                    .Arm64
                    .AddAcrossWidening(AdvSimd.LoadVector128((Int16*)(pClsVar1)));
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var result = AdvSimd
                .Arm64
                .AddAcrossWidening(AdvSimd.LoadVector128((Int16*)(&test._fld1)));
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.AddAcrossWidening)}<Int32>(Vector128<Int16>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
