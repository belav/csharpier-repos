...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ZipLow_Vector128_UInt16()
        {
            var test = new SimpleBinaryOpTest__ZipLow_Vector128_UInt16();
    ...
    public sealed unsafe class SimpleBinaryOpTest__ZipLow_Vector128_UInt16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__ZipLow_Vector128_UInt16 testClass)
            {
            ...
            public void RunStructFldScenario_Load(
                SimpleBinaryOpTest__ZipLow_Vector128_UInt16 testClass
            )
            {
        ...
        static SimpleBinaryOpTest__ZipLow_Vector128_UInt16()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetUInt16();
        ...
        public SimpleBinaryOpTest__ZipLow_Vector128_UInt16()
        {
            Succeeded = true;
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.ZipLow)}<UInt16>(Vector128<UInt16>, Vector128<UInt16>): {method} failed:"
                    );
