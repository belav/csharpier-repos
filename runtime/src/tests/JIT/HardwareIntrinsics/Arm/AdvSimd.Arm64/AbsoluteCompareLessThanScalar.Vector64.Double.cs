...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void AbsoluteCompareLessThanScalar_Vector64_Double()
        {
            var test = new SimpleBinaryOpTest__AbsoluteCompareLessThanScalar_Vector64_Double();
    ...
    public sealed unsafe class SimpleBinaryOpTest__AbsoluteCompareLessThanScalar_Vector64_Double
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__AbsoluteCompareLessThanScalar_Vector64_Double testClass
            ) {
                var result = AdvSimd.Arm64.AbsoluteCompareLessThanScalar(_fld1, _fld2);
            ...
            public void RunStructFldScenario_Load(
                ...
                {
                    var result = AdvSimd.Arm64.AbsoluteCompareLessThanScalar(
        ...
        static SimpleBinaryOpTest__AbsoluteCompareLessThanScalar_Vector64_Double()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetDouble();
        ...
        public SimpleBinaryOpTest__AbsoluteCompareLessThanScalar_Vector64_Double()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64).GetMethod(
                    nameof(AdvSimd.Arm64.AbsoluteCompareLessThanScalar),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.Arm64.AbsoluteCompareLessThanScalar(_clsVar1, _clsVar2);
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.Arm64.AbsoluteCompareLessThanScalar(op1, op2);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimpleBinaryOpTest__AbsoluteCompareLessThanScalar_Vector64_Double();
            var result = AdvSimd.Arm64.AbsoluteCompareLessThanScalar(test._fld1, test._fld2);
        ...
        private void ValidateResult(
            ...
            if (
                BitConverter.DoubleToInt64Bits(Helpers.AbsoluteCompareLessThan(left[0], right[0]))
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.AbsoluteCompareLessThanScalar)}<Double>(Vector64<Double>, Vector64<Double>): {method} failed:"
                );
