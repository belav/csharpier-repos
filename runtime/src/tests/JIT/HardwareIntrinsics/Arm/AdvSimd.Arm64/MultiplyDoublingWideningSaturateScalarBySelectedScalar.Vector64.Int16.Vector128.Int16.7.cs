...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void MultiplyDoublingWideningSaturateScalarBySelectedScalar_Vector64_Int16_Vector128_Int16_7()
        {
            var test =
                new ImmBinaryOpTest__MultiplyDoublingWideningSaturateScalarBySelectedScalar_Vector64_Int16_Vector128_Int16_7();
    ...
    public sealed unsafe class ImmBinaryOpTest__MultiplyDoublingWideningSaturateScalarBySelectedScalar_Vector64_Int16_Vector128_Int16_7
    {
        ...
        private struct TestStruct
        {
            ...
            public static TestStruct Create()
            {
                ...
                Unsafe.CopyBlockUnaligned(
                    ref Unsafe.As<Vector128<Int16>, byte>(ref testStruct._fld2),
            ...
            public void RunStructFldScenario(
                ImmBinaryOpTest__MultiplyDoublingWideningSaturateScalarBySelectedScalar_Vector64_Int16_Vector128_Int16_7 testClass
            )
            {
                var result = AdvSimd
                    .Arm64
                    .MultiplyDoublingWideningSaturateScalarBySelectedScalar(_fld1, _fld2, 7);
        ...
        static ImmBinaryOpTest__MultiplyDoublingWideningSaturateScalarBySelectedScalar_Vector64_Int16_Vector128_Int16_7()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetInt16();
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector128<Int16>, byte>(ref _clsVar2),
                ref Unsafe.As<Int16, byte>(ref _data2[0]),
                (uint)Unsafe.SizeOf<Vector128<Int16>>()
            );
        }

        public ImmBinaryOpTest__MultiplyDoublingWideningSaturateScalarBySelectedScalar_Vector64_Int16_Vector128_Int16_7()
        {
            Succeeded = true;
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector128<Int16>, byte>(ref _fld2),
                ref Unsafe.As<Int16, byte>(ref _data2[0]),
                (uint)Unsafe.SizeOf<Vector128<Int16>>()
            );
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64)
                .GetMethod(
                    nameof(AdvSimd.Arm64.MultiplyDoublingWideningSaturateScalarBySelectedScalar),
                    new Type[] { typeof(Vector64<Int16>), typeof(Vector128<Int16>), typeof(byte) }
                )
                .Invoke(
                    null,
                    new object[]
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd
                .Arm64
                .MultiplyDoublingWideningSaturateScalarBySelectedScalar(_clsVar1, _clsVar2, 7);
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd
                .Arm64
                .MultiplyDoublingWideningSaturateScalarBySelectedScalar(op1, op2, 7);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var result = AdvSimd
                .Arm64
                .MultiplyDoublingWideningSaturateScalarBySelectedScalar(test._fld1, test._fld2, 7);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.MultiplyDoublingWideningSaturateScalarBySelectedScalar)}<Int32>(Vector64<Int16>, Vector128<Int16>, 7): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
