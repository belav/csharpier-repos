...
namespace JIT.HardwareIntrinsics.Arm
{
    public static partial class Program
    {
        ...
        {
            var test =
                new SimpleTernaryOpTest__FusedMultiplySubtractBySelectedScalar_Vector128_Double_Vector128_Double_1();
    ...
    public sealed unsafe class SimpleTernaryOpTest__FusedMultiplySubtractBySelectedScalar_Vector128_Double_Vector128_Double_1
    {
        private struct DataTable
        {
            ...
            )
            {
                ...
                Unsafe.CopyBlockUnaligned(
                    ...
                    ref Unsafe.As<Double, byte>(ref inArray3[0]),
                    (uint)sizeOfinArray3
                );
            }
        ...
        private struct TestStruct
        {
            ...
            public static TestStruct Create()
            {
                ...
                Unsafe.CopyBlockUnaligned(
                    ref Unsafe.As<Vector128<Double>, byte>(ref testStruct._fld3),
                    ref Unsafe.As<Double, byte>(ref _data3[0]),
                    (uint)Unsafe.SizeOf<Vector128<Double>>()
                );
            ...
            public void RunStructFldScenario(
                SimpleTernaryOpTest__FusedMultiplySubtractBySelectedScalar_Vector128_Double_Vector128_Double_1 testClass
            )
            {
                var result = AdvSimd
                    .Arm64
                    .FusedMultiplySubtractBySelectedScalar(_fld1, _fld2, _fld3, 1);
        ...
        static SimpleTernaryOpTest__FusedMultiplySubtractBySelectedScalar_Vector128_Double_Vector128_Double_1()
        {
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector128<Double>, byte>(ref _clsVar3),
                ref Unsafe.As<Double, byte>(ref _data3[0]),
                (uint)Unsafe.SizeOf<Vector128<Double>>()
            );
        }
        ...
        public SimpleTernaryOpTest__FusedMultiplySubtractBySelectedScalar_Vector128_Double_Vector128_Double_1()
        {
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector128<Double>, byte>(ref _fld3),
                ref Unsafe.As<Double, byte>(ref _data3[0]),
                (uint)Unsafe.SizeOf<Vector128<Double>>()
            );
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64)
                .GetMethod(
                    nameof(AdvSimd.Arm64.FusedMultiplySubtractBySelectedScalar),
                    new Type[]
                    {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd
                .Arm64
                .FusedMultiplySubtractBySelectedScalar(_clsVar1, _clsVar2, _clsVar3, 1);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var result = AdvSimd
                .Arm64
                .FusedMultiplySubtractBySelectedScalar(test._fld1, test._fld2, test._fld3, 1);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.FusedMultiplySubtractBySelectedScalar)}<Double>(Vector128<Double>, Vector128<Double>, Vector128<Double>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
