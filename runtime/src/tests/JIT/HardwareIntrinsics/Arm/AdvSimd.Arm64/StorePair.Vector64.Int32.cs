...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void StorePair_Vector64_Int32()
        {
            var test = new StoreBinaryOpTest__StorePair_Vector64_Int32();
    ...
    public sealed unsafe class StoreBinaryOpTest__StorePair_Vector64_Int32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(StoreBinaryOpTest__StorePair_Vector64_Int32 testClass)
            {
            ...
            public void RunStructFldScenario_Load(
                StoreBinaryOpTest__StorePair_Vector64_Int32 testClass
            )
            {
        ...
        static StoreBinaryOpTest__StorePair_Vector64_Int32()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetInt32();
        ...
        public StoreBinaryOpTest__StorePair_Vector64_Int32()
        {
            Succeeded = true;
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.StorePair)}<Int32>(Vector64<Int32>, Vector64<Int32>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
