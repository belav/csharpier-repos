...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void LoadPairVector64NonTemporal_Int32()
        {
            var test = new LoadPairVector64NonTemporal_Int32();
    ...
    public sealed unsafe class LoadPairVector64NonTemporal_Int32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(LoadPairVector64NonTemporal_Int32 testClass)
            {
                _fld = AdvSimd
                    .Arm64
                    .LoadPairVector64NonTemporal((Int32*)(testClass._dataTable.inArrayPtr));
        ...
        public LoadPairVector64NonTemporal_Int32()
        {
            Succeeded = true;
        ...
        public void RunBasicScenario()
        {
            ...
            var result = AdvSimd.Arm64.LoadPairVector64NonTemporal((Int32*)(_dataTable.inArrayPtr));
        ...
        public void RunClsVarScenario()
        {
            ...
            _clsVar = AdvSimd.Arm64.LoadPairVector64NonTemporal((Int32*)(_dataTable.inArrayPtr));
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new LoadPairVector64NonTemporal_Int32();
            test._fld = AdvSimd.Arm64.LoadPairVector64NonTemporal((Int32*)(_dataTable.inArrayPtr));
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.LoadPairVector64NonTemporal)}<Int32>(Vector64<Int32>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
