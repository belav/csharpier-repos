    ...
    public sealed unsafe class ImmUnaryOpTest__ShiftRightArithmeticRoundedNarrowingSaturateScalar_Vector64_Int32_64
    {
        ...
        private struct TestStruct
        {
            ...
            )
            {
                var result = AdvSimd
                    .Arm64
                    .ShiftRightArithmeticRoundedNarrowingSaturateScalar(_fld, 32);
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd
                .Arm64
                .ShiftRightArithmeticRoundedNarrowingSaturateScalar(_clsVar, 32);
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd
                .Arm64
                .ShiftRightArithmeticRoundedNarrowingSaturateScalar(firstOp, 32);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var result = AdvSimd
                .Arm64
                .ShiftRightArithmeticRoundedNarrowingSaturateScalar(test._fld, 32);
