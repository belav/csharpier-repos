    ...
    public sealed unsafe class SimpleBinaryOpTest__ZipLow_Vector128_Double
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario_Load(
                SimpleBinaryOpTest__ZipLow_Vector128_Double testClass
            )
            {
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.ZipLow)}<Double>(Vector128<Double>, Vector128<Double>): {method} failed:"
                    );
