...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void MultiplyExtendedScalar_Vector64_Double()
        {
            var test = new SimpleBinaryOpTest__MultiplyExtendedScalar_Vector64_Double();
    ...
    public sealed unsafe class SimpleBinaryOpTest__MultiplyExtendedScalar_Vector64_Double
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__MultiplyExtendedScalar_Vector64_Double testClass
            ) {
        ...
        static SimpleBinaryOpTest__MultiplyExtendedScalar_Vector64_Double()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetDouble();
        ...
        public SimpleBinaryOpTest__MultiplyExtendedScalar_Vector64_Double()
        {
            Succeeded = true;
        ...
        private void ValidateResult(
            ...
            if (
                BitConverter.DoubleToInt64Bits(Helpers.MultiplyExtended(left[0], right[0]))
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.MultiplyExtendedScalar)}<Double>(Vector64<Double>, Vector64<Double>): {method} failed:"
                );
