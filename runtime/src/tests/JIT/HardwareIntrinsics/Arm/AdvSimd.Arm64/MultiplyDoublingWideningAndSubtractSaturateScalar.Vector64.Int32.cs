...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void MultiplyDoublingWideningAndSubtractSaturateScalar_Vector64_Int32()
        {
            var test =
                new SimpleTernaryOpTest__MultiplyDoublingWideningAndSubtractSaturateScalar_Vector64_Int32();
    ...
    public sealed unsafe class SimpleTernaryOpTest__MultiplyDoublingWideningAndSubtractSaturateScalar_Vector64_Int32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleTernaryOpTest__MultiplyDoublingWideningAndSubtractSaturateScalar_Vector64_Int32 testClass
            )
            {
                var result = AdvSimd
                    .Arm64
                    .MultiplyDoublingWideningAndSubtractSaturateScalar(_fld1, _fld2, _fld3);
        ...
        static SimpleTernaryOpTest__MultiplyDoublingWideningAndSubtractSaturateScalar_Vector64_Int32()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetInt64();
        ...
        public SimpleTernaryOpTest__MultiplyDoublingWideningAndSubtractSaturateScalar_Vector64_Int32()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64)
                .GetMethod(
                    nameof(AdvSimd.Arm64.MultiplyDoublingWideningAndSubtractSaturateScalar),
                    new Type[]
                    {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd
                .Arm64
                .MultiplyDoublingWideningAndSubtractSaturateScalar(_clsVar1, _clsVar2, _clsVar3);
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd
                .Arm64
                .MultiplyDoublingWideningAndSubtractSaturateScalar(op1, op2, op3);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.MultiplyDoublingWideningAndSubtractSaturateScalar)}<Int64>(Vector64<Int64>, Vector64<Int32>, Vector64<Int32>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
