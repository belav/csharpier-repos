    ...
    public sealed unsafe class SimpleBinaryOpTest__SubtractSaturateScalar_Vector64_SByte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__SubtractSaturateScalar_Vector64_SByte testClass
            )
            {
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.SubtractSaturateScalar)}<SByte>(Vector64<SByte>, Vector64<SByte>): {method} failed:"
                    );
