    ...
    public sealed unsafe class SimpleBinaryOpTest__AddSaturateScalar_Vector64_Int32_Vector64_UInt32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__AddSaturateScalar_Vector64_Int32_Vector64_UInt32 testClass
            )
            {
            ...
            {
                fixed (Vector64<Int32>* pFld1 = &_fld1)fixed (Vector64<UInt32>* pFld2 = &_fld2)
                {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64).GetMethod(
                    ...
                    new Type[] { typeof(Vector64<Int32>), typeof(Vector64<UInt32>) }
                )
                .Invoke(
                    null,
                    new object[]
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.AddSaturateScalar)}<Int32>(Vector64<Int32>, Vector64<UInt32>): {method} failed:"
                );
