...
namespace JIT.HardwareIntrinsics.Arm
{
    public static partial class Program
    {
        ...
        {
            var test =
                new SimpleUnaryOpTest__ExtractNarrowingSaturateUnsignedScalar_Vector64_UInt32();
    ...
    public sealed unsafe class SimpleUnaryOpTest__ExtractNarrowingSaturateUnsignedScalar_Vector64_UInt32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__ExtractNarrowingSaturateUnsignedScalar_Vector64_UInt32 testClass
            )
            {
        ...
        public void RunClassLclFldScenario_Load()
        {
            ...
            fixed (Vector64<Int64>* pFld1 = &test._fld1)
            {
                var result = AdvSimd
                    .Arm64
                    .ExtractNarrowingSaturateUnsignedScalar(AdvSimd.LoadVector64((Int64*)(pFld1)));
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.ExtractNarrowingSaturateUnsignedScalar)}<UInt32>(Vector64<Int64>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
