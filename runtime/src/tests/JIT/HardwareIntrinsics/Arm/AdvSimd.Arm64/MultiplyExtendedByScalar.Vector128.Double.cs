    ...
    public sealed unsafe class SimpleBinaryOpTest__MultiplyExtendedByScalar_Vector128_Double
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__MultiplyExtendedByScalar_Vector128_Double testClass
            ) {
            ...
            public void RunStructFldScenario_Load(
                ...
                fixed (Vector128<Double>* pFld1 = &_fld1)fixed (Vector64<Double>* pFld2 = &_fld2)
                {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64).GetMethod(
                    nameof(AdvSimd.Arm64.MultiplyExtendedByScalar),
                    new Type[] { typeof(Vector128<Double>), typeof(Vector64<Double>) }
                )
                .Invoke(
                    null,
                    new object[]
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.Arm64.MultiplyExtendedByScalar(_clsVar1, _clsVar2);
        ...
        private void ValidateResult(
            ...
            {
                if (
                    BitConverter.DoubleToInt64Bits(Helpers.MultiplyExtended(left[i], right[0]))
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.MultiplyExtendedByScalar)}<Double>(Vector128<Double>, Vector64<Double>): {method} failed:"
                );
