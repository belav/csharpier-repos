    ...
    public sealed unsafe class SimpleBinaryOpTest__AddSaturate_Vector64_UInt32_Vector64_Int32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__AddSaturate_Vector64_UInt32_Vector64_Int32 testClass
            )
            {
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.AddSaturate)}<UInt32>(Vector64<UInt32>, Vector64<Int32>): {method} failed:"
                    );
