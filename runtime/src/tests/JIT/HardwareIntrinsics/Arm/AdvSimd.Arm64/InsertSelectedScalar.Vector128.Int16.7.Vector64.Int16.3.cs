...
namespace JIT.HardwareIntrinsics.Arm
{
    public static partial class Program
    {
        ...
        {
            var test =
                new InsertSelectedScalarTest__InsertSelectedScalar_Vector128_Int16_7_Vector64_Int16_3();
    ...
    public sealed unsafe class InsertSelectedScalarTest__InsertSelectedScalar_Vector128_Int16_7_Vector64_Int16_3
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                InsertSelectedScalarTest__InsertSelectedScalar_Vector128_Int16_7_Vector64_Int16_3 testClass
            ) {
            ...
            public void RunStructFldScenario_Load(
                ...
                fixed (Vector128<Int16>* pFld1 = &_fld1)fixed (Vector64<Int16>* pFld2 = &_fld3)
                {
        ...
        public void RunClassLclFldScenario_Load()
        {
            ...
            fixed (Vector128<Int16>* pFld1 = &test._fld1)fixed (
                Vector64<Int16>* pFld2 = &test._fld3
            ) {
                var result = AdvSimd.Arm64.InsertSelectedScalar(
                    AdvSimd.LoadVector128((Int16*)pFld1),
                    7,
        ...
        private void ValidateResult(
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.InsertSelectedScalar)}<Int16>(Vector128<Int16>, {7}, Vector64<Int16>, {3}): {method} failed:"
                );
                TestLibrary.TestFramework.LogInformation(
