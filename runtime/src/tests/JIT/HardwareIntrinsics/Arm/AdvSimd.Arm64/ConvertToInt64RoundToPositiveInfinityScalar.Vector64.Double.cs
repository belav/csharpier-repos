...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ConvertToInt64RoundToPositiveInfinityScalar_Vector64_Double()
        {
            var test =
                new SimpleUnaryOpTest__ConvertToInt64RoundToPositiveInfinityScalar_Vector64_Double();
    ...
    public sealed unsafe class SimpleUnaryOpTest__ConvertToInt64RoundToPositiveInfinityScalar_Vector64_Double
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__ConvertToInt64RoundToPositiveInfinityScalar_Vector64_Double testClass
            )
            {
                var result = AdvSimd.Arm64.ConvertToInt64RoundToPositiveInfinityScalar(_fld1);
            ...
            )
            {
                ...
                {
                    var result = AdvSimd.Arm64.ConvertToInt64RoundToPositiveInfinityScalar(
        ...
        static SimpleUnaryOpTest__ConvertToInt64RoundToPositiveInfinityScalar_Vector64_Double()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetDouble();
        ...
        public SimpleUnaryOpTest__ConvertToInt64RoundToPositiveInfinityScalar_Vector64_Double()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64).GetMethod(
                    nameof(AdvSimd.Arm64.ConvertToInt64RoundToPositiveInfinityScalar),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.Arm64.ConvertToInt64RoundToPositiveInfinityScalar(_clsVar1);
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.Arm64.ConvertToInt64RoundToPositiveInfinityScalar(op1);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test =
                new SimpleUnaryOpTest__ConvertToInt64RoundToPositiveInfinityScalar_Vector64_Double();
            var result = AdvSimd.Arm64.ConvertToInt64RoundToPositiveInfinityScalar(test._fld1);
        ...
        )
        {
            ...
            if (Helpers.ConvertToInt64RoundToPositiveInfinity(firstOp[0]) != result[0])
            {
                succeeded = false;
            }
            else
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.ConvertToInt64RoundToPositiveInfinityScalar)}<Int64>(Vector64<Double>): {method} failed:"
                );
                TestLibrary.TestFramework.LogInformation(
