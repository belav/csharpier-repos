...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void LoadPairVector128_UInt16()
        {
            var test = new LoadPairVector128_UInt16();
    ...
    public sealed unsafe class LoadPairVector128_UInt16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(LoadPairVector128_UInt16 testClass)
            {
                _fld = AdvSimd.Arm64.LoadPairVector128((UInt16*)(testClass._dataTable.inArrayPtr));
        ...
        private static readonly int RetElementCount =
            Unsafe.SizeOf<(Vector128<UInt16>, Vector128<UInt16>)>() / sizeof(UInt16);
        ...
        public LoadPairVector128_UInt16()
        {
            Succeeded = true;
        ...
        public void RunBasicScenario()
        {
            ...
            var result = AdvSimd.Arm64.LoadPairVector128((UInt16*)(_dataTable.inArrayPtr));
        ...
        public void RunReflectionScenario()
        {
            ...
            var result = typeof(AdvSimd.Arm64)
                .GetMethod(nameof(AdvSimd.Arm64.LoadPairVector128), new Type[] { typeof(UInt16*) })
        ...
        public void RunClsVarScenario()
        {
            ...
            _clsVar = AdvSimd.Arm64.LoadPairVector128((UInt16*)(_dataTable.inArrayPtr));
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.LoadPairVector128)}<UInt16>(Vector128<UInt16>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
