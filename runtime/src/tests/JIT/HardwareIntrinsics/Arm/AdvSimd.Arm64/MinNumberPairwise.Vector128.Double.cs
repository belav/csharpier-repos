    ...
    public sealed unsafe class SimpleBinaryOpTest__MinNumberPairwise_Vector128_Double
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__MinNumberPairwise_Vector128_Double testClass
            )
            {
        ...
        )
        {
            ...
            {
                if (
                    BitConverter.DoubleToInt64Bits(Helpers.MinNumberPairwise(left, right, i))
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.MinNumberPairwise)}<Double>(Vector128<Double>, Vector128<Double>): {method} failed:"
                    );
