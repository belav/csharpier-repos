    ...
    public sealed unsafe class SimpleUnaryOpTest__AddAcrossWidening_Vector128_Int32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__AddAcrossWidening_Vector128_Int32 testClass
            )
            {
            ...
            )
            {
                fixed (Vector128<Int32>* pFld1 = &_fld1)
                {
                    var result = AdvSimd
                        .Arm64
                        .AddAcrossWidening(AdvSimd.LoadVector128((Int32*)(pFld1)));
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd
                .Arm64
                .AddAcrossWidening(Unsafe.Read<Vector128<Int32>>(_dataTable.inArray1Ptr));
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var result = AdvSimd
                .Arm64
                .AddAcrossWidening(AdvSimd.LoadVector128((Int32*)(_dataTable.inArray1Ptr)));
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            fixed (Vector128<Int32>* pClsVar1 = &_clsVar1)
            {
                var result = AdvSimd
                    .Arm64
                    .AddAcrossWidening(AdvSimd.LoadVector128((Int32*)(pClsVar1)));
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var result = AdvSimd
                .Arm64
                .AddAcrossWidening(AdvSimd.LoadVector128((Int32*)(&test._fld1)));
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.AddAcrossWidening)}<Int64>(Vector128<Int32>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
