    ...
    public sealed unsafe class SimpleUnaryOpTest__AddAcrossWidening_Vector64_UInt16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__AddAcrossWidening_Vector64_UInt16 testClass
            )
            {
            ...
            )
            {
                fixed (Vector64<UInt16>* pFld1 = &_fld1)
                {
                    var result = AdvSimd
                        .Arm64
                        .AddAcrossWidening(AdvSimd.LoadVector64((UInt16*)(pFld1)));
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd
                .Arm64
                .AddAcrossWidening(Unsafe.Read<Vector64<UInt16>>(_dataTable.inArray1Ptr));
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var result = AdvSimd
                .Arm64
                .AddAcrossWidening(AdvSimd.LoadVector64((UInt16*)(_dataTable.inArray1Ptr)));
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            fixed (Vector64<UInt16>* pClsVar1 = &_clsVar1)
            {
                var result = AdvSimd
                    .Arm64
                    .AddAcrossWidening(AdvSimd.LoadVector64((UInt16*)(pClsVar1)));
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var result = AdvSimd
                .Arm64
                .AddAcrossWidening(AdvSimd.LoadVector64((UInt16*)(&test._fld1)));
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.AddAcrossWidening)}<UInt32>(Vector64<UInt16>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
