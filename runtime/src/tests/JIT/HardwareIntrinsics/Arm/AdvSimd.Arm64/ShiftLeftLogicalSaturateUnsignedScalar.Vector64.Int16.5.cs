...
namespace JIT.HardwareIntrinsics.Arm
{
    public static partial class Program
    {
        ...
        {
            var test =
                new ImmUnaryOpTest__ShiftLeftLogicalSaturateUnsignedScalar_Vector64_Int16_5();
    ...
    public sealed unsafe class ImmUnaryOpTest__ShiftLeftLogicalSaturateUnsignedScalar_Vector64_Int16_5
    {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64)
                ...
                .Invoke(
                    null,
                    new object[] { Unsafe.Read<Vector64<Int16>>(_dataTable.inArrayPtr), (byte)5 }
                );
        ...
        public void RunReflectionScenario_Load()
        {
            ...
            var result = typeof(AdvSimd.Arm64)
                ...
                .Invoke(
                    null,
                    new object[] { AdvSimd.LoadVector64((Int16*)(_dataTable.inArrayPtr)), (byte)5 }
                );
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.Arm64.ShiftLeftLogicalSaturateUnsignedScalar(_clsVar, 5);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.ShiftLeftLogicalSaturateUnsignedScalar)}<UInt16>(Vector64<Int16>, 5): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
