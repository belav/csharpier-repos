...
namespace JIT.HardwareIntrinsics.Arm
{
    public static partial class Program
    {
        ...
        {
            var test =
                new InsertSelectedScalarTest__InsertSelectedScalar_Vector128_Int32_3_Vector64_Int32_1();
    ...
    public sealed unsafe class InsertSelectedScalarTest__InsertSelectedScalar_Vector128_Int32_3_Vector64_Int32_1
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                InsertSelectedScalarTest__InsertSelectedScalar_Vector128_Int32_3_Vector64_Int32_1 testClass
            )
            {
            ...
            {
                fixed (Vector128<Int32>* pFld1 = &_fld1)fixed (Vector64<Int32>* pFld2 = &_fld3)
                {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.Arm64.InsertSelectedScalar(_clsVar1, 3, _clsVar3, 1);
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            fixed (Vector128<Int32>* pClsVar1 = &_clsVar1)fixed (
                Vector64<Int32>* pClsVar3 = &_clsVar3
            )
            {
                var result = AdvSimd.Arm64.InsertSelectedScalar(
        ...
        public void RunClassLclFldScenario_Load()
        {
            ...
            fixed (Vector128<Int32>* pFld1 = &test._fld1)fixed (
                Vector64<Int32>* pFld2 = &test._fld3
            )
            {
                var result = AdvSimd.Arm64.InsertSelectedScalar(
                    AdvSimd.LoadVector128((Int32*)pFld1),
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.InsertSelectedScalar)}<Int32>(Vector128<Int32>, {3}, Vector64<Int32>, {1}): {method} failed:"
                );
                TestLibrary.TestFramework.LogInformation(
