...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ConvertToDouble_Vector128_Int64()
        {
            var test = new SimpleUnaryOpTest__ConvertToDouble_Vector128_Int64();
    ...
    public sealed unsafe class SimpleUnaryOpTest__ConvertToDouble_Vector128_Int64
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__ConvertToDouble_Vector128_Int64 testClass
            )
            {
            ...
            )
            {
                fixed (Vector128<Int64>* pFld1 = &_fld1)
                {
                    var result = AdvSimd
                        .Arm64
                        .ConvertToDouble(AdvSimd.LoadVector128((Int64*)(pFld1)));
        ...
        static SimpleUnaryOpTest__ConvertToDouble_Vector128_Int64()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetInt64();
        ...
        public SimpleUnaryOpTest__ConvertToDouble_Vector128_Int64()
        {
            Succeeded = true;
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd
                .Arm64
                .ConvertToDouble(Unsafe.Read<Vector128<Int64>>(_dataTable.inArray1Ptr));
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var result = AdvSimd
                .Arm64
                .ConvertToDouble(AdvSimd.LoadVector128((Int64*)(_dataTable.inArray1Ptr)));
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64)
                .GetMethod(
                    nameof(AdvSimd.Arm64.ConvertToDouble),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.Arm64.ConvertToDouble(_clsVar1);
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            fixed (Vector128<Int64>* pClsVar1 = &_clsVar1)
            {
                var result = AdvSimd
                    .Arm64
                    .ConvertToDouble(AdvSimd.LoadVector128((Int64*)(pClsVar1)));
        ...
        public void RunClassLclFldScenario_Load()
        {
            ...
            {
                var result = AdvSimd.Arm64.ConvertToDouble(AdvSimd.LoadVector128((Int64*)(pFld1)));
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var result = AdvSimd
                .Arm64
                .ConvertToDouble(AdvSimd.LoadVector128((Int64*)(&test._fld1)));
        ...
        )
        {
            ...
            {
                if (
                    BitConverter.DoubleToInt64Bits(Helpers.ConvertToDouble(firstOp[i]))
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.ConvertToDouble)}<Double>(Vector128<Int64>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
