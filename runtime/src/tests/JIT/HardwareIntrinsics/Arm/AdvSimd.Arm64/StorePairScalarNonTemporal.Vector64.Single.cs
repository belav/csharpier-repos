...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void StorePairScalarNonTemporal_Vector64_Single()
        {
    ...
    public sealed unsafe class StoreBinaryOpTest__StorePairScalarNonTemporal_Vector64_Single
    {
        ...
        static StoreBinaryOpTest__StorePairScalarNonTemporal_Vector64_Single()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetSingle();
        ...
        public StoreBinaryOpTest__StorePairScalarNonTemporal_Vector64_Single()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            typeof(AdvSimd.Arm64)
                .GetMethod(
                    nameof(AdvSimd.Arm64.StorePairScalarNonTemporal),
                    new Type[]
                    {
                        typeof(Single*),
        ...
        public void RunClsVarScenario()
        {
            ...
            AdvSimd
                .Arm64
                .StorePairScalarNonTemporal((Single*)_dataTable.outArrayPtr, _clsVar1, _clsVar2);
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            AdvSimd.Arm64.StorePairScalarNonTemporal((Single*)_dataTable.outArrayPtr, op1, op2);
        ...
        public void RunClassFldScenario()
        {
            ...
            AdvSimd.Arm64.StorePairScalarNonTemporal((Single*)_dataTable.outArrayPtr, _fld1, _fld2);
        ...
        )
        {
            ...
            Unsafe.CopyBlockUnaligned(
                ...
                (uint)(RetElementCount * Unsafe.SizeOf<Single>())
            );
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.StorePairScalarNonTemporal)}<Single>(Vector64<Single>, Vector64<Single>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
