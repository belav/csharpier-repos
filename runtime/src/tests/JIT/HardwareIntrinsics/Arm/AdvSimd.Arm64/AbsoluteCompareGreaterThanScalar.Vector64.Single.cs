...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    public sealed unsafe class SimpleBinaryOpTest__AbsoluteCompareGreaterThanScalar_Vector64_Single
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__AbsoluteCompareGreaterThanScalar_Vector64_Single testClass
            ) {
                var result = AdvSimd.Arm64.AbsoluteCompareGreaterThanScalar(_fld1, _fld2);
            ...
            public void RunStructFldScenario_Load(
                ...
                {
                    var result = AdvSimd.Arm64.AbsoluteCompareGreaterThanScalar(
        ...
        static SimpleBinaryOpTest__AbsoluteCompareGreaterThanScalar_Vector64_Single()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetSingle();
        ...
        public SimpleBinaryOpTest__AbsoluteCompareGreaterThanScalar_Vector64_Single()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64).GetMethod(
                    nameof(AdvSimd.Arm64.AbsoluteCompareGreaterThanScalar),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.Arm64.AbsoluteCompareGreaterThanScalar(_clsVar1, _clsVar2);
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.Arm64.AbsoluteCompareGreaterThanScalar(op1, op2);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimpleBinaryOpTest__AbsoluteCompareGreaterThanScalar_Vector64_Single();
            var result = AdvSimd.Arm64.AbsoluteCompareGreaterThanScalar(test._fld1, test._fld2);
        ...
        private void ValidateResult(
            ...
            if (
                BitConverter.SingleToInt32Bits(
                    Helpers.AbsoluteCompareGreaterThan(left[0], right[0])
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.AbsoluteCompareGreaterThanScalar)}<Single>(Vector64<Single>, Vector64<Single>): {method} failed:"
                );
