    ...
    public sealed unsafe class LoadPairVector64_UInt64
    {
        ...
        public void RunReflectionScenario()
        {
            ...
            var result = typeof(AdvSimd.Arm64)
                .GetMethod(nameof(AdvSimd.Arm64.LoadPairVector64), new Type[] { typeof(UInt64*) })
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.LoadPairVector64)}<UInt64>(Vector64<UInt64>): {method} failed:"
                );
                TestLibrary.TestFramework.LogInformation(
