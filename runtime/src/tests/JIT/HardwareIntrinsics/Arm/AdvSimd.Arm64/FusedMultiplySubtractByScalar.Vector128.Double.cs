    ...
    public sealed unsafe class SimpleTernaryOpTest__FusedMultiplySubtractByScalar_Vector128_Double
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleTernaryOpTest__FusedMultiplySubtractByScalar_Vector128_Double testClass
            )
            {
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.FusedMultiplySubtractByScalar)}<Double>(Vector128<Double>, Vector128<Double>, Vector64<Double>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
