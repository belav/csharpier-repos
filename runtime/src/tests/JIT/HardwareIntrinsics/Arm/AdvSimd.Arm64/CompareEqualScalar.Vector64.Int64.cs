...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void CompareEqualScalar_Vector64_Int64()
        {
    ...
    public sealed unsafe class SimpleBinaryOpTest__CompareEqualScalar_Vector64_Int64
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__CompareEqualScalar_Vector64_Int64 testClass
            )
            {
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.CompareEqualScalar)}<Int64>(Vector64<Int64>, Vector64<Int64>): {method} failed:"
                    );
