    ...
    public sealed unsafe class SimpleUnaryOpTest__MaxAcross_Vector128_UInt32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__MaxAcross_Vector128_UInt32 testClass
            )
            {
            ...
            )
            {
                ...
                {
                    var result = AdvSimd.Arm64.MaxAcross(AdvSimd.LoadVector128((UInt32*)(pFld1)));
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd
                .Arm64
                .MaxAcross(Unsafe.Read<Vector128<UInt32>>(_dataTable.inArray1Ptr));
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var result = AdvSimd
                .Arm64
                .MaxAcross(AdvSimd.LoadVector128((UInt32*)(_dataTable.inArray1Ptr)));
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            {
                var result = AdvSimd.Arm64.MaxAcross(AdvSimd.LoadVector128((UInt32*)(pClsVar1)));
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = AdvSimd.Arm64.MaxAcross(AdvSimd.LoadVector128((UInt32*)(&test._fld1)));
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.MaxAcross)}<UInt32>(Vector128<UInt32>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
