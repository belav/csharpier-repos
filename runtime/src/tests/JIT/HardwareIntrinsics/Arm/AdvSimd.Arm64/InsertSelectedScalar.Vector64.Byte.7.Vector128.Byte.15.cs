...
namespace JIT.HardwareIntrinsics.Arm
{
    public static partial class Program
    {
        ...
        {
            var test =
                new InsertSelectedScalarTest__InsertSelectedScalar_Vector64_Byte_7_Vector128_Byte_15();
    ...
    public sealed unsafe class InsertSelectedScalarTest__InsertSelectedScalar_Vector64_Byte_7_Vector128_Byte_15
    {
        ...
        public void RunClassLclFldScenario_Load()
        {
            ...
            fixed (Vector64<Byte>* pFld1 = &test._fld1)fixed (Vector128<Byte>* pFld2 = &test._fld3)
            {
                var result = AdvSimd.Arm64.InsertSelectedScalar(
                    AdvSimd.LoadVector64((Byte*)pFld1),
                    7,
        ...
        private void ValidateResult(
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.InsertSelectedScalar)}<Byte>(Vector64<Byte>, {7}, Vector128<Byte>, {15}): {method} failed:"
                );
                TestLibrary.TestFramework.LogInformation(
