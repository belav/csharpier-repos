    ...
    public sealed unsafe class SimpleBinaryOpTest__MinNumberPairwise_Vector128_Single
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__MinNumberPairwise_Vector128_Single testClass
            )
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64)
                .GetMethod(
                    nameof(AdvSimd.Arm64.MinNumberPairwise),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.Arm64.MinNumberPairwise(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            {
                if (
                    BitConverter.SingleToInt32Bits(Helpers.MinNumberPairwise(left, right, i))
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.MinNumberPairwise)}<Single>(Vector128<Single>, Vector128<Single>): {method} failed:"
                    );
