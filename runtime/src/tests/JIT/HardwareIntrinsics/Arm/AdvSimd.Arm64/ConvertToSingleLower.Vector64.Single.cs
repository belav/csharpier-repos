...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ConvertToSingleLower_Vector64_Single()
        {
            var test = new SimpleUnaryOpTest__ConvertToSingleLower_Vector64_Single();
    ...
    public sealed unsafe class SimpleUnaryOpTest__ConvertToSingleLower_Vector64_Single
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__ConvertToSingleLower_Vector64_Single testClass
            )
            {
                var result = AdvSimd.Arm64.ConvertToSingleLower(_fld1);
            ...
            )
            {
                fixed (Vector128<Double>* pFld1 = &_fld1)
                {
                    var result = AdvSimd
                        .Arm64
                        .ConvertToSingleLower(AdvSimd.LoadVector128((Double*)(pFld1)));
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd
                .Arm64
                .ConvertToSingleLower(Unsafe.Read<Vector128<Double>>(_dataTable.inArray1Ptr));
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var result = AdvSimd
                .Arm64
                .ConvertToSingleLower(AdvSimd.LoadVector128((Double*)(_dataTable.inArray1Ptr)));
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64)
                .GetMethod(
                    nameof(AdvSimd.Arm64.ConvertToSingleLower),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.Arm64.ConvertToSingleLower(_clsVar1);
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            fixed (Vector128<Double>* pClsVar1 = &_clsVar1)
            {
                var result = AdvSimd
                    .Arm64
                    .ConvertToSingleLower(AdvSimd.LoadVector128((Double*)(pClsVar1)));
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.Arm64.ConvertToSingleLower(op1);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimpleUnaryOpTest__ConvertToSingleLower_Vector64_Single();
            var result = AdvSimd.Arm64.ConvertToSingleLower(test._fld1);
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var result = AdvSimd
                .Arm64
                .ConvertToSingleLower(AdvSimd.LoadVector128((Double*)(&test._fld1)));
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.ConvertToSingleLower)}<Single>(Vector128<Double>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
