...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ConvertToUInt64RoundAwayFromZero_Vector128_Double()
        {
            var test = new SimpleUnaryOpTest__ConvertToUInt64RoundAwayFromZero_Vector128_Double();
    ...
    public sealed unsafe class SimpleUnaryOpTest__ConvertToUInt64RoundAwayFromZero_Vector128_Double
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__ConvertToUInt64RoundAwayFromZero_Vector128_Double testClass
            )
            {
                var result = AdvSimd.Arm64.ConvertToUInt64RoundAwayFromZero(_fld1);
            ...
            )
            {
                fixed (Vector128<Double>* pFld1 = &_fld1)
                {
                    var result = AdvSimd
                        .Arm64
                        .ConvertToUInt64RoundAwayFromZero(AdvSimd.LoadVector128((Double*)(pFld1)));
        ...
        static SimpleUnaryOpTest__ConvertToUInt64RoundAwayFromZero_Vector128_Double()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetDouble();
        ...
        public SimpleUnaryOpTest__ConvertToUInt64RoundAwayFromZero_Vector128_Double()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64)
                .GetMethod(
                    nameof(AdvSimd.Arm64.ConvertToUInt64RoundAwayFromZero),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.Arm64.ConvertToUInt64RoundAwayFromZero(_clsVar1);
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            fixed (Vector128<Double>* pClsVar1 = &_clsVar1)
            {
                var result = AdvSimd
                    .Arm64
                    .ConvertToUInt64RoundAwayFromZero(AdvSimd.LoadVector128((Double*)(pClsVar1)));
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.Arm64.ConvertToUInt64RoundAwayFromZero(op1);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimpleUnaryOpTest__ConvertToUInt64RoundAwayFromZero_Vector128_Double();
            var result = AdvSimd.Arm64.ConvertToUInt64RoundAwayFromZero(test._fld1);
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var result = AdvSimd
                .Arm64
                .ConvertToUInt64RoundAwayFromZero(AdvSimd.LoadVector128((Double*)(&test._fld1)));
        ...
        )
        {
            ...
            {
                if (Helpers.ConvertToUInt64RoundAwayFromZero(firstOp[i]) != result[i])
                {
                    succeeded = false;
                    break;
                }
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.ConvertToUInt64RoundAwayFromZero)}<UInt64>(Vector128<Double>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
