...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ReciprocalSquareRootEstimateScalar_Vector64_Double()
        {
    ...
    public sealed unsafe class SimpleUnaryOpTest__ReciprocalSquareRootEstimateScalar_Vector64_Double
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__ReciprocalSquareRootEstimateScalar_Vector64_Double testClass
            )
            {
            ...
            )
            {
                fixed (Vector64<Double>* pFld1 = &_fld1)
                {
                    var result = AdvSimd
                        .Arm64
                        .ReciprocalSquareRootEstimateScalar(AdvSimd.LoadVector64((Double*)(pFld1)));
        ...
        static SimpleUnaryOpTest__ReciprocalSquareRootEstimateScalar_Vector64_Double()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = BitConverter.Int64BitsToDouble(0x3fc9db3dab555868);
        ...
        public SimpleUnaryOpTest__ReciprocalSquareRootEstimateScalar_Vector64_Double()
        {
            Succeeded = true;
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            fixed (Vector64<Double>* pClsVar1 = &_clsVar1)
            {
                var result = AdvSimd
                    .Arm64
                    .ReciprocalSquareRootEstimateScalar(AdvSimd.LoadVector64((Double*)(pClsVar1)));
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var result = AdvSimd
                .Arm64
                .ReciprocalSquareRootEstimateScalar(AdvSimd.LoadVector64((Double*)(&test._fld1)));
        ...
        )
        {
            ...
            if (BitConverter.DoubleToInt64Bits(result[0]) != 0x4001d00000000000)
            {
                succeeded = false;
            }
            else
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.ReciprocalSquareRootEstimateScalar)}<Double>(Vector64<Double>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
