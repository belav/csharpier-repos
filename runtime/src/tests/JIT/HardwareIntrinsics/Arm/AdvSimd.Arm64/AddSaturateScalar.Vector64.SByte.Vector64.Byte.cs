    ...
    public sealed unsafe class SimpleBinaryOpTest__AddSaturateScalar_Vector64_SByte_Vector64_Byte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__AddSaturateScalar_Vector64_SByte_Vector64_Byte testClass
            )
            {
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.AddSaturateScalar)}<SByte>(Vector64<SByte>, Vector64<Byte>): {method} failed:"
                    );
