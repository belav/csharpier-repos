    ...
    public sealed unsafe class SimpleBinaryOpTest__AddSaturate_Vector64_UInt16_Vector64_Int16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__AddSaturate_Vector64_UInt16_Vector64_Int16 testClass
            )
            {
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.AddSaturate)}<UInt16>(Vector64<UInt16>, Vector64<Int16>): {method} failed:"
                    );
