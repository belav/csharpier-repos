...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ZipHigh_Vector128_Double()
        {
            var test = new SimpleBinaryOpTest__ZipHigh_Vector128_Double();
    ...
    public sealed unsafe class SimpleBinaryOpTest__ZipHigh_Vector128_Double
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__ZipHigh_Vector128_Double testClass)
            {
            ...
            public void RunStructFldScenario_Load(
                SimpleBinaryOpTest__ZipHigh_Vector128_Double testClass
            )
            {
        ...
        static SimpleBinaryOpTest__ZipHigh_Vector128_Double()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetDouble();
        ...
        public SimpleBinaryOpTest__ZipHigh_Vector128_Double()
        {
            Succeeded = true;
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.ZipHigh)}<Double>(Vector128<Double>, Vector128<Double>): {method} failed:"
                    );
