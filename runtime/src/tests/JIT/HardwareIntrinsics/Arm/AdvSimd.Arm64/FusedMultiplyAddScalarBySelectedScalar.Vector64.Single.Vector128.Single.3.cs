...
namespace JIT.HardwareIntrinsics.Arm
{
    public static partial class Program
    {
        ...
        {
            var test =
                new SimpleTernaryOpTest__FusedMultiplyAddScalarBySelectedScalar_Vector64_Single_Vector128_Single_3();
    ...
    public sealed unsafe class SimpleTernaryOpTest__FusedMultiplyAddScalarBySelectedScalar_Vector64_Single_Vector128_Single_3
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleTernaryOpTest__FusedMultiplyAddScalarBySelectedScalar_Vector64_Single_Vector128_Single_3 testClass
            )
            {
                var result = AdvSimd
                    .Arm64
                    .FusedMultiplyAddScalarBySelectedScalar(_fld1, _fld2, _fld3, 3);
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64)
                .GetMethod(
                    nameof(AdvSimd.Arm64.FusedMultiplyAddScalarBySelectedScalar),
                    new Type[]
                    {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd
                .Arm64
                .FusedMultiplyAddScalarBySelectedScalar(_clsVar1, _clsVar2, _clsVar3, 3);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var result = AdvSimd
                .Arm64
                .FusedMultiplyAddScalarBySelectedScalar(test._fld1, test._fld2, test._fld3, 3);
        ...
        )
        {
            ...
            if (
                BitConverter.SingleToInt32Bits(
                    Helpers.FusedMultiplyAdd(firstOp[0], secondOp[0], thirdOp[Imm])
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.FusedMultiplyAddScalarBySelectedScalar)}<Single>(Vector64<Single>, Vector64<Single>, Vector128<Single>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
