...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ZipHigh_Vector128_Byte()
        {
            var test = new SimpleBinaryOpTest__ZipHigh_Vector128_Byte();
    ...
    public sealed unsafe class SimpleBinaryOpTest__ZipHigh_Vector128_Byte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__ZipHigh_Vector128_Byte testClass)
            {
            ...
            public void RunStructFldScenario_Load(
                SimpleBinaryOpTest__ZipHigh_Vector128_Byte testClass
            )
            {
        ...
        static SimpleBinaryOpTest__ZipHigh_Vector128_Byte()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetByte();
        ...
        public SimpleBinaryOpTest__ZipHigh_Vector128_Byte()
        {
            Succeeded = true;
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.ZipHigh)}<Byte>(Vector128<Byte>, Vector128<Byte>): {method} failed:"
                    );
