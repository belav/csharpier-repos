...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    public sealed unsafe class ImmOpTest__DuplicateToVector128_Double_31
    {
        ...
        public void RunBasicScenario()
        {
            ...
            var result = AdvSimd.Arm64.DuplicateToVector128((Double)31);
        ...
        public void RunReflectionScenario()
        {
            ...
            var result = typeof(AdvSimd.Arm64)
                ...
                .Invoke(null, new object[] { (Double)31 });
        ...
        private void ValidateResult(Double[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.DuplicateToVector128)}<Double>(31): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
