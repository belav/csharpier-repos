...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ConvertToUInt64RoundToEvenScalar_Vector64_Double()
        {
            var test = new SimpleUnaryOpTest__ConvertToUInt64RoundToEvenScalar_Vector64_Double();
    ...
    public sealed unsafe class SimpleUnaryOpTest__ConvertToUInt64RoundToEvenScalar_Vector64_Double
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__ConvertToUInt64RoundToEvenScalar_Vector64_Double testClass
            )
            {
                var result = AdvSimd.Arm64.ConvertToUInt64RoundToEvenScalar(_fld1);
        ...
        static SimpleUnaryOpTest__ConvertToUInt64RoundToEvenScalar_Vector64_Double()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetDouble();
        ...
        public SimpleUnaryOpTest__ConvertToUInt64RoundToEvenScalar_Vector64_Double()
        {
            Succeeded = true;
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.Arm64.ConvertToUInt64RoundToEvenScalar(_clsVar1);
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.Arm64.ConvertToUInt64RoundToEvenScalar(op1);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimpleUnaryOpTest__ConvertToUInt64RoundToEvenScalar_Vector64_Double();
            var result = AdvSimd.Arm64.ConvertToUInt64RoundToEvenScalar(test._fld1);
        ...
        )
        {
            ...
            if (Helpers.ConvertToUInt64RoundToEven(firstOp[0]) != result[0])
            {
                succeeded = false;
            }
            else
