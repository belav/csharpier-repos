...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    public sealed unsafe class LoadPairVector128NonTemporal_UInt32
    {
        ...
        {
            public (Vector128<UInt32>, Vector128<UInt32>) _fld;
            ...
            public void RunStructFldScenario(LoadPairVector128NonTemporal_UInt32 testClass)
            {
                _fld = AdvSimd
                    .Arm64
                    .LoadPairVector128NonTemporal((UInt32*)(testClass._dataTable.inArrayPtr));
        ...
        private static readonly int RetElementCount =
            Unsafe.SizeOf<(Vector128<UInt32>, Vector128<UInt32>)>() / sizeof(UInt32);
        private static readonly int Op1ElementCount = RetElementCount;

        private static UInt32[] _data = new UInt32[Op1ElementCount];

        private static (Vector128<UInt32>, Vector128<UInt32>) _clsVar;

        private (Vector128<UInt32>, Vector128<UInt32>) _fld;
        ...
        public void RunBasicScenario()
        {
            ...
            var result = AdvSimd
                .Arm64
                .LoadPairVector128NonTemporal((UInt32*)(_dataTable.inArrayPtr));
        ...
        public void RunReflectionScenario()
        {
            ...
            Unsafe.Write(_dataTable.outArrayPtr, ((Vector128<UInt32>, Vector128<UInt32>))result);
            ValidateResult(_dataTable.inArrayPtr, _dataTable.outArrayPtr);
        }
        ...
        public void RunClsVarScenario()
        {
            ...
            _clsVar = AdvSimd.Arm64.LoadPairVector128NonTemporal((UInt32*)(_dataTable.inArrayPtr));
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.LoadPairVector128NonTemporal)}<UInt32>(Vector128<UInt32>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
