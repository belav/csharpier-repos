...
namespace JIT.HardwareIntrinsics.Arm
{
    public static partial class Program
    {
        ...
        {
            var test =
                new ImmBinaryOpTest__MultiplyDoublingScalarBySelectedScalarSaturateHigh_Vector64_Int32_Vector64_Int32_1();
    ...
    public sealed unsafe class ImmBinaryOpTest__MultiplyDoublingScalarBySelectedScalarSaturateHigh_Vector64_Int32_Vector64_Int32_1
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                ImmBinaryOpTest__MultiplyDoublingScalarBySelectedScalarSaturateHigh_Vector64_Int32_Vector64_Int32_1 testClass
            )
            {
                var result = AdvSimd
                    .Arm64
                    .MultiplyDoublingScalarBySelectedScalarSaturateHigh(_fld1, _fld2, 1);
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd
                .Arm64
                .MultiplyDoublingScalarBySelectedScalarSaturateHigh(_clsVar1, _clsVar2, 1);
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd
                .Arm64
                .MultiplyDoublingScalarBySelectedScalarSaturateHigh(op1, op2, 1);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var result = AdvSimd
                .Arm64
                .MultiplyDoublingScalarBySelectedScalarSaturateHigh(test._fld1, test._fld2, 1);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.MultiplyDoublingScalarBySelectedScalarSaturateHigh)}<Int32>(Vector64<Int32>, Vector64<Int32>, 1): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
