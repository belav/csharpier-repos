...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void StorePairNonTemporal_Vector128_UInt64()
        {
            var test = new StoreBinaryOpTest__StorePairNonTemporal_Vector128_UInt64();
    ...
    public sealed unsafe class StoreBinaryOpTest__StorePairNonTemporal_Vector128_UInt64
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                StoreBinaryOpTest__StorePairNonTemporal_Vector128_UInt64 testClass
            )
            {
                AdvSimd
                    .Arm64
                    .StorePairNonTemporal((UInt64*)testClass._dataTable.outArrayPtr, _fld1, _fld2);
        ...
        static StoreBinaryOpTest__StorePairNonTemporal_Vector128_UInt64()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetUInt64();
        ...
        public StoreBinaryOpTest__StorePairNonTemporal_Vector128_UInt64()
        {
            Succeeded = true;
        ...
        public void RunClassLclFldScenario()
        {
            ...
            AdvSimd
                .Arm64
                .StorePairNonTemporal((UInt64*)_dataTable.outArrayPtr, test._fld1, test._fld2);
        ...
        )
        {
            ...
            Unsafe.CopyBlockUnaligned(
                ...
                (uint)(RetElementCount * Unsafe.SizeOf<UInt64>())
            );
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.StorePairNonTemporal)}<UInt64>(Vector128<UInt64>, Vector128<UInt64>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
