...
namespace JIT.HardwareIntrinsics.Arm
{
    public static partial class Program
    {
        ...
        {
            var test =
                new InsertSelectedScalarTest__InsertSelectedScalar_Vector64_Int32_1_Vector64_Int32_1();
    ...
    public sealed unsafe class InsertSelectedScalarTest__InsertSelectedScalar_Vector64_Int32_1_Vector64_Int32_1
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                InsertSelectedScalarTest__InsertSelectedScalar_Vector64_Int32_1_Vector64_Int32_1 testClass
            )
            {
            ...
            {
                fixed (Vector64<Int32>* pFld1 = &_fld1)fixed (Vector64<Int32>* pFld2 = &_fld3)
                {
        ...
        public void RunClassLclFldScenario_Load()
        {
            ...
            fixed (Vector64<Int32>* pFld1 = &test._fld1)fixed (Vector64<Int32>* pFld2 = &test._fld3)
            {
                var result = AdvSimd.Arm64.InsertSelectedScalar(
                    AdvSimd.LoadVector64((Int32*)pFld1),
                    1,
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.InsertSelectedScalar)}<Int32>(Vector64<Int32>, {1}, Vector64<Int32>, {1}): {method} failed:"
                );
                TestLibrary.TestFramework.LogInformation(
