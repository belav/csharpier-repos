    ...
    public sealed unsafe class SimpleBinaryOpTest__Min_Vector128_Double
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario_Load(
                SimpleBinaryOpTest__Min_Vector128_Double testClass
            )
            {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.Arm64.Min(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            {
                if (
                    BitConverter.DoubleToInt64Bits(Helpers.Min(left[i], right[i]))
