...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void LoadPairScalarVector64NonTemporal_Int32()
        {
    ...
    public sealed unsafe class LoadPairScalarVector64NonTemporal_Int32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(LoadPairScalarVector64NonTemporal_Int32 testClass)
            {
                _fld = AdvSimd
                    .Arm64
                    .LoadPairScalarVector64NonTemporal((Int32*)(testClass._dataTable.inArrayPtr));
        ...
        public LoadPairScalarVector64NonTemporal_Int32()
        {
            Succeeded = true;
        ...
        public void RunBasicScenario()
        {
            ...
            var result = AdvSimd
                .Arm64
                .LoadPairScalarVector64NonTemporal((Int32*)(_dataTable.inArrayPtr));
        ...
        public void RunReflectionScenario()
        {
            ...
            var result = typeof(AdvSimd.Arm64)
                .GetMethod(
                    nameof(AdvSimd.Arm64.LoadPairScalarVector64NonTemporal),
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.LoadPairScalarVector64NonTemporal)}<Int32>(Vector64<Int32>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
