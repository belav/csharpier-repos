...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    public sealed unsafe class LoadPairVector128_Int32
    {
        ...
        private static readonly int RetElementCount =
            Unsafe.SizeOf<(Vector128<Int32>, Vector128<Int32>)>() / sizeof(Int32);
        ...
        public void RunReflectionScenario()
        {
            ...
            var result = typeof(AdvSimd.Arm64)
                .GetMethod(nameof(AdvSimd.Arm64.LoadPairVector128), new Type[] { typeof(Int32*) })
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.LoadPairVector128)}<Int32>(Vector128<Int32>): {method} failed:"
                );
                TestLibrary.TestFramework.LogInformation(
