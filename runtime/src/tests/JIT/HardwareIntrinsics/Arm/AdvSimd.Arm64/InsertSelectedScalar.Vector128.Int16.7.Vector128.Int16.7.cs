...
namespace JIT.HardwareIntrinsics.Arm
{
    public static partial class Program
    {
        ...
        {
            var test =
                new InsertSelectedScalarTest__InsertSelectedScalar_Vector128_Int16_7_Vector128_Int16_7();
    ...
    public sealed unsafe class InsertSelectedScalarTest__InsertSelectedScalar_Vector128_Int16_7_Vector128_Int16_7
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                InsertSelectedScalarTest__InsertSelectedScalar_Vector128_Int16_7_Vector128_Int16_7 testClass
            )
            {
            ...
            {
                fixed (Vector128<Int16>* pFld1 = &_fld1)fixed (Vector128<Int16>* pFld2 = &_fld3)
                {
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.InsertSelectedScalar)}<Int16>(Vector128<Int16>, {7}, Vector128<Int16>, {7}): {method} failed:"
                );
                TestLibrary.TestFramework.LogInformation(
