...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void AddSaturate_Vector128_UInt32_Vector128_Int32()
        {
            var test = new SimpleBinaryOpTest__AddSaturate_Vector128_UInt32_Vector128_Int32();
    ...
    public sealed unsafe class SimpleBinaryOpTest__AddSaturate_Vector128_UInt32_Vector128_Int32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__AddSaturate_Vector128_UInt32_Vector128_Int32 testClass
            )
            {
        ...
        static SimpleBinaryOpTest__AddSaturate_Vector128_UInt32_Vector128_Int32()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetUInt32();
        ...
        public SimpleBinaryOpTest__AddSaturate_Vector128_UInt32_Vector128_Int32()
        {
            Succeeded = true;
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.AddSaturate)}<UInt32>(Vector128<UInt32>, Vector128<Int32>): {method} failed:"
                    );
