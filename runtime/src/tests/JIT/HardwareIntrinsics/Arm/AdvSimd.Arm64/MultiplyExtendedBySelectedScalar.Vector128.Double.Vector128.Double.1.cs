...
namespace JIT.HardwareIntrinsics.Arm
{
    public static partial class Program
    {
        ...
        {
            var test =
                new ImmBinaryOpTest__MultiplyExtendedBySelectedScalar_Vector128_Double_Vector128_Double_1();
    ...
    public sealed unsafe class ImmBinaryOpTest__MultiplyExtendedBySelectedScalar_Vector128_Double_Vector128_Double_1
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                ImmBinaryOpTest__MultiplyExtendedBySelectedScalar_Vector128_Double_Vector128_Double_1 testClass
            )
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64)
                .GetMethod(
                    nameof(AdvSimd.Arm64.MultiplyExtendedBySelectedScalar),
                    new Type[]
                    {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.Arm64.MultiplyExtendedBySelectedScalar(_clsVar1, _clsVar2, 1);
        ...
        )
        {
            ...
            for (var i = 0; i < RetElementCount; i++)
            {
                if (
                    BitConverter.DoubleToInt64Bits(
                        Helpers.MultiplyExtended(firstOp[i], secondOp[Imm])
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.MultiplyExtendedBySelectedScalar)}<Double>(Vector128<Double>, Vector128<Double>, 1): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
