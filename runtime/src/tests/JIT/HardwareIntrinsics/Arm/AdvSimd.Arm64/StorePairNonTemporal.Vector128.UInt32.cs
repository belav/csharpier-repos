    ...
    public sealed unsafe class StoreBinaryOpTest__StorePairNonTemporal_Vector128_UInt32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                StoreBinaryOpTest__StorePairNonTemporal_Vector128_UInt32 testClass
            )
            {
                AdvSimd
                    .Arm64
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.StorePairNonTemporal)}<UInt32>(Vector128<UInt32>, Vector128<UInt32>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
