    ...
    public sealed unsafe class SimpleBinaryOpTest__AbsoluteCompareLessThanOrEqual_Vector128_Double
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__AbsoluteCompareLessThanOrEqual_Vector128_Double testClass
            )
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64)
                .GetMethod(
                    nameof(AdvSimd.Arm64.AbsoluteCompareLessThanOrEqual),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.Arm64.AbsoluteCompareLessThanOrEqual(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            for (var i = 0; i < RetElementCount; i++)
            {
                if (
                    BitConverter.DoubleToInt64Bits(
                        Helpers.AbsoluteCompareLessThanOrEqual(left[i], right[i])
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.AbsoluteCompareLessThanOrEqual)}<Double>(Vector128<Double>, Vector128<Double>): {method} failed:"
                    );
