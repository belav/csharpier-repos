    ...
    public sealed unsafe class LoadPairVector128NonTemporal_Byte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(LoadPairVector128NonTemporal_Byte testClass)
            {
                _fld = AdvSimd
                    .Arm64
                    .LoadPairVector128NonTemporal((Byte*)(testClass._dataTable.inArrayPtr));
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.LoadPairVector128NonTemporal)}<Byte>(Vector128<Byte>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
