...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void LoadPairVector64NonTemporal_UInt16()
        {
    ...
    public sealed unsafe class LoadPairVector64NonTemporal_UInt16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(LoadPairVector64NonTemporal_UInt16 testClass)
            {
                _fld = AdvSimd.Arm64.LoadPairVector64NonTemporal(
                    (UInt16*)(testClass._dataTable.inArrayPtr)
                );
        ...
        private static readonly int RetElementCount =
            Unsafe.SizeOf<(Vector64<UInt16>, Vector64<UInt16>)>() / sizeof(UInt16);
        ...
        )
        {
            ...
            Unsafe.CopyBlockUnaligned(
                ...
                (uint)(Unsafe.SizeOf<UInt16>() * Op1ElementCount)
            );
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<UInt16, byte>(ref outArray[0]),
                ref Unsafe.AsRef<byte>(result),
                (uint)(Unsafe.SizeOf<UInt16>() * RetElementCount)
            );
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.LoadPairVector64NonTemporal)}<UInt16>(Vector64<UInt16>): {method} failed:"
                );
                TestLibrary.TestFramework.LogInformation(
