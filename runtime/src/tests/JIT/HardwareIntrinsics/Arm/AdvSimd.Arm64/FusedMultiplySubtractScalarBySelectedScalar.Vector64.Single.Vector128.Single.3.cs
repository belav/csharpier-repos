...
namespace JIT.HardwareIntrinsics.Arm
{
    public static partial class Program
    {
        ...
        {
            var test =
                new SimpleTernaryOpTest__FusedMultiplySubtractScalarBySelectedScalar_Vector64_Single_Vector128_Single_3();
    ...
    public sealed unsafe class SimpleTernaryOpTest__FusedMultiplySubtractScalarBySelectedScalar_Vector64_Single_Vector128_Single_3
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleTernaryOpTest__FusedMultiplySubtractScalarBySelectedScalar_Vector64_Single_Vector128_Single_3 testClass
            )
            {
                var result = AdvSimd
                    .Arm64
                    .FusedMultiplySubtractScalarBySelectedScalar(_fld1, _fld2, _fld3, 3);
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd
                .Arm64
                .FusedMultiplySubtractScalarBySelectedScalar(_clsVar1, _clsVar2, _clsVar3, 3);
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd
                .Arm64
                .FusedMultiplySubtractScalarBySelectedScalar(op1, op2, op3, 3);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var result = AdvSimd
                .Arm64
                .FusedMultiplySubtractScalarBySelectedScalar(test._fld1, test._fld2, test._fld3, 3);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.FusedMultiplySubtractScalarBySelectedScalar)}<Single>(Vector64<Single>, Vector64<Single>, Vector128<Single>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
