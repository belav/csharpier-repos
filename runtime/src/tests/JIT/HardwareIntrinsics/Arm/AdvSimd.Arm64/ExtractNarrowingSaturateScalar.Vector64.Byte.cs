...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ExtractNarrowingSaturateScalar_Vector64_Byte()
        {
            var test = new SimpleUnaryOpTest__ExtractNarrowingSaturateScalar_Vector64_Byte();
    ...
    public sealed unsafe class SimpleUnaryOpTest__ExtractNarrowingSaturateScalar_Vector64_Byte
    {
        ...
        private struct TestStruct
        {
            ...
            public static TestStruct Create()
            {
                ...
                Unsafe.CopyBlockUnaligned(
                    ref Unsafe.As<Vector64<UInt16>, byte>(ref testStruct._fld1),
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__ExtractNarrowingSaturateScalar_Vector64_Byte testClass
            )
            {
            ...
            )
            {
                fixed (Vector64<UInt16>* pFld1 = &_fld1)
                {
                    var result = AdvSimd
                        .Arm64
                        .ExtractNarrowingSaturateScalar(AdvSimd.LoadVector64((UInt16*)(pFld1)));
        ...
        static SimpleUnaryOpTest__ExtractNarrowingSaturateScalar_Vector64_Byte()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetUInt16();
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector64<UInt16>, byte>(ref _clsVar1),
                ref Unsafe.As<UInt16, byte>(ref _data1[0]),
                (uint)Unsafe.SizeOf<Vector64<UInt16>>()
            );
        }

        public SimpleUnaryOpTest__ExtractNarrowingSaturateScalar_Vector64_Byte()
        {
            Succeeded = true;
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector64<UInt16>, byte>(ref _fld1),
                ref Unsafe.As<UInt16, byte>(ref _data1[0]),
                (uint)Unsafe.SizeOf<Vector64<UInt16>>()
            );
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64)
                .GetMethod(
                    nameof(AdvSimd.Arm64.ExtractNarrowingSaturateScalar),
                    new Type[] { typeof(Vector64<UInt16>) }
                )
                .Invoke(
                    null,
                    new object[] { Unsafe.Read<Vector64<UInt16>>(_dataTable.inArray1Ptr) }
                );
        ...
        public void RunReflectionScenario_Load()
        {
            ...
            var result = typeof(AdvSimd.Arm64)
                ...
                .Invoke(
                    null,
                    new object[] { AdvSimd.LoadVector64((UInt16*)(_dataTable.inArray1Ptr)) }
                );
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.Arm64.ExtractNarrowingSaturateScalar(_clsVar1);
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            fixed (Vector64<UInt16>* pClsVar1 = &_clsVar1)
            {
                var result = AdvSimd
                    .Arm64
                    .ExtractNarrowingSaturateScalar(AdvSimd.LoadVector64((UInt16*)(pClsVar1)));
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var result = AdvSimd
                .Arm64
                .ExtractNarrowingSaturateScalar(AdvSimd.LoadVector64((UInt16*)(&test._fld1)));
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.ExtractNarrowingSaturateScalar)}<Byte>(Vector64<UInt16>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
