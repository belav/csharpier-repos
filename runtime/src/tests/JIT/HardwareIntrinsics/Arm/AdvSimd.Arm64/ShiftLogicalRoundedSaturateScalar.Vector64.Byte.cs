...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ShiftLogicalRoundedSaturateScalar_Vector64_Byte()
        {
    ...
    public sealed unsafe class SimpleBinaryOpTest__ShiftLogicalRoundedSaturateScalar_Vector64_Byte
    {
        ...
        private struct TestStruct
        {
            ...
            public static TestStruct Create()
            {
                ...
                Unsafe.CopyBlockUnaligned(
                    ref Unsafe.As<Vector64<Byte>, byte>(ref testStruct._fld1),
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__ShiftLogicalRoundedSaturateScalar_Vector64_Byte testClass
            ) {
            ...
            public void RunStructFldScenario_Load(
                ...
                fixed (Vector64<Byte>* pFld1 = &_fld1)fixed (Vector64<SByte>* pFld2 = &_fld2)
                {
        ...
        static SimpleBinaryOpTest__ShiftLogicalRoundedSaturateScalar_Vector64_Byte()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetByte();
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector64<Byte>, byte>(ref _clsVar1),
                ref Unsafe.As<Byte, byte>(ref _data1[0]),
                (uint)Unsafe.SizeOf<Vector64<Byte>>()
            );
            for (var i = 0; i < Op2ElementCount; i++)
        ...
        public SimpleBinaryOpTest__ShiftLogicalRoundedSaturateScalar_Vector64_Byte()
        {
            Succeeded = true;
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector64<Byte>, byte>(ref _fld1),
                ref Unsafe.As<Byte, byte>(ref _data1[0]),
                (uint)Unsafe.SizeOf<Vector64<Byte>>()
            );
            for (var i = 0; i < Op2ElementCount; i++)
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64).GetMethod(
                    nameof(AdvSimd.Arm64.ShiftLogicalRoundedSaturateScalar),
                    new Type[] { typeof(Vector64<Byte>), typeof(Vector64<SByte>) }
                )
                .Invoke(
                    null,
                    new object[]
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.Arm64.ShiftLogicalRoundedSaturateScalar(_clsVar1, _clsVar2);
        ...
        public void RunClassLclFldScenario_Load()
        {
            ...
            fixed (Vector64<Byte>* pFld1 = &test._fld1)fixed (Vector64<SByte>* pFld2 = &test._fld2)
            {
                var result = AdvSimd.Arm64.ShiftLogicalRoundedSaturateScalar(
                    AdvSimd.LoadVector64((Byte*)(pFld1)),
                    AdvSimd.LoadVector64((SByte*)(pFld2))
        ...
        private void ValidateResult(
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.ShiftLogicalRoundedSaturateScalar)}<Byte>(Vector64<Byte>, Vector64<SByte>): {method} failed:"
                );
