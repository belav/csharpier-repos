...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void NegateSaturateScalar_Vector64_Int32()
        {
            var test = new SimpleUnaryOpTest__NegateSaturateScalar_Vector64_Int32();
    ...
    public sealed unsafe class SimpleUnaryOpTest__NegateSaturateScalar_Vector64_Int32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__NegateSaturateScalar_Vector64_Int32 testClass
            )
            {
                var result = AdvSimd.Arm64.NegateSaturateScalar(_fld1);
            ...
            )
            {
                fixed (Vector64<Int32>* pFld1 = &_fld1)
                {
                    var result = AdvSimd
                        .Arm64
                        .NegateSaturateScalar(AdvSimd.LoadVector64((Int32*)(pFld1)));
        ...
        static SimpleUnaryOpTest__NegateSaturateScalar_Vector64_Int32()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = Int32.MinValue;
        ...
        public SimpleUnaryOpTest__NegateSaturateScalar_Vector64_Int32()
        {
            Succeeded = true;
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd
                .Arm64
                .NegateSaturateScalar(Unsafe.Read<Vector64<Int32>>(_dataTable.inArray1Ptr));
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var result = AdvSimd
                .Arm64
                .NegateSaturateScalar(AdvSimd.LoadVector64((Int32*)(_dataTable.inArray1Ptr)));
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64)
                .GetMethod(
                    nameof(AdvSimd.Arm64.NegateSaturateScalar),
                    new Type[] { typeof(Vector64<Int32>) }
                )
                .Invoke(
                    null,
                    new object[] { Unsafe.Read<Vector64<Int32>>(_dataTable.inArray1Ptr) }
                );
        ...
        public void RunReflectionScenario_Load()
        {
            ...
            var result = typeof(AdvSimd.Arm64)
                ...
                .Invoke(
                    null,
                    new object[] { AdvSimd.LoadVector64((Int32*)(_dataTable.inArray1Ptr)) }
                );
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.Arm64.NegateSaturateScalar(_clsVar1);
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            fixed (Vector64<Int32>* pClsVar1 = &_clsVar1)
            {
                var result = AdvSimd
                    .Arm64
                    .NegateSaturateScalar(AdvSimd.LoadVector64((Int32*)(pClsVar1)));
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.Arm64.NegateSaturateScalar(op1);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimpleUnaryOpTest__NegateSaturateScalar_Vector64_Int32();
            var result = AdvSimd.Arm64.NegateSaturateScalar(test._fld1);
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var result = AdvSimd
                .Arm64
                .NegateSaturateScalar(AdvSimd.LoadVector64((Int32*)(&test._fld1)));
        ...
        )
        {
            ...
            if (Helpers.NegateSaturate(firstOp[0]) != result[0])
            {
                succeeded = false;
            }
            else
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.NegateSaturateScalar)}<Int32>(Vector64<Int32>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
