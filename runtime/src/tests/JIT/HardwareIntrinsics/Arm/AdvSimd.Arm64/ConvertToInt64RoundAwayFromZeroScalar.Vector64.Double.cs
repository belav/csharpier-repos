...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ConvertToInt64RoundAwayFromZeroScalar_Vector64_Double()
        {
            var test =
                new SimpleUnaryOpTest__ConvertToInt64RoundAwayFromZeroScalar_Vector64_Double();
    ...
    public sealed unsafe class SimpleUnaryOpTest__ConvertToInt64RoundAwayFromZeroScalar_Vector64_Double
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__ConvertToInt64RoundAwayFromZeroScalar_Vector64_Double testClass
            )
            {
                var result = AdvSimd.Arm64.ConvertToInt64RoundAwayFromZeroScalar(_fld1);
        ...
        static SimpleUnaryOpTest__ConvertToInt64RoundAwayFromZeroScalar_Vector64_Double()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetDouble();
        ...
        public SimpleUnaryOpTest__ConvertToInt64RoundAwayFromZeroScalar_Vector64_Double()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64)
                .GetMethod(
                    nameof(AdvSimd.Arm64.ConvertToInt64RoundAwayFromZeroScalar),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.Arm64.ConvertToInt64RoundAwayFromZeroScalar(_clsVar1);
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.Arm64.ConvertToInt64RoundAwayFromZeroScalar(op1);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test =
                new SimpleUnaryOpTest__ConvertToInt64RoundAwayFromZeroScalar_Vector64_Double();
            var result = AdvSimd.Arm64.ConvertToInt64RoundAwayFromZeroScalar(test._fld1);
        ...
        public void RunClassLclFldScenario_Load()
        {
            ...
            fixed (Vector64<Double>* pFld1 = &test._fld1)
            {
                var result = AdvSimd
                    .Arm64
                    .ConvertToInt64RoundAwayFromZeroScalar(AdvSimd.LoadVector64((Double*)(pFld1)));
        ...
        )
        {
            ...
            if (Helpers.ConvertToInt64RoundAwayFromZero(firstOp[0]) != result[0])
            {
                succeeded = false;
            }
            else
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.ConvertToInt64RoundAwayFromZeroScalar)}<Int64>(Vector64<Double>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
