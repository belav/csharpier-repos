    ...
    public sealed unsafe class SimpleBinaryOpTest__AddSaturate_Vector128_Int16_Vector128_UInt16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__AddSaturate_Vector128_Int16_Vector128_UInt16 testClass
            )
            {
            ...
            {
                fixed (Vector128<Int16>* pFld1 = &_fld1)fixed (Vector128<UInt16>* pFld2 = &_fld2)
                {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64).GetMethod(
                    ...
                    new Type[] { typeof(Vector128<Int16>), typeof(Vector128<UInt16>) }
                )
                .Invoke(
                    null,
                    new object[]
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.AddSaturate)}<Int16>(Vector128<Int16>, Vector128<UInt16>): {method} failed:"
                );
