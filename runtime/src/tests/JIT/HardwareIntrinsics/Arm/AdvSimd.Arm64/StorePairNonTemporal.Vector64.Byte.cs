...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void StorePairNonTemporal_Vector64_Byte()
        {
    ...
    public sealed unsafe class StoreBinaryOpTest__StorePairNonTemporal_Vector64_Byte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                StoreBinaryOpTest__StorePairNonTemporal_Vector64_Byte testClass
            )
            {
                AdvSimd
                    .Arm64
                    .StorePairNonTemporal((Byte*)testClass._dataTable.outArrayPtr, _fld1, _fld2);
        ...
        static StoreBinaryOpTest__StorePairNonTemporal_Vector64_Byte()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetByte();
        ...
        public StoreBinaryOpTest__StorePairNonTemporal_Vector64_Byte()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            typeof(AdvSimd.Arm64)
                .GetMethod(
                    nameof(AdvSimd.Arm64.StorePairNonTemporal),
                    new Type[] { typeof(Byte*), typeof(Vector64<Byte>), typeof(Vector64<Byte>) }
                )
                .Invoke(
                    null,
                    new object[]
        ...
        public void RunClassLclFldScenario()
        {
            ...
            AdvSimd
                .Arm64
                .StorePairNonTemporal((Byte*)_dataTable.outArrayPtr, test._fld1, test._fld2);
        ...
        )
        {
            ...
            Unsafe.CopyBlockUnaligned(
                ...
                (uint)(RetElementCount * Unsafe.SizeOf<Byte>())
            );
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.StorePairNonTemporal)}<Byte>(Vector64<Byte>, Vector64<Byte>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
