    ...
    public sealed unsafe class SimpleUnaryOpTest__MaxAcross_Vector64_UInt16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario_Load(
                SimpleUnaryOpTest__MaxAcross_Vector64_UInt16 testClass
            )
            {
                fixed (Vector64<UInt16>* pFld1 = &_fld1)
                {
                    var result = AdvSimd.Arm64.MaxAcross(AdvSimd.LoadVector64((UInt16*)(pFld1)));
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd
                .Arm64
                .MaxAcross(Unsafe.Read<Vector64<UInt16>>(_dataTable.inArray1Ptr));
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var result = AdvSimd
                .Arm64
                .MaxAcross(AdvSimd.LoadVector64((UInt16*)(_dataTable.inArray1Ptr)));
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64)
                .GetMethod(nameof(AdvSimd.Arm64.MaxAcross), new Type[] { typeof(Vector64<UInt16>) })
                .Invoke(
                    null,
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.Arm64.MaxAcross(_clsVar1);
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            {
                var result = AdvSimd.Arm64.MaxAcross(AdvSimd.LoadVector64((UInt16*)(pClsVar1)));
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = AdvSimd.Arm64.MaxAcross(AdvSimd.LoadVector64((UInt16*)(&test._fld1)));
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.MaxAcross)}<UInt16>(Vector64<UInt16>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
