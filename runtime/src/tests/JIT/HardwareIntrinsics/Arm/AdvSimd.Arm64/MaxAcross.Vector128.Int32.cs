...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    public sealed unsafe class SimpleUnaryOpTest__MaxAcross_Vector128_Int32
    {
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd
                .Arm64
                .MaxAcross(Unsafe.Read<Vector128<Int32>>(_dataTable.inArray1Ptr));
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var result = AdvSimd
                .Arm64
                .MaxAcross(AdvSimd.LoadVector128((Int32*)(_dataTable.inArray1Ptr)));
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64)
                .GetMethod(nameof(AdvSimd.Arm64.MaxAcross), new Type[] { typeof(Vector128<Int32>) })
                .Invoke(
                    null,
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            {
                var result = AdvSimd.Arm64.MaxAcross(AdvSimd.LoadVector128((Int32*)(pClsVar1)));
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = AdvSimd.Arm64.MaxAcross(AdvSimd.LoadVector128((Int32*)(&test._fld1)));
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.MaxAcross)}<Int32>(Vector128<Int32>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
