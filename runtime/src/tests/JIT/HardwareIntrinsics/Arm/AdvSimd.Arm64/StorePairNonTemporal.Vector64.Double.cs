    ...
    public sealed unsafe class StoreBinaryOpTest__StorePairNonTemporal_Vector64_Double
    {
        ...
        private struct TestStruct
        {
            ...
            )
            {
                AdvSimd
                    .Arm64
                    .StorePairNonTemporal((Double*)testClass._dataTable.outArrayPtr, _fld1, _fld2);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            AdvSimd
                .Arm64
                .StorePairNonTemporal((Double*)_dataTable.outArrayPtr, test._fld1, test._fld2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.StorePairNonTemporal)}<Double>(Vector64<Double>, Vector64<Double>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
