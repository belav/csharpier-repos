...
namespace JIT.HardwareIntrinsics.Arm
{
    public static partial class Program
    {
        ...
        {
            var test =
                new InsertSelectedScalarTest__InsertSelectedScalar_Vector64_Int32_1_Vector128_Int32_3();
    ...
    public sealed unsafe class InsertSelectedScalarTest__InsertSelectedScalar_Vector64_Int32_1_Vector128_Int32_3
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                InsertSelectedScalarTest__InsertSelectedScalar_Vector64_Int32_1_Vector128_Int32_3 testClass
            ) {
            ...
            public void RunStructFldScenario_Load(
                ...
                fixed (Vector64<Int32>* pFld1 = &_fld1)fixed (Vector128<Int32>* pFld2 = &_fld3)
                {
        ...
        private void ValidateResult(
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.InsertSelectedScalar)}<Int32>(Vector64<Int32>, {1}, Vector128<Int32>, {3}): {method} failed:"
                );
                TestLibrary.TestFramework.LogInformation(
