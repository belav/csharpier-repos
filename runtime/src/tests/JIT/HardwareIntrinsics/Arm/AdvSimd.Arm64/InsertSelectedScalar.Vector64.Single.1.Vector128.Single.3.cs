...
namespace JIT.HardwareIntrinsics.Arm
{
    public static partial class Program
    {
        ...
        {
            var test =
                new InsertSelectedScalarTest__InsertSelectedScalar_Vector64_Single_1_Vector128_Single_3();
    ...
    public sealed unsafe class InsertSelectedScalarTest__InsertSelectedScalar_Vector64_Single_1_Vector128_Single_3
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                InsertSelectedScalarTest__InsertSelectedScalar_Vector64_Single_1_Vector128_Single_3 testClass
            ) {
            ...
            public void RunStructFldScenario_Load(
                ...
                fixed (Vector64<Single>* pFld1 = &_fld1)fixed (Vector128<Single>* pFld2 = &_fld3)
                {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.Arm64.InsertSelectedScalar(_clsVar1, 1, _clsVar3, 3);
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            fixed (Vector64<Single>* pClsVar1 = &_clsVar1)fixed (
                Vector128<Single>* pClsVar3 = &_clsVar3
            ) {
                var result = AdvSimd.Arm64.InsertSelectedScalar(
        ...
        public void RunClassLclFldScenario_Load()
        {
            ...
            fixed (Vector64<Single>* pFld1 = &test._fld1)fixed (
                Vector128<Single>* pFld2 = &test._fld3
            ) {
                var result = AdvSimd.Arm64.InsertSelectedScalar(
                    AdvSimd.LoadVector64((Single*)pFld1),
                    1,
        ...
        private void ValidateResult(
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.InsertSelectedScalar)}<Single>(Vector64<Single>, {1}, Vector128<Single>, {3}): {method} failed:"
                );
                TestLibrary.TestFramework.LogInformation(
