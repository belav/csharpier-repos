    ...
    public sealed unsafe class SimpleBinaryOpTest__AddPairwise_Vector128_Int32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__AddPairwise_Vector128_Int32 testClass
            )
            {
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.AddPairwise)}<Int32>(Vector128<Int32>, Vector128<Int32>): {method} failed:"
                    );
