...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void Add_Vector128_Double()
        {
            var test = new SimpleBinaryOpTest__Add_Vector128_Double();
    ...
    public sealed unsafe class SimpleBinaryOpTest__Add_Vector128_Double
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__Add_Vector128_Double testClass)
            {
                var result = AdvSimd.Arm64.Add(_fld1, _fld2);
            ...
            public void RunStructFldScenario_Load(
                SimpleBinaryOpTest__Add_Vector128_Double testClass
            ) {
                fixed (Vector128<Double>* pFld1 = &_fld1)fixed (Vector128<Double>* pFld2 = &_fld2)
                {
                    var result = AdvSimd.Arm64.Add(
        ...
        static SimpleBinaryOpTest__Add_Vector128_Double()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetDouble();
        ...
        public SimpleBinaryOpTest__Add_Vector128_Double()
        {
            Succeeded = true;
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.Arm64.Add(_clsVar1, _clsVar2);
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.Arm64.Add(op1, op2);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimpleBinaryOpTest__Add_Vector128_Double();
            var result = AdvSimd.Arm64.Add(test._fld1, test._fld2);
        ...
        private void ValidateResult(
            ...
            {
                if (
                    BitConverter.DoubleToInt64Bits(Helpers.Add(left[i], right[i]))
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.Add)}<Double>(Vector128<Double>, Vector128<Double>): {method} failed:"
                );
