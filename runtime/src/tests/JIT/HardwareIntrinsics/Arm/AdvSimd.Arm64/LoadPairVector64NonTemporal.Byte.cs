    ...
    public sealed unsafe class LoadPairVector64NonTemporal_Byte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(LoadPairVector64NonTemporal_Byte testClass)
            {
                _fld = AdvSimd
                    .Arm64
                    .LoadPairVector64NonTemporal((Byte*)(testClass._dataTable.inArrayPtr));
        ...
        private static readonly int RetElementCount =
            Unsafe.SizeOf<(Vector64<Byte>, Vector64<Byte>)>() / sizeof(Byte);
        ...
        )
        {
            ...
            Unsafe.CopyBlockUnaligned(
                ...
                (uint)(Unsafe.SizeOf<Byte>() * Op1ElementCount)
            );
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Byte, byte>(ref outArray[0]),
                ref Unsafe.AsRef<byte>(result),
                (uint)(Unsafe.SizeOf<Byte>() * RetElementCount)
            );
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.LoadPairVector64NonTemporal)}<Byte>(Vector64<Byte>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
