...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void LoadPairVector128_Int16()
        {
            var test = new LoadPairVector128_Int16();
    ...
    public sealed unsafe class LoadPairVector128_Int16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(LoadPairVector128_Int16 testClass)
            {
                _fld = AdvSimd.Arm64.LoadPairVector128((Int16*)(testClass._dataTable.inArrayPtr));
        ...
        private static readonly int RetElementCount =
            Unsafe.SizeOf<(Vector128<Int16>, Vector128<Int16>)>() / sizeof(Int16);
        ...
        public LoadPairVector128_Int16()
        {
            Succeeded = true;
        ...
        public void RunBasicScenario()
        {
            ...
            var result = AdvSimd.Arm64.LoadPairVector128((Int16*)(_dataTable.inArrayPtr));
        ...
        public void RunReflectionScenario()
        {
            ...
            var result = typeof(AdvSimd.Arm64)
                .GetMethod(nameof(AdvSimd.Arm64.LoadPairVector128), new Type[] { typeof(Int16*) })
        ...
        public void RunClsVarScenario()
        {
            ...
            _clsVar = AdvSimd.Arm64.LoadPairVector128((Int16*)(_dataTable.inArrayPtr));
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new LoadPairVector128_Int16();
            test._fld = AdvSimd.Arm64.LoadPairVector128((Int16*)(_dataTable.inArrayPtr));
        ...
        )
        {
            ...
            Unsafe.CopyBlockUnaligned(
                ...
                (uint)(Unsafe.SizeOf<Int16>() * Op1ElementCount)
            );
            Unsafe.CopyBlockUnaligned(
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.LoadPairVector128)}<Int16>(Vector128<Int16>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
