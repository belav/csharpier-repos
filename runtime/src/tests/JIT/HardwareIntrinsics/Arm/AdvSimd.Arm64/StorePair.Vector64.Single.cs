...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void StorePair_Vector64_Single()
        {
    ...
    public sealed unsafe class StoreBinaryOpTest__StorePair_Vector64_Single
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(StoreBinaryOpTest__StorePair_Vector64_Single testClass)
            {
                AdvSimd.Arm64.StorePair((Single*)testClass._dataTable.outArrayPtr, _fld1, _fld2);
        ...
        static StoreBinaryOpTest__StorePair_Vector64_Single()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetSingle();
        ...
        public StoreBinaryOpTest__StorePair_Vector64_Single()
        {
            Succeeded = true;
        ...
        public void RunClsVarScenario()
        {
            ...
            AdvSimd.Arm64.StorePair((Single*)_dataTable.outArrayPtr, _clsVar1, _clsVar2);
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            AdvSimd.Arm64.StorePair((Single*)_dataTable.outArrayPtr, op1, op2);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new StoreBinaryOpTest__StorePair_Vector64_Single();
            AdvSimd.Arm64.StorePair((Single*)_dataTable.outArrayPtr, test._fld1, test._fld2);
        ...
        public void RunClassFldScenario()
        {
            ...
            AdvSimd.Arm64.StorePair((Single*)_dataTable.outArrayPtr, _fld1, _fld2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.StorePair)}<Single>(Vector64<Single>, Vector64<Single>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
