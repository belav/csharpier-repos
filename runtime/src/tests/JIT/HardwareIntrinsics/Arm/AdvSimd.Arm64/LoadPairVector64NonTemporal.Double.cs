...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void LoadPairVector64NonTemporal_Double()
        {
            var test = new LoadPairVector64NonTemporal_Double();
    ...
    public sealed unsafe class LoadPairVector64NonTemporal_Double
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(LoadPairVector64NonTemporal_Double testClass)
            {
                _fld = AdvSimd
                    .Arm64
                    .LoadPairVector64NonTemporal((Double*)(testClass._dataTable.inArrayPtr));
        ...
        private static readonly int RetElementCount =
            Unsafe.SizeOf<(Vector64<Double>, Vector64<Double>)>() / sizeof(Double);
        ...
        public LoadPairVector64NonTemporal_Double()
        {
            Succeeded = true;
        ...
        public void RunBasicScenario()
        {
            ...
            var result = AdvSimd
                .Arm64
                .LoadPairVector64NonTemporal((Double*)(_dataTable.inArrayPtr));
        ...
        public void RunClsVarScenario()
        {
            ...
            _clsVar = AdvSimd.Arm64.LoadPairVector64NonTemporal((Double*)(_dataTable.inArrayPtr));
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.LoadPairVector64NonTemporal)}<Double>(Vector64<Double>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
