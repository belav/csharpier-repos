...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void LoadPairVector64_Int32()
        {
            var test = new LoadPairVector64_Int32();
    ...
    public sealed unsafe class LoadPairVector64_Int32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(LoadPairVector64_Int32 testClass)
            {
                _fld = AdvSimd.Arm64.LoadPairVector64((Int32*)(testClass._dataTable.inArrayPtr));
        ...
        private static readonly int RetElementCount =
            Unsafe.SizeOf<(Vector64<Int32>, Vector64<Int32>)>() / sizeof(Int32);
        ...
        public void RunBasicScenario()
        {
            ...
            var result = AdvSimd.Arm64.LoadPairVector64((Int32*)(_dataTable.inArrayPtr));
        ...
        public void RunReflectionScenario()
        {
            ...
            var result = typeof(AdvSimd.Arm64)
                .GetMethod(nameof(AdvSimd.Arm64.LoadPairVector64), new Type[] { typeof(Int32*) })
                .Invoke(null, new object[] { Pointer.Box(_dataTable.inArrayPtr, typeof(Int32*)) });
        ...
        public void RunClsVarScenario()
        {
            ...
            _clsVar = AdvSimd.Arm64.LoadPairVector64((Int32*)(_dataTable.inArrayPtr));
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new LoadPairVector64_Int32();
            test._fld = AdvSimd.Arm64.LoadPairVector64((Int32*)(_dataTable.inArrayPtr));
        ...
        )
        {
            ...
            Unsafe.CopyBlockUnaligned(
                ...
                (uint)(Unsafe.SizeOf<Int32>() * Op1ElementCount)
            );
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Int32, byte>(ref outArray[0]),
                ref Unsafe.AsRef<byte>(result),
                (uint)(Unsafe.SizeOf<Int32>() * RetElementCount)
            );
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.LoadPairVector64)}<Int32>(Vector64<Int32>): {method} failed:"
                );
                TestLibrary.TestFramework.LogInformation(
