...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void StorePair_Vector128_UInt32()
        {
            var test = new StoreBinaryOpTest__StorePair_Vector128_UInt32();
    ...
    public sealed unsafe class StoreBinaryOpTest__StorePair_Vector128_UInt32
    {
        ...
        static StoreBinaryOpTest__StorePair_Vector128_UInt32()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetUInt32();
        ...
        public StoreBinaryOpTest__StorePair_Vector128_UInt32()
        {
            Succeeded = true;
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.StorePair)}<UInt32>(Vector128<UInt32>, Vector128<UInt32>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
