...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ShiftArithmeticRoundedSaturateScalar_Vector64_SByte()
        {
            var test =
                new SimpleBinaryOpTest__ShiftArithmeticRoundedSaturateScalar_Vector64_SByte();
    ...
    public sealed unsafe class SimpleBinaryOpTest__ShiftArithmeticRoundedSaturateScalar_Vector64_SByte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__ShiftArithmeticRoundedSaturateScalar_Vector64_SByte testClass
            )
            {
        ...
        static SimpleBinaryOpTest__ShiftArithmeticRoundedSaturateScalar_Vector64_SByte()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetSByte();
        ...
        public SimpleBinaryOpTest__ShiftArithmeticRoundedSaturateScalar_Vector64_SByte()
        {
            Succeeded = true;
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.Arm64.ShiftArithmeticRoundedSaturateScalar(_clsVar1, _clsVar2);
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.Arm64.ShiftArithmeticRoundedSaturateScalar(op1, op2);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test =
                new SimpleBinaryOpTest__ShiftArithmeticRoundedSaturateScalar_Vector64_SByte();
            var result = AdvSimd.Arm64.ShiftArithmeticRoundedSaturateScalar(test._fld1, test._fld2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.ShiftArithmeticRoundedSaturateScalar)}<SByte>(Vector64<SByte>, Vector64<SByte>): {method} failed:"
                    );
