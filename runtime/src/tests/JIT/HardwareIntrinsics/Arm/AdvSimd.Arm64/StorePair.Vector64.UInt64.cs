...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void StorePair_Vector64_UInt64()
        {
            var test = new StoreBinaryOpTest__StorePair_Vector64_UInt64();
    ...
    public sealed unsafe class StoreBinaryOpTest__StorePair_Vector64_UInt64
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(StoreBinaryOpTest__StorePair_Vector64_UInt64 testClass)
            {
                AdvSimd.Arm64.StorePair((UInt64*)testClass._dataTable.outArrayPtr, _fld1, _fld2);

                testClass.ValidateResult(_fld1, _fld2, testClass._dataTable.outArrayPtr);
            }

            public void RunStructFldScenario_Load(
                StoreBinaryOpTest__StorePair_Vector64_UInt64 testClass
            )
            {
        ...
        static StoreBinaryOpTest__StorePair_Vector64_UInt64()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetUInt64();
        ...
        public StoreBinaryOpTest__StorePair_Vector64_UInt64()
        {
            Succeeded = true;
        ...
        public void RunClsVarScenario()
        {
            ...
            AdvSimd.Arm64.StorePair((UInt64*)_dataTable.outArrayPtr, _clsVar1, _clsVar2);
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            AdvSimd.Arm64.StorePair((UInt64*)_dataTable.outArrayPtr, op1, op2);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new StoreBinaryOpTest__StorePair_Vector64_UInt64();
            AdvSimd.Arm64.StorePair((UInt64*)_dataTable.outArrayPtr, test._fld1, test._fld2);
        ...
        public void RunClassFldScenario()
        {
            ...
            AdvSimd.Arm64.StorePair((UInt64*)_dataTable.outArrayPtr, _fld1, _fld2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.StorePair)}<UInt64>(Vector64<UInt64>, Vector64<UInt64>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
