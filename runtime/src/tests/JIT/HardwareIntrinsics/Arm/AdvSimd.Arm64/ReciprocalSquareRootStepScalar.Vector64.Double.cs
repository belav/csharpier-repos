    ...
    public sealed unsafe class SimpleBinaryOpTest__ReciprocalSquareRootStepScalar_Vector64_Double
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__ReciprocalSquareRootStepScalar_Vector64_Double testClass
            )
            {
        ...
        )
        {
            ...
            if (
                BitConverter.DoubleToInt64Bits(Helpers.FPRSqrtStepFused(left[0], right[0]))
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.ReciprocalSquareRootStepScalar)}<Double>(Vector64<Double>, Vector64<Double>): {method} failed:"
                    );
