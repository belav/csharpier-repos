...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ShiftRightLogicalNarrowingSaturateScalar_Vector64_Int16_7()
        {
            var test =
                new ImmUnaryOpTest__ShiftRightLogicalNarrowingSaturateScalar_Vector64_Int16_7();
    ...
    public sealed unsafe class ImmUnaryOpTest__ShiftRightLogicalNarrowingSaturateScalar_Vector64_Int16_7
    {
        ...
        private struct TestStruct
        {
            ...
            public static TestStruct Create()
            {
                ...
                Unsafe.CopyBlockUnaligned(
                    ref Unsafe.As<Vector64<Int32>, byte>(ref testStruct._fld),
            ...
            public void RunStructFldScenario(
                ImmUnaryOpTest__ShiftRightLogicalNarrowingSaturateScalar_Vector64_Int16_7 testClass
            )
            {
                var result = AdvSimd.Arm64.ShiftRightLogicalNarrowingSaturateScalar(_fld, 15);
        ...
        private static readonly byte Imm = 15;
        ...
        static ImmUnaryOpTest__ShiftRightLogicalNarrowingSaturateScalar_Vector64_Int16_7()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data[i] = TestLibrary.Generator.GetInt32();
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector64<Int32>, byte>(ref _clsVar),
                ref Unsafe.As<Int32, byte>(ref _data[0]),
                (uint)Unsafe.SizeOf<Vector64<Int32>>()
            );
        }

        public ImmUnaryOpTest__ShiftRightLogicalNarrowingSaturateScalar_Vector64_Int16_7()
        {
            Succeeded = true;
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector64<Int32>, byte>(ref _fld),
                ref Unsafe.As<Int32, byte>(ref _data[0]),
                (uint)Unsafe.SizeOf<Vector64<Int32>>()
            );
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64)
                .GetMethod(
                    nameof(AdvSimd.Arm64.ShiftRightLogicalNarrowingSaturateScalar),
                    new Type[] { typeof(Vector64<Int32>), typeof(byte) }
                )
                .Invoke(
                    null,
                    new object[] { Unsafe.Read<Vector64<Int32>>(_dataTable.inArrayPtr), (byte)15 }
                );
        ...
        public void RunReflectionScenario_Load()
        {
            ...
            var result = typeof(AdvSimd.Arm64)
                ...
                .Invoke(
                    null,
                    new object[] { AdvSimd.LoadVector64((Int32*)(_dataTable.inArrayPtr)), (byte)15 }
                );
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.Arm64.ShiftRightLogicalNarrowingSaturateScalar(_clsVar, 15);
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.Arm64.ShiftRightLogicalNarrowingSaturateScalar(firstOp, 15);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test =
                new ImmUnaryOpTest__ShiftRightLogicalNarrowingSaturateScalar_Vector64_Int16_7();
            var result = AdvSimd.Arm64.ShiftRightLogicalNarrowingSaturateScalar(test._fld, 15);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.ShiftRightLogicalNarrowingSaturateScalar)}<Int16>(Vector64<Int32>, 15): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
