    ...
    public sealed unsafe class ImmUnaryOpTest__DuplicateSelectedScalarToVector128_V128_Int64_1
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                ImmUnaryOpTest__DuplicateSelectedScalarToVector128_V128_Int64_1 testClass
            )
            {
        ...
        public void RunClassLclFldScenario_Load()
        {
            ...
            fixed (Vector128<Int64>* pFld = &test._fld)
            {
                var result = AdvSimd
                    .Arm64
                    .DuplicateSelectedScalarToVector128(AdvSimd.LoadVector128((Int64*)(pFld)), 1);
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var result = AdvSimd
                .Arm64
                .DuplicateSelectedScalarToVector128(AdvSimd.LoadVector128((Int64*)(&test._fld)), 1);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.DuplicateSelectedScalarToVector128)}<Int64>(Vector128<Int64>, 1): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
