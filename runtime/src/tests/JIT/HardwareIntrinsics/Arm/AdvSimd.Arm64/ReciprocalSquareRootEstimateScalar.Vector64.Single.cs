...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ReciprocalSquareRootEstimateScalar_Vector64_Single()
        {
            var test = new SimpleUnaryOpTest__ReciprocalSquareRootEstimateScalar_Vector64_Single();
    ...
    public sealed unsafe class SimpleUnaryOpTest__ReciprocalSquareRootEstimateScalar_Vector64_Single
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__ReciprocalSquareRootEstimateScalar_Vector64_Single testClass
            )
            {
                var result = AdvSimd.Arm64.ReciprocalSquareRootEstimateScalar(_fld1);
            ...
            )
            {
                fixed (Vector64<Single>* pFld1 = &_fld1)
                {
                    var result = AdvSimd
                        .Arm64
                        .ReciprocalSquareRootEstimateScalar(AdvSimd.LoadVector64((Single*)(pFld1)));
        ...
        static SimpleUnaryOpTest__ReciprocalSquareRootEstimateScalar_Vector64_Single()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = BitConverter.Int32BitsToSingle(0x3e4ed9ed);
        ...
        public SimpleUnaryOpTest__ReciprocalSquareRootEstimateScalar_Vector64_Single()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64)
                .GetMethod(
                    nameof(AdvSimd.Arm64.ReciprocalSquareRootEstimateScalar),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.Arm64.ReciprocalSquareRootEstimateScalar(_clsVar1);
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            fixed (Vector64<Single>* pClsVar1 = &_clsVar1)
            {
                var result = AdvSimd
                    .Arm64
                    .ReciprocalSquareRootEstimateScalar(AdvSimd.LoadVector64((Single*)(pClsVar1)));
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.Arm64.ReciprocalSquareRootEstimateScalar(op1);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimpleUnaryOpTest__ReciprocalSquareRootEstimateScalar_Vector64_Single();
            var result = AdvSimd.Arm64.ReciprocalSquareRootEstimateScalar(test._fld1);
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var result = AdvSimd
                .Arm64
                .ReciprocalSquareRootEstimateScalar(AdvSimd.LoadVector64((Single*)(&test._fld1)));
        ...
        )
        {
            ...
            if (BitConverter.SingleToInt32Bits(result[0]) != 0x400e8000)
            {
                succeeded = false;
            }
            else
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.ReciprocalSquareRootEstimateScalar)}<Single>(Vector64<Single>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
