...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void LoadPairScalarVector64_Single()
        {
    ...
    public sealed unsafe class LoadPairScalarVector64_Single
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(LoadPairScalarVector64_Single testClass)
            {
                _fld = AdvSimd
                    .Arm64
                    .LoadPairScalarVector64((Single*)(testClass._dataTable.inArrayPtr));
        ...
        private static readonly int RetElementCount =
            Unsafe.SizeOf<(Vector64<Single>, Vector64<Single>)>() / sizeof(Single);
        ...
        public LoadPairScalarVector64_Single()
        {
            Succeeded = true;
        ...
        public void RunBasicScenario()
        {
            ...
            var result = AdvSimd.Arm64.LoadPairScalarVector64((Single*)(_dataTable.inArrayPtr));
        ...
        public void RunClsVarScenario()
        {
            ...
            _clsVar = AdvSimd.Arm64.LoadPairScalarVector64((Single*)(_dataTable.inArrayPtr));
        ...
        )
        {
            ...
            {
                if (
                    BitConverter.SingleToInt32Bits(Helpers.LoadPairScalar(firstOp, i))
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.LoadPairScalarVector64)}<Single>(Vector64<Single>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
