...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    public sealed unsafe class SimpleUnaryOpTest__AbsSaturateScalar_Vector64_Int32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__AbsSaturateScalar_Vector64_Int32 testClass
            )
            {
            ...
            )
            {
                fixed (Vector64<Int32>* pFld1 = &_fld1)
                {
                    var result = AdvSimd
                        .Arm64
                        .AbsSaturateScalar(AdvSimd.LoadVector64((Int32*)(pFld1)));
        ...
        static SimpleUnaryOpTest__AbsSaturateScalar_Vector64_Int32()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = Int32.MinValue;
        ...
        public SimpleUnaryOpTest__AbsSaturateScalar_Vector64_Int32()
        {
            Succeeded = true;
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd
                .Arm64
                .AbsSaturateScalar(Unsafe.Read<Vector64<Int32>>(_dataTable.inArray1Ptr));
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var result = AdvSimd
                .Arm64
                .AbsSaturateScalar(AdvSimd.LoadVector64((Int32*)(_dataTable.inArray1Ptr)));
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            fixed (Vector64<Int32>* pClsVar1 = &_clsVar1)
            {
                var result = AdvSimd
                    .Arm64
                    .AbsSaturateScalar(AdvSimd.LoadVector64((Int32*)(pClsVar1)));
        ...
        public void RunClassLclFldScenario_Load()
        {
            ...
            {
                var result = AdvSimd.Arm64.AbsSaturateScalar(AdvSimd.LoadVector64((Int32*)(pFld1)));
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var result = AdvSimd
                .Arm64
                .AbsSaturateScalar(AdvSimd.LoadVector64((Int32*)(&test._fld1)));
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.AbsSaturateScalar)}<Int32>(Vector64<Int32>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
