...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void MultiplyRoundedDoublingSaturateHighScalar_Vector64_Int16()
        {
            var test =
                new SimpleBinaryOpTest__MultiplyRoundedDoublingSaturateHighScalar_Vector64_Int16();
    ...
    public sealed unsafe class SimpleBinaryOpTest__MultiplyRoundedDoublingSaturateHighScalar_Vector64_Int16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__MultiplyRoundedDoublingSaturateHighScalar_Vector64_Int16 testClass
            )
            {
        ...
        static SimpleBinaryOpTest__MultiplyRoundedDoublingSaturateHighScalar_Vector64_Int16()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetInt16();
        ...
        public SimpleBinaryOpTest__MultiplyRoundedDoublingSaturateHighScalar_Vector64_Int16()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64)
                .GetMethod(
                    nameof(AdvSimd.Arm64.MultiplyRoundedDoublingSaturateHighScalar),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd
                .Arm64
                .MultiplyRoundedDoublingSaturateHighScalar(_clsVar1, _clsVar2);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var result = AdvSimd
                .Arm64
                .MultiplyRoundedDoublingSaturateHighScalar(test._fld1, test._fld2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.MultiplyRoundedDoublingSaturateHighScalar)}<Int16>(Vector64<Int16>, Vector64<Int16>): {method} failed:"
                    );
