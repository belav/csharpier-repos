...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void StorePairNonTemporal_Vector128_Int64()
        {
            var test = new StoreBinaryOpTest__StorePairNonTemporal_Vector128_Int64();
    ...
    public sealed unsafe class StoreBinaryOpTest__StorePairNonTemporal_Vector128_Int64
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                StoreBinaryOpTest__StorePairNonTemporal_Vector128_Int64 testClass
            )
            {
                AdvSimd
                    .Arm64
        ...
        static StoreBinaryOpTest__StorePairNonTemporal_Vector128_Int64()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetInt64();
        ...
        public StoreBinaryOpTest__StorePairNonTemporal_Vector128_Int64()
        {
            Succeeded = true;
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.StorePairNonTemporal)}<Int64>(Vector128<Int64>, Vector128<Int64>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
