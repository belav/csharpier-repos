...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void AddSaturateScalar_Vector64_Int64_Vector64_UInt64()
        {
            var test = new SimpleBinaryOpTest__AddSaturateScalar_Vector64_Int64_Vector64_UInt64();
    ...
    public sealed unsafe class SimpleBinaryOpTest__AddSaturateScalar_Vector64_Int64_Vector64_UInt64
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__AddSaturateScalar_Vector64_Int64_Vector64_UInt64 testClass
            )
            {
            ...
            {
                fixed (Vector64<Int64>* pFld1 = &_fld1)fixed (Vector64<UInt64>* pFld2 = &_fld2)
                {
        ...
        static SimpleBinaryOpTest__AddSaturateScalar_Vector64_Int64_Vector64_UInt64()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetInt64();
        ...
        public SimpleBinaryOpTest__AddSaturateScalar_Vector64_Int64_Vector64_UInt64()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64).GetMethod(
                    ...
                    new Type[] { typeof(Vector64<Int64>), typeof(Vector64<UInt64>) }
                )
                .Invoke(
                    null,
                    new object[]
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.AddSaturateScalar)}<Int64>(Vector64<Int64>, Vector64<UInt64>): {method} failed:"
                );
