    ...
    public sealed unsafe class SimpleBinaryOpTest__AddSaturate_Vector64_Byte_Vector64_SByte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__AddSaturate_Vector64_Byte_Vector64_SByte testClass
            ) {
        ...
        private void ValidateResult(
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.AddSaturate)}<Byte>(Vector64<Byte>, Vector64<SByte>): {method} failed:"
                );
