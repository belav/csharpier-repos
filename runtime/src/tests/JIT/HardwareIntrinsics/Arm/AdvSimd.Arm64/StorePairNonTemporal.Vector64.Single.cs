...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void StorePairNonTemporal_Vector64_Single()
        {
    ...
    public sealed unsafe class StoreBinaryOpTest__StorePairNonTemporal_Vector64_Single
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                StoreBinaryOpTest__StorePairNonTemporal_Vector64_Single testClass
            )
            {
                AdvSimd
                    .Arm64
                    .StorePairNonTemporal((Single*)testClass._dataTable.outArrayPtr, _fld1, _fld2);
        ...
        static StoreBinaryOpTest__StorePairNonTemporal_Vector64_Single()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetSingle();
        ...
        public StoreBinaryOpTest__StorePairNonTemporal_Vector64_Single()
        {
            Succeeded = true;
        ...
        public void RunClassLclFldScenario()
        {
            ...
            AdvSimd
                .Arm64
                .StorePairNonTemporal((Single*)_dataTable.outArrayPtr, test._fld1, test._fld2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.StorePairNonTemporal)}<Single>(Vector64<Single>, Vector64<Single>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
