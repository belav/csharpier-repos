...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void UnzipEven_Vector128_Int64()
        {
            var test = new SimpleBinaryOpTest__UnzipEven_Vector128_Int64();
    ...
    public sealed unsafe class SimpleBinaryOpTest__UnzipEven_Vector128_Int64
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__UnzipEven_Vector128_Int64 testClass
            )
            {
        ...
        static SimpleBinaryOpTest__UnzipEven_Vector128_Int64()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetInt64();
        ...
        public SimpleBinaryOpTest__UnzipEven_Vector128_Int64()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64)
                .GetMethod(
                    nameof(AdvSimd.Arm64.UnzipEven),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.Arm64.UnzipEven(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.UnzipEven)}<Int64>(Vector128<Int64>, Vector128<Int64>): {method} failed:"
                    );
