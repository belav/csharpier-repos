    ...
    public sealed unsafe class SimpleBinaryOpTest__AddSaturate_Vector64_Int32_Vector64_UInt32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__AddSaturate_Vector64_Int32_Vector64_UInt32 testClass
            )
            {
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.AddSaturate)}<Int32>(Vector64<Int32>, Vector64<UInt32>): {method} failed:"
                );
