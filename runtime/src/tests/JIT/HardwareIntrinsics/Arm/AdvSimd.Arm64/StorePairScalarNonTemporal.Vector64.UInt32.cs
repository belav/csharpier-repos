...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void StorePairScalarNonTemporal_Vector64_UInt32()
        {
    ...
    public sealed unsafe class StoreBinaryOpTest__StorePairScalarNonTemporal_Vector64_UInt32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                StoreBinaryOpTest__StorePairScalarNonTemporal_Vector64_UInt32 testClass
            )
            {
                AdvSimd
                    .Arm64
        ...
        static StoreBinaryOpTest__StorePairScalarNonTemporal_Vector64_UInt32()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetUInt32();
        ...
        public StoreBinaryOpTest__StorePairScalarNonTemporal_Vector64_UInt32()
        {
            Succeeded = true;
        ...
        public void RunClsVarScenario()
        {
            ...
            AdvSimd
                .Arm64
                .StorePairScalarNonTemporal((UInt32*)_dataTable.outArrayPtr, _clsVar1, _clsVar2);
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            AdvSimd.Arm64.StorePairScalarNonTemporal((UInt32*)_dataTable.outArrayPtr, op1, op2);
        ...
        public void RunClassFldScenario()
        {
            ...
            AdvSimd.Arm64.StorePairScalarNonTemporal((UInt32*)_dataTable.outArrayPtr, _fld1, _fld2);
        ...
        )
        {
            ...
            Unsafe.CopyBlockUnaligned(
                ...
                (uint)(RetElementCount * Unsafe.SizeOf<UInt32>())
            );
        ...
        )
        {
            ...
            {
                if (Helpers.ConcatScalar(firstOp, secondOp, i) != result[i])
                {
                    succeeded = false;
                    break;
                }
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.StorePairScalarNonTemporal)}<UInt32>(Vector64<UInt32>, Vector64<UInt32>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
