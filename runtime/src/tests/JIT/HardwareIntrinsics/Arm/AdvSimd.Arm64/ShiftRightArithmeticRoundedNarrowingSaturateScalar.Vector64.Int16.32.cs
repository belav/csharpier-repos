...
namespace JIT.HardwareIntrinsics.Arm
{
    public static partial class Program
    {
        ...
        {
            var test =
                new ImmUnaryOpTest__ShiftRightArithmeticRoundedNarrowingSaturateScalar_Vector64_Int16_32();
    ...
    public sealed unsafe class ImmUnaryOpTest__ShiftRightArithmeticRoundedNarrowingSaturateScalar_Vector64_Int16_32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                ImmUnaryOpTest__ShiftRightArithmeticRoundedNarrowingSaturateScalar_Vector64_Int16_32 testClass
            )
            {
                var result = AdvSimd
                    .Arm64
                    .ShiftRightArithmeticRoundedNarrowingSaturateScalar(_fld, 16);
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64)
                ...
                .Invoke(
                    null,
                    new object[] { Unsafe.Read<Vector64<Int32>>(_dataTable.inArrayPtr), (byte)16 }
                );
        ...
        public void RunReflectionScenario_Load()
        {
            ...
            var result = typeof(AdvSimd.Arm64)
                ...
                .Invoke(
                    null,
                    new object[] { AdvSimd.LoadVector64((Int32*)(_dataTable.inArrayPtr)), (byte)16 }
                );
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd
                .Arm64
                .ShiftRightArithmeticRoundedNarrowingSaturateScalar(_clsVar, 16);
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd
                .Arm64
                .ShiftRightArithmeticRoundedNarrowingSaturateScalar(firstOp, 16);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var result = AdvSimd
                .Arm64
                .ShiftRightArithmeticRoundedNarrowingSaturateScalar(test._fld, 16);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.ShiftRightArithmeticRoundedNarrowingSaturateScalar)}<Int16>(Vector64<Int32>, 16): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
