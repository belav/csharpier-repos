    ...
    public sealed unsafe class ImmUnaryOpTest__ShiftLeftLogicalSaturateScalar_Vector64_UInt32_1
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                ImmUnaryOpTest__ShiftLeftLogicalSaturateScalar_Vector64_UInt32_1 testClass
            )
            {
            ...
            )
            {
                fixed (Vector64<UInt32>* pFld = &_fld)
                {
                    var result = AdvSimd
                        .Arm64
                        .ShiftLeftLogicalSaturateScalar(AdvSimd.LoadVector64((UInt32*)(pFld)), 1);
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            fixed (Vector64<UInt32>* pClsVar = &_clsVar)
            {
                var result = AdvSimd
                    .Arm64
                    .ShiftLeftLogicalSaturateScalar(AdvSimd.LoadVector64((UInt32*)(pClsVar)), 1);
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var result = AdvSimd
                .Arm64
                .ShiftLeftLogicalSaturateScalar(AdvSimd.LoadVector64((UInt32*)(&test._fld)), 1);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.ShiftLeftLogicalSaturateScalar)}<UInt32>(Vector64<UInt32>, 1): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
