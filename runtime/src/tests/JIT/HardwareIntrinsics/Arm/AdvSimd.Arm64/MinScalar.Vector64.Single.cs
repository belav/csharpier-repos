...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void MinScalar_Vector64_Single()
        {
            var test = new SimpleBinaryOpTest__MinScalar_Vector64_Single();
    ...
    public sealed unsafe class SimpleBinaryOpTest__MinScalar_Vector64_Single
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__MinScalar_Vector64_Single testClass
            )
            {
        ...
        static SimpleBinaryOpTest__MinScalar_Vector64_Single()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetSingle();
        ...
        public SimpleBinaryOpTest__MinScalar_Vector64_Single()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64)
                .GetMethod(
                    nameof(AdvSimd.Arm64.MinScalar),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.Arm64.MinScalar(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (
                BitConverter.SingleToInt32Bits(Helpers.Min(left[0], right[0]))
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.MinScalar)}<Single>(Vector64<Single>, Vector64<Single>): {method} failed:"
                    );
