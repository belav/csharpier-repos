    ...
    public sealed unsafe class SimpleBinaryOpTest__Divide_Vector128_Double
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario_Load(
                SimpleBinaryOpTest__Divide_Vector128_Double testClass
            )
            {
        ...
        )
        {
            ...
            {
                if (
                    BitConverter.DoubleToInt64Bits(Helpers.Divide(left[i], right[i]))
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.Divide)}<Double>(Vector128<Double>, Vector128<Double>): {method} failed:"
                    );
