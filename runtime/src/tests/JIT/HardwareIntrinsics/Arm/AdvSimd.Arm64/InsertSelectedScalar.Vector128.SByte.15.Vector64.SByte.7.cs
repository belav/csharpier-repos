...
namespace JIT.HardwareIntrinsics.Arm
{
    public static partial class Program
    {
        ...
        {
            var test =
                new InsertSelectedScalarTest__InsertSelectedScalar_Vector128_SByte_15_Vector64_SByte_7();
    ...
    public sealed unsafe class InsertSelectedScalarTest__InsertSelectedScalar_Vector128_SByte_15_Vector64_SByte_7
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                InsertSelectedScalarTest__InsertSelectedScalar_Vector128_SByte_15_Vector64_SByte_7 testClass
            ) {
            ...
            public void RunStructFldScenario_Load(
                ...
                fixed (Vector128<SByte>* pFld1 = &_fld1)fixed (Vector64<SByte>* pFld2 = &_fld3)
                {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.Arm64.InsertSelectedScalar(_clsVar1, 15, _clsVar3, 7);
        ...
        public void RunClassLclFldScenario_Load()
        {
            ...
            fixed (Vector128<SByte>* pFld1 = &test._fld1)fixed (
                Vector64<SByte>* pFld2 = &test._fld3
            ) {
                var result = AdvSimd.Arm64.InsertSelectedScalar(
                    AdvSimd.LoadVector128((SByte*)pFld1),
                    15,
        ...
        private void ValidateResult(
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.InsertSelectedScalar)}<SByte>(Vector128<SByte>, {15}, Vector64<SByte>, {7}): {method} failed:"
                );
                TestLibrary.TestFramework.LogInformation(
