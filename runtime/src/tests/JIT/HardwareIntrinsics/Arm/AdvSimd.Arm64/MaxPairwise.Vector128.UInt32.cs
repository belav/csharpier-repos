    ...
    public sealed unsafe class SimpleBinaryOpTest__MaxPairwise_Vector128_UInt32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__MaxPairwise_Vector128_UInt32 testClass
            ) {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64).GetMethod(
                    nameof(AdvSimd.Arm64.MaxPairwise),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.Arm64.MaxPairwise(_clsVar1, _clsVar2);
        ...
        private void ValidateResult(
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.MaxPairwise)}<UInt32>(Vector128<UInt32>, Vector128<UInt32>): {method} failed:"
                );
