...
namespace JIT.HardwareIntrinsics.Arm
{
    public static partial class Program
    {
        ...
        {
            var test =
                new SimpleTernaryOpTest__FusedMultiplyAddBySelectedScalar_Vector64_Single_Vector64_Single_1();
    ...
    public sealed unsafe class SimpleTernaryOpTest__FusedMultiplyAddBySelectedScalar_Vector64_Single_Vector64_Single_1
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleTernaryOpTest__FusedMultiplyAddBySelectedScalar_Vector64_Single_Vector64_Single_1 testClass
            )
            {
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.FusedMultiplyAddBySelectedScalar)}<Single>(Vector64<Single>, Vector64<Single>, Vector64<Single>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
