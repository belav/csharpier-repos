    ...
    public sealed unsafe class SimpleUnaryOpTest__MinAcross_Vector64_Int16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario_Load(
                SimpleUnaryOpTest__MinAcross_Vector64_Int16 testClass
            )
            {
                fixed (Vector64<Int16>* pFld1 = &_fld1)
                {
                    var result = AdvSimd.Arm64.MinAcross(AdvSimd.LoadVector64((Int16*)(pFld1)));
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd
                .Arm64
                .MinAcross(Unsafe.Read<Vector64<Int16>>(_dataTable.inArray1Ptr));
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var result = AdvSimd
                .Arm64
                .MinAcross(AdvSimd.LoadVector64((Int16*)(_dataTable.inArray1Ptr)));
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64)
                .GetMethod(nameof(AdvSimd.Arm64.MinAcross), new Type[] { typeof(Vector64<Int16>) })
                .Invoke(
                    null,
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            {
                var result = AdvSimd.Arm64.MinAcross(AdvSimd.LoadVector64((Int16*)(pClsVar1)));
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = AdvSimd.Arm64.MinAcross(AdvSimd.LoadVector64((Int16*)(&test._fld1)));
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.MinAcross)}<Int16>(Vector64<Int16>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
