...
namespace JIT.HardwareIntrinsics.Arm
{
    public static partial class Program
    {
        ...
        {
            var test =
                new SimpleTernaryOpTest__FusedMultiplyAddBySelectedScalar_Vector64_Single_Vector128_Single_3();
    ...
    public sealed unsafe class SimpleTernaryOpTest__FusedMultiplyAddBySelectedScalar_Vector64_Single_Vector128_Single_3
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleTernaryOpTest__FusedMultiplyAddBySelectedScalar_Vector64_Single_Vector128_Single_3 testClass
            )
            {
        ...
        )
        {
            ...
            for (var i = 0; i < RetElementCount; i++)
            {
                if (
                    BitConverter.SingleToInt32Bits(
                        Helpers.FusedMultiplyAdd(firstOp[i], secondOp[i], thirdOp[Imm])
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.FusedMultiplyAddBySelectedScalar)}<Single>(Vector64<Single>, Vector64<Single>, Vector128<Single>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
