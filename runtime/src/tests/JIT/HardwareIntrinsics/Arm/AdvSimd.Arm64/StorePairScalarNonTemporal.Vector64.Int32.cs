...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void StorePairScalarNonTemporal_Vector64_Int32()
        {
    ...
    public sealed unsafe class StoreBinaryOpTest__StorePairScalarNonTemporal_Vector64_Int32
    {
        ...
        static StoreBinaryOpTest__StorePairScalarNonTemporal_Vector64_Int32()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetInt32();
        ...
        public StoreBinaryOpTest__StorePairScalarNonTemporal_Vector64_Int32()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            typeof(AdvSimd.Arm64)
                .GetMethod(
                    ...
                    new Type[] { typeof(Int32*), typeof(Vector64<Int32>), typeof(Vector64<Int32>) }
                )
                .Invoke(
                    null,
                    new object[]
        ...
        public void RunClsVarScenario()
        {
            ...
            AdvSimd
                .Arm64
                .StorePairScalarNonTemporal((Int32*)_dataTable.outArrayPtr, _clsVar1, _clsVar2);
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            AdvSimd.Arm64.StorePairScalarNonTemporal((Int32*)_dataTable.outArrayPtr, op1, op2);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            AdvSimd
                .Arm64
                .StorePairScalarNonTemporal((Int32*)_dataTable.outArrayPtr, test._fld1, test._fld2);
        ...
        public void RunClassFldScenario()
        {
            ...
            AdvSimd.Arm64.StorePairScalarNonTemporal((Int32*)_dataTable.outArrayPtr, _fld1, _fld2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.StorePairScalarNonTemporal)}<Int32>(Vector64<Int32>, Vector64<Int32>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
