...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ConvertToUInt64RoundToZeroScalar_Vector64_Double()
        {
            var test = new SimpleUnaryOpTest__ConvertToUInt64RoundToZeroScalar_Vector64_Double();
    ...
    public sealed unsafe class SimpleUnaryOpTest__ConvertToUInt64RoundToZeroScalar_Vector64_Double
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__ConvertToUInt64RoundToZeroScalar_Vector64_Double testClass
            )
            {
                var result = AdvSimd.Arm64.ConvertToUInt64RoundToZeroScalar(_fld1);
            ...
            )
            {
                fixed (Vector64<Double>* pFld1 = &_fld1)
                {
                    var result = AdvSimd
                        .Arm64
                        .ConvertToUInt64RoundToZeroScalar(AdvSimd.LoadVector64((Double*)(pFld1)));
        ...
        static SimpleUnaryOpTest__ConvertToUInt64RoundToZeroScalar_Vector64_Double()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetDouble();
        ...
        public SimpleUnaryOpTest__ConvertToUInt64RoundToZeroScalar_Vector64_Double()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64)
                .GetMethod(
                    nameof(AdvSimd.Arm64.ConvertToUInt64RoundToZeroScalar),
                    new Type[] { typeof(Vector64<Double>) }
                )
                .Invoke(
                    null,
                    new object[] { Unsafe.Read<Vector64<Double>>(_dataTable.inArray1Ptr) }
                );
        ...
        public void RunReflectionScenario_Load()
        {
            ...
            var result = typeof(AdvSimd.Arm64)
                ...
                .Invoke(
                    null,
                    new object[] { AdvSimd.LoadVector64((Double*)(_dataTable.inArray1Ptr)) }
                );
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.Arm64.ConvertToUInt64RoundToZeroScalar(_clsVar1);
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            fixed (Vector64<Double>* pClsVar1 = &_clsVar1)
            {
                var result = AdvSimd
                    .Arm64
                    .ConvertToUInt64RoundToZeroScalar(AdvSimd.LoadVector64((Double*)(pClsVar1)));
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.Arm64.ConvertToUInt64RoundToZeroScalar(op1);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimpleUnaryOpTest__ConvertToUInt64RoundToZeroScalar_Vector64_Double();
            var result = AdvSimd.Arm64.ConvertToUInt64RoundToZeroScalar(test._fld1);
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var result = AdvSimd
                .Arm64
                .ConvertToUInt64RoundToZeroScalar(AdvSimd.LoadVector64((Double*)(&test._fld1)));
        ...
        )
        {
            ...
            if (Helpers.ConvertToUInt64RoundToZero(firstOp[0]) != result[0])
            {
                succeeded = false;
            }
            else
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.ConvertToUInt64RoundToZeroScalar)}<UInt64>(Vector64<Double>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
