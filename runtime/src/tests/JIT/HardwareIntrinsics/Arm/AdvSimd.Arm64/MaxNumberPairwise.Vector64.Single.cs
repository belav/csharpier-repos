    ...
    public sealed unsafe class SimpleBinaryOpTest__MaxNumberPairwise_Vector64_Single
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__MaxNumberPairwise_Vector64_Single testClass
            )
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64)
                .GetMethod(
                    nameof(AdvSimd.Arm64.MaxNumberPairwise),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.Arm64.MaxNumberPairwise(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            {
                if (
                    BitConverter.SingleToInt32Bits(Helpers.MaxNumberPairwise(left, right, i))
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.MaxNumberPairwise)}<Single>(Vector64<Single>, Vector64<Single>): {method} failed:"
                    );
