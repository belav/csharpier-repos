    ...
    public sealed unsafe class LoadPairVector128NonTemporal_Int32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(LoadPairVector128NonTemporal_Int32 testClass)
            {
                _fld = AdvSimd
                    .Arm64
                    .LoadPairVector128NonTemporal((Int32*)(testClass._dataTable.inArrayPtr));
        ...
        public void RunBasicScenario()
        {
            ...
            var result = AdvSimd
                .Arm64
                .LoadPairVector128NonTemporal((Int32*)(_dataTable.inArrayPtr));
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.LoadPairVector128NonTemporal)}<Int32>(Vector128<Int32>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
