...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void MultiplyDoublingWideningSaturateScalar_Vector64_Int16()
        {
            var test =
                new SimpleBinaryOpTest__MultiplyDoublingWideningSaturateScalar_Vector64_Int16();
    ...
    public sealed unsafe class SimpleBinaryOpTest__MultiplyDoublingWideningSaturateScalar_Vector64_Int16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__MultiplyDoublingWideningSaturateScalar_Vector64_Int16 testClass
            ) {
                var result = AdvSimd.Arm64.MultiplyDoublingWideningSaturateScalar(_fld1, _fld2);
            ...
            public void RunStructFldScenario_Load(
                ...
                {
                    var result = AdvSimd.Arm64.MultiplyDoublingWideningSaturateScalar(
        ...
        static SimpleBinaryOpTest__MultiplyDoublingWideningSaturateScalar_Vector64_Int16()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetInt16();
        ...
        public SimpleBinaryOpTest__MultiplyDoublingWideningSaturateScalar_Vector64_Int16()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64).GetMethod(
                    nameof(AdvSimd.Arm64.MultiplyDoublingWideningSaturateScalar),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.Arm64.MultiplyDoublingWideningSaturateScalar(_clsVar1, _clsVar2);
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.Arm64.MultiplyDoublingWideningSaturateScalar(op1, op2);
        ...
        private void ValidateResult(
            ...
            if (Helpers.MultiplyDoublingWideningSaturate(left[0], right[0]) != result[0])
            {
                succeeded = false;
            }
            else
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.MultiplyDoublingWideningSaturateScalar)}<Int32>(Vector64<Int16>, Vector64<Int16>): {method} failed:"
                );
