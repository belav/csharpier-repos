    ...
    public sealed unsafe class SimpleUnaryOpTest__ExtractNarrowingSaturateScalar_Vector64_Int16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__ExtractNarrowingSaturateScalar_Vector64_Int16 testClass
            )
            {
            ...
            )
            {
                fixed (Vector64<Int32>* pFld1 = &_fld1)
                {
                    var result = AdvSimd
                        .Arm64
                        .ExtractNarrowingSaturateScalar(AdvSimd.LoadVector64((Int32*)(pFld1)));
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            fixed (Vector64<Int32>* pClsVar1 = &_clsVar1)
            {
                var result = AdvSimd
                    .Arm64
                    .ExtractNarrowingSaturateScalar(AdvSimd.LoadVector64((Int32*)(pClsVar1)));
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var result = AdvSimd
                .Arm64
                .ExtractNarrowingSaturateScalar(AdvSimd.LoadVector64((Int32*)(&test._fld1)));
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.ExtractNarrowingSaturateScalar)}<Int16>(Vector64<Int32>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
