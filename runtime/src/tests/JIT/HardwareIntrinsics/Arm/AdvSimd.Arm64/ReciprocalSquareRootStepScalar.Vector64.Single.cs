...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ReciprocalSquareRootStepScalar_Vector64_Single()
        {
            var test = new SimpleBinaryOpTest__ReciprocalSquareRootStepScalar_Vector64_Single();
    ...
    public sealed unsafe class SimpleBinaryOpTest__ReciprocalSquareRootStepScalar_Vector64_Single
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__ReciprocalSquareRootStepScalar_Vector64_Single testClass
            )
            {
                var result = AdvSimd.Arm64.ReciprocalSquareRootStepScalar(_fld1, _fld2);
            ...
            )
            {
                ...
                {
                    var result = AdvSimd.Arm64.ReciprocalSquareRootStepScalar(
        ...
        static SimpleBinaryOpTest__ReciprocalSquareRootStepScalar_Vector64_Single()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetSingle();
        ...
        public SimpleBinaryOpTest__ReciprocalSquareRootStepScalar_Vector64_Single()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64).GetMethod(
                    nameof(AdvSimd.Arm64.ReciprocalSquareRootStepScalar),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.Arm64.ReciprocalSquareRootStepScalar(_clsVar1, _clsVar2);
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.Arm64.ReciprocalSquareRootStepScalar(op1, op2);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimpleBinaryOpTest__ReciprocalSquareRootStepScalar_Vector64_Single();
            var result = AdvSimd.Arm64.ReciprocalSquareRootStepScalar(test._fld1, test._fld2);
        ...
        )
        {
            ...
            if (
                BitConverter.SingleToInt32Bits(Helpers.FPRSqrtStepFused(left[0], right[0]))
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.ReciprocalSquareRootStepScalar)}<Single>(Vector64<Single>, Vector64<Single>): {method} failed:"
                );
