...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ExtractNarrowingSaturateUnsignedScalar_Vector64_Byte()
        {
            var test =
                new SimpleUnaryOpTest__ExtractNarrowingSaturateUnsignedScalar_Vector64_Byte();
    ...
    public sealed unsafe class SimpleUnaryOpTest__ExtractNarrowingSaturateUnsignedScalar_Vector64_Byte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__ExtractNarrowingSaturateUnsignedScalar_Vector64_Byte testClass
            )
            {
        ...
        static SimpleUnaryOpTest__ExtractNarrowingSaturateUnsignedScalar_Vector64_Byte()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetInt16();
        ...
        public SimpleUnaryOpTest__ExtractNarrowingSaturateUnsignedScalar_Vector64_Byte()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64)
                .GetMethod(
                    ...
                    new Type[] { typeof(Vector64<Int16>) }
                )
                .Invoke(
                    null,
                    new object[] { Unsafe.Read<Vector64<Int16>>(_dataTable.inArray1Ptr) }
                );
        ...
        public void RunReflectionScenario_Load()
        {
            ...
            var result = typeof(AdvSimd.Arm64)
                ...
                .Invoke(
                    null,
                    new object[] { AdvSimd.LoadVector64((Int16*)(_dataTable.inArray1Ptr)) }
                );
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.Arm64.ExtractNarrowingSaturateUnsignedScalar(_clsVar1);
        ...
        public void RunClassLclFldScenario_Load()
        {
            ...
            fixed (Vector64<Int16>* pFld1 = &test._fld1)
            {
                var result = AdvSimd
                    .Arm64
                    .ExtractNarrowingSaturateUnsignedScalar(AdvSimd.LoadVector64((Int16*)(pFld1)));
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.ExtractNarrowingSaturateUnsignedScalar)}<Byte>(Vector64<Int16>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
