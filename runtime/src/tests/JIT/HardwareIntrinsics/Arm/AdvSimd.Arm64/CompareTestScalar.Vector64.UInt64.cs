    ...
    public sealed unsafe class SimpleBinaryOpTest__CompareTestScalar_Vector64_UInt64
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__CompareTestScalar_Vector64_UInt64 testClass
            )
            {
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.CompareTestScalar)}<UInt64>(Vector64<UInt64>, Vector64<UInt64>): {method} failed:"
                    );
