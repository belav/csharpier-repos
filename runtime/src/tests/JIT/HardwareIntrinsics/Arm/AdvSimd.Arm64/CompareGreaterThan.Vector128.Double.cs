...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void CompareGreaterThan_Vector128_Double()
        {
            var test = new SimpleBinaryOpTest__CompareGreaterThan_Vector128_Double();
    ...
    public sealed unsafe class SimpleBinaryOpTest__CompareGreaterThan_Vector128_Double
    {
        ...
        private struct TestStruct
        {
            ...
            public static TestStruct Create()
            {
                ...
                Unsafe.CopyBlockUnaligned(
                    ref Unsafe.As<Vector128<Double>, byte>(ref testStruct._fld2),
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__CompareGreaterThan_Vector128_Double testClass
            ) {
                var result = AdvSimd.Arm64.CompareGreaterThan(_fld1, _fld2);
            ...
            public void RunStructFldScenario_Load(
                ...
                {
                    var result = AdvSimd.Arm64.CompareGreaterThan(
        ...
        static SimpleBinaryOpTest__CompareGreaterThan_Vector128_Double()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetDouble();
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector128<Double>, byte>(ref _clsVar2),
                ref Unsafe.As<Double, byte>(ref _data2[0]),
                (uint)Unsafe.SizeOf<Vector128<Double>>()
            );
        }

        public SimpleBinaryOpTest__CompareGreaterThan_Vector128_Double()
        {
            Succeeded = true;
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector128<Double>, byte>(ref _fld2),
                ref Unsafe.As<Double, byte>(ref _data2[0]),
                (uint)Unsafe.SizeOf<Vector128<Double>>()
            );
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64).GetMethod(
                    nameof(AdvSimd.Arm64.CompareGreaterThan),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.Arm64.CompareGreaterThan(_clsVar1, _clsVar2);
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.Arm64.CompareGreaterThan(op1, op2);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimpleBinaryOpTest__CompareGreaterThan_Vector128_Double();
            var result = AdvSimd.Arm64.CompareGreaterThan(test._fld1, test._fld2);
        ...
        private void ValidateResult(
            ...
            {
                if (
                    BitConverter.DoubleToInt64Bits(Helpers.CompareGreaterThan(left[i], right[i]))
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.CompareGreaterThan)}<Double>(Vector128<Double>, Vector128<Double>): {method} failed:"
                );
