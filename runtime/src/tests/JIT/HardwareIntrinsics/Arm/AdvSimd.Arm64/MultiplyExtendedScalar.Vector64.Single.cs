...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void MultiplyExtendedScalar_Vector64_Single()
        {
            var test = new SimpleBinaryOpTest__MultiplyExtendedScalar_Vector64_Single();
    ...
    public sealed unsafe class SimpleBinaryOpTest__MultiplyExtendedScalar_Vector64_Single
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__MultiplyExtendedScalar_Vector64_Single testClass
            )
            {
                var result = AdvSimd.Arm64.MultiplyExtendedScalar(_fld1, _fld2);
            ...
            )
            {
                ...
                {
                    var result = AdvSimd.Arm64.MultiplyExtendedScalar(
        ...
        static SimpleBinaryOpTest__MultiplyExtendedScalar_Vector64_Single()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetSingle();
        ...
        public SimpleBinaryOpTest__MultiplyExtendedScalar_Vector64_Single()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64).GetMethod(
                    nameof(AdvSimd.Arm64.MultiplyExtendedScalar),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.Arm64.MultiplyExtendedScalar(_clsVar1, _clsVar2);
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.Arm64.MultiplyExtendedScalar(op1, op2);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimpleBinaryOpTest__MultiplyExtendedScalar_Vector64_Single();
            var result = AdvSimd.Arm64.MultiplyExtendedScalar(test._fld1, test._fld2);
        ...
        )
        {
            ...
            if (
                BitConverter.SingleToInt32Bits(Helpers.MultiplyExtended(left[0], right[0]))
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.MultiplyExtendedScalar)}<Single>(Vector64<Single>, Vector64<Single>): {method} failed:"
                );
