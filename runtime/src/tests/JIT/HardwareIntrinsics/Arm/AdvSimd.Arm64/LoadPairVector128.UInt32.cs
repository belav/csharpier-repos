...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void LoadPairVector128_UInt32()
        {
            var test = new LoadPairVector128_UInt32();
    ...
    public sealed unsafe class LoadPairVector128_UInt32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(LoadPairVector128_UInt32 testClass)
            {
                _fld = AdvSimd.Arm64.LoadPairVector128((UInt32*)(testClass._dataTable.inArrayPtr));
        ...
        public LoadPairVector128_UInt32()
        {
            Succeeded = true;
        ...
        public void RunBasicScenario()
        {
            ...
            var result = AdvSimd.Arm64.LoadPairVector128((UInt32*)(_dataTable.inArrayPtr));
        ...
        public void RunReflectionScenario()
        {
            ...
            var result = typeof(AdvSimd.Arm64)
                .GetMethod(nameof(AdvSimd.Arm64.LoadPairVector128), new Type[] { typeof(UInt32*) })
        ...
        public void RunClsVarScenario()
        {
            ...
            _clsVar = AdvSimd.Arm64.LoadPairVector128((UInt32*)(_dataTable.inArrayPtr));
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.LoadPairVector128)}<UInt32>(Vector128<UInt32>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
