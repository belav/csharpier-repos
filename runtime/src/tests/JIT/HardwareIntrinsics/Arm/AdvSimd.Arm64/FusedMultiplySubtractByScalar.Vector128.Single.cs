    ...
    public sealed unsafe class SimpleTernaryOpTest__FusedMultiplySubtractByScalar_Vector128_Single
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleTernaryOpTest__FusedMultiplySubtractByScalar_Vector128_Single testClass
            )
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64)
                .GetMethod(
                    nameof(AdvSimd.Arm64.FusedMultiplySubtractByScalar),
                    new Type[]
                    {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.Arm64.FusedMultiplySubtractByScalar(_clsVar1, _clsVar2, _clsVar3);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var result = AdvSimd
                .Arm64
                .FusedMultiplySubtractByScalar(test._fld1, test._fld2, test._fld3);
        ...
        )
        {
            ...
            for (var i = 0; i < RetElementCount; i++)
            {
                if (
                    BitConverter.SingleToInt32Bits(
                        Helpers.FusedMultiplySubtract(firstOp[i], secondOp[i], thirdOp[0])
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.FusedMultiplySubtractByScalar)}<Single>(Vector128<Single>, Vector128<Single>, Vector64<Single>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
