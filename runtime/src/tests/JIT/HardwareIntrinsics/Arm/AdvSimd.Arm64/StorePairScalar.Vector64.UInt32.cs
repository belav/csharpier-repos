...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void StorePairScalar_Vector64_UInt32()
        {
    ...
    public sealed unsafe class StoreBinaryOpTest__StorePairScalar_Vector64_UInt32
    {
        ...
        private struct TestStruct
        {
            ...
            )
            {
                AdvSimd
                    .Arm64
                    .StorePairScalar((UInt32*)testClass._dataTable.outArrayPtr, _fld1, _fld2);
        ...
        static StoreBinaryOpTest__StorePairScalar_Vector64_UInt32()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetUInt32();
        ...
        public StoreBinaryOpTest__StorePairScalar_Vector64_UInt32()
        {
            Succeeded = true;
        ...
        public void RunClsVarScenario()
        {
            ...
            AdvSimd.Arm64.StorePairScalar((UInt32*)_dataTable.outArrayPtr, _clsVar1, _clsVar2);
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            AdvSimd.Arm64.StorePairScalar((UInt32*)_dataTable.outArrayPtr, op1, op2);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new StoreBinaryOpTest__StorePairScalar_Vector64_UInt32();
            AdvSimd.Arm64.StorePairScalar((UInt32*)_dataTable.outArrayPtr, test._fld1, test._fld2);
        ...
        public void RunClassFldScenario()
        {
            ...
            AdvSimd.Arm64.StorePairScalar((UInt32*)_dataTable.outArrayPtr, _fld1, _fld2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.StorePairScalar)}<UInt32>(Vector64<UInt32>, Vector64<UInt32>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
