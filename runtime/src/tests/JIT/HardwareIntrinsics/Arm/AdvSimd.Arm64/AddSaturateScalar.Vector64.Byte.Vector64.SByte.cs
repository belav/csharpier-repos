...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void AddSaturateScalar_Vector64_Byte_Vector64_SByte()
        {
            var test = new SimpleBinaryOpTest__AddSaturateScalar_Vector64_Byte_Vector64_SByte();
    ...
    public sealed unsafe class SimpleBinaryOpTest__AddSaturateScalar_Vector64_Byte_Vector64_SByte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__AddSaturateScalar_Vector64_Byte_Vector64_SByte testClass
            )
            {
        ...
        static SimpleBinaryOpTest__AddSaturateScalar_Vector64_Byte_Vector64_SByte()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetByte();
        ...
        public SimpleBinaryOpTest__AddSaturateScalar_Vector64_Byte_Vector64_SByte()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64)
                .GetMethod(
                    nameof(AdvSimd.Arm64.AddSaturateScalar),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.Arm64.AddSaturateScalar(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.AddSaturateScalar)}<Byte>(Vector64<Byte>, Vector64<SByte>): {method} failed:"
                    );
