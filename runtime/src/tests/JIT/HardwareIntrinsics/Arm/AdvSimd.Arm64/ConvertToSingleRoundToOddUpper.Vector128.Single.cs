    ...
    public sealed unsafe class SimpleBinaryOpTest__ConvertToSingleRoundToOddUpper_Vector128_Single
    {
        ...
        private struct TestStruct
        {
            ...
            public static TestStruct Create()
            {
                ...
                {
                    _data1[i] = BitConverter.Int32BitsToSingle(0x3FCF213E);
                }
                Unsafe.CopyBlockUnaligned(
                ...
                {
                    _data2[i] = BitConverter.Int64BitsToDouble(0x3FF9E427C7C5260FL);
                }
                Unsafe.CopyBlockUnaligned(
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__ConvertToSingleRoundToOddUpper_Vector128_Single testClass
            ) {
            ...
            public void RunStructFldScenario_Load(
                ...
                fixed (Vector64<Single>* pFld1 = &_fld1)fixed (Vector128<Double>* pFld2 = &_fld2)
                {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64).GetMethod(
                    nameof(AdvSimd.Arm64.ConvertToSingleRoundToOddUpper),
                    new Type[] { typeof(Vector64<Single>), typeof(Vector128<Double>) }
                )
                .Invoke(
                    null,
                    new object[]
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.Arm64.ConvertToSingleRoundToOddUpper(_clsVar1, _clsVar2);
        ...
        private void ValidateResult(
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.ConvertToSingleRoundToOddUpper)}<Single>(Vector64<Single>, Vector128<Double>): {method} failed:"
                );
