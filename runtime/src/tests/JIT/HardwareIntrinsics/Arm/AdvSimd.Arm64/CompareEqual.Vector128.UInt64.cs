...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void CompareEqual_Vector128_UInt64()
        {
            var test = new SimpleBinaryOpTest__CompareEqual_Vector128_UInt64();
    ...
    public sealed unsafe class SimpleBinaryOpTest__CompareEqual_Vector128_UInt64
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__CompareEqual_Vector128_UInt64 testClass
            ) {
                var result = AdvSimd.Arm64.CompareEqual(_fld1, _fld2);
            ...
            public void RunStructFldScenario_Load(
                ...
                {
                    var result = AdvSimd.Arm64.CompareEqual(
        ...
        static SimpleBinaryOpTest__CompareEqual_Vector128_UInt64()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetUInt64();
        ...
        public SimpleBinaryOpTest__CompareEqual_Vector128_UInt64()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd.Arm64).GetMethod(
                    nameof(AdvSimd.Arm64.CompareEqual),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.Arm64.CompareEqual(_clsVar1, _clsVar2);
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.Arm64.CompareEqual(op1, op2);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimpleBinaryOpTest__CompareEqual_Vector128_UInt64();
            var result = AdvSimd.Arm64.CompareEqual(test._fld1, test._fld2);
        ...
        private void ValidateResult(
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd.Arm64)}.{nameof(AdvSimd.Arm64.CompareEqual)}<UInt64>(Vector128<UInt64>, Vector128<UInt64>): {method} failed:"
                );
