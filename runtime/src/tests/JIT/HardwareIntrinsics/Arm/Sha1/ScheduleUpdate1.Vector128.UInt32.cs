    ...
    public sealed unsafe class SecureHashBinaryOpTest__ScheduleUpdate1_Vector128_UInt32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SecureHashBinaryOpTest__ScheduleUpdate1_Vector128_UInt32 testClass
            )
            {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Sha1.ScheduleUpdate1(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Sha1)}.{nameof(Sha1.ScheduleUpdate1)}<UInt32>(Vector128<UInt32>, Vector128<UInt32>): {method} failed:"
                    );
