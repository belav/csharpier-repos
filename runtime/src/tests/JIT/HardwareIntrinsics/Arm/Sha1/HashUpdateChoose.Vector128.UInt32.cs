    ...
    public sealed unsafe class SecureHashTernaryOpTest__HashUpdateChoose_Vector128_UInt32
    {
        ...
        private struct TestStruct
        {
            ...
            public static TestStruct Create()
            {
                ...
                Unsafe.CopyBlockUnaligned(
                    ref Unsafe.As<Vector128<UInt32>, byte>(ref testStruct._fld3),
            ...
            public void RunStructFldScenario(
                SecureHashTernaryOpTest__HashUpdateChoose_Vector128_UInt32 testClass
            )
            {
        ...
        static SecureHashTernaryOpTest__HashUpdateChoose_Vector128_UInt32()
        {
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector128<UInt32>, byte>(ref _clsVar3),
                ref Unsafe.As<UInt32, byte>(ref _data3[0]),
                (uint)Unsafe.SizeOf<Vector128<UInt32>>()
            );
        }
        ...
        public SecureHashTernaryOpTest__HashUpdateChoose_Vector128_UInt32()
        {
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector128<UInt32>, byte>(ref _fld3),
                ref Unsafe.As<UInt32, byte>(ref _data3[0]),
                (uint)Unsafe.SizeOf<Vector128<UInt32>>()
            );
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Sha1.HashUpdateChoose(_clsVar1, _clsVar2, _clsVar3);
        ...
        public void RunClassFldScenario_Load()
        {
            ...
            fixed (Vector128<UInt32>* pFld1 = &_fld1)fixed (Vector64<UInt32>* pFld2 = &_fld2)fixed (
                Vector128<UInt32>* pFld3 = &_fld3
            )
            {
                var result = Sha1.HashUpdateChoose(
                    AdvSimd.LoadVector128((UInt32*)(pFld1)),
        ...
        )
        {
            ...
            UInt32[] expectedResult = new UInt32[]
            {
                0x27A38C6D,
                0xEFEFCA67,
                0xDB4E8169,
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(Sha1)}.{nameof(Sha1.HashUpdateChoose)}<UInt32>(Vector128<UInt32>, Vector64<UInt32>, Vector128<UInt32>): {method} failed:"
                );
                TestLibrary.TestFramework.LogInformation(
