    ...
    public sealed unsafe class SecureHashTernaryOpTest__ScheduleUpdate0_Vector128_UInt32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SecureHashTernaryOpTest__ScheduleUpdate0_Vector128_UInt32 testClass
            )
            {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Sha1.ScheduleUpdate0(_clsVar1, _clsVar2, _clsVar3);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Sha1)}.{nameof(Sha1.ScheduleUpdate0)}<UInt32>(Vector128<UInt32>, Vector128<UInt32>, Vector128<UInt32>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
