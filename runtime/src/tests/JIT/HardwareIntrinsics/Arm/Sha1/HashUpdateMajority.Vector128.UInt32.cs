    ...
    public sealed unsafe class SecureHashTernaryOpTest__HashUpdateMajority_Vector128_UInt32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SecureHashTernaryOpTest__HashUpdateMajority_Vector128_UInt32 testClass
            )
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Sha1)
                .GetMethod(
                    nameof(Sha1.HashUpdateMajority),
                    new Type[]
                    {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Sha1.HashUpdateMajority(_clsVar1, _clsVar2, _clsVar3);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Sha1)}.{nameof(Sha1.HashUpdateMajority)}<UInt32>(Vector128<UInt32>, Vector64<UInt32>, Vector128<UInt32>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
