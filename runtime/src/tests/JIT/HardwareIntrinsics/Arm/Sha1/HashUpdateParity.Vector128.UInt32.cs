    ...
    public sealed unsafe class SecureHashTernaryOpTest__HashUpdateParity_Vector128_UInt32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SecureHashTernaryOpTest__HashUpdateParity_Vector128_UInt32 testClass
            )
            {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Sha1.HashUpdateParity(_clsVar1, _clsVar2, _clsVar3);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Sha1)}.{nameof(Sha1.HashUpdateParity)}<UInt32>(Vector128<UInt32>, Vector64<UInt32>, Vector128<UInt32>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
