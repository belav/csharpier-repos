    ...
    public sealed unsafe class SecureHashUnaryOpTest__FixedRotate_Vector64_UInt32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SecureHashUnaryOpTest__FixedRotate_Vector64_UInt32 testClass
            )
            {
            ...
            )
            {
                ...
                {
                    var result = Sha1.FixedRotate(AdvSimd.LoadVector64((UInt32*)(pFld1)));
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = Sha1.FixedRotate(Unsafe.Read<Vector64<UInt32>>(_dataTable.inArray1Ptr));
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var result = Sha1.FixedRotate(AdvSimd.LoadVector64((UInt32*)(_dataTable.inArray1Ptr)));
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Sha1.FixedRotate(_clsVar1);
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            {
                var result = Sha1.FixedRotate(AdvSimd.LoadVector64((UInt32*)(pClsVar1)));
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = Sha1.FixedRotate(AdvSimd.LoadVector64((UInt32*)(&test._fld1)));
