...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ComputeCrc32_UInt64()
        {
            var test = new ScalarBinaryOpTest__ComputeCrc32_UInt64();
    ...
    public sealed unsafe class ScalarBinaryOpTest__ComputeCrc32_UInt64
    {
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(ScalarBinaryOpTest__ComputeCrc32_UInt64 testClass)
            {
                var result = Crc32.Arm64.ComputeCrc32(_fld1, _fld2);
        ...
        static ScalarBinaryOpTest__ComputeCrc32_UInt64()
        {
            _clsVar1 = 0xFFFFFFFF;
            _clsVar2 = 0x20191113110219UL;
        }

        public ScalarBinaryOpTest__ComputeCrc32_UInt64()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Crc32.Arm64)
                .GetMethod(
                    nameof(Crc32.Arm64.ComputeCrc32),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Crc32.Arm64.ComputeCrc32(_clsVar1, _clsVar2);
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = Crc32.Arm64.ComputeCrc32(data1, data2);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new ScalarBinaryOpTest__ComputeCrc32_UInt64();
            var result = Crc32.Arm64.ComputeCrc32(test._fld1, test._fld2);
        ...
        )
        {
            ...
            uint expectedResult = 0xEFAAAB74;
