...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    public sealed unsafe class LoadUnaryOpTest__LoadAndReplicateToVector128_UInt16
    {
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var result = AdvSimd.LoadAndReplicateToVector128((UInt16*)(_dataTable.inArray1Ptr));
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.LoadAndReplicateToVector128)}<UInt16>(Vector128<UInt16>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
