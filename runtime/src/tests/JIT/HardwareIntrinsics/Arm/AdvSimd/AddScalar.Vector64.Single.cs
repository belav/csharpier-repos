...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void AddScalar_Vector64_Single()
        {
            var test = new SimpleBinaryOpTest__AddScalar_Vector64_Single();
    ...
    public sealed unsafe class SimpleBinaryOpTest__AddScalar_Vector64_Single
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__AddScalar_Vector64_Single testClass
            )
            {
        ...
        static SimpleBinaryOpTest__AddScalar_Vector64_Single()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetSingle();
        ...
        public SimpleBinaryOpTest__AddScalar_Vector64_Single()
        {
            Succeeded = true;
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.AddScalar(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (
                BitConverter.SingleToInt32Bits(Helpers.Add(left[0], right[0]))
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.AddScalar)}<Single>(Vector64<Single>, Vector64<Single>): {method} failed:"
                    );
