    ...
    public sealed unsafe class SimpleBinaryOpTest__AddWideningLower_Vector128_Int64
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__AddWideningLower_Vector128_Int64 testClass
            )
            {
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.AddWideningLower)}<Int64>(Vector128<Int64>, Vector64<Int32>): {method} failed:"
                    );
