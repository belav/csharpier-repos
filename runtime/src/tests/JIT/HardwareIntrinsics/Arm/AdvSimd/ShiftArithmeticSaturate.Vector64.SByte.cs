...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ShiftArithmeticSaturate_Vector64_SByte()
        {
    ...
    public sealed unsafe class SimpleBinaryOpTest__ShiftArithmeticSaturate_Vector64_SByte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__ShiftArithmeticSaturate_Vector64_SByte testClass
            )
            {
                var result = AdvSimd.ShiftArithmeticSaturate(_fld1, _fld2);
            ...
            )
            {
                ...
                {
                    var result = AdvSimd.ShiftArithmeticSaturate(
        ...
        static SimpleBinaryOpTest__ShiftArithmeticSaturate_Vector64_SByte()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetSByte();
        ...
        public SimpleBinaryOpTest__ShiftArithmeticSaturate_Vector64_SByte()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(
                    nameof(AdvSimd.ShiftArithmeticSaturate),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.ShiftArithmeticSaturate(_clsVar1, _clsVar2);
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.ShiftArithmeticSaturate(op1, op2);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimpleBinaryOpTest__ShiftArithmeticSaturate_Vector64_SByte();
            var result = AdvSimd.ShiftArithmeticSaturate(test._fld1, test._fld2);
        ...
        )
        {
            ...
            {
                if (Helpers.ShiftArithmeticSaturate(left[i], right[i]) != result[i])
                {
                    succeeded = false;
                    break;
                }
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd)}.{nameof(AdvSimd.ShiftArithmeticSaturate)}<SByte>(Vector64<SByte>, Vector64<SByte>): {method} failed:"
                );
