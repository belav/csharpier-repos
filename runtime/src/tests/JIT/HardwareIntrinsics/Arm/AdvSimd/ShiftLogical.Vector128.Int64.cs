    ...
    public sealed unsafe class SimpleBinaryOpTest__ShiftLogical_Vector128_Int64
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__ShiftLogical_Vector128_Int64 testClass
            )
            {
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ShiftLogical)}<Int64>(Vector128<Int64>, Vector128<Int64>): {method} failed:"
                    );
