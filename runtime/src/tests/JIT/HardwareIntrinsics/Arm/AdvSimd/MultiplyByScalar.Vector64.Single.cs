    ...
    public sealed unsafe class SimpleBinaryOpTest__MultiplyByScalar_Vector64_Single
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__MultiplyByScalar_Vector64_Single testClass
            )
            {
        ...
        )
        {
            ...
            {
                if (
                    BitConverter.SingleToInt32Bits(Helpers.Multiply(left[i], right[0]))
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.MultiplyByScalar)}<Single>(Vector64<Single>, Vector64<Single>): {method} failed:"
                    );
