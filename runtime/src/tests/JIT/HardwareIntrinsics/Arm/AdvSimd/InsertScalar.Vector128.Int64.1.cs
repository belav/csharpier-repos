    ...
    public sealed unsafe class InsertScalarTest__InsertScalar_Vector128_Int64_1
    {
        ...
        private struct TestStruct
        {
            ...
            public static TestStruct Create()
            {
                ...
                Unsafe.CopyBlockUnaligned(
                    ref Unsafe.As<Vector64<Int64>, byte>(ref testStruct._fld3),
            ...
            public void RunStructFldScenario(
                InsertScalarTest__InsertScalar_Vector128_Int64_1 testClass
            )
            {
            ...
            {
                fixed (Vector128<Int64>* pFld1 = &_fld1)fixed (Vector64<Int64>* pFld2 = &_fld3)
                {
        ...
        static InsertScalarTest__InsertScalar_Vector128_Int64_1()
        {
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector64<Int64>, byte>(ref _clsVar3),
                ref Unsafe.As<Int64, byte>(ref _data3[0]),
                (uint)Unsafe.SizeOf<Vector64<Int64>>()
            );
        }
        ...
        public InsertScalarTest__InsertScalar_Vector128_Int64_1()
        {
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector64<Int64>, byte>(ref _fld3),
                ref Unsafe.As<Int64, byte>(ref _data3[0]),
                (uint)Unsafe.SizeOf<Vector64<Int64>>()
            );
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(
                    nameof(AdvSimd.InsertScalar),
                    new Type[] { typeof(Vector128<Int64>), typeof(byte), typeof(Vector64<Int64>) }
                )
                .Invoke(
                    null,
                    new object[]
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.InsertScalar(_clsVar1, 1, _clsVar3);
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            fixed (Vector128<Int64>* pClsVar1 = &_clsVar1)fixed (
                Vector64<Int64>* pClsVar3 = &_clsVar3
            )
            {
                var result = AdvSimd.InsertScalar(
        ...
        public void RunClassLclFldScenario_Load()
        {
            ...
            fixed (Vector128<Int64>* pFld1 = &test._fld1)fixed (
                Vector64<Int64>* pFld2 = &test._fld3
            )
            {
                var result = AdvSimd.InsertScalar(
                    AdvSimd.LoadVector128((Int64*)pFld1),
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd)}.{nameof(AdvSimd.InsertScalar)}<Int64>(Vector128<Int64>, 1, Vector64<Int64>): {method} failed:"
                );
                TestLibrary.TestFramework.LogInformation(
