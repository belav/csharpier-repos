    ...
    public sealed unsafe class SimpleUnaryOpTest__RoundToNearest_Vector128_Single
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__RoundToNearest_Vector128_Single testClass
            )
            {
            ...
            )
            {
                ...
                {
                    var result = AdvSimd.RoundToNearest(AdvSimd.LoadVector128((Single*)(pFld1)));
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(nameof(AdvSimd.RoundToNearest), new Type[] { typeof(Vector128<Single>) })
                .Invoke(
                    null,
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.RoundToNearest(_clsVar1);
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            {
                var result = AdvSimd.RoundToNearest(AdvSimd.LoadVector128((Single*)(pClsVar1)));
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = AdvSimd.RoundToNearest(AdvSimd.LoadVector128((Single*)(&test._fld1)));
        ...
        )
        {
            ...
            {
                if (
                    BitConverter.SingleToInt32Bits(Helpers.RoundToNearest(firstOp[i]))
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.RoundToNearest)}<Single>(Vector128<Single>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
