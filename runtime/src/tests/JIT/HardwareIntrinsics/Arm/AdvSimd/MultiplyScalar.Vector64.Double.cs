...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void MultiplyScalar_Vector64_Double()
        {
            var test = new SimpleBinaryOpTest__MultiplyScalar_Vector64_Double();
    ...
    public sealed unsafe class SimpleBinaryOpTest__MultiplyScalar_Vector64_Double
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__MultiplyScalar_Vector64_Double testClass
            )
            {
        ...
        static SimpleBinaryOpTest__MultiplyScalar_Vector64_Double()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetDouble();
        ...
        public SimpleBinaryOpTest__MultiplyScalar_Vector64_Double()
        {
            Succeeded = true;
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.MultiplyScalar(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (
                BitConverter.DoubleToInt64Bits(Helpers.Multiply(left[0], right[0]))
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.MultiplyScalar)}<Double>(Vector64<Double>, Vector64<Double>): {method} failed:"
                    );
