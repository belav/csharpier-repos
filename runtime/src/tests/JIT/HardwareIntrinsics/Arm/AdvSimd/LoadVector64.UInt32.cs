...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void LoadVector64_UInt32()
        {
            var test = new LoadUnaryOpTest__LoadVector64_UInt32();
    ...
    public sealed unsafe class LoadUnaryOpTest__LoadVector64_UInt32
    {
        ...
        public LoadUnaryOpTest__LoadVector64_UInt32()
        {
            Succeeded = true;
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var result = AdvSimd.LoadVector64((UInt32*)(_dataTable.inArray1Ptr));
        ...
        public void RunReflectionScenario_Load()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(nameof(AdvSimd.LoadVector64), new Type[] { typeof(UInt32*) })
                .Invoke(
                    null,
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.LoadVector64)}<UInt32>(Vector64<UInt32>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
