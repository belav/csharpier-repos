...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ShiftRightArithmetic_Vector64_SByte_1()
        {
            var test = new ImmUnaryOpTest__ShiftRightArithmetic_Vector64_SByte_1();
    ...
    public sealed unsafe class ImmUnaryOpTest__ShiftRightArithmetic_Vector64_SByte_1
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                ImmUnaryOpTest__ShiftRightArithmetic_Vector64_SByte_1 testClass
            )
            {
        ...
        static ImmUnaryOpTest__ShiftRightArithmetic_Vector64_SByte_1()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data[i] = TestLibrary.Generator.GetSByte();
        ...
        public ImmUnaryOpTest__ShiftRightArithmetic_Vector64_SByte_1()
        {
            Succeeded = true;
        ...
        public void RunClassLclFldScenario_Load()
        {
            ...
            {
                var result = AdvSimd.ShiftRightArithmetic(AdvSimd.LoadVector64((SByte*)(pFld)), 1);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ShiftRightArithmetic)}<SByte>(Vector64<SByte>, 1): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
