...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void AddHighNarrowingUpper_Vector128_UInt16()
        {
            var test = new SimpleTernaryOpTest__AddHighNarrowingUpper_Vector128_UInt16();
    ...
    public sealed unsafe class SimpleTernaryOpTest__AddHighNarrowingUpper_Vector128_UInt16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleTernaryOpTest__AddHighNarrowingUpper_Vector128_UInt16 testClass
            )
            {
        ...
        public SimpleTernaryOpTest__AddHighNarrowingUpper_Vector128_UInt16()
        {
            Succeeded = true;
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.AddHighNarrowingUpper)}<UInt16>(Vector64<UInt16>, Vector128<UInt32>, Vector128<UInt32>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
