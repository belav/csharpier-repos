    ...
    public sealed unsafe class SimpleBinaryOpTest__AddHighNarrowingLower_Vector64_SByte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__AddHighNarrowingLower_Vector64_SByte testClass
            )
            {
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.AddHighNarrowingLower)}<SByte>(Vector128<Int16>, Vector128<Int16>): {method} failed:"
                    );
