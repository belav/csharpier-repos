...
namespace JIT.HardwareIntrinsics.Arm
{
    public static partial class Program
    {
        ...
        {
            var test =
                new ImmBinaryOpTest__MultiplyBySelectedScalar_Vector128_Int32_Vector64_Int32_1();
    ...
    public sealed unsafe class ImmBinaryOpTest__MultiplyBySelectedScalar_Vector128_Int32_Vector64_Int32_1
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                ImmBinaryOpTest__MultiplyBySelectedScalar_Vector128_Int32_Vector64_Int32_1 testClass
            )
            {
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.MultiplyBySelectedScalar)}<Int32>(Vector128<Int32>, Vector64<Int32>, 1): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
