...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ShiftRightLogicalScalar_Vector64_Int64_1()
        {
            var test = new ImmUnaryOpTest__ShiftRightLogicalScalar_Vector64_Int64_1();
    ...
    public sealed unsafe class ImmUnaryOpTest__ShiftRightLogicalScalar_Vector64_Int64_1
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                ImmUnaryOpTest__ShiftRightLogicalScalar_Vector64_Int64_1 testClass
            )
            {
                var result = AdvSimd.ShiftRightLogicalScalar(_fld, 1);
            ...
            )
            {
                ...
                {
                    var result = AdvSimd.ShiftRightLogicalScalar(
        ...
        static ImmUnaryOpTest__ShiftRightLogicalScalar_Vector64_Int64_1()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data[i] = TestLibrary.Generator.GetInt64();
        ...
        public ImmUnaryOpTest__ShiftRightLogicalScalar_Vector64_Int64_1()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(
                    nameof(AdvSimd.ShiftRightLogicalScalar),
                    new Type[] { typeof(Vector64<Int64>), typeof(byte) }
                )
                .Invoke(
                    null,
                    new object[] { Unsafe.Read<Vector64<Int64>>(_dataTable.inArrayPtr), (byte)1 }
                );
        ...
        public void RunReflectionScenario_Load()
        {
            ...
            var result = typeof(AdvSimd)
                ...
                .Invoke(
                    null,
                    new object[] { AdvSimd.LoadVector64((Int64*)(_dataTable.inArrayPtr)), (byte)1 }
                );
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.ShiftRightLogicalScalar(_clsVar, 1);
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.ShiftRightLogicalScalar(firstOp, 1);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new ImmUnaryOpTest__ShiftRightLogicalScalar_Vector64_Int64_1();
            var result = AdvSimd.ShiftRightLogicalScalar(test._fld, 1);
        ...
        )
        {
            ...
            if (Helpers.ShiftRightLogical(firstOp[0], Imm) != result[0])
            {
                succeeded = false;
            }
            else
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ShiftRightLogicalScalar)}<Int64>(Vector64<Int64>, 1): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
