...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ShiftLeftLogicalSaturateUnsigned_Vector128_Int64_1()
        {
            var test = new ImmUnaryOpTest__ShiftLeftLogicalSaturateUnsigned_Vector128_Int64_1();
    ...
    public sealed unsafe class ImmUnaryOpTest__ShiftLeftLogicalSaturateUnsigned_Vector128_Int64_1
    {
        private struct DataTable
        {
            ...
            public DataTable(Int64[] inArray, UInt64[] outArray, int alignment)
            {
        ...
        private struct TestStruct
        {
            ...
            public static TestStruct Create()
            {
                ...
                Unsafe.CopyBlockUnaligned(
                    ref Unsafe.As<Vector128<Int64>, byte>(ref testStruct._fld),
            ...
            public void RunStructFldScenario(
                ImmUnaryOpTest__ShiftLeftLogicalSaturateUnsigned_Vector128_Int64_1 testClass
            )
            {
        ...
        static ImmUnaryOpTest__ShiftLeftLogicalSaturateUnsigned_Vector128_Int64_1()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data[i] = TestLibrary.Generator.GetInt64();
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector128<Int64>, byte>(ref _clsVar),
                ref Unsafe.As<Int64, byte>(ref _data[0]),
                (uint)Unsafe.SizeOf<Vector128<Int64>>()
            );
        }

        public ImmUnaryOpTest__ShiftLeftLogicalSaturateUnsigned_Vector128_Int64_1()
        {
            Succeeded = true;
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector128<Int64>, byte>(ref _fld),
                ref Unsafe.As<Int64, byte>(ref _data[0]),
                (uint)Unsafe.SizeOf<Vector128<Int64>>()
            );
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(
                    nameof(AdvSimd.ShiftLeftLogicalSaturateUnsigned),
                    new Type[] { typeof(Vector128<Int64>), typeof(byte) }
                )
                .Invoke(
                    null,
                    new object[] { Unsafe.Read<Vector128<Int64>>(_dataTable.inArrayPtr), (byte)1 }
                );
        ...
        public void RunReflectionScenario_Load()
        {
            ...
            var result = typeof(AdvSimd)
                ...
                .Invoke(
                    null,
                    new object[] { AdvSimd.LoadVector128((Int64*)(_dataTable.inArrayPtr)), (byte)1 }
                );
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.ShiftLeftLogicalSaturateUnsigned(_clsVar, 1);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ShiftLeftLogicalSaturateUnsigned)}<UInt64>(Vector128<Int64>, 1): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
