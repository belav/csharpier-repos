    ...
    public sealed unsafe class SimpleBinaryOpTest__MinNumberScalar_Vector64_Single
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__MinNumberScalar_Vector64_Single testClass
            )
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(
                    nameof(AdvSimd.MinNumberScalar),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.MinNumberScalar(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (
                BitConverter.SingleToInt32Bits(Helpers.MinNumber(left[0], right[0]))
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.MinNumberScalar)}<Single>(Vector64<Single>, Vector64<Single>): {method} failed:"
                    );
