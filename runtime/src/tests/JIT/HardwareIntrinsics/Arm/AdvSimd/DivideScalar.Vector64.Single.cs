    ...
    public sealed unsafe class SimpleBinaryOpTest__DivideScalar_Vector64_Single
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__DivideScalar_Vector64_Single testClass
            )
            {
        ...
        )
        {
            ...
            if (
                BitConverter.SingleToInt32Bits(Helpers.Divide(left[0], right[0]))
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.DivideScalar)}<Single>(Vector64<Single>, Vector64<Single>): {method} failed:"
                    );
