    ...
    public sealed unsafe class SimpleUnaryOpTest__AddPairwiseWidening_Vector64_Int16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__AddPairwiseWidening_Vector64_Int16 testClass
            )
            {
            ...
            )
            {
                ...
                {
                    var result = AdvSimd.AddPairwiseWidening(AdvSimd.LoadVector64((Int16*)(pFld1)));
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            {
                var result = AdvSimd.AddPairwiseWidening(AdvSimd.LoadVector64((Int16*)(pClsVar1)));
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = AdvSimd.AddPairwiseWidening(AdvSimd.LoadVector64((Int16*)(&test._fld1)));
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.AddPairwiseWidening)}<Int32>(Vector64<Int16>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
