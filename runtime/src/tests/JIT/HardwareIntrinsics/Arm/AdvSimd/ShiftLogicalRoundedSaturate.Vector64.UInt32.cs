...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ShiftLogicalRoundedSaturate_Vector64_UInt32()
        {
    ...
    public sealed unsafe class SimpleBinaryOpTest__ShiftLogicalRoundedSaturate_Vector64_UInt32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__ShiftLogicalRoundedSaturate_Vector64_UInt32 testClass
            ) {
            ...
            public void RunStructFldScenario_Load(
                ...
                fixed (Vector64<UInt32>* pFld1 = &_fld1)fixed (Vector64<Int32>* pFld2 = &_fld2)
                {
        ...
        static SimpleBinaryOpTest__ShiftLogicalRoundedSaturate_Vector64_UInt32()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetUInt32();
        ...
        public SimpleBinaryOpTest__ShiftLogicalRoundedSaturate_Vector64_UInt32()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(
                    ...
                    new Type[] { typeof(Vector64<UInt32>), typeof(Vector64<Int32>) }
                )
                .Invoke(
                    null,
                    new object[]
        ...
        private void ValidateResult(
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd)}.{nameof(AdvSimd.ShiftLogicalRoundedSaturate)}<UInt32>(Vector64<UInt32>, Vector64<Int32>): {method} failed:"
                );
