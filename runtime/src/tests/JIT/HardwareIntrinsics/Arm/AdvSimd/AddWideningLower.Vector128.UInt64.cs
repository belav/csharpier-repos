    ...
    public sealed unsafe class SimpleBinaryOpTest__AddWideningLower_Vector128_UInt64
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__AddWideningLower_Vector128_UInt64 testClass
            ) {
            ...
            public void RunStructFldScenario_Load(
                ...
                fixed (Vector128<UInt64>* pFld1 = &_fld1)fixed (Vector64<UInt32>* pFld2 = &_fld2)
                {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(
                    ...
                    new Type[] { typeof(Vector128<UInt64>), typeof(Vector64<UInt32>) }
                )
                .Invoke(
                    null,
                    new object[]
        ...
        private void ValidateResult(
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd)}.{nameof(AdvSimd.AddWideningLower)}<UInt64>(Vector128<UInt64>, Vector64<UInt32>): {method} failed:"
                );
