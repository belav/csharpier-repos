...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void Extract_Vector128_UInt64_1()
        {
            var test = new ExtractTest__Extract_Vector128_UInt64_1();
    ...
    public sealed unsafe class ExtractTest__Extract_Vector128_UInt64_1
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(ExtractTest__Extract_Vector128_UInt64_1 testClass)
            {
            ...
            public void RunStructFldScenario_Load(ExtractTest__Extract_Vector128_UInt64_1 testClass)
            {
        ...
        static ExtractTest__Extract_Vector128_UInt64_1()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetUInt64();
        ...
        public ExtractTest__Extract_Vector128_UInt64_1()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            ValidateResult(_dataTable.inArray1Ptr, (UInt64)result);
        }
        ...
        public void RunClassLclFldScenario_Load()
        {
            ...
            {
                var result = AdvSimd.Extract(AdvSimd.LoadVector128((UInt64*)(pFld1)), ElementIndex);
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = AdvSimd.Extract(AdvSimd.LoadVector128((UInt64*)&test._fld1), ElementIndex);
        ...
        private void ValidateResult(void* op1, UInt64 result, [CallerMemberName] string method = "")
        {
            UInt64[] inArray1 = new UInt64[Op1ElementCount];
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.Extract)}(Vector128<UInt64>, 1): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
