    ...
    public sealed unsafe class SimpleTernaryOpTest__BitwiseSelect_Vector128_Byte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleTernaryOpTest__BitwiseSelect_Vector128_Byte testClass
            ) {
            ...
            public void RunStructFldScenario_Load(
                ...
                fixed (Vector128<Byte>* pFld1 = &_fld1)fixed (
        ...
        public void RunClassFldScenario_Load()
        {
            ...
            fixed (Vector128<Byte>* pFld1 = &_fld1)fixed (Vector128<Byte>* pFld2 = &_fld2)fixed (
        ...
        private void ValidateResult(
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd)}.{nameof(AdvSimd.BitwiseSelect)}<Byte>(Vector128<Byte>, Vector128<Byte>, Vector128<Byte>): {method} failed:"
                );
                TestLibrary.TestFramework.LogInformation(
