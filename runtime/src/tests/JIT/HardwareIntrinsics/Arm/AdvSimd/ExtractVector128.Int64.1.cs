...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ExtractVector128_Int64_1()
        {
    ...
    public sealed unsafe class ExtractVectorTest__ExtractVector128_Int64_1
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(ExtractVectorTest__ExtractVector128_Int64_1 testClass)
            {
        ...
        static ExtractVectorTest__ExtractVector128_Int64_1()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetInt64();
        ...
        public ExtractVectorTest__ExtractVector128_Int64_1()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(
                    nameof(AdvSimd.ExtractVector128),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.ExtractVector128(_clsVar1, _clsVar2, ElementIndex);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ExtractVector128)}<Int64>(Vector128<Int64>, Vector128<Int64>, 1): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
