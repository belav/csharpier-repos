    ...
    public sealed unsafe class SimpleUnaryOpTest__RoundAwayFromZero_Vector64_Single
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__RoundAwayFromZero_Vector64_Single testClass
            )
            {
            ...
            )
            {
                ...
                {
                    var result = AdvSimd.RoundAwayFromZero(AdvSimd.LoadVector64((Single*)(pFld1)));
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            {
                var result = AdvSimd.RoundAwayFromZero(AdvSimd.LoadVector64((Single*)(pClsVar1)));
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = AdvSimd.RoundAwayFromZero(AdvSimd.LoadVector64((Single*)(&test._fld1)));
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.RoundAwayFromZero)}<Single>(Vector64<Single>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
