    ...
    public sealed unsafe class SimpleBinaryOpTest__ShiftArithmetic_Vector128_Int64
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__ShiftArithmetic_Vector128_Int64 testClass
            )
            {
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ShiftArithmetic)}<Int64>(Vector128<Int64>, Vector128<Int64>): {method} failed:"
                    );
