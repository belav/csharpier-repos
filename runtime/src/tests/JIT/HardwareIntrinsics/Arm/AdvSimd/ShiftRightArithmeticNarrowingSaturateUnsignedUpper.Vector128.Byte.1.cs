...
namespace JIT.HardwareIntrinsics.Arm
{
    public static partial class Program
    {
        ...
        {
            var test =
                new ImmBinaryOpTest__ShiftRightArithmeticNarrowingSaturateUnsignedUpper_Vector128_Byte_1();
    ...
    public sealed unsafe class ImmBinaryOpTest__ShiftRightArithmeticNarrowingSaturateUnsignedUpper_Vector128_Byte_1
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                ImmBinaryOpTest__ShiftRightArithmeticNarrowingSaturateUnsignedUpper_Vector128_Byte_1 testClass
            )
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(
                    ...
                    new Type[] { typeof(Vector64<Byte>), typeof(Vector128<Int16>), typeof(byte) }
                )
                .Invoke(
                    null,
                    new object[]
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ShiftRightArithmeticNarrowingSaturateUnsignedUpper)}<Byte>(Vector64<Byte>, Vector128<Int16>, 1): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
