...
namespace JIT.HardwareIntrinsics.Arm
{
    public static partial class Program
    {
        ...
        {
            var test =
                new ImmBinaryOpTest__MultiplyBySelectedScalarWideningUpper_Vector128_UInt32_Vector64_UInt32_1();
    ...
    public sealed unsafe class ImmBinaryOpTest__MultiplyBySelectedScalarWideningUpper_Vector128_UInt32_Vector64_UInt32_1
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                ImmBinaryOpTest__MultiplyBySelectedScalarWideningUpper_Vector128_UInt32_Vector64_UInt32_1 testClass
            )
            {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.MultiplyBySelectedScalarWideningUpper(_clsVar1, _clsVar2, 1);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.MultiplyBySelectedScalarWideningUpper)}<UInt64>(Vector128<UInt32>, Vector64<UInt32>, 1): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
