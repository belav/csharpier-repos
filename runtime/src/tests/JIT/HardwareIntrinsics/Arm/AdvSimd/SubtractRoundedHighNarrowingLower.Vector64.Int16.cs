...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void SubtractRoundedHighNarrowingLower_Vector64_Int16()
        {
    ...
    public sealed unsafe class SimpleBinaryOpTest__SubtractRoundedHighNarrowingLower_Vector64_Int16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__SubtractRoundedHighNarrowingLower_Vector64_Int16 testClass
            )
            {
        ...
        static SimpleBinaryOpTest__SubtractRoundedHighNarrowingLower_Vector64_Int16()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetInt32();
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(
                    nameof(AdvSimd.SubtractRoundedHighNarrowingLower),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.SubtractRoundedHighNarrowingLower(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.SubtractRoundedHighNarrowingLower)}<Int16>(Vector128<Int32>, Vector128<Int32>): {method} failed:"
                    );
