    ...
    public sealed unsafe class SimpleBinaryOpTest__AddWideningUpper_Vector128_Int16_Vector128_SByte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__AddWideningUpper_Vector128_Int16_Vector128_SByte testClass
            ) {
            ...
            public void RunStructFldScenario_Load(
                ...
                fixed (Vector128<Int16>* pFld1 = &_fld1)fixed (Vector128<SByte>* pFld2 = &_fld2)
                {
        ...
        private void ValidateResult(
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd)}.{nameof(AdvSimd.AddWideningUpper)}<Int16>(Vector128<Int16>, Vector128<SByte>): {method} failed:"
                );
