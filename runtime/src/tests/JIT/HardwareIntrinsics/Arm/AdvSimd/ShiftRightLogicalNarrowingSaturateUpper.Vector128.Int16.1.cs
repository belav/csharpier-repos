...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ShiftRightLogicalNarrowingSaturateUpper_Vector128_Int16_1()
        {
            var test =
                new ImmBinaryOpTest__ShiftRightLogicalNarrowingSaturateUpper_Vector128_Int16_1();
    ...
    public sealed unsafe class ImmBinaryOpTest__ShiftRightLogicalNarrowingSaturateUpper_Vector128_Int16_1
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                ImmBinaryOpTest__ShiftRightLogicalNarrowingSaturateUpper_Vector128_Int16_1 testClass
            ) {
            ...
            public void RunStructFldScenario_Load(
                ...
                fixed (Vector64<Int16>* pFld1 = &_fld1)fixed (Vector128<Int32>* pFld2 = &_fld2)
                {
        ...
        static ImmBinaryOpTest__ShiftRightLogicalNarrowingSaturateUpper_Vector128_Int16_1()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetInt16();
        ...
        public ImmBinaryOpTest__ShiftRightLogicalNarrowingSaturateUpper_Vector128_Int16_1()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(
                    nameof(AdvSimd.ShiftRightLogicalNarrowingSaturateUpper),
                    new Type[] { typeof(Vector64<Int16>), typeof(Vector128<Int32>), typeof(byte) }
                )
                .Invoke(
                    null,
                    new object[]
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.ShiftRightLogicalNarrowingSaturateUpper(_clsVar1, _clsVar2, 1);
        ...
        private void ValidateResult(
            ...
            {
                if (
                    Helpers.ShiftRightLogicalNarrowingSaturateUpper(firstOp, secondOp, Imm, i)
                    != result[i]
                ) {
                    succeeded = false;
                    break;
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd)}.{nameof(AdvSimd.ShiftRightLogicalNarrowingSaturateUpper)}<Int16>(Vector64<Int16>, Vector128<Int32>, 1): {method} failed:"
                );
                TestLibrary.TestFramework.LogInformation(
