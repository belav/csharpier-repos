...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    public sealed unsafe class ImmOpTest__DuplicateToVector64_UInt16_31
    {
        ...
        public void RunBasicScenario()
        {
            ...
            var result = AdvSimd.DuplicateToVector64((UInt16)31);
        ...
        public void RunReflectionScenario()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(nameof(AdvSimd.DuplicateToVector64), new Type[] { typeof(UInt16) })
                .Invoke(null, new object[] { (UInt16)31 });
        ...
        private void ValidateResult(UInt16[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.DuplicateToVector64)}<UInt16>(31): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
