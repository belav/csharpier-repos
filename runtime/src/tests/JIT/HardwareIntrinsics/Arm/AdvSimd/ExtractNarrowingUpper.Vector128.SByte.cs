    ...
    public sealed unsafe class SimpleBinaryOpTest__ExtractNarrowingUpper_Vector128_SByte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__ExtractNarrowingUpper_Vector128_SByte testClass
            )
            {
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ExtractNarrowingUpper)}<SByte>(Vector64<SByte>, Vector128<Int16>): {method} failed:"
                    );
