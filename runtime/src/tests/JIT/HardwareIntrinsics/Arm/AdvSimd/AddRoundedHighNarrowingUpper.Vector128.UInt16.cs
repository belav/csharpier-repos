    ...
    public sealed unsafe class SimpleTernaryOpTest__AddRoundedHighNarrowingUpper_Vector128_UInt16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleTernaryOpTest__AddRoundedHighNarrowingUpper_Vector128_UInt16 testClass
            ) {
            ...
            public void RunStructFldScenario_Load(
                ...
                fixed (Vector64<UInt16>* pFld1 = &_fld1)fixed (
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(
                    nameof(AdvSimd.AddRoundedHighNarrowingUpper),
                    new Type[]
                    {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.AddRoundedHighNarrowingUpper(_clsVar1, _clsVar2, _clsVar3);
        ...
        public void RunClassFldScenario_Load()
        {
            ...
            fixed (Vector64<UInt16>* pFld1 = &_fld1)fixed (Vector128<UInt32>* pFld2 = &_fld2)fixed (
        ...
        private void ValidateResult(
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd)}.{nameof(AdvSimd.AddRoundedHighNarrowingUpper)}<UInt16>(Vector64<UInt16>, Vector128<UInt32>, Vector128<UInt32>): {method} failed:"
                );
                TestLibrary.TestFramework.LogInformation(
