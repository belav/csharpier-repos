...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void FusedAddHalving_Vector64_UInt16()
        {
    ...
    public sealed unsafe class SimpleBinaryOpTest__FusedAddHalving_Vector64_UInt16
    {
        ...
        static SimpleBinaryOpTest__FusedAddHalving_Vector64_UInt16()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetUInt16();
        ...
        public SimpleBinaryOpTest__FusedAddHalving_Vector64_UInt16()
        {
            Succeeded = true;
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.FusedAddHalving)}<UInt16>(Vector64<UInt16>, Vector64<UInt16>): {method} failed:"
                    );
