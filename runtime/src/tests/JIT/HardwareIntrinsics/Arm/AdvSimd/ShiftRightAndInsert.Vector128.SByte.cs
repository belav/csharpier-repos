    ...
    public sealed unsafe class ImmBinaryOpTest__ShiftRightAndInsert_Vector128_SByte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                ImmBinaryOpTest__ShiftRightAndInsert_Vector128_SByte testClass
            )
            {
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ShiftRightAndInsert)}<SByte>(Vector128<SByte>, Vector128<SByte>, 4): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
