...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void Abs_Vector128_Int16()
        {
            var test = new SimpleUnaryOpTest__Abs_Vector128_Int16();
    ...
    public sealed unsafe class SimpleUnaryOpTest__Abs_Vector128_Int16
    {
        ...
        private struct TestStruct
        {
            ...
            public static TestStruct Create()
            {
                ...
                {
                    _data1[i] = (short)-TestLibrary.Generator.GetInt16();
                }
                Unsafe.CopyBlockUnaligned(
            ...
            public void RunStructFldScenario(SimpleUnaryOpTest__Abs_Vector128_Int16 testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleUnaryOpTest__Abs_Vector128_Int16 testClass)
            {
                fixed (Vector128<Int16>* pFld1 = &_fld1)
                {
                    var result = AdvSimd.Abs(AdvSimd.LoadVector128((Int16*)(pFld1)));
        ...
        static SimpleUnaryOpTest__Abs_Vector128_Int16()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = (short)-TestLibrary.Generator.GetInt16();
        ...
        public SimpleUnaryOpTest__Abs_Vector128_Int16()
        {
            Succeeded = true;
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.Abs(Unsafe.Read<Vector128<Int16>>(_dataTable.inArray1Ptr));
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var result = AdvSimd.Abs(AdvSimd.LoadVector128((Int16*)(_dataTable.inArray1Ptr)));
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(nameof(AdvSimd.Abs), new Type[] { typeof(Vector128<Int16>) })
                .Invoke(
                    null,
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.Abs(_clsVar1);
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            {
                var result = AdvSimd.Abs(AdvSimd.LoadVector128((Int16*)(pClsVar1)));
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = AdvSimd.Abs(AdvSimd.LoadVector128((Int16*)(&test._fld1)));
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.Abs)}<UInt16>(Vector128<Int16>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
