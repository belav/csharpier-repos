    ...
    public sealed unsafe class ImmUnaryOpTest__DuplicateSelectedScalarToVector64_Vector64_UInt32_1
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                ImmUnaryOpTest__DuplicateSelectedScalarToVector64_Vector64_UInt32_1 testClass
            )
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(
                    nameof(AdvSimd.DuplicateSelectedScalarToVector64),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.DuplicateSelectedScalarToVector64(_clsVar, 1);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.DuplicateSelectedScalarToVector64)}<UInt32>(Vector64<UInt32>, 1): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
