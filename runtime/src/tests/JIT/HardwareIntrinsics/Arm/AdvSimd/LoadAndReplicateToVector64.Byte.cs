...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    public sealed unsafe class LoadUnaryOpTest__LoadAndReplicateToVector64_Byte
    {
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var result = AdvSimd.LoadAndReplicateToVector64((Byte*)(_dataTable.inArray1Ptr));
        ...
        public void RunReflectionScenario_Load()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(nameof(AdvSimd.LoadAndReplicateToVector64), new Type[] { typeof(Byte*) })
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.LoadAndReplicateToVector64)}<Byte>(Vector64<Byte>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
