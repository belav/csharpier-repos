...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ShiftRightLogicalAddScalar_Vector64_UInt64_1()
        {
    ...
    public sealed unsafe class ImmBinaryOpTest__ShiftRightLogicalAddScalar_Vector64_UInt64_1
    {
        private struct DataTable
        {
            ...
            public DataTable(UInt64[] inArray1, UInt64[] inArray2, UInt64[] outArray, int alignment)
            {
                ...
                Unsafe.CopyBlockUnaligned(
                    ...
                    ref Unsafe.As<UInt64, byte>(ref inArray1[0]),
                    (uint)sizeOfinArray1
                );
                Unsafe.CopyBlockUnaligned(
                    ref Unsafe.AsRef<byte>(inArray2Ptr),
                    ref Unsafe.As<UInt64, byte>(ref inArray2[0]),
                    (uint)sizeOfinArray2
                );
            }
        ...
        private struct TestStruct
        {
            ...
            public static TestStruct Create()
            {
                ...
                Unsafe.CopyBlockUnaligned(
                    ref Unsafe.As<Vector64<UInt64>, byte>(ref testStruct._fld1),
                ...
                Unsafe.CopyBlockUnaligned(
                    ref Unsafe.As<Vector64<UInt64>, byte>(ref testStruct._fld2),
            ...
            public void RunStructFldScenario(
                ImmBinaryOpTest__ShiftRightLogicalAddScalar_Vector64_UInt64_1 testClass
            )
            {
                var result = AdvSimd.ShiftRightLogicalAddScalar(_fld1, _fld2, 1);
            ...
            {
                fixed (Vector64<UInt64>* pFld1 = &_fld1)fixed (Vector64<UInt64>* pFld2 = &_fld2)
                {
        ...
        static ImmBinaryOpTest__ShiftRightLogicalAddScalar_Vector64_UInt64_1()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetUInt64();
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector64<UInt64>, byte>(ref _clsVar1),
                ref Unsafe.As<UInt64, byte>(ref _data1[0]),
                (uint)Unsafe.SizeOf<Vector64<UInt64>>()
            );
            for (var i = 0; i < Op2ElementCount; i++)
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector64<UInt64>, byte>(ref _clsVar2),
                ref Unsafe.As<UInt64, byte>(ref _data2[0]),
                (uint)Unsafe.SizeOf<Vector64<UInt64>>()
            );
        }

        public ImmBinaryOpTest__ShiftRightLogicalAddScalar_Vector64_UInt64_1()
        {
            Succeeded = true;
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector64<UInt64>, byte>(ref _fld1),
                ref Unsafe.As<UInt64, byte>(ref _data1[0]),
                (uint)Unsafe.SizeOf<Vector64<UInt64>>()
            );
            for (var i = 0; i < Op2ElementCount; i++)
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector64<UInt64>, byte>(ref _fld2),
                ref Unsafe.As<UInt64, byte>(ref _data2[0]),
                (uint)Unsafe.SizeOf<Vector64<UInt64>>()
            );
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(
                    nameof(AdvSimd.ShiftRightLogicalAddScalar),
                    new Type[] { typeof(Vector64<UInt64>), typeof(Vector64<UInt64>), typeof(byte) }
                )
                .Invoke(
                    null,
                    new object[]
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.ShiftRightLogicalAddScalar(_clsVar1, _clsVar2, 1);
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            fixed (Vector64<UInt64>* pClsVar1 = &_clsVar1)fixed (
                Vector64<UInt64>* pClsVar2 = &_clsVar2
            )
            {
                var result = AdvSimd.ShiftRightLogicalAddScalar(
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new ImmBinaryOpTest__ShiftRightLogicalAddScalar_Vector64_UInt64_1();
            var result = AdvSimd.ShiftRightLogicalAddScalar(test._fld1, test._fld2, 1);
        ...
        public void RunClassLclFldScenario_Load()
        {
            ...
            fixed (Vector64<UInt64>* pFld1 = &test._fld1)fixed (
                Vector64<UInt64>* pFld2 = &test._fld2
            )
            {
                var result = AdvSimd.ShiftRightLogicalAddScalar(
                    AdvSimd.LoadVector64((UInt64*)(pFld1)),
        ...
        )
        {
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<UInt64, byte>(ref inArray2[0]),
                ref Unsafe.AsRef<byte>(secondOp),
                (uint)Unsafe.SizeOf<Vector64<UInt64>>()
            );
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<UInt64, byte>(ref outArray[0]),
        ...
        )
        {
            ...
            if (Helpers.ShiftRightLogicalAdd(firstOp[0], secondOp[0], Imm) != result[0])
            {
                succeeded = false;
            }
            else
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd)}.{nameof(AdvSimd.ShiftRightLogicalAddScalar)}<UInt64>(Vector64<UInt64>, Vector64<UInt64>, 1): {method} failed:"
                );
                TestLibrary.TestFramework.LogInformation(
