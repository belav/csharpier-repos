    ...
    public sealed unsafe class SimpleBinaryOpTest__FusedSubtractHalving_Vector128_Byte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__FusedSubtractHalving_Vector128_Byte testClass
            )
            {
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.FusedSubtractHalving)}<Byte>(Vector128<Byte>, Vector128<Byte>): {method} failed:"
                    );
