...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void MultiplyDoublingWideningUpperBySelectedScalarAndAddSaturate_Vector128_Int32_Vector64_Int32_1()
        {
            var test =
                new SimpleTernaryOpTest__MultiplyDoublingWideningUpperBySelectedScalarAndAddSaturate_Vector128_Int32_Vector64_Int32_1();
    ...
    public sealed unsafe class SimpleTernaryOpTest__MultiplyDoublingWideningUpperBySelectedScalarAndAddSaturate_Vector128_Int32_Vector64_Int32_1
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleTernaryOpTest__MultiplyDoublingWideningUpperBySelectedScalarAndAddSaturate_Vector128_Int32_Vector64_Int32_1 testClass
            )
            {
                var result = AdvSimd.MultiplyDoublingWideningUpperBySelectedScalarAndAddSaturate(
                    _fld1,
                    _fld2,
                    _fld3,
                    1
            ...
            )
            {
                ...
                {
                    var result =
                        AdvSimd.MultiplyDoublingWideningUpperBySelectedScalarAndAddSaturate(
        ...
        static SimpleTernaryOpTest__MultiplyDoublingWideningUpperBySelectedScalarAndAddSaturate_Vector128_Int32_Vector64_Int32_1()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetInt64();
        ...
        public SimpleTernaryOpTest__MultiplyDoublingWideningUpperBySelectedScalarAndAddSaturate_Vector128_Int32_Vector64_Int32_1()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(
                    nameof(AdvSimd.MultiplyDoublingWideningUpperBySelectedScalarAndAddSaturate),
                    new Type[]
                    {
        ...
        public void RunClassFldScenario_Load()
        {
            ...
            fixed (Vector128<Int64>* pFld1 = &_fld1)fixed (Vector128<Int32>* pFld2 = &_fld2)fixed (
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd)}.{nameof(AdvSimd.MultiplyDoublingWideningUpperBySelectedScalarAndAddSaturate)}<Int64>(Vector128<Int64>, Vector128<Int32>, Vector64<Int32>): {method} failed:"
                );
                TestLibrary.TestFramework.LogInformation(
