    ...
    public sealed unsafe class ImmUnaryOpTest__DuplicateSelectedScalarToVector128_Vector64_Int32_1
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                ImmUnaryOpTest__DuplicateSelectedScalarToVector128_Vector64_Int32_1 testClass
            )
            {
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.DuplicateSelectedScalarToVector128)}<Int32>(Vector64<Int32>, 1): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
