...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void AbsoluteDifferenceAdd_Vector128_UInt16()
        {
            var test = new SimpleTernaryOpTest__AbsoluteDifferenceAdd_Vector128_UInt16();
    ...
    public sealed unsafe class SimpleTernaryOpTest__AbsoluteDifferenceAdd_Vector128_UInt16
    {
        ...
        private struct TestStruct
        {
            ...
            public static TestStruct Create()
            {
                ...
                Unsafe.CopyBlockUnaligned(
                    ref Unsafe.As<Vector128<UInt16>, byte>(ref testStruct._fld3),
            ...
            public void RunStructFldScenario(
                SimpleTernaryOpTest__AbsoluteDifferenceAdd_Vector128_UInt16 testClass
            )
            {
        ...
        static SimpleTernaryOpTest__AbsoluteDifferenceAdd_Vector128_UInt16()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetUInt16();
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector128<UInt16>, byte>(ref _clsVar3),
                ref Unsafe.As<UInt16, byte>(ref _data3[0]),
                (uint)Unsafe.SizeOf<Vector128<UInt16>>()
            );
        }

        public SimpleTernaryOpTest__AbsoluteDifferenceAdd_Vector128_UInt16()
        {
            Succeeded = true;
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector128<UInt16>, byte>(ref _fld3),
                ref Unsafe.As<UInt16, byte>(ref _data3[0]),
                (uint)Unsafe.SizeOf<Vector128<UInt16>>()
            );
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.AbsoluteDifferenceAdd)}<UInt16>(Vector128<UInt16>, Vector128<UInt16>, Vector128<UInt16>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
