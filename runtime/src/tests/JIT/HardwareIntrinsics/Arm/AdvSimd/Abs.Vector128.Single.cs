...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void Abs_Vector128_Single()
        {
    ...
    public sealed unsafe class SimpleUnaryOpTest__Abs_Vector128_Single
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleUnaryOpTest__Abs_Vector128_Single testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleUnaryOpTest__Abs_Vector128_Single testClass)
            {
                fixed (Vector128<Single>* pFld1 = &_fld1)
                {
                    var result = AdvSimd.Abs(AdvSimd.LoadVector128((Single*)(pFld1)));
        ...
        static SimpleUnaryOpTest__Abs_Vector128_Single()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = -TestLibrary.Generator.GetSingle();
        ...
        public SimpleUnaryOpTest__Abs_Vector128_Single()
        {
            Succeeded = true;
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.Abs(Unsafe.Read<Vector128<Single>>(_dataTable.inArray1Ptr));
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var result = AdvSimd.Abs(AdvSimd.LoadVector128((Single*)(_dataTable.inArray1Ptr)));
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(nameof(AdvSimd.Abs), new Type[] { typeof(Vector128<Single>) })
                .Invoke(
                    null,
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            {
                var result = AdvSimd.Abs(AdvSimd.LoadVector128((Single*)(pClsVar1)));
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = AdvSimd.Abs(AdvSimd.LoadVector128((Single*)(&test._fld1)));
        ...
        )
        {
            ...
            {
                if (
                    BitConverter.SingleToInt32Bits(Helpers.Abs(firstOp[i]))
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.Abs)}<Single>(Vector128<Single>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
