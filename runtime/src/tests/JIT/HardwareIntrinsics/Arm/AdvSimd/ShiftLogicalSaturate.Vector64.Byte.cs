...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ShiftLogicalSaturate_Vector64_Byte()
        {
    ...
    public sealed unsafe class SimpleBinaryOpTest__ShiftLogicalSaturate_Vector64_Byte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__ShiftLogicalSaturate_Vector64_Byte testClass
            )
            {
        ...
        static SimpleBinaryOpTest__ShiftLogicalSaturate_Vector64_Byte()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetByte();
        ...
        public SimpleBinaryOpTest__ShiftLogicalSaturate_Vector64_Byte()
        {
            Succeeded = true;
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ShiftLogicalSaturate)}<Byte>(Vector64<Byte>, Vector64<SByte>): {method} failed:"
                    );
