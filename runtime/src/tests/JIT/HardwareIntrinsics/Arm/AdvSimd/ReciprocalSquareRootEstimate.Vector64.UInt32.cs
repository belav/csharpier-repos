    ...
    public sealed unsafe class SimpleUnaryOpTest__ReciprocalSquareRootEstimate_Vector64_UInt32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__ReciprocalSquareRootEstimate_Vector64_UInt32 testClass
            )
            {
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ReciprocalSquareRootEstimate)}<UInt32>(Vector64<UInt32>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
