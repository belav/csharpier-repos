...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void MultiplyAdd_Vector64_Byte()
        {
            var test = new SimpleTernaryOpTest__MultiplyAdd_Vector64_Byte();
    ...
    public sealed unsafe class SimpleTernaryOpTest__MultiplyAdd_Vector64_Byte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleTernaryOpTest__MultiplyAdd_Vector64_Byte testClass
            ) {
        ...
        static SimpleTernaryOpTest__MultiplyAdd_Vector64_Byte()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetByte();
        ...
        public SimpleTernaryOpTest__MultiplyAdd_Vector64_Byte()
        {
            Succeeded = true;
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.MultiplyAdd(_clsVar1, _clsVar2, _clsVar3);
        ...
        private void ValidateResult(
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd)}.{nameof(AdvSimd.MultiplyAdd)}<Byte>(Vector64<Byte>, Vector64<Byte>, Vector64<Byte>): {method} failed:"
                );
                TestLibrary.TestFramework.LogInformation(
