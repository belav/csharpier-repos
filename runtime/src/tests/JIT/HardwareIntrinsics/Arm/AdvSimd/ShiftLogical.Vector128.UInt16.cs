    ...
    public sealed unsafe class SimpleBinaryOpTest__ShiftLogical_Vector128_UInt16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__ShiftLogical_Vector128_UInt16 testClass
            )
            {
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ShiftLogical)}<UInt16>(Vector128<UInt16>, Vector128<Int16>): {method} failed:"
                    );
