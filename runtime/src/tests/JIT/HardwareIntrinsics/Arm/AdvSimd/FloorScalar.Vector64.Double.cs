...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void FloorScalar_Vector64_Double()
        {
            var test = new SimpleUnaryOpTest__FloorScalar_Vector64_Double();
    ...
    public sealed unsafe class SimpleUnaryOpTest__FloorScalar_Vector64_Double
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__FloorScalar_Vector64_Double testClass
            )
            {
                var result = AdvSimd.FloorScalar(_fld1);
            ...
            )
            {
                ...
                {
                    var result = AdvSimd.FloorScalar(AdvSimd.LoadVector64((Double*)(pFld1)));
        ...
        static SimpleUnaryOpTest__FloorScalar_Vector64_Double()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetDouble();
        ...
        public SimpleUnaryOpTest__FloorScalar_Vector64_Double()
        {
            Succeeded = true;
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.FloorScalar(Unsafe.Read<Vector64<Double>>(_dataTable.inArray1Ptr));
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var result = AdvSimd.FloorScalar(
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(nameof(AdvSimd.FloorScalar), new Type[] { typeof(Vector64<Double>) })
                .Invoke(
                    null,
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.FloorScalar(_clsVar1);
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            {
                var result = AdvSimd.FloorScalar(AdvSimd.LoadVector64((Double*)(pClsVar1)));
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.FloorScalar(op1);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimpleUnaryOpTest__FloorScalar_Vector64_Double();
            var result = AdvSimd.FloorScalar(test._fld1);
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = AdvSimd.FloorScalar(AdvSimd.LoadVector64((Double*)(&test._fld1)));
        ...
        )
        {
            ...
            if (
                BitConverter.DoubleToInt64Bits(Helpers.Floor(firstOp[0]))
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.FloorScalar)}<Double>(Vector64<Double>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
