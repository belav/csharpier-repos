...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ConvertToSingleScalar_Vector64_UInt32()
        {
            var test = new SimpleUnaryOpTest__ConvertToSingleScalar_Vector64_UInt32();
    ...
    public sealed unsafe class SimpleUnaryOpTest__ConvertToSingleScalar_Vector64_UInt32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__ConvertToSingleScalar_Vector64_UInt32 testClass
            )
            {
                var result = AdvSimd.ConvertToSingleScalar(_fld1);
            ...
            )
            {
                ...
                {
                    var result = AdvSimd.ConvertToSingleScalar(
        ...
        static SimpleUnaryOpTest__ConvertToSingleScalar_Vector64_UInt32()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetUInt32();
        ...
        public SimpleUnaryOpTest__ConvertToSingleScalar_Vector64_UInt32()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(
                    nameof(AdvSimd.ConvertToSingleScalar),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.ConvertToSingleScalar(_clsVar1);
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.ConvertToSingleScalar(op1);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimpleUnaryOpTest__ConvertToSingleScalar_Vector64_UInt32();
            var result = AdvSimd.ConvertToSingleScalar(test._fld1);
        ...
        public void RunClassLclFldScenario_Load()
        {
            ...
            {
                var result = AdvSimd.ConvertToSingleScalar(AdvSimd.LoadVector64((UInt32*)(pFld1)));
        ...
        )
        {
            ...
            if (
                BitConverter.SingleToInt32Bits(Helpers.ConvertToSingle(firstOp[0]))
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ConvertToSingleScalar)}<Single>(Vector64<UInt32>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
