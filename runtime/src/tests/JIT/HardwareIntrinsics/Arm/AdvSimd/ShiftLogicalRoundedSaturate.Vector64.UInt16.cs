...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ShiftLogicalRoundedSaturate_Vector64_UInt16()
        {
            var test = new SimpleBinaryOpTest__ShiftLogicalRoundedSaturate_Vector64_UInt16();
    ...
    public sealed unsafe class SimpleBinaryOpTest__ShiftLogicalRoundedSaturate_Vector64_UInt16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__ShiftLogicalRoundedSaturate_Vector64_UInt16 testClass
            ) {
            ...
            public void RunStructFldScenario_Load(
                ...
                fixed (Vector64<UInt16>* pFld1 = &_fld1)fixed (Vector64<Int16>* pFld2 = &_fld2)
                {
        ...
        static SimpleBinaryOpTest__ShiftLogicalRoundedSaturate_Vector64_UInt16()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetUInt16();
        ...
        public SimpleBinaryOpTest__ShiftLogicalRoundedSaturate_Vector64_UInt16()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(
                    ...
                    new Type[] { typeof(Vector64<UInt16>), typeof(Vector64<Int16>) }
                )
                .Invoke(
                    null,
                    new object[]
        ...
        private void ValidateResult(
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd)}.{nameof(AdvSimd.ShiftLogicalRoundedSaturate)}<UInt16>(Vector64<UInt16>, Vector64<Int16>): {method} failed:"
                );
