    ...
    public sealed unsafe class SimpleBinaryOpTest__MinNumberScalar_Vector64_Double
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__MinNumberScalar_Vector64_Double testClass
            )
            {
        ...
        )
        {
            ...
            if (
                BitConverter.DoubleToInt64Bits(Helpers.MinNumber(left[0], right[0]))
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.MinNumberScalar)}<Double>(Vector64<Double>, Vector64<Double>): {method} failed:"
                    );
