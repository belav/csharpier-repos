...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ShiftRightLogicalScalar_Vector64_UInt64_1()
        {
    ...
    public sealed unsafe class ImmUnaryOpTest__ShiftRightLogicalScalar_Vector64_UInt64_1
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                ImmUnaryOpTest__ShiftRightLogicalScalar_Vector64_UInt64_1 testClass
            )
            {
        ...
        static ImmUnaryOpTest__ShiftRightLogicalScalar_Vector64_UInt64_1()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data[i] = TestLibrary.Generator.GetUInt64();
        ...
        public ImmUnaryOpTest__ShiftRightLogicalScalar_Vector64_UInt64_1()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                ...
                .Invoke(
                    null,
                    new object[] { Unsafe.Read<Vector64<UInt64>>(_dataTable.inArrayPtr), (byte)1 }
                );
        ...
        public void RunReflectionScenario_Load()
        {
            ...
            var result = typeof(AdvSimd)
                ...
                .Invoke(
                    null,
                    new object[] { AdvSimd.LoadVector64((UInt64*)(_dataTable.inArrayPtr)), (byte)1 }
                );
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ShiftRightLogicalScalar)}<UInt64>(Vector64<UInt64>, 1): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
