    ...
    public sealed unsafe class SimpleBinaryOpTest__AbsoluteCompareLessThanOrEqual_Vector64_Single
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__AbsoluteCompareLessThanOrEqual_Vector64_Single testClass
            )
            {
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.AbsoluteCompareLessThanOrEqual)}<Single>(Vector64<Single>, Vector64<Single>): {method} failed:"
                    );
