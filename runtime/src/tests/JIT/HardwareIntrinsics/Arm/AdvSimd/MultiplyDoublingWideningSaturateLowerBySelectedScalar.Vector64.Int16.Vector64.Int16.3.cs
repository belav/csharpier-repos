...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void MultiplyDoublingWideningSaturateLowerBySelectedScalar_Vector64_Int16_Vector64_Int16_3()
        {
            var test =
                new ImmBinaryOpTest__MultiplyDoublingWideningSaturateLowerBySelectedScalar_Vector64_Int16_Vector64_Int16_3();
    ...
    public sealed unsafe class ImmBinaryOpTest__MultiplyDoublingWideningSaturateLowerBySelectedScalar_Vector64_Int16_Vector64_Int16_3
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                ImmBinaryOpTest__MultiplyDoublingWideningSaturateLowerBySelectedScalar_Vector64_Int16_Vector64_Int16_3 testClass
            )
            {
        ...
        static ImmBinaryOpTest__MultiplyDoublingWideningSaturateLowerBySelectedScalar_Vector64_Int16_Vector64_Int16_3()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetInt16();
        ...
        public ImmBinaryOpTest__MultiplyDoublingWideningSaturateLowerBySelectedScalar_Vector64_Int16_Vector64_Int16_3()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(
                    nameof(AdvSimd.MultiplyDoublingWideningSaturateLowerBySelectedScalar),
                    new Type[] { typeof(Vector64<Int16>), typeof(Vector64<Int16>), typeof(byte) }
                )
                .Invoke(
                    null,
                    new object[]
        ...
        public void RunClassLclFldScenario_Load()
        {
            ...
            fixed (Vector64<Int16>* pFld1 = &test._fld1)fixed (Vector64<Int16>* pFld2 = &test._fld2)
            {
                var result = AdvSimd.MultiplyDoublingWideningSaturateLowerBySelectedScalar(
                    AdvSimd.LoadVector64((Int16*)(pFld1)),
                    AdvSimd.LoadVector64((Int16*)(pFld2)),
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd)}.{nameof(AdvSimd.MultiplyDoublingWideningSaturateLowerBySelectedScalar)}<Int32>(Vector64<Int16>, Vector64<Int16>, 3): {method} failed:"
                );
                TestLibrary.TestFramework.LogInformation(
