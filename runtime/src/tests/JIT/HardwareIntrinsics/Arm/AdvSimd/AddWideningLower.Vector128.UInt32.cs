...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void AddWideningLower_Vector128_UInt32()
        {
            var test = new SimpleBinaryOpTest__AddWideningLower_Vector128_UInt32();
    ...
    public sealed unsafe class SimpleBinaryOpTest__AddWideningLower_Vector128_UInt32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__AddWideningLower_Vector128_UInt32 testClass
            )
            {
            ...
            {
                fixed (Vector128<UInt32>* pFld1 = &_fld1)fixed (Vector64<UInt16>* pFld2 = &_fld2)
                {
        ...
        static SimpleBinaryOpTest__AddWideningLower_Vector128_UInt32()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetUInt32();
        ...
        public SimpleBinaryOpTest__AddWideningLower_Vector128_UInt32()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(
                    ...
                    new Type[] { typeof(Vector128<UInt32>), typeof(Vector64<UInt16>) }
                )
                .Invoke(
                    null,
                    new object[]
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd)}.{nameof(AdvSimd.AddWideningLower)}<UInt32>(Vector128<UInt32>, Vector64<UInt16>): {method} failed:"
                );
