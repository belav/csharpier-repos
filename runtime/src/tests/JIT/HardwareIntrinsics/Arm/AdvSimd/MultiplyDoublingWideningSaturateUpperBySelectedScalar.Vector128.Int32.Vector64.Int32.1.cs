...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void MultiplyDoublingWideningSaturateUpperBySelectedScalar_Vector128_Int32_Vector64_Int32_1()
        {
            var test =
                new ImmBinaryOpTest__MultiplyDoublingWideningSaturateUpperBySelectedScalar_Vector128_Int32_Vector64_Int32_1();
    ...
    public sealed unsafe class ImmBinaryOpTest__MultiplyDoublingWideningSaturateUpperBySelectedScalar_Vector128_Int32_Vector64_Int32_1
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                ImmBinaryOpTest__MultiplyDoublingWideningSaturateUpperBySelectedScalar_Vector128_Int32_Vector64_Int32_1 testClass
            )
            {
            ...
            {
                fixed (Vector128<Int32>* pFld1 = &_fld1)fixed (Vector64<Int32>* pFld2 = &_fld2)
                {
                    var result = AdvSimd.MultiplyDoublingWideningSaturateUpperBySelectedScalar(
        ...
        static ImmBinaryOpTest__MultiplyDoublingWideningSaturateUpperBySelectedScalar_Vector128_Int32_Vector64_Int32_1()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetInt32();
        ...
        public ImmBinaryOpTest__MultiplyDoublingWideningSaturateUpperBySelectedScalar_Vector128_Int32_Vector64_Int32_1()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(
                    ...
                    new Type[] { typeof(Vector128<Int32>), typeof(Vector64<Int32>), typeof(byte) }
                )
                .Invoke(
                    null,
                    new object[]
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.MultiplyDoublingWideningSaturateUpperBySelectedScalar(op1, op2, 1);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd)}.{nameof(AdvSimd.MultiplyDoublingWideningSaturateUpperBySelectedScalar)}<Int64>(Vector128<Int32>, Vector64<Int32>, 1): {method} failed:"
                );
                TestLibrary.TestFramework.LogInformation(
