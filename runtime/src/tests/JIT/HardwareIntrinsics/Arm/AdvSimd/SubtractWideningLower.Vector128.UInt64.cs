    ...
    public sealed unsafe class SimpleBinaryOpTest__SubtractWideningLower_Vector128_UInt64
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__SubtractWideningLower_Vector128_UInt64 testClass
            )
            {
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.SubtractWideningLower)}<UInt64>(Vector128<UInt64>, Vector64<UInt32>): {method} failed:"
                    );
