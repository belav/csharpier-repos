...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void BitwiseSelect_Vector64_UInt64()
        {
            var test = new SimpleTernaryOpTest__BitwiseSelect_Vector64_UInt64();
    ...
    public sealed unsafe class SimpleTernaryOpTest__BitwiseSelect_Vector64_UInt64
    {
        ...
        private struct TestStruct
        {
            ...
            public static TestStruct Create()
            {
                ...
                Unsafe.CopyBlockUnaligned(
                    ref Unsafe.As<Vector64<UInt64>, byte>(ref testStruct._fld3),
            ...
            public void RunStructFldScenario(
                SimpleTernaryOpTest__BitwiseSelect_Vector64_UInt64 testClass
            ) {
            ...
            public void RunStructFldScenario_Load(
                ...
                fixed (Vector64<UInt64>* pFld1 = &_fld1)fixed (
                    Vector64<UInt64>* pFld2 = &_fld2
                )fixed (Vector64<UInt64>* pFld3 = &_fld3)
                {
                    var result = AdvSimd.BitwiseSelect(
                        AdvSimd.LoadVector64((UInt64*)(pFld1)),
                        AdvSimd.LoadVector64((UInt64*)(pFld2)),
                        AdvSimd.LoadVector64((UInt64*)(pFld3))
                    );
        ...
        static SimpleTernaryOpTest__BitwiseSelect_Vector64_UInt64()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetUInt64();
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector64<UInt64>, byte>(ref _clsVar3),
                ref Unsafe.As<UInt64, byte>(ref _data3[0]),
                (uint)Unsafe.SizeOf<Vector64<UInt64>>()
            );
        }

        public SimpleTernaryOpTest__BitwiseSelect_Vector64_UInt64()
        {
            Succeeded = true;
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector64<UInt64>, byte>(ref _fld3),
                ref Unsafe.As<UInt64, byte>(ref _data3[0]),
                (uint)Unsafe.SizeOf<Vector64<UInt64>>()
            );
        ...
        public void RunClassLclFldScenario_Load()
        {
            ...
            )fixed (Vector64<UInt64>* pFld3 = &test._fld3)
            {
                var result = AdvSimd.BitwiseSelect(
                    AdvSimd.LoadVector64((UInt64*)(pFld1)),
                    AdvSimd.LoadVector64((UInt64*)(pFld2)),
        ...
        public void RunClassFldScenario_Load()
        {
            ...
            fixed (Vector64<UInt64>* pFld1 = &_fld1)fixed (Vector64<UInt64>* pFld2 = &_fld2)fixed (
                Vector64<UInt64>* pFld3 = &_fld3
            ) {
                var result = AdvSimd.BitwiseSelect(
                    AdvSimd.LoadVector64((UInt64*)(pFld1)),
                    AdvSimd.LoadVector64((UInt64*)(pFld2)),
        ...
        private void ValidateResult(
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd)}.{nameof(AdvSimd.BitwiseSelect)}<UInt64>(Vector64<UInt64>, Vector64<UInt64>, Vector64<UInt64>): {method} failed:"
                );
                TestLibrary.TestFramework.LogInformation(
