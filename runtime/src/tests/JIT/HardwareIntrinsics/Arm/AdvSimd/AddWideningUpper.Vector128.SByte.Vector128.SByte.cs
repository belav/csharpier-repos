    ...
    public sealed unsafe class SimpleBinaryOpTest__AddWideningUpper_Vector128_SByte_Vector128_SByte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__AddWideningUpper_Vector128_SByte_Vector128_SByte testClass
            )
            {
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.AddWideningUpper)}<Int16>(Vector128<SByte>, Vector128<SByte>): {method} failed:"
                    );
