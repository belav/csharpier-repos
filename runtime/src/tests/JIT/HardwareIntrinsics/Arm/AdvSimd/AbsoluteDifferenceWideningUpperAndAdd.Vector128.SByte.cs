...
namespace JIT.HardwareIntrinsics.Arm
{
    public static partial class Program
    {
        ...
        {
            var test =
                new SimpleTernaryOpTest__AbsoluteDifferenceWideningUpperAndAdd_Vector128_SByte();
    ...
    public sealed unsafe class SimpleTernaryOpTest__AbsoluteDifferenceWideningUpperAndAdd_Vector128_SByte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleTernaryOpTest__AbsoluteDifferenceWideningUpperAndAdd_Vector128_SByte testClass
            )
            {
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.AbsoluteDifferenceWideningUpperAndAdd)}<Int16>(Vector128<Int16>, Vector128<SByte>, Vector128<SByte>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
