...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void AddPairwiseWidening_Vector128_UInt32()
        {
            var test = new SimpleUnaryOpTest__AddPairwiseWidening_Vector128_UInt32();
    ...
    public sealed unsafe class SimpleUnaryOpTest__AddPairwiseWidening_Vector128_UInt32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__AddPairwiseWidening_Vector128_UInt32 testClass
            )
            {
        ...
        static SimpleUnaryOpTest__AddPairwiseWidening_Vector128_UInt32()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetUInt32();
        ...
        public SimpleUnaryOpTest__AddPairwiseWidening_Vector128_UInt32()
        {
            Succeeded = true;
        ...
        public void RunClassLclFldScenario_Load()
        {
            ...
            {
                var result = AdvSimd.AddPairwiseWidening(AdvSimd.LoadVector128((UInt32*)(pFld1)));
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = AdvSimd.AddPairwiseWidening(AdvSimd.LoadVector128((UInt32*)(&test._fld1)));
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.AddPairwiseWidening)}<UInt64>(Vector128<UInt32>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
