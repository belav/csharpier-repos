    ...
    public sealed unsafe class ImmUnaryOpTest__ShiftLeftLogical_Vector128_UInt32_1
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                ImmUnaryOpTest__ShiftLeftLogical_Vector128_UInt32_1 testClass
            )
            {
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            {
                var result = AdvSimd.ShiftLeftLogical(AdvSimd.LoadVector128((UInt32*)(pClsVar)), 1);
        ...
        public void RunClassLclFldScenario_Load()
        {
            ...
            {
                var result = AdvSimd.ShiftLeftLogical(AdvSimd.LoadVector128((UInt32*)(pFld)), 1);
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = AdvSimd.ShiftLeftLogical(AdvSimd.LoadVector128((UInt32*)(&test._fld)), 1);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ShiftLeftLogical)}<UInt32>(Vector128<UInt32>, 1): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
