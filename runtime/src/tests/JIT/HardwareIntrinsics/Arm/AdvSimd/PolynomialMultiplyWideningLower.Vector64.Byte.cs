...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void PolynomialMultiplyWideningLower_Vector64_Byte()
        {
    ...
    public sealed unsafe class SimpleBinaryOpTest__PolynomialMultiplyWideningLower_Vector64_Byte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__PolynomialMultiplyWideningLower_Vector64_Byte testClass
            )
            {
        ...
        static SimpleBinaryOpTest__PolynomialMultiplyWideningLower_Vector64_Byte()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetByte();
        ...
        public SimpleBinaryOpTest__PolynomialMultiplyWideningLower_Vector64_Byte()
        {
            Succeeded = true;
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.PolynomialMultiplyWideningLower)}<UInt16>(Vector64<Byte>, Vector64<Byte>): {method} failed:"
                    );
