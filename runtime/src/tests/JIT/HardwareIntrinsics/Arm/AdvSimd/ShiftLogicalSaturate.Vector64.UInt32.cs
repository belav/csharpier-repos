    ...
    public sealed unsafe class SimpleBinaryOpTest__ShiftLogicalSaturate_Vector64_UInt32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__ShiftLogicalSaturate_Vector64_UInt32 testClass
            )
            {
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ShiftLogicalSaturate)}<UInt32>(Vector64<UInt32>, Vector64<Int32>): {method} failed:"
                    );
