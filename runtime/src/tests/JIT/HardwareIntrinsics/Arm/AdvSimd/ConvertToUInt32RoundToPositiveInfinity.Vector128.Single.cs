...
namespace JIT.HardwareIntrinsics.Arm
{
    public static partial class Program
    {
        ...
        {
            var test =
                new SimpleUnaryOpTest__ConvertToUInt32RoundToPositiveInfinity_Vector128_Single();
    ...
    public sealed unsafe class SimpleUnaryOpTest__ConvertToUInt32RoundToPositiveInfinity_Vector128_Single
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__ConvertToUInt32RoundToPositiveInfinity_Vector128_Single testClass
            )
            {
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ConvertToUInt32RoundToPositiveInfinity)}<UInt32>(Vector128<Single>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
