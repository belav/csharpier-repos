...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ShiftRightLogical_Vector64_UInt32_1()
        {
            var test = new ImmUnaryOpTest__ShiftRightLogical_Vector64_UInt32_1();
    ...
    public sealed unsafe class ImmUnaryOpTest__ShiftRightLogical_Vector64_UInt32_1
    {
        ...
        private struct TestStruct
        {
            ...
            public static TestStruct Create()
            {
                ...
                Unsafe.CopyBlockUnaligned(
                    ref Unsafe.As<Vector64<UInt32>, byte>(ref testStruct._fld),
            ...
            public void RunStructFldScenario(
                ImmUnaryOpTest__ShiftRightLogical_Vector64_UInt32_1 testClass
            )
            {
        ...
        static ImmUnaryOpTest__ShiftRightLogical_Vector64_UInt32_1()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data[i] = TestLibrary.Generator.GetUInt32();
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector64<UInt32>, byte>(ref _clsVar),
                ref Unsafe.As<UInt32, byte>(ref _data[0]),
                (uint)Unsafe.SizeOf<Vector64<UInt32>>()
            );
        }

        public ImmUnaryOpTest__ShiftRightLogical_Vector64_UInt32_1()
        {
            Succeeded = true;
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector64<UInt32>, byte>(ref _fld),
                ref Unsafe.As<UInt32, byte>(ref _data[0]),
                (uint)Unsafe.SizeOf<Vector64<UInt32>>()
            );
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(
                    nameof(AdvSimd.ShiftRightLogical),
                    new Type[] { typeof(Vector64<UInt32>), typeof(byte) }
                )
                .Invoke(
                    null,
                    new object[] { Unsafe.Read<Vector64<UInt32>>(_dataTable.inArrayPtr), (byte)1 }
                );
        ...
        public void RunReflectionScenario_Load()
        {
            ...
            var result = typeof(AdvSimd)
                ...
                .Invoke(
                    null,
                    new object[] { AdvSimd.LoadVector64((UInt32*)(_dataTable.inArrayPtr)), (byte)1 }
                );
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.ShiftRightLogical(_clsVar, 1);
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            {
                var result = AdvSimd.ShiftRightLogical(AdvSimd.LoadVector64((UInt32*)(pClsVar)), 1);
        ...
        public void RunClassLclFldScenario_Load()
        {
            ...
            {
                var result = AdvSimd.ShiftRightLogical(AdvSimd.LoadVector64((UInt32*)(pFld)), 1);
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = AdvSimd.ShiftRightLogical(AdvSimd.LoadVector64((UInt32*)(&test._fld)), 1);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ShiftRightLogical)}<UInt32>(Vector64<UInt32>, 1): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
