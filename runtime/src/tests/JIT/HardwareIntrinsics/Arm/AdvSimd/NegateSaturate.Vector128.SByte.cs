    ...
    public sealed unsafe class SimpleUnaryOpTest__NegateSaturate_Vector128_SByte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__NegateSaturate_Vector128_SByte testClass
            )
            {
            ...
            )
            {
                ...
                {
                    var result = AdvSimd.NegateSaturate(AdvSimd.LoadVector128((SByte*)(pFld1)));
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(nameof(AdvSimd.NegateSaturate), new Type[] { typeof(Vector128<SByte>) })
                .Invoke(
                    null,
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            {
                var result = AdvSimd.NegateSaturate(AdvSimd.LoadVector128((SByte*)(pClsVar1)));
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = AdvSimd.NegateSaturate(AdvSimd.LoadVector128((SByte*)(&test._fld1)));
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.NegateSaturate)}<SByte>(Vector128<SByte>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
