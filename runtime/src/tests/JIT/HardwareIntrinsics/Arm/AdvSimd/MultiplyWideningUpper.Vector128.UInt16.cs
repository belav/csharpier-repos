...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void MultiplyWideningUpper_Vector128_UInt16()
        {
    ...
    public sealed unsafe class SimpleBinaryOpTest__MultiplyWideningUpper_Vector128_UInt16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__MultiplyWideningUpper_Vector128_UInt16 testClass
            )
            {
        ...
        static SimpleBinaryOpTest__MultiplyWideningUpper_Vector128_UInt16()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetUInt16();
        ...
        public SimpleBinaryOpTest__MultiplyWideningUpper_Vector128_UInt16()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(
                    nameof(AdvSimd.MultiplyWideningUpper),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.MultiplyWideningUpper(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.MultiplyWideningUpper)}<UInt32>(Vector128<UInt16>, Vector128<UInt16>): {method} failed:"
                    );
