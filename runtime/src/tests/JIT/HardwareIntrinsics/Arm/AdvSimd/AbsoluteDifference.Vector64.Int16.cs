    ...
    public sealed unsafe class SimpleBinaryOpTest__AbsoluteDifference_Vector64_Int16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__AbsoluteDifference_Vector64_Int16 testClass
            ) {
        ...
        private void ValidateResult(
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd)}.{nameof(AdvSimd.AbsoluteDifference)}<UInt16>(Vector64<Int16>, Vector64<Int16>): {method} failed:"
                );
