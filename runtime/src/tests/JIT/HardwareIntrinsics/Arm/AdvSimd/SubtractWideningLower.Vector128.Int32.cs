    ...
    public sealed unsafe class SimpleBinaryOpTest__SubtractWideningLower_Vector128_Int32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__SubtractWideningLower_Vector128_Int32 testClass
            )
            {
            ...
            {
                fixed (Vector128<Int32>* pFld1 = &_fld1)fixed (Vector64<Int16>* pFld2 = &_fld2)
                {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(
                    ...
                    new Type[] { typeof(Vector128<Int32>), typeof(Vector64<Int16>) }
                )
                .Invoke(
                    null,
                    new object[]
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd)}.{nameof(AdvSimd.SubtractWideningLower)}<Int32>(Vector128<Int32>, Vector64<Int16>): {method} failed:"
                );
