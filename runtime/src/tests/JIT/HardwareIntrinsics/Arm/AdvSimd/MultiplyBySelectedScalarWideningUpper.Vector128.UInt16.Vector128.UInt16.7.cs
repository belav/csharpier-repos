...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    public sealed unsafe class ImmBinaryOpTest__MultiplyBySelectedScalarWideningUpper_Vector128_UInt16_Vector128_UInt16_7
    {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.MultiplyBySelectedScalarWideningUpper(_clsVar1, _clsVar2, 7);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.MultiplyBySelectedScalarWideningUpper)}<UInt32>(Vector128<UInt16>, Vector128<UInt16>, 7): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
