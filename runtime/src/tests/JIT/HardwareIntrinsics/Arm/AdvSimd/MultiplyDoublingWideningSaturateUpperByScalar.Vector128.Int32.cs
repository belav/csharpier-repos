...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void MultiplyDoublingWideningSaturateUpperByScalar_Vector128_Int32()
        {
            var test =
                new SimpleBinaryOpTest__MultiplyDoublingWideningSaturateUpperByScalar_Vector128_Int32();
    ...
    public sealed unsafe class SimpleBinaryOpTest__MultiplyDoublingWideningSaturateUpperByScalar_Vector128_Int32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__MultiplyDoublingWideningSaturateUpperByScalar_Vector128_Int32 testClass
            )
            {
        ...
        static SimpleBinaryOpTest__MultiplyDoublingWideningSaturateUpperByScalar_Vector128_Int32()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetInt32();
        ...
        public SimpleBinaryOpTest__MultiplyDoublingWideningSaturateUpperByScalar_Vector128_Int32()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(
                    nameof(AdvSimd.MultiplyDoublingWideningSaturateUpperByScalar),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.MultiplyDoublingWideningSaturateUpperByScalar(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            {
                if (
                    Helpers.MultiplyDoublingWideningSaturateUpperByScalar(left, right[0], i)
                    != result[i]
                )
                {
                    succeeded = false;
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.MultiplyDoublingWideningSaturateUpperByScalar)}<Int64>(Vector128<Int32>, Vector64<Int32>): {method} failed:"
                    );
