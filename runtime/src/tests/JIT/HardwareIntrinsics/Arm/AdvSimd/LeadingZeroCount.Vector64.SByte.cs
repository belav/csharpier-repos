...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void LeadingZeroCount_Vector64_SByte()
        {
            var test = new SimpleUnaryOpTest__LeadingZeroCount_Vector64_SByte();
    ...
    public sealed unsafe class SimpleUnaryOpTest__LeadingZeroCount_Vector64_SByte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__LeadingZeroCount_Vector64_SByte testClass
            )
            {
            ...
            )
            {
                ...
                {
                    var result = AdvSimd.LeadingZeroCount(AdvSimd.LoadVector64((SByte*)(pFld1)));
        ...
        static SimpleUnaryOpTest__LeadingZeroCount_Vector64_SByte()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetSByte();
        ...
        public SimpleUnaryOpTest__LeadingZeroCount_Vector64_SByte()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(nameof(AdvSimd.LeadingZeroCount), new Type[] { typeof(Vector64<SByte>) })
                .Invoke(
                    null,
                    new object[] { Unsafe.Read<Vector64<SByte>>(_dataTable.inArray1Ptr) }
                );
        ...
        public void RunReflectionScenario_Load()
        {
            ...
            var result = typeof(AdvSimd)
                ...
                .Invoke(
                    null,
                    new object[] { AdvSimd.LoadVector64((SByte*)(_dataTable.inArray1Ptr)) }
                );
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.LeadingZeroCount(_clsVar1);
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            {
                var result = AdvSimd.LeadingZeroCount(AdvSimd.LoadVector64((SByte*)(pClsVar1)));
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = AdvSimd.LeadingZeroCount(AdvSimd.LoadVector64((SByte*)(&test._fld1)));
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.LeadingZeroCount)}<SByte>(Vector64<SByte>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
