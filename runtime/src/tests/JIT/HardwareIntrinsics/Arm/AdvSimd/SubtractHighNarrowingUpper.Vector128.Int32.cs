...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void SubtractHighNarrowingUpper_Vector128_Int32()
        {
            var test = new SimpleTernaryOpTest__SubtractHighNarrowingUpper_Vector128_Int32();
    ...
    public sealed unsafe class SimpleTernaryOpTest__SubtractHighNarrowingUpper_Vector128_Int32
    {
        private struct DataTable
        {
            ...
            public DataTable(
                ...
                Unsafe.CopyBlockUnaligned(
                    ...
                    ref Unsafe.As<Int64, byte>(ref inArray3[0]),
                    (uint)sizeOfinArray3
                );
            }
        ...
        private struct TestStruct
        {
            ...
            public static TestStruct Create()
            {
                ...
                {
                    _data3[i] = TestLibrary.Generator.GetInt64();
                }
                Unsafe.CopyBlockUnaligned(
                    ref Unsafe.As<Vector128<Int64>, byte>(ref testStruct._fld3),
                    ref Unsafe.As<Int64, byte>(ref _data3[0]),
                    (uint)Unsafe.SizeOf<Vector128<Int64>>()
                );
            ...
            public void RunStructFldScenario(
                SimpleTernaryOpTest__SubtractHighNarrowingUpper_Vector128_Int32 testClass
            ) {
        ...
        static SimpleTernaryOpTest__SubtractHighNarrowingUpper_Vector128_Int32()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetInt32();
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector128<Int64>, byte>(ref _clsVar3),
                ref Unsafe.As<Int64, byte>(ref _data3[0]),
                (uint)Unsafe.SizeOf<Vector128<Int64>>()
            );
        }
        ...
        public SimpleTernaryOpTest__SubtractHighNarrowingUpper_Vector128_Int32()
        {
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector128<Int64>, byte>(ref _fld3),
                ref Unsafe.As<Int64, byte>(ref _data3[0]),
                (uint)Unsafe.SizeOf<Vector128<Int64>>()
            );
        ...
        public void RunClassFldScenario_Load()
        {
            ...
            fixed (Vector64<Int32>* pFld1 = &_fld1)fixed (Vector128<Int64>* pFld2 = &_fld2)fixed (
                Vector128<Int64>* pFld3 = &_fld3
            ) {
                var result = AdvSimd.SubtractHighNarrowingUpper(
                    AdvSimd.LoadVector64((Int32*)(pFld1)),
                    AdvSimd.LoadVector128((Int64*)(pFld2)),
        ...
        private void ValidateResult(
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd)}.{nameof(AdvSimd.SubtractHighNarrowingUpper)}<Int32>(Vector64<Int32>, Vector128<Int64>, Vector128<Int64>): {method} failed:"
                );
                TestLibrary.TestFramework.LogInformation(
