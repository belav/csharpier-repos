...
namespace JIT.HardwareIntrinsics.Arm
{
    public static partial class Program
    {
        ...
        {
            var test =
                new SimpleTernaryOpTest__MultiplyBySelectedScalarWideningUpperAndSubtract_Vector128_UInt16_Vector64_UInt16_3();
    ...
    public sealed unsafe class SimpleTernaryOpTest__MultiplyBySelectedScalarWideningUpperAndSubtract_Vector128_UInt16_Vector64_UInt16_3
    {
        ...
        private struct TestStruct
        {
            ...
            public static TestStruct Create()
            {
                ...
                Unsafe.CopyBlockUnaligned(
                    ref Unsafe.As<Vector128<UInt16>, byte>(ref testStruct._fld2),
            ...
            public void RunStructFldScenario(
                SimpleTernaryOpTest__MultiplyBySelectedScalarWideningUpperAndSubtract_Vector128_UInt16_Vector64_UInt16_3 testClass
            )
            {
        ...
        static SimpleTernaryOpTest__MultiplyBySelectedScalarWideningUpperAndSubtract_Vector128_UInt16_Vector64_UInt16_3()
        {
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector128<UInt16>, byte>(ref _clsVar2),
                ref Unsafe.As<UInt16, byte>(ref _data2[0]),
                (uint)Unsafe.SizeOf<Vector128<UInt16>>()
            );
            for (var i = 0; i < Op3ElementCount; i++)
        ...
        public SimpleTernaryOpTest__MultiplyBySelectedScalarWideningUpperAndSubtract_Vector128_UInt16_Vector64_UInt16_3()
        {
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector128<UInt16>, byte>(ref _fld2),
                ref Unsafe.As<UInt16, byte>(ref _data2[0]),
                (uint)Unsafe.SizeOf<Vector128<UInt16>>()
            );
            for (var i = 0; i < Op3ElementCount; i++)
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(
                    nameof(AdvSimd.MultiplyBySelectedScalarWideningUpperAndSubtract),
                    new Type[]
                    {
        ...
        )
        {
            ...
            {
                if (
                    Helpers.MultiplyByScalarWideningUpperAndSubtract(
                        firstOp,
                        secondOp,
                        thirdOp[Imm],
                        i
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.MultiplyBySelectedScalarWideningUpperAndSubtract)}<UInt32>(Vector128<UInt32>, Vector128<UInt16>, Vector64<UInt16>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
