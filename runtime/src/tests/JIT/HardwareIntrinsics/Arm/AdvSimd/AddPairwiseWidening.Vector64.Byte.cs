...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void AddPairwiseWidening_Vector64_Byte()
        {
    ...
    public sealed unsafe class SimpleUnaryOpTest__AddPairwiseWidening_Vector64_Byte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__AddPairwiseWidening_Vector64_Byte testClass
            )
            {
            ...
            )
            {
                ...
                {
                    var result = AdvSimd.AddPairwiseWidening(AdvSimd.LoadVector64((Byte*)(pFld1)));
        ...
        static SimpleUnaryOpTest__AddPairwiseWidening_Vector64_Byte()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetByte();
        ...
        public SimpleUnaryOpTest__AddPairwiseWidening_Vector64_Byte()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(
                    nameof(AdvSimd.AddPairwiseWidening),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.AddPairwiseWidening(_clsVar1);
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            {
                var result = AdvSimd.AddPairwiseWidening(AdvSimd.LoadVector64((Byte*)(pClsVar1)));
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = AdvSimd.AddPairwiseWidening(AdvSimd.LoadVector64((Byte*)(&test._fld1)));
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.AddPairwiseWidening)}<UInt16>(Vector64<Byte>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
