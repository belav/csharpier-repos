...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ShiftLogicalScalar_Vector64_UInt64()
        {
    ...
    public sealed unsafe class SimpleBinaryOpTest__ShiftLogicalScalar_Vector64_UInt64
    {
        ...
        static SimpleBinaryOpTest__ShiftLogicalScalar_Vector64_UInt64()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetUInt64();
        ...
        public SimpleBinaryOpTest__ShiftLogicalScalar_Vector64_UInt64()
        {
            Succeeded = true;
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd)}.{nameof(AdvSimd.ShiftLogicalScalar)}<UInt64>(Vector64<UInt64>, Vector64<Int64>): {method} failed:"
                );
