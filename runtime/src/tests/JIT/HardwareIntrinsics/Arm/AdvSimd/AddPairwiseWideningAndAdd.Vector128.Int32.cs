...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void AddPairwiseWideningAndAdd_Vector128_Int32()
        {
            var test = new SimpleBinaryOpTest__AddPairwiseWideningAndAdd_Vector128_Int32();
    ...
    public sealed unsafe class SimpleBinaryOpTest__AddPairwiseWideningAndAdd_Vector128_Int32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__AddPairwiseWideningAndAdd_Vector128_Int32 testClass
            )
            {
        ...
        static SimpleBinaryOpTest__AddPairwiseWideningAndAdd_Vector128_Int32()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetInt64();
        ...
        public SimpleBinaryOpTest__AddPairwiseWideningAndAdd_Vector128_Int32()
        {
            Succeeded = true;
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.AddPairwiseWideningAndAdd)}<Int64>(Vector128<Int64>, Vector128<Int32>): {method} failed:"
                    );
