...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void MultiplyDoublingWideningSaturateLower_Vector64_Int32()
        {
            var test =
                new SimpleBinaryOpTest__MultiplyDoublingWideningSaturateLower_Vector64_Int32();
    ...
    public sealed unsafe class SimpleBinaryOpTest__MultiplyDoublingWideningSaturateLower_Vector64_Int32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__MultiplyDoublingWideningSaturateLower_Vector64_Int32 testClass
            )
            {
                var result = AdvSimd.MultiplyDoublingWideningSaturateLower(_fld1, _fld2);
            ...
            )
            {
                ...
                {
                    var result = AdvSimd.MultiplyDoublingWideningSaturateLower(
        ...
        static SimpleBinaryOpTest__MultiplyDoublingWideningSaturateLower_Vector64_Int32()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetInt32();
        ...
        public SimpleBinaryOpTest__MultiplyDoublingWideningSaturateLower_Vector64_Int32()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(
                    nameof(AdvSimd.MultiplyDoublingWideningSaturateLower),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.MultiplyDoublingWideningSaturateLower(_clsVar1, _clsVar2);
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.MultiplyDoublingWideningSaturateLower(op1, op2);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test =
                new SimpleBinaryOpTest__MultiplyDoublingWideningSaturateLower_Vector64_Int32();
            var result = AdvSimd.MultiplyDoublingWideningSaturateLower(test._fld1, test._fld2);
        ...
        )
        {
            ...
            {
                if (Helpers.MultiplyDoublingWideningSaturate(left[i], right[i]) != result[i])
                {
                    succeeded = false;
                    break;
                }
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.MultiplyDoublingWideningSaturateLower)}<Int64>(Vector64<Int32>, Vector64<Int32>): {method} failed:"
                    );
