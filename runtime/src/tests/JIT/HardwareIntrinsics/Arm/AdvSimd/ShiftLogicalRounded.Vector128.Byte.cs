...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ShiftLogicalRounded_Vector128_Byte()
        {
    ...
    public sealed unsafe class SimpleBinaryOpTest__ShiftLogicalRounded_Vector128_Byte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__ShiftLogicalRounded_Vector128_Byte testClass
            )
            {
        ...
        static SimpleBinaryOpTest__ShiftLogicalRounded_Vector128_Byte()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetByte();
        ...
        public SimpleBinaryOpTest__ShiftLogicalRounded_Vector128_Byte()
        {
            Succeeded = true;
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ShiftLogicalRounded)}<Byte>(Vector128<Byte>, Vector128<SByte>): {method} failed:"
                    );
