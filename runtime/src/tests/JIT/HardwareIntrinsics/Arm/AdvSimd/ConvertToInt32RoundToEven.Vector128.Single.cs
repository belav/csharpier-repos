...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ConvertToInt32RoundToEven_Vector128_Single()
        {
            var test = new SimpleUnaryOpTest__ConvertToInt32RoundToEven_Vector128_Single();
    ...
    public sealed unsafe class SimpleUnaryOpTest__ConvertToInt32RoundToEven_Vector128_Single
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__ConvertToInt32RoundToEven_Vector128_Single testClass
            )
            {
        ...
        static SimpleUnaryOpTest__ConvertToInt32RoundToEven_Vector128_Single()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetSingle();
        ...
        public SimpleUnaryOpTest__ConvertToInt32RoundToEven_Vector128_Single()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(
                    nameof(AdvSimd.ConvertToInt32RoundToEven),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.ConvertToInt32RoundToEven(_clsVar1);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ConvertToInt32RoundToEven)}<Int32>(Vector128<Single>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
