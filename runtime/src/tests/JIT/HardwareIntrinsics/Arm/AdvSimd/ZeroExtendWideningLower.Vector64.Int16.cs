    ...
    public sealed unsafe class SimpleUnaryOpTest__ZeroExtendWideningLower_Vector64_Int16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__ZeroExtendWideningLower_Vector64_Int16 testClass
            )
            {
        ...
        public void RunClassLclFldScenario_Load()
        {
            ...
            {
                var result = AdvSimd.ZeroExtendWideningLower(AdvSimd.LoadVector64((Int16*)(pFld1)));
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ZeroExtendWideningLower)}<Int32>(Vector64<Int16>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
