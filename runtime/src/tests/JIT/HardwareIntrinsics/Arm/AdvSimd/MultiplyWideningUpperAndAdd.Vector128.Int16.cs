...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void MultiplyWideningUpperAndAdd_Vector128_Int16()
        {
    ...
    public sealed unsafe class SimpleTernaryOpTest__MultiplyWideningUpperAndAdd_Vector128_Int16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleTernaryOpTest__MultiplyWideningUpperAndAdd_Vector128_Int16 testClass
            )
            {
        ...
        static SimpleTernaryOpTest__MultiplyWideningUpperAndAdd_Vector128_Int16()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetInt32();
        ...
        public SimpleTernaryOpTest__MultiplyWideningUpperAndAdd_Vector128_Int16()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(
                    nameof(AdvSimd.MultiplyWideningUpperAndAdd),
                    new Type[]
                    {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.MultiplyWideningUpperAndAdd(_clsVar1, _clsVar2, _clsVar3);
        ...
        public void RunClassFldScenario_Load()
        {
            ...
            fixed (Vector128<Int32>* pFld1 = &_fld1)fixed (Vector128<Int16>* pFld2 = &_fld2)fixed (
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd)}.{nameof(AdvSimd.MultiplyWideningUpperAndAdd)}<Int32>(Vector128<Int32>, Vector128<Int16>, Vector128<Int16>): {method} failed:"
                );
                TestLibrary.TestFramework.LogInformation(
