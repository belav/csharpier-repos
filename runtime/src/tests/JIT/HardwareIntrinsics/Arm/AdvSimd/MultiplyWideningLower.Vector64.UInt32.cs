    ...
    public sealed unsafe class SimpleBinaryOpTest__MultiplyWideningLower_Vector64_UInt32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__MultiplyWideningLower_Vector64_UInt32 testClass
            )
            {
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.MultiplyWideningLower)}<UInt64>(Vector64<UInt32>, Vector64<UInt32>): {method} failed:"
                    );
