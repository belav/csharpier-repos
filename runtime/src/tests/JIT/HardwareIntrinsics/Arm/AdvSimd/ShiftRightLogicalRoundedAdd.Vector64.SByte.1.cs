...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ShiftRightLogicalRoundedAdd_Vector64_SByte_1()
        {
    ...
    public sealed unsafe class ImmBinaryOpTest__ShiftRightLogicalRoundedAdd_Vector64_SByte_1
    {
        ...
        static ImmBinaryOpTest__ShiftRightLogicalRoundedAdd_Vector64_SByte_1()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetSByte();
        ...
        public ImmBinaryOpTest__ShiftRightLogicalRoundedAdd_Vector64_SByte_1()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(
                    nameof(AdvSimd.ShiftRightLogicalRoundedAdd),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.ShiftRightLogicalRoundedAdd(_clsVar1, _clsVar2, 1);
        ...
        private void ValidateResult(
            Vector64<SByte> firstOp,
            Vector64<SByte> secondOp,
            void* result,
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd)}.{nameof(AdvSimd.ShiftRightLogicalRoundedAdd)}<SByte>(Vector64<SByte>, Vector64<SByte>, 1): {method} failed:"
                );
                TestLibrary.TestFramework.LogInformation(
