    ...
    public sealed unsafe class StoreSelectedScalarTest__StoreSelectedScalar_Vector64_UInt16_3
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                StoreSelectedScalarTest__StoreSelectedScalar_Vector64_UInt16_3 testClass
            )
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            typeof(AdvSimd)
                .GetMethod(
                    ...
                    new Type[] { typeof(UInt16*), typeof(Vector64<UInt16>), typeof(byte) }
                )
                .Invoke(
                    null,
                    new object[]
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.StoreSelectedScalar)}<UInt16>(UInt16*, Vector64<UInt16>, 3): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
