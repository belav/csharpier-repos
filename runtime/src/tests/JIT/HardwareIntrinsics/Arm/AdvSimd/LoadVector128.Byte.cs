...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void LoadVector128_Byte()
        {
            var test = new LoadUnaryOpTest__LoadVector128_Byte();
    ...
    public sealed unsafe class LoadUnaryOpTest__LoadVector128_Byte
    {
        ...
        public LoadUnaryOpTest__LoadVector128_Byte()
        {
            Succeeded = true;
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var result = AdvSimd.LoadVector128((Byte*)(_dataTable.inArray1Ptr));
        ...
        public void RunReflectionScenario_Load()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(nameof(AdvSimd.LoadVector128), new Type[] { typeof(Byte*) })
                .Invoke(null, new object[] { Pointer.Box(_dataTable.inArray1Ptr, typeof(Byte*)) });
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.LoadVector128)}<Byte>(Vector128<Byte>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
