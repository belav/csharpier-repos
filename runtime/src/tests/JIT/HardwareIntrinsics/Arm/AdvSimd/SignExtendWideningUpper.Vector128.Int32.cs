...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void SignExtendWideningUpper_Vector128_Int32()
        {
            var test = new SimpleUnaryOpTest__SignExtendWideningUpper_Vector128_Int32();
    ...
    public sealed unsafe class SimpleUnaryOpTest__SignExtendWideningUpper_Vector128_Int32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__SignExtendWideningUpper_Vector128_Int32 testClass
            )
            {
        ...
        static SimpleUnaryOpTest__SignExtendWideningUpper_Vector128_Int32()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetInt32();
        ...
        public SimpleUnaryOpTest__SignExtendWideningUpper_Vector128_Int32()
        {
            Succeeded = true;
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.SignExtendWideningUpper)}<Int64>(Vector128<Int32>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
