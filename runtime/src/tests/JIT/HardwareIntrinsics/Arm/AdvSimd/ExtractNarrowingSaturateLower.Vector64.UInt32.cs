...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ExtractNarrowingSaturateLower_Vector64_UInt32()
        {
            var test = new SimpleUnaryOpTest__ExtractNarrowingSaturateLower_Vector64_UInt32();
    ...
    public sealed unsafe class SimpleUnaryOpTest__ExtractNarrowingSaturateLower_Vector64_UInt32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__ExtractNarrowingSaturateLower_Vector64_UInt32 testClass
            )
            {
        ...
        static SimpleUnaryOpTest__ExtractNarrowingSaturateLower_Vector64_UInt32()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetUInt64();
        ...
        public SimpleUnaryOpTest__ExtractNarrowingSaturateLower_Vector64_UInt32()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                ...
                .Invoke(
                    null,
                    new object[] { Unsafe.Read<Vector128<UInt64>>(_dataTable.inArray1Ptr) }
                );
        ...
        public void RunReflectionScenario_Load()
        {
            ...
            var result = typeof(AdvSimd)
                ...
                .Invoke(
                    null,
                    new object[] { AdvSimd.LoadVector128((UInt64*)(_dataTable.inArray1Ptr)) }
                );
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ExtractNarrowingSaturateLower)}<UInt32>(Vector128<UInt64>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
