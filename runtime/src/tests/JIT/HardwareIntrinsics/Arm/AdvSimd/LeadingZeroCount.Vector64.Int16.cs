    ...
    public sealed unsafe class SimpleUnaryOpTest__LeadingZeroCount_Vector64_Int16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__LeadingZeroCount_Vector64_Int16 testClass
            )
            {
            ...
            )
            {
                ...
                {
                    var result = AdvSimd.LeadingZeroCount(AdvSimd.LoadVector64((Int16*)(pFld1)));
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(nameof(AdvSimd.LeadingZeroCount), new Type[] { typeof(Vector64<Int16>) })
                .Invoke(
                    null,
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            {
                var result = AdvSimd.LeadingZeroCount(AdvSimd.LoadVector64((Int16*)(pClsVar1)));
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = AdvSimd.LeadingZeroCount(AdvSimd.LoadVector64((Int16*)(&test._fld1)));
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.LeadingZeroCount)}<Int16>(Vector64<Int16>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
