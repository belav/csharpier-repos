...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void SubtractSaturateScalar_Vector64_UInt64()
        {
            var test = new SimpleBinaryOpTest__SubtractSaturateScalar_Vector64_UInt64();
    ...
    public sealed unsafe class SimpleBinaryOpTest__SubtractSaturateScalar_Vector64_UInt64
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__SubtractSaturateScalar_Vector64_UInt64 testClass
            )
            {
                var result = AdvSimd.SubtractSaturateScalar(_fld1, _fld2);
            ...
            )
            {
                ...
                {
                    var result = AdvSimd.SubtractSaturateScalar(
        ...
        static SimpleBinaryOpTest__SubtractSaturateScalar_Vector64_UInt64()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetUInt64();
        ...
        public SimpleBinaryOpTest__SubtractSaturateScalar_Vector64_UInt64()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(
                    nameof(AdvSimd.SubtractSaturateScalar),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.SubtractSaturateScalar(_clsVar1, _clsVar2);
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.SubtractSaturateScalar(op1, op2);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimpleBinaryOpTest__SubtractSaturateScalar_Vector64_UInt64();
            var result = AdvSimd.SubtractSaturateScalar(test._fld1, test._fld2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.SubtractSaturateScalar)}<UInt64>(Vector64<UInt64>, Vector64<UInt64>): {method} failed:"
                    );
