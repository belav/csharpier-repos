    ...
    public sealed unsafe class SimpleUnaryOpTest__ExtractNarrowingSaturateLower_Vector64_Int16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__ExtractNarrowingSaturateLower_Vector64_Int16 testClass
            )
            {
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ExtractNarrowingSaturateLower)}<Int16>(Vector128<Int32>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
