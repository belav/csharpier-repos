    ...
    public sealed unsafe class SimpleBinaryOpTest__VectorTableLookup_Vector64_Byte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario_Load(
                ...
                fixed (Vector128<Byte>* pFld1 = &_fld1)fixed (Vector64<Byte>* pFld2 = &_fld2)
                {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(
                    ...
                    new Type[] { typeof(Vector128<Byte>), typeof(Vector64<Byte>) }
                )
                .Invoke(
                    null,
                    new object[]
        ...
        public void RunClassLclFldScenario_Load()
        {
            ...
            fixed (Vector128<Byte>* pFld1 = &test._fld1)fixed (Vector64<Byte>* pFld2 = &test._fld2)
            {
                var result = AdvSimd.VectorTableLookup(
                    AdvSimd.LoadVector128((Byte*)(pFld1)),
                    AdvSimd.LoadVector64((Byte*)(pFld2))
        ...
        private void ValidateResult(
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd)}.{nameof(AdvSimd.VectorTableLookup)}<Byte>(Vector128<Byte>, Vector64<Byte>): {method} failed:"
                );
