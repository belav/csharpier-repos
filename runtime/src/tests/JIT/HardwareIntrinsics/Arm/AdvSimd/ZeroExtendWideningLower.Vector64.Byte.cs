...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ZeroExtendWideningLower_Vector64_Byte()
        {
    ...
    public sealed unsafe class SimpleUnaryOpTest__ZeroExtendWideningLower_Vector64_Byte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__ZeroExtendWideningLower_Vector64_Byte testClass
            )
            {
        ...
        static SimpleUnaryOpTest__ZeroExtendWideningLower_Vector64_Byte()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetByte();
        ...
        public SimpleUnaryOpTest__ZeroExtendWideningLower_Vector64_Byte()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(
                    nameof(AdvSimd.ZeroExtendWideningLower),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.ZeroExtendWideningLower(_clsVar1);
        ...
        public void RunClassLclFldScenario_Load()
        {
            ...
            {
                var result = AdvSimd.ZeroExtendWideningLower(AdvSimd.LoadVector64((Byte*)(pFld1)));
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ZeroExtendWideningLower)}<UInt16>(Vector64<Byte>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
