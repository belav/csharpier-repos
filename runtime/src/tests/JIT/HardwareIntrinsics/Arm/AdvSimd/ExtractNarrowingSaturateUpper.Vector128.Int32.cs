...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ExtractNarrowingSaturateUpper_Vector128_Int32()
        {
            var test = new SimpleBinaryOpTest__ExtractNarrowingSaturateUpper_Vector128_Int32();
    ...
    public sealed unsafe class SimpleBinaryOpTest__ExtractNarrowingSaturateUpper_Vector128_Int32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__ExtractNarrowingSaturateUpper_Vector128_Int32 testClass
            )
            {
        ...
        static SimpleBinaryOpTest__ExtractNarrowingSaturateUpper_Vector128_Int32()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetInt32();
        ...
        public SimpleBinaryOpTest__ExtractNarrowingSaturateUpper_Vector128_Int32()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(
                    nameof(AdvSimd.ExtractNarrowingSaturateUpper),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.ExtractNarrowingSaturateUpper(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ExtractNarrowingSaturateUpper)}<Int32>(Vector64<Int32>, Vector128<Int64>): {method} failed:"
                    );
