...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void AddWideningUpper_Vector128_UInt64_Vector128_UInt32()
        {
    ...
    public sealed unsafe class SimpleBinaryOpTest__AddWideningUpper_Vector128_UInt64_Vector128_UInt32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__AddWideningUpper_Vector128_UInt64_Vector128_UInt32 testClass
            )
            {
        ...
        static SimpleBinaryOpTest__AddWideningUpper_Vector128_UInt64_Vector128_UInt32()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetUInt64();
        ...
        public SimpleBinaryOpTest__AddWideningUpper_Vector128_UInt64_Vector128_UInt32()
        {
            Succeeded = true;
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.AddWideningUpper)}<UInt64>(Vector128<UInt64>, Vector128<UInt32>): {method} failed:"
                    );
