...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ConvertToUInt32RoundToPositiveInfinityScalar_Vector64_Single()
        {
            var test =
                new SimpleUnaryOpTest__ConvertToUInt32RoundToPositiveInfinityScalar_Vector64_Single();
    ...
    public sealed unsafe class SimpleUnaryOpTest__ConvertToUInt32RoundToPositiveInfinityScalar_Vector64_Single
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__ConvertToUInt32RoundToPositiveInfinityScalar_Vector64_Single testClass
            )
            {
                var result = AdvSimd.ConvertToUInt32RoundToPositiveInfinityScalar(_fld1);
            ...
            )
            {
                ...
                {
                    var result = AdvSimd.ConvertToUInt32RoundToPositiveInfinityScalar(
        ...
        static SimpleUnaryOpTest__ConvertToUInt32RoundToPositiveInfinityScalar_Vector64_Single()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetSingle();
        ...
        public SimpleUnaryOpTest__ConvertToUInt32RoundToPositiveInfinityScalar_Vector64_Single()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(
                    nameof(AdvSimd.ConvertToUInt32RoundToPositiveInfinityScalar),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.ConvertToUInt32RoundToPositiveInfinityScalar(_clsVar1);
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.ConvertToUInt32RoundToPositiveInfinityScalar(op1);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test =
                new SimpleUnaryOpTest__ConvertToUInt32RoundToPositiveInfinityScalar_Vector64_Single();
            var result = AdvSimd.ConvertToUInt32RoundToPositiveInfinityScalar(test._fld1);
        ...
        )
        {
            ...
            if (Helpers.ConvertToUInt32RoundToPositiveInfinity(firstOp[0]) != result[0])
            {
                succeeded = false;
            }
            else
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ConvertToUInt32RoundToPositiveInfinityScalar)}<UInt32>(Vector64<Single>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
