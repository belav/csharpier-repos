...
namespace JIT.HardwareIntrinsics.Arm
{
    public static partial class Program
    {
        ...
        {
            var test =
                new SimpleTernaryOpTest__MultiplySubtractBySelectedScalar_Vector128_UInt16_Vector64_UInt16_3();
    ...
    public sealed unsafe class SimpleTernaryOpTest__MultiplySubtractBySelectedScalar_Vector128_UInt16_Vector64_UInt16_3
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleTernaryOpTest__MultiplySubtractBySelectedScalar_Vector128_UInt16_Vector64_UInt16_3 testClass
            )
            {
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.MultiplySubtractBySelectedScalar)}<UInt16>(Vector128<UInt16>, Vector128<UInt16>, Vector64<UInt16>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
