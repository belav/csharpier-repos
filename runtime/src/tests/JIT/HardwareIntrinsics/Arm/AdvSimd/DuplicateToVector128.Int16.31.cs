...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void DuplicateToVector128_Int16_31()
        {
            var test = new ImmOpTest__DuplicateToVector128_Int16_31();
    ...
    public sealed unsafe class ImmOpTest__DuplicateToVector128_Int16_31
    {
        ...
        public ImmOpTest__DuplicateToVector128_Int16_31()
        {
            Succeeded = true;
        ...
        public void RunBasicScenario()
        {
            ...
            var result = AdvSimd.DuplicateToVector128((Int16)31);
        ...
        public void RunReflectionScenario()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(nameof(AdvSimd.DuplicateToVector128), new Type[] { typeof(Int16) })
        ...
        private void ValidateResult(Int16[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.DuplicateToVector128)}<Int16>(31): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
