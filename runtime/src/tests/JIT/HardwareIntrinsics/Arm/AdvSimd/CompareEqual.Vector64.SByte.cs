...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void CompareEqual_Vector64_SByte()
        {
            var test = new SimpleBinaryOpTest__CompareEqual_Vector64_SByte();
    ...
    public sealed unsafe class SimpleBinaryOpTest__CompareEqual_Vector64_SByte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__CompareEqual_Vector64_SByte testClass
            )
            {
        ...
        static SimpleBinaryOpTest__CompareEqual_Vector64_SByte()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetSByte();
        ...
        public SimpleBinaryOpTest__CompareEqual_Vector64_SByte()
        {
            Succeeded = true;
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.CompareEqual(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd)}.{nameof(AdvSimd.CompareEqual)}<SByte>(Vector64<SByte>, Vector64<SByte>): {method} failed:"
                );
