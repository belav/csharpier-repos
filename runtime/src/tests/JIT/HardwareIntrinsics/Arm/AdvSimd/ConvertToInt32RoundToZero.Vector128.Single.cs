...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ConvertToInt32RoundToZero_Vector128_Single()
        {
            var test = new SimpleUnaryOpTest__ConvertToInt32RoundToZero_Vector128_Single();
    ...
    public sealed unsafe class SimpleUnaryOpTest__ConvertToInt32RoundToZero_Vector128_Single
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__ConvertToInt32RoundToZero_Vector128_Single testClass
            )
            {
                var result = AdvSimd.ConvertToInt32RoundToZero(_fld1);
            ...
            )
            {
                ...
                {
                    var result = AdvSimd.ConvertToInt32RoundToZero(
        ...
        static SimpleUnaryOpTest__ConvertToInt32RoundToZero_Vector128_Single()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetSingle();
        ...
        public SimpleUnaryOpTest__ConvertToInt32RoundToZero_Vector128_Single()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(
                    nameof(AdvSimd.ConvertToInt32RoundToZero),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.ConvertToInt32RoundToZero(_clsVar1);
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.ConvertToInt32RoundToZero(op1);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimpleUnaryOpTest__ConvertToInt32RoundToZero_Vector128_Single();
            var result = AdvSimd.ConvertToInt32RoundToZero(test._fld1);
        ...
        )
        {
            ...
            {
                if (Helpers.ConvertToInt32RoundToZero(firstOp[i]) != result[i])
                {
                    succeeded = false;
                    break;
                }
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ConvertToInt32RoundToZero)}<Int32>(Vector128<Single>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
