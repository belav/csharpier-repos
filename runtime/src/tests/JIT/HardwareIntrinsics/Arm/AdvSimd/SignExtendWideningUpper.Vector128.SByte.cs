...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void SignExtendWideningUpper_Vector128_SByte()
        {
    ...
    public sealed unsafe class SimpleUnaryOpTest__SignExtendWideningUpper_Vector128_SByte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__SignExtendWideningUpper_Vector128_SByte testClass
            )
            {
        ...
        static SimpleUnaryOpTest__SignExtendWideningUpper_Vector128_SByte()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetSByte();
        ...
        public SimpleUnaryOpTest__SignExtendWideningUpper_Vector128_SByte()
        {
            Succeeded = true;
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.SignExtendWideningUpper)}<Int16>(Vector128<SByte>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
