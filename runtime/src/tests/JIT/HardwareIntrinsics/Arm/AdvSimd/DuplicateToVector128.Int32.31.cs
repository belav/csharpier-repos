...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    public sealed unsafe class ImmOpTest__DuplicateToVector128_Int32_31
    {
        ...
        public void RunBasicScenario()
        {
            ...
            var result = AdvSimd.DuplicateToVector128((Int32)31);
        ...
        public void RunReflectionScenario()
        {
            ...
            var result = typeof(AdvSimd)
                ...
                .Invoke(null, new object[] { (Int32)31 });
        ...
        private void ValidateResult(Int32[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.DuplicateToVector128)}<Int32>(31): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
