    ...
    public sealed unsafe class SimpleTernaryOpTest__MultiplySubtractByScalar_Vector128_Int32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleTernaryOpTest__MultiplySubtractByScalar_Vector128_Int32 testClass
            )
            {
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.MultiplySubtractByScalar)}<Int32>(Vector128<Int32>, Vector128<Int32>, Vector64<Int32>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
