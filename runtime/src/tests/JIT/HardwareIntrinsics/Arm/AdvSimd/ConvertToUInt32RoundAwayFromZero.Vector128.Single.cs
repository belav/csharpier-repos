    ...
    public sealed unsafe class SimpleUnaryOpTest__ConvertToUInt32RoundAwayFromZero_Vector128_Single
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__ConvertToUInt32RoundAwayFromZero_Vector128_Single testClass
            )
            {
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ConvertToUInt32RoundAwayFromZero)}<UInt32>(Vector128<Single>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
