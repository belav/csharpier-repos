...
namespace JIT.HardwareIntrinsics.Arm
{
    public static partial class Program
    {
        ...
        {
            var test =
                new SimpleUnaryOpTest__ConvertToUInt32RoundToPositiveInfinity_Vector64_Single();
    ...
    public sealed unsafe class SimpleUnaryOpTest__ConvertToUInt32RoundToPositiveInfinity_Vector64_Single
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__ConvertToUInt32RoundToPositiveInfinity_Vector64_Single testClass
            )
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(
                    nameof(AdvSimd.ConvertToUInt32RoundToPositiveInfinity),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.ConvertToUInt32RoundToPositiveInfinity(_clsVar1);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ConvertToUInt32RoundToPositiveInfinity)}<UInt32>(Vector64<Single>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
