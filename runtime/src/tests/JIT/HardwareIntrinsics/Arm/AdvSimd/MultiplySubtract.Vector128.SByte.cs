    ...
    public sealed unsafe class SimpleTernaryOpTest__MultiplySubtract_Vector128_SByte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleTernaryOpTest__MultiplySubtract_Vector128_SByte testClass
            )
            {
            ...
            {
                fixed (Vector128<SByte>* pFld1 = &_fld1)fixed (
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd)}.{nameof(AdvSimd.MultiplySubtract)}<SByte>(Vector128<SByte>, Vector128<SByte>, Vector128<SByte>): {method} failed:"
                );
                TestLibrary.TestFramework.LogInformation(
