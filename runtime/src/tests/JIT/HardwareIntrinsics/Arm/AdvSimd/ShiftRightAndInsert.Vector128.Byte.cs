    ...
    public sealed unsafe class ImmBinaryOpTest__ShiftRightAndInsert_Vector128_Byte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                ImmBinaryOpTest__ShiftRightAndInsert_Vector128_Byte testClass
            )
            {
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ShiftRightAndInsert)}<Byte>(Vector128<Byte>, Vector128<Byte>, 4): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
