    ...
    public sealed unsafe class SimpleBinaryOpTest__AddWideningLower_Vector128_Int32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__AddWideningLower_Vector128_Int32 testClass
            )
            {
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.AddWideningLower)}<Int32>(Vector128<Int32>, Vector64<Int16>): {method} failed:"
                    );
