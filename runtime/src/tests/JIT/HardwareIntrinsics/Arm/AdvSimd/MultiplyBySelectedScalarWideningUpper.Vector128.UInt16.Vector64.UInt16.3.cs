...
namespace JIT.HardwareIntrinsics.Arm
{
    public static partial class Program
    {
        ...
        {
            var test =
                new ImmBinaryOpTest__MultiplyBySelectedScalarWideningUpper_Vector128_UInt16_Vector64_UInt16_3();
    ...
    public sealed unsafe class ImmBinaryOpTest__MultiplyBySelectedScalarWideningUpper_Vector128_UInt16_Vector64_UInt16_3
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                ImmBinaryOpTest__MultiplyBySelectedScalarWideningUpper_Vector128_UInt16_Vector64_UInt16_3 testClass
            ) {
            ...
            public void RunStructFldScenario_Load(
                ...
                fixed (Vector128<UInt16>* pFld1 = &_fld1)fixed (Vector64<UInt16>* pFld2 = &_fld2)
                {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(
                    nameof(AdvSimd.MultiplyBySelectedScalarWideningUpper),
                    new Type[] { typeof(Vector128<UInt16>), typeof(Vector64<UInt16>), typeof(byte) }
                )
                .Invoke(
                    null,
                    new object[]
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.MultiplyBySelectedScalarWideningUpper(_clsVar1, _clsVar2, 3);
        ...
        private void ValidateResult(
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd)}.{nameof(AdvSimd.MultiplyBySelectedScalarWideningUpper)}<UInt32>(Vector128<UInt16>, Vector64<UInt16>, 3): {method} failed:"
                );
                TestLibrary.TestFramework.LogInformation(
