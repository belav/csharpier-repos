...
namespace JIT.HardwareIntrinsics.Arm
{
    public static partial class Program
    {
        ...
        {
            var test =
                new SimpleUnaryOpTest__ConvertToUInt32RoundAwayFromZeroScalar_Vector64_Single();
    ...
    public sealed unsafe class SimpleUnaryOpTest__ConvertToUInt32RoundAwayFromZeroScalar_Vector64_Single
    {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(
                    nameof(AdvSimd.ConvertToUInt32RoundAwayFromZeroScalar),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.ConvertToUInt32RoundAwayFromZeroScalar(_clsVar1);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ConvertToUInt32RoundAwayFromZeroScalar)}<UInt32>(Vector64<Single>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
