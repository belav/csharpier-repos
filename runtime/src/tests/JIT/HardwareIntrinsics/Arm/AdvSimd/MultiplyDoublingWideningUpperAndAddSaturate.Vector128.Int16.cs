...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void MultiplyDoublingWideningUpperAndAddSaturate_Vector128_Int16()
        {
            var test =
                new SimpleTernaryOpTest__MultiplyDoublingWideningUpperAndAddSaturate_Vector128_Int16();
    ...
    public sealed unsafe class SimpleTernaryOpTest__MultiplyDoublingWideningUpperAndAddSaturate_Vector128_Int16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleTernaryOpTest__MultiplyDoublingWideningUpperAndAddSaturate_Vector128_Int16 testClass
            )
            {
        ...
        static SimpleTernaryOpTest__MultiplyDoublingWideningUpperAndAddSaturate_Vector128_Int16()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetInt32();
        ...
        public SimpleTernaryOpTest__MultiplyDoublingWideningUpperAndAddSaturate_Vector128_Int16()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(
                    nameof(AdvSimd.MultiplyDoublingWideningUpperAndAddSaturate),
                    new Type[]
                    {
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.MultiplyDoublingWideningUpperAndAddSaturate(op1, op2, op3);
        ...
        )
        {
            ...
            {
                if (
                    Helpers.MultiplyDoublingWideningUpperAndAddSaturate(
                        firstOp,
                        secondOp,
                        thirdOp,
                        i
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.MultiplyDoublingWideningUpperAndAddSaturate)}<Int32>(Vector128<Int32>, Vector128<Int16>, Vector128<Int16>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
