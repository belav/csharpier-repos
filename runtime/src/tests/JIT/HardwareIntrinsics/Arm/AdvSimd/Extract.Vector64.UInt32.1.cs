...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void Extract_Vector64_UInt32_1()
        {
            var test = new ExtractTest__Extract_Vector64_UInt32_1();
    ...
    public sealed unsafe class ExtractTest__Extract_Vector64_UInt32_1
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(ExtractTest__Extract_Vector64_UInt32_1 testClass)
            {
            ...
            public void RunStructFldScenario_Load(ExtractTest__Extract_Vector64_UInt32_1 testClass)
            {
        ...
        static ExtractTest__Extract_Vector64_UInt32_1()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetUInt32();
        ...
        public ExtractTest__Extract_Vector64_UInt32_1()
        {
            Succeeded = true;
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            {
                var result = AdvSimd.Extract(AdvSimd.LoadVector64((UInt32*)pClsVar1), ElementIndex);
        ...
        public void RunClassLclFldScenario_Load()
        {
            ...
            {
                var result = AdvSimd.Extract(AdvSimd.LoadVector64((UInt32*)(pFld1)), ElementIndex);
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = AdvSimd.Extract(AdvSimd.LoadVector64((UInt32*)&test._fld1), ElementIndex);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.Extract)}(Vector64<UInt32>, 1): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
