...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ShiftLeftLogicalSaturateUnsignedScalar_Vector64_Int64_1()
        {
            var test =
                new ImmUnaryOpTest__ShiftLeftLogicalSaturateUnsignedScalar_Vector64_Int64_1();
    ...
    public sealed unsafe class ImmUnaryOpTest__ShiftLeftLogicalSaturateUnsignedScalar_Vector64_Int64_1
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                ImmUnaryOpTest__ShiftLeftLogicalSaturateUnsignedScalar_Vector64_Int64_1 testClass
            )
            {
                var result = AdvSimd.ShiftLeftLogicalSaturateUnsignedScalar(_fld, 1);
            ...
            )
            {
                ...
                {
                    var result = AdvSimd.ShiftLeftLogicalSaturateUnsignedScalar(
        ...
        static ImmUnaryOpTest__ShiftLeftLogicalSaturateUnsignedScalar_Vector64_Int64_1()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data[i] = TestLibrary.Generator.GetInt64();
        ...
        public ImmUnaryOpTest__ShiftLeftLogicalSaturateUnsignedScalar_Vector64_Int64_1()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(
                    nameof(AdvSimd.ShiftLeftLogicalSaturateUnsignedScalar),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.ShiftLeftLogicalSaturateUnsignedScalar(_clsVar, 1);
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.ShiftLeftLogicalSaturateUnsignedScalar(firstOp, 1);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test =
                new ImmUnaryOpTest__ShiftLeftLogicalSaturateUnsignedScalar_Vector64_Int64_1();
            var result = AdvSimd.ShiftLeftLogicalSaturateUnsignedScalar(test._fld, 1);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ShiftLeftLogicalSaturateUnsignedScalar)}<UInt64>(Vector64<Int64>, 1): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
