...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void SubtractRoundedHighNarrowingLower_Vector64_Byte()
        {
            var test = new SimpleBinaryOpTest__SubtractRoundedHighNarrowingLower_Vector64_Byte();
    ...
    public sealed unsafe class SimpleBinaryOpTest__SubtractRoundedHighNarrowingLower_Vector64_Byte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__SubtractRoundedHighNarrowingLower_Vector64_Byte testClass
            )
            {
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.SubtractRoundedHighNarrowingLower)}<Byte>(Vector128<UInt16>, Vector128<UInt16>): {method} failed:"
                    );
