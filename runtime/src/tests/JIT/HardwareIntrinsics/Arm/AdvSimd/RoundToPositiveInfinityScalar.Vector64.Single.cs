...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void RoundToPositiveInfinityScalar_Vector64_Single()
        {
            var test = new SimpleUnaryOpTest__RoundToPositiveInfinityScalar_Vector64_Single();
    ...
    public sealed unsafe class SimpleUnaryOpTest__RoundToPositiveInfinityScalar_Vector64_Single
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__RoundToPositiveInfinityScalar_Vector64_Single testClass
            )
            {
        ...
        static SimpleUnaryOpTest__RoundToPositiveInfinityScalar_Vector64_Single()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetSingle();
        ...
        public SimpleUnaryOpTest__RoundToPositiveInfinityScalar_Vector64_Single()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(
                    nameof(AdvSimd.RoundToPositiveInfinityScalar),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.RoundToPositiveInfinityScalar(_clsVar1);
        ...
        )
        {
            ...
            if (
                BitConverter.SingleToInt32Bits(Helpers.RoundToPositiveInfinity(firstOp[0]))
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.RoundToPositiveInfinityScalar)}<Single>(Vector64<Single>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
