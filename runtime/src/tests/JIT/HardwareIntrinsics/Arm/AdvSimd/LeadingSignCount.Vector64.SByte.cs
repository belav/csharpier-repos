    ...
    public sealed unsafe class SimpleUnaryOpTest__LeadingSignCount_Vector64_SByte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__LeadingSignCount_Vector64_SByte testClass
            )
            {
            ...
            )
            {
                ...
                {
                    var result = AdvSimd.LeadingSignCount(AdvSimd.LoadVector64((SByte*)(pFld1)));
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(nameof(AdvSimd.LeadingSignCount), new Type[] { typeof(Vector64<SByte>) })
                .Invoke(
                    null,
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            {
                var result = AdvSimd.LeadingSignCount(AdvSimd.LoadVector64((SByte*)(pClsVar1)));
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = AdvSimd.LeadingSignCount(AdvSimd.LoadVector64((SByte*)(&test._fld1)));
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.LeadingSignCount)}<SByte>(Vector64<SByte>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
