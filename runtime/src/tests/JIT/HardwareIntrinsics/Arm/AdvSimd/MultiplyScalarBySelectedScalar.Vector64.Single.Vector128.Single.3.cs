...
namespace JIT.HardwareIntrinsics.Arm
{
    public static partial class Program
    {
        ...
        {
            var test =
                new ImmBinaryOpTest__MultiplyScalarBySelectedScalar_Vector64_Single_Vector128_Single_3();
    ...
    public sealed unsafe class ImmBinaryOpTest__MultiplyScalarBySelectedScalar_Vector64_Single_Vector128_Single_3
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                ImmBinaryOpTest__MultiplyScalarBySelectedScalar_Vector64_Single_Vector128_Single_3 testClass
            )
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(
                    nameof(AdvSimd.MultiplyScalarBySelectedScalar),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.MultiplyScalarBySelectedScalar(_clsVar1, _clsVar2, 3);
        ...
        )
        {
            ...
            if (
                BitConverter.SingleToInt32Bits(Helpers.Multiply(firstOp[0], secondOp[Imm]))
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.MultiplyScalarBySelectedScalar)}<Single>(Vector64<Single>, Vector128<Single>, 3): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
