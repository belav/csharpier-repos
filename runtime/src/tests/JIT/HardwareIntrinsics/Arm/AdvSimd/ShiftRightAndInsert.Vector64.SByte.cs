    ...
    public sealed unsafe class ImmBinaryOpTest__ShiftRightAndInsert_Vector64_SByte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                ImmBinaryOpTest__ShiftRightAndInsert_Vector64_SByte testClass
            )
            {
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ShiftRightAndInsert)}<SByte>(Vector64<SByte>, Vector64<SByte>, 4): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
