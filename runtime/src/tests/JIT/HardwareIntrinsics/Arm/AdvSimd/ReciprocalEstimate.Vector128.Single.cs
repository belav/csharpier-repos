    ...
    public sealed unsafe class SimpleUnaryOpTest__ReciprocalEstimate_Vector128_Single
    {
        ...
        private struct TestStruct
        {
            ...
            public static TestStruct Create()
            {
                ...
                {
                    _data1[i] = BitConverter.Int32BitsToSingle(0x3e4ed9ed);
                }
                Unsafe.CopyBlockUnaligned(
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__ReciprocalEstimate_Vector128_Single testClass
            )
            {
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            {
                var result = AdvSimd.ReciprocalEstimate(AdvSimd.LoadVector128((Single*)(pClsVar1)));
        ...
        public void RunClassLclFldScenario_Load()
        {
            ...
            {
                var result = AdvSimd.ReciprocalEstimate(AdvSimd.LoadVector128((Single*)(pFld1)));
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = AdvSimd.ReciprocalEstimate(AdvSimd.LoadVector128((Single*)(&test._fld1)));
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ReciprocalEstimate)}<Single>(Vector128<Single>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
