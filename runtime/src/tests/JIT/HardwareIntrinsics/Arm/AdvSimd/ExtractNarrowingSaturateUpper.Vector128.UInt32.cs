    ...
    public sealed unsafe class SimpleBinaryOpTest__ExtractNarrowingSaturateUpper_Vector128_UInt32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__ExtractNarrowingSaturateUpper_Vector128_UInt32 testClass
            )
            {
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ExtractNarrowingSaturateUpper)}<UInt32>(Vector64<UInt32>, Vector128<UInt64>): {method} failed:"
                    );
