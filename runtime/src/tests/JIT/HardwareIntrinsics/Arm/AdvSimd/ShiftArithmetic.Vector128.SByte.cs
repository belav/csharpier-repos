    ...
    public sealed unsafe class SimpleBinaryOpTest__ShiftArithmetic_Vector128_SByte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__ShiftArithmetic_Vector128_SByte testClass
            )
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(
                    nameof(AdvSimd.ShiftArithmetic),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.ShiftArithmetic(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ShiftArithmetic)}<SByte>(Vector128<SByte>, Vector128<SByte>): {method} failed:"
                    );
