    ...
    public sealed unsafe class SimpleBinaryOpTest__ExtractNarrowingSaturateUpper_Vector128_Int16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__ExtractNarrowingSaturateUpper_Vector128_Int16 testClass
            )
            {
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ExtractNarrowingSaturateUpper)}<Int16>(Vector64<Int16>, Vector128<Int32>): {method} failed:"
                    );
