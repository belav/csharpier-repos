...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void AbsoluteDifferenceWideningUpper_Vector128_Int16()
        {
    ...
    public sealed unsafe class SimpleBinaryOpTest__AbsoluteDifferenceWideningUpper_Vector128_Int16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__AbsoluteDifferenceWideningUpper_Vector128_Int16 testClass
            )
            {
        ...
        static SimpleBinaryOpTest__AbsoluteDifferenceWideningUpper_Vector128_Int16()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetInt16();
        ...
        public SimpleBinaryOpTest__AbsoluteDifferenceWideningUpper_Vector128_Int16()
        {
            Succeeded = true;
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.AbsoluteDifferenceWideningUpper)}<UInt32>(Vector128<Int16>, Vector128<Int16>): {method} failed:"
                    );
