...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void AddHighNarrowingUpper_Vector128_SByte()
        {
            var test = new SimpleTernaryOpTest__AddHighNarrowingUpper_Vector128_SByte();
    ...
    public sealed unsafe class SimpleTernaryOpTest__AddHighNarrowingUpper_Vector128_SByte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleTernaryOpTest__AddHighNarrowingUpper_Vector128_SByte testClass
            ) {
        ...
        public SimpleTernaryOpTest__AddHighNarrowingUpper_Vector128_SByte()
        {
            Succeeded = true;
        ...
        private void ValidateResult(
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd)}.{nameof(AdvSimd.AddHighNarrowingUpper)}<SByte>(Vector64<SByte>, Vector128<Int16>, Vector128<Int16>): {method} failed:"
                );
                TestLibrary.TestFramework.LogInformation(
