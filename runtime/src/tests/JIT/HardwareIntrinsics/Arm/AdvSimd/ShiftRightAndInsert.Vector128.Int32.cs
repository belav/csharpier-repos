    ...
    public sealed unsafe class ImmBinaryOpTest__ShiftRightAndInsert_Vector128_Int32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                ImmBinaryOpTest__ShiftRightAndInsert_Vector128_Int32 testClass
            )
            {
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ShiftRightAndInsert)}<Int32>(Vector128<Int32>, Vector128<Int32>, 16): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
