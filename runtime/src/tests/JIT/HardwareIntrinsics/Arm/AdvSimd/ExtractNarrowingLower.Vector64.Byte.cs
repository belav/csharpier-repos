    ...
    public sealed unsafe class SimpleUnaryOpTest__ExtractNarrowingLower_Vector64_Byte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__ExtractNarrowingLower_Vector64_Byte testClass
            )
            {
        ...
        public void RunClassLclFldScenario_Load()
        {
            ...
            {
                var result = AdvSimd.ExtractNarrowingLower(AdvSimd.LoadVector128((UInt16*)(pFld1)));
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ExtractNarrowingLower)}<Byte>(Vector128<UInt16>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
