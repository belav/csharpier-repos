...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void Insert_Vector128_Double_1()
        {
            var test = new InsertTest__Insert_Vector128_Double_1();
    ...
    public sealed unsafe class InsertTest__Insert_Vector128_Double_1
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(InsertTest__Insert_Vector128_Double_1 testClass)
            {
            ...
            public void RunStructFldScenario_Load(InsertTest__Insert_Vector128_Double_1 testClass)
            {
        ...
        static InsertTest__Insert_Vector128_Double_1()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetDouble();
        ...
        public InsertTest__Insert_Vector128_Double_1()
        {
            Succeeded = true;
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.Insert)}<Double>(Vector128<Double>, 1, Double): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
