...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void CompareGreaterThanOrEqual_Vector128_UInt32()
        {
            var test = new SimpleBinaryOpTest__CompareGreaterThanOrEqual_Vector128_UInt32();
    ...
    public sealed unsafe class SimpleBinaryOpTest__CompareGreaterThanOrEqual_Vector128_UInt32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__CompareGreaterThanOrEqual_Vector128_UInt32 testClass
            )
            {
            ...
            {
                fixed (Vector128<UInt32>* pFld1 = &_fld1)fixed (Vector128<UInt32>* pFld2 = &_fld2)
                {
        ...
        static SimpleBinaryOpTest__CompareGreaterThanOrEqual_Vector128_UInt32()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetUInt32();
        ...
        public SimpleBinaryOpTest__CompareGreaterThanOrEqual_Vector128_UInt32()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(
                    nameof(AdvSimd.CompareGreaterThanOrEqual),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.CompareGreaterThanOrEqual(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd)}.{nameof(AdvSimd.CompareGreaterThanOrEqual)}<UInt32>(Vector128<UInt32>, Vector128<UInt32>): {method} failed:"
                );
