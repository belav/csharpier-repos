...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void MultiplySubtract_Vector128_UInt16()
        {
            var test = new SimpleTernaryOpTest__MultiplySubtract_Vector128_UInt16();
    ...
    public sealed unsafe class SimpleTernaryOpTest__MultiplySubtract_Vector128_UInt16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleTernaryOpTest__MultiplySubtract_Vector128_UInt16 testClass
            )
            {
        ...
        static SimpleTernaryOpTest__MultiplySubtract_Vector128_UInt16()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetUInt16();
        ...
        public SimpleTernaryOpTest__MultiplySubtract_Vector128_UInt16()
        {
            Succeeded = true;
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.MultiplySubtract)}<UInt16>(Vector128<UInt16>, Vector128<UInt16>, Vector128<UInt16>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
