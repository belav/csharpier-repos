...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ShiftLogicalRounded_Vector128_UInt16()
        {
            var test = new SimpleBinaryOpTest__ShiftLogicalRounded_Vector128_UInt16();
    ...
    public sealed unsafe class SimpleBinaryOpTest__ShiftLogicalRounded_Vector128_UInt16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__ShiftLogicalRounded_Vector128_UInt16 testClass
            ) {
            ...
            public void RunStructFldScenario_Load(
                ...
                fixed (Vector128<UInt16>* pFld1 = &_fld1)fixed (Vector128<Int16>* pFld2 = &_fld2)
                {
        ...
        static SimpleBinaryOpTest__ShiftLogicalRounded_Vector128_UInt16()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetUInt16();
        ...
        public SimpleBinaryOpTest__ShiftLogicalRounded_Vector128_UInt16()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(
                    nameof(AdvSimd.ShiftLogicalRounded),
                    new Type[] { typeof(Vector128<UInt16>), typeof(Vector128<Int16>) }
                )
                .Invoke(
                    null,
                    new object[]
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.ShiftLogicalRounded(_clsVar1, _clsVar2);
        ...
        private void ValidateResult(
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd)}.{nameof(AdvSimd.ShiftLogicalRounded)}<UInt16>(Vector128<UInt16>, Vector128<Int16>): {method} failed:"
                );
