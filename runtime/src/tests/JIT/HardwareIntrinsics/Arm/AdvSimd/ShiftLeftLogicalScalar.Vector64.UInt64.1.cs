    ...
    public sealed unsafe class ImmUnaryOpTest__ShiftLeftLogicalScalar_Vector64_UInt64_1
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                ImmUnaryOpTest__ShiftLeftLogicalScalar_Vector64_UInt64_1 testClass
            )
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(
                    nameof(AdvSimd.ShiftLeftLogicalScalar),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.ShiftLeftLogicalScalar(_clsVar, 1);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ShiftLeftLogicalScalar)}<UInt64>(Vector64<UInt64>, 1): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
