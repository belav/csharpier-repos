    ...
    public sealed unsafe class SimpleBinaryOpTest__MultiplyByScalar_Vector64_UInt16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__MultiplyByScalar_Vector64_UInt16 testClass
            )
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(
                    nameof(AdvSimd.MultiplyByScalar),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.MultiplyByScalar(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.MultiplyByScalar)}<UInt16>(Vector64<UInt16>, Vector64<UInt16>): {method} failed:"
                    );
