...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void LoadVector128_UInt64()
        {
            var test = new LoadUnaryOpTest__LoadVector128_UInt64();
    ...
    public sealed unsafe class LoadUnaryOpTest__LoadVector128_UInt64
    {
        ...
        public LoadUnaryOpTest__LoadVector128_UInt64()
        {
            Succeeded = true;
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var result = AdvSimd.LoadVector128((UInt64*)(_dataTable.inArray1Ptr));
        ...
        public void RunReflectionScenario_Load()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(nameof(AdvSimd.LoadVector128), new Type[] { typeof(UInt64*) })
                .Invoke(
                    null,
                    new object[] { Pointer.Box(_dataTable.inArray1Ptr, typeof(UInt64*)) }
                );
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.LoadVector128)}<UInt64>(Vector128<UInt64>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
