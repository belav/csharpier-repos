...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void NegateSaturate_Vector128_Int32()
        {
            var test = new SimpleUnaryOpTest__NegateSaturate_Vector128_Int32();
    ...
    public sealed unsafe class SimpleUnaryOpTest__NegateSaturate_Vector128_Int32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__NegateSaturate_Vector128_Int32 testClass
            )
            {
            ...
            )
            {
                ...
                {
                    var result = AdvSimd.NegateSaturate(AdvSimd.LoadVector128((Int32*)(pFld1)));
        ...
        static SimpleUnaryOpTest__NegateSaturate_Vector128_Int32()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = Int32.MinValue;
        ...
        public SimpleUnaryOpTest__NegateSaturate_Vector128_Int32()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(nameof(AdvSimd.NegateSaturate), new Type[] { typeof(Vector128<Int32>) })
                .Invoke(
                    null,
                    new object[] { Unsafe.Read<Vector128<Int32>>(_dataTable.inArray1Ptr) }
                );
        ...
        public void RunReflectionScenario_Load()
        {
            ...
            var result = typeof(AdvSimd)
                ...
                .Invoke(
                    null,
                    new object[] { AdvSimd.LoadVector128((Int32*)(_dataTable.inArray1Ptr)) }
                );
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.NegateSaturate(_clsVar1);
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            {
                var result = AdvSimd.NegateSaturate(AdvSimd.LoadVector128((Int32*)(pClsVar1)));
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = AdvSimd.NegateSaturate(AdvSimd.LoadVector128((Int32*)(&test._fld1)));
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.NegateSaturate)}<Int32>(Vector128<Int32>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
