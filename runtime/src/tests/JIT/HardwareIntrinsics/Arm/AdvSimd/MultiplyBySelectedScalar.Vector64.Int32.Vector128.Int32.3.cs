...
namespace JIT.HardwareIntrinsics.Arm
{
    public static partial class Program
    {
        ...
        {
            var test =
                new ImmBinaryOpTest__MultiplyBySelectedScalar_Vector64_Int32_Vector128_Int32_3();
    ...
    public sealed unsafe class ImmBinaryOpTest__MultiplyBySelectedScalar_Vector64_Int32_Vector128_Int32_3
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                ImmBinaryOpTest__MultiplyBySelectedScalar_Vector64_Int32_Vector128_Int32_3 testClass
            )
            {
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.MultiplyBySelectedScalar)}<Int32>(Vector64<Int32>, Vector128<Int32>, 3): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
