    ...
    public sealed unsafe class SimpleBinaryOpTest__ShiftLogical_Vector128_SByte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__ShiftLogical_Vector128_SByte testClass
            )
            {
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ShiftLogical)}<SByte>(Vector128<SByte>, Vector128<SByte>): {method} failed:"
                    );
