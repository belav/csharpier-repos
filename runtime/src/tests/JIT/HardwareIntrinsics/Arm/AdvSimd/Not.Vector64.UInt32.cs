...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void Not_Vector64_UInt32()
        {
            var test = new SimpleUnaryOpTest__Not_Vector64_UInt32();
    ...
    public sealed unsafe class SimpleUnaryOpTest__Not_Vector64_UInt32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleUnaryOpTest__Not_Vector64_UInt32 testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleUnaryOpTest__Not_Vector64_UInt32 testClass)
            {
                fixed (Vector64<UInt32>* pFld1 = &_fld1)
                {
                    var result = AdvSimd.Not(AdvSimd.LoadVector64((UInt32*)(pFld1)));
        ...
        static SimpleUnaryOpTest__Not_Vector64_UInt32()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetUInt32();
        ...
        public SimpleUnaryOpTest__Not_Vector64_UInt32()
        {
            Succeeded = true;
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.Not(Unsafe.Read<Vector64<UInt32>>(_dataTable.inArray1Ptr));
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var result = AdvSimd.Not(AdvSimd.LoadVector64((UInt32*)(_dataTable.inArray1Ptr)));
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(nameof(AdvSimd.Not), new Type[] { typeof(Vector64<UInt32>) })
                .Invoke(
                    null,
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            {
                var result = AdvSimd.Not(AdvSimd.LoadVector64((UInt32*)(pClsVar1)));
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = AdvSimd.Not(AdvSimd.LoadVector64((UInt32*)(&test._fld1)));
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.Not)}<UInt32>(Vector64<UInt32>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
