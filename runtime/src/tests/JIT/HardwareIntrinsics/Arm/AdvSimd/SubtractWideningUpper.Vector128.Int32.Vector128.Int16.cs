...
namespace JIT.HardwareIntrinsics.Arm
{
    public static partial class Program
    {
        ...
        {
            var test =
                new SimpleBinaryOpTest__SubtractWideningUpper_Vector128_Int32_Vector128_Int16();
    ...
    public sealed unsafe class SimpleBinaryOpTest__SubtractWideningUpper_Vector128_Int32_Vector128_Int16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__SubtractWideningUpper_Vector128_Int32_Vector128_Int16 testClass
            )
            {
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd)}.{nameof(AdvSimd.SubtractWideningUpper)}<Int32>(Vector128<Int32>, Vector128<Int16>): {method} failed:"
                );
