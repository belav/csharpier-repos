...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ShiftRightLogicalNarrowingLower_Vector64_UInt16_1()
        {
    ...
    public sealed unsafe class ImmUnaryOpTest__ShiftRightLogicalNarrowingLower_Vector64_UInt16_1
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                ImmUnaryOpTest__ShiftRightLogicalNarrowingLower_Vector64_UInt16_1 testClass
            )
            {
        ...
        static ImmUnaryOpTest__ShiftRightLogicalNarrowingLower_Vector64_UInt16_1()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data[i] = TestLibrary.Generator.GetUInt32();
        ...
        public ImmUnaryOpTest__ShiftRightLogicalNarrowingLower_Vector64_UInt16_1()
        {
            Succeeded = true;
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ShiftRightLogicalNarrowingLower)}<UInt16>(Vector128<UInt32>, 1): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
