    ...
    public sealed unsafe class ImmBinaryOpTest__ShiftLeftAndInsert_Vector128_UInt16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                ImmBinaryOpTest__ShiftLeftAndInsert_Vector128_UInt16 testClass
            )
            {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.ShiftLeftAndInsert(_clsVar1, _clsVar2, 8);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ShiftLeftAndInsert)}<UInt16>(Vector128<UInt16>, Vector128<UInt16>, 8): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
