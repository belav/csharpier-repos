...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void CompareLessThanOrEqual_Vector128_Int16()
        {
            var test = new SimpleBinaryOpTest__CompareLessThanOrEqual_Vector128_Int16();
    ...
    public sealed unsafe class SimpleBinaryOpTest__CompareLessThanOrEqual_Vector128_Int16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__CompareLessThanOrEqual_Vector128_Int16 testClass
            )
            {
        ...
        static SimpleBinaryOpTest__CompareLessThanOrEqual_Vector128_Int16()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetInt16();
        ...
        public SimpleBinaryOpTest__CompareLessThanOrEqual_Vector128_Int16()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(
                    nameof(AdvSimd.CompareLessThanOrEqual),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.CompareLessThanOrEqual(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.CompareLessThanOrEqual)}<Int16>(Vector128<Int16>, Vector128<Int16>): {method} failed:"
                    );
