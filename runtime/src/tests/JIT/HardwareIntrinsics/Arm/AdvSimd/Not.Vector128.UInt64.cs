...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void Not_Vector128_UInt64()
        {
            var test = new SimpleUnaryOpTest__Not_Vector128_UInt64();
    ...
    public sealed unsafe class SimpleUnaryOpTest__Not_Vector128_UInt64
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleUnaryOpTest__Not_Vector128_UInt64 testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleUnaryOpTest__Not_Vector128_UInt64 testClass)
            {
                fixed (Vector128<UInt64>* pFld1 = &_fld1)
                {
                    var result = AdvSimd.Not(AdvSimd.LoadVector128((UInt64*)(pFld1)));
        ...
        static SimpleUnaryOpTest__Not_Vector128_UInt64()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetUInt64();
        ...
        public SimpleUnaryOpTest__Not_Vector128_UInt64()
        {
            Succeeded = true;
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.Not(Unsafe.Read<Vector128<UInt64>>(_dataTable.inArray1Ptr));
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var result = AdvSimd.Not(AdvSimd.LoadVector128((UInt64*)(_dataTable.inArray1Ptr)));
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(nameof(AdvSimd.Not), new Type[] { typeof(Vector128<UInt64>) })
                .Invoke(
                    null,
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            {
                var result = AdvSimd.Not(AdvSimd.LoadVector128((UInt64*)(pClsVar1)));
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = AdvSimd.Not(AdvSimd.LoadVector128((UInt64*)(&test._fld1)));
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.Not)}<UInt64>(Vector128<UInt64>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
