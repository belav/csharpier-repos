    ...
    public sealed unsafe class ImmBinaryOpTest__ShiftLeftAndInsert_Vector128_Int32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                ImmBinaryOpTest__ShiftLeftAndInsert_Vector128_Int32 testClass
            )
            {
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ShiftLeftAndInsert)}<Int32>(Vector128<Int32>, Vector128<Int32>, 16): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
