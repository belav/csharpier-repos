    ...
    public sealed unsafe class SimpleTernaryOpTest__MultiplyWideningLowerAndSubtract_Vector64_Byte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleTernaryOpTest__MultiplyWideningLowerAndSubtract_Vector64_Byte testClass
            ) {
        ...
        public void RunClassFldScenario_Load()
        {
            ...
            fixed (Vector128<UInt16>* pFld1 = &_fld1)fixed (Vector64<Byte>* pFld2 = &_fld2)fixed (
        ...
        private void ValidateResult(
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd)}.{nameof(AdvSimd.MultiplyWideningLowerAndSubtract)}<UInt16>(Vector128<UInt16>, Vector64<Byte>, Vector64<Byte>): {method} failed:"
                );
                TestLibrary.TestFramework.LogInformation(
