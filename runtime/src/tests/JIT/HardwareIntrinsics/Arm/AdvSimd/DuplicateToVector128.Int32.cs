...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void DuplicateToVector128_Int32()
        {
    ...
    public sealed unsafe class DuplicateUnaryOpTest__DuplicateToVector128_Int32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                DuplicateUnaryOpTest__DuplicateToVector128_Int32 testClass
            )
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(nameof(AdvSimd.DuplicateToVector128), new Type[] { typeof(Int32) })
                .Invoke(
                    null,
                    new object[]
                    {
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.DuplicateToVector128)}<Int32>(Int32): DuplicateToVector128 failed:"
                    );
