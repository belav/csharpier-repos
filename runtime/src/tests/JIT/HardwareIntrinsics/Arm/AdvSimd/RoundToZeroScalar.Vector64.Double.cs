...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void RoundToZeroScalar_Vector64_Double()
        {
            var test = new SimpleUnaryOpTest__RoundToZeroScalar_Vector64_Double();
    ...
    public sealed unsafe class SimpleUnaryOpTest__RoundToZeroScalar_Vector64_Double
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__RoundToZeroScalar_Vector64_Double testClass
            )
            {
            ...
            )
            {
                ...
                {
                    var result = AdvSimd.RoundToZeroScalar(AdvSimd.LoadVector64((Double*)(pFld1)));
        ...
        static SimpleUnaryOpTest__RoundToZeroScalar_Vector64_Double()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetDouble();
        ...
        public SimpleUnaryOpTest__RoundToZeroScalar_Vector64_Double()
        {
            Succeeded = true;
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            {
                var result = AdvSimd.RoundToZeroScalar(AdvSimd.LoadVector64((Double*)(pClsVar1)));
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = AdvSimd.RoundToZeroScalar(AdvSimd.LoadVector64((Double*)(&test._fld1)));
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.RoundToZeroScalar)}<Double>(Vector64<Double>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
