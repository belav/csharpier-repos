...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ReverseElement16_Vector128_UInt32()
        {
            var test = new SimpleUnaryOpTest__ReverseElement16_Vector128_UInt32();
    ...
    public sealed unsafe class SimpleUnaryOpTest__ReverseElement16_Vector128_UInt32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__ReverseElement16_Vector128_UInt32 testClass
            )
            {
            ...
            )
            {
                ...
                {
                    var result = AdvSimd.ReverseElement16(AdvSimd.LoadVector128((UInt32*)(pFld1)));
        ...
        static SimpleUnaryOpTest__ReverseElement16_Vector128_UInt32()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetUInt32();
        ...
        public SimpleUnaryOpTest__ReverseElement16_Vector128_UInt32()
        {
            Succeeded = true;
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            {
                var result = AdvSimd.ReverseElement16(AdvSimd.LoadVector128((UInt32*)(pClsVar1)));
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = AdvSimd.ReverseElement16(AdvSimd.LoadVector128((UInt32*)(&test._fld1)));
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ReverseElement16)}<UInt32>(Vector128<UInt32>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
