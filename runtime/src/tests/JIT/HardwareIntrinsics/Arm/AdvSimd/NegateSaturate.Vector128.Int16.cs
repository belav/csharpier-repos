...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void NegateSaturate_Vector128_Int16()
        {
            var test = new SimpleUnaryOpTest__NegateSaturate_Vector128_Int16();
    ...
    public sealed unsafe class SimpleUnaryOpTest__NegateSaturate_Vector128_Int16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__NegateSaturate_Vector128_Int16 testClass
            )
            {
            ...
            )
            {
                ...
                {
                    var result = AdvSimd.NegateSaturate(AdvSimd.LoadVector128((Int16*)(pFld1)));
        ...
        static SimpleUnaryOpTest__NegateSaturate_Vector128_Int16()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = Int16.MinValue;
        ...
        public SimpleUnaryOpTest__NegateSaturate_Vector128_Int16()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(nameof(AdvSimd.NegateSaturate), new Type[] { typeof(Vector128<Int16>) })
                .Invoke(
                    null,
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            {
                var result = AdvSimd.NegateSaturate(AdvSimd.LoadVector128((Int16*)(pClsVar1)));
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = AdvSimd.NegateSaturate(AdvSimd.LoadVector128((Int16*)(&test._fld1)));
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.NegateSaturate)}<Int16>(Vector128<Int16>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
