    ...
    public sealed unsafe class SimpleUnaryOpTest__RoundAwayFromZeroScalar_Vector64_Double
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__RoundAwayFromZeroScalar_Vector64_Double testClass
            )
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(
                    nameof(AdvSimd.RoundAwayFromZeroScalar),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.RoundAwayFromZeroScalar(_clsVar1);
        ...
        )
        {
            ...
            if (
                BitConverter.DoubleToInt64Bits(Helpers.RoundAwayFromZero(firstOp[0]))
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.RoundAwayFromZeroScalar)}<Double>(Vector64<Double>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
