...
namespace JIT.HardwareIntrinsics.Arm
{
    public static partial class Program
    {
        ...
        {
            var test =
                new SimpleBinaryOpTest__MultiplyRoundedDoublingByScalarSaturateHigh_Vector128_Int32();
    ...
    public sealed unsafe class SimpleBinaryOpTest__MultiplyRoundedDoublingByScalarSaturateHigh_Vector128_Int32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__MultiplyRoundedDoublingByScalarSaturateHigh_Vector128_Int32 testClass
            )
            {
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.MultiplyRoundedDoublingByScalarSaturateHigh)}<Int32>(Vector128<Int32>, Vector64<Int32>): {method} failed:"
                    );
