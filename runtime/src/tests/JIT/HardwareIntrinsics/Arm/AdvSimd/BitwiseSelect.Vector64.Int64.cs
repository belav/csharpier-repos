    ...
    public sealed unsafe class SimpleTernaryOpTest__BitwiseSelect_Vector64_Int64
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleTernaryOpTest__BitwiseSelect_Vector64_Int64 testClass
            )
            {
        ...
        public void RunClassFldScenario_Load()
        {
            ...
            fixed (Vector64<Int64>* pFld1 = &_fld1)fixed (Vector64<Int64>* pFld2 = &_fld2)fixed (
                Vector64<Int64>* pFld3 = &_fld3
            )
            {
                var result = AdvSimd.BitwiseSelect(
                    AdvSimd.LoadVector64((Int64*)(pFld1)),
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd)}.{nameof(AdvSimd.BitwiseSelect)}<Int64>(Vector64<Int64>, Vector64<Int64>, Vector64<Int64>): {method} failed:"
                );
                TestLibrary.TestFramework.LogInformation(
