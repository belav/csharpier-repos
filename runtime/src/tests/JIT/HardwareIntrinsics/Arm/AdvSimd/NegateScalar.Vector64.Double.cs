    ...
    public sealed unsafe class SimpleUnaryOpTest__NegateScalar_Vector64_Double
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__NegateScalar_Vector64_Double testClass
            )
            {
            ...
            )
            {
                ...
                {
                    var result = AdvSimd.NegateScalar(AdvSimd.LoadVector64((Double*)(pFld1)));
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(nameof(AdvSimd.NegateScalar), new Type[] { typeof(Vector64<Double>) })
                .Invoke(
                    null,
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            {
                var result = AdvSimd.NegateScalar(AdvSimd.LoadVector64((Double*)(pClsVar1)));
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = AdvSimd.NegateScalar(AdvSimd.LoadVector64((Double*)(&test._fld1)));
        ...
        )
        {
            ...
            if (
                BitConverter.DoubleToInt64Bits(Helpers.Negate(firstOp[0]))
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.NegateScalar)}<Double>(Vector64<Double>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
