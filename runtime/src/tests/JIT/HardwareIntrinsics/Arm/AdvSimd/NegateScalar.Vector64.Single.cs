...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void NegateScalar_Vector64_Single()
        {
            var test = new SimpleUnaryOpTest__NegateScalar_Vector64_Single();
    ...
    public sealed unsafe class SimpleUnaryOpTest__NegateScalar_Vector64_Single
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__NegateScalar_Vector64_Single testClass
            )
            {
            ...
            )
            {
                ...
                {
                    var result = AdvSimd.NegateScalar(AdvSimd.LoadVector64((Single*)(pFld1)));
        ...
        static SimpleUnaryOpTest__NegateScalar_Vector64_Single()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetSingle();
        ...
        public SimpleUnaryOpTest__NegateScalar_Vector64_Single()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(nameof(AdvSimd.NegateScalar), new Type[] { typeof(Vector64<Single>) })
                .Invoke(
                    null,
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.NegateScalar(_clsVar1);
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            {
                var result = AdvSimd.NegateScalar(AdvSimd.LoadVector64((Single*)(pClsVar1)));
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = AdvSimd.NegateScalar(AdvSimd.LoadVector64((Single*)(&test._fld1)));
        ...
        )
        {
            ...
            if (
                BitConverter.SingleToInt32Bits(Helpers.Negate(firstOp[0]))
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.NegateScalar)}<Single>(Vector64<Single>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
