...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ReciprocalSquareRootStep_Vector128_Single()
        {
            var test = new SimpleBinaryOpTest__ReciprocalSquareRootStep_Vector128_Single();
    ...
    public sealed unsafe class SimpleBinaryOpTest__ReciprocalSquareRootStep_Vector128_Single
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__ReciprocalSquareRootStep_Vector128_Single testClass
            )
            {
        ...
        static SimpleBinaryOpTest__ReciprocalSquareRootStep_Vector128_Single()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetSingle();
        ...
        public SimpleBinaryOpTest__ReciprocalSquareRootStep_Vector128_Single()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(
                    nameof(AdvSimd.ReciprocalSquareRootStep),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.ReciprocalSquareRootStep(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            {
                if (
                    BitConverter.SingleToInt32Bits(Helpers.FPRSqrtStepFused(left[i], right[i]))
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ReciprocalSquareRootStep)}<Single>(Vector128<Single>, Vector128<Single>): {method} failed:"
                    );
