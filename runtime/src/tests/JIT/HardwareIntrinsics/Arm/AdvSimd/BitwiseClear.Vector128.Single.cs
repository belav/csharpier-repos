    ...
    public sealed unsafe class SimpleBinaryOpTest__BitwiseClear_Vector128_Single
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__BitwiseClear_Vector128_Single testClass
            )
            {
        ...
        )
        {
            ...
            {
                if (
                    BitConverter.SingleToInt32Bits(Helpers.BitwiseClear(left[i], right[i]))
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.BitwiseClear)}<Single>(Vector128<Single>, Vector128<Single>): {method} failed:"
                    );
