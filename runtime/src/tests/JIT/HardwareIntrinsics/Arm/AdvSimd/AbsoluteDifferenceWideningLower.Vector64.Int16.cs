...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void AbsoluteDifferenceWideningLower_Vector64_Int16()
        {
            var test = new SimpleBinaryOpTest__AbsoluteDifferenceWideningLower_Vector64_Int16();
    ...
    public sealed unsafe class SimpleBinaryOpTest__AbsoluteDifferenceWideningLower_Vector64_Int16
    {
        private struct DataTable
        {
            ...
            public DataTable(Int16[] inArray1, Int16[] inArray2, UInt32[] outArray, int alignment)
            {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__AbsoluteDifferenceWideningLower_Vector64_Int16 testClass
            )
            {
        ...
        static SimpleBinaryOpTest__AbsoluteDifferenceWideningLower_Vector64_Int16()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetInt16();
        ...
        public SimpleBinaryOpTest__AbsoluteDifferenceWideningLower_Vector64_Int16()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(
                    ...
                    new Type[] { typeof(Vector64<Int16>), typeof(Vector64<Int16>) }
                )
                .Invoke(
                    null,
                    new object[]
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd)}.{nameof(AdvSimd.AbsoluteDifferenceWideningLower)}<UInt32>(Vector64<Int16>, Vector64<Int16>): {method} failed:"
                );
