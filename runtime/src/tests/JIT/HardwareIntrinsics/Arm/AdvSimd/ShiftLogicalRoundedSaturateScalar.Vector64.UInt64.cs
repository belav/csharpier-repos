...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ShiftLogicalRoundedSaturateScalar_Vector64_UInt64()
        {
    ...
    public sealed unsafe class SimpleBinaryOpTest__ShiftLogicalRoundedSaturateScalar_Vector64_UInt64
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__ShiftLogicalRoundedSaturateScalar_Vector64_UInt64 testClass
            ) {
            ...
            public void RunStructFldScenario_Load(
                ...
                fixed (Vector64<UInt64>* pFld1 = &_fld1)fixed (Vector64<Int64>* pFld2 = &_fld2)
                {
        ...
        static SimpleBinaryOpTest__ShiftLogicalRoundedSaturateScalar_Vector64_UInt64()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetUInt64();
        ...
        public SimpleBinaryOpTest__ShiftLogicalRoundedSaturateScalar_Vector64_UInt64()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(
                    ...
                    new Type[] { typeof(Vector64<UInt64>), typeof(Vector64<Int64>) }
                )
                .Invoke(
                    null,
                    new object[]
        ...
        public void RunClassLclFldScenario_Load()
        {
            ...
            fixed (Vector64<UInt64>* pFld1 = &test._fld1)fixed (
                Vector64<Int64>* pFld2 = &test._fld2
            ) {
                var result = AdvSimd.ShiftLogicalRoundedSaturateScalar(
                    AdvSimd.LoadVector64((UInt64*)(pFld1)),
                    AdvSimd.LoadVector64((Int64*)(pFld2))
        ...
        private void ValidateResult(
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd)}.{nameof(AdvSimd.ShiftLogicalRoundedSaturateScalar)}<UInt64>(Vector64<UInt64>, Vector64<Int64>): {method} failed:"
                );
