...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    public sealed unsafe class SimpleBinaryOpTest__SubtractScalar_Vector64_Single
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__SubtractScalar_Vector64_Single testClass
            )
            {
        ...
        static SimpleBinaryOpTest__SubtractScalar_Vector64_Single()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetSingle();
        ...
        public SimpleBinaryOpTest__SubtractScalar_Vector64_Single()
        {
            Succeeded = true;
        ...
        )
        {
            ...
            if (
                BitConverter.SingleToInt32Bits(Helpers.Subtract(left[0], right[0]))
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.SubtractScalar)}<Single>(Vector64<Single>, Vector64<Single>): {method} failed:"
                    );
