...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void FusedMultiplyAdd_Vector128_Single()
        {
    ...
    public sealed unsafe class SimpleTernaryOpTest__FusedMultiplyAdd_Vector128_Single
    {
        private struct DataTable
        {
            ...
            )
            {
                ...
                Unsafe.CopyBlockUnaligned(
                    ...
                    ref Unsafe.As<Single, byte>(ref inArray3[0]),
                    (uint)sizeOfinArray3
                );
            }
        ...
        private struct TestStruct
        {
            ...
            public static TestStruct Create()
            {
                ...
                Unsafe.CopyBlockUnaligned(
                    ref Unsafe.As<Vector128<Single>, byte>(ref testStruct._fld1),
                ...
                Unsafe.CopyBlockUnaligned(
                    ref Unsafe.As<Vector128<Single>, byte>(ref testStruct._fld2),
                ...
                Unsafe.CopyBlockUnaligned(
                    ref Unsafe.As<Vector128<Single>, byte>(ref testStruct._fld3),
                    ref Unsafe.As<Single, byte>(ref _data3[0]),
                    (uint)Unsafe.SizeOf<Vector128<Single>>()
                );
            ...
            public void RunStructFldScenario(
                SimpleTernaryOpTest__FusedMultiplyAdd_Vector128_Single testClass
            )
            {
                var result = AdvSimd.FusedMultiplyAdd(_fld1, _fld2, _fld3);
            ...
            )
            {
                ...
                {
                    var result = AdvSimd.FusedMultiplyAdd(
        ...
        static SimpleTernaryOpTest__FusedMultiplyAdd_Vector128_Single()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetSingle();
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector128<Single>, byte>(ref _clsVar1),
                ref Unsafe.As<Single, byte>(ref _data1[0]),
                (uint)Unsafe.SizeOf<Vector128<Single>>()
            );
            for (var i = 0; i < Op2ElementCount; i++)
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector128<Single>, byte>(ref _clsVar2),
                ref Unsafe.As<Single, byte>(ref _data2[0]),
                (uint)Unsafe.SizeOf<Vector128<Single>>()
            );
            for (var i = 0; i < Op3ElementCount; i++)
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector128<Single>, byte>(ref _clsVar3),
                ref Unsafe.As<Single, byte>(ref _data3[0]),
                (uint)Unsafe.SizeOf<Vector128<Single>>()
            );
        }

        public SimpleTernaryOpTest__FusedMultiplyAdd_Vector128_Single()
        {
            Succeeded = true;
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector128<Single>, byte>(ref _fld1),
                ref Unsafe.As<Single, byte>(ref _data1[0]),
                (uint)Unsafe.SizeOf<Vector128<Single>>()
            );
            for (var i = 0; i < Op2ElementCount; i++)
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector128<Single>, byte>(ref _fld2),
                ref Unsafe.As<Single, byte>(ref _data2[0]),
                (uint)Unsafe.SizeOf<Vector128<Single>>()
            );
            for (var i = 0; i < Op3ElementCount; i++)
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector128<Single>, byte>(ref _fld3),
                ref Unsafe.As<Single, byte>(ref _data3[0]),
                (uint)Unsafe.SizeOf<Vector128<Single>>()
            );
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(
                    nameof(AdvSimd.FusedMultiplyAdd),
                    new Type[]
                    {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.FusedMultiplyAdd(_clsVar1, _clsVar2, _clsVar3);
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.FusedMultiplyAdd(op1, op2, op3);
        ...
        )
        {
            ...
            for (var i = 0; i < RetElementCount; i++)
            {
                if (
                    BitConverter.SingleToInt32Bits(
                        Helpers.FusedMultiplyAdd(firstOp[i], secondOp[i], thirdOp[i])
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.FusedMultiplyAdd)}<Single>(Vector128<Single>, Vector128<Single>, Vector128<Single>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
