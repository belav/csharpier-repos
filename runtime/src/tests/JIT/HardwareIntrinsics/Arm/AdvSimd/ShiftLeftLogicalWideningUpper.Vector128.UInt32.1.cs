...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ShiftLeftLogicalWideningUpper_Vector128_UInt32_1()
        {
    ...
    public sealed unsafe class ImmUnaryOpTest__ShiftLeftLogicalWideningUpper_Vector128_UInt32_1
    {
        private struct DataTable
        {
            ...
            public DataTable(UInt32[] inArray, UInt64[] outArray, int alignment)
            {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                ImmUnaryOpTest__ShiftLeftLogicalWideningUpper_Vector128_UInt32_1 testClass
            )
            {
        ...
        static ImmUnaryOpTest__ShiftLeftLogicalWideningUpper_Vector128_UInt32_1()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data[i] = TestLibrary.Generator.GetUInt32();
        ...
        public ImmUnaryOpTest__ShiftLeftLogicalWideningUpper_Vector128_UInt32_1()
        {
            Succeeded = true;
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ShiftLeftLogicalWideningUpper)}<UInt64>(Vector128<UInt32>, 1): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
