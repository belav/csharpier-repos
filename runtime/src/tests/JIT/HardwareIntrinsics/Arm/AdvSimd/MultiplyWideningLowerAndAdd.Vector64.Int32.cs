...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void MultiplyWideningLowerAndAdd_Vector64_Int32()
        {
    ...
    public sealed unsafe class SimpleTernaryOpTest__MultiplyWideningLowerAndAdd_Vector64_Int32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleTernaryOpTest__MultiplyWideningLowerAndAdd_Vector64_Int32 testClass
            )
            {
        ...
        static SimpleTernaryOpTest__MultiplyWideningLowerAndAdd_Vector64_Int32()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetInt64();
        ...
        public SimpleTernaryOpTest__MultiplyWideningLowerAndAdd_Vector64_Int32()
        {
            Succeeded = true;
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.MultiplyWideningLowerAndAdd)}<Int64>(Vector128<Int64>, Vector64<Int32>, Vector64<Int32>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
