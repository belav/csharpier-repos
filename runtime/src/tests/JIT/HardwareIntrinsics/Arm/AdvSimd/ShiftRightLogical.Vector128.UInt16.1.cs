...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ShiftRightLogical_Vector128_UInt16_1()
        {
    ...
    public sealed unsafe class ImmUnaryOpTest__ShiftRightLogical_Vector128_UInt16_1
    {
        ...
        private struct TestStruct
        {
            ...
            public static TestStruct Create()
            {
                ...
                {
                    _data[i] = TestLibrary.Generator.GetUInt16();
                }
                Unsafe.CopyBlockUnaligned(
                    ref Unsafe.As<Vector128<UInt16>, byte>(ref testStruct._fld),
            ...
            public void RunStructFldScenario(
                ImmUnaryOpTest__ShiftRightLogical_Vector128_UInt16_1 testClass
            )
            {
        ...
        static ImmUnaryOpTest__ShiftRightLogical_Vector128_UInt16_1()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data[i] = TestLibrary.Generator.GetUInt16();
        ...
        public ImmUnaryOpTest__ShiftRightLogical_Vector128_UInt16_1()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(
                    ...
                    new Type[] { typeof(Vector128<UInt16>), typeof(byte) }
                )
                .Invoke(
                    null,
                    new object[] { Unsafe.Read<Vector128<UInt16>>(_dataTable.inArrayPtr), (byte)1 }
                );
        ...
        public void RunClassLclFldScenario_Load()
        {
            ...
            {
                var result = AdvSimd.ShiftRightLogical(AdvSimd.LoadVector128((UInt16*)(pFld)), 1);
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = AdvSimd.ShiftRightLogical(AdvSimd.LoadVector128((UInt16*)(&test._fld)), 1);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ShiftRightLogical)}<UInt16>(Vector128<UInt16>, 1): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
