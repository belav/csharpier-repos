...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ShiftLogicalRoundedScalar_Vector64_Int64()
        {
            var test = new SimpleBinaryOpTest__ShiftLogicalRoundedScalar_Vector64_Int64();
    ...
    public sealed unsafe class SimpleBinaryOpTest__ShiftLogicalRoundedScalar_Vector64_Int64
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__ShiftLogicalRoundedScalar_Vector64_Int64 testClass
            )
            {
        ...
        static SimpleBinaryOpTest__ShiftLogicalRoundedScalar_Vector64_Int64()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetInt64();
        ...
        public SimpleBinaryOpTest__ShiftLogicalRoundedScalar_Vector64_Int64()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(
                    nameof(AdvSimd.ShiftLogicalRoundedScalar),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.ShiftLogicalRoundedScalar(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ShiftLogicalRoundedScalar)}<Int64>(Vector64<Int64>, Vector64<Int64>): {method} failed:"
                    );
