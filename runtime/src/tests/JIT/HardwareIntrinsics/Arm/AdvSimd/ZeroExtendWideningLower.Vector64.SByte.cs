    ...
    public sealed unsafe class SimpleUnaryOpTest__ZeroExtendWideningLower_Vector64_SByte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__ZeroExtendWideningLower_Vector64_SByte testClass
            )
            {
        ...
        public void RunClassLclFldScenario_Load()
        {
            ...
            {
                var result = AdvSimd.ZeroExtendWideningLower(AdvSimd.LoadVector64((SByte*)(pFld1)));
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ZeroExtendWideningLower)}<Int16>(Vector64<SByte>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
