...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void MultiplySubtract_Vector64_SByte()
        {
    ...
    public sealed unsafe class SimpleTernaryOpTest__MultiplySubtract_Vector64_SByte
    {
        ...
        private struct TestStruct
        {
            ...
            public static TestStruct Create()
            {
                ...
                {
                    _data3[i] = TestLibrary.Generator.GetSByte();
                }
                Unsafe.CopyBlockUnaligned(
                    ref Unsafe.As<Vector64<SByte>, byte>(ref testStruct._fld3),
            ...
            public void RunStructFldScenario(
                SimpleTernaryOpTest__MultiplySubtract_Vector64_SByte testClass
            ) {
            ...
            public void RunStructFldScenario_Load(
                ...
                fixed (Vector64<SByte>* pFld1 = &_fld1)fixed (
        ...
        static SimpleTernaryOpTest__MultiplySubtract_Vector64_SByte()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetSByte();
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector64<SByte>, byte>(ref _clsVar3),
                ref Unsafe.As<SByte, byte>(ref _data3[0]),
                (uint)Unsafe.SizeOf<Vector64<SByte>>()
            );
        }

        public SimpleTernaryOpTest__MultiplySubtract_Vector64_SByte()
        {
            Succeeded = true;
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector64<SByte>, byte>(ref _fld3),
                ref Unsafe.As<SByte, byte>(ref _data3[0]),
                (uint)Unsafe.SizeOf<Vector64<SByte>>()
            );
        ...
        public void RunClassFldScenario_Load()
        {
            ...
            fixed (Vector64<SByte>* pFld1 = &_fld1)fixed (Vector64<SByte>* pFld2 = &_fld2)fixed (
        ...
        private void ValidateResult(
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd)}.{nameof(AdvSimd.MultiplySubtract)}<SByte>(Vector64<SByte>, Vector64<SByte>, Vector64<SByte>): {method} failed:"
                );
                TestLibrary.TestFramework.LogInformation(
