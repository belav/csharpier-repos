...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void MultiplyDoublingWideningUpperAndSubtractSaturate_Vector128_Int16()
        {
            var test =
                new SimpleTernaryOpTest__MultiplyDoublingWideningUpperAndSubtractSaturate_Vector128_Int16();
    ...
    public sealed unsafe class SimpleTernaryOpTest__MultiplyDoublingWideningUpperAndSubtractSaturate_Vector128_Int16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleTernaryOpTest__MultiplyDoublingWideningUpperAndSubtractSaturate_Vector128_Int16 testClass
            )
            {
                var result = AdvSimd.MultiplyDoublingWideningUpperAndSubtractSaturate(
                    _fld1,
                    _fld2,
                    _fld3
                );
        ...
        static SimpleTernaryOpTest__MultiplyDoublingWideningUpperAndSubtractSaturate_Vector128_Int16()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetInt32();
        ...
        public SimpleTernaryOpTest__MultiplyDoublingWideningUpperAndSubtractSaturate_Vector128_Int16()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(
                    nameof(AdvSimd.MultiplyDoublingWideningUpperAndSubtractSaturate),
                    new Type[]
                    {
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.MultiplyDoublingWideningUpperAndSubtractSaturate(op1, op2, op3);
        ...
        )
        {
            ...
            {
                if (
                    Helpers.MultiplyDoublingWideningUpperAndSubtractSaturate(
                        firstOp,
                        secondOp,
                        thirdOp,
                        i
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.MultiplyDoublingWideningUpperAndSubtractSaturate)}<Int32>(Vector128<Int32>, Vector128<Int16>, Vector128<Int16>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
