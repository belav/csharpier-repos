...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void AbsoluteDifferenceWideningUpper_Vector128_UInt16()
        {
    ...
    public sealed unsafe class SimpleBinaryOpTest__AbsoluteDifferenceWideningUpper_Vector128_UInt16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__AbsoluteDifferenceWideningUpper_Vector128_UInt16 testClass
            )
            {
        ...
        static SimpleBinaryOpTest__AbsoluteDifferenceWideningUpper_Vector128_UInt16()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetUInt16();
        ...
        public SimpleBinaryOpTest__AbsoluteDifferenceWideningUpper_Vector128_UInt16()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(
                    nameof(AdvSimd.AbsoluteDifferenceWideningUpper),
                    new Type[] { typeof(Vector128<UInt16>), typeof(Vector128<UInt16>) }
                )
                .Invoke(
                    null,
                    new object[]
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.AbsoluteDifferenceWideningUpper(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.AbsoluteDifferenceWideningUpper)}<UInt32>(Vector128<UInt16>, Vector128<UInt16>): {method} failed:"
                    );
