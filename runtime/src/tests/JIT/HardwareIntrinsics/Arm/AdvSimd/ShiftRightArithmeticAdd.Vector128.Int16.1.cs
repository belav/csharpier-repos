...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ShiftRightArithmeticAdd_Vector128_Int16_1()
        {
    ...
    public sealed unsafe class ImmBinaryOpTest__ShiftRightArithmeticAdd_Vector128_Int16_1
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                ImmBinaryOpTest__ShiftRightArithmeticAdd_Vector128_Int16_1 testClass
            )
            {
        ...
        static ImmBinaryOpTest__ShiftRightArithmeticAdd_Vector128_Int16_1()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetInt16();
        ...
        public ImmBinaryOpTest__ShiftRightArithmeticAdd_Vector128_Int16_1()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(
                    nameof(AdvSimd.ShiftRightArithmeticAdd),
                    new Type[] { typeof(Vector128<Int16>), typeof(Vector128<Int16>), typeof(byte) }
                )
                .Invoke(
                    null,
                    new object[]
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.ShiftRightArithmeticAdd(_clsVar1, _clsVar2, 1);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ShiftRightArithmeticAdd)}<Int16>(Vector128<Int16>, Vector128<Int16>, 1): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
