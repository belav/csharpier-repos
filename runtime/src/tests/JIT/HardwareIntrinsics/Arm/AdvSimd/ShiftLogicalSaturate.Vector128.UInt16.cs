    ...
    public sealed unsafe class SimpleBinaryOpTest__ShiftLogicalSaturate_Vector128_UInt16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__ShiftLogicalSaturate_Vector128_UInt16 testClass
            ) {
        ...
        private void ValidateResult(
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd)}.{nameof(AdvSimd.ShiftLogicalSaturate)}<UInt16>(Vector128<UInt16>, Vector128<Int16>): {method} failed:"
                );
