...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ExtractNarrowingLower_Vector64_SByte()
        {
            var test = new SimpleUnaryOpTest__ExtractNarrowingLower_Vector64_SByte();
    ...
    public sealed unsafe class SimpleUnaryOpTest__ExtractNarrowingLower_Vector64_SByte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__ExtractNarrowingLower_Vector64_SByte testClass
            )
            {
        ...
        static SimpleUnaryOpTest__ExtractNarrowingLower_Vector64_SByte()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetInt16();
        ...
        public SimpleUnaryOpTest__ExtractNarrowingLower_Vector64_SByte()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(
                    nameof(AdvSimd.ExtractNarrowingLower),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.ExtractNarrowingLower(_clsVar1);
        ...
        public void RunClassLclFldScenario_Load()
        {
            ...
            {
                var result = AdvSimd.ExtractNarrowingLower(AdvSimd.LoadVector128((Int16*)(pFld1)));
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ExtractNarrowingLower)}<SByte>(Vector128<Int16>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
