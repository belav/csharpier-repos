...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ExtractVector64_Single_1()
        {
            var test = new ExtractVectorTest__ExtractVector64_Single_1();
    ...
    public sealed unsafe class ExtractVectorTest__ExtractVector64_Single_1
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(ExtractVectorTest__ExtractVector64_Single_1 testClass)
            {
            ...
            public void RunStructFldScenario_Load(
                ExtractVectorTest__ExtractVector64_Single_1 testClass
            )
            {
        ...
        static ExtractVectorTest__ExtractVector64_Single_1()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetSingle();
        ...
        public ExtractVectorTest__ExtractVector64_Single_1()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(
                    nameof(AdvSimd.ExtractVector64),
                    new Type[] { typeof(Vector64<Single>), typeof(Vector64<Single>), typeof(byte) }
                )
                .Invoke(
                    null,
                    new object[]
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.ExtractVector64(_clsVar1, _clsVar2, ElementIndex);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ExtractVector64)}<Single>(Vector64<Single>, Vector64<Single>, 1): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
