...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void RoundToNegativeInfinity_Vector128_Single()
        {
            var test = new SimpleUnaryOpTest__RoundToNegativeInfinity_Vector128_Single();
    ...
    public sealed unsafe class SimpleUnaryOpTest__RoundToNegativeInfinity_Vector128_Single
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__RoundToNegativeInfinity_Vector128_Single testClass
            )
            {
                var result = AdvSimd.RoundToNegativeInfinity(_fld1);
            ...
            )
            {
                ...
                {
                    var result = AdvSimd.RoundToNegativeInfinity(
        ...
        static SimpleUnaryOpTest__RoundToNegativeInfinity_Vector128_Single()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetSingle();
        ...
        public SimpleUnaryOpTest__RoundToNegativeInfinity_Vector128_Single()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(
                    nameof(AdvSimd.RoundToNegativeInfinity),
        ...
        public void RunReflectionScenario_Load()
        {
            ...
            var result = typeof(AdvSimd)
                ...
                .Invoke(
                    null,
                    new object[] { AdvSimd.LoadVector128((Single*)(_dataTable.inArray1Ptr)) }
                );
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.RoundToNegativeInfinity(_clsVar1);
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.RoundToNegativeInfinity(op1);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimpleUnaryOpTest__RoundToNegativeInfinity_Vector128_Single();
            var result = AdvSimd.RoundToNegativeInfinity(test._fld1);
        ...
        )
        {
            ...
            {
                if (
                    BitConverter.SingleToInt32Bits(Helpers.RoundToNegativeInfinity(firstOp[i]))
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.RoundToNegativeInfinity)}<Single>(Vector128<Single>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
