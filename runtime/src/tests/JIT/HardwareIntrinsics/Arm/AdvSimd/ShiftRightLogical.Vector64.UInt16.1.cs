...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ShiftRightLogical_Vector64_UInt16_1()
        {
    ...
    public sealed unsafe class ImmUnaryOpTest__ShiftRightLogical_Vector64_UInt16_1
    {
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            {
                var result = AdvSimd.ShiftRightLogical(AdvSimd.LoadVector64((UInt16*)(pClsVar)), 1);
        ...
        public void RunClassLclFldScenario_Load()
        {
            ...
            {
                var result = AdvSimd.ShiftRightLogical(AdvSimd.LoadVector64((UInt16*)(pFld)), 1);
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = AdvSimd.ShiftRightLogical(AdvSimd.LoadVector64((UInt16*)(&test._fld)), 1);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ShiftRightLogical)}<UInt16>(Vector64<UInt16>, 1): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
