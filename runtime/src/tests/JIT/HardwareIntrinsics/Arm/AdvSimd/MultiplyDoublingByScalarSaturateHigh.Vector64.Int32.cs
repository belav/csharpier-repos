...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void MultiplyDoublingByScalarSaturateHigh_Vector64_Int32()
        {
            var test =
                new SimpleBinaryOpTest__MultiplyDoublingByScalarSaturateHigh_Vector64_Int32();
    ...
    public sealed unsafe class SimpleBinaryOpTest__MultiplyDoublingByScalarSaturateHigh_Vector64_Int32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__MultiplyDoublingByScalarSaturateHigh_Vector64_Int32 testClass
            )
            {
                var result = AdvSimd.MultiplyDoublingByScalarSaturateHigh(_fld1, _fld2);
            ...
            )
            {
                ...
                {
                    var result = AdvSimd.MultiplyDoublingByScalarSaturateHigh(
        ...
        static SimpleBinaryOpTest__MultiplyDoublingByScalarSaturateHigh_Vector64_Int32()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetInt32();
        ...
        public SimpleBinaryOpTest__MultiplyDoublingByScalarSaturateHigh_Vector64_Int32()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(
                    nameof(AdvSimd.MultiplyDoublingByScalarSaturateHigh),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.MultiplyDoublingByScalarSaturateHigh(_clsVar1, _clsVar2);
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.MultiplyDoublingByScalarSaturateHigh(op1, op2);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test =
                new SimpleBinaryOpTest__MultiplyDoublingByScalarSaturateHigh_Vector64_Int32();
            var result = AdvSimd.MultiplyDoublingByScalarSaturateHigh(test._fld1, test._fld2);
        ...
        )
        {
            ...
            {
                if (Helpers.MultiplyDoublingSaturateHigh(left[i], right[0]) != result[i])
                {
                    succeeded = false;
                    break;
                }
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.MultiplyDoublingByScalarSaturateHigh)}<Int32>(Vector64<Int32>, Vector64<Int32>): {method} failed:"
                    );
