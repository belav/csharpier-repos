    ...
    public sealed unsafe class LoadAndInsertTest__LoadAndInsertScalar_Vector128_Double_1
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                LoadAndInsertTest__LoadAndInsertScalar_Vector128_Double_1 testClass
            )
            {
            ...
            {
                fixed (Vector128<Double>* pFld1 = &_fld1)fixed (Double* pFld3 = &_fld3)
                {
        ...
        public void RunClsVarScenario()
        {
            ...
            {
                var result = AdvSimd.LoadAndInsertScalar(_clsVar1, 1, pClsVar3);
                Unsafe.Write(_dataTable.outArrayPtr, result);
            }
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            fixed (Vector128<Double>* pClsVar1 = &_clsVar1)fixed (Double* pClsVar3 = &_clsVar3)
            {
                var result = AdvSimd.LoadAndInsertScalar(
        ...
        public void RunClassLclFldScenario_Load()
        {
            ...
            fixed (Vector128<Double>* pFld1 = &test._fld1)fixed (Double* pFld3 = &test._fld3)
            {
                var result = AdvSimd.LoadAndInsertScalar(
                    AdvSimd.LoadVector128((Double*)pFld1),
                    1,
