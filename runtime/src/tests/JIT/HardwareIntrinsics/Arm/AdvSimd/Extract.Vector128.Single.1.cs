...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void Extract_Vector128_Single_1()
        {
            var test = new ExtractTest__Extract_Vector128_Single_1();
    ...
    public sealed unsafe class ExtractTest__Extract_Vector128_Single_1
    {
        private struct DataTable
        {
            ...
            public DataTable(Single[] inArray1, int alignment)
            {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(ExtractTest__Extract_Vector128_Single_1 testClass)
            {
            ...
            public void RunStructFldScenario_Load(ExtractTest__Extract_Vector128_Single_1 testClass)
            {
        ...
        static ExtractTest__Extract_Vector128_Single_1()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetSingle();
        ...
        public ExtractTest__Extract_Vector128_Single_1()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            ValidateResult(_dataTable.inArray1Ptr, (Single)result);
        }
        ...
        public void RunClassLclFldScenario_Load()
        {
            ...
            {
                var result = AdvSimd.Extract(AdvSimd.LoadVector128((Single*)(pFld1)), ElementIndex);
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = AdvSimd.Extract(AdvSimd.LoadVector128((Single*)&test._fld1), ElementIndex);
        ...
        private void ValidateResult(void* op1, Single result, [CallerMemberName] string method = "")
        {
            Single[] inArray1 = new Single[Op1ElementCount];
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.Extract)}(Vector128<Single>, 1): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
