...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void RoundToNegativeInfinityScalar_Vector64_Single()
        {
            var test = new SimpleUnaryOpTest__RoundToNegativeInfinityScalar_Vector64_Single();
    ...
    public sealed unsafe class SimpleUnaryOpTest__RoundToNegativeInfinityScalar_Vector64_Single
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__RoundToNegativeInfinityScalar_Vector64_Single testClass
            )
            {
        ...
        static SimpleUnaryOpTest__RoundToNegativeInfinityScalar_Vector64_Single()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetSingle();
        ...
        public SimpleUnaryOpTest__RoundToNegativeInfinityScalar_Vector64_Single()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(
                    nameof(AdvSimd.RoundToNegativeInfinityScalar),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.RoundToNegativeInfinityScalar(_clsVar1);
        ...
        )
        {
            ...
            if (
                BitConverter.SingleToInt32Bits(Helpers.RoundToNegativeInfinity(firstOp[0]))
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.RoundToNegativeInfinityScalar)}<Single>(Vector64<Single>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
