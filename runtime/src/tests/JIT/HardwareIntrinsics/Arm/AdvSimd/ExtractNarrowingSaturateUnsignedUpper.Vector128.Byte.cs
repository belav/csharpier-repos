...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ExtractNarrowingSaturateUnsignedUpper_Vector128_Byte()
        {
            var test =
    ...
    public sealed unsafe class SimpleBinaryOpTest__ExtractNarrowingSaturateUnsignedUpper_Vector128_Byte
    {
        ...
        private struct TestStruct
        {
            ...
            {
                var result = AdvSimd.ExtractNarrowingSaturateUnsignedUpper(_fld1, _fld2);
        ...
        static SimpleBinaryOpTest__ExtractNarrowingSaturateUnsignedUpper_Vector128_Byte()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetByte();
        ...
        public SimpleBinaryOpTest__ExtractNarrowingSaturateUnsignedUpper_Vector128_Byte()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(
                    nameof(AdvSimd.ExtractNarrowingSaturateUnsignedUpper),
                    new Type[] { typeof(Vector64<Byte>), typeof(Vector128<Int16>) }
                )
                .Invoke(
                    null,
                    new object[]
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.ExtractNarrowingSaturateUnsignedUpper(_clsVar1, _clsVar2);
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.ExtractNarrowingSaturateUnsignedUpper(op1, op2);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test =
                new SimpleBinaryOpTest__ExtractNarrowingSaturateUnsignedUpper_Vector128_Byte();
            var result = AdvSimd.ExtractNarrowingSaturateUnsignedUpper(test._fld1, test._fld2);
        ...
        )
        {
            ...
            {
                if (Helpers.ExtractNarrowingSaturateUnsignedUpper(left, right, i) != result[i])
                {
                    succeeded = false;
                    break;
                }
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ExtractNarrowingSaturateUnsignedUpper)}<Byte>(Vector64<Byte>, Vector128<Int16>): {method} failed:"
                    );
