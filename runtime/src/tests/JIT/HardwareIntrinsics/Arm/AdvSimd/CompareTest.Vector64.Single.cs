...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void CompareTest_Vector64_Single()
        {
            var test = new SimpleBinaryOpTest__CompareTest_Vector64_Single();
    ...
    public sealed unsafe class SimpleBinaryOpTest__CompareTest_Vector64_Single
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__CompareTest_Vector64_Single testClass
            )
            {
        ...
        static SimpleBinaryOpTest__CompareTest_Vector64_Single()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetSingle();
        ...
        public SimpleBinaryOpTest__CompareTest_Vector64_Single()
        {
            Succeeded = true;
        ...
        )
        {
            ...
            {
                if (
                    BitConverter.SingleToInt32Bits(Helpers.CompareTest(left[i], right[i]))
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.CompareTest)}<Single>(Vector64<Single>, Vector64<Single>): {method} failed:"
                    );
