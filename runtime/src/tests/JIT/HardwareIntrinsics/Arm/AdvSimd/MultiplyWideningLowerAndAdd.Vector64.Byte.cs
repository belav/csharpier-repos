    ...
    public sealed unsafe class SimpleTernaryOpTest__MultiplyWideningLowerAndAdd_Vector64_Byte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleTernaryOpTest__MultiplyWideningLowerAndAdd_Vector64_Byte testClass
            )
            {
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.MultiplyWideningLowerAndAdd)}<UInt16>(Vector128<UInt16>, Vector64<Byte>, Vector64<Byte>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
