    ...
    public sealed unsafe class SimpleBinaryOpTest__CompareTest_Vector128_UInt32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__CompareTest_Vector128_UInt32 testClass
            )
            {
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.CompareTest)}<UInt32>(Vector128<UInt32>, Vector128<UInt32>): {method} failed:"
                    );
