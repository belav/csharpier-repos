...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void SignExtendWideningUpper_Vector128_Int16()
        {
    ...
    public sealed unsafe class SimpleUnaryOpTest__SignExtendWideningUpper_Vector128_Int16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__SignExtendWideningUpper_Vector128_Int16 testClass
            )
            {
                var result = AdvSimd.SignExtendWideningUpper(_fld1);
            ...
            )
            {
                ...
                {
                    var result = AdvSimd.SignExtendWideningUpper(
        ...
        static SimpleUnaryOpTest__SignExtendWideningUpper_Vector128_Int16()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetInt16();
        ...
        public SimpleUnaryOpTest__SignExtendWideningUpper_Vector128_Int16()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(
                    nameof(AdvSimd.SignExtendWideningUpper),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.SignExtendWideningUpper(_clsVar1);
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.SignExtendWideningUpper(op1);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimpleUnaryOpTest__SignExtendWideningUpper_Vector128_Int16();
            var result = AdvSimd.SignExtendWideningUpper(test._fld1);
        ...
        )
        {
            ...
            {
                if (Helpers.SignExtendWideningUpper(firstOp, i) != result[i])
                {
                    succeeded = false;
                    break;
                }
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.SignExtendWideningUpper)}<Int32>(Vector128<Int16>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
