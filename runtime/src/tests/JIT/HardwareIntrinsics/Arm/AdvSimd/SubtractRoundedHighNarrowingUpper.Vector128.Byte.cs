...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void SubtractRoundedHighNarrowingUpper_Vector128_Byte()
        {
    ...
    public sealed unsafe class SimpleTernaryOpTest__SubtractRoundedHighNarrowingUpper_Vector128_Byte
    {
        ...
        static SimpleTernaryOpTest__SubtractRoundedHighNarrowingUpper_Vector128_Byte()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetByte();
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(
                    nameof(AdvSimd.SubtractRoundedHighNarrowingUpper),
                    new Type[]
                    {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.SubtractRoundedHighNarrowingUpper(_clsVar1, _clsVar2, _clsVar3);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.SubtractRoundedHighNarrowingUpper)}<Byte>(Vector64<Byte>, Vector128<UInt16>, Vector128<UInt16>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
