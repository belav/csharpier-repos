    ...
    public sealed unsafe class SimpleTernaryOpTest__MultiplyWideningUpperAndAdd_Vector128_SByte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleTernaryOpTest__MultiplyWideningUpperAndAdd_Vector128_SByte testClass
            )
            {
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.MultiplyWideningUpperAndAdd)}<Int16>(Vector128<Int16>, Vector128<SByte>, Vector128<SByte>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
