...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void AddPairwiseWidening_Vector128_Byte()
        {
    ...
    public sealed unsafe class SimpleUnaryOpTest__AddPairwiseWidening_Vector128_Byte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__AddPairwiseWidening_Vector128_Byte testClass
            )
            {
            ...
            )
            {
                ...
                {
                    var result = AdvSimd.AddPairwiseWidening(AdvSimd.LoadVector128((Byte*)(pFld1)));
        ...
        static SimpleUnaryOpTest__AddPairwiseWidening_Vector128_Byte()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetByte();
        ...
        public SimpleUnaryOpTest__AddPairwiseWidening_Vector128_Byte()
        {
            Succeeded = true;
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            {
                var result = AdvSimd.AddPairwiseWidening(AdvSimd.LoadVector128((Byte*)(pClsVar1)));
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = AdvSimd.AddPairwiseWidening(AdvSimd.LoadVector128((Byte*)(&test._fld1)));
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.AddPairwiseWidening)}<UInt16>(Vector128<Byte>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
