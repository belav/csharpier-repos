    ...
    public sealed unsafe class SimpleUnaryOpTest__ExtractNarrowingLower_Vector64_Int16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__ExtractNarrowingLower_Vector64_Int16 testClass
            )
            {
        ...
        public void RunClassLclFldScenario_Load()
        {
            ...
            {
                var result = AdvSimd.ExtractNarrowingLower(AdvSimd.LoadVector128((Int32*)(pFld1)));
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ExtractNarrowingLower)}<Int16>(Vector128<Int32>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
