    ...
    public sealed unsafe class SimpleBinaryOpTest__MaxPairwise_Vector64_UInt32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__MaxPairwise_Vector64_UInt32 testClass
            )
            {
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.MaxPairwise)}<UInt32>(Vector64<UInt32>, Vector64<UInt32>): {method} failed:"
                    );
