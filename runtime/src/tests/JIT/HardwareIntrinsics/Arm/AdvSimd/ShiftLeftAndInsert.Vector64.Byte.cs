    ...
    public sealed unsafe class ImmBinaryOpTest__ShiftLeftAndInsert_Vector64_Byte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                ImmBinaryOpTest__ShiftLeftAndInsert_Vector64_Byte testClass
            )
            {
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ShiftLeftAndInsert)}<Byte>(Vector64<Byte>, Vector64<Byte>, 4): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
