    ...
    public sealed unsafe class SimpleBinaryOpTest__ShiftLogicalRounded_Vector128_UInt32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__ShiftLogicalRounded_Vector128_UInt32 testClass
            )
            {
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ShiftLogicalRounded)}<UInt32>(Vector128<UInt32>, Vector128<Int32>): {method} failed:"
                    );
