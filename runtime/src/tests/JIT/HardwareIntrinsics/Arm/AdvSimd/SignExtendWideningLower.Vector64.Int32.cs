    ...
    public sealed unsafe class SimpleUnaryOpTest__SignExtendWideningLower_Vector64_Int32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__SignExtendWideningLower_Vector64_Int32 testClass
            )
            {
        ...
        public void RunClassLclFldScenario_Load()
        {
            ...
            {
                var result = AdvSimd.SignExtendWideningLower(AdvSimd.LoadVector64((Int32*)(pFld1)));
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.SignExtendWideningLower)}<Int64>(Vector64<Int32>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
