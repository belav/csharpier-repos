...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ShiftRightArithmeticRounded_Vector64_SByte_1()
        {
            var test = new ImmUnaryOpTest__ShiftRightArithmeticRounded_Vector64_SByte_1();
    ...
    public sealed unsafe class ImmUnaryOpTest__ShiftRightArithmeticRounded_Vector64_SByte_1
    {
        ...
        private struct TestStruct
        {
            ...
            public static TestStruct Create()
            {
                ...
                Unsafe.CopyBlockUnaligned(
                    ref Unsafe.As<Vector64<SByte>, byte>(ref testStruct._fld),
            ...
            public void RunStructFldScenario(
                ImmUnaryOpTest__ShiftRightArithmeticRounded_Vector64_SByte_1 testClass
            )
            {
        ...
        static ImmUnaryOpTest__ShiftRightArithmeticRounded_Vector64_SByte_1()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data[i] = TestLibrary.Generator.GetSByte();
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector64<SByte>, byte>(ref _clsVar),
                ref Unsafe.As<SByte, byte>(ref _data[0]),
                (uint)Unsafe.SizeOf<Vector64<SByte>>()
            );
        }

        public ImmUnaryOpTest__ShiftRightArithmeticRounded_Vector64_SByte_1()
        {
            Succeeded = true;
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector64<SByte>, byte>(ref _fld),
                ref Unsafe.As<SByte, byte>(ref _data[0]),
                (uint)Unsafe.SizeOf<Vector64<SByte>>()
            );
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(
                    nameof(AdvSimd.ShiftRightArithmeticRounded),
                    new Type[] { typeof(Vector64<SByte>), typeof(byte) }
                )
                .Invoke(
                    null,
                    new object[] { Unsafe.Read<Vector64<SByte>>(_dataTable.inArrayPtr), (byte)1 }
                );
        ...
        public void RunReflectionScenario_Load()
        {
            ...
            var result = typeof(AdvSimd)
                ...
                .Invoke(
                    null,
                    new object[] { AdvSimd.LoadVector64((SByte*)(_dataTable.inArrayPtr)), (byte)1 }
                );
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.ShiftRightArithmeticRounded(_clsVar, 1);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ShiftRightArithmeticRounded)}<SByte>(Vector64<SByte>, 1): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
