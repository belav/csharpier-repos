    ...
    public sealed unsafe class SimpleUnaryOpTest__ConvertToSingleScalar_Vector64_Int32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__ConvertToSingleScalar_Vector64_Int32 testClass
            )
            {
        ...
        public void RunClassLclFldScenario_Load()
        {
            ...
            {
                var result = AdvSimd.ConvertToSingleScalar(AdvSimd.LoadVector64((Int32*)(pFld1)));
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = AdvSimd.ConvertToSingleScalar(AdvSimd.LoadVector64((Int32*)(&test._fld1)));
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ConvertToSingleScalar)}<Single>(Vector64<Int32>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
