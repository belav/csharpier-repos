...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ShiftLeftLogicalWideningLower_Vector64_Int32_1()
        {
            var test = new ImmUnaryOpTest__ShiftLeftLogicalWideningLower_Vector64_Int32_1();
    ...
    public sealed unsafe class ImmUnaryOpTest__ShiftLeftLogicalWideningLower_Vector64_Int32_1
    {
        private struct DataTable
        {
            ...
            public DataTable(Int32[] inArray, Int64[] outArray, int alignment)
            {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                ImmUnaryOpTest__ShiftLeftLogicalWideningLower_Vector64_Int32_1 testClass
            )
            {
                var result = AdvSimd.ShiftLeftLogicalWideningLower(_fld, 1);
            ...
            )
            {
                ...
                {
                    var result = AdvSimd.ShiftLeftLogicalWideningLower(
        ...
        static ImmUnaryOpTest__ShiftLeftLogicalWideningLower_Vector64_Int32_1()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data[i] = TestLibrary.Generator.GetInt32();
        ...
        public ImmUnaryOpTest__ShiftLeftLogicalWideningLower_Vector64_Int32_1()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(
                    nameof(AdvSimd.ShiftLeftLogicalWideningLower),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.ShiftLeftLogicalWideningLower(_clsVar, 1);
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.ShiftLeftLogicalWideningLower(firstOp, 1);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new ImmUnaryOpTest__ShiftLeftLogicalWideningLower_Vector64_Int32_1();
            var result = AdvSimd.ShiftLeftLogicalWideningLower(test._fld, 1);
        ...
        )
        {
            ...
            {
                if (Helpers.ShiftLeftLogicalWidening(firstOp[i], Imm) != result[i])
                {
                    succeeded = false;
                    break;
                }
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ShiftLeftLogicalWideningLower)}<Int64>(Vector64<Int32>, 1): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
