    ...
    public sealed unsafe class SimpleUnaryOpTest__RoundToPositiveInfinityScalar_Vector64_Double
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__RoundToPositiveInfinityScalar_Vector64_Double testClass
            )
            {
        ...
        )
        {
            ...
            if (
                BitConverter.DoubleToInt64Bits(Helpers.RoundToPositiveInfinity(firstOp[0]))
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.RoundToPositiveInfinityScalar)}<Double>(Vector64<Double>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
