    ...
    public sealed unsafe class ImmUnaryOpTest__ShiftRightLogical_Vector64_Byte_1
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                ImmUnaryOpTest__ShiftRightLogical_Vector64_Byte_1 testClass
            )
            {
            ...
            )
            {
                ...
                {
                    var result = AdvSimd.ShiftRightLogical(AdvSimd.LoadVector64((Byte*)(pFld)), 1);
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            {
                var result = AdvSimd.ShiftRightLogical(AdvSimd.LoadVector64((Byte*)(pClsVar)), 1);
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = AdvSimd.ShiftRightLogical(AdvSimd.LoadVector64((Byte*)(&test._fld)), 1);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ShiftRightLogical)}<Byte>(Vector64<Byte>, 1): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
