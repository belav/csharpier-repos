    ...
    public sealed unsafe class SimpleUnaryOpTest__RoundToNegativeInfinityScalar_Vector64_Double
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__RoundToNegativeInfinityScalar_Vector64_Double testClass
            )
            {
        ...
        )
        {
            ...
            if (
                BitConverter.DoubleToInt64Bits(Helpers.RoundToNegativeInfinity(firstOp[0]))
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.RoundToNegativeInfinityScalar)}<Double>(Vector64<Double>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
