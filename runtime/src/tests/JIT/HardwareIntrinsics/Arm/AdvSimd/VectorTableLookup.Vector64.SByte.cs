    ...
    public sealed unsafe class SimpleBinaryOpTest__VectorTableLookup_Vector64_SByte
    {
        ...
        private struct TestStruct
        {
            ...
            public static TestStruct Create()
            {
                ...
                {
                    _data2[i] = (SByte)(TestLibrary.Generator.GetSByte() % 20);
                }
                Unsafe.CopyBlockUnaligned(
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__VectorTableLookup_Vector64_SByte testClass
            ) {
            ...
            public void RunStructFldScenario_Load(
                ...
                fixed (Vector128<SByte>* pFld1 = &_fld1)fixed (Vector64<SByte>* pFld2 = &_fld2)
                {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(
                    nameof(AdvSimd.VectorTableLookup),
                    new Type[] { typeof(Vector128<SByte>), typeof(Vector64<SByte>) }
                )
                .Invoke(
                    null,
                    new object[]
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.VectorTableLookup(_clsVar1, _clsVar2);
        ...
        private void ValidateResult(
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd)}.{nameof(AdvSimd.VectorTableLookup)}<SByte>(Vector128<SByte>, Vector64<SByte>): {method} failed:"
                );
