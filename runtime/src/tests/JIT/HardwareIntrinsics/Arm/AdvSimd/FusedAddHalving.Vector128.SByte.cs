...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void FusedAddHalving_Vector128_SByte()
        {
            var test = new SimpleBinaryOpTest__FusedAddHalving_Vector128_SByte();
    ...
    public sealed unsafe class SimpleBinaryOpTest__FusedAddHalving_Vector128_SByte
    {
        ...
        static SimpleBinaryOpTest__FusedAddHalving_Vector128_SByte()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetSByte();
        ...
        public SimpleBinaryOpTest__FusedAddHalving_Vector128_SByte()
        {
            Succeeded = true;
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.FusedAddHalving)}<SByte>(Vector128<SByte>, Vector128<SByte>): {method} failed:"
                    );
