...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void AbsoluteCompareGreaterThanOrEqual_Vector64_Single()
        {
            var test = new SimpleBinaryOpTest__AbsoluteCompareGreaterThanOrEqual_Vector64_Single();
    ...
    public sealed unsafe class SimpleBinaryOpTest__AbsoluteCompareGreaterThanOrEqual_Vector64_Single
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__AbsoluteCompareGreaterThanOrEqual_Vector64_Single testClass
            )
            {
                var result = AdvSimd.AbsoluteCompareGreaterThanOrEqual(_fld1, _fld2);
            ...
            )
            {
                ...
                {
                    var result = AdvSimd.AbsoluteCompareGreaterThanOrEqual(
        ...
        static SimpleBinaryOpTest__AbsoluteCompareGreaterThanOrEqual_Vector64_Single()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetSingle();
        ...
        public SimpleBinaryOpTest__AbsoluteCompareGreaterThanOrEqual_Vector64_Single()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(
                    nameof(AdvSimd.AbsoluteCompareGreaterThanOrEqual),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.AbsoluteCompareGreaterThanOrEqual(_clsVar1, _clsVar2);
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.AbsoluteCompareGreaterThanOrEqual(op1, op2);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimpleBinaryOpTest__AbsoluteCompareGreaterThanOrEqual_Vector64_Single();
            var result = AdvSimd.AbsoluteCompareGreaterThanOrEqual(test._fld1, test._fld2);
        ...
        )
        {
            ...
            for (var i = 0; i < RetElementCount; i++)
            {
                if (
                    BitConverter.SingleToInt32Bits(
                        Helpers.AbsoluteCompareGreaterThanOrEqual(left[i], right[i])
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.AbsoluteCompareGreaterThanOrEqual)}<Single>(Vector64<Single>, Vector64<Single>): {method} failed:"
                    );
