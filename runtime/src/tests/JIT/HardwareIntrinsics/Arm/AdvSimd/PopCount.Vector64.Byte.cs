...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void PopCount_Vector64_Byte()
        {
            var test = new SimpleUnaryOpTest__PopCount_Vector64_Byte();
    ...
    public sealed unsafe class SimpleUnaryOpTest__PopCount_Vector64_Byte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleUnaryOpTest__PopCount_Vector64_Byte testClass)
            {
            ...
            public void RunStructFldScenario_Load(
                SimpleUnaryOpTest__PopCount_Vector64_Byte testClass
            )
            {
                fixed (Vector64<Byte>* pFld1 = &_fld1)
                {
                    var result = AdvSimd.PopCount(AdvSimd.LoadVector64((Byte*)(pFld1)));
        ...
        static SimpleUnaryOpTest__PopCount_Vector64_Byte()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetByte();
        ...
        public SimpleUnaryOpTest__PopCount_Vector64_Byte()
        {
            Succeeded = true;
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.PopCount(Unsafe.Read<Vector64<Byte>>(_dataTable.inArray1Ptr));
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var result = AdvSimd.PopCount(AdvSimd.LoadVector64((Byte*)(_dataTable.inArray1Ptr)));
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(nameof(AdvSimd.PopCount), new Type[] { typeof(Vector64<Byte>) })
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.PopCount(_clsVar1);
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            {
                var result = AdvSimd.PopCount(AdvSimd.LoadVector64((Byte*)(pClsVar1)));
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = AdvSimd.PopCount(AdvSimd.LoadVector64((Byte*)(&test._fld1)));
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.PopCount)}<Byte>(Vector64<Byte>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
