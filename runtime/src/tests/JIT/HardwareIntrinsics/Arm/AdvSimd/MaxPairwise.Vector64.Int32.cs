    ...
    public sealed unsafe class SimpleBinaryOpTest__MaxPairwise_Vector64_Int32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__MaxPairwise_Vector64_Int32 testClass
            )
            {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.MaxPairwise(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.MaxPairwise)}<Int32>(Vector64<Int32>, Vector64<Int32>): {method} failed:"
                    );
