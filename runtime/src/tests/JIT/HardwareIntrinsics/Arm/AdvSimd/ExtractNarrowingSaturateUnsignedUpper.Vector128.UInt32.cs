...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ExtractNarrowingSaturateUnsignedUpper_Vector128_UInt32()
        {
            var test =
                new SimpleBinaryOpTest__ExtractNarrowingSaturateUnsignedUpper_Vector128_UInt32();
    ...
    public sealed unsafe class SimpleBinaryOpTest__ExtractNarrowingSaturateUnsignedUpper_Vector128_UInt32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__ExtractNarrowingSaturateUnsignedUpper_Vector128_UInt32 testClass
            )
            {
        ...
        static SimpleBinaryOpTest__ExtractNarrowingSaturateUnsignedUpper_Vector128_UInt32()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetUInt32();
        ...
        public SimpleBinaryOpTest__ExtractNarrowingSaturateUnsignedUpper_Vector128_UInt32()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(
                    ...
                    new Type[] { typeof(Vector64<UInt32>), typeof(Vector128<Int64>) }
                )
                .Invoke(
                    null,
                    new object[]
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ExtractNarrowingSaturateUnsignedUpper)}<UInt32>(Vector64<UInt32>, Vector128<Int64>): {method} failed:"
                    );
