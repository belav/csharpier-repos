...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void FusedMultiplyAddNegatedScalar_Vector64_Single()
        {
    ...
    public sealed unsafe class SimpleTernaryOpTest__FusedMultiplyAddNegatedScalar_Vector64_Single
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleTernaryOpTest__FusedMultiplyAddNegatedScalar_Vector64_Single testClass
            )
            {
                var result = AdvSimd.FusedMultiplyAddNegatedScalar(_fld1, _fld2, _fld3);
            ...
            )
            {
                ...
                {
                    var result = AdvSimd.FusedMultiplyAddNegatedScalar(
        ...
        static SimpleTernaryOpTest__FusedMultiplyAddNegatedScalar_Vector64_Single()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetSingle();
        ...
        public SimpleTernaryOpTest__FusedMultiplyAddNegatedScalar_Vector64_Single()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(
                    nameof(AdvSimd.FusedMultiplyAddNegatedScalar),
                    new Type[]
                    {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.FusedMultiplyAddNegatedScalar(_clsVar1, _clsVar2, _clsVar3);
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.FusedMultiplyAddNegatedScalar(op1, op2, op3);
        ...
        )
        {
            ...
            if (
                BitConverter.SingleToInt32Bits(
                    Helpers.FusedMultiplyAddNegated(firstOp[0], secondOp[0], thirdOp[0])
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.FusedMultiplyAddNegatedScalar)}<Single>(Vector64<Single>, Vector64<Single>, Vector64<Single>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
