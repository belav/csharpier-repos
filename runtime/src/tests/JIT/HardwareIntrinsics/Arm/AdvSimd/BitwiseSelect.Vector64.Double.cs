...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void BitwiseSelect_Vector64_Double()
        {
            var test = new SimpleTernaryOpTest__BitwiseSelect_Vector64_Double();
    ...
    public sealed unsafe class SimpleTernaryOpTest__BitwiseSelect_Vector64_Double
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleTernaryOpTest__BitwiseSelect_Vector64_Double testClass
            )
            {
        ...
        static SimpleTernaryOpTest__BitwiseSelect_Vector64_Double()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetDouble();
        ...
        public SimpleTernaryOpTest__BitwiseSelect_Vector64_Double()
        {
            Succeeded = true;
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.BitwiseSelect)}<Double>(Vector64<Double>, Vector64<Double>, Vector64<Double>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
