...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void SubtractWideningUpper_Vector128_UInt32_Vector128_UInt32()
        {
            var test =
                new SimpleBinaryOpTest__SubtractWideningUpper_Vector128_UInt32_Vector128_UInt32();
    ...
    public sealed unsafe class SimpleBinaryOpTest__SubtractWideningUpper_Vector128_UInt32_Vector128_UInt32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__SubtractWideningUpper_Vector128_UInt32_Vector128_UInt32 testClass
            ) {
        ...
        static SimpleBinaryOpTest__SubtractWideningUpper_Vector128_UInt32_Vector128_UInt32()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetUInt32();
        ...
        public SimpleBinaryOpTest__SubtractWideningUpper_Vector128_UInt32_Vector128_UInt32()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(
                    nameof(AdvSimd.SubtractWideningUpper),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.SubtractWideningUpper(_clsVar1, _clsVar2);
        ...
        private void ValidateResult(
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd)}.{nameof(AdvSimd.SubtractWideningUpper)}<UInt64>(Vector128<UInt32>, Vector128<UInt32>): {method} failed:"
                );
