...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void AbsSaturate_Vector64_Int32()
        {
            var test = new SimpleUnaryOpTest__AbsSaturate_Vector64_Int32();
    ...
    public sealed unsafe class SimpleUnaryOpTest__AbsSaturate_Vector64_Int32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__AbsSaturate_Vector64_Int32 testClass
            )
            {
            ...
            )
            {
                ...
                {
                    var result = AdvSimd.AbsSaturate(AdvSimd.LoadVector64((Int32*)(pFld1)));
        ...
        static SimpleUnaryOpTest__AbsSaturate_Vector64_Int32()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = Int32.MinValue;
        ...
        public SimpleUnaryOpTest__AbsSaturate_Vector64_Int32()
        {
            Succeeded = true;
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.AbsSaturate(Unsafe.Read<Vector64<Int32>>(_dataTable.inArray1Ptr));
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(nameof(AdvSimd.AbsSaturate), new Type[] { typeof(Vector64<Int32>) })
                .Invoke(
                    null,
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.AbsSaturate(_clsVar1);
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            {
                var result = AdvSimd.AbsSaturate(AdvSimd.LoadVector64((Int32*)(pClsVar1)));
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = AdvSimd.AbsSaturate(AdvSimd.LoadVector64((Int32*)(&test._fld1)));
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.AbsSaturate)}<Int32>(Vector64<Int32>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
