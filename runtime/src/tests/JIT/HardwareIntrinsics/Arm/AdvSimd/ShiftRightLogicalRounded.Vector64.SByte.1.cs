...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ShiftRightLogicalRounded_Vector64_SByte_1()
        {
            var test = new ImmUnaryOpTest__ShiftRightLogicalRounded_Vector64_SByte_1();
    ...
    public sealed unsafe class ImmUnaryOpTest__ShiftRightLogicalRounded_Vector64_SByte_1
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                ImmUnaryOpTest__ShiftRightLogicalRounded_Vector64_SByte_1 testClass
            )
            {
        ...
        static ImmUnaryOpTest__ShiftRightLogicalRounded_Vector64_SByte_1()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data[i] = TestLibrary.Generator.GetSByte();
        ...
        public ImmUnaryOpTest__ShiftRightLogicalRounded_Vector64_SByte_1()
        {
            Succeeded = true;
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ShiftRightLogicalRounded)}<SByte>(Vector64<SByte>, 1): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
