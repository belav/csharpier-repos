    ...
    public sealed unsafe class SimpleTernaryOpTest__AddHighNarrowingUpper_Vector128_Int32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleTernaryOpTest__AddHighNarrowingUpper_Vector128_Int32 testClass
            )
            {
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.AddHighNarrowingUpper)}<Int32>(Vector64<Int32>, Vector128<Int64>, Vector128<Int64>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
