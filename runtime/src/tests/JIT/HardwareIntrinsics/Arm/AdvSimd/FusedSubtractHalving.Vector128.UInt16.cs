    ...
    public sealed unsafe class SimpleBinaryOpTest__FusedSubtractHalving_Vector128_UInt16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__FusedSubtractHalving_Vector128_UInt16 testClass
            )
            {
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.FusedSubtractHalving)}<UInt16>(Vector128<UInt16>, Vector128<UInt16>): {method} failed:"
                    );
