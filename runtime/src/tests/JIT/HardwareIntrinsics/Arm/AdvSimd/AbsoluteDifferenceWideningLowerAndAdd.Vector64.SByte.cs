...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void AbsoluteDifferenceWideningLowerAndAdd_Vector64_SByte()
        {
            var test =
    ...
    public sealed unsafe class SimpleTernaryOpTest__AbsoluteDifferenceWideningLowerAndAdd_Vector64_SByte
    {
        ...
        static SimpleTernaryOpTest__AbsoluteDifferenceWideningLowerAndAdd_Vector64_SByte()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetInt16();
        ...
        public SimpleTernaryOpTest__AbsoluteDifferenceWideningLowerAndAdd_Vector64_SByte()
        {
            Succeeded = true;
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.AbsoluteDifferenceWideningLowerAndAdd)}<Int16>(Vector128<Int16>, Vector64<SByte>, Vector64<SByte>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
