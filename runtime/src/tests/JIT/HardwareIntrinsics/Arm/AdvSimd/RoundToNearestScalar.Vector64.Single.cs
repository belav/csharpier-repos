...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void RoundToNearestScalar_Vector64_Single()
        {
            var test = new SimpleUnaryOpTest__RoundToNearestScalar_Vector64_Single();
    ...
    public sealed unsafe class SimpleUnaryOpTest__RoundToNearestScalar_Vector64_Single
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__RoundToNearestScalar_Vector64_Single testClass
            )
            {
        ...
        static SimpleUnaryOpTest__RoundToNearestScalar_Vector64_Single()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetSingle();
        ...
        public SimpleUnaryOpTest__RoundToNearestScalar_Vector64_Single()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(
                    nameof(AdvSimd.RoundToNearestScalar),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.RoundToNearestScalar(_clsVar1);
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.RoundToNearestScalar(op1);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimpleUnaryOpTest__RoundToNearestScalar_Vector64_Single();
            var result = AdvSimd.RoundToNearestScalar(test._fld1);
        ...
        public void RunClassLclFldScenario_Load()
        {
            ...
            {
                var result = AdvSimd.RoundToNearestScalar(AdvSimd.LoadVector64((Single*)(pFld1)));
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = AdvSimd.RoundToNearestScalar(AdvSimd.LoadVector64((Single*)(&test._fld1)));
        ...
        )
        {
            ...
            if (
                BitConverter.SingleToInt32Bits(Helpers.RoundToNearest(firstOp[0]))
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.RoundToNearestScalar)}<Single>(Vector64<Single>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
