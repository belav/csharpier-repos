...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void DuplicateToVector128_Byte_31()
        {
            var test = new ImmOpTest__DuplicateToVector128_Byte_31();
    ...
    public sealed unsafe class ImmOpTest__DuplicateToVector128_Byte_31
    {
        ...
        public ImmOpTest__DuplicateToVector128_Byte_31()
        {
            Succeeded = true;
