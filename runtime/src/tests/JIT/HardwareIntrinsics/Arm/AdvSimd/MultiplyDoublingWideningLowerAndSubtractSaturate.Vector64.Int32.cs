...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void MultiplyDoublingWideningLowerAndSubtractSaturate_Vector64_Int32()
        {
            var test =
                new SimpleTernaryOpTest__MultiplyDoublingWideningLowerAndSubtractSaturate_Vector64_Int32();
    ...
    public sealed unsafe class SimpleTernaryOpTest__MultiplyDoublingWideningLowerAndSubtractSaturate_Vector64_Int32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleTernaryOpTest__MultiplyDoublingWideningLowerAndSubtractSaturate_Vector64_Int32 testClass
            )
            {
                var result = AdvSimd.MultiplyDoublingWideningLowerAndSubtractSaturate(
                    _fld1,
                    _fld2,
                    _fld3
                );
        ...
        static SimpleTernaryOpTest__MultiplyDoublingWideningLowerAndSubtractSaturate_Vector64_Int32()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetInt64();
        ...
        public SimpleTernaryOpTest__MultiplyDoublingWideningLowerAndSubtractSaturate_Vector64_Int32()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(
                    nameof(AdvSimd.MultiplyDoublingWideningLowerAndSubtractSaturate),
                    new Type[]
                    {
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.MultiplyDoublingWideningLowerAndSubtractSaturate(op1, op2, op3);
        ...
        )
        {
            ...
            {
                if (
                    Helpers.MultiplyDoublingWideningAndSubtractSaturate(
                        firstOp[i],
                        secondOp[i],
                        thirdOp[i]
                    ) != result[i]
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.MultiplyDoublingWideningLowerAndSubtractSaturate)}<Int64>(Vector128<Int64>, Vector64<Int32>, Vector64<Int32>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
