    ...
    public sealed unsafe class SimpleUnaryOpTest__ExtractNarrowingLower_Vector64_UInt16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__ExtractNarrowingLower_Vector64_UInt16 testClass
            )
            {
        ...
        public void RunClassLclFldScenario_Load()
        {
            ...
            {
                var result = AdvSimd.ExtractNarrowingLower(AdvSimd.LoadVector128((UInt32*)(pFld1)));
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ExtractNarrowingLower)}<UInt16>(Vector128<UInt32>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
