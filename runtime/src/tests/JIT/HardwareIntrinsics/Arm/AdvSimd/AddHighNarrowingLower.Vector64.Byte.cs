...
namespace JIT.HardwareIntrinsics.Arm
{
    public static partial class Program
    {
        ...
        {
            var test = new SimpleBinaryOpTest__AddHighNarrowingLower_Vector64_Byte();
    ...
    public sealed unsafe class SimpleBinaryOpTest__AddHighNarrowingLower_Vector64_Byte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__AddHighNarrowingLower_Vector64_Byte testClass
            )
            {
        ...
        static SimpleBinaryOpTest__AddHighNarrowingLower_Vector64_Byte()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetUInt16();
        ...
        public SimpleBinaryOpTest__AddHighNarrowingLower_Vector64_Byte()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(
                    nameof(AdvSimd.AddHighNarrowingLower),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.AddHighNarrowingLower(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.AddHighNarrowingLower)}<Byte>(Vector128<UInt16>, Vector128<UInt16>): {method} failed:"
                    );
