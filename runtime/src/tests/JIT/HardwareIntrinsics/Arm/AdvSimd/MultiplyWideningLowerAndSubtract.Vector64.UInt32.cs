...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void MultiplyWideningLowerAndSubtract_Vector64_UInt32()
        {
    ...
    public sealed unsafe class SimpleTernaryOpTest__MultiplyWideningLowerAndSubtract_Vector64_UInt32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleTernaryOpTest__MultiplyWideningLowerAndSubtract_Vector64_UInt32 testClass
            )
            {
        ...
        static SimpleTernaryOpTest__MultiplyWideningLowerAndSubtract_Vector64_UInt32()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetUInt64();
        ...
        public SimpleTernaryOpTest__MultiplyWideningLowerAndSubtract_Vector64_UInt32()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(
                    nameof(AdvSimd.MultiplyWideningLowerAndSubtract),
                    new Type[]
                    {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.MultiplyWideningLowerAndSubtract(_clsVar1, _clsVar2, _clsVar3);
        ...
        )
        {
            ...
            {
                if (
                    Helpers.MultiplyWideningAndSubtract(firstOp[i], secondOp[i], thirdOp[i])
                    != result[i]
                )
                {
                    succeeded = false;
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd)}.{nameof(AdvSimd.MultiplyWideningLowerAndSubtract)}<UInt64>(Vector128<UInt64>, Vector64<UInt32>, Vector64<UInt32>): {method} failed:"
                );
                TestLibrary.TestFramework.LogInformation(
