...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void AddWideningLower_Vector128_UInt16()
        {
    ...
    public sealed unsafe class SimpleBinaryOpTest__AddWideningLower_Vector128_UInt16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__AddWideningLower_Vector128_UInt16 testClass
            )
            {
            ...
            {
                fixed (Vector128<UInt16>* pFld1 = &_fld1)fixed (Vector64<Byte>* pFld2 = &_fld2)
                {
        ...
        static SimpleBinaryOpTest__AddWideningLower_Vector128_UInt16()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetUInt16();
        ...
        public SimpleBinaryOpTest__AddWideningLower_Vector128_UInt16()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(
                    ...
                    new Type[] { typeof(Vector128<UInt16>), typeof(Vector64<Byte>) }
                )
                .Invoke(
                    null,
                    new object[]
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd)}.{nameof(AdvSimd.AddWideningLower)}<UInt16>(Vector128<UInt16>, Vector64<Byte>): {method} failed:"
                );
