...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ExtractNarrowingSaturateUnsignedLower_Vector64_UInt32()
        {
            var test =
                new SimpleUnaryOpTest__ExtractNarrowingSaturateUnsignedLower_Vector64_UInt32();
    ...
    public sealed unsafe class SimpleUnaryOpTest__ExtractNarrowingSaturateUnsignedLower_Vector64_UInt32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__ExtractNarrowingSaturateUnsignedLower_Vector64_UInt32 testClass
            )
            {
        ...
        static SimpleUnaryOpTest__ExtractNarrowingSaturateUnsignedLower_Vector64_UInt32()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetInt64();
        ...
        public SimpleUnaryOpTest__ExtractNarrowingSaturateUnsignedLower_Vector64_UInt32()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(
                    nameof(AdvSimd.ExtractNarrowingSaturateUnsignedLower),
                    new Type[] { typeof(Vector128<Int64>) }
                )
                .Invoke(
                    null,
                    new object[] { Unsafe.Read<Vector128<Int64>>(_dataTable.inArray1Ptr) }
                );
        ...
        public void RunReflectionScenario_Load()
        {
            ...
            var result = typeof(AdvSimd)
                ...
                .Invoke(
                    null,
                    new object[] { AdvSimd.LoadVector128((Int64*)(_dataTable.inArray1Ptr)) }
                );
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.ExtractNarrowingSaturateUnsignedLower(_clsVar1);
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.ExtractNarrowingSaturateUnsignedLower(op1);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test =
                new SimpleUnaryOpTest__ExtractNarrowingSaturateUnsignedLower_Vector64_UInt32();
            var result = AdvSimd.ExtractNarrowingSaturateUnsignedLower(test._fld1);
        ...
        )
        {
            ...
            {
                if (Helpers.ExtractNarrowingSaturateUnsigned(firstOp[i]) != result[i])
                {
                    succeeded = false;
                    break;
                }
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ExtractNarrowingSaturateUnsignedLower)}<UInt32>(Vector128<Int64>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
