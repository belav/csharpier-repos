...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void AddPairwiseWideningAndAdd_Vector64_SByte()
        {
    ...
    public sealed unsafe class SimpleBinaryOpTest__AddPairwiseWideningAndAdd_Vector64_SByte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__AddPairwiseWideningAndAdd_Vector64_SByte testClass
            )
            {
            ...
            {
                fixed (Vector64<Int16>* pFld1 = &_fld1)fixed (Vector64<SByte>* pFld2 = &_fld2)
                {
        ...
        static SimpleBinaryOpTest__AddPairwiseWideningAndAdd_Vector64_SByte()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetInt16();
        ...
        public SimpleBinaryOpTest__AddPairwiseWideningAndAdd_Vector64_SByte()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(
                    ...
                    new Type[] { typeof(Vector64<Int16>), typeof(Vector64<SByte>) }
                )
                .Invoke(
                    null,
                    new object[]
        ...
        public void RunClassLclFldScenario_Load()
        {
            ...
            fixed (Vector64<Int16>* pFld1 = &test._fld1)fixed (Vector64<SByte>* pFld2 = &test._fld2)
            {
                var result = AdvSimd.AddPairwiseWideningAndAdd(
                    AdvSimd.LoadVector64((Int16*)(pFld1)),
                    AdvSimd.LoadVector64((SByte*)(pFld2))
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd)}.{nameof(AdvSimd.AddPairwiseWideningAndAdd)}<Int16>(Vector64<Int16>, Vector64<SByte>): {method} failed:"
                );
