...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void Extract_Vector64_SByte_1()
        {
    ...
    public sealed unsafe class ExtractTest__Extract_Vector64_SByte_1
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(ExtractTest__Extract_Vector64_SByte_1 testClass)
            {
            ...
            public void RunStructFldScenario_Load(ExtractTest__Extract_Vector64_SByte_1 testClass)
            {
                fixed (Vector64<SByte>* pFld1 = &_fld1)
                {
                    var result = AdvSimd.Extract(AdvSimd.LoadVector64((SByte*)pFld1), ElementIndex);
        ...
        static ExtractTest__Extract_Vector64_SByte_1()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetSByte();
        ...
        public ExtractTest__Extract_Vector64_SByte_1()
        {
            Succeeded = true;
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            {
                var result = AdvSimd.Extract(AdvSimd.LoadVector64((SByte*)pClsVar1), ElementIndex);
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = AdvSimd.Extract(AdvSimd.LoadVector64((SByte*)&test._fld1), ElementIndex);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.Extract)}(Vector64<SByte>, 1): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
