...
namespace JIT.HardwareIntrinsics.Arm
{
    public static partial class Program
    {
        ...
        {
            var test =
                new SimpleTernaryOpTest__MultiplySubtractBySelectedScalar_Vector128_UInt32_Vector64_UInt32_1();
    ...
    public sealed unsafe class SimpleTernaryOpTest__MultiplySubtractBySelectedScalar_Vector128_UInt32_Vector64_UInt32_1
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleTernaryOpTest__MultiplySubtractBySelectedScalar_Vector128_UInt32_Vector64_UInt32_1 testClass
            )
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(
                    nameof(AdvSimd.MultiplySubtractBySelectedScalar),
                    new Type[]
                    {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.MultiplySubtractBySelectedScalar(_clsVar1, _clsVar2, _clsVar3, 1);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.MultiplySubtractBySelectedScalar)}<UInt32>(Vector128<UInt32>, Vector128<UInt32>, Vector64<UInt32>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
