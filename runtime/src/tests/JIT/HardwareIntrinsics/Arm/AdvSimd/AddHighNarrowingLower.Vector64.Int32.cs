...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void AddHighNarrowingLower_Vector64_Int32()
        {
            var test = new SimpleBinaryOpTest__AddHighNarrowingLower_Vector64_Int32();
    ...
    public sealed unsafe class SimpleBinaryOpTest__AddHighNarrowingLower_Vector64_Int32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__AddHighNarrowingLower_Vector64_Int32 testClass
            )
            {
        ...
        static SimpleBinaryOpTest__AddHighNarrowingLower_Vector64_Int32()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetInt64();
        ...
        public SimpleBinaryOpTest__AddHighNarrowingLower_Vector64_Int32()
        {
            Succeeded = true;
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.AddHighNarrowingLower)}<Int32>(Vector128<Int64>, Vector128<Int64>): {method} failed:"
                    );
