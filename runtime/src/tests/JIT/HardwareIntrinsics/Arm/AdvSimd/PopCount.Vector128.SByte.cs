    ...
    public sealed unsafe class SimpleUnaryOpTest__PopCount_Vector128_SByte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario_Load(
                SimpleUnaryOpTest__PopCount_Vector128_SByte testClass
            )
            {
                fixed (Vector128<SByte>* pFld1 = &_fld1)
                {
                    var result = AdvSimd.PopCount(AdvSimd.LoadVector128((SByte*)(pFld1)));
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.PopCount(Unsafe.Read<Vector128<SByte>>(_dataTable.inArray1Ptr));
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var result = AdvSimd.PopCount(AdvSimd.LoadVector128((SByte*)(_dataTable.inArray1Ptr)));
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(nameof(AdvSimd.PopCount), new Type[] { typeof(Vector128<SByte>) })
                .Invoke(
                    null,
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            {
                var result = AdvSimd.PopCount(AdvSimd.LoadVector128((SByte*)(pClsVar1)));
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = AdvSimd.PopCount(AdvSimd.LoadVector128((SByte*)(&test._fld1)));
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.PopCount)}<SByte>(Vector128<SByte>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
