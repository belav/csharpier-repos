...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void DuplicateToVector64_Int32()
        {
    ...
    public sealed unsafe class DuplicateUnaryOpTest__DuplicateToVector64_Int32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                DuplicateUnaryOpTest__DuplicateToVector64_Int32 testClass
            )
            {
        ...
        static DuplicateUnaryOpTest__DuplicateToVector64_Int32()
        {
            _clsVar = TestLibrary.Generator.GetInt32();
        }

        public DuplicateUnaryOpTest__DuplicateToVector64_Int32()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(nameof(AdvSimd.DuplicateToVector64), new Type[] { typeof(Int32) })
                .Invoke(
                    null,
                    new object[]
                    {
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.DuplicateToVector64)}<Int32>(Int32): DuplicateToVector64 failed:"
                    );
