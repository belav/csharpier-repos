...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void AddRoundedHighNarrowingLower_Vector64_Int32()
        {
    ...
    public sealed unsafe class SimpleBinaryOpTest__AddRoundedHighNarrowingLower_Vector64_Int32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__AddRoundedHighNarrowingLower_Vector64_Int32 testClass
            )
            {
        ...
        public SimpleBinaryOpTest__AddRoundedHighNarrowingLower_Vector64_Int32()
        {
            Succeeded = true;
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.AddRoundedHighNarrowingLower)}<Int32>(Vector128<Int64>, Vector128<Int64>): {method} failed:"
                    );
