...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void Negate_Vector64_SByte()
        {
            var test = new SimpleUnaryOpTest__Negate_Vector64_SByte();
    ...
    public sealed unsafe class SimpleUnaryOpTest__Negate_Vector64_SByte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleUnaryOpTest__Negate_Vector64_SByte testClass)
            {
            ...
            public void RunStructFldScenario_Load(
                SimpleUnaryOpTest__Negate_Vector64_SByte testClass
            )
            {
                fixed (Vector64<SByte>* pFld1 = &_fld1)
                {
                    var result = AdvSimd.Negate(AdvSimd.LoadVector64((SByte*)(pFld1)));
        ...
        static SimpleUnaryOpTest__Negate_Vector64_SByte()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetSByte();
        ...
        public SimpleUnaryOpTest__Negate_Vector64_SByte()
        {
            Succeeded = true;
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.Negate(Unsafe.Read<Vector64<SByte>>(_dataTable.inArray1Ptr));
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var result = AdvSimd.Negate(AdvSimd.LoadVector64((SByte*)(_dataTable.inArray1Ptr)));
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(nameof(AdvSimd.Negate), new Type[] { typeof(Vector64<SByte>) })
                .Invoke(
                    null,
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            {
                var result = AdvSimd.Negate(AdvSimd.LoadVector64((SByte*)(pClsVar1)));
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = AdvSimd.Negate(AdvSimd.LoadVector64((SByte*)(&test._fld1)));
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.Negate)}<SByte>(Vector64<SByte>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
