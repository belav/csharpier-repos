    ...
    public sealed unsafe class DuplicateUnaryOpTest__DuplicateToVector128_Single
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                DuplicateUnaryOpTest__DuplicateToVector128_Single testClass
            )
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(nameof(AdvSimd.DuplicateToVector128), new Type[] { typeof(Single) })
                .Invoke(
                    null,
                    new object[]
                    {
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.DuplicateToVector128)}<Single>(Single): DuplicateToVector128 failed:"
                    );
