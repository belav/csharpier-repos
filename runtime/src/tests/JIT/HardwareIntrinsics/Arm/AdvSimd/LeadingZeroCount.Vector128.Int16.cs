...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void LeadingZeroCount_Vector128_Int16()
        {
            var test = new SimpleUnaryOpTest__LeadingZeroCount_Vector128_Int16();
    ...
    public sealed unsafe class SimpleUnaryOpTest__LeadingZeroCount_Vector128_Int16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__LeadingZeroCount_Vector128_Int16 testClass
            )
            {
            ...
            )
            {
                ...
                {
                    var result = AdvSimd.LeadingZeroCount(AdvSimd.LoadVector128((Int16*)(pFld1)));
        ...
        static SimpleUnaryOpTest__LeadingZeroCount_Vector128_Int16()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetInt16();
        ...
        public SimpleUnaryOpTest__LeadingZeroCount_Vector128_Int16()
        {
            Succeeded = true;
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            {
                var result = AdvSimd.LeadingZeroCount(AdvSimd.LoadVector128((Int16*)(pClsVar1)));
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = AdvSimd.LeadingZeroCount(AdvSimd.LoadVector128((Int16*)(&test._fld1)));
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.LeadingZeroCount)}<Int16>(Vector128<Int16>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
