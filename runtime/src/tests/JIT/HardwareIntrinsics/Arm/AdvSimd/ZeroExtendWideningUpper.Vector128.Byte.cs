...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ZeroExtendWideningUpper_Vector128_Byte()
        {
    ...
    public sealed unsafe class SimpleUnaryOpTest__ZeroExtendWideningUpper_Vector128_Byte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__ZeroExtendWideningUpper_Vector128_Byte testClass
            )
            {
        ...
        static SimpleUnaryOpTest__ZeroExtendWideningUpper_Vector128_Byte()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetByte();
        ...
        public SimpleUnaryOpTest__ZeroExtendWideningUpper_Vector128_Byte()
        {
            Succeeded = true;
        ...
        public void RunClassLclFldScenario_Load()
        {
            ...
            {
                var result = AdvSimd.ZeroExtendWideningUpper(AdvSimd.LoadVector128((Byte*)(pFld1)));
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ZeroExtendWideningUpper)}<UInt16>(Vector128<Byte>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
