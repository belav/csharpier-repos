...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ExtractNarrowingSaturateLower_Vector64_UInt16()
        {
            var test = new SimpleUnaryOpTest__ExtractNarrowingSaturateLower_Vector64_UInt16();
    ...
    public sealed unsafe class SimpleUnaryOpTest__ExtractNarrowingSaturateLower_Vector64_UInt16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__ExtractNarrowingSaturateLower_Vector64_UInt16 testClass
            )
            {
        ...
        static SimpleUnaryOpTest__ExtractNarrowingSaturateLower_Vector64_UInt16()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetUInt32();
        ...
        public SimpleUnaryOpTest__ExtractNarrowingSaturateLower_Vector64_UInt16()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(
                    nameof(AdvSimd.ExtractNarrowingSaturateLower),
                    new Type[] { typeof(Vector128<UInt32>) }
                )
                .Invoke(
                    null,
                    new object[] { Unsafe.Read<Vector128<UInt32>>(_dataTable.inArray1Ptr) }
                );
        ...
        public void RunReflectionScenario_Load()
        {
            ...
            var result = typeof(AdvSimd)
                ...
                .Invoke(
                    null,
                    new object[] { AdvSimd.LoadVector128((UInt32*)(_dataTable.inArray1Ptr)) }
                );
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.ExtractNarrowingSaturateLower(_clsVar1);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ExtractNarrowingSaturateLower)}<UInt16>(Vector128<UInt32>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
