...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ConvertToInt32RoundToNegativeInfinityScalar_Vector64_Single()
        {
            var test =
                new SimpleUnaryOpTest__ConvertToInt32RoundToNegativeInfinityScalar_Vector64_Single();
    ...
    public sealed unsafe class SimpleUnaryOpTest__ConvertToInt32RoundToNegativeInfinityScalar_Vector64_Single
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__ConvertToInt32RoundToNegativeInfinityScalar_Vector64_Single testClass
            )
            {
                var result = AdvSimd.ConvertToInt32RoundToNegativeInfinityScalar(_fld1);
            ...
            )
            {
                ...
                {
                    var result = AdvSimd.ConvertToInt32RoundToNegativeInfinityScalar(
        ...
        static SimpleUnaryOpTest__ConvertToInt32RoundToNegativeInfinityScalar_Vector64_Single()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetSingle();
        ...
        public SimpleUnaryOpTest__ConvertToInt32RoundToNegativeInfinityScalar_Vector64_Single()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(
                    nameof(AdvSimd.ConvertToInt32RoundToNegativeInfinityScalar),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.ConvertToInt32RoundToNegativeInfinityScalar(_clsVar1);
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.ConvertToInt32RoundToNegativeInfinityScalar(op1);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test =
                new SimpleUnaryOpTest__ConvertToInt32RoundToNegativeInfinityScalar_Vector64_Single();
            var result = AdvSimd.ConvertToInt32RoundToNegativeInfinityScalar(test._fld1);
        ...
        )
        {
            ...
            if (Helpers.ConvertToInt32RoundToNegativeInfinity(firstOp[0]) != result[0])
            {
                succeeded = false;
            }
            else
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ConvertToInt32RoundToNegativeInfinityScalar)}<Int32>(Vector64<Single>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
