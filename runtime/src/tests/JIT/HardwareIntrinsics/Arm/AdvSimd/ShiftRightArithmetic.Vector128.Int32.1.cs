    ...
    public sealed unsafe class ImmUnaryOpTest__ShiftRightArithmetic_Vector128_Int32_1
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                ImmUnaryOpTest__ShiftRightArithmetic_Vector128_Int32_1 testClass
            )
            {
        ...
        public void RunClassLclFldScenario_Load()
        {
            ...
            {
                var result = AdvSimd.ShiftRightArithmetic(AdvSimd.LoadVector128((Int32*)(pFld)), 1);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ShiftRightArithmetic)}<Int32>(Vector128<Int32>, 1): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
