...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void FusedMultiplySubtract_Vector128_Single()
        {
    ...
    public sealed unsafe class SimpleTernaryOpTest__FusedMultiplySubtract_Vector128_Single
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleTernaryOpTest__FusedMultiplySubtract_Vector128_Single testClass
            )
            {
                var result = AdvSimd.FusedMultiplySubtract(_fld1, _fld2, _fld3);
            ...
            )
            {
                ...
                {
                    var result = AdvSimd.FusedMultiplySubtract(
        ...
        static SimpleTernaryOpTest__FusedMultiplySubtract_Vector128_Single()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetSingle();
        ...
        public SimpleTernaryOpTest__FusedMultiplySubtract_Vector128_Single()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(
                    nameof(AdvSimd.FusedMultiplySubtract),
                    new Type[]
                    {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.FusedMultiplySubtract(_clsVar1, _clsVar2, _clsVar3);
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.FusedMultiplySubtract(op1, op2, op3);
        ...
        )
        {
            ...
            for (var i = 0; i < RetElementCount; i++)
            {
                if (
                    BitConverter.SingleToInt32Bits(
                        Helpers.FusedMultiplySubtract(firstOp[i], secondOp[i], thirdOp[i])
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.FusedMultiplySubtract)}<Single>(Vector128<Single>, Vector128<Single>, Vector128<Single>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
