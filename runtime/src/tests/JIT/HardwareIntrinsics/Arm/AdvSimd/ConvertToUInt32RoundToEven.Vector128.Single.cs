    ...
    public sealed unsafe class SimpleUnaryOpTest__ConvertToUInt32RoundToEven_Vector128_Single
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__ConvertToUInt32RoundToEven_Vector128_Single testClass
            )
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(
                    nameof(AdvSimd.ConvertToUInt32RoundToEven),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.ConvertToUInt32RoundToEven(_clsVar1);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ConvertToUInt32RoundToEven)}<UInt32>(Vector128<Single>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
