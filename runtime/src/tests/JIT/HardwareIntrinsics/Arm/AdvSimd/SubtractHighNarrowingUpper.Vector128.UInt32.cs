...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void SubtractHighNarrowingUpper_Vector128_UInt32()
        {
    ...
    public sealed unsafe class SimpleTernaryOpTest__SubtractHighNarrowingUpper_Vector128_UInt32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleTernaryOpTest__SubtractHighNarrowingUpper_Vector128_UInt32 testClass
            )
            {
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.SubtractHighNarrowingUpper)}<UInt32>(Vector64<UInt32>, Vector128<UInt64>, Vector128<UInt64>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
