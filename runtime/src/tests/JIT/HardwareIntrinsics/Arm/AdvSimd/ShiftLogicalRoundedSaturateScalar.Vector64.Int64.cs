...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ShiftLogicalRoundedSaturateScalar_Vector64_Int64()
        {
    ...
    public sealed unsafe class SimpleBinaryOpTest__ShiftLogicalRoundedSaturateScalar_Vector64_Int64
    {
        ...
        private struct TestStruct
        {
            ...
            public static TestStruct Create()
            {
                ...
                Unsafe.CopyBlockUnaligned(
                    ref Unsafe.As<Vector64<Int64>, byte>(ref testStruct._fld1),
                ...
                Unsafe.CopyBlockUnaligned(
                    ref Unsafe.As<Vector64<Int64>, byte>(ref testStruct._fld2),
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__ShiftLogicalRoundedSaturateScalar_Vector64_Int64 testClass
            ) {
                var result = AdvSimd.ShiftLogicalRoundedSaturateScalar(_fld1, _fld2);
            ...
            public void RunStructFldScenario_Load(
                ...
                {
                    var result = AdvSimd.ShiftLogicalRoundedSaturateScalar(
        ...
        static SimpleBinaryOpTest__ShiftLogicalRoundedSaturateScalar_Vector64_Int64()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetInt64();
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector64<Int64>, byte>(ref _clsVar1),
                ref Unsafe.As<Int64, byte>(ref _data1[0]),
                (uint)Unsafe.SizeOf<Vector64<Int64>>()
            );
            for (var i = 0; i < Op2ElementCount; i++)
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector64<Int64>, byte>(ref _clsVar2),
                ref Unsafe.As<Int64, byte>(ref _data2[0]),
                (uint)Unsafe.SizeOf<Vector64<Int64>>()
            );
        }

        public SimpleBinaryOpTest__ShiftLogicalRoundedSaturateScalar_Vector64_Int64()
        {
            Succeeded = true;
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector64<Int64>, byte>(ref _fld1),
                ref Unsafe.As<Int64, byte>(ref _data1[0]),
                (uint)Unsafe.SizeOf<Vector64<Int64>>()
            );
            for (var i = 0; i < Op2ElementCount; i++)
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector64<Int64>, byte>(ref _fld2),
                ref Unsafe.As<Int64, byte>(ref _data2[0]),
                (uint)Unsafe.SizeOf<Vector64<Int64>>()
            );
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(
                    nameof(AdvSimd.ShiftLogicalRoundedSaturateScalar),
                    new Type[] { typeof(Vector64<Int64>), typeof(Vector64<Int64>) }
                )
                .Invoke(
                    null,
                    new object[]
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.ShiftLogicalRoundedSaturateScalar(_clsVar1, _clsVar2);
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.ShiftLogicalRoundedSaturateScalar(op1, op2);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimpleBinaryOpTest__ShiftLogicalRoundedSaturateScalar_Vector64_Int64();
            var result = AdvSimd.ShiftLogicalRoundedSaturateScalar(test._fld1, test._fld2);
        ...
        public void RunClassLclFldScenario_Load()
        {
            ...
            fixed (Vector64<Int64>* pFld1 = &test._fld1)fixed (Vector64<Int64>* pFld2 = &test._fld2)
            {
                var result = AdvSimd.ShiftLogicalRoundedSaturateScalar(
                    AdvSimd.LoadVector64((Int64*)(pFld1)),
                    AdvSimd.LoadVector64((Int64*)(pFld2))
        ...
        private void ValidateResult(
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd)}.{nameof(AdvSimd.ShiftLogicalRoundedSaturateScalar)}<Int64>(Vector64<Int64>, Vector64<Int64>): {method} failed:"
                );
