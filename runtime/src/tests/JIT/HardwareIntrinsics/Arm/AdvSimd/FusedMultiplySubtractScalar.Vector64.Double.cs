    ...
    public sealed unsafe class SimpleTernaryOpTest__FusedMultiplySubtractScalar_Vector64_Double
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleTernaryOpTest__FusedMultiplySubtractScalar_Vector64_Double testClass
            )
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(
                    nameof(AdvSimd.FusedMultiplySubtractScalar),
                    new Type[]
                    {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.FusedMultiplySubtractScalar(_clsVar1, _clsVar2, _clsVar3);
        ...
        )
        {
            ...
            if (
                BitConverter.DoubleToInt64Bits(
                    Helpers.FusedMultiplySubtract(firstOp[0], secondOp[0], thirdOp[0])
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.FusedMultiplySubtractScalar)}<Double>(Vector64<Double>, Vector64<Double>, Vector64<Double>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
