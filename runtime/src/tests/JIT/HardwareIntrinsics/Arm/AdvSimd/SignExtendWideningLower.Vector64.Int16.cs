    ...
    public sealed unsafe class SimpleUnaryOpTest__SignExtendWideningLower_Vector64_Int16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__SignExtendWideningLower_Vector64_Int16 testClass
            )
            {
        ...
        public void RunClassLclFldScenario_Load()
        {
            ...
            {
                var result = AdvSimd.SignExtendWideningLower(AdvSimd.LoadVector64((Int16*)(pFld1)));
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.SignExtendWideningLower)}<Int32>(Vector64<Int16>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
