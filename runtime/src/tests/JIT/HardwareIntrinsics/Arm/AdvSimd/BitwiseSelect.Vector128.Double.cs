    ...
    public sealed unsafe class SimpleTernaryOpTest__BitwiseSelect_Vector128_Double
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleTernaryOpTest__BitwiseSelect_Vector128_Double testClass
            )
            {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.BitwiseSelect(_clsVar1, _clsVar2, _clsVar3);
        ...
        )
        {
            ...
            for (var i = 0; i < RetElementCount; i++)
            {
                if (
                    BitConverter.DoubleToInt64Bits(
                        Helpers.BitwiseSelect(firstOp[i], secondOp[i], thirdOp[i])
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.BitwiseSelect)}<Double>(Vector128<Double>, Vector128<Double>, Vector128<Double>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
