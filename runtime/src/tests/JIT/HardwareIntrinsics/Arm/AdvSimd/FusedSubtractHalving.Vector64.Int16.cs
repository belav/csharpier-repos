...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void FusedSubtractHalving_Vector64_Int16()
        {
            var test = new SimpleBinaryOpTest__FusedSubtractHalving_Vector64_Int16();
    ...
    public sealed unsafe class SimpleBinaryOpTest__FusedSubtractHalving_Vector64_Int16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__FusedSubtractHalving_Vector64_Int16 testClass
            ) {
        ...
        static SimpleBinaryOpTest__FusedSubtractHalving_Vector64_Int16()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetInt16();
        ...
        public SimpleBinaryOpTest__FusedSubtractHalving_Vector64_Int16()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(
                    nameof(AdvSimd.FusedSubtractHalving),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.FusedSubtractHalving(_clsVar1, _clsVar2);
        ...
        private void ValidateResult(
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd)}.{nameof(AdvSimd.FusedSubtractHalving)}<Int16>(Vector64<Int16>, Vector64<Int16>): {method} failed:"
                );
