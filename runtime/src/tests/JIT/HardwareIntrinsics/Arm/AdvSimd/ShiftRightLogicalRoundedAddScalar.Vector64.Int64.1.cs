...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ShiftRightLogicalRoundedAddScalar_Vector64_Int64_1()
        {
    ...
    public sealed unsafe class ImmBinaryOpTest__ShiftRightLogicalRoundedAddScalar_Vector64_Int64_1
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                ImmBinaryOpTest__ShiftRightLogicalRoundedAddScalar_Vector64_Int64_1 testClass
            )
            {
                var result = AdvSimd.ShiftRightLogicalRoundedAddScalar(_fld1, _fld2, 1);
        ...
        static ImmBinaryOpTest__ShiftRightLogicalRoundedAddScalar_Vector64_Int64_1()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetInt64();
        ...
        public ImmBinaryOpTest__ShiftRightLogicalRoundedAddScalar_Vector64_Int64_1()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(
                    nameof(AdvSimd.ShiftRightLogicalRoundedAddScalar),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.ShiftRightLogicalRoundedAddScalar(_clsVar1, _clsVar2, 1);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new ImmBinaryOpTest__ShiftRightLogicalRoundedAddScalar_Vector64_Int64_1();
            var result = AdvSimd.ShiftRightLogicalRoundedAddScalar(test._fld1, test._fld2, 1);
        ...
        )
        {
            ...
            if (Helpers.ShiftRightLogicalRoundedAdd(firstOp[0], secondOp[0], Imm) != result[0])
            {
                succeeded = false;
            }
            else
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ShiftRightLogicalRoundedAddScalar)}<Int64>(Vector64<Int64>, Vector64<Int64>, 1): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
