    ...
    public sealed unsafe class ImmBinaryOpTest__ShiftRightAndInsertScalar_Vector64_Int64
    {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(
                    nameof(AdvSimd.ShiftRightAndInsertScalar),
                    new Type[] { typeof(Vector64<Int64>), typeof(Vector64<Int64>), typeof(byte) }
                )
                .Invoke(
                    null,
                    new object[]
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.ShiftRightAndInsertScalar(_clsVar1, _clsVar2, 32);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd)}.{nameof(AdvSimd.ShiftRightAndInsertScalar)}<Int64>(Vector64<Int64>, Vector64<Int64>, 32): {method} failed:"
                );
                TestLibrary.TestFramework.LogInformation(
