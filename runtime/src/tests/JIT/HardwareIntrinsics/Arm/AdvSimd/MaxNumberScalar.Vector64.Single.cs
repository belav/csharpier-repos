    ...
    public sealed unsafe class SimpleBinaryOpTest__MaxNumberScalar_Vector64_Single
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__MaxNumberScalar_Vector64_Single testClass
            )
            {
        ...
        )
        {
            ...
            if (
                BitConverter.SingleToInt32Bits(Helpers.MaxNumber(left[0], right[0]))
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.MaxNumberScalar)}<Single>(Vector64<Single>, Vector64<Single>): {method} failed:"
                    );
