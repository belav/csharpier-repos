    ...
    public sealed unsafe class SimpleUnaryOpTest__Abs_Vector64_SByte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario_Load(SimpleUnaryOpTest__Abs_Vector64_SByte testClass)
            {
                ...
                {
                    var result = AdvSimd.Abs(AdvSimd.LoadVector64((SByte*)(pFld1)));
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.Abs(Unsafe.Read<Vector64<SByte>>(_dataTable.inArray1Ptr));
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var result = AdvSimd.Abs(AdvSimd.LoadVector64((SByte*)(_dataTable.inArray1Ptr)));
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(nameof(AdvSimd.Abs), new Type[] { typeof(Vector64<SByte>) })
                .Invoke(
                    null,
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            {
                var result = AdvSimd.Abs(AdvSimd.LoadVector64((SByte*)(pClsVar1)));
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = AdvSimd.Abs(AdvSimd.LoadVector64((SByte*)(&test._fld1)));
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.Abs)}<Byte>(Vector64<SByte>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
