    ...
    public sealed unsafe class ExtractVectorTest__ExtractVector128_Int32_1
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario_Load(
                ExtractVectorTest__ExtractVector128_Int32_1 testClass
            )
            {
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ExtractVector128)}<Int32>(Vector128<Int32>, Vector128<Int32>, 1): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
