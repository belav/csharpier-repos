    ...
    public sealed unsafe class ImmBinaryOpTest__ShiftLeftAndInsert_Vector64_UInt16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                ImmBinaryOpTest__ShiftLeftAndInsert_Vector64_UInt16 testClass
            )
            {
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ShiftLeftAndInsert)}<UInt16>(Vector64<UInt16>, Vector64<UInt16>, 8): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
