...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void Extract_Vector64_Single_1()
        {
            var test = new ExtractTest__Extract_Vector64_Single_1();
    ...
    public sealed unsafe class ExtractTest__Extract_Vector64_Single_1
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(ExtractTest__Extract_Vector64_Single_1 testClass)
            {
            ...
            public void RunStructFldScenario_Load(ExtractTest__Extract_Vector64_Single_1 testClass)
            {
        ...
        static ExtractTest__Extract_Vector64_Single_1()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetSingle();
        ...
        public ExtractTest__Extract_Vector64_Single_1()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(
                    ...
                    new Type[] { typeof(Vector64<Single>), typeof(byte) }
                )
                .Invoke(
                    null,
                    new object[]
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            {
                var result = AdvSimd.Extract(AdvSimd.LoadVector64((Single*)pClsVar1), ElementIndex);
        ...
        public void RunClassLclFldScenario_Load()
        {
            ...
            {
                var result = AdvSimd.Extract(AdvSimd.LoadVector64((Single*)(pFld1)), ElementIndex);
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = AdvSimd.Extract(AdvSimd.LoadVector64((Single*)&test._fld1), ElementIndex);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.Extract)}(Vector64<Single>, 1): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
