...
namespace JIT.HardwareIntrinsics.Arm
{
    public static partial class Program
    {
        ...
        {
            var test =
                new ImmBinaryOpTest__MultiplyBySelectedScalarWideningLower_Vector64_UInt16_Vector64_UInt16_3();
    ...
    public sealed unsafe class ImmBinaryOpTest__MultiplyBySelectedScalarWideningLower_Vector64_UInt16_Vector64_UInt16_3
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                ImmBinaryOpTest__MultiplyBySelectedScalarWideningLower_Vector64_UInt16_Vector64_UInt16_3 testClass
            )
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(
                    ...
                    new Type[] { typeof(Vector64<UInt16>), typeof(Vector64<UInt16>), typeof(byte) }
                )
                .Invoke(
                    null,
                    new object[]
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.MultiplyBySelectedScalarWideningLower(_clsVar1, _clsVar2, 3);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.MultiplyBySelectedScalarWideningLower)}<UInt32>(Vector64<UInt16>, Vector64<UInt16>, 3): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
