...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void DuplicateToVector128_Byte()
        {
            var test = new DuplicateUnaryOpTest__DuplicateToVector128_Byte();
    ...
    public sealed unsafe class DuplicateUnaryOpTest__DuplicateToVector128_Byte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                DuplicateUnaryOpTest__DuplicateToVector128_Byte testClass
            )
            {
        ...
        static DuplicateUnaryOpTest__DuplicateToVector128_Byte()
        {
            _clsVar = TestLibrary.Generator.GetByte();
        }

        public DuplicateUnaryOpTest__DuplicateToVector128_Byte()
        {
            Succeeded = true;
        ...
        private void ValidateResult(Byte data, Byte[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.DuplicateToVector128)}<Byte>(Byte): DuplicateToVector128 failed:"
                    );
