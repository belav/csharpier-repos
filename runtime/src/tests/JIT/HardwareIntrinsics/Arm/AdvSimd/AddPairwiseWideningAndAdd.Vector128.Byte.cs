...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void AddPairwiseWideningAndAdd_Vector128_Byte()
        {
    ...
    public sealed unsafe class SimpleBinaryOpTest__AddPairwiseWideningAndAdd_Vector128_Byte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__AddPairwiseWideningAndAdd_Vector128_Byte testClass
            ) {
            ...
            public void RunStructFldScenario_Load(
                ...
                fixed (Vector128<UInt16>* pFld1 = &_fld1)fixed (Vector128<Byte>* pFld2 = &_fld2)
                {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(
                    ...
                    new Type[] { typeof(Vector128<UInt16>), typeof(Vector128<Byte>) }
                )
                .Invoke(
                    null,
                    new object[]
        ...
        private void ValidateResult(
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd)}.{nameof(AdvSimd.AddPairwiseWideningAndAdd)}<UInt16>(Vector128<UInt16>, Vector128<Byte>): {method} failed:"
                );
