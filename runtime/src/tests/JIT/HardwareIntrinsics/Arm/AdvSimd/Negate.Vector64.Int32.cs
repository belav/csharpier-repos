    ...
    public sealed unsafe class SimpleUnaryOpTest__Negate_Vector64_Int32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario_Load(
                SimpleUnaryOpTest__Negate_Vector64_Int32 testClass
            )
            {
                fixed (Vector64<Int32>* pFld1 = &_fld1)
                {
                    var result = AdvSimd.Negate(AdvSimd.LoadVector64((Int32*)(pFld1)));
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.Negate(Unsafe.Read<Vector64<Int32>>(_dataTable.inArray1Ptr));
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var result = AdvSimd.Negate(AdvSimd.LoadVector64((Int32*)(_dataTable.inArray1Ptr)));
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(nameof(AdvSimd.Negate), new Type[] { typeof(Vector64<Int32>) })
                .Invoke(
                    null,
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            {
                var result = AdvSimd.Negate(AdvSimd.LoadVector64((Int32*)(pClsVar1)));
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = AdvSimd.Negate(AdvSimd.LoadVector64((Int32*)(&test._fld1)));
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.Negate)}<Int32>(Vector64<Int32>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
