...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ShiftRightArithmetic_Vector64_Int16_1()
        {
            var test = new ImmUnaryOpTest__ShiftRightArithmetic_Vector64_Int16_1();
    ...
    public sealed unsafe class ImmUnaryOpTest__ShiftRightArithmetic_Vector64_Int16_1
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                ImmUnaryOpTest__ShiftRightArithmetic_Vector64_Int16_1 testClass
            )
            {
        ...
        static ImmUnaryOpTest__ShiftRightArithmetic_Vector64_Int16_1()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data[i] = TestLibrary.Generator.GetInt16();
        ...
        public ImmUnaryOpTest__ShiftRightArithmetic_Vector64_Int16_1()
        {
            Succeeded = true;
        ...
        public void RunClassLclFldScenario_Load()
        {
            ...
            {
                var result = AdvSimd.ShiftRightArithmetic(AdvSimd.LoadVector64((Int16*)(pFld)), 1);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ShiftRightArithmetic)}<Int16>(Vector64<Int16>, 1): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
