...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void LeadingSignCount_Vector64_Int16()
        {
    ...
    public sealed unsafe class SimpleUnaryOpTest__LeadingSignCount_Vector64_Int16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__LeadingSignCount_Vector64_Int16 testClass
            )
            {
            ...
            )
            {
                ...
                {
                    var result = AdvSimd.LeadingSignCount(AdvSimd.LoadVector64((Int16*)(pFld1)));
        ...
        static SimpleUnaryOpTest__LeadingSignCount_Vector64_Int16()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetInt16();
        ...
        public SimpleUnaryOpTest__LeadingSignCount_Vector64_Int16()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(nameof(AdvSimd.LeadingSignCount), new Type[] { typeof(Vector64<Int16>) })
                .Invoke(
                    null,
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            {
                var result = AdvSimd.LeadingSignCount(AdvSimd.LoadVector64((Int16*)(pClsVar1)));
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = AdvSimd.LeadingSignCount(AdvSimd.LoadVector64((Int16*)(&test._fld1)));
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.LeadingSignCount)}<Int16>(Vector64<Int16>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
