...
namespace JIT.HardwareIntrinsics.Arm
{
    public static partial class Program
    {
        ...
        {
            var test =
                new ImmBinaryOpTest__MultiplyBySelectedScalar_Vector64_Single_Vector128_Single_3();
    ...
    public sealed unsafe class ImmBinaryOpTest__MultiplyBySelectedScalar_Vector64_Single_Vector128_Single_3
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                ImmBinaryOpTest__MultiplyBySelectedScalar_Vector64_Single_Vector128_Single_3 testClass
            )
            {
            ...
            {
                fixed (Vector64<Single>* pFld1 = &_fld1)fixed (Vector128<Single>* pFld2 = &_fld2)
                {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(
                    ...
                    new Type[] { typeof(Vector64<Single>), typeof(Vector128<Single>), typeof(byte) }
                )
                .Invoke(
                    null,
                    new object[]
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd)}.{nameof(AdvSimd.MultiplyBySelectedScalar)}<Single>(Vector64<Single>, Vector128<Single>, 3): {method} failed:"
                );
                TestLibrary.TestFramework.LogInformation(
