    ...
    public sealed unsafe class SimpleUnaryOpTest__Not_Vector128_Byte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario_Load(SimpleUnaryOpTest__Not_Vector128_Byte testClass)
            {
                ...
                {
                    var result = AdvSimd.Not(AdvSimd.LoadVector128((Byte*)(pFld1)));
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.Not(Unsafe.Read<Vector128<Byte>>(_dataTable.inArray1Ptr));
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var result = AdvSimd.Not(AdvSimd.LoadVector128((Byte*)(_dataTable.inArray1Ptr)));
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(nameof(AdvSimd.Not), new Type[] { typeof(Vector128<Byte>) })
                .Invoke(
                    null,
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            {
                var result = AdvSimd.Not(AdvSimd.LoadVector128((Byte*)(pClsVar1)));
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = AdvSimd.Not(AdvSimd.LoadVector128((Byte*)(&test._fld1)));
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.Not)}<Byte>(Vector128<Byte>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
