...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void AddRoundedHighNarrowingLower_Vector64_UInt32()
        {
            var test = new SimpleBinaryOpTest__AddRoundedHighNarrowingLower_Vector64_UInt32();
    ...
    public sealed unsafe class SimpleBinaryOpTest__AddRoundedHighNarrowingLower_Vector64_UInt32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__AddRoundedHighNarrowingLower_Vector64_UInt32 testClass
            )
            {
                var result = AdvSimd.AddRoundedHighNarrowingLower(_fld1, _fld2);
        ...
        static SimpleBinaryOpTest__AddRoundedHighNarrowingLower_Vector64_UInt32()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetUInt64();
        ...
        public SimpleBinaryOpTest__AddRoundedHighNarrowingLower_Vector64_UInt32()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(
                    nameof(AdvSimd.AddRoundedHighNarrowingLower),
                    new Type[] { typeof(Vector128<UInt64>), typeof(Vector128<UInt64>) }
                )
                .Invoke(
                    null,
                    new object[]
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.AddRoundedHighNarrowingLower(_clsVar1, _clsVar2);
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.AddRoundedHighNarrowingLower(op1, op2);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimpleBinaryOpTest__AddRoundedHighNarrowingLower_Vector64_UInt32();
            var result = AdvSimd.AddRoundedHighNarrowingLower(test._fld1, test._fld2);
        ...
        )
        {
            ...
            {
                if (Helpers.AddRoundedHighNarrowing(left[i], right[i]) != result[i])
                {
                    succeeded = false;
                    break;
                }
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.AddRoundedHighNarrowingLower)}<UInt32>(Vector128<UInt64>, Vector128<UInt64>): {method} failed:"
                    );
