    ...
    public sealed unsafe class SimpleBinaryOpTest__SubtractHighNarrowingLower_Vector64_Int16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__SubtractHighNarrowingLower_Vector64_Int16 testClass
            )
            {
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.SubtractHighNarrowingLower)}<Int16>(Vector128<Int32>, Vector128<Int32>): {method} failed:"
                    );
