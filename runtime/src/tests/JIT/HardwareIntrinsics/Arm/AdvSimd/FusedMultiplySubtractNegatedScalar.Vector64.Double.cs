...
namespace JIT.HardwareIntrinsics.Arm
{
    public static partial class Program
    {
        ...
        {
            var test =
                new SimpleTernaryOpTest__FusedMultiplySubtractNegatedScalar_Vector64_Double();
    ...
    public sealed unsafe class SimpleTernaryOpTest__FusedMultiplySubtractNegatedScalar_Vector64_Double
    {
        ...
        private struct TestStruct
        {
            ...
            public static TestStruct Create()
            {
                ...
                Unsafe.CopyBlockUnaligned(
                    ref Unsafe.As<Vector64<Double>, byte>(ref testStruct._fld3),
            ...
            public void RunStructFldScenario(
                SimpleTernaryOpTest__FusedMultiplySubtractNegatedScalar_Vector64_Double testClass
            )
            {
        ...
        static SimpleTernaryOpTest__FusedMultiplySubtractNegatedScalar_Vector64_Double()
        {
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector64<Double>, byte>(ref _clsVar3),
                ref Unsafe.As<Double, byte>(ref _data3[0]),
                (uint)Unsafe.SizeOf<Vector64<Double>>()
            );
        }
        ...
        public SimpleTernaryOpTest__FusedMultiplySubtractNegatedScalar_Vector64_Double()
        {
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector64<Double>, byte>(ref _fld3),
                ref Unsafe.As<Double, byte>(ref _data3[0]),
                (uint)Unsafe.SizeOf<Vector64<Double>>()
            );
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(
                    nameof(AdvSimd.FusedMultiplySubtractNegatedScalar),
                    new Type[]
                    {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.FusedMultiplySubtractNegatedScalar(_clsVar1, _clsVar2, _clsVar3);
        ...
        )
        {
            ...
            if (
                BitConverter.DoubleToInt64Bits(
                    Helpers.FusedMultiplySubtractNegated(firstOp[0], secondOp[0], thirdOp[0])
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd)}.{nameof(AdvSimd.FusedMultiplySubtractNegatedScalar)}<Double>(Vector64<Double>, Vector64<Double>, Vector64<Double>): {method} failed:"
                );
                TestLibrary.TestFramework.LogInformation(
