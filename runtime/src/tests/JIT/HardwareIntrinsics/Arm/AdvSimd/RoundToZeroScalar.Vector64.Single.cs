...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void RoundToZeroScalar_Vector64_Single()
        {
            var test = new SimpleUnaryOpTest__RoundToZeroScalar_Vector64_Single();
    ...
    public sealed unsafe class SimpleUnaryOpTest__RoundToZeroScalar_Vector64_Single
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__RoundToZeroScalar_Vector64_Single testClass
            )
            {
                var result = AdvSimd.RoundToZeroScalar(_fld1);
            ...
            )
            {
                ...
                {
                    var result = AdvSimd.RoundToZeroScalar(AdvSimd.LoadVector64((Single*)(pFld1)));
        ...
        static SimpleUnaryOpTest__RoundToZeroScalar_Vector64_Single()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetSingle();
        ...
        public SimpleUnaryOpTest__RoundToZeroScalar_Vector64_Single()
        {
            Succeeded = true;
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.RoundToZeroScalar(
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(
                    nameof(AdvSimd.RoundToZeroScalar),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.RoundToZeroScalar(_clsVar1);
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            {
                var result = AdvSimd.RoundToZeroScalar(AdvSimd.LoadVector64((Single*)(pClsVar1)));
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.RoundToZeroScalar(op1);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimpleUnaryOpTest__RoundToZeroScalar_Vector64_Single();
            var result = AdvSimd.RoundToZeroScalar(test._fld1);
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = AdvSimd.RoundToZeroScalar(AdvSimd.LoadVector64((Single*)(&test._fld1)));
        ...
        )
        {
            ...
            {
                if (
                    BitConverter.SingleToInt32Bits(Helpers.RoundToZero(firstOp[i]))
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.RoundToZeroScalar)}<Single>(Vector64<Single>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
