    ...
    public sealed unsafe class SimpleTernaryOpTest__VectorTableLookupExtension_Vector64_Byte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleTernaryOpTest__VectorTableLookupExtension_Vector64_Byte testClass
            )
            {
            ...
            {
                fixed (Vector64<Byte>* pFld1 = &_fld1)fixed (Vector128<Byte>* pFld2 = &_fld2)fixed (
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd)}.{nameof(AdvSimd.VectorTableLookupExtension)}<Byte>(Vector64<Byte>, Vector128<Byte>, Vector64<Byte>): {method} failed:"
                );
                TestLibrary.TestFramework.LogInformation(
