    ...
    public sealed unsafe class ExtractVectorTest__ExtractVector128_Double_1
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario_Load(
                ExtractVectorTest__ExtractVector128_Double_1 testClass
            )
            {
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ExtractVector128)}<Double>(Vector128<Double>, Vector128<Double>, 1): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
