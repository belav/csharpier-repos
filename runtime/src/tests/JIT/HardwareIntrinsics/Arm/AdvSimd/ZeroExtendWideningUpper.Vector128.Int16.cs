...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ZeroExtendWideningUpper_Vector128_Int16()
        {
    ...
    public sealed unsafe class SimpleUnaryOpTest__ZeroExtendWideningUpper_Vector128_Int16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__ZeroExtendWideningUpper_Vector128_Int16 testClass
            )
            {
        ...
        static SimpleUnaryOpTest__ZeroExtendWideningUpper_Vector128_Int16()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetInt16();
        ...
        public SimpleUnaryOpTest__ZeroExtendWideningUpper_Vector128_Int16()
        {
            Succeeded = true;
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ZeroExtendWideningUpper)}<Int32>(Vector128<Int16>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
