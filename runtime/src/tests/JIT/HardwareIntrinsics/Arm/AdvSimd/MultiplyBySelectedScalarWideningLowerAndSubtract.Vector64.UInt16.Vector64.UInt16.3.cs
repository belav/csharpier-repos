...
namespace JIT.HardwareIntrinsics.Arm
{
    public static partial class Program
    {
        ...
        {
            var test =
                new SimpleTernaryOpTest__MultiplyBySelectedScalarWideningLowerAndSubtract_Vector64_UInt16_Vector64_UInt16_3();
    ...
    public sealed unsafe class SimpleTernaryOpTest__MultiplyBySelectedScalarWideningLowerAndSubtract_Vector64_UInt16_Vector64_UInt16_3
    {
        private struct DataTable
        {
            ...
            public DataTable(
                ...
                Unsafe.CopyBlockUnaligned(
                    ...
                    ref Unsafe.As<UInt16, byte>(ref inArray2[0]),
                    (uint)sizeOfinArray2
                );
                Unsafe.CopyBlockUnaligned(
                    ref Unsafe.AsRef<byte>(inArray3Ptr),
                    ref Unsafe.As<UInt16, byte>(ref inArray3[0]),
                    (uint)sizeOfinArray3
                );
            }
        ...
        private struct TestStruct
        {
            ...
            public static TestStruct Create()
            {
                ...
                Unsafe.CopyBlockUnaligned(
                    ref Unsafe.As<Vector128<UInt32>, byte>(ref testStruct._fld1),
                ...
                Unsafe.CopyBlockUnaligned(
                    ref Unsafe.As<Vector64<UInt16>, byte>(ref testStruct._fld2),
                    ref Unsafe.As<UInt16, byte>(ref _data2[0]),
                    (uint)Unsafe.SizeOf<Vector64<UInt16>>()
                );
                for (var i = 0; i < Op3ElementCount; i++)
                {
                    _data3[i] = TestLibrary.Generator.GetUInt16();
                }
                Unsafe.CopyBlockUnaligned(
                    ref Unsafe.As<Vector64<UInt16>, byte>(ref testStruct._fld3),
                    ref Unsafe.As<UInt16, byte>(ref _data3[0]),
                    (uint)Unsafe.SizeOf<Vector64<UInt16>>()
                );
            ...
            public void RunStructFldScenario(
                SimpleTernaryOpTest__MultiplyBySelectedScalarWideningLowerAndSubtract_Vector64_UInt16_Vector64_UInt16_3 testClass
            ) {
        ...
        static SimpleTernaryOpTest__MultiplyBySelectedScalarWideningLowerAndSubtract_Vector64_UInt16_Vector64_UInt16_3()
        {
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector128<UInt32>, byte>(ref _clsVar1),
                ref Unsafe.As<UInt32, byte>(ref _data1[0]),
                (uint)Unsafe.SizeOf<Vector128<UInt32>>()
            );
            for (var i = 0; i < Op2ElementCount; i++)
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector64<UInt16>, byte>(ref _clsVar2),
                ref Unsafe.As<UInt16, byte>(ref _data2[0]),
                (uint)Unsafe.SizeOf<Vector64<UInt16>>()
            );
            for (var i = 0; i < Op3ElementCount; i++)
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector64<UInt16>, byte>(ref _clsVar3),
                ref Unsafe.As<UInt16, byte>(ref _data3[0]),
                (uint)Unsafe.SizeOf<Vector64<UInt16>>()
            );
        }
        ...
        public SimpleTernaryOpTest__MultiplyBySelectedScalarWideningLowerAndSubtract_Vector64_UInt16_Vector64_UInt16_3()
        {
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector128<UInt32>, byte>(ref _fld1),
                ref Unsafe.As<UInt32, byte>(ref _data1[0]),
                (uint)Unsafe.SizeOf<Vector128<UInt32>>()
            );
            for (var i = 0; i < Op2ElementCount; i++)
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector64<UInt16>, byte>(ref _fld2),
                ref Unsafe.As<UInt16, byte>(ref _data2[0]),
                (uint)Unsafe.SizeOf<Vector64<UInt16>>()
            );
            for (var i = 0; i < Op3ElementCount; i++)
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector64<UInt16>, byte>(ref _fld3),
                ref Unsafe.As<UInt16, byte>(ref _data3[0]),
                (uint)Unsafe.SizeOf<Vector64<UInt16>>()
            );
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(
                    nameof(AdvSimd.MultiplyBySelectedScalarWideningLowerAndSubtract),
                    new Type[]
                    {
        ...
        public void RunClassFldScenario_Load()
        {
            ...
            fixed (Vector128<UInt32>* pFld1 = &_fld1)fixed (Vector64<UInt16>* pFld2 = &_fld2)fixed (
                Vector64<UInt16>* pFld3 = &_fld3
            ) {
                var result = AdvSimd.MultiplyBySelectedScalarWideningLowerAndSubtract(
                    AdvSimd.LoadVector128((UInt32*)(pFld1)),
                    AdvSimd.LoadVector64((UInt16*)(pFld2)),
        ...
        private void ValidateResult(
            ...
            {
                if (
                    Helpers.MultiplyWideningAndSubtract(firstOp[i], secondOp[i], thirdOp[Imm])
                    != result[i]
                ) {
                    succeeded = false;
                    break;
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd)}.{nameof(AdvSimd.MultiplyBySelectedScalarWideningLowerAndSubtract)}<UInt32>(Vector128<UInt32>, Vector64<UInt16>, Vector64<UInt16>): {method} failed:"
                );
                TestLibrary.TestFramework.LogInformation(
