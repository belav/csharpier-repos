...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ShiftRightArithmeticRoundedAdd_Vector128_Int16_1()
        {
    ...
    public sealed unsafe class ImmBinaryOpTest__ShiftRightArithmeticRoundedAdd_Vector128_Int16_1
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                ImmBinaryOpTest__ShiftRightArithmeticRoundedAdd_Vector128_Int16_1 testClass
            )
            {
        ...
        static ImmBinaryOpTest__ShiftRightArithmeticRoundedAdd_Vector128_Int16_1()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetInt16();
        ...
        public ImmBinaryOpTest__ShiftRightArithmeticRoundedAdd_Vector128_Int16_1()
        {
            Succeeded = true;
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ShiftRightArithmeticRoundedAdd)}<Int16>(Vector128<Int16>, Vector128<Int16>, 1): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
