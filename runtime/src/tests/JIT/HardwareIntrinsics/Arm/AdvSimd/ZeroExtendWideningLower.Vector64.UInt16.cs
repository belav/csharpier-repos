...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ZeroExtendWideningLower_Vector64_UInt16()
        {
            var test = new SimpleUnaryOpTest__ZeroExtendWideningLower_Vector64_UInt16();
    ...
    public sealed unsafe class SimpleUnaryOpTest__ZeroExtendWideningLower_Vector64_UInt16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__ZeroExtendWideningLower_Vector64_UInt16 testClass
            )
            {
        ...
        static SimpleUnaryOpTest__ZeroExtendWideningLower_Vector64_UInt16()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetUInt16();
        ...
        public SimpleUnaryOpTest__ZeroExtendWideningLower_Vector64_UInt16()
        {
            Succeeded = true;
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ZeroExtendWideningLower)}<UInt32>(Vector64<UInt16>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
