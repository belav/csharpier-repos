    ...
    public sealed unsafe class SimpleBinaryOpTest__AddWideningUpper_Vector128_UInt16_Vector128_Byte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__AddWideningUpper_Vector128_UInt16_Vector128_Byte testClass
            )
            {
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.AddWideningUpper)}<UInt16>(Vector128<UInt16>, Vector128<Byte>): {method} failed:"
                    );
