    ...
    public sealed unsafe class SimpleTernaryOpTest__AbsoluteDifferenceAdd_Vector128_Byte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleTernaryOpTest__AbsoluteDifferenceAdd_Vector128_Byte testClass
            )
            {
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.AbsoluteDifferenceAdd)}<Byte>(Vector128<Byte>, Vector128<Byte>, Vector128<Byte>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
