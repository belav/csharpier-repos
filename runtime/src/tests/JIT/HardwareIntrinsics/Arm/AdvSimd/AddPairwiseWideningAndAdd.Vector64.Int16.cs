    ...
    public sealed unsafe class SimpleBinaryOpTest__AddPairwiseWideningAndAdd_Vector64_Int16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__AddPairwiseWideningAndAdd_Vector64_Int16 testClass
            )
            {
            ...
            {
                fixed (Vector64<Int32>* pFld1 = &_fld1)fixed (Vector64<Int16>* pFld2 = &_fld2)
                {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(
                    ...
                    new Type[] { typeof(Vector64<Int32>), typeof(Vector64<Int16>) }
                )
                .Invoke(
                    null,
                    new object[]
        ...
        public void RunClassLclFldScenario_Load()
        {
            ...
            fixed (Vector64<Int32>* pFld1 = &test._fld1)fixed (Vector64<Int16>* pFld2 = &test._fld2)
            {
                var result = AdvSimd.AddPairwiseWideningAndAdd(
                    AdvSimd.LoadVector64((Int32*)(pFld1)),
                    AdvSimd.LoadVector64((Int16*)(pFld2))
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd)}.{nameof(AdvSimd.AddPairwiseWideningAndAdd)}<Int32>(Vector64<Int32>, Vector64<Int16>): {method} failed:"
                );
