...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ShiftLeftLogicalWideningLower_Vector64_UInt32_1()
        {
    ...
    public sealed unsafe class ImmUnaryOpTest__ShiftLeftLogicalWideningLower_Vector64_UInt32_1
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                ImmUnaryOpTest__ShiftLeftLogicalWideningLower_Vector64_UInt32_1 testClass
            )
            {
        ...
        static ImmUnaryOpTest__ShiftLeftLogicalWideningLower_Vector64_UInt32_1()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data[i] = TestLibrary.Generator.GetUInt32();
        ...
        public ImmUnaryOpTest__ShiftLeftLogicalWideningLower_Vector64_UInt32_1()
        {
            Succeeded = true;
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ShiftLeftLogicalWideningLower)}<UInt64>(Vector64<UInt32>, 1): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
