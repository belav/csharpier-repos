...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void PolynomialMultiplyWideningLower_Vector64_SByte()
        {
    ...
    public sealed unsafe class SimpleBinaryOpTest__PolynomialMultiplyWideningLower_Vector64_SByte
    {
        ...
        private struct TestStruct
        {
            ...
            public static TestStruct Create()
            {
                ...
                Unsafe.CopyBlockUnaligned(
                    ref Unsafe.As<Vector64<SByte>, byte>(ref testStruct._fld1),
                    ref Unsafe.As<SByte, byte>(ref _data1[0]),
                    (uint)Unsafe.SizeOf<Vector64<SByte>>()
                );
                ...
                Unsafe.CopyBlockUnaligned(
                    ref Unsafe.As<Vector64<SByte>, byte>(ref testStruct._fld2),
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__PolynomialMultiplyWideningLower_Vector64_SByte testClass
            ) {
                var result = AdvSimd.PolynomialMultiplyWideningLower(_fld1, _fld2);
            ...
            public void RunStructFldScenario_Load(
                ...
                {
                    var result = AdvSimd.PolynomialMultiplyWideningLower(
        ...
        private static readonly int Op1ElementCount =
            Unsafe.SizeOf<Vector64<SByte>>() / sizeof(SByte);
        ...
        static SimpleBinaryOpTest__PolynomialMultiplyWideningLower_Vector64_SByte()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetSByte();
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector64<SByte>, byte>(ref _clsVar1),
                ref Unsafe.As<SByte, byte>(ref _data1[0]),
                (uint)Unsafe.SizeOf<Vector64<SByte>>()
            );
            for (var i = 0; i < Op2ElementCount; i++)
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector64<SByte>, byte>(ref _clsVar2),
                ref Unsafe.As<SByte, byte>(ref _data2[0]),
                (uint)Unsafe.SizeOf<Vector64<SByte>>()
            );
        }

        public SimpleBinaryOpTest__PolynomialMultiplyWideningLower_Vector64_SByte()
        {
            Succeeded = true;
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector64<SByte>, byte>(ref _fld1),
                ref Unsafe.As<SByte, byte>(ref _data1[0]),
                (uint)Unsafe.SizeOf<Vector64<SByte>>()
            );
            for (var i = 0; i < Op2ElementCount; i++)
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector64<SByte>, byte>(ref _fld2),
                ref Unsafe.As<SByte, byte>(ref _data2[0]),
                (uint)Unsafe.SizeOf<Vector64<SByte>>()
            );
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(
                    nameof(AdvSimd.PolynomialMultiplyWideningLower),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.PolynomialMultiplyWideningLower(_clsVar1, _clsVar2);
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.PolynomialMultiplyWideningLower(op1, op2);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimpleBinaryOpTest__PolynomialMultiplyWideningLower_Vector64_SByte();
            var result = AdvSimd.PolynomialMultiplyWideningLower(test._fld1, test._fld2);
        ...
        public void RunClassLclFldScenario_Load()
        {
            ...
            fixed (Vector64<SByte>* pFld1 = &test._fld1)fixed (Vector64<SByte>* pFld2 = &test._fld2)
            {
                var result = AdvSimd.PolynomialMultiplyWideningLower(
                    AdvSimd.LoadVector64((SByte*)(pFld1)),
                    AdvSimd.LoadVector64((SByte*)(pFld2))
        ...
        private void ValidateResult(
            ...
            {
                if (Helpers.PolynomialMultiplyWidening(left[i], right[i]) != result[i])
                {
                    succeeded = false;
                    break;
                }
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd)}.{nameof(AdvSimd.PolynomialMultiplyWideningLower)}<Int16>(Vector64<SByte>, Vector64<SByte>): {method} failed:"
                );
