    ...
    public sealed unsafe class SimpleBinaryOpTest__SubtractHighNarrowingLower_Vector64_Int32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__SubtractHighNarrowingLower_Vector64_Int32 testClass
            )
            {
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.SubtractHighNarrowingLower)}<Int32>(Vector128<Int64>, Vector128<Int64>): {method} failed:"
                    );
