...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ExtractVector64_Byte_1()
        {
            var test = new ExtractVectorTest__ExtractVector64_Byte_1();
    ...
    public sealed unsafe class ExtractVectorTest__ExtractVector64_Byte_1
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(ExtractVectorTest__ExtractVector64_Byte_1 testClass)
            {
            ...
            public void RunStructFldScenario_Load(
                ExtractVectorTest__ExtractVector64_Byte_1 testClass
            )
            {
        ...
        static ExtractVectorTest__ExtractVector64_Byte_1()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetByte();
        ...
        public ExtractVectorTest__ExtractVector64_Byte_1()
        {
            Succeeded = true;
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ExtractVector64)}<Byte>(Vector64<Byte>, Vector64<Byte>, 1): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
