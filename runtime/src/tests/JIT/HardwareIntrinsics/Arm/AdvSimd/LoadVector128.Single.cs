...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    public sealed unsafe class LoadUnaryOpTest__LoadVector128_Single
    {
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var result = AdvSimd.LoadVector128((Single*)(_dataTable.inArray1Ptr));
        ...
        public void RunReflectionScenario_Load()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(nameof(AdvSimd.LoadVector128), new Type[] { typeof(Single*) })
                .Invoke(
                    null,
                    new object[] { Pointer.Box(_dataTable.inArray1Ptr, typeof(Single*)) }
                );
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.LoadVector128)}<Single>(Vector128<Single>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
