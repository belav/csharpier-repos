...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    public sealed unsafe class SimpleUnaryOpTest__ZeroExtendWideningLower_Vector64_Int32
    {
        ...
        public void RunClassLclFldScenario_Load()
        {
            ...
            {
                var result = AdvSimd.ZeroExtendWideningLower(AdvSimd.LoadVector64((Int32*)(pFld1)));
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ZeroExtendWideningLower)}<Int64>(Vector64<Int32>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
