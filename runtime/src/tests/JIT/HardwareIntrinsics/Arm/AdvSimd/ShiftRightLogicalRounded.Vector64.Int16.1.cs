...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ShiftRightLogicalRounded_Vector64_Int16_1()
        {
    ...
    public sealed unsafe class ImmUnaryOpTest__ShiftRightLogicalRounded_Vector64_Int16_1
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                ImmUnaryOpTest__ShiftRightLogicalRounded_Vector64_Int16_1 testClass
            )
            {
        ...
        static ImmUnaryOpTest__ShiftRightLogicalRounded_Vector64_Int16_1()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data[i] = TestLibrary.Generator.GetInt16();
        ...
        public ImmUnaryOpTest__ShiftRightLogicalRounded_Vector64_Int16_1()
        {
            Succeeded = true;
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ShiftRightLogicalRounded)}<Int16>(Vector64<Int16>, 1): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
