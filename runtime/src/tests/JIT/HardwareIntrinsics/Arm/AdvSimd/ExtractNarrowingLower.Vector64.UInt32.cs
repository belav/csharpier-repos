    ...
    public sealed unsafe class SimpleUnaryOpTest__ExtractNarrowingLower_Vector64_UInt32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__ExtractNarrowingLower_Vector64_UInt32 testClass
            )
            {
        ...
        public void RunClassLclFldScenario_Load()
        {
            ...
            {
                var result = AdvSimd.ExtractNarrowingLower(AdvSimd.LoadVector128((UInt64*)(pFld1)));
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ExtractNarrowingLower)}<UInt32>(Vector128<UInt64>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
