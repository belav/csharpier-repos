    ...
    public sealed unsafe class SimpleBinaryOpTest__AddPairwise_Vector64_SByte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__AddPairwise_Vector64_SByte testClass
            )
            {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.AddPairwise(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd)}.{nameof(AdvSimd.AddPairwise)}<SByte>(Vector64<SByte>, Vector64<SByte>): {method} failed:"
                );
