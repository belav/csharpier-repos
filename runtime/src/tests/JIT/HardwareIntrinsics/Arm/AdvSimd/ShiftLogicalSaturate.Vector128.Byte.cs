...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ShiftLogicalSaturate_Vector128_Byte()
        {
            var test = new SimpleBinaryOpTest__ShiftLogicalSaturate_Vector128_Byte();
    ...
    public sealed unsafe class SimpleBinaryOpTest__ShiftLogicalSaturate_Vector128_Byte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__ShiftLogicalSaturate_Vector128_Byte testClass
            )
            {
            ...
            {
                fixed (Vector128<Byte>* pFld1 = &_fld1)fixed (Vector128<SByte>* pFld2 = &_fld2)
                {
        ...
        static SimpleBinaryOpTest__ShiftLogicalSaturate_Vector128_Byte()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetByte();
        ...
        public SimpleBinaryOpTest__ShiftLogicalSaturate_Vector128_Byte()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(
                    ...
                    new Type[] { typeof(Vector128<Byte>), typeof(Vector128<SByte>) }
                )
                .Invoke(
                    null,
                    new object[]
        ...
        public void RunClassLclFldScenario_Load()
        {
            ...
            fixed (Vector128<Byte>* pFld1 = &test._fld1)fixed (
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd)}.{nameof(AdvSimd.ShiftLogicalSaturate)}<Byte>(Vector128<Byte>, Vector128<SByte>): {method} failed:"
                );
