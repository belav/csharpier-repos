    ...
    public sealed unsafe class SimpleBinaryOpTest__PolynomialMultiply_Vector128_Byte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__PolynomialMultiply_Vector128_Byte testClass
            )
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(
                    nameof(AdvSimd.PolynomialMultiply),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.PolynomialMultiply(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.PolynomialMultiply)}<Byte>(Vector128<Byte>, Vector128<Byte>): {method} failed:"
                    );
