...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ShiftRightLogicalAdd_Vector64_UInt32_1()
        {
    ...
    public sealed unsafe class ImmBinaryOpTest__ShiftRightLogicalAdd_Vector64_UInt32_1
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                ImmBinaryOpTest__ShiftRightLogicalAdd_Vector64_UInt32_1 testClass
            )
            {
        ...
        static ImmBinaryOpTest__ShiftRightLogicalAdd_Vector64_UInt32_1()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetUInt32();
        ...
        public ImmBinaryOpTest__ShiftRightLogicalAdd_Vector64_UInt32_1()
        {
            Succeeded = true;
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ShiftRightLogicalAdd)}<UInt32>(Vector64<UInt32>, Vector64<UInt32>, 1): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
