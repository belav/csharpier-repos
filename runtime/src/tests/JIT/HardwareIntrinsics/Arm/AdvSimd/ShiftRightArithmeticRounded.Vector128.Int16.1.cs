    ...
    public sealed unsafe class ImmUnaryOpTest__ShiftRightArithmeticRounded_Vector128_Int16_1
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                ImmUnaryOpTest__ShiftRightArithmeticRounded_Vector128_Int16_1 testClass
            )
            {
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ShiftRightArithmeticRounded)}<Int16>(Vector128<Int16>, 1): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
