...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void MultiplyRoundedDoublingByScalarSaturateHigh_Vector128_Int16()
        {
            var test =
                new SimpleBinaryOpTest__MultiplyRoundedDoublingByScalarSaturateHigh_Vector128_Int16();
    ...
    public sealed unsafe class SimpleBinaryOpTest__MultiplyRoundedDoublingByScalarSaturateHigh_Vector128_Int16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__MultiplyRoundedDoublingByScalarSaturateHigh_Vector128_Int16 testClass
            )
            {
        ...
        static SimpleBinaryOpTest__MultiplyRoundedDoublingByScalarSaturateHigh_Vector128_Int16()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetInt16();
        ...
        public SimpleBinaryOpTest__MultiplyRoundedDoublingByScalarSaturateHigh_Vector128_Int16()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(
                    ...
                    new Type[] { typeof(Vector128<Int16>), typeof(Vector64<Int16>) }
                )
                .Invoke(
                    null,
                    new object[]
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.MultiplyRoundedDoublingByScalarSaturateHigh)}<Int16>(Vector128<Int16>, Vector64<Int16>): {method} failed:"
                    );
