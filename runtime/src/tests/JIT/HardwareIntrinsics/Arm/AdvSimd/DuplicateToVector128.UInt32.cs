...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void DuplicateToVector128_UInt32()
        {
    ...
    public sealed unsafe class DuplicateUnaryOpTest__DuplicateToVector128_UInt32
    {
        ...
        static DuplicateUnaryOpTest__DuplicateToVector128_UInt32()
        {
            _clsVar = TestLibrary.Generator.GetUInt32();
        }

        public DuplicateUnaryOpTest__DuplicateToVector128_UInt32()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(nameof(AdvSimd.DuplicateToVector128), new Type[] { typeof(UInt32) })
                .Invoke(
                    null,
                    new object[]
                    {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.DuplicateToVector128(_clsVar);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.DuplicateToVector128)}<UInt32>(UInt32): DuplicateToVector128 failed:"
                    );
