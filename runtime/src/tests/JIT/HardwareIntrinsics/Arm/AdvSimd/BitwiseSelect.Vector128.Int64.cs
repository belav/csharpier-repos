    ...
    public sealed unsafe class SimpleTernaryOpTest__BitwiseSelect_Vector128_Int64
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleTernaryOpTest__BitwiseSelect_Vector128_Int64 testClass
            )
            {
        ...
        public void RunClassFldScenario_Load()
        {
            ...
            fixed (Vector128<Int64>* pFld1 = &_fld1)fixed (Vector128<Int64>* pFld2 = &_fld2)fixed (
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd)}.{nameof(AdvSimd.BitwiseSelect)}<Int64>(Vector128<Int64>, Vector128<Int64>, Vector128<Int64>): {method} failed:"
                );
                TestLibrary.TestFramework.LogInformation(
