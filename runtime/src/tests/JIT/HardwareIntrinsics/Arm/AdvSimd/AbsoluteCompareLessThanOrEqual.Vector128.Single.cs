    ...
    public sealed unsafe class SimpleBinaryOpTest__AbsoluteCompareLessThanOrEqual_Vector128_Single
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__AbsoluteCompareLessThanOrEqual_Vector128_Single testClass
            )
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(
                    nameof(AdvSimd.AbsoluteCompareLessThanOrEqual),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.AbsoluteCompareLessThanOrEqual(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.AbsoluteCompareLessThanOrEqual)}<Single>(Vector128<Single>, Vector128<Single>): {method} failed:"
                    );
