    ...
    public sealed unsafe class ImmUnaryOpTest__DuplicateSelectedScalarToVector128_Vector128_SByte_8
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                ImmUnaryOpTest__DuplicateSelectedScalarToVector128_Vector128_SByte_8 testClass
            )
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(
                    ...
                    new Type[] { typeof(Vector128<SByte>), typeof(byte) }
                )
                .Invoke(
                    null,
                    new object[] { Unsafe.Read<Vector128<SByte>>(_dataTable.inArrayPtr), (byte)8 }
                );
        ...
        public void RunReflectionScenario_Load()
        {
            ...
            var result = typeof(AdvSimd)
                ...
                .Invoke(
                    null,
                    new object[] { AdvSimd.LoadVector128((SByte*)(_dataTable.inArrayPtr)), (byte)8 }
                );
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.DuplicateSelectedScalarToVector128(_clsVar, 8);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.DuplicateSelectedScalarToVector128)}<SByte>(Vector128<SByte>, 8): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
