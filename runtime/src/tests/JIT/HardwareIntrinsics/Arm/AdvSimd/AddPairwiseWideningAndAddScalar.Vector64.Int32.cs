    ...
    public sealed unsafe class SimpleBinaryOpTest__AddPairwiseWideningAndAddScalar_Vector64_Int32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__AddPairwiseWideningAndAddScalar_Vector64_Int32 testClass
            ) {
            ...
            public void RunStructFldScenario_Load(
                ...
                fixed (Vector64<Int64>* pFld1 = &_fld1)fixed (Vector64<Int32>* pFld2 = &_fld2)
                {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(
                    nameof(AdvSimd.AddPairwiseWideningAndAddScalar),
                    new Type[] { typeof(Vector64<Int64>), typeof(Vector64<Int32>) }
                )
                .Invoke(
                    null,
                    new object[]
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.AddPairwiseWideningAndAddScalar(_clsVar1, _clsVar2);
        ...
        public void RunClassLclFldScenario_Load()
        {
            ...
            fixed (Vector64<Int64>* pFld1 = &test._fld1)fixed (Vector64<Int32>* pFld2 = &test._fld2)
            {
                var result = AdvSimd.AddPairwiseWideningAndAddScalar(
                    AdvSimd.LoadVector64((Int64*)(pFld1)),
                    AdvSimd.LoadVector64((Int32*)(pFld2))
        ...
        private void ValidateResult(
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd)}.{nameof(AdvSimd.AddPairwiseWideningAndAddScalar)}<Int64>(Vector64<Int64>, Vector64<Int32>): {method} failed:"
                );
