    ...
    public sealed unsafe class SimpleUnaryOpTest__ZeroExtendWideningLower_Vector64_UInt32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__ZeroExtendWideningLower_Vector64_UInt32 testClass
            )
            {
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ZeroExtendWideningLower)}<UInt64>(Vector64<UInt32>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
