...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    public sealed unsafe class ImmOpTest__DuplicateToVector64_Single_31
    {
        ...
        public void RunBasicScenario()
        {
            ...
            var result = AdvSimd.DuplicateToVector64((Single)31);
        ...
        public void RunReflectionScenario()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(nameof(AdvSimd.DuplicateToVector64), new Type[] { typeof(Single) })
                .Invoke(null, new object[] { (Single)31 });
        ...
        private void ValidateResult(Single[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.DuplicateToVector64)}<Single>(31): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
