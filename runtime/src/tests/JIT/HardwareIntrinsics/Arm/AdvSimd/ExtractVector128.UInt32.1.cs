...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ExtractVector128_UInt32_1()
        {
    ...
    public sealed unsafe class ExtractVectorTest__ExtractVector128_UInt32_1
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(ExtractVectorTest__ExtractVector128_UInt32_1 testClass)
            {
            ...
            public void RunStructFldScenario_Load(
                ExtractVectorTest__ExtractVector128_UInt32_1 testClass
            )
            {
        ...
        static ExtractVectorTest__ExtractVector128_UInt32_1()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetUInt32();
        ...
        public ExtractVectorTest__ExtractVector128_UInt32_1()
        {
            Succeeded = true;
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ExtractVector128)}<UInt32>(Vector128<UInt32>, Vector128<UInt32>, 1): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
