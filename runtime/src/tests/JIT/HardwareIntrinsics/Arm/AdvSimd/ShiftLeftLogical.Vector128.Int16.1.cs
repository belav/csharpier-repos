    ...
    public sealed unsafe class ImmUnaryOpTest__ShiftLeftLogical_Vector128_Int16_1
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                ImmUnaryOpTest__ShiftLeftLogical_Vector128_Int16_1 testClass
            )
            {
            ...
            )
            {
                ...
                {
                    var result = AdvSimd.ShiftLeftLogical(AdvSimd.LoadVector128((Int16*)(pFld)), 1);
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            {
                var result = AdvSimd.ShiftLeftLogical(AdvSimd.LoadVector128((Int16*)(pClsVar)), 1);
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = AdvSimd.ShiftLeftLogical(AdvSimd.LoadVector128((Int16*)(&test._fld)), 1);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ShiftLeftLogical)}<Int16>(Vector128<Int16>, 1): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
