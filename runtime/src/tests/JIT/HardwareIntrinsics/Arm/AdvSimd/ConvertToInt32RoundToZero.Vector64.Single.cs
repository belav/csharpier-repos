...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ConvertToInt32RoundToZero_Vector64_Single()
        {
            var test = new SimpleUnaryOpTest__ConvertToInt32RoundToZero_Vector64_Single();
    ...
    public sealed unsafe class SimpleUnaryOpTest__ConvertToInt32RoundToZero_Vector64_Single
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__ConvertToInt32RoundToZero_Vector64_Single testClass
            )
            {
        ...
        static SimpleUnaryOpTest__ConvertToInt32RoundToZero_Vector64_Single()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetSingle();
        ...
        public SimpleUnaryOpTest__ConvertToInt32RoundToZero_Vector64_Single()
        {
            Succeeded = true;
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ConvertToInt32RoundToZero)}<Int32>(Vector64<Single>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
