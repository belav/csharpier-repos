...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ShiftLogicalSaturateScalar_Vector64_Int64()
        {
    ...
    public sealed unsafe class SimpleBinaryOpTest__ShiftLogicalSaturateScalar_Vector64_Int64
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__ShiftLogicalSaturateScalar_Vector64_Int64 testClass
            ) {
                var result = AdvSimd.ShiftLogicalSaturateScalar(_fld1, _fld2);
            ...
            public void RunStructFldScenario_Load(
                ...
                {
                    var result = AdvSimd.ShiftLogicalSaturateScalar(
        ...
        static SimpleBinaryOpTest__ShiftLogicalSaturateScalar_Vector64_Int64()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetInt64();
        ...
        public SimpleBinaryOpTest__ShiftLogicalSaturateScalar_Vector64_Int64()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(
                    nameof(AdvSimd.ShiftLogicalSaturateScalar),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.ShiftLogicalSaturateScalar(_clsVar1, _clsVar2);
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.ShiftLogicalSaturateScalar(op1, op2);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimpleBinaryOpTest__ShiftLogicalSaturateScalar_Vector64_Int64();
            var result = AdvSimd.ShiftLogicalSaturateScalar(test._fld1, test._fld2);
        ...
        private void ValidateResult(
            ...
            if (Helpers.ShiftLogicalSaturate(left[0], right[0]) != result[0])
            {
                succeeded = false;
            }
            else
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd)}.{nameof(AdvSimd.ShiftLogicalSaturateScalar)}<Int64>(Vector64<Int64>, Vector64<Int64>): {method} failed:"
                );
