...
namespace JIT.HardwareIntrinsics.Arm
{
    public static partial class Program
    {
        ...
        {
            var test =
                new ImmBinaryOpTest__MultiplyBySelectedScalarWideningLower_Vector64_UInt32_Vector64_UInt32_1();
    ...
    public sealed unsafe class ImmBinaryOpTest__MultiplyBySelectedScalarWideningLower_Vector64_UInt32_Vector64_UInt32_1
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                ImmBinaryOpTest__MultiplyBySelectedScalarWideningLower_Vector64_UInt32_Vector64_UInt32_1 testClass
            )
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(
                    ...
                    new Type[] { typeof(Vector64<UInt32>), typeof(Vector64<UInt32>), typeof(byte) }
                )
                .Invoke(
                    null,
                    new object[]
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.MultiplyBySelectedScalarWideningLower)}<UInt64>(Vector64<UInt32>, Vector64<UInt32>, 1): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
