    ...
    public sealed unsafe class SimpleBinaryOpTest__ShiftArithmeticRounded_Vector64_SByte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__ShiftArithmeticRounded_Vector64_SByte testClass
            )
            {
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ShiftArithmeticRounded)}<SByte>(Vector64<SByte>, Vector64<SByte>): {method} failed:"
                    );
