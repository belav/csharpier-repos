...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void SubtractWideningLower_Vector128_UInt16()
        {
    ...
    public sealed unsafe class SimpleBinaryOpTest__SubtractWideningLower_Vector128_UInt16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__SubtractWideningLower_Vector128_UInt16 testClass
            )
            {
        ...
        static SimpleBinaryOpTest__SubtractWideningLower_Vector128_UInt16()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetUInt16();
        ...
        public SimpleBinaryOpTest__SubtractWideningLower_Vector128_UInt16()
        {
            Succeeded = true;
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.SubtractWideningLower)}<UInt16>(Vector128<UInt16>, Vector64<Byte>): {method} failed:"
                    );
