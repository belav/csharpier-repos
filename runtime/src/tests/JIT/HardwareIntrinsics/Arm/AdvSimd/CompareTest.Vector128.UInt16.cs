...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void CompareTest_Vector128_UInt16()
        {
            var test = new SimpleBinaryOpTest__CompareTest_Vector128_UInt16();
    ...
    public sealed unsafe class SimpleBinaryOpTest__CompareTest_Vector128_UInt16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__CompareTest_Vector128_UInt16 testClass
            )
            {
        ...
        static SimpleBinaryOpTest__CompareTest_Vector128_UInt16()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetUInt16();
        ...
        public SimpleBinaryOpTest__CompareTest_Vector128_UInt16()
        {
            Succeeded = true;
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.CompareTest(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.CompareTest)}<UInt16>(Vector128<UInt16>, Vector128<UInt16>): {method} failed:"
                    );
