    ...
    public sealed unsafe class SimpleBinaryOpTest__SubtractScalar_Vector64_Int64
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__SubtractScalar_Vector64_Int64 testClass
            )
            {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.SubtractScalar(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd)}.{nameof(AdvSimd.SubtractScalar)}<Int64>(Vector64<Int64>, Vector64<Int64>): {method} failed:"
                );
