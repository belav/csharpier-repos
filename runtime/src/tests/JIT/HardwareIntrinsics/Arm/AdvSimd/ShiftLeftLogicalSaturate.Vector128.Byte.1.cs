...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ShiftLeftLogicalSaturate_Vector128_Byte_1()
        {
            var test = new ImmUnaryOpTest__ShiftLeftLogicalSaturate_Vector128_Byte_1();
    ...
    public sealed unsafe class ImmUnaryOpTest__ShiftLeftLogicalSaturate_Vector128_Byte_1
    {
        ...
        private struct TestStruct
        {
            ...
            public static TestStruct Create()
            {
                ...
                {
                    _data[i] = TestLibrary.Generator.GetByte();
                }
                Unsafe.CopyBlockUnaligned(
            ...
            public void RunStructFldScenario(
                ImmUnaryOpTest__ShiftLeftLogicalSaturate_Vector128_Byte_1 testClass
            )
            {
        ...
        static ImmUnaryOpTest__ShiftLeftLogicalSaturate_Vector128_Byte_1()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data[i] = TestLibrary.Generator.GetByte();
        ...
        public ImmUnaryOpTest__ShiftLeftLogicalSaturate_Vector128_Byte_1()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                ...
                .Invoke(
                    null,
                    new object[] { Unsafe.Read<Vector128<Byte>>(_dataTable.inArrayPtr), (byte)1 }
                );
        ...
        public void RunReflectionScenario_Load()
        {
            ...
            var result = typeof(AdvSimd)
                ...
                .Invoke(
                    null,
                    new object[] { AdvSimd.LoadVector128((Byte*)(_dataTable.inArrayPtr)), (byte)1 }
                );
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ShiftLeftLogicalSaturate)}<Byte>(Vector128<Byte>, 1): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
