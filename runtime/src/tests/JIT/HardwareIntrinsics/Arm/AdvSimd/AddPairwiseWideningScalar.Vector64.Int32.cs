    ...
    public sealed unsafe class SimpleUnaryOpTest__AddPairwiseWideningScalar_Vector64_Int32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__AddPairwiseWideningScalar_Vector64_Int32 testClass
            )
            {
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.AddPairwiseWideningScalar)}<Int64>(Vector64<Int32>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
