    ...
    public sealed unsafe class ImmUnaryOpTest__DuplicateSelectedScalarToVector128_Vector128_Single_2
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                ImmUnaryOpTest__DuplicateSelectedScalarToVector128_Vector128_Single_2 testClass
            )
            {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.DuplicateSelectedScalarToVector128(_clsVar, 2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.DuplicateSelectedScalarToVector128)}<Single>(Vector128<Single>, 2): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
