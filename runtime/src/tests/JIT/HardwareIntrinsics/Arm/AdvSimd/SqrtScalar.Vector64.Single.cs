    ...
    public sealed unsafe class SimpleUnaryOpTest__SqrtScalar_Vector64_Single
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__SqrtScalar_Vector64_Single testClass
            )
            {
            ...
            )
            {
                ...
                {
                    var result = AdvSimd.SqrtScalar(AdvSimd.LoadVector64((Single*)(pFld1)));
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.SqrtScalar(Unsafe.Read<Vector64<Single>>(_dataTable.inArray1Ptr));
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(nameof(AdvSimd.SqrtScalar), new Type[] { typeof(Vector64<Single>) })
                .Invoke(
                    null,
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.SqrtScalar(_clsVar1);
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            {
                var result = AdvSimd.SqrtScalar(AdvSimd.LoadVector64((Single*)(pClsVar1)));
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = AdvSimd.SqrtScalar(AdvSimd.LoadVector64((Single*)(&test._fld1)));
        ...
        )
        {
            ...
            if (
                BitConverter.SingleToInt32Bits(Helpers.Sqrt(firstOp[0]))
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.SqrtScalar)}<Single>(Vector64<Single>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
