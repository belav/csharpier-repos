...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void SqrtScalar_Vector64_Double()
        {
            var test = new SimpleUnaryOpTest__SqrtScalar_Vector64_Double();
    ...
    public sealed unsafe class SimpleUnaryOpTest__SqrtScalar_Vector64_Double
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__SqrtScalar_Vector64_Double testClass
            )
            {
            ...
            )
            {
                ...
                {
                    var result = AdvSimd.SqrtScalar(AdvSimd.LoadVector64((Double*)(pFld1)));
        ...
        static SimpleUnaryOpTest__SqrtScalar_Vector64_Double()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetDouble();
        ...
        public SimpleUnaryOpTest__SqrtScalar_Vector64_Double()
        {
            Succeeded = true;
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.SqrtScalar(Unsafe.Read<Vector64<Double>>(_dataTable.inArray1Ptr));
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(nameof(AdvSimd.SqrtScalar), new Type[] { typeof(Vector64<Double>) })
                .Invoke(
                    null,
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            {
                var result = AdvSimd.SqrtScalar(AdvSimd.LoadVector64((Double*)(pClsVar1)));
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = AdvSimd.SqrtScalar(AdvSimd.LoadVector64((Double*)(&test._fld1)));
        ...
        )
        {
            ...
            if (
                BitConverter.DoubleToInt64Bits(Helpers.Sqrt(firstOp[0]))
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.SqrtScalar)}<Double>(Vector64<Double>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
