    ...
    public sealed unsafe class SimpleBinaryOpTest__FusedSubtractHalving_Vector128_SByte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__FusedSubtractHalving_Vector128_SByte testClass
            )
            {
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.FusedSubtractHalving)}<SByte>(Vector128<SByte>, Vector128<SByte>): {method} failed:"
                    );
