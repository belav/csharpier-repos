...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void AddWideningUpper_Vector128_UInt16_Vector128_UInt16()
        {
    ...
    public sealed unsafe class SimpleBinaryOpTest__AddWideningUpper_Vector128_UInt16_Vector128_UInt16
    {
        ...
        static SimpleBinaryOpTest__AddWideningUpper_Vector128_UInt16_Vector128_UInt16()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetUInt16();
        ...
        public SimpleBinaryOpTest__AddWideningUpper_Vector128_UInt16_Vector128_UInt16()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(
                    nameof(AdvSimd.AddWideningUpper),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.AddWideningUpper(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.AddWideningUpper)}<UInt32>(Vector128<UInt16>, Vector128<UInt16>): {method} failed:"
                    );
