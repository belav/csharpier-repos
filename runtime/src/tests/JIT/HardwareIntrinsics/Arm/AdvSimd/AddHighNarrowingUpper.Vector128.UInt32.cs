    ...
    public sealed unsafe class SimpleTernaryOpTest__AddHighNarrowingUpper_Vector128_UInt32
    {
        private struct DataTable
        {
            ...
            )
            {
                ...
                Unsafe.CopyBlockUnaligned(
                    ...
                    ref Unsafe.As<UInt64, byte>(ref inArray3[0]),
                    (uint)sizeOfinArray3
                );
            }
        ...
        private struct TestStruct
        {
            ...
            public static TestStruct Create()
            {
                ...
                {
                    _data3[i] = TestLibrary.Generator.GetUInt64();
                }
                Unsafe.CopyBlockUnaligned(
                    ref Unsafe.As<Vector128<UInt64>, byte>(ref testStruct._fld3),
                    ref Unsafe.As<UInt64, byte>(ref _data3[0]),
                    (uint)Unsafe.SizeOf<Vector128<UInt64>>()
                );
            ...
            public void RunStructFldScenario(
                SimpleTernaryOpTest__AddHighNarrowingUpper_Vector128_UInt32 testClass
            )
            {
        ...
        static SimpleTernaryOpTest__AddHighNarrowingUpper_Vector128_UInt32()
        {
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector128<UInt64>, byte>(ref _clsVar3),
                ref Unsafe.As<UInt64, byte>(ref _data3[0]),
                (uint)Unsafe.SizeOf<Vector128<UInt64>>()
            );
        }
        ...
        public SimpleTernaryOpTest__AddHighNarrowingUpper_Vector128_UInt32()
        {
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector128<UInt64>, byte>(ref _fld3),
                ref Unsafe.As<UInt64, byte>(ref _data3[0]),
                (uint)Unsafe.SizeOf<Vector128<UInt64>>()
            );
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(
                    nameof(AdvSimd.AddHighNarrowingUpper),
                    new Type[]
                    {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.AddHighNarrowingUpper(_clsVar1, _clsVar2, _clsVar3);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.AddHighNarrowingUpper)}<UInt32>(Vector64<UInt32>, Vector128<UInt64>, Vector128<UInt64>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
