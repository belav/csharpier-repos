...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void MultiplyWideningUpperAndSubtract_Vector128_Byte()
        {
            var test = new SimpleTernaryOpTest__MultiplyWideningUpperAndSubtract_Vector128_Byte();
    ...
    public sealed unsafe class SimpleTernaryOpTest__MultiplyWideningUpperAndSubtract_Vector128_Byte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleTernaryOpTest__MultiplyWideningUpperAndSubtract_Vector128_Byte testClass
            )
            {
        ...
        static SimpleTernaryOpTest__MultiplyWideningUpperAndSubtract_Vector128_Byte()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetUInt16();
        ...
        public SimpleTernaryOpTest__MultiplyWideningUpperAndSubtract_Vector128_Byte()
        {
            Succeeded = true;
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.MultiplyWideningUpperAndSubtract)}<UInt16>(Vector128<UInt16>, Vector128<Byte>, Vector128<Byte>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
