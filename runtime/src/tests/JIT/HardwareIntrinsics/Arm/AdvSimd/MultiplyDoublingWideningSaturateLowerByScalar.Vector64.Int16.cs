...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void MultiplyDoublingWideningSaturateLowerByScalar_Vector64_Int16()
        {
            var test =
                new SimpleBinaryOpTest__MultiplyDoublingWideningSaturateLowerByScalar_Vector64_Int16();
    ...
    public sealed unsafe class SimpleBinaryOpTest__MultiplyDoublingWideningSaturateLowerByScalar_Vector64_Int16
    {
        ...
        static SimpleBinaryOpTest__MultiplyDoublingWideningSaturateLowerByScalar_Vector64_Int16()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetInt16();
        ...
        public SimpleBinaryOpTest__MultiplyDoublingWideningSaturateLowerByScalar_Vector64_Int16()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(
                    nameof(AdvSimd.MultiplyDoublingWideningSaturateLowerByScalar),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.MultiplyDoublingWideningSaturateLowerByScalar(_clsVar1, _clsVar2);
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.MultiplyDoublingWideningSaturateLowerByScalar(op1, op2);
        ...
        )
        {
            ...
            {
                if (Helpers.MultiplyDoublingWideningSaturate(left[i], right[0]) != result[i])
                {
                    succeeded = false;
                    break;
                }
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.MultiplyDoublingWideningSaturateLowerByScalar)}<Int32>(Vector64<Int16>, Vector64<Int16>): {method} failed:"
                    );
