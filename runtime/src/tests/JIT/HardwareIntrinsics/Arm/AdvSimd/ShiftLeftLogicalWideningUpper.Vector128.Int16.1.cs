...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ShiftLeftLogicalWideningUpper_Vector128_Int16_1()
        {
            var test = new ImmUnaryOpTest__ShiftLeftLogicalWideningUpper_Vector128_Int16_1();
    ...
    public sealed unsafe class ImmUnaryOpTest__ShiftLeftLogicalWideningUpper_Vector128_Int16_1
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                ImmUnaryOpTest__ShiftLeftLogicalWideningUpper_Vector128_Int16_1 testClass
            )
            {
        ...
        static ImmUnaryOpTest__ShiftLeftLogicalWideningUpper_Vector128_Int16_1()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data[i] = TestLibrary.Generator.GetInt16();
        ...
        public ImmUnaryOpTest__ShiftLeftLogicalWideningUpper_Vector128_Int16_1()
        {
            Succeeded = true;
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ShiftLeftLogicalWideningUpper)}<Int32>(Vector128<Int16>, 1): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
