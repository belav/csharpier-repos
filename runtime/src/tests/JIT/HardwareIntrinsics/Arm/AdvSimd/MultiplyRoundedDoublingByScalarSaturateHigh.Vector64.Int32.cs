...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void MultiplyRoundedDoublingByScalarSaturateHigh_Vector64_Int32()
        {
            var test =
                new SimpleBinaryOpTest__MultiplyRoundedDoublingByScalarSaturateHigh_Vector64_Int32();
    ...
    public sealed unsafe class SimpleBinaryOpTest__MultiplyRoundedDoublingByScalarSaturateHigh_Vector64_Int32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__MultiplyRoundedDoublingByScalarSaturateHigh_Vector64_Int32 testClass
            )
            {
                var result = AdvSimd.MultiplyRoundedDoublingByScalarSaturateHigh(_fld1, _fld2);
            ...
            )
            {
                ...
                {
                    var result = AdvSimd.MultiplyRoundedDoublingByScalarSaturateHigh(
        ...
        static SimpleBinaryOpTest__MultiplyRoundedDoublingByScalarSaturateHigh_Vector64_Int32()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetInt32();
        ...
        public SimpleBinaryOpTest__MultiplyRoundedDoublingByScalarSaturateHigh_Vector64_Int32()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(
                    nameof(AdvSimd.MultiplyRoundedDoublingByScalarSaturateHigh),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.MultiplyRoundedDoublingByScalarSaturateHigh(_clsVar1, _clsVar2);
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.MultiplyRoundedDoublingByScalarSaturateHigh(op1, op2);
        ...
        )
        {
            ...
            {
                if (Helpers.MultiplyRoundedDoublingSaturateHigh(left[i], right[0]) != result[i])
                {
                    succeeded = false;
                    break;
                }
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.MultiplyRoundedDoublingByScalarSaturateHigh)}<Int32>(Vector64<Int32>, Vector64<Int32>): {method} failed:"
                    );
