...
namespace JIT.HardwareIntrinsics.Arm
{
    public static partial class Program
    {
        ...
        {
            var test =
                new SimpleTernaryOpTest__MultiplyAddBySelectedScalar_Vector128_UInt32_Vector128_UInt32_3();
    ...
    public sealed unsafe class SimpleTernaryOpTest__MultiplyAddBySelectedScalar_Vector128_UInt32_Vector128_UInt32_3
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleTernaryOpTest__MultiplyAddBySelectedScalar_Vector128_UInt32_Vector128_UInt32_3 testClass
            )
            {
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.MultiplyAddBySelectedScalar)}<UInt32>(Vector128<UInt32>, Vector128<UInt32>, Vector128<UInt32>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
