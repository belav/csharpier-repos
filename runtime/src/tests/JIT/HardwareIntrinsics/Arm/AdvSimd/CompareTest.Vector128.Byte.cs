...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void CompareTest_Vector128_Byte()
        {
            var test = new SimpleBinaryOpTest__CompareTest_Vector128_Byte();
    ...
    public sealed unsafe class SimpleBinaryOpTest__CompareTest_Vector128_Byte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__CompareTest_Vector128_Byte testClass
            )
            {
        ...
        static SimpleBinaryOpTest__CompareTest_Vector128_Byte()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetByte();
        ...
        public SimpleBinaryOpTest__CompareTest_Vector128_Byte()
        {
            Succeeded = true;
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.CompareTest)}<Byte>(Vector128<Byte>, Vector128<Byte>): {method} failed:"
                    );
