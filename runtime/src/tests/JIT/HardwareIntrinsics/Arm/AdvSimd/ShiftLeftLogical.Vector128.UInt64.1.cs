...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ShiftLeftLogical_Vector128_UInt64_1()
        {
            var test = new ImmUnaryOpTest__ShiftLeftLogical_Vector128_UInt64_1();
    ...
    public sealed unsafe class ImmUnaryOpTest__ShiftLeftLogical_Vector128_UInt64_1
    {
        ...
        static ImmUnaryOpTest__ShiftLeftLogical_Vector128_UInt64_1()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data[i] = TestLibrary.Generator.GetUInt64();
        ...
        public ImmUnaryOpTest__ShiftLeftLogical_Vector128_UInt64_1()
        {
            Succeeded = true;
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            {
                var result = AdvSimd.ShiftLeftLogical(AdvSimd.LoadVector128((UInt64*)(pClsVar)), 1);
        ...
        public void RunClassLclFldScenario_Load()
        {
            ...
            {
                var result = AdvSimd.ShiftLeftLogical(AdvSimd.LoadVector128((UInt64*)(pFld)), 1);
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = AdvSimd.ShiftLeftLogical(AdvSimd.LoadVector128((UInt64*)(&test._fld)), 1);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ShiftLeftLogical)}<UInt64>(Vector128<UInt64>, 1): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
