    ...
    public sealed unsafe class SimpleTernaryOpTest__FusedMultiplyAddScalar_Vector64_Double
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleTernaryOpTest__FusedMultiplyAddScalar_Vector64_Double testClass
            )
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(
                    nameof(AdvSimd.FusedMultiplyAddScalar),
                    new Type[]
                    {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.FusedMultiplyAddScalar(_clsVar1, _clsVar2, _clsVar3);
        ...
        )
        {
            ...
            if (
                BitConverter.DoubleToInt64Bits(
                    Helpers.FusedMultiplyAdd(firstOp[0], secondOp[0], thirdOp[0])
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.FusedMultiplyAddScalar)}<Double>(Vector64<Double>, Vector64<Double>, Vector64<Double>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
