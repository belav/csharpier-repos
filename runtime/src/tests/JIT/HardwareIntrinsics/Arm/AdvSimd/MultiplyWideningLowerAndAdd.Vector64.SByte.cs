...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void MultiplyWideningLowerAndAdd_Vector64_SByte()
        {
            var test = new SimpleTernaryOpTest__MultiplyWideningLowerAndAdd_Vector64_SByte();
    ...
    public sealed unsafe class SimpleTernaryOpTest__MultiplyWideningLowerAndAdd_Vector64_SByte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleTernaryOpTest__MultiplyWideningLowerAndAdd_Vector64_SByte testClass
            )
            {
        ...
        static SimpleTernaryOpTest__MultiplyWideningLowerAndAdd_Vector64_SByte()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetInt16();
        ...
        public SimpleTernaryOpTest__MultiplyWideningLowerAndAdd_Vector64_SByte()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(
                    nameof(AdvSimd.MultiplyWideningLowerAndAdd),
                    new Type[]
                    {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.MultiplyWideningLowerAndAdd(_clsVar1, _clsVar2, _clsVar3);
        ...
        )
        {
            ...
            {
                if (
                    Helpers.MultiplyWideningAndAdd(firstOp[i], secondOp[i], thirdOp[i]) != result[i]
                )
                {
                    succeeded = false;
                    break;
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.MultiplyWideningLowerAndAdd)}<Int16>(Vector128<Int16>, Vector64<SByte>, Vector64<SByte>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
