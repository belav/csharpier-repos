...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ConvertToInt32RoundToPositiveInfinityScalar_Vector64_Single()
        {
            var test =
                new SimpleUnaryOpTest__ConvertToInt32RoundToPositiveInfinityScalar_Vector64_Single();
    ...
    public sealed unsafe class SimpleUnaryOpTest__ConvertToInt32RoundToPositiveInfinityScalar_Vector64_Single
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__ConvertToInt32RoundToPositiveInfinityScalar_Vector64_Single testClass
            )
            {
                var result = AdvSimd.ConvertToInt32RoundToPositiveInfinityScalar(_fld1);
            ...
            )
            {
                ...
                {
                    var result = AdvSimd.ConvertToInt32RoundToPositiveInfinityScalar(
        ...
        static SimpleUnaryOpTest__ConvertToInt32RoundToPositiveInfinityScalar_Vector64_Single()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetSingle();
        ...
        public SimpleUnaryOpTest__ConvertToInt32RoundToPositiveInfinityScalar_Vector64_Single()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(
                    nameof(AdvSimd.ConvertToInt32RoundToPositiveInfinityScalar),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.ConvertToInt32RoundToPositiveInfinityScalar(_clsVar1);
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.ConvertToInt32RoundToPositiveInfinityScalar(op1);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test =
                new SimpleUnaryOpTest__ConvertToInt32RoundToPositiveInfinityScalar_Vector64_Single();
            var result = AdvSimd.ConvertToInt32RoundToPositiveInfinityScalar(test._fld1);
        ...
        )
        {
            ...
            if (Helpers.ConvertToInt32RoundToPositiveInfinity(firstOp[0]) != result[0])
            {
                succeeded = false;
            }
            else
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ConvertToInt32RoundToPositiveInfinityScalar)}<Int32>(Vector64<Single>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
