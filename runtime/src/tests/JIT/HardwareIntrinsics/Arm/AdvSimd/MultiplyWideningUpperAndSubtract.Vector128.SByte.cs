...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void MultiplyWideningUpperAndSubtract_Vector128_SByte()
        {
    ...
    public sealed unsafe class SimpleTernaryOpTest__MultiplyWideningUpperAndSubtract_Vector128_SByte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleTernaryOpTest__MultiplyWideningUpperAndSubtract_Vector128_SByte testClass
            ) {
        ...
        static SimpleTernaryOpTest__MultiplyWideningUpperAndSubtract_Vector128_SByte()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetInt16();
        ...
        public SimpleTernaryOpTest__MultiplyWideningUpperAndSubtract_Vector128_SByte()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(
                    nameof(AdvSimd.MultiplyWideningUpperAndSubtract),
                    new Type[]
                    {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.MultiplyWideningUpperAndSubtract(_clsVar1, _clsVar2, _clsVar3);
        ...
        public void RunClassFldScenario_Load()
        {
            ...
            fixed (Vector128<Int16>* pFld1 = &_fld1)fixed (Vector128<SByte>* pFld2 = &_fld2)fixed (
        ...
        private void ValidateResult(
            ...
            {
                if (
                    Helpers.MultiplyWideningUpperAndSubtract(firstOp, secondOp, thirdOp, i)
                    != result[i]
                ) {
                    succeeded = false;
                    break;
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd)}.{nameof(AdvSimd.MultiplyWideningUpperAndSubtract)}<Int16>(Vector128<Int16>, Vector128<SByte>, Vector128<SByte>): {method} failed:"
                );
                TestLibrary.TestFramework.LogInformation(
