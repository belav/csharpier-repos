    ...
    public sealed unsafe class SimpleTernaryOpTest__BitwiseSelect_Vector64_Single
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleTernaryOpTest__BitwiseSelect_Vector64_Single testClass
            ) {
        ...
        private void ValidateResult(
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd)}.{nameof(AdvSimd.BitwiseSelect)}<Single>(Vector64<Single>, Vector64<Single>, Vector64<Single>): {method} failed:"
                );
                TestLibrary.TestFramework.LogInformation(
