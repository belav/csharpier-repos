    ...
    public sealed unsafe class ImmUnaryOpTest__ShiftLeftLogical_Vector128_SByte_1
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                ImmUnaryOpTest__ShiftLeftLogical_Vector128_SByte_1 testClass
            )
            {
            ...
            )
            {
                ...
                {
                    var result = AdvSimd.ShiftLeftLogical(AdvSimd.LoadVector128((SByte*)(pFld)), 1);
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            {
                var result = AdvSimd.ShiftLeftLogical(AdvSimd.LoadVector128((SByte*)(pClsVar)), 1);
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = AdvSimd.ShiftLeftLogical(AdvSimd.LoadVector128((SByte*)(&test._fld)), 1);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ShiftLeftLogical)}<SByte>(Vector128<SByte>, 1): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
