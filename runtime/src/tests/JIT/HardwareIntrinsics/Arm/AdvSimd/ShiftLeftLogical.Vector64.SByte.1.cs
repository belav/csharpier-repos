...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ShiftLeftLogical_Vector64_SByte_1()
        {
            var test = new ImmUnaryOpTest__ShiftLeftLogical_Vector64_SByte_1();
    ...
    public sealed unsafe class ImmUnaryOpTest__ShiftLeftLogical_Vector64_SByte_1
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                ImmUnaryOpTest__ShiftLeftLogical_Vector64_SByte_1 testClass
            )
            {
            ...
            )
            {
                ...
                {
                    var result = AdvSimd.ShiftLeftLogical(AdvSimd.LoadVector64((SByte*)(pFld)), 1);
        ...
        static ImmUnaryOpTest__ShiftLeftLogical_Vector64_SByte_1()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data[i] = TestLibrary.Generator.GetSByte();
        ...
        public ImmUnaryOpTest__ShiftLeftLogical_Vector64_SByte_1()
        {
            Succeeded = true;
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            {
                var result = AdvSimd.ShiftLeftLogical(AdvSimd.LoadVector64((SByte*)(pClsVar)), 1);
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = AdvSimd.ShiftLeftLogical(AdvSimd.LoadVector64((SByte*)(&test._fld)), 1);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ShiftLeftLogical)}<SByte>(Vector64<SByte>, 1): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
