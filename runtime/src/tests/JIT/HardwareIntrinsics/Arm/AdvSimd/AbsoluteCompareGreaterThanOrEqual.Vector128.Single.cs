...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void AbsoluteCompareGreaterThanOrEqual_Vector128_Single()
        {
            var test = new SimpleBinaryOpTest__AbsoluteCompareGreaterThanOrEqual_Vector128_Single();
    ...
    public sealed unsafe class SimpleBinaryOpTest__AbsoluteCompareGreaterThanOrEqual_Vector128_Single
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__AbsoluteCompareGreaterThanOrEqual_Vector128_Single testClass
            )
            {
        ...
        static SimpleBinaryOpTest__AbsoluteCompareGreaterThanOrEqual_Vector128_Single()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetSingle();
        ...
        public SimpleBinaryOpTest__AbsoluteCompareGreaterThanOrEqual_Vector128_Single()
        {
            Succeeded = true;
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.AbsoluteCompareGreaterThanOrEqual)}<Single>(Vector128<Single>, Vector128<Single>): {method} failed:"
                    );
