    ...
    public sealed unsafe class SimpleUnaryOpTest__ConvertToInt32RoundToEvenScalar_Vector64_Single
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__ConvertToInt32RoundToEvenScalar_Vector64_Single testClass
            )
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(
                    nameof(AdvSimd.ConvertToInt32RoundToEvenScalar),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.ConvertToInt32RoundToEvenScalar(_clsVar1);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ConvertToInt32RoundToEvenScalar)}<Int32>(Vector64<Single>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
