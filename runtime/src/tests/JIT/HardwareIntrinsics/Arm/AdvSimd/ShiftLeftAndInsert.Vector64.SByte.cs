    ...
    public sealed unsafe class ImmBinaryOpTest__ShiftLeftAndInsert_Vector64_SByte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                ImmBinaryOpTest__ShiftLeftAndInsert_Vector64_SByte testClass
            )
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(
                    nameof(AdvSimd.ShiftLeftAndInsert),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.ShiftLeftAndInsert(_clsVar1, _clsVar2, 4);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd)}.{nameof(AdvSimd.ShiftLeftAndInsert)}<SByte>(Vector64<SByte>, Vector64<SByte>, 4): {method} failed:"
                );
                TestLibrary.TestFramework.LogInformation(
