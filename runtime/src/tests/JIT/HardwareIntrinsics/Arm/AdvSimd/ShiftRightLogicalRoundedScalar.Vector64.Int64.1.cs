...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ShiftRightLogicalRoundedScalar_Vector64_Int64_1()
        {
            var test = new ImmUnaryOpTest__ShiftRightLogicalRoundedScalar_Vector64_Int64_1();
    ...
    public sealed unsafe class ImmUnaryOpTest__ShiftRightLogicalRoundedScalar_Vector64_Int64_1
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                ImmUnaryOpTest__ShiftRightLogicalRoundedScalar_Vector64_Int64_1 testClass
            )
            {
                var result = AdvSimd.ShiftRightLogicalRoundedScalar(_fld, 1);
            ...
            )
            {
                ...
                {
                    var result = AdvSimd.ShiftRightLogicalRoundedScalar(
        ...
        static ImmUnaryOpTest__ShiftRightLogicalRoundedScalar_Vector64_Int64_1()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data[i] = TestLibrary.Generator.GetInt64();
        ...
        public ImmUnaryOpTest__ShiftRightLogicalRoundedScalar_Vector64_Int64_1()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(
                    nameof(AdvSimd.ShiftRightLogicalRoundedScalar),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.ShiftRightLogicalRoundedScalar(_clsVar, 1);
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.ShiftRightLogicalRoundedScalar(firstOp, 1);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new ImmUnaryOpTest__ShiftRightLogicalRoundedScalar_Vector64_Int64_1();
            var result = AdvSimd.ShiftRightLogicalRoundedScalar(test._fld, 1);
        ...
        )
        {
            ...
            if (Helpers.ShiftRightLogicalRounded(firstOp[0], Imm) != result[0])
            {
                succeeded = false;
            }
            else
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ShiftRightLogicalRoundedScalar)}<Int64>(Vector64<Int64>, 1): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
