    ...
    public sealed unsafe class SimpleBinaryOpTest__MaxNumber_Vector128_Single
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__MaxNumber_Vector128_Single testClass
            )
            {
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.MaxNumber)}<Single>(Vector128<Single>, Vector128<Single>): {method} failed:"
                    );
