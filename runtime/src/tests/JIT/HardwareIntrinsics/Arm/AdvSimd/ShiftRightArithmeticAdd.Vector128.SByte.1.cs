...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ShiftRightArithmeticAdd_Vector128_SByte_1()
        {
    ...
    public sealed unsafe class ImmBinaryOpTest__ShiftRightArithmeticAdd_Vector128_SByte_1
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                ImmBinaryOpTest__ShiftRightArithmeticAdd_Vector128_SByte_1 testClass
            )
            {
        ...
        static ImmBinaryOpTest__ShiftRightArithmeticAdd_Vector128_SByte_1()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetSByte();
        ...
        public ImmBinaryOpTest__ShiftRightArithmeticAdd_Vector128_SByte_1()
        {
            Succeeded = true;
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ShiftRightArithmeticAdd)}<SByte>(Vector128<SByte>, Vector128<SByte>, 1): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
