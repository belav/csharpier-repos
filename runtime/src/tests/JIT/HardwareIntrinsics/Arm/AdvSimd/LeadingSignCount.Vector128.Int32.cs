    ...
    public sealed unsafe class SimpleUnaryOpTest__LeadingSignCount_Vector128_Int32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__LeadingSignCount_Vector128_Int32 testClass
            )
            {
            ...
            )
            {
                ...
                {
                    var result = AdvSimd.LeadingSignCount(AdvSimd.LoadVector128((Int32*)(pFld1)));
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            {
                var result = AdvSimd.LeadingSignCount(AdvSimd.LoadVector128((Int32*)(pClsVar1)));
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = AdvSimd.LeadingSignCount(AdvSimd.LoadVector128((Int32*)(&test._fld1)));
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.LeadingSignCount)}<Int32>(Vector128<Int32>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
