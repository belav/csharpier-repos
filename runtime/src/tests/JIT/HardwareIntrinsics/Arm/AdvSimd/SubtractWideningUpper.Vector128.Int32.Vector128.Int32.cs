...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void SubtractWideningUpper_Vector128_Int32_Vector128_Int32()
        {
            var test =
                new SimpleBinaryOpTest__SubtractWideningUpper_Vector128_Int32_Vector128_Int32();
    ...
    public sealed unsafe class SimpleBinaryOpTest__SubtractWideningUpper_Vector128_Int32_Vector128_Int32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__SubtractWideningUpper_Vector128_Int32_Vector128_Int32 testClass
            )
            {
        ...
        static SimpleBinaryOpTest__SubtractWideningUpper_Vector128_Int32_Vector128_Int32()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetInt32();
        ...
        public SimpleBinaryOpTest__SubtractWideningUpper_Vector128_Int32_Vector128_Int32()
        {
            Succeeded = true;
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.SubtractWideningUpper)}<Int64>(Vector128<Int32>, Vector128<Int32>): {method} failed:"
                    );
