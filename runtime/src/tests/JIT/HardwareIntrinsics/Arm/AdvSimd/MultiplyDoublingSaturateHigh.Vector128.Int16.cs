...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void MultiplyDoublingSaturateHigh_Vector128_Int16()
        {
            var test = new SimpleBinaryOpTest__MultiplyDoublingSaturateHigh_Vector128_Int16();
    ...
    public sealed unsafe class SimpleBinaryOpTest__MultiplyDoublingSaturateHigh_Vector128_Int16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__MultiplyDoublingSaturateHigh_Vector128_Int16 testClass
            )
            {
                var result = AdvSimd.MultiplyDoublingSaturateHigh(_fld1, _fld2);
            ...
            )
            {
                ...
                {
                    var result = AdvSimd.MultiplyDoublingSaturateHigh(
        ...
        static SimpleBinaryOpTest__MultiplyDoublingSaturateHigh_Vector128_Int16()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetInt16();
        ...
        public SimpleBinaryOpTest__MultiplyDoublingSaturateHigh_Vector128_Int16()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(
                    nameof(AdvSimd.MultiplyDoublingSaturateHigh),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.MultiplyDoublingSaturateHigh(_clsVar1, _clsVar2);
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.MultiplyDoublingSaturateHigh(op1, op2);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimpleBinaryOpTest__MultiplyDoublingSaturateHigh_Vector128_Int16();
            var result = AdvSimd.MultiplyDoublingSaturateHigh(test._fld1, test._fld2);
        ...
        )
        {
            ...
            {
                if (Helpers.MultiplyDoublingSaturateHigh(left[i], right[i]) != result[i])
                {
                    succeeded = false;
                    break;
                }
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.MultiplyDoublingSaturateHigh)}<Int16>(Vector128<Int16>, Vector128<Int16>): {method} failed:"
                    );
