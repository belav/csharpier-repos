    ...
    public sealed unsafe class ImmUnaryOpTest__DuplicateSelectedScalarToVector64_Vector128_Int32_2
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                ImmUnaryOpTest__DuplicateSelectedScalarToVector64_Vector128_Int32_2 testClass
            )
            {
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.DuplicateSelectedScalarToVector64)}<Int32>(Vector128<Int32>, 2): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
