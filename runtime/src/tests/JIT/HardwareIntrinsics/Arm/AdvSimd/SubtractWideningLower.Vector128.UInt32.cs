    ...
    public sealed unsafe class SimpleBinaryOpTest__SubtractWideningLower_Vector128_UInt32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__SubtractWideningLower_Vector128_UInt32 testClass
            )
            {
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.SubtractWideningLower)}<UInt32>(Vector128<UInt32>, Vector64<UInt16>): {method} failed:"
                    );
