...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void CompareEqual_Vector128_Single()
        {
    ...
    public sealed unsafe class SimpleBinaryOpTest__CompareEqual_Vector128_Single
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__CompareEqual_Vector128_Single testClass
            )
            {
        ...
        static SimpleBinaryOpTest__CompareEqual_Vector128_Single()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetSingle();
        ...
        public SimpleBinaryOpTest__CompareEqual_Vector128_Single()
        {
            Succeeded = true;
        ...
        )
        {
            ...
            {
                if (
                    BitConverter.SingleToInt32Bits(Helpers.CompareEqual(left[i], right[i]))
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.CompareEqual)}<Single>(Vector128<Single>, Vector128<Single>): {method} failed:"
                    );
