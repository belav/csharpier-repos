    ...
    public sealed unsafe class SimpleBinaryOpTest__ShiftArithmeticRoundedSaturate_Vector64_SByte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__ShiftArithmeticRoundedSaturate_Vector64_SByte testClass
            )
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(
                    nameof(AdvSimd.ShiftArithmeticRoundedSaturate),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.ShiftArithmeticRoundedSaturate(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ShiftArithmeticRoundedSaturate)}<SByte>(Vector64<SByte>, Vector64<SByte>): {method} failed:"
                    );
