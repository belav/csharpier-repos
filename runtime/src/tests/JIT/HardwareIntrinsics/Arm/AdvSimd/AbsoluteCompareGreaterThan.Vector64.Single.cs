...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void AbsoluteCompareGreaterThan_Vector64_Single()
        {
            var test = new SimpleBinaryOpTest__AbsoluteCompareGreaterThan_Vector64_Single();
    ...
    public sealed unsafe class SimpleBinaryOpTest__AbsoluteCompareGreaterThan_Vector64_Single
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__AbsoluteCompareGreaterThan_Vector64_Single testClass
            )
            {
        ...
        static SimpleBinaryOpTest__AbsoluteCompareGreaterThan_Vector64_Single()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetSingle();
        ...
        public SimpleBinaryOpTest__AbsoluteCompareGreaterThan_Vector64_Single()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(
                    nameof(AdvSimd.AbsoluteCompareGreaterThan),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.AbsoluteCompareGreaterThan(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            for (var i = 0; i < RetElementCount; i++)
            {
                if (
                    BitConverter.SingleToInt32Bits(
                        Helpers.AbsoluteCompareGreaterThan(left[i], right[i])
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.AbsoluteCompareGreaterThan)}<Single>(Vector64<Single>, Vector64<Single>): {method} failed:"
                    );
