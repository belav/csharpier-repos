...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void AddRoundedHighNarrowingUpper_Vector128_SByte()
        {
            var test = new SimpleTernaryOpTest__AddRoundedHighNarrowingUpper_Vector128_SByte();
    ...
    public sealed unsafe class SimpleTernaryOpTest__AddRoundedHighNarrowingUpper_Vector128_SByte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleTernaryOpTest__AddRoundedHighNarrowingUpper_Vector128_SByte testClass
            )
            {
        ...
        public SimpleTernaryOpTest__AddRoundedHighNarrowingUpper_Vector128_SByte()
        {
            Succeeded = true;
        ...
        public void RunClassFldScenario_Load()
        {
            ...
            fixed (Vector64<SByte>* pFld1 = &_fld1)fixed (Vector128<Int16>* pFld2 = &_fld2)fixed (
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd)}.{nameof(AdvSimd.AddRoundedHighNarrowingUpper)}<SByte>(Vector64<SByte>, Vector128<Int16>, Vector128<Int16>): {method} failed:"
                );
                TestLibrary.TestFramework.LogInformation(
