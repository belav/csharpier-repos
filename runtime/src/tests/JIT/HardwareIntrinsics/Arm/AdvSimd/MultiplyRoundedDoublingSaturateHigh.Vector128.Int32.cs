...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void MultiplyRoundedDoublingSaturateHigh_Vector128_Int32()
        {
            var test =
                new SimpleBinaryOpTest__MultiplyRoundedDoublingSaturateHigh_Vector128_Int32();
    ...
    public sealed unsafe class SimpleBinaryOpTest__MultiplyRoundedDoublingSaturateHigh_Vector128_Int32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__MultiplyRoundedDoublingSaturateHigh_Vector128_Int32 testClass
            )
            {
        ...
        static SimpleBinaryOpTest__MultiplyRoundedDoublingSaturateHigh_Vector128_Int32()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetInt32();
        ...
        public SimpleBinaryOpTest__MultiplyRoundedDoublingSaturateHigh_Vector128_Int32()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(
                    nameof(AdvSimd.MultiplyRoundedDoublingSaturateHigh),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.MultiplyRoundedDoublingSaturateHigh(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.MultiplyRoundedDoublingSaturateHigh)}<Int32>(Vector128<Int32>, Vector128<Int32>): {method} failed:"
                    );
