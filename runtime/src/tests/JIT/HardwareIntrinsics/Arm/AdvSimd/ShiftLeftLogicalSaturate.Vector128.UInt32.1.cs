...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ShiftLeftLogicalSaturate_Vector128_UInt32_1()
        {
            var test = new ImmUnaryOpTest__ShiftLeftLogicalSaturate_Vector128_UInt32_1();
    ...
    public sealed unsafe class ImmUnaryOpTest__ShiftLeftLogicalSaturate_Vector128_UInt32_1
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                ImmUnaryOpTest__ShiftLeftLogicalSaturate_Vector128_UInt32_1 testClass
            )
            {
        ...
        static ImmUnaryOpTest__ShiftLeftLogicalSaturate_Vector128_UInt32_1()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data[i] = TestLibrary.Generator.GetUInt32();
        ...
        public ImmUnaryOpTest__ShiftLeftLogicalSaturate_Vector128_UInt32_1()
        {
            Succeeded = true;
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ShiftLeftLogicalSaturate)}<UInt32>(Vector128<UInt32>, 1): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
