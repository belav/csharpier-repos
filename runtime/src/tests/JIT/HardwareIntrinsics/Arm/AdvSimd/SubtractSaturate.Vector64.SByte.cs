...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void SubtractSaturate_Vector64_SByte()
        {
            var test = new SimpleBinaryOpTest__SubtractSaturate_Vector64_SByte();
    ...
    public sealed unsafe class SimpleBinaryOpTest__SubtractSaturate_Vector64_SByte
    {
        ...
        static SimpleBinaryOpTest__SubtractSaturate_Vector64_SByte()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetSByte();
        ...
        public SimpleBinaryOpTest__SubtractSaturate_Vector64_SByte()
        {
            Succeeded = true;
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.SubtractSaturate)}<SByte>(Vector64<SByte>, Vector64<SByte>): {method} failed:"
                    );
