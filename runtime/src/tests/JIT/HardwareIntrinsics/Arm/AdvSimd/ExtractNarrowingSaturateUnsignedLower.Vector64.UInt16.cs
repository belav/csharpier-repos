...
namespace JIT.HardwareIntrinsics.Arm
{
    public static partial class Program
    {
        ...
        {
            var test =
                new SimpleUnaryOpTest__ExtractNarrowingSaturateUnsignedLower_Vector64_UInt16();
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ExtractNarrowingSaturateUnsignedLower)}<UInt16>(Vector128<Int32>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
