...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ShiftLogicalRounded_Vector64_Byte()
        {
    ...
    public sealed unsafe class SimpleBinaryOpTest__ShiftLogicalRounded_Vector64_Byte
    {
        ...
        static SimpleBinaryOpTest__ShiftLogicalRounded_Vector64_Byte()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetByte();
        ...
        public SimpleBinaryOpTest__ShiftLogicalRounded_Vector64_Byte()
        {
            Succeeded = true;
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ShiftLogicalRounded)}<Byte>(Vector64<Byte>, Vector64<SByte>): {method} failed:"
                    );
