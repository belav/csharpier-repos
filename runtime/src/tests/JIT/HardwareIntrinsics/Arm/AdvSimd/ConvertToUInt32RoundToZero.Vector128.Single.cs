...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ConvertToUInt32RoundToZero_Vector128_Single()
        {
            var test = new SimpleUnaryOpTest__ConvertToUInt32RoundToZero_Vector128_Single();
    ...
    public sealed unsafe class SimpleUnaryOpTest__ConvertToUInt32RoundToZero_Vector128_Single
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__ConvertToUInt32RoundToZero_Vector128_Single testClass
            )
            {
                var result = AdvSimd.ConvertToUInt32RoundToZero(_fld1);
            ...
            )
            {
                ...
                {
                    var result = AdvSimd.ConvertToUInt32RoundToZero(
        ...
        static SimpleUnaryOpTest__ConvertToUInt32RoundToZero_Vector128_Single()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetSingle();
        ...
        public SimpleUnaryOpTest__ConvertToUInt32RoundToZero_Vector128_Single()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(
                    nameof(AdvSimd.ConvertToUInt32RoundToZero),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.ConvertToUInt32RoundToZero(_clsVar1);
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.ConvertToUInt32RoundToZero(op1);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimpleUnaryOpTest__ConvertToUInt32RoundToZero_Vector128_Single();
            var result = AdvSimd.ConvertToUInt32RoundToZero(test._fld1);
        ...
        )
        {
            ...
            {
                if (Helpers.ConvertToUInt32RoundToZero(firstOp[i]) != result[i])
                {
                    succeeded = false;
                    break;
                }
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ConvertToUInt32RoundToZero)}<UInt32>(Vector128<Single>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
