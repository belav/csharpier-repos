...
namespace JIT.HardwareIntrinsics.Arm
{
    public static partial class Program
    {
        ...
        {
            var test =
                new SimpleBinaryOpTest__SubtractWideningUpper_Vector128_UInt32_Vector128_UInt16();
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.SubtractWideningUpper)}<UInt32>(Vector128<UInt32>, Vector128<UInt16>): {method} failed:"
                    );
