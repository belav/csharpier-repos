...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ShiftRightLogical_Vector128_UInt32_1()
        {
            var test = new ImmUnaryOpTest__ShiftRightLogical_Vector128_UInt32_1();
    ...
    public sealed unsafe class ImmUnaryOpTest__ShiftRightLogical_Vector128_UInt32_1
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                ImmUnaryOpTest__ShiftRightLogical_Vector128_UInt32_1 testClass
            )
            {
        ...
        static ImmUnaryOpTest__ShiftRightLogical_Vector128_UInt32_1()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data[i] = TestLibrary.Generator.GetUInt32();
        ...
        public ImmUnaryOpTest__ShiftRightLogical_Vector128_UInt32_1()
        {
            Succeeded = true;
        ...
        public void RunClassLclFldScenario_Load()
        {
            ...
            {
                var result = AdvSimd.ShiftRightLogical(AdvSimd.LoadVector128((UInt32*)(pFld)), 1);
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = AdvSimd.ShiftRightLogical(AdvSimd.LoadVector128((UInt32*)(&test._fld)), 1);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ShiftRightLogical)}<UInt32>(Vector128<UInt32>, 1): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
