...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ShiftRightLogicalRounded_Vector128_Int64_1()
        {
            var test = new ImmUnaryOpTest__ShiftRightLogicalRounded_Vector128_Int64_1();
    ...
    public sealed unsafe class ImmUnaryOpTest__ShiftRightLogicalRounded_Vector128_Int64_1
    {
        ...
        static ImmUnaryOpTest__ShiftRightLogicalRounded_Vector128_Int64_1()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data[i] = TestLibrary.Generator.GetInt64();
        ...
        public ImmUnaryOpTest__ShiftRightLogicalRounded_Vector128_Int64_1()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(
                    nameof(AdvSimd.ShiftRightLogicalRounded),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.ShiftRightLogicalRounded(_clsVar, 1);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ShiftRightLogicalRounded)}<Int64>(Vector128<Int64>, 1): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
