...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void Insert_Vector64_Int16_1()
        {
            var test = new InsertTest__Insert_Vector64_Int16_1();
    ...
    public sealed unsafe class InsertTest__Insert_Vector64_Int16_1
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(InsertTest__Insert_Vector64_Int16_1 testClass)
            {
            ...
            public void RunStructFldScenario_Load(InsertTest__Insert_Vector64_Int16_1 testClass)
            {
                fixed (Vector64<Int16>* pFld1 = &_fld1)fixed (Int16* pFld3 = &_fld3)
                {
        ...
        static InsertTest__Insert_Vector64_Int16_1()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetInt16();
        ...
        public InsertTest__Insert_Vector64_Int16_1()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(
                    ...
                    new Type[] { typeof(Vector64<Int16>), typeof(byte), typeof(Int16) }
                )
                .Invoke(
                    null,
                    new object[]
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.Insert(_clsVar1, ElementIndex, _clsVar3);
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            fixed (Vector64<Int16>* pClsVar1 = &_clsVar1)fixed (Int16* pClsVar3 = &_clsVar3)
            {
                var result = AdvSimd.Insert(
        ...
        public void RunClassLclFldScenario_Load()
        {
            ...
            fixed (Vector64<Int16>* pFld1 = &test._fld1)fixed (Int16* pFld3 = &test._fld3)
            {
                var result = AdvSimd.Insert(
                    AdvSimd.LoadVector64((Int16*)pFld1),
                    ElementIndex,
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd)}.{nameof(AdvSimd.Insert)}<Int16>(Vector64<Int16>, 1, Int16): {method} failed:"
                );
                TestLibrary.TestFramework.LogInformation(
