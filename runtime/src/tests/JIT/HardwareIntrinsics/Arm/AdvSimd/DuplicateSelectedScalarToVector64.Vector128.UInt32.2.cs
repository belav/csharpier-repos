    ...
    public sealed unsafe class ImmUnaryOpTest__DuplicateSelectedScalarToVector64_Vector128_UInt32_2
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                ImmUnaryOpTest__DuplicateSelectedScalarToVector64_Vector128_UInt32_2 testClass
            )
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                ...
                .Invoke(
                    null,
                    new object[] { Unsafe.Read<Vector128<UInt32>>(_dataTable.inArrayPtr), (byte)2 }
                );
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.DuplicateSelectedScalarToVector64(_clsVar, 2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.DuplicateSelectedScalarToVector64)}<UInt32>(Vector128<UInt32>, 2): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
