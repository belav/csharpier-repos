...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    public sealed unsafe class ImmOpTest__DuplicateToVector64_SByte_31
    {
        ...
        public void RunBasicScenario()
        {
            ...
            var result = AdvSimd.DuplicateToVector64((SByte)31);
        ...
        public void RunReflectionScenario()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(nameof(AdvSimd.DuplicateToVector64), new Type[] { typeof(SByte) })
                .Invoke(null, new object[] { (SByte)31 });
        ...
        private void ValidateResult(SByte[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.DuplicateToVector64)}<SByte>(31): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
