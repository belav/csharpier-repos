    ...
    public sealed unsafe class SimpleTernaryOpTest__VectorTableLookupExtension_Vector64_SByte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleTernaryOpTest__VectorTableLookupExtension_Vector64_SByte testClass
            )
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(
                    nameof(AdvSimd.VectorTableLookupExtension),
                    new Type[]
                    {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.VectorTableLookupExtension(_clsVar1, _clsVar2, _clsVar3);
        ...
        public void RunClassFldScenario_Load()
        {
            ...
            fixed (Vector64<SByte>* pFld1 = &_fld1)fixed (Vector128<SByte>* pFld2 = &_fld2)fixed (
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd)}.{nameof(AdvSimd.VectorTableLookupExtension)}<SByte>(Vector64<SByte>, Vector128<SByte>, Vector64<SByte>): {method} failed:"
                );
                TestLibrary.TestFramework.LogInformation(
