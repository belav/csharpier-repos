...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    public sealed unsafe class LoadUnaryOpTest__LoadAndReplicateToVector64_UInt16
    {
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var result = AdvSimd.LoadAndReplicateToVector64((UInt16*)(_dataTable.inArray1Ptr));
        ...
        public void RunReflectionScenario_Load()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(
                    nameof(AdvSimd.LoadAndReplicateToVector64),
                    new Type[] { typeof(UInt16*) }
                )
                .Invoke(
                    null,
                    new object[] { Pointer.Box(_dataTable.inArray1Ptr, typeof(UInt16*)) }
                );
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.LoadAndReplicateToVector64)}<UInt16>(Vector64<UInt16>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
