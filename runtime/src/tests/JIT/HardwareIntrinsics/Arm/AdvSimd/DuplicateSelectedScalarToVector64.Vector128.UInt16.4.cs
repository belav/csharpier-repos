    ...
    public sealed unsafe class ImmUnaryOpTest__DuplicateSelectedScalarToVector64_Vector128_UInt16_4
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                ImmUnaryOpTest__DuplicateSelectedScalarToVector64_Vector128_UInt16_4 testClass
            )
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                ...
                .Invoke(
                    null,
                    new object[] { Unsafe.Read<Vector128<UInt16>>(_dataTable.inArrayPtr), (byte)4 }
                );
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.DuplicateSelectedScalarToVector64(_clsVar, 4);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.DuplicateSelectedScalarToVector64)}<UInt16>(Vector128<UInt16>, 4): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
