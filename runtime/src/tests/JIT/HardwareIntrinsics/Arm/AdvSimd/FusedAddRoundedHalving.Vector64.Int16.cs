    ...
    public sealed unsafe class SimpleBinaryOpTest__FusedAddRoundedHalving_Vector64_Int16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__FusedAddRoundedHalving_Vector64_Int16 testClass
            ) {
        ...
        private void ValidateResult(
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd)}.{nameof(AdvSimd.FusedAddRoundedHalving)}<Int16>(Vector64<Int16>, Vector64<Int16>): {method} failed:"
                );
