...
namespace JIT.HardwareIntrinsics.Arm
{
    public static partial class Program
    {
        ...
        {
            var test =
                new SimpleBinaryOpTest__SubtractWideningUpper_Vector128_UInt64_Vector128_UInt32();
    ...
    public sealed unsafe class SimpleBinaryOpTest__SubtractWideningUpper_Vector128_UInt64_Vector128_UInt32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__SubtractWideningUpper_Vector128_UInt64_Vector128_UInt32 testClass
            )
            {
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.SubtractWideningUpper)}<UInt64>(Vector128<UInt64>, Vector128<UInt32>): {method} failed:"
                    );
