    ...
    public sealed unsafe class ImmBinaryOpTest__ShiftRightAndInsert_Vector128_Int64
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                ImmBinaryOpTest__ShiftRightAndInsert_Vector128_Int64 testClass
            )
            {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.ShiftRightAndInsert(_clsVar1, _clsVar2, 32);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ShiftRightAndInsert)}<Int64>(Vector128<Int64>, Vector128<Int64>, 32): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
