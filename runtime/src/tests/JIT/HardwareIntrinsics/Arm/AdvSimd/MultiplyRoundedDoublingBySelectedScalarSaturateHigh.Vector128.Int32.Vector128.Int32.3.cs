...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void MultiplyRoundedDoublingBySelectedScalarSaturateHigh_Vector128_Int32_Vector128_Int32_3()
        {
            var test =
                new ImmBinaryOpTest__MultiplyRoundedDoublingBySelectedScalarSaturateHigh_Vector128_Int32_Vector128_Int32_3();
    ...
    public sealed unsafe class ImmBinaryOpTest__MultiplyRoundedDoublingBySelectedScalarSaturateHigh_Vector128_Int32_Vector128_Int32_3
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                ImmBinaryOpTest__MultiplyRoundedDoublingBySelectedScalarSaturateHigh_Vector128_Int32_Vector128_Int32_3 testClass
            )
            {
        ...
        static ImmBinaryOpTest__MultiplyRoundedDoublingBySelectedScalarSaturateHigh_Vector128_Int32_Vector128_Int32_3()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetInt32();
        ...
        public ImmBinaryOpTest__MultiplyRoundedDoublingBySelectedScalarSaturateHigh_Vector128_Int32_Vector128_Int32_3()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(
                    nameof(AdvSimd.MultiplyRoundedDoublingBySelectedScalarSaturateHigh),
                    new Type[] { typeof(Vector128<Int32>), typeof(Vector128<Int32>), typeof(byte) }
                )
                .Invoke(
                    null,
                    new object[]
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.MultiplyRoundedDoublingBySelectedScalarSaturateHigh(op1, op2, 3);
        ...
        )
        {
            ...
            {
                if (
                    Helpers.MultiplyRoundedDoublingSaturateHigh(firstOp[i], secondOp[Imm])
                    != result[i]
                )
                {
                    succeeded = false;
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.MultiplyRoundedDoublingBySelectedScalarSaturateHigh)}<Int32>(Vector128<Int32>, Vector128<Int32>, 3): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
