...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void MultiplyAdd_Vector128_Byte()
        {
            var test = new SimpleTernaryOpTest__MultiplyAdd_Vector128_Byte();
    ...
    public sealed unsafe class SimpleTernaryOpTest__MultiplyAdd_Vector128_Byte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleTernaryOpTest__MultiplyAdd_Vector128_Byte testClass
            )
            {
        ...
        static SimpleTernaryOpTest__MultiplyAdd_Vector128_Byte()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetByte();
        ...
        public SimpleTernaryOpTest__MultiplyAdd_Vector128_Byte()
        {
            Succeeded = true;
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.MultiplyAdd)}<Byte>(Vector128<Byte>, Vector128<Byte>, Vector128<Byte>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
