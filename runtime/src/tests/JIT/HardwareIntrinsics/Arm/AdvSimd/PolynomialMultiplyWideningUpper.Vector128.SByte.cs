    ...
    public sealed unsafe class SimpleBinaryOpTest__PolynomialMultiplyWideningUpper_Vector128_SByte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__PolynomialMultiplyWideningUpper_Vector128_SByte testClass
            )
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(
                    nameof(AdvSimd.PolynomialMultiplyWideningUpper),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.PolynomialMultiplyWideningUpper(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.PolynomialMultiplyWideningUpper)}<Int16>(Vector128<SByte>, Vector128<SByte>): {method} failed:"
                    );
