    ...
    public sealed unsafe class SimpleTernaryOpTest__MultiplyWideningUpperAndAdd_Vector128_Byte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleTernaryOpTest__MultiplyWideningUpperAndAdd_Vector128_Byte testClass
            )
            {
        ...
        public void RunClassFldScenario_Load()
        {
            ...
            fixed (Vector128<UInt16>* pFld1 = &_fld1)fixed (Vector128<Byte>* pFld2 = &_fld2)fixed (
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd)}.{nameof(AdvSimd.MultiplyWideningUpperAndAdd)}<UInt16>(Vector128<UInt16>, Vector128<Byte>, Vector128<Byte>): {method} failed:"
                );
                TestLibrary.TestFramework.LogInformation(
