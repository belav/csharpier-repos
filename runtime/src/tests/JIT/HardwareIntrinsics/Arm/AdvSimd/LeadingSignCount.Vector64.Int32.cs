...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void LeadingSignCount_Vector64_Int32()
        {
    ...
    public sealed unsafe class SimpleUnaryOpTest__LeadingSignCount_Vector64_Int32
    {
        ...
        private struct TestStruct
        {
            ...
            )
            {
                ...
                {
                    var result = AdvSimd.LeadingSignCount(AdvSimd.LoadVector64((Int32*)(pFld1)));
        ...
        static SimpleUnaryOpTest__LeadingSignCount_Vector64_Int32()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetInt32();
        ...
        public SimpleUnaryOpTest__LeadingSignCount_Vector64_Int32()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(nameof(AdvSimd.LeadingSignCount), new Type[] { typeof(Vector64<Int32>) })
                .Invoke(
                    null,
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.LeadingSignCount(_clsVar1);
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            {
                var result = AdvSimd.LeadingSignCount(AdvSimd.LoadVector64((Int32*)(pClsVar1)));
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = AdvSimd.LeadingSignCount(AdvSimd.LoadVector64((Int32*)(&test._fld1)));
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.LeadingSignCount)}<Int32>(Vector64<Int32>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
