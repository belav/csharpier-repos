...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void SignExtendWideningLower_Vector64_SByte()
        {
            var test = new SimpleUnaryOpTest__SignExtendWideningLower_Vector64_SByte();
    ...
    public sealed unsafe class SimpleUnaryOpTest__SignExtendWideningLower_Vector64_SByte
    {
        private struct DataTable
        {
            ...
            public DataTable(SByte[] inArray1, Int16[] outArray, int alignment)
            {
        ...
        static SimpleUnaryOpTest__SignExtendWideningLower_Vector64_SByte()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetSByte();
        ...
        public SimpleUnaryOpTest__SignExtendWideningLower_Vector64_SByte()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(
                    nameof(AdvSimd.SignExtendWideningLower),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.SignExtendWideningLower(_clsVar1);
        ...
        public void RunClassLclFldScenario_Load()
        {
            ...
            {
                var result = AdvSimd.SignExtendWideningLower(AdvSimd.LoadVector64((SByte*)(pFld1)));
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.SignExtendWideningLower)}<Int16>(Vector64<SByte>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
