...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void RoundToPositiveInfinity_Vector64_Single()
        {
    ...
    public sealed unsafe class SimpleUnaryOpTest__RoundToPositiveInfinity_Vector64_Single
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__RoundToPositiveInfinity_Vector64_Single testClass
            )
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(
                    nameof(AdvSimd.RoundToPositiveInfinity),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.RoundToPositiveInfinity(_clsVar1);
        ...
        )
        {
            ...
            {
                if (
                    BitConverter.SingleToInt32Bits(Helpers.RoundToPositiveInfinity(firstOp[i]))
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.RoundToPositiveInfinity)}<Single>(Vector64<Single>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
