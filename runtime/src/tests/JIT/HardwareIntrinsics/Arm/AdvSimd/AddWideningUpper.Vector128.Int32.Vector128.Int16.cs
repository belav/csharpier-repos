...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void AddWideningUpper_Vector128_Int32_Vector128_Int16()
        {
    ...
    public sealed unsafe class SimpleBinaryOpTest__AddWideningUpper_Vector128_Int32_Vector128_Int16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__AddWideningUpper_Vector128_Int32_Vector128_Int16 testClass
            ) {
            ...
            public void RunStructFldScenario_Load(
                ...
                fixed (Vector128<Int32>* pFld1 = &_fld1)fixed (Vector128<Int16>* pFld2 = &_fld2)
                {
        ...
        static SimpleBinaryOpTest__AddWideningUpper_Vector128_Int32_Vector128_Int16()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetInt32();
        ...
        public SimpleBinaryOpTest__AddWideningUpper_Vector128_Int32_Vector128_Int16()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(
                    ...
                    new Type[] { typeof(Vector128<Int32>), typeof(Vector128<Int16>) }
                )
                .Invoke(
                    null,
                    new object[]
        ...
        private void ValidateResult(
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd)}.{nameof(AdvSimd.AddWideningUpper)}<Int32>(Vector128<Int32>, Vector128<Int16>): {method} failed:"
                );
