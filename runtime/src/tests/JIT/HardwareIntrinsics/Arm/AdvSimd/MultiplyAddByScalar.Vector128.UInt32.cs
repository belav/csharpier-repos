    ...
    public sealed unsafe class SimpleTernaryOpTest__MultiplyAddByScalar_Vector128_UInt32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleTernaryOpTest__MultiplyAddByScalar_Vector128_UInt32 testClass
            )
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(
                    nameof(AdvSimd.MultiplyAddByScalar),
                    new Type[]
                    {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.MultiplyAddByScalar(_clsVar1, _clsVar2, _clsVar3);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.MultiplyAddByScalar)}<UInt32>(Vector128<UInt32>, Vector128<UInt32>, Vector64<UInt32>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
