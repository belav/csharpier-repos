    ...
    public sealed unsafe class SimpleUnaryOpTest__LeadingZeroCount_Vector128_Byte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__LeadingZeroCount_Vector128_Byte testClass
            )
            {
            ...
            )
            {
                ...
                {
                    var result = AdvSimd.LeadingZeroCount(AdvSimd.LoadVector128((Byte*)(pFld1)));
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(nameof(AdvSimd.LeadingZeroCount), new Type[] { typeof(Vector128<Byte>) })
                .Invoke(
                    null,
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            {
                var result = AdvSimd.LeadingZeroCount(AdvSimd.LoadVector128((Byte*)(pClsVar1)));
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = AdvSimd.LeadingZeroCount(AdvSimd.LoadVector128((Byte*)(&test._fld1)));
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.LeadingZeroCount)}<Byte>(Vector128<Byte>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
