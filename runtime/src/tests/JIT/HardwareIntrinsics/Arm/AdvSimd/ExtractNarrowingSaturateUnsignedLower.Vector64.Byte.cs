...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ExtractNarrowingSaturateUnsignedLower_Vector64_Byte()
        {
            var test = new SimpleUnaryOpTest__ExtractNarrowingSaturateUnsignedLower_Vector64_Byte();
    ...
    public sealed unsafe class SimpleUnaryOpTest__ExtractNarrowingSaturateUnsignedLower_Vector64_Byte
    {
        private struct DataTable
        {
            ...
            public DataTable(Int16[] inArray1, Byte[] outArray, int alignment)
            {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__ExtractNarrowingSaturateUnsignedLower_Vector64_Byte testClass
            )
            {
        ...
        static SimpleUnaryOpTest__ExtractNarrowingSaturateUnsignedLower_Vector64_Byte()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetInt16();
        ...
        public SimpleUnaryOpTest__ExtractNarrowingSaturateUnsignedLower_Vector64_Byte()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_Load()
        {
            ...
            var result = typeof(AdvSimd)
                ...
                .Invoke(
                    null,
                    new object[] { AdvSimd.LoadVector128((Int16*)(_dataTable.inArray1Ptr)) }
                );
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ExtractNarrowingSaturateUnsignedLower)}<Byte>(Vector128<Int16>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
