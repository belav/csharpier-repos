...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ShiftRightLogicalRoundedNarrowingUpper_Vector128_UInt32_1()
        {
            var test =
                new ImmBinaryOpTest__ShiftRightLogicalRoundedNarrowingUpper_Vector128_UInt32_1();
    ...
    public sealed unsafe class ImmBinaryOpTest__ShiftRightLogicalRoundedNarrowingUpper_Vector128_UInt32_1
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                ImmBinaryOpTest__ShiftRightLogicalRoundedNarrowingUpper_Vector128_UInt32_1 testClass
            ) {
            ...
            public void RunStructFldScenario_Load(
                ...
                fixed (Vector64<UInt32>* pFld1 = &_fld1)fixed (Vector128<UInt64>* pFld2 = &_fld2)
                {
        ...
        static ImmBinaryOpTest__ShiftRightLogicalRoundedNarrowingUpper_Vector128_UInt32_1()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetUInt32();
        ...
        public ImmBinaryOpTest__ShiftRightLogicalRoundedNarrowingUpper_Vector128_UInt32_1()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(
                    nameof(AdvSimd.ShiftRightLogicalRoundedNarrowingUpper),
                    new Type[] { typeof(Vector64<UInt32>), typeof(Vector128<UInt64>), typeof(byte) }
                )
                .Invoke(
                    null,
                    new object[]
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.ShiftRightLogicalRoundedNarrowingUpper(_clsVar1, _clsVar2, 1);
        ...
        private void ValidateResult(
            Vector64<UInt32> firstOp,
            Vector128<UInt64> secondOp,
            void* result,
        ...
        private void ValidateResult(
            ...
            {
                if (
                    Helpers.ShiftRightLogicalRoundedNarrowingUpper(firstOp, secondOp, Imm, i)
                    != result[i]
                ) {
                    succeeded = false;
                    break;
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd)}.{nameof(AdvSimd.ShiftRightLogicalRoundedNarrowingUpper)}<UInt32>(Vector64<UInt32>, Vector128<UInt64>, 1): {method} failed:"
                );
                TestLibrary.TestFramework.LogInformation(
