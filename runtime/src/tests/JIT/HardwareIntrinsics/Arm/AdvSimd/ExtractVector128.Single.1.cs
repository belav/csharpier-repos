...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ExtractVector128_Single_1()
        {
            var test = new ExtractVectorTest__ExtractVector128_Single_1();
    ...
    public sealed unsafe class ExtractVectorTest__ExtractVector128_Single_1
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(ExtractVectorTest__ExtractVector128_Single_1 testClass)
            {
        ...
        static ExtractVectorTest__ExtractVector128_Single_1()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetSingle();
        ...
        public ExtractVectorTest__ExtractVector128_Single_1()
        {
            Succeeded = true;
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.ExtractVector128)}<Single>(Vector128<Single>, Vector128<Single>, 1): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
