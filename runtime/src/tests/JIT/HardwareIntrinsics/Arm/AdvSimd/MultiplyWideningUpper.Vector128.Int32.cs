...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void MultiplyWideningUpper_Vector128_Int32()
        {
            var test = new SimpleBinaryOpTest__MultiplyWideningUpper_Vector128_Int32();
    ...
    public sealed unsafe class SimpleBinaryOpTest__MultiplyWideningUpper_Vector128_Int32
    {
        ...
        static SimpleBinaryOpTest__MultiplyWideningUpper_Vector128_Int32()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetInt32();
        ...
        public SimpleBinaryOpTest__MultiplyWideningUpper_Vector128_Int32()
        {
            Succeeded = true;
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.MultiplyWideningUpper)}<Int64>(Vector128<Int32>, Vector128<Int32>): {method} failed:"
                    );
