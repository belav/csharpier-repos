...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void CeilingScalar_Vector64_Single()
        {
            var test = new SimpleUnaryOpTest__CeilingScalar_Vector64_Single();
    ...
    public sealed unsafe class SimpleUnaryOpTest__CeilingScalar_Vector64_Single
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__CeilingScalar_Vector64_Single testClass
            )
            {
                var result = AdvSimd.CeilingScalar(_fld1);
            ...
            )
            {
                ...
                {
                    var result = AdvSimd.CeilingScalar(AdvSimd.LoadVector64((Single*)(pFld1)));
        ...
        static SimpleUnaryOpTest__CeilingScalar_Vector64_Single()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetSingle();
        ...
        public SimpleUnaryOpTest__CeilingScalar_Vector64_Single()
        {
            Succeeded = true;
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.CeilingScalar(
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd)
                .GetMethod(nameof(AdvSimd.CeilingScalar), new Type[] { typeof(Vector64<Single>) })
                .Invoke(
                    null,
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AdvSimd.CeilingScalar(_clsVar1);
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            {
                var result = AdvSimd.CeilingScalar(AdvSimd.LoadVector64((Single*)(pClsVar1)));
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = AdvSimd.CeilingScalar(op1);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimpleUnaryOpTest__CeilingScalar_Vector64_Single();
            var result = AdvSimd.CeilingScalar(test._fld1);
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = AdvSimd.CeilingScalar(AdvSimd.LoadVector64((Single*)(&test._fld1)));
        ...
        )
        {
            ...
            if (
                BitConverter.SingleToInt32Bits(Helpers.Ceiling(firstOp[0]))
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.CeilingScalar)}<Single>(Vector64<Single>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
