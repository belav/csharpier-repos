...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ExtractNarrowingUpper_Vector128_UInt32()
        {
            var test = new SimpleBinaryOpTest__ExtractNarrowingUpper_Vector128_UInt32();
    ...
    public sealed unsafe class SimpleBinaryOpTest__ExtractNarrowingUpper_Vector128_UInt32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__ExtractNarrowingUpper_Vector128_UInt32 testClass
            )
            {
        ...
        static SimpleBinaryOpTest__ExtractNarrowingUpper_Vector128_UInt32()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetUInt32();
        ...
        public SimpleBinaryOpTest__ExtractNarrowingUpper_Vector128_UInt32()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(AdvSimd).GetMethod(
                    ...
                    new Type[] { typeof(Vector64<UInt32>), typeof(Vector128<UInt64>) }
                )
                .Invoke(
                    null,
                    new object[]
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(AdvSimd)}.{nameof(AdvSimd.ExtractNarrowingUpper)}<UInt32>(Vector64<UInt32>, Vector128<UInt64>): {method} failed:"
                );
