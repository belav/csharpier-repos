    ...
    public sealed unsafe class SimpleUnaryOpTest__AddPairwiseWidening_Vector128_Int16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__AddPairwiseWidening_Vector128_Int16 testClass
            )
            {
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            {
                var result = AdvSimd.AddPairwiseWidening(AdvSimd.LoadVector128((Int16*)(pClsVar1)));
        ...
        public void RunClassLclFldScenario_Load()
        {
            ...
            {
                var result = AdvSimd.AddPairwiseWidening(AdvSimd.LoadVector128((Int16*)(pFld1)));
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = AdvSimd.AddPairwiseWidening(AdvSimd.LoadVector128((Int16*)(&test._fld1)));
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.AddPairwiseWidening)}<Int32>(Vector128<Int16>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
