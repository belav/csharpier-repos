...
namespace JIT.HardwareIntrinsics.Arm
{
    public static partial class Program
    {
        ...
        {
            var test =
                new SimpleTernaryOpTest__MultiplyAddBySelectedScalar_Vector128_UInt16_Vector128_UInt16_7();
    ...
    public sealed unsafe class SimpleTernaryOpTest__MultiplyAddBySelectedScalar_Vector128_UInt16_Vector128_UInt16_7
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleTernaryOpTest__MultiplyAddBySelectedScalar_Vector128_UInt16_Vector128_UInt16_7 testClass
            )
            {
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.MultiplyAddBySelectedScalar)}<UInt16>(Vector128<UInt16>, Vector128<UInt16>, Vector128<UInt16>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
