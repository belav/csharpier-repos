...
namespace JIT.HardwareIntrinsics.Arm
{
    public static partial class Program
    {
        ...
        {
            var test =
                new ImmBinaryOpTest__MultiplyDoublingBySelectedScalarSaturateHigh_Vector128_Int16_Vector64_Int16_3();
    ...
    public sealed unsafe class ImmBinaryOpTest__MultiplyDoublingBySelectedScalarSaturateHigh_Vector128_Int16_Vector64_Int16_3
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                ImmBinaryOpTest__MultiplyDoublingBySelectedScalarSaturateHigh_Vector128_Int16_Vector64_Int16_3 testClass
            )
            {
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(AdvSimd)}.{nameof(AdvSimd.MultiplyDoublingBySelectedScalarSaturateHigh)}<Int16>(Vector128<Int16>, Vector64<Int16>, 3): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
