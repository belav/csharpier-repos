...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void PolynomialMultiplyWideningLower_Vector64_Int64()
        {
    ...
    public sealed unsafe class SimpleBinaryOpTest__PolynomialMultiplyWideningLower_Vector64_Int64
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__PolynomialMultiplyWideningLower_Vector64_Int64 testClass
            )
            {
                var result = Aes.PolynomialMultiplyWideningLower(_fld1, _fld2);
            ...
            )
            {
                ...
                {
                    var result = Aes.PolynomialMultiplyWideningLower(
        ...
        static SimpleBinaryOpTest__PolynomialMultiplyWideningLower_Vector64_Int64()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetInt64();
        ...
        public SimpleBinaryOpTest__PolynomialMultiplyWideningLower_Vector64_Int64()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Aes)
                .GetMethod(
                    nameof(Aes.PolynomialMultiplyWideningLower),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Aes.PolynomialMultiplyWideningLower(_clsVar1, _clsVar2);
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = Aes.PolynomialMultiplyWideningLower(op1, op2);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimpleBinaryOpTest__PolynomialMultiplyWideningLower_Vector64_Int64();
            var result = Aes.PolynomialMultiplyWideningLower(test._fld1, test._fld2);
        ...
        )
        {
            ...
            if (Helpers.PolynomialMultiplyWideningLo64(left[0], right[0]) != result[0])
            {
                succeeded = false;
            }
            else
            {
                ...
                {
                    if (Helpers.PolynomialMultiplyWideningHi64(left[0], right[0]) != result[1])
                    {
                        succeeded = false;
                        break;
                    }
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Aes)}.{nameof(Aes.PolynomialMultiplyWideningLower)}<Int64>(Vector64<Int64>, Vector64<Int64>): {method} failed:"
                    );
