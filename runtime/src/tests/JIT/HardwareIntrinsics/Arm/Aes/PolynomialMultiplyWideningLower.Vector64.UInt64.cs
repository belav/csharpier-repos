    ...
    public sealed unsafe class SimpleBinaryOpTest__PolynomialMultiplyWideningLower_Vector64_UInt64
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__PolynomialMultiplyWideningLower_Vector64_UInt64 testClass
            )
            {
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Aes)}.{nameof(Aes.PolynomialMultiplyWideningLower)}<UInt64>(Vector64<UInt64>, Vector64<UInt64>): {method} failed:"
                    );
