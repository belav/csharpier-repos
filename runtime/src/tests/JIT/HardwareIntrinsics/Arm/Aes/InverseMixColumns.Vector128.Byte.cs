...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void InverseMixColumns_Vector128_Byte()
        {
    ...
    public sealed unsafe class AesUnaryOpTest__InverseMixColumns_Vector128_Byte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                AesUnaryOpTest__InverseMixColumns_Vector128_Byte testClass
            )
            {
            ...
            )
            {
                ...
                {
                    var result = Aes.InverseMixColumns(AdvSimd.LoadVector128((Byte*)(pFld)));
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            {
                var result = Aes.InverseMixColumns(AdvSimd.LoadVector128((Byte*)(pClsVar)));
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = Aes.InverseMixColumns(AdvSimd.LoadVector128((Byte*)(&test._fld)));
