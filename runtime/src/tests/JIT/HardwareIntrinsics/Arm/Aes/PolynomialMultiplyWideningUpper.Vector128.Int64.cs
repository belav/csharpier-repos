...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void PolynomialMultiplyWideningUpper_Vector128_Int64()
        {
    ...
    public sealed unsafe class SimpleBinaryOpTest__PolynomialMultiplyWideningUpper_Vector128_Int64
    {
        ...
        private struct TestStruct
        {
            ...
            {
                var result = Aes.PolynomialMultiplyWideningUpper(_fld1, _fld2);
            ...
            )
            {
                ...
                {
                    var result = Aes.PolynomialMultiplyWideningUpper(
        ...
        static SimpleBinaryOpTest__PolynomialMultiplyWideningUpper_Vector128_Int64()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetInt64();
        ...
        public SimpleBinaryOpTest__PolynomialMultiplyWideningUpper_Vector128_Int64()
        {
            Succeeded = true;
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Aes.PolynomialMultiplyWideningUpper(_clsVar1, _clsVar2);
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = Aes.PolynomialMultiplyWideningUpper(op1, op2);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimpleBinaryOpTest__PolynomialMultiplyWideningUpper_Vector128_Int64();
            var result = Aes.PolynomialMultiplyWideningUpper(test._fld1, test._fld2);
        ...
        )
        {
            ...
            if (Helpers.PolynomialMultiplyWideningLo64(left[1], right[1]) != result[0])
            {
                succeeded = false;
            }
            else
            {
                ...
                {
                    if (Helpers.PolynomialMultiplyWideningHi64(left[1], right[1]) != result[1])
                    {
                        succeeded = false;
                        break;
                    }
