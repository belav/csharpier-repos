...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void MultiplyRoundedDoublingBySelectedScalarAndSubtractSaturateHigh_Vector128_Int32_Vector128_Int32_3()
        {
            var test =
                new SimpleTernaryOpTest__MultiplyRoundedDoublingBySelectedScalarAndSubtractSaturateHigh_Vector128_Int32_Vector128_Int32_3();
    ...
    public sealed unsafe class SimpleTernaryOpTest__MultiplyRoundedDoublingBySelectedScalarAndSubtractSaturateHigh_Vector128_Int32_Vector128_Int32_3
    {
        ...
        private struct TestStruct
        {
            ...
            public static TestStruct Create()
            {
                ...
                Unsafe.CopyBlockUnaligned(
                    ref Unsafe.As<Vector128<Int32>, byte>(ref testStruct._fld1),
                ...
                Unsafe.CopyBlockUnaligned(
                    ref Unsafe.As<Vector128<Int32>, byte>(ref testStruct._fld2),
                ...
                Unsafe.CopyBlockUnaligned(
                    ref Unsafe.As<Vector128<Int32>, byte>(ref testStruct._fld3),
            ...
            public void RunStructFldScenario(
                SimpleTernaryOpTest__MultiplyRoundedDoublingBySelectedScalarAndSubtractSaturateHigh_Vector128_Int32_Vector128_Int32_3 testClass
            )
            {
        ...
        static SimpleTernaryOpTest__MultiplyRoundedDoublingBySelectedScalarAndSubtractSaturateHigh_Vector128_Int32_Vector128_Int32_3()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetInt32();
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector128<Int32>, byte>(ref _clsVar1),
                ref Unsafe.As<Int32, byte>(ref _data1[0]),
                (uint)Unsafe.SizeOf<Vector128<Int32>>()
            );
            for (var i = 0; i < Op2ElementCount; i++)
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector128<Int32>, byte>(ref _clsVar2),
                ref Unsafe.As<Int32, byte>(ref _data2[0]),
                (uint)Unsafe.SizeOf<Vector128<Int32>>()
            );
            for (var i = 0; i < Op3ElementCount; i++)
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector128<Int32>, byte>(ref _clsVar3),
                ref Unsafe.As<Int32, byte>(ref _data3[0]),
                (uint)Unsafe.SizeOf<Vector128<Int32>>()
            );
        }

        public SimpleTernaryOpTest__MultiplyRoundedDoublingBySelectedScalarAndSubtractSaturateHigh_Vector128_Int32_Vector128_Int32_3()
        {
            Succeeded = true;
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector128<Int32>, byte>(ref _fld1),
                ref Unsafe.As<Int32, byte>(ref _data1[0]),
                (uint)Unsafe.SizeOf<Vector128<Int32>>()
            );
            for (var i = 0; i < Op2ElementCount; i++)
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector128<Int32>, byte>(ref _fld2),
                ref Unsafe.As<Int32, byte>(ref _data2[0]),
                (uint)Unsafe.SizeOf<Vector128<Int32>>()
            );
            for (var i = 0; i < Op3ElementCount; i++)
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector128<Int32>, byte>(ref _fld3),
                ref Unsafe.As<Int32, byte>(ref _data3[0]),
                (uint)Unsafe.SizeOf<Vector128<Int32>>()
            );
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Rdm).GetMethod(
                    nameof(Rdm.MultiplyRoundedDoublingBySelectedScalarAndSubtractSaturateHigh),
                    new Type[]
                    {
        ...
        )
        {
            ...
            {
                if (
                    Helpers.MultiplyRoundedDoublingAndSubtractSaturateHigh(
                        firstOp[i],
                        secondOp[i],
                        thirdOp[Imm]
                    ) != result[i]
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(Rdm)}.{nameof(Rdm.MultiplyRoundedDoublingBySelectedScalarAndSubtractSaturateHigh)}<Int32>(Vector128<Int32>, Vector128<Int32>, Vector128<Int32>): {method} failed:"
                );
                TestLibrary.TestFramework.LogInformation(
