...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void MultiplyRoundedDoublingAndSubtractSaturateHigh_Vector64_Int16()
        {
            var test =
                new SimpleTernaryOpTest__MultiplyRoundedDoublingAndSubtractSaturateHigh_Vector64_Int16();
    ...
    public sealed unsafe class SimpleTernaryOpTest__MultiplyRoundedDoublingAndSubtractSaturateHigh_Vector64_Int16
    {
        ...
        private struct TestStruct
        {
            ...
            public static TestStruct Create()
            {
                ...
                Unsafe.CopyBlockUnaligned(
                    ref Unsafe.As<Vector64<Int16>, byte>(ref testStruct._fld3),
            ...
            public void RunStructFldScenario(
                SimpleTernaryOpTest__MultiplyRoundedDoublingAndSubtractSaturateHigh_Vector64_Int16 testClass
            )
            {
        ...
        static SimpleTernaryOpTest__MultiplyRoundedDoublingAndSubtractSaturateHigh_Vector64_Int16()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetInt16();
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector64<Int16>, byte>(ref _clsVar3),
                ref Unsafe.As<Int16, byte>(ref _data3[0]),
                (uint)Unsafe.SizeOf<Vector64<Int16>>()
            );
        }

        public SimpleTernaryOpTest__MultiplyRoundedDoublingAndSubtractSaturateHigh_Vector64_Int16()
        {
            Succeeded = true;
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector64<Int16>, byte>(ref _fld3),
                ref Unsafe.As<Int16, byte>(ref _data3[0]),
                (uint)Unsafe.SizeOf<Vector64<Int16>>()
            );
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Rdm)
                .GetMethod(
                    nameof(Rdm.MultiplyRoundedDoublingAndSubtractSaturateHigh),
                    new Type[]
                    {
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Rdm)}.{nameof(Rdm.MultiplyRoundedDoublingAndSubtractSaturateHigh)}<Int16>(Vector64<Int16>, Vector64<Int16>, Vector64<Int16>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
