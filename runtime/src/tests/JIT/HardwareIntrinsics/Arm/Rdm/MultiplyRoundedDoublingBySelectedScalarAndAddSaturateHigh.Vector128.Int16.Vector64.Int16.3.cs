...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void MultiplyRoundedDoublingBySelectedScalarAndAddSaturateHigh_Vector128_Int16_Vector64_Int16_3()
        {
            var test =
    ...
    public sealed unsafe class SimpleTernaryOpTest__MultiplyRoundedDoublingBySelectedScalarAndAddSaturateHigh_Vector128_Int16_Vector64_Int16_3
    {
        ...
        static SimpleTernaryOpTest__MultiplyRoundedDoublingBySelectedScalarAndAddSaturateHigh_Vector128_Int16_Vector64_Int16_3()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetInt16();
        ...
        public SimpleTernaryOpTest__MultiplyRoundedDoublingBySelectedScalarAndAddSaturateHigh_Vector128_Int16_Vector64_Int16_3()
        {
            Succeeded = true;
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Rdm)}.{nameof(Rdm.MultiplyRoundedDoublingBySelectedScalarAndAddSaturateHigh)}<Int16>(Vector128<Int16>, Vector128<Int16>, Vector64<Int16>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
