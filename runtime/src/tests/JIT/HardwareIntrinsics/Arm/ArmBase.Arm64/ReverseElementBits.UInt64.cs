...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void ReverseElementBits_UInt64()
        {
            var test = new ScalarUnaryOpTest__ReverseElementBits_UInt64();
    ...
    public sealed unsafe class ScalarUnaryOpTest__ReverseElementBits_UInt64
    {
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(ScalarUnaryOpTest__ReverseElementBits_UInt64 testClass)
            {
                var result = ArmBase.Arm64.ReverseElementBits(_fld);
        ...
        static ScalarUnaryOpTest__ReverseElementBits_UInt64()
        {
            _clsVar = TestLibrary.Generator.GetUInt64();
        }

        public ScalarUnaryOpTest__ReverseElementBits_UInt64()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(ArmBase.Arm64)
                .GetMethod(nameof(ArmBase.Arm64.ReverseElementBits), new Type[] { typeof(UInt64) })
                .Invoke(
                    null,
                    new object[]
                    {
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = ArmBase.Arm64.ReverseElementBits(data);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new ScalarUnaryOpTest__ReverseElementBits_UInt64();
            var result = ArmBase.Arm64.ReverseElementBits(test._fld);
