...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void MultiplyRoundedDoublingScalarBySelectedScalarAndSubtractSaturateHigh_Vector64_Int16_Vector64_Int16_3()
        {
            var test =
    ...
    public sealed unsafe class SimpleTernaryOpTest__MultiplyRoundedDoublingScalarBySelectedScalarAndSubtractSaturateHigh_Vector64_Int16_Vector64_Int16_3
    {
        ...
        static SimpleTernaryOpTest__MultiplyRoundedDoublingScalarBySelectedScalarAndSubtractSaturateHigh_Vector64_Int16_Vector64_Int16_3()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetInt16();
        ...
        public SimpleTernaryOpTest__MultiplyRoundedDoublingScalarBySelectedScalarAndSubtractSaturateHigh_Vector64_Int16_Vector64_Int16_3()
        {
            Succeeded = true;
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Rdm.Arm64)}.{nameof(Rdm.Arm64.MultiplyRoundedDoublingScalarBySelectedScalarAndSubtractSaturateHigh)}<Int16>(Vector64<Int16>, Vector64<Int16>, Vector64<Int16>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
