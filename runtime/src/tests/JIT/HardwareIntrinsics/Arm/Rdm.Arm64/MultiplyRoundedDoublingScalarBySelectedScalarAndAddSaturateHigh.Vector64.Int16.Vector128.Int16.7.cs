...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void MultiplyRoundedDoublingScalarBySelectedScalarAndAddSaturateHigh_Vector64_Int16_Vector128_Int16_7()
        {
            var test =
                new SimpleTernaryOpTest__MultiplyRoundedDoublingScalarBySelectedScalarAndAddSaturateHigh_Vector64_Int16_Vector128_Int16_7();
    ...
    public sealed unsafe class SimpleTernaryOpTest__MultiplyRoundedDoublingScalarBySelectedScalarAndAddSaturateHigh_Vector64_Int16_Vector128_Int16_7
    {
        private struct DataTable
        {
            ...
            )
            {
                ...
                Unsafe.CopyBlockUnaligned(
                    ...
                    ref Unsafe.As<Int16, byte>(ref inArray3[0]),
                    (uint)sizeOfinArray3
                );
            }
        ...
        private struct TestStruct
        {
            ...
            public static TestStruct Create()
            {
                ...
                Unsafe.CopyBlockUnaligned(
                    ref Unsafe.As<Vector64<Int16>, byte>(ref testStruct._fld2),
                    ref Unsafe.As<Int16, byte>(ref _data2[0]),
                    (uint)Unsafe.SizeOf<Vector64<Int16>>()
                );
                for (var i = 0; i < Op3ElementCount; i++)
                {
                    _data3[i] = TestLibrary.Generator.GetInt16();
                }
                Unsafe.CopyBlockUnaligned(
                    ref Unsafe.As<Vector128<Int16>, byte>(ref testStruct._fld3),
                    ref Unsafe.As<Int16, byte>(ref _data3[0]),
            ...
            public void RunStructFldScenario(
                SimpleTernaryOpTest__MultiplyRoundedDoublingScalarBySelectedScalarAndAddSaturateHigh_Vector64_Int16_Vector128_Int16_7 testClass
            )
            {
                var result = Rdm.Arm64
        ...
        static SimpleTernaryOpTest__MultiplyRoundedDoublingScalarBySelectedScalarAndAddSaturateHigh_Vector64_Int16_Vector128_Int16_7()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetInt16();
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector64<Int16>, byte>(ref _clsVar2),
                ref Unsafe.As<Int16, byte>(ref _data2[0]),
                (uint)Unsafe.SizeOf<Vector64<Int16>>()
            );
            for (var i = 0; i < Op3ElementCount; i++)
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector128<Int16>, byte>(ref _clsVar3),
                ref Unsafe.As<Int16, byte>(ref _data3[0]),
                (uint)Unsafe.SizeOf<Vector128<Int16>>()
            );
        }

        public SimpleTernaryOpTest__MultiplyRoundedDoublingScalarBySelectedScalarAndAddSaturateHigh_Vector64_Int16_Vector128_Int16_7()
        {
            Succeeded = true;
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector64<Int16>, byte>(ref _fld2),
                ref Unsafe.As<Int16, byte>(ref _data2[0]),
                (uint)Unsafe.SizeOf<Vector64<Int16>>()
            );
            for (var i = 0; i < Op3ElementCount; i++)
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector128<Int16>, byte>(ref _fld3),
                ref Unsafe.As<Int16, byte>(ref _data3[0]),
                (uint)Unsafe.SizeOf<Vector128<Int16>>()
            );
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Rdm.Arm64)
                .GetMethod(
                    nameof(
                        Rdm.Arm64.MultiplyRoundedDoublingScalarBySelectedScalarAndAddSaturateHigh
                    ),
                    new Type[]
                    {
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = Rdm.Arm64
                .MultiplyRoundedDoublingScalarBySelectedScalarAndAddSaturateHigh(op1, op2, op3, 7);
        ...
        )
        {
            ...
            if (
                Helpers.MultiplyRoundedDoublingAndAddSaturateHigh(
                    firstOp[0],
                    secondOp[0],
                    thirdOp[Imm]
                ) != result[0]
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework
                    .LogInformation(
                        $"{nameof(Rdm.Arm64)}.{nameof(Rdm.Arm64.MultiplyRoundedDoublingScalarBySelectedScalarAndAddSaturateHigh)}<Int16>(Vector64<Int16>, Vector64<Int16>, Vector128<Int16>): {method} failed:"
                    );
                TestLibrary.TestFramework
