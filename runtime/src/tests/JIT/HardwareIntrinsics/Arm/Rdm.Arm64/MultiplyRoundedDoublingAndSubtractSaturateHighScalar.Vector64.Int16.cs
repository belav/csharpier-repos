...
namespace JIT.HardwareIntrinsics.Arm
{
    public static partial class Program
    {
        ...
        {
            var test =
                new SimpleTernaryOpTest__MultiplyRoundedDoublingAndSubtractSaturateHighScalar_Vector64_Int16();
    ...
    public sealed unsafe class SimpleTernaryOpTest__MultiplyRoundedDoublingAndSubtractSaturateHighScalar_Vector64_Int16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleTernaryOpTest__MultiplyRoundedDoublingAndSubtractSaturateHighScalar_Vector64_Int16 testClass
            )
            {
                var result = Rdm.Arm64
                    .MultiplyRoundedDoublingAndSubtractSaturateHighScalar(_fld1, _fld2, _fld3);
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Rdm.Arm64)
                .GetMethod(
                    nameof(Rdm.Arm64.MultiplyRoundedDoublingAndSubtractSaturateHighScalar),
                    new Type[]
                    {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Rdm.Arm64
                .MultiplyRoundedDoublingAndSubtractSaturateHighScalar(_clsVar1, _clsVar2, _clsVar3);
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = Rdm.Arm64
                .MultiplyRoundedDoublingAndSubtractSaturateHighScalar(op1, op2, op3);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework
                    .LogInformation(
                        $"{nameof(Rdm.Arm64)}.{nameof(Rdm.Arm64.MultiplyRoundedDoublingAndSubtractSaturateHighScalar)}<Int16>(Vector64<Int16>, Vector64<Int16>, Vector64<Int16>): {method} failed:"
                    );
                TestLibrary.TestFramework
