...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void DotProductBySelectedQuadruplet_Vector128_Int32_Vector128_SByte_3()
        {
            var test =
                new SimpleTernaryOpTest__DotProductBySelectedQuadruplet_Vector128_Int32_Vector128_SByte_3();
    ...
    public sealed unsafe class SimpleTernaryOpTest__DotProductBySelectedQuadruplet_Vector128_Int32_Vector128_SByte_3
    {
        ...
        static SimpleTernaryOpTest__DotProductBySelectedQuadruplet_Vector128_Int32_Vector128_SByte_3()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetInt32();
        ...
        public SimpleTernaryOpTest__DotProductBySelectedQuadruplet_Vector128_Int32_Vector128_SByte_3()
        {
            Succeeded = true;
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Dp)}.{nameof(Dp.DotProductBySelectedQuadruplet)}<Int32>(Vector128<Int32>, Vector128<SByte>, Vector128<SByte>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
