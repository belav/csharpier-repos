...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void DotProduct_Vector128_UInt32()
        {
            var test = new SimpleTernaryOpTest__DotProduct_Vector128_UInt32();
    ...
    public sealed unsafe class SimpleTernaryOpTest__DotProduct_Vector128_UInt32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleTernaryOpTest__DotProduct_Vector128_UInt32 testClass
            )
            {
        ...
        static SimpleTernaryOpTest__DotProduct_Vector128_UInt32()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetUInt32();
        ...
        public SimpleTernaryOpTest__DotProduct_Vector128_UInt32()
        {
            Succeeded = true;
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Dp.DotProduct(_clsVar1, _clsVar2, _clsVar3);
        ...
        public void RunClassLclFldScenario_Load()
        {
            ...
            fixed (Vector128<UInt32>* pFld1 = &test._fld1)fixed (
                Vector128<Byte>* pFld2 = &test._fld2
        ...
        public void RunClassFldScenario_Load()
        {
            ...
            fixed (Vector128<UInt32>* pFld1 = &_fld1)fixed (Vector128<Byte>* pFld2 = &_fld2)fixed (
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(Dp)}.{nameof(Dp.DotProduct)}<UInt32>(Vector128<UInt32>, Vector128<Byte>, Vector128<Byte>): {method} failed:"
                );
                TestLibrary.TestFramework.LogInformation(
