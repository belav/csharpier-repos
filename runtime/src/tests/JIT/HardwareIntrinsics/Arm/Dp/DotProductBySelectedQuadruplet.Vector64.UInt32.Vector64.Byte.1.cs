...
namespace JIT.HardwareIntrinsics.Arm
{
    public static partial class Program
    {
        ...
        {
            var test =
                new SimpleTernaryOpTest__DotProductBySelectedQuadruplet_Vector64_UInt32_Vector64_Byte_1();
    ...
    public sealed unsafe class SimpleTernaryOpTest__DotProductBySelectedQuadruplet_Vector64_UInt32_Vector64_Byte_1
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleTernaryOpTest__DotProductBySelectedQuadruplet_Vector64_UInt32_Vector64_Byte_1 testClass
            )
            {
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Dp)}.{nameof(Dp.DotProductBySelectedQuadruplet)}<UInt32>(Vector64<UInt32>, Vector64<Byte>, Vector64<Byte>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
