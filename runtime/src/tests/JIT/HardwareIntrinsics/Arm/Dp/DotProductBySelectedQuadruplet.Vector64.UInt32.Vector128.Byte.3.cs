...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void DotProductBySelectedQuadruplet_Vector64_UInt32_Vector128_Byte_3()
        {
            var test =
                new SimpleTernaryOpTest__DotProductBySelectedQuadruplet_Vector64_UInt32_Vector128_Byte_3();
    ...
    public sealed unsafe class SimpleTernaryOpTest__DotProductBySelectedQuadruplet_Vector64_UInt32_Vector128_Byte_3
    {
        private struct DataTable
        {
            ...
            public DataTable(
                ...
                Unsafe.CopyBlockUnaligned(
                    ...
                    ref Unsafe.As<UInt32, byte>(ref inArray1[0]),
                    (uint)sizeOfinArray1
                );
                Unsafe.CopyBlockUnaligned(
                ...
                Unsafe.CopyBlockUnaligned(
                    ...
                    ref Unsafe.As<Byte, byte>(ref inArray3[0]),
                    (uint)sizeOfinArray3
                );
            }
        ...
        private struct TestStruct
        {
            ...
            public static TestStruct Create()
            {
                ...
                Unsafe.CopyBlockUnaligned(
                    ref Unsafe.As<Vector64<UInt32>, byte>(ref testStruct._fld1),
                    ref Unsafe.As<UInt32, byte>(ref _data1[0]),
                    (uint)Unsafe.SizeOf<Vector64<UInt32>>()
                );
                ...
                Unsafe.CopyBlockUnaligned(
                    ref Unsafe.As<Vector64<Byte>, byte>(ref testStruct._fld2),
                    ref Unsafe.As<Byte, byte>(ref _data2[0]),
                    (uint)Unsafe.SizeOf<Vector64<Byte>>()
                );
                for (var i = 0; i < Op3ElementCount; i++)
                {
                    _data3[i] = TestLibrary.Generator.GetByte();
                }
                Unsafe.CopyBlockUnaligned(
                    ref Unsafe.As<Vector128<Byte>, byte>(ref testStruct._fld3),
                    ref Unsafe.As<Byte, byte>(ref _data3[0]),
            ...
            public void RunStructFldScenario(
                SimpleTernaryOpTest__DotProductBySelectedQuadruplet_Vector64_UInt32_Vector128_Byte_3 testClass
            ) {
        ...
        private static readonly int Op1ElementCount =
            Unsafe.SizeOf<Vector64<UInt32>>() / sizeof(UInt32);
        private static readonly int Op2ElementCount =
            Unsafe.SizeOf<Vector64<Byte>>() / sizeof(Byte);
        ...
        static SimpleTernaryOpTest__DotProductBySelectedQuadruplet_Vector64_UInt32_Vector128_Byte_3()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetUInt32();
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector64<UInt32>, byte>(ref _clsVar1),
                ref Unsafe.As<UInt32, byte>(ref _data1[0]),
                (uint)Unsafe.SizeOf<Vector64<UInt32>>()
            );
            for (var i = 0; i < Op2ElementCount; i++)
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector64<Byte>, byte>(ref _clsVar2),
                ref Unsafe.As<Byte, byte>(ref _data2[0]),
                (uint)Unsafe.SizeOf<Vector64<Byte>>()
            );
            for (var i = 0; i < Op3ElementCount; i++)
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector128<Byte>, byte>(ref _clsVar3),
                ref Unsafe.As<Byte, byte>(ref _data3[0]),
                (uint)Unsafe.SizeOf<Vector128<Byte>>()
            );
        }

        public SimpleTernaryOpTest__DotProductBySelectedQuadruplet_Vector64_UInt32_Vector128_Byte_3()
        {
            Succeeded = true;
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector64<UInt32>, byte>(ref _fld1),
                ref Unsafe.As<UInt32, byte>(ref _data1[0]),
                (uint)Unsafe.SizeOf<Vector64<UInt32>>()
            );
            for (var i = 0; i < Op2ElementCount; i++)
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector64<Byte>, byte>(ref _fld2),
                ref Unsafe.As<Byte, byte>(ref _data2[0]),
                (uint)Unsafe.SizeOf<Vector64<Byte>>()
            );
            for (var i = 0; i < Op3ElementCount; i++)
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector128<Byte>, byte>(ref _fld3),
                ref Unsafe.As<Byte, byte>(ref _data3[0]),
                (uint)Unsafe.SizeOf<Vector128<Byte>>()
            );
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Dp).GetMethod(
                    nameof(Dp.DotProductBySelectedQuadruplet),
                    new Type[]
                    {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Dp.DotProductBySelectedQuadruplet(_clsVar1, _clsVar2, _clsVar3, 3);
        ...
        public void RunClassLclFldScenario_Load()
        {
            ...
            fixed (Vector64<UInt32>* pFld1 = &test._fld1)fixed (
                Vector64<Byte>* pFld2 = &test._fld2
        ...
        public void RunClassFldScenario_Load()
        {
            ...
            fixed (Vector64<UInt32>* pFld1 = &_fld1)fixed (Vector64<Byte>* pFld2 = &_fld2)fixed (
                Vector128<Byte>* pFld3 = &_fld3
            ) {
                var result = Dp.DotProductBySelectedQuadruplet(
                    AdvSimd.LoadVector64((UInt32*)(pFld1)),
                    AdvSimd.LoadVector64((Byte*)(pFld2)),
        ...
        private void ValidateResult(
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<UInt32, byte>(ref outArray[0]),
        ...
        private void ValidateResult(
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(Dp)}.{nameof(Dp.DotProductBySelectedQuadruplet)}<UInt32>(Vector64<UInt32>, Vector64<Byte>, Vector128<Byte>): {method} failed:"
                );
                TestLibrary.TestFramework.LogInformation(
