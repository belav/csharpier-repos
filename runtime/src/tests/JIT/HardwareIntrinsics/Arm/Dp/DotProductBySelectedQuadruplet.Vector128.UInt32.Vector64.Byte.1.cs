...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void DotProductBySelectedQuadruplet_Vector128_UInt32_Vector64_Byte_1()
        {
            var test =
                new SimpleTernaryOpTest__DotProductBySelectedQuadruplet_Vector128_UInt32_Vector64_Byte_1();
    ...
    public sealed unsafe class SimpleTernaryOpTest__DotProductBySelectedQuadruplet_Vector128_UInt32_Vector64_Byte_1
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleTernaryOpTest__DotProductBySelectedQuadruplet_Vector128_UInt32_Vector64_Byte_1 testClass
            )
            {
        ...
        static SimpleTernaryOpTest__DotProductBySelectedQuadruplet_Vector128_UInt32_Vector64_Byte_1()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetUInt32();
        ...
        public SimpleTernaryOpTest__DotProductBySelectedQuadruplet_Vector128_UInt32_Vector64_Byte_1()
        {
            Succeeded = true;
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Dp.DotProductBySelectedQuadruplet(_clsVar1, _clsVar2, _clsVar3, 1);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Dp)}.{nameof(Dp.DotProductBySelectedQuadruplet)}<UInt32>(Vector128<UInt32>, Vector128<Byte>, Vector64<Byte>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
