...
namespace JIT.HardwareIntrinsics.Arm
{
    public static partial class Program
    {
        ...
        {
            var test =
                new SimpleTernaryOpTest__DotProductBySelectedQuadruplet_Vector64_Int32_Vector128_SByte_3();
    ...
    public sealed unsafe class SimpleTernaryOpTest__DotProductBySelectedQuadruplet_Vector64_Int32_Vector128_SByte_3
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleTernaryOpTest__DotProductBySelectedQuadruplet_Vector64_Int32_Vector128_SByte_3 testClass
            )
            {
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Dp)}.{nameof(Dp.DotProductBySelectedQuadruplet)}<Int32>(Vector64<Int32>, Vector64<SByte>, Vector128<SByte>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
