    ...
    public sealed unsafe class ScalarUnaryOpTest__ExtractLowestSetBitUInt32
    {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Bmi1)
                .GetMethod(nameof(Bmi1.ExtractLowestSetBit), new Type[] { typeof(UInt32) })
                .Invoke(
                    null,
                    new object[]
                    {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Bmi1.ExtractLowestSetBit(_clsVar);
        ...
        )
        {
            ...
            if (isUnexpectedResult)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Bmi1)}.{nameof(Bmi1.ExtractLowestSetBit)}<UInt32>(UInt32): ExtractLowestSetBit failed:"
                    );
