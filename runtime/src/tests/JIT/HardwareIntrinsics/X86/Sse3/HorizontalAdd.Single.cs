    ...
    public sealed unsafe class HorizontalBinaryOpTest__HorizontalAddSingle
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario_Load(
                HorizontalBinaryOpTest__HorizontalAddSingle testClass
            )
            {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Sse3.HorizontalAdd(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Sse3)}.{nameof(Sse3.HorizontalAdd)}<Single>(Vector128<Single>, Vector128<Single>): {method} failed:"
                    );
