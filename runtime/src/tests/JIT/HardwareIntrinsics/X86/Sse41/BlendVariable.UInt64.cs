    ...
    public sealed unsafe class SimpleTernaryOpTest__BlendVariableUInt64
    {
        ...
        private struct TestStruct
        {
            ...
            public static TestStruct Create()
            {
                ...
                {
                    _data3[i] = (
                        ((i % 2) == 0) ? Convert.ToUInt64("0xFFFFFFFFFFFFFFFF", 16) : (ulong)0
                    );
                }
                Unsafe.CopyBlockUnaligned(
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Sse41)}.{nameof(Sse41.BlendVariable)}<UInt64>(Vector128<UInt64>, Vector128<UInt64>, Vector128<UInt64>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
