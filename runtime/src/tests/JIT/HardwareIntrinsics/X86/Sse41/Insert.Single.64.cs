...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    public sealed unsafe class InsertVector128Test__InsertSingle64
    {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Sse41.Insert(_clsVar1, _clsVar2, 64);
        ...
        )
        {
            ...
            if (
                ...
                != BitConverter.SingleToInt32Bits(right[1])
            )
            {
                succeeded = false;
            }
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Sse41)}.{nameof(Sse41.Insert)}<Single>(Vector128<Single>, Vector128<Single>.64): {method} failed:"
                    );
