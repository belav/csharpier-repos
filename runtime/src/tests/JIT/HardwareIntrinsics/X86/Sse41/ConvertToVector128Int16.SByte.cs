...
namespace JIT.HardwareIntrinsics.X86._Sse41.handwritten
{
    ...
    public sealed unsafe class SimpleUnaryOpTest__ConvertToVector128Int16SByte
    {
        ...
        {
            var result = Sse41.ConvertToVector128Int16((SByte*)(_dataTable.inArrayPtr));
        ...
        {
            var result = typeof(Sse41)
                .GetMethod(nameof(Sse41.ConvertToVector128Int16), new Type[] { typeof(SByte*) })
        ...
        )
        {
            ...
            {
                Console.WriteLine(
                    $"{nameof(Sse41)}.{nameof(Sse41.ConvertToVector128Int16)}<Int16>(Vector128<SByte>): {method} failed:"
                );
