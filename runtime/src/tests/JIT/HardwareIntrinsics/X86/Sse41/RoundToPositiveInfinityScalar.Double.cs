    ...
    public sealed unsafe class SimpleBinaryOpTest__RoundToPositiveInfinityScalarDouble
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__RoundToPositiveInfinityScalarDouble testClass
            )
            {
        ...
        )
        {
            ...
            if (
                ...
                != BitConverter.DoubleToInt64Bits(Math.Ceiling(right[0]))
            )
            {
                succeeded = false;
            }
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Sse41)}.{nameof(Sse41.RoundToPositiveInfinityScalar)}<Double>(Vector128<Double>, Vector128<Double>): {method} failed:"
                    );
