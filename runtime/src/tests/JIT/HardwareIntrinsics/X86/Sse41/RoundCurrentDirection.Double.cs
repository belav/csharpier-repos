    ...
    public sealed unsafe class SimpleUnaryOpTest__RoundCurrentDirectionDouble
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__RoundCurrentDirectionDouble testClass
            )
            {
            ...
            )
            {
                ...
                {
                    var result = Sse41.RoundCurrentDirection(Sse2.LoadVector128((Double*)(pFld1)));
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Sse41)
                .GetMethod(
                    nameof(Sse41.RoundCurrentDirection),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Sse41.RoundCurrentDirection(_clsVar1);
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            {
                var result = Sse41.RoundCurrentDirection(Sse2.LoadVector128((Double*)(pClsVar1)));
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = Sse41.RoundCurrentDirection(Sse2.LoadVector128((Double*)(&test._fld1)));
        ...
        )
        {
            ...
            else
            {
                for (var i = 1; i < RetElementCount; i++)
                {
                    if (
                        ...
                        != BitConverter.DoubleToInt64Bits(Math.Round(firstOp[i]))
                    )
                    {
                        succeeded = false;
                        break;
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Sse41)}.{nameof(Sse41.RoundCurrentDirection)}<Double>(Vector128<Double>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
