...
namespace JIT.HardwareIntrinsics.X86._Sse41.handwritten
{
    ...
    public sealed unsafe class SimpleUnaryOpTest__ConvertToVector128Int32UInt16
    {
        ...
        public SimpleUnaryOpTest__ConvertToVector128Int32UInt16()
        {
            ...
            _dataTable = new SimpleUnaryOpTest__DataTable<Int32, UInt16>(
                _data,
        ...
        {
            var result = Sse41.ConvertToVector128Int32((UInt16*)(_dataTable.inArrayPtr));
        ...
        )
        {
            ...
            {
                Console.WriteLine(
                    $"{nameof(Sse41)}.{nameof(Sse41.ConvertToVector128Int32)}<Int32>(Vector128<UInt16>): {method} failed:"
                );
