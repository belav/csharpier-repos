...
namespace JIT.HardwareIntrinsics.X86._Sse41.handwritten
{
    ...
    {
        [Fact]
        public static void ConvertToVector128Int32Int16()
        {
    ...
    public sealed unsafe class SimpleUnaryOpTest__ConvertToVector128Int32Int16
    {
        ...
        {
            var result = Sse41.ConvertToVector128Int32((Int16*)(_dataTable.inArrayPtr));
        ...
        {
            var result = typeof(Sse41)
                .GetMethod(nameof(Sse41.ConvertToVector128Int32), new Type[] { typeof(Int16*) })
        ...
        {
            var result = Sse41.ConvertToVector128Int32(_clsVar);
        ...
        )
        {
            ...
            {
                Console.WriteLine(
                    $"{nameof(Sse41)}.{nameof(Sse41.ConvertToVector128Int32)}<Int32>(Vector128<Int16>): {method} failed:"
                );
