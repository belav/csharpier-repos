    ...
    public sealed unsafe class SimpleUnaryOpTest__RoundCurrentDirectionSingle
    {
        ...
        private struct TestStruct
        {
            ...
            )
            {
                ...
                {
                    var result = Sse41.RoundCurrentDirection(Sse.LoadVector128((Single*)(pFld1)));
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            {
                var result = Sse41.RoundCurrentDirection(Sse.LoadVector128((Single*)(pClsVar1)));
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = Sse41.RoundCurrentDirection(Sse.LoadVector128((Single*)(&test._fld1)));
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Sse41)}.{nameof(Sse41.RoundCurrentDirection)}<Single>(Vector128<Single>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
