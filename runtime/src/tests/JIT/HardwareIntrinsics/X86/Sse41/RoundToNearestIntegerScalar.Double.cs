    ...
    public sealed unsafe class SimpleBinaryOpTest__RoundToNearestIntegerScalarDouble
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__RoundToNearestIntegerScalarDouble testClass
            )
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Sse41)
                .GetMethod(
                    nameof(Sse41.RoundToNearestIntegerScalar),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Sse41.RoundToNearestIntegerScalar(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (
                ...
                != BitConverter.DoubleToInt64Bits(
                    Math.Round(right[0], MidpointRounding.AwayFromZero)
                )
            )
            {
                succeeded = false;
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Sse41)}.{nameof(Sse41.RoundToNearestIntegerScalar)}<Double>(Vector128<Double>, Vector128<Double>): {method} failed:"
                    );
