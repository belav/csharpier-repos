...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    public sealed unsafe class InsertVector128Test__InsertSingle128
    {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Sse41.Insert(_clsVar1, _clsVar2, 128);
        ...
        )
        {
            ...
            if (
                ...
                != BitConverter.SingleToInt32Bits(right[2])
            )
            {
                succeeded = false;
            }
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Sse41)}.{nameof(Sse41.Insert)}<Single>(Vector128<Single>, Vector128<Single>.128): {method} failed:"
                    );
