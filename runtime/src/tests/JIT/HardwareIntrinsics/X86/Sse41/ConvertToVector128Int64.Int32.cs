...
namespace JIT.HardwareIntrinsics.X86._Sse41.handwritten
{
    ...
    public sealed unsafe class SimpleUnaryOpTest__ConvertToVector128Int64Int32
    {
        ...
        {
            var result = Sse41.ConvertToVector128Int64((Int32*)(_dataTable.inArrayPtr));
        ...
        {
            var result = typeof(Sse41)
                .GetMethod(nameof(Sse41.ConvertToVector128Int64), new Type[] { typeof(Int32*) })
        ...
        )
        {
            ...
            {
                Console.WriteLine(
                    $"{nameof(Sse41)}.{nameof(Sse41.ConvertToVector128Int64)}<Int64>(Vector128<Int32>): {method} failed:"
                );
