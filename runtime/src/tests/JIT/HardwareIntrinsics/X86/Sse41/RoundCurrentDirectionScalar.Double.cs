    ...
    public sealed unsafe class SimpleBinaryOpTest__RoundCurrentDirectionScalarDouble
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__RoundCurrentDirectionScalarDouble testClass
            )
            {
        ...
        )
        {
            ...
            if (
                ...
                != BitConverter.DoubleToInt64Bits(Math.Round(right[0]))
            )
            {
                succeeded = false;
            }
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Sse41)}.{nameof(Sse41.RoundCurrentDirectionScalar)}<Double>(Vector128<Double>, Vector128<Double>): {method} failed:"
                    );
