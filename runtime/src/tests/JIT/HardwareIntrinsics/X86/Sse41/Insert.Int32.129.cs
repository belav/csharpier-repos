    ...
    public sealed unsafe class InsertScalarTest__InsertInt32129
    {
        ...
        public void RunReflectionScenario()
        {
            ...
            var result = typeof(Sse41)
                .GetMethod(
                    nameof(Sse41.Insert),
                    new Type[] { typeof(Vector128<Int32>), typeof(Int32), typeof(byte) }
                )
                .Invoke(
                    null,
                    new object[]
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Sse41.Insert(_clsVar, _scalarClsData, 129);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Sse41)}.{nameof(Sse41.Insert)}<Int32>(Vector128<Int32><9>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
