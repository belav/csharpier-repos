...
namespace JIT.HardwareIntrinsics.X86._Sse41.handwritten
{
    ...
    public sealed unsafe class SimpleUnaryOpTest__ConvertToVector128Int64Byte
    {
        ...
        public SimpleUnaryOpTest__ConvertToVector128Int64Byte()
        {
            ...
            _dataTable = new SimpleUnaryOpTest__DataTable<Int64, Byte>(
                _data,
        ...
        {
            var result = Sse41.ConvertToVector128Int64((Byte*)(_dataTable.inArrayPtr));
        ...
        {
            var result = typeof(Sse41)
                .GetMethod(nameof(Sse41.ConvertToVector128Int64), new Type[] { typeof(Byte*) })
        ...
        )
        {
            ...
            {
                Console.WriteLine(
                    $"{nameof(Sse41)}.{nameof(Sse41.ConvertToVector128Int64)}<Int64>(Vector128<Byte>): {method} failed:"
                );
