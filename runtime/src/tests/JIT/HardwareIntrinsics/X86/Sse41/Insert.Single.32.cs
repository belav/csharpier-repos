...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    public sealed unsafe class InsertVector128Test__InsertSingle32
    {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Sse41.Insert(_clsVar1, _clsVar2, 32);
        ...
        )
        {
            ...
            if (
                BitConverter.SingleToInt32Bits(result[0]) != BitConverter.SingleToInt32Bits(left[0])
            )
            {
                succeeded = false;
            }
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Sse41)}.{nameof(Sse41.Insert)}<Single>(Vector128<Single>, Vector128<Single>.32): {method} failed:"
                    );
