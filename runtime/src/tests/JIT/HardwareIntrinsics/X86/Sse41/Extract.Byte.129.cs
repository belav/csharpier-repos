...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    public sealed unsafe class ExtractScalarTest__ExtractByte129
    {
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = Sse41.Extract(Unsafe.Read<Vector128<Byte>>(_dataTable.inArrayPtr), 129);
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var result = Sse41.Extract(Sse2.LoadVector128((Byte*)(_dataTable.inArrayPtr)), 129);
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Sse41)
                ...
                .Invoke(
                    null,
                    new object[] { Unsafe.Read<Vector128<Byte>>(_dataTable.inArrayPtr), (byte)129 }
                );
        ...
        public void RunReflectionScenario_Load()
        {
            ...
            var result = typeof(Sse41)
                ...
                .Invoke(
                    null,
                    new object[] { Sse2.LoadVector128((Byte*)(_dataTable.inArrayPtr)), (byte)129 }
                );
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Sse41.Extract(_clsVar, 129);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Sse41)}.{nameof(Sse41.Extract)}<Byte>(Vector128<Byte><9>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
