    ...
    public sealed unsafe class SimpleBinaryOpTest__RoundCurrentDirectionScalarSingle
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__RoundCurrentDirectionScalarSingle testClass
            )
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Sse41)
                .GetMethod(
                    nameof(Sse41.RoundCurrentDirectionScalar),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Sse41.RoundCurrentDirectionScalar(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (
                ...
                != BitConverter.SingleToInt32Bits(MathF.Round(right[0]))
            )
            {
                succeeded = false;
            }
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Sse41)}.{nameof(Sse41.RoundCurrentDirectionScalar)}<Single>(Vector128<Single>, Vector128<Single>): {method} failed:"
                    );
