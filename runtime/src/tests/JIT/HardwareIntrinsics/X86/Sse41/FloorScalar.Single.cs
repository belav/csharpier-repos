...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    public sealed unsafe class SimpleBinaryOpTest__FloorScalarSingle
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario_Load(SimpleBinaryOpTest__FloorScalarSingle testClass)
            {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Sse41.FloorScalar(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (
                ...
                != BitConverter.SingleToInt32Bits(MathF.Floor(right[0]))
            )
            {
                succeeded = false;
            }
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Sse41)}.{nameof(Sse41.FloorScalar)}<Single>(Vector128<Single>, Vector128<Single>): {method} failed:"
                    );
