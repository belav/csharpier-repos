...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    public sealed unsafe class SimpleUnaryOpTest__RoundToNegativeInfinityDouble
    {
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            {
                var result = Sse41.RoundToNegativeInfinity(Sse2.LoadVector128((Double*)(pClsVar1)));
        ...
        public void RunClassLclFldScenario_Load()
        {
            ...
            {
                var result = Sse41.RoundToNegativeInfinity(Sse2.LoadVector128((Double*)(pFld1)));
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = Sse41.RoundToNegativeInfinity(Sse2.LoadVector128((Double*)(&test._fld1)));
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Sse41)}.{nameof(Sse41.RoundToNegativeInfinity)}<Double>(Vector128<Double>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
