...
namespace JIT.HardwareIntrinsics.X86._Sse41.handwritten
{
    ...
    {
        [Fact]
        public static void ConvertToVector128Int32SByte()
        {
    ...
    public sealed unsafe class SimpleUnaryOpTest__ConvertToVector128Int32SByte
    {
        ...
        {
            var result = Sse41.ConvertToVector128Int32((SByte*)(_dataTable.inArrayPtr));
        ...
        {
            var result = typeof(Sse41)
                .GetMethod(nameof(Sse41.ConvertToVector128Int32), new Type[] { typeof(SByte*) })
        ...
        )
        {
            ...
            {
                Console.WriteLine(
                    $"{nameof(Sse41)}.{nameof(Sse41.ConvertToVector128Int32)}<Int32>(Vector128<SByte>): {method} failed:"
                );
