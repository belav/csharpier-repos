...
namespace JIT.HardwareIntrinsics.X86._Sse41.handwritten
{
    ...
    public sealed unsafe class SimpleUnaryOpTest__ConvertToVector128Int64UInt16
    {
        ...
        public SimpleUnaryOpTest__ConvertToVector128Int64UInt16()
        {
            ...
            _dataTable = new SimpleUnaryOpTest__DataTable<Int64, UInt16>(
                _data,
        ...
        {
            var result = Sse41.ConvertToVector128Int64((UInt16*)(_dataTable.inArrayPtr));
        ...
        {
            var result = typeof(Sse41)
                .GetMethod(nameof(Sse41.ConvertToVector128Int64), new Type[] { typeof(UInt16*) })
        ...
        )
        {
            ...
            {
                Console.WriteLine(
                    $"{nameof(Sse41)}.{nameof(Sse41.ConvertToVector128Int64)}<Int64>(Vector128<UInt16>): {method} failed:"
                );
