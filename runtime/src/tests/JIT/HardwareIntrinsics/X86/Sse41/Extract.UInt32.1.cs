...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    public sealed unsafe class ExtractScalarTest__ExtractUInt321
    {
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = Sse41.Extract(Unsafe.Read<Vector128<UInt32>>(_dataTable.inArrayPtr), 1);
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var result = Sse41.Extract(Sse2.LoadVector128((UInt32*)(_dataTable.inArrayPtr)), 1);
