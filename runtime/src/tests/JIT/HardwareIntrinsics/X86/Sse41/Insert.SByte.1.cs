...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    public sealed unsafe class InsertScalarTest__InsertSByte1
    {
        ...
        public unsafe void RunBasicScenario_Load()
        {
            ...
            var result = Sse41.Insert(Sse2.LoadVector128((SByte*)(_dataTable.inArrayPtr)), *ptr, 1);
        ...
        public void RunReflectionScenario()
        {
            ...
            var result = typeof(Sse41)
                .GetMethod(
                    nameof(Sse41.Insert),
                    new Type[] { typeof(Vector128<SByte>), typeof(SByte), typeof(byte) }
                )
                .Invoke(
                    null,
                    new object[]
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Sse41.Insert(_clsVar, _scalarClsData, 1);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Sse41)}.{nameof(Sse41.Insert)}<SByte>(Vector128<SByte><9>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
