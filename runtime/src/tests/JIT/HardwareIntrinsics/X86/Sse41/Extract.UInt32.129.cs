...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    public sealed unsafe class ExtractScalarTest__ExtractUInt32129
    {
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = Sse41.Extract(Unsafe.Read<Vector128<UInt32>>(_dataTable.inArrayPtr), 129);
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var result = Sse41.Extract(Sse2.LoadVector128((UInt32*)(_dataTable.inArrayPtr)), 129);
        ...
        public void RunReflectionScenario_Load()
        {
            ...
            var result = typeof(Sse41)
                ...
                .Invoke(
                    null,
                    new object[] { Sse2.LoadVector128((UInt32*)(_dataTable.inArrayPtr)), (byte)129 }
                );
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Sse41)}.{nameof(Sse41.Extract)}<UInt32>(Vector128<UInt32><9>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
