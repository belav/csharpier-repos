    ...
    public sealed unsafe class SimpleUnaryOpTest__CeilingSingle
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario_Load(SimpleUnaryOpTest__CeilingSingle testClass)
            {
                ...
                {
                    var result = Sse41.Ceiling(Sse.LoadVector128((Single*)(pFld1)));
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = Sse41.Ceiling(Unsafe.Read<Vector128<Single>>(_dataTable.inArray1Ptr));
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var result = Sse41.Ceiling(Sse.LoadVector128((Single*)(_dataTable.inArray1Ptr)));
        ...
        public void RunBasicScenario_LoadAligned()
        {
            ...
            var result = Sse41.Ceiling(Sse.LoadAlignedVector128((Single*)(_dataTable.inArray1Ptr)));
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Sse41)
                .GetMethod(nameof(Sse41.Ceiling), new Type[] { typeof(Vector128<Single>) })
                .Invoke(
                    null,
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Sse41.Ceiling(_clsVar1);
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            {
                var result = Sse41.Ceiling(Sse.LoadVector128((Single*)(pClsVar1)));
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = Sse41.Ceiling(Sse.LoadVector128((Single*)(&test._fld1)));
        ...
        )
        {
            ...
            if (
                ...
                != BitConverter.SingleToInt32Bits(MathF.Ceiling(firstOp[0]))
            )
            {
                succeeded = false;
            }
            else
            {
                for (var i = 1; i < RetElementCount; i++)
                {
                    if (
                        ...
                        != BitConverter.SingleToInt32Bits(MathF.Ceiling(firstOp[i]))
                    )
                    {
                        succeeded = false;
                        break;
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Sse41)}.{nameof(Sse41.Ceiling)}<Single>(Vector128<Single>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
