    ...
    public sealed unsafe class SimpleUnaryOpTest__FloorSingle
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario_Load(SimpleUnaryOpTest__FloorSingle testClass)
            {
                ...
                {
                    var result = Sse41.Floor(Sse.LoadVector128((Single*)(pFld1)));
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = Sse41.Floor(Unsafe.Read<Vector128<Single>>(_dataTable.inArray1Ptr));
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var result = Sse41.Floor(Sse.LoadVector128((Single*)(_dataTable.inArray1Ptr)));
        ...
        public void RunBasicScenario_LoadAligned()
        {
            ...
            var result = Sse41.Floor(Sse.LoadAlignedVector128((Single*)(_dataTable.inArray1Ptr)));
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Sse41.Floor(_clsVar1);
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            {
                var result = Sse41.Floor(Sse.LoadVector128((Single*)(pClsVar1)));
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = Sse41.Floor(Sse.LoadVector128((Single*)(&test._fld1)));
