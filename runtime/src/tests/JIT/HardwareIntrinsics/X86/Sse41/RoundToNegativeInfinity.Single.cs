    ...
    public sealed unsafe class SimpleUnaryOpTest__RoundToNegativeInfinitySingle
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__RoundToNegativeInfinitySingle testClass
            )
            {
            ...
            )
            {
                ...
                {
                    var result = Sse41.RoundToNegativeInfinity(Sse.LoadVector128((Single*)(pFld1)));
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Sse41)
                .GetMethod(
                    nameof(Sse41.RoundToNegativeInfinity),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Sse41.RoundToNegativeInfinity(_clsVar1);
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            {
                var result = Sse41.RoundToNegativeInfinity(Sse.LoadVector128((Single*)(pClsVar1)));
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = Sse41.RoundToNegativeInfinity(Sse.LoadVector128((Single*)(&test._fld1)));
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Sse41)}.{nameof(Sse41.RoundToNegativeInfinity)}<Single>(Vector128<Single>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
