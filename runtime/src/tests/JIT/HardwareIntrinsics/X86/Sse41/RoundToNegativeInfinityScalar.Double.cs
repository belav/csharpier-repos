    ...
    public sealed unsafe class SimpleBinaryOpTest__RoundToNegativeInfinityScalarDouble
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__RoundToNegativeInfinityScalarDouble testClass
            )
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Sse41)
                .GetMethod(
                    nameof(Sse41.RoundToNegativeInfinityScalar),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Sse41.RoundToNegativeInfinityScalar(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (
                ...
                != BitConverter.DoubleToInt64Bits(Math.Floor(right[0]))
            )
            {
                succeeded = false;
            }
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Sse41)}.{nameof(Sse41.RoundToNegativeInfinityScalar)}<Double>(Vector128<Double>, Vector128<Double>): {method} failed:"
                    );
