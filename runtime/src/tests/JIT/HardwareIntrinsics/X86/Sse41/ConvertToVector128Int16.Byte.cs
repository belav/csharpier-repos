...
namespace JIT.HardwareIntrinsics.X86._Sse41.handwritten
{
    ...
    {
        [Fact]
        public static void ConvertToVector128Int16Byte()
        {
    ...
    public sealed unsafe class SimpleUnaryOpTest__ConvertToVector128Int16Byte
    {
        ...
        public SimpleUnaryOpTest__ConvertToVector128Int16Byte()
        {
            ...
            _dataTable = new SimpleUnaryOpTest__DataTable<Int16, Byte>(
                _data,
        ...
        {
            var result = Sse41.ConvertToVector128Int16((Byte*)_dataTable.inArrayPtr);
        ...
        {
            var result = typeof(Sse41)
                .GetMethod(nameof(Sse41.ConvertToVector128Int16), new Type[] { typeof(Byte*) })
                .Invoke(null, new object[] { Pointer.Box(_dataTable.inArrayPtr, typeof(Byte*)) });
        ...
        public void RunReflectionScenario_Load()
        {
            var result = typeof(Sse41)
                ...
                .Invoke(null, new object[] { Sse2.LoadVector128((Byte*)(_dataTable.inArrayPtr)) });
        ...
        public void RunReflectionScenario_LoadAligned()
        {
            var result = typeof(Sse41)
                ...
                .Invoke(
                    null,
                    new object[] { Sse2.LoadAlignedVector128((Byte*)(_dataTable.inArrayPtr)) }
                );
        ...
        {
            var result = Sse41.ConvertToVector128Int16(_clsVar);
        ...
        )
        {
            ...
            {
                Console.WriteLine(
                    $"{nameof(Sse41)}.{nameof(Sse41.ConvertToVector128Int16)}<Int16>(Vector128<Byte>): {method} failed:"
                );
