    ...
    public sealed unsafe class SimpleUnaryOpTest__RoundToZeroDouble
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario_Load(SimpleUnaryOpTest__RoundToZeroDouble testClass)
            {
                ...
                {
                    var result = Sse41.RoundToZero(Sse2.LoadVector128((Double*)(pFld1)));
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = Sse41.RoundToZero(Unsafe.Read<Vector128<Double>>(_dataTable.inArray1Ptr));
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var result = Sse41.RoundToZero(Sse2.LoadVector128((Double*)(_dataTable.inArray1Ptr)));
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            {
                var result = Sse41.RoundToZero(Sse2.LoadVector128((Double*)(pClsVar1)));
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = Sse41.RoundToZero(Sse2.LoadVector128((Double*)(&test._fld1)));
