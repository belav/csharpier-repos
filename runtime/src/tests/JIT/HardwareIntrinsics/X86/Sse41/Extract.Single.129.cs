...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    public sealed unsafe class ExtractScalarTest__ExtractSingle129
    {
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = Sse41.Extract(Unsafe.Read<Vector128<Single>>(_dataTable.inArrayPtr), 129);
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var result = Sse41.Extract(Sse.LoadVector128((Single*)(_dataTable.inArrayPtr)), 129);
        ...
        public void RunReflectionScenario_Load()
        {
            ...
            var result = typeof(Sse41)
                ...
                .Invoke(
                    null,
                    new object[] { Sse.LoadVector128((Single*)(_dataTable.inArrayPtr)), (byte)129 }
                );
