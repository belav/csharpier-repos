...
namespace JIT.HardwareIntrinsics.X86._AvxVnni
{
    ...
    {
        [Fact]
        public static void MultiplyWideningAndAddInt16()
        {
    ...
    public sealed unsafe class SimpleTernaryOpTest__MultiplyWideningAndAddInt16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleTernaryOpTest__MultiplyWideningAndAddInt16 testClass
            )
            {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = AvxVnni.MultiplyWideningAndAdd(_clsVar0, _clsVar1, _clsVar2);
        ...
        )
        {
            ...
            {
                outArray[i] = Math.Clamp(
                    (addend[i] + (right[i * 2 + 1] * left[i * 2 + 1] + right[i * 2] * left[i * 2])),
                    int.MinValue,
                    int.MaxValue
                );
            }
