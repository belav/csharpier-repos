    ...
    public sealed unsafe class SimpleBinaryOpTest__MultiplyAddAdjacentInt16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario_Load(
                SimpleBinaryOpTest__MultiplyAddAdjacentInt16 testClass
            )
            {
                fixed (Vector256<Byte>* pFld1 = &_fld1)fixed (Vector256<SByte>* pFld2 = &_fld2)
                {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Avx2).GetMethod(
                    ...
                    new Type[] { typeof(Vector256<Byte>), typeof(Vector256<SByte>) }
                )
                .Invoke(
                    null,
                    new object[]
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(Avx2)}.{nameof(Avx2.MultiplyAddAdjacent)}<Int16>(Vector256<Byte>, Vector256<SByte>): {method} failed:"
                );
