...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    public sealed unsafe class SimpleTernaryOpTest__BlendVariableUInt32
    {
        ...
        private struct TestStruct
        {
            ...
            {
                fixed (Vector256<UInt32>* pFld1 = &_fld1)fixed (
                    Vector256<UInt32>* pFld2 = &_fld2
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(Avx2)}.{nameof(Avx2.BlendVariable)}<UInt32>(Vector256<UInt32>, Vector256<UInt32>, Vector256<UInt32>): {method} failed:"
                );
                TestLibrary.TestFramework.LogInformation(
