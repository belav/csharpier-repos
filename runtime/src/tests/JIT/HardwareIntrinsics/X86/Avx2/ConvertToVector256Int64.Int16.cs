...
namespace JIT.HardwareIntrinsics.X86._Avx2.handwritten
{
    ...
    {
        [Fact]
        public static void ConvertToVector256Int64Int16()
        {
    ...
    public sealed unsafe class SimpleUnaryOpTest__ConvertToVector256Int64Int16
    {
        ...
        {
            var result = Avx2.ConvertToVector256Int64((Int16*)(_dataTable.inArrayPtr));
        ...
        {
            var result = typeof(Avx2)
                .GetMethod(nameof(Avx2.ConvertToVector256Int64), new Type[] { typeof(Int16*) })
        ...
        )
        {
            ...
            {
                Console.WriteLine(
                    $"{nameof(Avx2)}.{nameof(Avx2.ConvertToVector256Int64)}<Int64>(Vector128<Int16>): {method} failed:"
                );
