...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    public sealed unsafe class SimpleBinaryOpTest__XorInt64
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario_Load(SimpleBinaryOpTest__XorInt64 testClass)
            {
                fixed (Vector256<Int64>* pFld1 = &_fld1)fixed (Vector256<Int64>* pFld2 = &_fld2)
                {
                    var result = Avx2.Xor(
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Avx2).GetMethod(
                    nameof(Avx2.Xor),
                    new Type[] { typeof(Vector256<Int64>), typeof(Vector256<Int64>) }
                )
                .Invoke(
                    null,
                    new object[]
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            fixed (Vector256<Int64>* pClsVar1 = &_clsVar1)fixed (
        ...
        public void RunClassLclFldScenario_Load()
        {
            ...
            fixed (Vector256<Int64>* pFld1 = &test._fld1)fixed (
        ...
        private void ValidateResult(
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(Avx2)}.{nameof(Avx2.Xor)}<Int64>(Vector256<Int64>, Vector256<Int64>): {method} failed:"
                );
