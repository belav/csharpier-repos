    ...
    public sealed unsafe class SimpleBinaryOpTest__PackUnsignedSaturateByte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario_Load(
                SimpleBinaryOpTest__PackUnsignedSaturateByte testClass
            ) {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Avx2).GetMethod(
                    nameof(Avx2.PackUnsignedSaturate),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Avx2.PackUnsignedSaturate(_clsVar1, _clsVar2);
        ...
        private void ValidateResult(
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(Avx2)}.{nameof(Avx2.PackUnsignedSaturate)}<Byte>(Vector256<Int16>, Vector256<Int16>): {method} failed:"
                );
