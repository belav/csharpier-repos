...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    public sealed unsafe class ImmUnaryOpTest__ShuffleHighInt16228
    {
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var result = Avx2.ShuffleHigh(Avx.LoadVector256((Int16*)(_dataTable.inArrayPtr)), 228);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Avx2)}.{nameof(Avx2.ShuffleHigh)}<Int16>(Vector256<Int16><9>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
