        ...
        static unsafe int Main(string[] args)
        {
            ...
            if (Avx2.IsSupported)
            {
                ...
                )
                {
                    ...
                    if (
                        (shortTable.inArray1[1] + shortTable.inArray1[0] != shortTable.outArray[0])
                        || (
                            shortTable.inArray1[3] + shortTable.inArray1[2]
                            != shortTable.outArray[1]
                        )
                        || (
                            shortTable.inArray1[5] + shortTable.inArray1[4]
                            != shortTable.outArray[2]
                        )
                        || (
                            shortTable.inArray1[7] + shortTable.inArray1[6]
                            != shortTable.outArray[3]
                        )
                        || (
                            shortTable.inArray2[1] + shortTable.inArray2[0]
                            != shortTable.outArray[4]
                        )
                        || (
                            shortTable.inArray2[3] + shortTable.inArray2[2]
                            != shortTable.outArray[5]
                        )
                        || (
                            shortTable.inArray2[5] + shortTable.inArray2[4]
                            != shortTable.outArray[6]
                        )
                        || (
                            shortTable.inArray2[7] + shortTable.inArray2[6]
                            != shortTable.outArray[7]
                        )
                        || (
                            shortTable.inArray1[9] + shortTable.inArray1[8]
                            != shortTable.outArray[8]
                        )
                        || (
                            shortTable.inArray1[11] + shortTable.inArray1[10]
                            != shortTable.outArray[9]
                        )
                        || (
                            shortTable.inArray1[13] + shortTable.inArray1[12]
                            != shortTable.outArray[10]
                        )
                        || (
                            shortTable.inArray1[15] + shortTable.inArray1[14]
                            != shortTable.outArray[11]
                        )
                        || (
                            shortTable.inArray2[9] + shortTable.inArray2[8]
                            != shortTable.outArray[12]
                        )
                        || (
                            shortTable.inArray2[11] + shortTable.inArray2[10]
                            != shortTable.outArray[13]
                        )
                        || (
                            shortTable.inArray2[13] + shortTable.inArray2[12]
                    ...
                    if (
                        (intTable.inArray1[1] + intTable.inArray1[0] != intTable.outArray[0])
