    ...
    public sealed unsafe class ImmUnaryOpTest__ShiftLeftLogicalUInt3232
    {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Avx2)
                ...
                .Invoke(
                    null,
                    new object[] { Unsafe.Read<Vector256<UInt32>>(_dataTable.inArrayPtr), (byte)32 }
                );
        ...
        public void RunReflectionScenario_Load()
        {
            ...
            var result = typeof(Avx2)
                ...
                .Invoke(
                    null,
                    new object[] { Avx.LoadVector256((UInt32*)(_dataTable.inArrayPtr)), (byte)32 }
                );
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Avx2)}.{nameof(Avx2.ShiftLeftLogical)}<UInt32>(Vector256<UInt32><9>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
