    ...
    public sealed unsafe class SimpleUnaryOpTest__BroadcastScalarToVector128Int64
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__BroadcastScalarToVector128Int64 testClass
            )
            {
        ...
        public void RunReflectionScenario_Load()
        {
            ...
            var result = typeof(Avx2)
                ...
                .Invoke(
                    null,
                    new object[] { Sse2.LoadVector128((Int64*)(_dataTable.inArray1Ptr)) }
                );
        ...
        public void RunReflectionScenario_LoadAligned()
        {
            ...
            var result = typeof(Avx2)
                ...
                .Invoke(
                    null,
                    new object[] { Sse2.LoadAlignedVector128((Int64*)(_dataTable.inArray1Ptr)) }
                );
        ...
        public void RunClassLclFldScenario_Load()
        {
            ...
            {
                var result = Avx2.BroadcastScalarToVector128(Sse2.LoadVector128((Int64*)(pFld1)));
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = Avx2.BroadcastScalarToVector128(Sse2.LoadVector128((Int64*)(&test._fld1)));
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Avx2)}.{nameof(Avx2.BroadcastScalarToVector128)}<Int64>(Vector128<Int64>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
