...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    public sealed unsafe class ImmUnaryOpTest__ShuffleLowInt16228
    {
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = Avx2.ShuffleLow(Unsafe.Read<Vector256<Int16>>(_dataTable.inArrayPtr), 228);
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var result = Avx2.ShuffleLow(Avx.LoadVector256((Int16*)(_dataTable.inArrayPtr)), 228);
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Avx2)
                ...
                .Invoke(
                    null,
                    new object[] { Unsafe.Read<Vector256<Int16>>(_dataTable.inArrayPtr), (byte)228 }
                );
        ...
        public void RunReflectionScenario_Load()
        {
            ...
            var result = typeof(Avx2)
                ...
                .Invoke(
                    null,
                    new object[] { Avx.LoadVector256((Int16*)(_dataTable.inArrayPtr)), (byte)228 }
                );
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Avx2)}.{nameof(Avx2.ShuffleLow)}<Int16>(Vector256<Int16><9>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
