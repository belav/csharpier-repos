...
namespace JIT.HardwareIntrinsics.X86._Avx2.handwritten
{
    ...
    {
        [Fact]
        public static void ConvertToVector256Int32Int16()
        {
    ...
    public sealed unsafe class SimpleUnaryOpTest__ConvertToVector256Int32Int16
    {
        ...
        public SimpleUnaryOpTest__ConvertToVector256Int32Int16()
        {
            ...
            _dataTable = new SimpleUnaryOpTest__DataTable<Int32, Int16>(
                _data,
        ...
        {
            var result = Avx2.ConvertToVector256Int32((Int16*)(_dataTable.inArrayPtr));
        ...
        {
            var result = typeof(Avx2)
                .GetMethod(nameof(Avx2.ConvertToVector256Int32), new Type[] { typeof(Int16*) })
        ...
        )
        {
            ...
            {
                Console.WriteLine(
                    $"{nameof(Avx2)}.{nameof(Avx2.ConvertToVector256Int32)}<Int32>(Vector128<Int16>): {method} failed:"
                );
