...
namespace JIT.HardwareIntrinsics.X86
{
    public static partial class Program
    {
        ...
        {
            var test = new InsertVector128Test__InsertVector128Int321();
    ...
    public sealed unsafe class InsertVector128Test__InsertVector128Int321
    {
        private struct TestStruct
        {
            ...
            public static TestStruct Create()
            {
                ...
                Unsafe.CopyBlockUnaligned(
                    ref Unsafe.As<Vector256<Int32>, byte>(ref testStruct._fld1),
            ...
            public void RunStructFldScenario(InsertVector128Test__InsertVector128Int321 testClass)
            {
        ...
        static InsertVector128Test__InsertVector128Int321()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetInt32();
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector256<Int32>, byte>(ref _clsVar1),
                ref Unsafe.As<Int32, byte>(ref _data1[0]),
                (uint)Unsafe.SizeOf<Vector256<Int32>>()
            );
            for (var i = 0; i < Op2ElementCount; i++)
        ...
        public InsertVector128Test__InsertVector128Int321()
        {
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector256<Int32>, byte>(ref _fld1),
                ref Unsafe.As<Int32, byte>(ref _data1[0]),
                (uint)Unsafe.SizeOf<Vector256<Int32>>()
            );
            for (var i = 0; i < Op2ElementCount; i++)
            ...
            _dataTable = new SimpleBinaryOpTest__DataTable<Int32, Int32, Int32>(
                _data1,
                _data2,
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Avx2)
                .GetMethod(
                    nameof(Avx2.InsertVector128),
                    new Type[] { typeof(Vector256<Int32>), typeof(Vector128<Int32>), typeof(byte) }
                )
                .Invoke(
                    null,
                    new object[]
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Avx2.InsertVector128(_clsVar1, _clsVar2, 1);
        ...
        private void ValidateResult(
            Vector256<Int32> left,
            Vector128<Int32> right,
            void* result,
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Avx2)}.{nameof(Avx2.InsertVector128)}<Int32>(Vector256<Int32>, Vector128<Int32>.1): {method} failed:"
                    );
