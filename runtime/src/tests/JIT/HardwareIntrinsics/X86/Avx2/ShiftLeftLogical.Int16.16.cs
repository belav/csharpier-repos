    ...
    public sealed unsafe class ImmUnaryOpTest__ShiftLeftLogicalInt1616
    {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Avx2)
                .GetMethod(
                    nameof(Avx2.ShiftLeftLogical),
                    new Type[] { typeof(Vector256<Int16>), typeof(byte) }
                )
                .Invoke(
                    null,
                    new object[] { Unsafe.Read<Vector256<Int16>>(_dataTable.inArrayPtr), (byte)16 }
                );
        ...
        public void RunReflectionScenario_Load()
        {
            ...
            var result = typeof(Avx2)
                ...
                .Invoke(
                    null,
                    new object[] { Avx.LoadVector256((Int16*)(_dataTable.inArrayPtr)), (byte)16 }
                );
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Avx2.ShiftLeftLogical(_clsVar, 16);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Avx2)}.{nameof(Avx2.ShiftLeftLogical)}<Int16>(Vector256<Int16><9>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
