    ...
    public sealed unsafe class SimpleBinaryOpTest__PackSignedSaturateInt16
    {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Avx2)
                .GetMethod(
                    nameof(Avx2.PackSignedSaturate),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Avx2.PackSignedSaturate(_clsVar1, _clsVar2);
        ...
        )
        {
                        ...
                        != (
                            i < 4
                                ...
                                : (
                                    i < 8 && i > 3
                                        ? (short)
                                            Math.Clamp(right[i % 4], short.MinValue, short.MaxValue)
                                        : (
                                            i < 12 && i > 7
                                                ? (short)
                                                    Math.Clamp(
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(Avx2)}.{nameof(Avx2.PackSignedSaturate)}<Int16>(Vector256<Int32>, Vector256<Int32>): {method} failed:"
                );
