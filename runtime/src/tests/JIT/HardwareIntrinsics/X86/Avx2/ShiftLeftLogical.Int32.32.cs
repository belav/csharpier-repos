    ...
    public sealed unsafe class ImmUnaryOpTest__ShiftLeftLogicalInt3232
    {
        private struct TestStruct
        {
            ...
            public static TestStruct Create()
            {
                ...
                Unsafe.CopyBlockUnaligned(
                    ref Unsafe.As<Vector256<Int32>, byte>(ref testStruct._fld),
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Avx2)
                .GetMethod(
                    ...
                    new Type[] { typeof(Vector256<Int32>), typeof(byte) }
                )
                .Invoke(
                    null,
                    new object[] { Unsafe.Read<Vector256<Int32>>(_dataTable.inArrayPtr), (byte)32 }
                );
        ...
        public void RunReflectionScenario_Load()
        {
            ...
            var result = typeof(Avx2)
                ...
                .Invoke(
                    null,
                    new object[] { Avx.LoadVector256((Int32*)(_dataTable.inArrayPtr)), (byte)32 }
                );
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Avx2.ShiftLeftLogical(_clsVar, 32);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Avx2)}.{nameof(Avx2.ShiftLeftLogical)}<Int32>(Vector256<Int32><9>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
