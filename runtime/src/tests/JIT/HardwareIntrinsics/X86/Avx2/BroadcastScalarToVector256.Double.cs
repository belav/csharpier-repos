    ...
    public sealed unsafe class SimpleUnaryOpTest__BroadcastScalarToVector256Double
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__BroadcastScalarToVector256Double testClass
            )
            {
        ...
        public void RunClassLclFldScenario_Load()
        {
            ...
            {
                var result = Avx2.BroadcastScalarToVector256(Sse2.LoadVector128((Double*)(pFld1)));
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Avx2)}.{nameof(Avx2.BroadcastScalarToVector256)}<Double>(Vector128<Double>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
