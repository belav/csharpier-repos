...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    public sealed unsafe class SimpleBinaryOpTest__MultiplyLowInt16
    {
        ...
        private struct TestStruct
        {
            ...
            {
                fixed (Vector256<Int16>* pFld1 = &_fld1)fixed (Vector256<Int16>* pFld2 = &_fld2)
                {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Avx2).GetMethod(
                    nameof(Avx2.MultiplyLow),
                    new Type[] { typeof(Vector256<Int16>), typeof(Vector256<Int16>) }
                )
                .Invoke(
                    null,
                    new object[]
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Avx2.MultiplyLow(_clsVar1, _clsVar2);
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            fixed (Vector256<Int16>* pClsVar1 = &_clsVar1)fixed (
                Vector256<Int16>* pClsVar2 = &_clsVar2
            ) {
                var result = Avx2.MultiplyLow(
        ...
        public void RunClassLclFldScenario_Load()
        {
            ...
            fixed (Vector256<Int16>* pFld1 = &test._fld1)fixed (
                Vector256<Int16>* pFld2 = &test._fld2
            ) {
                var result = Avx2.MultiplyLow(
                    Avx.LoadVector256((Int16*)(pFld1)),
                    Avx.LoadVector256((Int16*)(pFld2))
        ...
        private void ValidateResult(
            ...
            if (
                result[0]
                != BitConverter.ToInt16(BitConverter.GetBytes(((int)(left[0])) * right[0]), 0)
            ) {
                succeeded = false;
            }
            else
                ...
                for (var i = 1; i < RetElementCount; i++)
                {
                    if (
                        ...
                        != BitConverter.ToInt16(
                            BitConverter.GetBytes(((int)(left[i])) * right[i]),
                            0
                        )
                    ) {
                        succeeded = false;
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(Avx2)}.{nameof(Avx2.MultiplyLow)}<Int16>(Vector256<Int16>, Vector256<Int16>): {method} failed:"
                );
