...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    public sealed unsafe class SimpleTernaryOpTest__BlendVariableSByte
    {
        ...
        private struct TestStruct
        {
            ...
            {
                fixed (Vector256<SByte>* pFld1 = &_fld1)fixed (
                    Vector256<SByte>* pFld2 = &_fld2
        ...
        public void RunClassFldScenario_Load()
        {
            ...
            fixed (Vector256<SByte>* pFld1 = &_fld1)fixed (Vector256<SByte>* pFld2 = &_fld2)fixed (
                Vector256<SByte>* pFld3 = &_fld3
            )
            {
                var result = Avx2.BlendVariable(
                    Avx.LoadVector256((SByte*)(pFld1)),
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(Avx2)}.{nameof(Avx2.BlendVariable)}<SByte>(Vector256<SByte>, Vector256<SByte>, Vector256<SByte>): {method} failed:"
                );
                TestLibrary.TestFramework.LogInformation(
