    ...
    public sealed unsafe class SimpleTernaryOpTest__BlendVariableInt32
    {
        ...
        private struct TestStruct
        {
            ...
            public static TestStruct Create()
            {
                ...
                {
                    _data3[i] = (((i % 2) == 0) ? Convert.ToInt32("0xFFFFFFFF", 16) : (int)0);
                }
                Unsafe.CopyBlockUnaligned(
                    ref Unsafe.As<Vector256<Int32>, byte>(ref testStruct._fld3),
            ...
            {
                fixed (Vector256<Int32>* pFld1 = &_fld1)fixed (
                    Vector256<Int32>* pFld2 = &_fld2
        ...
        static SimpleTernaryOpTest__BlendVariableInt32()
        {
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector256<Int32>, byte>(ref _clsVar3),
                ref Unsafe.As<Int32, byte>(ref _data3[0]),
                (uint)Unsafe.SizeOf<Vector256<Int32>>()
            );
        }
        ...
        public SimpleTernaryOpTest__BlendVariableInt32()
        {
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector256<Int32>, byte>(ref _fld3),
                ref Unsafe.As<Int32, byte>(ref _data3[0]),
                (uint)Unsafe.SizeOf<Vector256<Int32>>()
            );
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Avx2.BlendVariable(_clsVar1, _clsVar2, _clsVar3);
        ...
        public void RunClassFldScenario_Load()
        {
            ...
            fixed (Vector256<Int32>* pFld1 = &_fld1)fixed (Vector256<Int32>* pFld2 = &_fld2)fixed (
                Vector256<Int32>* pFld3 = &_fld3
            )
            {
                var result = Avx2.BlendVariable(
                    Avx.LoadVector256((Int32*)(pFld1)),
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(Avx2)}.{nameof(Avx2.BlendVariable)}<Int32>(Vector256<Int32>, Vector256<Int32>, Vector256<Int32>): {method} failed:"
                );
                TestLibrary.TestFramework.LogInformation(
