    ...
    public sealed unsafe class SimpleBinaryOpTest__MultiplyHighRoundScaleInt16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__MultiplyHighRoundScaleInt16 testClass
            )
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Avx2).GetMethod(
                    nameof(Avx2.MultiplyHighRoundScale),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Avx2.MultiplyHighRoundScale(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(Avx2)}.{nameof(Avx2.MultiplyHighRoundScale)}<Int16>(Vector256<Int16>, Vector256<Int16>): {method} failed:"
                );
