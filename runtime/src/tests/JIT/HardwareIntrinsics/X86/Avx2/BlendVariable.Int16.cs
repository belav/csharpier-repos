...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    public sealed unsafe class SimpleTernaryOpTest__BlendVariableInt16
    {
        ...
        private struct TestStruct
        {
            ...
            {
                fixed (Vector256<Int16>* pFld1 = &_fld1)fixed (
                    Vector256<Int16>* pFld2 = &_fld2
        ...
        public void RunClassFldScenario_Load()
        {
            ...
            fixed (Vector256<Int16>* pFld1 = &_fld1)fixed (Vector256<Int16>* pFld2 = &_fld2)fixed (
                Vector256<Int16>* pFld3 = &_fld3
            )
            {
                var result = Avx2.BlendVariable(
                    Avx.LoadVector256((Int16*)(pFld1)),
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(Avx2)}.{nameof(Avx2.BlendVariable)}<Int16>(Vector256<Int16>, Vector256<Int16>, Vector256<Int16>): {method} failed:"
                );
                TestLibrary.TestFramework.LogInformation(
