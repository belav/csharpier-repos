        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Avx2)
                .GetMethod(
                    ...
                    new Type[] { typeof(Vector256<Int16>), typeof(Vector256<Int16>), typeof(byte) }
                )
                .Invoke(
                    null,
                    new object[]
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Avx2)}.{nameof(Avx2.AlignRight)}<Int16>(Vector256<Int16>.0, Vector256<Int16>): {method} failed:"
                    );
