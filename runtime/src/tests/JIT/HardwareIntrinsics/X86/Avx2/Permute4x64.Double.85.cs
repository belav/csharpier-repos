...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    public sealed unsafe class ImmUnaryOpTest__Permute4x64Double85
    {
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var result = Avx2.Permute4x64(Avx.LoadVector256((Double*)(_dataTable.inArrayPtr)), 85);
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Avx2)
                ...
                .Invoke(
                    null,
                    new object[] { Unsafe.Read<Vector256<Double>>(_dataTable.inArrayPtr), (byte)85 }
                );
        ...
        public void RunReflectionScenario_Load()
        {
            ...
            var result = typeof(Avx2)
                ...
                .Invoke(
                    null,
                    new object[] { Avx.LoadVector256((Double*)(_dataTable.inArrayPtr)), (byte)85 }
                );
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Avx2)}.{nameof(Avx2.Permute4x64)}<Double>(Vector256<Double><9>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
