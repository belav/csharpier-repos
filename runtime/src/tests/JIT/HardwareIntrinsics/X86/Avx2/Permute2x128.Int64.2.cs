    ...
    public sealed unsafe class ImmBinaryOpTest__Permute2x128Int642
    {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Avx2)
                .GetMethod(
                    nameof(Avx2.Permute2x128),
                    new Type[] { typeof(Vector256<Int64>), typeof(Vector256<Int64>), typeof(byte) }
                )
                .Invoke(
                    null,
                    new object[]
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Avx2.Permute2x128(_clsVar1, _clsVar2, 2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Avx2)}.{nameof(Avx2.Permute2x128)}<Int64>(Vector256<Int64>.2, Vector256<Int64>): {method} failed:"
                    );
