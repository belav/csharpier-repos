...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    public sealed unsafe class SimdScalarUnaryOpTest__ConvertToInt32Int32
    {
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = Avx2.ConvertToInt32(Unsafe.Read<Vector256<Int32>>(_dataTable.inArrayPtr));
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var result = Avx2.ConvertToInt32(Avx.LoadVector256((Int32*)(_dataTable.inArrayPtr)));
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Avx2.ConvertToInt32(_clsVar);
