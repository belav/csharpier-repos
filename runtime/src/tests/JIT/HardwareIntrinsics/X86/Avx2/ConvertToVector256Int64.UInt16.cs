...
namespace JIT.HardwareIntrinsics.X86._Avx2.handwritten
{
    ...
    {
        [Fact]
        public static void ConvertToVector256Int64UInt16()
        {
    ...
    public sealed unsafe class SimpleUnaryOpTest__ConvertToVector256Int64UInt16
    {
        ...
        public SimpleUnaryOpTest__ConvertToVector256Int64UInt16()
        {
            ...
            _dataTable = new SimpleUnaryOpTest__DataTable<UInt64, UInt16>(
                _data,
        ...
        {
            var result = Avx2.ConvertToVector256Int64((UInt16*)(_dataTable.inArrayPtr));
        ...
        {
            var result = typeof(Avx2)
                .GetMethod(nameof(Avx2.ConvertToVector256Int64), new Type[] { typeof(UInt16*) })
        ...
        )
        {
            ...
            {
                Console.WriteLine(
                    $"{nameof(Avx2)}.{nameof(Avx2.ConvertToVector256Int64)}<UInt64>(Vector128<UInt16>): {method} failed:"
                );
