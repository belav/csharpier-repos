...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    public sealed unsafe class SimpleBinaryOpTest__ShiftRightArithmeticVariableInt32
    {
        ...
        private struct TestStruct
        {
            ...
            {
                fixed (Vector256<Int32>* pFld1 = &_fld1)fixed (Vector256<UInt32>* pFld2 = &_fld2)
                {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Avx2).GetMethod(
                    ...
                    new Type[] { typeof(Vector256<Int32>), typeof(Vector256<UInt32>) }
                )
                .Invoke(
                    null,
                    new object[]
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(Avx2)}.{nameof(Avx2.ShiftRightArithmeticVariable)}<Int32>(Vector256<Int32>, Vector256<UInt32>): {method} failed:"
                );
