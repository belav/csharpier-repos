    ...
    public sealed unsafe class SimpleUnaryOpTest__BroadcastScalarToVector256SByte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__BroadcastScalarToVector256SByte testClass
            )
            {
        ...
        public void RunClassLclFldScenario_Load()
        {
            ...
            {
                var result = Avx2.BroadcastScalarToVector256(Sse2.LoadVector128((SByte*)(pFld1)));
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = Avx2.BroadcastScalarToVector256(Sse2.LoadVector128((SByte*)(&test._fld1)));
