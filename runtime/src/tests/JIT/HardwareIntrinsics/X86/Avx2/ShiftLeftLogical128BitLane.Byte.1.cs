...
namespace JIT.HardwareIntrinsics.X86
{
    public static partial class Program
    {
        ...
        {
            var test = new ImmUnaryOpTest__ShiftLeftLogical128BitLaneByte1();
    ...
    public sealed unsafe class ImmUnaryOpTest__ShiftLeftLogical128BitLaneByte1
    {
        private struct TestStruct
        {
            ...
            public static TestStruct Create()
            {
                ...
                Unsafe.CopyBlockUnaligned(
                    ref Unsafe.As<Vector256<Byte>, byte>(ref testStruct._fld),
            ...
            public void RunStructFldScenario(
                ImmUnaryOpTest__ShiftLeftLogical128BitLaneByte1 testClass
            )
            {
        ...
        static ImmUnaryOpTest__ShiftLeftLogical128BitLaneByte1()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data[i] = (byte)8;
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector256<Byte>, byte>(ref _clsVar),
                ref Unsafe.As<Byte, byte>(ref _data[0]),
                (uint)Unsafe.SizeOf<Vector256<Byte>>()
            );
        }

        public ImmUnaryOpTest__ShiftLeftLogical128BitLaneByte1()
        {
            Succeeded = true;
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector256<Byte>, byte>(ref _fld),
                ref Unsafe.As<Byte, byte>(ref _data[0]),
                (uint)Unsafe.SizeOf<Vector256<Byte>>()
            );
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Avx2)
                .GetMethod(
                    nameof(Avx2.ShiftLeftLogical128BitLane),
                    new Type[] { typeof(Vector256<Byte>), typeof(byte) }
                )
                .Invoke(
                    null,
                    new object[] { Unsafe.Read<Vector256<Byte>>(_dataTable.inArrayPtr), (byte)1 }
                );
        ...
        public void RunReflectionScenario_Load()
        {
            ...
            var result = typeof(Avx2)
                ...
                .Invoke(
                    null,
                    new object[] { Avx.LoadVector256((Byte*)(_dataTable.inArrayPtr)), (byte)1 }
                );
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Avx2.ShiftLeftLogical128BitLane(_clsVar, 1);
        ...
        )
        {
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Byte, byte>(ref inArray[0]),
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Avx2)}.{nameof(Avx2.ShiftLeftLogical128BitLane)}<Byte>(Vector256<Byte><9>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
