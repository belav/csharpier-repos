    ...
    public sealed unsafe class SimpleTernaryOpTest__BlendVariableInt64
    {
        ...
        private struct TestStruct
        {
            ...
            public static TestStruct Create()
            {
                ...
                {
                    _data3[i] = (
                        ((i % 2) == 0) ? Convert.ToInt64("0xFFFFFFFFFFFFFFFF", 16) : (long)0
                    );
                }
                Unsafe.CopyBlockUnaligned(
            ...
            {
                fixed (Vector256<Int64>* pFld1 = &_fld1)fixed (
                    Vector256<Int64>* pFld2 = &_fld2
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(Avx2)}.{nameof(Avx2.BlendVariable)}<Int64>(Vector256<Int64>, Vector256<Int64>, Vector256<Int64>): {method} failed:"
                );
                TestLibrary.TestFramework.LogInformation(
