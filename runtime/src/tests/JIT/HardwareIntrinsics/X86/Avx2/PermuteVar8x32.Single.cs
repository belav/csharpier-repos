    ...
    public sealed unsafe class SimpleBinaryOpTest__PermuteVar8x32Single
    {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Avx2)
                .GetMethod(
                    nameof(Avx2.PermuteVar8x32),
                    new Type[] { typeof(Vector256<Single>), typeof(Vector256<Int32>) }
                )
                .Invoke(
                    null,
                    new object[]
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Avx2.PermuteVar8x32(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            else
            {
                ...
                {
                    if (
                        BitConverter.SingleToInt32Bits(left[(right[i] & 7)])
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Avx2)}.{nameof(Avx2.PermuteVar8x32)}<Single>(Vector256<Single>, Vector256<Int32>): {method} failed:"
                    );
