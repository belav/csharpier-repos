    ...
    public sealed unsafe class ImmUnaryOpTest__ShiftRightLogicalUInt1616
    {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Avx2)
                ...
                .Invoke(
                    null,
                    new object[] { Unsafe.Read<Vector256<UInt16>>(_dataTable.inArrayPtr), (byte)16 }
                );
        ...
        public void RunReflectionScenario_Load()
        {
            ...
            var result = typeof(Avx2)
                ...
                .Invoke(
                    null,
                    new object[] { Avx.LoadVector256((UInt16*)(_dataTable.inArrayPtr)), (byte)16 }
                );
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Avx2.ShiftRightLogical(_clsVar, 16);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Avx2)}.{nameof(Avx2.ShiftRightLogical)}<UInt16>(Vector256<UInt16><9>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
