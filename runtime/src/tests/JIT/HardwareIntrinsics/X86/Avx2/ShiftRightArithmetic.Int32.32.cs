    ...
    public sealed unsafe class ImmUnaryOpTest__ShiftRightArithmeticInt3232
    {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Avx2)
                .GetMethod(
                    nameof(Avx2.ShiftRightArithmetic),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Avx2.ShiftRightArithmetic(_clsVar, 32);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Avx2)}.{nameof(Avx2.ShiftRightArithmetic)}<Int32>(Vector256<Int32><9>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
