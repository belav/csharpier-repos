...
namespace JIT.HardwareIntrinsics.X86._Avx2.handwritten
{
    ...
    {
        [Fact]
        public static void ConvertToVector256Int64Byte()
        {
    ...
    public sealed unsafe class SimpleUnaryOpTest__ConvertToVector256Int64Byte
    {
        ...
        {
            var result = Avx2.ConvertToVector256Int64((Byte*)(_dataTable.inArrayPtr));
        ...
        {
            var result = typeof(Avx2)
                .GetMethod(nameof(Avx2.ConvertToVector256Int64), new Type[] { typeof(Byte*) })
        ...
        )
        {
            ...
            {
                Console.WriteLine(
                    $"{nameof(Avx2)}.{nameof(Avx2.ConvertToVector256Int64)}<UInt64>(Vector128<Byte>): {method} failed:"
                );
