    ...
    public sealed unsafe class SimpleUnaryOpTest__BroadcastScalarToVector128Byte
    {
        ...
        public void RunReflectionScenario_Load()
        {
            ...
            var result = typeof(Avx2)
                ...
                .Invoke(null, new object[] { Sse2.LoadVector128((Byte*)(_dataTable.inArray1Ptr)) });
        ...
        public void RunReflectionScenario_LoadAligned()
        {
            ...
            var result = typeof(Avx2)
                ...
                .Invoke(
                    null,
                    new object[] { Sse2.LoadAlignedVector128((Byte*)(_dataTable.inArray1Ptr)) }
                );
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            {
                var result = Avx2.BroadcastScalarToVector128(Sse2.LoadVector128((Byte*)(pClsVar1)));
        ...
        public void RunClassLclFldScenario_Load()
        {
            ...
            {
                var result = Avx2.BroadcastScalarToVector128(Sse2.LoadVector128((Byte*)(pFld1)));
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = Avx2.BroadcastScalarToVector128(Sse2.LoadVector128((Byte*)(&test._fld1)));
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Avx2)}.{nameof(Avx2.BroadcastScalarToVector128)}<Byte>(Vector128<Byte>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
