...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    public sealed unsafe class ImmUnaryOpTest__ShuffleUInt321
    {
        private struct TestStruct
        {
            ...
            public static TestStruct Create()
            {
                ...
                Unsafe.CopyBlockUnaligned(
                    ref Unsafe.As<Vector256<UInt32>, byte>(ref testStruct._fld),
        ...
        static ImmUnaryOpTest__ShuffleUInt321()
        {
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector256<UInt32>, byte>(ref _clsVar),
                ref Unsafe.As<UInt32, byte>(ref _data[0]),
                (uint)Unsafe.SizeOf<Vector256<UInt32>>()
            );
        }
        ...
        public ImmUnaryOpTest__ShuffleUInt321()
        {
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector256<UInt32>, byte>(ref _fld),
                ref Unsafe.As<UInt32, byte>(ref _data[0]),
                (uint)Unsafe.SizeOf<Vector256<UInt32>>()
            );
            ...
            _dataTable = new SimpleUnaryOpTest__DataTable<UInt32, UInt32>(
                _data,
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = Avx2.Shuffle(Unsafe.Read<Vector256<UInt32>>(_dataTable.inArrayPtr), 1);
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var result = Avx2.Shuffle(Avx.LoadVector256((UInt32*)(_dataTable.inArrayPtr)), 1);
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Avx2)
                .GetMethod(
                    nameof(Avx2.Shuffle),
                    new Type[] { typeof(Vector256<UInt32>), typeof(byte) }
                )
                .Invoke(
                    null,
                    new object[] { Unsafe.Read<Vector256<UInt32>>(_dataTable.inArrayPtr), (byte)1 }
                );
        ...
        public void RunReflectionScenario_Load()
        {
            ...
            var result = typeof(Avx2)
                ...
                .Invoke(
                    null,
                    new object[] { Avx.LoadVector256((UInt32*)(_dataTable.inArrayPtr)), (byte)1 }
                );
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Avx2.Shuffle(_clsVar, 1);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Avx2)}.{nameof(Avx2.Shuffle)}<UInt32>(Vector256<UInt32><9>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
