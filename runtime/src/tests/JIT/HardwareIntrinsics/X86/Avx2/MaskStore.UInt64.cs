...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    public sealed unsafe class StoreBinaryOpTest__MaskStoreUInt64
    {
        ...
        public void RunClsVarScenario()
        {
            ...
            Avx2.MaskStore((UInt64*)_dataTable.outArrayPtr, _clsVar1, _clsVar2);
        ...
        private void ValidateResult(
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(Avx2)}.{nameof(Avx2.MaskStore)}<UInt64>(Vector256<UInt64>, Vector256<UInt64>): {method} failed:"
                );
