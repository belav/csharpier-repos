...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    public sealed unsafe class ImmUnaryOpTest__ShuffleLowUInt16228
    {
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var result = Avx2.ShuffleLow(Avx.LoadVector256((UInt16*)(_dataTable.inArrayPtr)), 228);
        ...
        public void RunReflectionScenario_Load()
        {
            ...
            var result = typeof(Avx2)
                ...
                .Invoke(
                    null,
                    new object[] { Avx.LoadVector256((UInt16*)(_dataTable.inArrayPtr)), (byte)228 }
                );
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Avx2.ShuffleLow(_clsVar, 228);
