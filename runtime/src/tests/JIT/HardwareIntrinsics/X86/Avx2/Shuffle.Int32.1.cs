...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    public sealed unsafe class ImmUnaryOpTest__ShuffleInt321
    {
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = Avx2.Shuffle(Unsafe.Read<Vector256<Int32>>(_dataTable.inArrayPtr), 1);
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var result = Avx2.Shuffle(Avx.LoadVector256((Int32*)(_dataTable.inArrayPtr)), 1);
        ...
        public void RunBasicScenario_LoadAligned()
        {
            ...
            var result = Avx2.Shuffle(Avx.LoadAlignedVector256((Int32*)(_dataTable.inArrayPtr)), 1);
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Avx2)
                ...
                .Invoke(
                    null,
                    new object[] { Unsafe.Read<Vector256<Int32>>(_dataTable.inArrayPtr), (byte)1 }
                );
        ...
        public void RunReflectionScenario_Load()
        {
            ...
            var result = typeof(Avx2)
                ...
                .Invoke(
                    null,
                    new object[] { Avx.LoadVector256((Int32*)(_dataTable.inArrayPtr)), (byte)1 }
                );
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Avx2)}.{nameof(Avx2.Shuffle)}<Int32>(Vector256<Int32><9>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
