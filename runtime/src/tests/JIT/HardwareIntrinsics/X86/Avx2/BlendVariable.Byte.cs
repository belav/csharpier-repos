...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    public sealed unsafe class SimpleTernaryOpTest__BlendVariableByte
    {
        ...
        private struct TestStruct
        {
            ...
            {
                fixed (Vector256<Byte>* pFld1 = &_fld1)fixed (
                    Vector256<Byte>* pFld2 = &_fld2
        ...
        public void RunClassLclFldScenario_Load()
        {
            ...
            fixed (Vector256<Byte>* pFld1 = &test._fld1)fixed (
                Vector256<Byte>* pFld2 = &test._fld2
        ...
        public void RunClassFldScenario_Load()
        {
            ...
            fixed (Vector256<Byte>* pFld1 = &_fld1)fixed (Vector256<Byte>* pFld2 = &_fld2)fixed (
                Vector256<Byte>* pFld3 = &_fld3
            )
            {
                var result = Avx2.BlendVariable(
                    Avx.LoadVector256((Byte*)(pFld1)),
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(Avx2)}.{nameof(Avx2.BlendVariable)}<Byte>(Vector256<Byte>, Vector256<Byte>, Vector256<Byte>): {method} failed:"
                );
                TestLibrary.TestFramework.LogInformation(
