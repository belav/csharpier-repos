    ...
    public sealed unsafe class SimpleUnaryOpTest__BroadcastScalarToVector128Double
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__BroadcastScalarToVector128Double testClass
            )
            {
        ...
        public void RunClassLclFldScenario_Load()
        {
            ...
            {
                var result = Avx2.BroadcastScalarToVector128(Sse2.LoadVector128((Double*)(pFld1)));
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Avx2)}.{nameof(Avx2.BroadcastScalarToVector128)}<Double>(Vector128<Double>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
