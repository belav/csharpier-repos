    ...
    public sealed unsafe class SimpleBinaryOpTest__MultiplyAddAdjacentInt32
    {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Avx2)
                .GetMethod(
                    nameof(Avx2.MultiplyAddAdjacent),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Avx2.MultiplyAddAdjacent(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Avx2)}.{nameof(Avx2.MultiplyAddAdjacent)}<Int32>(Vector256<Int16>, Vector256<Int16>): {method} failed:"
                    );
