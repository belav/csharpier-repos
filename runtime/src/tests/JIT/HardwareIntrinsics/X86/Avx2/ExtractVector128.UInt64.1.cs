...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    public sealed unsafe class ExtractVector128Test__ExtractVector128UInt641
    {
        private struct TestStruct
        {
            ...
            public static TestStruct Create()
            {
                ...
                Unsafe.CopyBlockUnaligned(
                    ref Unsafe.As<Vector256<UInt64>, byte>(ref testStruct._fld),
            ...
            public void RunStructFldScenario(
                ExtractVector128Test__ExtractVector128UInt641 testClass
            )
            {
        ...
        static ExtractVector128Test__ExtractVector128UInt641()
        {
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector256<UInt64>, byte>(ref _clsVar),
                ref Unsafe.As<UInt64, byte>(ref _data[0]),
                (uint)Unsafe.SizeOf<Vector256<UInt64>>()
            );
        }
        ...
        public ExtractVector128Test__ExtractVector128UInt641()
        {
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector256<UInt64>, byte>(ref _fld),
                ref Unsafe.As<UInt64, byte>(ref _data[0]),
                (uint)Unsafe.SizeOf<Vector256<UInt64>>()
            );
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Avx2)
                .GetMethod(
                    nameof(Avx2.ExtractVector128),
                    new Type[] { typeof(Vector256<UInt64>), typeof(byte) }
                )
                .Invoke(
                    null,
                    new object[] { Unsafe.Read<Vector256<UInt64>>(_dataTable.inArrayPtr), (byte)1 }
                );
        ...
        public void RunReflectionScenario_Load()
        {
            ...
            var result = typeof(Avx2)
                ...
                .Invoke(
                    null,
                    new object[] { Avx.LoadVector256((UInt64*)(_dataTable.inArrayPtr)), (byte)1 }
                );
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Avx2.ExtractVector128(_clsVar, 1);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Avx2)}.{nameof(Avx2.ExtractVector128)}<UInt64>(Vector256<UInt64><9>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
