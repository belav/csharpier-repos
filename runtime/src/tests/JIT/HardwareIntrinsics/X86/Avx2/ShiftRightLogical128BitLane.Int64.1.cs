...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    public sealed unsafe class ImmUnaryOpTest__ShiftRightLogical128BitLaneInt641
    {
        private struct TestStruct
        {
            ...
            public static TestStruct Create()
            {
                ...
                Unsafe.CopyBlockUnaligned(
                    ref Unsafe.As<Vector256<Int64>, byte>(ref testStruct._fld),
            ...
            public void RunStructFldScenario(
                ImmUnaryOpTest__ShiftRightLogical128BitLaneInt641 testClass
            )
            {
        ...
        static ImmUnaryOpTest__ShiftRightLogical128BitLaneInt641()
        {
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector256<Int64>, byte>(ref _clsVar),
                ref Unsafe.As<Int64, byte>(ref _data[0]),
                (uint)Unsafe.SizeOf<Vector256<Int64>>()
            );
        }
        ...
        public ImmUnaryOpTest__ShiftRightLogical128BitLaneInt641()
        {
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector256<Int64>, byte>(ref _fld),
                ref Unsafe.As<Int64, byte>(ref _data[0]),
                (uint)Unsafe.SizeOf<Vector256<Int64>>()
            );
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Avx2)
                .GetMethod(
                    ...
                    new Type[] { typeof(Vector256<Int64>), typeof(byte) }
                )
                .Invoke(
                    null,
                    new object[] { Unsafe.Read<Vector256<Int64>>(_dataTable.inArrayPtr), (byte)1 }
                );
        ...
        public void RunReflectionScenario_Load()
        {
            ...
            var result = typeof(Avx2)
                ...
                .Invoke(
                    null,
                    new object[] { Avx.LoadVector256((Int64*)(_dataTable.inArrayPtr)), (byte)1 }
                );
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Avx2)}.{nameof(Avx2.ShiftRightLogical128BitLane)}<Int64>(Vector256<Int64><9>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
