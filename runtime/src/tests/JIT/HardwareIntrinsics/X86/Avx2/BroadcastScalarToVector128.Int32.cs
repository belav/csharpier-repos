    ...
    public sealed unsafe class SimpleUnaryOpTest__BroadcastScalarToVector128Int32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__BroadcastScalarToVector128Int32 testClass
            )
            {
        ...
        public void RunReflectionScenario_Load()
        {
            ...
            var result = typeof(Avx2)
                ...
                .Invoke(
                    null,
                    new object[] { Sse2.LoadVector128((Int32*)(_dataTable.inArray1Ptr)) }
                );
        ...
        public void RunReflectionScenario_LoadAligned()
        {
            ...
            var result = typeof(Avx2)
                ...
                .Invoke(
                    null,
                    new object[] { Sse2.LoadAlignedVector128((Int32*)(_dataTable.inArray1Ptr)) }
                );
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Avx2.BroadcastScalarToVector128(_clsVar1);
        ...
        public void RunClassLclFldScenario_Load()
        {
            ...
            {
                var result = Avx2.BroadcastScalarToVector128(Sse2.LoadVector128((Int32*)(pFld1)));
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = Avx2.BroadcastScalarToVector128(Sse2.LoadVector128((Int32*)(&test._fld1)));
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Avx2)}.{nameof(Avx2.BroadcastScalarToVector128)}<Int32>(Vector128<Int32>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
