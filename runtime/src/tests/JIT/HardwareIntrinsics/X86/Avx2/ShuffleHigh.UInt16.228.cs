...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    public sealed unsafe class ImmUnaryOpTest__ShuffleHighUInt16228
    {
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var result = Avx2.ShuffleHigh(Avx.LoadVector256((UInt16*)(_dataTable.inArrayPtr)), 228);
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Avx2.ShuffleHigh(_clsVar, 228);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Avx2)}.{nameof(Avx2.ShuffleHigh)}<UInt16>(Vector256<UInt16><9>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
