...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    public sealed unsafe class ImmUnaryOpTest__ShiftRightLogicalUInt641
    {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Avx2.ShiftRightLogical(_clsVar, 1);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Avx2)}.{nameof(Avx2.ShiftRightLogical)}<UInt64>(Vector256<UInt64><9>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
