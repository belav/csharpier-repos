...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    {
        private static void BlendInt1685()
        {
            var test = new ImmBinaryOpTest__BlendInt1685();
    ...
    public sealed unsafe class ImmBinaryOpTest__BlendInt1685
    {
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(ImmBinaryOpTest__BlendInt1685 testClass)
            {
        ...
        static ImmBinaryOpTest__BlendInt1685()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetInt16();
        ...
        public ImmBinaryOpTest__BlendInt1685()
        {
            Succeeded = true;
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Avx2)}.{nameof(Avx2.Blend)}<Int16>(Vector256<Int16>.85, Vector256<Int16>): {method} failed:"
                    );
