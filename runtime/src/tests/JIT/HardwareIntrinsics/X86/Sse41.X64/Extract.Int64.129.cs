...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    public sealed unsafe class ExtractScalarTest__ExtractInt64129
    {
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = Sse41
                .X64
                .Extract(Unsafe.Read<Vector128<Int64>>(_dataTable.inArrayPtr), 129);
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var result = Sse41
                .X64
                .Extract(Sse2.LoadVector128((Int64*)(_dataTable.inArrayPtr)), 129);
        ...
        public void RunBasicScenario_LoadAligned()
        {
            ...
            var result = Sse41
                .X64
                .Extract(Sse2.LoadAlignedVector128((Int64*)(_dataTable.inArrayPtr)), 129);
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Sse41.X64)
                ...
                .Invoke(
                    null,
                    new object[] { Unsafe.Read<Vector128<Int64>>(_dataTable.inArrayPtr), (byte)129 }
                );
        ...
        public void RunReflectionScenario_Load()
        {
            ...
            var result = typeof(Sse41.X64)
                ...
                .Invoke(
                    null,
                    new object[] { Sse2.LoadVector128((Int64*)(_dataTable.inArrayPtr)), (byte)129 }
                );
