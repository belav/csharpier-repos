...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    public sealed unsafe class ExtractScalarTest__ExtractUInt641
    {
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = Sse41
                .X64
                .Extract(Unsafe.Read<Vector128<UInt64>>(_dataTable.inArrayPtr), 1);
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var result = Sse41.X64.Extract(Sse2.LoadVector128((UInt64*)(_dataTable.inArrayPtr)), 1);
        ...
        public void RunBasicScenario_LoadAligned()
        {
            ...
            var result = Sse41
                .X64
                .Extract(Sse2.LoadAlignedVector128((UInt64*)(_dataTable.inArrayPtr)), 1);
        ...
        public void RunReflectionScenario_Load()
        {
            ...
            var result = typeof(Sse41.X64)
                ...
                .Invoke(
                    null,
                    new object[] { Sse2.LoadVector128((UInt64*)(_dataTable.inArrayPtr)), (byte)1 }
                );
