...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    public sealed unsafe class ExtractScalarTest__ExtractInt641
    {
        ...
        public ExtractScalarTest__ExtractInt641()
        {
            ...
            _dataTable = new SimpleUnaryOpTest__DataTable<Int64, Int64>(
                _data,
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = Sse41.X64.Extract(Unsafe.Read<Vector128<Int64>>(_dataTable.inArrayPtr), 1);
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var result = Sse41.X64.Extract(Sse2.LoadVector128((Int64*)(_dataTable.inArrayPtr)), 1);
        ...
        public void RunBasicScenario_LoadAligned()
        {
            ...
            var result = Sse41
                .X64
                .Extract(Sse2.LoadAlignedVector128((Int64*)(_dataTable.inArrayPtr)), 1);
        ...
        public void RunReflectionScenario_Load()
        {
            ...
            var result = typeof(Sse41.X64)
                ...
                .Invoke(
                    null,
                    new object[] { Sse2.LoadVector128((Int64*)(_dataTable.inArrayPtr)), (byte)1 }
                );
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Sse41.X64.Extract(_clsVar, 1);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Sse41.X64)}.{nameof(Sse41.X64.Extract)}<Int64>(Vector128<Int64><9>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
