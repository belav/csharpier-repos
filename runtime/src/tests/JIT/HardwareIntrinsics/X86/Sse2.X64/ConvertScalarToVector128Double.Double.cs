    ...
    public sealed unsafe class SimpleBinaryOpConvTest__ConvertScalarToVector128DoubleDouble
    {
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpConvTest__ConvertScalarToVector128DoubleDouble testClass
            )
            {
        ...
        public SimpleBinaryOpConvTest__ConvertScalarToVector128DoubleDouble()
        {
            ...
            _dataTable = new SimpleBinaryOpConvTest__DataTable<Double, Double, Int64>(
                _data1,
                _data2,
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Sse2.X64)
                .GetMethod(
                    nameof(Sse2.X64.ConvertScalarToVector128Double),
                    new Type[] { typeof(Vector128<Double>), typeof(Int64) }
                )
                .Invoke(
                    null,
                    new object[]
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Sse2.X64.ConvertScalarToVector128Double(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (!Succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Sse2.X64)}.{nameof(Sse2.X64.ConvertScalarToVector128Double)}<Double>(Vector128<Double>, Int64): {method} failed:"
                    );
