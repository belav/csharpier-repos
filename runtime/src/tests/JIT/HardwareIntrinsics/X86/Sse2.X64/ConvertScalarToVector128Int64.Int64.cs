...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    public sealed unsafe class ScalarSimdUnaryOpTest__ConvertScalarToVector128Int64Int64
    {
        ...
        public ScalarSimdUnaryOpTest__ConvertScalarToVector128Int64Int64()
        {
            ...
            _dataTable = new ScalarSimdUnaryOpTest__DataTable<Int64>(
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Sse2.X64)
                .GetMethod(
                    nameof(Sse2.X64.ConvertScalarToVector128Int64),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Sse2.X64.ConvertScalarToVector128Int64(_clsVar);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Sse2.X64)}.{nameof(Sse2.X64.ConvertScalarToVector128Int64)}<Int64>(Int64): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
