    ...
    public sealed unsafe class SimpleUnaryOpTest__AbsUInt16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario_Load(SimpleUnaryOpTest__AbsUInt16 testClass)
            {
                ...
                {
                    var result = Ssse3.Abs(Sse2.LoadVector128((Int16*)(pFld1)));
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = Ssse3.Abs(Unsafe.Read<Vector128<Int16>>(_dataTable.inArray1Ptr));
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var result = Ssse3.Abs(Sse2.LoadVector128((Int16*)(_dataTable.inArray1Ptr)));
        ...
        public void RunBasicScenario_LoadAligned()
        {
            ...
            var result = Ssse3.Abs(Sse2.LoadAlignedVector128((Int16*)(_dataTable.inArray1Ptr)));
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            {
                var result = Ssse3.Abs(Sse2.LoadVector128((Int16*)(pClsVar1)));
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = Ssse3.Abs(Sse2.LoadVector128((Int16*)(&test._fld1)));
