    ...
    public sealed unsafe class HorizontalBinaryOpTest__HorizontalSubtractInt32
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                HorizontalBinaryOpTest__HorizontalSubtractInt32 testClass
            )
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Ssse3)
                .GetMethod(
                    nameof(Ssse3.HorizontalSubtract),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Ssse3.HorizontalSubtract(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Ssse3)}.{nameof(Ssse3.HorizontalSubtract)}<Int32>(Vector128<Int32>, Vector128<Int32>): {method} failed:"
                    );
