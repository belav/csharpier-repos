    ...
    public sealed unsafe class HorizontalBinaryOpTest__HorizontalSubtractInt16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                HorizontalBinaryOpTest__HorizontalSubtractInt16 testClass
            )
            {
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Ssse3)}.{nameof(Ssse3.HorizontalSubtract)}<Int16>(Vector128<Int16>, Vector128<Int16>): {method} failed:"
                    );
