    ...
    public sealed unsafe class SimpleUnaryOpTest__AbsByte
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario_Load(SimpleUnaryOpTest__AbsByte testClass)
            {
                ...
                {
                    var result = Ssse3.Abs(Sse2.LoadVector128((SByte*)(pFld1)));
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = Ssse3.Abs(Unsafe.Read<Vector128<SByte>>(_dataTable.inArray1Ptr));
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var result = Ssse3.Abs(Sse2.LoadVector128((SByte*)(_dataTable.inArray1Ptr)));
        ...
        public void RunBasicScenario_LoadAligned()
        {
            ...
            var result = Ssse3.Abs(Sse2.LoadAlignedVector128((SByte*)(_dataTable.inArray1Ptr)));
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            {
                var result = Ssse3.Abs(Sse2.LoadVector128((SByte*)(pClsVar1)));
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = Ssse3.Abs(Sse2.LoadVector128((SByte*)(&test._fld1)));
