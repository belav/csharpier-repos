    ...
    public sealed unsafe class HorizontalBinaryOpTest__HorizontalAddInt16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario_Load(
                HorizontalBinaryOpTest__HorizontalAddInt16 testClass
            )
            {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Ssse3.HorizontalAdd(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Ssse3)}.{nameof(Ssse3.HorizontalAdd)}<Int16>(Vector128<Int16>, Vector128<Int16>): {method} failed:"
                    );
