    ...
    public sealed unsafe class SimpleBinaryOpTest__MultiplyHighRoundScaleInt16
    {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Ssse3)
                .GetMethod(
                    nameof(Ssse3.MultiplyHighRoundScale),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Ssse3.MultiplyHighRoundScale(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Ssse3)}.{nameof(Ssse3.MultiplyHighRoundScale)}<Int16>(Vector128<Int16>, Vector128<Int16>): {method} failed:"
                    );
