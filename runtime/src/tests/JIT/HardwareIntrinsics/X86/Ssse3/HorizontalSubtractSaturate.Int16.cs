    ...
    public sealed unsafe class HorizontalBinaryOpTest__HorizontalSubtractSaturateInt16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                HorizontalBinaryOpTest__HorizontalSubtractSaturateInt16 testClass
            )
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Ssse3)
                .GetMethod(
                    nameof(Ssse3.HorizontalSubtractSaturate),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Ssse3.HorizontalSubtractSaturate(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Ssse3)}.{nameof(Ssse3.HorizontalSubtractSaturate)}<Int16>(Vector128<Int16>, Vector128<Int16>): {method} failed:"
                    );
