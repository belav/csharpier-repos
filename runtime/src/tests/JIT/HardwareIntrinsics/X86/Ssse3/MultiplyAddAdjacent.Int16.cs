    ...
    public sealed unsafe class SimpleBinaryOpTest__MultiplyAddAdjacentInt16
    {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Ssse3)
                .GetMethod(
                    nameof(Ssse3.MultiplyAddAdjacent),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Ssse3.MultiplyAddAdjacent(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Ssse3)}.{nameof(Ssse3.MultiplyAddAdjacent)}<Int16>(Vector128<Byte>, Vector128<SByte>): {method} failed:"
                    );
