...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    public sealed unsafe class ImmBinaryOpTest__AlignRightInt160
    {
        ...
        public ImmBinaryOpTest__AlignRightInt160()
        {
            ...
            _dataTable = new SimpleBinaryOpTest__DataTable<Int16, Int16, Int16>(
                _data1,
                _data2,
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Ssse3.AlignRight(_clsVar1, _clsVar2, 0);
        ...
        private void ValidateResult(
            Vector128<Int16> left,
            Vector128<Int16> right,
            void* result,
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Ssse3)}.{nameof(Ssse3.AlignRight)}<Int16>(Vector128<Int16>.0, Vector128<Int16>): {method} failed:"
                    );
