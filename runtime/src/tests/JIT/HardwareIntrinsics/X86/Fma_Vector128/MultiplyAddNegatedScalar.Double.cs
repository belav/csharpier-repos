...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    {
        private static void MultiplyAddNegatedScalarDouble()
        {
    ...
    public sealed unsafe class SimpleTernaryOpTest__MultiplyAddNegatedScalarDouble
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleTernaryOpTest__MultiplyAddNegatedScalarDouble testClass
            )
            {
        ...
        public SimpleTernaryOpTest__MultiplyAddNegatedScalarDouble()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Fma)
                .GetMethod(
                    nameof(Fma.MultiplyAddNegatedScalar),
                    new Type[]
                    {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Fma.MultiplyAddNegatedScalar(_clsVar1, _clsVar2, _clsVar3);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Fma)}.{nameof(Fma.MultiplyAddNegatedScalar)}<Double>(Vector128<Double>, Vector128<Double>, Vector128<Double>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
