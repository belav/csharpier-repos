    ...
    public sealed unsafe class SimpleTernaryOpTest__MultiplySubtractNegatedScalarSingle
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleTernaryOpTest__MultiplySubtractNegatedScalarSingle testClass
            )
            {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Fma.MultiplySubtractNegatedScalar(_clsVar1, _clsVar2, _clsVar3);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Fma)}.{nameof(Fma.MultiplySubtractNegatedScalar)}<Single>(Vector128<Single>, Vector128<Single>, Vector128<Single>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
