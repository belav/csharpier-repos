    ...
    public sealed unsafe class AlternatingTernaryOpTest__MultiplyAddSubtractSingle
    {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Fma)
                .GetMethod(
                    nameof(Fma.MultiplyAddSubtract),
                    new Type[]
                    {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Fma.MultiplyAddSubtract(_clsVar1, _clsVar2, _clsVar3);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Fma)}.{nameof(Fma.MultiplyAddSubtract)}<Single>(Vector128<Single>, Vector128<Single>, Vector128<Single>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
