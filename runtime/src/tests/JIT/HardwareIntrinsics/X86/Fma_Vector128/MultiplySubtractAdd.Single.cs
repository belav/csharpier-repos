    ...
    public sealed unsafe class AlternatingTernaryOpTest__MultiplySubtractAddSingle
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                AlternatingTernaryOpTest__MultiplySubtractAddSingle testClass
            )
            {
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Fma)}.{nameof(Fma.MultiplySubtractAdd)}<Single>(Vector128<Single>, Vector128<Single>, Vector128<Single>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
