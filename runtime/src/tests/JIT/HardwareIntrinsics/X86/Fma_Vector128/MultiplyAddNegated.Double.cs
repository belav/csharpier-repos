    ...
    public sealed unsafe class SimpleTernaryOpTest__MultiplyAddNegatedDouble
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleTernaryOpTest__MultiplyAddNegatedDouble testClass
            )
            {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Fma.MultiplyAddNegated(_clsVar1, _clsVar2, _clsVar3);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Fma)}.{nameof(Fma.MultiplyAddNegated)}<Double>(Vector128<Double>, Vector128<Double>, Vector128<Double>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
