    ...
    public sealed unsafe class SimpleTernaryOpTest__MultiplySubtractDouble
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario_Load(
                SimpleTernaryOpTest__MultiplySubtractDouble testClass
            )
            {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Fma.MultiplySubtract(_clsVar1, _clsVar2, _clsVar3);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Fma)}.{nameof(Fma.MultiplySubtract)}<Double>(Vector128<Double>, Vector128<Double>, Vector128<Double>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
