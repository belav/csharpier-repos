    ...
    public sealed unsafe class SimpleUnaryOpTest__RoundToNegativeInfinityScalarDouble
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__RoundToNegativeInfinityScalarDouble testClass
            )
            {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Sse41.RoundToNegativeInfinityScalar(_clsVar1);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Sse41)}.{nameof(Sse41.RoundToNegativeInfinityScalar)}<Double>(Vector128<Double>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
