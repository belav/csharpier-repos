    ...
    public sealed unsafe class SimpleUnaryOpTest__RoundCurrentDirectionScalarDouble
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__RoundCurrentDirectionScalarDouble testClass
            )
            {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Sse41.RoundCurrentDirectionScalar(_clsVar1);
        ...
        )
        {
            ...
            if (
                ...
                != BitConverter.DoubleToInt64Bits(Math.Round(firstOp[0]))
            )
            {
                succeeded = false;
            }
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Sse41)}.{nameof(Sse41.RoundCurrentDirectionScalar)}<Double>(Vector128<Double>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
