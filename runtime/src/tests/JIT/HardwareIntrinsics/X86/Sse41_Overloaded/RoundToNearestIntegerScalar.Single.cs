    ...
    public sealed unsafe class SimpleUnaryOpTest__RoundToNearestIntegerScalarSingle
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__RoundToNearestIntegerScalarSingle testClass
            )
            {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Sse41.RoundToNearestIntegerScalar(_clsVar1);
        ...
        public void RunClassLclFldScenario_Load()
        {
            ...
            {
                var result = Sse41.RoundToNearestIntegerScalar(Sse.LoadVector128((Single*)(pFld1)));
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Sse41)}.{nameof(Sse41.RoundToNearestIntegerScalar)}<Single>(Vector128<Single>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
