...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    public sealed unsafe class SimpleUnaryOpTest__RoundCurrentDirectionScalarSingle
    {
        ...
        public void RunClassLclFldScenario_Load()
        {
            ...
            {
                var result = Sse41.RoundCurrentDirectionScalar(Sse.LoadVector128((Single*)(pFld1)));
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Sse41)}.{nameof(Sse41.RoundCurrentDirectionScalar)}<Single>(Vector128<Single>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
