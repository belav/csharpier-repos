        ...
        static int Main(string[] args)
        {
            ...
            else
            {
                try
                {
                    resl = Lzcnt.X64.LeadingZeroCount(sl);
                    Console.WriteLine(
                        "Intrinsic Lzcnt.X64.LeadingZeroCount is called on non-supported hardware."
                    );
                ...
                try
                {
                    ...
                    Console.WriteLine(
                        "Intrinsic Lzcnt.X64.LeadingZeroCount is called via reflection on non-supported hardware."
                    );
                    Console.WriteLine("Lzcnt.X64.IsSupported " + Lzcnt.X64.IsSupported);
                    testResult = Fail;
                }
