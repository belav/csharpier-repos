    ...
    public sealed unsafe class ImmUnaryOpTest__ShiftRightLogical128BitLaneUInt641
    {
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                ImmUnaryOpTest__ShiftRightLogical128BitLaneUInt641 testClass
            )
            {
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Sse2)}.{nameof(Sse2.ShiftRightLogical128BitLane)}<UInt64>(Vector128<UInt64><9>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
