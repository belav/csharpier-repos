    ...
    public sealed unsafe class SimpleBinaryOpTest__CompareScalarNotLessThanOrEqualDouble
    {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Sse2)
                .GetMethod(
                    nameof(Sse2.CompareScalarNotLessThanOrEqual),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Sse2.CompareScalarNotLessThanOrEqual(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Sse2)}.{nameof(Sse2.CompareScalarNotLessThanOrEqual)}<Double>(Vector128<Double>, Vector128<Double>): {method} failed:"
                    );
