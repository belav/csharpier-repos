    ...
    public sealed unsafe class ImmUnaryOpTest__ShiftLeftLogical128BitLaneSByte1
    {
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                ImmUnaryOpTest__ShiftLeftLogical128BitLaneSByte1 testClass
            )
            {
        ...
        public void RunReflectionScenario_Load()
        {
            ...
            var result = typeof(Sse2)
                ...
                .Invoke(
                    null,
                    new object[] { Sse2.LoadVector128((SByte*)(_dataTable.inArrayPtr)), (byte)1 }
                );
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Sse2)}.{nameof(Sse2.ShiftLeftLogical128BitLane)}<SByte>(Vector128<SByte><9>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
