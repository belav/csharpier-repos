    ...
    public sealed unsafe class SimpleBinaryOpTest__CompareOrderedDouble
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario_Load(
                SimpleBinaryOpTest__CompareOrderedDouble testClass
            )
            {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Sse2.CompareOrdered(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Sse2)}.{nameof(Sse2.CompareOrdered)}<Double>(Vector128<Double>, Vector128<Double>): {method} failed:"
                    );
