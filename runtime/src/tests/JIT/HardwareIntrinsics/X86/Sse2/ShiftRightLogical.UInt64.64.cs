...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    public sealed unsafe class ImmUnaryOpTest__ShiftRightLogicalUInt6464
    {
        private struct TestStruct
        {
            ...
            public static TestStruct Create()
            {
                ...
                Unsafe.CopyBlockUnaligned(
                    ref Unsafe.As<Vector128<UInt64>, byte>(ref testStruct._fld),
        ...
        static ImmUnaryOpTest__ShiftRightLogicalUInt6464()
        {
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector128<UInt64>, byte>(ref _clsVar),
                ref Unsafe.As<UInt64, byte>(ref _data[0]),
                (uint)Unsafe.SizeOf<Vector128<UInt64>>()
            );
        }
        ...
        public ImmUnaryOpTest__ShiftRightLogicalUInt6464()
        {
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector128<UInt64>, byte>(ref _fld),
                ref Unsafe.As<UInt64, byte>(ref _data[0]),
                (uint)Unsafe.SizeOf<Vector128<UInt64>>()
            );
            ...
            _dataTable = new SimpleUnaryOpTest__DataTable<UInt64, UInt64>(
                _data,
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Sse2)
                .GetMethod(
                    ...
                    new Type[] { typeof(Vector128<UInt64>), typeof(byte) }
                )
                .Invoke(
                    null,
                    new object[] { Unsafe.Read<Vector128<UInt64>>(_dataTable.inArrayPtr), (byte)64 }
                );
        ...
        public void RunReflectionScenario_Load()
        {
            ...
            var result = typeof(Sse2)
                ...
                .Invoke(
                    null,
                    new object[] { Sse2.LoadVector128((UInt64*)(_dataTable.inArrayPtr)), (byte)64 }
                );
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Sse2.ShiftRightLogical(_clsVar, 64);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Sse2)}.{nameof(Sse2.ShiftRightLogical)}<UInt64>(Vector128<UInt64><9>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
