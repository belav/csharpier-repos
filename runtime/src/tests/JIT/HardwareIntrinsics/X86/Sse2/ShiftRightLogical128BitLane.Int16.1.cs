    ...
    public sealed unsafe class ImmUnaryOpTest__ShiftRightLogical128BitLaneInt161
    {
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                ImmUnaryOpTest__ShiftRightLogical128BitLaneInt161 testClass
            )
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Sse2)
                .GetMethod(
                    nameof(Sse2.ShiftRightLogical128BitLane),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Sse2.ShiftRightLogical128BitLane(_clsVar, 1);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Sse2)}.{nameof(Sse2.ShiftRightLogical128BitLane)}<Int16>(Vector128<Int16><9>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
