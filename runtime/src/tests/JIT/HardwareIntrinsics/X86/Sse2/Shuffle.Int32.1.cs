...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    public sealed unsafe class ImmUnaryOpTest__ShuffleInt321
    {
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = Sse2.Shuffle(Unsafe.Read<Vector128<Int32>>(_dataTable.inArrayPtr), 1);
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var result = Sse2.Shuffle(Sse2.LoadVector128((Int32*)(_dataTable.inArrayPtr)), 1);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Sse2)}.{nameof(Sse2.Shuffle)}<Int32>(Vector128<Int32><9>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
