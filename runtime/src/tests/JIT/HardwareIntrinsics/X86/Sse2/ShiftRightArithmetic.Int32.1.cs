...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    public sealed unsafe class ImmUnaryOpTest__ShiftRightArithmeticInt321
    {
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(ImmUnaryOpTest__ShiftRightArithmeticInt321 testClass)
            {
        ...
        static ImmUnaryOpTest__ShiftRightArithmeticInt321()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data[i] = TestLibrary.Generator.GetInt32();
        ...
        public ImmUnaryOpTest__ShiftRightArithmeticInt321()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Sse2)
                .GetMethod(
                    nameof(Sse2.ShiftRightArithmetic),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Sse2.ShiftRightArithmetic(_clsVar, 1);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Sse2)}.{nameof(Sse2.ShiftRightArithmetic)}<Int32>(Vector128<Int32><9>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
