    ...
    public sealed unsafe class BooleanBinaryOpTest__CompareScalarOrderedLessThanOrEqualBoolean
    {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Sse2)
                .GetMethod(
                    nameof(Sse2.CompareScalarOrderedLessThanOrEqual),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Sse2.CompareScalarOrderedLessThanOrEqual(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Sse2)}.{nameof(Sse2.CompareScalarOrderedLessThanOrEqual)}<Boolean>(Vector128<Double>, Vector128<Double>): {method} failed:"
                    );
