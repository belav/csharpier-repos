...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    public sealed unsafe class ImmUnaryOpTest__ShuffleHighInt161
    {
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = Sse2.ShuffleHigh(Unsafe.Read<Vector128<Int16>>(_dataTable.inArrayPtr), 1);
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var result = Sse2.ShuffleHigh(Sse2.LoadVector128((Int16*)(_dataTable.inArrayPtr)), 1);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Sse2)}.{nameof(Sse2.ShuffleHigh)}<Int16>(Vector128<Int16><9>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
