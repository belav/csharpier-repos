...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    public sealed unsafe class InsertScalarTest__InsertInt161
    {
        ...
        public unsafe void RunBasicScenario_Load()
        {
            ...
            var result = Sse2.Insert(Sse2.LoadVector128((Int16*)(_dataTable.inArrayPtr)), *ptr, 1);
        ...
        public void RunReflectionScenario()
        {
            ...
            var result = typeof(Sse2)
                .GetMethod(
                    nameof(Sse2.Insert),
                    new Type[] { typeof(Vector128<Int16>), typeof(Int16), typeof(byte) }
                )
                .Invoke(
                    null,
                    new object[]
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Sse2)}.{nameof(Sse2.Insert)}<Int16>(Vector128<Int16><9>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
