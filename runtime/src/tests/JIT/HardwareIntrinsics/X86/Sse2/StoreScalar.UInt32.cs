...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    {
        private static void StoreScalarUInt32()
        {
    ...
    public sealed unsafe class StoreUnaryOpTest__StoreScalarUInt32
    {
        ...
        public void RunClsVarScenario()
        {
            ...
            Sse2.StoreScalar((UInt32*)_dataTable.outArrayPtr, _clsVar1);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Sse2)}.{nameof(Sse2.StoreScalar)}<UInt32>(Vector128<UInt32>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
                    .LogInformation($"    value: ({string.Join(", ", value)})");
                TestLibrary
                    .TestFramework
