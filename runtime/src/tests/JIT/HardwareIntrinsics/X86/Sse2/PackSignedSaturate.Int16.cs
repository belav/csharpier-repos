    ...
    public sealed unsafe class SimpleBinaryOpTest__PackSignedSaturateInt16
    {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Sse2)
                .GetMethod(
                    nameof(Sse2.PackSignedSaturate),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Sse2.PackSignedSaturate(_clsVar1, _clsVar2);
        ...
        )
        {
                    ...
                    if (
                        ...
                        != (
                            (i < 4)
                                ...
                                : (short)
                                    Math.Min(Math.Max(right[i % 4], short.MinValue), short.MaxValue)
                        )
                    )
                    {
                        succeeded = false;
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(Sse2)}.{nameof(Sse2.PackSignedSaturate)}<Int16>(Vector128<Int32>, Vector128<Int32>): {method} failed:"
                );
