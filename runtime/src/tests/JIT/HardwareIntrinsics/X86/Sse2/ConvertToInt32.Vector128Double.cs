    ...
    public sealed unsafe class SimdScalarUnaryOpConvertTest__ConvertToInt32Vector128Double
    {
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimdScalarUnaryOpConvertTest__ConvertToInt32Vector128Double testClass
            )
            {
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = Sse2.ConvertToInt32(Unsafe.Read<Vector128<Double>>(_dataTable.inArrayPtr));
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var result = Sse2.ConvertToInt32(Sse2.LoadVector128((Double*)(_dataTable.inArrayPtr)));
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Sse2)
                .GetMethod(nameof(Sse2.ConvertToInt32), new Type[] { typeof(Vector128<Double>) })
                .Invoke(
                    null,
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Sse2.ConvertToInt32(_clsVar);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Sse2)}.{nameof(Sse2.ConvertToInt32)}<Int32>(Vector128<Double>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
