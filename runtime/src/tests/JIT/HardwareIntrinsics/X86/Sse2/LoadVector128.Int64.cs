...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    public sealed unsafe class SimpleUnaryOpTest__LoadVector128Int64
    {
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var result = Sse2.LoadVector128((Int64*)(_dataTable.inArrayPtr));
        ...
        public void RunReflectionScenario_Load()
        {
            ...
            var result = typeof(Sse2)
                .GetMethod(nameof(Sse2.LoadVector128), new Type[] { typeof(Int64*) })
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Sse2)}.{nameof(Sse2.LoadVector128)}<Int64>(Vector128<Int64>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
