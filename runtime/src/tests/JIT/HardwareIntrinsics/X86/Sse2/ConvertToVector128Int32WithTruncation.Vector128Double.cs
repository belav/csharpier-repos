...
namespace JIT.HardwareIntrinsics.X86
{
    public static partial class Program
    {
        ...
        {
            var test =
                new SimpleUnaryOpConvTest__ConvertToVector128Int32WithTruncationVector128Double();
    ...
    public sealed unsafe class SimpleUnaryOpConvTest__ConvertToVector128Int32WithTruncationVector128Double
    {
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpConvTest__ConvertToVector128Int32WithTruncationVector128Double testClass
            )
            {
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Sse2)}.{nameof(Sse2.ConvertToVector128Int32WithTruncation)}<Int32>(Vector128<Double>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
