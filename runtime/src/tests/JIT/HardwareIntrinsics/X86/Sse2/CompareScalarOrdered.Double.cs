    ...
    public sealed unsafe class SimpleBinaryOpTest__CompareScalarOrderedDouble
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__CompareScalarOrderedDouble testClass
            )
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Sse2)
                .GetMethod(
                    nameof(Sse2.CompareScalarOrdered),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Sse2.CompareScalarOrdered(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Sse2)}.{nameof(Sse2.CompareScalarOrdered)}<Double>(Vector128<Double>, Vector128<Double>): {method} failed:"
                    );
