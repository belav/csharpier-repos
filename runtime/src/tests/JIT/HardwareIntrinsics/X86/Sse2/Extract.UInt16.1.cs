...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    public sealed unsafe class ExtractScalarTest__ExtractUInt161
    {
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = Sse2.Extract(Unsafe.Read<Vector128<UInt16>>(_dataTable.inArrayPtr), 1);
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var result = Sse2.Extract(Sse2.LoadVector128((UInt16*)(_dataTable.inArrayPtr)), 1);
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Sse2.Extract(_clsVar, 1);
