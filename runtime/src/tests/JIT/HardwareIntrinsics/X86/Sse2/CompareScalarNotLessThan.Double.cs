    ...
    public sealed unsafe class SimpleBinaryOpTest__CompareScalarNotLessThanDouble
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__CompareScalarNotLessThanDouble testClass
            )
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Sse2)
                .GetMethod(
                    nameof(Sse2.CompareScalarNotLessThan),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Sse2.CompareScalarNotLessThan(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Sse2)}.{nameof(Sse2.CompareScalarNotLessThan)}<Double>(Vector128<Double>, Vector128<Double>): {method} failed:"
                    );
