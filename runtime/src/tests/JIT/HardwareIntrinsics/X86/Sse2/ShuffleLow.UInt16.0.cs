...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    public sealed unsafe class ImmUnaryOpTest__ShuffleLowUInt160
    {
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = Sse2.ShuffleLow(Unsafe.Read<Vector128<UInt16>>(_dataTable.inArrayPtr), 0);
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var result = Sse2.ShuffleLow(Sse2.LoadVector128((UInt16*)(_dataTable.inArrayPtr)), 0);
