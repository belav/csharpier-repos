...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    public sealed unsafe class ImmUnaryOpTest__ShuffleLowInt161
    {
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = Sse2.ShuffleLow(Unsafe.Read<Vector128<Int16>>(_dataTable.inArrayPtr), 1);
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var result = Sse2.ShuffleLow(Sse2.LoadVector128((Int16*)(_dataTable.inArrayPtr)), 1);
