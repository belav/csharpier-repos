    ...
    public sealed unsafe class SimpleBinaryOpTest__SubtractScalarDouble
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario_Load(
                SimpleBinaryOpTest__SubtractScalarDouble testClass
            )
            {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Sse2.SubtractScalar(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (
                BitConverter.DoubleToInt64Bits(left[0] - right[0])
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Sse2)}.{nameof(Sse2.SubtractScalar)}<Double>(Vector128<Double>, Vector128<Double>): {method} failed:"
                    );
