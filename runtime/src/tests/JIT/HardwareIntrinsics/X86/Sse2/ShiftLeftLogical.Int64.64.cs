    ...
    public sealed unsafe class ImmUnaryOpTest__ShiftLeftLogicalInt6464
    {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Sse2)
                .GetMethod(
                    nameof(Sse2.ShiftLeftLogical),
                    new Type[] { typeof(Vector128<Int64>), typeof(byte) }
                )
                .Invoke(
                    null,
                    new object[] { Unsafe.Read<Vector128<Int64>>(_dataTable.inArrayPtr), (byte)64 }
                );
        ...
        public void RunReflectionScenario_Load()
        {
            ...
            var result = typeof(Sse2)
                ...
                .Invoke(
                    null,
                    new object[] { Sse2.LoadVector128((Int64*)(_dataTable.inArrayPtr)), (byte)64 }
                );
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Sse2.ShiftLeftLogical(_clsVar, 64);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Sse2)}.{nameof(Sse2.ShiftLeftLogical)}<Int64>(Vector128<Int64><9>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
