    ...
    public sealed unsafe class ImmUnaryOpTest__ShiftLeftLogicalUInt1616
    {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Sse2)
                ...
                .Invoke(
                    null,
                    new object[] { Unsafe.Read<Vector128<UInt16>>(_dataTable.inArrayPtr), (byte)16 }
                );
        ...
        public void RunReflectionScenario_Load()
        {
            ...
            var result = typeof(Sse2)
                ...
                .Invoke(
                    null,
                    new object[] { Sse2.LoadVector128((UInt16*)(_dataTable.inArrayPtr)), (byte)16 }
                );
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Sse2.ShiftLeftLogical(_clsVar, 16);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Sse2)}.{nameof(Sse2.ShiftLeftLogical)}<UInt16>(Vector128<UInt16><9>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
