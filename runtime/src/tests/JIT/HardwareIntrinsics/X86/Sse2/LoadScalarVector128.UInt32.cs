...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    public sealed unsafe class SimpleUnaryOpTest__LoadScalarVector128UInt32
    {
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var result = Sse2.LoadScalarVector128((UInt32*)(_dataTable.inArrayPtr));
        ...
        public void RunReflectionScenario_Load()
        {
            ...
            var result = typeof(Sse2)
                .GetMethod(nameof(Sse2.LoadScalarVector128), new Type[] { typeof(UInt32*) })
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Sse2)}.{nameof(Sse2.LoadScalarVector128)}<UInt32>(Vector128<UInt32>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
