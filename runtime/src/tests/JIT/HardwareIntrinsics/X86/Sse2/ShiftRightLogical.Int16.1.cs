...
namespace JIT.HardwareIntrinsics.X86
{
    public static partial class Program
    {
        ...
        {
            var test = new ImmUnaryOpTest__ShiftRightLogicalInt161();
    ...
    public sealed unsafe class ImmUnaryOpTest__ShiftRightLogicalInt161
    {
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(ImmUnaryOpTest__ShiftRightLogicalInt161 testClass)
            {
        ...
        public void RunReflectionScenario_Load()
        {
            ...
            var result = typeof(Sse2)
                ...
                .Invoke(
                    null,
                    new object[] { Sse2.LoadVector128((Int16*)(_dataTable.inArrayPtr)), (byte)1 }
                );
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Sse2.ShiftRightLogical(_clsVar, 1);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Sse2)}.{nameof(Sse2.ShiftRightLogical)}<Int16>(Vector128<Int16><9>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
