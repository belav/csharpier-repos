...
namespace JIT.HardwareIntrinsics.X86
{
    public static partial class Program
    {
        ...
        {
            var test =
                new SimpleUnaryOpConvTest__ConvertToVector128Int32WithTruncationVector128Single();
    ...
    public sealed unsafe class SimpleUnaryOpConvTest__ConvertToVector128Int32WithTruncationVector128Single
    {
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpConvTest__ConvertToVector128Int32WithTruncationVector128Single testClass
            )
            {
