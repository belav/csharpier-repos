...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    public sealed unsafe class SimpleBinaryOpTest__MaxDouble
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__MaxDouble testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleBinaryOpTest__MaxDouble testClass)
            {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Sse2.Max(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (
                BitConverter.DoubleToInt64Bits(Math.Max(left[0], right[0]))
            ...
            else
            {
                ...
                {
                    if (
                        BitConverter.DoubleToInt64Bits(Math.Max(left[i], right[i]))
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Sse2)}.{nameof(Sse2.Max)}<Double>(Vector128<Double>, Vector128<Double>): {method} failed:"
                    );
