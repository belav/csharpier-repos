...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    public sealed unsafe class SimpleUnaryOpTest__LoadVector128Int32
    {
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var result = Sse2.LoadVector128((Int32*)(_dataTable.inArrayPtr));
        ...
        public void RunReflectionScenario_Load()
        {
            ...
            var result = typeof(Sse2)
                .GetMethod(nameof(Sse2.LoadVector128), new Type[] { typeof(Int32*) })
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Sse2)}.{nameof(Sse2.LoadVector128)}<Int32>(Vector128<Int32>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
