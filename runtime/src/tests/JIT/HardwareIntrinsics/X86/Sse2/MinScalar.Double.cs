...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    public sealed unsafe class SimpleBinaryOpTest__MinScalarDouble
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__MinScalarDouble testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleBinaryOpTest__MinScalarDouble testClass)
            {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Sse2.MinScalar(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (
                BitConverter.DoubleToInt64Bits(Math.Min(left[0], right[0]))
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Sse2)}.{nameof(Sse2.MinScalar)}<Double>(Vector128<Double>, Vector128<Double>): {method} failed:"
                    );
