...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    public sealed unsafe class SimpleBinaryOpTest__CompareLessThanInt16
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__CompareLessThanInt16 testClass)
            {
            ...
            public void RunStructFldScenario_Load(
                SimpleBinaryOpTest__CompareLessThanInt16 testClass
            )
            {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Sse2.CompareLessThan(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Sse2)}.{nameof(Sse2.CompareLessThan)}<Int16>(Vector128<Int16>, Vector128<Int16>): {method} failed:"
                    );
