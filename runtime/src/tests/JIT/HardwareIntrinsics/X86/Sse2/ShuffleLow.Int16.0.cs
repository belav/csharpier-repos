...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    public sealed unsafe class ImmUnaryOpTest__ShuffleLowInt160
    {
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = Sse2.ShuffleLow(Unsafe.Read<Vector128<Int16>>(_dataTable.inArrayPtr), 0);
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var result = Sse2.ShuffleLow(Sse2.LoadVector128((Int16*)(_dataTable.inArrayPtr)), 0);
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Sse2)
                ...
                .Invoke(
                    null,
                    new object[] { Unsafe.Read<Vector128<Int16>>(_dataTable.inArrayPtr), (byte)0 }
                );
        ...
        public void RunReflectionScenario_Load()
        {
            ...
            var result = typeof(Sse2)
                ...
                .Invoke(
                    null,
                    new object[] { Sse2.LoadVector128((Int16*)(_dataTable.inArrayPtr)), (byte)0 }
                );
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Sse2.ShuffleLow(_clsVar, 0);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Sse2)}.{nameof(Sse2.ShuffleLow)}<Int16>(Vector128<Int16><9>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
