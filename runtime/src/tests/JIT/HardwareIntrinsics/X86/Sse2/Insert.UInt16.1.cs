...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    public sealed unsafe class InsertScalarTest__InsertUInt161
    {
        ...
        public unsafe void RunBasicScenario_Load()
        {
            ...
            var result = Sse2.Insert(Sse2.LoadVector128((UInt16*)(_dataTable.inArrayPtr)), *ptr, 1);
        ...
        public void RunReflectionScenario()
        {
            ...
            var result = typeof(Sse2)
                .GetMethod(
                    nameof(Sse2.Insert),
                    new Type[] { typeof(Vector128<UInt16>), typeof(UInt16), typeof(byte) }
                )
                .Invoke(
                    null,
                    new object[]
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Sse2.Insert(_clsVar, _scalarClsData, 1);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Sse2)}.{nameof(Sse2.Insert)}<UInt16>(Vector128<UInt16><9>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
