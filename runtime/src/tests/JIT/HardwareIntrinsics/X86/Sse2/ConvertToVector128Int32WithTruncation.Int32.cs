...
namespace JIT.HardwareIntrinsics.X86
{
    public static partial class Program
    {
        ...
        {
            var test =
                new SimpleUnaryOpConvTest__ConvertToVector128Int32WithTruncationInt32Vector128Single();
    ...
    public sealed unsafe class SimpleUnaryOpConvTest__ConvertToVector128Int32WithTruncationInt32Vector128Single
    {
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpConvTest__ConvertToVector128Int32WithTruncationInt32Vector128Single testClass
            )
            {
        ...
        public SimpleUnaryOpConvTest__ConvertToVector128Int32WithTruncationInt32Vector128Single()
        {
            ...
            _dataTable = new SimpleUnaryOpTest__DataTable<Int32, Single>(
                _data,
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Sse2)
                .GetMethod(
                    nameof(Sse2.ConvertToVector128Int32WithTruncation),
        ...
        public void RunReflectionScenario_Load()
        {
            ...
            var result = typeof(Sse2)
                ...
                .Invoke(
                    null,
                    new object[] { Sse2.LoadVector128((Single*)(_dataTable.inArrayPtr)) }
                );
        ...
        public void RunReflectionScenario_LoadAligned()
        {
            ...
            var result = typeof(Sse2)
                ...
                .Invoke(
                    null,
                    new object[] { Sse2.LoadAlignedVector128((Single*)(_dataTable.inArrayPtr)) }
                );
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Sse2.ConvertToVector128Int32WithTruncation(_clsVar);
        ...
        )
        {
            ...
            if (!Succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Sse2)}.{nameof(Sse2.ConvertToVector128Int32WithTruncation)}<Int32>(Vector128<Single>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
