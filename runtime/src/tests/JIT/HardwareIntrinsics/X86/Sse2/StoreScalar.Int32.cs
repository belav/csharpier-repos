...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    {
        private static void StoreScalarInt32()
        {
            var test = new StoreUnaryOpTest__StoreScalarInt32();
    ...
    public sealed unsafe class StoreUnaryOpTest__StoreScalarInt32
    {
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(StoreUnaryOpTest__StoreScalarInt32 testClass)
            {
                Sse2.StoreScalar((Int32*)testClass._dataTable.outArrayPtr, _fld1);
        ...
        static StoreUnaryOpTest__StoreScalarInt32()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetInt32();
        ...
        public StoreUnaryOpTest__StoreScalarInt32()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            typeof(Sse2)
                .GetMethod(
                    ...
                    new Type[] { typeof(Int32*), typeof(Vector128<Int32>) }
                )
                .Invoke(
                    null,
                    new object[]
        ...
        public void RunClsVarScenario()
        {
            ...
            Sse2.StoreScalar((Int32*)_dataTable.outArrayPtr, _clsVar1);
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            Sse2.StoreScalar((Int32*)_dataTable.outArrayPtr, value);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new StoreUnaryOpTest__StoreScalarInt32();
            Sse2.StoreScalar((Int32*)_dataTable.outArrayPtr, test._fld1);
        ...
        public void RunClassFldScenario()
        {
            ...
            Sse2.StoreScalar((Int32*)_dataTable.outArrayPtr, _fld1);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Sse2)}.{nameof(Sse2.StoreScalar)}<Int32>(Vector128<Int32>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
