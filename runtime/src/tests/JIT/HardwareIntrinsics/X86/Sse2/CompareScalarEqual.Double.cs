    ...
    public sealed unsafe class SimpleBinaryOpTest__CompareScalarEqualDouble
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario_Load(
                SimpleBinaryOpTest__CompareScalarEqualDouble testClass
            )
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Sse2)
                .GetMethod(
                    nameof(Sse2.CompareScalarEqual),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Sse2.CompareScalarEqual(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Sse2)}.{nameof(Sse2.CompareScalarEqual)}<Double>(Vector128<Double>, Vector128<Double>): {method} failed:"
                    );
