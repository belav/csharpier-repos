...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    public sealed unsafe class ImmUnaryOpTest__ShuffleHighInt160
    {
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = Sse2.ShuffleHigh(Unsafe.Read<Vector128<Int16>>(_dataTable.inArrayPtr), 0);
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var result = Sse2.ShuffleHigh(Sse2.LoadVector128((Int16*)(_dataTable.inArrayPtr)), 0);
