...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    {
        private static void ConvertToInt32WithTruncationVector128Double()
        {
            var test =
                new SimdScalarUnaryOpConvertTest__ConvertToInt32WithTruncationVector128Double();
    ...
    public sealed unsafe class SimdScalarUnaryOpConvertTest__ConvertToInt32WithTruncationVector128Double
    {
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimdScalarUnaryOpConvertTest__ConvertToInt32WithTruncationVector128Double testClass
            )
            {
        ...
        static SimdScalarUnaryOpConvertTest__ConvertToInt32WithTruncationVector128Double()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data[i] = TestLibrary.Generator.GetDouble();
        ...
        public SimdScalarUnaryOpConvertTest__ConvertToInt32WithTruncationVector128Double()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Sse2)
                .GetMethod(
                    nameof(Sse2.ConvertToInt32WithTruncation),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Sse2.ConvertToInt32WithTruncation(_clsVar);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Sse2)}.{nameof(Sse2.ConvertToInt32WithTruncation)}<Int32>(Vector128<Double>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
