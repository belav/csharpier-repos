...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    public sealed unsafe class ImmUnaryOpTest__ShiftRightLogicalUInt3232
    {
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(ImmUnaryOpTest__ShiftRightLogicalUInt3232 testClass)
            {
        ...
        static ImmUnaryOpTest__ShiftRightLogicalUInt3232()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data[i] = TestLibrary.Generator.GetUInt32();
        ...
        public ImmUnaryOpTest__ShiftRightLogicalUInt3232()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Sse2)
                .GetMethod(
                    nameof(Sse2.ShiftRightLogical),
                    new Type[] { typeof(Vector128<UInt32>), typeof(byte) }
                )
                .Invoke(
                    null,
                    new object[] { Unsafe.Read<Vector128<UInt32>>(_dataTable.inArrayPtr), (byte)32 }
                );
        ...
        public void RunReflectionScenario_Load()
        {
            ...
            var result = typeof(Sse2)
                ...
                .Invoke(
                    null,
                    new object[] { Sse2.LoadVector128((UInt32*)(_dataTable.inArrayPtr)), (byte)32 }
                );
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Sse2.ShiftRightLogical(_clsVar, 32);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Sse2)}.{nameof(Sse2.ShiftRightLogical)}<UInt32>(Vector128<UInt32><9>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
