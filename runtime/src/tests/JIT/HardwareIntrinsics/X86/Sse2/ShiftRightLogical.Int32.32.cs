    ...
    public sealed unsafe class ImmUnaryOpTest__ShiftRightLogicalInt3232
    {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Sse2)
                ...
                .Invoke(
                    null,
                    new object[] { Unsafe.Read<Vector128<Int32>>(_dataTable.inArrayPtr), (byte)32 }
                );
        ...
        public void RunReflectionScenario_Load()
        {
            ...
            var result = typeof(Sse2)
                ...
                .Invoke(
                    null,
                    new object[] { Sse2.LoadVector128((Int32*)(_dataTable.inArrayPtr)), (byte)32 }
                );
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Sse2)}.{nameof(Sse2.ShiftRightLogical)}<Int32>(Vector128<Int32><9>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
