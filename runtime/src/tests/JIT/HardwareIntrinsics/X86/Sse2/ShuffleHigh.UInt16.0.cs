...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    public sealed unsafe class ImmUnaryOpTest__ShuffleHighUInt160
    {
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = Sse2.ShuffleHigh(Unsafe.Read<Vector128<UInt16>>(_dataTable.inArrayPtr), 0);
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var result = Sse2.ShuffleHigh(Sse2.LoadVector128((UInt16*)(_dataTable.inArrayPtr)), 0);
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Sse2)
                .GetMethod(
                    nameof(Sse2.ShuffleHigh),
                    new Type[] { typeof(Vector128<UInt16>), typeof(byte) }
                )
                .Invoke(
                    null,
                    new object[] { Unsafe.Read<Vector128<UInt16>>(_dataTable.inArrayPtr), (byte)0 }
                );
        ...
        public void RunReflectionScenario_Load()
        {
            ...
            var result = typeof(Sse2)
                ...
                .Invoke(
                    null,
                    new object[] { Sse2.LoadVector128((UInt16*)(_dataTable.inArrayPtr)), (byte)0 }
                );
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Sse2.ShuffleHigh(_clsVar, 0);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Sse2)}.{nameof(Sse2.ShuffleHigh)}<UInt16>(Vector128<UInt16><9>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
