    ...
    public sealed unsafe class SimpleUnaryOpConvTest__ConvertToVector128Int32Vector128Double
    {
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpConvTest__ConvertToVector128Int32Vector128Double testClass
            )
            {
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Sse2)}.{nameof(Sse2.ConvertToVector128Int32)}<Int32>(Vector128<Double>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
