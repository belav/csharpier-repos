    ...
    public sealed unsafe class SimpleBinaryOpTest__MultiplyByte
    {
        ...
        static SimpleBinaryOpTest__MultiplyByte()
        {
            ...
            Unsafe.CopyBlockUnaligned(
                ...
                Unsafe.SizeOf<Vector128<UInt16>>()
            );
        ...
        public SimpleBinaryOpTest__MultiplyByte()
        {
            ...
            _dataTable = new SimpleBinaryOpTest__DataTable<Byte>(
                _data1,
                _data2,
        ...
        {
            var result = Sse2.Multiply(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            {
                Console.WriteLine(
                    $"{nameof(Sse2)}.{nameof(Sse2.Multiply)}<Byte>: {method} failed:"
                );
