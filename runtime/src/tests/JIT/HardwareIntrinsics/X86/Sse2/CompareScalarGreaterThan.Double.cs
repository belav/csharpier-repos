    ...
    public sealed unsafe class SimpleBinaryOpTest__CompareScalarGreaterThanDouble
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__CompareScalarGreaterThanDouble testClass
            )
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Sse2)
                .GetMethod(
                    nameof(Sse2.CompareScalarGreaterThan),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Sse2.CompareScalarGreaterThan(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Sse2)}.{nameof(Sse2.CompareScalarGreaterThan)}<Double>(Vector128<Double>, Vector128<Double>): {method} failed:"
                    );
