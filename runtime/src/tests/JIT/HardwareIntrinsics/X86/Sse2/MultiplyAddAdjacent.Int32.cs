    ...
    public sealed unsafe class SimpleBinaryOpTest__MultiplyAddAdjacentInt32
    {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Sse2)
                .GetMethod(
                    nameof(Sse2.MultiplyAddAdjacent),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Sse2.MultiplyAddAdjacent(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Sse2)}.{nameof(Sse2.MultiplyAddAdjacent)}<Int32>(Vector128<Int16>, Vector128<Int16>): {method} failed:"
                    );
