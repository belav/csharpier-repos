...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    public sealed unsafe class ImmUnaryOpTest__ShuffleUInt320
    {
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = Sse2.Shuffle(Unsafe.Read<Vector128<UInt32>>(_dataTable.inArrayPtr), 0);
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var result = Sse2.Shuffle(Sse2.LoadVector128((UInt32*)(_dataTable.inArrayPtr)), 0);
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Sse2)
                ...
                .Invoke(
                    null,
                    new object[] { Unsafe.Read<Vector128<UInt32>>(_dataTable.inArrayPtr), (byte)0 }
                );
        ...
        public void RunReflectionScenario_Load()
        {
            ...
            var result = typeof(Sse2)
                ...
                .Invoke(
                    null,
                    new object[] { Sse2.LoadVector128((UInt32*)(_dataTable.inArrayPtr)), (byte)0 }
                );
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Sse2.Shuffle(_clsVar, 0);
