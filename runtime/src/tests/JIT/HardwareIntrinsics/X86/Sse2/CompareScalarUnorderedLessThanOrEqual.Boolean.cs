    ...
    public sealed unsafe class BooleanBinaryOpTest__CompareScalarUnorderedLessThanOrEqualBoolean
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                BooleanBinaryOpTest__CompareScalarUnorderedLessThanOrEqualBoolean testClass
            )
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Sse2)
                .GetMethod(
                    nameof(Sse2.CompareScalarUnorderedLessThanOrEqual),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Sse2.CompareScalarUnorderedLessThanOrEqual(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Sse2)}.{nameof(Sse2.CompareScalarUnorderedLessThanOrEqual)}<Boolean>(Vector128<Double>, Vector128<Double>): {method} failed:"
                    );
