...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    {
        private static void ConvertToVector128SingleVector128Int32()
        {
            var test = new SimpleUnaryOpConvTest__ConvertToVector128SingleVector128Int32();
    ...
    public sealed unsafe class SimpleUnaryOpConvTest__ConvertToVector128SingleVector128Int32
    {
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpConvTest__ConvertToVector128SingleVector128Int32 testClass
            )
            {
        ...
        static SimpleUnaryOpConvTest__ConvertToVector128SingleVector128Int32()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data[i] = TestLibrary.Generator.GetInt32();
        ...
        public SimpleUnaryOpConvTest__ConvertToVector128SingleVector128Int32()
        {
            Succeeded = true;
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Sse2)
                .GetMethod(
                    nameof(Sse2.ConvertToVector128Single),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Sse2.ConvertToVector128Single(_clsVar);
        ...
        )
        {
            ...
            if (
                ...
                != BitConverter.SingleToInt32Bits((float)firstOp[0])
            )
            {
                succeeded = false;
            }
            else
            {
                for (var i = 1; i < RetElementCount; i++)
                {
                    if (
                        ...
                        != BitConverter.SingleToInt32Bits((float)firstOp[i])
                    )
                    {
                        succeeded = false;
                        break;
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Sse2)}.{nameof(Sse2.ConvertToVector128Single)}<Single>(Vector128<Int32>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
