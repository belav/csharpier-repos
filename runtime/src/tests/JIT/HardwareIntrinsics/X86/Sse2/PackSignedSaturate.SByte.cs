        ...
        )
        {
                    ...
                    if (
                        ...
                        != (
                            (i < 8)
                                ...
                                : (sbyte)
                                    Math.Min(Math.Max(right[i % 8], sbyte.MinValue), sbyte.MaxValue)
                        )
                    )
                    {
                        succeeded = false;
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(Sse2)}.{nameof(Sse2.PackSignedSaturate)}<SByte>(Vector128<Int16>, Vector128<Int16>): {method} failed:"
                );
