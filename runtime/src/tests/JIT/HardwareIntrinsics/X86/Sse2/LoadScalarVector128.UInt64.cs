...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    public sealed unsafe class SimpleUnaryOpTest__LoadScalarVector128UInt64
    {
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var result = Sse2.LoadScalarVector128((UInt64*)(_dataTable.inArrayPtr));
        ...
        public void RunReflectionScenario_Load()
        {
            ...
            var result = typeof(Sse2)
                .GetMethod(nameof(Sse2.LoadScalarVector128), new Type[] { typeof(UInt64*) })
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Sse2)}.{nameof(Sse2.LoadScalarVector128)}<UInt64>(Vector128<UInt64>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
