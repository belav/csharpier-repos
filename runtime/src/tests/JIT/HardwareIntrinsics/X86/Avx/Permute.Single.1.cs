...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    public sealed unsafe class ImmUnaryOpTest__PermuteSingle1
    {
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = Avx.Permute(Unsafe.Read<Vector256<Single>>(_dataTable.inArrayPtr), 1);
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var result = Avx.Permute(Avx.LoadVector256((Single*)(_dataTable.inArrayPtr)), 1);
        ...
        public void RunBasicScenario_LoadAligned()
        {
            ...
            var result = Avx.Permute(Avx.LoadAlignedVector256((Single*)(_dataTable.inArrayPtr)), 1);
        ...
        )
        {
            ...
            else
            {
                ...
                {
                    if (
                        BitConverter.SingleToInt32Bits(result[4])
                        != BitConverter.SingleToInt32Bits(firstOp[5])
                    )
                    {
                        succeeded = false;
                        break;
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Avx)}.{nameof(Avx.Permute)}<Single>(Vector256<Single><9>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
