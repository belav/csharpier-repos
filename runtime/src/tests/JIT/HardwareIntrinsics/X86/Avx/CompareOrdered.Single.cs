...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    public sealed unsafe class SimpleBinaryOpTest__CompareOrderedSingle
    {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Avx.CompareOrdered(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(Avx)}.{nameof(Avx.CompareOrdered)}<Single>(Vector256<Single>, Vector256<Single>): {method} failed:"
                );
