    ...
    public sealed unsafe class SimpleUnaryOpTest__RoundToNegativeInfinitySingle
    {
        ...
        private struct TestStruct
        {
            ...
            )
            {
                ...
                {
                    var result = Avx.RoundToNegativeInfinity(Avx.LoadVector256((Single*)(pFld1)));
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            {
                var result = Avx.RoundToNegativeInfinity(Avx.LoadVector256((Single*)(pClsVar1)));
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = Avx.RoundToNegativeInfinity(Avx.LoadVector256((Single*)(&test._fld1)));
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Avx)}.{nameof(Avx.RoundToNegativeInfinity)}<Single>(Vector256<Single>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
