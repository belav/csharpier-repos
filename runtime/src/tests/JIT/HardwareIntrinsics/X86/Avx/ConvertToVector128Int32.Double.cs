...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    {
        private static void ConvertToVector128Int32Double()
        {
            var test = new SimpleUnaryOpTest__ConvertToVector128Int32Double();
    ...
    public sealed unsafe class SimpleUnaryOpTest__ConvertToVector128Int32Double
    {
        ...
        static SimpleUnaryOpTest__ConvertToVector128Int32Double()
        {
        ...
        {
            var result = Avx.ConvertToVector128Int32(
        ...
        {
            var result = Avx.ConvertToVector128Int32(_clsVar);
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = Avx.ConvertToVector128Int32(firstOp);
        ...
        {
            var test = new SimpleUnaryOpTest__ConvertToVector128Int32Double();
            var result = Avx.ConvertToVector128Int32(test._fld);
        ...
        {
            var result = Avx.ConvertToVector128Int32(_fld);
        ...
        )
        {
            ...
            {
                Console.WriteLine(
                    $"{nameof(Avx)}.{nameof(Avx.ConvertToVector128Int32)}(Vector256<Double>): {method} failed:"
                );
