                ...
                )
                {
                    ...
                    if (
                        !floatTable.CheckResult(
                            (left, right, result) =>
                                (left[0] + left[1] == result[0])
                                && (right[0] + right[1] == result[2])
                                && (left[2] + left[3] == result[1])
                                && (right[2] + right[3] == result[3])
                                && (left[4] + left[5] == result[4])
                                && (right[4] + right[5] == result[6])
                                && (left[6] + left[7] == result[5])
                                && (right[6] + right[7] == result[7])
                        )
                    )
                    {
                    ...
                    if (
                        !doubleTable.CheckResult(
                            (left, right, result) =>
                                (left[0] + left[1] == result[0])
                                && (right[0] + right[1] == result[1])
                                && (left[2] + left[3] == result[2])
                                && (right[2] + right[3] == result[3])
                        )
                    )
                    {
