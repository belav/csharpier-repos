    ...
    public sealed unsafe class SimpleUnaryOpTest__CeilingSingle
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario_Load(SimpleUnaryOpTest__CeilingSingle testClass)
            {
                ...
                {
                    var result = Avx.Ceiling(Avx.LoadVector256((Single*)(pFld1)));
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = Avx.Ceiling(Unsafe.Read<Vector256<Single>>(_dataTable.inArray1Ptr));
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var result = Avx.Ceiling(Avx.LoadVector256((Single*)(_dataTable.inArray1Ptr)));
        ...
        public void RunBasicScenario_LoadAligned()
        {
            ...
            var result = Avx.Ceiling(Avx.LoadAlignedVector256((Single*)(_dataTable.inArray1Ptr)));
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Avx)
                .GetMethod(nameof(Avx.Ceiling), new Type[] { typeof(Vector256<Single>) })
                .Invoke(
                    null,
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Avx.Ceiling(_clsVar1);
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            {
                var result = Avx.Ceiling(Avx.LoadVector256((Single*)(pClsVar1)));
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = Avx.Ceiling(Avx.LoadVector256((Single*)(&test._fld1)));
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Avx)}.{nameof(Avx.Ceiling)}<Single>(Vector256<Single>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
