...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    public sealed unsafe class SimpleUnaryOpTest__LoadVector256Byte
    {
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var result = Avx.LoadVector256((Byte*)(_dataTable.inArrayPtr));
        ...
        public void RunReflectionScenario_Load()
        {
            ...
            var result = typeof(Avx)
                .GetMethod(nameof(Avx.LoadVector256), new Type[] { typeof(Byte*) })
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Avx)}.{nameof(Avx.LoadVector256)}<Byte>(Vector256<Byte>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
