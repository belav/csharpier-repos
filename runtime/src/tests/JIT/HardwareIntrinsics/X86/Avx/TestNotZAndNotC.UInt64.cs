    ...
    public sealed unsafe class BooleanBinaryOpTest__TestNotZAndNotCUInt64
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario_Load(
                BooleanBinaryOpTest__TestNotZAndNotCUInt64 testClass
            )
            {
                fixed (Vector256<UInt64>* pFld1 = &_fld1)fixed (Vector256<UInt64>* pFld2 = &_fld2)
                {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Avx.TestNotZAndNotC(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(Avx)}.{nameof(Avx.TestNotZAndNotC)}<UInt64>(Vector256<UInt64>, Vector256<UInt64>): {method} failed:"
                );
