...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    public sealed unsafe class SimpleUnaryOpTest__LoadVector256UInt64
    {
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var result = Avx.LoadVector256((UInt64*)(_dataTable.inArrayPtr));
        ...
        public void RunReflectionScenario_Load()
        {
            ...
            var result = typeof(Avx)
                .GetMethod(nameof(Avx.LoadVector256), new Type[] { typeof(UInt64*) })
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Avx)}.{nameof(Avx.LoadVector256)}<UInt64>(Vector256<UInt64>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
