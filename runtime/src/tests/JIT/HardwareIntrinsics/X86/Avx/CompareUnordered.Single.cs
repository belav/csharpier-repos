    ...
    public sealed unsafe class SimpleBinaryOpTest__CompareUnorderedSingle
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario_Load(
                SimpleBinaryOpTest__CompareUnorderedSingle testClass
            ) {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Avx.CompareUnordered(_clsVar1, _clsVar2);
        ...
        private void ValidateResult(
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(Avx)}.{nameof(Avx.CompareUnordered)}<Single>(Vector256<Single>, Vector256<Single>): {method} failed:"
                );
