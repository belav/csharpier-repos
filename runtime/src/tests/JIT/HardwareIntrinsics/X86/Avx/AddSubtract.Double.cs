...
namespace JIT.HardwareIntrinsics.X86
{
    public static partial class Program
    {
        ...
        {
            var test = new SimpleBinaryOpTest__AddSubtractDouble();
    ...
    public sealed unsafe class SimpleBinaryOpTest__AddSubtractDouble
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleBinaryOpTest__AddSubtractDouble testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleBinaryOpTest__AddSubtractDouble testClass)
            {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Avx.AddSubtract(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Avx)}.{nameof(Avx.AddSubtract)}<Double>(Vector256<Double>, Vector256<Double>): {method} failed:"
                    );
