...
namespace JIT.HardwareIntrinsics.X86
{
    public static partial class Program
    {
        ...
        {
            var test = new ImmBinaryOpTest__InsertVector128UInt321();
    ...
    public sealed unsafe class ImmBinaryOpTest__InsertVector128UInt321
    {
        private struct TestStruct
        {
            ...
            public static TestStruct Create()
            {
                ...
                Unsafe.CopyBlockUnaligned(
                    ref Unsafe.As<Vector256<UInt32>, byte>(ref testStruct._fld1),
                    ref Unsafe.As<UInt32, byte>(ref _data1[0]),
                    (uint)Unsafe.SizeOf<Vector256<UInt32>>()
                );
                ...
                Unsafe.CopyBlockUnaligned(
                    ref Unsafe.As<Vector128<UInt32>, byte>(ref testStruct._fld2),
            ...
            public void RunStructFldScenario(ImmBinaryOpTest__InsertVector128UInt321 testClass)
            {
        ...
        static ImmBinaryOpTest__InsertVector128UInt321()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetUInt32();
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector256<UInt32>, byte>(ref _clsVar1),
                ref Unsafe.As<UInt32, byte>(ref _data1[0]),
                (uint)Unsafe.SizeOf<Vector256<UInt32>>()
            );
            for (var i = 0; i < Op2ElementCount; i++)
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector128<UInt32>, byte>(ref _clsVar2),
                ref Unsafe.As<UInt32, byte>(ref _data2[0]),
                (uint)Unsafe.SizeOf<Vector128<UInt32>>()
            );
        }

        public ImmBinaryOpTest__InsertVector128UInt321()
        {
            Succeeded = true;
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector256<UInt32>, byte>(ref _fld1),
                ref Unsafe.As<UInt32, byte>(ref _data1[0]),
                (uint)Unsafe.SizeOf<Vector256<UInt32>>()
            );
            for (var i = 0; i < Op2ElementCount; i++)
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector128<UInt32>, byte>(ref _fld2),
                ref Unsafe.As<UInt32, byte>(ref _data2[0]),
                (uint)Unsafe.SizeOf<Vector128<UInt32>>()
            );
            ...
            _dataTable = new SimpleBinaryOpTest__DataTable<UInt32, UInt32, UInt32>(
                _data1,
                _data2,
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var result = Avx.InsertVector128(
                ...
                Avx.LoadVector128((UInt32*)(_dataTable.inArray2Ptr)),
                1
            );
        ...
        public void RunBasicScenario_LoadAligned()
        {
            ...
            var result = Avx.InsertVector128(
                ...
                Avx.LoadAlignedVector128((UInt32*)(_dataTable.inArray2Ptr)),
                1
            );
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Avx.InsertVector128(_clsVar1, _clsVar2, 1);
        ...
        public void RunLclVarScenario_Load()
        {
            ...
            var right = Avx.LoadVector128((UInt32*)(_dataTable.inArray2Ptr));
            var result = Avx.InsertVector128(left, right, 1);
        ...
        public void RunLclVarScenario_LoadAligned()
        {
            ...
            var right = Avx.LoadAlignedVector128((UInt32*)(_dataTable.inArray2Ptr));
            var result = Avx.InsertVector128(left, right, 1);
        ...
        private void ValidateResult(
            Vector256<UInt32> left,
            Vector128<UInt32> right,
            void* result,
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Avx)}.{nameof(Avx.InsertVector128)}<UInt32>(Vector256<UInt32>.1, Vector128<UInt32>): {method} failed:"
                    );
