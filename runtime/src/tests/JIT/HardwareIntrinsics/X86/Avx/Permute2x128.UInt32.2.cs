...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    public sealed unsafe class ImmBinaryOpTest__Permute2x128UInt322
    {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Avx.Permute2x128(_clsVar1, _clsVar2, 2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Avx)}.{nameof(Avx.Permute2x128)}<UInt32>(Vector256<UInt32>.2, Vector256<UInt32>): {method} failed:"
                    );
