    ...
    public sealed unsafe class SimpleBinaryOpTest__CompareGreaterThanOrEqualDouble
    {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Avx)
                .GetMethod(
                    nameof(Avx.CompareGreaterThanOrEqual),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Avx.CompareGreaterThanOrEqual(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Avx)}.{nameof(Avx.CompareGreaterThanOrEqual)}<Double>(Vector256<Double>, Vector256<Double>): {method} failed:"
                    );
