    ...
    public sealed unsafe class SimpleUnaryOpTest__RoundToNearestIntegerSingle
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__RoundToNearestIntegerSingle testClass
            )
            {
            ...
            )
            {
                ...
                {
                    var result = Avx.RoundToNearestInteger(Avx.LoadVector256((Single*)(pFld1)));
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Avx)
                .GetMethod(
                    nameof(Avx.RoundToNearestInteger),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Avx.RoundToNearestInteger(_clsVar1);
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            {
                var result = Avx.RoundToNearestInteger(Avx.LoadVector256((Single*)(pClsVar1)));
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = Avx.RoundToNearestInteger(Avx.LoadVector256((Single*)(&test._fld1)));
        ...
        )
        {
            ...
            if (
                ...
                != BitConverter.SingleToInt32Bits(
                    MathF.Round(firstOp[0], MidpointRounding.AwayFromZero)
                )
            )
            {
                succeeded = false;
            ...
            else
            {
                for (var i = 1; i < RetElementCount; i++)
                {
                    if (
                        ...
                        != BitConverter.SingleToInt32Bits(
                            MathF.Round(firstOp[i], MidpointRounding.AwayFromZero)
                        )
                    )
                    {
                        succeeded = false;
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Avx)}.{nameof(Avx.RoundToNearestInteger)}<Single>(Vector256<Single>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
