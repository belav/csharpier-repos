    ...
    public sealed unsafe class SimpleBinaryOpTest__CompareNotLessThanOrEqualDouble
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__CompareNotLessThanOrEqualDouble testClass
            )
            {
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework
                    .LogInformation(
                        $"{nameof(Avx)}.{nameof(Avx.CompareNotLessThanOrEqual)}<Double>(Vector256<Double>, Vector256<Double>): {method} failed:"
                    );
