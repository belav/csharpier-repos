    ...
    public sealed unsafe class SimpleUnaryOpTest__RoundToPositiveInfinityDouble
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__RoundToPositiveInfinityDouble testClass
            )
            {
            ...
            )
            {
                ...
                {
                    var result = Avx.RoundToPositiveInfinity(Avx.LoadVector256((Double*)(pFld1)));
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Avx.RoundToPositiveInfinity(_clsVar1);
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            {
                var result = Avx.RoundToPositiveInfinity(Avx.LoadVector256((Double*)(pClsVar1)));
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = Avx.RoundToPositiveInfinity(Avx.LoadVector256((Double*)(&test._fld1)));
        ...
        )
        {
            ...
            if (
                ...
                != BitConverter.DoubleToInt64Bits(Math.Ceiling(firstOp[0]))
            )
            {
                succeeded = false;
            }
            else
            {
                for (var i = 1; i < RetElementCount; i++)
                {
                    if (
                        ...
                        != BitConverter.DoubleToInt64Bits(Math.Ceiling(firstOp[i]))
                    )
                    {
                        succeeded = false;
                        break;
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Avx)}.{nameof(Avx.RoundToPositiveInfinity)}<Double>(Vector256<Double>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
