    ...
    public sealed unsafe class SimpleUnaryOpTest__DuplicateEvenIndexedDouble
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__DuplicateEvenIndexedDouble testClass
            )
            {
            ...
            )
            {
                ...
                {
                    var result = Avx.DuplicateEvenIndexed(Avx.LoadVector256((Double*)(pFld1)));
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Avx)
                .GetMethod(
                    nameof(Avx.DuplicateEvenIndexed),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Avx.DuplicateEvenIndexed(_clsVar1);
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            {
                var result = Avx.DuplicateEvenIndexed(Avx.LoadVector256((Double*)(pClsVar1)));
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = Avx.DuplicateEvenIndexed(Avx.LoadVector256((Double*)(&test._fld1)));
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(Avx)}.{nameof(Avx.DuplicateEvenIndexed)}<Double>(Vector256<Double>): {method} failed:"
                );
                TestLibrary.TestFramework.LogInformation(
