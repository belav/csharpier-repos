    ...
    public sealed unsafe class SimpleBinaryOpTest__CompareNotLessThanSingle
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario_Load(
                SimpleBinaryOpTest__CompareNotLessThanSingle testClass
            )
            {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Avx.CompareNotLessThan(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(Avx)}.{nameof(Avx.CompareNotLessThan)}<Single>(Vector256<Single>, Vector256<Single>): {method} failed:"
                );
