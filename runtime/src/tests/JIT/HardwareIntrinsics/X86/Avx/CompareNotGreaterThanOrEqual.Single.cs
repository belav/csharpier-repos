    ...
    public sealed unsafe class SimpleBinaryOpTest__CompareNotGreaterThanOrEqualSingle
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__CompareNotGreaterThanOrEqualSingle testClass
            )
            {
            ...
            {
                fixed (Vector256<Single>* pFld1 = &_fld1)fixed (Vector256<Single>* pFld2 = &_fld2)
                {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Avx).GetMethod(
                    nameof(Avx.CompareNotGreaterThanOrEqual),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Avx.CompareNotGreaterThanOrEqual(_clsVar1, _clsVar2);
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            fixed (Vector256<Single>* pClsVar1 = &_clsVar1)fixed (
                Vector256<Single>* pClsVar2 = &_clsVar2
            )
            {
                var result = Avx.CompareNotGreaterThanOrEqual(
        ...
        public void RunClassLclFldScenario_Load()
        {
            ...
            fixed (Vector256<Single>* pFld1 = &test._fld1)fixed (
                Vector256<Single>* pFld2 = &test._fld2
            )
            {
                var result = Avx.CompareNotGreaterThanOrEqual(
                    Avx.LoadVector256((Single*)(pFld1)),
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(Avx)}.{nameof(Avx.CompareNotGreaterThanOrEqual)}<Single>(Vector256<Single>, Vector256<Single>): {method} failed:"
                );
