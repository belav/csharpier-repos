...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    public sealed unsafe class SimpleUnaryOpTest__LoadVector256Int32
    {
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var result = Avx.LoadVector256((Int32*)(_dataTable.inArrayPtr));
        ...
        public void RunReflectionScenario_Load()
        {
            ...
            var result = typeof(Avx)
                .GetMethod(nameof(Avx.LoadVector256), new Type[] { typeof(Int32*) })
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Avx)}.{nameof(Avx.LoadVector256)}<Int32>(Vector256<Int32>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
