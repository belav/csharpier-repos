    ...
    public sealed unsafe class SimpleBinaryOpTest__CompareNotGreaterThanSingle
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__CompareNotGreaterThanSingle testClass
            )
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Avx).GetMethod(
                    nameof(Avx.CompareNotGreaterThan),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Avx.CompareNotGreaterThan(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(Avx)}.{nameof(Avx.CompareNotGreaterThan)}<Single>(Vector256<Single>, Vector256<Single>): {method} failed:"
                );
