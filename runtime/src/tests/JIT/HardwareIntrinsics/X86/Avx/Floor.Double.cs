    ...
    public sealed unsafe class SimpleUnaryOpTest__FloorDouble
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario_Load(SimpleUnaryOpTest__FloorDouble testClass)
            {
                ...
                {
                    var result = Avx.Floor(Avx.LoadVector256((Double*)(pFld1)));
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = Avx.Floor(Unsafe.Read<Vector256<Double>>(_dataTable.inArray1Ptr));
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var result = Avx.Floor(Avx.LoadVector256((Double*)(_dataTable.inArray1Ptr)));
        ...
        public void RunBasicScenario_LoadAligned()
        {
            ...
            var result = Avx.Floor(Avx.LoadAlignedVector256((Double*)(_dataTable.inArray1Ptr)));
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            {
                var result = Avx.Floor(Avx.LoadVector256((Double*)(pClsVar1)));
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = Avx.Floor(Avx.LoadVector256((Double*)(&test._fld1)));
