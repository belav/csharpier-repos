    ...
    public sealed unsafe class SimpleUnaryOpTest__RoundToZeroSingle
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario_Load(SimpleUnaryOpTest__RoundToZeroSingle testClass)
            {
                ...
                {
                    var result = Avx.RoundToZero(Avx.LoadVector256((Single*)(pFld1)));
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = Avx.RoundToZero(Unsafe.Read<Vector256<Single>>(_dataTable.inArray1Ptr));
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var result = Avx.RoundToZero(Avx.LoadVector256((Single*)(_dataTable.inArray1Ptr)));
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Avx.RoundToZero(_clsVar1);
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            {
                var result = Avx.RoundToZero(Avx.LoadVector256((Single*)(pClsVar1)));
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = Avx.RoundToZero(Avx.LoadVector256((Single*)(&test._fld1)));
        ...
        )
        {
            ...
            if (
                ...
                != BitConverter.SingleToInt32Bits(
                    (firstOp[0] > 0) ? MathF.Floor(firstOp[0]) : MathF.Ceiling(firstOp[0])
                )
            )
            {
                succeeded = false;
            ...
            else
            {
                for (var i = 1; i < RetElementCount; i++)
                {
                    if (
                        ...
                        != BitConverter.SingleToInt32Bits(
                            (firstOp[i] > 0) ? MathF.Floor(firstOp[i]) : MathF.Ceiling(firstOp[i])
                        )
                    )
                    {
                        succeeded = false;
