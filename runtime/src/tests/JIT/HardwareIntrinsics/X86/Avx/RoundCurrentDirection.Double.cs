    ...
    public sealed unsafe class SimpleUnaryOpTest__RoundCurrentDirectionDouble
    {
        ...
        private struct TestStruct
        {
            ...
            )
            {
                ...
                {
                    var result = Avx.RoundCurrentDirection(Avx.LoadVector256((Double*)(pFld1)));
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            {
                var result = Avx.RoundCurrentDirection(Avx.LoadVector256((Double*)(pClsVar1)));
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = Avx.RoundCurrentDirection(Avx.LoadVector256((Double*)(&test._fld1)));
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Avx)}.{nameof(Avx.RoundCurrentDirection)}<Double>(Vector256<Double>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
