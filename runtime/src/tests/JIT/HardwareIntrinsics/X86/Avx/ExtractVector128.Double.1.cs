    ...
    public sealed unsafe class ImmUnaryOpTest__ExtractVector128Double1
    {
        private struct TestStruct
        {
            ...
            public static TestStruct Create()
            {
                ...
                Unsafe.CopyBlockUnaligned(
                    ref Unsafe.As<Vector256<Double>, byte>(ref testStruct._fld),
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Avx)
                .GetMethod(
                    ...
                    new Type[] { typeof(Vector256<Double>), typeof(byte) }
                )
                .Invoke(
                    null,
                    new object[] { Unsafe.Read<Vector256<Double>>(_dataTable.inArrayPtr), (byte)1 }
                );
        ...
        public void RunReflectionScenario_Load()
        {
            ...
            var result = typeof(Avx)
                ...
                .Invoke(
                    null,
                    new object[] { Avx.LoadVector256((Double*)(_dataTable.inArrayPtr)), (byte)1 }
                );
        ...
        )
        {
            ...
            else
            {
                for (var i = 1; i < RetElementCount; i++)
                {
                    if (
                        ...
                        != BitConverter.DoubleToInt64Bits(firstOp[i + 2])
                    )
                    {
                        succeeded = false;
                        break;
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Avx)}.{nameof(Avx.ExtractVector128)}<Double>(Vector256<Double><9>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
