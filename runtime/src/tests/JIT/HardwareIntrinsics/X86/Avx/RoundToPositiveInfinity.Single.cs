    ...
    public sealed unsafe class SimpleUnaryOpTest__RoundToPositiveInfinitySingle
    {
        ...
        private struct TestStruct
        {
            ...
            )
            {
                ...
                {
                    var result = Avx.RoundToPositiveInfinity(Avx.LoadVector256((Single*)(pFld1)));
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            {
                var result = Avx.RoundToPositiveInfinity(Avx.LoadVector256((Single*)(pClsVar1)));
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = Avx.RoundToPositiveInfinity(Avx.LoadVector256((Single*)(&test._fld1)));
