...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    public sealed unsafe class ImmUnaryOpTest__ExtractVector128Byte1
    {
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var result = Avx.ExtractVector128(Avx.LoadVector256((Byte*)(_dataTable.inArrayPtr)), 1);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Avx)}.{nameof(Avx.ExtractVector128)}<Byte>(Vector256<Byte><9>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
