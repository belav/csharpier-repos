...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    public sealed unsafe class SimpleBinaryOpTest__PermuteVarDouble
    {
        ...
        private struct TestStruct
        {
            ...
            {
                fixed (Vector128<Double>* pFld1 = &_fld1)fixed (Vector128<Int64>* pFld2 = &_fld2)
                {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Avx).GetMethod(
                    ...
                    new Type[] { typeof(Vector128<Double>), typeof(Vector128<Int64>) }
                )
                .Invoke(
                    null,
                    new object[]
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(Avx)}.{nameof(Avx.PermuteVar)}<Double>(Vector128<Double>, Vector128<Int64>): {method} failed:"
                );
