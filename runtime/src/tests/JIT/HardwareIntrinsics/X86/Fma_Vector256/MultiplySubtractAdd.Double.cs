    ...
    public sealed unsafe class AlternatingTernaryOpTest__MultiplySubtractAddDouble
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                AlternatingTernaryOpTest__MultiplySubtractAddDouble testClass
            )
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Fma)
                .GetMethod(
                    nameof(Fma.MultiplySubtractAdd),
                    new Type[]
                    {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Fma.MultiplySubtractAdd(_clsVar1, _clsVar2, _clsVar3);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Fma)}.{nameof(Fma.MultiplySubtractAdd)}<Double>(Vector256<Double>, Vector256<Double>, Vector256<Double>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
