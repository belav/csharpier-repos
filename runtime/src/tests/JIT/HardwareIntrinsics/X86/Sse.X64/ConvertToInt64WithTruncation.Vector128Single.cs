...
namespace JIT.HardwareIntrinsics.X86
{
    public static partial class Program
    {
        ...
        {
            var test =
                new SimdScalarUnaryOpConvertTest__ConvertToInt64WithTruncationVector128Single();
    ...
    public sealed unsafe class SimdScalarUnaryOpConvertTest__ConvertToInt64WithTruncationVector128Single
    {
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimdScalarUnaryOpConvertTest__ConvertToInt64WithTruncationVector128Single testClass
            )
            {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Sse.X64.ConvertToInt64WithTruncation(_clsVar);
