    ...
    public sealed unsafe class BooleanBinaryOpTest__CompareScalarUnorderedNotEqualBoolean
    {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Sse)
                .GetMethod(
                    nameof(Sse.CompareScalarUnorderedNotEqual),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Sse.CompareScalarUnorderedNotEqual(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(Sse)}.{nameof(Sse.CompareScalarUnorderedNotEqual)}<Boolean>(Vector128<Single>, Vector128<Single>): {method} failed:"
                );
