    ...
    public sealed unsafe class BooleanBinaryOpTest__CompareScalarUnorderedEqualBoolean
    {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Sse)
                .GetMethod(
                    nameof(Sse.CompareScalarUnorderedEqual),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Sse.CompareScalarUnorderedEqual(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(Sse)}.{nameof(Sse.CompareScalarUnorderedEqual)}<Boolean>(Vector128<Single>, Vector128<Single>): {method} failed:"
                );
