...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    public sealed unsafe class StoreBinaryOpTest__MaskStoreUInt32
    {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            typeof(Avx2).GetMethod(
                    nameof(Avx2.MaskStore),
                    new Type[]
                    {
                        typeof(UInt32*),
        ...
        public void RunClsVarScenario()
        {
            ...
            Avx2.MaskStore((UInt32*)_dataTable.outArrayPtr, _clsVar1, _clsVar2);
        ...
        private void ValidateResult(
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(Avx2)}.{nameof(Avx2.MaskStore)}<UInt32>(Vector128<UInt32>, Vector128<UInt32>): {method} failed:"
                );
