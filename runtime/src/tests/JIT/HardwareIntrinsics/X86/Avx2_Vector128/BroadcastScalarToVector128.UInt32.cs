...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    public sealed unsafe class SimpleUnaryOpTest__BroadcastScalarToVector128UInt32
    {
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var result = Avx2.BroadcastScalarToVector128((UInt32*)(_dataTable.inArrayPtr));
        ...
        public void RunReflectionScenario_Load()
        {
            ...
            var result = typeof(Avx2)
                .GetMethod(nameof(Avx2.BroadcastScalarToVector128), new Type[] { typeof(UInt32*) })
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Avx2)}.{nameof(Avx2.BroadcastScalarToVector128)}<UInt32>(Vector128<UInt32>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
