...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    {
        private static void BlendInt321()
        {
            var test = new ImmBinaryOpTest__BlendInt321();
    ...
    public sealed unsafe class ImmBinaryOpTest__BlendInt321
    {
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(ImmBinaryOpTest__BlendInt321 testClass)
            {
        ...
        public ImmBinaryOpTest__BlendInt321()
        {
            Succeeded = true;
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Avx2.Blend(_clsVar1, _clsVar2, 1);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Avx2)}.{nameof(Avx2.Blend)}<Int32>(Vector128<Int32>.1, Vector128<Int32>): {method} failed:"
                    );
