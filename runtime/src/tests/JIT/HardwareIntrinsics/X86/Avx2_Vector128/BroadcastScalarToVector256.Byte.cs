...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    public sealed unsafe class SimpleUnaryOpTest__BroadcastScalarToVector256Byte
    {
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var result = Avx2.BroadcastScalarToVector256((Byte*)(_dataTable.inArrayPtr));
        ...
        public void RunReflectionScenario_Load()
        {
            ...
            var result = typeof(Avx2)
                .GetMethod(nameof(Avx2.BroadcastScalarToVector256), new Type[] { typeof(Byte*) })
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Avx2)}.{nameof(Avx2.BroadcastScalarToVector256)}<Byte>(Vector128<Byte>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
