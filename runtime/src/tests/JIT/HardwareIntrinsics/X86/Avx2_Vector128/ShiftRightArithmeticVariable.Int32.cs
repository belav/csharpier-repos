    ...
    public sealed unsafe class SimpleBinaryOpTest__ShiftRightArithmeticVariableInt32
    {
        ...
        private struct TestStruct
        {
            ...
            public static TestStruct Create()
            {
                ...
                {
                    _data2[i] = (TestLibrary.Generator.GetUInt32() % 32);
                }
                Unsafe.CopyBlockUnaligned(
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Avx2)
                .GetMethod(
                    nameof(Avx2.ShiftRightArithmeticVariable),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Avx2.ShiftRightArithmeticVariable(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Avx2)}.{nameof(Avx2.ShiftRightArithmeticVariable)}<Int32>(Vector128<Int32>, Vector128<UInt32>): {method} failed:"
                    );
