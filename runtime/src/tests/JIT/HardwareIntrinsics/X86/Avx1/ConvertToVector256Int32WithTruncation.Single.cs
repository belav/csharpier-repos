    ...
    public sealed unsafe class SimpleUnaryOpTest__ConvertToVector256Int32WithTruncationSingle
    {
        ...
        static SimpleUnaryOpTest__ConvertToVector256Int32WithTruncationSingle()
        {
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector256<Single>, byte>(ref _clsVar),
        ...
        public SimpleUnaryOpTest__ConvertToVector256Int32WithTruncationSingle()
        {
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector256<Single>, byte>(ref _fld),
                ref Unsafe.As<Single, byte>(ref _data[0]),
                (uint)Unsafe.SizeOf<Vector256<Single>>()
            );
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            var result = typeof(Avx)
                .GetMethod(
                    nameof(Avx.ConvertToVector256Int32WithTruncation),
                    new Type[] { typeof(Vector256<Single>) }
                )
                .Invoke(
                    null,
                    new object[] { Unsafe.Read<Vector256<Single>>(_dataTable.inArrayPtr) }
                );
        ...
        public void RunReflectionScenario_LoadAligned()
        {
            var result = typeof(Avx)
                ...
                .Invoke(
                    null,
                    new object[] { Avx.LoadAlignedVector256((Single*)(_dataTable.inArrayPtr)) }
                );
        ...
        {
            var result = Avx.ConvertToVector256Int32WithTruncation(_clsVar);
        ...
        )
        {
            ...
            {
                Console.WriteLine(
                    $"{nameof(Avx)}.{nameof(Avx.ConvertToVector256Int32WithTruncation)}(Vector256<Single>): {method} failed:"
                );
