...
namespace JIT.HardwareIntrinsics.X86
{
    partial public static class Program
    {
        ...
        {
            var test = new ImmBinaryOpTest__InsertVector128UInt641();
    ...
    public sealed unsafe class ImmBinaryOpTest__InsertVector128UInt641
    {
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(ImmBinaryOpTest__InsertVector128UInt641 testClass)
            {
        ...
        static ImmBinaryOpTest__InsertVector128UInt641()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetUInt64();
        ...
        public ImmBinaryOpTest__InsertVector128UInt641()
        {
            Succeeded = true;
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var result = Avx.InsertVector128(
                ...
                Avx.LoadVector128((UInt64*)(_dataTable.inArray2Ptr)),
                1
            );
        ...
        public void RunBasicScenario_LoadAligned()
        {
            ...
            var result = Avx.InsertVector128(
                ...
                Avx.LoadAlignedVector128((UInt64*)(_dataTable.inArray2Ptr)),
                1
            );
        ...
        public void RunLclVarScenario_Load()
        {
            ...
            var right = Avx.LoadVector128((UInt64*)(_dataTable.inArray2Ptr));
            var result = Avx.InsertVector128(left, right, 1);
        ...
        public void RunLclVarScenario_LoadAligned()
        {
            ...
            var right = Avx.LoadAlignedVector128((UInt64*)(_dataTable.inArray2Ptr));
            var result = Avx.InsertVector128(left, right, 1);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(Avx)}.{nameof(Avx.InsertVector128)}<UInt64>(Vector256<UInt64>.1, Vector128<UInt64>): {method} failed:"
                );
