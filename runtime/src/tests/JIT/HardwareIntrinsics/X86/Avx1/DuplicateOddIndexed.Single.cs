    ...
    public sealed unsafe class SimpleUnaryOpTest__DuplicateOddIndexedSingle
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario_Load(
                SimpleUnaryOpTest__DuplicateOddIndexedSingle testClass
            )
            {
                fixed (Vector256<Single>* pFld1 = &_fld1)
                {
                    var result = Avx.DuplicateOddIndexed(Avx.LoadVector256((Single*)(pFld1)));
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Avx)
                .GetMethod(
                    nameof(Avx.DuplicateOddIndexed),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Avx.DuplicateOddIndexed(_clsVar1);
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            {
                var result = Avx.DuplicateOddIndexed(Avx.LoadVector256((Single*)(pClsVar1)));
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = Avx.DuplicateOddIndexed(Avx.LoadVector256((Single*)(&test._fld1)));
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(Avx)}.{nameof(Avx.DuplicateOddIndexed)}<Single>(Vector256<Single>): {method} failed:"
                );
                TestLibrary.TestFramework.LogInformation(
