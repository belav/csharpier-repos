...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    public sealed unsafe class ImmUnaryOpTest__ExtractVector128Int161
    {
        private struct TestStruct
        {
            ...
            public static TestStruct Create()
            {
                ...
                Unsafe.CopyBlockUnaligned(
                    ref Unsafe.As<Vector256<Int16>, byte>(ref testStruct._fld),
            ...
            public void RunStructFldScenario(ImmUnaryOpTest__ExtractVector128Int161 testClass)
            {
        ...
        static ImmUnaryOpTest__ExtractVector128Int161()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data[i] = TestLibrary.Generator.GetInt16();
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector256<Int16>, byte>(ref _clsVar),
                ref Unsafe.As<Int16, byte>(ref _data[0]),
                (uint)Unsafe.SizeOf<Vector256<Int16>>()
            );
        }

        public ImmUnaryOpTest__ExtractVector128Int161()
        {
            Succeeded = true;
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector256<Int16>, byte>(ref _fld),
                ref Unsafe.As<Int16, byte>(ref _data[0]),
                (uint)Unsafe.SizeOf<Vector256<Int16>>()
            );
            ...
            _dataTable = new SimpleUnaryOpTest__DataTable<Int16, Int16>(
                _data,
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Avx)
                .GetMethod(
                    nameof(Avx.ExtractVector128),
                    new Type[] { typeof(Vector256<Int16>), typeof(byte) }
                )
                .Invoke(
                    null,
                    new object[] { Unsafe.Read<Vector256<Int16>>(_dataTable.inArrayPtr), (byte)1 }
                );
        ...
        public void RunReflectionScenario_Load()
        {
            ...
            var result = typeof(Avx)
                ...
                .Invoke(
                    null,
                    new object[] { Avx.LoadVector256((Int16*)(_dataTable.inArrayPtr)), (byte)1 }
                );
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Avx.ExtractVector128(_clsVar, 1);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Avx)}.{nameof(Avx.ExtractVector128)}<Int16>(Vector256<Int16><9>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
