...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    public sealed unsafe class ImmBinaryOpTest__InsertVector128UInt161
    {
        ...
        public ImmBinaryOpTest__InsertVector128UInt161()
        {
            ...
            _dataTable = new SimpleBinaryOpTest__DataTable<UInt16, UInt16, UInt16>(
                _data1,
                _data2,
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(Avx)}.{nameof(Avx.InsertVector128)}<UInt16>(Vector256<UInt16>.1, Vector128<UInt16>): {method} failed:"
                );
