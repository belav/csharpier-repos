    ...
    public sealed unsafe class SimpleUnaryOpTest__ConvertToVector256Int32Single
    {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            var result = typeof(Avx)
                .GetMethod(
                    nameof(Avx.ConvertToVector256Int32),
        ...
        {
            var result = Avx.ConvertToVector256Int32(_clsVar);
        ...
        )
        {
            ...
            {
                Console.WriteLine(
                    $"{nameof(Avx)}.{nameof(Avx.ConvertToVector256Int32)}(Vector256<Single>): {method} failed:"
                );
