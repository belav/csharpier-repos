    ...
    public sealed unsafe class SimpleBinaryOpTest__CompareLessThanOrEqualSingle
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__CompareLessThanOrEqualSingle testClass
            )
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Avx)
                .GetMethod(
                    nameof(Avx.CompareLessThanOrEqual),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Avx.CompareLessThanOrEqual(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(Avx)}.{nameof(Avx.CompareLessThanOrEqual)}<Single>(Vector256<Single>, Vector256<Single>): {method} failed:"
                );
