    ...
    public sealed unsafe class SimpleUnaryOpTest__RoundToNegativeInfinityDouble
    {
        ...
        private struct TestStruct
        {
            ...
            )
            {
                ...
                {
                    var result = Avx.RoundToNegativeInfinity(Avx.LoadVector256((Double*)(pFld1)));
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Avx)
                .GetMethod(
                    nameof(Avx.RoundToNegativeInfinity),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Avx.RoundToNegativeInfinity(_clsVar1);
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            {
                var result = Avx.RoundToNegativeInfinity(Avx.LoadVector256((Double*)(pClsVar1)));
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = Avx.RoundToNegativeInfinity(Avx.LoadVector256((Double*)(&test._fld1)));
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Avx)}.{nameof(Avx.RoundToNegativeInfinity)}<Double>(Vector256<Double>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
