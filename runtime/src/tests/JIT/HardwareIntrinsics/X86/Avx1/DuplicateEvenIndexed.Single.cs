...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    {
        private static void DuplicateEvenIndexedSingle()
        {
    ...
    public sealed unsafe class SimpleUnaryOpTest__DuplicateEvenIndexedSingle
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleUnaryOpTest__DuplicateEvenIndexedSingle testClass
            )
            {
            ...
            )
            {
                ...
                {
                    var result = Avx.DuplicateEvenIndexed(Avx.LoadVector256((Single*)(pFld1)));
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            {
                var result = Avx.DuplicateEvenIndexed(Avx.LoadVector256((Single*)(pClsVar1)));
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = Avx.DuplicateEvenIndexed(Avx.LoadVector256((Single*)(&test._fld1)));
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(Avx)}.{nameof(Avx.DuplicateEvenIndexed)}<Single>(Vector256<Single>): {method} failed:"
                );
                TestLibrary.TestFramework.LogInformation(
