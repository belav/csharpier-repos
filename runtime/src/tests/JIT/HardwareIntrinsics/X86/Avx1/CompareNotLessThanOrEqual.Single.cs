    ...
    public sealed unsafe class SimpleBinaryOpTest__CompareNotLessThanOrEqualSingle
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__CompareNotLessThanOrEqualSingle testClass
            )
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Avx)
                .GetMethod(
                    nameof(Avx.CompareNotLessThanOrEqual),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Avx.CompareNotLessThanOrEqual(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(Avx)}.{nameof(Avx.CompareNotLessThanOrEqual)}<Single>(Vector256<Single>, Vector256<Single>): {method} failed:"
                );
