...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    public sealed unsafe class ImmBinaryOpTest__InsertVector128Int641
    {
        private struct TestStruct
        {
            ...
            public static TestStruct Create()
            {
                ...
                Unsafe.CopyBlockUnaligned(
                    ref Unsafe.As<Vector256<Int64>, byte>(ref testStruct._fld1),
            ...
            public void RunStructFldScenario(ImmBinaryOpTest__InsertVector128Int641 testClass)
            {
        ...
        static ImmBinaryOpTest__InsertVector128Int641()
        {
            for (var i = 0; i < Op1ElementCount; i++)
            {
                _data1[i] = TestLibrary.Generator.GetInt64();
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector256<Int64>, byte>(ref _clsVar1),
                ref Unsafe.As<Int64, byte>(ref _data1[0]),
                (uint)Unsafe.SizeOf<Vector256<Int64>>()
            );
            for (var i = 0; i < Op2ElementCount; i++)
        ...
        public ImmBinaryOpTest__InsertVector128Int641()
        {
            Succeeded = true;
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector256<Int64>, byte>(ref _fld1),
                ref Unsafe.As<Int64, byte>(ref _data1[0]),
                (uint)Unsafe.SizeOf<Vector256<Int64>>()
            );
            for (var i = 0; i < Op2ElementCount; i++)
            ...
            _dataTable = new SimpleBinaryOpTest__DataTable<Int64, Int64, Int64>(
                _data1,
                _data2,
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Avx)
                .GetMethod(
                    ...
                    new Type[] { typeof(Vector256<Int64>), typeof(Vector128<Int64>), typeof(byte) }
                )
                .Invoke(
                    null,
                    new object[]
        ...
        private void ValidateResult(
            Vector256<Int64> left,
            Vector128<Int64> right,
            void* result,
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Avx)}.{nameof(Avx.InsertVector128)}<Int64>(Vector256<Int64>.1, Vector128<Int64>): {method} failed:"
                    );
