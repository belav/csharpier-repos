    ...
    public sealed unsafe class ImmUnaryOpTest__ExtractVector128Single1
    {
        private struct TestStruct
        {
            ...
            public static TestStruct Create()
            {
                ...
                Unsafe.CopyBlockUnaligned(
                    ref Unsafe.As<Vector256<Single>, byte>(ref testStruct._fld),
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Avx)
                .GetMethod(
                    ...
                    new Type[] { typeof(Vector256<Single>), typeof(byte) }
                )
                .Invoke(
                    null,
                    new object[] { Unsafe.Read<Vector256<Single>>(_dataTable.inArrayPtr), (byte)1 }
                );
        ...
        public void RunReflectionScenario_Load()
        {
            ...
            var result = typeof(Avx)
                ...
                .Invoke(
                    null,
                    new object[] { Avx.LoadVector256((Single*)(_dataTable.inArrayPtr)), (byte)1 }
                );
        ...
        )
        {
            ...
            if (
                ...
                != BitConverter.SingleToInt32Bits(firstOp[4])
            )
            {
                succeeded = false;
            }
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(Avx)}.{nameof(Avx.ExtractVector128)}<Single>(Vector256<Single><9>): {method} failed:"
                );
                TestLibrary.TestFramework.LogInformation(
