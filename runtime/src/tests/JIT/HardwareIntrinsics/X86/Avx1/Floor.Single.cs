    ...
    public sealed unsafe class SimpleUnaryOpTest__FloorSingle
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario_Load(SimpleUnaryOpTest__FloorSingle testClass)
            {
                ...
                {
                    var result = Avx.Floor(Avx.LoadVector256((Single*)(pFld1)));
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = Avx.Floor(Unsafe.Read<Vector256<Single>>(_dataTable.inArray1Ptr));
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var result = Avx.Floor(Avx.LoadVector256((Single*)(_dataTable.inArray1Ptr)));
        ...
        public void RunBasicScenario_LoadAligned()
        {
            ...
            var result = Avx.Floor(Avx.LoadAlignedVector256((Single*)(_dataTable.inArray1Ptr)));
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Avx)
                .GetMethod(nameof(Avx.Floor), new Type[] { typeof(Vector256<Single>) })
                .Invoke(
                    null,
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            {
                var result = Avx.Floor(Avx.LoadVector256((Single*)(pClsVar1)));
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = Avx.Floor(Avx.LoadVector256((Single*)(&test._fld1)));
        ...
        )
        {
            ...
            if (
                ...
                != BitConverter.SingleToInt32Bits(MathF.Floor(firstOp[0]))
            )
            {
                succeeded = false;
            }
            else
            {
                for (var i = 1; i < RetElementCount; i++)
                {
                    if (
                        ...
                        != BitConverter.SingleToInt32Bits(MathF.Floor(firstOp[i]))
                    )
                    {
                        succeeded = false;
                        break;
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Avx)}.{nameof(Avx.Floor)}<Single>(Vector256<Single>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
