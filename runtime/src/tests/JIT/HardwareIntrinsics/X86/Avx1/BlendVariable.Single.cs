    ...
    public sealed unsafe class SimpleTernaryOpTest__BlendVariableSingle
    {
        ...
        private struct TestStruct
        {
            ...
            public static TestStruct Create()
            {
                ...
                Unsafe.CopyBlockUnaligned(
                    ref Unsafe.As<Vector256<Single>, byte>(ref testStruct._fld3),
        ...
        static SimpleTernaryOpTest__BlendVariableSingle()
        {
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector256<Single>, byte>(ref _clsVar3),
                ref Unsafe.As<Single, byte>(ref _data3[0]),
                (uint)Unsafe.SizeOf<Vector256<Single>>()
            );
        }
        ...
        public SimpleTernaryOpTest__BlendVariableSingle()
        {
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector256<Single>, byte>(ref _fld3),
                ref Unsafe.As<Single, byte>(ref _data3[0]),
                (uint)Unsafe.SizeOf<Vector256<Single>>()
            );
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Avx.BlendVariable(_clsVar1, _clsVar2, _clsVar3);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Avx)}.{nameof(Avx.BlendVariable)}<Single>(Vector256<Single>, Vector256<Single>, Vector256<Single>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
