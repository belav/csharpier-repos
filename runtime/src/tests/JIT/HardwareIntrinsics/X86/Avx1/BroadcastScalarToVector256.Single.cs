...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    public sealed unsafe class SimpleUnaryOpTest__BroadcastScalarToVector256Single
    {
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var result = Avx.BroadcastScalarToVector256((Single*)(_dataTable.inArrayPtr));
        ...
        public void RunReflectionScenario_Load()
        {
            ...
            var result = typeof(Avx)
                .GetMethod(nameof(Avx.BroadcastScalarToVector256), new Type[] { typeof(Single*) })
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(Avx)}.{nameof(Avx.BroadcastScalarToVector256)}<Single>(Vector128<Single>): {method} failed:"
                );
                TestLibrary.TestFramework.LogInformation(
