    ...
    public sealed unsafe class SimpleUnaryOpTest__RoundCurrentDirectionSingle
    {
        ...
        private struct TestStruct
        {
            ...
            )
            {
                ...
                {
                    var result = Avx.RoundCurrentDirection(Avx.LoadVector256((Single*)(pFld1)));
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Avx)
                .GetMethod(
                    nameof(Avx.RoundCurrentDirection),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Avx.RoundCurrentDirection(_clsVar1);
        ...
        public void RunClsVarScenario_Load()
        {
            ...
            {
                var result = Avx.RoundCurrentDirection(Avx.LoadVector256((Single*)(pClsVar1)));
        ...
        public void RunStructLclFldScenario_Load()
        {
            ...
            var test = TestStruct.Create();
            var result = Avx.RoundCurrentDirection(Avx.LoadVector256((Single*)(&test._fld1)));
        ...
        )
        {
            ...
            else
            {
                for (var i = 1; i < RetElementCount; i++)
                {
                    if (
                        ...
                        != BitConverter.SingleToInt32Bits(MathF.Round(firstOp[i]))
                    )
                    {
                        succeeded = false;
                        break;
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(Avx)}.{nameof(Avx.RoundCurrentDirection)}<Single>(Vector256<Single>): {method} failed:"
                );
                TestLibrary.TestFramework.LogInformation(
