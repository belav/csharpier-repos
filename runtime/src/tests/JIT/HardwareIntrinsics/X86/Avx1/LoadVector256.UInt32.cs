...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    public sealed unsafe class SimpleUnaryOpTest__LoadVector256UInt32
    {
        ...
        public void RunBasicScenario_Load()
        {
            ...
            var result = Avx.LoadVector256((UInt32*)(_dataTable.inArrayPtr));
        ...
        public void RunReflectionScenario_Load()
        {
            ...
            var result = typeof(Avx)
                .GetMethod(nameof(Avx.LoadVector256), new Type[] { typeof(UInt32*) })
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(Avx)}.{nameof(Avx.LoadVector256)}<UInt32>(Vector256<UInt32>): {method} failed:"
                );
                TestLibrary.TestFramework.LogInformation(
