...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    public sealed unsafe class SimpleBinaryOpTest__CompareLessThanDouble
    {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Avx.CompareLessThan(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(Avx)}.{nameof(Avx.CompareLessThan)}<Double>(Vector256<Double>, Vector256<Double>): {method} failed:"
                );
