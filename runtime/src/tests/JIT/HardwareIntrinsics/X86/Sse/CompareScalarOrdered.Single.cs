    ...
    public sealed unsafe class SimpleBinaryOpTest__CompareScalarOrderedSingle
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__CompareScalarOrderedSingle testClass
            )
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Sse)
                .GetMethod(
                    nameof(Sse.CompareScalarOrdered),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Sse.CompareScalarOrdered(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Sse)}.{nameof(Sse.CompareScalarOrdered)}<Single>(Vector128<Single>, Vector128<Single>): {method} failed:"
                    );
