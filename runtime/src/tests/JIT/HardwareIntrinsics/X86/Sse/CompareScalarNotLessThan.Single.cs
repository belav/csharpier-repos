    ...
    public sealed unsafe class SimpleBinaryOpTest__CompareScalarNotLessThanSingle
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__CompareScalarNotLessThanSingle testClass
            )
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Sse).GetMethod(
                    nameof(Sse.CompareScalarNotLessThan),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Sse.CompareScalarNotLessThan(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(Sse)}.{nameof(Sse.CompareScalarNotLessThan)}<Single>(Vector128<Single>, Vector128<Single>): {method} failed:"
                );
