    ...
    public sealed unsafe class SimpleBinaryOpTest__CompareScalarGreaterThanSingle
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__CompareScalarGreaterThanSingle testClass
            )
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Sse).GetMethod(
                    nameof(Sse.CompareScalarGreaterThan),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Sse.CompareScalarGreaterThan(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(Sse)}.{nameof(Sse.CompareScalarGreaterThan)}<Single>(Vector128<Single>, Vector128<Single>): {method} failed:"
                );
