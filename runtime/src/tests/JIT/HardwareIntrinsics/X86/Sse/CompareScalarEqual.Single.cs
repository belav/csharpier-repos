...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    public sealed unsafe class SimpleBinaryOpTest__CompareScalarEqualSingle
    {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Sse.CompareScalarEqual(_clsVar1, _clsVar2);
        ...
        private void ValidateResult(
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(Sse)}.{nameof(Sse.CompareScalarEqual)}<Single>(Vector128<Single>, Vector128<Single>): {method} failed:"
                );
