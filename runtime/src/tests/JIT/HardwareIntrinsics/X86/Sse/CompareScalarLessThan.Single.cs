    ...
    public sealed unsafe class SimpleBinaryOpTest__CompareScalarLessThanSingle
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__CompareScalarLessThanSingle testClass
            ) {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Sse).GetMethod(
                    nameof(Sse.CompareScalarLessThan),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Sse.CompareScalarLessThan(_clsVar1, _clsVar2);
        ...
        private void ValidateResult(
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(Sse)}.{nameof(Sse.CompareScalarLessThan)}<Single>(Vector128<Single>, Vector128<Single>): {method} failed:"
                );
