    ...
    public sealed unsafe class SimpleBinaryOpTest__CompareScalarUnorderedSingle
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                SimpleBinaryOpTest__CompareScalarUnorderedSingle testClass
            )
            {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Sse).GetMethod(
                    nameof(Sse.CompareScalarUnordered),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Sse.CompareScalarUnordered(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(Sse)}.{nameof(Sse.CompareScalarUnordered)}<Single>(Vector128<Single>, Vector128<Single>): {method} failed:"
                );
