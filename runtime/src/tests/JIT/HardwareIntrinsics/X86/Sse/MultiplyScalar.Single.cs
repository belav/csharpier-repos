    ...
    public sealed unsafe class SimpleBinaryOpTest__MultiplyScalarSingle
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario_Load(
                SimpleBinaryOpTest__MultiplyScalarSingle testClass
            )
            {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Sse.MultiplyScalar(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Sse)}.{nameof(Sse.MultiplyScalar)}<Single>(Vector128<Single>, Vector128<Single>): {method} failed:"
                    );
