    ...
    public sealed unsafe class SimpleBinaryOpTest__SubtractScalarSingle
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario_Load(
                SimpleBinaryOpTest__SubtractScalarSingle testClass
            )
            {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Sse.SubtractScalar(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Sse)}.{nameof(Sse.SubtractScalar)}<Single>(Vector128<Single>, Vector128<Single>): {method} failed:"
                    );
