    ...
    public sealed unsafe class BooleanBinaryOpTest__CompareScalarUnorderedGreaterThanOrEqualBoolean
    {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Sse)
                .GetMethod(
                    nameof(Sse.CompareScalarUnorderedGreaterThanOrEqual),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Sse.CompareScalarUnorderedGreaterThanOrEqual(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Sse)}.{nameof(Sse.CompareScalarUnorderedGreaterThanOrEqual)}<Boolean>(Vector128<Single>, Vector128<Single>): {method} failed:"
                    );
