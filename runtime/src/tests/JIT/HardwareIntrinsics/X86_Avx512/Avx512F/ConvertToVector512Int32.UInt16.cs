...
namespace JIT.HardwareIntrinsics.X86._Avx512F.handwritten
{
    ...
    public sealed unsafe class SimpleUnaryOpTest__ConvertToVector512Int32UInt16
    {
        ...
        public SimpleUnaryOpTest__ConvertToVector512Int32UInt16()
        {
            ...
            _dataTable = new SimpleUnaryOpTest__DataTable<UInt32, UInt16>(
                _data,
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            var result = typeof(Avx512F)
                .GetMethod(
                    nameof(Avx512F.ConvertToVector512Int32),
                    new Type[] { typeof(Vector256<UInt16>) }
                )
                .Invoke(
                    null,
                    new object[] { Unsafe.Read<Vector256<UInt16>>(_dataTable.inArrayPtr) }
                );
        ...
        public void RunReflectionScenario_Load()
        {
            var result = typeof(Avx512F)
                ...
                .Invoke(null, new object[] { Avx.LoadVector256((UInt16*)(_dataTable.inArrayPtr)) });
        ...
        public void RunReflectionScenario_LoadAligned()
        {
            var result = typeof(Avx512F)
                ...
                .Invoke(
                    null,
                    new object[] { Avx.LoadAlignedVector256((UInt16*)(_dataTable.inArrayPtr)) }
                );
        ...
        {
            var result = Avx512F.ConvertToVector512Int32(_clsVar);
        ...
        )
        {
            ...
            {
                Console.WriteLine(
                    $"{nameof(Avx512F)}.{nameof(Avx512F.ConvertToVector512Int32)}<UInt32>(Vector256<UInt16>): {method} failed:"
                );
