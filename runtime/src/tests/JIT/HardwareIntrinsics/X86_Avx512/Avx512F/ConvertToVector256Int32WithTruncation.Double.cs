    ...
    public sealed unsafe class SimpleUnaryOpTest__ConvertToVector256Int32WithTruncationDouble
    {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            var result = typeof(Avx512F)
                .GetMethod(
                    nameof(Avx512F.ConvertToVector256Int32WithTruncation),
        ...
        {
            var result = Avx512F.ConvertToVector256Int32WithTruncation(_clsVar);
        ...
        )
        {
            ...
            {
                Console.WriteLine(
                    $"{nameof(Avx512F)}.{nameof(Avx512F.ConvertToVector256Int32WithTruncation)}(Vector512<Double>): {method} failed:"
                );
