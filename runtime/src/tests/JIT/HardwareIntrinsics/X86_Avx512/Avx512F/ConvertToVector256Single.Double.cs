    ...
    public sealed unsafe class SimpleUnaryOpTest__ConvertToVector256SingleDouble
    {
        ...
        static SimpleUnaryOpTest__ConvertToVector256SingleDouble()
        {
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector512<Double>, byte>(ref _clsVar),
        ...
        public SimpleUnaryOpTest__ConvertToVector256SingleDouble()
        {
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector512<Double>, byte>(ref _fld),
                ref Unsafe.As<Double, byte>(ref _data[0]),
                (uint)Unsafe.SizeOf<Vector512<Double>>()
            );
            ...
            _dataTable = new SimpleUnaryOpTest__DataTable<Single, Double>(
                _data,
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            var result = typeof(Avx512F)
                .GetMethod(
                    nameof(Avx512F.ConvertToVector256Single),
                    new Type[] { typeof(Vector512<Double>) }
                )
                .Invoke(
                    null,
                    new object[] { Unsafe.Read<Vector512<Double>>(_dataTable.inArrayPtr) }
                );
        ...
        public void RunReflectionScenario_Load()
        {
            var result = typeof(Avx512F)
                ...
                .Invoke(
                    null,
                    new object[] { Avx512F.LoadVector512((Double*)(_dataTable.inArrayPtr)) }
                );
        ...
        public void RunReflectionScenario_LoadAligned()
        {
            var result = typeof(Avx512F)
                ...
                .Invoke(
                    null,
                    new object[] { Avx512F.LoadAlignedVector512((Double*)(_dataTable.inArrayPtr)) }
                );
        ...
        {
            var result = Avx512F.ConvertToVector256Single(_clsVar);
        ...
        )
        {
            ...
            {
                Console.WriteLine(
                    $"{nameof(Avx512F)}.{nameof(Avx512F.ConvertToVector256Single)}(Vector512<Double>): {method} failed:"
                );
