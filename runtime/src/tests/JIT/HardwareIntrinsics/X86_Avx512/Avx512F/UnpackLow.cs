            ...
            if (Avx512F.IsSupported)
            {
                using (
                    TestTable_2Input<float> floatTable = new TestTable_2Input<float>(
                        new float[16] { 1, 5, 100, 0, 1, 5, 100, 0, 1, 5, 100, 0, 1, 5, 100, 0 },
                        new float[16]
                        {
                            22,
                            -1,
                ...
                using (
                    TestTable_2Input<double> doubleTable = new TestTable_2Input<double>(
                        new double[8] { 1, -5, 100, 0, 1, -5, 100, 0 },
                        new double[8] { 22, -1, -50, 0, 22, -1, -50, 0 },
                        new double[8]
                    )
                )
                {
                ...
                using (
                    TestTable<int, int, int> intTable = new TestTable<int, int, int>(
                        new int[16] { 1, 5, 100, 0, 1, 5, 100, 0, 1, 5, 100, 0, 1, 5, 100, 0 },
                        new int[16] { 22, 1, 50, 0, 22, 1, 50, 0, 22, 1, 50, 0, 22, 1, 50, 0 },
                        new int[16]
                    )
                )
                using (
                    TestTable<uint, uint, uint> uintTable = new TestTable<uint, uint, uint>(
                        new uint[16] { 1, 5, 100, 0, 1, 5, 100, 0, 1, 5, 100, 0, 1, 5, 100, 0 },
                        new uint[16] { 22, 1, 50, 0, 22, 1, 50, 0, 22, 1, 50, 0, 22, 1, 50, 0 },
                        new uint[16]
                    )
                )
                using (
                    TestTable<long, long, long> longTable = new TestTable<long, long, long>(
                        new long[8] { 1, -5, 100, 0, 1, -5, 100, 0 },
                        new long[8] { 22, -1, -50, 0, 22, -1, -50, 0 },
                        new long[8]
                    )
                )
                using (
                    TestTable<ulong, ulong, ulong> ulongTable = new TestTable<ulong, ulong, ulong>(
                        new ulong[8] { 1, 5, 100, 0, 1, 5, 100, 0 },
                        new ulong[8] { 22, 1, 50, 0, 22, 1, 50, 0 },
                        new ulong[8]
                    )
                )
                {
                    ...
                    if (
                        ...
                        || (intTable.inArray1[8] != intTable.outArray[8])
                        || (intTable.inArray2[8] != intTable.outArray[9])
                        || (intTable.inArray1[9] != intTable.outArray[10])
                        || (intTable.inArray2[9] != intTable.outArray[11])
                        || (intTable.inArray1[12] != intTable.outArray[12])
                        || (intTable.inArray2[12] != intTable.outArray[13])
                        || (intTable.inArray1[13] != intTable.outArray[14])
                        || (intTable.inArray2[13] != intTable.outArray[15])
                    )
                    {
                    ...
                    if (
                        ...
                        || (uintTable.inArray1[8] != uintTable.outArray[8])
                        || (uintTable.inArray2[8] != uintTable.outArray[9])
                        || (uintTable.inArray1[9] != uintTable.outArray[10])
                        || (uintTable.inArray2[9] != uintTable.outArray[11])
                        || (uintTable.inArray1[12] != uintTable.outArray[12])
                        || (uintTable.inArray2[12] != uintTable.outArray[13])
                        || (uintTable.inArray1[13] != uintTable.outArray[14])
                        || (uintTable.inArray2[13] != uintTable.outArray[15])
                    )
                    {
                    ...
                    if (
                        ...
                        || (longTable.inArray1[4] != longTable.outArray[4])
                        || (longTable.inArray2[4] != longTable.outArray[5])
                        || (longTable.inArray1[6] != longTable.outArray[6])
                        || (longTable.inArray2[6] != longTable.outArray[7])
                    )
                    {
                    ...
                    if (
                        ...
                        || (ulongTable.inArray1[4] != ulongTable.outArray[4])
                        || (ulongTable.inArray2[4] != ulongTable.outArray[5])
                        || (ulongTable.inArray1[6] != ulongTable.outArray[6])
                        || (ulongTable.inArray2[6] != ulongTable.outArray[7])
                    )
                    {
