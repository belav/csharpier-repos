...
namespace JIT.HardwareIntrinsics.X86._Avx512BW.handwritten
{
    ...
    public sealed unsafe class SimpleUnaryOpTest__ConvertToVector512Int16SByte
    {
        ...
        public SimpleUnaryOpTest__ConvertToVector512Int16SByte()
        {
            ...
            _dataTable = new SimpleUnaryOpTest__DataTable<Int16, SByte>(
                _data,
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            var result = typeof(Avx512BW)
                ...
                .Invoke(
                    null,
                    new object[] { Unsafe.Read<Vector256<SByte>>(_dataTable.inArrayPtr) }
                );
        ...
        public void RunReflectionScenario_Load()
        {
            var result = typeof(Avx512BW)
                ...
                .Invoke(null, new object[] { Avx.LoadVector256((SByte*)(_dataTable.inArrayPtr)) });
        ...
        public void RunReflectionScenario_LoadAligned()
        {
            var result = typeof(Avx512BW)
                ...
                .Invoke(
                    null,
                    new object[] { Avx.LoadAlignedVector256((SByte*)(_dataTable.inArrayPtr)) }
                );
        ...
        {
            var result = Avx512BW.ConvertToVector512Int16(_clsVar);
        ...
        )
        {
            ...
            {
                Console.WriteLine(
                    $"{nameof(Avx512BW)}.{nameof(Avx512BW.ConvertToVector512Int16)}<Int16>(Vector256<SByte>): {method} failed:"
                );
