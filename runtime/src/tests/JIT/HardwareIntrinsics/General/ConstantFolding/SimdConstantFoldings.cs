...
public class SimdConstantFoldings
{
    ...
    public static void NegateTests()
    {
        ...
        Assert.Equal(Vector128.Create((long)(-1), +2), -Vector128.Create((long)(+1), -2));
        ...
        Assert.Equal(Vector128.Create((double)(-1), +2), -Vector128.Create((double)(+1), -2));
    }
    ...
    public static void AddTests()
    {
        ...
        Assert.Equal(
            ...
            Vector128.Create((int)(+1), -2, +3, -4) + Vector128.Create((int)(+1), +1, +3, -4)
        );

        Assert.Equal(
            Vector128.Create((long)(+2), -1),
            Vector128.Create((long)(+1), -2) + Vector128.Create((long)(+1), +1)
        );

        Assert.Equal(
            Vector128.Create((float)(+2), -1, +6, -8),
            Vector128.Create((float)(+1), -2, +3, -4) + Vector128.Create((float)(+1), +1, +3, -4)
        );

        Assert.Equal(
            Vector128.Create((double)(+2), -1),
            Vector128.Create((double)(+1), -2) + Vector128.Create((double)(+1), +1)
        );
    }
    ...
    public static void GetElementTests()
    {
        ...
        Assert.Equal(
            (ushort)(0xFFFE),
            Vector128
                .Create((ushort)(0x0001), 0xFFFE, 0x0003, 0xFFFC, 0x0005, 0xFFFA, 0x0007, 0xFFF8)
                .GetElement(1)
        );
        ...
        Assert.Equal(
            (uint)(0xFFFF_FFFE),
            Vector128
                .Create((uint)(0x0000_0001), 0xFFFF_FFFE, 0x0000_0003, 0xFFFF_FFFC)
                .GetElement(1)
        );
        ...
        Assert.Equal((int)(-2), Vector128.Create((int)(+1), -2, +3, -4).GetElement(1));

        Assert.Equal((long)(-2), Vector128.Create((long)(+1), -2).GetElement(1));

        Assert.Equal((float)(-2), Vector128.Create((float)(+1), -2, +3, -4).GetElement(1));

        Assert.Equal((double)(-2), Vector128.Create((double)(+1), -2).GetElement(1));
    }
    ...
    public static void NotTests()
    {
        ...
        Assert.Equal(Vector128.Create((long)(-2), +1), ~Vector128.Create((long)(+1), -2));
    ...
    public static void AndNotTests()
    {
        ...
        Assert.Equal(
            ...
            Vector128.AndNot(Vector128.Create((long)(+1), -2), Vector128.Create((long)(+1), +1))
        );
        ...
        Assert.Equal(
            ...
            Vector128.AndNot(Vector128.Create((double)(+1), -2), Vector128.Create((double)(+1), +1))
        );
    }
    ...
    public static void LeftShiftTests()
    {
        ...
        Assert.Equal(Vector128.Create((long)(+2), -4), Vector128.Create((long)(+1), -2) << 1);
    ...
    public static void RightShiftTests()
    {
        ...
        Assert.Equal(Vector128.Create((long)(+0), -1), Vector128.Create((long)(+1), -2) >> 1);
