...
public class StaticReadonlySimd
{
    ...
    static readonly Vector256<byte> v10 = Vector256
        .Create(1111111111, 2222222222, ulong.MaxValue, 0)
        .AsByte();
    static readonly Vector256<ulong> v11 = Vector256.Create(
        444444444,
        2222222222,
        0,
        ulong.MaxValue
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    static void AssertEquals<T>(T t1, T t2)
