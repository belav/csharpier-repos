    ...
    public sealed unsafe class VectorUnaryOpTest__ConvertToInt64Double
    {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var method = typeof(Vector128).GetMethod(
                nameof(Vector128.ConvertToInt64),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Vector128.ConvertToInt64(_clsVar1);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(Vector128)}.{nameof(Vector128.ConvertToInt64)}<Int64>(Vector128<Double>): {method} failed:"
                );
                TestLibrary.TestFramework.LogInformation(
