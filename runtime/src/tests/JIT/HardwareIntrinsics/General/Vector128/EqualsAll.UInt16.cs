...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorBooleanBinaryOpTest__EqualsAllUInt16
    {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Vector128.EqualsAll(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Vector128)}.{nameof(Vector128.EqualsAll)}<UInt16>(Vector128<UInt16>, Vector128<UInt16>): {method} failed:"
                    );
