...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorBinaryOpTest__BitwiseAndUInt16
    {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Vector128.BitwiseAnd(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Vector128)}.{nameof(Vector128.BitwiseAnd)}<UInt16>(Vector128<UInt16>, Vector128<UInt16>): {method} failed:"
                    );
