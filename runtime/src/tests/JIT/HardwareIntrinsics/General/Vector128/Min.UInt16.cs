...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorBinaryOpTest__MinUInt16
    {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Vector128.Min(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Vector128)}.{nameof(Vector128.Min)}<UInt16>(Vector128<UInt16>, Vector128<UInt16>): {method} failed:"
                    );
