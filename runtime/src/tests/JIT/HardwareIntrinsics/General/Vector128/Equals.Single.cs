...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorBinaryOpTest__EqualsSingle
    {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Vector128.Equals(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Vector128)}.{nameof(Vector128.Equals)}<Single>(Vector128<Single>, Vector128<Single>): {method} failed:"
                    );
