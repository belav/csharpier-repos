...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorBinaryOpTest__XorInt32
    {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Vector128.Xor(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Vector128)}.{nameof(Vector128.Xor)}<Int32>(Vector128<Int32>, Vector128<Int32>): {method} failed:"
                    );
