...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorUnaryOpTest__SqrtInt16
    {
        ...
        private struct TestStruct
        {
            ...
            {
                var result = Vector128.Sqrt(_fld1);
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = Vector128.Sqrt(Unsafe.Read<Vector128<Int16>>(_dataTable.inArray1Ptr));
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Vector128.Sqrt(_clsVar1);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new VectorUnaryOpTest__SqrtInt16();
            var result = Vector128.Sqrt(test._fld1);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Vector128)}.{nameof(Vector128.Sqrt)}<Int16>(Vector128<Int16>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
