...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorBinaryOpTest__AndNotUInt32
    {
        ...
        private struct TestStruct
        {
            ...
            {
                var result = Vector128.AndNot(_fld1, _fld2);
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var method = typeof(Vector128).GetMethod(
                nameof(Vector128.AndNot),
                new Type[] { typeof(Vector128<UInt32>), typeof(Vector128<UInt32>) }
            );

            if (method is null)
            {
                method = typeof(Vector128).GetMethod(
                    nameof(Vector128.AndNot),
                    1,
                    new Type[]
                    {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Vector128.AndNot(_clsVar1, _clsVar2);
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = Vector128.AndNot(op1, op2);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new VectorBinaryOpTest__AndNotUInt32();
            var result = Vector128.AndNot(test._fld1, test._fld2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Vector128)}.{nameof(Vector128.AndNot)}<UInt32>(Vector128<UInt32>, Vector128<UInt32>): {method} failed:"
                    );
