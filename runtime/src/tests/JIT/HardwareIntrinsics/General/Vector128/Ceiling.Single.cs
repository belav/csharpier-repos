...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorUnaryOpTest__CeilingSingle
    {
        ...
        private struct TestStruct
        {
            ...
            {
                var result = Vector128.Ceiling(_fld1);
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = Vector128.Ceiling(Unsafe.Read<Vector128<Single>>(_dataTable.inArray1Ptr));
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Vector128.Ceiling(_clsVar1);
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = Vector128.Ceiling(op1);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new VectorUnaryOpTest__CeilingSingle();
            var result = Vector128.Ceiling(test._fld1);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Vector128)}.{nameof(Vector128.Ceiling)}<Single>(Vector128<Single>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
