...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorBinaryOpTest__DotInt32
    {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Vector128.Dot(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Vector128)}.{nameof(Vector128.Dot)}<Int32>(Vector128<Int32>, Vector128<Int32>): {method} failed:"
                    );
