...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorBinaryOpTest__BitwiseOrInt16
    {
        ...
        private struct TestStruct
        {
            ...
            {
                var result = Vector128.BitwiseOr(_fld1, _fld2);
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = Vector128.BitwiseOr(
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Vector128.BitwiseOr(_clsVar1, _clsVar2);
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = Vector128.BitwiseOr(op1, op2);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new VectorBinaryOpTest__BitwiseOrInt16();
            var result = Vector128.BitwiseOr(test._fld1, test._fld2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Vector128)}.{nameof(Vector128.BitwiseOr)}<Int16>(Vector128<Int16>, Vector128<Int16>): {method} failed:"
                    );
