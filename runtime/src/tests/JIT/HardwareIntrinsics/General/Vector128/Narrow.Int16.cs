...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorBinaryOpTest__NarrowInt16
    {
        ...
        private struct TestStruct
        {
            ...
            {
                var result = Vector128.Narrow(_fld1, _fld2);
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Vector128.Narrow(_clsVar1, _clsVar2);
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = Vector128.Narrow(op1, op2);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new VectorBinaryOpTest__NarrowInt16();
            var result = Vector128.Narrow(test._fld1, test._fld2);
        ...
        )
        {
            ...
            else
            {
                for (var i = 1; i < RetElementCount; i++)
                {
                    if (
                        result[i]
                        != (sbyte)((i < Op1ElementCount) ? left[i] : right[i - Op1ElementCount])
                    )
                    {
                        succeeded = false;
                        break;
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Vector128)}.{nameof(Vector128.Narrow)}<SByte>(Vector128<Int16>, Vector128<Int16>): {method} failed:"
                    );
