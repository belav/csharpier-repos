...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorUnaryOpTest__ConvertToUInt32UInt32
    {
        ...
        private struct TestStruct
        {
            ...
            {
                var result = Vector128.ConvertToUInt32(_fld1);
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = Vector128.ConvertToUInt32(
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var method = typeof(Vector128).GetMethod(
                nameof(Vector128.ConvertToUInt32),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Vector128.ConvertToUInt32(_clsVar1);
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = Vector128.ConvertToUInt32(op1);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new VectorUnaryOpTest__ConvertToUInt32UInt32();
            var result = Vector128.ConvertToUInt32(test._fld1);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Vector128)}.{nameof(Vector128.ConvertToUInt32)}<UInt32>(Vector128<Single>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
