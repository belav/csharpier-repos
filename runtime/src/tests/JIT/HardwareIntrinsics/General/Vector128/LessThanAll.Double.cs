...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorBooleanBinaryOpTest__LessThanAllDouble
    {
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = Vector128.LessThanAll(
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Vector128.LessThanAll(_clsVar1, _clsVar2);
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = Vector128.LessThanAll(op1, op2);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new VectorBooleanBinaryOpTest__LessThanAllDouble();
            var result = Vector128.LessThanAll(test._fld1, test._fld2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Vector128)}.{nameof(Vector128.LessThanAll)}<Double>(Vector128<Double>, Vector128<Double>): {method} failed:"
                    );
