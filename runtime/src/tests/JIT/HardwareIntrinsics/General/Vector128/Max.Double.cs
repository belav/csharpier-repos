...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorBinaryOpTest__MaxDouble
    {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Vector128.Max(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Vector128)}.{nameof(Vector128.Max)}<Double>(Vector128<Double>, Vector128<Double>): {method} failed:"
                    );
