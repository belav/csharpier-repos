...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorBooleanBinaryOpTest__LessThanAnySingle
    {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Vector128.LessThanAny(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Vector128)}.{nameof(Vector128.LessThanAny)}<Single>(Vector128<Single>, Vector128<Single>): {method} failed:"
                    );
