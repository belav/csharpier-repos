...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorAllBitsSet__AllBitsSetSingle
    {
        ...
        public void RunBasicScenario()
        {
            ...
            Vector128<Single> result = Vector128<Single>.AllBitsSet;
        ...
        public void RunReflectionScenario()
        {
            ...
            object result = typeof(Vector128<Single>).GetProperty(
                    nameof(Vector128<Single>.AllBitsSet),
                    new Type[] {  }
                )
                .GetGetMethod()
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"Vector128.AllBitsSet(Single): {method} failed:"
                );
                TestLibrary.TestFramework.LogInformation(
