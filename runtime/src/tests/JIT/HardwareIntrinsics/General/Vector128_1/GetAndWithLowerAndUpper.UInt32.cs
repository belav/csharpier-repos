    ...
    public sealed unsafe class VectorGetAndWithLowerAndUpper__GetAndWithLowerAndUpperUInt32
    {
        ...
        public void RunReflectionScenario()
        {
            ...
            object upperResult = typeof(Vector128)
                ...
                .Invoke(null, new object[] { value });
            ValidateGetResult(
                (Vector64<UInt32>)(lowerResult),
                (Vector64<UInt32>)(upperResult),
                values
            );
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation($"Vector128<UInt32>.GetLower(): {method} failed:");
                TestLibrary
                    .TestFramework
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation($"Vector128<UInt32>.GetUpper(): {method} failed:");
                TestLibrary
                    .TestFramework
                    .LogInformation($"   value: ({string.Join(", ", values)})");
                TestLibrary
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation($"Vector128<UInt32.WithLower(): {method} failed:");
                TestLibrary
                    .TestFramework
                    .LogInformation($"   value: ({string.Join(", ", values)})");
                TestLibrary
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation($"Vector128<UInt32.WithUpper(): {method} failed:");
                TestLibrary
                    .TestFramework
                    .LogInformation($"   value: ({string.Join(", ", values)})");
                TestLibrary
