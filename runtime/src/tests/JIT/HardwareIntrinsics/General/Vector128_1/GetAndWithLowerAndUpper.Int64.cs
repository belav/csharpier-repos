    ...
    public sealed unsafe class VectorGetAndWithLowerAndUpper__GetAndWithLowerAndUpperInt64
    {
        ...
        public void RunReflectionScenario()
        {
            ...
            object upperResult = typeof(Vector128)
                ...
                .Invoke(null, new object[] { value });
            ValidateGetResult(
                (Vector64<Int64>)(lowerResult),
                (Vector64<Int64>)(upperResult),
                values
            );
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation($"Vector128<Int64>.GetLower(): {method} failed:");
                TestLibrary
                    .TestFramework
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation($"Vector128<Int64>.GetUpper(): {method} failed:");
                TestLibrary
                    .TestFramework
                    .LogInformation($"   value: ({string.Join(", ", values)})");
                TestLibrary
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation($"Vector128<Int64.WithLower(): {method} failed:");
                TestLibrary
                    .TestFramework
                    .LogInformation($"   value: ({string.Join(", ", values)})");
                TestLibrary
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation($"Vector128<Int64.WithUpper(): {method} failed:");
                TestLibrary
                    .TestFramework
                    .LogInformation($"   value: ({string.Join(", ", values)})");
                TestLibrary
