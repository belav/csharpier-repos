...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorAllBitsSet__AllBitsSetInt16
    {
        ...
        public void RunBasicScenario()
        {
            ...
            Vector128<Int16> result = Vector128<Int16>.AllBitsSet;
        ...
        public void RunReflectionScenario()
        {
            ...
            object result = typeof(Vector128<Int16>).GetProperty(
                    nameof(Vector128<Int16>.AllBitsSet),
                    new Type[] {  }
                )
                .GetGetMethod()
        ...
        private unsafe void ValidateResult(
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"Vector128.AllBitsSet(Int16): {method} failed:"
                );
                TestLibrary.TestFramework.LogInformation(
