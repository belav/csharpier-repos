...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorAllBitsSet__AllBitsSetUInt16
    {
        ...
        public void RunBasicScenario()
        {
            ...
            Vector128<UInt16> result = Vector128<UInt16>.AllBitsSet;
        ...
        public void RunReflectionScenario()
        {
            ...
            object result = typeof(Vector128<UInt16>).GetProperty(
                    nameof(Vector128<UInt16>.AllBitsSet),
                    new Type[] {  }
                )
                .GetGetMethod()
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"Vector128.AllBitsSet(UInt16): {method} failed:"
                );
                TestLibrary.TestFramework.LogInformation(
