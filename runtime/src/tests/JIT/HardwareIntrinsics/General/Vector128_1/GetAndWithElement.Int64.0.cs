...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorGetAndWithElement__GetAndWithElementInt640
    {
        ...
        public void RunBasicScenario(int imm = 0, bool expectedOutOfRangeException = false)
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"Vector128<Int64.GetElement({imm}): {nameof(RunBasicScenario)} failed to throw ArgumentOutOfRangeException."
                );
            ...
            {
                TestLibrary.TestFramework.LogInformation(
                    $"Vector128<Int64.WithElement({imm}): {nameof(RunBasicScenario)} failed to throw ArgumentOutOfRangeException."
                );
                TestLibrary.TestFramework.LogInformation(string.Empty);
        ...
        public void RunReflectionScenario(int imm = 0, bool expectedOutOfRangeException = false)
        {
            ...
            {
                TestLibrary.TestFramework.LogInformation(
                    $"Vector128<Int64.GetElement({imm}): {nameof(RunReflectionScenario)} failed to throw ArgumentOutOfRangeException."
                );
                TestLibrary.TestFramework.LogInformation(string.Empty);
            ...
            {
                TestLibrary.TestFramework.LogInformation(
                    $"Vector128<Int64.WithElement({imm}): {nameof(RunReflectionScenario)} failed to throw ArgumentOutOfRangeException."
                );
                TestLibrary.TestFramework.LogInformation(string.Empty);
        ...
        private void ValidateGetResult(
            ...
            if (result != values[0])
            {
                ...
                TestLibrary.TestFramework.LogInformation(
                    $"Vector128<Int64.GetElement(0): {method} failed:"
                );
                TestLibrary.TestFramework.LogInformation(
        ...
        private void ValidateWithResult(
            ...
            {
                TestLibrary.TestFramework.LogInformation(
                    $"Vector128<Int64.WithElement(0): {method} failed:"
                );
                TestLibrary.TestFramework.LogInformation(
                    $"   value: ({string.Join(", ", values)})"
                );
