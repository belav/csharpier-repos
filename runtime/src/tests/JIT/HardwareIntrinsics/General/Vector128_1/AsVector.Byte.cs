...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorAs__AsVectorByte
    {
        ...
        private static readonly int NumericsElementCount =
            Unsafe.SizeOf<Vector<Byte>>() / sizeof(Byte);
        ...
        public void RunReflectionScenario()
        {
            ...
            value = (Vector128<Byte>)typeof(Vector128).GetMethods().Where(
                    (methodInfo) =>
                    {
                ...
                ).Single().MakeGenericMethod(typeof(Byte)).Invoke(null, new object[] { Result });
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework
                    .LogInformation($"Vector128<Byte>.AsVector: {method} failed:");
                TestLibrary.TestFramework
