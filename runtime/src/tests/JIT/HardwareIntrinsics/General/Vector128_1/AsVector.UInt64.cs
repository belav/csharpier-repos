...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorAs__AsVectorUInt64
    {
        ...
        public void RunReflectionScenario()
        {
            ...
            value = (Vector128<UInt64>)typeof(Vector128).GetMethods().Where(
                    (methodInfo) =>
                    {
                ...
                ).Single().MakeGenericMethod(typeof(UInt64)).Invoke(null, new object[] { Result });
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework
                    .LogInformation($"Vector128<UInt64>.AsVector: {method} failed:");
                TestLibrary.TestFramework
