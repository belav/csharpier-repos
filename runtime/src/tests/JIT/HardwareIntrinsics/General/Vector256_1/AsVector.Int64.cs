...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorAs__AsVectorInt64
    {
        ...
        private static readonly int NumericsElementCount =
            Unsafe.SizeOf<Vector<Int64>>() / sizeof(Int64);
        ...
        public void RunReflectionScenario()
        {
            ...
            value = (Vector256<Int64>)typeof(Vector256).GetMethods().Where(
                    (methodInfo) =>
                    {
                ...
                ).Single().MakeGenericMethod(typeof(Int64)).Invoke(null, new object[] { Result });
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework
                    .LogInformation($"Vector256<Int64>.AsVector: {method} failed:");
                TestLibrary.TestFramework
