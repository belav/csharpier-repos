...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorUnaryOpTest__op_UnaryNegationSingle
    {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Vector256<Single>)
                .GetMethod("op_UnaryNegation", new Type[] { typeof(Vector256<Single>) })
                .Invoke(
                    null,
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Vector256)}.op_UnaryNegation<Single>(Vector256<Single>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
