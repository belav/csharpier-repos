...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorUnaryOpTest__op_UnaryPlusDouble
    {
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = +Unsafe.Read<Vector256<Double>>(_dataTable.inArray1Ptr);
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Vector256<Double>)
                .GetMethod("op_UnaryPlus", new Type[] { typeof(Vector256<Double>) })
                .Invoke(
                    null,
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Vector256)}.op_UnaryPlus<Double>(Vector256<Double>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
