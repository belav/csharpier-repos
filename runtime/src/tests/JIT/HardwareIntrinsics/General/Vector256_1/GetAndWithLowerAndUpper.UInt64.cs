    ...
    public sealed unsafe class VectorGetAndWithLowerAndUpper__GetAndWithLowerAndUpperUInt64
    {
        ...
        public void RunReflectionScenario()
        {
            ...
            object upperResult = typeof(Vector256)
                ...
                .Invoke(null, new object[] { value });
            ValidateGetResult(
                (Vector128<UInt64>)(lowerResult),
                (Vector128<UInt64>)(upperResult),
                values
            );
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation($"Vector256<UInt64>.GetLower(): {method} failed:");
                TestLibrary
                    .TestFramework
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation($"Vector256<UInt64>.GetUpper(): {method} failed:");
                TestLibrary
                    .TestFramework
                    .LogInformation($"   value: ({string.Join(", ", values)})");
                TestLibrary
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation($"Vector256<UInt64.WithLower(): {method} failed:");
                TestLibrary
                    .TestFramework
                    .LogInformation($"   value: ({string.Join(", ", values)})");
                TestLibrary
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation($"Vector256<UInt64.WithUpper(): {method} failed:");
                TestLibrary
                    .TestFramework
                    .LogInformation($"   value: ({string.Join(", ", values)})");
                TestLibrary
