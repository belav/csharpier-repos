...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorAs__AsVectorUInt32
    {
        ...
        private static readonly int NumericsElementCount =
            Unsafe.SizeOf<Vector<UInt32>>() / sizeof(UInt32);
        ...
        public void RunReflectionScenario()
        {
            ...
            value = (Vector256<UInt32>)typeof(Vector256).GetMethods().Where(
                    (methodInfo) =>
                    {
                ...
                ).Single().MakeGenericMethod(typeof(UInt32)).Invoke(null, new object[] { Result });
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework
                    .LogInformation($"Vector256<UInt32>.AsVector: {method} failed:");
                TestLibrary.TestFramework
