...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorUnaryOpTest__op_UnaryNegationUInt64
    {
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = -Unsafe.Read<Vector256<UInt64>>(_dataTable.inArray1Ptr);
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Vector256<UInt64>)
                .GetMethod("op_UnaryNegation", new Type[] { typeof(Vector256<UInt64>) })
                .Invoke(
                    null,
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Vector256)}.op_UnaryNegation<UInt64>(Vector256<UInt64>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
