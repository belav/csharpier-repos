...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorUnaryOpTest__op_UnaryNegationInt64
    {
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = -Unsafe.Read<Vector256<Int64>>(_dataTable.inArray1Ptr);
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Vector256<Int64>)
                .GetMethod("op_UnaryNegation", new Type[] { typeof(Vector256<Int64>) })
                .Invoke(
                    null,
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Vector256)}.op_UnaryNegation<Int64>(Vector256<Int64>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
