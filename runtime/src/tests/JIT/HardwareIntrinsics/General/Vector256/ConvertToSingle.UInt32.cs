...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorUnaryOpTest__ConvertToSingleUInt32
    {
        ...
        private struct TestStruct
        {
            ...
            {
                var result = Vector256.ConvertToSingle(_fld1);
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = Vector256.ConvertToSingle(
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var method = typeof(Vector256).GetMethod(
                nameof(Vector256.ConvertToSingle),
                new Type[] { typeof(Vector256<UInt32>) }
            );
            ...
            var result = method.Invoke(
                null,
                new object[] { Unsafe.Read<Vector256<UInt32>>(_dataTable.inArray1Ptr) }
            );
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Vector256.ConvertToSingle(_clsVar1);
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = Vector256.ConvertToSingle(op1);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new VectorUnaryOpTest__ConvertToSingleUInt32();
            var result = Vector256.ConvertToSingle(test._fld1);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(Vector256)}.{nameof(Vector256.ConvertToSingle)}<Single>(Vector256<UInt32>): {method} failed:"
                );
                TestLibrary.TestFramework.LogInformation(
