...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorUnaryOpTest__AbsInt64
    {
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = Vector256.Abs(Unsafe.Read<Vector256<Int64>>(_dataTable.inArray1Ptr));
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var method = typeof(Vector256).GetMethod(
                nameof(Vector256.Abs),
                new Type[] { typeof(Vector256<Int64>) }
            );
            ...
            var result = method.Invoke(
                null,
                new object[] { Unsafe.Read<Vector256<Int64>>(_dataTable.inArray1Ptr) }
            );
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Vector256.Abs(_clsVar1);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Vector256)}.{nameof(Vector256.Abs)}<Int64>(Vector256<Int64>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
