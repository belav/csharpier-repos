    ...
    public sealed unsafe class VectorBooleanBinaryOpTest__GreaterThanOrEqualAnySingle
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(
                VectorBooleanBinaryOpTest__GreaterThanOrEqualAnySingle testClass
            )
            {
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Vector256)}.{nameof(Vector256.GreaterThanOrEqualAny)}<Single>(Vector256<Single>, Vector256<Single>): {method} failed:"
                    );
