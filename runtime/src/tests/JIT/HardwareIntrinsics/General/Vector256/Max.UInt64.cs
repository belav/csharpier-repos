...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorBinaryOpTest__MaxUInt64
    {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Vector256.Max(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Vector256)}.{nameof(Vector256.Max)}<UInt64>(Vector256<UInt64>, Vector256<UInt64>): {method} failed:"
                    );
