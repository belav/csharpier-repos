...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorBinaryOpTest__BitwiseOrInt64
    {
        ...
        private struct TestStruct
        {
            ...
            {
                var result = Vector256.BitwiseOr(_fld1, _fld2);
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = Vector256.BitwiseOr(
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Vector256.BitwiseOr(_clsVar1, _clsVar2);
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = Vector256.BitwiseOr(op1, op2);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new VectorBinaryOpTest__BitwiseOrInt64();
            var result = Vector256.BitwiseOr(test._fld1, test._fld2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Vector256)}.{nameof(Vector256.BitwiseOr)}<Int64>(Vector256<Int64>, Vector256<Int64>): {method} failed:"
                    );
