...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorUnaryOpTest__NegateUInt32
    {
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = Vector256.Negate(Unsafe.Read<Vector256<UInt32>>(_dataTable.inArray1Ptr));
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Vector256.Negate(_clsVar1);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Vector256)}.{nameof(Vector256.Negate)}<UInt32>(Vector256<UInt32>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
