...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorBinaryOpTest__EqualsUInt16
    {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Vector256.Equals(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Vector256)}.{nameof(Vector256.Equals)}<UInt16>(Vector256<UInt16>, Vector256<UInt16>): {method} failed:"
                    );
