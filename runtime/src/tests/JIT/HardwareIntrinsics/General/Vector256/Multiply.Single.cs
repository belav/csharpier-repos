...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorBinaryOpTest__MultiplySingle
    {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Vector256.Multiply(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Vector256)}.{nameof(Vector256.Multiply)}<Single>(Vector256<Single>, Vector256<Single>): {method} failed:"
                    );
