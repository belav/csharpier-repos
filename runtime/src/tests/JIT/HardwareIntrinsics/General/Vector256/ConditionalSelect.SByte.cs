    ...
    public sealed unsafe class VectorTernaryOpTest__ConditionalSelectSByte
    {
        ...
        private struct TestStruct
        {
            ...
            public static TestStruct Create()
            {
                ...
                Unsafe.CopyBlockUnaligned(
                    ref Unsafe.As<Vector256<SByte>, byte>(ref testStruct._fld3),
        ...
        static VectorTernaryOpTest__ConditionalSelectSByte()
        {
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector256<SByte>, byte>(ref _clsVar3),
                ref Unsafe.As<SByte, byte>(ref _data3[0]),
                (uint)Unsafe.SizeOf<Vector256<SByte>>()
            );
        }
        ...
        public VectorTernaryOpTest__ConditionalSelectSByte()
        {
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector256<SByte>, byte>(ref _fld3),
                ref Unsafe.As<SByte, byte>(ref _data3[0]),
                (uint)Unsafe.SizeOf<Vector256<SByte>>()
            );
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Vector256)}.{nameof(Vector256.ConditionalSelect)}<SByte>(Vector256<SByte>, Vector256<SByte>, Vector256<SByte>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
