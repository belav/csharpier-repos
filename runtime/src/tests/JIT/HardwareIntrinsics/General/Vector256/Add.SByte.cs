...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorBinaryOpTest__AddSByte
    {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Vector256.Add(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Vector256)}.{nameof(Vector256.Add)}<SByte>(Vector256<SByte>, Vector256<SByte>): {method} failed:"
                    );
