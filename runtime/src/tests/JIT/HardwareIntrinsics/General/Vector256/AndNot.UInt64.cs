...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorBinaryOpTest__AndNotUInt64
    {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Vector256.AndNot(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Vector256)}.{nameof(Vector256.AndNot)}<UInt64>(Vector256<UInt64>, Vector256<UInt64>): {method} failed:"
                    );
