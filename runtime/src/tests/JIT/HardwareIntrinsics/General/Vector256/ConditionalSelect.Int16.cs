    ...
    public sealed unsafe class VectorTernaryOpTest__ConditionalSelectInt16
    {
        ...
        private struct TestStruct
        {
            ...
            public static TestStruct Create()
            {
                ...
                Unsafe.CopyBlockUnaligned(
                    ref Unsafe.As<Vector256<Int16>, byte>(ref testStruct._fld3),
        ...
        static VectorTernaryOpTest__ConditionalSelectInt16()
        {
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector256<Int16>, byte>(ref _clsVar3),
                ref Unsafe.As<Int16, byte>(ref _data3[0]),
                (uint)Unsafe.SizeOf<Vector256<Int16>>()
            );
        }
        ...
        public VectorTernaryOpTest__ConditionalSelectInt16()
        {
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector256<Int16>, byte>(ref _fld3),
                ref Unsafe.As<Int16, byte>(ref _data3[0]),
                (uint)Unsafe.SizeOf<Vector256<Int16>>()
            );
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var method = typeof(Vector256).GetMethod(
                nameof(Vector256.ConditionalSelect),
                new Type[]
                {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Vector256.ConditionalSelect(_clsVar1, _clsVar2, _clsVar3);
        ...
        )
        {
            ...
            else
            {
                for (var i = 1; i < RetElementCount; i++)
                {
                    if (
                        result[i]
                        != (short)((secondOp[i] & firstOp[i]) | (thirdOp[i] & ~firstOp[i]))
                    )
                    {
                        succeeded = false;
                        break;
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Vector256)}.{nameof(Vector256.ConditionalSelect)}<Int16>(Vector256<Int16>, Vector256<Int16>, Vector256<Int16>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
