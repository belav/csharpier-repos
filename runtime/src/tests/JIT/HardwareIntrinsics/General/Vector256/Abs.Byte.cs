...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorUnaryOpTest__AbsByte
    {
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = Vector256.Abs(Unsafe.Read<Vector256<Byte>>(_dataTable.inArray1Ptr));
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var method = typeof(Vector256).GetMethod(
                ...
                new Type[] { typeof(Vector256<Byte>) }
            );
            ...
            var result = method.Invoke(
                null,
                new object[] { Unsafe.Read<Vector256<Byte>>(_dataTable.inArray1Ptr) }
            );
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Vector256)}.{nameof(Vector256.Abs)}<Byte>(Vector256<Byte>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
