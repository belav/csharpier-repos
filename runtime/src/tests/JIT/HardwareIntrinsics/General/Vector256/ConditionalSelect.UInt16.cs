    ...
    public sealed unsafe class VectorTernaryOpTest__ConditionalSelectUInt16
    {
        ...
        private struct TestStruct
        {
            ...
            public static TestStruct Create()
            {
                ...
                Unsafe.CopyBlockUnaligned(
                    ref Unsafe.As<Vector256<UInt16>, byte>(ref testStruct._fld3),
        ...
        static VectorTernaryOpTest__ConditionalSelectUInt16()
        {
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector256<UInt16>, byte>(ref _clsVar3),
                ref Unsafe.As<UInt16, byte>(ref _data3[0]),
                (uint)Unsafe.SizeOf<Vector256<UInt16>>()
            );
        }
        ...
        public VectorTernaryOpTest__ConditionalSelectUInt16()
        {
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector256<UInt16>, byte>(ref _fld3),
                ref Unsafe.As<UInt16, byte>(ref _data3[0]),
                (uint)Unsafe.SizeOf<Vector256<UInt16>>()
            );
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Vector256)}.{nameof(Vector256.ConditionalSelect)}<UInt16>(Vector256<UInt16>, Vector256<UInt16>, Vector256<UInt16>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
