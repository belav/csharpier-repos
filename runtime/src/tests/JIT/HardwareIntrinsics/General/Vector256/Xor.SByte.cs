...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorBinaryOpTest__XorSByte
    {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Vector256.Xor(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Vector256)}.{nameof(Vector256.Xor)}<SByte>(Vector256<SByte>, Vector256<SByte>): {method} failed:"
                    );
