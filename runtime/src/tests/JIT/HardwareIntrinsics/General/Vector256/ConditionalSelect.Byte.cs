    ...
    public sealed unsafe class VectorTernaryOpTest__ConditionalSelectByte
    {
        ...
        private struct TestStruct
        {
            ...
            public static TestStruct Create()
            {
                ...
                Unsafe.CopyBlockUnaligned(
                    ref Unsafe.As<Vector256<Byte>, byte>(ref testStruct._fld3),
        ...
        static VectorTernaryOpTest__ConditionalSelectByte()
        {
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector256<Byte>, byte>(ref _clsVar3),
                ref Unsafe.As<Byte, byte>(ref _data3[0]),
                (uint)Unsafe.SizeOf<Vector256<Byte>>()
            );
        }
        ...
        public VectorTernaryOpTest__ConditionalSelectByte()
        {
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector256<Byte>, byte>(ref _fld3),
                ref Unsafe.As<Byte, byte>(ref _data3[0]),
                (uint)Unsafe.SizeOf<Vector256<Byte>>()
            );
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Vector256)}.{nameof(Vector256.ConditionalSelect)}<Byte>(Vector256<Byte>, Vector256<Byte>, Vector256<Byte>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
