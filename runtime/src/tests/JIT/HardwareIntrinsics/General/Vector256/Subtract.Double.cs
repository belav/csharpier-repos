...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorBinaryOpTest__SubtractDouble
    {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Vector256.Subtract(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Vector256)}.{nameof(Vector256.Subtract)}<Double>(Vector256<Double>, Vector256<Double>): {method} failed:"
                    );
