    ...
    public sealed unsafe class VectorBinaryOpTest__DivideSingle
    {
        ...
        private struct TestStruct
        {
            ...
            public static TestStruct Create()
            {
                ...
                {
                    _data2[i] = Math.Max((float)(1), TestLibrary.Generator.GetSingle());
                }
                Unsafe.CopyBlockUnaligned(
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Vector256.Divide(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Vector256)}.{nameof(Vector256.Divide)}<Single>(Vector256<Single>, Vector256<Single>): {method} failed:"
                    );
