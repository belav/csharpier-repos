    ...
    public sealed unsafe class VectorUnaryOpTest__ConvertToInt32Int32
    {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var method = typeof(Vector256).GetMethod(
                nameof(Vector256.ConvertToInt32),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Vector256.ConvertToInt32(_clsVar1);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Vector256)}.{nameof(Vector256.ConvertToInt32)}<Int32>(Vector256<Single>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
