    ...
    public sealed unsafe class VectorTernaryOpTest__ConditionalSelectInt64
    {
        ...
        private struct TestStruct
        {
            ...
            public static TestStruct Create()
            {
                ...
                Unsafe.CopyBlockUnaligned(
                    ref Unsafe.As<Vector256<Int64>, byte>(ref testStruct._fld3),
        ...
        static VectorTernaryOpTest__ConditionalSelectInt64()
        {
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector256<Int64>, byte>(ref _clsVar3),
                ref Unsafe.As<Int64, byte>(ref _data3[0]),
                (uint)Unsafe.SizeOf<Vector256<Int64>>()
            );
        }
        ...
        public VectorTernaryOpTest__ConditionalSelectInt64()
        {
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector256<Int64>, byte>(ref _fld3),
                ref Unsafe.As<Int64, byte>(ref _data3[0]),
                (uint)Unsafe.SizeOf<Vector256<Int64>>()
            );
        ...
        )
        {
            ...
            else
            {
                ...
                {
                    if (
                        result[i] != (long)((secondOp[i] & firstOp[i]) | (thirdOp[i] & ~firstOp[i]))
                    )
                    {
                        succeeded = false;
                        break;
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Vector256)}.{nameof(Vector256.ConditionalSelect)}<Int64>(Vector256<Int64>, Vector256<Int64>, Vector256<Int64>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
