    ...
    public sealed unsafe class VectorBinaryOpTest__NarrowUInt64
    {
        ...
        private struct TestStruct
        {
            ...
            public static TestStruct Create()
            {
                ...
                Unsafe.CopyBlockUnaligned(
                    ref Unsafe.As<Vector256<UInt64>, byte>(ref testStruct._fld1),
                    ref Unsafe.As<UInt64, byte>(ref _data1[0]),
                    (uint)Unsafe.SizeOf<Vector256<UInt64>>()
                );
                ...
                Unsafe.CopyBlockUnaligned(
                    ref Unsafe.As<Vector256<UInt64>, byte>(ref testStruct._fld2),
            ...
            {
                var result = Vector256.Narrow(_fld1, _fld2);
        ...
        static VectorBinaryOpTest__NarrowUInt64()
        {
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector256<UInt64>, byte>(ref _clsVar1),
                ref Unsafe.As<UInt64, byte>(ref _data1[0]),
                (uint)Unsafe.SizeOf<Vector256<UInt64>>()
            );
            for (var i = 0; i < Op2ElementCount; i++)
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector256<UInt64>, byte>(ref _clsVar2),
                ref Unsafe.As<UInt64, byte>(ref _data2[0]),
                (uint)Unsafe.SizeOf<Vector256<UInt64>>()
            );
        }
        ...
        public VectorBinaryOpTest__NarrowUInt64()
        {
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector256<UInt64>, byte>(ref _fld1),
                ref Unsafe.As<UInt64, byte>(ref _data1[0]),
                (uint)Unsafe.SizeOf<Vector256<UInt64>>()
            );
            for (var i = 0; i < Op2ElementCount; i++)
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector256<UInt64>, byte>(ref _fld2),
                ref Unsafe.As<UInt64, byte>(ref _data2[0]),
                (uint)Unsafe.SizeOf<Vector256<UInt64>>()
            );
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var method = typeof(Vector256).GetMethod(
                nameof(Vector256.Narrow),
                new Type[] { typeof(Vector256<UInt64>), typeof(Vector256<UInt64>) }
            );
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Vector256.Narrow(_clsVar1, _clsVar2);
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = Vector256.Narrow(op1, op2);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new VectorBinaryOpTest__NarrowUInt64();
            var result = Vector256.Narrow(test._fld1, test._fld2);
        ...
        )
        {
            ...
            else
            {
                for (var i = 1; i < RetElementCount; i++)
                {
                    if (
                        result[i]
                        != (uint)((i < Op1ElementCount) ? left[i] : right[i - Op1ElementCount])
                    )
                    {
                        succeeded = false;
                        break;
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Vector256)}.{nameof(Vector256.Narrow)}<UInt32>(Vector256<UInt64>, Vector256<UInt64>): {method} failed:"
                    );
