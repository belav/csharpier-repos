...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorUnaryOpTest__ConvertToUInt64Double
    {
        ...
        private struct TestStruct
        {
            ...
            {
                var result = Vector256.ConvertToUInt64(_fld1);
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = Vector256.ConvertToUInt64(
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var method = typeof(Vector256).GetMethod(
                nameof(Vector256.ConvertToUInt64),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Vector256.ConvertToUInt64(_clsVar1);
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = Vector256.ConvertToUInt64(op1);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new VectorUnaryOpTest__ConvertToUInt64Double();
            var result = Vector256.ConvertToUInt64(test._fld1);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(Vector256)}.{nameof(Vector256.ConvertToUInt64)}<UInt64>(Vector256<Double>): {method} failed:"
                );
                TestLibrary.TestFramework.LogInformation(
