    ...
    public sealed unsafe class VectorTernaryOpTest__ConditionalSelectUInt64
    {
        ...
        private struct TestStruct
        {
            ...
            public static TestStruct Create()
            {
                ...
                Unsafe.CopyBlockUnaligned(
                    ref Unsafe.As<Vector256<UInt64>, byte>(ref testStruct._fld3),
        ...
        static VectorTernaryOpTest__ConditionalSelectUInt64()
        {
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector256<UInt64>, byte>(ref _clsVar3),
                ref Unsafe.As<UInt64, byte>(ref _data3[0]),
                (uint)Unsafe.SizeOf<Vector256<UInt64>>()
            );
        }
        ...
        public VectorTernaryOpTest__ConditionalSelectUInt64()
        {
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector256<UInt64>, byte>(ref _fld3),
                ref Unsafe.As<UInt64, byte>(ref _data3[0]),
                (uint)Unsafe.SizeOf<Vector256<UInt64>>()
            );
        ...
        )
        {
            ...
            else
            {
                for (var i = 1; i < RetElementCount; i++)
                {
                    if (
                        result[i]
                        != (ulong)((secondOp[i] & firstOp[i]) | (thirdOp[i] & ~firstOp[i]))
                    )
                    {
                        succeeded = false;
                        break;
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Vector256)}.{nameof(Vector256.ConditionalSelect)}<UInt64>(Vector256<UInt64>, Vector256<UInt64>, Vector256<UInt64>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
