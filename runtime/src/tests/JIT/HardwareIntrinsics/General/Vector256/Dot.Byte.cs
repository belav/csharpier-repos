...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorBinaryOpTest__DotByte
    {
        ...
        private struct TestStruct
        {
            ...
            {
                var result = Vector256.Dot(_fld1, _fld2);
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Vector256.Dot(_clsVar1, _clsVar2);
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = Vector256.Dot(op1, op2);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new VectorBinaryOpTest__DotByte();
            var result = Vector256.Dot(test._fld1, test._fld2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Vector256)}.{nameof(Vector256.Dot)}<Byte>(Vector256<Byte>, Vector256<Byte>): {method} failed:"
                    );
