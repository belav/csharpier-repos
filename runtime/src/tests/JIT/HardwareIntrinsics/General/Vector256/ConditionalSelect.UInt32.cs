    ...
    public sealed unsafe class VectorTernaryOpTest__ConditionalSelectUInt32
    {
        ...
        private struct TestStruct
        {
            ...
            public static TestStruct Create()
            {
                ...
                Unsafe.CopyBlockUnaligned(
                    ref Unsafe.As<Vector256<UInt32>, byte>(ref testStruct._fld3),
        ...
        static VectorTernaryOpTest__ConditionalSelectUInt32()
        {
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector256<UInt32>, byte>(ref _clsVar3),
                ref Unsafe.As<UInt32, byte>(ref _data3[0]),
                (uint)Unsafe.SizeOf<Vector256<UInt32>>()
            );
        }
        ...
        public VectorTernaryOpTest__ConditionalSelectUInt32()
        {
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Vector256<UInt32>, byte>(ref _fld3),
                ref Unsafe.As<UInt32, byte>(ref _data3[0]),
                (uint)Unsafe.SizeOf<Vector256<UInt32>>()
            );
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Vector256)}.{nameof(Vector256.ConditionalSelect)}<UInt32>(Vector256<UInt32>, Vector256<UInt32>, Vector256<UInt32>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
