...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorBooleanBinaryOpTest__LessThanAnyUInt32
    {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Vector256.LessThanAny(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Vector256)}.{nameof(Vector256.LessThanAny)}<UInt32>(Vector256<UInt32>, Vector256<UInt32>): {method} failed:"
                    );
