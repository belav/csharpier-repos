    ...
    public sealed unsafe class VectorUnaryOpTest__ConvertToInt64Double
    {
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var method = typeof(Vector256).GetMethod(
                nameof(Vector256.ConvertToInt64),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Vector256.ConvertToInt64(_clsVar1);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Vector256)}.{nameof(Vector256.ConvertToInt64)}<Int64>(Vector256<Double>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
