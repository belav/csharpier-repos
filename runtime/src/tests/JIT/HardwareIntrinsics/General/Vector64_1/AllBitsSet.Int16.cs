...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorAllBitsSet__AllBitsSetInt16
    {
        ...
        public void RunBasicScenario()
        {
            ...
            Vector64<Int16> result = Vector64<Int16>.AllBitsSet;
        ...
        public void RunReflectionScenario()
        {
            ...
            object result = typeof(Vector64<Int16>).GetProperty(
                    nameof(Vector64<Int16>.AllBitsSet),
                    new Type[] {  }
                )
                .GetGetMethod()
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"Vector64.AllBitsSet(Int16): {method} failed:"
                );
                TestLibrary.TestFramework.LogInformation(
