...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorAllBitsSet__AllBitsSetInt32
    {
        ...
        public void RunBasicScenario()
        {
            ...
            Vector64<Int32> result = Vector64<Int32>.AllBitsSet;
        ...
        public void RunReflectionScenario()
        {
            ...
            object result = typeof(Vector64<Int32>).GetProperty(
                    nameof(Vector64<Int32>.AllBitsSet),
                    new Type[] {  }
                )
                .GetGetMethod()
        ...
        private unsafe void ValidateResult(
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"Vector64.AllBitsSet(Int32): {method} failed:"
                );
                TestLibrary.TestFramework.LogInformation(
