...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorUnaryOpTest__op_UnaryNegationInt32
    {
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = -Unsafe.Read<Vector64<Int32>>(_dataTable.inArray1Ptr);
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Vector64<Int32>)
                .GetMethod("op_UnaryNegation", new Type[] { typeof(Vector64<Int32>) })
                .Invoke(
                    null,
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Vector64)}.op_UnaryNegation<Int32>(Vector64<Int32>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
