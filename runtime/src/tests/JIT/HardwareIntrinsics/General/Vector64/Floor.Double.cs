...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorUnaryOpTest__FloorDouble
    {
        ...
        private struct TestStruct
        {
            ...
            {
                var result = Vector64.Floor(_fld1);
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = Vector64.Floor(Unsafe.Read<Vector64<Double>>(_dataTable.inArray1Ptr));
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Vector64.Floor(_clsVar1);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new VectorUnaryOpTest__FloorDouble();
            var result = Vector64.Floor(test._fld1);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Vector64)}.{nameof(Vector64.Floor)}<Double>(Vector64<Double>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
