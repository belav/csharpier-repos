...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorUnaryOpTest__ConvertToInt64Double
    {
        ...
        private struct TestStruct
        {
            ...
            {
                var result = Vector64.ConvertToInt64(_fld1);
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = Vector64.ConvertToInt64(
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var method = typeof(Vector64).GetMethod(
                nameof(Vector64.ConvertToInt64),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Vector64.ConvertToInt64(_clsVar1);
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = Vector64.ConvertToInt64(op1);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new VectorUnaryOpTest__ConvertToInt64Double();
            var result = Vector64.ConvertToInt64(test._fld1);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(Vector64)}.{nameof(Vector64.ConvertToInt64)}<Int64>(Vector64<Double>): {method} failed:"
                );
                TestLibrary.TestFramework.LogInformation(
