...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorBinaryOpTest__MultiplyUInt32
    {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Vector64.Multiply(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Vector64)}.{nameof(Vector64.Multiply)}<UInt32>(Vector64<UInt32>, Vector64<UInt32>): {method} failed:"
                    );
