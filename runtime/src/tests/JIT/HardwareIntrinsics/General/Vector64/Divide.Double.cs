...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorBinaryOpTest__DivideDouble
    {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Vector64.Divide(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Vector64)}.{nameof(Vector64.Divide)}<Double>(Vector64<Double>, Vector64<Double>): {method} failed:"
                    );
