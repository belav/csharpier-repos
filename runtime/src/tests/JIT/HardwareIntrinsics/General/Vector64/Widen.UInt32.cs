...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorWidenTest__WidenUInt32
    {
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = Vector64.Widen(Unsafe.Read<Vector64<UInt16>>(_dataTable.inArray1Ptr));
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            Unsafe.Write(
                _dataTable.outLowerArrayPtr,
                (((Vector64<UInt32> Lower, Vector64<UInt32> Upper))(result)).Lower
            );
            Unsafe.Write(
                _dataTable.outUpperArrayPtr,
                (((Vector64<UInt32> Lower, Vector64<UInt32> Upper))(result)).Upper
            );
            ValidateResult(
                _dataTable.inArray1Ptr,
                _dataTable.outLowerArrayPtr,
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Vector64)}.{nameof(Vector64.Widen)}<UInt32>(Vector64<UInt16>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
