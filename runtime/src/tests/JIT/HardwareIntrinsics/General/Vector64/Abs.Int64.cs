...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorUnaryOpTest__AbsInt64
    {
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = Vector64.Abs(Unsafe.Read<Vector64<Int64>>(_dataTable.inArray1Ptr));
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Vector64.Abs(_clsVar1);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Vector64)}.{nameof(Vector64.Abs)}<Int64>(Vector64<Int64>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
