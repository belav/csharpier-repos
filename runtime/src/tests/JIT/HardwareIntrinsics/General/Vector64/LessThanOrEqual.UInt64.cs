...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorBinaryOpTest__LessThanOrEqualUInt64
    {
        ...
        private struct TestStruct
        {
            ...
            {
                var result = Vector64.LessThanOrEqual(_fld1, _fld2);
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = Vector64.LessThanOrEqual(
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var method = typeof(Vector64).GetMethod(
                nameof(Vector64.LessThanOrEqual),
                new Type[] { typeof(Vector64<UInt64>), typeof(Vector64<UInt64>) }
            );
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Vector64.LessThanOrEqual(_clsVar1, _clsVar2);
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = Vector64.LessThanOrEqual(op1, op2);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new VectorBinaryOpTest__LessThanOrEqualUInt64();
            var result = Vector64.LessThanOrEqual(test._fld1, test._fld2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Vector64)}.{nameof(Vector64.LessThanOrEqual)}<UInt64>(Vector64<UInt64>, Vector64<UInt64>): {method} failed:"
                    );
