...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorBinaryOpTest__BitwiseAndSByte
    {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Vector64.BitwiseAnd(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Vector64)}.{nameof(Vector64.BitwiseAnd)}<SByte>(Vector64<SByte>, Vector64<SByte>): {method} failed:"
                    );
