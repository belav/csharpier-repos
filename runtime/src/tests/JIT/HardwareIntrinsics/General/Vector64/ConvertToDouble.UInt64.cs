    ...
    public sealed unsafe class VectorUnaryOpTest__ConvertToDoubleUInt64
    {
        ...
        private struct TestStruct
        {
            ...
            public static TestStruct Create()
            {
                ...
                {
                    _data1[i] = Math.Min(long.MaxValue, TestLibrary.Generator.GetUInt64());
                }
                Unsafe.CopyBlockUnaligned(
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var method = typeof(Vector64).GetMethod(
                nameof(Vector64.ConvertToDouble),
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Vector64.ConvertToDouble(_clsVar1);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation(
                    $"{nameof(Vector64)}.{nameof(Vector64.ConvertToDouble)}<Double>(Vector64<UInt64>): {method} failed:"
                );
                TestLibrary.TestFramework.LogInformation(
