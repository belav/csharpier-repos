...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorBinaryOpTest__AndNotByte
    {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Vector64.AndNot(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Vector64)}.{nameof(Vector64.AndNot)}<Byte>(Vector64<Byte>, Vector64<Byte>): {method} failed:"
                    );
