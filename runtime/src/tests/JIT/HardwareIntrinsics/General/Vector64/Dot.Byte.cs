...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorBinaryOpTest__DotByte
    {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Vector64.Dot(_clsVar1, _clsVar2);
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = Vector64.Dot(op1, op2);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new VectorBinaryOpTest__DotByte();
            var result = Vector64.Dot(test._fld1, test._fld2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Vector64)}.{nameof(Vector64.Dot)}<Byte>(Vector64<Byte>, Vector64<Byte>): {method} failed:"
                    );
