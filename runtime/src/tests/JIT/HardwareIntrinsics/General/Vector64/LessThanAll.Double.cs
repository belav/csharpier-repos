...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorBooleanBinaryOpTest__LessThanAllDouble
    {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Vector64.LessThanAll(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Vector64)}.{nameof(Vector64.LessThanAll)}<Double>(Vector64<Double>, Vector64<Double>): {method} failed:"
                    );
