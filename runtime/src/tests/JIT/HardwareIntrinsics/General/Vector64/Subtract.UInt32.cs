...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorBinaryOpTest__SubtractUInt32
    {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Vector64.Subtract(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Vector64)}.{nameof(Vector64.Subtract)}<UInt32>(Vector64<UInt32>, Vector64<UInt32>): {method} failed:"
                    );
