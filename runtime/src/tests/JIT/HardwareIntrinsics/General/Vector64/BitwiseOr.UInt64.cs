...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorBinaryOpTest__BitwiseOrUInt64
    {
        ...
        private struct TestStruct
        {
            ...
            {
                var result = Vector64.BitwiseOr(_fld1, _fld2);
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Vector64.BitwiseOr(_clsVar1, _clsVar2);
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = Vector64.BitwiseOr(op1, op2);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new VectorBinaryOpTest__BitwiseOrUInt64();
            var result = Vector64.BitwiseOr(test._fld1, test._fld2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Vector64)}.{nameof(Vector64.BitwiseOr)}<UInt64>(Vector64<UInt64>, Vector64<UInt64>): {method} failed:"
                    );
