...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorBinaryOpTest__EqualsUInt16
    {
        ...
        private struct TestStruct
        {
            ...
            {
                var result = Vector64.Equals(_fld1, _fld2);
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Vector64.Equals(_clsVar1, _clsVar2);
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = Vector64.Equals(op1, op2);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new VectorBinaryOpTest__EqualsUInt16();
            var result = Vector64.Equals(test._fld1, test._fld2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Vector64)}.{nameof(Vector64.Equals)}<UInt16>(Vector64<UInt16>, Vector64<UInt16>): {method} failed:"
                    );
