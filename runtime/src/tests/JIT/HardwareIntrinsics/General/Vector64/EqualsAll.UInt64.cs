...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorBooleanBinaryOpTest__EqualsAllUInt64
    {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Vector64.EqualsAll(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Vector64)}.{nameof(Vector64.EqualsAll)}<UInt64>(Vector64<UInt64>, Vector64<UInt64>): {method} failed:"
                    );
