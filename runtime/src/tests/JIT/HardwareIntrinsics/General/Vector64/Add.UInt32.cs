...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorBinaryOpTest__AddUInt32
    {
        ...
        private struct TestStruct
        {
            ...
            {
                var result = Vector64.Add(_fld1, _fld2);
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Vector64.Add(_clsVar1, _clsVar2);
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = Vector64.Add(op1, op2);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new VectorBinaryOpTest__AddUInt32();
            var result = Vector64.Add(test._fld1, test._fld2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Vector64)}.{nameof(Vector64.Add)}<UInt32>(Vector64<UInt32>, Vector64<UInt32>): {method} failed:"
                    );
