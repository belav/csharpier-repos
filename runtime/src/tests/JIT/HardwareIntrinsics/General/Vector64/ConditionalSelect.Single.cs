        ...
        )
        {
            ...
            if (
                ...
                != (
                    ...
                    | (
                        BitConverter.SingleToInt32Bits(thirdOp[0])
                        & ~BitConverter.SingleToInt32Bits(firstOp[0])
                    )
                )
            )
                ...
                for (var i = 1; i < RetElementCount; i++)
                {
                    if (
                        ...
                        != (
                            ...
                            | (
                                BitConverter.SingleToInt32Bits(thirdOp[i])
                                & ~BitConverter.SingleToInt32Bits(firstOp[i])
                            )
                        )
                    )
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Vector64)}.{nameof(Vector64.ConditionalSelect)}<Single>(Vector64<Single>, Vector64<Single>, Vector64<Single>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
