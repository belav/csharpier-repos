...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorBooleanBinaryOpTest__EqualsAnyUInt32
    {
        ...
        public void RunClsVarScenario()
        {
            ...
            var result = Vector64.EqualsAny(_clsVar1, _clsVar2);
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Vector64)}.{nameof(Vector64.EqualsAny)}<UInt32>(Vector64<UInt32>, Vector64<UInt32>): {method} failed:"
                    );
