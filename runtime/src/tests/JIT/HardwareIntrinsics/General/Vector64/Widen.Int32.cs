...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorWidenTest__WidenInt32
    {
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = Vector64.Widen(Unsafe.Read<Vector64<Int16>>(_dataTable.inArray1Ptr));
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            Unsafe.Write(
                _dataTable.outLowerArrayPtr,
                (((Vector64<Int32> Lower, Vector64<Int32> Upper))(result)).Lower
            );
            Unsafe.Write(
                _dataTable.outUpperArrayPtr,
                (((Vector64<Int32> Lower, Vector64<Int32> Upper))(result)).Upper
            );
            ValidateResult(
                _dataTable.inArray1Ptr,
                _dataTable.outLowerArrayPtr,
        ...
        )
        {
            ...
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Int32, byte>(ref outLowerArray[0]),
                ref Unsafe.AsRef<byte>(lowerResult),
                (uint)Unsafe.SizeOf<Vector64<Int32>>()
            );
            Unsafe.CopyBlockUnaligned(
                ref Unsafe.As<Int32, byte>(ref outUpperArray[0]),
        ...
        )
        {
            ...
            if (!succeeded)
            {
                TestLibrary
                    .TestFramework
                    .LogInformation(
                        $"{nameof(Vector64)}.{nameof(Vector64.Widen)}<Int32>(Vector64<Int16>): {method} failed:"
                    );
                TestLibrary
                    .TestFramework
