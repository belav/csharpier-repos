...
namespace IntelHardwareIntrinsicTest._Avx2
{
    ...
    {
        [Fact]
        public static unsafe void ShiftLeftLogicalVariable()
        {
            int testResult = Pass;
            ...
            if (Avx2.IsSupported)
            {
                ...
                )
                {
                    ...
                    for (int i = 0; i < intTable.outArray.Length; i++)
                    {
                        ...
                        {
                            Console.WriteLine(
                                "AVX2 ShiftLeftLogicalVariable Vector128 failed on int:"
                            );
                            Console.WriteLine(
                                $"    left: ({string.Join(", ", intTable.inArray1)})"
                            );
                    ...
                    for (int i = 0; i < uintTable.outArray.Length; i++)
                    {
                        ...
                        {
                            Console.WriteLine(
                                "AVX2 ShiftLeftLogicalVariable Vector128 failed on uint:"
                            );
                            Console.WriteLine(
                                $"    left: ({string.Join(", ", uintTable.inArray1)})"
                            );
                    ...
                    for (int i = 0; i < longTable.outArray.Length; i++)
                    {
                        ...
                        {
                            Console.WriteLine(
                                "AVX2 ShiftLeftLogicalVariable Vector128 failed on long:"
                            );
                            Console.WriteLine(
                                $"    left: ({string.Join(", ", longTable.inArray1)})"
                            );
                    ...
                    for (int i = 0; i < ulongTable.outArray.Length; i++)
                    {
                        ...
                        {
                            Console.WriteLine(
                                "AVX2 ShiftLeftLogicalVariable Vector128 failed on ulong:"
                            );
                            Console.WriteLine(
                                $"    left: ({string.Join(", ", ulongTable.inArray1)})"
                            );
