...
namespace IntelHardwareIntrinsicTest._Avx2
{
    ...
    {
        public class GatherMaskVector256
        {
            const int N = 128;
                ...
                if (Avx2.IsSupported)
                {
                    ...
                    )
                    {
                        ...
                        try
                        {
                            ...
                            Console.WriteLine(
                                "AVX2 GatherMaskVector256 failed on float with invalid scale (IMM)"
                            );
                            testResult = Fail;
                        }
                        ...
                        try
                        {
                            ...
                            Console.WriteLine(
                                "AVX2 GatherMaskVector256 failed on float with invalid non-const scale (IMM)"
                            );
                            testResult = Fail;
                        }
                        catch (System.ArgumentOutOfRangeException)
                    ...
                    )
                    {
                        ...
                        try
                        {
                            ...
                            Console.WriteLine(
                                "AVX2 GatherMaskVector256 failed on double with invalid scale (IMM)"
                            );
                            testResult = Fail;
                        }
                        catch (System.ArgumentOutOfRangeException)
                        ...
                        try
                        {
                            ...
                            Console.WriteLine(
                                "AVX2 GatherMaskVector256 failed on double with invalid non-const scale (IMM)"
                            );
                            testResult = Fail;
                        }
                        catch (System.ArgumentOutOfRangeException)
                    ...
                    )
                    {
                        ...
                        {
                            Console.WriteLine(
                                "AVX2 GatherMaskVector256 failed with reflection on int:"
                            );
                            foreach (var item in intTable.outArray)
                            {
                                Console.Write(item + ", ");
                        ...
                        try
                        {
                            ...
                            Console.WriteLine(
                                "AVX2 GatherMaskVector256 failed on int with invalid scale (IMM)"
                            );
                            testResult = Fail;
                        }
                        catch (System.ArgumentOutOfRangeException)
                        ...
                        {
                            Console.WriteLine(
                                "AVX2 GatherMaskVector256 failed on int with non-const scale (IMM):"
                            );
                            foreach (var item in intTable.outArray)
                            {
                                Console.Write(item + ", ");
                        ...
                        try
                        {
                            ...
                            Console.WriteLine(
                                "AVX2 GatherMaskVector256 failed on int with invalid non-const scale (IMM)"
                            );
                            testResult = Fail;
                        }
                        catch (System.ArgumentOutOfRangeException)
                    ...
                    )
                    {
                        ...
                        {
                            Console.WriteLine(
                                "AVX2 GatherMaskVector256 failed with reflection on uint:"
                            );
                            foreach (var item in intTable.outArray)
                            {
                                Console.Write(item + ", ");
                        ...
                        try
                        {
                            ...
                            Console.WriteLine(
                                "AVX2 GatherMaskVector256 failed on uint with invalid scale (IMM)"
                            );
                            testResult = Fail;
                        }
                        catch (System.ArgumentOutOfRangeException)
                        ...
                        {
                            Console.WriteLine(
                                "AVX2 GatherMaskVector256 failed on uint with non-const scale (IMM):"
                            );
                            foreach (var item in intTable.outArray)
                            {
                                Console.Write(item + ", ");
                        ...
                        try
                        {
                            ...
                            Console.WriteLine(
                                "AVX2 GatherMaskVector256 failed on uint with invalid non-const scale (IMM)"
                            );
                            testResult = Fail;
                        }
                        catch (System.ArgumentOutOfRangeException)
                    ...
                    )
                    {
                        ...
                        {
                            Console.WriteLine(
                                "AVX2 GatherMaskVector256 failed with reflection on long:"
                            );
                            foreach (var item in longTable.outArray)
                            {
                                Console.Write(item + ", ");
                        ...
                        try
                        {
                            ...
                            Console.WriteLine(
                                "AVX2 GatherMaskVector256 failed on long with invalid scale (IMM)"
                            );
                            testResult = Fail;
                        }
                        catch (System.ArgumentOutOfRangeException)
                        ...
                        {
                            Console.WriteLine(
                                "AVX2 GatherMaskVector256 failed on long with non-const scale (IMM):"
                            );
                            foreach (var item in longTable.outArray)
                            {
                                Console.Write(item + ", ");
                        ...
                        try
                        {
                            ...
                            Console.WriteLine(
                                "AVX2 GatherMaskVector256 failed on long with invalid non-const scale (IMM)"
                            );
                            testResult = Fail;
                        }
                        catch (System.ArgumentOutOfRangeException)
                    ...
                    )
                    {
                        ...
                        {
                            Console.WriteLine(
                                "AVX2 GatherMaskVector256 failed with reflection on ulong:"
                            );
                            foreach (var item in longTable.outArray)
                            {
                                Console.Write(item + ", ");
                        ...
                        try
                        {
                            ...
                            Console.WriteLine(
                                "AVX2 GatherMaskVector256 failed on ulong with invalid scale (IMM)"
                            );
                            testResult = Fail;
                        }
                        catch (System.ArgumentOutOfRangeException)
                        ...
                        {
                            Console.WriteLine(
                                "AVX2 GatherMaskVector256 failed on ulong with non-const scale (IMM):"
                            );
                            foreach (var item in longTable.outArray)
                            {
                                Console.Write(item + ", ");
                        ...
                        try
                        {
                            ...
                            Console.WriteLine(
                                "AVX2 GatherMaskVector256 failed on ulong with invalid non-const scale (IMM)"
                            );
                            testResult = Fail;
                        }
                        catch (System.ArgumentOutOfRangeException)
                    ...
                    )
                    {
                        ...
                        {
                            Console.WriteLine(
                                "AVX2 GatherMaskVector256 failed on long with Vector256 long index:"
                            );
                            foreach (var item in longTable.outArray)
                            {
                                Console.Write(item + ", ");
                        ...
                        {
                            Console.WriteLine(
                                "AVX2 GatherMaskVector256 failed with reflection on long with Vector256 long index:"
                            );
                            foreach (var item in longTable.outArray)
                            {
                                Console.Write(item + ", ");
                        ...
                        try
                        {
                            ...
                            Console.WriteLine(
                                "AVX2 GatherMaskVector256 failed on long with invalid scale (IMM) and Vector256 long index"
                            );
                            testResult = Fail;
                        }
                        catch (System.ArgumentOutOfRangeException)
                        ...
                        {
                            Console.WriteLine(
                                "AVX2 GatherMaskVector256 failed on long with non-const scale (IMM) and Vector256 long index:"
                            );
                            foreach (var item in longTable.outArray)
                            {
                                Console.Write(item + ", ");
                        ...
                        try
                        {
                            ...
                            Console.WriteLine(
                                "AVX2 GatherMaskVector256 failed on long with invalid non-const scale (IMM) and Vector256 long index"
                            );
                            testResult = Fail;
                        }
                        catch (System.ArgumentOutOfRangeException)
                    ...
                    )
                    {
                        ...
                        {
                            Console.WriteLine(
                                "AVX2 GatherMaskVector256 failed on ulong with Vector256 long index:"
                            );
                            foreach (var item in longTable.outArray)
                            {
                                Console.Write(item + ", ");
                        ...
                        {
                            Console.WriteLine(
                                "AVX2 GatherMaskVector256 failed with reflection on ulong with Vector256 long index:"
                            );
                            foreach (var item in longTable.outArray)
                            {
                                Console.Write(item + ", ");
                        ...
                        try
                        {
                            ...
                            Console.WriteLine(
                                "AVX2 GatherMaskVector256 failed on ulong with invalid scale (IMM) and Vector256 long index"
                            );
                            testResult = Fail;
                        }
                        catch (System.ArgumentOutOfRangeException)
                        ...
                        {
                            Console.WriteLine(
                                "AVX2 GatherMaskVector256 failed on ulong with non-const scale (IMM) and Vector256 long index:"
                            );
                            foreach (var item in longTable.outArray)
                            {
                                Console.Write(item + ", ");
                    ...
                    )
                    {
                        ...
                        try
                        {
                            ...
                            Console.WriteLine(
                                "AVX2 GatherMaskVector256 failed on double with invalid scale (IMM) and Vector256 long index"
                            );
                            testResult = Fail;
                        }
                        catch (System.ArgumentOutOfRangeException)
                        ...
                        try
                        {
                            ...
                            Console.WriteLine(
                                "AVX2 GatherMaskVector256 failed on double with invalid non-const scale (IMM) and Vector256 long index"
                            );
                            testResult = Fail;
                        }
                        catch (System.ArgumentOutOfRangeException)
                ...
                public bool CheckResult(Func<T, T, bool> check, U[] indexArray)
                {
                    ...
                    for (int i = 0; i < length; i++)
                    {
                        ...
                        if (
                            ...
                            || (
                                !take
                                && !EqualityComparer<T>.Default.Equals(outArray[i], default(T))
                            )
                        )
                        {
                            return false;
