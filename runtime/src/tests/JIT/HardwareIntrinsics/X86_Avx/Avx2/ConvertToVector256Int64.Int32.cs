...
namespace JIT.HardwareIntrinsics.X86._Avx2.handwritten
{
    ...
    {
        [Fact]
        public static void ConvertToVector256Int64Int32()
        {
    ...
    public sealed unsafe class SimpleUnaryOpTest__ConvertToVector256Int64Int32
    {
        ...
        public SimpleUnaryOpTest__ConvertToVector256Int64Int32()
        {
            ...
            _dataTable = new SimpleUnaryOpTest__DataTable<Int64, Int32>(
                _data,
        ...
        {
            var result = Avx2.ConvertToVector256Int64((Int32*)(_dataTable.inArrayPtr));
        ...
        {
            var result = typeof(Avx2)
                .GetMethod(nameof(Avx2.ConvertToVector256Int64), new Type[] { typeof(Int32*) })
        ...
        )
        {
            ...
            {
                Console.WriteLine(
                    $"{nameof(Avx2)}.{nameof(Avx2.ConvertToVector256Int64)}<Int64>(Vector128<Int32>): {method} failed:"
                );
