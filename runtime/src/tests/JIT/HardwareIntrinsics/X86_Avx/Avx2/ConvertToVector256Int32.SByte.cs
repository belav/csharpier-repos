...
namespace JIT.HardwareIntrinsics.X86._Avx2.handwritten
{
    ...
    {
        [Fact]
        public static void ConvertToVector256Int32SByte()
        {
    ...
    public sealed unsafe class SimpleUnaryOpTest__ConvertToVector256Int32SByte
    {
        ...
        public SimpleUnaryOpTest__ConvertToVector256Int32SByte()
        {
            ...
            _dataTable = new SimpleUnaryOpTest__DataTable<Int32, SByte>(
                _data,
        ...
        {
            var result = Avx2.ConvertToVector256Int32((SByte*)(_dataTable.inArrayPtr));
        ...
        {
            var result = typeof(Avx2)
                .GetMethod(nameof(Avx2.ConvertToVector256Int32), new Type[] { typeof(SByte*) })
        ...
        )
        {
            ...
            {
                Console.WriteLine(
                    $"{nameof(Avx2)}.{nameof(Avx2.ConvertToVector256Int32)}<Int32>(Vector128<SByte>): {method} failed:"
                );
