...
namespace JIT.HardwareIntrinsics.X86._Avx2.handwritten
{
    ...
    {
        [Fact]
        public static void ConvertToVector256Int16SByte()
        {
    ...
    public sealed unsafe class SimpleUnaryOpTest__ConvertToVector256Int16SByte
    {
        ...
        {
            var result = Avx2.ConvertToVector256Int16((SByte*)(_dataTable.inArrayPtr));
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            var result = typeof(Avx2)
                .GetMethod(
                    nameof(Avx2.ConvertToVector256Int16),
        ...
        {
            var result = typeof(Avx2)
                .GetMethod(nameof(Avx2.ConvertToVector256Int16), new Type[] { typeof(SByte*) })
        ...
        {
            var result = Avx2.ConvertToVector256Int16(_clsVar);
        ...
        )
        {
            ...
            {
                Console.WriteLine(
                    $"{nameof(Avx2)}.{nameof(Avx2.ConvertToVector256Int16)}<Int16>(Vector128<SByte>): {method} failed:"
                );
