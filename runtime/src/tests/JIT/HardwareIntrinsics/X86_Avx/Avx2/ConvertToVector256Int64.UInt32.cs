...
namespace JIT.HardwareIntrinsics.X86._Avx2.handwritten
{
    ...
    {
        [Fact]
        public static void ConvertToVector256Int64UInt32()
        {
    ...
    public sealed unsafe class SimpleUnaryOpTest__ConvertToVector256Int64UInt32
    {
        ...
        {
            var result = Avx2.ConvertToVector256Int64((UInt32*)(_dataTable.inArrayPtr));
        ...
        {
            var result = typeof(Avx2)
                .GetMethod(nameof(Avx2.ConvertToVector256Int64), new Type[] { typeof(UInt32*) })
        ...
        )
        {
            ...
            {
                Console.WriteLine(
                    $"{nameof(Avx2)}.{nameof(Avx2.ConvertToVector256Int64)}<UInt64>(Vector128<UInt32>): {method} failed:"
                );
