            ...
            public static unsafe void Test()
            {
                ...
                if (Avx2.IsSupported)
                {
                    ...
                    )
                    {
                        ...
                        {
                            Console.WriteLine(
                                "AVX2 GatherVector128 failed with reflection on float:"
                            );
                            foreach (var item in floatTable.outArray)
                            {
                                Console.Write(item + ", ");
                    ...
                    )
                    {
                        ...
                        {
                            Console.WriteLine(
                                "AVX2 GatherVector128 failed with reflection on double:"
                            );
                            foreach (var item in doubletTable.outArray)
                            {
                                Console.Write(item + ", ");
                    ...
                    )
                    {
                        ...
                        {
                            Console.WriteLine(
                                "AVX2 GatherVector128 failed with reflection on int:"
                            );
                            foreach (var item in intTable.outArray)
                            {
                                Console.Write(item + ", ");
                    ...
                    )
                    {
                        ...
                        {
                            Console.WriteLine(
                                "AVX2 GatherVector128 failed with reflection on uint:"
                            );
                            foreach (var item in intTable.outArray)
                            {
                                Console.Write(item + ", ");
                    ...
                    )
                    {
                        ...
                        {
                            Console.WriteLine(
                                "AVX2 GatherVector128 failed with reflection on long:"
                            );
                            foreach (var item in longTable.outArray)
                            {
                                Console.Write(item + ", ");
