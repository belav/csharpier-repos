...
public class BringUpTest_struct16args
{
    ...
    [MethodImplAttribute(MethodImplOptions.NoInlining)]
    public static int method_2I4S2D(
        int i0,
        int i1,
        Point p0,
        Point p1,
    ...
    [MethodImplAttribute(MethodImplOptions.NoInlining)]
    public static int method_2I2D4S(
        int i0,
        int i1,
        double d0,
        double d1,
    ...
    [MethodImplAttribute(MethodImplOptions.NoInlining)]
    public static int method_2I2D4S2D(
        int i0,
        int i1,
        double d0,
        double d1,
