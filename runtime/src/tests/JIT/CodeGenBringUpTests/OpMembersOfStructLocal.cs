...
public struct PointFlt
{
    ...
    [MethodImplAttribute(MethodImplOptions.NoInlining)]
    public PointFlt(float a, float b, float c)
    {
        x = a;
        y = b;
        z = c;
    ...
    {
        return (
            Math.Abs(x) <= Single.Epsilon
            && Math.Abs(y) <= Single.Epsilon
            && Math.Abs(z) <= Single.Epsilon
        );
    }
}
...
public struct PointDbl
{
    ...
    [MethodImplAttribute(MethodImplOptions.NoInlining)]
    public PointDbl(double a, double b, double c)
    {
        x = a;
        y = b;
        z = c;
