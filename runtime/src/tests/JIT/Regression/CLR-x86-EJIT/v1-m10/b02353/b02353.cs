...
namespace DefaultNamespace
{
    public class Bug
    {
        ...
        internal static readonly Boolean[,] bArr =
        {
            { true, true, true, true, true, false, false, false, false, false },
            { true, true, true, true, true, false, false, false, false, false }
        };
        internal static readonly Char[,] cArr =
        {
            { 'a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'j' },
            { 'k', 'l', 'm', 'n', 'o', 'p', 'q', 'r', 's', 't' }
        };
        internal static readonly SByte[,] sbtArr =
        {
            {
                SByte.MinValue,
                (SByte)(-100),
        ...
        internal static readonly Byte[,] btArr =
        {
            { Byte.MinValue, 0, 5, 100, Byte.MaxValue },
            { Byte.MinValue, 0, 5, 100, Byte.MaxValue }
        };
        internal static readonly Int16[,] i16Arr =
        {
            { 19, 238, 317, 6, 565, 0, -52, 60, -563, 753 },
            { 19, 238, 317, 6, 565, 0, -52, 60, -563, 753 }
        };
        internal static readonly Int32[,] i32Arr =
        {
            { 19, 238, 317, 6, 565, 0, -52, 60, -563, 753 },
            { 19, 238, 317, 6, 565, 0, -52, 60, -563, 753 }
        };
        internal static readonly Int64[,] i64Arr =
        {
            {
                -530,
                Int64.MinValue,
        ...
        internal static readonly Single[,] fArr =
        {
            { -1.2e23f, 1.2e-32f, -1.23f, 0.0f, -1.0f, -1.2e23f, 1.2e-32f, -1.23f, 0.0f, -1.0f },
            { 1.23e23f, 1.23f, 0.0f, 2.45f, 35.0f, 1.23e23f, 1.23f, 0.0f, 2.45f, 35.0f }
        };
        internal static readonly Double[,] dArr =
        {
            { -1.2e23, 1.2e-32, -1.23, 0.0, 56.0, -1.2e23, 1.2e-32, -1.23, 0.0, 56.0, },
            { 1.23e23, 1.23, 0.0, 2.45, 635.0, -1.2e23, 1.2e-32, -1.23, 0.0, 56.0 }
        };
        internal static readonly String[,] strArr =
        {
