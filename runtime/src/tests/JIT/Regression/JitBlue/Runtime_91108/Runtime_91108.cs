        ...
        unchecked
        {
            return (
                (int)(
                    (
                        (int)(
                            s_int_8 = ((int)(s_int_8 &= ((int)(s_int_8 % ((int)((s_int_8) | 49))))))
                        )
                    ) ^ ((int)(s_int_8 & ((int)(s_int_8 += ((int)(int_24 &= s_int_8))))))
                )
            );
        }
    }
        ...
        unchecked
        {
            ...
            p_int_546 = (
                (int)(
                    (
                        (int)(
                            int_554 |= ((int)(((int)(int_554 |= -1)) + ((int)(int_24 >>= s_int_8))))
                        )
                    )
                    / (
                        (int)(
                            (
                                (
                                    (int)(
                                        ((int)(((int)(s_int_8 / ((int)((int_24) | 46)))) & int_24))
                                        | (
                                            (int)(
                                                ((int)(int_554 % ((int)((int_554) | 16))))
                                                << ((int)(int_554 % ((int)((int_24) | 52))))
                                            )
                                        )
                                    )
                                )
                    ...
                    finally
                    {
                        sbyte_26 <<= (
                            (int)(
                                ...
                                << (
                                    (int)(
                                        s_int_8 + ((int)(s_int_8 = ((int)(p_int_546 -= p_int_546))))
                                    )
                                )
                            )
                        );
                        ...
                        (long)(
                            (
                                (long)(
                                    (
                                        (long)(
                                            ((long)(s_long_9 + long_25))
                                            << ((int)(s_int_8 % ((int)((int_24) | 22))))
                                        )
                                    )
                                    >> (
                                        (int)(
                                            ((int)(int_24 + LeafMethod6()))
                                            + ((int)(int_24 % ((int)((s_int_8) | 81))))
                                        )
                                    )
                                )
                            ) << int_554
