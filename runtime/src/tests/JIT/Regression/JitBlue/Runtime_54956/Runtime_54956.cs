...
public unsafe class Runtime_54956
{
    ...
    static bool Test(Action action, [CallerArgumentExpression("action")] string expr = null)
    {
        ...
        catch (Exception exception)
        {
            ...
            Console.WriteLine(
                $"{expr} failed. Expected {nameof(IndexOutOfRangeException)} but caught {exception.GetType().Name} instead."
            );
            return false;
        }

        Console.WriteLine(
            $"{expr} failed. Expected {nameof(IndexOutOfRangeException)} but none was thrown."
        );
        return false;
    }
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    static Vector256<int> SideEffects_Avx2_PermuteVar8x32(
        Vector256<int>[] left,
        Vector256<int>* right
    )
    {
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    static Vector128<double> SideEffects_Sse2_CompareScalarNotGreaterThanOrEqual(
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    static void SideEffects_Vector64_StoreAlignedNonTemporal(
        Vector64<int>[] source,
        int* destination
    )
    {
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    static void SideEffects_Vector128_StoreAlignedNonTemporal(
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    static void SideEffects_Vector256_StoreAlignedNonTemporal(
