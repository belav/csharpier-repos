...
public class Program
{
    ...
    public static int TestEntryPoint()
    {
        ...
        Vector256<int> v256ShuffleExpectedResult = Vector256.Create(
            107,
            105,
            0,
            101,
        ...
        Vector512<int> v512Shuffle = Vector512.Create(
            100,
            101,
            102,
            103,
        ...
        Vector512<int> v512ShuffleExpectedResult = Vector512.Create(
            115,
            113,
            111,
            0,
    ...
    public static Vector512<int> Vector512Shuffle(Vector512<int> v1)
    {
        return Vector512.Shuffle(
            v1,
            Vector512.Create(15, 13, 11, 99, 7, 5, 3, 1, 14, 12, 10, 8, -11, 4, 2, 0)
        );
    }
}
