...
public struct AA
{
    ...
    {
        for (
            (new long[58u, 97u, 118u])[122, 61, Math.Sign(41)] = ((long)(Math.Max(82.0, 69.0)));
            ((bool)((new object[42u])[54]));
            (new byte[33u, 119u])[60, (new int[46u, 48u])[55, 81]] = (new byte[8u][,,])[82][
                    48,
