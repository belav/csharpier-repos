...
public class AA
{
    ...
    public static Array Static1()
    {
        ...
        local1 = (new byte[26u, 74u, 72u, 42u])[
            new int[] { 96 }[60],
            (local1 ^ local1),
            (0),
            Math.Min(123, 31)
        ];
        return (new Array[29u, 70u, 67u][,,,])[16, 69, 1][
            75,
            Math.Sign(30),
            Math.Sign(7),
            Math.Max(71, 35)
    ...
    public static byte[,] Static2()
    {
        ...
        while ((new bool[2u, 2u, 54u, 97u][,])[32, 9, 82, 40][new int[] { }[31], Math.Sign(7)])
        {
            do
            {
                ...
                local2 = (new sbyte[122u, 103u])[(new int[52u, 120u])[18, 122], Math.Sign(109)];
                do
                {
                    break;
                }
#pragma warning disable 0162
                while (
                    (
                        new uint[] { 47u, 48u, 35u, 86u }[72]
                        != (new uint[95u, 92u, 5u])[15, (0), 101]
                    )
                );
#pragma warning restore 0162
            ...
            if (((bool)(new object[] { null }[65])))
                AA.Static1();
            for (
                (new sbyte[101u, 64u][])[122, 88][75] += Math.Min(
                    (new sbyte[91u, 27u, 86u])[48, 111, 62],
                    (new sbyte[57u, 83u])[122, 57]
                );
                (new float[] { 93.0f, 67.0f, 46.0f, 61.0f, 70.0f }[34] == ((float)(68.0)));
                (new ulong[93u, 100u, 123u, 105u][])[110, 106, 35, 16][((int)(47.0f))] *= Math.Max(
