...
internal unsafe class test1
{
    ...
    public static double Func2(CL2 cl2)
    {
        ...
        double retval2 = Convert.ToDouble(
            (
                (
                    ((clstatic2.arr1d2[0] - 0) / 4210752.2509803921)
                    * ((4210752.2509803921 + 0.0 - cl2.a52) * -0.015747789311803151)
                ) - (-0.015747789311803151 * (-0.015747789311803151 + cl2.a62))
            )
                - (
                    (clstatic2.arr1d2[0] / (cl2.a62 + 4210768.048464071))
                    - clstatic2.arr1d2[0] / -2093063.9766233866
                )
        );
        return retval2;
    }
    ...
    public static double Func(double* a3)
    {
        ...
        double retval = Convert.ToDouble(
            (-1.0000000018626452 + *a3 + val_1) * clstatic.a0
                + clstatic.a0
                + val2
                - val_3
                + 0.0
