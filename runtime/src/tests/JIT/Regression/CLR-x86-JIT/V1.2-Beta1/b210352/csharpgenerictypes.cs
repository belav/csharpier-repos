...
public class Utils
{
    ...
    public static void CheckType<U>(U parameterToCheck, Type typeToCheckAgainst)
    {
        ...
        {
            Fail(
                "Expected typeof generic method Type Parameter for parameter, '"
                    + parameterToCheck
                    + "', to be '"
                    + typeToCheckAgainst
                    + "', but found '"
        ...
        {
            Fail(
                "Expected Type.GetType parameter, '"
                    + parameterToCheck
                    + "', to be '"
                    + typeToCheckAgainst
                    + "', but found '"
                    + parameterToCheck.GetType()
                    + "'"
            );
        }
    }
...
public class GenericClass<T>
{
    ...
    public static U StaticGenericMethodUsesClassTypeParam<U>(
        T classParameter,
        U methodParameter,
        Type methodParameterType
    )
    ...
    public static int StaticNonGenericMethodIntUsesClassTypeParam(
        T classParameter,
        int methodParameter,
        Type methodParameterType
    )
    ...
    public static string StaticNonGenericMethodStringUsesClassTypeParam(
        T classParameter,
        string methodParameter,
        Type methodParameterType
    )
    ...
    public static int[] StaticNonGenericMethodIntArrayUsesClassTypeParam(
        T classParameter,
        int[] methodParameter,
        Type methodParameterType
    )
    ...
    public static string[] StaticNonGenericMethodStringArrayUsesClassTypeParam(
        T classParameter,
        string[] methodParameter,
        Type methodParameterType
    )
    ...
    public U GenericMethodUsesClassTypeParam<U>(
        T classParameter,
        U methodParameter,
        Type methodParameterType
    )
    ...
    public int NonGenericMethodIntUsesClassTypeParam(
        T classParameter,
        int methodParameter,
        Type methodParameterType
    )
    ...
    public string NonGenericMethodStringUsesClassTypeParam(
        T classParameter,
        string methodParameter,
        Type methodParameterType
    )
    ...
    public int[] NonGenericMethodIntArrayUsesClassTypeParam(
        T classParameter,
        int[] methodParameter,
        Type methodParameterType
    )
    ...
    public string[] NonGenericMethodStringArrayUsesClassTypeParam(
        T classParameter,
        string[] methodParameter,
        Type methodParameterType
    )
    ...
    public virtual U VirtualGenericMethod<U>(
        U methodParameter,
        Type methodParameterType,
        bool isBase
    )
    {
        ...
        if (isBase == false)
        {
            Utils.Fail("Expected to be true, but found it to be false.");
        }
        return methodParameter;
    }

    public virtual int VirtualNonGenericMethodInt(
        int methodParameter,
        Type methodParameterType,
        bool isBase
    )
    ...
    public virtual string VirtualNonGenericMethodString(
        string methodParameter,
        Type methodParameterType,
        bool isBase
    )
    ...
    public virtual int[] VirtualNonGenericMethodIntArray(
        int[] methodParameter,
        Type methodParameterType,
        bool isBase
    )
    ...
    public virtual string[] VirtualNonGenericMethodStringArray(
        string[] methodParameter,
        Type methodParameterType,
        bool isBase
    )
    ...
    public virtual U VirtualGenericMethodUsesClassTypeParam<U>(
        T classParameter,
        U methodParameter,
        Type methodParameterType,
        bool isBase
    ...
    public virtual int VirtualNonGenericMethodIntUsesClassTypeParam(
        T classParameter,
        int methodParameter,
        Type methodParameterType,
        bool isBase
    ...
    public virtual string VirtualNonGenericMethodStringUsesClassTypeParam(
        T classParameter,
        string methodParameter,
        Type methodParameterType,
        bool isBase
    ...
    public virtual int[] VirtualNonGenericMethodIntArrayUsesClassTypeParam(
        T classParameter,
        int[] methodParameter,
        Type methodParameterType,
        bool isBase
    ...
    public virtual string[] VirtualNonGenericMethodStringArrayUsesClassTypeParam(
        T classParameter,
        string[] methodParameter,
        Type methodParameterType,
        bool isBase
    ...
    {
        get { return nongenericIntField; }
        set { nongenericIntField = value; }
    }

    public string nongenericStringProperty
    {
        get { return nongenericStringField; }
        set { nongenericStringField = value; }
    }

    public int[] nongenericIntArrayProperty
    {
        get { return nongenericIntArrayField; }
        set { nongenericIntArrayField = value; }
    }

    public string[] nongenericStringArrayProperty
    {
        get { return nongenericStringArrayField; }
        set { nongenericStringArrayField = value; }
    }
    ...
    public virtual T genericVirtualProperty
    {
        ...
        {
            Utils.CheckType<T>(genericField, classParameterType);
            if (usingBaseVirtualProperty == false)
            {
                Utils.Fail(
                    "Expected usingBaseVirtualProperty to be true, but found it to be false."
                );
            }
            return genericField;
        }
    ...
    public delegate string nongenericDelegateString(
        string delegateParameter,
        Type typeOfDelegateParameter
    );
    public delegate int[] nongenericDelegateIntArray(
        int[] delegateParameter,
        Type typeOfDelegateParameter
    );
    public delegate string[] nongenericDelegateStringArray(
        string[] delegateParameter,
        Type typeOfDelegateParameter
    );
    public delegate U genericDelegateUsesClassTypeParam<U>(
        T classParameter,
        U delegateParameter,
        Type typeOfDelegateParameter
    );
    public delegate int nongenericDelegateIntUsesClassTypeParam(
        T classParameter,
        int delegateParameter,
        Type typeOfDelegateParameter
    );
    public delegate string nongenericDelegateStringUsesClassTypeParam(
        T classParameter,
        string delegateParameter,
        Type typeOfDelegateParameter
    );
    public delegate int[] nongenericDelegateIntArrayUsesClassTypeParam(
        T classParameter,
        int[] delegateParameter,
        Type typeOfDelegateParameter
    );
    public delegate string[] nongenericDelegateStringArrayUsesClassTypeParam(
        T classParameter,
        string[] delegateParameter,
        Type typeOfDelegateParameter
    );
...
{
    public override U VirtualGenericMethod<U>(
        U methodParameter,
        Type methodParameterType,
        bool isBase
    )
    {
        ...
        if (isBase == true)
        {
            Utils.Fail("Expected to be false, but found it to be true.");
        }
        return methodParameter;
    }

    public override int VirtualNonGenericMethodInt(
        int methodParameter,
        Type methodParameterType,
        bool isBase
    )
    ...
    public override string VirtualNonGenericMethodString(
        string methodParameter,
        Type methodParameterType,
        bool isBase
    )
    ...
    public override int[] VirtualNonGenericMethodIntArray(
        int[] methodParameter,
        Type methodParameterType,
        bool isBase
    )
    ...
    public override string[] VirtualNonGenericMethodStringArray(
        string[] methodParameter,
        Type methodParameterType,
        bool isBase
    )
    ...
    public override U VirtualGenericMethodUsesClassTypeParam<U>(
        T classParameter,
        U methodParameter,
        Type methodParameterType,
        bool isBase
    ...
    public override int VirtualNonGenericMethodIntUsesClassTypeParam(
        T classParameter,
        int methodParameter,
        Type methodParameterType,
        bool isBase
    ...
    public override string VirtualNonGenericMethodStringUsesClassTypeParam(
        T classParameter,
        string methodParameter,
        Type methodParameterType,
        bool isBase
    ...
    public override int[] VirtualNonGenericMethodIntArrayUsesClassTypeParam(
        T classParameter,
        int[] methodParameter,
        Type methodParameterType,
        bool isBase
    ...
    public override string[] VirtualNonGenericMethodStringArrayUsesClassTypeParam(
        T classParameter,
        string[] methodParameter,
        Type methodParameterType,
        bool isBase
    ...
    public override T genericVirtualProperty
    {
        ...
        {
            Utils.CheckType<T>(genericField, classParameterType);
            if (usingBaseVirtualProperty == true)
            {
                Utils.Fail(
                    "Expected usingBaseVirtualProperty to be false, but found it to be true."
                );
            }
            return genericField;
        }
