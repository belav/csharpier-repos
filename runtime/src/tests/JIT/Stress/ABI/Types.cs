...
namespace ABIStress
{
    ...
    internal class TypeEx
    {
        ...
        public TypeEx(Type t)
        {
            ...
            Fields = Enumerable
                .Range(0, 10000)
                .Select(i => t.GetField($"F{i}"))
                .TakeWhile(fi => fi != null)
                .ToArray();
    ...
    public struct I128_1
    {
        public Int128 F0;

        public I128_1(Int128 f0) => F0 = f0;
    }

    public struct I128_2
    {
        public byte F0;
        public Int128 F1;

        public I128_2(byte f0, Int128 f1) => (F0, F1) = (f0, f1);
    }
