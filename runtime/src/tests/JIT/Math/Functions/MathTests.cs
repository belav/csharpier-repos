...
namespace System.MathBenchmarks
{
    public partial class MathTests
    {
        ...
        // as we would have computed with the single-precision version of the function (without
        // aggregation).
        ...
        // for functions which have a larger domain (such as Atan, which covers the full set of real
        // numbers).
