...
public partial class Program
{
    public static void TestIsAssignableFrom()
    {
        ...
        IsFalse(
            typeof(IDictionary<ClassA, int>).IsAssignableFrom(typeof(IDictionary<ClassB, int>))
        );
        ...
        IsFalse(
            typeof(IDictionary<string, string>).IsAssignableFrom(typeof(IDictionary<string, int>))
        );
        ...
        ThrowsNRE(() =>
        {
            _ = ((Type)null).IsAssignableFrom(typeof(int));
        });
        ThrowsNRE(() =>
        {
            _ = ((Type)null).IsAssignableFrom(typeof(object));
        });
        ThrowsNRE(() =>
        {
            _ = ((Type)null).IsAssignableFrom(null);
        });
        ThrowsNRE(() =>
        {
            _ = ((Type)null).IsAssignableFrom(null);
        ...
        ThrowsNRE(() =>
        {
            _ = __reftype(default).IsAssignableFrom(typeof(int));
        });
        ThrowsNRE(() =>
        {
            _ = __reftype(default).IsAssignableFrom(typeof(object));
        });
        ThrowsNRE(() =>
        {
            _ = __reftype(default).IsAssignableFrom(__reftype(default));
        });
        ThrowsNRE(() =>
        {
            _ = __reftype(default).IsAssignableFrom(__reftype(default));
        ...
        IsTrue(
            IsAssignableFrom<KeyValuePair<IDisposable, object>, KeyValuePair<IDisposable, object>>()
        );
        IsTrue(
            IsAssignableFrom<
        ...
        IsTrue(
            IsAssignableFrom<IDictionary<IDisposable, object>, IDictionary<IDisposable, object>>()
        );
        IsTrue(
            IsAssignableFrom<
        ...
        IsTrue(
            IsAssignableFrom<Dictionary<IDisposable, object>, Dictionary<IDisposable, object>>()
        );
        ...
        IsFalse(
            IsAssignableFrom<KeyValuePair<IDisposable, int>, KeyValuePair<IDisposable, object>>()
        );
        IsFalse(
            IsAssignableFrom<
                IDictionary<IDisposable, IDisposable>,
        ...
        IsFalse(
            IsAssignableFrom<IDictionary<IDisposable, int>, IDictionary<IDisposable, object>>()
        );
        IsFalse(
            IsAssignableFrom<
                Dictionary<IDisposable, IDisposable>,
                Dictionary<IDisposable, object>
            >()
        );
