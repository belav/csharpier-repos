...
namespace MemoryMarshalGetArrayDataReferenceTest
{
    class Program
    {
        ...
        static unsafe int Main(string[] args)
        {
            ...
            static delegate* <byte[], ref byte> GetBytePtr() =>
                &MemoryMarshal.GetArrayDataReference<byte>;
            delegate* <byte[], ref byte> ptrByte = GetBytePtr();
            [MethodImpl(MethodImplOptions.NoInlining)]
            static delegate* <string[], ref string> GetStringPtr() =>
                &MemoryMarshal.GetArrayDataReference<string>;
            ...
            IsTrue(
                Unsafe.AreSame(
                    ref MemoryMarshal.GetArrayDataReference(testByteArray),
                    ref testByteArray[0]
                )
            );
            ...
            IsTrue(
                Unsafe.AreSame(
                    ref MemoryMarshal.GetArrayDataReference(NoInline(testByteArray)),
                    ref testByteArray[0]
                )
            );
            ...
            IsTrue(
                Unsafe.AreSame(
                    ref MemoryMarshal.GetArrayDataReference(testStringArray),
                    ref testStringArray[0]
                )
            );
            ...
            IsTrue(
                Unsafe.AreSame(
                    ref MemoryMarshal.GetArrayDataReference(NoInline(testStringArray)),
                    ref testStringArray[0]
                )
            );
            IsTrue(
                Unsafe.AreSame(ref ptrString(NoInline(testStringArray)), ref testStringArray[0])
            );
            ...
            IsFalse(
                Unsafe.IsNullRef(ref MemoryMarshal.GetArrayDataReference(new Vector128<byte>[0]))
            );
            IsFalse(
                Unsafe.IsNullRef(ref MemoryMarshal.GetArrayDataReference(new StructWithByte[0]))
            );
            IsFalse(Unsafe.IsNullRef(ref MemoryMarshal.GetArrayDataReference(new SimpleEnum[0])));
            IsFalse(
                Unsafe.IsNullRef(
                    ref MemoryMarshal.GetArrayDataReference(new GenericStruct<byte>[0])
                )
            );
            IsFalse(
                Unsafe.IsNullRef(
                    ref MemoryMarshal.GetArrayDataReference(new GenericStruct<string>[0])
                )
            );
            ...
            IsFalse(
                Unsafe.IsNullRef(ref MemoryMarshal.GetArrayDataReference(NoInline(new byte[0])))
            );
            IsFalse(
                Unsafe.IsNullRef(ref MemoryMarshal.GetArrayDataReference(NoInline(new string[0])))
            );
            IsFalse(
                Unsafe.IsNullRef(ref MemoryMarshal.GetArrayDataReference(NoInline(new Half[0])))
            );
            IsFalse(
                Unsafe.IsNullRef(
                    ref MemoryMarshal.GetArrayDataReference(NoInline(new Vector128<byte>[0]))
                )
            );
            IsFalse(
                Unsafe.IsNullRef(
                    ref MemoryMarshal.GetArrayDataReference(NoInline(new StructWithByte[0]))
                )
            );
            IsFalse(
                Unsafe.IsNullRef(
                    ref MemoryMarshal.GetArrayDataReference(NoInline(new SimpleEnum[0]))
                )
            );
            IsFalse(
                Unsafe.IsNullRef(
                    ref MemoryMarshal.GetArrayDataReference(NoInline(new GenericStruct<byte>[0]))
                )
            );
            IsFalse(
                Unsafe.IsNullRef(
                    ref MemoryMarshal.GetArrayDataReference(NoInline(new GenericStruct<string>[0]))
                )
            );
            ...
            ThrowsNRE(() =>
            {
                _ = ref MemoryMarshal.GetArrayDataReference<byte>(null);
            });
            ThrowsNRE(() =>
            {
                _ = ref MemoryMarshal.GetArrayDataReference<string>(null);
            });
            ThrowsNRE(() =>
            {
                _ = ref MemoryMarshal.GetArrayDataReference<Half>(null);
            });
            ThrowsNRE(() =>
            {
                _ = ref MemoryMarshal.GetArrayDataReference<Vector128<byte>>(null);
            });
            ThrowsNRE(() =>
            {
                _ = ref MemoryMarshal.GetArrayDataReference<StructWithByte>(null);
            });
            ThrowsNRE(() =>
            {
                _ = ref MemoryMarshal.GetArrayDataReference<SimpleEnum>(null);
            });
            ThrowsNRE(() =>
            {
                _ = ref MemoryMarshal.GetArrayDataReference<GenericStruct<byte>>(null);
            });
            ThrowsNRE(() =>
            {
                _ = ref MemoryMarshal.GetArrayDataReference<GenericStruct<string>>(null);
            });
            ...
            ThrowsNRE(() =>
            {
                _ = ref MemoryMarshal.GetArrayDataReference(NoInline<string[]>(null));
            });
            ThrowsNRE(() =>
            {
                _ = ref MemoryMarshal.GetArrayDataReference(NoInline<Half[]>(null));
            });
            ThrowsNRE(() =>
            {
                _ = ref MemoryMarshal.GetArrayDataReference(NoInline<Vector128<byte>[]>(null));
            });
            ThrowsNRE(() =>
            {
                _ = ref MemoryMarshal.GetArrayDataReference(NoInline<StructWithByte[]>(null));
            });
            ThrowsNRE(() =>
            {
                _ = ref MemoryMarshal.GetArrayDataReference(NoInline<SimpleEnum[]>(null));
            });
            ThrowsNRE(() =>
            {
                _ = ref MemoryMarshal.GetArrayDataReference(NoInline<GenericStruct<byte>[]>(null));
            });
            ThrowsNRE(() =>
            {
                _ = ref MemoryMarshal.GetArrayDataReference(
                    NoInline<GenericStruct<string>[]>(null)
                );
            });

            ThrowsNRE(() =>
            {
                _ = ref ptrByte(NoInline<byte[]>(null));
            });
            ThrowsNRE(() =>
            {
                _ = ref ptrString(NoInline<string[]>(null));
            });
            ...
            IsTrue(
                Unsafe.AreSame(
                    ref MemoryMarshal.GetArrayDataReference((Array)testByteArray),
                    ref testByteArray[0]
                )
            );
            ...
            IsTrue(
                Unsafe.AreSame(
                    ref MemoryMarshal.GetArrayDataReference((Array)NoInline(testByteArray)),
                    ref testByteArray[0]
                )
            );
            IsTrue(
                Unsafe.AreSame(
                    ref MemoryMarshal.GetArrayDataReference(NoInline<Array>(testByteArray)),
                    ref testByteArray[0]
                )
            );
            ...
            IsTrue(
                Unsafe.AreSame(
                    ref Unsafe.As<byte, string>(
                        ref MemoryMarshal.GetArrayDataReference((Array)testStringArray)
                    ),
                    ref testStringArray[0]
                )
            );
            IsTrue(
                Unsafe.AreSame(
                    ref Unsafe.As<byte, string>(ref ptrMd(testStringArray)),
                    ref testStringArray[0]
                )
            );
            ...
            IsTrue(
                Unsafe.AreSame(
                    ref Unsafe.As<byte, string>(
                        ref MemoryMarshal.GetArrayDataReference((Array)NoInline(testStringArray))
                    ),
                    ref testStringArray[0]
                )
            );
            IsTrue(
                Unsafe.AreSame(
                    ref Unsafe.As<byte, string>(
                        ref MemoryMarshal.GetArrayDataReference(NoInline<Array>(testStringArray))
                    ),
                    ref testStringArray[0]
                )
            );
            IsTrue(
                Unsafe.AreSame(
                    ref Unsafe.As<byte, string>(ref ptrMd(NoInline(testStringArray))),
                    ref testStringArray[0]
                )
            );
            ...
            IsTrue(
                Unsafe.AreSame(
                    ref MemoryMarshal.GetArrayDataReference(testByteMdArray),
                    ref testByteMdArray[0, 0]
                )
            );
            ...
            IsTrue(
                Unsafe.AreSame(
                    ref MemoryMarshal.GetArrayDataReference(NoInline(testByteMdArray)),
                    ref testByteMdArray[0, 0]
                )
            );
            ...
            IsTrue(
                Unsafe.AreSame(
                    ref Unsafe.As<byte, string>(
                        ref MemoryMarshal.GetArrayDataReference(testStringMdArray)
                    ),
                    ref testStringMdArray[0, 0]
                )
            );
            IsTrue(
                Unsafe.AreSame(
                    ref Unsafe.As<byte, string>(ref ptrMd(testStringMdArray)),
                    ref testStringMdArray[0, 0]
                )
            );
            ...
            IsTrue(
                Unsafe.AreSame(
                    ref Unsafe.As<byte, string>(
                        ref MemoryMarshal.GetArrayDataReference(NoInline(testStringMdArray))
                    ),
                    ref testStringMdArray[0, 0]
                )
            );
            IsTrue(
                Unsafe.AreSame(
                    ref Unsafe.As<byte, string>(ref ptrMd(NoInline(testStringMdArray))),
                    ref testStringMdArray[0, 0]
                )
            );
            ...
            {
                Array nonZeroArray = Array.CreateInstance(
                    typeof(string),
                    new[] { 1 },
                    new[] { -1 }
                );
                ...
                IsTrue(
                    ReferenceEquals(
                        Unsafe.As<byte, string>(
                            ref MemoryMarshal.GetArrayDataReference(nonZeroArray)
                        ),
                        test
                    )
                );
                ...
                IsTrue(
                    ReferenceEquals(
                        Unsafe.As<byte, string>(
                            ref MemoryMarshal.GetArrayDataReference(NoInline(nonZeroArray))
                        ),
                        test
                    )
                );
                IsTrue(
                    ReferenceEquals(
                        Unsafe.As<byte, string>(ref ptrMd(NoInline(nonZeroArray))),
                        test
                    )
                );
            }
            ...
            IsFalse(
                Unsafe.IsNullRef(ref MemoryMarshal.GetArrayDataReference((Array)new string[0]))
            );
            ...
            IsFalse(
                Unsafe.IsNullRef(
                    ref MemoryMarshal.GetArrayDataReference((Array)NoInline(new byte[0]))
                )
            );
            IsFalse(
                Unsafe.IsNullRef(
                    ref MemoryMarshal.GetArrayDataReference((Array)NoInline(new string[0]))
                )
            );
            IsFalse(
                Unsafe.IsNullRef(ref MemoryMarshal.GetArrayDataReference(NoInline(new byte[0, 0])))
            );
            IsFalse(
                Unsafe.IsNullRef(
                    ref MemoryMarshal.GetArrayDataReference(NoInline(new string[0, 0]))
                )
            );
            IsFalse(
                Unsafe.IsNullRef(
                    ref MemoryMarshal.GetArrayDataReference(NoInline<Array>(new byte[0]))
                )
            );
            IsFalse(
                Unsafe.IsNullRef(
                    ref MemoryMarshal.GetArrayDataReference(NoInline<Array>(new string[0]))
                )
            );
            IsFalse(
                Unsafe.IsNullRef(
                    ref MemoryMarshal.GetArrayDataReference(NoInline<Array>(new byte[0, 0]))
                )
            );
            IsFalse(
                Unsafe.IsNullRef(
                    ref MemoryMarshal.GetArrayDataReference(NoInline<Array>(new string[0, 0]))
                )
            );
            ...
            ThrowsNRE(() =>
            {
                _ = ref MemoryMarshal.GetArrayDataReference((Array)null);
            });
            ThrowsNRE(() =>
            {
                _ = ref ptrMd(null);
            ...
            ThrowsNRE(() =>
            {
                _ = ref MemoryMarshal.GetArrayDataReference((Array)NoInline<byte[]>(null));
            });
            ThrowsNRE(() =>
            {
                _ = ref MemoryMarshal.GetArrayDataReference((Array)NoInline<string[]>(null));
            });
            ThrowsNRE(() =>
            {
                _ = ref MemoryMarshal.GetArrayDataReference(NoInline<Array>(null));
            });

            ThrowsNRE(() =>
            {
                _ = ref ptrMd(NoInline<byte[]>(null));
            });
            ThrowsNRE(() =>
            {
                _ = ref ptrMd(NoInline<string[]>(null));
            });
            ThrowsNRE(() =>
            {
                _ = ref ptrMd(NoInline<Array>(null));
            });
            ...
            static void Problem5()
            {
                ...
                static void Create(out Vector<int> result, int[] values, int index)
                {
                    ...
                    result = Unsafe.ReadUnaligned<Vector<int>>(
                        ref Unsafe.As<int, byte>(
                            ref Unsafe.Add(ref MemoryMarshal.GetArrayDataReference(values), index)
                        )
                    );
                }
        ...
        )
        {
            ...
            {
                Console.WriteLine(
                    $"{file}:L{line} test failed (expected: equal, actual: {left}-{right})."
                );
                _errors++;
            }
        }
        ...
        [MethodImpl(MethodImplOptions.NoInlining)]
        static void ThrowsNRE<T>(
            RefFunction<T> function,
            [CallerLineNumber] int line = 0,
            [CallerFilePath] string file = ""
        )
        {
