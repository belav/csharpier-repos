...
namespace BMI1Intrinsics
{
    internal class Program
    {
        ...
        static int Main(string[] args)
        {
            ...
            var values =
                new (uint input1, uint input2, uint andnExpected, uint blsiExpected, uint blsrExpected, uint blmskExpected)[]
                {
                    (0, 0, 0, 0, 0, 0),
            ...
            var values2 =
                new (ulong input1, ulong input2, ulong andnExpected, ulong blsiExpected, ulong blsrExpected, ulong blmskExpected)[]
                {
                    (0, 0, 0, 0, 0, 0),
