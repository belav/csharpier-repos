    ...
    class Program
    {
        ...
        static unsafe int Main()
        {
            ...
            fixed (double* pStaticValueArray = &staticValueArray[0])
            {
                ...
                {
                    Console.WriteLine(
                        "Math.Round of a addressed static value array (index 0) failed"
                    );
                    return Fail;
                }
                ...
                {
                    Console.WriteLine(
                        "Math.Round of a addressed static value array (index 1) failed"
                    );
                    return Fail;
                }
                ...
                {
                    Console.WriteLine(
                        "Math.Round of a addressed static value array (index 2) failed"
                    );
                    return Fail;
                }
            }
            ...
            fixed (double* pInstanceValueArray = &program.instanceValueArray[0])
            {
                ...
                {
                    Console.WriteLine(
                        "Math.Round of a addressed instance value array (index 0) failed"
                    );
                    return Fail;
                }
                ...
                {
                    Console.WriteLine(
                        "Math.Round of a addressed instance value array (index 1) failed"
                    );
                    return Fail;
                }
                ...
                {
                    Console.WriteLine(
                        "Math.Round of a addressed instance value array (index 2) failed"
                    );
                    return Fail;
                }
            }
