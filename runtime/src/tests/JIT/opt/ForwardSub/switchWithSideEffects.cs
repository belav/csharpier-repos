...
public class SwitchWithSideEffects
{
    ...
    public short Method12(
        out S2 p_s2_337,
        out float p_float_338,
        ref S2 p_s2_339,
        uint p_uint_340,
        S1 p_s1_341,
        ref long p_long_342,
    ...
    )
    {
        unchecked
        {
            ...
            return (short)(
                Method7(p_s1_344, s_s2_18, ref s2_34, ref s2_34, s1_33, out s1_33, s2_34, s_s2_18)
                + 15 / 4
                + 4
            );
        }
    ...
    public uint Method40(
        out ulong p_ulong_1015,
        ref S1 p_s1_1016,
        ref S2 p_s2_1017,
        S1 p_s1_1018,
        ref S1 p_s1_1019,
