...
public class Program
{
    ...
    private static void AssertEquals<T>(
        T expected,
        T actual,
        string values = "",
        ...
        where TException : Exception
    {
        ...
        catch (Exception ex)
        {
            if (ex.GetType() == typeof(TException))
                return;
            Console.WriteLine(
                $"{values}{ex.GetType().FullName} != {typeof(TException).FullName}, L{line}"
            );
            s_ReturnCode++;
        }
    }
    ...
    private static void Compare_Enum_Int32(MethodImplOptions a, MethodImplOptions b) =>
        AssertEquals(
            a.CompareTo(b),
            Comparer<MethodImplOptions>.Default.Compare(a, b),
            $"({a}; {b}): "
        );
    ...
    private static void Compare_Struct2(Struct2 a, Struct2 b) =>
        AssertThrows<ArgumentException>(
            () => Comparer<Struct2>.Default.Compare(a, b),
            $"({a}; {b}): "
        );

    private static void Compare_Struct1_Nullable(Struct1? a, Struct1? b) =>
        AssertEquals(
            ((IComparable)a)?.CompareTo(b) ?? (b.HasValue ? -1 : 0),
            Comparer<Struct1?>.Default.Compare(a, b),
            $"({a}; {b}): "
        );
    ...
    private static void Compare_Double_Enum(DoubleEnum a, DoubleEnum b) =>
        AssertEquals(
            a.CompareTo(b),
            Comparer<DoubleEnum>.Default.Compare(a, b),
            $"({PrintBits(a)}; {PrintBits(b)}): "
        );

    private static void Compare_Generic_Enum<TEnum>(TEnum a, TEnum b)
        where TEnum : Enum =>
        AssertEquals(
            a.CompareTo(b),
            Comparer<TEnum>.Default.Compare(a, b),
            $"({PrintBits(a)}; {PrintBits(b)}): "
        );
    ...
    private static void GetTypeTests()
    {
        ...
        AssertEquals(
            "System.Collections.Generic.EnumComparer`1[CharEnum]",
            Comparer<CharEnum>.Default.GetType().ToString()
        );
        AssertEquals(
            "System.Collections.Generic.EnumComparer`1[BoolEnum]",
            Comparer<BoolEnum>.Default.GetType().ToString()
        );
        AssertEquals(
            "System.Collections.Generic.EnumComparer`1[FloatEnum]",
            Comparer<FloatEnum>.Default.GetType().ToString()
        );
        AssertEquals(
            "System.Collections.Generic.EnumComparer`1[DoubleEnum]",
            Comparer<DoubleEnum>.Default.GetType().ToString()
        );
        AssertEquals(
            "System.Collections.Generic.EnumComparer`1[IntPtrEnum]",
            Comparer<IntPtrEnum>.Default.GetType().ToString()
        );
        AssertEquals(
            "System.Collections.Generic.EnumComparer`1[UIntPtrEnum]",
            Comparer<UIntPtrEnum>.Default.GetType().ToString()
        );
        AssertEquals(
        ...
        AssertEquals(
            "System.Collections.Generic.ObjectComparer`1[Struct2]",
            Comparer<Struct2>.Default.GetType().ToString()
        );
        AssertEquals(
            "System.Collections.Generic.GenericComparer`1[StructGeneric`1[System.Int32]]",
            Comparer<StructGeneric<int>>.Default.GetType().ToString()
        );
        AssertEquals(
            "System.Collections.Generic.GenericComparer`1[StructGeneric`1[System.String]]",
            Comparer<StructGeneric<string>>.Default.GetType().ToString()
        );
        AssertEquals(
            "System.Collections.Generic.ObjectComparer`1[StructGenericString`1[System.String]]",
            Comparer<StructGenericString<string>>.Default.GetType().ToString()
        );
        AssertEquals(
            "System.Collections.Generic.ObjectComparer`1[StructGenericString`1[System.Object]]",
            Comparer<StructGenericString<object>>.Default.GetType().ToString()
        );
        AssertEquals(
            "System.Collections.Generic.GenericComparer`1[StructGeneric`1[StructGeneric`1[System.Int32]]]",
            Comparer<StructGeneric<StructGeneric<int>>>.Default.GetType().ToString()
        );
        AssertEquals(
            "System.Collections.Generic.GenericComparer`1[StructGeneric`1[StructGeneric`1[System.String]]]",
            Comparer<StructGeneric<StructGeneric<string>>>.Default.GetType().ToString()
        );
        AssertEquals(
            "System.Collections.Generic.ObjectComparer`1[StructGenericString`1[StructGeneric`1[System.String]]]",
            Comparer<StructGenericString<StructGeneric<string>>>.Default.GetType().ToString()
        );
        AssertEquals(
            "System.Collections.Generic.ObjectComparer`1[StructGenericString`1[StructGeneric`1[System.Object]]]",
            Comparer<StructGenericString<StructGeneric<object>>>.Default.GetType().ToString()
        );
        ...
        AssertEquals(
            "System.Collections.Generic.NullableComparer`1[System.Int32]",
            Comparer<int?>.Default.GetType().ToString()
        );
        AssertEquals(
            "System.Collections.Generic.NullableComparer`1[System.Runtime.CompilerServices.MethodImplOptions]",
            Comparer<MethodImplOptions?>.Default.GetType().ToString()
        );
        AssertEquals(
            "System.Collections.Generic.NullableComparer`1[CharEnum]",
            Comparer<CharEnum?>.Default.GetType().ToString()
        );
        AssertEquals(
            "System.Collections.Generic.NullableComparer`1[BoolEnum]",
            Comparer<BoolEnum?>.Default.GetType().ToString()
        );
        AssertEquals(
            "System.Collections.Generic.NullableComparer`1[FloatEnum]",
            Comparer<FloatEnum?>.Default.GetType().ToString()
        );
        AssertEquals(
            "System.Collections.Generic.NullableComparer`1[DoubleEnum]",
            Comparer<DoubleEnum?>.Default.GetType().ToString()
        );
        AssertEquals(
            "System.Collections.Generic.NullableComparer`1[IntPtrEnum]",
            Comparer<IntPtrEnum?>.Default.GetType().ToString()
        );
        AssertEquals(
            "System.Collections.Generic.NullableComparer`1[UIntPtrEnum]",
            Comparer<UIntPtrEnum?>.Default.GetType().ToString()
        );
        AssertEquals(
            "System.Collections.Generic.NullableComparer`1[Struct1]",
            Comparer<Struct1?>.Default.GetType().ToString()
        );
        AssertEquals(
            "System.Collections.Generic.NullableComparer`1[Struct2]",
            Comparer<Struct2?>.Default.GetType().ToString()
        );
        AssertEquals(
            "System.Collections.Generic.NullableComparer`1[StructGeneric`1[System.Int32]]",
            Comparer<StructGeneric<int>?>.Default.GetType().ToString()
        );
        AssertEquals(
            "System.Collections.Generic.NullableComparer`1[StructGeneric`1[System.String]]",
            Comparer<StructGeneric<string>?>.Default.GetType().ToString()
        );
        AssertEquals(
            "System.Collections.Generic.NullableComparer`1[StructGenericString`1[System.String]]",
            Comparer<StructGenericString<string>?>.Default.GetType().ToString()
        );
        AssertEquals(
            "System.Collections.Generic.NullableComparer`1[StructGenericString`1[System.Object]]",
            Comparer<StructGenericString<object>?>.Default.GetType().ToString()
        );
        AssertEquals(
            "System.Collections.Generic.NullableComparer`1[StructGeneric`1[StructGeneric`1[System.Int32]]]",
            Comparer<StructGeneric<StructGeneric<int>>?>.Default.GetType().ToString()
        );
        AssertEquals(
            "System.Collections.Generic.NullableComparer`1[StructGeneric`1[StructGeneric`1[System.String]]]",
            Comparer<StructGeneric<StructGeneric<string>>?>.Default.GetType().ToString()
        );
        AssertEquals(
            "System.Collections.Generic.NullableComparer`1[StructGenericString`1[StructGeneric`1[System.String]]]",
            Comparer<StructGenericString<StructGeneric<string>>?>.Default.GetType().ToString()
        );
        AssertEquals(
            "System.Collections.Generic.NullableComparer`1[StructGenericString`1[StructGeneric`1[System.Object]]]",
            Comparer<StructGenericString<StructGeneric<object>>?>.Default.GetType().ToString()
        );

        AssertEquals(
            "System.Collections.Generic.GenericEqualityComparer`1[System.Byte]",
            EqualityComparer<byte>.Default.GetType().ToString()
        );
        AssertEquals(
            "System.Collections.Generic.GenericEqualityComparer`1[System.Int32]",
            EqualityComparer<int>.Default.GetType().ToString()
        );
        AssertEquals(
            "System.Collections.Generic.GenericEqualityComparer`1[System.String]",
            EqualityComparer<string>.Default.GetType().ToString()
        );
        AssertEquals(
            "System.Collections.Generic.GenericEqualityComparer`1[System.Guid]",
            EqualityComparer<Guid>.Default.GetType().ToString()
        );
        AssertEquals(
            "System.Collections.Generic.EnumEqualityComparer`1[System.Runtime.CompilerServices.MethodImplOptions]",
            EqualityComparer<MethodImplOptions>.Default.GetType().ToString()
        );
        AssertEquals(
            "System.Collections.Generic.EnumEqualityComparer`1[CharEnum]",
            EqualityComparer<CharEnum>.Default.GetType().ToString()
        );
        AssertEquals(
            "System.Collections.Generic.EnumEqualityComparer`1[BoolEnum]",
            EqualityComparer<BoolEnum>.Default.GetType().ToString()
        );
        AssertEquals(
            "System.Collections.Generic.EnumEqualityComparer`1[FloatEnum]",
            EqualityComparer<FloatEnum>.Default.GetType().ToString()
        );
        AssertEquals(
            "System.Collections.Generic.EnumEqualityComparer`1[DoubleEnum]",
            EqualityComparer<DoubleEnum>.Default.GetType().ToString()
        );
        AssertEquals(
            "System.Collections.Generic.EnumEqualityComparer`1[IntPtrEnum]",
            EqualityComparer<IntPtrEnum>.Default.GetType().ToString()
        );
        AssertEquals(
            "System.Collections.Generic.EnumEqualityComparer`1[UIntPtrEnum]",
            EqualityComparer<UIntPtrEnum>.Default.GetType().ToString()
        );
        AssertEquals(
            "System.Collections.Generic.ObjectEqualityComparer`1[Struct1]",
            EqualityComparer<Struct1>.Default.GetType().ToString()
        );
        AssertEquals(
            "System.Collections.Generic.ObjectEqualityComparer`1[Struct2]",
            EqualityComparer<Struct2>.Default.GetType().ToString()
        );
        AssertEquals(
            "System.Collections.Generic.GenericEqualityComparer`1[StructGeneric`1[System.Int32]]",
            EqualityComparer<StructGeneric<int>>.Default.GetType().ToString()
        );
        AssertEquals(
            "System.Collections.Generic.GenericEqualityComparer`1[StructGeneric`1[System.String]]",
            EqualityComparer<StructGeneric<string>>.Default.GetType().ToString()
        );
        AssertEquals(
            "System.Collections.Generic.ObjectEqualityComparer`1[StructGenericString`1[System.String]]",
            EqualityComparer<StructGenericString<string>>.Default.GetType().ToString()
        );
        AssertEquals(
            "System.Collections.Generic.ObjectEqualityComparer`1[StructGenericString`1[System.Object]]",
            EqualityComparer<StructGenericString<object>>.Default.GetType().ToString()
        );
        AssertEquals(
            "System.Collections.Generic.GenericEqualityComparer`1[StructGeneric`1[StructGeneric`1[System.Int32]]]",
            EqualityComparer<StructGeneric<StructGeneric<int>>>.Default.GetType().ToString()
        );
        AssertEquals(
            "System.Collections.Generic.GenericEqualityComparer`1[StructGeneric`1[StructGeneric`1[System.String]]]",
            EqualityComparer<StructGeneric<StructGeneric<string>>>.Default.GetType().ToString()
        );
        AssertEquals(
        ...
        AssertEquals(
            "System.Collections.Generic.NullableEqualityComparer`1[System.Byte]",
            EqualityComparer<byte?>.Default.GetType().ToString()
        );
        AssertEquals(
            "System.Collections.Generic.NullableEqualityComparer`1[System.Int32]",
            EqualityComparer<int?>.Default.GetType().ToString()
        );
        AssertEquals(
            "System.Collections.Generic.NullableEqualityComparer`1[System.Runtime.CompilerServices.MethodImplOptions]",
            EqualityComparer<MethodImplOptions?>.Default.GetType().ToString()
        );
        AssertEquals(
            "System.Collections.Generic.NullableEqualityComparer`1[CharEnum]",
            EqualityComparer<CharEnum?>.Default.GetType().ToString()
        );
        AssertEquals(
            "System.Collections.Generic.NullableEqualityComparer`1[BoolEnum]",
            EqualityComparer<BoolEnum?>.Default.GetType().ToString()
        );
        AssertEquals(
            "System.Collections.Generic.NullableEqualityComparer`1[FloatEnum]",
            EqualityComparer<FloatEnum?>.Default.GetType().ToString()
        );
        AssertEquals(
            "System.Collections.Generic.NullableEqualityComparer`1[DoubleEnum]",
            EqualityComparer<DoubleEnum?>.Default.GetType().ToString()
        );
        AssertEquals(
            "System.Collections.Generic.NullableEqualityComparer`1[IntPtrEnum]",
            EqualityComparer<IntPtrEnum?>.Default.GetType().ToString()
        );
        AssertEquals(
            "System.Collections.Generic.NullableEqualityComparer`1[UIntPtrEnum]",
            EqualityComparer<UIntPtrEnum?>.Default.GetType().ToString()
        );
        AssertEquals(
            "System.Collections.Generic.NullableEqualityComparer`1[Struct1]",
            EqualityComparer<Struct1?>.Default.GetType().ToString()
        );
        AssertEquals(
            "System.Collections.Generic.NullableEqualityComparer`1[Struct2]",
            EqualityComparer<Struct2?>.Default.GetType().ToString()
        );
        AssertEquals(
            "System.Collections.Generic.NullableEqualityComparer`1[StructGeneric`1[System.Int32]]",
            EqualityComparer<StructGeneric<int>?>.Default.GetType().ToString()
        );
        AssertEquals(
            "System.Collections.Generic.NullableEqualityComparer`1[StructGeneric`1[System.String]]",
            EqualityComparer<StructGeneric<string>?>.Default.GetType().ToString()
        );
        AssertEquals(
            "System.Collections.Generic.NullableEqualityComparer`1[StructGenericString`1[System.String]]",
            EqualityComparer<StructGenericString<string>?>.Default.GetType().ToString()
        );
        AssertEquals(
            "System.Collections.Generic.NullableEqualityComparer`1[StructGenericString`1[System.Object]]",
            EqualityComparer<StructGenericString<object>?>.Default.GetType().ToString()
        );
        AssertEquals(
            "System.Collections.Generic.NullableEqualityComparer`1[StructGeneric`1[StructGeneric`1[System.Int32]]]",
            EqualityComparer<StructGeneric<StructGeneric<int>>?>.Default.GetType().ToString()
        );
        AssertEquals(
            "System.Collections.Generic.NullableEqualityComparer`1[StructGeneric`1[StructGeneric`1[System.String]]]",
            EqualityComparer<StructGeneric<StructGeneric<string>>?>.Default.GetType().ToString()
        );
        AssertEquals(
