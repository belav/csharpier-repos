...
namespace coreclr_test_13647
{
    public class doublenegate
    {
        ...
        static bool Test1()
        {
            ...
            var y = DoubleNegationInt(DoubleNegationInt(DoubleNegationInt(x)));
        ...
        static bool Test2()
        {
            ...
            var y = DoubleNegationDouble(DoubleNegationDouble(DoubleNegationDouble(x)));
        ...
        static bool Test3()
        {
            ...
            var y = DoubleNotInt(DoubleNotInt(DoubleNotInt(x)));
