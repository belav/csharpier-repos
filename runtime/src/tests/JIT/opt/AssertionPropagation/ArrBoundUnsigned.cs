...
public class ArrBoundUnsigned
{
    ...
    public static int TestEntryPoint()
    {
        ...
        if (i_LT_UN_len(arr, 1) != arr[1])
            return Fail;
        if (i_LT_UN_len(arr, arr.Length) != 9999)
            return Fail;
        if (i_LT_UN_len(arr, -1) != 9999)
            return Fail;
        if (i_LT_UN_len(empty, 1) != 9999)
            return Fail;

        // len_GT_UN_i

        if (len_GT_UN_i(arr, 1) != arr[1])
            return Fail;
        if (len_GT_UN_i(arr, arr.Length) != 9999)
            return Fail;
        if (len_GT_UN_i(arr, -1) != 9999)
            return Fail;
        if (len_GT_UN_i(empty, 1) != 9999)
            return Fail;

        // i_LE_UN_len

        if (i_LE_UN_len(arr, -1) != 9999)
            return Fail;
        if (i_LE_UN_len(arr, arr.Length + 1) != 9999)
            return Fail;
        try
        {
        ...
        if (len_GE_UN_i(arr, -1) != 9999)
            return Fail;
        if (len_GE_UN_i(arr, arr.Length + 1) != 9999)
            return Fail;
        try
        {
        ...
        if (i_GT_UN_len(arr, arr.Length) != 9999)
            return Fail;
        try
        {
            i_GT_UN_len(arr, -1);
        ...
        if (len_LT_UN_i(arr, arr.Length) != 9999)
            return Fail;
        try
        {
            len_LT_UN_i(arr, -1);
        ...
        if (i_LT_UN_len_next_edge(arr, 1) != 9999)
            return Fail;
        try
        {
        ...
        if (len_GT_UN_i_next_edge(arr, 1) != 9999)
            return Fail;
        try
        {
        ...
        if (i_GE_UN_len_next_edge(arr, arr.Length) != 9999)
            return Fail;
        if (i_GE_UN_len_next_edge(arr, 0) != 1)
            return Fail;
        if (i_GE_UN_len_next_edge(arr, arr.Length - 1) != 3000)
            return Fail;

        // len_LE_UN_i

        if (len_LE_UN_i_next_edge(arr, arr.Length) != 9999)
            return Fail;
        if (len_LE_UN_i_next_edge(arr, 0) != 1)
            return Fail;
        if (len_LE_UN_i_next_edge(arr, arr.Length - 1) != 3000)
            return Fail;
        ...
        if (new Func<int>(() => i_LT_UN_len(arr, 0, 2))() != 1)
            return Fail;
        if (new Func<int>(() => i_LT_UN_len(arr, 0, 3))() != 9999)
            return Fail;
        try
        {
        ...
        if (new Func<int>(() => len_LT_UN_i(arr, 3, 0))() != 9999)
            return Fail;
        try
        {
        ...
        if (new Func<int>(() => len_GT_UN_i(arr, 2, 2))() != 3000)
            return Fail;
        try
        {
        ...
        if (new Func<int>(() => i_GT_UN_len(arr, 0, 4))() != 1)
            return Fail;
        if (new Func<int>(() => i_GT_UN_len(arr, 0, 3))() != 9999)
            return Fail;
        try
        {
        ...
        if (new Func<int>(() => len_LE_UN_i(arr, 0, 3))() != 1)
            return Fail;
        if (new Func<int>(() => len_LE_UN_i(arr, 0, 2))() != 9999)
            return Fail;
        try
        {
        ...
        if (new Func<int>(() => i_GE_UN_len(arr, 2, 3))() != 3000)
            return Fail;
        if (new Func<int>(() => i_GE_UN_len(arr, 3, 2))() != 9999)
            return Fail;
        try
        {
        ...
        if (new Func<int>(() => i_LT_UN_len_next_edge(arr, 0, 2))() != 9999)
            return Fail;
        if (new Func<int>(() => i_LT_UN_len_next_edge(arr, 0, 3))() != 1)
            return Fail;
        try
        {
        ...
        if (new Func<int>(() => i_GT_UN_len_next_edge(arr, 0, 3))() != 1)
            return Fail;
        if (new Func<int>(() => i_GT_UN_len_next_edge(arr, 2, 2))() != 3000)
            return Fail;
        try
        {
        ...
        if (new Func<int>(() => len_LE_UN_i_next_edge(arr, 0, 2))() != 1)
            return Fail;
        if (new Func<int>(() => len_LE_UN_i_next_edge(arr, 2, 3))() != 9999)
            return Fail;
        try
        {
        ...
        if (new Func<int>(() => i_GE_UN_len_next_edge(arr, 0, 2))() != 1)
            return Fail;
        if (new Func<int>(() => i_GE_UN_len_next_edge(arr, 2, 3))() != 9999)
            return Fail;
        try
        {
