...
public class BitOps : BitOpStruct
{
    ...
    */
    private static long DoBitfieldIteration(
        int[] bitarraybase,
        int[] bitoparraybase,
        int bitoparraysize,
        ref int nbitops
        ...
        for (i = 0; i < bitoparraysize; i++)
        {
            switch (i % 3)
            {
                ...
                case 1: /* Clear run of bits */
                    ToggleBitRun(bitarraybase, bitoparraybase[i + i], bitoparraybase[i + i + 1], 0);
                    break;

                case 2: /* Complement run of bits */
                    FlipBitRun(bitarraybase, bitoparraybase[i + i], bitoparraybase[i + i + 1]);
                    break;
            }
        }
    ...
    ** bit_addr in bitmap.
    */
    private static void ToggleBitRun(
        int[] bitmap, /* Bitmap */
    ...
    */
    private static void FlipBitRun(
        int[] bitmap, /* Bit map */
