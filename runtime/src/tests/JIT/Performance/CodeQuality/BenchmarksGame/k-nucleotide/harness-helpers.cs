    ...
    class TestHarnessHelpers
    {
        ...
        )
        {
            if (bigInput)
            {
                ...
                resourceName =
                    $"{Path.GetFileNameWithoutExtension(csFileName)}.knucleotide-input-big.txt";
            }
            else
            {
                ...
                resourceName =
                    $"{Path.GetFileNameWithoutExtension(csFileName)}.knucleotide-input.txt";
            }
