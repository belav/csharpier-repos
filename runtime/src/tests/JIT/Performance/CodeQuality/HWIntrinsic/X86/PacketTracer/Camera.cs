...
internal class Camera
{
    ...
    public static Camera Create(VectorPacket256 pos, VectorPacket256 lookAt)
    {
        ...
        VectorPacket256 down = new VectorPacket256(
        ...
        VectorPacket256 right =
            OnePointFive * VectorPacket256.CrossProduct(forward, down).Normalize();
        VectorPacket256 up =
            OnePointFive * VectorPacket256.CrossProduct(forward, right).Normalize();
