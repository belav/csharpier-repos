            ...
            for (kx = 2; kx <= 3; kx++)
            {
                for (ky = 2; ky <= 21; ky++)
                {
                    ...
                    _u1[kx, ky, nl2] =
                        ...
                        + sig
                            * (
                                _u1[kx + 1, ky, nl1] - 2.0 * _u1[kx, ky, nl1] + _u1[kx - 1, ky, nl1]
                            );
                    _u2[kx, ky, nl2] =
                        _u2[kx, ky, nl1]
                        + a21 * du1
                        ...
                        + sig
                            * (
                                _u2[kx + 1, ky, nl1] - 2.0 * _u2[kx, ky, nl1] + _u2[kx - 1, ky, nl1]
                            );
                    _u3[kx, ky, nl2] =
                        _u3[kx, ky, nl1]
                        + a31 * du1
                        ...
                        + sig
                            * (
                                _u3[kx + 1, ky, nl1] - 2.0 * _u3[kx, ky, nl1] + _u3[kx - 1, ky, nl1]
                            );
                }
            }
                ...
                for (kx = 2; kx <= 3; kx++)
                {
                    for (ky = 2; ky <= 21; ky++)
                    {
                        cksum[8] +=
                            ...
                            * (double)ky
                            * (double)i
                            * (_u1[kx, ky, i] + _u2[kx, ky, i] + _u3[kx, ky, i]);
                    }
                }
            }
