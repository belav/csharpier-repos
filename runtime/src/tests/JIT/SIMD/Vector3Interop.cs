...
class PInvokeTest
{
    ...
    public static bool test()
    {
        ...
        // Dot product makes sure that the backend assumption 1 and 2 are met.
        {
            ...
            Console.WriteLine(
                "    Managed Vector3 v1: ({0} {1} {2})",
                cdt.vecs.a.X,
                cdt.vecs.a.Y,
                cdt.vecs.a.Z
            );
            Console.WriteLine(
                "    Managed Vector3 v2: ({0} {1} {2})",
                cdt.vecs.b.X,
                cdt.vecs.b.Y,
                cdt.vecs.b.Z
            );
            Console.WriteLine(
                "    Managed Vector3 v3: ({0} {1} {2})",
                cdt.v3.X,
                cdt.v3.Y,
                cdt.v3.Z
            );
...
class RPInvokeTest
{
    ...
    public delegate void CallBackDelegate_RPInvoke_Vector3InStruct(DT v);

    public delegate void CallBackDelegate_RPInvoke_Vector3InComplexStruct(ref ComplexDT v);
    ...
    static void callBack_RPInvoke_Vector3InComplexStruct(ref ComplexDT arg)
    {
        ...
        Console.WriteLine(
            "    Arg Vector3 v1: ({0} {1} {2})",
            arg.vecs.a.X,
            arg.vecs.a.Y,
            arg.vecs.a.Z
        );
        Console.WriteLine(
            "    Arg Vector3 v2: ({0} {1} {2})",
            arg.vecs.b.X,
            arg.vecs.b.Y,
            arg.vecs.b.Z
        );
        ...
        Console.WriteLine(
            "    Return Vector3 v1: ({0} {1} {2})",
            arg.vecs.a.X,
            arg.vecs.a.Y,
            arg.vecs.a.Z
        );
        Console.WriteLine(
            "    Return Vector3 v2: ({0} {1} {2})",
            arg.vecs.b.X,
            arg.vecs.b.Y,
            arg.vecs.b.Z
        );
