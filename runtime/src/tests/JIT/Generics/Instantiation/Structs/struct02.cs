...
public class Test_struct02
{
    ...
    public static int Main()
    {
        ...
        Eval(
            (new Gen<int, double>(new int(), new double())).InstVerify(typeof(int), typeof(double))
        );
        Eval((new Gen<int, string>(new int(), "string")).InstVerify(typeof(int), typeof(string)));
        Eval(
            (new Gen<int, object>(new int(), new object())).InstVerify(typeof(int), typeof(object))
        );
        ...
        Eval(
            (
                new Gen<ValX1<string>, RefX1<ValX1<string>>>(
                    new ValX1<string>(),
        ...
        Eval(
            (
                new Gen<ValX1<string>, ValX1<ValX1<string>>>(
                    new ValX1<string>(),
