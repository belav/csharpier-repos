...
class mainMethod
{
    ...
    public static void checkGetType<T>(X<T> x)
    {
        ...
        if (x.GetType() == typeof(A))
            (new A()).incCount();
        if (x.GetType() == typeof(X<int>))
            (new X<int>()).incCount();
        if (x.GetType() == typeof(X<string>))
            (new X<string>()).incCount();
        if (x.GetType() == typeof(X<double>))
            (new X<double>()).incCount();
        if (x.GetType() == typeof(X<X<int>>))
            (new X<X<int>>()).incCount();
        if (x.GetType() == typeof(X<X<string>>))
            (new X<X<string>>()).incCount();
        if (x.GetType() == typeof(X<X<double>>))
            (new X<X<double>>()).incCount();
        if (x.GetType() == null)
            (new X<string>()).incCount();
    }
