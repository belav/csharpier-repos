...
class class_string
{
    public static void printName()
    {
        Console.WriteLine("class_string");
    }
}
...
class class_double
{
    public static void printName()
    {
        Console.WriteLine("class_double");
    }
}
...
public class mainMethod
{
    ...
    internal static void checkGetType<T>(X<T> x)
    {
        ...
        if (x.GetType() == typeof(A))
            (new A()).incCount();
        if (x.GetType() == typeof(X<class_int>))
            (new X<class_int>()).incCount();
        if (x.GetType() == typeof(X<class_string>))
            (new X<class_string>()).incCount();
        if (x.GetType() == typeof(X<class_double>))
            (new X<class_double>()).incCount();
        if (x.GetType() == typeof(X<X<class_int>>))
            (new X<X<class_int>>()).incCount();
        if (x.GetType() == typeof(X<X<class_string>>))
            (new X<X<class_string>>()).incCount();
        if (x.GetType() == typeof(X<X<class_double>>))
            (new X<X<class_double>>()).incCount();
        if (x.GetType() == null)
            (new X<class_string>()).incCount();
    }
    ...
    internal static void checkIs<T>(X<T> x)
    {
        ...
        if (x is X<X<class_double>>)
            (new X<X<class_double>>()).incCount();
        if (x is X<X<class_string>>)
            (new X<X<class_string>>()).incCount();
        if (x is X<X<class_int>>)
            (new X<X<class_int>>()).incCount();
        if (x is X<class_double>)
            (new X<class_double>()).incCount();
        if (x is X<class_string>)
            (new X<class_string>()).incCount();
        if (x is X<class_int>)
            (new X<class_int>()).incCount();
        if (x is A)
    ...
    public static void checkAllCounts(
        ref int x_actual,
        int ds,
        int cs,
        int d,
    ...
    public static void callCheckGetType()
    {
        ...
        checkAllCounts(
            ...
            1,
            11,
            "DS Count after GetType and typeof",
            "CS Count after GetType and typeof",
            "D Count after GetType and typeof",
            "C Count after GetType and typeof",
            "B Count after GetType and typeof",
            "A Count after GetType and typeof",
            "X Count after GetType and typeof"
        );
        Console.WriteLine("-----------{0}", i++);
        checkGetType(new X<X<class_string>>());
        checkAllCounts(
            ref X<X<class_string>>.x_count,
            1,
            1,
            1,
            1,
    ...
    public static void callCheckIs()
    {
        ...
        checkAllCounts(
            ...
            1,
            11,
            "DS Count after checking is",
            "CS Count after checking is",
            "D Count after checking is",
            "C Count after checking is",
            "B Count after checking is",
            "A Count after checking is",
            "X Count after checking is"
        );
        Console.WriteLine("-----------{0}", i++);
    ...
    public static void callCheckAs()
    {
        ...
        checkAllCounts(
            ...
            1,
            11,
            "DS Count after checking as",
            "CS Count after checking as",
            "D Count after checking as",
            "C Count after checking as",
            "B Count after checking as",
            "A Count after checking as",
            "X Count after checking as"
        );
        Console.WriteLine("-----------{0}", i++);
    ...
    public static void callCheckGetTypeStringCast()
    {
        ...
        checkAllCounts(
            ...
            1,
            3,
            "DS Count after GetType and typeof string cast",
            "CS Count after GetType and typeof string cast",
            "D Count after GetType and typeof string cast",
            "C Count after GetType and typeof string cast",
            "B Count after GetType and typeof string cast",
            "A Count after GetType and typeof string cast",
            "X Count after GetType and typeof string cast"
        );
        Console.WriteLine("-----------{0}", i++);
    ...
    public static void callCheckGetTypeIntCast()
    {
        ...
        checkAllCounts(
            ...
            1,
            2,
            "DS Count after GetType and typeof int cast",
            "CS Count after GetType and typeof int cast",
            "D Count after GetType and typeof int cast",
            "C Count after GetType and typeof int cast",
            "B Count after GetType and typeof int cast",
            "A Count after GetType and typeof int cast",
            "X Count after GetType and typeof int cast"
        );
        Console.WriteLine("-----------{0}", i++);
    ...
    public static void callCheckIsStringCast()
    {
        ...
        checkAllCounts(
            ...
            1,
            3,
            "DS Count after check is string cast ",
            "CS Count after check is string cast ",
            "D Count after check is string cast ",
            "C Count after check is string cast ",
            "B Count after check is string cast ",
            "A Count after check is string cast ",
            "X Count after check is string cast "
        );
        Console.WriteLine("-----------{0}", i++);
    ...
    public static void callCheckIsIntCast()
    {
        ...
        checkAllCounts(
            ...
            1,
            2,
            "DS Count after check is int cast",
            "CS Count after check is int cast",
            "D Count after check is int cast",
            "C Count after check is int cast",
            "B Count after check is int cast",
            "A Count after check is int cast",
            "X Count after check is int cast"
        );
        Console.WriteLine("-----------{0}", i++);
    ...
    public static void callCheckAsStringCast()
    {
        ...
        checkAllCounts(
            ...
            1,
            3,
            "DS Count after check as string cast ",
            "CS Count after check as string cast ",
            "D Count after check as string cast ",
            "C Count after check as string cast ",
            "B Count after check as string cast ",
            "A Count after check as string cast ",
            "X Count after check as string cast "
        );
        Console.WriteLine("-----------{0}", i++);
    ...
    public static void callCheckAsIntCast()
    {
        ...
        checkAllCounts(
            ...
            1,
            2,
            "DS Count after check as int cast",
            "CS Count after check as int cast",
            "D Count after check as int cast",
            "C Count after check as int cast",
            "B Count after check as int cast",
            "A Count after check as int cast",
            "X Count after check as int cast"
        );
        Console.WriteLine("-----------{0}", i++);
