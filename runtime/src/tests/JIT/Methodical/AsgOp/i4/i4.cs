    ...
    public class test
    {
        ...
        public static int TestEntryPoint()
        {
            ...
            if (x != -671088640)
            {
                Console.WriteLine("Initial parameters: x is -10 and y is 4.");
                Console.WriteLine(
                    "f60    x <<= x + y failed.    x: {0}, \texpected: -671088640\n",
                    x
                );
                pass = false;
            }
            ...
            if (x != -2621440)
            {
                Console.WriteLine("Initial parameters: x is -10 and y is 4.");
                Console.WriteLine(
                    "f61    x <<= x - y failed.    x: {0}, \texpected: -2621440\n",
                    x
                );
                pass = false;
            }
            ...
            if (x != -167772160)
            {
                Console.WriteLine("Initial parameters: x is -10 and y is 4.");
                Console.WriteLine(
                    "f62    x <<= x * y failed.    x: {0}, \texpected: -167772160\n",
                    x
                );
                pass = false;
            }
            ...
            if (x != -2147483648)
            {
                Console.WriteLine("Initial parameters: x is -10 and y is 4.");
                Console.WriteLine(
                    "f63    x <<= x / y failed.    x: {0}, \texpected: -2147483648\n",
                    x
                );
                pass = false;
            }
            ...
            if (x != -2147483648)
            {
                Console.WriteLine("Initial parameters: x is -10 and y is 4.");
                Console.WriteLine(
                    "f64    x <<= x % y failed.    x: {0}, \texpected: -2147483648\n",
                    x
                );
                pass = false;
            }
            ...
            if (x != -2621440)
            {
                Console.WriteLine("Initial parameters: x is -10 and y is 4.");
                Console.WriteLine(
                    "f68    x <<= x ^ y failed.    x: {0}, \texpected: -2621440\n",
                    x
                );
                pass = false;
            }
            ...
            if (x != -41943040)
            {
                Console.WriteLine("Initial parameters: x is -10 and y is 4.");
                Console.WriteLine(
                    "f69    x <<= x | y failed.    x: {0}, \texpected: -41943040\n",
                    x
                );
                pass = false;
            }
