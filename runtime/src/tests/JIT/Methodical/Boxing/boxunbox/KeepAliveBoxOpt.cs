...
public class KeepAliveBoxFieldsTest
{
    ...
    public static void TestLocalsOneBlock()
    {
        ...
        s1.StructWithRef.ObjectField = new Reporter(
            "s1.StructWithRef.ObjectField",
    ...
    public static void TestImplicitByrefsOneBlock()
    {
        ...
        s1.AnotherObjectField = new Reporter(
            "s1.AnotherObjectField",
            nameof(TestImplicitByrefsOneBlock)
        );
        s1.StructWithRef.ObjectField = new Reporter(
            "s1.StructWithRef.ObjectField",
            nameof(TestImplicitByrefsOneBlock)
        ...
        s3.AnotherObjectField = new Reporter(
            "s3.AnotherObjectField",
            nameof(TestImplicitByrefsOneBlock)
        );
        var s4 = new SingleObjectStruct();
    ...
    public static void TestExplicitByrefsOneBlock()
    {
        ...
        s1.AnotherObjectField = new Reporter(
            "s1.AnotherObjectField",
            nameof(TestExplicitByrefsOneBlock)
        );
        s1.StructWithRef.ObjectField = new Reporter(
            "s1.StructWithRef.ObjectField",
            nameof(TestExplicitByrefsOneBlock)
    ...
    public static void TestClassWrapperOneBlock()
    {
        ...
        c1.Field.ObjectField = new Reporter(
            "c1.Field.ObjectField",
            nameof(TestClassWrapperOneBlock)
        );
        c1.Field.AnotherObjectField = new Reporter(
            "c1.Field.AnotherObjectField",
            nameof(TestClassWrapperOneBlock)
        );
        c1.Field.StructWithRef.ObjectField = new Reporter(
            "c1.Field.StructWithRef.ObjectField",
            nameof(TestClassWrapperOneBlock)
        );
        var c2 = new Class<SimpleStructWithExplicitLayout>();
        c2.Field = new SimpleStructWithExplicitLayout();
        c2.Field.ObjectField = new Reporter(
            "c2.Field.ObjectField",
            nameof(TestClassWrapperOneBlock)
        );
        var c3 = new Class<SimpleStructWithAutoLayout>();
        c3.Field.ObjectField = new Reporter(
            "c3.Field.ObjectField",
            nameof(TestClassWrapperOneBlock)
        );
        c3.Field.AnotherObjectField = new Reporter(
            "c3.Field.AnotherObjectField",
            nameof(TestClassWrapperOneBlock)
        );
        var c4 = new Class<SingleObjectStruct>();
        c4.Field.ObjectField = new Reporter(
            "c4.Field.ObjectField",
            nameof(TestClassWrapperOneBlock)
        );
    ...
    public static void TestThrowCatchFinallyLocals()
    {
        ...
        try
        {
            ...
            s1.AnotherObjectField = new Reporter(
                "s1.AnotherObjectField",
                nameof(TestThrowCatchFinallyLocals)
            );
            s1.StructWithRef.ObjectField = new Reporter(
                "s1.StructWithRef.ObjectField",
                nameof(TestThrowCatchFinallyLocals)
            ...
            var s6src = new SingleObjectStruct();
            s6src.ObjectField = new Reporter(
                "s6src.ObjectField",
                nameof(TestThrowCatchFinallyLocals)
            );
            s6 = new SingleObjectStruct?(s6src);
