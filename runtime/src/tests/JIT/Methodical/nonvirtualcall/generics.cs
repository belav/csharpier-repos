    ...
    namespace Test
    {
        ...
        public class GrandChild : Child
        {
            ...
            public void TestGrandChild()
            {
                ...
                Assert.AreEqual("Child.AbstractFinal", AbstractFinal<object>());
                Assert.AreEqual(
                    "Child.AbstractOverrideFinal",
                    base.AbstractOverrideFinal<object>()
                );
                Assert.AreEqual(
                    "GrandChild.AbstractOverrideFinal",
                    AbstractOverrideFinal<object>()
                );
                Assert.AreEqual(
                    "Child.AbstractOverrideOverride",
        ...
        public static class Program
        {
            public static void CallSealedGrandChild()
            {
                ...
                Assert.AreEqual(
                    "GrandChild.AbstractOverrideFinal",
                    o.AbstractOverrideFinal<object>()
                );
                Assert.AreEqual(
                    "GrandChild.AbstractOverrideOverride",
