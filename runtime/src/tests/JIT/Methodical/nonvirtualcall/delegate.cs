    ...
    namespace Test
    {
        ...
        public static class Program
        {
            public static void CallDelegateFromSealedGrandChild()
            {
                ...
                Assert.AreEqual(
                    "GrandChild.VirtualNilFinal",
                    new TestMethod(child.VirtualNilFinal)
                );
                ...
                Assert.AreEqual(
                    "Child.VirtualOverrideNil",
                    new TestMethod(child.VirtualOverrideNil)
                );
                Assert.AreEqual(
