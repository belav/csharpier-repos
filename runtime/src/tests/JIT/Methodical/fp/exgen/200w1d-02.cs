            ...
            *a36_0 = 137438953472M;
                ...
                Convert.ToDecimal(
                    Convert.ToDecimal(
                        (
                            ...
                            * (
                                Convert.ToDecimal(
                                    (Convert.ToDecimal(s_a91_0) + Convert.ToDecimal(0M))
                                )
                                - Convert.ToDecimal(
                                    (
            ...
            asgop8 -= (
                Convert.ToDecimal(
                    Convert.ToDecimal(
                        (
                            Convert.ToDecimal(10.4980392156863M)
                            - Convert.ToDecimal(37.0933021099920M)
                        )
                    )
                )
            );
                ...
                (
                    Convert.ToInt32(
                        (
                            ...
                            % (
                                Convert.ToInt32(
                                    (Convert.ToInt32(s_arr2d_0[2, 10] * 1.2820505479201487))
                                )
                            )
                    )
                )
                        ...
                        - (
                            (
                                Convert.ToUInt64(
                                    Convert.ToUInt16(
                                        Convert.ToUInt16(
                                            vtstatic_0.a70_0 * Convert.ToSingle(4.777921F)
                                        )
                                    )
                                        + Convert.ToInt64(
                                            Convert.ToInt64(
