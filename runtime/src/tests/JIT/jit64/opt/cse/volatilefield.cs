    ...
    public class Test_Main
    {
        static int Main()
        {
            ...
            try
            {
                ...
                {
                    Console.WriteLine(
                        "test0: for (((s.a+s.b)+s.c)+s.d)  failed actual value {0} ",
                        v1
                    );
                    ret = ret + 1;
                }
                ...
                {
                    Console.WriteLine(
                        "test1: for (s.d+((s.a+s.b)+s.c))  failed actual value {0} ",
                        v2
                    );
                    ret = ret + 1;
                }
                ...
                {
                    Console.WriteLine(
                        "test14: for ((s.a+s.b)+(s.c+s.d))  failed actual value {0} ",
                        v15
                    );
                    ret = ret + 1;
                }
                ...
                {
                    Console.WriteLine(
                        "test15: for (s.c+((s.a+s.b)+s.d))  failed actual value {0} ",
                        v16
                    );
                    ret = ret + 1;
                }
                ...
                {
                    Console.WriteLine(
                        "test22: for (((s.a+s.b)+s.c)+s.d)  failed actual value {0} ",
                        v23
                    );
                    ret = ret + 1;
                }
                ...
                {
                    Console.WriteLine(
                        "test23: for (s.d+((s.a+s.b)+s.c))  failed actual value {0} ",
                        v24
                    );
                    ret = ret + 1;
                }
