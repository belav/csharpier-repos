...
public class StrAccess1
{
    ...
    public static int TestEntryPoint()
    {
        ...
        if (
            ...
            || (str1[4] != cl1.str[4])
            || (cl1.str[4] != vt1.str[4])
            || (vt1.str[4] != str1darr[1][4])
            || (str1darr[1][4] != str2darr[0, 0][4])
            || (str2darr[0, 0][4] != f(ref str2)[4])
        )
            passed = false;
        b0 = str2[10];
        b1 = str1[10];
        ...
        if (
            ...
            || (str1[5] != cl1.str[5])
            || (cl1.str[5] != vt1.str[5])
            || (vt1.str[5] != str1darr[1][5])
            || (str1darr[1][5] != str2darr[0, 0][5])
            || (str2darr[0, 0][5] != f(ref str2)[5])
        )
            passed = false;
        sb0 = str2[9];
        sb1 = str1[9];
        ...
        if (
            ...
            || (str1[6] != cl1.str[6])
            || (cl1.str[6] != vt1.str[6])
            || (vt1.str[6] != str1darr[1][6])
            || (str1darr[1][6] != str2darr[0, 0][6])
            || (str2darr[0, 0][6] != f(ref str2)[6])
        )
            passed = false;
        vt1.b0 = str2[8];
        vt1.b1 = str1[8];
        ...
        if (
            ...
            || (str1[0] != cl1.str[0])
            || (cl1.str[0] != vt1.str[0])
            || (vt1.str[0] != str1darr[1][0])
            || (str1darr[1][0] != str2darr[0, 0][0])
            || (str2darr[0, 0][0] != f(ref str2)[0])
        )
            passed = false;
        cl1.b0 = str2[4];
        cl1.b1 = str1[4];
        ...
        if (
            (c2darr[1, 0] != c2darr[1, 1])
            || (c2darr[1, 1] != c2darr[1, 2])
            || (c2darr[1, 2] != c2darr[1, 3])
            || (c2darr[1, 3] != c2darr[1, 4])
            || (c2darr[1, 4] != c2darr[1, 5])
            || (c2darr[1, 5] != c2darr[1, 6])
        )
            passed = false;
        if (
            (str2[0] != str1[0])
