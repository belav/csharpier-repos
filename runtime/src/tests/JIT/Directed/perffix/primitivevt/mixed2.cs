...
internal unsafe class testout1
{
    ...
    public static float Func_0_1_1_1_1_1_1_1_1_1()
    {
        ...
        *a3_0_1_1_1_1_1_1_1_1_1 = 3.7252902984619141E-09;
        ...
        {
            float if0_0retval_0_1_1_1_1_1_1_1_1_1 = Convert.ToSingle(
                Convert.ToSingle(
                    (
                        Convert.ToInt32(
                            (Convert.ToInt32(1218424101 * 0.37129554777249107))
                                * ((*a1_0_1_1_1_1_1_1_1_1_1))
                        )
                    ) * (asgop0 + (*a3_0_1_1_1_1_1_1_1_1_1))
                )
            );
    ...
    public static double Func_0_1_1_1_1_1_1_1_1()
    {
        ...
        double retval_0_1_1_1_1_1_1_1_1 = Convert.ToDouble(
            (
                Convert.ToUInt16(val_0_1_1_1_1_1_1_1_1_1 + s_arr2d_0_1_1_1_1_1_1_1_1[2, 0])
                / (29637 * (4.6566128730773926E-10 + a2_0_1_1_1_1_1_1_1_1))
            )
        );
    ...
    public static ushort Func_0_1_1_1_1_1_1_1()
    {
        ...
        {
            ushort if0_0retval_0_1_1_1_1_1_1_1 = Convert.ToUInt16(
                (
                    Convert.ToUInt16(
                        Convert.ToInt32(
                            Convert.ToUInt64(10247887076011802624UL)
                                - Convert.ToUInt64(arr1d_0_1_1_1_1_1_1_1[0])
                        ) / val_0_1_1_1_1_1_1_1_1
                    )
                )
            );
            return if0_0retval_0_1_1_1_1_1_1_1;
        }
        ushort retval_0_1_1_1_1_1_1_1 = Convert.ToUInt16(
            (
                Convert.ToUInt16(
                    Convert.ToInt32(
                        Convert.ToUInt64(10247887076011802624UL)
    ...
    public static long Func_0_1_1_1_1_1_1()
    {
        ...
        *a2_0_1_1_1_1_1_1 = 4375;
        ...
        if (
            (s_arr2d_0_1_1_1_1_1_1[2, 0])
            > (
                Convert.ToInt64(
                    Convert.ToInt16(((*a2_0_1_1_1_1_1_1)))
                        + Convert.ToInt64(s_arr2d_0_1_1_1_1_1_1[2, 0])
                )
            )
        )
            Console.WriteLine("Func_0_1_1_1_1_1_1: > true");
        long retval_0_1_1_1_1_1_1 = Convert.ToInt64(
            Convert.ToInt64(
                Convert.ToUInt16(val_0_1_1_1_1_1_1_1)
                    + Convert.ToInt64(
                        Convert.ToInt64(
                            Convert.ToInt16(((*a2_0_1_1_1_1_1_1)))
                                + Convert.ToInt64(s_arr2d_0_1_1_1_1_1_1[2, 0])
    ...
    public static long Func_0_1_1_1_1_1()
    {
        ...
        asgop0 %= (
            Convert.ToInt32(
                (
                    Convert.ToInt32(
                        (Convert.ToInt32(((Convert.ToInt32(64462) + 1977507624) - 1268894055)))
                    )
                )
            )
        );
        if ((arr1d_0_1_1_1_1_1[0]) <= 10)
        {
            if ((arr1d_0_1_1_1_1_1[0]) == 10)
            {
                long if1_0retval_0_1_1_1_1_1 = Convert.ToInt64(
                    Convert.ToInt64(
                        Convert.ToUInt32(
                            Convert.ToUInt32(asgop0 / Convert.ToSingle(arr1d_0_1_1_1_1_1[0]))
                        )
                            - Convert.ToInt64(
                                Convert.ToInt64(
                                    Convert.ToInt32(s_arr2d_0_1_1_1_1_1[2, 2])
                                        + Convert.ToInt64(val_0_1_1_1_1_1_1)
                                )
                            )
                    )
                );
        ...
        {
            long else0_0retval_0_1_1_1_1_1 = Convert.ToInt64(
                Convert.ToInt64(
                    Convert.ToUInt32(
                        Convert.ToUInt32(asgop0 / Convert.ToSingle(arr1d_0_1_1_1_1_1[0]))
                    )
        ...
        long retval_0_1_1_1_1_1 = Convert.ToInt64(
            Convert.ToInt64(
                Convert.ToUInt32(Convert.ToUInt32(asgop0 / Convert.ToSingle(arr1d_0_1_1_1_1_1[0])))
                    - Convert.ToInt64(
                        Convert.ToInt64(
                            Convert.ToInt32(s_arr2d_0_1_1_1_1_1[2, 2])
                                + Convert.ToInt64(val_0_1_1_1_1_1_1)
            ...
            return Convert.ToInt64(
                (
                    Convert.ToInt64(
                        (
                            Convert.ToInt64(
                                Convert.ToDouble(8828430758690422784L) * ((*a2_0_1_1_1_1))
                            ) - val_0_1_1_1_1_1
                        )
                            / (
                                Convert.ToInt64(
                                    (
                                        Convert.ToInt64(vt_0_1_1_1_1.a1_0_1_1_1_1)
                                        + s_arr3d_0_1_1_1_1[4, 0, 3]
                                    )
                                        / (
                                            Convert.ToInt64(
                                                Convert.ToInt64(
                                                    Convert.ToDouble(s_arr3d_0_1_1_1_1[4, 0, 3])
                                                        * -8.3365516869005671E-10
                                                )
                                            )
                                            * Convert.ToInt64(
                                                (
    ...
    public static short Func_0_1_1_1()
    {
        ...
        return Convert.ToInt16(
            (Convert.ToInt16((val_0_1_1_1_1 / asgop0) - ((Convert.ToDouble(8192UL * asgop1)))))
        );
    }
                    ...
                    Convert.ToUInt16(
                        Convert.ToInt16((Convert.ToInt16(val_0_1_1_1)) % (Convert.ToInt16(15783)))
                            * Convert.ToSingle(
                                Convert.ToSingle(
                                    Convert.ToUInt32(
                                        vtstatic_0_1_1.arr1d_0_1_1[1] * arr3d_0_1_1[4, 2, 3]
                                    ) * arr3d_0_1_1[4, 0, 3]
                                )
                            )
                    )
            ...
            else
            {
                ...
                else
                {
                    return Convert.ToUInt16(
                        Convert.ToUInt16(
                            Convert.ToInt16(
                                (Convert.ToInt16(val_0_1_1_1)) % (Convert.ToInt16(15783))
                            )
                                * Convert.ToSingle(
                                    Convert.ToSingle(
                                        Convert.ToUInt32(
        ...
        return Convert.ToUInt16(
            Convert.ToUInt16(
                Convert.ToInt16((Convert.ToInt16(val_0_1_1_1)) % (Convert.ToInt16(15783)))
                    * Convert.ToSingle(
                        Convert.ToSingle(
                            Convert.ToUInt32(vtstatic_0_1_1.arr1d_0_1_1[1] * arr3d_0_1_1[4, 2, 3])
                                * arr3d_0_1_1[4, 0, 3]
                        )
                    )
            )
    ...
    public static int Func_0_1()
    {
        ...
        asgop0 += (
            (
                Convert.ToInt32(
                    Convert.ToInt64(3029300219813560320L) - Convert.ToInt64(arr2d_0_1[2, 0])
                )
            )
        );
        return Convert.ToInt32(
            (
                Convert.ToInt32(
                    (Convert.ToInt32((Convert.ToInt32(val_0_1_1) + cl_0_1.a2_0_1)))
                        % (Convert.ToInt32(asgop0))
                )
            )
        );
    }
    ...
    public static int Func_0()
    {
        ...
        int retval_0 = Convert.ToInt32(
            Convert.ToInt32(
                Convert.ToDecimal((Convert.ToInt32(val_0_1 * (s_a2_0 / 41477.078575715459))))
                    / (
                        Convert.ToDecimal(
                            Convert.ToInt64(Convert.ToDouble(s_a1_0) * 0.00390625)
                                * (Convert.ToDecimal(s_a2_0) * s_arr3d_0[4, 0, 3])
                        )
                    )
            )
        );
