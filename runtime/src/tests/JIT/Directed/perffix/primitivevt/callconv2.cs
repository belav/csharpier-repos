...
namespace PrimitiveVT
{
    public unsafe class CallConv2
    {
        ...
        private static uint f1(VT2B x, VT2B y)
        {
            return x.m + y.m;
        }

        private VT2B f2a(VT2A x, VT2B y)
        {
            VT2B z;
            z.m = x.m + y.m;
            return z;
        ...
        private VT2B f2b(VT2A x, VT2B y)
        {
            return f2a(x, y);
        }

        private VT2B f2(VT2A x, VT2B y)
        {
            return f2b(x, y);
        }

        private static uint f3(ref VT2B x, VT2B y)
        {
            return x.m - y.m;
        }

        private VT2B f4(VT2A x, VT2B y)
        {
            VT2B z;
            z.m = x.m - y.m;
            return z;
        ...
        private static uint f5(VT2B x, VT2A y)
        {
            return x.m * y.m;
        }

        private uint f6(VT2B[] x, VT2B y)
        {
            return x[0].m * y.m;
        }

        private VT2B f7(VT2A x, VT2B y)
        {
            return f4(x, y);
        }

        private float f8(VT2A x, VT2B y)
        {
            return x.m / y.m;
        }

        private static VT2B[,] f9a()
        {
            return new VT2B[1, 2];
        }

        private static VT2B[,] f9()
        {
            return f9a();
        }

        private uint f10(params VT2B[] args)
        {
            uint sum = 0;
        ...
        public static int TestEntryPoint()
        {
            ...
            VT2B u =
                ...
                + (VT2B)f
                + y * s_x
                + (uint)(s_x / (d % 2 == 0 ? (VT2B)(d / 2) : (VT2B)(d + 1 / 2)));
            uint w =
                f5((VT2B)s_x, (VT2A)y)
                + t.f6(yarr, (VT2B)s_x)
                + f1(y, d)
