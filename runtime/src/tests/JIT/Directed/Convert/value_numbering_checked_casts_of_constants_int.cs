...
public partial class ValueNumberingCheckedCastsOfConstants
{
    private static void TestCastingInt32ToSingle()
    {
        ...
        static void ConfirmIntegerZeroCastToSingleIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(float)0' was evaluted to '{(float)integerZero}'. Expected: '0f'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSByteMinValueCastToSingleIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(float)-128' was evaluted to '{(float)sByteMinValue}'. Expected: '-128f'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSByteMaxValueCastToSingleIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(float)127' was evaluted to '{(float)sByteMaxValue}'. Expected: '127f'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderSByteMinValueCastToSingleIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(float)-129' was evaluted to '{(float)integerOneDecrementUnderSByteMinValue}'. Expected: '-129f'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveSByteMinValueCastToSingleIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(float)-127' was evaluted to '{(float)integerOneIncrementAboveSByteMinValue}'. Expected: '-127f'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderSByteMaxValueCastToSingleIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(float)126' was evaluted to '{(float)integerOneDecrementUnderSByteMaxValue}'. Expected: '126f'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveSByteMaxValueCastToSingleIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(float)128' was evaluted to '{(float)integerOneIncrementAboveSByteMaxValue}'. Expected: '128f'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmByteMaxValueCastToSingleIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(float)255' was evaluted to '{(float)byteMaxValue}'. Expected: '255f'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderByteMinValueCastToSingleIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(float)-1' was evaluted to '{(float)integerOneDecrementUnderByteMinValue}'. Expected: '-1f'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveByteMinValueCastToSingleIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(float)1' was evaluted to '{(float)integerOneIncrementAboveByteMinValue}'. Expected: '1f'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderByteMaxValueCastToSingleIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(float)254' was evaluted to '{(float)integerOneDecrementUnderByteMaxValue}'. Expected: '254f'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveByteMaxValueCastToSingleIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(float)256' was evaluted to '{(float)integerOneIncrementAboveByteMaxValue}'. Expected: '256f'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmInt16MinValueCastToSingleIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(float)-32768' was evaluted to '{(float)int16MinValue}'. Expected: '-32768f'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmInt16MaxValueCastToSingleIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(float)32767' was evaluted to '{(float)int16MaxValue}'. Expected: '32767f'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderInt16MinValueCastToSingleIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(float)-32769' was evaluted to '{(float)integerOneDecrementUnderInt16MinValue}'. Expected: '-32769f'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveInt16MinValueCastToSingleIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(float)-32767' was evaluted to '{(float)integerOneIncrementAboveInt16MinValue}'. Expected: '-32767f'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderInt16MaxValueCastToSingleIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(float)32766' was evaluted to '{(float)integerOneDecrementUnderInt16MaxValue}'. Expected: '32766f'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveInt16MaxValueCastToSingleIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(float)32768' was evaluted to '{(float)integerOneIncrementAboveInt16MaxValue}'. Expected: '32768f'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmUInt16MaxValueCastToSingleIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(float)65535' was evaluted to '{(float)uInt16MaxValue}'. Expected: '65535f'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderUInt16MaxValueCastToSingleIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(float)65534' was evaluted to '{(float)integerOneDecrementUnderUInt16MaxValue}'. Expected: '65534f'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveUInt16MaxValueCastToSingleIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(float)65536' was evaluted to '{(float)integerOneIncrementAboveUInt16MaxValue}'. Expected: '65536f'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmInt32MinValueCastToSingleIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(float)-2147483648' was evaluted to '{(float)int32MinValue}'. Expected: '-2.1474836E+09f'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmInt32MaxValueCastToSingleIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(float)2147483647' was evaluted to '{(float)int32MaxValue}'. Expected: '2.1474836E+09f'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveInt32MinValueCastToSingleIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(float)-2147483647' was evaluted to '{(float)integerOneIncrementAboveInt32MinValue}'. Expected: '-2.1474836E+09f'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderInt32MaxValueCastToSingleIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(float)2147483646' was evaluted to '{(float)integerOneDecrementUnderInt32MaxValue}'. Expected: '2.1474836E+09f'."
                );
                _counter++;
            }
        }
    ...
    private static void TestCastingInt32ToDouble()
    {
        ...
        static void ConfirmIntegerZeroCastToDoubleIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(double)0' was evaluted to '{(double)integerZero}'. Expected: '0d'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSByteMinValueCastToDoubleIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(double)-128' was evaluted to '{(double)sByteMinValue}'. Expected: '-128d'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSByteMaxValueCastToDoubleIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(double)127' was evaluted to '{(double)sByteMaxValue}'. Expected: '127d'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderSByteMinValueCastToDoubleIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(double)-129' was evaluted to '{(double)integerOneDecrementUnderSByteMinValue}'. Expected: '-129d'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveSByteMinValueCastToDoubleIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(double)-127' was evaluted to '{(double)integerOneIncrementAboveSByteMinValue}'. Expected: '-127d'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderSByteMaxValueCastToDoubleIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(double)126' was evaluted to '{(double)integerOneDecrementUnderSByteMaxValue}'. Expected: '126d'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveSByteMaxValueCastToDoubleIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(double)128' was evaluted to '{(double)integerOneIncrementAboveSByteMaxValue}'. Expected: '128d'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmByteMaxValueCastToDoubleIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(double)255' was evaluted to '{(double)byteMaxValue}'. Expected: '255d'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderByteMinValueCastToDoubleIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(double)-1' was evaluted to '{(double)integerOneDecrementUnderByteMinValue}'. Expected: '-1d'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveByteMinValueCastToDoubleIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(double)1' was evaluted to '{(double)integerOneIncrementAboveByteMinValue}'. Expected: '1d'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderByteMaxValueCastToDoubleIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(double)254' was evaluted to '{(double)integerOneDecrementUnderByteMaxValue}'. Expected: '254d'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveByteMaxValueCastToDoubleIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(double)256' was evaluted to '{(double)integerOneIncrementAboveByteMaxValue}'. Expected: '256d'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmInt16MinValueCastToDoubleIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(double)-32768' was evaluted to '{(double)int16MinValue}'. Expected: '-32768d'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmInt16MaxValueCastToDoubleIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(double)32767' was evaluted to '{(double)int16MaxValue}'. Expected: '32767d'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderInt16MinValueCastToDoubleIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(double)-32769' was evaluted to '{(double)integerOneDecrementUnderInt16MinValue}'. Expected: '-32769d'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveInt16MinValueCastToDoubleIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(double)-32767' was evaluted to '{(double)integerOneIncrementAboveInt16MinValue}'. Expected: '-32767d'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderInt16MaxValueCastToDoubleIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(double)32766' was evaluted to '{(double)integerOneDecrementUnderInt16MaxValue}'. Expected: '32766d'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveInt16MaxValueCastToDoubleIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(double)32768' was evaluted to '{(double)integerOneIncrementAboveInt16MaxValue}'. Expected: '32768d'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmUInt16MaxValueCastToDoubleIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(double)65535' was evaluted to '{(double)uInt16MaxValue}'. Expected: '65535d'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderUInt16MaxValueCastToDoubleIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(double)65534' was evaluted to '{(double)integerOneDecrementUnderUInt16MaxValue}'. Expected: '65534d'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveUInt16MaxValueCastToDoubleIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(double)65536' was evaluted to '{(double)integerOneIncrementAboveUInt16MaxValue}'. Expected: '65536d'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmInt32MinValueCastToDoubleIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(double)-2147483648' was evaluted to '{(double)int32MinValue}'. Expected: '-2147483648d'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmInt32MaxValueCastToDoubleIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(double)2147483647' was evaluted to '{(double)int32MaxValue}'. Expected: '2147483647d'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveInt32MinValueCastToDoubleIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(double)-2147483647' was evaluted to '{(double)integerOneIncrementAboveInt32MinValue}'. Expected: '-2147483647d'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderInt32MaxValueCastToDoubleIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(double)2147483646' was evaluted to '{(double)integerOneDecrementUnderInt32MaxValue}'. Expected: '2147483646d'."
                );
                _counter++;
            }
        }
    ...
    private static void TestCastingInt32ToSByte()
    {
        ...
        static void ConfirmIntegerZeroCastToSByteIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(sbyte)0' was evaluted to '{(sbyte)integerZero}'. Expected: '0'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSByteMinValueCastToSByteIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(sbyte)-128' was evaluted to '{(sbyte)sByteMinValue}'. Expected: '-128'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSByteMaxValueCastToSByteIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(sbyte)127' was evaluted to '{(sbyte)sByteMaxValue}'. Expected: '127'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveSByteMinValueCastToSByteIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(sbyte)-127' was evaluted to '{(sbyte)integerOneIncrementAboveSByteMinValue}'. Expected: '-127'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderSByteMaxValueCastToSByteIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(sbyte)126' was evaluted to '{(sbyte)integerOneDecrementUnderSByteMaxValue}'. Expected: '126'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderByteMinValueCastToSByteIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(sbyte)-1' was evaluted to '{(sbyte)integerOneDecrementUnderByteMinValue}'. Expected: '-1'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveByteMinValueCastToSByteIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(sbyte)1' was evaluted to '{(sbyte)integerOneIncrementAboveByteMinValue}'. Expected: '1'."
                );
                _counter++;
            }
        }
    ...
    private static void TestCastingInt32ToByte()
    {
        ...
        static void ConfirmIntegerZeroCastToByteIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(byte)0' was evaluted to '{(byte)integerZero}'. Expected: '0'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSByteMaxValueCastToByteIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(byte)127' was evaluted to '{(byte)sByteMaxValue}'. Expected: '127'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderSByteMaxValueCastToByteIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(byte)126' was evaluted to '{(byte)integerOneDecrementUnderSByteMaxValue}'. Expected: '126'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveSByteMaxValueCastToByteIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(byte)128' was evaluted to '{(byte)integerOneIncrementAboveSByteMaxValue}'. Expected: '128'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmByteMaxValueCastToByteIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(byte)255' was evaluted to '{(byte)byteMaxValue}'. Expected: '255'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveByteMinValueCastToByteIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(byte)1' was evaluted to '{(byte)integerOneIncrementAboveByteMinValue}'. Expected: '1'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderByteMaxValueCastToByteIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(byte)254' was evaluted to '{(byte)integerOneDecrementUnderByteMaxValue}'. Expected: '254'."
                );
                _counter++;
            }
        }
    ...
    private static void TestCastingInt32ToInt16()
    {
        ...
        static void ConfirmIntegerZeroCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)0' was evaluted to '{(short)integerZero}'. Expected: '0'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSByteMinValueCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)-128' was evaluted to '{(short)sByteMinValue}'. Expected: '-128'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSByteMaxValueCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)127' was evaluted to '{(short)sByteMaxValue}'. Expected: '127'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderSByteMinValueCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)-129' was evaluted to '{(short)integerOneDecrementUnderSByteMinValue}'. Expected: '-129'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveSByteMinValueCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)-127' was evaluted to '{(short)integerOneIncrementAboveSByteMinValue}'. Expected: '-127'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderSByteMaxValueCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)126' was evaluted to '{(short)integerOneDecrementUnderSByteMaxValue}'. Expected: '126'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveSByteMaxValueCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)128' was evaluted to '{(short)integerOneIncrementAboveSByteMaxValue}'. Expected: '128'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmByteMaxValueCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)255' was evaluted to '{(short)byteMaxValue}'. Expected: '255'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderByteMinValueCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)-1' was evaluted to '{(short)integerOneDecrementUnderByteMinValue}'. Expected: '-1'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveByteMinValueCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)1' was evaluted to '{(short)integerOneIncrementAboveByteMinValue}'. Expected: '1'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderByteMaxValueCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)254' was evaluted to '{(short)integerOneDecrementUnderByteMaxValue}'. Expected: '254'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveByteMaxValueCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)256' was evaluted to '{(short)integerOneIncrementAboveByteMaxValue}'. Expected: '256'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmInt16MinValueCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)-32768' was evaluted to '{(short)int16MinValue}'. Expected: '-32768'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmInt16MaxValueCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)32767' was evaluted to '{(short)int16MaxValue}'. Expected: '32767'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveInt16MinValueCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)-32767' was evaluted to '{(short)integerOneIncrementAboveInt16MinValue}'. Expected: '-32767'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderInt16MaxValueCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)32766' was evaluted to '{(short)integerOneDecrementUnderInt16MaxValue}'. Expected: '32766'."
                );
                _counter++;
            }
        }
    ...
    private static void TestCastingInt32ToUInt16()
    {
        ...
        static void ConfirmIntegerZeroCastToUInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ushort)0' was evaluted to '{(ushort)integerZero}'. Expected: '0'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSByteMaxValueCastToUInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ushort)127' was evaluted to '{(ushort)sByteMaxValue}'. Expected: '127'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderSByteMaxValueCastToUInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ushort)126' was evaluted to '{(ushort)integerOneDecrementUnderSByteMaxValue}'. Expected: '126'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveSByteMaxValueCastToUInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ushort)128' was evaluted to '{(ushort)integerOneIncrementAboveSByteMaxValue}'. Expected: '128'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmByteMaxValueCastToUInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ushort)255' was evaluted to '{(ushort)byteMaxValue}'. Expected: '255'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveByteMinValueCastToUInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ushort)1' was evaluted to '{(ushort)integerOneIncrementAboveByteMinValue}'. Expected: '1'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderByteMaxValueCastToUInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ushort)254' was evaluted to '{(ushort)integerOneDecrementUnderByteMaxValue}'. Expected: '254'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveByteMaxValueCastToUInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ushort)256' was evaluted to '{(ushort)integerOneIncrementAboveByteMaxValue}'. Expected: '256'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmInt16MaxValueCastToUInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ushort)32767' was evaluted to '{(ushort)int16MaxValue}'. Expected: '32767'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderInt16MaxValueCastToUInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ushort)32766' was evaluted to '{(ushort)integerOneDecrementUnderInt16MaxValue}'. Expected: '32766'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveInt16MaxValueCastToUInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ushort)32768' was evaluted to '{(ushort)integerOneIncrementAboveInt16MaxValue}'. Expected: '32768'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmUInt16MaxValueCastToUInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ushort)65535' was evaluted to '{(ushort)uInt16MaxValue}'. Expected: '65535'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderUInt16MaxValueCastToUInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ushort)65534' was evaluted to '{(ushort)integerOneDecrementUnderUInt16MaxValue}'. Expected: '65534'."
                );
                _counter++;
            }
        }
    ...
    private static void TestCastingInt32ToInt32()
    {
        ...
        static void ConfirmSByteMinValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)-128' was evaluted to '{(int)sByteMinValue}'. Expected: '-128'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSByteMaxValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)127' was evaluted to '{(int)sByteMaxValue}'. Expected: '127'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderSByteMinValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)-129' was evaluted to '{(int)integerOneDecrementUnderSByteMinValue}'. Expected: '-129'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveSByteMinValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)-127' was evaluted to '{(int)integerOneIncrementAboveSByteMinValue}'. Expected: '-127'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderSByteMaxValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)126' was evaluted to '{(int)integerOneDecrementUnderSByteMaxValue}'. Expected: '126'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveSByteMaxValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)128' was evaluted to '{(int)integerOneIncrementAboveSByteMaxValue}'. Expected: '128'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmByteMaxValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)255' was evaluted to '{(int)byteMaxValue}'. Expected: '255'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderByteMinValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)-1' was evaluted to '{(int)integerOneDecrementUnderByteMinValue}'. Expected: '-1'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveByteMinValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)1' was evaluted to '{(int)integerOneIncrementAboveByteMinValue}'. Expected: '1'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderByteMaxValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)254' was evaluted to '{(int)integerOneDecrementUnderByteMaxValue}'. Expected: '254'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveByteMaxValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)256' was evaluted to '{(int)integerOneIncrementAboveByteMaxValue}'. Expected: '256'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmInt16MinValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)-32768' was evaluted to '{(int)int16MinValue}'. Expected: '-32768'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmInt16MaxValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)32767' was evaluted to '{(int)int16MaxValue}'. Expected: '32767'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderInt16MinValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)-32769' was evaluted to '{(int)integerOneDecrementUnderInt16MinValue}'. Expected: '-32769'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveInt16MinValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)-32767' was evaluted to '{(int)integerOneIncrementAboveInt16MinValue}'. Expected: '-32767'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderInt16MaxValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)32766' was evaluted to '{(int)integerOneDecrementUnderInt16MaxValue}'. Expected: '32766'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveInt16MaxValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)32768' was evaluted to '{(int)integerOneIncrementAboveInt16MaxValue}'. Expected: '32768'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmUInt16MaxValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)65535' was evaluted to '{(int)uInt16MaxValue}'. Expected: '65535'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderUInt16MaxValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)65534' was evaluted to '{(int)integerOneDecrementUnderUInt16MaxValue}'. Expected: '65534'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveUInt16MaxValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)65536' was evaluted to '{(int)integerOneIncrementAboveUInt16MaxValue}'. Expected: '65536'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmInt32MinValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)-2147483648' was evaluted to '{(int)int32MinValue}'. Expected: '-2147483648'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmInt32MaxValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)2147483647' was evaluted to '{(int)int32MaxValue}'. Expected: '2147483647'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveInt32MinValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)-2147483647' was evaluted to '{(int)integerOneIncrementAboveInt32MinValue}'. Expected: '-2147483647'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderInt32MaxValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)2147483646' was evaluted to '{(int)integerOneDecrementUnderInt32MaxValue}'. Expected: '2147483646'."
                );
                _counter++;
            }
        }
    ...
    private static void TestCastingInt32ToUInt32()
    {
        ...
        static void ConfirmIntegerZeroCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)0' was evaluted to '{(uint)integerZero}'. Expected: '0'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSByteMaxValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)127' was evaluted to '{(uint)sByteMaxValue}'. Expected: '127'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderSByteMaxValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)126' was evaluted to '{(uint)integerOneDecrementUnderSByteMaxValue}'. Expected: '126'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveSByteMaxValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)128' was evaluted to '{(uint)integerOneIncrementAboveSByteMaxValue}'. Expected: '128'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmByteMaxValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)255' was evaluted to '{(uint)byteMaxValue}'. Expected: '255'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveByteMinValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)1' was evaluted to '{(uint)integerOneIncrementAboveByteMinValue}'. Expected: '1'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderByteMaxValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)254' was evaluted to '{(uint)integerOneDecrementUnderByteMaxValue}'. Expected: '254'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveByteMaxValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)256' was evaluted to '{(uint)integerOneIncrementAboveByteMaxValue}'. Expected: '256'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmInt16MaxValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)32767' was evaluted to '{(uint)int16MaxValue}'. Expected: '32767'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderInt16MaxValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)32766' was evaluted to '{(uint)integerOneDecrementUnderInt16MaxValue}'. Expected: '32766'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveInt16MaxValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)32768' was evaluted to '{(uint)integerOneIncrementAboveInt16MaxValue}'. Expected: '32768'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmUInt16MaxValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)65535' was evaluted to '{(uint)uInt16MaxValue}'. Expected: '65535'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderUInt16MaxValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)65534' was evaluted to '{(uint)integerOneDecrementUnderUInt16MaxValue}'. Expected: '65534'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveUInt16MaxValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)65536' was evaluted to '{(uint)integerOneIncrementAboveUInt16MaxValue}'. Expected: '65536'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmInt32MaxValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)2147483647' was evaluted to '{(uint)int32MaxValue}'. Expected: '2147483647'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderInt32MaxValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)2147483646' was evaluted to '{(uint)integerOneDecrementUnderInt32MaxValue}'. Expected: '2147483646'."
                );
                _counter++;
            }
        }
    ...
    private static void TestCastingInt32ToInt64()
    {
        ...
        static void ConfirmIntegerZeroCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)0' was evaluted to '{(long)integerZero}'. Expected: '0'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSByteMinValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)-128' was evaluted to '{(long)sByteMinValue}'. Expected: '-128'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSByteMaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)127' was evaluted to '{(long)sByteMaxValue}'. Expected: '127'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderSByteMinValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)-129' was evaluted to '{(long)integerOneDecrementUnderSByteMinValue}'. Expected: '-129'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveSByteMinValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)-127' was evaluted to '{(long)integerOneIncrementAboveSByteMinValue}'. Expected: '-127'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderSByteMaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)126' was evaluted to '{(long)integerOneDecrementUnderSByteMaxValue}'. Expected: '126'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveSByteMaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)128' was evaluted to '{(long)integerOneIncrementAboveSByteMaxValue}'. Expected: '128'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmByteMaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)255' was evaluted to '{(long)byteMaxValue}'. Expected: '255'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderByteMinValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)-1' was evaluted to '{(long)integerOneDecrementUnderByteMinValue}'. Expected: '-1'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveByteMinValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)1' was evaluted to '{(long)integerOneIncrementAboveByteMinValue}'. Expected: '1'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderByteMaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)254' was evaluted to '{(long)integerOneDecrementUnderByteMaxValue}'. Expected: '254'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveByteMaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)256' was evaluted to '{(long)integerOneIncrementAboveByteMaxValue}'. Expected: '256'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmInt16MinValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)-32768' was evaluted to '{(long)int16MinValue}'. Expected: '-32768'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmInt16MaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)32767' was evaluted to '{(long)int16MaxValue}'. Expected: '32767'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderInt16MinValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)-32769' was evaluted to '{(long)integerOneDecrementUnderInt16MinValue}'. Expected: '-32769'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveInt16MinValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)-32767' was evaluted to '{(long)integerOneIncrementAboveInt16MinValue}'. Expected: '-32767'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderInt16MaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)32766' was evaluted to '{(long)integerOneDecrementUnderInt16MaxValue}'. Expected: '32766'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveInt16MaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)32768' was evaluted to '{(long)integerOneIncrementAboveInt16MaxValue}'. Expected: '32768'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmUInt16MaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)65535' was evaluted to '{(long)uInt16MaxValue}'. Expected: '65535'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderUInt16MaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)65534' was evaluted to '{(long)integerOneDecrementUnderUInt16MaxValue}'. Expected: '65534'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveUInt16MaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)65536' was evaluted to '{(long)integerOneIncrementAboveUInt16MaxValue}'. Expected: '65536'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmInt32MinValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)-2147483648' was evaluted to '{(long)int32MinValue}'. Expected: '-2147483648'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmInt32MaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)2147483647' was evaluted to '{(long)int32MaxValue}'. Expected: '2147483647'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveInt32MinValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)-2147483647' was evaluted to '{(long)integerOneIncrementAboveInt32MinValue}'. Expected: '-2147483647'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderInt32MaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)2147483646' was evaluted to '{(long)integerOneDecrementUnderInt32MaxValue}'. Expected: '2147483646'."
                );
                _counter++;
            }
        }
    ...
    private static void TestCastingInt32ToUInt64()
    {
        ...
        static void ConfirmIntegerZeroCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)0' was evaluted to '{(ulong)integerZero}'. Expected: '0'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSByteMaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)127' was evaluted to '{(ulong)sByteMaxValue}'. Expected: '127'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderSByteMaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)126' was evaluted to '{(ulong)integerOneDecrementUnderSByteMaxValue}'. Expected: '126'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveSByteMaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)128' was evaluted to '{(ulong)integerOneIncrementAboveSByteMaxValue}'. Expected: '128'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmByteMaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)255' was evaluted to '{(ulong)byteMaxValue}'. Expected: '255'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveByteMinValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)1' was evaluted to '{(ulong)integerOneIncrementAboveByteMinValue}'. Expected: '1'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderByteMaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)254' was evaluted to '{(ulong)integerOneDecrementUnderByteMaxValue}'. Expected: '254'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveByteMaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)256' was evaluted to '{(ulong)integerOneIncrementAboveByteMaxValue}'. Expected: '256'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmInt16MaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)32767' was evaluted to '{(ulong)int16MaxValue}'. Expected: '32767'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderInt16MaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)32766' was evaluted to '{(ulong)integerOneDecrementUnderInt16MaxValue}'. Expected: '32766'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveInt16MaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)32768' was evaluted to '{(ulong)integerOneIncrementAboveInt16MaxValue}'. Expected: '32768'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmUInt16MaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)65535' was evaluted to '{(ulong)uInt16MaxValue}'. Expected: '65535'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderUInt16MaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)65534' was evaluted to '{(ulong)integerOneDecrementUnderUInt16MaxValue}'. Expected: '65534'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveUInt16MaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)65536' was evaluted to '{(ulong)integerOneIncrementAboveUInt16MaxValue}'. Expected: '65536'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmInt32MaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)2147483647' was evaluted to '{(ulong)int32MaxValue}'. Expected: '2147483647'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderInt32MaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)2147483646' was evaluted to '{(ulong)integerOneDecrementUnderInt32MaxValue}'. Expected: '2147483646'."
                );
                _counter++;
            }
        }
    ...
    private static void TestCastingUInt32ToSingle()
    {
        ...
        static void ConfirmIntegerOneIncrementAboveInt32MaxValueCastToSingleIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(float)2147483648' was evaluted to '{(float)integerOneIncrementAboveInt32MaxValue}'. Expected: '2.1474836E+09f'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmUInt32MaxValueCastToSingleIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(float)4294967295' was evaluted to '{(float)uInt32MaxValue}'. Expected: '4.2949673E+09f'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderUInt32MaxValueCastToSingleIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(float)4294967294' was evaluted to '{(float)integerOneDecrementUnderUInt32MaxValue}'. Expected: '4.2949673E+09f'."
                );
                _counter++;
            }
        }
    ...
    private static void TestCastingUInt32ToDouble()
    {
        ...
        static void ConfirmIntegerOneIncrementAboveInt32MaxValueCastToDoubleIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(double)2147483648' was evaluted to '{(double)integerOneIncrementAboveInt32MaxValue}'. Expected: '2147483648d'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmUInt32MaxValueCastToDoubleIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(double)4294967295' was evaluted to '{(double)uInt32MaxValue}'. Expected: '4294967295d'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderUInt32MaxValueCastToDoubleIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(double)4294967294' was evaluted to '{(double)integerOneDecrementUnderUInt32MaxValue}'. Expected: '4294967294d'."
                );
                _counter++;
            }
        }
    ...
    private static void TestCastingUInt32ToUInt32()
    {
        ...
        static void ConfirmIntegerOneIncrementAboveInt32MaxValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)2147483648' was evaluted to '{(uint)integerOneIncrementAboveInt32MaxValue}'. Expected: '2147483648'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmUInt32MaxValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)4294967295' was evaluted to '{(uint)uInt32MaxValue}'. Expected: '4294967295'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderUInt32MaxValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)4294967294' was evaluted to '{(uint)integerOneDecrementUnderUInt32MaxValue}'. Expected: '4294967294'."
                );
                _counter++;
            }
        }
    ...
    private static void TestCastingUInt32ToInt64()
    {
        ...
        static void ConfirmIntegerOneIncrementAboveInt32MaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)2147483648' was evaluted to '{(long)integerOneIncrementAboveInt32MaxValue}'. Expected: '2147483648'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmUInt32MaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)4294967295' was evaluted to '{(long)uInt32MaxValue}'. Expected: '4294967295'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderUInt32MaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)4294967294' was evaluted to '{(long)integerOneDecrementUnderUInt32MaxValue}'. Expected: '4294967294'."
                );
                _counter++;
            }
        }
    ...
    private static void TestCastingUInt32ToUInt64()
    {
        ...
        static void ConfirmIntegerOneIncrementAboveInt32MaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)2147483648' was evaluted to '{(ulong)integerOneIncrementAboveInt32MaxValue}'. Expected: '2147483648'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmUInt32MaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)4294967295' was evaluted to '{(ulong)uInt32MaxValue}'. Expected: '4294967295'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderUInt32MaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)4294967294' was evaluted to '{(ulong)integerOneDecrementUnderUInt32MaxValue}'. Expected: '4294967294'."
                );
                _counter++;
            }
        }
