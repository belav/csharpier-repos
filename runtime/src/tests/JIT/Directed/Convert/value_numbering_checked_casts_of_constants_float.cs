...
public partial class ValueNumberingCheckedCastsOfConstants
{
    private static void TestCastingSingleToSByte()
    {
        ...
        static void ConfirmIntegerZeroCastToSByteIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(sbyte)0.0f' was evaluted to '{(sbyte)integerZero}'. Expected: '0'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmFloatMinusZeroCastToSByteIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(sbyte)-0f' was evaluted to '{(sbyte)floatMinusZero}'. Expected: '0'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmFloatZeroCastToSByteIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(sbyte)0f' was evaluted to '{(sbyte)floatZero}'. Expected: '0'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSByteMinValueCastToSByteIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(sbyte)-128.0f' was evaluted to '{(sbyte)sByteMinValue}'. Expected: '-128'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSByteMaxValueCastToSByteIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(sbyte)127.0f' was evaluted to '{(sbyte)sByteMaxValue}'. Expected: '127'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneDecrementUnderSByteMinValueCastToSByteIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(sbyte)-128.00002f' was evaluted to '{(sbyte)singleOneDecrementUnderSByteMinValue}'. Expected: '-128'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneIncrementAboveSByteMinValueCastToSByteIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(sbyte)-127.99999f' was evaluted to '{(sbyte)singleOneIncrementAboveSByteMinValue}'. Expected: '-127'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneFullIncrementAboveSByteMinValueCastToSByteIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(sbyte)-127f' was evaluted to '{(sbyte)singleOneFullIncrementAboveSByteMinValue}'. Expected: '-127'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneDecrementUnderSByteMaxValueCastToSByteIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(sbyte)126.99999f' was evaluted to '{(sbyte)singleOneDecrementUnderSByteMaxValue}'. Expected: '126'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneFullDecrementUnderSByteMaxValueCastToSByteIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(sbyte)126f' was evaluted to '{(sbyte)singleOneFullDecrementUnderSByteMaxValue}'. Expected: '126'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneIncrementAboveSByteMaxValueCastToSByteIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(sbyte)127.00001f' was evaluted to '{(sbyte)singleOneIncrementAboveSByteMaxValue}'. Expected: '127'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveSByteMinValueCastToSByteIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(sbyte)-127.0f' was evaluted to '{(sbyte)integerOneIncrementAboveSByteMinValue}'. Expected: '-127'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderSByteMaxValueCastToSByteIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(sbyte)126.0f' was evaluted to '{(sbyte)integerOneDecrementUnderSByteMaxValue}'. Expected: '126'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneDecrementUnderByteMinValueCastToSByteIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(sbyte)-1E-45f' was evaluted to '{(sbyte)singleOneDecrementUnderByteMinValue}'. Expected: '0'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneFullDecrementUnderByteMinValueCastToSByteIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(sbyte)-1f' was evaluted to '{(sbyte)singleOneFullDecrementUnderByteMinValue}'. Expected: '-1'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneIncrementAboveByteMinValueCastToSByteIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(sbyte)1E-45f' was evaluted to '{(sbyte)singleOneIncrementAboveByteMinValue}'. Expected: '0'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneFullIncrementAboveByteMinValueCastToSByteIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(sbyte)1f' was evaluted to '{(sbyte)singleOneFullIncrementAboveByteMinValue}'. Expected: '1'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderByteMinValueCastToSByteIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(sbyte)-1.0f' was evaluted to '{(sbyte)integerOneDecrementUnderByteMinValue}'. Expected: '-1'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveByteMinValueCastToSByteIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(sbyte)1.0f' was evaluted to '{(sbyte)integerOneIncrementAboveByteMinValue}'. Expected: '1'."
                );
                _counter++;
            }
        }
    ...
    private static void TestCastingSingleToByte()
    {
        ...
        static void ConfirmIntegerZeroCastToByteIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(byte)0.0f' was evaluted to '{(byte)integerZero}'. Expected: '0'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmFloatMinusZeroCastToByteIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(byte)-0f' was evaluted to '{(byte)floatMinusZero}'. Expected: '0'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmFloatZeroCastToByteIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(byte)0f' was evaluted to '{(byte)floatZero}'. Expected: '0'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSByteMaxValueCastToByteIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(byte)127.0f' was evaluted to '{(byte)sByteMaxValue}'. Expected: '127'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneDecrementUnderSByteMaxValueCastToByteIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(byte)126.99999f' was evaluted to '{(byte)singleOneDecrementUnderSByteMaxValue}'. Expected: '126'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneFullDecrementUnderSByteMaxValueCastToByteIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(byte)126f' was evaluted to '{(byte)singleOneFullDecrementUnderSByteMaxValue}'. Expected: '126'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneIncrementAboveSByteMaxValueCastToByteIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(byte)127.00001f' was evaluted to '{(byte)singleOneIncrementAboveSByteMaxValue}'. Expected: '127'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneFullIncrementAboveSByteMaxValueCastToByteIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(byte)128f' was evaluted to '{(byte)singleOneFullIncrementAboveSByteMaxValue}'. Expected: '128'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderSByteMaxValueCastToByteIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(byte)126.0f' was evaluted to '{(byte)integerOneDecrementUnderSByteMaxValue}'. Expected: '126'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveSByteMaxValueCastToByteIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(byte)128.0f' was evaluted to '{(byte)integerOneIncrementAboveSByteMaxValue}'. Expected: '128'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmByteMaxValueCastToByteIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(byte)255.0f' was evaluted to '{(byte)byteMaxValue}'. Expected: '255'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneDecrementUnderByteMinValueCastToByteIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(byte)-1E-45f' was evaluted to '{(byte)singleOneDecrementUnderByteMinValue}'. Expected: '0'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneIncrementAboveByteMinValueCastToByteIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(byte)1E-45f' was evaluted to '{(byte)singleOneIncrementAboveByteMinValue}'. Expected: '0'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneFullIncrementAboveByteMinValueCastToByteIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(byte)1f' was evaluted to '{(byte)singleOneFullIncrementAboveByteMinValue}'. Expected: '1'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneDecrementUnderByteMaxValueCastToByteIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(byte)254.99998f' was evaluted to '{(byte)singleOneDecrementUnderByteMaxValue}'. Expected: '254'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneFullDecrementUnderByteMaxValueCastToByteIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(byte)254f' was evaluted to '{(byte)singleOneFullDecrementUnderByteMaxValue}'. Expected: '254'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneIncrementAboveByteMaxValueCastToByteIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(byte)255.00002f' was evaluted to '{(byte)singleOneIncrementAboveByteMaxValue}'. Expected: '255'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveByteMinValueCastToByteIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(byte)1.0f' was evaluted to '{(byte)integerOneIncrementAboveByteMinValue}'. Expected: '1'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderByteMaxValueCastToByteIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(byte)254.0f' was evaluted to '{(byte)integerOneDecrementUnderByteMaxValue}'. Expected: '254'."
                );
                _counter++;
            }
        }
    ...
    private static void TestCastingSingleToInt16()
    {
        ...
        static void ConfirmIntegerZeroCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)0.0f' was evaluted to '{(short)integerZero}'. Expected: '0'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmFloatMinusZeroCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)-0f' was evaluted to '{(short)floatMinusZero}'. Expected: '0'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmFloatZeroCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)0f' was evaluted to '{(short)floatZero}'. Expected: '0'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSByteMinValueCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)-128.0f' was evaluted to '{(short)sByteMinValue}'. Expected: '-128'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSByteMaxValueCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)127.0f' was evaluted to '{(short)sByteMaxValue}'. Expected: '127'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneDecrementUnderSByteMinValueCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)-128.00002f' was evaluted to '{(short)singleOneDecrementUnderSByteMinValue}'. Expected: '-128'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneFullDecrementUnderSByteMinValueCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)-129f' was evaluted to '{(short)singleOneFullDecrementUnderSByteMinValue}'. Expected: '-129'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneIncrementAboveSByteMinValueCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)-127.99999f' was evaluted to '{(short)singleOneIncrementAboveSByteMinValue}'. Expected: '-127'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneFullIncrementAboveSByteMinValueCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)-127f' was evaluted to '{(short)singleOneFullIncrementAboveSByteMinValue}'. Expected: '-127'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneDecrementUnderSByteMaxValueCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)126.99999f' was evaluted to '{(short)singleOneDecrementUnderSByteMaxValue}'. Expected: '126'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneFullDecrementUnderSByteMaxValueCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)126f' was evaluted to '{(short)singleOneFullDecrementUnderSByteMaxValue}'. Expected: '126'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneIncrementAboveSByteMaxValueCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)127.00001f' was evaluted to '{(short)singleOneIncrementAboveSByteMaxValue}'. Expected: '127'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneFullIncrementAboveSByteMaxValueCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)128f' was evaluted to '{(short)singleOneFullIncrementAboveSByteMaxValue}'. Expected: '128'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderSByteMinValueCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)-129.0f' was evaluted to '{(short)integerOneDecrementUnderSByteMinValue}'. Expected: '-129'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveSByteMinValueCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)-127.0f' was evaluted to '{(short)integerOneIncrementAboveSByteMinValue}'. Expected: '-127'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderSByteMaxValueCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)126.0f' was evaluted to '{(short)integerOneDecrementUnderSByteMaxValue}'. Expected: '126'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveSByteMaxValueCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)128.0f' was evaluted to '{(short)integerOneIncrementAboveSByteMaxValue}'. Expected: '128'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmByteMaxValueCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)255.0f' was evaluted to '{(short)byteMaxValue}'. Expected: '255'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneDecrementUnderByteMinValueCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)-1E-45f' was evaluted to '{(short)singleOneDecrementUnderByteMinValue}'. Expected: '0'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneFullDecrementUnderByteMinValueCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)-1f' was evaluted to '{(short)singleOneFullDecrementUnderByteMinValue}'. Expected: '-1'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneIncrementAboveByteMinValueCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)1E-45f' was evaluted to '{(short)singleOneIncrementAboveByteMinValue}'. Expected: '0'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneFullIncrementAboveByteMinValueCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)1f' was evaluted to '{(short)singleOneFullIncrementAboveByteMinValue}'. Expected: '1'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneDecrementUnderByteMaxValueCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)254.99998f' was evaluted to '{(short)singleOneDecrementUnderByteMaxValue}'. Expected: '254'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneFullDecrementUnderByteMaxValueCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)254f' was evaluted to '{(short)singleOneFullDecrementUnderByteMaxValue}'. Expected: '254'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneIncrementAboveByteMaxValueCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)255.00002f' was evaluted to '{(short)singleOneIncrementAboveByteMaxValue}'. Expected: '255'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneFullIncrementAboveByteMaxValueCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)256f' was evaluted to '{(short)singleOneFullIncrementAboveByteMaxValue}'. Expected: '256'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderByteMinValueCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)-1.0f' was evaluted to '{(short)integerOneDecrementUnderByteMinValue}'. Expected: '-1'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveByteMinValueCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)1.0f' was evaluted to '{(short)integerOneIncrementAboveByteMinValue}'. Expected: '1'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderByteMaxValueCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)254.0f' was evaluted to '{(short)integerOneDecrementUnderByteMaxValue}'. Expected: '254'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveByteMaxValueCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)256.0f' was evaluted to '{(short)integerOneIncrementAboveByteMaxValue}'. Expected: '256'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmInt16MinValueCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)-32768.0f' was evaluted to '{(short)int16MinValue}'. Expected: '-32768'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmInt16MaxValueCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)32767.0f' was evaluted to '{(short)int16MaxValue}'. Expected: '32767'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneDecrementUnderInt16MinValueCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)-32768.004f' was evaluted to '{(short)singleOneDecrementUnderInt16MinValue}'. Expected: '-32768'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneIncrementAboveInt16MinValueCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)-32767.998f' was evaluted to '{(short)singleOneIncrementAboveInt16MinValue}'. Expected: '-32767'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneFullIncrementAboveInt16MinValueCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)-32767f' was evaluted to '{(short)singleOneFullIncrementAboveInt16MinValue}'. Expected: '-32767'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneDecrementUnderInt16MaxValueCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)32766.998f' was evaluted to '{(short)singleOneDecrementUnderInt16MaxValue}'. Expected: '32766'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneFullDecrementUnderInt16MaxValueCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)32766f' was evaluted to '{(short)singleOneFullDecrementUnderInt16MaxValue}'. Expected: '32766'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneIncrementAboveInt16MaxValueCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)32767.002f' was evaluted to '{(short)singleOneIncrementAboveInt16MaxValue}'. Expected: '32767'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveInt16MinValueCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)-32767.0f' was evaluted to '{(short)integerOneIncrementAboveInt16MinValue}'. Expected: '-32767'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderInt16MaxValueCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)32766.0f' was evaluted to '{(short)integerOneDecrementUnderInt16MaxValue}'. Expected: '32766'."
                );
                _counter++;
            }
        }
    ...
    private static void TestCastingSingleToUInt16()
    {
        ...
        static void ConfirmIntegerZeroCastToUInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ushort)0.0f' was evaluted to '{(ushort)integerZero}'. Expected: '0'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmFloatMinusZeroCastToUInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ushort)-0f' was evaluted to '{(ushort)floatMinusZero}'. Expected: '0'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmFloatZeroCastToUInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ushort)0f' was evaluted to '{(ushort)floatZero}'. Expected: '0'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSByteMaxValueCastToUInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ushort)127.0f' was evaluted to '{(ushort)sByteMaxValue}'. Expected: '127'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneDecrementUnderSByteMaxValueCastToUInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ushort)126.99999f' was evaluted to '{(ushort)singleOneDecrementUnderSByteMaxValue}'. Expected: '126'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneFullDecrementUnderSByteMaxValueCastToUInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ushort)126f' was evaluted to '{(ushort)singleOneFullDecrementUnderSByteMaxValue}'. Expected: '126'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneIncrementAboveSByteMaxValueCastToUInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ushort)127.00001f' was evaluted to '{(ushort)singleOneIncrementAboveSByteMaxValue}'. Expected: '127'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneFullIncrementAboveSByteMaxValueCastToUInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ushort)128f' was evaluted to '{(ushort)singleOneFullIncrementAboveSByteMaxValue}'. Expected: '128'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderSByteMaxValueCastToUInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ushort)126.0f' was evaluted to '{(ushort)integerOneDecrementUnderSByteMaxValue}'. Expected: '126'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveSByteMaxValueCastToUInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ushort)128.0f' was evaluted to '{(ushort)integerOneIncrementAboveSByteMaxValue}'. Expected: '128'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmByteMaxValueCastToUInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ushort)255.0f' was evaluted to '{(ushort)byteMaxValue}'. Expected: '255'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneDecrementUnderByteMinValueCastToUInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ushort)-1E-45f' was evaluted to '{(ushort)singleOneDecrementUnderByteMinValue}'. Expected: '0'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneIncrementAboveByteMinValueCastToUInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ushort)1E-45f' was evaluted to '{(ushort)singleOneIncrementAboveByteMinValue}'. Expected: '0'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneFullIncrementAboveByteMinValueCastToUInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ushort)1f' was evaluted to '{(ushort)singleOneFullIncrementAboveByteMinValue}'. Expected: '1'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneDecrementUnderByteMaxValueCastToUInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ushort)254.99998f' was evaluted to '{(ushort)singleOneDecrementUnderByteMaxValue}'. Expected: '254'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneFullDecrementUnderByteMaxValueCastToUInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ushort)254f' was evaluted to '{(ushort)singleOneFullDecrementUnderByteMaxValue}'. Expected: '254'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneIncrementAboveByteMaxValueCastToUInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ushort)255.00002f' was evaluted to '{(ushort)singleOneIncrementAboveByteMaxValue}'. Expected: '255'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneFullIncrementAboveByteMaxValueCastToUInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ushort)256f' was evaluted to '{(ushort)singleOneFullIncrementAboveByteMaxValue}'. Expected: '256'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveByteMinValueCastToUInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ushort)1.0f' was evaluted to '{(ushort)integerOneIncrementAboveByteMinValue}'. Expected: '1'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderByteMaxValueCastToUInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ushort)254.0f' was evaluted to '{(ushort)integerOneDecrementUnderByteMaxValue}'. Expected: '254'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveByteMaxValueCastToUInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ushort)256.0f' was evaluted to '{(ushort)integerOneIncrementAboveByteMaxValue}'. Expected: '256'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmInt16MaxValueCastToUInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ushort)32767.0f' was evaluted to '{(ushort)int16MaxValue}'. Expected: '32767'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneDecrementUnderInt16MaxValueCastToUInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ushort)32766.998f' was evaluted to '{(ushort)singleOneDecrementUnderInt16MaxValue}'. Expected: '32766'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneFullDecrementUnderInt16MaxValueCastToUInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ushort)32766f' was evaluted to '{(ushort)singleOneFullDecrementUnderInt16MaxValue}'. Expected: '32766'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneIncrementAboveInt16MaxValueCastToUInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ushort)32767.002f' was evaluted to '{(ushort)singleOneIncrementAboveInt16MaxValue}'. Expected: '32767'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneFullIncrementAboveInt16MaxValueCastToUInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ushort)32768f' was evaluted to '{(ushort)singleOneFullIncrementAboveInt16MaxValue}'. Expected: '32768'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderInt16MaxValueCastToUInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ushort)32766.0f' was evaluted to '{(ushort)integerOneDecrementUnderInt16MaxValue}'. Expected: '32766'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveInt16MaxValueCastToUInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ushort)32768.0f' was evaluted to '{(ushort)integerOneIncrementAboveInt16MaxValue}'. Expected: '32768'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmUInt16MaxValueCastToUInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ushort)65535.0f' was evaluted to '{(ushort)uInt16MaxValue}'. Expected: '65535'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneDecrementUnderUInt16MaxValueCastToUInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ushort)65534.996f' was evaluted to '{(ushort)singleOneDecrementUnderUInt16MaxValue}'. Expected: '65534'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneFullDecrementUnderUInt16MaxValueCastToUInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ushort)65534f' was evaluted to '{(ushort)singleOneFullDecrementUnderUInt16MaxValue}'. Expected: '65534'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneIncrementAboveUInt16MaxValueCastToUInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ushort)65535.004f' was evaluted to '{(ushort)singleOneIncrementAboveUInt16MaxValue}'. Expected: '65535'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderUInt16MaxValueCastToUInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ushort)65534.0f' was evaluted to '{(ushort)integerOneDecrementUnderUInt16MaxValue}'. Expected: '65534'."
                );
                _counter++;
            }
        }
    ...
    private static void TestCastingSingleToInt32()
    {
        ...
        static void ConfirmIntegerZeroCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)0.0f' was evaluted to '{(int)integerZero}'. Expected: '0'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmFloatMinusZeroCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)-0f' was evaluted to '{(int)floatMinusZero}'. Expected: '0'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmFloatZeroCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine($"'(int)0f' was evaluted to '{(int)floatZero}'. Expected: '0'.");
                _counter++;
            }
        }
        ...
        static void ConfirmSByteMinValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)-128.0f' was evaluted to '{(int)sByteMinValue}'. Expected: '-128'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSByteMaxValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)127.0f' was evaluted to '{(int)sByteMaxValue}'. Expected: '127'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneDecrementUnderSByteMinValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)-128.00002f' was evaluted to '{(int)singleOneDecrementUnderSByteMinValue}'. Expected: '-128'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneFullDecrementUnderSByteMinValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)-129f' was evaluted to '{(int)singleOneFullDecrementUnderSByteMinValue}'. Expected: '-129'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneIncrementAboveSByteMinValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)-127.99999f' was evaluted to '{(int)singleOneIncrementAboveSByteMinValue}'. Expected: '-127'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneFullIncrementAboveSByteMinValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)-127f' was evaluted to '{(int)singleOneFullIncrementAboveSByteMinValue}'. Expected: '-127'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneDecrementUnderSByteMaxValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)126.99999f' was evaluted to '{(int)singleOneDecrementUnderSByteMaxValue}'. Expected: '126'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneFullDecrementUnderSByteMaxValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)126f' was evaluted to '{(int)singleOneFullDecrementUnderSByteMaxValue}'. Expected: '126'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneIncrementAboveSByteMaxValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)127.00001f' was evaluted to '{(int)singleOneIncrementAboveSByteMaxValue}'. Expected: '127'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneFullIncrementAboveSByteMaxValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)128f' was evaluted to '{(int)singleOneFullIncrementAboveSByteMaxValue}'. Expected: '128'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderSByteMinValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)-129.0f' was evaluted to '{(int)integerOneDecrementUnderSByteMinValue}'. Expected: '-129'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveSByteMinValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)-127.0f' was evaluted to '{(int)integerOneIncrementAboveSByteMinValue}'. Expected: '-127'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderSByteMaxValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)126.0f' was evaluted to '{(int)integerOneDecrementUnderSByteMaxValue}'. Expected: '126'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveSByteMaxValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)128.0f' was evaluted to '{(int)integerOneIncrementAboveSByteMaxValue}'. Expected: '128'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmByteMaxValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)255.0f' was evaluted to '{(int)byteMaxValue}'. Expected: '255'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneDecrementUnderByteMinValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)-1E-45f' was evaluted to '{(int)singleOneDecrementUnderByteMinValue}'. Expected: '0'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneFullDecrementUnderByteMinValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)-1f' was evaluted to '{(int)singleOneFullDecrementUnderByteMinValue}'. Expected: '-1'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneIncrementAboveByteMinValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)1E-45f' was evaluted to '{(int)singleOneIncrementAboveByteMinValue}'. Expected: '0'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneFullIncrementAboveByteMinValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)1f' was evaluted to '{(int)singleOneFullIncrementAboveByteMinValue}'. Expected: '1'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneDecrementUnderByteMaxValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)254.99998f' was evaluted to '{(int)singleOneDecrementUnderByteMaxValue}'. Expected: '254'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneFullDecrementUnderByteMaxValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)254f' was evaluted to '{(int)singleOneFullDecrementUnderByteMaxValue}'. Expected: '254'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneIncrementAboveByteMaxValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)255.00002f' was evaluted to '{(int)singleOneIncrementAboveByteMaxValue}'. Expected: '255'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneFullIncrementAboveByteMaxValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)256f' was evaluted to '{(int)singleOneFullIncrementAboveByteMaxValue}'. Expected: '256'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderByteMinValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)-1.0f' was evaluted to '{(int)integerOneDecrementUnderByteMinValue}'. Expected: '-1'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveByteMinValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)1.0f' was evaluted to '{(int)integerOneIncrementAboveByteMinValue}'. Expected: '1'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderByteMaxValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)254.0f' was evaluted to '{(int)integerOneDecrementUnderByteMaxValue}'. Expected: '254'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveByteMaxValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)256.0f' was evaluted to '{(int)integerOneIncrementAboveByteMaxValue}'. Expected: '256'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmInt16MinValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)-32768.0f' was evaluted to '{(int)int16MinValue}'. Expected: '-32768'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmInt16MaxValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)32767.0f' was evaluted to '{(int)int16MaxValue}'. Expected: '32767'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneDecrementUnderInt16MinValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)-32768.004f' was evaluted to '{(int)singleOneDecrementUnderInt16MinValue}'. Expected: '-32768'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneFullDecrementUnderInt16MinValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)-32769f' was evaluted to '{(int)singleOneFullDecrementUnderInt16MinValue}'. Expected: '-32769'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneIncrementAboveInt16MinValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)-32767.998f' was evaluted to '{(int)singleOneIncrementAboveInt16MinValue}'. Expected: '-32767'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneFullIncrementAboveInt16MinValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)-32767f' was evaluted to '{(int)singleOneFullIncrementAboveInt16MinValue}'. Expected: '-32767'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneDecrementUnderInt16MaxValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)32766.998f' was evaluted to '{(int)singleOneDecrementUnderInt16MaxValue}'. Expected: '32766'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneFullDecrementUnderInt16MaxValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)32766f' was evaluted to '{(int)singleOneFullDecrementUnderInt16MaxValue}'. Expected: '32766'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneIncrementAboveInt16MaxValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)32767.002f' was evaluted to '{(int)singleOneIncrementAboveInt16MaxValue}'. Expected: '32767'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneFullIncrementAboveInt16MaxValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)32768f' was evaluted to '{(int)singleOneFullIncrementAboveInt16MaxValue}'. Expected: '32768'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderInt16MinValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)-32769.0f' was evaluted to '{(int)integerOneDecrementUnderInt16MinValue}'. Expected: '-32769'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveInt16MinValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)-32767.0f' was evaluted to '{(int)integerOneIncrementAboveInt16MinValue}'. Expected: '-32767'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderInt16MaxValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)32766.0f' was evaluted to '{(int)integerOneDecrementUnderInt16MaxValue}'. Expected: '32766'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveInt16MaxValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)32768.0f' was evaluted to '{(int)integerOneIncrementAboveInt16MaxValue}'. Expected: '32768'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmUInt16MaxValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)65535.0f' was evaluted to '{(int)uInt16MaxValue}'. Expected: '65535'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneDecrementUnderUInt16MaxValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)65534.996f' was evaluted to '{(int)singleOneDecrementUnderUInt16MaxValue}'. Expected: '65534'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneFullDecrementUnderUInt16MaxValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)65534f' was evaluted to '{(int)singleOneFullDecrementUnderUInt16MaxValue}'. Expected: '65534'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneIncrementAboveUInt16MaxValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)65535.004f' was evaluted to '{(int)singleOneIncrementAboveUInt16MaxValue}'. Expected: '65535'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneFullIncrementAboveUInt16MaxValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)65536f' was evaluted to '{(int)singleOneFullIncrementAboveUInt16MaxValue}'. Expected: '65536'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderUInt16MaxValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)65534.0f' was evaluted to '{(int)integerOneDecrementUnderUInt16MaxValue}'. Expected: '65534'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveUInt16MaxValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)65536.0f' was evaluted to '{(int)integerOneIncrementAboveUInt16MaxValue}'. Expected: '65536'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmInt32MinValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)-2147483648.0f' was evaluted to '{(int)int32MinValue}'. Expected: '-2147483648'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneIncrementAboveInt32MinValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)-2.1474835E+09f' was evaluted to '{(int)singleOneIncrementAboveInt32MinValue}'. Expected: '-2147483520'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneDecrementUnderInt32MaxValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)2.1474835E+09f' was evaluted to '{(int)singleOneDecrementUnderInt32MaxValue}'. Expected: '2147483520'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderInt32MinValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)-2147483649.0f' was evaluted to '{(int)integerOneDecrementUnderInt32MinValue}'. Expected: '-2147483648'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveInt32MinValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)-2147483647.0f' was evaluted to '{(int)integerOneIncrementAboveInt32MinValue}'. Expected: '-2147483648'."
                );
                _counter++;
            }
        }
    ...
    private static void TestCastingSingleToUInt32()
    {
        ...
        static void ConfirmIntegerZeroCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)0.0f' was evaluted to '{(uint)integerZero}'. Expected: '0'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmFloatMinusZeroCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)-0f' was evaluted to '{(uint)floatMinusZero}'. Expected: '0'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmFloatZeroCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)0f' was evaluted to '{(uint)floatZero}'. Expected: '0'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSByteMaxValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)127.0f' was evaluted to '{(uint)sByteMaxValue}'. Expected: '127'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneDecrementUnderSByteMaxValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)126.99999f' was evaluted to '{(uint)singleOneDecrementUnderSByteMaxValue}'. Expected: '126'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneFullDecrementUnderSByteMaxValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)126f' was evaluted to '{(uint)singleOneFullDecrementUnderSByteMaxValue}'. Expected: '126'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneIncrementAboveSByteMaxValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)127.00001f' was evaluted to '{(uint)singleOneIncrementAboveSByteMaxValue}'. Expected: '127'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneFullIncrementAboveSByteMaxValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)128f' was evaluted to '{(uint)singleOneFullIncrementAboveSByteMaxValue}'. Expected: '128'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderSByteMaxValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)126.0f' was evaluted to '{(uint)integerOneDecrementUnderSByteMaxValue}'. Expected: '126'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveSByteMaxValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)128.0f' was evaluted to '{(uint)integerOneIncrementAboveSByteMaxValue}'. Expected: '128'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmByteMaxValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)255.0f' was evaluted to '{(uint)byteMaxValue}'. Expected: '255'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneDecrementUnderByteMinValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)-1E-45f' was evaluted to '{(uint)singleOneDecrementUnderByteMinValue}'. Expected: '0'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneIncrementAboveByteMinValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)1E-45f' was evaluted to '{(uint)singleOneIncrementAboveByteMinValue}'. Expected: '0'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneFullIncrementAboveByteMinValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)1f' was evaluted to '{(uint)singleOneFullIncrementAboveByteMinValue}'. Expected: '1'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneDecrementUnderByteMaxValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)254.99998f' was evaluted to '{(uint)singleOneDecrementUnderByteMaxValue}'. Expected: '254'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneFullDecrementUnderByteMaxValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)254f' was evaluted to '{(uint)singleOneFullDecrementUnderByteMaxValue}'. Expected: '254'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneIncrementAboveByteMaxValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)255.00002f' was evaluted to '{(uint)singleOneIncrementAboveByteMaxValue}'. Expected: '255'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneFullIncrementAboveByteMaxValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)256f' was evaluted to '{(uint)singleOneFullIncrementAboveByteMaxValue}'. Expected: '256'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveByteMinValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)1.0f' was evaluted to '{(uint)integerOneIncrementAboveByteMinValue}'. Expected: '1'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderByteMaxValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)254.0f' was evaluted to '{(uint)integerOneDecrementUnderByteMaxValue}'. Expected: '254'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveByteMaxValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)256.0f' was evaluted to '{(uint)integerOneIncrementAboveByteMaxValue}'. Expected: '256'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmInt16MaxValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)32767.0f' was evaluted to '{(uint)int16MaxValue}'. Expected: '32767'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneDecrementUnderInt16MaxValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)32766.998f' was evaluted to '{(uint)singleOneDecrementUnderInt16MaxValue}'. Expected: '32766'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneFullDecrementUnderInt16MaxValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)32766f' was evaluted to '{(uint)singleOneFullDecrementUnderInt16MaxValue}'. Expected: '32766'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneIncrementAboveInt16MaxValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)32767.002f' was evaluted to '{(uint)singleOneIncrementAboveInt16MaxValue}'. Expected: '32767'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneFullIncrementAboveInt16MaxValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)32768f' was evaluted to '{(uint)singleOneFullIncrementAboveInt16MaxValue}'. Expected: '32768'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderInt16MaxValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)32766.0f' was evaluted to '{(uint)integerOneDecrementUnderInt16MaxValue}'. Expected: '32766'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveInt16MaxValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)32768.0f' was evaluted to '{(uint)integerOneIncrementAboveInt16MaxValue}'. Expected: '32768'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmUInt16MaxValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)65535.0f' was evaluted to '{(uint)uInt16MaxValue}'. Expected: '65535'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneDecrementUnderUInt16MaxValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)65534.996f' was evaluted to '{(uint)singleOneDecrementUnderUInt16MaxValue}'. Expected: '65534'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneFullDecrementUnderUInt16MaxValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)65534f' was evaluted to '{(uint)singleOneFullDecrementUnderUInt16MaxValue}'. Expected: '65534'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneIncrementAboveUInt16MaxValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)65535.004f' was evaluted to '{(uint)singleOneIncrementAboveUInt16MaxValue}'. Expected: '65535'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneFullIncrementAboveUInt16MaxValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)65536f' was evaluted to '{(uint)singleOneFullIncrementAboveUInt16MaxValue}'. Expected: '65536'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderUInt16MaxValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)65534.0f' was evaluted to '{(uint)integerOneDecrementUnderUInt16MaxValue}'. Expected: '65534'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveUInt16MaxValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)65536.0f' was evaluted to '{(uint)integerOneIncrementAboveUInt16MaxValue}'. Expected: '65536'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmInt32MaxValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)2147483647.0f' was evaluted to '{(uint)int32MaxValue}'. Expected: '2147483648'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneDecrementUnderInt32MaxValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)2.1474835E+09f' was evaluted to '{(uint)singleOneDecrementUnderInt32MaxValue}'. Expected: '2147483520'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneIncrementAboveInt32MaxValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)2.147484E+09f' was evaluted to '{(uint)singleOneIncrementAboveInt32MaxValue}'. Expected: '2147483904'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneFullIncrementAboveInt32MaxValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)2.1474836E+09f' was evaluted to '{(uint)singleOneFullIncrementAboveInt32MaxValue}'. Expected: '2147483648'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderInt32MaxValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)2147483646.0f' was evaluted to '{(uint)integerOneDecrementUnderInt32MaxValue}'. Expected: '2147483648'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveInt32MaxValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)2147483648.0f' was evaluted to '{(uint)integerOneIncrementAboveInt32MaxValue}'. Expected: '2147483648'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneDecrementUnderUInt32MaxValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)4.294967E+09f' was evaluted to '{(uint)singleOneDecrementUnderUInt32MaxValue}'. Expected: '4294967040'."
                );
                _counter++;
            }
        }
    ...
    private static void TestCastingSingleToInt64()
    {
        ...
        static void ConfirmIntegerZeroCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)0.0f' was evaluted to '{(long)integerZero}'. Expected: '0'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmFloatMinusZeroCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)-0f' was evaluted to '{(long)floatMinusZero}'. Expected: '0'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmFloatZeroCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)0f' was evaluted to '{(long)floatZero}'. Expected: '0'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSByteMinValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)-128.0f' was evaluted to '{(long)sByteMinValue}'. Expected: '-128'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSByteMaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)127.0f' was evaluted to '{(long)sByteMaxValue}'. Expected: '127'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneDecrementUnderSByteMinValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)-128.00002f' was evaluted to '{(long)singleOneDecrementUnderSByteMinValue}'. Expected: '-128'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneFullDecrementUnderSByteMinValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)-129f' was evaluted to '{(long)singleOneFullDecrementUnderSByteMinValue}'. Expected: '-129'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneIncrementAboveSByteMinValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)-127.99999f' was evaluted to '{(long)singleOneIncrementAboveSByteMinValue}'. Expected: '-127'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneFullIncrementAboveSByteMinValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)-127f' was evaluted to '{(long)singleOneFullIncrementAboveSByteMinValue}'. Expected: '-127'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneDecrementUnderSByteMaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)126.99999f' was evaluted to '{(long)singleOneDecrementUnderSByteMaxValue}'. Expected: '126'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneFullDecrementUnderSByteMaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)126f' was evaluted to '{(long)singleOneFullDecrementUnderSByteMaxValue}'. Expected: '126'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneIncrementAboveSByteMaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)127.00001f' was evaluted to '{(long)singleOneIncrementAboveSByteMaxValue}'. Expected: '127'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneFullIncrementAboveSByteMaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)128f' was evaluted to '{(long)singleOneFullIncrementAboveSByteMaxValue}'. Expected: '128'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderSByteMinValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)-129.0f' was evaluted to '{(long)integerOneDecrementUnderSByteMinValue}'. Expected: '-129'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveSByteMinValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)-127.0f' was evaluted to '{(long)integerOneIncrementAboveSByteMinValue}'. Expected: '-127'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderSByteMaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)126.0f' was evaluted to '{(long)integerOneDecrementUnderSByteMaxValue}'. Expected: '126'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveSByteMaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)128.0f' was evaluted to '{(long)integerOneIncrementAboveSByteMaxValue}'. Expected: '128'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmByteMaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)255.0f' was evaluted to '{(long)byteMaxValue}'. Expected: '255'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneDecrementUnderByteMinValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)-1E-45f' was evaluted to '{(long)singleOneDecrementUnderByteMinValue}'. Expected: '0'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneFullDecrementUnderByteMinValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)-1f' was evaluted to '{(long)singleOneFullDecrementUnderByteMinValue}'. Expected: '-1'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneIncrementAboveByteMinValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)1E-45f' was evaluted to '{(long)singleOneIncrementAboveByteMinValue}'. Expected: '0'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneFullIncrementAboveByteMinValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)1f' was evaluted to '{(long)singleOneFullIncrementAboveByteMinValue}'. Expected: '1'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneDecrementUnderByteMaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)254.99998f' was evaluted to '{(long)singleOneDecrementUnderByteMaxValue}'. Expected: '254'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneFullDecrementUnderByteMaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)254f' was evaluted to '{(long)singleOneFullDecrementUnderByteMaxValue}'. Expected: '254'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneIncrementAboveByteMaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)255.00002f' was evaluted to '{(long)singleOneIncrementAboveByteMaxValue}'. Expected: '255'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneFullIncrementAboveByteMaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)256f' was evaluted to '{(long)singleOneFullIncrementAboveByteMaxValue}'. Expected: '256'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderByteMinValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)-1.0f' was evaluted to '{(long)integerOneDecrementUnderByteMinValue}'. Expected: '-1'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveByteMinValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)1.0f' was evaluted to '{(long)integerOneIncrementAboveByteMinValue}'. Expected: '1'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderByteMaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)254.0f' was evaluted to '{(long)integerOneDecrementUnderByteMaxValue}'. Expected: '254'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveByteMaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)256.0f' was evaluted to '{(long)integerOneIncrementAboveByteMaxValue}'. Expected: '256'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmInt16MinValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)-32768.0f' was evaluted to '{(long)int16MinValue}'. Expected: '-32768'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmInt16MaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)32767.0f' was evaluted to '{(long)int16MaxValue}'. Expected: '32767'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneDecrementUnderInt16MinValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)-32768.004f' was evaluted to '{(long)singleOneDecrementUnderInt16MinValue}'. Expected: '-32768'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneFullDecrementUnderInt16MinValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)-32769f' was evaluted to '{(long)singleOneFullDecrementUnderInt16MinValue}'. Expected: '-32769'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneIncrementAboveInt16MinValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)-32767.998f' was evaluted to '{(long)singleOneIncrementAboveInt16MinValue}'. Expected: '-32767'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneFullIncrementAboveInt16MinValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)-32767f' was evaluted to '{(long)singleOneFullIncrementAboveInt16MinValue}'. Expected: '-32767'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneDecrementUnderInt16MaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)32766.998f' was evaluted to '{(long)singleOneDecrementUnderInt16MaxValue}'. Expected: '32766'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneFullDecrementUnderInt16MaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)32766f' was evaluted to '{(long)singleOneFullDecrementUnderInt16MaxValue}'. Expected: '32766'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneIncrementAboveInt16MaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)32767.002f' was evaluted to '{(long)singleOneIncrementAboveInt16MaxValue}'. Expected: '32767'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneFullIncrementAboveInt16MaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)32768f' was evaluted to '{(long)singleOneFullIncrementAboveInt16MaxValue}'. Expected: '32768'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderInt16MinValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)-32769.0f' was evaluted to '{(long)integerOneDecrementUnderInt16MinValue}'. Expected: '-32769'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveInt16MinValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)-32767.0f' was evaluted to '{(long)integerOneIncrementAboveInt16MinValue}'. Expected: '-32767'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderInt16MaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)32766.0f' was evaluted to '{(long)integerOneDecrementUnderInt16MaxValue}'. Expected: '32766'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveInt16MaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)32768.0f' was evaluted to '{(long)integerOneIncrementAboveInt16MaxValue}'. Expected: '32768'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmUInt16MaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)65535.0f' was evaluted to '{(long)uInt16MaxValue}'. Expected: '65535'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneDecrementUnderUInt16MaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)65534.996f' was evaluted to '{(long)singleOneDecrementUnderUInt16MaxValue}'. Expected: '65534'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneFullDecrementUnderUInt16MaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)65534f' was evaluted to '{(long)singleOneFullDecrementUnderUInt16MaxValue}'. Expected: '65534'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneIncrementAboveUInt16MaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)65535.004f' was evaluted to '{(long)singleOneIncrementAboveUInt16MaxValue}'. Expected: '65535'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneFullIncrementAboveUInt16MaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)65536f' was evaluted to '{(long)singleOneFullIncrementAboveUInt16MaxValue}'. Expected: '65536'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderUInt16MaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)65534.0f' was evaluted to '{(long)integerOneDecrementUnderUInt16MaxValue}'. Expected: '65534'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveUInt16MaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)65536.0f' was evaluted to '{(long)integerOneIncrementAboveUInt16MaxValue}'. Expected: '65536'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmInt32MinValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)-2147483648.0f' was evaluted to '{(long)int32MinValue}'. Expected: '-2147483648'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmInt32MaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)2147483647.0f' was evaluted to '{(long)int32MaxValue}'. Expected: '2147483648'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneDecrementUnderInt32MinValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)-2.147484E+09f' was evaluted to '{(long)singleOneDecrementUnderInt32MinValue}'. Expected: '-2147483904'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneIncrementAboveInt32MinValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)-2.1474835E+09f' was evaluted to '{(long)singleOneIncrementAboveInt32MinValue}'. Expected: '-2147483520'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneDecrementUnderInt32MaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)2.1474835E+09f' was evaluted to '{(long)singleOneDecrementUnderInt32MaxValue}'. Expected: '2147483520'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneIncrementAboveInt32MaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)2.147484E+09f' was evaluted to '{(long)singleOneIncrementAboveInt32MaxValue}'. Expected: '2147483904'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneFullIncrementAboveInt32MaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)2.1474836E+09f' was evaluted to '{(long)singleOneFullIncrementAboveInt32MaxValue}'. Expected: '2147483648'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderInt32MinValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)-2147483649.0f' was evaluted to '{(long)integerOneDecrementUnderInt32MinValue}'. Expected: '-2147483648'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveInt32MinValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)-2147483647.0f' was evaluted to '{(long)integerOneIncrementAboveInt32MinValue}'. Expected: '-2147483648'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderInt32MaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)2147483646.0f' was evaluted to '{(long)integerOneDecrementUnderInt32MaxValue}'. Expected: '2147483648'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveInt32MaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)2147483648.0f' was evaluted to '{(long)integerOneIncrementAboveInt32MaxValue}'. Expected: '2147483648'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmUInt32MaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)4294967295.0f' was evaluted to '{(long)uInt32MaxValue}'. Expected: '4294967296'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneDecrementUnderUInt32MaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)4.294967E+09f' was evaluted to '{(long)singleOneDecrementUnderUInt32MaxValue}'. Expected: '4294967040'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneIncrementAboveUInt32MaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)4.294968E+09f' was evaluted to '{(long)singleOneIncrementAboveUInt32MaxValue}'. Expected: '4294967808'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneFullIncrementAboveUInt32MaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)4.2949673E+09f' was evaluted to '{(long)singleOneFullIncrementAboveUInt32MaxValue}'. Expected: '4294967296'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderUInt32MaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)4294967294.0f' was evaluted to '{(long)integerOneDecrementUnderUInt32MaxValue}'. Expected: '4294967296'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveUInt32MaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)4294967296.0f' was evaluted to '{(long)integerOneIncrementAboveUInt32MaxValue}'. Expected: '4294967296'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmInt64MinValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)-9223372036854775808.0f' was evaluted to '{(long)int64MinValue}'. Expected: '-9223372036854775808'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneIncrementAboveInt64MinValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)-9.2233715E+18f' was evaluted to '{(long)singleOneIncrementAboveInt64MinValue}'. Expected: '-9223371487098961920'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneDecrementUnderInt64MaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)9.2233715E+18f' was evaluted to '{(long)singleOneDecrementUnderInt64MaxValue}'. Expected: '9223371487098961920'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveInt64MinValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)-9223372036854775807.0f' was evaluted to '{(long)integerOneIncrementAboveInt64MinValue}'. Expected: '-9223372036854775808'."
                );
                _counter++;
            }
        }
    ...
    private static void TestCastingSingleToUInt64()
    {
        ...
        static void ConfirmIntegerZeroCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)0.0f' was evaluted to '{(ulong)integerZero}'. Expected: '0'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmFloatMinusZeroCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)-0f' was evaluted to '{(ulong)floatMinusZero}'. Expected: '0'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmFloatZeroCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)0f' was evaluted to '{(ulong)floatZero}'. Expected: '0'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSByteMaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)127.0f' was evaluted to '{(ulong)sByteMaxValue}'. Expected: '127'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneDecrementUnderSByteMaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)126.99999f' was evaluted to '{(ulong)singleOneDecrementUnderSByteMaxValue}'. Expected: '126'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneFullDecrementUnderSByteMaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)126f' was evaluted to '{(ulong)singleOneFullDecrementUnderSByteMaxValue}'. Expected: '126'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneIncrementAboveSByteMaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)127.00001f' was evaluted to '{(ulong)singleOneIncrementAboveSByteMaxValue}'. Expected: '127'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneFullIncrementAboveSByteMaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)128f' was evaluted to '{(ulong)singleOneFullIncrementAboveSByteMaxValue}'. Expected: '128'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderSByteMaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)126.0f' was evaluted to '{(ulong)integerOneDecrementUnderSByteMaxValue}'. Expected: '126'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveSByteMaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)128.0f' was evaluted to '{(ulong)integerOneIncrementAboveSByteMaxValue}'. Expected: '128'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmByteMaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)255.0f' was evaluted to '{(ulong)byteMaxValue}'. Expected: '255'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneDecrementUnderByteMinValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)-1E-45f' was evaluted to '{(ulong)singleOneDecrementUnderByteMinValue}'. Expected: '0'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneIncrementAboveByteMinValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)1E-45f' was evaluted to '{(ulong)singleOneIncrementAboveByteMinValue}'. Expected: '0'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneFullIncrementAboveByteMinValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)1f' was evaluted to '{(ulong)singleOneFullIncrementAboveByteMinValue}'. Expected: '1'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneDecrementUnderByteMaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)254.99998f' was evaluted to '{(ulong)singleOneDecrementUnderByteMaxValue}'. Expected: '254'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneFullDecrementUnderByteMaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)254f' was evaluted to '{(ulong)singleOneFullDecrementUnderByteMaxValue}'. Expected: '254'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneIncrementAboveByteMaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)255.00002f' was evaluted to '{(ulong)singleOneIncrementAboveByteMaxValue}'. Expected: '255'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneFullIncrementAboveByteMaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)256f' was evaluted to '{(ulong)singleOneFullIncrementAboveByteMaxValue}'. Expected: '256'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveByteMinValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)1.0f' was evaluted to '{(ulong)integerOneIncrementAboveByteMinValue}'. Expected: '1'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderByteMaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)254.0f' was evaluted to '{(ulong)integerOneDecrementUnderByteMaxValue}'. Expected: '254'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveByteMaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)256.0f' was evaluted to '{(ulong)integerOneIncrementAboveByteMaxValue}'. Expected: '256'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmInt16MaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)32767.0f' was evaluted to '{(ulong)int16MaxValue}'. Expected: '32767'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneDecrementUnderInt16MaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)32766.998f' was evaluted to '{(ulong)singleOneDecrementUnderInt16MaxValue}'. Expected: '32766'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneFullDecrementUnderInt16MaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)32766f' was evaluted to '{(ulong)singleOneFullDecrementUnderInt16MaxValue}'. Expected: '32766'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneIncrementAboveInt16MaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)32767.002f' was evaluted to '{(ulong)singleOneIncrementAboveInt16MaxValue}'. Expected: '32767'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneFullIncrementAboveInt16MaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)32768f' was evaluted to '{(ulong)singleOneFullIncrementAboveInt16MaxValue}'. Expected: '32768'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderInt16MaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)32766.0f' was evaluted to '{(ulong)integerOneDecrementUnderInt16MaxValue}'. Expected: '32766'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveInt16MaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)32768.0f' was evaluted to '{(ulong)integerOneIncrementAboveInt16MaxValue}'. Expected: '32768'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmUInt16MaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)65535.0f' was evaluted to '{(ulong)uInt16MaxValue}'. Expected: '65535'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneDecrementUnderUInt16MaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)65534.996f' was evaluted to '{(ulong)singleOneDecrementUnderUInt16MaxValue}'. Expected: '65534'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneFullDecrementUnderUInt16MaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)65534f' was evaluted to '{(ulong)singleOneFullDecrementUnderUInt16MaxValue}'. Expected: '65534'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneIncrementAboveUInt16MaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)65535.004f' was evaluted to '{(ulong)singleOneIncrementAboveUInt16MaxValue}'. Expected: '65535'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneFullIncrementAboveUInt16MaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)65536f' was evaluted to '{(ulong)singleOneFullIncrementAboveUInt16MaxValue}'. Expected: '65536'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderUInt16MaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)65534.0f' was evaluted to '{(ulong)integerOneDecrementUnderUInt16MaxValue}'. Expected: '65534'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveUInt16MaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)65536.0f' was evaluted to '{(ulong)integerOneIncrementAboveUInt16MaxValue}'. Expected: '65536'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmInt32MaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)2147483647.0f' was evaluted to '{(ulong)int32MaxValue}'. Expected: '2147483648'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneDecrementUnderInt32MaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)2.1474835E+09f' was evaluted to '{(ulong)singleOneDecrementUnderInt32MaxValue}'. Expected: '2147483520'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneIncrementAboveInt32MaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)2.147484E+09f' was evaluted to '{(ulong)singleOneIncrementAboveInt32MaxValue}'. Expected: '2147483904'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneFullIncrementAboveInt32MaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)2.1474836E+09f' was evaluted to '{(ulong)singleOneFullIncrementAboveInt32MaxValue}'. Expected: '2147483648'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderInt32MaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)2147483646.0f' was evaluted to '{(ulong)integerOneDecrementUnderInt32MaxValue}'. Expected: '2147483648'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveInt32MaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)2147483648.0f' was evaluted to '{(ulong)integerOneIncrementAboveInt32MaxValue}'. Expected: '2147483648'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmUInt32MaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)4294967295.0f' was evaluted to '{(ulong)uInt32MaxValue}'. Expected: '4294967296'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneDecrementUnderUInt32MaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)4.294967E+09f' was evaluted to '{(ulong)singleOneDecrementUnderUInt32MaxValue}'. Expected: '4294967040'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneIncrementAboveUInt32MaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)4.294968E+09f' was evaluted to '{(ulong)singleOneIncrementAboveUInt32MaxValue}'. Expected: '4294967808'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneFullIncrementAboveUInt32MaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)4.2949673E+09f' was evaluted to '{(ulong)singleOneFullIncrementAboveUInt32MaxValue}'. Expected: '4294967296'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderUInt32MaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)4294967294.0f' was evaluted to '{(ulong)integerOneDecrementUnderUInt32MaxValue}'. Expected: '4294967296'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveUInt32MaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)4294967296.0f' was evaluted to '{(ulong)integerOneIncrementAboveUInt32MaxValue}'. Expected: '4294967296'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmInt64MaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)9223372036854775807.0f' was evaluted to '{(ulong)int64MaxValue}'. Expected: '9223372036854775808'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneDecrementUnderInt64MaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)9.2233715E+18f' was evaluted to '{(ulong)singleOneDecrementUnderInt64MaxValue}'. Expected: '9223371487098961920'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneIncrementAboveInt64MaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)9.223373E+18f' was evaluted to '{(ulong)singleOneIncrementAboveInt64MaxValue}'. Expected: '9223373136366403584'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneFullIncrementAboveInt64MaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)9.223372E+18f' was evaluted to '{(ulong)singleOneFullIncrementAboveInt64MaxValue}'. Expected: '9223372036854775808'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderInt64MaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)9223372036854775806.0f' was evaluted to '{(ulong)integerOneDecrementUnderInt64MaxValue}'. Expected: '9223372036854775808'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveInt64MaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)9223372036854775808.0f' was evaluted to '{(ulong)integerOneIncrementAboveInt64MaxValue}'. Expected: '9223372036854775808'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSingleOneDecrementUnderUInt64MaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)1.8446743E+19f' was evaluted to '{(ulong)singleOneDecrementUnderUInt64MaxValue}'. Expected: '18446742974197923840'."
                );
                _counter++;
            }
        }
