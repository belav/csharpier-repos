...
public partial class ValueNumberingCheckedCastsOfConstants
{
    private static void TestCastingDoubleToSByte()
    {
        ...
        static void ConfirmIntegerZeroCastToSByteIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(sbyte)0.0' was evaluated to '{(sbyte)integerZero}'. Expected: '0'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleMinusZeroCastToSByteIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(sbyte)-0d' was evaluated to '{(sbyte)doubleMinusZero}'. Expected: '0'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleZeroCastToSByteIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(sbyte)0d' was evaluated to '{(sbyte)doubleZero}'. Expected: '0'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleMinValueCastToSByteOverflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((sbyte)-1.7976931348623157E+308d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmSByteMinValueCastToSByteIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(sbyte)-128.0' was evaluated to '{(sbyte)sByteMinValue}'. Expected: '-128'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSByteMaxValueCastToSByteIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(sbyte)127.0' was evaluated to '{(sbyte)sByteMaxValue}'. Expected: '127'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneDecrementUnderSByteMinValueCastToSByteIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(sbyte)-128.00000000000003d' was evaluated to '{(sbyte)doubleOneDecrementUnderSByteMinValue}'. Expected: '-128'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneIncrementAboveSByteMinValueCastToSByteIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(sbyte)-127.99999999999999d' was evaluated to '{(sbyte)doubleOneIncrementAboveSByteMinValue}'. Expected: '-127'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneFullIncrementAboveSByteMinValueCastToSByteIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(sbyte)-127d' was evaluated to '{(sbyte)doubleOneFullIncrementAboveSByteMinValue}'. Expected: '-127'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneDecrementUnderSByteMaxValueCastToSByteIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(sbyte)126.99999999999999d' was evaluated to '{(sbyte)doubleOneDecrementUnderSByteMaxValue}'. Expected: '126'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneFullDecrementUnderSByteMaxValueCastToSByteIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(sbyte)126d' was evaluated to '{(sbyte)doubleOneFullDecrementUnderSByteMaxValue}'. Expected: '126'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneIncrementAboveSByteMaxValueCastToSByteIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(sbyte)127.00000000000001d' was evaluated to '{(sbyte)doubleOneIncrementAboveSByteMaxValue}'. Expected: '127'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveSByteMinValueCastToSByteIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(sbyte)-127.0' was evaluated to '{(sbyte)integerOneIncrementAboveSByteMinValue}'. Expected: '-127'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderSByteMaxValueCastToSByteIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(sbyte)126.0' was evaluated to '{(sbyte)integerOneDecrementUnderSByteMaxValue}'. Expected: '126'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneDecrementUnderByteMinValueCastToSByteIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(sbyte)-5E-324d' was evaluated to '{(sbyte)doubleOneDecrementUnderByteMinValue}'. Expected: '0'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneFullDecrementUnderByteMinValueCastToSByteIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(sbyte)-1d' was evaluated to '{(sbyte)doubleOneFullDecrementUnderByteMinValue}'. Expected: '-1'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneIncrementAboveByteMinValueCastToSByteIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(sbyte)5E-324d' was evaluated to '{(sbyte)doubleOneIncrementAboveByteMinValue}'. Expected: '0'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneFullIncrementAboveByteMinValueCastToSByteIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(sbyte)1d' was evaluated to '{(sbyte)doubleOneFullIncrementAboveByteMinValue}'. Expected: '1'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneDecrementUnderByteMaxValueCastToSByteOverflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((sbyte)254.99999999999997d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneIncrementAboveByteMaxValueCastToSByteOverflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((sbyte)255.00000000000003d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmIntegerOneDecrementUnderByteMinValueCastToSByteIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(sbyte)-1.0' was evaluated to '{(sbyte)integerOneDecrementUnderByteMinValue}'. Expected: '-1'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveByteMinValueCastToSByteIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(sbyte)1.0' was evaluated to '{(sbyte)integerOneIncrementAboveByteMinValue}'. Expected: '1'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneDecrementUnderInt16MinValueCastToSByteOverflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((sbyte)-32768.00000000001d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneIncrementAboveInt16MinValueCastToSByteOverflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((sbyte)-32767.999999999996d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneDecrementUnderInt16MaxValueCastToSByteOverflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((sbyte)32766.999999999996d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneIncrementAboveInt16MaxValueCastToSByteOverflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((sbyte)32767.000000000004d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneDecrementUnderUInt16MaxValueCastToSByteOverflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((sbyte)65534.99999999999d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneIncrementAboveUInt16MaxValueCastToSByteOverflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((sbyte)65535.00000000001d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmInt32MinValueCastToSByteOverflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((sbyte)-2147483648.0)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmInt32MaxValueCastToSByteOverflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((sbyte)2147483647.0)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneDecrementUnderInt32MinValueCastToSByteOverflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((sbyte)-2147483648.0000005d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneFullDecrementUnderInt32MinValueCastToSByteOverflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((sbyte)-2147483649d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneIncrementAboveInt32MinValueCastToSByteOverflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((sbyte)-2147483647.9999998d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneFullIncrementAboveInt32MinValueCastToSByteOverflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((sbyte)-2147483647d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneDecrementUnderInt32MaxValueCastToSByteOverflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((sbyte)2147483646.9999998d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneIncrementAboveInt32MaxValueCastToSByteOverflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((sbyte)2147483647.0000002d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmIntegerOneDecrementUnderInt32MinValueCastToSByteOverflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((sbyte)-2147483649.0)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmIntegerOneDecrementUnderInt32MaxValueCastToSByteOverflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((sbyte)2147483646.0)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmUInt32MaxValueCastToSByteOverflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((sbyte)4294967295.0)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneDecrementUnderUInt32MaxValueCastToSByteOverflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((sbyte)4294967294.9999995d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneIncrementAboveUInt32MaxValueCastToSByteOverflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((sbyte)4294967295.0000005d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmIntegerOneDecrementUnderUInt32MaxValueCastToSByteOverflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((sbyte)4294967294.0)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmIntegerOneIncrementAboveUInt32MaxValueCastToSByteOverflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((sbyte)4294967296.0)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmInt64MinValueCastToSByteOverflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((sbyte)-9223372036854775808.0)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmInt64MaxValueCastToSByteOverflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((sbyte)9223372036854775807.0)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneIncrementAboveInt64MinValueCastToSByteOverflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((sbyte)-9.223372036854775E+18d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneIncrementAboveInt64MaxValueCastToSByteOverflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((sbyte)9.223372036854778E+18d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneFullIncrementAboveInt64MaxValueCastToSByteOverflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((sbyte)9.223372036854776E+18d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmIntegerOneDecrementUnderInt64MaxValueCastToSByteOverflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((sbyte)9223372036854775806.0)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmUInt64MaxValueCastToSByteOverflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((sbyte)18446744073709551615.0)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneDecrementUnderUInt64MaxValueCastToSByteOverflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((sbyte)1.844674407370955E+19d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmIntegerOneDecrementUnderUInt64MaxValueCastToSByteOverflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((sbyte)18446744073709551614.0)' did not throw OverflowException."
                );
        }
    }
    ...
    private static void TestCastingDoubleToByte()
    {
        ...
        static void ConfirmIntegerZeroCastToByteIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(byte)0.0' was evaluated to '{(byte)integerZero}'. Expected: '0'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleMinusZeroCastToByteIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(byte)-0d' was evaluated to '{(byte)doubleMinusZero}'. Expected: '0'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleZeroCastToByteIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(byte)0d' was evaluated to '{(byte)doubleZero}'. Expected: '0'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleMinValueCastToByteOverflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((byte)-1.7976931348623157E+308d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmSByteMaxValueCastToByteIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(byte)127.0' was evaluated to '{(byte)sByteMaxValue}'. Expected: '127'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneDecrementUnderSByteMinValueCastToByteOverflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((byte)-128.00000000000003d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneIncrementAboveSByteMinValueCastToByteOverflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((byte)-127.99999999999999d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneDecrementUnderSByteMaxValueCastToByteIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(byte)126.99999999999999d' was evaluated to '{(byte)doubleOneDecrementUnderSByteMaxValue}'. Expected: '126'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneFullDecrementUnderSByteMaxValueCastToByteIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(byte)126d' was evaluated to '{(byte)doubleOneFullDecrementUnderSByteMaxValue}'. Expected: '126'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneIncrementAboveSByteMaxValueCastToByteIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(byte)127.00000000000001d' was evaluated to '{(byte)doubleOneIncrementAboveSByteMaxValue}'. Expected: '127'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneFullIncrementAboveSByteMaxValueCastToByteIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(byte)128d' was evaluated to '{(byte)doubleOneFullIncrementAboveSByteMaxValue}'. Expected: '128'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderSByteMaxValueCastToByteIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(byte)126.0' was evaluated to '{(byte)integerOneDecrementUnderSByteMaxValue}'. Expected: '126'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveSByteMaxValueCastToByteIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(byte)128.0' was evaluated to '{(byte)integerOneIncrementAboveSByteMaxValue}'. Expected: '128'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmByteMaxValueCastToByteIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(byte)255.0' was evaluated to '{(byte)byteMaxValue}'. Expected: '255'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneDecrementUnderByteMinValueCastToByteIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(byte)-5E-324d' was evaluated to '{(byte)doubleOneDecrementUnderByteMinValue}'. Expected: '0'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneIncrementAboveByteMinValueCastToByteIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(byte)5E-324d' was evaluated to '{(byte)doubleOneIncrementAboveByteMinValue}'. Expected: '0'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneFullIncrementAboveByteMinValueCastToByteIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(byte)1d' was evaluated to '{(byte)doubleOneFullIncrementAboveByteMinValue}'. Expected: '1'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneDecrementUnderByteMaxValueCastToByteIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(byte)254.99999999999997d' was evaluated to '{(byte)doubleOneDecrementUnderByteMaxValue}'. Expected: '254'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneFullDecrementUnderByteMaxValueCastToByteIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(byte)254d' was evaluated to '{(byte)doubleOneFullDecrementUnderByteMaxValue}'. Expected: '254'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneIncrementAboveByteMaxValueCastToByteIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(byte)255.00000000000003d' was evaluated to '{(byte)doubleOneIncrementAboveByteMaxValue}'. Expected: '255'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveByteMinValueCastToByteIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(byte)1.0' was evaluated to '{(byte)integerOneIncrementAboveByteMinValue}'. Expected: '1'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderByteMaxValueCastToByteIsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(byte)254.0' was evaluated to '{(byte)integerOneDecrementUnderByteMaxValue}'. Expected: '254'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneDecrementUnderInt16MinValueCastToByteOverflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((byte)-32768.00000000001d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneIncrementAboveInt16MinValueCastToByteOverflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((byte)-32767.999999999996d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneDecrementUnderInt16MaxValueCastToByteOverflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((byte)32766.999999999996d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneIncrementAboveInt16MaxValueCastToByteOverflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((byte)32767.000000000004d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneDecrementUnderUInt16MaxValueCastToByteOverflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((byte)65534.99999999999d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneIncrementAboveUInt16MaxValueCastToByteOverflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((byte)65535.00000000001d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmInt32MinValueCastToByteOverflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((byte)-2147483648.0)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneDecrementUnderInt32MinValueCastToByteOverflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((byte)-2147483648.0000005d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneIncrementAboveInt32MinValueCastToByteOverflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((byte)-2147483647.9999998d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneDecrementUnderInt32MaxValueCastToByteOverflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((byte)2147483646.9999998d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneIncrementAboveInt32MaxValueCastToByteOverflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((byte)2147483647.0000002d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmIntegerOneDecrementUnderInt32MinValueCastToByteOverflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((byte)-2147483649.0)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmIntegerOneIncrementAboveInt32MinValueCastToByteOverflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((byte)-2147483647.0)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneDecrementUnderUInt32MaxValueCastToByteOverflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((byte)4294967294.9999995d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneIncrementAboveUInt32MaxValueCastToByteOverflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((byte)4294967295.0000005d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmInt64MinValueCastToByteOverflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((byte)-9223372036854775808.0)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmInt64MaxValueCastToByteOverflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((byte)9223372036854775807.0)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneIncrementAboveInt64MinValueCastToByteOverflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((byte)-9.223372036854775E+18d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneIncrementAboveInt64MaxValueCastToByteOverflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((byte)9.223372036854778E+18d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneFullIncrementAboveInt64MaxValueCastToByteOverflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((byte)9.223372036854776E+18d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmIntegerOneDecrementUnderInt64MaxValueCastToByteOverflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((byte)9223372036854775806.0)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmUInt64MaxValueCastToByteOverflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((byte)18446744073709551615.0)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneDecrementUnderUInt64MaxValueCastToByteOverflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((byte)1.844674407370955E+19d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmIntegerOneDecrementUnderUInt64MaxValueCastToByteOverflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((byte)18446744073709551614.0)' did not throw OverflowException."
                );
        }
    }
    ...
    private static void TestCastingDoubleToInt16()
    {
        ...
        static void ConfirmIntegerZeroCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)0.0' was evaluated to '{(short)integerZero}'. Expected: '0'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleMinusZeroCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)-0d' was evaluated to '{(short)doubleMinusZero}'. Expected: '0'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleZeroCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)0d' was evaluated to '{(short)doubleZero}'. Expected: '0'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleMinValueCastToInt16Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((short)-1.7976931348623157E+308d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmSByteMinValueCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)-128.0' was evaluated to '{(short)sByteMinValue}'. Expected: '-128'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSByteMaxValueCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)127.0' was evaluated to '{(short)sByteMaxValue}'. Expected: '127'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneDecrementUnderSByteMinValueCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)-128.00000000000003d' was evaluated to '{(short)doubleOneDecrementUnderSByteMinValue}'. Expected: '-128'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneFullDecrementUnderSByteMinValueCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)-129d' was evaluated to '{(short)doubleOneFullDecrementUnderSByteMinValue}'. Expected: '-129'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneIncrementAboveSByteMinValueCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)-127.99999999999999d' was evaluated to '{(short)doubleOneIncrementAboveSByteMinValue}'. Expected: '-127'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneFullIncrementAboveSByteMinValueCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)-127d' was evaluated to '{(short)doubleOneFullIncrementAboveSByteMinValue}'. Expected: '-127'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneDecrementUnderSByteMaxValueCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)126.99999999999999d' was evaluated to '{(short)doubleOneDecrementUnderSByteMaxValue}'. Expected: '126'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneFullDecrementUnderSByteMaxValueCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)126d' was evaluated to '{(short)doubleOneFullDecrementUnderSByteMaxValue}'. Expected: '126'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneIncrementAboveSByteMaxValueCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)127.00000000000001d' was evaluated to '{(short)doubleOneIncrementAboveSByteMaxValue}'. Expected: '127'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneFullIncrementAboveSByteMaxValueCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)128d' was evaluated to '{(short)doubleOneFullIncrementAboveSByteMaxValue}'. Expected: '128'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderSByteMinValueCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)-129.0' was evaluated to '{(short)integerOneDecrementUnderSByteMinValue}'. Expected: '-129'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveSByteMinValueCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)-127.0' was evaluated to '{(short)integerOneIncrementAboveSByteMinValue}'. Expected: '-127'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderSByteMaxValueCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)126.0' was evaluated to '{(short)integerOneDecrementUnderSByteMaxValue}'. Expected: '126'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveSByteMaxValueCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)128.0' was evaluated to '{(short)integerOneIncrementAboveSByteMaxValue}'. Expected: '128'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmByteMaxValueCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)255.0' was evaluated to '{(short)byteMaxValue}'. Expected: '255'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneDecrementUnderByteMinValueCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)-5E-324d' was evaluated to '{(short)doubleOneDecrementUnderByteMinValue}'. Expected: '0'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneFullDecrementUnderByteMinValueCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)-1d' was evaluated to '{(short)doubleOneFullDecrementUnderByteMinValue}'. Expected: '-1'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneIncrementAboveByteMinValueCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)5E-324d' was evaluated to '{(short)doubleOneIncrementAboveByteMinValue}'. Expected: '0'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneFullIncrementAboveByteMinValueCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)1d' was evaluated to '{(short)doubleOneFullIncrementAboveByteMinValue}'. Expected: '1'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneDecrementUnderByteMaxValueCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)254.99999999999997d' was evaluated to '{(short)doubleOneDecrementUnderByteMaxValue}'. Expected: '254'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneFullDecrementUnderByteMaxValueCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)254d' was evaluated to '{(short)doubleOneFullDecrementUnderByteMaxValue}'. Expected: '254'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneIncrementAboveByteMaxValueCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)255.00000000000003d' was evaluated to '{(short)doubleOneIncrementAboveByteMaxValue}'. Expected: '255'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneFullIncrementAboveByteMaxValueCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)256d' was evaluated to '{(short)doubleOneFullIncrementAboveByteMaxValue}'. Expected: '256'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderByteMinValueCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)-1.0' was evaluated to '{(short)integerOneDecrementUnderByteMinValue}'. Expected: '-1'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveByteMinValueCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)1.0' was evaluated to '{(short)integerOneIncrementAboveByteMinValue}'. Expected: '1'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderByteMaxValueCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)254.0' was evaluated to '{(short)integerOneDecrementUnderByteMaxValue}'. Expected: '254'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveByteMaxValueCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)256.0' was evaluated to '{(short)integerOneIncrementAboveByteMaxValue}'. Expected: '256'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmInt16MinValueCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)-32768.0' was evaluated to '{(short)int16MinValue}'. Expected: '-32768'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmInt16MaxValueCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)32767.0' was evaluated to '{(short)int16MaxValue}'. Expected: '32767'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneDecrementUnderInt16MinValueCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)-32768.00000000001d' was evaluated to '{(short)doubleOneDecrementUnderInt16MinValue}'. Expected: '-32768'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneIncrementAboveInt16MinValueCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)-32767.999999999996d' was evaluated to '{(short)doubleOneIncrementAboveInt16MinValue}'. Expected: '-32767'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneFullIncrementAboveInt16MinValueCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)-32767d' was evaluated to '{(short)doubleOneFullIncrementAboveInt16MinValue}'. Expected: '-32767'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneDecrementUnderInt16MaxValueCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)32766.999999999996d' was evaluated to '{(short)doubleOneDecrementUnderInt16MaxValue}'. Expected: '32766'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneFullDecrementUnderInt16MaxValueCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)32766d' was evaluated to '{(short)doubleOneFullDecrementUnderInt16MaxValue}'. Expected: '32766'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneIncrementAboveInt16MaxValueCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)32767.000000000004d' was evaluated to '{(short)doubleOneIncrementAboveInt16MaxValue}'. Expected: '32767'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveInt16MinValueCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)-32767.0' was evaluated to '{(short)integerOneIncrementAboveInt16MinValue}'. Expected: '-32767'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderInt16MaxValueCastToInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(short)32766.0' was evaluated to '{(short)integerOneDecrementUnderInt16MaxValue}'. Expected: '32766'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneDecrementUnderUInt16MaxValueCastToInt16Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((short)65534.99999999999d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneIncrementAboveUInt16MaxValueCastToInt16Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((short)65535.00000000001d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmInt32MinValueCastToInt16Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((short)-2147483648.0)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmInt32MaxValueCastToInt16Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((short)2147483647.0)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneDecrementUnderInt32MinValueCastToInt16Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((short)-2147483648.0000005d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneFullDecrementUnderInt32MinValueCastToInt16Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((short)-2147483649d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneIncrementAboveInt32MinValueCastToInt16Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((short)-2147483647.9999998d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneFullIncrementAboveInt32MinValueCastToInt16Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((short)-2147483647d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneDecrementUnderInt32MaxValueCastToInt16Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((short)2147483646.9999998d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneIncrementAboveInt32MaxValueCastToInt16Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((short)2147483647.0000002d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmIntegerOneDecrementUnderInt32MinValueCastToInt16Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((short)-2147483649.0)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmIntegerOneDecrementUnderInt32MaxValueCastToInt16Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((short)2147483646.0)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmUInt32MaxValueCastToInt16Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((short)4294967295.0)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneDecrementUnderUInt32MaxValueCastToInt16Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((short)4294967294.9999995d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneIncrementAboveUInt32MaxValueCastToInt16Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((short)4294967295.0000005d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmIntegerOneDecrementUnderUInt32MaxValueCastToInt16Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((short)4294967294.0)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmIntegerOneIncrementAboveUInt32MaxValueCastToInt16Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((short)4294967296.0)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmInt64MinValueCastToInt16Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((short)-9223372036854775808.0)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmInt64MaxValueCastToInt16Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((short)9223372036854775807.0)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneIncrementAboveInt64MinValueCastToInt16Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((short)-9.223372036854775E+18d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneIncrementAboveInt64MaxValueCastToInt16Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((short)9.223372036854778E+18d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneFullIncrementAboveInt64MaxValueCastToInt16Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((short)9.223372036854776E+18d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmIntegerOneDecrementUnderInt64MaxValueCastToInt16Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((short)9223372036854775806.0)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmUInt64MaxValueCastToInt16Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((short)18446744073709551615.0)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneDecrementUnderUInt64MaxValueCastToInt16Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((short)1.844674407370955E+19d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmIntegerOneDecrementUnderUInt64MaxValueCastToInt16Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((short)18446744073709551614.0)' did not throw OverflowException."
                );
        }
    }
    ...
    private static void TestCastingDoubleToUInt16()
    {
        ...
        static void ConfirmIntegerZeroCastToUInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ushort)0.0' was evaluated to '{(ushort)integerZero}'. Expected: '0'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleMinusZeroCastToUInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ushort)-0d' was evaluated to '{(ushort)doubleMinusZero}'. Expected: '0'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleZeroCastToUInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ushort)0d' was evaluated to '{(ushort)doubleZero}'. Expected: '0'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleMinValueCastToUInt16Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((ushort)-1.7976931348623157E+308d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmSByteMaxValueCastToUInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ushort)127.0' was evaluated to '{(ushort)sByteMaxValue}'. Expected: '127'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneDecrementUnderSByteMinValueCastToUInt16Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((ushort)-128.00000000000003d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneIncrementAboveSByteMinValueCastToUInt16Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((ushort)-127.99999999999999d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneDecrementUnderSByteMaxValueCastToUInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ushort)126.99999999999999d' was evaluated to '{(ushort)doubleOneDecrementUnderSByteMaxValue}'. Expected: '126'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneFullDecrementUnderSByteMaxValueCastToUInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ushort)126d' was evaluated to '{(ushort)doubleOneFullDecrementUnderSByteMaxValue}'. Expected: '126'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneIncrementAboveSByteMaxValueCastToUInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ushort)127.00000000000001d' was evaluated to '{(ushort)doubleOneIncrementAboveSByteMaxValue}'. Expected: '127'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneFullIncrementAboveSByteMaxValueCastToUInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ushort)128d' was evaluated to '{(ushort)doubleOneFullIncrementAboveSByteMaxValue}'. Expected: '128'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderSByteMaxValueCastToUInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ushort)126.0' was evaluated to '{(ushort)integerOneDecrementUnderSByteMaxValue}'. Expected: '126'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveSByteMaxValueCastToUInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ushort)128.0' was evaluated to '{(ushort)integerOneIncrementAboveSByteMaxValue}'. Expected: '128'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmByteMaxValueCastToUInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ushort)255.0' was evaluated to '{(ushort)byteMaxValue}'. Expected: '255'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneDecrementUnderByteMinValueCastToUInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ushort)-5E-324d' was evaluated to '{(ushort)doubleOneDecrementUnderByteMinValue}'. Expected: '0'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneIncrementAboveByteMinValueCastToUInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ushort)5E-324d' was evaluated to '{(ushort)doubleOneIncrementAboveByteMinValue}'. Expected: '0'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneFullIncrementAboveByteMinValueCastToUInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ushort)1d' was evaluated to '{(ushort)doubleOneFullIncrementAboveByteMinValue}'. Expected: '1'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneDecrementUnderByteMaxValueCastToUInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ushort)254.99999999999997d' was evaluated to '{(ushort)doubleOneDecrementUnderByteMaxValue}'. Expected: '254'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneFullDecrementUnderByteMaxValueCastToUInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ushort)254d' was evaluated to '{(ushort)doubleOneFullDecrementUnderByteMaxValue}'. Expected: '254'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneIncrementAboveByteMaxValueCastToUInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ushort)255.00000000000003d' was evaluated to '{(ushort)doubleOneIncrementAboveByteMaxValue}'. Expected: '255'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneFullIncrementAboveByteMaxValueCastToUInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ushort)256d' was evaluated to '{(ushort)doubleOneFullIncrementAboveByteMaxValue}'. Expected: '256'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveByteMinValueCastToUInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ushort)1.0' was evaluated to '{(ushort)integerOneIncrementAboveByteMinValue}'. Expected: '1'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderByteMaxValueCastToUInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ushort)254.0' was evaluated to '{(ushort)integerOneDecrementUnderByteMaxValue}'. Expected: '254'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveByteMaxValueCastToUInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ushort)256.0' was evaluated to '{(ushort)integerOneIncrementAboveByteMaxValue}'. Expected: '256'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmInt16MaxValueCastToUInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ushort)32767.0' was evaluated to '{(ushort)int16MaxValue}'. Expected: '32767'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneDecrementUnderInt16MinValueCastToUInt16Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((ushort)-32768.00000000001d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneIncrementAboveInt16MinValueCastToUInt16Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((ushort)-32767.999999999996d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneDecrementUnderInt16MaxValueCastToUInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ushort)32766.999999999996d' was evaluated to '{(ushort)doubleOneDecrementUnderInt16MaxValue}'. Expected: '32766'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneFullDecrementUnderInt16MaxValueCastToUInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ushort)32766d' was evaluated to '{(ushort)doubleOneFullDecrementUnderInt16MaxValue}'. Expected: '32766'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneIncrementAboveInt16MaxValueCastToUInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ushort)32767.000000000004d' was evaluated to '{(ushort)doubleOneIncrementAboveInt16MaxValue}'. Expected: '32767'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneFullIncrementAboveInt16MaxValueCastToUInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ushort)32768d' was evaluated to '{(ushort)doubleOneFullIncrementAboveInt16MaxValue}'. Expected: '32768'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderInt16MaxValueCastToUInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ushort)32766.0' was evaluated to '{(ushort)integerOneDecrementUnderInt16MaxValue}'. Expected: '32766'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveInt16MaxValueCastToUInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ushort)32768.0' was evaluated to '{(ushort)integerOneIncrementAboveInt16MaxValue}'. Expected: '32768'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmUInt16MaxValueCastToUInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ushort)65535.0' was evaluated to '{(ushort)uInt16MaxValue}'. Expected: '65535'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneDecrementUnderUInt16MaxValueCastToUInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ushort)65534.99999999999d' was evaluated to '{(ushort)doubleOneDecrementUnderUInt16MaxValue}'. Expected: '65534'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneFullDecrementUnderUInt16MaxValueCastToUInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ushort)65534d' was evaluated to '{(ushort)doubleOneFullDecrementUnderUInt16MaxValue}'. Expected: '65534'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneIncrementAboveUInt16MaxValueCastToUInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ushort)65535.00000000001d' was evaluated to '{(ushort)doubleOneIncrementAboveUInt16MaxValue}'. Expected: '65535'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderUInt16MaxValueCastToUInt16IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ushort)65534.0' was evaluated to '{(ushort)integerOneDecrementUnderUInt16MaxValue}'. Expected: '65534'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmInt32MinValueCastToUInt16Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((ushort)-2147483648.0)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmInt32MaxValueCastToUInt16Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((ushort)2147483647.0)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneDecrementUnderInt32MinValueCastToUInt16Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((ushort)-2147483648.0000005d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneFullDecrementUnderInt32MinValueCastToUInt16Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((ushort)-2147483649d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneIncrementAboveInt32MinValueCastToUInt16Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((ushort)-2147483647.9999998d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneFullIncrementAboveInt32MinValueCastToUInt16Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((ushort)-2147483647d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneDecrementUnderInt32MaxValueCastToUInt16Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((ushort)2147483646.9999998d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneFullDecrementUnderInt32MaxValueCastToUInt16Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((ushort)2147483646d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneIncrementAboveInt32MaxValueCastToUInt16Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((ushort)2147483647.0000002d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneFullIncrementAboveInt32MaxValueCastToUInt16Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((ushort)2147483648d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmIntegerOneDecrementUnderInt32MinValueCastToUInt16Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((ushort)-2147483649.0)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmIntegerOneDecrementUnderInt32MaxValueCastToUInt16Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((ushort)2147483646.0)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmUInt32MaxValueCastToUInt16Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((ushort)4294967295.0)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneDecrementUnderUInt32MaxValueCastToUInt16Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((ushort)4294967294.9999995d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneFullDecrementUnderUInt32MaxValueCastToUInt16Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((ushort)4294967294d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneIncrementAboveUInt32MaxValueCastToUInt16Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((ushort)4294967295.0000005d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneFullIncrementAboveUInt32MaxValueCastToUInt16Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((ushort)4294967296d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmIntegerOneDecrementUnderUInt32MaxValueCastToUInt16Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((ushort)4294967294.0)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmIntegerOneIncrementAboveUInt32MaxValueCastToUInt16Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((ushort)4294967296.0)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmInt64MinValueCastToUInt16Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((ushort)-9223372036854775808.0)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmInt64MaxValueCastToUInt16Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((ushort)9223372036854775807.0)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneIncrementAboveInt64MinValueCastToUInt16Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((ushort)-9.223372036854775E+18d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneIncrementAboveInt64MaxValueCastToUInt16Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((ushort)9.223372036854778E+18d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneFullIncrementAboveInt64MaxValueCastToUInt16Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((ushort)9.223372036854776E+18d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmIntegerOneDecrementUnderInt64MaxValueCastToUInt16Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((ushort)9223372036854775806.0)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmUInt64MaxValueCastToUInt16Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((ushort)18446744073709551615.0)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneDecrementUnderUInt64MaxValueCastToUInt16Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((ushort)1.844674407370955E+19d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmIntegerOneDecrementUnderUInt64MaxValueCastToUInt16Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((ushort)18446744073709551614.0)' did not throw OverflowException."
                );
        }
    }
    ...
    private static void TestCastingDoubleToInt32()
    {
        ...
        static void ConfirmIntegerZeroCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)0.0' was evaluated to '{(int)integerZero}'. Expected: '0'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleMinusZeroCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)-0d' was evaluated to '{(int)doubleMinusZero}'. Expected: '0'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleZeroCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)0d' was evaluated to '{(int)doubleZero}'. Expected: '0'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleMinValueCastToInt32Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((int)-1.7976931348623157E+308d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmSByteMinValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)-128.0' was evaluated to '{(int)sByteMinValue}'. Expected: '-128'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSByteMaxValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)127.0' was evaluated to '{(int)sByteMaxValue}'. Expected: '127'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneDecrementUnderSByteMinValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)-128.00000000000003d' was evaluated to '{(int)doubleOneDecrementUnderSByteMinValue}'. Expected: '-128'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneFullDecrementUnderSByteMinValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)-129d' was evaluated to '{(int)doubleOneFullDecrementUnderSByteMinValue}'. Expected: '-129'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneIncrementAboveSByteMinValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)-127.99999999999999d' was evaluated to '{(int)doubleOneIncrementAboveSByteMinValue}'. Expected: '-127'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneFullIncrementAboveSByteMinValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)-127d' was evaluated to '{(int)doubleOneFullIncrementAboveSByteMinValue}'. Expected: '-127'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneDecrementUnderSByteMaxValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)126.99999999999999d' was evaluated to '{(int)doubleOneDecrementUnderSByteMaxValue}'. Expected: '126'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneFullDecrementUnderSByteMaxValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)126d' was evaluated to '{(int)doubleOneFullDecrementUnderSByteMaxValue}'. Expected: '126'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneIncrementAboveSByteMaxValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)127.00000000000001d' was evaluated to '{(int)doubleOneIncrementAboveSByteMaxValue}'. Expected: '127'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneFullIncrementAboveSByteMaxValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)128d' was evaluated to '{(int)doubleOneFullIncrementAboveSByteMaxValue}'. Expected: '128'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderSByteMinValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)-129.0' was evaluated to '{(int)integerOneDecrementUnderSByteMinValue}'. Expected: '-129'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveSByteMinValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)-127.0' was evaluated to '{(int)integerOneIncrementAboveSByteMinValue}'. Expected: '-127'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderSByteMaxValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)126.0' was evaluated to '{(int)integerOneDecrementUnderSByteMaxValue}'. Expected: '126'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveSByteMaxValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)128.0' was evaluated to '{(int)integerOneIncrementAboveSByteMaxValue}'. Expected: '128'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmByteMaxValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)255.0' was evaluated to '{(int)byteMaxValue}'. Expected: '255'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneDecrementUnderByteMinValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)-5E-324d' was evaluated to '{(int)doubleOneDecrementUnderByteMinValue}'. Expected: '0'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneFullDecrementUnderByteMinValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)-1d' was evaluated to '{(int)doubleOneFullDecrementUnderByteMinValue}'. Expected: '-1'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneIncrementAboveByteMinValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)5E-324d' was evaluated to '{(int)doubleOneIncrementAboveByteMinValue}'. Expected: '0'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneFullIncrementAboveByteMinValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)1d' was evaluated to '{(int)doubleOneFullIncrementAboveByteMinValue}'. Expected: '1'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneDecrementUnderByteMaxValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)254.99999999999997d' was evaluated to '{(int)doubleOneDecrementUnderByteMaxValue}'. Expected: '254'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneFullDecrementUnderByteMaxValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)254d' was evaluated to '{(int)doubleOneFullDecrementUnderByteMaxValue}'. Expected: '254'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneIncrementAboveByteMaxValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)255.00000000000003d' was evaluated to '{(int)doubleOneIncrementAboveByteMaxValue}'. Expected: '255'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneFullIncrementAboveByteMaxValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)256d' was evaluated to '{(int)doubleOneFullIncrementAboveByteMaxValue}'. Expected: '256'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderByteMinValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)-1.0' was evaluated to '{(int)integerOneDecrementUnderByteMinValue}'. Expected: '-1'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveByteMinValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)1.0' was evaluated to '{(int)integerOneIncrementAboveByteMinValue}'. Expected: '1'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderByteMaxValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)254.0' was evaluated to '{(int)integerOneDecrementUnderByteMaxValue}'. Expected: '254'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveByteMaxValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)256.0' was evaluated to '{(int)integerOneIncrementAboveByteMaxValue}'. Expected: '256'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmInt16MinValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)-32768.0' was evaluated to '{(int)int16MinValue}'. Expected: '-32768'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmInt16MaxValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)32767.0' was evaluated to '{(int)int16MaxValue}'. Expected: '32767'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneDecrementUnderInt16MinValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)-32768.00000000001d' was evaluated to '{(int)doubleOneDecrementUnderInt16MinValue}'. Expected: '-32768'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneFullDecrementUnderInt16MinValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)-32769d' was evaluated to '{(int)doubleOneFullDecrementUnderInt16MinValue}'. Expected: '-32769'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneIncrementAboveInt16MinValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)-32767.999999999996d' was evaluated to '{(int)doubleOneIncrementAboveInt16MinValue}'. Expected: '-32767'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneFullIncrementAboveInt16MinValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)-32767d' was evaluated to '{(int)doubleOneFullIncrementAboveInt16MinValue}'. Expected: '-32767'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneDecrementUnderInt16MaxValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)32766.999999999996d' was evaluated to '{(int)doubleOneDecrementUnderInt16MaxValue}'. Expected: '32766'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneFullDecrementUnderInt16MaxValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)32766d' was evaluated to '{(int)doubleOneFullDecrementUnderInt16MaxValue}'. Expected: '32766'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneIncrementAboveInt16MaxValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)32767.000000000004d' was evaluated to '{(int)doubleOneIncrementAboveInt16MaxValue}'. Expected: '32767'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneFullIncrementAboveInt16MaxValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)32768d' was evaluated to '{(int)doubleOneFullIncrementAboveInt16MaxValue}'. Expected: '32768'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderInt16MinValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)-32769.0' was evaluated to '{(int)integerOneDecrementUnderInt16MinValue}'. Expected: '-32769'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveInt16MinValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)-32767.0' was evaluated to '{(int)integerOneIncrementAboveInt16MinValue}'. Expected: '-32767'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderInt16MaxValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)32766.0' was evaluated to '{(int)integerOneDecrementUnderInt16MaxValue}'. Expected: '32766'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveInt16MaxValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)32768.0' was evaluated to '{(int)integerOneIncrementAboveInt16MaxValue}'. Expected: '32768'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmUInt16MaxValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)65535.0' was evaluated to '{(int)uInt16MaxValue}'. Expected: '65535'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneDecrementUnderUInt16MaxValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)65534.99999999999d' was evaluated to '{(int)doubleOneDecrementUnderUInt16MaxValue}'. Expected: '65534'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneFullDecrementUnderUInt16MaxValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)65534d' was evaluated to '{(int)doubleOneFullDecrementUnderUInt16MaxValue}'. Expected: '65534'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneIncrementAboveUInt16MaxValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)65535.00000000001d' was evaluated to '{(int)doubleOneIncrementAboveUInt16MaxValue}'. Expected: '65535'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneFullIncrementAboveUInt16MaxValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)65536d' was evaluated to '{(int)doubleOneFullIncrementAboveUInt16MaxValue}'. Expected: '65536'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderUInt16MaxValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)65534.0' was evaluated to '{(int)integerOneDecrementUnderUInt16MaxValue}'. Expected: '65534'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveUInt16MaxValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)65536.0' was evaluated to '{(int)integerOneIncrementAboveUInt16MaxValue}'. Expected: '65536'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmInt32MinValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)-2147483648.0' was evaluated to '{(int)int32MinValue}'. Expected: '-2147483648'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmInt32MaxValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)2147483647.0' was evaluated to '{(int)int32MaxValue}'. Expected: '2147483647'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneDecrementUnderInt32MinValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)-2147483648.0000005d' was evaluated to '{(int)doubleOneDecrementUnderInt32MinValue}'. Expected: '-2147483648'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneIncrementAboveInt32MinValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)-2147483647.9999998d' was evaluated to '{(int)doubleOneIncrementAboveInt32MinValue}'. Expected: '-2147483647'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneFullIncrementAboveInt32MinValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)-2147483647d' was evaluated to '{(int)doubleOneFullIncrementAboveInt32MinValue}'. Expected: '-2147483647'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneDecrementUnderInt32MaxValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)2147483646.9999998d' was evaluated to '{(int)doubleOneDecrementUnderInt32MaxValue}'. Expected: '2147483646'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneFullDecrementUnderInt32MaxValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)2147483646d' was evaluated to '{(int)doubleOneFullDecrementUnderInt32MaxValue}'. Expected: '2147483646'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneIncrementAboveInt32MaxValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)2147483647.0000002d' was evaluated to '{(int)doubleOneIncrementAboveInt32MaxValue}'. Expected: '2147483647'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveInt32MinValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)-2147483647.0' was evaluated to '{(int)integerOneIncrementAboveInt32MinValue}'. Expected: '-2147483647'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderInt32MaxValueCastToInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(int)2147483646.0' was evaluated to '{(int)integerOneDecrementUnderInt32MaxValue}'. Expected: '2147483646'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneDecrementUnderUInt32MaxValueCastToInt32Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((int)4294967294.9999995d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneIncrementAboveUInt32MaxValueCastToInt32Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((int)4294967295.0000005d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmInt64MinValueCastToInt32Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((int)-9223372036854775808.0)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmInt64MaxValueCastToInt32Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((int)9223372036854775807.0)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneIncrementAboveInt64MinValueCastToInt32Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((int)-9.223372036854775E+18d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneIncrementAboveInt64MaxValueCastToInt32Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((int)9.223372036854778E+18d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneFullIncrementAboveInt64MaxValueCastToInt32Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((int)9.223372036854776E+18d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmIntegerOneDecrementUnderInt64MaxValueCastToInt32Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((int)9223372036854775806.0)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmUInt64MaxValueCastToInt32Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((int)18446744073709551615.0)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneDecrementUnderUInt64MaxValueCastToInt32Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((int)1.844674407370955E+19d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmIntegerOneDecrementUnderUInt64MaxValueCastToInt32Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((int)18446744073709551614.0)' did not throw OverflowException."
                );
        }
    }
    ...
    private static void TestCastingDoubleToUInt32()
    {
        ...
        static void ConfirmIntegerZeroCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)0.0' was evaluated to '{(uint)integerZero}'. Expected: '0'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleMinusZeroCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)-0d' was evaluated to '{(uint)doubleMinusZero}'. Expected: '0'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleZeroCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)0d' was evaluated to '{(uint)doubleZero}'. Expected: '0'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleMinValueCastToUInt32Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((uint)-1.7976931348623157E+308d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmSByteMaxValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)127.0' was evaluated to '{(uint)sByteMaxValue}'. Expected: '127'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneDecrementUnderSByteMinValueCastToUInt32Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((uint)-128.00000000000003d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneIncrementAboveSByteMinValueCastToUInt32Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((uint)-127.99999999999999d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneDecrementUnderSByteMaxValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)126.99999999999999d' was evaluated to '{(uint)doubleOneDecrementUnderSByteMaxValue}'. Expected: '126'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneFullDecrementUnderSByteMaxValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)126d' was evaluated to '{(uint)doubleOneFullDecrementUnderSByteMaxValue}'. Expected: '126'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneIncrementAboveSByteMaxValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)127.00000000000001d' was evaluated to '{(uint)doubleOneIncrementAboveSByteMaxValue}'. Expected: '127'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneFullIncrementAboveSByteMaxValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)128d' was evaluated to '{(uint)doubleOneFullIncrementAboveSByteMaxValue}'. Expected: '128'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderSByteMaxValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)126.0' was evaluated to '{(uint)integerOneDecrementUnderSByteMaxValue}'. Expected: '126'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveSByteMaxValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)128.0' was evaluated to '{(uint)integerOneIncrementAboveSByteMaxValue}'. Expected: '128'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmByteMaxValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)255.0' was evaluated to '{(uint)byteMaxValue}'. Expected: '255'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneDecrementUnderByteMinValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)-5E-324d' was evaluated to '{(uint)doubleOneDecrementUnderByteMinValue}'. Expected: '0'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneIncrementAboveByteMinValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)5E-324d' was evaluated to '{(uint)doubleOneIncrementAboveByteMinValue}'. Expected: '0'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneFullIncrementAboveByteMinValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)1d' was evaluated to '{(uint)doubleOneFullIncrementAboveByteMinValue}'. Expected: '1'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneDecrementUnderByteMaxValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)254.99999999999997d' was evaluated to '{(uint)doubleOneDecrementUnderByteMaxValue}'. Expected: '254'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneFullDecrementUnderByteMaxValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)254d' was evaluated to '{(uint)doubleOneFullDecrementUnderByteMaxValue}'. Expected: '254'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneIncrementAboveByteMaxValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)255.00000000000003d' was evaluated to '{(uint)doubleOneIncrementAboveByteMaxValue}'. Expected: '255'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneFullIncrementAboveByteMaxValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)256d' was evaluated to '{(uint)doubleOneFullIncrementAboveByteMaxValue}'. Expected: '256'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveByteMinValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)1.0' was evaluated to '{(uint)integerOneIncrementAboveByteMinValue}'. Expected: '1'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderByteMaxValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)254.0' was evaluated to '{(uint)integerOneDecrementUnderByteMaxValue}'. Expected: '254'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveByteMaxValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)256.0' was evaluated to '{(uint)integerOneIncrementAboveByteMaxValue}'. Expected: '256'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmInt16MaxValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)32767.0' was evaluated to '{(uint)int16MaxValue}'. Expected: '32767'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneDecrementUnderInt16MinValueCastToUInt32Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((uint)-32768.00000000001d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneIncrementAboveInt16MinValueCastToUInt32Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((uint)-32767.999999999996d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneDecrementUnderInt16MaxValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)32766.999999999996d' was evaluated to '{(uint)doubleOneDecrementUnderInt16MaxValue}'. Expected: '32766'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneFullDecrementUnderInt16MaxValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)32766d' was evaluated to '{(uint)doubleOneFullDecrementUnderInt16MaxValue}'. Expected: '32766'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneIncrementAboveInt16MaxValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)32767.000000000004d' was evaluated to '{(uint)doubleOneIncrementAboveInt16MaxValue}'. Expected: '32767'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneFullIncrementAboveInt16MaxValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)32768d' was evaluated to '{(uint)doubleOneFullIncrementAboveInt16MaxValue}'. Expected: '32768'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderInt16MaxValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)32766.0' was evaluated to '{(uint)integerOneDecrementUnderInt16MaxValue}'. Expected: '32766'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveInt16MaxValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)32768.0' was evaluated to '{(uint)integerOneIncrementAboveInt16MaxValue}'. Expected: '32768'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmUInt16MaxValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)65535.0' was evaluated to '{(uint)uInt16MaxValue}'. Expected: '65535'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneDecrementUnderUInt16MaxValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)65534.99999999999d' was evaluated to '{(uint)doubleOneDecrementUnderUInt16MaxValue}'. Expected: '65534'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneFullDecrementUnderUInt16MaxValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)65534d' was evaluated to '{(uint)doubleOneFullDecrementUnderUInt16MaxValue}'. Expected: '65534'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneIncrementAboveUInt16MaxValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)65535.00000000001d' was evaluated to '{(uint)doubleOneIncrementAboveUInt16MaxValue}'. Expected: '65535'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneFullIncrementAboveUInt16MaxValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)65536d' was evaluated to '{(uint)doubleOneFullIncrementAboveUInt16MaxValue}'. Expected: '65536'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderUInt16MaxValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)65534.0' was evaluated to '{(uint)integerOneDecrementUnderUInt16MaxValue}'. Expected: '65534'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveUInt16MaxValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)65536.0' was evaluated to '{(uint)integerOneIncrementAboveUInt16MaxValue}'. Expected: '65536'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmInt32MinValueCastToUInt32Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((uint)-2147483648.0)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmInt32MaxValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)2147483647.0' was evaluated to '{(uint)int32MaxValue}'. Expected: '2147483647'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneDecrementUnderInt32MinValueCastToUInt32Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((uint)-2147483648.0000005d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneIncrementAboveInt32MinValueCastToUInt32Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((uint)-2147483647.9999998d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneDecrementUnderInt32MaxValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)2147483646.9999998d' was evaluated to '{(uint)doubleOneDecrementUnderInt32MaxValue}'. Expected: '2147483646'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneFullDecrementUnderInt32MaxValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)2147483646d' was evaluated to '{(uint)doubleOneFullDecrementUnderInt32MaxValue}'. Expected: '2147483646'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneIncrementAboveInt32MaxValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)2147483647.0000002d' was evaluated to '{(uint)doubleOneIncrementAboveInt32MaxValue}'. Expected: '2147483647'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneFullIncrementAboveInt32MaxValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)2147483648d' was evaluated to '{(uint)doubleOneFullIncrementAboveInt32MaxValue}'. Expected: '2147483648'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderInt32MinValueCastToUInt32Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((uint)-2147483649.0)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmIntegerOneIncrementAboveInt32MinValueCastToUInt32Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((uint)-2147483647.0)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmIntegerOneDecrementUnderInt32MaxValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)2147483646.0' was evaluated to '{(uint)integerOneDecrementUnderInt32MaxValue}'. Expected: '2147483646'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveInt32MaxValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)2147483648.0' was evaluated to '{(uint)integerOneIncrementAboveInt32MaxValue}'. Expected: '2147483648'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmUInt32MaxValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)4294967295.0' was evaluated to '{(uint)uInt32MaxValue}'. Expected: '4294967295'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneDecrementUnderUInt32MaxValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)4294967294.9999995d' was evaluated to '{(uint)doubleOneDecrementUnderUInt32MaxValue}'. Expected: '4294967294'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneFullDecrementUnderUInt32MaxValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)4294967294d' was evaluated to '{(uint)doubleOneFullDecrementUnderUInt32MaxValue}'. Expected: '4294967294'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneIncrementAboveUInt32MaxValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)4294967295.0000005d' was evaluated to '{(uint)doubleOneIncrementAboveUInt32MaxValue}'. Expected: '4294967295'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderUInt32MaxValueCastToUInt32IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(uint)4294967294.0' was evaluated to '{(uint)integerOneDecrementUnderUInt32MaxValue}'. Expected: '4294967294'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmInt64MinValueCastToUInt32Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((uint)-9223372036854775808.0)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmInt64MaxValueCastToUInt32Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((uint)9223372036854775807.0)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneIncrementAboveInt64MinValueCastToUInt32Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((uint)-9.223372036854775E+18d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneIncrementAboveInt64MaxValueCastToUInt32Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((uint)9.223372036854778E+18d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneFullIncrementAboveInt64MaxValueCastToUInt32Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((uint)9.223372036854776E+18d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmIntegerOneDecrementUnderInt64MaxValueCastToUInt32Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((uint)9223372036854775806.0)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmUInt64MaxValueCastToUInt32Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((uint)18446744073709551615.0)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneDecrementUnderUInt64MaxValueCastToUInt32Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((uint)1.844674407370955E+19d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmIntegerOneDecrementUnderUInt64MaxValueCastToUInt32Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((uint)18446744073709551614.0)' did not throw OverflowException."
                );
        }
    }
    ...
    private static void TestCastingDoubleToInt64()
    {
        ...
        static void ConfirmIntegerZeroCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)0.0' was evaluated to '{(long)integerZero}'. Expected: '0'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleMinusZeroCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)-0d' was evaluated to '{(long)doubleMinusZero}'. Expected: '0'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleZeroCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)0d' was evaluated to '{(long)doubleZero}'. Expected: '0'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleMinValueCastToInt64Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((long)-1.7976931348623157E+308d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmSByteMinValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)-128.0' was evaluated to '{(long)sByteMinValue}'. Expected: '-128'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmSByteMaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)127.0' was evaluated to '{(long)sByteMaxValue}'. Expected: '127'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneDecrementUnderSByteMinValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)-128.00000000000003d' was evaluated to '{(long)doubleOneDecrementUnderSByteMinValue}'. Expected: '-128'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneFullDecrementUnderSByteMinValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)-129d' was evaluated to '{(long)doubleOneFullDecrementUnderSByteMinValue}'. Expected: '-129'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneIncrementAboveSByteMinValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)-127.99999999999999d' was evaluated to '{(long)doubleOneIncrementAboveSByteMinValue}'. Expected: '-127'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneFullIncrementAboveSByteMinValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)-127d' was evaluated to '{(long)doubleOneFullIncrementAboveSByteMinValue}'. Expected: '-127'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneDecrementUnderSByteMaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)126.99999999999999d' was evaluated to '{(long)doubleOneDecrementUnderSByteMaxValue}'. Expected: '126'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneFullDecrementUnderSByteMaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)126d' was evaluated to '{(long)doubleOneFullDecrementUnderSByteMaxValue}'. Expected: '126'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneIncrementAboveSByteMaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)127.00000000000001d' was evaluated to '{(long)doubleOneIncrementAboveSByteMaxValue}'. Expected: '127'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneFullIncrementAboveSByteMaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)128d' was evaluated to '{(long)doubleOneFullIncrementAboveSByteMaxValue}'. Expected: '128'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderSByteMinValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)-129.0' was evaluated to '{(long)integerOneDecrementUnderSByteMinValue}'. Expected: '-129'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveSByteMinValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)-127.0' was evaluated to '{(long)integerOneIncrementAboveSByteMinValue}'. Expected: '-127'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderSByteMaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)126.0' was evaluated to '{(long)integerOneDecrementUnderSByteMaxValue}'. Expected: '126'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveSByteMaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)128.0' was evaluated to '{(long)integerOneIncrementAboveSByteMaxValue}'. Expected: '128'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmByteMaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)255.0' was evaluated to '{(long)byteMaxValue}'. Expected: '255'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneDecrementUnderByteMinValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)-5E-324d' was evaluated to '{(long)doubleOneDecrementUnderByteMinValue}'. Expected: '0'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneFullDecrementUnderByteMinValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)-1d' was evaluated to '{(long)doubleOneFullDecrementUnderByteMinValue}'. Expected: '-1'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneIncrementAboveByteMinValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)5E-324d' was evaluated to '{(long)doubleOneIncrementAboveByteMinValue}'. Expected: '0'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneFullIncrementAboveByteMinValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)1d' was evaluated to '{(long)doubleOneFullIncrementAboveByteMinValue}'. Expected: '1'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneDecrementUnderByteMaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)254.99999999999997d' was evaluated to '{(long)doubleOneDecrementUnderByteMaxValue}'. Expected: '254'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneFullDecrementUnderByteMaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)254d' was evaluated to '{(long)doubleOneFullDecrementUnderByteMaxValue}'. Expected: '254'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneIncrementAboveByteMaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)255.00000000000003d' was evaluated to '{(long)doubleOneIncrementAboveByteMaxValue}'. Expected: '255'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneFullIncrementAboveByteMaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)256d' was evaluated to '{(long)doubleOneFullIncrementAboveByteMaxValue}'. Expected: '256'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderByteMinValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)-1.0' was evaluated to '{(long)integerOneDecrementUnderByteMinValue}'. Expected: '-1'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveByteMinValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)1.0' was evaluated to '{(long)integerOneIncrementAboveByteMinValue}'. Expected: '1'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderByteMaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)254.0' was evaluated to '{(long)integerOneDecrementUnderByteMaxValue}'. Expected: '254'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveByteMaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)256.0' was evaluated to '{(long)integerOneIncrementAboveByteMaxValue}'. Expected: '256'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmInt16MinValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)-32768.0' was evaluated to '{(long)int16MinValue}'. Expected: '-32768'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmInt16MaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)32767.0' was evaluated to '{(long)int16MaxValue}'. Expected: '32767'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneDecrementUnderInt16MinValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)-32768.00000000001d' was evaluated to '{(long)doubleOneDecrementUnderInt16MinValue}'. Expected: '-32768'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneFullDecrementUnderInt16MinValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)-32769d' was evaluated to '{(long)doubleOneFullDecrementUnderInt16MinValue}'. Expected: '-32769'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneIncrementAboveInt16MinValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)-32767.999999999996d' was evaluated to '{(long)doubleOneIncrementAboveInt16MinValue}'. Expected: '-32767'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneFullIncrementAboveInt16MinValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)-32767d' was evaluated to '{(long)doubleOneFullIncrementAboveInt16MinValue}'. Expected: '-32767'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneDecrementUnderInt16MaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)32766.999999999996d' was evaluated to '{(long)doubleOneDecrementUnderInt16MaxValue}'. Expected: '32766'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneFullDecrementUnderInt16MaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)32766d' was evaluated to '{(long)doubleOneFullDecrementUnderInt16MaxValue}'. Expected: '32766'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneIncrementAboveInt16MaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)32767.000000000004d' was evaluated to '{(long)doubleOneIncrementAboveInt16MaxValue}'. Expected: '32767'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneFullIncrementAboveInt16MaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)32768d' was evaluated to '{(long)doubleOneFullIncrementAboveInt16MaxValue}'. Expected: '32768'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderInt16MinValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)-32769.0' was evaluated to '{(long)integerOneDecrementUnderInt16MinValue}'. Expected: '-32769'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveInt16MinValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)-32767.0' was evaluated to '{(long)integerOneIncrementAboveInt16MinValue}'. Expected: '-32767'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderInt16MaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)32766.0' was evaluated to '{(long)integerOneDecrementUnderInt16MaxValue}'. Expected: '32766'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveInt16MaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)32768.0' was evaluated to '{(long)integerOneIncrementAboveInt16MaxValue}'. Expected: '32768'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmUInt16MaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)65535.0' was evaluated to '{(long)uInt16MaxValue}'. Expected: '65535'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneDecrementUnderUInt16MaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)65534.99999999999d' was evaluated to '{(long)doubleOneDecrementUnderUInt16MaxValue}'. Expected: '65534'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneFullDecrementUnderUInt16MaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)65534d' was evaluated to '{(long)doubleOneFullDecrementUnderUInt16MaxValue}'. Expected: '65534'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneIncrementAboveUInt16MaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)65535.00000000001d' was evaluated to '{(long)doubleOneIncrementAboveUInt16MaxValue}'. Expected: '65535'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneFullIncrementAboveUInt16MaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)65536d' was evaluated to '{(long)doubleOneFullIncrementAboveUInt16MaxValue}'. Expected: '65536'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderUInt16MaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)65534.0' was evaluated to '{(long)integerOneDecrementUnderUInt16MaxValue}'. Expected: '65534'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveUInt16MaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)65536.0' was evaluated to '{(long)integerOneIncrementAboveUInt16MaxValue}'. Expected: '65536'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmInt32MinValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)-2147483648.0' was evaluated to '{(long)int32MinValue}'. Expected: '-2147483648'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmInt32MaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)2147483647.0' was evaluated to '{(long)int32MaxValue}'. Expected: '2147483647'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneDecrementUnderInt32MinValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)-2147483648.0000005d' was evaluated to '{(long)doubleOneDecrementUnderInt32MinValue}'. Expected: '-2147483648'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneFullDecrementUnderInt32MinValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)-2147483649d' was evaluated to '{(long)doubleOneFullDecrementUnderInt32MinValue}'. Expected: '-2147483649'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneIncrementAboveInt32MinValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)-2147483647.9999998d' was evaluated to '{(long)doubleOneIncrementAboveInt32MinValue}'. Expected: '-2147483647'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneFullIncrementAboveInt32MinValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)-2147483647d' was evaluated to '{(long)doubleOneFullIncrementAboveInt32MinValue}'. Expected: '-2147483647'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneDecrementUnderInt32MaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)2147483646.9999998d' was evaluated to '{(long)doubleOneDecrementUnderInt32MaxValue}'. Expected: '2147483646'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneFullDecrementUnderInt32MaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)2147483646d' was evaluated to '{(long)doubleOneFullDecrementUnderInt32MaxValue}'. Expected: '2147483646'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneIncrementAboveInt32MaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)2147483647.0000002d' was evaluated to '{(long)doubleOneIncrementAboveInt32MaxValue}'. Expected: '2147483647'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneFullIncrementAboveInt32MaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)2147483648d' was evaluated to '{(long)doubleOneFullIncrementAboveInt32MaxValue}'. Expected: '2147483648'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderInt32MinValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)-2147483649.0' was evaluated to '{(long)integerOneDecrementUnderInt32MinValue}'. Expected: '-2147483649'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveInt32MinValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)-2147483647.0' was evaluated to '{(long)integerOneIncrementAboveInt32MinValue}'. Expected: '-2147483647'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderInt32MaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)2147483646.0' was evaluated to '{(long)integerOneDecrementUnderInt32MaxValue}'. Expected: '2147483646'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveInt32MaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)2147483648.0' was evaluated to '{(long)integerOneIncrementAboveInt32MaxValue}'. Expected: '2147483648'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmUInt32MaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)4294967295.0' was evaluated to '{(long)uInt32MaxValue}'. Expected: '4294967295'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneDecrementUnderUInt32MaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)4294967294.9999995d' was evaluated to '{(long)doubleOneDecrementUnderUInt32MaxValue}'. Expected: '4294967294'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneFullDecrementUnderUInt32MaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)4294967294d' was evaluated to '{(long)doubleOneFullDecrementUnderUInt32MaxValue}'. Expected: '4294967294'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneIncrementAboveUInt32MaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)4294967295.0000005d' was evaluated to '{(long)doubleOneIncrementAboveUInt32MaxValue}'. Expected: '4294967295'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneFullIncrementAboveUInt32MaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)4294967296d' was evaluated to '{(long)doubleOneFullIncrementAboveUInt32MaxValue}'. Expected: '4294967296'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderUInt32MaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)4294967294.0' was evaluated to '{(long)integerOneDecrementUnderUInt32MaxValue}'. Expected: '4294967294'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveUInt32MaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)4294967296.0' was evaluated to '{(long)integerOneIncrementAboveUInt32MaxValue}'. Expected: '4294967296'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmInt64MinValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)-9223372036854775808.0' was evaluated to '{(long)int64MinValue}'. Expected: '-9223372036854775808'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmInt64MaxValueCastToInt64Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((long)9223372036854775807.0)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneIncrementAboveInt64MinValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)-9.223372036854775E+18d' was evaluated to '{(long)doubleOneIncrementAboveInt64MinValue}'. Expected: '-9223372036854774784'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneDecrementUnderInt64MaxValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)9.223372036854775E+18d' was evaluated to '{(long)doubleOneDecrementUnderInt64MaxValue}'. Expected: '9223372036854774784'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneIncrementAboveInt64MaxValueCastToInt64Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((long)9.223372036854778E+18d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneFullIncrementAboveInt64MaxValueCastToInt64Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((long)9.223372036854776E+18d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmIntegerOneIncrementAboveInt64MinValueCastToInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(long)-9223372036854775807.0' was evaluated to '{(long)integerOneIncrementAboveInt64MinValue}'. Expected: '-9223372036854775808'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderInt64MaxValueCastToInt64Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((long)9223372036854775806.0)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmIntegerOneIncrementAboveInt64MaxValueCastToInt64Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((long)9223372036854775808.0)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmUInt64MaxValueCastToInt64Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((long)18446744073709551615.0)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneDecrementUnderUInt64MaxValueCastToInt64Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((long)1.844674407370955E+19d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmIntegerOneDecrementUnderUInt64MaxValueCastToInt64Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((long)18446744073709551614.0)' did not throw OverflowException."
                );
        }
    }
    ...
    private static void TestCastingDoubleToUInt64()
    {
        ...
        static void ConfirmIntegerZeroCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)0.0' was evaluated to '{(ulong)integerZero}'. Expected: '0'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleMinusZeroCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)-0d' was evaluated to '{(ulong)doubleMinusZero}'. Expected: '0'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleZeroCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)0d' was evaluated to '{(ulong)doubleZero}'. Expected: '0'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleMinValueCastToUInt64Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((ulong)-1.7976931348623157E+308d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmSByteMaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)127.0' was evaluated to '{(ulong)sByteMaxValue}'. Expected: '127'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneDecrementUnderSByteMinValueCastToUInt64Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((ulong)-128.00000000000003d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneIncrementAboveSByteMinValueCastToUInt64Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((ulong)-127.99999999999999d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneDecrementUnderSByteMaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)126.99999999999999d' was evaluated to '{(ulong)doubleOneDecrementUnderSByteMaxValue}'. Expected: '126'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneFullDecrementUnderSByteMaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)126d' was evaluated to '{(ulong)doubleOneFullDecrementUnderSByteMaxValue}'. Expected: '126'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneIncrementAboveSByteMaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)127.00000000000001d' was evaluated to '{(ulong)doubleOneIncrementAboveSByteMaxValue}'. Expected: '127'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneFullIncrementAboveSByteMaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)128d' was evaluated to '{(ulong)doubleOneFullIncrementAboveSByteMaxValue}'. Expected: '128'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderSByteMaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)126.0' was evaluated to '{(ulong)integerOneDecrementUnderSByteMaxValue}'. Expected: '126'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveSByteMaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)128.0' was evaluated to '{(ulong)integerOneIncrementAboveSByteMaxValue}'. Expected: '128'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmByteMaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)255.0' was evaluated to '{(ulong)byteMaxValue}'. Expected: '255'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneDecrementUnderByteMinValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)-5E-324d' was evaluated to '{(ulong)doubleOneDecrementUnderByteMinValue}'. Expected: '0'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneIncrementAboveByteMinValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)5E-324d' was evaluated to '{(ulong)doubleOneIncrementAboveByteMinValue}'. Expected: '0'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneFullIncrementAboveByteMinValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)1d' was evaluated to '{(ulong)doubleOneFullIncrementAboveByteMinValue}'. Expected: '1'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneDecrementUnderByteMaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)254.99999999999997d' was evaluated to '{(ulong)doubleOneDecrementUnderByteMaxValue}'. Expected: '254'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneFullDecrementUnderByteMaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)254d' was evaluated to '{(ulong)doubleOneFullDecrementUnderByteMaxValue}'. Expected: '254'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneIncrementAboveByteMaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)255.00000000000003d' was evaluated to '{(ulong)doubleOneIncrementAboveByteMaxValue}'. Expected: '255'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneFullIncrementAboveByteMaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)256d' was evaluated to '{(ulong)doubleOneFullIncrementAboveByteMaxValue}'. Expected: '256'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveByteMinValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)1.0' was evaluated to '{(ulong)integerOneIncrementAboveByteMinValue}'. Expected: '1'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderByteMaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)254.0' was evaluated to '{(ulong)integerOneDecrementUnderByteMaxValue}'. Expected: '254'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveByteMaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)256.0' was evaluated to '{(ulong)integerOneIncrementAboveByteMaxValue}'. Expected: '256'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmInt16MaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)32767.0' was evaluated to '{(ulong)int16MaxValue}'. Expected: '32767'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneDecrementUnderInt16MinValueCastToUInt64Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((ulong)-32768.00000000001d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneIncrementAboveInt16MinValueCastToUInt64Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((ulong)-32767.999999999996d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneDecrementUnderInt16MaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)32766.999999999996d' was evaluated to '{(ulong)doubleOneDecrementUnderInt16MaxValue}'. Expected: '32766'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneFullDecrementUnderInt16MaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)32766d' was evaluated to '{(ulong)doubleOneFullDecrementUnderInt16MaxValue}'. Expected: '32766'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneIncrementAboveInt16MaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)32767.000000000004d' was evaluated to '{(ulong)doubleOneIncrementAboveInt16MaxValue}'. Expected: '32767'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneFullIncrementAboveInt16MaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)32768d' was evaluated to '{(ulong)doubleOneFullIncrementAboveInt16MaxValue}'. Expected: '32768'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderInt16MaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)32766.0' was evaluated to '{(ulong)integerOneDecrementUnderInt16MaxValue}'. Expected: '32766'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveInt16MaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)32768.0' was evaluated to '{(ulong)integerOneIncrementAboveInt16MaxValue}'. Expected: '32768'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmUInt16MaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)65535.0' was evaluated to '{(ulong)uInt16MaxValue}'. Expected: '65535'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneDecrementUnderUInt16MaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)65534.99999999999d' was evaluated to '{(ulong)doubleOneDecrementUnderUInt16MaxValue}'. Expected: '65534'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneFullDecrementUnderUInt16MaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)65534d' was evaluated to '{(ulong)doubleOneFullDecrementUnderUInt16MaxValue}'. Expected: '65534'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneIncrementAboveUInt16MaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)65535.00000000001d' was evaluated to '{(ulong)doubleOneIncrementAboveUInt16MaxValue}'. Expected: '65535'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneFullIncrementAboveUInt16MaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)65536d' was evaluated to '{(ulong)doubleOneFullIncrementAboveUInt16MaxValue}'. Expected: '65536'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderUInt16MaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)65534.0' was evaluated to '{(ulong)integerOneDecrementUnderUInt16MaxValue}'. Expected: '65534'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveUInt16MaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)65536.0' was evaluated to '{(ulong)integerOneIncrementAboveUInt16MaxValue}'. Expected: '65536'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmInt32MinValueCastToUInt64Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((ulong)-2147483648.0)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmInt32MaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)2147483647.0' was evaluated to '{(ulong)int32MaxValue}'. Expected: '2147483647'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneDecrementUnderInt32MinValueCastToUInt64Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((ulong)-2147483648.0000005d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneFullDecrementUnderInt32MinValueCastToUInt64Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((ulong)-2147483649d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneIncrementAboveInt32MinValueCastToUInt64Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((ulong)-2147483647.9999998d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneFullIncrementAboveInt32MinValueCastToUInt64Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((ulong)-2147483647d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneDecrementUnderInt32MaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)2147483646.9999998d' was evaluated to '{(ulong)doubleOneDecrementUnderInt32MaxValue}'. Expected: '2147483646'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneFullDecrementUnderInt32MaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)2147483646d' was evaluated to '{(ulong)doubleOneFullDecrementUnderInt32MaxValue}'. Expected: '2147483646'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneIncrementAboveInt32MaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)2147483647.0000002d' was evaluated to '{(ulong)doubleOneIncrementAboveInt32MaxValue}'. Expected: '2147483647'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneFullIncrementAboveInt32MaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)2147483648d' was evaluated to '{(ulong)doubleOneFullIncrementAboveInt32MaxValue}'. Expected: '2147483648'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderInt32MinValueCastToUInt64Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((ulong)-2147483649.0)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmIntegerOneIncrementAboveInt32MinValueCastToUInt64Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((ulong)-2147483647.0)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmIntegerOneDecrementUnderInt32MaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)2147483646.0' was evaluated to '{(ulong)integerOneDecrementUnderInt32MaxValue}'. Expected: '2147483646'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveInt32MaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)2147483648.0' was evaluated to '{(ulong)integerOneIncrementAboveInt32MaxValue}'. Expected: '2147483648'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmUInt32MaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)4294967295.0' was evaluated to '{(ulong)uInt32MaxValue}'. Expected: '4294967295'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneDecrementUnderUInt32MaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)4294967294.9999995d' was evaluated to '{(ulong)doubleOneDecrementUnderUInt32MaxValue}'. Expected: '4294967294'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneFullDecrementUnderUInt32MaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)4294967294d' was evaluated to '{(ulong)doubleOneFullDecrementUnderUInt32MaxValue}'. Expected: '4294967294'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneIncrementAboveUInt32MaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)4294967295.0000005d' was evaluated to '{(ulong)doubleOneIncrementAboveUInt32MaxValue}'. Expected: '4294967295'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneFullIncrementAboveUInt32MaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)4294967296d' was evaluated to '{(ulong)doubleOneFullIncrementAboveUInt32MaxValue}'. Expected: '4294967296'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderUInt32MaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)4294967294.0' was evaluated to '{(ulong)integerOneDecrementUnderUInt32MaxValue}'. Expected: '4294967294'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveUInt32MaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)4294967296.0' was evaluated to '{(ulong)integerOneIncrementAboveUInt32MaxValue}'. Expected: '4294967296'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmInt64MinValueCastToUInt64Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((ulong)-9223372036854775808.0)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmInt64MaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)9223372036854775807.0' was evaluated to '{(ulong)int64MaxValue}'. Expected: '9223372036854775808'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneIncrementAboveInt64MinValueCastToUInt64Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((ulong)-9.223372036854775E+18d)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneDecrementUnderInt64MaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)9.223372036854775E+18d' was evaluated to '{(ulong)doubleOneDecrementUnderInt64MaxValue}'. Expected: '9223372036854774784'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneIncrementAboveInt64MaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)9.223372036854778E+18d' was evaluated to '{(ulong)doubleOneIncrementAboveInt64MaxValue}'. Expected: '9223372036854777856'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmDoubleOneFullIncrementAboveInt64MaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)9.223372036854776E+18d' was evaluated to '{(ulong)doubleOneFullIncrementAboveInt64MaxValue}'. Expected: '9223372036854775808'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveInt64MinValueCastToUInt64Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((ulong)-9223372036854775807.0)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmIntegerOneDecrementUnderInt64MaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)9223372036854775806.0' was evaluated to '{(ulong)integerOneDecrementUnderInt64MaxValue}'. Expected: '9223372036854775808'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneIncrementAboveInt64MaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)9223372036854775808.0' was evaluated to '{(ulong)integerOneIncrementAboveInt64MaxValue}'. Expected: '9223372036854775808'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmUInt64MaxValueCastToUInt64Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((ulong)18446744073709551615.0)' did not throw OverflowException."
                );
        }
        ...
        static void ConfirmDoubleOneDecrementUnderUInt64MaxValueCastToUInt64IsFoldedCorrectly()
        {
            ...
            {
                Console.WriteLine(
                    $"'(ulong)1.844674407370955E+19d' was evaluated to '{(ulong)doubleOneDecrementUnderUInt64MaxValue}'. Expected: '18446744073709549568'."
                );
                _counter++;
            }
        }
        ...
        static void ConfirmIntegerOneDecrementUnderUInt64MaxValueCastToUInt64Overflows()
        {
            ...
            if (_counter != 100)
                Console.WriteLine(
                    "'checked((ulong)18446744073709551614.0)' did not throw OverflowException."
                );
        }
    }
}
