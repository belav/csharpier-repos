...
public class TestClass_Loops
{
    ...
    public ulong Method18(
        S2 p_s2_492,
        ref decimal p_decimal_493,
        out uint p_uint_494,
        ref float p_float_495,
        ref int p_int_496,
        short p_short_497,
        out uint p_uint_498,
        ref S1 p_s1_499
    ...
    public float Method21(
        ...
        S2 p_s2_567,
        ref S1 p_s1_568,
        ref S1.S1_D1_F1 p_s1_s1_d1_f1_569,
        S1 p_s1_570,
        out S1.S1_D1_F1 p_s1_s1_d1_f1_571,
        ref S2 p_s2_572
    )
    {
    ...
    public S1 Method60(
        ref decimal p_decimal_1639,
        out float p_float_1640,
        ref byte p_byte_1641,
        out S2 p_s2_1642,
        S1.S1_D1_F1 p_s1_s1_d1_f1_1643,
        ref S1 p_s1_1644,
        out S2 p_s2_1645,
        S2 p_s2_1646,
        ref ulong p_ulong_1647,
        out ulong p_ulong_1648,
        ref S2 p_s2_1649,
        out S2 p_s2_1650
    )
    {
        unchecked
        {
                ...
                (float)(
                    (
                        (float)(
                            float_1660 /= (
                                (float)(
                                    (((float)(float_29 - ((float)(LeafMethod9() * float_1660)))))
                                    + 89
                                )
                            )
                        )
                        ...
                        (float)(
                            (
                                Method21(
                                    ...
                                    s_s2_19,
                                    ref s1_35,
                                    ref p_s1_s1_d1_f1_1643,
                                    s_s1_18,
                                    out s_s1_s1_d1_f1_17,
                                    ref s2_1667
                                )
                            ) + 45
                        )
            ...
            p_s2_1642 = s2_36;
            p_s2_1645 = s_s2_19;
            p_ulong_1648 = Method18(
                s2_36,
                ref decimal_23,
                out uint_1663,
                ref p_float_1640,
                ref int_1657,
                ((short)(short_1656 % ((short)((((short)(short_25 - s_short_8))) + 35)))),
                out uint_1663,
                ref s_s1_18
            );
            p_s2_1650 = s2_36;
                                                ...
                                                s_s2_19.decimal_2 += (
                                                    (decimal)(
                                                        (
                                                            (decimal)(
                                                                decimal_1654
                                                                - -1.9841269841269841269841269841m
                                                            )
                                                        )
                                                        + (
                                                            (decimal)(
                                                                s_decimal_6 *= s2_1668.decimal_2
                                                            )
                                                        )
                                                    )
                                                )
                                        ...
                                        * (
                                            (decimal)(
                                                s_s2_19.decimal_2 *= (
                                                    (decimal)(
                                                        s2_36.decimal_2 += (
                                                            (decimal)(LeafMethod3() + LeafMethod3())
                                                        )
                                                    )
                                                )
                                            )
