...
namespace JitBench
{
    public class TestRun
    {
        ...
        private void ValidateMetrics()
        {
            ...
            var isSubset = !reducedList
                .Except(validCollectionOptions, StringComparer.OrdinalIgnoreCase)
                .Any();
        ...
        )
        {
            ...
            {
                int columnWidth = Enumerable
                    .Range(0, formattedCells.Count)
        ...
        )
        {
            ...
            foreach (Benchmark benchmark in Benchmarks)
            {
                BenchmarkRunResult canonResult = BenchmarkRunResults
                    .Where(r => r.Benchmark == benchmark)
                    .FirstOrDefault();
                if (
                    canonResult == null
