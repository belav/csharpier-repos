...
namespace JitBench
{
    ...
    internal sealed class CommandLineOptions
    {
        ...
        [Option(
            "use-existing-setup",
            Required = false,
            HelpText = "Use existing setup for all benchmarks."
        )]
        ...
        [Option(
            "coreclr-bin-dir",
            Required = false,
            HelpText = "Copy private CoreCLR binaries from this directory. (The binaries must match target-architecture)"
        )]
        ...
        [Option(
            ...
            Required = false,
            HelpText = "The version of dotnet on which private CoreCLR binaries will be overlayed"
        )]
        ...
        [Option(
            "dotnet-sdk-version",
            Required = false,
            HelpText = "The version of dotnet SDK to install for this test"
        )]
        ...
        [Option(
            ...
            Required = false,
            Separator = ',',
            HelpText = "A comma list of all configurations that the benchmarks will be run with. The options are: Default, Tiering, Minopts, NoR2R, and NoNgen. "
        ...
        [Option(
            "perf:outputdir",
            Required = false,
            HelpText = "Specifies the output directory name."
        )]
        ...
        [Option(
            "target-architecture",
            Required = false,
            HelpText = "The architecture of the binaries being tested."
        )]
        ...
        [Option(
            "benchmark",
            Required = false,
            HelpText = "A semicolon seperated list of benchmarks to run"
        )]
        ...
        [Option(
            "perf:runid",
            Required = false,
            HelpText = "User defined id given to the performance harness."
        )]
        public string RunId
        {
            get { return _runid; }
