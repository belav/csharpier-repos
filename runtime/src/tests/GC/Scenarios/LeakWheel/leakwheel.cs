...
namespace DefaultNamespace
{
    ...
    internal class LeakWheel
    {
        ...
        public static int Main(String[] Args)
        {
            ...
            Console.WriteLine(
                "iMem= {0} MB, iIter= {1}, iTable={2} iSeed={3}",
                iMem,
                iIter,
                iTable,
                iSeed
            ...
            while (!my_obj.RunGame())
            {
                ...
                Console.WriteLine(
                    "After Delete and GCed all Objects: {0}",
            ...
            Console.WriteLine(
                "Created VarAry objects: {0} Finalized VarAry Objects: {1}",
                Node.iVarAryCreat,
                Node.iVarAryFinal
            );
            Console.WriteLine(
                "Created BitArray objects: {0} Finalized BitArray Objects: {1}",
                Node.iBitAryCreat,
                Node.iBitAryFinal
            );
            Console.WriteLine(
                "Created small objects: {0} Finalized small Objects: {1}",
                Node.iSmallCreat,
                Node.iSmallFinal
            );
            Console.WriteLine(
                "Created BinaryTree objects: {0} Finalized BinaryTree Objects: {1}",
                Node.iBiTreeCreat,
                Node.iBiTreeFinal
            );
            Console.WriteLine(
                "Created Thread objects: {0} Finalized Thread Objects: {1}",
                Node.iThrdCreat,
                Node.iThrdFinal
            );

            if (
                Node.iBitAryCreat == Node.iBitAryFinal
                    ...
                    switch (iSwitch)
                    {
                        case 0:
                            ...
                            { //delete one child Node at iKey if there is,
                                ...
                                goto case 1; //otherwise del this Node in "case 1" (the node is shared with "case 1" );
