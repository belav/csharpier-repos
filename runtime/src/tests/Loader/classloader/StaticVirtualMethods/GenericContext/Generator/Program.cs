    ...
    class Program
    {
        ...
        static void GenerateImplementations(TextWriter tw)
        {
            ...
            )
            {
                ...
                if (constrainedTypeDefinition.ToString().StartsWith("Generic"))
                {
                    ...
                    GenerateImpl(
                        implClass.Name + "<!0>",
                        $"IFaceCuriouslyRecurringGeneric`1",
        ...
        static void Main(string[] args)
        {
            using StreamWriter twOutputCommon = new StreamWriter(
                Path.Combine(args[0], @$"{CommonAndImplAssemblyName}.il")
            );
            using StreamWriter twOutputTest = new StreamWriter(
                Path.Combine(args[0], @$"{TestAssemblyName}.il")
            );
                ...
                switch (scenario.InterfaceType)
                {
                    ...
                    case InterfaceType.CuriouslyRecurringGeneric:
                        interfaceTypeSansImplPrefix =
                            $"IFaceCuriouslyRecurringGeneric`1<{constrainedTypePrefix}{constrainedType}>";
                        break;
                    default:
                        throw new Exception("Unexpected value");
                }
