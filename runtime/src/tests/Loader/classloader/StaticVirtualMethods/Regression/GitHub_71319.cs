...
public class Program : IFoo<object>
{
    ...
    public static int TestEntryPoint()
    {
        ...
        Console.WriteLine(
            "SVM call result #1: {0} (System.Object expected - using default interface implementation)",
            staticResult1
        );
        string staticResult2 = CallStatic2<Fooer<object>, string>();
        Console.WriteLine(
            "SVM call result #2: {0} (System.Object expected - using implementation in a helper class)",
            staticResult2
        );
