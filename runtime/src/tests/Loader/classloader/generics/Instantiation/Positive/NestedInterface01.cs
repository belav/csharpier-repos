...
public class GenInt : Outer.IGen<int>
{
    int Fld1;
...
public class GenDouble : Outer.IGen<double>
{
    double Fld1;
...
public class GenString : Outer.IGen<String>
{
    string Fld1;
...
public class GenObject : Outer.IGen<object>
{
    object Fld1;
...
public class GenGuid : Outer.IGen<Guid>
{
    Guid Fld1;
...
public class GenConstructedReference : Outer.IGen<RefX1<int>>
{
    RefX1<int> Fld1;
    ...
    public bool InstVerify(System.Type t1)
    {
        ...
        if (!(Fld1.GetType().Equals(t1)))
        {
            result = false;
            Console.WriteLine(
                "Failed to verify type of Fld1 in: " + typeof(Outer.IGen<RefX1<int>>)
            );
        }
...
public class GenConstructedValue : Outer.IGen<ValX1<string>>
{
    ValX1<string> Fld1;
    ...
    public bool InstVerify(System.Type t1)
    {
        ...
        if (!(Fld1.GetType().Equals(t1)))
        {
            result = false;
            Console.WriteLine(
                "Failed to verify type of Fld1 in: " + typeof(Outer.IGen<ValX1<string>>)
            );
        }
...
public class Gen1DIntArray : Outer.IGen<int[]>
{
    int[] Fld1;
...
public class Gen2DStringArray : Outer.IGen<string[,]>
{
    string[,] Fld1;
...
public class GenJaggedObjectArray : Outer.IGen<object[][]>
{
    object[][] Fld1;
    ...
    public bool InstVerify(System.Type t1)
    {
        ...
        if (!(Fld1.GetType().Equals(t1)))
        {
            result = false;
            Console.WriteLine(
                "Failed to verify type of Fld1 in: " + typeof(Outer.IGen<object[][]>)
            );
        }
