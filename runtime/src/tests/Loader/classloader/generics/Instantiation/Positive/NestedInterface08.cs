...
public class Test_NestedInterface08
{
    ...
    public static int TestEntryPoint()
    {
        ...
        Outer<RefX1<int>>.IGen<RefX1<int>> IGenConstructedReference = new Gen<RefX1<int>>(
            new RefX1<int>()
        );
        Eval(IGenConstructedReference.InstVerify(typeof(RefX1<int>)));

        Outer<ValX1<string>>.IGen<ValX1<string>> IGenConstructedValue = new Gen<ValX1<string>>(
            new ValX1<string>()
        );
        ...
        Outer<object[][]>.IGen<object[][]> IGenJaggedObjectArray = new Gen<object[][]>(
            new object[1][]
        );
