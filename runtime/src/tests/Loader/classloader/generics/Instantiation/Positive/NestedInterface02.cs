...
public class GenInt : GenOuter<int>.IGen<int>
{
    ...
    public bool InstVerify(System.Type t1)
    {
        ...
        if (!(Fld1.GetType().Equals(t1)))
        {
            result = false;
            Console.WriteLine(
                "Failed to verify type of Fld1 in: " + typeof(GenOuter<int>.IGen<int>)
            );
        }
...
public class GenDouble : GenOuter<int>.IGen<double>
{
    ...
    public bool InstVerify(System.Type t1)
    {
        ...
        if (!(Fld1.GetType().Equals(t1)))
        {
            result = false;
            Console.WriteLine(
                "Failed to verify type of Fld1 in: " + typeof(GenOuter<int>.IGen<double>)
            );
        }
...
public class GenString : GenOuter<int>.IGen<String>
{
    ...
    public bool InstVerify(System.Type t1)
    {
        ...
        if (!(Fld1.GetType().Equals(t1)))
        {
            result = false;
            Console.WriteLine(
                "Failed to verify type of Fld1 in: " + typeof(GenOuter<int>.IGen<string>)
            );
        }
...
public class GenObject : GenOuter<int>.IGen<object>
{
    ...
    public bool InstVerify(System.Type t1)
    {
        ...
        if (!(Fld1.GetType().Equals(t1)))
        {
            result = false;
            Console.WriteLine(
                "Failed to verify type of Fld1 in: " + typeof(GenOuter<int>.IGen<object>)
            );
        }
...
public class GenGuid : GenOuter<int>.IGen<Guid>
{
    ...
    public bool InstVerify(System.Type t1)
    {
        ...
        if (!(Fld1.GetType().Equals(t1)))
        {
            result = false;
            Console.WriteLine(
                "Failed to verify type of Fld1 in: " + typeof(GenOuter<int>.IGen<Guid>)
            );
        }
...
public class GenConstructedReference : GenOuter<int>.IGen<RefX1<int>>
{
    ...
    public bool InstVerify(System.Type t1)
    {
        ...
        if (!(Fld1.GetType().Equals(t1)))
        {
            result = false;
            Console.WriteLine(
                "Failed to verify type of Fld1 in: " + typeof(GenOuter<int>.IGen<RefX1<int>>)
            );
        }
...
public class GenConstructedValue : GenOuter<int>.IGen<ValX1<string>>
{
    ...
    public bool InstVerify(System.Type t1)
    {
        ...
        if (!(Fld1.GetType().Equals(t1)))
        {
            result = false;
            Console.WriteLine(
                "Failed to verify type of Fld1 in: " + typeof(GenOuter<int>.IGen<ValX1<string>>)
            );
        }
