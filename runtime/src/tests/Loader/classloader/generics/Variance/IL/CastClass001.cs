...
public class TestClass
{
    ...
    private static bool RunTests()
    {
        ...
        Eval(
            "Test009",
            CastClassUToT<GBase<int>, GSubT<string>, GTU<GSubT<int>, GBase<string>>>(true)
        );

        Eval(
            "Test010",
            CastClassUToTIPlusT<GBase<int>[], GTU<GSubT<int>[], GBase<string>[]>>(true)
        );
        Eval(
            "Test011",
            CastClassUToTIMinusT<GSubT<string>[], GTU<GSubT<int>[], GBase<string>[]>>(true)
        );
        Eval(
            "Test012",
            CastClassUToT<GBase<int>[], GSubT<string>[], GTU<GSubT<int>[], GBase<string>[]>>(true)
        ...
        Eval(
            "Test107",
            CastClassUToTIPlusT<GBase<int>[], GTArrUArr<GSubT<int>, GBase<string>>>(true)
        );
        Eval(
            "Test108",
            CastClassUToTIMinusT<GSubT<string>[], GTArrUArr<GSubT<int>, GBase<string>>>(true)
        );
        Eval(
            "Test109",
            CastClassUToT<GBase<int>[], GSubT<string>[], GTArrUArr<GSubT<int>, GBase<string>>>(true)
        );
        ...
        Eval(
            ...
            CastClassUToT<
                GBase<int>[][],
                GSubT<string>[][],
                GTArrUArr<GSubT<int>[], GBase<string>[]>
            >(true)
        );
        ...
        Eval(
            "Test206",
            CastClassUToT<IPlusT<Base[]>, IPlusT<Sub[]>, GRefTRefU<Sub[], Base[]>>(true)
        );

        Eval(
            "Test207",
            CastClassUToTIPlusT<IPlusT<GBase<int>>, GRefTRefU<GSubT<int>, GBase<string>>>(true)
        );
        Eval(
            "Test208",
            CastClassUToTIPlusT<IMinusT<GSubT<string>>, GRefTRefU<GSubT<int>, GBase<string>>>(true)
        );
        Eval(
            "Test209",
            CastClassUToT<
                IPlusT<GBase<int>>,
                IPlusT<GSubT<string>>,
                GRefTRefU<GSubT<int>, GBase<string>>
            >(true)
        );

        Eval(
            "Test210",
            CastClassUToTIPlusT<IPlusT<GBase<int>[]>, GRefTRefU<GSubT<int>[], GBase<string>[]>>(
                true
            )
        );
        Eval(
            "Test211",
            CastClassUToTIPlusT<IMinusT<GSubT<string>[]>, GRefTRefU<GSubT<int>[], GBase<string>[]>>(
                true
            )
        );
        Eval(
        ...
        Eval(
            "Test303",
            CastClassUToT<IPlusT<Base[]>, IPlusT<Sub[]>, GRefTArrRefUArr<Sub, Base>>(true)
        );

        Eval(
            "Test304",
            CastClassUToTIPlusT<IPlusT<Base[][]>, GRefTArrRefUArr<Sub[], Base[]>>(true)
        );
        Eval(
            "Test305",
            CastClassUToTIPlusT<IMinusT<Sub[][]>, GRefTArrRefUArr<Sub[], Base[]>>(true)
        );
        Eval(
            "Test306",
            CastClassUToT<IPlusT<Base[][]>, IPlusT<Sub[][]>, GRefTArrRefUArr<Sub[], Base[]>>(true)
        ...
        Eval(
            "Test307",
            CastClassUToTIPlusT<IPlusT<GBase<int>[]>, GRefTArrRefUArr<GSubT<int>, GBase<string>>>(
                true
            )
        );
        Eval(
            "Test308",
            CastClassUToTIPlusT<
                IMinusT<GSubT<string>[]>,
                GRefTArrRefUArr<GSubT<int>, GBase<string>>
            >(true)
        );
        Eval(
            "Test309",
        ...
        Eval(
            "Test403",
            CastClassUToT<IPlusT<Base>[], IPlusT<Sub>[], GArrRefTArrRefU<Sub, Base>>(true)
        );

        Eval(
            "Test404",
            CastClassUToTIPlusT<IPlusT<Base[,]>[], GArrRefTArrRefU<Sub[,], Base[,]>>(true)
        );
        Eval(
            "Test405",
            CastClassUToTIPlusT<IMinusT<Sub[,]>[], GArrRefTArrRefU<Sub[,], Base[,]>>(true)
        );
        Eval(
            "Test406",
            CastClassUToT<IPlusT<Base[,]>[], IPlusT<Sub[,]>[], GArrRefTArrRefU<Sub[,], Base[,]>>(
                true
            )
        );
        ...
        Eval(
            "Test407",
            CastClassUToTIPlusT<IPlusT<GBase<int>>[], GArrRefTArrRefU<GSubT<int>, GBase<string>>>(
                true
            )
        );
        Eval(
            ...
            CastClassUToTIPlusT<
                IMinusT<GSubT<string>>[],
                GArrRefTArrRefU<GSubT<int>, GBase<string>>
            >(true)
        );
        Eval(
            "Test409",
