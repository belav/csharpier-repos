...
public class TestClass
{
    ...
    private static bool RunTests()
    {
        ...
        Eval(
            "Test009",
            UIsInstT<IPlusTMinusU<GBase<int>, GSubT<string>>, GTU<GSubT<int>, GBase<string>>>(true)
        );

        Eval("Test010", UIsInstT<IPlusT<GBase<int>[]>, GTU<GSubT<int>[], GBase<string>[]>>(true));
        Eval(
            "Test011",
            UIsInstT<IMinusT<GSubT<string>[]>, GTU<GSubT<int>[], GBase<string>[]>>(true)
        );
        Eval(
            "Test012",
            UIsInstT<
                IPlusTMinusU<GBase<int>[], GSubT<string>[]>,
                GTU<GSubT<int>[], GBase<string>[]>
            >(true)
        );
        ...
        Eval(
            "Test108",
            UIsInstT<IMinusT<GSubT<string>[]>, GTArrUArr<GSubT<int>, GBase<string>>>(true)
        );
        Eval(
            "Test109",
            UIsInstT<
        ...
        Eval(
            "Test110",
            UIsInstT<IPlusT<GBase<int>[][]>, GTArrUArr<GSubT<int>[], GBase<string>[]>>(true)
        );
        Eval(
            "Test111",
            UIsInstT<IMinusT<GSubT<string>[][]>, GTArrUArr<GSubT<int>[], GBase<string>[]>>(true)
        ...
        Eval(
            "Test203",
            UIsInstT<IPlusTMinusU<IPlusT<Base>, IPlusT<Sub>>, GRefTRefU<Sub, Base>>(true)
        );
        ...
        Eval(
            "Test207",
            UIsInstT<IPlusT<IPlusT<GBase<int>>>, GRefTRefU<GSubT<int>, GBase<string>>>(true)
        );
        Eval(
            "Test208",
            UIsInstT<IPlusT<IMinusT<GSubT<string>>>, GRefTRefU<GSubT<int>, GBase<string>>>(true)
        );
        Eval(
            "Test209",
            UIsInstT<
                IPlusTMinusU<IPlusT<GBase<int>>, IPlusT<GSubT<string>>>,
        ...
        Eval(
            "Test211",
            UIsInstT<IPlusT<IMinusT<GSubT<string>[]>>, GRefTRefU<GSubT<int>[], GBase<string>[]>>(
                true
            )
        );
        Eval(
        ...
        Eval(
            "Test303",
            UIsInstT<IPlusTMinusU<IPlusT<Base[]>, IPlusT<Sub[]>>, GRefTArrRefUArr<Sub, Base>>(true)
        );
        ...
        Eval(
            "Test307",
            UIsInstT<IPlusT<IPlusT<GBase<int>[]>>, GRefTArrRefUArr<GSubT<int>, GBase<string>>>(true)
        );
        Eval(
            "Test308",
            UIsInstT<IPlusT<IMinusT<GSubT<string>[]>>, GRefTArrRefUArr<GSubT<int>, GBase<string>>>(
                true
            )
        );
        Eval(
        ...
        Eval(
            "Test403",
            UIsInstT<IPlusTMinusU<IPlusT<Base>[], IPlusT<Sub>[]>, GArrRefTArrRefU<Sub, Base>>(true)
        );

        Eval(
            "Test404",
            UIsInstT<IPlusT<IPlusT<Base[,]>[]>, GArrRefTArrRefU<Sub[,], Base[,]>>(true)
        );
        Eval(
            "Test405",
            UIsInstT<IPlusT<IMinusT<Sub[,]>[]>, GArrRefTArrRefU<Sub[,], Base[,]>>(true)
        );
        Eval(
            "Test406",
            UIsInstT<
        ...
        Eval(
            "Test407",
            UIsInstT<IPlusT<IPlusT<GBase<int>>[]>, GArrRefTArrRefU<GSubT<int>, GBase<string>>>(true)
        );
        Eval(
            "Test408",
            UIsInstT<IPlusT<IMinusT<GSubT<string>>[]>, GArrRefTArrRefU<GSubT<int>, GBase<string>>>(
                true
            )
        );
        Eval(
