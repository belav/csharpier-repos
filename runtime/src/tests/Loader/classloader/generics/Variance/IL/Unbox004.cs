...
public class TestClass
{
    ...
    private static bool RunTests()
    {
        ...
        Eval(
            "Test009",
            UnboxUToT<IPlusTMinusU<GBase<int>, GSubT<string>>, GTU<GSubT<int>, GBase<string>>>(true)
        );

        Eval("Test010", UnboxUToT<IPlusT<GBase<int>[]>, GTU<GSubT<int>[], GBase<string>[]>>(true));
        Eval(
            "Test011",
            UnboxUToT<IMinusT<GSubT<string>[]>, GTU<GSubT<int>[], GBase<string>[]>>(true)
        );
        Eval(
            "Test012",
            UnboxUToT<
        ...
        Eval(
            "Test107",
            UnboxUToT<IPlusT<GBase<int>[]>, GTArrUArr<GSubT<int>, GBase<string>>>(true)
        );
        Eval(
            "Test108",
            UnboxUToT<IMinusT<GSubT<string>[]>, GTArrUArr<GSubT<int>, GBase<string>>>(true)
        );
        Eval(
            "Test109",
            UnboxUToT<
        ...
        Eval(
            "Test203",
            UnboxUToT<IPlusTMinusU<IPlusT<Base>, IPlusT<Sub>>, GRefTRefU<Sub, Base>>(true)
        );
        ...
        Eval(
            "Test207",
            UnboxUToT<IPlusT<IPlusT<GBase<int>>>, GRefTRefU<GSubT<int>, GBase<string>>>(true)
        );
        Eval(
            "Test208",
            UnboxUToT<IPlusT<IMinusT<GSubT<string>>>, GRefTRefU<GSubT<int>, GBase<string>>>(true)
        );
        Eval(
            "Test209",
            UnboxUToT<
        ...
        Eval(
            "Test211",
            UnboxUToT<IPlusT<IMinusT<GSubT<string>[]>>, GRefTRefU<GSubT<int>[], GBase<string>[]>>(
                true
            )
        );
        Eval(
        ...
        Eval(
            "Test303",
            UnboxUToT<IPlusTMinusU<IPlusT<Base[]>, IPlusT<Sub[]>>, GRefTArrRefUArr<Sub, Base>>(true)
        );
        ...
        Eval(
            "Test307",
            UnboxUToT<IPlusT<IPlusT<GBase<int>[]>>, GRefTArrRefUArr<GSubT<int>, GBase<string>>>(
                true
            )
        );
        Eval(
            "Test308",
            UnboxUToT<IPlusT<IMinusT<GSubT<string>[]>>, GRefTArrRefUArr<GSubT<int>, GBase<string>>>(
                true
            )
        );
        Eval(
        ...
        Eval(
            "Test403",
            UnboxUToT<IPlusTMinusU<IPlusT<Base>[], IPlusT<Sub>[]>, GArrRefTArrRefU<Sub, Base>>(true)
        );

        Eval(
            "Test404",
            UnboxUToT<IPlusT<IPlusT<Base[,]>[]>, GArrRefTArrRefU<Sub[,], Base[,]>>(true)
        );
        Eval(
            "Test405",
            UnboxUToT<IPlusT<IMinusT<Sub[,]>[]>, GArrRefTArrRefU<Sub[,], Base[,]>>(true)
        );
        Eval(
            "Test406",
            UnboxUToT<
        ...
        Eval(
            "Test407",
            UnboxUToT<IPlusT<IPlusT<GBase<int>>[]>, GArrRefTArrRefU<GSubT<int>, GBase<string>>>(
                true
            )
        );
        Eval(
            "Test408",
            UnboxUToT<IPlusT<IMinusT<GSubT<string>>[]>, GArrRefTArrRefU<GSubT<int>, GBase<string>>>(
                true
            )
        );
        Eval(
