...
public class TestClass
{
    ...
    private static bool RunTests()
    {
        ...
        Eval(
            "Test009",
            UnboxUToT<IPlusTMinusU<GSubT<int>, GBase<string>>, GTU<GBase<int>, GSubT<string>>>(
                false
            )
        );
        ...
        Eval(
            "Test011",
            UnboxUToT<IMinusT<GBase<string>[]>, GTU<GBase<int>[], GSubT<string>[]>>(false)
        );
        Eval(
            "Test012",
            UnboxUToT<
        ...
        Eval(
            "Test106",
            UnboxUToT<IPlusTMinusU<Sub[][], Base[][]>, GTArrUArr<Base[], Sub[]>>(false)
        );

        Eval(
            "Test107",
            UnboxUToT<IPlusT<GSubT<int>[]>, GTArrUArr<GBase<int>, GSubT<string>>>(false)
        );
        Eval(
            "Test108",
            UnboxUToT<IMinusT<GBase<string>[]>, GTArrUArr<GBase<int>, GSubT<string>>>(false)
        );
        Eval(
            "Test109",
            UnboxUToT<
        ...
        Eval(
            "Test203",
            UnboxUToT<IPlusTMinusU<IPlusT<Sub>, IPlusT<Base>>, GRefTRefU<Base, Sub>>(false)
        );
        ...
        Eval(
            "Test207",
            UnboxUToT<IPlusT<IPlusT<GSubT<int>>>, GRefTRefU<GBase<int>, GSubT<string>>>(false)
        );
        Eval(
            "Test208",
            UnboxUToT<IPlusT<IMinusT<GBase<string>>>, GRefTRefU<GBase<int>, GSubT<string>>>(false)
        );
        Eval(
            "Test209",
            UnboxUToT<
        ...
        Eval(
            "Test211",
            UnboxUToT<IPlusT<IMinusT<GBase<string>[]>>, GRefTRefU<GBase<int>[], GSubT<string>[]>>(
                false
            )
        );
        Eval(
        ...
        Eval(
            "Test303",
            UnboxUToT<IPlusTMinusU<IPlusT<Sub[]>, IPlusT<Base[]>>, GRefTArrRefUArr<Base, Sub>>(
                false
            )
        );
        ...
        Eval(
            "Test305",
            UnboxUToT<IPlusT<IMinusT<Base[][]>>, GRefTArrRefUArr<Base[], Sub[]>>(false)
        );
        Eval(
            "Test306",
            UnboxUToT<
        ...
        Eval(
            "Test307",
            UnboxUToT<IPlusT<IPlusT<GSubT<int>[]>>, GRefTArrRefUArr<GBase<int>, GSubT<string>>>(
                false
            )
        );
        Eval(
            "Test308",
            UnboxUToT<IPlusT<IMinusT<GBase<string>[]>>, GRefTArrRefUArr<GBase<int>, GSubT<string>>>(
                false
            )
        );
        Eval(
        ...
        Eval(
            "Test403",
            UnboxUToT<IPlusTMinusU<IPlusT<Sub>[], IPlusT<Base>[]>, GArrRefTArrRefU<Base, Sub>>(
                false
            )
        );
        ...
        Eval(
            "Test404",
            UnboxUToT<IPlusT<IPlusT<Sub[,]>[]>, GArrRefTArrRefU<Base[,], Sub[,]>>(false)
        );
        Eval(
            "Test405",
            UnboxUToT<IPlusT<IMinusT<Base[,]>[]>, GArrRefTArrRefU<Base[,], Sub[,]>>(false)
        );
        Eval(
            "Test406",
            UnboxUToT<
        ...
        Eval(
            "Test407",
            UnboxUToT<IPlusT<IPlusT<GSubT<int>>[]>, GArrRefTArrRefU<GBase<int>, GSubT<string>>>(
                false
            )
        );
        Eval(
            "Test408",
            UnboxUToT<IPlusT<IMinusT<GBase<string>>[]>, GArrRefTArrRefU<GBase<int>, GSubT<string>>>(
                false
            )
        );
        Eval(
