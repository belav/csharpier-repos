...
public class TestClass
{
    ...
    private static bool RunTests()
    {
        ...
        Eval(
            "Test009",
            UIsInstT<IPlusTMinusU<GSubT<int>, GBase<string>>, GTU<GBase<int>, GSubT<string>>>(false)
        );

        Eval("Test010", UIsInstT<IPlusT<GSubT<int>[]>, GTU<GBase<int>[], GSubT<string>[]>>(false));
        Eval(
            "Test011",
            UIsInstT<IMinusT<GBase<string>[]>, GTU<GBase<int>[], GSubT<string>[]>>(false)
        );
        Eval(
            "Test012",
            UIsInstT<
                IPlusTMinusU<GSubT<int>[], GBase<string>[]>,
                GTU<GBase<int>[], GSubT<string>[]>
            >(false)
        );
        ...
        Eval(
            "Test107",
            UIsInstT<IPlusT<GSubT<int>[]>, GTArrUArr<GBase<int>, GSubT<string>>>(false)
        );
        Eval(
            "Test108",
            UIsInstT<IMinusT<GBase<string>[]>, GTArrUArr<GBase<int>, GSubT<string>>>(false)
        );
        Eval(
            "Test109",
            UIsInstT<
                IPlusTMinusU<GSubT<int>[], GBase<string>[]>,
                GTArrUArr<GBase<int>, GSubT<string>>
            >(false)
        );
        ...
        Eval(
            "Test203",
            UIsInstT<IPlusTMinusU<IPlusT<Sub>, IPlusT<Base>>, GRefTRefU<Base, Sub>>(false)
        );
        ...
        Eval(
            "Test207",
            UIsInstT<IPlusT<IPlusT<GSubT<int>>>, GRefTRefU<GBase<int>, GSubT<string>>>(false)
        );
        Eval(
            "Test208",
            UIsInstT<IPlusT<IMinusT<GBase<string>>>, GRefTRefU<GBase<int>, GSubT<string>>>(false)
        );
        Eval(
            "Test209",
            UIsInstT<
                IPlusTMinusU<IPlusT<GSubT<int>>, IPlusT<GBase<string>>>,
                GRefTRefU<GBase<int>, GSubT<string>>
            >(false)
        );
        ...
        Eval(
            "Test211",
            UIsInstT<IPlusT<IMinusT<GBase<string>[]>>, GRefTRefU<GBase<int>[], GSubT<string>[]>>(
                false
            )
        );
        Eval(
        ...
        Eval(
            "Test303",
            UIsInstT<IPlusTMinusU<IPlusT<Sub[]>, IPlusT<Base[]>>, GRefTArrRefUArr<Base, Sub>>(false)
        );
        ...
        Eval(
            "Test306",
            UIsInstT<
                IPlusTMinusU<IPlusT<Sub[][]>, IPlusT<Base[][]>>,
                GRefTArrRefUArr<Base[], Sub[]>
            >(false)
        );

        Eval(
            "Test307",
            UIsInstT<IPlusT<IPlusT<GSubT<int>[]>>, GRefTArrRefUArr<GBase<int>, GSubT<string>>>(
                false
            )
        );
        Eval(
            "Test308",
            UIsInstT<IPlusT<IMinusT<GBase<string>[]>>, GRefTArrRefUArr<GBase<int>, GSubT<string>>>(
                false
            )
        );
        Eval(
            ...
            UIsInstT<
                IPlusTMinusU<IPlusT<GSubT<int>[]>, IPlusT<GBase<string>[]>>,
                GRefTArrRefUArr<GBase<int>, GSubT<string>>
            >(false)
        );
        ...
        Eval(
            "Test403",
            UIsInstT<IPlusTMinusU<IPlusT<Sub>[], IPlusT<Base>[]>, GArrRefTArrRefU<Base, Sub>>(false)
        );

        Eval(
            "Test404",
            UIsInstT<IPlusT<IPlusT<Sub[,]>[]>, GArrRefTArrRefU<Base[,], Sub[,]>>(false)
        );
        Eval(
            "Test405",
            UIsInstT<IPlusT<IMinusT<Base[,]>[]>, GArrRefTArrRefU<Base[,], Sub[,]>>(false)
        );
        Eval(
            "Test406",
            UIsInstT<
                IPlusTMinusU<IPlusT<Sub[,]>[], IPlusT<Base[,]>[]>,
                GArrRefTArrRefU<Base[,], Sub[,]>
            >(false)
        );

        Eval(
            "Test407",
            UIsInstT<IPlusT<IPlusT<GSubT<int>>[]>, GArrRefTArrRefU<GBase<int>, GSubT<string>>>(
                false
            )
        );
        Eval(
            "Test408",
            UIsInstT<IPlusT<IMinusT<GBase<string>>[]>, GArrRefTArrRefU<GBase<int>, GSubT<string>>>(
                false
            )
        );
        Eval(
            ...
            UIsInstT<
                IPlusTMinusU<IPlusT<GSubT<int>>[], IPlusT<GBase<string>>[]>,
                GArrRefTArrRefU<GBase<int>, GSubT<string>>
            >(false)
        );
