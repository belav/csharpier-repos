    ...
    public class M
    {
        ...
        public static void TestEntryPoint()
        {
            ...
            Assert.Equal(
                ...
                attrs.ElementAt(0).ToString()
            );
            Assert.Equal(
                "System.ComponentModel.DataAnnotations.RequiredAttribute",
                attrs.ElementAt(1).ToString()
            );
            Assert.Equal(typeof(RequiredAttribute), attrs.ElementAt(1).GetType());
            Assert.Equal(
                ObjectRequiredMessage,
                ((RequiredAttribute)attrs.ElementAt(1)).FormatErrorMessage("abc")
            );
        ...
        public static object createObject()
        {
            ...
            FieldBuilder fb = tb.DefineField("_prop1", typeof(string), FieldAttributes.Private);
            ...
            MethodBuilder custNameGetPropMthdBldr = tb.DefineMethod(
                "get_prop1",
                getSetAttr,
                typeof(string),
                Type.EmptyTypes
            ...
            MethodBuilder custNameSetPropMthdBldr = tb.DefineMethod(
                "set_prop1",
                getSetAttr,
                null,
            ...
            CustomAttributeBuilder CABR = new CustomAttributeBuilder(
                rat.GetConstructor(new Type[0]),
                new object[0],
                new PropertyInfo[2]
                {
