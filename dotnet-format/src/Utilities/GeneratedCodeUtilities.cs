...
namespace Microsoft.CodeAnalysis.Tools.Utilities
{
    ...
    {
        private static readonly string[] s_autoGeneratedStrings = new[]
        {
            "<autogenerated",
            "<auto-generated"
        };

        private static readonly Func<SyntaxTrivia, bool> s_isCSharpCommentTrivia = (syntaxTrivia) =>
        ...
        internal static async Task<bool> IsGeneratedCodeAsync(
            ...
            var isCommentTrivia =
                syntaxTree.Options.Language == LanguageNames.CSharp
