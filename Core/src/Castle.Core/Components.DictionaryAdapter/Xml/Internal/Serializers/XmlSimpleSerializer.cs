...
namespace Castle.Components.DictionaryAdapter.Xml
{
    ...
    public static class XmlSimpleSerializer
    {
        public static readonly XmlTypeSerializer ForBoolean = new XmlSimpleSerializer<Boolean>(
            ...
            ForDecimal = new XmlSimpleSerializer<Decimal>(
                XmlConvert.ToString,
                XmlConvert.ToDecimal
            ),
            ForTimeSpan = new XmlSimpleSerializer<TimeSpan>(
                XmlConvert.ToString,
                XmlConvert.ToTimeSpan
            ),
            ForDateTime = new XmlSimpleSerializer<DateTime>(
                XmlConvert_ToString,
                XmlConvert_ToDateTime
            ),
