...
namespace Castle.DynamicProxy
{
    ...
    public class PersistentProxyBuilder : DefaultProxyBuilder
    {
        ...
        /// <summary>
        ///   Saves the generated assembly to a physical file. Note that this renders the <see cref =
        // "PersistentProxyBuilder" /> unusable.
        /// </summary>
        /// <returns>The path of the generated assembly file, or null if no assembly has been
        // generated.</returns>
        /// <remarks>
        ///   This method does not support saving multiple files. If both a signed and an unsigned module
        // have been generated, use the
