...
namespace Castle.DynamicProxy.Tests
{
    ...
    public class TypeUtilTestCase
    {
        ...
        {
            MethodInfo[] methods = typeof(object).GetAllInstanceMethods();
        ...
        {
            MethodInfo[] methods = typeof(Derived).GetAllInstanceMethods();
            MethodInfo[] realMethods = typeof(Derived).GetMethods(
                BindingFlags.Instance | BindingFlags.NonPublic | BindingFlags.Public
            );
        ...
        {
            public abstract override Derived Method();
        }
