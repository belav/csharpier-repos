    ...
    public class ClassProxyWithTargetTestCase : BasePEVerifyTestCase
    {
        ...
        public void Can_proxy_class_with_no_default_ctor()
        {
            var proxy = generator.CreateClassProxyWithTarget(
                typeof(VirtualClassWithNoDefaultCtor),
        ...
        {
            var proxy = generator.CreateClassProxyWithTarget(
                new VirtualClassWithProtectedGenericMethod(42)
            );
        ...
        {
            var proxy = generator.CreateClassProxyWithTarget(
                new ClassWithProtectedGenericMethod(42)
            );
            var result = proxy.PublicMethod<int>();
            Assert.AreEqual(42, result);
        }
        ...
        {
            var proxy = generator.CreateClassProxyWithTarget(
                new VirtualClassWithProtectedMethod(42)
            );
        ...
        {
            var proxy = generator.CreateClassProxyWithTarget<AbstractClassWithMethod>(
                new InheritsAbstractClassWithMethod()
            );
            var result = proxy.Method();
            Assert.AreEqual(42, result);
        }
        ...
        public void Cannot_proxy_generic_class_with_inaccessible_type_argument()
        {
            var ex = Assert.Throws<ArgumentException>(
                () =>
                    generator.CreateClassProxyWithTarget<List<PrivateClass>>(
                        new List<PrivateClass>()
                    )
            );
            StringAssert.StartsWith(
        ...
        public void Cannot_proxy_generic_class_with_type_argument_that_has_inaccessible_type_argument()
        {
            ...
            var expected = string.Format(
                ...
                typeof(List<List<PrivateClass>>).FullName,
                typeof(PrivateClass).FullName
            );
        ...
        public void Hook_does_NOT_get_notified_about_autoproperty_field()
        {
            ...
            generator.CreateClassProxyWithTarget(
                typeof(VirtualClassWithAutoProperty),
                Type.EmptyTypes,
                new VirtualClassWithAutoProperty(),
        ...
        public void Hook_gets_notified_about_public_field()
        {
            ...
            generator.CreateClassProxyWithTarget(
                typeof(VirtualClassWithPublicField),
                Type.EmptyTypes,
                new VirtualClassWithPublicField(),
                new ProxyGenerationOptions(hook),
                new object[0]
            );
