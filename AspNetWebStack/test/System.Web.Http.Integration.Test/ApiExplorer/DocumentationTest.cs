...
namespace System.Web.Http.ApiExplorer
{
    public class DocumentationTest
    {
        ...
        public void VerifyCustomDocumentationProviderMessage()
        {
            ...
            AttributeDocumentationProvider documentationProvider =
            ...
            foreach (ApiDescription description in explorer.ApiDescriptions)
            {
                Assert.Equal(
                    ...
                    documentationProvider.GetDocumentation(
                        description.ActionDescriptor.ControllerDescriptor
                    )
                );
                Assert.Equal(
                ...
                foreach (ApiParameterDescription param in description.ParameterDescriptions)
                {
                    Assert.Equal(String.Format("{0} parameter", param.Name), param.Documentation);
                }
