...
namespace System.Web.Http.ModelBinding
{
    ...
    public class QueryStringBindingTests : ModelBindingTests
    {
        ...
        public async Task Query_String_Binds_Simple_Types_Get(
            string action,
            string queryString,
        ...
        public async Task Query_String_Binds_Simple_Types_Post(
            string action,
            string queryString,
            string expectedResponse
        )
        ...
        [Theory]
        [InlineData(
            "GetComplexTypeFromUri",
            "itemName=Tires&quantity=2&customer.Name=Sue",
            "Tires",
            2,
            "Sue"
        )]
        public async Task Query_String_ComplexType_Type_Get(
            string action,
            string queryString,
            string itemName,
            int quantity,
        ...
        [Theory]
        [InlineData(
            "PostComplexTypeFromUri",
            "itemName=Tires&quantity=2&customer.Name=Bob",
            "Tires",
            2,
            "Bob"
        )]
        public async Task Query_String_ComplexType_Type_Post(
            string action,
            string queryString,
            string itemName,
            int quantity,
        ...
        [Theory]
        [InlineData(
            "PostComplexTypeFromUriWithNestedCollection",
            "value.Numbers[0]=1&value.Numbers[1]=2",
            new[] { 1, 2 }
        )]
        ...
        )
        {
            ...
            // Assert
            ComplexTypeWithNestedCollection actualResult = await response.Content
