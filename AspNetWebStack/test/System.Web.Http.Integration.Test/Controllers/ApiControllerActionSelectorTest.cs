...
namespace System.Web.Http
{
    ...
    public class ApiControllerActionSelectorTest
    {
        ...
        [InlineData(
            "Delete",
            "Test/6?email=user@test.com",
            "DeleteUserById_Email_OptName_OptPhone"
        )]
        [InlineData(
            "Delete",
            "Test/6?email=user@test.com&name=user",
            "DeleteUserById_Email_OptName_OptPhone"
        )]
        [InlineData(
            "Delete",
            "Test/6?email=user@test.com&name=user&phone=123456789",
            "DeleteUserById_Email_OptName_OptPhone"
        )]
        [InlineData(
            "Delete",
            "Test/6?email=user@test.com&height=1.8",
            "DeleteUserById_Email_Height_OptName_OptPhone"
        )]
        [InlineData(
            "Delete",
            "Test/6?email=user@test.com&height=1.8&name=user",
            "DeleteUserById_Email_Height_OptName_OptPhone"
        )]
        [InlineData(
            "Delete",
            "Test/6?email=user@test.com&height=1.8&name=user&phone=12345678",
            "DeleteUserById_Email_Height_OptName_OptPhone"
        )]
        ...
        public void Route_Parameters_Default(
            string httpMethod,
            string requestUrl,
        ...
        public void Route_Parameters_Non_Id(
            string httpMethod,
            string requestUrl,
            string expectedActionName
        )
        ...
        [InlineData("GET", "Test?nAmE=mario&ssn=123456&AgE=3", "GetUserByNameAgeAndSsn")]
        [InlineData("Delete", "Test/6?AGe=10", "DeleteUserByIdAndOptName")]
        public void Route_Parameters_Casing(
            string httpMethod,
            string requestUrl,
            string expectedActionName
        )
        ...
        [InlineData(
            "GET",
            "Test/GetUserByNameAgeAndSsn?name=user&age=90&ssn=123456789",
            "GetUserByNameAgeAndSsn"
        )]
        [InlineData(
            "GET",
            "Test/GetUserByNameAndSsn?name=user&ssn=123456789",
            "GetUserByNameAndSsn"
        )]
        ...
        [InlineData("POST", "Test/PostUserByNameAndAddress?name=user", "PostUserByNameAndAddress")]
        public void Route_Action_Name_Casing(
            string httpMethod,
            string requestUrl,
            string expectedActionName
        )
        ...
        public void ModelBindingParameterAttribute_AreAppliedWhenSelectingActions(
            string httpMethod,
            string requestUrl,
            string expectedActionName
        )
        {
            ...
            context.ControllerDescriptor = new HttpControllerDescriptor(
                context.Configuration,
                "ParameterAttribute",
                typeof(ParameterAttributeController)
            );
            HttpActionDescriptor descriptor = ApiControllerHelper.SelectAction(context);
        ...
        [InlineData("GET", "Test?name=mario&ssn=123456&age=3", "GetUserByNameAgeAndSsn")]
        [InlineData("GET", "Test/5?random=9", "GetUser")]
        public void SelectionBasedOnParameter_IsNotAffectedBy_AddingGlobalValueProvider(
            string httpMethod,
            string requestUrl,
            string expectedActionName
        )
        {
            ...
            context.Configuration.Services.Add(
