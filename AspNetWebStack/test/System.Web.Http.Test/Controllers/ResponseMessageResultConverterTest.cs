...
namespace System.Web.Http.Controllers
{
    ...
    {
        private readonly ResponseMessageResultConverter _converter =
            ...
            Assert.ThrowsArgumentNull(
                () =>
                    _converter.Convert(
                        ...
                        actionResult: new HttpResponseMessage()
                    ),
                "controllerContext"
            );
        }
        ...
        public void Convert_WhenValueIsNull_Throws()
        {
            Assert.Throws<InvalidOperationException>(
                () => _converter.Convert(_context, null),
        ...
        public void Convert_WhenValueIsIncompatibleType_Throws()
        {
            Assert.Throws<InvalidCastException>(
                () => _converter.Convert(_context, "42"),
