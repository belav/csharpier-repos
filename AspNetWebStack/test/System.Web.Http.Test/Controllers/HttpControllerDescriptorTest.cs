...
namespace System.Web.Http
{
    public class HttpControllerDescriptorTest
    {
        ...
        public void GetFilters_InvokesGetCustomAttributesMethod()
        {
            ...
            descriptorMock.Setup(d => d.GetCustomAttributes<IFilter>())
                .Returns(filters)
                .Verifiable();
        ...
        public void Initialize_In_InheritenceHierarchy()
        {
            ...
            // Act.
            HttpControllerDescriptor desc = new HttpControllerDescriptor(
                config,
                "MyController",
                typeof(MyDerived2Controller)
            );

            // Assert
            Assert.Same(
                MyDerived1Controller.SelectorBase,
                desc.Configuration.Services.GetActionSelector()
            );
            Assert.Same(
                MyDerived1Controller.ActionValueBinderDerived1,
                desc.Configuration.Services.GetActionValueBinder()
            );
        ...
        public void Initialize_GetsTheActualControllerDescriptor_In_InheritenceHierarchy()
        {
            ...
            HttpControllerDescriptor desc = new HttpControllerDescriptor(
                config,
                "MyController",
                typeof(VerifyControllerDescriptorDerivedController)
            );
            Assert.Equal(
                typeof(VerifyControllerDescriptorDerivedController),
                VerifyControllerDescriptorAttribute.ControllerType
            );

            desc = new HttpControllerDescriptor(
                config,
                "MyController",
                typeof(VerifyControllerDescriptorBaseController)
            );
            Assert.Equal(
                typeof(VerifyControllerDescriptorBaseController),
                VerifyControllerDescriptorAttribute.ControllerType
        ...
        public void EmptySetting_DoesNotChangeTheConfigurationInstance()
        {
            ...
            HttpControllerDescriptor desc = new HttpControllerDescriptor(
                config,
                "MyController",
                typeof(NoopControllerConfigController)
            );
        ...
        class MyConfigDerived1Attribute : Attribute, IControllerConfiguration
        {
            ...
            )
            {
                ...
                Assert.Same(
                    ...
                    settings.Services.GetActionValueBinder()
                );
        ...
        {
            public static IActionValueBinder ActionValueBinderDerived1 =
                new Mock<IActionValueBinder>().Object;
        }
        ...
        {
            public static IActionValueBinder ActionValueBinderDerived3 =
                new Mock<IActionValueBinder>().Object;
        }
        ...
        public void Initialize_Append_A_Formatter()
        {
            ...
            HttpControllerDescriptor desc = new HttpControllerDescriptor(
                config,
                "MyController",
                typeof(MyControllerWithCustomFormatter)
            );
            ...
            Assert.Same(
                MyControllerWithCustomFormatter.CustomFormatter,
                desc.Configuration.Formatters[1]
            );
        }
