...
namespace System.Web.Http
{
    ...
    {
        private readonly HttpActionContext _actionContextInstance =
            ContextUtil.CreateActionContext();
        private readonly HttpConfiguration _configurationInstance = new HttpConfiguration();
        private readonly HttpActionDescriptor _actionDescriptorInstance =
        ...
        public async Task Setting_CustomActionSelector()
        {
            ...
            mockSelector.Setup(invoker => invoker.SelectAction(It.IsAny<HttpControllerContext>()))
                .Returns(
                    () =>
                    {
        ...
        public async Task Default_Post()
        {
            ...
            HttpControllerContext controllerContext = ContextUtil.CreateControllerContext(
                instance: api,
                request: new HttpRequestMessage() { Method = HttpMethod.Post }
            );
            controllerContext.ControllerDescriptor = new HttpControllerDescriptor(
                controllerContext.Configuration,
                "test",
        ...
        public async Task Default_Put()
        {
            ...
            HttpControllerContext controllerContext = ContextUtil.CreateControllerContext(
                instance: api,
                request: new HttpRequestMessage() { Method = HttpMethod.Put }
            );
            controllerContext.ControllerDescriptor = new HttpControllerDescriptor(
                controllerContext.Configuration,
                "test",
        ...
        public async Task Default_Delete()
        {
            ...
            HttpControllerContext controllerContext = ContextUtil.CreateControllerContext(
                instance: api,
                request: new HttpRequestMessage() { Method = HttpMethod.Delete }
            );
            controllerContext.ControllerDescriptor = new HttpControllerDescriptor(
                controllerContext.Configuration,
                "test",
        ...
        public async Task Route_Get_Action_With_Query_Parameters()
        {
            ...
            Uri requestUri = new Uri(
                "http://localhost/?firstName=QueryFirstName&lastName=QueryLastName"
            );
            HttpControllerContext controllerContext = ContextUtil.CreateControllerContext(
                instance: api,
                routeData: route,
        ...
        public async Task Invalid_Action_In_Route()
        {
            ...
            Assert.Equal(
                "No action was found on the controller 'UsersController' that matches the name 'invalidOp'.",
        ...
        public async Task ExecuteAsync_InvokesAuthenticationFilters_ThenInvokesAuthorizationFilters_ThenInvokesModelBinding_ThenInvokesActionFilters_ThenInvokesAction()
        {
            ...
            var actionFilterMock = CreateActionFilterMock(
                (ac, ct, cont) =>
                {
            ...
            var authorizationFilterMock = CreateAuthorizationFilterMock(
                (ac, ct, cont) =>
                {
            ...
            selectorMock.Setup(s => s.SelectAction(controllerContext))
                .Returns(actionDescriptorMock.Object);
        ...
        public void GetFilters_UsesFilterProvidersToGetFilters()
        {
            ...
            filterProviderMock.Verify(
                fp => fp.GetFilters(_configurationInstance, actionDescriptorMock)
            );
        }
        ...
        public void GetFilters_RemovesDuplicateUniqueFiltersKeepingMostSpecificScope()
        {
            ...
            var uniqueControllerFilter = new FilterInfo(
                new TestUniqueFilter(),
            ...
            // Assert
            Assert.Equal(
                new[] { multiGlobalFilter, multiActionFilter, uniqueActionFilter },
                result
            );
        }
        ...
        )
        {
            ...
            using (HttpResponseMessage response = new HttpResponseMessage())
            {
                ...
                // Act
                HttpResponseMessage ignore = await controller.ExecuteAsync(
                    context,
                    CancellationToken.None
                );
            }
        ...
        public async Task ApiControllerCannotBeReused()
        {
            ...
            mockDescriptor.Setup(d => d.CreateController(It.IsAny<HttpRequestMessage>()))
                .Returns(singletonController);
            var mockSelector = new Mock<DefaultHttpControllerSelector>(config) { CallBase = true };
            mockSelector.Setup(s => s.SelectController(It.IsAny<HttpRequestMessage>()))
            ...
            // Act
            HttpResponseMessage response1 = await invoker.SendAsync(
                new HttpRequestMessage(HttpMethod.Get, "http://localhost/"),
                CancellationToken.None
            );
            HttpResponseMessage response2 = await invoker.SendAsync(
                new HttpRequestMessage(HttpMethod.Get, "http://localhost/"),
                CancellationToken.None
            );
            ...
            Assert.Contains(
                "Cannot reuse an 'ApiController' instance. 'ApiController' has to be constructed per incoming message.",
        ...
        public void RequestSet_UpdatesRequestBackedContextRequest()
        {
            ...
            {
                ApiController controller = CreateFakeController();
                RequestBackedHttpRequestContext context =
        ...
        public void RequestContextSet_Throws_WhenNull()
        {
            ...
            Assert.ThrowsArgumentNull(
                () =>
                {
                    controller.RequestContext = null;
                },
                "value"
            );
        }
        ...
        public void UserGet_ReturnsContextPrincipal()
        {
            ...
            controller.RequestContext = new HttpRequestContext { Principal = expectedPrincipal };
        ...
        public void Validate_SetsModelStateErrors_ForInvalidModels()
        {
            ...
            Assert.Equal(
                "The field ID must be between 0 and 100.",
                controller.ModelState["ID"].Errors[0].ErrorMessage
            );
        }
        ...
        private static Mock<DefaultServices> BuildFilterProvidingServicesMock(
