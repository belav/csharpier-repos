...
namespace System.Web.Http.Services
{
    public class DefaultServicesTests
    {
        ...
        public void Constructor_DefaultServicesInContainer()
        {
            ...
            object[] filterProviders = defaultServices.GetServices(typeof(IFilterProvider))
                .ToArray();
            ...
            object[] modelBinderProviders = defaultServices.GetServices(typeof(ModelBinderProvider))
                .ToArray();
            ...
            object[] exceptionLoggers = defaultServices.GetServices(typeof(IExceptionLogger))
                .ToArray();
        ...
        public void GetService_PrefersServiceInDependencyInjectionContainer()
        {
            ...
            mockDependencyResolver.Setup(dr => dr.GetService(typeof(IActionValueBinder)))
        ...
        public void GetServices_PrependsServiceInDependencyInjectionContainer()
        {
            ...
            var filterProvider = new Mock<IFilterProvider>().Object;
            var mockDependencyResolver = new Mock<IDependencyResolver>();
            mockDependencyResolver.Setup(dr => dr.GetServices(typeof(IFilterProvider)))
