...
namespace System.Web.Http.Dispatcher
{
    public class DefaultHttpControllerActivatorTest
    {
        ...
        public void Create_GuardClauses()
        {
            ...
            Assert.ThrowsArgumentNull(
                () =>
                    activator.Create(
                        ...
                        controllerType: typeof(SimpleController)
                    ),
                "request"
            );
            Assert.ThrowsArgumentNull(
            ...
            Assert.ThrowsArgumentNull(
                () => activator.Create(request, descriptor, controllerType: null),
                "controllerType"
            );
        ...
        public void Create_DoesnotCacheControllerFromRequestLevelDependencyScope()
        {
            ...
            // Act
            IHttpController result1 = activator.Create(
                request,
                descriptor,
                typeof(ControllerWithCtorParams)
            );
            IHttpController result2 = activator.Create(
                request,
                descriptor,
                typeof(ControllerWithCtorParams)
            );
        ...
        public void Create_MixupInstanceCreationAndDependencyScope()
        {
            ...
            request.SetConfiguration(config);
            request.Properties[HttpPropertyKeys.DependencyScope] = mockScope.Object;
            var descriptorControllerWithCtorParamsResult = new HttpControllerDescriptor(
                config,
                "Name",
                typeof(ControllerWithCtorParams)
            );
            var descriptorSimpleController = new HttpControllerDescriptor(
                config,
                "Simple",
                typeof(SimpleController)
            );
            ...
            // Act
            IHttpController simpleController = activator.Create(
                request,
                descriptorSimpleController,
                typeof(SimpleController)
            );
            IHttpController controllerWithCtorParamsResult = activator.Create(
                request,
                descriptorControllerWithCtorParamsResult,
                typeof(ControllerWithCtorParams)
            );
        ...
        public void Create_ThrowsForNullDependencyScope()
        {
            ...
            mockResolver.Setup(resolver => resolver.BeginScope())
                .Returns((IDependencyScope)null)
                .Verifiable();
