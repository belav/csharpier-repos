    ...
    public class HttpControllerDispatcherTest
    {
        ...
        public async Task SendAsync_CallsControllerExecuteAsyncWithPopulatedControllerContext()
        {
            ...
            mockController.Setup(
                c => c.ExecuteAsync(It.IsAny<HttpControllerContext>(), CancellationToken.None)
            )
                .Callback(
        ...
        public async Task SendAsync_CreatesControllerContext_WithRequestContextFromRequest()
        {
            ...
            using (HttpRequestMessage request = new HttpRequestMessage())
            {
                ...
                controllerDescriptorMock.Setup(d => d.CreateController(request))
                ...
                controllerSelectorMock.Setup(s => s.SelectController(request))
