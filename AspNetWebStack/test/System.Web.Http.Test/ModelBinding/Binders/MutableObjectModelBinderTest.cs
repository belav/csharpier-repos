...
namespace System.Web.Http.ModelBinding.Binders
{
    public class MutableObjectModelBinderTest
    {
        ...
        public void BindModel()
        {
            ...
            mockTestableBinder.Setup(o => o.EnsureModelPublic(context, bindingContext))
                .Verifiable();
            mockTestableBinder.Setup(o => o.GetMetadataForPropertiesPublic(context, bindingContext))
        ...
        public void EnsureModel_ModelIsNotNull_DoesNothing()
        {
            ...
            mockTestableBinder.Verify(
                o => o.CreateModelPublic(actionContext, bindingContext),
                Times.Never()
            );
        }
        ...
        public void EnsureModel_ModelIsNull_CallsCreateModel()
        {
            ...
            Mock<TestableMutableObjectModelBinder> mockTestableBinder =
                new Mock<TestableMutableObjectModelBinder> { CallBase = true };
            mockTestableBinder.Setup(o => o.CreateModelPublic(null, bindingContext))
                .Returns(new Person())
                .Verifiable();
            TestableMutableObjectModelBinder testableBinder = mockTestableBinder.Object;
        ...
        public void GetMetadataForProperties_WithBindAttribute()
        {
            ...
            string[] returnedPropertyNames = propertyMetadatas.Select(o => o.PropertyName)
                .ToArray();
        ...
        public void GetRequiredPropertiesCollection_MixedAttributes()
        {
            ...
            MutableObjectModelBinder.GetRequiredPropertiesCollection(
                actionContext,
                bindingContext,
                out requiredProperties,
                out requiredValidators,
                out skipProperties
            );
        ...
        public void ProcessDto_RequiredFieldNull_RaisesModelError()
        {
            ...
            dto.Results[propertyMetadata] = new ComplexModelDtoResult(
                null,
                new ModelValidationNode(propertyMetadata, "theModel.City")
            );
        ...
        public void ProcessDto_Success()
        {
            ...
            PersonWithBindExclusion model = new PersonWithBindExclusion { DateOfBirth = dob };
            ModelMetadata containerMetadata = GetMetadataForObject(model);
        ...
        public void SetProperty_PropertyHasDefaultValue_SetsDefaultValue()
        {
            ...
            ModelValidator requiredValidator = context.GetValidators(propertyMetadata)
        ...
        public void SetProperty_PropertyIsSettable_SetterThrows_RecordsError()
        {
            ...
            // Assert
            Assert.Equal(
                "Date of death can't be before date of birth."
                    + Environment.NewLine
        ...
        public void SetProperty_SettingNullableTypeToNull_RequiredValidatorNotPresent_PropertySetterThrows_AddsRequiredMessageString()
        {
            ...
            // Assert
            Assert.False(bindingContext.ModelState.IsValid);
            ModelError modelError = Assert.Single(
