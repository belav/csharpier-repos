...
namespace System.Web.Http.ModelBinding
{
    public class CompositeModelBinderTest
    {
        ...
        public void BindModel_SuccessfulBind_RunsValidationAndReturnsModel()
        {
            ...
            mockIntBinder.Setup(o => o.BindModel(actionContext, It.IsAny<ModelBindingContext>()))
                .Returns(
        ...
        public void BindModel_UnsuccessfulBind_BinderFails_ReturnsNull()
        {
            ...
            mockListBinder.Setup(o => o.BindModel(actionContext, It.IsAny<ModelBindingContext>()))
                .Returns(false)
                .Verifiable();
