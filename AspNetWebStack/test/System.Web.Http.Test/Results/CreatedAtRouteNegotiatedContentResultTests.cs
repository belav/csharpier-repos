...
namespace System.Web.Http.Results
{
    public class CreatedAtRouteNegotiatedContentResultTests
    {
        ...
        public async Task ExecuteAsync_Returns_CorrectResponse_WhenContentNegotiationSucceeds()
        {
            ...
            spyUrlFactory.Setup(f => f.Link(expectedRouteName, expectedRouteValues))
        ...
        public async Task ExecuteAsync_Throws_WhenUrlHelperLinkReturnsNull_AfterContentNegotiationSucceeds()
        {
            ...
            stubUrlFactory.Setup(f => f.Link(expectedRouteName, expectedRouteValues))
                .Returns((string)null);
        ...
        public void ApiControllerCreatedAtRoute_WithStringAndDictionary_CreatesCorrectResult()
        {
            ...
            // Act
            CreatedAtRouteNegotiatedContentResult<object> result = controller.CreatedAtRoute(
                expectedRouteName,
                expectedRouteValues,
                expectedContent
            );
        ...
        private static CreatedAtRouteNegotiatedContentResult<object> CreateProductUnderTest(
            string routeName,
