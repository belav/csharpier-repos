...
namespace System.Web.Http.Tracing.Tracers
{
    public class AuthorizationFilterTracerTest
    {
        ...
        public async Task ExecuteAuthorizationFilterAsync_Traces()
        {
            ...
            AuthorizationFilterTracer tracer = new AuthorizationFilterTracer(
                mockFilter.Object,
                traceWriter
            );
        ...
        public void Inner_Property_On_AuthorizationFilterTracer_Returns_IAuthorizationFilter()
        {
            ...
            AuthorizationFilterTracer productUnderTest = new AuthorizationFilterTracer(
                expectedInner,
                new TestTraceWriter()
            );
        ...
        public void Decorator_GetInner_On_AuthorizationFilterTracer_Returns_IAuthorizationFilter()
        {
            ...
            // Act
            IAuthorizationFilter actualInner = Decorator.GetInner(
                productUnderTest as IAuthorizationFilter
            );
