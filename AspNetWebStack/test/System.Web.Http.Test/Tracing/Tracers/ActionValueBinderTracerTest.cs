...
namespace System.Web.Http.Tracing.Tracers
{
    public class ActionValueBinderTracerTest
    {
        ...
        public void GetBinding_Returns_HttpActionBindingTracer()
        {
            ...
            Mock<HttpParameterDescriptor> mockParameterDescriptor =
            ...
            HttpActionBinding actionBinding = new HttpActionBinding(
                ...
                new HttpParameterBinding[] { mockParameterBinding.Object }
            );
            ...
            mockBinder.Setup(b => b.GetBinding(It.IsAny<HttpActionDescriptor>()))
                .Returns(actionBinding);
            ActionValueBinderTracer tracer = new ActionValueBinderTracer(
                mockBinder.Object,
                new TestTraceWriter()
            );
        ...
        public void GetBinding_Invokes_Inner_And_Returns_ActionBinder_With_Tracing_FormatterParameterBinding()
        {
            ...
            Mock<HttpParameterDescriptor> mockParameterDescriptor =
                new Mock<HttpParameterDescriptor>() { CallBase = true };
            Mock<FormatterParameterBinding> mockParameterBinding =
                new Mock<FormatterParameterBinding>(
                    mockParameterDescriptor.Object,
            ...
            Assert.IsAssignableFrom<FormatterParameterBindingTracer>(
                actualBinding.ParameterBindings[0]
            );
        }
        ...
        public void GetBinding_DoesNotWrapHttpActionBindingTracer()
        {
            ...
            HttpActionBindingTracer actionBindingTracer = new HttpActionBindingTracer(
                actionBinding,
                traceWriter
            );
            Mock<IActionValueBinder> mockBinder = new Mock<IActionValueBinder>()
