...
namespace System.Web.Http.Tracing.Tracers
{
    public class HttpActionInvokerTracerTest
    {
        ...
        public void InvokeActionAsync_Invokes_Inner_InvokeActionAsync()
        {
            ...
            IHttpActionInvoker invoker = new HttpActionInvokerTracer(
                mockInnerInvoker.Object,
                new Mock<ITraceWriter>().Object
            );
            ...
            // Assert
            mockInnerInvoker.Verify(
                i => i.InvokeActionAsync(_actionContext, cts.Token),
                Times.Once()
            );
        }
        ...
        public async Task InvokeActionAsync_Traces_Begin_And_End_Info()
        {
            ...
            HttpActionInvokerTracer tracer = new HttpActionInvokerTracer(
                new ApiControllerActionInvoker(),
                traceWriter
            );
        ...
        public void Decorator_GetInner_On_HttpActionInvokerTracer_Returns_IHttpActionInvoker()
        {
            ...
            // Act
            IHttpActionInvoker actualInner = Decorator.GetInner(
                productUnderTest as IHttpActionInvoker
            );
