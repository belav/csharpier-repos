...
namespace System.Web.Http.Metadata.Providers
{
    public class DataAnnotationsModelMetadataProviderTest
    {
        ...
        public void DataAnnotationsNameTests(string propertyName, string expected)
        {
            ...
            // Act
            var actual = provider.GetMetadataForProperty(null, typeof(DisplayModel), propertyName)
                .GetDisplayName();
        ...
        public void DisplayAttribute_WithLocalizedName()
        {
            ...
            // Act
            var actual = provider.GetMetadataForProperty(null, typeof(DisplayModel), "Localized")
                .GetDisplayName();
