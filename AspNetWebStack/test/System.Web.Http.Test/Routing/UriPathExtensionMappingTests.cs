...
namespace System.Net.Http.Formatting
{
    public class UriPathExtensionMappingTests
    {
        ...
        )
        {
            ...
            HttpRequestMessage request = GetRequestWithExtInRouteData(
                uriPathExtension.ToLowerInvariant()
            );
            Assert.Equal(1.0, mapping.TryMatchMediaType(request));
        }
        ...
        public void TryMatchMediaType_Returns_ZeroWithExtensionNotInRouteData(
            string uriPathExtension,
            string mediaType,
            string baseUriString
        )
