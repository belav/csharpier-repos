...
namespace System.Web.TestUtil
{
    public static class MemberHelper
    {
        ...
        private static PropertyInfo GetPropertyInfo(object instance, string propertyName)
        {
            ...
            PropertyInfo propInfo = instance
                .GetType()
                .GetProperty(
                    propertyName,
            ...
            where TAttribute : Attribute
        {
            ...
            if (attributeValue == null)
            {
                Assert.True(
                    attrs.Length == 0,
                    "Member should not have an attribute of type " + typeof(TAttribute)
                );
            }
            else
            {
        ...
        public static void TestBooleanProperty(
            object instance,
            string propertyName,
            bool initialValue,
        ...
        public static void TestEvent<TEventArgs>(
            object instance,
            string eventName,
            ...
            where TEventArgs : EventArgs
        {
            ...
            MethodInfo methodInfo = GetMethodInfo(
                instance,
                "On" + eventName,
                attrs: MethodAttributes.Family | MethodAttributes.Virtual
            );
            ...
            EventHandler<TEventArgs> handler = new EventHandler<TEventArgs>(
                delegate(object sender, TEventArgs t)
                {
        ...
        public static void TestEnumProperty<TEnumValue>(
            object instance,
            string propertyName,
        ...
        public static void TestInt32Property(
            object instance,
            string propertyName,
            int value1,
            int value2
        ...
        public static void TestPropertyWithDefaultInstance(
            object instance,
            string propertyName,
            object valueToSet
        )
        ...
        public static void TestStringParams(
            object instance,
        ...
        private static void TestStringParams(
            MethodBase method,
            object instance,
            object[] parameters
        )
