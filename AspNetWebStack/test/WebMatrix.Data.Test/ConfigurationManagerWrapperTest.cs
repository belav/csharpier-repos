...
namespace WebMatrix.Data.Test
{
    public class ConfigurationManagerWrapperTest
    {
        ...
        public void GetConnectionGetsConnectionFromConfig()
        {
            ...
            Func<string, IConnectionConfiguration> getFromConfig =
                name => new MockConnectionConfiguration("connection string");
        ...
        public void GetConnectionSdfAndMdfFile_MdfFileWins()
        {
            ...
            mockSdfHandler
                .Setup(m => m.GetConnectionConfiguration(@"DataDirectory\Bar.sdf"))
                .Returns(new MockConnectionConfiguration("sdf connection"));
            var mockMdfHandler = new Mock<MockDbFileHandler>();
            mockMdfHandler
                .Setup(m => m.GetConnectionConfiguration(@"DataDirectory\Bar.mdf"))
