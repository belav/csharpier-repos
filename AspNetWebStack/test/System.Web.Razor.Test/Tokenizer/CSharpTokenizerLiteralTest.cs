...
namespace System.Web.Razor.Test.Tokenizer
{
    public class CSharpTokenizerLiteralTest : CSharpTokenizerTestBase
    {
        ...
        public void Trailing_Letter_Is_Not_Part_Of_Integer_Literal_If_Not_Type_Sufix()
        {
            TestTokenizer(
                "42a",
                new CSharpSymbol(0, 0, 0, "42", CSharpSymbolType.IntegerLiteral),
                IgnoreRemaining
            );
        }
        ...
        public void Trailing_Letter_Is_Not_Part_Of_Hex_Literal_If_Not_Type_Sufix()
        {
            TestTokenizer(
                "0xDEADBEEFz",
                new CSharpSymbol(0, 0, 0, "0xDEADBEEF", CSharpSymbolType.IntegerLiteral),
                IgnoreRemaining
            );
        }
        ...
        public void Dot_Followed_By_Non_Digit_Is_Not_Part_Of_Real_Literal()
        {
            TestTokenizer(
                "3.a",
                new CSharpSymbol(0, 0, 0, "3", CSharpSymbolType.IntegerLiteral),
                IgnoreRemaining
            );
        }
        ...
        public void Simple_Real_Literal_Is_Recognized()
        {
            TestTokenizer(
                "3.14159",
                new CSharpSymbol(0, 0, 0, "3.14159", CSharpSymbolType.RealLiteral)
            );
        }
        ...
        public void Real_Literal_Between_Zero_And_One_Is_Recognized()
        {
            TestTokenizer(
                ".14159",
                new CSharpSymbol(0, 0, 0, ".14159", CSharpSymbolType.RealLiteral)
            );
        }
        ...
        public void Character_Literal_Is_Terminated_By_EOL_If_Unterminated()
        {
            TestTokenizer(
                "'foo\n",
                new CSharpSymbol(0, 0, 0, "'foo", CSharpSymbolType.CharacterLiteral),
                IgnoreRemaining
            );
        }
        ...
        public void String_Literal_Is_Terminated_By_EOL_If_Unterminated()
        {
            TestTokenizer(
                "\"foo\n",
                new CSharpSymbol(0, 0, 0, "\"foo", CSharpSymbolType.StringLiteral),
                IgnoreRemaining
            );
        }
