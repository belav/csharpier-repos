            ...
            ParseDocumentTest(
                ...
                new MarkupBlock(
                    ...
                    new ExpressionBlock(
                        ...
                        Factory.Code("foo(").AsImplicitExpression(VBCodeParser.DefaultKeywords),
                        new CommentBlock(
                            Factory
                                .CodeTransition(VBSymbolType.RazorCommentTransition)
                                .Accepts(AcceptedCharacters.None),
                            Factory
                                .MetaCode("*", VBSymbolType.RazorCommentStar)
                                .Accepts(AcceptedCharacters.None),
                            Factory
                                .Span(
                                    SpanKind.Comment,
                        ...
                        Factory.EmptyVB().AsImplicitExpression(VBCodeParser.DefaultKeywords)
                    )
                ),
                new RazorError(
                    String.Format(
            ...
            ParseDocumentTest(
                ...
                new RazorError(
                    String.Format(
                        ...
                        SyntaxConstants.VB.EndCodeKeyword
                    ),
                    1,
                    0,
                    1
