...
namespace System.Web.Razor.Test.Parser.VB
{
    public class VBSpecialKeywordsTest : VBHtmlCodeParserTestBase
    {
        ...
        public void ParseInheritsStatementMarksInheritsSpanAsCanGrowIfMissingTrailingSpace()
        {
            ParseBlockTest(
                "inherits",
                new DirectiveBlock(Factory.MetaCode("inherits")),
                new RazorError(
        ...
        {
            ParseBlockTest(
                "inherits Foo.Bar(Of Biz(Of Qux), String, Integer).Baz",
                new DirectiveBlock(
                    Factory.MetaCode("inherits ").Accepts(AcceptedCharacters.None),
                    Factory
                        .Code("Foo.Bar(Of Biz(Of Qux), String, Integer).Baz")
        ...
        public void ParseBlockShouldSupportNamespaceImports()
        {
            ParseBlockTest(
                ...
                new DirectiveBlock(
                    Factory
                        .MetaCode("Imports Foo.Bar.Baz.Biz.Boz")
                        .With(
        ...
        {
            ParseBlockTest(
                "Imports" + Environment.NewLine + "Foo",
                new DirectiveBlock(
                    Factory
                        .MetaCode("Imports\r\n")
                        .With(
                ...
                new RazorError(RazorResources.ParseError_NamespaceOrTypeAliasExpected, 7, 0, 7)
            );
        }
        ...
        {
            ParseBlockTest(
                "Imports Foo =" + Environment.NewLine + "System.Bar",
                new DirectiveBlock(
                    Factory
                        .MetaCode("Imports Foo =\r\n")
                        .With(
                            new AddImportCodeGenerator(
                                ns: " Foo =\r\n",
                                namespaceKeywordLength: SyntaxConstants.VB.ImportsKeywordLength
        ...
        public void ParseBlockThrowsErrorIfOptionStrictIsNotFollowedByOnOrOff()
        {
            ParseBlockTest(
                ...
                new DirectiveBlock(
                    Factory
                        .MetaCode("Option Strict Yes")
                        .With(SetVBOptionCodeGenerator.Strict(true))
                ),
                new RazorError(
                    String.Format(RazorResources.ParseError_InvalidOptionValue, "Strict", "Yes"),
                    14,
                    0,
                    14
                )
        ...
        {
            ParseBlockTest(
                "Option Strict On Foo Bar Baz",
                new DirectiveBlock(
                    Factory.MetaCode("Option Strict On").With(SetVBOptionCodeGenerator.Strict(true))
                )
            );
        }
        ...
        {
            ParseBlockTest(
                "Option Explicit On Foo Bar Baz",
                new DirectiveBlock(
                    Factory
                        .MetaCode("Option Explicit On")
        ...
        {
            ParseBlockTest(
                "Option Explicit Off Foo Bar Baz",
                new DirectiveBlock(
                    Factory
