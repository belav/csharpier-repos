...
namespace System.Web.Razor.Test.Parser.VB
{
    public class VBBlockTest : VBHtmlCodeParserTestBase
    {
        ...
        {
            ParseBlockTest(
                "If True Then" + Environment.NewLine + "    @foo" + Environment.NewLine + "End If",
                new StatementBlock(
        ...
        public void ParseBlockAcceptsIfStatementWithinCodeBlockIfInDesignTimeMode()
        {
            ParseBlockTest(
                ...
                new StatementBlock(
                    ...
                    Factory.Code(@"End If").AsStatement().Accepts(AcceptedCharacters.None)
                )
            );
        }
        ...
        {
            ParseBlockTest(
                "for each p in db.Query(\"SELECT * FROM PRODUCTS\")"
                    + Environment.NewLine
                    + "    @<p>@p.Name</p>"
                    + Environment.NewLine
                    + "next",
                new StatementBlock(
                    Factory
                        .Code("for each p in db.Query(\"SELECT * FROM PRODUCTS\")\r\n")
                        .AsStatement(),
                    new MarkupBlock(
                        Factory.Markup("    "),
        ...
        {
            ParseBlockTest(
                "Code" + Environment.NewLine + "    Bar End" + Environment.NewLine + "End Code",
                new StatementBlock(
                    Factory.MetaCode("Code").Accepts(AcceptedCharacters.None),
                    Factory.Code("\r\n    Bar End\r\n").AsStatement(),
                    Factory.MetaCode("End Code").Accepts(AcceptedCharacters.None)
            ...
            ParseBlockTest(
                ...
                new FunctionsBlock(
                    ...
                    Factory
                        .Code("\r\n    Bar End\r\n")
                        .AsFunctionsBody()
                        .AutoCompleteWith(null, atEndOfSpan: false),
                    Factory.MetaCode("End Functions").Accepts(AcceptedCharacters.None)
                )
            );
        }
        ...
        public void KeywordAllowsNewlinesIfPrefixedByUnderscore(
            string startKeyword,
            string endKeyword1,
            string endKeyword2
        )
        {
            ...
            ParseBlockTest(
                code + "foo bar baz",
                new StatementBlock(
                    Factory.Code(code).AsStatement().Accepts(AcceptedCharacters.None)
                )
            );
        }
        ...
        public void EndTerminatedKeywordRequiresSpaceBetweenEndAndKeyword(
            string startKeyword,
            ...
            ParseBlockTest(
                ...
                new StatementBlock(
                    Factory
                        .Code(code)
                        .AsStatement()
                        .Accepts(GetAcceptedCharacters(acceptToEndOfLine))
                )
            );
        }
        ...
        [InlineData("With", "End With", false)]
        [InlineData("Using", "End Using", false)]
        private void CommentedEndSequence(
            string keyword,
            string endSequence,
        ...
        private void KeywordWithExitOrContinue(
            string startKeyword,
            string exitKeyword,
            string endKeyword,
            bool acceptToEndOfLine
