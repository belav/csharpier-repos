...
namespace System.Web.Razor.Test.Parser.VB
{
    public class VBAutoCompleteTest : VBHtmlCodeParserTestBase
    {
        ...
        {
            ParseBlockTest(
                "@Helper Strong(value As String)",
                new HelperBlock(
                    new HelperCodeGenerator(
                        new LocationTagged<string>("Strong(value As String)", 8, 0, 8),
                        headerComplete: true
                    ),
                    Factory.CodeTransition(),
                    Factory.MetaCode("Helper ").Accepts(AcceptedCharacters.None),
                    Factory
                        .Code("Strong(value As String)")
                        .Hidden()
        ...
        {
            ParseBlockTest(
                "@Helper Strong(value As String)" + Environment.NewLine + "Foo",
                new HelperBlock(
                    new HelperCodeGenerator(
                        new LocationTagged<string>("Strong(value As String)", 8, 0, 8),
                        headerComplete: true
        ...
        {
            ParseBlockTest(
                "@Section Header" + Environment.NewLine + "Foo",
                new SectionBlock(
                    new SectionCodeGenerator("Header"),
                    Factory.CodeTransition(),
                    Factory
                    ...
                    new MarkupBlock(Factory.Markup("\r\nFoo").With(new MarkupCodeGenerator()))
                ),
                new RazorError(
                    String.Format(
                        RazorResources.ParseError_BlockNotTerminated,
