    ...
    public class VBHelperTest : VBHtmlMarkupParserTestBase
    {
                ...
                new MarkupBlock(
                    ...
                    new HelperBlock(
                        new HelperCodeGenerator(
                            new LocationTagged<string>("()", 8, 0, 8),
                            headerComplete: true
                        ),
        ...
        public void ParseHelperStatementMarksHelperSpanAsCanGrowIfMissingTrailingSpace()
        {
            ParseDocumentTest(
                ...
                new MarkupBlock(
                    Factory.EmptyHtml(),
                    new HelperBlock(Factory.CodeTransition(), Factory.MetaCode("Helper"))
                ),
                new RazorError(
                    String.Format(
                        RazorResources.ParseError_Unexpected_Character_At_Helper_Name_Start,
        ...
        {
            ParseDocumentTest(
                "@Helper" + Environment.NewLine + "@Helper",
                new MarkupBlock(
                    Factory.EmptyHtml(),
                    new HelperBlock(
                        Factory.CodeTransition(),
        ...
        {
            ParseDocumentTest(
                "@Helper Foo()" + Environment.NewLine + "end helper",
                new MarkupBlock(
                    Factory.EmptyHtml(),
                    new HelperBlock(
                        new HelperCodeGenerator(
                            new LocationTagged<string>("Foo()", 8, 0, 8),
                            headerComplete: true
                        ),
                        Factory.CodeTransition(),
                        Factory.MetaCode("Helper ").Accepts(AcceptedCharacters.None),
        ...
        public void ParseHelperStatementCapturesAllContentToEndOfFileIfHelperStatementMissingCloseParenInParameterList()
        {
            ParseDocumentTest(
                ...
                new MarkupBlock(
                    ...
                    new HelperBlock(
                        new HelperCodeGenerator(
                            new LocationTagged<string>("Foo(Foo Bar\r\nBiz\r\nBoz", 8, 0, 8),
                            headerComplete: false
                        ),
                        Factory.CodeTransition(),
                        Factory.MetaCode("Helper ").Accepts(AcceptedCharacters.None),
        ...
        {
            ParseDocumentTest(
                "@Helper Foo(foo as String)    " + Environment.NewLine,
                new MarkupBlock(
                    Factory.EmptyHtml(),
                    new HelperBlock(
                        new HelperCodeGenerator(
                            new LocationTagged<string>("Foo(foo as String)", 8, 0, 8),
                            headerComplete: true
                        ),
                        Factory.CodeTransition(),
                        Factory.MetaCode("Helper ").Accepts(AcceptedCharacters.None),
                        Factory
                            .Code("Foo(foo as String)")
                            .Hidden()
                            .AutoCompleteWith(SyntaxConstants.VB.EndHelperKeyword),
                        new StatementBlock(Factory.Code("    \r\n").AsStatement())
                    )
                ),
                new RazorError(
                    String.Format(
        ...
        {
            ParseDocumentTest(
                "@Helper Foo(foo as String)" + Environment.NewLine + "    @<p>Foo</p>",
                new MarkupBlock(
                    Factory.EmptyHtml(),
                    new HelperBlock(
                        new HelperCodeGenerator(
        ...
        {
            ParseDocumentTest(
                "@Helper Foo(foo as String, bar as String)"
                    + Environment.NewLine
                    + "    @<p>@foo</p>"
                    + Environment.NewLine
                    + "End Helper",
                    ...
                    new HelperBlock(
                        new HelperCodeGenerator(
                            new LocationTagged<string>(
                                "Foo(foo as String, bar as String)",
                                8,
                                0,
                                8
                            ),
        ...
        public void ParseHelperStatementGivesWhitespaceAfterCloseParenToMarkup()
        {
            ParseDocumentTest(
                ...
                new MarkupBlock(
                    ...
                    new HelperBlock(
                        new HelperCodeGenerator(
                            new LocationTagged<string>("Foo(string foo)", 8, 0, 8),
                            headerComplete: true
                        ),
                        Factory.CodeTransition(),
                        Factory.MetaCode("Helper ").Accepts(AcceptedCharacters.None),
                ...
                new MarkupBlock(
                    ...
                    new HelperBlock(
                        ...
                        new StatementBlock(
                            ...
                            new HelperBlock(
                                new HelperCodeGenerator(
                                    new LocationTagged<string>("Bar(string baz)", 37, 1, 12),
                                    headerComplete: true
                                ),
                                Factory.CodeTransition(),
                                Factory.MetaCode("Helper ").Accepts(AcceptedCharacters.None),
