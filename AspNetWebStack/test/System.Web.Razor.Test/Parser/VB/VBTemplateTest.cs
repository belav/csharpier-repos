    ...
    public class VBTemplateTest : VBHtmlCodeParserTestBase
    {
        ...
        private TemplateBlock TestTemplate()
        {
            return new TemplateBlock(
                new TemplateBlockCodeGenerator(),
                new MarkupBlock(
        ...
        private const string TestNestedTemplateCode =
            "@@<p>Foo #@Html.Repeat(10,@@<p>@item</p>)</p>";
        ...
        {
            ParseBlockTest(
                "Html.Repeat(10," + TestTemplateCode + "," + TestTemplateCode + ")",
                new ExpressionBlock(
                    Factory.Code("Html.Repeat(10,").AsImplicitExpression(KeywordSet),
                    TestTemplate(),
        ...
        private static RazorError GetNestedSectionError(
            int absoluteIndex,
            int lineIndex,
            int characterIndex
        )
