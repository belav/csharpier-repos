                ...
                new MarkupBlock(
                    ...
                    new MarkupBlock(
                        new AttributeBlockCodeGenerator(
                            ...
                            new LocationTagged<string>("'", 22, 0, 22)
                        ),
                    ...
                    new SectionBlock(
                        ...
                        new MarkupBlock(
                            ...
                            new MarkupBlock(
                                new AttributeBlockCodeGenerator(
                                    "href",
                                    new LocationTagged<string>(" href='", 17, 0, 17),
                                    new LocationTagged<string>("'", 37, 0, 37)
                                ),
                                Factory.Markup(" href='").With(SpanCodeGenerator.Null),
                                Factory
                                    .Markup("~/Foo/Bar/Baz")
                ...
                new MarkupBlock(
                    ...
                    new MarkupBlock(
                        ...
                        Factory
                            ...
                            .With(
                                new LiteralAttributeCodeGenerator(
                                    new LocationTagged<string>(String.Empty, 18, 0, 18),
                                    new LocationTagged<string>("/Baz", 18, 0, 18)
                                )
                            ),
                        Factory.Markup("'").With(SpanCodeGenerator.Null)
                    ),
                        ...
                        new MarkupBlock(
                            ...
                            new MarkupBlock(
                                ...
                                Factory
                                    ...
                                    .With(
                                        new LiteralAttributeCodeGenerator(
                                            new LocationTagged<string>(String.Empty, 33, 0, 33),
                                            new LocationTagged<string>("/Baz", 33, 0, 33)
                                        )
                                    ),
                                Factory.Markup("'").With(SpanCodeGenerator.Null)
                            ),
                ...
                new MarkupBlock(
                    ...
                    new MarkupBlock(
                        new AttributeBlockCodeGenerator(
                            "href",
                            new LocationTagged<string>(" href='", 2, 0, 2),
                            new LocationTagged<string>("'", 31, 0, 31)
                        ),
                        Factory.Markup(" href='").With(SpanCodeGenerator.Null),
                        Factory
                            .Markup("~/Foo+Bar:Baz(Biz),Boz")
                            .WithEditorHints(EditorHints.VirtualPath)
                            .With(
                                new LiteralAttributeCodeGenerator(
                                    new LocationTagged<string>(String.Empty, 9, 0, 9),
                ...
                new MarkupBlock(
                    ...
                    new MarkupBlock(
                        new AttributeBlockCodeGenerator(
                            "href",
                            new LocationTagged<string>(" href=", 2, 0, 2),
                            new LocationTagged<string>(String.Empty, 38, 0, 38)
                        ),
                        Factory.Markup(" href=").With(SpanCodeGenerator.Null),
                        Factory
                            .Markup("~/Foo+Bar:Baz(Biz),Boz/")
                        ...
                        new MarkupBlock(
                            new DynamicAttributeBlockCodeGenerator(
                                new LocationTagged<string>(String.Empty, 31, 0, 31),
                                31,
                                0,
                                31
                            ),
                        ...
                        Factory
                            ...
                            .With(
                                new LiteralAttributeCodeGenerator(
                                    ...
                                    new LocationTagged<string>("/Boz", 34, 0, 34)
                                )
                            )
                    ),
                    Factory.Markup(" />").Accepts(AcceptedCharacters.None)
                        ...
                        new MarkupBlock(
                            ...
                            new MarkupBlock(
                                new AttributeBlockCodeGenerator(
                                    "href",
                                    new LocationTagged<string>(" href=", 17, 0, 17),
                                    new LocationTagged<string>(String.Empty, 53, 0, 53)
                                ),
                                Factory.Markup(" href=").With(SpanCodeGenerator.Null),
                                Factory
                                    .Markup("~/Foo+Bar:Baz(Biz),Boz/")
                                ...
                                new MarkupBlock(
                                    new DynamicAttributeBlockCodeGenerator(
                                        new LocationTagged<string>(String.Empty, 46, 0, 46),
                                        46,
                                        0,
                                        46
                                    ),
                                ...
                                Factory
                                    ...
                                    .With(
                                        new LiteralAttributeCodeGenerator(
                                            new LocationTagged<string>(String.Empty, 49, 0, 49),
                                            new LocationTagged<string>("/Boz", 49, 0, 49)
                                        )
                                    )
                            ),
                            Factory.Markup(" /> ")
