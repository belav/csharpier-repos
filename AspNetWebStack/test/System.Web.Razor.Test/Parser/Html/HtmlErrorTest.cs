    ...
    public class HtmlErrorTest : CsHtmlMarkupParserTestBase
    {
        ...
        public void ParseBlockStartingWithEndTagProducesRazorErrorThenOutputsMarkupSegmentAndEndsBlock()
        {
            ParseBlockTest(
                ...
                new RazorError(
                    String.Format(RazorResources.ParseError_UnexpectedEndTag, "foo"),
                    SourceLocation.Zero
                )
            );
        }
        ...
        public void ParseBlockWithUnclosedTopLevelTagThrowsMissingEndTagParserExceptionOnOutermostUnclosedTag()
        {
            ParseBlockTest(
                "<p><foo></bar>",
                new MarkupBlock(Factory.Markup("<p><foo></bar>").Accepts(AcceptedCharacters.None)),
                new RazorError(
                    String.Format(RazorResources.ParseError_MissingEndTag, "p"),
        ...
        public void ParseBlockWithUnclosedTagAtEOFThrowsMissingEndTagException()
        {
            ParseBlockTest(
                ...
                new MarkupBlock(Factory.Markup("<foo>blah blah blah blah blah")),
                new RazorError(
        ...
        public void ParseBlockWithUnfinishedTagAtEOFThrowsIncompleteTagException()
        {
            ParseBlockTest(
                ...
                new MarkupBlock(
                    ...
                    new MarkupBlock(
                        new AttributeBlockCodeGenerator(
                            ...
                            new LocationTagged<string>(String.Empty, 12, 0, 12)
                        ),
                ...
                new RazorError(
                    String.Format(RazorResources.ParseError_UnfinishedTag, "foo"),
                    new SourceLocation(0, 0, 0)
                )
            );
        }
