    ...
    public class HtmlBlockTest : CsHtmlMarkupParserTestBase
    {
        ...
        public void ParseBlockHandlesOpenAngleWithProperTagFollowingIt()
        {
            ParseDocumentTest(
                ...
                {
                    new RazorError(
                        String.Format(RazorResources.ParseError_UnexpectedEndTag, "html"),
                        7,
                        2,
                        0
                    ),
        ...
        public void TagWithoutCloseAngleDoesNotTerminateBlock()
        {
            ParseBlockTest(
                ...
                expectedErrors: new RazorError(
                    String.Format(RazorResources.ParseError_UnfinishedTag, String.Empty),
                    0,
                    0,
                    0
                )
                ...
                new MarkupBlock(
                    ...
                    new MarkupBlock(
                        new AttributeBlockCodeGenerator(
                            "bar",
                            new LocationTagged<string>(" bar=\"", 4, 0, 4),
                        ...
                        Factory
                            ...
                            .With(
                                new LiteralAttributeCodeGenerator(
                                    new LocationTagged<string>(String.Empty, 10, 0, 10),
                                    new LocationTagged<string>("baz", 10, 0, 10)
                                )
                            ),
                    ...
                    new MarkupBlock(
                        new AttributeBlockCodeGenerator(
                            "zoop",
                            new LocationTagged<string>(" zoop=", 24, 0, 24),
                            new LocationTagged<string>(String.Empty, 34, 0, 34)
                        ),
                        ...
                        Factory
                            ...
                            .With(
                                new LiteralAttributeCodeGenerator(
                                    new LocationTagged<string>(String.Empty, 30, 0, 30),
                                    new LocationTagged<string>("zork", 30, 0, 30)
                                )
                            )
                    ),
            ...
            ParseBlockTest(
                ...
                new MarkupBlock(
                    ...
                    new MarkupBlock(
                        new AttributeBlockCodeGenerator(
                            "baz",
                            new LocationTagged<string>(" baz=\"", 9, 0, 9),
                            new LocationTagged<string>("\"", 16, 0, 16)
                        ),
                        ...
                        Factory
                            ...
                            .With(
                                new LiteralAttributeCodeGenerator(
                                    new LocationTagged<string>(String.Empty, 15, 0, 15),
                                    new LocationTagged<string>(">", 15, 0, 15)
                                )
                            ),
                        Factory.Markup("\"").With(SpanCodeGenerator.Null)
                    ),
        ...
        public void ParseBlockTerminatesAtEOF()
        {
            SingleSpanBlockTest(
                ...
                SpanKind.Markup,
                new RazorError(
                    String.Format(RazorResources.ParseError_MissingEndTag, "foo"),
        ...
        {
            ParseBlockTest("<text/>", new MarkupBlock(Factory.MarkupTransition("<text/>")));
        }
        ...
        public void ParseBlockStopsParsingMidEmptyTagIfEOFReached()
        {
            ParseBlockTest(
                "<br/",
                new MarkupBlock(Factory.Markup("<br/")),
                new RazorError(
                    String.Format(RazorResources.ParseError_UnfinishedTag, "br"),
                    SourceLocation.Zero
                )
            );
        }
