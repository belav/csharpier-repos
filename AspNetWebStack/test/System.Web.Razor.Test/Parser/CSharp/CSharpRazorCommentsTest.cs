    ...
    public class CSharpRazorCommentsTest : CsHtmlMarkupParserTestBase
    {
        ...
        public void UnterminatedRazorComment()
        {
            ParseDocumentTest(
                ...
                new MarkupBlock(
                    ...
                    new CommentBlock(
                        Factory
                            .MarkupTransition(HtmlSymbolType.RazorCommentTransition)
                            .Accepts(AcceptedCharacters.None),
                        Factory
                            .MetaMarkup("*", HtmlSymbolType.RazorCommentStar)
                            .Accepts(AcceptedCharacters.None),
                        Factory
                            .Span(
                                SpanKind.Comment,
            ...
            ParseDocumentTest(
                ...
                new MarkupBlock(
                    ...
                    new ExpressionBlock(
                        ...
                        new CommentBlock(
                            Factory
                                .CodeTransition(CSharpSymbolType.RazorCommentTransition)
                                .Accepts(AcceptedCharacters.None),
                            Factory
                                .MetaCode("*", CSharpSymbolType.RazorCommentStar)
                                .Accepts(AcceptedCharacters.None),
                            Factory
                                .Span(
                                    SpanKind.Comment,
        ...
        public void RazorCommentInVerbatimBlock()
        {
            ParseDocumentTest(
                ...
                new RazorError(
                    String.Format(RazorResources.ParseError_MissingEndTag, "text"),
                    8,
                    1,
                    4
                ),
