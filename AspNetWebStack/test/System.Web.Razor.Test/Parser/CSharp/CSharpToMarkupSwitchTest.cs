...
namespace System.Web.Razor.Test.Parser.CSharp
{
    public class CSharpToMarkupSwitchTest : CsHtmlCodeParserTestBase
    {
        ...
        {
            ParseBlockTest(
                "Foo(    " + Environment.NewLine + "@:<p>Foo</p>    " + Environment.NewLine + ")",
                new ExpressionBlock(
                    Factory
                        .Code("Foo(    \r\n")
                        .AsImplicitExpression(CSharpCodeParser.DefaultKeywords),
        ...
        {
            ParseBlockTest(
                "{" + Environment.NewLine + "    <p>Foo</p>    " + Environment.NewLine + "}",
                new StatementBlock(
                    Factory.MetaCode("{").Accepts(AcceptedCharacters.None),
                    Factory.Code("\r\n    ").AsStatement(),
        ...
        {
            ParseBlockTest(
                "Repeat(10," + Environment.NewLine + "    @: @{}" + Environment.NewLine + ")",
                new ExpressionBlock(
                    Factory
                        .Code("Repeat(10,\r\n    ")
                        .AsImplicitExpression(CSharpCodeParser.DefaultKeywords),
        ...
        public void ParseBlockParsesMarkupStatementOnSwitchCharacterFollowedByColon()
        {
            // Arrange
            ParseBlockTest(
                "if(foo) { @:Bar" + Environment.NewLine + "} zoop",
                new StatementBlock(
                    Factory.Code("if(foo) {").AsStatement(),
                    new MarkupBlock(
                        Factory.Markup(" "),
