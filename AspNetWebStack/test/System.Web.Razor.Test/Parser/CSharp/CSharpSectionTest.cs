    ...
    public class CSharpSectionTest : CsHtmlMarkupParserTestBase
    {
        ...
        public void ParseSectionBlockCapturesNewlineImmediatelyFollowing()
        {
            ParseDocumentTest(
                ...
                new MarkupBlock(
                    Factory.EmptyHtml(),
                    new SectionBlock(
                        new SectionCodeGenerator(String.Empty),
                    ...
                    new SectionBlock(
                        ...
                        new MarkupBlock(
                            ...
                            new SectionBlock(
                                ...
                                Factory.CodeTransition(),
                                Factory
                                    .MetaCode("section bar {")
                                    .AutoCompleteWith(null, atEndOfSpan: true),
                                new MarkupBlock(Factory.Markup(" <p>Foo</p> ")),
        ...
        public void ParseSectionBlockHandlesEOFAfterOpenBrace()
        {
            ParseDocumentTest(
                ...
                new RazorError(String.Format(RazorResources.ParseError_Expected_X, "}"), 14, 0, 14)
            );
        }
        ...
        public void ParseSectionBlockHandlesUnterminatedSection()
        {
            ParseDocumentTest(
                ...
                new RazorError(String.Format(RazorResources.ParseError_Expected_X, "}"), 27, 0, 27)
            );
        }
            ...
            ParseDocumentTest(
                ...
                new MarkupBlock(
                    ...
                    new SectionBlock(
                        ...
                        new MarkupBlock(
                            Factory.Markup(
                                " I really want to render a close brace, so here I go: "
                            ),
                            new ExpressionBlock(
                                Factory.CodeTransition(),
                                Factory.MetaCode("(").Accepts(AcceptedCharacters.None),
            ...
            ParseDocumentTest(
                ...
                new MarkupBlock(
                    ...
                    new SectionBlock(
                        ...
                        Factory.CodeTransition(),
                        Factory.MetaCode("section foo {").AutoCompleteWith(null, atEndOfSpan: true),
                        new MarkupBlock(Factory.Markup("something")),
                        Factory.MetaCode("}").Accepts(AcceptedCharacters.None)
                    ),
                    Factory.EmptyHtml()
                )
        ...
        public void ParseSectionBlockParsesComment()
        {
            ParseDocumentTest(
                ...
                new MarkupBlock(
                    Factory.EmptyHtml(),
                    new SectionBlock(
                        new SectionCodeGenerator("s"),
                        Factory.CodeTransition(),
                        Factory.MetaCode("section s {").AutoCompleteWith(null, atEndOfSpan: true),
                        new MarkupBlock(Factory.Markup("<!-- -->")),
                        Factory.MetaCode("}").Accepts(AcceptedCharacters.None)
                    ),
                    Factory.EmptyHtml()
            ...
            ParseDocumentTest(
                ...
                new MarkupBlock(
                    ...
                    new SectionBlock(
                        ...
                        new MarkupBlock(
                            Factory.Markup(
                                Environment.NewLine + "<a" + Environment.NewLine + "<!--  > \" '-->"
                            )
                        ),
                        Factory.MetaCode("}").Accepts(AcceptedCharacters.None)
                    ),
            ...
            ParseDocumentTest(
                ...
                new MarkupBlock(
                    ...
                    new SectionBlock(
                        ...
                        Factory.CodeTransition(),
                        Factory.MetaCode("section s {").AutoCompleteWith(null, atEndOfSpan: true),
                        new MarkupBlock(Factory.Markup(" <? xml bleh ?>")),
                        Factory.MetaCode("}").Accepts(AcceptedCharacters.None)
                    ),
                    Factory.EmptyHtml()
                )
