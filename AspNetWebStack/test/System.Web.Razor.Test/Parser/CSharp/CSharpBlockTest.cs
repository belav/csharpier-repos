    ...
    zoop();
        ...
        public void NestedCodeBlockWithAtCausesError()
        {
            ParseBlockTest(
                ...
                new RazorError(
                    String.Format(RazorResources.ParseError_Unexpected_Keyword_After_At, "if"),
...
// Bar
    ...
    Debug.WriteLine(@""bar } baz""); 
            ...
            ParseBlockTest(
                document,
                new StatementBlock(
                    Factory.Code(expected).AsStatement().Accepts(AcceptedCharacters.None)
                )
            );
        }
    ...
    default:
        ...
        public void ParseBlockTerminatesBlockCommentAtEndOfFile()
        {
            ...
            SingleSpanBlockTest(
                ...
                SpanKind.Code,
                new RazorError(
                    String.Format(RazorResources.ParseError_BlockComment_Not_Terminated),
                    24,
                    0,
                    24
                ),
...
// Bar
        ...
        public void ParseBlockSupportsMarkupWithinCatchClause()
        {
            RunSimpleWrappedMarkupTest(
                "try { var foo = new { } } catch(Foo Bar Baz) {",
                " <p>Foo</p> ",
                "}"
            );
        }
        ...
        public void ParseBlockStopsParsingCatchClausesAfterFinallyBlock()
        {
            ...
            SingleSpanBlockTest(
                expectedContent + " catch(Foo Bar Baz) { }",
                expectedContent,
                BlockType.Statement,
                SpanKind.Code,
                acceptedCharacters: AcceptedCharacters.None
        ...
        public void ParseBlockDoesNotParseMarkupStatementOrExpressionOnSwitchCharacterNotFollowedByOpenAngleOrColon()
        {
            ...
            ParseBlockTest(
                "if(foo) { @\"Foo\".ToString(); }",
                new StatementBlock(Factory.Code("if(foo) { @\"Foo\".ToString(); }").AsStatement())
            );
        }
                            ...
                            new MarkupBlock(
                                ...
                                new MarkupBlock(
                                    new AttributeBlockCodeGenerator(
                                        "href",
                                        new LocationTagged<string>(" href=\"", 193, 5, 30),
                                        new LocationTagged<string>("\"", 256, 5, 93)
                                    ),
                                    Factory.Markup(" href=\"").With(SpanCodeGenerator.Null),
                                    new MarkupBlock(
                                        new DynamicAttributeBlockCodeGenerator(
                                            new LocationTagged<string>(String.Empty, 200, 5, 37),
                                            200,
                                            5,
                                            37
                                        ),
        ...
        private void RunSimpleWrappedMarkupTest(
            string prefix,
            string markup,
            string suffix,
            AcceptedCharacters acceptedCharacters = AcceptedCharacters.Any
        )
        {
            ParseBlockTest(
                ...
                new StatementBlock(
                    ...
                    new MarkupBlock(Factory.Markup(markup).Accepts(AcceptedCharacters.None)),
