    ...
    public class CSharpAutoCompleteTest : CsHtmlCodeParserTestBase
    {
            ...
            ParseBlockTest(
                ...
                new HelperBlock(
                    new HelperCodeGenerator(
                        new LocationTagged<string>("Strong(string value) {", 8, 0, 8),
                        headerComplete: true
                    ),
        ...
        public void SectionDirectiveAutoCompleteAtEOF()
        {
            ParseBlockTest(
                ...
                new RazorError(String.Format(RazorResources.ParseError_Expected_X, "}"), 17, 0, 17)
            );
        }
        ...
        public void SectionDirectiveAutoCompleteAtStartOfFile()
        {
            ParseBlockTest(
                ...
                new RazorError(String.Format(RazorResources.ParseError_Expected_X, "}"), 29, 1, 10)
            );
        }
