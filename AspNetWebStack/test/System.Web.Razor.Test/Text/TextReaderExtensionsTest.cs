...
namespace System.Web.Razor.Test.Text
{
    public class TextReaderExtensionsTest
    {
        ...
        {
            Assert.ThrowsArgumentNull(
                () => TextReaderExtensions.ReadUntil(null, c => true),
                "reader"
            );
        }
        ...
        {
            Assert.ThrowsArgumentNull(
                () => TextReaderExtensions.ReadWhile(null, c => true, inclusive: true),
                "reader"
            );
        }
        ...
        public void ReadWhileWithPredicateThrowsArgNullIfPredicateNull()
        {
            Assert.ThrowsArgumentNull(
                () =>
                    TextReaderExtensions.ReadWhile(new StringReader("Foo"), (Predicate<char>)null),
                "condition"
            );
        }
