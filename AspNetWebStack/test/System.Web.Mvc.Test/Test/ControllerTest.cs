...
namespace System.Web.Mvc.Test
{
    ...
    public class ControllerTest
    {
        ...
        public void RequestProperty()
        {
            ...
            Mock<ControllerContext> mockControllerContext = new Mock<ControllerContext>();
            mockControllerContext.Setup(cc => cc.Controller).Returns(c);
            mockControllerContext.Setup(cc => cc.HttpContext.Request)
        ...
        public void ResponseProperty()
        {
            ...
            Mock<ControllerContext> mockControllerContext = new Mock<ControllerContext>();
            mockControllerContext.Setup(cc => cc.Controller).Returns(c);
            mockControllerContext.Setup(cc => cc.HttpContext.Response)
        ...
        public void ServerProperty()
        {
            ...
            Mock<ControllerContext> mockControllerContext = new Mock<ControllerContext>();
            mockControllerContext.Setup(cc => cc.Controller).Returns(c);
            mockControllerContext.Setup(cc => cc.HttpContext.Server)
        ...
        public void SessionProperty()
        {
            ...
            Mock<ControllerContext> mockControllerContext = new Mock<ControllerContext>();
            mockControllerContext.Setup(cc => cc.Controller).Returns(c);
            mockControllerContext.Setup(cc => cc.HttpContext.Session)
        ...
        public void RedirectToRouteSimpleOverridesCallLegacyMethod()
        {
            ...
            Mock<Controller> controllerMock = new Mock<Controller>();
            controllerMock.Setup(
                c => c.RedirectToRoute(It.IsAny<string>(), It.IsAny<RouteValueDictionary>())
            )
                .Callback(
                    () =>
                    {
        ...
        public void TempDataMovedToPreviousTempDataInDestinationController()
        {
            ...
            mockDestinationController.Object.TempData
                .Load(
            ...
            mockSecondDestinationController.Object.TempData
                .Load(
        ...
        public void CreateActionInvokerCallsAsyncActionInvokerFactoryCreateInstance()
        {
            ...
            asyncActionInvokerFactoryMock.Setup(a => a.CreateInstance())
        ...
        public void CreateActionInvokerCallsActionInvokerFactoryCreateInstance()
        {
            ...
            actionInvokerFactoryMock.Setup(a => a.CreateInstance())
        ...
        public void CreateActionInvokerCallsIntoResolverInstance()
        {
            ...
            resolverMock.Setup(r => r.GetService(typeof(IAsyncActionInvoker)))
                .Returns(actionInvokerMock.Object);
            controller.Resolver = resolverMock.Object;
        ...
        public void CreateTempProviderWithResolver()
        {
            ...
            resolverMock.Setup(r => r.GetService(typeof(ITempDataProvider)))
        ...
        public void CreateTempProviderWithResolver_ITempDataProviderFactory()
        {
            ...
            resolverMock.Setup(r => r.GetService(typeof(ITempDataProvider)))
                .Returns(tempMock.Object);
            resolverMock.Setup(r => r.GetService(typeof(ITempDataProviderFactory)))
