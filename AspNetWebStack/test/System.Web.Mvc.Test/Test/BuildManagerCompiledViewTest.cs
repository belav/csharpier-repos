...
namespace System.Web.Mvc.Test
{
    public class CompiledTypeViewTest
    {
        ...
        {
            // Arrange
            TestableBuildManagerCompiledView view = new TestableBuildManagerCompiledView(
        ...
        {
            // Act
            BuildManagerCompiledView view = new TestableBuildManagerCompiledView(
                new ControllerContext(),
                "view path"
            );
        ...
        public void ViewCreationConsultsSetActivator()
        {
            ...
            activator.Setup(a => a.Create(controllerContext, typeof(object)))
        ...
        public void ViewCreationDelegatesToDependencyResolverWhenActivatorIsNull()
        {
            ...
            dependencyResolver.Setup(dr => dr.GetService(typeof(object)))
                .Returns(viewInstance)
                .Verifiable();
            var view = new TestableBuildManagerCompiledView(
                controllerContext,
                "view path",
        ...
        {
            public TestableBuildManagerCompiledView(
