...
namespace System.Web.Mvc.Test
{
    public class ReflectedActionDescriptorTest
    {
        ...
        public void ConstructorSetsActionNameProperty()
        {
            ...
            // Act
            ReflectedActionDescriptor ad = new ReflectedActionDescriptor(
        ...
        public void ExecuteCallsMethodInfoOnSuccess()
        {
            ...
            ReflectedActionDescriptor ad = GetActionDescriptor(
                typeof(ConcatController).GetMethod("Concat")
            );
        ...
        public void GetCustomAttributesWithAttributeTypeCallsMethodInfoGetCustomAttributes()
        {
            ...
            object[] expected = new object[0];
            Mock<MethodInfo> mockMethod = new Mock<MethodInfo>();
            mockMethod.Setup(mi => mi.GetCustomAttributes(typeof(ObsoleteAttribute), true))
                .Returns(expected);
            ReflectedActionDescriptor ad = GetActionDescriptor(mockMethod.Object);
        ...
        public void GetParametersWrapsParameterInfos()
        {
            ...
            ReflectedParameterDescriptor pDesc0 =
                pDescsFirstCall[0] as ReflectedParameterDescriptor;
            ReflectedParameterDescriptor pDesc1 =
                pDescsFirstCall[1] as ReflectedParameterDescriptor;
        ...
        public void GetSelectorsWrapsSelectorAttributes()
        {
            ...
            mockAttr.Setup(attr => attr.IsValidForRequest(controllerContext, mockMethod.Object))
                .Returns(true)
                .Verifiable();
            mockMethod.Setup(
