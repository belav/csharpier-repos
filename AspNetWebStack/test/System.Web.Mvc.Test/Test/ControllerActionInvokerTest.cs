...
namespace System.Web.Mvc.Test
{
    ...
    public class ControllerActionInvokerTest
    {
        ...
        public void CreateActionResultWithActionResultParameterReturnsParameterUnchanged()
        {
            ...
            // Act
            ActionResult returnedActionResult = invoker.PublicCreateActionResult(
                null,
                null,
                originalResult
            );
        ...
        public void FindAction()
        {
            ...
            // Act
            ActionDescriptor returnedAd = helper.PublicFindAction(
                controllerContext,
                mockCd.Object,
                "someAction"
            );
        ...
        public void FindActionDoesNotMatchMethodsDefinedOnControllerType()
        {
            ...
            foreach (var method in methods)
            {
                ...
                finally
                {
                    Assert.False(
                        wasFound,
                        "FindAction() should return false for methods defined on the Controller class: "
                            + method
                    );
                }
            }
        ...
        public void GetParameterValueAllowsAllSubpropertiesIfBindAttributeNotSpecified()
        {
            ...
            // Act
            object valueWithoutBindAttribute = helper.PublicGetParameterValue(
                controllerContext,
                pd
            );
        ...
        public void GetParameterValueResolvesConvertersInCorrectOrderOfPrecedence()
        {
            ...
            // Act
            object valueWithOneConverter = helper.PublicGetParameterValue(
                controllerContext,
                pdOneConverter
            );
            object valueWithNoConverters = helper.PublicGetParameterValue(
                controllerContext,
                pdNoConverters
            );
        ...
        public void GetParameterValueRespectsBindAttributePrefixOnComplexType()
        {
            ...
            // Act
            MySimpleModel parameterValue =
                helper.PublicGetParameterValue(controllerContext, pd) as MySimpleModel;
        ...
        public void GetParameterValueRespectsDefaultValueAttribute()
        {
            ...
            // Act
            object valueWithDefaultValueAttribute = helper.PublicGetParameterValue(
                controllerContext,
                pd
            );
        ...
        public void GetParameterValuesCallsGetParameterValue()
        {
            ...
            mockHelper
                .Setup(h => h.PublicGetParameterValue(context, pds[0]))
                .Returns("Myfoo")
                .Verifiable();
            mockHelper
                .Setup(h => h.PublicGetParameterValue(context, pds[1]))
                .Returns("Mybar")
                .Verifiable();
            mockHelper
                .Setup(h => h.PublicGetParameterValue(context, pds[2]))
                .Returns("Mybaz")
                .Verifiable();
        ...
        public void InvokeAction()
        {
            ...
            AuthenticationChallengeContext authenticationChallengeContext =
                new AuthenticationChallengeContext() { Result = challengeResult };

            Mock<ControllerActionInvokerHelper> mockHelper =
                new Mock<ControllerActionInvokerHelper>() { CallBase = true };
            mockHelper
                .Setup(h => h.PublicGetControllerDescriptor(context))
                .Returns(cd)
                .Verifiable();
            mockHelper
                .Setup(h => h.PublicFindAction(context, cd, "SomeMethod"))
                .Returns(ad)
                .Verifiable();
            ...
            mockHelper
                ...
                .Verifiable();
            mockHelper
                .Setup(h => h.PublicGetParameterValues(context, ad))
                .Returns(parameters)
                .Verifiable();
            mockHelper
                .Setup(h =>
        ...
        public void InvokeActionCallsValidateRequestIfAsked()
        {
            ...
            Mock<ControllerActionInvokerHelper> mockHelper =
                new Mock<ControllerActionInvokerHelper>();
        ...
        public void InvokeActionMethodFilterWhereContinuationThrowsExceptionAndIsHandled()
        {
            ...
            ActionExecutingContext context = new ActionExecutingContext(
                GetControllerContext(new EmptyController()),
                action,
                parameters
            );

            // Act
            ActionExecutedContext result = ControllerActionInvoker.InvokeActionMethodFilter(
                filter,
                context,
                continuation
            );
        ...
        public void InvokeActionInvokesExceptionFiltersAndExecutesResultIfExceptionHandled()
        {
            ...
            mockHelper
                .Setup(h =>
                    h.PublicInvokeExceptionFilters(context, filterInfo.ExceptionFilters, exception)
                )
                .Returns(exContext)
                .Verifiable();
        ...
        public void InvokeActionInvokesExceptionFiltersAndRethrowsExceptionIfNotHandled()
        {
            ...
            mockHelper
                ...
                .Verifiable();
            mockHelper
                .Setup(h => h.PublicInvokeActionResult(context, It.IsAny<ActionResult>()))
                .Callback(
                    delegate
                    {
                        Assert.True(
                            false,
                            "InvokeActionResult() shouldn't be called if the exception was unhandled by filters."
                        );
                    }
                );
            ControllerActionInvokerHelper helper = mockHelper.Object;
        ...
        public void InvokeActionInvokesResultIfAuthenticationFilterReturnsResult()
        {
            ...
            AuthenticationChallengeContext authenticationChallengeContext =
                new AuthenticationChallengeContext() { Result = challengeActionResult };
            ...
            mockHelper
                ...
                .Verifiable();
            mockHelper
                .Setup(h => h.PublicInvokeActionResult(context, challengeActionResult))
                .Verifiable();
            ControllerActionInvokerHelper helper = mockHelper.Object;
        ...
        public void InvokeActionInvokesResultIfAuthorizationFilterReturnsResult()
        {
            ...
            mockHelper
                ...
                .Verifiable();
            mockHelper
                .Setup(h => h.PublicInvokeActionResult(context, challengeResult))
                .Verifiable();
            ControllerActionInvokerHelper helper = mockHelper.Object;
        ...
        public void InvokeActionMethod()
        {
            ...
            mockHelper
                .Setup(h =>
                    h.PublicCreateActionResult(controllerContext, mockAd.Object, "hello world")
                )
                .Returns(expectedResult);
            ControllerActionInvokerHelper helper = mockHelper.Object;

            // Act
            ActionResult returnedResult = helper.PublicInvokeActionMethod(
                controllerContext,
                mockAd.Object,
                parameters
            );
        ...
        public void InvokeActionMethodWithFiltersOrdersFiltersCorrectly()
        {
            ...
            ControllerContext context = GetControllerContext(controller);
            ActionDescriptor actionDescriptor = new ReflectedActionDescriptor(
                ContinuationController.GoMethod,
                "someName",
                new Mock<ControllerDescriptor>().Object
            );
            ControllerActionInvokerHelper helper = new ControllerActionInvokerHelper();
            ...
            // Act
            helper.PublicInvokeActionMethodWithFilters(
                context,
                filters,
                actionDescriptor,
                parameters
        ...
        public void InvokeActionMethodWithFiltersPassesArgumentsCorrectly()
        {
            ...
            // Act
            ActionExecutedContext result = helper.PublicInvokeActionMethodWithFilters(
                context,
                filters,
                actionDescriptor,
                parameters
        ...
        public void InvokeActionWithResultExceptionInvokesExceptionFiltersAndExecutesResultIfExceptionHandled()
        {
            ...
            AuthorizationContext authorizationContext = new AuthorizationContext();
            AuthenticationChallengeContext authenticationChallengeContext =
                new AuthenticationChallengeContext();
        ...
        public void InvokeAuthorizationFilters()
        {
            ...
            // Act
            AuthorizationContext postContext = helper.PublicInvokeAuthorizationFilters(
                controllerContext,
                filters,
                ad
            );
        ...
        public void InvokeAuthenticationFilters()
        {
            ...
            {
                // Act
                postContext = helper.PublicInvokeAuthenticationFilters(
                    controllerContext,
                    filters,
                    ad
                );
        ...
        public void InvokeAuthenticationFiltersSetsThreadCurrentPrincipalWhenPrincipalIsProvided()
        {
            ...
            {
                // Act
                AuthenticationContext postContext = helper.PublicInvokeAuthenticationFilters(
                    controllerContext,
                    filters,
                    ad
                );
        ...
        public void InvokeAuthenticationFiltersChallenge()
        {
            ...
            // Act
            AuthenticationChallengeContext postContext =
                helper.PublicInvokeAuthenticationFiltersChallenge(
                    controllerContext,
                    filters,
                    ad,
                    result
        ...
        public void InvokeExceptionFilters()
        {
            ...
            // Act
            ExceptionContext postContext = helper.PublicInvokeExceptionFilters(
                controllerContext,
                filters,
                exception
            );
        ...
        public void InvokeActionResultWithFiltersPassesArgumentsCorrectly()
        {
            ...
            // Act
            ResultExecutedContext result = helper.PublicInvokeActionResultWithFilters(
                context,
                filters,
                actionResult
            );
        ...
        public void InvokeActionResultWithFiltersPassesSameContextObjectToInnerFilters()
        {
            ...
            // Act
            ResultExecutedContext postContext = helper.PublicInvokeActionResultWithFilters(
                context,
                filters,
                result
            );
        ...
        public void InvokeActionResultWithFiltersWhereContinuationThrowsExceptionAndIsHandled()
        {
            ...
            // Act
            ResultExecutedContext result = helper.PublicInvokeActionResultWithFilters(
                mockResultExecutingContext.Object,
                filters,
                actionResult
            );
        ...
        public void InvokeActionResultWithFiltersWhereContinuationThrowsExceptionAndIsNotHandled()
        {
            ...
            Assert.Throws<Exception>(
                delegate
                {
                    helper.PublicInvokeActionResultWithFilters(
                        mockResultExecutingContext.Object,
                        filters,
                        actionResult
                    );
        ...
        public void FindAction_MultipleMethodsSameActionOneWithRouteAttributeAndRouteWasMatched_ReturnsMethodWithRoutingAttribute()
        {
            ...
            // Act
            ActionDescriptor actionDescriptor = actionInvoker.PublicFindAction(
                context,
        ...
        public void FindAction_ControllerLevelDirectRoute_FindsMatch()
        {
            ...
            // Act
            ActionDescriptor actionDescriptor = invoker.PublicFindAction(
                context,
                controllerDescriptor,
                actionName: null
            );
            ...
            // Assert
            Assert.Equal(
                typeof(AttributeRoutingOnTheController).GetMethod("Action1"),
                matchedMethod
            );
        }
        ...
        )
        {
            ...
            mockControllerContext
                .SetupGet(c => c.HttpContext.Session)
...
#pragma warning restore 0067
        ...
        public class ControllerActionInvokerHelper : ControllerActionInvoker
        {
            ...
            public virtual ActionResult PublicCreateActionResult(
                ControllerContext controllerContext,
                ActionDescriptor actionDescriptor,
                object actionReturnValue
            )
            ...
            public virtual ActionResult PublicInvokeActionMethod(
                ControllerContext controllerContext,
                ActionDescriptor actionDescriptor,
            ...
            public virtual ActionExecutedContext PublicInvokeActionMethodWithFilters(
                ControllerContext controllerContext,
            ...
            public virtual ResultExecutedContext PublicInvokeActionResultWithFilters(
                ControllerContext controllerContext,
            ...
            private class MyConverter : IModelBinder
            {
                ...
                )
                {
                    string s = String.Format(
                        ...
                        bindingContext.PropertyFilter("bar")
                    );
                    return s;
                }
            }
