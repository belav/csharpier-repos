...
namespace System.Web.Mvc.Test
{
    public class ModelValidatorProviderCollectionTest
    {
        ...
        public void ModelBinderValidatorCollectionCombinedItemsDelegatesToResolver()
        {
            ...
            resolver.Setup(r => r.GetServices(typeof(ModelValidatorProvider)))
        ...
        public void GetValidators()
        {
            ...
            provider1.Setup(p => p.GetValidators(metadata, controllerContext))
            ...
            provider2.Setup(p => p.GetValidators(metadata, controllerContext))
                .Returns(
        ...
        public void GetValidatorsDelegatesToResolver()
        {
            ...
            resolverProvider1.Setup(p => p.GetValidators(metadata, controllerContext))
                .Returns(new ModelValidator[] { allValidators[0], allValidators[1] });

            Mock<ModelValidatorProvider> resolverprovider2 = new Mock<ModelValidatorProvider>();
            resolverprovider2.Setup(p => p.GetValidators(metadata, controllerContext))
