...
namespace System.Web.Mvc.Test
{
    public class ViewEngineCollectionTest
    {
        ...
        public void ViewEngineCollectionCombinedItemsInsertResetsCache()
        {
            TestCacheReset(
                (collection) =>
                    collection.Insert(0, new Mock<IViewEngine>(MockBehavior.Strict).Object)
            );
        }
        ...
        {
            TestCacheReset(
                (collection) => collection[0] = new Mock<IViewEngine>(MockBehavior.Strict).Object
            );
        }
        ...
        public void ViewEngineCollectionCombinedItemsDelegatesToResolver()
        {
            ...
            var expectedEngines = new IViewEngine[]
            {
                firstEngine.Object,
                secondEngine.Object,
                thirdEngine.Object
        ...
        public void FindPartialViewAggregatesAllSearchedLocationsIfAllEnginesFail()
        {
            ...
            engine1.Setup(e => e.FindPartialView(context, "partial", It.IsAny<bool>()))
            ...
            engine2.Setup(e => e.FindPartialView(context, "partial", It.IsAny<bool>()))
        ...
        public void FindPartialViewFailureWithOneEngine()
        {
            ...
            engine.Setup(e => e.FindPartialView(context, "partial", It.IsAny<bool>()))
        ...
        public void FindPartialViewLooksAtLocatorIfCacheEmpty()
        {
            ...
            engine.Setup(e => e.FindPartialView(context, "partial", true))
        ...
        public void FindPartialViewIgnoresSearchLocationsFromCache()
        {
            ...
            engine.Setup(e => e.FindPartialView(context, "partial", false))
        ...
        public void FindPartialViewRemovesDuplicateSearchedLocationsFromMultipleEngines()
        {
            ...
            Mock<IViewEngine> engine1 = new Mock<IViewEngine>();
            ViewEngineResult engine1Result = new ViewEngineResult(
                new[] { "repeatLocation", "location1" }
            );
            engine1.Setup(e => e.FindPartialView(context, "partial", It.IsAny<bool>()))
                .Returns(engine1Result);
            Mock<IViewEngine> engine2 = new Mock<IViewEngine>();
            ViewEngineResult engine2Result = new ViewEngineResult(
                new[] { "location2", "repeatLocation" }
            );
            engine2.Setup(e => e.FindPartialView(context, "partial", It.IsAny<bool>()))
                .Returns(engine2Result);
            ViewEngineCollection viewEngineCollection = new ViewEngineCollection()
        ...
        public void FindViewAggregatesAllSearchedLocationsIfAllEnginesFail()
        {
            ...
            engine1.Setup(e => e.FindView(context, "view", "master", It.IsAny<bool>()))
                .Returns(engine1Result);
            Mock<IViewEngine> engine2 = new Mock<IViewEngine>();
            ViewEngineResult engine2Result = new ViewEngineResult(
                new[] { "location3", "location4" }
            );
            engine2.Setup(e => e.FindView(context, "view", "master", It.IsAny<bool>()))
                .Returns(engine2Result);
            collection.Add(engine1.Object);
            collection.Add(engine2.Object);
        ...
        public void FindViewFailureWithOneEngine()
        {
            ...
            engine.Setup(e => e.FindView(context, "view", "master", It.IsAny<bool>()))
                .Returns(engineResult);
            collection.Add(engine.Object);
        ...
        public void FindViewLooksAtLocatorIfCacheEmpty()
        {
            ...
            engine.Setup(e => e.FindView(context, "view", "master", true))
                .Returns(new ViewEngineResult(new[] { "path" }));
        ...
        public void FindViewIgnoresSearchLocationsFromCache()
        {
            ...
            engine.Setup(e => e.FindView(context, "view", "master", true))
                .Returns(new ViewEngineResult(new[] { "cachePath" }));
            engine.Setup(e => e.FindView(context, "view", "master", false))
                .Returns(new ViewEngineResult(new[] { "locatorPath" }));
            ViewEngineCollection collection = new ViewEngineCollection() { engine.Object, };
        ...
        public void FindViewDelegatesToResolver()
        {
            ...
            var resolver = new Mock<IDependencyResolver>();
            resolver.Setup(r => r.GetServices(typeof(IViewEngine)))
                .Returns(new IViewEngine[] { locatedEngine.Object, secondEngine.Object });
            ...
            Assert.Same(engineResult, result);
            secondEngine.Verify(
                e => e.FindView(context, "ViewName", "MasterName", It.IsAny<bool>()),
                Times.Never()
            );
        }
        ...
        public void FindPartialViewDelegatesToResolver()
        {
            ...
            Assert.Same(engineResult, result);
            secondEngine.Verify(
                e => e.FindPartialView(context, "ViewName", It.IsAny<bool>()),
                Times.Never()
            );
        }
    }
