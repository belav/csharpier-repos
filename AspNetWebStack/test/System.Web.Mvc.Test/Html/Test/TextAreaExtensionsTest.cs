...
namespace System.Web.Mvc.Html.Test
{
    ...
    public class TextAreaExtensionsTest : IDisposable
    {
        ...
        public void TextArea_AttributeEncodes_Name(string text, bool htmlEncode, string encodedText)
        {
            ...
            var result = helper
                .TextArea(name: text, htmlAttributes: new { id = "id" })
                .ToHtmlString();
        ...
        )
        {
            ...
            // htmlAttributes included only to avoid special-cased renaming done for id attribute.
            var result = helper
                .TextArea(name: String.Empty, htmlAttributes: new { id = "id" })
                .ToHtmlString();
        ...
        )
        {
            ...
            // Act
            var result = helper
                .TextArea(name: "", htmlAttributes: new { attribute = text })
                .ToHtmlString();
        ...
        )
        {
            ...
            // htmlAttributes included only to avoid special-cased renaming done for id attribute.
            var result = helper
                .TextAreaFor(m => m, htmlAttributes: new { id = "id" })
                .ToHtmlString();
        ...
        )
        {
            ...
            // Act
            var result = helper
                .TextAreaFor(m => m, htmlAttributes: new { attribute = text })
                .ToHtmlString();
