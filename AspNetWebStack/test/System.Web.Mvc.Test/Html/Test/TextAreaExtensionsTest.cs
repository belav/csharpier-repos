...
namespace System.Web.Mvc.Html.Test
{
    ...
    public class TextAreaExtensionsTest : IDisposable
    {
        private static readonly RouteValueDictionary _textAreaAttributesDictionary =
            new RouteValueDictionary(new { rows = "15", cols = "12" });
        private static readonly object _textAreaAttributesObjectDictionary = new
        {
            rows = "15",
            cols = "12"
        };
        private static readonly object _textAreaAttributesObjectUnderscoresDictionary = new
        {
            rows = "15",
            cols = "12",
            foo_bar = "baz"
        ...
        {
            ViewDataDictionary<TextAreaModel> viewData = new ViewDataDictionary<TextAreaModel>
            {
                { "foo", "ViewDataFoo" }
            };
        ...
        public void TextAreaParameterDictionaryMerging()
        {
            ...
            // Assert
            Assert.Equal(
                "<textarea cols=\"20\" id=\"foo\" name=\"foo\" rows=\"30\">"
                    + Environment.NewLine
                    + "</textarea>",
                html.ToHtmlString()
            );
        ...
        public void TextAreaParameterDictionaryMergingExplicitParameters()
        {
            ...
            // Assert
            Assert.Equal(
                "<textarea cols=\"25\" id=\"foo\" name=\"foo\" rows=\"10\">"
                    + Environment.NewLine
                    + "bar</textarea>",
                html.ToHtmlString()
            );
        ...
        public void TextAreaParameterDictionaryMergingExplicitParametersWithUnderscores()
        {
            ...
            // Act
            MvcHtmlString html = helper.TextArea(
                "foo",
                "bar",
                10,
                25,
                new { rows = "30", foo_bar = "baz" }
            );

            // Assert
            Assert.Equal(
                "<textarea cols=\"25\" foo-bar=\"baz\" id=\"foo\" name=\"foo\" rows=\"10\">"
                    + Environment.NewLine
                    + "bar</textarea>",
                html.ToHtmlString()
            );
        ...
        public void TextArea_AttributeEncodes_Name(string text, bool htmlEncode, string encodedText)
        {
            ...
            var result = helper.TextArea(name: text, htmlAttributes: new { id = "id", })
                .ToHtmlString();
        ...
        [Theory]
        [PropertyData("AttributeEncodedData", PropertyType = typeof(EncodedDataSets))]
        public void TextArea_AttributeEncodes_Prefix(
            string text,
            bool htmlEncode,
            string encodedText
        )
        {
            ...
            // Act
            // htmlAttributes included only to avoid special-cased renaming done for id attribute.
            var result = helper.TextArea(name: String.Empty, htmlAttributes: new { id = "id", })
                .ToHtmlString();
        ...
        public void TextAreaWithExplicitValue()
        {
            ...
            // Assert
            Assert.Equal(
                "<textarea cols=\"20\" id=\"foo\" name=\"foo\" rows=\"2\">"
                    + Environment.NewLine
                    + "bar</textarea>",
                html.ToHtmlString()
            );
        ...
        [Theory]
        [PropertyData("HtmlEncodedData", PropertyType = typeof(EncodedDataSets))]
        public void TextAreaWithExplicitValue_HtmlEncodes_Value(
            string text,
            bool htmlEncode,
            string encodedText
        )
        ...
        public void TextAreaWithDotReplacementForId()
        {
            ...
            // Assert
            Assert.Equal(
                "<textarea cols=\"20\" id=\"foo_bar_baz\" name=\"foo.bar.baz\" rows=\"2\">"
                    + Environment.NewLine
                    + "</textarea>",
                html.ToHtmlString()
            );
        ...
        public void TextAreaWithObjectAttributes()
        {
            ...
            // Assert
            Assert.Equal(
                "<textarea cols=\"12\" id=\"foo\" name=\"foo\" rows=\"15\">"
                    + Environment.NewLine
                    + "ViewDataFoo</textarea>",
                html.ToHtmlString()
            );
        ...
        )
        {
            ...
            // Act
            var result = helper.TextArea(name: "", htmlAttributes: new { attribute = text, })
                .ToHtmlString();
        ...
        public void TextAreaWithObjectAttributesWithUnderscores()
        {
            ...
            MvcHtmlString html = helper.TextArea(
                "foo",
                _textAreaAttributesObjectUnderscoresDictionary
            );

            // Assert
            Assert.Equal(
                "<textarea cols=\"12\" foo-bar=\"baz\" id=\"foo\" name=\"foo\" rows=\"15\">"
                    + Environment.NewLine
                    + "ViewDataFoo</textarea>",
                html.ToHtmlString()
            );
        ...
        public void TextAreaWithExplicitValueAndObjectAttributes()
        {
            ...
            MvcHtmlString html = helper.TextArea(
                "foo",
                "Hello World",
                _textAreaAttributesObjectDictionary
            );
        ...
        public void TextAreaWithNoValueAndObjectAttributes()
        {
            ...
            // Assert
            Assert.Equal(
                "<textarea cols=\"12\" id=\"baz\" name=\"baz\" rows=\"15\">"
                    + Environment.NewLine
                    + "</textarea>",
                html.ToHtmlString()
            );
        ...
        public void TextAreaWithViewDataErrors()
        {
            ...
            // Assert
            Assert.Equal(
                "<textarea class=\"input-validation-error\" cols=\"12\" id=\"foo\" name=\"foo\" rows=\"15\">"
                    + Environment.NewLine
        ...
        [Theory]
        [PropertyData("AttributeEncodedData", PropertyType = typeof(EncodedDataSets))]
        public void TextAreaFor_AttributeEncodes_Prefix(
            string text,
            bool htmlEncode,
            string encodedText
        )
        {
            ...
            // Act
            // htmlAttributes included only to avoid special-cased renaming done for id attribute.
            var result = helper.TextAreaFor(m => m, htmlAttributes: new { id = "id", })
                .ToHtmlString();
        ...
        public void TextAreaForWithObjectAttributes()
        {
            ...
            // Act
            MvcHtmlString html = helper.TextAreaFor(
                m => m.foo,
                _textAreaAttributesObjectDictionary
            );
        ...
        )
        {
            ...
            // Act
            var result = helper.TextAreaFor(m => m, htmlAttributes: new { attribute = text, })
                .ToHtmlString();
        ...
        public void TextAreaForParameterDictionaryMergingWithDictionaryValues()
        {
            ...
            MvcHtmlString html = helper.TextAreaFor(
                ...
                10,
                25,
                new RouteValueDictionary(new { rows = "30" })
            );
        ...
        public void TextAreaHelperDoesNotEncodeInnerHtmlPrefix()
        {
            ...
            // Act
            MvcHtmlString html = TextAreaExtensions.TextAreaHelper(
                helper,
                metadata,
                "testEncoding",
                rowsAndColumns: null,
                htmlAttributes: null,
                innerHtmlPrefix: "<prefix>"
            );

            // Assert
            Assert.Equal(
                "<textarea id=\"testEncoding\" name=\"testEncoding\"><prefix>&lt;model&gt;</textarea>",
                html.ToHtmlString()
            );
        }
