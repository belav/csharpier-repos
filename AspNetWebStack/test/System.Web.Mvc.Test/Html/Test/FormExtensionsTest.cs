...
//]]>
        ...
        private static HtmlHelper GetFormHelper(out StringWriter writer)
        {
            ...
            mockViewContext.Setup(c => c.HttpContext.Request.Url)
            ...
            mockViewContext.Setup(c => c.HttpContext.Request.ServerVariables)
                .Returns((NameValueCollection)null);
            mockViewContext.Setup(c => c.HttpContext.Response.Write(It.IsAny<string>()))
