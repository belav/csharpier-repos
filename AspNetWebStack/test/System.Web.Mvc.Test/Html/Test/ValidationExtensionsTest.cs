...
namespace System.Web.Mvc.Html.Test
{
    ...
    public class ValidationExtensionsTest : IDisposable
    {
        ...
        )
        {
            ...
            // Act
            var result = helper.ValidationMessage(modelName: "name", validationMessage: text)
                .ToHtmlString();
        ...
        )
        {
            ...
            // Act
            var result = helper.ValidationMessageFor(m => name, validationMessage: text)
                .ToHtmlString();
        ...
        public void ValidationMessageFor_DoesNotEncode_Tag(string text, bool htmlEncode)
        {
            ...
            // Act
            var result = helper.ValidationMessageFor(m => name, validationMessage: null, tag: text)
                .ToHtmlString();
        ...
        public void ValidationSummary_DoesNotEncode_Tag(string text, bool htmlEncode)
        {
            ...
            // Act
            var result = helper.ValidationSummary(message: "message", headingTag: text)
                .ToHtmlString();
