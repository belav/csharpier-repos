...
namespace System.Web.Mvc.ExpressionUtil.Test
{
    public class HoistingExpressionVisitorTest
    {
        ...
        public void Hoist()
        {
            ...
            // Act
            Expression<Hoisted<string, int>> hoisted = HoistingExpressionVisitor<string, int>
                .Hoist(expr);
            ...
            ExpressionFingerprintChain fingerprint =
                FingerprintingExpressionVisitor.GetFingerprintChain(hoisted, out capturedConstants);
            ...
            FingerprintingExpressionVisitorTest.AssertChainEquals(
                fingerprint,
                new LambdaExpressionFingerprint(
                    ExpressionType.Lambda,
                    typeof(Hoisted<string, int>)
                ),
