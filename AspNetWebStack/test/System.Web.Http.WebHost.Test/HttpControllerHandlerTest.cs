...
namespace System.Web.Http.WebHost
{
    public class HttpControllerHandlerTest
    {
        ...
        {
            // Arrange
            HttpContextBase contextMock = CreateStubContextBase(
                "Post",
        ...
        public async Task ConvertRequest_WithBufferedPolicy_ReturnsInputStreamIfBufferedStreamWasFullyRead()
        {
            ...
            HttpRequestBase fakeRequest = CreateFakeRequestBase(
                () => bufferedStream,
                buffered: true
            );
            HttpContextBase context = CreateStubContextBase(request: fakeRequest, items: null);
            Mock<HttpRequestBase> mockRequest = Mock.Get<HttpRequestBase>(fakeRequest);
            mockRequest.SetupGet(f => f.InputStream).Returns(inputStream).Verifiable();
        ...
        public async Task ConvertRequest_DoesLazyGetBufferlessInputStream_IfRequestStreamHasNotBeenRead()
        {
            ...
            hostBufferPolicy
                .Setup(c => c.UseBufferedInputStream(It.IsAny<object>()))
                .Returns(false);
            hostBufferPolicy
                .Setup(c => c.UseBufferedOutputStream(It.IsAny<HttpResponseMessage>()))
                .Returns(true);
            ...
            HttpContextBase context = HttpControllerHandlerTest.CreateStubContextBase(
                request: stubRequest,
                items: null
            );

            // Act
            HttpRequestMessage actualRequest = HttpControllerHandler.ConvertRequest(
                context,
                hostBufferPolicy.Object
            );
        ...
        public Task ConvertRequest_WithBufferlessPolicy_ThrowsIfRequestStreamHasBeenReadInBufferedMode()
        {
            ...
            HttpRequestMessage message = HttpControllerHandler.ConvertRequest(
                context,
                hostBufferPolicy.Object
            );
        ...
        public async Task CopyResponseAsync_IfResponseHasCacheControlDefined_DoesNotSetCacheCacheabilityOnAspNetResponse()
        {
            ...
            // Assert
            contextMock.Verify(
                c => c.Response.Cache.SetCacheability(HttpCacheability.NoCache),
                Times.Never()
            );
        }
        ...
        public async Task ProcessRequestAsync_DisposesRequestAndResponse()
        {
            ...
            using (HttpMessageHandler handler = new LambdaHttpMessageHandler(sendAsync))
            {
                HttpControllerHandler product = new HttpControllerHandler(
                    new Mock<RouteData>(MockBehavior.Strict).Object,
                    handler
                );
        ...
        public void SuppressFormsAuthenticationRedirect_DoesntRequireSuppressRedirect()
        {
            ...
            responseMock
                .SetupSet(r => r.SuppressFormsAuthenticationRedirect = It.IsAny<bool>())
                .Verifiable();
            Mock<HttpContextBase> contextMock = new Mock<HttpContextBase>()
            {
                DefaultValue = DefaultValue.Mock,
        ...
        public void SuppressFormsAuthenticationRedirect_RequireSuppressRedirect()
        {
            ...
            responseMock
                .SetupSet<bool>(r => r.SuppressFormsAuthenticationRedirect = It.IsAny<bool>())
        ...
        public async Task CopyResponseAsync_Creates_Correct_HttpResponseBase()
        {
            ...
            Assert.StartsWith(
                ...
                responseBase.Headers["Content-Type"]
            );
        ...
        public async Task CopyResponseAsync_IfHandlerIsDefault_Returns_Error_Response_When_Formatter_Write_Task_Faults()
        {
            ...
            Assert.Equal(
                ...
                innerError["ExceptionType"].ToString()
            );
            Assert.Equal("Expected error", innerError["ExceptionMessage"]);
            Assert.Contains(
                MethodInfo.GetCurrentMethod().Name,
                innerError["StackTrace"].ToString()
            );
        }
        ...
        public async Task WriteStreamedResponseContentAsync_IfCopyToAsyncThrows_CallsExceptionLogger()
        {
            ...
            using (CancellationTokenSource tokenSource = new CancellationTokenSource())
            {
                ...
                // Act
                await HttpControllerHandler.WriteStreamedResponseContentAsync(
                    contextBase,
                    expectedRequest,
                    expectedResponse,
                    logger,
        ...
        public async Task WriteBufferedResponseContentAsync_IfCopyToAsyncThrowsAndHandlerHandles_ReturnsCompletedTask()
        {
            ...
            using (HttpResponseMessage response = new HttpResponseMessage())
            {
                ...
                // Act
                await HttpControllerHandler.WriteBufferedResponseContentAsync(
                    contextBase,
                    request,
                    response,
                    logger,
        ...
        public async Task PrepareHeadersAsync_IfTryComputeLengthThrows_CallsExceptionLogger()
        {
            ...
            using (CancellationTokenSource tokenSource = new CancellationTokenSource())
            {
                ...
                // Act
                await HttpControllerHandler.PrepareHeadersAsync(
                    responseBase,
                    expectedRequest,
                    expectedResponse,
                    logger,
        ...
        public async Task PrepareHeadersAsync_IfTryComputeLengthThrows_SetsEmptyErrorResponseAndReturnsFalse()
        {
            ...
            responseBaseMock
                .SetupSet((r) => r.SuppressContent = It.IsAny<bool>())
                .Callback<bool>((s) => suppressContent = s);
            HttpResponseBase responseBase = responseBaseMock.Object;
            ...
            using (HttpResponseMessage response = new HttpResponseMessage())
            {
                ...
                // Act
                bool result = await HttpControllerHandler.PrepareHeadersAsync(
                    responseBase,
                    request,
                    response,
                    logger,
        ...
        {
            // Arrange
            var request = CreateStubRequestBaseMock(
                "Ignore",
                new MemoryStream(),
                new MemoryStream()
            );
            ...
            var messageHandler = new LambdaHttpMessageHandler(
                (r, ct) =>
                {
        ...
        private static Task CopyResponseAsync(
        ...
        )
        {
            ...
            return HttpControllerHandler.CopyResponseAsync(
                contextBase,
                request,
                response,
                exceptionLogger,
        ...
        private static Mock<HttpRequestBase> CreateStubRequestBaseMock(
            string httpMethod,
        ...
        )
        {
            ...
            responseBaseMock
                .Setup(m => m.AppendHeader(It.IsAny<string>(), It.IsAny<string>()))
                .Callback<string, string>((s, v) => testHeaders.Add(s, v));
        ...
        private static Task WriteStreamedResponseContentAsync(
            HttpContextBase contextBase,
            HttpRequestMessage request,
            HttpResponseMessage response
        )
        {
            ...
            return HttpControllerHandler.WriteStreamedResponseContentAsync(
                contextBase,
                request,
                response,
                exceptionLogger,
