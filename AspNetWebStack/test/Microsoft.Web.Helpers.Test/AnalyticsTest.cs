...
namespace Microsoft.Web.Helpers.Test
{
    public class AnalyticsTest
    {
        ...
        public void GetStatCounterAnalyticsHtmlTest()
        {
            ...
            Assert.True(
                actual.Contains("statcounter.com/counter/counter_xhtml.js")
                    && actual.Contains(project.ToString())
                    && actual.Contains(security)
            );
        }
        ...
        public void GetGoogleAnalyticsHtmlTest()
        {
            ...
            Assert.True(
                actual.Contains("google-analytics.com/ga.js")
                    && actual.Contains("My_google_account")
            );
        }
