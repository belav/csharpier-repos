...
namespace Microsoft.Web.Mvc.Test
{
    public class SubmitImageExtensionsTest
    {
        ...
        {
            HtmlHelper html = MvcHelper.GetHtmlHelper(new ViewDataDictionary());
            MvcHtmlString button = html.SubmitImage(
                "specified-name",
                "/mvc.jpg",
                new { foo_bar = "baz" }
            );
            Assert.Equal(
                "<input foo-bar=\"baz\" id=\"specified-name\" name=\"specified-name\" src=\"/mvc.jpg\" type=\"image\" />",
                button.ToHtmlString()
            );
        }
        ...
        public void SubmitImageWithTypeAttributeRendersExplicitTypeAttribute()
        {
            ...
            Assert.Equal(
                "<input id=\"specified-name\" name=\"specified-name\" src=\"/mvc.jpg\" type=\"not-image\" />",
                button.ToHtmlString()
            );
        }
        ...
        public void SubmitImageWithNameAndImageUrlRendersNameAndSrcAttributes()
        {
            ...
            Assert.Equal(
                "<input id=\"button-name\" name=\"button-name\" src=\"/mvc.gif\" type=\"image\" />",
                button.ToHtmlString()
            );
        }
        ...
        public void SubmitImageWithImageUrlStartingWithTildeRendersAppPath()
        {
            ...
            MvcHtmlString button = html.SubmitImage("button-name", "~/mvc.gif");
            Assert.Equal(
                "<input id=\"button-name\" name=\"button-name\" src=\"/app/mvc.gif\" type=\"image\" />",
                button.ToHtmlString()
            );
        }
        ...
        public void SubmitImageWithNameAndIdRendersBothAttributesCorrectly()
        {
            ...
            Assert.Equal(
                "<input id=\"button-id\" name=\"button-name\" src=\"/mvc.png\" type=\"image\" />",
                button.ToHtmlString()
            );
        }
        ...
        public void SubmitButtonWithNameAndValueSpecifiedAndPassedInAsAttributeChoosesExplicitAttributes()
        {
            ...
            Assert.Equal(
                "<input id=\"specified-name\" name=\"name-attribute\" src=\"src-attribute\" type=\"image\" />",
                button.ToHtmlString()
            );
        }
    }
