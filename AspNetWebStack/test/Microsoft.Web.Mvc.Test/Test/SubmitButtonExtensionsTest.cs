...
namespace Microsoft.Web.Mvc.Test
{
    public class SubmitButtonExtensionsTest
    {
        ...
        public void SubmitButtonWithAttributesWithUnderscores()
        {
            ...
            Assert.Equal(
                "<input foo-bar=\"baz\" type=\"submit\" value=\"blah\" />",
                button.ToHtmlString()
            );
        }
        ...
        public void SubmitButtonWithNameRendersButtonWithNameAttribute()
        {
            ...
            Assert.Equal(
                "<input id=\"button-name\" name=\"button-name\" type=\"submit\" />",
                button.ToHtmlString()
            );
        }
        ...
        public void SubmitButtonWithIdDifferentFromNameRendersButtonWithId()
        {
            ...
            Assert.Equal(
                "<input id=\"foo\" name=\"button-name\" type=\"submit\" value=\"blah\" />",
                button.ToHtmlString()
            );
        }
        ...
        public void SubmitButtonWithNameAndTextRendersAttributes()
        {
            ...
            Assert.Equal(
                "<input id=\"button-name\" name=\"button-name\" type=\"submit\" value=\"button-text\" />",
                button.ToHtmlString()
            );
        }
        ...
        public void SubmitButtonWithNameAndValueRendersBothAttributes()
        {
            ...
            Assert.Equal(
                "<input id=\"button-id\" name=\"button-name\" type=\"submit\" value=\"button-value\" />",
                button.ToHtmlString()
            );
        }
        ...
        public void SubmitButtonWithTypeAttributeRendersCorrectType()
        {
            ...
            Assert.Equal(
                "<input id=\"specified-name\" name=\"specified-name\" type=\"not-submit\" value=\"button-value\" />",
                button.ToHtmlString()
            );
        }
        ...
        public void SubmitButtonWithNameAndValueSpecifiedAndPassedInAsAttributeChoosesSpecified()
        {
            ...
            MvcHtmlString button = html.SubmitButton(
                ...
                new RouteValueDictionary(
                    new { name = "name-attribute-value", value = "value-attribute" }
                )
            );
            Assert.Equal(
                "<input id=\"specified-name\" name=\"name-attribute-value\" type=\"submit\" value=\"value-attribute\" />",
                button.ToHtmlString()
            );
        }
    }
