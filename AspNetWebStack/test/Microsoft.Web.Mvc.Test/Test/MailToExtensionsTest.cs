...
namespace Microsoft.Web.Mvc.Test
{
    public class MailToExtensionsTest
    {
        ...
        public void MailToWithLinkTextAndEmailRendersProperElement()
        {
            ...
            Assert.Equal(
                "<a href=\"mailto:test@example.com\">This is a test</a>",
                result.ToHtmlString()
            );
        }
        ...
        {
            HtmlHelper html = MvcHelper.GetHtmlHelperWithPath(new ViewDataDictionary());
            MvcHtmlString result = html.Mailto(
                "This is a test",
                "test@example.com",
                new { title = "this is a test" }
            );
            Assert.Equal(
                "<a href=\"mailto:test@example.com\" title=\"this is a test\">This is a test</a>",
                result.ToHtmlString()
            );
        }
        ...
        public void MailToWithLinkTextEmailAndHtmlAttributesDictionaryRendersAttributes()
        {
            ...
            MvcHtmlString result = html.Mailto(
                "This is a test",
                "test@example.com",
                new RouteValueDictionary(new { title = "this is a test" })
            );
            Assert.Equal(
                "<a href=\"mailto:test@example.com\" title=\"this is a test\">This is a test</a>",
                result.ToHtmlString()
        ...
        public void MailToWithSubjectAndHtmlAttributesRendersAttributes()
        {
            ...
            Assert.Equal(
                "<a href=\"mailto:test@example.com?subject=The subject\" title=\"this is a test\">This is a test</a>",
                result.ToHtmlString()
            );
        }
        ...
        public void MailToAttributeEncodesEmail()
        {
            ...
            Assert.Equal(
                "<a href=\"mailto:te&quot;>st@example.com\">This is a test</a>",
                result.ToHtmlString()
            );
        }
        ...
        public void MailToWithMultipleRecipientsRendersWithCommas()
        {
            ...
            Assert.Equal(
                "<a href=\"mailto:te&quot;>st@example.com,test2@example.com\">This is a test</a>",
                result.ToHtmlString()
            );
        }
        ...
        public void MailToWithSubjectAppendsSubjectQuery()
        {
            ...
            Assert.Equal(
                "<a href=\"mailto:test@example.com?subject=This is the subject\">This is a test</a>",
                result.ToHtmlString()
            );
        }
        ...
        public void MailToWithCopyOnlyAppendsCopyQuery()
        {
            ...
            Assert.Equal(
                "<a href=\"mailto:test@example.com?cc=cctest@example.com\">This is a test</a>",
                result.ToHtmlString()
            );
        }
        ...
        public void MailToWithMultipartBodyRendersProperMailtoEncoding()
        {
            HtmlHelper html = MvcHelper.GetHtmlHelperWithPath(new ViewDataDictionary());
            string body =
                "Line one" + Environment.NewLine + "Line two" + Environment.NewLine + "Line three";
            ...
            Assert.Equal(
                "<a href=\"mailto:test@example.com?body=Line one%0ALine two%0ALine three\">email me</a>",
                result.ToHtmlString()
            );
        }
        ...
        public void MailToWithAllValuesProvidedRendersCorrectTag()
        {
            ...
            MvcHtmlString result = html.Mailto(
                ...
                "cc@example.com",
                "bcc@example.com",
                new { title = "email test" }
            );
            string expected =
                @"<a href=""mailto:test@example.com?subject=the subject&amp;cc=cc@example.com&amp;bcc=bcc@example.com&amp;body=Line one%0ALine two%0ALine three"" title=""email test"">email me</a>";
        ...
        public void MailToWithAttributesWithUnderscores()
        {
            ...
            string expected =
                @"<a foo-bar=""baz"" href=""mailto:test@example.com?subject=the subject&amp;cc=cc@example.com&amp;bcc=bcc@example.com&amp;body=Line one%0ALine two%0ALine three"">email me</a>";
            Assert.Equal(expected, result.ToHtmlString());
        }
    }
}
