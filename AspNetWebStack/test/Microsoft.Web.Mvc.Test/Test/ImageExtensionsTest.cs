...
namespace Microsoft.Web.Mvc.Test
{
    public class ImageExtensionsTest
    {
        ...
        public void ImageWithWithAttributesWithUnderscores()
        {
            ...
            Assert.Equal(
                "<img foo-bar=\"baz\" src=\"/system/web/mvc.jpg\" />",
                imageResult.ToHtmlString()
            );
        }
        ...
        public void ImageWithAltValueRendersImageWithAltTag()
        {
            ...
            Assert.Equal(
                "<img alt=\"this is an alt value\" src=\"/system/web/mvc.jpg\" title=\"this is an alt value\" />",
                imageResult.ToHtmlString()
            );
        }
        ...
        {
            HtmlHelper html = MvcHelper.GetHtmlHelperWithPath(new ViewDataDictionary());
            MvcHtmlString imageResult = html.Image(
                "/system/web/mvc.jpg",
                new { alt = "this is an alt value" }
            );
            Assert.Equal(
                "<img alt=\"this is an alt value\" src=\"/system/web/mvc.jpg\" title=\"this is an alt value\" />",
                imageResult.ToHtmlString()
        ...
        public void ImageWithAltValueHtmlAttributeEncodesAltTag()
        {
            ...
            MvcHtmlString imageResult = html.Image("/system/web/mvc.jpg", @"<"">");
            Assert.Equal(
                "<img alt=\"&lt;&quot;>\" src=\"/system/web/mvc.jpg\" title=\"&lt;&quot;>\" />",
                imageResult.ToHtmlString()
            );
        }
        ...
        public void ImageWithAltSpecifiedAndInDictionaryRendersExplicit()
        {
            ...
            MvcHtmlString imageResult = html.Image(
                "/system/web/mvc.jpg",
                "specified-alt",
                new { alt = "object-dictionary-alt" }
            );
            Assert.Equal(
                "<img alt=\"object-dictionary-alt\" src=\"/system/web/mvc.jpg\" title=\"object-dictionary-alt\" />",
                imageResult.ToHtmlString()
            );
        }
        ...
        public void ImageWithAltAndAttributesWithUnderscores()
        {
            ...
            Assert.Equal(
                "<img alt=\"specified-alt\" foo-bar=\"baz\" src=\"/system/web/mvc.jpg\" title=\"specified-alt\" />",
                imageResult.ToHtmlString()
            );
        }
        ...
        public void ImageWithOtherAttributesRendersThoseAttributesCaseSensitively()
        {
            ...
            MvcHtmlString imageResult = html.Image(
                "/system/web/mvc.jpg",
                new { width = 100, Height = 200 }
            );
            Assert.Equal(
                "<img Height=\"200\" src=\"/system/web/mvc.jpg\" width=\"100\" />",
                imageResult.ToHtmlString()
            );
        }
        ...
        public void ImageWithUrlAndDictionaryRendersAttributes()
        {
            ...
            Assert.Equal(
                "<img src=\"/system/web/mvc.jpg\" width=\"125\" />",
                imageResult.ToHtmlString()
            );
        }
