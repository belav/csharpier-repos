...
namespace Microsoft.Web.Mvc.ModelBinding.Test
{
    public class MutableObjectModelBinderTest
    {
        ...
        public void BindModel()
        {
            ...
            mockTestableBinder.Setup(o => o.EnsureModelPublic(controllerContext, bindingContext))
                .Verifiable();
            mockTestableBinder.Setup(
                o => o.GetMetadataForPropertiesPublic(controllerContext, bindingContext)
            )
        ...
        public void NullCheckFailedHandler_ModelStateValid_CallbackReturnsNull_DoesNothing()
        {
            ...
            try
            {
                ModelBinderConfig.ValueRequiredErrorMessageProvider = delegate
                {
                    return null;
                };
                EventHandler<ModelValidatedEventArgs> handler =
        ...
        public void ProcessDto_Success()
        {
            ...
            Person model = new Person { DateOfBirth = dob };
            ModelMetadata containerMetadata = GetMetadataForObject(model);
        ...
        public void SetProperty_SettingNullableTypeToNull_RequiredValidatorNotPresent_PropertySetterThrows_AddsRequiredMessageString()
        {
            ...
            // Assert
            Assert.False(bindingContext.ModelState.IsValid);
            ModelError error = Assert.Single(
