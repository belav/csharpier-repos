...
namespace System.Net.Http.Formatting
{
    public class DefaultContentNegotiatorTests
    {
        ...
        public static TheoryDataSet<string, string[], string> MatchRequestMediaTypeData
        {
            get
            {
                ...
                return new TheoryDataSet<string, string[], string>
                {
                    ...
                    {
                        "application/xml; charset=utf-8; parameter=value",
                        new string[] { "text/xml", "application/xml" },
                        "application/xml"
                    },
                };
                ...
                {
                    {
                        ...
                        null,
                        0.0,
                        (int)MediaTypeFormatterMatchRanking.MatchOnRequestAcceptHeaderLiteral
                    },
                    {
                        new string[] { "text/plain" },
                        new string[] { "text/xml", "application/xml" },
                        null,
                        0.0,
                        (int)MediaTypeFormatterMatchRanking.None
                    },
                    {
                        new string[] { "text/plain; q=0.5" },
                        new string[] { "text/xml", "application/xml" },
                        null,
                        0.0,
                        (int)MediaTypeFormatterMatchRanking.None
                    ...
                    {
                        new string[] { "APPLICATION/XML; q=0.5" },
                        new string[] { "text/xml", "application/xml" },
                        "application/xml",
                        0.5,
                        (int)MediaTypeFormatterMatchRanking.MatchOnRequestAcceptHeaderLiteral
                    ...
                    {
                        new string[] { "text/xml; q=0.5", "APPLICATION/XML; q=0.7" },
                        new string[] { "text/xml", "application/xml" },
                        "application/xml",
                        0.7,
                        (int)MediaTypeFormatterMatchRanking.MatchOnRequestAcceptHeaderLiteral
                    ...
                    {
                        new string[] { "application/xml; q=0.0" },
                        new string[] { "application/xml", "text/xml" },
                        null,
                        0.0,
                        (int)MediaTypeFormatterMatchRanking.None
                    ...
                    {
                        new string[] { "text/xml; q=0.0", "APPLICATION/XML; q=0.0" },
                        new string[] { "text/xml", "application/xml" },
                        null,
                        0.0,
                        (int)MediaTypeFormatterMatchRanking.None
                    ...
                    {
                        new string[] { "text/*", "application/xml; q=0.5" },
                        new string[] { "text/xml", "application/xml" },
                        "text/xml",
                        1.0,
                        (int)
                    ...
                    {
                        new string[] { "text/*; q=0.0", "application/xml; q=0.0" },
                        new string[] { "text/xml", "application/xml" },
                        null,
                        0.0,
                        (int)MediaTypeFormatterMatchRanking.None
                    ...
                    },
                    {
                        ...
                        "text/xml",
                        0.5,
                        (int)MediaTypeFormatterMatchRanking.MatchOnRequestAcceptHeaderAllMediaRange
                    },
                    {
                        new string[] { "*/*; q=0.0" },
                        new string[] { "text/xml", "application/xml" },
                    ...
                    {
                        new string[] { "*/*; q=0.5", "application/xml" },
                        new string[] { "text/xml", "application/xml" },
                        "application/xml",
                        1.0,
                        (int)MediaTypeFormatterMatchRanking.MatchOnRequestAcceptHeaderLiteral
                    ...
                    {
                        new string[] { "*/*; q=1.0", "application/xml; q=0.5" },
                        new string[] { "text/xml", "application/xml" },
                        "text/xml",
                        1.0,
                        (int)MediaTypeFormatterMatchRanking.MatchOnRequestAcceptHeaderAllMediaRange
                    ...
                    {
                        new string[] { "text/*; q=0.5", "*/*; q=0.2", "application/xml; q=1.0" },
                        new string[] { "text/xml", "application/xml" },
                        "application/xml",
                        1.0,
                        (int)MediaTypeFormatterMatchRanking.MatchOnRequestAcceptHeaderLiteral
        ...
        public static TheoryDataSet<
            ...
            string[],
            string
        > SelectResponseCharacterEncodingData
        {
            get
            {
                ...
                return new TheoryDataSet<string[], string, string[], string>
                {
                    ...
                    {
                        new string[] { "utf-16; q=0.5" },
                        "utf-8",
                        new string[] { "utf-8", "utf-16" },
                        "utf-16"
                    },
                    {
                        new string[] { "utf-8; q=0.0" },
                        null,
                        new string[] { "utf-8", "utf-16" },
                        "utf-8"
                    },
                    ...
                    {
                        new string[] { "utf-8; q=0.0", "utf-16; q=0.0" },
                        "utf-16",
                        new string[] { "utf-8", "utf-16" },
                        "utf-16"
                    },
        ...
        > SelectResponseMediaTypeData
        {
            get
            {
                // Only mapping and accept makes sense with q != 1.0
                MediaTypeFormatterMatch matchMapping10 = CreateMatch(
                    1.0,
                    MediaTypeFormatterMatchRanking.MatchOnRequestWithMediaTypeMapping
                );
                MediaTypeFormatterMatch matchMapping05 = CreateMatch(
                    0.5,
                    MediaTypeFormatterMatchRanking.MatchOnRequestWithMediaTypeMapping
                );

                MediaTypeFormatterMatch matchAccept10 = CreateMatch(
                    1.0,
                ...
                MediaTypeFormatterMatch matchAcceptSubTypeRange10 = CreateMatch(
                    1.0,
                    MediaTypeFormatterMatchRanking.MatchOnRequestAcceptHeaderSubtypeMediaRange
                );
                MediaTypeFormatterMatch matchAcceptSubTypeRange05 = CreateMatch(
                    0.5,
                    MediaTypeFormatterMatchRanking.MatchOnRequestAcceptHeaderSubtypeMediaRange
                );

                MediaTypeFormatterMatch matchAcceptAllRange10 = CreateMatch(
                    1.0,
                    MediaTypeFormatterMatchRanking.MatchOnRequestAcceptHeaderAllMediaRange
                );
                MediaTypeFormatterMatch matchAcceptAllRange05 = CreateMatch(
                    0.5,
                    MediaTypeFormatterMatchRanking.MatchOnRequestAcceptHeaderAllMediaRange
                );

                MediaTypeFormatterMatch matchRequest10 = CreateMatch(
                    1.0,
                    MediaTypeFormatterMatchRanking.MatchOnRequestMediaType
                );
                MediaTypeFormatterMatch matchType10 = CreateMatch(
                    1.0,
                ...
                >
                {
                    ...
                    {
                        new List<MediaTypeFormatterMatch>()
                        {
                            matchType10,
                            matchRequest10,
                            matchAcceptAllRange10,
                        },
                        matchAcceptAllRange10
                    },
                    {
                    ...
                    {
                        new List<MediaTypeFormatterMatch>() { matchAccept05, matchAccept10 },
                        matchAccept10
                    },
                    {
                        new List<MediaTypeFormatterMatch>() { matchAccept10, matchAccept05 },
                        matchAccept10
                    },
                    {
                        new List<MediaTypeFormatterMatch>()
                        {
                            matchAcceptSubTypeRange05,
                            matchAcceptSubTypeRange10,
                        },
                        matchAcceptSubTypeRange10
                    },
                    ...
                    {
                        new List<MediaTypeFormatterMatch>() { matchMapping05, matchMapping10 },
                        matchMapping10
                    },
                    {
                        new List<MediaTypeFormatterMatch>() { matchMapping10, matchMapping05 },
                        matchMapping10
                    },
                    {
                        new List<MediaTypeFormatterMatch>() { matchMapping05, matchAccept05 },
                        matchMapping05
                    },
                    {
                        new List<MediaTypeFormatterMatch>() { matchMapping10, matchAccept10 },
                        matchMapping10
                    },
                    {
                        new List<MediaTypeFormatterMatch>()
                    ...
                    {
                        new List<MediaTypeFormatterMatch>() { matchMapping05, matchAccept10 },
                        matchAccept10
                    },
                    {
                        new List<MediaTypeFormatterMatch>()
        ...
        public void Negotiate_WhenTypeParameterIsNull_ThrowsException()
        {
            Assert.ThrowsArgumentNull(
                () => _negotiator.Negotiate(null, _request, Enumerable.Empty<MediaTypeFormatter>()),
                "type"
            );
        }
        ...
        {
            Assert.ThrowsArgumentNull(
                () => _negotiator.Negotiate(typeof(string), _request, null),
                "formatters"
            );
        }
        ...
        public void Negotiate_SelectsJsonAsDefaultFormatter()
        {
            ...
            Assert.Equal(
                MediaTypeConstants.ApplicationJsonMediaType.MediaType,
        ...
        public void ComputeFormatterMatches_ThrowsOnNull()
        {
            ...
            Assert.ThrowsArgumentNull(
                () =>
                    negotiator.ComputeFormatterMatches(
                        type: null,
                        request: request,
        ...
        public void MatchMediaTypeMapping_ThrowsOnNull()
        {
            ...
            Assert.ThrowsArgumentNull(
                () => negotiator.MatchMediaTypeMapping(request: null, formatter: formatter),
                "request"
            );
            Assert.ThrowsArgumentNull(
                () => negotiator.MatchMediaTypeMapping(request: request, formatter: null),
                "formatter"
            );
        }
        ...
        public void MatchMediaTypeMapping_ReturnsMatch()
        {
            ...
            MockMediaTypeMapping mockMediaTypeMapping = new MockMediaTypeMapping(
                mappingMediatype,
                0.75
            );
        ...
        public void MatchAcceptHeader_ThrowsOnNull()
        {
            MockContentNegotiator negotiator = new MockContentNegotiator();
            MockMediaTypeFormatter formatter = new MockMediaTypeFormatter();
            List<MediaTypeWithQualityHeaderValue> sortedAcceptValues =
                new List<MediaTypeWithQualityHeaderValue>();

            Assert.ThrowsArgumentNull(
                () => negotiator.MatchAcceptHeader(sortedAcceptValues: null, formatter: formatter),
                "sortedAcceptValues"
            );
            Assert.ThrowsArgumentNull(
                () =>
                    negotiator.MatchAcceptHeader(
                        sortedAcceptValues: sortedAcceptValues,
                        formatter: null
                    ),
                "formatter"
            );
        ...
        public void MatchAcceptHeader_ReturnsMatch(
        ...
        )
        {
            ...
            List<MediaTypeWithQualityHeaderValue> unsortedAcceptHeaders = acceptHeaders
                .Select(a => MediaTypeWithQualityHeaderValue.Parse(a))
                .ToList();
            IEnumerable<MediaTypeWithQualityHeaderValue> sortedAcceptHeaders =
                negotiator.SortMediaTypeWithQualityHeaderValuesByQFactor(unsortedAcceptHeaders);
            ...
            // Act
            MediaTypeFormatterMatch match = negotiator.MatchAcceptHeader(
                sortedAcceptHeaders,
                formatter
            );
        ...
        public void MatchRequestMediaType_ThrowsOnNull()
        {
            ...
            Assert.ThrowsArgumentNull(
                () => negotiator.MatchRequestMediaType(request: null, formatter: formatter),
                "request"
            );
            Assert.ThrowsArgumentNull(
                () => negotiator.MatchRequestMediaType(request: request, formatter: null),
                "formatter"
            );
        }
        ...
        public void ShouldMatchOnType_ThrowsOnNull()
        {
            MockContentNegotiator negotiator = new MockContentNegotiator();
            Assert.ThrowsArgumentNull(
                () => negotiator.ShouldMatchOnType(sortedAcceptValues: null),
                "sortedAcceptValues"
            );
        }
        ...
        public void ShouldMatchOnType_ReturnsExpectedResult(
        ...
        public void MatchType_ThrowsOnNull()
        {
            ...
            Assert.ThrowsArgumentNull(
                () => negotiator.MatchType(type: null, formatter: formatter),
                "type"
            );
            Assert.ThrowsArgumentNull(
                () => negotiator.MatchType(type: type, formatter: null),
                "formatter"
            );
        }
        ...
        public void SelectResponseMediaTypeFormatter_ThrowsOnNull()
        {
            ...
            Assert.ThrowsArgumentNull(
                () => negotiator.SelectResponseMediaTypeFormatter(matches: null),
                "matches"
            );
        }
        ...
        public void SelectResponseCharacterEncoding_ThrowsOnNull()
        {
            ...
            Assert.ThrowsArgumentNull(
                () =>
                    negotiator.SelectResponseCharacterEncoding(request: null, formatter: formatter),
                "request"
            );
            Assert.ThrowsArgumentNull(
                () => negotiator.SelectResponseCharacterEncoding(request: request, formatter: null),
                "formatter"
            );
        }
        ...
        )
        {
            ...
            // Act
            Encoding actualEncoding = negotiator.SelectResponseCharacterEncoding(
                request,
                formatter
            );
        ...
        public void SortMediaTypeWithQualityHeaderValuesByQFactor_ThrowsOnNull()
        {
            ...
            Assert.ThrowsArgumentNull(
                () =>
                    negotiator.SortMediaTypeWithQualityHeaderValuesByQFactor(
                        (HttpHeaderValueCollection<MediaTypeWithQualityHeaderValue>)null
                    ),
                "headerValues"
            );
        }
        ...
        [Theory]
        [TestDataSet(
            typeof(MediaTypeWithQualityHeaderValueComparerTests),
            "BeforeAfterSortedValues"
        )]
        ...
        )
        {
            ...
            IEnumerable<MediaTypeWithQualityHeaderValue> actualSorted =
                negotiator.SortMediaTypeWithQualityHeaderValuesByQFactor(unsortedValues);
            ...
            Assert.ThrowsArgumentNull(
                () =>
                    negotiator.SortStringWithQualityHeaderValuesByQFactor(
                        (HttpHeaderValueCollection<StringWithQualityHeaderValue>)null
                    ),
                "headerValues"
            );
        }
        ...
        )
        {
            ...
            List<StringWithQualityHeaderValue> unsortedValues =
                new List<StringWithQualityHeaderValue>(
            ...
            IEnumerable<StringWithQualityHeaderValue> actualSorted =
                negotiator.SortStringWithQualityHeaderValuesByQFactor(unsortedValues);
        ...
        public void UpdateBestMatch_SelectsCorrectly(
