...
namespace System.Web.WebPages.Test
{
    public class SessionStateUtilTest
    {
        ...
        public void SetUpSessionStateUsesSessionStateValueFromRequestingPageIfAvailable()
        {
            ...
            var context = new Mock<HttpContextBase>(MockBehavior.Strict);
            context.Setup(c => c.SetSessionStateBehavior(SessionStateBehavior.Disabled))
                .Verifiable();
        ...
        public void SetUpSessionStateUsesSessionStateValueFromStartPageHierarchy()
        {
            ...
            var context = new Mock<HttpContextBase>(MockBehavior.Strict);
            context.Setup(c => c.SetSessionStateBehavior(SessionStateBehavior.ReadOnly))
                .Verifiable();
        ...
        public void SetUpSessionStateUsesCache()
        {
            ...
            context.Setup(c => c.SetSessionStateBehavior(SessionStateBehavior.Default))
                .Verifiable();
