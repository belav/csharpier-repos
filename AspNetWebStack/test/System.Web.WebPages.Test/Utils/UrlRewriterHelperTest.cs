...
namespace System.Web.WebPages.Test
{
    public class UrlRewriterHelperTest
    {
        ...
        public void WasRequestRewritten_FalseIfUrlRewriterIsTurnedOff()
        {
            ...
            UrlRewriteMocks request = CreateMockContext(
        ...
        )
        {
            ...
            if (isUrlRewriteOnForServer)
            {
                mockWorkerRequest
                    .Setup(wr =>
                        wr.GetServerVariable(UrlRewriterHelper.UrlRewriterEnabledServerVar)
                    )
                    .Returns("On!")
                    .Verifiable();
            }
