...
namespace System.Web.Helpers.AntiXsrf.Test
{
    public class AntiForgeryWorkerTest
    {
        ...
        public void ChecksSSL()
        {
            ...
            IAntiForgeryConfig config = new MockAntiForgeryConfig() { RequireSSL = true };
        ...
        public void GetFormInputElement_ExistingInvalidCookieToken()
        {
            ...
            mockTokenStore
                .Setup(o => o.GetCookieToken(mockHttpContext.Object))
                .Returns(oldCookieToken);
            mockTokenStore
                .Setup(o => o.SaveCookieToken(mockHttpContext.Object, newCookieToken))
                .Verifiable();
            ...
            mockValidator
                .Setup(o => o.GenerateFormToken(mockHttpContext.Object, identity, newCookieToken))
                .Returns(formToken);
            ...
            // Assert
            Assert.Equal(
                @"<input name=""form-field-name"" type=""hidden"" value=""serialized-form-token"" />",
