...
namespace Microsoft.Web.WebPages.OAuth.Test
{
    public class OAuthWebSecurityTest : IDisposable
    {
        ...
        public void VerifyAuthenticationFail()
        {
            ...
            client.Setup(c => c.VerifyAuthentication(context.Object))
            ...
            anotherClient.Setup(c => c.VerifyAuthentication(context.Object))
        ...
        public void LoginSetAuthenticationTicketIfSuccessful()
        {
            ...
            try
            {
                ...
                dataProvider.Setup(p => p.GetUserNameFromOpenAuth("twitter", "12345"))
                    .Returns("hola");
