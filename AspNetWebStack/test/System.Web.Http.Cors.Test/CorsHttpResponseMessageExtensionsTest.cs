...
namespace System.Web.Cors.Test.WebAPI
{
    public class CorsHttpResponseMessageExtensionsTest
    {
        ...
        public void WriteCorsHeaders_WritesAllowMethods()
        {
            ...
            string[] allowMethods = headers.GetValues("Access-Control-Allow-Methods")
                .FirstOrDefault()
                .Split(',');
        ...
        public void WriteCorsHeaders_WritesAllowExposedHeaders()
        {
            ...
            Assert.Single(headers);
            string[] exposedHeaders = headers.GetValues("Access-Control-Expose-Headers")
                .FirstOrDefault()
                .Split(',');
        ...
        public void WriteCorsHeaders_WritesAllowHeaders()
        {
            ...
            Assert.Single(headers);
            string[] allowHeaders = headers.GetValues("Access-Control-Allow-Headers")
                .FirstOrDefault()
                .Split(',');
