...
{
    /// <summary>
    /// Represents an action result that returns an empty <see cref="HttpStatusCode.NotFound"/>
    // response.
    /// </summary>
    public class NotFoundResult : IHttpActionResult
    {
        ...
        public virtual Task<HttpResponseMessage> ExecuteAsync(CancellationToken cancellationToken)
        {
            return Task.FromResult(
                StatusCodeResult.Execute(HttpStatusCode.NotFound, _dependencies.Request)
            );
        }
    }
}
