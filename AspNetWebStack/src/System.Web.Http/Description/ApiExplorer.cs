...
namespace System.Web.Http.Description
{
    ...
    public class ApiExplorer : IApiExplorer
    {
        ...
        public virtual bool ShouldExploreController(
            ...
            ApiExplorerSettingsAttribute setting =
                controllerDescriptor.GetCustomAttributes<ApiExplorerSettingsAttribute>()
                    .FirstOrDefault();
        ...
        public virtual bool ShouldExploreAction(
            ...
            ApiExplorerSettingsAttribute setting =
                actionDescriptor.GetCustomAttributes<ApiExplorerSettingsAttribute>()
                    .FirstOrDefault();
            return (setting == null || !setting.IgnoreApi)
        ...
        private void ExploreRouteActions(
            ...
            if (!controllerDescriptor.IsAttributeRouted())
            {
                ...
                ILookup<string, HttpActionDescriptor> actionMappings =
                    controllerServices.GetActionSelector().GetActionMapping(controllerDescriptor);
                string actionVariableValue;
        ...
        private ResponseDescription CreateResponseDescription(HttpActionDescriptor actionDescriptor)
        {
            ...
            Type responseType = responseTypeAttribute.Select(attribute => attribute.ResponseType)
                .FirstOrDefault();
