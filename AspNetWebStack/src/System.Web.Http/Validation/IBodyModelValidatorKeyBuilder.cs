...
namespace System.Web.Http.Validation
{
    ...
    /// <see cref="IBodyModelValidator"/> implementations, especially <see
    // cref="DefaultBodyModelValidator"/>.
    /// </summary>
    public interface IBodyModelValidatorKeyBuilder
    {
        ...
        /// <returns>Key for a nested scope. Usually appends a property name to <paramref
        // name="prefix"/>.</returns>
