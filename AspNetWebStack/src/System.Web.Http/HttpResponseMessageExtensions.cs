...
namespace System.Net.Http
{
    ...
    public static class HttpResponseMessageExtensions
    {
        ...
        /// attempts to retrieve the <see cref="ObjectContent.Value"/> if it is compatible with
        // <typeparamref name="T"/>.
        /// If it is it returns <c>true</c> and sets <paramref name="value"/>. If not it returns
        // <c>false</c> and
        ...
        /// <returns>Returns <c>true</c> if the response has a content with a value that can be cast to
        // <typeparamref name="T"/>,
        ...
        /// <summary>
        /// Attaches the given <paramref name="request"/> to the <paramref name="response"/> if the response
        // does not already
