...
namespace System.Web.Http
{
    ...
    public static class HttpConfigurationExtensions
    {
        ...
        // Public APIs can get similar functionality by querying the IHttpRoute for
        // IReadOnlyCollection<IHttpRoute>.
        ...
        /// <param name="configuration">The server configuration.</param>
        /// <remarks>
        /// When the host's principal is suppressed, the current principal is set to anonymous upon entering
        // the
        /// <see cref="HttpServer"/>'s first message handler. As a result, any authentication performed by
        // the host is
