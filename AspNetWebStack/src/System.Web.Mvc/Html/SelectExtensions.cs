...
namespace System.Web.Mvc.Html
{
    public static class SelectExtensions
    {
        ...
        )
        {
            ...
            string expressionFullName = htmlHelper.ViewContext.ViewData.TemplateInfo
        ...
        )
        {
            ...
            IEnumerable<string> enumValues =
                from Enum value in defaultValues.OfType<Enum>()
        ...
        )
        {
            ...
            IEnumerable<IGrouping<int, SelectListItem>> groupedSelectList = selectList.GroupBy<
                SelectListItem,
                int
