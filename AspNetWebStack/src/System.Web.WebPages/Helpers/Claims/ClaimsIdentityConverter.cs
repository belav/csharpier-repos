...
namespace System.Web.Helpers.Claims
{
    ...
    internal sealed class ClaimsIdentityConverter
    {
        ...
        )
        {
            if (claimsIdentityType != null && claimType != null)
            {
                MethodInfo tryConvertClosedMethod =
                    _claimsIdentityTryConvertOpenMethod.MakeGenericMethod(
                        claimsIdentityType,
                        claimType
                    );
        ...
        private static Func<IIdentity, ClaimsIdentity>[] GetDefaultConverters()
        {
            ...
            {
                Type claimsIdentityType = Type.GetType(
                ...
                Type claimType = Type.GetType(
                    "Microsoft.IdentityModel.Claims.Claim, Microsoft.IdentityModel, Version=3.5.0.0, Culture=neutral, PublicKeyToken=31bf3856ad364e35"
                );
            ...
            // 4.5 ClaimsIdentity type
            {
                ...
                Type claimsIdentityType = mscorlibModule.GetType(
