...
namespace System.Web.WebPages
{
    public abstract class Validator
    {
        [SuppressMessage(
            ...
            Justification = "We are ok using default parameters for helpers"
        )]
        public static IValidator Required(string errorMessage = null)
        {
            errorMessage = DefaultIfEmpty(
                errorMessage,
                WebPageResources.ValidationDefault_Required
            );
        ...
        public static IValidator Range(int minValue, int maxValue, string errorMessage = null)
        {
            errorMessage = String.Format(
                ...
                DefaultIfEmpty(errorMessage, WebPageResources.ValidationDefault_IntegerRange),
                minValue,
                maxValue
            );
            var clientAttributes = new ModelClientValidationRangeRule(
                errorMessage,
                minValue,
                maxValue
            );
        ...
        public static IValidator Range(double minValue, double maxValue, string errorMessage = null)
        {
            errorMessage = String.Format(
                CultureInfo.CurrentCulture,
                DefaultIfEmpty(errorMessage, WebPageResources.ValidationDefault_FloatRange),
                minValue,
                maxValue
            );
            var clientAttributes = new ModelClientValidationRangeRule(
        ...
        )
        {
            ...
            return new ValidationAttributeAdapter(
                new StringLengthAttribute(maxLength) { MinimumLength = minLength },
                errorMessage,
                clientAttributes,
                useUnvalidatedValues: true
            );
        ...
        public static IValidator EqualsTo(string otherFieldName, string errorMessage = null)
        {
            ...
            errorMessage = DefaultIfEmpty(
                errorMessage,
                WebPageResources.ValidationDefault_EqualsTo
            );
        ...
        public static IValidator DateTime(string errorMessage = null)
        {
            errorMessage = DefaultIfEmpty(
                errorMessage,
                WebPageResources.ValidationDefault_DataType
            );
            return new DataTypeValidator(
                DataTypeValidator.SupportedValidationDataType.DateTime,
                errorMessage
            );
        }
        ...
        public static IValidator Decimal(string errorMessage = null)
        {
            ...
            return new DataTypeValidator(
                DataTypeValidator.SupportedValidationDataType.Decimal,
                errorMessage
            );
        }
        ...
        public static IValidator Integer(string errorMessage = null)
        {
            ...
            return new DataTypeValidator(
                DataTypeValidator.SupportedValidationDataType.Integer,
                errorMessage
            );
        }
        ...
        public static IValidator Url(string errorMessage = null)
        {
            ...
            return new DataTypeValidator(
                DataTypeValidator.SupportedValidationDataType.Url,
                errorMessage
            );
        }
        ...
        public static IValidator Float(string errorMessage = null)
        {
            ...
            return new DataTypeValidator(
                DataTypeValidator.SupportedValidationDataType.Float,
                errorMessage
            );
        }
