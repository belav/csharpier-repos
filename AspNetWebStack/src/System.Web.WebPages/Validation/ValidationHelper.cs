...
namespace System.Web.WebPages
{
    public sealed class ValidationHelper
    {
        ...
        private readonly Dictionary<string, List<IValidator>> _validators = new Dictionary<
            string,
            List<IValidator>
        ...
        [SuppressMessage(
            ...
            Justification = "This makes it easier for a user to read this value without knowing of this type."
        )]
        ...
        )
        {
            ...
            foreach (var attribute in attributes)
            {
                ...
                string value = HttpUtility.HtmlEncode(
