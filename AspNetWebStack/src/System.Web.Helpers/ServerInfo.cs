...
namespace System.Web.Helpers
{
    ...
    public static class ServerInfo
    {
        ...
        internal static IDictionary<string, string> EnvironmentVariables()
        {
            ...
            IDictionary<string, string> environmentVariablesResult = new SortedDictionary<
                string,
                string
            ...
            {
                environmentVariablesResult.Add(
                    entry.Key.ToString(),
                    InsertWhiteSpace(entry.Value.ToString())
                );
            }
        ...
        internal static IDictionary<string, string> ServerVariables()
        {
            ...
            return ServerVariables(
                httpContext != null ? new HttpContextWrapper(httpContext) : null
            );
        }
        ...
        internal static IDictionary<string, string> Configuration()
        {
            ...
            info.Add(
                "ASP.NET Web Pages Version",
                new AssemblyName(typeof(WebPage).Assembly.FullName).Version.ToString()
            );
            ...
            info.Add(
                "Working Set",
                Environment.WorkingSet.ToString(CultureInfo.InvariantCulture) + " bytes"
            );
        ...
        internal static IDictionary<string, string> HttpRuntimeInfo()
        {
            ...
            info.Add(
                ...
                HttpRuntime.Cache.EffectivePrivateBytesLimit.ToString(CultureInfo.InvariantCulture)
            );
        ...
        internal static IDictionary<string, string> LegacyCAS(AppDomain appDomain)
        {
            ...
            try
            {
                ...
                {
                    info[HelpersResources.ServerInfo_LegacyCAS] =
                        HelpersResources.ServerInfo_LegacyCasHelpInfo;
                }
            }
            catch (SecurityException)
            {
        ...
        )
        {
            ...
            foreach (var entry in entries)
            {
                ...
                builder.AppendFormat(
                    CultureInfo.InvariantCulture,
                    "<th scope=\"row\">{0}</th>",
                    HttpUtility.HtmlEncode(entry.Key)
                );
                builder.AppendFormat(
                    CultureInfo.InvariantCulture,
                    "<td{0}>{1}</td>",
