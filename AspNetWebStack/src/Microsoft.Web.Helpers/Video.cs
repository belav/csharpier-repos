...
namespace Microsoft.Web.Helpers
{
    public static class Video
    {
        ...
        private static readonly string[] _globalBlacklist = new[]
        {
            "width",
            "height",
            "type",
        ...
        private static readonly string[] _mediaPlayerBlacklist = new[]
        {
            "autoStart",
            "playCount",
            "uiMode",
        ...
        private static readonly string[] _silverlightBlacklist = new[]
        {
            "background",
            "initparams",
            "minruntimeversion",
        ...
        private static readonly string[] _flashBlacklist = new[]
        {
            "play",
            "loop",
            "menu",
        ...
        internal static HelperResult Flash(
        ...
        internal static HelperResult MediaPlayer(
            HttpContextBase context,
            VirtualPathUtilityBase pathUtility,
            string path,
            string width = null,
        ...
        internal static HelperResult Silverlight(
            HttpContextBase context,
            VirtualPathUtilityBase pathUtility,
            string path,
            string width,
        ...
        )
        {
            ...
            return GetHtml(
                ...
                height,
                SilverlightMimeType,
                "data:" + SilverlightMimeType + ",", // ',' required for Opera support
                null,
                null,
                "source",
                null,
        ...
        private static IDictionary<string, object> ObjectToDictionary(
            object o,
            string argName,
            string[] blackList
        )
                ...
                if (blackList.Contains(key, StringComparer.OrdinalIgnoreCase))
                {
                    throw new ArgumentException(
                        String.Format(
                            ...
                            HelpersToolkitResources.Video_PropertyCannotBeSet,
                            key
                        ),
                        argName
                    );
        ...
        private static HelperResult GetHtml(
            HttpContextBase context,
            VirtualPathUtilityBase pathUtility,
            string path,
            string width,
            ...
            string objectCodeBase,
            string pathParamName,
            string embedContentType,
            ...
            if (!path.StartsWith("http", StringComparison.OrdinalIgnoreCase))
            {
                ...
                if (!File.Exists(context.Server.MapPath(path)))
                {
                    throw new InvalidOperationException(
                        String.Format(
                            CultureInfo.CurrentUICulture,
                            HelpersToolkitResources.Video_FileDoesNotExist,
                            originalPath
                        )
                    );
                }
