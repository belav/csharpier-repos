...
namespace System.Web.WebPages.Deployment
{
    ...
    public static class WebPagesDeployment
    {
        ...
        [Obsolete(
            "This method is obsolete and is meant for legacy code. Use GetVersionWithoutEnabled instead."
        )]
        ...
        [SuppressMessage(
            ...
            Justification = "This operation might be expensive since it has to reflect over Assembly names."
        )]
        ...
        public static IDictionary<string, Version> GetIncompatibleDependencies(string appPath)
        {
            ...
            var assemblyReferences = AppDomainHelper.GetBinAssemblyReferences(
                appPath,
                configFilePath
            );
        ...
        public static string GetAssemblyPath(Version version)
        {
            ...
            string webPagesRegistryKey = String.Format(
            ...
            if (installPath == null)
            {
                throw new InvalidOperationException(
                    String.Format(
                        ...
                        ConfigurationResources.WebPagesRegistryKeyDoesNotExist,
                        webPagesRegistryKey
                    )
                );
            }
            else if (installPath == _installPathNotFound)
            {
                throw new InvalidOperationException(
                    String.Format(
                        CultureInfo.CurrentCulture,
                        ConfigurationResources.InstallPathNotFound,
                        webPagesRegistryKey
                    )
                );
            }
        ...
        [SuppressMessage(
            ...
            Justification = "We never want to throw an exception from this method."
        )]
