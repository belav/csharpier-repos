...
namespace System.Web.Razor
{
    ...
    /// * What method names will be used for rendering markup, expressions etc.  For example "Write",
    // "WriteLiteral"
    ...
    /// * The default Class Name and Namespace for the generated class (can be overridden by parameters
    // in RazorTemplateEngine.GeneratedCode)
    /// * The language of the code in a Razor page
    /// * The markup, code parsers and code generators to use (the system will select defaults, but a
    // Host gets a change to augment them)
    ...
    public class RazorEngineHost
    {
        ...
        /// <returns>Either the same markup parser, after modifications, or a different markup
        // parser</returns>
        ...
        /// <returns>Either the same code generator, after modifications, or a different code
        // generator</returns>
        ...
        /// <summary>
        /// Gets the important CodeDOM nodes generated by the code generator and has a chance to add to
        // them.
        /// </summary>
        /// <remarks>
