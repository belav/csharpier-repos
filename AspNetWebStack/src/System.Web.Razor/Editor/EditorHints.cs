...
namespace System.Web.Razor.Editor
{
    ...
    public enum EditorHints
    {
        ...
        /// Editors can always use the default behavior, even if the span is labeled with a different
        // CompletionType.
        /// </summary>
        None = 0, // 0000 0000
        ...
        /// Editors need not support this mode of completion, and will use the default (<see
        // cref="F:EditorHints.None"/>) behavior
