...
namespace WebMatrix.Data
{
    ...
    {
        private const string SqlServerConnectionStringFormat =
            @"Data Source=.\SQLEXPRESS;AttachDbFilename={0};Initial Catalog={1};Integrated Security=True;User Instance=True;MultipleActiveResultSets=True";
        ...
        public IConnectionConfiguration GetConnectionConfiguration(string fileName)
        {
            return new ConnectionConfiguration(
                ...
                GetConnectionString(fileName, Database.DataDirectory)
            );
        }
        ...
        internal static string GetConnectionString(string fileName, string dataDirectory)
        {
            if (Path.IsPathRooted(fileName))
            {
                ...
                return String.Format(
                    ...
                    SqlServerConnectionStringFormat,
                    fileName,
                    fileName
                );
            }
