...
namespace WebMatrix.Data
{
    public class Database : IDisposable
    {
        ...
        private static readonly IDictionary<string, IDbFileHandler> _databaseFileHandlers =
            new Dictionary<string, IDbFileHandler>(StringComparer.OrdinalIgnoreCase)
            {
        ...
        private static readonly IConfigurationManager _configurationManager =
            new ConfigurationManagerWrapper(_databaseFileHandlers);
        ...
        [SuppressMessage(
            ...
            Justification = "Users are responsible for ensuring the inputs to this method are SQL Injection sanitized"
        )]
        ...
        [SuppressMessage(
            ...
            Justification = "This makes a database request"
        )]
        ...
        private static void AddParameters(DbCommand command, object[] args)
        {
            ...
            IEnumerable<DbParameter> parameters = args.Select(
                (o, index) =>
                {
        ...
        )
        {
            ...
            throw new InvalidOperationException(
                String.Format(
                    ...
                    DataResources.UnableToDetermineDatabase,
                    fileName
                )
            );
        }
        ...
        )
        {
            ...
            throw new InvalidOperationException(
                String.Format(
                    CultureInfo.CurrentCulture,
                    DataResources.ConnectionStringNotFound,
                    name
                )
            );
        }
