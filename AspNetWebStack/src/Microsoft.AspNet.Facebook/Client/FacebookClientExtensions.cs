...
namespace Microsoft.AspNet.Facebook.Client
{
    ...
    public static class FacebookClientExtensions
    {
        ...
        /// <param name="client">The client.</param>
        /// <returns>The current user.</returns>
        public static Task<TUser> GetCurrentUserAsync<TUser>(this FacebookClient client)
            where TUser : class
        {
            ...
            where TUserFriend : class
        {
            ...
            >(client, "me/friends");
            return friends != null ? friends.Data : new TUserFriend[0];
        }
            ...
            where TStatus : class
        {
            ...
            >(client, "me/statuses");
            return statuses != null ? statuses.Data : new TStatus[0];
        }
            ...
            where TPhotos : class
        {
            ...
            >(client, "me/photos");
            return photos != null ? photos.Data : new TPhotos[0];
        }
