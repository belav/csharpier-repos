...
namespace Moq.Tests.Regressions
{
    public class IssueReportsFixture
    {
        ...
        {
            [Fact(
                Skip = "Fails due to a bug in Castle DynamicProxy. Try enabling this test once we reference Castle.Core > 4.4.0."
            )]
...
#pragma warning restore CS0067
        ...
        public class Issue897
        {
            ...
            public void DateTimeOffset()
            {
                ...
                serviceMock.Setup(s => s.GetDataList(It.IsAny<DateTimeOffset>()))
                    .Returns(this.data);
...
#pragma warning restore 618
        ...
        public class _152
        {
            ...
            public void ShouldReturnEnum()
            {
                ...
                provider.Setup(p => p.CreateUser(string.Empty, string.Empty, string.Empty))
        ...
        public class _267
        {
            ...
            public class HelperSetup
            {
                ...
                {
                    m_OperationStub.Setup(m => m.Operation(It.IsAny<string>()))
                        .Returns<string>(value => "test");
                    m_OperationStub.Setup(m => m.Operation(It.IsAny<int>()))
                ...
                {
                    m_OperationStub.Setup(m => m.Operation(It.IsAny<T>()))
