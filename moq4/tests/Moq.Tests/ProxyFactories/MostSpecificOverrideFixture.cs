...
namespace Moq.Tests.ProxyFactories
{
    public class MostSpecificOverrideFixture
    {
        ...
        [InlineData(
            ...
            typeof(IBoverride),
            typeof(IBoverride),
            "Moq.Tests.ProxyFactories.MostSpecificOverrideFixture.IA.Method"
        )]
        [InlineData(typeof(IA), "Method", typeof(IBnew), typeof(IA), "Method")]
        [InlineData(
            typeof(IA),
            "Method",
            typeof(ICfromBoverride),
            typeof(ICfromBoverride),
            "Moq.Tests.ProxyFactories.MostSpecificOverrideFixture.IA.Method"
        )]
        [InlineData(
        ...
        [InlineData(
            ...
            typeof(ICfromBnew),
            typeof(ICfromBnew),
            "Moq.Tests.ProxyFactories.MostSpecificOverrideFixture.IBnew.Method"
        )]
        public void Finds_correct_most_specific_override(
        ...
        )
        {
            ...
            var actual = CastleProxyFactory.FindMostSpecificOverride(
                declaration: declarationType.GetMethod(
                    declarationName,
                    BindingFlags.Public
                        | BindingFlags.NonPublic
                        | BindingFlags.Instance
