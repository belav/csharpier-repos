...
namespace Moq.Tests
{
    public class SetupTaskResultFixture
    {
        ...
        {
            var person = new Mock<IPerson>();
            person.SetupSequence(p => p.GetFriendTaskAsync().Result)
                .Returns(Friend)
        ...
        {
            var person = new Mock<IPerson>();
            person.SetupSequence(p => p.GetFriendValueTaskAsync().Result)
                .Returns(Friend)
                .Returns(SecondFriend);
            var friend = await person.Object.GetFriendValueTaskAsync();
        ...
        {
            var person = new Mock<IPerson>();
            person.SetupSequence(p => p.GetFriendTaskAsync().Result.Name)
        ...
        {
            var person = new Mock<IPerson>();
            person.SetupSequence(p => p.GetFriendValueTaskAsync().Result.Name)
                .Returns(NameOfFriend)
                .Returns(SecondNameOfFriend);
            var friend = await person.Object.GetFriendValueTaskAsync();
            Assert.Equal(NameOfFriend, friend.Name);
        ...
        public async Task SetupSet__property_of__completed_Task__Callback()
        {
            ...
            var person = new Mock<IPerson>();
            person.SetupSet(p => p.GetFriendTaskAsync().Result.Name = It.IsAny<string>())
        ...
        public async Task SetupSet__property_of__completed_ValueTask__Callback()
        {
            string setToValue = null;
            var person = new Mock<IPerson>();
            person.SetupSet(p => p.GetFriendValueTaskAsync().Result.Name = It.IsAny<string>())
                .Callback((string value) => setToValue = value);
            var friend = await person.Object.GetFriendValueTaskAsync();
            Assert.Null(setToValue);
            friend.Name = NameOfFriend;
