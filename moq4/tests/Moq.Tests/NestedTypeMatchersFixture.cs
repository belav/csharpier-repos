...
namespace Moq.Tests
{
    public class NestedTypeMatchersFixture
    {
        ...
        [InlineData(
            typeof(It.IsSubtype<Enum>[]),
            typeof(AttributeTargets[]),
            typeof(AttributeTargets[])
        )]
        [InlineData(
            typeof(IEnumerable<It.IsSubtype<Enum>>),
            typeof(IEnumerable<AttributeTargets>),
            typeof(IEnumerable<AttributeTargets>)
        )]
        [InlineData(
            typeof(IEnumerable<It.IsSubtype<Enum>[]>),
        ...
        public void SubstituteTypeMatchers_does_not_substitute_mismatches(
            Type type,
            Type other,
            Type expected
        )
        ...
        [InlineData(
            typeof(IEnumerable<It.IsAnyType>),
            typeof(object[]),
            typeof(IEnumerable<It.IsAnyType>)
        )]
        public void SubstituteTypeMatchers_does_not_substitute_mismatched_composite_kind(
            Type type,
            Type other,
            Type expected
        )
        ...
        public void SubstituteTypeMatchers_gives_precedence_to_type_matchers_over_composite_kind(
            Type type,
            Type other,
            Type expected
        )
        ...
        [Theory]
        [InlineData(
            typeof(Tuple<It.IsSubtype<Enum>, object, It.IsAnyType, It.IsSubtype<Enum>>),
            typeof(Tuple<AttributeTargets, object, object, object>),
            typeof(Tuple<AttributeTargets, object, object, It.IsSubtype<Enum>>)
        )]
        public void SubstituteTypeMatchers_may_substitute_only_some_parts(
            Type type,
            Type other,
            Type expected
        )
        ...
        public void It_IsAnyType_used_as_generic_type_argument_of_method()
        {
            ...
            mock.Setup(m => m.Method<It.IsAnyType>(It.IsAny<IEnumerable<It.IsAnyType>>()))
                .Verifiable();
