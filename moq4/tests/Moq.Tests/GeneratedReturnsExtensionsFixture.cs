    ...
    public class GeneratedReturnsExtensionsFixture
    {
        ...
        public void ReturnsAsync_onParams_AllParametersUsedForCalculationOfTheResult()
        {
            ...
            DateTime evaluationResult =
                mock.Object
                    .WithParamsAsync(DateTime.MinValue, DateTime.Now, DateTime.MaxValue).Result;
        ...
        public void ReturnsAsync_onParams_LazyEvaluationOfTheResult()
        {
            ...
            DateTime firstEvaluationResult =
                mock.Object.WithParamsAsync(DateTime.MinValue, now).Result;

            comparedDateTime = DateTime.MaxValue;
            DateTime secondEvaluationResult =
                mock.Object.WithParamsAsync(DateTime.MinValue, now).Result;
