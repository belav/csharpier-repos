...
namespace Moq
{
    static partial class ExpressionExtensions
    {
        ...
        /// </summary>
        /// <param name="expression">The <see cref="Expression"/> to which <paramref name="visitor"/> should
        // be applied.</param>
        /// <param name="visitor">The <see cref="ExpressionVisitor"/> that should be applied to <paramref
