...
*/
    /// <summary>
    ///   A <see cref="ExpressionReconstructor"/> reconstructs LINQ expression trees (<see
    // cref="LambdaExpression"/>)
    ///   from <see cref="Action"/> delegates. It is the counterpart to <see
    // cref="ExpressionCompiler"/>.
    /// </summary>
    abstract class ExpressionReconstructor
/* Unmerged change from project 'Moq(netstandard2.0)'
Before:
...
*/
    {
        ...
        /// </summary>
        /// <param name="action">The <see cref="Action"/> delegate for which to reconstruct a LINQ
        // expression tree.</param>
        /// <param name="ctorArgs">Arguments to pass to a parameterized constructor of <typeparamref
        // name="T"/>. (Optional.)</param>
