...
namespace Moq.Protected
{
    ...
    /// Any type with members whose signatures are identical to the mock's protected members (except for
        ...
        where TAnalog : class
    {
        ...
        /// meaning that setting its value will cause it to be saved and later returned when the property is
        // requested.
        ...
        /// </param>
        /// <param name="failMessage">Message to include in the thrown <see cref="MockException"/> if
        // verification fails.</param>
        /// <exception cref="MockException">The specified invocation did not occur (or did not occur the
        // specified number of times).</exception>
        void Verify(
