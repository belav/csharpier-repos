    ...
    */
    {
        ...
        After:
        static readonly MethodInfo proxyInterceptorGetter =
        typeof(IProxy).GetProperty(nameof(IProxy.Interceptor)).GetMethod;
        */
        ...
        */
        {
            static readonly MethodInfo proxyInterceptorGetter = typeof(IProxy)
        ...
        */
        {
            ...
            public void DetachFromUnderlying()
            {
                ...
                private static ConcurrentDictionary<MethodInfo, Func<object, object[], object>>
        ...
        /// <summary>
        ///   Attempts to find the most specific override for the given method <paramref
        // name="declaration"/>
                ...
                static key =>
                {
                    ...
                    )
                    {
                        ...
                        candidateMethods.ExceptWith(
                            candidateMethods
                                .Where(cm =>
                                    cm.DeclaringType.IsAssignableFrom(implementedInterface)
                                )
                                .ToArray()
                        );
