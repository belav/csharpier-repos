...
namespace Moq
{
    ...
    public interface ISetup
    {
        ...
        ///   <para>
        ///     An "inner mock" is the <see cref="Moq.Mock"/> instance associated with a setup's return
        // value,
        ///     if that setup is configured to return a mock object.
        ///   </para>
        ///   <para>
        ///     This property will be <see langword="null"/> if a setup either does not return a mock
        // object,
        ///     or if Moq cannot safely determine its return value without risking any side effects. For
        // instance,
        ///     Moq is able to inspect the return value if it is a constant (e.g. <c>`.Returns(value)`</c>);
        ///     if, on the other hand, it gets computed by a factory function (e.g. <c>`.Returns(() =>
        // value)`</c>),
        ///     Moq will not attempt to retrieve that value just to find the inner mock,
        ///     since calling a user-provided function could have effects beyond Moq's understanding and
        // control.
        ///   </para>
        /// </summary>
        // /// <exception cref="InvalidOperationException">The setup has more than one inner
        // mock.</exception>
        ...
        // ///   </para>
        // ///   <para>
        // ///     This property will return an empty sequence if a setup either does not return any mock
        // objects,
        // ///     or if Moq cannot safely determine its return value(s) without risking any side effects.
        // For instance,
        // ///     Moq is able to inspect the return value if it is a constant (e.g.
        // <c>`.Returns(value)`</c>);
        // ///     if, on the other hand, it gets computed by a factory function (e.g. <c>`.Returns(() =>
        // value)`</c>),
        // ///     Moq will not attempt to retrieve that value just to find the inner mock,
        ...
        ///   (that is, whether it is being shadowed by a more recent non-conditional setup with an equal
        // expression).
        /// </summary>
        ...
        ///     <see cref="Mock.Verify()"/>, however, will only verify setups where this property is <see
        // langword="true"/>.
        ///   </para>
        /// </remarks>
        ...
        ///   <para>
        ///     For setups doing a simple member access or method invocation (such as <c>`mock =>
        // mock.Member`</c>),
        ///     this property will be equal to <see cref="Expression"/>.
        ///   </para>
        ///   <para>
        ///     For setups whose expression involves member chaining (such as <c>`parent =>
        // parent.Child.Member`</c>),
        ...
        ///     their <see cref="Expression"/> will return the partial expression for just a single member
        // access,
        ///     while their <see cref="OriginalExpression"/> will return the original, full expression.
        ///   </para>
        ///   <para>
        ///     This property may also return <see langword="null"/> if this setup was created
        // automatically,
        ...
        /// <summary>
        ///   Verifies this setup and optionally all verifiable setups of its inner mock (if present and
        // known).
        ///   <para>
        ///     If <paramref name="recursive"/> is set to <see langword="true"/>,
        ///     the semantics of this method are essentially the same as those of <see
        // cref="Mock.Verify()"/>,
