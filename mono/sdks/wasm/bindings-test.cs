...
public class TestClass
{
    ...
    {
        var httpMessageHandler = typeof(HttpClient).GetField(
    ...
    public static void SetRequestEnums(
        RequestCache dflt,
...
public class BindingTests
{
    ...
    public static void MarshalTypedArrayByte()
    {
        ...
        Assert.AreEqual(
            "hic sunt dracones",
            System.Text.Encoding.Default.GetString(TestClass.taByte)
        );
    }
