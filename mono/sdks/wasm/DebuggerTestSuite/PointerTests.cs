...
namespace DebuggerTests
{
    public class PointerTests : DebuggerTestBase
    {
        public static TheoryData<string, string, string, int, string, bool> PointersTestData =>
            ...
            {
                {
                    $"invoke_static_method ('[debugger-test] DebuggerTests.PointerTests:LocalPointers');",
                ...
                {
                    $"invoke_static_method_async ('[debugger-test] DebuggerTests.PointerTests:LocalPointersAsync');",
                    "DebuggerTests.PointerTests",
                    "LocalPointersAsync",
                    32,
                    "MoveNext",
        ...
        public async Task InspectLocalPointersToPrimitiveTypes(
            string eval_fn,
            string type,
            string method,
            int line_offset,
        ...
        [Theory]
        [MemberDataAttribute(nameof(PointersTestData))]
        public async Task InspectLocalPointerArrays(
            string eval_fn,
            string type,
            string method,
            int line_offset,
            ...
            await CheckInspectLocalsAtBreakpointSite(
                ...
                wait_for_event_fn: async (pause_location) =>
                {
                    ...
                    await CheckProps(
                        locals,
                        new { ipa = TArray("int*[]", 3) },
                        "locals",
                        num_fields: 26
                    );

                    var ipa_elems = await CompareObjectPropertiesFor(
                        locals,
                        "ipa",
                        new[]
                        {
                    ...
                    await CheckArrayElements(ipa_elems, new[] { TNumber(5), TNumber(10), null });
                }
            );

        [Theory]
        [MemberDataAttribute(nameof(PointersTestData))]
        public async Task InspectLocalDoublePointerToPrimitiveTypeArrays(
            string eval_fn,
            string type,
            string method,
            int line_offset,
            ...
            await CheckInspectLocalsAtBreakpointSite(
                ...
                wait_for_event_fn: async (pause_location) =>
                {
                    ...
                    await CheckProps(
                        locals,
                        new { ippa = TArray("int**[]", 5) },
                        "locals",
                        num_fields: 26
                    );

                    var ippa_elems = await CompareObjectPropertiesFor(
                        locals,
                        "ippa",
                        new[]
                        {
                    ...
                    {
                        var actual_elems = await CheckArrayElements(
                            ippa_elems,
                            new[]
                            {
                                TPointer("int*"),
        ...
        [Theory]
        [MemberDataAttribute(nameof(PointersTestData))]
        public async Task InspectLocalPointersToValueTypes(
            string eval_fn,
            string type,
            string method,
            int line_offset,
        ...
        [Theory]
        [MemberDataAttribute(nameof(PointersTestData))]
        public async Task InspectLocalPointersToValueTypeArrays(
            string eval_fn,
            string type,
            string method,
            int line_offset,
            ...
            await CheckInspectLocalsAtBreakpointSite(
                ...
                wait_for_event_fn: async (pause_location) =>
                {
                    ...
                    await CheckProps(
                        locals,
                        new { dtpa = TArray("System.DateTime*[]", 2) },
                        "locals",
                        num_fields: 26
                    );
                    ...
                    );
                    {
                        var actual_elems = await CheckArrayElements(
                            dtpa_elems,
                            new[] { TValueType("System.DateTime", dt.ToString()), null }
                        );
        ...
        [Theory]
        [MemberDataAttribute(nameof(PointersTestData))]
        public async Task InspectLocalPointersToGenericValueTypeArrays(
            string eval_fn,
            string type,
            string method,
            int line_offset,
            ...
            await CheckInspectLocalsAtBreakpointSite(
                ...
                wait_for_event_fn: async (pause_location) =>
                {
                    ...
                    // dtpa
                    var gspa_elems = await CompareObjectPropertiesFor(
                        locals,
                        "gspa",
                        new[]
                        {
        ...
        [Theory]
        [MemberDataAttribute(nameof(PointersTestData))]
        public async Task InspectLocalDoublePointersToValueTypeArrays(
            string eval_fn,
            string type,
            string method,
            int line_offset,
            ...
            await CheckInspectLocalsAtBreakpointSite(
                ...
                wait_for_event_fn: async (pause_location) =>
                {
                    ...
                    await CheckProps(
                        locals,
                        new { dtppa = TArray("System.DateTime**[]", 3), },
                        "locals",
                        num_fields: 26
                    );
        ...
        [Theory]
        [MemberDataAttribute(nameof(PointersTestData))]
        public async Task InspectLocalPointersInClasses(
            string eval_fn,
            string type,
            string method,
            int line_offset,
        ...
        public async Task InspectPrimitiveTypePointersAsMethodArgs(
            string eval_fn,
            string type,
            string method,
            int line_offset,
        ...
        [Theory]
        [MemberDataAttribute(nameof(PointersAsMethodArgsTestData))]
        public async Task InspectValueTypePointersAsMethodArgs(
            string eval_fn,
            string type,
            string method,
            int line_offset,
        ...
        [Theory]
        [InlineData(
            "invoke_static_method ('[debugger-test] Math:UseComplex', 0, 0);",
            "Math",
            "UseComplex",
            3,
            "UseComplex",
        ...
        public async Task DerefNonPointerObject(
            string eval_fn,
            string type,
            string method,
            int line_offset,
