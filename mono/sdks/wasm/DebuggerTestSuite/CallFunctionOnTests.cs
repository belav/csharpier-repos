...
namespace DebuggerTests
{
    public class CallFunctionOnTests : DebuggerTestBase
    {
        ...
        [InlineData(
            ...
            "dotnet://debugger-test.dll/debugger-cfo-test.cs",
            23,
            12,
            10,
            false
        ...
        [InlineData(
            "invoke_static_method ('[debugger-test] DebuggerTests.CallFunctionOnTest:LocalsTest', 0);",
            "dotnet://debugger-test.dll/debugger-cfo-test.cs",
            23,
            12,
            0,
        ...
        public async Task CheckVSCodeTestFunction1(
            string eval_fn,
            string bp_loc,
            int line,
            int col,
        ...
        )
        {
            ...
            await RunCallFunctionOn(
                ...
                test_fn: async (result) =>
                {
                    ...
                    var obj_accessors = await ctx.cli.SendCommand(
                    ...
                    if (is_js)
                        await CheckProps(
                            obj_accessors.Value["result"],
                            new { __proto__ = TIgnore() },
                            "obj_accessors"
                        );
                    else
                        AssertEqual(
                            0,
                            obj_accessors.Value["result"]?.Count(),
                            "obj_accessors-count"
                        );

                    // Check for a __proto__ object
                    // isOwn = true, accessorPropertiesOnly = false
                    var obj_own = await ctx.cli.SendCommand(
                        "Runtime.getProperties",
                        JObject.FromObject(
                            new
                            {
        ...
        public async Task CheckVSCodeTestFunction2(
            string eval_fn,
            string bp_loc,
            int line,
            int col,
        ...
        )
        {
            ...
            string vscode_fn1 =
                "function(e,t){const r={},n=-1===e?0:e,i=-1===t?this.length:e+t;for(let e=n;e<i&&e<this.length;++e){const t=Object.getOwnPropertyDescriptor(this,e);t&&Object.defineProperty(r,e,t)}return r}";
            ...
            await RunCallFunctionOn(
                ...
                line,
                col,
                fn_args: JArray.FromObject(
                    new[] { new { @value = fetch_start_idx }, new { @value = num_elems_fetch } }
                ),
                test_fn: async (result) =>
                {
                    var is_js = bp_loc.EndsWith(".js", StringComparison.Ordinal);
                    ...
                    AssertEqual(
                        is_js ? num_elems_recd + 1 : num_elems_recd,
                        obj_own_val.Count(),
                        $"obj_own-count"
                    );
        ...
        public async Task RunOnArrayReturnEmptyArray(
            string eval_fn,
            string bp_loc,
            int line,
            int col,
        ...
        public async Task RunOnArrayReturnArray(
            string eval_fn,
            string bp_loc,
            int line,
            int col,
            ...
            await RunCallFunctionOn(
                ...
                test_fn: async (result) =>
                {
                    ...
                    await CheckProps(
                        ...
                        $"obj_own",
                        num_fields: (is_js ? ret_len + 2 : ret_len + 1)
                    );
            ...
            await RunCallFunctionOn(
                ...
                test_fn: async (result) =>
                {
                    ...
                    for (int i = 0; i < ret_len; i++)
                    {
                        ...
                        var act_i_props = await GetProperties(
                            act_i["value"]["objectId"]?.Value<string>()
                        );
                        await CheckProps(
                            act_i_props,
                            new
                            {
                                dt = TValueType(
                                    "System.DateTime",
                                    new DateTime(2020 + (i * 2), 1, 2, 3, 4, 5).ToString()
                                ),
        ...
        public async Task RunOnCFOValueTypeResult(bool roundtrip) =>
            await RunCallFunctionOn(
                ...
                bp_loc: "dotnet://debugger-test.dll/debugger-cfo-test.cs",
                23,
                12,
                roundtrip: roundtrip,
                test_fn: async (result) =>
        ...
        public async Task RunOnJSObject(bool roundtrip) =>
            await RunCallFunctionOn(
                ...
                test_fn: async (result) =>
                {
                    ...
                    await CheckProps(
                        obj_own_val,
                        new { a_obj = TObject("Object"), b_arr = TArray("Array", 2) },
                        "obj_own",
                        num_fields: 3
                    );
                }
        ...
        public async Task RunOnArrayReturnObjectArrayByValue(
            string eval_fn,
            string bp_loc,
            int line,
            int col,
        ...
        )
        {
            ...
            await RunCallFunctionOn(
                ...
                test_fn: async (result) =>
                {
                    ...
                    AssertEqual(
                        "object",
                        result.Value["result"]["type"]?.Value<string>(),
                        "cfo-res-type"
                    );
                    ...
                    for (int i = 0; i < ret_len; i++)
                    {
                        ...
                        else
                        {
                            AssertEqual(
                                "number",
                                actual[i]?["type"]?.Value<string>(),
                                $"[{i}]-type"
                            );
                            AssertEqual(
                                exp_num.ToString(),
                                actual[i]?["description"]?.Value<string>(),
                                $"[{i}]-description"
                            );
        ...
        public async Task RunOnArrayReturnArrayByValue(
            string eval_fn,
            string bp_loc,
            int line,
            int col,
        ...
        public async Task RunOnArrayReturnPrimitive(
            string eval_fn,
            string bp_loc,
            int line,
            int col,
            ...
            await insp.Ready(
                async (cli, token) =>
                {
                    ...
                    var cfo_args = JObject.FromObject(
                        new { functionDeclaration = "function () { return 5; }", objectId = obj_id }
                    );
                    ...
                    // callFunctionOn
                    result = await ctx.cli.SendCommand(
                    ...
                    await CheckValue(
                        result.Value["result"],
                        JObject.FromObject(new { type = "string", value = "test value" }),
                        "cfo-res"
                    );
                    ...
                    await CheckValue(
                        result.Value["result"],
                        JObject.Parse("{ type: 'object', subtype: 'null', value: null }"),
                        "cfo-res"
                    );
                }
            );
        ...
        public static TheoryData<string, string, int, int, bool?> SilentErrorsTestData(
            bool? silent
        ) =>
        ...
        public async Task CFOWithSilentReturnsErrors(
            string eval_fn,
            string bp_loc,
            int line,
            int col,
        ...
        public static TheoryData<
            ...
            string,
            bool
        > GettersTestData(string local_name, bool use_cfo) =>
        ...
        public async Task PropertyGettersTest(
            string eval_fn,
            string method_name,
            int line,
            int col,
            string cfo_fn,
            Func<string[], object> get_args_fn,
            string local_name,
            bool use_cfo
        ) =>
            await CheckInspectLocalsAtBreakpointSite(
                ...
                wait_for_event_fn: async (pause_location) =>
                {
                    ...
                    var obj_props = await GetProperties(
                        obj?["value"]?["objectId"]?.Value<string>()
                    );
                    await CheckProps(
                        obj_props,
                        new
                    ...
                    await CheckValue(
                        res.Value["result"],
                        JObject.FromObject(
                            new { type = "number", value = (0xDEADBEEF + (uint)dt.Month) }
                        ),
                        $"{local_name}.Int"
                    );
                    ...
                    await CheckValue(
                        res.Value["result"],
                        JObject.FromObject(
                            new { type = "string", value = $"String property, V: 0xDEADBEEF" }
                        ),
                        $"{local_name}.String"
                    );
                    ...
                    {
                        var arr_elems = await GetProperties(
                            res.Value["result"]?["objectId"]?.Value<string>()
                        );
                        var exp_elems = new[] { TNumber(10), TNumber(20) };
        ...
        public async Task CheckAccessorsOnObjectsWithCFO(
            string eval_fn,
            string bp_loc,
            int line,
            int col,
        ...
        )
        {
            await RunCallFunctionOn(
                ...
                test_fn: async (result) =>
                {
                    ...
                    var get_prop_req = JObject.FromObject(
                        new { objectId = id, accessorPropertiesOnly = true }
                    );

                    var res = await GetPropertiesAndCheckAccessors(get_prop_req, is_js ? 6 : 5); // js returns extra `__proto__` member also
                    Assert.False(
                        res.Value["result"].Any(jt => jt["name"]?.Value<string>() == "StringField"),
                        "StringField shouldn't be returned for `accessorPropertiesOnly`"
                    );

                    // Check with `accessorPropertiesOnly` unset, == false
                    get_prop_req = JObject.FromObject(new { objectId = id, });

                    res = await GetPropertiesAndCheckAccessors(get_prop_req, is_js ? 8 : 7); // js returns a `__proto__` member also
                    Assert.True(
                        res.Value["result"].Any(jt => jt["name"]?.Value<string>() == "StringField"),
                        "StringField should be returned for `accessorPropertiesOnly=false`"
                    );
                }
            );
            ...
            async Task<Result> GetPropertiesAndCheckAccessors(JObject get_prop_req, int num_fields)
            {
                ...
                if (!res.IsOk)
                    Assert.True(
                        false,
                        $"Runtime.getProperties failed for {get_prop_req.ToString()}, with Result: {res}"
                    );
        ...
        public static TheoryData<string, string, int, int, bool> NegativeTestsData(
            bool use_cfo = false
        ) =>
            new TheoryData<string, string, int, int, bool>
            {
                {
                    "invoke_static_method ('[debugger-test] DebuggerTests.CallFunctionOnTest:MethodForNegativeTests', null);",
                    "dotnet://debugger-test.dll/debugger-cfo-test.cs",
                    45,
                    12,
                    use_cfo
        ...
        public async Task RunOnInvalidCfoId(
            string eval_fn,
            string bp_loc,
            int line,
            int col,
        ...
        [Theory]
        [MemberData(nameof(NegativeTestsData), false)]
        public async Task RunOnInvalidThirdSegmentOfObjectId(
            string eval_fn,
            string bp_loc,
            int line,
            int col,
        ...
        public async Task InvalidPropertyGetters(
            string eval_fn,
            string bp_loc,
            int line,
            int col,
        ...
        )
        {
            ...
            await insp.Ready(
                async (cli, token) =>
                {
                    ...
                    {
                        var getter_res = await InvokeGetter(
                            JObject.FromObject(new { value = new { objectId = ptd_id } }),
                            invalid_arg
                        );
                        AssertEqual(
                            "undefined",
                            getter_res.Value["result"]?["type"]?.ToString(),
                            $"Expected to get undefined result for non-existant accessor - {invalid_arg}"
                        );
                    }
                }
            );
        ...
        [Theory]
        [MemberData(nameof(NegativeTestsData), false)]
        public async Task ReturnNullFromCFO(
            string eval_fn,
            string bp_loc,
            int line,
            int col,
        ...
        )
        {
            ...
            await insp.Ready(
                async (cli, token) =>
                {
                    ...
                    var cfo_args = JObject.FromObject(
                        new { functionDeclaration = fn_decl, objectId = obj_id }
                    );
