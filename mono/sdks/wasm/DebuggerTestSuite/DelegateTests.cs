            ...
            await CheckInspectLocalsAtBreakpointSite(
                ...
                wait_for_event_fn: async (pause_location) =>
                {
                    var locals = await GetProperties(
                        pause_location["callFrames"][frame]["callFrameId"].Value<string>()
                    );
                    ...
                    await CompareObjectPropertiesFor(
                        ...
                        new[]
                        {
                            TDelegate("System.Func<Math, bool>", "bool <DelegatesTest>|(Math)")
                        },
                        "locals#fn_func_arr"
                    );
                    ...
                    await CompareObjectPropertiesFor(
                        ...
                        new[]
                        {
                            TDelegate("Math.IsMathNull", "bool IsMathNullDelegateTarget (Math)")
                        },
                        "locals#fn_del_arr"
                    );
                ...
                wait_for_event_fn: async (pause_location) =>
                {
                    ...
                    await CheckProps(
                        ...
                        new
                        {
                            ...
                            fn_action_del = TDelegate(
                                "System.Action<Math.GenericStruct<int[]>>",
                                "void DelegateTargetWithVoidReturn (Math.GenericStruct<int[]>)"
                            ),
                            fn_action_bare = TDelegate("System.Action", "void|()"),
                            fn_action_null = TObject(
                                "System.Action<Math.GenericStruct<int[]>>",
                                is_null: true
                            ),
