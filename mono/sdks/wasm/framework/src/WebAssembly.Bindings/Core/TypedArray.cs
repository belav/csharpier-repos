...
namespace WebAssembly.Core
{
        ...
        where U : struct
    {
        ...
        internal TypedArray(IntPtr js_handle)
            : base(js_handle) { }
            ...
            if (jsValue != null)
            {
                ...
                else
                {
                    throw new InvalidCastException(
                        $"Unable to cast object of type {type} to type {typeof(U)}."
                    );
                }
            }
            else
        ...
        public unsafe static T From(ReadOnlySpan<U> span)
        {
            ...
            {
                var res = Runtime.TypedArrayFrom(
                    (int)ptr,
                    0,
                    span.Length,
                    Marshal.SizeOf<U>(),
        ...
        public unsafe int CopyTo(Span<U> span)
        {
            ...
            fixed (byte* ptr = bytes)
            {
                var res = Runtime.TypedArrayCopyTo(
                    JSHandle,
                    (int)ptr,
                    0,
                    span.Length,
        ...
        {
            var res = Runtime.TypedArrayCopyFrom(
                JSHandle,
                (int)ptrSource,
                offset,
                offset + count,
        ...
        protected void ValidateTarget(Span<U> target)
        {
            ...
            if (target == null || target.Length == 0)
            {
                throw new System.ArgumentException(
                    $"Invalid argument: {nameof(target)} can not be null and must have a length"
                );
            }
        }
        ...
        protected void ValidateSource(ReadOnlySpan<U> source)
        {
            ...
            {
                throw new System.ArgumentException(
                    $"Invalid argument: {nameof(source)} can not be null and must have a length"
                );
            }
        }
        ...
        protected static void ValidateFromSource(ReadOnlySpan<U> source)
        {
            ...
            {
                throw new System.ArgumentException(
                    $"Invalid argument: {nameof(source)} can not be null."
                );
            }
        }
        ...
        protected static void ValidateFromSource(U[] source, int offset, int count)
        {
            ...
            {
                throw new System.ArgumentException(
                    $"Invalid argument: {nameof(offset)} can not be greater than length of '{nameof(source)}'"
                );
            }
            ...
            {
                throw new System.ArgumentException(
                    $"Invalid argument: {nameof(offset)} plus {nameof(count)} can not be greater than length of '{nameof(source)}'"
                );
            }
        }
    }
