...
public class WasmExecutor : IExecutor
{
    ...
    private ExecuteResult GetExecutionResult(
    ...
    )
    {
        ...
        var lines = runResults
            .GetMeasurements()
            .Select(measurement => measurement.ToOutputLine())
            .ToList();
...
public sealed class WasmToolchain : IToolchain
{
    ...
    public WasmToolchain(bool logOutput)
        : this(WasmExecutor.DefaultTimeout, logOutput) { }
...
public class Program
{
    static int Main(string[] args)
    {
        ...
        env_info
            .GetType()
            .GetMethod("set_DotNetSdkVersion", BindingFlags.Instance | BindingFlags.NonPublic)
            .Invoke(env_info, new object[] { sdk_version });
