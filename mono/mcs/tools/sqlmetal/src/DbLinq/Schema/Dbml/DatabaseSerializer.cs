...
namespace DbLinq.Schema.Dbml
{
    ...
    {
        static readonly System.Reflection.MethodInfo fromBinHexStringMethod =
            typeof(XmlConvert).GetMethod(
                "FromBinHexString",
        ...
        static byte[] FromBinHexString(string input)
        {
            return input == null
                ? null
                : (byte[])fromBinHexStringMethod.Invoke(null, new object[] { input });
        }
        ...
        public object ReadRoot_Database()
        {
            ...
            if (
                Reader.LocalName != "Database"
                || Reader.NamespaceURI != "http://schemas.microsoft.com/linqtosql/dbml/2007"
            )
        ...
        public DbLinq.Schema.Dbml.Database ReadObject_Database(bool isNullable, bool checkType)
        {
            ...
            if (checkType)
            {
                ...
                if (t == null) { }
                    ...
                    t.Name != "Database"
                    || t.Namespace != "http://schemas.microsoft.com/linqtosql/dbml/2007"
                )
                    throw CreateUnknownTypeException(t);
            }

            ob = (DbLinq.Schema.Dbml.Database)
                Activator.CreateInstance(typeof(DbLinq.Schema.Dbml.Database), true);
            ...
            while (Reader.NodeType != System.Xml.XmlNodeType.EndElement)
            {
                if (Reader.NodeType == System.Xml.XmlNodeType.Element)
                {
                    ...
                    {
                        o4 = (DbLinq.Schema.Dbml.Table[])EnsureArrayIndex(
                            o4,
                            n3,
                            typeof(DbLinq.Schema.Dbml.Table)
                        );
                        o4[n3] = ReadObject_Table(false, true);
                        n3++;
                    }
                    else if (
                        Reader.LocalName == "Function"
                        && Reader.NamespaceURI == "http://schemas.microsoft.com/linqtosql/dbml/2007"
                        && !b2
                    )
                    {
                        o6 = (DbLinq.Schema.Dbml.Function[])EnsureArrayIndex(
                            o6,
                            n5,
                            typeof(DbLinq.Schema.Dbml.Function)
                        );
            ...
            o4 = (DbLinq.Schema.Dbml.Table[])ShrinkArray(
                o4,
                n3,
                typeof(DbLinq.Schema.Dbml.Table),
                true
            ...
            ob.@Table = o4;
            o6 = (DbLinq.Schema.Dbml.Function[])ShrinkArray(
                o6,
                n5,
                typeof(DbLinq.Schema.Dbml.Function),
                true
        ...
        public DbLinq.Schema.Dbml.AccessModifier ReadObject_AccessModifier(
            bool isNullable,
            bool checkType
        )
        {
            Reader.ReadStartElement();
            DbLinq.Schema.Dbml.AccessModifier res = GetEnumValue_AccessModifier(
                Reader.ReadString()
            );
        ...
        DbLinq.Schema.Dbml.AccessModifier GetEnumValue_AccessModifier(string xmlName)
        {
            ...
            {
                case "Public":
                    return DbLinq.Schema.Dbml.AccessModifier.Public;
                case "Internal":
                    return DbLinq.Schema.Dbml.AccessModifier.Internal;
                case "Protected":
                    return DbLinq.Schema.Dbml.AccessModifier.Protected;
                case "ProtectedInternal":
                    return DbLinq.Schema.Dbml.AccessModifier.ProtectedInternal;
                case "Private":
                    return DbLinq.Schema.Dbml.AccessModifier.Private;
                default:
                    throw CreateUnknownConstantException(
                        xmlName,
                        typeof(DbLinq.Schema.Dbml.AccessModifier)
                    );
            }
        }

        public DbLinq.Schema.Dbml.ClassModifier ReadObject_ClassModifier(
            bool isNullable,
            bool checkType
        )
        {
        ...
        DbLinq.Schema.Dbml.ClassModifier GetEnumValue_ClassModifier(string xmlName)
        {
            ...
            {
                case "Sealed":
                    return DbLinq.Schema.Dbml.ClassModifier.Sealed;
                case "Abstract":
                    return DbLinq.Schema.Dbml.ClassModifier.Abstract;
                default:
                    throw CreateUnknownConstantException(
                        xmlName,
                        typeof(DbLinq.Schema.Dbml.ClassModifier)
                    );
            }
        }

        public DbLinq.Schema.Dbml.SerializationMode ReadObject_SerializationMode(
            bool isNullable,
            bool checkType
        )
        {
            Reader.ReadStartElement();
            DbLinq.Schema.Dbml.SerializationMode res = GetEnumValue_SerializationMode(
                Reader.ReadString()
            );
            if (Reader.NodeType != XmlNodeType.None)
                Reader.ReadEndElement();
        ...
        DbLinq.Schema.Dbml.SerializationMode GetEnumValue_SerializationMode(string xmlName)
        {
            ...
            {
                case "None":
                    return DbLinq.Schema.Dbml.SerializationMode.None;
                case "Unidirectional":
                    return DbLinq.Schema.Dbml.SerializationMode.Unidirectional;
                default:
                    throw CreateUnknownConstantException(
                        xmlName,
                        typeof(DbLinq.Schema.Dbml.SerializationMode)
                    );
            }
        }
        ...
        public DbLinq.Schema.Dbml.Table ReadObject_Table(bool isNullable, bool checkType)
        {
            ...
            ob = (DbLinq.Schema.Dbml.Table)
                Activator.CreateInstance(typeof(DbLinq.Schema.Dbml.Table), true);
            ...
            while (Reader.NodeType != System.Xml.XmlNodeType.EndElement)
            {
                ...
                {
                    if (
                        Reader.LocalName == "UpdateFunction"
                        && Reader.NamespaceURI == "http://schemas.microsoft.com/linqtosql/dbml/2007"
                        && !b9
                    )
                    {
                    ...
                    )
                    {
                        ...
                        Reader.LocalName == "InsertFunction"
                        && Reader.NamespaceURI == "http://schemas.microsoft.com/linqtosql/dbml/2007"
                        && !b8
                    )
                    {
                        ...
                        Reader.LocalName == "DeleteFunction"
                        && Reader.NamespaceURI == "http://schemas.microsoft.com/linqtosql/dbml/2007"
                        && !b10
                    )
                    {
        ...
        public DbLinq.Schema.Dbml.Function ReadObject_Function(bool isNullable, bool checkType)
        {
            ...
            ob = (DbLinq.Schema.Dbml.Function)
                Activator.CreateInstance(typeof(DbLinq.Schema.Dbml.Function), true);
            ...
            while (Reader.NodeType != System.Xml.XmlNodeType.EndElement)
            {
                if (Reader.NodeType == System.Xml.XmlNodeType.Element)
                {
                    ...
                    )
                    {
                        ...
                        Reader.LocalName == "Parameter"
                        && Reader.NamespaceURI == "http://schemas.microsoft.com/linqtosql/dbml/2007"
                        && !b11
                    )
                    {
                        o14 = (DbLinq.Schema.Dbml.Parameter[])EnsureArrayIndex(
                            o14,
                            n13,
                            typeof(DbLinq.Schema.Dbml.Parameter)
                        );
            ...
            o14 = (DbLinq.Schema.Dbml.Parameter[])ShrinkArray(
                o14,
                n13,
                typeof(DbLinq.Schema.Dbml.Parameter),
                true
        ...
        public DbLinq.Schema.Dbml.Connection ReadObject_Connection(bool isNullable, bool checkType)
        {
            ...
            ob = (DbLinq.Schema.Dbml.Connection)
                Activator.CreateInstance(typeof(DbLinq.Schema.Dbml.Connection), true);
        ...
        public DbLinq.Schema.Dbml.MemberModifier ReadObject_MemberModifier(
            bool isNullable,
            bool checkType
        )
        {
            Reader.ReadStartElement();
            DbLinq.Schema.Dbml.MemberModifier res = GetEnumValue_MemberModifier(
                Reader.ReadString()
            );
            if (Reader.NodeType != XmlNodeType.None)
                Reader.ReadEndElement();
        ...
        DbLinq.Schema.Dbml.MemberModifier GetEnumValue_MemberModifier(string xmlName)
        {
            ...
            {
                case "Virtual":
                    return DbLinq.Schema.Dbml.MemberModifier.Virtual;
                case "Override":
                    return DbLinq.Schema.Dbml.MemberModifier.Override;
                case "New":
                    return DbLinq.Schema.Dbml.MemberModifier.New;
                case "NewVirtual":
                    return DbLinq.Schema.Dbml.MemberModifier.NewVirtual;
                default:
                    throw CreateUnknownConstantException(
                        xmlName,
                        typeof(DbLinq.Schema.Dbml.MemberModifier)
                    );
            }
        }

        public DbLinq.Schema.Dbml.TableFunction ReadObject_TableFunction(
            bool isNullable,
            bool checkType
        )
        {
            ...
            if (checkType)
            {
                ...
                if (t == null) { }
                    ...
                    t.Name != "TableFunction"
                    || t.Namespace != "http://schemas.microsoft.com/linqtosql/dbml/2007"
                )
                    throw CreateUnknownTypeException(t);
            }

            ob = (DbLinq.Schema.Dbml.TableFunction)
                Activator.CreateInstance(typeof(DbLinq.Schema.Dbml.TableFunction), true);
            ...
            while (Reader.NodeType != System.Xml.XmlNodeType.EndElement)
            {
                if (Reader.NodeType == System.Xml.XmlNodeType.Element)
                {
                    ...
                    {
                        o20 = (DbLinq.Schema.Dbml.TableFunctionParameter[])EnsureArrayIndex(
                            o20,
                            n19,
                            typeof(DbLinq.Schema.Dbml.TableFunctionParameter)
                        );
            ...
            o20 = (DbLinq.Schema.Dbml.TableFunctionParameter[])ShrinkArray(
                o20,
                n19,
                typeof(DbLinq.Schema.Dbml.TableFunctionParameter),
                true
        ...
        public DbLinq.Schema.Dbml.Type ReadObject_Type(bool isNullable, bool checkType)
        {
            ...
            ob = (DbLinq.Schema.Dbml.Type)
                Activator.CreateInstance(typeof(DbLinq.Schema.Dbml.Type), true);
            ...
            while (Reader.NodeType != System.Xml.XmlNodeType.EndElement)
            {
                if (Reader.NodeType == System.Xml.XmlNodeType.Element)
                {
                    ...
                    {
                        o26 = (DbLinq.Schema.Dbml.Type[])EnsureArrayIndex(
                            o26,
                            n25,
                            typeof(DbLinq.Schema.Dbml.Type)
                        );
            ...
            ob.@Items = o24;
            o26 = (DbLinq.Schema.Dbml.Type[])ShrinkArray(
                o26,
                n25,
                typeof(DbLinq.Schema.Dbml.Type),
                true
        ...
        public DbLinq.Schema.Dbml.Return ReadObject_Return(bool isNullable, bool checkType)
        {
            ...
            ob = (DbLinq.Schema.Dbml.Return)
                Activator.CreateInstance(typeof(DbLinq.Schema.Dbml.Return), true);
        ...
        public DbLinq.Schema.Dbml.Parameter ReadObject_Parameter(bool isNullable, bool checkType)
        {
            ...
            ob = (DbLinq.Schema.Dbml.Parameter)
                Activator.CreateInstance(typeof(DbLinq.Schema.Dbml.Parameter), true);
        ...
        public DbLinq.Schema.Dbml.ConnectionMode ReadObject_ConnectionMode(
            bool isNullable,
            bool checkType
        )
        {
            Reader.ReadStartElement();
            DbLinq.Schema.Dbml.ConnectionMode res = GetEnumValue_ConnectionMode(
                Reader.ReadString()
            );
            if (Reader.NodeType != XmlNodeType.None)
                Reader.ReadEndElement();
        ...
        DbLinq.Schema.Dbml.ConnectionMode GetEnumValue_ConnectionMode(string xmlName)
        {
            switch (xmlName)
            {
                case "ConnectionString":
                    return DbLinq.Schema.Dbml.ConnectionMode.ConnectionString;
                case "AppSettings":
                    return DbLinq.Schema.Dbml.ConnectionMode.AppSettings;
                case "WebSettings":
                    return DbLinq.Schema.Dbml.ConnectionMode.WebSettings;
                default:
                    throw CreateUnknownConstantException(
                        xmlName,
                        typeof(DbLinq.Schema.Dbml.ConnectionMode)
                    );
            }
        }

        public DbLinq.Schema.Dbml.TableFunctionReturn ReadObject_TableFunctionReturn(
            bool isNullable,
            bool checkType
        )
        {
            ...
            if (checkType)
            {
                ...
                if (t == null) { }
                    ...
                    t.Name != "TableFunctionReturn"
                    || t.Namespace != "http://schemas.microsoft.com/linqtosql/dbml/2007"
                )
                    throw CreateUnknownTypeException(t);
            }

            ob = (DbLinq.Schema.Dbml.TableFunctionReturn)
                Activator.CreateInstance(typeof(DbLinq.Schema.Dbml.TableFunctionReturn), true);
        ...
        public DbLinq.Schema.Dbml.TableFunctionParameter ReadObject_TableFunctionParameter(
            bool isNullable,
            bool checkType
        )
        {
            ...
            if (checkType)
            {
                ...
                if (t == null) { }
                    ...
                    t.Name != "TableFunctionParameter"
                    || t.Namespace != "http://schemas.microsoft.com/linqtosql/dbml/2007"
                )
                    throw CreateUnknownTypeException(t);
            }

            ob = (DbLinq.Schema.Dbml.TableFunctionParameter)
                Activator.CreateInstance(typeof(DbLinq.Schema.Dbml.TableFunctionParameter), true);
        ...
        public DbLinq.Schema.Dbml.Column ReadObject_Column(bool isNullable, bool checkType)
        {
            ...
            ob = (DbLinq.Schema.Dbml.Column)
                Activator.CreateInstance(typeof(DbLinq.Schema.Dbml.Column), true);
        ...
        public DbLinq.Schema.Dbml.Association ReadObject_Association(
            bool isNullable,
            bool checkType
        )
        {
            ...
            ob = (DbLinq.Schema.Dbml.Association)
                Activator.CreateInstance(typeof(DbLinq.Schema.Dbml.Association), true);
        ...
        public DbLinq.Schema.Dbml.ParameterDirection ReadObject_ParameterDirection(
            bool isNullable,
            bool checkType
        )
        {
            Reader.ReadStartElement();
            DbLinq.Schema.Dbml.ParameterDirection res = GetEnumValue_ParameterDirection(
                Reader.ReadString()
            );
            if (Reader.NodeType != XmlNodeType.None)
                Reader.ReadEndElement();
        ...
        DbLinq.Schema.Dbml.ParameterDirection GetEnumValue_ParameterDirection(string xmlName)
        {
            switch (xmlName)
            {
                ...
                default:
                    throw CreateUnknownConstantException(
                        xmlName,
                        typeof(DbLinq.Schema.Dbml.ParameterDirection)
                    );
            }
        }
        ...
        DbLinq.Schema.Dbml.Version GetEnumValue_Version(string xmlName)
        {
            ...
            {
                case "Current":
                    return DbLinq.Schema.Dbml.Version.Current;
                case "Original":
                    return DbLinq.Schema.Dbml.Version.Original;
                default:
                    throw CreateUnknownConstantException(
                        xmlName,
                        typeof(DbLinq.Schema.Dbml.Version)
                    );
            }
        }

        public DbLinq.Schema.Dbml.UpdateCheck ReadObject_UpdateCheck(
            bool isNullable,
            bool checkType
        )
        {
        ...
        DbLinq.Schema.Dbml.UpdateCheck GetEnumValue_UpdateCheck(string xmlName)
        {
            ...
            {
                case "Always":
                    return DbLinq.Schema.Dbml.UpdateCheck.Always;
                case "Never":
                    return DbLinq.Schema.Dbml.UpdateCheck.Never;
                case "WhenChanged":
                    return DbLinq.Schema.Dbml.UpdateCheck.WhenChanged;
                default:
                    throw CreateUnknownConstantException(
                        xmlName,
                        typeof(DbLinq.Schema.Dbml.UpdateCheck)
                    );
            }
        }
        ...
        DbLinq.Schema.Dbml.AutoSync GetEnumValue_AutoSync(string xmlName)
        {
            ...
            {
                case "Never":
                    return DbLinq.Schema.Dbml.AutoSync.Never;
                case "OnInsert":
                    return DbLinq.Schema.Dbml.AutoSync.OnInsert;
                case "OnUpdate":
                    return DbLinq.Schema.Dbml.AutoSync.OnUpdate;
                case "Always":
                    return DbLinq.Schema.Dbml.AutoSync.Always;
                case "Default":
                    return DbLinq.Schema.Dbml.AutoSync.Default;
                default:
                    throw CreateUnknownConstantException(
                        xmlName,
                        typeof(DbLinq.Schema.Dbml.AutoSync)
                    );
            }
        }

        public DbLinq.Schema.Dbml.Cardinality ReadObject_Cardinality(
            bool isNullable,
            bool checkType
        )
        {
        ...
        DbLinq.Schema.Dbml.Cardinality GetEnumValue_Cardinality(string xmlName)
        {
            ...
            {
                case "One":
                    return DbLinq.Schema.Dbml.Cardinality.One;
                case "Many":
                    return DbLinq.Schema.Dbml.Cardinality.Many;
                default:
                    throw CreateUnknownConstantException(
                        xmlName,
                        typeof(DbLinq.Schema.Dbml.Cardinality)
                    );
            }
        }
    ...
    class GeneratedWriter : XmlSerializationWriter
    {
        ...
        static readonly System.Reflection.MethodInfo toBinHexStringMethod =
            typeof(XmlConvert).GetMethod(
                "ToBinHexString",
                System.Reflection.BindingFlags.Static | System.Reflection.BindingFlags.NonPublic,
                null,
        ...
        static string ToBinHexString(byte[] input)
        {
            return input == null
                ? null
                : (string)toBinHexStringMethod.Invoke(null, new object[] { input });
        }
        ...
        void WriteObject_Database(
            DbLinq.Schema.Dbml.Database ob,
            string element,
            string namesp,
            bool isNullable,
            bool needType,
        ...
        )
        {
            ...
            if (needType)
                WriteXsiType("Database", "http://schemas.microsoft.com/linqtosql/dbml/2007");
            ...
            if (ob.@AccessModifierSpecified)
            {
                WriteAttribute(
                    "AccessModifier",
                    "",
                    GetEnumValue_AccessModifier(ob.@AccessModifier)
                );
            }
            ...
            if (ob.@SerializationSpecified)
            {
                WriteAttribute(
                    "Serialization",
                    "",
                    GetEnumValue_SerializationMode(ob.@Serialization)
                );
            }
            WriteAttribute("EntityBase", "", ob.@EntityBase);

            WriteObject_Connection(
                ob.@Connection,
                "Connection",
                "http://schemas.microsoft.com/linqtosql/dbml/2007",
                false,
        ...
        void WriteObject_AccessModifier(
            DbLinq.Schema.Dbml.AccessModifier ob,
            string element,
            string namesp,
            bool isNullable,
            bool needType,
        ...
        )
        {
            ...
            if (needType)
                WriteXsiType("AccessModifier", "http://schemas.microsoft.com/linqtosql/dbml/2007");
        ...
        string GetEnumValue_AccessModifier(DbLinq.Schema.Dbml.AccessModifier val)
        {
            switch (val)
            {
                case DbLinq.Schema.Dbml.AccessModifier.Public:
                    return "Public";
                case DbLinq.Schema.Dbml.AccessModifier.Internal:
                    return "Internal";
                case DbLinq.Schema.Dbml.AccessModifier.Protected:
                    return "Protected";
                case DbLinq.Schema.Dbml.AccessModifier.ProtectedInternal:
                    return "ProtectedInternal";
                case DbLinq.Schema.Dbml.AccessModifier.Private:
                    return "Private";
                default:
                    throw CreateInvalidEnumValueException(
                        (long)val,
                        typeof(DbLinq.Schema.Dbml.AccessModifier).FullName
                    );
            }
        }

        void WriteObject_ClassModifier(
            DbLinq.Schema.Dbml.ClassModifier ob,
            string element,
            string namesp,
            bool isNullable,
            bool needType,
        ...
        )
        {
            ...
            if (needType)
                WriteXsiType("ClassModifier", "http://schemas.microsoft.com/linqtosql/dbml/2007");
        ...
        string GetEnumValue_ClassModifier(DbLinq.Schema.Dbml.ClassModifier val)
        {
            switch (val)
            {
                case DbLinq.Schema.Dbml.ClassModifier.Sealed:
                    return "Sealed";
                case DbLinq.Schema.Dbml.ClassModifier.Abstract:
                    return "Abstract";
                default:
                    throw CreateInvalidEnumValueException(
                        (long)val,
                        typeof(DbLinq.Schema.Dbml.ClassModifier).FullName
                    );
            }
        }

        void WriteObject_SerializationMode(
            DbLinq.Schema.Dbml.SerializationMode ob,
            string element,
            string namesp,
            bool isNullable,
            bool needType,
        ...
        string GetEnumValue_SerializationMode(DbLinq.Schema.Dbml.SerializationMode val)
        {
            switch (val)
            {
                case DbLinq.Schema.Dbml.SerializationMode.None:
                    return "None";
                case DbLinq.Schema.Dbml.SerializationMode.Unidirectional:
                    return "Unidirectional";
                default:
                    throw CreateInvalidEnumValueException(
                        (long)val,
                        typeof(DbLinq.Schema.Dbml.SerializationMode).FullName
                    );
            }
        }

        void WriteObject_Connection(
            DbLinq.Schema.Dbml.Connection ob,
            string element,
            string namesp,
            bool isNullable,
            bool needType,
        ...
        )
        {
            ...
            if (needType)
                WriteXsiType("Connection", "http://schemas.microsoft.com/linqtosql/dbml/2007");
        ...
        void WriteObject_Table(
            DbLinq.Schema.Dbml.Table ob,
            string element,
            string namesp,
            bool isNullable,
            bool needType,
        ...
        )
        {
            ...
            if (needType)
                WriteXsiType("Table", "http://schemas.microsoft.com/linqtosql/dbml/2007");
        ...
        void WriteObject_Function(
            DbLinq.Schema.Dbml.Function ob,
            string element,
            string namesp,
            bool isNullable,
            bool needType,
        ...
        )
        {
            ...
            if (needType)
                WriteXsiType("Function", "http://schemas.microsoft.com/linqtosql/dbml/2007");
            ...
            if (ob.@HasMultipleResultsSpecified)
            {
                WriteAttribute(
                    "HasMultipleResults",
                    "",
                    (ob.@HasMultipleResults ? "true" : "false")
                );
            }
            ...
            if (ob.@Items != null)
            {
                for (int n30 = 0; n30 < ob.@Items.Length; n30++)
                {
                    ...
                    {
                        WriteObject_Return(
                            ((DbLinq.Schema.Dbml.Return)ob.@Items[n30]),
                            "Return",
                            "http://schemas.microsoft.com/linqtosql/dbml/2007",
                            false,
                            false,
                    ...
                    {
                        WriteObject_Type(
                            ((DbLinq.Schema.Dbml.Type)ob.@Items[n30]),
                            "ElementType",
                            "http://schemas.microsoft.com/linqtosql/dbml/2007",
                            false,
                            false,
                        ...
                        throw CreateUnknownTypeException(ob.@Items[n30]);
                }
            }
            if (writeWrappingElem)
                WriteEndElement(ob);
        ...
        void WriteObject_ConnectionMode(
            DbLinq.Schema.Dbml.ConnectionMode ob,
            string element,
            string namesp,
            bool isNullable,
            bool needType,
        ...
        )
        {
            ...
            if (needType)
                WriteXsiType("ConnectionMode", "http://schemas.microsoft.com/linqtosql/dbml/2007");
        ...
        string GetEnumValue_ConnectionMode(DbLinq.Schema.Dbml.ConnectionMode val)
        {
            switch (val)
            {
                case DbLinq.Schema.Dbml.ConnectionMode.ConnectionString:
                    return "ConnectionString";
                case DbLinq.Schema.Dbml.ConnectionMode.AppSettings:
                    return "AppSettings";
                case DbLinq.Schema.Dbml.ConnectionMode.WebSettings:
                    return "WebSettings";
                default:
                    throw CreateInvalidEnumValueException(
                        (long)val,
                        typeof(DbLinq.Schema.Dbml.ConnectionMode).FullName
                    );
            }
        }

        void WriteObject_MemberModifier(
            DbLinq.Schema.Dbml.MemberModifier ob,
            string element,
            string namesp,
            bool isNullable,
            bool needType,
        ...
        )
        {
            ...
            if (needType)
                WriteXsiType("MemberModifier", "http://schemas.microsoft.com/linqtosql/dbml/2007");
        ...
        string GetEnumValue_MemberModifier(DbLinq.Schema.Dbml.MemberModifier val)
        {
            switch (val)
            {
                case DbLinq.Schema.Dbml.MemberModifier.Virtual:
                    return "Virtual";
                case DbLinq.Schema.Dbml.MemberModifier.Override:
                    return "Override";
                case DbLinq.Schema.Dbml.MemberModifier.New:
                    return "New";
                case DbLinq.Schema.Dbml.MemberModifier.NewVirtual:
                    return "NewVirtual";
                default:
                    throw CreateInvalidEnumValueException(
                        (long)val,
                        typeof(DbLinq.Schema.Dbml.MemberModifier).FullName
                    );
            }
        }

        void WriteObject_Type(
            DbLinq.Schema.Dbml.Type ob,
            string element,
            string namesp,
            bool isNullable,
            bool needType,
        ...
        )
        {
            ...
            if (needType)
                WriteXsiType("Type", "http://schemas.microsoft.com/linqtosql/dbml/2007");
            ...
            if (ob.@IsInheritanceDefaultSpecified)
            {
                WriteAttribute(
                    ...
                    "",
                    (ob.@IsInheritanceDefault ? "true" : "false")
                );
            }
            if (ob.@AccessModifierSpecified)
            {
            ...
            if (ob.@Items != null)
            {
                for (int n31 = 0; n31 < ob.@Items.Length; n31++)
                {
                    ...
                    {
                        WriteObject_Column(
                            ((DbLinq.Schema.Dbml.Column)ob.@Items[n31]),
                            "Column",
                            "http://schemas.microsoft.com/linqtosql/dbml/2007",
                            false,
                            false,
                    ...
                    {
                        WriteObject_Association(
                            ((DbLinq.Schema.Dbml.Association)ob.@Items[n31]),
                            "Association",
                            "http://schemas.microsoft.com/linqtosql/dbml/2007",
                            false,
                            false,
                        ...
                        throw CreateUnknownTypeException(ob.@Items[n31]);
                }
            }
            if (ob.@Type1 != null)
            {
        ...
        void WriteObject_TableFunction(
            DbLinq.Schema.Dbml.TableFunction ob,
            string element,
            string namesp,
            bool isNullable,
            bool needType,
        ...
        )
        {
            ...
            if (needType)
                WriteXsiType("TableFunction", "http://schemas.microsoft.com/linqtosql/dbml/2007");
            ...
            WriteObject_TableFunctionReturn(
                ob.@Return,
                "Return",
                "http://schemas.microsoft.com/linqtosql/dbml/2007",
                false,
        ...
        void WriteObject_Parameter(
            DbLinq.Schema.Dbml.Parameter ob,
            string element,
            string namesp,
            bool isNullable,
            bool needType,
        ...
        )
        {
            ...
            if (needType)
                WriteXsiType("Parameter", "http://schemas.microsoft.com/linqtosql/dbml/2007");
        ...
        void WriteObject_Return(
            DbLinq.Schema.Dbml.Return ob,
            string element,
            string namesp,
            bool isNullable,
            bool needType,
        ...
        )
        {
            ...
            if (needType)
                WriteXsiType("Return", "http://schemas.microsoft.com/linqtosql/dbml/2007");
        ...
        void WriteObject_Column(
            DbLinq.Schema.Dbml.Column ob,
            string element,
            string namesp,
            bool isNullable,
            bool needType,
        ...
        )
        {
            ...
            if (needType)
                WriteXsiType("Column", "http://schemas.microsoft.com/linqtosql/dbml/2007");
        ...
        void WriteObject_Association(
            DbLinq.Schema.Dbml.Association ob,
            string element,
            string namesp,
            bool isNullable,
            bool needType,
        ...
        )
        {
            ...
            if (needType)
                WriteXsiType("Association", "http://schemas.microsoft.com/linqtosql/dbml/2007");
        ...
        void WriteObject_TableFunctionParameter(
            DbLinq.Schema.Dbml.TableFunctionParameter ob,
            string element,
            string namesp,
            bool isNullable,
            bool needType,
        ...
        void WriteObject_TableFunctionReturn(
            DbLinq.Schema.Dbml.TableFunctionReturn ob,
            string element,
            string namesp,
            bool isNullable,
            bool needType,
        ...
        void WriteObject_ParameterDirection(
            DbLinq.Schema.Dbml.ParameterDirection ob,
            string element,
            string namesp,
            bool isNullable,
            bool needType,
        ...
        string GetEnumValue_ParameterDirection(DbLinq.Schema.Dbml.ParameterDirection val)
        {
            switch (val)
            {
                ...
                default:
                    throw CreateInvalidEnumValueException(
                        (long)val,
                        typeof(DbLinq.Schema.Dbml.ParameterDirection).FullName
                    );
            }
        }

        void WriteObject_UpdateCheck(
            DbLinq.Schema.Dbml.UpdateCheck ob,
            string element,
            string namesp,
            bool isNullable,
            bool needType,
        ...
        )
        {
            ...
            if (needType)
                WriteXsiType("UpdateCheck", "http://schemas.microsoft.com/linqtosql/dbml/2007");
        ...
        string GetEnumValue_UpdateCheck(DbLinq.Schema.Dbml.UpdateCheck val)
        {
            switch (val)
            {
                case DbLinq.Schema.Dbml.UpdateCheck.Always:
                    return "Always";
                case DbLinq.Schema.Dbml.UpdateCheck.Never:
                    return "Never";
                case DbLinq.Schema.Dbml.UpdateCheck.WhenChanged:
                    return "WhenChanged";
                default:
                    throw CreateInvalidEnumValueException(
                        (long)val,
                        typeof(DbLinq.Schema.Dbml.UpdateCheck).FullName
                    );
            }
        }

        void WriteObject_AutoSync(
            DbLinq.Schema.Dbml.AutoSync ob,
            string element,
            string namesp,
            bool isNullable,
            bool needType,
        ...
        )
        {
            ...
            if (needType)
                WriteXsiType("AutoSync", "http://schemas.microsoft.com/linqtosql/dbml/2007");
        ...
        string GetEnumValue_AutoSync(DbLinq.Schema.Dbml.AutoSync val)
        {
            switch (val)
            {
                case DbLinq.Schema.Dbml.AutoSync.Never:
                    return "Never";
                case DbLinq.Schema.Dbml.AutoSync.OnInsert:
                    return "OnInsert";
                case DbLinq.Schema.Dbml.AutoSync.OnUpdate:
                    return "OnUpdate";
                case DbLinq.Schema.Dbml.AutoSync.Always:
                    return "Always";
                case DbLinq.Schema.Dbml.AutoSync.Default:
                    return "Default";
                default:
                    throw CreateInvalidEnumValueException(
                        (long)val,
                        typeof(DbLinq.Schema.Dbml.AutoSync).FullName
                    );
            }
        }

        void WriteObject_Cardinality(
            DbLinq.Schema.Dbml.Cardinality ob,
            string element,
            string namesp,
            bool isNullable,
            bool needType,
        ...
        )
        {
            ...
            if (needType)
                WriteXsiType("Cardinality", "http://schemas.microsoft.com/linqtosql/dbml/2007");
        ...
        string GetEnumValue_Cardinality(DbLinq.Schema.Dbml.Cardinality val)
        {
            switch (val)
            {
                case DbLinq.Schema.Dbml.Cardinality.One:
                    return "One";
                case DbLinq.Schema.Dbml.Cardinality.Many:
                    return "Many";
                default:
                    throw CreateInvalidEnumValueException(
                        (long)val,
                        typeof(DbLinq.Schema.Dbml.Cardinality).FullName
                    );
            }
        }

        void WriteObject_Version(
            DbLinq.Schema.Dbml.Version ob,
            string element,
            string namesp,
            bool isNullable,
            bool needType,
        ...
        )
        {
            ...
            if (needType)
                WriteXsiType("Version", "http://schemas.microsoft.com/linqtosql/dbml/2007");
        ...
        string GetEnumValue_Version(DbLinq.Schema.Dbml.Version val)
        {
            switch (val)
            {
                case DbLinq.Schema.Dbml.Version.Current:
                    return "Current";
                case DbLinq.Schema.Dbml.Version.Original:
                    return "Original";
                default:
                    throw CreateInvalidEnumValueException(
                        (long)val,
                        typeof(DbLinq.Schema.Dbml.Version).FullName
                    );
            }
        }
