...
namespace Mono.DocTest
{
    ...
    public unsafe class Widget : IProcess
    {
        ...
        public void M1(
            [Doc("c", FlagsEnum = ConsoleModifiers.Alt | ConsoleModifiers.Control)] char c,
            [Doc("f", NonFlagsEnum = Color.Red)] out float f,
            [Doc("v")] ref DocValueType v
        )
        {
            f = 0;
        }
        ...
        public dynamic Dynamic0(dynamic a, dynamic b)
        {
            return a + b;
        }
    ...
    public class UseLists
    {
        ...
        public Generic.MyList<T> GetValues<T>(T value)
            where T : struct
        {
            return null;
        }
...
namespace Mono.DocTest.Generic
{
    ...
    public class MyList<[Mono.DocTest.Doc("Type Parameter!")] T>
        : GenericBase<T>,
            IEnumerable<int[]>
    {
