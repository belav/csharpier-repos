...
namespace Mono.Tools.CertView
{
    public class CertificateViewer : System.Windows.Forms.Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            // badPictureBox
            //
            this.badPictureBox.Image = (
                (System.Drawing.Bitmap)(resources.GetObject("badPictureBox.Image"))
            );
            ...
            // goodPictureBox
            //
            this.goodPictureBox.Image = (
                (System.Drawing.Bitmap)(resources.GetObject("goodPictureBox.Image"))
            );
            ...
            this.subjectAltNameLinkLabel.LinkClicked +=
                new System.Windows.Forms.LinkLabelLinkClickedEventHandler(
                    this.subjectAltNameLinkLabel_LinkClicked
                );
            //
            // keyUsageRichTextBox
            //
            ...
            this.panel4.Controls.AddRange(new System.Windows.Forms.Control[] { this.panel5 });
            ...
            // privateKeyLabel
            //
            this.privateKeyLabel.Font = new System.Drawing.Font(
                "Tahoma",
                8.25F,
            ...
            // notAfterLabel
            //
            this.notAfterLabel.Font = new System.Drawing.Font(
                "Tahoma",
                8.25F,
                System.Drawing.FontStyle.Regular,
                System.Drawing.GraphicsUnit.Point,
            ...
            // notBeforeLabel
            //
            this.notBeforeLabel.Font = new System.Drawing.Font(
                "Tahoma",
                8.25F,
                System.Drawing.FontStyle.Regular,
                System.Drawing.GraphicsUnit.Point,
            ...
            // certificateLabel
            //
            this.certificateLabel.Font = new System.Drawing.Font(
                "Tahoma",
                8.25F,
                System.Drawing.FontStyle.Bold,
                System.Drawing.GraphicsUnit.Point,
            ...
            this.showComboBox.SelectedIndexChanged += new System.EventHandler(
                this.showComboBox_SelectedIndexChanged
            );
            //
            // detailsTextBox
            //
            ...
            this.fieldListView.SelectedIndexChanged += new System.EventHandler(
                this.fieldListView_SelectedIndexChanged
            );
            //
            // fieldColumnHeader
            //
            ...
            this.fieldsImageList.ImageStream = (
                (System.Windows.Forms.ImageListStreamer)(
                    resources.GetObject("fieldsImageList.ImageStream")
                )
            );
            ...
            this.iconImageList.ImageStream = (
                (System.Windows.Forms.ImageListStreamer)(
                    resources.GetObject("iconImageList.ImageStream")
                )
            );
        ...
        public void LoadCertificate(string filename)
        {
            ...
            itemSignatureAlgorithm = new ListViewItem(
                CertificateFormatter.FieldNames.SignatureAlgorithm,
                1
            );
            ...
            itemThumbprintAlgorithm = new ListViewItem(
                CertificateFormatter.PropertyNames.ThumbprintAlgorithm,
                0
            );
        ...
        private void subjectAltNameLinkLabel_LinkClicked(
            object sender,
