...
namespace Mono
{
    public class Driver
    {
        ...
        static bool SplitDriverAndScriptArguments(
            ref string[] driver_args,
            out string[] script_args
        )
        {
    ...
    public class CSharpShell
    {
        ...
        void SetupConsole()
        {
            ...
            editor = new Mono.Terminal.LineEditor("csharp", 300) { HeuristicsMode = "csharp" };
    ...
    class ClientCSharpShell : CSharpShell
    {
        ...
        public ClientCSharpShell(Evaluator evaluator, string target_host, int target_port)
            : base(evaluator)
        {
    ...
    class ClientCSharpShell_v1 : CSharpShell
    {
            ...
            : base(evaluator)
        {
            ...
            string agent_arg = String.Format(
                "--agent:{0}:{1}",
