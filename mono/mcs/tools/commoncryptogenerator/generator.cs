...
namespace Xamarin
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            const string checkUseSalt =
                "if (UseSalt) throw new NotImplementedException (\"UseSalt=true is not implemented on Mono yet\");";
            CommonCryptor.Generate(
                "System.Security.Cryptography",
