...
namespace Microsoft.Cci.Pdb
{
    ...
    internal struct CV_PRIMITIVE_TYPE
    {
        ...
        {
            return (
                ((CV_TYPE(typ) == CV_type.CV_UNSIGNED) && CV_TYP_IS_DIRECT(typ))
        ...
        {
            return (
                CV_IS_PRIMITIVE(typ) && CV_TYPE(typ) == CV_type.CV_CVRESERVED && CV_TYP_IS_PTR(typ)
            );
        }
    }
    ...
    internal enum CV_ptrtype
    {
        ...
        CV_PTR_UNUSEDPTR =
            0x0d // first unused pointer type
        ,
    };
