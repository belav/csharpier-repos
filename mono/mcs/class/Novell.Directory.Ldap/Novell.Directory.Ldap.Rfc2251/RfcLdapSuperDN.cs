...
namespace Novell.Directory.Ldap.Rfc2251
{
    ...
    public class RfcLdapSuperDN : Asn1Tagged
    {
        ...
        /// </summary>
        protected static readonly Asn1Identifier ID = new Asn1Identifier(
        ...
        public RfcLdapSuperDN(String s)
            : base(ID, new Asn1OctetString(s), false) //type is encoded IMPLICITLY
        {
            try
            {
        ...
        public RfcLdapSuperDN(sbyte[] ba)
            : base(ID, new Asn1OctetString(ba), false) //type is encoded IMPLICITLY
        {
            this.content = ba;
        }
