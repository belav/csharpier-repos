...
namespace zipsharp
{
    static class NativeUnzip
    {
        ...
        public static long CurrentFileLength32(UnzipHandle handle)
        {
            ...
            int result = unzGetCurrentFileInfo_32(
                handle,
                out info,
                null,
                0,
        ...
        public static long CurrentFileLength64(UnzipHandle handle)
        {
            ...
            int result = unzGetCurrentFileInfo_64(
                handle,
                out info,
                null,
                0,
        ...
        private static string[] GetFiles(
            UnzipHandle handle,
            Func<UnzipHandle, string> getCurrentFileName
        )
        {
        ...
        public static unsafe int Read(UnzipHandle handle, byte[] buffer, int offset, int count)
        {
            if ((buffer.Length - offset) > count)
                throw new ArgumentOutOfRangeException(
                    "count",
                    "Buffer is too small to read that amount of data"
                );
        ...
        static extern UnzipHandle unzOpen2_32(
            string path,
        ...
        static extern UnzipHandle unzOpen2_64(
            string path,
        ...
        [DllImport("MonoPosixHelper", CallingConvention = CallingConvention.Cdecl)]
        static extern int unzOpenCurrentFile2(
            UnzipHandle handle,
            out int method,
            out int level,
            int raw
        ...
        [DllImport(
            "MonoPosixHelper",
            EntryPoint = "unzGetCurrentFileInfo",
            CallingConvention = CallingConvention.Cdecl
        )]
        static extern int unzGetCurrentFileInfo_32(
            UnzipHandle handle,
        ...
        static extern int unzGetCurrentFileInfo_64(
            UnzipHandle handle,
