...
namespace zipsharp
{
    static class NativeZip
    {
        ...
        static extern unsafe int zipWriteInFileInZip(ZipHandle handle, byte* buffer, uint len);

        [DllImport("MonoPosixHelper")]
        static extern int zipCloseFileInZip(ZipHandle handle);

        [DllImport("MonoPosixHelper", EntryPoint = "zipOpen2")]
        static extern ZipHandle zipOpen2_32(
            string pathname,
            int append,
        ...
        [DllImport("MonoPosixHelper", EntryPoint = "zipOpen2")]
        static extern ZipHandle zipOpen2_64(
            string pathname,
            int append,
            IntPtr globalcomment, // zipcharpc*
        ...
        static extern int zipOpenNewFileInZip_32(
            ZipHandle handle,
            string filename,
        ...
        [DllImport("MonoPosixHelper", EntryPoint = "zipOpenNewFileInZip")]
        static extern int zipOpenNewFileInZip_64(
            ZipHandle handle,
            string filename,
