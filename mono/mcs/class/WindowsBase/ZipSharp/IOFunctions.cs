...
namespace zipsharp
{
    ...
    int TellFileFunc32(IntPtr opaque, IntPtr stream);
    ...
    [UnmanagedFunctionPointerAttribute(CallingConvention.Cdecl)]
    internal delegate /* long */
    long TellFileFunc64(IntPtr opaque, IntPtr stream);
