...
namespace MonoTests.System.Xml.TestClasses
{
    ...
    public enum EnumDefaultValueNF
    {
        e1 = 1,
        e2 = 2,
        e3 = 3,
    ...
    public class EntityContainer
    {
        ...
        public EntityCollection Collection1
        {
            ...
            {
                collection1 = value;
                collection1.Container = "assigned";
            }
        }
        ...
        public EntityCollection Collection2
        {
            ...
            {
                collection2 = value;
                collection2.Container = "assigned";
            }
        }
        ...
        public EntityCollection Collection3
        {
            ...
            {
                collection3 = value;
                collection3.Container = "assigned";
            }
        }
        ...
        public EntityCollection Collection4
        {
            ...
            {
                collection4 = value;
                collection4.Container = "assigned";
            }
        }
    }
    ...
    public class ObjectWithElementRequiringImplicitCast
    {
        ...
        public SimpleObjectB Object { get; set; }
    }
