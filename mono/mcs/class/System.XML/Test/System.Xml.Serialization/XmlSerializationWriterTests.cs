...
namespace MonoTests.System.XmlSerialization
{
    ...
    public class XmlSerializarionWriterTester : XmlSerializationWriter
    {
        ...
        public void ExecuteWritePotentiallyReferencingElement(
            string name,
            string ns,
            object o,
            Type ambientType,
    ...
    public class XmlSerializationWriterSimpleTests : XmlSerializarionWriterTester
    {
        ...
        {
            Assert.AreEqual(
                "Hello go dogs_go 123go what_x0027_s.up",
                FromXmlNmTokens("Hello go dogs_go 123go what's.up")
            );
        }
        ...
        public void TestWriteNamespaceDeclarations()
        {
            ...
            WriteEndElement();
            Assert.AreEqual(
                XmlSerializerTests.Infoset("<x xmlns:mypref='some:urn' />"),
                XmlSerializerTests.Infoset(Content)
            );
            ...
            WriteEndElement();
            Assert.AreEqual(
                XmlSerializerTests.Infoset("<x xmlns:ns2='another:urn' xmlns:mypref='some:urn' />"),
                XmlSerializerTests.Infoset(Content)
            );
            ...
            WriteEndElement();
            Assert.AreEqual(
                XmlSerializerTests.Infoset(
                    "<x xmlns:ns3='ya:urn' xmlns:ns2='another:urn' xmlns:mypref='some:urn' />"
                ),
                XmlSerializerTests.Infoset(Content)
            );
        }
        ...
        public void TestWriteNullableStringLiteral()
        {
            ...
            Assert.AreEqual(
                XmlSerializerTests.Infoset(
                    "<x d1p1:nil='true' xmlns:d1p1='http://www.w3.org/2001/XMLSchema-instance' />"
                ),
                XmlSerializerTests.Infoset(Content)
            );
        ...
        public void TestWritePotentiallyReferencingElement()
        {
            ...
            xsw.ExecuteWritePotentiallyReferencingElement(
                "x",
                ANamespace,
                EnumDefaultValue.e1,
            ...
            Assert.AreEqual(
                string.Format(CultureInfo.InvariantCulture, "<x xmlns='{0}'>1</x>", ANamespace),
                xsw.Content,
                "#1"
            );
        ...
        public void TestWriteTypedPrimitive_Base64Binary()
        {
            ...
            Assert.AreEqual(
                string.Format(CultureInfo.InvariantCulture, "<x>{0}</x>", expected),
                xsw.Content,
                "#2"
            );
        ...
        public void TestWriteTypedPrimitive_Boolean()
        {
            ...
            Assert.AreEqual(
                string.Format(CultureInfo.InvariantCulture, "<x xmlns='{0}'>true</x>", ANamespace),
                xsw.Content,
                "#1"
            );
            ...
            Assert.AreEqual(
                string.Format(CultureInfo.InvariantCulture, "< xmlns='{0}'>false</>", ANamespace),
                xsw.Content,
                "#6"
            );
        ...
        public void TestWriteTypedPrimitive_Char()
        {
            ...
            Assert.AreEqual(
                string.Format(CultureInfo.InvariantCulture, "<x xmlns='{0}'>99</x>", ANamespace),
                xsw.Content,
                "#1"
            );
            ...
            Assert.AreEqual(
                string.Format(CultureInfo.InvariantCulture, "< xmlns='{0}'>32</>", ANamespace),
                xsw.Content,
                "#6"
            );
        ...
        public void TestWriteTypedPrimitive_DateTime()
        {
            ...
            Assert.AreEqual(
                string.Format(
                    CultureInfo.InvariantCulture,
                    "<x xmlns='{0}'>1973-08-13T00:00:00</x>",
                    ANamespace
                ),
                xsw.Content,
                "#1"
            ...
            Assert.AreEqual(
                string.Format(CultureInfo.InvariantCulture, "<x>{0}</x>", FromDateTime(dateTime)),
                xsw.Content,
                "#2"
            );
        ...
        public void TestWriteTypedPrimitive_Enum()
        {
            ...
            xsw.ExecuteWriteTypedPrimitive(
                "x",
                XmlSchemaInstanceNamespace,
                EnumDefaultValue.e2,
                false
            ...
            Assert.AreEqual(
                string.Format(CultureInfo.InvariantCulture, "< xmlns='{0}'>3</>", ANamespace),
                xsw.Content,
                "#6"
            );
        ...
        public void TestWriteTypedPrimitive_Guid()
        {
            ...
            Assert.AreEqual(
                string.Format(CultureInfo.InvariantCulture, "<x>{0}</x>", expectedGuid),
                xsw.Content,
                "#2"
            );
        ...
        public void TestWriteTypedPrimitive_Int()
        {
            ...
            Assert.AreEqual(
                string.Format(CultureInfo.InvariantCulture, "<x xmlns='{0}'>76665</x>", ANamespace),
                xsw.Content,
                "#1"
            );
            ...
            Assert.AreEqual(
                string.Format(CultureInfo.InvariantCulture, "< xmlns='{0}'>434</>", ANamespace),
                xsw.Content,
                "#6"
            );
        ...
        public void TestWriteTypedPrimitive_String()
        {
            ...
            Assert.AreEqual(
                string.Format(CultureInfo.InvariantCulture, "<x xmlns='{0}'>hello</x>", ANamespace),
                xsw.Content,
                "#1"
            );
            ...
            Assert.AreEqual(
                string.Format(CultureInfo.InvariantCulture, "<x xmlns='{0}' />", ANamespace),
                xsw.Content,
                "#6"
            );
        ...
        public void TestWriteTypedPrimitive_UnsignedByte()
        {
            ...
            Assert.AreEqual(
                string.Format(CultureInfo.InvariantCulture, "<x xmlns='{0}'>5</x>", ANamespace),
                xsw.Content,
                "#1"
            );
            ...
            Assert.AreEqual(
                string.Format(CultureInfo.InvariantCulture, "< xmlns='{0}'>1</>", ANamespace),
                xsw.Content,
                "#6"
            );
        ...
        public void TestWriteTypedPrimitive_XmlQualifiedName()
        {
            ...
            Assert.AreEqual(
                string.Format(
                    CultureInfo.InvariantCulture,
                    "<x xmlns:q4='{0}' xmlns='{1}'>q4:something</x>",
                    AnotherNamespace,
                    XmlSchemaNamespace
                ),
                xsw.Content,
            ...
            Assert.AreEqual(
                string.Format(
                    CultureInfo.InvariantCulture,
                    "<x xmlns:q5='{0}' xmlns='{1}'>q5:something</x>",
                    AnotherNamespace,
                    XmlSchemaInstanceNamespace
                ),
                xsw.Content,
            ...
            Assert.AreEqual(
                string.Format(
                    CultureInfo.InvariantCulture,
                    "< xmlns:q6='{0}' xmlns='{1}'>q6:something</>",
                    AnotherNamespace,
                    ANamespace
                ),
                xsw.Content,
            ...
            xsw.ExecuteWriteTypedPrimitive("x", ANamespace, qname, false);
            Assert.AreEqual(
                string.Format(CultureInfo.InvariantCulture, "<x xmlns='{0}'>else</x>", ANamespace),
                xsw.Content,
                "#B1"
            );
            ...
            xsw.ExecuteWriteTypedPrimitive(string.Empty, ANamespace, qname, false);
            Assert.AreEqual(
                string.Format(CultureInfo.InvariantCulture, "< xmlns='{0}'>else</>", ANamespace),
                xsw.Content,
                "#B6"
            );
        ...
        public void TestNullableDatesAndTimes()
        {
            ...
            var expected =
                ...
                + Environment.NewLine
                + "  <MyTimeNullable>10:00:00.0000000Z</MyTimeNullable>"
                + Environment.NewLine
                + "  <MyDate>2012-01-03</MyDate>"
                + Environment.NewLine
                + "  <MyDateNullable>2012-01-03</MyDateNullable>"
                + Environment.NewLine
                + "</root>";
