...
namespace MonoTests.System.XmlSerialization
{
    ...
    public class XmlReflectionImporterTests
    {
        ...
        private XmlMembersMapping MembersMap(
            Type t,
        ...
        public void TestXmlSerializableTypeMapping()
        {
            ...
            Assert.AreEqual(
                "MonoTests.System.XmlSerialization.XmlReflectionImporterTests.Employee",
                tm.TypeFullName,
                "#4"
            );
        }
        ...
        public void TestClassTypeMapping_NestedStruct()
        {
            ...
            Assert.AreEqual(
                "MonoTests.System.XmlSerialization.XmlReflectionImporterTests.NestedStruct",
                tm.TypeFullName,
                "#4"
            );
        }
        ...
        public void TestClassTypeMapping_Array()
        {
            ...
            Assert.AreEqual(
                "MonoTests.System.Xml.TestClasses.SimpleClass[]",
                tm.TypeFullName,
                "#A4"
            );
        ...
        public void TypeMapping_IEnumerable_SimpleClass()
        {
            ...
            Assert.AreEqual(
                "MonoTests.System.XmlSerialization.XmlReflectionImporterTests.SimpleClassEnumerable",
                tm.TypeFullName,
                "#4"
            );
        ...
        public void TypeMapping_IEnumerable_Object()
        {
            ...
            Assert.AreEqual(
                "MonoTests.System.XmlSerialization.XmlReflectionImporterTests.ObjectEnumerable",
                tm.TypeFullName,
                "#4"
            );
        ...
        public void TypeMapping_IEnumerable_SimpleClass_PrivateCurrent()
        {
            ...
            Assert.AreEqual(
                "MonoTests.System.XmlSerialization.XmlReflectionImporterTests.SimpleClassEnumerablePrivateCurrent",
                tm.TypeFullName,
                "#4"
            );
            ...
            Assert.AreEqual(string.Empty, tm.Namespace, "#B2");
            Assert.AreEqual(
                "ArrayOfArrayOfSimpleClassEnumerablePrivateCurrent",
                tm.TypeName,
                "#B3"
            );
            Assert.AreEqual(
            ...
            Assert.AreEqual(string.Empty, tm.Namespace, "#C2");
            Assert.AreEqual(
                "ArrayOfArrayOfArrayOfSimpleClassEnumerablePrivateCurrent",
                tm.TypeName,
                "#C3"
            );
            Assert.AreEqual(
        ...
        public void TypeMapping_IEnumerable_SimpleClass_PrivateGetEnumerator()
        {
            ...
            Assert.AreEqual(
                "MonoTests.System.XmlSerialization.XmlReflectionImporterTests.SimpleClassEnumerablePrivateGetEnumerator",
                tm.TypeFullName,
                "#4"
            );
            ...
            Assert.AreEqual(string.Empty, tm.Namespace, "#B2");
            Assert.AreEqual(
                "ArrayOfArrayOfSimpleClassEnumerablePrivateGetEnumerator",
                tm.TypeName,
                "#B3"
            );
            Assert.AreEqual(
            ...
            Assert.AreEqual(string.Empty, tm.Namespace, "#C2");
            Assert.AreEqual(
                "ArrayOfArrayOfArrayOfSimpleClassEnumerablePrivateGetEnumerator",
                tm.TypeName,
                "#C3"
            );
            Assert.AreEqual(
        ...
        public void TypeMapping_ICollection_SimpleClass()
        {
            ...
            Assert.AreEqual(
                "MonoTests.System.XmlSerialization.XmlReflectionImporterTests.SimpleClassCollection",
                tm.TypeFullName,
                "#4"
            );
        ...
        public void TypeMapping_ICollection_Object()
        {
            ...
            Assert.AreEqual(
                "MonoTests.System.XmlSerialization.XmlReflectionImporterTests.ObjectCollection",
                tm.TypeFullName,
                "#4"
            );
        ...
        public void TypeMapping_InvalidDefault()
        {
            ...
            catch (InvalidOperationException ex)
            {
                ...
                Assert.AreEqual(
                    typeof(InvalidOperationException),
                    ex.InnerException.InnerException.GetType(),
                    "#A10"
                );
                Assert.IsNotNull(ex.InnerException.InnerException.Message, "#A11");
                Assert.IsTrue(
                    ex.InnerException.InnerException.Message.IndexOf("'2'") != -1,
                    "#A12"
                );
                Assert.IsTrue(
                    ex.InnerException.InnerException.Message.IndexOf(typeof(int).FullName) != -1,
                    "#A13"
                );
            ...
            catch (InvalidOperationException ex)
            {
                ...
                Assert.IsTrue(
                    ex.InnerException.InnerException.Message.IndexOf(typeof(string).FullName) != -1,
                    "#B12"
                );
                Assert.IsTrue(
                    ex.InnerException.InnerException.Message.IndexOf(typeof(int).FullName) != -1,
            ...
            catch (InvalidOperationException ex)
            {
                ...
                Assert.IsTrue(
                    ex.InnerException.InnerException.Message.IndexOf(typeof(MapModifiers).FullName)
                        != -1,
                    "#C13"
                );
            ...
            catch (InvalidOperationException ex)
            {
                ...
                Assert.IsTrue(
                    ex.InnerException.InnerException.Message.IndexOf("'20'") != -1,
                    "#D12"
                );
                Assert.IsTrue(
                    ex.InnerException.InnerException.Message.IndexOf(typeof(MapModifiers).FullName)
        ...
        public void TypeMapping_WrongChoices()
        {
            ...
            catch (InvalidOperationException ex)
            {
                ...
                Assert.IsTrue(
                    ex.Message.IndexOf("'" + typeof(WrongChoices).FullName + "'") != -1,
                    "#3"
                );
                ...
                Assert.IsTrue(
                    ex.InnerException.InnerException.Message.IndexOf("'StrangeOne'") != -1,
                    "#10"
                );
        ...
        public void TypeMapping_XmlText_PrimitiveTypes()
        {
            ...
            catch (InvalidOperationException ex)
            {
                ...
                Assert.IsTrue(
                    ex.InnerException.InnerException.Message.IndexOf("XmlText") != -1,
                    "#A9"
                );
            }
        ...
        {
            XmlTypeMapping tm = new XmlReflectionImporter("urn:bar").ImportTypeMapping(
                typeof(XmlSchemaProviderAndDefaultNamespaceType)
            );
        ...
        public class SimpleClassCollectionNoMatchingAddMethod : ICollection
        {
            ...
            {
                get { return (SimpleClass)_list[index]; }
            }
