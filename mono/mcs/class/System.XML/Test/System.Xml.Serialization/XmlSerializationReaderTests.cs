    ...
    public class XmlSerializationReaderTests : XmlSerializarionReaderTester
    {
        ...
        public void HandleOutAttributeParameters()
        {
            ...
            XmlMembersMapping map = imp.ImportMembersMapping(
                "elem",
                "urn:x",
                new XmlReflectionMember[] { m },
                true
            );
            XmlSerializer ser = XmlSerializer.FromMappings(new XmlMapping[] { map })[0];
            string xml = "<elem xmlns='urn:x' hooray='doh' />";
            object[] arr = ser.Deserialize(new StringReader(xml)) as object[];
        ...
        public void ExplicitlyOrderedMembers1()
        {
            ...
            var result = (ExplicitlyOrderedMembersType1)
                xs.Deserialize(
                    new StringReader(
                        @"
<root>
	...
	<child0>test</child0>
        ...
        public void ExplicitlyOrderedMembers3()
        {
            ...
            var result = (ExplicitlyOrderedMembersType3)
                xs.Deserialize(
                    new StringReader(
                        @"
<root>
	...
	<child0>test</child0>
        ...
        public void ExplicitlyOrderedMembers4()
        {
            ...
            var result = (ExplicitlyOrderedMembersType4)
                xs.Deserialize(
                    new StringReader(
                        @"
<root>
