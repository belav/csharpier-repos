...
namespace MonoTests.System.XmlSerialization
{
    ...
    public class ComplexDataStructure
    {
        ...
        void CheckObjectContent(Test exp, Test t)
        {
            ...
            Assert.AreEqual(
                ((AnotherTestPart)exp.anot).lo,
                ((AnotherTestPart)t.anot).lo,
                "t.anot.lo"
            );
            ...
            for (int n = 0; n < exp.extraElems.Length; n++)
                AssertionHelper.AssertEqualsXml(
                    "t.extraElems[" + n + "]",
                    exp.extraElems[n],
                    t.extraElems[n]
                );
            ...
            Assert.AreEqual(
                exp.extraElems23.Length,
                t.extraElems23.Length,
                "t.extraElems23.Length"
            );
            ...
            AssertionHelper.AssertEqualsArray(
                "t.byteByteArray",
                exp.byteByteArray,
                t.byteByteArray
            );
            ...
            for (int n = 0; n < t.RoList.Count; n++)
                TestPart.AssertEquals(
                    "t.RoList " + n,
                    (TestPart)exp.RoList[n],
                    (TestPart)t.RoList[n]
                );
    ...
    public class UnknownAttributeTester
    {
        ...
        public static void AssertEquals(
            string id,
            UnknownAttributeTester exp,
            UnknownAttributeTester ob
        )
        {
