...
namespace MonoTests.System.XmlSerialization
{
    ...
    public class XmlSerializerTests
    {
        ...
        public void TestSerializeEnumeration()
        {
            ...
            Assert.AreEqual(
                Infoset("<SimpleEnumeration>FIRST</SimpleEnumeration>"),
                WriterText,
                "#1"
            );
            ...
            Assert.AreEqual(
                Infoset("<SimpleEnumeration>SECOND</SimpleEnumeration>"),
                WriterText,
                "#2"
            );
        }
        ...
        public void TestSerializeEnumDefaultValue()
        {
            ...
            Serialize(
                EnumDefaultValue.e1 | EnumDefaultValue.e2 | EnumDefaultValue.e3,
            ...
            Assert.AreEqual(
                Infoset("<EnumDefaultValueNF>e3</EnumDefaultValueNF>"),
                WriterText,
                "#16"
            );
            ...
            Assert.AreEqual(
                Infoset("<EnumDefaultValueNF>e2</EnumDefaultValueNF>"),
                WriterText,
                "#17"
            );
            ...
            Assert.AreEqual(
                Infoset("<ZeroFlagEnum>tns:t&lt;w&gt;o</ZeroFlagEnum>"),
                WriterText,
                "#18"
            );
        ...
        public void TestSerializeEnumDefaultValue_InvalidValue2()
        {
            ...
            catch (InvalidOperationException ex)
            {
                ...
                Assert.IsTrue(
                    ex.InnerException.Message.IndexOf(typeof(EnumDefaultValue).FullName) != -1,
                    "#7"
                );
            }
        }
        ...
        public void TestSerializeEnumDefaultValueNF_InvalidValue1()
        {
            ...
            catch (InvalidOperationException ex)
            {
                ...
                Assert.IsTrue(
                    ex.InnerException.Message.IndexOf(typeof(EnumDefaultValueNF).FullName) != -1,
                    "#7"
                );
            }
        }
...
*/
        ...
        public void TestSerializeXmlEnumAttribute()
        {
            ...
            Assert.AreEqual(
                Infoset("<XmlSchemaForm>unqualified</XmlSchemaForm>"),
                WriterText,
                "#2"
            );
        }
        ...
        public void TestSerializeXmlEnumAttribute_IgnoredValue()
        {
            ...
            catch (InvalidOperationException ex)
            {
                ...
                Assert.IsTrue(ex.InnerException.Message.IndexOf("'0'") != -1, "#6");
                Assert.IsTrue(
                    ex.InnerException.Message.IndexOf(typeof(XmlSchemaForm).FullName) != -1,
                    "#7"
                );
            }
        }
        ...
        public void TestSerializeXmlElementArray()
        {
            XmlDocument doc = new XmlDocument();
            Serialize(
                new XmlElement[] { doc.CreateElement("elem1"), doc.CreateElement("elem2") },
                typeof(object)
            );
...
(?<error>(fatal\s)?error)[^:]+:(?<message>.+$)
        ...
        public void XmlArrayAttributeOnArray()
        {
            ...
            xtw.Close();
            string expected =
                @"<?xml version=""1.0"" encoding=""utf-16""?><XmlArrayOnArray xmlns:xsd=""http://www.w3.org/2001/XMLSchema"" xmlns:xsi=""http://www.w3.org/2001/XMLSchema-instance"" xmlns=""urn:foo""><Sane xmlns=""""><string xmlns=""urn:foo"">foo</string><string xmlns=""urn:foo"">bar</string></Sane><Mids xmlns=""""><ArrayItemInXmlArray xmlns=""urn:foo""><Whee xmlns=""""><string xmlns=""urn:gyabo"">foo</string><string xmlns=""urn:gyabo"">bar</string></Whee></ArrayItemInXmlArray></Mids></XmlArrayOnArray>";
            Assert.AreEqual(Infoset(expected), WriterText);
        }
        ...
        public void SupportIXmlSerializableImplicitlyConvertible()
        {
            ...
            new XmlSerializer(typeof(XmlSerializableImplicitConvertible), attrOverrides).Serialize(
                TextWriter.Null,
                x
            );
        }
        ...
        {
            GenNestedClass<string, int>.InnerClass<bool> nested = new GenNestedClass<
                string,
                int
            >.InnerClass<bool>();
            Serialize(nested);
        ...
        public void TestSerializeGenListClassListNested()
        {
            ...
            GenNestedClass<int, int>.InnerClass<string> inval1 = new GenNestedClass<
                int,
                int
            >.InnerClass<string>();
            inval1.inner = 1;
            ...
            GenNestedClass<int, int>.InnerClass<string> inval2 = new GenNestedClass<
                int,
                int
            >.InnerClass<string>();
            inval2.inner = 2;
            ...
            GenListClass<GenNestedClass<int, int>.InnerClass<string>> inlist2 =
                new GenListClass<GenNestedClass<int, int>.InnerClass<string>>();
            GenNestedClass<int, int>.InnerClass<string> inval3 = new GenNestedClass<
                int,
                int
            >.InnerClass<string>();
            inval3.inner = 30;
        ...
        {
            new XmlSerializer(typeof(XmlAnyElementForObjectsType)).Serialize(
                TextWriter.Null,
                new XmlAnyElementForObjectsType()
            );
        }
            ...
            switch (nod.NodeType)
            {
                case XmlNodeType.Attribute:
                    if (
                        ...
                        return;
                    sb.Append(
                        " " + nod.NamespaceURI + ":" + nod.LocalName + "='" + nod.Value + "'"
                    );
                    break;
        ...
        static XmlTypeMapping CreateSoapMapping(
            Type type,
