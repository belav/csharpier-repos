...
namespace MonoTests.System.XmlSerialization
{
    ...
    public class SoapReflectionImporterTests
    {
        ...
        {
            SoapReflectionImporter ri = new SoapReflectionImporter(overrides);
            XmlMembersMapping mm = ri.ImportMembersMapping(
                null,
                null,
                members,
                inContainer,
        ...
        public void TypeMapping_Field_Encoded()
        {
            ...
            Assert.AreEqual(
                "MonoTests.System.Xml.TestClasses.Field_Encoded",
                tm.TypeFullName,
                "#4"
            );
        }
        ...
        public void TypeMapping_IEnumerable_SimpleClass()
        {
            ...
            Assert.AreEqual(
                "MonoTests.System.XmlSerialization.SoapReflectionImporterTests.SimpleClassEnumerable",
                tm.TypeFullName,
                "#4"
            );
        ...
        public void TypeMapping_IEnumerable_Object()
        {
            ...
            Assert.AreEqual(
                "MonoTests.System.XmlSerialization.SoapReflectionImporterTests.ObjectEnumerable",
                tm.TypeFullName,
                "#4"
            );
        ...
        public void TypeMapping_IEnumerable_SimpleClass_PrivateCurrent()
        {
            ...
            Assert.AreEqual(
                "MonoTests.System.XmlSerialization.SoapReflectionImporterTests.SimpleClassEnumerablePrivateCurrent",
                tm.TypeFullName,
                "#4"
            );
        ...
        public void TypeMapping_IEnumerable_SimpleClass_PrivateGetEnumerator()
        {
            ...
            Assert.AreEqual(
                "MonoTests.System.XmlSerialization.SoapReflectionImporterTests.SimpleClassEnumerablePrivateGetEnumerator",
                tm.TypeFullName,
                "#4"
            );
        ...
        public void TypeMapping_ICollection_SimpleClass()
        {
            ...
            Assert.AreEqual(
                "MonoTests.System.XmlSerialization.SoapReflectionImporterTests.SimpleClassCollection",
                tm.TypeFullName,
                "#4"
            );
        ...
        public void TypeMapping_ICollection_Object()
        {
            ...
            Assert.AreEqual(
                "MonoTests.System.XmlSerialization.SoapReflectionImporterTests.ObjectCollection",
                tm.TypeFullName,
                "#4"
            );
        ...
        public void TypeMapping_InvalidDefault()
        {
            SoapAttributes attrs = new SoapAttributes(
                typeof(Field_Encoded).GetMember("Modifiers")[0]
            );
