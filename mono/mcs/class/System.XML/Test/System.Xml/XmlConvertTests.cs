...
namespace MonoTests.System.Xml
{
    ...
    public class XmlConvertTests
    {
        ...
        {
            Assert.AreEqual(result, XmlConvert.EncodeName(source));
        }

        private void AssertNmToken(string result, string source)
        {
            Assert.AreEqual(result, XmlConvert.EncodeNmToken(source));
        }
        ...
        public void ToDateTime()
        {
            ...
            Assert.AreEqual(
                632001798000000000L,
                XmlConvert.ToDateTime("2003-09-26T13:30:00").Ticks
            );
            Assert.AreEqual(
                632001798000000000L,
                XmlConvert.ToDateTime("2003-09-26T13:30:00.0").Ticks
            );
            Assert.AreEqual(
                632001798000000000L,
                XmlConvert.ToDateTime("2003-09-26T13:30:00.00").Ticks
            );
            Assert.AreEqual(
                632001798000000000L,
                XmlConvert.ToDateTime("2003-09-26T13:30:00.000").Ticks
            );
            Assert.AreEqual(
                632001798000000000L,
                XmlConvert.ToDateTime("2003-09-26T13:30:00.0000").Ticks
            );
            Assert.AreEqual(
                632001798000000000L,
                XmlConvert.ToDateTime("2003-09-26T13:30:00.00000").Ticks
            );
            Assert.AreEqual(
                632001798000000000L,
                XmlConvert.ToDateTime("2003-09-26T13:30:00.000000").Ticks
            );
            Assert.AreEqual(
                632001798000000000L,
                XmlConvert.ToDateTime("2003-09-26T13:30:00.0000000").Ticks
            );
/*
...
Assert.AreEqual (632001150000000000L, XmlConvert.ToDateTime
("2003-09-26T13:30:00.000+13:00").Ticks);
Assert.AreEqual (632001150000000000L, XmlConvert.ToDateTime
("2003-09-26T13:30:00.0000+13:00").Ticks);
Assert.AreEqual (632001150000000000L, XmlConvert.ToDateTime
("2003-09-26T13:30:00.00000+13:00").Ticks);
Assert.AreEqual (632001150000000000L, XmlConvert.ToDateTime
("2003-09-26T13:30:00.000000+13:00").Ticks);
Assert.AreEqual (632001150000000000L, XmlConvert.ToDateTime
("2003-09-26T13:30:00.0000000+13:00").Ticks);
...
*/
            ...
            //Assert.AreEqual (t1.Ticks, XmlConvert.ToDateTime ("12:00:00.f+13:00").Ticks);//doesn't work on
            // .NET
            //Assert.AreEqual (t1.Ticks, XmlConvert.ToDateTime ("12:00:00.ff+13:00").Ticks);//doesn't work on
            // .NET
            //Assert.AreEqual (t1.Ticks, XmlConvert.ToDateTime ("12:00:00.fff+13:00").Ticks);//doesn't work on
            // .NET
            //Assert.AreEqual (t1.Ticks, XmlConvert.ToDateTime ("12:00:00.ffff+13:00").Ticks);//doesn't work on
            // .NET
            //Assert.AreEqual (t1.Ticks, XmlConvert.ToDateTime ("12:00:00.fffff+13:00").Ticks);//doesn't work on
            // .NET
            //Assert.AreEqual (t1.Ticks, XmlConvert.ToDateTime ("12:00:00.ffffff+13:00").Ticks);//doesn't work
            // on .NET
            //Assert.AreEqual (t1.Ticks, XmlConvert.ToDateTime ("12:00:00.fffffff+13:00").Ticks);//doesn't work
            // on .NET
            ...
            //Assert.AreEqual (t1.Ticks, XmlConvert.ToDateTime ("12:00:00.ffffffZ").Ticks);//doesn't work on
            // .NET
            //Assert.AreEqual (t1.Ticks, XmlConvert.ToDateTime ("12:00:00.fffffffZ").Ticks);//doesn't work on
            // .NET
            //date
            ...
            //			Assert.AreEqual (632001312000000000L, XmlConvert.ToDateTime ("--09-26").Ticks);//shouldn't have
            // a hardcoded value
            //			Assert.AreEqual (632000664000000000L, XmlConvert.ToDateTime
            // ("--09-26+13:00").Ticks);//shouldn't have a hardcoded value
            //			Assert.AreEqual (632001132000000000L, XmlConvert.ToDateTime ("--09-26Z").Ticks);//shouldn't
            // have a hardcoded value
            //gDay
            // Don't try locale-dependent test
            //			Assert.AreEqual (631791360000000000L, XmlConvert.ToDateTime ("---26").Ticks);//shouldn't have a
            // hardcoded value
            //			Assert.AreEqual (631790676000000000L, XmlConvert.ToDateTime ("---26+13:00").Ticks);//shouldn't
            // have a hardcoded value
            //			Assert.AreEqual (631791144000000000L, XmlConvert.ToDateTime ("---26Z").Ticks);//shouldn't have
            // a hardcoded value
            try
            {
        ...
        public void ToDateTimeWithSerializationMode()
        {
            ...
            foreach (
                XmlDateTimeSerializationMode dateTimeSerializationMode in Enum.GetValues(
            ...
            )
            {
                //dateTime local
                Assert.AreEqual(
                    new DateTime(2003, 09, 26, 13, 30, 44, 000).Ticks,
                ...
                Assert.AreEqual(
                    new DateTime(2003, 09, 26, 13, 30, 44, 000).Ticks,
                    XmlConvert
                        .ToDateTime("2003-09-26T13:30:44.000", dateTimeSerializationMode)
                        .Ticks
                );
                Assert.AreEqual(
                    new DateTime(2003, 09, 26, 13, 30, 44, 000).Ticks,
                    XmlConvert
                        .ToDateTime("2003-09-26T13:30:44.0000", dateTimeSerializationMode)
                        .Ticks
                );
                Assert.AreEqual(
                    new DateTime(2003, 09, 26, 13, 30, 44, 000).Ticks,
                    XmlConvert
                        .ToDateTime("2003-09-26T13:30:44.00000", dateTimeSerializationMode)
                        .Ticks
                );
                Assert.AreEqual(
                    new DateTime(2003, 09, 26, 13, 30, 44, 000).Ticks,
                    XmlConvert
                        .ToDateTime("2003-09-26T13:30:44.000000", dateTimeSerializationMode)
                        .Ticks
                );
                Assert.AreEqual(
                    new DateTime(2003, 09, 26, 13, 30, 44, 000).Ticks,
                    XmlConvert
                        .ToDateTime("2003-09-26T13:30:44.0000000", dateTimeSerializationMode)
                        .Ticks
                );
                Assert.AreEqual(
                    new DateTime(2003, 09, 26, 13, 30, 44, 123).Ticks,
                    XmlConvert
                        .ToDateTime("2003-09-26T13:30:44.123", dateTimeSerializationMode)
                        .Ticks
                );
                ...
                {
                    Assert.AreEqual(
                        new DateTime(2003, 09, 26, 13, 30, 44, 000, DateTimeKind.Utc)
                            .ToLocalTime()
                            .Ticks,
                        XmlConvert
                            .ToDateTime("2003-09-26T13:30:44Z", dateTimeSerializationMode)
                            .Ticks
                    );
                    Assert.AreEqual(
                        new DateTime(2003, 09, 26, 13, 30, 44, 000, DateTimeKind.Utc)
                            ...
                            .Ticks,
                        XmlConvert
                            .ToDateTime("2003-09-26T13:30:44.0Z", dateTimeSerializationMode)
                            .Ticks
                    );
                    Assert.AreEqual(
                        new DateTime(2003, 09, 26, 13, 30, 44, 000, DateTimeKind.Utc)
                            ...
                            .Ticks,
                        XmlConvert
                            .ToDateTime("2003-09-26T13:30:44.00Z", dateTimeSerializationMode)
                            .Ticks
                    );
                    Assert.AreEqual(
                        new DateTime(2003, 09, 26, 13, 30, 44, 000, DateTimeKind.Utc)
                            ...
                            .Ticks,
                        XmlConvert
                            .ToDateTime("2003-09-26T13:30:44.000Z", dateTimeSerializationMode)
                            .Ticks
                    );
                    Assert.AreEqual(
                        new DateTime(2003, 09, 26, 13, 30, 44, 000, DateTimeKind.Utc)
                            ...
                            .Ticks,
                        XmlConvert
                            .ToDateTime("2003-09-26T13:30:44.0000Z", dateTimeSerializationMode)
                            .Ticks
                    );
                    Assert.AreEqual(
                        new DateTime(2003, 09, 26, 13, 30, 44, 000, DateTimeKind.Utc)
                            ...
                            .Ticks,
                        XmlConvert
                            .ToDateTime("2003-09-26T13:30:44.00000Z", dateTimeSerializationMode)
                            .Ticks
                    );
                    Assert.AreEqual(
                        new DateTime(2003, 09, 26, 13, 30, 44, 000, DateTimeKind.Utc)
                            ...
                            .Ticks,
                        XmlConvert
                            .ToDateTime("2003-09-26T13:30:44.000000Z", dateTimeSerializationMode)
                            .Ticks
                    );
                    Assert.AreEqual(
                        new DateTime(2003, 09, 26, 13, 30, 44, 000, DateTimeKind.Utc)
                            ...
                            .Ticks,
                        XmlConvert
                            .ToDateTime("2003-09-26T13:30:44.0000000Z", dateTimeSerializationMode)
                            .Ticks
                    );
                    Assert.AreEqual(
                        new DateTime(2003, 09, 26, 13, 30, 44, 123, DateTimeKind.Utc)
                            .ToLocalTime()
                            .Ticks,
                        XmlConvert
                            .ToDateTime("2003-09-26T13:30:44.123Z", dateTimeSerializationMode)
                            .Ticks
                    );
                }
                else
                {
                    Assert.AreEqual(
                        new DateTime(2003, 09, 26, 13, 30, 44, 000, DateTimeKind.Local).Ticks,
                        XmlConvert
                            .ToDateTime("2003-09-26T13:30:44Z", dateTimeSerializationMode)
                            .Ticks
                    );
                    ...
                    Assert.AreEqual(
                        new DateTime(2003, 09, 26, 13, 30, 44, 123, DateTimeKind.Local).Ticks,
                        XmlConvert
                            .ToDateTime("2003-09-26T13:30:44.123Z", dateTimeSerializationMode)
                            .Ticks
                    );
                ...
                {
                    Assert.AreEqual(
                        new DateTimeOffset(2003, 09, 26, 13, 30, 44, 000, new TimeSpan(13, 0, 0))
                            .ToUniversalTime()
                            .Ticks,
                        XmlConvert
                            .ToDateTime("2003-09-26T13:30:44+13:00", dateTimeSerializationMode)
                            .Ticks
                    );
                    Assert.AreEqual(
                        new DateTimeOffset(2003, 09, 26, 13, 30, 44, 000, new TimeSpan(13, 0, 0))
                            ...
                            .Ticks,
                        XmlConvert
                            .ToDateTime("2003-09-26T13:30:44.0+13:00", dateTimeSerializationMode)
                            .Ticks
                    );
                    Assert.AreEqual(
                        new DateTimeOffset(2003, 09, 26, 13, 30, 44, 000, new TimeSpan(13, 0, 0))
                            ...
                            .Ticks,
                        XmlConvert
                            .ToDateTime("2003-09-26T13:30:44.00+13:00", dateTimeSerializationMode)
                            .Ticks
                    );
                    Assert.AreEqual(
                        new DateTimeOffset(2003, 09, 26, 13, 30, 44, 000, new TimeSpan(13, 0, 0))
                            ...
                            .Ticks,
                        XmlConvert
                            .ToDateTime("2003-09-26T13:30:44.000+13:00", dateTimeSerializationMode)
                            .Ticks
                    );
                    Assert.AreEqual(
                        new DateTimeOffset(2003, 09, 26, 13, 30, 44, 000, new TimeSpan(13, 0, 0))
                            ...
                            .Ticks,
                        XmlConvert
                            .ToDateTime("2003-09-26T13:30:44.0000+13:00", dateTimeSerializationMode)
                            .Ticks
                    );
                    Assert.AreEqual(
                        new DateTimeOffset(2003, 09, 26, 13, 30, 44, 000, new TimeSpan(13, 0, 0))
                        ...
                        XmlConvert
                            .ToDateTime(
                                "2003-09-26T13:30:44.00000+13:00",
                    ...
                    Assert.AreEqual(
                        ...
                        XmlConvert
                            .ToDateTime(
                                "2003-09-26T13:30:44.000000+13:00",
                                dateTimeSerializationMode
                            )
                            .Ticks
                    );
                    Assert.AreEqual(
                        ...
                        XmlConvert
                            .ToDateTime(
                                "2003-09-26T13:30:44.0000000+13:00",
                                dateTimeSerializationMode
                            )
                            .Ticks
                    );
                    Assert.AreEqual(
                        new DateTimeOffset(2003, 09, 26, 13, 30, 44, 123, new TimeSpan(13, 0, 0))
                            .ToUniversalTime()
                            .Ticks,
                        XmlConvert
                            .ToDateTime("2003-09-26T13:30:44.123+13:00", dateTimeSerializationMode)
                            .Ticks
                    );
                }
                else
                ...
                if (dateTimeSerializationMode == XmlDateTimeSerializationMode.Utc)
                {
                    ...
                    Assert.AreEqual(
                        new DateTimeOffset(
                            ...
                            .Ticks,
                        XmlConvert
                            .ToDateTime("13:30:44.0000+13:00", dateTimeSerializationMode)
                            .Ticks
                    );
                    Assert.AreEqual(
                        new DateTimeOffset(
                            ...
                            .Ticks,
                        XmlConvert
                            .ToDateTime("13:30:44.00000+13:00", dateTimeSerializationMode)
                            .Ticks
                    );
                    Assert.AreEqual(
                        new DateTimeOffset(
                            ...
                            .Ticks,
                        XmlConvert
                            .ToDateTime("13:30:44.000000+13:00", dateTimeSerializationMode)
                            .Ticks
                    );
                    Assert.AreEqual(
                        new DateTimeOffset(
                            ...
                            .Ticks,
                        XmlConvert
                            .ToDateTime("13:30:44.0000000+13:00", dateTimeSerializationMode)
                            .Ticks
                    );
                    Assert.AreEqual(
                        new DateTimeOffset(
                ...
                //date
                Assert.AreEqual(
                    new DateTime(2003, 09, 26, 00, 00, 00, 000).Ticks,
                    XmlConvert.ToDateTime("2003-09-26", dateTimeSerializationMode).Ticks
                );
                if (dateTimeSerializationMode == XmlDateTimeSerializationMode.Local)
                    Assert.AreEqual(
                        new DateTime(2003, 09, 26, 00, 00, 00, 000, DateTimeKind.Utc)
                            .ToLocalTime()
                            .Ticks,
                    ...
                    Assert.AreEqual(
                        new DateTime(2003, 09, 26, 00, 00, 00, 000, DateTimeKind.Local).Ticks,
                        XmlConvert.ToDateTime("2003-09-26Z", dateTimeSerializationMode).Ticks
                    );
                if (dateTimeSerializationMode == XmlDateTimeSerializationMode.Utc)
                    Assert.AreEqual(
                        new DateTimeOffset(2003, 09, 26, 00, 00, 00, 000, new TimeSpan(13, 0, 0))
                            .ToUniversalTime()
                            .Ticks,
                ...
                //gYearMonth
                Assert.AreEqual(
                    new DateTime(2003, 09, 01, 00, 00, 00, 000).Ticks,
                    XmlConvert.ToDateTime("2003-09", dateTimeSerializationMode).Ticks
                );
                if (dateTimeSerializationMode == XmlDateTimeSerializationMode.Local)
                    Assert.AreEqual(
                        new DateTime(2003, 09, 01, 00, 00, 00, 000, DateTimeKind.Utc)
                            .ToLocalTime()
                            .Ticks,
                    ...
                    Assert.AreEqual(
                        new DateTime(2003, 09, 01, 00, 00, 00, 000, DateTimeKind.Local).Ticks,
                        XmlConvert.ToDateTime("2003-09Z", dateTimeSerializationMode).Ticks
                    );
                if (dateTimeSerializationMode == XmlDateTimeSerializationMode.Utc)
                    Assert.AreEqual(
                        new DateTimeOffset(2003, 09, 01, 00, 00, 00, 000, new TimeSpan(13, 0, 0))
                            .ToUniversalTime()
                            .Ticks,
                ...
                //gYear
                Assert.AreEqual(
                    new DateTime(2003, 01, 01, 00, 00, 00, 000).Ticks,
                    XmlConvert.ToDateTime("2003", dateTimeSerializationMode).Ticks
                );
                if (dateTimeSerializationMode == XmlDateTimeSerializationMode.Local)
                    Assert.AreEqual(
                        new DateTime(2003, 01, 01, 00, 00, 00, 000, DateTimeKind.Utc)
                            .ToLocalTime()
                            .Ticks,
                    ...
                    Assert.AreEqual(
                        new DateTime(2003, 01, 01, 00, 00, 00, 000, DateTimeKind.Local).Ticks,
                        XmlConvert.ToDateTime("2003Z", dateTimeSerializationMode).Ticks
                    );
                if (dateTimeSerializationMode == XmlDateTimeSerializationMode.Utc)
                    Assert.AreEqual(
                        new DateTimeOffset(2003, 01, 01, 00, 00, 00, 000, new TimeSpan(13, 0, 0))
                            .ToUniversalTime()
                            .Ticks,
                ...
                //gDay
                Assert.AreEqual(
                    new DateTime(DateTime.Now.Year, 01, 26, 00, 00, 00, 000).Ticks,
                    XmlConvert.ToDateTime("---26", dateTimeSerializationMode).Ticks
                );
                if (dateTimeSerializationMode == XmlDateTimeSerializationMode.Local)
                    Assert.AreEqual(
                        new DateTime(DateTime.Now.Year, 01, 26, 00, 00, 00, 000, DateTimeKind.Utc)
                            .ToLocalTime()
                            .Ticks,
            ...
            Assert.AreEqual(
                DateTimeKind.Local,
                XmlConvert
                    .ToDateTime("2003-09-26T13:30:44", XmlDateTimeSerializationMode.Local)
                    .Kind
            );
            Assert.AreEqual(
                DateTimeKind.Local,
                XmlConvert
                    .ToDateTime("2003-09-26T13:30:44Z", XmlDateTimeSerializationMode.Local)
                    .Kind
            );
            Assert.AreEqual(
                DateTimeKind.Local,
                XmlConvert
                    .ToDateTime("2003-09-26T13:30:44+13:00", XmlDateTimeSerializationMode.Local)
                    .Kind
            );
            Assert.AreEqual(
                DateTimeKind.Utc,
                XmlConvert.ToDateTime("2003-09-26T13:30:44", XmlDateTimeSerializationMode.Utc).Kind
            );
            Assert.AreEqual(
                DateTimeKind.Utc,
                XmlConvert.ToDateTime("2003-09-26T13:30:44Z", XmlDateTimeSerializationMode.Utc).Kind
            );
            Assert.AreEqual(
                DateTimeKind.Utc,
                XmlConvert
                    .ToDateTime("2003-09-26T13:30:44+13:00", XmlDateTimeSerializationMode.Utc)
                    .Kind
            );
            Assert.AreEqual(
                DateTimeKind.Unspecified,
                XmlConvert
                    .ToDateTime("2003-09-26T13:30:44", XmlDateTimeSerializationMode.Unspecified)
                    .Kind
            );
            Assert.AreEqual(
                DateTimeKind.Unspecified,
                XmlConvert
                    .ToDateTime("2003-09-26T13:30:44Z", XmlDateTimeSerializationMode.Unspecified)
                    .Kind
            );
            Assert.AreEqual(
                DateTimeKind.Unspecified,
            ...
            Assert.AreEqual(
                DateTimeKind.Unspecified,
                XmlConvert
                    .ToDateTime("2003-09-26T13:30:44", XmlDateTimeSerializationMode.RoundtripKind)
                    .Kind
            );
            Assert.AreEqual(
                DateTimeKind.Utc,
                XmlConvert
                    .ToDateTime("2003-09-26T13:30:44Z", XmlDateTimeSerializationMode.RoundtripKind)
                    .Kind
            );
            Assert.AreEqual(
                DateTimeKind.Local,
        ...
        public void ToGuid()
        {
            Assert.AreEqual(
                ...
                XmlConvert.ToGuid("ca761232-ed42-11ce-bacd-00aa0057b223")
            );
        }
        ...
        public void ToInt64()
        {
            ...
            Assert.AreEqual(
                long.MaxValue,
                XmlConvert.ToInt64("9223372036854775807"),
                "9223372036854775807"
            );
            Assert.AreEqual(
                long.MinValue,
        ...
        public void ToStringTest() //not done
        {
            ...
            string dateString = XmlConvert.ToString(new DateTime(2003, 5, 5));
        ...
        {
            // bug #77252
            TimeSpan t1 = TimeSpan.FromTicks(TimeSpan.TicksPerSecond + 1);
        ...
        public void ToUInt64()
        {
            ...
            Assert.AreEqual(
                ulong.MaxValue,
                XmlConvert.ToUInt64("18446744073709551615"),
        ...
        public void XmlDateTimeSerializationModeAndMaxValue()
        {
            Assert.AreEqual(
                ...
                XmlConvert
                    .ToString(DateTime.MaxValue, XmlDateTimeSerializationMode.Unspecified)
                    .Substring(0, 27),
                "#1"
            );
            Assert.AreEqual(
                "9999-12-31T23:59:59.9999999Z",
                XmlConvert.ToString(DateTime.MaxValue, XmlDateTimeSerializationMode.Utc),
                "#2"
            );
            Assert.AreEqual(
                "9999-12-31T23:59:59.9999999",
                XmlConvert.ToString(DateTime.MaxValue, XmlDateTimeSerializationMode.RoundtripKind),
                "#3"
            );
            Assert.AreEqual(
                "9999-12-31T23:59:59.9999999",
                XmlConvert
                    .ToString(DateTime.MaxValue, XmlDateTimeSerializationMode.Local)
                    .Substring(0, 27),
                "#4"
            );
            ...
            Assert.AreEqual(
                "9999-12-31T23:59:59.9999999Z",
                XmlConvert.ToString(DateTime.MaxValue, "yyyy-MM-ddTHH:mm:ss.FFFFFFFZ"),
                "#5"
            );
            Assert.AreEqual(
                "9999-12-31T23:59:59.9999999",
                XmlConvert
                    .ToString(DateTime.MaxValue, "yyyy-MM-ddTHH:mm:ss.FFFFFFFzzz")
                    .Substring(0, 27),
                "#6"
            );
        }
        ...
        public void XmlDateTimeSerializationModeRountripKind()
        {
            ...
            Assert.AreEqual(
                DateTimeKind.Utc,
                XmlConvert.ToDateTime(s, XmlDateTimeSerializationMode.RoundtripKind).Kind,
                "#2-2"
            );
        }
        ...
        public void XmlDateTimeSerializationModeUnspecified()
        {
            ...
            DateTime dt1 = XmlConvert.ToDateTime(
                "0001-02-03T10:20:30.0000-01:00",
                XmlDateTimeSerializationMode.Unspecified
            );
            DateTime dt2 = XmlConvert.ToDateTime(
                "0001-02-03T10:20:30.0000",
                XmlDateTimeSerializationMode.Unspecified
            );
            Assert.AreEqual(false, dt1 == dt2, "#2");
            XmlConvert.ToDateTime(
                "2006-05-30T09:48:32.0Z",
                XmlDateTimeSerializationMode.Unspecified
            );
            string format = "yyyy-MM-ddTHH:mm:ss.FFFFFFFK";
            XmlConvert.ToDateTime(
                XmlConvert.ToString(DateTime.UtcNow, format),
                XmlDateTimeSerializationMode.Unspecified
            );
        }
        ...
        public void XmlDateTimeSerializationModeUtc()
        {
            ...
            DateTime dt1 = XmlConvert.ToDateTime(
                "0001-02-03T10:20:30.0000+02:00",
        ...
        {
            Assert.AreEqual(
                new DateTimeOffset(2009, 11, 05, 20, 16, 22, TimeSpan.FromHours(9)),
                XmlConvert.ToDateTimeOffset("2009-11-05T20:16:22+09:00"),
                "#1"
            );
        }
        ...
        {
            // bug #661787
            var date = XmlConvert.ToDateTime(
                "2010-12-29T22:01:15.1619814",
                XmlDateTimeSerializationMode.Utc
            );
        ...
        public void ToDateTimeZ()
        {
            ...
            foreach (
                XmlDateTimeSerializationMode mode in Enum.GetValues(
                    typeof(XmlDateTimeSerializationMode)
                )
            )
            {
