...
namespace MonoTests.System.Xml
{
    ...
    public class XmlElementTests
    {
        ...
        {
            Assert.AreEqual(
                prefix != String.Empty ? prefix + ":" + localName : localName,
                element.Name
            );
        ...
        public void CreateElement2()
        {
            ...
            AssertElement(element, String.Empty, "qualifiedName", "namespaceURI", 0);
        }
        ...
        {
            string xml =
                @"<library><book><title>XML Fun</title><author>John Doe</author>
            ...
            Assert.AreEqual(
                4,
                bookList.Count,
                "GetElementsByTagName (string) returned incorrect count."
            );
        }
        ...
        public void GetElementsByTagNameUsingNameSpace()
        {
            ...
            Assert.AreEqual(
                1,
                bookList.Count,
                "GetElementsByTagName (string, uri) returned incorrect count."
            );
        }
        ...
        public void RemoveAllAttributes()
        {
            ...
            Assert.AreEqual(
                ...
                "attributes not properly removed."
            );
        }

        [Test]
        [Ignore(
            "This test is very implementation dependent and thus .NET 2.0 does not pass. That's why I said http://primates.ximian.com/~atsushi/blog/archives/000416.html and http://svn.myrealbox.com/viewcvs/trunk/mono/web/xml-classes?rev=23598"
        )]
        public void RemoveDoesNotRemoveDefaultAttributes()
        {
            string dtd =
                "<!DOCTYPE root [<!ELEMENT root EMPTY><!ATTLIST root   foo CDATA 'def'   bar CDATA #IMPLIED>]>";
        ...
        public void SetAttributeNode()
        {
            ...
            Assert.AreEqual(
                true,
                xmlAttribute.Name.Equals("attr1"),
                "attribute name not properly created."
            );
            Assert.AreEqual(
                true,
                xmlAttribute.NamespaceURI.Equals("namespace1"),
        ...
        public void InnerTextAndEvent()
        {
            ...
            doc.NodeInserted += new XmlNodeChangedEventHandler(OnNodeInserted);
            doc.NodeRemoved += new XmlNodeChangedEventHandler(OnNodeRemoved);
            ...
            Assert.AreEqual(
                "no events fired.",
                doc.DocumentElement.FirstChild.InnerText,
                "SetInnerTextToSingleText"
            );
            Inserted = false;
            Removed = false;
        ...
        public void InnerXmlSetter()
        {
            ...
            doc.LoadXml(
                "<root xmlns='NS0' xmlns:ns1='NS1'><foo/><ns1:bar/><ns2:bar xmlns:ns2='NS2' /></root>"
            );
...
,int&gt;
        ...
        public void IsEmpty()
        {
            ...
            Assert.AreEqual(
                true,
                ((XmlElement)document.DocumentElement.FirstChild).IsEmpty,
                "Empty"
            );
            Assert.AreEqual(
                false,
                ((XmlElement)document.DocumentElement.LastChild).IsEmpty,
                "Empty"
            );
        }
        ...
        public void WriteToWithDefaultNamespace()
        {
            XmlDocument doc = new XmlDocument();
            doc.LoadXml(
                "<RetrievalElement URI=\"\" xmlns=\"http://www.w3.org/2000/09/xmldsig#\" />"
            );
        ...
        public void WriteToWithDifferentNamespaceAttributes()
        {
            XmlDocument doc = new XmlDocument();
            doc.LoadXml(
                "<root xmlns:foo='urn:dummy' xmlns:html='http://www.w3.org/1999/xhtml' html:style='font-size: 1em'></root>"
            );
        ...
        public void WriteToDefaultAttribute()
        {
            ...
            string dtd =
                "<!DOCTYPE root[<!ATTLIST root hoge CDATA 'hoge-def'><!ENTITY foo 'ent-foo'>]>";
        ...
        private void AssertClearPrefix(string newPrefix)
        {
            ...
            Assert.AreEqual(
                "<x:root xmlns:x=\"http://somenamespace.com\" />",
                doc.OuterXml,
                "#Clear1"
            );
            Assert.AreEqual(
            ...
            Assert.AreEqual(
                "<root xmlns:x=\"http://somenamespace.com\" xmlns=\"http://somenamespace.com\" />",
                doc.OuterXml,
                "#Clear4"
            );
            Assert.AreEqual(
