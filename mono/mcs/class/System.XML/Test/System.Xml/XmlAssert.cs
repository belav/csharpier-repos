...
namespace MonoTests.System.Xml
{
    public class XmlAssert
    {
        ...
        public static void AssertStartDocument(XmlReader xmlReader, string label)
        {
        ...
        )
        {
            ...
            Assert.AreEqual(value, xmlReader.GetAttribute(name), label + ".GetAttribute(name)");
            ...
            if (namespaceURI != String.Empty)
            {
                ...
                Assert.AreEqual(
                    value,
                    xmlReader.GetAttribute(localName, namespaceURI),
                    label + ".GetAttribute(localName,namespaceURI)"
                );
            }
        }
