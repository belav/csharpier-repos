...
namespace MonoTests.System.Xml
{
    ...
    public class XmlTextWriterTests
    {
        ...
        public void WriteAttributeString_XmlPrefix_Valid()
        {
            ...
            xtw.WriteEndElement();
            Assert.AreEqual(
                "<person xml:something='default' xml:else='whatever' />",
                StringWriterText,
                "#3"
            );
        }
        ...
        [Test]
        [Ignore(
            "Due to the (silly) dependency on bug #77088, this test will not be fixed. The test could be rewritten but it depends on the original test author."
        )]
        public void AutoCreatePrefixes()
        {
            ...
            Assert.AreEqual(
                "<root d1p1:abc='http://abc.def' d1p1:def='http://def.ghi' d1p2:ghi='http://ghi.jkl' xmlns:d1p2='http://othernamespace.com' xmlns:d1p1='http://somenamespace.com' />",
                StringWriterText,
                "#1"
            );
        }
        ...
        public void WriteElementString_EmptyLocalName()
        {
            ...
            Assert.AreEqual(
                "< xmlns='http://somenamespace.com'>whatever</>",
                StringWriterText,
                "#3"
            );
        ...
        {
            Assert.IsTrue(
                Object.ReferenceEquals(null, this.xtw.BaseStream),
                "BaseStream property returned wrong value."
            );
            ...
            Assert.IsTrue(
                Object.ReferenceEquals(ms, xtw.BaseStream),
                "BaseStream property returned wrong value."
            );
        ...
        public void ElementWriteElementString()
        {
            ...
            Assert.AreEqual(
                "<foo>bar</foo><baz /><quux /><>quuux</><>quuuux</>",
                StringWriterText,
                "#5"
            );
        }
        ...
        public void FormattingTest()
        {
            ...
            Assert.AreEqual(
                String.Format(
                    "<?xml version='1.0' encoding='utf-16'?>{0}<foo>{0}  <bar />{0}</foo>",
                    Environment.NewLine
                ),
                StringWriterText
            );
        ...
        public void FormattingInvalidXmlForFun()
        {
            ...
            Assert.AreEqual(
                String.Format(
                    "<?xml version='1.0' encoding='utf-16'?>{0}<foo>{0}xx<bar>{0}xxxx<baz />{0}xx</bar>{0}</foo>",
                    Environment.NewLine
                ),
                StringWriterText
            );
        ...
        public void FormattingFromRemarks()
        {
            ...
            Assert.AreEqual(
                String.Format(
                    "<ol>{0}  <li>The big <b>E</b><i>lephant</i> walks slowly.</li>{0}</ol>",
                    Environment.NewLine
                ),
                StringWriterText
            );
        ...
        public void QuoteCharDoubleQuote()
        {
            ...
            Assert.AreEqual(
                "<?xml version=\"1.0\" encoding=\"utf-16\" standalone=\"yes\"?><foo xmlns=\"http://netsack.com\">bar</foo>",
                StringWriterText
            );
        }
        ...
        public void XmlLang()
        {
            ...
            Assert.AreEqual("langfoo", xtw.XmlLang);
            Assert.AreEqual(
                "<foo xml:lang='langfoo' boo='yah'><bar>baz</bar>baz",
                StringWriterText
            );
        ...
        public void XmlSpaceTest()
        {
            ...
            Assert.AreEqual(
                "<foo><bar xml:space='preserve'><baz xml:space='preserve'",
                StringWriterText,
                "#5"
            );
        ...
        public void Indent()
        {
            ...
            Assert.AreEqual(
                @"<root>_  <test>test<foo></foo>string</test>_  <test>string</test>_</root>",
                sw.ToString()
            );
        }
        ...
        public void Indent2()
        {
            ...
            Assert.AreEqual(
                string.Format(
                    ...
                    @"<?xml version=""1.0""?>{0}" + "<!--sample XML fragment-->",
                    Environment.NewLine
                ),
                sw.ToString()
            );
        ...
        public void Indent3()
        {
            ...
            doc.LoadXml(
                "<root><element></element><!-- comment indented --><element>sample <!-- comment non-indented --></element></root>"
            );
            s = GetIndentedOutput(doc.DocumentElement);
            Assert.AreEqual(
                s,
                String.Format(
                    "<root>{0}  <element>{0}  </element>{0}  <!-- comment indented -->{0}  <element>sample <!-- comment non-indented --></element>{0}</root>",
                    "\n"
                ),
                "#1"
            );
            ...
            Assert.AreEqual(
                s,
                String.Format(
                    "<root> {0}<mid> {0}<mid>   {0}<child attr='value'>sample <nested attr='value' /> string</child>     <child2 attr='value'>sample string</child2>  <empty attr='value' />{0}<a>test</a> {0}</mid> <returnValue>  <returnType>System.String</returnType>  </returnValue>  </mid>   </root>",
                    "\n"
                ),
                "#2"
            );
            ...
            doc.LoadXml(
                "<!-- after /MemberType and after /returnValue --><root><MemberType>blah</MemberType>\n  <returnValue><returnType>System.String</returnType></returnValue>\n  <Docs><summary>text</summary><value>text<see cref='ttt' /></value><remarks/></Docs></root>"
            );
            s = GetIndentedOutput(doc.DocumentElement);
            Assert.AreEqual(
                s,
                String.Format(
                    "<root>{0}  <MemberType>blah</MemberType>{0}  <returnValue><returnType>System.String</returnType></returnValue>{0}  <Docs><summary>text</summary><value>text<see cref='ttt' /></value><remarks /></Docs></root>",
                    "\n"
                ),
                "#3"
            );
        ...
        public void WriteDocType()
        {
            ...
            xtw.WriteDocType("test", "-//W3C//DTD XHTML 1.0 Strict//EN", string.Empty, "sub");
            Assert.AreEqual(
                "<!DOCTYPE test PUBLIC \"-//W3C//DTD XHTML 1.0 Strict//EN\"" + " \"\"[sub]>",
                sw.ToString(),
                "#03"
            );
            ...
            Assert.AreEqual("<!DOCTYPE test PUBLIC \"\" \"\"[sub]>", sw.ToString(), "#05");
            ...
            Assert.AreEqual("<!DOCTYPE test PUBLIC \"\" \"\"[]>", sw.ToString(), "#08");
            ...
            xtw.WriteDocType("test", "-//W3C//DTD XHTML 1.0 Strict//EN", (string)null, "sub");
            Assert.AreEqual(
                "<!DOCTYPE test PUBLIC \"-//W3C//DTD XHTML 1.0 Strict//EN\"" + " \"\"[sub]>",
                sw.ToString(),
                "#10"
            ...
            Assert.AreEqual("<!DOCTYPE test[sub]>", sw.ToString(), "#12");
            ...
            Assert.AreEqual("<!DOCTYPE test>", sw.ToString(), "#15");
        }
        ...
        public void InvalidCharIsWrittenAsSillyReferences()
        {
            ...
            NUnit.Framework.Assert.AreEqual("<a>&#x0;</a>", StringWriterText);
        }
        ...
        public void WriteDocTypeIndent()
        {
            string expected = String.Format(
                @"<?xml version='1.0'?>{0}<!DOCTYPE root PUBLIC '' 'urn:foo'[]>{0}<root />",
                Environment.NewLine
            );
            xtw.Formatting = Formatting.Indented;
            xtw.WriteProcessingInstruction("xml", "version='1.0'");
        ...
        public void WriteRawEmptyCloseStartTag()
        {
            ...
            Assert.AreEqual(
                "<stream:stream version='1.0' to='me@test.com' from='server' xmlns='jabber:client' xmlns:stream='http://etherx.jabber.org/streams'>",
                StringWriterText
            );
        }
        ...
        public void WriteCommentPIAndIndent()
        {
            ...
            Assert.AreEqual(
                String.Format(
                    @"<foo>{0}  <!--test-->{0}  <?PI ?>{0}  <child />{0}  <!--test-->STRING</foo>",
                    Environment.NewLine
                ),
                sw.ToString()
            );
        ...
        public void WriteElementPrefixedNullNamespace()
        {
            ...
            xw.WriteEndElement();
            Assert.AreEqual(
                "<root xmlns:abc=\"uri:abcnamespace\"><abc:def /></root>",
                sw.ToString()
            );
        }
