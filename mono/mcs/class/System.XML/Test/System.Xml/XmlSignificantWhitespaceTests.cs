    ...
    public class XmlSignificantWhitespaceTests
    {
        ...
        public void XmlSignificantWhitespaceName()
        {
            Assert.AreEqual(
                ...
                whitespace.NodeType + " Name property broken"
            );
        }
        ...
        {
            Assert.AreEqual(
                whitespace.LocalName,
                "#significant-whitespace",
                whitespace.NodeType + " LocalName property broken"
            );
        }
        ...
        {
            Assert.AreEqual(
                whitespace.NodeType.ToString(),
                "SignificantWhitespace",
                "XmlSignificantWhitespace NodeType property broken"
            );
        }
        ...
        public void XmlSignificantWhitespaceIsReadOnly()
        {
            Assert.AreEqual(
                ...
                false,
                "XmlSignificantWhitespace IsReadOnly property broken"
            );
        }
