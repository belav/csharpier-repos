...
namespace MonoTests.System.Xml
{
    ...
    public class XmlAttributeCollectionTests
    {
        ...
        public void RemoveAll()
        {
            ...
            xml.Append(
                "<?xml version=\"1.0\" ?><library><book type=\"non-fiction\" price=\"34.95\"> "
            );
        ...
        public void Append()
        {
            ...
            Assert.AreEqual(
                true,
                xmlAttribute3.Name.Equals("attr3"),
                "attribute name not properly created."
            );
            Assert.AreEqual(
                true,
                xmlAttribute3.NamespaceURI.Equals("namespace1"),
                "attribute namespace not properly created."
            );
        }
        ...
        public void CopyTo()
        {
            XmlDocument xmlDoc = new XmlDocument();
            xmlDoc.LoadXml(
                "<root a1='garnet' a2='amethyst' a3='Bloodstone' a4='diamond' a5='emerald' a6='pearl' a7='ruby' a8='sapphire' a9='moonstone' a10='opal' a11='topaz' a12='turquoize' />"
            );
        ...
        public void InsertBeforeAfterPrepend()
        {
            ...
            Assert.AreEqual(
                "mixed modern and traditional;-)",
                el.GetAttributeNode("warning").Value,
                "InsertBeforeAttr"
            );
            Assert.AreEqual(
                el.GetAttributeNode("warning").Value,
                col[0].Value,
                "InsertBeforeAttr.Pos"
            );
        ...
        public void InsertAfterError()
        {
            ...
            attr.Value = "test";
            document.DocumentElement.Attributes.InsertAfter(
                attr,
                document.DocumentElement.FirstChild.Attributes[0]
            );
        }
        ...
        {
            string dtd =
                "<!DOCTYPE root [<!ELEMENT root EMPTY><!ATTLIST root attr CDATA 'default'>]>";
            string xml = dtd + "<root/>";
        ...
        public void AddIdenticalAttrToTheSameNode()
        {
            XmlDocument doc = new XmlDocument();
            doc.LoadXml(
                @"<blah><br><mynode txt='blah/drinks1'/></br><br><mynode txt='hello world'/></br></blah>"
            );
