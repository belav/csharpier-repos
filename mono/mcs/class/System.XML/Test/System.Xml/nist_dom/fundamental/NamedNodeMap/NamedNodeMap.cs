    ...
    public class NamedNodeMapTest
    {
        ...
        */
        ...
        public void core0002M()
        {
            ...
            {
                results.description =
                    "The \"getNamedItem(name)\" method returns a node "
        ...
        public void core0003M()
        {
            ...
            {
                results.description =
                    "The \"getNamedItem(name)\" method returns null if the "
                    + "specified name did not identify any node in the map.";
                //
        ...
        public void core0004M()
        {
            ...
            {
                results.description =
                    "The \"setNamedItem(arg)\" method adds a node "
                ...
                districtAttr = (System.Xml.XmlAttribute)
                    testNode.Attributes.GetNamedItem("district");
        ...
        public void core0005M()
        {
            ...
            {
                results.description =
                    "If the node to be replaced by the \"setNamedItem(arg)\" "
        ...
        public void core0006M()
        {
            ...
            {
                results.description =
                    "If the \"setNamedItem(arg)\" method replaces an "
        ...
        public void core0007M()
        {
            ...
            {
                results.description =
                    "If a node with that name is already present in the collection. The \"setNamedItem(arg)\" method is replacing it by the new one";
                //
        ...
        public void core0009M()
        {
            ...
            {
                results.description =
                    "If the node removed by the \"removeNamedItem(name)\" "
        ...
        public void core0010M()
        {
            ...
            {
                results.description =
                    "The \"removeNamedItem(name)\" method returns the "
        ...
        public void core0011M()
        {
            ...
            {
                results.description =
                    "The \"removeNamedItem(name)\" method returns null "
        ...
        public void core0012M()
        {
            ...
            {
                results.description =
                    "Retrieve the first item in the map via the \"item(index)\" method.";
        ...
        public void core0013M()
        {
            ...
            {
                results.description =
                    "Retrieve the last item in the map via the \"item(index)\" method.";
                //
        ...
        public void core0015M()
        {
            ...
            {
                results.description =
                    "The \"item(index)\" method returns null if the index "
        ...
        public void core0018M()
        {
            ...
            System.Xml.XmlAttribute newAttrNode = util.getOtherDOMDocument()
        ...
        public void core0019M()
        {
            ...
            System.Xml.XmlAttribute newAttrNode = (System.Xml.XmlAttribute)
        ...
        public void core0020M()
        {
            ...
            {
                results.description =
                    "The \"setNamedItem(arg)\" method raises an "
