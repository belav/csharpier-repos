...
namespace nist_dom
{
    ...
    public class util
    {
        ...
        public static string NO_MODIFICATION_ALLOWED_ERR =
            "Attempt to modify a read-only node." + EOL;
        public static string NOT_FOUND1_ERR = "Invalid procedure call or argument";
        public static string NOT_FOUND2_ERR =
            "Insert position Node must be a Child of the Node to " + "insert under." + EOL;
        public static string NOT_FOUND3_ERR =
            "The parameter Node is not a child of this Node." + EOL;
        public static string NOT_SUPPORTED_ERR = " ";
        public static string INUSE_ATTRIBUTE_ERR =
            "The Attribute node cannot be inserted because it is already an attribute of another element."; //"Attributes must be removed before adding them " + "to a different node." + EOL;
        ...
        public const int PROCESSING_INSTRUCTION_NODE = (int)
        ...
        public static void resetData()
        {
            try
            {
                ...
                System.Xml.XmlNode tmpNode = getDOMDocument()
                    .ImportNode(getOriginalDOMDocument().DocumentElement, true);
...
*/
        ...
        private static void getAllNodesRecursively(
            XmlNode argNode,
            System.Collections.ArrayList argArrayList
        )
        {
