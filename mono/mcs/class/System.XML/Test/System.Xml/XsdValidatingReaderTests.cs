...
namespace MonoTests.System.Xml
{
    ...
    public class XsdValidatingReaderTests
    {
        ...
        [Test]
        [Ignore(
            "XML Schema validator should not be available for validating non namespace-aware XmlReader that handled colon as a name character"
        )]
        ...
        public void DuplicateSchemaAssignment()
        {
            ...
            schemas.Add(XmlSchema.Read(new XmlTextReader(xsd, XmlNodeType.Document, null), null));
        ...
        {
            string xml =
                "<xml xmlns='urn:a'> <foo> <a:bar xmlns='urn:b' xmlns:a='urn:a' /> <bug /> </foo> </xml>";
    ...
    <xs:simpleType>
      <xs:restriction base='xs:string'>
        <xs:minLength value='2' />
            ...
            XmlTextReader xir = new XmlTextReader(xml, XmlNodeType.Document, null);
            XmlTextReader xsr = new XmlTextReader(xsd, XmlNodeType.Document, null);
...
";
            ...
            reader.Schemas.Add(null, new XmlTextReader(new StringReader(schema)));
            while (reader.Read())
                ;
        }
        ...
        public void EnumerationFacetOnAttribute()
        {
            ...
            XmlSchema schema = XmlSchema.Read(
                new XmlTextReader(
                    TestResourceHelper.GetFullPathOfResource("Test/XmlFiles/xsd/79650.xsd")
                ),
                null
            );
            XmlValidatingReader xvr = new XmlValidatingReader(xml, XmlNodeType.Document, null);
        ...
        {
            string xml =
                "<project xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance' xsi:noNamespaceSchemaLocation='nosuchschema.xsd'/>";
        ...
        {
            string xml =
                "<test xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance' xsi:noNamespaceSchemaLocation='Test/XmlFiles/xsd/336625.xsd'/>";
            XmlValidatingReader vr = new XmlValidatingReader(
                new XmlTextReader(new StringReader(xml))
            );
            vr.ValidationType = ValidationType.None;
        ...
        public void Bug81360()
        {
            ...
            XmlTextReader treader = new XmlTextReader(
                TestResourceHelper.GetFullPathOfResource(schemaResource)
            );
        ...
        {
            string xsd =
                "<xs:schema xmlns:xs='http://www.w3.org/2001/XMLSchema'><xs:element name='foo'><xs:complexType><xs:attribute name='a' default='x' /></xs:complexType></xs:element></xs:schema>";
            string xml = "<foo/>";
