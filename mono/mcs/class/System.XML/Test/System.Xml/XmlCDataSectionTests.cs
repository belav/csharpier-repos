    ...
    public class XmlCDataSectionTests
    {
        ...
        public void XmlCDataSectionName()
        {
            Assert.AreEqual(
                section.Name,
                "#cdata-section",
                section.NodeType + " Name property broken"
            );
        }
        ...
        public void XmlCDataSectionLocalName()
        {
            Assert.AreEqual(
                section.LocalName,
                "#cdata-section",
                section.NodeType + " LocalName property broken"
            );
        }
        ...
        {
            Assert.AreEqual(
                section.NodeType.ToString(),
                "CDATA",
                "XmlCDataSection NodeType property broken"
            );
        }
        ...
        public void XmlCDataSectionIsReadOnly()
        {
            Assert.AreEqual(
                section.IsReadOnly,
                false,
                "XmlCDataSection IsReadOnly property broken"
            );
        }
