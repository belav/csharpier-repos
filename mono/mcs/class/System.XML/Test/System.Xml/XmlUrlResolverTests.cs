...
namespace MonoTests.System.Xml
{
    ...
    public class XmlUrlResolverTests
    {
        ...
        public void FileUri()
        {
            Uri resolved = resolver.ResolveUri(
                null,
        ...
        {
            Assert.AreEqual(
                resolver.ResolveUri(new Uri("file://usr/local/src"), null).ToString(),
                "file://usr/local/src"
            );
        ...
        {
            Assert.AreEqual(
                resolver.ResolveUri(null, "http://test.xml").ToString(),
                "http://test.xml/"
            );
        }
        ...
        {
            Assert.AreEqual(
                resolver.ResolveUri(new Uri("http://example.com"), null).ToString(),
                "http://example.com/"
            );
        }
