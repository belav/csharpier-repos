...
namespace MonoTests.System.Xml
{
    ...
    public class XmlNodeListTests
    {
        ...
        public void ZeroChildren()
        {
            ...
            documentElement = document.DocumentElement;
            Assert.AreEqual(
                documentElement.GetEnumerator().MoveNext(),
                false,
                "Should be empty node list."
            );
        }
        ...
        public void OneChild()
        {
            ...
            documentElement = document.DocumentElement;
            Assert.AreEqual(
                documentElement.ChildNodes.Count,
                1,
                "Incorrect number of children returned from Count property."
            );
            index = 1;
            foreach (XmlNode childNode in documentElement.ChildNodes)
            {
                Assert.AreEqual(
                    ...
                    childNode.LocalName,
                    "Enumerator didn't return correct node."
                );
                index++;
            }
        ...
        public void MultipleChildren()
        {
            ...
            Assert.AreEqual(
                element.ChildNodes.Count,
                3,
                "Incorrect number of children returned from Count property."
            );
            Assert.IsNull(
                element.ChildNodes[-1],
                "Index less than zero should have returned null."
            );
            Assert.IsNull(
                element.ChildNodes[3],
                "Index greater than or equal to Count should have returned null."
            );
            Assert.AreEqual(
                element.FirstChild,
                element.ChildNodes[0],
                "Didn't return the correct child."
            );
            Assert.AreEqual(
                "child1",
                element.ChildNodes[0].LocalName,
                "Didn't return the correct child."
            );
            Assert.AreEqual(
                "child2",
                element.ChildNodes[1].LocalName,
                "Didn't return the correct child."
            );
            Assert.AreEqual(
                "child3",
                element.ChildNodes[2].LocalName,
                "Didn't return the correct child."
            );
        ...
        public void RemoveChildAffectOnEnumeration()
        {
            ...
            enumerator.MoveNext();
            Assert.AreEqual(
                ((XmlElement)enumerator.Current).LocalName,
                "child2",
                "Expected child2 element."
            );
        }
        ...
        public void RemoveChildAffectOnEnumerationWhenEnumeratorIsOnRemovedChild()
        {
            ...
            Assert.AreEqual(
                "child2",
                element.FirstChild.NextSibling.LocalName,
                "Expected child2 element."
            );
        ...
        public void CurrentBeforeFirstNode()
        {
            ...
            try
            {
                ...
                Assert.Fail(
                    "Calling Current property before first node in list should have thrown InvalidOperationException."
                );
            }
            catch (InvalidOperationException) { }
        }
        ...
        public void CurrentAfterLastNode()
        {
            ...
            try
            {
                obj = enumerator.Current;
                Assert.Fail(
                    "Calling Current property after last node in list should have thrown InvalidOperationException."
                );
            }
            catch (InvalidOperationException) { }
        }
        ...
        public void CurrentDoesntMove()
        {
            ...
            enumerator.MoveNext();
            Assert.AreEqual(
                Object.ReferenceEquals(enumerator.Current, enumerator.Current),
                true,
                "Consecutive calls to Current property should yield same reference."
            );
        }
