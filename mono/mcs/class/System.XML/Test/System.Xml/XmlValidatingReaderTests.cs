...
namespace MonoTests.System.Xml
{
    ...
    public class XmlValidatingReaderTests
    {
        ...
        {
            string intSubset =
                "<!ELEMENT root ((foo, bar)|(foo,baz))><!ELEMENT foo EMPTY><!ELEMENT bar EMPTY><!ELEMENT baz EMPTY>";
            string dtd = "<!DOCTYPE root [" + intSubset + "]>";
            string xml = dtd + "<root><foo/><bar/></root>";
            dvr = PrepareXmlReader(xml);
            dvr.Read(); // DTD
        ...
        public void TestAttributes()
        {
            ...
            string intSubset =
                "<!ELEMENT root (foo)><!ELEMENT foo EMPTY><!ATTLIST root foo CDATA #REQUIRED bar CDATA #IMPLIED>";
            string dtd = "<!DOCTYPE root [" + intSubset + "]>";
            ...
            intSubset =
                "<!ELEMENT root EMPTY><!ATTLIST root foo CDATA #REQUIRED bar CDATA #IMPLIED>";
        ...
        {
            string intSubset =
                "<!ELEMENT root EMPTY><!ATTLIST root foo CDATA 'foo-def' bar CDATA 'bar-def'>";
            string dtd = "<!DOCTYPE root [" + intSubset + "]>";
            string xml = dtd + "<root />";
        ...
        public void TestNormalization()
        {
            ...
            string xml =
                dtd
                + "<root foo=' id1 ' bar='  nameToken  ' baz=' list  of\r\nname token' quux=' quuux\tquuux\t ' />";
            dvr = PrepareXmlReader(xml);
        ...
        {
            string intSubset =
                "<!ELEMENT root (c)+><!ELEMENT c EMPTY><!ATTLIST root foo ID #REQUIRED>";
            string dtd = "<!DOCTYPE root [" + intSubset + "]>";
            ...
            intSubset =
                "<!ELEMENT root (c)+><!ELEMENT c EMPTY><!ATTLIST c foo ID #REQUIRED bar IDREF #IMPLIED baz IDREFS #IMPLIED>";
            dtd = "<!DOCTYPE root [" + intSubset + "]>";
        ...
        {
            string dtd =
                "<!DOCTYPE root [<!ELEMENT root (#PCDATA)*><!ATTLIST root attr CDATA #REQUIRED><!ENTITY ent 'entity string'>]>";
        ...
        {
            string xml =
                "<!DOCTYPE file [<!ELEMENT file EMPTY><!ATTLIST file name CDATA #REQUIRED>]><file name=\"foo\" bar=\"baz\" />";
