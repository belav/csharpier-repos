...
namespace MonoTests.System.Xml
{
    ...
    public class XmlReaderTests
    {
        ...
        [Ignore(
            "Too inconsistent reference implementations to determine which is correct behavior."
        )]
        ...
        public void CreateSimple()
        {
            ...
            XmlReader xr = XmlReader.Create(
                TestResourceHelper.GetFullPathOfResource("Test/XmlFiles/nested-dtd-test.xml"),
                s
            );
            xr.Read();
        ...
        {
            string xml =
                @"<root><foo/><bar attr='value'/><foo><pooh/><bar></bar><foo></foo><bar/></foo></root>";
        ...
        {
            string xml =
                @"<root><baz><bar><foo attr='value'/></bar><foo attr='value2'><bar><foo /></bar></foo></baz></root>";
...
<DictionaryEntry Key=""Key3"" Value=""Value3""/>
        ...
        {
            XmlReader xr = XmlReader.Create(new StringReader("<doc>1.0</doc>"));
            xr.Read();
        ...
        {
            XmlReader xr = XmlReader.Create(new StringReader("<doc>P1Y2M3D</doc>"));
            xr.Read();
        ...
        {
            XmlReader xr = XmlReader.Create(new StringReader("<doc xmlns:x='urn:foo'>x:el</doc>"));
            xr.Read();
            object o = xr.ReadElementContentAs(typeof(XmlQualifiedName), null);
        ...
        {
            XmlTextReader r = new XmlTextReader("<root/>", XmlNodeType.Document, null);
            r.Read();
        ...
        public void ReadContentAsBase64()
        {
            ...
            string xmlString =
                "<?xml version=\"1.0\"?><data>" + Convert.ToBase64String(randomData) + "</data>";
        ...
        {
            StringReader readerString = new StringReader(
                "<root><b64>TWFu</b64><b64>TWFu</b64>\r\n\t<b64>TWFu</b64><b64>TWFu</b64></root>"
            );
        ...
        public void ReadContentAsBase64_3() // bug #543332
        {
            ...
            int bytesRead;
            bytesRead = reader.ReadElementContentAsBase64(
                fixedSizeBuffer,
                0,
        ...
        public void ReadElementContentAsQNameDefaultNS()
        {
            ...
            xr.MoveToContent();
            var q = (XmlQualifiedName)
                xr.ReadElementContentAs(typeof(XmlQualifiedName), xr as IXmlNamespaceResolver);
        ...
        public void ReadElementContentAsArray()
        {
            ...
            var arr = new XmlQualifiedName[]
            {
                new XmlQualifiedName("foo"),
                new XmlQualifiedName("bar", "urn:bar"),
            };
            xw.WriteValue(arr);
            xw.Close();
            var xr = XmlReader.Create(new StringReader(sw.ToString()));
            xr.MoveToContent();
            var ret =
                xr.ReadElementContentAs(typeof(XmlQualifiedName[]), null) as XmlQualifiedName[];
