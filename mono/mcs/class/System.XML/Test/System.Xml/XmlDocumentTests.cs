...
namespace MonoTests.System.Xml
{
    ...
    public class XmlDocumentTests
    {
        ...
        public void EventNodeChanging()
        {
            ...
            document.NodeChanging += new XmlNodeChangedEventHandler(
                this.EventNodeChangingException
            );
            element = document.CreateElement("foo");
            comment = document.CreateComment("bar");
            element.AppendChild(comment);
            ...
            try
            {
                comment.Value = "baz";
                Assert.Fail(
                    "Expected an exception to be thrown by the NodeChanging event handler method EventNodeChangingException()."
                );
            }
            catch (Exception) { }
            Assert.AreEqual("<!--bar-->", element.InnerXml);
...
*/
        ...
        public void EventNodeInserted()
        {
            ...
            document.AppendChild(element);
            Assert.IsTrue(
                eventStrings.Contains("NodeInserted, Insert, <foo />, <none>, #document")
            );
        ...
        public void EventNodeInserting()
        {
            ...
            document.AppendChild(element);
            Assert.IsTrue(
                eventStrings.Contains("NodeInserting, Insert, <foo />, <none>, #document")
            );
            ...
            // If an exception is thrown the Document returns to original state.
            document.NodeInserting += new XmlNodeChangedEventHandler(
                this.EventNodeInsertingException
            );
            Assert.AreEqual(1, element.ChildNodes.Count);
            try
            {
                ...
                Assert.Fail(
                    "Expected an exception to be thrown by the NodeInserting event handler method EventNodeInsertingException()."
                );
            }
            catch (Exception) { }
            Assert.AreEqual(1, element.ChildNodes.Count);
        ...
        public void EventNodeRemoving()
        {
            ...
            */
            ...
            // If an exception is thrown the Document returns to original state.
            document.NodeRemoving += new XmlNodeChangedEventHandler(
                this.EventNodeRemovingException
            );
            element.AppendChild(element2);
            Assert.AreEqual(1, element.ChildNodes.Count);
            try
            {
                element.RemoveChild(element2);
                Assert.Fail(
                    "Expected an exception to be thrown by the NodeRemoving event handler method EventNodeRemovingException()."
                );
            }
            catch (Exception) { }
            Assert.AreEqual(1, element.ChildNodes.Count);
        ...
        public void InnerAndOuterXml()
        {
            ...
            document.DocumentElement.AppendChild(element);
            Assert.AreEqual(
                "<?xml version=\"1.0\"?><foo><!--bar-->baz<quux quuux=\"squonk\" /></foo>",
                document.InnerXml
            );
            Assert.AreEqual(document.InnerXml, document.OuterXml);
        }
        ...
        public void LoadXMLComment()
        {
            ...
            Assert.AreEqual(
                "bar",
                ((XmlComment)document.FirstChild.FirstChild).Data,
                "Incorrect target."
            );
        }
        ...
        public void LoadXmlProcessingInstruction()
        {
            ...
            Assert.AreEqual(
                "foo",
                ((XmlProcessingInstruction)document.FirstChild).Target,
                "Incorrect target."
            );
            Assert.AreEqual(
                "bar='baaz' quux='quuux'",
                ((XmlProcessingInstruction)document.FirstChild).Data,
                "Incorrect data."
            );
        }
        ...
        public void OuterXml()
        {
            ...
            Assert.AreEqual(
                xml,
                document.OuterXml,
                "XmlDocument with cdata OuterXml is incorrect."
            );
            ...
            Assert.AreEqual(
                xml,
                document.OuterXml,
                "XmlDocument with comment OuterXml is incorrect."
            );
            ...
            Assert.AreEqual(
                xml,
                document.OuterXml,
                "XmlDocument with processing instruction OuterXml is incorrect."
            );
        }
        ...
        public void ParentNodes()
        {
            ...
            Assert.AreEqual(
                "#document",
                node.ParentNode.ParentNode.ParentNode.LocalName,
                "Wrong parent."
            );
            Assert.IsNull(
                node.ParentNode.ParentNode.ParentNode.ParentNode,
                "Expected parent to be null."
            );
        }
        ...
        public void ImportNode()
        {
            ...
            string xml1 =
                "<?xml version='1.0' encoding='utf-8' ?><foo xmlns:xlink='"
                + xlinkURI
                + "'><bar a1='v1' xlink:href='#foo'><baz><![CDATA[cdata section.\n\titem 1\n\titem 2\n]]>From here, simple text node.</baz></bar></foo>";
            ...
            XmlProcessingInstruction pi = (XmlProcessingInstruction)
                newDoc.ImportNode(document.DocumentElement.FirstChild, false);
            Assert.AreEqual("xml-stylesheet", pi.Name, "#ImportNode.ProcessingInstruction.Name");
            Assert.AreEqual(
                "href='foo.xsl'",
                pi.Data.Trim(),
                "#ImportNode.ProcessingInstruction.Data"
            );
            ...
            Assert.AreEqual(
                ...
                decl.NodeType,
                "#ImportNode.XmlDeclaration.Type"
            );
        ...
        public void DocumentWithDoctypeDecl()
        {
            ...
            {
                doc.LoadXml(
                    "<!DOCTYPE test SYSTEM 'http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd'><root />"
                );
            }
            catch (XmlException)
            {
            ...
            {
                doc.LoadXml(
                    "<!DOCTYPE test PUBLIC '-//test' 'http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd'><root />"
                );
            }
            catch (XmlException)
            {
        ...
        public void OuterXmlWithDefaultXmlns()
        {
            XmlDocument doc = new XmlDocument();
            doc.LoadXml(
                "<iq type=\"get\" id=\"ATECLIENT_1\"><query xmlns=\"jabber:iq:auth\"><username></username></query></iq>"
            );
            Assert.AreEqual(
                "<iq type=\"get\" id=\"ATECLIENT_1\"><query xmlns=\"jabber:iq:auth\"><username></username></query></iq>",
                doc.OuterXml
        ...
        {
            string input = "<?xml version=\"1.0\" encoding=\"utf-8\" ?><!-- --> <foo/>";
        ...
        {
            string xml =
                "<!DOCTYPE root [<!ELEMENT root (#PCDATA)*><!ENTITY ent 'val'>]><root attr='a &ent; string'>&ent;</root>";
            XmlTextReader xtr = new XmlTextReader(xml, XmlNodeType.Document, null);
            XmlDocument doc = new XmlDocument();
            doc.Load(xtr);
            Assert.AreEqual(
        ...
        public void ReadNodeEntityReferenceFillsChildren()
        {
            ...
            Assert.AreEqual(1, doc.DocumentElement.FirstChild.ChildNodes.Count);
        }
        ...
        {
            string xml =
                @"<!DOCTYPE foo [<!ELEMENT foo EMPTY><!ATTLIST foo xmlns CDATA #FIXED 'urn:foo'>]><foo />";
            XmlDocument doc = new XmlDocument();
