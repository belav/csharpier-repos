    ...
    public class XmlDocumentEventTests
    {
        ...
        private void OnInsertingLog(object o, XmlNodeChangedEventArgs e)
        {
            eventLogBuilder.Append(
                "Inserting: " + e.Node.NodeType + " into " + e.NewParent.NodeType + ".\n"
            );
        }
        ...
        {
            eventLogBuilder.Append(
                "Inserted: " + e.Node.NodeType + " into " + e.NewParent.NodeType + ".\n"
            );
        }
        ...
        {
            eventLogBuilder.Append(
                "Changing: " + e.Node.NodeType + " into " + e.NewParent.NodeType + ".\n"
            );
        }
        ...
        {
            eventLogBuilder.Append(
                "Changed: " + e.Node.NodeType + " into " + e.NewParent.NodeType + ".\n"
            );
        }
        ...
        {
            eventLogBuilder.Append(
                "Removing: " + e.Node.NodeType + " from " + e.OldParent.NodeType + ".\n"
            );
        }
        ...
        {
            eventLogBuilder.Append(
                "Removed: " + e.Node.NodeType + " from " + e.OldParent.NodeType + ".\n"
            );
        }
        ...
        public void DefaultAttributeRemoval()
        {
            ...
            doc.LoadXml(
                "<!DOCTYPE root [<!ELEMENT root (#PCDATA)><!ATTLIST root foo CDATA 'foo-def'>]><root></root>"
            );
            SetEvents(doc);
