...
namespace MonoTests.System.Xml
{
    ...
    public class XmlSchemaDatatypeTests
    {
        ...
        [Test]
        [Ignore(
            "The behavior has been inconsistent between versions, so it is not worthy of testing."
        )]
        ...
        {
            return (
                allWrappers.GlobalTypes[new QName("x-" + name, String.Empty)] as SimpleType
            ).Datatype;
        }
        ...
        {
            XmlSchemaDatatype datatype = XmlSchemaType
        ...
        {
            XmlSchemaDatatype datatype = XmlSchemaType
                .GetBuiltInSimpleType(XmlTypeCode.Integer)
                .Datatype;
            Assert.IsTrue(datatype != null);
        ...
        {
            XmlSchemaDatatype datatype = XmlSchemaType
                .GetBuiltInSimpleType(XmlTypeCode.DateTime)
                .Datatype;
            Assert.IsTrue(datatype != null);
        ...
        {
            XmlSchemaDatatype datatype = XmlSchemaType
                .GetBuiltInSimpleType(XmlTypeCode.DayTimeDuration)
                .Datatype;
            Assert.IsTrue(datatype != null);
