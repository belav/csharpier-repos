    ...
    public class XmlSchemaAssertion
    {
        public static XmlSchema GetSchema(string resourceName)
        {
            XmlTextReader reader = new XmlTextReader(
                TestResourceHelper.GetFullPathOfResource(resourceName)
            );
        ...
        public static void AssertElementEx(
            XmlSchemaElement element,
        ...
        public static void AssertCompiledComplexType(
        ...
        public static void AssertCompiledComplexContentExtension(
        ...
        public static void AssertCompiledElement(
            XmlSchemaElement element,
            XmlQualifiedName name,
            object elementType
        )
