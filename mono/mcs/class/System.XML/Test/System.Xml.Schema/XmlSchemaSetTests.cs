...
namespace MonoTests.System.Xml
{
    ...
    public class XmlSchemaSetTests
    {
        ...
        {
            string xsd =
                @"<xs:schema targetNamespace='urn:foo' xmlns:xs='http://www.w3.org/2001/XMLSchema'><xs:element name='el' type='xs:int' /></xs:schema>";
        ...
        public void AddSchemaTwice()
        {
            ...
            XmlDocument doc = new XmlDocument();
            doc.LoadXml(
                "<xs:schema xmlns:xs='http://www.w3.org/2001/XMLSchema' targetNamespace='urn:ab' />"
            );
    ...
    <xs:sequence>
      ...
      <xs:element name='el' />
            ...
            XmlSchema xs = XmlSchema.Read(
                new XmlTextReader(schema, XmlNodeType.Document, null),
                null
            );
            XmlSchemaSet xss = new XmlSchemaSet();
            xss.Add(xs);
        ...
        {
            string schema1 =
                @"<xsd:schema id=""Base.Schema"" elementFormDefault=""qualified"" xmlns:xsd=""http://www.w3.org/2001/XMLSchema"">
...
use=""required""/> 
            ...
            string schema2 =
                @"<xsd:schema id=""Sub.Schema"" elementFormDefault=""qualified"" xmlns:xsd=""http://www.w3.org/2001/XMLSchema"">
...
type=""xsd:string"" use=""required""/> 
        ...
        {
            var xsdraw =
                "<xs:schema xmlns:xs='http://www.w3.org/2001/XMLSchema'><xs:element name='foo' /></xs:schema>";
    ...
    <xs:schema
      ...
      <xs:element name='GetSystemDateAndTimeResponse'>
        ...
        public void ResolveSchemaUriUsingXmlResolver()
        {
            ...
            string xml =
                "<people xmlns='testschema'><person name='Ian'><books><book>Clean Code</book></books></person></people>";
