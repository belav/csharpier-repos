...
namespace MonoTests.System.Xml
{
    ...
    public class XmlSchemaTests : XmlSchemaAssertion
    {
            ...
            foreach (XmlSchemaObject obj in schema.Items)
            {
                ...
                if (element.Name == "Foo")
                {
                    AssertElement(
                        ...
                        null,
                        QName("string", XmlSchema.Namespace),
                        null
                    );
                    fooValidated = true;
                }
        ...
        public void TestReadFlags()
        {
            ...
            Assert.IsNotNull(el);
            Assert.AreEqual(
                XmlSchemaDerivationMethod.Extension | XmlSchemaDerivationMethod.Restriction,
                el.Block
            );
        }
        ...
        public void TestCompile()
        {
            ...
            AssertCompiledComplexContentExtension(xccx, 0, false, QName("HogeType", ns));
        ...
        public void TestSimpleImport()
        {
            XmlSchema schema = XmlSchema.Read(
                new XmlTextReader(
                    TestResourceHelper.GetFullPathOfResource("Test/XmlFiles/xsd/3.xsd")
                ),
                null
            );
        ...
        {
            XmlReader r = new XmlTextReader(
                TestResourceHelper.GetFullPathOfResource("Test/XmlFiles/xsd/inter-inc-1.xsd")
            );
            try
            {
        ...
        public void TestQualification()
        {
            XmlSchema schema = XmlSchema.Read(
                new XmlTextReader(
                    TestResourceHelper.GetFullPathOfResource("Test/XmlFiles/xsd/5.xsd")
                ),
                null
            );
            schema.Compile(null);
            ...
            schema = XmlSchema.Read(
                new XmlTextReader(
                    TestResourceHelper.GetFullPathOfResource("Test/XmlFiles/xsd/6.xsd")
                ),
                null
            );
            schema.Compile(null);
        ...
        public void TestWriteNamespaces()
        {
            ...
            doc.LoadXml(sw.ToString());
            Assert.AreEqual(
                "<xs:schema xmlns:tns=\"urn:foo\" targetNamespace=\"urn:foo\" xmlns:xs=\"http://www.w3.org/2001/XMLSchema\" />",
                doc.DocumentElement.OuterXml,
                "#2"
            );
        ...
        public void TestWriteNamespaces2()
        {
            ...
            Assert.AreEqual(
                xmldecl + "<xs:schema xmlns:xs=\"http://www.w3.org/2001/XMLSchema\" />",
                sw.ToString(),
                "#1"
            );
        ...
        {
            string xsd =
                @"<xs:schema xmlns:xs='http://www.w3.org/2001/XMLSchema' elementFormDefault='qualified'>  <xs:element name='test' type='xs:integer'/></xs:schema>";
...
<xs:complexType name='TestType'>
  ...
  <xs:element name='choice'>
    <xs:annotation><xs:documentation /></xs:annotation>
            ...
            XmlTextReader tr = new XmlTextReader(schemaxml, XmlNodeType.Document, null);
        ...
        {
            string schemaFileName = TestResourceHelper.GetFullPathOfResource(
        ...
        public void DuplicateKeyFieldAttributePath()
        {
            ...
            string xmlFileName = TestResourceHelper.GetFullPathOfResource(
                "Test/XmlFiles/xsd/78985.xml"
            );
            XmlTextReader tr = new XmlTextReader(schemaFileName);

            XmlValidatingReader vr = new XmlValidatingReader(new XmlTextReader(xmlFileName));
        ...
        public void ThreeLevelNestedInclusion()
        {
            XmlTextReader r = new XmlTextReader(
                TestResourceHelper.GetFullPathOfResource("Test/XmlFiles/xsd/361818.xsd")
            );
            try
            {
        ...
        public void TestResolveUri()
        {
            ...
            FileStream stream = new FileStream(
                TestResourceHelper.GetFullPathOfResource("Test/XmlFiles/xsd/resolveUriSchema.xsd"),
                FileMode.Open,
                FileAccess.Read
            );
            ...
            Assert.AreEqual(
                "assembly://MyAssembly.Name/MyProjectNameSpace/objects.xsd",
                resolver.ReceivedUri.OriginalString
            );
        }
        ...
        public void TestImportNoSchemaLocation()
        {
            ...
            XmlReader reader = XmlReader.Create(
                TestResourceHelper.GetFullPathOfResource("Test/XmlFiles/xsd/xsdimporttest.xml"),
                settings
            );
