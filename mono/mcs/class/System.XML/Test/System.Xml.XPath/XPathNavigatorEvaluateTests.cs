...
namespace MonoTests.System.Xml
{
    ...
    public class XPathNavigatorEvaluateTests
    {
        ...
        public void saveTestCoreFunctionString()
        {
            ...
            Assert.AreEqual(
                "0.33333333333333331",
                navigator.Evaluate("string(1 div 3)").ToString(),
                "#14"
            );
        }
        ...
        public void CoreFunctionConcat()
        {
            ...
            Assert.AreEqual(
                "foobarbaz",
                navigator.Evaluate("concat('foo', 'bar', 'baz')").ToString(),
                "#2"
            );
            Assert.AreEqual(
                "foobarbazqux",
                navigator.Evaluate("concat('foo', 'bar', 'baz', 'qux')").ToString(),
                "#3"
            );
            Assert.AreEqual(
                "foobarbazquxquux",
                navigator.Evaluate("concat('foo', 'bar', 'baz', 'qux', 'quux')").ToString(),
                "#4"
            );
        }
