...
namespace MonoTests.System.Xml
{
    ...
    public class XPathNavigatorTests
    {
        ...
        {
            document.LoadXml(
                "<?xml version=\"1.0\" standalone=\"yes\"?><Root><foo>bar</foo></Root>"
            );
            navigator = document.CreateNavigator();
        ...
        public void SelectFromOrphan()
        {
            ...
            Assert.AreEqual(
                "<child><grandchild><include id=\"new\" /></grandchild></child>",
        ...
        <child xml:space='preserve'>    </child>
            ...
            nav.MoveToNext();
            nav.MoveToFirstChild();
            Assert.AreEqual(XPathNodeType.SignificantWhitespace, nav.NodeType, "#2");
        }
