...
namespace MonoTests.System.Xml.XPath
{
    ...
    public class SelectNodesTests
    {
        ...
        public void AncestorAxisOrder2()
        {
            ...
            XmlNode id,
                n = doc.SelectSingleNode("/item/item/n");
        ...
        {
            string xml =
                "<foo xmlns='urn:foo'><bar><div id='e1'> <div id='e1.1'> <div id='e1.1.1'> <div id='e1.1.1.1'> <div id='e1.1.1.1.1'/> </div> <div id='e1.1.1.2'/> </div> </div> </div></bar></foo>";
            XmlDocument doc = new XmlDocument();
            doc.LoadXml(xml);
    ...
    <div id='e1.1'>
        ...
        public void ReturnedNavigatorInstancesUnique()
        {
            ...
            foreach (XPathNavigator n in parent.Select("Note[Reference]"))
            {
                Assert.IsFalse(
                    l.Contains(n),
                    "should not iterate the same XPathNavigator instance twice, regardless of whether position is same or not"
                );
                l.Add(n);
            }
            ...
            foreach (
                XPathNavigator n in data.CreateNavigator()
