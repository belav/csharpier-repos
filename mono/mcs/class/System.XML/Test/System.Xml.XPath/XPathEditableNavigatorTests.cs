...
namespace MonoTests.System.Xml.XPath
{
    ...
    public class XPathEditableNavigatorTests
    {
        ...
        private static void AssertNavigator(
            string label,
            XPathNavigator nav,
            XPathNodeType type,
            string prefix,
        ...
        {
            XPathNavigator nav = GetInstance(
                "<root><foo><bar/><baz/></foo><next>child<tmp/></next>final</root>"
            );
            nav.MoveToFirstChild();
        ...
        public void MoveToFollowing()
        {
            ...
            XPathNavigator nav = GetInstance(
                "<root><bar><foo attr='v1'><baz><foo attr='v2'/></baz></foo></bar><dummy/><foo attr='v3'></foo></root>"
            );
