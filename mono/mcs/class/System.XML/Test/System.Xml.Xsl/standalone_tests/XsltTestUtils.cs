...
namespace MonoTests.oasis_xslt
{
    ...
    class CatalogTestCase
    {
        ...
        string GetRelPath()
        {
            ...
            string submitter = _testCase
                .SelectSingleNode("./parent::test-catalog/@submitter")
                .InnerText;
            if (submitter == "Lotus")
        ...
        {
            string stylesheetBase = scenario
                .SelectSingleNode("input-file[@role='principal-stylesheet']")
                .InnerText;
    ...
    class SingleTestTransform
    {
            ...
            if (EnvOptions.UseDomStyle)
            {
                ...
                trans.Load(
                    new XPathDocument(
                        ...
                        EnvOptions.WhitespaceStyle ? XmlSpace.Preserve : XmlSpace.Default
                    ),
                    null,
                    null
                );
        ...
        IXPathNavigable LoadInput()
        {
            ...
            try
            {
                ...
                {
                    input = new XPathDocument(
                        xvr,
                        EnvOptions.WhitespaceInstance ? XmlSpace.Preserve : XmlSpace.Default
                    );
                }
                return input;
            }
