...
namespace MonoTests.System.Xml.Xsl
{
    ...
    public class XslTransformTests
    {
        ...
        public void TestBasicTransform()
        {
            ...
            xslt.Transform(
                TestResourceHelper.GetFullPathOfResource("Test/XmlFiles/xsl/empty.xsl"),
                output
            );
            result.Load(output);
...
<xsl:template match='/'>
	<root>
		...
		<xsl:for-each select='msxsl:node-set($var)/foo'>
            ...
            Assert.AreEqual(
                @"<?xml version=""1.0"" encoding=""utf-16""?><root xmlns:msxsl=""urn:schemas-microsoft-com:xslt"">foo: Afoo: Bfoo: C</root>",
                sw.ToString()
            );
        }
...
<xsl:template match='/'>
	<root>
		<p>The current date is <xsl:value-of select=""msxsl:format-date($date, 'd MMMM yyyy')""/> and current time is <xsl:value-of select=""msxsl:format-time($date, 'HH:mm')""/>.</p>
            ...
            t.Transform(
                new XPathDocument(new XmlTextReader(new StringReader("<root></root>"))),
                arguments,
                sw
            );

            Assert.AreEqual(
                "<?xml version=\"1.0\" encoding=\"utf-16\"?><root xmlns=\"http://www.w3.org/1999/xhtml\"><p>The current date is 22 November 2010 and current time is 05:04.</p></root>",
                sw.ToString()
            );
        }
...
<xsl:template match='/'>
	...
	<root><xsl:if test='$var'>true</xsl:if></root>
            ...
            t.Load(new XPathDocument(new StringReader(xsl)));
            StringWriter sw = new StringWriter();
            t.Transform(new XPathDocument(new StringReader("<root/>")), null, sw);
...
<xsl:template match='/descendant-or-self::node()/elem'>
	<ERROR/>
            ...
            new XslTransform().Load(new XPathDocument(new StringReader(xsl)));
        }
...
<xsl:template match='/'></xsl:template>
	<xsl:import href='dummy.xsl' />
        ...
        {
            XPathDocument doc = new XPathDocument(new StringReader(xsl));
        ...
        public void ErrorOnDocumentResolution()
        {
            ...
            Assert.AreEqual("<?xml version=\"1.0\" encoding=\"utf-16\"?>" + "xx", sw.ToString());
        }
        ...
        public void LoadStyleFromNonRoot()
        {
            ...
            XslTransform xslt = new XslTransform();
            doc.LoadXml(
                "<root><dummy /><xsl:transform xmlns:xsl='http://www.w3.org/1999/XSL/Transform' version='1.0' /></root>"
            );
        ...
        public void ReturnEmptyResultsAsXmlReader()
        {
            ...
            doc.LoadXml(
                "<xsl:transform xmlns:xsl='http://www.w3.org/1999/XSL/Transform' version='1.0' ><xsl:output standalone='yes' indent='no'/><xsl:template match='/'><foo/></xsl:template></xsl:transform>"
            );
            xslt = new XslTransform();
            xslt.Load(doc, null, null);
        ...
        public void LREDefaultNamespace()
        {
            ...
            t.Transform(new XPathDocument(new StringReader(xml)), null, xw);
            Assert.AreEqual("<root xmlns=\"urn:foo\" />", sw.ToString());
            ...
            t.Transform(new XPathDocument(new StringReader(xml2)), null, xw);
            Assert.AreEqual("<root xmlns=\"urn:foo\"><page /></root>", sw.ToString());
        }
    ...
    ";
        ...
        public void Output_Standalone()
        {
            ...
            xsltProcessor.Load(
                new XmlTextReader(
                    new StringReader(string.Format(xsltFragment, "standalone=\"yes\""))
                ),
                new XmlUrlResolver()
            );
            xsltProcessor.Transform(xmlDoc, xsltArgs, sw, new XmlUrlResolver());
            ...
            xsltProcessor.Load(
                new XmlTextReader(
                    new StringReader(string.Format(xsltFragment, "standalone=\"no\""))
                ),
                new XmlUrlResolver()
            );
            xsltProcessor.Transform(xmlDoc, xsltArgs, sw, new XmlUrlResolver());
            ...
            sw = new StringWriter();
            xsltProcessor.Load(
                new XmlTextReader(new StringReader(string.Format(xsltFragment, ""))),
                new XmlUrlResolver()
            );
            xsltProcessor.Transform(xmlDoc, xsltArgs, sw, new XmlUrlResolver());
        ...
        public void Output_Standalone_ForwardsCompatible()
        {
            ...
            // standalone is "Yes"
            xsltProcessor.Load(
                new XmlTextReader(new StringReader(string.Format(xsltFragment, "Yes"))),
                new XmlUrlResolver()
            );
            xsltProcessor.Transform(xmlDoc, xsltArgs, sw, new XmlUrlResolver());
        ...
        public void Output_OmitXmlDeclaration()
        {
            ...
            xsltProcessor.Load(
                new XmlTextReader(
                    new StringReader(string.Format(xsltFragment, "omit-xml-declaration=\"yes\""))
                ),
                new XmlUrlResolver()
            );
            xsltProcessor.Transform(xmlDoc, xsltArgs, sw, new XmlUrlResolver());
            ...
            xsltProcessor.Load(
                new XmlTextReader(
                    new StringReader(string.Format(xsltFragment, "omit-xml-declaration=\"no\""))
                ),
                new XmlUrlResolver()
            );
            xsltProcessor.Transform(xmlDoc, xsltArgs, sw, new XmlUrlResolver());
        ...
        public void Output_DocType_Xml()
        {
            ...
            Assert.AreEqual(
                "<?xml version=\"1.0\" encoding=\"utf-16\"?>" + "<test><abc /></test>",
                sw.ToString(),
                "#2"
            );
        ...
        public void Output_DocType_Html()
        {
            ...
            Assert.AreEqual(
                "<!DOCTYPE html PUBLIC \"\" \"\">" + "<test><abc></abc></test>",
                sw.ToString(),
                "#4"
            );
            ...
            Assert.AreEqual(
                "<!DOCTYPE html SYSTEM \"\">" + "<test><abc></abc></test>",
                sw.ToString(),
                "#6"
            );
        }
        ...
        public void Output_Indent_Xml_DocType()
        {
            ...
            StringWriter sw = new StringWriter();
            xsltProcessor.Load(
                new XmlTextReader(new StringReader(string.Format(xsltFragment, "indent=\"yes\""))),
                new XmlUrlResolver()
            );
            xsltProcessor.Transform(xmlDoc, xsltArgs, sw, new XmlUrlResolver());
            ...
            sw.GetStringBuilder().Length = 0;
            xsltProcessor.Load(
                new XmlTextReader(new StringReader(string.Format(xsltFragment, "indent=\"no\""))),
                new XmlUrlResolver()
            );
            xsltProcessor.Transform(xmlDoc, xsltArgs, sw, new XmlUrlResolver());
            ...
            Assert.AreEqual(
                "<?xml version=\"1.0\" encoding=\"utf-16\"?>"
                    + "<!DOCTYPE test PUBLIC \"-//W3C//DTD XHTML 1.0 Strict//EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd\">"
                    + "<test><something><else /></something></test>",
                sw.ToString(),
                "#2"
            );
        ...
        public void Output_Encoding_TextWriter()
        {
            ...
            sw = new StringWriter();
            xsltProcessor.Load(
                new XmlTextReader(new StringReader(string.Format(xsltFragment, string.Empty))),
                new XmlUrlResolver()
            );
            xsltProcessor.Transform(xmlDoc, xsltArgs, sw, new XmlUrlResolver());
            ...
            xsltProcessor.Load(
                new XmlTextReader(
                    new StringReader(string.Format(xsltFragment, "encoding=\"iso-8859-1\""))
                ),
                new XmlUrlResolver()
            );
            xsltProcessor.Transform(xmlDoc, xsltArgs, sw, new XmlUrlResolver());
            ...
            xsltProcessor.Load(
                new XmlTextReader(
                    new StringReader(string.Format(xsltFragment, "encoding=\"doesnotexist\""))
                ),
                new XmlUrlResolver()
            );
            xsltProcessor.Transform(xmlDoc, xsltArgs, sw, new XmlUrlResolver());
            ...
            sw.GetStringBuilder().Length = 0;
            xsltProcessor.Load(
                new XmlTextReader(new StringReader(string.Format(xsltFragment, "encoding=\"\""))),
                new XmlUrlResolver()
            );
            xsltProcessor.Transform(xmlDoc, xsltArgs, sw, new XmlUrlResolver());
        ...
        public void Output_Version()
        {
            ...
            sw = new StringWriter();
            xsltProcessor.Load(
                new XmlTextReader(new StringReader(string.Format(xsltFragment, "1.0"))),
                new XmlUrlResolver()
            );
            xsltProcessor.Transform(xmlDoc, xsltArgs, sw, new XmlUrlResolver());
            ...
            sw.GetStringBuilder().Length = 0;
            xsltProcessor.Load(
                new XmlTextReader(new StringReader(string.Format(xsltFragment, "2.0"))),
                new XmlUrlResolver()
            );
            xsltProcessor.Transform(xmlDoc, xsltArgs, sw, new XmlUrlResolver());
            ...
            sw.GetStringBuilder().Length = 0;
            xsltProcessor.Load(
                new XmlTextReader(new StringReader(string.Format(xsltFragment, "BLABLA"))),
                new XmlUrlResolver()
            );
            xsltProcessor.Transform(xmlDoc, xsltArgs, sw, new XmlUrlResolver());
        ...
        public void Output_Method_Html_TextWriter()
        {
            ...
            sw.GetStringBuilder().Length = 0;
            xsltProcessor.Load(
                new XmlTextReader(new StringReader(string.Format(xsltFragment, options))),
                new XmlUrlResolver()
            );
            xsltProcessor.Transform(xmlDoc, xsltArgs, sw, new XmlUrlResolver());
        ...
        public void FormatNumber_KB_832757()
        {
            ...
            xsltProcessor.Transform(xmlDoc, new XsltArgumentList(), sw, new XmlUrlResolver());
...
<xsl:stylesheet version='1.0' xmlns:xsl='http://www.w3.org/1999/XSL/Transform'>
    ...
    <xsl:template match='/'>
        ...
        <foo/>
            ...
            try
            {
                t.Transform(new XPathDocument(new StringReader("<root/>")), null, TextWriter.Null);
                Assert.Fail(
                    "should fail; doctype is not allowed after whitespace. See XSLT 1.0 section 16.1."
                );
            }
            catch { }
        }
...
";
            ...
            XPathDocument d = new XPathDocument(
                TestResourceHelper.GetFullPathOfResource("Test/XmlFiles/xsl/stripspace.xml"),
                XmlSpace.Preserve
            );
            StringWriter sw = new StringWriter();
        ...
        public void CurrentInSelect()
        {
            XslTransform t = new XslTransform();
            t.Load(
                TestResourceHelper.GetFullPathOfResource("Test/XmlFiles/xsl/current-in-select.xsl")
            );
            XPathDocument d = new XPathDocument(
                TestResourceHelper.GetFullPathOfResource("Test/XmlFiles/xsl/current-in-select.xml"),
                XmlSpace.Preserve
            );
            StringWriter sw = new StringWriter();
            t.Transform(d, null, sw);
  ...
  <xsl:template name='bar'>
            ...
            t.Transform(
                new XPathDocument(new StringReader("<dummy/>")),
                null,
                new XmlTextWriter(TextWriter.Null)
            );
        }
        ...
        public void Bug82493()
        {
            ...
            transformationObj.Load(
                TestResourceHelper.GetFullPathOfResource("Test/XmlFiles/xsl/82493.xsl")
            );
            XmlDocument doc = new XmlDocument();
      ...
      <xsl:with-param name=""bar"">
        <xsl:for-each select=""@bar"">
          <xsl:value-of select="".""/>
            ...
            XPathDocument input = new XPathDocument(
                new StringReader(
                    @"<root>
        <zap bar=""HaHa""/>
        <zap/>
...
<root>
  ...
  <a>
    ...
    <ab>4</ab>
            ...
            Assert.AreEqual(
                "<x><foo>1</foo><bar>2</bar><baz>3</baz><tem>4</tem></x>",
                sw.ToString()
            );
        }
...
<family>
  ...
  <person>
    ...
    <family-name>Smith</family-name>
        ...
        {
            ResolveVariableInXsltArgumentList(
                TestResourceHelper.GetFullPathOfResource("Test/XmlFiles/xsl/316238-1.xsl")
            );
            ResolveVariableInXsltArgumentList(
                TestResourceHelper.GetFullPathOfResource("Test/XmlFiles/xsl/316238-2.xsl")
            );
        }
  ...
  <l0>
    <p>
      ...
      <span> </span>
            ...
            Assert.AreEqual(
                @"<y><t yes-one-node="""">1</t><t yes-one-node=""""> </t></y>",
                sw.ToString()
            );
        }
    ...
    <p>
      ...
      <span> </span>
        ...
        public void CompiledTransform_Fragment() // bug #391424
        {
            ...
            xslTransform.Load(
                TestResourceHelper.GetFullPathOfResource("Test/XmlFiles/xsl/391424.xsl"),
                settings,
                new XmlUrlResolver()
            );
            StringWriter sw = new StringWriter();
            xslTransform.Transform(
                new XPathDocument(
                    TestResourceHelper.GetFullPathOfResource("Test/XmlFiles/xsl/391424.xml"),
                    XmlSpace.Preserve
                ),
                null,
                sw
            ...
            Assert.AreEqual(
                "<?xml version=\"1.0\" encoding=\"utf-16\"?>Document found",
                sw.ToString()
            );
        }
  ...
  <xsl:template match='foo'>
    <xsl:text> </xsl:text>
        ...
        public void Bug487065()
        {
            ...
            {
                using (
                    XmlWriter output = XmlWriter.Create(Path.Combine(Path.GetTempPath(), "out.xml"))
                )
                {
        ...
        private static XmlReader GetInput()
        {
            return XmlReader.Create(
                new StringReader(
                    "<cb:config-template xmlns:cb=\"urn:ccnet.config.builder\"><cb:define name=\"var1\">value1</cb:define></cb:config-template>"
                )
            );
        }
