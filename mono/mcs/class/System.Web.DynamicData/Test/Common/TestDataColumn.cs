...
namespace MonoTests.Common
{
    public class TestDataColumn<DataType> : DynamicDataColumn
    {
        public TestDataColumn(MemberInfo member)
        {
            ...
            try
            {
                associationAttr = attrs
                    .OfType<DynamicDataAssociationAttribute>()
                    .First<DynamicDataAssociationAttribute>();
            }
            ...
            {
                sortableAttr = attrs
                    .OfType<DynamicDataSortableAttribute>()
                    .First<DynamicDataSortableAttribute>();
            }
            catch (InvalidOperationException)
            {
                sortableAttr = null;
