...
namespace MonoTests.System.ServiceModel.Channels
{
    ...
    public class AddressHeaderTest
    {
        ...
        {
            AddressHeader h = AddressHeader.CreateAddressHeader("foo", "urn:foo", null);
            AddressHeader h2 = AddressHeader.CreateAddressHeader("foo", "urn:foo", null);
        ...
        public void WriteAddressHeader()
        {
            ...
            xw.Close();
            Assert.AreEqual(
                "<?xml version=\"1.0\" encoding=\"utf-16\"?><foo i:nil=\"true\" xmlns:i=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns=\"urn:foo\" />",
                sw.ToString(),
                "#1"
            );
        }
