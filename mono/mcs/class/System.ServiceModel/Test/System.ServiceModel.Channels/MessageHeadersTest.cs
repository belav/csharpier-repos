...
namespace MonoTests.System.ServiceModel.Channels
{
    ...
    public class MessageHeadersTest
    {
        ...
        {
            Message m = Message.CreateMessage(MessageVersion.Default, "test", 1);
            MessageHeader h = MessageHeader.CreateHeader(
                "FirstHeader",
                "ns",
                "first",
                true,
        ...
        public void TestWriteHeaderContents()
        {
            ...
            Assert.AreEqual(
                "<root><HEADER1>first</HEADER1><HEADER2>2</HEADER2></root>",
                sb.ToString()
            );
        }
        ...
        public void TestAction()
        {
            ...
            headers.Add(
                MessageHeader.CreateHeader("Action", "http://www.w3.org/2005/08/addressing", "test")
            );
...
*/
            ...
            Assert.AreEqual(
                "1",
                r.GetAttribute("mustUnderstand", "http://www.w3.org/2003/05/soap-envelope"),
                "#1-5"
            );
