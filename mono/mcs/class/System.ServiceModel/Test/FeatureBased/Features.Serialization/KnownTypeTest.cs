...
using System;using System.Collections.Generic;using System.Text;using NUnit.Framework;using MonoTests.Features.Contracts;
...
namespace MonoTests.Features.Serialization
{
    ...
    public class KnownTypeTest
        : TestFixtureBase<
            object,
            MonoTests.Features.Contracts.KnownTypeTester,
            MonoTests.Features.Contracts.IKnownTypeTesterContract
        >
    {
        [Test]
