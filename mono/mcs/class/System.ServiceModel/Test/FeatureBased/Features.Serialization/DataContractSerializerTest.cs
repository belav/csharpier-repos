...
using System;using System.Collections.Generic;using System.Text;using System.ServiceModel;using MonoTests.Features;using MonoTests.Features.Contracts;using System.Runtime.Serialization;using NUnit.Framework;using System.Xml;using System.IO;
...
namespace MonoTests.Features.Serialization
{
    ...
    public class DataContractSerializerTest
        : TestFixtureBase<
            DataContractTesterContractClient,
            DataContractTester,
            MonoTests.Features.Contracts.IDataContractTesterContract
        >
    {
        [Test]
        ...
        {
            Proxy.MonoTests.Features.Client.ComplexPrimitiveClass inst =
                new Proxy.MonoTests.Features.Client.ComplexPrimitiveClass();
            inst.byteMember = 1;
            inst.sbyteMember = 1;
            inst.intMember = 1;
            inst.uintMember = 1;
        ...
        {
            string t =
                "<Type1 xmlns=\"http://schemas.datacontract.org/2004/07/NS1.NS3\" "
