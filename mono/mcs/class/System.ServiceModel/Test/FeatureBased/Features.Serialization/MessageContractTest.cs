...
using System;using System.Collections.Generic;using System.Text;using Proxy.MonoTests.Features.Client;using NUnit.Framework;
...
namespace MonoTests.Features.Serialization
{
    ...
    public class MessageContractTest
        : TestFixtureBase<
            MessageContractTesterContractClient,
            MonoTests.Features.Contracts.MessageContractTester,
            MonoTests.Features.Contracts.IMessageContractTesterContract
        >
    {
        [Test]
