namespace Proxy.MonoTests.Features.Client
{
    ...
    public partial class AdvPoint2D : Point2D
    {
        ...
        {
            get { return this.ZeroDistanceField; }
            set
            {
    ...
    [System.ServiceModel.ServiceContractAttribute(
        Namespace = "http://MonoTests.Features.Contracts",
        ConfigurationName = "IKnownTypeTesterContract"
    )]
    public interface IKnownTypeTesterContract
    {
        [System.ServiceModel.OperationContractAttribute(
            Action = "http://MonoTests.Features.Contracts/IKnownTypeTesterContract/Move",
            ReplyAction = "http://MonoTests.Features.Contracts/IKnownTypeTesterContract/MoveResponse"
        )]
        Point2D Move(Point2D point, Point2D delta);

        [System.ServiceModel.OperationContractAttribute(
            Action = "http://MonoTests.Features.Contracts/IKnownTypeTesterContract/Distance",
            ReplyAction = "http://MonoTests.Features.Contracts/IKnownTypeTesterContract/DistanceResponse"
        )]
        double Distance(Point2D point1, Point2D point2);
    }

    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "3.0.0.0")]
    public interface IKnownTypeTesterContractChannel
