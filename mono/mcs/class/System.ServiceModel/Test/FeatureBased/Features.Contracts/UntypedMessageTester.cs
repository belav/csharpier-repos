...
namespace MonoTests.Features.Contracts
{
    ...
    {
        [OperationContract(
            Action = UntypedMessageTester.RequestAction,
            ReplyAction = UntypedMessageTester.ReplyAction
        )]
    ...
    {
        public const String ReplyAction =
            "http://localhost/UntypedMessageTester/Message_ReplyAction";
        public const String RequestAction =
            "http://localhost/UntypedMessageTester/Message_RequestAction";
