    ...
    class Program
    {
        ...
        void runSetUp(object t)
        {
            ...
            var methods =
                ...
                where
                    method.GetCustomAttributes(typeof(NUnit.Framework.SetUpAttribute), true).Length
                    > 0
                select method;
            if (methods.Count() == 0)
            {
        ...
        static void Main(string[] args)
        {
            if (args.Count() > 0 && args[0] == "shutdown")
            {
                ...
                MonoTests.Features.Serialization.ExitProcessHelper exiter =
                    new MonoTests.Features.Serialization.ExitProcessHelper();
