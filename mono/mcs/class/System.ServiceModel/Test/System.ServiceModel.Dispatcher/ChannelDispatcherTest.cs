...
namespace MonoTests.System.ServiceModel.Dispatcher
{
    ...
    public class ChannelDispatcherTest
    {
        ...
        {
            var cd = new ChannelDispatcher(
                new MyChannelListener<IReplyChannel>(new Uri("urn:foo"))
            );
...
*/
        ...
        public void EndpointDispatcherAddTest9() // test singleton service
        {
            ...
            h.Description.Behaviors.Find<ServiceBehaviorAttribute>().InstanceContextMode =
        ...
        class MyChannelDispatcher : ChannelDispatcher
        {
            ...
            public MyChannelDispatcher(IChannelListener l)
                : base(l) { }
        ...
        class MyChannelListener<TChannel> : MyChannelListener, IChannelListener<TChannel>
