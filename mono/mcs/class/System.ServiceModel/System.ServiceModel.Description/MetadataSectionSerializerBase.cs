...
namespace System.ServiceModel.Description
{
    internal class MetadataSectionReaderBase : XmlSerializationReader
    {
        public object ReadRoot_MetadataSection()
        {
            ...
            if (
                Reader.LocalName != "MetadataSection"
        ...
        public System.ServiceModel.Description.MetadataSection ReadObject_MetadataSection(
            bool isNullable,
            bool checkType
        )
        {
            ...
            if (checkType)
            {
                ...
                if (t == null) { }
                    ...
                    t.Name != "MetadataSection"
                    || t.Namespace != "http://schemas.xmlsoap.org/ws/2004/09/mex"
                )
            ...
            System.Collections.ObjectModel.Collection<System.Xml.XmlAttribute> anyAttributeArray =
                null;
            while (Reader.MoveToNextAttribute())
            {
                ...
                else
                {
                    ...
                    if (((object)anyAttributeArray) == null)
                        anyAttributeArray =
                            new System.Collections.ObjectModel.Collection<System.Xml.XmlAttribute>();
            ...
            while (Reader.NodeType != System.Xml.XmlNodeType.EndElement)
            {
                if (Reader.NodeType == System.Xml.XmlNodeType.Element)
                {
                    ...
                    )
                    {
                        b0 = true;
                        ob.@Metadata = (
                            (System.ServiceModel.Description.MetadataSet)ReadSerializable(
                                new System.ServiceModel.Description.MetadataSet()
                            )
                        );
                    }
                    else if (
                    ...
                    )
                    {
                        b0 = true;
                        ob.@Metadata = (
                            (System.ServiceModel.Description.MetadataReference)ReadSerializable(
                                new System.ServiceModel.Description.MetadataReference()
                            )
                        );
                    }
                    else if (
        ...
        public System.ServiceModel.Description.MetadataLocation ReadObject_MetadataLocation(
            bool isNullable,
            bool checkType
        )
        {
        ...
        )
        {
            ...
            ob = (System.Web.Services.Description.ServiceDescription)
                System.Web.Services.Description.ServiceDescription.Serializer.Deserialize(Reader);
            return ob;
        }
    ...
    internal class MetadataSectionWriterBase : XmlSerializationWriter
    {
        ...
        {
            WriteStartDocument();
            System.ServiceModel.Description.MetadataSection ob =
                (System.ServiceModel.Description.MetadataSection)o;
            TopLevelElement();
            WriteObject_MetadataSection(
                ob,
                "MetadataSection",
        ...
        void WriteObject_MetadataSection(
            System.ServiceModel.Description.MetadataSection ob,
            string element,
            string namesp,
            bool isNullable,
        ...
        )
        {
            ...
            {
                WriteSerializable(
                    ((System.ServiceModel.Description.MetadataReference)ob.@Metadata),
                    "MetadataReference",
                    "http://schemas.xmlsoap.org/ws/2004/09/mex",
                    false
                );
            ...
            else if (ob.@Metadata is System.Web.Services.Description.ServiceDescription)
            {
                WriteObject_ServiceDescription(
                    ((System.Web.Services.Description.ServiceDescription)ob.@Metadata),
                    "definitions",
            ...
            else if (ob.@Metadata is System.Xml.Schema.XmlSchema)
            {
                WriteObject_XmlSchema(
                    ((System.Xml.Schema.XmlSchema)ob.@Metadata),
                    "schema",
            ...
            {
                WriteSerializable(
                    ((System.ServiceModel.Description.MetadataSet)ob.@Metadata),
                    "Metadata",
                    "http://schemas.xmlsoap.org/ws/2004/09/mex",
                    false
                );
            ...
            else if (ob.@Metadata is System.ServiceModel.Description.MetadataLocation)
            {
                WriteObject_MetadataLocation(
                    ((System.ServiceModel.Description.MetadataLocation)ob.@Metadata),
                    "Location",
                    "http://schemas.xmlsoap.org/ws/2004/09/mex",
                    false,
                    false,
            ...
            {
                WriteElementLiteral(
                    ((System.Xml.XmlElement)ob.@Metadata),
                    "",
                    "http://schemas.xmlsoap.org/ws/2004/09/mex",
                    false,
                    false
        ...
        void WriteObject_MetadataLocation(
            System.ServiceModel.Description.MetadataLocation ob,
            string element,
            string namesp,
            bool isNullable,
            bool needType,
        ...
        )
        {
            ...
            if (ob.@DocumentationElement != null)
            {
                ...
                if (o14 is XmlElement)
                {
                    if (
                        (
                            o14.LocalName == "documentation"
                            && o14.NamespaceURI == "http://schemas.xmlsoap.org/wsdl/"
                        )
                    ) { }
                    else
                        o14.WriteTo(Writer);
        ...
        )
        {
            ...
            if (ob.@DocumentationElement != null)
            {
                ...
                if (o17 is XmlElement)
                {
                    if (
                        (
                            o17.LocalName == "documentation"
                            && o17.NamespaceURI == "http://schemas.xmlsoap.org/wsdl/"
                        )
                    ) { }
                    else
                        o17.WriteTo(Writer);
        ...
        )
        {
            ...
            if (ob.@DocumentationElement != null)
            {
                ...
                if (o21 is XmlElement)
                {
                    if (
                        (
                            o21.LocalName == "documentation"
                            && o21.NamespaceURI == "http://schemas.xmlsoap.org/wsdl/"
                        )
                    ) { }
                    else
                        o21.WriteTo(Writer);
        ...
        )
        {
            ...
            if (ob.@DocumentationElement != null)
            {
                ...
                if (o25 is XmlElement)
                {
                    if (
                        (
                            o25.LocalName == "documentation"
                            && o25.NamespaceURI == "http://schemas.xmlsoap.org/wsdl/"
                        )
                    ) { }
                    else
                        o25.WriteTo(Writer);
        ...
        )
        {
            ...
            if (ob.@DocumentationElement != null)
            {
                ...
                if (o29 is XmlElement)
                {
                    if (
                        (
                            o29.LocalName == "documentation"
                            && o29.NamespaceURI == "http://schemas.xmlsoap.org/wsdl/"
                        )
                    ) { }
                    else
                        o29.WriteTo(Writer);
        ...
        )
        {
            ...
            if (ob.@DocumentationElement != null)
            {
                ...
                if (o33 is XmlElement)
                {
                    if (
                        (
                            o33.LocalName == "documentation"
                            && o33.NamespaceURI == "http://schemas.xmlsoap.org/wsdl/"
                        )
                    ) { }
                    else
                        o33.WriteTo(Writer);
        ...
        )
        {
            ...
            if (ob.@DocumentationElement != null)
            {
                ...
                if (o37 is XmlElement)
                {
                    if (
                        (
                            o37.LocalName == "documentation"
                            && o37.NamespaceURI == "http://schemas.xmlsoap.org/wsdl/"
                        )
                    ) { }
                    else
                        o37.WriteTo(Writer);
        ...
        )
        {
            ...
            if (ob.@DocumentationElement != null)
            {
                ...
                if (o40 is XmlElement)
                {
                    if (
                        (
                            o40.LocalName == "documentation"
                            && o40.NamespaceURI == "http://schemas.xmlsoap.org/wsdl/"
                        )
                    ) { }
                    else
                        o40.WriteTo(Writer);
            ...
            if (ob.@Messages != null)
            {
                for (int n42 = 0; n42 < ob.@Messages.Count; n42++)
                {
                    if (((object)ob.@Messages[n42]) == null) { }
                        ...
                        ob.@Messages[n42].GetType()
                        == typeof(System.Web.Services.Description.OperationInput)
                    )
                    {
                        WriteObject_OperationInput(
                            ((System.Web.Services.Description.OperationInput)ob.@Messages[n42]),
                            "input",
                            "http://schemas.xmlsoap.org/wsdl/",
                            false,
                            false,
                    ...
                    )
                    {
                        WriteObject_OperationOutput(
                            ((System.Web.Services.Description.OperationOutput)ob.@Messages[n42]),
                            "output",
                            "http://schemas.xmlsoap.org/wsdl/",
                            false,
                            false,
                        ...
                        throw CreateUnknownTypeException(ob.@Messages[n42]);
                }
            }
            if (writeWrappingElem)
                WriteEndElement(ob);
        ...
        )
        {
            ...
            if (ob.@DocumentationElement != null)
            {
                ...
                if (o45 is XmlElement)
                {
                    if (
                        (
                            o45.LocalName == "documentation"
                            && o45.NamespaceURI == "http://schemas.xmlsoap.org/wsdl/"
                        )
                    ) { }
                    else
                        o45.WriteTo(Writer);
        ...
        )
        {
            ...
            if (ob.@DocumentationElement != null)
            {
                ...
                if (o49 is XmlElement)
                {
                    if (
                        (
                            o49.LocalName == "documentation"
                            && o49.NamespaceURI == "http://schemas.xmlsoap.org/wsdl/"
                        )
                    ) { }
                    else
                        o49.WriteTo(Writer);
        ...
        )
        {
            ...
            if (ob.@DocumentationElement != null)
            {
                ...
                if (o52 is XmlElement)
                {
                    if (
                        (
                            o52.LocalName == "documentation"
                            && o52.NamespaceURI == "http://schemas.xmlsoap.org/wsdl/"
                        )
                    ) { }
                    else
                        o52.WriteTo(Writer);
        ...
        )
        {
            ...
            if (ob.@DocumentationElement != null)
            {
                ...
                if (o55 is XmlElement)
                {
                    if (
                        (
                            o55.LocalName == "documentation"
                            && o55.NamespaceURI == "http://schemas.xmlsoap.org/wsdl/"
                        )
                    ) { }
                    else
                        o55.WriteTo(Writer);
        ...
        )
        {
            ...
            if (ob.@DocumentationElement != null)
            {
                ...
                if (o58 is XmlElement)
                {
                    if (
                        (
                            o58.LocalName == "documentation"
                            && o58.NamespaceURI == "http://schemas.xmlsoap.org/wsdl/"
                        )
                    ) { }
                    else
                        o58.WriteTo(Writer);
        ...
        )
        {
            ...
            if (ob.@DocumentationElement != null)
            {
                ...
                if (o64 is XmlElement)
                {
                    if (
                        (
                            o64.LocalName == "documentation"
                            && o64.NamespaceURI == "http://schemas.xmlsoap.org/wsdl/"
                        )
                    ) { }
                    else
                        o64.WriteTo(Writer);
        ...
        )
        {
            ...
            if (ob.@DocumentationElement != null)
            {
                ...
                if (o67 is XmlElement)
                {
                    if (
                        (
                            o67.LocalName == "documentation"
                            && o67.NamespaceURI == "http://schemas.xmlsoap.org/wsdl/"
                        )
                    ) { }
                    else
                        o67.WriteTo(Writer);
    ...
    internal class XmlSerializerContract : System.Xml.Serialization.XmlSerializerImplementation
    {
        ...
        {
            get { return new MetadataSectionReaderBase(); }
        }

        public override System.Xml.Serialization.XmlSerializationWriter Writer
        {
            get { return new MetadataSectionWriterBase(); }
        }
