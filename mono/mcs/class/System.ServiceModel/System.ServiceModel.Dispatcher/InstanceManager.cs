...
namespace System.ServiceModel.Dispatcher
{
    internal class InstanceManager
    {
        ...
        internal void Initialize(InstanceContext iCtx)
        {
            ...
            {
                dispatch_runtime.InstanceContextProvider.InitializeInstanceContext(
                    iCtx,
                    message,
                    channel
                );
            ...
            foreach (
                IInstanceContextInitializer init in dispatch_runtime.InstanceContextInitializers
            )
                init.Initialize(iCtx, message);
        }

        internal object GetServiceInstance(
            InstanceContext ctx,
            Message m,
            ref bool createdByUserProvider
        )
        {
        ...
        {
            get { return dispatch_runtime.InstanceContextProvider; }
        }
