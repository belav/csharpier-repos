    ...
    internal static class SecurityUtil
    {
        ...
        private static Action<Action> GetCallInAppTrustThunk()
        {
            ...
            if (_callInAppTrustThunk == null)
            {
                ...
                {
                    if (
                        !typeof(SecurityUtil).Assembly.IsFullyTrusted /* bin-deployed */
                    ...
                    else
                    {
                        ...
                        NamedPermissionSet namedPermissionSet = (NamedPermissionSet)
                            typeof(HttpRuntime)
                                .GetProperty(
                                    "NamedPermissionSet",
                                ...
                                .GetValue(null, null);
                        bool disableProcessRequestInApplicationTrust = (bool)
                            typeof(HttpRuntime)
                                .GetProperty(
                                    "DisableProcessRequestInApplicationTrust",
                                    BindingFlags.NonPublic
                                        | BindingFlags.Public
                                        | BindingFlags.Static
                                )
