namespace System.Web.Mvc.Async
{
    ...
    internal static class AsyncResultWrapper
    {
        ...
        {
            return Begin<AsyncVoid>(
                callback,
                state,
                beginDelegate,
                MakeVoidDelegate(endDelegate),
                tag,
                timeout
            );
        }
        ...
        {
            return BeginSynchronous<TResult>(
                callback,
                state,
                func,
                null /* tag */
