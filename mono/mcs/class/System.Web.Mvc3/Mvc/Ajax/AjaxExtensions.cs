namespace System.Web.Mvc.Ajax
{
    ...
    public static class AjaxExtensions
    {
        ...
        private const string _globalizationScript =
        ...
        private static MvcHtmlString GlobalizationScriptHelper(
            string scriptPath,
            CultureInfo cultureInfo
        )
        {
            ...
            string src =
                VirtualPathUtility.AppendTrailingSlash(scriptPath) + cultureInfo.Name + ".js";
