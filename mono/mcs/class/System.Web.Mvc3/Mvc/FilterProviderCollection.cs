namespace System.Web.Mvc
{
    ...
    public class FilterProviderCollection : Collection<IFilterProvider>
    {
        ...
        {
            _serviceResolver =
                serviceResolver ?? new MultiServiceResolver<IFilterProvider>(() => Items);
        }
        ...
        )
        {
            ...
            IEnumerable<Filter> combinedFilters = CombinedItems
                .SelectMany(fp => fp.GetFilters(controllerContext, actionDescriptor))
