namespace System.Web.Mvc.Html
{
    ...
    internal static class DefaultEditorTemplates
    {
        ...
        {
            return html.CheckBox(String.Empty, value, CreateHtmlAttributes("check-box"))
                .ToHtmlString();
        }
        ...
        internal static string MultilineTextTemplate(HtmlHelper html)
        {
            return html.TextArea(
                    ...
                    0 /* columns */
                    ,
                    CreateHtmlAttributes("text-box multi-line")
                )
                .ToHtmlString();
        }
        ...
        {
            return new Dictionary<string, object>() { { "class", className } };
        }
        ...
        )
        {
            ...
            )
            {
                ...
                {
                    string label = LabelExtensions
                        .LabelHelper(html, propertyMetadata, propertyMetadata.PropertyName)
                        .ToHtmlString();
