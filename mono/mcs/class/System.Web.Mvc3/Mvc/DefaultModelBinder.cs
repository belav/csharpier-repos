namespace System.Web.Mvc
{
    ...
    public class DefaultModelBinder : IModelBinder
    {
        ...
        {
            IEnumerable<PropertyDescriptor> properties = GetFilteredModelProperties(
                controllerContext,
                bindingContext
            );
        ...
        )
        {
            ...
            foreach (string currentIndex in indexes)
            {
                ...
                ModelBindingContext valueBindingContext = new ModelBindingContext()
                {
                    ModelMetadata = ModelMetadataProviders
                        .Current
                        .GetMetadataForType(null, valueType),
                ...
                KeyValuePair<object, object> kvp = new KeyValuePair<object, object>(
                    thisKey,
                    thisValue
                );
                modelList.Add(kvp);
