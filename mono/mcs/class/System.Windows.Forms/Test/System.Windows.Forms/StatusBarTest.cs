...
namespace MonoTests.System.Windows.Forms
{
    ...
    public class StatusBarTest : TestHelper
    {
        ...
        public void ToStringMethodTest()
        {
            ...
            Assert.AreEqual(
                "System.Windows.Forms.StatusBar, Panels.Count: 0",
                mysbar.ToString(),
                "#T3"
            );
        }
    ...
    public class StatusBarPanelCollectionTest : TestHelper
    {
        ...
        public void DefaultPropertiesTest()
        {
            ...
            StatusBar.StatusBarPanelCollection collection = new StatusBar.StatusBarPanelCollection(
                bar
            );
        ...
        public void Interface_AddRemoveTest()
        {
            ...
            //
            StatusBar bar = new StatusBar();
            StatusBar.StatusBarPanelCollection collectionX = new StatusBar.StatusBarPanelCollection(
                bar
            );
