// Automatically generated for assembly: System.Windows.Forms, Version=2.0.0.0, Culture=neutral,
// PublicKeyToken=b77a5c561934e089
// To regenerate:
// gmcs -r:System.Windows.Forms.dll LogGenerator.cs && mono LogGenerator.exe
// System.Windows.Forms.Control overrides ControlLogger2.cs
...
namespace MonoTests.System.Windows.Forms
{
    public class ControlOverrideLogger : Control
    {
        ...
        {
            ShowLocation(
                string.Format("NotifyInvalidate (invalidatedArea=<{0}>) ", invalidatedArea)
            );
        ...
        {
            ShowLocation(
                string.Format("Select (directed=<{0}>, forward=<{1}>) ", directed, forward)
            );
        ...
        )
        {
            ShowLocation(
                string.Format(
                    "SetBoundsCore (x=<{0}>, y=<{1}>, width=<{2}>, height=<{3}>, specified=<{4}>) ",
                    x,
                    y,
                    width,
                    height,
