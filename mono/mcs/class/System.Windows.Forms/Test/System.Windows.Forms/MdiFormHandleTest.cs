...
namespace MonoTests.System.Windows.Forms
{
    ...
    public class MdiFormHandleTest : TestHelper
    {
        ...
        public void TestPublicProperties()
        {
            ...
            child1.AutoScrollMargin = new Size(
                child1.AutoScrollMargin.Width + 1,
                child1.AutoScrollMargin.Height + 1
            );
            Assert.IsFalse(child1.IsHandleCreated, "FA8");

            SetUp();
            o = child1.AutoScrollMinSize;
            child1.AutoScrollMinSize = new Size(
                child1.AutoScrollMinSize.Width + 1,
                child1.AutoScrollMinSize.Height + 1
            );
            ...
            SetUp();
            o = child1.AutoScrollOffset;
            child1.AutoScrollOffset = new Point(
                child1.AutoScrollOffset.X + 1,
                child1.AutoScrollOffset.Y + 1
            );
            ...
            child1.AutoScrollPosition = new Point(
                child1.AutoScrollPosition.X + 1,
                child1.AutoScrollPosition.Y + 1
            );
            ...
            child1.DesktopBounds = new Rectangle(
                3,
                5,
                child1.DesktopBounds.Width + 1,
                child1.DesktopBounds.Height + 1
            );
        ...
        public void TestProtectedMethods()
        {
            ...
            SetUp();
            child1.PublicInvokePaintBackground(
                child1,
                new PaintEventArgs(Graphics.FromImage(new Bitmap(1, 1)), Rectangle.Empty)
            );
            Assert.IsFalse(child1.IsHandleCreated, "A16");
        ...
        {
            // Properties
            public SizeF PublicAutoScaleFactor
            {
            ...
            public EventHandlerList PublicEvents
            {
            ...
            public Rectangle PublicMaximizedBounds
            {
                get { return base.MaximizedBounds; }
                set { base.MaximizedBounds = value; }
            }
            ...
            public bool PublicShowWithoutActivation
            {
                get { return base.ShowWithoutActivation; }
            }
            ...
            public void PublicActivateMdiChild(Form form)
            {
                base.ActivateMdiChild(form);
            }

            public void PublicAdjustFormScrollbars(bool displayScrollbars)
            {
                base.AdjustFormScrollbars(displayScrollbars);
            }

            public void PublicCenterToParent()
            {
                base.CenterToParent();
            }

            public void PublicCenterToScreen()
            {
                base.CenterToScreen();
            }
            ...
            public bool PublicGetScrollState(int bit)
            {
                return base.GetScrollState(bit);
            }

            public object PublicGetService(Type service)
            {
            ...
            public void PublicProcessCmdKey(ref Message msg, Keys keyData)
            {
                base.ProcessCmdKey(ref msg, keyData);
            }

            public void PublicProcessDialogChar(char charCode)
            {
                base.ProcessDialogChar(charCode);
            }

            public void PublicProcessDialogKey(Keys keyData)
            {
                base.ProcessDialogKey(keyData);
            }

            public void PublicProcessKeyEventArgs(ref Message m)
            {
                base.ProcessKeyEventArgs(ref m);
            }

            public void PublicProcessKeyMessage(ref Message m)
            {
                base.ProcessKeyMessage(ref m);
            }

            public void PublicProcessKeyPreview(ref Message m)
            {
                base.ProcessKeyPreview(ref m);
            }

            public void PublicProcessMnemonic(char charCode)
            {
                base.ProcessMnemonic(charCode);
            }

            public void PublicProcessTabKey(bool forward)
            {
...
#if !MONO
            public void PublicScrollToControl(Control activeControl)
            {
                base.ScrollToControl(activeControl);
            }
#endif
            ...
            public void PublicSelect(bool directed, bool forward)
            {
            ...
            public void PublicSetDisplayRectLocation(int x, int y)
            {
            ...
            public void PublicUpdateDefaultButton(int bit, bool value)
            {
