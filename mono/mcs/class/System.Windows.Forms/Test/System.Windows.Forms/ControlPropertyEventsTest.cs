...
namespace MonoTests.System.Windows.Forms
{
    ...
    public class ControlPropertyEventsTest : TestHelper
    {
        ...
        public void PropertyClientSize()
        {
            ...
            Assert.AreEqual(
                "Layout;Resize;SizeChanged;ClientSizeChanged;ClientSizeChanged",
                ew.ToString(),
                "B2"
            );
        ...
        private class EventWatcher
        {
            ...
            {
                c.AutoSizeChanged += new EventHandler(
                    delegate(Object obj, EventArgs e)
                    {
                        events += ("AutoSizeChanged;");
                    }
                );
                c.BackColorChanged += new EventHandler(
                    delegate(Object obj, EventArgs e)
                    {
                        events += ("BackColorChanged;");
                    }
                );
                c.BackgroundImageChanged += new EventHandler(
                    delegate(Object obj, EventArgs e)
                    {
                        events += ("BackgroundImageChanged;");
                    }
                );
                c.BackgroundImageLayoutChanged += new EventHandler(
                    delegate(Object obj, EventArgs e)
                    {
                        events += ("BackgroundImageLayoutChanged;");
                    }
                );
                c.BindingContextChanged += new EventHandler(
                    delegate(Object obj, EventArgs e)
                    {
                        events += ("BindingContextChanged;");
                    }
                );
                c.CausesValidationChanged += new EventHandler(
                    delegate(Object obj, EventArgs e)
                    {
                        events += ("CausesValidationChanged;");
                    }
                );
                c.ChangeUICues += new UICuesEventHandler(
                    delegate(Object obj, UICuesEventArgs e)
                    {
                        events += ("ChangeUICues;");
                    }
                );
                ...
                c.ClientSizeChanged += new EventHandler(
                    delegate(Object obj, EventArgs e)
                    {
                        events += ("ClientSizeChanged;");
                    }
                );
                c.ContextMenuChanged += new EventHandler(
                    delegate(Object obj, EventArgs e)
                    {
                        events += ("ContextMenuChanged;");
                    }
                );
                c.ContextMenuStripChanged += new EventHandler(
                    delegate(Object obj, EventArgs e)
                    {
                        events += ("ContextMenuStripChanged;");
                    }
                );
                c.ControlAdded += new ControlEventHandler(
                    delegate(Object obj, ControlEventArgs e)
                    {
                        events += ("ControlAdded;");
                    }
                );
                c.ControlRemoved += new ControlEventHandler(
                    delegate(Object obj, ControlEventArgs e)
                    {
                        events += ("ControlRemoved;");
                    }
                );
                c.CursorChanged += new EventHandler(
                    delegate(Object obj, EventArgs e)
                    {
                        events += ("CursorChanged;");
                    }
                );
                c.DockChanged += new EventHandler(
                    delegate(Object obj, EventArgs e)
                    {
                        events += ("DockChanged;");
                    }
                );
                c.DoubleClick += new EventHandler(
                    delegate(Object obj, EventArgs e)
                    {
                        events += ("DoubleClick;");
                    }
                );
                c.DragDrop += new DragEventHandler(
                    delegate(Object obj, DragEventArgs e)
                    {
                        events += ("DragDrop;");
                    }
                );
                c.DragEnter += new DragEventHandler(
                    delegate(Object obj, DragEventArgs e)
                    {
                        events += ("DragEnter;");
                    }
                );
                c.DragLeave += new EventHandler(
                    delegate(Object obj, EventArgs e)
                    {
                        events += ("DragLeave;");
                    }
                );
                c.DragOver += new DragEventHandler(
                    delegate(Object obj, DragEventArgs e)
                    {
                        events += ("DragOver;");
                    }
                );
                c.EnabledChanged += new EventHandler(
                    delegate(Object obj, EventArgs e)
                    {
                        events += ("EnabledChanged;");
                    }
                );
                c.Enter += new EventHandler(
                    delegate(Object obj, EventArgs e)
                    {
                        events += ("Enter;");
                    }
                );
                c.FontChanged += new EventHandler(
                    delegate(Object obj, EventArgs e)
                    {
                        events += ("FontChanged;");
                    }
                );
                c.ForeColorChanged += new EventHandler(
                    delegate(Object obj, EventArgs e)
                    {
                        events += ("ForeColorChanged;");
                    }
                );
                c.GiveFeedback += new GiveFeedbackEventHandler(
                    delegate(Object obj, GiveFeedbackEventArgs e)
                    {
                        events += ("GiveFeedback;");
                    }
                );
                c.GotFocus += new EventHandler(
                    delegate(Object obj, EventArgs e)
                    {
                        events += ("GotFocus;");
                    }
                );
                c.HandleCreated += new EventHandler(
                    delegate(Object obj, EventArgs e)
                    {
                        events += ("HandleCreated;");
                    }
                );
                c.HandleDestroyed += new EventHandler(
                    delegate(Object obj, EventArgs e)
                    {
                        events += ("HandleDestroyed;");
                    }
                );
                c.ImeModeChanged += new EventHandler(
                    delegate(Object obj, EventArgs e)
                    {
                        events += ("ImeModeChanged;");
                    }
                );
                c.Invalidated += new InvalidateEventHandler(
                    delegate(Object obj, InvalidateEventArgs e)
                    {
                        events += ("Invalidated;");
                    }
                );
                c.KeyDown += new KeyEventHandler(
                    delegate(Object obj, KeyEventArgs e)
                    {
                        events += ("KeyDown;");
                    }
                );
                c.KeyPress += new KeyPressEventHandler(
                    delegate(Object obj, KeyPressEventArgs e)
                    {
                        events += ("KeyPress;");
                    }
                );
                c.KeyUp += new KeyEventHandler(
                    delegate(Object obj, KeyEventArgs e)
                    {
                        events += ("KeyUp;");
                    }
                );
                c.Layout += new LayoutEventHandler(
                    delegate(Object obj, LayoutEventArgs e)
                    {
                        events += ("Layout;");
                    }
                );
                c.Leave += new EventHandler(
                    delegate(Object obj, EventArgs e)
                    {
                        events += ("Leave;");
                    }
                );
                c.LocationChanged += new EventHandler(
                    delegate(Object obj, EventArgs e)
                    {
                        events += ("LocationChanged;");
                    }
                );
                c.LostFocus += new EventHandler(
                    delegate(Object obj, EventArgs e)
                    {
                        events += ("LostFocus;");
                    }
                );
                c.MarginChanged += new EventHandler(
                    delegate(Object obj, EventArgs e)
                    {
                        events += ("MarginChanged;");
                    }
                );
                c.MouseCaptureChanged += new EventHandler(
                    delegate(Object obj, EventArgs e)
                    {
                        events += ("MouseCaptureChanged;");
                    }
                );
                c.MouseClick += new MouseEventHandler(
                    delegate(Object obj, MouseEventArgs e)
                    {
                        events += ("MouseClick;");
                    }
                );
                c.MouseDoubleClick += new MouseEventHandler(
                    delegate(Object obj, MouseEventArgs e)
                    {
                        events += ("MouseDoubleClick;");
                    }
                );
                ...
                c.MouseEnter += new EventHandler(
                    delegate(Object obj, EventArgs e)
                    {
                        events += ("MouseEnter;");
                    }
                );
                c.MouseLeave += new EventHandler(
                    delegate(Object obj, EventArgs e)
                    {
                        events += ("MouseLeave;");
                    }
                );
                c.MouseMove += new MouseEventHandler(
                    delegate(Object obj, MouseEventArgs e)
                    {
                        events += ("MouseMove;");
                    }
                );
                c.MouseUp += new MouseEventHandler(
                    delegate(Object obj, MouseEventArgs e)
                    {
                        events += ("MouseUp;");
                    }
                );
                c.MouseWheel += new MouseEventHandler(
                    delegate(Object obj, MouseEventArgs e)
                    {
                        events += ("MouseWheel;");
                    }
                );
                c.Move += new EventHandler(
                    delegate(Object obj, EventArgs e)
                    {
                        events += ("Move;");
                    }
                );
                c.PaddingChanged += new EventHandler(
                    delegate(Object obj, EventArgs e)
                    {
                        events += ("PaddingChanged;");
                    }
                );
                c.Paint += new PaintEventHandler(
                    delegate(Object obj, PaintEventArgs e)
                    {
                        events += ("Paint;");
                    }
                );
                c.ParentChanged += new EventHandler(
                    delegate(Object obj, EventArgs e)
                    {
                        events += ("ParentChanged;");
                    }
                );
                c.PreviewKeyDown += new PreviewKeyDownEventHandler(
                    delegate(Object obj, PreviewKeyDownEventArgs e)
                    {
                        events += ("PreviewKeyDown;");
                    }
                );
                c.QueryAccessibilityHelp += new QueryAccessibilityHelpEventHandler(
                    delegate(Object obj, QueryAccessibilityHelpEventArgs e)
                    {
                        events += ("QueryAccessibilityHelp;");
                    }
                );
                c.QueryContinueDrag += new QueryContinueDragEventHandler(
                    delegate(Object obj, QueryContinueDragEventArgs e)
                    {
                        events += ("QueryContinueDrag;");
                    }
                );
                c.RegionChanged += new EventHandler(
                    delegate(Object obj, EventArgs e)
                    {
                        events += ("RegionChanged;");
                    }
                );
                c.Resize += new EventHandler(
                    delegate(Object obj, EventArgs e)
                    {
                        events += ("Resize;");
                    }
                );
                c.RightToLeftChanged += new EventHandler(
                    delegate(Object obj, EventArgs e)
                    {
                        events += ("RightToLeftChanged;");
                    }
                );
                c.SizeChanged += new EventHandler(
                    delegate(Object obj, EventArgs e)
                    {
                        events += ("SizeChanged;");
                    }
                );
                c.StyleChanged += new EventHandler(
                    delegate(Object obj, EventArgs e)
                    {
                        events += ("StyleChanged;");
                    }
                );
                c.SystemColorsChanged += new EventHandler(
                    delegate(Object obj, EventArgs e)
                    {
                        events += ("SystemColorsChanged;");
                    }
                );
                c.TabIndexChanged += new EventHandler(
                    delegate(Object obj, EventArgs e)
                    {
                        events += ("TabIndexChanged;");
                    }
                );
                c.TabStopChanged += new EventHandler(
                    delegate(Object obj, EventArgs e)
                    {
                        events += ("TabStopChanged;");
                    }
                );
                c.TextChanged += new EventHandler(
                    delegate(Object obj, EventArgs e)
                    {
                        events += ("TextChanged;");
                    }
                );
                c.Validated += new EventHandler(
                    delegate(Object obj, EventArgs e)
                    {
                        events += ("Validated;");
                    }
                );
                c.Validating += new CancelEventHandler(
                    delegate(Object obj, CancelEventArgs e)
                    {
                        events += ("Validating;");
                    }
                );
                c.VisibleChanged += new EventHandler(
                    delegate(Object obj, EventArgs e)
                    {
        ...
        private class ExposeProtectedProperties : Control
        {
            ...
            public new Size DefaultMaximumSize
            {
                get { return base.DefaultMaximumSize; }
            }
            public new Size DefaultMinimumSize
            {
