...
namespace MonoTests.System.Windows.Forms
{
    ...
    public class RichTextBoxTest : TestHelper
    {
        ...
        public void FindTest()
        {
            ...
            Assert.AreEqual(
                t.Find("blah", 10, 73, RichTextBoxFinds.Reverse | RichTextBoxFinds.MatchCase),
                62,
                "Find10"
            );
            ...
            Assert.AreEqual(
                t.Find("blah", 10, RichTextBoxFinds.Reverse | RichTextBoxFinds.MatchCase),
                62,
                "Find15"
            );
            ...
            Assert.AreEqual(
                t.Find("Testtext", RichTextBoxFinds.WholeWord | RichTextBoxFinds.Reverse),
                0,
                "Find24"
            ); // First word in document, searched in reverse
        }
