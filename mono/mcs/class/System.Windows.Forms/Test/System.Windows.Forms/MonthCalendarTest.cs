...
namespace MonoTests.System.Windows.Forms
{
    ...
    public class MonthCalendarTest : TestHelper
    {
        ...
        public void MonthCalendarPropertyTest()
        {
            ...
            Assert.AreEqual(
                new DateTime(2005, 09, 01),
                myMonthCal1.AnnuallyBoldedDates.GetValue(0),
                "#A1"
            );
            ...
            Assert.AreEqual(
                new DateTime(2005, 09, 01),
                myMonthCal1.MonthlyBoldedDates.GetValue(0),
                "#M4"
            );
        ...
        {
            MonthCalendar myMonthCal1 = new MonthCalendar();
            myMonthCal1.SelectionRange = new SelectionRange(
                new DateTime(1752, 01, 01),
                new DateTime(1752, 01, 02)
            );
        }
        ...
        public void AddAnnuallyBoldedDateTest()
        {
            ...
            Assert.AreEqual(
                new DateTime(2005, 09, 01),
                myMonthCal.AnnuallyBoldedDates.GetValue(0),
                "#add1"
            );
            ...
            for (int i = 0; i < dts.Length; i++)
            {
                for (int j = 0; j < dts.Length; j++)
                {
                    ...
                    if (dts[j].Month == dts[i].Month && dts[j].Day == dts[i].Day)
                        Assert.AreEqual(
                            0,
                            myMonthCal.AnnuallyBoldedDates.Length,
                            "#remove0" + i.ToString() + ", " + j.ToString()
                        );
                    else
                        Assert.AreEqual(
                            1,
            ...
            for (int i = 0; i < dts.Length; i++)
            {
                for (int j = 0; j < dts.Length; j++)
                {
                    ...
                    if (dts[j].Month == dts[i].Month && dts[j].Day == dts[i].Day)
                        Assert.AreEqual(
                            0,
                            myMonthCal.MonthlyBoldedDates.Length,
                            "#remove0" + i.ToString() + ", " + j.ToString()
                        );
                    else
                        Assert.AreEqual(
        ...
        public void RemoveBoldedDateTest()
        {
            ...
            for (int i = 0; i < dts.Length; i++)
            {
                for (int j = 0; j < dts.Length; j++)
                {
                    ...
                    if (
                        dts[j].Month == dts[i].Month
                        && dts[j].Day == dts[i].Day
                        && dts[j].Year == dts[i].Year
                    )
                        Assert.AreEqual(
                            0,
                            myMonthCal.BoldedDates.Length,
                            "#remove0" + i.ToString() + ", " + j.ToString()
                        );
                    else
                        Assert.AreEqual(
        ...
        public void AddBoldedDateTest()
        {
            ...
            Assert.AreEqual(
                ...
                myMonthCal.BoldedDates.GetValue(0),
                "#add2"
            );
            myForm.Dispose();
        }
        ...
        public void AddMonthlyBoldedDateTest()
        {
            ...
            myForm.Controls.Add(myMonthCal);
            Assert.AreEqual(
                new DateTime(2005, 09, 03),
                myMonthCal.MonthlyBoldedDates.GetValue(0),
                "#add2"
            );
            myForm.Dispose();
        }
