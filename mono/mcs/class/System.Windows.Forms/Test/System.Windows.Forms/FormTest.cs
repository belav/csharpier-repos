    ...
    public class FormTest : TestHelper
    {
        ...
        public void bug_82358()
        {
            ...
            using (Form f = new Form())
            {
                ...
                Assert.AreEqual(
                    new Size(
                        size.Width + tool_border,
                        size.Height + tool_border + tool_bar
                    ).ToString(),
                    f.Size.ToString(),
                    style.ToString() + "-A2"
                );
            ...
            using (Form f = new Form())
            {
                ...
                Assert.AreEqual(
                    new Size(
                        size.Width + tool_border + sizeable_factor,
                        size.Height + tool_border + tool_bar + sizeable_factor
                    ).ToString(),
                    f.Size.ToString(),
                    style.ToString() + "-A2"
                );
            ...
            using (Form f = new Form())
            {
                ...
                Assert.AreEqual(size.ToString(), f.ClientSize.ToString(), style.ToString() + "-A1");
                Assert.AreEqual(
                    new Size(size.Width + d3, size.Height + title_bar + d3).ToString(),
                    f.Size.ToString(),
                    style.ToString() + "-A2"
                );
                f.Visible = true;
            ...
            using (Form f = new Form())
            {
                ...
                Assert.AreEqual(size.ToString(), f.ClientSize.ToString(), style.ToString() + "-A1");
                Assert.AreEqual(
                    new Size(size.Width + d2, size.Height + title_bar + d2).ToString(),
                    f.Size.ToString(),
                    style.ToString() + "-A2"
                );
                f.Visible = true;
            ...
            using (Form f = new Form())
            {
                ...
                Assert.AreEqual(
                    new Size(
                        size.Width + d2 + sizeable_factor,
                        size.Height + title_bar + d2 + sizeable_factor
                    ).ToString(),
                    f.Size.ToString(),
                    style.ToString() + "-A2"
                );
            ...
            using (Form f = new Form())
            {
                ...
                Assert.AreEqual(
                    new Size(
                        size.Width - d2 - sizeable_factor + tool_border,
                        size.Height - title_bar - d2 - sizeable_factor + tool_border + tool_bar
                    ).ToString(),
                    f.Size.ToString(),
                    style.ToString() + "-E1"
                );
            ...
            using (Form f = new Form())
            {
                ...
                Assert.AreEqual(
                    new Size(
                        size.Width - d2 - sizeable_factor + tool_border + sizeable_factor,
                        size.Height
                            - title_bar
                            - d2
                            - sizeable_factor
            ...
            using (Form f = new Form())
            {
                ...
                Assert.AreEqual(
                    new Size(
                        size.Width - d2 - sizeable_factor + d3,
                        size.Height - title_bar - d2 - sizeable_factor + title_bar + d3
                    ).ToString(),
                    f.Size.ToString(),
                    style.ToString() + "-E1"
                );
            ...
            using (Form f = new Form())
            {
                ...
                Assert.AreEqual(
                    new Size(
                        size.Width - d2 - sizeable_factor + d2,
                        size.Height - title_bar - d2 - sizeable_factor + title_bar + d2
                    ).ToString(),
                    f.Size.ToString(),
                    style.ToString() + "-E1"
                );
            ...
            using (Form f = new Form())
            {
                ...
                Assert.AreEqual(
                    new Size(
                        size.Width - d2 - sizeable_factor + d2 + sizeable_factor,
                        size.Height
                            - title_bar
                            - d2
                            - sizeable_factor
        ...
        {
            using (
                FormHandleTest.ProtectedMethodsForm form = new FormHandleTest.ProtectedMethodsForm()
            )
            {
                form.Dispose();
        ...
        public void FormStartupPositionTest()
        {
            ...
            using (Form frm = new Form())
            {
                ...
                Assert.AreEqual(
                    new Point(int.MinValue, int.MinValue).ToString(),
                    new Point(cp.X, cp.Y).ToString(),
                    "#01"
                );
                ...
                Assert.AreEqual(
                    new Point(
                        Screen.PrimaryScreen.WorkingArea.Width / 2 - frm.Width / 2,
                        Screen.PrimaryScreen.WorkingArea.Height / 2 - frm.Height / 2
                    ).ToString(),
                    new Point(cp.X, cp.Y).ToString(),
                    "#03"
                );
        ...
        public void MdiFormStartupPositionTest()
        {
            ...
            using (Form Main = new Form())
            {
                ...
                using (Form frm = new Form())
                {
                    ...
                    Assert.AreEqual(
                        new Point(
                            Main.Controls[0].ClientSize.Width / 2 - frm.Width / 2,
                            Main.Controls[0].ClientSize.Height / 2 - frm.Height / 2
                        ).ToString(),
                        new Point(cp.X, cp.Y).ToString(),
                        "#C3"
                    );
        ...
        public void ParentedFormEventTest()
        {
            using (Form Main = new Form())
            {
                ...
                Assert.AreEqual(
                    "ParentChanged;BindingContextChanged;VisibleChanged;Layout;VisibleChanged",
                    log.EventsJoined(),
                    "#B1"
                );
            }
        ...
        public void FormCreateParamsStyleTest()
        {
            ...
            using (frm = new Form())
            {
                Assert.AreEqual(
                    ...
                    ((WindowStyles)TestHelper.GetCreateParams(frm).Style),
                    "#01-Style"
                );
                Assert.AreEqual(
                    ...
                    ((WindowExStyles)TestHelper.GetCreateParams(frm).ExStyle),
                    "#01-ExStyle"
                );
            }
            ...
            using (frm = new Form())
            {
                ...
                Assert.AreEqual(
                    WindowStyles.WS_TILED | WindowStyles.WS_TABSTOP | WindowStyles.WS_CLIPCHILDREN,
                    ((WindowStyles)TestHelper.GetCreateParams(frm).Style),
                    "#14-Style"
                );
                Assert.AreEqual(
        ...
        public void FormClosingEvents()
        {
            ...
            f.Closing += new CancelEventHandler(
                delegate(Object obj, CancelEventArgs e)
                {
                    events += ("Closing;");
                }
            );
            f.FormClosing += new FormClosingEventHandler(
                delegate(Object obj, FormClosingEventArgs e)
                {
                    events += string.Format(
                        "FormClosing [Reason:{0} - Cancel:{1}]",
                        e.CloseReason,
                        e.Cancel
                    );
                }
            ...
            Assert.AreEqual(
                "Closing;FormClosing [Reason:UserClosing - Cancel:False]",
                events,
                "A1"
            );
        }
        ...
        public void FormClosedEvents()
        {
            ...
            f.Closed += new EventHandler(
                delegate(Object obj, EventArgs e)
                {
                    events += ("Closed;");
                }
            );
            f.FormClosed += new FormClosedEventHandler(
                delegate(Object obj, FormClosedEventArgs e)
                {
                    events += string.Format("FormClosed [Reason:{0}]", e.CloseReason);
                }
            );
        ...
        public void Bug686486()
        {
            using (Form f = new Bug686486Form())
            {
                ...
                {
                    Assert.Fail(
                        "Setting DialogResult in FormClosing Event causes endless loop: StackOverflowException"
                    );
                }
            }
        }
        ...
        public void GetScaledBoundsTest()
        {
            ...
            Assert.AreEqual(
                new Rectangle(100, 200, rescaled_size.Width, rescaled_size.Height),
            ...
            Assert.AreEqual(
                new Rectangle(100, 200, 300, rescaled_size.Height),
            ...
            Assert.AreEqual(
                new Rectangle(100, 200, 300, 400),
                c.PublicGetScaledBounds(r, new SizeF(1f, 1f), BoundsSpecified.All),
                "A6-2"
            );
            Assert.AreEqual(
                new Rectangle(100, 200, 600 - b.Width, 800 - b.Height),
                c.PublicGetScaledBounds(r, new SizeF(2f, 2f), BoundsSpecified.All),
                "A7"
            );
            Assert.AreEqual(
                new Rectangle(100, 200, 900 - 2 * b.Width, 1200 - 2 * b.Height),
                c.PublicGetScaledBounds(r, new SizeF(3f, 3f), BoundsSpecified.All),
                "A8"
            );
            Assert.AreEqual(
                new Rectangle(100, 200, 1200 - 3 * b.Width, 1600 - 3 * b.Height),
                c.PublicGetScaledBounds(r, new SizeF(4f, 4f), BoundsSpecified.All),
                "A9"
            );
            rescaled_size = new Size(
                (int)((300 - b.Width) * .5f) + b.Width,
                (int)((400 - b.Height) * .5f) + b.Height
            );
            Assert.AreEqual(
                new Rectangle(100, 200, rescaled_size.Width, rescaled_size.Height),
                c.PublicGetScaledBounds(r, new SizeF(.5f, .5f), BoundsSpecified.All),
                "A10"
            );
        }
        ...
        public void AutoScaleDetails()
        {
            ...
            f.AutoScaleDimensions = new SizeF(
                f.CurrentAutoScaleDimensions.Width / 2F,
                f.CurrentAutoScaleDimensions.Height / 2F
            );
        ...
        public void AutoScaleBounds()
        {
            ...
            Assert.AreEqual(
                new Rectangle(5, 107, 132, 9),
                new Rectangle(a.hScrollBar1.Location, a.hScrollBar1.Size),
                "A1"
            );
            Assert.AreEqual(
                new Rectangle(151, 74, 60, 44),
                new Rectangle(a.treeView1.Location, a.treeView1.Size),
                "A2"
            );
            Assert.AreEqual(
                new Rectangle(197, 21, 9, 39),
                new Rectangle(a.vScrollBar1.Location, a.vScrollBar1.Size),
                "A3"
            );
            Assert.AreEqual(
                new Rectangle(139, 21, 54, 49),
                new Rectangle(a.listView1.Location, a.listView1.Size),
                "A4"
            );
            Assert.AreEqual(
                new Rectangle(70, 5, 65, 37),
                new Rectangle(a.textBox2.Location, a.textBox2.Size),
                "A5"
            );
            Assert.AreEqual(
                new Rectangle(139, 5, 70, 0),
                new Rectangle(a.comboBox1.Location, new Size(a.comboBox1.Width, 0)),
                "A6"
            );
            Assert.AreEqual(
                new Rectangle(5, 77, 43, 13),
                new Rectangle(a.button2.Location, a.button2.Size),
                "A7"
            );
            Assert.AreEqual(
                new Rectangle(70, 44, 65, 37),
                new Rectangle(a.richTextBox1.Location, a.richTextBox1.Size),
                "A8"
            );
            Assert.AreEqual(
                new Rectangle(53, 86, 21, 7),
                new Rectangle(a.label1.Location, a.label1.Size),
                "A9"
            );
            Assert.AreEqual(
                new Rectangle(65, 84, 58, 0),
                new Rectangle(a.textBox1.Location, new Size(a.textBox1.Width, 0)),
                "A10"
            );
            Assert.AreEqual(
                new Rectangle(5, 63, 43, 13),
                new Rectangle(a.button1.Location, a.button1.Size),
                "A11"
            );
            Assert.AreEqual(
                new Rectangle(5, 5, 60, 47),
                new Rectangle(a.listBox1.Location, a.listBox1.Size),
                "A12"
            );
            a.Dispose();
            ...
            Assert.AreEqual(
                new Rectangle(4, 92, 114, 16),
                new Rectangle(a.hScrollBar1.Location, a.hScrollBar1.ClientSize),
                "B1"
            );
            Assert.AreEqual(
                new Rectangle(130, 64, 50, 36),
                new Rectangle(a.treeView1.Location, a.treeView1.ClientSize),
                "B2"
            );
            Assert.AreEqual(
                new Rectangle(170, 18, 16, 34),
                new Rectangle(a.vScrollBar1.Location, a.vScrollBar1.ClientSize),
                "B3"
            );
            Assert.AreEqual(
                new Rectangle(120, 18, 44, 40),
                new Rectangle(a.listView1.Location, a.listView1.ClientSize),
                "B4"
            );
            Assert.AreEqual(
                new Rectangle(60, 4, 54, 30),
                new Rectangle(a.textBox2.Location, a.textBox2.ClientSize),
                "B5"
            );
            Assert.AreEqual(
                new Rectangle(120, 4, 62, 0),
                new Rectangle(a.comboBox1.Location, new Size(a.comboBox1.ClientSize.Width, 0)),
                "B6"
            );
            Assert.AreEqual(
                new Rectangle(4, 66, 38, 12),
                new Rectangle(a.button2.Location, a.button2.ClientSize),
                "B7"
            );
            Assert.AreEqual(
                new Rectangle(60, 38, 54, 30),
                new Rectangle(a.richTextBox1.Location, a.richTextBox1.ClientSize),
                "B8"
            );
            Assert.AreEqual(
                new Rectangle(46, 74, 18, 6),
                new Rectangle(a.label1.Location, a.label1.ClientSize),
                "B9"
            );
            Assert.AreEqual(
                new Rectangle(56, 72, 48, 0),
                new Rectangle(a.textBox1.Location, new Size(a.textBox1.ClientSize.Width, 0)),
                "B10"
            );
            Assert.AreEqual(
                new Rectangle(4, 54, 38, 12),
                new Rectangle(a.button1.Location, a.button1.ClientSize),
                "B11"
            );
            Assert.AreEqual(
                new Rectangle(4, 4, 50, 39),
                new Rectangle(a.listBox1.Location, a.listBox1.ClientSize),
                "B12"
            );
            a.Dispose();
        }
