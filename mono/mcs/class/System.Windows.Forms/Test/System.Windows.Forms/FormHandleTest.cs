...
namespace MonoTests.System.Windows.Forms
{
    ...
    public class FormHandleTest : TestHelper
    {
        ...
        public void TestPublicProperties()
        {
            ...
            c.AutoScrollMargin = new Size(
                c.AutoScrollMargin.Width + 1,
                c.AutoScrollMargin.Height + 1
            );
            Assert.IsFalse(c.IsHandleCreated, "FA8");

            o = c.AutoScrollMinSize;
            c.AutoScrollMinSize = new Size(
                c.AutoScrollMinSize.Width + 1,
                c.AutoScrollMinSize.Height + 1
            );
            ...
            c.AutoScrollPosition = new Point(
                c.AutoScrollPosition.X + 1,
                c.AutoScrollPosition.Y + 1
            );
            ...
            o = c.DesktopBounds;
            c.DesktopBounds = new Rectangle(
                3,
                5,
                c.DesktopBounds.Width + 1,
                c.DesktopBounds.Height + 1
            );
