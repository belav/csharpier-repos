...
namespace MonoTests.System.Windows.Forms
{
    ...
    public class TestControlStyle : TestHelper
    {
        ...
        public static void CheckStyles(
            Control ctrl,
            string msg,
            params ControlStyles[] ExpectedStyles
        )
        {
            MethodInfo method = ctrl.GetType()
                .GetMethod(
                    "GetStyle",
            ...
            Assert.IsNotNull(
                method,
                "Cannot complete test, didn't find GetStyle method on Control"
            );
        ...
        public static string[] GetStyles(Control control)
        {
            ...
            for (int i = 0; i < style_values.Length; i++)
            {
                result[i] =
                    ...
                    + control
                        .GetType()
                        .GetMethod("GetStyle", BindingFlags.NonPublic | BindingFlags.Instance)
                        .Invoke(control, new object[1] { (ControlStyles)style_values.GetValue(i) });
            }
        ...
        public void CheckedListBoxStyleTest()
        {
            ...
            Assert.AreEqual(
                CheckedListBox_want,
                GetStyles(new CheckedListBox()),
                "CheckedListBoxStyles"
            );
        }
        ...
        public void ContainerControlStyleTest()
        {
            ...
            Assert.AreEqual(
                ContainerControl_want,
                GetStyles(new ContainerControl()),
                "ContainerControlStyles"
            );
        }
        ...
        public void DataGridTextBoxStyleTest()
        {
            ...
            Assert.AreEqual(
                DataGridTextBox_want,
                GetStyles(new DataGridTextBox()),
                "DataGridTextBoxStyles"
            );
        }
