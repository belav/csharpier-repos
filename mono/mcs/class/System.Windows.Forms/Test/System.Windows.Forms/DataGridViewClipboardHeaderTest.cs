    ...
    public class DataGridViewClipboardHeaderTest : TestHelper
    {
        ...
        public void Test()
        {
            ...
            using (DataGridView dgv = DataGridViewCommon.CreateAndFillForClipboard())
            {
                ...
                row_header_cell =
                    dgv.Rows[0].HeaderCell
                    as DataGridViewRowHeaderTest.DataGridViewRowHeaderClipboardCell;
                code =
                    row_header_cell.GetClipboardContentPublic(0, true, true, true, true, "Text")
                    as string;
                ...
                row_header_cell =
                    ...
                    as DataGridViewRowHeaderTest.DataGridViewRowHeaderClipboardCell;
                code =
                    row_header_cell.GetClipboardContentPublic(
                        0,
                        true,
                        true,
                        true,
                ...
                Assert.AreEqual(
                    "<TABLE><TR><TD ALIGN=\"center\"><B>Row#1</B></TD></TR></TABLE>",
                    code,
                    "#EnableAlwaysIncludeHeaderText#0-2"
                );
                row_header_cell =
                    dgv.Rows[0].HeaderCell
                    as DataGridViewRowHeaderTest.DataGridViewRowHeaderClipboardCell;
                code =
                    row_header_cell.GetClipboardContentPublic(0, true, true, true, true, "Csv")
                    as string;
                ...
                row_header_cell =
                    ...
                    as DataGridViewRowHeaderTest.DataGridViewRowHeaderClipboardCell;
                code =
                    row_header_cell.GetClipboardContentPublic(0, true, true, true, false, "Text")
                    as string;
                Assert.AreEqual(
                    string.Format("Row#1{0}", Environment.NewLine),
                    code,
                    "#EnableAlwaysIncludeHeaderText#0-4"
                );
                row_header_cell =
                    dgv.Rows[0].HeaderCell
                    as DataGridViewRowHeaderTest.DataGridViewRowHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    string.Format("Row#1{0}", Environment.NewLine),
                    code,
                    "#EnableAlwaysIncludeHeaderText#0-5"
                );
                row_header_cell =
                    dgv.Rows[0].HeaderCell
                    as DataGridViewRowHeaderTest.DataGridViewRowHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    "<TABLE><TR><TD ALIGN=\"center\"><B>Row#1</B></TD></TR>",
                    code,
                    "#EnableAlwaysIncludeHeaderText#0-6"
                );
                row_header_cell =
                    dgv.Rows[0].HeaderCell
                    as DataGridViewRowHeaderTest.DataGridViewRowHeaderClipboardCell;
                code =
                    row_header_cell.GetClipboardContentPublic(0, true, true, true, false, "Csv")
                    as string;
                Assert.AreEqual(
                    string.Format("Row#1{0}", Environment.NewLine),
                    code,
                    "#EnableAlwaysIncludeHeaderText#0-7"
                );
                row_header_cell =
                    dgv.Rows[0].HeaderCell
                    as DataGridViewRowHeaderTest.DataGridViewRowHeaderClipboardCell;
                code =
                    row_header_cell.GetClipboardContentPublic(0, true, true, false, true, "Text")
                    as string;
                ...
                Assert.AreEqual(
                    "<TR><TD ALIGN=\"center\"><B>Row#1</B></TD></TR></TABLE>",
                    code,
                    "#EnableAlwaysIncludeHeaderText#0-10"
                );
                row_header_cell =
                    dgv.Rows[0].HeaderCell
                    as DataGridViewRowHeaderTest.DataGridViewRowHeaderClipboardCell;
                code =
                    row_header_cell.GetClipboardContentPublic(0, true, true, false, true, "Csv")
                    as string;
                ...
                row_header_cell =
                    ...
                    as DataGridViewRowHeaderTest.DataGridViewRowHeaderClipboardCell;
                code =
                    row_header_cell.GetClipboardContentPublic(0, true, true, false, false, "Text")
                    as string;
                Assert.AreEqual(
                    string.Format("Row#1{0}", Environment.NewLine),
                    code,
                    "#EnableAlwaysIncludeHeaderText#0-12"
                );
                row_header_cell =
                    dgv.Rows[0].HeaderCell
                    as DataGridViewRowHeaderTest.DataGridViewRowHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    string.Format("Row#1{0}", Environment.NewLine),
                    code,
                    "#EnableAlwaysIncludeHeaderText#0-13"
                );
                row_header_cell =
                    dgv.Rows[0].HeaderCell
                    as DataGridViewRowHeaderTest.DataGridViewRowHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    "<TR><TD ALIGN=\"center\"><B>Row#1</B></TD></TR>",
                    code,
                    "#EnableAlwaysIncludeHeaderText#0-14"
                );
                row_header_cell =
                    dgv.Rows[0].HeaderCell
                    as DataGridViewRowHeaderTest.DataGridViewRowHeaderClipboardCell;
                code =
                    row_header_cell.GetClipboardContentPublic(0, true, true, false, false, "Csv")
                    as string;
                Assert.AreEqual(
                    string.Format("Row#1{0}", Environment.NewLine),
                    code,
                    "#EnableAlwaysIncludeHeaderText#0-15"
                );
                row_header_cell =
                    dgv.Rows[0].HeaderCell
                    as DataGridViewRowHeaderTest.DataGridViewRowHeaderClipboardCell;
                code =
                    row_header_cell.GetClipboardContentPublic(0, true, false, true, true, "Text")
                    as string;
                ...
                Assert.AreEqual(
                    "<TABLE><TR><TD ALIGN=\"center\"><B>Row#1</B></TD>",
                    code,
                    "#EnableAlwaysIncludeHeaderText#0-18"
                );
                row_header_cell =
                    dgv.Rows[0].HeaderCell
                    as DataGridViewRowHeaderTest.DataGridViewRowHeaderClipboardCell;
                code =
                    row_header_cell.GetClipboardContentPublic(0, true, false, true, true, "Csv")
                    as string;
                ...
                row_header_cell =
                    ...
                    as DataGridViewRowHeaderTest.DataGridViewRowHeaderClipboardCell;
                code =
                    row_header_cell.GetClipboardContentPublic(0, true, false, true, false, "Text")
                    as string;
                ...
                Assert.AreEqual(
                    "<TABLE><TR><TD ALIGN=\"center\"><B>Row#1</B></TD>",
                    code,
                    "#EnableAlwaysIncludeHeaderText#0-22"
                );
                row_header_cell =
                    dgv.Rows[0].HeaderCell
                    as DataGridViewRowHeaderTest.DataGridViewRowHeaderClipboardCell;
                code =
                    row_header_cell.GetClipboardContentPublic(0, true, false, true, false, "Csv")
                    as string;
                ...
                row_header_cell =
                    ...
                    as DataGridViewRowHeaderTest.DataGridViewRowHeaderClipboardCell;
                code =
                    row_header_cell.GetClipboardContentPublic(0, true, false, false, true, "Text")
                    as string;
                ...
                Assert.AreEqual(
                    "<TR><TD ALIGN=\"center\"><B>Row#1</B></TD>",
                    code,
                    "#EnableAlwaysIncludeHeaderText#0-26"
                );
                row_header_cell =
                    dgv.Rows[0].HeaderCell
                    as DataGridViewRowHeaderTest.DataGridViewRowHeaderClipboardCell;
                code =
                    row_header_cell.GetClipboardContentPublic(0, true, false, false, true, "Csv")
                    as string;
                ...
                row_header_cell =
                    ...
                    as DataGridViewRowHeaderTest.DataGridViewRowHeaderClipboardCell;
                code =
                    row_header_cell.GetClipboardContentPublic(0, true, false, false, false, "Text")
                    as string;
                ...
                Assert.AreEqual(
                    "<TR><TD ALIGN=\"center\"><B>Row#1</B></TD>",
                    code,
                    "#EnableAlwaysIncludeHeaderText#0-30"
                );
                row_header_cell =
                    dgv.Rows[0].HeaderCell
                    as DataGridViewRowHeaderTest.DataGridViewRowHeaderClipboardCell;
                code =
                    row_header_cell.GetClipboardContentPublic(0, true, false, false, false, "Csv")
                    as string;
                ...
                row_header_cell =
                    ...
                    as DataGridViewRowHeaderTest.DataGridViewRowHeaderClipboardCell;
                code =
                    row_header_cell.GetClipboardContentPublic(0, false, true, true, true, "Text")
                    as string;
                ...
                Assert.AreEqual(
                    "<TABLE><TR><TD ALIGN=\"center\"><B>Row#1</B></TD></TR></TABLE>",
                    code,
                    "#EnableAlwaysIncludeHeaderText#0-34"
                );
                row_header_cell =
                    dgv.Rows[0].HeaderCell
                    as DataGridViewRowHeaderTest.DataGridViewRowHeaderClipboardCell;
                code =
                    row_header_cell.GetClipboardContentPublic(0, false, true, true, true, "Csv")
                    as string;
                ...
                row_header_cell =
                    ...
                    as DataGridViewRowHeaderTest.DataGridViewRowHeaderClipboardCell;
                code =
                    row_header_cell.GetClipboardContentPublic(0, false, true, true, false, "Text")
                    as string;
                Assert.AreEqual(
                    string.Format("Row#1{0}", Environment.NewLine),
                    code,
                    "#EnableAlwaysIncludeHeaderText#0-36"
                );
                row_header_cell =
                    dgv.Rows[0].HeaderCell
                    as DataGridViewRowHeaderTest.DataGridViewRowHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    string.Format("Row#1{0}", Environment.NewLine),
                    code,
                    "#EnableAlwaysIncludeHeaderText#0-37"
                );
                row_header_cell =
                    dgv.Rows[0].HeaderCell
                    as DataGridViewRowHeaderTest.DataGridViewRowHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    "<TABLE><TR><TD ALIGN=\"center\"><B>Row#1</B></TD></TR>",
                    code,
                    "#EnableAlwaysIncludeHeaderText#0-38"
                );
                row_header_cell =
                    dgv.Rows[0].HeaderCell
                    as DataGridViewRowHeaderTest.DataGridViewRowHeaderClipboardCell;
                code =
                    row_header_cell.GetClipboardContentPublic(0, false, true, true, false, "Csv")
                    as string;
                Assert.AreEqual(
                    string.Format("Row#1{0}", Environment.NewLine),
                    code,
                    "#EnableAlwaysIncludeHeaderText#0-39"
                );
                row_header_cell =
                    dgv.Rows[0].HeaderCell
                    as DataGridViewRowHeaderTest.DataGridViewRowHeaderClipboardCell;
                code =
                    row_header_cell.GetClipboardContentPublic(0, false, true, false, true, "Text")
                    as string;
                ...
                Assert.AreEqual(
                    "<TR><TD ALIGN=\"center\"><B>Row#1</B></TD></TR></TABLE>",
                    code,
                    "#EnableAlwaysIncludeHeaderText#0-42"
                );
                row_header_cell =
                    dgv.Rows[0].HeaderCell
                    as DataGridViewRowHeaderTest.DataGridViewRowHeaderClipboardCell;
                code =
                    row_header_cell.GetClipboardContentPublic(0, false, true, false, true, "Csv")
                    as string;
                ...
                row_header_cell =
                    ...
                    as DataGridViewRowHeaderTest.DataGridViewRowHeaderClipboardCell;
                code =
                    row_header_cell.GetClipboardContentPublic(0, false, true, false, false, "Text")
                    as string;
                Assert.AreEqual(
                    string.Format("Row#1{0}", Environment.NewLine),
                    code,
                    "#EnableAlwaysIncludeHeaderText#0-44"
                );
                row_header_cell =
                    dgv.Rows[0].HeaderCell
                    as DataGridViewRowHeaderTest.DataGridViewRowHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    string.Format("Row#1{0}", Environment.NewLine),
                    code,
                    "#EnableAlwaysIncludeHeaderText#0-45"
                );
                row_header_cell =
                    dgv.Rows[0].HeaderCell
                    as DataGridViewRowHeaderTest.DataGridViewRowHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    "<TR><TD ALIGN=\"center\"><B>Row#1</B></TD></TR>",
                    code,
                    "#EnableAlwaysIncludeHeaderText#0-46"
                );
                row_header_cell =
                    dgv.Rows[0].HeaderCell
                    as DataGridViewRowHeaderTest.DataGridViewRowHeaderClipboardCell;
                code =
                    row_header_cell.GetClipboardContentPublic(0, false, true, false, false, "Csv")
                    as string;
                Assert.AreEqual(
                    string.Format("Row#1{0}", Environment.NewLine),
                    code,
                    "#EnableAlwaysIncludeHeaderText#0-47"
                );
                row_header_cell =
                    dgv.Rows[0].HeaderCell
                    as DataGridViewRowHeaderTest.DataGridViewRowHeaderClipboardCell;
                code =
                    row_header_cell.GetClipboardContentPublic(0, false, false, true, true, "Text")
                    as string;
                ...
                Assert.AreEqual(
                    "<TABLE><TR><TD ALIGN=\"center\"><B>Row#1</B></TD>",
                    code,
                    "#EnableAlwaysIncludeHeaderText#0-50"
                );
                row_header_cell =
                    dgv.Rows[0].HeaderCell
                    as DataGridViewRowHeaderTest.DataGridViewRowHeaderClipboardCell;
                code =
                    row_header_cell.GetClipboardContentPublic(0, false, false, true, true, "Csv")
                    as string;
                ...
                row_header_cell =
                    ...
                    as DataGridViewRowHeaderTest.DataGridViewRowHeaderClipboardCell;
                code =
                    row_header_cell.GetClipboardContentPublic(0, false, false, true, false, "Text")
                    as string;
                ...
                Assert.AreEqual(
                    "<TABLE><TR><TD ALIGN=\"center\"><B>Row#1</B></TD>",
                    code,
                    "#EnableAlwaysIncludeHeaderText#0-54"
                );
                row_header_cell =
                    dgv.Rows[0].HeaderCell
                    as DataGridViewRowHeaderTest.DataGridViewRowHeaderClipboardCell;
                code =
                    row_header_cell.GetClipboardContentPublic(0, false, false, true, false, "Csv")
                    as string;
                ...
                row_header_cell =
                    ...
                    as DataGridViewRowHeaderTest.DataGridViewRowHeaderClipboardCell;
                code =
                    row_header_cell.GetClipboardContentPublic(0, false, false, false, true, "Text")
                    as string;
                ...
                Assert.AreEqual(
                    "<TR><TD ALIGN=\"center\"><B>Row#1</B></TD>",
                    code,
                    "#EnableAlwaysIncludeHeaderText#0-58"
                );
                row_header_cell =
                    dgv.Rows[0].HeaderCell
                    as DataGridViewRowHeaderTest.DataGridViewRowHeaderClipboardCell;
                code =
                    row_header_cell.GetClipboardContentPublic(0, false, false, false, true, "Csv")
                    as string;
                ...
                row_header_cell =
                    ...
                    as DataGridViewRowHeaderTest.DataGridViewRowHeaderClipboardCell;
                code =
                    row_header_cell.GetClipboardContentPublic(0, false, false, false, false, "Text")
                    as string;
                ...
                Assert.AreEqual(
                    "<TR><TD ALIGN=\"center\"><B>Row#1</B></TD>",
                    code,
                    "#EnableAlwaysIncludeHeaderText#0-62"
                );
                row_header_cell =
                    dgv.Rows[0].HeaderCell
                    as DataGridViewRowHeaderTest.DataGridViewRowHeaderClipboardCell;
                code =
                    row_header_cell.GetClipboardContentPublic(0, false, false, false, false, "Csv")
                    as string;
                Assert.AreEqual("Row#1,", code, "#EnableAlwaysIncludeHeaderText#0-63");
                col_header_cell =
                    dgv.Columns[0].HeaderCell
                    as DataGridViewColumnHeaderTest.DataGridViewColumnHeaderClipboardCell;
                code =
                    col_header_cell.GetClipboardContentPublic(-1, true, true, true, true, "Text")
                    as string;
                ...
                col_header_cell =
                    ...
                    as DataGridViewColumnHeaderTest.DataGridViewColumnHeaderClipboardCell;
                code =
                    col_header_cell.GetClipboardContentPublic(
                        -1,
                        true,
                        true,
                        true,
                ...
                Assert.AreEqual(
                    "<TABLE><THEAD><TH>A</TH></THEAD></TABLE>",
                    code,
                    "#EnableAlwaysIncludeHeaderText#0-66"
                );
                col_header_cell =
                    dgv.Columns[0].HeaderCell
                    as DataGridViewColumnHeaderTest.DataGridViewColumnHeaderClipboardCell;
                code =
                    col_header_cell.GetClipboardContentPublic(-1, true, true, true, true, "Csv")
                    as string;
                ...
                col_header_cell =
                    ...
                    as DataGridViewColumnHeaderTest.DataGridViewColumnHeaderClipboardCell;
                code =
                    col_header_cell.GetClipboardContentPublic(-1, true, true, true, false, "Text")
                    as string;
                Assert.AreEqual(
                    string.Format("A{0}", Environment.NewLine),
                    code,
                    "#EnableAlwaysIncludeHeaderText#0-68"
                );
                col_header_cell =
                    dgv.Columns[0].HeaderCell
                    as DataGridViewColumnHeaderTest.DataGridViewColumnHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    string.Format("A{0}", Environment.NewLine),
                    code,
                    "#EnableAlwaysIncludeHeaderText#0-69"
                );
                col_header_cell =
                    dgv.Columns[0].HeaderCell
                    as DataGridViewColumnHeaderTest.DataGridViewColumnHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    "<TABLE><THEAD><TH>A</TH></THEAD>",
                    code,
                    "#EnableAlwaysIncludeHeaderText#0-70"
                );
                col_header_cell =
                    dgv.Columns[0].HeaderCell
                    as DataGridViewColumnHeaderTest.DataGridViewColumnHeaderClipboardCell;
                code =
                    col_header_cell.GetClipboardContentPublic(-1, true, true, true, false, "Csv")
                    as string;
                Assert.AreEqual(
                    string.Format("A{0}", Environment.NewLine),
                    code,
                    "#EnableAlwaysIncludeHeaderText#0-71"
                );
                col_header_cell =
                    dgv.Columns[0].HeaderCell
                    as DataGridViewColumnHeaderTest.DataGridViewColumnHeaderClipboardCell;
                code =
                    col_header_cell.GetClipboardContentPublic(-1, true, true, false, true, "Text")
                    as string;
                ...
                Assert.AreEqual(
                    "<TABLE><THEAD><TH>A</TH></THEAD></TABLE>",
                    code,
                    "#EnableAlwaysIncludeHeaderText#0-74"
                );
                col_header_cell =
                    dgv.Columns[0].HeaderCell
                    as DataGridViewColumnHeaderTest.DataGridViewColumnHeaderClipboardCell;
                code =
                    col_header_cell.GetClipboardContentPublic(-1, true, true, false, true, "Csv")
                    as string;
                ...
                col_header_cell =
                    ...
                    as DataGridViewColumnHeaderTest.DataGridViewColumnHeaderClipboardCell;
                code =
                    col_header_cell.GetClipboardContentPublic(-1, true, true, false, false, "Text")
                    as string;
                Assert.AreEqual(
                    string.Format("A{0}", Environment.NewLine),
                    code,
                    "#EnableAlwaysIncludeHeaderText#0-76"
                );
                col_header_cell =
                    dgv.Columns[0].HeaderCell
                    as DataGridViewColumnHeaderTest.DataGridViewColumnHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    string.Format("A{0}", Environment.NewLine),
                    code,
                    "#EnableAlwaysIncludeHeaderText#0-77"
                );
                col_header_cell =
                    dgv.Columns[0].HeaderCell
                    as DataGridViewColumnHeaderTest.DataGridViewColumnHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    "<TABLE><THEAD><TH>A</TH></THEAD>",
                    code,
                    "#EnableAlwaysIncludeHeaderText#0-78"
                );
                col_header_cell =
                    dgv.Columns[0].HeaderCell
                    as DataGridViewColumnHeaderTest.DataGridViewColumnHeaderClipboardCell;
                code =
                    col_header_cell.GetClipboardContentPublic(-1, true, true, false, false, "Csv")
                    as string;
                Assert.AreEqual(
                    string.Format("A{0}", Environment.NewLine),
                    code,
                    "#EnableAlwaysIncludeHeaderText#0-79"
                );
                col_header_cell =
                    dgv.Columns[0].HeaderCell
                    as DataGridViewColumnHeaderTest.DataGridViewColumnHeaderClipboardCell;
                code =
                    col_header_cell.GetClipboardContentPublic(-1, true, false, true, true, "Text")
                    as string;
                ...
                Assert.AreEqual(
                    "<TABLE><THEAD><TH>A</TH>",
                    code,
                    "#EnableAlwaysIncludeHeaderText#0-82"
                );
                col_header_cell =
                    dgv.Columns[0].HeaderCell
                    as DataGridViewColumnHeaderTest.DataGridViewColumnHeaderClipboardCell;
                code =
                    col_header_cell.GetClipboardContentPublic(-1, true, false, true, true, "Csv")
                    as string;
                ...
                col_header_cell =
                    ...
                    as DataGridViewColumnHeaderTest.DataGridViewColumnHeaderClipboardCell;
                code =
                    col_header_cell.GetClipboardContentPublic(-1, true, false, true, false, "Text")
                    as string;
                ...
                Assert.AreEqual(
                    "<TABLE><THEAD><TH>A</TH>",
                    code,
                    "#EnableAlwaysIncludeHeaderText#0-86"
                );
                col_header_cell =
                    dgv.Columns[0].HeaderCell
                    as DataGridViewColumnHeaderTest.DataGridViewColumnHeaderClipboardCell;
                code =
                    col_header_cell.GetClipboardContentPublic(-1, true, false, true, false, "Csv")
                    as string;
                ...
                col_header_cell =
                    ...
                    as DataGridViewColumnHeaderTest.DataGridViewColumnHeaderClipboardCell;
                code =
                    col_header_cell.GetClipboardContentPublic(-1, true, false, false, true, "Text")
                    as string;
                ...
                Assert.AreEqual(
                    "<TABLE><THEAD><TH>A</TH>",
                    code,
                    "#EnableAlwaysIncludeHeaderText#0-90"
                );
                col_header_cell =
                    dgv.Columns[0].HeaderCell
                    as DataGridViewColumnHeaderTest.DataGridViewColumnHeaderClipboardCell;
                code =
                    col_header_cell.GetClipboardContentPublic(-1, true, false, false, true, "Csv")
                    as string;
                ...
                col_header_cell =
                    ...
                    as DataGridViewColumnHeaderTest.DataGridViewColumnHeaderClipboardCell;
                code =
                    col_header_cell.GetClipboardContentPublic(-1, true, false, false, false, "Text")
                    as string;
                ...
                Assert.AreEqual(
                    "<TABLE><THEAD><TH>A</TH>",
                    code,
                    "#EnableAlwaysIncludeHeaderText#0-94"
                );
                col_header_cell =
                    dgv.Columns[0].HeaderCell
                    as DataGridViewColumnHeaderTest.DataGridViewColumnHeaderClipboardCell;
                code =
                    col_header_cell.GetClipboardContentPublic(-1, true, false, false, false, "Csv")
                    as string;
                ...
                col_header_cell =
                    ...
                    as DataGridViewColumnHeaderTest.DataGridViewColumnHeaderClipboardCell;
                code =
                    col_header_cell.GetClipboardContentPublic(-1, false, true, true, true, "Text")
                    as string;
                ...
                Assert.AreEqual(
                    "<TH>A</TH></THEAD></TABLE>",
                    code,
                    "#EnableAlwaysIncludeHeaderText#0-98"
                );
                col_header_cell =
                    dgv.Columns[0].HeaderCell
                    as DataGridViewColumnHeaderTest.DataGridViewColumnHeaderClipboardCell;
                code =
                    col_header_cell.GetClipboardContentPublic(-1, false, true, true, true, "Csv")
                    as string;
                ...
                col_header_cell =
                    ...
                    as DataGridViewColumnHeaderTest.DataGridViewColumnHeaderClipboardCell;
                code =
                    col_header_cell.GetClipboardContentPublic(-1, false, true, true, false, "Text")
                    as string;
                Assert.AreEqual(
                    string.Format("A{0}", Environment.NewLine),
                    code,
                    "#EnableAlwaysIncludeHeaderText#0-100"
                );
                col_header_cell =
                    dgv.Columns[0].HeaderCell
                    as DataGridViewColumnHeaderTest.DataGridViewColumnHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    string.Format("A{0}", Environment.NewLine),
                    code,
                    "#EnableAlwaysIncludeHeaderText#0-101"
                );
                col_header_cell =
                    dgv.Columns[0].HeaderCell
                    as DataGridViewColumnHeaderTest.DataGridViewColumnHeaderClipboardCell;
                ...
                col_header_cell =
                    ...
                    as DataGridViewColumnHeaderTest.DataGridViewColumnHeaderClipboardCell;
                code =
                    col_header_cell.GetClipboardContentPublic(-1, false, true, true, false, "Csv")
                    as string;
                Assert.AreEqual(
                    string.Format("A{0}", Environment.NewLine),
                    code,
                    "#EnableAlwaysIncludeHeaderText#0-103"
                );
                col_header_cell =
                    dgv.Columns[0].HeaderCell
                    as DataGridViewColumnHeaderTest.DataGridViewColumnHeaderClipboardCell;
                code =
                    col_header_cell.GetClipboardContentPublic(-1, false, true, false, true, "Text")
                    as string;
                ...
                Assert.AreEqual(
                    "<TH>A</TH></THEAD></TABLE>",
                    code,
                    "#EnableAlwaysIncludeHeaderText#0-106"
                );
                col_header_cell =
                    dgv.Columns[0].HeaderCell
                    as DataGridViewColumnHeaderTest.DataGridViewColumnHeaderClipboardCell;
                code =
                    col_header_cell.GetClipboardContentPublic(-1, false, true, false, true, "Csv")
                    as string;
                ...
                col_header_cell =
                    ...
                    as DataGridViewColumnHeaderTest.DataGridViewColumnHeaderClipboardCell;
                code =
                    col_header_cell.GetClipboardContentPublic(-1, false, true, false, false, "Text")
                    as string;
                Assert.AreEqual(
                    string.Format("A{0}", Environment.NewLine),
                    code,
                    "#EnableAlwaysIncludeHeaderText#0-108"
                );
                col_header_cell =
                    dgv.Columns[0].HeaderCell
                    as DataGridViewColumnHeaderTest.DataGridViewColumnHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    string.Format("A{0}", Environment.NewLine),
                    code,
                    "#EnableAlwaysIncludeHeaderText#0-109"
                );
                col_header_cell =
                    dgv.Columns[0].HeaderCell
                    as DataGridViewColumnHeaderTest.DataGridViewColumnHeaderClipboardCell;
                ...
                col_header_cell =
                    ...
                    as DataGridViewColumnHeaderTest.DataGridViewColumnHeaderClipboardCell;
                code =
                    col_header_cell.GetClipboardContentPublic(-1, false, true, false, false, "Csv")
                    as string;
                Assert.AreEqual(
                    string.Format("A{0}", Environment.NewLine),
                    code,
                    "#EnableAlwaysIncludeHeaderText#0-111"
                );
                col_header_cell =
                    dgv.Columns[0].HeaderCell
                    as DataGridViewColumnHeaderTest.DataGridViewColumnHeaderClipboardCell;
                code =
                    col_header_cell.GetClipboardContentPublic(-1, false, false, true, true, "Text")
                    as string;
                ...
                col_header_cell =
                    ...
                    as DataGridViewColumnHeaderTest.DataGridViewColumnHeaderClipboardCell;
                code =
                    col_header_cell.GetClipboardContentPublic(-1, false, false, true, true, "Csv")
                    as string;
                ...
                col_header_cell =
                    ...
                    as DataGridViewColumnHeaderTest.DataGridViewColumnHeaderClipboardCell;
                code =
                    col_header_cell.GetClipboardContentPublic(-1, false, false, true, false, "Text")
                    as string;
                ...
                col_header_cell =
                    ...
                    as DataGridViewColumnHeaderTest.DataGridViewColumnHeaderClipboardCell;
                code =
                    col_header_cell.GetClipboardContentPublic(-1, false, false, true, false, "Csv")
                    as string;
                ...
                col_header_cell =
                    ...
                    as DataGridViewColumnHeaderTest.DataGridViewColumnHeaderClipboardCell;
                code =
                    col_header_cell.GetClipboardContentPublic(-1, false, false, false, true, "Text")
                    as string;
                ...
                col_header_cell =
                    ...
                    as DataGridViewColumnHeaderTest.DataGridViewColumnHeaderClipboardCell;
                code =
                    col_header_cell.GetClipboardContentPublic(-1, false, false, false, true, "Csv")
                    as string;
                ...
                col_header_cell =
                    ...
                    as DataGridViewColumnHeaderTest.DataGridViewColumnHeaderClipboardCell;
                code =
                    col_header_cell.GetClipboardContentPublic(-1, false, false, false, false, "Csv")
                    as string;
            ...
            using (DataGridView dgv = DataGridViewCommon.CreateAndFillForClipboard())
            {
                ...
                Assert.AreEqual(
                    string.Format("Row#1{0}", Environment.NewLine),
                    code,
                    "#EnableAlwaysIncludeHeaderText#1-5"
                );
                row_header_cell =
                    dgv.Rows[0].HeaderCell
                    as DataGridViewRowHeaderTest.DataGridViewRowHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    "<TABLE><TR><TD ALIGN=\"center\"><B>Row#1</B></TD></TR>",
                    code,
                    "#EnableAlwaysIncludeHeaderText#1-6"
                );
                row_header_cell =
                    dgv.Rows[0].HeaderCell
                    as DataGridViewRowHeaderTest.DataGridViewRowHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    string.Format("Row#1{0}", Environment.NewLine),
                    code,
                    "#EnableAlwaysIncludeHeaderText#1-7"
                );
                row_header_cell =
                    dgv.Rows[0].HeaderCell
                    as DataGridViewRowHeaderTest.DataGridViewRowHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    "<TR><TD ALIGN=\"center\"><B>Row#1</B></TD></TR></TABLE>",
                    code,
                    "#EnableAlwaysIncludeHeaderText#1-10"
                );
                row_header_cell =
                    dgv.Rows[0].HeaderCell
                    as DataGridViewRowHeaderTest.DataGridViewRowHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    string.Format("Row#1{0}", Environment.NewLine),
                    code,
                    "#EnableAlwaysIncludeHeaderText#1-12"
                );
                row_header_cell =
                    dgv.Rows[0].HeaderCell
                    as DataGridViewRowHeaderTest.DataGridViewRowHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    string.Format("Row#1{0}", Environment.NewLine),
                    code,
                    "#EnableAlwaysIncludeHeaderText#1-13"
                );
                row_header_cell =
                    dgv.Rows[0].HeaderCell
                    as DataGridViewRowHeaderTest.DataGridViewRowHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    "<TR><TD ALIGN=\"center\"><B>Row#1</B></TD></TR>",
                    code,
                    "#EnableAlwaysIncludeHeaderText#1-14"
                );
                row_header_cell =
                    dgv.Rows[0].HeaderCell
                    as DataGridViewRowHeaderTest.DataGridViewRowHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    string.Format("Row#1{0}", Environment.NewLine),
                    code,
                    "#EnableAlwaysIncludeHeaderText#1-15"
                );
                row_header_cell =
                    dgv.Rows[0].HeaderCell
                    as DataGridViewRowHeaderTest.DataGridViewRowHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    "<TABLE><TR><TD ALIGN=\"center\"><B>Row#1</B></TD>",
                    code,
                    "#EnableAlwaysIncludeHeaderText#1-18"
                );
                row_header_cell =
                    dgv.Rows[0].HeaderCell
                    as DataGridViewRowHeaderTest.DataGridViewRowHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    "<TABLE><TR><TD ALIGN=\"center\"><B>Row#1</B></TD>",
                    code,
                    "#EnableAlwaysIncludeHeaderText#1-22"
                );
                row_header_cell =
                    dgv.Rows[0].HeaderCell
                    as DataGridViewRowHeaderTest.DataGridViewRowHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    "<TR><TD ALIGN=\"center\"><B>Row#1</B></TD>",
                    code,
                    "#EnableAlwaysIncludeHeaderText#1-26"
                );
                row_header_cell =
                    dgv.Rows[0].HeaderCell
                    as DataGridViewRowHeaderTest.DataGridViewRowHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    "<TR><TD ALIGN=\"center\"><B>Row#1</B></TD>",
                    code,
                    "#EnableAlwaysIncludeHeaderText#1-30"
                );
                row_header_cell =
                    dgv.Rows[0].HeaderCell
                    as DataGridViewRowHeaderTest.DataGridViewRowHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    "<TABLE><TR><TD ALIGN=\"center\"><B>Row#1</B></TD></TR></TABLE>",
                    code,
                    "#EnableAlwaysIncludeHeaderText#1-34"
                );
                row_header_cell =
                    dgv.Rows[0].HeaderCell
                    as DataGridViewRowHeaderTest.DataGridViewRowHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    string.Format("Row#1{0}", Environment.NewLine),
                    code,
                    "#EnableAlwaysIncludeHeaderText#1-36"
                );
                row_header_cell =
                    dgv.Rows[0].HeaderCell
                    as DataGridViewRowHeaderTest.DataGridViewRowHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    string.Format("Row#1{0}", Environment.NewLine),
                    code,
                    "#EnableAlwaysIncludeHeaderText#1-37"
                );
                row_header_cell =
                    dgv.Rows[0].HeaderCell
                    as DataGridViewRowHeaderTest.DataGridViewRowHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    "<TABLE><TR><TD ALIGN=\"center\"><B>Row#1</B></TD></TR>",
                    code,
                    "#EnableAlwaysIncludeHeaderText#1-38"
                );
                row_header_cell =
                    dgv.Rows[0].HeaderCell
                    as DataGridViewRowHeaderTest.DataGridViewRowHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    string.Format("Row#1{0}", Environment.NewLine),
                    code,
                    "#EnableAlwaysIncludeHeaderText#1-39"
                );
                row_header_cell =
                    dgv.Rows[0].HeaderCell
                    as DataGridViewRowHeaderTest.DataGridViewRowHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    "<TR><TD ALIGN=\"center\"><B>Row#1</B></TD></TR></TABLE>",
                    code,
                    "#EnableAlwaysIncludeHeaderText#1-42"
                );
                row_header_cell =
                    dgv.Rows[0].HeaderCell
                    as DataGridViewRowHeaderTest.DataGridViewRowHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    string.Format("Row#1{0}", Environment.NewLine),
                    code,
                    "#EnableAlwaysIncludeHeaderText#1-44"
                );
                row_header_cell =
                    dgv.Rows[0].HeaderCell
                    as DataGridViewRowHeaderTest.DataGridViewRowHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    string.Format("Row#1{0}", Environment.NewLine),
                    code,
                    "#EnableAlwaysIncludeHeaderText#1-45"
                );
                row_header_cell =
                    dgv.Rows[0].HeaderCell
                    as DataGridViewRowHeaderTest.DataGridViewRowHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    "<TR><TD ALIGN=\"center\"><B>Row#1</B></TD></TR>",
                    code,
                    "#EnableAlwaysIncludeHeaderText#1-46"
                );
                row_header_cell =
                    dgv.Rows[0].HeaderCell
                    as DataGridViewRowHeaderTest.DataGridViewRowHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    string.Format("Row#1{0}", Environment.NewLine),
                    code,
                    "#EnableAlwaysIncludeHeaderText#1-47"
                );
                row_header_cell =
                    dgv.Rows[0].HeaderCell
                    as DataGridViewRowHeaderTest.DataGridViewRowHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    "<TABLE><TR><TD ALIGN=\"center\"><B>Row#1</B></TD>",
                    code,
                    "#EnableAlwaysIncludeHeaderText#1-50"
                );
                row_header_cell =
                    dgv.Rows[0].HeaderCell
                    as DataGridViewRowHeaderTest.DataGridViewRowHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    "<TABLE><TR><TD ALIGN=\"center\"><B>Row#1</B></TD>",
                    code,
                    "#EnableAlwaysIncludeHeaderText#1-54"
                );
                row_header_cell =
                    dgv.Rows[0].HeaderCell
                    as DataGridViewRowHeaderTest.DataGridViewRowHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    "<TR><TD ALIGN=\"center\"><B>Row#1</B></TD>",
                    code,
                    "#EnableAlwaysIncludeHeaderText#1-58"
                );
                row_header_cell =
                    dgv.Rows[0].HeaderCell
                    as DataGridViewRowHeaderTest.DataGridViewRowHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    "<TR><TD ALIGN=\"center\"><B>Row#1</B></TD>",
                    code,
                    "#EnableAlwaysIncludeHeaderText#1-62"
                );
                row_header_cell =
                    dgv.Rows[0].HeaderCell
                    as DataGridViewRowHeaderTest.DataGridViewRowHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    "<TABLE><THEAD><TH>A</TH></THEAD></TABLE>",
                    code,
                    "#EnableAlwaysIncludeHeaderText#1-66"
                );
                col_header_cell =
                    dgv.Columns[0].HeaderCell
                    as DataGridViewColumnHeaderTest.DataGridViewColumnHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    string.Format("A{0}", Environment.NewLine),
                    code,
                    "#EnableAlwaysIncludeHeaderText#1-68"
                );
                col_header_cell =
                    dgv.Columns[0].HeaderCell
                    as DataGridViewColumnHeaderTest.DataGridViewColumnHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    string.Format("A{0}", Environment.NewLine),
                    code,
                    "#EnableAlwaysIncludeHeaderText#1-69"
                );
                col_header_cell =
                    dgv.Columns[0].HeaderCell
                    as DataGridViewColumnHeaderTest.DataGridViewColumnHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    "<TABLE><THEAD><TH>A</TH></THEAD>",
                    code,
                    "#EnableAlwaysIncludeHeaderText#1-70"
                );
                col_header_cell =
                    dgv.Columns[0].HeaderCell
                    as DataGridViewColumnHeaderTest.DataGridViewColumnHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    string.Format("A{0}", Environment.NewLine),
                    code,
                    "#EnableAlwaysIncludeHeaderText#1-71"
                );
                col_header_cell =
                    dgv.Columns[0].HeaderCell
                    as DataGridViewColumnHeaderTest.DataGridViewColumnHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    "<TABLE><THEAD><TH>A</TH></THEAD></TABLE>",
                    code,
                    "#EnableAlwaysIncludeHeaderText#1-74"
                );
                col_header_cell =
                    dgv.Columns[0].HeaderCell
                    as DataGridViewColumnHeaderTest.DataGridViewColumnHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    string.Format("A{0}", Environment.NewLine),
                    code,
                    "#EnableAlwaysIncludeHeaderText#1-76"
                );
                col_header_cell =
                    dgv.Columns[0].HeaderCell
                    as DataGridViewColumnHeaderTest.DataGridViewColumnHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    string.Format("A{0}", Environment.NewLine),
                    code,
                    "#EnableAlwaysIncludeHeaderText#1-77"
                );
                col_header_cell =
                    dgv.Columns[0].HeaderCell
                    as DataGridViewColumnHeaderTest.DataGridViewColumnHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    "<TABLE><THEAD><TH>A</TH></THEAD>",
                    code,
                    "#EnableAlwaysIncludeHeaderText#1-78"
                );
                col_header_cell =
                    dgv.Columns[0].HeaderCell
                    as DataGridViewColumnHeaderTest.DataGridViewColumnHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    string.Format("A{0}", Environment.NewLine),
                    code,
                    "#EnableAlwaysIncludeHeaderText#1-79"
                );
                col_header_cell =
                    dgv.Columns[0].HeaderCell
                    as DataGridViewColumnHeaderTest.DataGridViewColumnHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    "<TABLE><THEAD><TH>A</TH>",
                    code,
                    "#EnableAlwaysIncludeHeaderText#1-82"
                );
                col_header_cell =
                    dgv.Columns[0].HeaderCell
                    as DataGridViewColumnHeaderTest.DataGridViewColumnHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    "<TABLE><THEAD><TH>A</TH>",
                    code,
                    "#EnableAlwaysIncludeHeaderText#1-86"
                );
                col_header_cell =
                    dgv.Columns[0].HeaderCell
                    as DataGridViewColumnHeaderTest.DataGridViewColumnHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    "<TABLE><THEAD><TH>A</TH>",
                    code,
                    "#EnableAlwaysIncludeHeaderText#1-90"
                );
                col_header_cell =
                    dgv.Columns[0].HeaderCell
                    as DataGridViewColumnHeaderTest.DataGridViewColumnHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    "<TABLE><THEAD><TH>A</TH>",
                    code,
                    "#EnableAlwaysIncludeHeaderText#1-94"
                );
                col_header_cell =
                    dgv.Columns[0].HeaderCell
                    as DataGridViewColumnHeaderTest.DataGridViewColumnHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    "<TH>A</TH></THEAD></TABLE>",
                    code,
                    "#EnableAlwaysIncludeHeaderText#1-98"
                );
                col_header_cell =
                    dgv.Columns[0].HeaderCell
                    as DataGridViewColumnHeaderTest.DataGridViewColumnHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    string.Format("A{0}", Environment.NewLine),
                    code,
                    "#EnableAlwaysIncludeHeaderText#1-100"
                );
                col_header_cell =
                    dgv.Columns[0].HeaderCell
                    as DataGridViewColumnHeaderTest.DataGridViewColumnHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    string.Format("A{0}", Environment.NewLine),
                    code,
                    "#EnableAlwaysIncludeHeaderText#1-101"
                );
                col_header_cell =
                    dgv.Columns[0].HeaderCell
                    as DataGridViewColumnHeaderTest.DataGridViewColumnHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    string.Format("A{0}", Environment.NewLine),
                    code,
                    "#EnableAlwaysIncludeHeaderText#1-103"
                );
                col_header_cell =
                    dgv.Columns[0].HeaderCell
                    as DataGridViewColumnHeaderTest.DataGridViewColumnHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    "<TH>A</TH></THEAD></TABLE>",
                    code,
                    "#EnableAlwaysIncludeHeaderText#1-106"
                );
                col_header_cell =
                    dgv.Columns[0].HeaderCell
                    as DataGridViewColumnHeaderTest.DataGridViewColumnHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    string.Format("A{0}", Environment.NewLine),
                    code,
                    "#EnableAlwaysIncludeHeaderText#1-108"
                );
                col_header_cell =
                    dgv.Columns[0].HeaderCell
                    as DataGridViewColumnHeaderTest.DataGridViewColumnHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    string.Format("A{0}", Environment.NewLine),
                    code,
                    "#EnableAlwaysIncludeHeaderText#1-109"
                );
                col_header_cell =
                    dgv.Columns[0].HeaderCell
                    as DataGridViewColumnHeaderTest.DataGridViewColumnHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    string.Format("A{0}", Environment.NewLine),
                    code,
                    "#EnableAlwaysIncludeHeaderText#1-111"
                );
                col_header_cell =
                    dgv.Columns[0].HeaderCell
                    as DataGridViewColumnHeaderTest.DataGridViewColumnHeaderClipboardCell;
            ...
            using (DataGridView dgv = DataGridViewCommon.CreateAndFillForClipboard())
            {
                ...
                Assert.AreEqual(
                    string.Format("Row#1{0}", Environment.NewLine),
                    code,
                    "#EnableAlwaysIncludeHeaderText#2-5"
                );
                row_header_cell =
                    dgv.Rows[0].HeaderCell
                    as DataGridViewRowHeaderTest.DataGridViewRowHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    "<TABLE><TR><TD ALIGN=\"center\"><B>Row#1</B></TD></TR>",
                    code,
                    "#EnableAlwaysIncludeHeaderText#2-6"
                );
                row_header_cell =
                    dgv.Rows[0].HeaderCell
                    as DataGridViewRowHeaderTest.DataGridViewRowHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    string.Format("Row#1{0}", Environment.NewLine),
                    code,
                    "#EnableAlwaysIncludeHeaderText#2-7"
                );
                row_header_cell =
                    dgv.Rows[0].HeaderCell
                    as DataGridViewRowHeaderTest.DataGridViewRowHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    "<TR><TD ALIGN=\"center\"><B>Row#1</B></TD></TR></TABLE>",
                    code,
                    "#EnableAlwaysIncludeHeaderText#2-10"
                );
                row_header_cell =
                    dgv.Rows[0].HeaderCell
                    as DataGridViewRowHeaderTest.DataGridViewRowHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    string.Format("Row#1{0}", Environment.NewLine),
                    code,
                    "#EnableAlwaysIncludeHeaderText#2-12"
                );
                row_header_cell =
                    dgv.Rows[0].HeaderCell
                    as DataGridViewRowHeaderTest.DataGridViewRowHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    string.Format("Row#1{0}", Environment.NewLine),
                    code,
                    "#EnableAlwaysIncludeHeaderText#2-13"
                );
                row_header_cell =
                    dgv.Rows[0].HeaderCell
                    as DataGridViewRowHeaderTest.DataGridViewRowHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    "<TR><TD ALIGN=\"center\"><B>Row#1</B></TD></TR>",
                    code,
                    "#EnableAlwaysIncludeHeaderText#2-14"
                );
                row_header_cell =
                    dgv.Rows[0].HeaderCell
                    as DataGridViewRowHeaderTest.DataGridViewRowHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    string.Format("Row#1{0}", Environment.NewLine),
                    code,
                    "#EnableAlwaysIncludeHeaderText#2-15"
                );
                row_header_cell =
                    dgv.Rows[0].HeaderCell
                    as DataGridViewRowHeaderTest.DataGridViewRowHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    "<TABLE><TR><TD ALIGN=\"center\"><B>Row#1</B></TD>",
                    code,
                    "#EnableAlwaysIncludeHeaderText#2-18"
                );
                row_header_cell =
                    dgv.Rows[0].HeaderCell
                    as DataGridViewRowHeaderTest.DataGridViewRowHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    "<TABLE><TR><TD ALIGN=\"center\"><B>Row#1</B></TD>",
                    code,
                    "#EnableAlwaysIncludeHeaderText#2-22"
                );
                row_header_cell =
                    dgv.Rows[0].HeaderCell
                    as DataGridViewRowHeaderTest.DataGridViewRowHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    "<TR><TD ALIGN=\"center\"><B>Row#1</B></TD>",
                    code,
                    "#EnableAlwaysIncludeHeaderText#2-26"
                );
                row_header_cell =
                    dgv.Rows[0].HeaderCell
                    as DataGridViewRowHeaderTest.DataGridViewRowHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    "<TR><TD ALIGN=\"center\"><B>Row#1</B></TD>",
                    code,
                    "#EnableAlwaysIncludeHeaderText#2-30"
                );
                row_header_cell =
                    dgv.Rows[0].HeaderCell
                    as DataGridViewRowHeaderTest.DataGridViewRowHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    "<TABLE><TR><TD ALIGN=\"center\"><B>Row#1</B></TD></TR></TABLE>",
                    code,
                    "#EnableAlwaysIncludeHeaderText#2-34"
                );
                row_header_cell =
                    dgv.Rows[0].HeaderCell
                    as DataGridViewRowHeaderTest.DataGridViewRowHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    string.Format("Row#1{0}", Environment.NewLine),
                    code,
                    "#EnableAlwaysIncludeHeaderText#2-36"
                );
                row_header_cell =
                    dgv.Rows[0].HeaderCell
                    as DataGridViewRowHeaderTest.DataGridViewRowHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    string.Format("Row#1{0}", Environment.NewLine),
                    code,
                    "#EnableAlwaysIncludeHeaderText#2-37"
                );
                row_header_cell =
                    dgv.Rows[0].HeaderCell
                    as DataGridViewRowHeaderTest.DataGridViewRowHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    "<TABLE><TR><TD ALIGN=\"center\"><B>Row#1</B></TD></TR>",
                    code,
                    "#EnableAlwaysIncludeHeaderText#2-38"
                );
                row_header_cell =
                    dgv.Rows[0].HeaderCell
                    as DataGridViewRowHeaderTest.DataGridViewRowHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    string.Format("Row#1{0}", Environment.NewLine),
                    code,
                    "#EnableAlwaysIncludeHeaderText#2-39"
                );
                row_header_cell =
                    dgv.Rows[0].HeaderCell
                    as DataGridViewRowHeaderTest.DataGridViewRowHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    "<TR><TD ALIGN=\"center\"><B>Row#1</B></TD></TR></TABLE>",
                    code,
                    "#EnableAlwaysIncludeHeaderText#2-42"
                );
                row_header_cell =
                    dgv.Rows[0].HeaderCell
                    as DataGridViewRowHeaderTest.DataGridViewRowHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    string.Format("Row#1{0}", Environment.NewLine),
                    code,
                    "#EnableAlwaysIncludeHeaderText#2-44"
                );
                row_header_cell =
                    dgv.Rows[0].HeaderCell
                    as DataGridViewRowHeaderTest.DataGridViewRowHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    string.Format("Row#1{0}", Environment.NewLine),
                    code,
                    "#EnableAlwaysIncludeHeaderText#2-45"
                );
                row_header_cell =
                    dgv.Rows[0].HeaderCell
                    as DataGridViewRowHeaderTest.DataGridViewRowHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    "<TR><TD ALIGN=\"center\"><B>Row#1</B></TD></TR>",
                    code,
                    "#EnableAlwaysIncludeHeaderText#2-46"
                );
                row_header_cell =
                    dgv.Rows[0].HeaderCell
                    as DataGridViewRowHeaderTest.DataGridViewRowHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    string.Format("Row#1{0}", Environment.NewLine),
                    code,
                    "#EnableAlwaysIncludeHeaderText#2-47"
                );
                row_header_cell =
                    dgv.Rows[0].HeaderCell
                    as DataGridViewRowHeaderTest.DataGridViewRowHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    "<TABLE><TR><TD ALIGN=\"center\"><B>Row#1</B></TD>",
                    code,
                    "#EnableAlwaysIncludeHeaderText#2-50"
                );
                row_header_cell =
                    dgv.Rows[0].HeaderCell
                    as DataGridViewRowHeaderTest.DataGridViewRowHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    "<TABLE><TR><TD ALIGN=\"center\"><B>Row#1</B></TD>",
                    code,
                    "#EnableAlwaysIncludeHeaderText#2-54"
                );
                row_header_cell =
                    dgv.Rows[0].HeaderCell
                    as DataGridViewRowHeaderTest.DataGridViewRowHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    "<TR><TD ALIGN=\"center\"><B>Row#1</B></TD>",
                    code,
                    "#EnableAlwaysIncludeHeaderText#2-58"
                );
                row_header_cell =
                    dgv.Rows[0].HeaderCell
                    as DataGridViewRowHeaderTest.DataGridViewRowHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    "<TR><TD ALIGN=\"center\"><B>Row#1</B></TD>",
                    code,
                    "#EnableAlwaysIncludeHeaderText#2-62"
                );
                row_header_cell =
                    dgv.Rows[0].HeaderCell
                    as DataGridViewRowHeaderTest.DataGridViewRowHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    "<TABLE><THEAD><TH>A</TH></THEAD></TABLE>",
                    code,
                    "#EnableAlwaysIncludeHeaderText#2-66"
                );
                col_header_cell =
                    dgv.Columns[0].HeaderCell
                    as DataGridViewColumnHeaderTest.DataGridViewColumnHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    string.Format("A{0}", Environment.NewLine),
                    code,
                    "#EnableAlwaysIncludeHeaderText#2-68"
                );
                col_header_cell =
                    dgv.Columns[0].HeaderCell
                    as DataGridViewColumnHeaderTest.DataGridViewColumnHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    string.Format("A{0}", Environment.NewLine),
                    code,
                    "#EnableAlwaysIncludeHeaderText#2-69"
                );
                col_header_cell =
                    dgv.Columns[0].HeaderCell
                    as DataGridViewColumnHeaderTest.DataGridViewColumnHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    "<TABLE><THEAD><TH>A</TH></THEAD>",
                    code,
                    "#EnableAlwaysIncludeHeaderText#2-70"
                );
                col_header_cell =
                    dgv.Columns[0].HeaderCell
                    as DataGridViewColumnHeaderTest.DataGridViewColumnHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    string.Format("A{0}", Environment.NewLine),
                    code,
                    "#EnableAlwaysIncludeHeaderText#2-71"
                );
                col_header_cell =
                    dgv.Columns[0].HeaderCell
                    as DataGridViewColumnHeaderTest.DataGridViewColumnHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    "<TABLE><THEAD><TH>A</TH></THEAD></TABLE>",
                    code,
                    "#EnableAlwaysIncludeHeaderText#2-74"
                );
                col_header_cell =
                    dgv.Columns[0].HeaderCell
                    as DataGridViewColumnHeaderTest.DataGridViewColumnHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    string.Format("A{0}", Environment.NewLine),
                    code,
                    "#EnableAlwaysIncludeHeaderText#2-76"
                );
                col_header_cell =
                    dgv.Columns[0].HeaderCell
                    as DataGridViewColumnHeaderTest.DataGridViewColumnHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    string.Format("A{0}", Environment.NewLine),
                    code,
                    "#EnableAlwaysIncludeHeaderText#2-77"
                );
                col_header_cell =
                    dgv.Columns[0].HeaderCell
                    as DataGridViewColumnHeaderTest.DataGridViewColumnHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    "<TABLE><THEAD><TH>A</TH></THEAD>",
                    code,
                    "#EnableAlwaysIncludeHeaderText#2-78"
                );
                col_header_cell =
                    dgv.Columns[0].HeaderCell
                    as DataGridViewColumnHeaderTest.DataGridViewColumnHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    string.Format("A{0}", Environment.NewLine),
                    code,
                    "#EnableAlwaysIncludeHeaderText#2-79"
                );
                col_header_cell =
                    dgv.Columns[0].HeaderCell
                    as DataGridViewColumnHeaderTest.DataGridViewColumnHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    "<TABLE><THEAD><TH>A</TH>",
                    code,
                    "#EnableAlwaysIncludeHeaderText#2-82"
                );
                col_header_cell =
                    dgv.Columns[0].HeaderCell
                    as DataGridViewColumnHeaderTest.DataGridViewColumnHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    "<TABLE><THEAD><TH>A</TH>",
                    code,
                    "#EnableAlwaysIncludeHeaderText#2-86"
                );
                col_header_cell =
                    dgv.Columns[0].HeaderCell
                    as DataGridViewColumnHeaderTest.DataGridViewColumnHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    "<TABLE><THEAD><TH>A</TH>",
                    code,
                    "#EnableAlwaysIncludeHeaderText#2-90"
                );
                col_header_cell =
                    dgv.Columns[0].HeaderCell
                    as DataGridViewColumnHeaderTest.DataGridViewColumnHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    "<TABLE><THEAD><TH>A</TH>",
                    code,
                    "#EnableAlwaysIncludeHeaderText#2-94"
                );
                col_header_cell =
                    dgv.Columns[0].HeaderCell
                    as DataGridViewColumnHeaderTest.DataGridViewColumnHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    "<TH>A</TH></THEAD></TABLE>",
                    code,
                    "#EnableAlwaysIncludeHeaderText#2-98"
                );
                col_header_cell =
                    dgv.Columns[0].HeaderCell
                    as DataGridViewColumnHeaderTest.DataGridViewColumnHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    string.Format("A{0}", Environment.NewLine),
                    code,
                    "#EnableAlwaysIncludeHeaderText#2-100"
                );
                col_header_cell =
                    dgv.Columns[0].HeaderCell
                    as DataGridViewColumnHeaderTest.DataGridViewColumnHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    string.Format("A{0}", Environment.NewLine),
                    code,
                    "#EnableAlwaysIncludeHeaderText#2-101"
                );
                col_header_cell =
                    dgv.Columns[0].HeaderCell
                    as DataGridViewColumnHeaderTest.DataGridViewColumnHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    string.Format("A{0}", Environment.NewLine),
                    code,
                    "#EnableAlwaysIncludeHeaderText#2-103"
                );
                col_header_cell =
                    dgv.Columns[0].HeaderCell
                    as DataGridViewColumnHeaderTest.DataGridViewColumnHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    "<TH>A</TH></THEAD></TABLE>",
                    code,
                    "#EnableAlwaysIncludeHeaderText#2-106"
                );
                col_header_cell =
                    dgv.Columns[0].HeaderCell
                    as DataGridViewColumnHeaderTest.DataGridViewColumnHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    string.Format("A{0}", Environment.NewLine),
                    code,
                    "#EnableAlwaysIncludeHeaderText#2-108"
                );
                col_header_cell =
                    dgv.Columns[0].HeaderCell
                    as DataGridViewColumnHeaderTest.DataGridViewColumnHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    string.Format("A{0}", Environment.NewLine),
                    code,
                    "#EnableAlwaysIncludeHeaderText#2-109"
                );
                col_header_cell =
                    dgv.Columns[0].HeaderCell
                    as DataGridViewColumnHeaderTest.DataGridViewColumnHeaderClipboardCell;
                ...
                Assert.AreEqual(
                    string.Format("A{0}", Environment.NewLine),
                    code,
                    "#EnableAlwaysIncludeHeaderText#2-111"
                );
                col_header_cell =
                    dgv.Columns[0].HeaderCell
                    as DataGridViewColumnHeaderTest.DataGridViewColumnHeaderClipboardCell;
