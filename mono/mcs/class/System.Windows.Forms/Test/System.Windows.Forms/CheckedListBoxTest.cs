...
namespace MonoTests.System.Windows.Forms
{
    ...
    public class CheckedListBoxTest : TestHelper
    {
        ...
        const string ExpectedEventsCheckedSorted =
            "ItemCheck, index 0, is: Unchecked, will be: Checked, item is: 'c'"
            + ", CheckedIndices: { }"
            + ";\n"
            + "ItemCheck, index 0, is: Unchecked, will be: Checked, item is: 'a'"
            + ", CheckedIndices: { '1', }"
            + ";\n"
            + "ItemCheck, index 2, is: Unchecked, will be: Checked, item is: 'd'"
            + ", CheckedIndices: { '0', '1', }"
            + ";\n"
            + "ItemCheck, index 1, is: Unchecked, will be: Checked, item is: 'b'"
        ...
        const string ExpectedEventsCheckedUnsorted =
            ...
            + ", CheckedIndices: { }"
            + ";\n"
            + "ItemCheck, index 1, is: Unchecked, will be: Checked, item is: 'a'"
            + ", CheckedIndices: { '0', }"
            + ";\n"
            + "ItemCheck, index 2, is: Unchecked, will be: Checked, item is: 'd'"
            + ", CheckedIndices: { '0', '1', }"
            + ";\n"
            + "ItemCheck, index 3, is: Unchecked, will be: Checked, item is: 'b'"
        ...
        class ItemCheckLoggingReceiver
        {
            ...
            public void HandleItemCheck(object sender, ItemCheckEventArgs e)
            {
                ...
                string text = String.Format(
                    "ItemCheck, index {0}, is: {1}, will be: {2}, item is: '{3}'"
                        + ", CheckedIndices: {{ {4}}}"
                        + ";\n",
                    e.Index,
                    e.CurrentValue,
        ...
        public void AddCheckedBoolToSorted()
        {
            AddBoolItems(
                ...
                Items,
                true,
                ExpectedAddPositionsSorted,
                ExpectedEventsCheckedSorted
            );
        }
        ...
        public void AddCheckedBoolToUnsorted()
        {
            AddBoolItems(
                ...
                Items,
                true,
                ExpectedAddPositionsUnsorted,
                ExpectedEventsCheckedUnsorted
            );
        }
        ...
        private void SetInitialState(
            ...
            int index,
            bool isChecked,
            ItemCheckNewValueSetReceiver target
        )
        {
