...
namespace MonoTests.System.Windows.Forms
{
    ...
    public class FlowPanelTests : TestHelper
    {
        ...
        public void PreferredSize()
        {
            ...
            Assert.AreEqual(
                new Size(212, 106),
                panel.GetPreferredSize(new Size(150, 150)),
                "2, WrapContents"
            );
            Assert.AreEqual(
                new Size(212, 106),
                panel.GetPreferredSize(new Size(1000, 1000)),
                "3, WrapContents"
            );
            Assert.AreEqual(
                new Size(212, 106),
                panel.GetPreferredSize(new Size(0, 0)),
                "4, WrapContents"
            );
            Assert.AreEqual(
                new Size(212, 106),
                panel.GetPreferredSize(new Size(1, 1)),
                "5, WrapContents"
            );
            Assert.AreEqual(
                new Size(212, 106),
                panel.GetPreferredSize(new Size(0, 150)),
                "6, WrapContents"
            );
            Assert.AreEqual(
                new Size(212, 106),
                panel.GetPreferredSize(new Size(150, 0)),
                "7, WrapContents"
            );
        }
