...
namespace MonoTests.System.Windows.Forms
{
    ...
    public class TextBoxTest : TestHelper
    {
        ...
        {
            string text =
                "blabla blablabalbalbalbalbalbal blabla blablabl bal "
    ...
    public class TextBoxAutoCompleteSourceConverterTest : TestHelper
    {
        ...
        public void One()
        {
            PropertyDescriptor pd = TypeDescriptor.GetProperties(typeof(TextBox))[
                "AutoCompleteSource"
            ];
            TypeConverter converter = pd.Converter;
            Assert.AreEqual(
                "System.Windows.Forms.TextBoxAutoCompleteSourceConverter",
                converter.GetType().FullName,
                "setup--converter type"
            );
