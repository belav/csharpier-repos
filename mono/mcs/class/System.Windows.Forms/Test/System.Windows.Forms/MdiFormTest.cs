...
*/
        ...
        [ExpectedException(
            ...
            ExpectedMessage = "Cannot add a top level control to a control."
        )]
        ...
        public void MdiClosingClosedEvent()
        {
            ...
            Assert.AreEqual(
                "Child.Closing: True, Child.FormClosing: True, Parent.Closing: True, Parent.FormClosing: True, ",
                events_fired,
                "A1-2.0"
            );
            ...
            Assert.AreEqual(
                "Child.Closing: False, Child.FormClosing: False, Parent.Closing: False, Parent.FormClosing: False, Child.Closed, Child.FormClosed, Parent.Closed, Parent.FormClosed, ",
                events_fired,
                "A2-2.0"
            );
