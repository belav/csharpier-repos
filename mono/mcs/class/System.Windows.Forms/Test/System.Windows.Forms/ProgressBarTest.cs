...
namespace MonoTests.System.Windows.Forms
{
    ...
    public class ProgressBarTest : TestHelper
    {
        ...
        public void ProgressBarPropertyTest()
        {
            ...
            Assert.AreEqual(
                Image.FromFile(gif, true).Size,
                myProgressBar.BackgroundImage.Size,
                "#B4"
            );
        ...
        public void Styles()
        {
            ...
            catch (global::System.ComponentModel.InvalidEnumArgumentException ex)
            {
                ...
                Assert.AreEqual(
                    typeof(global::System.ComponentModel.InvalidEnumArgumentException),
                    ex.GetType(),
                    "Typeof bad style4"
                );
        ...
        public void ToStringMethodTest()
        {
            ...
            myProgressBar.Text = "New ProgressBar";
            Assert.AreEqual(
                "System.Windows.Forms.ProgressBar, Minimum: 0, Maximum: 100, Value: 0",
                myProgressBar.ToString(),
                "#T3"
            );
        }
