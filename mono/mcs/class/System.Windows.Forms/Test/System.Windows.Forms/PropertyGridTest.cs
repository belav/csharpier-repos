    ...
    public class PropertyGridTest : TestHelper
    {
        ...
        public void PropertySort_Invalid()
        {
            ...
            catch (InvalidEnumArgumentException ex)
            {
                ...
                Assert.IsTrue(
                    ex.Message.IndexOf("(" + 666.ToString(CultureInfo.CurrentCulture) + ")") != -1,
                    "#6"
                );
        ...
        public void PropertyGrid_ArrayRootTest()
        {
            ...
            Assert.AreEqual(
                typeof(ArrayTest_object).ToString(),
                pg.SelectedGridItem.Parent.Parent.Label,
                "2"
            );
        ...
        public void PropertyGrid_ArrayChildrenTest()
        {
            ...
            Assert.AreEqual(
                ...
                pg.SelectedGridItem.GridItems[0].GridItemType,
                "2"
            );
