...
namespace MonoTests.System.Windows.Forms
{
    ...
    public class FormEvent : TestHelper
    {
        ...
        public void EventOrder()
        {
            ...
            string[] expectedEvents_Show = { "Load", "VisibleChanged", "GotFocus", "Activated" };
            ...
            Assert.IsTrue(
                logger.ContainsEventsOrdered(expectedEvents_Show),
                "#A1:" + logger.EventsJoined()
            );
            ...
            Assert.IsTrue(
                logger.ContainsEventsOrdered(expectedEvents_Close),
                "#B1:" + logger.EventsJoined()
            );
        ...
        public void EventOrder_Dialog()
        {
            ...
            _form.ShowDialog();
            Assert.IsTrue(
                logger.ContainsEventsOrdered(expectedEvents),
                "#A1:" + logger.EventsJoined()
            );
            Assert.AreEqual(1, logger.CountEvents("Load"), "#A2");
        ...
        public static void TestIdlePerThread2(object o, EventArgs e)
        {
            ...
            if (form2_OneIdlePerThread != null)
                form2_OneIdlePerThread.Invoke(new MethodInvoker(form2_OneIdlePerThread.Close));
    ...
    public class OnClosedOverride
    {
        ...
        public void OnClosedOverride_Test1()
        {
            ...
            using (var f = new ButtonedForm(removeButtonOnClick))
            {
                f.Show();
                Assert.Null(
                    f.onClosedForm.CatchedException,
                    "An exception has been detected in `WndProc`"
                );
            }
        }
        ...
        public void InputLanguageChangedEventTest()
        {
            ...
            try
            {
                if (InputLanguage.InstalledInputLanguages.Count > 1)
                {
                    ...
                    myform.InputLanguageChanged += new InputLanguageChangedEventHandler(
                        InputLanguage_Handler
                    );
    ...
    public class InputLanguageChangingEvent
    {
        ...
        public void InputLanguageChangingEventTest()
        {
            ...
            try
            {
                ...
                {
                    InputLanguage.CurrentInputLanguage = InputLanguage.InstalledInputLanguages[0];
                    myform.InputLanguageChanging += new InputLanguageChangingEventHandler(
                        InputLangChanging_Handler
                    );
                    Thread.CurrentThread.CurrentCulture = new CultureInfo("ta-IN");
                    Thread.CurrentThread.CurrentUICulture = Thread.CurrentThread.CurrentCulture;
                    InputLanguage.CurrentInputLanguage = InputLanguage.InstalledInputLanguages[1];
