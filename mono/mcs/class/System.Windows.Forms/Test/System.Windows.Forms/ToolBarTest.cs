...
namespace MonoTests.System.Windows.Forms
{
    ...
    public class ToolBarTest : TestHelper
    {
        ...
        public void ToolBarPropertyTest()
        {
            ...
            myToolBar.BackgroundImage = Image.FromFile(
                TestResourceHelper.GetFullPathOfResource("Test/resources/M.gif")
            );
        ...
        public void ToStringMethodTest()
        {
            ToolBar tb = new ToolBar();
            tb.Text = "New ToolBar";
            Assert.AreEqual("System.Windows.Forms.ToolBar, Buttons.Count: 0", tb.ToString(), "#1");
            ...
            Assert.AreEqual(
                "System.Windows.Forms.ToolBar, Buttons.Count: 2, "
