...
namespace MonoTests.System.Windows.Forms
{
    ...
    public class RtfTest
    {
        ...
        public void TestSimpleBold()
        {
            ...
            Assert.AreEqual(
                "<b><b>text</b></b>",
                ParsedText("{\\rtf1 \\b\\b text\\b0\\b0}"),
                "simplebold-6"
            );
        }
        ...
        public void TestSimpleItalic()
        {
            ...
            Assert.AreEqual(
                "<i><i>text</i></i>",
                ParsedText("{\\rtf1 \\i\\i text\\i0\\i0}"),
                "simpleitalic-6"
            );
        }
        ...
        public void TestSimpleStrikeThru()
        {
            ...
            Assert.AreEqual(
                "<s>text</s>",
                ParsedText("{\\rtf1 \\strike text\\strike0}"),
                "simplestrike-2"
            );
            Assert.AreEqual(
                "<s>text</s>",
            ...
            Assert.AreEqual(
                "<s><s>text",
                ParsedText("{\\rtf1 \\strike\\strike text}"),
                "simplestrike-5"
            );
            Assert.AreEqual(
                "<s><s>text</s></s>",
                ParsedText("{\\rtf1 \\strike\\strike text\\strike0\\strike0}"),
                "simplestrike-6"
            );
        }
