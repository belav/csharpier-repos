    ...
    internal class Error
    {
        ...
        public static Exception CreateDatabaseFailedBecauseOfContextWithNoTables(object p0)
        {
            return new Exception(
                SR.Format(SR.CreateDatabaseFailedBecauseOfContextWithNoTables, p0)
            );
        }
        ...
        {
            return new Exception(
                SR.Format(SR.CreateDatabaseFailedBecauseSqlCEDatabaseAlreadyExists, p0)
            );
        }
        ...
        public static Exception WrongNumberOfValuesInCollectionArgument(
            object p0,
            object p1,
            object p2
        )
        ...
        {
            return new Exception(
                SR.Format(SR.NonCountAggregateFunctionsAreNotValidOnProjections, p0)
            );
        }
        ...
        public static Exception CouldNotRemoveRelationshipBecauseOneSideCannotBeNull(
            object p0,
            object p1,
            object p2
        )
        {
            return new Exception(
                SR.Format(SR.CouldNotRemoveRelationshipBecauseOneSideCannotBeNull, p0, p1, p2)
            );
        }
        ...
        {
            return new Exception(
                SR.Format(SR.EntitySetDataBindingWithNonPublicDefaultConstructor, p0)
            );
        }
...
{
    // in the generated class in referencesource this seems to be in two different namespaces, we just
