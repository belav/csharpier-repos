...
namespace MonoTests.Microsoft.Build.Tasks
{
    ...
    public class CreateVisualBasicManifestResourceNameTest
    {
        ...
        public CreateVisualBasicManifestResourceNameTest()
        {
            ...
            string sample_vb_path = TestResourceHelper.GetFullPathOfResource(
        ...
        public void TestWithRootNamespaceWithCulture()
        {
            CheckResourceNames(
                ...
                {
                    // With dependent file
                    "RN1.RN2.Mono.Tests.Sample.de",
                    "RN1.RN2.Mono.Tests.Sample.de",
                    "RN1.RN2.Mono.Tests.Sample.fr",
        ...
        public void TestExternalResourcesNoRootNamespaceNoTargetPath()
        {
            CheckResourceNames(
                ...
                new string[] { "foo.txt", Path.Combine("de", "foo.txt") },
                null
            );
        }
        ...
        public void TestExternalResourcesWithRootNamespaceNoTargetPath()
        {
            CheckResourceNames(
                ...
                new string[] { "RN.foo.txt", Path.Combine("de", "RN.foo.txt") },
                "RN"
            );
        }
        ...
        string CreateProject(string[,] files, string rootNamespace)
        {
            ...
            sb.Append(
                "\t\t<CreateVisualBasicManifestResourceName ResourceFiles=\"@(ResourceFiles)\" "
            );
