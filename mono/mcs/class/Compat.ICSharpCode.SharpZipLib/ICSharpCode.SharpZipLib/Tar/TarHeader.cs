...
namespace ICSharpCode.SharpZipLib.Tar
{
    ...
    public class TarHeader : ICloneable
    {
        ...
        public object Clone()
        {
            ...
            hdr.linkName =
                (this.linkName == null) ? null : new StringBuilder(this.linkName.ToString());
            hdr.magic = (this.magic == null) ? null : new StringBuilder(this.magic.ToString());
            hdr.version =
                (this.version == null) ? null : new StringBuilder(this.version.ToString());
            hdr.userName =
                (this.userName == null) ? null : new StringBuilder(this.userName.ToString());
            hdr.groupName =
                (this.groupName == null) ? null : new StringBuilder(this.groupName.ToString());
        ...
        public void WriteHeader(byte[] outbuf)
        {
            ...
            offset = GetLongOctalBytes(
                GetCTime(this.modTime),
                outbuf,
                offset,
