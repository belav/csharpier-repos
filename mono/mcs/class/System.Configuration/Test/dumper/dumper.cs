...
public class Dumper
{
    ...
    public void DumpProperties()
    {
        foreach (object o in things)
        {
            ...
            ConfigurationPropertyCollection col = (ConfigurationPropertyCollection)
                pinfo.GetValue(o, null);
    ...
    public void DumpElementProperties()
    {
        foreach (object o in things)
        {
            ...
            if (p == null)
                ...
                Console.WriteLine(
                    "{0}.ElementProperty (Validator) = {1} ({2})",
                    type,
                    p.Validator,
                    p.Validator.CanValidate(type)
                );
        }
    }
