...
namespace MonoTests.Microsoft.VisualBasic
{
    ...
    public class CodeGeneratorFromTypeTest_Class : CodeGeneratorFromTypeTestBase
    {
        ...
        public override void SimpleTypeTest()
        {
            ...
            Assert.AreEqual(
                string.Format(
                    CultureInfo.InvariantCulture,
                    "Public Class Test1{0}" + "End Class{0}",
                    NewLine
                ),
                code
            );
        ...
        {
            string code = GenerateFieldMembersType(
                MemberAttributes.Assembly | MemberAttributes.New,
                Options
            );
            Assert.AreEqual(
                string.Format(
        ...
        {
            string code = GeneratePropertyMembersType(
        ...
        {
            string code = GeneratePropertyMembersType(MemberAttributes.Family, true, true, Options);
            Assert.AreEqual(
                string.Format(
                    CultureInfo.InvariantCulture,
                    "Public Class Test1{0}"
        ...
        {
            string code = GeneratePropertyIndexer(
                MemberAttributes.Public,
                false,
                false,
                true,
        ...
        {
            string code = GeneratePropertyMembersType(
                MemberAttributes.Private | MemberAttributes.New,
                true,
                true,
                Options
            );
        ...
        public override void PartialTypeTest()
        {
            ...
            Assert.AreEqual(
                string.Format(
                    CultureInfo.InvariantCulture,
                    "Partial Public Class Test1{0}" + "End Class{0}",
                    NewLine
                ),
                code
            );
    ...
    public class CodeGeneratorFromTypeTest_Delegate : CodeGeneratorFromTypeTestBase
    {
        ...
        public override void DefaultTypeTest()
        {
            string code = GenerateDefaultType(Options);
            Assert.AreEqual(
                string.Format(CultureInfo.InvariantCulture, "Public Delegate Sub (){0}", NewLine),
                code
            );
        }
        ...
        public override void DerivedTypeTest()
        {
            string code = GenerateDerivedType(Options);
            Assert.AreEqual(
                string.Format(CultureInfo.InvariantCulture, "Delegate Sub Test1(){0}", NewLine),
                code
            );
        }
        ...
        public override void AttributesAndTypeTest()
        {
            ...
            Assert.AreEqual(
                string.Format(
                    ...
                    "<A(),  _{0}"
                        + " B()>  _{0}"
                        + "Public Delegate Function Test1() As Integer{0}",
                    NewLine
                ),
                code
            );
        ...
        public override void PropertyOverloadsTest2()
        {
            ...
            Assert.AreEqual(
                string.Format(
                    CultureInfo.InvariantCulture,
                    "Public Delegate Sub Test1(){0}{0}{0}",
                    NewLine
                ),
                code
            );
        ...
        public void DelegateWithParametersTest()
        {
            ...
            Assert.AreEqual(
                string.Format(
                    CultureInfo.InvariantCulture,
                    "Public Delegate Sub A(ByVal param As type){0}",
                    NewLine
                ),
                code
            );
    ...
    public class CodeGeneratorFromTypeTest_Interface : CodeGeneratorFromTypeTestBase
    {
        ...
        public override void DefaultTypeTest()
        {
            ...
            Assert.AreEqual(
                string.Format(
                    CultureInfo.InvariantCulture,
                    "Public Interface {0}" + "End Interface{0}",
                    NewLine
                ),
                code
            );
        ...
        public override void SimpleTypeTest()
        {
            ...
            Assert.AreEqual(
                string.Format(
                    CultureInfo.InvariantCulture,
                    "Public Interface Test1{0}" + "End Interface{0}",
                    NewLine
                ),
                code
            );
        ...
        public override void FieldMembersAttributesTest()
        {
            ...
            Assert.AreEqual(
                string.Format(
                    CultureInfo.InvariantCulture,
                    "Public Interface Test1{0}" + "    {0}" + "End Interface{0}",
                    NewLine
                ),
                code
            );
        ...
        public override void PartialTypeTest()
        {
            ...
            Assert.AreEqual(
                string.Format(
                    CultureInfo.InvariantCulture,
                    "Partial Public Interface Test1{0}" + "End Interface{0}",
                    NewLine
                ),
                code
            );
    ...
    public class CodeGeneratorFromTypeTest_Struct : CodeGeneratorFromTypeTestBase
    {
        ...
        public override void DefaultTypeTest()
        {
            ...
            Assert.AreEqual(
                string.Format(
                    CultureInfo.InvariantCulture,
                    "Public Structure {0}" + "End Structure{0}",
                    NewLine
                ),
                code
            );
        ...
        public override void SimpleTypeTest()
        {
            ...
            Assert.AreEqual(
                string.Format(
                    CultureInfo.InvariantCulture,
                    "Public Structure Test1{0}" + "End Structure{0}",
                    NewLine
                ),
                code
            );
        ...
        public override void PartialTypeTest()
        {
            ...
            Assert.AreEqual(
                string.Format(
                    CultureInfo.InvariantCulture,
                    "Partial Public Structure Test1{0}" + "End Structure{0}",
                    NewLine
                ),
                code
            );
    ...
    public class CodeGeneratorFromTypeTest_Enum : CodeGeneratorFromTypeTestBase
    {
        ...
        public override void SimpleTypeTest()
        {
            ...
            Assert.AreEqual(
                string.Format(
                    CultureInfo.InvariantCulture,
                    "Public Enum Test1{0}" + "End Enum{0}",
                    NewLine
                ),
                code
            );
        ...
        public override void DerivedTypeTest()
        {
            ...
            Assert.AreEqual(
                string.Format(
                    CultureInfo.InvariantCulture,
                    "Friend Enum Test1 As Integer{0}" + "End Enum{0}",
                    NewLine
                ),
                code
            );
        ...
        public override void AttributesAndTypeTest()
        {
            ...
            Assert.AreEqual(
                string.Format(
                    CultureInfo.InvariantCulture,
                    "<A(),  _{0}" + " B()>  _{0}" + "Public Enum Test1{0}" + "End Enum{0}",
                    NewLine
                ),
                code
            );
        ...
        public override void EventMembersTypeTest1()
        {
            ...
            Assert.AreEqual(
                string.Format(
                    CultureInfo.InvariantCulture,
                    "Public Enum Test1{0}" + "    {0}" + "End Enum{0}",
                    NewLine
                ),
                code
            );
        ...
        public override void FieldMembersTypeTest()
        {
            ...
            Assert.AreEqual(
                string.Format(
                    CultureInfo.InvariantCulture,
                    "Public Enum Test1{0}" + "    {0}" + "    Name = 2{0}" + "End Enum{0}",
                    NewLine
                ),
                code
            );
        ...
        public override void PropertyOverloadsTest2()
        {
            ...
            Assert.AreEqual(
                string.Format(
                    CultureInfo.InvariantCulture,
                    "Public Enum Test1{0}" + "    {0}" + "    {0}" + "End Enum{0}",
                    NewLine
                ),
                code
            );
        ...
        public override void PartialTypeTest()
        {
            ...
            Assert.AreEqual(
                string.Format(
                    CultureInfo.InvariantCulture,
                    "Partial Public Enum Test1{0}" + "End Enum{0}",
                    NewLine
                ),
                code
            );
