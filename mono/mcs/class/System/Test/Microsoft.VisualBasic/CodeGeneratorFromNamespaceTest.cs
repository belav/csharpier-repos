    ...
    public class CodeGeneratorFromNamespaceTest : CodeGeneratorTestBase
    {
        ...
        public void ImportsTest()
        {
            ...
            Assert.AreEqual(
                string.Format(
                    ...
                    "Imports System{0}" + "Imports System.Collections{0}" + "{0}",
                    NewLine
                ),
                Generate(),
                "#1"
            ...
            Assert.AreEqual(
                string.Format(
                    CultureInfo.InvariantCulture,
                    "Imports System{0}" + "Imports System.Collections{0}" + "{0}" + "'a{0}",
                    NewLine
                ),
                Generate(),
                "#3"
        ...
        public void TypeTest()
        {
            ...
            Assert.AreEqual(
                string.Format(
                    CultureInfo.InvariantCulture,
                    "{0}" + "{0}" + "Public Class Person{0}" + "End Class{0}",
                    NewLine
                ),
                Generate(),
                "#A1"
            ...
            Assert.AreEqual(
                string.Format(
                    CultureInfo.InvariantCulture,
                    "{0}" + "Public Class Person{0}" + "End Class{0}",
                    NewLine
                ),
                Generate(options),
                "#A2"
