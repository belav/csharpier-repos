...
namespace MonoTests.Microsoft.VisualBasic
{
    ...
    public class CodeGeneratorFromStatementTest : CodeGeneratorTestBase
    {
        ...
        public void CodeAssignStatementTest()
        {
            ...
            Assert.AreEqual(
                string.Format(CultureInfo.InvariantCulture, "A = B{0}", NewLine),
                Generate(),
                "#1"
            );
        ...
        public void CodeAttachEventStatementTest()
        {
            ...
            Assert.AreEqual(
                string.Format(
                    CultureInfo.InvariantCulture,
                    "AddHandler A.[class], EventHandler{0}",
                    NewLine
                ),
                Generate(),
                "#4"
            ...
            Assert.AreEqual(
                string.Format(CultureInfo.InvariantCulture, "AddHandler ., {0}", NewLine),
                Generate(),
                "#6"
            );
        }
        ...
        public void CodeAttachEventStatementKeywordTest()
        {
            ...
            attachEventStatement.Listener = handler;
            Assert.AreEqual(
                string.Format(CultureInfo.InvariantCulture, "AddHandler , Handles{0}", NewLine),
                Generate(),
                "#3"
            );
            ...
            Assert.AreEqual(
                string.Format(
                    CultureInfo.InvariantCulture,
                    "AddHandler Set.[Event], Handles{0}",
                    NewLine
                ),
                Generate(),
                "#4"
        ...
        public void CodeCommentStatementTest()
        {
            ...
            Assert.AreEqual(
                string.Format(CultureInfo.InvariantCulture, "'{0}", NewLine),
                Generate(),
                "#1"
            );
            ...
            comment.Text = "a\nb";
            Assert.AreEqual(
                string.Format(CultureInfo.InvariantCulture, "'a\n'b{0}", NewLine),
                Generate(),
                "#2"
            );
            ...
            comment.Text = "a\rb";
            Assert.AreEqual(
                string.Format(CultureInfo.InvariantCulture, "'a\r'b{0}", NewLine),
                Generate(),
                "#4"
            );
        }
        ...
        public void CodeConditionStatementTest()
        {
            ...
            Assert.AreEqual(
                string.Format(CultureInfo.InvariantCulture, "If  Then{0}" + "End If{0}", NewLine),
                Generate(),
                "#2"
            );
        ...
        public void CodeExpressionStatementTest()
        {
            ...
            Assert.AreEqual(
                string.Format(CultureInfo.InvariantCulture, "something{0}", NewLine),
                Generate(),
                "#2"
            );
        }
        ...
        public void CodeGotoStatementTest()
        {
            ...
            Assert.AreEqual(
                string.Format(CultureInfo.InvariantCulture, "goto something{0}", NewLine),
                Generate()
            );
        }
        ...
        public void CodeLabeledStatementTest()
        {
            ...
            cls.Label = "class";
            Assert.AreEqual(
                string.Format(CultureInfo.InvariantCulture, "class:{0}", NewLine),
                Generate(),
                "#2"
            );
            ...
            Assert.AreEqual(
                string.Format(CultureInfo.InvariantCulture, "class:{0}" + "A{0}", NewLine),
                Generate(),
                "#3"
            );
        }
        ...
        public void CodeMethodReturnStatementTest()
        {
            ...
            Assert.AreEqual(
                string.Format(CultureInfo.InvariantCulture, "Return{0}", NewLine),
                Generate(),
                "#1"
            );
            ...
            Assert.AreEqual(
                string.Format(CultureInfo.InvariantCulture, "Return 1{0}", NewLine),
                Generate(),
                "#2"
            );
        }
        ...
        public void CodeRemoveEventStatementTest()
        {
            ...
            Assert.AreEqual(
                string.Format(
                    CultureInfo.InvariantCulture,
                    "RemoveHandler A.[class], EventHandler{0}",
                    NewLine
                ),
                Generate(),
                "#4"
            ...
            Assert.AreEqual(
                string.Format(CultureInfo.InvariantCulture, "RemoveHandler ., {0}", NewLine),
                Generate(),
                "#6"
            );
        }
        ...
        public void CodeThrowExceptionStatementTest()
        {
            ...
            statement = ctet;
            Assert.AreEqual(
                string.Format(CultureInfo.InvariantCulture, "Throw{0}", NewLine),
                Generate(),
                "#1"
            );
            ...
            Assert.AreEqual(
                string.Format(CultureInfo.InvariantCulture, "Throw whatever{0}", NewLine),
                Generate(),
                "#2"
            );
        }
        ...
        public void CodeTryCatchFinallyStatementTest()
        {
            ...
            statement = new CodeTryCatchFinallyStatement(
                new CodeStatement[] { cs },
                new CodeCatchClause[] { ccc1, ccc2 },
                new CodeStatement[] { fin1, fin2 }
            );
            ...
            Assert.AreEqual(
                string.Format(CultureInfo.InvariantCulture, "Try {0}" + "End Try{0}", NewLine),
                Generate(),
                "#3"
            );
        ...
        public void CodeVariableDeclarationStatementTest()
        {
            ...
            cvds.Name = "A";
            Assert.AreEqual(
                string.Format(CultureInfo.InvariantCulture, "Dim A As System.Void{0}", NewLine),
                Generate(),
                "#3"
            );
            ...
            Assert.AreEqual(
                string.Format(CultureInfo.InvariantCulture, "Dim A As Integer{0}", NewLine),
                Generate(),
                "#4"
            );
            ...
            Assert.AreEqual(
                string.Format(CultureInfo.InvariantCulture, "Dim A As Integer = 25{0}", NewLine),
                Generate(),
                "#5"
            );
