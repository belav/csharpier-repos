...
namespace MonoTests.Microsoft.VisualBasic
{
    ...
    public class VBCodeProviderTest
    {
        ...
        private static readonly string _sourceLibrary1 =
            "Public Class Test1" + Environment.NewLine + "End Class";
        private static readonly string _sourceLibrary2 =
            "Public Class Test2" + Environment.NewLine + "End Class";
        ...
        public void GeneratorSupports()
        {
            ...
            Assert.IsTrue(
                codeGenerator.Supports(GeneratorSupport.ChainedConstructorArguments),
                "#4"
            );
        ...
        public void CreateCompiler()
        {
            ...
            // process compilation
            CompilerResults compilerResults = codeCompiler.CompileAssemblyFromSource(
                options,
            ...
            {
                Assert.Fail(
                    "#JW32 - compilerResults.CompiledAssembly hasn't been an expected object"
                        + Environment.NewLine
                        + ex.Message
                        + Environment.NewLine
                        + ex.StackTrace
        ...
        public void CompileFromFile_InMemory()
        {
            ...
            CompilerResults results = compiler.CompileAssemblyFromFile(options, sourceFile);
        ...
        public void CompileFromSource_InMemory()
        {
            ...
            ICodeCompiler compiler = _codeProvider.CreateCompiler();
            CompilerResults results = compiler.CompileAssemblyFromSource(options, _sourceLibrary1);
        ...
        public void CompileFromDomBatch_InMemory()
        {
            ...
            ICodeCompiler compiler = _codeProvider.CreateCompiler();
            CompilerResults results = compiler.CompileAssemblyFromDomBatch(
                options,
