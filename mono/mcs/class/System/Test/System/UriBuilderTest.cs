...
namespace MonoTests.System
{
    ...
    public class UriBuilderTest
    {
        ...
        public void Equals()
        {
            ...
            Assert.AreEqual(
                "http://www.ximian.com:80/foo/bar/index.html%3Fitem=1",
                b.ToString(),
                "1.ToString"
            );
            ...
            Assert.AreEqual(
                "http://www.ximian.com:80/foo/bar/index.html?item=1",
                b2.ToString(),
                "2.ToString"
            );
        ...
        public void IPv6_Host_IncompleteAddress()
        {
            ...
            Assert.AreEqual(
                "http://[1:2:3:4:5:6:7:8]:8080/dir/subdir/file",
                ub.ToString(),
                "1.ToString ()"
            );
        ...
        public void AspNetRedirectUsage_Old()
        {
            ...
            Assert.AreEqual(
                "http://192.168.0.21/error404.aspx%3Faspxerrorpath=/WebResource.axd",
                ub.Uri.ToString()
            );
        }
        ...
        public void AspNetRedirectUsage_New()
        {
            ...
            Assert.AreEqual(
                "http://192.168.0.21/error404.aspx?aspxerrorpath=/WebResource.axd",
                ub.Uri.ToString()
            );
        }
