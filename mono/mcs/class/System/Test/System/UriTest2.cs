...
namespace MonoTests.System
{
    ...
    static class Assert2
    {
        ...
        )
        {
            ...
            catch (Exception ex)
            {
                ...
                if (expected_inner_exception != null)
                {
                    ...
                    if (ex.InnerException.GetType() != expected_inner_exception)
                        throw new AssertionException(
                            string.Format(
                                "Expected InnerException '{0}', got '{1}'. {2}",
                                expected_inner_exception.FullName,
            ...
            if (failed)
                throw new AssertionException(
                    string.Format(
                        "Expected '{0}', but got no exception. {1}",
                        expected_exception.FullName,
                        message
                    )
                );
    ...
    public class UriTest2
    {
        ...
        public void SetUp()
        {
            ...
            FieldInfo iriParsingField = typeof(Uri).GetField(
                "s_IriParsing",
        ...
        private void FromResource(string res, Uri baseUri)
        {
            StreamReader sr = new StreamReader(
                TestResourceHelper.GetFullPathOfResource(res),
                Encoding.UTF8
            );
            while (sr.Peek() > 0)
            {
                ...
                */
                ...
                {
                    Assert.Fail(
                        String.Format("Construction failed: [{0}] {1}", uriString, ex.Message)
                    );
                }
            }
        }
        ...
        public void HttpWithNonStandardPort()
        {
            ...
            Assert.AreEqual(
                "http://monkey:s3kr3t@host.domain.com:8080/app.xap?option=1",
                uri.AbsoluteUri,
                "AbsoluteUri"
            );
            Assert.AreEqual("host.domain.com", uri.DnsSafeHost, "DnsSafeHost");
        ...
        public void HttpsWithoutPort()
        {
            ...
            else
            {
                Assert.AreEqual("/dir/app.xap", uri.AbsolutePath, "AbsolutePath");
                Assert.AreEqual(
                    "https://host.domain.com/dir/app.xap#",
                    uri.AbsoluteUri,
                    "AbsoluteUri"
                );
            }
        ...
        public void HttpsWithNonStandardPort()
        {
            ...
            else
            {
                Assert.AreEqual("/app.xap", uri.AbsolutePath, "AbsolutePath");
                Assert.AreEqual(
                    "https://monkey:s3kr3t@host.domain.com:4430/app.xap?",
                    uri.AbsoluteUri,
                    "AbsoluteUri"
                );
                Assert.AreEqual("/app.xap", uri.LocalPath, "LocalPath");
        ...
        public void Relative()
        {
            ...
            Assert2.Throws<ArgumentOutOfRangeException>(
                delegate
                {
        ...
        public void Bug496783()
        {
            ...
            Assert.AreEqual(
                uri.Authority,
                uri.GetComponents(UriComponents.HostAndPort, UriFormat.Unescaped),
                "HostAndPort"
            );
            Assert.AreEqual(
                uri.AbsoluteUri,
            ...
            Assert.AreEqual(
                String.Empty,
                uri.GetComponents(UriComponents.KeepDelimiter, UriFormat.Unescaped),
                "KeepDelimiter"
            );
            Assert.AreEqual(
                "Aneka",
            ...
            Assert.AreEqual(
                uri.Port.ToString(),
                uri.GetComponents(UriComponents.Port, UriFormat.Unescaped),
                "Port"
            );
            Assert.AreEqual(
                uri.Query,
            ...
            Assert.AreEqual(
                uri.Scheme,
                uri.GetComponents(UriComponents.Scheme, UriFormat.Unescaped),
                "Scheme"
            );
            Assert.AreEqual(
                "tcp://csve2.csse.unimelb.edu.au:9090",
                uri.GetComponents(UriComponents.SchemeAndServer, UriFormat.Unescaped),
                "SchemeAndServer"
            );
            Assert.AreEqual(
                uri.OriginalString,
                uri.GetComponents(UriComponents.SerializationInfoString, UriFormat.Unescaped),
                "SerializationInfoString"
            );
            Assert.AreEqual(
                uri.Authority,
                uri.GetComponents(UriComponents.StrongAuthority, UriFormat.Unescaped),
                "StrongAuthority"
            );
            Assert.AreEqual(
                uri.Port.ToString(),
                uri.GetComponents(UriComponents.StrongPort, UriFormat.Unescaped),
                "StrongPort"
            );
            Assert.AreEqual(
                uri.UserInfo,
                uri.GetComponents(UriComponents.UserInfo, UriFormat.Unescaped),
                "UserInfo"
            );
        }
        ...
        public void Merge_Query_Fragment()
        {
            ...
            Assert.AreEqual(
                "http://host/dir/subdir/weird;name?moonlight#mono",
                merged.ToString(),
                "merged.ToString"
            );
        }
        ...
        public void Merge_Query_Query()
        {
            ...
            Assert.AreEqual(
                "http://host/dir/subdir/weird;name?moon",
                merged.ToString(),
                "merged.ToString"
            );
        }
        ...
        public void Merge_Query_RelativePath()
        {
            ...
            Assert.AreEqual(
                "http://host/dir/subdir/index.html",
                merged.ToString(),
                "index.html ToString"
            );
            ...
            Assert.AreEqual(
                "http://host/dir/subdir/weird;name?moonlight",
                merged.ToString(),
                "ToString"
            );
        }
        ...
        public void Merge_Fragment_RelativePath()
        {
            ...
            Assert.AreEqual(
                "http://host/dir/subdir/weird;name#mono",
                merged.ToString(),
                "ToString"
            );
        }
        ...
        public void UnknownScheme()
        {
            ...
            Assert.AreEqual(
                "mono:c:/dir/subdir/file",
                uri.ToString().Replace("%5C", "/"),
                "ToString"
            );
            ...
            if (IriParsing)
                Assert.AreEqual(
                    "/%3C%3E%25%22%7B%7D%7C/%5E%60;/:@&=+$,[]",
                    uri.AbsolutePath,
                    "Special"
                );
            else
                Assert.AreEqual(
                    "/%3C%3E%25%22%7B%7D%7C/%5E%60;/:@&=+$,%5B%5D",
                    uri.AbsolutePath,
                    "Special"
                );
        }
        ...
        public void NewsScheme()
        {
            ...
            Assert.AreEqual(
                "news:novell.mono.moonlight/uri%3Fquery",
                uri.AbsoluteUri,
                "AbsoluteUri"
            );
            ...
            Assert.AreEqual(
                "news:novell.mono.moonlight/uri?query",
                uri.OriginalString,
                "OriginalString"
            );
            ...
            if (IriParsing)
                Assert.AreEqual(
                    "novell.mono.moonlight/%3C%3E%25%22%7B%7D%7C%5C%5E%60;/%3F:@&=+$,[]",
                    uri.AbsolutePath,
                    "Special"
                );
            else
                Assert.AreEqual(
                    "novell.mono.moonlight/%3C%3E%25%22%7B%7D%7C%5C%5E%60;/%3F:@&=+$,%5B%5D",
                    uri.AbsolutePath,
                    "Special"
                );
        }
        ...
        public void NntpScheme()
        {
            ...
            Assert.AreEqual("/novell.mono.moonlight/uri%3Fquery", uri.AbsolutePath, "AbsolutePath");
            Assert.AreEqual(
                "nntp://news.example.com/novell.mono.moonlight/uri%3Fquery",
                uri.AbsoluteUri,
                "AbsoluteUri"
            );
            ...
            Assert.AreEqual("/novell.mono.moonlight/uri?query", uri.LocalPath, "LocalPath");
            Assert.AreEqual(
                "nntp://news.example.com/novell.mono.moonlight/uri?query",
                uri.OriginalString,
                "OriginalString"
            );
            Assert.AreEqual("/novell.mono.moonlight/uri%3Fquery", uri.PathAndQuery, "PathAndQuery");
            ...
            // special escaped characters - they differs a bit from other URI
            uri = new Uri(
                "nntp://news.example.com/novell.mono.moonlight/<>%\"{}|\\^`;/?:@&=+$,[]#abc"
            );
            Assert.AreEqual("#abc", uri.Fragment, "Special/Fragment");
            if (IriParsing)
                Assert.AreEqual(
        ...
        public void FtpScheme()
        {
            ...
            Uri uri = new Uri(
                "ftp://user:password@ftp.example.com:2121/mono.zip?latest-n-greatest"
            );
            Assert.AreEqual("/mono.zip%3Flatest-n-greatest", uri.AbsolutePath, "AbsolutePath");
            Assert.AreEqual(
                "ftp://user:password@ftp.example.com:2121/mono.zip%3Flatest-n-greatest",
                uri.AbsoluteUri,
                "AbsoluteUri"
            );
            ...
            if (IriParsing)
                Assert.AreEqual(
                    "/%3C%3E%25%22%7B%7D%7C/%5E%60;/%3F:@&=+$,[]",
                    uri.AbsolutePath,
                    "Special"
                );
            else
                Assert.AreEqual(
                    "/%3C%3E%25%22%7B%7D%7C/%5E%60;/%3F:@&=+$,%5B%5D",
                    uri.AbsolutePath,
                    "Special"
                );
        }
        ...
        {
            Uri uri = new Uri(
                "file://host/dir/subdir/file?this-is-not-a-query#but-this-is-a-fragment"
            );
            ...
            if (IriParsing)
            {
                ...
                Assert.AreEqual(
                    "/dir/subdir/file?this-is-not-a-query",
                    uri.PathAndQuery,
                    "PathAndQuery"
                );
            ...
            {
                Assert.AreEqual(
                    "/dir/subdir/file%3Fthis-is-not-a-query",
                    uri.AbsolutePath,
                    "AbsolutePath"
                );
                Assert.AreEqual(
                    "file://host/dir/subdir/file%3Fthis-is-not-a-query#but-this-is-a-fragment",
                    uri.AbsoluteUri,
                    "AbsoluteUri"
                );
                Assert.AreEqual(
                    isWin32
                        ? "\\\\host\\dir\\subdir\\file?this-is-not-a-query"
                        : "/dir/subdir/file?this-is-not-a-query",
                    uri.LocalPath,
                    "LocalPath"
                );
            ...
            if (IriParsing)
                ...
                Assert.AreEqual(
                    "/%3C%3E%25%22%7B%7D%7C/%5E%60;/:@&=+$,%5B%5D%3F",
                    uri.AbsolutePath,
                    "Special"
                );
        }
        ...
        public void LocalhostWinFile()
        {
            ...
            Assert.AreEqual(
                isWin32 ? "\\\\localhost\\c:\\subdir\\file" : "/c:/subdir/file",
                uri.LocalPath,
                "LocalPath"
            );
            Assert.AreEqual("/c:/subdir/file", uri.PathAndQuery, "PathAndQuery");
        ...
        public void LocalhostFile()
        {
            ...
            Assert.AreEqual(
                isWin32 ? "\\\\localhost\\dir\\subdir\\file" : "/dir/subdir/file",
                uri.LocalPath,
                "LocalPath"
            );
            ...
            Assert.AreEqual(isWin32, uri.IsUnc, "IsUnc");
            Assert.AreEqual(
                "file://localhost/dir/subdir/file",
                uri.OriginalString,
                "OriginalString"
            );
            Assert.AreEqual(-1, uri.Port, "Port");
        ...
        public void IPv6SafeDnsName()
        {
            ...
            {
                Assert.AreEqual(
                    "[FE80:0000:0000:0000:0200:39FF:FE36:1A2D]",
                    uri.Authority,
                    "2.Authority"
                );
                Assert.AreEqual(
                    "FE80:0000:0000:0000:0200:39FF:FE36:1A2D%4",
                    uri.DnsSafeHost,
                    "2.DnsSafeHost"
                );
        ...
        public void RelativeEscapes()
        {
            ...
            if (IriParsing)
                Assert.AreEqual(
                    "../dir/../subdir/file?query#fragment",
                    uri.ToString(),
                    "1.ToString"
                );
            else
                Assert.AreEqual(
                    "%2e%2e/dir/%2e%2e/subdir/file?query#fragment",
                    uri.ToString(),
                    "1.ToString"
                );
        }
        ...
        public void BadUri()
        {
            Assert2.Throws<UriFormatException>(
                delegate
                {
        ...
        public void MergeWithConfusingRelativeUri()
        {
            ...
            Assert.AreEqual(
                "http://novell.com/http@ftp://example.com/dir/file",
                uri.ToString(),
                "1.ToString"
            );
        ...
        public void Fragment_SpecialCharacters()
        {
            ...
            Assert.AreEqual(
                "http://host/dir/file#fragment <>%25\"{}|\\^`;/?:@&=+$,[]%23second",
                uri.ToString(),
                "ToString"
            );
            if (IriParsing)
                Assert.AreEqual(
                    "#fragment%20%3C%3E%25%22%7B%7D%7C%5C%5E%60;/?:@&=+$,[]#second",
                    uri.Fragment,
                    "Fragment"
                );
            else
                Assert.AreEqual(
                    "#fragment%20%3C%3E%25%22%7B%7D%7C%5C%5E%60;/?:@&=+$,%5B%5D%23second",
                    uri.Fragment,
                    "Fragment"
                );
        }
        ...
        public void Query_SpecialCharacters()
        {
            ...
            Assert.AreEqual(
                "http://host/dir/file?query <>%25\"{}|\\^`;/?:@&=+$,[]",
                uri.ToString(),
                "ToString"
            );
            if (IriParsing)
                Assert.AreEqual(
                    "?query%20%3C%3E%25%22%7B%7D%7C%5C%5E%60;/?:@&=+$,[]",
                    uri.Query,
                    "Query"
                );
            else
                Assert.AreEqual(
                    "?query%20%3C%3E%25%22%7B%7D%7C%5C%5E%60;/?:@&=+$,%5B%5D",
                    uri.Query,
                    "Query"
                );
        }
        ...
        public void CheckHostName()
        {
            Assert.AreEqual(
                ...
                Uri.CheckHostName("host;machine"),
                "CheckHostName ;"
            );
            Assert.AreEqual(
                UriHostNameType.Unknown,
                Uri.CheckHostName("www..example.com"),
                "CheckHostName .."
            );
            Assert.AreEqual(
                UriHostNameType.Unknown,
