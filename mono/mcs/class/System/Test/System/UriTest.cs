...
*/
            ...
            Assert.AreEqual(
                "http",
                uri.GetComponents(UriComponents.Scheme, UriFormat.UriEscaped),
                "#k0-gc"
            );
            ...
            uri = new Uri(
                ...
                "http://www.xxx.com/Hello World.htm",
                false
            );
            ...
            uri = new Uri(
                new Uri("http://www.contoso.com"),
                "foo/bar/Hello World.htm?x=0:8",
                false
            );
            Assert.AreEqual(
                "http://www.contoso.com/foo/bar/Hello%20World.htm?x=0:8",
                uri.AbsoluteUri,
                "#rel5"
            );
            uri = new Uri(
                new Uri("http://www.contoso.com/xxx/yyy/index.htm"),
                "foo/bar/Hello World.htm?x=0:8",
                false
            );
            Assert.AreEqual(
                "http://www.contoso.com/xxx/yyy/foo/bar/Hello%20World.htm?x=0:8",
                uri.AbsoluteUri,
                "#rel6"
            );
            uri = new Uri(
            ...
            Assert.AreEqual(
                "http://www.contoso.com/xxx/foo/bar/Hello%20World.htm?x=0:8",
                uri.AbsoluteUri,
                "#rel8"
            );
            uri = new Uri(
            ...
            uri = new Uri(
                new Uri("http://www.contoso.com/foo/bar/index.html?x=0"),
                String.Empty,
                false
            );
        ...
        {
            string[] reluris = new string[] { "readme.txt", "thisdir/childdir/file", "./testfile" };
            string[] winRelUris = new string[] { "c:readme.txt" };
        ...
        public void UnixPath()
        {
            if (!isWin32)
                Assert.AreEqual(
                    ...
                    new Uri("/cygwin/tmp/hello.txt").ToString(),
                    "#6a"
                );
        }
        ...
        public void MoreHexEscape()
        {
            ...
            string escapedAbsolutePath =
                "/wiki/wiki%20document%20library/%D7%91%D7%93%20%D7%99%D7%A7%D7%94.docx";
            Uri u = new Uri(url);
        ...
        public void GetLeftPart()
        {
            ...
            Assert.AreEqual(
                "http://www.contoso.com:8080/index.htm",
                uri.GetLeftPart(UriPartial.Path),
                "#25"
            );
        }
        ...
        public void CheckHostName1()
        {
            ...
            Assert.AreEqual(
                ...
                Uri.CheckHostName(":11:22:33:44:55:66:77:88"),
                "#36 known to fail with ms.net: this is not a valid IPv6 address."
            );
        }
        ...
        public void CheckHostName2()
        {
            ...
            Assert.AreEqual(
                UriHostNameType.IPv6,
                Uri.CheckHostName("11::33:44:55:66:77:88"),
                "#16"
            );
            Assert.AreEqual(
                UriHostNameType.IPv6,
                Uri.CheckHostName("::22:33:44:55:66:77:88"),
                "#17"
            );
            Assert.AreEqual(
                UriHostNameType.IPv6,
                Uri.CheckHostName("11:22:33:44:55:66:77::"),
                "#18"
            );
            ...
            Assert.AreEqual(
                UriHostNameType.IPv6,
                Uri.CheckHostName("0:0:0:0:0:0:127.0.0.1"),
                "#26"
            );
            ...
            Assert.AreEqual(
                ...
                Uri.CheckHostName("::ffff:123.256.155.43"),
                "#34"
            );
        ...
        public void TestPartialToString()
        {
            ...
            Assert.AreEqual(
                new Uri("foo#dingus?aa", UriKind.Relative).ToString(),
                "foo#dingus?aa",
                "#4"
            );
            Assert.AreEqual(
        ...
        public void MakeRelative()
        {
            ...
            Assert.AreEqual(
                "https://www.contoso.com/bar/foo/index.htm?y=1",
                uri4.MakeRelative(uri5),
                "#7"
            );

            Assert.AreEqual(
                "http://www.contoso2.com/bar/foo/index.htm?x=0",
            ...
            Assert.AreEqual(
                "mailto:xxx@mail.xxx.com?subject=hola",
                uri10.MakeRelative(uri12),
                "#12"
            );
            ...
            Assert.AreEqual(
                "http://www.xxx.com/bar/foo/foobar.htm?z=0&y=5" + (char)0xa9,
                uri1.MakeRelative(uri8),
                "#14"
            );
        }
        ...
        public void RelativeFragmentUri2()
        {
            Assert.AreEqual(
                "hoge:ext",
                new Uri(new Uri("hoge:foo:bar:baz"), "hoge:ext").ToString(),
                "#1"
            );
            if (isWin32)
            {
                ...
                Assert.AreEqual(
                    "file:///c:/localhost/myhost/ext",
                    new Uri(new Uri("file:///c:/localhost/bar"), "file:myhost/ext").ToString(),
                    "#3-w"
                );
                Assert.AreEqual(
                    "uuid:ext",
                    new Uri(new Uri("file:///c:/localhost/bar"), "uuid:ext").ToString(),
                    "#4-w"
                );
                Assert.AreEqual(
                    "file:///c:/localhost/ext",
                    new Uri(new Uri("file:///c:/localhost/bar"), "file:./ext").ToString(),
                    "#5-w"
                );
            }
            else
            ...
            Assert.AreEqual(
                "http://localhost/ext",
                new Uri(new Uri("http://localhost/bar"), "http:./ext").ToString(),
                "#6"
            );
        }
        ...
        public void CheckSchemeName_AnyOtherChar()
        {
            for (int i = 0; i < 256; i++)
            {
                ...
                bool valid = (
                    common || ((i >= 0x41) && (i <= 0x5A)) || ((i >= 0x61) && (i <= 0x7A))
                );
                Assert.AreEqual(valid, b, s);
            }
        }
        ...
        {
            string[] tests = { "file:///tmp/x (%232).jpg", "file:///tmp/ü (%232).jpg" };
            ...
            foreach (string test in tests)
            {
                ...
                Assert.IsFalse(
                    ...
                    "IsWellFormedOriginalString/" + test
                );
        ...
        public void LocalPath_FileNameWithAtSign1()
        {
            ...
            Assert.AreEqual(
                fileUri.UserInfo,
                String.Empty,
                "LocalPath_FileNameWithAtSign UserInfo"
            );
            ...
            Assert.AreEqual(
                ...
                "LocalPath_FileNameWithAtSign OriginalString"
            );
            Assert.AreEqual(
                path,
                new DerivedUri(fullpath).TestUnescape(path),
                "LocalPath_FileNameWithAtSign ProtectedUnescape"
            );
        ...
        public void LocalPath_FileNameWithAtSign5()
        {
            ...
            string expected = isWin32
                ? "\\\\localhost" + path.Replace("/", "\\")
                : "/some/path/file_with_an_@_sign.mp3";
        ...
        {
            string s =
                @"Transform?args=[{""__type"":""Record:#Nostr"",""Code"":""%22test%22SomeGloss"",""ID"":""1"",""Table"":""Glossary""},{""__type"":""Record:#Nostr"",""Code"":""%22test%22All"",""ID"":""2"",""Table"":""GlossView""}, {""__type"":""Record:#Nostr"",""Code"":""%22test%22Q"",""ID"":""3"",""Table"":""Glossary""}]"; // with related to bug #573795
        ...
        public void GetComponents_AbsoluteUri()
        {
            ...
            Assert.AreEqual(
                "http://example.com/list?id=1%262&sort=asc#fragment%263",
                uri.AbsoluteUri,
                "AbsoluteUri"
            );
            ...
            Assert.AreEqual(
                "http://example.com/list?id=1&2&sort=asc#fragment&3",
                unescaped,
                "Unescaped"
            );
        ...
        public void GetComponents_PathAndQuery()
        {
            ...
            Assert.AreEqual(
                "/M%C3%A5%C3%8Fn%20P%C3%A5ge?id=1%262&sort=asc",
                uri.PathAndQuery,
                "PathAndQuery"
            );
        ...
        static UriKind DotNetRelativeOrAbsolute =
        ...
        public void DotNetRelativeOrAbsoluteTest()
        {
            ...
            {
                useDotNetRelativeOrAbsoluteField = typeof(Uri).GetField(
                    "useDotNetRelativeOrAbsolute",
                    BindingFlags.Static | BindingFlags.GetField | BindingFlags.NonPublic
                );
                useDotNetRelativeOrAbsoluteOld = (bool)
                    useDotNetRelativeOrAbsoluteField.GetValue(null);
        ...
        public void GetSerializationInfoStringException()
        {
            var uri = new Uri("/relative/path", UriKind.Relative);
            uri.GetComponents(
                UriComponents.SerializationInfoString | UriComponents.Host,
                UriFormat.UriEscaped
            );
        }
        ...
        public void UserInfo_EscapedChars()
        {
            for (var ch = (char)1; ch < 128; ch++)
            {
                ...
                catch (Exception e)
                {
                    Assert.Fail(
                        string.Format(
                            "Unexpected {0} while building URI with username {1}",
                            e.GetType().Name,
                            userinfo
                        )
                    );
        ...
        public void ImplicitUnixFileWithUnicode()
        {
            ...
            Uri uri;
            Assert.IsTrue(
                Uri.TryCreate("/Library/Frameworks/System.Runtim…ee", UriKind.Absolute, out uri),
                "#1"
            );
