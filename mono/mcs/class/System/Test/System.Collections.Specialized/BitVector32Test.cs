...
namespace MonoTests.System.Collections.Specialized
{
    ...
    public class BitVector32Test
    {
        ...
        public void Constructors()
        {
            ...
            Assert.AreEqual(
                b.ToString(),
                "BitVector32{00000000000000000000000000011111}",
                b.ToString()
            );
        ...
        public void Constructors_MaxValue()
        {
            ...
            Assert.AreEqual(
                "BitVector32{01111111111111111111111111111111}",
                BitVector32.ToString(b),
                "ToString(BitVector)"
            );
        }
        ...
        public void Constructors_MinValue()
        {
            ...
            Assert.AreEqual(
                "BitVector32{10000000000000000000000000000000}",
                BitVector32.ToString(b),
                "ToString(BitVector)"
            );
        }
        ...
        public void Section()
        {
            ...
            Assert.AreEqual(
                "Section{0x1f, 0x0}",
                BitVector32.Section.ToString(s1),
                "ToString(Section)"
            );
