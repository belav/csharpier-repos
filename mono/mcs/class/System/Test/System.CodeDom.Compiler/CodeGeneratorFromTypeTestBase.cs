...
namespace MonoTests.System.CodeDom.Compiler
{
    ...
    {
        protected abstract CodeTypeDeclaration TypeDeclaration { get; }
        ...
        {
            TypeDeclaration.Name = "Test1";
            TypeDeclaration.TypeAttributes |= TypeAttributes.NestedFamily | TypeAttributes.Abstract;
        ...
        protected string GenerateFieldMembersType(
        ...
        protected string GeneratePropertyMembersType(
            MemberAttributes memberAttributes,
            bool hasGet,
            bool hasSet,
            CodeGeneratorOptions options
        ...
        protected string GeneratePropertyIndexer(
            MemberAttributes memberAttributes,
            bool hasGet,
            bool hasSet,
            bool addParameters,
        ...
        protected string GenerateMethodMembersType2(CodeGeneratorOptions options)
        {
            ...
            param = new CodeParameterDeclarationExpression(typeof(object), "value2");
        ...
        protected string GenerateEntryPointMethod(CodeGeneratorOptions options)
        {
            ...
            CodeVariableDeclarationStatement v = new CodeVariableDeclarationStatement(
                "Test+InnerType",
                "x"
            );
        ...
        protected string GenerateGenericCodeTypeReferences(CodeGeneratorOptions options)
        {
            ...
            CodeMemberField f = new CodeMemberField(
                new CodeTypeReference("System.Nullable", new CodeTypeReference(typeof(int))),
                "Foo"
            );
            td.Members.Add(f);
