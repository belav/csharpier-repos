...
namespace MonoTests.System.CodeDom.Compiler
{
    ...
    public class MockCodeGenerator : CodeGenerator
    {
        ...
        public void IsCurrentTest()
        {
            ...
            ((ICodeGenerator)codeGenerator).GenerateCodeFromType(
                GetClassType(),
                new StringWriter(),
        ...
        public void IsValidLanguageIndependentIdentifierTest()
        {
            Assert.AreEqual(
                true,
                CodeGenerator.IsValidLanguageIndependentIdentifier("hello"),
                "#G1"
            );
            Assert.AreEqual(
                true,
                CodeGenerator.IsValidLanguageIndependentIdentifier("good1"),
                "#G2"
            );
            Assert.AreEqual(
                false,
                CodeGenerator.IsValidLanguageIndependentIdentifier("2bad"),
                "#G3"
            );
            Assert.AreEqual(
                false,
                CodeGenerator.IsValidLanguageIndependentIdentifier("@start"),
                "#G4"
            );
            Assert.AreEqual(
                false,
                CodeGenerator.IsValidLanguageIndependentIdentifier("not@start"),
                "#G5"
            );
            Assert.AreEqual(
                false,
                CodeGenerator.IsValidLanguageIndependentIdentifier(" spaceatstart"),
                "#G6"
            );
            Assert.AreEqual(
                false,
                CodeGenerator.IsValidLanguageIndependentIdentifier("spaceatend "),
                "#G7"
            );
            Assert.AreEqual(
                false,
                CodeGenerator.IsValidLanguageIndependentIdentifier("a spacein2ndplace"),
                "#G8"
            );
        }
            ...
            var t = new CodeTypeDeclaration()
            {
                ...
                Members =
                {
                    ...
                    new CodeMemberMethod()
                    {
                        ...
                        EndDirectives = { new CodeRegionDirective(CodeRegionMode.End, null) },
                    },
                },
            };

            var opts = new CodeGeneratorOptions() { IndentString = "\t" };
