...
namespace MonoTests.System.CodeDom.Compiler
{
    ...
    public class CodeGeneratorGenerateFromCompileUnitTest
    {
        [Test]
        [Ignore(
            "This test is wrong; on .NET, ATTRIBUTE is not written and this attributePosition is always < 0."
        )]
...
/* test overrides */
            ...
            protected override void GenerateNamespaceImport(CodeNamespaceImport i)
            {
                Output.Write("IMPORT");
            }
...
/* must overrides */
            ...
            protected override void GenerateThrowExceptionStatement(
                CodeThrowExceptionStatement s
            ) { }

            protected override void GenerateTryCatchFinallyStatement(
                CodeTryCatchFinallyStatement s
            ) { }
