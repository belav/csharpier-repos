...
namespace MonoTests.System.Net.Mail
{
    ...
    public class SmtpClientTest
    {
        ...
        public void DeliveryMethod()
        {
            ...
            Assert.AreEqual(SmtpDeliveryMethod.SpecifiedPickupDirectory, smtp.DeliveryMethod, "#2");
            smtp.DeliveryMethod = SmtpDeliveryMethod.PickupDirectoryFromIis;
            Assert.AreEqual(SmtpDeliveryMethod.PickupDirectoryFromIis, smtp.DeliveryMethod, "#3");
            smtp.DeliveryMethod = SmtpDeliveryMethod.Network;
            Assert.AreEqual(SmtpDeliveryMethod.Network, smtp.DeliveryMethod, "#4");
        }
