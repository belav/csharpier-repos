...
namespace MonoTests.System.Net.Mail
{
    ...
    public class SmtpExceptionTest
    {
        ...
        public void Constructor1()
        {
            ...
            Assert.AreEqual(
                -1,
                se.Message.IndexOf(typeof(SmtpException).FullName),
                "#5:" + se.Message
            );
        ...
        public void Constructor3()
        {
            ...
            Assert.IsTrue(
                se.Message.IndexOf("'" + typeof(SmtpException).FullName + "'") != -1,
                "#C5:" + se.Message
            );
        ...
        public void Constructor4_SerializationInfo_Null()
        {
            try
            {
                new MySmtpException((SerializationInfo)null, new StreamingContext());
                Assert.Fail("#1");
            }
        ...
        public void GetObjectData()
        {
            ...
            se = new SmtpException(msg, inner);
            si = new SerializationInfo(typeof(SmtpException), new FormatterConverter());
            ...
            Assert.AreEqual((int)SmtpStatusCode.GeneralFailure, si.GetInt32("Status"), "#A13");
            ...
            Assert.AreEqual((int)SmtpStatusCode.GeneralFailure, si.GetInt32("Status"), "#B13");
            ...
            catch (SmtpException ex)
            {
                ...
                Assert.AreEqual((int)SmtpStatusCode.GeneralFailure, si.GetInt32("Status"), "#C13");
            }
            ...
            catch (SmtpException ex)
            {
                ...
                Assert.AreEqual(
                    typeof(SmtpExceptionTest).Assembly.GetName().Name,
                    si.GetString("Source"),
                    "#D11"
                );
                //Assert.IsNotNull (si.GetString ("ExceptionMethod"), "#D12");
                Assert.AreEqual((int)SmtpStatusCode.GeneralFailure, si.GetInt32("Status"), "#D13");
            }
        }
        ...
        public void GetObjectData_SerializationInfo_Null()
        {
            ...
            try
            {
                se.GetObjectData((SerializationInfo)null, new StreamingContext());
                Assert.Fail("#1");
            }
            catch (ArgumentNullException ex)
            {
