...
namespace MonoTests.System.Diagnostics
{
    ...
    public class ProcessTest
    {
        ...
        {
            Process process = new Process();
            string exe = RunningOnUnix
                ? exe = "/usr/bin/shouldnoteverexist"
        ...
        public void Start1_FileName_Whitespace()
        {
            ...
            catch (Win32Exception ex)
            {
                ...
                Assert.IsTrue(
                    ex.NativeErrorCode == 2 || ex.NativeErrorCode == 5 || ex.NativeErrorCode == 87,
                    "#6"
                );
            }
        }
        ...
        public void TestRedirectedOutputIsAsync()
        {
            ...
            IAsyncResult ar = stdout.BeginRead(
                buffer,
                0,
                buffer.Length,
        ...
        public void TestEventRaising()
        {
            ...
            bool r = WaitHandle.WaitAll(
                new WaitHandle[] { errorClosed, outClosed, exited },
                10000,
                false
            );
        ...
        public void Modules()
        {
            ...
            foreach (var a in AppDomain.CurrentDomain.GetAssemblies())
            {
                ...
                foreach (var o in modules)
                {
                    ...
                    if (
                        fv.FileBuildPart != name.Version.Build
        ...
        public void TestExitedRaisedTooSoon()
        {
            ...
            using (Process p = Process.Start("sleep", sleeptime.ToString()))
            {
                ...
                Assert.IsFalse(
                    mre.WaitOne((sleeptime - 2) * 1000),
                    "Exited triggered before the process returned"
                );
            }
        }
#endif // MONO_FEATURE_PROCESS_START
