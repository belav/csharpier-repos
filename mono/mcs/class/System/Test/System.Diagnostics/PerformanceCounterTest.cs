            ...
            Assert.That(
                new[]
                {
                    new string[]
                    {
                        ...
                        counters[0].InstanceName,
                        counters[0].RawValue.ToString(),
                    },
                    new string[]
                    {
                        counters[1].CategoryName,
                        counters[1].CounterName,
                        counters[1].InstanceName,
                        counters[1].RawValue.ToString(),
                    },
                },
                Is.EquivalentTo(
                    new[]
