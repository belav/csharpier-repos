...
namespace MonoTests.System.Diagnostics
{
    ...
    public class DiagnosticsConfigurationHandlerTest
    {
        ...
        void ValidateExceptions(string name, string format, string[] args)
        {
            ...
            {
                string xml = string.Format(XmlFormat, string.Format(format, arg));
                try
                {
                    CreateHandler(xml);
                ...
                catch (Exception e)
                {
                    Assert.Fail(
                        string.Format(
                            "{0}:{1}: wrong exception generated: {2} ({3}).",
                            name,
                            arg,
                            e.ToString(),
        ...
        public void AssertTag()
        {
            ...
            string[] badChildren = { "<any element=\"here\"/>" };
        ...
        public void PerformanceCountersTag()
        {
            ...
            ValidateExceptions(
                "#PCT:BadChildren",
                "<performanceCounters>{0}</performanceCounters>",
                badChildren
            );
        }
        ...
        public void TraceTag_Children()
        {
            ...
            string[] bad = { "<listeners with=\"attribute\"/>", "<invalid element=\"here\"/>" };
