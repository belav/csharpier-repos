...
using System;using System.ComponentModel.Design;using System.Collections;using NUnit.Framework;
...
namespace MonoTests.System.ComponentModel.Design
{
    ...
    public class ServiceContainerTest
    {
        ...
        public void AddService1()
        {
            ...
            object callback1 = new ServiceCreatorCallback(Svc.ServiceCreator);
        ...
        public void AddService2_Disposed()
        {
            ...
            object callback = new ServiceCreatorCallback(Svc.ServiceCreator);
        ...
        {
            ServiceContainer sc = new ServiceContainer();
            ServiceCreatorCallback callback = new ServiceCreatorCallback(Svc.ServiceCreator);
