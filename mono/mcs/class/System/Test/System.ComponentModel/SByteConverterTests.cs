...
namespace MonoTests.System.ComponentModel
{
    ...
    public class SByteConverterTests
    {
        ...
        public void ConvertFrom_String()
        {
            ...
            Assert.AreEqual(
                (sbyte)16,
                converter.ConvertFrom(null, CultureInfo.InvariantCulture, "#0x10"),
                "#3"
            );
            Assert.AreEqual(
                (sbyte)16,
        ...
        public void ConvertTo_MinValue()
        {
            ...
            Assert.AreEqual(
                sbyte.MinValue.ToString(CultureInfo.CurrentCulture),
                converter.ConvertTo(
                    null,
            ...
            Assert.AreEqual(
                sbyte.MinValue.ToString(CultureInfo.CurrentCulture),
                converter.ConvertTo(sbyte.MinValue, typeof(string)),
                "#3"
            );
        }
        ...
        public void ConvertTo_MaxValue()
        {
            ...
            Assert.AreEqual(
                sbyte.MaxValue.ToString(CultureInfo.CurrentCulture),
                converter.ConvertTo(
                    null,
                    CultureInfo.CurrentCulture,
                    sbyte.MaxValue,
            ...
            Assert.AreEqual(
                sbyte.MaxValue.ToString(CultureInfo.CurrentCulture),
                converter.ConvertTo(sbyte.MaxValue, typeof(string)),
                "#3"
            );
        }
        ...
        public void ConvertToString()
        {
            ...
            Assert.AreEqual(
                ...
                converter.ConvertToString(null, culture, (sbyte)-5),
                "#1"
            );
            Assert.AreEqual(
                culture.NumberFormat.NegativeSign + "5",
                converter.ConvertToString(null, culture, (short)-5),
                "#2"
            );
        }
