...
namespace MonoTests.System.ComponentModel
{
    ...
    public class ByteConverterTests
    {
        ...
        public void ConvertFrom_MinValue()
        {
            Assert.AreEqual(
                byte.MinValue,
                converter.ConvertFrom(null, CultureInfo.InvariantCulture, "#0"),
                "#1"
            );
            Assert.AreEqual(
                byte.MinValue,
                converter.ConvertFrom(null, CultureInfo.InvariantCulture, "#0x0"),
                "#2"
            );
            Assert.AreEqual(
                byte.MinValue,
        ...
        public void ConvertFrom_MaxValue()
        {
            Assert.AreEqual(
                byte.MaxValue,
                converter.ConvertFrom(null, CultureInfo.InvariantCulture, "#ff"),
                "#1"
            );
            Assert.AreEqual(
                byte.MaxValue,
            ...
            Assert.AreEqual(
                byte.MaxValue,
                converter.ConvertFrom(null, CultureInfo.InvariantCulture, "#0xff"),
                "#3"
            );
            Assert.AreEqual(
                byte.MaxValue,
        ...
        public void ConvertToString()
        {
            ...
            Assert.AreEqual(
                ...
                converter.ConvertToString(null, culture, -5)
            );
        }
        ...
        public void ConvertTo_MinValue()
        {
            ...
            Assert.AreEqual(
                byte.MinValue.ToString(CultureInfo.CurrentCulture),
                converter.ConvertTo(
                    null,
            ...
            Assert.AreEqual(
                byte.MinValue.ToString(CultureInfo.CurrentCulture),
                converter.ConvertTo(byte.MinValue, typeof(string)),
                "#3"
            );
        }
        ...
        public void ConvertTo_MaxValue()
        {
            ...
            Assert.AreEqual(
                byte.MaxValue.ToString(CultureInfo.CurrentCulture),
                converter.ConvertTo(
                    null,
                    CultureInfo.CurrentCulture,
                    byte.MaxValue,
            ...
            Assert.AreEqual(
                byte.MaxValue.ToString(CultureInfo.CurrentCulture),
                converter.ConvertTo(byte.MaxValue, typeof(string)),
                "#3"
            );
        }
        ...
        public void ConvertToString_MinValue()
        {
            Assert.AreEqual(
                byte.MinValue.ToString(CultureInfo.InvariantCulture),
                converter.ConvertToString(null, CultureInfo.InvariantCulture, byte.MinValue),
                "#1"
            );

            Assert.AreEqual(
                byte.MinValue.ToString(CultureInfo.CurrentCulture),
                converter.ConvertToString(null, byte.MinValue),
                "#2"
            );
            Assert.AreEqual(
                byte.MinValue.ToString(CultureInfo.CurrentCulture),
                converter.ConvertToString(null, CultureInfo.CurrentCulture, byte.MinValue),
                "#3"
            );
            Assert.AreEqual(
                byte.MinValue.ToString(CultureInfo.CurrentCulture),
                converter.ConvertToString(byte.MinValue),
                "#4"
            );
        }
        ...
        public void ConvertToString_MaxValue()
        {
            Assert.AreEqual(
                byte.MaxValue.ToString(CultureInfo.InvariantCulture),
                converter.ConvertToString(null, CultureInfo.InvariantCulture, byte.MaxValue),
                "#1"
            );

            Assert.AreEqual(
                byte.MaxValue.ToString(CultureInfo.CurrentCulture),
                converter.ConvertToString(null, byte.MaxValue),
                "#2"
            );
            Assert.AreEqual(
                byte.MaxValue.ToString(CultureInfo.CurrentCulture),
                converter.ConvertToString(null, CultureInfo.CurrentCulture, byte.MaxValue),
                "#3"
            );
            Assert.AreEqual(
                byte.MaxValue.ToString(CultureInfo.CurrentCulture),
                converter.ConvertToString(byte.MaxValue),
                "#4"
            );
        }
        ...
        {
            string minOverflow = ((int)(byte.MinValue - 1)).ToString(CultureInfo.CurrentCulture);
        ...
        {
            string minOverflow = ((int)(byte.MinValue - 1)).ToString(CultureInfo.InvariantCulture);
        ...
        {
            string maxOverflow = ((int)(byte.MaxValue + 1)).ToString(CultureInfo.CurrentCulture);
        ...
        {
            string maxOverflow = ((int)(byte.MaxValue + 1)).ToString(CultureInfo.InvariantCulture);
