...
namespace MonoTests.System.ComponentModel
{
    ...
    public class SingleConverterTests
    {
        ...
        {
            Assert.AreEqual(
                1.5f.ToString(CultureInfo.InvariantCulture),
                converter.ConvertTo(null, CultureInfo.InvariantCulture, 1.5f, typeof(string)),
                "#1"
            );
            Assert.AreEqual(
                1.5f.ToString(CultureInfo.CurrentCulture),
                converter.ConvertTo(null, CultureInfo.CurrentCulture, 1.5f, typeof(string)),
                "#2"
            );
            Assert.AreEqual(
                1.5f.ToString(CultureInfo.CurrentCulture),
                converter.ConvertTo(1.5f, typeof(string)),
                "#3"
            );
        }
        ...
        public void ConvertToString()
        {
            ...
            Assert.AreEqual(
                ...
                converter.ConvertToString(null, culture, (float)-5),
                "#1"
            );
            Assert.AreEqual(
