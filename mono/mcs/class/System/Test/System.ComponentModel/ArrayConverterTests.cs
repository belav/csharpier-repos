...
namespace MonoTests.System.ComponentModel
{
    ...
    public class ArrayConverterTests
    {
        ...
        public void ConvertTo()
        {
            ...
            string text = (string)
                converter.ConvertTo(null, CultureInfo.InvariantCulture, numbers, typeof(string));
        ...
        public void ConvertTo_DestinationType_Null()
        {
            ...
            try
            {
                converter.ConvertTo(null, CultureInfo.InvariantCulture, numbers, (Type)null);
                Assert.Fail("#1");
            }
        ...
        {
            int[] numbers = new int[] { 5, 7 };
            PropertyDescriptorCollection pds = converter.GetProperties(null, numbers, null);
