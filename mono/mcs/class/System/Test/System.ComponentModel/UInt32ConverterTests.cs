...
namespace MonoTests.System.ComponentModel
{
    ...
    public class UInt32ConverterTests
    {
        ...
        public void ConvertFrom_MaxValue()
        {
            Assert.AreEqual(
                uint.MaxValue,
                converter.ConvertFrom(null, CultureInfo.InvariantCulture, "#ffffffff"),
                "#1"
            );
            Assert.AreEqual(
                uint.MaxValue,
            ...
            Assert.AreEqual(
                uint.MaxValue,
                converter.ConvertFrom(null, CultureInfo.InvariantCulture, "#0xffffffff"),
                "#3"
            );
            Assert.AreEqual(
                uint.MaxValue,
        ...
        public void ConvertTo_MinValue()
        {
            ...
            Assert.AreEqual(
                uint.MinValue.ToString(CultureInfo.CurrentCulture),
                converter.ConvertTo(
                    null,
            ...
            Assert.AreEqual(
                uint.MinValue.ToString(CultureInfo.CurrentCulture),
                converter.ConvertTo(uint.MinValue, typeof(string)),
                "#3"
            );
        }
        ...
        public void ConvertTo_MaxValue()
        {
            ...
            Assert.AreEqual(
                uint.MaxValue.ToString(CultureInfo.CurrentCulture),
                converter.ConvertTo(
                    null,
                    CultureInfo.CurrentCulture,
                    uint.MaxValue,
            ...
            Assert.AreEqual(
                uint.MaxValue.ToString(CultureInfo.CurrentCulture),
                converter.ConvertTo(uint.MaxValue, typeof(string)),
                "#3"
            );
        }
