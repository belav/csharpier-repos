...
namespace MonoTests.System.ComponentModel
{
    ...
    public class Int32ConverterTests
    {
        ...
        public void ConvertFrom_MinValue()
        {
            Assert.AreEqual(
                int.MinValue,
                converter.ConvertFrom(null, CultureInfo.InvariantCulture, "#80000000"),
                "#1"
            );
            Assert.AreEqual(
                int.MinValue,
                converter.ConvertFrom(null, CultureInfo.InvariantCulture, "#0x80000000"),
                "#2"
            );
            Assert.AreEqual(
                int.MinValue,
        ...
        public void ConvertFrom_MaxValue()
        {
            Assert.AreEqual(
                int.MaxValue,
                converter.ConvertFrom(null, CultureInfo.InvariantCulture, "#7fffffff"),
                "#1"
            );
            Assert.AreEqual(
                int.MaxValue,
            ...
            Assert.AreEqual(
                int.MaxValue,
                converter.ConvertFrom(null, CultureInfo.InvariantCulture, "#0x7fffffff"),
                "#3"
            );
            Assert.AreEqual(
                int.MaxValue,
        ...
        public void ConvertTo_MinValue()
        {
            ...
            Assert.AreEqual(
                ...
                converter.ConvertTo(null, CultureInfo.CurrentCulture, int.MinValue, typeof(string)),
                "#2"
            );
            Assert.AreEqual(
                int.MinValue.ToString(CultureInfo.CurrentCulture),
                converter.ConvertTo(int.MinValue, typeof(string)),
                "#3"
            );
        }
        ...
        public void ConvertTo_MaxValue()
        {
            ...
            Assert.AreEqual(
                ...
                converter.ConvertTo(null, CultureInfo.CurrentCulture, int.MaxValue, typeof(string)),
                "#2"
            );
            Assert.AreEqual(
                int.MaxValue.ToString(CultureInfo.CurrentCulture),
                converter.ConvertTo(int.MaxValue, typeof(string)),
                "#3"
            );
        }
