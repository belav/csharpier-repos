...
namespace MonoTests.System.ComponentModel
{
    ...
    public class DesignerAttributeTest
    {
        ...
        public void Constructor1()
        {
            ...
            Assert.AreEqual(
                typeof(DesignerAttribute).FullName + da.DesignerBaseTypeName,
                da.TypeId,
                "#A3"
            );
        ...
        public void Constructor3()
        {
            ...
            da = new DesignerAttribute(
                "Mono.Components.CategoryType",
                "Mono.Design.CompositeAttribute"
            );
        ...
        {
            DesignerAttribute da = new DesignerAttribute("CategoryType", (string)null);
        ...
        public void Constructor4()
        {
            ...
            Assert.AreEqual("Mono.Components.CategoryType", da.DesignerTypeName, "#A2");
            Assert.AreEqual(
                typeof(DesignerAttribute).FullName + typeof(string).FullName,
                da.TypeId,
                "#A3"
            );
            ...
            Assert.AreEqual("CategoryType", da.DesignerTypeName, "#B2");
            Assert.AreEqual(
                typeof(DesignerAttribute).FullName + typeof(int).FullName,
                da.TypeId,
                "#B3"
            );
