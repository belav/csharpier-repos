...
namespace MonoTests.System.ComponentModel
{
    ...
    public class DecimalConverterTests
    {
        ...
        public void ConvertTo_MinValue()
        {
            ...
            Assert.AreEqual(
                decimal.MinValue.ToString(CultureInfo.CurrentCulture),
                converter.ConvertTo(
                    null,
            ...
            Assert.AreEqual(
                decimal.MinValue.ToString(CultureInfo.CurrentCulture),
                converter.ConvertTo(decimal.MinValue, typeof(string)),
                "#3"
            );
        }
        ...
        public void ConvertTo_MaxValue()
        {
            ...
            Assert.AreEqual(
                decimal.MaxValue.ToString(CultureInfo.CurrentCulture),
                converter.ConvertTo(
                    null,
                    CultureInfo.CurrentCulture,
                    decimal.MaxValue,
            ...
            Assert.AreEqual(
                decimal.MaxValue.ToString(CultureInfo.CurrentCulture),
                converter.ConvertTo(decimal.MaxValue, typeof(string)),
                "#3"
            );
        }
        ...
        public void ConvertToString_MinValue()
        {
            Assert.AreEqual(
                decimal.MinValue.ToString(CultureInfo.InvariantCulture),
                converter.ConvertToString(null, CultureInfo.InvariantCulture, decimal.MinValue),
                "#1"
            );

            Assert.AreEqual(
                decimal.MinValue.ToString(CultureInfo.CurrentCulture),
                converter.ConvertToString(null, decimal.MinValue),
                "#2"
            );
            Assert.AreEqual(
                decimal.MinValue.ToString(CultureInfo.CurrentCulture),
                converter.ConvertToString(null, CultureInfo.CurrentCulture, decimal.MinValue),
                "#3"
            );
            Assert.AreEqual(
                decimal.MinValue.ToString(CultureInfo.CurrentCulture),
                converter.ConvertToString(decimal.MinValue),
                "#4"
            );
        }
        ...
        public void ConvertToString_MaxValue()
        {
            Assert.AreEqual(
                decimal.MaxValue.ToString(CultureInfo.InvariantCulture),
                converter.ConvertToString(null, CultureInfo.InvariantCulture, decimal.MaxValue),
                "#1"
            );

            Assert.AreEqual(
                decimal.MaxValue.ToString(CultureInfo.CurrentCulture),
                converter.ConvertToString(null, decimal.MaxValue),
                "#2"
            );
            Assert.AreEqual(
                decimal.MaxValue.ToString(CultureInfo.CurrentCulture),
                converter.ConvertToString(null, CultureInfo.CurrentCulture, decimal.MaxValue),
                "#3"
            );
            Assert.AreEqual(
                decimal.MaxValue.ToString(CultureInfo.CurrentCulture),
                converter.ConvertToString(decimal.MaxValue),
                "#4"
            );
        }
        ...
        public void ConvertToString()
        {
            ...
            Assert.AreEqual(
                ...
                converter.ConvertToString(null, culture, (decimal)-5),
                "#1"
            );
            Assert.AreEqual(
