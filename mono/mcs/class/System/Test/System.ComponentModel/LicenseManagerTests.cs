    ...
    public class LicenseManagerTests
    {
        ...
        public void Test()
        {
            ...
            Assert.AreEqual(
                ...
                LicenseManager.CurrentContext.GetType().ToString(),
                "LicenseManager #1"
            );
            //Read default LicenseUsageMode, check against CurrentContext (LicCont).UsageMode
            Assert.AreEqual(
                LicenseManager.CurrentContext.UsageMode,
            ...
            Assert.AreEqual(
                true,
                LicenseManager.IsLicensed(typeof(UnlicensedObject)),
                "LicenseManager #13"
            );
            Assert.AreEqual(
                true,
                LicenseManager.IsLicensed(typeof(LicensedObject)),
                "LicenseManager #14"
            );
            Assert.AreEqual(
                false,
            ...
            Assert.AreEqual(
                true,
                LicenseManager.IsValid(typeof(UnlicensedObject)),
                "LicenseManager #16"
            );
            Assert.AreEqual(
                true,
                LicenseManager.IsValid(typeof(LicensedObject)),
                "LicenseManager #17"
            );
            Assert.AreEqual(
                false,
                LicenseManager.IsValid(typeof(InvalidLicensedObject)),
                "LicenseManager #18"
            );
