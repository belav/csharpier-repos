...
namespace MonoTests.System.ComponentModel
{
    ...
    public class CultureInfoConverterTest
    {
        ...
        public void ConvertFrom_String()
        {
            ...
            c = (CultureInfo)converter.ConvertFrom(null, CultureInfo.InvariantCulture, "nl-BE");
            Assert.AreEqual(new CultureInfo("nl-BE"), c, "#2");

            try
            {
                c = (CultureInfo)converter.ConvertFrom(null, CultureInfo.InvariantCulture, "Dut");
                Assert.Fail("#3");
            }
            ...
            {
                c = (CultureInfo)
                    converter.ConvertFrom(null, CultureInfo.InvariantCulture, "Dutch (Bel");
                Assert.Fail("#4");
            }
            catch (ArgumentException) { }
        ...
        {
            converter.ConvertFrom(null, CultureInfo.InvariantCulture, "nl-B");
        }
        ...
        public void ConvertFrom_String_InvalidCulture()
        {
            try
            {
                converter.ConvertFrom(null, CultureInfo.InvariantCulture, "(default)");
                Assert.Fail("#A1");
            }
        ...
        public void ConvertFrom_Value_Null()
        {
            try
            {
                converter.ConvertFrom(null, CultureInfo.InvariantCulture, (string)null);
                Assert.Fail("#1");
            }
        ...
        public void ConvertToString()
        {
            ...
            result = converter.ConvertToString(
                null,
            ...
            result = converter.ConvertToString(null, CultureInfo.InvariantCulture, null);
