...
namespace MonoTests.System.ComponentModel
{
    ...
    public class InvalidEnumArgumentExceptionTest
    {
        ...
        public void Constructor0()
        {
            ...
            Assert.IsTrue(
                iea.Message.IndexOf(typeof(InvalidEnumArgumentException).FullName) != -1,
                "#3"
            );
        ...
        public void Constructor4()
        {
            ...
            Assert.IsTrue(
                iea.Message.IndexOf("(" + 667666.ToString(CultureInfo.CurrentCulture) + ")") != -1,
                "#A4"
            );
            ...
            Assert.IsTrue(
                iea.Message.IndexOf("(" + 0.ToString(CultureInfo.CurrentCulture) + ")") != -1,
                "#B4"
            );
            ...
            Assert.IsTrue(
                iea.Message.IndexOf("(" + (-56776).ToString(CultureInfo.CurrentCulture) + ")")
                    != -1,
                "#C4"
            );
