...
namespace MonoTests.System.ComponentModel
{
    ...
    public class Int16ConverterTests
    {
        ...
        public void ConvertFrom_MinValue()
        {
            Assert.AreEqual(
                short.MinValue,
                converter.ConvertFrom(null, CultureInfo.InvariantCulture, "#8000"),
                "#1"
            );
            Assert.AreEqual(
                short.MinValue,
                converter.ConvertFrom(null, CultureInfo.InvariantCulture, "#0x8000"),
                "#2"
            );
            Assert.AreEqual(
                short.MinValue,
        ...
        public void ConvertFrom_MaxValue()
        {
            Assert.AreEqual(
                short.MaxValue,
                converter.ConvertFrom(null, CultureInfo.InvariantCulture, "#7fff"),
                "#1"
            );
            Assert.AreEqual(
                short.MaxValue,
            ...
            Assert.AreEqual(
                short.MaxValue,
                converter.ConvertFrom(null, CultureInfo.InvariantCulture, "#0x7fff"),
                "#3"
            );
            Assert.AreEqual(
                short.MaxValue,
        ...
        public void ConvertTo_MinValue()
        {
            ...
            Assert.AreEqual(
                short.MinValue.ToString(CultureInfo.CurrentCulture),
                converter.ConvertTo(
                    null,
            ...
            Assert.AreEqual(
                short.MinValue.ToString(CultureInfo.CurrentCulture),
                converter.ConvertTo(short.MinValue, typeof(string)),
                "#3"
            );
        }
        ...
        public void ConvertTo_MaxValue()
        {
            ...
            Assert.AreEqual(
                short.MaxValue.ToString(CultureInfo.CurrentCulture),
                converter.ConvertTo(short.MaxValue, typeof(string)),
                "#3"
            );
        }
        ...
        public void ConvertToString_MinValue()
        {
            Assert.AreEqual(
                short.MinValue.ToString(CultureInfo.InvariantCulture),
                converter.ConvertToString(null, CultureInfo.InvariantCulture, short.MinValue),
                "#1"
            );

            Assert.AreEqual(
                short.MinValue.ToString(CultureInfo.CurrentCulture),
                converter.ConvertToString(null, short.MinValue),
                "#2"
            );
            Assert.AreEqual(
                short.MinValue.ToString(CultureInfo.CurrentCulture),
                converter.ConvertToString(null, CultureInfo.CurrentCulture, short.MinValue),
                "#3"
            );
            Assert.AreEqual(
                short.MinValue.ToString(CultureInfo.CurrentCulture),
                converter.ConvertToString(short.MinValue),
                "#4"
            );
        }
        ...
        public void ConvertToString_MaxValue()
        {
            Assert.AreEqual(
                short.MaxValue.ToString(CultureInfo.InvariantCulture),
                converter.ConvertToString(null, CultureInfo.InvariantCulture, short.MaxValue),
                "#1"
            );

            Assert.AreEqual(
                short.MaxValue.ToString(CultureInfo.CurrentCulture),
                converter.ConvertToString(null, short.MaxValue),
                "#2"
            );
            Assert.AreEqual(
                short.MaxValue.ToString(CultureInfo.CurrentCulture),
                converter.ConvertToString(null, CultureInfo.CurrentCulture, short.MaxValue),
                "#3"
            );
            Assert.AreEqual(
                short.MaxValue.ToString(CultureInfo.CurrentCulture),
                converter.ConvertToString(short.MaxValue),
                "#4"
            );
        }
        ...
        {
            string minOverflow = ((int)(short.MinValue - 1)).ToString(CultureInfo.CurrentCulture);
        ...
        {
            string minOverflow = ((int)(short.MinValue - 1)).ToString(CultureInfo.InvariantCulture);
        ...
        {
            string maxOverflow = ((int)(short.MaxValue + 1)).ToString(CultureInfo.CurrentCulture);
        ...
        {
            string maxOverflow = ((int)(short.MaxValue + 1)).ToString(CultureInfo.InvariantCulture);
        ...
        public void ConvertFrom_Base16_MaxOverflow()
        {
            ...
            Assert.AreEqual(
                -32768,
                converter.ConvertFrom(null, CultureInfo.CurrentCulture, "#" + maxOverflow),
                "#1"
            );

            maxOverflow = ((int)(ushort.MaxValue)).ToString("x", CultureInfo.CurrentCulture);
            Assert.AreEqual(
                -1,
                converter.ConvertFrom(null, CultureInfo.CurrentCulture, "#" + maxOverflow),
                "#2"
            ...
            maxOverflow = (ushort.MaxValue + 1).ToString("x", CultureInfo.CurrentCulture);
        ...
        public void ConvertFrom_Base16_MaxOverflow_Invariant()
        {
            ...
            maxOverflow = ((int)(ushort.MaxValue)).ToString("x", CultureInfo.InvariantCulture);
            Assert.AreEqual(
                -1,
                converter.ConvertFrom(null, CultureInfo.InvariantCulture, "#" + maxOverflow),
                "#2"
            ...
            maxOverflow = (ushort.MaxValue + 1).ToString("x", CultureInfo.InvariantCulture);
        ...
        public void ConvertFromString_Base16_MaxOverflow()
        {
            ...
            maxOverflow = (ushort.MaxValue).ToString("x", CultureInfo.CurrentCulture);
