...
namespace MonoTests.System.ComponentModel
{
    ...
    public class EnumConverterTests
    {
        ...
        public void ConvertFrom_EnumArray()
        {
            ...
            Assert.AreEqual(
                ...
                converter.ConvertFrom(
                    null,
                    CultureInfo.InvariantCulture,
                    (Enum[])new Enum[] { (E2)444, (E)666 }
                ),
                "#A3"
            );
            Assert.AreEqual(
                (E)0,
                converter.ConvertFrom(null, CultureInfo.InvariantCulture, (Enum[])new Enum[0]),
                "#A4"
            );
        ...
        public void ConvertFrom_String()
        {
            ...
            Assert.AreEqual(
                E.Bb,
                converter.ConvertFrom(null, CultureInfo.InvariantCulture, "Bb"),
                "#A1"
            );
            Assert.AreEqual(
                E.Cc,
            ...
            Assert.AreEqual(
                E.Dd,
                converter.ConvertFrom(null, CultureInfo.InvariantCulture, " 3 "),
                "#A4"
            );
            Assert.AreEqual(
                (E)666,
                converter.ConvertFrom(null, CultureInfo.InvariantCulture, "666"),
                "#A5"
            );
            Assert.AreEqual(
                E.Dd,
                converter.ConvertFrom(null, CultureInfo.InvariantCulture, "Bb,Dd"),
                "#A6"
            );
            Assert.AreEqual(
                E.Dd,
                converter.ConvertFrom(null, CultureInfo.InvariantCulture, "Dd,Bb"),
                "#A7"
            );
            Assert.AreEqual(
                E.Bb,
        ...
        public void ConvertFrom_String_Flags()
        {
            ...
            Assert.AreEqual(
                E2.Cc,
                converter.ConvertFrom(null, CultureInfo.InvariantCulture, "Cc"),
                "#B1"
            );
            Assert.AreEqual(
                E2.Dd,
                converter.ConvertFrom(null, CultureInfo.InvariantCulture, "8"),
                "#B2"
            );
            Assert.AreEqual(
                E2.Cc | E2.Dd,
                converter.ConvertFrom(null, CultureInfo.InvariantCulture, "Cc,Dd"),
                "#B3"
            );
            Assert.AreEqual(
                E2.Aa | E2.Bb,
            ...
            Assert.AreEqual(
                E2.Bb | E2.Cc,
                converter.ConvertFrom(null, CultureInfo.InvariantCulture, "2,4"),
                "#B5"
            );
            Assert.AreEqual(
                E2.Aa | E2.Dd,
                converter.ConvertFrom(null, CultureInfo.InvariantCulture, " 1 , 8 "),
                "#B5"
            );
            Assert.AreEqual(
                (E2)666,
            ...
            Assert.AreEqual(
                E2.Cc | E2.Dd,
                converter.ConvertFrom(null, CultureInfo.InvariantCulture, " Dd , Cc "),
                "#B7"
            );
            Assert.AreEqual(
                E2.Bb,
        ...
        public void ConvertTo_EnumArray()
        {
            ...
            enums =
                converter.ConvertTo(null, CultureInfo.InvariantCulture, E.Bb, typeof(Enum[]))
                as Enum[];
            ...
            enums =
                converter.ConvertTo(null, CultureInfo.InvariantCulture, 2, typeof(Enum[]))
                as Enum[];
            ...
            try
            {
                converter.ConvertTo(null, CultureInfo.InvariantCulture, null, typeof(Enum[]));
                Assert.Fail("#D1");
            }
            catch (NotSupportedException ex)
            {
                ...
                Assert.IsTrue(
                    ex.Message.IndexOf("'" + typeof(EnumConverter).Name + "'") != -1,
                    "#D5"
                );
            ...
            try
            {
                converter.ConvertTo(null, CultureInfo.InvariantCulture, "Cc", typeof(Enum[]));
                Assert.Fail("#E1");
            }
            catch (ArgumentException ex)
            {
        ...
        public void ConvertTo_EnumArray_Flags()
        {
            ...
            enums =
                converter.ConvertTo(null, CultureInfo.InvariantCulture, E2.Bb, typeof(Enum[]))
                as Enum[];
            Assert.IsNotNull(enums, "#B1");
            Assert.AreEqual(1, enums.Length, "#B2");
            ...
            enums =
                converter.ConvertTo(null, CultureInfo.InvariantCulture, (E2)0, typeof(Enum[]))
                as Enum[];
            Assert.IsNotNull(enums, "#C1");
            Assert.AreEqual(0, enums.Length, "#C2");

            enums =
                converter.ConvertTo(null, CultureInfo.InvariantCulture, (E2)18, typeof(Enum[]))
                as Enum[];
            ...
            {
                enums =
                    converter.ConvertTo(null, CultureInfo.InvariantCulture, 5, typeof(Enum[]))
                    as Enum[];
                Assert.Fail("#E1");
            }
            ...
            try
            {
                converter.ConvertTo(null, CultureInfo.InvariantCulture, "Bb,Cc", typeof(Enum[]));
                Assert.Fail("#H1");
            }
            catch (InvalidCastException ex)
            {
            ...
            try
            {
                converter.ConvertTo(null, CultureInfo.InvariantCulture, "2,4", typeof(Enum[]));
                Assert.Fail("#I1");
            }
            catch (InvalidCastException ex)
            {
            ...
            enums =
                converter.ConvertTo(null, CultureInfo.InvariantCulture, (F2)15, typeof(Enum[]))
                as Enum[];
            ...
            enums =
                converter.ConvertTo(null, CultureInfo.InvariantCulture, E3.Aa, typeof(Enum[]))
                as Enum[];
        ...
        public void ConvertTo_InstanceDescriptor()
        {
            ...
            catch (NotSupportedException ex)
            {
                ...
                Assert.IsTrue(
                    ex.Message.IndexOf("'" + typeof(InstanceDescriptor).FullName + "'") != -1,
                    "#E7"
                );
            }
        ...
        public void ConvertTo_String()
        {
            ...
            Assert.AreEqual(
                "Bb",
                converter.ConvertTo(null, CultureInfo.InvariantCulture, E.Bb, typeof(string)),
                "#A1"
            );
            Assert.AreEqual(
                "Dd",
                converter.ConvertTo(null, CultureInfo.InvariantCulture, 3, typeof(string)),
                "#A2"
            );
            Assert.AreEqual(
                string.Empty,
            ...
            Assert.AreEqual(
                "Cc",
                converter.ConvertTo(null, CultureInfo.InvariantCulture, (E)2, typeof(string)),
                "#A4"
            );
            Assert.AreEqual(
                "Cc",
                converter.ConvertTo(null, CultureInfo.InvariantCulture, E2.Bb, typeof(string)),
                "#A5"
            );
            Assert.AreEqual(
                "Dd",
            ...
            try
            {
                converter.ConvertTo(null, CultureInfo.InvariantCulture, (E)666, typeof(string));
                Assert.Fail("#B1");
            }
            catch (ArgumentException ex)
            {
            ...
            try
            {
                converter.ConvertTo(null, CultureInfo.InvariantCulture, "Cc", typeof(string));
                Assert.Fail("#C1");
            }
            catch (FormatException ex)
            {
            ...
            Assert.AreEqual(
                "Bb",
                converter.ConvertTo(null, CultureInfo.InvariantCulture, (E2)2, typeof(string)),
                "#B4"
            );
            Assert.AreEqual(
                "Aa, Bb",
                converter.ConvertTo(null, CultureInfo.InvariantCulture, E.Dd, typeof(string)),
                "#B5"
            );
            Assert.AreEqual(
                "Bb, Dd",
