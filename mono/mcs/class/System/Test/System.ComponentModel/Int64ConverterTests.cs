...
namespace MonoTests.System.ComponentModel
{
    ...
    public class Int64ConverterTests
    {
        ...
        public void ConvertFrom_MinValue()
        {
            Assert.AreEqual(
                long.MinValue,
                converter.ConvertFrom(null, CultureInfo.InvariantCulture, "#8000000000000000"),
                "#1"
            );
            Assert.AreEqual(
                long.MinValue,
                converter.ConvertFrom(null, CultureInfo.InvariantCulture, "#0x8000000000000000"),
                "#2"
            );
            Assert.AreEqual(
                long.MinValue,
        ...
        public void ConvertFrom_MaxValue()
        {
            Assert.AreEqual(
                long.MaxValue,
                converter.ConvertFrom(null, CultureInfo.InvariantCulture, "#7fffffffffffffff"),
                "#1"
            );
            Assert.AreEqual(
                long.MaxValue,
            ...
            Assert.AreEqual(
                long.MaxValue,
                converter.ConvertFrom(null, CultureInfo.InvariantCulture, "#0x7fffffffffffffff"),
                "#3"
            );
            Assert.AreEqual(
                long.MaxValue,
        ...
        public void ConvertTo_MinValue()
        {
            ...
            Assert.AreEqual(
                long.MinValue.ToString(CultureInfo.CurrentCulture),
                converter.ConvertTo(
                    null,
            ...
            Assert.AreEqual(
                long.MinValue.ToString(CultureInfo.CurrentCulture),
                converter.ConvertTo(long.MinValue, typeof(string)),
                "#3"
            );
        }
        ...
        public void ConvertTo_MaxValue()
        {
            ...
            Assert.AreEqual(
                long.MaxValue.ToString(CultureInfo.CurrentCulture),
                converter.ConvertTo(
                    null,
                    CultureInfo.CurrentCulture,
                    long.MaxValue,
            ...
            Assert.AreEqual(
                long.MaxValue.ToString(CultureInfo.CurrentCulture),
                converter.ConvertTo(long.MaxValue, typeof(string)),
                "#3"
            );
        }
        ...
        public void ConvertToString()
        {
            ...
            Assert.AreEqual(
                ...
                converter.ConvertToString(null, culture, (long)-5),
                "#1"
            );
            Assert.AreEqual(
