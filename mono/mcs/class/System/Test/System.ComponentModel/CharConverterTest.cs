...
namespace MonoTests.System.ComponentModel
{
    ...
    public class CharConverterTest
    {
        ...
        public void ConvertFrom_String()
        {
            ...
            c = (char)converter.ConvertFrom(null, CultureInfo.InvariantCulture, String.Empty);
            Assert.AreEqual('\0', c, "#1");

            c = (char)converter.ConvertFrom(null, CultureInfo.InvariantCulture, "e");
            Assert.AreEqual('e', c, "#2");

            c = (char)converter.ConvertFrom(null, CultureInfo.InvariantCulture, "\t f\r\n ");
        ...
        public void ConvertFrom_String_Invalid()
        {
            try
            {
                converter.ConvertFrom(null, CultureInfo.InvariantCulture, "ef");
                Assert.Fail("#A1");
            }
            ...
            try
            {
                converter.ConvertFrom(null, CultureInfo.InvariantCulture, "\ref \n");
                Assert.Fail("#B1");
            }
            catch (FormatException ex)
            {
        ...
        public void ConvertToString()
        {
            ...
            result = converter.ConvertToString(null, CultureInfo.InvariantCulture, '\0');
            Assert.AreEqual(string.Empty, result, "#2");

            result = converter.ConvertToString(null, CultureInfo.InvariantCulture, 'f');
