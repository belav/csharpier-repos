...
namespace MonoTests.System.ComponentModel
{
    ...
    public class MyDerivedComponent : MyComponent
    {
        ...
        public MyDerivedComponent(ISite site)
            : base(site) { }
    ...
    public class TypeDescriptorTests
    {
        ...
        public void TestGetAttributes()
        {
            ...
            for (int i = 0; i < col.Count; i++)
            {
                ...
                {
                    found =
                        typeof(MyOtherDesigner).AssemblyQualifiedName == attribute.DesignerTypeName;
                    if (found)
                        break;
                }
            }
        ...
        public void TestGetConverter()
        {
            Assert.AreEqual(
                ...
                TypeDescriptor.GetConverter(typeof(bool)).GetType(),
                "#1"
            );
            Assert.AreEqual(
                typeof(ByteConverter),
                TypeDescriptor.GetConverter(typeof(byte)).GetType(),
                "#2"
            );
            Assert.AreEqual(
                typeof(SByteConverter),
                TypeDescriptor.GetConverter(typeof(sbyte)).GetType(),
                "#3"
            );
            Assert.AreEqual(
                typeof(StringConverter),
                TypeDescriptor.GetConverter(typeof(string)).GetType(),
                "#4"
            );
            Assert.AreEqual(
                typeof(CharConverter),
                TypeDescriptor.GetConverter(typeof(char)).GetType(),
                "#5"
            );
            Assert.AreEqual(
                typeof(Int16Converter),
                TypeDescriptor.GetConverter(typeof(short)).GetType(),
                "#6"
            );
            Assert.AreEqual(
                typeof(Int32Converter),
                TypeDescriptor.GetConverter(typeof(int)).GetType(),
                "#7"
            );
            Assert.AreEqual(
                typeof(Int64Converter),
                TypeDescriptor.GetConverter(typeof(long)).GetType(),
                "#8"
            );
            Assert.AreEqual(
                typeof(UInt16Converter),
                TypeDescriptor.GetConverter(typeof(ushort)).GetType(),
                "#9"
            );
            Assert.AreEqual(
                typeof(UInt32Converter),
                TypeDescriptor.GetConverter(typeof(uint)).GetType(),
                "#10"
            );
            Assert.AreEqual(
                typeof(UInt64Converter),
                TypeDescriptor.GetConverter(typeof(ulong)).GetType(),
                "#11"
            );
            Assert.AreEqual(
                typeof(SingleConverter),
                TypeDescriptor.GetConverter(typeof(float)).GetType(),
                "#12"
            );
            Assert.AreEqual(
                typeof(DoubleConverter),
                TypeDescriptor.GetConverter(typeof(double)).GetType(),
                "#13"
            );
            Assert.AreEqual(
                typeof(DecimalConverter),
                TypeDescriptor.GetConverter(typeof(decimal)).GetType(),
                "#14"
            );
            Assert.AreEqual(
                typeof(ArrayConverter),
                TypeDescriptor.GetConverter(typeof(Array)).GetType(),
                "#15"
            );
            Assert.AreEqual(
                typeof(CultureInfoConverter),
                TypeDescriptor.GetConverter(typeof(CultureInfo)).GetType(),
                "#16"
            );
            Assert.AreEqual(
                typeof(DateTimeConverter),
                TypeDescriptor.GetConverter(typeof(DateTime)).GetType(),
                "#17"
            );
            Assert.AreEqual(
                typeof(GuidConverter),
                TypeDescriptor.GetConverter(typeof(Guid)).GetType(),
                "#18"
            );
            Assert.AreEqual(
                typeof(TimeSpanConverter),
                TypeDescriptor.GetConverter(typeof(TimeSpan)).GetType(),
                "#19"
            );
            Assert.AreEqual(
                typeof(CollectionConverter),
                TypeDescriptor.GetConverter(typeof(ICollection)).GetType(),
                "#20"
            );
            ...
            Assert.AreEqual(
                typeof(CollectionConverter),
                TypeDescriptor.GetConverter(typeof(IDictionary)).GetType(),
                "#21"
            );
            Assert.AreEqual(
                typeof(ReferenceConverter),
                TypeDescriptor.GetConverter(typeof(ITestInterface)).GetType(),
                "#22"
            );
            Assert.AreEqual(
                typeof(TypeConverter),
                TypeDescriptor.GetConverter(typeof(TestClass)).GetType(),
                "#23"
            );
            Assert.AreEqual(
                typeof(TypeConverter),
                TypeDescriptor.GetConverter(typeof(TestStruct)).GetType(),
                "#24"
            );

            Assert.AreEqual(
                typeof(TypeConverter),
                TypeDescriptor.GetConverter(new TestClass()).GetType(),
                "#25"
            );
            Assert.AreEqual(
                typeof(TypeConverter),
                TypeDescriptor.GetConverter(new TestStruct()).GetType(),
                "#26"
            );
            Assert.AreEqual(
                typeof(CollectionConverter),
                TypeDescriptor.GetConverter(new Hashtable()).GetType(),
                "#27"
            );
            ...
            Assert.AreEqual(
                typeof(Int32Converter),
                TypeDescriptor.GetConverter((int?)1).GetType(),
                "#28"
            );
            new ComponentConverter(null); // Needed for MT linker
            Assert.IsTrue(
                TypeDescriptor.GetConverter(typeof(Component)) is ComponentConverter,
                "#29"
            );
            Assert.IsTrue(
                TypeDescriptor.GetConverter(new Component()) is ComponentConverter,
                "#30"
            );
            Assert.AreEqual(
            ...
            Assert.AreEqual(
                ...
                TypeDescriptor.GetConverter(typeof(DateTimeOffset)).GetType(),
                "#32"
            );
        }
        ...
        public void TestGetProperties()
        {
            ...
            //
            PropertyDescriptorCollection derivedCol = TypeDescriptor.GetProperties(
                typeof(MyDerivedComponent)
            );
            Assert.IsNotNull(
                derivedCol["AnotherProperty"].Attributes[typeof(DescriptionAttribute)],
                "#G1"
            );
            ...
            //
            PropertyDescriptorCollection filteredCol = TypeDescriptor.GetProperties(
                typeof(MyDerivedComponent),
        ...
        {
            PropertyDescriptorCollection pc = TypeDescriptor.GetProperties(typeof(string));
        ...
        public void DynamicAttributesShouldBeReturnedForType()
        {
            ...
            var registeredAttributeTypes = TypeDescriptor
                .GetAttributes(testType)
                .Cast<Attribute>()
                .Select(attr => attr.GetType())
                .ToArray();
            Assert.AreEqual(2, registeredAttributeTypes.Length);
            Assert.IsTrue(
                registeredAttributeTypes.Contains(typeof(ProviderTestAttribute)),
                "Contains-1"
            );
            Assert.IsTrue(
                registeredAttributeTypes.Contains(typeof(SerializableAttribute)),
                "Contains-2"
            );
        }
        ...
        public void CustomTypeDescriptorsShouldBeUsedForType()
        {
            ...
            var registeredPropertyDescriptorTypes = TypeDescriptor
                .GetProperties(testType)
                .Cast<PropertyDescriptor>()
                .Select(prop => prop.GetType())
                .ToArray();
            Assert.AreEqual(1, registeredPropertyDescriptorTypes.Length);
            Assert.IsTrue(
                registeredPropertyDescriptorTypes.Contains(typeof(ProviderTestPropertyDescriptor)),
                "Contains-2"
            );
        }
        ...
        private class CustomTestProvider : CustomTypeDescriptor
        {
            ...
            public override PropertyDescriptorCollection GetProperties()
            {
                return new PropertyDescriptorCollection(
                    new PropertyDescriptor[] { new ProviderTestPropertyDescriptor() }
                );
            }
        }
