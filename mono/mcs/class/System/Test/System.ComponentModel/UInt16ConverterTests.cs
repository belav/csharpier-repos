...
namespace MonoTests.System.ComponentModel
{
    ...
    public class UInt16ConverterTests
    {
        ...
        public void ConvertFrom_MaxValue()
        {
            Assert.AreEqual(
                ushort.MaxValue,
                converter.ConvertFrom(null, CultureInfo.InvariantCulture, "#ffff"),
                "#1"
            );
            Assert.AreEqual(
                ushort.MaxValue,
            ...
            Assert.AreEqual(
                ushort.MaxValue,
                converter.ConvertFrom(null, CultureInfo.InvariantCulture, "#0xffff"),
                "#3"
            );
            Assert.AreEqual(
                ushort.MaxValue,
        ...
        public void ConvertTo_MinValue()
        {
            ...
            Assert.AreEqual(
                ushort.MinValue.ToString(CultureInfo.CurrentCulture),
                converter.ConvertTo(
                    null,
            ...
            Assert.AreEqual(
                ushort.MinValue.ToString(CultureInfo.CurrentCulture),
                converter.ConvertTo(ushort.MinValue, typeof(string)),
                "#3"
            );
        }
        ...
        public void ConvertTo_MaxValue()
        {
            ...
            Assert.AreEqual(
                ushort.MaxValue.ToString(CultureInfo.CurrentCulture),
                converter.ConvertTo(ushort.MaxValue, typeof(string)),
                "#3"
            );
        }
