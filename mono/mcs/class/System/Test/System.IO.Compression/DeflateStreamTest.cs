    ...
    public class DeflateStreamTest
    {
        ...
        public void Constructor_InvalidCompressionMode()
        {
            DeflateStream ds = new DeflateStream(
                new MemoryStream(),
                (CompressionMode)Int32.MinValue
            );
        }
        ...
        {
            var base64String =
                @"7cWxCQAgDACwpeBjgqsgXiHU0fd9QzBLErX1EQAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAADepcxcuU/atm3btm3btm3btm3btm3btm3btm3btm3btm3btm3btm3btm3btm3btm3btm3btm3btm3btm3btm3btm3btm3btm3btm3btm3btm3btm3btm3btm3btm3btm37zy8=";
            ...
            using (var zippedMemoryStream = new MemoryStream(byteArray))
            using (
                var gZipStream = new DeflateStream(zippedMemoryStream, CompressionMode.Decompress)
            )
            using (var unzippedMemStream = new MemoryStream())
            using (var unZippedStream = new StreamReader(gZipStream, Encoding.UTF8))
            {
        ...
        public void Bug44994_InflateByteByByte()
        {
            ...
            using (
                var fileStream = File.OpenRead(
                    TestResourceHelper.GetFullPathOfResource("Test/compressed.bin")
                )
            )
            {
                using (
