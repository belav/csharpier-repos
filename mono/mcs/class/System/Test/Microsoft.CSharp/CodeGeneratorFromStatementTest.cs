...
namespace MonoTests.Microsoft.CSharp
{
    ...
    public class CodeGeneratorFromStatementTest : CodeGeneratorTestBase
    {
        ...
        public void CodeAttachEventStatementTest()
        {
            ...
            Assert.AreEqual(
                string.Format(CultureInfo.InvariantCulture, " += EventHandler;{0}", NewLine),
                Generate(),
                "#3"
            );
        ...
        public void CodeConditionStatementTest()
        {
            ...
            Assert.AreEqual(
                string.Format(CultureInfo.InvariantCulture, "if () {{{0}" + "}}{0}", NewLine),
                Generate(),
                "#2"
            );
        ...
        public void CodeTryCatchFinallyStatementTest()
        {
            ...
            Assert.AreEqual(
                string.Format(CultureInfo.InvariantCulture, "try {{{0}" + "}}{0}", NewLine),
                Generate(),
                "#3"
            );
        ...
        public void CodeVariableDeclarationStatementTest()
        {
            ...
            Assert.AreEqual(
                string.Format(CultureInfo.InvariantCulture, "void ;{0}", NewLine),
                Generate(),
                "#1"
            );
            ...
            cvds.Name = "class";
            Assert.AreEqual(
                string.Format(CultureInfo.InvariantCulture, "void @class;{0}", NewLine),
                Generate(),
                "#2"
            );
            ...
            cvds.Name = "A";
            Assert.AreEqual(
                string.Format(CultureInfo.InvariantCulture, "void A;{0}", NewLine),
                Generate(),
                "#3"
            );
            ...
            Assert.AreEqual(
                string.Format(CultureInfo.InvariantCulture, "int A;{0}", NewLine),
                Generate(),
                "#4"
            );
            ...
            Assert.AreEqual(
                string.Format(CultureInfo.InvariantCulture, "int A = 25;{0}", NewLine),
                Generate(),
                "#5"
            );
            ...
            cvds.Name = null;
            Assert.AreEqual(
                string.Format(CultureInfo.InvariantCulture, "int  = 25;{0}", NewLine),
                Generate(),
                "#5"
            );
        }
