...
namespace MonoTests.System.Net
{
    ...
    public class CredentialCacheTest
    {
        ...
        public void All()
        {
            ...
            result = c.GetCredential(
                new Uri("http://www.contoso.com/portal/foo/bar.html"),
                "**Unknown**"
            );
            ...
            result = c.GetCredential(
                new Uri("http://www.contoso.com:80/portal/news/index.aspx"),
                "Basic"
            );
            Assert.AreEqual(result, cred3, "#9");

            result = c.GetCredential(
                new Uri("http://www.contoso.com:80/portal/news/index"),
                "Basic"
            );
