...
namespace MonoTests.System.Net
{
    ...
    public class ServicePointTest
    {
        ...
        public void All()
        {
            ...
            ServicePoint exampleCom = ServicePointManager.FindServicePoint(
                new Uri("http://www.example.com")
            );
            try
            {
                ServicePoint exampleOrg = ServicePointManager.FindServicePoint(
            ...
            ServicePoint example2 = ServicePointManager.FindServicePoint(
                new Uri("http://www.example.com/dilbert.html")
            );
        ...
        public void DnsRefreshTimeout()
        {
            ...
            hostEntryProperty = typeof(ServicePoint).GetProperty(
                "HostEntry",
