...
namespace MonoTests.System.Net
{
    ...
    public class WebClientTest
    {
        ...
        public void DownloadFile1_FileName_Null()
        {
            ...
            try
            {
                wc.DownloadFile("tp://scheme.notsupported", (string)null);
                Assert.Fail("#1");
            }
            catch (ArgumentNullException ex)
            {
        ...
        public void DownloadFile2_FileName_Null()
        {
            ...
            try
            {
                wc.DownloadFile(new Uri("tp://scheme.notsupported"), (string)null);
                Assert.Fail("#1");
            }
            catch (ArgumentNullException ex)
            {
        ...
        public void OpenWrite4_Address_SchemeNotSupported()
        {
            ...
            try
            {
                wc.OpenWrite(new Uri("tp://scheme.notsupported"), "POST");
                Assert.Fail("#1");
            }
            catch (WebException ex)
            {
        ...
        public void UploadData1_Data_Null()
        {
            ...
            try
            {
                wc.UploadData("http://www.example.com", (byte[])null);
                Assert.Fail("#1");
            }
            catch (ArgumentNullException ex)
            {
        ...
        public void UploadData2_Address_SchemeNotSupported()
        {
            ...
            try
            {
                wc.UploadData(new Uri("tp://scheme.notsupported"), new byte[] { 0x1a });
                Assert.Fail("#1");
            }
            catch (WebException ex)
            {
        ...
        public void UploadData2_Data_Null()
        {
            ...
            try
            {
                wc.UploadData(new Uri("http://www.example.com"), (byte[])null);
                Assert.Fail("#1");
            }
            catch (ArgumentNullException ex)
            {
        ...
        public void UploadData3_Address_Null()
        {
            ...
            try
            {
                wc.UploadData((string)null, "POST", new byte[] { 0x1a });
                Assert.Fail("#1");
            }
            catch (ArgumentNullException ex)
            {
        ...
        public void UploadData3_Address_SchemeNotSupported()
        {
            ...
            try
            {
                wc.UploadData("tp://scheme.notsupported", "POST", new byte[] { 0x1a });
                Assert.Fail("#1");
            }
            catch (WebException ex)
            {
        ...
        public void UploadData3_Data_Null()
        {
            ...
            try
            {
                wc.UploadData("http://www.example.com", "POST", (byte[])null);
                Assert.Fail("#1");
            }
            catch (ArgumentNullException ex)
            {
        ...
        public void UploadData4_Address_SchemeNotSupported()
        {
            ...
            try
            {
                wc.UploadData(new Uri("tp://scheme.notsupported"), "POST", new byte[] { 0x1a });
                Assert.Fail("#1");
            }
            catch (WebException ex)
            {
        ...
        public void UploadData4_Data_Null()
        {
            ...
            try
            {
                wc.UploadData(new Uri("http://www.example.com"), "POST", (byte[])null);
                Assert.Fail("#1");
            }
            catch (ArgumentNullException ex)
            {
        ...
        public void UploadFile1_Address_SchemeNotSupported()
        {
            ...
            try
            {
                wc.UploadFile("tp://scheme.notsupported", tempFile);
                Assert.Fail("#1");
            }
            catch (WebException ex)
            {
        ...
        public void UploadFile1_FileName_NotFound()
        {
            using (var tempPath = new TempDirectory())
            {
                ...
                catch (WebException ex)
                {
                    ...
                    // Could not find file "..."
                    FileNotFoundException inner = ex.InnerException as FileNotFoundException;
        ...
        public void UploadFile1_FileName_Null()
        {
            ...
            try
            {
                wc.UploadFile("tp://scheme.notsupported", (string)null);
                Assert.Fail("#1");
            }
            catch (ArgumentNullException ex)
            {
        ...
        public void UploadFile2_Address_SchemeNotSupported()
        {
            ...
            try
            {
                wc.UploadFile(new Uri("tp://scheme.notsupported"), tempFile);
                Assert.Fail("#1");
            }
            catch (WebException ex)
            {
        ...
        public void UploadFile2_FileName_Null()
        {
            ...
            try
            {
                wc.UploadFile(new Uri("tp://scheme.notsupported"), null);
                Assert.Fail("#1");
            }
            catch (ArgumentNullException ex)
            {
        ...
        public void UploadFile3_Address_SchemeNotSupported()
        {
            ...
            try
            {
                wc.UploadFile("tp://scheme.notsupported", "POST", tempFile);
                Assert.Fail("#1");
            }
            catch (WebException ex)
            {
        ...
        public void UploadFile3_FileName_Null()
        {
            ...
            try
            {
                wc.UploadFile("tp://scheme.notsupported", "POST", (string)null);
                Assert.Fail("#1");
            }
            catch (ArgumentNullException ex)
            {
        ...
        public void UploadFile4_Address_SchemeNotSupported()
        {
            ...
            try
            {
                wc.UploadFile(new Uri("tp://scheme.notsupported"), "POST", tempFile);
                Assert.Fail("#1");
            }
            catch (WebException ex)
            {
        ...
        public void UploadFile4_FileName_Null()
        {
            ...
            try
            {
                wc.UploadFile(new Uri("tp://scheme.notsupported"), "POST", (string)null);
                Assert.Fail("#1");
            }
            catch (ArgumentNullException ex)
            {
        ...
        public void UploadString2_Data_Null()
        {
            ...
            try
            {
                wc.UploadString(new Uri("tp://scheme.notsupported"), (string)null);
                Assert.Fail("#1");
            }
            catch (ArgumentNullException ex)
            {
        ...
        public void UploadString3_Address_Null()
        {
            ...
            try
            {
                wc.UploadString((string)null, (string)null, (string)null);
                Assert.Fail("#1");
            }
            catch (ArgumentNullException ex)
            {
        ...
        public void UploadString3_Address_SchemeNotSupported()
        {
            ...
            try
            {
                wc.UploadString("tp://scheme.notsupported", "POST", "abc");
                Assert.Fail("#1");
            }
            catch (WebException ex)
            {
        ...
        public void UploadString3_Data_Null()
        {
            ...
            try
            {
                wc.UploadString("tp://scheme.notsupported", "POST", (string)null);
                Assert.Fail("#1");
            }
            catch (ArgumentNullException ex)
            {
        ...
        public void UploadString4_Address_Null()
        {
            ...
            try
            {
                wc.UploadString((Uri)null, (string)null, (string)null);
                Assert.Fail("#1");
            }
            catch (ArgumentNullException ex)
            {
        ...
        public void UploadString4_Address_SchemeNotSupported()
        {
            ...
            try
            {
                wc.UploadString(new Uri("tp://scheme.notsupported"), "POST", "abc");
                Assert.Fail("#1");
            }
            catch (WebException ex)
            {
        ...
        public void UploadString4_Data_Null()
        {
            ...
            try
            {
                wc.UploadString(new Uri("tp://scheme.notsupported"), "POST", (string)null);
                Assert.Fail("#1");
            }
            catch (ArgumentNullException ex)
            {
        ...
        public void UploadValues1_Address_SchemeNotSupported()
        {
            ...
            try
            {
                wc.UploadValues("tp://scheme.notsupported", new NameValueCollection());
                Assert.Fail("#1");
            }
            catch (WebException ex)
            {
        ...
        public void UploadValues1_Data_Null()
        {
            ...
            try
            {
                wc.UploadValues("http://www.example.com", (NameValueCollection)null);
                Assert.Fail("#1");
            }
            catch (ArgumentNullException ex)
            {
        ...
        public void UploadValues2_Address_SchemeNotSupported()
        {
            ...
            try
            {
                wc.UploadValues(new Uri("tp://scheme.notsupported"), new NameValueCollection());
                Assert.Fail("#1");
            }
            catch (WebException ex)
            {
        ...
        public void UploadValues2_Data_Null()
        {
            ...
            try
            {
                wc.UploadValues(new Uri("http://www.example.com"), (NameValueCollection)null);
                Assert.Fail("#1");
            }
            catch (ArgumentNullException ex)
            {
        ...
        public void UploadValues3_Address_Null()
        {
            ...
            try
            {
                wc.UploadValues((string)null, "POST", new NameValueCollection());
                Assert.Fail("#1");
            }
            catch (ArgumentNullException ex)
            {
        ...
        public void UploadValues3_Address_SchemeNotSupported()
        {
            ...
            try
            {
                wc.UploadValues("tp://scheme.notsupported", "POST", new NameValueCollection());
                Assert.Fail("#1");
            }
            catch (WebException ex)
            {
        ...
        public void UploadValues3_Data_Null()
        {
            ...
            try
            {
                wc.UploadValues("http://www.example.com", "POST", (NameValueCollection)null);
                Assert.Fail("#1");
            }
            catch (ArgumentNullException ex)
            {
        ...
        public void UploadValues4_Address_Null()
        {
            ...
            try
            {
                wc.UploadValues((Uri)null, "POST", new NameValueCollection());
                Assert.Fail("#1");
            }
            catch (ArgumentNullException ex)
            {
        ...
        public void UploadValues4_Address_SchemeNotSupported()
        {
            ...
            {
                wc.UploadValues(
                    new Uri("tp://scheme.notsupported"),
                    "POST",
        ...
        public void UploadAsyncCancelEventTest(
            int port,
            Action<WebClient, Uri, EventWaitHandle> uploadAction
        )
        {
