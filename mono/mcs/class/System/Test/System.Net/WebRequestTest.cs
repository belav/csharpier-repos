...
namespace MonoTests.System.Net
{
    ...
    public class WebRequestTest
    {
        ...
        public void All()
        {
            ...
            bool ret = WebRequest.RegisterPrefix(
                "http://WWW.contoso.com",
                new TestWebRequestCreator()
            );
            Assert.AreEqual(false, ret, "#5a");
            ret = WebRequest.RegisterPrefix(
                "http://www.contoso.com/foo/bar",
                new TestWebRequestCreator2()
            );
        ...
        public void DefaultWebProxy()
        {
            ...
            HttpWebRequest req = (HttpWebRequest)
                WebRequest.CreateDefault(new Uri("http://www.example.com"));
            ...
            req = (HttpWebRequest)WebRequest.CreateDefault(new Uri("http://www.example.com"));
        ...
        public void TestFailedConnection()
        {
            ...
            catch (Exception e)
            {
                ...
                Assert.IsTrue(
                    e.InnerException is Socks.SocketException,
                    "InnerException should be SocketException"
                );
        ...
        public void TestFailedResolution()
        {
            ...
            {
                var req = WebRequest
                    .Create("http://thisdomaindoesnotexist.monotestcase.x/non-existant.txt")
                    .GetResponse();
                /*
