    ...
    public class WebHeaderCollectionTest
    {
        ...
        public void IsRestricted_2_0_RequestRequest()
        {
            ...
            foreach (string str in request_headers)
            {
                ...
                {
                    Assert.IsTrue(
                        Array.IndexOf(restricted_request_request, str) != -1,
                        "restricted " + str
                    );
                    count++;
                }
        ...
        public void IsRestricted_2_0_ResponseRequest()
        {
            ...
            foreach (string str in response_headers)
            {
                ...
                {
                    Assert.IsTrue(
                        Array.IndexOf(restricted_response_request, str) != -1,
                        "restricted " + str
                    );
                    count++;
                }
        ...
        public void IsRestricted_2_0_RequestResponse()
        {
            ...
            foreach (string str in request_headers)
            {
                ...
                {
                    Assert.IsTrue(
                        Array.IndexOf(restricted_request_response, str) != -1,
                        "restricted " + str
                    );
                    count++;
                }
        ...
        public void IsRestricted_2_0_ResponseResponse()
        {
            ...
            foreach (string str in response_headers)
            {
                ...
                {
                    Assert.IsTrue(
                        Array.IndexOf(restricted_response_response, str) != -1,
                        "restricted " + str
                    );
                    count++;
                }
