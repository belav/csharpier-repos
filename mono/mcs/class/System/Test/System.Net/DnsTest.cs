...
namespace MonoTests.System.Net
{
    ...
    public class DnsTest
    {
        ...
        private uint site1IP = 134744072,
            site2IP = 134743044; // Big-Endian
        ...
        public void BeginGetHostAddresses_HostNameOrAddress_Null()
        {
            try
            {
                Dns.BeginGetHostAddresses((string)null, new AsyncCallback(ShouldntBeCalled), null);
                Assert.Fail("#1");
            }
        ...
        public void BeginGetHostAddresses_HostNameOrAddress_UnspecifiedAddress()
        {
            ...
            try
            {
                Dns.BeginGetHostAddresses("0.0.0.0", new AsyncCallback(ShouldntBeCalled), null);
                Assert.Fail("#A1");
            }
            ...
            try
            {
                Dns.BeginGetHostAddresses("::0", new AsyncCallback(ShouldntBeCalled), null);
                Assert.Fail("#B1");
            }
            catch (ArgumentException ex)
            {
        ...
        public void GetHostByName()
        {
            ...
            try
            {
                ...
                Assert.Fail(
                    "Should raise a SocketException (assuming that '"
                        + noneExistingSite
                        + "' does not exist)"
                );
            }
        ...
        public void BeginResolve_HostName_Null()
        {
            try
            {
                Dns.BeginResolve((string)null, new AsyncCallback(ShouldntBeCalled), null);
                Assert.Fail("#1");
            }
            catch (ArgumentNullException ex)
            {
        ...
        public void BeginGetHostEntry1_Address_Null()
        {
            try
            {
                Dns.BeginGetHostEntry((IPAddress)null, new AsyncCallback(ShouldntBeCalled), null);
                Assert.Fail("#1");
            }
            catch (ArgumentNullException ex)
            {
        ...
        public void BeginGetHostEntry2_HostNameOrAddress_Null()
        {
            try
            {
                Dns.BeginGetHostEntry((string)null, new AsyncCallback(ShouldntBeCalled), null);
                Assert.Fail("#1");
            }
            catch (ArgumentNullException ex)
            {
        ...
        public void BeginGetHostEntry2_HostNameOrAddress_UnspecifiedAddress()
        {
            ...
            try
            {
                Dns.BeginGetHostEntry("0.0.0.0", new AsyncCallback(GetHostEntryCallback), null);
                Assert.Fail("#1");
            }
            catch (ArgumentException ex)
            {
            ...
            try
            {
                Dns.BeginGetHostEntry("::0", new AsyncCallback(GetHostEntryCallback), null);
                Assert.Fail("#1");
            }
            catch (ArgumentException ex)
            {
