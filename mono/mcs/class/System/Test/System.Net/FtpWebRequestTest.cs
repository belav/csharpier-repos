    ...
    public class FtpWebRequestTest
    {
        ...
        FtpWebRequest defaultRequest
        {
            get
            {
                return _defaultRequest
                    ?? (
                        _defaultRequest = (FtpWebRequest)WebRequest.Create("ftp://www.contoso.com")
                    );
            }
        }
        ...
        void UploadFile1(bool ipv6)
        {
            ...
            string uri = String.Format(
                "ftp://{0}:{1}/uploads/file.txt",
                EncloseIPv6(sp.IPAddress),
                sp.Port
            );
            try
            {
        ...
        {
            string filename =
                "\u0411\u0430\u0448\u043DRowan-\u041F\u0435\u0441\u043D\u043F\u0440\u043E\u043C\u043E\u043D\u0430\u0445\u0430\u0422\u0435\u043E\u0434\u043E\u0440\u0443\u0441\u0430\u0438\u0437\u0413\u0430\u043C\u043C\u0435\u043B\u044C\u043D\u0430.mp3";
            DownloadFile(
                new ServerDownload(null, null, filename, false),
                "ftp://{0}:{1}/" + filename
            );
        }
        ...
        void DownloadFile(ServerDownload sp, string uriTemplate = "ftp://{0}:{1}/file.txt")
        {
            ...
            try
            {
                ...
                FtpWebResponse response = (FtpWebResponse)ftp.GetResponse();
                Assert.IsTrue(
                    (int)response.StatusCode >= 100 && (int)response.StatusCode < 200,
                    "DL#01"
                );
        ...
        abstract class FtpServer
        {
            ...
            protected bool DoInitialDialog(
                StreamWriter writer,
                StreamReader reader,
                string pwd,
                string cwd
