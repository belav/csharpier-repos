...
namespace MonoTests.System.Net
{
    ...
    public class CookieContainerTest
    {
        ...
        public void Constructor1()
        {
            ...
            Assert.AreEqual(
                CookieContainer.DefaultPerDomainCookieLimit,
                c.PerDomainCapacity,
                "PerDomainCapacity"
            );
        }
        ...
        public void Add_Domain_Invalid()
        {
            ...
            {
                cc.Add(
                    new Uri("http://mono.com/"),
                    new Cookie("Foo", "Bar", string.Empty, ".evil.org")
                );
                Assert.Fail("#A2");
            }
            catch (CookieException)
        ...
        public void GetCookieHeader1()
        {
            ...
            cc.Add(cookie);
            Assert.AreEqual(
                "$Version=1; name2=value2; $Path=/path/sub; name1=value1",
                cc.GetCookieHeader(new Uri("http://localhost/path/sub")),
                "#A1"
            );
#endif
            Assert.AreEqual(
                "name1=value1",
                cc.GetCookieHeader(new Uri("http://localhost/path")),
                "#A2"
            );
            Assert.AreEqual(
                string.Empty,
                cc.GetCookieHeader(new Uri("http://localhost/whatever")),
                "#A3"
            );
        }
        ...
        public void GetCookieHeader2a()
        {
            ...
            Assert.AreEqual(
                "Age=26; Country=Belgium",
                cc.GetCookieHeader(new Uri("http://dev.mono.com/path/ok")),
                "#A1"
            );
            Assert.AreEqual(
                "Country=Belgium",
                cc.GetCookieHeader(new Uri("http://mono.com/path")),
                "#A2"
            );
            Assert.AreEqual(
                "Country=Belgium",
                cc.GetCookieHeader(new Uri("http://test.mono.com/path")),
                "#A3"
            );
            Assert.AreEqual(
                "Age=26; Country=Belgium",
                cc.GetCookieHeader(new Uri("http://us.dev.mono.com/path")),
                "#A4"
            );
        }
        ...
        public void GetCookieHeader3()
        {
            CookieContainer cc = new CookieContainer();
            cc.SetCookies(
                new Uri("http://dev.test.mono.com/Whatever/Do"),
            ...
            Assert.AreEqual(
                "Weight=87; Country=Belgium",
                cc.GetCookieHeader(new Uri("http://dev.mono.com/Whatever/Do")),
                "#C1"
            );
            Assert.AreEqual(
                "Weight=87; Country=Belgium",
                cc.GetCookieHeader(new Uri("http://test.mono.com/Whatever/Do")),
                "#C2"
            );
            Assert.AreEqual(
                "Weight=87; Country=Belgium",
                cc.GetCookieHeader(new Uri("http://mono.com/Whatever/Do")),
                "#C3"
            );
            Assert.AreEqual(
                "Weight=87; Country=Belgium",
                cc.GetCookieHeader(new Uri("http://us.test.mono.com/Whatever/Do")),
                "#C4"
            );
        }
        ...
        public void GetCookieHeader4()
        {
            ...
            cc.Add(cookie);
            cc.SetCookies(
                new Uri("http://dev.test.mono.com/Whatever/Do/You"),
                "Country=Belgium,"
                    + "Age=26; path=/Whatever/Do; domain=test.mono.com,"
                    + "Weight=87; path=/"
            );
            Assert.AreEqual(
                "Age=26; Income=34445; Height=178; Town=Brussels",
        ...
        public void GetCookieHeader5a()
        {
            ...
            cc.Add(cookie);
            Assert.AreEqual(
                "$Version=1; name1=value1; $Domain=localhost",
                cookie.ToString(),
                "#E0"
            );
            Assert.AreEqual(
        ...
        public void GetCookieHeader7a()
        {
            ...
            cc.Add(cookie);
            Assert.AreEqual(
                "$Version=1; name2=value2; $Path=/path/sub; $Domain=.mono.com; name1=value1",
                cc.GetCookieHeader(new Uri("http://live.mono.com/path/sub")),
                "#A1"
            );
#endif
            Assert.AreEqual(
                "name1=value1",
                cc.GetCookieHeader(new Uri("http://live.mono.com/path")),
                "#A2"
            );
            Assert.AreEqual(
                string.Empty,
                cc.GetCookieHeader(new Uri("http://live.mono.com/whatever")),
                "#A3"
            );
            Assert.AreEqual(
                string.Empty,
                cc.GetCookieHeader(new Uri("http://gomono.com/path/sub")),
                "#A4"
            );
            Assert.AreEqual(
                "name1=value1",
                cc.GetCookieHeader(new Uri("http://mono.com/path/sub")),
                "#A5"
            );
        }
        ...
        public void GetCookieHeader7b()
        {
            ...
            Assert.AreEqual(
                "name1=value1",
                cc.GetCookieHeader(new Uri("http://go.live.mono.com/path/sub")),
                "#B4"
            );
            Assert.AreEqual(
                "name1=value1",
                cc.GetCookieHeader(new Uri("http://go.live.mono.com/path")),
                "#B5"
            );
            Assert.AreEqual(
                string.Empty,
                cc.GetCookieHeader(new Uri("http://go.live.mono.com/whatever")),
                "#B6"
            );
            Assert.AreEqual(
                string.Empty,
                cc.GetCookieHeader(new Uri("http://golive.mono.com/whatever")),
                "#B7"
            );
        }
        ...
        public void GetCookies()
        {
            ...
            CookieCollection cookies = container.GetCookies(new Uri("http://localhost/path/sub"));
        ...
        public void GetCookies2b()
        {
            ...
            CookieCollection cookies = container.GetCookies(
                new Uri("http://dev.mono.com/Whatever/Do")
            );
        ...
        public void GetCookies2c()
        {
            ...
            CookieCollection cookies = container.GetCookies(
                new Uri("http://us.test.mono.com/Whatever/Do/Ok")
            );
        ...
        public void SetCookies()
        {
            ...
            CookieCollection cookies = cc.GetCookies(
                new Uri("http://us.test.mono.com/Whatever/Do/Ok")
            );
            ...
            for (int i = 0; i < cookies.Count; i++)
            {
                ...
                switch (cookie.Name)
                {
                    case "Weight":
                        ...
                        Assert.IsTrue(
                            (cookie.TimeStamp - now).TotalMilliseconds >= 0,
                            "#E:TimeStamp1"
                        );
                        Assert.IsTrue(
                            (cookie.TimeStamp - now).TotalMilliseconds < 1000,
                            "#E:TimeStamp2"
                        );
        ...
        public void SetCookies_CookieHeader_Invalid_2()
        {
            ...
            {
                cc.SetCookies(
                    new Uri("http://dev.test.mono.com/Whatever"),
                    "Age=26; path=/Whatever/Do; domain=test.mono.com"
                );
                Assert.Fail("#B1");
            }
            catch (CookieException ex)
            {
                ...
                Assert.IsTrue(
                    inner.Message.IndexOf("'Path'='/Whatever/Do'") != -1
                        || inner.Message.IndexOf("\"Path\"=\"/Whatever/Do\"") != 1,
                    "#B9"
                );
            }
        ...
        public void SetCookies_DomainMatchesHost()
        {
            ...
            cc.SetCookies(
                new Uri("http://test.mono.com/Whatever/Do"),
                "Age=26; path=/Whatever; domain=test.mono.com"
            );
        ...
        public void bug421827()
        {
            ...
            container = new CookieContainer();
            container.SetCookies(
                new Uri("http://sub.mono.com/Whatever/Do"),
                "Country=Belgium; path=/Whatever; domain=mono.com"
            );
        ...
        public void SaveAndLoadViaAddUriCookie()
        {
            ...
            Assert.AreEqual(
                ...
                cloned.Expires.ToUniversalTime(),
                "#A7"
            );
        ...
        public void SaveAndLoadViaSetCookies()
        {
            ...
            container.SetCookies(
                uri,
                "name=value; domain=.example.com; expires=Fri, 01-Jan-2100 00:00:00 GMT; HttpOnly; secure"
            );
            CookieCollection collection = container.GetCookies(uri);
            Assert.AreEqual(collection.Count, 1, "#A1");
            Cookie cloned = collection[0];
