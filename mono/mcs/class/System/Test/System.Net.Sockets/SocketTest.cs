    ...
    public class SocketTest
    {
        ...
        public void IncompatibleAddress()
        {
            ...
            catch (SocketException ex)
            {
                ...
                Assert.AreEqual(expectedError, ex.ErrorCode, "#2");
            }
        }
        ...
        public void ConnectFailAsync()
        {
             ...
             */
            sock.BeginConnect(
                new IPEndPoint(IPAddress.Loopback, NetworkHelpers.FindFreePort()),
        ...
        public void SocketErrorTest()
        {
            ...
            sock.Blocking = false;
            sock.BeginConnect(ep, new AsyncCallback(SocketError_callback), sock);
        ...
        public void TtlChangeOverflow()
        {
            ...
            {
                Assert.AreEqual("value", ex.ParamName, "TtlChangeOverflow #2");
            }
            finally
            {
                sock.Close();
        ...
        */
        ...
        public void ReceiveTimeoutChange()
        {
            ...
            Assert.AreEqual(
                2000,
                Approximate(2000, sock.ReceiveTimeout),
                "ReceiveTimeoutChange #2"
            );
        ...
        public void NoDelayDefaultUdp()
        {
            ...
            {
                Assert.AreEqual(10042, ex.ErrorCode, "NoDelayDefaultUdp #2");
            }
            finally
            {
                sock.Close();
        ...
        public void NoDelayChangeUdp()
        {
            ...
            {
                Assert.AreEqual(10042, ex.ErrorCode, "NoDelayChangeUdp #2");
            }
            finally
            {
                sock.Close();
        ...
        private static void BADCallback(IAsyncResult asyncResult)
        {
            ...
            BADSocket = sock.EndAccept(out BADBytes, out BADByteCount, asyncResult);
        ...
        public void BeginAcceptData()
        {
             ...
             */
            Assert.IsFalse(BADBytes.Length == send_bytes.Length, "BeginAcceptData #6");
        ...
        public void BeginAcceptSocketUdp()
        {
            ...
            Socket acc = new Socket(AddressFamily.InterNetwork, SocketType.Dgram, ProtocolType.Udp);
        ...
        public void BeginAcceptSocket()
        {
             ...
             * parameter in BeginAccept()
             */
            Assert.IsFalse(BADBytes.Length == send_bytes.Length, "BeginAcceptSocket #10");
            ...
            for (int i = 0; i < send_bytes.Length; i++)
            {
                Assert.AreEqual(
                    send_bytes[i],
                    BADBytes[i],
                    "BeginAcceptSocket #" + (i + 11).ToString()
                );
            }
        ...
        public void BeginConnectHostPortNull()
        {
            ...
            try
            {
                sock.BeginConnect((string)null, 0, BCCallback, sock);
        ...
        public void BeginConnectHostPortListen()
        {
            ...
            try
            {
                sock.BeginConnect("localhost", ep.Port, BCCallback, sock);
        ...
        public void TestDefaultsDualMode()
        {
            ...
            )
            {
                Assert.IsTrue(
                    socket.DualMode,
                    "In Mono, DualMode must be true when constructing InterNetworkV6 sockets"
                );
            }
            ...
            using (var socket = new Socket(SocketType.Stream, ProtocolType.Tcp))
            {
                Assert.AreEqual(
                    ...
                    "When creating sockets of type stream/tcp, the address family should be InterNetworkV6"
                );
                Assert.IsTrue(
                    socket.DualMode,
                    "In Mono, DualMode must be true when constructing InterNetworkV6 sockets"
                ...
                Assert.IsFalse(
                    socket.DualMode,
                    "Setting of DualSocket should turn DualSockets off"
                );
            }
        }
        ...
        public void ReceiveGeneric()
        {
            ...
            for (i = 4; i < 6; i++)
            {
                Assert.AreEqual(sendbuf[i], (byte)i, "#1/" + i.ToString());
            }

            SocketError err;
            sendsock.Send(sendbuf, 0, 256, SocketFlags.None, out err);
            ...
            for (i = 2; i < 232; i++)
            {
                Assert.AreEqual(sendbuf[i], recvbuf[i + 18], "#2/" + i.ToString());
            }
        ...
        public void SendGeneric()
        {
            ...
            for (i = 2; i < 232; i++)
            {
                Assert.AreEqual(recvbuf[i], sendbuf[i + 18], "#2/" + i.ToString());
            }
        ...
        public void SendGenericExceedBuffer()
        {
            ...
            for (i = 0; i < BUFFER_SIZE; i++)
            {
                Assert.AreEqual(recvbuf[i], sendbuf[i], "#3/" + i.ToString());
            }
        ...
        {
            CWRSocket = new Socket(AddressFamily.InterNetwork, SocketType.Dgram, ProtocolType.Udp);
        ...
        public void Receive8_Buffers_Null()
        {
            ...
            try
            {
                s.Receive((IList<ArraySegment<byte>>)null, (SocketFlags)666, out error);
                Assert.Fail("#1");
            }
            catch (ArgumentNullException ex)
            {
        ...
        public void ReceiveFrom3_Buffer_Null()
        {
            ...
            try
            {
                s.ReceiveFrom((Byte[])null, 0, (SocketFlags)666, ref remoteEP);
                Assert.Fail("#1");
            }
            catch (ArgumentNullException ex)
            {
        ...
        public void ReceiveFrom3_Size_OutOfRange()
        {
            ...
            try
            {
                s.ReceiveFrom(buffer, (buffer.Length + 1), (SocketFlags)666, ref remoteEP);
                Assert.Fail("#B1");
            }
            catch (ArgumentOutOfRangeException ex)
            {
        ...
        public void ReceiveFrom3_Socket_Closed()
        {
            ...
            try
            {
                s.ReceiveFrom((Byte[])null, -1, (SocketFlags)666, ref remoteEP);
                Assert.Fail("#1");
            }
            catch (ObjectDisposedException ex)
            {
        ...
        public void ReceiveFrom4_Buffer_Null()
        {
            ...
            try
            {
                s.ReceiveFrom((Byte[])null, -1, -1, (SocketFlags)666, ref remoteEP);
                Assert.Fail("#1");
            }
            catch (ArgumentNullException ex)
            {
        ...
        public void ReceiveFrom4_Offset_OutOfRange()
        {
            ...
            try
            {
                s.ReceiveFrom(buffer, -1, 0, (SocketFlags)666, ref remoteEP);
                Assert.Fail("#A1");
            }
            catch (ArgumentOutOfRangeException ex)
            {
            ...
            try
            {
                s.ReceiveFrom(buffer, (buffer.Length + 1), 0, (SocketFlags)666, ref remoteEP);
                Assert.Fail("#B1");
            }
            catch (ArgumentOutOfRangeException ex)
            {
        ...
        public void ReceiveFrom4_Size_OutOfRange()
        {
            ...
            try
            {
                s.ReceiveFrom(buffer, 0, -1, (SocketFlags)666, ref remoteEP);
                Assert.Fail("#A1");
            }
            catch (ArgumentOutOfRangeException ex)
            {
            ...
            try
            {
                s.ReceiveFrom(buffer, 0, (buffer.Length + 1), (SocketFlags)666, ref remoteEP);
                Assert.Fail("#B1");
            }
            catch (ArgumentOutOfRangeException ex)
            {
        ...
        public void UdpDoubleBind()
        {
            ...
            )
            {
                ...
                try
                {
                    ...
                    if (!supportsReuseAddress)
                        Assert.Fail(
                            "Reusing address is not supported, exception was expected on second bind."
                        );
                }
                catch (SocketException e) { }
            }
        ...
        public void SetSocketOption3_AddMembershipIPv4_IPv6MulticastOption()
        {
            ...
            )
            {
                ...
                catch (ArgumentException ex)
                {
                    ...
                    Assert.IsTrue(
                        ex.Message.IndexOf("'MulticastOption'") != -1,
                        "#5:" + ex.Message
                    );
        ...
        public void SetSocketOption3_AddMembershipIPv6_MulticastOption()
        {
            ...
            )
            {
                ...
                catch (ArgumentException ex)
                {
                    ...
                    Assert.IsTrue(
                        ex.Message.IndexOf("'IPv6MulticastOption'") != -1,
                        "#5:" + ex.Message
                    );
                    Assert.AreEqual("optionValue", ex.ParamName, "#6");
                }
        ...
        public void SetSocketOption3_Linger_Int32()
        {
            ...
            )
            {
                try
                {
                    s.SetSocketOption(SocketOptionLevel.Socket, SocketOptionName.Linger, (object)0);
                    Assert.Fail("#1");
                }
                catch (ArgumentException ex)
                {
        ...
        public void SetSocketOption3_DropMembershipIPv4_MulticastOption()
        {
            ...
            )
            {
                ...
                s.SetSocketOption(SocketOptionLevel.IP, SocketOptionName.DropMembership, option);
            }
        }
        ...
        public void SetSocketOption3_DropMembershipIPv6_IPv6MulticastOption()
        {
            ...
            {
                IPv6MulticastOption option = new IPv6MulticastOption(IPAddress.Parse("ff02::1"));

                s.Bind(new IPEndPoint(IPAddress.IPv6Any, 0));
                s.SetSocketOption(SocketOptionLevel.IPv6, SocketOptionName.AddMembership, option);
                s.SetSocketOption(SocketOptionLevel.IPv6, SocketOptionName.DropMembership, option);
            }
        }
