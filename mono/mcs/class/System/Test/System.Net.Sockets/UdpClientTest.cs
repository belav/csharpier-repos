    ...
    public class UdpClientTest
    {
        ...
        public void Constructor3()
        {
            ...
            using (MyUdpClient client = new MyUdpClient(IPEndPoint.MinPort))
            {
                ...
                Assert.AreEqual(
                    ...
                    "#A:Client:LocalEndPoint/AddressFamily"
                );
            }
            using (MyUdpClient client = new MyUdpClient(IPEndPoint.MaxPort))
            {
                ...
                Assert.AreEqual(
                    AddressFamily.InterNetwork,
                    localEP.AddressFamily,
                    "#B:Client:LocalEndPoint/AddressFamily"
                );
        ...
        public void Constructor4()
        {
            ...
            using (MyUdpClient client = new MyUdpClient(clientEP))
            {
                ...
                Assert.IsNotNull(localEP, "#A:Client:LocalEndpoint");
                Assert.IsFalse(
                    object.ReferenceEquals(clientEP, localEP),
                    "#A:Client:LocalEndPoint/ReferenceEquality"
                );
                Assert.AreEqual(
                    clientEP.Address,
                    localEP.Address,
                    "#A:Client:LocalEndPoint/Address"
                );
                Assert.AreEqual(
                    clientEP.AddressFamily,
                    localEP.AddressFamily,
                    "#A:Client:LocalEndPoint/AddressFamily"
                );
        ...
        public void Constructor5()
        {
            ...
            using (
                MyUdpClient client = new MyUdpClient(IPEndPoint.MinPort, AddressFamily.InterNetwork)
            )
            {
                s = client.Client;
                Assert.IsNotNull(s, "#A:Client");
            ...
            )
            {
                ...
                Assert.AreEqual(
                    IPAddress.IPv6Any,
                    localEP.Address,
                    "#B:Client:LocalEndPoint/Address"
                );
                Assert.AreEqual(
                    AddressFamily.InterNetworkV6,
                    localEP.AddressFamily,
        ...
        public void UdpClientBroadcastTest()
        {
            ...
            try
            {
                client.Send(
                    bytes,
                    bytes.Length,
                    new IPEndPoint(IPAddress.Broadcast, NetworkHelpers.FindFreePort())
                );
            }
            finally
            {
        ...
        public void BeginSend()
        {
            ...
            {
                Assert.AreEqual(10057, ex.ErrorCode, "BeginSend #2");
            }
            ...
            {
                Assert.AreEqual(10057, ex.ErrorCode, "BeginSend #4");
            }
            ...
            client.BeginSend(bytes, bytes.Length, ep, new AsyncCallback(BSCallback), client);
