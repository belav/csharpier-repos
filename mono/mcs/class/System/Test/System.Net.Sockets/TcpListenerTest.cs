...
namespace MonoTests.System.Net.Sockets
{
    ...
    public class TcpListenerTest
    {
        ...
        public void TcpListener()
        {
            ...
            foreach (IPAddress address in hostent.AddressList)
            {
                if (address.AddressFamily == AddressFamily.InterNetwork)
                {
                    ...
                    outSock = new Socket(address.AddressFamily, SocketType.Stream, ProtocolType.IP);
        ...
        {
            var listenerSocket = NetworkHelpers.CreateAndStartTcpListener(
                IPAddress.Any,
                out int port
            );
            listenerSocket.BeginAcceptTcpClient(
                new AsyncCallback(l =>
                {
