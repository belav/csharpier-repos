...
namespace MonoTests.System.CodeDom
{
    ...
    public class CodeTypeReferenceTest
    {
        ...
        {
            CodeTypeReference reference = new CodeTypeReference(new CodeTypeParameter("A"));
            Assert.AreEqual("A", reference.BaseType, "#1");
            Assert.AreEqual(0, reference.ArrayRank, "#2");
            Assert.IsNull(reference.ArrayElementType, "#3");
        ...
        {
            CodeTypeReference reference = new CodeTypeReference(new CodeTypeParameter("A[B]"));
            Assert.AreEqual("A", reference.BaseType, "#1");
            Assert.AreEqual(0, reference.ArrayRank, "#2");
            Assert.IsNull(reference.ArrayElementType, "#3");
            Assert.AreEqual(CodeTypeReferenceOptions.GenericTypeParameter, reference.Options, "#4");
        ...
        {
            CodeTypeReference reference = new CodeTypeReference(new CodeTypeParameter("A[B, C]"));
            Assert.AreEqual("A", reference.BaseType, "#1");
            Assert.AreEqual(0, reference.ArrayRank, "#2");
            Assert.IsNull(reference.ArrayElementType, "#3");
            Assert.AreEqual(CodeTypeReferenceOptions.GenericTypeParameter, reference.Options, "#4");
        ...
        {
            CodeTypeReference reference = new CodeTypeReference(typeof(Dictionary<int, string>));
        ...
        {
            CodeTypeReference reference = new CodeTypeReference(
                "System.Collections.List<System.Globalization.CultureInfo[]>"
            );
            Assert.AreEqual(
                "System.Collections.List<System.Globalization.CultureInfo[]>",
                reference.BaseType,
