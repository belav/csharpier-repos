...
namespace Mono.Audio
{
    ...
    class AlsaDevice : AudioDevice, IDisposable
    {
        ...
        [DllImport("libasound")]
        static extern int snd_pcm_hw_params_set_rate_near(
            IntPtr handle,
            IntPtr param,
            ref uint rate,
            ref int dir
        ...
        [DllImport("libasound")]
        static extern int snd_pcm_hw_params_set_period_time_near(
            IntPtr handle,
            IntPtr param,
            ref uint period,
            ref int dir
        ...
        [DllImport("libasound")]
        static extern int snd_pcm_hw_params_get_period_size(
            IntPtr param,
            ref uint period,
            ref int dir
        );
        ...
        [DllImport("libasound")]
        static extern int snd_pcm_hw_params_set_buffer_size_near(
            IntPtr handle,
            IntPtr param,
            ref uint buff_size
        );
        ...
        [DllImport("libasound")]
        static extern int snd_pcm_hw_params_get_buffer_time_max(
            IntPtr param,
            ref uint buffer_time,
            ref int dir
        );

        [DllImport("libasound")]
        static extern int snd_pcm_hw_params_set_buffer_time_near(
            IntPtr handle,
            IntPtr param,
            ref uint BufferTime,
            ref int dir
        ...
        [DllImport("libasound")]
        static extern int snd_pcm_sw_params_set_start_threshold(
            IntPtr handle,
            IntPtr param,
            uint StartThreshold
        );
