...
namespace System.IO.Ports
{
    ...
    public class SerialPort : Component
    {
        ...
        {
            SerialErrorReceivedEventHandler handler = (SerialErrorReceivedEventHandler)
                Events[error_received];
        ...
        {
            SerialDataReceivedEventHandler handler = (SerialDataReceivedEventHandler)
        ...
        {
            SerialPinChangedEventHandler handler = (SerialPinChangedEventHandler)
                Events[pin_changed];
