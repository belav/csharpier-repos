...
namespace MonoTests.Microsoft.Build.Construction
{
    ...
    {
        const string empty_project_xml =
        ...
        public void CreateAndPaths()
        {
            ...
            var xml = XmlReader.Create(
                new StringReader(empty_project_xml),
                null,
                "file:///foo.xml"
            );
        ...
        {
            string project_xml_1 =
                "<Project xmlns='http://schemas.microsoft.com/developer/msbuild/2003'><ItemGroup><None Include='bar.txt' /></ItemGroup></Project>";
            var xml = XmlReader.Create(
                new StringReader(project_xml_1),
                null,
        ...
        {
            string project_xml_1 =
                "<Project xmlns='http://schemas.microsoft.com/developer/msbuild/2003'><Unknown /></Project>";
            var xml = XmlReader.Create(
                new StringReader(project_xml_1),
                null,
                "file://localhost/foo.xml"
        ...
        {
            string project_xml_1 =
                "<Project xmlns='http://schemas.microsoft.com/developer/msbuild/2003'><ItemGroup><UnregisteredItem Include='bar.txt' /></ItemGroup></Project>";
            var xml = XmlReader.Create(
                new StringReader(project_xml_1),
                null,
                "file://localhost/foo.xml"
