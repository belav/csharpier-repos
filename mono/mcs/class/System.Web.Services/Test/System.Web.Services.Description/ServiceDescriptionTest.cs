...
namespace MonoTests.System.Web.Services.Description
{
    ...
    public class ServiceDescriptionTest
    {
        ...
        public void Namespaces()
        {
            ...
            Assert.AreEqual(
                new XmlQualifiedName("http", "http://schemas.xmlsoap.org/wsdl/http/"),
                list[1]
            );
            Assert.AreEqual(
                new XmlQualifiedName("mime", "http://schemas.xmlsoap.org/wsdl/mime/"),
                list[2]
            );
            ...
            Assert.AreEqual(
                new XmlQualifiedName("soap", "http://schemas.xmlsoap.org/wsdl/soap/"),
                list[5]
            );
            Assert.AreEqual(
                new XmlQualifiedName("soapenc", "http://schemas.xmlsoap.org/soap/encoding/"),
                list[6]
            );
            Assert.AreEqual(
                new XmlQualifiedName("tm", "http://microsoft.com/wsdl/mime/textMatching/"),
                list[7]
            );
        }
        ...
        public void Extensions()
        {
            ...
            Assert.AreEqual(
                ...
                sd.Bindings[0].Operations[0].Extensions[0].GetType()
            );
            ...
            Assert.AreEqual(
                ...
                sd.Services[0].Ports[0].Extensions[0].GetType()
            );
        ...
        public void ReadInvalid()
        {
            ServiceDescription sd = ServiceDescription.Read(
                XmlReader.Create(
                    new StringReader(
                        "<definitions xmlns='http://schemas.xmlsoap.org/wsdl/'><hoge/></definitions>"
                    )
                )
            );
        }
