...
namespace External.HPcatalogTests
{
    ...
    public class HPcatalogTest : WebServiceTest
    {
        ...
        public void TestService()
        {
            ...
            Assert.AreEqual(
                "Power cord (Flint Gray) - 18 AWG, 1.8m (6.0ft) long - Has straight (F) receptacle (For 120V in the USA and Canada)",
                list[0][1]
            );
            ...
            Assert.AreEqual(
                "Heat sink support base / retention base - For Pentium II (Klamath) processor",
                list[1][1]
            );
        }
    }
