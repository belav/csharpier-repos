...
namespace System.Web.Services.Protocols
{
    internal class Soap12FaultReader : XmlSerializationReader
    {
        public object ReadRoot_Soap12Fault()
        {
            ...
            if (
                ...
                || Reader.NamespaceURI != "http://www.w3.org/2003/05/soap-envelope"
            )
                throw CreateUnknownNodeException();
            return ReadObject_Fault(true, true);
        }

        public System.Web.Services.Protocols.Soap12Fault ReadObject_Fault(
            bool isNullable,
            bool checkType
        )
        {
        ...
        public System.Web.Services.Protocols.Soap12FaultDetail ReadObject_Detail(
            bool isNullable,
            bool checkType
        )
        {
            ...
            while (Reader.NodeType != System.Xml.XmlNodeType.EndElement)
            {
                if (Reader.NodeType == System.Xml.XmlNodeType.Element)
                {
                    o8 = (System.Xml.XmlElement[])EnsureArrayIndex(
                        o8,
                        n7,
        ...
        public System.Web.Services.Protocols.Soap12FaultCode ReadObject_Code(
            bool isNullable,
            bool checkType
        )
        {
        ...
        public System.Web.Services.Protocols.Soap12FaultReason ReadObject_Reason(
            bool isNullable,
            bool checkType
        )
        {
            ...
            while (Reader.NodeType != System.Xml.XmlNodeType.EndElement)
            {
                if (Reader.NodeType == System.Xml.XmlNodeType.Element)
                {
                    ...
                    {
                        o13 =
                            (System.Web.Services.Protocols.Soap12FaultReasonText[])EnsureArrayIndex(
                                o13,
                                n12,
                                typeof(System.Web.Services.Protocols.Soap12FaultReasonText)
                            );
            ...
            o13 = (System.Web.Services.Protocols.Soap12FaultReasonText[])ShrinkArray(
                o13,
                n12,
                typeof(System.Web.Services.Protocols.Soap12FaultReasonText),
                true
        ...
        public System.Web.Services.Protocols.Soap12FaultReasonText ReadObject_Text(
            bool isNullable,
            bool checkType
        )
        {
            ...
            while (Reader.MoveToNextAttribute())
            {
                if (
                    ...
                    && Reader.NamespaceURI == "http://www.w3.org/XML/1998/namespace"
                )
                {
    ...
    internal class Soap12FaultWriter : XmlSerializationWriter
    {
        ...
        {
            WriteStartDocument();
            System.Web.Services.Protocols.Soap12Fault ob =
                (System.Web.Services.Protocols.Soap12Fault)o;
            TopLevelElement();
            WriteObject_Fault(
                ob,
                "Fault",
        ...
        )
        {
            ...
            WriteElementString(
                "Node",
                "http://www.w3.org/2003/05/soap-envelope",
                ((ob.@Node != null) ? (ob.@Node).ToString() : null)
            );
            WriteElementString(
                "Role",
                "http://www.w3.org/2003/05/soap-envelope",
                ((ob.@Role != null) ? (ob.@Role).ToString() : null)
            );
            WriteObject_Detail(
                ob.@Detail,
                "Detail",
        ...
        void WriteObject_Code(
            System.Web.Services.Protocols.Soap12FaultCode ob,
            string element,
            string namesp,
            bool isNullable,
            bool needType,
        ...
        void WriteObject_Reason(
            System.Web.Services.Protocols.Soap12FaultReason ob,
            string element,
            string namesp,
            bool isNullable,
            bool needType,
        ...
        void WriteObject_Detail(
            System.Web.Services.Protocols.Soap12FaultDetail ob,
            string element,
            string namesp,
            bool isNullable,
            bool needType,
        ...
        void WriteObject_Text(
            System.Web.Services.Protocols.Soap12FaultReasonText ob,
            string element,
            string namesp,
            bool isNullable,
            bool needType,
    ...
    internal class Soap12FaultSerializerImplementation
