...
namespace System.Json
{
    ...
    {
        /// <summary>
        /// Extension method for creating a <see cref="JsonValue"/> from an <see cref="IEnumerable{T}"/>
        // collection of <see cref="JsonValue"/> types.
        /// </summary>
        ...
        /// <summary>
        /// Extension method for creating a <see cref="JsonValue"/> from an <see cref="IEnumerable{T}"/>
        // collection of <see cref="KeyValuePair{K,V}"/> of <see cref="String"/> and <see cref="JsonValue"/>
        // types.
        /// </summary>
        /// <param name="items">The enumerable instance.</param>
