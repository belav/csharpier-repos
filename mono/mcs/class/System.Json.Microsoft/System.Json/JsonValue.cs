...
{
    /// <summary>
    /// This is the base class for JavaScript Object Notation (JSON) common language runtime (CLR)
    // types.
    /// </summary>
    [SuppressMessage(
        "Microsoft.Naming",
...
#endif
    {
        ...
        /// </summary>
        /// <remarks><p>Events are raised when elements are added or removed to <see
        // cref="System.Json.JsonValue"/>
        /// instances. It applies to both complex descendants of <see cref="System.Json.JsonValue"/>: <see
        // cref="System.Json.JsonArray"/>
        /// and <see cref="System.Json.JsonObject"/>.</p>
        /// <p>You should be careful when modifying a <see cref="System.Json.JsonValue"/> tree within one of
        // these events,
        /// because doing this might lead to unexpected results. For example, if you receive a Changing
        // event, and while
        /// the event is being processed you remove the node from the tree, you might not receive the
        // Changed event. When
        /// an event is being processed, it is valid to modify a tree other than the one that contains the
        // node that is
        /// receiving the event; it is even valid to modify the same tree provided the modifications do not
        // affect the
        /// specific nodes on which the event was raised. However, if you modify the area of the tree that
        // contains the
        /// node receiving the event, the events that you receive and the impact to the tree are
        // undefined.</p></remarks>
        ...
        /// <summary>
        /// Raised when this <see cref="System.Json.JsonValue"/> or any of its members are about to be
        // changed.
        /// </summary>
        /// <remarks><p>Events are raised when elements are added or removed to <see
        // cref="System.Json.JsonValue"/>
        ...
        /// </summary>
        /// <param name="textReader">A <see cref="System.IO.TextReader"/> over text-based JSON
        // content.</param>
        /// <returns>The <see cref="System.Json.JsonValue"/> object that represents the parsed
        /// text-based JSON as a CLR type.</returns>
        ...
        /// </summary>
        /// <param name="stream">A <see cref="System.IO.Stream"/> that contains text-based JSON
        // content.</param>
        /// <returns>The <see cref="System.Json.JsonValue"/> object that represents the parsed
        /// text-based JSON as a CLR type.</returns>
        ...
        /// <summary>
        /// Performs a cast operation from a <see cref="JsonValue"/> instance into the specified type
        // parameter./>
        /// </summary>
        ...
        /// <returns>An object of type T initialized with the <see cref="System.Json.JsonValue"/> value
        // specified.</returns>
        /// <remarks>This method is to support the framework and is not intended to be used externally, use
        // explicit type cast instead.</remarks>
        ...
        /// <remarks>The enumerator returned by this class is empty; subclasses will override this method to
        // return appropriate enumerators for themselves.</remarks>
        ...
        /// Returns an enumerator which iterates through the values in this object.
        /// </summary>
        /// <returns>An <see cref="System.Collections.IEnumerator"/> which iterates through the values in
        // this object.</returns>
        /// <remarks>The enumerator returned by this class is empty; subclasses will override this method to
        // return appropriate enumerators for themselves.</remarks>
        ...
        /// <param name="valueOfT">An instance of T initialized with this instance, or the default value of
        // T if the conversion cannot be performed.</param>
        /// <returns>true if this <see cref="System.Json.JsonValue"/> instance can be read as type T;
        ...
        /// </summary>
        /// <typeparam name="T">The type to which the conversion is being performed.</typeparam>
        /// <returns>An instance of T initialized with the value from the conversion of this
        // instance.</returns>
        /// <exception cref="System.NotSupportedException">If this <see cref="System.Json.JsonValue"/> value
        // cannot be converted into the type T.</exception>
        [SuppressMessage(
            "Microsoft.Design",
            "CA1004:GenericMethodsShouldProvideTypeParameter",
            Justification = "The generic parameter is used to specify the output type"
        ...
        /// </summary>
        /// <typeparam name="T">The type to which the conversion is being performed.</typeparam>
        /// <param name="fallback">The fallback value to be returned if the conversion cannot be
        // made.</param>
        /// <returns>An instance of T initialized with the value from the conversion of this instance, or
        // the specified fallback value if the conversion cannot be made.</returns>
        ...
        /// <summary>
        /// Attempts to convert this <see cref="System.Json.JsonValue"/> instance to an instance of the
        // specified type.
        /// </summary>
        /// <param name="type">The type to which the conversion is being performed.</param>
        /// <param name="fallback">The fallback value to be returned if the conversion cannot be
        // made.</param>
        /// <returns>An instance of the specified type initialized with the value from the conversion of
        // this instance, or the specified fallback value if the conversion cannot be made.</returns>
        ...
        /// <summary>
        /// Attempts to convert this <see cref="System.Json.JsonValue"/> instance into an instance of the
        // specified type.
        /// </summary>
        /// <param name="type">The type to which the conversion is being performed.</param>
        /// <returns>An instance of the specified type initialized with the value from the conversion of
        ...
        /// <returns>true if this <see cref="System.Json.JsonValue"/> instance can be read as the specified
        ...
        /// </summary>
        /// <param name="textWriter">The <see cref="System.IO.TextWriter"/> used to write text-based
        // JSON.</param>
        ...
        /// <returns>false in this class; subclasses may override this method to return other
        // values.</returns>
        /// <remarks>This method is overloaded in the implementation of the <see
        // cref="System.Json.JsonObject"/>
        /// class, which inherits from this class.</remarks>
        ...
        /// the given key and the value corresponding to the key is not null, then it will return that
        // value.
        /// Otherwise it will return a <see cref="System.Json.JsonValue"/> instance with <see
        // cref="System.Json.JsonValue.JsonType"/>
        ...
        /// <returns>If this is an instance of <see cref="System.Json.JsonArray"/>, the index is within the
        // array
        ...
        /// <exception cref="System.ArgumentException">If the value cannot be converted into a
        // JsonValue.</exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        ...
        /// <returns>A <see cref="JsonValue"/> which is equivalent to calling<see
        // cref="ValueOrDefault(int)"/> or
        ...
        /// </summary>
        /// <param name="jsonWriter">An <see cref="XmlDictionaryWriter"/> instance to serialize this
        // instance into.</param>
        ...
        /// <returns>An <see cref="System.Collections.IEnumerator"/> which iterates through the values in
        // this object.</returns>
        /// <remarks>This method is the virtual version of the IEnumerator.GetEnumerator method and is
        // provided to allow derived classes to implement the
        /// appropriate version of the generic interface (enumerator of values or key/value
        // pairs).</remarks>
        [SuppressMessage(
            "Microsoft.Design",
        ...
        /// <summary>
        /// Enables explicit casts from an instance of type <see cref="System.Json.JsonValue"/> to a <see
        // cref="System.String"/> object.
        /// </summary>
        /// <param name="value">The instance of <see cref="System.Json.JsonValue"/> used to initialize the
        // <see cref="System.String"/> object.</param>
        /// <returns>The <see cref="System.String"/> initialized with the <see
        // cref="System.Json.JsonValue"/> value specified or null if value is null.</returns>
        ...
        /// <summary>
        /// Enables explicit casts from an instance of type <see cref="System.Json.JsonValue"/> to a <see
        // cref="System.Double"/> object.
        /// </summary>
        /// <param name="value">The instance of <see cref="System.Json.JsonValue"/> used to initialize the
        // <see cref="System.Double"/> object.</param>
        /// <returns>The <see cref="System.Double"/> initialized with the <see
        // cref="System.Json.JsonValue"/> value specified.</returns>
        ...
        /// <summary>
        /// Enables explicit casts from an instance of type <see cref="System.Json.JsonValue"/> to a <see
        // cref="System.Single"/> object.
        /// </summary>
        /// <param name="value">The instance of <see cref="System.Json.JsonValue"/> used to initialize the
        // <see cref="System.Single"/> object.</param>
        /// <returns>The <see cref="System.Single"/> initialized with the <see
        // cref="System.Json.JsonValue"/> value specified.</returns>
        ...
        /// <summary>
        /// Enables explicit casts from an instance of type <see cref="System.Json.JsonValue"/> to a <see
        // cref="System.Decimal"/> object.
        /// </summary>
        /// <param name="value">The instance of <see cref="System.Json.JsonValue"/> used to initialize the
        // <see cref="System.Decimal"/> object.</param>
        /// <returns>The <see cref="System.Decimal"/> initialized with the <see
        // cref="System.Json.JsonValue"/> value specified.</returns>
        ...
        /// <summary>
        /// Enables explicit casts from an instance of type <see cref="System.Json.JsonValue"/> to a <see
        // cref="System.Int64"/> object.
        /// </summary>
        /// <param name="value">The instance of <see cref="System.Json.JsonValue"/> used to initialize the
        // <see cref="System.Int64"/> object.</param>
        /// <returns>The <see cref="System.Int64"/> initialized with the <see cref="System.Json.JsonValue"/>
        // value specified.</returns>
        ...
        /// <summary>
        /// Enables explicit casts from an instance of type <see cref="System.Json.JsonValue"/> to a <see
        // cref="System.UInt64"/> object.
        /// </summary>
        /// <param name="value">The instance of <see cref="System.Json.JsonValue"/> used to initialize the
        // <see cref="System.UInt64"/> object.</param>
        /// <returns>The <see cref="System.UInt64"/> initialized with the <see
        // cref="System.Json.JsonValue"/> value specified.</returns>
        [CLSCompliant(false)]
        ...
        /// <summary>
        /// Enables explicit casts from an instance of type <see cref="System.Json.JsonValue"/> to a <see
        // cref="System.Int32"/> object.
        /// </summary>
        /// <param name="value">The instance of <see cref="System.Json.JsonValue"/> used to initialize the
        // <see cref="System.Int32"/> object.</param>
        /// <returns>The <see cref="System.Int32"/> initialized with the <see cref="System.Json.JsonValue"/>
        // value specified.</returns>
        ...
        /// <summary>
        /// Enables explicit casts from an instance of type <see cref="System.Json.JsonValue"/> to a <see
        // cref="System.UInt32"/> object.
        /// </summary>
        /// <param name="value">The instance of <see cref="System.Json.JsonValue"/> used to initialize the
        // <see cref="System.UInt32"/> object.</param>
        /// <returns>The <see cref="System.UInt32"/> initialized with the <see
        // cref="System.Json.JsonValue"/> value specified.</returns>
        [CLSCompliant(false)]
        ...
        /// <summary>
        /// Enables explicit casts from an instance of type <see cref="System.Json.JsonValue"/> to a <see
        // cref="System.Int16"/> object.
        /// </summary>
        /// <param name="value">The instance of <see cref="System.Json.JsonValue"/> used to initialize the
        // <see cref="System.Int16"/> object.</param>
        /// <returns>The <see cref="System.Int16"/> initialized with the <see cref="System.Json.JsonValue"/>
        // value specified.</returns>
        ...
        /// <summary>
        /// Enables explicit casts from an instance of type <see cref="System.Json.JsonValue"/> to a <see
        // cref="System.UInt16"/> object.
        /// </summary>
        /// <param name="value">The instance of <see cref="System.Json.JsonValue"/> used to initialize the
        // <see cref="System.UInt16"/> object.</param>
        /// <returns>The <see cref="System.UInt16"/> initialized with the <see
        // cref="System.Json.JsonValue"/> value specified.</returns>
        [CLSCompliant(false)]
        ...
        /// <summary>
        /// Enables explicit casts from an instance of type <see cref="System.Json.JsonValue"/> to a <see
        // cref="System.SByte"/> object.
        /// </summary>
        /// <param name="value">The instance of <see cref="System.Json.JsonValue"/> used to initialize the
        // <see cref="System.SByte"/> object.</param>
        /// <returns>The <see cref="System.SByte"/> initialized with the <see cref="System.Json.JsonValue"/>
        // value specified.</returns>
        [CLSCompliant(false)]
        ...
        /// <summary>
        /// Enables explicit casts from an instance of type <see cref="System.Json.JsonValue"/> to a <see
        // cref="System.Byte"/> object.
        /// </summary>
        /// <param name="value">The instance of <see cref="System.Json.JsonValue"/> used to initialize the
        // <see cref="System.Byte"/> object.</param>
        /// <returns>The <see cref="System.Byte"/> initialized with the <see cref="System.Json.JsonValue"/>
        // value specified.</returns>
        ...
        /// <summary>
        /// Enables explicit casts from an instance of type <see cref="System.Json.JsonValue"/> to a <see
        // cref="System.Uri"/> object.
        /// </summary>
        /// <param name="value">The instance of <see cref="System.Json.JsonValue"/> used to initialize the
        // <see cref="System.Uri"/> object.</param>
        /// <returns>The <see cref="System.Uri"/> initialized with the <see cref="System.Json.JsonValue"/>
        // value specified or null if value is null.</returns>
        ...
        /// <summary>
        /// Enables explicit casts from an instance of type <see cref="System.Json.JsonValue"/> to a <see
        // cref="System.Guid"/> object.
        /// </summary>
        /// <param name="value">The instance of <see cref="System.Json.JsonValue"/> used to initialize the
        // <see cref="System.Guid"/> object.</param>
        /// <returns>The <see cref="System.Guid"/> initialized with the <see cref="System.Json.JsonValue"/>
        // value specified.</returns>
        ...
        /// <summary>
        /// Enables explicit casts from an instance of type <see cref="System.Json.JsonValue"/> to a <see
        // cref="System.DateTime"/> object.
        /// </summary>
        /// <param name="value">The instance of <see cref="System.Json.JsonValue"/> used to initialize the
        // <see cref="System.DateTime"/> object.</param>
        /// <returns>The <see cref="System.DateTime"/> initialized with the <see
        // cref="System.Json.JsonValue"/> value specified.</returns>
        ...
        /// <summary>
        /// Enables explicit casts from an instance of type <see cref="System.Json.JsonValue"/> to a <see
        // cref="System.Char"/> object.
        /// </summary>
        /// <param name="value">The instance of <see cref="System.Json.JsonValue"/> used to initialize the
        // <see cref="System.Char"/> object.</param>
        /// <returns>The <see cref="System.Char"/> initialized with the <see cref="System.Json.JsonValue"/>
        // value specified.</returns>
        ...
        /// <summary>
        /// Enables explicit casts from an instance of type <see cref="System.Json.JsonValue"/> to a <see
        // cref="System.Boolean"/> object.
        /// </summary>
        /// <param name="value">The instance of <see cref="System.Json.JsonValue"/> used to initialize the
        // <see cref="System.Boolean"/> object.</param>
        /// <returns>The <see cref="System.Boolean"/> initialized with the <see
        // cref="System.Json.JsonValue"/> value specified.</returns>
        ...
        /// <summary>
        /// Enables explicit casts from an instance of type <see cref="System.Json.JsonValue"/> to a <see
        // cref="System.DateTimeOffset"/> object.
        /// </summary>
        /// <param name="value">The instance of <see cref="System.Json.JsonValue"/> used to initialize the
        // <see cref="System.DateTimeOffset"/> object.</param>
        /// <returns>The <see cref="System.DateTimeOffset"/> initialized with the <see
        // cref="System.Json.JsonValue"/> value specified.</returns>
        ...
        /// <summary>
        /// Enables implicit casts from type <see cref="System.Boolean"/> to a <see
        // cref="System.Json.JsonPrimitive"/>.
        /// </summary>
        /// <param name="value">The <see cref="System.Boolean"/> instance used to initialize the <see
        // cref="System.Json.JsonPrimitive"/>.</param>
        /// <returns>The <see cref="System.Json.JsonValue"/> initialized with the <see
        // cref="System.Boolean"/> specified.</returns>
        ...
        /// <summary>
        /// Enables implicit casts from type <see cref="System.Byte"/> to a <see
        // cref="System.Json.JsonPrimitive"/>.
        /// </summary>
        /// <param name="value">The <see cref="System.Byte"/> instance used to initialize the <see
        // cref="System.Json.JsonPrimitive"/>.</param>
        /// <returns>The <see cref="System.Json.JsonValue"/> initialized with the <see cref="System.Byte"/>
        // specified.</returns>
        ...
        /// <summary>
        /// Enables implicit casts from type <see cref="System.Decimal"/> to a <see
        // cref="System.Json.JsonPrimitive"/>.
        /// </summary>
        /// <param name="value">The <see cref="System.Decimal"/> instance used to initialize the <see
        // cref="System.Json.JsonPrimitive"/>.</param>
        /// <returns>The <see cref="System.Json.JsonValue"/> initialized with the <see
        // cref="System.Decimal"/> specified.</returns>
        ...
        /// <summary>
        /// Enables implicit casts from type <see cref="System.Double"/> to a <see
        // cref="System.Json.JsonPrimitive"/>.
        /// </summary>
        /// <param name="value">The <see cref="System.Double"/> instance used to initialize the <see
        // cref="System.Json.JsonPrimitive"/>.</param>
        /// <returns>The <see cref="System.Json.JsonValue"/> initialized with the <see
        // cref="System.Double"/> specified.</returns>
        ...
        /// <summary>
        /// Enables implicit casts from type <see cref="System.Int16"/> to a <see
        // cref="System.Json.JsonPrimitive"/>.
        /// </summary>
        /// <param name="value">The <see cref="System.Int16"/> instance used to initialize the <see
        // cref="System.Json.JsonPrimitive"/>.</param>
        /// <returns>The <see cref="System.Json.JsonValue"/> initialized with the <see cref="System.Int16"/>
        // specified.</returns>
        ...
        /// <summary>
        /// Enables implicit casts from type <see cref="System.Int32"/> to a <see
        // cref="System.Json.JsonPrimitive"/>.
        /// </summary>
        /// <param name="value">The <see cref="System.Int32"/> instance used to initialize the <see
        // cref="System.Json.JsonPrimitive"/>.</param>
        /// <returns>The <see cref="System.Json.JsonValue"/> initialized with the <see cref="System.Int32"/>
        // specified.</returns>
        ...
        /// <summary>
        /// Enables implicit casts from type <see cref="System.Int64"/> to a <see
        // cref="System.Json.JsonPrimitive"/>.
        /// </summary>
        /// <param name="value">The <see cref="System.Int64"/> instance used to initialize the <see
        // cref="System.Json.JsonPrimitive"/>.</param>
        /// <returns>The <see cref="System.Json.JsonValue"/> initialized with the <see cref="System.Int64"/>
        // specified.</returns>
        ...
        /// <summary>
        /// Enables implicit casts from type <see cref="System.Single"/> to a <see
        // cref="System.Json.JsonPrimitive"/>.
        /// </summary>
        /// <param name="value">The <see cref="System.Single"/> instance used to initialize the <see
        // cref="System.Json.JsonPrimitive"/>.</param>
        /// <returns>The <see cref="System.Json.JsonValue"/> initialized with the <see
        // cref="System.Single"/> specified.</returns>
        ...
        /// <summary>
        /// Enables implicit casts from type <see cref="System.String"/> to a <see
        // cref="System.Json.JsonPrimitive"/>.
        /// </summary>
        /// <param name="value">The <see cref="System.String"/> instance used to initialize the <see
        // cref="System.Json.JsonPrimitive"/>.</param>
        /// <returns>The <see cref="System.Json.JsonValue"/> initialized with the <see
        // cref="System.String"/> specified, or null if the value is null.</returns>
        [SuppressMessage(
            "Microsoft.Design",
        ...
        /// <summary>
        /// Enables implicit casts from type <see cref="System.Char"/> to a <see
        // cref="System.Json.JsonPrimitive"/>.
        /// </summary>
        /// <param name="value">The <see cref="System.Char"/> instance used to initialize the <see
        // cref="System.Json.JsonPrimitive"/>.</param>
        /// <returns>The <see cref="System.Json.JsonValue"/> initialized with the <see cref="System.Char"/>
        // specified.</returns>
        ...
        /// <summary>
        /// Enables implicit casts from type <see cref="System.DateTime"/> to a <see
        // cref="System.Json.JsonPrimitive"/>.
        /// </summary>
        /// <param name="value">The <see cref="System.DateTime"/> instance used to initialize the <see
        // cref="System.Json.JsonPrimitive"/>.</param>
        /// <returns>The <see cref="System.Json.JsonValue"/> initialized with the <see
        // cref="System.DateTime"/> specified.</returns>
        ...
        /// <summary>
        /// Enables implicit casts from type <see cref="System.Guid"/> to a <see
        // cref="System.Json.JsonPrimitive"/>.
        /// </summary>
        /// <param name="value">The <see cref="System.Guid"/> instance used to initialize the <see
        // cref="System.Json.JsonPrimitive"/>.</param>
        /// <returns>The <see cref="System.Json.JsonValue"/> initialized with the <see cref="System.Guid"/>
        // specified.</returns>
        ...
        /// <summary>
        /// Enables implicit casts from type <see cref="System.Uri"/> to a <see
        // cref="System.Json.JsonPrimitive"/>.
        /// </summary>
        /// <param name="value">The <see cref="System.Uri"/> instance used to initialize the <see
        // cref="System.Json.JsonPrimitive"/>.</param>
        /// <returns>The <see cref="System.Json.JsonValue"/> initialized with the <see cref="System.Uri"/>
        // specified, or null if the value is null.</returns>
        ...
        /// <summary>
        /// Enables implicit casts from type <see cref="System.SByte"/> to a <see
        // cref="System.Json.JsonPrimitive"/>.
        /// </summary>
        /// <param name="value">The <see cref="System.SByte"/> instance used to initialize the <see
        // cref="System.Json.JsonPrimitive"/>.</param>
        /// <returns>The <see cref="System.Json.JsonValue"/> initialized with the <see cref="System.SByte"/>
        // specified.</returns>
        [CLSCompliant(false)]
        ...
        /// <summary>
        /// Enables implicit casts from type <see cref="System.UInt16"/> to a <see
        // cref="System.Json.JsonPrimitive"/>.
        /// </summary>
        /// <param name="value">The <see cref="System.UInt16"/> instance used to initialize the <see
        // cref="System.Json.JsonPrimitive"/>.</param>
        /// <returns>The <see cref="System.Json.JsonValue"/> initialized with the <see
        // cref="System.UInt16"/> specified.</returns>
        [CLSCompliant(false)]
        ...
        /// <summary>
        /// Enables implicit casts from type <see cref="System.UInt32"/> to a <see
        // cref="System.Json.JsonPrimitive"/>.
        /// </summary>
        /// <param name="value">The <see cref="System.UInt32"/> instance used to initialize the <see
        // cref="System.Json.JsonPrimitive"/>.</param>
        /// <returns>The <see cref="System.Json.JsonValue"/> initialized with the <see
        // cref="System.UInt32"/> specified.</returns>
        [CLSCompliant(false)]
        ...
        /// <summary>
        /// Enables implicit casts from type <see cref="System.UInt64"/> to a <see
        // cref="System.Json.JsonPrimitive"/>.
        /// </summary>
        /// <param name="value">The <see cref="System.UInt64"/> instance used to initialize the <see
        // cref="System.Json.JsonPrimitive"/>.</param>
        /// <returns>The <see cref="System.Json.JsonValue"/> initialized with the <see
        // cref="System.UInt64"/> specified.</returns>
        [CLSCompliant(false)]
        ...
        /// <summary>
        /// Enables implicit casts from type <see cref="System.DateTimeOffset"/> to a <see
        // cref="System.Json.JsonPrimitive"/>.
        /// </summary>
        /// <param name="value">The <see cref="System.DateTimeOffset"/> instance used to initialize the <see
        // cref="System.Json.JsonPrimitive"/>.</param>
        /// <returns>The <see cref="System.Json.JsonValue"/> initialized with the <see
        // cref="System.DateTimeOffset"/> specified.</returns>
