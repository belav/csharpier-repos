...
namespace Mono.Profiling.Tests
{
    static class Program
    {
        ...
        static readonly IReadOnlyDictionary<string, ProfilerTest> _tests = new Dictionary<
            string,
            ProfilerTest
        >
        {
    ...
    sealed class BusyWorkTest : ProfilerTest
    {
        ...
        public override void Run()
        {
            ...
            {
                threads[i] = new Thread(Work) { Name = "BusyWork" + i };
            }
    ...
    sealed class IdleSleepTest : ProfilerTest
    {
        public override void Run()
        {
            ...
            for (var i = 0; i < threads.Length; i++)
            {
                threads[i] = new Thread(Sleep) { Name = "IdleSleep" + i };
            }
    ...
    sealed class MonitorLockTest : ProfilerTest
    {
        ...
        public override void Run()
        {
            var thread = new Thread(TryLock) { Name = "MonitorLock1" };
            ...
            thread = new Thread(Lock) { Name = "MonitorLock2" };
    ...
    sealed class GCHandleTest : ProfilerTest
    {
        ...
        public override void Run()
        {
            ...
            var weakTrack = GCHandle.Alloc(
                new WeakTrackResurrectionClass(),
