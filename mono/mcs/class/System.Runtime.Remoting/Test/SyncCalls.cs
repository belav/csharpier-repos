...
namespace MonoTests.Remoting
{
    ...
    {
        public override InstanceSurrogate GetInstanceSurrogate()
        {
            return new SyncInstanceSurrogate();
        }

        public override AbstractSurrogate GetAbstractSurrogate()
        {
            return new SyncAbstractSurrogate();
        }

        public override InterfaceSurrogate GetInterfaceSurrogate()
        {
            return new SyncInterfaceSurrogate();
        }
    }
    ...
    public class SyncInstanceSurrogate : InstanceSurrogate
    {
        ...
        public override string PrimitiveParamsInOut(
            ref int a1,
            out int a2,
            ref float b1,
            out float b2,
        ...
        {
            return RemoteObject.PrimitiveParamsInOut(
                ref a1,
                out a2,
                ref b1,
                out b2,
        ...
        public override Complex ComplexParamsInOut(
            ref ArrayList a,
            out Complex b,
            [In, Out] byte[] bytes,
