...
namespace MonoTests.Remoting
{
    public abstract class ReflectionCallTest : BaseCallTest
    {
        ...
        {
            return new ReflectionInstanceSurrogate();
        }

        public override AbstractSurrogate GetAbstractSurrogate()
        {
            return new ReflectionAbstractSurrogate();
        }

        public override InterfaceSurrogate GetInterfaceSurrogate()
        {
            return new ReflectionInterfaceSurrogate();
        }
        ...
        public static string PrimitiveParams(
            Type type,
            object target,
            int a,
            uint b,
        ...
        public static string PrimitiveParamsInOut(
            Type type,
            object target,
            ref int a1,
            out int a2,
        ...
        public static Complex ComplexParams(
            Type type,
            object target,
            ArrayList a,
            Complex b,
        ...
        public static Complex ComplexParamsInOut(
            Type type,
            object target,
            ref ArrayList a,
            out Complex b,
    ...
    public class ReflectionInstanceSurrogate : InstanceSurrogate
    {
        ...
        {
            return ReflectionCallTest.PrimitiveParams(
                typeof(RemoteObject),
                RemoteObject,
                a,
                b,
        ...
        {
            return ReflectionCallTest.PrimitiveParamsInOut(
                typeof(RemoteObject),
                RemoteObject,
                ref a1,
                out a2,
        ...
        {
            return ReflectionCallTest.ComplexParamsInOut(
                typeof(RemoteObject),
                RemoteObject,
                ref a,
                out b,
    ...
    public class ReflectionAbstractSurrogate : AbstractSurrogate
    {
        ...
        public override Complex ComplexParams(ArrayList a, Complex b, string c)
        {
            return ReflectionCallTest.ComplexParams(
                typeof(AbstractRemoteObject),
                RemoteObject,
                a,
                b,
