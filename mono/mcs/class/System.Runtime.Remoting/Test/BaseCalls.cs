...
namespace MonoTests.Remoting
{
    public abstract class BaseCallTest
    {
        ...
        {
            return (AbstractRemoteObject)
                Activator.GetObject(typeof(AbstractRemoteObject), remoteUris[1]);
        }
        ...
        {
            Assert.AreEqual(
                "11-22-L-SG@" + remoteDomId,
                testerSurrogate.PrimitiveParams(11, 22, 'L', "SG"),
                "ReturnValue"
            );
        }
        ...
        public void RunTestPrimitiveParamsInOut(IRemoteObject testerSurrogate)
        {
            ...
            string res = testerSurrogate.PrimitiveParamsInOut(
                ref a1,
                out a2,
                ref b1,
                out b2,
    ...
    public abstract class InstanceSurrogate : IRemoteObject
    {
        ...
        public abstract string PrimitiveParamsInOut(
            ref int a1,
            out int a2,
            ref float b1,
            out float b2,
        ...
        public abstract Complex ComplexParamsInOut(
            ref ArrayList a,
            out Complex b,
            [In, Out] byte[] bytes,
            [In, Out] StringBuilder sb,
    ...
    public class RemoteObject : AbstractRemoteObject, IRemoteObject
    {
        ...
        )
        {
            string res =
                ...
                + a1
                + "-"
                + b1.ToString(CultureInfo.InvariantCulture)
                + "-"
                + c1
                + "-"
                + d1
