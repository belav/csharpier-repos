...
namespace MonoTests.Remoting
{
    ...
    public delegate string DelegatePrimitiveParamsInOut(
        ref int a1,
        out int a2,
        ref float b1,
        out float b2,
    ...
    public delegate Complex DelegateComplexParamsInOut(
        ref ArrayList a,
        out Complex b,
        byte[] bytes,
        StringBuilder sb,
    ...
    public class AsyncInstanceSurrogate : InstanceSurrogate
    {
        ...
        {
            DelegatePrimitiveParamsInOut de = new DelegatePrimitiveParamsInOut(
                RemoteObject.PrimitiveParamsInOut
            );
            IAsyncResult ar = de.BeginInvoke(
                ref a1,
                out a2,
                ref b1,
                out b2,
        ...
        {
            DelegateComplexParamsInOut de = new DelegateComplexParamsInOut(
                RemoteObject.ComplexParamsInOut
            );
        ...
        {
            DelegateProcessContextData de = new DelegateProcessContextData(
