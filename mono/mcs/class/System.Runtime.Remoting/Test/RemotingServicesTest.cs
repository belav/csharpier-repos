...
namespace MonoTests.System.Runtime.Remoting.RemotingServicesInternal
{
    ...
    public class MyProxy : RealProxy
    {
            ...
            : base(serverType)
        {
            ...
            foreach (IChannel channel in registeredChannels)
            {
                ...
                {
                    _sink = (IMessageSink)
                        channelSender.CreateMessageSink(
                            RemotingServices.GetObjectUri(target),
                            null,
                            out ObjectURI
                        );
                }
        ...
        public override IMessage Invoke(IMessage msg)
        {
            try
            {
                ...
                {
                    IActivator remActivator = (IActivator)
                        RemotingServices.Connect(
                            typeof(IActivator),
                            "tcp://localhost:1234/RemoteActivationService.rem"
                        );
                    IConstructionReturnMessage crm = remActivator.Activate(
                ...
                else
                {
                    ...
                    MethodCallMessageWrapper mcm = new MethodCallMessageWrapper(
                        (IMethodCallMessage)msg
                    );
                    mcm.Uri = RemotingServices.GetObjectUri((MarshalByRefObject)target);
                    MarshalByRefObject objRem = (MarshalByRefObject)
                        Activator.CreateInstance(GetProxiedType());
                    RemotingServices.ExecuteMessage(
                        (MarshalByRefObject)objRem,
                        (IMethodCallMessage)msg
                    );
    ...
    public class DerivedMarshalObject : MarshalObject
    {
        ...
        public DerivedMarshalObject(int id, string uri)
            : base(id, uri) { }
    }
...
namespace MonoTests.Remoting
{
    ...
    public class RemotingServicesTest
    {
        ...
        {
            string uri =
                "MonoTests.System.Runtime.Remoting.RemotingServicesTest.MarshalObject"
                + MarshalObjectId.ToString();
        ...
        {
            string uri =
                "MonoTests.System.Runtime.Remoting.RemotingServicesTest.DerivedMarshalObject"
                + MarshalObjectId.ToString();
        ...
        public void Marshal2()
        {
            ...
            ObjRef objRef = RemotingServices.Marshal(
                derivedObjMarshal,
                derivedObjMarshal.Uri,
                typeof(MarshalObject)
            );

            // Check that the type of the marshaled object is MarshalObject
            Assert.IsTrue(
                objRef.TypeInfo.TypeName.StartsWith((typeof(MarshalObject)).ToString()),
                "#A05"
            );
        ...
        public void Connect()
        {
            ...
            try
            {
                ...
                MarshalObject objRem = (MarshalObject)
                    RemotingServices.Connect(
                        typeof(MarshalObject),
                        $"tcp://localhost:{port}/" + objMarshal.Uri
                    );
        ...
        public void IsOneWay()
        {
            ...
            try
            {
                ...
                MarshalObject objRem = (MarshalObject)
                    Activator.GetObject(
                        typeof(MarshalObject),
                        $"tcp://localhost:{port}/MarshalObject.rem"
                    );
        ...
        public void GetObjRefForProxy()
        {
            ...
            try
            {
                ...
                RemotingConfiguration.RegisterWellKnownServiceType(
                    typeof(MarshalObjectFactory),
                    "MonoTests.System.Runtime.Remoting.RemotingServicesTest.Factory.soap",
                    WellKnownObjectMode.Singleton
                );

                MarshalObjectFactory objFactory = (MarshalObjectFactory)
                    Activator.GetObject(
                        typeof(MarshalObjectFactory),
                        $"tcp://localhost:{port}/MonoTests.System.Runtime.Remoting.RemotingServicesTest.Factory.soap"
                    );
        ...
        public void GetRealProxy()
        {
            ...
            try
            {
                RemotingConfiguration.RegisterWellKnownServiceType(
                    typeof(MarshalObject),
                    "MonoTests.System.Runtime.Remoting.RemotingServicesTest.MarshalObject.soap",
                    WellKnownObjectMode.Singleton
                );
                ...
                MyProxy proxy = new MyProxy(
                    ...
                    (MarshalByRefObject)
                        Activator.GetObject(
                            typeof(MarshalObject),
                            $"tcp://localhost:{port}/MonoTests.System.Runtime.Remoting.RemotingServicesTest.MarshalObject.soap"
                        )
                );
                MarshalObject objRem = (MarshalObject)proxy.GetTransparentProxy();
                ...
                Assert.AreEqual(
                    "MonoTests.System.Runtime.Remoting.RemotingServicesInternal.MyProxy",
                    rp.GetType().ToString(),
                    "#A13"
                );
            }
        ...
        public void SetObjectUriForMarshal()
        {
            ...
            try
            {
                ...
                objRem = (MarshalObject)
                    Activator.GetObject(
                        typeof(MarshalObject),
                        $"tcp://localhost:{port}/" + objRem.Uri
                    );
        ...
        public void GetServeurTypeForUri()
        {
            ...
            try
            {
                ...
                Type typeRem = RemotingServices.GetServerTypeForUri(
                    RemotingServices.GetObjectUri(objRem)
                );
        ...
        public void IsObjectOutOf()
        {
            ...
            try
            {
                ...
                MarshalObject objRem = (MarshalObject)
                    Activator.GetObject(
                        typeof(MarshalObject),
                        $"tcp://localhost:{port}/MarshalObject2.rem"
                    );
        ...
        public void ApplicationNameTest()
        {
            ...
            try
            {
                ...
                MarshalObject objRem = (MarshalObject)
                    Activator.GetObject(
                        typeof(MarshalObject),
                        $"tcp://localhost:{port}/app/obj3.rem"
                    );
                MarshalObject objRem2 = (MarshalObject)
                    Activator.GetObject(typeof(MarshalObject), $"tcp://localhost:{port}/obj3.rem");
        ...
        public void GetObjectWithChannelDataTest()
        {
            ...
            try
            {
                ...
                Assert.IsNotNull(
                    Activator.GetObject(
                        typeof(MarshalObject),
                        $"tcp://localhost:{port}/getobjectwithchanneldata.rem",
                        channelData
                    ),
                    "#01"
                );
        ...
        [Test]
        [Ignore(
            "We cannot test RemotingConfiguration.Configure() because it keeps channels registered. If we really need to test it, do it as a standalone case"
        )]
        public void ConnectProxyCast()
        {
            ...
            o = RemotingServices.Connect(
                typeof(MarshalByRefObject),
                $"tcp://localhost:{port}/ff1.rem"
            );
