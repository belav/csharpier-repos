...
namespace MonoTests.Remoting.Http
{
    ...
    public class Bug324362
    {
        ...
        [Ignore(
            "This test somehow keeps http channel registered and then blocks any further http tests working. This also happens under .NET, so this test itself is wrong with nunit 2.4.8."
        )]
        public void Test()
        {
            ...
            Service remObj = (Service)
                RemotingServices.Connect(typeof(Service), $"http://127.0.0.1:{port}/test");
    ...
    public class Bug321420 : MarshalByRefObject
    {
        ...
        public void Main()
        {
            ...
            Bug321420 s = (Bug321420)
                Activator.GetObject(typeof(Bug321420), $"http://127.0.0.1:{port}/Server.soap");
    ...
    public class Bug315570
    {
        ...
        {
            Foo foo = (Foo)
                Activator.GetObject(typeof(Foo), $"http://127.0.0.1:{server.HttpPort}/Test");
        ...
        public void Start()
        {
            ...
            server = (Server)
                domain.CreateInstanceAndUnwrap(
                    typeof(Server).Assembly.FullName,
