    ...
    public static class EnumerableRowCollectionExtensions
    {
        ...
        )
        {
            EnumerableRowCollection<TRow> edt = new EnumerableRowCollection<TRow>(
                source,
                Enumerable.Where<TRow>(source, predicate),
                null
            ); //copy constructor
        ...
        {
            IEnumerable<TRow> ie = Enumerable.OrderByDescending<TRow, TKey>(
                source,
                keySelector,
                comparer
            );
        ...
        {
            IEnumerable<TRow> ie = Enumerable.ThenBy<TRow, TKey>(
        ...
        {
            IEnumerable<TRow> ie = Enumerable.ThenByDescending<TRow, TKey>(
                (IOrderedEnumerable<TRow>)source.EnumerableRows,
                keySelector
            );
        ...
        )
        {
            ...
            return new EnumerableRowCollection<S>(
                ((object)source) as EnumerableRowCollection<S>,
                typedEnumerable,
        ...
        )
        {
            ...
            { //Anonymous type or some other type
                ...
                EnumerableRowCollection<TResult> newEdt = new EnumerableRowCollection<TResult>(
                    typedEnumerable,
                    typeof(TResult).IsAssignableFrom(source.ElementType)
