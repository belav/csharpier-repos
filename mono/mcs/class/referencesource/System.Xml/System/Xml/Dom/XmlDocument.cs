...
namespace System.Xml
{
    ...
    public class XmlDocument : XmlNode
    {
            ...
            if (!this.IsLoading)
            {
                ...
                if (
                    (
                        ...
                        || (oPrefix == (object)strEmpty && oLocalName == (object)strXmlns)
                    ) ^ (oNamespaceURI == (object)strReservedXmlns)
                )
                    throw new ArgumentException(
                        Res.GetString(Res.Xdom_Attr_Reserved_XmlNS, namespaceURI)
                    );
            }
            return xmlName;
        }
                ...
                if (value != null)
                {
                    ...
                    catch (SecurityException e)
                    {
                        throw new SecurityException(
                            Res.GetString(Res.Xml_UntrustedCodeSettingResolver),
                            e
                        );
                    }
                }
            ...
            switch (type)
            {
                ...
                case XmlNodeType.DocumentType:
                    if (DocumentType != null)
                        throw new InvalidOperationException(
                            Res.GetString(Res.Xdom_DualDocumentTypeNode)
                        );
                    return true;
                ...
                case XmlNodeType.Element:
                    if (DocumentElement != null)
                        throw new InvalidOperationException(
                            Res.GetString(Res.Xdom_DualDocumentElementNode)
                        );
                    return true;
                ...
                case XmlNodeType.XmlDeclaration:
                    if (Declaration != null)
                        throw new InvalidOperationException(
                            Res.GetString(Res.Xdom_DualDeclarationNode)
                        );
                    return true;
        ...
        {
            set { throw new InvalidOperationException(Res.GetString(Res.Xdom_Document_Innertext)); }
        }
        ...
        public void Validate(ValidationEventHandler validationEventHandler, XmlNode nodeToValidate)
        {
            ...
            {
                throw new ArgumentException(
                    Res.GetString(Res.XmlDocument_NodeNotFromDocument, "nodeToValidate")
                );
            }
        ...
        {
            add { onNodeInsertingDelegate += value; }
            remove { onNodeInsertingDelegate -= value; }
        }

        public event XmlNodeChangedEventHandler NodeInserted
        {
            add { onNodeInsertedDelegate += value; }
            remove { onNodeInsertedDelegate -= value; }
        }

        public event XmlNodeChangedEventHandler NodeRemoving
        {
            add { onNodeRemovingDelegate += value; }
            remove { onNodeRemovingDelegate -= value; }
        }

        public event XmlNodeChangedEventHandler NodeRemoved
        {
            add { onNodeRemovedDelegate += value; }
            remove { onNodeRemovedDelegate -= value; }
        }

        public event XmlNodeChangedEventHandler NodeChanging
        {
            add { onNodeChangingDelegate += value; }
            remove { onNodeChangingDelegate -= value; }
        }

        public event XmlNodeChangedEventHandler NodeChanged
        {
            add { onNodeChangedDelegate += value; }
            remove { onNodeChangedDelegate -= value; }
        }
        ...
        internal override XmlNode AppendChildForLoad(XmlNode newChild, XmlDocument doc)
        {
            ...
            if (!IsValidChildType(newChild.NodeType))
                throw new InvalidOperationException(
                    Res.GetString(Res.Xdom_Node_Insert_TypeConflict)
                );
