...
namespace System.Xml
{
    internal sealed class DocumentXPathNavigator : XPathNavigator, IHasXmlNode
    {
                    ...
                    if (node != end)
                    {
                        if (node.IsReadOnly)
                        {
                            throw new InvalidOperationException(
                                Res.GetString(Res.Xdom_Node_Modify_ReadOnly)
                            );
                        }
        ...
        public override bool MoveToNextAttribute()
        {
            ...
            if (
                !CheckAttributePosition(attribute, out attributes, attributeIndex)
        ...
        public override bool MoveTo(XPathNavigator other)
        {
            ...
            if (that != null && document == that.document)
            {
                source = that.source;
        ...
        public override bool MoveToNext(XPathNodeType type)
        {
            ...
            if (sibling.IsText && source.IsText)
            {
                sibling = NextSibling(TextEnd(sibling));
                if (sibling == null)
                {
        ...
        public override bool IsSamePosition(XPathNavigator other)
        {
            ...
            if (that != null)
            {
                ...
                return this.source == that.source && this.namespaceParent == that.namespaceParent;
            }
            return false;
        }
            ...
            else
            {
                ...
                if (schemas != null)
                {
                    throw new ArgumentException(
                        Res.GetString(Res.XPathDocument_SchemaSetNotAllowed, null)
                    );
                }
            }
        ...
        public override XmlNodeOrder ComparePosition(XPathNavigator other)
        {
            ...
            if (this.source == that.source && this.namespaceParent == that.namespaceParent)
            {
                return XmlNodeOrder.Same;
            }

            if (this.namespaceParent != null || that.namespaceParent != null)
            {
        ...
        internal void ResetPosition(XmlNode node)
        {
            ...
            Debug.Assert(
                node == document || node.OwnerDocument == document,
        ...
        private static bool CheckAttributePosition(
            XmlAttribute attribute,
            out XmlAttributeCollection attributes,
            int index
        )
        {
            XmlElement element = attribute.OwnerElement;
