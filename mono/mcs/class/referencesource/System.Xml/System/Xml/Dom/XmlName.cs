...
namespace System.Xml
{
    ...
    internal sealed class XmlNameEx : XmlName
    {
        ...
        public override XmlSchemaValidity Validity
        {
            get
            {
                return ownerDoc.CanReportValidity
                    ? (XmlSchemaValidity)(flags & ValidityMask)
        ...
        {
            get { return (flags & IsDefaultBit) != 0; }
        }

        public override bool IsNil
        {
            get { return (flags & IsNilBit) != 0; }
        }
        ...
        {
            get { return decl as XmlSchemaElement; }
        }

        public override XmlSchemaAttribute SchemaAttribute
        {
            get { return decl as XmlSchemaAttribute; }
        }
