...
namespace System.Xml.Xsl
{
    ...
    public sealed class XslCompiledTransform
    {
        ...
        static XslCompiledTransform()
        {
            ...
            MemberAccessPermissionSet.AddPermission(
        ...
        {
            get { return this.outputSettings; }
        }
        ...
        public void Load(XmlReader stylesheet)
        {
            ...
            LoadInternal(
                ...
                XsltConfigSection.CreateDefaultResolver()
            );
        }
        ...
        [ResourceConsumption(ResourceScope.Machine)]
        [ResourceExposure(ResourceScope.Machine)]
        private CompilerResults LoadInternal(
            object stylesheet,
            XsltSettings settings,
            XmlResolver stylesheetResolver
        )
        ...
        [ResourceConsumption(ResourceScope.Machine)]
        [ResourceExposure(ResourceScope.Machine)]
        private void CompileXsltToQil(
            object stylesheet,
            XsltSettings settings,
            XmlResolver stylesheetResolver
        )
        {
            this.compilerResults = new Compiler(settings, this.enableDebug, null).Compile(
                stylesheet,
                stylesheetResolver,
                out this.qil
            );
        ...
        {
            this.command = new XmlILGenerator().Generate(
                this.qil, /*typeBuilder:*/
                null
            );
        ...
        )
        {
            ...
            QilExpression qil;
            CompilerErrorCollection errors = new Compiler(settings, debug, scriptAssemblyPath)
                .Compile(stylesheet, stylesheetResolver, out qil)
                .Errors;
            ...
            if (!errors.HasErrors)
            {
                ...
                if (GeneratedCodeCtor == null)
                    GeneratedCodeCtor = typeof(GeneratedCodeAttribute).GetConstructor(
        ...
        public void Load(Type compiledStylesheet)
        {
            ...
            object[] customAttrs = compiledStylesheet.GetCustomAttributes(
                typeof(GeneratedCodeAttribute), /*inherit:*/
                false
            );
            GeneratedCodeAttribute generatedCodeAttr =
                customAttrs.Length > 0 ? (GeneratedCodeAttribute)customAttrs[0] : null;
            ...
            )
            {
                if (new Version(Version).CompareTo(new Version(generatedCodeAttr.Version)) < 0)
                {
                    throw new ArgumentException(
                        Res.GetString(
                            Res.Xslt_IncompatibleCompiledStylesheetVersion,
                            generatedCodeAttr.Version,
                            Version
                        ),
                        "compiledStylesheet"
                    );
                ...
                FieldInfo fldData = compiledStylesheet.GetField(
                    XmlQueryStaticData.DataFieldName,
                    BindingFlags.Static | BindingFlags.NonPublic
                );
                FieldInfo fldTypes = compiledStylesheet.GetField(
                    XmlQueryStaticData.TypesFieldName,
                    BindingFlags.Static | BindingFlags.NonPublic
                );
                ...
                if (fldData != null && fldTypes != null)
                {
                    ...
                    byte[] queryData =
                        fldData.GetValue( /*this:*/
                            null
                        ) as byte[];

                    if (queryData != null)
                    {
                        MethodInfo executeMethod = compiledStylesheet.GetMethod(
                            "Execute",
                            BindingFlags.Static | BindingFlags.NonPublic
                        );
                        Type[] earlyBoundTypes = (Type[])
                            fldTypes.GetValue( /*this:*/
                                null
                            );
            ...
            if (this.command == null)
                throw new ArgumentException(
                    Res.GetString(Res.Xslt_NotCompiledStylesheet, compiledStylesheet.FullName),
                    "compiledStylesheet"
                );
        }
        ...
        public void Load(MethodInfo executeMethod, byte[] queryData, Type[] earlyBoundTypes)
        {
            ...
            Delegate delExec =
                (dm != null)
                    ...
                    : Delegate.CreateDelegate(typeof(ExecuteDelegate), executeMethod);
            this.command = new XmlILCommand(
                (ExecuteDelegate)delExec,
                new XmlQueryStaticData(queryData, earlyBoundTypes)
            );
            this.outputSettings = this.command.StaticData.DefaultWriterSettings;
        }
        ...
        [ResourceConsumption(ResourceScope.Machine)]
        [ResourceExposure(ResourceScope.Machine)]
        private QilExpression TestCompile(
            object stylesheet,
            XsltSettings settings,
            XmlResolver stylesheetResolver
        )
