...
namespace System.Xml
{
    ...
    internal abstract partial class XmlRawWriter : XmlWriter
    {
        ...
        //      2) any method that can be used to write out a value of an attribute: WriteString,
        // WriteChars, WriteRaw, WriteCharEntity...
        //      3) WriteEndNamespaceDeclaration
        // instead of just a single WriteNamespaceDeclaration call.
        //
        // This feature will be supported by raw writers serializing to text that wish to preserve the
        // attribute value escaping and entities.
