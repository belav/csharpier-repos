...
namespace System.Xml
{
            ...
            IXmlNamespaceResolver
    {
            ...
            get
            {
                ...
                else
                {
                    ...
                    if (
                        ...
                        && (
                            validator.CurrentContentType == XmlSchemaContentType.TextOnly
        ...
        public override string GetAttribute(int i)
        {
            ...
            else
            {
                ...
                ValidatingReaderNodeData attNode = (ValidatingReaderNodeData)
                    defaultAttributes[defaultIndex];
        ...
        {
            get { return xmlSchemaInfo.XmlType; }
        }
        ...
        private void ProcessElementEvent()
        {
            if (
                this.processInlineSchema
                && IsXSDRoot(coreReader.LocalName, coreReader.NamespaceURI)
                && coreReader.Depth > 0
            )
            {
                xmlSchemaInfo.Clear();
                ...
                { //If its not empty schema, then parse else ignore
                    inlineSchemaParser = new Parser(
                        SchemaType.XSD,
                        coreReaderNameTable,
                        validator.SchemaSet.GetSchemaNames(coreReaderNameTable),
                        validationEvent
                    );
                    ...
                    do
                    {
                        ...
                        if (manageNamespaces && Ref.Equal(coreReader.NamespaceURI, NsXmlNs))
                        {
                            nsManager.AddNamespace(
                                coreReader.Prefix.Length == 0 ? string.Empty : coreReader.LocalName,
                                coreReader.Value
                            );
                        }
        ...
        private void ProcessEndElementEvent()
        {
            ...
            { //The atomicValue returned is a default value
                ...
                cachingReader.RecordTextNode(
                    xmlSchemaInfo.XmlType.ValueConverter.ToString(atomicValue),
        ...
        private void ValidateAttributes()
        {
            ...
            if (coreReader.MoveToFirstAttribute())
            {
                do
                {
                    ...
                    attributePSVI.typedAttributeValue = validator.ValidateAttribute(
                        localName,
                        ns,
                        valueGetter,
