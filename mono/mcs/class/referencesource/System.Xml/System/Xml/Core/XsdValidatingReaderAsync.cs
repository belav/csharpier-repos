...
namespace System.Xml
{
            ...
            IXmlNamespaceResolver
    {
        ...
        private async Task ProcessElementEventAsync()
        {
            ...
            )
            {
                ...
                { //If its not empty schema, then parse else ignore
                    ...
                    await inlineSchemaParser
                        .StartParsingAsync(coreReader, null)
                        .ConfigureAwait(false);
        ...
        private async Task<Tuple<XmlSchemaType, object>> InternalReadElementContentAsObjectAsync(
            bool unwrapTypedValue
        )
        {
        ...
        private async Task<
            Tuple<XmlSchemaType, string, object>
        > InternalReadElementContentAsObjectTupleAsync(bool unwrapTypedValue)
        {
            ...
            if (this.IsEmptyElement)
            {
                ...
                tuple = new Tuple<XmlSchemaType, string, object>(
                    xmlType,
                    originalString,
                    typedValue
                );
