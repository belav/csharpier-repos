            ...
            try
            {
                ...
                if (specAttr == SpecialAttribute.No)
                {
                    ...
                    return TryReturnTask(
                        writer.WriteStartAttributeAsync(prefix, localName, namespaceName)
                    );
                }
                return AsyncHelper.DoneTask;
            }
                    ...
                    case SpecialAttribute.PrefixedXmlns:
                        ...
                        { // returns true if the namespace declaration should be written out
                            if (rawWriter != null)
                            {
                                ...
                                {
                                    await rawWriter
                                        .WriteStartNamespaceDeclarationAsync(curDeclPrefix)
                                        .ConfigureAwait(false);
                                    await attrValueCache
                                        .ReplayAsync(rawWriter)
                                        .ConfigureAwait(false);
                                ...
                                {
                                    await rawWriter
                                        .WriteNamespaceDeclarationAsync(curDeclPrefix, value)
                                        .ConfigureAwait(false);
                                }
                            }
                            else
