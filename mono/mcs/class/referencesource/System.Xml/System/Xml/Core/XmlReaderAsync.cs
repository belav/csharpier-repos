    ...
    public abstract partial class XmlReader : IDisposable
    {
        ...
        public virtual Task<int> ReadContentAsBase64Async(byte[] buffer, int index, int count)
        {
            throw new NotSupportedException(
                Res.GetString(Res.Xml_ReadBinaryContentNotSupported, "ReadContentAsBase64")
            );
        }
        ...
        {
            throw new NotSupportedException(
                Res.GetString(Res.Xml_ReadBinaryContentNotSupported, "ReadElementContentAsBase64")
            );
        }
        ...
        {
            throw new NotSupportedException(
                Res.GetString(Res.Xml_ReadBinaryContentNotSupported, "ReadContentAsBinHex")
            );
        }
        ...
        {
            throw new NotSupportedException(
                Res.GetString(Res.Xml_ReadBinaryContentNotSupported, "ReadElementContentAsBinHex")
            );
        }
        ...
        private async Task<bool> SetupReadElementContentAsXxxAsync(string methodName)
        {
            ...
            {
                throw new XmlException(
                    Res.Xml_MixedReadElementContentAs,
                    string.Empty,
                    this as IXmlLineInfo
                );
            }
