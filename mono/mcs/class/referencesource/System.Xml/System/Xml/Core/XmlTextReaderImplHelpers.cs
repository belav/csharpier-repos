...
#endif
using System.Collections;using System.Diagnostics;using System.Globalization;using System.Collections.Generic;using System.Runtime.Versioning;
#if SILVERLIGHT
...
namespace System.Xml
{
    internal partial class XmlTextReaderImpl
    {
        ...
        private class NodeData : IComparable
        {
            ...
            {
                get { return type == XmlNodeType.Element && isEmptyOrDefault; }
                set
                {
            ...
            {
                get { return type == XmlNodeType.Attribute && isEmptyOrDefault; }
                set
                {
