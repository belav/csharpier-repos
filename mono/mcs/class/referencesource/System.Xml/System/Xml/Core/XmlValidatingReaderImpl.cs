...
namespace System.Xml
{
            ...
            IXmlNamespaceResolver
    {
        ...
        internal class ValidationEventHandling : IValidationEventHandling
        {
            ...
            void IValidationEventHandling.SendEvent(
            ...
            )
            {
                if (eventHandler != null)
                {
                    eventHandler(
                        reader,
                        new ValidationEventArgs((XmlSchemaException)exception, severity)
                    );
                }
                else if (
        ...
        internal XmlValidatingReaderImpl(XmlReader reader)
        {
            ...
            if (coreReaderImpl == null)
            {
                throw new ArgumentException(
                    Res.GetString(Res.Arg_ExpectingXmlTextReader),
                    "reader"
                );
            }
...
#pragma warning disable 618
            ...
            coreReaderImpl.OnDefaultAttributeUse =
                new XmlTextReaderImpl.OnDefaultAttributeUseDelegate(ValidateDefaultAttributeOnUse);
...
#pragma warning restore 618
        ...
        {
            get { return coreReader.QuoteChar; }
        }
        ...
        {
            get { return coreReaderImpl.Encoding; }
        }
...
#pragma warning restore 618
        ...
        {
            get { return ((IXmlLineInfo)coreReader).LineNumber; }
        }

        // Returns the line number of the current node
        public int LinePosition
        {
            get { return ((IXmlLineInfo)coreReader).LinePosition; }
        }
        ...
        {
            add { eventHandling.AddHandler(value); }
            remove
            {
            ...
            get
            {
                if (validationType != ValidationType.None)
                {
                    XmlSchemaType schemaTypeObj =
                        coreReaderImpl.InternalSchemaType as XmlSchemaType;
                    if (
                        schemaTypeObj != null
...
#pragma warning restore 618
        ...
        {
            get { return coreReaderImpl.EntityHandling; }
            set { coreReaderImpl.EntityHandling = value; }
        }
        ...
        {
            get { return coreReaderImpl.Namespaces; }
            set { coreReaderImpl.Namespaces = value; }
        }
...
#pragma warning restore 618
        ...
        {
            validator = BaseValidator.CreateInstance(
                valType,
                this,
                schemaCollection,
                eventHandling,
            ...
            if (outerReader.BaseURI.Length > 0)
            {
                validator.BaseUri =
                    (resolver == null)
                        ? new Uri(outerReader.BaseURI, UriKind.RelativeOrAbsolute)
                        : resolver.ResolveUri(null, outerReader.BaseURI);
            }
            coreReaderImpl.ValidationEventHandling =
                (validationType == ValidationType.None) ? null : eventHandling;
        }
        ...
        {
            get { return coreReaderImpl.NamespaceManager; }
        }

        internal bool StandAlone
        {
            get { return coreReaderImpl.StandAlone; }
        }

        internal object SchemaTypeObject
        {
            set { coreReaderImpl.InternalSchemaType = value; }
        }

        internal object TypedValueObject
        {
            get { return coreReaderImpl.InternalTypedValue; }
            set { coreReaderImpl.InternalTypedValue = value; }
        }

        internal bool Normalization
        {
            get { return coreReaderImpl.Normalization; }
        }
        ...
        )
        {
            ...
            if (!attdef.DefaultValueChecked)
            {
                ...
                DtdValidator.CheckDefaultValue(
                    attdef,
                    schemaInfo,
                    eventHandling,
                    coreReader.BaseURI
