...
namespace System.Xml.Serialization
{
    ...
    {
        private const string UseLegacySerializerGenerationAppSettingsString =
            "System:Xml:Serialization:UseLegacySerializerGeneration";
                    ...
                    if (!settingsInitalized)
                    {
                        ...
                        finally
                        {
                            ...
                            if (
                                ...
                                || !bool.TryParse(
                                    appSettingsSection[
                                        UseLegacySerializerGenerationAppSettingsString
                                    ],
                                    out tempUseLegacySerializerGeneration
                                )
                            )
                            {
