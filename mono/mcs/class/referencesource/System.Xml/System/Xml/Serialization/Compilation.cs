    ...
    internal class TempAssembly
    {
        ...
        )
        {
            ...
            if (!containsSoapMapping && !TempAssembly.UseLegacySerializerGeneration)
            {
                try
                {
                    assembly = GenerateRefEmitAssembly(
                        xmlMappings,
                        types,
                        defaultNamespace,
                        evidence
            ...
            if (fallbackToCSharpAssemblyGeneration)
            {
                assembly = GenerateAssembly(
                    ...
                    defaultNamespace,
                    evidence,
                    XmlSerializerCompilerParameters.Create(location),
                    null,
                    assemblies
                );
            }
                ...
                else
                {
                    ...
                    XmlSerializerSection configSection =
                        ConfigurationManager.GetSection(
                            ConfigurationStrings.XmlSerializerSectionPath
                        ) as XmlSerializerSection;
                    return configSection == null
                        ? false
                        : configSection.UseLegacySerializerGeneration;
#else
                    return false;
#endif
                }
                ...
                if (contract == null)
                {
                    contract = (XmlSerializerImplementation)
                        Activator.CreateInstance(
                            GetTypeFromAssembly(this.assembly, "XmlSerializerContract")
                        );
                }
                return contract;
            }
...
#pragma warning restore 618
                ...
                if (serializer == null)
                {
                    ...
                    {
                        Log(
                            Res.GetString(Res.XmlPregenCannotLoad, serializerName),
                ...
                if (!IsSerializerVersionMatch(serializer, type, defaultNamespace, null))
                {
                    ...
                    if (logEnabled)
                        Log(
                            Res.GetString(
                                Res.XmlSerializerExpiredDetails,
                                serializerName,
                                type.FullName
                            ),
            ...
            {
                XmlSerializerAssemblyAttribute assemblyAttribute = (XmlSerializerAssemblyAttribute)
                    attrs[0];
                if (assemblyAttribute.AssemblyName != null && assemblyAttribute.CodeBase != null)
                    throw new InvalidOperationException(
                        Res.GetString(
                            Res.XmlPregenInvalidXmlSerializerAssemblyAttribute,
                            "AssemblyName",
                            "CodeBase"
                        )
                    );
...
#pragma warning restore 618
            ...
            if (logEnabled)
                Log(
                    Res.GetString(Res.XmlSerializerExpiredDetails, serializerName, type.FullName),
                    EventLogEntryType.Error
                );
#endif //!FEATURE_PAL // EventLog
            return null;
            ...
            try
            {
                ...
                if (assembly != null && types.Length > 0)
                {
                    for (int i = 0; i < types.Length; i++)
                    {
                        ...
                        {
                            throw new InvalidOperationException(
                                Res.GetString(Res.XmlPregenTypeDynamic, types[i].FullName)
                            );
                        }
                    }
                ...
                XmlSerializationWriterCodeGen writerCodeGen = new XmlSerializationWriterCodeGen(
                    writer,
                    scopes,
                    "public",
                    writerClass
                ...
                XmlSerializationReaderCodeGen readerCodeGen = new XmlSerializationReaderCodeGen(
                    writer,
                    scopes,
                    "public",
                    readerClass
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage(
            ...
            Justification = "It is safe because the serialization assembly is generated by the framework code, not by the user."
        )]
        ...
        )
        {
            ...
            ConstructorInfo SecurityTransparentAttribute_ctor =
            ...
            assemblyBuilder.SetCustomAttribute(
                new CustomAttributeBuilder(SecurityTransparentAttribute_ctor, new Object[0])
            );
            ConstructorInfo AllowPartiallyTrustedCallersAttribute_ctor =
            ...
            assemblyBuilder.SetCustomAttribute(
                new CustomAttributeBuilder(
                    AllowPartiallyTrustedCallersAttribute_ctor,
                    new Object[0]
                )
            );
            ConstructorInfo SecurityRulesAttribute_ctor =
                typeof(SecurityRulesAttribute).GetConstructor(
                    CodeGenerator.InstanceBindingFlags,
                    null,
        ...
        static MethodInfo GetMethodFromType(Type type, string methodName, Assembly assembly)
        {
            ...
            {
                throw new InvalidOperationException(
                    Res.GetString(Res.XmlSerializerExpired, assembly.FullName, assembly.CodeBase),
                    missingMethod
                );
            }
            throw missingMethod;
        ...
        internal static Type GetTypeFromAssembly(Assembly assembly, string typeName)
        {
            ...
            if (type == null)
                throw new InvalidOperationException(
                    Res.GetString(Res.XmlMissingType, typeName, assembly.FullName)
                );
            return type;
        }
        ...
        string ValidateEncodingStyle(string encodingStyle, string methodKey)
        {
            if (encodingStyle != null && encodingStyle.Length > 0)
            {
                ...
                {
                    throw new InvalidOperationException(
                        Res.GetString(Res.XmlInvalidEncodingNotEncoded1, encodingStyle)
                    );
                }
            }
            else
        ...
        )
        {
            ...
            try
            {
                ...
                if (methods[mapping.Key].readMethod == null)
                {
                    ...
                    {
                        throw new InvalidOperationException(
                            Res.GetString(Res.XmlNotSerializable, mapping.Accessor.Name)
                        );
                    }
                    methods[mapping.Key].readMethod = GetMethodFromType(
                        reader.GetType(),
                        methodName,
                        pregeneratedAssmbly ? this.assembly : null
                    );
                }
        ...
        )
        {
            ...
            try
            {
                ...
                if (methods[mapping.Key].writeMethod == null)
                {
                    ...
                    methods[mapping.Key].writeMethod = GetMethodFromType(
                        writer.GetType(),
                        methodName,
                        pregeneratedAssmbly ? assembly : null
                    );
                }
        ...
        internal sealed class TempMethodDictionary : DictionaryBase
        {
            ...
            {
                get { return (TempMethod)Dictionary[key]; }
            }
    ...
    sealed class XmlSerializerCompilerParameters
    {
        ...
        {
            get { return this.needTempDirAccess; }
        }
        ...
        internal static XmlSerializerCompilerParameters Create(
            CompilerParameters parameters,
            bool needTempDirAccess
        )
        {
