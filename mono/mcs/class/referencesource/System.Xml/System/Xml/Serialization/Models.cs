...
namespace System.Xml.Serialization
{
                ...
                default:
                    if (!typeDesc.IsSpecial)
                        throw new NotSupportedException(
                            Res.GetString(Res.XmlUnsupportedTypeKind, type.FullName)
                        );
            ...
            if (typeDesc.IsUnsupported)
            {
                if (typeDesc.Exception == null)
                {
                    typeDesc.Exception = new NotSupportedException(
                        Res.GetString(Res.XmlSerializerUnsupportedType, typeDesc.FullName)
                    );
                }
                throw new InvalidOperationException(
                    Res.GetString(
                        Res.XmlSerializerUnsupportedMember,
    ...
    internal class FieldModel
    {
        ...
        internal FieldModel(MemberInfo memberInfo, Type fieldType, TypeDesc fieldTypeDesc)
        {
            ...
            this.checkShouldPersistMethodInfo = memberInfo.DeclaringType.GetMethod(
            ...
            if (specifiedField != null)
            {
                ...
                this.checkSpecified = specifiedField.IsInitOnly
            ...
            else
            {
                ...
                if (specifiedProperty != null)
                {
                    ...
                    {
                        this.checkSpecified = specifiedProperty.CanWrite
                            ? SpecifiedAccessor.ReadWrite
                            : SpecifiedAccessor.ReadOnly;
                        this.checkSpecifiedMemberInfo = specifiedProperty;
                    }
                    if (
                        this.checkSpecified != SpecifiedAccessor.None
