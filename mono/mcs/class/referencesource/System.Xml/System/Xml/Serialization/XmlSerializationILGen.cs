...
namespace System.Xml.Serialization
{
    ...
    internal class XmlSerializationILGen
    {
        ...
        Dictionary<string, MethodBuilderInfo> methodBuilders =
        ...
        internal ModuleBuilder ModuleBuilder
        {
            get
            {
                System.Diagnostics.Debug.Assert(moduleBuilder != null);
                return moduleBuilder;
            }
            set
            {
                System.Diagnostics.Debug.Assert(moduleBuilder == null && value != null);
                moduleBuilder = value;
            }
        }
        ...
        internal FieldBuilder GenerateHashtableGetBegin(
            string privateName,
            string publicName,
        ...
        internal FieldBuilder GeneratePublicMethods(
            string privateName,
            string publicName,
            string[] methods,
        ...
        )
        {
            ...
            ConstructorInfo readerCtor = CreatedTypes[readerClass]
                .GetConstructor(
                    CodeGenerator.InstanceBindingFlags,
                    null,
                    CodeGenerator.EmptyTypeArray,
            ...
            ConstructorInfo writerCtor = CreatedTypes[writerClass]
                .GetConstructor(
                    CodeGenerator.InstanceBindingFlags,
                    null,
                    CodeGenerator.EmptyTypeArray,
        ...
        )
        {
            ...
            {
                ConstructorInfo ctor = CreatedTypes[(string)serializers[key]]
                    .GetConstructor(
                        CodeGenerator.InstanceBindingFlags,
                        null,
                        CodeGenerator.EmptyTypeArray,
        ...
        )
        {
            ...
            for (int i = 0; i < xmlMappings.Length; i++)
            {
                if (xmlMappings[i] is XmlTypeMapping)
                {
                    ...
                    ilg.If(Cmp.EqualTo);
                    {
                        ConstructorInfo ctor = CreatedTypes[(string)serializers[xmlMappings[i].Key]]
                            .GetConstructor(
                                CodeGenerator.InstanceBindingFlags,
                                null,
                                CodeGenerator.EmptyTypeArray,
        ...
        )
        {
            ...
            propertyBuilder.SetGetMethod(ilg.MethodBuilder);
            ConstructorInfo ctor = CreatedTypes[readerType]
                .GetConstructor(
                    CodeGenerator.InstanceBindingFlags,
                    null,
                    CodeGenerator.EmptyTypeArray,
            ...
            FieldBuilder readMethodsField = GeneratePublicMethods(
                "readMethods",
                "ReadMethods",
                readMethods,
                xmlMappings,
            ...
            FieldBuilder writeMethodsField = GeneratePublicMethods(
                "writeMethods",
                "WriteMethods",
                writerMethods,
                xmlMappings,
            ...
            FieldBuilder typedSerializersField = GenerateTypedSerializers(
                serializers,
                serializerContractTypeBuilder
            );
