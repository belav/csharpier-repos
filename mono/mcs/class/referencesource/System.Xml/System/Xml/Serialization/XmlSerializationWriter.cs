...
namespace System.Xml.Serialization
{
    ...
    public abstract class XmlSerializationWriter : XmlSerializationGeneratedCode
    {
        ...
        {
            get { return namespaces == null ? null : namespaces.NamespaceList; }
            set
            {
                if (value == null)
                {
            ...
            if (o != null && objectsInUse != null)
            {
                if (objectsInUse.ContainsKey(o))
                    throw new InvalidOperationException(
                        Res.GetString(Res.XmlCircularReference, o.GetType().FullName)
                    );
            ...
            if (namespaces != null)
            {
                foreach (string alias in namespaces.Namespaces.Keys)
                {
                    ...
                    if (aliasNs == null || aliasNs.Length == 0)
                    {
                        if (alias.Length > 0)
                            throw new InvalidOperationException(
                                Res.GetString(Res.XmlInvalidXmlns, alias)
                            );
            ...
            foreach (string alias in namespaces.Namespaces.Keys)
            {
                ...
                if (alias.Length > prefixLength)
                {
                    ...
                    if (
                        ...
                        && name.Length <= prefixLength + MaxInt32.Length
        ...
        protected Exception CreateUnknownTypeException(Type type)
        {
            if (typeof(IXmlSerializable).IsAssignableFrom(type))
                return new InvalidOperationException(
                    Res.GetString(Res.XmlInvalidSerializable, type.FullName)
                );
            TypeDesc typeDesc = new TypeScope().GetTypeDesc(type);
            if (!typeDesc.IsStructLike)
                return new InvalidOperationException(
                    Res.GetString(Res.XmlInvalidUseOfType, type.FullName)
                );
            return new InvalidOperationException(
                Res.GetString(Res.XmlUnxpectedType, type.FullName)
            );
        }
        ...
        )
        {
            ...
            return new InvalidOperationException(
                Res.GetString(Res.XmlChoiceMismatchChoiceException, elementName, value, enumValue)
            );
        }
        ...
        {
            return new InvalidOperationException(
                Res.GetString(Res.XmlInvalidChoiceIdentifierValue, type, identifier)
            );
        }
        ...
        {
            return new InvalidOperationException(
                Res.GetString(Res.XmlUnknownConstant, value, typeName)
            );
        }
        ...
        {
            return new InvalidOperationException(
                Res.GetString(Res.XmlIllegalAnyElement, type.FullName)
            );
        }
        ...
        protected void WriteXmlAttribute(XmlNode node, object container)
        {
            ...
            if (attr == null)
                throw new InvalidOperationException(Res.GetString(Res.XmlNeedAttributeHere));
            if (attr.Value != null)
            {
                if (attr.NamespaceURI == Wsdl.Namespace && attr.LocalName == Wsdl.ArrayType)
                {
                    ...
                    XmlQualifiedName qname = TypeScope.ParseWsdlArrayType(
                        attr.Value,
                        out dims,
                        (container is XmlSchemaObject) ? (XmlSchemaObject)container : null
                    );
        ...
        void WriteArray(string name, string ns, object o, Type type)
        {
            ...
            {
                while (
                    (elementType.IsArray || typeof(IEnumerable).IsAssignableFrom(elementType))
                    && GetPrimitiveTypeName(elementType, false) == null
                )
                {
            ...
            if (type.IsArray)
            {
                ...
                if (soap12)
                {
                    w.WriteAttributeString(
                        "itemType",
                        Soap12.Encoding,
                        GetQualifiedName(typeName, typeNs)
                    );
                    w.WriteAttributeString(
                        "arraySize",
                        Soap12.Encoding,
                        arrayLength.ToString(CultureInfo.InvariantCulture)
                    );
                }
                else
                {
            ...
            else
            {
                ...
                else
                {
                    ...
                    w.WriteAttributeString(
                        "arrayType",
                        Soap.Encoding,
                        GetQualifiedName(typeName, typeNs) + brackets
                    );
                }
        ...
        )
        {
            ...
            else
            {
                ...
                if (entry != null)
                {
                    ...
                    if (needXsiType)
                        WriteXsiType(entry.typeName, entry.typeNs);
                    entry.callback(o);
                    w.WriteEndElement();
                }
                else
        ...
        void WriteReferencedElement(string name, string ns, object o, Type ambientType)
        {
            ...
            else
            {
                ...
                if (entry == null)
                    throw CreateUnknownTypeException(t);
                WriteStartElement(
                    name.Length == 0 ? entry.typeName : name,
                    ns == null ? entry.typeNs : ns,
                    null,
                    true
                );
                WriteId(o, false);
            ...
            if (xmlns != null)
            {
                foreach (DictionaryEntry entry in xmlns.Namespaces)
                {
                    ...
                    if (namespaces != null)
                    {
                        ...
                        {
                            throw new InvalidOperationException(
                                Res.GetString(Res.XmlDuplicateNs, prefix, ns)
                            );
                        }
                    }
                    string oldPrefix =
                        (ns == null || ns.Length == 0) ? null : Writer.LookupPrefix(ns);
    ...
    internal class XmlSerializationWriterCodeGen : XmlSerializationCodeGen
    {
                    ...
                    )
                    {
                        ...
                        Writer.Write(
                            RaCodeGen.GetStringForTypeof(
                                typeMapping.TypeDesc.CSharpName,
                    ...
                    if (((EnumMapping)mapping).IsFlags)
                    {
                        ...
                        for (int i = 0; i < values.Length; i++)
                        {
                            ...
                            if (i > 0)
                                Writer.WriteLine(" | ");
                            Writer.Write(
                                RaCodeGen.GetStringForEnumCompare(
                                    (EnumMapping)mapping,
                                    values[i],
                                    mapping.TypeDesc.UseReflection
                                )
        ...
        void WriteDerivedTypes(StructMapping mapping)
        {
            ...
            )
            {
                ...
                Writer.Write(methodName);
                Writer.Write("(n, ns,");
                if (!derived.TypeDesc.UseReflection)
                    Writer.Write("(" + fullTypeName + ")");
                Writer.Write("o");
                    ...
                    else if (m is ArrayMapping && !m.IsSoap)
                    {
                        ...
                        if (mapping.TypeDesc.IsArray)
                            WriteArrayTypeCompare(
                                "t",
                                fullTypeName,
                                mapping.TypeDesc.ArrayElementTypeDesc.CSharpName,
                                mapping.TypeDesc.UseReflection
                            );
                        else
                            WriteTypeCompare("t", fullTypeName, mapping.TypeDesc.UseReflection);
            ...
            if (!mapping.TypeDesc.IsAbstract)
            {
                ...
                for (int i = 0; i < members.Length; i++)
                {
                    ...
                    if (m.Attribute != null)
                    {
                        ...
                        {
                            Writer.Write("if (");
                            string methodInvoke = RaCodeGen.GetStringForMethodInvoke(
                                "o",
                                fullTypeName,
                            ...
                            if (mapping.TypeDesc.UseReflection)
                                methodInvoke =
                                    "((" + typeof(bool).FullName + ")" + methodInvoke + ")";
                        ...
                        WriteMember(
                            RaCodeGen.GetStringForMember("o", m.Name, mapping.TypeDesc),
                            m.Attribute,
                            m.TypeDesc,
                            "o"
                        );
                ...
                if (memberTypeDesc.IsEnumerable)
                {
                    ...
                    else if (memberTypeDesc.IsGenericInterface)
                    {
                        if (memberTypeDesc.UseReflection)
                        {
                            ...
                            Writer.Write(")");
                            Writer.Write(
                                RaCodeGen.GetReflectionVariable(
                    ...
                    else
                    {
                        ...
                        Writer.Write(
                            RaCodeGen.GetStringForMethodInvoke(
                                "a",
                                memberTypeDesc.CSharpName,
                                "GetEnumerator",
                                memberTypeDesc.UseReflection
                            )
                        );
                        Writer.WriteLine(";");
                    }
                    ...
                    WriteLocalDecl(
                        ...
                        "ai",
                        "e.Current",
                        arrayElementTypeDesc.UseReflection
                    );
                }
                else
                {
                    ...
                    WriteLocalDecl(
                        arrayTypeFullName,
                        "ai",
                        RaCodeGen.GetStringForArrayMember("a", "i", memberTypeDesc),
                        arrayElementTypeDesc.UseReflection
                    );
                }
                if (attribute.IsList)
        ...
        )
        {
            ...
            if (elements.Length == 1 && text == null)
            {
                ...
                if (
                    !elements[0].Any
                    && !elements[0].Mapping.TypeDesc.UseReflection
            ...
            else
            {
                ...
                for (int i = 0; i < elements.Length; i++)
                {
                    ...
                    else if (choice != null)
                    {
                        ...
                        string enumFullName =
                            (enumUseReflection ? "" : enumTypeName + ".@")
                            + FindChoiceEnumValue(
                                element,
            ...
            else
            {
                ...
                switch (Type.GetTypeCode(type))
                {
                    ...
                    default:
                        ...
                        {
                            throw new InvalidOperationException(
                                Res.GetString(Res.XmlUnsupportedDefaultType, type.FullName)
                            );
                        }
                        break;
                }
        ...
        {
            RaCodeGen.WriteArrayTypeCompare(
                variable,
                escapedTypeName,
                elementTypeName,
                useReflection
        ...
        )
        {
            ...
            if (enumValue == null || enumValue.Length == 0)
            {
                if (element.Any && element.Name.Length == 0)
                {
                    ...
                    throw new InvalidOperationException(
                        Res.GetString(Res.XmlChoiceMissingAnyValue, choiceMapping.TypeDesc.FullName)
                    );
                }
                // Type {0} is missing value for '{1}'.
                throw new InvalidOperationException(
                    Res.GetString(
                        Res.XmlChoiceMissingValue,
    ...
    internal class ReflectionAwareCodeGen
    {
        ...
        string WriteTypeInfo(TypeScope scope, TypeDesc typeDesc, Type type)
        {
            ...
            if (type.IsArray)
            {
                ...
                {
                    string elementTypeVariable = WriteTypeInfo(
                        scope,
                        elementTypeDesc,
                        scope.GetTypeFromTypeDesc(elementTypeDesc)
                    );
                    writer.WriteLine(
                        "static "
            ...
            else
            {
                ...
                {
                    string parameterTypeVariable = WriteTypeInfo(
                        scope,
                        scope.GetTypeDesc(parameterType),
                        parameterType
                    );
                    writer.WriteLine(
                        "static "
        ...
        void WriteMappingInfo(TypeMapping mapping, string typeVariable, Type type)
        {
            ...
            if (mapping is StructMapping)
            {
                ...
                for (int i = 0; i < structMapping.Members.Length; i++)
                {
                    ...
                    string memberVariable = WriteMemberInfo(
                        type,
                        typeFullName,
                        typeVariable,
                        member.Name
                    ...
                    if (member.CheckShouldPersist)
                    {
                        ...
                        memberVariable = WriteMethodInfo(
                            typeFullName,
                            typeVariable,
                            memberName,
                            false
                    ...
                    if (member.CheckSpecified != SpecifiedAccessor.None)
                    {
                        ...
                        memberVariable = WriteMemberInfo(
                            type,
                            typeFullName,
                            typeVariable,
                            memberName
        ...
        void WriteCollectionInfo(string typeVariable, TypeDesc typeDesc, Type type)
        {
            ...
            WriteMethodInfo(
                ...
                "Add",
                false,
                GetStringForTypeof(elementTypeFullName, elementUseReflection)
            );
        }
        ...
        string WriteAssemblyInfo(Type type)
        {
            ...
            if (assemblyVariable == null)
            {
                ...
                WriteQuotedCSharpString(
                    DynamicAssemblies.GetName(type.Assembly) /*assemblyFullName*/
                );
                writer.WriteLine(");");
        ...
        )
        {
            ...
            throw new InvalidOperationException(
                Res.GetString(Res.XmlSerializerUnsupportedType, memberInfos[0].ToString())
            );
        }

        string WriteMethodInfo(
            string escapedName,
            string typeVariable,
            string memberName,
            bool isNonPublic,
        ...
        string WriteDefaultIndexerInit(
            Type type,
            string escapedName,
        ...
        )
        {
            ...
            writer.Write(
                GetStringForTypeof(
                    CodeIdentifier.GetCSharpName(defaultIndexer.PropertyType),
                    elementUseReflection
                )
            );
            writer.Write(",new ");
        ...
        internal string GetStringForMethodInvoke(
            string obj,
            string escapedTypeName,
            string methodName,
            bool useReflection,
        ...
        )
        {
            ...
            string memberAccess = GetStringForEnumMember(
                mapping.TypeDesc.CSharpName,
                memberName,
                useReflection
            );
        ...
        )
        {
            ...
            string typeFullName = arrayTypeDesc.IsCollection
                ? arrayTypeDesc.CSharpName
        ...
        {
            return GetStringForCreateInstance(
                escapedTypeName,
                useReflection,
                ctorInaccessible,
                cast,
        ...
        )
        {
            ...
            return GetStringForCreateInstance(
                ...
                cast && !useReflection ? escapedTypeName : null,
                ctorInaccessible,
                arg
            );
        }
        ...
        )
        {
            ...
            writer.Write(
                GetStringForCreateInstance(
                    ...
                    useReflection,
                    ctorInaccessible,
                    !useReflection && ctorInaccessible
                )
            );
            writer.WriteLine(";");
        }
