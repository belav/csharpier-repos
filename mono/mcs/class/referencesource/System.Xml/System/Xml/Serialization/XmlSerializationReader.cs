...
namespace System.Xml.Serialization
{
    ...
    public abstract class XmlSerializationReader : XmlSerializationGeneratedCode
    {
        ...
        {
            XmlSerializerSection configSection =
                ConfigurationManager.GetSection(ConfigurationStrings.XmlSerializerSectionPath)
                as XmlSerializerSection;
            checkDeserializeAdvances =
                (configSection == null) ? false : configSection.CheckDeserializeAdvances;
        }
#endif
        ...
        Type GetPrimitiveType(XmlQualifiedName typeName, bool throwOnUnknown)
        {
            ...
            if (
                (object)typeName.Namespace == (object)schemaNsID
                || (object)typeName.Namespace == (object)soapNsID
                || (object)typeName.Namespace == (object)soap12NsID
            )
            {
                if (
                    (object)typeName.Name == (object)stringID
                ...
                (object)typeName.Namespace == (object)schemaNs2000ID
                || (object)typeName.Namespace == (object)schemaNs1999ID
            )
            {
                if (
                    (object)typeName.Name == (object)stringID
        ...
        private object ReadTypedPrimitive(XmlQualifiedName type, bool elementCanBeType)
        {
            ...
            if (
                (object)type.Namespace == (object)schemaNsID
                || (object)type.Namespace == (object)soapNsID
                || (object)type.Namespace == (object)soap12NsID
            )
            {
                if (
                    (object)type.Name == (object)stringID
                    ...
                    (object)type.Name == (object)base64ID
                    && (
                        (object)type.Namespace == (object)soapNsID
                        || (object)type.Namespace == (object)soap12NsID
                    )
                ...
                (object)type.Namespace == (object)schemaNs2000ID
                || (object)type.Namespace == (object)schemaNs1999ID
            )
            {
                if (
                    (object)type.Name == (object)stringID
            ...
            else if ((object)type.Namespace == (object)schemaNonXsdTypesNsID)
            {
                if ((object)type.Name == (object)charID)
                    ...
                    (object)type.Name == (object)timeSpanID
        ...
        {
            if (
                (object)attr.LocalName == (object)wsdlArrayTypeID
                && (object)attr.NamespaceURI == (object)wsdlNsID
            )
            {
                ...
                {
                    attr.Value =
                        r.LookupNamespace(attr.Value.Substring(0, colon))
                        + ":"
        ...
        protected int GetArrayLength(string name, string ns)
        {
            ...
            if (arrayInfo.dimensions != 1)
                throw new InvalidOperationException(
                    Res.GetString(Res.XmlInvalidArrayDimentions, CurrentTag())
                );
            XmlQualifiedName qname = ToXmlQualifiedName(arrayInfo.qname, false);
            if (qname.Name != name)
                throw new InvalidOperationException(
                    Res.GetString(Res.XmlInvalidArrayTypeName, qname.Name, name, CurrentTag())
                );
            if (qname.Namespace != ns)
                throw new InvalidOperationException(
                    Res.GetString(
                        Res.XmlInvalidArrayTypeNamespace,
                        qname.Namespace,
                        ns,
                        CurrentTag()
                    )
        ...
        private SoapArrayInfo ParseArrayType(string value)
        {
            if (value == null)
            {
                throw new ArgumentNullException(
                    Res.GetString(Res.XmlMissingArrayType, CurrentTag())
                );
            }
            ...
            if (value.Length == 0)
            {
                throw new ArgumentException(
                    Res.GetString(Res.XmlEmptyArrayType, CurrentTag()),
                    "value"
                );
            }
            ...
            if (len > 0)
            {
                ...
                catch (Exception e)
                {
                    ...
                    throw new ArgumentException(
                        Res.GetString(Res.XmlInvalidArrayLength, lengthString),
                        "value"
                    );
                }
            }
            ...
            while (pos != -1 && chars[pos] == ']')
            {
                ...
                if (pos < 0)
                    throw new ArgumentException(
                        Res.GetString(Res.XmlMismatchedArrayBrackets),
                        "value"
                    );
                if (chars[pos] == ',')
                    throw new ArgumentException(
            ...
            for (int i = 0; i < dimensions.Length; i++)
            {
                if (dimensions[i].Length > 0)
                {
                    ...
                    else
                    {
                        try
                        {
                            soapArrayInfo.length = Int32.Parse(
                                dimensions[i],
                        ...
                        catch (Exception e)
                        {
                            ...
                            throw new ArgumentException(
                                Res.GetString(Res.XmlInvalidArrayLength, dimensions[i]),
                                "value"
                            );
                        }
                    }
        ...
        internal XmlQualifiedName ToXmlQualifiedName(string value, bool decodeName)
        {
            ...
            else
            {
                ...
                if (ns == null)
                {
                    ...
                    throw new InvalidOperationException(
                        Res.GetString(Res.XmlUndefinedAlias, prefix)
                    );
                }
        ...
        protected Exception CreateUnknownTypeException(XmlQualifiedName type)
        {
            return new InvalidOperationException(
                Res.GetString(Res.XmlUnknownType, type.Name, type.Namespace, CurrentTag())
            );
        }
        ...
        {
            return new InvalidOperationException(
                Res.GetString(Res.XmlAbstractType, name, ns, CurrentTag())
            );
        }
        ...
        {
            return new InvalidOperationException(
                Res.GetString(Res.XmlConstructorInaccessible, typeName)
            );
        }
        ...
        {
            return new InvalidOperationException(
                Res.GetString(Res.XmlConstructorHasSecurityAttributes, typeName)
            );
        }
        ...
        {
            return new InvalidOperationException(
                Res.GetString(Res.XmlUnknownConstant, value, enumType.Name)
            );
        }
        ...
        protected Exception CreateInvalidCastException(Type type, object value, string id)
        {
            if (value == null)
                return new InvalidCastException(
                    Res.GetString(Res.XmlInvalidNullCast, type.FullName)
                );
            else if (id == null)
                return new InvalidCastException(
                    Res.GetString(Res.XmlInvalidCast, value.GetType().FullName, type.FullName)
                );
            else
                return new InvalidCastException(
                    Res.GetString(
                        Res.XmlInvalidCastWithId,
        ...
        )
        {
            return new InvalidOperationException(
                Res.GetString(
                    Res.XmlSerializableBadDerivation,
                    xsdDerived,
                    nsDerived,
                    xsdBase,
                    nsBase,
        ...
        )
        {
            return new InvalidOperationException(
                Res.GetString(
                    Res.XmlSerializableMissingClrType,
                    name,
                    ns,
        ...
        protected bool ReadReference(out string fixupReference)
        {
            ...
            if (!soap12)
            {
                ...
                if (!href.StartsWith("#", StringComparison.Ordinal))
                    throw new InvalidOperationException(Res.GetString(Res.XmlMissingHref, href));
            ...
            if (elementType.IsValueType)
            {
                if (!isPrimitive && !elementType.IsEnum)
                {
                    throw new NotSupportedException(
                        Res.GetString(Res.XmlRpcArrayOfValueTypes, elementType.FullName)
                    );
                }
                //
        ...
        )
        {
            ...
            if (callbacks == null)
            {
                ...
                XmlQualifiedName urType = new XmlQualifiedName(
                    urTypeID,
                    r.NameTable.Add(XmlSchema.Namespace)
                );
                ...
                if (typeId == null)
                {
                    if (name == null)
                        typeId = new XmlQualifiedName(
                            r.NameTable.Add(r.LocalName),
                            r.NameTable.Add(r.NamespaceURI)
                        );
                    else
        ...
        object ReadXmlNodes(bool elementCanBeType)
        {
            ...
            while (Reader.MoveToNextAttribute())
            {
                if (
                    ...
                    || (Reader.Name == "id" && (!soap12 || Reader.NamespaceURI == Soap12.Encoding))
                )
                    skippableNodeCount++;
                if (
                    (object)Reader.LocalName == (object)typeID
                    && (
            ...
            if (checkDeserializeAdvances)
            {
                ...
                if ((whileIterations & 0x80) == 0x80)
                {
                    if (readerCount == ReaderCount)
                        throw new InvalidOperationException(
                            Res.GetString(Res.XmlInternalErrorReaderAdvance)
                        );
    ...
    internal class XmlSerializationReaderCodeGen : XmlSerializationCodeGen
    {
        ...
        )
        {
            ...
            if (create == null)
            {
                string createName =
                    "create"
                    + (++nextCreateMethodNumber).ToString(CultureInfo.InvariantCulture)
                    + "_"
                    + typeDesc.Name;
        ...
        void WriteWhileLoopEndCheck(int loopIndex)
        {
            Writer.WriteLine(
                String.Format(
                    CultureInfo.InvariantCulture,
                    "CheckReaderCount(ref whileIterations{0}, ref readerCount{1});",
                    loopIndex,
                    loopIndex
                )
            );
