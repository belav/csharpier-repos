...
namespace System.Xml.Serialization
{
    ...
    public class XmlReflectionImporter
    {
        ...
        void IncludeType(Type type, RecursionLimiter limiter)
        {
            ...
            TypeMapping mapping = ImportTypeMapping(
                modelScope.GetTypeModel(type),
                defaultNs,
                ImportContext.Element,
                string.Empty,
                null,
                limiter
            );
            if (mapping.IsAnonymousType && !mapping.TypeDesc.IsSpecial)
            {
                ...
                throw new InvalidOperationException(
                    Res.GetString(Res.XmlAnonymousInclude, type.FullName)
                );
            }
        ...
        )
        {
            ...
            MembersMapping membersMapping = ImportMembersMapping(
                members,
                ns,
                hasWrapperElement,
                rpc,
        ...
        )
        {
            ...
            savedArrayItemAttributes = null;
            savedArrayNamespace = null;
            ElementAccessor element = CreateElementAccessor(
                ImportTypeMapping(model, ns, ImportContext.Element, string.Empty, a, limiter),
                ns
            );
            ...
            if (root != null)
            {
                ...
                if (root.IsNullableSpecified && !root.IsNullable && model.TypeDesc.IsOptionalValue)
                    ...
                    throw new InvalidOperationException(
                        Res.GetString(
                            Res.XmlInvalidNotNullable,
                            model.TypeDesc.BaseTypeDesc.FullName,
                            "XmlRoot"
                        )
                    );
                element.IsNullable = root.IsNullableSpecified
                    ? root.IsNullable
        ...
        Accessor ReconcileAccessor(Accessor accessor, NameTable accessors)
        {
            ...
            {
                if (
                    accessor.Mapping.TypeDesc == existing.Mapping.TypeDesc
                    || (
                        existing.Mapping is NullableMapping
                        && accessor.Mapping.TypeDesc
                            == ((NullableMapping)existing.Mapping).BaseMapping.TypeDesc
                    )
                    || (
                ...
                )
                {
                    ...
                    string value2 = Convert.ToString(
                        existing.Default,
                        CultureInfo.InvariantCulture
                    );
                    if (value1 == value2)
                    ...
                    throw new InvalidOperationException(
                        Res.GetString(
                            Res.XmlCannotReconcileAccessorDefault,
                            accessor.Name,
                            accessor.Namespace,
                            value1,
                            value2
            ...
            if (accessor.Mapping is MembersMapping || existing.Mapping is MembersMapping)
                throw new InvalidOperationException(
                    Res.GetString(Res.XmlMethodTypeNameConflict, accessor.Name, accessor.Namespace)
                );
            ...
            if (accessor.Mapping is ArrayMapping)
            {
                if (!(existing.Mapping is ArrayMapping))
                {
                    throw new InvalidOperationException(
                        Res.GetString(
                            Res.XmlCannotReconcileAccessor,
                            accessor.Name,
                            accessor.Namespace,
                            GetMappingName(existing.Mapping),
                            GetMappingName(accessor.Mapping)
                        )
                    );
                }
                ArrayMapping mapping = (ArrayMapping)accessor.Mapping;
                ArrayMapping existingMapping = mapping.IsAnonymousType
                    ? null
                    : (ArrayMapping)types[existing.Mapping.TypeName, existing.Mapping.Namespace];
            ...
            if (accessor is AttributeAccessor)
                throw new InvalidOperationException(
                    Res.GetString(
                        Res.XmlCannotReconcileAttributeAccessor,
                        accessor.Name,
                        accessor.Namespace,
                        GetMappingName(existing.Mapping),
                        GetMappingName(accessor.Mapping)
        ...
        Exception CreateTypeReflectionException(string context, Exception e)
        {
            return new InvalidOperationException(
                Res.GetString(Res.XmlTypeReflectionError, context),
                e
            );
        }
        ...
        Exception CreateMemberReflectionException(FieldModel model, Exception e)
        {
            return new InvalidOperationException(
                Res.GetString(
                    model.IsProperty ? Res.XmlPropertyReflectionError : Res.XmlFieldReflectionError,
                    model.Name
                ),
                e
            );
            ...
            try
            {
                if (dataType.Length > 0)
                {
                    ...
                    if (td == null)
                    {
                        throw new InvalidOperationException(
                            Res.GetString(
                                Res.XmlInvalidXsdDataType,
                                dataType,
                                "XmlElementAttribute.DataType",
                                new XmlQualifiedName(dataType, XmlSchema.Namespace).ToString()
                            )
                        );
                    }
                    if (modelTypeDesc.FullName != td.FullName)
                    {
                        throw new InvalidOperationException(
                            Res.GetString(
                                Res.XmlDataTypeMismatch,
                                dataType,
                                "XmlElementAttribute.DataType",
                                modelTypeDesc.FullName
                            )
                        );
                    }
                }
                ...
                if ((a.XmlFlags & ~(XmlAttributeFlags.Type | XmlAttributeFlags.Root)) != 0)
                    throw new InvalidOperationException(
                        Res.GetString(Res.XmlInvalidTypeAttributes, model.Type.FullName)
                    );
                        ...
                        if (model.TypeDesc.IsOptionalValue)
                        {
                            ...
                            if (baseMapping == null)
                                baseMapping = ImportTypeMapping(
                                    modelScope.GetTypeModel(model.TypeDesc.BaseTypeDesc.Type),
                                    ns,
                                    context,
                                    dataType,
                                    null,
        ...
        )
        {
            ...
            if (!CodeGenerator.IsValidLanguageIndependentIdentifier(provider.MethodName))
                throw new ArgumentException(
                    Res.GetString(Res.XmlGetSchemaMethodName, provider.MethodName),
                    "MethodName"
                );
            ...
            if (
                !(typeof(XmlQualifiedName).IsAssignableFrom(getMethod.ReturnType))
                && !(typeof(XmlSchemaType).IsAssignableFrom(getMethod.ReturnType))
            )
                throw new InvalidOperationException(
                    Res.GetString(
        ...
        SpecialMapping ImportSpecialMapping(
            Type type,
            TypeDesc typeDesc,
            string ns,
            ImportContext context,
        ...
        internal void SetBase(SerializableMapping mapping, XmlQualifiedName baseQname)
        {
            if (baseQname.IsEmpty)
                return;
            if (baseQname.Namespace == XmlSchema.Namespace)
                return;
            ...
            {
                throw new InvalidOperationException(
                    Res.GetString(Res.XmlMissingSchema, baseQname.Namespace)
                );
            }
        ...
        {
            return new InvalidOperationException(
                Res.GetString(Res.XmlInvalidAttributeUse, type.FullName)
            );
        }
        ...
        {
            return new InvalidOperationException(
                Res.GetString(Res.XmlIllegalTypeContext, typeDesc.FullName, GetContextName(context))
            );
        }
            ...
            if (existingMapping != null)
            {
                if (existingMapping is NullableMapping)
                {
                    ...
                    else
                    {
                        throw new InvalidOperationException(
                            Res.GetString(
                                Res.XmlTypesDuplicate,
                                typeDesc.FullName,
                                existingMapping.TypeDesc.FullName,
                                typeDesc.Name,
        ...
        )
        {
            ...
            if (model.TypeDesc.BaseTypeDesc != null)
            {
                ...
                if (!(baseModel is StructModel))
                {
                    ...
                    throw new NotSupportedException(
                        Res.GetString(Res.XmlUnsupportedInheritance, model.Type.BaseType.FullName)
                    );
                }
                StructMapping baseMapping = ImportStructLikeMapping(
                    (StructModel)baseModel,
                    mapping.Namespace,
                    openModel,
                    null,
                    limiter
                ...
                else
                {
                    ...
                    if (baseIndex < top)
                    {
                        ImportStructWorkItem baseMappingWorkItem = limiter.DeferredWorkItems[
                            baseIndex
                        ];
            ...
            foreach (MemberInfo memberInfo in model.GetMemberInfos())
            {
                ...
                try
                {
                    MemberMapping member = ImportFieldMapping(
                        model,
                        fieldModel,
                        memberAttrs,
                        mapping.Namespace,
                    ...
                    {
                        if (
                            !member.Text.Mapping.TypeDesc.CanBeTextValue
                        ...
                        {
                            throw new InvalidOperationException(
                                Res.GetString(Res.XmlIllegalMultipleText, model.Type.FullName)
                            );
                        }
                    ...
                    if (member.Xmlns != null)
                    {
                        if (mapping.XmlnsMember != null)
                            throw new InvalidOperationException(
                                Res.GetString(Res.XmlMultipleXmlns, model.Type.FullName)
                            );
                ...
                for (int i = 0; i < members.Count; i++)
                {
                    ...
                    if (member.IsSequence)
                    {
                        if (ids[member.SequenceId] != null)
                        {
                            throw new InvalidOperationException(
                                Res.GetString(
                                    Res.XmlSequenceUnique,
                                    member.SequenceId.ToString(CultureInfo.InvariantCulture),
                                    "Order",
                                    member.Name
                                )
                            );
                    ...
                    {
                        throw new InvalidOperationException(
                            Res.GetString(Res.XmlSequenceInconsistent, "Order", member.Name)
                        );
                    }
                }
        ...
        internal string XsdTypeName(Type type)
        {
            ...
            if (
                ...
                && typeDesc.DataType != null
                && typeDesc.DataType.Name != null
                && typeDesc.DataType.Name.Length > 0
            )
        ...
        void SetArrayMappingType(ArrayMapping mapping, string defaultNs, Type type)
        {
            ...
            {
                ns =
                    itemTypeMapping.Namespace == XmlSchema.Namespace
                        ? defaultNs
        ...
        ArrayMapping ImportArrayLikeMapping(ArrayModel model, string ns, RecursionLimiter limiter)
        {
            ...
            if (CountAtLevel(savedArrayItemAttributes, arrayNestingLevel) == 0)
                savedArrayItemAttributes.Add(
                    CreateArrayItemAttribute(
                        typeScope.GetTypeDesc(model.Element.Type),
                        arrayNestingLevel
                    )
                );
            CreateArrayElementsFromAttributes(
                ...
                model.Element.Type,
                savedArrayNamespace == null ? ns : savedArrayNamespace,
                limiter
            );
            ...
            {
                mapping.Elements[i] = ReconcileLocalAccessor(
                    mapping.Elements[i],
                    mapping.Namespace
                );
            }
        ...
        PrimitiveMapping ImportPrimitiveMapping(
            PrimitiveModel model,
            ImportContext context,
            string dataType,
            bool repeats
        )
        {
            ...
            if (dataType.Length > 0)
            {
                ...
                if (mapping.TypeDesc == null)
                {
                    ...
                    {
                        throw new InvalidOperationException(
                            Res.GetString(Res.XmlUdeclaredXsdType, dataType)
                        );
                    }
                }
            }
        ...
        EnumMapping ImportEnumMapping(EnumModel model, string ns, bool repeats)
        {
            ...
            if (mapping == null)
            {
                ...
                if (mapping.IsFlags && repeats)
                    throw new InvalidOperationException(
                        Res.GetString(Res.XmlIllegalAttributeFlagsArray, model.TypeDesc.FullName)
                    );
                mapping.IsList = repeats;
                ...
                {
                    throw new InvalidOperationException(
                        Res.GetString(Res.XmlNoSerializableMembers, model.TypeDesc.FullName)
                    );
                }
        ...
        MembersMapping ImportMembersMapping(
        ...
        )
        {
            ...
            for (int i = 0; i < mappings.Length; i++)
            {
                try
                {
                    MemberMapping mapping = ImportMemberMapping(
                        xmlReflectionMembers[i],
                        ns,
                    ...
                    if (!hasWrapperElement)
                    {
                        if (mapping.Attribute != null)
                        {
                            ...
                            {
                                throw new InvalidOperationException(
                                    Res.GetString(Res.XmlRpcLitAttributeAttributes)
                                );
                            }
                            else
                            {
                                throw new InvalidOperationException(
                                    Res.GetString(Res.XmlInvalidAttributeType, "XmlAttribute")
                                );
                            }
                        }
                    }
                    if (rpc && xmlReflectionMembers[i].IsReturnValue)
                    {
                        if (i > 0)
                            throw new InvalidOperationException(
                                Res.GetString(Res.XmlInvalidReturnPosition)
                            );
                    ...
                    if (mapping.Text != null)
                    {
                        ...
                        {
                            throw new InvalidOperationException(
                                Res.GetString(Res.XmlIllegalMultipleTextMembers)
                            );
                        }
                    ...
                    if (mapping.Xmlns != null)
                    {
                        if (members.XmlnsMember != null)
                            throw new InvalidOperationException(
                                Res.GetString(Res.XmlMultipleXmlnsMembers)
                            );
        ...
        MemberMapping ImportMemberMapping(
        ...
        )
        {
            ...
            if (a.XmlFlags == 0)
            {
                ...
                else
                {
                    ...
                    {
                        XmlAttributes structAttrs = new XmlAttributes(
            ...
            bool checkSpecified =
                FindSpecifiedMember(xmlReflectionMember.MemberName, xmlReflectionMembers) != null;
            FieldModel model = new FieldModel(
                xmlReflectionMember.MemberName,
                xmlReflectionMember.MemberType,
                typeScope.GetTypeDesc(xmlReflectionMember.MemberType),
                checkSpecified,
                false
            );
            ...
            {
                choiceIdentifierType = GetChoiceIdentifierType(
                    a.XmlChoiceIdentifier,
                    xmlReflectionMembers,
                    typeDesc.IsArrayLike,
                    model.Name
                );
            }
        ...
        )
        {
            ...
            if (a.XmlChoiceIdentifier != null)
            {
                choiceIdentifierType = GetChoiceIdentifierType(
                    a.XmlChoiceIdentifier,
                    parent,
                    model.FieldTypeDesc.IsArrayLike,
                    model.Name
                );
            }
            ImportAccessorMapping(
        ...
        Type CheckChoiceIdentifierType(
            Type type,
            bool isArrayLike,
        ...
        )
        {
            ...
            else if (isArrayLike)
            {
                ...
                throw new InvalidOperationException(
                    Res.GetString(
                        Res.XmlChoiceIdentifierArrayType,
                        identifierName,
                        memberName,
                        type.FullName
                    )
            ...
            if (!type.IsEnum)
            {
                ...
                throw new InvalidOperationException(
                    Res.GetString(Res.XmlChoiceIdentifierTypeEnum, identifierName)
                );
            }
            return type;
        }
        ...
        Type GetChoiceIdentifierType(
            XmlChoiceIdentifierAttribute choice,
            XmlReflectionMember[] xmlReflectionMembers,
            bool isArrayLike,
            string accessorName
        )
        {
            for (int i = 0; i < xmlReflectionMembers.Length; i++)
            {
                ...
                {
                    return CheckChoiceIdentifierType(
                        xmlReflectionMembers[i].MemberType,
                        isArrayLike,
                        choice.MemberName,
                        accessorName
                    );
            ...
            throw new InvalidOperationException(
                Res.GetString(Res.XmlChoiceIdentiferMemberMissing, choice.MemberName, accessorName)
            );
        }
        ...
        )
        {
            ...
            if (infos == null || infos.Length == 0)
            {
                ...
                if (info == null)
                {
                    ...
                    throw new InvalidOperationException(
                        Res.GetString(
                            Res.XmlChoiceIdentiferMemberMissing,
                            choice.MemberName,
                            accessorName
                        )
                    );
            ...
            else if (infos.Length > 1)
            {
                ...
                throw new InvalidOperationException(
                    Res.GetString(Res.XmlChoiceIdentiferAmbiguous, choice.MemberName)
                );
            }
            ...
            enumType = CheckChoiceIdentifierType(
                enumType,
                isArrayLike,
                choice.MemberName,
                accessorName
        ...
        )
        {
            ...
            for (int i = 0; attributes != null && i < attributes.Count; i++)
            {
                ...
                arrayItemElement.Name =
                    xmlArrayItem.ElementName.Length == 0
                        ? arrayItemElement.Mapping.DefaultElementName
                        : XmlConvert.EncodeLocalName(xmlArrayItem.ElementName);
                arrayItemElement.IsNullable = xmlArrayItem.IsNullableSpecified
                ...
                CheckNullable(
                    arrayItemElement.IsNullable,
                    targetTypeDesc,
                    arrayItemElement.Mapping
                );
        ...
        )
        {
            ...
            XmlAttributeFlags elemFlags =
                XmlAttributeFlags.Elements
                | XmlAttributeFlags.Text
                | XmlAttributeFlags.AnyElements
                | XmlAttributeFlags.ChoiceIdentifier;
            XmlAttributeFlags attrFlags =
            ...
            if (a.XmlChoiceIdentifier != null)
            {
                ...
                accessor.ChoiceIdentifier.Mapping = ImportTypeMapping(
                    modelScope.GetTypeModel(choiceIdentifierType),
                    ns,
                    ImportContext.Element,
                    String.Empty,
                    null,
            ...
            if (accessor.TypeDesc.IsArrayLike)
            {
                ...
                if ((flags & attrFlags) != 0)
                {
                    if ((flags & attrFlags) != flags)
                        throw new InvalidOperationException(
                            Res.GetString(Res.XmlIllegalAttributesArrayAttribute)
                        );
                    ...
                    )
                    {
                        if (accessor.TypeDesc.ArrayElementTypeDesc.Kind == TypeKind.Serializable)
                        {
                            throw new InvalidOperationException(
                                Res.GetString(
                                    Res.XmlIllegalAttrOrTextInterface,
                                    accessorName,
                    ...
                    Type targetType =
                        a.XmlAttribute.Type == null ? arrayElementType : a.XmlAttribute.Type;
                    TypeDesc targetTypeDesc = typeScope.GetTypeDesc(targetType);
                    ...
                    attribute.Mapping = ImportTypeMapping(
                        modelScope.GetTypeModel(targetType),
                        ns,
                        ImportContext.Attribute,
                        a.XmlAttribute.DataType,
                        null,
                        isList,
                        false,
                        limiter
                ...
                else if ((flags & elemFlags) != 0)
                {
                    if ((flags & elemFlags) != flags)
                        throw new InvalidOperationException(
                            Res.GetString(Res.XmlIllegalElementsArrayAttribute)
                        );
                    ...
                    if (a.XmlText != null)
                    {
                        ...
                        Type targetType =
                            a.XmlText.Type == null ? arrayElementType : a.XmlText.Type;
                        TypeDesc targetTypeDesc = typeScope.GetTypeDesc(targetType);
                        ...
                        if (
                            !(text.Mapping is SpecialMapping)
                            && targetTypeDesc != typeScope.GetTypeDesc(typeof(string))
                        )
                            throw new InvalidOperationException(
                                Res.GetString(Res.XmlIllegalArrayTextAttribute, accessorName)
                            );
                    ...
                    for (int i = 0; i < a.XmlElements.Count; i++)
                    {
                        ...
                        Type targetType =
                            xmlElement.Type == null ? arrayElementType : xmlElement.Type;
                        TypeDesc targetTypeDesc = typeScope.GetTypeDesc(targetType);
                        TypeModel typeModel = modelScope.GetTypeModel(targetType);
                        ElementAccessor element = new ElementAccessor();
                        element.Namespace =
                            rpc ? null
                            : xmlElement.Namespace == null ? ns
                        ...
                        else
                        {
                            element.Name =
                                xmlElement.ElementName.Length == 0
                                    ...
                                    : XmlConvert.EncodeLocalName(xmlElement.ElementName);
                        }
                        element.Default = GetDefaultValue(model.FieldTypeDesc, model.FieldType, a);
                        if (
                            xmlElement.IsNullableSpecified
                        ...
                        element.IsNullable = xmlElement.IsNullableSpecified
                            ? xmlElement.IsNullable
                            : typeModel.TypeDesc.IsOptionalValue;
                        element.Form =
                        ...
                        if (xmlElement.Order != -1)
                        {
                            if (xmlElement.Order != sequenceId && sequenceId != -1)
                                throw new InvalidOperationException(
                                    Res.GetString(Res.XmlSequenceMatch, "Order")
                                );
                    ...
                    for (int i = 0; i < a.XmlAnyElements.Count; i++)
                    {
                        ...
                        if (!arrayElementType.IsAssignableFrom(targetType))
                            throw new InvalidOperationException(
                                Res.GetString(Res.XmlIllegalAnyElement, arrayElementType.FullName)
                            );
                        string anyName =
                            xmlAnyElement.Name.Length == 0
                                ? xmlAnyElement.Name
                                : XmlConvert.EncodeLocalName(xmlAnyElement.Name);
                        string anyNs = xmlAnyElement.NamespaceSpecified
                ...
                else
                {
                    if ((flags & arrayFlags) != 0)
                    {
                        if ((flags & arrayFlags) != flags)
                            throw new InvalidOperationException(
                                Res.GetString(Res.XmlIllegalArrayArrayAttribute)
                            );
                    }
            ...
            {
                XmlAttributeFlags allFlags =
                    XmlAttributeFlags.Elements
                    | XmlAttributeFlags.Text
                    | XmlAttributeFlags.Attribute
                    | XmlAttributeFlags.AnyElements
                    | XmlAttributeFlags.ChoiceIdentifier
                ...
                if (accessor.TypeDesc.IsPrimitive || accessor.TypeDesc.IsEnum)
                {
                    if (a.XmlAnyElements.Count > 0)
                        throw new InvalidOperationException(
                            Res.GetString(Res.XmlIllegalAnyElement, accessor.TypeDesc.FullName)
                        );
                    ...
                    if (a.XmlAttribute != null)
                    {
                        if (a.XmlElements.Count > 0)
                            throw new InvalidOperationException(
                                Res.GetString(Res.XmlIllegalAttribute)
                            );
                        if (a.XmlAttribute.Type != null)
                            throw new InvalidOperationException(
                                Res.GetString(Res.XmlIllegalType, "XmlAttribute")
                            );
                        AttributeAccessor attribute = new AttributeAccessor();
                        attribute.Name = Accessor.EscapeQName(
                            a.XmlAttribute.AttributeName.Length == 0
                        ...
                        CheckForm(attribute.Form, ns != attribute.Namespace);
                        attribute.Mapping = ImportTypeMapping(
                            modelScope.GetTypeModel(accessorType),
                            ns,
                            ImportContext.Attribute,
                            a.XmlAttribute.DataType,
                            null,
                        ...
                        attribute.Default = GetDefaultValue(
                            model.FieldTypeDesc,
                            model.FieldType,
                            a
                        );
                    ...
                    else
                    {
                        if (a.XmlText != null)
                        {
                            if (a.XmlText.Type != null && a.XmlText.Type != accessorType)
                                throw new InvalidOperationException(
                                    Res.GetString(Res.XmlIllegalType, "XmlText")
                                );
                            TextAccessor text = new TextAccessor();
                            text.Name = accessorName; // unused except to make more helpful error messages
                            text.Mapping = ImportTypeMapping(
                        ...
                        for (int i = 0; i < a.XmlElements.Count; i++)
                        {
                            ...
                            if (xmlElement.Type != null)
                            {
                                if (typeScope.GetTypeDesc(xmlElement.Type) != accessor.TypeDesc)
                                    throw new InvalidOperationException(
                                        Res.GetString(Res.XmlIllegalType, "XmlElement")
                                    );
                            }
                            ElementAccessor element = new ElementAccessor();
                            element.Name = XmlConvert.EncodeLocalName(
                            ...
                            element.Default = GetDefaultValue(
                                model.FieldTypeDesc,
                                model.FieldType,
                                a
                            );
                ...
                else if (a.Xmlns)
                {
                    if (flags != XmlAttributeFlags.XmlnsDeclarations)
                        throw new InvalidOperationException(
                            Res.GetString(Res.XmlSoleXmlnsAttribute)
                        );
                ...
                else
                {
                    ...
                    for (int i = 0; i < a.XmlAnyElements.Count; i++)
                    {
                        ...
                        if (!accessorType.IsAssignableFrom(targetType))
                            throw new InvalidOperationException(
                                Res.GetString(Res.XmlIllegalAnyElement, accessorType.FullName)
                            );
            ...
            {
                if (
                    accessor.TypeDesc.IsArrayLike
                    && accessor.Elements.Length > 0
                    && !(accessor.Elements[0].Mapping is ArrayMapping)
                )
                    throw new InvalidOperationException(
                        Res.GetString(Res.XmlRpcLitArrayElement, accessor.Elements[0].Name)
                    );

                if (accessor.Xmlns != null)
                    throw new InvalidOperationException(
                        Res.GetString(Res.XmlRpcLitXmlns, accessor.Name)
                    );
            }
            ...
            if (accessor.ChoiceIdentifier != null)
            {
                ...
                for (int i = 0; i < accessor.Elements.Length; i++)
                {
                    ...
                    if (!found)
                    {
                        ...
                        {
                            string id =
                                element.Namespace != null && element.Namespace.Length > 0
        ...
        void CheckTopLevelAttributes(XmlAttributes a, string accessorName)
        {
            ...
            if (a.XmlElements != null && a.XmlElements.Count > 0)
            {
                ...
                {
                    throw new InvalidOperationException(
                        Res.GetString(Res.XmlRpcLitElementNullable, "IsNullable", "true")
                    );
                }
            }
            ...
            {
                throw new InvalidOperationException(
                    Res.GetString(Res.XmlRpcLitElementNamespace, "Namespace", a.XmlArray.Namespace)
                );
            }
        }
            ...
            if (items != null && items.Count >= 2)
            {
                ...
                for (int i = 0; i < items.Count; i++)
                {
                    ...
                    if (item != null)
                    {
                        throw new InvalidOperationException(
                            Res.GetString(
                                Res.XmlArrayItemAmbiguousTypes,
                                accessorName,
                                item.ElementName,
                                items[i].ElementName,
        ...
        void CheckChoiceIdentifierMapping(EnumMapping choiceMapping)
        {
            ...
            for (int i = 0; i < choiceMapping.Constants.Length; i++)
            {
                ...
                if (ids[choiceName, choiceNs] != null)
                {
                    ...
                    throw new InvalidOperationException(
                        Res.GetString(Res.XmlChoiceIdDuplicate, choiceMapping.TypeName, choiceId)
                    );
                }
        ...
        static void CheckForm(XmlSchemaForm form, bool isQualified)
        {
            if (isQualified && form == XmlSchemaForm.Unqualified)
                throw new InvalidOperationException(Res.GetString(Res.XmlInvalidFormUnqualified));
        }
        ...
        static void CheckNullable(bool isNullable, TypeDesc typeDesc, TypeMapping mapping)
        {
            ...
            if (isNullable && !typeDesc.IsNullable)
                throw new InvalidOperationException(
                    Res.GetString(Res.XmlInvalidIsNullable, typeDesc.FullName)
                );
        }
    ...
    internal class WorkItems
    {
        ...
        {
            get { return (ImportStructWorkItem)list[index]; }
    ...
    internal class RecursionLimiter
    {
        ...
        {
            get { return this.depth > this.maxDepth; }
        }
        internal int Depth
        {
