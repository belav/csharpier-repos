...
namespace System.Xml.Serialization.Configuration
{
    ...
    public sealed class DateTimeSerializationSection : ConfigurationSection
    {
        ...
        [ConfigurationProperty(
            ...
            DefaultValue = DateTimeSerializationMode.Roundtrip
        )]
        ...
        readonly ConfigurationProperty mode = new ConfigurationProperty(
            ConfigurationStrings.Mode,
            typeof(DateTimeSerializationMode),
            DateTimeSerializationMode.Roundtrip,
            new EnumConverter(typeof(DateTimeSerializationMode)),
            null,
