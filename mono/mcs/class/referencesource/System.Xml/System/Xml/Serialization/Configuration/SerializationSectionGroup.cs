...
namespace System.Xml.Serialization.Configuration
{
    ...
    public sealed class SerializationSectionGroup : ConfigurationSectionGroup
    {
        ...
        public SchemaImporterExtensionsSection SchemaImporterExtensions
        {
            get
            {
                return (SchemaImporterExtensionsSection)
                    Sections[ConfigurationStrings.SchemaImporterExtensionsSectionName];
            }
        }
        ...
        public DateTimeSerializationSection DateTimeSerialization
        {
            get
            {
                return (DateTimeSerializationSection)
                    Sections[ConfigurationStrings.DateTimeSerializationSectionName];
            }
        }
        ...
        public XmlSerializerSection XmlSerializer
        {
            get
            {
                return (XmlSerializerSection)
                    Sections[ConfigurationStrings.XmlSerializerSectionName];
            }
        }
    }
}
