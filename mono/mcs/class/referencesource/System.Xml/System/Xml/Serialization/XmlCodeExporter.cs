    ...
    public class XmlCodeExporter : CodeExporter
    {
                ...
                if (mapping.Xmlns == null)
                {
                    if (mapping.Attribute != null)
                    {
                        ExportType(
                            ...
                            Accessor.UnescapeName(mapping.Attribute.Name),
                            mapping.Attribute.Namespace,
                            null,
                            false
                        );
                    }
                    if (mapping.Elements != null)
                    {
                        for (int j = 0; j < mapping.Elements.Length; j++)
                        {
                            ...
                            ExportType(
                                element.Mapping,
                                Accessor.UnescapeName(element.Name),
                                element.Namespace,
                                null,
                                false
                            );
                    ...
                    if (mapping.Text != null)
                    {
                        ExportType(
                            ...
                            Accessor.UnescapeName(mapping.Text.Name),
        ...
        )
        {
            ...
            if (
                ...
                && checkReference
                && ((StructMapping)mapping).ReferencedByTopLevelElement
                && rootElement == null
            )
                return;
            ...
            if (
                ...
                && rootElement != null
                && rootElement.IsTopLevelInSchema
            ...
            if (ExportedMappings[mapping] == null)
            {
                ...
                {
                    codeClass = mapping.TypeDesc.ExtendedType.ExportTypeDefinition(
                        CodeNamespace,
                        CodeCompileUnit
                    );
                }
                ...
                if (codeClass != null)
                {
                    if (!mapping.TypeDesc.IsMappedType)
                    {
                        ...
                        AddTypeMetadata(
                            ...
                            Accessor.UnescapeName(mapping.TypeName),
                            mapping.Namespace,
        ...
        )
        {
            ...
            if (typeMapping.TypeDesc != null && typeMapping.TypeDesc.IsAmbiguousDataType)
            {
                attribute.Arguments.Add(
                    new CodeAttributeArgument(
                        "DataType",
                        new CodePrimitiveExpression(typeMapping.TypeDesc.DataType.Name)
                    )
                );
            }
            if ((object)(rootElement.IsNullable) != null)
            {
                attribute.Arguments.Add(
                    new CodeAttributeArgument(
                        "IsNullable",
                        new CodePrimitiveExpression((bool)rootElement.IsNullable)
                    )
                );
            }
        ...
        CodeAttributeArgument[] GetDefaultValueArguments(
            PrimitiveMapping mapping,
            object value,
            out CodeExpression initExpression
        )
        {
            initExpression = null;
            if (value == null)
                ...
                if (((EnumMapping)mapping).IsFlags)
                {
                    ...
                    for (int i = 0; i < values.Length; i++)
                    {
                        if (values[i].Length == 0)
                            continue;
                        CodeExpression enumRef = new CodeFieldReferenceExpression(
                            new CodeTypeReferenceExpression(mapping.TypeDesc.FullName),
                            values[i]
                        );
                        if (valueExpression != null)
                            valueExpression = new CodeBinaryOperatorExpression(
                                valueExpression,
        ...
        object ImportDefaultValue(TypeMapping mapping, string defaultValue)
        {
            ...
            if (mapping is EnumMapping)
            {
                ...
                throw new InvalidOperationException(
                    Res.GetString(Res.XmlInvalidDefaultValue, defaultValue, em.TypeDesc.FullName)
                );
            }
            ...
            if (!pm.TypeDesc.HasCustomFormatter)
            {
                ...
                MethodInfo format = formatter.GetMethod(
                    "To" + pm.TypeDesc.FormatterName,
...
#if DEBUG
                Debug.WriteLineIf(
                    DiagnosticsSwitches.XmlSerialization.TraceVerbose,
                    "XmlSerialization::Failed to GetMethod "
                        + formatter.Name
                        + ".To"
                        + pm.TypeDesc.FormatterName
                );
#endif
            }
            else
            {
                ...
                {
                    return XmlCustomFormatter.ToDefaultValue(
                        defaultValue,
                        pm.TypeDesc.FormatterName
                    );
                }
        ...
        )
        {
            ...
            if (memberTypeDesc.IsArrayLike && accessor is ElementAccessor)
            {
                if (comments != null && defaultValue is string)
                {
                    ...
                    AddWarningComment(
                        comments,
                        Res.GetString(
                            Res.XmlDropArrayAttributeValue,
                            attributeName,
                            defaultValue.ToString(),
            ...
            if (mapping.TypeDesc.IsMappedType && field != null && defaultValue is string)
            {
                ...
                CodeExpression init = extension.ImportDefaultValue(
                    (string)defaultValue,
                ...
                if (init != null)
                {
                    ...
                    {
                        field.InitExpression = extension.ImportDefaultValue(
                            (string)defaultValue,
                            mapping.TypeDesc.FullName
                        );
                    }
            ...
            if (!(mapping is PrimitiveMapping))
            {
                if (comments != null)
                {
                    ...
                    AddWarningComment(
                        comments,
                        Res.GetString(
                            Res.XmlDropNonPrimitiveAttributeValue,
                            attributeName,
                            defaultValue.ToString()
                        )
                    );
        ...
        static void AddInitializationStatement(
            CodeConstructor ctor,
            CodeMemberField field,
            CodeExpression init
        )
        ...
        CodeTypeDeclaration ExportStruct(StructMapping mapping)
        {
            ...
            string baseName =
                mapping.TypeDesc.BaseTypeDesc == null || mapping.TypeDesc.BaseTypeDesc.IsRoot
                    ? string.Empty
                    : mapping.TypeDesc.BaseTypeDesc.FullName;
            ...
            ctor.Attributes =
                (ctor.Attributes & ~MemberAttributes.AccessMask) | MemberAttributes.Public;
        ...
        )
        {
            ...
            AddRootMetadata(
                metadata,
                mapping.Mapping,
                Accessor.UnescapeName(mapping.Accessor.Name),
        ...
        )
        {
            for (int i = 0; i < array.Elements.Length; i++)
            {
                ...
                bool sameName = arrayElement.Mapping.TypeDesc.IsArray
                    ? false
                    : elementName == arrayElement.Mapping.TypeName;
                bool sameElementType = elementMapping.TypeDesc == elementTypeDesc;
                bool sameElementNs =
                    arrayElement.Form == XmlSchemaForm.Unqualified || arrayElement.Namespace == ns;
                ...
                if (
                    ...
                    ExportArrayItem(
                        metadata,
                        sameName ? null : elementName,
                        sameElementNs ? null : arrayElement.Namespace,
                        sameElementType ? null : elementMapping.TypeDesc,
                        elementMapping.TypeDesc,
                        arrayElement.IsNullable,
                        defaultForm ? XmlSchemaForm.None : arrayElement.Form,
                        nestingLevel
                    );
                if (elementMapping is ArrayMapping)
                    ExportArrayElements(
                        ...
                        ns,
                        elementTypeDesc.ArrayElementTypeDesc,
                        nestingLevel + 1
                    );
            }
        }
        ...
        )
        {
            ...
            else if (member.Attribute != null)
            {
                ...
                else
                {
                    ...
                    bool sameType =
                        mapping.TypeDesc == member.TypeDesc
                        || (
                            member.TypeDesc.IsArrayLike
            ...
            else
            {
                if (member.Text != null)
                {
                    ...
                    ExportText(
                        metadata,
                        sameType ? null : mapping.TypeDesc,
                        mapping.TypeDesc.IsAmbiguousDataType ? mapping.TypeDesc.DataType.Name : null
                    );
                }
                if (member.Elements.Length == 1)
                {
                    ...
                    else if (isArray)
                    {
                        ...
                        if (
                            ...
                            ExportArray(
                                metadata,
                                sameName ? null : elemName,
                                sameNs ? null : element.Namespace,
                                element.IsNullable,
                                defaultForm ? XmlSchemaForm.None : element.Form,
                                member.SequenceId
                            );
                        else if (
                            mapping.TypeDesc.ArrayElementTypeDesc
                    ...
                    for (int i = 0; i < member.Elements.Length; i++)
                    {
                        ...
                        else
                        {
                            ...
                            ExportElement(
                                ...
                                elemName,
                                sameNs ? null : element.Namespace,
                                ((TypeMapping)element.Mapping).TypeDesc,
                                ((TypeMapping)element.Mapping).TypeDesc,
                                element.IsNullable,
                                defaultForm ? XmlSchemaForm.None : element.Form,
                                member.SequenceId
        ...
        )
        {
            ...
            field.Attributes =
                (field.Attributes & ~MemberAttributes.AccessMask) | MemberAttributes.Public;
        ...
        )
        {
            ...
            if (member.CheckSpecified != SpecifiedAccessor.None)
            {
                ...
                prop = CreatePropertyDeclaration(
                    field,
        ...
        )
        {
                ...
                attribute.Arguments.Add(
                    new CodeAttributeArgument(
                        ...
                        new CodeFieldReferenceExpression(
                            new CodeTypeReferenceExpression(typeof(XmlSchemaForm).FullName),
                            Enum.Format(typeof(XmlSchemaForm), form, "G")
                        )
                    )
                );
            ...
            if (
                dataTypeDesc != null
                && dataTypeDesc.IsAmbiguousDataType
            ...
            )
            {
                attribute.Arguments.Add(
                    new CodeAttributeArgument(
                        "DataType",
                        new CodePrimitiveExpression(dataTypeDesc.DataType.Name)
                    )
                );
            }
            if (isNullable != null)
            {
                attribute.Arguments.Add(
                    new CodeAttributeArgument(
                        "IsNullable",
                        new CodePrimitiveExpression((bool)isNullable)
                    )
                );
            }
            if (nestingLevel > 0)
            {
                attribute.Arguments.Add(
                    new CodeAttributeArgument(
                        "NestingLevel",
                        new CodePrimitiveExpression(nestingLevel)
                    )
                );
            }
            if (sequenceId >= 0)
