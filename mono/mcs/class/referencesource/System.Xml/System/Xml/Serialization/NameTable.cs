...
namespace System.Xml.Serialization
{
    ...
    internal class NameKey
    {
        ...
        {
            return (ns == null ? "<null>".GetHashCode() : ns.GetHashCode())
    ...
    internal class NameTable : INameScope
    {
        ...
        {
            get { return table[new NameKey(qname.Name, qname.Namespace)]; }
            set { table[new NameKey(qname.Name, qname.Namespace)] = value; }
        }
        internal object this[string name, string ns]
        {
            get { return table[new NameKey(name, ns)]; }
            set { table[new NameKey(name, ns)] = value; }
        }
