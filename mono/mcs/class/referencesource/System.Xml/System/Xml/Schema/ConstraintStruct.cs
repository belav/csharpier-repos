...
namespace System.Xml.Schema
{
            ...
            switch (xsdtype.TypeCode)
            {
                ...
                case XmlTypeCode.NonPositiveInteger:
                    ...
                    if (this.isList)
                    {
                        ...
                        {
                            this.dstruct.Dvalue[i] = Convert.ToDecimal(
                                ((Array)this.ovalue).GetValue(i),
                    ...
                    { //not list
                        ...
                        this.dstruct.Dvalue[0] = Convert.ToDecimal(
                            this.ovalue,
                            NumberFormatInfo.InvariantInfo
                        );
                    }
            ...
            if (this.IsList)
            {
                ...
                { //this is a list and other is a single value
                    ...
                    { // this is a list of union
                        return atomicValues1.Length == 1
                            && atomicValues1.GetValue(0).Equals(other.Value);
                    }
                    else
                    {
    ...
    internal class KeySequence
    {
        ...
        public object this[int index]
        {
            ...
            set { ks[index] = (TypedObject)value; }
        }
