...
namespace System.Xml.Schema
{
    ...
    internal sealed class Preprocessor : BaseProcessor
    {
        ...
        const XmlSchemaDerivationMethod elementBlockAllowed =
            XmlSchemaDerivationMethod.Restriction
            | XmlSchemaDerivationMethod.Extension
            | XmlSchemaDerivationMethod.Substitution;
        const XmlSchemaDerivationMethod elementFinalAllowed =
            XmlSchemaDerivationMethod.Restriction | XmlSchemaDerivationMethod.Extension;
        const XmlSchemaDerivationMethod simpleTypeFinalAllowed =
            XmlSchemaDerivationMethod.Restriction
            | XmlSchemaDerivationMethod.Extension
            | XmlSchemaDerivationMethod.List
            | XmlSchemaDerivationMethod.Union;
        const XmlSchemaDerivationMethod complexTypeBlockAllowed =
            XmlSchemaDerivationMethod.Restriction | XmlSchemaDerivationMethod.Extension;
        const XmlSchemaDerivationMethod complexTypeFinalAllowed =
            XmlSchemaDerivationMethod.Restriction | XmlSchemaDerivationMethod.Extension;
...
#pragma warning restore 0618
                    ...
                    if (schemaLocation != null)
                    {
                        SendValidationEvent(
                            new XmlSchemaException(
                                Res.Sch_InvalidIncludeLocation,
                                null,
                                innerException,
                                include.SourceUri,
                                include.LineNumber,
                ...
                { // Only if location already not processed
                    ...
                    if (obj != null)
                    {
                        ...
                        else
                        {
                            ...
                            {
                                SendValidationEvent(
                                    Res.Sch_CannotLoadSchemaLocation,
                                    schemaLocation,
                                    e.Message,
                                    e.SourceUri,
                                    e.LineNumber,
        ...
        private void Preprocess(XmlSchema schema, string targetNamespace, ArrayList imports)
        {
            ...
            if (schema.Version != null)
            {
                ...
                {
                    SendValidationEvent(
                        Res.Sch_AttributeValueDataTypeDetailed,
                        new string[]
                        {
                            "version",
                            schema.Version,
                            tokenDt.TypeCodeString,
                            exception.Message,
                        },
                        exception,
                        schema
            ...
            for (int i = 0; i < schema.Includes.Count; ++i)
            {
                ...
                if (loc != null)
                {
                    ...
                    (
                        include.Compositor == Compositor.Include
                ...
                switch (include.Compositor)
                {
                    case Compositor.Import:
                        ...
                        if (externalSchema != null)
                        {
                            ...
                            {
                                SendValidationEvent(
                                    Res.Sch_MismatchTargetNamespaceImport,
                                    importNS,
                                    externalSchema.TargetNamespace,
                                    import
                                );
                            }
                        ...
                        else
                        {
                            if (importNS != null)
                            {
                                ...
                                {
                                    SendValidationEvent(
                                        Res.Sch_InvalidNamespaceAttribute,
                                        importNS,
                                        include
                                    );
                                }
                    ...
                    default: //For include, redefine common case
                        if (externalSchema.TargetNamespace != null)
                        {
                            ...
                            { //namespaces for includes should be the same
                                SendValidationEvent(
                                    Res.Sch_MismatchTargetNamespaceInclude,
                                    externalSchema.TargetNamespace,
                    ...
                    switch (external.Compositor)
                    {
                        ...
                        case Compositor.Import:
                            if (includedSchema != rootSchema)
                            {
                                ...
                                string importNS =
                                    import.Namespace != null ? import.Namespace : string.Empty;
        ...
        private void PreprocessRedefine(RedefineEntry redefineEntry)
        {
            ...
            string targetNS =
                schemaToUpdate.TargetNamespace == null
                    ? string.Empty
                    : schemaToUpdate.TargetNamespace;
                    ...
                    else
                    {
                        ...
                        )
                        {
                            SendValidationEvent(
                                Res.Sch_ComponentRedefineNotFound,
                                "<attributeGroup>",
                                attributeGroup.QualifiedName.ToString(),
                                attributeGroup
                            );
                        }
                        else
                    ...
                    else
                    {
                        ...
                        )
                        {
                            SendValidationEvent(
                                Res.Sch_ComponentRedefineNotFound,
                                "<complexType>",
                                complexType.QualifiedName.ToString(),
                                complexType
                            );
                        }
                    ...
                    else
                    {
                        ...
                        )
                        {
                            SendValidationEvent(
                                Res.Sch_ComponentRedefineNotFound,
                                "<simpleType>",
                                simpleType.QualifiedName.ToString(),
                                simpleType
                            );
                        }
            ...
            for (int i = 0; i < items.Count; ++i)
            {
                ...
                else if (items[i] is XmlSchemaGroupBase)
                {
                    count += CountGroupSelfReference(
                        ((XmlSchemaGroupBase)items[i]).Items,
                        name,
                        redefined
                    );
                }
        ...
        private void CheckRefinedAttributeGroup(XmlSchemaAttributeGroup attributeGroup)
        {
            ...
            for (int i = 0; i < attributeGroup.Attributes.Count; ++i)
            {
                XmlSchemaAttributeGroupRef attrGroupRef =
                    attributeGroup.Attributes[i] as XmlSchemaAttributeGroupRef;
        ...
        private void PreprocessLocalAttribute(XmlSchemaAttribute attribute)
        {
                    ...
                    new XmlQualifiedName(
                        ...
                        (
                            ...
                            || (
                                ...
                                && this.attributeFormDefault == XmlSchemaForm.Qualified
                            )
                        )
            ...
            { // ref
                ...
                if (
                    !attribute.SchemaTypeName.IsEmpty
        ...
        private void PreprocessAttributeGroup(XmlSchemaAttributeGroup attributeGroup)
        {
            if (attributeGroup.Name != null)
            {
                ...
                attributeGroup.SetQualifiedName(
                    new XmlQualifiedName(attributeGroup.Name, this.targetNamespace)
                );
            }
            else
            {
                    ...
                    new XmlQualifiedName(
                        ...
                        (
                            ...
                            || (
                                ...
                                && this.elementFormDefault == XmlSchemaForm.Qualified
                            )
                        )
                            ? this.targetNamespace
                            : null
        ...
        private void PreprocessIdentityConstraint(XmlSchemaIdentityConstraint constraint)
        {
            ...
            {
                SendValidationEvent(
                    Res.Sch_DupIdentityConstraint,
                    constraint.QualifiedName.ToString(),
                    constraint
                );
                valid = false;
            }
            ...
            if (complexType.ContentModel != null)
            {
                ...
                if (complexType.ContentModel is XmlSchemaSimpleContent)
                {
                    ...
                    if (content.Content == null)
                    {
                        ...
                        else
                        {
                            SendValidationEvent(
                                ...
                                complexType.QualifiedName.Namespace,
                                complexType
                            );
                        }
                    }
                    else
                    {
                        ...
                        {
                            XmlSchemaSimpleContentExtension contentExtension =
                                (XmlSchemaSimpleContentExtension)content.Content;
                            if (contentExtension.BaseTypeName.IsEmpty)
                            {
                                SendValidationEvent(
                                    Res.Sch_MissAttribute,
                                    "base",
                                    contentExtension
                                );
                            }
                            ...
                            PreprocessAttributes(
                                contentExtension.Attributes,
                                contentExtension.AnyAttribute,
                                contentExtension
                            );
                        ...
                        { //XmlSchemaSimpleContentRestriction
                            ...
                            PreprocessAttributes(
                                contentRestriction.Attributes,
                                contentRestriction.AnyAttribute,
                                contentRestriction
                            );
        ...
        private void PreprocessNotation(XmlSchemaNotation notation)
        {
            ...
            else
            {
                if (notation.Public != null)
                {
                    ...
                    {
                        SendValidationEvent(
                            Res.Sch_InvalidPublicAttribute,
                            new string[] { notation.Public },
                            eInner,
                            notation
                        );
                    }
        ...
        private void PreprocessParticle(XmlSchemaParticle particle)
        {
            ...
            else
            {
                ...
                else if (particle is XmlSchemaAny)
                {
                    ...
                    {
                        SendValidationEvent(
                            Res.Sch_InvalidAnyDetailed,
                            new string[] { fe.Message },
                            fe,
                            particle
                        );
                    }
        ...
        private void ValidateIdAttribute(XmlSchemaObject xso)
        {
            if (xso.IdAttribute != null)
            {
                ...
                catch (ArgumentNullException)
                {
                    SendValidationEvent(
                        Res.Sch_InvalidIdAttribute,
                        Res.GetString(Res.Sch_NullValue),
                        xso
                    );
                    return;
                }
        ...
        private void ValidateNameAttribute(XmlSchemaObject xso)
        {
            ...
            {
                SendValidationEvent(
                    Res.Sch_InvalidNameAttributeEx,
                    null,
                    Res.GetString(Res.Sch_NullValue),
                    xso
                );
            ...
            { // If the string is not a valid NCName, then throw or return false
                ...
                string innerStr = Res.GetString(
                    Res.Xml_BadNameCharWithPos,
                    invCharArgs[0],
                    invCharArgs[1],
                    len
                );
        ...
        private void ValidateQNameAttribute(
            XmlSchemaObject xso,
        ...
        )
        {
            ...
            catch (XmlException ex)
            {
                SendValidationEvent(
                    Res.Sch_InvalidAttribute,
                    new string[] { attributeName, ex.Message },
                    ex,
                    xso
                );
            }
