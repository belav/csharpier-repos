    ...
    internal abstract class FacetsChecker
    {
        private struct FacetsCompiler
        {
            ...
            )
            {
                ...
                nonNegativeInt = DatatypeImplementation
                    .GetSimpleTypeFromTypeCode(XmlTypeCode.NonNegativeInteger)
                    .Datatype;
                builtInEnum = !(datatype is Datatype_union || datatype is Datatype_List)
                    ? datatype.TypeCode
                    : 0;
                builtInType =
                    (int)builtInEnum > 0
                        ? DatatypeImplementation.GetSimpleTypeFromTypeCode(builtInEnum).Datatype
                        : datatype;
            }
            ...
            internal void CompileLengthFacet(XmlSchemaFacet facet)
            {
                ...
                derivedRestriction.Length = XmlBaseConverter.DecimalToInt32(
                    (decimal)ParseFacetValue(
                        nonNegativeInt,
                        facet,
                        Res.Sch_LengthFacetInvalid,
                        null,
                        null
                    )
                );
            ...
            internal void CompileMinLengthFacet(XmlSchemaFacet facet)
            {
                ...
                if ((baseFixedFlags & RestrictionFlags.MinLength) != 0)
                {
                    if (
                        !datatype.IsEqual(
                            datatype.Restriction.MinLength,
                            derivedRestriction.MinLength
                        )
                    )
                    {
                        throw new XmlSchemaException(Res.Sch_FacetBaseFixed, facet);
            ...
            internal void CompileMaxLengthFacet(XmlSchemaFacet facet)
            {
                ...
                derivedRestriction.MaxLength = XmlBaseConverter.DecimalToInt32(
                    (decimal)ParseFacetValue(
                        nonNegativeInt,
                        facet,
                        Res.Sch_MaxLengthFacetInvalid,
                        null,
                        null
                    )
                );
                ...
                if ((baseFixedFlags & RestrictionFlags.MaxLength) != 0)
                {
                    if (
                        !datatype.IsEqual(
                            datatype.Restriction.MaxLength,
            ...
            internal void CompilePatternFacet(XmlSchemaPatternFacet facet)
            {
                CheckProhibitedFlag(
                    ...
                    Res.Sch_PatternFacetProhibited
                );
            ...
            )
            {
                CheckProhibitedFlag(
                    ...
                    Res.Sch_EnumerationFacetProhibited
                );
            ...
            internal void CompileWhitespaceFacet(XmlSchemaFacet facet)
            {
                CheckProhibitedFlag(
                    ...
                    Res.Sch_WhiteSpaceFacetProhibited
                );
                ...
                if ((baseFixedFlags & RestrictionFlags.WhiteSpace) != 0)
                {
                    if (
                        !datatype.IsEqual(
                            datatype.Restriction.WhiteSpace,
                            derivedRestriction.WhiteSpace
                        )
                    )
                    {
                        throw new XmlSchemaException(Res.Sch_FacetBaseFixed, facet);
            ...
            internal void CompileMaxInclusiveFacet(XmlSchemaFacet facet)
            {
                CheckProhibitedFlag(
                    ...
                    Res.Sch_MaxInclusiveFacetProhibited
                );
                CheckDupFlag(facet, RestrictionFlags.MaxInclusive, Res.Sch_DupMaxInclusiveFacet);
                derivedRestriction.MaxInclusive = ParseFacetValue(
                    builtInType,
                    facet,
                    Res.Sch_MaxInclusiveFacetInvalid,
                    null,
                    null
                );
                ...
                if ((baseFixedFlags & RestrictionFlags.MaxInclusive) != 0)
                {
                    if (
                        !datatype.IsEqual(
                            datatype.Restriction.MaxInclusive,
                            derivedRestriction.MaxInclusive
                        )
                    )
                    {
                        throw new XmlSchemaException(Res.Sch_FacetBaseFixed, facet);
            ...
            internal void CompileMaxExclusiveFacet(XmlSchemaFacet facet)
            {
                ...
                derivedRestriction.MaxExclusive = ParseFacetValue(
                    builtInType,
                    facet,
                    Res.Sch_MaxExclusiveFacetInvalid,
                    null,
                    null
                );
                ...
                if ((baseFixedFlags & RestrictionFlags.MaxExclusive) != 0)
                {
                    if (
                        !datatype.IsEqual(
                            datatype.Restriction.MaxExclusive,
                            derivedRestriction.MaxExclusive
                        )
                    )
                    {
                        throw new XmlSchemaException(Res.Sch_FacetBaseFixed, facet);
            ...
            internal void CompileMinInclusiveFacet(XmlSchemaFacet facet)
            {
                CheckProhibitedFlag(
                    ...
                    Res.Sch_MinInclusiveFacetProhibited
                );
                CheckDupFlag(facet, RestrictionFlags.MinInclusive, Res.Sch_DupMinInclusiveFacet);
                derivedRestriction.MinInclusive = ParseFacetValue(
                    builtInType,
                    facet,
                    Res.Sch_MinInclusiveFacetInvalid,
                    null,
                    null
                );
                ...
                if ((baseFixedFlags & RestrictionFlags.MinInclusive) != 0)
                {
                    if (
                        !datatype.IsEqual(
                            datatype.Restriction.MinInclusive,
                            derivedRestriction.MinInclusive
                        )
                    )
                    {
                        throw new XmlSchemaException(Res.Sch_FacetBaseFixed, facet);
            ...
            internal void CompileMinExclusiveFacet(XmlSchemaFacet facet)
            {
                CheckProhibitedFlag(
                    ...
                    Res.Sch_MinExclusiveFacetProhibited
                );
                CheckDupFlag(facet, RestrictionFlags.MinExclusive, Res.Sch_DupMinExclusiveFacet);
                derivedRestriction.MinExclusive = ParseFacetValue(
                    builtInType,
                    facet,
                    Res.Sch_MinExclusiveFacetInvalid,
                    null,
                    null
                );
                ...
                if ((baseFixedFlags & RestrictionFlags.MinExclusive) != 0)
                {
                    if (
                        !datatype.IsEqual(
                            datatype.Restriction.MinExclusive,
                            derivedRestriction.MinExclusive
                        )
                    )
                    {
                        throw new XmlSchemaException(Res.Sch_FacetBaseFixed, facet);
            ...
            internal void CompileTotalDigitsFacet(XmlSchemaFacet facet)
            {
                CheckProhibitedFlag(
                    ...
                    Res.Sch_TotalDigitsFacetProhibited
                );
                ...
                XmlSchemaDatatype positiveInt = DatatypeImplementation
                    ...
                    .Datatype;
                derivedRestriction.TotalDigits = XmlBaseConverter.DecimalToInt32(
                    (decimal)ParseFacetValue(
                        positiveInt,
                        facet,
                        Res.Sch_TotalDigitsFacetInvalid,
                        null,
                        null
                    )
                );
                ...
                if ((baseFixedFlags & RestrictionFlags.TotalDigits) != 0)
                {
                    if (
                        !datatype.IsEqual(
                            datatype.Restriction.TotalDigits,
                            derivedRestriction.TotalDigits
                        )
                    )
                    {
                        throw new XmlSchemaException(Res.Sch_FacetBaseFixed, facet);
            ...
            internal void CompileFractionDigitsFacet(XmlSchemaFacet facet)
            {
                CheckProhibitedFlag(
                    ...
                    Res.Sch_FractionDigitsFacetProhibited
                );
                CheckDupFlag(
                    facet,
                    RestrictionFlags.FractionDigits,
                    Res.Sch_DupFractionDigitsFacet
                );
                derivedRestriction.FractionDigits = XmlBaseConverter.DecimalToInt32(
                    (decimal)ParseFacetValue(
                        nonNegativeInt,
                        facet,
                        Res.Sch_FractionDigitsFacetInvalid,
                        null,
                        null
                    )
                );
                ...
                if (
                    (derivedRestriction.FractionDigits != 0)
                    && (datatype.TypeCode != XmlTypeCode.Decimal)
                )
                {
                    throw new XmlSchemaException(
                        Res.Sch_FractionDigitsFacetInvalid,
                        Res.GetString(Res.Sch_FractionDigitsNotOnDecimal),
                        facet
                    );
                }
            ...
            internal void FinishFacetCompile()
            {
                ...
                if (firstPattern == false)
                {
                    ...
                    {
                        throw new XmlSchemaException(
                            Res.Sch_PatternFacetInvalid,
                            new string[] { e.Message },
                            e,
                            pattern_facet.SourceUri,
                            pattern_facet.LineNumber,
                            pattern_facet.LinePosition,
                            pattern_facet
                        );
                    }
                }
            ...
            internal void CompileFacetCombinations()
            {
                ...
                )
                {
                    ...
                    {
                        throw new XmlSchemaException(
                            Res.Sch_MinInclusiveGtMaxInclusive,
                            string.Empty
                        );
                    }
                }
                ...
                )
                {
                    ...
                    {
                        throw new XmlSchemaException(
                            Res.Sch_MinInclusiveGtMaxExclusive,
                            string.Empty
                        );
                    }
                }
                ...
                )
                {
                    ...
                    {
                        throw new XmlSchemaException(
                            Res.Sch_MinExclusiveGtMaxExclusive,
                            string.Empty
                        );
                    }
                }
                ...
                )
                {
                    ...
                    {
                        throw new XmlSchemaException(
                            Res.Sch_MinExclusiveGtMaxInclusive,
                            string.Empty
                        );
                    }
                }
                ...
                )
                {
                    ...
                    {
                        throw new XmlSchemaException(
                            Res.Sch_FractionDigitsGtTotalDigits,
                            string.Empty
                        );
                    }
                }
                ...
                for (int i = 0; i < restriction.Patterns.Count; ++i)
                {
                    ...
                    if (!regex.IsMatch(value))
                    {
                        return new XmlSchemaException(
                            Res.Sch_PatternConstraintFailed,
                            string.Empty
                        );
                    }
                }
        ...
        internal override Exception CheckValueFacets(decimal value, XmlSchemaDatatype datatype)
        {
            ...
            if (flags != 0)
            {
                if ((flags & RestrictionFlags.MaxInclusive) != 0)
                {
                    ...
                    {
                        return new XmlSchemaException(
                            Res.Sch_MaxInclusiveConstraintFailed,
                            string.Empty
                        );
                    }
                }
                ...
                if ((flags & RestrictionFlags.MaxExclusive) != 0)
                {
                    ...
                    {
                        return new XmlSchemaException(
                            Res.Sch_MaxExclusiveConstraintFailed,
                            string.Empty
                        );
                    }
                }
                ...
                if ((flags & RestrictionFlags.MinInclusive) != 0)
                {
                    ...
                    {
                        return new XmlSchemaException(
                            Res.Sch_MinInclusiveConstraintFailed,
                            string.Empty
                        );
                    }
                }
                ...
                if ((flags & RestrictionFlags.MinExclusive) != 0)
                {
                    ...
                    {
                        return new XmlSchemaException(
                            Res.Sch_MinExclusiveConstraintFailed,
                            string.Empty
                        );
                    }
                }
                if ((flags & RestrictionFlags.Enumeration) != 0)
                {
                    ...
                    {
                        return new XmlSchemaException(
                            Res.Sch_EnumerationConstraintFailed,
                            string.Empty
                        );
                    }
                }
        ...
        )
        {
            ...
            if (flags != 0)
            {
                ...
                if ((flags & RestrictionFlags.MinLength) != 0)
                {
                    ...
                    {
                        return new XmlSchemaException(
                            Res.Sch_MinLengthConstraintFailed,
                            string.Empty
                        );
                    }
                }
                if ((flags & RestrictionFlags.MaxLength) != 0)
                {
                    ...
                    {
                        return new XmlSchemaException(
                            Res.Sch_MaxLengthConstraintFailed,
                            string.Empty
                        );
                    }
                }
