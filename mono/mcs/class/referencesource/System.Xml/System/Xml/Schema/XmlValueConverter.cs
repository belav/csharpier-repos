...
namespace System.Xml.Schema
{
    ...
    internal abstract class XmlBaseConverter : XmlValueConverter
    {
        ...
        protected string XmlTypeName
        {
            get
            {
                ...
                Debug.Assert(
                    this.typeCode == XmlTypeCode.Item,
        ...
        protected Exception CreateInvalidClrMappingException(Type sourceType, Type destinationType)
        {
            ...
            return new InvalidCastException(
                Res.GetString(
                    Res.XmlConvert_TypeBadMapping2,
                    XmlTypeName,
                    sourceType.Name,
        ...
        )
        {
            ...
            if (nsResolver == null)
                throw new InvalidCastException(
                    Res.GetString(Res.XmlConvert_TypeNoNamespace, value, prefix)
                );
        ...
        )
        {
            ...
            if (prefix == null)
                throw new InvalidCastException(
                    Res.GetString(Res.XmlConvert_TypeNoPrefix, qname.ToString(), qname.Namespace)
                );
    ...
    internal class XmlDateTimeConverter : XmlBaseConverter
    {
        ...
        public override DateTime ToDateTime(string value)
        {
            ...
            switch (TypeCode)
            {
                ...
                case XmlTypeCode.GDay:
                    return StringToGDay((string)value);
                case XmlTypeCode.GMonth:
                    return StringToGMonth((string)value);
                case XmlTypeCode.GMonthDay:
                    return StringToGMonthDay((string)value);
                case XmlTypeCode.GYear:
                    return StringToGYear((string)value);
                case XmlTypeCode.GYearMonth:
                    return StringToGYearMonth((string)value);
            }
        ...
        public override DateTimeOffset ToDateTimeOffset(string value)
        {
            ...
            {
                case XmlTypeCode.Date:
                    return StringToDateOffset((string)value);
                case XmlTypeCode.Time:
                    return StringToTimeOffset((string)value);
                case XmlTypeCode.GDay:
                    return StringToGDayOffset((string)value);
                case XmlTypeCode.GMonth:
                    return StringToGMonthOffset((string)value);
                case XmlTypeCode.GMonthDay:
                    return StringToGMonthDayOffset((string)value);
                case XmlTypeCode.GYear:
                    return StringToGYearOffset((string)value);
                case XmlTypeCode.GYearMonth:
                    return StringToGYearMonthOffset((string)value);
            }
        ...
        public override string ToString(DateTime value)
        {
            switch (TypeCode)
            {
                ...
                case XmlTypeCode.GDay:
                    return GDayToString((DateTime)value);
                case XmlTypeCode.GMonth:
                    return GMonthToString((DateTime)value);
                case XmlTypeCode.GMonthDay:
                    return GMonthDayToString((DateTime)value);
                case XmlTypeCode.GYear:
                    return GYearToString((DateTime)value);
                case XmlTypeCode.GYearMonth:
                    return GYearMonthToString((DateTime)value);
            }
        ...
        public override string ToString(DateTimeOffset value)
        {
            ...
            {
                case XmlTypeCode.Date:
                    return DateOffsetToString((DateTimeOffset)value);
                case XmlTypeCode.Time:
                    return TimeOffsetToString((DateTimeOffset)value);
                case XmlTypeCode.GDay:
                    return GDayOffsetToString((DateTimeOffset)value);
                case XmlTypeCode.GMonth:
                    return GMonthOffsetToString((DateTimeOffset)value);
                case XmlTypeCode.GMonthDay:
                    return GMonthDayOffsetToString((DateTimeOffset)value);
                case XmlTypeCode.GYear:
                    return GYearOffsetToString((DateTimeOffset)value);
                case XmlTypeCode.GYearMonth:
                    return GYearMonthOffsetToString((DateTimeOffset)value);
            }
    ...
    internal class XmlAnyConverter : XmlBaseConverter
    {
        ...
        public override object ChangeType(float value, Type destinationType)
        {
            ...
            if (destinationType == XmlAtomicValueType)
                return (
                    new XmlAtomicValue(XmlSchemaType.GetBuiltInSimpleType(XmlTypeCode.Float), value)
                );
    ...
    internal class XmlListConverter : XmlBaseConverter
    {
        ...
        )
        {
            if (sourceType == destinationType)
                return new InvalidCastException(
                    Res.GetString(Res.XmlConvert_TypeListBadMapping, XmlTypeName, sourceType.Name)
                );

            return new InvalidCastException(
                Res.GetString(
                    Res.XmlConvert_TypeListBadMapping2,
                    XmlTypeName,
                    sourceType.Name,
                    destinationType.Name
                )
