...
#pragma warning disable 618
    internal sealed class SchemaCollectionPreprocessor : BaseProcessor
    {
        ...
        public SchemaCollectionPreprocessor(
                ...
                { //Added for SchemaCollection compatibility
                    ...
                    if (include.Schema != null)
                    {
                        ...
                        if (
                            ...
                            && schemaLocations[include.Schema.BaseUri] == null
                        )
                        {
                        ...
                        catch (XmlSchemaException e)
                        {
                            SendValidationEventNoThrow(
                                new XmlSchemaException(
                                    ...
                                    new string[] { schemaLocation, e.Message },
                                    e.SourceUri,
                                    e.LineNumber,
                                    e.LinePosition
                                ),
        ...
        private void BuildRefNamespaces(XmlSchema schema)
        {
            ...
            if (
                ...
                && referenceNamespaces[schema.TargetNamespace] == null
            )
            ...
            for (int i = 0; i < schema.Includes.Count; ++i)
            {
                ...
                if (include.Schema != null)
                {
                    ...
                    else if (include is XmlSchemaImport)
                    {
                        ...
                        Preprocess(
                            include.Schema,
                            ((XmlSchemaImport)include).Namespace,
                            Compositor.Import
                        );
                    }
                    else
                ...
                else if (redefine.Items[i] is XmlSchemaComplexType)
                {
                    ...
                    else
                    {
                        ...
                        if (type != null)
                        {
                            ...
                            {
                                SendValidationEvent(
                                    Res.Sch_SimpleToComplexTypeRedefine,
                                    complexType
                                );
                            }
                        }
                ...
                else if (redefine.Items[i] is XmlSchemaSimpleType)
                {
                    ...
                    else
                    {
                        ...
                        if (type != null)
                        {
                            ...
                            {
                                SendValidationEvent(
                                    Res.Sch_ComplexToSimpleTypeRedefine,
                                    simpleType
                                );
                            }
                        }
