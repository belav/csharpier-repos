...
namespace System.Xml.Schema
{
    ...
    /// <include file='doc\DatatypeImplementation.uex'
    // path='docs/doc[@for="XmlSchemaDatatypeVariety"]/*' />
    public enum XmlSchemaDatatypeVariety
    {
        /// <include file='doc\DatatypeImplementation.uex'
        // path='docs/doc[@for="XmlSchemaDatatypeVariety.Atomic"]/*' />
        Atomic,

        /// <include file='doc\DatatypeImplementation.uex'
        // path='docs/doc[@for="XmlSchemaDatatypeVariety.List"]/*' />
        List,

        /// <include file='doc\DatatypeImplementation.uex'
        // path='docs/doc[@for="XmlSchemaDatatypeVariety.Union"]/*' />
        Union,
    }
    ...
    internal abstract class DatatypeImplementation : XmlSchemaDatatype
    {
        ...
        private static XmlSchemaSimpleType[] enumToTypeCode = new XmlSchemaSimpleType[
            (int)XmlTypeCode.DayTimeDuration + 1
        ];
        ...
        internal static XmlQualifiedName QnAnySimpleType = new XmlQualifiedName(
            "anySimpleType",
            XmlReservedNs.NsXs
        );
        internal static XmlQualifiedName QnAnyType = new XmlQualifiedName(
            "anyType",
            XmlReservedNs.NsXs
        );
        ...
        /// <summary>
        /// Begin the creation of an XmlSchemaSimpleType object that will be used to represent a static
        // built-in type.
        /// Once StartBuiltinType has been called for all built-in types, FinishBuiltinType should be called
        // in order
            ...
            if (derivedType.Datatype.Variety == XmlSchemaDatatypeVariety.List)
            {
                ...
                switch (derivedType.Datatype.TypeCode)
                {
                    case XmlTypeCode.NmToken:
                        listContent.ItemType = listContent.BaseItemType = enumToTypeCode[
        ...
        internal static void CreateBuiltinTypes()
        {
            ...
            for (int i = 0; i < c_XsdTypes.Length; i++)
            {
                ...
                XmlSchemaSimpleType derivedType = (XmlSchemaSimpleType)
                    builtinTypes[new XmlQualifiedName(sdm.Name, XmlReservedNs.NsXs)];
                XmlSchemaSimpleType baseType;
                    ...
                    baseType = (XmlSchemaSimpleType)
                        builtinTypes[
                            new XmlQualifiedName(
                                ((SchemaDatatypeMap)(c_XsdTypes[sdm.ParentIndex])).Name,
                                XmlReservedNs.NsXs
                            )
                        ];
        ...
        internal static XmlSchemaSimpleType GetNormalizedStringTypeV1Compat()
        {
            if (normalizedStringTypeV1Compat == null)
            {
                ...
                XmlSchemaSimpleType tempNormalizedStringTypeV1Compat =
        ...
        internal static XmlSchemaSimpleType GetTokenTypeV1Compat()
        {
            if (tokenTypeV1Compat == null)
            {
                ...
                XmlSchemaSimpleType tempTokenTypeV1Compat =
                    correctType.Clone() as XmlSchemaSimpleType;
        ...
        {
            //Debug.WriteLineIf(DiagnosticsSwitches.XmlSchema.TraceVerbose,
            // string.Format("\t\tSchemaDatatype.IsEqual({0}, {1})", o1, o2));
        ...
        internal override object ParseValue(
            string s,
            Type typDest,
            XmlNameTable nameTable,
        ...
        )
        {
            ...
            if (exception != null)
            {
                throw new XmlSchemaException(
                    Res.Sch_InvalidValueDetailed,
                    new string[] { s, GetTypeName(), exception.Message },
                    exception,
                    null,
                    0,
                    0,
        ...
        internal override Exception TryParseValue(
            object value,
            XmlNameTable nameTable,
        ...
        private static readonly DatatypeImplementation c_char = new Datatype_char(); // XDR
        ...
        private static readonly DatatypeImplementation c_doubleXdr = new Datatype_doubleXdr(); // XDR
        ...
        private static readonly DatatypeImplementation c_ENTITIES = (DatatypeImplementation)
            c_ENTITY.DeriveByList(1, null);
        private static readonly DatatypeImplementation c_ENUMERATION = new Datatype_ENUMERATION(); // XDR
        ...
        private static readonly DatatypeImplementation c_floatXdr = new Datatype_floatXdr(); // XDR
        ...
        private static readonly DatatypeImplementation c_IDREFS = (DatatypeImplementation)
        ...
        private static readonly DatatypeImplementation c_NMTOKENS = (DatatypeImplementation)
        ...
        private static readonly DatatypeImplementation c_positiveInteger =
            new Datatype_positiveInteger();
        private static readonly DatatypeImplementation c_QName = new Datatype_QName();
        private static readonly DatatypeImplementation c_QNameXdr = new Datatype_QNameXdr(); //XDR
        ...
        private static readonly DatatypeImplementation c_timeNoTz = new Datatype_timeNoTimeZone(); // XDR
        private static readonly DatatypeImplementation c_timeTz = new Datatype_timeTimeZone(); // XDR
        ...
        //V1 compat types
        static internal readonly DatatypeImplementation c_normalizedStringV1Compat =
            new Datatype_normalizedStringV1Compat();
    ...
    internal class Datatype_List : Datatype_anySimpleType
    {
        ...
        internal override XmlValueConverter CreateValueConverter(XmlSchemaType schemaType)
        {
            ...
            if (simpleType != null)
            {
                do
                {
                    XmlSchemaSimpleTypeList listType =
                        simpleType.Content as XmlSchemaSimpleTypeList;
                    if (listType != null)
                    {
            ...
            { //Get built-in simple type for the typecode
                listItemType = DatatypeImplementation.GetSimpleTypeFromTypeCode(
                    schemaType.Datatype.TypeCode
                );
            }
        ...
        public override XmlTokenizedType TokenizedType
        {
            get { return itemType.TokenizedType; }
        }

        internal override Type ListValueType
        {
            get { return itemType.ListValueType; }
        }

        internal override FacetsChecker FacetsChecker
        {
            get { return listFacetsChecker; }
        }

        public override XmlTypeCode TypeCode
        {
            get { return itemType.TypeCode; }
        }
        ...
        )
        {
            ...
            if (itemType.Variety == XmlSchemaDatatypeVariety.Union)
            {
                ...
                for (int i = 0; i < splitString.Length; ++i)
                {
                    ...
                    exception = itemType.TryParseValue(
                        splitString[i],
                        nameTable,
                        nsmgr,
                        out unionTypedValue
    ...
    internal class Datatype_union : Datatype_anySimpleType
    {
        ...
        internal override RestrictionFlags ValidRestrictionFlags
        {
            get { return RestrictionFlags.Pattern | RestrictionFlags.Enumeration; }
        }
        ...
        )
        {
            ...
            {
                if (
                    types[i].Datatype.TryParseValue(value, nameTable, nsmgr, out valueToCheck)
                    == null
                )
                { //no error
                    memberType = types[i];
            ...
            try
            {
                ...
                {
                    string s1 = (string)
                        this.ValueConverter.ChangeType(valueToCheck, typeof(System.String), nsmgr); //Using value here to avoid info loss
    ...
    internal class Datatype_anySimpleType : DatatypeImplementation
    {
        ...
        internal override XmlSchemaWhiteSpace BuiltInWhitespaceFacet
        {
            get { return XmlSchemaWhiteSpace.Collapse; }
        }

        internal override int Compare(object value1, object value2)
        {
            //Changed StringComparison.CurrentCulture to StringComparison.Ordinal to handle zero-weight code
            // points like the cyrillic E
    ...
    */
    internal class Datatype_boolean : Datatype_anySimpleType
    {
        ...
        internal override RestrictionFlags ValidRestrictionFlags
        {
            get { return RestrictionFlags.Pattern | RestrictionFlags.WhiteSpace; }
        }
    ...
    */
    internal class Datatype_float : Datatype_anySimpleType
    {
        ...
        internal override FacetsChecker FacetsChecker
        {
            get { return numeric2FacetsChecker; }
        }
    ...
    */
    internal class Datatype_decimal : Datatype_anySimpleType
    {
        ...
        static readonly FacetsChecker numeric10FacetsChecker = new Numeric10FacetsChecker(
            decimal.MinValue,
            decimal.MaxValue
        );
        ...
        internal override FacetsChecker FacetsChecker
        {
            get { return numeric10FacetsChecker; }
        }
    ...
    */
    internal class Datatype_duration : Datatype_anySimpleType
    {
        ...
        internal override FacetsChecker FacetsChecker
        {
            get { return durationFacetsChecker; }
        }
    ...
    internal class Datatype_yearMonthDuration : Datatype_duration
    {
        ...
        )
        {
            ...
            exception = XsdDuration.TryParse(
                s,
            ...
            exception = duration.TryToTimeSpan(
                XsdDuration.DurationType.YearMonthDuration,
                out timeSpanValue
            );
            if (exception != null)
    ...
    internal class Datatype_dateTimeBase : Datatype_anySimpleType
    {
        ...
        internal override FacetsChecker FacetsChecker
        {
            get { return dateTimeFacetsChecker; }
        }
    ...
    */
    internal class Datatype_normalizedString : Datatype_string
    {
        ...
        internal override XmlSchemaWhiteSpace BuiltInWhitespaceFacet
        {
            get { return XmlSchemaWhiteSpace.Replace; }
        }
    ...
    */
    internal class Datatype_NOTATION : Datatype_anySimpleType
    {
        ...
        {
            // Only datatypes that are derived from NOTATION by specifying a value for enumeration can be used
            // in a schema.
            // Furthermore, the value of all enumeration facets must match the name of a notation declared in
            // the current schema.                    //
    ...
    */
    ...
    internal class Datatype_ENUMERATION : Datatype_NMTOKEN
    {
        public override XmlTokenizedType TokenizedType
        {
            get { return XmlTokenizedType.ENUMERATION; }
        }
    }
    ...
    internal class Datatype_fixed : Datatype_decimal
    {
        ...
        )
        {
            ...
            Numeric10FacetsChecker facetsChecker = this.FacetsChecker as Numeric10FacetsChecker;
            exception = facetsChecker.CheckTotalAndFractionDigits(
                decimalValue,
                14 + 4,
                4,
                true,
