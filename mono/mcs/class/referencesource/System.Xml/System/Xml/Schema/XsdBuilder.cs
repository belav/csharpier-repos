...
namespace System.Xml.Schema
{
    ...
    internal sealed class XsdBuilder : SchemaBuilder
    {
        ...
        //Elements
        //
        private static readonly State[] SchemaElement = { State.Schema };
        ...
        private static readonly State[] AllSubelements = { State.Annotation, State.Element };
        ...
        private static readonly State[] AnnotatedSubelements = { State.Annotation };
        ...
        */
        ...
        {
            builder.schema.AttributeFormDefault = (XmlSchemaForm)
        ...
        {
            builder.schema.ElementFormDefault = (XmlSchemaForm)
        ...
        {
            builder.schema.FinalDefault = (XmlSchemaDerivationMethod)
        ...
        {
            builder.schema.BlockDefault = (XmlSchemaDerivationMethod)
        ...
        */
        ...
        {
            builder.attribute.Form = (XmlSchemaForm)
        ...
        */
        ...
        {
            builder.element.Block = (XmlSchemaDerivationMethod)
        ...
        {
            builder.element.Form = (XmlSchemaForm)
                builder.ParseEnum(value, "form", FormStringValues);
        }
        ...
        {
            builder.element.Final = (XmlSchemaDerivationMethod)
        ...
        */
        ...
        {
            builder.simpleType.Final = (XmlSchemaDerivationMethod)
                builder.ParseBlockFinalEnum(value, "final");
        }
        ...
        */
        ...
        private static void BuildSimpleTypeUnion_MemberTypes(XsdBuilder builder, string value)
        {
            ...
            try
            {
                builder.simpleTypeUnion.MemberTypes = (XmlQualifiedName[])
                    dt.ParseValue(value, builder.nameTable, builder.namespaceManager);
            }
            catch (XmlSchemaException e)
            {
                e.SetSource(
                    builder.reader.BaseURI,
                    builder.positionInfo.LineNumber,
                    builder.positionInfo.LinePosition
                );
        ...
        */
        ...
        {
            builder.complexType.Block = (XmlSchemaDerivationMethod)
                builder.ParseBlockFinalEnum(value, "block");
        }

        private static void BuildComplexType_Final(XsdBuilder builder, string value)
        {
            builder.complexType.Final = (XmlSchemaDerivationMethod)
                builder.ParseBlockFinalEnum(value, "final");
        }
        ...
        */
        ...
        {
            if (
                (builder.complexType.ContentModel != null)
                || (
                    builder.complexType.Particle != null
                    || builder.complexType.Attributes.Count != 0
                    || builder.complexType.AnyAttribute != null
                )
            )
            {
        ...
        */
        ...
        {
            builder.xso = builder.complexContentRestriction =
        ...
        */
        private static void InitSimpleContentRestriction(XsdBuilder builder, string value)
        {
            ...
            builder.xso = builder.simpleContentRestriction =
        ...
        */
                ...
                case SchemaNames.Token.XsdComplexType:
                    if (builder.complexType.ContentModel != null)
                    {
                        builder.SendValidationEvent(
                            Res.Sch_AttributeMutuallyExclusive,
                            "anyAttribute"
                        );
                    }
        ...
        {
            builder.anyAttribute.ProcessContents = (XmlSchemaContentProcessing)
        ...
        */
        ...
        {
            builder.anyElement.ProcessContents = (XmlSchemaContentProcessing)
                builder.ParseEnum(value, "processContents", ProcessContentsStringValues);
        }
        ...
        */
        ...
        private static void BuildIdentityConstraint_Refer(XsdBuilder builder, string value)
        {
            ...
            {
                ((XmlSchemaKeyref)builder.identityConstraint).Refer = builder.ParseQName(
                    value,
                    "refer"
                );
            }
        ...
        */
        ...
        private void AddParticle(XmlSchemaParticle particle)
        {
            switch (this.ParentElement)
            {
                ...
                case SchemaNames.Token.XsdComplexContentExtension:
                    if (
                        (complexContentExtension.Particle != null)
                        || (
                            complexContentExtension.Attributes.Count != 0
                            || complexContentExtension.AnyAttribute != null
                        )
                    )
                    {
                        SendValidationEvent(
                            Res.Sch_ComplexContentContentModel,
                            "ComplexContentExtension"
                        );
                    }
                ...
                case SchemaNames.Token.XsdComplexContentRestriction:
                    if (
                        (complexContentRestriction.Particle != null)
                        || (
                            complexContentRestriction.Attributes.Count != 0
                            || complexContentRestriction.AnyAttribute != null
                        )
                    )
                    {
                        SendValidationEvent(
            ...
            for (int i = 0; i < stringValues.Length; i++)
            {
                ...
                for (int j = 0; j < DerivationMethodStrings.Length; j++)
                {
                    if (stringValues[i] == DerivationMethodStrings[j])
                    {
                        ...
                        {
                            SendValidationEvent(
                                Res.Sch_InvalidXsdAttributeValue,
                                attributeName,
                                value,
                                null
                            );
