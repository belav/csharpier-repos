...
namespace MS.Internal.Xml.Cache
{
    ...
    internal struct XPathNode
    {
        ...
        public int LineNumber
        {
            get
            {
                return this.info.LineNumberBase
        ...
        {
            Debug.Assert(
                localName == null || (object)Document.NameTable.Get(localName) == (object)localName,
        ...
        public bool HasNamespaceDecls
        {
            ...
            {
                if (value)
                    this.props |= HasNmspDeclsBit;
                else
                    unchecked
                    {
                        this.props &= (byte)~((uint)HasNmspDeclsBit);
                    }
            }
        }
        ...
        {
            Debug.Assert(
                pageSibling != null && idxSibling != 0 && idxSibling <= UInt16.MaxValue,
                "Bad argument"
            );
            ...
            if (pageSibling != this.info.SiblingPage)
            {
                ...
                this.info = infoTable.Create(
                    this.info.LocalName,
                    this.info.NamespaceUri,
                    this.info.Prefix,
                    this.info.BaseUri,
                    this.info.ParentPage,
                    pageSibling,
                    this.info.SimilarElementPage,
                    this.info.Document,
                    this.info.LineNumberBase,
        ...
        {
            Debug.Assert(
                pageSimilar != null && idxSimilar != 0 && idxSimilar <= UInt16.MaxValue,
                "Bad argument"
            );
            Debug.Assert(
                this.idxSimilar == 0,
