...
namespace MS.Internal.Xml.Cache
{
    ...
    internal sealed class XPathDocumentNavigator : XPathNavigator, IXmlLineInfo
    {
            ...
            get
            {
                ...
                switch (this.pageCurrent[this.idxCurrent].NodeType)
                {
                    ...
                    case XPathNodeType.ProcessingInstruction:
                        Debug.Assert(
                            false,
                            "ReadStringValue() should have taken care of these node types."
                        );
                        break;

                    case XPathNodeType.Text:
                        Debug.Assert(
                            this.idxParent != 0 && this.pageParent[this.idxParent].HasCollapsedText,
        ...
        public override bool MoveToAttribute(string localName, string namespaceURI)
        {
            ...
            if (
                XPathNodeHelper.GetAttribute(
                    ref this.pageCurrent,
                    ref this.idxCurrent,
        ...
        public override bool MoveToFirstNamespace(XPathNamespaceScope namespaceScope)
        {
            ...
            if (namespaceScope == XPathNamespaceScope.Local)
            {
                ...
                idx = XPathNodeHelper.GetLocalNamespaces(
                    this.pageCurrent,
                    this.idxCurrent,
                    out page
                );
            ...
            else
            {
                ...
                idx = XPathNodeHelper.GetInScopeNamespaces(
                    this.pageCurrent,
                    this.idxCurrent,
                    out page
                );
        ...
        public override bool MoveToPrevious()
        {
            ...
            return XPathNodeHelper.GetPreviousContentSibling(
                ref this.pageCurrent,
                ref this.idxCurrent
            );
        }
        ...
        public override bool MoveToFirstChild()
        {
            if (this.pageCurrent[this.idxCurrent].HasCollapsedText)
            {
                ...
                this.pageParent = this.pageCurrent;
                this.idxParent = this.idxCurrent;
                this.idxCurrent = this.pageCurrent[this.idxCurrent].Document.GetCollapsedTextNode(
        ...
        public override bool IsSamePosition(XPathNavigator other)
        {
            ...
            if (that != null)
            {
                return this.idxCurrent == that.idxCurrent
                    && this.pageCurrent == that.pageCurrent
                    && this.idxParent == that.idxParent
                    && this.pageParent == that.pageParent;
            }
        ...
        public override bool MoveToChild(string localName, string namespaceURI)
        {
            ...
            return XPathNodeHelper.GetElementChild(
                ref this.pageCurrent,
                ref this.idxCurrent,
                this.atomizedLocalName,
                namespaceURI
        ...
        public override bool MoveToNext(string localName, string namespaceURI)
        {
            ...
            return XPathNodeHelper.GetElementSibling(
                ref this.pageCurrent,
                ref this.idxCurrent,
                this.atomizedLocalName,
                namespaceURI
        ...
        {
            return XPathNodeHelper.GetContentSibling(
                ref this.pageCurrent,
                ref this.idxCurrent,
                type
            );
        ...
        )
        {
            ...
            {
                if (
                    !XPathNodeHelper.GetElementFollowing(
                        ref this.pageParent,
                        ref this.idxParent,
                        pageEnd,
                        idxEnd,
            ...
            return XPathNodeHelper.GetElementFollowing(
                ref this.pageCurrent,
                ref this.idxCurrent,
                pageEnd,
                idxEnd,
        ...
        public override bool MoveToFollowing(XPathNodeType type, XPathNavigator end)
        {
            ...
            if (type == XPathNodeType.Text || type == XPathNodeType.All)
            {
                if (this.pageCurrent[this.idxCurrent].HasCollapsedText)
                {
                    ...
                    if (
                        endTiny != null
                        && this.idxCurrent == endTiny.idxParent
                    ...
                    this.pageParent = this.pageCurrent;
                    this.idxParent = this.idxCurrent;
                    this.idxCurrent = this.pageCurrent[
                        this.idxCurrent
            ...
            {
                if (
                    !XPathNodeHelper.GetContentFollowing(
                        ref this.pageParent,
                        ref this.idxParent,
                        pageEnd,
                        idxEnd,
            ...
            return XPathNodeHelper.GetContentFollowing(
                ref this.pageCurrent,
                ref this.idxCurrent,
                pageEnd,
                idxEnd,
        ...
        public bool IsElementMatch(string localName, string namespaceURI)
        {
            ...
            return this.pageCurrent[this.idxCurrent].ElementMatch(
                this.atomizedLocalName,
                namespaceURI
            );
        }
        ...
        {
            return (
                ((1 << (int)this.pageCurrent[this.idxCurrent].NodeType) & GetContentKindMask(typ))
                != 0
            );
        }
        ...
        {
            return (
                ((1 << (int)this.pageCurrent[this.idxCurrent].NodeType) & GetKindMask(typ)) != 0
            );
        }
        ...
        )
        {
            ...
            if (
                ...
                && this.pageCurrent[this.idxCurrent].Document
                    == end.pageCurrent[end.idxCurrent].Document
            )
            {
