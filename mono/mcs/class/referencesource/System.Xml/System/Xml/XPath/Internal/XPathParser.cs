...
namespace MS.Internal.Xml.XPath
{
    ...
    internal class XPathParser
    {
                ...
                if (pi != null)
                {
                    ...
                    if (argCount < pi.Minargs)
                    {
                        throw XPathException.Create(
                            Res.Xp_InvalidNumArgs,
                            name,
                            this.scanner.SourceText
                        );
                    }
        ...
        private AstNode ParseLocationPathPattern(AstNode qyInput)
        {
            ...
            switch (this.scanner.Kind)
            {
                case XPathScanner.LexKind.Slash:
                    ...
                    opnd = new Root();
                    if (
                        this.scanner.Kind == XPathScanner.LexKind.Eof
        ...
        static readonly XPathResultType[] temparray5 =
        {
            XPathResultType.String,
            XPathResultType.String,
        };
        static readonly XPathResultType[] temparray6 =
        {
            XPathResultType.String,
            XPathResultType.Number,
            XPathResultType.Number,
        };
        static readonly XPathResultType[] temparray7 =
        {
            XPathResultType.String,
            XPathResultType.String,
            XPathResultType.String,
