    ...
    internal static class DiagnosticsSwitches
    {
        ...
        public static BooleanSwitch XmlSchemaContentModel
        {
            get
            {
                ...
                {
                    xmlSchemaContentModel = new BooleanSwitch(
                        "XmlSchemaContentModel",
                        "Enable tracing for the XmlSchema content model."
                    );
                }
        ...
        public static TraceSwitch XmlSchema
        {
            get
            {
                if (xmlSchema == null)
                {
                    xmlSchema = new TraceSwitch(
                        "XmlSchema",
                        "Enable tracing for the XmlSchema class."
                    );
                }
                return xmlSchema;
            }
        ...
        public static BooleanSwitch KeepTempFiles
        {
            get
            {
                ...
                {
                    keepTempFiles = new BooleanSwitch(
        ...
        public static BooleanSwitch PregenEventLog
        {
            get
            {
                ...
                {
                    pregenEventLog = new BooleanSwitch(
                        "XmlSerialization.PregenEventLog",
                        "Log failures while loading pre-generated XmlSerialization assembly."
                    );
                }
        ...
        public static TraceSwitch XmlSerialization
        {
            get
            {
                ...
                {
                    xmlSerialization = new TraceSwitch(
                        "XmlSerialization",
                        "Enable tracing for the System.Xml.Serialization component."
                    );
                }
        ...
        public static TraceSwitch XslTypeInference
        {
            get
            {
                ...
                {
                    xslTypeInference = new TraceSwitch(
                        "XslTypeInference",
                        "Enable tracing for the XSLT type inference algorithm."
                    );
                }
        ...
        public static BooleanSwitch NonRecursiveTypeLoading
        {
            get
            {
                ...
                {
                    nonRecursiveTypeLoading = new BooleanSwitch(
