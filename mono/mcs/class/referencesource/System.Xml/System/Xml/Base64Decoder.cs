...
namespace System.Xml
{
    internal class Base64Decoder : IncrementalReadDecoder
    {
        ...
        private static readonly String CharsBase64 =
        ...
        {
            get { return curIndex - startIndex; }
        }

        internal override bool IsFull
        {
            get { return curIndex == endIndex; }
        }
        ...
        )
        {
            ...
            while (pChar < pCharsEndPos && pByte < pBytesEndPos)
            {
                ...
                if (ch > 122 || (digit = MapBase64[ch]) == Invalid)
                {
                    throw new XmlException(
                        Res.Xml_InvalidBase64Value,
                        new string(pChars, 0, (int)(pCharsEndPos - pChars))
                    );
                }
            ...
            if (pChar < pCharsEndPos && *pChar == '=')
            {
                ...
                if (pChar < pCharsEndPos)
                {
                    ...
                    {
                        if (
                            !((xmlCharType.charProperties[*pChar++] & XmlCharType.fWhitespace) != 0)
                        )
