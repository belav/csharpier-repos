...
namespace System.Configuration
{
    ...
    public sealed class Configuration
    {
        ...
        )
        {
            ...
            string configPath,
                locationConfigPath;
            configHost.InitForConfiguration(
                ref locationSubPath,
                out configPath,
        ...
        private void ForceGroupsRecursive(ConfigurationSectionGroup group)
        {
            foreach (ConfigurationSection configSection in group.Sections)
            {
                ...
                ConfigurationSection section = group.Sections[
        ...
        {
            get { return _TypeStringTransformerIsSet; }
        }
        ...
        {
            get { return _AssemblyStringTransformerIsSet; }
        }
