    ...
    public sealed class SectionInformation
    {
        ...
        )
        {
            ...
            else
            {
                ...
                _flags[Flag_Declared] =
                    configRecord.GetFactoryRecord(factoryRecord.ConfigKey, false) != null;
                _flags[Flag_DeclarationRequired] = configRecord.IsRootDeclaration(
            ...
            if (sectionRecord.HasFileInput)
            {
                ...
                _flags[Flag_ProtectionProviderDetermined] =
        ...
        {
            get { return (_flags[Flag_Attached]) && (_configRecord == null); }
        }
        ...
        private void VerifyIsAttachedToConfigRecord()
        {
            if (_configRecord == null)
            {
                throw new InvalidOperationException(
                    SR.GetString(SR.Config_cannot_edit_configurationsection_when_not_attached)
                );
            }
        }
        ...
        internal void VerifyIsEditable()
        {
            ...
            {
                throw new InvalidOperationException(
                    SR.GetString(SR.Config_cannot_edit_configurationsection_when_locked)
                );
            }
            ...
            {
                throw new InvalidOperationException(
                    SR.GetString(SR.Config_cannot_edit_configurationsection_parentsection)
                );
            }

            if (
                !_flags[Flag_AllowLocation]
                && (_configRecord != null)
                && (_configRecord.IsLocationConfig)
            )
            {
                throw new InvalidOperationException(
                    SR.GetString(SR.Config_cannot_edit_configurationsection_when_location_locked)
                );
            }
        }
        ...
        private void VerifyNotParentSection()
        {
            ...
            {
                throw new InvalidOperationException(
                    SR.GetString(SR.Config_configsection_parentnotvalid)
                );
            }
        }
        ...
        private void VerifySupportsLocation()
        {
            ...
            {
                throw new InvalidOperationException(
                    SR.GetString(SR.Config_cannot_edit_locationattriubtes)
                );
            }
        }
        ...
        internal void VerifyIsEditableFactory()
        {
            ...
            {
                throw new InvalidOperationException(
                    SR.GetString(SR.Config_cannot_edit_configurationsection_in_location_config)
                );
            }
            ...
            {
                throw new InvalidOperationException(
                    SR.GetString(SR.Config_cannot_edit_configurationsection_when_it_is_implicit)
                );
            }
            ...
            {
                throw new InvalidOperationException(
                    SR.GetString(SR.Config_cannot_edit_configurationsection_when_it_is_undeclared)
                );
            }
        }
        ...
        {
            get { return _flags[Flag_Removed]; }
            set { _flags[Flag_Removed] = value; }
        }
            ...
            set
            {
                ...
                if (factoryRecord != null && factoryRecord.AllowDefinition != value)
                {
                    throw new ConfigurationErrorsException(
                        SR.GetString(SR.Config_tag_name_already_defined, _configKey)
                    );
                }
        ...
        {
            get { return _modifiedFlags[Flag_AllowDefinitionModified]; }
        }
        ...
        {
            get { return _modifiedFlags[Flag_AllowExeDefinitionModified]; }
        }
        ...
        {
            get { return _modifiedFlags[Flag_OverrideModeDefaultModified]; }
        }
        ...
        {
            get { return _modifiedFlags[Flag_AllowLocation]; }
        }
        ...
        {
            get { return (_flags[Flag_ChildrenLocked] ? OverrideMode.Deny : OverrideMode.Allow); }
        }
        ...
        internal bool LocationAttributesAreDefault
        {
            ...
            {
                return (
                    _overrideMode.IsDefaultForLocationTag
                    && (_flags[Flag_InheritInChildApps] == true)
                );
            }
        }
        ...
        {
            get { return _modifiedFlags[Flag_ConfigSourceModified]; }
        }
        ...
        {
            get { return _flags[Flag_InheritInChildApps]; }
            set
            {
                VerifyIsEditable();
                VerifySupportsLocation();
        ...
        public void ForceDeclaration(bool force)
        {
            ...
            if ((force == false) && _flags[Flag_DeclarationRequired])
            {
            ...
            else
            {
                ...
                {
                    throw new ConfigurationErrorsException(
                        SR.GetString(SR.Cannot_declare_or_remove_implicit_section)
                    );
                }
        ...
        public bool IsLocked
        {
            get
            {
                return _flags[Flag_LocationLocked]
                    || !IsDefinitionAllowed
        ...
        public void ProtectSection(string protectionProvider)
        {
            ...
            {
                throw new InvalidOperationException(
                    SR.GetString(SR.Config_not_allowed_to_encrypt_this_section)
                );
            }
            ...
            {
                throw new InvalidOperationException(
                    SR.GetString(SR.Must_add_to_config_before_protecting_it)
                );
            }
        ...
        {
            get { return _modifiedFlags[Flag_RestartOnExternalChanges]; }
        }
        ...
        {
            get { return _modifiedFlags[Flag_RequirePermission]; }
        }
        ...
        public ConfigurationSection GetParentSection()
        {
            ...
            {
                throw new InvalidOperationException(
                    SR.GetString(SR.Config_getparentconfigurationsection_first_instance)
                );
            }
        ...
        {
            get { return _flags[Flag_ForceSave]; }
            set
            {
                VerifyIsEditable();
