...
namespace System.Configuration
{
    internal static class TypeUtil
    {
        ...
        // exception as indicated by throwOnError.
        //
        internal static Type GetTypeWithReflectionPermission(
        ...
        internal static object CreateInstanceRestricted(Type callingType, Type targetType)
        {
            ...
            else
            {
                ...
                DynamicMethod dm = CreateDynamicMethod(
                    ...
                    parameterTypes: new Type[] { typeof(Type) }
                );
                ...
                var createInstanceDel =
                    (Func<Type, object>)dm.CreateDelegate(typeof(Func<Type, object>));
        ...
        internal static Delegate CreateDelegateRestricted(
            Type callingType,
            Type delegateType,
        ...
        )
        {
            ...
            else
            {
                ...
                PreventTailCall(ilGen); // stack = { retVal }
                ilGen.Emit(OpCodes.Ret);
                var createDelegateDel =
                    (Func<Type, MethodInfo, Delegate>)
                        dm.CreateDelegate(typeof(Func<Type, MethodInfo, Delegate>));
        ...
        )
        {
            if (owner != null)
            {
                return CreateDynamicMethodWithUnrestrictedPermission(
                    owner,
                    returnType,
                    parameterTypes
                );
        ...
        private static DynamicMethod CreateDynamicMethodWithUnrestrictedPermission(
            Type owner,
            Type returnType,
            Type[] parameterTypes
        )
        ...
        )
        {
            ...
            if (ctor == null && throwOnError)
            {
                throw new TypeLoadException(
                    SR.GetString(SR.TypeNotPublic, type.AssemblyQualifiedName)
                );
            }
        ...
        private static bool HasAptcaBit(Assembly assembly)
        {
            Object[] attrs = assembly.GetCustomAttributes(
                typeof(System.Security.AllowPartiallyTrustedCallersAttribute), /*inherit*/
                false
            );
