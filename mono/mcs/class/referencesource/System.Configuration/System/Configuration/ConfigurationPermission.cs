...
namespace System.Configuration
{
    ...
    public sealed class ConfigurationPermission : CodeAccessPermission, IUnrestrictedPermission
    {
        ...
        [SuppressMessage(
            ...
            Justification = "This is a standard implementation of a copy method."
        )]
        ...
        [SuppressMessage(
            "Microsoft.Security",
            "CA2103:ReviewImperativeSecurity",
            Justification = "This is a standard implementation of a union method."
        )]
        ...
        [SuppressMessage(
            "Microsoft.Security",
            "CA2103:ReviewImperativeSecurity",
            Justification = "This is a standard implementation of an intersection method."
        )]
        ...
        public override void FromXml(SecurityElement securityElement)
        {
            if (securityElement == null)
            {
                throw new ArgumentNullException(
                    SR.GetString(SR.ConfigurationPermissionBadXml, "securityElement")
                );
            }
            ...
            {
                throw new ArgumentException(
                    SR.GetString(SR.ConfigurationPermissionBadXml, "version")
                );
            }
            ...
            else
            {
                switch (unrestricted)
                {
                    ...
                    default:
                        throw new ArgumentException(
                            SR.GetString(SR.ConfigurationPermissionBadXml, "Unrestricted")
                        );
                }
            }
        }
