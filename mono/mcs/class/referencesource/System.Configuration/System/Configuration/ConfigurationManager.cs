...
namespace System.Configuration
{
    ...
    public static class ConfigurationManager
    {
        ...
        {
            get { return InitState.NotStarted < s_initState && s_initState < InitState.Completed; }
        }
            ...
            get
            {
                ...
                if (section == null || !(section is NameValueCollection))
                {
                    ...
                    throw new ConfigurationErrorsException(
                        SR.GetString(SR.Config_appsettings_declaration_invalid)
                    );
                }
        ...
        public static ConnectionStringSettingsCollection ConnectionStrings
        {
            get
            {
                ...
                if (section == null || section.GetType() != typeof(ConnectionStringsSection))
                {
                    ...
                    // Treat it as a configuration error.
                    throw new ConfigurationErrorsException(
                        SR.GetString(SR.Config_connectionstrings_declaration_invalid)
                    );
                }
