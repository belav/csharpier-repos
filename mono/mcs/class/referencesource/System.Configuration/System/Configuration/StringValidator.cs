        ...
        public override void Validate(object value)
        {
            ...
            if (len < _minLength)
            {
                throw new ArgumentException(
                    SR.GetString(SR.Validator_string_min_length, _minLength)
                );
            }
            ...
            {
                throw new ArgumentException(
                    SR.GetString(SR.Validator_string_max_length, _maxLength)
                );
            }
            ...
            if ((len > 0) && (_invalidChars != null) && (_invalidChars.Length > 0))
            {
                ...
                {
                    throw new ArgumentException(
                        SR.GetString(SR.Validator_string_invalid_chars, _invalidChars)
                    );
                }
            }
        }
