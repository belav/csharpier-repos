    ...
    public sealed class ConfigurationProperty
    {
        ...
        internal ConfigurationProperty(PropertyInfo info)
        {
            ...
            foreach (Attribute attribute in Attribute.GetCustomAttributes(info))
            {
                if (attribute is TypeConverterAttribute)
                {
                    ...
                    typeConverter = TypeUtil.CreateInstanceRestricted<TypeConverter>(
                        info.DeclaringType,
                ...
                else if (attribute is ConfigurationValidatorAttribute)
                {
                    ...
                    if (validator != null)
                    {
                        throw new ConfigurationErrorsException(
                            SR.GetString(SR.Validator_multiple_validator_attributes, info.Name)
                        );
                    }
            ...
            // Get the description
            if (
                (attribStdDescription != null)
                && !string.IsNullOrEmpty(attribStdDescription.Description)
            )
            {
        ...
        )
        {
            ...
            else
            {
                ...
                {
                    throw new ConfigurationErrorsException(
                        SR.GetString(SR.Validator_does_not_support_prop_type, _name)
                    );
                }
            }
        }
        ...
        private void SetDefaultValue(object value)
        {
            ...
            if (value != null && value != ConfigurationElement.s_nullPropertyValue)
            {
                ...
                {
                    throw new ConfigurationErrorsException(
                        SR.GetString(SR.Default_value_wrong_type, _name)
                    );
                }
        ...
        )
        {
            ...
            if (
                (defaultValue == null || defaultValue == ConfigurationElement.s_nullPropertyValue)
            ...
            if ((defaultValue != null) && (defaultValue is string) && (_type != typeof(string)))
            {
                ...
                catch (Exception ex)
                {
                    throw new ConfigurationErrorsException(
                        SR.GetString(
                            SR.Default_value_conversion_error_from_string,
                            _name,
                            ex.Message
                        )
                    );
        ...
        public string Name
        {
            [SuppressMessage(
                ...
                "CA8001",
                Justification = "_name is actually immutable once constructed"
            )]
            get { return _name; }
        }
        ...
        public string Description
        {
            [SuppressMessage(
                "Microsoft.Concurrency",
                "CA8001",
                Justification = "_description is actually immutable once constructed"
            )]
        ...
        internal string ProvidedName
        {
            [SuppressMessage(
                "Microsoft.Concurrency",
                "CA8001",
                Justification = "_providedName is actually immutable once constructed"
            )]
        ...
        internal bool IsConfigurationElementType
        {
            [SuppressMessage(
                "Microsoft.Concurrency",
                "CA8001",
                Justification = "_type is effectively readonly"
            )]
            get
            {
                if (!_isTypeInited)
        ...
        public Type Type
        {
            [SuppressMessage(
                "Microsoft.Concurrency",
                "CA8001",
                Justification = "_type is actually immutable once constructed"
            )]
            get { return _type; }
        }
        ...
        public Object DefaultValue
        {
            [SuppressMessage(
                "Microsoft.Concurrency",
                "CA8001",
                Justification = "_defaultValue is actually immutable once constructed"
            )]
        ...
        public bool IsRequired
        {
            [SuppressMessage(
                "Microsoft.Concurrency",
                "CA8001",
                Justification = "_options is actually immutable once constructed"
            )]
            get { return (_options & ConfigurationPropertyOptions.IsRequired) != 0; }
        }
        ...
        public bool IsKey
        {
            ...
            get { return (_options & ConfigurationPropertyOptions.IsKey) != 0; }
        }
        ...
        public bool IsDefaultCollection
        {
            ...
            get { return ((_options & ConfigurationPropertyOptions.IsDefaultCollection) != 0); }
        }
        ...
        public bool IsTypeStringTransformationRequired
        {
            ...
            get
            {
                return (_options & ConfigurationPropertyOptions.IsTypeStringTransformationRequired)
                    != 0;
            }
        }
        ...
        public bool IsVersionCheckRequired
        {
            ...
            get { return (_options & ConfigurationPropertyOptions.IsVersionCheckRequired) != 0; }
        }
        ...
        internal Object ConvertFromString(string value)
        {
            ...
            {
                throw new ConfigurationErrorsException(
                    SR.GetString(SR.Top_level_conversion_error_from_string, _name, ex.Message)
                );
            }
        ...
        internal string ConvertToString(Object value)
        {
            ...
            {
                throw new ConfigurationErrorsException(
                    SR.GetString(SR.Top_level_conversion_error_to_string, _name, ex.Message)
                );
            }
        ...
        [SuppressMessage(
            "Microsoft.Concurrency",
            "CA8001",
            Justification = "_name and _validator are effectively readonly"
        )]
        internal void Validate(object value)
        {
            ...
            {
                throw new ConfigurationErrorsException(
                    SR.GetString(SR.Top_level_validation_error, _name, ex.Message),
                    ex
                );
            }
        }
        ...
        private void CreateConverter()
        {
            ...
            if (_converter == null)
            {
                ...
                else if (!_type.IsSubclassOf(typeof(ConfigurationElement)))
                {
                    ...
                    {
                        throw new ConfigurationErrorsException(
                            SR.GetString(SR.No_converter, _name, _type.Name)
                        );
                    }
                }
            }
