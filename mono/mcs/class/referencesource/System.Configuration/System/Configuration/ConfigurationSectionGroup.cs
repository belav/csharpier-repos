    ...
    public class ConfigurationSectionGroup
    {
        ...
        )
        {
            ...
            if (_typeName != null)
            {
                ...
                _declarationRequired = (
                    parentFactoryRecord == null || parentFactoryRecord.FactoryTypeName == null
                );
        ...
        private void VerifyIsAttachedToConfigRecord()
        {
            if (_configRecord == null)
            {
                throw new InvalidOperationException(
                    SR.GetString(SR.Config_cannot_edit_configurationsectiongroup_when_not_attached)
                );
            }
        }
        ...
        {
            get { return _declarationRequired; }
        }
        ...
        public void ForceDeclaration(bool force)
        {
            ...
            {
                throw new InvalidOperationException(
                    SR.GetString(SR.Config_root_section_group_cannot_be_edited)
                );
            }
            ...
            {
                throw new InvalidOperationException(
                    SR.GetString(SR.Config_cannot_edit_configurationsectiongroup_in_location_config)
                );
            }
