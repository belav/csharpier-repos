...
namespace System.Activities.DurableInstancing
{
    ...
    sealed class LoadWorkflowByKeyAsyncResult : LoadWorkflowAsyncResult
    {
        ...
        {
            LoadWorkflowByInstanceKeyCommand keyLoadCommand =
                base.InstancePersistenceCommand as LoadWorkflowByInstanceKeyCommand;
            LoadType loadType = keyLoadCommand.AcceptUninitializedInstance
                ? LoadType.LoadOrCreateByKey
                : LoadType.LoadByKey;
            Guid key = keyLoadCommand.LookupInstanceKey;
            List<CorrelationKey> keysToAssociate = CorrelationKey.BuildKeyList(
                keyLoadCommand.InstanceKeysToAssociate,
