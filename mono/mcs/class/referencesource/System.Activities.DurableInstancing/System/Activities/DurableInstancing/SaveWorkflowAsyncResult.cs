...
namespace System.Activities.DurableInstancing
{
    ...
    {
        const string createServiceDeploymentStoredProcedureParameters =
            @"@serviceDeploymentHash, @siteName, @relativeServicePath, @relativeApplicationPath,
                @serviceName, @serviceNamespace, @serviceDeploymentId output";

        const string storedProcedureParameters40 =
            @"@instanceId, @surrogateLockOwnerId, @handleInstanceVersion, @handleIsBoundToLock,
...
@lastMachineRunOn, @executionStatus, @blockingBookmarks, @workflowHostType, @serviceDeploymentId, @operationTimeout";
        ...
        const string storedProcedureParameters =
            @"@instanceId, @surrogateLockOwnerId, @handleInstanceVersion, @handleIsBoundToLock,
@primitiveDataProperties, @complexDataProperties, @writeOnlyPrimitiveDataProperties, @writeOnlyComplexDataProperties, @metadataProperties,
@metadataIsConsistent, @encodingOption, @timerDurationMilliseconds, @suspensionStateChange, @suspensionReason, @suspensionExceptionName, @keysToAssociate,
@keysToComplete, @keysToFree, @concatenatedKeyProperties, @unlockInstance, @isReadyToRun, @isCompleted, @singleKeyId,
@lastMachineRunOn, @executionStatus, @blockingBookmarks, @workflowHostType, @serviceDeploymentId, @operationTimeout, @identityMetadata";
        ...
        protected override void GenerateSqlCommand(SqlCommand command)
        {
            SaveWorkflowCommand saveWorkflowCommand =
                base.InstancePersistenceCommand as SaveWorkflowCommand;
            ...
            parameters.Add(
                new SqlParameter
                {
                    ...
                    Value = GetSuspensionReason(
                        saveWorkflowCommand,
                        out suspensionReason,
                        out suspensionExceptionName
                    ),
                }
            );
            parameters.Add(
                new SqlParameter
                {
                    ...
                    Value = (object)suspensionReason ?? DBNull.Value,
                }
            );
            parameters.Add(
                new SqlParameter
                {
                    ...
                    SqlDbType = SqlDbType.NVarChar,
                    Size = 450,
                    Value = (object)suspensionExceptionName ?? DBNull.Value,
                }
            );
            parameters.Add(
                new SqlParameter
            ...
            if (base.Store.DatabaseVersion >= StoreUtilities.Version45)
            {
                ...
                parameters.Add(
                    new SqlParameter
                    {
                        ...
                        Value = (object)identityMetadataXml ?? DBNull.Value,
                    }
                );
        ...
        protected override Exception ProcessSqlResult(SqlDataReader reader)
        {
            ...
            if (exception == null)
            {
                ...
                if ((this.serviceDeploymentHash != Guid.Empty) && (this.serviceDeploymentId == 0))
                {
                    ...
                    exception = StoreUtilities.GetNextResultSet(
                        base.InstancePersistenceCommand.Name,
                        reader
                    );
                }
                ...
                if (exception == null)
                {
                    if (!base.InstancePersistenceContext.InstanceView.IsBoundToLock)
                    {
                        ...
                        instanceLockTracking.TrackStoreLock(
                            base.InstancePersistenceContext.InstanceView.InstanceId,
                            instanceVersion,
                    ...
                    SaveWorkflowAsyncResult.UpdateKeyData(
                        base.InstancePersistenceContext,
                        saveWorkflowCommand
                    );
        ...
        static void AddSerializedProperty(
        ...
        static string GetBlockingBookmarks(SaveWorkflowCommand saveWorkflowCommand)
        {
            ...
            if (
                saveWorkflowCommand.InstanceData
                    .TryGetValue(
            ...
            )
            {
                ...
                IEnumerable<BookmarkInfo> activeBookmarks =
                    binaryBlockingBookmarks.Value as IEnumerable<BookmarkInfo>;

                foreach (BookmarkInfo bookmarkInfo in activeBookmarks)
                {
                    bookmarkListBuilder.AppendFormat(
                        CultureInfo.InvariantCulture,
                        "[{0}: {1}]{2}",
                        bookmarkInfo.BookmarkName,
                        bookmarkInfo.OwnerDisplayName,
                        Environment.NewLine
                    );
                }
        ...
        static Int64? GetPendingTimerExpiration(SaveWorkflowCommand saveWorkflowCommand)
        {
            ...
            )
            {
                DateTime pendingTimerExpiration = (
                    (DateTime)pendingTimerExpirationPropertyValue.Value
                ).ToUniversalTime();
        ...
        static SuspensionStateChange GetSuspensionReason(
            SaveWorkflowCommand saveWorkflowCommand,
            out string suspensionReason,
            out string suspensionExceptionName
        )
        {
            IDictionary<XName, InstanceValue> instanceMetadataChanges =
                saveWorkflowCommand.InstanceMetadataChanges;
            ...
            if (
                instanceMetadataChanges.TryGetValue(
        ...
        )
        {
            ...
            )
            {
                if (!instanceView.InstanceKeys.ContainsKey(keyEntry.Key))
                {
                    ...
                    if (keyEntry.Value != null)
                    {
                        ...
                        {
                            context.WroteInstanceKeyMetadataValue(
                                keyEntry.Key,
                                property.Key,
                                property.Value
                            );
            ...
            {
                foreach (
                    KeyValuePair<Guid, InstanceKeyView> instanceKeys in instanceView.InstanceKeys
                )
                {
        ...
        void ExtractServiceDeploymentInformation(
            SaveWorkflowCommand saveWorkflowCommand,
        ...
        )
        {
            ...
            )
            {
                if (PersistenceMetadataNamespace.ActivationTypes.WAS.Equals(instanceValue.Value))
                {
                    ...
                    byte[] serviceDeploymentHashBuffer = Encoding.Unicode
                        .GetBytes(
                            string.Format(
                                CultureInfo.InvariantCulture,
                                "{0}#{1}#{2}#{3}#{4}",
            ...
            if ((this.serviceDeploymentHash != Guid.Empty) && (this.serviceDeploymentId == 0))
            {
                ...
                commandTextBuilder.AppendLine(
                    string.Format(
                        CultureInfo.InvariantCulture,
                        "exec {0}.[CreateServiceDeployment] {1} ;",
                        SqlWorkflowInstanceStoreConstants.DefaultSchema,
                        SaveWorkflowAsyncResult.createServiceDeploymentStoredProcedureParameters
                    )
                );
                ...
                parameters.Add(
                    new SqlParameter
                    {
                        ...
                        Size = -1,
                        SqlDbType = SqlDbType.NVarChar,
                        Value = serviceName ?? (object)DBNull.Value,
                    }
                );
                parameters.Add(
                    new SqlParameter
                    {
                        ...
                        Size = -1,
                        SqlDbType = SqlDbType.NVarChar,
                        Value = serviceNamespace ?? (object)DBNull.Value,
                    }
                );
                parameters.Add(
                    new SqlParameter
                    {
                        ...
                        Size = -1,
                        SqlDbType = SqlDbType.NVarChar,
                        Value = site ?? (object)DBNull.Value,
                    }
                );
                parameters.Add(
                    new SqlParameter
                    {
                        ...
                        Size = -1,
                        SqlDbType = SqlDbType.NVarChar,
                        Value = relativeServicePath ?? (object)DBNull.Value,
                    }
                );
                parameters.Add(
                    new SqlParameter
                    {
                        ...
                        Size = -1,
                        SqlDbType = SqlDbType.NVarChar,
                        Value = relativeApplicationPath ?? (object)DBNull.Value,
                    }
                );
            }
            else
                    ...
                    new SqlParameter
                    {
                        ...
                        Value =
                            (this.serviceDeploymentId != 0)
                                ? (object)this.serviceDeploymentId
                                : (object)DBNull.Value,
                    }
                );
            }
        ...
        void GetServiceDeploymentId()
        {
            try
            {
                ...
                SaveWorkflowAsyncResult.serviceDeploymentIdsCache
        ...
        )
        {
            ...
            List<CorrelationKey> keysToAssociate = CorrelationKey.BuildKeyList(
                saveWorkflowCommand.InstanceKeysToAssociate,
                base.Store.InstanceEncodingOption
            );
            List<CorrelationKey> keysToComplete = CorrelationKey.BuildKeyList(
                saveWorkflowCommand.InstanceKeysToComplete
            );
            List<CorrelationKey> keysToFree = CorrelationKey.BuildKeyList(
                saveWorkflowCommand.InstanceKeysToFree
            );
            ArraySegment<byte>[] dataProperties = SerializationUtilities.SerializePropertyBag(
                saveWorkflowCommand.InstanceData,
                base.Store.InstanceEncodingOption
            );
            ArraySegment<byte> metadataProperties =
                SerializationUtilities.SerializeMetadataPropertyBag(
                    saveWorkflowCommand,
                    base.InstancePersistenceContext,
                    base.Store.InstanceEncodingOption
                );
            byte[] concatenatedKeyProperties = SerializationUtilities.CreateKeyBinaryBlob(
                keysToAssociate
            );
            bool metadataConsistency = (
                base.InstancePersistenceContext.InstanceView.InstanceMetadataConsistency
            ...
            parameters.Add(
                new SqlParameter
                {
                    ParameterName = "@keysToComplete",
                    SqlDbType = SqlDbType.Xml,
                    Value = SerializationUtilities.CreateCorrelationKeyXmlBlob(keysToComplete),
                }
            );
            parameters.Add(
                new SqlParameter
                {
                    ParameterName = "@keysToFree",
                    SqlDbType = SqlDbType.Xml,
                    Value = SerializationUtilities.CreateCorrelationKeyXmlBlob(keysToFree),
                }
            );
            parameters.Add(
                new SqlParameter
            ...
            parameters.Add(
                new SqlParameter
                {
                    ...
                    SqlDbType = SqlDbType.NVarChar,
                    Size = 450,
                    Value = GetExecutionStatus(saveWorkflowCommand) ?? (object)DBNull.Value,
                }
            );
            parameters.Add(
                new SqlParameter
                {
                    ...
                    SqlDbType = SqlDbType.NVarChar,
                    Size = -1,
                    Value = GetBlockingBookmarks(saveWorkflowCommand) ?? (object)DBNull.Value,
                }
            );
            ...
            for (int i = 0; i < 5; i++)
            {
                SaveWorkflowAsyncResult.AddSerializedProperty(
                    properties[i],
                    parameters,
                    dataPropertyParameters[i]
                );
            }
        ...
        )
        {
            ...
            foreach (
                KeyValuePair<string, Tuple<List<XName>, List<XName>>> promotion in base.Store
                    .Promotions
            )
            {
                StringBuilder storedProcInvocationBuilder = new StringBuilder(
                    SqlWorkflowInstanceStoreConstants.DefaultStringBuilderCapacity
                );
                int column = SqlVariantStartColumn;
                bool addPromotion = false;
                string promotionNameArgument = string.Format(
                    CultureInfo.InvariantCulture,
                    "@promotionName{0}",
                    promotionNumber
                );
                string instanceIdArgument = string.Format(
                    CultureInfo.InvariantCulture,
                    "@instanceId{0}",
                    promotionNumber
                );
                ...
                foreach (XName name in promotion.Value.Item1)
                {
                    ...
                    {
                        if (
                            !SerializationUtilities.IsPropertyTypeSqlVariantCompatible(
                                propertyValue
                            )
                        )
                        {
                        ...
                        string argumentName = string.Format(
                            CultureInfo.InvariantCulture,
                            "@value{0}_promotion{1}",
                            column,
                            promotionNumber
                        );
                        parameters.Add(
                            new SqlParameter()
                            {
                                ...
                                Value = propertyValue.Value ?? DBNull.Value,
                            }
                        );
                ...
                foreach (XName name in promotion.Value.Item2)
                {
                    ...
                    if (saveWorkflowCommand.InstanceData.TryGetValue(name, out propertyValue))
                    {
                        ...
                        SaveWorkflowAsyncResult.AddSerializedProperty(
                            serializer.SerializeValue(propertyValue.Value),
                            parameters,
                            argumentName
                        );
                        storedProcInvocationBuilder.Append(", ");
                ...
                if (addPromotion)
                {
                    parameters.Add(
                        new SqlParameter()
                        {
                            SqlDbType = SqlDbType.NVarChar,
                            Size = 400,
                            ParameterName = promotionNameArgument,
                            Value = promotion.Key,
                        }
                    );
                    parameters.Add(
                        ...
                        {
                            SqlDbType = SqlDbType.UniqueIdentifier,
                            ParameterName = instanceIdArgument,
                            Value = base.InstancePersistenceContext.InstanceView.InstanceId,
                        }
                    );
                    storedProcInvocationBuilder.Append(";");
