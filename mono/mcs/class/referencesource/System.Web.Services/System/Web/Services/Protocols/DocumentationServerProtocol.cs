...
namespace System.Web.Services.Protocols
{
    ...
    internal class DocumentationServerType : ServerType
    {
        ...
        internal DocumentationServerType(
            Type type,
            string uri,
            ...
            : base(typeof(DocumentationServerProtocol))
        {
            ...
            methodInfo = new LogicalMethodInfo(
                typeof(DocumentationServerProtocol).GetMethod(
                    "Documentation",
    ...
    internal sealed class DocumentationServerProtocol : ServerProtocol
    {
        ...
        internal override bool Initialize()
        {
            ...
            if (
                null
                    == (
                        serverType = (DocumentationServerType)GetFromCache(
                            typeof(DocumentationServerProtocol),
                            Type
                        )
                    )
                && null
                ...
                if (Tracing.On)
                    Tracing.Enter(
                        ...
                        new TraceMethod(
                            ...
                            config.WsdlHelpGenerator.HelpGeneratorVirtualPath,
                            config.WsdlHelpGenerator.HelpGeneratorPath,
                            Context
                        )
                    );

                handler = GetCompiledPageInstance(
                    config.WsdlHelpGenerator.HelpGeneratorVirtualPath,
                    config.WsdlHelpGenerator.HelpGeneratorPath,
                    Context
                );
        ...
        private IHttpHandler GetCompiledPageInstance(
            string virtualPath,
            string inputFile,
            HttpContext context
        )
        ...
        internal override void WriteReturns(object[] returnValues, Stream outputStream)
        {
            ...
            catch (Exception e)
            {
                ...
                throw new InvalidOperationException(
                    Res.GetString(Res.HelpGeneratorInternalError),
                    e
                );
            }
        }
