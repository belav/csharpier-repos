    ...
    public sealed class WebServicesSection : ConfigurationSection
    {
        ...
        public static WebServicesSection Current
        {
            get
            {
                ...
                if (retval == null)
                {
                    retval = (WebServicesSection)
                        PrivilegedConfigurationManager.GetSection(WebServicesSection.SectionName);
                }
                return retval;
            }
        }
                ...
                if (this.discoveryDocumentSerializer == null)
                {
                    lock (WebServicesSection.ClassSyncObject)
                    {
                        if (this.discoveryDocumentSerializer == null)
                        {
                            ...
                            {
                                object[] xmlElementAttribs =
                                    discoveryReferenceType.GetCustomAttributes(
                                ...
                                if (xmlElementAttribs.Length == 0)
                                {
                                    throw new InvalidOperationException(
                                        Res.GetString(
                                            Res.WebMissingCustomAttribute,
                                            discoveryReferenceType.FullName,
                                            "XmlRoot"
                                        )
                                    );
                                }
        ...
        internal Type[] GetAllFormatExtensionTypes()
        {
            ...
            {
                Type[] formatTypes = new Type[
                    defaultFormatTypes.Length + this.ServiceDescriptionFormatExtensionTypes.Count
                ];
                Array.Copy(defaultFormatTypes, formatTypes, defaultFormatTypes.Length);

                for (
                    int index = 0;
                    index < this.ServiceDescriptionFormatExtensionTypes.Count;
                    ++index
                )
                {
                    formatTypes[index + defaultFormatTypes.Length] =
                        this.ServiceDescriptionFormatExtensionTypes[index].Type;
                }
                return formatTypes;
            }
        }
        ...
        static XmlFormatExtensionPointAttribute GetExtensionPointAttribute(Type type)
        {
            object[] attrs = type.GetCustomAttributes(
                typeof(XmlFormatExtensionPointAttribute),
                false
            );
            if (attrs.Length == 0)
                throw new ArgumentException(
                    Res.GetString(Res.TheSyntaxOfTypeMayNotBeExtended1, type.FullName),
                    "type"
                );
        ...
        internal static void LoadXmlFormatExtensions(
            Type[] extensionTypes,
        ...
        )
        {
            ...
            foreach (Type extensionType in extensionTypes)
            {
                ...
                object[] attrs = extensionType.GetCustomAttributes(
                ...
                if (attrs.Length == 0)
                {
                    throw new ArgumentException(
                        Res.GetString(
                            Res.RequiredXmlFormatExtensionAttributeIsMissing1,
                ...
                foreach (Type extensionPointType in extensionAttr.ExtensionPoints)
                {
                    ...
                    XmlElementAttribute xmlAttr = new XmlElementAttribute(
                        extensionAttr.ElementName,
                        extensionType
                    );
                ...
                attrs = extensionType.GetCustomAttributes(
                    typeof(XmlFormatExtensionPrefixAttribute),
                    false
                );
                ...
                {
                    XmlFormatExtensionPrefixAttribute prefixAttr =
                        (XmlFormatExtensionPrefixAttribute)attrs[i];
            ...
            {
                XmlFormatExtensionPointAttribute attr = GetExtensionPointAttribute(
                    extensionPointType
                );
                XmlAttributes xmlAttrs = (XmlAttributes)table[extensionPointType];
            ...
            get
            {
                if (this.serverProtocolFactories == null)
                {
                    lock (WebServicesSection.ClassSyncObject)
                    {
                        ...
                        {
                            WebServiceProtocols enabledProtocols = this.EnabledProtocols;
                            List<ServerProtocolFactory> serverProtocolFactoryList =
                                new List<ServerProtocolFactory>();
                            ...
                            {
                                serverProtocolFactoryList.Add(
                                    new HttpPostLocalhostServerProtocolFactory()
                                );
                            }
                            if ((enabledProtocols & WebServiceProtocols.HttpGet) != 0)
                            {
                            ...
                            if ((enabledProtocols & WebServiceProtocols.Documentation) != 0)
                            {
                                ...
                                serverProtocolFactoryList.Add(
                                    new DocumentationServerProtocolFactory()
                                );
                            }
        ...
        readonly ConfigurationProperty conformanceWarnings = new ConfigurationProperty(
            "conformanceWarnings",
            typeof(WsiProfilesElementCollection),
            null,
            ConfigurationPropertyOptions.None
        );
        readonly ConfigurationProperty protocols = new ConfigurationProperty(
            "protocols",
            typeof(ProtocolElementCollection),
            null,
            ConfigurationPropertyOptions.None
        );
        readonly ConfigurationProperty serviceDescriptionFormatExtensionTypes =
            new ConfigurationProperty(
                "serviceDescriptionFormatExtensionTypes",
                typeof(TypeElementCollection),
                null,
                ConfigurationPropertyOptions.None
            );
        readonly ConfigurationProperty soapEnvelopeProcessing = new ConfigurationProperty(
            "soapEnvelopeProcessing",
            typeof(SoapEnvelopeProcessingElement),
            null,
            ConfigurationPropertyOptions.None
        );
        readonly ConfigurationProperty soapExtensionImporterTypes = new ConfigurationProperty(
            "soapExtensionImporterTypes",
            typeof(TypeElementCollection),
            null,
            ConfigurationPropertyOptions.None
        );
        readonly ConfigurationProperty soapExtensionReflectorTypes = new ConfigurationProperty(
            "soapExtensionReflectorTypes",
            typeof(TypeElementCollection),
            null,
            ConfigurationPropertyOptions.None
        );
        readonly ConfigurationProperty soapExtensionTypes = new ConfigurationProperty(
            "soapExtensionTypes",
            typeof(SoapExtensionTypeElementCollection),
            null,
            ConfigurationPropertyOptions.None
        );
        readonly ConfigurationProperty soapTransportImporterTypes = new ConfigurationProperty(
            "soapTransportImporterTypes",
            typeof(TypeElementCollection),
            null,
            ConfigurationPropertyOptions.None
        );
        readonly ConfigurationProperty wsdlHelpGenerator = new ConfigurationProperty(
            "wsdlHelpGenerator",
            typeof(WsdlHelpGeneratorElement),
            null,
            ConfigurationPropertyOptions.None
        );
        readonly ConfigurationProperty soapServerProtocolFactoryType = new ConfigurationProperty(
            "soapServerProtocolFactory",
            typeof(TypeElement),
            null,
            ConfigurationPropertyOptions.None
        );
        readonly ConfigurationProperty diagnostics = new ConfigurationProperty(
            "diagnostics",
            typeof(DiagnosticsElement),
            null,
            ConfigurationPropertyOptions.None
        );
        ...
        Type[] discoveryReferenceTypes = new Type[]
        {
