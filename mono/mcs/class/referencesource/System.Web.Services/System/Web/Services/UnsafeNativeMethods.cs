...
namespace System.Web.Services
{
    ...
    internal class UnsafeNativeMethods
    {
        ...
        internal static INotifySink2 RegisterNotifySource(
            INotifyConnection2 connection,
            INotifySource2 source
        )
        {
            return connection.RegisterNotifySource(source);
        }

        internal static void UnregisterNotifySource(
            INotifyConnection2 connection,
            INotifySource2 source
        )
        {
