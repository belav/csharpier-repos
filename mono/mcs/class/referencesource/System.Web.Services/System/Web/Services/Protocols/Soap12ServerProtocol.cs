    ...
    internal class Soap12ServerProtocolHelper : SoapServerProtocolHelper
    {
        ...
        internal override SoapServerMethod RouteRequest()
        {
            ...
            if (action != null && action.Length > 0)
            {
                ...
                if (Tracing.On)
                    Tracing.Enter(
                        "RouteRequest",
                        caller,
                        new TraceMethod(ServerType, "GetMethod", action),
            ...
            if (method == null)
            {
                ...
                if (Tracing.On)
                    Tracing.Enter(
                        "RouteRequest",
                        caller,
                        new TraceMethod(ServerType, "GetMethod", requestElement),
                        Tracing.Details(ServerProtocol.Request)
                    );
            ...
            if (method == null)
            {
                ...
                else
                {
                    ...
                    throw new SoapException(
                        Res.GetString(Res.UnableToHandleRequestActionNotRecognized1, action),
                        Soap12FaultCodes.SenderFaultCode
                    );
                }
            }
        ...
        )
        {
            ...
            if (ServerProtocol.ServerMethod != null)
                ...
                SoapHeaderHandling.WriteUnknownHeaders(
                    writer,
                    ServerProtocol.Message.Headers,
                    Soap12.Namespace
                );
            ...
            WriteFaultCodeValue(
                writer,
                TranslateFaultCode(soapException.Code),
