    ...
    internal class SchemaCompiler
    {
        ...
        internal static string WarningDetails(XmlSchemaException exception, string message)
        {
            ...
            else
            {
                ...
                details = Res.GetString(
                    Res.SchemaSyntaxErrorDetails,
                    ns,
                    message,
            ...
            else if (o is XmlSchemaAttribute)
            {
                ...
                if (a.Name == null || a.Name.Length == 0)
                {
                    ...
                    return Res.GetString(
                        Res.XmlSchemaAttributeReference,
                        a.RefName.ToString(),
                        parentName.Name,
                        parentName.Namespace
                    );
            ...
            Warnings.Add(
                Res.GetString(
                    args.Severity == XmlSeverityType.Error
                        ? Res.SchemaValidationError
                        : Res.SchemaValidationWarning,
                    WarningDetails(args.Exception, args.Message)
                )
            );
        }
    }
