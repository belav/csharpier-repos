...
namespace System.Web.Services.Description
{
    ...
    public class WebReferenceOptions
    {
        ...
        {
            get { return codeGenerationOptions; }
        ...
        ///    <para>[To be supplied.]</para>
        /// </devdoc>
        public static WebReferenceOptions Read(
            TextReader reader,
    ...
    internal class WebReferenceOptionsSerializationWriter : XmlSerializationWriter
    {
        string Write1_CodeGenerationOptions(System.Xml.Serialization.CodeGenerationOptions v)
        {
            ...
            switch (v)
            {
                case System.Xml.Serialization.CodeGenerationOptions.@GenerateProperties:
                    s = @"properties";
                    break;
                case System.Xml.Serialization.CodeGenerationOptions.@GenerateNewAsync:
                    s = @"newAsync";
                    break;
                case System.Xml.Serialization.CodeGenerationOptions.@GenerateOldAsync:
                    s = @"oldAsync";
                    break;
                case System.Xml.Serialization.CodeGenerationOptions.@GenerateOrder:
                    s = @"order";
                    break;
                case System.Xml.Serialization.CodeGenerationOptions.@EnableDataBinding:
                    s = @"enableDataBinding";
                    break;
                default:
                    s = FromEnum(
        ...
        string Write2_ServiceDescriptionImportStyle(
            System.Web.Services.Description.ServiceDescriptionImportStyle v
        )
        {
            string s = null;
            switch (v)
            {
                case System.Web.Services.Description.ServiceDescriptionImportStyle.@Client:
                    s = @"client";
                    break;
                case System.Web.Services.Description.ServiceDescriptionImportStyle.@Server:
                    s = @"server";
                    break;
                case System.Web.Services.Description.ServiceDescriptionImportStyle.@ServerInterface:
                    s = @"serverInterface";
                    break;
                default:
        ...
        void Write4_WebReferenceOptions(
            string n,
            string ns,
            WebReferenceOptions o,
            bool isNullable,
            bool needType
        )
        {
            ...
            if (
                ((CodeGenerationOptions)o.@CodeGenerationOptions)
            ...
            )
            {
                WriteElementString(
                    ...
                    Write1_CodeGenerationOptions(((CodeGenerationOptions)o.@CodeGenerationOptions))
                );
            }
            {
                System.Collections.Specialized.StringCollection a =
                    (System.Collections.Specialized.StringCollection)(
                        (System.Collections.Specialized.StringCollection)o.@SchemaImporterExtensions
                    );
                if (a != null)
                {
                    WriteStartElement(
            ...
            if (
                ((System.Web.Services.Description.ServiceDescriptionImportStyle)o.@Style)
            ...
            WriteElementStringRaw(
                @"verbose",
                @"http://microsoft.com/webReference/",
                System.Xml.XmlConvert.ToString((System.Boolean)((System.Boolean)o.@Verbose))
            );
            WriteEndElement(o);
        }
    ...
    internal class WebReferenceOptionsSerializationReader : XmlSerializationReader
    {
        ...
        internal System.Collections.Hashtable CodeGenerationOptionsValues
        {
            get
            {
                if ((object)_CodeGenerationOptionsValues == null)
                {
                    ...
                    h.Add(
                        @"properties",
                        (long)System.Xml.Serialization.CodeGenerationOptions.@GenerateProperties
                    );
                    h.Add(
                        @"newAsync",
                        (long)System.Xml.Serialization.CodeGenerationOptions.@GenerateNewAsync
        ...
        {
            return (System.Xml.Serialization.CodeGenerationOptions)ToEnum(
                s,
                CodeGenerationOptionsValues,
                @"System.Xml.Serialization.CodeGenerationOptions"
            );
        }

        System.Web.Services.Description.ServiceDescriptionImportStyle Read2_ServiceDescriptionImportStyle(
            string s
        )
        {
            switch (s)
            {
                case @"client":
                    return System.Web.Services.Description.ServiceDescriptionImportStyle.@Client;
                case @"server":
                ...
                default:
                    throw CreateUnknownConstantException(
                        s,
                        typeof(System.Web.Services.Description.ServiceDescriptionImportStyle)
                    );
            }
        }

        System.Web.Services.Description.WebReferenceOptions Read4_WebReferenceOptions(
            bool isNullable,
            bool checkType
        )
        {
                ...
                if (
                    ...
                    || (
                        (object)((System.Xml.XmlQualifiedName)xsiType).Name
                            == (object)id1_webReferenceOptions
            ...
            System.Collections.Specialized.StringCollection a_1 =
                (System.Collections.Specialized.StringCollection)o.@SchemaImporterExtensions;
            ...
            )
            {
                if (Reader.NodeType == System.Xml.XmlNodeType.Element)
                {
                    if (
                        !paramsRead[0]
                        && (
                            (object)Reader.LocalName == (object)id3_codeGenerationOptions
                    ...
                    )
                    {
                        ...
                        (
                            (object)Reader.LocalName == (object)id4_schemaImporterExtensions
                            && (object)Reader.NamespaceURI == (object)id2_Item
                        )
                    )
                    {
                        if (!ReadNull())
                        {
                            System.Collections.Specialized.StringCollection a_1_0 =
                                (System.Collections.Specialized.StringCollection)
                                    o.@SchemaImporterExtensions;
                            ...
                            else
                            {
                                ...
                                )
                                {
                                    if (Reader.NodeType == System.Xml.XmlNodeType.Element)
                                    {
                                        if (
                                            (
                                                (object)Reader.LocalName == (object)id5_type
                                                && (object)Reader.NamespaceURI == (object)id2_Item
                                            )
                                        )
                                        {
                                        ...
                                        else
                                        {
                                            UnknownNode(
                                                null,
                                                @"http://microsoft.com/webReference/:type"
                                            );
                                        }
                                    }
                                    else
                        ...
                        !paramsRead[2]
                        && (
                            (object)Reader.LocalName == (object)id6_style
                            && (object)Reader.NamespaceURI == (object)id2_Item
                        )
                    )
                    {
                        ...
                        !paramsRead[3]
                        && (
                            (object)Reader.LocalName == (object)id7_verbose
                            && (object)Reader.NamespaceURI == (object)id2_Item
                        )
                    )
                    {
                    ...
                    else
                    {
                        UnknownNode(
                            (object)o,
                            @"http://microsoft.com/webReference/:codeGenerationOptions, http://microsoft.com/webReference/:schemaImporterExtensions, http://microsoft.com/webReference/:style, http://microsoft.com/webReference/:verbose"
                        );
                    }
                }
                else
        ...
        internal object Read5_webReferenceOptions()
        {
            ...
            if (Reader.NodeType == System.Xml.XmlNodeType.Element)
            {
                if (
                    (
                        (object)Reader.LocalName == (object)id1_webReferenceOptions
                        && (object)Reader.NamespaceURI == (object)id2_Item
                    )
                )
                {
