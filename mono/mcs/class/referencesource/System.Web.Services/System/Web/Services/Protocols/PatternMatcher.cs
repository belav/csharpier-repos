    ...
    internal class MatchMember
    {
        ...
        static Exception BadCaptureIndexException(int index, string matchName, int highestIndex)
        {
            return new Exception(
                Res.GetString(Res.WebTextMatchBadCaptureIndex, index, matchName, highestIndex)
            );
        }
        ...
        {
            return new Exception(
                Res.GetString(Res.WebTextMatchBadGroupIndex, index, matchName, highestIndex)
            );
        }
