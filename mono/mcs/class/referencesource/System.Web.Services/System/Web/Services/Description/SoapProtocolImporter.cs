...
namespace System.Web.Services.Description
{
    ...
    internal class SoapParameters
    {
        ...
        internal SoapParameters(
            XmlMembersMapping request,
            XmlMembersMapping response,
        ...
        )
        {
            ...
            if (response != null)
                AddMappings(responseList, response);
            ...
            foreach (SoapParameter parameter in parameters)
            {
                parameter.name = identifiers.MakeUnique(
                    CodeIdentifier.MakeValid(parameter.mapping.MemberName)
                );
            }
        }
        ...
        {
            XmlMemberMapping responseMapping = FindMapping(
                responseList,
                requestMapping.ElementName
            );
            if (responseMapping == null)
                return false;
            if (requestMapping.TypeFullName != responseMapping.TypeFullName)
                return false;
            if (requestMapping.Namespace != responseMapping.Namespace)
                return false;
            if (requestMapping.MemberName != responseMapping.MemberName)
                return false;
            responseList.Remove(responseMapping);
            return true;
        }
    ...
    internal class SoapParameter
    {
        ...
        internal static string[] GetTypeFullNames(
            IList parameters,
            int specifiedCount,
        ...
        internal static void GetTypeFullNames(
            IList parameters,
        ...
        )
        {
            ...
            {
                typeFullNames[i + start + specified] = WebCodeGenerator.FullTypeName(
                    ((SoapParameter)parameters[i]).mapping,
                    codeProvider
                );
        ...
        internal static void GetCodeFlags(
            IList parameters,
            CodeFlags[] codeFlags,
            int start,
            int specifiedCount
    ...
    public class SoapProtocolImporter : ProtocolImporter
    {
        ...
        protected override void BeginNamespace()
        {
            try
            {
                ...
                soapImporter = new SoapSchemaImporter(
                    AbstractSchemas,
                    ServiceImporter.CodeGenerationOptions,
                    ImportContext
                );
                xmlImporter = new XmlSchemaImporter(
                    ConcreteSchemas,
                    ServiceImporter.CodeGenerationOptions,
                ...
                xmlExporter = new XmlCodeExporter(
                    this.CodeNamespace,
                ...
                soapExporter = new SoapCodeExporter(
                    this.CodeNamespace,
                    null,
                    ServiceImporter.CodeGenerator,
                    ServiceImporter.CodeGenerationOptions,
        ...
        protected override bool IsBindingSupported()
        {
            ...
            if (GetTransport(soapBinding.Transport) == null)
            {
                UnsupportedBindingWarning(
                    Res.GetString(
                        Res.ThereIsNoSoapTransportImporterThatUnderstands1,
        ...
        internal SoapTransportImporter GetTransport(string transport)
        {
            foreach (Type type in WebServicesSection.Current.SoapTransportImporters)
            {
                ...
                if (transportImporter.IsSupportedTransport(transport))
                    return transportImporter;
            }
            return null;
        }
        ...
        protected override CodeTypeDeclaration BeginClass()
        {
            ...
            CodeTypeDeclaration codeClass = WebCodeGenerator.CreateClass(
                this.ClassName,
                null,
                new string[0],
                null,
                CodeFlags.IsPublic | flags,
            ...
            {
                CodeAttributeDeclaration webService = new CodeAttributeDeclaration(
            ...
            if (extensions == null)
            {
                ...
                for (int i = 0; i < extensions.Length; i++)
                {
                    SoapExtensionImporter extension = (SoapExtensionImporter)
                        Activator.CreateInstance(extensionTypes[i].Type);
        ...
        void PrepareHeaders(MessageBinding messageBinding)
        {
            ...
            SoapHeaderBinding[] headers = (SoapHeaderBinding[])
                messageBinding.Extensions.FindAll(typeof(SoapHeaderBinding));
        ...
        )
        {
            ...
            for (int i = 0; i < 2; ++i)
            {
                ...
                SoapHeaderBinding[] headerBindings = (SoapHeaderBinding[])
                    messageBinding.Extensions.FindAll(typeof(SoapHeaderBinding));
                foreach (SoapHeaderBinding header in headerBindings)
                {
                    ...
                    if (!header.MapToProperty)
                        continue;

                    if (use != header.Use)
                        throw new InvalidOperationException(
                            Res.GetString(Res.WebDescriptionHeaderAndBodyUseMismatch)
                        );
                    if (use == SoapBindingUse.Encoded && !IsSoapEncodingPresent(header.Encoding))
                        throw new InvalidOperationException(
                            Res.GetString(Res.WebUnknownEncodingStyle, header.Encoding)
                        );
                    ...
                    if (use == SoapBindingUse.Encoded)
                    {
                        if (part.Type.IsEmpty)
                            throw new InvalidOperationException(
                                Res.GetString(
                                    Res.WebDescriptionPartTypeRequired,
                                    part.Name,
                                    header.Message.Name,
                                    header.Message.Namespace
                                )
                        ...
                        if (!part.Element.IsEmpty)
                            UnsupportedOperationBindingWarning(
                                Res.GetString(
                                    Res.WebDescriptionPartElementWarning,
                                    part.Name,
                                    header.Message.Name,
                                    header.Message.Namespace
                                )
                            );
                        mapping = soapImporter.ImportDerivedTypeMapping(
                            part.Type,
                            typeof(SoapHeader),
                            true
                        );
                    ...
                    else
                    {
                        if (part.Element.IsEmpty)
                            throw new InvalidOperationException(
                                Res.GetString(
                                    Res.WebDescriptionPartElementRequired,
                                    part.Name,
                                    header.Message.Name,
                                    header.Message.Namespace
                                )
                        ...
                        if (!part.Type.IsEmpty)
                            UnsupportedOperationBindingWarning(
                                Res.GetString(
                                    Res.WebDescriptionPartTypeWarning,
                                    part.Name,
                                    header.Message.Name,
                                    header.Message.Namespace
                                )
                            );
                        mapping = xmlImporter.ImportDerivedTypeMapping(
                            part.Element,
                            typeof(SoapHeader),
                            true
                        );
            ...
            foreach (LocalSoapHeader soapHeader in localHeaders.Values)
            {
                ...
                if (soapHeader.direction == SoapHeaderDirection.Out)
                {
                    AddMetadataProperty(
                        ...
                        new CodeFieldReferenceExpression(
                            new CodeTypeReferenceExpression(typeof(SoapHeaderDirection).FullName),
                            SoapHeaderDirection.Out.ToString()
                        )
                    );
                }
                else if (soapHeader.direction == SoapHeaderDirection.InOut)
                {
                    AddMetadataProperty(
                        ...
                        new CodeFieldReferenceExpression(
                            new CodeTypeReferenceExpression(typeof(SoapHeaderDirection).FullName),
                            SoapHeaderDirection.InOut.ToString()
                        )
                    );
                }
        ...
        protected override CodeMemberMethod GenerateMethod()
        {
            ...
            SoapOperationBinding soapOperationBinding = (SoapOperationBinding)
                this.OperationBinding.Extensions.Find(typeof(SoapOperationBinding));
            if (soapOperationBinding == null)
                throw OperationBindingSyntaxException(
                    Res.GetString(Res.MissingSoapOperationBinding0)
                );
            ...
            soapRequestBinding = (SoapBodyBinding)
                this.OperationBinding.Input.Extensions.Find(typeof(SoapBodyBinding));
            ...
            if (this.Operation.Messages.Output != null)
            {
                ...
                soapResponseBinding = (SoapBodyBinding)
                    this.OperationBinding.Output.Extensions.Find(typeof(SoapBodyBinding));
                if (soapResponseBinding == null)
                {
                    UnsupportedOperationBindingWarning(
                        Res.GetString(Res.MissingSoapBodyOutputBinding0)
                    );
                    return null;
                }
            }
            ...
            if (responseBinding != null)
                PrepareHeaders(responseBinding);

            string requestMessageName;
            string responseMessageName = null;

            requestMessageName =
                !String.IsNullOrEmpty(requestBinding.Name)
                && soapBindingStyle != SoapBindingStyle.Rpc
                    ? requestBinding.Name
                    : this.Operation.Name; // per WSDL 1.1 sec 3.5
            requestMessageName = XmlConvert.DecodeName(requestMessageName);

            if (responseBinding != null)
            {
                responseMessageName =
                    !String.IsNullOrEmpty(responseBinding.Name)
                    && soapBindingStyle != SoapBindingStyle.Rpc
                        ? responseBinding.Name
                        : this.Operation.Name + "Response"; // per WSDL 1.1 sec 3.5
            ...
            bool wrapperNamesMatter =
                (soapBindingStyle != SoapBindingStyle.Rpc && hasWrapper)
                || (
                    soapRequestBinding.Use == SoapBindingUse.Literal
                    && soapBindingStyle == SoapBindingStyle.Rpc
                );

            XmlMembersMapping request = ImportMessage(
                requestMessageName,
                requestParts,
                soapRequestBinding,
                soapBindingStyle,
            ...
            string methodName = CodeIdentifier.MakeValid(
                XmlConvert.DecodeName(this.Operation.Name)
            );
            ...
            string uniqueMethodName = MethodNames.AddUnique(
                CodeIdentifier.MakeValid(XmlConvert.DecodeName(methodName)),
                this.Operation
            );
            ...
            {
                if (
                    (param.IsOut || param.IsByRef)
                    && !ServiceImporter.CodeGenerator.Supports(GeneratorSupport.ReferenceParameters)
                )
                {
                    UnsupportedOperationWarning(
                        Res.GetString(
                            Res.CodeGenSupportReferenceParameters,
                            ServiceImporter.CodeGenerator.GetType().Name
                        )
                    );
                    return null;
                }
                ...
                if (param.mapping.CheckSpecified)
                    param.specifiedName = localIdentifiers.AddUnique(
            ...
            if (!(Style == ServiceDescriptionImportStyle.Client) || differentNames)
            {
                BeginMetadata();
                if (differentNames)
                    AddMetadataProperty("MessageName", uniqueMethodName);
            ...
            if (
                wrapperNamesMatter
                && request.ElementName.Length > 0
                && request.ElementName != uniqueMethodName
            )
            ...
            else
            {
                if (
                    wrapperNamesMatter
                    && response.ElementName.Length > 0
                    && response.ElementName != (uniqueMethodName + "Response")
                )
            ...
            if (soapBindingStyle == SoapBindingStyle.Rpc)
            {
                if (soapRequestBinding.Use != SoapBindingUse.Encoded)
                {
                    AddMetadataProperty(
                        "Use",
                        new CodeFieldReferenceExpression(
                            new CodeTypeReferenceExpression(typeof(SoapBindingUse).FullName),
                            Enum.Format(typeof(SoapBindingUse), soapRequestBinding.Use, "G")
                        )
                    );
                }
                EndMetadata(
            ...
            else
            {
                ...
                AddMetadataProperty(
                    "ParameterStyle",
                    new CodeFieldReferenceExpression(
                        new CodeTypeReferenceExpression(typeof(SoapParameterStyle).FullName),
                        Enum.Format(
                            typeof(SoapParameterStyle),
                            hasWrapper ? SoapParameterStyle.Wrapped : SoapParameterStyle.Bare,
                            "G"
                        )
                    )
                );
            ...
            IsEncodedBinding =
                IsEncodedBinding || (soapRequestBinding.Use == SoapBindingUse.Encoded);

            CodeAttributeDeclarationCollection[] paramsMetadata =
                new CodeAttributeDeclarationCollection[
                    parameters.Parameters.Count + parameters.CheckSpecifiedCount
                ];
            int j = 0;
            CodeAttributeDeclaration ignoreAttribute = new CodeAttributeDeclaration(
            ...
            foreach (SoapParameter parameter in parameters.Parameters)
            {
                ...
                if (soapRequestBinding.Use == SoapBindingUse.Encoded)
                    soapExporter.AddMappingMetadata(
                        paramsMetadata[j],
                        parameter.mapping,
                        parameter.name != parameter.mapping.MemberName
                    );
                else
                {
                    string ns =
                    ...
                    if (parameter.mapping.CheckSpecified)
                    {
                        ...
                        xmlExporter.AddMappingMetadata(
                            ...
                            parameter.mapping,
                            ns,
                            parameter.specifiedName != parameter.mapping.MemberName + "Specified"
                        );
                        paramsMetadata[j].Add(ignoreAttribute);
                    }
                }
                if (
                    paramsMetadata[j].Count > 0
                    && !ServiceImporter.CodeGenerator.Supports(GeneratorSupport.ParameterAttributes)
                )
                {
                    UnsupportedOperationWarning(
                        Res.GetString(
                            Res.CodeGenSupportParameterAttributes,
                            ServiceImporter.CodeGenerator.GetType().Name
                        )
                    );
                    return null;
            ...
            CodeFlags[] parameterFlags = SoapParameter.GetCodeFlags(
                parameters.Parameters,
                parameters.CheckSpecifiedCount
            );
            string[] parameterTypes = SoapParameter.GetTypeFullNames(
                parameters.Parameters,
                parameters.CheckSpecifiedCount,
                ServiceImporter.CodeGenerator
            );
            ...
            CodeMemberMethod mainCodeMethod = WebCodeGenerator.AddMethod(
            ...
            if (parameters.Return != null)
            {
                if (soapRequestBinding.Use == SoapBindingUse.Encoded)
                    soapExporter.AddMappingMetadata(
                        mainCodeMethod.ReturnTypeCustomAttributes,
                        parameters.Return,
                        parameters.Return.ElementName != uniqueMethodName + "Result"
                    );
                else
                    xmlExporter.AddMappingMetadata(
                        mainCodeMethod.ReturnTypeCustomAttributes,
                ...
                )
                {
                    UnsupportedOperationWarning(
                        Res.GetString(
                            Res.CodeGenSupportReturnTypeAttributes,
                            ServiceImporter.CodeGenerator.GetType().Name
                        )
                    );
                    return null;
            ...
            {
                bool oldAsync =
                    (ServiceImporter.CodeGenerationOptions & CodeGenerationOptions.GenerateOldAsync)
                    != 0;
                bool newAsync =
                ...
                CreateInvokeParams(
                    ...
                    parameters.InCheckSpecifiedCount
                );
                ...
                if (oldAsync)
                {
                    ...
                    SoapParameter.GetTypeFullNames(
                        parameters.InParameters,
                        asyncParameterTypes,
                        0,
                        parameters.InCheckSpecifiedCount,
                    ...
                    CodeMemberMethod beginCodeMethod = WebCodeGenerator.AddMethod(
                        this.CodeTypeDeclaration,
                    ...
                    int outCount =
                        parameters.OutParameters.Count + parameters.OutCheckSpecifiedCount;
                    string[] asyncReturnTypes = new string[outCount + 1];
                    SoapParameter.GetTypeFullNames(
                        parameters.OutParameters,
                        asyncReturnTypes,
                        1,
                        parameters.OutCheckSpecifiedCount,
                        ServiceImporter.CodeGenerator
                    );
                    ...
                    CodeMemberMethod codeMethod = WebCodeGenerator.AddMethod(
                        this.CodeTypeDeclaration,
                    ...
                    invoke = new CodeMethodInvokeExpression(
                        new CodeThisReferenceExpression(),
                        "EndInvoke",
                        new CodeExpression[] { invokeParam }
                    );
                ...
                if (newAsync)
                {
                    string methodKey = MethodSignature(
                        uniqueMethodName,
                        returnType,
                        parameterFlags,
                        parameterTypes
                    ...
                    {
                        string handlerType = ClassNames.AddUnique(
                            uniqueMethodName + "CompletedEventHandler",
                            uniqueMethodName
                        );
                        string handlerArgs = ClassNames.AddUnique(
                            uniqueMethodName + "CompletedEventArgs",
                            uniqueMethodName
                        );
                        delegateInfo = new DelegateInfo(handlerType, handlerArgs);
                    }
                    string handlerName = MethodNames.AddUnique(
                        uniqueMethodName + "Completed",
                        uniqueMethodName
                    );
                    string asyncName = MethodNames.AddUnique(
                        uniqueMethodName + "Async",
                        uniqueMethodName
                    );
                    string callbackMember = MethodNames.AddUnique(
                        uniqueMethodName + "OperationCompleted",
                        uniqueMethodName
                    );
                    string callbackName = MethodNames.AddUnique(
                        "On" + uniqueMethodName + "OperationCompleted",
                        uniqueMethodName
                    );

                    // public event xxxCompletedEventHandler xxxCompleted;
                    WebCodeGenerator.AddEvent(
                        this.CodeTypeDeclaration.Members,
                        delegateInfo.handlerType,
                        handlerName
                    );

                    // private SendOrPostCallback xxxOperationCompleted;
                    WebCodeGenerator.AddCallbackDeclaration(
                        this.CodeTypeDeclaration.Members,
                        callbackMember
                    );

                    // create the pair of xxxAsync methods
                    string[] inParamNames = SoapParameter.GetNames(
                        parameters.InParameters,
                        parameters.InCheckSpecifiedCount
                    );
                    string userState = UniqueName("userState", inParamNames);
                    CodeMemberMethod asyncCodeMethod = WebCodeGenerator.AddAsyncMethod(
                        this.CodeTypeDeclaration,
                        asyncName,
                        SoapParameter.GetTypeFullNames(
                            parameters.InParameters,
                    ...
                    invokeParams[2] = new CodeFieldReferenceExpression(
                        new CodeThisReferenceExpression(),
                        callbackMember
                    );
                    ...
                    bool methodHasOutParameters =
                        parameters.Return != null || parameters.OutParameters.Count > 0;
                    WebCodeGenerator.AddCallbackImplementation(
                        this.CodeTypeDeclaration,
                        callbackName,
                        handlerName,
                        delegateInfo.handlerArgs,
                        methodHasOutParameters
                    );
                    ...
                    if (ExportContext[methodKey] == null)
                    {
                        ...
                        WebCodeGenerator.AddDelegate(
                            ...
                            methodHasOutParameters
                                ? delegateInfo.handlerArgs
                                : typeof(AsyncCompletedEventArgs).FullName
                        );
                        ...
                        if (methodHasOutParameters)
                        {
                            ...
                            ExtraCodeClasses.Add(
                                WebCodeGenerator.CreateArgsClass(
                                    delegateInfo.handlerArgs,
                                    asyncReturnTypes,
                                    asyncReturnNames,
                                    ServiceImporter.CodeGenerator
        ...
        )
        {
            ...
            else
            {
                ...
                for (int i = 0; i < parameters.OutParameters.Count; i++)
                {
                    ...
                    ((CodeArrayIndexerExpression)value).Indices
        ...
        )
        {
            ...
            if (soapBodyBinding.Use == SoapBindingUse.Literal)
            {
                ...
                if (parts.Length == 1 && !parts[0].Type.IsEmpty)
                {
                    ...
                    {
                        UnsupportedOperationBindingWarning(
                            Res.GetString(Res.SpecifyingATypeForUseLiteralMessagesIs0)
                        );
                        return false;
                    }
                    XmlMembersMapping membersMapping = xmlImporter.ImportAnyType(
                        parts[0].Type,
                        parts[0].Name
                    );
                    if (membersMapping == null)
                    {
                        UnsupportedOperationBindingWarning(
                            Res.GetString(
                                Res.SpecifyingATypeForUseLiteralMessagesIsAny,
                                parts[0].Type.Name,
                ...
                else
                {
                    foreach (MessagePart part in parts)
                    {
                        ...
                        {
                            UnsupportedOperationBindingWarning(
                                Res.GetString(Res.EachMessagePartInAUseLiteralMessageMustSpecify0)
                            );
                            return false;
                        }
                    }
            ...
            else if (soapBodyBinding.Use == SoapBindingUse.Encoded)
            {
                ...
                {
                    UnsupportedOperationBindingWarning(
                        Res.GetString(Res.TheEncodingIsNotSupported1, soapBodyBinding.Encoding)
                    );
                    return false;
                }
                foreach (MessagePart part in parts)
                {
                    ...
                    {
                        UnsupportedOperationBindingWarning(
                            Res.GetString(Res.SpecifyingAnElementForUseEncodedMessageParts0)
                        );
                        return false;
                    }
                    if (part.Type.IsEmpty)
                    {
                        UnsupportedOperationBindingWarning(
                            Res.GetString(Res.EachMessagePartInAnUseEncodedMessageMustSpecify0)
                        );
                        return false;
                    }
                }
            ...
            else if (soapBindingStyle == SoapBindingStyle.Document)
            {
                ...
                hasWrapper = (
                    parts.Length == 1
                    && string.Compare(parts[0].Name, "parameters", StringComparison.Ordinal) == 0
                );
                return true;
            }
            return false;
        ...
        XmlMembersMapping ImportMessage(
            string messageName,
            MessagePart[] parts,
            SoapBodyBinding soapBodyBinding,
            SoapBindingStyle soapBindingStyle,
        ...
        XmlMembersMapping ImportEncodedMessage(
            string messageName,
            MessagePart[] parts,
            SoapBodyBinding soapBodyBinding,
            bool wrapped
        )
        {
            ...
            if (wrapped)
            {
                ...
                membersMapping = soapImporter.ImportMembersMapping(
                    messageName,
                    soapBodyBinding.Namespace,
                    schemaMember
                );
            }
            else
        ...
        )
        {
            ...
            if (soapBindingStyle == SoapBindingStyle.Rpc)
            {
                ...
                membersMapping = xmlImporter.ImportMembersMapping(
                    messageName,
                    soapBodyBinding.Namespace,
                    schemaMembers
                );
