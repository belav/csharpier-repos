namespace System.Web.Services.Description
{
    ...
    public sealed class MimeTextMatch
    {
        ...
        public int Group
        {
            ...
            {
                if (value < 0)
                    throw new ArgumentException(Res.GetString(Res.WebNegativeValue, "group"));
                group = value;
            }
        }
        ...
        public int Capture
        {
            ...
            {
                if (value < 0)
                    throw new ArgumentException(Res.GetString(Res.WebNegativeValue, "capture"));
                capture = value;
            }
        }
        ...
        public int Repeats
        {
            ...
            {
                if (value < 0)
                    throw new ArgumentException(Res.GetString(Res.WebNegativeValue, "repeats"));
                repeats = value;
            }
        }
