...
namespace System.Web.Services.Protocols
{
    ...
    internal class HttpServerType : ServerType
    {
            ...
            : base(type)
        {
            ...
            {
                initializersByType[i] = MimeFormatter.GetInitializers(
                    returnWriterTypes[i],
                    methodInfos
                );
            }
    ...
    internal abstract class HttpServerProtocol : ServerProtocol
    {
        ...
        internal override bool Initialize()
        {
            ...
            if (
                ...
                && null
                    == (
                        serverType = (HttpServerType)GetFromCache(
                            typeof(HttpServerProtocol),
                            Type,
                            true
                        )
                    )
            ...
            if (serverMethod == null)
            {
                ...
                if (serverMethod != null)
                    throw new ArgumentException(
                        Res.GetString(Res.WebInvalidMethodNameCase, methodName, serverMethod.name),
                        "methodName"
                    );
                else
                {
                    ...
                    // again as UTF8...
                    string utf8MethodName = Encoding.UTF8
        ...
        internal override object[] ReadParameters()
        {
            ...
            for (int i = 0; i < serverMethod.readerTypes.Length; i++)
            {
                ...
                MimeParameterReader reader = (MimeParameterReader)
                    MimeFormatter.CreateInstance(
                        serverMethod.readerTypes[i],
            ...
            if (!hasInputPayload)
                ...
                throw new InvalidOperationException(
                    Res.GetString(Res.WebInvalidRequestFormatDetails, Request.ContentType)
                );
        }
        ...
        internal override void WriteReturns(object[] returnValues, Stream outputStream)
        {
            if (serverMethod.writerType == null)
                return;
            MimeReturnWriter writer = (MimeReturnWriter)
                MimeFormatter.CreateInstance(
                    serverMethod.writerType,
