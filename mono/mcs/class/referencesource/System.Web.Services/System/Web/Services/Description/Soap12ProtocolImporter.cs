...
namespace System.Web.Services.Description
{
    ...
    internal class Soap12ProtocolImporter : SoapProtocolImporter
    {
        ...
        {
            Soap12Binding soapBinding = (Soap12Binding)
                Binding.Extensions.Find(typeof(Soap12Binding));
            if (soapBinding == null)
                return false;
        ...
        protected override bool IsSoapEncodingPresent(string uriList)
        {
            ...
            if (base.IsSoapEncodingPresent(uriList))
                UnsupportedOperationBindingWarning(
                    Res.GetString(Res.WebSoap11EncodingStyleNotSupported1, Soap12.Encoding)
                );
