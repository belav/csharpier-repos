...
namespace System.Web.Services
{
    ...
    public sealed class WebMethodAttribute : Attribute
    {
        ...
        {
            get { return descriptionSpecified; }
        }
        ...
        {
            get { return enableSessionSpecified; }
        }
        ...
        {
            get { return cacheDurationSpecified; }
        }
        ...
        {
            get { return bufferResponseSpecified; }
        }
        ...
        {
            get { return transactionOptionSpecified; }
        }

        internal bool TransactionEnabled
        {
            get { return transactionOption != 0; }
        }
        ...
        {
            get { return messageName == null ? string.Empty : messageName; }
            set
            {
                messageName = value;
        ...
        {
            get { return messageNameSpecified; }
        }
    }
    ...
    internal class WebMethodReflector
    {
        ...
        */
        ...
        )
        {
            ...
            WebMethodAttribute attribute = new WebMethodAttribute(
                implAttribute.EnableSessionSpecified
                    ? implAttribute.EnableSession
                    : declAttribute.EnableSession
            );
            attribute.TransactionOption = implAttribute.TransactionOptionSpecified
                ? implAttribute.TransactionOption
                : declAttribute.TransactionOption;
            attribute.CacheDuration = implAttribute.CacheDurationSpecified
                ? implAttribute.CacheDuration
                : declAttribute.CacheDuration;
            attribute.BufferResponse = implAttribute.BufferResponseSpecified
                ? implAttribute.BufferResponse
                : declAttribute.BufferResponse;
            attribute.Description = implAttribute.DescriptionSpecified
                ? implAttribute.Description
                : declAttribute.Description;
            return attribute;
        }
        ...
        internal static LogicalMethodInfo[] GetMethods(Type type)
        {
            ...
            {
                throw new InvalidOperationException(
                    Res.GetString(Res.NeedConcreteType, type.FullName)
                );
            }
            ...
            for (int i = 0; i < methods.Length; i++)
            {
                ...
                if (declaration != null)
                {
                    object[] attrs = declaration.DeclaringType.GetCustomAttributes(
                    ...
                    if (attrs.Length > 0)
                    {
                        if (attrs.Length > 1)
                            throw new ArgumentException(
                                Res.GetString(
                                    Res.OnlyOneWebServiceBindingAttributeMayBeSpecified1,
                                    declaration.DeclaringType.FullName
                                ),
                                "type"
                            );
                ...
                WebMethodAttribute attribute = WebMethodReflector.GetAttribute(
                    methods[i],
                    declaration
                );
                if (attribute == null)
            ...
            return LogicalMethodInfo.Create(
                (MethodInfo[])list.ToArray(typeof(MethodInfo)),
                LogicalMethodTypes.Async | LogicalMethodTypes.Sync,
                methodInfos
            );
        }
