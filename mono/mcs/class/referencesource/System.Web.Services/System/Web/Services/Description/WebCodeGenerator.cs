...
namespace System.Web.Services.Description
{
    ...
    internal class WebCodeGenerator
    {
        ...
        static CodeMemberProperty CreatePropertyDeclaration(
        ...
        internal static CodeTypeMember AddMember(
        ...
        internal static CodeConstructor AddConstructor(
            CodeTypeDeclaration codeClass,
        ...
        )
        {
            ...
            Debug.Assert(
                parameterTypeNames.Length == parameterNames.Length,
        ...
        internal static CodeMemberMethod AddMethod(
            CodeTypeDeclaration codeClass,
            string methodName,
        ...
        )
        {
            return AddMethod(
                ...
                parameterTypeNames,
                parameterNames,
                new CodeAttributeDeclarationCollection[0],
                returnTypeName,
                metadata,
                flags
            );
        ...
        )
        {
            ...
            if ((flags & CodeFlags.IsPublic) != 0)
                method.Attributes =
                    (method.Attributes & ~MemberAttributes.AccessMask) | MemberAttributes.Public;
            if ((flags & CodeFlags.IsAbstract) != 0)
                method.Attributes =
            ...
            if ((flags & CodeFlags.IsNew) != 0)
                method.Attributes =
                    (method.Attributes & ~MemberAttributes.VTableMask) | MemberAttributes.New;

            Debug.Assert(
                parameterFlags.Length == parameterTypeNames.Length
                    && parameterTypeNames.Length == parameterNames.Length,
                "invalid set of parameters"
            );
        ...
        internal static CodeTypeDeclaration AddClass(
        ...
        internal static CodeTypeDeclaration CreateClass(
            string className,
            string baseClassName,
            string[] implementedInterfaceNames,
            CodeAttributeDeclarationCollection metadata,
        ...
        internal static CodeAttributeDeclarationCollection AddCustomAttribute(
            CodeAttributeDeclarationCollection metadata,
            Type type,
        ...
        )
        {
            ...
            int count =
                ...
                + (propNames == null ? 0 : propNames.Length);
            ...
            for (int i = 0; i < propNames.Length; i++)
                arguments[parameters.Length + i] = new CodeAttributeArgument(
                    propNames[i],
                    propValues[i]
                );
        ...
        internal static void AddDelegate(
            CodeTypeDeclarationCollection codeClasses,
            string handlerType,
            string handlerArgs
        )
        {
        ...
        internal static void AddCallbackDeclaration(
            CodeTypeMemberCollection members,
        ...
        internal static void AddCallbackImplementation(
            CodeTypeDeclaration codeClass,
            string callbackName,
            string handlerName,
            string handlerArgs,
        ...
        {
            CodeMemberMethod asyncCompleted = WebCodeGenerator.AddMethod(
                codeClass,
                callbackName,
                new CodeFlags[1] { 0 },
            ...
            CodeEventReferenceExpression member = new CodeEventReferenceExpression(
                new CodeThisReferenceExpression(),
                handlerName
            );
            ...
            CodeVariableReferenceExpression invokeArgs = new CodeVariableReferenceExpression(
                "invokeArgs"
            );
            ...
            trueStatements[1] = new CodeExpressionStatement(
                new CodeDelegateInvokeExpression(
                    new CodeEventReferenceExpression(
                        new CodeThisReferenceExpression(),
                        handlerName
                    ),
                    new CodeExpression[] { new CodeThisReferenceExpression(), create }
                )
            );
        ...
        {
            CodeMemberMethod asyncCodeMethod = WebCodeGenerator.AddMethod(
                codeClass,
                methodName,
                new CodeFlags[parameterNames.Length],
                parameterTypeNames,
                parameterNames,
                typeof(void).FullName,
                null,
            ...
            asyncCodeMethod = WebCodeGenerator.AddMethod(
                codeClass,
                methodName,
                new CodeFlags[parameterNames.Length],
                parameterTypeNames,
        ...
        internal static CodeTypeDeclaration CreateArgsClass(
            string name,
            string[] paramTypes,
            string[] paramNames,
            bool isPartial
        )
        {
            ...
            CodeConstructor ctor = new CodeConstructor();
            ctor.Attributes =
                (ctor.Attributes & ~MemberAttributes.AccessMask) | MemberAttributes.Assembly;
            ...
            ctor.Statements.Add(
                new CodeAssignStatement(
                    new CodeFieldReferenceExpression(new CodeThisReferenceExpression(), data.Name),
        ...
        )
        {
            ...
            valueRef.TargetObject = new CodeFieldReferenceExpression(
                new CodeThisReferenceExpression(),
                field.Name
            );
