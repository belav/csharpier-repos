...
namespace System.Web.Services.Protocols
{
        ...
        internal static object FromString(string value, Type type)
        {
            ...
            catch (Exception e)
            {
                ...
                throw new ArgumentException(
                    Res.GetString(Res.WebChangeTypeFailed, value, type.FullName),
                    "type",
                    e
                );
            }
    ...
    internal class ContentType
    {
        ...
        internal static bool IsSoap(string contentType)
        {
            ...
            return (
                    String.Compare(type, ContentType.TextXml, StringComparison.OrdinalIgnoreCase)
                    == 0
                )
                || (
                    String.Compare(
        ...
        {
            string type = GetBase(contentType);
            return String.Compare(type, ContentType.TextHtml, StringComparison.OrdinalIgnoreCase)
                == 0;
        }
