    ...
    internal sealed class CompModSwitches
    {
        ...
        public static BooleanSwitch DisableRemoteDebugging
        {
            get
            {
                ...
                {
                    disableRemoteDebugging = new BooleanSwitch(
                        "Remote.Disable",
                        "Disable remote debugging for web methods."
                    );
                }
        ...
        public static TraceSwitch DynamicDiscoverySearcher
        {
            get
            {
                ...
                {
                    dynamicDiscoSearcher = new TraceSwitch(
                        "DynamicDiscoverySearcher",
                        "Enable tracing for the DynamicDiscoverySearcher class."
                    );
                }
        ...
        public static BooleanSwitch DynamicDiscoveryVirtualSearch
        {
            get
            {
                ...
                {
                    dynamicDiscoVirtualSearch = new BooleanSwitch(
                        "DynamicDiscoveryVirtualSearch",
                        "Force virtual search for DiscoveryRequestHandler class."
                    );
                }
        ...
        public static TraceSwitch Remote
        {
            get
            {
                if (remote == null)
                {
                    remote = new TraceSwitch(
                        "Microsoft.WFC.Remote",
                        "Enable tracing for remote method calls."
                    );
                }
                return remote;
            }
