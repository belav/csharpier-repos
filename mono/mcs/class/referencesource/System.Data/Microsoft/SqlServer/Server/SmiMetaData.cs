...
namespace Microsoft.SqlServer.Server
{
    ...
    internal class SmiMetaData
    {
        ...
        internal static readonly DateTime MaxSmallDateTime = new DateTime(
            2079,
            06,
            06,
            23,
        ...
        internal static readonly DateTime MinSmallDateTime = new DateTime(
            1899,
            12,
            31,
            23,
        ...
        internal static readonly SqlMoney MaxSmallMoney = new SqlMoney(
            ((Decimal)Int32.MaxValue) / 10000
        );
        internal static readonly SqlMoney MinSmallMoney = new SqlMoney(
            ((Decimal)Int32.MinValue) / 10000
        );
        internal const SqlCompareOptions DefaultStringCompareOptions =
        ...
        private static readonly IList<SmiExtendedMetaData> __emptyFieldList =
            new List<SmiExtendedMetaData>().AsReadOnly();
        ...
        )
        {
            ...
            switch (dbType)
            {
                ...
                case SqlDbType.Decimal:
                    Debug.Assert(
                        MinPrecision <= precision && SqlDecimal.MaxPrecision >= precision,
                        "Invalid precision: " + precision
                    );
                    Debug.Assert(
                        MinScale <= scale && SqlDecimal.MaxScale >= scale,
                        "Invalid scale: " + scale
                    );
                    Debug.Assert(
                        scale <= precision,
                        "Precision: " + precision + " greater than scale: " + scale
                    );
                ...
                case SqlDbType.Udt:
                    ...
                    Debug.Assert(
                        (null != userDefinedType)
                            || (0 <= maxLength || UnlimitedMaxLengthIndicator == maxLength),
                        String.Format(
                            (IFormatProvider)null,
                            "SmiMetaData.ctor: Udt name={0}, maxLength={1}",
                ...
                case SqlDbType.Time:
                    Debug.Assert(
                        MinScale <= scale && scale <= MaxTimeScale,
                        "Invalid time scale: " + scale
                    );
                    _scale = scale;
            ...
            Debug.Assert(
                null != _extendedProperties && _extendedProperties.IsReadOnly,
                "SmiMetaData.ctor: _extendedProperties is "
                    + (null != _extendedProperties ? "writeable" : "null")
            );
            Debug.Assert(
                null != _fieldMetaData && _fieldMetaData.IsReadOnly,
                "SmiMetaData.ctor: _fieldMetaData is "
                    + (null != _fieldMetaData ? "writeable" : "null")
            );
#if DEBUG
            (
                (SmiDefaultFieldsProperty)_extendedProperties[SmiPropertySelector.DefaultFields]
            ).CheckCount(_fieldMetaData.Count);
            ((SmiOrderProperty)_extendedProperties[SmiPropertySelector.SortOrder]).CheckCount(
                _fieldMetaData.Count
            );
            ((SmiUniqueKeyProperty)_extendedProperties[SmiPropertySelector.UniqueKey]).CheckCount(
                _fieldMetaData.Count
            );
#endif
        }
            ...
            switch (dbType)
            {
                ...
                case SqlDbType.VarBinary:
                    result =
                        ...
                        || (0 < maxLength && MaxBinaryLength >= maxLength);
                    break;
                case SqlDbType.Char:
                ...
                case SqlDbType.NVarChar:
                    result =
                        UnlimitedMaxLengthIndicator == maxLength
                        || (0 < maxLength && MaxUnicodeCharacters >= maxLength);
                    break;
                case SqlDbType.VarChar:
                    result =
                        UnlimitedMaxLengthIndicator == maxLength
                        || (0 < maxLength && MaxANSICharacters >= maxLength);
                    break;
                default:
                    Debug.Assert(false, "How in the world did we get here? :" + dbType);
                    break;
        ...
        internal Type Type
        {
            get
            {
                ...
                if (
                    null == _clrType
                    && SqlDbType.Udt == _databaseType
                    && _udtAssemblyQualifiedName != null
                )
                {
        ...
        internal string TypeName
        {
            get
            {
                ...
                {
                    Debug.Assert(
                        String.Empty == __typeNameByDatabaseType[(int)_databaseType],
                        "unexpected udt?"
                    );
    ...
    internal class SmiExtendedMetaData : SmiMetaData
    {
        ...
        {
            get { return _typeSpecificNamePart1; }
        }

        internal string TypeSpecificNamePart2
        {
            get { return _typeSpecificNamePart2; }
        }

        internal string TypeSpecificNamePart3
        {
            get { return _typeSpecificNamePart3; }
        }
            ...
            )
        {
            Debug.Assert(
                ParameterDirection.Input == direction
                    ...
                    || ParameterDirection.ReturnValue == direction,
