    ...
    internal sealed class SmiContextFactory
    {
        ...
        private SmiContextFactory()
        {
            if (InOutOfProcHelper.InProc)
            {
                ...
                System.Reflection.FieldInfo buildVersionField = GetStaticField(
                    smiLinkType,
                    "BuildVersion"
                );
        ...
        internal SmiContext GetCurrentContext()
        {
            ...
            Debug.Assert(
                typeof(SmiContext).IsInstanceOfType(result),
                "didn't get SmiContext from GetCurrentContext?"
            );
        ...
        {
            System.Reflection.FieldInfo result = aType.GetField(
                fieldName,
