...
namespace Microsoft.SqlServer.Server
{
    ...
    internal class MetaDataUtilsSmi
    {
        ...
        {
            return IsUnicodeType(type) || IsAnsiType(type) || type == SqlDbType.Xml;
        }
        ...
        internal static SqlDbType InferSqlDbTypeFromTypeCode(ExtendedClrTypeCode typeCode)
        {
            Debug.Assert(
                ...
                "Someone added a typecode without adding support here!"
            );
        ...
        internal static bool IsValidForSmiVersion(SmiExtendedMetaData md, ulong smiVersion)
        {
            ...
            else
            {
                ...
                Debug.Assert(
                    SmiContextFactory.YukonVersion == smiVersion,
        ...
        internal static bool IsCompatible(SmiMetaData firstMd, SqlMetaData secondMd)
        {
            return firstMd.SqlDbType == secondMd.SqlDbType
                ...
                && firstMd.SqlDbType != SqlDbType.Structured
        ...
        internal static SmiExtendedMetaData SmiMetaDataFromDataColumn(
            DataColumn column,
            DataTable parent
        )
        {
            ...
            {
                throw SQL.UnsupportedColumnTypeForSqlProvider(
                    column.ColumnName,
        ...
        internal static SmiExtendedMetaData SmiMetaDataFromSchemaTableRow(DataRow schemaRow)
        {
            ...
            switch (colDbType)
            {
                ...
                case SqlDbType.Decimal:
                    ...
                    if (
                        precision < SmiMetaData.MinPrecision
