    ...
    public class SqlDataRecord : IDataRecord
    {
        ...
        public virtual int SetValues(params object[] values)
        {
            ...
            for (int i = 0; i < copyLength; i++)
            {
                ...
                {
                    ValueUtilsSmi.SetCompatibleValue(
                        _eventSink,
                        _recordBuffer,
                        i,
                        GetSmiMetaData(i),
        ...
        public virtual void SetValue(int ordinal, object value)
        {
            ...
            ExtendedClrTypeCode typeCode =
                MetaDataUtilsSmi.DetermineExtendedTypeCodeForUseWithSqlDbType(
                    metaData.SqlDbType,
                    false /* isMultiValued */
                    ,
                    value,
        ...
        public SqlDataRecord(params SqlMetaData[] metaData)
        {
            ...
            for (int i = 0; i < _columnSmiMetaData.Length; i++)
            {
                ...
                _columnSmiMetaData[i] = MetaDataUtilsSmi.SqlMetaDataToSmiExtendedMetaData(
                    _columnMetaData[i]
                );
        ...
        internal SqlDataRecord(SmiRecordBuffer recordBuffer, params SmiExtendedMetaData[] metaData)
        {
            Debug.Assert(
                null != recordBuffer,
                "invalid attempt to instantiate SqlDataRecord with null SmiRecordBuffer"
            );
            Debug.Assert(
                null != metaData,
                "invalid attempt to instantiate SqlDataRecord with null SmiExtendedMetaData[]"
            );
            ...
            for (int i = 0; i < _columnSmiMetaData.Length; i++)
            {
                ...
                _columnMetaData[i] = MetaDataUtilsSmi.SmiExtendedMetaDataToSqlMetaData(
        ...
        private ulong SmiVersion
        {
            get
            {
                return InOutOfProcHelper.InProc
                    ? SmiContextFactory.Instance.NegotiatedSmiVersion
